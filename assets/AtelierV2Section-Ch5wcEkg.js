...
/* Afficher plus — pill outline discret (écrase styles.gen lien/muted) */
.atl2 .moregrp,.atl2 button.moregrp{display:flex!important;flex-direction:column!important;
  align-items:center!important;justify-content:center!important;gap:5px!important;
  width:100%!important;padding:14px 12px 16px!important;background:transparent!important;
  border:0!important;border-top:1px solid var(--line)!important;cursor:pointer!important;
  font:inherit!important;color:inherit!important;text-align:center!important;
  text-decoration:none!important;letter-spacing:normal!important}
.atl2 .moregrp .more-label{display:inline-flex!important;align-items:center!important;
  justify-content:center!important;min-width:0!important;padding:7px 16px!important;
  font-size:12.5px!important;font-weight:600!important;letter-spacing:.01em!important;
  color:#475569!important;background:#fff!important;border:1px solid #E2E8F0!important;
  border-radius:999px!important;box-shadow:none!important;
  transition:color .12s,border-color .12s,background .12s}
.atl2 .moregrp:hover .more-label{color:#0F172A!important;background:#F8FAFC!important;
  border-color:#CBD5E1!important}
.atl2 .moregrp .more-meta{display:block!important;font-family:var(--mono)!important;
  font-size:10.5px!important;font-weight:500!important;letter-spacing:.04em!important;
...
`)}`}function Cn(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const En=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function fe({k:t,v:a}){return a==null||a===""?null:e.jsxs("div",{className:"dsl",children:[e.jsx("span",{children:t}),e.jsx("b",{children:String(a)})]})}function zn({o:t,qa:a}){const{t:n,lang:r,fund:s}=T(),o=(t.cribleStatus||"").trim().toUpperCase()||(Ye(t)==="NO MATCH"?"NO MATCH":"MATCH"),d=Ae(t),i=(a==null?void 0:a.blocs)||{},c=[[n.qaVP,i.value_prop],[n.qaProduct,i.produit],[n.qaModel,i.modele],[n.qaSummary,i.synthese]];return e.jsxs("article",{className:"dspage",children:[e.jsxs("header",{className:"dsh",children:[e.jsxs("div",{children:[e.jsx("b",{children:t.name}),t.tagline&&e.jsx("p",{children:t.tagline})]}),e.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?n.vOut:n.vKept,d&&e.jsx("em",{children:d})]})]}),t.reasoning&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsWhy}),e.jsx("p",{className:"dstxt",children:t.reasoning})]}),e.jsxs("section",{className:"dsgrid",children:[e.jsx(fe,{k:n.cdSector,v:t.sector}),e.jsx(fe,{k:n.cdStage,v:t.stage}),e.jsx(fe,{k:n.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(fe,{k:n.cdSite,v:t.domain||t.website}),e.jsx(fe,{k:n.cdName,v:t.contactName}),e.jsx(fe,{k:n.cdEmail,v:t.contactEmail}),e.jsx(fe,{k:n.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(fe,{k:n.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(fe,{k:n.cdAngle,v:t.angle}),e.jsx(fe,{k:n.cdDetected,v:En(t.date,r)})]}),c.some(([,m])=>m)&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsAnalysis}),c.filter(([,m])=>m).map(([m,b])=>e.jsxs("div",{className:"dsb",children:[e.jsx("span",{children:m}),e.jsx("p",{children:b})]},m))]}),(t.ceoStatus||t.ceoNote)&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsDecision}),t.ceoStatus&&e.jsx("p",{className:"dstxt",children:e.jsx("b",{children:t.ceoStatus})}),t.ceoNote&&e.jsxs("p",{className:"dstxt",children:["« ",t.ceoNote," »"]})]}),e.jsx("footer",{className:"dsf",children:n.dsFoot(s)})]})}function Tn(){const{t,lang:a,token:n,scoped:r,fund:s,data:o,dispatch:d}=T(),[i,c]=l.useState({}),m=25,b=l.useMemo(()=>r.slice(0,m),[r]);l.useEffect(()=>{b.length&&_a(n,b.map(v=>v.name)).then(c)},[n,b]);const u=o.stats,h=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return e.jsxs("div",{className:"dossier",children:[e.jsxs("div",{className:"dsbar",children:[e.jsx("b",{children:t.dsTitle(b.length)}),r.length>m&&e.jsx("span",{className:"mnote dim",children:t.dsCap(m,r.length)}),e.jsx("span",{className:"dssp"}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:t.printBtn})]}),e.jsxs("div",{className:"dscover",children:[e.jsx("b",{children:s}),u&&typeof u.screened=="number"&&e.jsxs("p",{children:[h(u.screened)," ",t.funScreened(""),typeof u.kept=="number"&&e.jsxs(e.Fragment,{children:[" · ",h(u.kept)," ",t.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&e.jsxs(e.Fragment,{children:[" · ",t.covOf(h(o.marketEstimate)),", ",Math.round(u.screened/o.marketEstimate*100)," %"]})]})]}),b.map(v=>e.jsx(zn,{o:v,qa:i[v.name]},v.id)),!b.length&&e.jsx("p",{className:"mnote",children:t.dsEmpty})]})}const An=50;function ft({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:s}=T(),[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(""),[u,h]=l.useState(0),[v,f]=l.useState(""),[x,g]=l.useState(!1),p=l.useRef(null);l.useEffect(()=>()=>{p.current&&window.clearInterval(p.current)},[]);const y=async w=>{c(!0),b("");const C=await a();if(c(!1),C.ok){d(C);return}if(C.busy){b(s.alertPreviewBusy);return}if(!w){b(s.alertPreviewFail);return}h(An),p.current=window.setInterval(()=>{h(j=>j>1?j-1:(p.current&&window.clearInterval(p.current),y(!1),0))},1e3)},S=async()=>{if(r||x)return;g(!0),f("");const w=await n();g(!1),f(w.ok?s.alertTestOk(w.sentTo||""):w.error||s.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:i||u>0,onClick:()=>{y(!0)},children:i?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||x,onClick:()=>{S()},children:x?"…":s.alertTest})]}),u>0&&e.jsx("p",{className:"mnote",children:s.alertPreviewRetry(u)}),m&&e.jsx("p",{className:"mnote warn",children:m}),v&&e.jsx("p",{className:"mnote",children:v}),!v&&e.jsx("p",{className:"mnote dim",children:s.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:s.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:s.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Fe="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function oe({title:t,icon:a,children:n,wide:r}){const{dispatch:s}=T();return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&s({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>s({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function Ln(){const{st:t}=T();switch(t.modal){case"chain":return e.jsx(Rn,{});case"space":return e.jsx(On,{});case"alert":return e.jsx(Fn,{});case"queue":return e.jsx(Bn,{});case"export":return e.jsx($n,{});case"plug":return e.jsx(Vn,{});case"recharge":return e.jsx(Yn,{});case"cover":return e.jsx(Gn,{});case"dossier":return e.jsx(Wn,{});case"crit":return e.jsx(Kn,{});case"tuto":return e.jsx(Qn,{});case"rdv":return e.jsx(qn,{});case"memoalert":return e.jsx(_n,{});default:return null}}function qn(){const{dispatch:t,fund:a}=T(),n=typeof document<"u"&&!!document.getElementById("rdv");return l.useEffect(()=>{n&&(t({type:"modal",modal:null}),Rr())},[n,t]),n?null:e.jsx(Ha,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function Rn(){const{st:t,dispatch:a,byId:n,t:r,lang:s,mode:o,askEvaluate:d,evalBusy:i}=T(),c=o==="client",m=t.chain.queue.map(v=>n.get(v)).filter(v=>!!v),b=t.chain.idx,u=m[b],h=b>=m.length;return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:h?r.finished:`${b+1} / ${m.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(h?100:b/Math.max(1,m.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:h||!u?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(m.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:u.name}),e.jsx("div",{className:"sub",children:[Le(u.cc,s)||u.countryLabel,u.sector,u.stage,r.daysAgo(Te(u.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:ge(u.engine,s).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{children:ct(u.amountEur,s)})]}),ne(u)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(qe,{o:u,lg:!0})," ",e.jsx(We,{o:u,src:!0})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),c&&de(u)&&e.jsxs("div",{className:"vbox",style:{"--c":Ee(u)==="retenu"?"var(--brand)":Ee(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:Ee(u)==="retenu"?"✓ "+r.kept:Ee(u)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!h&&u&&!(c&&de(u))&&e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:i,onClick:()=>{d(u)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(h?{type:"modal",modal:null}:{type:"chainNext"}),children:h?r.closeBtn:r.skip})]})]})})}),document.body)}function On(){const{st:t,dispatch:a,dossiers:n,t:r,mode:s}=T(),o=s==="client",d=l.useMemo(()=>o?n.filter(u=>de(u)):[],[n,o]),i=l.useMemo(()=>ut(d.filter(u=>Ee(u)==="retenu"),{key:"signal",dir:-1}),[d]),c=l.useMemo(()=>d.filter(u=>Ee(u)==="ecarte"),[d]),m=t.spaceTab==="retenu"?i:c,b=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(oe,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:i.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),m.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),m.slice(0,40).map(u=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":b},children:typeof u.score=="number"&&u.score>0?u.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:u.name}),e.jsx("div",{className:"rr",children:u.reasoning||u.tagline||""})]})]},u.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function Fn(){const{mode:t}=T();return t==="client"||t==="apercu"?e.jsx(Mn,{}):e.jsx(In,{})}function Mn(){const{t,token:a,flash:n,flashErr:r,mode:s}=T(),[o,d]=l.useState("d"),i=s!=="client";return e.jsxs(oe,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>d("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>d("w"),children:t.alertTabWeekly}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>d("m"),children:t.alertTabMarket})]}),o==="d"&&e.jsx(Dn,{t,token:a,readOnly:i,flash:n,flashErr:r}),o==="w"&&e.jsx(Pn,{t,token:a,readOnly:i,flash:n,flashErr:r}),o==="m"&&e.jsx(Zt,{})]})}function Dn({t,token:a,readOnly:n,flash:r,flashErr:s}){const[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(0);l.useEffect(()=>{let f=!0;return c(!1),Ct(a).then(x=>{f&&(x?d(x):c(!0))}),()=>{f=!1}},[a,m]);const u=f=>{n||Ct(a,f).then(x=>{if(!x){s(t.actErr);return}d(x),x.throttled?s(t.alertThrottled):r(t.alertSaved)})};if(i)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const h=f=>!o.sections||o.sections.includes(f),v=f=>{const x=o.sections||t.alertSec.map(([g])=>g);u({sections:h(f)?x.filter(g=>g!==f):[...x,f]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([f,x])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:h(f),disabled:n,onChange:()=>v(f)}),e.jsxs("span",{children:[x,f==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},f))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(ft,{label:t.alertPreview,readOnly:n,onPreview:()=>Xa(a),onTest:()=>Ja(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Pn({t,token:a,readOnly:n,flash:r,flashErr:s}){const[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(0);l.useEffect(()=>{let f=!0;return c(!1),Et(a).then(x=>{f&&(x?d(x):c(!0))}),()=>{f=!1}},[a,m]);const u=f=>{n||Et(a,f).then(x=>{if(!x){s(t.actErr);return}d(x),r(t.alertSaved)})};if(i)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const h=o.dow??0,v=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:h,disabled:n,onChange:f=>u({dow:Number(f.target.value)}),children:t.alertDow.map((f,x)=>e.jsx("option",{value:x,children:f},f))}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,v-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[v," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,v+1)}),disabled:n,children:"＋"})]})]}),e.jsx(ft,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>er(a),onTest:()=>Za(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Zt(){const{st:t,t:a,lang:n,scoped:r,contName:s,email:o}=T(),[d,i]=l.useState(o||""),[c,m]=l.useState(!1),[b,u]=l.useState(!1);l.useEffect(()=>{o&&i(o)},[o]);const h=t.filters,v=l.useMemo(()=>r.filter(p=>ne(p)).length,[r]),f=h.win==="1"?0:h.win==="7"?1:h.win==="30"?2:3,x=async()=>{if(!(!/.+@.+\..+/.test(d)||b)){u(!0);try{await fetch(`${ot}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:h.sector,countries:h.country,source:o?"atelier2-client":"atelier2",website:""})}),m(!0)}finally{u(!1)}}},g=[[a.amRows.continent,s],[a.amRows.since,a.amSince[f]],[a.amRows.signal,h.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,h.engine.length?h.engine.map(p=>ge(p,n)).join(", "):a.amAllEngines],[a.amRows.sectors,h.sector.length?h.sector.join(", "):a.amAllSectors],[a.amRows.countries,h.country.length?h.country.map(p=>Le(p,n)||p).join(", "):a.amAllCountries],[a.amRows.stages,h.stage.length?h.stage.join(", "):a.amAllStages]];return c?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:g.map(([p,y])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:p}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},p))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!o,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(b?" loading":""),style:{padding:"12px 18px"},onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})}function In(){const{t}=T();return e.jsx(oe,{title:t.alertTitle,icon:"🔔",children:e.jsx(Zt,{})})}function Bn(){var x,g,p;const{t,token:a,fund:n,mode:r,flash:s}=T(),[o,d]=l.useState(null),[i,c]=l.useState([]),[m,b]=l.useState(0),u=r==="client";l.useEffect(()=>{let y=!0;return(async()=>{const[S,w]=await Promise.all([it(n),Vt(a)]);y&&(S&&d(S),c(w))})(),()=>{y=!1}},[a,n,m]);const h=(o==null?void 0:o.per_day)??2,v=((x=o==null?void 0:o.analyzed_today)==null?void 0:x.length)??0,f=(g=o==null?void 0:o.tomorrow)!=null&&g.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(oe,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(v,v+(((p=o==null?void 0:o.pool_order)==null?void 0:p.length)??0))}})}),e.jsxs("div",{className:"qrate",children:[t.covRate," — ",e.jsx("b",{children:t.covRateNow(h)})]})]}),i.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:i.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),u&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{St(a,y.company,"retry").then(()=>b(S=>S+1))},children:t.queueRetry}),u&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{St(a,y.company,"delete").then(()=>b(S=>S+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[f.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),f.slice(0,10).map((y,S)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",S+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function $n(){const{t,token:a,flash:n,scoped:r,caps:s,stageOf:o,dispatch:d}=T(),i=`${Fe}/cibles/list.csv?token=${a}`,c=`${Fe}/cibles/list.json?token=${a}`,m=`${Fe}/cibles/export.xlsx?token=${a}&scope=full`,b=`=IMPORTDATA("${i}")`,u=g=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>n(t.exportCopied))},h=[{def:t.exportCsv,value:i,href:i},{def:t.exportSheet,value:b},{def:t.exportLive,value:c,href:c},{def:t.exportXlsx,value:m,href:m}],v=!s.lockActions&&r.length>0,f=()=>{Cn(Sn(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:g=>(t.stg.find(([p])=>p===g)||["",""])[1]})),n(t.exportViewDone(r.length))},x=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(oe,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:x,children:t.printBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🗂"}),e.jsxs("div",{children:[e.jsx("b",{children:t.dsBtn}),e.jsx("p",{children:t.dsHint})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:t.exportViewBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:f,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:h.map(({def:g,value:p,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:g[0]}),e.jsxs("div",{children:[e.jsx("b",{children:g[1]}),e.jsx("p",{children:g[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>u(p),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},g[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function _n(){const{t,token:a,flash:n,flashErr:r,mode:s}=T(),o=s!=="client",[d,i]=l.useState(null),[c,m]=l.useState(!1),[b,u]=l.useState(0),[h,v]=l.useState(!1);l.useEffect(()=>{let p=!0;return m(!1),Nt(a).then(y=>{p&&(y?i(y):m(!0))}),()=>{p=!1}},[a,b]);const f=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},x=p=>{if(o||!d)return;const y={enabled:p.enabled??!!d.enabled,email:p.email??(d.email||""),sections:p.sections??f()};v(!0),Nt(a,y).then(S=>{if(v(!1),!S){r(t.memoAlertErr);return}i(S),n(t.memoAlertSaved)})};if(c)return e.jsx(oe,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>u(p=>p+1),children:t.retry})]})});if(!d)return e.jsx(oe,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const g=f();return e.jsxs(oe,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:o||h,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),e.jsx(Un,{value:d.email||"",readOnly:o||h,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:p=>x({email:p})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([p,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!g[p],disabled:o||h,onChange:()=>x({sections:{...g,[p]:!g[p]}})}),e.jsx("span",{children:y})]},p))}),e.jsx(ft,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Va(a,g),onTest:()=>Ua(a,g)})]})}function Un({value:t,readOnly:a,label:n,okLabel:r,onSave:s}){const[o,d]=l.useState(t);l.useEffect(()=>{d(t)},[t]);const i=o.trim()!==t.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:m=>d(m.target.value),onKeyDown:m=>{m.key==="Enter"&&i&&c&&s(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!i||!c,onClick:()=>s(o.trim()),children:r})]})]})}function Vn(){const{t,token:a,flash:n,flashErr:r,canWrite:s}=T(),[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(null),[u,h]=l.useState(""),[v,f]=l.useState(0);l.useEffect(()=>{let p=!0;return c(!1),rt(a).then(y=>{p&&(y?d({configured:y.configured,url_hint:y.url_hint}):c(!0))}),Wa(a).then(y=>{p&&b(y)}),()=>{p=!1}},[a,v]);const x=(p,y)=>{s&&rt(a,p).then(S=>{if(!S||S.ok===!1){r(t.actErr);return}p.test&&S.sent===!1?r(t.plugTestThrottled):n(y),f(w=>w+1)})},g='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(oe,{title:t.plugTitle,icon:"🔌",wide:!0,children:[m&&e.jsx("p",{className:"mnote"+(m.enabled?" warn":""),children:m.enabled?t.plugAutoOn(m.destination||"webhook"):t.plugAutoOff}),i?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>f(p=>p+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:u,disabled:!s,onChange:p=>h(p.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!s||!u.trim(),onClick:()=>x({url:u.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!s,onClick:()=>x({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!s,onClick:()=>x({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Hn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:g}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Hn(){const{t,token:a,lang:n}=T(),[r,s]=l.useState("valides"),[o,d]=l.useState(!1),[i,c]=l.useState(null),[m,b]=l.useState(null),[u,h]=l.useState(!1),[v,f]=l.useState(!1),[x,g]=l.useState(null),[p,y]=l.useState(null),[S,w]=l.useState(null),C=`atl2:bulk:${a}:${r}`;l.useEffect(()=>{rt(a).then(z=>{y(z&&z.configured?z.url_hint||"webhook":null)})},[a]),l.useEffect(()=>{c(null),b(null),h(!1),g(null);try{const z=JSON.parse(localStorage.getItem(C)||"null");w(z&&Date.now()-Date.parse(z.t)<24*3600*1e3?z:null)}catch{w(null)}},[C]);const j=async()=>{d(!0),h(!1),g(null);const z=await Ka(a,r);c(z),b(z.ok?r:null),d(!1)},E=l.useRef(!1),N=async()=>{if(E.current)return;E.current=!0,f(!0);const z=`${a}:${r}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await Qa(a,r,"webhook",void 0,z)}finally{E.current=!1}if(f(!1),h(!1),g(_),_.ok&&(_.pushed||0)>0){const D={t:new Date().toISOString(),n:_.pushed||0};w(D);try{localStorage.setItem(C,JSON.stringify(D))}catch{}}},q=i!=null&&i.ok&&i.ready||0,$=!!(i!=null&&i.ok)&&m===r&&q>0&&!!p&&!S,F=S?new Date(S.t).toLocaleString(n==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:r,onChange:z=>s(z.target.value),children:t.plugBulkTabs.map(([z,_])=>e.jsx("option",{value:z,children:_},z))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{j()},children:o?"…":t.plugBulkPreview})]}),i&&(i.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(i.ready||0,i.linkedinReady||0,(i.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(i!=null&&i.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),S&&e.jsx("p",{className:"mnote",children:t.bulkLocked(F,S.n)}),!S&&!!(i!=null&&i.ok)&&!p&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!S&&!i&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),$&&!u&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>h(!0),children:t.bulkArm}),$&&u&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(q,p||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{N()},children:v?t.bulkSending:t.bulkConfirm(p||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>h(!1),children:t.bulkCancel})]}),x&&(x.ok?x.replayed?e.jsx("p",{className:"mnote",children:x.pending?t.bulkPending:t.bulkReplayed}):(x.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(x.pushed||0,x.linkedinReady||0,x.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:x.error||t.actErr}))]})}function Yn(){const{t,data:a,lang:n}=T(),r=a.credits,s=a.email,o=async d=>{if(!s)return;const i=window.location.href.split("?")[0];try{const m=await(await fetch(`${ot}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s,lookup_key:d,success_url:i+"?credits=ok",cancel_url:i+"?credits=cancel"})})).json();m.url&&(window.location.href=m.url)}catch{}};return e.jsxs(oe,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(d=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(d.credits,d.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(d.lookup_key)},children:t.rechargeBuy})]},d.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Wn(){const{t}=T();return e.jsx(oe,{title:t.dsBtn,icon:"🗂",wide:!0,children:e.jsx(Tn,{})})}function Gn(){const{t,lang:a,data:n,dossiers:r,token:s,canWrite:o,flash:d}=T(),[i,c]=l.useState(null),[m,b]=l.useState(!1);l.useEffect(()=>{let j=!0;return it(s).then(E=>{j&&E&&typeof E.per_day=="number"&&c(E.per_day)}),()=>{j=!1}},[s]);const u=n.stats,h=typeof(u==null?void 0:u.screened)=="number"?u.screened:r.filter(j=>j.kind==="target"&&de(j)).length,v=n.marketEstimate||0,f=v>0?Math.min(100,Math.round(h/v*100)):null,x=(u==null?void 0:u.window_days)||30,g=h>0?h/x:0,p=v>0?Math.max(0,v-h):0,S=v>0&&g>0&&h>=100?Math.round(p/g):null,w=j=>Math.round(j).toLocaleString(a==="en"?"en-US":"fr-FR"),C=j=>{m||!o||(b(!0),Ga(s,j).then(E=>{if(b(!1),E===null){d(t.actErr);return}c(E),d(t.alertSaved)}))};return e.jsxs(oe,{title:t.coverTitle,icon:"🌍",children:[e.jsxs("div",{className:"covg",children:[e.jsx("b",{children:t.covScreened(w(h))}),v>0&&e.jsx("span",{children:t.covOf(w(v))})]}),f!==null?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"covbar",children:[e.jsx("i",{style:{width:f+"%"}}),e.jsxs("em",{children:[f," %"]})]}),S!==null&&e.jsx("p",{className:"mnote",children:t.covEta(S)})]}):e.jsx("p",{className:"mnote dim",children:t.covNoEst}),g>=1&&e.jsx("p",{className:"mnote",children:t.covPace(w(g))}),u&&e.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.kept)})," ",t.covKept]}),typeof u.analyzed=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.analyzed)})," ",t.covAna]}),typeof u.shown=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.shown)})," ",t.covShown]})]}),o&&i!==null&&e.jsxs("div",{className:"covr",children:[e.jsxs("div",{className:"covrh",children:[e.jsx("span",{children:t.covRate}),e.jsx("b",{children:t.covRateNow(i)})]}),e.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(j=>e.jsx("button",{type:"button",className:i===j?"on":"",disabled:m,onClick:()=>C(j),children:j===0?"⏸":j},j))}),e.jsx("p",{className:"mnote dim",children:t.covRateHint})]})]})}function Kn(){var p,y,S;const{t,dossiers:a,token:n,mode:r,flash:s,criteria:o}=T(),d=r==="client",i=l.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[c,m]=l.useState(null);l.useEffect(()=>{let w=!0;return Ya(n).then(C=>{w&&m(C.thumbs)}),()=>{w=!1}},[n]);const[b,u]=l.useState(""),[h,v]=l.useState(""),[f,x]=l.useState(!1),g=async()=>{const w=b.trim();if(!(!w||f||!d)){x(!0),v("");try{const j=await(await fetch(`${Fe}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:w,who:"atelier2"})})).json().catch(()=>({}));if(j.reply&&v(String(j.reply)),j.job_id){v(t.critChatRunning);const E=async()=>{const N=await fetch(`${Fe}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:j.job_id})}).then(q=>q.json()).catch(()=>null);if(N&&N.done){v(String(N.reply||N.clarification||N.summary||"✓")),x(!1),N.applied&&s(t.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),u("");return}u("")}finally{h.startsWith("⏳")||x(!1)}}};return e.jsxs(oe,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((p=o.points)!=null&&p.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(w=>{var C,j;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(E=>e.jsx("li",{children:E},E))})]}),!!((j=w.out)!=null&&j.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(E=>e.jsx("li",{children:E},E))})]})]})]},w.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),i.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:i.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:b,disabled:!d||f,onChange:w=>u(w.target.value),onKeyDown:w=>{w.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!d||f||!b.trim(),onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),h&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:h})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((w,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Xt[w]||"v-cons"),children:w}),e.jsx("span",{children:C})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",C]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Qn(){const{t,dispatch:a,startTour:n}=T(),r=s=>{var o,d;a({type:"modal",modal:null}),s==="crit"||s==="plug"||s==="alert"?a({type:"modal",modal:s}):s.startsWith("tab")?a({type:"ptab",tab:Number(s.slice(3))}):s==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return e.jsxs(oe,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([s,o],d)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:d+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+d))})]})}const tt={},Bt=(tt==null?void 0:tt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function He(){return new Date().toISOString().slice(0,10)}const ea=l.createContext(null);function ta(){const t=l.useContext(ea);if(!t)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return t}function Jn({token:t,children:a}){const{dispatch:n,st:r,lang:s}=T(),[o,d]=l.useState(()=>r.filters.day||He()),[i,c]=l.useState(null),[m,b]=l.useState(!1),u=l.useCallback(f=>{if(/^\d{4}-\d{2}-\d{2}$/.test(f)){d(f);try{n({type:"filters",patch:{day:f,win:"all"}})}catch{}}},[n]);l.useEffect(()=>{r.filters.day||u(He())},[]),l.useEffect(()=>{const f=x=>{var p;const g=(p=x.detail)==null?void 0:p.day;typeof g=="string"&&u(g)};return window.addEventListener("pp-edition-day",f),()=>window.removeEventListener("pp-edition-day",f)},[u]),l.useEffect(()=>{r.filters.day&&r.filters.day!==o&&d(r.filters.day)},[r.filters.day]),l.useEffect(()=>{if(!t||!o)return;let f=!1;b(!0);const x=new URLSearchParams({token:t,date:o});return fetch(`${Bt}/cibles/edition.json?${x}`).then(g=>g.json()).then(g=>{f||c(g)}).catch(()=>{f||c({ok:!1,error:"network"})}).finally(()=>{f||b(!1)}),()=>{f=!0}},[t,o]);const h=l.useMemo(()=>`${Bt}/cibles/editions.json?token=${encodeURIComponent(t)}`,[t]),v=l.useMemo(()=>({token:t,day:o,ed:i,loading:m,pickDay:u,daysUrl:h,isEn:s==="en"}),[t,o,i,m,u,h,s]);return e.jsx(ea.Provider,{value:v,children:a})}function Xn(){const{day:t,daysUrl:a,pickDay:n,isEn:r}=ta();return e.jsxs("div",{className:"thesis-days",children:[e.jsx("style",{children:`
      ...
      `}),e.jsx("p",{className:"thesis-days__h",children:r?"Thesis brief · pick a day":"Brief thèse · choisir un jour"}),e.jsx(tr,{mode:"local",theme:"light",month:t.slice(0,7),current:t,daysUrl:a,onPick:n})]})}function Zn(){const{day:t,ed:a,loading:n,pickDay:r,isEn:s}=ta(),o=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!o,i=a&&!a.ok;return e.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||t,"data-fund":(a==null?void 0:a.fund)||"",children:[e.jsx("style",{children:`
