...
`,Vi=Ui+Hi;function Ba(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Wi(){const e=Ba("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Yi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Wi();return r==="0"?"client":r==="1"||Ba("embed")==="1"&&Ba("chrome")==="1"?"apercu":"client"}const Gi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ki=e=>Gi[e];function pa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const xt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!wr(a)||pa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:qo(e.cc)})};function Ea(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Qi=60*60*1e3;function Ji(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Qi?null:a}catch{return null}}function Qt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Xi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Zi(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:wo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Yi(e,i),[e,i,n]),l=m.useMemo(()=>Ki(o),[o]),d=o!=="visiteur",c=Xi(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[g,p]=m.useState(null),[b,y]=m.useState(null),[h,S]=m.useState(null),[j,w]=m.useState(()=>new Map),[C,T]=m.useState(()=>new Map),[A,L]=m.useState(""),[z,N]=m.useState(new Set),[R,I]=m.useState(null),[M,F]=m.useState(!0),[v,q]=m.useState(!1),[V,B]=m.useState(0),[_,W]=m.useState(0),Q=m.useRef(0),K=m.useMemo(()=>{var ne;if(o!=="client")return"";try{return((ne=ko())==null?void 0:ne.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ne=++Q.current;let ge=!0;const G=()=>ge&&ne===Q.current,de=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),ce=Ji(de);return ce?(s(ce.objs.map(xt)),ce.fund&&u(ce.fund),p(ce.marketEstimate??null),y(ce.criteria??null),S(ce.stats??null),L(ce.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const je=await Na(),ve=((je==null?void 0:je.recent_ops)||[]).map(ee=>{const Z=sa(ee.company_name||ee.title?ee:{...ee,title:(ee.headline_fr||ee.headline||"").slice(0,120)},a),J=String(ee.rubrique||"").toLowerCase();return Z&&(J==="nominations"||J==="recrutements")&&(Z.engine=J),Z&&!String(ee.company_name||"").trim()&&(Z.noCo=!0),Z}).filter(ee=>!!ee).map(ee=>(wr((ee.name||"").trim())||(ee.noCo=!0),ee));try{const ee=jo(),Z=ee&&ee.doc||await No(),J=So(Z),H=((ee==null?void 0:ee.day)||(Z==null?void 0:Z.date)||"").slice(0,10);if(H&&J.length){const xe=new Set;for(const te of ve){if((te.date||"").slice(0,10)!==H)continue;const pe=Nn(J,xe,te.name,"");pe>=0&&(xe.add(pe),te.decryptHtml=J[pe].html)}for(const te of ve){if(te.decryptHtml||(te.date||"").slice(0,10)!==H)continue;const pe=Nn(J,xe,"",te.headline||te.tagline||te.name);pe>=0&&(xe.add(pe),te.decryptHtml=J[pe].html)}}if(H){const xe=((Z==null?void 0:Z.title_fr)||"").trim(),te=((Z==null?void 0:Z.lead_fr)||"").trim(),pe=Eo(Z),ue=((Z==null?void 0:Z.url)||"").trim();xe&&(pe||ue)&&ve.unshift({id:`edito:${H}`,kind:"op",name:xe,cc:null,date:H,engine:"edito",dealKind:"other",headline:te||xe,tagline:te||xe,decryptHtml:pe||void 0,url:ue,noCo:!0})}}catch{}if(!G())return;s(ve.map(xt)),Qt(de,{objs:ve})}else if(typeof r=="object"){const ve=(await Sn()||[]).filter(Z=>(Z.slug||"")===r.research).map(Z=>En(Z,a)).filter(Z=>!!Z),ee=Ea(await Cn(ve,a));if(!G())return;s(ee.map(xt)),Qt(de,{objs:ee})}else if(d&&i.token){const je=Co(i.token),ve=Na(),ee=zo(i.token),Z=Ao(i.token),J=To(i.token),H=await je;let xe=H?H.targets:[];G()&&H&&(u(H.fund||""),p(H.marketEstimate??null),y(H.criteria??null),S(H.stats??null),L(H.generatedAt||""),s(xe.map(xt)),F(!1),q(!1));const[te,pe,ue,me]=await Promise.all([ve,ee,Z,J]),Re=((te==null?void 0:te.recent_ops)||[]).map(Ae=>sa(Ae,a)).filter(Ae=>!!Ae);if(xe=[...xe,...Re],!G())return;s(xe.map(xt));const Ve=new Set;for(const Ae of pe){const Fe=(Ae.id||Ae.co||"").toString().trim().toLowerCase();Fe&&Ve.add(Fe.startsWith("t:")?Fe:"t:"+Fe)}N(Ve),w(ue),T(me),H&&Qt(de,{fund:H.fund,marketEstimate:H.marketEstimate,criteria:H.criteria,stats:H.stats,generatedAt:H.generatedAt,objs:xe})}else{const je=Lo(),ve=Sn(),ee=Na(),Z=await je;G()&&Z.length&&(s(Ea(Z).map(xt)),F(!1),q(!1));const[J,H]=await Promise.all([ve,ee]),xe=(J||[]).map(me=>En(me,a)).filter(me=>!!me),te=await Cn(xe,a),pe=((H==null?void 0:H.recent_ops)||[]).map(me=>sa(me,a)).filter(me=>!!me),ue=Ea([...Z,...te,...pe]);if(!G())return;s(ue.map(xt)),Qt(de,{objs:ue})}G()&&q(!1)}catch{G()&&!ce&&q(!0)}finally{G()&&F(!1)}})(),()=>{ge=!1}},[d,i.token,a,V,c]),m.useEffect(()=>{if(!l.showCredits||!K){I(null);return}let ne=!0;return(async()=>{try{const ge=await fetch(`${nn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K})});if(!ge.ok)return;const G=await ge.json();ne&&G&&G.ok!==!1&&I(G)}catch{}})(),()=>{ne=!1}},[l.showCredits,K,_]);const ie=m.useCallback(ne=>N(new Set(ne)),[]);return{session:i,mode:o,caps:l,fund:x,email:K,marketEstimate:g,generatedAt:A,criteria:b,stats:h,thumbs:j,stages:C,dossiers:f,favIds:z,setFavIds:ie,credits:R,reloadCredits:()=>W(ne=>ne+1),loading:M,error:v,refresh:()=>B(ne=>ne+1)}}function ut(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Sr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),es=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Sr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ts=new Set(["signal","amount","score","crible","memo"]);function as(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Sr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ts.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Er)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Er=80;function ua(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!qe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(rn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(ct(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&gt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Cr(e,a,r){return ut(e)?ua(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ua(e,a.filters,r)}function ns(e,a,r,n){return!(!Cr(e,a,r)||r&&!Mo(e,a.ptab,n))}function dn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ct(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Fo(i);case"memo":return Ro(i);case"signal":{const o=qe(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const Ca={},Pn=(Ca==null?void 0:Ca.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Dn(){return new Date().toISOString().slice(0,10)}const cn=m.createContext(null);function zr(){return m.useContext(cn)}function rs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const f=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(c.setAttribute("href",f),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function In(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Ar(){const e=m.useContext(cn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function os({token:e,children:a}){const{dispatch:r,st:n,lang:i}=$(),[o,l]=m.useState(()=>n.filters.day||Dn()),[d,c]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(Dn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var S;const h=(S=y.detail)==null?void 0:S.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${Pn}/cibles/edition.json?${y}`).then(h=>h.json()).then(h=>{b||c(h)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const g=m.useMemo(()=>`${Pn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:d,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:g,isEn:i==="en"}),[e,o,d,f,x,u,n.filters.day,g,i]);return t.jsx(cn.Provider,{value:p,children:a})}function is(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Ar(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:In(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:In(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const ls=300,Jt=7,ds={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Tr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},cs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function za(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Bo(r)&&r!=="media")return"news:"+r;const n=qe(e);return n?"sig:"+(n.theme&&Tr.fr[n.theme]?n.theme:"other"):"actualites"}function ps(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=$(),c=zr(),f=l==="en",[s,x]=m.useState("all"),[u,g]=m.useState(!1),p=m.useMemo(()=>{var ge;const v=(a.filters.day||"").slice(0,10),q=G=>!(!o&&a.continent!=="monde"&&G.continent!==a.continent||v&&(G.date||"").slice(0,10)!==v),V=e.filter(G=>q(G)&&qe(G)&&(!o||G.kind!=="target"||Te(G)!==5)),B=o&&(((ge=c==null?void 0:c.ed)==null?void 0:ge.ops)||[]).length?c.ed.ops.map(G=>sa(G,l)).filter(G=>!!G).filter(G=>!v||(G.date||"").slice(0,10)===v):[],_=e.filter(G=>q(G)&&G.kind==="op"&&(v?!0:ct(G.date)<=Jt)),W=o?B.length?B:_.filter(G=>{const de=(d||"").trim().toLowerCase();if(!de)return!1;const ce=G.match||null;return ce?Object.keys(ce).map(je=>je.trim().toLowerCase()).includes(de):!1}):_,Q=v||new Date().toISOString().slice(0,10),K=G=>{const de=za(G);return de==="ma"?0:de==="levees"?1:2};W.sort((G,de)=>{const ce=K(G)-K(de);if(ce)return ce;const je=(G.date||"").slice(0,10)===Q?0:1,ve=(de.date||"").slice(0,10)===Q?0:1;return je!==ve?je-ve:(de.amountEur||0)-(G.amountEur||0)});const ie=new Set,ne=[];for(const G of[...W,...dn(V,{key:"signal",dir:-1})]){const de=G.id||G.name;!de||ie.has(de)||(ie.add(de),ne.push(G))}return o&&ne.length===0?e.filter(de=>q(de)&&ct(de.date)<=Jt).sort((de,ce)=>(ce.date||"").localeCompare(de.date||"")).slice(0,80):ne},[e,a.continent,a.filters.day,o,d,l,c]),b=m.useMemo(()=>{const v={};for(const q of p){const V=za(q);v[V]=(v[V]||0)+1}return v},[p]),y=m.useMemo(()=>s==="all"?p:p.filter(v=>za(v)===s),[p,s]),h=m.useMemo(()=>y.slice(0,ls),[y]),S=y.length-h.length,j=m.useRef(null);m.useEffect(()=>{var W,Q;const v=j.current;if(!v)return;const q=()=>{const K=v.scrollWidth;K<200||(v.style.animationDuration=Math.max(18,Math.round(K/130))+"s")};q();const V=requestAnimationFrame(q),B=window.setTimeout(q,1200);let _=!0;return(Q=(W=document.fonts)==null?void 0:W.ready)==null||Q.then(()=>{_&&q()}),()=>{_=!1,cancelAnimationFrame(V),window.clearTimeout(B)}},[h.length,s]);const w=v=>v==="all"?p.length:b[v]||0,C=v=>{if(v==="all")return f?"All":"Tout";if(v.startsWith("sig:"))return Tr[f?"en":"fr"][v.slice(4)]||"🔔";if(v.startsWith("news:")){const q=v.slice(5);return Do[q]?Io(q,f?"en":"fr"):v}return ds[f?"en":"fr"][v]},T=[{k:"all"}],A=["ma","levees"].filter(v=>w(v)>0||v===s);if(A.length){T.push({g:f?"Deals":"Opérations"});for(const v of A)T.push({k:v})}const L=["nominations","recrutements"].filter(v=>w(v)>0||v===s),z=Po.filter(v=>v!=="media").map(v=>"news:"+v).filter(v=>w(v)>0||v===s),N=w("actualites")>0||s==="actualites"?["actualites"]:[];if(L.length||z.length||N.length){T.push({g:f?"News":"Actualités"});for(const v of L)T.push({k:v});for(const v of z)T.push({k:v});for(const v of N)T.push({k:v})}const R=cs.map(v=>"sig:"+v).filter(v=>w(v)>0||v===s);if(R.length){T.push({g:f?"Signals (your engines)":"Signaux (vos moteurs)"});for(const v of R)T.push({k:v})}const I=v=>{try{return new Date(v+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return v}},M=(()=>{const v=(a.filters.day||"").slice(0,10),q=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return v?(f?`LIVE covers the events of ${I(v)}.`:`Le LIVE regroupe les événements du ${I(v)}.`)+q:(f?`LIVE covers the still-open signals and the deals of the last ${Jt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Jt} derniers jours.`)+q})(),F=v=>h.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Be(q)?" spent":""),onClick:V=>{if(n({type:"focus",id:q.id}),a.dens!=="liste"){const B=V.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:B.left+B.width/2,y:B.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(wt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(co,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Od(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(ka,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},v+(q.id||q.name))).concat(S>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${S} more — filter by section to see them`:`+ ${S} autres — filtrez par rubrique pour les voir`},v+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:v=>{v.currentTarget.contains(v.relatedTarget)||g(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>g(v=>!v),children:[C(s),t.jsx("b",{children:w(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:M}),T.map(v=>"g"in v?t.jsx("span",{className:"tkfilg",children:v.g},v.g):t.jsxs("button",{type:"button","aria-pressed":v.k===s,onClick:()=>{x(v.k),g(!1)},children:[C(v.k),t.jsx("b",{children:w(v.k)})]},v.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:j,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsx(ms,{isEn:f})]})}const us=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ms({isEn:e}){const[a,r]=m.useState(()=>$o());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(zn,i),()=>window.removeEventListener(zn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>_o(!a),children:us})}const pn="+33 6 83 10 72 86",ma="alexandre@proplace.co",Lr=`tel:${pn.replace(/[^\d+]/g,"")}`;function fs(){return null}class Pe extends m.Component{constructor(){super(...arguments);kn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Aa=600,ht=62,Bn="atl2:fstats";function xs(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=$(),[l,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Bn)==="on"}catch{return!1}}),c=r.stats,f=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=C=>a==="en"?C.slice(5,10):`${C.slice(8,10)}/${C.slice(5,7)}`,u=C=>C.toLocaleString(a==="en"?"en-US":"fr-FR"),g=f.reduce((C,T)=>Math.max(C,T.s||0),0),p=f.length?Aa/f.length:0,b=Math.max(4,p-4),y=f.length>=5&&g>0,h=r.marketEstimate||0,S=x(new Date().toISOString().slice(0,10)),j=C=>[...typeof C=="number"?[[C,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&s&&w.push({cle:"fenetre",periode:e.funPerWindow(x(s),S),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:j(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(C=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:C.periode}),C.etapes.map(([T,A],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(T)}),t.jsx("i",{children:A})]},C.cle+A)),C.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((c.screened||0)/h*100)))})]}),C.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!l;d(T),T&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Bn,T?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},C.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Aa} ${ht}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((C,T)=>{const A=(C.s||0)/g*(ht-4),L=(C.m||0)/g*(ht-4),z=T*p+(p-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(C.d)} — ${C.s} ${e.actScreened} · ${C.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:ht-2-A,width:b,height:A,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:ht-2-L,width:b,height:L,fill:"#185c38"})]},C.d)}),t.jsx("line",{x1:0,y1:ht-1.5,x2:Aa,y2:ht-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const qr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function hs(e,a){if((mt(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return qr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function gs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=$(),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){u(!0);return}s(b);const y=await i(e,b);s(""),y&&(c(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),u(!1)},children:[g||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]}):hs(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(g===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{p(b)},children:y},b))})]})}function bs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=$(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(mt(e)||"").startsWith("CALL")&&Te(e)===3,x=Te(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const b=await i(e,p);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},g=s?[["Validé",a.csYes],["Écarté",a.csNo]]:qr.filter(([p])=>!(x&&p==="Retenu")).map(([p,b])=>[p,a[b]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),g.map(([p,b])=>t.jsx("button",{type:"button",className:"csb"+(f===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:b},p)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(vs,{o:e})]})}function vs({o:e}){const{t:a,saveNote:r,flash:n}=$(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;d(!0);const u=await r(e,i.trim());d(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function ys({placeholder:e,onDone:a}){const{t:r}=$(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ws({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=$(),[c,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||Te(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",u=async h=>{if(c||h===x)return;f(!0);const S=s;l(e,{stage:h,stamps:(s==null?void 0:s.stamps)||{}});const j=Math.max(Date.now(),$n+=1);$n=j;const w=await Uo(r,{company:e.name||"",stage:h,cts:j,deal_id:e.airtableId,check_id:e.checkId});f(!1),!w.stale&&(w.ok||(l(e,S),d(a.actErr)))},g=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,p=g?Math.floor((Date.now()-Date.parse(g))/864e5):0,b=x==="sent"&&g&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,S])=>t.jsx("button",{type:"button",className:"stgb"+(x===h?" on":""),disabled:c,onClick:()=>{u(h)},children:S},h)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let $n=0;const Xt=8,Zt=360;function _n({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Un({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(_n,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(_n,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ks({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=$(),[l,d]=m.useState(0),[c,f]=m.useState(null),[s,x]=m.useState([]),u=m.useRef(!1),g=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const A=g.current;return()=>{p.current||(n({type:"ptab",tab:A.ptab}),n({type:"dens",dens:A.dens}),n({type:"modal",modal:A.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,x(e.filter(A=>!!document.querySelector(A.need||A.sel))))},[e]);const b=s[l],y=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const A=b.click,L=window.setTimeout(()=>{const z=document.querySelector(A);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(L)}},[l,b]);const h=m.useRef(-1),S=m.useCallback(()=>{if(!b){f(null);return}const A=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!A){f(null);return}h.current!==l&&(h.current=l,A.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=A.getBoundingClientRect();f(z=>z&&Math.abs(z.top-L.top)<1&&Math.abs(z.left-L.left)<1&&Math.abs(z.width-L.width)<1&&Math.abs(z.height-L.height)<1?z:L)},[b,l]);m.useLayoutEffect(()=>{S();const A=[90,300,700,1300].map(z=>window.setTimeout(S,z)),L=()=>S();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{A.forEach(z=>window.clearTimeout(z)),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[S]);const j=m.useRef(a);if(j.current=a,m.useEffect(()=>{const A=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),j.current()):L.key==="ArrowRight"?d(z=>z+1):L.key==="ArrowLeft"&&d(z=>Math.max(0,z-1))};return document.addEventListener("keydown",A,!0),()=>document.removeEventListener("keydown",A,!0)},[]),!s.length)return null;let w=null;const C=A=>()=>{p.current=!0,n({type:"modal",modal:null}),A()};if(y){const A=i[3]||0;A>0?w={title:A===1?r.ahaATitle1:r.ahaATitleN(A),body:r.ahaABody,btn:r.ahaABtn,go:C(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:C(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:C(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:C(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Zt};if(!y&&c){const A=c.bottom+14,z=window.innerHeight-A>190?A:Math.max(12,c.top-200);T={left:Math.min(Math.max(12,c.left+c.width/2-Zt/2),window.innerWidth-Zt-12),top:z,width:Zt}}return Tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Xt,top:c.top-Xt,width:c.width+Xt*2,height:c.height+Xt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:T,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(Un,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Un,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(A=>Math.max(0,A-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(A=>A+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Mr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Rr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function js(){var L,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=$(),f=r?a:e,s=m.useMemo(()=>f.filter(N=>ct(N.date)===0&&N.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(N=>N.kind==="target"&&Te(N)===0).slice().sort((N,R)=>(R.date||"").localeCompare(N.date||"")):[],[a,r]),u=m.useMemo(()=>s.filter(N=>r?Te(N)===0:!Be(N)),[s,r]),g=r?x:u,p=r?a.length-x.length:s.length-u.length,b=r?a.length:s.length,y=b?Math.min(100,p/b*100):100,h=m.useMemo(()=>Mr(f),[f]),S=!!h&&ct(h)>0,j=m.useMemo(()=>S?f.filter(N=>(N.date||"").slice(0,10)===h):[],[f,h,S]),w=typeof((L=d.stats)==null?void 0:L.kept_today)=="number"?d.stats.kept_today:null,C=typeof((z=d.stats)==null?void 0:z.screened_today)=="number"?d.stats.screened_today:s.length;let T;S?T=i.morningLast(j.length,x.length,Rr(h,l)):r?T=i.morningThesis(C,x.length,w):s.length?p===0?T=i.goalSourced(s.length):p>=s.length?T=i.goalCleared:T=i.goalDone(p,s.length):T=i.goalSourced(0);const A=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(N=>N.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),g.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:A,children:r?i.morningEval(g.length):o.pileMode?i.goalContinue(g.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ns(){var V,B;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:f,startTour:s,flash:x,flashErr:u}=$(),[g,p]=m.useState(null),[b,y]=m.useState(!0),[h,S]=m.useState([]),j=c==="client";m.useEffect(()=>{if(!i||!o)return;let _=!0;return y(!0),(async()=>{const[W,Q]=await Promise.all([on(o),kr(i)]);_&&(W&&p(W),y(!1),S(Q))})(),()=>{_=!1}},[i,o]);const[w,C]=m.useState(!1),T=()=>{!j||w||!o||(C(!0),Ho(o).then(_=>{C(!1),_?x(e.identRepubDone):u(e.actErr)}))},A=(g==null?void 0:g.per_day)??null,L=((V=g==null?void 0:g.pool_order)==null?void 0:V.length)??0,z=h.filter(_=>_.status==="running").length,N=m.useMemo(()=>d.filter(_=>_.kind==="target"&&Be(_)).length,[d]),R=l.marketEstimate,I=typeof((B=l.stats)==null?void 0:B.screened)=="number"?l.stats.screened:N,M=R&&R>0?Math.min(100,Math.round(I/R*100)):null,F=_=>_.toLocaleString(a==="en"?"en-US":"fr-FR"),v=(o||"P").split(/\s+/).map(_=>_[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const _=Date.parse(l.generatedAt||"");if(Number.isNaN(_))return"";const W=new Date(_),Q=K=>String(K).padStart(2,"0");return`${Q(W.getDate())}/${Q(W.getMonth()+1)} à ${Q(W.getHours())}:${Q(W.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?v:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[M===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:F(I)})})]}),M!==null&&R&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:M+"%"}})}),t.jsxs("b",{children:[M," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,R)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),A!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:A})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),A===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:_=>{_.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||w,onClick:T,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:_=>n({type:"filters",patch:{search:_.target.value}})})]})]})]})}function Ss(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=$(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const f=u=>{const g=c.current[u],p=g!==void 0?r[u]-g:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Fa[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},s=(u,g,p)=>t.jsxs("button",{type:"button",className:"off"+(g?" view":""),style:{"--c":`var(${Fa[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),x=(u,g,p,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:g,disabled:b,onClick:p,children:u},g);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Es(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=$(),d=m.useRef(null),[c,f]=m.useState(60);m.useEffect(()=>{let p=0;const b=()=>{var w;const y=d.current;if(!y)return;const h=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!h)return;const S=h.getBoundingClientRect(),j=y.getBoundingClientRect();f(Math.max(20,Math.min(S.left+S.width/2-j.left,j.width-30)))};return p=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const p=n.filter(h=>h.kind==="target"&&Te(h)===3),b=p.filter(h=>Oa(h)==="auto").length,y=p.filter(h=>Oa(h)==="cd").length;x=r.tutoPending(b,y,p.length)}const u=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(s===1){const p=n.filter(b=>b.kind==="target"&&Te(b)===1&&!i.has(b.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(b=>b.id)})}}return null})(),g=Vo(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(g?"":" on-dark"),style:{"--bg":`var(${Fa[s]})`,"--ax":c+"px","--stc":g?"var(--ink)":"#fff","--stt":g?"#fff":"var(--ink)","--tc":g?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class vt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Cs(e){for(const a of e)yield*a}function Fr(e){return Array.from(Cs(e))}var he=1e-6,le=Math.PI,Je=le/2,Hn=le/4,Ze=le*2,lt=180/le,Ue=le/180,ke=Math.abs,zs=Math.atan,$t=Math.atan2,Ce=Math.cos,ze=Math.sin,As=Math.sign||function(e){return e>0?1:e<0?-1:0},kt=Math.sqrt;function Ts(e){return e>1?0:e<-1?le:Math.acos(e)}function _t(e){return e>1?Je:e<-1?-Je:Math.asin(e)}function Xe(){}function fa(e,a){e&&Wn.hasOwnProperty(e.type)&&Wn[e.type](e,a)}var Vn={Feature:function(e,a){fa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)fa(r[n].geometry,a)}},Wn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){$a(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)$a(r[n],a,0)},Polygon:function(e,a){Yn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Yn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)fa(r[n],a)}};function $a(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Yn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)$a(e[r],a,1);a.polygonEnd()}function jt(e,a){e&&Vn.hasOwnProperty(e.type)?Vn[e.type](e,a):fa(e,a)}function _a(e){return[$t(e[1],e[0]),_t(e[2])]}function Ct(e){var a=e[0],r=e[1],n=Ce(r);return[n*Ce(a),n*ze(a),ze(r)]}function ea(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function xa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ta(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Ua(e){var a=kt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ha(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Va(e,a){return ke(e)>le&&(e-=Math.round(e/Ze)*Ze),[e,a]}Va.invert=Va;function Ls(e,a,r){return(e%=Ze)?a||r?Ha(Kn(e),Qn(a,r)):Kn(e):a||r?Qn(a,r):Va}function Gn(e){return function(a,r){return a+=e,ke(a)>le&&(a-=Math.round(a/Ze)*Ze),[a,r]}}function Kn(e){var a=Gn(e);return a.invert=Gn(-e),a}function Qn(e,a){var r=Ce(e),n=ze(e),i=Ce(a),o=ze(a);function l(d,c){var f=Ce(c),s=Ce(d)*f,x=ze(d)*f,u=ze(c),g=u*r+s*n;return[$t(x*i-g*o,s*r-u*n),_t(g*i+x*o)]}return l.invert=function(d,c){var f=Ce(c),s=Ce(d)*f,x=ze(d)*f,u=ze(c),g=u*i-x*o;return[$t(x*i+u*o,s*r+g*n),_t(g*r-s*n)]},l}function qs(e,a,r,n,i,o){if(r){var l=Ce(a),d=ze(a),c=n*r;i==null?(i=a+n*Ze,o=a-c/2):(i=Jn(l,i),o=Jn(l,o),(n>0?i<o:i>o)&&(i+=n*Ze));for(var f,s=i;n>0?s>o:s<o;s-=c)f=_a([l,-d*Ce(s),-d*ze(s)]),e.point(f[0],f[1])}}function Jn(e,a){a=Ct(a),a[0]-=e,Ua(a);var r=Ts(-a[1]);return((-a[2]<0?-r:r)+Ze-he)%Ze}function Or(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Xe,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function la(e,a){return ke(e[0]-a[0])<he&&ke(e[1]-a[1])<he}function aa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Pr(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(p){if(!((b=p.length-1)<=0)){var b,y=p[0],h=p[b],S;if(la(y,h)){if(!y[2]&&!h[2]){for(i.lineStart(),d=0;d<b;++d)i.point((y=p[d])[0],y[1]);i.lineEnd();return}h[0]+=2*he}o.push(S=new aa(y,p,null,!0)),l.push(S.o=new aa(y,null,S,!1)),o.push(S=new aa(h,p,null,!1)),l.push(S.o=new aa(h,null,S,!0))}}),!!o.length){for(l.sort(a),Xn(o),Xn(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var f=o[0],s,x;;){for(var u=f,g=!0;u.v;)if((u=u.n)===f)return;s=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(g)for(d=0,c=s.length;d<c;++d)i.point((x=s[d])[0],x[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(g)for(s=u.p.z,d=s.length-1;d>=0;--d)i.point((x=s[d])[0],x[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,s=u.z,g=!g}while(!u.v);i.lineEnd()}}}function Xn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function La(e){return ke(e[0])<=le?e[0]:As(e[0])*((ke(e[0])+le)%Ze-le)}function Ms(e,a){var r=La(a),n=a[1],i=ze(n),o=[ze(r),-Ce(r),0],l=0,d=0,c=new vt;i===1?n=Je+he:i===-1&&(n=-Je-he);for(var f=0,s=e.length;f<s;++f)if(u=(x=e[f]).length)for(var x,u,g=x[u-1],p=La(g),b=g[1]/2+Hn,y=ze(b),h=Ce(b),S=0;S<u;++S,p=w,y=T,h=A,g=j){var j=x[S],w=La(j),C=j[1]/2+Hn,T=ze(C),A=Ce(C),L=w-p,z=L>=0?1:-1,N=z*L,R=N>le,I=y*T;if(c.add($t(I*z*ze(N),h*A+I*Ce(N))),l+=R?L+z*Ze:L,R^p>=r^w>=r){var M=xa(Ct(g),Ct(j));Ua(M);var F=xa(o,M);Ua(F);var v=(R^L>=0?-1:1)*_t(F[2]);(n>v||n===v&&(M[0]||M[1]))&&(d+=R^L>=0?1:-1)}}return(l<-he||l<he&&c<-1e-12)^d&1}function Dr(e,a,r,n){return function(i){var o=a(i),l=Or(),d=a(l),c=!1,f,s,x,u={point:g,lineStart:b,lineEnd:y,polygonStart:function(){u.point=h,u.lineStart=S,u.lineEnd=j,s=[],f=[]},polygonEnd:function(){u.point=g,u.lineStart=b,u.lineEnd=y,s=Fr(s);var w=Ms(f,n);s.length?(c||(i.polygonStart(),c=!0),Pr(s,Fs,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function g(w,C){e(w,C)&&i.point(w,C)}function p(w,C){o.point(w,C)}function b(){u.point=p,o.lineStart()}function y(){u.point=g,o.lineEnd()}function h(w,C){x.push([w,C]),d.point(w,C)}function S(){d.lineStart(),x=[]}function j(){h(x[0][0],x[0][1]),d.lineEnd();var w=d.clean(),C=l.result(),T,A=C.length,L,z,N;if(x.pop(),f.push(x),x=null,!!A){if(w&1){if(z=C[0],(L=z.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),T=0;T<L;++T)i.point((N=z[T])[0],N[1]);i.lineEnd()}return}A>1&&w&2&&C.push(C.pop().concat(C.shift())),s.push(C.filter(Rs))}}return u}}function Rs(e){return e.length>1}function Fs(e,a){return((e=e.x)[0]<0?e[1]-Je-he:Je-e[1])-((a=a.x)[0]<0?a[1]-Je-he:Je-a[1])}const Zn=Dr(function(){return!0},Os,Ds,[-le,-Je]);function Os(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?le:-le,c=ke(o-a);ke(c-le)<he?(e.point(a,r=(r+l)/2>0?Je:-Je),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=le&&(ke(a-n)<he&&(a-=n*he),ke(o-d)<he&&(o-=d*he),r=Ps(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ps(e,a,r,n){var i,o,l=ze(e-r);return ke(l)>he?zs((ze(a)*(o=Ce(n))*ze(r)-ze(n)*(i=Ce(a))*ze(e))/(i*o*l)):(a+n)/2}function Ds(e,a,r,n){var i;if(e==null)i=r*Je,n.point(-le,i),n.point(0,i),n.point(le,i),n.point(le,0),n.point(le,-i),n.point(0,-i),n.point(-le,-i),n.point(-le,0),n.point(-le,i);else if(ke(e[0]-a[0])>he){var o=e[0]<a[0]?le:-le;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Is(e){var a=Ce(e),r=2*Ue,n=a>0,i=ke(a)>he;function o(s,x,u,g){qs(g,e,r,u,s,x)}function l(s,x){return Ce(s)*Ce(x)>a}function d(s){var x,u,g,p,b;return{lineStart:function(){p=g=!1,b=1},point:function(y,h){var S=[y,h],j,w=l(y,h),C=n?w?0:f(y,h):w?f(y+(y<0?le:-le),h):0;if(!x&&(p=g=w)&&s.lineStart(),w!==g&&(j=c(x,S),(!j||la(x,j)||la(S,j))&&(S[2]=1)),w!==g)b=0,w?(s.lineStart(),j=c(S,x),s.point(j[0],j[1])):(j=c(x,S),s.point(j[0],j[1],2),s.lineEnd()),x=j;else if(i&&x&&n^w){var T;!(C&u)&&(T=c(S,x,!0))&&(b=0,n?(s.lineStart(),s.point(T[0][0],T[0][1]),s.point(T[1][0],T[1][1]),s.lineEnd()):(s.point(T[1][0],T[1][1]),s.lineEnd(),s.lineStart(),s.point(T[0][0],T[0][1],3)))}w&&(!x||!la(x,S))&&s.point(S[0],S[1]),x=S,g=w,u=C},lineEnd:function(){g&&s.lineEnd(),x=null},clean:function(){return b|(p&&g)<<1}}}function c(s,x,u){var g=Ct(s),p=Ct(x),b=[1,0,0],y=xa(g,p),h=ea(y,y),S=y[0],j=h-S*S;if(!j)return!u&&s;var w=a*h/j,C=-a*S/j,T=xa(b,y),A=ta(b,w),L=ta(y,C);Ta(A,L);var z=T,N=ea(A,z),R=ea(z,z),I=N*N-R*(ea(A,A)-1);if(!(I<0)){var M=kt(I),F=ta(z,(-N-M)/R);if(Ta(F,A),F=_a(F),!u)return F;var v=s[0],q=x[0],V=s[1],B=x[1],_;q<v&&(_=v,v=q,q=_);var W=q-v,Q=ke(W-le)<he,K=Q||W<he;if(!Q&&B<V&&(_=V,V=B,B=_),K?Q?V+B>0^F[1]<(ke(F[0]-v)<he?V:B):V<=F[1]&&F[1]<=B:W>le^(v<=F[0]&&F[0]<=q)){var ie=ta(z,(-N+M)/R);return Ta(ie,A),[F,_a(ie)]}}}function f(s,x){var u=n?e:le-e,g=0;return s<-u?g|=1:s>u&&(g|=2),x<-u?g|=4:x>u&&(g|=8),g}return Dr(l,d,o,n?[0,-e]:[-le,e-le])}function Bs(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],f=a[1],s=0,x=1,u=c-l,g=f-d,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<s)return;p<x&&(x=p)}else if(u>0){if(p>x)return;p>s&&(s=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>x)return;p>s&&(s=p)}else if(u>0){if(p<s)return;p<x&&(x=p)}if(p=n-d,!(!g&&p>0)){if(p/=g,g<0){if(p<s)return;p<x&&(x=p)}else if(g>0){if(p>x)return;p>s&&(s=p)}if(p=o-d,!(!g&&p<0)){if(p/=g,g<0){if(p>x)return;p>s&&(s=p)}else if(g>0){if(p<s)return;p<x&&(x=p)}return s>0&&(e[0]=l+s*u,e[1]=d+s*g),x<1&&(a[0]=l+x*u,a[1]=d+x*g),!0}}}}}var Ft=1e9,na=-Ft;function $s(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,u){var g=0,p=0;if(f==null||(g=l(f,x))!==(p=l(s,x))||c(f,s)<0^x>0)do u.point(g===0||g===3?e:r,g>1?n:a);while((g=(g+x+4)%4)!==p);else u.point(s[0],s[1])}function l(f,s){return ke(f[0]-e)<he?s>0?0:3:ke(f[0]-r)<he?s>0?2:1:ke(f[1]-a)<he?s>0?1:0:s>0?3:2}function d(f,s){return c(f.x,s.x)}function c(f,s){var x=l(f,1),u=l(s,1);return x!==u?x-u:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=Or(),u,g,p,b,y,h,S,j,w,C,T,A={point:L,lineStart:I,lineEnd:M,polygonStart:N,polygonEnd:R};function L(v,q){i(v,q)&&s.point(v,q)}function z(){for(var v=0,q=0,V=g.length;q<V;++q)for(var B=g[q],_=1,W=B.length,Q=B[0],K,ie,ne=Q[0],ge=Q[1];_<W;++_)K=ne,ie=ge,Q=B[_],ne=Q[0],ge=Q[1],ie<=n?ge>n&&(ne-K)*(n-ie)>(ge-ie)*(e-K)&&++v:ge<=n&&(ne-K)*(n-ie)<(ge-ie)*(e-K)&&--v;return v}function N(){s=x,u=[],g=[],T=!0}function R(){var v=z(),q=T&&v,V=(u=Fr(u)).length;(q||V)&&(f.polygonStart(),q&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),V&&Pr(u,d,v,o,f),f.polygonEnd()),s=f,u=g=p=null}function I(){A.point=F,g&&g.push(p=[]),C=!0,w=!1,S=j=NaN}function M(){u&&(F(b,y),h&&w&&x.rejoin(),u.push(x.result())),A.point=L,w&&s.lineEnd()}function F(v,q){var V=i(v,q);if(g&&p.push([v,q]),C)b=v,y=q,h=V,C=!1,V&&(s.lineStart(),s.point(v,q));else if(V&&w)s.point(v,q);else{var B=[S=Math.max(na,Math.min(Ft,S)),j=Math.max(na,Math.min(Ft,j))],_=[v=Math.max(na,Math.min(Ft,v)),q=Math.max(na,Math.min(Ft,q))];Bs(B,_,e,a,r,n)?(w||(s.lineStart(),s.point(B[0],B[1])),s.point(_[0],_[1]),V||s.lineEnd(),T=!1):V&&(s.lineStart(),s.point(v,q),T=!1)}S=v,j=q,w=V}return A}}const Wa=e=>e;var qa=new vt,Ya=new vt,Ir,Br,Ga,Ka,dt={point:Xe,lineStart:Xe,lineEnd:Xe,polygonStart:function(){dt.lineStart=_s,dt.lineEnd=Hs},polygonEnd:function(){dt.lineStart=dt.lineEnd=dt.point=Xe,qa.add(ke(Ya)),Ya=new vt},result:function(){var e=qa/2;return qa=new vt,e}};function _s(){dt.point=Us}function Us(e,a){dt.point=$r,Ir=Ga=e,Br=Ka=a}function $r(e,a){Ya.add(Ka*e-Ga*a),Ga=e,Ka=a}function Hs(){$r(Ir,Br)}var zt=1/0,ha=zt,Ut=-zt,ga=Ut,ba={point:Vs,lineStart:Xe,lineEnd:Xe,polygonStart:Xe,polygonEnd:Xe,result:function(){var e=[[zt,ha],[Ut,ga]];return Ut=ga=-(ha=zt=1/0),e}};function Vs(e,a){e<zt&&(zt=e),e>Ut&&(Ut=e),a<ha&&(ha=a),a>ga&&(ga=a)}var Qa=0,Ja=0,Ot=0,va=0,ya=0,Nt=0,Xa=0,Za=0,Pt=0,_r,Ur,rt,ot,Qe={point:yt,lineStart:er,lineEnd:tr,polygonStart:function(){Qe.lineStart=Gs,Qe.lineEnd=Ks},polygonEnd:function(){Qe.point=yt,Qe.lineStart=er,Qe.lineEnd=tr},result:function(){var e=Pt?[Xa/Pt,Za/Pt]:Nt?[va/Nt,ya/Nt]:Ot?[Qa/Ot,Ja/Ot]:[NaN,NaN];return Qa=Ja=Ot=va=ya=Nt=Xa=Za=Pt=0,e}};function yt(e,a){Qa+=e,Ja+=a,++Ot}function er(){Qe.point=Ws}function Ws(e,a){Qe.point=Ys,yt(rt=e,ot=a)}function Ys(e,a){var r=e-rt,n=a-ot,i=kt(r*r+n*n);va+=i*(rt+e)/2,ya+=i*(ot+a)/2,Nt+=i,yt(rt=e,ot=a)}function tr(){Qe.point=yt}function Gs(){Qe.point=Qs}function Ks(){Hr(_r,Ur)}function Qs(e,a){Qe.point=Hr,yt(_r=rt=e,Ur=ot=a)}function Hr(e,a){var r=e-rt,n=a-ot,i=kt(r*r+n*n);va+=i*(rt+e)/2,ya+=i*(ot+a)/2,Nt+=i,i=ot*e-rt*a,Xa+=i*(rt+e),Za+=i*(ot+a),Pt+=i*3,yt(rt=e,ot=a)}function Vr(e){this._context=e}Vr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Ze);break}}},result:Xe};var en=new vt,Ma,Wr,Yr,Dt,It,Ht={point:Xe,lineStart:function(){Ht.point=Js},lineEnd:function(){Ma&&Gr(Wr,Yr),Ht.point=Xe},polygonStart:function(){Ma=!0},polygonEnd:function(){Ma=null},result:function(){var e=+en;return en=new vt,e}};function Js(e,a){Ht.point=Gr,Wr=Dt=e,Yr=It=a}function Gr(e,a){Dt-=e,It-=a,en.add(kt(Dt*Dt+It*It)),Dt=e,It=a}let ar,wa,nr,rr;class or{constructor(a){this._append=a==null?Kr:Xs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==nr||this._append!==wa){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,nr=n,wa=this._append,rr=this._,this._=i}this._+=rr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Kr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Xs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Kr;if(a!==ar){const r=10**a;ar=a,wa=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return wa}function Zs(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),jt(d,i(o))),o.result()}return l.area=function(d){return jt(d,i(dt)),dt.result()},l.measure=function(d){return jt(d,i(Ht)),Ht.result()},l.bounds=function(d){return jt(d,i(ba)),ba.result()},l.centroid=function(d){return jt(d,i(Qe)),Qe.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,Wa):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new or(r)):new Vr(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new or(r)),l},l.projection(e).digits(r).context(a)}function un(e){return function(a){var r=new tn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function tn(){}tn.prototype={constructor:tn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function mn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),jt(r,e.stream(ba)),a(ba.result()),n!=null&&e.clipExtent(n),e}function Qr(e,a,r){return mn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function el(e,a,r){return Qr(e,[[0,0],a],r)}function tl(e,a,r){return mn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function al(e,a,r){return mn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var ir=16,nl=Ce(30*Ue);function sr(e,a){return+a?ol(e,a):rl(e)}function rl(e){return un({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ol(e,a){function r(n,i,o,l,d,c,f,s,x,u,g,p,b,y){var h=f-n,S=s-i,j=h*h+S*S;if(j>4*a&&b--){var w=l+u,C=d+g,T=c+p,A=kt(w*w+C*C+T*T),L=_t(T/=A),z=ke(ke(T)-1)<he||ke(o-x)<he?(o+x)/2:$t(C,w),N=e(z,L),R=N[0],I=N[1],M=R-n,F=I-i,v=S*M-h*F;(v*v/j>a||ke((h*M+S*F)/j-.5)>.3||l*u+d*g+c*p<nl)&&(r(n,i,o,l,d,c,R,I,z,w/=A,C/=A,T,b,y),y.point(R,I),r(R,I,z,w,C,T,f,s,x,u,g,p,b,y))}}return function(n){var i,o,l,d,c,f,s,x,u,g,p,b,y={point:h,lineStart:S,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=C},polygonEnd:function(){n.polygonEnd(),y.lineStart=S}};function h(L,z){L=e(L,z),n.point(L[0],L[1])}function S(){x=NaN,y.point=j,n.lineStart()}function j(L,z){var N=Ct([L,z]),R=e(L,z);r(x,u,s,g,p,b,x=R[0],u=R[1],s=L,g=N[0],p=N[1],b=N[2],ir,n),n.point(x,u)}function w(){y.point=h,n.lineEnd()}function C(){S(),y.point=T,y.lineEnd=A}function T(L,z){j(i=L,z),o=x,l=u,d=g,c=p,f=b,y.point=j}function A(){r(x,u,s,g,p,b,o,l,i,d,c,f,ir,n),y.lineEnd=w,w()}return y}}var il=un({point:function(e,a){this.stream.point(e*Ue,a*Ue)}});function sl(e){return un({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ll(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function lr(e,a,r,n,i,o){if(!o)return ll(e,a,r,n,i);var l=Ce(o),d=ze(o),c=l*e,f=d*e,s=l/e,x=d/e,u=(d*r-l*a)/e,g=(d*a+l*r)/e;function p(b,y){return b*=n,y*=i,[c*b-f*y+a,r-f*b-c*y]}return p.invert=function(b,y){return[n*(s*b-x*y+u),i*(g-x*b-s*y)]},p}function dl(e){return cl(function(){return e})()}function cl(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,f=0,s,x=0,u=1,g=1,p=null,b=Zn,y=null,h,S,j,w=Wa,C=.5,T,A,L,z,N;function R(v){return L(v[0]*Ue,v[1]*Ue)}function I(v){return v=L.invert(v[0],v[1]),v&&[v[0]*lt,v[1]*lt]}R.stream=function(v){return z&&N===v?z:z=il(sl(s)(b(T(w(N=v)))))},R.preclip=function(v){return arguments.length?(b=v,p=void 0,F()):b},R.postclip=function(v){return arguments.length?(w=v,y=h=S=j=null,F()):w},R.clipAngle=function(v){return arguments.length?(b=+v?Is(p=v*Ue):(p=null,Zn),F()):p*lt},R.clipExtent=function(v){return arguments.length?(w=v==null?(y=h=S=j=null,Wa):$s(y=+v[0][0],h=+v[0][1],S=+v[1][0],j=+v[1][1]),F()):y==null?null:[[y,h],[S,j]]},R.scale=function(v){return arguments.length?(r=+v,M()):r},R.translate=function(v){return arguments.length?(n=+v[0],i=+v[1],M()):[n,i]},R.center=function(v){return arguments.length?(o=v[0]%360*Ue,l=v[1]%360*Ue,M()):[o*lt,l*lt]},R.rotate=function(v){return arguments.length?(d=v[0]%360*Ue,c=v[1]%360*Ue,f=v.length>2?v[2]%360*Ue:0,M()):[d*lt,c*lt,f*lt]},R.angle=function(v){return arguments.length?(x=v%360*Ue,M()):x*lt},R.reflectX=function(v){return arguments.length?(u=v?-1:1,M()):u<0},R.reflectY=function(v){return arguments.length?(g=v?-1:1,M()):g<0},R.precision=function(v){return arguments.length?(T=sr(A,C=v*v),F()):kt(C)},R.fitExtent=function(v,q){return Qr(R,v,q)},R.fitSize=function(v,q){return el(R,v,q)},R.fitWidth=function(v,q){return tl(R,v,q)},R.fitHeight=function(v,q){return al(R,v,q)};function M(){var v=lr(r,0,0,u,g,x).apply(null,a(o,l)),q=lr(r,n-v[0],i-v[1],u,g,x);return s=Ls(d,c,f),A=Ha(a,q),L=Ha(s,A),T=sr(A,C),F()}function F(){return z=N=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&I,M()}}function Jr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Jr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ke(i)>he&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function pl(){return dl(Jr).scale(175.295)}function ul(e){return e}function ml(e){if(e==null)return ul;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var f=2,s=d.length,x=new Array(s);for(x[0]=(a+=d[0])*n+o,x[1]=(r+=d[1])*i+l;f<s;)x[f]=d[f],++f;return x}}function fl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function xl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return dr(e,r)})}:dr(e,a)}function dr(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=hl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function hl(e,a){var r=ml(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var u=n[s<0?~s:s],g=0,p=u.length;g<p;++g)x.push(r(u[g],g));s<0&&fl(x,p)}function o(s){return r(s)}function l(s){for(var x=[],u=0,g=s.length;u<g;++u)i(s[u],x);return x.length<2&&x.push(x[0]),x}function d(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function c(s){return s.map(d)}function f(s){var x=s.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":u=o(s.coordinates);break;case"MultiPoint":u=s.coordinates.map(o);break;case"LineString":u=l(s.arcs);break;case"MultiLineString":u=s.arcs.map(l);break;case"Polygon":u=c(s.arcs);break;case"MultiPolygon":u=s.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return f(a)}const Xr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},gl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function bl(e,a,r){const n=Xr[e];if(!n||!n.length)return-1;const i=gl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let ra=null;function vl(){return ra||(ra=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=xl(r,n),o=pl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Zs(o),d=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var g;const x=((g=s.properties)==null?void 0:g.name)||"",u=l(s)||"";return u?{i2:Wo(x)||null,n:x,d:u}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,x]of Object.entries(Yo)){const u=o(x);u&&(c[s]={x:u[0],y:u[1]})}const f={};for(const[s,x]of Object.entries(Xr)){const u=x.map(g=>o(g.ll)).filter(g=>!!g).map(([g,p])=>({x:g,y:p}));u.length&&(f[s]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:d,anchors:c,metros:f}}catch{return null}})(),ra)}function yl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return vl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const wl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},cr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function pr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function kl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const c=(f=e.current)==null?void 0:f.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function ur({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function jl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:f,dossiers:s,source:x}=$(),u=f.loading&&!s.length,g=m.useRef(null),p=m.useRef(null),b=yl(e.continent==="monde"),y=e.continent==="monde"?b:sn.find(v=>v.key===e.continent)||null,h=kl(g,e.continent+":"+e.mapFolded+":"+!!y),[S,j]=m.useState(new Map),[w,C]=m.useState(null);m.useEffect(()=>{const v=g.current;if(!v)return;const q=new Map;v.querySelectorAll("path[data-i2]").forEach(V=>{const B=V.dataset.i2;if(B)try{const _=V.getBBox();_.width>0&&q.set(B,{x:_.x,y:_.y,w:_.width,h:_.height})}catch{}}),j(q)},[e.continent,h,y]);const T=m.useMemo(()=>r.filter(v=>v.cc),[r]),A=m.useMemo(()=>{const v=new Map;return T.forEach(q=>v.set(q.cc,(v.get(q.cc)||0)+1)),v},[T]),L=e.continent==="monde"&&b?b.anchors:null,z=e.continent==="monde"&&b?b.metros:null,N=m.useMemo(()=>T.map(v=>{const q=pr(v.name||v.id||""),V=pr((v.id||v.name||"")+"·y");if(L&&v.cc){const K=z?z[v.cc]:void 0;if(K&&K.length){const ne=bl(v.cc,v.city,q);if(ne>=0&&K[ne])return{d:v,x:K[ne].x+(q-.5)*5,y:K[ne].y+(V-.5)*5}}const ie=L[v.cc];if(ie)return{d:v,x:ie.x+(q-.5)*10,y:ie.y+(V-.5)*10}}const B=v.cc?S.get(v.cc):void 0;if(!B)return null;const _=wl[`${e.continent}:${v.cc||""}`];if(_)return{d:v,x:B.x+B.w*(_.fx+(q-.5)*_.sx),y:B.y+B.h*(_.fy+(V-.5)*_.sy)};const W=(q-.5)*Math.min(B.w*.55,60),Q=(V-.5)*Math.min(B.h*.55,60);return{d:v,x:B.x+B.w/2+W,y:B.y+B.h/2+Q}}).filter(v=>!!v),[T,S,L,z,e.continent]),R=v=>h>0?v/h:v,I=m.useMemo(()=>n?[0,1,2,3,4,5].map(v=>({c:cr[v],fr:c.plabels[v].toUpperCase(),en:c.plabels[v].toUpperCase(),n:r.filter(q=>q.kind==="target"&&Te(q)===v).length})).filter(v=>v.n>0):An.map((v,q)=>({...v,n:r.filter(V=>Tn(V)===q).length})),[r,n,c.plabels]),M=o?l.get(o):null,F=M?N.find(v=>v.d.id===M.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(ur,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:g,viewBox:y.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{C(null),i(null)},children:[t.jsx("g",{children:y.countries.map((v,q)=>t.jsx("g",{className:"ct"+(v.i2&&A.get(v.i2)?"":" empty"),children:t.jsx("path",{d:v.d,"data-i2":v.i2||void 0})},q))}),t.jsx("g",{children:N.map(v=>{const q=An[Tn(v.d)],V=!!qe(v.d),B=v.d.kind==="target",_=n&&B?cr[Te(v.d)]:q.c,W=!n&&Be(v.d);return t.jsxs("g",{className:"co"+(W?" done":""),onMouseEnter:()=>{var ie,ne;const Q=(ie=p.current)==null?void 0:ie.getBoundingClientRect(),K=(ne=g.current)==null?void 0:ne.createSVGPoint();if(K&&g.current&&Q){K.x=v.x,K.y=v.y;const ge=K.matrixTransform(g.current.getScreenCTM());C({x:ge.x-Q.left,y:ge.y-Q.top,label:v.d.name+" · "+(Lt(v.d.cc,d)||v.d.countryLabel||"")})}i(v.d.id)},onMouseLeave:()=>{C(null),i(null)},onClick:()=>{var ie;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:v.d.id}),(v.d.noCo||["media","nominations","recrutements"].includes(v.d.engine||""))&&(v.d.url||v.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:v.d.url||"",text:[v.d.headline,v.d.tagline].filter(Boolean).join(`
`)}})):v.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:v.d.name}}));return}const Q=(ie=g.current)==null?void 0:ie.createSVGPoint();let K=null;if(Q&&g.current){Q.x=v.x,Q.y=v.y;const ne=Q.matrixTransform(g.current.getScreenCTM());K={x:ne.x,y:ne.y}}a({type:"popup",id:v.d.id,anchor:K})},children:[t.jsx("circle",{className:"h",cx:v.x,cy:v.y,r:R(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:v.x,cy:v.y,r:R(q.px),fill:_,stroke:V?"#DC2626":"#ffffff",strokeWidth:R(V?2.2:1.3)})]},v.d.id||v.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:R(13),fill:"none",stroke:"#0F172A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:I.map((v,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":v.c}}),d==="fr"?v.fr:v.en," ",t.jsx("b",{children:v.n})]},q))}),r.some(v=>!v.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(v=>!v.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(ur,{msgs:c.loadMsgs})})}function Nl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Zr({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=$(),c=a.filters,[f,s]=m.useState(!1),[x,u]=m.useState(!1),g=m.useRef(null),p=m.useRef(null),b=m.useMemo(()=>a.continent==="monde"?n:n.filter(M=>M.continent===a.continent),[n,a.continent]),y=M=>b.filter(F=>M!=="country"&&c.country.length&&!c.country.includes(F.cc||"")?!1:ua(F,c,o,M==="country"?void 0:M)),h=m.useMemo(()=>{const M=y("win"),F=v=>M.filter(q=>(q.date?Math.max(0,Math.floor((Date.now()-Date.parse(q.date))/864e5)):9999)<=v).length;return[F(0),F(7),F(30),M.length]},[b,c,o]),S=m.useMemo(()=>c.day?y("win").filter(M=>(M.date||"").slice(0,10)===c.day).length:0,[b,c,o]),j=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,w=j+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f&&!x)return;const M=v=>{var V,B;const q=v.target;f&&!((V=g.current)!=null&&V.contains(q))&&s(!1),x&&!((B=p.current)!=null&&B.contains(q))&&u(!1)},F=v=>{v.key==="Escape"&&(s(!1),u(!1))};return document.addEventListener("mousedown",M),document.addEventListener("keydown",F),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("keydown",F)}},[f,x]);const C=(M,F,v,q="fbtn")=>t.jsxs("button",{type:"button",className:q,"aria-expanded":a.openFacet===M,onClick:()=>r({type:"openFacet",facet:M}),children:[t.jsx("span",{className:"fl",children:F}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},M),T=["1","7","30","all"],A=Math.max(0,T.indexOf(c.win||"all")),L=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(Nl(c.day,d))}),t.jsx("b",{children:S})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:p,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(M=>!M),children:[t.jsx("span",{className:"winpick-k",children:i.winMenu}),t.jsx("span",{className:"winpick-v",children:i.datesShort[A]}),t.jsx("b",{children:h[A]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:T.map((M,F)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===M,onClick:()=>{r({type:"filters",patch:{win:M}}),u(!1)},children:[i.datesShort[F],t.jsx("span",{className:"n",children:h[F]})]},M))})]}):t.jsx("div",{className:"seg",children:T.map((M,F)=>t.jsxs("button",{type:"button","aria-pressed":c.win===M,onClick:()=>r({type:"filters",patch:{win:M}}),children:[t.jsx("span",{className:"sl",children:i.dates[F]}),t.jsx("b",{children:h[F]})]},M))}),z=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:M=>r({type:"filters",patch:{search:M.target.value}})})]}),N=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):C("sec",i.fSector,c.sector.length),C("pay",i.fCountry,c.country.length),C("det",i.fEngine,c.engine.length),C("sta",i.fStage,c.stage.length),o&&C("ang","Angle",c.angle.length),o&&C("mem","Mémo",c.memoLevel.length)]}),R=(M=!1)=>t.jsxs("div",{className:"frow2",children:[w>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(b.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(w)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),M&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),I=t.jsxs("div",{className:"fmenu",ref:g,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(j?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(M=>!M),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),j>0&&t.jsx("span",{className:"n",children:j}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:N})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[!c.day&&t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[z,I,R(a.mapFolded)]})]}),a.openFacet&&t.jsx(mr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,z,N,t.jsx("span",{className:"fgrow"}),R()]}),a.openFacet&&t.jsx(mr,{poolFor:y})]})}function mr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:f}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(h=>qe(h)),b=new Map;p.forEach(h=>{const S=h.engine||"";b.set(S,(b.get(S)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Pa([...b.keys()],i).map(h=>({v:h,label:bt(h)+" "+He(h,i),n:b.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const p=e("sector"),b=new Map;return p.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y,n:h,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const p=e("country"),b=new Map;return p.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:Lt(y,i)||y,n:h,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const p=e("engine"),b=new Map;return p.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Pa([...b.keys()],i).map(y=>({v:y,label:bt(y)+" "+He(y,i)+' <span style="color:var(--dim);font-size:10px">· '+Go(Ko(y),i)+"</span>",n:b.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const p=e("angle"),b=new Map;return p.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const p=e("memoLevel"),b=new Map;p.forEach(h=>{if(h.kind==="target"){const S=rn(h);b.set(S,(b.get(S)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:y[h],n:b.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),g=new Map;return u.forEach(p=>{p.stage&&g.set(p.stage,(g.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...g.entries()].sort((p,b)=>b[1]-p[1]).map(([p,b])=>({v:p,label:p,n:b,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),s=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>s(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function eo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=$(),c=m.useMemo(()=>{const g={};return r.forEach(p=>{ua(p,n.filters,o)&&(g.monde=(g.monde||0)+1,p.continent&&(g[p.continent]=(g[p.continent]||0)+1))}),g},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const g=b=>{var y;(y=x.current)!=null&&y.contains(b.target)||s(!1)},p=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",g),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",g),document.removeEventListener("keydown",p)}},[f]);const u=g=>{const p=sn.find(b=>b.key===g);return g==="monde"?d.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(g=>!g),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Ln.map(g=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===g,onClick:()=>{i({type:"continent",key:g}),s(!1)},children:[u(g),t.jsx("span",{className:"n",children:c[g]||0})]},g))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Ln.map(g=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===g,onClick:()=>i({type:"continent",key:g}),children:[u(g),t.jsx("span",{className:"n",children:c[g]||0})]},g)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function to(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Sl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function fr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=$();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function ao({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=$(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(fr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(fr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function El({card:e,onEvaluate:a,onAddAll:r}){var d,c,f;const{t:n}=$(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:to(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(ao,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Cl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function zl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=$(),d=i,[c,f]=m.useState(null),[s,x]=m.useState(null),[u,g]=m.useState(null),[p,b]=m.useState(!1);m.useEffect(()=>{let h=!0;return(async()=>{const S=await jr({email:l,cbToken:d});h&&f(S)})(),()=>{h=!1}},[l,d,n]);const y=h=>{x(h),g(null),b(!0),(async()=>{const S=await Qo(h.id);g(S),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),g(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[Cl(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(El,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Ra=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function oa(e){return/^https?:\/\//i.test((e||"").trim())}function Al(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:f,data:s,canWrite:x,source:u,dossiers:g,doAnalyse:p,liveMemos:b,pipe:y}=$(),h=a==="client",S=m.useMemo(()=>r||(u!=="default"?Jo():""),[r,u]),[j,w]=m.useState(""),[C,T]=m.useState(!1),[A,L]=m.useState(""),[z,N]=m.useState(!1),[R,I]=m.useState(""),[M,F]=m.useState(!1),[v,q]=m.useState(""),[V,B]=m.useState([]),_=m.useRef(!1),[W,Q]=m.useState(!1),[K,ie]=m.useState(""),[ne,ge]=m.useState(""),[G,de]=m.useState(!1),[ce,je]=m.useState(!1),[ve,ee]=m.useState(0),[Z,J]=m.useState(""),[H,xe]=m.useState(null),[te,pe]=m.useState(null),[ue,me]=m.useState(!1),[Re,Ve]=m.useState(null),[Ae,Fe]=m.useState(0),We=m.useRef(!1),it=j.trim()?Ra.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting,Me=m.useMemo(()=>R.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[R]);m.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),ae=(O.get("rs")||"").trim(),re=(O.get("rstext")||"").trim();ae&&/^https?:\/\//i.test(ae)&&ie(ae),re&&ge(re),(ae&&/^https?:\/\//i.test(ae)||re)&&Q(!0)},[]),m.useEffect(()=>{const O=ae=>{const re=ae.detail||{},fe=String(re.url||"").trim(),Ye=String(re.text||"").trim();fe&&/^https?:\/\//i.test(fe)&&ie(fe),Ye&&ge(Ye),(fe&&/^https?:\/\//i.test(fe)||Ye)&&(Q(!0),w(""),L(""),de(!0),window.setTimeout(()=>de(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),m.useEffect(()=>{const O=ae=>{const re=ae.detail||{},fe=String(re.name||"").trim();fe&&(Q(!1),w(fe),L(fe),T(!0),window.setTimeout(()=>T(!1),900))};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),m.useEffect(()=>{const O=ae=>{var fe;const re=String(((fe=ae.detail)==null?void 0:fe.url)||"").trim();oa(re)&&window.open(re,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",O),()=>window.removeEventListener("ppmap:view",O)},[]),m.useEffect(()=>{if(typeof window>"u"||u!=="ops")return;const O=document.querySelector(".atl2.ops .eval-stick")||document.querySelector(".atl2.ops .demand"),ae=document.querySelector(".atl2.ops");if(!O||!ae)return;const re=()=>ae.style.setProperty("--demand-h",`${O.offsetHeight}px`);re();const fe=new ResizeObserver(re);return fe.observe(O),()=>fe.disconnect()},[u,C,G,z,W]),m.useEffect(()=>{if(!x&&!S){Ve(null);return}let O=!0;return(async()=>{const ae=await jr({email:n,cbToken:S});O&&Ve(ae.length)})(),()=>{O=!1}},[x,S,n,Ae]);const ft=V.length?V:c,Oe=s.credits,tt=m.useCallback(O=>{const ae=O.map(re=>(re||"").trim()).filter(Boolean);ae.length&&(I(re=>{const fe=re.split(`
`).map(Se=>Se.trim()).filter(Boolean),Ye=new Set(fe.map(Se=>Se.toLowerCase())),Ie=ae.filter(Se=>!Ye.has(Se.toLowerCase()));return[...fe,...Ie].slice(0,15).join(`
`)}),N(!0))},[]);m.useEffect(()=>{if(!ce)return;ee(0);const O=window.setInterval(()=>ee(ae=>ae+1),1e3);return()=>window.clearInterval(O)},[ce]);const st=m.useMemo(()=>{const O=j.trim().toLowerCase();return!O||!y?null:g.find(ae=>Ke(ae.name)===O&&Te(ae)===1)||null},[j,g,y]),E=()=>{const O=j.trim();if(O){if(st){p(st);return}i(null,O),h&&w("")}},D=async()=>{if(!h){i(null,Me[0]||"");return}if(!Me.length||M)return;F(!0),_.current=!1;const O=[];for(let ae=0;ae<Me.length&&!_.current;ae++){q(e.evaluating(ae+1,Me.length,Me[ae]));const re=await Nr(r,Me[ae],"atelier2");if(O.unshift({name:re.company||Me[ae],verdict:re.verdict,reason:re.reason||"",remaining:re.remaining??null}),B([...O]),re.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(Me.length-ae-1),remaining:0}),B([...O]),I(Me.slice(ae+1).join(`
`)),q(""),F(!1);return}}q(""),I(_.current?Me.slice(O.length).join(`
`):""),F(!1)},Y=async()=>{var re,fe,Ye;if(We.current)return;const O=K.trim().replace(/\s+/g,""),ae=ne.trim();if(!O&&!ae){J(e.rsNeed);return}if(!h&&!S){i(null,O||ae.slice(0,80));return}We.current=!0,J(""),xe(null),pe(null),je(!0);try{const Ie=await Zo({url:O,text:ae,email:n,cbToken:S});if(je(!1),!Ie||Ie.status!=="success"){J((Ie==null?void 0:Ie.message)||"Erreur");return}xe(Ie),Q(!1),tt((((re=Ie.prospective)==null?void 0:re.companies_to_evaluate)||[]).map(Ge=>(Ge==null?void 0:Ge.name)||"")),pe({state:"pending"});const Se=await ei(Ie,{email:n,cbToken:S});pe(Se.ok?{state:"ok",scopeLabel:((fe=Se.summary)==null?void 0:fe.scope_label)||"",scope:((Ye=Se.summary)==null?void 0:Ye.scope)||""}:{state:"fail",msg:Se.error||""}),Se.ok&&Fe(Ge=>Ge+1)}finally{We.current=!1,je(!1)}},oe=[H==null?void 0:H.industry,...(H==null?void 0:H.market_tags)||[],H==null?void 0:H.author].map(O=>(O||"").trim()).filter(Boolean),Ee=(te==null?void 0:te.state)==="pending",ye=te&&(Ee?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):te.state==="ok"?t.jsx("span",{className:"rslink ok",children:te.scope&&te.scope!=="public"?e.rsSavedIn(te.scopeLabel||te.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:te.msg,children:e.rsSaveFail})),_e=Sl(H).length,Ne=W,at=(A||j).trim(),pt=st?e.actAnalyse:at?e.evalGoOn(at.length>22?at.slice(0,21)+"…":at):e.evalGo,Mt=ce?`${Xo(K.trim())==="youtube"&&K.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ve)}`:Ee?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ne?" rs-mode":"")+(A&&j.trim()===A||C||G?" pair":"")+(C||G?" echo":""),children:[t.jsxs("div",{className:"drow"+((Ne?G:C)?" flash":"")+((Ne?K.trim():Ra.test(j.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ne?K:j,placeholder:Ne?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ne?600:200,spellCheck:Ne?!1:void 0,inputMode:Ne?"url":void 0,onChange:O=>{if(Ne){ie(O.target.value);return}w(O.target.value),A&&O.target.value.trim()!==A&&L("")},onKeyDown:O=>{O.key==="Enter"&&(Ne?Y():E())}}),!Ne&&t.jsx("span",{className:"detect"+(Ra.test(j.trim())?" url":""),children:it})]}),Ne?t.jsxs(t.Fragment,{children:[t.jsx("a",{className:"viewbtn"+(oa(K)?"":" off"),href:oa(K)?K.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:O=>{oa(K)||O.preventDefault()},children:e.viewLink}),t.jsxs("button",{type:"button",className:"evalbtn"+(ce?" loading":""),disabled:ce||Ee||!K.trim()&&!ne.trim(),onClick:()=>{Y()},children:[t.jsx("span",{className:"fill"}),Mt]})]}):t.jsxs("button",{type:"button",className:"evalbtn"+(st?" analyse":"")+(d?" loading":""),disabled:d,onClick:E,children:[t.jsx("span",{className:"fill"}),pt]}),f.showCredits&&Oe&&t.jsxs("button",{type:"button",className:"credits"+(Oe.total_available<=0&&!Oe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Oe.unlimited?"∞":Oe.total_available}),!Oe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Oe.daily_grant+Oe.purchased]}),Oe.total_available<=0&&!Oe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(O=>O.status==="boot"||O.status==="running").map(O=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:O.name}),t.jsx(Bt,{item:O,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+O.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>N(!z),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(W?" on":""),onClick:()=>Q(!W),children:e.rsOpen}),Re!==null&&Re>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ue?" on":""),onClick:()=>me(!ue),children:e.rsArchOpen(Re)})]}),ue&&t.jsx(zl,{bump:Ae,cbToken:S,onClose:()=>me(!1),onEvaluate:O=>i(null,O),onAddAll:tt}),W&&t.jsxs("div",{className:"rsp on slim",children:[t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:ne,placeholder:e.rsTextPh,onChange:O=>ge(O.target.value)})]}),Z&&t.jsx("div",{className:"rserr",children:Z}),H&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:H.title}),H.source_url&&t.jsx("a",{href:H.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{xe(null),pe(null)},children:"×"})]}),H.market&&t.jsx("p",{className:"rsmk",children:H.market}),oe.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),oe.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[H.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${H.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:to(H.summary_md||"").map((O,ae)=>t.jsx("p",{children:O},ae))})]}),t.jsx(ao,{card:H,onEvaluate:O=>i(null,O),onAddAll:tt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(_e)}),ye]})]}),z&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:R,placeholder:e.bulkPh,onChange:O=>I(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(M?" loading":""),style:{justifyContent:"center"},disabled:M||!Me.length,onClick:()=>{D()},children:[t.jsx("span",{className:"fill"}),M&&v?v:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(Me.length)})]})]}),ft.slice(0,1).map((O,ae)=>{const re=O.verdict==="kept",fe=O.verdict==="quota",Ye=re?"var(--brand)":fe?"var(--bolt)":"var(--red)",Ie=re?"var(--brand-l)":fe?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ye,"--bgc":Ie},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:re?"✓ "+e.kept:fe?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map(Se=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Se.url.startsWith("http")?Se.url:`https://${Se.url}`,target:"_blank",rel:"nofollow noopener",children:[(Se.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Se.url),children:e.evalPickGo})]},Se.url))}),!fe&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:re?1:5});const Se=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ge=[...document.querySelectorAll(".atl2 .list .row")].find(ja=>{var Gt;return(((Gt=ja.querySelector(".rnm"))==null?void 0:Gt.textContent)||"").trim().toLowerCase().includes(Se)});Ge&&(Ge.scrollIntoView({behavior:"smooth",block:"center"}),Ge.classList.add("flashrow"),window.setTimeout(()=>Ge.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(re?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),h&&(o.kept+o.dropped>0||ft.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Tl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ll(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=$(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",Tl(o.summary||"")].filter(Boolean).join(`
...
`;function Dl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let d=e.y+10;return d+n>o-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function Il(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:f,doPromote:s,doRepeche:x,doApproach:u,doDeep:g,doOnboard:p,outbound:b,evalBusy:y}=$(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const S=qe(h),j=Te(h),w=mt(h),C=Wt(h),T=h.kind==="target",A=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Tt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Pl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Dl(e.popupAnchor,!!h.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ct(h.date)),He(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[h.cc]}),children:(Lt(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:qt(h.amountEur,i)})]}),o.pipe&&T&&t.jsxs("div",{className:"pstat",children:[C&&t.jsx("span",{className:"vd "+(C==="MATCH"?"v-ok":"v-no"),title:n.vt[C],children:C}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[bt(h.engine)," ",t.jsx("b",{children:He(h.engine,i)})," — ",ni(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),S?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:h,lg:!0})," ",t.jsx(ka,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(ln(S,i))," · ",n.win7(ca(S,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(Yt,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&T&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&T&&t.jsx(xn,{o:h})]}),t.jsx(fn,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(h,!1),a({type:"popup",id:null})},children:n.actNo}),Et(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{g(h),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(h.name),onClick:()=>d(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const Bl=8;function $l(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=$(),[d,c]=m.useState(!1),[f,s]=m.useState(!1),[x,u]=m.useState(!1),g=`atl2:sincemini:${r||"home"}`,[p,b]=m.useState(()=>{try{return localStorage.getItem(g)==="1"}catch{return!1}}),y=()=>{b(L=>{try{localStorage.setItem(g,L?"0":"1")}catch{}return!L})},h=r||"home",{names:S,verdicts:j}=m.useMemo(()=>{const L=[],z={};return n.forEach(N=>{N.kind!=="target"||!N.name||(L.push(N.name),z[N.name]=ri(N)||"")}),{names:L,verdicts:z}},[n]),w=m.useMemo(()=>S.length?oi(h,S,j,a):null,[h,S.length]);if(!i.pipe||d||!w||w.firstVisit||!w.added.length&&!w.gone.length)return null;const C=f?w.added:w.added.slice(0,Bl),T=w.added.length-C.length,A=L=>{const z=n.find(N=>N.name===L);z&&(o(z.id),l({type:"popup",id:z.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(w.added.length,w.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:y,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),ii(h,S,j,w.fp,a)},children:"×"})]}),!!w.added.length&&t.jsxs("div",{className:"sg-c",children:[C.map(L=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>A(L),children:t.jsx("b",{children:L})},L)),T>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>s(!0),children:e.sinceMore(T)})]}),!!w.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(L=>!L),children:e.sinceOut(w.gone.length)}),x&&w.gone.slice(0,20).map(L=>t.jsx("span",{className:"gone",children:L},L))]})]})}const no={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function hn({o:e,locked:a=!1}){const{t:r}=$(),n=Wt(e),i=mt(e),o=Te(e),l=Oa(e),d=li(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(no[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(gs,{o:e})]})}const At=e=>e.length>22?e.slice(0,21)+"…":e,da=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function gn(e){return da.has(e.engine||"")}function an(e){return!!e.noCo||gn(e)&&!!e.url}function Vt(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function ro(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function _l(e){const r=()=>{const n=ro(),i=e.getBoundingClientRect().top-n-8;Math.abs(i)<2||window.scrollBy({top:i,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function hr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=$(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),Be(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(At(e.name))})]})}function bn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:f,dispatch:s,liveMemos:x}=$();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),s({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Vt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return gn(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Vt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(hr,{o:e})});const u=Te(e),g=p=>b=>{b.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(hr,{o:e})});if(u===1){const p=x.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Bt,{item:p,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:g(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:g(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:g(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:g(()=>f(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:g(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Ul({o:e}){const{t:a,doThumb:r,thumbOf:n}=$(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Hl({o:e}){const{lang:a}=$();return qe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(ka,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[bt(e.engine||"")," ",He(e.engine||"",a)]})})}function Vl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:d,caps:c,markRow:f,markedId:s,favIds:x,toggleFav:u,t:g}=$(),p=Te(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,h=y<=0?0:y<=7?1:y<=30?2:3,S=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][p]:b[h],j=x.has(e.id),w=C=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const T=C.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:T.left+Math.min(280,T.width/3),y:T.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>f(e.id),onMouseLeave:()=>f(null),onClick:w,children:[t.jsx("span",{className:"pt",style:{"--c":S}}),t.jsx(co,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:j?1:.35,padding:0,marginRight:4},onClick:C=>{C.stopPropagation(),u(e)},children:j?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(C=>C&&C!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:g.acqSee(e.acquirer),onClick:C=>{C.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",At(e.acquirer)]}),ut(e)?t.jsx("span",{className:"rdec",title:g.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:g.zoomNewsMark,children:"📰"}):null]}),t.jsx(Wl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Hl,{o:e}),c.pipe&&t.jsx(hn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(bn,{o:e}),c.showThumbs&&t.jsx(Ul,{o:e})]}),r&&!a&&!l&&t.jsx(Kl,{o:e})]})}function Wl({o:e}){const{lang:a,caps:r}=$();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=qt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Yl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=$(),l=(u,g=!1)=>p=>{p.stopPropagation(),g&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=qt(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Be(e),x=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):an(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),Vt(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(At(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(At(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Yt,{spec:e.card})})]})}function Gl({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=$();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[He(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(bn,{o:e})}),t.jsx(xn,{o:e})]})}function oo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:d,dossiers:c}=$();if(!e&&!a){const M=c.find(ut);if(M)return t.jsx(oo,{o:M})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),s=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),x=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),g=e?!!e.noCo:!f||pa(f),p=(e==null?void 0:e.engine)||"",b=ut(e),y=e?qt(e.amountEur,n):"",h=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),S=(()=>{const M=/https?:\/\/(?:www\.)?([^/]+)/.exec(s);return M?M[1].replace(/^www\./,"").slice(0,40):""})(),j=c.find(ut),w=((j==null?void 0:j.url)||"").trim(),C=!!s&&!!w&&(s===w||s.endsWith(w)||w.endsWith(s)),T=(M,F=!1)=>v=>{v.stopPropagation(),F&&l({type:"continent",key:"monde"}),l({type:"filters",patch:M})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const A=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},L=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},z=()=>{Vt({url:s,headline:x,tagline:e==null?void 0:e.tagline,name:f})},N=e?Be(e):!1,R=N&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",I=b?r.doEdito.replace(/^📖\s*/,""):p?He(p,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[I,h?` · ${h}`:""]}),t.jsx("h3",{className:"zoom-h",children:x}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(Yt,{spec:u})}),(s&&!C||w)&&t.jsxs("div",{className:"zoom-srcbox",children:[s&&!C&&t.jsxs("a",{className:"zoom-src",href:s,target:"_blank",rel:"nofollow noopener",onClick:M=>M.stopPropagation(),children:[r.zoomSrc,S?` · ${S}`:""," ↗"]}),j&&!b&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:M=>{M.stopPropagation(),l({type:"focus",id:j.id})},children:[r.doEdito," →"]}),w&&b&&t.jsxs("a",{className:"zoom-src zoom-src-art",href:w,target:"_blank",rel:"noopener noreferrer",onClick:M=>M.stopPropagation(),children:[r.zoomArt," ↗"]})]}),t.jsxs("div",{className:"zoom-acts",children:[N?t.jsxs("span",{className:"verdict",style:{"--c":R?"var(--brand)":"var(--red)"},children:[R?"✓":"✗"," ",t.jsx("b",{children:R?r.kept:r.dropped})]}):!g&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:M=>{M.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(At(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,s&&(g||gn({engine:p}))&&t.jsxs("div",{className:"zp-pair",children:[t.jsxs("a",{className:"zp-go ghost",href:s,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:M=>M.stopPropagation(),children:[t.jsx("span",{className:"zp-ico",children:"↗"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.viewLink}),t.jsx("em",{children:S||r.zoomSrc})]})]}),t.jsxs("button",{type:"button",className:"zp-go"+(!g&&f?" ghost":""),onClick:M=>{M.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]})]}),!g&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:M=>{M.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:M=>{M.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:At(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!g&&f&&d.pipe&&t.jsx(fn,{name:f})]})]})}function Kl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=$();return!i.pipe&&e.kind==="op"?t.jsx(Yl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(xn,{o:e}),t.jsx(bs,{o:e}),t.jsx(ws,{o:e}),t.jsx(fn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(hn,{o:e})})]}),e.card&&t.jsx(Yt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[bt(e.engine||"")," ",He(e.engine||"",r)]}),qe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Ql({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:d,lang:c}=$();if(!l.pipe&&e.kind==="op"){const x=qt(e.amountEur,c),u=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),g=(p,b=!1)=>y=>{y.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Yt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:g({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:g({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:g({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[bt(e.engine||"")," ",He(e.engine||"",c)]}),qe(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(bn,{o:e})})]})}const f=Te(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][f];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(hn,{o:e}),qe(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&f===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function Jl(){const{t:e}=$(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Xl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=i==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,x)=>(e[x]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(c)}”`:`${f} dossier${f>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function Zl(){var tt,st;const e=$(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:d,markRow:c,lang:f,sessTally:s,data:x,dossiers:u,source:g,focusExtra:p,byId:b}=e,y=E=>i.lockRowsAfter!==null||g==="ops"?Number.MAX_SAFE_INTEGER:Er,[h,S]=m.useState(new Set);m.useEffect(()=>{S(new Set)},[a.ptab,a.continent]);const[j,w]=m.useState(null);m.useEffect(()=>{w(null)},[a.ptab,a.continent]);const[C,T]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){T(!1);return}const E=document.getElementById("atl2-stage");if(!E){T(!1);return}const D=new IntersectionObserver(([Y])=>T(!!Y&&Y.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return D.observe(E),()=>D.disconnect()},[a.mapFolded]);const A=a.mapFolded||!C,L=E=>S(D=>{const Y=new Set(D);return Y.has(E)?Y.delete(E):Y.add(E),Y}),z=g==="ops"||i.pipe,[N,R]=m.useState("all"),[I,M]=m.useState(null),[F,v]=m.useState(!1),q=m.useRef(!0);m.useEffect(()=>{if(q.current){q.current=!1;return}R("all"),v(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!F)return;const E=D=>{var Y,oe;(oe=(Y=D.target)==null?void 0:Y.closest)!=null&&oe.call(Y,".atl2 .doable")||v(!1)};return document.addEventListener("click",E),()=>document.removeEventListener("click",E)},[F]);const V=zr(),B=m.useMemo(()=>{var D;const E=new Map;for(const Y of rs(((D=V==null?void 0:V.ed)==null?void 0:D.html)||""))E.has(Y.t)||E.set(Y.t,Y.html);return E},[(tt=V==null?void 0:V.ed)==null?void 0:tt.html]),_=m.useCallback(E=>{if(E.decryptHtml)return E.decryptHtml;if(!B.size)return;const D=(E.name||"").trim().toLowerCase();if(D.length<3)return;const Y=B.get(D);if(Y)return Y;for(const[oe,Ee]of B)if(oe.includes(D)||D.includes(oe))return Ee},[B]),W=m.useMemo(()=>{let E=dn(l,a.sort);return E=E.filter(D=>!ut(D)),N==="explore"?E=E.filter(an):N==="eval"&&(E=E.filter(D=>!D.noCo)),E},[l,a.sort,N,_]),Q=m.useMemo(()=>i.pipe?d.filter(E=>qe(E)&&si(E)):W.filter(E=>qe(E)&&!Be(E)),[i.pipe,d,W]),K=Q.length,[ie,ne]=m.useState(!1),[ge,G]=m.useState(!1),de=`atl2:sigmini:${((st=x.session)==null?void 0:st.token)||"home"}`,[ce,je]=m.useState(()=>{try{return localStorage.getItem(de)==="1"}catch{return!1}}),ve=m.useMemo(()=>i.pipe?W:W.filter(E=>!Be(E)&&!E.noCo),[W,i.pipe]),ee=g==="ops"?W.filter(E=>E.noCo).length:0,Z=i.pipe?n.plabels[a.ptab].toLowerCase():g==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,J=a.filters,H=[];if(J.day)H.push({k:"day",lib:n.fDay(J.day.slice(8,10)+"/"+J.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(J.win&&J.win!=="all"){const E=["1","7","30"].indexOf(J.win);E>=0&&H.push({k:"win",lib:n.dates[E],off:()=>r({type:"filters",patch:{win:"all"}})})}const xe=E=>E.length<=2?E.join(", "):`${E.length} ${n.fSelected}`;for(const E of["sector","country","engine"]){const D=J[E];D&&D.length&&H.push({k:E,lib:xe(D),off:()=>r({type:"clearFacet",facet:E})})}J.search&&H.push({k:"search",lib:"🔍 "+J.search,off:()=>r({type:"filters",patch:{search:""}})});const te=(E,D,Y="",oe=!1)=>t.jsxs("button",{type:"button","data-s":E,className:Y,"aria-sort":a.sort.key===E?a.sort.dir===1?"ascending":"descending":"none",style:oe?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:E}),children:[D,t.jsx("span",{className:"ar",children:a.sort.key===E&&a.sort.dir===1?"▴":"▾"})]},E),pe=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const E=new Map;W.forEach(oe=>{const Ee=oe.engine||"?";E.has(Ee)||E.set(Ee,[]),E.get(Ee).push(oe)});const D={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},Y=Pa([...E.keys()],f);return[...E.entries()].sort((oe,Ee)=>{const ye=D[oe[0]]??10+Y.indexOf(oe[0]),_e=D[Ee[0]]??10+Y.indexOf(Ee[0]);return ye-_e})},[W,i.pipe,a.groupBy,f]),ue=pe?pe.filter(([E])=>da.has(E)).length:0,me=(()=>{var D;return((D=(pe?pe.flatMap(([,Y])=>Y):W)[0])==null?void 0:D.id)??null})(),Re=m.useRef(!1),Ve=m.useRef(null),Ae=m.useMemo(()=>u.find(ut)||null,[u]);m.useEffect(()=>{const E=()=>{Re.current=!0};return window.addEventListener("ppmap:reveal",E),window.addEventListener("ppmap:focus",E),()=>{window.removeEventListener("ppmap:reveal",E),window.removeEventListener("ppmap:focus",E)}},[]),m.useEffect(()=>{if(!a.focusId)return;M(a.focusId);const E=window.setTimeout(()=>M(null),900);return()=>window.clearTimeout(E)},[a.focusId]),m.useEffect(()=>{z&&(a.focusId&&(W.some(E=>E.id===a.focusId)||u.some(E=>E.id===a.focusId))||p||me&&r({type:"focus",id:me}))},[z,a.focusId,W,me,p,r,u]),m.useEffect(()=>{if(!(!z||!a.focusId)&&N!=="all"&&!W.some(E=>E.id===a.focusId)&&u.some(E=>E.id===a.focusId)){if(Re.current){R("all");return}me&&r({type:"focus",id:me})}},[z,a.focusId,N,W,u,me,r]),m.useEffect(()=>{if(!z||!a.focusId||!Re.current)return;Re.current=!1;const E=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel");if(!E)return;const D=ro(),Y=E.getBoundingClientRect();Y.top>=D-2&&Y.bottom<=window.innerHeight-4||_l(E)},[z,a.focusId]),m.useEffect(()=>{if(typeof window>"u")return;const E=document.querySelector(".atl2.ops .listhead"),D=document.querySelector(".atl2.ops");if(!E||!D)return;const Y=()=>D.style.setProperty("--listhead-h",`${E.offsetHeight}px`);Y();const oe=new ResizeObserver(Y);return oe.observe(E),()=>oe.disconnect()},[A,a.dens,a.mapFolded]);const Fe=m.useMemo(()=>{if(!z||!a.focusId)return null;const E=W.find(Y=>Y.id===a.focusId)||u.find(Y=>Y.id===a.focusId)||null;if(!E)return null;const D=_(E);return D&&D!==E.decryptHtml?{...E,decryptHtml:D}:E},[z,a.focusId,W,u,_]);m.useEffect(()=>{const E=Ve.current;if(!E||!z)return;const D=Y=>{Y.preventDefault(),window.scrollBy(0,Y.deltaY)};return E.addEventListener("wheel",D,{passive:!1}),()=>E.removeEventListener("wheel",D)},[z,Fe==null?void 0:Fe.id]);const We=i.lockRowsAfter;let it=0;const Me=(E,D)=>{let Y=a.shown[D]||y();return E.length-Y<=4&&(Y=E.length),E.slice(0,Y).map(ye=>{const _e=We!==null&&it>=We;it++;const Ne=_(ye),at=Ne&&Ne!==ye.decryptHtml?{...ye,decryptHtml:Ne}:ye,pt=!z&&a.dens!=="maxi"&&(a.dens==="deplie"||(j?j==="open":!!Ne)),Mt=h.has(ye.id)?!pt:pt,O=z?ae=>{Re.current=!0,r({type:"focus",id:ae});const re=b.get(ae);re&&(an(re)?Vt(re):re.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:re.name}})))}:void 0;return a.dens==="maxi"?t.jsx(Ql,{o:at,locked:_e,selected:z&&a.focusId===ye.id,onSelect:O},ye.id):t.jsx(Vl,{o:at,locked:_e,open:Mt,onToggle:()=>L(ye.id),selected:z&&a.focusId===ye.id,echo:I===ye.id,onSelect:O},ye.id)})},ft="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(g==="ops"?" opsl":"")+(W.length?"":" list-empty"),Oe=t.jsxs(t.Fragment,{children:[pe?pe.map(([E,D])=>t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:bt(E)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:E==="ma"?n.grpMa:E==="fundraising"?n.grpLev:da.has(E)&&ue<=1?n.grpNews:E==="nominations"?n.grpNom:E==="media"?n.grpNewsOther:E==="recrutements"?n.grpHire:da.has(E)?n.grpNews+" · "+He(E,f):He(E,f)}),t.jsx("div",{className:"s",children:n.grpCount(D.filter(Y=>!Be(Y)).length,D.length)})]})]}),Me(D,E)]},E)):Me(W,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Jl,{}),!W.length&&!(x.loading&&!u.length)&&(i.pipe?t.jsx(Xl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(A?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:W.length})," ",Z]}),t.jsx("span",{className:"dot",children:"·"}),A&&t.jsx(eo,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[A?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),H.map(E=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:D=>{D.stopPropagation(),E.off()},children:[E.lib,t.jsx("i",{children:"×"})]},E.k)),g==="ops"&&W.length>0&&!A&&" — "+n.edSplit(W.length-ee,ee)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||g==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([E,D])=>t.jsxs("button",{type:"button","data-d":E,"aria-pressed":a.dens===E||E==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:E}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:D})]},E))}),!z&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":j==="open",onClick:()=>{w("open"),S(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":j==="closed",onClick:()=>{w("closed"),S(new Set)},children:n.foldAllLbl})]}),g==="ops"&&Ae&&t.jsx("button",{type:"button",className:"edito-go","aria-pressed":a.focusId===Ae.id,title:n.doEdito,onClick:()=>r({type:"focus",id:Ae.id}),children:n.doEdito}),(i.showFunnel||g==="ops")&&(()=>{var Y;const E=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],D=((Y=E.find(([oe])=>oe===N))==null?void 0:Y[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":F,onClick:()=>v(oe=>!oe),children:[D,t.jsx("i",{children:"▾"})]}),F&&t.jsx("div",{className:"dolist",children:E.map(([oe,Ee])=>t.jsx("button",{type:"button","aria-pressed":N===oe,onClick:()=>{R(oe),v(!1)},children:Ee},oe))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:E=>r({type:"sort",key:E.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([E,D])=>t.jsx("option",{value:E,children:D},E))})]}),i.showChain&&ve.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ve.map(E=>E.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(ve.length):n.chainAll(ve.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]}),A&&t.jsx(Zr,{compact:!0})]}),t.jsx($l,{}),K>0&&!a.filters.signalOnly&&!ge&&t.jsxs("div",{className:"sigstrip"+(ce?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(K)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!ce,title:ce?n.boxExpand:n.boxCollapse,onClick:()=>je(E=>{try{localStorage.setItem(de,E?"0":"1")}catch{}return!E}),children:ce?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>G(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(ie?Q:Q.slice(0,12)).map(E=>{const D=qe(E);return D?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(ln(D,f),ca(D,f)),onClick:()=>{c(E.id),r({type:"popup",id:E.id})},children:[t.jsx("b",{children:E.name}),t.jsxs("i",{children:[D.emoji," ",Da(D,f)]}),t.jsx("em",{children:ca(D,f)})]},"sg-"+E.id):null}),!ie&&Q.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>ne(!0),children:n.sigStripMore(Q.length-12)})]})]}),a.dens!=="maxi"&&!z&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),te("country",n.colCountry),te("name",n.colCompany),te("amount",n.colAmount,"h-amt",!0),te("stage",n.colStage,"h-stade"),te("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[te("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),te("memo",n.colMemo)]}),i.pipe&&te("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),z?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),te("country",n.colCountry),te("name",n.colCompany),te("amount",n.colAmount,"h-amt",!0),te("stage",n.colStage,"h-stade"),te("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:ft,children:Oe})]}),t.jsxs("aside",{ref:Ve,className:"readpane","aria-label":f==="fr"?"Dossier":"File",children:[g==="ops"&&Ae&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===Ae.id,onClick:()=>r({type:"focus",id:Ae.id}),children:n.doEdito}),i.pipe?t.jsx(Gl,{o:Fe}):t.jsx(oo,{o:Fe,extra:Fe?null:p})]})]}):t.jsx("div",{className:ft,children:Oe}),(()=>{const E=pe||[["pt"+a.ptab,W]];let D=0,Y=0;for(const[Ee,ye]of E){Y+=ye.length;let _e=a.shown[Ee]||y();ye.length-_e<=4&&(_e=ye.length),D+=Math.min(ye.length,_e)}const oe=Y-D;return oe<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>E.forEach(([Ee,ye])=>r({type:"more",group:Ee,by:ye.length,base:y()})),children:[t.jsx("span",{className:"more-label",children:n.more(oe,oe)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(D,Y)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}function gr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ed(e,a){const r=di(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function td(e,a){const n=[a.head.split("|").map(gr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",ed(i,a.plabels),Wt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(gr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ad(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const nd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function nt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function rd({o:e,qa:a}){const{t:r,lang:n,fund:i}=$(),o=(e.cribleStatus||"").trim().toUpperCase()||(Wt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=mt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(nt,{k:r.cdSector,v:e.sector}),t.jsx(nt,{k:r.cdStage,v:e.stage}),t.jsx(nt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(nt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(nt,{k:r.cdName,v:e.contactName}),t.jsx(nt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(nt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(nt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(nt,{k:r.cdAngle,v:e.angle}),t.jsx(nt,{k:r.cdDetected,v:nd(e.date,n)})]}),c.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,f])=>f).map(([f,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:s})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function od(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=$(),[d,c]=m.useState({}),f=25,s=m.useMemo(()=>n.slice(0,f),[n]);m.useEffect(()=>{s.length&&ci(r,s.map(g=>g.name)).then(c)},[r,s]);const x=o.stats,u=g=>g.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(x.screened/o.marketEstimate*100)," %"]})]})]}),s.map(g=>t.jsx(rd,{o:g,qa:d[g.name]},g.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const id=50;function vn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=$(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(0),[g,p]=m.useState(""),[b,y]=m.useState(!1),h=m.useRef(null);m.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const S=async w=>{c(!0),s("");const C=await a();if(c(!1),C.ok){l(C);return}if(C.busy){s(i.alertPreviewBusy);return}if(!w){s(i.alertPreviewFail);return}u(id),h.current=window.setInterval(()=>{u(T=>T>1?T-1:(h.current&&window.clearInterval(h.current),S(!1),0))},1e3)},j=async()=>{if(n||b)return;y(!0),p("");const w=await r();y(!1),p(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||x>0,onClick:()=>{S(!0)},children:d?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{j()},children:b?"…":i.alertTest})]}),x>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(x)}),f&&t.jsx("p",{className:"mnote warn",children:f}),g&&t.jsx("p",{className:"mnote",children:g}),!g&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const St="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function $e({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=$();return Tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function sd(){const{st:e}=$();switch(e.modal){case"chain":return t.jsx(dd,{});case"space":return t.jsx(cd,{});case"alert":return t.jsx(pd,{});case"queue":return t.jsx(hd,{});case"export":return t.jsx(gd,{});case"plug":return t.jsx(yd,{});case"recharge":return t.jsx(kd,{});case"cover":return t.jsx(Nd,{});case"dossier":return t.jsx(jd,{});case"crit":return t.jsx(Sd,{});case"tuto":return t.jsx(Ed,{});case"rdv":return t.jsx(ld,{});case"memoalert":return t.jsx(bd,{});default:return null}}function ld(){const{dispatch:e,fund:a,t:r}=$(),n=a||r.rdvCoFallback;return Tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Lr,children:pn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ma}`,children:ma})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Fi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function dd(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:d,caps:c,memoQueued:f,doAnalyse:s}=$(),x=o==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),g=e.chain.idx,p=u[g],b=g>=u.length;return Tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${g+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:g/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[Lt(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(ct(p.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:He(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:qt(p.amountEur,i)})]}),qe(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:p,lg:!0})," ",t.jsx(ka,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),x&&Be(p)&&t.jsxs("div",{className:"vbox",style:{"--c":gt(p)==="retenu"?"var(--brand)":gt(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:gt(p)==="retenu"?"✓ "+n.kept:gt(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&p&&c.pipe&&Te(p)===1&&!f.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&p&&!(x&&Be(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function cd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=$(),o=i==="client",l=m.useMemo(()=>o?r.filter(x=>Be(x)):[],[r,o]),d=m.useMemo(()=>dn(l.filter(x=>gt(x)==="retenu"),{key:"signal",dir:-1}),[l]),c=m.useMemo(()=>l.filter(x=>gt(x)==="ecarte"),[l]),f=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs($e,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function pd(){const{mode:e}=$();return e==="client"||e==="apercu"?t.jsx(ud,{}):t.jsx(xd,{})}function ud(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),[o,l]=m.useState("d"),d=i!=="client";return t.jsxs($e,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(md,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="w"&&t.jsx(fd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="m"&&t.jsx(io,{})]})}function md({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),Fn(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||Fn(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),g=p=>{const b=o.sections||e.alertSec.map(([y])=>y);x({sections:u(p)?b.filter(y=>y!==p):[...b,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>g(p)}),t.jsxs("span",{children:[b,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(vn,{label:e.alertPreview,readOnly:r,onPreview:()=>yi(a),onTest:()=>vi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function fd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),On(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||On(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,g=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>x({dow:Number(p.target.value)}),children:e.alertDow.map((p,b)=>t.jsx("option",{value:b,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,g-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[g," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,g+1)}),disabled:r,children:"＋"})]})]}),t.jsx(vn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ki(a),onTest:()=>wi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function io(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=$(),[l,d]=m.useState(o||""),[c,f]=m.useState(!1),[s,x]=m.useState(!1);m.useEffect(()=>{o&&d(o)},[o]);const u=e.filters,g=m.useMemo(()=>n.filter(h=>qe(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){x(!0);try{await fetch(`${nn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{x(!1)}}},y=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>He(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>Lt(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([h,S])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:S}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,g)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function xd(){const{t:e}=$();return t.jsx($e,{title:e.alertTitle,icon:"🔔",children:t.jsx(io,{})})}function hd(){var L,z;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:d,dispatch:c,liveMemos:f}=$(),[s,x]=m.useState(null),[u,g]=m.useState([]),[p,b]=m.useState(0),y=n==="client",h=m.useMemo(()=>{const N=new Map;return i.forEach(R=>{const I=(R.name||"").trim().toLowerCase();I&&!N.has(I)&&N.set(I,R)}),N},[i]);m.useEffect(()=>{let N=!0;return(async()=>{const[R,I]=await Promise.all([on(r),kr(a)]);N&&(R&&x(R),g(I))})(),()=>{N=!1}},[a,r,p]);const S=(s==null?void 0:s.per_day)??0,j=((L=s==null?void 0:s.analyzed_today)==null?void 0:L.length)??0,w=s==null?void 0:s.offre,C=(s==null?void 0:s.pool_meta)||[],T=m.useMemo(()=>{const N=new Map;for(const R of(s==null?void 0:s.scheduled)||[])for(const I of R.names||[])N.has(I)||N.set(I,{label:R.day_label,date:R.date});return N},[s==null?void 0:s.scheduled]),A=(s==null?void 0:s.in_progress)||[];return t.jsxs($e,{title:e.queueTitle,wide:!0,children:[w&&t.jsxs("div",{className:"qoffre"+(w.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:w.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:w.delai})]}),t.jsx("span",{className:"osp"}),w.rythme>0?t.jsx("span",{className:"or",children:e.qRate(w.rythme)}):w.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(w.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(j,j+(((z=s==null?void 0:s.pool_order)==null?void 0:z.length)??0))}})}),w&&t.jsxs("div",{className:"qeta",children:[w.file===0?e.qEtaDone:w.rythme<=0?e.qEtaPaused:e.qEta(w.file,w.rythme,w.jours_restants),w.en_retard&&t.jsxs("em",{children:[" ",e.qLate(w.delai,w.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(S)}),(w==null?void 0:w.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(A.length>0||f.items.some(N=>N.status==="boot"||N.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(N=>N.status==="boot"||N.status==="running"||N.status==="error").map(N=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:N.name}),t.jsx("span",{className:"qd",children:N.memoType||""}),t.jsx(Bt,{item:N,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+N.name)),A.filter(N=>!f.liveOf(N.name)).map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.name}),t.jsxs("span",{className:"qd",children:[N.memo_type||"",N.age_min?` · ${Math.round(N.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:N.state||""})]},"ip-"+N.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.company}),t.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),t.jsx("span",{className:"qt",children:N.status}),N.url&&t.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),y&&N.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Rn(a,N.company,"retry").then(()=>b(R=>R+1))},children:e.queueRetry}),y&&N.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Rn(a,N.company,"delete").then(()=>b(R=>R+1))},children:e.queueDelete})]},N.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(C.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[C.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),C.map((N,R)=>{const I=T.get(N.name),M=h.get((N.name||"").trim().toLowerCase()),F=f.liveOf(N.name),v=!!(M&&l.has(M.id))||!!(F&&(F.status==="boot"||F.status==="running")),q=!!(M&&Te(M)===1&&!M.memoUrl)&&!F;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),I?t.jsx("span",{className:"qwhen"+(I.label==="demain"?" soon":""),children:I.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:N.name}),N.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof N.score=="number"&&t.jsx("span",{className:"qs2",children:N.score}),F&&(F.status==="boot"||F.status==="running")&&t.jsx(Bt,{item:F,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),q&&(d.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:v,onClick:()=>{o(M),b(V=>V+1)},children:v?e.actAnalyseQueued:e.actAnalyse})),N.excerpt&&t.jsx("span",{className:"qex",children:N.excerpt})]},N.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([N,R])=>t.jsxs("li",{children:[t.jsx("b",{children:N})," — ",R]},N))})]})}function gd(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=$(),d=`${St}/cibles/list.csv?token=${a}`,c=`${St}/cibles/list.json?token=${a}`,f=`${St}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,x=y=>{var h;(h=navigator.clipboard)==null||h.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:f,href:f}],g=!i.lockActions&&n.length>0,p=()=>{ad(td(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:y=>(e.stg.find(([h])=>h===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs($e,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:h,href:S})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(h),children:e.exportCopy}),S&&t.jsx("a",{className:"exb",href:S,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function bd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),o=i!=="client",[l,d]=m.useState(null),[c,f]=m.useState(!1),[s,x]=m.useState(0),[u,g]=m.useState(!1);m.useEffect(()=>{let h=!0;return f(!1),Mn(a).then(S=>{h&&(S?d(S):f(!0))}),()=>{h=!1}},[a,s]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=h=>{if(o||!l)return;const S={enabled:h.enabled??!!l.enabled,email:h.email??(l.email||""),sections:h.sections??p()};g(!0),Mn(a,S).then(j=>{if(g(!1),!j){n(e.memoAlertErr);return}d(j),r(e.memoAlertSaved)})};if(c)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(h=>h+1),children:e.retry})]})});if(!l)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=p();return t.jsxs($e,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(vd,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>b({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,S])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[h],disabled:o||u,onChange:()=>b({sections:{...y,[h]:!y[h]}})}),t.jsx("span",{children:S})]},h))}),t.jsx(vn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>ui(a,y),onTest:()=>pi(a,y)})]})}function vd({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const d=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&d&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:n})]})]})}function yd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=$(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(null),[x,u]=m.useState(""),[g,p]=m.useState(0);m.useEffect(()=>{let j=!0;return c(!1),Ia(a).then(w=>{j&&(w?l({configured:w.configured,url_hint:w.url_hint}):c(!0))}),xi(a).then(w=>{j&&s(w)}),()=>{j=!1}},[a,g]);const b=(j,w)=>{i&&Ia(a,j).then(C=>{if(!C||C.ok===!1){n(e.actErr);return}j.test&&C.sent===!1?n(e.plugTestThrottled):r(w),p(T=>T+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),S=`curl -X POST ${St}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs($e,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(j=>j+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!i,onChange:j=>u(j.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(wd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function wd(){const{t:e,token:a,lang:r}=$(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[d,c]=m.useState(null),[f,s]=m.useState(null),[x,u]=m.useState(!1),[g,p]=m.useState(!1),[b,y]=m.useState(null),[h,S]=m.useState(null),[j,w]=m.useState(null),C=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Ia(a).then(I=>{S(I&&I.configured?I.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),s(null),u(!1),y(null);try{const I=JSON.parse(localStorage.getItem(C)||"null");w(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{w(null)}},[C]);const T=async()=>{l(!0),u(!1),y(null);const I=await gi(a,n);c(I),s(I.ok?n:null),l(!1)},A=m.useRef(!1),L=async()=>{if(A.current)return;A.current=!0,p(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await bi(a,n,"webhook",void 0,I)}finally{A.current=!1}if(p(!1),u(!1),y(M),M.ok&&(M.pushed||0)>0){const F={t:new Date().toISOString(),n:M.pushed||0};w(F);try{localStorage.setItem(C,JSON.stringify(F))}catch{}}},z=d!=null&&d.ok&&d.ready||0,N=!!(d!=null&&d.ok)&&f===n&&z>0&&!!h&&!j,R=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>i(I.target.value),children:e.plugBulkTabs.map(([I,M])=>t.jsx("option",{value:I,children:M},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(R,j.n)}),!j&&!!(d!=null&&d.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),N&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),N&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:g,onClick:()=>{L()},children:g?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:g,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function kd(){const{t:e,data:a,lang:r}=$(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const f=await(await fetch(`${nn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs($e,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function jd(){const{t:e}=$();return t.jsx($e,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(od,{})})}function Nd(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:d}=$(),[c,f]=m.useState(null),[s,x]=m.useState(!1);m.useEffect(()=>{let z=!0;if(o)return on(o).then(N=>{z&&N&&typeof N.per_day=="number"&&f(N.per_day)}),()=>{z=!1}},[o]);const[u,g]=m.useState(null);m.useEffect(()=>{if(!i)return;let z=!0;return fi(i).then(N=>{z&&g(N)}),()=>{z=!1}},[i]);const p=r.stats,b=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(z=>z.kind==="target"&&Be(z)).length,y=r.marketEstimate||0,h=y>0?Math.min(100,Math.round(b/y*100)):null,S=(p==null?void 0:p.window_days)||30,j=b>0?b/S:0,w=y>0?Math.max(0,y-b):0,T=y>0&&j>0&&b>=100?Math.round(w/j):null,A=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),L=z=>{s||!l||(x(!0),hi(i,z).then(N=>{if(x(!1),N===null){d(e.actErr);return}f(N),d(e.alertSaved)}))};return t.jsxs($e,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(A(b))}),y>0&&t.jsx("span",{children:e.covOf(A(y))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(A(j))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((z,N)=>t.jsxs("tr",{className:z.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[z.code,z.geo?` · ${z.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof z.n=="number"?A(z.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:z.source}),z.elargi&&t.jsx("em",{children:e.covWide(String(z.demande||""))}),z.erreur&&t.jsx("em",{children:e.covMissing})]})]},N)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:A(u.total||y)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:A(p.shown)})," ",e.funShown]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:c===z?"on":"",disabled:s,onClick:()=>L(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Sd(){var h,S,j;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:d}=$(),c=n==="client",f=m.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[s,x]=m.useState(""),[u,g]=m.useState(""),[p,b]=m.useState(!1),y=async()=>{const w=s.trim();if(!(!w||p||!c)){b(!0),g("");try{const T=await(await fetch(`${St}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&g(String(T.reply)),T.job_id){g(e.critChatRunning);const A=async()=>{const L=await fetch(`${St}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(z=>z.json()).catch(()=>null);if(L&&L.done){g(String(L.reply||L.clarification||L.summary||"✓")),b(!1),L.applied&&i(e.alertSaved);return}setTimeout(()=>{A()},8e3)};setTimeout(()=>{A()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs($e,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((S=o==null?void 0:o.angles)!=null&&S.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var C,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(A=>t.jsx("li",{children:A},A))})]}),!!((T=w.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(A=>t.jsx("li",{children:A},A))})]})]})]},w.title)})]}),!!((j=o==null?void 0:o.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||p,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!c||p||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(mi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(no[w]||"v-cons"),children:w}),t.jsx("span",{children:C})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",C]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ed(){const{t:e,dispatch:a,startTour:r}=$(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs($e,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const so="atl2:mapfold",Cd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(so);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},zd=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},lo=m.createContext(null),$=()=>{const e=m.useContext(lo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=$(),n=qe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Da(n,r),children:[n.emoji," ",Da(n,r)]}):null}function ka({o:e,src:a}){const{lang:r,t:n}=$(),i=qe(e);if(!i)return null;const o=zi(i),l=Ai(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(ln(i,r))+" · "+n.win7(ca(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Ad(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Ke(a);if(i)return e.find(o=>Ke(o.name)===i)||e.find(o=>{const l=Ke(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function Td(){const{scoped:e,t:a,st:r,dispatch:n}=$(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(x=>!ut(x)),d=l.length,c=l.filter(x=>!x.noCo).length,f=l.filter(x=>!!x.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const x=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",f," ",a.zoomPulseExplore]})]})]})}function co({o:e}){const{lang:a}=$(),r=Ci(e.cc),n=e.cc?Lt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const br="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Ld=!1;function qd(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const po=e=>`atl2:tour:${e||"anon"}`;function Md(e){try{return localStorage.getItem(po(e))==="1"}catch{return!0}}function vr(e){try{localStorage.setItem(po(e),"1")}catch{}}function Rd(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Id({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var wn;const{lang:l}=ji(),d=_i[l],c=Zi(e,l,a),[f,s]=m.useReducer(as,void 0,()=>es((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?zd():Cd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=m.useRef(!0);m.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(so,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var k;(k=u.current)==null||k.call(u,f.filters)},[f.filters]);const[g,p]=m.useState(null),[b,y]=m.useState(null),[h,S]=m.useState(null),[j,w]=m.useState({kept:0,dropped:0}),[C,T]=m.useState(!1),[A,L]=m.useState(""),[z,N]=m.useState(!1),[R,I]=m.useState(null),[M,F]=m.useState(!1),[v,q]=m.useState(!1),[,V]=m.useState(0),B=()=>V(k=>k+1),_=m.useRef([]),W=m.useRef(new Set),Q=m.useRef(new Set),[K,ie]=m.useState([]),[ne,ge]=m.useState([]),[G,de]=m.useState(0),ce=m.useRef(new Map),je=m.useRef(null),{mode:ve}=c,ee=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),Z=ee.pipe,J=c.session.token||"",H=ve==="client"&&!e;m.useEffect(()=>{if(!J||!Z)return;let k=!0;const U=async()=>{const se=await Ti(J);!k||!se||(ge(se.runs),de(Date.now()/1e3-se.now),ie(we=>we.filter(Le=>!se.runs.some(et=>Ke(et.company)===Ke(Le.name)))))};U();const P=K.length>0||ne.some(se=>se.status==="running"),X=window.setInterval(()=>{U()},P?8e3:25e3);return()=>{k=!1,window.clearInterval(X)}},[J,Z,K.length,ne.some(k=>k.status==="running")]);const xe=m.useMemo(()=>{const k=[],U=new Set;for(const P of K){const X=Ke(P.name);!X||U.has(X)||(U.add(X),k.push({name:P.name,id:P.id,status:"boot",started:P.started,estMin:P.estMin,memoType:"instant"}))}for(const P of ne){const X=Ke(P.company);if(!X||U.has(X))continue;U.add(X);const se=P.status==="error"?"error":P.status==="done"?"done":"running";k.push({name:P.company,status:se,started:P.started||0,estMin:P.est_min||(P.memo_type==="detailed"?40:15),url:P.url,error:P.error,memoType:P.memo_type})}return k},[K,ne]),te=k=>xe.find(U=>Ke(U.name)===Ke(k))||null,pe=(k,U)=>{ie(P=>P.some(X=>Ke(X.name)===Ke(k.name))?P:[...P,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:U==="detailed"?40:15}]),W.current.add(k.id),B()};m.useEffect(()=>{if(document.querySelector(`link[href="${br}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=br,document.head.appendChild(k)},[]);const ue=(k,U=!1)=>{L(k),N(U),je.current&&clearTimeout(je.current),je.current=setTimeout(()=>L(""),U?4200:2400)},me=k=>ue(k,!0),Re=m.useMemo(()=>{const k=new Map;return c.dossiers.forEach(U=>{U.id&&k.set(U.id,U)}),k},[c.dossiers]),Ve=m.useMemo(()=>c.dossiers.filter(k=>Cr(k,f,Z)),[c.dossiers,f,Z]),Ae=m.useRef(!1);m.useEffect(()=>{if(Ae.current||e||c.loading||!c.dossiers.length)return;if(!ee.showFunnel||Md(c.session.token||"")){Ae.current=!0;return}Ae.current=!0;const k=window.setTimeout(()=>{vr(c.session.token||""),F(!0)},700);return()=>window.clearTimeout(k)},[e,c.loading,c.dossiers.length,ee.showFunnel,c.session.token]);const Fe=m.useMemo(()=>c.dossiers.filter(k=>ns(k,f,Z,c.favIds)),[c.dossiers,f,Z,c.favIds]),We=m.useMemo(()=>Ni(Ve,c.favIds),[Ve,c.favIds]),it=m.useRef(!1);m.useEffect(()=>{if(it.current)return;if(!Z||a==="ops"){it.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){it.current=!0;return}if(c.loading)return;it.current=!0;const k=Si(We);k!==f.ptab&&s({type:"ptab",tab:k})},[Z,a,n==null?void 0:n.ptab,c.loading,We,f.ptab]);const Me=m.useMemo(()=>{const k=Mr(c.dossiers);return k?ct(k)===0?d.tourToday:Rr(k,l):d.tourNoRun},[c.dossiers,d,l]),ft=m.useMemo(()=>c.dossiers.some(k=>!!k.memoUrl||!!k.summary||Et(k)),[c.dossiers]),[Oe,tt]=m.useState(!1);m.useEffect(()=>{if(c.loading){tt(!1);return}if(c.dossiers.length>0||c.error){tt(!0);return}const k=window.setTimeout(()=>tt(!0),6e3);return()=>window.clearTimeout(k)},[c.loading,c.dossiers.length,c.error]);const st=(c.marketEstimate||0)>0||typeof((wn=c.stats)==null?void 0:wn.screened)=="number"&&c.stats.screened>0,E=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(We[k]||0)>0)??0,[We]),D=sn.find(k=>k.key===f.continent),Y=f.continent==="monde"?d.contWorld:(l==="fr"?D==null?void 0:D.fr:D==null?void 0:D.en)||"";m.useEffect(()=>{const k=U=>{var X;const P=(((X=U.detail)==null?void 0:X.name)||"").trim();P&&oe(null,P)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{if(a!=="ops")return;const k=U=>{const P=U.detail||{},X=String(P.id||"").trim(),se=String(P.name||"").trim(),we=String(P.url||"").trim(),Le=X&&Re.get(X)||Ad(c.dossiers,se,we);if(Le){y(null),window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Le.id}),(Le.noCo||["media","nominations","recrutements"].includes(Le.engine||""))&&(Le.url||Le.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Le.url||"",text:[Le.headline,Le.tagline].filter(Boolean).join(`
`)}})):Le.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Le.name}}));return}!se&&!we||(s({type:"focus",id:null}),y({name:se,headline:String(P.text||"").trim()||se,url:we,card:P.card}),we&&(pa(se)||!se)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:we,text:String(P.text||"").trim()}})):se&&!pa(se)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:se,url:we}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=X=>{const se={},we=String((X==null?void 0:X.sector)||"").trim();we&&(se.sector=[we]);const Le=String((X==null?void 0:X.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Le)&&(se.day=Le);const et=String((X==null?void 0:X.search)||"").trim();et&&(se.search=et);const be=String((X==null?void 0:X.dealKind)||"").trim();(be==="ma"||be==="levee"||be==="other")&&(se.dealKind=[be]),Object.keys(se).length&&s({type:"filters",patch:se})},U=X=>k(X.detail),P=X=>{X.data&&X.data.type==="pp-filter"&&k(X.data)};return window.addEventListener("ppmap:filter",U),window.addEventListener("message",P),()=>{window.removeEventListener("ppmap:filter",U),window.removeEventListener("message",P)}},[]),m.useEffect(()=>{const k=U=>{var se;const P=(((se=U.detail)==null?void 0:se.name)||"").trim().toLowerCase();if(!P)return;const X=c.dossiers.find(we=>(we.name||"").trim().toLowerCase()===P);X&&s(a==="ops"?{type:"focus",id:X.id}:{type:"popup",id:X.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const oe=(k,U)=>{const P=((k==null?void 0:k.name)||U||"").trim();if(!H){S({kicker:P});return}!P||C||(T(!0),(async()=>{try{let X=P;const se=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(se)X=se;else try{const be=await Li(P);if(be!=null&&be.website)X=be.website;else if(((be==null?void 0:be.candidates)||[]).length===1)X=be.candidates[0].url;else if(((be==null?void 0:be.candidates)||[]).length>1){_.current=[{name:P,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(be.candidates||[]).slice(0,5)},..._.current].slice(0,8),B();return}}catch{}const we=await Nr(J,X,"atelier2"),Le={name:we.company||P,verdict:we.verdict,reason:we.reason||"",remaining:we.remaining??null};_.current=[Le,..._.current].slice(0,8),we.verdict==="kept"&&w(be=>({...be,kept:be.kept+1})),we.verdict==="ruled_out"&&w(be=>({...be,dropped:be.dropped+1}));const et=k||c.dossiers.find(be=>(be.name||"").toLowerCase()===P.toLowerCase());et&&(we.verdict==="kept"?et.verdict=et.verdict||"MATCH":we.verdict==="ruled_out"&&(et.verdict="NO MATCH"),we.reason&&(et.reasoning=we.reason)),B()}finally{T(!1)}})())},Ee=k=>{if(!H){S({kicker:k.name});return}pe(k,"instant"),Rt(J,"fast_request",k.name||"",""),ue(d.memoInstantSent(k.name))},ye=k=>ce.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),_e=(k,U)=>s({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:U}}),Ne=async(k,U,P)=>{const X=k.ceoStatus||"";k.ceoStatus=U,B();const se=await Sa(J,{status:U,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(P==null?void 0:P.note)!==void 0?{note:P.note}:{},...P!=null&&P.via?{via:P.via}:{}});return se.ok?se.skipped?(k.ceoStatus=X,B(),me(d.actNotPersisted),!1):((P==null?void 0:P.undo)!==!1&&_e(k,X),P!=null&&P.msg&&ue(P.msg),(U==="Validé"||U==="Écarté")&&!k.ceoNote&&(P==null?void 0:P.note)===void 0&&I({o:k,yes:U==="Validé"}),!0):(k.ceoStatus=X,B(),me(d.actErr),!1)},at=async(k,U)=>{const P=await Sa(J,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:U,via:"note"});return!P.ok||P.skipped?(me(P.skipped?d.actNotPersisted:d.actErr),!1):(k.ceoNote=U,B(),!0)},pt=m.useRef(new Map),Mt=k=>pt.current.has(k.id)?pt.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),O=(k,U)=>{pt.current.set(k.id,U),B()},ae=(k,U)=>{H&&Ne(k,U?"Validé":"Écarté",{msg:U?d.decidedYes(k.name):d.decidedNo(k.name)})},re=k=>{H&&Ne(k,"À trancher",{msg:d.promoted(k.name)})},fe=k=>{H&&(async()=>{const U=k.ceoStatus||"";k.ceoStatus="Retenu",B();const P=await Sa(J,{status:"Retenu",check_id:k.checkId,company:k.name});if(!P.ok||P.skipped){k.ceoStatus=U,B(),me(P.skipped?d.actNotPersisted:d.actErr);return}_e(k,U),ue(d.repeched(k.name))})()},Ye=()=>{const k=f.undo[f.undo.length-1];if(!k){ue(d.undoNone);return}const U=Re.get(k.id);if(!U){s({type:"undoPop"}),ue(d.undoNone);return}let P=k.prevCeoStatus;if(!P)if((U.verdict||"").toUpperCase().includes("CALL"))P="À trancher";else{ue(d.undoLockedTitle);return}(async()=>await Ne(U,P,{undo:!1})&&(s({type:"undoPop"}),U.ceoStatus=k.prevCeoStatus,B(),ue(d.undoDone(U.name))))()},Ie=k=>{H&&(Q.current.add(k.id),B(),(async()=>{const U=await qi(J,k.name,"email");if(!U||U.ok===!1){Q.current.delete(k.id),B(),me(d.actErr);return}Rt(J,"approach",k.name||"",""),ue(d.actApproachSent)})())},Se=(k,U)=>{H&&(async()=>{if(!(await Rt(J,U?"yes":"no",k.name||"","")).ok){me(d.actErr);return}ce.current.set(k.id,U?"yes":"no"),B(),ue(U?d.thumbUpDone:d.thumbDnDone)})()},Ge=k=>{!H||!Et(k)||(pe(k,"detailed"),Rt(J,"detailed_request",k.name||"",""),ue(d.memoDeepSent(k.name)))},ja=k=>{const U=new Set(c.favIds),P=U.has(k.id);P?U.delete(k.id):U.add(k.id),c.setFavIds(U),H&&Mi(J,{id:k.id,co:k.name},P)},Gt=()=>{!H||v||window.confirm(d.identSyncConfirm)&&(q(!0),(async()=>{const k=await Ri(J);q(!1),k?ue(d.identSyncDone):me(d.actErr)})())},yn=/proplace/i.test(c.fund||""),uo=k=>{!H||!yn||(Rt(J,"onboard_request",k.name||"",""),ue(d.onboardSent(k.name)))},mo={st:f,dispatch:s,t:d,lang:l,mode:ve,caps:ee,pipe:Z,token:J,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:fe,thumbOf:ye,canWrite:H,commitStatus:Ne,saveNote:at,stageOf:Mt,setStage:O,flashErr:me,startTour:()=>F(!0),dossiers:c.dossiers,scopedAll:Ve,scoped:Fe,counts:We,byId:Re,contName:Y,favIds:c.favIds,toggleFav:ja,askEvaluate:oe,doAnalyse:Ee,doDecide:ae,doPromote:re,doApproach:Ie,doThumb:Se,doDeep:Ge,doUndo:Ye,doSync:Gt,doOnboard:uo,outbound:yn,memoQueued:W.current,liveMemos:{items:xe,serverOff:G,liveOf:te},approachDone:Q.current,sessTally:j,evalCards:_.current,evalBusy:C,markRow:p,markedId:g,flash:ue,focusExtra:b};m.useEffect(()=>{const k=U=>{U.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const fo=k=>J?t.jsx(os,{token:J,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(lo.Provider,{value:mo,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(J?" cibles":""),children:[t.jsx("style",{children:Vi}),ee.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Lr,children:pn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${ma}`,children:ma})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),fo(t.jsxs("div",{className:"app"+(Z?" pipe":"")+(J?" has-thesis":""),children:[ee.showTicker&&t.jsx(Pe,{name:"live",children:t.jsxs("div",{className:"live-stack"+(J?" live-stack--cibles":""),children:[t.jsx(ps,{}),!!J&&t.jsx(is,{})]})}),ee.showIdent&&t.jsx(Pe,{name:"identite",children:t.jsx(Ns,{})}),!1,!!J&&t.jsx(Pe,{name:"brief",children:t.jsx(ss,{})}),Ld,ee.showMorning&&t.jsx(Pe,{name:"matin",children:t.jsx(js,{})}),t.jsx(Pe,{name:"mesure",children:t.jsx(xs,{})}),ee.showFunnel&&t.jsx(Pe,{name:"entonnoir",children:t.jsx(Fd,{})}),ee.showFunnel&&t.jsx(Pe,{name:"tunnel",children:t.jsx(Ss,{})}),ee.showFunnel&&t.jsx(Pe,{name:"tuto",children:t.jsx(Es,{})}),!f.mapFolded&&t.jsx(Pe,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(eo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Td,{}),t.jsx(jl,{}),t.jsx(Zr,{})]})]})}),ee.showDemand&&Z&&t.jsx(Pe,{name:"direct",children:t.jsx(Ii,{items:xe,serverOff:G,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),ee.showDemand&&t.jsx(Pe,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Al,{})})}),ee.showDemand&&f.memoConsole&&t.jsx(Pe,{name:"console",children:t.jsx(Ll,{})}),t.jsx(Pe,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(Zl,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(Pe,{name:"fiche",children:t.jsx(Il,{})}),t.jsx(Pe,{name:"modales",children:t.jsx(sd,{})}),t.jsx(fs,{}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(ys,{placeholder:R.yes?d.whyYesPh:d.whyNoPh,onDone:k=>{const U=R.o;I(null),k&&at(U,k).then(P=>{P&&ue(d.csNoteSaved)})}})]}),M&&Oe&&t.jsx(ks,{steps:Rd(d,Me,ft,E,st),onClose:()=>{F(!1),vr(J)}}),t.jsx(qd,{}),A&&t.jsx("div",{className:"flash on"+(z?" err":""),children:A}),h&&t.jsx(Ei,{variant:"acquirer",initialCompany:yr().co,initialWebsite:yr().site,onClose:()=>S(null)})]})})}function Fd(){const{t:e}=$(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function yr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Od(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{co as FlagCell,wt as SigBadge,ka as SigWin,Id as default,Od as fmtShort,$ as useV2};
