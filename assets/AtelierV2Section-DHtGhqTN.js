...
`,ko=yo+wo;function ta(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function jo(){const e=ta("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function No(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=jo();return r==="0"?"client":r==="1"||ta("embed")==="1"&&ta("chrome")==="1"?"apercu":"client"}const So={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Co=e=>So[e],Ie=e=>Object.assign(e,{continent:Er(e.cc)});function Vt(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Eo=60*60*1e3;function zo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Eo?null:a}catch{return null}}function ht(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const To=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ao(e,a,r="default"){const n=r!=="default",o=g.useMemo(()=>e||n?{mode:"anon"}:gr(),[e,n]),i=g.useMemo(()=>n?"visiteur":No(e,o),[e,o,n]),c=g.useMemo(()=>Co(i),[i]),s=i!=="visiteur",p=To(r),[u,d]=g.useState([]),[l,m]=g.useState(""),[h,f]=g.useState(null),[v,b]=g.useState(null),[x,y]=g.useState(null),[j,w]=g.useState(()=>new Map),[C,E]=g.useState(()=>new Map),[A,q]=g.useState(""),[P,N]=g.useState(new Set),[T,k]=g.useState(null),[M,R]=g.useState(!0),[S,L]=g.useState(!1),[D,$]=g.useState(0),[Q,pe]=g.useState(0),_=g.useRef(0),le=g.useMemo(()=>{var G;if(i!=="client")return"";try{return((G=br())==null?void 0:G.email)||""}catch{return""}},[i]);g.useEffect(()=>{const G=++_.current;let U=!0;const K=()=>U&&G===_.current,H=(s&&o.token?o.token:"pub:"+a)+(p?":"+p:""),re=zo(H);return re?(d(re.objs.map(Ie)),re.fund&&m(re.fund),f(re.marketEstimate??null),b(re.criteria??null),y(re.stats??null),q(re.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const ne=await $t(),ue=((ne==null?void 0:ne.recent_ops)||[]).map(ee=>_t(ee,a)).filter(ee=>!!ee).map(ee=>(vr((ee.name||"").trim())||(ee.noCo=!0),ee));try{const ee=await yr(),oe=wr(ee),Ce=((ee==null?void 0:ee.date)||"").slice(0,10);if(oe.length&&Ce){const W=new Set;for(const ce of ue){if(ce.noCo||(ce.date||"").slice(0,10)!==Ce)continue;const ge=(ce.name||"").trim().toLowerCase();if(!(ge.length<3)){for(let me=0;me<oe.length;me++)if(!W.has(me)&&oe[me].t.includes(ge)){W.add(me),ce.decryptHtml=oe[me].html;break}}}}}catch{}if(!K())return;d(ue.map(Ie)),ht(H,{objs:ue})}else if(typeof r=="object"){const ue=(await Ma()||[]).filter(oe=>(oe.slug||"")===r.research).map(oe=>Oa(oe,a)).filter(oe=>!!oe),ee=Vt(await qa(ue,a));if(!K())return;d(ee.map(Ie)),ht(H,{objs:ee})}else if(s&&o.token){const ne=kr(o.token),ue=$t(),ee=jr(o.token),oe=Nr(o.token),Ce=Sr(o.token),W=await ne;let ce=W?W.targets:[];K()&&W&&(m(W.fund||""),f(W.marketEstimate??null),b(W.criteria??null),y(W.stats??null),q(W.generatedAt||""),d(ce.map(Ie)),R(!1),L(!1));const[ge,me,Le,O]=await Promise.all([ue,ee,oe,Ce]),J=((ge==null?void 0:ge.recent_ops)||[]).map(X=>_t(X,a)).filter(X=>!!X);if(ce=[...ce,...J],!K())return;d(ce.map(Ie));const ae=new Set;for(const X of me){const Ee=(X.id||X.co||"").toString().trim().toLowerCase();Ee&&ae.add(Ee.startsWith("t:")?Ee:"t:"+Ee)}N(ae),w(Le),E(O),W&&ht(H,{fund:W.fund,marketEstimate:W.marketEstimate,criteria:W.criteria,stats:W.stats,generatedAt:W.generatedAt,objs:ce})}else{const ne=Cr(),ue=Ma(),ee=$t(),oe=await ne;K()&&oe.length&&(d(Vt(oe).map(Ie)),R(!1),L(!1));const[Ce,W]=await Promise.all([ue,ee]),ce=(Ce||[]).map(O=>Oa(O,a)).filter(O=>!!O),ge=await qa(ce,a),me=((W==null?void 0:W.recent_ops)||[]).map(O=>_t(O,a)).filter(O=>!!O),Le=Vt([...oe,...ge,...me]);if(!K())return;d(Le.map(Ie)),ht(H,{objs:Le})}K()&&L(!1)}catch{K()&&!re&&L(!0)}finally{K()&&R(!1)}})(),()=>{U=!1}},[s,o.token,a,D,p]),g.useEffect(()=>{if(!c.showCredits||!le){k(null);return}let G=!0;return(async()=>{try{const U=await fetch(`${ba}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:le})});if(!U.ok)return;const K=await U.json();G&&K&&K.ok!==!1&&k(K)}catch{}})(),()=>{G=!1}},[c.showCredits,le,Q]);const V=g.useCallback(G=>N(new Set(G)),[]);return{session:o,mode:i,caps:c,fund:l,email:le,marketEstimate:h,generatedAt:A,criteria:v,stats:x,thumbs:j,stages:C,dossiers:u,favIds:P,setFavIds:V,credits:T,reloadCredits:()=>pe(G=>G+1),loading:M,error:S,refresh:()=>$(G=>G+1)}}const zn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Lo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...zn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Ro(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:zn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Tn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Tn=40;function ja(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!he(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(va(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(Qe(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&$e(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(o))return!1}return!0}function An(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ja(e,a.filters,r)}function Mo(e,a,r,n){return!(!An(e,a,r)||r&&!zr(e,a.ptab,n))}function Na(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-Qe(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const i=he(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const c=n(o),s=n(i);return c<s?-a.dir:c>s?a.dir:(o.name||"").localeCompare(i.name||"")})}function Oo(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i}=F(),c=g.useMemo(()=>{const p=(a.filters.day||"").slice(0,10),u=h=>!(!i&&a.continent!=="monde"&&h.continent!==a.continent||p&&(h.date||"").slice(0,10)!==p),d=e.filter(h=>u(h)&&he(h)),l=e.filter(h=>u(h)&&h.kind==="op"&&!he(h)&&(p?!0:Qe(h.date)<=7)),m=p||new Date().toISOString().slice(0,10);return l.sort((h,f)=>{const v=(h.date||"").slice(0,10)===m?0:1,b=(f.date||"").slice(0,10)===m?0:1;return v!==b?v-b:(f.amountEur||0)-(h.amountEur||0)}),[...Na(d,{key:"signal",dir:-1}),...l].slice(0,48)},[e,a.continent,a.filters.day,i]),s=p=>c.map(u=>t.jsxs("button",{type:"button",className:"tk"+(we(u)?" spent":""),onClick:d=>{const l=d.currentTarget.getBoundingClientRect();n({type:"popup",id:u.id,anchor:{x:l.left+l.width/2,y:l.bottom}})},title:u.name+(u.tagline?" — "+u.tagline:""),children:[t.jsx(et,{o:u}),t.jsxs("span",{className:"who",children:[t.jsx(ar,{o:u}),t.jsx("span",{className:"co",children:u.name})]}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{className:"am",children:tl(u.amountEur)}),u.sector&&t.jsx("span",{className:"mt",children:u.sector}),t.jsx(Dt,{o:u}),t.jsx("span",{className:"tkgo",children:"→"})]},p+(u.id||u.name)));return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live,t.jsx("span",{className:"cnt",children:c.length})]}),t.jsx("div",{className:"win",children:c.length?t.jsxs("div",{className:"run",children:[s(0),s(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})})]})}const qo="aDx8z7Hzksus",Ln="+33 6 83 10 72 86",Va="alexandre@proplace.co",Fo=`tel:${Ln.replace(/[^\d+]/g,"")}`,Ha="pp-rdv-slot";function Po(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Do(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:Bo}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Fo,children:Ln}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Va}`,children:Va})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([o,i],c)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(c+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(ho,{filloutId:qo,parameters:r?{company_name:r}:void 0})})]})}function Io(){const[e,a]=g.useState(()=>typeof document>"u"?null:document.getElementById(Ha));return g.useEffect(()=>{e||a(document.getElementById(Ha))},[e]),e?Je.createPortal(t.jsx(Do,{}),e):null}const Bo=`
...
`;class fe extends g.Component{constructor(){super(...arguments);La(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const $o=8;function _o(){const{t:e,lang:a,token:r,dossiers:n,caps:o,markRow:i,dispatch:c}=F(),[s,p]=g.useState(!1),[u,d]=g.useState(!1),[l,m]=g.useState(!1),h=r||"home",{names:f,verdicts:v}=g.useMemo(()=>{const w=[],C={};return n.forEach(E=>{E.kind!=="target"||!E.name||(w.push(E.name),C[E.name]=Tr(E)||"")}),{names:w,verdicts:C}},[n]),b=g.useMemo(()=>f.length?Ar(h,f,v,a):null,[h,f.length]);if(!o.pipe||s||!b||b.firstVisit||!b.added.length&&!b.gone.length)return null;const x=u?b.added:b.added.slice(0,$o),y=b.added.length-x.length,j=w=>{const C=n.find(E=>E.name===w);C&&(i(C.id),c({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(b.added.length,b.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Lr(h,f,v,b.fp,a)},children:"×"})]}),!!b.added.length&&t.jsxs("div",{className:"since-c",children:[x.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!b.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>m(w=>!w),children:e.sinceOut(b.gone.length)}),l&&b.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Ht=600,Be=62,Ya="atl2:fstats";function Uo(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=F(),[c,s]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Ya)==="on"}catch{return!1}}),p=r.stats,u=g.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=g.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const l=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,m=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),h=u.reduce((y,j)=>Math.max(y,j.s||0),0),f=u.length?Ht/u.length:0,v=Math.max(4,f-4),b=u.length>=5&&h>0,x=[[p.screened,e.funScreened(l(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(c?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[x.map(([y,j,w],C)=>t.jsxs("span",{className:"fst-t",children:[C>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(y)}),t.jsx("i",{children:j}),c&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),b&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":c,title:c?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!c;s(y),y&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Ya,y?"on":"off")}catch{}},children:c?"⌃":"⌄"})]}),c&&b&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ht} ${Be}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[u.map((y,j)=>{const w=(y.s||0)/h*(Be-4),C=(y.m||0)/h*(Be-4),E=j*f+(f-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${l(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:E,y:Be-2-w,width:v,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:E,y:Be-2-C,width:v,height:C,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Be-1.5,x2:Ht,y2:Be-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:l(u[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Vo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Ho({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=F(),[i,c]=g.useState(""),[s,p]=g.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const u=(e.ceoStatus||"").trim(),d=(Xe(e)||"").startsWith("CALL")&&ve(e)===3,l=ve(e)>=2,m=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;c(f);const v=await o(e,f);c(""),v&&(p(!0),setTimeout(()=>p(!1),2200))},h=d?[["Validé",a.csYes],["Écarté",a.csNo]]:Vo.filter(([f])=>!(l&&f==="Retenu")).map(([f,v])=>[f,a[v]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([f,v])=>t.jsx("button",{type:"button",className:"csb"+(u===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{m(f)},children:v},f)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Yo,{o:e})]})}function Yo({o:e}){const{t:a,saveNote:r,flash:n}=F(),[o,i]=g.useState(e.ceoNote||""),[c,s]=g.useState(!1),[p,u]=g.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),l=async()=>{if(c||!d)return;s(!0);const m=await r(e,o.trim());s(!1),m&&(u(!0),setTimeout(()=>u(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:c,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&l()}}),t.jsx("button",{type:"button",disabled:c||!d,onClick:()=>{l()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Wo({placeholder:e,onDone:a}){const{t:r}=F(),[n,o]=g.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Go({o:e}){var b;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:c,flashErr:s}=F(),[p,u]=g.useState(!1);if(!n.pipe||!o||n.lockActions||ve(e)!==4)return null;const d=i(e),l=(d==null?void 0:d.stage)||"todo",m=async x=>{if(p||x===l)return;u(!0);const y=d;c(e,{stage:x,stamps:(d==null?void 0:d.stamps)||{}});const j=Math.max(Date.now(),Wa+=1);Wa=j;const w=await Rr(r,{company:e.name||"",stage:x,cts:j,deal_id:e.airtableId,check_id:e.checkId});u(!1),!w.stale&&(w.ok||(c(e,y),s(a.actErr)))},h=(b=d==null?void 0:d.stamps)==null?void 0:b.sent,f=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,v=l==="sent"&&h&&f>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,y])=>t.jsx("button",{type:"button",className:"stgb"+(l===x?" on":""),disabled:p,onClick:()=>{m(x)},children:y},x)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let Wa=0;const gt=8,bt=340;function Ga({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Ko({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,scoped:i,byId:c,st:s}=F(),[p,u]=g.useState(0),[d,l]=g.useState(null),[m,h]=g.useState([]),f=g.useRef(!1);g.useEffect(()=>{f.current||(f.current=!0,h(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const v=m[p],b=p>=m.length;g.useEffect(()=>{v&&(v.ptab!==void 0&&s.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&s.dens!==v.dens&&n({type:"dens",dens:v.dens}))},[p,v]);const x=g.useCallback(()=>{if(!v){l(null);return}const C=document.querySelector(v.sel);if(!C){l(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),l(C.getBoundingClientRect())},[v]);g.useLayoutEffect(()=>{x();const C=window.setTimeout(x,260),E=()=>x();return window.addEventListener("scroll",E,!0),window.addEventListener("resize",E),()=>{window.clearTimeout(C),window.removeEventListener("scroll",E,!0),window.removeEventListener("resize",E)}},[x]);const y=g.useRef(a);if(y.current=a,g.useEffect(()=>{const C=E=>{E.key==="Escape"?(E.preventDefault(),E.stopPropagation(),y.current()):E.key==="ArrowRight"?u(A=>A+1):E.key==="ArrowLeft"&&u(A=>Math.max(0,A-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!m.length)return null;let j=null;if(b){const C=o[3]||0,E=i.find(A=>A.memoUrl)||[...c.values()].find(A=>A.memoUrl);C>0?j={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:E?j={title:r.ahaBTitle,body:r.ahaBBody(E.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:E.id}),a()}}:j={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:bt};if(!b&&d){const C=d.bottom+14,A=window.innerHeight-C>190?C:Math.max(12,d.top-200);w={left:Math.min(Math.max(12,d.left+d.width/2-bt/2),window.innerWidth-bt-12),top:A,width:bt}}return Je.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!b&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-gt,top:d.top-gt,width:d.width+gt*2,height:d.height+gt*2}}),(b||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(b?" fin":""),style:w,children:[b&&j?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:j.title}),t.jsx("p",{children:t.jsx(Ga,{text:j.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>u(m.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:j.go,children:j.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(p+1,m.length)}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx("p",{children:t.jsx(Ga,{text:(v==null?void 0:v.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>u(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>u(C=>C+1),children:p===m.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Qo(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,dispatch:c}=F(),s=r?a:e,p=g.useMemo(()=>s.filter(x=>Qe(x.date)===0&&x.kind==="target"),[s]),u=g.useMemo(()=>r?a.filter(x=>ve(x)===0).slice().sort((x,y)=>(y.date||"").localeCompare(x.date||"")):[],[a,r]),d=g.useMemo(()=>p.filter(x=>r?ve(x)===0:!we(x)),[p,r]),l=r?u:d,m=r?a.length-u.length:p.length-d.length,h=r?a.length:p.length,f=h?Math.min(100,m/h*100):100;let v;r?v=o.morningThesis(p.length,u.length):p.length?m===0?v=o.goalSourced(p.length):m>=p.length?v=o.goalCleared:v=o.goalDone(m,p.length):v=o.goalSourced(0);const b=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&u.length&&c({type:"chainStart",queue:u.map(x=>x.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:v}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:f+"%"}})}),l.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:b,children:r?o.morningEval(l.length):i.pileMode?o.goalContinue(l.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Jo(){var N,T;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:c,dossiers:s,mode:p,doSync:u,startTour:d}=F(),[l,m]=g.useState(null),[h,f]=g.useState([]),v=p==="client";g.useEffect(()=>{if(!o||!i)return;let k=!0;return(async()=>{const[M,R]=await Promise.all([ya(i),Nn(o)]);k&&(M&&m(M),f(R))})(),()=>{k=!1}},[o,i]);const b=(l==null?void 0:l.per_day)??null,x=((N=l==null?void 0:l.pool_order)==null?void 0:N.length)??0,y=h.filter(k=>k.status==="running").length,j=g.useMemo(()=>s.filter(k=>k.kind==="target"&&we(k)).length,[s]),w=c.marketEstimate,C=typeof((T=c.stats)==null?void 0:T.screened)=="number"?c.stats.screened:j,E=w&&w>0?Math.min(100,Math.round(C/w*100)):null,A=k=>k.toLocaleString(a==="en"?"en-US":"fr-FR"),q=(i||"P").split(/\s+/).map(k=>k[0]).join("").slice(0,2).toUpperCase(),P=(()=>{const k=Date.parse(c.generatedAt||"");if(Number.isNaN(k))return"";const M=new Date(k),R=S=>String(S).padStart(2,"0");return`${R(M.getDate())}/${R(M.getMonth()+1)} à ${R(M.getHours())}:${R(M.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:q}),t.jsx("i",{children:i})]}),t.jsx("h1",{children:e.identTitle(i||"…")}),t.jsx("span",{className:"idsp"}),P&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(P)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[E===null&&C>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:A(C)})})]}),E!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:E+"%"}})}),t.jsxs("b",{children:[E," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(C,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),b!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:b})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),b===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(x)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:k=>{k.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!v,onClick:u,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:k=>n({type:"filters",patch:{search:k.target.value}})})]})]})]})}function Xo(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,o],i)=>{const c=i===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(c?" go":""),children:[t.jsx("span",{className:"s4n",children:i+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:o}),c&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},i)})})]})}const Zo=["--p0","--p1","--p2","--p3","--p4"];function ei(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o}=F(),i=g.useRef({});g.useEffect(()=>{i.current={...r}},[r]);const c=u=>{const d=i.current[u],l=d!==void 0?r[u]-d:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zo[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(l>0?" up":l<0?" down":""),children:[r[u],l!==0&&t.jsxs("em",{className:"delta",children:[l>0?"+":"−",Math.abs(l)]})]})]},u)},s=(u,d,l)=>t.jsxs("button",{type:"button",className:"off"+(d?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:l.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),p=(u,d,l,m=!1)=>t.jsx("button",{type:"button",className:"tool",title:d,disabled:m,onClick:l,children:u},d);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(c)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,o,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const ti=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function ai(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:c}=F(),s=g.useRef(null),[p,u]=g.useState(60);g.useEffect(()=>{let h=0;const f=()=>{var j;const v=s.current;if(!v)return;const b=(j=v.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!b)return;const x=b.getBoundingClientRect(),y=v.getBoundingClientRect();u(Math.max(20,Math.min(x.left+x.width/2-y.left,y.width-30)))};return h=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(h),window.removeEventListener("resize",f)}},[e.ptab]);const d=e.ptab;let l=r.tuto[d].p;if(d===3){const h=n.filter(b=>b.kind==="target"&&ve(b)===3),f=h.filter(b=>Xt(b)==="auto").length,v=h.filter(b=>Xt(b)==="cd").length;l=r.tutoPending(f,v,h.length)}const m=(()=>{if(c!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(h=>h.id)})};if(d===1){const h=n.filter(f=>f.kind==="target"&&ve(f)===1&&!o.has(f.id)).slice(0,10);if(h.length)return{label:r.tuto[1].a,run:()=>h.forEach(f=>i(f))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":ti[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:l}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label})]})}class _e{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],c=a+i,s=Math.abs(a)<Math.abs(i)?a-(c-i):i-(c-a);s&&(r[n++]=s),a=c}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,c=0;if(r>0){for(c=a[--r];r>0&&(n=c,o=a[--r],c=n+o,i=o-(c-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=c+o,o==n-c&&(c=n))}return c}}function*ni(e){for(const a of e)yield*a}function Rn(e){return Array.from(ni(e))}var Z=1e-6,Y=Math.PI,je=Y/2,Ka=Y/4,Se=Y*2,Re=180/Y,ye=Y/180,te=Math.abs,ri=Math.atan,ct=Math.atan2,ie=Math.cos,se=Math.sin,oi=Math.sign||function(e){return e>0?1:e<0?-1:0},Ve=Math.sqrt;function ii(e){return e>1?0:e<-1?Y:Math.acos(e)}function dt(e){return e>1?je:e<-1?-je:Math.asin(e)}function Ne(){}function Et(e,a){e&&Ja.hasOwnProperty(e.type)&&Ja[e.type](e,a)}var Qa={Feature:function(e,a){Et(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Et(r[n].geometry,a)}},Ja={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){aa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)aa(r[n],a,0)},Polygon:function(e,a){Xa(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Xa(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Et(r[n],a)}};function aa(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Xa(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)aa(e[r],a,1);a.polygonEnd()}function He(e,a){e&&Qa.hasOwnProperty(e.type)?Qa[e.type](e,a):Et(e,a)}function na(e){return[ct(e[1],e[0]),dt(e[2])]}function Ge(e){var a=e[0],r=e[1],n=ie(r);return[n*ie(a),n*se(a),se(r)]}function vt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function zt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Yt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function yt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ra(e){var a=Ve(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function oa(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function ia(e,a){return te(e)>Y&&(e-=Math.round(e/Se)*Se),[e,a]}ia.invert=ia;function si(e,a,r){return(e%=Se)?a||r?oa(en(e),tn(a,r)):en(e):a||r?tn(a,r):ia}function Za(e){return function(a,r){return a+=e,te(a)>Y&&(a-=Math.round(a/Se)*Se),[a,r]}}function en(e){var a=Za(e);return a.invert=Za(-e),a}function tn(e,a){var r=ie(e),n=se(e),o=ie(a),i=se(a);function c(s,p){var u=ie(p),d=ie(s)*u,l=se(s)*u,m=se(p),h=m*r+d*n;return[ct(l*o-h*i,d*r-m*n),dt(h*o+l*i)]}return c.invert=function(s,p){var u=ie(p),d=ie(s)*u,l=se(s)*u,m=se(p),h=m*o-l*i;return[ct(l*o+m*i,d*r+h*n),dt(h*r-d*n)]},c}function li(e,a,r,n,o,i){if(r){var c=ie(a),s=se(a),p=n*r;o==null?(o=a+n*Se,i=a-p/2):(o=an(c,o),i=an(c,i),(n>0?o<i:o>i)&&(o+=n*Se));for(var u,d=o;n>0?d>i:d<i;d-=p)u=na([c,-s*ie(d),-s*se(d)]),e.point(u[0],u[1])}}function an(e,a){a=Ge(a),a[0]-=e,ra(a);var r=ii(-a[1]);return((-a[2]<0?-r:r)+Se-Z)%Se}function Mn(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ne,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ct(e,a){return te(e[0]-a[0])<Z&&te(e[1]-a[1])<Z}function wt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function On(e,a,r,n,o){var i=[],c=[],s,p;if(e.forEach(function(f){if(!((v=f.length-1)<=0)){var v,b=f[0],x=f[v],y;if(Ct(b,x)){if(!b[2]&&!x[2]){for(o.lineStart(),s=0;s<v;++s)o.point((b=f[s])[0],b[1]);o.lineEnd();return}x[0]+=2*Z}i.push(y=new wt(b,f,null,!0)),c.push(y.o=new wt(b,null,y,!1)),i.push(y=new wt(x,f,null,!1)),c.push(y.o=new wt(x,null,y,!0))}}),!!i.length){for(c.sort(a),nn(i),nn(c),s=0,p=c.length;s<p;++s)c[s].e=r=!r;for(var u=i[0],d,l;;){for(var m=u,h=!0;m.v;)if((m=m.n)===u)return;d=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(h)for(s=0,p=d.length;s<p;++s)o.point((l=d[s])[0],l[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(h)for(d=m.p.z,s=d.length-1;s>=0;--s)o.point((l=d[s])[0],l[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,d=m.z,h=!h}while(!m.v);o.lineEnd()}}}function nn(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Wt(e){return te(e[0])<=Y?e[0]:oi(e[0])*((te(e[0])+Y)%Se-Y)}function ci(e,a){var r=Wt(a),n=a[1],o=se(n),i=[se(r),-ie(r),0],c=0,s=0,p=new _e;o===1?n=je+Z:o===-1&&(n=-je-Z);for(var u=0,d=e.length;u<d;++u)if(m=(l=e[u]).length)for(var l,m,h=l[m-1],f=Wt(h),v=h[1]/2+Ka,b=se(v),x=ie(v),y=0;y<m;++y,f=w,b=E,x=A,h=j){var j=l[y],w=Wt(j),C=j[1]/2+Ka,E=se(C),A=ie(C),q=w-f,P=q>=0?1:-1,N=P*q,T=N>Y,k=b*E;if(p.add(ct(k*P*se(N),x*A+k*ie(N))),c+=T?q+P*Se:q,T^f>=r^w>=r){var M=zt(Ge(h),Ge(j));ra(M);var R=zt(i,M);ra(R);var S=(T^q>=0?-1:1)*dt(R[2]);(n>S||n===S&&(M[0]||M[1]))&&(s+=T^q>=0?1:-1)}}return(c<-Z||c<Z&&p<-1e-12)^s&1}function qn(e,a,r,n){return function(o){var i=a(o),c=Mn(),s=a(c),p=!1,u,d,l,m={point:h,lineStart:v,lineEnd:b,polygonStart:function(){m.point=x,m.lineStart=y,m.lineEnd=j,d=[],u=[]},polygonEnd:function(){m.point=h,m.lineStart=v,m.lineEnd=b,d=Rn(d);var w=ci(u,n);d.length?(p||(o.polygonStart(),p=!0),On(d,pi,w,r,o)):w&&(p||(o.polygonStart(),p=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),p&&(o.polygonEnd(),p=!1),d=u=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function h(w,C){e(w,C)&&o.point(w,C)}function f(w,C){i.point(w,C)}function v(){m.point=f,i.lineStart()}function b(){m.point=h,i.lineEnd()}function x(w,C){l.push([w,C]),s.point(w,C)}function y(){s.lineStart(),l=[]}function j(){x(l[0][0],l[0][1]),s.lineEnd();var w=s.clean(),C=c.result(),E,A=C.length,q,P,N;if(l.pop(),u.push(l),l=null,!!A){if(w&1){if(P=C[0],(q=P.length-1)>0){for(p||(o.polygonStart(),p=!0),o.lineStart(),E=0;E<q;++E)o.point((N=P[E])[0],N[1]);o.lineEnd()}return}A>1&&w&2&&C.push(C.pop().concat(C.shift())),d.push(C.filter(di))}}return m}}function di(e){return e.length>1}function pi(e,a){return((e=e.x)[0]<0?e[1]-je-Z:je-e[1])-((a=a.x)[0]<0?a[1]-je-Z:je-a[1])}const rn=qn(function(){return!0},ui,mi,[-Y,-je]);function ui(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,c){var s=i>0?Y:-Y,p=te(i-a);te(p-Y)<Z?(e.point(a,r=(r+c)/2>0?je:-je),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&p>=Y&&(te(a-n)<Z&&(a-=n*Z),te(i-s)<Z&&(i-=s*Z),r=fi(a,r,i,c),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=c),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function fi(e,a,r,n){var o,i,c=se(e-r);return te(c)>Z?ri((se(a)*(i=ie(n))*se(r)-se(n)*(o=ie(a))*se(e))/(o*i*c)):(a+n)/2}function mi(e,a,r,n){var o;if(e==null)o=r*je,n.point(-Y,o),n.point(0,o),n.point(Y,o),n.point(Y,0),n.point(Y,-o),n.point(0,-o),n.point(-Y,-o),n.point(-Y,0),n.point(-Y,o);else if(te(e[0]-a[0])>Z){var i=e[0]<a[0]?Y:-Y;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function xi(e){var a=ie(e),r=2*ye,n=a>0,o=te(a)>Z;function i(d,l,m,h){li(h,e,r,m,d,l)}function c(d,l){return ie(d)*ie(l)>a}function s(d){var l,m,h,f,v;return{lineStart:function(){f=h=!1,v=1},point:function(b,x){var y=[b,x],j,w=c(b,x),C=n?w?0:u(b,x):w?u(b+(b<0?Y:-Y),x):0;if(!l&&(f=h=w)&&d.lineStart(),w!==h&&(j=p(l,y),(!j||Ct(l,j)||Ct(y,j))&&(y[2]=1)),w!==h)v=0,w?(d.lineStart(),j=p(y,l),d.point(j[0],j[1])):(j=p(l,y),d.point(j[0],j[1],2),d.lineEnd()),l=j;else if(o&&l&&n^w){var E;!(C&m)&&(E=p(y,l,!0))&&(v=0,n?(d.lineStart(),d.point(E[0][0],E[0][1]),d.point(E[1][0],E[1][1]),d.lineEnd()):(d.point(E[1][0],E[1][1]),d.lineEnd(),d.lineStart(),d.point(E[0][0],E[0][1],3)))}w&&(!l||!Ct(l,y))&&d.point(y[0],y[1]),l=y,h=w,m=C},lineEnd:function(){h&&d.lineEnd(),l=null},clean:function(){return v|(f&&h)<<1}}}function p(d,l,m){var h=Ge(d),f=Ge(l),v=[1,0,0],b=zt(h,f),x=vt(b,b),y=b[0],j=x-y*y;if(!j)return!m&&d;var w=a*x/j,C=-a*y/j,E=zt(v,b),A=yt(v,w),q=yt(b,C);Yt(A,q);var P=E,N=vt(A,P),T=vt(P,P),k=N*N-T*(vt(A,A)-1);if(!(k<0)){var M=Ve(k),R=yt(P,(-N-M)/T);if(Yt(R,A),R=na(R),!m)return R;var S=d[0],L=l[0],D=d[1],$=l[1],Q;L<S&&(Q=S,S=L,L=Q);var pe=L-S,_=te(pe-Y)<Z,le=_||pe<Z;if(!_&&$<D&&(Q=D,D=$,$=Q),le?_?D+$>0^R[1]<(te(R[0]-S)<Z?D:$):D<=R[1]&&R[1]<=$:pe>Y^(S<=R[0]&&R[0]<=L)){var V=yt(P,(-N+M)/T);return Yt(V,A),[R,na(V)]}}}function u(d,l){var m=n?e:Y-e,h=0;return d<-m?h|=1:d>m&&(h|=2),l<-m?h|=4:l>m&&(h|=8),h}return qn(c,s,i,n?[0,-e]:[-Y,e-Y])}function hi(e,a,r,n,o,i){var c=e[0],s=e[1],p=a[0],u=a[1],d=0,l=1,m=p-c,h=u-s,f;if(f=r-c,!(!m&&f>0)){if(f/=m,m<0){if(f<d)return;f<l&&(l=f)}else if(m>0){if(f>l)return;f>d&&(d=f)}if(f=o-c,!(!m&&f<0)){if(f/=m,m<0){if(f>l)return;f>d&&(d=f)}else if(m>0){if(f<d)return;f<l&&(l=f)}if(f=n-s,!(!h&&f>0)){if(f/=h,h<0){if(f<d)return;f<l&&(l=f)}else if(h>0){if(f>l)return;f>d&&(d=f)}if(f=i-s,!(!h&&f<0)){if(f/=h,h<0){if(f>l)return;f>d&&(d=f)}else if(h>0){if(f<d)return;f<l&&(l=f)}return d>0&&(e[0]=c+d*m,e[1]=s+d*h),l<1&&(a[0]=c+l*m,a[1]=s+l*h),!0}}}}}var nt=1e9,kt=-nt;function gi(e,a,r,n){function o(u,d){return e<=u&&u<=r&&a<=d&&d<=n}function i(u,d,l,m){var h=0,f=0;if(u==null||(h=c(u,l))!==(f=c(d,l))||p(u,d)<0^l>0)do m.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+l+4)%4)!==f);else m.point(d[0],d[1])}function c(u,d){return te(u[0]-e)<Z?d>0?0:3:te(u[0]-r)<Z?d>0?2:1:te(u[1]-a)<Z?d>0?1:0:d>0?3:2}function s(u,d){return p(u.x,d.x)}function p(u,d){var l=c(u,1),m=c(d,1);return l!==m?l-m:l===0?d[1]-u[1]:l===1?u[0]-d[0]:l===2?u[1]-d[1]:d[0]-u[0]}return function(u){var d=u,l=Mn(),m,h,f,v,b,x,y,j,w,C,E,A={point:q,lineStart:k,lineEnd:M,polygonStart:N,polygonEnd:T};function q(S,L){o(S,L)&&d.point(S,L)}function P(){for(var S=0,L=0,D=h.length;L<D;++L)for(var $=h[L],Q=1,pe=$.length,_=$[0],le,V,G=_[0],U=_[1];Q<pe;++Q)le=G,V=U,_=$[Q],G=_[0],U=_[1],V<=n?U>n&&(G-le)*(n-V)>(U-V)*(e-le)&&++S:U<=n&&(G-le)*(n-V)<(U-V)*(e-le)&&--S;return S}function N(){d=l,m=[],h=[],E=!0}function T(){var S=P(),L=E&&S,D=(m=Rn(m)).length;(L||D)&&(u.polygonStart(),L&&(u.lineStart(),i(null,null,1,u),u.lineEnd()),D&&On(m,s,S,i,u),u.polygonEnd()),d=u,m=h=f=null}function k(){A.point=R,h&&h.push(f=[]),C=!0,w=!1,y=j=NaN}function M(){m&&(R(v,b),x&&w&&l.rejoin(),m.push(l.result())),A.point=q,w&&d.lineEnd()}function R(S,L){var D=o(S,L);if(h&&f.push([S,L]),C)v=S,b=L,x=D,C=!1,D&&(d.lineStart(),d.point(S,L));else if(D&&w)d.point(S,L);else{var $=[y=Math.max(kt,Math.min(nt,y)),j=Math.max(kt,Math.min(nt,j))],Q=[S=Math.max(kt,Math.min(nt,S)),L=Math.max(kt,Math.min(nt,L))];hi($,Q,e,a,r,n)?(w||(d.lineStart(),d.point($[0],$[1])),d.point(Q[0],Q[1]),D||d.lineEnd(),E=!1):D&&(d.lineStart(),d.point(S,L),E=!1)}y=S,j=L,w=D}return A}}const sa=e=>e;var Gt=new _e,la=new _e,Fn,Pn,ca,da,Me={point:Ne,lineStart:Ne,lineEnd:Ne,polygonStart:function(){Me.lineStart=bi,Me.lineEnd=yi},polygonEnd:function(){Me.lineStart=Me.lineEnd=Me.point=Ne,Gt.add(te(la)),la=new _e},result:function(){var e=Gt/2;return Gt=new _e,e}};function bi(){Me.point=vi}function vi(e,a){Me.point=Dn,Fn=ca=e,Pn=da=a}function Dn(e,a){la.add(da*e-ca*a),ca=e,da=a}function yi(){Dn(Fn,Pn)}var Ke=1/0,Tt=Ke,pt=-Ke,At=pt,Lt={point:wi,lineStart:Ne,lineEnd:Ne,polygonStart:Ne,polygonEnd:Ne,result:function(){var e=[[Ke,Tt],[pt,At]];return pt=At=-(Tt=Ke=1/0),e}};function wi(e,a){e<Ke&&(Ke=e),e>pt&&(pt=e),a<Tt&&(Tt=a),a>At&&(At=a)}var pa=0,ua=0,rt=0,Rt=0,Mt=0,Ye=0,fa=0,ma=0,ot=0,In,Bn,Te,Ae,ke={point:Ue,lineStart:on,lineEnd:sn,polygonStart:function(){ke.lineStart=Ni,ke.lineEnd=Si},polygonEnd:function(){ke.point=Ue,ke.lineStart=on,ke.lineEnd=sn},result:function(){var e=ot?[fa/ot,ma/ot]:Ye?[Rt/Ye,Mt/Ye]:rt?[pa/rt,ua/rt]:[NaN,NaN];return pa=ua=rt=Rt=Mt=Ye=fa=ma=ot=0,e}};function Ue(e,a){pa+=e,ua+=a,++rt}function on(){ke.point=ki}function ki(e,a){ke.point=ji,Ue(Te=e,Ae=a)}function ji(e,a){var r=e-Te,n=a-Ae,o=Ve(r*r+n*n);Rt+=o*(Te+e)/2,Mt+=o*(Ae+a)/2,Ye+=o,Ue(Te=e,Ae=a)}function sn(){ke.point=Ue}function Ni(){ke.point=Ci}function Si(){$n(In,Bn)}function Ci(e,a){ke.point=$n,Ue(In=Te=e,Bn=Ae=a)}function $n(e,a){var r=e-Te,n=a-Ae,o=Ve(r*r+n*n);Rt+=o*(Te+e)/2,Mt+=o*(Ae+a)/2,Ye+=o,o=Ae*e-Te*a,fa+=o*(Te+e),ma+=o*(Ae+a),ot+=o*3,Ue(Te=e,Ae=a)}function _n(e){this._context=e}_n.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Se);break}}},result:Ne};var xa=new _e,Kt,Un,Vn,it,st,ut={point:Ne,lineStart:function(){ut.point=Ei},lineEnd:function(){Kt&&Hn(Un,Vn),ut.point=Ne},polygonStart:function(){Kt=!0},polygonEnd:function(){Kt=null},result:function(){var e=+xa;return xa=new _e,e}};function Ei(e,a){ut.point=Hn,Un=it=e,Vn=st=a}function Hn(e,a){it-=e,st-=a,xa.add(Ve(it*it+st*st)),it=e,st=a}let ln,Ot,cn,dn;class pn{constructor(a){this._append=a==null?Yn:zi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==cn||this._append!==Ot){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,cn=n,Ot=this._append,dn=this._,this._=o}this._+=dn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Yn(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function zi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Yn;if(a!==ln){const r=10**a;ln=a,Ot=function(o){let i=1;this._+=o[0];for(const c=o.length;i<c;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ot}function Ti(e,a){let r=3,n=4.5,o,i;function c(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),He(s,o(i))),i.result()}return c.area=function(s){return He(s,o(Me)),Me.result()},c.measure=function(s){return He(s,o(ut)),ut.result()},c.bounds=function(s){return He(s,o(Lt)),Lt.result()},c.centroid=function(s){return He(s,o(ke)),ke.result()},c.projection=function(s){return arguments.length?(o=s==null?(e=null,sa):(e=s).stream,c):e},c.context=function(s){return arguments.length?(i=s==null?(a=null,new pn(r)):new _n(a=s),typeof n!="function"&&i.pointRadius(n),c):a},c.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),c):n},c.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(i=new pn(r)),c},c.projection(e).digits(r).context(a)}function Sa(e){return function(a){var r=new ha;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ha(){}ha.prototype={constructor:ha,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ca(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),He(r,e.stream(Lt)),a(Lt.result()),n!=null&&e.clipExtent(n),e}function Wn(e,a,r){return Ca(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],c=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-c*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(i-c*(n[1][1]+n[0][1]))/2;e.scale(150*c).translate([s,p])},r)}function Ai(e,a,r){return Wn(e,[[0,0],a],r)}function Li(e,a,r){return Ca(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),c=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([c,s])},r)}function Ri(e,a,r){return Ca(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),c=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([c,s])},r)}var un=16,Mi=ie(30*ye);function fn(e,a){return+a?qi(e,a):Oi(e)}function Oi(e){return Sa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function qi(e,a){function r(n,o,i,c,s,p,u,d,l,m,h,f,v,b){var x=u-n,y=d-o,j=x*x+y*y;if(j>4*a&&v--){var w=c+m,C=s+h,E=p+f,A=Ve(w*w+C*C+E*E),q=dt(E/=A),P=te(te(E)-1)<Z||te(i-l)<Z?(i+l)/2:ct(C,w),N=e(P,q),T=N[0],k=N[1],M=T-n,R=k-o,S=y*M-x*R;(S*S/j>a||te((x*M+y*R)/j-.5)>.3||c*m+s*h+p*f<Mi)&&(r(n,o,i,c,s,p,T,k,P,w/=A,C/=A,E,v,b),b.point(T,k),r(T,k,P,w,C,E,u,d,l,m,h,f,v,b))}}return function(n){var o,i,c,s,p,u,d,l,m,h,f,v,b={point:x,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),b.lineStart=C},polygonEnd:function(){n.polygonEnd(),b.lineStart=y}};function x(q,P){q=e(q,P),n.point(q[0],q[1])}function y(){l=NaN,b.point=j,n.lineStart()}function j(q,P){var N=Ge([q,P]),T=e(q,P);r(l,m,d,h,f,v,l=T[0],m=T[1],d=q,h=N[0],f=N[1],v=N[2],un,n),n.point(l,m)}function w(){b.point=x,n.lineEnd()}function C(){y(),b.point=E,b.lineEnd=A}function E(q,P){j(o=q,P),i=l,c=m,s=h,p=f,u=v,b.point=j}function A(){r(l,m,d,h,f,v,i,c,o,s,p,u,un,n),b.lineEnd=w,w()}return b}}var Fi=Sa({point:function(e,a){this.stream.point(e*ye,a*ye)}});function Pi(e){return Sa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Di(e,a,r,n,o){function i(c,s){return c*=n,s*=o,[a+e*c,r-e*s]}return i.invert=function(c,s){return[(c-a)/e*n,(r-s)/e*o]},i}function mn(e,a,r,n,o,i){if(!i)return Di(e,a,r,n,o);var c=ie(i),s=se(i),p=c*e,u=s*e,d=c/e,l=s/e,m=(s*r-c*a)/e,h=(s*a+c*r)/e;function f(v,b){return v*=n,b*=o,[p*v-u*b+a,r-u*v-p*b]}return f.invert=function(v,b){return[n*(d*v-l*b+m),o*(h-l*v-d*b)]},f}function Ii(e){return Bi(function(){return e})()}function Bi(e){var a,r=150,n=480,o=250,i=0,c=0,s=0,p=0,u=0,d,l=0,m=1,h=1,f=null,v=rn,b=null,x,y,j,w=sa,C=.5,E,A,q,P,N;function T(S){return q(S[0]*ye,S[1]*ye)}function k(S){return S=q.invert(S[0],S[1]),S&&[S[0]*Re,S[1]*Re]}T.stream=function(S){return P&&N===S?P:P=Fi(Pi(d)(v(E(w(N=S)))))},T.preclip=function(S){return arguments.length?(v=S,f=void 0,R()):v},T.postclip=function(S){return arguments.length?(w=S,b=x=y=j=null,R()):w},T.clipAngle=function(S){return arguments.length?(v=+S?xi(f=S*ye):(f=null,rn),R()):f*Re},T.clipExtent=function(S){return arguments.length?(w=S==null?(b=x=y=j=null,sa):gi(b=+S[0][0],x=+S[0][1],y=+S[1][0],j=+S[1][1]),R()):b==null?null:[[b,x],[y,j]]},T.scale=function(S){return arguments.length?(r=+S,M()):r},T.translate=function(S){return arguments.length?(n=+S[0],o=+S[1],M()):[n,o]},T.center=function(S){return arguments.length?(i=S[0]%360*ye,c=S[1]%360*ye,M()):[i*Re,c*Re]},T.rotate=function(S){return arguments.length?(s=S[0]%360*ye,p=S[1]%360*ye,u=S.length>2?S[2]%360*ye:0,M()):[s*Re,p*Re,u*Re]},T.angle=function(S){return arguments.length?(l=S%360*ye,M()):l*Re},T.reflectX=function(S){return arguments.length?(m=S?-1:1,M()):m<0},T.reflectY=function(S){return arguments.length?(h=S?-1:1,M()):h<0},T.precision=function(S){return arguments.length?(E=fn(A,C=S*S),R()):Ve(C)},T.fitExtent=function(S,L){return Wn(T,S,L)},T.fitSize=function(S,L){return Ai(T,S,L)},T.fitWidth=function(S,L){return Li(T,S,L)},T.fitHeight=function(S,L){return Ri(T,S,L)};function M(){var S=mn(r,0,0,m,h,l).apply(null,a(i,c)),L=mn(r,n-S[0],o-S[1],m,h,l);return d=si(s,p,u),A=oa(a,L),q=oa(d,A),E=fn(A,C),R()}function R(){return P=N=null,T}return function(){return a=e.apply(this,arguments),T.invert=a.invert&&k,M()}}function Gn(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Gn.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,c=i*i;r-=o=(r*(1.007226+i*(.015085+c*(-.044475+.028874*i-.005916*c)))-a)/(1.007226+i*(.015085*3+c*(-.044475*7+.028874*9*i-.005916*11*c)))}while(te(o)>Z&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function $i(){return Ii(Gn).scale(175.295)}function _i(e){return e}function Ui(e){if(e==null)return _i;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],c=e.translate[1];return function(s,p){p||(a=r=0);var u=2,d=s.length,l=new Array(d);for(l[0]=(a+=s[0])*n+i,l[1]=(r+=s[1])*o+c;u<d;)l[u]=s[u],++u;return l}}function Vi(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Hi(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return xn(e,r)})}:xn(e,a)}function xn(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Yi(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Yi(e,a){var r=Ui(e.transform),n=e.arcs;function o(d,l){l.length&&l.pop();for(var m=n[d<0?~d:d],h=0,f=m.length;h<f;++h)l.push(r(m[h],h));d<0&&Vi(l,f)}function i(d){return r(d)}function c(d){for(var l=[],m=0,h=d.length;m<h;++m)o(d[m],l);return l.length<2&&l.push(l[0]),l}function s(d){for(var l=c(d);l.length<4;)l.push(l[0]);return l}function p(d){return d.map(s)}function u(d){var l=d.type,m;switch(l){case"GeometryCollection":return{type:l,geometries:d.geometries.map(u)};case"Point":m=i(d.coordinates);break;case"MultiPoint":m=d.coordinates.map(i);break;case"LineString":m=c(d.arcs);break;case"MultiLineString":m=d.arcs.map(c);break;case"Polygon":m=p(d.arcs);break;case"MultiPolygon":m=d.arcs.map(p);break;default:return null}return{type:l,coordinates:m}}return u(a)}let jt=null;function Wi(){return jt||(jt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Hi(r,n),i=$i().fitExtent([[8,8],[992,492]],{type:"Sphere"}),c=Ti(i),s=(o.features||[]).filter(u=>{var d;return(((d=u.properties)==null?void 0:d.name)||"")!=="Antarctica"}).map(u=>{var m;const d=((m=u.properties)==null?void 0:m.name)||"",l=c(u)||"";return l?{i2:Mr(d)||null,n:d,d:l}:null}).filter(u=>!!u);if(!s.length)return null;const p={};for(const[u,d]of Object.entries(Or)){const l=i(d);l&&(p[u]={x:l[0],y:l[1]})}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p}}catch{return null}})(),jt)}function Gi(e){const[a,r]=g.useState(null);return g.useEffect(()=>{if(!e||a)return;let n=!1;return Wi().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const hn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Nt(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Ki(e,a){const[r,n]=g.useState(1);return g.useEffect(()=>{let o=!0,i=0;const c=()=>{var u;if(!o)return;const p=(u=e.current)==null?void 0:u.getScreenCTM();p&&p.a>0?n(p.a):i=requestAnimationFrame(c)};c();const s=new ResizeObserver(()=>c());return e.current&&s.observe(e.current),window.addEventListener("resize",c),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",c)}},[e,a]),r}function Qi(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:c,lang:s,t:p}=F(),u=g.useRef(null),d=g.useRef(null),l=Gi(e.continent==="monde"),m=e.continent==="monde"?l:wa.find(N=>N.key===e.continent)||null,h=Ki(u,e.continent+":"+e.mapFolded+":"+!!m),[f,v]=g.useState(new Map),[b,x]=g.useState(null);g.useEffect(()=>{const N=u.current;if(!N)return;const T=new Map;N.querySelectorAll("path[data-i2]").forEach(k=>{const M=k.dataset.i2;if(M)try{const R=k.getBBox();R.width>0&&T.set(M,{x:R.x,y:R.y,w:R.width,h:R.height})}catch{}}),v(T)},[e.continent,h,m]);const y=g.useMemo(()=>r.filter(N=>N.cc),[r]),j=g.useMemo(()=>{const N=new Map;return y.forEach(T=>N.set(T.cc,(N.get(T.cc)||0)+1)),N},[y]),w=e.continent==="monde"&&l?l.anchors:null,C=g.useMemo(()=>y.map(N=>{const T=w&&N.cc?w[N.cc]:void 0;if(T){const D=Nt(N.name||N.id||""),$=Nt((N.id||N.name||"")+"·y");return{d:N,x:T.x+(D-.5)*10,y:T.y+($-.5)*10}}const k=N.cc?f.get(N.cc):void 0;if(!k)return null;const M=Nt(N.name||N.id||""),R=Nt((N.id||N.name||"")+"·y"),S=(M-.5)*Math.min(k.w*.55,60),L=(R-.5)*Math.min(k.h*.55,60);return{d:N,x:k.x+k.w/2+S,y:k.y+k.h/2+L}}).filter(N=>!!N),[y,f,w]),E=N=>h>0?N/h:N,A=g.useMemo(()=>n?[0,1,2,3,4,5].map(N=>({c:hn[N],fr:p.plabels[N].toUpperCase(),en:p.plabels[N].toUpperCase(),n:r.filter(T=>T.kind==="target"&&ve(T)===N).length})).filter(N=>N.n>0):Fa.map((N,T)=>({...N,n:r.filter(k=>Pa(k)===T).length})),[r,n,p.plabels]),q=i?c.get(i):null,P=q?C.find(N=>N.d.id===q.id):null;return m?t.jsxs("div",{className:"mapzone",ref:d,children:[t.jsxs("svg",{ref:u,viewBox:m.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?m.fr:m.en,onMouseLeave:()=>{x(null),o(null)},children:[t.jsx("g",{children:m.countries.map((N,T)=>t.jsx("g",{className:"ct"+(N.i2&&j.get(N.i2)?"":" empty"),children:t.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},T))}),t.jsx("g",{children:C.map(N=>{const T=Fa[Pa(N.d)],k=!!he(N.d),M=N.d.kind==="target",R=n&&M?hn[ve(N.d)]:T.c,S=!n&&we(N.d);return t.jsxs("g",{className:"co"+(S?" done":""),onMouseEnter:()=>{var $,Q;const L=($=d.current)==null?void 0:$.getBoundingClientRect(),D=(Q=u.current)==null?void 0:Q.createSVGPoint();if(D&&u.current&&L){D.x=N.x,D.y=N.y;const pe=D.matrixTransform(u.current.getScreenCTM());x({x:pe.x-L.left,y:pe.y-L.top,label:N.d.name+" · "+(Ze(N.d.cc,s)||N.d.countryLabel||"")})}o(N.d.id)},onMouseLeave:()=>{x(null),o(null)},onClick:()=>{var $;const L=($=u.current)==null?void 0:$.createSVGPoint();let D=null;if(L&&u.current){L.x=N.x,L.y=N.y;const Q=L.matrixTransform(u.current.getScreenCTM());D={x:Q.x,y:Q.y}}a({type:"popup",id:N.d.id,anchor:D})},children:[t.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:E(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:E(T.px),fill:R,stroke:k?"#DC2626":"#ffffff",strokeWidth:E(k?2.2:1.3)})]},N.d.id||N.d.name)})}),P&&t.jsx("circle",{className:"ring on",cx:P.x,cy:P.y,r:E(13),fill:"none",stroke:"#0F172A",strokeWidth:E(2)})]}),t.jsx("div",{className:"hov"+(b?" on":""),style:b?{left:b.x,top:b.y}:void 0,children:b==null?void 0:b.label}),t.jsx("div",{className:"legend",children:A.map((N,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":N.c}}),s==="fr"?N.fr:N.en," ",t.jsx("b",{children:N.n})]},T))}),r.some(N=>!N.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(N=>!N.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:d})}function Ji(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Xi(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:o,contName:i,lang:c}=F(),s=e.filters,p=g.useMemo(()=>e.continent==="monde"?r:r.filter(f=>f.continent===e.continent),[r,e.continent]),u=f=>p.filter(v=>f!=="country"&&s.country.length&&!s.country.includes(v.cc||"")?!1:ja(v,s,o,f==="country"?void 0:f)),d=g.useMemo(()=>{const f=u("win"),v=b=>f.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=b).length;return[v(0),v(7),v(30),f.length]},[p,s,o]),l=g.useMemo(()=>s.day?u("win").filter(f=>(f.date||"").slice(0,10)===s.day).length:0,[p,s,o]),m=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),h=(f,v,b,x="fbtn")=>t.jsxs("button",{type:"button",className:x,"aria-expanded":e.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[t.jsx("span",{className:"fl",children:v}),b>0&&t.jsx("span",{className:"n",children:b}),t.jsx("span",{className:"cv",children:"▾"})]},f);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Ji(s.day,c)),t.jsx("b",{children:l})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,v)=>t.jsxs("button",{type:"button","aria-pressed":s.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[n.dates[v],t.jsx("b",{children:d[v]})]},f))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):h("sec",n.fSector,s.sector.length),h("pay",n.fCountry,s.country.length),h("det",n.fEngine,s.engine.length),h("sta",n.fStage,s.stage.length),o&&h("ang","Angle",s.angle.length),o&&h("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),m>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,i),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(m)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Zi,{poolFor:u})]})}function Zi({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=F(),i=a.filters,c=a.openFacet,{title:s,cols:p,options:u}=g.useMemo(()=>{if(c==="sig"){const f=e("signal").filter(x=>he(x)),v=new Map;f.forEach(x=>{const y=x.engine||"";v.set(y,(v.get(y)||0)+1)});const b=[{v:"*",label:n.fpSigAll,n:f.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Zt([...v.keys()],o).map(x=>({v:x,label:We(x)+" "+Oe(x,o),n:v.get(x)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:b}}if(c==="sec"){const f=e("sector"),v=new Map;return f.forEach(b=>{b.sector&&v.set(b.sector,(v.get(b.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((b,x)=>x[1]-b[1]).map(([b,x])=>({v:b,label:b,n:x,html:!1,on:i.sector.includes(b)}))}}if(c==="pay"){const f=e("country"),v=new Map;return f.forEach(b=>{b.cc&&v.set(b.cc,(v.get(b.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((b,x)=>x[1]-b[1]).map(([b,x])=>({v:b,label:Ze(b,o)||b,n:x,html:!1,on:i.country.includes(b)}))}}if(c==="det"){const f=e("engine"),v=new Map;return f.forEach(b=>{b.engine&&v.set(b.engine,(v.get(b.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Zt([...v.keys()],o).map(b=>({v:b,label:We(b)+" "+Oe(b,o)+' <span style="color:var(--dim);font-size:10px">· '+qr(Fr(b),o)+"</span>",n:v.get(b)||0,html:!0,on:i.engine.includes(b)}))}}if(c==="ang"){const f=e("angle"),v=new Map;return f.forEach(b=>{b.angle&&v.set(b.angle,(v.get(b.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((b,x)=>x[1]-b[1]).map(([b,x])=>({v:b,label:b.replace(/[_-]+/g," "),n:x,html:!1,on:i.angle.includes(b)}))}}if(c==="mem"){const f=e("memoLevel"),v=new Map;f.forEach(x=>{if(x.kind==="target"){const y=va(x);v.set(y,(v.get(y)||0)+1)}});const b=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:b[x],n:v.get(x)||0,html:!1,on:i.memoLevel.includes(x)}))}}const m=e("stage"),h=new Map;return m.forEach(f=>{f.stage&&h.set(f.stage,(h.get(f.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((f,v)=>v[1]-f[1]).map(([f,v])=>({v:f,label:f,n:v,html:!1,on:i.stage.includes(f)}))}},[c,a,o]),d=m=>{if(c==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const f=i.signalEngines.includes(m)?i.signalEngines.filter(v=>v!==m):[...i.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(c==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage",value:m})},l=()=>{r(c==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:c==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:l,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:u.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>d(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}const gn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function es(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function ts(){var Le;const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:c,evalBusy:s,evalCards:p,caps:u,data:d}=F(),l=a==="client",[m,h]=g.useState(""),[f,v]=g.useState(!1),[b,x]=g.useState(""),[y,j]=g.useState(!1),[w,C]=g.useState(""),[E,A]=g.useState([]),q=g.useRef(!1),[P,N]=g.useState(!1),[T,k]=g.useState(""),[M,R]=g.useState(""),[S,L]=g.useState(!1),[D,$]=g.useState(0),[Q,pe]=g.useState(""),[_,le]=g.useState(null),[V,G]=g.useState(null),U=g.useRef(!1),K=m.trim()?gn.test(m.trim())?e.evalUrl:e.evalName:e.evalWaiting,H=g.useMemo(()=>b.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[b]);g.useEffect(()=>{if(typeof window>"u")return;const O=(new URLSearchParams(window.location.search).get("rs")||"").trim();!O||!/^https?:\/\//i.test(O)||(k(O),N(!0))},[]),g.useEffect(()=>{const O=J=>{var X;const ae=String(((X=J.detail)==null?void 0:X.url)||"").trim();!ae||!/^https?:\/\//i.test(ae)||(k(ae),N(!0))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]);const re=E.length?E:p,ne=d.credits;g.useEffect(()=>{if(!S)return;$(0);const O=window.setInterval(()=>$(J=>J+1),1e3);return()=>window.clearInterval(O)},[S]);const ue=()=>{const O=m.trim();O&&(o(null,O),h(""))},ee=async()=>{if(!l){o(null,H[0]||"");return}if(!H.length||y)return;j(!0),q.current=!1;const O=[];for(let J=0;J<H.length&&!q.current;J++){C(e.evaluating(J+1,H.length,H[J]));const ae=await Sn(r,H[J],"atelier2");if(O.unshift({name:ae.company||H[J],verdict:ae.verdict,reason:ae.reason||"",remaining:ae.remaining??null}),A([...O]),ae.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(H.length-J-1),remaining:0}),A([...O]),x(H.slice(J+1).join(`
`)),C(""),j(!1);return}}C(""),x(q.current?H.slice(O.length).join(`
`):""),j(!1)},oe=async()=>{var ae;if(U.current)return;const O=T.trim().replace(/\s+/g,""),J=M.trim();if(!O&&!J){pe(e.rsNeed);return}if(!l){o(null,O||J.slice(0,80));return}U.current=!0,pe(""),le(null),G(null),L(!0);try{const X=await Dr({url:O,text:J,email:n,cbToken:r});if(L(!1),!X||X.status!=="success"){pe((X==null?void 0:X.message)||"Erreur");return}le(X),N(!1);const Ee=(((ae=X.prospective)==null?void 0:ae.companies_to_evaluate)||[]).map(Fe=>((Fe==null?void 0:Fe.name)||"").trim()).filter(Boolean);Ee.length&&(x(Fe=>{const ft=Fe.split(`
`).map(Pe=>Pe.trim()).filter(Boolean),It=new Set(ft.map(Pe=>Pe.toLowerCase())),Bt=Ee.filter(Pe=>!It.has(Pe.toLowerCase()));return[...ft,...Bt].slice(0,15).join(`
`)}),v(!0)),G({state:"pending"});const qe=await Ir(X,{email:n,cbToken:r});G(qe.ok&&qe.url?{state:"ok",url:qe.url}:{state:"fail",msg:qe.error||""})}finally{U.current=!1,L(!1)}},Ce=(((Le=_==null?void 0:_.prospective)==null?void 0:Le.companies_to_evaluate)||[]).filter(O=>O&&O.name),W=[_==null?void 0:_.industry,...(_==null?void 0:_.market_tags)||[],_==null?void 0:_.author].map(O=>(O||"").trim()).filter(Boolean),ce=(V==null?void 0:V.state)==="pending",ge=V&&(ce?t.jsx("span",{className:"rslink pend",children:e.rsPublishing}):V.state==="ok"?t.jsx("a",{className:"rslink",href:V.url,target:"_blank",rel:"noopener noreferrer",children:e.rsLink}):t.jsx("span",{className:"rslink fail",title:V.msg,children:e.rsPublishFail})),me=f&&Ce.length>0;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:m,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:O=>h(O.target.value),onKeyDown:O=>{O.key==="Enter"&&ue()}}),t.jsx("span",{className:"detect"+(gn.test(m.trim())?" url":""),children:K})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:ue,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),u.showCredits&&ne&&t.jsxs("button",{type:"button",className:"credits"+(ne.total_available<=0&&!ne.unlimited?" empty":""),onClick:()=>c({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ne.unlimited?"∞":ne.total_available}),!ne.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ne.daily_grant+ne.purchased]}),ne.total_available<=0&&!ne.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>v(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(P?" on":""),onClick:()=>N(!P),children:e.rsOpen})]}),P&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:T,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:O=>k(O.target.value),onKeyDown:O=>{O.key==="Enter"&&oe()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:M,placeholder:e.rsTextPh,onChange:O=>R(O.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(S?" loading":""),style:{justifyContent:"center"},disabled:S||ce||!T.trim()&&!M.trim(),onClick:()=>{oe()},children:[t.jsx("span",{className:"fill"}),S?`${Pr(T.trim())==="youtube"&&T.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(D)}`:ce?e.rsPublishing:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),Q&&t.jsx("div",{className:"rserr",children:Q}),_&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:_.title}),_.source_url&&t.jsx("a",{href:_.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{le(null),G(null)},children:"×"})]}),_.market&&t.jsx("p",{className:"rsmk",children:_.market}),W.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),W.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[_.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${_.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:es(_.summary_md||"").map((O,J)=>t.jsx("p",{children:O},J))})]}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Ce.length)}),!me&&ge]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:b,placeholder:e.bulkPh,onChange:O=>x(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(y?" loading":""),style:{justifyContent:"center"},disabled:y||!H.length,onClick:()=>{ee()},children:[t.jsx("span",{className:"fill"}),y&&w?w:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(H.length)}),me&&ge]})]}),re.slice(0,1).map((O,J)=>{const ae=O.verdict==="kept",X=O.verdict==="quota",Ee=ae?"var(--brand)":X?"var(--bolt)":"var(--red)",qe=ae?"var(--brand-l)":X?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ee,"--bgc":qe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ae?"✓ "+e.kept:X?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!X&&t.jsx("button",{type:"button",className:"go",onClick:()=>c({type:"modal",modal:"space"}),children:e.seeSpace(ae?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),l&&(i.kept+i.dropped>0||re.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>c({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function as(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ns(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=F(),i=e.memoConsole?r.get(e.memoConsole):null,c=g.useMemo(()=>i?[i.reasoning||"",as(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const s=Xe(i),p=va(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:c?c.split(`

`).map((u,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:u},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[ka(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Kn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=F(),[c,s]=g.useState(!1),[p,u]=g.useState(null);if(!n.pipe||o!=="client"||n.lockActions)return null;const d=async()=>{if(c)return;s(!0);const l=await Br(r,e);if(s(!1),!l){i(a.actErr);return}u(l.results||[])};return t.jsxs("div",{className:"simb",onClick:l=>l.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:c,onClick:()=>{d()},children:c?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(l=>t.jsxs("li",{children:[t.jsx("b",{className:l.verdict==="kept"?"ok":"ko",children:l.company}),l.reason&&t.jsx("span",{children:l.reason})]},l.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function Ea({spec:e}){const a=g.useRef(null),r=g.useRef(null),[n,o]=g.useState(!1);return g.useEffect(()=>{const i=a.current;if(!i)return;let c=!1;return Da({kind:"op",card:e},Math.max(240,i.clientWidth||320)).then(s=>{!c&&s&&i.isConnected&&i.replaceChildren(s)}),()=>{c=!0,i.replaceChildren()}},[e]),g.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let c=!1;Da({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!c&&p&&i.isConnected&&i.replaceChildren(p)});const s=p=>{p.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{c=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>o(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&Je.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const rs=`
...
`;function os(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,c=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:c,top:s}}function is(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:c,askEvaluate:s,doAnalyse:p,doDecide:u,doPromote:d,doRepeche:l,doApproach:m,doDeep:h,doOnboard:f,outbound:v,evalBusy:b}=F(),x=e.popupId?r.get(e.popupId):null;if(!x)return null;const y=he(x),j=ve(x),w=Xe(x),C=x.kind==="target",E=A=>{a({type:"filters",patch:A}),a({type:"popup",id:null})};return Je.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:rs}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:os(e.popupAnchor,!!x.card),onClick:A=>A.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:x.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Qe(x.date)),Oe(x.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[x.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>E({country:[x.cc]}),children:(Ze(x.cc,o)||x.countryLabel||"").toUpperCase()}),x.sector&&t.jsx("button",{type:"button",onClick:()=>E({sector:[x.sector]}),children:x.sector.toUpperCase()}),x.stage&&t.jsx("button",{type:"button",onClick:()=>E({stage:[x.stage]}),children:x.stage.toUpperCase()}),typeof x.amountEur=="number"&&x.amountEur>0&&t.jsx("span",{className:"am2",children:Ft(x.amountEur,o)})]}),(x.tagline||x.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:x.tagline||x.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[We(x.engine)," ",t.jsx("b",{children:Oe(x.engine,o)})," — ",$r(x.engine,o),x.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",x.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(et,{o:x,lg:!0})," ",t.jsx(Dt,{o:x,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Cn(y,o))," · ",n.win7(En(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),x.card?t.jsx(Ea,{spec:x.card}):null,x.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:x.reasoning})]}),i.pipe&&C&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof x.score=="number"&&x.score>0?" · "+n.score(x.score):""]})})]}),t.jsx(Kn,{name:x.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||c!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:b,onClick:()=>s(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(x,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{u(x,!1),a({type:"popup",id:null})},children:n.actNo}),ka(x)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{h(x),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{l(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),x.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:x.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{f(x),a({type:"popup",id:null})},children:"🚀"})]}):x.engine==="media"&&x.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var A;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.url}}))}catch{}a({type:"popup",id:null}),(A=document.querySelector(".atl2 .demand"))==null||A.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:b,title:n.evalGoOn(x.name),onClick:()=>s(x),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:b,onClick:()=>s(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)," →"]}),x.website&&t.jsx("a",{className:"psite",href:x.website.startsWith("http")?x.website:"https://"+x.website,target:"_blank",rel:"noopener noreferrer",title:x.website,children:"🌐"})]})]})]}),document.body)}const ss=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),St=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ls(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=St(a.slice(n));break}r+=St(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=St(a.slice(o));break}const c=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(c),p=s?s[2].toLowerCase():"";s&&ss.has(p)?r+=`<${s[1]}${p}>`:r+=St(a.slice(o,i+1)),n=i+1}return r}const bn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function xe({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function cs({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=F(),i=Pt(e),c=Xe(e),s=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,u=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),l=g.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(c?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:u},{k:"suivi",lib:a.cdSuivi,n:d}].filter(v=>v.n>0),[e,a,s,c,p,u,d]),[m,h]=g.useState("");if(!l.length)return null;const f=l.some(v=>v.k===m)?m:l[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:l.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":f===v.k,className:f===v.k?"on":"",onClick:b=>{b.stopPropagation(),h(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[f==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),c&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:c}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(xe,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(xe,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(xe,{k:a.cdVerdictDate,v:bn(e.verdictDate,r)})]})]}),f==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:ls(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(ds,{o:e})]}),f==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(xe,{k:a.cdSector,v:e.sector}),t.jsx(xe,{k:a.cdStage,v:e.stage}),t.jsx(xe,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(xe,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(xe,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(xe,{k:a.cdAngle,v:e.angle}),t.jsx(xe,{k:a.cdDetected,v:bn(e.date,r)})]}),f==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(xe,{k:a.cdName,v:e.contactName}),t.jsx(xe,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(xe,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),f==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(xe,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(xe,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function ds({o:e}){const{t:a,token:r}=F(),[n,o]=g.useState(!1),[i,c]=g.useState(null),s=async()=>{n||(o(!0),c(await _r(r,e.name,e.website||e.domain||"")),o(!1))},p=(i==null?void 0:i.blocs)||{},u=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=u.some(([,l])=>l);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[u.filter(([,l])=>l).map(([l,m])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:l}),t.jsx("p",{children:m})]},l)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}const Qn={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function za({o:e}){const{t:a}=F(),r=Pt(e),n=Xe(e),o=ve(e),i=Xt(e),c=Ur(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(Qn[n]||"v-cons"),title:a.vt[n],children:n}):o===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,o===3&&i==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),o===3&&i==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),o===3&&c!==null&&t.jsx("span",{className:"wait2 "+(c>10?"hot":c>=5?"warm":""),title:a.waitTitle(c),children:a.waitChip(c)})]})}const ga=e=>e.length>22?e.slice(0,21)+"…":e;function Qt({o:e,compact:a=!1}){const{t:r,askEvaluate:n,evalBusy:o,lang:i}=F(),[c,s]=g.useState(!1);if(g.useEffect(()=>{o||s(!1)},[o]),we(e)){const d=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":d?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[d?"✓":"✗"," ",t.jsx("b",{children:d?r.kept:r.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const u=c&&o;return t.jsxs("button",{type:"button",className:"rev"+(a?" rev-min":"")+(u?" loading":""),disabled:o,title:r.evalGoOn(e.name),onClick:d=>{d.stopPropagation(),s(!0),n(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a?"⚡":r.evalGoOn(ga(e.name))})]})}function ps({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:c,doPromote:s,doRepeche:p,doApproach:u,dispatch:d}=F();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:h=>{h.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.engine==="media"&&e.url?t.jsxs("span",{className:"cell cell-duo",children:[t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:h=>{var f;h.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(f=document.querySelector(".atl2 .demand"))==null||f.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]}),!e.noCo&&t.jsx(Qt,{o:e,compact:!0})]}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Qt,{o:e})});const l=ve(e),m=h=>f=>{f.stopPropagation(),h()};if(l===0)return t.jsx("span",{className:"cell",children:t.jsx(Qt,{o:e})});if(l===1){const h=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:h,onClick:m(()=>i(e)),children:h?a.actAnalyseQueued:a.actAnalyse})})}if(l===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:m(()=>c(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:m(()=>c(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(l===4){const h=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:h,onClick:m(()=>u(e)),children:h?a.actApproachSent:a.actApproach})})}return l===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):l===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:m(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function us({o:e}){const{t:a,doThumb:r,thumbOf:n}=F(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function fs({o:e}){const{lang:a}=F();return he(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(et,{o:e}),t.jsx(Dt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[We(e.engine||"")," ",Oe(e.engine||"",a)]})})}function ms({o:e,locked:a,open:r,onToggle:n}){const{st:o,dispatch:i,caps:c,markRow:s,markedId:p,favIds:u,toggleFav:d}=F(),l=ve(e),m=["#0F172A","#475C6E","#8798A8","#B9C6D2"],h=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,f=h<=0?0:h<=7?1:h<=30?2:3,v=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][l]:m[f],b=u.has(e.id),x=y=>{if(a)return;if(c.pipe||e.kind==="op"){n();return}const j=y.currentTarget.getBoundingClientRect();i({type:"popup",id:e.id,anchor:{x:j.left+Math.min(280,j.width/3),y:j.bottom}})};return t.jsxs(g.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:x,children:[t.jsx("span",{className:"pt",style:{"--c":v}}),t.jsx(ar,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:b?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:b?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""})]}),t.jsx(xs,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(fs,{o:e}),c.pipe&&t.jsx(za,{o:e}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(ps,{o:e}),c.showThumbs&&t.jsx(us,{o:e})]}),(r||o.dens==="deplie")&&!a&&t.jsx(gs,{o:e})]})}function xs({o:e}){const{lang:a,caps:r}=F();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ft(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function hs({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o}=F(),i=(()=>{const d=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return d?d[1].slice(0,40):""})(),c=Ft(e.amountEur,r),s=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=we(e),u=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("span",{children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&t.jsx("span",{children:e.countryLabel}),e.stage&&t.jsx("span",{children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),s&&t.jsx("span",{children:s})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":u?"var(--brand)":"var(--red)"},children:[u?"✓":"✗"," ",t.jsx("b",{children:u?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:d=>{var l;d.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(l=document.querySelector(".atl2 .demand"))==null||l.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:o,onClick:d=>{d.stopPropagation(),n(e)},children:a.evalGoOn(ga(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:d=>{d.stopPropagation(),n(e)},children:a.evalGoOn(ga(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:d=>d.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(i?` · ${i}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Ea,{spec:e.card})})]})}function gs({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:c}=F();return!o.pipe&&e.kind==="op"?t.jsx(hs,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(cs,{o:e}),t.jsx(Ho,{o:e}),t.jsx(Go,{o:e}),t.jsx(Kn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("span",{children:e.sector}),e.stage&&t.jsx("span",{children:e.stage}),e.countryLabel&&t.jsx("span",{children:e.countryLabel}),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(za,{o:e})})]}),e.card&&t.jsx(Ea,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[We(e.engine||"")," ",Oe(e.engine||"",r)]}),he(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(et,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsxs("div",{className:"sec2 acts2",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>c(e),children:a.actOnboard})]})]})]})}function bs({o:e,locked:a}){const{t:r,dispatch:n,caps:o,doDecide:i}=F(),c=ve(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][c];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":s},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(za,{o:e}),he(e)&&t.jsx(et,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&o.pipe&&c===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>i(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>i(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function vs(){const e=F(),{st:a,dispatch:r,t:n,caps:o,scoped:i,lang:c,sessTally:s,data:p,dossiers:u,source:d}=e,l=d==="ops"?8:Tn,[m,h]=g.useState(null),f=a.filters.day,[v,b]=g.useState(new Set);g.useEffect(()=>{b(new Set)},[a.ptab,a.continent]);const x=k=>b(M=>{const R=new Set(M);return R.has(k)?R.delete(k):R.add(k),R}),y=g.useMemo(()=>Na(i,a.sort),[i,a.sort]),j=g.useMemo(()=>y.filter(k=>he(k)&&!we(k)).length,[y]),w=g.useMemo(()=>o.pipe?y:y.filter(k=>!we(k)&&!k.noCo),[y,o.pipe]),C=d==="ops"?y.filter(k=>k.noCo).length:0,E=o.pipe?n.plabels[a.ptab].toLowerCase():d==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,A=(k,M,R="",S=!1)=>t.jsxs("button",{type:"button","data-s":k,className:R,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:S?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:k}),children:[M,t.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),q=g.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const k=new Map;y.forEach(S=>{const L=S.engine||"?";k.has(L)||k.set(L,[]),k.get(L).push(S)});const M={ma:0,fundraising:1,media:2},R=Zt([...k.keys()],c);return[...k.entries()].sort((S,L)=>{const D=M[S[0]]??10+R.indexOf(S[0]),$=M[L[0]]??10+R.indexOf(L[0]);return D-$})},[y,o.pipe,a.groupBy,c]),P=o.lockRowsAfter;let N=0;const T=(k,M)=>{const R=a.shown[M]||l,L=k.slice(0,R).map(D=>{const $=P!==null&&N>=P;return N++,a.dens==="maxi"?t.jsx(bs,{o:D,locked:$},D.id):t.jsx(ms,{o:D,locked:$,open:v.has(D.id),onToggle:()=>x(D.id)},D.id)});if(k.length>R&&d!=="ops"){const D=Math.min(l,k.length-R),$=k.length-R;L.push(t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:M,by:l,base:l}),children:[t.jsx("span",{className:"more-label",children:n.more(D,$)}),t.jsxs("span",{className:"more-meta",children:[n.moreMeta(R,k.length)," · ",$," ",c==="en"?"remaining":"restantes"]})]},M+":more"))}return L};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:y.length})," ",E]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,o.pipe&&e.fund?" · "+e.fund:"",d==="ops"&&y.length>0&&" — "+n.edSplit(y.length-C,C)]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(o.showFunnel||d==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["deplie",n.densOpen],["maxi",n.densMaxi]].map(([k,M])=>t.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>r({type:"dens",dens:k}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:M})]},k))}),o.showChain&&w.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:w.map(k=>k.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(w.length):n.chainAll(w.length)]})]}),j>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(j)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),A("country",n.colCountry),A("name",n.colCompany),A("amount",n.colAmount,"h-amt",!0),A("stage",n.colStage,"h-stade"),A("signal",n.colSignal,"h-sig"),o.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),o.pipe&&A("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[q?q.map(([k,M])=>{const R=d==="ops"&&(k==="ma"||k==="fundraising"),S=k==="ma"?"carte-ma":"carte-levees",L=f?`/actualites/operations/cartes/${S}-${f}.png`:`/actualites/operations/${S}-du-jour.png`;return t.jsxs(g.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:We(k)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Oe(k,c)}),t.jsx("div",{className:"s",children:n.grpCount(M.filter(D=>!we(D)).length,M.length)})]}),R&&t.jsx("img",{className:"grp-thumb",src:L,alt:n.grpCard,title:n.grpCard,loading:"lazy",onClick:D=>{D.stopPropagation(),h(L)},onError:D=>{D.currentTarget.style.display="none"}})]}),T(M,k)]},k)}):T(y,"pt"+a.ptab),!y.length&&!(p.loading&&!u.length)&&t.jsx("div",{className:"void",children:o.pipe?n.emptyTab:n.emptyScope})]}),d==="ops"&&q&&(()=>{const k=q.reduce((M,[R,S])=>M+Math.max(0,S.length-(a.shown[R]||l)),0);return k?t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>q.forEach(([M])=>r({type:"more",group:M,by:l,base:l})),children:[t.jsx("span",{className:"more-label",children:n.more(Math.min(k,l*q.length),k)}),t.jsxs("span",{className:"more-meta",children:[k," ",c==="en"?"remaining":"restantes"]})]}):null})(),m&&t.jsxs("div",{className:"atl2-lb",onClick:()=>h(null),children:[t.jsx("img",{src:m,alt:""}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>h(null),children:"×"})]}),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}function vn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ys(e,a){const r=Vr(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ws(e,a){const n=[a.head.split("|").map(vn).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",ys(o,a.plabels),Pt(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(vn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ks(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const js=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ze({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Ns({o:e,qa:a}){const{t:r,lang:n,fund:o}=F(),i=(e.cribleStatus||"").trim().toUpperCase()||(Pt(e)==="NO MATCH"?"NO MATCH":"MATCH"),c=Xe(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,c&&t.jsx("em",{children:c})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(ze,{k:r.cdSector,v:e.sector}),t.jsx(ze,{k:r.cdStage,v:e.stage}),t.jsx(ze,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ze,{k:r.cdSite,v:e.domain||e.website}),t.jsx(ze,{k:r.cdName,v:e.contactName}),t.jsx(ze,{k:r.cdEmail,v:e.contactEmail}),t.jsx(ze,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ze,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ze,{k:r.cdAngle,v:e.angle}),t.jsx(ze,{k:r.cdDetected,v:js(e.date,n)})]}),p.some(([,u])=>u)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,u])=>u).map(([u,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:u}),t.jsx("p",{children:d})]},u))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Ss(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:c}=F(),[s,p]=g.useState({}),u=25,d=g.useMemo(()=>n.slice(0,u),[n]);g.useEffect(()=>{d.length&&Hr(r,d.map(h=>h.name)).then(p)},[r,d]);const l=i.stats,m=h=>h.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),l&&typeof l.screened=="number"&&t.jsxs("p",{children:[m(l.screened)," ",e.funScreened(""),typeof l.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",m(l.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(m(i.marketEstimate)),", ",Math.round(l.screened/i.marketEstimate*100)," %"]})]})]}),d.map(h=>t.jsx(Ns,{o:h,qa:s[h.name]},h.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Cs=50;function Ta({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=F(),[i,c]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(""),[l,m]=g.useState(0),[h,f]=g.useState(""),[v,b]=g.useState(!1),x=g.useRef(null);g.useEffect(()=>()=>{x.current&&window.clearInterval(x.current)},[]);const y=async w=>{p(!0),d("");const C=await a();if(p(!1),C.ok){c(C);return}if(C.busy){d(o.alertPreviewBusy);return}if(!w){d(o.alertPreviewFail);return}m(Cs),x.current=window.setInterval(()=>{m(E=>E>1?E-1:(x.current&&window.clearInterval(x.current),y(!1),0))},1e3)},j=async()=>{if(n||v)return;b(!0),f("");const w=await r();b(!1),f(w.ok?o.alertTestOk(w.sentTo||""):w.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||l>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v,onClick:()=>{j()},children:v?"…":o.alertTest})]}),l>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(l)}),u&&t.jsx("p",{className:"mnote warn",children:u}),h&&t.jsx("p",{className:"mnote",children:h}),!h&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const lt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function be({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=F();return Je.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Es(){const{st:e}=F();switch(e.modal){case"chain":return t.jsx(Ts,{});case"space":return t.jsx(As,{});case"alert":return t.jsx(Ls,{});case"queue":return t.jsx(Fs,{});case"export":return t.jsx(Ps,{});case"plug":return t.jsx(Bs,{});case"recharge":return t.jsx(_s,{});case"cover":return t.jsx(Vs,{});case"dossier":return t.jsx(Us,{});case"crit":return t.jsx(Hs,{});case"tuto":return t.jsx(Ys,{});case"rdv":return t.jsx(zs,{});case"memoalert":return t.jsx(Ds,{});default:return null}}function zs(){const{dispatch:e,fund:a}=F(),r=typeof document<"u"&&!!document.getElementById("rdv");return g.useEffect(()=>{r&&(e({type:"modal",modal:null}),Po())},[r,e]),r?null:t.jsx(Gr,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Ts(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:c,evalBusy:s}=F(),p=i==="client",u=e.chain.queue.map(h=>r.get(h)).filter(h=>!!h),d=e.chain.idx,l=u[d],m=d>=u.length;return Je.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:m?n.finished:`${d+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(m?100:d/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:m||!l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:l.name}),t.jsx("div",{className:"sub",children:[Ze(l.cc,o)||l.countryLabel,l.sector,l.stage,n.daysAgo(Qe(l.date))].filter(Boolean).map(h=>String(h).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Oe(l.engine,o).toUpperCase()}),typeof l.amountEur=="number"&&l.amountEur>0&&t.jsx("span",{children:Ft(l.amountEur,o)})]}),he(l)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(et,{o:l,lg:!0})," ",t.jsx(Dt,{o:l,src:!0})]}),(l.tagline||l.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:l.tagline||l.headline})]}),l.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:l.reasoning})]}),p&&we(l)&&t.jsxs("div",{className:"vbox",style:{"--c":$e(l)==="retenu"?"var(--brand)":$e(l)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:$e(l)==="retenu"?"✓ "+n.kept:$e(l)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:l.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!m&&l&&!(p&&we(l))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{c(l)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(m?{type:"modal",modal:null}:{type:"chainNext"}),children:m?n.closeBtn:n.skip})]})]})})}),document.body)}function As(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=F(),i=o==="client",c=g.useMemo(()=>i?r.filter(l=>we(l)):[],[r,i]),s=g.useMemo(()=>Na(c.filter(l=>$e(l)==="retenu"),{key:"signal",dir:-1}),[c]),p=g.useMemo(()=>c.filter(l=>$e(l)==="ecarte"),[c]),u=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(be,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),u.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),u.slice(0,40).map(l=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof l.score=="number"&&l.score>0?l.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:l.name}),t.jsx("div",{className:"rr",children:l.reasoning||l.tagline||""})]})]},l.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Ls(){const{mode:e}=F();return e==="client"||e==="apercu"?t.jsx(Rs,{}):t.jsx(qs,{})}function Rs(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=F(),[i,c]=g.useState("d"),s=o!=="client";return t.jsxs(be,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>c("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>c("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>c("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Ms,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(Os,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(Jn,{})]})}function Ms({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,c]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),$a(a).then(v=>{f&&(v?c(v):p(!0))}),()=>{f=!1}},[a,u]);const l=f=>{r||$a(a,f).then(v=>{if(!v){o(e.actErr);return}c(v),v.throttled?o(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=f=>!i.sections||i.sections.includes(f),h=f=>{const v=i.sections||e.alertSec.map(([b])=>b);l({sections:m(f)?v.filter(b=>b!==f):[...v,f]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,(i.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[i.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,(i.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>l({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:m(f),disabled:r,onChange:()=>h(f)}),t.jsxs("span",{children:[v,f==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},f))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ta,{label:e.alertPreview,readOnly:r,onPreview:()=>to(a),onTest:()=>eo(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Os({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,c]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),_a(a).then(v=>{f&&(v?c(v):p(!0))}),()=>{f=!1}},[a,u]);const l=f=>{r||_a(a,f).then(v=>{if(!v){o(e.actErr);return}c(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=i.dow??0,h=i.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>l({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:f=>l({dow:Number(f.target.value)}),children:e.alertDow.map((f,v)=>t.jsx("option",{value:v,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>l({hour:Math.max(6,h-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[h," h"]}),t.jsx("button",{type:"button",onClick:()=>l({hour:Math.min(21,h+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ta,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>no(a),onTest:()=>ao(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Jn(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=F(),[c,s]=g.useState(i||""),[p,u]=g.useState(!1),[d,l]=g.useState(!1);g.useEffect(()=>{i&&s(i)},[i]);const m=e.filters,h=g.useMemo(()=>n.filter(x=>he(x)).length,[n]),f=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(c)||d)){l(!0);try{await fetch(`${ba}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c.trim(),sectors:m.sector,countries:m.country,source:i?"atelier2-client":"atelier2",website:""})}),u(!0)}finally{l(!1)}}},b=[[a.amRows.continent,o],[a.amRows.since,a.amSince[f]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(x=>Oe(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(x=>Ze(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(c)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:b.map(([x,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:c,readOnly:!!i,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,h)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function qs(){const{t:e}=F();return t.jsx(be,{title:e.alertTitle,icon:"🔔",children:t.jsx(Jn,{})})}function Fs(){var v,b,x;const{t:e,token:a,fund:r,mode:n,flash:o}=F(),[i,c]=g.useState(null),[s,p]=g.useState([]),[u,d]=g.useState(0),l=n==="client";g.useEffect(()=>{let y=!0;return(async()=>{const[j,w]=await Promise.all([ya(r),Nn(a)]);y&&(j&&c(j),p(w))})(),()=>{y=!1}},[a,r,u]);const m=(i==null?void 0:i.per_day)??2,h=((v=i==null?void 0:i.analyzed_today)==null?void 0:v.length)??0,f=(b=i==null?void 0:i.tomorrow)!=null&&b.length?i.tomorrow:((i==null?void 0:i.pool_meta)||[]).slice(0,10);return t.jsxs(be,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(h,h+(((x=i==null?void 0:i.pool_order)==null?void 0:x.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(m)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),l&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Ba(a,y.company,"retry").then(()=>d(j=>j+1))},children:e.queueRetry}),l&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Ba(a,y.company,"delete").then(()=>d(j=>j+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[f.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),f.slice(0,10).map((y,j)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",j+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Ps(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:c}=F(),s=`${lt}/cibles/list.csv?token=${a}`,p=`${lt}/cibles/list.json?token=${a}`,u=`${lt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,l=b=>{var x;(x=navigator.clipboard)==null||x.writeText(b).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:u,href:u}],h=!o.lockActions&&n.length>0,f=()=>{ks(ws(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:b=>(e.stg.find(([x])=>x===b)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(be,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:b,value:x,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:b[0]}),t.jsxs("div",{children:[t.jsx("b",{children:b[1]}),t.jsx("p",{children:b[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l(x),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},b[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ds(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=F(),i=o!=="client",[c,s]=g.useState(null),[p,u]=g.useState(!1),[d,l]=g.useState(0),[m,h]=g.useState(!1);g.useEffect(()=>{let x=!0;return u(!1),Ia(a).then(y=>{x&&(y?s(y):u(!0))}),()=>{x=!1}},[a,d]);const f=()=>(c==null?void 0:c.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=x=>{if(i||!c)return;const y={enabled:x.enabled??!!c.enabled,email:x.email??(c.email||""),sections:x.sections??f()};h(!0),Ia(a,y).then(j=>{if(h(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(p)return t.jsx(be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(x=>x+1),children:e.retry})]})});if(!c)return t.jsx(be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const b=f();return t.jsxs(be,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":c.enabled===!0,disabled:i||m,style:c.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!c.enabled}),children:c.enabled?"ON":"OFF"})})]}),t.jsx(Is,{value:c.email||"",readOnly:i||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>v({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!b[x],disabled:i||m,onChange:()=>v({sections:{...b,[x]:!b[x]}})}),t.jsx("span",{children:y})]},x))}),t.jsx(Ta,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Wr(a,b),onTest:()=>Yr(a,b)})]})}function Is({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,c]=g.useState(e);g.useEffect(()=>{c(e)},[e]);const s=i.trim()!==e.trim(),p=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:u=>c(u.target.value),onKeyDown:u=>{u.key==="Enter"&&s&&p&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>o(i.trim()),children:n})]})]})}function Bs(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=F(),[i,c]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(null),[l,m]=g.useState(""),[h,f]=g.useState(0);g.useEffect(()=>{let x=!0;return p(!1),ea(a).then(y=>{x&&(y?c({configured:y.configured,url_hint:y.url_hint}):p(!0))}),Qr(a).then(y=>{x&&d(y)}),()=>{x=!1}},[a,h]);const v=(x,y)=>{o&&ea(a,x).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}x.test&&j.sent===!1?n(e.plugTestThrottled):r(y),f(w=>w+1)})},b='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(be,{title:e.plugTitle,icon:"🔌",wide:!0,children:[u&&t.jsx("p",{className:"mnote"+(u.enabled?" warn":""),children:u.enabled?e.plugAutoOn(u.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(x=>x+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:l,disabled:!o,onChange:x=>m(x.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!l.trim(),onClick:()=>v({url:l.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx($s,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:b}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(b).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function $s(){const{t:e,token:a,lang:r}=F(),[n,o]=g.useState("valides"),[i,c]=g.useState(!1),[s,p]=g.useState(null),[u,d]=g.useState(null),[l,m]=g.useState(!1),[h,f]=g.useState(!1),[v,b]=g.useState(null),[x,y]=g.useState(null),[j,w]=g.useState(null),C=`atl2:bulk:${a}:${n}`;g.useEffect(()=>{ea(a).then(k=>{y(k&&k.configured?k.url_hint||"webhook":null)})},[a]),g.useEffect(()=>{p(null),d(null),m(!1),b(null);try{const k=JSON.parse(localStorage.getItem(C)||"null");w(k&&Date.now()-Date.parse(k.t)<24*3600*1e3?k:null)}catch{w(null)}},[C]);const E=async()=>{c(!0),m(!1),b(null);const k=await Xr(a,n);p(k),d(k.ok?n:null),c(!1)},A=g.useRef(!1),q=async()=>{if(A.current)return;A.current=!0,f(!0);const k=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await Zr(a,n,"webhook",void 0,k)}finally{A.current=!1}if(f(!1),m(!1),b(M),M.ok&&(M.pushed||0)>0){const R={t:new Date().toISOString(),n:M.pushed||0};w(R);try{localStorage.setItem(C,JSON.stringify(R))}catch{}}},P=s!=null&&s.ok&&s.ready||0,N=!!(s!=null&&s.ok)&&u===n&&P>0&&!!x&&!j,T=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:k=>o(k.target.value),children:e.plugBulkTabs.map(([k,M])=>t.jsx("option",{value:k,children:M},k))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{E()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(T,j.n)}),!j&&!!(s!=null&&s.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),N&&!l&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>m(!0),children:e.bulkArm}),N&&l&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(P,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{q()},children:h?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>m(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function _s(){const{t:e,data:a,lang:r}=F(),n=a.credits,o=a.email,i=async c=>{if(!o)return;const s=window.location.href.split("?")[0];try{const u=await(await fetch(`${ba}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:c,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();u.url&&(window.location.href=u.url)}catch{}};return t.jsxs(be,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(c=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(c.credits,c.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(c.lookup_key)},children:e.rechargeBuy})]},c.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Us(){const{t:e}=F();return t.jsx(be,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Ss,{})})}function Vs(){const{t:e,lang:a,data:r,dossiers:n,token:o,canWrite:i,flash:c}=F(),[s,p]=g.useState(null),[u,d]=g.useState(!1);g.useEffect(()=>{let E=!0;return ya(o).then(A=>{E&&A&&typeof A.per_day=="number"&&p(A.per_day)}),()=>{E=!1}},[o]);const l=r.stats,m=typeof(l==null?void 0:l.screened)=="number"?l.screened:n.filter(E=>E.kind==="target"&&we(E)).length,h=r.marketEstimate||0,f=h>0?Math.min(100,Math.round(m/h*100)):null,v=(l==null?void 0:l.window_days)||30,b=m>0?m/v:0,x=h>0?Math.max(0,h-m):0,j=h>0&&b>0&&m>=100?Math.round(x/b):null,w=E=>Math.round(E).toLocaleString(a==="en"?"en-US":"fr-FR"),C=E=>{u||!i||(d(!0),Jr(o,E).then(A=>{if(d(!1),A===null){c(e.actErr);return}p(A),c(e.alertSaved)}))};return t.jsxs(be,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(m))}),h>0&&t.jsx("span",{children:e.covOf(w(h))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),j!==null&&t.jsx("p",{className:"mnote",children:e.covEta(j)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),b>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(b))}),l&&t.jsxs("div",{className:"covf",children:[typeof l.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(l.kept)})," ",e.covKept]}),typeof l.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(l.analyzed)})," ",e.covAna]}),typeof l.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(l.shown)})," ",e.covShown]})]}),i&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(E=>t.jsx("button",{type:"button",className:s===E?"on":"",disabled:u,onClick:()=>C(E),children:E===0?"⏸":E},E))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Hs(){var x,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i}=F(),c=n==="client",s=g.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[p,u]=g.useState(null);g.useEffect(()=>{let w=!0;return Kr(r).then(C=>{w&&u(C.thumbs)}),()=>{w=!1}},[r]);const[d,l]=g.useState(""),[m,h]=g.useState(""),[f,v]=g.useState(!1),b=async()=>{const w=d.trim();if(!(!w||f||!c)){v(!0),h("");try{const E=await(await fetch(`${lt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(E.reply&&h(String(E.reply)),E.job_id){h(e.critChatRunning);const A=async()=>{const q=await fetch(`${lt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:E.job_id})}).then(P=>P.json()).catch(()=>null);if(q&&q.done){h(String(q.reply||q.clarification||q.summary||"✓")),v(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{A()},8e3)};setTimeout(()=>{A()},8e3),l("");return}l("")}finally{m.startsWith("⏳")||v(!1)}}};return t.jsxs(be,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((x=i.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var C,E;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(A=>t.jsx("li",{children:A},A))})]}),!!((E=w.out)!=null&&E.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(A=>t.jsx("li",{children:A},A))})]})]})]},w.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||f,onChange:w=>l(w.target.value),onKeyDown:w=>{w.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!c||f||!d.trim(),onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,C)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},C))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Qn[w]||"v-cons"),children:w}),t.jsx("span",{children:C})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",C]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ys(){const{t:e,dispatch:a,startTour:r}=F(),n=o=>{var i,c;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(c=document.querySelector(".atl2 .demand input"))==null||c.focus())};return t.jsxs(be,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],c)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:c+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+c))})]})}const Jt={},yn=(Jt==null?void 0:Jt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function qt(){return new Date().toISOString().slice(0,10)}const Xn=g.createContext(null);function Zn(){const e=g.useContext(Xn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ws({token:e,children:a}){const{dispatch:r,st:n,lang:o}=F(),[i,c]=g.useState(()=>n.filters.day||qt()),[s,p]=g.useState(null),[u,d]=g.useState(!1),l=g.useCallback(f=>{if(/^\d{4}-\d{2}-\d{2}$/.test(f)){c(f);try{r({type:"filters",patch:{day:f,win:"all"}})}catch{}}},[r]);g.useEffect(()=>{n.filters.day||l(qt())},[]),g.useEffect(()=>{const f=v=>{var x;const b=(x=v.detail)==null?void 0:x.day;typeof b=="string"&&l(b)};return window.addEventListener("pp-edition-day",f),()=>window.removeEventListener("pp-edition-day",f)},[l]),g.useEffect(()=>{n.filters.day&&n.filters.day!==i&&c(n.filters.day)},[n.filters.day]),g.useEffect(()=>{if(!e||!i)return;let f=!1;d(!0);const v=new URLSearchParams({token:e,date:i});return fetch(`${yn}/cibles/edition.json?${v}`).then(b=>b.json()).then(b=>{f||p(b)}).catch(()=>{f||p({ok:!1,error:"network"})}).finally(()=>{f||d(!1)}),()=>{f=!0}},[e,i]);const m=g.useMemo(()=>`${yn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),h=g.useMemo(()=>({token:e,day:i,ed:s,loading:u,pickDay:l,daysUrl:m,isEn:o==="en"}),[e,i,s,u,l,m,o]);return t.jsx(Xn.Provider,{value:h,children:a})}function Gs(){const{day:e,daysUrl:a,pickDay:r,isEn:n}=Zn();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsx("p",{className:"thesis-days__h",children:n?"Thesis brief · pick a day":"Brief thèse · choisir un jour"}),t.jsx(ro,{mode:"local",theme:"light",month:e.slice(0,7),current:e,daysUrl:a,onPick:r})]})}function Ks(){const{day:e,ed:a,loading:r,pickDay:n,isEn:o}=Zn(),i=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),c=(a==null?void 0:a.ok)&&!i,s=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!i&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),s&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["No thesis brief for ",t.jsx("b",{children:e})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):t.jsxs(t.Fragment,{children:["Pas encore de brief de thèse pour le ",t.jsx("b",{children:e}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),i&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,i&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,e&&e!==qt()&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:()=>n(qt()),children:o?"← Back to today":"← Revenir à aujourd’hui"})]})}const er="atl2:mapfold",Qs=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(er);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},tr=g.createContext(null),F=()=>{const e=g.useContext(tr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function et({o:e,lg:a}){const{lang:r}=F(),n=he(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ua(n,r),children:[n.emoji," ",Ua(n,r)]}):null}function Dt({o:e,src:a}){const{lang:r,t:n}=F(),o=he(e);if(!o)return null;const i=co(o),c=po(o);return t.jsxs("em",{className:"sigwin"+(c?" hot":""),title:n.signaledOn(Cn(o,r))+" · "+n.win7(En(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<i?"on":""},p))}),t.jsx("span",{className:"lb",children:c?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function ar({o:e}){const{lang:a}=F(),r=lo(e.cc),n=e.cc?Ze(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const wn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",nr=e=>`atl2:tour:${e||"anon"}`;function Js(e){try{return localStorage.getItem(nr(e))==="1"}catch{return!0}}function kn(e){try{localStorage.setItem(nr(e),"1")}catch{}}function Xs(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function rl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){const{lang:c}=oo(),s=vo[c],p=Ao(e,c,a),[u,d]=g.useReducer(Ro,void 0,()=>Lo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Qs(),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??(a==="ops"?"deplie":void 0),filters:r,modal:n==null?void 0:n.modal})),l=g.useRef(!0);g.useEffect(()=>{if(l.current){l.current=!1;return}if(!e)try{localStorage.setItem(er,u.mapFolded?"on":"off")}catch{}},[u.mapFolded,e]);const m=g.useRef(i);m.current=i,g.useEffect(()=>{var z;(z=m.current)==null||z.call(m,u.filters)},[u.filters]);const[h,f]=g.useState(null),[v,b]=g.useState(null),[x,y]=g.useState({kept:0,dropped:0}),[j,w]=g.useState(!1),[C,E]=g.useState(""),[A,q]=g.useState(!1),[P,N]=g.useState(null),[T,k]=g.useState(!1),[M,R]=g.useState(!1),[,S]=g.useState(0),L=()=>S(z=>z+1),D=g.useRef([]),$=g.useRef(new Set),Q=g.useRef(new Set),pe=g.useRef(new Map),_=g.useRef(null),{mode:le}=p,V=g.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[p.caps,o,a]),G=V.pipe,U=p.session.token||"",K=le==="client"&&!e;g.useEffect(()=>{if(document.querySelector(`link[href="${wn}"]`))return;const z=document.createElement("link");z.rel="stylesheet",z.href=wn,document.head.appendChild(z)},[]);const H=(z,I=!1)=>{E(z),q(I),_.current&&clearTimeout(_.current),_.current=setTimeout(()=>E(""),I?4200:2400)},re=z=>H(z,!0),ne=g.useMemo(()=>{const z=new Map;return p.dossiers.forEach(I=>{I.id&&z.set(I.id,I)}),z},[p.dossiers]),ue=g.useMemo(()=>p.dossiers.filter(z=>An(z,u,G)),[p.dossiers,u,G]),ee=g.useRef(!1);g.useEffect(()=>{if(ee.current||e||p.loading||!p.dossiers.length)return;if(!V.showFunnel||Js(p.session.token||"")){ee.current=!0;return}ee.current=!0;const z=window.setTimeout(()=>{kn(p.session.token||""),k(!0)},700);return()=>window.clearTimeout(z)},[e,p.loading,p.dossiers.length,V.showFunnel,p.session.token]);const oe=g.useMemo(()=>p.dossiers.filter(z=>Mo(z,u,G,p.favIds)),[p.dossiers,u,G,p.favIds]),Ce=g.useMemo(()=>io(ue,p.favIds),[ue,p.favIds]),W=wa.find(z=>z.key===u.continent),ce=u.continent==="monde"?s.contWorld:(c==="fr"?W==null?void 0:W.fr:W==null?void 0:W.en)||"";g.useEffect(()=>{const z=I=>{var de;const B=(((de=I.detail)==null?void 0:de.name)||"").trim();B&&ge(null,B)};return window.addEventListener("ppmap:evaluate",z),()=>window.removeEventListener("ppmap:evaluate",z)});const ge=(z,I)=>{const B=((z==null?void 0:z.name)||I||"").trim();if(!K){b({kicker:B});return}!B||j||(w(!0),(async()=>{try{const de=await Sn(U,B,"atelier2"),mt={name:de.company||B,verdict:de.verdict,reason:de.reason||"",remaining:de.remaining??null};D.current=[mt,...D.current].slice(0,8),de.verdict==="kept"&&y(De=>({...De,kept:De.kept+1})),de.verdict==="ruled_out"&&y(De=>({...De,dropped:De.dropped+1}));const tt=z||p.dossiers.find(De=>(De.name||"").toLowerCase()===B.toLowerCase());tt&&(de.verdict==="kept"?tt.verdict=tt.verdict||"MATCH":de.verdict==="ruled_out"&&(tt.verdict="NO MATCH"),de.reason&&(tt.reasoning=de.reason)),L()}finally{w(!1)}})())},me=z=>{if(!K){b({kicker:z.name});return}$.current.add(z.id),at(U,"fast_request",z.name||"",""),H(s.memoInstantSent(z.name)),L()},Le=z=>pe.current.get(z.id)??p.thumbs.get((z.name||"").trim().toLowerCase()),O=(z,I)=>d({type:"undoPush",entry:{id:z.id,name:z.name,prevCeoStatus:I}}),J=async(z,I,B)=>{const de=z.ceoStatus||"";z.ceoStatus=I,L();const mt=await Ut(U,{status:I,airtable_id:z.airtableId,check_id:z.checkId,company:z.name,...(B==null?void 0:B.note)!==void 0?{note:B.note}:{},...B!=null&&B.via?{via:B.via}:{}});return mt.ok?mt.skipped?(z.ceoStatus=de,L(),re(s.actNotPersisted),!1):((B==null?void 0:B.undo)!==!1&&O(z,de),B!=null&&B.msg&&H(B.msg),(I==="Validé"||I==="Écarté")&&!z.ceoNote&&(B==null?void 0:B.note)===void 0&&N({o:z,yes:I==="Validé"}),!0):(z.ceoStatus=de,L(),re(s.actErr),!1)},ae=async(z,I)=>{const B=await Ut(U,{status:z.ceoStatus||"Retenu",airtable_id:z.airtableId,check_id:z.checkId,company:z.name,note:I,via:"note"});return!B.ok||B.skipped?(re(B.skipped?s.actNotPersisted:s.actErr),!1):(z.ceoNote=I,L(),!0)},X=g.useRef(new Map),Ee=z=>X.current.has(z.id)?X.current.get(z.id):p.stages.get((z.name||"").trim().toLowerCase()),qe=(z,I)=>{X.current.set(z.id,I),L()},Fe=(z,I)=>{K&&J(z,I?"Validé":"Écarté",{msg:I?s.decidedYes(z.name):s.decidedNo(z.name)})},ft=z=>{K&&J(z,"À trancher",{msg:s.promoted(z.name)})},It=z=>{K&&(async()=>{const I=z.ceoStatus||"";z.ceoStatus="Retenu",L();const B=await Ut(U,{status:"Retenu",check_id:z.checkId,company:z.name});if(!B.ok||B.skipped){z.ceoStatus=I,L(),re(B.skipped?s.actNotPersisted:s.actErr);return}O(z,I),H(s.repeched(z.name))})()},Bt=()=>{const z=u.undo[u.undo.length-1];if(!z){H(s.undoNone);return}const I=ne.get(z.id);if(!I){d({type:"undoPop"}),H(s.undoNone);return}let B=z.prevCeoStatus;if(!B)if((I.verdict||"").toUpperCase().includes("CALL"))B="À trancher";else{H(s.undoLockedTitle);return}(async()=>await J(I,B,{undo:!1})&&(d({type:"undoPop"}),I.ceoStatus=z.prevCeoStatus,L(),H(s.undoDone(I.name))))()},Pe=z=>{K&&(Q.current.add(z.id),L(),(async()=>{const I=await uo(U,z.name,"email");if(!I||I.ok===!1){Q.current.delete(z.id),L(),re(s.actErr);return}at(U,"approach",z.name||"",""),H(s.actApproachSent)})())},rr=(z,I)=>{K&&(async()=>{if(!(await at(U,I?"yes":"no",z.name||"","")).ok){re(s.actErr);return}pe.current.set(z.id,I?"yes":"no"),L(),H(I?s.thumbUpDone:s.thumbDnDone)})()},or=z=>{!K||!ka(z)||(at(U,"detailed_request",z.name||"",""),H(s.memoDeepSent(z.name)))},ir=z=>{const I=new Set(p.favIds),B=I.has(z.id);B?I.delete(z.id):I.add(z.id),p.setFavIds(I),K&&fo(U,{id:z.id,co:z.name},B)},sr=()=>{!K||M||window.confirm(s.identSyncConfirm)&&(R(!0),(async()=>{const z=await mo(U);R(!1),z?H(s.identSyncDone):re(s.actErr)})())},Aa=/proplace/i.test(p.fund||""),lr=z=>{!K||!Aa||(at(U,"onboard_request",z.name||"",""),H(s.onboardSent(z.name)))},cr={st:u,dispatch:d,t:s,lang:c,mode:le,caps:V,pipe:G,token:U,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:It,thumbOf:Le,canWrite:K,commitStatus:J,saveNote:ae,stageOf:Ee,setStage:qe,flashErr:re,startTour:()=>k(!0),dossiers:p.dossiers,scopedAll:ue,scoped:oe,counts:Ce,byId:ne,contName:ce,favIds:p.favIds,toggleFav:ir,askEvaluate:ge,doAnalyse:me,doDecide:Fe,doPromote:ft,doApproach:Pe,doThumb:rr,doDeep:or,doUndo:Bt,doSync:sr,doOnboard:lr,outbound:Aa,memoQueued:$.current,approachDone:Q.current,sessTally:x,evalCards:D.current,evalBusy:j,markRow:f,markedId:h,flash:H};g.useEffect(()=>{const z=I=>{I.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",z),()=>window.removeEventListener("keydown",z)},[]);const dr=z=>U?t.jsx(Ws,{token:U,children:z}):t.jsx(t.Fragment,{children:z});return t.jsx(tr.Provider,{value:cr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:ko}),dr(t.jsxs("div",{className:"app"+(G?" pipe":"")+(U?" has-thesis":""),children:[V.showTicker&&t.jsx(fe,{name:"live",children:t.jsxs("div",{className:"live-stack"+(U?" live-stack--cibles":""),children:[t.jsx(Oo,{}),!!U&&t.jsx(Gs,{})]})}),V.showIdent&&t.jsx(fe,{name:"identite",children:t.jsx(Jo,{})}),V.showOnb&&t.jsx(fe,{name:"onboarding",children:t.jsx(Xo,{})}),V.showMorning&&t.jsx(fe,{name:"matin",children:t.jsx(Qo,{})}),t.jsx(fe,{name:"fraicheur",children:t.jsx(_o,{})}),t.jsx(fe,{name:"mesure",children:t.jsx(Uo,{})}),V.showFunnel&&t.jsx(fe,{name:"entonnoir",children:t.jsx(Zs,{})}),V.showFunnel&&t.jsx(fe,{name:"tunnel",children:t.jsx(ei,{})}),V.showFunnel&&t.jsx(fe,{name:"tuto",children:t.jsx(ai,{})}),t.jsx(fe,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(el,{}),t.jsxs("div",{className:"stage"+(u.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Qi,{}),t.jsx(Xi,{})]})]})}),V.showDemand&&t.jsx(fe,{name:"evaluation",children:t.jsx(ts,{})}),V.showDemand&&u.memoConsole&&t.jsx(fe,{name:"console",children:t.jsx(ns,{})}),t.jsx(fe,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(vs,{})}),!!U&&t.jsx(fe,{name:"edition",children:t.jsx(Ks,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),V.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),u.popupId&&t.jsx(fe,{name:"fiche",children:t.jsx(is,{})}),t.jsx(fe,{name:"modales",children:t.jsx(Es,{})}),t.jsx(Io,{}),P&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:P.o.name}),t.jsx(Wo,{placeholder:P.yes?s.whyYesPh:s.whyNoPh,onDone:z=>{const I=P.o;N(null),z&&ae(I,z).then(B=>{B&&H(s.csNoteSaved)})}})]}),T&&t.jsx(Ko,{steps:Xs(s),onClose:()=>{k(!1),kn(U)}}),C&&t.jsx("div",{className:"flash on"+(A?" err":""),children:C}),v&&t.jsx(so,{variant:"acquirer",initialCompany:jn().co,initialWebsite:jn().site,onClose:()=>b(null)})]})})}function Zs(){const{t:e}=F(),[a,r]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function el(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:o,t:i}=F(),c=g.useMemo(()=>{const s={};return e.forEach(p=>{ja(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[xo.map(s=>{const p=wa.find(d=>d.key===s),u=s==="monde"?i.contWorld:o==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[u,t.jsx("span",{className:"n",children:c[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?i.showMap:i.hideMap})})]})}function jn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function tl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{ar as FlagCell,et as SigBadge,Dt as SigWin,rl as default,tl as fmtShort,F as useV2};
