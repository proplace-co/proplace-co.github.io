...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ua=`
...
`,_a=Va+Ua;function Ha(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function Ya(t,a){return t||a.mode!=="client"||!a.token?"visiteur":Ha("teaser")==="1"?"apercu":"client"}const Wa={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},Ga=t=>Wa[t],fe=t=>Object.assign(t,{continent:ia(t.cc)});function Be(t){const a=new Set,n=[];for(const r of t){const i=(r.name||"").toLowerCase();!i||a.has(i)||(a.add(i),n.push(r))}return n}const Ka=60*60*1e3;function Qa(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ka?null:a}catch{return null}}function Te(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ja=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function Xa(t,a,n="default"){const r=n!=="default",i=c.useMemo(()=>t||r?{mode:"anon"}:Zt(),[t,r]),o=c.useMemo(()=>r?"visiteur":Ya(t,i),[t,i,r]),l=c.useMemo(()=>Ga(o),[o]),u=o!=="visiteur",m=Ja(n),[p,h]=c.useState([]),[s,v]=c.useState(""),[b,f]=c.useState(null),[x,g]=c.useState(null),[d,N]=c.useState(()=>new Map),[k,y]=c.useState(()=>new Map),[C,S]=c.useState(""),[F,j]=c.useState(new Set),[E,$]=c.useState(null),[O,M]=c.useState(!0),[P,A]=c.useState(!1),[R,I]=c.useState(0),[H,ae]=c.useState(0),de=c.useRef(0),ie=c.useMemo(()=>{var q;if(o!=="client")return"";try{return((q=ea())==null?void 0:q.email)||""}catch{return""}},[o]);c.useEffect(()=>{const q=++de.current;let Z=!0;const D=()=>Z&&q===de.current,V=(u&&i.token?i.token:"pub:"+a)+(m?":"+m:""),B=Qa(V);return B?(h(B.objs.map(fe)),B.fund&&v(B.fund),f(B.marketEstimate??null),g(B.criteria??null),S(B.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(n==="ops"){const _=await De(),ee=((_==null?void 0:_.recent_ops)||[]).map(K=>qe(K,a)).filter(K=>!!K);if(!D())return;h(ee.map(fe)),Te(V,{objs:ee})}else if(typeof n=="object"){const ee=(await Xe()||[]).filter(Y=>(Y.slug||"")===n.research).map(Y=>Ze(Y,a)).filter(Y=>!!Y),K=Be(await et(ee,a));if(!D())return;h(K.map(fe)),Te(V,{objs:K})}else if(u&&i.token){const _=ta(i.token),ee=De(),K=aa(i.token),Y=ra(i.token),ve=na(i.token),U=await _;let re=U?U.targets:[];D()&&U&&(v(U.fund||""),f(U.marketEstimate??null),g(U.criteria??null),S(U.generatedAt||""),h(re.map(fe)),M(!1),A(!1));const[ce,ye,me,te]=await Promise.all([ee,K,Y,ve]),Se=((ce==null?void 0:ce.recent_ops)||[]).map(ne=>qe(ne,a)).filter(ne=>!!ne);if(re=[...re,...Se],!D())return;h(re.map(fe));const pe=new Set;for(const ne of ye){const le=(ne.id||ne.co||"").toString().trim().toLowerCase();le&&pe.add(le.startsWith("t:")?le:"t:"+le)}j(pe),N(me),y(te),U&&Te(V,{fund:U.fund,marketEstimate:U.marketEstimate,criteria:U.criteria,generatedAt:U.generatedAt,objs:re})}else{const _=oa(),ee=Xe(),K=De(),Y=await _;D()&&Y.length&&(h(Be(Y).map(fe)),M(!1),A(!1));const[ve,U]=await Promise.all([ee,K]),re=(ve||[]).map(te=>Ze(te,a)).filter(te=>!!te),ce=await et(re,a),ye=((U==null?void 0:U.recent_ops)||[]).map(te=>qe(te,a)).filter(te=>!!te),me=Be([...Y,...ce,...ye]);if(!D())return;h(me.map(fe)),Te(V,{objs:me})}D()&&A(!1)}catch{D()&&!B&&A(!0)}finally{D()&&M(!1)}})(),()=>{Z=!1}},[u,i.token,a,R,m]),c.useEffect(()=>{if(!l.showCredits||!ie){$(null);return}let q=!0;return(async()=>{try{const Z=await fetch(`${$e}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ie})});if(!Z.ok)return;const D=await Z.json();q&&D&&D.ok!==!1&&$(D)}catch{}})(),()=>{q=!1}},[l.showCredits,ie,H]);const Ce=c.useCallback(q=>j(new Set(q)),[]);return{session:i,mode:o,caps:l,fund:s,email:ie,marketEstimate:b,generatedAt:C,criteria:x,thumbs:d,stages:k,dossiers:p,favIds:F,setFavIds:Ce,credits:E,reloadCredits:()=>ae(q=>q+1),loading:O,error:P,refresh:()=>I(q=>q+1)}}const Et=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Za=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Et(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function er(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Et(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Le)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Le=60;function Ye(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!G(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Ve(t)))return!1;if(r!=="win"&&a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ge(t.date)>i)return!1}if(r!=="status"&&!n&&a.status!=="all"&&se(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Tt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:Ye(t,a.filters,n)}function tr(t,a,n,r){return!(!Tt(t,a,n)||n&&!la(t,a.ptab,r))}function We(t,a){const n=a.key,r=i=>{switch(n){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ge(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=G(i);return o?100-(o.left??0):-1}}};return[...t].sort((i,o)=>{const l=r(i),u=r(o);return l<u?-a.dir:l>u?a.dir:(i.name||"").localeCompare(o.name||"")})}function ar(){const{dossiers:t,st:a,t:n,dispatch:r,contName:i,pipe:o}=z(),l=c.useMemo(()=>{const m=s=>o?!0:s.continent===a.continent,p=t.filter(s=>m(s)&&G(s)),h=t.filter(s=>m(s)&&s.kind==="op"&&!G(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&ge(s.date)<=2);return h.sort((s,v)=>(v.amountEur||0)-(s.amountEur||0)),[...We(p,{key:"signal",dir:-1}),...h].slice(0,40)},[t,a.continent,o]),u=m=>l.map(p=>e.jsxs("button",{type:"button",className:"tk"+(Q(p)?" spent":""),onClick:h=>{const s=h.currentTarget.getBoundingClientRect();r({type:"popup",id:p.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:p.name+(p.tagline?" — "+p.tagline:""),children:[e.jsx(be,{o:p}),e.jsxs("span",{className:"who",children:[e.jsx(Rt,{o:p}),e.jsx("span",{className:"co",children:p.name})]}),typeof p.amountEur=="number"&&p.amountEur>0&&e.jsx("span",{className:"am",children:gn(p.amountEur)}),p.sector&&e.jsx("span",{className:"mt",children:p.sector}),e.jsx(Me,{o:p}),e.jsx("span",{className:"tkgo",children:"→"})]},m+(p.id||p.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:l.length})]}),e.jsx("div",{className:"win",children:l.length?e.jsxs("div",{className:"run",children:[u(0),u(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(i)})})})]})}const rr="aDx8z7Hzksus",At="+33 6 83 10 72 86",ct="alexandre@proplace.co",nr=`tel:${At.replace(/[^\d+]/g,"")}`,pt="pp-rdv-slot";function or(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ir(){const{t,caps:a,fund:n}=z(),r=a.showOnb,i=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:sr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:nr,children:At}),t.rdvSubMid,e.jsx("a",{href:`mailto:${ct}`,children:ct})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(i).map(([o,l],u)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(u+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:l})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Pa,{filloutId:rr,parameters:n?{company_name:n}:void 0})})]})}function lr(){const[t,a]=c.useState(()=>typeof document>"u"?null:document.getElementById(pt));return c.useEffect(()=>{t||a(document.getElementById(pt))},[t]),t?Ne.createPortal(e.jsx(ir,{}),t):null}const sr=`
...
`,dr=8;function cr(){const{t,lang:a,token:n,dossiers:r,caps:i,markRow:o,dispatch:l}=z(),[u,m]=c.useState(!1),[p,h]=c.useState(!1),[s,v]=c.useState(!1),b=n||"home",{names:f,verdicts:x}=c.useMemo(()=>{const y=[],C={};return r.forEach(S=>{S.kind!=="target"||!S.name||(y.push(S.name),C[S.name]=sa(S)||"")}),{names:y,verdicts:C}},[r]),g=c.useMemo(()=>f.length?da(b,f,x,a):null,[b,f.length]);if(!i.pipe||u||!g||g.firstVisit||!g.added.length&&!g.gone.length)return null;const d=p?g.added:g.added.slice(0,dr),N=g.added.length-d.length,k=y=>{const C=r.find(S=>S.name===y);C&&(o(C.id),l({type:"popup",id:C.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(g.added.length,g.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{m(!0),ca(b,f,x,g.fp,a)},children:"×"})]}),!!g.added.length&&e.jsxs("div",{className:"since-c",children:[d.map(y=>e.jsx("button",{type:"button",onClick:()=>k(y),children:y},y)),N>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(N)})]}),!!g.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>v(y=>!y),children:t.sinceOut(g.gone.length)}),s&&g.gone.slice(0,20).map(y=>e.jsx("span",{className:"gone",children:y},y))]})]})}const pr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ur({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:i}=z(),[o,l]=c.useState(""),[u,m]=c.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const p=(t.ceoStatus||"").trim(),h=(Re(t)||"").startsWith("CALL")&&X(t)===3,s=X(t)>=2,v=async f=>{if(o||f==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(f);const x=await i(t,f);l(""),x&&(m(!0),setTimeout(()=>m(!1),2200))},b=h?[["Validé",a.csYes],["Écarté",a.csNo]]:pr.filter(([f])=>!(s&&f==="Retenu")).map(([f,x])=>[f,a[x]]);return e.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([f,x])=>e.jsx("button",{type:"button",className:"csb"+(p===f?" on":"")+(o===f?" busy":""),disabled:!!o,onClick:()=>{v(f)},children:x},f)),u&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(fr,{o:t})]})}function fr({o:t}){const{t:a,saveNote:n,flash:r}=z(),[i,o]=c.useState(t.ceoNote||""),[l,u]=c.useState(!1),[m,p]=c.useState(!1),h=i.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(l||!h)return;u(!0);const v=await n(t,i.trim());u(!1),v&&(p(!0),setTimeout(()=>p(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:l||!h,onClick:()=>{s()},children:m?a.csNoteSaved:a.csNoteOk})]})}function mr({placeholder:t,onDone:a}){const{t:n}=z(),[r,i]=c.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function xr({o:t}){var g;const{t:a,token:n,caps:r,canWrite:i,stageOf:o,setStage:l,flashErr:u}=z(),[m,p]=c.useState(!1);if(!r.pipe||!i||r.lockActions||X(t)!==4)return null;const h=o(t),s=(h==null?void 0:h.stage)||"todo",v=async d=>{if(m||d===s)return;p(!0);const N=h;l(t,{stage:d,stamps:(h==null?void 0:h.stamps)||{}});const k=Math.max(Date.now(),ut+=1);ut=k;const y=await pa(n,{company:t.name||"",stage:d,cts:k,deal_id:t.airtableId,check_id:t.checkId});p(!1),!y.stale&&(y.ok||(l(t,N),u(a.actErr)))},b=(g=h==null?void 0:h.stamps)==null?void 0:g.sent,f=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,x=s==="sent"&&b&&f>=4;return e.jsxs("div",{className:"stg",onClick:d=>d.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([d,N])=>e.jsx("button",{type:"button",className:"stgb"+(s===d?" on":""),disabled:m,onClick:()=>{v(d)},children:N},d)),x&&e.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let ut=0;const Ae=8,Oe=340;function ft({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function gr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:i,scoped:o,byId:l,st:u}=z(),[m,p]=c.useState(0),[h,s]=c.useState(null),[v,b]=c.useState([]),f=c.useRef(!1);c.useEffect(()=>{f.current||(f.current=!0,b(t.filter(C=>!!document.querySelector(C.need||C.sel))))},[t]);const x=v[m],g=m>=v.length;c.useEffect(()=>{x&&(x.ptab!==void 0&&u.ptab!==x.ptab&&r({type:"ptab",tab:x.ptab}),x.dens&&u.dens!==x.dens&&r({type:"dens",dens:x.dens}))},[m,x]);const d=c.useCallback(()=>{if(!x){s(null);return}const C=document.querySelector(x.sel);if(!C){s(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),s(C.getBoundingClientRect())},[x]);c.useLayoutEffect(()=>{d();const C=window.setTimeout(d,260),S=()=>d();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{window.clearTimeout(C),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[d]);const N=c.useRef(a);if(N.current=a,c.useEffect(()=>{const C=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),N.current()):S.key==="ArrowRight"?p(F=>F+1):S.key==="ArrowLeft"&&p(F=>Math.max(0,F-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!v.length)return null;let k=null;if(g){const C=i[3]||0,S=o.find(F=>F.memoUrl)||[...l.values()].find(F=>F.memoUrl);C>0?k={title:C===1?n.ahaATitle1:n.ahaATitleN(C),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:S?k={title:n.ahaBTitle,body:n.ahaBBody(S.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:S.id}),a()}}:k={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Oe};if(!g&&h){const C=h.bottom+14,F=window.innerHeight-C>190?C:Math.max(12,h.top-200);y={left:Math.min(Math.max(12,h.left+h.width/2-Oe/2),window.innerWidth-Oe-12),top:F,width:Oe}}return Ne.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!g&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-Ae,top:h.top-Ae,width:h.width+Ae*2,height:h.height+Ae*2}}),(g||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(g?" fin":""),style:y,children:[g&&k?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:k.title}),e.jsx("p",{children:e.jsx(ft,{text:k.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>p(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(m+1,v.length)}),e.jsx("h3",{children:x==null?void 0:x.title}),e.jsx("p",{children:e.jsx(ft,{text:(x==null?void 0:x.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:m===0,onClick:()=>p(C=>Math.max(0,C-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>p(C=>C+1),children:m===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function hr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:i}=z(),o=c.useMemo(()=>t.filter(s=>ge(s.date)===0&&s.kind==="target"),[t]),l=c.useMemo(()=>o.filter(s=>a?X(s)===0:!Q(s)),[o,a]),u=o.length-l.length,m=o.length?Math.min(100,u/o.length*100):100;let p;a?p=n.morningThesis(o.length,u,l.length):o.length?u===0?p=n.goalSourced(o.length):u>=o.length?p=n.goalCleared:p=n.goalDone(u,o.length):p=n.goalSourced(0);const h=()=>{a?(i({type:"ptab",tab:0}),i({type:"filters",patch:{win:"1"}})):i({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:p}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:m+"%"}})}),l.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?n.morningEval(l.length):r.pileMode?n.goalContinue(l.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function br(){var $;const{t,st:a,dispatch:n,token:r,fund:i,data:o,dossiers:l,mode:u,doSync:m,startTour:p}=z(),[h,s]=c.useState(null),[v,b]=c.useState([]),[f,x]=c.useState(!1),g=u==="client";c.useEffect(()=>{if(!r||!i)return;let O=!0;return(async()=>{const[M,P]=await Promise.all([kt(i),jt(r)]);O&&(M&&s(M),b(P))})(),()=>{O=!1}},[r,i]);const d=(h==null?void 0:h.per_day)??null,N=(($=h==null?void 0:h.pool_order)==null?void 0:$.length)??0,k=v.filter(O=>O.status==="running").length,y=O=>{if(!g||d===null||f)return;const M=Math.max(0,Math.min(10,d+O));M!==d&&(x(!0),s(P=>P&&{...P,per_day:M}),Nt(r,M).then(P=>{x(!1),s(P===null?A=>A&&{...A,per_day:d}:A=>A&&{...A,per_day:P})}))},C=c.useMemo(()=>l.filter(O=>O.kind==="target"&&Q(O)).length,[l]),S=o.marketEstimate,F=S&&S>0?Math.min(100,Math.round(C/S*100)):null,j=(i||"P").split(/\s+/).map(O=>O[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const O=Date.parse(o.generatedAt||"");if(Number.isNaN(O))return"";const M=new Date(O),P=A=>String(A).padStart(2,"0");return`${P(M.getDate())}/${P(M.getMonth()+1)} à ${P(M.getHours())}:${P(M.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:j}),e.jsx("i",{children:i})]}),e.jsx("h1",{children:t.identTitle(i||"…")}),e.jsx("span",{className:"idsp"}),E&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(E)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:p,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&S&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(C,S)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),d!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),y(-1)},children:"−"}),e.jsx("b",{className:"q",children:d})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),y(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),d===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),k>0&&e.jsxs("span",{className:"ev",children:["⏳ ",k]}),e.jsx("span",{className:"ego",children:t.identPending(N)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:O=>{O.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!g,onClick:m,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:O=>n({type:"filters",patch:{search:O.target.value}})})]})]})]})}function vr(){const{t,counts:a,dispatch:n}=z();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,i],o)=>{const l=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(l?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:i}),l&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const yr=["--p0","--p1","--p2","--p3","--p4"];function wr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:i}=z(),o=c.useRef({});c.useEffect(()=>{o.current={...n}},[n]);const l=p=>{const h=o.current[p],s=h!==void 0?n[p]-h:0;return e.jsxs("button",{type:"button",className:"step"+(p===3&&n[3]>0?" wait":""),style:{"--c":`var(${yr[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===p,title:r.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[e.jsxs("span",{className:"l",children:[r.plabels[p].toUpperCase(),p===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[p],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},p)},u=(p,h,s)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":p===5?"var(--p5)":p===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===p,title:r.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[p]})]},p),m=(p,h,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:v,onClick:s,children:p},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),e.jsxs("div",{className:"offtrack",children:[u(5,!1,r.plabels[5]),u(7,!0,r.plabels[7]),u(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[m("↩",r.toolUndo,i,t.undo.length===0),m("↺",r.toolReset,()=>{a({type:"reset"})}),m("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),m("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const kr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function jr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:i,doAnalyse:o,mode:l}=z(),u=c.useRef(null),[m,p]=c.useState(60);c.useEffect(()=>{let b=0;const f=()=>{var k;const x=u.current;if(!x)return;const g=(k=x.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!g)return;const d=g.getBoundingClientRect(),N=x.getBoundingClientRect();p(Math.max(20,Math.min(d.left+d.width/2-N.left,N.width-30)))};return b=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",f)}},[t.ptab]);const h=t.ptab;let s=n.tuto[h].p;if(h===3){const b=r.filter(g=>g.kind==="target"&&X(g)===3),f=b.filter(g=>Ie(g)==="auto").length,x=b.filter(g=>Ie(g)==="cd").length;s=n.tutoPending(f,x,b.length)}const v=(()=>{if(l!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(h===1){const b=r.filter(f=>f.kind==="target"&&X(f)===1&&!i.has(f.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(f=>o(f))}}return null})();return e.jsxs("div",{ref:u,className:"tuto mini",style:{"--bg":kr[h],"--ax":m+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const mt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function xt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Nr(t,a){const[n,r]=c.useState(1);return c.useEffect(()=>{let i=!0,o=0;const l=()=>{var p;if(!i)return;const m=(p=t.current)==null?void 0:p.getScreenCTM();m&&m.a>0?r(m.a):o=requestAnimationFrame(l)};l();const u=new ResizeObserver(()=>l());return t.current&&u.observe(t.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),u.disconnect(),window.removeEventListener("resize",l)}},[t,a]),n}function Cr(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:i,markedId:o,byId:l,lang:u,t:m}=z(),p=c.useRef(null),h=c.useRef(null),s=Ue.find(j=>j.key===t.continent),v=Nr(p,t.continent+":"+t.mapFolded),[b,f]=c.useState(new Map),[x,g]=c.useState(null);c.useEffect(()=>{const j=p.current;if(!j)return;const E=new Map;j.querySelectorAll("path[data-i2]").forEach($=>{const O=$.dataset.i2;if(O)try{const M=$.getBBox();M.width>0&&E.set(O,{x:M.x,y:M.y,w:M.width,h:M.height})}catch{}}),f(E)},[t.continent,v]);const d=c.useMemo(()=>n.filter(j=>j.cc),[n]),N=c.useMemo(()=>{const j=new Map;return d.forEach(E=>j.set(E.cc,(j.get(E.cc)||0)+1)),j},[d]),k=c.useMemo(()=>d.map(j=>{const E=j.cc?b.get(j.cc):void 0;if(!E)return null;const $=xt(j.name||j.id||""),O=xt((j.id||j.name||"")+"·y"),M=($-.5)*Math.min(E.w*.55,60),P=(O-.5)*Math.min(E.h*.55,60);return{d:j,x:E.x+E.w/2+M,y:E.y+E.h/2+P}}).filter(j=>!!j),[d,b]),y=j=>v>0?j/v:j,C=c.useMemo(()=>r?[0,1,2,3,4,5].map(j=>({c:mt[j],fr:m.plabels[j].toUpperCase(),en:m.plabels[j].toUpperCase(),n:n.filter(E=>E.kind==="target"&&X(E)===j).length})).filter(j=>j.n>0):tt.map((j,E)=>({...j,n:n.filter($=>at($)===E).length})),[n,r,m.plabels]),S=o?l.get(o):null,F=S?k.find(j=>j.d.id===S.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:p,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":u==="fr"?s.fr:s.en,onMouseLeave:()=>{g(null),i(null)},children:[e.jsx("g",{children:s.countries.map((j,E)=>e.jsx("g",{className:"ct"+(j.i2&&N.get(j.i2)?"":" empty"),children:e.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},E))}),e.jsx("g",{children:k.map(j=>{const E=tt[at(j.d)],$=!!G(j.d),O=j.d.kind==="target",M=r&&O?mt[X(j.d)]:E.c,P=!r&&Q(j.d);return e.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var I,H;const A=(I=h.current)==null?void 0:I.getBoundingClientRect(),R=(H=p.current)==null?void 0:H.createSVGPoint();if(R&&p.current&&A){R.x=j.x,R.y=j.y;const ae=R.matrixTransform(p.current.getScreenCTM());g({x:ae.x-A.left,y:ae.y-A.top,label:j.d.name+" · "+(he(j.d.cc,u)||j.d.countryLabel||"")})}i(j.d.id)},onMouseLeave:()=>{g(null),i(null)},onClick:()=>{var I;const A=(I=p.current)==null?void 0:I.createSVGPoint();let R=null;if(A&&p.current){A.x=j.x,A.y=j.y;const H=A.matrixTransform(p.current.getScreenCTM());R={x:H.x,y:H.y}}a({type:"popup",id:j.d.id,anchor:R})},children:[e.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:y(Math.max(11,E.px+7))}),e.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:y(E.px),fill:M,stroke:$?"#DC2626":"#ffffff",strokeWidth:y($?2.2:1.3)})]},j.d.id||j.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:y(13),fill:"none",stroke:"#0F172A",strokeWidth:y(2)})]}),e.jsx("div",{className:"hov"+(x?" on":""),style:x?{left:x.x,top:x.y}:void 0,children:x==null?void 0:x.label}),e.jsx("div",{className:"legend",children:C.map((j,E)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":j.c}}),u==="fr"?j.fr:j.en," ",e.jsx("b",{children:j.n})]},E))}),n.some(j=>!j.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",m.notLocated," ",e.jsx("b",{children:n.filter(j=>!j.cc).length})]})})]})}function Sr(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:i,contName:o}=z(),l=t.filters,u=c.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),m=b=>u.filter(f=>b!=="country"&&l.country.length&&!l.country.includes(f.cc||"")?!1:Ye(f,l,i,b==="country"?void 0:b)),p=c.useMemo(()=>{const b=m("win"),f=x=>b.filter(g=>(g.date?Math.max(0,Math.floor((Date.now()-Date.parse(g.date))/864e5)):9999)<=x).length;return[f(0),f(7),f(30),b.length]},[u,l,i]),h=c.useMemo(()=>{if(i)return null;const b=m("status"),f={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(x=>{f[se(x)]+=1}),f},[u,l,i]),s=l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+(l.signalOnly?1:0)+(l.win!=="all"?1:0)+(!i&&l.status!=="all"?1:0)+(l.search.trim()?1:0),v=(b,f,x,g="fbtn")=>e.jsxs("button",{type:"button",className:g,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:f}),x>0&&e.jsx("span",{className:"n",children:x}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,f)=>e.jsxs("button",{type:"button","aria-pressed":l.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[f],e.jsx("b",{children:p[f]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:l.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!i&&h&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,f])=>e.jsxs("button",{type:"button","aria-pressed":l.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[f,e.jsx("b",{children:h[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),l.signalOnly&&e.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,l.sector.length),v("pay",r.fCountry,l.country.length),v("det",r.fEngine,l.engine.length),v("sta",r.fStage,l.stage.length),i&&v("ang","Angle",l.angle.length),i&&v("mem","Mémo",l.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(u.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(zr,{poolFor:m})]})}function zr({poolFor:t}){const{st:a,dispatch:n,t:r,lang:i}=z(),o=a.filters,l=a.openFacet,{title:u,cols:m,options:p}=c.useMemo(()=>{if(l==="sig"){const f=t("signal").filter(d=>G(d)),x=new Map;f.forEach(d=>{const N=d.engine||"";x.set(N,(x.get(N)||0)+1)});const g=[{v:"*",label:r.fpSigAll,n:f.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...rt([...x.keys()],i).map(d=>({v:d,label:xe(d)+" "+oe(d,i),n:x.get(d)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(d)}))];return{title:r.fpSigTitle,cols:2,options:g}}if(l==="sec"){const f=t("sector"),x=new Map;return f.forEach(g=>{g.sector&&x.set(g.sector,(x.get(g.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...x.entries()].sort((g,d)=>d[1]-g[1]).map(([g,d])=>({v:g,label:g,n:d,html:!1,on:o.sector.includes(g)}))}}if(l==="pay"){const f=t("country"),x=new Map;return f.forEach(g=>{g.cc&&x.set(g.cc,(x.get(g.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...x.entries()].sort((g,d)=>d[1]-g[1]).map(([g,d])=>({v:g,label:he(g,i)||g,n:d,html:!1,on:o.country.includes(g)}))}}if(l==="det"){const f=t("engine"),x=new Map;return f.forEach(g=>{g.engine&&x.set(g.engine,(x.get(g.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:rt([...x.keys()],i).map(g=>({v:g,label:xe(g)+" "+oe(g,i)+' <span style="color:var(--dim);font-size:10px">· '+ua(fa(g),i)+"</span>",n:x.get(g)||0,html:!0,on:o.engine.includes(g)}))}}if(l==="ang"){const f=t("angle"),x=new Map;return f.forEach(g=>{g.angle&&x.set(g.angle,(x.get(g.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...x.entries()].sort((g,d)=>d[1]-g[1]).map(([g,d])=>({v:g,label:g.replace(/[_-]+/g," "),n:d,html:!1,on:o.angle.includes(g)}))}}if(l==="mem"){const f=t("memoLevel"),x=new Map;f.forEach(d=>{if(d.kind==="target"){const N=Ve(d);x.set(N,(x.get(N)||0)+1)}});const g=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(d=>({v:String(d),label:g[d],n:x.get(d)||0,html:!1,on:o.memoLevel.includes(d)}))}}const v=t("stage"),b=new Map;return v.forEach(f=>{f.stage&&b.set(f.stage,(b.get(f.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((f,x)=>x[1]-f[1]).map(([f,x])=>({v:f,label:f,n:x,html:!1,on:o.stage.includes(f)}))}},[l,a,i]),h=v=>{if(l==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const f=o.signalEngines.includes(v)?o.signalEngines.filter(x=>x!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(l==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:v})},s=()=>{n(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:u}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(m===2?" two":""),children:p.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>h(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const gt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Er(){const{t,mode:a,token:n,askEvaluate:r,sessTally:i,dispatch:o,evalBusy:l,evalCards:u,caps:m,data:p}=z(),h=a==="client",[s,v]=c.useState(""),[b,f]=c.useState(!1),[x,g]=c.useState(""),[d,N]=c.useState(!1),[k,y]=c.useState(""),[C,S]=c.useState([]),F=c.useRef(!1),j=s.trim()?gt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,E=c.useMemo(()=>x.split(`
`).map(A=>A.trim()).filter(Boolean).slice(0,15),[x]),$=C.length?C:u,O=p.credits,M=()=>{const A=s.trim();A&&(r(null,A),v(""))},P=async()=>{if(!h){r(null,E[0]||"");return}if(!E.length||d)return;N(!0),F.current=!1;const A=[];for(let R=0;R<E.length&&!F.current;R++){y(t.evaluating(R+1,E.length,E[R]));const I=await Ct(n,E[R],"atelier2");if(A.unshift({name:I.company||E[R],verdict:I.verdict,reason:I.reason||"",remaining:I.remaining??null}),S([...A]),I.verdict==="quota"){A.unshift({name:"",verdict:"quota",reason:t.quota(E.length-R-1),remaining:0}),S([...A]);break}}y(""),g(""),N(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:A=>v(A.target.value),onKeyDown:A=>{A.key==="Enter"&&M()}}),e.jsx("span",{className:"detect"+(gt.test(s.trim())?" url":""),children:j})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),disabled:l,onClick:M,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),m.showCredits&&O&&e.jsxs("button",{type:"button",className:"credits"+(O.total_available<=0&&!O.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:O.unlimited?"∞":O.total_available}),!O.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",O.daily_grant+O.purchased]}),O.total_available<=0&&!O.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>f(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:x,placeholder:t.bulkPh,onChange:A=>g(A.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{justifyContent:"center"},disabled:d||!E.length,onClick:()=>{P()},children:[e.jsx("span",{className:"fill"}),d&&k?k:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(E.length)})]})]}),$.slice(0,1).map((A,R)=>{const I=A.verdict==="kept",H=A.verdict==="quota",ae=I?"var(--brand)":H?"var(--bolt)":"var(--red)",de=I?"var(--brand-l)":H?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":ae,"--bgc":de},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:I?"✓ "+t.kept:H?"⏳":"✗ "+t.dropped})}),A.name&&e.jsx("span",{className:"rn",children:A.name}),e.jsx("span",{className:"rr",children:A.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",A.reason]}):null}),!H&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(I?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},R)}),h&&(i.kept+i.dropped>0||$.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(i.kept,i.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Tr(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ar(){const{st:t,dispatch:a,byId:n,t:r,doDeep:i}=z(),o=t.memoConsole?n.get(t.memoConsole):null,l=c.useMemo(()=>o?[o.reasoning||"",Tr(o.summary||"")].filter(Boolean).join(`
...
`).map((p,h)=>e.jsx("p",{style:{margin:"0 0 10px"},children:p},h)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[_e(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:m===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}function Ot({name:t}){const{t:a,token:n,caps:r,mode:i,flashErr:o}=z(),[l,u]=c.useState(!1),[m,p]=c.useState(null);if(!r.pipe||i!=="client"||r.lockActions)return null;const h=async()=>{if(l)return;u(!0);const s=await ma(n,t);if(u(!1),!s){o(a.actErr);return}p(s.results||[])};return e.jsxs("div",{className:"simb",onClick:s=>s.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{h()},children:l?a.similarBusy:a.similar}),m&&(m.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:m.map(s=>e.jsxs("li",{children:[e.jsx("b",{className:s.verdict==="kept"?"ok":"ko",children:s.company}),s.reason&&e.jsx("span",{children:s.reason})]},s.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Lt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ge({o:t}){const{t:a}=z(),n=Fe(t),r=Re(t),i=X(t),o=Ie(t),l=xa(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Lt[r]||"v-cons"),title:a.vt[r],children:r}):i===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&e.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}function ht({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:i}=z(),[o,l]=c.useState(!1);if(c.useEffect(()=>{r||l(!1)},[r]),Q(t)){const p=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":p?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[p?"✓":"✗"," ",e.jsx("b",{children:p?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const m=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(m?" loading":""),disabled:r,onClick:p=>{p.stopPropagation(),l(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function Or({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:i,doAnalyse:o,doDecide:l,doPromote:u,doRepeche:m,doApproach:p,dispatch:h}=z();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),h({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(ht,{o:t})});const s=X(t),v=b=>f=>{f.stopPropagation(),b()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(ht,{o:t})});if(s===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:v(()=>o(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:v(()=>l(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:v(()=>l(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const b=i.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:v(()=>p(t)),children:b?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>u(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>m(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:v(()=>h({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function Lr({o:t}){const{t:a,doThumb:n,thumbOf:r}=z(),i=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function Fr({o:t}){const{lang:a}=z();return G(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(be,{o:t}),e.jsx(Me,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[xe(t.engine||"")," ",oe(t.engine||"",a)]})})}function Rr({o:t,locked:a,open:n,onToggle:r}){const{st:i,dispatch:o,caps:l,markRow:u,markedId:m,favIds:p,toggleFav:h}=z(),s=X(t),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,f=b<=0?0:b<=7?1:b<=30?2:3,x=l.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:v[f],g=p.has(t.id),d=N=>{if(a)return;if(l.pipe){r();return}const k=N.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:k.left+Math.min(280,k.width/3),y:k.bottom}})};return e.jsxs(c.Fragment,{children:[e.jsxs("div",{className:"row"+(m===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>u(t.id),onMouseLeave:()=>u(null),onClick:d,children:[e.jsx("span",{className:"pt",style:{"--c":x}}),e.jsx(Rt,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[l.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:g?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),h(t)},children:g?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(N=>N&&N!==t.name)||""})]}),e.jsx(Mr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(Fr,{o:t}),l.pipe&&e.jsx(Ge,{o:t}),l.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(Or,{o:t}),l.showThumbs&&e.jsx(Lr,{o:t})]}),(n||i.dens==="deplie")&&!a&&e.jsx(Dr,{o:t})]})}function Mr({o:t}){const{lang:a,caps:n}=z();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=He(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function Dr({o:t}){const{t:a,lang:n,dispatch:r,caps:i,outbound:o,doOnboard:l}=z();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(Fe(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:Fe(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsx(ur,{o:t}),e.jsx(xr,{o:t}),e.jsx(Ot,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(Ge,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[xe(t.engine||"")," ",oe(t.engine||"",n)]}),G(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(be,{o:t})})]}),i.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(t),children:a.actOnboard})]})]})]})}function qr({o:t,locked:a}){const{t:n,dispatch:r,caps:i,doDecide:o}=z(),l=X(t),u=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":u},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(Ge,{o:t}),G(t)&&e.jsx(be,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&i.pipe&&l===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function Pr(){const t=z(),{st:a,dispatch:n,t:r,caps:i,scoped:o,lang:l,sessTally:u}=t,[m,p]=c.useState(new Set);c.useEffect(()=>{p(new Set)},[a.ptab,a.continent]);const h=k=>p(y=>{const C=new Set(y);return C.has(k)?C.delete(k):C.add(k),C}),s=c.useMemo(()=>We(o,a.sort),[o,a.sort]),v=c.useMemo(()=>s.filter(k=>G(k)&&!Q(k)).length,[s]),b=i.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,f=(k,y,C="",S=!1)=>e.jsxs("button",{type:"button","data-s":k,className:C,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:S?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:k}),children:[y,e.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),x=c.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const k=new Map;return s.forEach(y=>{const C=y.engine||"?";k.has(C)||k.set(C,[]),k.get(C).push(y)}),[...k.entries()]},[s,i.pipe,a.groupBy]),g=i.lockRowsAfter;let d=0;const N=(k,y)=>{const C=a.shown[y]||Le,F=k.slice(0,C).map(j=>{const E=g!==null&&d>=g;return d++,a.dens==="maxi"?e.jsx(qr,{o:j,locked:E},j.id):e.jsx(Rr,{o:j,locked:E,open:m.has(j.id),onToggle:()=>h(j.id)},j.id)});return k.length>C&&F.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:y,by:Le}),children:r.more(Math.min(Le,k.length-C),k.length-C)},y+":more")),F};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:s.length})," ",b]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,i.pipe&&t.fund?" · "+t.fund:""]}),i.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),i.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([k,y])=>e.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>n({type:"dens",dens:k}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:y})]},k))}),i.showChain&&s.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:s.filter(k=>i.pipe?!0:!Q(k)).map(k=>k.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",i.pipe?r.browse(s.length):r.chainAll(s.filter(k=>!Q(k)).length)]})]}),v>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(v)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),f("country",r.colCountry),f("name",r.colCompany),f("amount",r.colAmount,"h-amt",!0),f("stage",r.colStage,"h-stade"),f("signal",r.colSignal,"h-sig"),i.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),i.pipe&&f("score",r.colScore,"h-sc",!0),e.jsx("span",{}),i.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[x?x.map(([k,y])=>e.jsxs(c.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:xe(k)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:oe(k,l)}),e.jsx("div",{className:"s",children:r.grpCount(y.filter(C=>!Q(C)).length,y.length)})]})]}),N(y,k)]},k)):N(s,"pt"+a.ptab),!s.length&&e.jsx("div",{className:"void",children:i.pipe?r.emptyTab:r.emptyScope})]}),i.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(u.kept>0||u.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(u.kept,u.dropped)}})]})}const Br=`
...
`;function Ir(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,i=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let l=t.y+10;return l+n>i-8&&(l=Math.max(8,t.y-n-14)),l<8&&(l=8),{left:o,top:l}}function $r(){const{st:t,dispatch:a,byId:n,t:r,lang:i,caps:o,mode:l,askEvaluate:u,doAnalyse:m,doDecide:p,doPromote:h,doRepeche:s,doApproach:v,doDeep:b,doOnboard:f,outbound:x,evalBusy:g}=z(),d=t.popupId?n.get(t.popupId):null;if(!d)return null;const N=G(d),k=X(d),y=Re(d),C=d.kind==="target",S=F=>{a({type:"filters",patch:F}),a({type:"popup",id:null})};return Ne.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Br}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Ir(t.popupAnchor),onClick:F=>F.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:d.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(ge(d.date)),oe(d.engine,i))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[d.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[d.cc]}),children:(he(d.cc,i)||d.countryLabel||"").toUpperCase()}),d.sector&&e.jsx("button",{type:"button",onClick:()=>S({sector:[d.sector]}),children:d.sector.toUpperCase()}),d.stage&&e.jsx("button",{type:"button",onClick:()=>S({stage:[d.stage]}),children:d.stage.toUpperCase()}),typeof d.amountEur=="number"&&d.amountEur>0&&e.jsx("span",{className:"am2",children:He(d.amountEur,i)})]}),(d.tagline||d.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:d.tagline||d.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[xe(d.engine)," ",e.jsx("b",{children:oe(d.engine,i)})," — ",ga(d.engine,i),d.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",d.noteTitle]})]}),N?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(be,{o:d,lg:!0})," ",e.jsx(Me,{o:d,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(St(N,i))," · ",r.win7(zt(N,i))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),d.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&k>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:d.reasoning})]}),o.pipe&&C&&y&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[y,typeof d.score=="number"&&d.score>0?" · "+r.score(d.score):""]})})]}),e.jsx(Ot,{name:d.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[k===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>u(d),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),k===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{m(d),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),k===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(d),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),k===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(d,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{p(d,!1),a({type:"popup",id:null})},children:r.actNo}),_e(d)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(d),a({type:"popup",id:null})},children:r.memoDeep})]}),k===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{v(d),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),k===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(d),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),d.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:d.id}),a({type:"popup",id:null})},children:"📄"}),x&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{f(d),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>u(d),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),d.website&&e.jsx("a",{className:"psite",href:d.website.startsWith("http")?d.website:"https://"+d.website,target:"_blank",rel:"noopener noreferrer",title:d.website,children:"🌐"})]})]})]}),document.body)}function bt(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Vr(t,a){const n=ha(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function Ur(t,a){const r=[a.head.split("|").map(bt).join(";")];for(const i of t){const o=a.stageOf(i);r.push([i.name||"",Vr(i,a.plabels),Fe(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(bt).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function _r(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const Hr=50;function Ke({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:i}=z(),[o,l]=c.useState(null),[u,m]=c.useState(!1),[p,h]=c.useState(""),[s,v]=c.useState(0),[b,f]=c.useState(""),[x,g]=c.useState(!1),d=c.useRef(null);c.useEffect(()=>()=>{d.current&&window.clearInterval(d.current)},[]);const N=async y=>{m(!0),h("");const C=await a();if(m(!1),C.ok){l(C);return}if(C.busy){h(i.alertPreviewBusy);return}if(!y){h(i.alertPreviewFail);return}v(Hr),d.current=window.setInterval(()=>{v(S=>S>1?S-1:(d.current&&window.clearInterval(d.current),N(!1),0))},1e3)},k=async()=>{if(r||x)return;g(!0),f("");const y=await n();g(!1),f(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:u||s>0,onClick:()=>{N(!0)},children:u?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||x,onClick:()=>{k()},children:x?"…":i.alertTest})]}),s>0&&e.jsx("p",{className:"mnote",children:i.alertPreviewRetry(s)}),p&&e.jsx("p",{className:"mnote warn",children:p}),b&&e.jsx("p",{className:"mnote",children:b}),!b&&e.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const je="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function J({title:t,icon:a,children:n,wide:r}){const{dispatch:i}=z();return Ne.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function Yr(){const{st:t}=z();switch(t.modal){case"chain":return e.jsx(Gr,{});case"space":return e.jsx(Kr,{});case"alert":return e.jsx(Qr,{});case"queue":return e.jsx(tn,{});case"export":return e.jsx(an,{});case"plug":return e.jsx(on,{});case"recharge":return e.jsx(sn,{});case"cover":return e.jsx(dn,{});case"crit":return e.jsx(cn,{});case"tuto":return e.jsx(pn,{});case"rdv":return e.jsx(Wr,{});case"memoalert":return e.jsx(rn,{});default:return null}}function Wr(){const{dispatch:t,fund:a}=z(),n=typeof document<"u"&&!!document.getElementById("rdv");return c.useEffect(()=>{n&&(t({type:"modal",modal:null}),or())},[n,t]),n?null:e.jsx(ya,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function Gr(){const{st:t,dispatch:a,byId:n,t:r,lang:i,mode:o,askEvaluate:l,evalBusy:u}=z(),m=o==="client",p=t.chain.queue.map(b=>n.get(b)).filter(b=>!!b),h=t.chain.idx,s=p[h],v=h>=p.length;return Ne.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:v?r.finished:`${h+1} / ${p.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(v?100:h/Math.max(1,p.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:v||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(p.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[he(s.cc,i)||s.countryLabel,s.sector,s.stage,r.daysAgo(ge(s.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:oe(s.engine,i).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:He(s.amountEur,i)})]}),G(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(be,{o:s,lg:!0})," ",e.jsx(Me,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),m&&Q(s)&&e.jsxs("div",{className:"vbox",style:{"--c":se(s)==="retenu"?"var(--brand)":se(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:se(s)==="retenu"?"✓ "+r.kept:se(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!v&&s&&!(m&&Q(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:u,onClick:()=>{l(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?r.closeBtn:r.skip})]})]})})}),document.body)}function Kr(){const{st:t,dispatch:a,dossiers:n,t:r,mode:i}=z(),o=i==="client",l=c.useMemo(()=>o?n.filter(s=>Q(s)):[],[n,o]),u=c.useMemo(()=>We(l.filter(s=>se(s)==="retenu"),{key:"signal",dir:-1}),[l]),m=c.useMemo(()=>l.filter(s=>se(s)==="ecarte"),[l]),p=t.spaceTab==="retenu"?u:m,h=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(J,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:u.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:m.length})]})]}),p.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),p.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":h},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function Qr(){const{mode:t}=z();return t==="client"||t==="apercu"?e.jsx(Jr,{}):e.jsx(en,{})}function Jr(){const{t,token:a,flash:n,flashErr:r,mode:i}=z(),[o,l]=c.useState("d"),u=i!=="client";return e.jsxs(J,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(Xr,{t,token:a,readOnly:u,flash:n,flashErr:r}):e.jsx(Zr,{t,token:a,readOnly:u,flash:n,flashErr:r})]})}function Xr({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,l]=c.useState(null),[u,m]=c.useState(!1),[p,h]=c.useState(0);c.useEffect(()=>{let f=!0;return m(!1),lt(a).then(x=>{f&&(x?l(x):m(!0))}),()=>{f=!1}},[a,p]);const s=f=>{n||lt(a,f).then(x=>{if(!x){i(t.actErr);return}l(x),x.throttled?i(t.alertThrottled):r(t.alertSaved)})};if(u)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=f=>!o.sections||o.sections.includes(f),b=f=>{const x=o.sections||t.alertSec.map(([g])=>g);s({sections:v(f)?x.filter(g=>g!==f):[...x,f]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([f,x])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:v(f),disabled:n,onChange:()=>b(f)}),e.jsxs("span",{children:[x,f==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},f))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(Ke,{label:t.alertPreview,readOnly:n,onPreview:()=>Ca(a),onTest:()=>Na(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Zr({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,l]=c.useState(null),[u,m]=c.useState(!1),[p,h]=c.useState(0);c.useEffect(()=>{let f=!0;return m(!1),st(a).then(x=>{f&&(x?l(x):m(!0))}),()=>{f=!1}},[a,p]);const s=f=>{n||st(a,f).then(x=>{if(!x){i(t.actErr);return}l(x),r(t.alertSaved)})};if(u)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=o.dow??0,b=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:v,disabled:n,onChange:f=>s({dow:Number(f.target.value)}),children:t.alertDow.map((f,x)=>e.jsx("option",{value:x,children:f},f))}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,b-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[b," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,b+1)}),disabled:n,children:"＋"})]})]}),e.jsx(Ke,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>za(a),onTest:()=>Sa(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function en(){const{st:t,t:a,lang:n,scoped:r,contName:i}=z(),[o,l]=c.useState(""),[u,m]=c.useState(!1),[p,h]=c.useState(!1),s=t.filters,v=c.useMemo(()=>r.filter(g=>G(g)).length,[r]),b=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,f=async()=>{if(!(!/.+@.+\..+/.test(o)||p)){h(!0);try{await fetch(`${$e}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),m(!0)}finally{h(!1)}}},x=[[a.amRows.continent,i],[a.amRows.since,a.amSince[b]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(g=>oe(g,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(g=>he(g,n)||g).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(J,{title:a.alertTitle,icon:"🔔",children:u?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:x.map(([g,d])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:g}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:d}})]},g))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&f()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void f(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function tn(){var x,g,d;const{t,token:a,fund:n,mode:r,flash:i}=z(),[o,l]=c.useState(null),[u,m]=c.useState([]),[p,h]=c.useState(0),s=r==="client";c.useEffect(()=>{let N=!0;return(async()=>{const[k,y]=await Promise.all([kt(n),jt(a)]);N&&(k&&l(k),m(y))})(),()=>{N=!1}},[a,n,p]);const v=(o==null?void 0:o.per_day)??2,b=((x=o==null?void 0:o.analyzed_today)==null?void 0:x.length)??0,f=(g=o==null?void 0:o.tomorrow)!=null&&g.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(J,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(b,b+(((d=o==null?void 0:o.pool_order)==null?void 0:d.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(N=>e.jsx("button",{type:"button",className:"qr"+(v===N?" on":""),disabled:!s,onClick:()=>{Nt(a,N).then(k=>{k!==null&&(h(y=>y+1),i(t.alertSaved))})},children:e.jsxs("b",{children:[N,"/j"]})},N))})]}),u.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:u.map(N=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:N.company}),e.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),e.jsx("span",{className:"qt",children:N.status}),N.url&&e.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&N.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{it(a,N.company,"retry").then(()=>h(k=>k+1))},children:t.queueRetry}),s&&N.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{it(a,N.company,"delete").then(()=>h(k=>k+1))},children:t.queueDelete})]},N.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[f.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),f.slice(0,10).map((N,k)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",k+1]}),e.jsx("b",{children:N.name}),typeof N.score=="number"&&e.jsx("span",{className:"qs2",children:N.score})]},N.name))]})]})}function an(){const{t,token:a,flash:n,scoped:r,caps:i,stageOf:o}=z(),l=`${je}/cibles/list.csv?token=${a}`,u=`${je}/cibles/list.json?token=${a}`,m=`${je}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${l}")`,h=f=>{var x;(x=navigator.clipboard)==null||x.writeText(f).then(()=>n(t.exportCopied))},s=[{def:t.exportCsv,value:l,href:l},{def:t.exportSheet,value:p},{def:t.exportLive,value:u,href:u},{def:t.exportXlsx,value:m,href:m}],v=!i.lockActions&&r.length>0,b=()=>{_r(Ur(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:f=>(t.stg.find(([x])=>x===f)||["",""])[1]})),n(t.exportViewDone(r.length))};return e.jsxs(J,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:b,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:s.map(({def:f,value:x,href:g})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:f[0]}),e.jsxs("div",{children:[e.jsx("b",{children:f[1]}),e.jsx("p",{children:f[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>h(x),children:t.exportCopy}),g&&e.jsx("a",{className:"exb",href:g,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},f[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function rn(){const{t,token:a,flash:n,flashErr:r,mode:i}=z(),o=i!=="client",[l,u]=c.useState(null),[m,p]=c.useState(!1),[h,s]=c.useState(0),[v,b]=c.useState(!1);c.useEffect(()=>{let d=!0;return p(!1),nt(a).then(N=>{d&&(N?u(N):p(!0))}),()=>{d=!1}},[a,h]);const f=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},x=d=>{if(o||!l)return;const N={enabled:d.enabled??!!l.enabled,email:d.email??(l.email||""),sections:d.sections??f()};b(!0),nt(a,N).then(k=>{if(b(!1),!k){r(t.memoAlertErr);return}u(k),n(t.memoAlertSaved)})};if(m)return e.jsx(J,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>s(d=>d+1),children:t.retry})]})});if(!l)return e.jsx(J,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const g=f();return e.jsxs(J,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||v,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),e.jsx(nn,{value:l.email||"",readOnly:o||v,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:d=>x({email:d})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([d,N])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!g[d],disabled:o||v,onChange:()=>x({sections:{...g,[d]:!g[d]}})}),e.jsx("span",{children:N})]},d))}),e.jsx(Ke,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>va(a,g),onTest:()=>ba(a,g)})]})}function nn({value:t,readOnly:a,label:n,okLabel:r,onSave:i}){const[o,l]=c.useState(t);c.useEffect(()=>{l(t)},[t]);const u=o.trim()!==t.trim(),m=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:p=>l(p.target.value),onKeyDown:p=>{p.key==="Enter"&&u&&m&&i(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!u||!m,onClick:()=>i(o.trim()),children:r})]})]})}function on(){const{t,token:a,flash:n,flashErr:r,canWrite:i}=z(),[o,l]=c.useState(null),[u,m]=c.useState(!1),[p,h]=c.useState(null),[s,v]=c.useState(""),[b,f]=c.useState(0);c.useEffect(()=>{let d=!0;return m(!1),ot(a).then(N=>{d&&(N?l({configured:N.configured,url_hint:N.url_hint}):m(!0))}),ka(a).then(N=>{d&&h(N)}),()=>{d=!1}},[a,b]);const x=(d,N)=>{i&&ot(a,d).then(k=>{if(!k||k.ok===!1){r(t.actErr);return}d.test&&k.sent===!1?r(t.plugTestThrottled):n(N),f(y=>y+1)})},g='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(J,{title:t.plugTitle,icon:"🔌",wide:!0,children:[p&&e.jsx("p",{className:"mnote"+(p.enabled?" warn":""),children:p.enabled?t.plugAutoOn(p.destination||"webhook"):t.plugAutoOff}),u?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>f(d=>d+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:s,disabled:!i,onChange:d=>v(d.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!i||!s.trim(),onClick:()=>x({url:s.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>x({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>x({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(ln,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:g}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var d;(d=navigator.clipboard)==null||d.writeText(g).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function ln(){const{t,token:a}=z(),[n,r]=c.useState("valides"),[i,o]=c.useState(!1),[l,u]=c.useState(null),m=async()=>{o(!0),u(await ja(a,n)),o(!1)};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:n,onChange:p=>r(p.target.value),children:t.plugBulkTabs.map(([p,h])=>e.jsx("option",{value:p,children:h},p))}),e.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{m()},children:i?"…":t.plugBulkPreview})]}),l&&(l.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr}))]})}function sn(){const{t,data:a,lang:n}=z(),r=a.credits,i=a.email,o=async l=>{if(!i)return;const u=window.location.href.split("?")[0];try{const p=await(await fetch(`${$e}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:u+"?credits=ok",cancel_url:u+"?credits=cancel"})})).json();p.url&&(window.location.href=p.url)}catch{}};return e.jsxs(J,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(l=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(l.credits,l.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:t.rechargeBuy})]},l.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function dn(){const{t,data:a,dossiers:n}=z(),r=n.filter(o=>o.kind==="target"&&Q(o)).length,i=a.marketEstimate||0;return e.jsx(J,{title:t.coverTitle,icon:"🌍",children:i>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,i)}}):e.jsx("p",{children:t.coverScreened(r)})})}function cn(){var d,N,k;const{t,dossiers:a,token:n,mode:r,flash:i,criteria:o}=z(),l=r==="client",u=c.useMemo(()=>{const y=new Set;return a.forEach(C=>{C.angle&&y.add(C.angle)}),[...y]},[a]),[m,p]=c.useState(null);c.useEffect(()=>{let y=!0;return wa(n).then(C=>{y&&p(C.thumbs)}),()=>{y=!1}},[n]);const[h,s]=c.useState(""),[v,b]=c.useState(""),[f,x]=c.useState(!1),g=async()=>{const y=h.trim();if(!(!y||f||!l)){x(!0),b("");try{const S=await(await fetch(`${je}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:y,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&b(String(S.reply)),S.job_id){b(t.critChatRunning);const F=async()=>{const j=await fetch(`${je}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(E=>E.json()).catch(()=>null);if(j&&j.done){b(String(j.reply||j.clarification||j.summary||"✓")),x(!1),j.applied&&i(t.alertSaved);return}setTimeout(()=>{F()},8e3)};setTimeout(()=>{F()},8e3),s("");return}s("")}finally{v.startsWith("⏳")||x(!1)}}};return e.jsxs(J,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((d=o.points)!=null&&d.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(y=>e.jsx("li",{children:y},y))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((N=o==null?void 0:o.angles)!=null&&N.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(y=>{var C,S;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:y.title}),y.why&&e.jsx("p",{className:"why",children:y.why}),e.jsxs("div",{className:"lo",children:[!!((C=y.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:y.look.map(F=>e.jsx("li",{children:F},F))})]}),!!((S=y.out)!=null&&S.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:y.out.map(F=>e.jsx("li",{children:F},F))})]})]})]},y.title)})]}),!!((k=o==null?void 0:o.gate)!=null&&k.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>e.jsxs("li",{children:[y.k&&e.jsx("b",{children:y.k}),y.t]},y.t))})]}),u.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:u.map(y=>e.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:h,disabled:!l||f,onChange:y=>s(y.target.value),onKeyDown:y=>{y.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!l||f||!h.trim(),onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),v&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:v})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),m===null?e.jsx("div",{className:"sp-empty",children:"…"}):m.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:m.slice(0,12).map((y,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:y.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:y.company}),e.jsx("span",{className:"qd",children:(y.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([y,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Lt[y]||"v-cons"),children:y}),e.jsx("span",{children:C})]},y))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([y,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:y}),e.jsxs("span",{children:["← ",C]})]},y))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function pn(){const{t,dispatch:a,startTour:n}=z(),r=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return e.jsxs(J,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([i,o],l)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:u=>{(u.key==="Enter"||u.key===" ")&&(u.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:l+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Ft=c.createContext(null),z=()=>{const t=c.useContext(Ft);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function be({o:t,lg:a}){const{lang:n}=z(),r=G(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:dt(r,n),children:[r.emoji," ",dt(r,n)]}):null}function Me({o:t,src:a}){const{lang:n,t:r}=z(),i=G(t);if(!i)return null;const o=La(i),l=Fa(i);return e.jsxs("em",{className:"sigwin"+(l?" hot":""),title:r.signaledOn(St(i,n))+" · "+r.win7(zt(i,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(u,m)=>e.jsx("i",{className:m<o?"on":""},m))}),e.jsx("span",{className:"lb",children:l?r.lastDay:r.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&e.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:u=>u.stopPropagation(),children:"↗"})]})}function Rt({o:t}){const{lang:a}=z(),n=Oa(t.cc),r=t.cc?he(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const vt="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Mt=t=>`atl2:tour:${t||"anon"}`;function un(t){try{return localStorage.getItem(Mt(t))==="1"}catch{return!0}}function yt(t){try{localStorage.setItem(Mt(t),"1")}catch{}}function fn(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function bn({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:i,onFiltersChange:o}){const{lang:l}=Ea(),u=$a[l],m=Xa(t,l,a),[p,h]=c.useReducer(er,void 0,()=>Za((r==null?void 0:r.continent)??"europe",t,{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=c.useRef(o);s.current=o,c.useEffect(()=>{var w;(w=s.current)==null||w.call(s,p.filters)},[p.filters]);const[v,b]=c.useState(null),[f,x]=c.useState(null),[g,d]=c.useState({kept:0,dropped:0}),[N,k]=c.useState(!1),[y,C]=c.useState(""),[S,F]=c.useState(!1),[j,E]=c.useState(null),[$,O]=c.useState(!1),[M,P]=c.useState(!1),[,A]=c.useState(0),R=()=>A(w=>w+1),I=c.useRef([]),H=c.useRef(new Set),ae=c.useRef(new Set),de=c.useRef(new Map),ie=c.useRef(null),{mode:Ce}=m,q=c.useMemo(()=>i?{...m.caps,...i}:m.caps,[m.caps,i]),Z=q.pipe,D=m.session.token||"",V=Ce==="client"&&!t;c.useEffect(()=>{if(document.querySelector(`link[href="${vt}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=vt,document.head.appendChild(w)},[]);const B=(w,T=!1)=>{C(w),F(T),ie.current&&clearTimeout(ie.current),ie.current=setTimeout(()=>C(""),T?4200:2400)},_=w=>B(w,!0),ee=c.useMemo(()=>{const w=new Map;return m.dossiers.forEach(T=>{T.id&&w.set(T.id,T)}),w},[m.dossiers]),K=c.useMemo(()=>m.dossiers.filter(w=>Tt(w,p,Z)),[m.dossiers,p,Z]),Y=c.useRef(!1);c.useEffect(()=>{if(Y.current||t||m.loading||!m.dossiers.length)return;if(!q.showFunnel||un(m.session.token||"")){Y.current=!0;return}Y.current=!0;const w=window.setTimeout(()=>{yt(m.session.token||""),O(!0)},700);return()=>window.clearTimeout(w)},[t,m.loading,m.dossiers.length,q.showFunnel,m.session.token]);const ve=c.useMemo(()=>m.dossiers.filter(w=>tr(w,p,Z,m.favIds)),[m.dossiers,p,Z,m.favIds]),U=c.useMemo(()=>Ta(K,m.favIds),[K,m.favIds]),re=Ue.find(w=>w.key===p.continent),ce=l==="fr"?re.fr:re.en,ye=(w,T)=>{const L=((w==null?void 0:w.name)||T||"").trim();if(!V){x({kicker:L});return}!L||N||(k(!0),(async()=>{try{const W=await Ct(D,L,"atelier2"),ze={name:W.company||L,verdict:W.verdict,reason:W.reason||"",remaining:W.remaining??null};I.current=[ze,...I.current].slice(0,8),W.verdict==="kept"&&d(ue=>({...ue,kept:ue.kept+1})),W.verdict==="ruled_out"&&d(ue=>({...ue,dropped:ue.dropped+1}));const we=w||m.dossiers.find(ue=>(ue.name||"").toLowerCase()===L.toLowerCase());we&&(W.verdict==="kept"?we.verdict=we.verdict||"MATCH":W.verdict==="ruled_out"&&(we.verdict="NO MATCH"),W.reason&&(we.reasoning=W.reason)),R()}finally{k(!1)}})())},me=w=>{if(!V){x({kicker:w.name});return}H.current.add(w.id),ke(D,"fast_request",w.name||"",""),B(u.memoInstantSent(w.name)),R()},te=w=>de.current.get(w.id)??m.thumbs.get((w.name||"").trim().toLowerCase()),Se=(w,T)=>h({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:T}}),pe=async(w,T,L)=>{const W=w.ceoStatus||"";w.ceoStatus=T,R();const ze=await Pe(D,{status:T,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(L==null?void 0:L.note)!==void 0?{note:L.note}:{},...L!=null&&L.via?{via:L.via}:{}});return ze.ok?ze.skipped?(w.ceoStatus=W,R(),_(u.actNotPersisted),!1):((L==null?void 0:L.undo)!==!1&&Se(w,W),L!=null&&L.msg&&B(L.msg),(T==="Validé"||T==="Écarté")&&!w.ceoNote&&(L==null?void 0:L.note)===void 0&&E({o:w,yes:T==="Validé"}),!0):(w.ceoStatus=W,R(),_(u.actErr),!1)},ne=async(w,T)=>{const L=await Pe(D,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:T,via:"note"});return!L.ok||L.skipped?(_(L.skipped?u.actNotPersisted:u.actErr),!1):(w.ceoNote=T,R(),!0)},le=c.useRef(new Map),Dt=w=>le.current.has(w.id)?le.current.get(w.id):m.stages.get((w.name||"").trim().toLowerCase()),qt=(w,T)=>{le.current.set(w.id,T),R()},Pt=(w,T)=>{V&&pe(w,T?"Validé":"Écarté",{msg:T?u.decidedYes(w.name):u.decidedNo(w.name)})},Bt=w=>{V&&pe(w,"À trancher",{msg:u.promoted(w.name)})},It=w=>{V&&(async()=>{const T=w.ceoStatus||"";w.ceoStatus="Retenu",R();const L=await Pe(D,{status:"Retenu",check_id:w.checkId,company:w.name});if(!L.ok||L.skipped){w.ceoStatus=T,R(),_(L.skipped?u.actNotPersisted:u.actErr);return}Se(w,T),B(u.repeched(w.name))})()},$t=()=>{const w=p.undo[p.undo.length-1];if(!w){B(u.undoNone);return}const T=ee.get(w.id);if(!T){h({type:"undoPop"}),B(u.undoNone);return}let L=w.prevCeoStatus;if(!L)if((T.verdict||"").toUpperCase().includes("CALL"))L="À trancher";else{B(u.undoLockedTitle);return}(async()=>await pe(T,L,{undo:!1})&&(h({type:"undoPop"}),T.ceoStatus=w.prevCeoStatus,R(),B(u.undoDone(T.name))))()},Vt=w=>{V&&(ae.current.add(w.id),R(),(async()=>{const T=await Ra(D,w.name,"email");if(!T||T.ok===!1){ae.current.delete(w.id),R(),_(u.actErr);return}ke(D,"approach",w.name||"",""),B(u.actApproachSent)})())},Ut=(w,T)=>{V&&(async()=>{if(!(await ke(D,T?"yes":"no",w.name||"","")).ok){_(u.actErr);return}de.current.set(w.id,T?"yes":"no"),R(),B(T?u.thumbUpDone:u.thumbDnDone)})()},_t=w=>{!V||!_e(w)||(ke(D,"detailed_request",w.name||"",""),B(u.memoDeepSent(w.name)))},Ht=w=>{const T=new Set(m.favIds),L=T.has(w.id);L?T.delete(w.id):T.add(w.id),m.setFavIds(T),V&&Ma(D,{id:w.id,co:w.name},L)},Yt=()=>{!V||M||window.confirm(u.identSyncConfirm)&&(P(!0),(async()=>{const w=await Da(D);P(!1),w?B(u.identSyncDone):_(u.actErr)})())},Qe=/proplace/i.test(m.fund||""),Wt=w=>{!V||!Qe||(ke(D,"onboard_request",w.name||"",""),B(u.onboardSent(w.name)))},Gt={st:p,dispatch:h,t:u,lang:l,mode:Ce,caps:q,pipe:Z,token:D,fund:m.fund,email:m.email,criteria:m.criteria,data:m,doRepeche:It,thumbOf:te,canWrite:V,commitStatus:pe,saveNote:ne,stageOf:Dt,setStage:qt,flashErr:_,startTour:()=>O(!0),dossiers:m.dossiers,scopedAll:K,scoped:ve,counts:U,byId:ee,contName:ce,favIds:m.favIds,toggleFav:Ht,askEvaluate:ye,doAnalyse:me,doDecide:Pt,doPromote:Bt,doApproach:Vt,doThumb:Ut,doDeep:_t,doUndo:$t,doSync:Yt,doOnboard:Wt,outbound:Qe,memoQueued:H.current,approachDone:ae.current,sessTally:g,evalCards:I.current,evalBusy:N,markRow:b,markedId:v,flash:B};return c.useEffect(()=>{const w=T=>{T.key==="Escape"&&(h({type:"popup",id:null}),h({type:"modal",modal:null}),h({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]),e.jsx(Ft.Provider,{value:Gt,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:_a}),e.jsxs("div",{className:"app"+(Z?" pipe":""),children:[q.showTicker&&e.jsx(ar,{}),q.showIdent&&e.jsx(br,{}),q.showOnb&&e.jsx(vr,{}),e.jsx(hr,{}),e.jsx(cr,{}),q.showFunnel&&e.jsx(mn,{}),q.showFunnel&&e.jsx(wr,{}),q.showFunnel&&e.jsx(jr,{}),e.jsxs("div",{className:"fzone",children:[e.jsx(xn,{}),e.jsxs("div",{className:"stage"+(p.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Cr,{}),e.jsx(Sr,{})]})]}),q.showDemand&&e.jsx(Er,{}),q.showDemand&&p.memoConsole&&e.jsx(Ar,{}),e.jsx(Pr,{}),m.loading&&e.jsx("div",{className:"void",children:u.loadingV2}),m.error&&!m.loading&&e.jsxs("div",{className:"void",children:[u.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:m.refresh,children:u.retry})]})]}),q.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:u.lockbarText}),e.jsx("button",{type:"button",onClick:()=>h({type:"modal",modal:"rdv"}),children:u.lockbarCta})]}),p.popupId&&e.jsx($r,{}),e.jsx(Yr,{}),e.jsx(lr,{}),j&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:j.o.name}),e.jsx(mr,{placeholder:j.yes?u.whyYesPh:u.whyNoPh,onDone:w=>{const T=j.o;E(null),w&&ne(T,w).then(L=>{L&&B(u.csNoteSaved)})}})]}),$&&e.jsx(gr,{steps:fn(u),onClose:()=>{O(!1),yt(D)}}),y&&e.jsx("div",{className:"flash on"+(S?" err":""),children:y}),f&&e.jsx(Aa,{variant:"acquirer",initialCompany:wt().co,initialWebsite:wt().site,onClose:()=>x(null)})]})})}function mn(){const{t}=z(),[a,n]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function xn(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:i,t:o}=z(),l=c.useMemo(()=>{const u={};return t.forEach(m=>{m.continent&&Ye(m,a.filters,r)&&(u[m.continent]=(u[m.continent]||0)+1)}),u},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[qa.map(u=>{const m=Ue.find(p=>p.key===u);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===u,onClick:()=>n({type:"continent",key:u}),children:[i==="fr"?m.fr:m.en,e.jsx("span",{className:"n",children:l[u]||0})]},u)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function wt(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function gn(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Rt as FlagCell,be as SigBadge,Me as SigWin,bn as default,gn as fmtShort,z as useV2};
