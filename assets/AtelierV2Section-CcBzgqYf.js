...
.atl2.ops .eval-stick{background:var(--pp-bg,#fff);box-shadow:none;padding-bottom:8px}
.atl2.ops .demand{margin:0 var(--v3-pad);padding:18px;
...
.atl2.ops .demand .evalbtn,.atl2.ops .demand .dacts .evalbtn{
  ...
  white-space:nowrap}
.atl2.ops .demand .dacts .viewbtn.sm{border:1px solid var(--pp-line,#E3E8F0);
  padding:8px 14px;font-size:12px;font-weight:600;background:#fff;color:#4B5E78}
.atl2.ops .demand .dacts .viewbtn.sm:not(.off){background:var(--pp-navy,#0F1D33);
  color:#fff;border-color:var(--pp-navy,#0F1D33)}
...
.atl2.ops .readpane .zoom,.atl2.ops .readpane.is-edito .zoom{
  ...
  background:#fff!important;overflow:visible;padding:0;margin:0!important;
  max-width:none!important;min-width:0;box-sizing:border-box}
.atl2.ops .readpane .zoom>.zoom-body,.atl2.ops .readpane .zoom>.thesis-brief,
.atl2.ops .readpane .card.ops-open{padding:24px;margin:0;background:transparent;border:0}
...
/* Filtres / densité : pilules comme /cibles */
.atl2.ops .listhead .lh-tools .fstrip button,
.atl2.ops .listhead .dens button,.atl2.ops .listhead .doable .dobtn{
  ...
  cursor:pointer;white-space:nowrap}
.atl2.ops .listhead .dens button.on,.atl2.ops .listhead .dens button[aria-pressed="true"]{
  background:var(--pp-navy,#0F1D33);color:#fff;border-color:var(--pp-navy,#0F1D33)}
