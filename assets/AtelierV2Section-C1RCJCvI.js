...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ki=`
...
`,Qi=Gi+Ki;function Qa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ji(){const e=Qa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Xi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ji();return r==="0"?"client":r==="1"||Qa("embed")==="1"&&Qa("chrome")==="1"?"apercu":"client"}const Zi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},es=e=>Zi[e];function wa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const vt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Cr(a)||wa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Bo(e.cc)})};function Da(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const ts=60*60*1e3;function as(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ts?null:a}catch{return null}}function ia(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ns=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function rs(e,a,r="default"){const n=r!=="default",o=u.useMemo(()=>e||n?{mode:"anon"}:Ao(),[e,n]),i=u.useMemo(()=>n?"visiteur":Xi(e,o),[e,o,n]),l=u.useMemo(()=>es(i),[i]),d=i!=="visiteur",c=ns(r),[g,s]=u.useState([]),[f,p]=u.useState(""),[b,m]=u.useState(null),[v,y]=u.useState(null),[x,N]=u.useState(null),[E,k]=u.useState(()=>new Map),[j,L]=u.useState(()=>new Map),[C,q]=u.useState(""),[z,F]=u.useState(new Set),[D,I]=u.useState(null),[S,M]=u.useState(!0),[h,T]=u.useState(!1),[B,Y]=u.useState(0),[V,K]=u.useState(0),X=u.useRef(0),Q=u.useMemo(()=>{var ae;if(i!=="client")return"";try{return((ae=To())==null?void 0:ae.email)||""}catch{return""}},[i]);u.useEffect(()=>{const ae=++X.current;let ce=!0;const W=()=>ce&&ae===X.current,re=(d&&o.token?o.token:"pub:"+a)+(c?":"+c:""),ee=as(re);return ee?(s(ee.objs.map(vt)),ee.fund&&p(ee.fund),m(ee.marketEstimate??null),y(ee.criteria??null),N(ee.stats??null),q(ee.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const Le=await Ma(),je=((Le==null?void 0:Le.recent_ops)||[]).map(oe=>{const me=ha(oe.company_name||oe.title?oe:{...oe,title:(oe.headline_fr||oe.headline||"").slice(0,120)},a),se=String(oe.rubrique||"").toLowerCase();return me&&(se==="nominations"||se==="recrutements")&&(me.engine=se),me&&!String(oe.company_name||"").trim()&&(me.noCo=!0),me}).filter(oe=>!!oe).map(oe=>(Cr((oe.name||"").trim())||(oe.noCo=!0),oe));try{const oe=qo(),me=await Lo(),se=((me==null?void 0:me.date)||"").slice(0,10),G=oe?oe.doc:me,Z=Fo(G),he=((oe==null?void 0:oe.day)||(G==null?void 0:G.date)||se||"").slice(0,10);if(he&&Z.length){const le=new Set;for(const fe of je){if((fe.date||"").slice(0,10)!==he)continue;const ge=An(Z,le,fe.name,"");ge>=0&&(le.add(ge),fe.decryptHtml=Z[ge].html)}for(const fe of je){if(fe.decryptHtml||(fe.date||"").slice(0,10)!==he)continue;const ge=An(Z,le,"",fe.headline||fe.tagline||fe.name);ge>=0&&(le.add(ge),fe.decryptHtml=Z[ge].html)}}if(he){const le=((G==null?void 0:G.title_fr)||"").trim(),fe=((G==null?void 0:G.lead_fr)||"").trim(),ge=Ro(G),be=((G==null?void 0:G.url)||"").trim();le&&(ge||be)&&je.unshift({id:`edito:${he}`,kind:"op",name:le,cc:null,date:he,engine:"edito",dealKind:"other",headline:le,tagline:fe||le,decryptHtml:ge||void 0,url:be,noCo:!0})}}catch{}if(!W())return;s(je.map(vt)),ia(re,{objs:je})}else if(typeof r=="object"){const je=(await Tn()||[]).filter(me=>(me.slug||"")===r.research).map(me=>qn(me,a)).filter(me=>!!me),oe=Da(await Ln(je,a));if(!W())return;s(oe.map(vt)),ia(re,{objs:oe})}else if(d&&o.token){const Le=Mo(o.token),je=Ma(),oe=Oo(o.token),me=Po(o.token),se=Do(o.token),G=await Le;let Z=G?G.targets:[];W()&&G&&(p(G.fund||""),m(G.marketEstimate??null),y(G.criteria??null),N(G.stats??null),q(G.generatedAt||""),s(Z.map(vt)),M(!1),T(!1));const[he,le,fe,ge]=await Promise.all([je,oe,me,se]),be=((he==null?void 0:he.recent_ops)||[]).map(ve=>ha(ve,a)).filter(ve=>!!ve);if(Z=[...Z,...be],!W())return;s(Z.map(vt));const qe=new Set;for(const ve of le){const Fe=(ve.id||ve.co||"").toString().trim().toLowerCase();Fe&&qe.add(Fe.startsWith("t:")?Fe:"t:"+Fe)}F(qe),k(fe),L(ge),G&&ia(re,{fund:G.fund,marketEstimate:G.marketEstimate,criteria:G.criteria,stats:G.stats,generatedAt:G.generatedAt,objs:Z})}else{const Le=Io(),je=Tn(),oe=Ma(),me=await Le;W()&&me.length&&(s(Da(me).map(vt)),M(!1),T(!1));const[se,G]=await Promise.all([je,oe]),Z=(se||[]).map(ge=>qn(ge,a)).filter(ge=>!!ge),he=await Ln(Z,a),le=((G==null?void 0:G.recent_ops)||[]).map(ge=>ha(ge,a)).filter(ge=>!!ge),fe=Da([...me,...he,...le]);if(!W())return;s(fe.map(vt)),ia(re,{objs:fe})}W()&&T(!1)}catch{W()&&!ee&&T(!0)}finally{W()&&M(!1)}})(),()=>{ce=!1}},[d,o.token,a,B,c]),u.useEffect(()=>{if(!l.showCredits||!Q){I(null);return}let ae=!0;return(async()=>{try{const ce=await fetch(`${mn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Q})});if(!ce.ok)return;const W=await ce.json();ae&&W&&W.ok!==!1&&I(W)}catch{}})(),()=>{ae=!1}},[l.showCredits,Q,V]);const ie=u.useCallback(ae=>F(new Set(ae)),[]);return{session:o,mode:i,caps:l,fund:f,email:Q,marketEstimate:b,generatedAt:C,criteria:v,stats:x,thumbs:E,stages:j,dossiers:g,favIds:z,setFavIds:ie,credits:D,reloadCredits:()=>K(ae=>ae+1),loading:S,error:h,refresh:()=>Y(ae=>ae+1)}}function Ze(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Or=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),os=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Or(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),is=new Set(["signal","amount","score","crible","memo"]);function ss(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Or(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:is.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Pr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Pr=80;function ka(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(fn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ct(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&kt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function Dr(e,a,r){return Ze(e)?ka(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ka(e,a.filters,r)}function ls(e,a,r,n){return!(!Dr(e,a,r)||r&&!$o(e,a.ptab,n))}function gn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-ct(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Uo(o);case"memo":return _o(o);case"signal":{const i=Me(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),d=n(i);return l<d?-a.dir:l>d?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ia={},_n=(Ia==null?void 0:Ia.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Un(){return new Date().toISOString().slice(0,10)}const bn=u.createContext(null);function Ir(){return u.useContext(bn)}function ds(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),l=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function Hn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null;[...n.attributes].forEach(i=>n.removeAttribute(i.name)),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Vn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${i} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${i} ${r[1]}`}function Br(){const e=u.useContext(bn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function cs({token:e,children:a}){const{dispatch:r,st:n,lang:o}=H(),[i,l]=u.useState(()=>n.filters.day||Un()),[d,c]=u.useState(null),[g,s]=u.useState(!1),f=u.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){l(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),p=u.useCallback(()=>{l(Un());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);u.useEffect(()=>{const v=y=>{var N;const x=(N=y.detail)==null?void 0:N.day;typeof x=="string"&&f(x)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[f]),u.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),u.useEffect(()=>{if(!e||!i)return;let v=!1;s(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${_n}/cibles/edition.json?${y}`).then(x=>x.json()).then(x=>{v||c(x)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||s(!1)}),()=>{v=!0}},[e,i]);const b=u.useMemo(()=>`${_n}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=u.useMemo(()=>({token:e,day:i,ed:d,loading:g,pickDay:f,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,d,g,f,p,n.filters.day,b,o]);return t.jsx(bn.Provider,{value:m,children:a})}function ps(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Br(),[o,i]=u.useState(()=>n||zr());return u.useEffect(()=>{n&&i(!0)},[n]),u.useEffect(()=>{const l=d=>{var c;return i(!!((c=d.detail)!=null&&c.open))};return window.addEventListener(ya,l),()=>window.removeEventListener(ya,l)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Ho,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}function us(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Br(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok,g=u.useRef(null),s=u.useMemo(()=>Hn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),f=u.useMemo(()=>Hn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return u.useEffect(()=>{const p=g.current;if(!p||!s)return;let b=!1;return Ar(()=>import("./fit-BnaWm7z_.js"),[]).then(async m=>{await m.ensureEditoCss(),!(b||!p.isConnected)&&(m.beautifyEditoRows(p),m.mountCardFits(p))}),()=>{b=!0}},[s]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:i?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:Vn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:Vn(e)}),"."]})}),l&&s?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:s}}):null,l&&f?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:f}}):null,o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const ms=300,sa=7,fs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},$r={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},xs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ba(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Go(r)&&r!=="media")return"news:"+r;const n=Me(e);return n?"sig:"+(n.theme&&$r.fr[n.theme]?n.theme:"other"):"actualites"}function hs(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:l,fund:d}=H(),c=Ir(),g=l==="en",[s,f]=u.useState("all"),[p,b]=u.useState(!1),m=u.useMemo(()=>{var ce;const h=(a.filters.day||"").slice(0,10),T=W=>!(!i&&a.continent!=="monde"&&W.continent!==a.continent||h&&(W.date||"").slice(0,10)!==h),B=e.filter(W=>T(W)&&Me(W)&&(!i||W.kind!=="target"||ze(W)!==5)),Y=i&&(((ce=c==null?void 0:c.ed)==null?void 0:ce.ops)||[]).length?c.ed.ops.map(W=>ha(W,l)).filter(W=>!!W).filter(W=>!h||(W.date||"").slice(0,10)===h):[],V=e.filter(W=>T(W)&&W.kind==="op"&&(h?!0:ct(W.date)<=sa)),K=i?Y.length?Y:V.filter(W=>{const re=(d||"").trim().toLowerCase();if(!re)return!1;const ee=W.match||null;return ee?Object.keys(ee).map(Le=>Le.trim().toLowerCase()).includes(re):!1}):V,X=h||new Date().toISOString().slice(0,10),Q=W=>{const re=Ba(W);return re==="ma"?0:re==="levees"?1:2};K.sort((W,re)=>{const ee=Q(W)-Q(re);if(ee)return ee;const Le=(W.date||"").slice(0,10)===X?0:1,je=(re.date||"").slice(0,10)===X?0:1;return Le!==je?Le-je:(re.amountEur||0)-(W.amountEur||0)});const ie=new Set,ae=[];for(const W of[...K,...gn(B,{key:"signal",dir:-1})]){const re=W.id||W.name;!re||ie.has(re)||(ie.add(re),ae.push(W))}return i&&ae.length===0?e.filter(re=>T(re)&&ct(re.date)<=sa).sort((re,ee)=>(ee.date||"").localeCompare(re.date||"")).slice(0,80):ae},[e,a.continent,a.filters.day,i,d,l,c]),v=u.useMemo(()=>{const h={};for(const T of m){const B=Ba(T);h[B]=(h[B]||0)+1}return h},[m]),y=u.useMemo(()=>s==="all"?m:m.filter(h=>Ba(h)===s),[m,s]),x=u.useMemo(()=>y.slice(0,ms),[y]),N=y.length-x.length,E=u.useRef(null);u.useEffect(()=>{var K,X;const h=E.current;if(!h)return;const T=()=>{const Q=h.scrollWidth;Q<200||(h.style.animationDuration=Math.max(18,Math.round(Q/130))+"s")};T();const B=requestAnimationFrame(T),Y=window.setTimeout(T,1200);let V=!0;return(X=(K=document.fonts)==null?void 0:K.ready)==null||X.then(()=>{V&&T()}),()=>{V=!1,cancelAnimationFrame(B),window.clearTimeout(Y)}},[x.length,s]);const k=h=>h==="all"?m.length:v[h]||0,j=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return $r[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const T=h.slice(5);return Wo[T]?Yo(T,g?"en":"fr"):h}return fs[g?"en":"fr"][h]},L=[{k:"all"}],C=["ma","levees"].filter(h=>k(h)>0||h===s);if(C.length){L.push({g:g?"Deals":"Opérations"});for(const h of C)L.push({k:h})}const q=["nominations","recrutements"].filter(h=>k(h)>0||h===s),z=Vo.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>k(h)>0||h===s),F=k("actualites")>0||s==="actualites"?["actualites"]:[];if(q.length||z.length||F.length){L.push({g:g?"News":"Actualités"});for(const h of q)L.push({k:h});for(const h of z)L.push({k:h});for(const h of F)L.push({k:h})}const D=xs.map(h=>"sig:"+h).filter(h=>k(h)>0||h===s);if(D.length){L.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of D)L.push({k:h})}const I=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},S=(()=>{const h=(a.filters.day||"").slice(0,10),T=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${I(h)}.`:`Le LIVE regroupe les événements du ${I(h)}.`)+T:(g?`LIVE covers the still-open signals and the deals of the last ${sa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${sa} derniers jours.`)+T})(),M=h=>x.map(T=>t.jsxs("button",{type:"button",className:"tk"+(Ie(T)?" spent":""),onClick:B=>{try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:T.id,name:T.name,url:T.url||"",text:T.tagline||T.headline||"",card:T.card}}))}catch{}if(n({type:"focus",id:T.id}),a.dens!=="liste"){const Y=B.currentTarget.getBoundingClientRect();n({type:"popup",id:T.id,anchor:{x:Y.left+Y.width/2,y:Y.bottom}})}},title:T.name+(T.tagline?" — "+T.tagline:""),children:[t.jsx(Ct,{o:T}),t.jsxs("span",{className:"who",children:[t.jsx(wo,{o:T}),t.jsx("span",{className:"co",children:T.name})]}),typeof T.amountEur=="number"&&T.amountEur>0&&t.jsx("span",{className:"am",children:Hd(T.amountEur)}),T.sector&&t.jsx("span",{className:"mt",children:T.sector}),t.jsx(Fa,{o:T}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(T.id||T.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>b(h=>!h),children:[j(s),t.jsx("b",{children:k(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:S}),L.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===s,onClick:()=>{f(h.k),b(!1)},children:[j(h.k),t.jsx("b",{children:k(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:x.length?t.jsxs("div",{className:"run",ref:E,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(bs,{isEn:g})]})}const gs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function bs({isEn:e}){const[a,r]=u.useState(()=>zr());u.useEffect(()=>{const o=i=>{var l;return r(!!((l=i.detail)!=null&&l.open))};return window.addEventListener(ya,o),()=>window.removeEventListener(ya,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Ko(!a),children:gs})}const vn="+33 6 83 10 72 86",ja="alexandre@proplace.co",_r=`tel:${vn.replace(/[^\d+]/g,"")}`;function vs(){return null}class at extends u.Component{constructor(){super(...arguments);Cn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Ur=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ys(e,a){if((mt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return Ur.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}function ws({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:l}=H(),[d,c]=u.useState(!1),[g,s]=u.useState(""),[f,p]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),m=async v=>{if(g)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}s(v);const y=await o(e,v);s(""),y&&(c(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:v=>v.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(v=>!v),p(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:f?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{i(e),p(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const v=await o(e,"Analysé");s(""),v&&(c(!1),p(!1))})()},children:a.csAnaAnyway})]}):ys(e,a).map(([v,y])=>t.jsx("button",{type:"button",className:"rsti"+(b===v?" on":"")+(g===v?" busy":""),disabled:!!g,onClick:()=>{m(v)},children:y},v))})]})}function ks({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=H(),[i,l]=u.useState(""),[d,c]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),s=(mt(e)||"").startsWith("CALL")&&ze(e)===3,f=ze(e)>=2,p=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const v=await o(e,m);l(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Ur.filter(([m])=>!(f&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{p(m)},children:v},m)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(js,{o:e})]})}function js({o:e}){const{t:a,saveNote:r,flash:n}=H(),[o,i]=u.useState(e.ceoNote||""),[l,d]=u.useState(!1),[c,g]=u.useState(!1),s=o.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(l||!s)return;d(!0);const p=await r(e,o.trim());d(!1),p&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{f()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Ns({placeholder:e,onDone:a}){const{t:r}=H(),[n,o]=u.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Ss({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:d}=H(),[c,g]=u.useState(!1);if(!n.pipe||!o||n.lockActions||ze(e)!==4)return null;const s=i(e),f=(s==null?void 0:s.stage)||"todo",p=async x=>{if(c||x===f)return;g(!0);const N=s;l(e,{stage:x,stamps:(s==null?void 0:s.stamps)||{}});const E=Math.max(Date.now(),Wn+=1);Wn=E;const k=await Qo(r,{company:e.name||"",stage:x,cts:E,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(l(e,N),d(a.actErr)))},b=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=f==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,N])=>t.jsx("button",{type:"button",className:"stgb"+(f===x?" on":""),disabled:c,onClick:()=>{p(x)},children:N},x)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let Wn=0;const la=8,da=360;function Yn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Gn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Yn,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Yn,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Es({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=H(),[l,d]=u.useState(0),[c,g]=u.useState(null),[s,f]=u.useState([]),p=u.useRef(!1),b=u.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=u.useRef(!1);u.useEffect(()=>{const C=b.current;return()=>{m.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),u.useEffect(()=>{p.current||(p.current=!0,f(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const v=s[l],y=l>=s.length;u.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const C=v.click,q=window.setTimeout(()=>{const z=document.querySelector(C);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(q)}},[l,v]);const x=u.useRef(-1),N=u.useCallback(()=>{if(!v){g(null);return}const C=document.querySelector(v.sel)||(v.need?document.querySelector(v.need):null);if(!C){g(null);return}x.current!==l&&(x.current=l,C.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=C.getBoundingClientRect();g(z=>z&&Math.abs(z.top-q.top)<1&&Math.abs(z.left-q.left)<1&&Math.abs(z.width-q.width)<1&&Math.abs(z.height-q.height)<1?z:q)},[v,l]);u.useLayoutEffect(()=>{N();const C=[90,300,700,1300].map(z=>window.setTimeout(N,z)),q=()=>N();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{C.forEach(z=>window.clearTimeout(z)),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[N]);const E=u.useRef(a);if(E.current=a,u.useEffect(()=>{const C=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),E.current()):q.key==="ArrowRight"?d(z=>z+1):q.key==="ArrowLeft"&&d(z=>Math.max(0,z-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!s.length)return null;let k=null;const j=C=>()=>{m.current=!0,n({type:"modal",modal:null}),C()};if(y){const C=o[3]||0;C>0?k={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let L={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:da};if(!y&&c){const C=c.bottom+14,z=window.innerHeight-C>190?C:Math.max(12,c.top-200);L={left:Math.min(Math.max(12,c.left+c.width/2-da/2),window.innerWidth-da-12),top:z,width:da}}return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-la,top:c.top-la,width:c.width+la*2,height:c.height+la*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:L,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Gn,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(Gn,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(C=>C+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Hr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Vr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Cs(){var q,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:l,data:d,dispatch:c}=H(),g=r?a:e,s=u.useMemo(()=>g.filter(F=>ct(F.date)===0&&F.kind==="target"),[g]),f=u.useMemo(()=>r?a.filter(F=>F.kind==="target"&&ze(F)===0).slice().sort((F,D)=>(D.date||"").localeCompare(F.date||"")):[],[a,r]),p=u.useMemo(()=>s.filter(F=>r?ze(F)===0:!Ie(F)),[s,r]),b=r?f:p,m=r?a.length-f.length:s.length-p.length,v=r?a.length:s.length,y=v?Math.min(100,m/v*100):100,x=u.useMemo(()=>Hr(g),[g]),N=!!x&&ct(x)>0,E=u.useMemo(()=>N?g.filter(F=>(F.date||"").slice(0,10)===x):[],[g,x,N]),k=typeof((q=d.stats)==null?void 0:q.kept_today)=="number"?d.stats.kept_today:null,j=typeof((z=d.stats)==null?void 0:z.screened_today)=="number"?d.stats.screened_today:s.length;let L;N?L=o.morningLast(E.length,f.length,Vr(x,l)):r?L=o.morningThesis(j,f.length,k):s.length?m===0?L=o.goalSourced(s.length):m>=s.length?L=o.goalCleared:L=o.goalDone(m,s.length):L=o.goalSourced(0);const C=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&f.length&&c({type:"chainStart",queue:f.map(F=>F.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:L}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function zs(){var B,Y;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:d,mode:c,doSync:g,startTour:s,flash:f,flashErr:p}=H(),[b,m]=u.useState(null),[v,y]=u.useState(!0),[x,N]=u.useState([]),E=c==="client";u.useEffect(()=>{if(!o||!i)return;let V=!0;return y(!0),(async()=>{const[K,X]=await Promise.all([xn(i),Tr(o)]);V&&(K&&m(K),y(!1),N(X))})(),()=>{V=!1}},[o,i]);const[k,j]=u.useState(!1),L=()=>{!E||k||!i||(j(!0),Jo(i).then(V=>{j(!1),V?f(e.identRepubDone):p(e.actErr)}))},C=(b==null?void 0:b.per_day)??null,q=((B=b==null?void 0:b.pool_order)==null?void 0:B.length)??0,z=x.filter(V=>V.status==="running").length,F=u.useMemo(()=>d.filter(V=>V.kind==="target"&&Ie(V)).length,[d]),D=l.marketEstimate,I=typeof((Y=l.stats)==null?void 0:Y.screened)=="number"?l.stats.screened:F,S=D&&D>0?Math.min(100,Math.round(I/D*100)):null,M=V=>V.toLocaleString(a==="en"?"en-US":"fr-FR"),h=(i||"P").split(/\s+/).map(V=>V[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const V=Date.parse(l.generatedAt||"");if(Number.isNaN(V))return"";const K=new Date(V),X=Q=>String(Q).padStart(2,"0");return`${X(K.getDate())}/${X(K.getMonth()+1)} à ${X(K.getHours())}:${X(K.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),T?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(T)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[S===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:M(I)})})]}),S!==null&&D&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:S+"%"}})}),t.jsxs("b",{children:[S," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,D)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:V=>{V.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||k,onClick:L,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:V=>n({type:"filters",patch:{search:V.target.value}})})]})]})]})}class Nt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,d=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*As(e){for(const a of e)yield*a}function Wr(e){return Array.from(As(e))}var ke=1e-6,ue=Math.PI,Ye=ue/2,Kn=ue/4,Ke=ue*2,lt=180/ue,_e=ue/180,Ce=Math.abs,Ts=Math.atan,Jt=Math.atan2,Ae=Math.cos,Te=Math.sin,qs=Math.sign||function(e){return e>0?1:e<0?-1:0},zt=Math.sqrt;function Ls(e){return e>1?0:e<-1?ue:Math.acos(e)}function Xt(e){return e>1?Ye:e<-1?-Ye:Math.asin(e)}function Ge(){}function Na(e,a){e&&Jn.hasOwnProperty(e.type)&&Jn[e.type](e,a)}var Qn={Feature:function(e,a){Na(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Na(r[n].geometry,a)}},Jn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Ja(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Ja(r[n],a,0)},Polygon:function(e,a){Xn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Xn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Na(r[n],a)}};function Ja(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Xn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Ja(e[r],a,1);a.polygonEnd()}function Lt(e,a){e&&Qn.hasOwnProperty(e.type)?Qn[e.type](e,a):Na(e,a)}function Xa(e){return[Jt(e[1],e[0]),Xt(e[2])]}function Ot(e){var a=e[0],r=e[1],n=Ae(r);return[n*Ae(a),n*Te(a),Te(r)]}function ca(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Sa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function $a(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function pa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Za(e){var a=zt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function en(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function tn(e,a){return Ce(e)>ue&&(e-=Math.round(e/Ke)*Ke),[e,a]}tn.invert=tn;function Fs(e,a,r){return(e%=Ke)?a||r?en(er(e),tr(a,r)):er(e):a||r?tr(a,r):tn}function Zn(e){return function(a,r){return a+=e,Ce(a)>ue&&(a-=Math.round(a/Ke)*Ke),[a,r]}}function er(e){var a=Zn(e);return a.invert=Zn(-e),a}function tr(e,a){var r=Ae(e),n=Te(e),o=Ae(a),i=Te(a);function l(d,c){var g=Ae(c),s=Ae(d)*g,f=Te(d)*g,p=Te(c),b=p*r+s*n;return[Jt(f*o-b*i,s*r-p*n),Xt(b*o+f*i)]}return l.invert=function(d,c){var g=Ae(c),s=Ae(d)*g,f=Te(d)*g,p=Te(c),b=p*o-f*i;return[Jt(f*o+p*i,s*r+b*n),Xt(b*r-s*n)]},l}function Rs(e,a,r,n,o,i){if(r){var l=Ae(a),d=Te(a),c=n*r;o==null?(o=a+n*Ke,i=a-c/2):(o=ar(l,o),i=ar(l,i),(n>0?o<i:o>i)&&(o+=n*Ke));for(var g,s=o;n>0?s>i:s<i;s-=c)g=Xa([l,-d*Ae(s),-d*Te(s)]),e.point(g[0],g[1])}}function ar(e,a){a=Ot(a),a[0]-=e,Za(a);var r=Ls(-a[1]);return((-a[2]<0?-r:r)+Ke-ke)%Ke}function Yr(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ge,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ga(e,a){return Ce(e[0]-a[0])<ke&&Ce(e[1]-a[1])<ke}function ua(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Gr(e,a,r,n,o){var i=[],l=[],d,c;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,y=m[0],x=m[v],N;if(ga(y,x)){if(!y[2]&&!x[2]){for(o.lineStart(),d=0;d<v;++d)o.point((y=m[d])[0],y[1]);o.lineEnd();return}x[0]+=2*ke}i.push(N=new ua(y,m,null,!0)),l.push(N.o=new ua(y,null,N,!1)),i.push(N=new ua(x,m,null,!1)),l.push(N.o=new ua(x,null,N,!0))}}),!!i.length){for(l.sort(a),nr(i),nr(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var g=i[0],s,f;;){for(var p=g,b=!0;p.v;)if((p=p.n)===g)return;s=p.z,o.lineStart();do{if(p.v=p.o.v=!0,p.e){if(b)for(d=0,c=s.length;d<c;++d)o.point((f=s[d])[0],f[1]);else n(p.x,p.n.x,1,o);p=p.n}else{if(b)for(s=p.p.z,d=s.length-1;d>=0;--d)o.point((f=s[d])[0],f[1]);else n(p.x,p.p.x,-1,o);p=p.p}p=p.o,s=p.z,b=!b}while(!p.v);o.lineEnd()}}}function nr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function _a(e){return Ce(e[0])<=ue?e[0]:qs(e[0])*((Ce(e[0])+ue)%Ke-ue)}function Ms(e,a){var r=_a(a),n=a[1],o=Te(n),i=[Te(r),-Ae(r),0],l=0,d=0,c=new Nt;o===1?n=Ye+ke:o===-1&&(n=-Ye-ke);for(var g=0,s=e.length;g<s;++g)if(p=(f=e[g]).length)for(var f,p,b=f[p-1],m=_a(b),v=b[1]/2+Kn,y=Te(v),x=Ae(v),N=0;N<p;++N,m=k,y=L,x=C,b=E){var E=f[N],k=_a(E),j=E[1]/2+Kn,L=Te(j),C=Ae(j),q=k-m,z=q>=0?1:-1,F=z*q,D=F>ue,I=y*L;if(c.add(Jt(I*z*Te(F),x*C+I*Ae(F))),l+=D?q+z*Ke:q,D^m>=r^k>=r){var S=Sa(Ot(b),Ot(E));Za(S);var M=Sa(i,S);Za(M);var h=(D^q>=0?-1:1)*Xt(M[2]);(n>h||n===h&&(S[0]||S[1]))&&(d+=D^q>=0?1:-1)}}return(l<-ke||l<ke&&c<-1e-12)^d&1}function Kr(e,a,r,n){return function(o){var i=a(o),l=Yr(),d=a(l),c=!1,g,s,f,p={point:b,lineStart:v,lineEnd:y,polygonStart:function(){p.point=x,p.lineStart=N,p.lineEnd=E,s=[],g=[]},polygonEnd:function(){p.point=b,p.lineStart=v,p.lineEnd=y,s=Wr(s);var k=Ms(g,n);s.length?(c||(o.polygonStart(),c=!0),Gr(s,Ps,k,r,o)):k&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),s=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function m(k,j){i.point(k,j)}function v(){p.point=m,i.lineStart()}function y(){p.point=b,i.lineEnd()}function x(k,j){f.push([k,j]),d.point(k,j)}function N(){d.lineStart(),f=[]}function E(){x(f[0][0],f[0][1]),d.lineEnd();var k=d.clean(),j=l.result(),L,C=j.length,q,z,F;if(f.pop(),g.push(f),f=null,!!C){if(k&1){if(z=j[0],(q=z.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),L=0;L<q;++L)o.point((F=z[L])[0],F[1]);o.lineEnd()}return}C>1&&k&2&&j.push(j.pop().concat(j.shift())),s.push(j.filter(Os))}}return p}}function Os(e){return e.length>1}function Ps(e,a){return((e=e.x)[0]<0?e[1]-Ye-ke:Ye-e[1])-((a=a.x)[0]<0?a[1]-Ye-ke:Ye-a[1])}const rr=Kr(function(){return!0},Ds,Bs,[-ue,-Ye]);function Ds(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var d=i>0?ue:-ue,c=Ce(i-a);Ce(c-ue)<ke?(e.point(a,r=(r+l)/2>0?Ye:-Ye),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(i,r),o=0):n!==d&&c>=ue&&(Ce(a-n)<ke&&(a-=n*ke),Ce(i-d)<ke&&(i-=d*ke),r=Is(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),o=0),e.point(a=i,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Is(e,a,r,n){var o,i,l=Te(e-r);return Ce(l)>ke?Ts((Te(a)*(i=Ae(n))*Te(r)-Te(n)*(o=Ae(a))*Te(e))/(o*i*l)):(a+n)/2}function Bs(e,a,r,n){var o;if(e==null)o=r*Ye,n.point(-ue,o),n.point(0,o),n.point(ue,o),n.point(ue,0),n.point(ue,-o),n.point(0,-o),n.point(-ue,-o),n.point(-ue,0),n.point(-ue,o);else if(Ce(e[0]-a[0])>ke){var i=e[0]<a[0]?ue:-ue;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function $s(e){var a=Ae(e),r=2*_e,n=a>0,o=Ce(a)>ke;function i(s,f,p,b){Rs(b,e,r,p,s,f)}function l(s,f){return Ae(s)*Ae(f)>a}function d(s){var f,p,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(y,x){var N=[y,x],E,k=l(y,x),j=n?k?0:g(y,x):k?g(y+(y<0?ue:-ue),x):0;if(!f&&(m=b=k)&&s.lineStart(),k!==b&&(E=c(f,N),(!E||ga(f,E)||ga(N,E))&&(N[2]=1)),k!==b)v=0,k?(s.lineStart(),E=c(N,f),s.point(E[0],E[1])):(E=c(f,N),s.point(E[0],E[1],2),s.lineEnd()),f=E;else if(o&&f&&n^k){var L;!(j&p)&&(L=c(N,f,!0))&&(v=0,n?(s.lineStart(),s.point(L[0][0],L[0][1]),s.point(L[1][0],L[1][1]),s.lineEnd()):(s.point(L[1][0],L[1][1]),s.lineEnd(),s.lineStart(),s.point(L[0][0],L[0][1],3)))}k&&(!f||!ga(f,N))&&s.point(N[0],N[1]),f=N,b=k,p=j},lineEnd:function(){b&&s.lineEnd(),f=null},clean:function(){return v|(m&&b)<<1}}}function c(s,f,p){var b=Ot(s),m=Ot(f),v=[1,0,0],y=Sa(b,m),x=ca(y,y),N=y[0],E=x-N*N;if(!E)return!p&&s;var k=a*x/E,j=-a*N/E,L=Sa(v,y),C=pa(v,k),q=pa(y,j);$a(C,q);var z=L,F=ca(C,z),D=ca(z,z),I=F*F-D*(ca(C,C)-1);if(!(I<0)){var S=zt(I),M=pa(z,(-F-S)/D);if($a(M,C),M=Xa(M),!p)return M;var h=s[0],T=f[0],B=s[1],Y=f[1],V;T<h&&(V=h,h=T,T=V);var K=T-h,X=Ce(K-ue)<ke,Q=X||K<ke;if(!X&&Y<B&&(V=B,B=Y,Y=V),Q?X?B+Y>0^M[1]<(Ce(M[0]-h)<ke?B:Y):B<=M[1]&&M[1]<=Y:K>ue^(h<=M[0]&&M[0]<=T)){var ie=pa(z,(-F+S)/D);return $a(ie,C),[M,Xa(ie)]}}}function g(s,f){var p=n?e:ue-e,b=0;return s<-p?b|=1:s>p&&(b|=2),f<-p?b|=4:f>p&&(b|=8),b}return Kr(l,d,i,n?[0,-e]:[-ue,e-ue])}function _s(e,a,r,n,o,i){var l=e[0],d=e[1],c=a[0],g=a[1],s=0,f=1,p=c-l,b=g-d,m;if(m=r-l,!(!p&&m>0)){if(m/=p,p<0){if(m<s)return;m<f&&(f=m)}else if(p>0){if(m>f)return;m>s&&(s=m)}if(m=o-l,!(!p&&m<0)){if(m/=p,p<0){if(m>f)return;m>s&&(s=m)}else if(p>0){if(m<s)return;m<f&&(f=m)}if(m=n-d,!(!b&&m>0)){if(m/=b,b<0){if(m<s)return;m<f&&(f=m)}else if(b>0){if(m>f)return;m>s&&(s=m)}if(m=i-d,!(!b&&m<0)){if(m/=b,b<0){if(m>f)return;m>s&&(s=m)}else if(b>0){if(m<s)return;m<f&&(f=m)}return s>0&&(e[0]=l+s*p,e[1]=d+s*b),f<1&&(a[0]=l+f*p,a[1]=d+f*b),!0}}}}}var Ht=1e9,ma=-Ht;function Us(e,a,r,n){function o(g,s){return e<=g&&g<=r&&a<=s&&s<=n}function i(g,s,f,p){var b=0,m=0;if(g==null||(b=l(g,f))!==(m=l(s,f))||c(g,s)<0^f>0)do p.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+f+4)%4)!==m);else p.point(s[0],s[1])}function l(g,s){return Ce(g[0]-e)<ke?s>0?0:3:Ce(g[0]-r)<ke?s>0?2:1:Ce(g[1]-a)<ke?s>0?1:0:s>0?3:2}function d(g,s){return c(g.x,s.x)}function c(g,s){var f=l(g,1),p=l(s,1);return f!==p?f-p:f===0?s[1]-g[1]:f===1?g[0]-s[0]:f===2?g[1]-s[1]:s[0]-g[0]}return function(g){var s=g,f=Yr(),p,b,m,v,y,x,N,E,k,j,L,C={point:q,lineStart:I,lineEnd:S,polygonStart:F,polygonEnd:D};function q(h,T){o(h,T)&&s.point(h,T)}function z(){for(var h=0,T=0,B=b.length;T<B;++T)for(var Y=b[T],V=1,K=Y.length,X=Y[0],Q,ie,ae=X[0],ce=X[1];V<K;++V)Q=ae,ie=ce,X=Y[V],ae=X[0],ce=X[1],ie<=n?ce>n&&(ae-Q)*(n-ie)>(ce-ie)*(e-Q)&&++h:ce<=n&&(ae-Q)*(n-ie)<(ce-ie)*(e-Q)&&--h;return h}function F(){s=f,p=[],b=[],L=!0}function D(){var h=z(),T=L&&h,B=(p=Wr(p)).length;(T||B)&&(g.polygonStart(),T&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),B&&Gr(p,d,h,i,g),g.polygonEnd()),s=g,p=b=m=null}function I(){C.point=M,b&&b.push(m=[]),j=!0,k=!1,N=E=NaN}function S(){p&&(M(v,y),x&&k&&f.rejoin(),p.push(f.result())),C.point=q,k&&s.lineEnd()}function M(h,T){var B=o(h,T);if(b&&m.push([h,T]),j)v=h,y=T,x=B,j=!1,B&&(s.lineStart(),s.point(h,T));else if(B&&k)s.point(h,T);else{var Y=[N=Math.max(ma,Math.min(Ht,N)),E=Math.max(ma,Math.min(Ht,E))],V=[h=Math.max(ma,Math.min(Ht,h)),T=Math.max(ma,Math.min(Ht,T))];_s(Y,V,e,a,r,n)?(k||(s.lineStart(),s.point(Y[0],Y[1])),s.point(V[0],V[1]),B||s.lineEnd(),L=!1):B&&(s.lineStart(),s.point(h,T),L=!1)}N=h,E=T,k=B}return C}}const an=e=>e;var Ua=new Nt,nn=new Nt,Qr,Jr,rn,on,dt={point:Ge,lineStart:Ge,lineEnd:Ge,polygonStart:function(){dt.lineStart=Hs,dt.lineEnd=Ws},polygonEnd:function(){dt.lineStart=dt.lineEnd=dt.point=Ge,Ua.add(Ce(nn)),nn=new Nt},result:function(){var e=Ua/2;return Ua=new Nt,e}};function Hs(){dt.point=Vs}function Vs(e,a){dt.point=Xr,Qr=rn=e,Jr=on=a}function Xr(e,a){nn.add(on*e-rn*a),rn=e,on=a}function Ws(){Xr(Qr,Jr)}var Pt=1/0,Ea=Pt,Zt=-Pt,Ca=Zt,za={point:Ys,lineStart:Ge,lineEnd:Ge,polygonStart:Ge,polygonEnd:Ge,result:function(){var e=[[Pt,Ea],[Zt,Ca]];return Zt=Ca=-(Ea=Pt=1/0),e}};function Ys(e,a){e<Pt&&(Pt=e),e>Zt&&(Zt=e),a<Ea&&(Ea=a),a>Ca&&(Ca=a)}var sn=0,ln=0,Vt=0,Aa=0,Ta=0,Ft=0,dn=0,cn=0,Wt=0,Zr,eo,ot,it,We={point:St,lineStart:or,lineEnd:ir,polygonStart:function(){We.lineStart=Qs,We.lineEnd=Js},polygonEnd:function(){We.point=St,We.lineStart=or,We.lineEnd=ir},result:function(){var e=Wt?[dn/Wt,cn/Wt]:Ft?[Aa/Ft,Ta/Ft]:Vt?[sn/Vt,ln/Vt]:[NaN,NaN];return sn=ln=Vt=Aa=Ta=Ft=dn=cn=Wt=0,e}};function St(e,a){sn+=e,ln+=a,++Vt}function or(){We.point=Gs}function Gs(e,a){We.point=Ks,St(ot=e,it=a)}function Ks(e,a){var r=e-ot,n=a-it,o=zt(r*r+n*n);Aa+=o*(ot+e)/2,Ta+=o*(it+a)/2,Ft+=o,St(ot=e,it=a)}function ir(){We.point=St}function Qs(){We.point=Xs}function Js(){to(Zr,eo)}function Xs(e,a){We.point=to,St(Zr=ot=e,eo=it=a)}function to(e,a){var r=e-ot,n=a-it,o=zt(r*r+n*n);Aa+=o*(ot+e)/2,Ta+=o*(it+a)/2,Ft+=o,o=it*e-ot*a,dn+=o*(ot+e),cn+=o*(it+a),Wt+=o*3,St(ot=e,it=a)}function ao(e){this._context=e}ao.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Ke);break}}},result:Ge};var pn=new Nt,Ha,no,ro,Yt,Gt,ea={point:Ge,lineStart:function(){ea.point=Zs},lineEnd:function(){Ha&&oo(no,ro),ea.point=Ge},polygonStart:function(){Ha=!0},polygonEnd:function(){Ha=null},result:function(){var e=+pn;return pn=new Nt,e}};function Zs(e,a){ea.point=oo,no=Yt=e,ro=Gt=a}function oo(e,a){Yt-=e,Gt-=a,pn.add(zt(Yt*Yt+Gt*Gt)),Yt=e,Gt=a}let sr,qa,lr,dr;class cr{constructor(a){this._append=a==null?io:el(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==lr||this._append!==qa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,lr=n,qa=this._append,dr=this._,this._=o}this._+=dr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function io(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function el(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return io;if(a!==sr){const r=10**a;sr=a,qa=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return qa}function tl(e,a){let r=3,n=4.5,o,i;function l(d){return d&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Lt(d,o(i))),i.result()}return l.area=function(d){return Lt(d,o(dt)),dt.result()},l.measure=function(d){return Lt(d,o(ea)),ea.result()},l.bounds=function(d){return Lt(d,o(za)),za.result()},l.centroid=function(d){return Lt(d,o(We)),We.result()},l.projection=function(d){return arguments.length?(o=d==null?(e=null,an):(e=d).stream,l):e},l.context=function(d){return arguments.length?(i=d==null?(a=null,new cr(r)):new ao(a=d),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(i.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(i=new cr(r)),l},l.projection(e).digits(r).context(a)}function yn(e){return function(a){var r=new un;for(var n in e)r[n]=e[n];return r.stream=a,r}}function un(){}un.prototype={constructor:un,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function wn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Lt(r,e.stream(za)),a(za.result()),n!=null&&e.clipExtent(n),e}function so(e,a,r){return wn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),d=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function al(e,a,r){return so(e,[[0,0],a],r)}function nl(e,a,r){return wn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,d=-i*n[0][1];e.scale(150*i).translate([l,d])},r)}function rl(e,a,r){return wn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],d=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,d])},r)}var pr=16,ol=Ae(30*_e);function ur(e,a){return+a?sl(e,a):il(e)}function il(e){return yn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function sl(e,a){function r(n,o,i,l,d,c,g,s,f,p,b,m,v,y){var x=g-n,N=s-o,E=x*x+N*N;if(E>4*a&&v--){var k=l+p,j=d+b,L=c+m,C=zt(k*k+j*j+L*L),q=Xt(L/=C),z=Ce(Ce(L)-1)<ke||Ce(i-f)<ke?(i+f)/2:Jt(j,k),F=e(z,q),D=F[0],I=F[1],S=D-n,M=I-o,h=N*S-x*M;(h*h/E>a||Ce((x*S+N*M)/E-.5)>.3||l*p+d*b+c*m<ol)&&(r(n,o,i,l,d,c,D,I,z,k/=C,j/=C,L,v,y),y.point(D,I),r(D,I,z,k,j,L,g,s,f,p,b,m,v,y))}}return function(n){var o,i,l,d,c,g,s,f,p,b,m,v,y={point:x,lineStart:N,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=j},polygonEnd:function(){n.polygonEnd(),y.lineStart=N}};function x(q,z){q=e(q,z),n.point(q[0],q[1])}function N(){f=NaN,y.point=E,n.lineStart()}function E(q,z){var F=Ot([q,z]),D=e(q,z);r(f,p,s,b,m,v,f=D[0],p=D[1],s=q,b=F[0],m=F[1],v=F[2],pr,n),n.point(f,p)}function k(){y.point=x,n.lineEnd()}function j(){N(),y.point=L,y.lineEnd=C}function L(q,z){E(o=q,z),i=f,l=p,d=b,c=m,g=v,y.point=E}function C(){r(f,p,s,b,m,v,i,l,o,d,c,g,pr,n),y.lineEnd=k,k()}return y}}var ll=yn({point:function(e,a){this.stream.point(e*_e,a*_e)}});function dl(e){return yn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function cl(e,a,r,n,o){function i(l,d){return l*=n,d*=o,[a+e*l,r-e*d]}return i.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*o]},i}function mr(e,a,r,n,o,i){if(!i)return cl(e,a,r,n,o);var l=Ae(i),d=Te(i),c=l*e,g=d*e,s=l/e,f=d/e,p=(d*r-l*a)/e,b=(d*a+l*r)/e;function m(v,y){return v*=n,y*=o,[c*v-g*y+a,r-g*v-c*y]}return m.invert=function(v,y){return[n*(s*v-f*y+p),o*(b-f*v-s*y)]},m}function pl(e){return ul(function(){return e})()}function ul(e){var a,r=150,n=480,o=250,i=0,l=0,d=0,c=0,g=0,s,f=0,p=1,b=1,m=null,v=rr,y=null,x,N,E,k=an,j=.5,L,C,q,z,F;function D(h){return q(h[0]*_e,h[1]*_e)}function I(h){return h=q.invert(h[0],h[1]),h&&[h[0]*lt,h[1]*lt]}D.stream=function(h){return z&&F===h?z:z=ll(dl(s)(v(L(k(F=h)))))},D.preclip=function(h){return arguments.length?(v=h,m=void 0,M()):v},D.postclip=function(h){return arguments.length?(k=h,y=x=N=E=null,M()):k},D.clipAngle=function(h){return arguments.length?(v=+h?$s(m=h*_e):(m=null,rr),M()):m*lt},D.clipExtent=function(h){return arguments.length?(k=h==null?(y=x=N=E=null,an):Us(y=+h[0][0],x=+h[0][1],N=+h[1][0],E=+h[1][1]),M()):y==null?null:[[y,x],[N,E]]},D.scale=function(h){return arguments.length?(r=+h,S()):r},D.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],S()):[n,o]},D.center=function(h){return arguments.length?(i=h[0]%360*_e,l=h[1]%360*_e,S()):[i*lt,l*lt]},D.rotate=function(h){return arguments.length?(d=h[0]%360*_e,c=h[1]%360*_e,g=h.length>2?h[2]%360*_e:0,S()):[d*lt,c*lt,g*lt]},D.angle=function(h){return arguments.length?(f=h%360*_e,S()):f*lt},D.reflectX=function(h){return arguments.length?(p=h?-1:1,S()):p<0},D.reflectY=function(h){return arguments.length?(b=h?-1:1,S()):b<0},D.precision=function(h){return arguments.length?(L=ur(C,j=h*h),M()):zt(j)},D.fitExtent=function(h,T){return so(D,h,T)},D.fitSize=function(h,T){return al(D,h,T)},D.fitWidth=function(h,T){return nl(D,h,T)},D.fitHeight=function(h,T){return rl(D,h,T)};function S(){var h=mr(r,0,0,p,b,f).apply(null,a(i,l)),T=mr(r,n-h[0],o-h[1],p,b,f);return s=Fs(d,c,g),C=en(a,T),q=en(s,C),L=ur(C,j),M()}function M(){return z=F=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&I,S()}}function lo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}lo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(Ce(o)>ke&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function ml(){return pl(lo).scale(175.295)}function fl(e){return e}function xl(e){if(e==null)return fl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var g=2,s=d.length,f=new Array(s);for(f[0]=(a+=d[0])*n+i,f[1]=(r+=d[1])*o+l;g<s;)f[g]=d[g],++g;return f}}function hl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function gl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return fr(e,r)})}:fr(e,a)}function fr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=bl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function bl(e,a){var r=xl(e.transform),n=e.arcs;function o(s,f){f.length&&f.pop();for(var p=n[s<0?~s:s],b=0,m=p.length;b<m;++b)f.push(r(p[b],b));s<0&&hl(f,m)}function i(s){return r(s)}function l(s){for(var f=[],p=0,b=s.length;p<b;++p)o(s[p],f);return f.length<2&&f.push(f[0]),f}function d(s){for(var f=l(s);f.length<4;)f.push(f[0]);return f}function c(s){return s.map(d)}function g(s){var f=s.type,p;switch(f){case"GeometryCollection":return{type:f,geometries:s.geometries.map(g)};case"Point":p=i(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(i);break;case"LineString":p=l(s.arcs);break;case"MultiLineString":p=s.arcs.map(l);break;case"Polygon":p=c(s.arcs);break;case"MultiPolygon":p=s.arcs.map(c);break;default:return null}return{type:f,coordinates:p}}return g(a)}const co={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},vl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function yl(e,a,r){const n=co[e];if(!n||!n.length)return-1;const o=vl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(l=>o.includes(l)))return i}return Math.floor(r*n.length)%n.length}let fa=null;function wl(){return fa||(fa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=gl(r,n),i=ml().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=tl(i),d=(o.features||[]).filter(s=>{var f;return(((f=s.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(s=>{var b;const f=((b=s.properties)==null?void 0:b.name)||"",p=l(s)||"";return p?{i2:Xo(f)||null,n:f,d:p}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,f]of Object.entries(Zo)){const p=i(f);p&&(c[s]={x:p[0],y:p[1]})}const g={};for(const[s,f]of Object.entries(co)){const p=f.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));p.length&&(g[s]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:d,anchors:c,metros:g}}catch{return null}})(),fa)}function kl(e){const[a,r]=u.useState(null);return u.useEffect(()=>{if(!e||a)return;let n=!1;return wl().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const jl="8 40 984 210",Nl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},xr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function hr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Sl(e,a){const[r,n]=u.useState(1);return u.useEffect(()=>{let o=!0,i=0;const l=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function gr({msgs:e}){const[a,r]=u.useState(0);u.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],l)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function El(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:d,t:c,data:g,dossiers:s,source:f}=H(),p=g.loading&&!s.length,b=u.useRef(null),m=u.useRef(null),v=kl(e.continent==="monde"),y=e.continent==="monde"?v:hn.find(h=>h.key===e.continent)||null,x=Sl(b,e.continent+":"+e.mapFolded+":"+!!y),[N,E]=u.useState(new Map),[k,j]=u.useState(null);u.useEffect(()=>{const h=b.current;if(!h)return;const T=new Map;h.querySelectorAll("path[data-i2]").forEach(B=>{const Y=B.dataset.i2;if(Y)try{const V=B.getBBox();V.width>0&&T.set(Y,{x:V.x,y:V.y,w:V.width,h:V.height})}catch{}}),E(T)},[e.continent,x,y]);const L=u.useMemo(()=>r.filter(h=>h.cc),[r]),C=u.useMemo(()=>{const h=new Map;return L.forEach(T=>h.set(T.cc,(h.get(T.cc)||0)+1)),h},[L]),q=e.continent==="monde"&&v?v.anchors:null,z=e.continent==="monde"&&v?v.metros:null,F=u.useMemo(()=>L.map(h=>{const T=hr(h.name||h.id||""),B=hr((h.id||h.name||"")+"·y");if(q&&h.cc){const Q=z?z[h.cc]:void 0;if(Q&&Q.length){const ae=yl(h.cc,h.city,T);if(ae>=0&&Q[ae])return{d:h,x:Q[ae].x+(T-.5)*5,y:Q[ae].y+(B-.5)*5}}const ie=q[h.cc];if(ie)return{d:h,x:ie.x+(T-.5)*10,y:ie.y+(B-.5)*10}}const Y=h.cc?N.get(h.cc):void 0;if(!Y)return null;const V=Nl[`${e.continent}:${h.cc||""}`];if(V)return{d:h,x:Y.x+Y.w*(V.fx+(T-.5)*V.sx),y:Y.y+Y.h*(V.fy+(B-.5)*V.sy)};const K=(T-.5)*Math.min(Y.w*.55,60),X=(B-.5)*Math.min(Y.h*.55,60);return{d:h,x:Y.x+Y.w/2+K,y:Y.y+Y.h/2+X}}).filter(h=>!!h),[L,N,q,z,e.continent]),D=h=>x>0?h/x:h,I=u.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:xr[h],fr:c.plabels[h].toUpperCase(),en:c.plabels[h].toUpperCase(),n:r.filter(T=>T.kind==="target"&&ze(T)===h).length})).filter(h=>h.n>0):Fn.map((h,T)=>({...h,n:r.filter(B=>Rn(B)===T).length})),[r,n,c.plabels]),S=i?l.get(i):null,M=S?F.find(h=>h.d.id===S.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:[p&&t.jsx(gr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:f==="ops"&&e.continent==="monde"?jl:y.viewBox,preserveAspectRatio:f==="ops"&&e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:y.countries.map((h,T)=>t.jsx("g",{className:"ct"+(h.i2&&C.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},T))}),t.jsx("g",{children:F.map(h=>{const T=Fn[Rn(h.d)],B=!!Me(h.d),Y=h.d.kind==="target",V=n&&Y?xr[ze(h.d)]:T.c,K=!n&&Ie(h.d);return t.jsxs("g",{className:"co"+(K?" done":""),onMouseEnter:()=>{var ie,ae;const X=(ie=m.current)==null?void 0:ie.getBoundingClientRect(),Q=(ae=b.current)==null?void 0:ae.createSVGPoint();if(Q&&b.current&&X){Q.x=h.x,Q.y=h.y;const ce=Q.matrixTransform(b.current.getScreenCTM());j({x:ce.x-X.left,y:ce.y-X.top,label:h.d.name+" · "+(It(h.d.cc,d)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var ie;if(f==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const X=(ie=b.current)==null?void 0:ie.createSVGPoint();let Q=null;if(X&&b.current){X.x=h.x,X.y=h.y;const ae=X.matrixTransform(b.current.getScreenCTM());Q={x:ae.x,y:ae.y}}a({type:"popup",id:h.d.id,anchor:Q})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:D(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:D(T.px),fill:V,stroke:B?"#DC2626":"#ffffff",strokeWidth:D(B?2.2:1.3)})]},h.d.id||h.d.name)})}),M&&t.jsx("circle",{className:"ring on",cx:M.x,cy:M.y,r:D(13),fill:"none",stroke:"#0F172A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:I.map((h,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),d==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},T))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:m,children:t.jsx(gr,{msgs:c.loadMsgs})})}function Cl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function po({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:l,lang:d}=H(),c=a.filters,[g,s]=u.useState(!1),[f,p]=u.useState(!1),b=u.useRef(null),m=u.useRef(null),v=u.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),y=S=>v.filter(M=>S!=="country"&&c.country.length&&!c.country.includes(M.cc||"")?!1:ka(M,c,i,S==="country"?void 0:S)),x=u.useMemo(()=>{const S=y("win"),M=h=>S.filter(T=>(T.date?Math.max(0,Math.floor((Date.now()-Date.parse(T.date))/864e5)):9999)<=h).length;return[M(0),M(7),M(30),S.length]},[v,c,i]),N=u.useMemo(()=>c.day?y("win").filter(S=>(S.date||"").slice(0,10)===c.day).length:0,[v,c,i]),E=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,k=E+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);u.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),u.useEffect(()=>{if(!g&&!f)return;const S=h=>{var B,Y;const T=h.target;g&&!((B=b.current)!=null&&B.contains(T))&&s(!1),f&&!((Y=m.current)!=null&&Y.contains(T))&&p(!1)},M=h=>{h.key==="Escape"&&(s(!1),p(!1))};return document.addEventListener("mousedown",S),document.addEventListener("keydown",M),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",M)}},[g,f]);const j=(S,M,h,T="fbtn")=>t.jsxs("button",{type:"button",className:T,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:M}),h>0&&t.jsx("span",{className:"n",children:h}),t.jsx("span",{className:"cv",children:"▾"})]},S),L=["1","7","30","all"],C=Math.max(0,L.indexOf(c.win||"all")),q=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(Cl(c.day,d))}),t.jsx("b",{children:N})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>p(S=>!S),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[C]}),t.jsx("b",{children:x[C]}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:L.map((S,M)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===S,onClick:()=>{r({type:"filters",patch:{win:S}}),p(!1)},children:[o.datesShort[M],t.jsx("span",{className:"n",children:x[M]})]},S))})]}):t.jsx("div",{className:"seg",children:L.map((S,M)=>t.jsxs("button",{type:"button","aria-pressed":c.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:o.dates[M]}),t.jsx("b",{children:x[M]})]},S))}),z=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),F=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):j("sec",o.fSector,c.sector.length),j("pay",o.fCountry,c.country.length),j("det",o.fEngine,c.engine.length),j("sta",o.fStage,c.stage.length),i&&j("ang","Angle",c.angle.length),i&&j("mem","Mémo",c.memoLevel.length)]}),D=(S=!1)=>t.jsxs("div",{className:"frow2",children:[k>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(k)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),S&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),I=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(E?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{s(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),E>0&&t.jsx("span",{className:"n",children:E}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:F})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:q}),t.jsxs("div",{className:"fstrip-b",children:[z,I,D(!1)]})]}),a.openFacet&&t.jsx(br,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[q,z,F,t.jsx("span",{className:"fgrow"}),D()]}),a.openFacet&&t.jsx(br,{poolFor:y})]})}function br({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=H(),i=a.filters,l=a.openFacet,{title:d,cols:c,options:g}=u.useMemo(()=>{if(l==="sig"){const m=e("signal").filter(x=>Me(x)),v=new Map;m.forEach(x=>{const N=x.engine||"";v.set(N,(v.get(N)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Wa([...v.keys()],o).map(x=>({v:x,label:jt(x)+" "+Ue(x,o),n:v.get(x)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const m=e("sector"),v=new Map;return m.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:y,n:x,html:!1,on:i.sector.includes(y)}))}}if(l==="pay"){const m=e("country"),v=new Map;return m.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:It(y,o)||y,n:x,html:!1,on:i.country.includes(y)}))}}if(l==="det"){const m=e("engine"),v=new Map;return m.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Wa([...v.keys()],o).map(y=>({v:y,label:jt(y)+" "+Ue(y,o)+' <span style="color:var(--dim);font-size:10px">· '+ei(ti(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(l==="ang"){const m=e("angle"),v=new Map;return m.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:y.replace(/[_-]+/g," "),n:x,html:!1,on:i.angle.includes(y)}))}}if(l==="mem"){const m=e("memoLevel"),v=new Map;m.forEach(x=>{if(x.kind==="target"){const N=fn(x);v.set(N,(v.get(N)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:y[x],n:v.get(x)||0,html:!1,on:i.memoLevel.includes(x)}))}}const p=e("stage"),b=new Map;return p.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,v)=>v[1]-m[1]).map(([m,v])=>({v:m,label:m,n:v,html:!1,on:i.stage.includes(m)}))}},[l,a,o]),s=p=>{if(l==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(p)?i.signalEngines.filter(v=>v!==p):[...i.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:p})},f=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function uo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:l,t:d}=H(),c=u.useMemo(()=>{const b={};return r.forEach(m=>{ka(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,s]=u.useState(!1),f=u.useRef(null);u.useEffect(()=>{if(!g)return;const b=v=>{var y;(y=f.current)!=null&&y.contains(v.target)||s(!1)},m=v=>{v.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const p=b=>{const m=hn.find(v=>v.key===b);return b==="monde"?d.contWorld:l==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:f,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>s(b=>!b),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Mn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),s(!1)},children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Mn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[p(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function mo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function zl(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function vr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:d}=H();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function fo({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=H(),o=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(vr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(vr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Al({card:e,onEvaluate:a,onAddAll:r}){var d,c,g;const{t:n}=H(),o=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),i=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:mo(e.summary_md||"").map((s,f)=>t.jsx("p",{children:s},f))})]}),t.jsx(fo,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Tl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ql({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:l}=H(),d=o,[c,g]=u.useState(null),[s,f]=u.useState(null),[p,b]=u.useState(null),[m,v]=u.useState(!1);u.useEffect(()=>{let x=!0;return(async()=>{const N=await qr({email:l,cbToken:d});x&&g(N)})(),()=>{x=!1}},[l,d,n]);const y=x=>{f(x),b(null),v(!0),(async()=>{const N=await ai(x.id);b(N),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(x=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(x),children:[t.jsx("span",{className:"ti",children:x.title}),t.jsxs("span",{className:"me",children:[Tl(x.created_at),x.industry?` · ${x.industry}`:"",x.author?` · ${x.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(x.cited_n||0,x.evaluate_n||0)}),t.jsx("span",{className:"st"+(x.published?" on":""),children:x.published?i.rsPub:i.rsPriv})]},x.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!p&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&p&&t.jsx(Al,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Kt(e){return/^https?:\/\//i.test((e||"").trim())}function nt(e){const a=(e||"").trim();return a?Kt(a)?a:ba.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Ll(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Fl(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:d,evalCards:c,caps:g,data:s,canWrite:f,source:p,dossiers:b,doAnalyse:m,liveMemos:v,pipe:y}=H(),x=a==="client",N=u.useMemo(()=>r||(p!=="default"?ni():""),[r,p]),[E,k]=u.useState(""),[j,L]=u.useState(!1),[C,q]=u.useState(""),[z,F]=u.useState(""),[D,I]=u.useState(""),[S,M]=u.useState(!1),[h,T]=u.useState(!1),[B,Y]=u.useState(""),[V,K]=u.useState(!1),[X,Q]=u.useState(""),[ie,ae]=u.useState([]),ce=u.useRef(!1),[W,re]=u.useState(!1),[ee,Le]=u.useState(!1),[je,oe]=u.useState(!1),me=u.useRef(!1),[se,G]=u.useState(""),[Z,he]=u.useState(""),[le,fe]=u.useState(!1),[ge,be]=u.useState(!1),[qe,ve]=u.useState(0),[Fe,et]=u.useState(""),[Ne,He]=u.useState(null),[Re,st]=u.useState(null),[pt,ft]=u.useState(!1),[tt,xt]=u.useState(null),[ht,Qe]=u.useState(0),A=u.useRef(!1),U=E.trim()?ba.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,_=u.useMemo(()=>B.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[B]);u.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),J=(O.get("rs")||"").trim(),ne=(O.get("rstext")||"").trim();J&&/^https?:\/\//i.test(J)&&G(J),ne&&he(ne),(J&&/^https?:\/\//i.test(J)||ne)&&re(!0)},[]),u.useEffect(()=>{const O=J=>{const ne=J.detail||{},w=String(ne.url||"").trim(),P=String(ne.text||"").trim();w&&/^https?:\/\//i.test(w)&&G(w),P&&he(P),(w&&/^https?:\/\//i.test(w)||P)&&(re(!0),k(""),q(""),fe(!0),window.setTimeout(()=>fe(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),u.useEffect(()=>{const O=J=>{const ne=J.detail||{},w=String(ne.name||"").trim();if(!w)return;re(!1),k(w),q(w);const P=nt(String(ne.website||ne.domain||""));F(P),I(nt(String(ne.url||""))),M(!P),L(!0),window.setTimeout(()=>L(!1),900)};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),u.useEffect(()=>{const O=(C||"").trim();if(!O||W||z){(z||!O||W)&&M(!1);return}const J=b.find(P=>Oe(P.name)===Oe(O)),ne=nt((J==null?void 0:J.website)||"")||nt((J==null?void 0:J.domain)||"");if(ne){F(ne),M(!1);return}let w=!0;return M(!0),Lr(O).then(P=>{var $,te;if(!w)return;const R=nt(P.website||"")||nt(((te=($=P.candidates)==null?void 0:$[0])==null?void 0:te.url)||"");R&&F(R)}).catch(()=>{}).finally(()=>{w&&M(!1)}),()=>{w=!1}},[C,W,z,b]),u.useEffect(()=>{const O=J=>{var w;const ne=String(((w=J.detail)==null?void 0:w.url)||"").trim();Kt(ne)&&window.open(ne,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",O),()=>window.removeEventListener("ppmap:view",O)},[]),u.useEffect(()=>{if(me.current===W)return;me.current=W,oe(!0);const O=window.setTimeout(()=>oe(!1),560);return()=>window.clearTimeout(O)},[W]),u.useEffect(()=>{if(typeof window>"u")return;const O=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),J=document.querySelector(".atl2.ops, .atl2.cibles");if(!O||!J)return;const ne=()=>J.style.setProperty("--demand-h",`${O.offsetHeight}px`);ne();const w=new ResizeObserver(ne);return w.observe(O),()=>w.disconnect()},[p,j,le,h,W,je,S]),u.useEffect(()=>{if(!f&&!N){xt(null);return}let O=!0;return(async()=>{const J=await qr({email:n,cbToken:N});O&&xt(J.length)})(),()=>{O=!1}},[f,N,n,ht]);const pe=ie.length?ie:c,xe=s.credits,de=u.useCallback(O=>{const J=O.map(ne=>(ne||"").trim()).filter(Boolean);J.length&&(Y(ne=>{const w=ne.split(`
`).map($=>$.trim()).filter(Boolean),P=new Set(w.map($=>$.toLowerCase())),R=J.filter($=>!P.has($.toLowerCase()));return[...w,...R].slice(0,15).join(`
`)}),T(!0))},[]);u.useEffect(()=>{if(!ge)return;ve(0);const O=window.setInterval(()=>ve(J=>J+1),1e3);return()=>window.clearInterval(O)},[ge]);const ye=u.useMemo(()=>{const O=E.trim().toLowerCase();return!O||!y?null:b.find(J=>Oe(J.name)===O&&ze(J)===1)||null},[E,b,y]),$e=()=>{const O=E.trim();if(O){if(ye){m(ye);return}o(null,O),x&&k("")}},At=async()=>{if(!x){o(null,_[0]||"");return}if(!_.length||V)return;K(!0),ce.current=!1;const O=[];for(let J=0;J<_.length&&!ce.current;J++){Q(e.evaluating(J+1,_.length,_[J]));const ne=await Fr(r,_[J],"atelier2");if(O.unshift({name:ne.company||_[J],verdict:ne.verdict,reason:ne.reason||"",remaining:ne.remaining??null}),ae([...O]),ne.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(_.length-J-1),remaining:0}),ae([...O]),Y(_.slice(J+1).join(`
`)),Q(""),K(!1);return}}Q(""),Y(ce.current?_.slice(O.length).join(`
`):""),K(!1)},gt=async()=>{var ne,w,P;if(A.current)return;const O=se.trim().replace(/\s+/g,""),J=Z.trim();if(!O&&!J){et(e.rsNeed);return}if(!x&&!N){o(null,O||J.slice(0,80));return}A.current=!0,et(""),He(null),st(null),be(!0);try{const R=await oi({url:O,text:J,email:n,cbToken:N});if(be(!1),!R||R.status!=="success"){et((R==null?void 0:R.message)||"Erreur");return}He(R),re(!1),de((((ne=R.prospective)==null?void 0:ne.companies_to_evaluate)||[]).map(te=>(te==null?void 0:te.name)||"")),st({state:"pending"});const $=await ii(R,{email:n,cbToken:N});st($.ok?{state:"ok",scopeLabel:((w=$.summary)==null?void 0:w.scope_label)||"",scope:((P=$.summary)==null?void 0:P.scope)||""}:{state:"fail",msg:$.error||""}),$.ok&&Qe(te=>te+1)}finally{A.current=!1,be(!1)}},Tt=[Ne==null?void 0:Ne.industry,...(Ne==null?void 0:Ne.market_tags)||[],Ne==null?void 0:Ne.author].map(O=>(O||"").trim()).filter(Boolean),ut=(Re==null?void 0:Re.state)==="pending",qt=Re&&(ut?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Re.state==="ok"?t.jsx("span",{className:"rslink ok",children:Re.scope&&Re.scope!=="public"?e.rsSavedIn(Re.scopeLabel||Re.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Re.msg,children:e.rsSaveFail})),Ve=zl(Ne).length,De=W,bt=(C||E).trim(),Je=b.find(O=>Oe(O.name)===Oe(bt)),$t=nt(E)||z||nt((Je==null?void 0:Je.website)||"")||nt((Je==null?void 0:Je.domain)||""),_t=D||nt((Je==null?void 0:Je.url)||""),ra=ye?e.actAnalyse:bt?e.evalGoOn(bt.length>22?bt.slice(0,21)+"…":bt):e.evalGo,Ra=ge?`${ri(se.trim())==="youtube"&&se.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(qe)}`:ut?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(De?" rs-mode":"")+(C&&E.trim()===C||j||le?" pair":"")+(j||le||je?" echo":"")+(je?" swap":""),children:[t.jsxs("div",{className:"drow"+((De?le:j)||je?" flash":"")+((De?se.trim():ba.test(E.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:De?se:E,placeholder:De?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:De?600:200,spellCheck:De?!1:void 0,inputMode:De?"url":void 0,onChange:O=>{if(De){G(O.target.value);return}k(O.target.value),C&&O.target.value.trim()!==C&&(q(""),F(""),I(""),M(!1))},onKeyDown:O=>{O.key==="Enter"&&(De?gt():$e())}}),t.jsx("span",{className:"detect"+(De?" off":"")+(ba.test(E.trim())?" url":""),children:U})]}),t.jsx("span",{className:"dacts",children:De?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ge?" loading":""),disabled:ge||ut||!se.trim()&&!Z.trim(),onClick:()=>{gt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ra})]}),t.jsxs("a",{className:"viewbtn"+(Kt(se)?"":" off"),href:Kt(se)?se.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:O=>{Kt(se)||O.preventDefault()},children:[t.jsx(Ll,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ye?" analyse":"")+(d?" loading":""),disabled:d,onClick:$e,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ra})]}),t.jsxs("a",{className:"viewbtn sm"+(S?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":S||void 0,title:S?e.viewSiteBusyHint:e.viewSiteHint,onClick:O=>{$t||O.preventDefault()},children:[S&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),S?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(_t?"":" off"),href:_t||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:O=>{_t||O.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&xe&&t.jsxs("button",{type:"button",className:"credits"+(xe.total_available<=0&&!xe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:xe.unlimited?"∞":xe.total_available}),!xe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",xe.daily_grant+xe.purchased]}),xe.total_available<=0&&!xe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),v.items.filter(O=>O.status==="boot"||O.status==="running").map(O=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:O.name}),t.jsx(Qt,{item:O,serverOff:v.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+O.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>T(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(W?" on":""),onClick:()=>re(!W),children:e.rsOpen}),tt!==null&&tt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(pt?" on":""),onClick:()=>ft(!pt),children:e.rsArchOpen(tt)})]}),pt&&t.jsx(ql,{bump:ht,cbToken:N,onClose:()=>ft(!1),onEvaluate:O=>o(null,O),onAddAll:de}),t.jsx("div",{className:"rsp slim"+(W?" on":" off"),"aria-hidden":!W,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:W?void 0:-1,onClick:()=>Le(O=>!O),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:ee?"▴":"▾"})]}),ee&&t.jsx("textarea",{className:"rstext",value:Z,placeholder:e.rsTextPh,tabIndex:W?void 0:-1,onChange:O=>he(O.target.value)})]})}),Fe&&t.jsx("div",{className:"rserr",children:Fe}),Ne&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Ne.title}),Ne.source_url&&t.jsx("a",{href:Ne.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{He(null),st(null)},children:"×"})]}),Ne.market&&t.jsx("p",{className:"rsmk",children:Ne.market}),Tt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Tt.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[Ne.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Ne.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:mo(Ne.summary_md||"").map((O,J)=>t.jsx("p",{children:O},J))})]}),t.jsx(fo,{card:Ne,onEvaluate:O=>o(null,O),onAddAll:de}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Ve)}),qt]})]}),h&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:B,placeholder:e.bulkPh,onChange:O=>Y(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(V?" loading":""),style:{justifyContent:"center"},disabled:V||!_.length,onClick:()=>{At()},children:[t.jsx("span",{className:"fill"}),V&&X?X:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(_.length)})]})]}),pe.slice(0,1).map((O,J)=>{const ne=O.verdict==="kept",w=O.verdict==="quota",P=ne?"var(--brand)":w?"var(--bolt)":"var(--red)",R=ne?"var(--brand-l)":w?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":P,"--bgc":R},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ne?"✓ "+e.kept:w?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map($=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:$.url.startsWith("http")?$.url:`https://${$.url}`,target:"_blank",rel:"nofollow noopener",children:[($.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,$.url),children:e.evalPickGo})]},$.url))}),!w&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:ne?1:5});const $=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const te=[...document.querySelectorAll(".atl2 .list .row")].find(Se=>{var Ee;return(((Ee=Se.querySelector(".rnm"))==null?void 0:Ee.textContent)||"").trim().toLowerCase().includes($)});te&&(te.scrollIntoView({behavior:"smooth",block:"center"}),te.classList.add("flashrow"),window.setTimeout(()=>te.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ne?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),x&&(i.kept+i.dropped>0||pe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Rl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ml(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=H(),i=e.memoConsole?r.get(e.memoConsole):null,l=u.useMemo(()=>i?[i.reasoning||"",Rl(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const d=mt(i),c=fn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Mt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function kn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=H(),[l,d]=u.useState(!1),[c,g]=u.useState(null),s=n.pipe&&o==="client"&&!n.lockActions,f=async()=>{if(!s||l)return;d(!0);const p=await si(r,e);if(d(!1),!p){i(a.actErr);return}g(p.results||[])};return u.useEffect(()=>{if(!s)return;const p=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&f()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,s]),u.useEffect(()=>{if(s)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),f())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{f()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Ol=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),xa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Pl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=xa(a.slice(n));break}r+=xa(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=xa(a.slice(o));break}const l=a.slice(o+1,i).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Ol.has(c)?r+=`<${d[1]}${c}>`:r+=xa(a.slice(o,i+1)),n=i+1}return r}const yr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Pe({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Dl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Il({o:e}){const{t:a,doDeep:r}=H(),[n,o]=u.useState(!1),i=mt(e),l=[e.reasoning||"",Dl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Mt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function jn({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=H(),i=aa(e),l=mt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=u.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Mt(e)?1:0}].filter(v=>v.n>0),[e,a,d,l,c,g,s]),[p,b]=u.useState("");if(!f.length)return null;const m=f.some(v=>v.k===p)?p:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===v.k,"data-tour":"tab-"+v.k,className:m===v.k?"on":"",onClick:y=>{y.stopPropagation(),b(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Pe,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Pe,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Pe,{k:a.cdVerdictDate,v:yr(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Pl(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(Bl,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Pe,{k:a.cdSector,v:e.sector}),t.jsx(Pe,{k:a.cdStage,v:e.stage}),t.jsx(Pe,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Pe,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Pe,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Pe,{k:a.cdAngle,v:e.angle}),t.jsx(Pe,{k:a.cdDetected,v:yr(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Pe,{k:a.cdName,v:e.contactName}),t.jsx(Pe,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Pe,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="memo"&&t.jsx(Il,{o:e}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Pe,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Pe,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Bl({o:e}){const{t:a,token:r}=H(),[n,o]=u.useState(!1),[i,l]=u.useState(null),d=async()=>{n||(o(!0),l(await li(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=g.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),i&&s&&t.jsxs(t.Fragment,{children:[g.filter(([,f])=>f).map(([f,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:p})]},f)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!s&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function na({spec:e}){const a=u.useRef(null),r=u.useRef(null),[n,o]=u.useState(!1);return u.useEffect(()=>{const i=a.current;if(!i)return;let l=!1;const d=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));On({kind:"op",card:e},g).then(s=>{!l&&s&&i.isConnected&&i.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),u.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let l=!1;On({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&i.isConnected&&i.replaceChildren(c)});const d=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const $l=`
...
`;function _l(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let d=e.y+10;return d+n>i-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function Ul(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:l,askEvaluate:d,doAnalyse:c,doDecide:g,doPromote:s,doRepeche:f,doApproach:p,doDeep:b,doOnboard:m,outbound:v,evalBusy:y}=H(),x=e.popupId?r.get(e.popupId):null;if(!x)return null;const N=Me(x),E=ze(x),k=mt(x),j=aa(x),L=x.kind==="target",C=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return Dt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:$l}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:_l(e.popupAnchor,!!x.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:x.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ct(x.date)),Ue(x.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[x.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[x.cc]}),children:(It(x.cc,o)||x.countryLabel||"").toUpperCase()}),x.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[x.sector]}),children:x.sector.toUpperCase()}),x.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[x.stage]}),children:x.stage.toUpperCase()}),typeof x.amountEur=="number"&&x.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(x.amountEur,o)})]}),i.pipe&&L&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),x.ceoStatus&&t.jsx("span",{className:"pstep own",children:x.ceoStatus})]}),(x.tagline||x.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:x.tagline||x.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[jt(x.engine)," ",t.jsx("b",{children:Ue(x.engine,o)})," — ",di(x.engine,o),x.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",x.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ct,{o:x,lg:!0})," ",t.jsx(Fa,{o:x,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Rr(N,o))," · ",n.win7(Mr(N,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),x.card?t.jsx(na,{spec:x.card}):null,x.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:x.reasoning})]}),i.pipe&&L&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof x.score=="number"&&x.score>0?" · "+n.score(x.score):""]})}),i.pipe&&L&&t.jsx(jn,{o:x})]}),t.jsx(kn,{name:x.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||l!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(x,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(x,!1),a({type:"popup",id:null})},children:n.actNo}),Mt(x)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(x),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),x.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:x.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(x),a({type:"popup",id:null})},children:"🚀"})]}):x.engine==="media"&&x.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(x.name),onClick:()=>d(x),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)," →"]}),x.website&&t.jsx("a",{className:"psite",href:x.website.startsWith("http")?x.website:"https://"+x.website,target:"_blank",rel:"noopener noreferrer",title:x.website,children:"🌐"})]})]})]}),document.body)}function Hl(){const{lang:e,token:a,dossiers:r,caps:n}=H(),o=a||"home",{names:i,verdicts:l}=u.useMemo(()=>{const c=[],g={};return r.forEach(s=>{s.kind!=="target"||!s.name||(c.push(s.name),g[s.name]=ci(s)||"")}),{names:c,verdicts:g}},[r]);return{diff:u.useMemo(()=>i.length?pi(o,i,l,e):null,[o,i.length]),names:i,verdicts:l,scope:o,caps:n}}function Vl(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:l}=H(),d=i.loading&&!l.length,c=u.useRef({});u.useEffect(()=>{c.current={...r}},[r]);const g=p=>{const b=c.current[p],m=b!==void 0?r[p]-b:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ya[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(m>0?" up":m<0?" down":""),children:[r[p],m!==0&&t.jsxs("em",{className:"delta",children:[m>0?"+":"−",Math.abs(m)]})]})]},p)},s=(p,b,m)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${Ya[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:m.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),f=(p,b,m,v=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:v,onClick:m,children:p},b);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[f("↩",n.toolUndo,o,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Wl(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=H(),d=u.useRef(null),[c,g]=u.useState(60);u.useEffect(()=>{let m=0;const v=()=>{var k;const y=d.current;if(!y)return;const x=(k=y.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!x)return;const N=x.getBoundingClientRect(),E=y.getBoundingClientRect();g(Math.max(20,Math.min(N.left+N.width/2-E.left,E.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const s=e.ptab;let f=r.tuto[s].p;if(s===3){const m=n.filter(x=>x.kind==="target"&&ze(x)===3),v=m.filter(x=>Ga(x)==="auto").length,y=m.filter(x=>Ga(x)==="cd").length;f=r.tutoPending(v,y,m.length)}const p=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(s===1){const m=n.filter(v=>v.kind==="target"&&ze(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=ui(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Ya[s]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:f}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Va=600,yt=62,wr="atl2:fstats";function Yl(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=H(),[l,d]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(wr)==="on"}catch{return!1}}),c=r.stats,g=u.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const f=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,p=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((j,L)=>Math.max(j,L.s||0),0),m=g.length?Va/g.length:0,v=Math.max(4,m-4),y=g.length>=5&&b>0,x=r.marketEstimate||0,N=f(new Date().toISOString().slice(0,10)),E=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],k=[];return typeof c.screened_window=="number"&&s&&k.push({cle:"fenetre",periode:e.funPerWindow(f(s),N),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:E(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([L,C],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(L)}),t.jsx("i",{children:C})]},j.cle+C)),j.cle==="total"&&x>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(x),Math.min(100,Math.round((c.screened||0)/x*100)))})]}),j.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const L=!l;d(L),L&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(wr,L?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},j.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Va} ${yt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((j,L)=>{const C=(j.s||0)/b*(yt-4),q=(j.m||0)/b*(yt-4),z=L*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:yt-2-C,width:v,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:yt-2-q,width:v,height:q,fill:"#185c38"})]},j.d)}),t.jsx("line",{x1:0,y1:yt-1.5,x2:Va,y2:yt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const xo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Nn({o:e,locked:a=!1}){const{t:r}=H(),n=aa(e),o=mt(e),i=ze(e),l=Ga(e),d=fi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(xo[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(ws,{o:e})]})}const Et=e=>e.length>22?e.slice(0,21)+"…":e,va=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function La(e){return va.has(e.engine||"")}function wt(e){return!!e.noCo||La(e)&&!!e.url}function ta(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function ho(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Gl({on:e,rev:a}){const[r,n]=u.useState(null),[o,i]=u.useState({top:0,left:0,width:0});return u.useEffect(()=>{if(!e){n(null);return}const l=()=>{var m,v,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const g=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(s),left:Math.round(g.left),width:Math.round(g.width)});const f=[...d.querySelectorAll(":scope .grp")];let p=null;for(const x of f){const N=x.querySelector(".grp-h");N&&N.getBoundingClientRect().bottom<=s+2&&(p=x)}if(!p){n(null);return}const b=p.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Kl(e){const r=()=>{const n=ho(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function kr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=H(),[i,l]=u.useState(!1);if(u.useEffect(()=>{n||l(!1)},[n]),Ie(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Et(e.name))})]})}function Sn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:l,doPromote:d,doRepeche:c,doApproach:g,dispatch:s,liveMemos:f}=H(),p=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=p(()=>s({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=ze(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Et(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return La(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(kr,{o:e})});const b=ze(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(kr,{o:e})});if(b===1){const m=f.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Qt,{item:m,serverOff:f.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:p(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:p(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Ql({o:e}){const{t:a,doThumb:r,thumbOf:n}=H(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Jl({o:e}){const{lang:a}=H();return Me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ct,{o:e}),t.jsx(Fa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[jt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function Xl({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:l}){const{dispatch:d,caps:c,markRow:g,markedId:s,favIds:f,toggleFav:p,t:b}=H(),m=ze(e),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,x=y<=0?0:y<=7?1:y<=30?2:3,N=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][m]:v[x],E=f.has(e.id),k=j=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const L=j.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:L.left+Math.min(280,L.width/3),y:L.bottom}})};return t.jsxs(u.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>g(e.id),onMouseLeave:()=>g(null),onClick:k,children:[t.jsx("span",{className:"pt",style:{"--c":N}}),t.jsx(wo,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:E?1:.35,padding:0,marginRight:4},onClick:j=>{j.stopPropagation(),p(e)},children:E?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(j=>j&&j!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:b.acqSee(e.acquirer),onClick:j=>{j.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",Et(e.acquirer)]}),Ze(e)?t.jsx("span",{className:"rdec",title:b.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:b.zoomNewsMark,children:"📰"}):null]}),t.jsx(Zl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Jl,{o:e}),c.pipe&&t.jsx(Nn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Sn,{o:e}),c.showThumbs&&t.jsx(Ql,{o:e})]}),r&&!a&&!l&&t.jsx(ad,{o:e})]})}function Zl({o:e}){const{lang:a,caps:r}=H();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function ed({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=H(),l=(p,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:p})},d=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=Bt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Ie(e),f=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):wt(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),ta(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Et(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Et(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(na,{spec:e.card})})]})}function td({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=H();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ue(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Sn,{o:e})}),t.jsx(jn,{o:e})]})}function go({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:l,caps:d,dossiers:c}=H(),g=u.useRef(null),s=Ze(e);if(u.useEffect(()=>{if(!s||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let T=!1;return Ar(()=>import("./fit-BnaWm7z_.js"),[]).then(async B=>{await B.ensureEditoCss(),!(T||!h.isConnected)&&(B.beautifyEditoRows(h),B.mountCardFits(h))}),()=>{T=!0}},[s,e==null?void 0:e.decryptHtml]),!e&&!a){const h=c.find(Ze);if(h)return t.jsx(go,{o:h})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!f||wa(f),y=(e==null?void 0:e.engine)||"",x=Ze(e),N=e?Bt(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),j=c.find(Ze),L=((j==null?void 0:j.url)||"").trim(),C=!!p&&!!L&&(p===L||p.endsWith(L)||L.endsWith(p)),q=(h,T=!1)=>B=>{B.stopPropagation(),T&&l({type:"continent",key:"monde"}),l({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const z=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},F=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},D=()=>{ta({url:p,headline:b,tagline:e==null?void 0:e.tagline,name:f})},I=e?Ie(e):!1,S=I&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",M=x?r.doEdito.replace(/^📖\s*/,""):y?Ue(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[M,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),p&&!x&&(v||La({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(x?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),N&&t.jsx("span",{className:"oc-amt",children:N})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(na,{spec:m})}),(p&&!C&&!x||j&&!x)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!C&&!x&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!x&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),l({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[I?t.jsxs("span",{className:"verdict",style:{"--c":S?"var(--brand)":"var(--red)"},children:[S?"✓":"✗"," ",t.jsx("b",{children:S?r.kept:r.dropped})]}):!v&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Et(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!x&&(v||La({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&f?" ghost":""),onClick:h=>{h.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Et(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&f&&d.pipe&&t.jsx(kn,{name:f})]})]})}function ad({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:l}=H();return!o.pipe&&e.kind==="op"?t.jsx(ed,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(jn,{o:e}),t.jsx(ks,{o:e}),t.jsx(Ss,{o:e}),t.jsx(kn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Nn,{o:e})})]}),e.card&&t.jsx(na,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[jt(e.engine||"")," ",Ue(e.engine||"",r)]}),Me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ct,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function nd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:l,doDecide:d,lang:c}=H();if(!l.pipe&&e.kind==="op"){const f=Bt(e.amountEur,c),p=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(na,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),f&&t.jsx("span",{className:"damt",children:f})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[jt(e.engine||"")," ",Ue(e.engine||"",c)]}),Me(e)&&t.jsx(Ct,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Sn,{o:e})})]})}const g=ze(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Nn,{o:e}),Me(e)&&t.jsx(Ct,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function rd(){const{t:e}=H(),[a,r]=u.useState(0);return u.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function od({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=H(),i=o==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,f)=>(e[f]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${l(c)}”`:`${g} dossier${g>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+l(c)," →"]})]})}function id(){var ft,tt,xt,ht,Qe;const e=H(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:l,scopedAll:d,markRow:c,lang:g,sessTally:s,data:f,dossiers:p,source:b,focusExtra:m,byId:v,token:y}=e,x=Ir(),N=u.useMemo(()=>{var _,pe,xe,de;if(!y||b==="ops")return null;const A=(((_=x==null?void 0:x.ed)==null?void 0:_.date)||(x==null?void 0:x.day)||"").slice(0,10),U=[(pe=x==null?void 0:x.ed)==null?void 0:pe.html,(xe=x==null?void 0:x.ed)==null?void 0:xe.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((de=x==null?void 0:x.ed)==null?void 0:de.date)||A,decryptHtml:U||void 0,date:A,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,g,(ft=x==null?void 0:x.ed)==null?void 0:ft.html,(tt=x==null?void 0:x.ed)==null?void 0:tt.acquirers_html,(xt=x==null?void 0:x.ed)==null?void 0:xt.date,x==null?void 0:x.day]),E=A=>o.lockRowsAfter!==null||b==="ops"?Number.MAX_SAFE_INTEGER:Pr,[k,j]=u.useState(new Set);u.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[L,C]=u.useState(null);u.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[q,z]=u.useState(!a.mapFolded);u.useEffect(()=>{if(a.mapFolded){z(!1);return}const A=document.getElementById("atl2-stage");if(!A){z(!1);return}const U=new IntersectionObserver(([_])=>z(!!_&&_.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return U.observe(A),()=>U.disconnect()},[a.mapFolded]);const F=a.mapFolded||!q,D=A=>j(U=>{const _=new Set(U);return _.has(A)?_.delete(A):_.add(A),_}),I=b==="ops"||o.pipe,[S,M]=u.useState("all"),[h,T]=u.useState(null),[B,Y]=u.useState(!1),V=u.useRef(!0);u.useEffect(()=>{if(V.current){V.current=!1;return}M("all"),Y(!1)},[a.ptab,a.continent]),u.useEffect(()=>{if(!B)return;const A=U=>{var _,pe;(pe=(_=U.target)==null?void 0:_.closest)!=null&&pe.call(_,".atl2 .doable")||Y(!1)};return document.addEventListener("click",A),()=>document.removeEventListener("click",A)},[B]);const K=u.useMemo(()=>{var U;const A=new Map;for(const _ of ds(((U=x==null?void 0:x.ed)==null?void 0:U.html)||""))A.has(_.t)||A.set(_.t,_.html);return A},[(ht=x==null?void 0:x.ed)==null?void 0:ht.html]),X=u.useCallback(A=>{if(A.decryptHtml)return A.decryptHtml;if(!K.size)return;const U=(A.name||"").trim().toLowerCase();if(U.length<3)return;const _=K.get(U);if(_)return _;for(const[pe,xe]of K)if(pe.includes(U)||U.includes(pe))return xe},[K]),{diff:Q}=Hl(),[ie,ae]=u.useState(!1),[ce,W]=u.useState(!1),re=u.useMemo(()=>new Set(((Q==null?void 0:Q.added)||[]).map(A=>A.trim().toLowerCase()).filter(Boolean)),[Q]),ee=u.useMemo(()=>{const A=ce&&re.size?d:l;let U=gn(A,a.sort);return U=U.filter(_=>!Ze(_)),ce&&re.size&&(U=U.filter(_=>re.has((_.name||"").trim().toLowerCase()))),S==="explore"?U=U.filter(wt):S==="eval"&&(U=U.filter(_=>!wt(_)&&!_.noCo)),U},[l,d,a.sort,S,ce,re]),je=u.useMemo(()=>o.pipe?d.filter(A=>Me(A)&&mi(A)):ee.filter(A=>Me(A)&&!Ie(A)),[o.pipe,d,ee]).length,oe=u.useMemo(()=>o.pipe?ee:ee.filter(A=>!Ie(A)&&!A.noCo),[ee,o.pipe]),me=b==="ops"?ee.filter(wt).length:0,se=ce?n.sinceDock(ee.length):o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,G=a.filters,Z=[];if(G.day)Z.push({k:"day",lib:n.fDay(G.day.slice(8,10)+"/"+G.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(G.win&&G.win!=="all"){const A=["1","7","30"].indexOf(G.win);A>=0&&Z.push({k:"win",lib:n.dates[A],off:()=>r({type:"filters",patch:{win:"all"}})})}const he=A=>A.length<=2?A.join(", "):`${A.length} ${n.fSelected}`;for(const A of["sector","country","engine"]){const U=G[A];U&&U.length&&Z.push({k:A,lib:he(U),off:()=>r({type:"clearFacet",facet:A})})}G.search&&Z.push({k:"search",lib:"🔍 "+G.search,off:()=>r({type:"filters",patch:{search:""}})}),ce&&re.size&&Z.push({k:"since",lib:"✨ "+n.sinceDock(re.size),off:()=>W(!1)}),G.signalOnly&&Z.push({k:"sig",lib:"🔴 "+n.sigDock(je||G.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const le=(A,U,_="",pe=!1)=>t.jsxs("button",{type:"button","data-s":A,className:_,"aria-sort":a.sort.key===A?a.sort.dir===1?"ascending":"descending":"none",style:pe?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:A}),children:[U,t.jsx("span",{className:"ar",children:a.sort.key===A&&a.sort.dir===1?"▴":"▾"})]},A),fe=u.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const A=new Map;ee.forEach(pe=>{const xe=pe.engine||"?";A.has(xe)||A.set(xe,[]),A.get(xe).push(pe)});const U={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},_=Wa([...A.keys()],g);return[...A.entries()].sort((pe,xe)=>{const de=U[pe[0]]??10+_.indexOf(pe[0]),ye=U[xe[0]]??10+_.indexOf(xe[0]);return de-ye})},[ee,o.pipe,a.groupBy,g]),ge=fe?fe.filter(([A])=>va.has(A)).length:0,be=(()=>{var U;return((U=(fe?fe.flatMap(([,_])=>_):ee)[0])==null?void 0:U.id)??null})(),qe=u.useRef(!1),ve=u.useMemo(()=>p.find(Ze)||N,[p,N]);u.useEffect(()=>{const A=()=>{qe.current=!0};return window.addEventListener("ppmap:reveal",A),window.addEventListener("ppmap:focus",A),()=>{window.removeEventListener("ppmap:reveal",A),window.removeEventListener("ppmap:focus",A)}},[]),u.useEffect(()=>{const A=()=>{ve&&r({type:"focus",id:ve.id})};return window.addEventListener("ppmap:edito",A),()=>window.removeEventListener("ppmap:edito",A)},[ve,r]),u.useEffect(()=>{if(!a.focusId)return;T(a.focusId);const A=window.setTimeout(()=>T(null),900);return()=>window.clearTimeout(A)},[a.focusId]),u.useEffect(()=>{if(I&&!(a.focusId&&(ee.some(A=>A.id===a.focusId)||p.some(A=>A.id===a.focusId)||a.focusId===(ve==null?void 0:ve.id)))&&!m){if(ve){r({type:"focus",id:ve.id});return}be&&r({type:"focus",id:be})}},[I,a.focusId,ee,be,m,r,p,b,ve]),u.useEffect(()=>{if(!(!I||!a.focusId)&&S!=="all"&&!(ve&&a.focusId===ve.id)&&!ee.some(A=>A.id===a.focusId)&&p.some(A=>A.id===a.focusId)){if(qe.current){M("all");return}be&&r({type:"focus",id:be})}},[I,a.focusId,S,ee,p,be,r]),u.useEffect(()=>{if(!I||!a.focusId||!qe.current)return;const A=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!A)return;qe.current=!1;const U=ho(),_=A.getBoundingClientRect();_.top>=U-2&&_.bottom<=window.innerHeight-4||Kl(A)},[I,a.focusId,a.ptab,ee]),u.useEffect(()=>{if(typeof window>"u")return;const A=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),U=document.querySelector(".atl2.ops, .atl2.cibles");if(!A||!U)return;const _=()=>U.style.setProperty("--listhead-h",`${A.offsetHeight}px`);_();const pe=new ResizeObserver(_);return pe.observe(A),()=>pe.disconnect()},[F,a.dens,a.mapFolded]);const Fe=u.useMemo(()=>{if(!I||!a.focusId)return null;if(N&&a.focusId===N.id)return N;const A=ee.find(_=>_.id===a.focusId)||p.find(_=>_.id===a.focusId)||null;if(!A)return null;const U=X(A);return U&&U!==A.decryptHtml?{...A,decryptHtml:U}:A},[I,a.focusId,ee,p,X,N]),et=o.lockRowsAfter;let Ne=0;const He=(A,U)=>{let _=a.shown[U]||E();return A.length-_<=4&&(_=A.length),A.slice(0,_).map(de=>{const ye=et!==null&&Ne>=et;Ne++;const $e=X(de),At=$e&&$e!==de.decryptHtml?{...de,decryptHtml:$e}:de,gt=!I&&a.dens!=="maxi"&&(a.dens==="deplie"||(L?L==="open":!!$e)),Tt=k.has(de.id)?!gt:gt,ut=I?qt=>{qe.current=!0,r({type:"focus",id:qt});const Ve=v.get(qt);Ve&&(wt(Ve)?ta(Ve):Ve.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ve.name,url:Ve.url||"",website:Ve.website||"",domain:Ve.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(nd,{o:At,locked:ye,selected:I&&a.focusId===de.id,onSelect:ut},de.id):t.jsx(Xl,{o:At,locked:ye,open:Tt,onToggle:()=>D(de.id),selected:I&&a.focusId===de.id,echo:h===de.id,onSelect:ut},de.id)})},Re="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ee.length?"":" list-empty"),st=t.jsxs(t.Fragment,{children:[fe?fe.map(([A,U])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:jt(A)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:A==="ma"?n.grpMa:A==="fundraising"?n.grpLev:va.has(A)&&ge<=1?n.grpNews:A==="nominations"?n.grpNom:A==="media"?n.grpNewsOther:A==="recrutements"?n.grpHire:va.has(A)?n.grpNews+" · "+Ue(A,g):Ue(A,g)}),t.jsx("div",{className:"s",children:n.grpCount(U.filter(_=>!Ie(_)).length,U.length)})]})]}),He(U,A)]},A)):He(ee,"pt"+a.ptab),f.loading&&!p.length&&t.jsx(rd,{}),!ee.length&&!(f.loading&&!p.length)&&(o.pipe?t.jsx(od,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),pt=t.jsxs("div",{className:"listhead"+(F?" mapoff":""),children:[F&&t.jsx("div",{className:"lh-tools",children:t.jsx(po,{compact:!0})}),o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ie?" on":""),"aria-expanded":ie,onClick:()=>ae(A=>!A),children:["📊 ",n.morningDock(typeof((Qe=f.stats)==null?void 0:Qe.screened_today)=="number"?f.stats.screened_today:0)]}),Q&&!Q.firstVisit&&(Q.added.length>0||Q.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ce?" on":""),"aria-pressed":ce,title:n.sinceSub,onClick:()=>W(A=>!A),children:["✨ ",n.sinceDock(Q.added.length)]}),je>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[]}}),children:["🔴 ",n.sigDock(je)]})]}),o.showFunnel&&ie&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(Cs,{}),t.jsx(Yl,{})]}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Vl,{}),t.jsx(Wl,{})]}),t.jsxs("div",{className:"lh-top",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:ee.length})," ",se]}),t.jsx("span",{className:"dot",children:"·"}),F&&t.jsx(uo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[F?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),Z.map(A=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:U=>{U.stopPropagation(),A.off()},children:[A.lib,t.jsx("i",{children:"×"})]},A.k)),b==="ops"&&ee.length>0&&!F&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ee.length-me," ",n.zoomPulseEval,me>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",me," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([A,U])=>t.jsxs("button",{type:"button","data-d":A,"aria-pressed":a.dens===A||A==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:A}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:U})]},A))}),!I&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":L==="open",onClick:()=>{C("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":L==="closed",onClick:()=>{C("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var de;const A=l.filter(ye=>!Ze(ye)),U=A.filter(ye=>!wt(ye)&&!ye.noCo).length,_=A.filter(wt).length,pe=[["all",n.doAll],["eval",`${n.doEval}${U?` ${U}`:""}`],["explore",`${n.doExplore}${_?` ${_}`:""}`]],xe=((de=pe.find(([ye])=>ye===S))==null?void 0:de[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":B,onClick:()=>Y(ye=>!ye),children:[xe,t.jsx("i",{children:"▾"})]}),B&&t.jsx("div",{className:"dolist",children:pe.map(([ye,$e])=>t.jsx("button",{type:"button","aria-pressed":S===ye,onClick:()=>{M(ye),Y(!1)},children:$e},ye))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:A=>r({type:"sort",key:A.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([A,U])=>t.jsx("option",{value:A,children:U},A))})]}),o.showChain&&oe.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:oe.map(A=>A.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(oe.length):n.chainAll(oe.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!I&&pt,a.dens!=="maxi"&&!I&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),le("country",n.colCountry),le("name",n.colCompany),le("amount",n.colAmount,"h-amt",!0),le("stage",n.colStage,"h-stade"),le("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[le("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),le("memo",n.colMemo)]}),o.pipe&&le("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),I?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[pt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),le("country",n.colCountry),le("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[le("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),le("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Re,children:st})]}),t.jsxs("aside",{className:"readpane"+((Fe?Ze(Fe):!m&&ve)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[ve&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===ve.id,onClick:()=>r({type:"focus",id:ve.id}),children:n.doEdito}),N&&a.focusId===N.id?t.jsx("div",{className:"zoom",children:t.jsx(us,{})}):Fe&&o.pipe?t.jsx(td,{o:Fe}):t.jsx(go,{o:Fe,extra:Fe?null:m})]})]}):t.jsx("div",{className:Re,children:st}),(()=>{const A=fe||[["pt"+a.ptab,ee]];let U=0,_=0;for(const[xe,de]of A){_+=de.length;let ye=a.shown[xe]||E();de.length-ye<=4&&(ye=de.length),U+=Math.min(de.length,ye)}const pe=_-U;return pe<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>A.forEach(([xe,de])=>r({type:"more",group:xe,by:de.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(pe,pe)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(U,_)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),I&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Gl,{on:!!fe,rev:(fe||[]).map(([A,U])=>A+U.length).join("|")})]})}function jr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function sd(e,a){const r=xi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ld(e,a){const n=[a.head.split("|").map(jr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",sd(o,a.plabels),aa(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(jr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function dd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const cd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function rt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function pd({o:e,qa:a}){const{t:r,lang:n,fund:o}=H(),i=(e.cribleStatus||"").trim().toUpperCase()||(aa(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=mt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(rt,{k:r.cdSector,v:e.sector}),t.jsx(rt,{k:r.cdStage,v:e.stage}),t.jsx(rt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(rt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(rt,{k:r.cdName,v:e.contactName}),t.jsx(rt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(rt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(rt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(rt,{k:r.cdAngle,v:e.angle}),t.jsx(rt,{k:r.cdDetected,v:cd(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:s})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function ud(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=H(),[d,c]=u.useState({}),g=25,s=u.useMemo(()=>n.slice(0,g),[n]);u.useEffect(()=>{s.length&&hi(r,s.map(b=>b.name)).then(c)},[r,s]);const f=i.stats,p=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[p(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(f.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(i.marketEstimate)),", ",Math.round(f.screened/i.marketEstimate*100)," %"]})]})]}),s.map(b=>t.jsx(pd,{o:b,qa:d[b.name]},b.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const md=50;function En({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=H(),[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(""),[f,p]=u.useState(0),[b,m]=u.useState(""),[v,y]=u.useState(!1),[x,N]=u.useState(0),E=u.useRef(null),k=u.useRef(null),j=()=>{N(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>N(z=>z+1),1e3)},L=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};u.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),k.current&&window.clearInterval(k.current)},[]);const C=async z=>{c(!0),s(""),j();const F=await a();if(c(!1),L(),F.ok){l(F);return}if(F.busy){s(o.alertPreviewBusy);return}if(!z){s(o.alertPreviewFail);return}p(md),L(),E.current=window.setInterval(()=>{p(D=>D>1?D-1:(E.current&&window.clearInterval(E.current),C(!1),0))},1e3)},q=async()=>{if(n||v||d)return;y(!0),m(""),j();const z=await r();y(!1),L(),m(z.ok?o.alertTestOk(z.sentTo||""):z.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||v||f>0,onClick:()=>{C(!0)},children:d?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||d,onClick:()=>{q()},children:v?o.alertBtnTestBusy:o.alertTest})]}),d&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(x)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(x)]}),f>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(f)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Rt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Be({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=H();return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function fd(){const{st:e}=H();switch(e.modal){case"chain":return t.jsx(hd,{});case"space":return t.jsx(gd,{});case"alert":return t.jsx(bd,{});case"queue":return t.jsx(jd,{});case"export":return t.jsx(Nd,{});case"plug":return t.jsx(Cd,{});case"recharge":return t.jsx(Ad,{});case"cover":return t.jsx(qd,{});case"dossier":return t.jsx(Td,{});case"crit":return t.jsx(Ld,{});case"tuto":return t.jsx(Fd,{});case"rdv":return t.jsx(xd,{});case"memoalert":return t.jsx(Sd,{});default:return null}}function xd(){const{dispatch:e,fund:a,t:r}=H(),n=a||r.rdvCoFallback;return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:_r,children:vn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Bi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function hd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:d,caps:c,memoQueued:g,doAnalyse:s}=H(),f=i==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,m=p[b],v=b>=p.length;return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[It(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(ct(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Bt(m.amountEur,o)})]}),Me(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ct,{o:m,lg:!0})," ",t.jsx(Fa,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),f&&Ie(m)&&t.jsxs("div",{className:"vbox",style:{"--c":kt(m)==="retenu"?"var(--brand)":kt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:kt(m)==="retenu"?"✓ "+n.kept:kt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&c.pipe&&ze(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(f&&Ie(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function gd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=H(),i=o==="client",l=u.useMemo(()=>i?r.filter(f=>Ie(f)):[],[r,i]),d=u.useMemo(()=>gn(l.filter(f=>kt(f)==="retenu"),{key:"signal",dir:-1}),[l]),c=u.useMemo(()=>l.filter(f=>kt(f)==="ecarte"),[l]),g=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Be,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function bd(){const{mode:e}=H();return e==="client"||e==="apercu"?t.jsx(vd,{}):t.jsx(kd,{})}function vd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=H(),[i,l]=u.useState("d"),d=o!=="client";return t.jsxs(Be,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(yd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="w"&&t.jsx(wd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="m"&&t.jsx(bo,{})]})}function yd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let q=!0;return c(!1),In(a).then(z=>{q&&(z?l(z):c(!0))}),()=>{q=!1}},[a,g]);const f=u.useRef({}),[p,b]=u.useState({}),[m,v]=u.useState(!1),[y,x]=u.useState(!1),N=u.useRef(null);u.useEffect(()=>()=>{N.current&&window.clearTimeout(N.current)},[]);const E=q=>{const z=f.current;Object.keys(z).length&&(v(!0),In(a,z).then(F=>{if(!F){v(!1),o(e.actErr);return}if(F.throttled&&q<3){N.current=window.setTimeout(()=>E(q+1),5400);return}if(f.current={},b({}),l(F),v(!1),F.throttled){o(e.alertThrottled);return}x(!0),window.setTimeout(()=>x(!1),2e3),n(e.alertSaved)}))},k=q=>{r||(f.current={...f.current,...q},b(z=>({...z,...q})),N.current&&window.clearTimeout(N.current),N.current=window.setTimeout(()=>E(1),700))};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...p},L=q=>!j.sections||j.sections.includes(q),C=q=>{const z=j.sections||e.alertSec.map(([F])=>F);k({sections:L(q)?z.filter(F=>F!==q):[...z,q]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,z])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:L(q),disabled:r,onChange:()=>C(q)}),t.jsxs("span",{children:[z,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(En,{label:e.alertPreview,readOnly:r,onPreview:()=>Ei(a),onTest:()=>Si(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function wd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(0);u.useEffect(()=>{let m=!0;return c(!1),Bn(a).then(v=>{m&&(v?l(v):c(!0))}),()=>{m=!1}},[a,g]);const f=m=>{r||Bn(a,m).then(v=>{if(!v){o(e.actErr);return}l(v),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const p=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:m=>f({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(En,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>zi(a),onTest:()=>Ci(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function bo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=H(),[l,d]=u.useState(i||""),[c,g]=u.useState(!1),[s,f]=u.useState(!1);u.useEffect(()=>{i&&d(i)},[i]);const p=e.filters,b=u.useMemo(()=>n.filter(x=>Me(x)).length,[n]),m=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){f(!0);try{await fetch(`${mn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:p.sector,countries:p.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{f(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(x=>Ue(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(x=>It(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([x,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:x=>d(x.target.value),onKeyDown:x=>{x.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function kd(){const{t:e}=H();return t.jsx(Be,{title:e.alertTitle,icon:"🔔",children:t.jsx(bo,{})})}function jd(){var D,I;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:l,caps:d,dispatch:c,liveMemos:g}=H(),[s,f]=u.useState(()=>Oa(r)),[p,b]=u.useState(()=>!Oa(r)),[m,v]=u.useState([]),[y,x]=u.useState(0),N=n==="client",E=u.useMemo(()=>{const S=new Map;return o.forEach(M=>{const h=(M.name||"").trim().toLowerCase();h&&!S.has(h)&&S.set(h,M)}),S},[o]);u.useEffect(()=>{let S=!0;return(!Oa(r)||y>0)&&b(!0),(async()=>{const[M,h]=await Promise.all([xn(r,y>0),Tr(a)]);S&&(M&&f(M),b(!1),v(h))})(),()=>{S=!1}},[a,r,y]);const k=p&&!s,j=(s==null?void 0:s.per_day)??0,L=((D=s==null?void 0:s.analyzed_today)==null?void 0:D.length)??0,C=s==null?void 0:s.offre,q=(s==null?void 0:s.pool_meta)||[],z=u.useMemo(()=>{const S=new Map;for(const M of(s==null?void 0:s.scheduled)||[])for(const h of M.names||[])S.has(h)||S.set(h,{label:M.day_label,date:M.date});return S},[s==null?void 0:s.scheduled]),F=(s==null?void 0:s.in_progress)||[];return t.jsxs(Be,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(L,L+(((I=s==null?void 0:s.pool_order)==null?void 0:I.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(F.length>0||g.items.some(S=>S.status==="boot"||S.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(S=>S.status==="boot"||S.status==="running"||S.status==="error").map(S=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:S.name}),t.jsx("span",{className:"qd",children:S.memoType||""}),t.jsx(Qt,{item:S,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+S.name)),F.filter(S=>!g.liveOf(S.name)).map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.name}),t.jsxs("span",{className:"qd",children:[S.memo_type||"",S.age_min?` · ${Math.round(S.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:S.state||""})]},"ip-"+S.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.company}),t.jsxs("span",{className:"qd",children:[S.memo_type,typeof S.est_min=="number"?` · ~${S.est_min} min`:""]}),t.jsx("span",{className:"qt",children:S.status}),S.url&&t.jsx("a",{className:"qgo",href:S.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),N&&S.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Dn(a,S.company,"retry").then(()=>x(M=>M+1))},children:e.queueRetry}),N&&S.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Dn(a,S.company,"delete").then(()=>x(M=>M+1))},children:e.queueDelete})]},S.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((S,M)=>{const h=z.get(S.name),T=E.get((S.name||"").trim().toLowerCase()),B=g.liveOf(S.name),Y=!!(T&&l.has(T.id))||!!(B&&(B.status==="boot"||B.status==="running")),V=!!(T&&ze(T)===1&&!T.memoUrl)&&!B;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:S.name}),S.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof S.score=="number"&&t.jsx("span",{className:"qs2",children:S.score}),B&&(B.status==="boot"||B.status==="running")&&t.jsx(Qt,{item:B,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),V&&(d.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:Y,onClick:()=>{i(T),x(K=>K+1)},children:Y?e.actAnalyseQueued:e.actAnalyse})),S.excerpt&&t.jsx("span",{className:"qex",children:S.excerpt})]},S.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([S,M])=>t.jsxs("li",{children:[t.jsx("b",{children:S})," — ",M]},S))})]})}function Nd(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=H(),d=`${Rt}/cibles/list.csv?token=${a}`,c=`${Rt}/cibles/list.json?token=${a}`,g=`${Rt}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,f=y=>{var x;(x=navigator.clipboard)==null||x.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{dd(ld(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([x])=>x===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Be,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:x,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(x),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Sd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=H(),i=o!=="client",[l,d]=u.useState(null),[c,g]=u.useState(!1),[s,f]=u.useState(0),[p,b]=u.useState(!1);u.useEffect(()=>{let x=!0;return g(!1),Pn(a).then(N=>{x&&(N?d(N):g(!0))}),()=>{x=!1}},[a,s]);const m=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=x=>{if(i||!l)return;const N={enabled:x.enabled??!!l.enabled,email:x.email??(l.email||""),sections:x.sections??m()};b(!0),Pn(a,N).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}d(E),r(e.memoAlertSaved)})};if(c)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(x=>x+1),children:e.retry})]})});if(!l)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(Be,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||p,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Ed,{value:l.email||"",readOnly:i||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>v({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[x],disabled:i||p,onChange:()=>v({sections:{...y,[x]:!y[x]}})}),t.jsx("span",{children:N})]},x))}),t.jsx(En,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>bi(a,y),onTest:()=>gi(a,y)})]})}function Ed({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=u.useState(e);u.useEffect(()=>{l(e)},[e]);const d=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&d&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>o(i.trim()),children:n})]})]})}function Cd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=H(),[i,l]=u.useState(null),[d,c]=u.useState(!1),[g,s]=u.useState(null),[f,p]=u.useState(""),[b,m]=u.useState(0);u.useEffect(()=>{let E=!0;return c(!1),Ka(a).then(k=>{E&&(k?l({configured:k.configured,url_hint:k.url_hint}):c(!0))}),wi(a).then(k=>{E&&s(k)}),()=>{E=!1}},[a,b]);const v=(E,k)=>{o&&Ka(a,E).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}E.test&&j.sent===!1?n(e.plugTestThrottled):r(k),m(L=>L+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',x=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${Rt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Be,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!o,onChange:E=>p(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!f.trim(),onClick:()=>v({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:x}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(x).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(zd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function zd(){const{t:e,token:a,lang:r}=H(),[n,o]=u.useState("valides"),[i,l]=u.useState(!1),[d,c]=u.useState(null),[g,s]=u.useState(null),[f,p]=u.useState(!1),[b,m]=u.useState(!1),[v,y]=u.useState(null),[x,N]=u.useState(null),[E,k]=u.useState(null),j=`atl2:bulk:${a}:${n}`;u.useEffect(()=>{Ka(a).then(I=>{N(I&&I.configured?I.url_hint||"webhook":null)})},[a]),u.useEffect(()=>{c(null),s(null),p(!1),y(null);try{const I=JSON.parse(localStorage.getItem(j)||"null");k(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{k(null)}},[j]);const L=async()=>{l(!0),p(!1),y(null);const I=await ji(a,n);c(I),s(I.ok?n:null),l(!1)},C=u.useRef(!1),q=async()=>{if(C.current)return;C.current=!0,m(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let S;try{S=await Ni(a,n,"webhook",void 0,I)}finally{C.current=!1}if(m(!1),p(!1),y(S),S.ok&&(S.pushed||0)>0){const M={t:new Date().toISOString(),n:S.pushed||0};k(M);try{localStorage.setItem(j,JSON.stringify(M))}catch{}}},z=d!=null&&d.ok&&d.ready||0,F=!!(d!=null&&d.ok)&&g===n&&z>0&&!!x&&!E,D=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>o(I.target.value),children:e.plugBulkTabs.map(([I,S])=>t.jsx("option",{value:I,children:S},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{L()},children:i?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(D,E.n)}),!E&&!!(d!=null&&d.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),F&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),F&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{q()},children:b?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>p(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function Ad(){const{t:e,data:a,lang:r}=H(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const d=window.location.href.split("?")[0];try{const g=await(await fetch(`${mn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Be,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Td(){const{t:e}=H();return t.jsx(Be,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(ud,{})})}function qd(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:l,flash:d}=H(),[c,g]=u.useState(null),[s,f]=u.useState(!1);u.useEffect(()=>{let z=!0;if(i)return xn(i).then(F=>{z&&F&&typeof F.per_day=="number"&&g(F.per_day)}),()=>{z=!1}},[i]);const[p,b]=u.useState(null);u.useEffect(()=>{if(!o)return;let z=!0;return yi(o).then(F=>{z&&b(F)}),()=>{z=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(z=>z.kind==="target"&&Ie(z)).length,y=r.marketEstimate||0,x=y>0?Math.min(100,Math.round(v/y*100)):null,N=(m==null?void 0:m.window_days)||30,E=v>0?v/N:0,k=y>0?Math.max(0,y-v):0,L=y>0&&E>0&&v>=100?Math.round(k/E):null,C=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),q=z=>{s||!l||(f(!0),ki(o,z).then(F=>{if(f(!1),F===null){d(e.actErr);return}g(F),d(e.alertSaved)}))};return t.jsxs(Be,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(v))}),y>0&&t.jsx("span",{children:e.covOf(C(y))})]}),x!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:x+"%"}}),t.jsxs("em",{children:[x," %"]})]}),L!==null&&t.jsx("p",{className:"mnote",children:e.covEta(L)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(E))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((z,F)=>t.jsxs("tr",{className:z.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[z.code,z.geo?` · ${z.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof z.n=="number"?C(z.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:z.source}),z.elargi&&t.jsx("em",{children:e.covWide(String(z.demande||""))}),z.erreur&&t.jsx("em",{children:e.covMissing})]})]},F)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(p.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:c===z?"on":"",disabled:s,onClick:()=>q(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Ld(){var x,N,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:l,lang:d}=H(),c=n==="client",g=u.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[s,f]=u.useState(""),[p,b]=u.useState(""),[m,v]=u.useState(!1),y=async()=>{const k=s.trim();if(!(!k||m||!c)){v(!0),b("");try{const L=await(await fetch(`${Rt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(L.reply&&b(String(L.reply)),L.job_id){b(e.critChatRunning);const C=async()=>{const q=await fetch(`${Rt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:L.job_id})}).then(z=>z.json()).catch(()=>null);if(q&&q.done){b(String(q.reply||q.clarification||q.summary||"✓")),v(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),f("");return}f("")}finally{p.startsWith("⏳")||v(!1)}}};return t.jsxs(Be,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((x=i.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=i==null?void 0:i.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,L;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((L=k.out)!=null&&L.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},k.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||m,onChange:k=>f(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(vi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(xo[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Fd(){const{t:e,dispatch:a,startTour:r}=H(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Be,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const vo="atl2:mapfold",Rd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(vo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Md=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},yo=u.createContext(null),H=()=>{const e=u.useContext(yo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ct({o:e,lg:a}){const{lang:r}=H(),n=Me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:$n(n,r),children:[n.emoji," ",$n(n,r)]}):null}function Fa({o:e,src:a}){const{lang:r,t:n}=H(),o=Me(e);if(!o)return null;const i=Ri(o),l=Mi(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Rr(o,r))+" · "+n.win7(Mr(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Od(e,a,r){const n=(r||"").trim();if(n){const i=e.find(l=>(l.url||"")===n);if(i)return i}const o=Oe(a);if(o)return e.find(i=>Oe(i.name)===o)||e.find(i=>{const l=Oe(i.name);return l.length>=3&&(o.includes(l)||l.includes(o))})}function Pd(){const{scoped:e,t:a,st:r,dispatch:n}=H(),o=u.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,l=e.filter(f=>!Ze(f)),d=l.length,c=l.filter(f=>!f.noCo).length,g=l.filter(f=>!!f.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const f=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:f,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Dd(){const{t:e,lang:a,data:r,dispatch:n}=H(),o=r.stats,i=d=>d.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const l=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:l>0?e.covOf(i(l)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function wo({o:e}){const{lang:a}=H(),r=Fi(e.cc),n=e.cc?It(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Nr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Id=!1;function Bd(){const[e,a]=u.useState(!1);return u.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ko=e=>`atl2:tour:${e||"anon"}`;function $d(e){try{return localStorage.getItem(ko(e))==="1"}catch{return!0}}function Sr(e){try{localStorage.setItem(ko(e),"1")}catch{}}function _d(e,a,r,n,o){const i=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:i.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:i.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:i.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:i.live,body:e.fhintLive},{sel:".atl2 .goal",title:i.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:i.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:i.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:i.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:i.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:i.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:i.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:i.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:i.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:i.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:i.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:i.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:i.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Yd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var ne;const{lang:l}=Ai(),d=Yi[l],c=rs(e,l,a),[g,s]=u.useReducer(ss,void 0,()=>os((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Md():Rd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),f=u.useRef(!0);u.useEffect(()=>{if(f.current){f.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(vo,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),u.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const w=()=>{window.innerWidth<=760&&s({type:"mapFold",folded:!0})};return w(),window.addEventListener("resize",w),()=>window.removeEventListener("resize",w)},[a]);const p=u.useRef(i);p.current=i,u.useEffect(()=>{var w;(w=p.current)==null||w.call(p,g.filters)},[g.filters]);const[b,m]=u.useState(()=>{if(typeof window>"u")return"both";try{const w=localStorage.getItem("atl2:chrome-mode");if(w==="eval"||w==="filt"||w==="both")return w;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=u.useState(null),[x,N]=u.useState(null),[E,k]=u.useState(null),[j,L]=u.useState({kept:0,dropped:0}),[C,q]=u.useState(!1),[z,F]=u.useState(""),[D,I]=u.useState(!1),[S,M]=u.useState(null),[h,T]=u.useState(!1),[B,Y]=u.useState(!1),[,V]=u.useState(0),K=()=>V(w=>w+1),X=u.useRef([]),Q=u.useRef(new Set),ie=u.useRef(new Set),[ae,ce]=u.useState([]),[W,re]=u.useState([]),[ee,Le]=u.useState(0),je=u.useRef(new Map),oe=u.useRef(null),{mode:me}=c,se=u.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),G=se.pipe,Z=c.session.token||"",he=me==="client"&&!e;u.useEffect(()=>{if(!Z||!G)return;let w=!0;const P=async()=>{const te=await Oi(Z);!w||!te||(re(te.runs),Le(Date.now()/1e3-te.now),ce(Se=>Se.filter(Ee=>!te.runs.some(Xe=>Oe(Xe.company)===Oe(Ee.name)))))};P();const R=ae.length>0||W.some(te=>te.status==="running"),$=window.setInterval(()=>{P()},R?8e3:25e3);return()=>{w=!1,window.clearInterval($)}},[Z,G,ae.length,W.some(w=>w.status==="running")]);const le=u.useMemo(()=>{const w=[],P=new Set;for(const R of ae){const $=Oe(R.name);!$||P.has($)||(P.add($),w.push({name:R.name,id:R.id,status:"boot",started:R.started,estMin:R.estMin,memoType:"instant"}))}for(const R of W){const $=Oe(R.company);if(!$||P.has($))continue;P.add($);const te=R.status==="error"?"error":R.status==="done"?"done":"running";w.push({name:R.company,status:te,started:R.started||0,estMin:R.est_min||(R.memo_type==="detailed"?40:15),url:R.url,error:R.error,memoType:R.memo_type})}return w},[ae,W]),fe=w=>le.find(P=>Oe(P.name)===Oe(w))||null,ge=(w,P)=>{ce(R=>R.some($=>Oe($.name)===Oe(w.name))?R:[...R,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:P==="detailed"?40:15}]),Q.current.add(w.id),K()};u.useEffect(()=>{if(document.querySelector(`link[href="${Nr}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=Nr,document.head.appendChild(w)},[]);const be=(w,P=!1)=>{F(w),I(P),oe.current&&clearTimeout(oe.current),oe.current=setTimeout(()=>F(""),P?4200:2400)},qe=w=>be(w,!0),ve=u.useMemo(()=>{const w=new Map;return c.dossiers.forEach(P=>{P.id&&w.set(P.id,P)}),w},[c.dossiers]),Fe=u.useMemo(()=>c.dossiers.filter(w=>Dr(w,g,G)),[c.dossiers,g,G]),et=u.useRef(!1);u.useEffect(()=>{if(et.current||e||c.loading||!c.dossiers.length)return;if(!se.showFunnel||$d(c.session.token||"")){et.current=!0;return}et.current=!0;const w=window.setTimeout(()=>{Sr(c.session.token||""),T(!0)},700);return()=>window.clearTimeout(w)},[e,c.loading,c.dossiers.length,se.showFunnel,c.session.token]);const Ne=u.useMemo(()=>c.dossiers.filter(w=>ls(w,g,G,c.favIds)),[c.dossiers,g,G,c.favIds]),He=u.useMemo(()=>Ti(Fe,c.favIds),[Fe,c.favIds]),Re=u.useRef(!1);u.useEffect(()=>{if(Re.current)return;if(!G||a==="ops"){Re.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Re.current=!0;return}if(c.loading)return;Re.current=!0;const w=qi(He);w!==g.ptab&&s({type:"ptab",tab:w})},[G,a,n==null?void 0:n.ptab,c.loading,He,g.ptab]);const st=u.useMemo(()=>{const w=Hr(c.dossiers);return w?ct(w)===0?d.tourToday:Vr(w,l):d.tourNoRun},[c.dossiers,d,l]),pt=u.useMemo(()=>c.dossiers.some(w=>!!w.memoUrl||!!w.summary||Mt(w)),[c.dossiers]),[ft,tt]=u.useState(!1);u.useEffect(()=>{if(c.loading){tt(!1);return}if(c.dossiers.length>0||c.error){tt(!0);return}const w=window.setTimeout(()=>tt(!0),6e3);return()=>window.clearTimeout(w)},[c.loading,c.dossiers.length,c.error]);const xt=(c.marketEstimate||0)>0||typeof((ne=c.stats)==null?void 0:ne.screened)=="number"&&c.stats.screened>0,ht=u.useMemo(()=>[1,0,2,4,5,3].find(w=>(He[w]||0)>0)??0,[He]),Qe=hn.find(w=>w.key===g.continent),A=g.continent==="monde"?d.contWorld:(l==="fr"?Qe==null?void 0:Qe.fr:Qe==null?void 0:Qe.en)||"";u.useEffect(()=>{const w=P=>{var $;const R=((($=P.detail)==null?void 0:$.name)||"").trim();R&&U(null,R)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),u.useEffect(()=>{const w=P=>{const R=P.detail||{},$=String(R.id||"").trim(),te=String(R.name||"").trim(),Se=String(R.url||"").trim(),Ee=$&&ve.get($)||Od(c.dossiers,te,Se);if(Ee){if(N(null),G){const we=ze(Ee);typeof we=="number"&&we!==g.ptab&&s({type:"ptab",tab:we})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Ee.id}),(Ee.noCo||["media","nominations","recrutements"].includes(Ee.engine||""))&&(Ee.url||Ee.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee.url||"",text:[Ee.headline,Ee.tagline].filter(Boolean).join(`
`)}})):Ee.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ee.name,url:Ee.url||"",website:Ee.website||"",domain:Ee.domain||""}}));return}!te&&!Se||(s({type:"focus",id:$||null}),N({name:te,headline:String(R.text||"").trim()||te,url:Se,card:R.card}),Se&&(wa(te)||!te)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Se,text:String(R.text||"").trim()}})):te&&!wa(te)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:te}})))};return window.addEventListener("ppmap:focus",w),()=>window.removeEventListener("ppmap:focus",w)}),u.useEffect(()=>{const w=$=>{const te={},Se=String(($==null?void 0:$.sector)||"").trim();Se&&(te.sector=[Se]);const Ee=String(($==null?void 0:$.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ee)&&(te.day=Ee);const Xe=String(($==null?void 0:$.search)||"").trim();Xe&&(te.search=Xe);const we=String(($==null?void 0:$.dealKind)||"").trim();(we==="ma"||we==="levee"||we==="other")&&(te.dealKind=[we]),Object.keys(te).length&&s({type:"filters",patch:te})},P=$=>w($.detail),R=$=>{$.data&&$.data.type==="pp-filter"&&w($.data)};return window.addEventListener("ppmap:filter",P),window.addEventListener("message",R),()=>{window.removeEventListener("ppmap:filter",P),window.removeEventListener("message",R)}},[]),u.useEffect(()=>{const w=P=>{var te;const R=(((te=P.detail)==null?void 0:te.name)||"").trim().toLowerCase();if(!R)return;const $=c.dossiers.find(Se=>(Se.name||"").trim().toLowerCase()===R);$&&s(a==="ops"?{type:"focus",id:$.id}:{type:"popup",id:$.id})};return window.addEventListener("ppmap:similar",w),()=>window.removeEventListener("ppmap:similar",w)});const U=(w,P)=>{const R=((w==null?void 0:w.name)||P||"").trim();if(!he){k({kicker:R});return}!R||C||(q(!0),(async()=>{try{let $=R;const te=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(te)$=te;else try{const we=await Lr(R);if(we!=null&&we.website)$=we.website;else if(((we==null?void 0:we.candidates)||[]).length===1)$=we.candidates[0].url;else if(((we==null?void 0:we.candidates)||[]).length>1){X.current=[{name:R,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(we.candidates||[]).slice(0,5)},...X.current].slice(0,8),K();return}}catch{}const Se=await Fr(Z,$,"atelier2"),Ee={name:Se.company||R,verdict:Se.verdict,reason:Se.reason||"",remaining:Se.remaining??null};X.current=[Ee,...X.current].slice(0,8),Se.verdict==="kept"&&L(we=>({...we,kept:we.kept+1})),Se.verdict==="ruled_out"&&L(we=>({...we,dropped:we.dropped+1}));const Xe=w||c.dossiers.find(we=>(we.name||"").toLowerCase()===R.toLowerCase());Xe&&(Se.verdict==="kept"?Xe.verdict=Xe.verdict||"MATCH":Se.verdict==="ruled_out"&&(Xe.verdict="NO MATCH"),Se.reason&&(Xe.reasoning=Se.reason)),K()}finally{q(!1)}})())},_=w=>{if(!he){k({kicker:w.name});return}ge(w,"instant"),Ut(Z,"fast_request",w.name||"",""),be(d.memoInstantSent(w.name))},pe=w=>je.current.get(w.id)??c.thumbs.get((w.name||"").trim().toLowerCase()),xe=(w,P)=>s({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:P}}),de=async(w,P,R)=>{const $=w.ceoStatus||"";w.ceoStatus=P,K();const te=await Pa(Z,{status:P,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(R==null?void 0:R.note)!==void 0?{note:R.note}:{},...R!=null&&R.via?{via:R.via}:{}});return te.ok?te.skipped?(w.ceoStatus=$,K(),qe(d.actNotPersisted),!1):((R==null?void 0:R.undo)!==!1&&xe(w,$),R!=null&&R.msg&&be(R.msg),(P==="Validé"||P==="Écarté")&&!w.ceoNote&&(R==null?void 0:R.note)===void 0&&M({o:w,yes:P==="Validé"}),!0):(w.ceoStatus=$,K(),qe(d.actErr),!1)},ye=async(w,P)=>{const R=await Pa(Z,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:P,via:"note"});return!R.ok||R.skipped?(qe(R.skipped?d.actNotPersisted:d.actErr),!1):(w.ceoNote=P,K(),!0)},$e=u.useRef(new Map),At=w=>$e.current.has(w.id)?$e.current.get(w.id):c.stages.get((w.name||"").trim().toLowerCase()),gt=(w,P)=>{$e.current.set(w.id,P),K()},Tt=(w,P)=>{he&&de(w,P?"Validé":"Écarté",{msg:P?d.decidedYes(w.name):d.decidedNo(w.name)})},ut=w=>{he&&de(w,"À trancher",{msg:d.promoted(w.name)})},qt=w=>{he&&(async()=>{const P=w.ceoStatus||"";w.ceoStatus="Retenu",K();const R=await Pa(Z,{status:"Retenu",check_id:w.checkId,company:w.name});if(!R.ok||R.skipped){w.ceoStatus=P,K(),qe(R.skipped?d.actNotPersisted:d.actErr);return}xe(w,P),be(d.repeched(w.name))})()},Ve=()=>{const w=g.undo[g.undo.length-1];if(!w){be(d.undoNone);return}const P=ve.get(w.id);if(!P){s({type:"undoPop"}),be(d.undoNone);return}let R=w.prevCeoStatus;if(!R)if((P.verdict||"").toUpperCase().includes("CALL"))R="À trancher";else{be(d.undoLockedTitle);return}(async()=>await de(P,R,{undo:!1})&&(s({type:"undoPop"}),P.ceoStatus=w.prevCeoStatus,K(),be(d.undoDone(P.name))))()},De=w=>{he&&(ie.current.add(w.id),K(),(async()=>{const P=await Pi(Z,w.name,"email");if(!P||P.ok===!1){ie.current.delete(w.id),K(),qe(d.actErr);return}Ut(Z,"approach",w.name||"",""),be(d.actApproachSent)})())},bt=(w,P)=>{he&&(async()=>{if(!(await Ut(Z,P?"yes":"no",w.name||"","")).ok){qe(d.actErr);return}je.current.set(w.id,P?"yes":"no"),K(),be(P?d.thumbUpDone:d.thumbDnDone)})()},Je=w=>{!he||!Mt(w)||(ge(w,"detailed"),Ut(Z,"detailed_request",w.name||"",""),be(d.memoDeepSent(w.name)))},$t=w=>{const P=new Set(c.favIds),R=P.has(w.id);R?P.delete(w.id):P.add(w.id),c.setFavIds(P),he&&Di(Z,{id:w.id,co:w.name},R)},_t=()=>{!he||B||window.confirm(d.identSyncConfirm)&&(Y(!0),(async()=>{const w=await Ii(Z);Y(!1),w?be(d.identSyncDone):qe(d.actErr)})())},ra=/proplace/i.test(c.fund||""),Ra=w=>{!he||!ra||(Ut(Z,"onboard_request",w.name||"",""),be(d.onboardSent(w.name)))},O={st:g,dispatch:s,t:d,lang:l,mode:me,caps:se,pipe:G,token:Z,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:qt,thumbOf:pe,canWrite:he,commitStatus:de,saveNote:ye,stageOf:At,setStage:gt,flashErr:qe,startTour:()=>T(!0),dossiers:c.dossiers,scopedAll:Fe,scoped:Ne,counts:He,byId:ve,contName:A,favIds:c.favIds,toggleFav:$t,askEvaluate:U,doAnalyse:_,doDecide:Tt,doPromote:ut,doApproach:De,doThumb:bt,doDeep:Je,doUndo:Ve,doSync:_t,doOnboard:Ra,outbound:ra,memoQueued:Q.current,liveMemos:{items:le,serverOff:ee,liveOf:fe},approachDone:ie.current,sessTally:j,evalCards:X.current,evalBusy:C,markRow:y,markedId:v,flash:be,focusExtra:x};u.useEffect(()=>{const w=P=>{P.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const J=w=>Z?t.jsx(cs,{token:Z,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(yo.Provider,{value:O,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(Z?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Qi}),J(t.jsxs("div",{className:"app"+(G?" pipe":"")+(Z?" has-thesis":""),children:[se.showTicker&&t.jsx(at,{name:"live",children:t.jsxs("div",{className:"live-stack"+(Z?" live-stack--cibles":""),children:[t.jsx(hs,{}),!!Z&&t.jsx(ps,{})]})}),se.showIdent&&t.jsx(at,{name:"identite",children:t.jsx(zs,{})}),!1,Id,se.showFunnel&&t.jsx(at,{name:"entonnoir",children:t.jsx(Ud,{})}),!g.mapFolded&&t.jsx(at,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(uo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Pd,{}),a!=="ops"&&se.showFunnel&&t.jsx(Dd,{}),t.jsx(El,{}),t.jsx(po,{})]})]})}),se.showDemand&&G&&t.jsx(at,{name:"direct",children:t.jsx(Hi,{items:le,serverOff:ee,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":d.chromeBoth,children:[["eval",d.chromeEval],["filt",d.chromeFilt],["both",d.chromeBoth]].map(([w,P])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===w,onClick:()=>{m(w);try{localStorage.setItem("atl2:chrome-mode",w)}catch{}},children:P},w))}),se.showDemand&&t.jsx(at,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Fl,{})})}),se.showDemand&&g.memoConsole&&t.jsx(at,{name:"console",children:t.jsx(Ml,{})}),t.jsx(at,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(id,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(at,{name:"fiche",children:t.jsx(Ul,{})}),t.jsx(at,{name:"modales",children:t.jsx(fd,{})}),t.jsx(vs,{}),S&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:S.o.name}),t.jsx(Ns,{placeholder:S.yes?d.whyYesPh:d.whyNoPh,onDone:w=>{const P=S.o;M(null),w&&ye(P,w).then(R=>{R&&be(d.csNoteSaved)})}})]}),h&&ft&&t.jsx(Es,{steps:_d(d,st,pt,ht,xt),onClose:()=>{T(!1),Sr(Z)}}),t.jsx(Bd,{}),se.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:_r,children:vn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),z&&t.jsx("div",{className:"flash on"+(D?" err":""),children:z}),E&&t.jsx(Li,{variant:"acquirer",initialCompany:Er().co,initialWebsite:Er().site,onClose:()=>k(null)})]})})}function Ud(){const{t:e}=H(),[a,r]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Er(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Hd(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{wo as FlagCell,Ct as SigBadge,Fa as SigWin,Yd as default,Hd as fmtShort,H as useV2};
