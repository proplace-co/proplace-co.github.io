...
`,Hl=_l+Bl+$l+Ul;function Cn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Vl(){const e=Cn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Wl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Vl();return r==="0"?"client":r==="1"||Cn("embed")==="1"&&Cn("chrome")==="1"?"apercu":"client"}const Gl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Yl=e=>Gl[e];function Kt(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||/\?$/.test(a)||/^(this|that|these|those|why|what|what'?s|how|when|where|who|which|is|are|do|does|did|can)\b/i.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Dt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!tn(a)||Kt(a))&&(e.noCo=!0)}return Object.assign(e,{continent:ps(e.cc)})};function pn(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ql=60*60*1e3;function Kl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ql?null:a}catch{return null}}function ja(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Jl=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Xl(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:Zi(),[e,n]),i=p.useMemo(()=>n?"visiteur":Wl(e,o),[e,o,n]),d=p.useMemo(()=>Yl(i),[i]),l=i!=="visiteur",s=Jl(r),[h,c]=p.useState([]),[g,u]=p.useState(""),[b,m]=p.useState(null),[y,w]=p.useState(null),[f,v]=p.useState(null),[E,k]=p.useState(()=>new Map),[j,S]=p.useState(()=>new Map),[A,L]=p.useState(""),[F,O]=p.useState(new Set),[M,V]=p.useState(null),[Q,R]=p.useState(!0),[x,q]=p.useState(!1),[C,P]=p.useState(0),[H,G]=p.useState(0),Z=p.useRef(0),z=p.useMemo(()=>{var D;if(i!=="client")return"";try{return((D=es())==null?void 0:D.email)||""}catch{return""}},[i]);p.useEffect(()=>{const D=++Z.current;let X=!0;const U=()=>X&&D===Z.current,ee=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),ue=Kl(ee);return ue?(c(ue.objs.map(Dt)),ue.fund&&u(ue.fund),m(ue.marketEstimate??null),w(ue.criteria??null),v(ue.stats??null),L(ue.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const fe=await on(),ve=((fe==null?void 0:fe.recent_ops)||[]).map(me=>{const we=Oa(me.company_name||me.title?me:{...me,title:(me.headline_fr||me.headline||"").slice(0,120)},a),ze=String(me.rubrique||"").toLowerCase();return we&&(ze==="nominations"||ze==="recrutements")&&(we.engine=ze),we&&!String(me.company_name||"").trim()&&(we.noCo=!0),we}).filter(me=>!!me).map(me=>(tn((me.name||"").trim())||(me.noCo=!0),me));try{const me=ts(),we=await as(),ze=((we==null?void 0:we.date)||"").slice(0,10),he=me?me.doc:we,ke=ns(he),ge=((me==null?void 0:me.day)||(he==null?void 0:he.date)||ze||"").slice(0,10);if(ge&&ke.length){const ie=new Set;for(const I of ve){if((I.date||"").slice(0,10)!==ge)continue;const ae=ur(ke,ie,I.name,"");ae>=0&&(ie.add(ae),I.decryptHtml=ke[ae].html)}for(const I of ve){if(I.decryptHtml||(I.date||"").slice(0,10)!==ge)continue;const ae=ur(ke,ie,"",I.headline||I.tagline||I.name);ae>=0&&(ie.add(ae),I.decryptHtml=ke[ae].html)}}if(ge){const ie=((he==null?void 0:he.title_fr)||"").trim(),I=((he==null?void 0:he.lead_fr)||"").trim(),ae=rs(he),pe=((he==null?void 0:he.url)||"").trim();ie&&(ae||pe)&&ve.unshift({id:`edito:${ge}`,kind:"op",name:ie,cc:null,date:ge,engine:"edito",dealKind:"other",headline:ie,tagline:I||ie,decryptHtml:ae||void 0,url:pe,noCo:!0})}}catch{}if(!U())return;c(ve.map(Dt)),ja(ee,{objs:ve})}else if(typeof r=="object"){const ve=(await mr()||[]).filter(we=>(we.slug||"")===r.research).map(we=>fr(we,a)).filter(we=>!!we),me=pn(await hr(ve,a));if(!U())return;c(me.map(Dt)),ja(ee,{objs:me})}else if(l&&o.token){const fe=os(o.token),ve=on(),me=is(o.token),we=ss(o.token),ze=ls(o.token),he=await fe;let ke=he?he.targets:[];U()&&he&&(u(he.fund||""),m(he.marketEstimate??null),w(he.criteria??null),v(he.stats??null),L(he.generatedAt||""),c(ke.map(Dt)),R(!1),q(!1));const[ge,ie,I,ae]=await Promise.all([ve,me,we,ze]),pe=((ge==null?void 0:ge.recent_ops)||[]).map(te=>Oa(te,a)).filter(te=>!!te),se=new Set(ke.map(te=>te.id));if(ke=[...ke,...pe.filter(te=>!se.has(te.id)&&(se.add(te.id),!0))],!U())return;c(ke.map(Dt));const ne=new Set;for(const te of ie){const de=(te.id||te.co||"").toString().trim().toLowerCase();de&&ne.add(de.startsWith("t:")?de:"t:"+de)}O(ne),k(I),S(ae),he&&ja(ee,{fund:he.fund,marketEstimate:he.marketEstimate,criteria:he.criteria,stats:he.stats,generatedAt:he.generatedAt,objs:ke})}else{const fe=ds(),ve=mr(),me=on(),we=await fe;U()&&we.length&&(c(pn(we).map(Dt)),R(!1),q(!1));const[ze,he]=await Promise.all([ve,me]),ke=(ze||[]).map(ae=>fr(ae,a)).filter(ae=>!!ae),ge=await hr(ke,a),ie=((he==null?void 0:he.recent_ops)||[]).map(ae=>Oa(ae,a)).filter(ae=>!!ae),I=pn([...we,...ge,...ie]);if(!U())return;c(I.map(Dt)),ja(ee,{objs:I})}U()&&q(!1)}catch{U()&&!ue&&q(!0)}finally{U()&&R(!1)}})(),()=>{X=!1}},[l,o.token,a,C,s]),p.useEffect(()=>{if(!d.showCredits||!z){V(null);return}let D=!0;return(async()=>{try{const X=await fetch(`${ya}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:z})});if(!X.ok)return;const U=await X.json();D&&U&&U.ok!==!1&&V(U)}catch{}})(),()=>{D=!1}},[d.showCredits,z,H]);const $=p.useCallback(D=>O(new Set(D)),[]);return{session:o,mode:i,caps:d,fund:g,email:z,marketEstimate:b,generatedAt:A,criteria:y,thesisMode:String((y==null?void 0:y.mode)||""),stats:f,thumbs:E,stages:j,dossiers:h,patchStatuses:(D,X)=>{c(U=>{let ee=!1;const ue=U.map(fe=>{if(!fe.checkId)return fe;const ve=D.get(fe.checkId);return!ve||ve===(fe.ceoStatus||"")||!X(fe.id)?fe:(ee=!0,{...fe,ceoStatus:ve})});return ee?ue:U})},favIds:F,setFavIds:$,credits:M,reloadCredits:()=>G(D=>D+1),loading:Q,error:x,refresh:()=>P(D=>D+1)}}function He(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Ma=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ha(e){return Ma.has(e.engine||"")}function tt(e){return!!e.noCo||Ha(e)&&!!e.url}const Jo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Zl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Jo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),ed=new Set(["signal","amount","score","crible","memo"]);function td(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Jo(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ed.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Xo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Xo=80;function Va(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!$e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Yn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(gt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&It(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(Fo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function Pt(e,a,r){return He(e)?Va(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Va(e,a.filters,r)}function ad(e,a,r,n){return!(!Pt(e,a,r)||r&&!Lo(e,a.ptab,n))}function Wa(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-gt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return us(o)||null;case"memo":return cs(o)||null;case"signal":{const i=$e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const cn={},Rr=(cn==null?void 0:cn.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Or(){return new Date().toISOString().slice(0,10)}const Zn=p.createContext(null);function Zo(){return p.useContext(Zn)}function nd(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const h=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(c=>s.removeAttribute(c.name)),h&&/^https?:\/\//i.test(h)&&(s.setAttribute("href",h),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function ei(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function rd(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),ei(r),r.innerHTML):e}catch{return e}}function Mr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),ei(r),r.innerHTML):e}catch{return e}}function Dr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function ti(){const e=p.useContext(Zn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function od({token:e,children:a}){const{dispatch:r,st:n,lang:o}=K(),[i,d]=p.useState(()=>n.filters.day||Or()),[l,s]=p.useState(null),[h,c]=p.useState(!1),g=p.useCallback(y=>{if(/^\d{4}-\d{2}-\d{2}$/.test(y)){d(y);try{r({type:"filters",patch:{day:y,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{d(Or());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const y=w=>{var v;const f=(v=w.detail)==null?void 0:v.day;typeof f=="string"&&g(f)};return window.addEventListener("pp-edition-day",y),()=>window.removeEventListener("pp-edition-day",y)},[g]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let y=!1;c(!0);const w=new URLSearchParams({token:e,date:i});return fetch(`${Rr}/cibles/edition.json?${w}`).then(f=>f.json()).then(f=>{y||s(f)}).catch(()=>{y||s({ok:!1,error:"network"})}).finally(()=>{y||c(!1)}),()=>{y=!0}},[e,i]);const b=p.useMemo(()=>`${Rr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:l,loading:h,pickDay:g,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,h,g,u,n.filters.day,b,o]);return t.jsx(Zn.Provider,{value:m,children:a})}function id(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=ti(),[o,i]=p.useState(()=>n||Ro());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(_a,d),()=>window.removeEventListener(_a,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(ms,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function sd(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Ir(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Pr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function ld(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=ti(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,h=p.useRef(null),[c,g]=p.useState("fonds"),[u,b]=p.useState(null),[m,y]=p.useState("idle"),w=p.useRef(!1);p.useEffect(()=>{b(null),y("idle"),w.current=!1,g("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||w.current)return;w.current=!0;let j=!0;return y("load"),sd(e).then(S=>{j&&(b(S),y("fait"))}),()=>{j=!1}},[c,e]);const f=p.useMemo(()=>rd((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),v=p.useRef(null);p.useEffect(()=>{const j=v.current;if(!j||!f)return;let S=!1;return Nn(()=>Promise.resolve().then(()=>Gn),void 0).then(async A=>{await A.ensureEditoCss(),!(S||!j.isConnected)&&(A.beautifyEditoRows(j),A.mountCardFits(j))}),()=>{S=!0}},[f]);const E=p.useMemo(()=>Mr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>Mr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const j=h.current;if(!j||!E)return;let S=!1;return Nn(()=>Promise.resolve().then(()=>Gn),void 0).then(async A=>{await A.ensureEditoCss(),!(S||!j.isConnected)&&(A.beautifyEditoRows(j),A.mountCardFits(j))}),()=>{S=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,S=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return S?i?`${S[2]}/${S[3]}/${S[1]}`:`${S[3]}/${S[2]}/${S[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>g("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>g("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Ir(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Dr(e,!0)}),"."]}):Ir(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Dr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>g("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&E?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:u.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Pr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Pr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const dd=300,Na=7,pd={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},ai={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},cd=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Sa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(xs(r)&&r!=="media")return"news:"+r;const n=$e(e);return n?"sig:"+(n.theme&&ai.fr[n.theme]?n.theme:"other"):"actualites"}function ud(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=K(),s=Zo(),h=d==="en",[c,g]=p.useState("all"),[u,b]=p.useState(!1),m=p.useMemo(()=>{var X;const x=(a.filters.day||"").slice(0,10),q=U=>!(!i&&a.continent!=="monde"&&U.continent!==a.continent||x&&(U.date||"").slice(0,10)!==x),C=e.filter(U=>q(U)&&$e(U)&&(!i||U.kind!=="target"||Te(U)!==5)),P=i&&(((X=s==null?void 0:s.ed)==null?void 0:X.ops)||[]).length?s.ed.ops.map(U=>Oa(U,d)).filter(U=>!!U).map(U=>(U.briefOnly=!0,U)).filter(U=>!x||(U.date||"").slice(0,10)===x):[],H=e.filter(U=>q(U)&&U.kind==="op"&&(x?!0:gt(U.date)<=Na)),G=i?P.length?P:H.filter(U=>{const ee=(l||"").trim().toLowerCase();if(!ee)return!1;const ue=U.match||null;return ue?Object.keys(ue).map(fe=>fe.trim().toLowerCase()).includes(ee):!1}):H,Z=x||new Date().toISOString().slice(0,10),z=U=>{const ee=Sa(U);return ee==="ma"?0:ee==="levees"?1:2};G.sort((U,ee)=>{const ue=z(U)-z(ee);if(ue)return ue;const fe=(U.date||"").slice(0,10)===Z?0:1,ve=(ee.date||"").slice(0,10)===Z?0:1;return fe!==ve?fe-ve:(ee.amountEur||0)-(U.amountEur||0)});const $=new Set,D=[];for(const U of[...G,...Wa(C,{key:"signal",dir:-1})]){const ee=U.id||U.name;!ee||$.has(ee)||($.add(ee),D.push(U))}return i&&D.length===0?e.filter(ee=>q(ee)&&gt(ee.date)<=Na).sort((ee,ue)=>(ue.date||"").localeCompare(ee.date||"")).slice(0,80):D},[e,a.continent,a.filters.day,i,l,d,s]),y=p.useMemo(()=>{const x={};for(const q of m){const C=Sa(q);x[C]=(x[C]||0)+1}return x},[m]),w=p.useMemo(()=>c==="all"?m:m.filter(x=>Sa(x)===c),[m,c]),f=p.useMemo(()=>w.slice(0,dd),[w]),v=w.length-f.length,E=p.useRef(null);p.useEffect(()=>{var G,Z;const x=E.current;if(!x)return;const q=()=>{const z=x.scrollWidth;z<200||(x.style.animationDuration=Math.max(18,Math.round(z/130))+"s")};q();const C=requestAnimationFrame(q),P=window.setTimeout(q,1200);let H=!0;return(Z=(G=document.fonts)==null?void 0:G.ready)==null||Z.then(()=>{H&&q()}),()=>{H=!1,cancelAnimationFrame(C),window.clearTimeout(P)}},[f.length,c]);const k=x=>x==="all"?m.length:y[x]||0,j=x=>{if(x==="all")return h?"All":"Tout";if(x.startsWith("sig:"))return ai[h?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const q=x.slice(5);return hs[q]?gs(q,h?"en":"fr"):x}return pd[h?"en":"fr"][x]},S=[{k:"all"}],A=["ma","levees"].filter(x=>k(x)>0||x===c);if(A.length){S.push({g:h?"Deals":"Opérations"});for(const x of A)S.push({k:x})}const L=["nominations","recrutements"].filter(x=>k(x)>0||x===c),F=fs.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===c),O=k("actualites")>0||c==="actualites"?["actualites"]:[];if(L.length||F.length||O.length){S.push({g:h?"News":"Actualités"});for(const x of L)S.push({k:x});for(const x of F)S.push({k:x});for(const x of O)S.push({k:x})}const M=cd.map(x=>"sig:"+x).filter(x=>k(x)>0||x===c);if(M.length){S.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of M)S.push({k:x})}const V=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},Q=(()=>{const x=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(h?`LIVE covers the events of ${V(x)}.`:`Le LIVE regroupe les événements du ${V(x)}.`)+q:(h?`LIVE covers the still-open signals and the deals of the last ${Na} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Na} derniers jours.`)+q})(),R=x=>f.map(q=>t.jsxs("button",{type:"button",className:"tk"+(We(q)?" spent":""),onClick:C=>{const P=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:P?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(P||n({type:"focus",id:q.id}),a.dens!=="liste"){const H=C.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:H.left+H.width/2,y:H.bottom}})}},title:We(q)?h?`${q.name} — already screened (dimmed)`:`${q.name} — déjà évaluée (grisée)`:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(Tt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx($i,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),(()=>{const C=(q.tagline||q.headline||"").trim();if(C&&C!==q.name)return t.jsx("span",{className:"what",children:C});const P=Sa(q),H=P==="ma"?h?"M&A deal":"opération M&A":P==="levees"?h?"fundraising":"levée de fonds":P==="nominations"?h?"appointment":"nomination":P==="recrutements"?h?"hiring":"recrutement":P.startsWith("sig:")?h?"engine signal":"signal moteur":P.startsWith("news:")?h?"news":"actualité":q.kind==="target"?h?"sourced target":"cible sourcée":h?"news item":"actualité";return t.jsx("span",{className:"what dim",children:H})})(),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:ju(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(nn,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(q.id||q.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(x=>!x),children:[j(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:Q}),S.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===c,onClick:()=>{g(x.k),b(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:E,children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(fd,{isEn:h})]})}const md=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function fd({isEn:e}){const[a,r]=p.useState(()=>Ro());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(_a,o),()=>window.removeEventListener(_a,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>bs(!a),children:md})}class ft extends p.Component{constructor(){super(...arguments);dr(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ni=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function _r(e,a){if((Lt(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return ni.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Br=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",hd={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function gd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=K(),[l,s]=p.useState(""),[h,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!g)return;const v=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),c(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[g]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),y=async v=>{if(l)return;if(v==="Analysé"&&!e.memoUrl){c(!0);return}s(v);const E=(_r(e,a).find(([j])=>j===v)||[v,v])[1],k=await o(e,v,{msg:a.csMoved(e.name,E)});s(""),k&&(c(!1),u(!1))},w=_r(e,a),f=v=>(w.find(([E])=>E===v)||[])[1]||v;return w.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:w.map(([v,E])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(l===v?" busy":""),disabled:!!l,onClick:()=>{y(v)},children:E},v))}):t.jsxs("span",{className:"rstat"+(g||h?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":g,disabled:!!l,title:a.csLabel,className:"rsel rs-"+Br(m),onClick:()=>{u(v=>!v),c(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),g&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:w.map(([v,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===v,className:"rsopt"+(m===v?" on":"")+(l===v?" busy":""),disabled:!!l,onClick:()=>{if(v===m){u(!1);return}y(v)},children:[t.jsx("i",{className:"pt2",style:{background:hd[Br(v)]}}),E]},v))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const v=await o(e,"Analysé");s(""),v&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function xd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=K(),[i,d]=p.useState(""),[l,s]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),c=(Lt(e)||"").startsWith("CALL")&&Te(e)===3,g=Te(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const y=await o(e,m);d(""),y&&(s(!0),setTimeout(()=>s(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:ni.filter(([m])=>!(g&&m==="Retenu")).map(([m,y])=>[m,a[y]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,y])=>t.jsx("button",{type:"button",className:"csb"+(h===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:y},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(bd,{o:e})]})}function bd({o:e}){const{t:a,saveNote:r,flash:n}=K(),[o,i]=p.useState(e.ceoNote||""),[d,l]=p.useState(!1),[s,h]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),g=async()=>{if(d||!c)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&g()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{g()},children:s?a.csNoteSaved:a.csNoteOk})]})}function $r({placeholder:e,onDone:a}){const{t:r}=K(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function vd({o:e}){var w;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=K(),[s,h]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const c=i(e),g=(c==null?void 0:c.stage)||"todo",u=async f=>{if(s||f===g)return;h(!0);const v=c;d(e,{stage:f,stamps:(c==null?void 0:c.stamps)||{}});const E=Math.max(Date.now(),Ur+=1);Ur=E;const k=await vs(r,{company:e.name||"",stage:f,cts:E,deal_id:e.airtableId,check_id:e.checkId});h(!1),!k.stale&&(k.ok||(d(e,v),l(a.actErr)))},b=(w=c==null?void 0:c.stamps)==null?void 0:w.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,y=g==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,v])=>t.jsx("button",{type:"button",className:"stgb"+(g===f?" on":""),disabled:s,onClick:()=>{u(f)},children:v},f)),y&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let Ur=0;const ra=8,Ct=360;function Hr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Vr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Hr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Hr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function wd({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=K(),[d,l]=p.useState(0),[s,h]=p.useState(null),[c,g]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const A=b.current;return()=>{m.current||(n({type:"ptab",tab:A.ptab}),n({type:"dens",dens:A.dens}),n({type:"modal",modal:A.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,g(e.filter(A=>!!document.querySelector(A.need||A.sel))))},[e]);const y=c[d],w=d>=c.length;p.useEffect(()=>{if(y&&(y.ptab!==void 0&&i.ptab!==y.ptab&&n({type:"ptab",tab:y.ptab}),y.dens&&i.dens!==y.dens&&n({type:"dens",dens:y.dens}),i.modal!==(y.modal??null)&&n({type:"modal",modal:y.modal??null}),y.click)){const A=y.click,L=window.setTimeout(()=>{const F=document.querySelector(A);F&&F.getAttribute("aria-selected")!=="true"&&F.click()},60);return()=>window.clearTimeout(L)}},[d,y]);const f=p.useRef(-1),v=p.useCallback(()=>{if(!y){h(null);return}const A=O=>{if(!O)return null;for(const M of document.querySelectorAll(O)){const V=M.getBoundingClientRect();if(V.width>1&&V.height>1)return M}return null},L=A(y.sel)||A(y.need);if(!L){h(null);return}f.current!==d&&(f.current=d,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const F=L.getBoundingClientRect();h(O=>O&&Math.abs(O.top-F.top)<1&&Math.abs(O.left-F.left)<1&&Math.abs(O.width-F.width)<1&&Math.abs(O.height-F.height)<1?O:F)},[y,d]);p.useLayoutEffect(()=>{v();const A=[90,300,700,1300].map(O=>window.setTimeout(v,O)),L=window.setInterval(v,400),F=()=>v();return window.addEventListener("scroll",F,!0),window.addEventListener("resize",F),()=>{A.forEach(O=>window.clearTimeout(O)),window.clearInterval(L),window.removeEventListener("scroll",F,!0),window.removeEventListener("resize",F)}},[v]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const A=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),E.current()):L.key==="ArrowRight"?l(F=>F+1):L.key==="ArrowLeft"&&l(F=>Math.max(0,F-1))};return document.addEventListener("keydown",A,!0),()=>document.removeEventListener("keydown",A,!0)},[]),!c.length)return null;let k=null;const j=A=>()=>{m.current=!0,n({type:"modal",modal:null}),A()};if(w){const A=o[3]||0;A>0?k={title:A===1?r.ahaATitle1:r.ahaATitleN(A),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let S={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Ct};if(!w&&s){const A=s.bottom+14,L=window.innerHeight-A;let F=L>190?A:Math.max(12,s.top-200),O=Math.min(Math.max(12,s.left+s.width/2-Ct/2),window.innerWidth-Ct-12);L<=190&&s.top<212&&(window.innerWidth-s.right>=Ct+40?O=Math.min(s.right+26,window.innerWidth-Ct-12):s.left>=Ct+40&&(O=Math.max(12,s.left-Ct-26)),F=Math.max(12,s.top-ra)),S={left:O,top:F,width:Ct}}return ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!w&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-ra,top:s.top-ra,width:s.width+ra*2,height:s.height+ra*2}}),(w||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(w?" fin":""),style:S,children:[w&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Vr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:y==null?void 0:y.title}),t.jsx(Vr,{text:(y==null?void 0:y.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(A=>Math.max(0,A-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(A=>A+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function ri(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function oi(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function yd(){var L,F;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=K(),h=r?a:e,c=p.useMemo(()=>h.filter(O=>gt(O.date)===0&&O.kind==="target"),[h]),g=p.useMemo(()=>r?a.filter(O=>O.kind==="target"&&Te(O)===0).slice().sort((O,M)=>(M.date||"").localeCompare(O.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(O=>r?Te(O)===0:!We(O)),[c,r]),b=r?g:u,m=r?a.length-g.length:c.length-u.length,y=r?a.length:c.length,w=y?Math.min(100,m/y*100):100,f=p.useMemo(()=>ri(h),[h]),v=!!f&&gt(f)>0,E=p.useMemo(()=>v?h.filter(O=>(O.date||"").slice(0,10)===f):[],[h,f,v]),k=typeof((L=l.stats)==null?void 0:L.kept_today)=="number"?l.stats.kept_today:null,j=typeof((F=l.stats)==null?void 0:F.screened_today)=="number"?l.stats.screened_today:c.length;let S;v?S=o.morningLast(E.length,g.length,oi(f,d)):r?S=o.morningThesis(j,g.length,k):c.length?m===0?S=o.goalSourced(c.length):m>=c.length?S=o.goalCleared:S=o.goalDone(m,c.length):S=o.goalSourced(0);const A=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&g.length&&s({type:"chainStart",queue:g.map(O=>O.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:S}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:w+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:A,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function kd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:l}=K(),s=i==="client",[h,c]=p.useState(!1),[g,u]=p.useState(""),b=()=>{!s||h||!n||(c(!0),u(""),ws(n).then(w=>{if(c(!1),w.pending){u(e.refreshSlow);return}if(!w.ok){w.error&&console.warn("[republish]",w.error),u(e.refreshKo);return}const f=w.entered??0,v=w.left??0;u(w.unchanged||!f&&!v?e.refreshSame:e.refreshDone(f,v)),o.refresh()}))},m=(n||"P").split(/\s+/).map(w=>w[0]).join("").slice(0,2).toUpperCase(),y=(()=>{const w=Date.parse(o.generatedAt||"");if(Number.isNaN(w))return"";const f=new Date(w),v=E=>String(E).padStart(2,"0");return`${v(f.getDate())}/${v(f.getMonth()+1)} à ${v(f.getHours())}:${v(f.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?m:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),y?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(y)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!s||h,onClick:b,children:h?"⏳":"📰"}),(h||!!g)&&t.jsxs("span",{className:"repubst",children:[h?e.refreshRun:g,!h&&t.jsx("button",{type:"button",onClick:()=>u(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!s,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:w=>r({type:"filters",patch:{search:w.target.value}})})]})]})})}class Bt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*Ed(e){for(const a of e)yield*a}function ii(e){return Array.from(Ed(e))}var Le=1e-6,Ne=Math.PI,pt=Ne/2,Wr=Ne/4,ut=Ne*2,yt=180/Ne,nt=Ne/180,Fe=Math.abs,jd=Math.atan,ha=Math.atan2,Me=Math.cos,De=Math.sin,Nd=Math.sign||function(e){return e>0?1:e<0?-1:0},Vt=Math.sqrt;function Sd(e){return e>1?0:e<-1?Ne:Math.acos(e)}function ga(e){return e>1?pt:e<-1?-pt:Math.asin(e)}function ct(){}function Ga(e,a){e&&Yr.hasOwnProperty(e.type)&&Yr[e.type](e,a)}var Gr={Feature:function(e,a){Ga(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ga(r[n].geometry,a)}},Yr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){An(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)An(r[n],a,0)},Polygon:function(e,a){Qr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Qr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ga(r[n],a)}};function An(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Qr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)An(e[r],a,1);a.polygonEnd()}function Yt(e,a){e&&Gr.hasOwnProperty(e.type)?Gr[e.type](e,a):Ga(e,a)}function qn(e){return[ha(e[1],e[0]),ga(e[2])]}function Jt(e){var a=e[0],r=e[1],n=Me(r);return[n*Me(a),n*De(a),De(r)]}function za(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ya(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function un(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Ca(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Tn(e){var a=Vt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ln(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function Fn(e,a){return Fe(e)>Ne&&(e-=Math.round(e/ut)*ut),[e,a]}Fn.invert=Fn;function zd(e,a,r){return(e%=ut)?a||r?Ln(Jr(e),Xr(a,r)):Jr(e):a||r?Xr(a,r):Fn}function Kr(e){return function(a,r){return a+=e,Fe(a)>Ne&&(a-=Math.round(a/ut)*ut),[a,r]}}function Jr(e){var a=Kr(e);return a.invert=Kr(-e),a}function Xr(e,a){var r=Me(e),n=De(e),o=Me(a),i=De(a);function d(l,s){var h=Me(s),c=Me(l)*h,g=De(l)*h,u=De(s),b=u*r+c*n;return[ha(g*o-b*i,c*r-u*n),ga(b*o+g*i)]}return d.invert=function(l,s){var h=Me(s),c=Me(l)*h,g=De(l)*h,u=De(s),b=u*o-g*i;return[ha(g*o+u*i,c*r+b*n),ga(b*r-c*n)]},d}function Cd(e,a,r,n,o,i){if(r){var d=Me(a),l=De(a),s=n*r;o==null?(o=a+n*ut,i=a-s/2):(o=Zr(d,o),i=Zr(d,i),(n>0?o<i:o>i)&&(o+=n*ut));for(var h,c=o;n>0?c>i:c<i;c-=s)h=qn([d,-l*Me(c),-l*De(c)]),e.point(h[0],h[1])}}function Zr(e,a){a=Jt(a),a[0]-=e,Tn(a);var r=Sd(-a[1]);return((-a[2]<0?-r:r)+ut-Le)%ut}function si(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:ct,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Da(e,a){return Fe(e[0]-a[0])<Le&&Fe(e[1]-a[1])<Le}function Aa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function li(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(m){if(!((y=m.length-1)<=0)){var y,w=m[0],f=m[y],v;if(Da(w,f)){if(!w[2]&&!f[2]){for(o.lineStart(),l=0;l<y;++l)o.point((w=m[l])[0],w[1]);o.lineEnd();return}f[0]+=2*Le}i.push(v=new Aa(w,m,null,!0)),d.push(v.o=new Aa(w,null,v,!1)),i.push(v=new Aa(f,m,null,!1)),d.push(v.o=new Aa(f,null,v,!0))}}),!!i.length){for(d.sort(a),eo(i),eo(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var h=i[0],c,g;;){for(var u=h,b=!0;u.v;)if((u=u.n)===h)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,s=c.length;l<s;++l)o.point((g=c[l])[0],g[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,l=c.length-1;l>=0;--l)o.point((g=c[l])[0],g[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function eo(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function mn(e){return Fe(e[0])<=Ne?e[0]:Nd(e[0])*((Fe(e[0])+Ne)%ut-Ne)}function Ad(e,a){var r=mn(a),n=a[1],o=De(n),i=[De(r),-Me(r),0],d=0,l=0,s=new Bt;o===1?n=pt+Le:o===-1&&(n=-pt-Le);for(var h=0,c=e.length;h<c;++h)if(u=(g=e[h]).length)for(var g,u,b=g[u-1],m=mn(b),y=b[1]/2+Wr,w=De(y),f=Me(y),v=0;v<u;++v,m=k,w=S,f=A,b=E){var E=g[v],k=mn(E),j=E[1]/2+Wr,S=De(j),A=Me(j),L=k-m,F=L>=0?1:-1,O=F*L,M=O>Ne,V=w*S;if(s.add(ha(V*F*De(O),f*A+V*Me(O))),d+=M?L+F*ut:L,M^m>=r^k>=r){var Q=Ya(Jt(b),Jt(E));Tn(Q);var R=Ya(i,Q);Tn(R);var x=(M^L>=0?-1:1)*ga(R[2]);(n>x||n===x&&(Q[0]||Q[1]))&&(l+=M^L>=0?1:-1)}}return(d<-Le||d<Le&&s<-1e-12)^l&1}function di(e,a,r,n){return function(o){var i=a(o),d=si(),l=a(d),s=!1,h,c,g,u={point:b,lineStart:y,lineEnd:w,polygonStart:function(){u.point=f,u.lineStart=v,u.lineEnd=E,c=[],h=[]},polygonEnd:function(){u.point=b,u.lineStart=y,u.lineEnd=w,c=ii(c);var k=Ad(h,n);c.length?(s||(o.polygonStart(),s=!0),li(c,Td,k,r,o)):k&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),c=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function m(k,j){i.point(k,j)}function y(){u.point=m,i.lineStart()}function w(){u.point=b,i.lineEnd()}function f(k,j){g.push([k,j]),l.point(k,j)}function v(){l.lineStart(),g=[]}function E(){f(g[0][0],g[0][1]),l.lineEnd();var k=l.clean(),j=d.result(),S,A=j.length,L,F,O;if(g.pop(),h.push(g),g=null,!!A){if(k&1){if(F=j[0],(L=F.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),S=0;S<L;++S)o.point((O=F[S])[0],O[1]);o.lineEnd()}return}A>1&&k&2&&j.push(j.pop().concat(j.shift())),c.push(j.filter(qd))}}return u}}function qd(e){return e.length>1}function Td(e,a){return((e=e.x)[0]<0?e[1]-pt-Le:pt-e[1])-((a=a.x)[0]<0?a[1]-pt-Le:pt-a[1])}const to=di(function(){return!0},Ld,Rd,[-Ne,-pt]);function Ld(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?Ne:-Ne,s=Fe(i-a);Fe(s-Ne)<Le?(e.point(a,r=(r+d)/2>0?pt:-pt),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=Ne&&(Fe(a-n)<Le&&(a-=n*Le),Fe(i-l)<Le&&(i-=l*Le),r=Fd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Fd(e,a,r,n){var o,i,d=De(e-r);return Fe(d)>Le?jd((De(a)*(i=Me(n))*De(r)-De(n)*(o=Me(a))*De(e))/(o*i*d)):(a+n)/2}function Rd(e,a,r,n){var o;if(e==null)o=r*pt,n.point(-Ne,o),n.point(0,o),n.point(Ne,o),n.point(Ne,0),n.point(Ne,-o),n.point(0,-o),n.point(-Ne,-o),n.point(-Ne,0),n.point(-Ne,o);else if(Fe(e[0]-a[0])>Le){var i=e[0]<a[0]?Ne:-Ne;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Od(e){var a=Me(e),r=2*nt,n=a>0,o=Fe(a)>Le;function i(c,g,u,b){Cd(b,e,r,u,c,g)}function d(c,g){return Me(c)*Me(g)>a}function l(c){var g,u,b,m,y;return{lineStart:function(){m=b=!1,y=1},point:function(w,f){var v=[w,f],E,k=d(w,f),j=n?k?0:h(w,f):k?h(w+(w<0?Ne:-Ne),f):0;if(!g&&(m=b=k)&&c.lineStart(),k!==b&&(E=s(g,v),(!E||Da(g,E)||Da(v,E))&&(v[2]=1)),k!==b)y=0,k?(c.lineStart(),E=s(v,g),c.point(E[0],E[1])):(E=s(g,v),c.point(E[0],E[1],2),c.lineEnd()),g=E;else if(o&&g&&n^k){var S;!(j&u)&&(S=s(v,g,!0))&&(y=0,n?(c.lineStart(),c.point(S[0][0],S[0][1]),c.point(S[1][0],S[1][1]),c.lineEnd()):(c.point(S[1][0],S[1][1]),c.lineEnd(),c.lineStart(),c.point(S[0][0],S[0][1],3)))}k&&(!g||!Da(g,v))&&c.point(v[0],v[1]),g=v,b=k,u=j},lineEnd:function(){b&&c.lineEnd(),g=null},clean:function(){return y|(m&&b)<<1}}}function s(c,g,u){var b=Jt(c),m=Jt(g),y=[1,0,0],w=Ya(b,m),f=za(w,w),v=w[0],E=f-v*v;if(!E)return!u&&c;var k=a*f/E,j=-a*v/E,S=Ya(y,w),A=Ca(y,k),L=Ca(w,j);un(A,L);var F=S,O=za(A,F),M=za(F,F),V=O*O-M*(za(A,A)-1);if(!(V<0)){var Q=Vt(V),R=Ca(F,(-O-Q)/M);if(un(R,A),R=qn(R),!u)return R;var x=c[0],q=g[0],C=c[1],P=g[1],H;q<x&&(H=x,x=q,q=H);var G=q-x,Z=Fe(G-Ne)<Le,z=Z||G<Le;if(!Z&&P<C&&(H=C,C=P,P=H),z?Z?C+P>0^R[1]<(Fe(R[0]-x)<Le?C:P):C<=R[1]&&R[1]<=P:G>Ne^(x<=R[0]&&R[0]<=q)){var $=Ca(F,(-O+Q)/M);return un($,A),[R,qn($)]}}}function h(c,g){var u=n?e:Ne-e,b=0;return c<-u?b|=1:c>u&&(b|=2),g<-u?b|=4:g>u&&(b|=8),b}return di(d,l,i,n?[0,-e]:[-Ne,e-Ne])}function Md(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],h=a[1],c=0,g=1,u=s-d,b=h-l,m;if(m=r-d,!(!u&&m>0)){if(m/=u,u<0){if(m<c)return;m<g&&(g=m)}else if(u>0){if(m>g)return;m>c&&(c=m)}if(m=o-d,!(!u&&m<0)){if(m/=u,u<0){if(m>g)return;m>c&&(c=m)}else if(u>0){if(m<c)return;m<g&&(g=m)}if(m=n-l,!(!b&&m>0)){if(m/=b,b<0){if(m<c)return;m<g&&(g=m)}else if(b>0){if(m>g)return;m>c&&(c=m)}if(m=i-l,!(!b&&m<0)){if(m/=b,b<0){if(m>g)return;m>c&&(c=m)}else if(b>0){if(m<c)return;m<g&&(g=m)}return c>0&&(e[0]=d+c*u,e[1]=l+c*b),g<1&&(a[0]=d+g*u,a[1]=l+g*b),!0}}}}}var sa=1e9,qa=-sa;function Dd(e,a,r,n){function o(h,c){return e<=h&&h<=r&&a<=c&&c<=n}function i(h,c,g,u){var b=0,m=0;if(h==null||(b=d(h,g))!==(m=d(c,g))||s(h,c)<0^g>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+g+4)%4)!==m);else u.point(c[0],c[1])}function d(h,c){return Fe(h[0]-e)<Le?c>0?0:3:Fe(h[0]-r)<Le?c>0?2:1:Fe(h[1]-a)<Le?c>0?1:0:c>0?3:2}function l(h,c){return s(h.x,c.x)}function s(h,c){var g=d(h,1),u=d(c,1);return g!==u?g-u:g===0?c[1]-h[1]:g===1?h[0]-c[0]:g===2?h[1]-c[1]:c[0]-h[0]}return function(h){var c=h,g=si(),u,b,m,y,w,f,v,E,k,j,S,A={point:L,lineStart:V,lineEnd:Q,polygonStart:O,polygonEnd:M};function L(x,q){o(x,q)&&c.point(x,q)}function F(){for(var x=0,q=0,C=b.length;q<C;++q)for(var P=b[q],H=1,G=P.length,Z=P[0],z,$,D=Z[0],X=Z[1];H<G;++H)z=D,$=X,Z=P[H],D=Z[0],X=Z[1],$<=n?X>n&&(D-z)*(n-$)>(X-$)*(e-z)&&++x:X<=n&&(D-z)*(n-$)<(X-$)*(e-z)&&--x;return x}function O(){c=g,u=[],b=[],S=!0}function M(){var x=F(),q=S&&x,C=(u=ii(u)).length;(q||C)&&(h.polygonStart(),q&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),C&&li(u,l,x,i,h),h.polygonEnd()),c=h,u=b=m=null}function V(){A.point=R,b&&b.push(m=[]),j=!0,k=!1,v=E=NaN}function Q(){u&&(R(y,w),f&&k&&g.rejoin(),u.push(g.result())),A.point=L,k&&c.lineEnd()}function R(x,q){var C=o(x,q);if(b&&m.push([x,q]),j)y=x,w=q,f=C,j=!1,C&&(c.lineStart(),c.point(x,q));else if(C&&k)c.point(x,q);else{var P=[v=Math.max(qa,Math.min(sa,v)),E=Math.max(qa,Math.min(sa,E))],H=[x=Math.max(qa,Math.min(sa,x)),q=Math.max(qa,Math.min(sa,q))];Md(P,H,e,a,r,n)?(k||(c.lineStart(),c.point(P[0],P[1])),c.point(H[0],H[1]),C||c.lineEnd(),S=!1):C&&(c.lineStart(),c.point(x,q),S=!1)}v=x,E=q,k=C}return A}}const Rn=e=>e;var fn=new Bt,On=new Bt,pi,ci,Mn,Dn,Et={point:ct,lineStart:ct,lineEnd:ct,polygonStart:function(){Et.lineStart=Id,Et.lineEnd=_d},polygonEnd:function(){Et.lineStart=Et.lineEnd=Et.point=ct,fn.add(Fe(On)),On=new Bt},result:function(){var e=fn/2;return fn=new Bt,e}};function Id(){Et.point=Pd}function Pd(e,a){Et.point=ui,pi=Mn=e,ci=Dn=a}function ui(e,a){On.add(Dn*e-Mn*a),Mn=e,Dn=a}function _d(){ui(pi,ci)}var Xt=1/0,Qa=Xt,xa=-Xt,Ka=xa,Ja={point:Bd,lineStart:ct,lineEnd:ct,polygonStart:ct,polygonEnd:ct,result:function(){var e=[[Xt,Qa],[xa,Ka]];return xa=Ka=-(Qa=Xt=1/0),e}};function Bd(e,a){e<Xt&&(Xt=e),e>xa&&(xa=e),a<Qa&&(Qa=a),a>Ka&&(Ka=a)}var In=0,Pn=0,la=0,Xa=0,Za=0,Qt=0,_n=0,Bn=0,da=0,mi,fi,bt,vt,dt={point:$t,lineStart:ao,lineEnd:no,polygonStart:function(){dt.lineStart=Hd,dt.lineEnd=Vd},polygonEnd:function(){dt.point=$t,dt.lineStart=ao,dt.lineEnd=no},result:function(){var e=da?[_n/da,Bn/da]:Qt?[Xa/Qt,Za/Qt]:la?[In/la,Pn/la]:[NaN,NaN];return In=Pn=la=Xa=Za=Qt=_n=Bn=da=0,e}};function $t(e,a){In+=e,Pn+=a,++la}function ao(){dt.point=$d}function $d(e,a){dt.point=Ud,$t(bt=e,vt=a)}function Ud(e,a){var r=e-bt,n=a-vt,o=Vt(r*r+n*n);Xa+=o*(bt+e)/2,Za+=o*(vt+a)/2,Qt+=o,$t(bt=e,vt=a)}function no(){dt.point=$t}function Hd(){dt.point=Wd}function Vd(){hi(mi,fi)}function Wd(e,a){dt.point=hi,$t(mi=bt=e,fi=vt=a)}function hi(e,a){var r=e-bt,n=a-vt,o=Vt(r*r+n*n);Xa+=o*(bt+e)/2,Za+=o*(vt+a)/2,Qt+=o,o=vt*e-bt*a,_n+=o*(bt+e),Bn+=o*(vt+a),da+=o*3,$t(bt=e,vt=a)}function gi(e){this._context=e}gi.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,ut);break}}},result:ct};var $n=new Bt,hn,xi,bi,pa,ca,ba={point:ct,lineStart:function(){ba.point=Gd},lineEnd:function(){hn&&vi(xi,bi),ba.point=ct},polygonStart:function(){hn=!0},polygonEnd:function(){hn=null},result:function(){var e=+$n;return $n=new Bt,e}};function Gd(e,a){ba.point=vi,xi=pa=e,bi=ca=a}function vi(e,a){pa-=e,ca-=a,$n.add(Vt(pa*pa+ca*ca)),pa=e,ca=a}let ro,en,oo,io;class so{constructor(a){this._append=a==null?wi:Yd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==oo||this._append!==en){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,oo=n,en=this._append,io=this._,this._=o}this._+=io;break}}}result(){const a=this._;return this._="",a.length?a:null}}function wi(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Yd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return wi;if(a!==ro){const r=10**a;ro=a,en=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return en}function Qd(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Yt(l,o(i))),i.result()}return d.area=function(l){return Yt(l,o(Et)),Et.result()},d.measure=function(l){return Yt(l,o(ba)),ba.result()},d.bounds=function(l){return Yt(l,o(Ja)),Ja.result()},d.centroid=function(l){return Yt(l,o(dt)),dt.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,Rn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new so(r)):new gi(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new so(r)),d},d.projection(e).digits(r).context(a)}function er(e){return function(a){var r=new Un;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Un(){}Un.prototype={constructor:Un,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function tr(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Yt(r,e.stream(Ja)),a(Ja.result()),n!=null&&e.clipExtent(n),e}function yi(e,a,r){return tr(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Kd(e,a,r){return yi(e,[[0,0],a],r)}function Jd(e,a,r){return tr(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Xd(e,a,r){return tr(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var lo=16,Zd=Me(30*nt);function po(e,a){return+a?tp(e,a):ep(e)}function ep(e){return er({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function tp(e,a){function r(n,o,i,d,l,s,h,c,g,u,b,m,y,w){var f=h-n,v=c-o,E=f*f+v*v;if(E>4*a&&y--){var k=d+u,j=l+b,S=s+m,A=Vt(k*k+j*j+S*S),L=ga(S/=A),F=Fe(Fe(S)-1)<Le||Fe(i-g)<Le?(i+g)/2:ha(j,k),O=e(F,L),M=O[0],V=O[1],Q=M-n,R=V-o,x=v*Q-f*R;(x*x/E>a||Fe((f*Q+v*R)/E-.5)>.3||d*u+l*b+s*m<Zd)&&(r(n,o,i,d,l,s,M,V,F,k/=A,j/=A,S,y,w),w.point(M,V),r(M,V,F,k,j,S,h,c,g,u,b,m,y,w))}}return function(n){var o,i,d,l,s,h,c,g,u,b,m,y,w={point:f,lineStart:v,lineEnd:k,polygonStart:function(){n.polygonStart(),w.lineStart=j},polygonEnd:function(){n.polygonEnd(),w.lineStart=v}};function f(L,F){L=e(L,F),n.point(L[0],L[1])}function v(){g=NaN,w.point=E,n.lineStart()}function E(L,F){var O=Jt([L,F]),M=e(L,F);r(g,u,c,b,m,y,g=M[0],u=M[1],c=L,b=O[0],m=O[1],y=O[2],lo,n),n.point(g,u)}function k(){w.point=f,n.lineEnd()}function j(){v(),w.point=S,w.lineEnd=A}function S(L,F){E(o=L,F),i=g,d=u,l=b,s=m,h=y,w.point=E}function A(){r(g,u,c,b,m,y,i,d,o,l,s,h,lo,n),w.lineEnd=k,k()}return w}}var ap=er({point:function(e,a){this.stream.point(e*nt,a*nt)}});function np(e){return er({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function rp(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function co(e,a,r,n,o,i){if(!i)return rp(e,a,r,n,o);var d=Me(i),l=De(i),s=d*e,h=l*e,c=d/e,g=l/e,u=(l*r-d*a)/e,b=(l*a+d*r)/e;function m(y,w){return y*=n,w*=o,[s*y-h*w+a,r-h*y-s*w]}return m.invert=function(y,w){return[n*(c*y-g*w+u),o*(b-g*y-c*w)]},m}function op(e){return ip(function(){return e})()}function ip(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,h=0,c,g=0,u=1,b=1,m=null,y=to,w=null,f,v,E,k=Rn,j=.5,S,A,L,F,O;function M(x){return L(x[0]*nt,x[1]*nt)}function V(x){return x=L.invert(x[0],x[1]),x&&[x[0]*yt,x[1]*yt]}M.stream=function(x){return F&&O===x?F:F=ap(np(c)(y(S(k(O=x)))))},M.preclip=function(x){return arguments.length?(y=x,m=void 0,R()):y},M.postclip=function(x){return arguments.length?(k=x,w=f=v=E=null,R()):k},M.clipAngle=function(x){return arguments.length?(y=+x?Od(m=x*nt):(m=null,to),R()):m*yt},M.clipExtent=function(x){return arguments.length?(k=x==null?(w=f=v=E=null,Rn):Dd(w=+x[0][0],f=+x[0][1],v=+x[1][0],E=+x[1][1]),R()):w==null?null:[[w,f],[v,E]]},M.scale=function(x){return arguments.length?(r=+x,Q()):r},M.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],Q()):[n,o]},M.center=function(x){return arguments.length?(i=x[0]%360*nt,d=x[1]%360*nt,Q()):[i*yt,d*yt]},M.rotate=function(x){return arguments.length?(l=x[0]%360*nt,s=x[1]%360*nt,h=x.length>2?x[2]%360*nt:0,Q()):[l*yt,s*yt,h*yt]},M.angle=function(x){return arguments.length?(g=x%360*nt,Q()):g*yt},M.reflectX=function(x){return arguments.length?(u=x?-1:1,Q()):u<0},M.reflectY=function(x){return arguments.length?(b=x?-1:1,Q()):b<0},M.precision=function(x){return arguments.length?(S=po(A,j=x*x),R()):Vt(j)},M.fitExtent=function(x,q){return yi(M,x,q)},M.fitSize=function(x,q){return Kd(M,x,q)},M.fitWidth=function(x,q){return Jd(M,x,q)},M.fitHeight=function(x,q){return Xd(M,x,q)};function Q(){var x=co(r,0,0,u,b,g).apply(null,a(i,d)),q=co(r,n-x[0],o-x[1],u,b,g);return c=zd(l,s,h),A=Ln(a,q),L=Ln(c,A),S=po(A,j),R()}function R(){return F=O=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&V,Q()}}function ki(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}ki.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Fe(o)>Le&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function sp(){return op(ki).scale(175.295)}function lp(e){return e}function dp(e){if(e==null)return lp;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var h=2,c=l.length,g=new Array(c);for(g[0]=(a+=l[0])*n+i,g[1]=(r+=l[1])*o+d;h<c;)g[h]=l[h],++h;return g}}function pp(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function cp(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return uo(e,r)})}:uo(e,a)}function uo(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=up(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function up(e,a){var r=dp(e.transform),n=e.arcs;function o(c,g){g.length&&g.pop();for(var u=n[c<0?~c:c],b=0,m=u.length;b<m;++b)g.push(r(u[b],b));c<0&&pp(g,m)}function i(c){return r(c)}function d(c){for(var g=[],u=0,b=c.length;u<b;++u)o(c[u],g);return g.length<2&&g.push(g[0]),g}function l(c){for(var g=d(c);g.length<4;)g.push(g[0]);return g}function s(c){return c.map(l)}function h(c){var g=c.type,u;switch(g){case"GeometryCollection":return{type:g,geometries:c.geometries.map(h)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=d(c.arcs);break;case"MultiLineString":u=c.arcs.map(d);break;case"Polygon":u=s(c.arcs);break;case"MultiPolygon":u=c.arcs.map(s);break;default:return null}return{type:g,coordinates:u}}return h(a)}const Ei={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},mp=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function fp(e,a,r){const n=Ei[e];if(!n||!n.length)return-1;const o=mp(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let Ta=null;function hp(){return Ta||(Ta=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=cp(r,n),i=sp().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Qd(i),l=(o.features||[]).filter(c=>{var g;return(((g=c.properties)==null?void 0:g.name)||"")!=="Antarctica"}).map(c=>{var b;const g=((b=c.properties)==null?void 0:b.name)||"",u=d(c)||"";return u?{i2:ys(g)||null,n:g,d:u}:null}).filter(c=>!!c);if(!l.length)return null;const s={};for(const[c,g]of Object.entries(ks)){const u=i(g);u&&(s[c]={x:u[0],y:u[1]})}const h={};for(const[c,g]of Object.entries(Ei)){const u=g.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(h[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:h}}catch{return null}})(),Ta)}function gp(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return hp().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const xp="8 40 984 210",bp={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},mo=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function fo(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function vp(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var h;if(!o)return;const s=(h=e.current)==null?void 0:h.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function ho({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function wp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:h,dossiers:c,source:g}=K(),u=h.loading&&!c.length,b=p.useRef(null),m=p.useRef(null),y=gp(e.continent==="monde"),w=e.continent==="monde"?y:Qn.find(x=>x.key===e.continent)||null,f=vp(b,e.continent+":"+e.mapFolded+":"+!!w),[v,E]=p.useState(new Map),[k,j]=p.useState(null);p.useEffect(()=>{const x=b.current;if(!x)return;const q=new Map;x.querySelectorAll("path[data-i2]").forEach(C=>{const P=C.dataset.i2;if(P)try{const H=C.getBBox();H.width>0&&q.set(P,{x:H.x,y:H.y,w:H.width,h:H.height})}catch{}}),E(q)},[e.continent,f,w]);const S=p.useMemo(()=>r.filter(x=>x.cc),[r]),A=p.useMemo(()=>{const x=new Map;return S.forEach(q=>x.set(q.cc,(x.get(q.cc)||0)+1)),x},[S]),L=e.continent==="monde"&&y?y.anchors:null,F=e.continent==="monde"&&y?y.metros:null,O=p.useMemo(()=>S.map(x=>{const q=fo(x.name||x.id||""),C=fo((x.id||x.name||"")+"·y");if(L&&x.cc){const z=F?F[x.cc]:void 0;if(z&&z.length){const D=fp(x.cc,x.city,q);if(D>=0&&z[D])return{d:x,x:z[D].x+(q-.5)*5,y:z[D].y+(C-.5)*5}}const $=L[x.cc];if($)return{d:x,x:$.x+(q-.5)*10,y:$.y+(C-.5)*10}}const P=x.cc?v.get(x.cc):void 0;if(!P)return null;const H=bp[`${e.continent}:${x.cc||""}`];if(H)return{d:x,x:P.x+P.w*(H.fx+(q-.5)*H.sx),y:P.y+P.h*(H.fy+(C-.5)*H.sy)};const G=(q-.5)*Math.min(P.w*.55,60),Z=(C-.5)*Math.min(P.h*.55,60);return{d:x,x:P.x+P.w/2+G,y:P.y+P.h/2+Z}}).filter(x=>!!x),[S,v,L,F,e.continent]),M=x=>f>0?x/f:x,V=p.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:mo[x],fr:s.plabels[x],en:s.plabels[x],n:r.filter(q=>q.kind==="target"&&Te(q)===x).length})).filter(x=>x.n>0):gr.map((x,q)=>({...x,n:r.filter(C=>xr(C)===q).length})),[r,n,s.plabels]),Q=i?d.get(i):null,R=Q?O.find(x=>x.d.id===Q.id):null;return w?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:m,children:[u&&t.jsx(ho,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?xp:w.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?w.fr:w.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:w.countries.map((x,q)=>t.jsx("g",{className:"ct"+(x.i2&&A.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},q))}),t.jsx("g",{children:O.map(x=>{const q=gr[xr(x.d)],C=!!$e(x.d),P=x.d.kind==="target",H=n&&P?mo[Te(x.d)]:q.c,G=!n&&We(x.d);return t.jsxs("g",{className:"co"+(G?" done":""),onMouseEnter:()=>{var $,D;const Z=($=m.current)==null?void 0:$.getBoundingClientRect(),z=(D=b.current)==null?void 0:D.createSVGPoint();if(z&&b.current&&Z){z.x=x.x,z.y=x.y;const X=z.matrixTransform(b.current.getScreenCTM());j({x:X.x-Z.left,y:X.y-Z.top,label:x.d.name+" · "+(ta(x.d.cc,l)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var $;if(g==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const Z=($=b.current)==null?void 0:$.createSVGPoint();let z=null;if(Z&&b.current){Z.x=x.x,Z.y=x.y;const D=Z.matrixTransform(b.current.getScreenCTM());z={x:D.x,y:D.y}}a({type:"popup",id:x.d.id,anchor:z})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:M(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:M(q.px),fill:H,stroke:C?"#E5484D":"#ffffff",strokeWidth:M(C?2.2:1.3)})]},x.d.id||x.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:M(13),fill:"none",stroke:"#16233A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:V.map((x,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),l==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},q))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:m,children:t.jsx(ho,{msgs:s.loadMsgs})})}function yp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function ji({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=K(),s=a.filters,[h,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null),m=p.useRef(null),y=p.useMemo(()=>a.continent==="monde"?n:n.filter(R=>R.continent===a.continent),[n,a.continent]),w=R=>y.filter(x=>R!=="country"&&s.country.length&&!s.country.includes(x.cc||"")?!1:Va(x,s,i,R==="country"?void 0:R)),f=R=>!i||R.kind!=="op",v=p.useMemo(()=>{const R=w("win").filter(f),x=q=>R.filter(C=>(C.date?Math.max(0,Math.floor((Date.now()-Date.parse(C.date))/864e5)):9999)<=q).length;return[x(0),x(7),x(30),R.length]},[y,s,i]),E=p.useMemo(()=>s.day?w("win").filter(f).filter(R=>(R.date||"").slice(0,10)===s.day).length:0,[y,s,i]),k=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,j=k+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!h&&!g)return;const R=q=>{var P,H;const C=q.target;h&&!((P=b.current)!=null&&P.contains(C))&&c(!1),g&&!((H=m.current)!=null&&H.contains(C))&&u(!1)},x=q=>{q.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",R),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",R),document.removeEventListener("keydown",x)}},[h,g]);const S=(R,x,q,C="fbtn")=>t.jsxs("button",{type:"button",className:C,"aria-expanded":a.openFacet===R,onClick:()=>r({type:"openFacet",facet:R}),children:[t.jsx("span",{className:"fl",children:x}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},R),A=["1","7","30","all"],L=Math.max(0,A.indexOf(s.win||"all")),F=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(yp(s.day,l))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>u(R=>!R),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:v[L]}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:A.map((R,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===R,onClick:()=>{r({type:"filters",patch:{win:R}}),u(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:v[x]})]},R))})]}):t.jsx("div",{className:"seg",children:A.map((R,x)=>t.jsxs("button",{type:"button","aria-pressed":s.win===R,onClick:()=>r({type:"filters",patch:{win:R}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:v[x]})]},R))}),O=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:R=>r({type:"filters",patch:{search:R.target.value}})})]}),M=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):S("sec",o.fSector,s.sector.length),(n.some(R=>!!R.market)||s.market.length>0)&&S("mar",o.fMarket,s.market.length),S("pay",o.fCountry,s.country.length),S("det",o.fEngine,s.engine.length),S("sta",o.fStage,s.stage.length),i&&S("crib",o.fVerdict,s.crible.length),i&&S("ang","Angle",s.angle.length),i&&S("mem","Mémo",s.memoLevel.length)]}),V=(R=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(y.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),R&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),Q=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{c(R=>!R),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:M})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:F}),t.jsxs("div",{className:"fstrip-b",children:[O,Q,V(!1)]})]}),a.openFacet&&t.jsx(go,{poolFor:w})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[F,O,M,t.jsx("span",{className:"fgrow"}),V()]}),a.openFacet&&t.jsx(go,{poolFor:w})]})}function go({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=K(),l=a.filters,s=a.openFacet,{title:h,cols:c,options:g}=p.useMemo(()=>{if(s==="sig"){const w=e("signal").filter(E=>$e(E)),f=new Map;w.forEach(E=>{const k=E.engine||"";f.set(k,(f.get(k)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:w.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...Sn([...f.keys()],o).map(E=>({v:E,label:_t(E)+" "+rt(E,o),n:f.get(E)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="crib"){const w=e("crible").filter(v=>!i||Lo(v,a.ptab,d.favIds)),f=new Map;return w.forEach(v=>{const E=Fo(v);E&&E!=="NEW"&&f.set(E,(f.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((v,E)=>(br[v[0]]??9)-(br[E[0]]??9)||E[1]-v[1]).map(([v,E])=>({v,label:'<span class="fdot" style="background:'+(Es[v]||"#94A3B8")+'"></span>'+v,n:E,html:!0,on:l.crible.includes(v)}))}}if(s==="sec"){const w=e("sector"),f=new Map;return w.forEach(v=>{v.sector&&f.set(v.sector,(f.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:v,n:E,html:!1,on:l.sector.includes(v)}))}}if(s==="mar"){const w=e("market"),f=new Map;return w.forEach(v=>{v.market&&f.set(v.market,(f.get(v.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...f.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:v,n:E,html:!1,on:l.market.includes(v)}))}}if(s==="pay"){const w=e("country"),f=new Map;return w.forEach(v=>{v.cc&&f.set(v.cc,(f.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:ta(v,o)||v,n:E,html:!1,on:l.country.includes(v)}))}}if(s==="det"){const w=e("engine"),f=new Map;return w.forEach(v=>{v.engine&&f.set(v.engine,(f.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:Sn([...f.keys()],o).map(v=>({v,label:_t(v)+" "+rt(v,o)+' <span style="color:var(--dim);font-size:10px">· '+js(Ns(v),o)+"</span>",n:f.get(v)||0,html:!0,on:l.engine.includes(v)}))}}if(s==="ang"){const w=e("angle"),f=new Map;return w.forEach(v=>{v.angle&&f.set(v.angle,(f.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:v.replace(/[_-]+/g," "),n:E,html:!1,on:l.angle.includes(v)}))}}if(s==="mem"){const w=e("memoLevel"),f=new Map;w.forEach(E=>{if(E.kind==="target"){const k=Yn(E);f.set(k,(f.get(k)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:v[E],n:f.get(E)||0,html:!1,on:l.memoLevel.includes(E)}))}}const m=e("stage"),y=new Map;return m.forEach(w=>{w.stage&&y.set(w.stage,(y.get(w.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...y.entries()].sort((w,f)=>f[1]-w[1]).map(([w,f])=>({v:w,label:w,n:f,html:!1,on:l.stage.includes(w)}))}},[s,a,o]),u=m=>{if(s==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const w=l.signalEngines.includes(m)?l.signalEngines.filter(f=>f!==m):[...l.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:w}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:m})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:h}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Ni({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=K(),s=p.useMemo(()=>{const b={};return r.forEach(m=>{Va(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[h,c]=p.useState(!1),g=p.useRef(null);p.useEffect(()=>{if(!h)return;const b=y=>{var w;(w=g.current)!=null&&w.contains(y.target)||c(!1)},m=y=>{y.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[h]);const u=b=>{const m=Qn.find(y=>y.key===b);return b==="monde"?l.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:g,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:vr.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[vr.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]})]})}function Hn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function Si(e){return"atl2:evalq:"+(e||"anon")}function kp(e,a){const r=Si(e),n=Hn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}let Vn=null;function Ep(e){Vn=e;try{window.dispatchEvent(new CustomEvent("atl2:extract-note",{detail:e}))}catch{}}function jp(){const{t:e,lang:a,data:r,dossiers:n}=K(),o=r.session.token||"",i=Si(o),[d,l]=p.useState(()=>Hn(i)),s=p.useRef(!1),[h,c]=p.useState(!1);p.useEffect(()=>{try{const z=d.slice(0,30).map(({descBusy:$,evalBusy:D,...X})=>X);localStorage.setItem(i,JSON.stringify(z)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[d,i]),p.useEffect(()=>{const z=()=>{if(s.current)return;const $=Hn(i);l(D=>JSON.stringify(D.map(({descBusy:X,evalBusy:U,...ee})=>ee))===JSON.stringify($)?D:$)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[i]);const[g,u]=p.useState([]),[b,m]=p.useState(""),[y,w]=p.useState(!1),[f,v]=p.useState(!1),[E,k]=p.useState(""),[j,S]=p.useState(()=>Vn);p.useEffect(()=>{const z=$=>{var X,U;const D=$.detail;D&&((X=D.cited)!=null&&X.length||(U=D.match)!=null&&U.length||D.title)&&S(D)};return window.addEventListener("atl2:extract-note",z),()=>window.removeEventListener("atl2:extract-note",z)},[]);const A=p.useCallback((z,$)=>l(D=>D.map((X,U)=>U===z?{...X,...$}:X)),[]),L=p.useCallback((z,$)=>{const D=$.trim();D&&(A(z,{name:D,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Kn(D).then(X=>{const U=X.candidates||[];X.website?A(z,{site:X.website,status:"ready"}):U.length===1?A(z,{site:U[0].url,status:"ready"}):U.length>1?A(z,{status:"pick",candidates:U.slice(0,6)}):A(z,{status:"ready"})}).catch(()=>A(z,{status:"ready"})))},[A]),F=p.useCallback((z,$,D)=>{A(z,{descBusy:!0}),Oo(o,$,D).then(X=>{if(X.quota){c(!0),A(z,{descBusy:!1,descDone:!0});return}const U=X.blocs||{},ee=(U.synthese||U.value_prop||U.produit||U.modele||"").trim();A(z,{descBusy:!1,descDone:!0,desc:ee})}).catch(()=>A(z,{descBusy:!1,descDone:!0}))},[A,o]);p.useEffect(()=>{const z=d.findIndex(D=>D.auto&&D.name.trim()&&D.status==="");if(z>=0){L(z,d[z].name);return}if(h)return;const $=d.findIndex(D=>D.status==="ready"&&D.site&&!D.descDone&&!D.descBusy);$>=0&&F($,d[$].name,d[$].site)},[d,L,F,h]);const[O,M]=p.useState(!1),V=p.useCallback(async(z,$)=>{A(z,{evalBusy:!0});const D=($.site||$.name).trim(),X=await Mo(o,D,"atelier2");return X.verdict==="quota"?(A(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:X.reason||"",remaining:0}})),!1):(A(z,{evalBusy:!1,status:X.verdict==="kept"?"kept":"out",reason:X.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:X.company||$.name,verdict:X.verdict,reason:X.reason||"",remaining:X.remaining??null}})),!0)},[A,o]),Q=async()=>{if(O)return;const z=d.map(($,D)=>({r:$,i:D})).filter(({r:$})=>$.name.trim()&&$.status!=="kept"&&$.status!=="out"&&$.status!=="resolving");if(z.length){M(!0);for(const{r:$,i:D}of z)if(!await V(D,$))break;M(!1)}},R=p.useMemo(()=>{const z=new Set,$=[];return d.filter(D=>D.status==="kept").forEach(D=>{const X=D.name.trim().toLowerCase();X&&!z.has(X)&&(z.add(X),$.push(D.name.trim()))}),n.filter(D=>Te(D)>=1&&Te(D)<=4&&(D.website||D.domain)).forEach(D=>{const X=(D.name||"").trim().toLowerCase();X&&!z.has(X)&&(z.add(X),$.push((D.name||"").trim()))}),$},[d,n]),x=p.useMemo(()=>{const z=new Set;return n.forEach($=>{const D=($.name||"").trim().toLowerCase();D&&z.add(D)}),d.forEach($=>{const D=$.name.trim().toLowerCase();D&&z.add(D)}),z},[n,d]),q=async()=>{if(b||!R.length)return;v(!1);const z=[];for(const $ of R.slice(0,2)){m($);const D=await Do(o,$);if(D){if(D.verdict==="quota"){w(!0);break}(D.results||[]).forEach(X=>{const U=(X.company||"").trim().toLowerCase();!U||x.has(U)||z.some(ee=>ee.name.toLowerCase()===U)||z.push({name:(X.company||"").trim(),verdict:X.verdict||"",reason:X.reason,from:$})})}}m(""),v(!0),u($=>[...z,...$].slice(0,24))},C=async(z,$)=>{if(b)return;v(!1),m(z==="thesis"?e.pxThesis:$);const D=await zs(o,z,$,6);if(m(""),v(!0),!D)return;if(D.verdict==="quota"){w(!0);return}const X=[];(D.results||[]).forEach(U=>{const ee=(U.company||"").trim().toLowerCase();!ee||x.has(ee)||X.some(ue=>ue.name.toLowerCase()===ee)||X.push({name:(U.company||"").trim(),verdict:U.verdict||"",reason:U.reason,from:z==="thesis"?e.pxThesis:$})}),u(U=>[...X,...U].slice(0,24))},P=()=>{const z=E.trim();z.length<3||C(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},H=z=>{l($=>[...$,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),u($=>$.filter(D=>D.name!==z.name))},G=d.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,Z=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[j&&t.jsxs("div",{className:"eq-note"+(j.fallback?" fb":""),children:[t.jsxs("b",{children:[j.fallback?e.rsNoteFallback:e.rsNoteRead,j.title?` « ${j.title.length>90?j.title.slice(0,89)+"…":j.title} »`:""]}),!!j.cited.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteCited," ",t.jsx("i",{children:j.cited.join(" · ")})]}),!!j.match.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteMatch," ",t.jsx("i",{children:j.match.join(" · ")})]}),!j.match.length&&!!j.cited.length&&t.jsx("p",{className:"eq-nl",children:e.rsNoteNoMatch}),t.jsx("p",{className:"eq-nl",children:e.rsNoteAdded(j.added)}),t.jsx("button",{type:"button",className:"eq-note-x",onClick:()=>{Vn=null,S(null)},title:e.rsClose,children:"×"})]}),t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{className:"eq-h-go",children:e.eqRunOneShort})]}),d.map((z,$)=>{const D=z.name.trim(),X=D.length>18?D.slice(0,17)+"…":D,U=D?e.eqRunOn(X):e.eqRunOneShort;return t.jsxs("div",{className:"eq-item eq-card"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),style:{border:"none",borderRadius:10,padding:"10px 12px 8px",background:z.status==="kept"?"#F3FBF6":z.status==="out"?"#FDF6F6":"#F4F6F9"},children:[t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:ee=>{const ue=ee.target.value.split(`
`).map(fe=>fe.trim()).filter(Boolean);ue.length>1?l(fe=>{const ve=[...fe];return ve.splice($,1,...ue.map(me=>({name:me,site:"",status:"",auto:!0}))),ve.slice(0,30)}):A($,{name:ee.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&L($,z.name)},onKeyDown:ee=>{ee.key==="Enter"&&L($,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:ee=>{const ue=ee.target.value;ue&&A($,{site:ue,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(z.candidates||[]).map(ee=>t.jsx("option",{value:ee.url,children:(ee.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},ee.url))]}),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?h?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>l(ee=>ee.filter((ue,fe)=>fe!==$)),children:"×"}),(D||z.site)&&z.status!=="kept"&&z.status!=="out"?t.jsxs(an,{lang:a,storeKey:(z.site||z.name).trim(),className:"eq-go",title:U,disabled:!Z(z)||O,confirmLabel:"⚡ "+U,onConfirm:()=>{V($,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:U})]}):t.jsxs("button",{type:"button",className:"eq-go",title:U,disabled:!Z(z)||O,onClick:()=>{V($,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:U})]})]}),(z.name.trim()||z.site)&&z.status!=="kept"&&z.status!=="out"&&t.jsx(Ss,{lang:a,variant:"row",storeKey:(z.site||z.name).trim()})]},$)}),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>l(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{C("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:z=>k(z.target.value),onKeyDown:z=>{z.key==="Enter"&&P()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:P,children:e.pxGoFree}),!!R.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{q()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!R.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(R[0],R.length)}),y&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),f&&!g.length&&!y&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),g.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>H(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>l(z=>z.filter($=>$.status!=="kept"&&$.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(O?" loading":""),style:{justifyContent:"center"},disabled:O||!G,onClick:()=>{Q()},children:[t.jsx("span",{className:"fill"}),O?e.eqRunning:e.eqGo(G)]})]})]})]})}const Np={deals:"ma-deals",news:"veille"},zi=/^(deals?|news|breaking|live|update|analysis|markets?|opinion|icymi)$/i,Sp=/^(this|that|these|those|why|what|what'?s|how|when|where|who|which|is|are|do|does|did|can|could|should|would|will|a|an|the|les?|la|des?|une?|un)\b/i,zp=/\b(labor day|workers?|toast|monday|tuesday|wednesday|thursday|friday|saturday|sunday|assessment|volunteer)\b/i,Cp=/\b(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\b/i;function Ci(e){const a=(e||"").trim();return!(!a||a.length<2||a.length>48||zi.test(a)||Sp.test(a)||zp.test(a)||Kt(a)||!tn(a))}function xo(e){return(e.url||e.title||"").trim()}function gn(e){const a=(e.kind||"").toLowerCase(),r=(e.ingest_kind||"").toLowerCase();if(a==="article"||a==="news"||a==="media"||r==="url"||r==="youtube")return!0;const n=(e.title||"").replace(/\s+/g," ").trim();return n?Kt(n)||Cp.test(n)?!0:!tn(n):!!(e.url||"").trim()}function ar(e){let a=(e||"").replace(/\s+/g," ").trim();a=a.replace(/^\s*(?:deals?|news|breaking|live|update|analysis)\s*[:–—|]\s*/i,"");const r=[],n=d=>{let l=(d||"").replace(/[\u2018\u2019\u201c\u201d'"«»]/g,"").trim();l=l.replace(/^(the|le|la|les|l['’])\s+/i,"").trim(),l=l.replace(/\s+(?:'s|retirement|business|unit|division|arm|operations?)\b.*$/i,"").trim(),Ci(l)&&(r.some(s=>s.toLowerCase()===l.toLowerCase())||r.push(l))},o=a.match(/^(.{2,48}?)\s+(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\s+(.{2,60}?)(?:\s+(?:for|pour|en|in|at|à|from|de)\b|$)/i);if(o&&(n(o[1]),n(o[2]),r.length))return r;const i=a.match(/^(.{2,48}?)\s*[:–—]/);return i&&n(i[1]),r}function bo(e){const a=ar(e.title||"");if(a.length)return a[0];const r=(e.title||"").replace(/\s+/g," ").trim();if(!r)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const n=/^(.{2,72}?)[:–—|]/.exec(r);return n&&!zi.test(n[1].trim())?n[1].trim():(r.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||r).slice(0,72).trim()}function Ap({pageToken:e,onAddNames:a,onPanel:r}){const{t:n,lang:o,token:i,canWrite:d,flash:l}=K(),[s,h]=p.useState(null),[c,g]=p.useState(!1),[u,b]=p.useState({deals:[],news:[]}),[m,y]=p.useState({deals:!1,news:!1}),[w,f]=p.useState(null),[v,E]=p.useState(""),k=p.useCallback(async R=>{if(!i)return[];if(m[R])return u[R];f(R),E("");const x=Date.now(),q=await Cs(Np[R],i,o),C=700-(Date.now()-x);return C>0&&await new Promise(P=>window.setTimeout(P,C)),f(null),!q.ok&&q.error?(E(q.error),[]):(b(P=>({...P,[R]:q.items})),y(P=>({...P,[R]:!0})),q.items)},[i,o,m,u]);p.useEffect(()=>{s&&k(s)},[s,k]);const j=p.useCallback(R=>u[R].map(xo).filter(Boolean),[u]),S=p.useMemo(()=>{var q,C;if(!i)return{deals:[],news:[]};const R={deals:j("deals"),news:j("news")},x=Qo("feed:"+i,R);return{deals:((q=x.deals)==null?void 0:q.noms)||[],news:((C=x.news)==null?void 0:C.noms)||[]}},[i,j]),A=p.useRef(null);p.useEffect(()=>{A.current&&!s&&i&&Ko("feed:"+i,{deals:j("deals"),news:j("news")}),A.current=s},[s,i,j]);const L=()=>{h(null),g(!1),r==null||r(!1)},F=R=>{const x=[],q=new Set,C=P=>{const H=P.trim();!H||q.has(H.toLowerCase())||(q.add(H.toLowerCase()),x.push(H))};R.forEach(P=>{gn(P)?ar(P.title||"").forEach(C):C(bo(P))}),x.length&&(a(x),L(),l(n.feedSent(x.length)))},O=R=>{const x=bo(R);x&&(window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x,url:(R.url||"").trim()}})),L(),l(n.feedPasted(x)),requestAnimationFrame(()=>{var q;(q=document.querySelector(".atl2 .eval-stick, .atl2 .demand"))==null||q.scrollIntoView({block:"center",behavior:"smooth"})}))},M=R=>{if(gn(R)){const x=(R.url||"").trim(),q=(R.title||"").trim();if(!x&&!q)return;window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x,text:q,auto:!0}})),L(),l(n.feedExtracting);return}O(R)},V=R=>{h(x=>{const q=x===R?null:R;return q&&g(!1),r==null||r(!!q),q})},Q=R=>{const x=u[R],q=new Set(S[R].map(P=>P.toLowerCase())),C=w===R||s===R&&!m[R]&&!v;return t.jsxs("div",{className:"dfpane"+(s===R?" on":"")+(c?" tall":""),hidden:s!==R,children:[t.jsxs("div",{className:"dfhow",children:[t.jsxs("div",{className:"dfhow-h",children:[t.jsx("p",{className:"dfh",children:R==="deals"?n.feedDealsH:n.feedNewsH}),t.jsxs("span",{className:"dfhow-acts",children:[t.jsx("button",{type:"button",className:"dffold",onClick:()=>g(P=>!P),children:c?n.feedShrink:n.feedExpand}),t.jsx("button",{type:"button",className:"dffold",onClick:L,children:n.feedFold})]})]}),t.jsx("p",{className:"dfh2",children:R==="deals"?n.feedDealsHow:n.feedNewsHow})]}),C&&t.jsxs("div",{className:"dfwait",role:"status","aria-live":"polite",children:[t.jsx("i",{className:"dfspin","aria-hidden":"true"}),t.jsxs("div",{children:[t.jsx("b",{children:R==="deals"?n.feedWaitDeals:n.feedWaitNews}),t.jsx("span",{className:"dfbar",children:t.jsx("i",{})})]})]}),s===R&&!!v&&t.jsx("p",{className:"dferr",children:v}),m[R]&&!x.length&&!w&&t.jsx("p",{className:"dfempty",children:R==="deals"?n.feedEmptyDeals:n.feedEmptyNews}),!!x.length&&!C&&t.jsxs(t.Fragment,{children:[R==="deals"&&d&&x.length>1&&t.jsxs("button",{type:"button",className:"dfall",onClick:()=>F(x),children:[n.feedPutAll," (",x.length,")"]}),t.jsx("ul",{className:"dflist",children:x.map((P,H)=>{const G=xo(P),Z=q.has(G.toLowerCase()),z=(P.url||"").trim();return t.jsxs("li",{className:Z?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:P.title||z}),t.jsx("span",{children:[P.source,P.sector_fr,(P.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[z&&t.jsx("a",{href:z,target:"_blank",rel:"noopener noreferrer",children:n.feedOpen}),d&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>M(P),children:gn(P)?n.rowExtract:n.feedPutEval})]})]},G||H)})})]})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(R=>{const x=S[R].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(R==="deals"?"ddeals":"dnews")+(s===R?" on":"")+(w===R?" busy":""),title:R==="deals"?n.feedDealsH:n.feedNewsH,"aria-expanded":s===R,"aria-busy":w===R||void 0,onClick:()=>V(R),children:[w===R?o==="en"?"Loading…":"Chargement…":R==="deals"?n.feedDeals:n.feedNews,x>0&&w!==R&&t.jsx("em",{title:n.feedHint,children:n.feedNew(x)})]},R)}),s&&Q(s)]})}function qp(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function vo(e){return(e||"").replace(/\*\*|__/g,"").replace(/`/g,"").trim()}function Tp(e){const a=[],r=[];for(const n of String(e||"").split(`
`)){const o=n.replace(/\s+$/,"");if(!o.trim()||o.trim()==="---"||/^\s*markmap:/.test(o)||/^\s+\w+:/.test(o))continue;const i=/^(#+)\s+(.*)/.exec(o);if(i){const c={title:vo(i[2]),kids:[]};a.push(c),r.length=0,r.push({indent:-1,node:c});continue}const d=/^(\s*)[-*+]\s+(.*)/.exec(o);if(!d)continue;const l=d[1].replace(/\t/g,"  ").length,s={title:vo(d[2]),kids:[]};for(;r.length&&r[r.length-1].indent>=l;)r.pop();const h=r.length?r[r.length-1].node:null;h?h.kids.push(s):a.push(s),r.push({indent:l,node:s})}return a}function Ai({nodes:e,depth:a=0}){return e.length?t.jsx("ul",{className:"rscats"+(a?" nested":""),children:e.map((r,n)=>t.jsx("li",{children:r.kids.length?t.jsxs("details",{open:a<1,children:[t.jsx("summary",{children:r.title}),t.jsx(Ai,{nodes:r.kids,depth:a+1})]}):t.jsx("span",{children:r.title})},n))}):null}function Lp(e){return`<!doctype html><html><head><meta charset="utf-8">
...
</body></html>`}function Fp({md:e,png:a,alt:r}){const{t:n}=K(),o=(e||"").trim(),i=Tp(o);return!o&&!a&&!i.length?null:t.jsxs("section",{className:"rslive",children:[t.jsxs("div",{className:"rslive-h",children:[t.jsxs("b",{children:["🗺 ",n.rsMindmap]}),t.jsx("span",{children:n.rsMmTip})]}),t.jsxs("div",{className:"rslive-grid",children:[t.jsx("div",{className:"rslive-map",children:o?t.jsx("iframe",{className:"rs-mm-frame",title:r,sandbox:"allow-scripts",srcDoc:Lp(o)}):a?t.jsx("img",{className:"rslive-png",src:`data:image/png;base64,${a}`,alt:r}):null}),i.length>0&&t.jsxs("nav",{className:"rslive-cats","aria-label":n.rsMmCats,children:[t.jsx("b",{children:n.rsMmCats}),t.jsx("p",{className:"rslive-cat-hint",children:n.rsMmTip}),t.jsx(Ai,{nodes:i})]})]})]})}function Rp(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function wo({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=K();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function Op({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=K(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(wo,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(wo,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function qi({card:e,onEvaluate:a,onAddAll:r}){var s,h,c;const{t:n}=K(),o=[e.industry,...e.market_tags||[],e.author].map(g=>(g||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(g=>g&&g.url),l=qp(e.summary_md||"");return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(g=>t.jsx("span",{children:g},g))]}),t.jsx(Fp,{md:e.mindmap_md,png:e.mindmap_png_b64,alt:n.rsMindmap}),l.length>0&&t.jsxs("article",{className:"rsart",children:[t.jsx("b",{children:n.rsArticle}),l.map((g,u)=>t.jsx("p",{children:g},u))]}),t.jsx(Op,{card:e,onEvaluate:a,onAddAll:r}),(((h=e.prospective)==null?void 0:h.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((c=e.prospective)==null?void 0:c.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(g=>t.jsx("li",{children:g},g))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(g=>t.jsx("a",{href:g.url,target:"_blank",rel:"noopener noreferrer",children:g.label||g.url},g.url))})]})]})}function Mp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Dp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=K(),l=o,[s,h]=p.useState(null),[c,g]=p.useState(null),[u,b]=p.useState(null),[m,y]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const v=await Io({email:d,cbToken:l});f&&h(v)})(),()=>{f=!1}},[d,l,n]);const w=f=>{g(f),b(null),y(!0),(async()=>{const v=await As(f.id);b(v),y(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{g(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>w(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Mp(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(qi,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Ia=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ua(e){return/^https?:\/\//i.test((e||"").trim())}function ht(e){const a=(e||"").trim();return a?ua(a)?a:Ia.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Ip(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Pp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:h,caps:c,data:g,canWrite:u,source:b,dossiers:m,doAnalyse:y,liveMemos:w,pipe:f}=K(),v=r==="client",E=p.useMemo(()=>n||(b!=="default"?qs():""),[n,b]),[k,j]=p.useState(""),[S,A]=p.useState(!1),[L,F]=p.useState(""),[O,M]=p.useState(""),[V,Q]=p.useState(""),[R,x]=p.useState(!1),[q,C]=p.useState(!1),[P,H]=p.useState([]);p.useEffect(()=>{const N=_=>{const B=_.detail;B&&H(Y=>[B,...Y].slice(0,8))};return window.addEventListener("ppmap:evalcard",N),()=>window.removeEventListener("ppmap:evalcard",N)},[]);const[G,Z]=p.useState(!1),[z,$]=p.useState(!1),[D,X]=p.useState(!1),U=p.useRef(!1),[ee,ue]=p.useState(""),[fe,ve]=p.useState(""),[me,we]=p.useState(!1),[ze,he]=p.useState(!1),[ke,ge]=p.useState(0),[ie,I]=p.useState(""),[ae,pe]=p.useState(null),[se,ne]=p.useState(null),[te,de]=p.useState(!1),[je,re]=p.useState(null),[Ae,ye]=p.useState(0),Be=p.useRef(!1),Ie=p.useRef(()=>{}),Ue=k.trim()?Ia.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const N=new URLSearchParams(window.location.search),_=(N.get("rs")||"").trim(),B=(N.get("rstext")||"").trim();_&&/^https?:\/\//i.test(_)&&ue(_),B&&ve(B),(_&&/^https?:\/\//i.test(_)||B)&&Z(!0)},[]),p.useEffect(()=>{const N=_=>{const B=_.detail||{},Y=String(B.url||"").trim(),ce=String(B.text||"").trim(),le=Y&&/^https?:\/\//i.test(Y)?Y:"";le&&ue(le),ce&&ve(ce),(le||ce)&&(Z(!0),j(""),F(""),I(""),$(!1),we(!0),window.setTimeout(()=>we(!1),900),B.auto&&window.setTimeout(()=>{Ie.current({url:le,text:ce})},0))};return window.addEventListener("ppmap:research",N),()=>window.removeEventListener("ppmap:research",N)},[]),p.useEffect(()=>{const N=_=>{const B=_.detail||{},Y=String(B.name||"").trim();if(!Y)return;Z(!1),j(Y),F(Y);const ce=ht(String(B.website||B.domain||""));M(ce),Q(ht(String(B.url||""))),x(!ce),A(!0),window.setTimeout(()=>A(!1),900)};return window.addEventListener("ppmap:prefill",N),()=>window.removeEventListener("ppmap:prefill",N)},[]),p.useEffect(()=>{const N=(L||"").trim();if(!N||G||O){(O||!N||G)&&x(!1);return}const _=Ve(N),B=m.find(xe=>Ve(xe.name)===_)||m.find(xe=>{const Se=Ve(xe.name);return Se.length>=3&&(_.includes(Se)||Se.includes(_))}),Y=ht((B==null?void 0:B.website)||"")||ht((B==null?void 0:B.domain)||""),ce=ht((B==null?void 0:B.url)||"");if(ce&&Q(xe=>xe||ce),Y){M(Y),x(!1);return}let le=!0;return x(!0),Kn(N).then(xe=>{var Ee,at;if(!le)return;const Se=ht(xe.website||"")||ht(((at=(Ee=xe.candidates)==null?void 0:Ee[0])==null?void 0:at.url)||"");Se&&M(Se)}).catch(()=>{}).finally(()=>{le&&x(!1)}),()=>{le=!1}},[L,G,O,m]),p.useEffect(()=>{const N=_=>{var Y;const B=String(((Y=_.detail)==null?void 0:Y.url)||"").trim();ua(B)&&window.open(B,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",N),()=>window.removeEventListener("ppmap:view",N)},[]),p.useEffect(()=>{if(U.current===G)return;U.current=G,X(!0);const N=window.setTimeout(()=>X(!1),560);return()=>window.clearTimeout(N)},[G]),p.useEffect(()=>{if(typeof window>"u")return;const N=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),_=document.querySelector(".atl2.ops, .atl2.cibles");if(!N||!_)return;const B=_.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,Y=()=>{const le=parseFloat(window.getComputedStyle(N).top)||0,xe=N.getBoundingClientRect().top<=le+1;N.classList.toggle("is-stuck",xe),_.classList.toggle("url-stuck",xe);const Se=Math.round(N.getBoundingClientRect().height);_.style.setProperty("--demand-h",`${Se}px`);const Ee=window.matchMedia("(min-width: 861px)").matches;B&&Ee?_.style.setProperty("--pp-live-h",`${Math.round(B.getBoundingClientRect().height)}px`):_.classList.contains("cibles")&&_.style.setProperty("--pp-live-h","0px")};Y();const ce=new ResizeObserver(Y);return ce.observe(N),B&&ce.observe(B),window.addEventListener("scroll",Y,!0),window.addEventListener("resize",Y),()=>{ce.disconnect(),N.classList.remove("is-stuck"),_.classList.remove("url-stuck"),window.removeEventListener("scroll",Y,!0),window.removeEventListener("resize",Y)}},[b,S,me,q,G,D,R]),p.useEffect(()=>{if(!u&&!E){re(null);return}let N=!0;return(async()=>{const _=await Io({email:o,cbToken:E});N&&re(_.length)})(),()=>{N=!1}},[u,E,o,Ae]);const Wt=P.length?P:h,Re=g.credits,ot=p.useCallback(N=>{const _=kp(n,N);return C(!1),l({type:"ptab",tab:0}),requestAnimationFrame(()=>{const B=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!B)return;const Y=window.scrollY+B.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,Y),behavior:"smooth"})}),_},[n,l]);p.useEffect(()=>{if(!ze)return;ge(0);const N=window.setInterval(()=>ge(_=>_+1),1e3);return()=>window.clearInterval(N)},[ze]);const Ce=p.useMemo(()=>{const N=k.trim().toLowerCase();return!N||!f?null:m.find(_=>Ve(_.name)===N&&Te(_)===1)||null},[k,m,f]),it=()=>{const N=k.trim();if(N){if(Ce){y(Ce);return}i(null,N),v&&j("")}},Ft=(N,_,B,Y)=>{const ce=B.length?B:_,le=ot(ce)||0;Ep({title:(N.title||"").trim(),url:(N.source_url||"").trim(),cited:_,match:B,added:le,fallback:Y})},Qe=async N=>{var Y,ce,le;if(Be.current)return;const _=((N==null?void 0:N.url)??ee).trim().replace(/\s+/g,""),B=((N==null?void 0:N.text)??fe).trim();if(!_&&!B){I(e.rsNeed);return}if(!v&&!E){i(null,_||B.slice(0,80));return}Be.current=!0,I(""),pe(null),ne(null),he(!0);try{const xe=await Ls({url:_,text:B,email:o,cbToken:E});he(!1);const Se=Ke=>(Ke||[]).map(mt=>((mt==null?void 0:mt.name)||"").trim()).filter(Ci);if(!xe||xe.status!=="success"){const Ke=ar(B||(xe==null?void 0:xe.title)||"");if(Ke.length){const mt={status:"success",title:B||_,source_url:_,summary_md:e.rsNoteFallback,companies_cited:Ke.map(et=>({name:et})),prospective:{companies_to_evaluate:Ke.map(et=>({name:et}))}};I(""),pe(mt),Z(!1),Ft(mt,Ke,Ke,!0);return}pe(null),$(!0),I((xe!=null&&xe.message?xe.message+" — ":"")+e.rsNoteNone);return}pe(xe),Z(!1);const Ee=Se(xe.companies_cited),at=Se((Y=xe.prospective)==null?void 0:Y.companies_to_evaluate);Ft(xe,Ee,at,!1),ne({state:"pending"});const lt=await Fs(xe,{email:o,cbToken:E});ne(lt.ok?{state:"ok",scopeLabel:((ce=lt.summary)==null?void 0:ce.scope_label)||"",scope:((le=lt.summary)==null?void 0:le.scope)||""}:{state:"fail",msg:lt.error||""}),lt.ok&&ye(Ke=>Ke+1)}finally{Be.current=!1,he(!1)}};Ie.current=N=>{Qe(N)};const Nt=(se==null?void 0:se.state)==="pending",Rt=()=>{de(!0),requestAnimationFrame(()=>{var N;(N=document.querySelector(".atl2 .rsarch"))==null||N.scrollIntoView({block:"nearest",behavior:"smooth"})})},Ot=se&&(Nt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):se.state==="ok"?t.jsxs("button",{type:"button",className:"rslink ok",onClick:Rt,children:[se.scope&&se.scope!=="public"?e.rsSavedIn(se.scopeLabel||se.scope.replace(/^fund:/,"")):e.rsSaved," ",e.rsSavedOpen]}):t.jsx("span",{className:"rslink fail",title:se.msg,children:e.rsSaveFail})),wt=Rp(ae).length,Pe=G,st=(L||k).trim(),Ze=m.find(N=>Ve(N.name)===Ve(st)),St=ht(k)||O||ht((Ze==null?void 0:Ze.website)||"")||ht((Ze==null?void 0:Ze.domain)||""),zt=V||ht((Ze==null?void 0:Ze.url)||""),Mt=Ce?e.actAnalyse:st?e.evalGoOn(st.length>22?st.slice(0,21)+"…":st):e.evalGo,Gt=ze?`${Ts(ee.trim())==="youtube"&&ee.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ke)}`:Nt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Pe?" rs-mode":"")+(L&&k.trim()===L||S||me?" pair":"")+(S||me||D?" echo":"")+(D?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:Pe?a==="en"?"Extract companies from an article":"Extraire les sociétés d’un article":a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:Pe?a==="en"?"Paste an article or video URL — Stan lists the companies, then you pick which ones to screen.":"Collez l’URL d’un article ou d’une vidéo — Stan en sort les sociétés, vous choisissez lesquelles évaluer.":a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Pe?me:S)||D?" flash":"")+((Pe?ee.trim():Ia.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Pe?ee:k,placeholder:Pe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Pe?600:200,spellCheck:Pe?!1:void 0,inputMode:Pe?"url":void 0,onChange:N=>{if(Pe){ue(N.target.value);return}j(N.target.value),L&&N.target.value.trim()!==L&&(F(""),M(""),Q(""),x(!1))},onKeyDown:N=>{N.key==="Enter"&&(Pe?Qe():it())}}),t.jsx("span",{className:"detect"+(Pe?" off":"")+(Ia.test(k.trim())?" url":""),children:Ue})]}),t.jsx("span",{className:"dacts",children:Pe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ze?" loading":""),disabled:ze||Nt||!ee.trim()&&!fe.trim(),onClick:()=>{Qe()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Gt})]}),t.jsxs("a",{className:"viewbtn"+(ua(ee)?"":" off"),href:ua(ee)?ee.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:N=>{ua(ee)||N.preventDefault()},children:[t.jsx(Ip,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(an,{lang:a,storeKey:((Ce==null?void 0:Ce.name)||k).trim(),className:"evalbtn"+(Ce?" analyse":"")+(s?" loading":""),disabled:s,confirmLabel:Mt,onConfirm:it,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Mt})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(R?" searching":St?"":" off"),href:St||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":R||void 0,title:R?e.viewSiteBusyHint:e.viewSiteHint,onClick:N=>{St||N.preventDefault()},children:[R&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),R?e.viewSiteBusy:e.viewSite,!R&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(zt?"":" off"),href:zt||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:N=>{zt||N.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),c.showCredits&&Re&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(Re.total_available<=0&&!Re.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Re.unlimited?"∞":Re.total_available}),!Re.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Re.daily_grant+Re.purchased]}),Re.total_available<=0&&!Re.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),C(!1),requestAnimationFrame(()=>{const N=document.querySelector(".atl2.cibles .desk-list");if(!N)return;const _=window.scrollY+N.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,_),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(G?" on":""),title:e.rsOpenHint,onClick:()=>Z(!G),children:e.rsOpen}),je!==null&&je>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(te?" on":""),onClick:()=>{te?de(!1):Rt()},children:e.rsArchOpen(je)}),c.pipe&&!!n&&t.jsx(Ap,{pageToken:E,onAddNames:ot,onPanel:()=>{$(!1)}})]}),te&&t.jsx(Dp,{bump:Ae,cbToken:E,onClose:()=>de(!1),onEvaluate:N=>i(null,N),onAddAll:ot}),t.jsx("div",{className:"rsp slim"+(G?" on":" off"),"aria-hidden":!G,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:G?void 0:-1,onClick:()=>$(N=>!N),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:z?"▴":"▾"})]}),t.jsx("button",{type:"button",className:"dffold",tabIndex:G?void 0:-1,onClick:()=>{Z(!1),$(!1),I("")},children:e.feedFold}),z&&t.jsx("textarea",{className:"rstext",value:fe,placeholder:e.rsTextPh,tabIndex:G?void 0:-1,onChange:N=>ve(N.target.value)})]})}),ie&&t.jsxs("div",{className:"rserr",children:[ie,t.jsx("button",{type:"button",className:"eq-note-x",title:e.rsClose,onClick:()=>I(""),children:"×"})]}),ae&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ae.title}),ae.source_url&&t.jsx("a",{href:ae.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{pe(null),ne(null)},children:"×"})]}),t.jsx(qi,{card:ae,onEvaluate:N=>i(null,N),onAddAll:ot}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(wt)}),Ot]})]}),Wt.slice(0,1).map((N,_)=>{const B=N.verdict==="kept",Y=N.verdict==="quota",ce=N.verdict==="unresolved",le=B?"var(--brand)":Y?"var(--bolt)":ce?"var(--blue)":"var(--red)",xe=B?"var(--brand-l)":Y?"#FFF3D6":ce?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":le,"--bgc":xe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:B?"✓ "+e.kept:Y?"⏳":ce?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),N.name&&t.jsx("span",{className:"rn",children:N.name}),t.jsx("span",{className:"rr",children:N.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",N.reason]}):null}),!!(N.candidates&&N.candidates.length)&&t.jsx("span",{className:"sitepick",children:N.candidates.map(Se=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Se.url.startsWith("http")?Se.url:`https://${Se.url}`,target:"_blank",rel:"nofollow noopener",children:[(Se.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Se.url,N.name),children:e.evalPickGo})]},Se.url))}),!Y&&!ce&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:B?1:5});const Se=(N.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ee=[...document.querySelectorAll(".atl2 .list .row")].find(at=>{var lt;return(((lt=at.querySelector(".rnm"))==null?void 0:lt.textContent)||"").trim().toLowerCase().includes(Se)});Ee&&(Ee.scrollIntoView({behavior:"smooth",block:"center"}),Ee.classList.add("flashrow"),window.setTimeout(()=>Ee.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(B?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},_)}),v&&(d.kept+d.dropped>0||Wt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function _p(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Bp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=K(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",_p(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=Lt(i),s=Yn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((h,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[qt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:s===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function nr({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=K(),[d,l]=p.useState(!1),[s,h]=p.useState(null),c=n.pipe&&o==="client"&&!n.lockActions,g=async()=>{if(!c||d)return;l(!0);const u=await Do(r,e);if(l(!1),!u){i(a.actErr);return}h(u.results||[])};return p.useEffect(()=>{if(!c)return;const u=b=>{var y;const m=String(((y=b.detail)==null?void 0:y.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&g()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,c]),p.useEffect(()=>{if(c)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),g())}catch{}},[e,c]),c?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{g()},children:d?a.similarBusy:a.similar}),s&&(s.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:s.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const $p=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),La=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function va(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function Wn(e){const a=va(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function Up(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=La(a.slice(n));break}r+=La(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=La(a.slice(o));break}const d=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(d),s=l?l[2].toLowerCase():"";l&&$p.has(s)?r+=`<${l[1]}${s}>`:r+=La(a.slice(o,i+1)),n=i+1}return r}const Hp=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),yo={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Ti(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(Hp.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const l=d.name.toLowerCase();(!(yo["*"].has(l)||((r=yo[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}Ti(n)}}function Pa(e){const a=e.cloneNode(!0);return Ti(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Vp={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},Wp=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,Gp=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function Ut(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function Li(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function xn(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?Li(e,n.index):""}function Yp(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const l=r[d],s=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(l),h=s?Ut(s[1]):"";if((d<2||/<th/i.test(l)||Wp.test(h))&&n.push(l),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function Qp(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=Yp(o,a);return r=r||i.pruned,i.html}),pruned:r}}function Kp(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=Li(e,i.index);let l=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(s=>Ut(s));if(!l.length){const s=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);s&&(l=[Ut(s[1])])}if(l=l.filter(s=>s&&!/not available/i.test(s)&&!/non disponible/i.test(s)).map(s=>s.slice(0,260)).slice(0,4),!l.length)return null;a[n]=l}return a}function Jp(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?Ut(n[1]).slice(0,600):""}function Xp(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(Ut(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function ko(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function bn(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function Zp(e){const a={...Vp,pruned:[]};if(!e)return a;try{const n=xn(e,"swot");n&&(a.swot=Kp(n))}catch{}try{a.summary=Jp(e)}catch{}try{const n=xn(e,"action-plan");if(n){const o=ko(n);a.plan=bn(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of Gp)try{let i=Xp(e,o,r);if(!i)continue;const d=Qp(i);i=bn(d.html,45e3),Ut(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=xn(e,"conviction");if(n){const o=bn(ko(n),8e3);Ut(o)&&(a.reco=o)}}catch{}return a}function ec(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const vn=new Map;function Fi(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=vn.get(a);return r||(r=tc(a).catch(()=>null),r.then(n=>{n||vn.delete(a)}),vn.set(a,r)),r}async function tc(e){var u,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=m=>{var y;return(((y=n.querySelector(m))==null?void 0:y.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((u=Array.from((i==null?void 0:i.classList)||[]).find(m=>m.startsWith("sb-score-")))==null?void 0:u.slice(9))||"",l=[];let s=null;const h=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const m of h){if(m.classList.contains("sb-nav-heading")){s={label:(m.textContent||"").trim(),items:[]},l.push(s);continue}const y=m.getAttribute("href")||"";if(!y.startsWith("#"))continue;const w=y.slice(1),f=nc(n,w);f&&(s||(s={label:"",items:[]},l.push(s)),s.items.push({id:w,title:(m.textContent||"").trim(),html:f,poids:f.length}))}const c=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",g={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(m=>(m.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:l.filter(m=>m.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?c:"",comite:ac(n,Zp(r))};return g.groups.length?g:null}function ac(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,Pa(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const Eo={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function nc(e,a){const r=e.getElementById(a),n=r?jo(e,r):"";if(n)return n;const o=Eo[a]?e.querySelector(Eo[a]):null;return o&&o!==r?jo(e,o):""}function jo(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Pa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(s=>/^h3$/i.test(s.tagName))[0]===a)for(const s of i){if(s===a)break;/^h2$/i.test(s.tagName)||o.appendChild(s.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?Pa(o):""}return Pa(a)}const wn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ye({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function rc({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function No(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function So({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const yn=new Map;function oc(e,a){const{token:r}=K(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=yn.get(i);d||(d=Rs(r,e.name,e.checkId),yn.set(i,d),d.then(s=>{(!s||!s.reasoning&&!s.summaryHtml)&&yn.delete(i)}));let l=!0;return d.then(s=>{l&&s&&o({id:e.id,d:s})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const ic=6e4;function sc({o:e}){const{t:a,doDeep:r}=K(),[n,o]=p.useState(null),[i,d]=p.useState(e.memoUrl?"load":"off"),[l,s]=p.useState(()=>new Set),[h,c]=p.useState(!1),g=p.useRef(new Map);p.useEffect(()=>{let w=!0;if(s(new Set),c(!1),g.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),Fi(e.memoUrl).then(f=>{w&&(o(f),d(f?"ok":"err"))}),()=>{w=!1}},[e.memoUrl]);const u=Lt(e),b=w=>{var f;return(f=g.current.get(w))==null?void 0:f.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[qt(e)&&t.jsx("button",{type:"button",className:"md-deep-txt",title:a.memoDeepHint,onClick:w=>{w.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"PDF ↗"})]}),y=e.memoUrl?t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull}):null;if(i==="off"){const w=[e.reasoning||"",No(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[w.length?w.join(`

`).split(`

`).map((f,v)=>t.jsx("p",{className:"cdtxt",children:f},v)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m,y]})}if(i!=="ok"){const w=[e.reasoning||"",No(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),w.length>0&&w.join(`

`).split(`

`).map((f,v)=>t.jsx("p",{className:"cdtxt",children:f},v)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:f=>{f.stopPropagation(),c(v=>!v)},children:h?a.memoHideHere:a.memoReadHere})}),h&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:f=>f.stopPropagation()}),m,y]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(w=>t.jsx("span",{className:"md-tag",children:w},w)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(w=>w.items.map(f=>t.jsx("button",{type:"button",className:"md-jump",onClick:v=>{v.stopPropagation(),b(f.id)},children:f.title},f.id)))}),n.groups.map((w,f)=>t.jsxs("div",{className:"md-grp",children:[w.label&&t.jsx("div",{className:"md-grp-h",children:w.label}),w.items.map(v=>{const E=v.poids>ic&&!l.has(v.id),k=v.id==="fiche-contact"||v.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:j=>{j&&g.current.set(v.id,j)},children:[t.jsx("h4",{className:"md-h",children:v.title}),k&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:j=>j.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:j=>j.stopPropagation(),children:"LinkedIn"})]}),E?t.jsx("button",{type:"button",className:"abtn md-more",onClick:j=>{j.stopPropagation(),s(S=>new Set(S).add(v.id))},children:a.memoUnfold(Math.round(v.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:k?v.html.replace(/>\s*unavailable(\s+unavailable)*\s*</gi,"><"):v.html}}),!E&&n.mindmapSlug&&v.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${ya}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:j=>j.stopPropagation()})]})]},v.id)})]},w.label||f)),m,y]})}function lc({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:l}=K(),[s,h]=p.useState(!1),[c,g]=p.useState(!1),[u,b]=p.useState(!1),[m,y]=p.useState(null),[w,f]=p.useState(""),[v,E]=p.useState(null),[k,j]=p.useState(""),S={airtableId:e.airtableId,checkId:e.checkId},A=!!(e.airtableId||e.checkId),L=m&&m.id===e.id?m.entries:[],F=!!m&&m.id===e.id;if(p.useEffect(()=>{f(""),E(null),b(!1)},[e.id]),p.useEffect(()=>{if(!s||F||!A||!o)return;let M=!0;g(!0),b(!1);const V=e.id;return wr(r,"list",S).then(Q=>{if(!(!M||V!==e.id)){if(g(!1),!Q.ok){b(!0);return}y({id:V,entries:Q.entries})}}),()=>{M=!1}},[s,F,A,r,e.id,o]),!n.pipe||!o||!A)return null;const O=(M,V)=>{g(!0);const Q=e.id;wr(r,M,S,V).then(R=>{if(Q===e.id){if(g(!1),!R.ok){d(a.notesErr);return}y({id:Q,entries:R.entries}),b(!1),M==="add"&&(f(""),i(a.notesAdded)),M==="edit"&&E(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":s,onClick:M=>{M.stopPropagation(),h(V=>!V)},children:[t.jsx("b",{children:a.notesT}),L.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(L.length)}),t.jsx("i",{children:s?"▾":"▸"})]}),s&&t.jsxs("div",{className:"dn-b",onClick:M=>M.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),c&&!L.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!c&&!u&&F&&!L.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),L.map(M=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:l==="fr"?M.date.split("-").reverse().join("/"):M.date}),v===M.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:V=>j(V.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||!k.trim(),onClick:()=>O("edit",{entryId:M.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>E(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:M.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{E(M.id),j(M.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:c,onClick:()=>{window.confirm(a.notesDelAsk)&&O("delete",{entryId:M.id})},children:a.notesDel})]})]})]},M.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:w,onChange:M=>f(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:c||!w.trim(),onClick:()=>O("add",{text:w.trim()}),children:a.notesAdd})]})]})]})}function rr({o:e}){var j;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=K(),l=ka(e),s=Lt(e),h=(e.cribleStatus||"").trim().toUpperCase()||(l==="NO MATCH"?"NO MATCH":l==="MATCH"?"MATCH":""),c=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,Wn(e.provUrl||""),Ba(e),e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,u=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(h?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||qt(e)?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:u}].filter(S=>S.n>0),[e,a,o,h,s,c,g,u]),[m,y]=p.useState(""),w=b.some(S=>S.k===m)?m:((j=b[0])==null?void 0:j.k)||"";p.useEffect(()=>{const S=A=>{var F;const L=String(((F=A.detail)==null?void 0:F.tab)||"");L&&b.some(O=>O.k===L)&&y(L)};return window.addEventListener("ppmap:card-tab",S),()=>window.removeEventListener("ppmap:card-tab",S)},[b]);const f=oc(e,w==="eval"||w==="conv");if(!b.length)return null;const v=((f==null?void 0:f.reasoning)||"").length>(e.reasoning||"").length?f.reasoning:e.reasoning||"",E=((f==null?void 0:f.summaryHtml)||"").length>(e.summary||"").length?f.summaryHtml:e.summary||"",k=(f==null?void 0:f.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(S=>t.jsx("button",{type:"button",role:"tab","aria-selected":w===S.k,"data-tour":"tab-"+S.k,className:w===S.k?"on":"",onClick:A=>{A.stopPropagation(),y(S.k)},children:S.lib},S.k))}),t.jsxs("div",{className:"cdbody",onClick:S=>S.stopPropagation(),children:[w==="eval"&&t.jsxs(t.Fragment,{children:[h&&t.jsxs("div",{className:"cdv1"+(h==="NO MATCH"?" out":""),children:[t.jsx("b",{children:h==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(So,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),v&&v.split(`

`).map((S,A)=>t.jsx("p",{className:"cdtxt",children:S},A)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(dc,{o:e})]}),w==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(So,{v:k,sur:100,k:a.cdConvScore}),wn(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",wn(e.verdictDate,r)]})]}),E&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Up(E)}})]}),w==="memo"&&t.jsx(sc,{o:e}),w==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ye,{k:a.cdSector,v:e.sector}),t.jsx(Ye,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(rc,{k:a.cdTags,vals:e.tags}),t.jsx(Ye,{k:a.cdStage,v:e.stage}),t.jsx(Ye,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ye,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ye,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ye,{k:a.cdAngle,v:e.angle}),t.jsx(Ye,{k:a.cdDetected,v:wn(e.date,r)}),t.jsx(Ye,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(Ye,{k:a.cdSrc,v:Wn(e.provUrl||""),href:va(e.provUrl||"")}),t.jsx(Ye,{k:a.cdAngleSrc,v:Ba(e)})]}),w==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ye,{k:a.cdName,v:e.contactName}),t.jsx(Ye,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ye,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(Ye,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),w==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(Ye,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(lc,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const Fa=new Map;function dc({o:e}){const{t:a,token:r}=K(),[n,o]=p.useState(!1),[i,d]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const g=`${r}:${e.name.toLowerCase()}`;let u=Fa.get(g);u||(u=Po(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),Fa.set(g,u),u.then(m=>{(!m||!m.ok)&&Fa.delete(g)}));let b=!0;return u.then(m=>{b&&m&&m.ok&&d(m)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const g=await Oo(r,e.name,e.website||e.domain||"");d(g),g.ok&&Fa.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(g)),o(!1)},s=(i==null?void 0:i.blocs)||{},h=[[a.qaVP,s.value_prop],[a.qaProduct,s.produit],[a.qaModel,s.modele],[a.qaSummary,s.synthese]],c=h.some(([,g])=>g);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&c&&t.jsxs(t.Fragment,{children:[h.filter(([,g])=>g).map(([g,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:g}),t.jsx("p",{children:u})]},g)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!c&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}const pc=1200,cc=675;function uc(e){return e.classList.contains("f-li")?{w:1080,h:1350}:{w:pc,h:cc}}function Ra(e){const a=e.firstElementChild;if(!a)return;a.style.maxWidth="none";const r=e.clientWidth;if(!r)return;const{w:n,h:o}=uc(a),i=r/n;a.style.transformOrigin="top left",a.style.transform=`scale(${i})`,e.style.height=`${Math.round(o*i)}px`,e.style.overflow="hidden"}let kn=null;const En="pp-article-style";let oa=null;function mc(){if(typeof document>"u"||document.getElementById(En))return Promise.resolve();if(oa)return oa;const e=r=>fetch(r).then(n=>n.ok?n.text():""),a=r=>Promise.all([e(`${r}/article.css`).catch(()=>""),e(`${r}/social-card.css`).catch(()=>"")]).then(([n,o])=>n||o?`${o}
${n}`:"");return oa=a("").then(r=>r||a("https://proplace.co")).then(r=>{if(!r||document.getElementById(En))return;const n=document.createElement("style");n.id=En,n.textContent=r,document.head.appendChild(n)}).catch(()=>{oa=null}),oa}function fc(e){if(typeof document>"u")return;const a=e instanceof Element?e:e.body;if(!a)return;const r=a.querySelector("details.ed-plus");r&&r.parentElement&&(r.open=!0,r.parentElement.insertBefore(r,r.parentElement.firstChild)),a.querySelectorAll(".art-allops li").forEach(n=>{if(n.dataset.edPretty==="1")return;n.dataset.edPretty="1",n.classList.add("ed-op"),Array.from(n.childNodes).forEach(u=>{u.nodeType===3&&/[—–]/.test(u.textContent||"")&&(u.textContent="")});const o=n.querySelector(".aa-n"),i=n.querySelector(".aa-d");if(o&&!o.closest(".aa-head")){const u=document.createElement("div");u.className="aa-head",o.replaceWith(u),u.appendChild(o),i&&u.appendChild(i)}const d=n.querySelector(".aa-meta");if(!d||d.querySelector(".aa-tag"))return;const l=!!n.querySelector(".ed-decrypt"),s=d.querySelector("a"),h=((s==null?void 0:s.textContent)||"").replace(/[→\s]+$/g,"").trim().toLowerCase(),c=(d.textContent||"").split("·").map(u=>u.replace(/→/g,"").trim()).filter(Boolean),g=document.createElement("div");g.className="aa-tags",c.forEach(u=>{const b=u.toLowerCase();if(h&&(b===h||b.endsWith(h)))return;const m=document.createElement("span");m.className="aa-tag",m.textContent=u,g.appendChild(m)}),d.replaceWith(g),s&&!l&&(s.className="aa-src",s.textContent=(s.textContent||"").replace(/\s*→\s*$/,"").trim(),g.after(s))})}function Ri(e=document){if(typeof window>"u")return;const a=Array.from(e.querySelectorAll(".ppcard-fit"));if(a.length){if(typeof ResizeObserver>"u"){a.forEach(Ra),window.addEventListener("resize",()=>a.forEach(Ra));return}kn||(kn=new ResizeObserver(r=>r.forEach(n=>Ra(n.target)))),a.forEach(r=>{Ra(r),r.dataset.fit!=="1"&&(r.dataset.fit="1",kn.observe(r))})}}const Gn=Object.freeze(Object.defineProperty({__proto__:null,beautifyEditoRows:fc,ensureEditoCss:mc,mountCardFits:Ri},Symbol.toStringTag,{value:"Module"}));function aa({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;return yr({kind:"op",card:e},1200).then(l=>{if(d||!l||!i.isConnected)return;const s=l.querySelector(".ppcard");s?(s.style.transform="",i.replaceChildren(s)):i.replaceChildren(l),i.parentElement&&Ri(i.parentElement)}),()=>{d=!0,i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;yr({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(s=>{!d&&s&&i.isConnected&&i.replaceChildren(s)});const l=s=>{s.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{d=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host ppcard-fit",title:"Agrandir",onClick:()=>o(!0)}),n&&ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const hc=`
...
`;function gc(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function xc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:s,doDecide:h,doPromote:c,doRepeche:g,doApproach:u,doDeep:b,doOnboard:m,outbound:y,evalBusy:w}=K(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const v=$e(f),E=Te(f),k=Lt(f),j=ka(f),S=f.kind==="target",A=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return ea.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:hc}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:gc(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(gt(f.date)),rt(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[f.cc]}),children:(ta(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Ht(f.amountEur,o)})]}),i.pipe&&S&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[_t(f.engine)," ",t.jsx("b",{children:rt(f.engine,o)})," — ",Os(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),v?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Tt,{o:f,lg:!0})," ",t.jsx(nn,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(_o(v,o))," · ",n.win7(Bo(v,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(aa,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&S&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&S&&t.jsx(rr,{o:f})]}),t.jsx(nr,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),E===1&&t.jsxs(an,{lang:o,storeKey:f.name,className:"evalbtn memo",style:{flex:1,justifyContent:"center"},confirmLabel:n.actAnalyse,onConfirm:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(f,!1),a({type:"popup",id:null})},children:n.actNo}),qt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),y&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:w,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function bc(){const{lang:e,token:a,dossiers:r,caps:n}=K(),o=a||"home",{names:i,verdicts:d}=p.useMemo(()=>{const s=[],h={};return r.forEach(c=>{c.kind!=="target"||!c.name||(s.push(c.name),h[c.name]=Ms(c)||"")}),{names:s,verdicts:h}},[r]);return{diff:p.useMemo(()=>i.length?Ds(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function vc(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:l}=K(),[s,h]=p.useState(!1),[c,g]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!s)return;const E=k=>{u.current&&!u.current.contains(k.target)&&h(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[s]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!d.length,y=p.useRef({});p.useEffect(()=>{y.current={...r}},[r]);const w=E=>{const k=y.current[E],j=k!==void 0?r[E]-k:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${fa[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E],E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(j>0?" up":j<0?" down":""),children:[r[E],j!==0&&t.jsxs("em",{className:"delta",children:[j>0?"+":"−",Math.abs(j)]})]})]},E)},f=(E,k,j)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),"data-off":E,style:{"--c":`var(${fa[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:j}),t.jsx("span",{className:"n",children:r[E]})]},E),v=(E,k,j,S=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:S,onClick:j,children:E},k);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(w)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[v("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(c?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:l.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}g(!0),window.setTimeout(()=>g(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":s,title:n.toolSort,onClick:()=>h(E=>!E),children:"⇅"}),s&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[k,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),v("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),v("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function wc(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,mode:l,data:s}=K(),h=p.useRef(null),[c,g]=p.useState(60);p.useEffect(()=>{let A=0;const L=()=>{var Q;const F=h.current;if(!F)return;const O=(Q=F.parentElement)==null?void 0:Q.querySelector('.funnel [aria-selected="true"]');if(!O)return;const M=O.getBoundingClientRect(),V=F.getBoundingClientRect();g(Math.max(20,Math.min(M.left+M.width/2-V.left,V.width-30)))};return A=requestAnimationFrame(L),window.addEventListener("resize",L),()=>{cancelAnimationFrame(A),window.removeEventListener("resize",L)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const A=i.filter(O=>O.kind==="target"&&Te(O)===3),L=A.filter(O=>zn(O)==="auto").length,F=A.filter(O=>zn(O)==="cd").length;b=r.tutoPending(L,F,A.length)}const m=(()=>{var A;if(l!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(L=>L.id)})};if(u===1){const L=i.filter(F=>F.kind==="target"&&Te(F)===1&&!d.has(F.id)).slice(0,10);if(L.length){const F=String(((A=s.credits)==null?void 0:A.plan)||"").toLowerCase(),O=F==="enterprise"||F==="entreprise";return{label:r.tuto[1].a,locked:!O,run:()=>{O&&a({type:"chainStart",queue:L.map(M=>M.id)})}}}}return null})(),y=Is(u),w=u===1||u===2,f=u===5,v=u===7,E=u===6,k=y||f||v,j=r.plabels[u]+" · "+(o[u]??0),S=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:h,className:"tuto mini"+(k?"":" on-dark")+(w?" etape-on":"")+(f?" etape-out":"")+(v?" etape-view":"")+(E?" etape-fav":""),style:{"--bg":`var(${fa[u]})`,"--ax":c+"px","--stc":k?"var(--ink)":"#fff","--stt":k?"#fff":"var(--ink)","--tc":k?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:j}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),m&&t.jsx("button",{type:"button",className:"tprim"+(m.locked?" lock":""),disabled:!!m.locked,title:m.locked?r.analyseLockHint:void 0,onClick:m.run,children:m.locked?"🔒 "+r.analyseLock:m.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:S})]})}const jn=600,At=62,zo="atl2:fstats";function yc(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=K(),[d,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(zo)==="on"}catch{return!1}}),s=r.stats,h=p.useMemo(()=>((s==null?void 0:s.by_day)||[]).slice(-30),[s]),c=(s==null?void 0:s.since)||"";if(!n.showFunnel||!s||typeof s.screened!="number")return null;const g=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,u=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((j,S)=>Math.max(j,S.s||0),0),m=h.length?jn/h.length:0,y=Math.max(4,m-4),w=h.length>=5&&b>0,f=r.marketEstimate||0,v=g(new Date().toISOString().slice(0,10)),E=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof s.kept=="number"?[[s.kept,e.funKept]]:[],...typeof s.analyzed=="number"?[[s.analyzed,e.funAnalyzed]]:[],...typeof s.shown=="number"?[[s.shown,e.funShown]]:[]],k=[];return typeof s.screened_window=="number"&&c&&k.push({cle:"fenetre",periode:e.funPerWindow(g(c),v),etapes:[[s.screened_window,e.funScreened("","")]]}),typeof s.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:E(s.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([S,A],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(S)}),t.jsx("i",{children:A})]},j.cle+A)),j.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((s.screened||0)/f*100)))})]}),j.cle==="total"&&(s.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),j.cle===k[k.length-1].cle&&w&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const S=!d;l(S),S&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(zo,S?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},j.cle)),d&&w&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${jn} ${At}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((j,S)=>{const A=(j.s||0)/b*(At-4),L=(j.m||0)/b*(At-4),F=S*m+(m-y)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===j.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}),onKeyDown:O=>{O.key!=="Enter"&&O.key!==" "||(O.preventDefault(),i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}))},children:[t.jsx("title",{children:`${g(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:F-1,y:0,width:y+2,height:At,fill:"transparent"}),t.jsx("rect",{x:F,y:At-2-A,width:y,height:A,fill:"#cfe0d6"}),t.jsx("rect",{x:F,y:At-2-L,width:y,height:L,fill:"#0E7F3F"})]},j.d)}),t.jsx("line",{x1:0,y1:At-1.5,x2:jn,y2:At-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:g(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Oi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function or({o:e,locked:a=!1}){const{t:r}=K(),n=ka(e),o=Lt(e),i=Te(e),d=zn(e),l=Ps(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Oi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(gd,{o:e})]})}const Zt=e=>e.length>22?e.slice(0,21)+"…":e;function wa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Mi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .fzone:has(.stage.folded), .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .fzone:has(.stage.folded), .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function kc({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const d=()=>{var m,y,w;const l=document.querySelector(".atl2.ops .desk-list"),s=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const h=l.getBoundingClientRect(),c=s?s.getBoundingClientRect().bottom:h.top;i({top:Math.round(c),left:Math.round(h.left),width:Math.round(h.width)});const g=[...l.querySelectorAll(":scope .grp")];let u=null;for(const f of g){const v=f.querySelector(".grp-h");v&&v.getBoundingClientRect().bottom<=c+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((y=b.querySelector(".t"))==null?void 0:y.textContent)||"").trim(),s:(((w=b.querySelector(".s"))==null?void 0:w.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Ec(e){const r=()=>{const n=Mi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Co({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=K(),[i,d]=p.useState(!1);if(p.useEffect(()=>{n||d(!1)},[n]),We(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const s=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(s?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Zt(e.name))})]})}function ma(e,a){e({type:"focus",id:a.id}),window.setTimeout(()=>{var r;window.dispatchEvent(new CustomEvent("ppmap:card-tab",{detail:{tab:"memo"}})),(r=document.querySelector(".atl2 .readpane"))==null||r.scrollIntoView({block:"nearest"})},40)}function ir({o:e}){const{t:a,lang:r,caps:n,memoQueued:o,approachDone:i,doAnalyse:d,doDecide:l,doPromote:s,doRepeche:h,doApproach:c,dispatch:g,liveMemos:u}=K(),b=y=>w=>{w.stopPropagation(),y()};if(n.lockActions){const y=b(()=>g({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:y,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const w=Te(e);return w===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:y,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Zt(e.name))})]})}):w===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:y,children:a.actAnalyse})}):w===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:y,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:y,children:a.actNo})]})}):w===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:y,children:a.actPromote})}):w===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:y,children:a.actApproach})}):w===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:y,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:y,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:y=>{y.stopPropagation(),wa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Ha(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:y=>{y.stopPropagation(),wa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!n.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Co,{o:e})});const m=Te(e);if(m===0)return t.jsx("span",{className:"cell",children:t.jsx(Co,{o:e})});if(m===1){const y=u.liveOf(e.name);if(y&&(y.status==="boot"||y.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ua,{item:y,serverOff:u.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const w=o.has(e.id);return t.jsx("span",{className:"cell cell-an",children:t.jsx(an,{lang:r,storeKey:e.name,className:"memobtn",disabled:w,confirmLabel:a.actAnalyse,onConfirm:()=>d(e),children:w?a.actAnalyseQueued:a.actAnalyse})})}if(m===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ma(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(m===4){const y=i.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:y,onClick:b(()=>c(e)),children:y?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:b(()=>g({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:b(()=>g({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return m===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ma(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):m===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>h(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ma(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>ma(g,e)),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function jc({o:e}){const{t:a,doThumb:r,thumbOf:n}=K(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Nc({o:e}){const{lang:a}=K();return $e(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Tt,{o:e}),t.jsx(nn,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[_t(e.engine||"")," ",rt(e.engine||"",a)]})})}function Sc({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:l}){const{dispatch:s,caps:h,markRow:c,markedId:g,favIds:u,toggleFav:b,t:m}=K(),y=Te(e),w=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=f<=0?0:f<=7?1:f<=30?2:3,E=h.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][y]:w[v],k=u.has(e.id),j=S=>{if(a)return;if(d){d(e.id);return}if(h.pipe||e.kind==="op"){n();return}const A=S.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:A.left+Math.min(280,A.width/3),y:A.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(g===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(h.pipe&&e.kind==="target"?" p"+y:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>c(e.id),onMouseLeave:()=>c(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx($i,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),$e(e)&&t.jsx(Tt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[h.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:S=>{S.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[tt(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(S=>S&&S!==e.name)||""]}),h.pipe&&!h.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:S=>S.stopPropagation(),children:[e.website&&t.jsx("a",{href:va(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowSite,title:m.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:va(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowLi,title:m.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":m.rowMail,title:m.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":m.rowTel,title:m.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:S=>{S.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Zt(e.acquirer)]}),He(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(zc,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Nc,{o:e}),h.pipe&&t.jsx(or,{o:e,locked:a}),h.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(ir,{o:e}),h.showThumbs&&t.jsx(jc,{o:e})]}),r&&!a&&!d&&t.jsx(qc,{o:e})]})}function zc({o:e}){const{lang:a,caps:r}=K();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ht(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Cc({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=K(),d=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),s=Ht(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=We(e),g=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),s&&t.jsx("span",{className:"oc-amt",children:s}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped})]}):tt(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),wa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Zt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(aa,{spec:e.card})})]})}function Ac({o:e}){const{t:a,lang:r,caps:n,dispatch:o,doDeep:i}=K();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const d=(e.date||"").slice(0,10).split("-").reverse().join("/"),l=[e.tagline,e.headline,e.reasoning].find(c=>c&&c!==e.name)||"",s=Ht(e.amountEur,r),h=(()=>{const c=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return c?c[1].replace(/^www\./,"").slice(0,40):""})();return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[rt(e.engine||"",r),d?` · ${d}`:"",s?` · ${s}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(ir,{o:e})})]}),(e.sector||e.countryLabel||e.stage||e.acquirer)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null,e.acquirer?t.jsxs("span",{children:["← ",e.acquirer]}):null]}),(e.memoUrl||qt(e))&&t.jsxs("div",{className:"zoom-memo-acts",children:[e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:c=>c.stopPropagation(),children:a.memoOpenFull}),qt(e)&&t.jsx("button",{type:"button",className:"md-deep-txt",title:a.memoDeepHint,onClick:c=>{c.stopPropagation(),i(e)},children:a.memoDeep})]}),(l||e.decryptHtml||e.url||e.card)&&t.jsxs("div",{className:"zoom-news",children:[l?t.jsx("p",{className:"zoom-lead",children:l}):null,e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):null,e.card?t.jsx("div",{className:"zoom-card",children:t.jsx(aa,{spec:e.card})}):null,e.url?t.jsxs("a",{className:"zoom-src",href:e.url,target:"_blank",rel:"nofollow noopener",children:[a.zoomSrc,h?` · ${h}`:""," ↗"]}):null]}),t.jsx(rr,{o:e})]})}function Di({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:s}=K(),h=p.useRef(null),c=He(e);if(p.useEffect(()=>{if(!c||!(e!=null&&e.decryptHtml))return;const x=h.current;if(!x)return;let q=!1;return Nn(()=>Promise.resolve().then(()=>Gn),void 0).then(async C=>{await C.ensureEditoCss(),!(q||!x.isConnected)&&(C.beautifyEditoRows(x),C.mountCardFits(x))}),()=>{q=!0}},[c,e==null?void 0:e.decryptHtml]),!e&&!a){const x=s.find(He);if(x)return t.jsx(Di,{o:x})}const g=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||g,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),y=e?!!e.noCo:!g||Kt(g),w=(e==null?void 0:e.engine)||"",f=He(e),v=e?Ht(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),j=s.find(He),S=((j==null?void 0:j.url)||"").trim(),A=!!u&&!!S&&(u===S||u.endsWith(S)||S.endsWith(u)),L=(x,q=!1)=>C=>{C.stopPropagation(),q&&d({type:"continent",key:"monde"}),d({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const F=()=>{g&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:g}}))},O=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},M=()=>{wa({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:g})},V=e?We(e):!1,Q=V&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",R=f?r.doEdito.replace(/^📖\s*/,""):w?rt(w,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[R,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(y||Ha({engine:w}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(aa,{spec:m})}),(u&&!A&&!f||j&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!A&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),d({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[V?t.jsxs("span",{className:"verdict",style:{"--c":Q?"var(--brand)":"var(--red)"},children:[Q?"✓":"✗"," ",t.jsx("b",{children:Q?r.kept:r.dropped})]}):!y&&g?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,g)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Zt(g))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(y||Ha({engine:w}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!y&&g?" ghost":""),onClick:x=>{x.stopPropagation(),M()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!y&&g&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),O()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Zt(g)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!y&&g&&l.pipe&&t.jsx(nr,{name:g})]})]})}function qc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=K();return!o.pipe&&e.kind==="op"?t.jsx(Cc,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(rr,{o:e}),t.jsx(xd,{o:e}),t.jsx(vd,{o:e}),t.jsx(nr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(or,{o:e})})]}),e.card&&t.jsx(aa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[_t(e.engine||"")," ",rt(e.engine||"",r)]}),$e(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Tt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function Tc({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:s}=K();if(!d.pipe&&e.kind==="op"){const g=Ht(e.amountEur,s),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,y=!1)=>w=>{w.stopPropagation(),y&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(aa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[_t(e.engine||"")," ",rt(e.engine||"",s)]}),$e(e)&&t.jsx(Tt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(ir,{o:e})})]})}const h=Te(e),c=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":c},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(or,{o:e}),$e(e)&&t.jsx(Tt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>ma(i,e),children:[o.actMemoOf(e.memoType)," →"]})]})}function Lc(){const{t:e}=K(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Fc({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=K(),i=o==="en",d=c=>n.plabels[c]||"",l=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),s=l.includes(0)?0:l.sort((c,g)=>(e[g]||0)-(e[c]||0))[0];if(s===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[s]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:s===0?i?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:i?`${h} ${h>1?"files":"file"} in “${d(s)}”`:`${h} dossier${h>1?"s":""} dans « ${d(s)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:s}),children:[(i?"Open ":"Ouvrir ")+d(s)," →"]})]})}function Rc(){var St,zt,Mt,Gt;const e=K(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:s,lang:h,sessTally:c,data:g,dossiers:u,source:b,focusExtra:m,byId:y,token:w}=e,f=Zo(),v=p.useMemo(()=>{var B,Y,ce,le;if(!w||b==="ops")return null;const N=(((B=f==null?void 0:f.ed)==null?void 0:B.date)||(f==null?void 0:f.day)||"").slice(0,10),_=[(Y=f==null?void 0:f.ed)==null?void 0:Y.html,(ce=f==null?void 0:f.ed)==null?void 0:ce.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((le=f==null?void 0:f.ed)==null?void 0:le.date)||N,decryptHtml:_||void 0,date:N,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[w,b,h,(St=f==null?void 0:f.ed)==null?void 0:St.html,(zt=f==null?void 0:f.ed)==null?void 0:zt.acquirers_html,(Mt=f==null?void 0:f.ed)==null?void 0:Mt.date,f==null?void 0:f.day]),E=N=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Xo,[k,j]=p.useState(new Set);p.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[S,A]=p.useState(null);p.useEffect(()=>{A(null)},[a.ptab,a.continent]);const[L,F]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){F(!1);return}const N=document.getElementById("atl2-stage");if(!N){F(!1);return}const _=new IntersectionObserver(([B])=>F(!!B&&B.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return _.observe(N),()=>_.disconnect()},[a.mapFolded]);const O=a.mapFolded||!L,M=N=>j(_=>{const B=new Set(_);return B.has(N)?B.delete(N):B.add(N),B}),V=b==="ops"||o.pipe,[Q,R]=p.useState("all"),[x,q]=p.useState(!1),[C,P]=p.useState(null),[H,G]=p.useState(!1),Z=p.useRef(!0);p.useEffect(()=>{if(Z.current){Z.current=!1;return}R("all"),G(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!H)return;const N=_=>{var B,Y;(Y=(B=_.target)==null?void 0:B.closest)!=null&&Y.call(B,".atl2 .doable")||G(!1)};return document.addEventListener("click",N,!0),()=>document.removeEventListener("click",N,!0)},[H]);const z=p.useMemo(()=>{var _;const N=new Map;for(const B of nd(((_=f==null?void 0:f.ed)==null?void 0:_.html)||""))N.has(B.t)||N.set(B.t,B.html);return N},[(Gt=f==null?void 0:f.ed)==null?void 0:Gt.html]),$=p.useCallback(N=>{if(N.decryptHtml)return N.decryptHtml;if(!z.size)return;const _=(N.name||"").trim().toLowerCase();if(_.length<3)return;const B=z.get(_);if(B)return B;for(const[Y,ce]of z)if(Y.includes(_)||_.includes(Y))return ce},[z]),{diff:D}=bc(),[X,U]=p.useState(!1),ee=a.filters.win==="1"&&!a.filters.day,[ue,fe]=p.useState(!1),[ve,me]=p.useState(!1),[we,ze]=p.useState(!1),he=N=>!He(N)&&(!o.pipe||N.kind!=="op"),ke=p.useMemo(()=>{const N={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(_=>he(_)&&gt(_.date)===0&&Pt(_,N,o.pipe)).length},[u,a,o.pipe]),ge=p.useMemo(()=>new Set(((D==null?void 0:D.added)||[]).map(N=>N.trim().toLowerCase()).filter(Boolean)),[D]),ie=p.useMemo(()=>{if(!ge.size)return 0;const N={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(_=>!He(_)&&ge.has((_.name||"").trim().toLowerCase())&&Pt(_,N,o.pipe)).length},[u,ge,a,o.pipe]);p.useEffect(()=>{const N=()=>{me(!1),q(!1),fe(!1),ze(!1),R("all"),G(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",N),()=>window.removeEventListener("ppmap:tunnel",N)},[]),p.useEffect(()=>{me(!1),q(!1),fe(!1),ze(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const I=p.useMemo(()=>{const N=l.filter(B=>!He(B)&&tt(B));let _="";for(const B of N){const Y=(B.date||"").slice(0,10);Y&&(!_||Y<_)&&(_=Y)}return{n:N.length,since:_?_.split("-").reverse().slice(0,2).join("/"):""}},[l]),ae=I.n,pe=p.useMemo(()=>o.pipe?u.filter(N=>N.kind==="target"&&!He(N)&&$e(N)&&(a.continent==="monde"||N.continent===a.continent)):u.filter(N=>$e(N)&&!We(N)),[o.pipe,u,a.continent]),se=pe.length,ne=p.useMemo(()=>{if(we)return Wa(pe,a.sort);const _=ve&&ge.size>0||a.filters.signalOnly||Q!=="all"||x||ue?l:d;let B=Wa(_,a.sort);return B=B.filter(Y=>!He(Y)),ue&&(B=B.filter(Y=>gt(Y.date)===0&&he(Y))),ve&&ge.size&&(B=B.filter(Y=>ge.has((Y.name||"").trim().toLowerCase()))),x||Q==="explore"?B=B.filter(tt):Q==="eval"?B=B.filter(Y=>!tt(Y)&&!Y.noCo&&(Y.kind==="op"||!We(Y))):o.pipe&&(B=B.filter(Y=>!tt(Y))),B},[d,l,a.sort,Q,ve,ge,x,ue,we,pe,o.pipe,a.filters.signalOnly]),te=p.useMemo(()=>o.pipe?ne:ne.filter(N=>!We(N)&&!N.noCo&&!tt(N)),[ne,o.pipe]),de=b==="ops"?ne.filter(tt).length:0,je=ue?n.morningList:we?n.sigList:ve?n.sinceList:o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,re=a.filters,Ae=re.sector.length+re.market.length+re.country.length+re.engine.length+re.stage.length+re.crible.length+re.angle.length+re.memoLevel.length+re.dealKind.length+(re.signalOnly?1:0)+(re.acquirer.trim()?1:0)+(re.search.trim()?1:0),ye=[];if(re.day)ye.push({k:"day",lib:n.fDay(re.day.slice(8,10)+"/"+re.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(re.win&&re.win!=="all"){const N=["1","7","30"].indexOf(re.win);N>=0&&ye.push({k:"win",lib:n.dates[N],off:()=>r({type:"filters",patch:{win:"all"}})})}const Be=N=>N.length<=2?N.join(", "):`${N.length} ${n.fSelected}`;for(const N of["sector","market","country","engine","crible"]){const _=re[N];_&&_.length&&ye.push({k:N,lib:Be(_),off:()=>r({type:"clearFacet",facet:N})})}re.search&&ye.push({k:"search",lib:"🔍 "+re.search,off:()=>r({type:"filters",patch:{search:""}})}),ve&&ge.size&&ye.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>me(!1)}),we?ye.push({k:"sig",lib:"🔴 "+n.sigDock(se),off:()=>ze(!1)}):re.signalOnly&&ye.push({k:"sig",lib:"🔴 "+n.sigDock(se||re.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const Ie=(N,_,B="",Y=!1)=>t.jsxs("button",{type:"button","data-s":N,className:B,"aria-sort":a.sort.key===N?a.sort.dir===1?"ascending":"descending":"none",style:Y?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:N}),children:[_,t.jsx("span",{className:"ar",children:a.sort.key===N&&a.sort.dir===1?"▴":"▾"})]},N),Ue=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const N=new Map;ne.forEach(Y=>{const ce=Y.engine||"?";N.has(ce)||N.set(ce,[]),N.get(ce).push(Y)});const _={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},B=Sn([...N.keys()],h);return[...N.entries()].sort((Y,ce)=>{const le=_[Y[0]]??10+B.indexOf(Y[0]),xe=_[ce[0]]??10+B.indexOf(ce[0]);return le-xe})},[ne,o.pipe,a.groupBy,h]),Wt=Ue?Ue.filter(([N])=>Ma.has(N)).length:0,Re=(()=>{var _;return((_=(Ue?Ue.flatMap(([,B])=>B):ne)[0])==null?void 0:_.id)??null})(),ot=p.useRef(!1),Ce=p.useMemo(()=>u.find(He)||v,[u,v]),[it,Ft]=p.useState(!1);p.useEffect(()=>{const N=()=>{ot.current=!0,me(!1)};return window.addEventListener("ppmap:reveal",N),window.addEventListener("ppmap:focus",N),()=>{window.removeEventListener("ppmap:reveal",N),window.removeEventListener("ppmap:focus",N)}},[]),p.useEffect(()=>{const N=()=>{Ce&&r({type:"focus",id:Ce.id})};return window.addEventListener("ppmap:edito",N),()=>window.removeEventListener("ppmap:edito",N)},[Ce,r]),p.useEffect(()=>{if(!a.focusId)return;P(a.focusId);const N=window.setTimeout(()=>P(null),900);return()=>window.clearTimeout(N)},[a.focusId]),p.useEffect(()=>{if(V&&!(a.focusId&&(ne.some(N=>N.id===a.focusId)||u.some(N=>N.id===a.focusId)||a.focusId===(Ce==null?void 0:Ce.id)))&&!m){if(Ce){r({type:"focus",id:Ce.id});return}Re&&r({type:"focus",id:Re})}},[V,a.focusId,ne,Re,m,r,u,b,Ce]),p.useEffect(()=>{if(!V||!a.focusId||Ce&&a.focusId===Ce.id||ne.some(_=>_.id===a.focusId))return;const N=u.find(_=>_.id===a.focusId);if(N){if(ot.current){N.kind==="op"?R(tt(N)?"explore":"eval"):Q!=="all"&&R("all");return}Q!=="all"&&Re&&r({type:"focus",id:Re})}},[V,a.focusId,Q,ne,u,Re,r,Ce]),p.useEffect(()=>{if(!V||!a.focusId||!ot.current)return;const N=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!N){const ce=ne.findIndex(le=>le.id===a.focusId);if(ce>=0){const le=Ue?"":"pt"+a.ptab;if(le){const xe=a.shown[le]||E();ce>=xe&&r({type:"more",group:le,by:ce-xe+8})}}return}ot.current=!1;const _=Mi(),B=N.getBoundingClientRect();B.top>=_-2&&B.bottom<=window.innerHeight-4||Ec(N)},[V,a.focusId,a.ptab,ne,a.shown,Ue,r]),p.useEffect(()=>{if(typeof window>"u")return;const N=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),_=document.querySelector(".atl2.ops, .atl2.cibles");if(!N||!_)return;const B=document.querySelector(".atl2 .fzone"),Y=()=>{_.style.setProperty("--listhead-h",`${N.offsetHeight}px`);const le=!!(B&&B.querySelector(".stage.folded"));_.style.setProperty("--fold-h",le&&B?`${B.offsetHeight}px`:"0px")};Y();const ce=new ResizeObserver(Y);return ce.observe(N),B&&ce.observe(B),()=>ce.disconnect()},[O,a.dens,a.mapFolded]);const Qe=p.useMemo(()=>{if(!V||!a.focusId)return null;if(v&&a.focusId===v.id)return v;const N=ne.find(B=>B.id===a.focusId)||u.find(B=>B.id===a.focusId)||null;if(!N)return null;const _=$(N);return _&&_!==N.decryptHtml?{...N,decryptHtml:_}:N},[V,a.focusId,ne,u,$,v]),Nt=o.lockRowsAfter;let Rt=0;const Ot=(N,_)=>{let B=a.shown[_]||E();return N.length-B<=4&&(B=N.length),N.slice(0,B).map(le=>{const xe=Nt!==null&&Rt>=Nt;Rt++;const Se=$(le),Ee=Se&&Se!==le.decryptHtml?{...le,decryptHtml:Se}:le,at=!V&&a.dens!=="maxi"&&(a.dens==="deplie"||(S?S==="open":!!Se)),lt=k.has(le.id)?!at:at,Ke=V?mt=>{ot.current=!0,r({type:"focus",id:mt});const et=y.get(mt);et&&(tt(et)?wa(et):et.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:et.name,url:et.url||"",website:et.website||"",domain:et.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Tc,{o:Ee,locked:xe,selected:V&&a.focusId===le.id,onSelect:Ke},le.id):t.jsx(Sc,{o:Ee,locked:xe,open:lt,onToggle:()=>M(le.id),selected:V&&a.focusId===le.id,echo:C===le.id,fresh:ge.has((le.name||"").trim().toLowerCase()),onSelect:Ke},le.id)})},wt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ne.length?"":" list-empty"),Pe=t.jsxs(t.Fragment,{children:[Ue?Ue.map(([N,_])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:_t(N)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:N==="ma"?n.grpMa:N==="fundraising"?n.grpLev:Ma.has(N)&&Wt<=1?n.grpNews:N==="nominations"?n.grpNom:N==="media"?n.grpNewsOther:N==="recrutements"?n.grpHire:Ma.has(N)?n.grpNews+" · "+rt(N,h):rt(N,h)}),t.jsx("div",{className:"s",children:n.grpCount(_.filter(B=>!We(B)).length,_.length)})]})]}),Ot(_,N)]},N)):Ot(ne,"pt"+a.ptab),g.loading&&!u.length&&t.jsx(Lc,{}),o.pipe&&a.ptab===0&&!x&&!ve&&!ue&&!we&&Q==="all"&&!a.filters.signalOnly&&!g.loading&&t.jsx(jp,{}),!ne.length&&!(g.loading&&!u.length)&&(o.pipe&&Q==="all"?t.jsx(Fc,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(re.win!=="all"||!!re.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),Ae>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(Ae)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),st=t.jsxs(t.Fragment,{children:[!x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+fa[a.ptab]+")"},children:ne.length})," ",je]}),x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+fa[a.ptab]+")"},children:ne.length})," ",n.newsWord]}),t.jsx("span",{className:"dot",children:"·"}),O&&!a.mapFolded&&t.jsx(Ni,{variant:"compact",mapToggle:!1}),t.jsxs("span",{className:"ctx",children:[O?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ye.map(N=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:_=>{_.stopPropagation(),N.off()},children:[N.lib,t.jsx("i",{children:"×"})]},N.k)),b==="ops"&&ne.length>0&&!O&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ne.length-de," ",n.zoomPulseEval,de>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",de," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),Ze=t.jsxs("div",{className:"listhead"+(O?" mapoff":""),children:[O&&t.jsx("div",{className:"lh-tools",children:t.jsx(ji,{compact:!0})}),o.showFunnel&&X&&ee&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(yd,{}),t.jsx(yc,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:st}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(vc,{}),t.jsx(wc,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ue?" on":""),"aria-pressed":ue,title:n.morningDockTitle,onClick:()=>{if(ue){fe(!1),U(!1);return}me(!1),q(!1),ze(!1),R("all"),fe(!0),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}}),U(!1)},children:["📊 ",n.morningDock(ke)]}),D&&!D.firstVisit&&(D.added.length>0||D.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ve?" on":""),"aria-pressed":ve,title:n.sinceSub,onClick:()=>{const N=!ve;me(N),q(!1),fe(!1),ze(!1),U(!1),R("all"),N&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(ie),D!=null&&D.lastDate?` · ${n.sinceSince(D.lastDate)}`:""]}),se>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(we?" on":""),"aria-pressed":we,onClick:()=>{ze(!we),me(!1),q(!1),fe(!1),U(!1),R("all"),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},children:["🔴 ",n.sigDock(se)]}),o.pipe&&ae>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(x?" on":""),"aria-pressed":x,title:n.newsDockHint,onClick:()=>{const N=!x;q(N),me(!1),fe(!1),ze(!1),U(!1),R("all"),N&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ae),I.since?` · ${n.newsSince(I.since)}`:""]})]}),!o.showFunnel&&st,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([N,_])=>t.jsxs("button",{type:"button","data-d":N,"aria-pressed":a.dens===N||N==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:N}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:_})]},N))}),!V&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":S==="open",onClick:()=>{A("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":S==="closed",onClick:()=>{A("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Se;const N={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},_=u.filter(Ee=>Pt(Ee,N,o.pipe)&&!He(Ee)),B=_.filter(Ee=>!tt(Ee)&&!Ee.noCo&&(Ee.kind==="op"||!We(Ee))).length,Y=_.filter(tt).length,ce=o.pipe?_.filter(Ee=>Ee.kind!=="op"&&Te(Ee)===1).length:0,le=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ce?` ${ce}`:""}`]]:[],["eval",`${n.doEval}${B?` ${B}`:""}`],["explore",`${n.doExplore}${Y?` ${Y}`:""}`]],xe=((Se=le.find(([Ee])=>Ee===Q))==null?void 0:Se[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":H,onClick:()=>G(Ee=>!Ee),children:[xe,t.jsx("i",{children:"▾"})]}),H&&t.jsx("div",{className:"dolist",children:le.map(([Ee,at])=>t.jsx("button",{type:"button","aria-pressed":Q===Ee,onClick:()=>{if(G(!1),Ee==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}R(Ee),Ee!=="all"&&(me(!1),q(!1),U(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:at},Ee))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:N=>r({type:"sort",key:N.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([N,_])=>t.jsx("option",{value:N,children:_},N))})]}),o.showChain&&t.jsxs("span",{className:"chainwrap"+(te.length===0?" empty":""),children:[t.jsxs("button",{type:"button",className:"chain",disabled:te.length===0,title:n.chainHint,onClick:()=>{te.length&&r({type:"chainStart",queue:te.map(N=>N.id)})},children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(te.length):n.chainAll(te.length)]}),!o.pipe&&t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!V&&Ze,a.dens!=="maxi"&&!V&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ie("country",n.colCountry),Ie("name",n.colCompany),Ie("amount",n.colAmount,"h-amt",!0),Ie("stage",n.colStage,"h-stade"),Ie("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ie("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ie("memo",n.colMemo)]}),o.pipe&&Ie("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),V?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[Ze,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ie("country",n.colCountry),Ie("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ie("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ie("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:wt,children:Pe})]}),t.jsxs("aside",{className:"readpane"+((Qe?He(Qe):!m&&Ce)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[Ce&&(()=>{const N=a.focusId===Ce.id&&!it,_=(Ce.headline||Ce.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":N,onClick:()=>{if(N){Ft(!0);return}Ft(!1),r({type:"focus",id:Ce.id})},children:[t.jsx("span",{className:"eg-t",children:h==="en"?"Today’s editorial":"Édito du jour"}),_&&t.jsx("span",{className:"eg-sub",children:_}),t.jsx("span",{className:"eg-chev",children:N?h==="en"?"Collapse ▴":"Replier ▴":h==="en"?"Read ▾":"Lire ▾"})]})})(),!!(Ce&&(Qe?He(Qe):!m))&&it?null:v&&a.focusId===v.id?t.jsx("div",{className:"zoom",children:t.jsx(ld,{})}):Qe&&o.pipe?t.jsx(Ac,{o:Qe}):t.jsx(Di,{o:Qe,extra:Qe?null:m})]})]}):t.jsx("div",{className:wt,children:Pe}),(()=>{const N=Ue||[["pt"+a.ptab,ne]];let _=0,B=0;for(const[ce,le]of N){B+=le.length;let xe=a.shown[ce]||E();le.length-xe<=4&&(xe=le.length),_+=Math.min(le.length,xe)}const Y=B-_;return Y<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>N.forEach(([ce,le])=>r({type:"more",group:ce,by:le.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(Y,Y)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(_,B)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}}),V&&b==="ops"&&a.dens!=="maxi"&&t.jsx(kc,{on:!!Ue,rev:(Ue||[]).map(([N,_])=>N+_.length).join("|")})]})}function Ao(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Oc(e,a){const r=_s(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Mc(e,a){const n=[a.head.split("|").map(Ao).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Oc(o,a.plabels),ka(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Ao).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Dc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Ic=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Je({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function ia({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function Pc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=K(),d=(e.cribleStatus||"").trim().toUpperCase()||(ka(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Lt(e),s=(a==null?void 0:a.blocs)||{},h=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Je,{k:n.cdSector,v:e.sector}),t.jsx(Je,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Je,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Je,{k:n.cdStage,v:e.stage}),t.jsx(Je,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Je,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Je,{k:n.cdName,v:e.contactName}),t.jsx(Je,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Je,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Je,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Je,{k:n.cdAngle,v:e.angle}),t.jsx(Je,{k:n.cdDetected,v:Ic(e.date,o)})]}),!!(e.provQuery||e.provUrl||Ba(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Je,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Je,{k:n.cdSrc,v:Wn(e.provUrl||""),href:va(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Je,{k:n.cdAngleSrc,v:Ba(e)})]})]}),h.some(([,c])=>c)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),h.filter(([,c])=>c).map(([c,g])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:c}),t.jsx("p",{children:g})]},c))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([c,g,u])=>t.jsxs("div",{className:"dssq "+c,children:[t.jsx("b",{children:g}),t.jsx("ul",{children:u.map(b=>t.jsx("li",{children:b},b))})]},c))})]}),t.jsx(ia,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(ia,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(ia,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(ia,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(ia,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function _c(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:l}=K(),[s,h]=p.useState({}),[c,g]=p.useState({}),u=25,b=12,m=p.useMemo(()=>{if(l.dossierId){const f=n.find(v=>v.id===l.dossierId)||i.dossiers.find(v=>v.id===l.dossierId);return f?[f]:n.slice(0,u)}return n.slice(0,u)},[n,l.dossierId,i.dossiers]);p.useEffect(()=>{m.length&&Po(r,m.map(f=>f.name)).then(h)},[r,m]),p.useEffect(()=>{const f=m.filter(k=>!!k.memoUrl).slice(0,b);if(!f.length){g({});return}let v=!1;const E={};return(async()=>{for(const k of f){if(v)return;try{const j=await Fi(k.memoUrl||"");if(v)return;j&&ec(j.comite)&&(E[k.id]=j.comite,g({...E}))}catch{}}})(),()=>{v=!0}},[m]);const y=i.stats,w=f=>f.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(m.length)}),!l.dossierId&&n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),y&&typeof y.screened=="number"&&t.jsxs("p",{children:[w(y.screened)," ",e.funScreened(""),typeof y.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",w(y.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(w(i.marketEstimate)),", ",Math.round(y.screened/i.marketEstimate*100)," %"]})]})]}),m.map(f=>t.jsx(Pc,{o:f,qa:s[f.name],comite:c[f.id]},f.id)),!m.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Bc=50;function sr({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=K(),[i,d]=p.useState(null),[l,s]=p.useState(!1),[h,c]=p.useState(""),[g,u]=p.useState(0),[b,m]=p.useState(""),[y,w]=p.useState(!1),[f,v]=p.useState(0),E=p.useRef(null),k=p.useRef(null),j=()=>{v(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>v(F=>F+1),1e3)},S=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),k.current&&window.clearInterval(k.current)},[]);const A=async F=>{s(!0),c(""),j();const O=await a();if(s(!1),S(),O.ok){d(O);return}if(O.busy){c(o.alertPreviewBusy);return}if(!F){c(o.alertPreviewFail);return}u(Bc),S(),E.current=window.setInterval(()=>{u(M=>M>1?M-1:(E.current&&window.clearInterval(E.current),A(!1),0))},1e3)},L=async()=>{if(n||y||l)return;w(!0),m(""),j();const F=await r();w(!1),S(),m(F.ok?o.alertTestOk(F.sentTo||""):F.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||y||g>0,onClick:()=>{A(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||y||l,onClick:()=>{L()},children:y?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),y&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),g>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(g)}),h&&t.jsx("p",{className:"mnote warn",children:h}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const jt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Xe({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=K(),l=o==="plug"?"min(720px,100%)":"min(760px,100%)";return ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:l}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function $c(){const{st:e}=K();switch(e.modal){case"chain":return t.jsx(Hc,{});case"space":return t.jsx(Vc,{});case"alert":return t.jsx(Wc,{});case"queue":return t.jsx(Jc,{});case"export":return t.jsx(Xc,{});case"plug":return t.jsx(tu,{});case"approach":return t.jsx(au,{});case"recharge":return t.jsx(ou,{});case"cover":return t.jsx(su,{});case"dossier":return t.jsx(iu,{});case"crit":return t.jsx(cu,{});case"tuto":return t.jsx(uu,{});case"rdv":return t.jsx(Uc,{});case"memoalert":return t.jsx(Zc,{});default:return null}}function Uc(){const{dispatch:e,fund:a,t:r}=K(),n=a||r.rdvCoFallback;return ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Uo,children:$o}),r.rdvSubMid,t.jsx("a",{href:`mailto:${$a}`,children:$a})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(hl,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Hc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:s,memoQueued:h,doAnalyse:c}=K(),g=i==="client",u=e.chain.queue.map(w=>r.get(w)).filter(w=>!!w),b=e.chain.idx,m=u[b],y=b>=u.length;return ea.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:y?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(y?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:y||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[ta(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(gt(m.date))].filter(Boolean).map(w=>String(w)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:rt(m.engine,o)}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Ht(m.amountEur,o)})]}),$e(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Tt,{o:m,lg:!0})," ",t.jsx(nn,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(g&&We(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),g&&We(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":It(m)==="retenu"?"var(--brand)":It(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:It(m)==="retenu"?"✓ "+n.kept:It(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!y&&m&&s.pipe&&Te(m)===1&&!h.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!y&&m&&!(g&&We(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var w;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(w=document.querySelector(".atl2 .demand"))==null||w.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(y?{type:"modal",modal:null}:{type:"chainNext"}),children:y?n.closeBtn:n.skip})]})]})})}),document.body)}function Vc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=K(),i=o==="client",d=p.useMemo(()=>i?r.filter(g=>We(g)):[],[r,i]),l=p.useMemo(()=>Wa(d.filter(g=>It(g)==="retenu"),{key:"signal",dir:-1}),[d]),s=p.useMemo(()=>d.filter(g=>It(g)==="ecarte"),[d]),h=e.spaceTab==="retenu"?l:s,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Xe,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:s.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(g=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof g.score=="number"&&g.score>0?g.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:g.name}),t.jsx("div",{className:"rr",children:g.reasoning||g.tagline||""})]})]},g.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Wc(){const{mode:e}=K();return e==="client"||e==="apercu"?t.jsx(Gc,{}):t.jsx(Kc,{})}function Gc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),[i,d]=p.useState("d"),l=o!=="client";return t.jsxs(Xe,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Yc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(Qc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(Ii,{})]})}function Yc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[l,s]=p.useState(!1),[h,c]=p.useState(0);p.useEffect(()=>{let L=!0;return s(!1),Sr(a).then(F=>{L&&(F?d(F):s(!0))}),()=>{L=!1}},[a,h]);const g=p.useRef({}),[u,b]=p.useState({}),[m,y]=p.useState(!1),[w,f]=p.useState(!1),v=p.useRef(null);p.useEffect(()=>()=>{v.current&&window.clearTimeout(v.current)},[]);const E=L=>{const F=g.current;Object.keys(F).length&&(y(!0),Sr(a,F).then(O=>{if(!O){y(!1),o(e.actErr);return}if(O.throttled&&L<3){v.current=window.setTimeout(()=>E(L+1),5400);return}if(g.current={},b({}),d(O),y(!1),O.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=L=>{r||(g.current={...g.current,...L},b(F=>({...F,...L})),v.current&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>E(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...u},S=L=>!j.sections||j.sections.includes(L),A=L=>{const F=j.sections||e.alertSec.map(([O])=>O);k({sections:S(L)?F.filter(O=>O!==L):[...F,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&w&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,F])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:S(L),disabled:r,onChange:()=>A(L)}),t.jsxs("span",{children:[F,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(sr,{label:e.alertPreview,readOnly:r,onPreview:()=>Zs(a),onTest:()=>Xs(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Qc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[l,s]=p.useState(!1),[h,c]=p.useState(0);p.useEffect(()=>{let m=!0;return s(!1),zr(a).then(y=>{m&&(y?d(y):s(!0))}),()=>{m=!1}},[a,h]);const g=m=>{r||zr(a,m).then(y=>{if(!y){o(e.actErr);return}d(y),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>g({dow:Number(m.target.value)}),children:e.alertDow.map((m,y)=>t.jsx("option",{value:y,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(sr,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>tl(a),onTest:()=>el(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ii(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=K(),[d,l]=p.useState(i||""),[s,h]=p.useState(!1),[c,g]=p.useState(!1);p.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(f=>$e(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,y=async()=>{if(!(!/.+@.+\..+/.test(d)||c)){g(!0);try{await fetch(`${ya}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{g(!1)}}},w=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>rt(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>ta(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return s?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:w.map(([f,v])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:v}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Kc(){const{t:e}=K();return t.jsx(Xe,{title:e.alertTitle,icon:"🔔",children:t.jsx(Ii,{})})}function Jc(){var x,q;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:s,liveMemos:h,data:c,flash:g}=K(),[u,b]=p.useState(()=>sn(r)),[m,y]=p.useState(()=>!sn(r)),[w,f]=p.useState([]),[v,E]=p.useState(0),[k,j]=p.useState(!1),S=n==="client",A=p.useMemo(()=>{const C=new Map;return o.forEach(P=>{const H=(P.name||"").trim().toLowerCase();H&&!C.has(H)&&C.set(H,P)}),C},[o]);p.useEffect(()=>{let C=!0;return(!sn(r)||v>0)&&y(!0),(async()=>{const[P,H]=await Promise.all([Jn(r,v>0),Ho(a)]);C&&(P&&b(P),y(!1),f(H))})(),()=>{C=!1}},[a,r,v]);const L=m&&!u,F=(u==null?void 0:u.per_day)??0,O=((x=u==null?void 0:u.analyzed_today)==null?void 0:x.length)??0,M=u==null?void 0:u.offre,V=(u==null?void 0:u.pool_meta)||[],Q=p.useMemo(()=>{const C=new Map;for(const P of(u==null?void 0:u.scheduled)||[])for(const H of P.names||[])C.has(H)||C.set(H,{label:P.day_label,date:P.date});return C},[u==null?void 0:u.scheduled]),R=(u==null?void 0:u.in_progress)||[];return t.jsxs(Xe,{title:e.queueTitle,wide:!0,children:[M&&t.jsxs("div",{className:"qoffre"+(M.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:M.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:M.delai})]}),t.jsx("span",{className:"osp"}),M.rythme>0?t.jsx("span",{className:"or",children:e.qRate(M.rythme)}):M.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(M.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:L?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(O,O+(((q=u==null?void 0:u.pool_order)==null?void 0:q.length)??0))}})}),M&&t.jsxs("div",{className:"qeta",children:[M.file===0?e.qEtaDone:M.rythme<=0?e.qEtaPaused:e.qEta(M.file,M.rythme,M.jours_restants),M.en_retard&&t.jsxs("em",{children:[" ",e.qLate(M.delai,M.plafond)]})]}),!L&&t.jsxs("div",{className:"qrate",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate})," — ",t.jsx("b",{children:e.covRateNow(F)}),(M==null?void 0:M.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]}),S&&t.jsx("div",{className:"covrb",role:"group","aria-label":e.covRate,children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:F===C?"on":"",disabled:k,title:C===0?e.identPauseTitle:e.covRateNow(C),onClick:()=>{k||!a||(j(!0),Vo(a,C).then(P=>{j(!1),P!==null&&(b(H=>H&&{...H,per_day:P}),g(e.alertSaved))}))},children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint}),!!c.credits&&!c.credits.unlimited&&!!(c.credits.packs||[]).length&&t.jsxs("div",{className:"qpacks-mini",children:[t.jsxs("span",{children:[e.creditsCap," ",c.credits.total_available,"/",c.credits.daily_grant+c.credits.purchased," · ",e.creditsPacksLbl]}),t.jsx("div",{children:c.credits.packs.map(C=>t.jsxs("button",{type:"button",className:"qpack-mini",onClick:()=>{const P=c.email;if(!P)return;const H=window.location.href.split("?")[0];fetch(`${ya}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:P,lookup_key:C.lookup_key,success_url:H+"?credits=ok",cancel_url:H+"?credits=cancel"})}).then(G=>G.json()).then(G=>{G.url&&(window.location.href=G.url)}).catch(()=>{})},children:[C.credits," · ",C.price_eur," €"]},C.lookup_key))})]})]})]}),(R.length>0||h.items.some(C=>C.status==="boot"||C.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(C=>C.status==="boot"||C.status==="running"||C.status==="error").map(C=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:C.name}),t.jsx("span",{className:"qd",children:C.memoType||""}),t.jsx(Ua,{item:C,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+C.name)),R.filter(C=>!h.liveOf(C.name)).map(C=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:C.name}),t.jsxs("span",{className:"qd",children:[C.memo_type||"",C.age_min?` · ${Math.round(C.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:C.state||""})]},"ip-"+C.name))]})]}),w.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:w.map(C=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:C.company}),t.jsxs("span",{className:"qd",children:[C.memo_type,typeof C.est_min=="number"?` · ~${C.est_min} min`:""]}),t.jsx("span",{className:"qt",children:C.status}),C.url&&t.jsx("a",{className:"qgo",href:C.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(C.memo_type)}),S&&C.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{jr(a,C.company,"retry").then(()=>E(P=>P+1))},children:e.queueRetry}),S&&C.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{jr(a,C.company,"delete").then(()=>E(P=>P+1))},children:e.queueDelete})]},C.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",L?e.qUpNextWait:e.qUpNext(V.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[L&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!L&&V.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),V.map((C,P)=>{const H=Q.get(C.name),G=A.get((C.name||"").trim().toLowerCase()),Z=h.liveOf(C.name),z=!!(G&&d.has(G.id))||!!(Z&&(Z.status==="boot"||Z.status==="running")),$=!!(G&&Te(G)===1&&!G.memoUrl)&&!Z;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",P+1]}),H?t.jsx("span",{className:"qwhen"+(H.label==="demain"?" soon":""),children:H.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:C.name}),C.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof C.score=="number"&&t.jsx("span",{className:"qs2",children:C.score}),Z&&(Z.status==="boot"||Z.status==="running")&&t.jsx(Ua,{item:Z,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),$&&(l.lockActions||!S?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>s({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:z,onClick:()=>{i(G),E(D=>D+1)},children:z?e.actAnalyseQueued:e.actAnalyse})),C.excerpt&&t.jsx("span",{className:"qex",children:C.excerpt})]},C.name+":"+P)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([C,P])=>t.jsxs("li",{children:[t.jsx("b",{children:C})," — ",P]},C))})]})}function Xc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=K(),l=`${jt}/cibles/list.csv?token=${a}`,s=`${jt}/cibles/list.json?token=${a}`,h=`${jt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${l}")`,g=w=>{var f;(f=navigator.clipboard)==null||f.writeText(w).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:c},{def:e.exportLive,value:s,href:s},{def:e.exportXlsx,value:h,href:h}],b=!o.lockActions&&n.length>0,m=()=>{Dc(Mc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:w=>(e.stg.find(([f])=>f===w)||["",""])[1]})),r(e.exportViewDone(n.length))},y=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Xe,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:y,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:w,value:f,href:v})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:w[0]}),t.jsxs("div",{children:[t.jsx("b",{children:w[1]}),t.jsx("p",{children:w[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>g(f),children:e.exportCopy}),v&&t.jsx("a",{className:"exb",href:v,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},w[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Zc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),i=o!=="client",[d,l]=p.useState(null),[s,h]=p.useState(!1),[c,g]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return h(!1),kr(a).then(v=>{f&&(v?l(v):h(!0))}),()=>{f=!1}},[a,c]);const m=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},y=f=>{if(i||!d)return;const v={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??m()};b(!0),kr(a,v).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}l(E),r(e.memoAlertSaved)})};if(s)return t.jsx(Xe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>g(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(Xe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const w=m();return t.jsxs(Xe,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>y({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(eu,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>y({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!w[f],disabled:i||u,onChange:()=>y({sections:{...w,[f]:!w[f]}})}),t.jsx("span",{children:v})]},f))}),t.jsx(sr,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>$s(a,w),onTest:()=>Bs(a,w)})]})}function eu({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=p.useState(e);p.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),s=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&l&&s&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!s,onClick:()=>o(i.trim()),children:n})]})]})}function tu(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=K(),[i,d]=p.useState(null),[l,s]=p.useState(!1),[h,c]=p.useState(null),[g,u]=p.useState(!1),[b,m]=p.useState(""),[y,w]=p.useState(0),[f,v]=p.useState("webhook"),[E,k]=p.useState("webhook"),[j,S]=p.useState(""),A=p.useRef(!1);p.useEffect(()=>{let C=!0;return s(!1),Er(a).then(P=>{C&&(P?d({configured:P.configured,url_hint:P.url_hint}):s(!0))}),Ws(a).then(P=>{if(C){if(!P){u(!0);return}u(!1),c(P),A.current||(A.current=!0,P.destination==="instantly"&&(v(H=>H==="webhook"?"instantly":H),k(H=>H==="webhook"?"instantly":H)),P.campaign_id&&S(H=>H||P.campaign_id||""))}}),()=>{C=!1}},[a,y]);const L=(C,P)=>{o&&Er(a,C).then(H=>{if(!H||H.ok===!1){n(e.actErr);return}C.test&&H.sent===!1?n(e.plugTestThrottled):r(P),w(G=>G+1)})},F='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',O=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),M=`curl -X POST ${jt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,V=`curl -X POST ${jt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,Q=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugDestInstS},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],R=E==="instantly"?e.plugStep2Inst:E==="script"?e.plugStep2Script:e.plugStep2Wh,x=E==="instantly"?e.plugAideInst:E==="script"?e.plugAideScript:e.plugAideWh,q=C=>{k(C),C!=="script"&&v(C)};return t.jsxs(Xe,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[h&&t.jsxs("div",{className:"plugetat"+(h.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:h.enabled?e.plugEtatOn:e.plugEtatOff})]}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>w(C=>C+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:Q.map(C=>{const P=E===C.k;return t.jsxs("button",{type:"button",className:"plugdest"+(P?" on":""),onClick:()=>q(C.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:C.t}),t.jsx("em",{children:C.s})]},C.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:R})]}),E==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):E==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:j,disabled:!o,onChange:C=>S(C.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:C=>m(C.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>L({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>L({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>L({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:x}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(nu,{auto:h,autoKo:g,destKind:f,camp:j,onRetry:()=>w(C=>C+1),onDone:C=>{c(C),u(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:O}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(O).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(ru,{destKind:f,setDestKind:C=>{v(C),k(C)},camp:j,setCamp:S,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),E!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:F}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(F).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:V}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(V).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function au(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:l}=K(),s=p.useMemo(()=>r.find(x=>x.id===n.approachId)||null,[r,n.approachId]),[h,c]=p.useState("email"),[g,u]=p.useState(0),[b,m]=p.useState({}),[y,w]=p.useState(!1),[f,v]=p.useState(""),[E,k]=p.useState({});if(p.useEffect(()=>{!s||b[h]||y||(w(!0),v(""),Vs(a,s.name,h).then(x=>{if(w(!1),!x||x.ok===!1){v((x==null?void 0:x.error)||e.apprFail);return}m(q=>({...q,[h]:x}))}))},[s,h,a]),!s)return null;const j=b[h],S=(j==null?void 0:j.sequence)||[],A=S[g],L=x=>`${h}|${g}|${x}`,F=x=>{const q=L(x);return q in E?E[q]:String(((A==null?void 0:A[x])??"")||"")},O=(x,q)=>k(C=>({...C,[L(x)]:q})),M=L("subject")in E||L("body")in E||L("message")in E,V=F(h==="email"?"body":"message"),Q=F("subject"),R=h==="email"&&Q?`${Q}

${V}`:V;return t.jsxs(Xe,{title:e.apprT(s.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(x=>t.jsx("button",{type:"button",className:"apch"+(h===x?" on":""),"aria-pressed":h===x,onClick:()=>{c(x),u(0)},children:x==="email"?e.apprChEmail:e.apprChLi},x)),t.jsx("span",{className:"sp"}),S.map((x,q)=>t.jsxs("button",{type:"button",className:"apday"+(g===q?" on":""),"aria-pressed":g===q,onClick:()=>u(q),children:[x.day||`J${q}`,[`${h}|${q}|subject`,`${h}|${q}|body`,`${h}|${q}|message`].some(C=>C in E)&&t.jsx("i",{children:"✎"})]},x.day||q))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,j!=null&&j.sender?" · "+e.apprSender(j.sender):""]}),y&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!y&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(x=>{const q={...x};return delete q[h],q}),v("")},children:e.retry})]}),!y&&!f&&!A&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),A&&t.jsxs(t.Fragment,{children:[h==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:Q,onChange:x=>O("subject",x.target.value)})]}),h==="linkedin"&&g===0&&(j==null?void 0:j.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:V,onChange:x=>O(h==="email"?"body":"message",x.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(R).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),h==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(s.contactEmail||"")}?subject=${encodeURIComponent(Q)}&body=${encodeURIComponent(V)}`,children:e.apprMailto}),M&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function nu({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:l,flash:s,flashErr:h,canWrite:c}=K(),[g,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),y=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,w=()=>{if(g||!c||m)return;u(!0),(b?Nr(l,!1):Nr(l,!0,r,n.trim()||void 0)).then(v=>{if(u(!1),!v){h(d.actErr);return}o(v),s(v.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:g||!c||!!m,title:m||void 0,onClick:w,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),m===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),y&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function ru({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:l,canWrite:s}=K(),[h,c]=p.useState("valides"),[g,u]=p.useState(!1),[b,m]=p.useState(null),[y,w]=p.useState(null),[f,v]=p.useState(!1),[E,k]=p.useState(!1),[j,S]=p.useState(null),[A,L]=p.useState(null),F=`atl2:bulk:${d}:${h}:${e}`;p.useEffect(()=>{m(null),w(null),v(!1),S(null);try{const G=localStorage.getItem(F)||localStorage.getItem(`atl2:bulk:${d}:${h}`),Z=JSON.parse(G||"null");L(Z&&Date.now()-Date.parse(Z.t)<24*3600*1e3?Z:null)}catch{L(null)}},[F,h,d]);const O=e==="instantly"&&!r.trim(),M=`${h}|${e}|${r.trim()}`,V=async()=>{if(O||!s)return;u(!0),v(!1),S(null);const G=await Ks(d,h,e,r.trim()||void 0);m(G),w(G.ok?M:null),u(!1)},Q=p.useRef(!1);if(!s)return null;const R=async()=>{if(Q.current||!s)return;Q.current=!0,k(!0);const G=`${d}:${h}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let Z;try{Z=await Js(d,h,e,r.trim()||void 0,G)}finally{Q.current=!1}if(k(!1),v(!1),S(Z),Z.ok&&(Z.pushed||0)>0){const z={t:new Date().toISOString(),n:Z.pushed||0};L(z);try{localStorage.setItem(F,JSON.stringify(z))}catch{}}};f&&y!==null&&y!==M&&v(!1);const x=o,q=b!=null&&b.ok&&b.ready||0,C=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":x||"",P=!!(b!=null&&b.ok)&&y===M&&q>0&&!!C&&!A,H=A?new Date(A.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:h,onChange:G=>c(G.target.value),children:i.plugBulkTabs.map(([G,Z])=>t.jsx("option",{value:G,children:Z},G))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:G=>a(G.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:G=>n(G.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:g||O,onClick:()=>{V()},children:g?"…":i.plugBulkPreview})]}),O&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),A&&t.jsx("p",{className:"mnote",children:i.bulkLocked(H,A.n)}),!A&&!!(b!=null&&b.ok)&&!C&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!A&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),P&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:i.bulkArm}),P&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(q,C)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{R()},children:E?i.bulkSending:i.bulkConfirm(C)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>v(!1),children:i.bulkCancel})]}),j&&(j.ok?j.replayed?t.jsx("p",{className:"mnote",children:j.pending?i.bulkPending:i.bulkReplayed}):(j.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(j.pushed||0,j.linkedinReady||0,j.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:j.error||i.actErr}))]})}function ou(){const{t:e,data:a,lang:r}=K(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const h=await(await fetch(`${ya}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Xe,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("b",{className:"pk-n",children:d.credits}),t.jsx("span",{className:"pk-u",children:e.creditsUnit}),t.jsxs("span",{className:"pk-p",children:[d.price_eur," €"]}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function iu(){const{t:e}=K();return t.jsx(Xe,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(_c,{})})}function su(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=K(),[s,h]=p.useState(null),[c,g]=p.useState(!1);p.useEffect(()=>{let F=!0;if(i)return Jn(i).then(O=>{F&&O&&typeof O.per_day=="number"&&h(O.per_day)}),()=>{F=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let F=!0;return Hs(o).then(O=>{F&&b(O)}),()=>{F=!1}},[o]);const m=r.stats,y=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(F=>F.kind==="target"&&We(F)).length,w=r.marketEstimate||0,f=w>0?Math.min(100,Math.round(y/w*100)):null,v=(m==null?void 0:m.window_days)||30,E=y>0?y/v:0,k=w>0?Math.max(0,w-y):0,S=w>0&&E>0&&y>=100?Math.round(k/E):null,A=F=>Math.round(F).toLocaleString(a==="en"?"en-US":"fr-FR"),L=F=>{c||!d||(g(!0),Vo(o,F).then(O=>{if(g(!1),O===null){l(e.actErr);return}h(O),l(e.alertSaved)}))};return t.jsxs(Xe,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(A(y))}),w>0&&t.jsx("span",{children:e.covOf(A(w))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),S!==null&&t.jsx("p",{className:"mnote",children:e.covEta(S)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(A(E))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:A(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((F,O)=>t.jsxs("tr",{className:F.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[F.code,F.geo?` · ${F.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof F.n=="number"?A(F.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:F.source}),F.elargi&&t.jsx("em",{children:e.covWide(String(F.demande||""))}),F.erreur&&t.jsx("em",{children:e.covMissing})]})]},O)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:A(u.total||w)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(F=>t.jsx("button",{type:"button",className:s===F?"on":"",disabled:c,onClick:()=>L(F),children:F===0?"⏸":F},F))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function Pi(e,a,r){const n=await fetch(`${jt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${jt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function lu(){const{t:e,token:a,canWrite:r}=K(),[n,o]=p.useState(null),[i,d]=p.useState(""),[l,s]=p.useState(""),[h,c]=p.useState(!1),g=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=p.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(g)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[g,n==null?void 0:n.pattern]);if(p.useEffect(()=>{if(!r)return;let m=!0;return Ys(a).then(y=>{m&&o(y)}),()=>{m=!1}},[a,r]),!r||h||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),Pi(a,n.instruction||"","atelier2-avis").then(m=>{if(d(m.applied?"ok":"ko"),m.applied||s(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(g,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{c(!0);try{localStorage.setItem(g,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function du(){var j;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=K(),[i,d]=p.useState(!1),[l,s]=p.useState(null),[h,c]=p.useState(!1),[g,u]=p.useState([]),[b,m]=p.useState(null),[y,w]=p.useState([]);if(!r)return null;const f=()=>{d(!0),c(!1),u([]),w([]),Qs(a).then(S=>{if(d(!1),!S){c(!0),s(null);return}s(S)})},v=S=>{b||(m(S.title),Pi(a,S.instruction,"atelier2-prop").then(A=>{m(null),A.applied?(w(L=>[...L,S.title]),n(e.propApplied)):A.encours?n(e.propSlow):o(A.reply||e.propApplyFail)}))},E=((l==null?void 0:l.proposals)||[]).filter(S=>!g.includes(S.title)&&!y.includes(S.title)),k=((j=l==null?void 0:l.counts)==null?void 0:j.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&h&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!h&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(k):e.propNone}),E.map(S=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[S.section]||S.section}),t.jsx("p",{className:"propt",children:S.title}),S.why&&t.jsx("p",{className:"mnote dim",children:S.why}),S.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",S.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>v(S),children:b===S.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(A=>[...A,S.title]),children:e.propSkip})]})]},S.title))]})}function pu(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=K(),[l,s]=p.useState(null),[h,c]=p.useState(!1),[g,u]=p.useState(!1),[b,m]=p.useState(""),[y,w]=p.useState(""),[f,v]=p.useState(!1),E=p.useRef(!1);if(p.useEffect(()=>{if(!a||!r)return;let S=!0;return Gs(a).then(A=>{S&&(c(!0),!(!A||E.current)&&(s(A),m(A.fit),w(A.note)))}),()=>{S=!1}},[a,r]),!r)return null;const k=()=>{if(!(!b||f)){if(l&&l.fit===b&&l.note===y.trim()){u(!1);return}v(!0),kt(a,"thesis_fit",b,y.trim(),"",d.email||"").then(S=>{if(v(!1),!S.ok){o(e.fitKo);return}s({fit:b,note:y.trim(),ts:new Date().toISOString()}),u(!1),n(e.fitSaved)})}},j=S=>S==="yes"?e.fitYes:S==="partial"?e.fitPartial:e.fitNo;if(l&&!g){const S=new Date(String(l.ts||"")),A=Number.isNaN(S.getTime())?"":S.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:j(l.fit)}),l.note?` — ${l.note}`:""]}),!!A&&t.jsx("p",{className:"mnote dim",children:A}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(S=>t.jsx("button",{type:"button","aria-pressed":b===S,className:"fitopt"+(b===S?" on":""),onClick:()=>{E.current=!0,m(S)},children:j(S)},S))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:y,onChange:S=>{E.current=!0,w(S.target.value)},onKeyDown:S=>{S.key==="Enter"&&k()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||f,onClick:k,children:f?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!h&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function cu(){var f,v,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=K(),s=n==="client",h=p.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[c,g]=p.useState(""),[u,b]=p.useState(""),[m,y]=p.useState(!1),w=async()=>{const k=c.trim();if(!(!k||m||!s)){y(!0),b("");try{const S=await(await fetch(`${jt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&b(String(S.reply)),S.job_id){b(e.critChatRunning);const A=async()=>{const L=await fetch(`${jt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(F=>F.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),y(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{A()},8e3)};setTimeout(()=>{A()},8e3),g("");return}g("")}finally{u.startsWith("⏳")||y(!1)}}};return t.jsxs(Xe,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((v=i==null?void 0:i.angles)!=null&&v.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,S;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(A=>t.jsx("li",{children:A},A))})]}),!!((S=k.out)!=null&&S.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(A=>t.jsx("li",{children:A},A))})]})]})]},k.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(pu,{}),t.jsx(lu,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!s||m,onChange:k=>g(k.target.value),onKeyDown:k=>{k.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!s||m||!c.trim(),onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(du,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Us,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Oi[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function uu(){const{t:e,dispatch:a,startTour:r}=K(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Xe,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const _i="atl2:mapfold",mu=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(_i);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},fu=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Bi=p.createContext(null),K=()=>{const e=p.useContext(Bi);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Tt({o:e,lg:a}){const{lang:r}=K(),n=$e(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Cr(n,r),children:[n.emoji," ",Cr(n,r)]}):null}function nn({o:e,src:a}){const{lang:r,t:n}=K(),o=$e(e);if(!o)return null;const i=ll(o),d=dl(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(_o(o,r))+" · "+n.win7(Bo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,s)=>t.jsx("i",{className:s<i?"on":""},s))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function hu(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ve(a);if(o)return e.find(i=>Ve(i.name)===o)||e.find(i=>{const d=Ve(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function gu(){const{scoped:e,t:a,st:r,dispatch:n}=K(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(g=>!He(g)),l=d.length,s=d.filter(g=>!g.noCo).length,h=d.filter(g=>!!g.noCo).length,c=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:c?"7":"all"}});else{const g=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:g,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",s," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function xu(){var y;const{t:e,lang:a,data:r,dispatch:n,dossiers:o,st:i,caps:d}=K(),l=w=>w.toLocaleString(a==="en"?"en-US":"fr-FR"),s={...i,filters:{...i.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}},h=o.filter(w=>!He(w)&&Pt(w,s,d.pipe)),c=h.length,g=h.filter(w=>Te(w)===1).length,u=h.filter(w=>Te(w)===2).length,b=typeof((y=r.stats)==null?void 0:y.screened)=="number"?r.stats.screened:0;if(c<=0&&b<=0)return null;const m=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:l(c)}),t.jsx("span",{children:m>0?e.covOf(l(m)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",l(g)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",l(u)," ",e.covAna]})]})]})}function bu(){var w;const{t:e,token:a,fund:r,dispatch:n,data:o}=K(),[i,d]=p.useState(null),[l,s]=p.useState(!0),[h,c]=p.useState([]),g=o.credits,u=!!g&&!g.unlimited;p.useEffect(()=>{if(!a||!r)return;let f=!0;return s(!0),(async()=>{const[v,E]=await Promise.all([Jn(r),Ho(a)]);f&&(v&&d(v),s(!1),c(E))})(),()=>{f=!1}},[a,r]);const b=(i==null?void 0:i.per_day)??null,m=((w=i==null?void 0:i.pool_order)==null?void 0:w.length)??0,y=h.filter(f=>f.status==="running").length;return t.jsxs("div",{className:"map-pulse map-engine",children:[t.jsxs("button",{type:"button",className:"map-engine-hit",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("em",{children:e.identEngine}),t.jsx("b",{children:b===null?"—":b}),t.jsx("span",{children:e.identPerDay}),t.jsxs("ul",{children:[b===0&&t.jsx("li",{children:t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause})}),y>0&&t.jsxs("li",{children:["⏳ ",y]}),t.jsx("li",{children:l?e.identPendingWait:e.identPending(m)})]})]}),t.jsxs("button",{type:"button",className:"map-engine-alert",title:e.memoAlertSub,onClick:()=>n({type:"modal",modal:"memoalert"}),children:["🔔 ",e.memoAlertBtn]}),u&&g&&t.jsxs("div",{className:"map-engine-credits",children:[t.jsx("em",{children:e.creditsCap}),t.jsxs("b",{children:[g.total_available,t.jsxs("span",{children:[" / ",g.daily_grant+g.purchased]})]}),t.jsx("span",{children:e.creditsToday})]})]})}function $i({o:e}){const{lang:a}=K(),r=sl(e.cc),n=e.cc?ta(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:16,height:16,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const vu=!1;function wu(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Ui=e=>`atl2:tour:${e||"anon"}`;function yu(e){try{return localStorage.getItem(Ui(e))==="1"}catch{return!0}}function qo(e){try{localStorage.setItem(Ui(e),"1")}catch{}}function ku(e,a,r,n,o,i,d,l){const s=e.tourT,h=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .map-pulse",title:s.cover,body:e.fhintCover,need:".atl2 .map-hud"}:null,{sel:".atl2 .map-engine",title:s.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:h[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:h[1][0]},{sel:".atl2 .dmulti.ddeals",title:s.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:s.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:s.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:s.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(c=>(l[c]||0)>0).map(c=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:c===2?s.tabAna:c===4?s.tabValid:s.tabRej,body:c===2?e.fhintTabAna:c===4?e.fhintTabValid:e.fhintTabRej,ptab:c})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:s.rank,body:e.fhintRank},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:s.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:h[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:h[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:s.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:s.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:s.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function zu({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var lr;const{lang:d}=al(),l=Xl(e,d,a),s=p.useMemo(()=>({...Pl[d],...Il(d,l.thesisMode)}),[d,l.thesisMode]),[h,c]=p.useReducer(td,void 0,()=>Zl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?fu():mu()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),g=p.useRef(!0);p.useEffect(()=>{if(g.current){g.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(_i,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const T=()=>{window.innerWidth<=760&&c({type:"mapFold",folded:!0})};return T(),window.addEventListener("resize",T),()=>window.removeEventListener("resize",T)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var T;(T=u.current)==null||T.call(u,h.filters)},[h.filters]);const[b,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const T=localStorage.getItem("atl2:chrome-mode");if(T==="eval"||T==="filt"||T==="both")return T;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[y,w]=p.useState(null),[f,v]=p.useState(null),[E,k]=p.useState(null),[j,S]=p.useState({kept:0,dropped:0}),[A,L]=p.useState(!1),[F,O]=p.useState(""),[M,V]=p.useState(!1),[Q,R]=p.useState(null),[x,q]=p.useState(null),[C,P]=p.useState(!1),[H,G]=p.useState(!1),[,Z]=p.useState(0),z=()=>Z(T=>T+1),$=p.useRef([]),D=p.useRef(new Set),X=p.useRef(new Set),[U,ee]=p.useState([]),[ue,fe]=p.useState([]),[ve,me]=p.useState(0),we=p.useRef(new Map),ze=p.useRef(null),{mode:he}=l,ke=p.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),ge=ke.pipe,ie=l.session.token||"",I=he==="client"&&!e;p.useEffect(()=>{if(!ie||!ge)return;let T=!0;const J=async()=>{const be=await pl(ie);!T||!be||(fe(be.runs),me(Date.now()/1e3-be.now),ee(Oe=>Oe.filter(qe=>!be.runs.some(Ge=>Ve(Ge.company)===Ve(qe.name)))))};J();const W=U.length>0||ue.some(be=>be.status==="running"),oe=window.setInterval(()=>{J()},W?8e3:25e3);return()=>{T=!1,window.clearInterval(oe)}},[ie,ge,U.length,ue.some(T=>T.status==="running")]),p.useEffect(()=>{if(!ie||!ge||!I)return;let T=!0;const J=async()=>{const oe=await cl(ie);if(!T||!oe.length)return;const be=new Map;oe.forEach(Oe=>{const qe=String(Oe.ceo_status||"").trim();qe&&Oe.check_id&&be.set(String(Oe.check_id),qe)}),l.patchStatuses(be,Oe=>Date.now()-(B.current.get(Oe)||0)>9e4)};J();const W=window.setInterval(()=>{J()},6e4);return()=>{T=!1,window.clearInterval(W)}},[ie,ge,I]);const ae=p.useMemo(()=>{const T=[],J=new Set;for(const W of U){const oe=Ve(W.name);!oe||J.has(oe)||(J.add(oe),T.push({name:W.name,id:W.id,status:"boot",started:W.started,estMin:W.estMin,memoType:"instant"}))}for(const W of ue){const oe=Ve(W.company);if(!oe||J.has(oe))continue;J.add(oe);const be=W.status==="error"?"error":W.status==="done"?"done":"running";T.push({name:W.company,status:be,started:W.started||0,estMin:W.est_min||(W.memo_type==="detailed"?40:15),url:W.url,error:W.error,memoType:W.memo_type,note:W.note})}return T},[U,ue]),pe=T=>ae.find(J=>Ve(J.name)===Ve(T))||null,se=(T,J)=>{ee(W=>W.some(oe=>Ve(oe.name)===Ve(T.name))?W:[...W,{name:T.name,id:T.id,started:Date.now()/1e3,estMin:J==="detailed"?40:15}]),D.current.add(T.id),z()},ne=(T,J=!1)=>{O(T),V(J),ze.current&&clearTimeout(ze.current),ze.current=setTimeout(()=>O(""),J?4200:2400)},te=T=>ne(T,!0),de=p.useMemo(()=>{const T=new Map;return l.dossiers.forEach(J=>{J.id&&T.set(J.id,J)}),T},[l.dossiers]),je=p.useMemo(()=>l.dossiers.filter(T=>Pt(T,h,ge)),[l.dossiers,h,ge]),re=p.useRef(!1);p.useEffect(()=>{if(re.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){re.current=!0;return}if(!ke.showFunnel||yu(l.session.token||"")){re.current=!0;return}re.current=!0;const T=window.setTimeout(()=>{qo(l.session.token||""),P(!0)},700);return()=>window.clearTimeout(T)},[e,l.loading,l.dossiers.length,ke.showFunnel,l.session.token]);const Ae=p.useMemo(()=>l.dossiers.filter(T=>ad(T,h,ge,l.favIds)),[l.dossiers,h,ge,l.favIds]),ye=p.useMemo(()=>nl(je.filter(T=>!tt(T)),l.favIds),[je,l.favIds]),Be=p.useRef(!1);p.useEffect(()=>{if(Be.current)return;if(!ge||a==="ops"){Be.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Be.current=!0;return}if(l.loading)return;Be.current=!0;const T=rl(ye);T!==h.ptab&&c({type:"ptab",tab:T})},[ge,a,n==null?void 0:n.ptab,l.loading,ye,h.ptab]);const Ie=p.useMemo(()=>{const T=ri(l.dossiers);return T?gt(T)===0?s.tourToday:oi(T,d):s.tourNoRun},[l.dossiers,s,d]),Ue=p.useMemo(()=>l.dossiers.some(T=>!!T.memoUrl||!!T.summary||qt(T)),[l.dossiers]),[Wt,Re]=p.useState(!1);p.useEffect(()=>{if(l.loading){Re(!1);return}if(l.dossiers.length>0||l.error){Re(!0);return}const T=window.setTimeout(()=>Re(!0),6e3);return()=>window.clearTimeout(T)},[l.loading,l.dossiers.length,l.error]);const ot=(l.marketEstimate||0)>0||typeof((lr=l.stats)==null?void 0:lr.screened)=="number"&&l.stats.screened>0,Ce=p.useMemo(()=>[1,0,2,4,5,3].find(T=>(ye[T]||0)>0)??0,[ye]),it=Qn.find(T=>T.key===h.continent),Ft=h.continent==="monde"?s.contWorld:(d==="fr"?it==null?void 0:it.fr:it==null?void 0:it.en)||"";p.useEffect(()=>{const T=J=>{var oe;const W=(((oe=J.detail)==null?void 0:oe.name)||"").trim();W&&Qe(null,W)};return window.addEventListener("ppmap:evaluate",T),()=>window.removeEventListener("ppmap:evaluate",T)}),p.useEffect(()=>{const T=J=>{const W=J.detail||{},oe=String(W.id||"").trim(),be=String(W.name||"").trim(),Oe=String(W.url||"").trim(),qe=oe&&de.get(oe)||hu(l.dossiers,be,Oe);if(qe){if(v(null),Pt(qe,h,ge)||(h.continent!=="monde"&&qe.continent!==h.continent&&c({type:"continent",key:qe.continent||"monde"}),c({type:"reset"})),ge&&qe.kind!=="op"){const xt=Te(qe);typeof xt=="number"&&xt!==h.ptab&&c({type:"ptab",tab:xt})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),c({type:"focus",id:qe.id}),(qe.noCo||["media","nominations","recrutements"].includes(qe.engine||""))&&(qe.url||qe.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:qe.url||"",text:[qe.headline,qe.tagline].filter(Boolean).join(`
`)}})):qe.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:qe.name,url:qe.url||"",website:qe.website||"",domain:qe.domain||""}}));return}!be&&!Oe||(c({type:"focus",id:oe||null}),v({name:be,headline:String(W.text||"").trim()||be,url:Oe,card:W.card}),Oe&&(Kt(be)||!be)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Oe,text:String(W.text||"").trim()}})):be&&!Kt(be)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:be}})))};return window.addEventListener("ppmap:focus",T),()=>window.removeEventListener("ppmap:focus",T)}),p.useEffect(()=>{const T=oe=>{const be={},Oe=String((oe==null?void 0:oe.sector)||"").trim();Oe&&(be.sector=[Oe]);const qe=String((oe==null?void 0:oe.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(qe)&&(be.day=qe);const Ge=String((oe==null?void 0:oe.search)||"").trim();Ge&&(be.search=Ge);const xt=String((oe==null?void 0:oe.dealKind)||"").trim();(xt==="ma"||xt==="levee"||xt==="other")&&(be.dealKind=[xt]),Object.keys(be).length&&c({type:"filters",patch:be})},J=oe=>T(oe.detail),W=oe=>{oe.data&&oe.data.type==="pp-filter"&&T(oe.data)};return window.addEventListener("ppmap:filter",J),window.addEventListener("message",W),()=>{window.removeEventListener("ppmap:filter",J),window.removeEventListener("message",W)}},[]),p.useEffect(()=>{const T=J=>{var be;const W=(((be=J.detail)==null?void 0:be.name)||"").trim().toLowerCase();if(!W)return;const oe=l.dossiers.find(Oe=>(Oe.name||"").trim().toLowerCase()===W);oe&&c(a==="ops"?{type:"focus",id:oe.id}:{type:"popup",id:oe.id})};return window.addEventListener("ppmap:similar",T),()=>window.removeEventListener("ppmap:similar",T)});const Qe=(T,J,W)=>{const oe=(W||(T==null?void 0:T.name)||J||"").trim();if(!I){k({kicker:oe});return}!oe||A||(L(!0),(async()=>{try{let be=(J||oe).trim();const Oe=((T==null?void 0:T.website)||(T==null?void 0:T.domain)||"").trim();if(!(/^https?:\/\//i.test(be)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(be)&&!/\s/.test(be)))if(Oe)be=Oe;else try{const _e=await Kn(oe);if(_e!=null&&_e.website)be=_e.website;else if(((_e==null?void 0:_e.candidates)||[]).length===1)be=_e.candidates[0].url;else if(((_e==null?void 0:_e.candidates)||[]).length>1){$.current=[{name:oe,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(_e.candidates||[]).slice(0,5)},...$.current].slice(0,8),z();return}}catch{}const Ge=await Mo(ie,be,"atelier2"),xt={name:Ge.company||oe,verdict:Ge.verdict,reason:Ge.reason||"",remaining:Ge.remaining??null};$.current=[xt,...$.current].slice(0,8),Ge.verdict==="kept"&&S(_e=>({..._e,kept:_e.kept+1})),Ge.verdict==="ruled_out"&&S(_e=>({..._e,dropped:_e.dropped+1}));const na=T||l.dossiers.find(_e=>(_e.name||"").toLowerCase()===oe.toLowerCase());na&&(Ge.verdict==="kept"?na.verdict=na.verdict||"MATCH":Ge.verdict==="ruled_out"&&(na.verdict="NO MATCH"),Ge.reason&&(na.reasoning=Ge.reason)),z()}finally{L(!1)}})())},Nt=T=>{if(!I){k({kicker:T.name});return}se(T,"instant"),kt(ie,"fast_request",T.name||"",""),ne(s.memoInstantSent(T.name))},Rt=T=>we.current.get(T.id)??l.thumbs.get((T.name||"").trim().toLowerCase()),Ot=(T,J)=>c({type:"undoPush",entry:{id:T.id,name:T.name,prevCeoStatus:J}}),wt=async(T,J,W)=>{const oe=T.ceoStatus||"";B.current.set(T.id,Date.now()),T.ceoStatus=J,z();const be=await ln(ie,{status:J,airtable_id:T.airtableId,check_id:T.checkId,company:T.name,...(W==null?void 0:W.note)!==void 0?{note:W.note}:{},...W!=null&&W.via?{via:W.via}:{}});return be.ok?be.skipped?(T.ceoStatus=oe,z(),te(s.actNotPersisted),!1):((W==null?void 0:W.undo)!==!1&&Ot(T,oe),W!=null&&W.msg&&ne(W.msg),(J==="Validé"||J==="Écarté")&&!T.ceoNote&&(W==null?void 0:W.note)===void 0&&R({o:T,yes:J==="Validé"}),!0):(T.ceoStatus=oe,z(),te(s.actErr),!1)},Pe=async(T,J)=>{const W=await ln(ie,{status:T.ceoStatus||"Retenu",airtable_id:T.airtableId,check_id:T.checkId,company:T.name,note:J,via:"note"});return!W.ok||W.skipped?(te(W.skipped?s.actNotPersisted:s.actErr),!1):(T.ceoNote=J,z(),!0)},st=p.useRef(new Map),Ze=T=>st.current.has(T.id)?st.current.get(T.id):l.stages.get((T.name||"").trim().toLowerCase()),St=(T,J)=>{st.current.set(T.id,J),z()},zt=(T,J)=>{I&&wt(T,J?"Validé":"Écarté",{msg:J?s.decidedYes(T.name):s.decidedNo(T.name)})},Mt=T=>{I&&wt(T,"À trancher",{msg:s.promoted(T.name)})},Gt=T=>{I&&(async()=>{const J=T.ceoStatus||"";T.ceoStatus="Retenu",z();const W=await ln(ie,{status:"Retenu",check_id:T.checkId,company:T.name});if(!W.ok||W.skipped){T.ceoStatus=J,z(),te(W.skipped?s.actNotPersisted:s.actErr);return}Ot(T,J),ne(s.repeched(T.name))})()},N=()=>{const T=h.undo[h.undo.length-1];if(!T){ne(s.undoNone);return}const J=de.get(T.id);if(!J){c({type:"undoPop"}),ne(s.undoNone);return}let W=T.prevCeoStatus;if(!W)if((J.verdict||"").toUpperCase().includes("CALL"))W="À trancher";else{ne(s.undoLockedTitle);return}(async()=>await wt(J,W,{undo:!1})&&(c({type:"undoPop"}),J.ceoStatus=T.prevCeoStatus,z(),ne(s.undoDone(J.name))))()},_=T=>{I&&(X.current.add(T.id),z(),c({type:"approachOpen",id:T.id}),kt(ie,"approach",T.name||"","","",l.email||""))},B=p.useRef(new Map),Y=p.useRef(!1),[ce,le]=p.useState(0);p.useEffect(()=>{if(!ie||e||!I||Y.current)return;Y.current=!0;const T=new Date().toISOString().slice(0,10),J=l.email||"",W=`cbv_${ie}_${J}_${T}`,oe=`atl2:vue:${ie}:${T}`;try{if(localStorage.getItem(W)||localStorage.getItem(oe))return}catch{}kt(ie,"view","","","",J).then(be=>{if(!be.ok){Y.current=!1;return}try{localStorage.setItem(W,"1")}catch{}})},[ie,e,I,l.email]),p.useEffect(()=>{if(!ie||!ge||e||!I||!l.generatedAt)return;let T=!0;const J=()=>{document.hidden||ul(ie,l.generatedAt||"").then(oe=>{T&&le(oe)})};J();const W=window.setInterval(J,6e4);return()=>{T=!1,window.clearInterval(W)}},[ie,ge,e,l.generatedAt]);const xe=(T,J)=>{I&&(async()=>{if(!(await kt(ie,J?"yes":"no",T.name||"",(T.ceoNote||"").slice(0,400),T.sector||"",l.email||"")).ok){te(s.actErr);return}we.current.set(T.id,J?"yes":"no"),z(),ne(J?s.thumbUpDone:s.thumbDnDone),q({o:T,up:J})})()},Se=T=>{!I||!qt(T)||(se(T,"detailed"),kt(ie,"detailed_request",T.name||"","","",l.email||""),ne(s.memoDeepSent(T.name)))},Ee=T=>{!I||!T.memoUrl||window.confirm(s.memoRegenAsk(T.name))&&(se(T,"detailed"),kt(ie,"detailed_regen",T.name||"","","",l.email||""),ne(s.memoDeepSent(T.name)))},at=T=>{const J=new Set(l.favIds),W=J.has(T.id);W?J.delete(T.id):J.add(T.id),l.setFavIds(J),I&&ml(ie,{id:T.id,co:T.name},W)},lt=()=>{!I||H||window.confirm(s.identSyncConfirm)&&(G(!0),(async()=>{const T=await fl(ie);G(!1),T?ne(s.identSyncDone):te(s.actErr)})())},Ke=/proplace/i.test(l.fund||""),mt=T=>{!I||!Ke||(kt(ie,"onboard_request",T.name||"",""),ne(s.onboardSent(T.name)))},et={st:h,dispatch:c,t:s,lang:d,mode:he,caps:ke,pipe:ge,token:ie,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:Gt,thumbOf:Rt,canWrite:I,commitStatus:wt,saveNote:Pe,stageOf:Ze,setStage:St,flashErr:te,startTour:()=>P(!0),dossiers:l.dossiers,scopedAll:je,scoped:Ae,counts:ye,byId:de,contName:Ft,favIds:l.favIds,toggleFav:at,askEvaluate:Qe,doAnalyse:Nt,doDecide:zt,doPromote:Mt,doApproach:_,doThumb:xe,doDeep:Se,doRegen:Ee,doUndo:N,doSync:lt,doOnboard:mt,outbound:Ke,memoQueued:D.current,liveMemos:{items:ae,serverOff:ve,liveOf:pe},approachDone:X.current,sessTally:j,evalCards:$.current,evalBusy:A,markRow:w,markedId:y,flash:ne,focusExtra:f};p.useEffect(()=>{const T=J=>{J.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",T),()=>window.removeEventListener("keydown",T)},[]);const Hi=T=>ie?t.jsx(od,{token:ie,children:T}):t.jsx(t.Fragment,{children:T});return t.jsx(Bi.Provider,{value:et,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ie?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Hl}),Hi(t.jsxs("div",{className:"app"+(ge?" pipe":"")+(ie?" has-thesis":""),children:[ke.showTicker&&t.jsx(ft,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ie?" live-stack--cibles":""),children:[t.jsx(ud,{}),!!ie&&t.jsx(id,{})]})}),ke.showIdent&&t.jsx(ft,{name:"identite",children:t.jsx(kd,{})}),!1,vu,ke.showFunnel&&t.jsx(ft,{name:"entonnoir",children:t.jsx(Eu,{})}),t.jsx(ft,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Ni,{variant:"tabs"}),!h.mapFolded&&t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(gu,{}),a!=="ops"&&(ke.showFunnel||ke.showIdent)&&t.jsxs("div",{className:"map-hud",children:[ke.showFunnel&&t.jsx(xu,{}),ke.showIdent&&t.jsx(bu,{})]}),t.jsx(wp,{}),t.jsx(ji,{})]})]})}),ke.showDemand&&ge&&t.jsx(ft,{name:"direct",children:t.jsx(vl,{items:ae,serverOff:ve,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([T,J])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===T,onClick:()=>{m(T);try{localStorage.setItem("atl2:chrome-mode",T)}catch{}},children:J},T))}),ke.showDemand&&t.jsx(ft,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Pp,{})})}),ke.showDemand&&h.memoConsole&&t.jsx(ft,{name:"console",children:t.jsx(Bp,{})}),ke.pipe&&!!ie&&t.jsx(ft,{name:"moteurs",children:t.jsx(Ll,{})}),ce>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{le(0),l.refresh()},children:s.freshGo})]}),t.jsx(ft,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Rc,{})}),ke.pipe&&!!ie&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(ft,{name:"fiche",children:t.jsx(xc,{})}),t.jsx(ft,{name:"modales",children:t.jsx($c,{})}),t.jsx(ol,{}),x&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:x.o.name}),t.jsx($r,{placeholder:x.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:T=>{const J=x.o;q(null),T&&kt(ie,"note",J.name||"",T,J.sector||"",l.email||"").then(W=>{W.ok&&ne(s.csNoteSaved)})}})]}),Q&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:Q.o.name}),t.jsx($r,{placeholder:Q.yes?s.whyYesPh:s.whyNoPh,onDone:T=>{const J=Q.o;R(null),T&&Pe(J,T).then(W=>{W&&ne(s.csNoteSaved)})}})]}),C&&Wt&&t.jsx(wd,{steps:ku(s,Ie,Ue,Ce,ot,ye[3]||0,ye[4]||0,ye),onClose:()=>{P(!1),qo(ie)}}),t.jsx(wu,{}),ke.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Uo,children:$o}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${$a}`,children:$a})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),F&&t.jsx("div",{className:"flash on"+(M?" err":""),children:F}),E&&t.jsx(il,{variant:"acquirer",initialCompany:To().co,initialWebsite:To().site,onClose:()=>k(null)})]})})}function Eu(){const{t:e}=K(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function To(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function ju(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{$i as FlagCell,Tt as SigBadge,nn as SigWin,zu as default,ju as fmtShort,K as useV2};
