...
`):""),$(!1)},re=async()=>{var oe,be,We;if(He.current)return;const R=K.trim().replace(/\s+/g,""),ee=ne.trim();if(!R&&!ee){J(e.rsNeed);return}if(!g&&!N){i(null,R||ee.slice(0,80));return}He.current=!0,J(""),me(null),pe(null),je(!0);try{const Ie=await Zo({url:R,text:ee,email:n,cbToken:N});if(je(!1),!Ie||Ie.status!=="success"){J((Ie==null?void 0:Ie.message)||"Erreur");return}me(Ie),Q(!1),tt((((oe=Ie.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Ye=>(Ye==null?void 0:Ye.name)||"")),pe({state:"pending"});const Ne=await ei(Ie,{email:n,cbToken:N});pe(Ne.ok?{state:"ok",scopeLabel:((be=Ne.summary)==null?void 0:be.scope_label)||"",scope:((We=Ne.summary)==null?void 0:We.scope)||""}:{state:"fail",msg:Ne.error||""}),Ne.ok&&Ze(Ye=>Ye+1)}finally{He.current=!1,je(!1)}},Se=[H==null?void 0:H.industry,...(H==null?void 0:H.market_tags)||[],H==null?void 0:H.author].map(R=>(R||"").trim()).filter(Boolean),he=(ae==null?void 0:ae.state)==="pending",Ve=ae&&(he?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):ae.state==="ok"?t.jsx("span",{className:"rslink ok",children:ae.scope&&ae.scope!=="public"?e.rsSavedIn(ae.scopeLabel||ae.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:ae.msg,children:e.rsSaveFail})),st=Sl(H).length,ze=Y,at=(T||E).trim(),ft=z?e.actAnalyse:at?e.evalGoOn(at.length>22?at.slice(0,21)+"…":at):e.evalGo,jt=ce?`${Xo(K.trim())==="youtube"&&K.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ye)}`:he?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(ze?" rs-mode":"")+(T&&E.trim()===T||A||G?" pair":"")+(A||G?" echo":""),children:[t.jsxs("div",{className:"drow"+((ze?G:A)?" flash":"")+((ze?K.trim():Ra.test(E.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:ze?K:E,placeholder:ze?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:ze?600:200,spellCheck:ze?!1:void 0,inputMode:ze?"url":void 0,onChange:R=>{if(ze){ie(R.target.value);return}w(R.target.value),T&&R.target.value.trim()!==T&&C("")},onKeyDown:R=>{R.key==="Enter"&&(ze?re():_())}}),!ze&&t.jsx("span",{className:"detect"+(Ra.test(E.trim())?" url":""),children:it})]}),ze?t.jsxs(t.Fragment,{children:[t.jsx("a",{className:"viewbtn"+(la(K)?"":" off"),href:la(K)?K.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:R=>{la(K)||R.preventDefault()},children:e.viewLink}),t.jsxs("button",{type:"button",className:"evalbtn"+(ce?" loading":""),disabled:ce||he||!K.trim()&&!ne.trim(),onClick:()=>{re()},children:[t.jsx("span",{className:"fill"}),jt]})]}):t.jsxs("button",{type:"button",className:"evalbtn"+(z?" analyse":"")+(d?" loading":""),disabled:d,onClick:_,children:[t.jsx("span",{className:"fill"}),ft]}),f.showCredits&&Fe&&t.jsxs("button",{type:"button",className:"credits"+(Fe.total_available<=0&&!Fe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Fe.unlimited?"∞":Fe.total_available}),!Fe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Fe.daily_grant+Fe.purchased]}),Fe.total_available<=0&&!Fe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(R=>R.status==="boot"||R.status==="running").map(R=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:R.name}),t.jsx(Bt,{item:R,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+R.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>j(!S),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(Y?" on":""),onClick:()=>Q(!Y),children:e.rsOpen}),De!==null&&De>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ue?" on":""),onClick:()=>ge(!ue),children:e.rsArchOpen(De)})]}),ue&&t.jsx(zl,{bump:qe,cbToken:N,onClose:()=>ge(!1),onEvaluate:R=>i(null,R),onAddAll:tt}),Y&&t.jsxs("div",{className:"rsp on slim",children:[t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:ne,placeholder:e.rsTextPh,onChange:R=>xe(R.target.value)})]}),Z&&t.jsx("div",{className:"rserr",children:Z}),H&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:H.title}),H.source_url&&t.jsx("a",{href:H.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{me(null),pe(null)},children:"×"})]}),H.market&&t.jsx("p",{className:"rsmk",children:H.market}),Se.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Se.map(R=>t.jsx("span",{children:R},R))]}),t.jsxs("div",{className:"rsbody",children:[H.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${H.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:to(H.summary_md||"").map((R,ee)=>t.jsx("p",{children:R},ee))})]}),t.jsx(ao,{card:H,onEvaluate:R=>i(null,R),onAddAll:tt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(st)}),Ve]})]}),S&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:M,placeholder:e.bulkPh,onChange:R=>P(R.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(O?" loading":""),style:{justifyContent:"center"},disabled:O||!Me.length,onClick:()=>{W()},children:[t.jsx("span",{className:"fill"}),O&&v?v:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(Me.length)})]})]}),mt.slice(0,1).map((R,ee)=>{const oe=R.verdict==="kept",be=R.verdict==="quota",We=oe?"var(--brand)":be?"var(--bolt)":"var(--red)",Ie=oe?"var(--brand-l)":be?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":We,"--bgc":Ie},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:be?"⏳":"✗ "+e.dropped})}),R.name&&t.jsx("span",{className:"rn",children:R.name}),t.jsx("span",{className:"rr",children:R.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",R.reason]}):null}),!!(R.candidates&&R.candidates.length)&&t.jsx("span",{className:"sitepick",children:R.candidates.map(Ne=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ne.url.startsWith("http")?Ne.url:`https://${Ne.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ne.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Ne.url),children:e.evalPickGo})]},Ne.url))}),!be&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const Ne=(R.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ye=[...document.querySelectorAll(".atl2 .list .row")].find(ja=>{var Gt;return(((Gt=ja.querySelector(".rnm"))==null?void 0:Gt.textContent)||"").trim().toLowerCase().includes(Ne)});Ye&&(Ye.scrollIntoView({behavior:"smooth",block:"center"}),Ye.classList.add("flashrow"),window.setTimeout(()=>Ye.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),g&&(o.kept+o.dropped>0||mt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ll(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ql(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=D(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",Ll(o.summary||"")].filter(Boolean).join(`
