...
body.pp-desk .atl2.cibles .listhead.mapoff{
  ...
  align-items:stretch!important;z-index:34;width:62%;max-width:calc(100% - 280px);
...
body.pp-desk .atl2.cibles .listhead .lh-funnel .funnel{gap:6px;flex-wrap:wrap}
body.pp-desk .atl2.cibles .listhead .lh-funnel .tuto{margin:6px 0 0}
...
.atl2 .ticker .tk-edito{flex:none;display:inline-flex;align-items:center;gap:6px;
  height:28px;margin:0 6px 0 2px;padding:0 10px;border:1px solid #1E2C41;border-radius:5px;
...
.eval-sent{display:block;height:0;overflow:hidden;pointer-events:none}
@media (max-width:760px){
  body.pp-desk .atl2.ops .eval-stick{
    ...
    box-shadow:0 1px 0 var(--line,#e2e8f0)}
  body.pp-desk .atl2.ops .eval-stick.is-pinned{
    position:fixed!important;left:0;right:0;width:100%;
    top:calc(var(--pp-gap,48px) + var(--pp-live-h,44px));
    z-index:37;background:var(--panel2,#fff);
    box-shadow:0 1px 0 var(--line,#e2e8f0)}
  body.pp-desk .atl2.ops .listhead,
  body.pp-desk .atl2.ops .listhead.mapoff{
...
`,Ui=$i+_i;function Wa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Hi(){const e=Wa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Vi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Hi();return r==="0"?"client":r==="1"||Wa("embed")==="1"&&Wa("chrome")==="1"?"apercu":"client"}const Wi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Yi=e=>Wi[e];function ga(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const gt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!kr(a)||ga(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Lo(e.cc)})};function Ra(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Gi=60*60*1e3;function Ki(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Gi?null:a}catch{return null}}function aa(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Qi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ji(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:yo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Vi(e,i),[e,i,n]),l=m.useMemo(()=>Yi(o),[o]),d=o!=="visiteur",c=Qi(r),[x,s]=m.useState([]),[h,u]=m.useState(""),[b,p]=m.useState(null),[g,y]=m.useState(null),[f,j]=m.useState(null),[E,k]=m.useState(()=>new Map),[A,R]=m.useState(()=>new Map),[T,M]=m.useState(""),[C,S]=m.useState(new Set),[P,I]=m.useState(null),[q,D]=m.useState(!0),[v,L]=m.useState(!1),[G,_]=m.useState(0),[H,oe]=m.useState(0),Z=m.useRef(0),W=m.useMemo(()=>{var te;if(o!=="client")return"";try{return((te=wo())==null?void 0:te.email)||""}catch{return""}},[o]);m.useEffect(()=>{const te=++Z.current;let ge=!0;const Y=()=>ge&&te===Z.current,de=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),ye=Ki(de);return ye?(s(ye.objs.map(gt)),ye.fund&&u(ye.fund),p(ye.marketEstimate??null),y(ye.criteria??null),j(ye.stats??null),M(ye.generatedAt||""),D(!1)):D(!0),(async()=>{try{if(r==="ops"){const Se=await qa(),be=((Se==null?void 0:Se.recent_ops)||[]).map(ne=>{const re=ua(ne.company_name||ne.title?ne:{...ne,title:(ne.headline_fr||ne.headline||"").slice(0,120)},a),ee=String(ne.rubrique||"").toLowerCase();return re&&(ee==="nominations"||ee==="recrutements")&&(re.engine=ee),re&&!String(ne.company_name||"").trim()&&(re.noCo=!0),re}).filter(ne=>!!ne).map(ne=>(kr((ne.name||"").trim())||(ne.noCo=!0),ne));try{const ne=ko(),re=await jo(),ee=((re==null?void 0:re.date)||"").slice(0,10),Q=ne?ne.doc:re,me=No(Q),ke=((ne==null?void 0:ne.day)||(Q==null?void 0:Q.date)||ee||"").slice(0,10);if(ke&&me.length){const Ne=new Set;for(const J of be){if((J.date||"").slice(0,10)!==ke)continue;const ae=En(me,Ne,J.name,"");ae>=0&&(Ne.add(ae),J.decryptHtml=me[ae].html)}for(const J of be){if(J.decryptHtml||(J.date||"").slice(0,10)!==ke)continue;const ae=En(me,Ne,"",J.headline||J.tagline||J.name);ae>=0&&(Ne.add(ae),J.decryptHtml=me[ae].html)}}if(ke){const Ne=((Q==null?void 0:Q.title_fr)||"").trim(),J=((Q==null?void 0:Q.lead_fr)||"").trim(),ae=So(Q),Pe=((Q==null?void 0:Q.url)||"").trim();Ne&&(ae||Pe)&&be.unshift({id:`edito:${ke}`,kind:"op",name:Ne,cc:null,date:ke,engine:"edito",dealKind:"other",headline:Ne,tagline:J||Ne,decryptHtml:ae||void 0,url:Pe,noCo:!0})}}catch{}if(!Y())return;s(be.map(gt)),aa(de,{objs:be})}else if(typeof r=="object"){const be=(await Cn()||[]).filter(re=>(re.slug||"")===r.research).map(re=>zn(re,a)).filter(re=>!!re),ne=Ra(await An(be,a));if(!Y())return;s(ne.map(gt)),aa(de,{objs:ne})}else if(d&&i.token){const Se=Eo(i.token),be=qa(),ne=Co(i.token),re=zo(i.token),ee=Ao(i.token),Q=await Se;let me=Q?Q.targets:[];Y()&&Q&&(u(Q.fund||""),p(Q.marketEstimate??null),y(Q.criteria??null),j(Q.stats??null),M(Q.generatedAt||""),s(me.map(gt)),D(!1),L(!1));const[ke,Ne,J,ae]=await Promise.all([be,ne,re,ee]),Pe=((ke==null?void 0:ke.recent_ops)||[]).map(Ae=>ua(Ae,a)).filter(Ae=>!!Ae);if(me=[...me,...Pe],!Y())return;s(me.map(gt));const qe=new Set;for(const Ae of Ne){const we=(Ae.id||Ae.co||"").toString().trim().toLowerCase();we&&qe.add(we.startsWith("t:")?we:"t:"+we)}S(qe),k(J),R(ae),Q&&aa(de,{fund:Q.fund,marketEstimate:Q.marketEstimate,criteria:Q.criteria,stats:Q.stats,generatedAt:Q.generatedAt,objs:me})}else{const Se=To(),be=Cn(),ne=qa(),re=await Se;Y()&&re.length&&(s(Ra(re).map(gt)),D(!1),L(!1));const[ee,Q]=await Promise.all([be,ne]),me=(ee||[]).map(ae=>zn(ae,a)).filter(ae=>!!ae),ke=await An(me,a),Ne=((Q==null?void 0:Q.recent_ops)||[]).map(ae=>ua(ae,a)).filter(ae=>!!ae),J=Ra([...re,...ke,...Ne]);if(!Y())return;s(J.map(gt)),aa(de,{objs:J})}Y()&&L(!1)}catch{Y()&&!ye&&L(!0)}finally{Y()&&D(!1)}})(),()=>{ge=!1}},[d,i.token,a,G,c]),m.useEffect(()=>{if(!l.showCredits||!W){I(null);return}let te=!0;return(async()=>{try{const ge=await fetch(`${dn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:W})});if(!ge.ok)return;const Y=await ge.json();te&&Y&&Y.ok!==!1&&I(Y)}catch{}})(),()=>{te=!1}},[l.showCredits,W,H]);const se=m.useCallback(te=>S(new Set(te)),[]);return{session:i,mode:o,caps:l,fund:h,email:W,marketEstimate:b,generatedAt:T,criteria:g,stats:f,thumbs:E,stages:A,dossiers:x,favIds:C,setFavIds:se,credits:P,reloadCredits:()=>oe(te=>te+1),loading:q,error:v,refresh:()=>_(te=>te+1)}}function nt(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Cr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Xi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Cr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Zi=new Set(["signal","amount","score","crible","memo"]);function es(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Cr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Zi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??zr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const zr=80;function ba(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Te(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(cn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(st(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&vt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Ar(e,a,r){return nt(e)?ba(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ba(e,a.filters,r)}function ts(e,a,r,n){return!(!Ar(e,a,r)||r&&!qo(e,a.ptab,n))}function fn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-st(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Ro(i);case"memo":return Mo(i);case"signal":{const o=Te(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const Fa={},In=(Fa==null?void 0:Fa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Bn(){return new Date().toISOString().slice(0,10)}const xn=m.createContext(null);function Tr(){return m.useContext(xn)}function as(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const x=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),x&&/^https?:\/\//i.test(x)&&(c.setAttribute("href",x),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function $n(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Lr(){const e=m.useContext(xn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ns({token:e,children:a}){const{dispatch:r,st:n,lang:i}=U(),[o,l]=m.useState(()=>n.filters.day||Bn()),[d,c]=m.useState(null),[x,s]=m.useState(!1),h=m.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(Bn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const g=y=>{var j;const f=(j=y.detail)==null?void 0:j.day;typeof f=="string"&&h(f)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[h]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let g=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${In}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{g||c(f)}).catch(()=>{g||c({ok:!1,error:"network"})}).finally(()=>{g||s(!1)}),()=>{g=!0}},[e,o]);const b=m.useMemo(()=>`${In}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:d,loading:x,pickDay:h,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,d,x,h,u,n.filters.day,b,i]);return t.jsx(xn.Provider,{value:p,children:a})}function rs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Lr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Fo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})]})}function os(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Lr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:$n(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:$n(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const is=300,na=7,ss={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},qr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},ls=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Oa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Io(r)&&r!=="media")return"news:"+r;const n=Te(e);return n?"sig:"+(n.theme&&qr.fr[n.theme]?n.theme:"other"):"actualites"}function ds(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=U(),c=Tr(),x=l==="en",[s,h]=m.useState("all"),[u,b]=m.useState(!1),p=m.useMemo(()=>{var ge;const v=(a.filters.day||"").slice(0,10),L=Y=>!(!o&&a.continent!=="monde"&&Y.continent!==a.continent||v&&(Y.date||"").slice(0,10)!==v),G=e.filter(Y=>L(Y)&&Te(Y)&&(!o||Y.kind!=="target"||ze(Y)!==5)),_=o&&(((ge=c==null?void 0:c.ed)==null?void 0:ge.ops)||[]).length?c.ed.ops.map(Y=>ua(Y,l)).filter(Y=>!!Y).filter(Y=>!v||(Y.date||"").slice(0,10)===v):[],H=e.filter(Y=>L(Y)&&Y.kind==="op"&&(v?!0:st(Y.date)<=na)),oe=o?_.length?_:H.filter(Y=>{const de=(d||"").trim().toLowerCase();if(!de)return!1;const ye=Y.match||null;return ye?Object.keys(ye).map(Se=>Se.trim().toLowerCase()).includes(de):!1}):H,Z=v||new Date().toISOString().slice(0,10),W=Y=>{const de=Oa(Y);return de==="ma"?0:de==="levees"?1:2};oe.sort((Y,de)=>{const ye=W(Y)-W(de);if(ye)return ye;const Se=(Y.date||"").slice(0,10)===Z?0:1,be=(de.date||"").slice(0,10)===Z?0:1;return Se!==be?Se-be:(de.amountEur||0)-(Y.amountEur||0)});const se=new Set,te=[];for(const Y of[...oe,...fn(G,{key:"signal",dir:-1})]){const de=Y.id||Y.name;!de||se.has(de)||(se.add(de),te.push(Y))}return o&&te.length===0?e.filter(de=>L(de)&&st(de.date)<=na).sort((de,ye)=>(ye.date||"").localeCompare(de.date||"")).slice(0,80):te},[e,a.continent,a.filters.day,o,d,l,c]),g=m.useMemo(()=>{const v={};for(const L of p){const G=Oa(L);v[G]=(v[G]||0)+1}return v},[p]),y=m.useMemo(()=>s==="all"?p:p.filter(v=>Oa(v)===s),[p,s]),f=m.useMemo(()=>y.slice(0,is),[y]),j=y.length-f.length,E=m.useRef(null);m.useEffect(()=>{var oe,Z;const v=E.current;if(!v)return;const L=()=>{const W=v.scrollWidth;W<200||(v.style.animationDuration=Math.max(18,Math.round(W/130))+"s")};L();const G=requestAnimationFrame(L),_=window.setTimeout(L,1200);let H=!0;return(Z=(oe=document.fonts)==null?void 0:oe.ready)==null||Z.then(()=>{H&&L()}),()=>{H=!1,cancelAnimationFrame(G),window.clearTimeout(_)}},[f.length,s]);const k=v=>v==="all"?p.length:g[v]||0,A=v=>{if(v==="all")return x?"All":"Tout";if(v.startsWith("sig:"))return qr[x?"en":"fr"][v.slice(4)]||"🔔";if(v.startsWith("news:")){const L=v.slice(5);return Po[L]?Do(L,x?"en":"fr"):v}return ss[x?"en":"fr"][v]},R=[{k:"all"}],T=["ma","levees"].filter(v=>k(v)>0||v===s);if(T.length){R.push({g:x?"Deals":"Opérations"});for(const v of T)R.push({k:v})}const M=["nominations","recrutements"].filter(v=>k(v)>0||v===s),C=Oo.filter(v=>v!=="media").map(v=>"news:"+v).filter(v=>k(v)>0||v===s),S=k("actualites")>0||s==="actualites"?["actualites"]:[];if(M.length||C.length||S.length){R.push({g:x?"News":"Actualités"});for(const v of M)R.push({k:v});for(const v of C)R.push({k:v});for(const v of S)R.push({k:v})}const P=ls.map(v=>"sig:"+v).filter(v=>k(v)>0||v===s);if(P.length){R.push({g:x?"Signals (your engines)":"Signaux (vos moteurs)"});for(const v of P)R.push({k:v})}const I=v=>{try{return new Date(v+"T12:00:00Z").toLocaleDateString(x?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return v}},q=(()=>{const v=(a.filters.day||"").slice(0,10),L=!o&&a.continent!=="monde"&&i?x?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return v?(x?`LIVE covers the events of ${I(v)}.`:`Le LIVE regroupe les événements du ${I(v)}.`)+L:(x?`LIVE covers the still-open signals and the deals of the last ${na} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${na} derniers jours.`)+L})(),D=v=>f.map(L=>t.jsxs("button",{type:"button",className:"tk"+(Ie(L)?" spent":""),onClick:G=>{if(n({type:"focus",id:L.id}),a.dens!=="liste"){const _=G.currentTarget.getBoundingClientRect();n({type:"popup",id:L.id,anchor:{x:_.left+_.width/2,y:_.bottom}})}},title:L.name+(L.tagline?" — "+L.tagline:""),children:[t.jsx(Nt,{o:L}),t.jsxs("span",{className:"who",children:[t.jsx(uo,{o:L}),t.jsx("span",{className:"co",children:L.name})]}),typeof L.amountEur=="number"&&L.amountEur>0&&t.jsx("span",{className:"am",children:Od(L.amountEur)}),L.sector&&t.jsx("span",{className:"mt",children:L.sector}),t.jsx(Aa,{o:L}),t.jsx("span",{className:"tkgo",children:"→"})]},v+(L.id||L.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:x?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},v+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:v=>{v.currentTarget.contains(v.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(v=>!v),children:[A(s),t.jsx("b",{children:k(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:q}),R.map(v=>"g"in v?t.jsx("span",{className:"tkfilg",children:v.g},v.g):t.jsxs("button",{type:"button","aria-pressed":v.k===s,onClick:()=>{h(v.k),b(!1)},children:[A(v.k),t.jsx("b",{children:k(v.k)})]},v.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:E,children:[D(0),D(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:x?"Show today's brief":"Afficher le brief du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",x?"Brief":"Brief du jour"]}),!!c&&t.jsx(ps,{isEn:x})]})}const cs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ps({isEn:e}){const[a,r]=m.useState(()=>Bo());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(Tn,i),()=>window.removeEventListener(Tn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>$o(!a),children:cs})}const hn="+33 6 83 10 72 86",va="alexandre@proplace.co",Mr=`tel:${hn.replace(/[^\d+]/g,"")}`;function us(){return null}class Xe extends m.Component{constructor(){super(...arguments);Nn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Rr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ms(e,a){if((pt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return Rr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function fs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=U(),[d,c]=m.useState(!1),[x,s]=m.useState(""),[h,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),p=async g=>{if(x)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}s(g);const y=await i(e,g);s(""),y&&(c(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:h?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const g=await i(e,"Analysé");s(""),g&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]}):ms(e,a).map(([g,y])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(x===g?" busy":""),disabled:!!x,onClick:()=>{p(g)},children:y},g))})]})}function xs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=U(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),s=(pt(e)||"").startsWith("CALL")&&ze(e)===3,h=ze(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const g=await i(e,p);l(""),g&&(c(!0),setTimeout(()=>c(!1),2200))},b=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Rr.filter(([p])=>!(h&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(x===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(hs,{o:e})]})}function hs({o:e}){const{t:a,saveNote:r,flash:n}=U(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,x]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),h=async()=>{if(l||!s)return;d(!0);const u=await r(e,i.trim());d(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&h()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{h()},children:c?a.csNoteSaved:a.csNoteOk})]})}function gs({placeholder:e,onDone:a}){const{t:r}=U(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function bs({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=U(),[c,x]=m.useState(!1);if(!n.pipe||!i||n.lockActions||ze(e)!==4)return null;const s=o(e),h=(s==null?void 0:s.stage)||"todo",u=async f=>{if(c||f===h)return;x(!0);const j=s;l(e,{stage:f,stamps:(s==null?void 0:s.stamps)||{}});const E=Math.max(Date.now(),_n+=1);_n=E;const k=await _o(r,{company:e.name||"",stage:f,cts:E,deal_id:e.airtableId,check_id:e.checkId});x(!1),!k.stale&&(k.ok||(l(e,j),d(a.actErr)))},b=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=h==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,j])=>t.jsx("button",{type:"button",className:"stgb"+(h===f?" on":""),disabled:c,onClick:()=>{u(f)},children:j},f)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let _n=0;const ra=8,oa=360;function Un({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Hn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Un,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Un,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function vs({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=U(),[l,d]=m.useState(0),[c,x]=m.useState(null),[s,h]=m.useState([]),u=m.useRef(!1),b=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const T=b.current;return()=>{p.current||(n({type:"ptab",tab:T.ptab}),n({type:"dens",dens:T.dens}),n({type:"modal",modal:T.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,h(e.filter(T=>!!document.querySelector(T.need||T.sel))))},[e]);const g=s[l],y=l>=s.length;m.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const T=g.click,M=window.setTimeout(()=>{const C=document.querySelector(T);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(M)}},[l,g]);const f=m.useRef(-1),j=m.useCallback(()=>{if(!g){x(null);return}const T=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!T){x(null);return}f.current!==l&&(f.current=l,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const M=T.getBoundingClientRect();x(C=>C&&Math.abs(C.top-M.top)<1&&Math.abs(C.left-M.left)<1&&Math.abs(C.width-M.width)<1&&Math.abs(C.height-M.height)<1?C:M)},[g,l]);m.useLayoutEffect(()=>{j();const T=[90,300,700,1300].map(C=>window.setTimeout(j,C)),M=()=>j();return window.addEventListener("scroll",M,!0),window.addEventListener("resize",M),()=>{T.forEach(C=>window.clearTimeout(C)),window.removeEventListener("scroll",M,!0),window.removeEventListener("resize",M)}},[j]);const E=m.useRef(a);if(E.current=a,m.useEffect(()=>{const T=M=>{M.key==="Escape"?(M.preventDefault(),M.stopPropagation(),E.current()):M.key==="ArrowRight"?d(C=>C+1):M.key==="ArrowLeft"&&d(C=>Math.max(0,C-1))};return document.addEventListener("keydown",T,!0),()=>document.removeEventListener("keydown",T,!0)},[]),!s.length)return null;let k=null;const A=T=>()=>{p.current=!0,n({type:"modal",modal:null}),T()};if(y){const T=i[3]||0;T>0?k={title:T===1?r.ahaATitle1:r.ahaATitleN(T),body:r.ahaABody,btn:r.ahaABtn,go:A(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?k={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:A(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?k={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:A(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:A(()=>{n({type:"modal",modal:"crit"}),a()})}}let R={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:oa};if(!y&&c){const T=c.bottom+14,C=window.innerHeight-T>190?T:Math.max(12,c.top-200);R={left:Math.min(Math.max(12,c.left+c.width/2-oa/2),window.innerWidth-oa-12),top:C,width:oa}}return Ot.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-ra,top:c.top-ra,width:c.width+ra*2,height:c.height+ra*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:R,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Hn,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(Hn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(T=>Math.max(0,T-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(T=>T+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Fr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Or(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ys(){var M,C;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=U(),x=r?a:e,s=m.useMemo(()=>x.filter(S=>st(S.date)===0&&S.kind==="target"),[x]),h=m.useMemo(()=>r?a.filter(S=>S.kind==="target"&&ze(S)===0).slice().sort((S,P)=>(P.date||"").localeCompare(S.date||"")):[],[a,r]),u=m.useMemo(()=>s.filter(S=>r?ze(S)===0:!Ie(S)),[s,r]),b=r?h:u,p=r?a.length-h.length:s.length-u.length,g=r?a.length:s.length,y=g?Math.min(100,p/g*100):100,f=m.useMemo(()=>Fr(x),[x]),j=!!f&&st(f)>0,E=m.useMemo(()=>j?x.filter(S=>(S.date||"").slice(0,10)===f):[],[x,f,j]),k=typeof((M=d.stats)==null?void 0:M.kept_today)=="number"?d.stats.kept_today:null,A=typeof((C=d.stats)==null?void 0:C.screened_today)=="number"?d.stats.screened_today:s.length;let R;j?R=i.morningLast(E.length,h.length,Or(f,l)):r?R=i.morningThesis(A,h.length,k):s.length?p===0?R=i.goalSourced(s.length):p>=s.length?R=i.goalCleared:R=i.goalDone(p,s.length):R=i.goalSourced(0);const T=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&h.length&&c({type:"chainStart",queue:h.map(S=>S.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:R}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:T,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ws(){var G,_;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:x,startTour:s,flash:h,flashErr:u}=U(),[b,p]=m.useState(null),[g,y]=m.useState(!0),[f,j]=m.useState([]),E=c==="client";m.useEffect(()=>{if(!i||!o)return;let H=!0;return y(!0),(async()=>{const[oe,Z]=await Promise.all([pn(o),jr(i)]);H&&(oe&&p(oe),y(!1),j(Z))})(),()=>{H=!1}},[i,o]);const[k,A]=m.useState(!1),R=()=>{!E||k||!o||(A(!0),Uo(o).then(H=>{A(!1),H?h(e.identRepubDone):u(e.actErr)}))},T=(b==null?void 0:b.per_day)??null,M=((G=b==null?void 0:b.pool_order)==null?void 0:G.length)??0,C=f.filter(H=>H.status==="running").length,S=m.useMemo(()=>d.filter(H=>H.kind==="target"&&Ie(H)).length,[d]),P=l.marketEstimate,I=typeof((_=l.stats)==null?void 0:_.screened)=="number"?l.stats.screened:S,q=P&&P>0?Math.min(100,Math.round(I/P*100)):null,D=H=>H.toLocaleString(a==="en"?"en-US":"fr-FR"),v=(o||"P").split(/\s+/).map(H=>H[0]).join("").slice(0,2).toUpperCase(),L=(()=>{const H=Date.parse(l.generatedAt||"");if(Number.isNaN(H))return"";const oe=new Date(H),Z=W=>String(W).padStart(2,"0");return`${Z(oe.getDate())}/${Z(oe.getMonth()+1)} à ${Z(oe.getHours())}:${Z(oe.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?v:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),L?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(L)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[q===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:D(I)})})]}),q!==null&&P&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:q+"%"}})}),t.jsxs("b",{children:[q," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,P)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),T!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:T})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),T===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),C>0&&t.jsxs("span",{className:"ev",children:["⏳ ",C]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(M)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:H=>{H.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||k,onClick:R,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:H=>n({type:"filters",patch:{search:H.target.value}})})]})]}),t.jsx(ys,{})]})}class wt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*ks(e){for(const a of e)yield*a}function Pr(e){return Array.from(ks(e))}var ve=1e-6,pe=Math.PI,We=pe/2,Vn=pe/4,Ge=pe*2,ot=180/pe,$e=pe/180,je=Math.abs,js=Math.atan,Gt=Math.atan2,Ee=Math.cos,Ce=Math.sin,Ns=Math.sign||function(e){return e>0?1:e<0?-1:0},St=Math.sqrt;function Ss(e){return e>1?0:e<-1?pe:Math.acos(e)}function Kt(e){return e>1?We:e<-1?-We:Math.asin(e)}function Ye(){}function ya(e,a){e&&Yn.hasOwnProperty(e.type)&&Yn[e.type](e,a)}var Wn={Feature:function(e,a){ya(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)ya(r[n].geometry,a)}},Yn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Ya(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Ya(r[n],a,0)},Polygon:function(e,a){Gn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Gn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)ya(r[n],a)}};function Ya(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Gn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Ya(e[r],a,1);a.polygonEnd()}function Tt(e,a){e&&Wn.hasOwnProperty(e.type)?Wn[e.type](e,a):ya(e,a)}function Ga(e){return[Gt(e[1],e[0]),Kt(e[2])]}function Rt(e){var a=e[0],r=e[1],n=Ee(r);return[n*Ee(a),n*Ce(a),Ce(r)]}function ia(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function wa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Pa(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function sa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Ka(e){var a=St(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Qa(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ja(e,a){return je(e)>pe&&(e-=Math.round(e/Ge)*Ge),[e,a]}Ja.invert=Ja;function Es(e,a,r){return(e%=Ge)?a||r?Qa(Qn(e),Jn(a,r)):Qn(e):a||r?Jn(a,r):Ja}function Kn(e){return function(a,r){return a+=e,je(a)>pe&&(a-=Math.round(a/Ge)*Ge),[a,r]}}function Qn(e){var a=Kn(e);return a.invert=Kn(-e),a}function Jn(e,a){var r=Ee(e),n=Ce(e),i=Ee(a),o=Ce(a);function l(d,c){var x=Ee(c),s=Ee(d)*x,h=Ce(d)*x,u=Ce(c),b=u*r+s*n;return[Gt(h*i-b*o,s*r-u*n),Kt(b*i+h*o)]}return l.invert=function(d,c){var x=Ee(c),s=Ee(d)*x,h=Ce(d)*x,u=Ce(c),b=u*i-h*o;return[Gt(h*i+u*o,s*r+b*n),Kt(b*r-s*n)]},l}function Cs(e,a,r,n,i,o){if(r){var l=Ee(a),d=Ce(a),c=n*r;i==null?(i=a+n*Ge,o=a-c/2):(i=Xn(l,i),o=Xn(l,o),(n>0?i<o:i>o)&&(i+=n*Ge));for(var x,s=i;n>0?s>o:s<o;s-=c)x=Ga([l,-d*Ee(s),-d*Ce(s)]),e.point(x[0],x[1])}}function Xn(e,a){a=Rt(a),a[0]-=e,Ka(a);var r=Ss(-a[1]);return((-a[2]<0?-r:r)+Ge-ve)%Ge}function Dr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ye,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ma(e,a){return je(e[0]-a[0])<ve&&je(e[1]-a[1])<ve}function la(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ir(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,y=p[0],f=p[g],j;if(ma(y,f)){if(!y[2]&&!f[2]){for(i.lineStart(),d=0;d<g;++d)i.point((y=p[d])[0],y[1]);i.lineEnd();return}f[0]+=2*ve}o.push(j=new la(y,p,null,!0)),l.push(j.o=new la(y,null,j,!1)),o.push(j=new la(f,p,null,!1)),l.push(j.o=new la(f,null,j,!0))}}),!!o.length){for(l.sort(a),Zn(o),Zn(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var x=o[0],s,h;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;s=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(d=0,c=s.length;d<c;++d)i.point((h=s[d])[0],h[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(s=u.p.z,d=s.length-1;d>=0;--d)i.point((h=s[d])[0],h[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,s=u.z,b=!b}while(!u.v);i.lineEnd()}}}function Zn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Da(e){return je(e[0])<=pe?e[0]:Ns(e[0])*((je(e[0])+pe)%Ge-pe)}function zs(e,a){var r=Da(a),n=a[1],i=Ce(n),o=[Ce(r),-Ee(r),0],l=0,d=0,c=new wt;i===1?n=We+ve:i===-1&&(n=-We-ve);for(var x=0,s=e.length;x<s;++x)if(u=(h=e[x]).length)for(var h,u,b=h[u-1],p=Da(b),g=b[1]/2+Vn,y=Ce(g),f=Ee(g),j=0;j<u;++j,p=k,y=R,f=T,b=E){var E=h[j],k=Da(E),A=E[1]/2+Vn,R=Ce(A),T=Ee(A),M=k-p,C=M>=0?1:-1,S=C*M,P=S>pe,I=y*R;if(c.add(Gt(I*C*Ce(S),f*T+I*Ee(S))),l+=P?M+C*Ge:M,P^p>=r^k>=r){var q=wa(Rt(b),Rt(E));Ka(q);var D=wa(o,q);Ka(D);var v=(P^M>=0?-1:1)*Kt(D[2]);(n>v||n===v&&(q[0]||q[1]))&&(d+=P^M>=0?1:-1)}}return(l<-ve||l<ve&&c<-1e-12)^d&1}function Br(e,a,r,n){return function(i){var o=a(i),l=Dr(),d=a(l),c=!1,x,s,h,u={point:b,lineStart:g,lineEnd:y,polygonStart:function(){u.point=f,u.lineStart=j,u.lineEnd=E,s=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=y,s=Pr(s);var k=zs(x,n);s.length?(c||(i.polygonStart(),c=!0),Ir(s,Ts,k,r,i)):k&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(k,A){e(k,A)&&i.point(k,A)}function p(k,A){o.point(k,A)}function g(){u.point=p,o.lineStart()}function y(){u.point=b,o.lineEnd()}function f(k,A){h.push([k,A]),d.point(k,A)}function j(){d.lineStart(),h=[]}function E(){f(h[0][0],h[0][1]),d.lineEnd();var k=d.clean(),A=l.result(),R,T=A.length,M,C,S;if(h.pop(),x.push(h),h=null,!!T){if(k&1){if(C=A[0],(M=C.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),R=0;R<M;++R)i.point((S=C[R])[0],S[1]);i.lineEnd()}return}T>1&&k&2&&A.push(A.pop().concat(A.shift())),s.push(A.filter(As))}}return u}}function As(e){return e.length>1}function Ts(e,a){return((e=e.x)[0]<0?e[1]-We-ve:We-e[1])-((a=a.x)[0]<0?a[1]-We-ve:We-a[1])}const er=Br(function(){return!0},Ls,Ms,[-pe,-We]);function Ls(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?pe:-pe,c=je(o-a);je(c-pe)<ve?(e.point(a,r=(r+l)/2>0?We:-We),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=pe&&(je(a-n)<ve&&(a-=n*ve),je(o-d)<ve&&(o-=d*ve),r=qs(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function qs(e,a,r,n){var i,o,l=Ce(e-r);return je(l)>ve?js((Ce(a)*(o=Ee(n))*Ce(r)-Ce(n)*(i=Ee(a))*Ce(e))/(i*o*l)):(a+n)/2}function Ms(e,a,r,n){var i;if(e==null)i=r*We,n.point(-pe,i),n.point(0,i),n.point(pe,i),n.point(pe,0),n.point(pe,-i),n.point(0,-i),n.point(-pe,-i),n.point(-pe,0),n.point(-pe,i);else if(je(e[0]-a[0])>ve){var o=e[0]<a[0]?pe:-pe;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Rs(e){var a=Ee(e),r=2*$e,n=a>0,i=je(a)>ve;function o(s,h,u,b){Cs(b,e,r,u,s,h)}function l(s,h){return Ee(s)*Ee(h)>a}function d(s){var h,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(y,f){var j=[y,f],E,k=l(y,f),A=n?k?0:x(y,f):k?x(y+(y<0?pe:-pe),f):0;if(!h&&(p=b=k)&&s.lineStart(),k!==b&&(E=c(h,j),(!E||ma(h,E)||ma(j,E))&&(j[2]=1)),k!==b)g=0,k?(s.lineStart(),E=c(j,h),s.point(E[0],E[1])):(E=c(h,j),s.point(E[0],E[1],2),s.lineEnd()),h=E;else if(i&&h&&n^k){var R;!(A&u)&&(R=c(j,h,!0))&&(g=0,n?(s.lineStart(),s.point(R[0][0],R[0][1]),s.point(R[1][0],R[1][1]),s.lineEnd()):(s.point(R[1][0],R[1][1]),s.lineEnd(),s.lineStart(),s.point(R[0][0],R[0][1],3)))}k&&(!h||!ma(h,j))&&s.point(j[0],j[1]),h=j,b=k,u=A},lineEnd:function(){b&&s.lineEnd(),h=null},clean:function(){return g|(p&&b)<<1}}}function c(s,h,u){var b=Rt(s),p=Rt(h),g=[1,0,0],y=wa(b,p),f=ia(y,y),j=y[0],E=f-j*j;if(!E)return!u&&s;var k=a*f/E,A=-a*j/E,R=wa(g,y),T=sa(g,k),M=sa(y,A);Pa(T,M);var C=R,S=ia(T,C),P=ia(C,C),I=S*S-P*(ia(T,T)-1);if(!(I<0)){var q=St(I),D=sa(C,(-S-q)/P);if(Pa(D,T),D=Ga(D),!u)return D;var v=s[0],L=h[0],G=s[1],_=h[1],H;L<v&&(H=v,v=L,L=H);var oe=L-v,Z=je(oe-pe)<ve,W=Z||oe<ve;if(!Z&&_<G&&(H=G,G=_,_=H),W?Z?G+_>0^D[1]<(je(D[0]-v)<ve?G:_):G<=D[1]&&D[1]<=_:oe>pe^(v<=D[0]&&D[0]<=L)){var se=sa(C,(-S+q)/P);return Pa(se,T),[D,Ga(se)]}}}function x(s,h){var u=n?e:pe-e,b=0;return s<-u?b|=1:s>u&&(b|=2),h<-u?b|=4:h>u&&(b|=8),b}return Br(l,d,o,n?[0,-e]:[-pe,e-pe])}function Fs(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],x=a[1],s=0,h=1,u=c-l,b=x-d,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<s)return;p<h&&(h=p)}else if(u>0){if(p>h)return;p>s&&(s=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>h)return;p>s&&(s=p)}else if(u>0){if(p<s)return;p<h&&(h=p)}if(p=n-d,!(!b&&p>0)){if(p/=b,b<0){if(p<s)return;p<h&&(h=p)}else if(b>0){if(p>h)return;p>s&&(s=p)}if(p=o-d,!(!b&&p<0)){if(p/=b,b<0){if(p>h)return;p>s&&(s=p)}else if(b>0){if(p<s)return;p<h&&(h=p)}return s>0&&(e[0]=l+s*u,e[1]=d+s*b),h<1&&(a[0]=l+h*u,a[1]=d+h*b),!0}}}}}var $t=1e9,da=-$t;function Os(e,a,r,n){function i(x,s){return e<=x&&x<=r&&a<=s&&s<=n}function o(x,s,h,u){var b=0,p=0;if(x==null||(b=l(x,h))!==(p=l(s,h))||c(x,s)<0^h>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+h+4)%4)!==p);else u.point(s[0],s[1])}function l(x,s){return je(x[0]-e)<ve?s>0?0:3:je(x[0]-r)<ve?s>0?2:1:je(x[1]-a)<ve?s>0?1:0:s>0?3:2}function d(x,s){return c(x.x,s.x)}function c(x,s){var h=l(x,1),u=l(s,1);return h!==u?h-u:h===0?s[1]-x[1]:h===1?x[0]-s[0]:h===2?x[1]-s[1]:s[0]-x[0]}return function(x){var s=x,h=Dr(),u,b,p,g,y,f,j,E,k,A,R,T={point:M,lineStart:I,lineEnd:q,polygonStart:S,polygonEnd:P};function M(v,L){i(v,L)&&s.point(v,L)}function C(){for(var v=0,L=0,G=b.length;L<G;++L)for(var _=b[L],H=1,oe=_.length,Z=_[0],W,se,te=Z[0],ge=Z[1];H<oe;++H)W=te,se=ge,Z=_[H],te=Z[0],ge=Z[1],se<=n?ge>n&&(te-W)*(n-se)>(ge-se)*(e-W)&&++v:ge<=n&&(te-W)*(n-se)<(ge-se)*(e-W)&&--v;return v}function S(){s=h,u=[],b=[],R=!0}function P(){var v=C(),L=R&&v,G=(u=Pr(u)).length;(L||G)&&(x.polygonStart(),L&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),G&&Ir(u,d,v,o,x),x.polygonEnd()),s=x,u=b=p=null}function I(){T.point=D,b&&b.push(p=[]),A=!0,k=!1,j=E=NaN}function q(){u&&(D(g,y),f&&k&&h.rejoin(),u.push(h.result())),T.point=M,k&&s.lineEnd()}function D(v,L){var G=i(v,L);if(b&&p.push([v,L]),A)g=v,y=L,f=G,A=!1,G&&(s.lineStart(),s.point(v,L));else if(G&&k)s.point(v,L);else{var _=[j=Math.max(da,Math.min($t,j)),E=Math.max(da,Math.min($t,E))],H=[v=Math.max(da,Math.min($t,v)),L=Math.max(da,Math.min($t,L))];Fs(_,H,e,a,r,n)?(k||(s.lineStart(),s.point(_[0],_[1])),s.point(H[0],H[1]),G||s.lineEnd(),R=!1):G&&(s.lineStart(),s.point(v,L),R=!1)}j=v,E=L,k=G}return T}}const Xa=e=>e;var Ia=new wt,Za=new wt,$r,_r,en,tn,it={point:Ye,lineStart:Ye,lineEnd:Ye,polygonStart:function(){it.lineStart=Ps,it.lineEnd=Is},polygonEnd:function(){it.lineStart=it.lineEnd=it.point=Ye,Ia.add(je(Za)),Za=new wt},result:function(){var e=Ia/2;return Ia=new wt,e}};function Ps(){it.point=Ds}function Ds(e,a){it.point=Ur,$r=en=e,_r=tn=a}function Ur(e,a){Za.add(tn*e-en*a),en=e,tn=a}function Is(){Ur($r,_r)}var Ft=1/0,ka=Ft,Qt=-Ft,ja=Qt,Na={point:Bs,lineStart:Ye,lineEnd:Ye,polygonStart:Ye,polygonEnd:Ye,result:function(){var e=[[Ft,ka],[Qt,ja]];return Qt=ja=-(ka=Ft=1/0),e}};function Bs(e,a){e<Ft&&(Ft=e),e>Qt&&(Qt=e),a<ka&&(ka=a),a>ja&&(ja=a)}var an=0,nn=0,_t=0,Sa=0,Ea=0,Lt=0,rn=0,on=0,Ut=0,Hr,Vr,tt,at,Ve={point:kt,lineStart:tr,lineEnd:ar,polygonStart:function(){Ve.lineStart=Us,Ve.lineEnd=Hs},polygonEnd:function(){Ve.point=kt,Ve.lineStart=tr,Ve.lineEnd=ar},result:function(){var e=Ut?[rn/Ut,on/Ut]:Lt?[Sa/Lt,Ea/Lt]:_t?[an/_t,nn/_t]:[NaN,NaN];return an=nn=_t=Sa=Ea=Lt=rn=on=Ut=0,e}};function kt(e,a){an+=e,nn+=a,++_t}function tr(){Ve.point=$s}function $s(e,a){Ve.point=_s,kt(tt=e,at=a)}function _s(e,a){var r=e-tt,n=a-at,i=St(r*r+n*n);Sa+=i*(tt+e)/2,Ea+=i*(at+a)/2,Lt+=i,kt(tt=e,at=a)}function ar(){Ve.point=kt}function Us(){Ve.point=Vs}function Hs(){Wr(Hr,Vr)}function Vs(e,a){Ve.point=Wr,kt(Hr=tt=e,Vr=at=a)}function Wr(e,a){var r=e-tt,n=a-at,i=St(r*r+n*n);Sa+=i*(tt+e)/2,Ea+=i*(at+a)/2,Lt+=i,i=at*e-tt*a,rn+=i*(tt+e),on+=i*(at+a),Ut+=i*3,kt(tt=e,at=a)}function Yr(e){this._context=e}Yr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Ge);break}}},result:Ye};var sn=new wt,Ba,Gr,Kr,Ht,Vt,Jt={point:Ye,lineStart:function(){Jt.point=Ws},lineEnd:function(){Ba&&Qr(Gr,Kr),Jt.point=Ye},polygonStart:function(){Ba=!0},polygonEnd:function(){Ba=null},result:function(){var e=+sn;return sn=new wt,e}};function Ws(e,a){Jt.point=Qr,Gr=Ht=e,Kr=Vt=a}function Qr(e,a){Ht-=e,Vt-=a,sn.add(St(Ht*Ht+Vt*Vt)),Ht=e,Vt=a}let nr,Ca,rr,or;class ir{constructor(a){this._append=a==null?Jr:Ys(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==rr||this._append!==Ca){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,rr=n,Ca=this._append,or=this._,this._=i}this._+=or;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Jr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ys(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Jr;if(a!==nr){const r=10**a;nr=a,Ca=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Ca}function Gs(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Tt(d,i(o))),o.result()}return l.area=function(d){return Tt(d,i(it)),it.result()},l.measure=function(d){return Tt(d,i(Jt)),Jt.result()},l.bounds=function(d){return Tt(d,i(Na)),Na.result()},l.centroid=function(d){return Tt(d,i(Ve)),Ve.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,Xa):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new ir(r)):new Yr(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new ir(r)),l},l.projection(e).digits(r).context(a)}function gn(e){return function(a){var r=new ln;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ln(){}ln.prototype={constructor:ln,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function bn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Tt(r,e.stream(Na)),a(Na.result()),n!=null&&e.clipExtent(n),e}function Xr(e,a,r){return bn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function Ks(e,a,r){return Xr(e,[[0,0],a],r)}function Qs(e,a,r){return bn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function Js(e,a,r){return bn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var sr=16,Xs=Ee(30*$e);function lr(e,a){return+a?el(e,a):Zs(e)}function Zs(e){return gn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function el(e,a){function r(n,i,o,l,d,c,x,s,h,u,b,p,g,y){var f=x-n,j=s-i,E=f*f+j*j;if(E>4*a&&g--){var k=l+u,A=d+b,R=c+p,T=St(k*k+A*A+R*R),M=Kt(R/=T),C=je(je(R)-1)<ve||je(o-h)<ve?(o+h)/2:Gt(A,k),S=e(C,M),P=S[0],I=S[1],q=P-n,D=I-i,v=j*q-f*D;(v*v/E>a||je((f*q+j*D)/E-.5)>.3||l*u+d*b+c*p<Xs)&&(r(n,i,o,l,d,c,P,I,C,k/=T,A/=T,R,g,y),y.point(P,I),r(P,I,C,k,A,R,x,s,h,u,b,p,g,y))}}return function(n){var i,o,l,d,c,x,s,h,u,b,p,g,y={point:f,lineStart:j,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=A},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function f(M,C){M=e(M,C),n.point(M[0],M[1])}function j(){h=NaN,y.point=E,n.lineStart()}function E(M,C){var S=Rt([M,C]),P=e(M,C);r(h,u,s,b,p,g,h=P[0],u=P[1],s=M,b=S[0],p=S[1],g=S[2],sr,n),n.point(h,u)}function k(){y.point=f,n.lineEnd()}function A(){j(),y.point=R,y.lineEnd=T}function R(M,C){E(i=M,C),o=h,l=u,d=b,c=p,x=g,y.point=E}function T(){r(h,u,s,b,p,g,o,l,i,d,c,x,sr,n),y.lineEnd=k,k()}return y}}var tl=gn({point:function(e,a){this.stream.point(e*$e,a*$e)}});function al(e){return gn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function nl(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function dr(e,a,r,n,i,o){if(!o)return nl(e,a,r,n,i);var l=Ee(o),d=Ce(o),c=l*e,x=d*e,s=l/e,h=d/e,u=(d*r-l*a)/e,b=(d*a+l*r)/e;function p(g,y){return g*=n,y*=i,[c*g-x*y+a,r-x*g-c*y]}return p.invert=function(g,y){return[n*(s*g-h*y+u),i*(b-h*g-s*y)]},p}function rl(e){return ol(function(){return e})()}function ol(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,x=0,s,h=0,u=1,b=1,p=null,g=er,y=null,f,j,E,k=Xa,A=.5,R,T,M,C,S;function P(v){return M(v[0]*$e,v[1]*$e)}function I(v){return v=M.invert(v[0],v[1]),v&&[v[0]*ot,v[1]*ot]}P.stream=function(v){return C&&S===v?C:C=tl(al(s)(g(R(k(S=v)))))},P.preclip=function(v){return arguments.length?(g=v,p=void 0,D()):g},P.postclip=function(v){return arguments.length?(k=v,y=f=j=E=null,D()):k},P.clipAngle=function(v){return arguments.length?(g=+v?Rs(p=v*$e):(p=null,er),D()):p*ot},P.clipExtent=function(v){return arguments.length?(k=v==null?(y=f=j=E=null,Xa):Os(y=+v[0][0],f=+v[0][1],j=+v[1][0],E=+v[1][1]),D()):y==null?null:[[y,f],[j,E]]},P.scale=function(v){return arguments.length?(r=+v,q()):r},P.translate=function(v){return arguments.length?(n=+v[0],i=+v[1],q()):[n,i]},P.center=function(v){return arguments.length?(o=v[0]%360*$e,l=v[1]%360*$e,q()):[o*ot,l*ot]},P.rotate=function(v){return arguments.length?(d=v[0]%360*$e,c=v[1]%360*$e,x=v.length>2?v[2]%360*$e:0,q()):[d*ot,c*ot,x*ot]},P.angle=function(v){return arguments.length?(h=v%360*$e,q()):h*ot},P.reflectX=function(v){return arguments.length?(u=v?-1:1,q()):u<0},P.reflectY=function(v){return arguments.length?(b=v?-1:1,q()):b<0},P.precision=function(v){return arguments.length?(R=lr(T,A=v*v),D()):St(A)},P.fitExtent=function(v,L){return Xr(P,v,L)},P.fitSize=function(v,L){return Ks(P,v,L)},P.fitWidth=function(v,L){return Qs(P,v,L)},P.fitHeight=function(v,L){return Js(P,v,L)};function q(){var v=dr(r,0,0,u,b,h).apply(null,a(o,l)),L=dr(r,n-v[0],i-v[1],u,b,h);return s=Es(d,c,x),T=Qa(a,L),M=Qa(s,T),R=lr(T,A),D()}function D(){return C=S=null,P}return function(){return a=e.apply(this,arguments),P.invert=a.invert&&I,q()}}function Zr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Zr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(je(i)>ve&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function il(){return rl(Zr).scale(175.295)}function sl(e){return e}function ll(e){if(e==null)return sl;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var x=2,s=d.length,h=new Array(s);for(h[0]=(a+=d[0])*n+o,h[1]=(r+=d[1])*i+l;x<s;)h[x]=d[x],++x;return h}}function dl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function cl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return cr(e,r)})}:cr(e,a)}function cr(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=pl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function pl(e,a){var r=ll(e.transform),n=e.arcs;function i(s,h){h.length&&h.pop();for(var u=n[s<0?~s:s],b=0,p=u.length;b<p;++b)h.push(r(u[b],b));s<0&&dl(h,p)}function o(s){return r(s)}function l(s){for(var h=[],u=0,b=s.length;u<b;++u)i(s[u],h);return h.length<2&&h.push(h[0]),h}function d(s){for(var h=l(s);h.length<4;)h.push(h[0]);return h}function c(s){return s.map(d)}function x(s){var h=s.type,u;switch(h){case"GeometryCollection":return{type:h,geometries:s.geometries.map(x)};case"Point":u=o(s.coordinates);break;case"MultiPoint":u=s.coordinates.map(o);break;case"LineString":u=l(s.arcs);break;case"MultiLineString":u=s.arcs.map(l);break;case"Polygon":u=c(s.arcs);break;case"MultiPolygon":u=s.arcs.map(c);break;default:return null}return{type:h,coordinates:u}}return x(a)}const eo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ul=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ml(e,a,r){const n=eo[e];if(!n||!n.length)return-1;const i=ul(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let ca=null;function fl(){return ca||(ca=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=cl(r,n),o=il().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Gs(o),d=(i.features||[]).filter(s=>{var h;return(((h=s.properties)==null?void 0:h.name)||"")!=="Antarctica"}).map(s=>{var b;const h=((b=s.properties)==null?void 0:b.name)||"",u=l(s)||"";return u?{i2:Ho(h)||null,n:h,d:u}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,h]of Object.entries(Vo)){const u=o(h);u&&(c[s]={x:u[0],y:u[1]})}const x={};for(const[s,h]of Object.entries(eo)){const u=h.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(x[s]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:d,anchors:c,metros:x}}catch{return null}})(),ca)}function xl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return fl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const hl="8 40 984 210",gl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},pr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function ur(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function bl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var x;if(!i)return;const c=(x=e.current)==null?void 0:x.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function mr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function vl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:x,dossiers:s,source:h}=U(),u=x.loading&&!s.length,b=m.useRef(null),p=m.useRef(null),g=xl(e.continent==="monde"),y=e.continent==="monde"?g:un.find(v=>v.key===e.continent)||null,f=bl(b,e.continent+":"+e.mapFolded+":"+!!y),[j,E]=m.useState(new Map),[k,A]=m.useState(null);m.useEffect(()=>{const v=b.current;if(!v)return;const L=new Map;v.querySelectorAll("path[data-i2]").forEach(G=>{const _=G.dataset.i2;if(_)try{const H=G.getBBox();H.width>0&&L.set(_,{x:H.x,y:H.y,w:H.width,h:H.height})}catch{}}),E(L)},[e.continent,f,y]);const R=m.useMemo(()=>r.filter(v=>v.cc),[r]),T=m.useMemo(()=>{const v=new Map;return R.forEach(L=>v.set(L.cc,(v.get(L.cc)||0)+1)),v},[R]),M=e.continent==="monde"&&g?g.anchors:null,C=e.continent==="monde"&&g?g.metros:null,S=m.useMemo(()=>R.map(v=>{const L=ur(v.name||v.id||""),G=ur((v.id||v.name||"")+"·y");if(M&&v.cc){const W=C?C[v.cc]:void 0;if(W&&W.length){const te=ml(v.cc,v.city,L);if(te>=0&&W[te])return{d:v,x:W[te].x+(L-.5)*5,y:W[te].y+(G-.5)*5}}const se=M[v.cc];if(se)return{d:v,x:se.x+(L-.5)*10,y:se.y+(G-.5)*10}}const _=v.cc?j.get(v.cc):void 0;if(!_)return null;const H=gl[`${e.continent}:${v.cc||""}`];if(H)return{d:v,x:_.x+_.w*(H.fx+(L-.5)*H.sx),y:_.y+_.h*(H.fy+(G-.5)*H.sy)};const oe=(L-.5)*Math.min(_.w*.55,60),Z=(G-.5)*Math.min(_.h*.55,60);return{d:v,x:_.x+_.w/2+oe,y:_.y+_.h/2+Z}}).filter(v=>!!v),[R,j,M,C,e.continent]),P=v=>f>0?v/f:v,I=m.useMemo(()=>n?[0,1,2,3,4,5].map(v=>({c:pr[v],fr:c.plabels[v].toUpperCase(),en:c.plabels[v].toUpperCase(),n:r.filter(L=>L.kind==="target"&&ze(L)===v).length})).filter(v=>v.n>0):Ln.map((v,L)=>({...v,n:r.filter(G=>qn(G)===L).length})),[r,n,c.plabels]),q=o?l.get(o):null,D=q?S.find(v=>v.d.id===q.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(mr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:h==="ops"&&e.continent==="monde"?hl:y.viewBox,preserveAspectRatio:h==="ops"&&e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{A(null),i(null)},children:[t.jsx("g",{children:y.countries.map((v,L)=>t.jsx("g",{className:"ct"+(v.i2&&T.get(v.i2)?"":" empty"),children:t.jsx("path",{d:v.d,"data-i2":v.i2||void 0})},L))}),t.jsx("g",{children:S.map(v=>{const L=Ln[qn(v.d)],G=!!Te(v.d),_=v.d.kind==="target",H=n&&_?pr[ze(v.d)]:L.c,oe=!n&&Ie(v.d);return t.jsxs("g",{className:"co"+(oe?" done":""),onMouseEnter:()=>{var se,te;const Z=(se=p.current)==null?void 0:se.getBoundingClientRect(),W=(te=b.current)==null?void 0:te.createSVGPoint();if(W&&b.current&&Z){W.x=v.x,W.y=v.y;const ge=W.matrixTransform(b.current.getScreenCTM());A({x:ge.x-Z.left,y:ge.y-Z.top,label:v.d.name+" · "+(Pt(v.d.cc,d)||v.d.countryLabel||"")})}i(v.d.id)},onMouseLeave:()=>{A(null),i(null)},onClick:()=>{var se;if(h==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:v.d.id}),(v.d.noCo||["media","nominations","recrutements"].includes(v.d.engine||""))&&(v.d.url||v.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:v.d.url||"",text:[v.d.headline,v.d.tagline].filter(Boolean).join(`
`)}})):v.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:v.d.name,url:v.d.url||"",website:v.d.website||"",domain:v.d.domain||""}}));return}const Z=(se=b.current)==null?void 0:se.createSVGPoint();let W=null;if(Z&&b.current){Z.x=v.x,Z.y=v.y;const te=Z.matrixTransform(b.current.getScreenCTM());W={x:te.x,y:te.y}}a({type:"popup",id:v.d.id,anchor:W})},children:[t.jsx("circle",{className:"h",cx:v.x,cy:v.y,r:P(Math.max(11,L.px+7))}),t.jsx("circle",{className:"v",cx:v.x,cy:v.y,r:P(L.px),fill:H,stroke:G?"#DC2626":"#ffffff",strokeWidth:P(G?2.2:1.3)})]},v.d.id||v.d.name)})}),D&&t.jsx("circle",{className:"ring on",cx:D.x,cy:D.y,r:P(13),fill:"none",stroke:"#0F172A",strokeWidth:P(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:I.map((v,L)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":v.c}}),d==="fr"?v.fr:v.en," ",t.jsx("b",{children:v.n})]},L))}),r.some(v=>!v.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(v=>!v.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(mr,{msgs:c.loadMsgs})})}function yl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function to({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=U(),c=a.filters,[x,s]=m.useState(!1),[h,u]=m.useState(!1),b=m.useRef(null),p=m.useRef(null),g=m.useMemo(()=>a.continent==="monde"?n:n.filter(q=>q.continent===a.continent),[n,a.continent]),y=q=>g.filter(D=>q!=="country"&&c.country.length&&!c.country.includes(D.cc||"")?!1:ba(D,c,o,q==="country"?void 0:q)),f=m.useMemo(()=>{const q=y("win"),D=v=>q.filter(L=>(L.date?Math.max(0,Math.floor((Date.now()-Date.parse(L.date))/864e5)):9999)<=v).length;return[D(0),D(7),D(30),q.length]},[g,c,o]),j=m.useMemo(()=>c.day?y("win").filter(q=>(q.date||"").slice(0,10)===c.day).length:0,[g,c,o]),E=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,k=E+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!x&&!h)return;const q=v=>{var G,_;const L=v.target;x&&!((G=b.current)!=null&&G.contains(L))&&s(!1),h&&!((_=p.current)!=null&&_.contains(L))&&u(!1)},D=v=>{v.key==="Escape"&&(s(!1),u(!1))};return document.addEventListener("mousedown",q),document.addEventListener("keydown",D),()=>{document.removeEventListener("mousedown",q),document.removeEventListener("keydown",D)}},[x,h]);const A=(q,D,v,L="fbtn")=>t.jsxs("button",{type:"button",className:L,"aria-expanded":a.openFacet===q,onClick:()=>r({type:"openFacet",facet:q}),children:[t.jsx("span",{className:"fl",children:D}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},q),R=["1","7","30","all"],T=Math.max(0,R.indexOf(c.win||"all")),M=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(yl(c.day,d))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:p,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>u(q=>!q),children:[t.jsx("span",{className:"winpick-k",children:i.winMenu}),t.jsx("span",{className:"winpick-v",children:i.datesShort[T]}),t.jsx("b",{children:f[T]}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:R.map((q,D)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===q,onClick:()=>{r({type:"filters",patch:{win:q}}),u(!1)},children:[i.datesShort[D],t.jsx("span",{className:"n",children:f[D]})]},q))})]}):t.jsx("div",{className:"seg",children:R.map((q,D)=>t.jsxs("button",{type:"button","aria-pressed":c.win===q,onClick:()=>r({type:"filters",patch:{win:q}}),children:[t.jsx("span",{className:"sl",children:i.dates[D]}),t.jsx("b",{children:f[D]})]},q))}),C=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:q=>r({type:"filters",patch:{search:q.target.value}})})]}),S=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):A("sec",i.fSector,c.sector.length),A("pay",i.fCountry,c.country.length),A("det",i.fEngine,c.engine.length),A("sta",i.fStage,c.stage.length),o&&A("ang","Angle",c.angle.length),o&&A("mem","Mémo",c.memoLevel.length)]}),P=(q=!1)=>t.jsxs("div",{className:"frow2",children:[k>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(g.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(k)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),q&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),I=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(E?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{s(q=>!q),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),E>0&&t.jsx("span",{className:"n",children:E}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:S})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:M}),t.jsxs("div",{className:"fstrip-b",children:[C,I,P(!1)]})]}),a.openFacet&&t.jsx(fr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[M,C,S,t.jsx("span",{className:"fgrow"}),P()]}),a.openFacet&&t.jsx(fr,{poolFor:y})]})}function fr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=U(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:x}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(f=>Te(f)),g=new Map;p.forEach(f=>{const j=f.engine||"";g.set(j,(g.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...$a([...g.keys()],i).map(f=>({v:f,label:yt(f)+" "+_e(f,i),n:g.get(f)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const p=e("sector"),g=new Map;return p.forEach(y=>{y.sector&&g.set(y.sector,(g.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const p=e("country"),g=new Map;return p.forEach(y=>{y.cc&&g.set(y.cc,(g.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:Pt(y,i)||y,n:f,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const p=e("engine"),g=new Map;return p.forEach(y=>{y.engine&&g.set(y.engine,(g.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:$a([...g.keys()],i).map(y=>({v:y,label:yt(y)+" "+_e(y,i)+' <span style="color:var(--dim);font-size:10px">· '+Wo(Yo(y),i)+"</span>",n:g.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const p=e("angle"),g=new Map;return p.forEach(y=>{y.angle&&g.set(y.angle,(g.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(f=>{if(f.kind==="target"){const j=cn(f);g.set(j,(g.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:g.get(f)||0,html:!1,on:o.memoLevel.includes(f)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),s=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},h=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:h,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>s(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function ao({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=U(),c=m.useMemo(()=>{const b={};return r.forEach(p=>{ba(p,n.filters,o)&&(b.monde=(b.monde||0)+1,p.continent&&(b[p.continent]=(b[p.continent]||0)+1))}),b},[r,n.filters,o]),[x,s]=m.useState(!1),h=m.useRef(null);m.useEffect(()=>{if(!x)return;const b=g=>{var y;(y=h.current)!=null&&y.contains(g.target)||s(!1)},p=g=>{g.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",p)}},[x]);const u=b=>{const p=un.find(g=>g.key===b);return b==="monde"?d.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:h,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>s(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Mn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{i({type:"continent",key:b}),s(!1)},children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Mn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>i({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function no(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function wl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function xr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=U();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function ro({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=U(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(xr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(xr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function kl({card:e,onEvaluate:a,onAddAll:r}){var d,c,x;const{t:n}=U(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:no(e.summary_md||"").map((s,h)=>t.jsx("p",{children:s},h))})]}),t.jsx(ro,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function jl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Nl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=U(),d=i,[c,x]=m.useState(null),[s,h]=m.useState(null),[u,b]=m.useState(null),[p,g]=m.useState(!1);m.useEffect(()=>{let f=!0;return(async()=>{const j=await Nr({email:l,cbToken:d});f&&x(j)})(),()=>{f=!1}},[l,d,n]);const y=f=>{h(f),b(null),g(!0),(async()=>{const j=await Go(f.id);b(j),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{h(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[jl(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?o.rsPub:o.rsPriv})]},f.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(kl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const fa=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Wt(e){return/^https?:\/\//i.test((e||"").trim())}function Ze(e){const a=(e||"").trim();return a?Wt(a)?a:fa.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Sl(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function El(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:x,data:s,canWrite:h,source:u,dossiers:b,doAnalyse:p,liveMemos:g,pipe:y}=U(),f=a==="client",j=m.useMemo(()=>r||(u!=="default"?Ko():""),[r,u]),[E,k]=m.useState(""),[A,R]=m.useState(!1),[T,M]=m.useState(""),[C,S]=m.useState(""),[P,I]=m.useState(""),[q,D]=m.useState(!1),[v,L]=m.useState(!1),[G,_]=m.useState(""),[H,oe]=m.useState(!1),[Z,W]=m.useState(""),[se,te]=m.useState([]),ge=m.useRef(!1),[Y,de]=m.useState(!1),[ye,Se]=m.useState(!1),[be,ne]=m.useState(!1),re=m.useRef(!1),[ee,Q]=m.useState(""),[me,ke]=m.useState(""),[Ne,J]=m.useState(!1),[ae,Pe]=m.useState(!1),[qe,Ae]=m.useState(0),[we,Me]=m.useState(""),[xe,lt]=m.useState(null),[Re,rt]=m.useState(null),[Je,ut]=m.useState(!1),[dt,Ue]=m.useState(null),[mt,ft]=m.useState(0),N=m.useRef(!1),$=E.trim()?fa.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,V=m.useMemo(()=>G.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[G]);m.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),w=(O.get("rs")||"").trim(),F=(O.get("rstext")||"").trim();w&&/^https?:\/\//i.test(w)&&Q(w),F&&ke(F),(w&&/^https?:\/\//i.test(w)||F)&&de(!0)},[]),m.useEffect(()=>{const O=w=>{const F=w.detail||{},z=String(F.url||"").trim(),B=String(F.text||"").trim();z&&/^https?:\/\//i.test(z)&&Q(z),B&&ke(B),(z&&/^https?:\/\//i.test(z)||B)&&(de(!0),k(""),M(""),J(!0),window.setTimeout(()=>J(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),m.useEffect(()=>{const O=w=>{const F=w.detail||{},z=String(F.name||"").trim();if(!z)return;de(!1),k(z),M(z);const B=Ze(String(F.website||F.domain||""));S(B),I(Ze(String(F.url||""))),D(!B),R(!0),window.setTimeout(()=>R(!1),900)};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),m.useEffect(()=>{const O=(T||"").trim();if(!O||Y||C){(C||!O||Y)&&D(!1);return}const w=b.find(B=>Le(B.name)===Le(O)),F=Ze((w==null?void 0:w.website)||"")||Ze((w==null?void 0:w.domain)||"");if(F){S(F),D(!1);return}let z=!0;return D(!0),Sr(O).then(B=>{var X,ie;if(!z)return;const K=Ze(B.website||"")||Ze(((ie=(X=B.candidates)==null?void 0:X[0])==null?void 0:ie.url)||"");K&&S(K)}).catch(()=>{}).finally(()=>{z&&D(!1)}),()=>{z=!1}},[T,Y,C,b]),m.useEffect(()=>{const O=w=>{var z;const F=String(((z=w.detail)==null?void 0:z.url)||"").trim();Wt(F)&&window.open(F,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",O),()=>window.removeEventListener("ppmap:view",O)},[]),m.useEffect(()=>{if(re.current===Y)return;re.current=Y,ne(!0);const O=window.setTimeout(()=>ne(!1),560);return()=>window.clearTimeout(O)},[Y]),m.useEffect(()=>{if(typeof window>"u")return;const O=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),w=document.querySelector(".atl2.ops, .atl2.cibles");if(!O||!w)return;const F=()=>w.style.setProperty("--demand-h",`${O.offsetHeight}px`);F();let z=null;O.classList.contains("eval-stick")&&O.parentElement&&(z=O.previousElementSibling,(!z||!z.classList.contains("eval-sent"))&&(z=document.createElement("div"),z.className="eval-sent",z.setAttribute("aria-hidden","true"),O.parentElement.insertBefore(z,O)));const B=()=>{if(F(),!z||window.innerWidth>760){O.classList.remove("is-pinned"),z&&(z.style.height="0px");return}const X=getComputedStyle(document.documentElement),ie=parseFloat(X.getPropertyValue("--pp-gap"))||48,Fe=parseFloat(X.getPropertyValue("--pp-live-h"))||44,fe=z.getBoundingClientRect().top<ie+Fe+.5;O.classList.toggle("is-pinned",fe),z.style.height=fe?`${O.offsetHeight}px`:"0px"};B();const K=new ResizeObserver(B);return K.observe(O),window.addEventListener("scroll",B,{passive:!0}),window.addEventListener("resize",B),()=>{K.disconnect(),window.removeEventListener("scroll",B),window.removeEventListener("resize",B),O.classList.remove("is-pinned"),z&&z.classList.contains("eval-sent")&&z.remove()}},[u,A,Ne,v,Y,be,q]),m.useEffect(()=>{if(!h&&!j){Ue(null);return}let O=!0;return(async()=>{const w=await Nr({email:n,cbToken:j});O&&Ue(w.length)})(),()=>{O=!1}},[h,j,n,mt]);const le=se.length?se:c,ue=s.credits,ce=m.useCallback(O=>{const w=O.map(F=>(F||"").trim()).filter(Boolean);w.length&&(_(F=>{const z=F.split(`
`).map(X=>X.trim()).filter(Boolean),B=new Set(z.map(X=>X.toLowerCase())),K=w.filter(X=>!B.has(X.toLowerCase()));return[...z,...K].slice(0,15).join(`
`)}),L(!0))},[]);m.useEffect(()=>{if(!ae)return;Ae(0);const O=window.setInterval(()=>Ae(w=>w+1),1e3);return()=>window.clearInterval(O)},[ae]);const he=m.useMemo(()=>{const O=E.trim().toLowerCase();return!O||!y?null:b.find(w=>Le(w.name)===O&&ze(w)===1)||null},[E,b,y]),Ke=()=>{const O=E.trim();if(O){if(he){p(he);return}i(null,O),f&&k("")}},Et=async()=>{if(!f){i(null,V[0]||"");return}if(!V.length||H)return;oe(!0),ge.current=!1;const O=[];for(let w=0;w<V.length&&!ge.current;w++){W(e.evaluating(w+1,V.length,V[w]));const F=await Er(r,V[w],"atelier2");if(O.unshift({name:F.company||V[w],verdict:F.verdict,reason:F.reason||"",remaining:F.remaining??null}),te([...O]),F.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(V.length-w-1),remaining:0}),te([...O]),_(V.slice(w+1).join(`
`)),W(""),oe(!1);return}}W(""),_(ge.current?V.slice(O.length).join(`
`):""),oe(!1)},xt=async()=>{var F,z,B;if(N.current)return;const O=ee.trim().replace(/\s+/g,""),w=me.trim();if(!O&&!w){Me(e.rsNeed);return}if(!f&&!j){i(null,O||w.slice(0,80));return}N.current=!0,Me(""),lt(null),rt(null),Pe(!0);try{const K=await Jo({url:O,text:w,email:n,cbToken:j});if(Pe(!1),!K||K.status!=="success"){Me((K==null?void 0:K.message)||"Erreur");return}lt(K),de(!1),ce((((F=K.prospective)==null?void 0:F.companies_to_evaluate)||[]).map(ie=>(ie==null?void 0:ie.name)||"")),rt({state:"pending"});const X=await Xo(K,{email:n,cbToken:j});rt(X.ok?{state:"ok",scopeLabel:((z=X.summary)==null?void 0:z.scope_label)||"",scope:((B=X.summary)==null?void 0:B.scope)||""}:{state:"fail",msg:X.error||""}),X.ok&&ft(ie=>ie+1)}finally{N.current=!1,Pe(!1)}},Ct=[xe==null?void 0:xe.industry,...(xe==null?void 0:xe.market_tags)||[],xe==null?void 0:xe.author].map(O=>(O||"").trim()).filter(Boolean),ct=(Re==null?void 0:Re.state)==="pending",zt=Re&&(ct?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Re.state==="ok"?t.jsx("span",{className:"rslink ok",children:Re.scope&&Re.scope!=="public"?e.rsSavedIn(Re.scopeLabel||Re.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Re.msg,children:e.rsSaveFail})),He=wl(xe).length,De=Y,ht=(T||E).trim(),Qe=b.find(O=>Le(O.name)===Le(ht)),At=Ze(E)||C||Ze((Qe==null?void 0:Qe.website)||"")||Ze((Qe==null?void 0:Qe.domain)||""),It=P||Ze((Qe==null?void 0:Qe.url)||""),Ta=he?e.actAnalyse:ht?e.evalGoOn(ht.length>22?ht.slice(0,21)+"…":ht):e.evalGo,La=ae?`${Qo(ee.trim())==="youtube"&&ee.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(qe)}`:ct?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(De?" rs-mode":"")+(T&&E.trim()===T||A||Ne?" pair":"")+(A||Ne||be?" echo":"")+(be?" swap":""),children:[t.jsxs("div",{className:"drow"+((De?Ne:A)||be?" flash":"")+((De?ee.trim():fa.test(E.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:De?ee:E,placeholder:De?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:De?600:200,spellCheck:De?!1:void 0,inputMode:De?"url":void 0,onChange:O=>{if(De){Q(O.target.value);return}k(O.target.value),T&&O.target.value.trim()!==T&&(M(""),S(""),I(""),D(!1))},onKeyDown:O=>{O.key==="Enter"&&(De?xt():Ke())}}),t.jsx("span",{className:"detect"+(De?" off":"")+(fa.test(E.trim())?" url":""),children:$})]}),t.jsx("span",{className:"dacts",children:De?t.jsxs(t.Fragment,{children:[t.jsxs("a",{className:"viewbtn"+(Wt(ee)?"":" off"),href:Wt(ee)?ee.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:O=>{Wt(ee)||O.preventDefault()},children:[t.jsx(Sl,{}),e.viewLink]}),t.jsxs("button",{type:"button",className:"evalbtn"+(ae?" loading":""),disabled:ae||ct||!ee.trim()&&!me.trim(),onClick:()=>{xt()},children:[t.jsx("span",{className:"fill"}),La]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("a",{className:"viewbtn sm"+(q?" searching":At?"":" off"),href:At||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":q||void 0,title:q?e.viewSiteBusyHint:e.viewSiteHint,onClick:O=>{At||O.preventDefault()},children:[q&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),q?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(It?"":" off"),href:It||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:O=>{It||O.preventDefault()},children:e.viewSrc}),t.jsxs("button",{type:"button",className:"evalbtn"+(he?" analyse":"")+(d?" loading":""),disabled:d,onClick:Ke,children:[t.jsx("span",{className:"fill"}),Ta]})]})}),x.showCredits&&ue&&t.jsxs("button",{type:"button",className:"credits"+(ue.total_available<=0&&!ue.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ue.unlimited?"∞":ue.total_available}),!ue.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ue.daily_grant+ue.purchased]}),ue.total_available<=0&&!ue.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),g.items.filter(O=>O.status==="boot"||O.status==="running").map(O=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:O.name}),t.jsx(Yt,{item:O,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+O.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>L(!v),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(Y?" on":""),onClick:()=>de(!Y),children:e.rsOpen}),dt!==null&&dt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Je?" on":""),onClick:()=>ut(!Je),children:e.rsArchOpen(dt)})]}),Je&&t.jsx(Nl,{bump:mt,cbToken:j,onClose:()=>ut(!1),onEvaluate:O=>i(null,O),onAddAll:ce}),t.jsx("div",{className:"rsp slim"+(Y?" on":" off"),"aria-hidden":!Y,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:Y?void 0:-1,onClick:()=>Se(O=>!O),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:ye?"▴":"▾"})]}),ye&&t.jsx("textarea",{className:"rstext",value:me,placeholder:e.rsTextPh,tabIndex:Y?void 0:-1,onChange:O=>ke(O.target.value)})]})}),we&&t.jsx("div",{className:"rserr",children:we}),xe&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:xe.title}),xe.source_url&&t.jsx("a",{href:xe.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{lt(null),rt(null)},children:"×"})]}),xe.market&&t.jsx("p",{className:"rsmk",children:xe.market}),Ct.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Ct.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[xe.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${xe.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:no(xe.summary_md||"").map((O,w)=>t.jsx("p",{children:O},w))})]}),t.jsx(ro,{card:xe,onEvaluate:O=>i(null,O),onAddAll:ce}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(He)}),zt]})]}),v&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:G,placeholder:e.bulkPh,onChange:O=>_(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(H?" loading":""),style:{justifyContent:"center"},disabled:H||!V.length,onClick:()=>{Et()},children:[t.jsx("span",{className:"fill"}),H&&Z?Z:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(V.length)})]})]}),le.slice(0,1).map((O,w)=>{const F=O.verdict==="kept",z=O.verdict==="quota",B=F?"var(--brand)":z?"var(--bolt)":"var(--red)",K=F?"var(--brand-l)":z?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":B,"--bgc":K},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:F?"✓ "+e.kept:z?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map(X=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:X.url.startsWith("http")?X.url:`https://${X.url}`,target:"_blank",rel:"nofollow noopener",children:[(X.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,X.url),children:e.evalPickGo})]},X.url))}),!z&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:F?1:5});const X=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const ie=[...document.querySelectorAll(".atl2 .list .row")].find(Fe=>{var fe;return(((fe=Fe.querySelector(".rnm"))==null?void 0:fe.textContent)||"").trim().toLowerCase().includes(X)});ie&&(ie.scrollIntoView({behavior:"smooth",block:"center"}),ie.classList.add("flashrow"),window.setTimeout(()=>ie.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(F?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},w)}),f&&(o.kept+o.dropped>0||le.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Cl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function zl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=U(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",Cl(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const d=pt(o),c=cn(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((x,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Mt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function vn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=U(),[l,d]=m.useState(!1),[c,x]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,h=async()=>{if(!s||l)return;d(!0);const u=await Zo(r,e);if(d(!1),!u){o(a.actErr);return}x(u.results||[])};return m.useEffect(()=>{if(!s)return;const u=b=>{var g;const p=String(((g=b.detail)==null?void 0:g.name)||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&h()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,s]),m.useEffect(()=>{if(s)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),h())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{h()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Al=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),pa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Tl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=pa(a.slice(n));break}r+=pa(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=pa(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Al.has(c)?r+=`<${d[1]}${c}>`:r+=pa(a.slice(i,o+1)),n=o+1}return r}const hr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Oe({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ll(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ql({o:e}){const{t:a,doDeep:r}=U(),[n,i]=m.useState(!1),o=pt(e),l=[e.reasoning||"",Ll(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Mt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function yn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=U(),o=Zt(e),l=pt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),h=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Mt(e)?1:0}].filter(g=>g.n>0),[e,a,d,l,c,x,s]),[u,b]=m.useState("");if(!h.length)return null;const p=h.some(g=>g.k===u)?u:h[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:h.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===g.k,"data-tour":"tab-"+g.k,className:p===g.k?"on":"",onClick:y=>{y.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Oe,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Oe,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Oe,{k:a.cdVerdictDate,v:hr(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Tl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Ml,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Oe,{k:a.cdSector,v:e.sector}),t.jsx(Oe,{k:a.cdStage,v:e.stage}),t.jsx(Oe,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Oe,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Oe,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Oe,{k:a.cdAngle,v:e.angle}),t.jsx(Oe,{k:a.cdDetected,v:hr(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Oe,{k:a.cdName,v:e.contactName}),t.jsx(Oe,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Oe,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(ql,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Oe,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Oe,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Ml({o:e}){const{t:a,token:r}=U(),[n,i]=m.useState(!1),[o,l]=m.useState(null),d=async()=>{n||(i(!0),l(await ei(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},x=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=x.some(([,h])=>h);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[x.filter(([,h])=>h).map(([h,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:h}),t.jsx("p",{children:u})]},h)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function ea({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const d=()=>{const x=Math.max(280,Math.min(560,o.clientWidth||320));Rn({kind:"op",card:e},x).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Rn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const d=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&Ot.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Rl=`
...
`;function Fl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let d=e.y+10;return d+n>o-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function Ol(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:x,doPromote:s,doRepeche:h,doApproach:u,doDeep:b,doOnboard:p,outbound:g,evalBusy:y}=U(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const j=Te(f),E=ze(f),k=pt(f),A=Zt(f),R=f.kind==="target",T=M=>{a({type:"filters",patch:M}),a({type:"popup",id:null})};return Ot.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Rl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Fl(e.popupAnchor,!!f.card),onClick:M=>M.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(st(f.date)),_e(f.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>T({country:[f.cc]}),children:(Pt(f.cc,i)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>T({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>T({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Dt(f.amountEur,i)})]}),o.pipe&&R&&t.jsxs("div",{className:"pstat",children:[A&&t.jsx("span",{className:"vd "+(A==="MATCH"?"v-ok":"v-no"),title:n.vt[A],children:A}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[yt(f.engine)," ",t.jsx("b",{children:_e(f.engine,i)})," — ",ti(f.engine,i),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Nt,{o:f,lg:!0})," ",t.jsx(Aa,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(mn(j,i))," · ",n.win7(ha(j,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ea,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),o.pipe&&R&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),o.pipe&&R&&t.jsx(yn,{o:f})]}),t.jsx(vn,{name:f.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(f,!1),a({type:"popup",id:null})},children:n.actNo}),Mt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var M;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(M=document.querySelector(".atl2 .demand"))==null||M.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>d(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}const Pl=8;function Dl(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=U(),[d,c]=m.useState(!1),[x,s]=m.useState(!1),[h,u]=m.useState(!1),b=`atl2:sincemini:${r||"home"}`,[p,g]=m.useState(()=>{try{return localStorage.getItem(b)==="1"}catch{return!1}}),y=()=>{g(M=>{try{localStorage.setItem(b,M?"0":"1")}catch{}return!M})},f=r||"home",{names:j,verdicts:E}=m.useMemo(()=>{const M=[],C={};return n.forEach(S=>{S.kind!=="target"||!S.name||(M.push(S.name),C[S.name]=ai(S)||"")}),{names:M,verdicts:C}},[n]),k=m.useMemo(()=>j.length?ni(f,j,E,a):null,[f,j.length]);if(!i.pipe||d||!k||k.firstVisit||!k.added.length&&!k.gone.length)return null;const A=x?k.added:k.added.slice(0,Pl),R=k.added.length-A.length,T=M=>{const C=n.find(S=>S.name===M);C&&(o(C.id),l({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(k.added.length,k.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:y,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),ri(f,j,E,k.fp,a)},children:"×"})]}),!!k.added.length&&t.jsxs("div",{className:"sg-c",children:[A.map(M=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>T(M),children:t.jsx("b",{children:M})},M)),R>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>s(!0),children:e.sinceMore(R)})]}),!!k.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(M=>!M),children:e.sinceOut(k.gone.length)}),h&&k.gone.slice(0,20).map(M=>t.jsx("span",{className:"gone",children:M},M))]})]})}function Il(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=U(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const x=u=>{const b=c.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${_a[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},s=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${_a[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),h=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[h("↩",n.toolUndo,i,e.undo.length===0),h("↺",n.toolReset,()=>{a({type:"reset"})}),h("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),h("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),h("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Bl(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=U(),d=m.useRef(null),[c,x]=m.useState(60);m.useEffect(()=>{let p=0;const g=()=>{var k;const y=d.current;if(!y)return;const f=(k=y.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!f)return;const j=f.getBoundingClientRect(),E=y.getBoundingClientRect();x(Math.max(20,Math.min(j.left+j.width/2-E.left,E.width-30)))};return p=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",g)}},[e.ptab]);const s=e.ptab;let h=r.tuto[s].p;if(s===3){const p=n.filter(f=>f.kind==="target"&&ze(f)===3),g=p.filter(f=>Ua(f)==="auto").length,y=p.filter(f=>Ua(f)==="cd").length;h=r.tutoPending(g,y,p.length)}const u=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(s===1){const p=n.filter(g=>g.kind==="target"&&ze(g)===1&&!i.has(g.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(g=>g.id)})}}return null})(),b=oi(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${_a[s]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:h}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const oo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function wn({o:e,locked:a=!1}){const{t:r}=U(),n=Zt(e),i=pt(e),o=ze(e),l=Ua(e),d=si(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(oo[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(fs,{o:e})]})}const jt=e=>e.length>22?e.slice(0,21)+"…":e,xa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function za(e){return xa.has(e.engine||"")}function bt(e){return!!e.noCo||za(e)&&!!e.url}function Xt(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function io(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function $l({on:e,rev:a}){const[r,n]=m.useState(null),[i,o]=m.useState({top:0,left:0,width:0});return m.useEffect(()=>{if(!e){n(null);return}const l=()=>{var p,g,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const x=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:x.top;o({top:Math.round(s),left:Math.round(x.left),width:Math.round(x.width)});const h=[...d.querySelectorAll(":scope .grp")];let u=null;for(const f of h){const j=f.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=s+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((p=b.querySelector(".ic"))==null?void 0:p.textContent)||"").trim(),t:(((g=b.querySelector(".t"))==null?void 0:g.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||i.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:i.top,left:i.left,width:i.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function _l(e){const r=()=>{const n=io(),i=e.getBoundingClientRect().top-n-8;Math.abs(i)<2||window.scrollBy({top:i,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function gr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=U(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),Ie(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(jt(e.name))})]})}function kn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:x,dispatch:s,liveMemos:h}=U(),u=p=>g=>{g.stopPropagation(),p()};if(r.lockActions){const p=u(()=>s({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:p,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const g=ze(e);return g===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:p,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(jt(e.name))})]})}):g===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p,children:a.actAnalyse})}):g===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:p,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:p,children:a.actNo})]})}):g===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:p,children:a.actPromote})}):g===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:p,children:a.actApproach})}):g===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:p,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:p,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Xt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return za(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Xt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(gr,{o:e})});const b=ze(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(gr,{o:e})});if(b===1){const p=h.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Yt,{item:p,serverOff:h.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const g=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:g,onClick:u(()=>o(e)),children:g?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(b===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:u(()=>x(e)),children:p?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Ul({o:e}){const{t:a,doThumb:r,thumbOf:n}=U(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Hl({o:e}){const{lang:a}=U();return Te(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Nt,{o:e}),t.jsx(Aa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[yt(e.engine||"")," ",_e(e.engine||"",a)]})})}function Vl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:d,caps:c,markRow:x,markedId:s,favIds:h,toggleFav:u,t:b}=U(),p=ze(e),g=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,f=y<=0?0:y<=7?1:y<=30?2:3,j=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][p]:g[f],E=h.has(e.id),k=A=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const R=A.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:R.left+Math.min(280,R.width/3),y:R.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>x(e.id),onMouseLeave:()=>x(null),onClick:k,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(uo,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:E?1:.35,padding:0,marginRight:4},onClick:A=>{A.stopPropagation(),u(e)},children:E?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(A=>A&&A!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:b.acqSee(e.acquirer),onClick:A=>{A.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",jt(e.acquirer)]}),nt(e)?t.jsx("span",{className:"rdec",title:b.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:b.zoomNewsMark,children:"📰"}):null]}),t.jsx(Wl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Hl,{o:e}),c.pipe&&t.jsx(wn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(kn,{o:e}),c.showThumbs&&t.jsx(Ul,{o:e})]}),r&&!a&&!l&&t.jsx(Kl,{o:e})]})}function Wl({o:e}){const{lang:a,caps:r}=U();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Dt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Yl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=U(),l=(u,b=!1)=>p=>{p.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Dt(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Ie(e),h=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped})]}):bt(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),Xt(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(jt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(jt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ea,{spec:e.card})})]})}function Gl({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=U();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[_e(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(kn,{o:e})}),t.jsx(yn,{o:e})]})}function so({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:d,dossiers:c}=U();if(!e&&!a){const q=c.find(nt);if(q)return t.jsx(so,{o:q})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),s=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),h=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),b=e?!!e.noCo:!x||ga(x),p=(e==null?void 0:e.engine)||"",g=nt(e),y=e?Dt(e.amountEur,n):"",f=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),j=(()=>{const q=/https?:\/\/(?:www\.)?([^/]+)/.exec(s);return q?q[1].replace(/^www\./,"").slice(0,40):""})(),E=c.find(nt),k=((E==null?void 0:E.url)||"").trim(),A=!!s&&!!k&&(s===k||s.endsWith(k)||k.endsWith(s)),R=(q,D=!1)=>v=>{v.stopPropagation(),D&&l({type:"continent",key:"monde"}),l({type:"filters",patch:q})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{x&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:x}}))},M=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},C=()=>{Xt({url:s,headline:h,tagline:e==null?void 0:e.tagline,name:x})},S=e?Ie(e):!1,P=S&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",I=g?r.doEdito.replace(/^📖\s*/,""):p?_e(p,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[I,f?` · ${f}`:""]}),t.jsx("h3",{className:"zoom-h",children:h}),s&&!g&&(b||za({engine:p}))&&t.jsxs("a",{className:"zoom-ext",href:s,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:q=>q.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,j?t.jsx("em",{children:j}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:R({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:R({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:R({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(ea,{spec:u})}),(s&&!A&&!g||E&&!g)&&t.jsxs("div",{className:"zoom-srcbox",children:[s&&!A&&!g&&t.jsxs("a",{className:"zoom-src",href:s,target:"_blank",rel:"nofollow noopener",onClick:q=>q.stopPropagation(),children:[r.zoomSrc,j?` · ${j}`:""," ↗"]}),E&&!g&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:q=>{q.stopPropagation(),l({type:"focus",id:E.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[S?t.jsxs("span",{className:"verdict",style:{"--c":P?"var(--brand)":"var(--red)"},children:[P?"✓":"✗"," ",t.jsx("b",{children:P?r.kept:r.dropped})]}):!b&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:q=>{q.stopPropagation(),i(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(jt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,s&&!g&&(b||za({engine:p}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!b&&x?" ghost":""),onClick:q=>{q.stopPropagation(),C()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!b&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:q=>{q.stopPropagation(),M()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:q=>{q.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:jt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!b&&x&&d.pipe&&t.jsx(vn,{name:x})]})]})}function Kl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=U();return!i.pipe&&e.kind==="op"?t.jsx(Yl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(yn,{o:e}),t.jsx(xs,{o:e}),t.jsx(bs,{o:e}),t.jsx(vn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(wn,{o:e})})]}),e.card&&t.jsx(ea,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[yt(e.engine||"")," ",_e(e.engine||"",r)]}),Te(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Nt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Ql({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:d,lang:c}=U();if(!l.pipe&&e.kind==="op"){const h=Dt(e.amountEur,c),u=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),b=(p,g=!1)=>y=>{y.stopPropagation(),g&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ea,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[yt(e.engine||"")," ",_e(e.engine||"",c)]}),Te(e)&&t.jsx(Nt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(kn,{o:e})})]})}const x=ze(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][x];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(wn,{o:e}),Te(e)&&t.jsx(Nt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&x===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function Jl(){const{t:e}=U(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Xl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=U(),o=i==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,h)=>(e[h]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:o?`${x} ${x>1?"files":"file"} in “${l(c)}”`:`${x} dossier${x>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function Zl(){var ut,dt,Ue,mt,ft;const e=U(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:d,markRow:c,lang:x,sessTally:s,data:h,dossiers:u,source:b,focusExtra:p,byId:g,token:y}=e,f=Tr(),j=m.useMemo(()=>{var V,le,ue,ce;if(!y||b==="ops")return null;const N=(((V=f==null?void 0:f.ed)==null?void 0:V.date)||(f==null?void 0:f.day)||"").slice(0,10),$=[(le=f==null?void 0:f.ed)==null?void 0:le.html,(ue=f==null?void 0:f.ed)==null?void 0:ue.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:x==="en"?"Today's brief":"Brief du jour",headline:x==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((ce=f==null?void 0:f.ed)==null?void 0:ce.date)||N,decryptHtml:$||void 0,date:N,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,x,(ut=f==null?void 0:f.ed)==null?void 0:ut.html,(dt=f==null?void 0:f.ed)==null?void 0:dt.acquirers_html,(Ue=f==null?void 0:f.ed)==null?void 0:Ue.date,f==null?void 0:f.day]),E=N=>i.lockRowsAfter!==null||b==="ops"?Number.MAX_SAFE_INTEGER:zr,[k,A]=m.useState(new Set);m.useEffect(()=>{A(new Set)},[a.ptab,a.continent]);const[R,T]=m.useState(null);m.useEffect(()=>{T(null)},[a.ptab,a.continent]);const[M,C]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){C(!1);return}const N=document.getElementById("atl2-stage");if(!N){C(!1);return}const $=new IntersectionObserver(([V])=>C(!!V&&V.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return $.observe(N),()=>$.disconnect()},[a.mapFolded]);const S=a.mapFolded||!M,P=N=>A($=>{const V=new Set($);return V.has(N)?V.delete(N):V.add(N),V}),I=b==="ops"||i.pipe,[q,D]=m.useState("all"),[v,L]=m.useState(null),[G,_]=m.useState(!1),H=m.useRef(!0);m.useEffect(()=>{if(H.current){H.current=!1;return}D("all"),_(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!G)return;const N=$=>{var V,le;(le=(V=$.target)==null?void 0:V.closest)!=null&&le.call(V,".atl2 .doable")||_(!1)};return document.addEventListener("click",N),()=>document.removeEventListener("click",N)},[G]);const oe=m.useMemo(()=>{var $;const N=new Map;for(const V of as((($=f==null?void 0:f.ed)==null?void 0:$.html)||""))N.has(V.t)||N.set(V.t,V.html);return N},[(mt=f==null?void 0:f.ed)==null?void 0:mt.html]),Z=m.useCallback(N=>{if(N.decryptHtml)return N.decryptHtml;if(!oe.size)return;const $=(N.name||"").trim().toLowerCase();if($.length<3)return;const V=oe.get($);if(V)return V;for(const[le,ue]of oe)if(le.includes($)||$.includes(le))return ue},[oe]),W=m.useMemo(()=>{let N=fn(l,a.sort);return N=N.filter($=>!nt($)),q==="explore"?N=N.filter(bt):q==="eval"&&(N=N.filter($=>!bt($)&&!$.noCo)),N},[l,a.sort,q,Z]),se=m.useMemo(()=>i.pipe?d.filter(N=>Te(N)&&ii(N)):W.filter(N=>Te(N)&&!Ie(N)),[i.pipe,d,W]),te=se.length,[ge,Y]=m.useState(!1),[de,ye]=m.useState(!1),Se=`atl2:sigmini:${((ft=h.session)==null?void 0:ft.token)||"home"}`,[be,ne]=m.useState(()=>{try{return localStorage.getItem(Se)==="1"}catch{return!1}}),re=m.useMemo(()=>i.pipe?W:W.filter(N=>!Ie(N)&&!N.noCo),[W,i.pipe]),ee=b==="ops"?W.filter(bt).length:0,Q=i.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,me=a.filters,ke=[];if(me.day)ke.push({k:"day",lib:n.fDay(me.day.slice(8,10)+"/"+me.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(me.win&&me.win!=="all"){const N=["1","7","30"].indexOf(me.win);N>=0&&ke.push({k:"win",lib:n.dates[N],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ne=N=>N.length<=2?N.join(", "):`${N.length} ${n.fSelected}`;for(const N of["sector","country","engine"]){const $=me[N];$&&$.length&&ke.push({k:N,lib:Ne($),off:()=>r({type:"clearFacet",facet:N})})}me.search&&ke.push({k:"search",lib:"🔍 "+me.search,off:()=>r({type:"filters",patch:{search:""}})});const J=(N,$,V="",le=!1)=>t.jsxs("button",{type:"button","data-s":N,className:V,"aria-sort":a.sort.key===N?a.sort.dir===1?"ascending":"descending":"none",style:le?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:N}),children:[$,t.jsx("span",{className:"ar",children:a.sort.key===N&&a.sort.dir===1?"▴":"▾"})]},N),ae=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const N=new Map;W.forEach(le=>{const ue=le.engine||"?";N.has(ue)||N.set(ue,[]),N.get(ue).push(le)});const $={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},V=$a([...N.keys()],x);return[...N.entries()].sort((le,ue)=>{const ce=$[le[0]]??10+V.indexOf(le[0]),he=$[ue[0]]??10+V.indexOf(ue[0]);return ce-he})},[W,i.pipe,a.groupBy,x]),Pe=ae?ae.filter(([N])=>xa.has(N)).length:0,qe=(()=>{var $;return(($=(ae?ae.flatMap(([,V])=>V):W)[0])==null?void 0:$.id)??null})(),Ae=m.useRef(!1),we=m.useMemo(()=>u.find(nt)||j,[u,j]);m.useEffect(()=>{const N=()=>{Ae.current=!0};return window.addEventListener("ppmap:reveal",N),window.addEventListener("ppmap:focus",N),()=>{window.removeEventListener("ppmap:reveal",N),window.removeEventListener("ppmap:focus",N)}},[]),m.useEffect(()=>{const N=()=>{we&&r({type:"focus",id:we.id})};return window.addEventListener("ppmap:edito",N),()=>window.removeEventListener("ppmap:edito",N)},[we,r]),m.useEffect(()=>{if(!a.focusId)return;L(a.focusId);const N=window.setTimeout(()=>L(null),900);return()=>window.clearTimeout(N)},[a.focusId]),m.useEffect(()=>{if(I&&!(a.focusId&&(W.some(N=>N.id===a.focusId)||u.some(N=>N.id===a.focusId)||a.focusId===(we==null?void 0:we.id)))&&!p){if(we){r({type:"focus",id:we.id});return}qe&&r({type:"focus",id:qe})}},[I,a.focusId,W,qe,p,r,u,b,we]),m.useEffect(()=>{if(!(!I||!a.focusId)&&q!=="all"&&!(we&&a.focusId===we.id)&&!W.some(N=>N.id===a.focusId)&&u.some(N=>N.id===a.focusId)){if(Ae.current){D("all");return}qe&&r({type:"focus",id:qe})}},[I,a.focusId,q,W,u,qe,r]),m.useEffect(()=>{if(!I||!a.focusId||!Ae.current)return;Ae.current=!1;const N=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel");if(!N)return;const $=io(),V=N.getBoundingClientRect();V.top>=$-2&&V.bottom<=window.innerHeight-4||_l(N)},[I,a.focusId]),m.useEffect(()=>{if(typeof window>"u")return;const N=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),$=document.querySelector(".atl2.ops, .atl2.cibles");if(!N||!$)return;const V=()=>$.style.setProperty("--listhead-h",`${N.offsetHeight}px`);V();const le=new ResizeObserver(V);return le.observe(N),()=>le.disconnect()},[S,a.dens,a.mapFolded]);const Me=m.useMemo(()=>{if(!I||!a.focusId)return null;if(j&&a.focusId===j.id)return j;const N=W.find(V=>V.id===a.focusId)||u.find(V=>V.id===a.focusId)||null;if(!N)return null;const $=Z(N);return $&&$!==N.decryptHtml?{...N,decryptHtml:$}:N},[I,a.focusId,W,u,Z,j]),xe=i.lockRowsAfter;let lt=0;const Re=(N,$)=>{let V=a.shown[$]||E();return N.length-V<=4&&(V=N.length),N.slice(0,V).map(ce=>{const he=xe!==null&&lt>=xe;lt++;const Ke=Z(ce),Et=Ke&&Ke!==ce.decryptHtml?{...ce,decryptHtml:Ke}:ce,xt=!I&&a.dens!=="maxi"&&(a.dens==="deplie"||(R?R==="open":!!Ke)),Ct=k.has(ce.id)?!xt:xt,ct=I?zt=>{Ae.current=!0,r({type:"focus",id:zt});const He=g.get(zt);He&&(bt(He)?Xt(He):He.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:He.name,url:He.url||"",website:He.website||"",domain:He.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Ql,{o:Et,locked:he,selected:I&&a.focusId===ce.id,onSelect:ct},ce.id):t.jsx(Vl,{o:Et,locked:he,open:Ct,onToggle:()=>P(ce.id),selected:I&&a.focusId===ce.id,echo:v===ce.id,onSelect:ct},ce.id)})},rt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(W.length?"":" list-empty"),Je=t.jsxs(t.Fragment,{children:[ae?ae.map(([N,$])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:yt(N)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:N==="ma"?n.grpMa:N==="fundraising"?n.grpLev:xa.has(N)&&Pe<=1?n.grpNews:N==="nominations"?n.grpNom:N==="media"?n.grpNewsOther:N==="recrutements"?n.grpHire:xa.has(N)?n.grpNews+" · "+_e(N,x):_e(N,x)}),t.jsx("div",{className:"s",children:n.grpCount($.filter(V=>!Ie(V)).length,$.length)})]})]}),Re($,N)]},N)):Re(W,"pt"+a.ptab),h.loading&&!u.length&&t.jsx(Jl,{}),!W.length&&!(h.loading&&!u.length)&&(i.pipe?t.jsx(Xl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(S?" mapoff":""),children:[i.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Il,{}),t.jsx(Bl,{})]}),t.jsxs("div",{className:"lh-top",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:W.length})," ",Q]}),t.jsx("span",{className:"dot",children:"·"}),S&&t.jsx(ao,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[S?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),ke.map(N=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:$=>{$.stopPropagation(),N.off()},children:[N.lib,t.jsx("i",{children:"×"})]},N.k)),b==="ops"&&W.length>0&&!S&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",W.length-ee," ",n.zoomPulseEval,ee>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",ee," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(i.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([N,$])=>t.jsxs("button",{type:"button","data-d":N,"aria-pressed":a.dens===N||N==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:N}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:$})]},N))}),!I&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":R==="open",onClick:()=>{T("open"),A(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":R==="closed",onClick:()=>{T("closed"),A(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||b==="ops")&&(()=>{var ce;const N=l.filter(he=>!nt(he)),$=N.filter(he=>!bt(he)&&!he.noCo).length,V=N.filter(bt).length,le=[["all",n.doAll],["eval",`${n.doEval}${$?` ${$}`:""}`],["explore",`${n.doExplore}${V?` ${V}`:""}`]],ue=((ce=le.find(([he])=>he===q))==null?void 0:ce[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":G,onClick:()=>_(he=>!he),children:[ue,t.jsx("i",{children:"▾"})]}),G&&t.jsx("div",{className:"dolist",children:le.map(([he,Ke])=>t.jsx("button",{type:"button","aria-pressed":q===he,onClick:()=>{D(he),_(!1)},children:Ke},he))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:N=>r({type:"sort",key:N.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([N,$])=>t.jsx("option",{value:N,children:$},N))})]}),i.showChain&&re.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:re.map(N=>N.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(re.length):n.chainAll(re.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]}),S&&t.jsx("div",{className:"lh-tools",children:t.jsx(to,{compact:!0})})]}),t.jsx(Dl,{}),te>0&&!a.filters.signalOnly&&!de&&t.jsxs("div",{className:"sigstrip"+(be?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(te)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!be,title:be?n.boxExpand:n.boxCollapse,onClick:()=>ne(N=>{try{localStorage.setItem(Se,N?"0":"1")}catch{}return!N}),children:be?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>ye(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(ge?se:se.slice(0,12)).map(N=>{const $=Te(N);return $?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(mn($,x),ha($,x)),onClick:()=>{c(N.id),r({type:"popup",id:N.id})},children:[t.jsx("b",{children:N.name}),t.jsxs("i",{children:[$.emoji," ",Ha($,x)]}),t.jsx("em",{children:ha($,x)})]},"sg-"+N.id):null}),!ge&&se.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>Y(!0),children:n.sigStripMore(se.length-12)})]})]}),a.dens!=="maxi"&&!I&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),J("country",n.colCountry),J("name",n.colCompany),J("amount",n.colAmount,"h-amt",!0),J("stage",n.colStage,"h-stade"),J("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[J("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),J("memo",n.colMemo)]}),i.pipe&&J("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),I?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),J("country",n.colCountry),J("name",n.colCompany),J("amount",n.colAmount,"h-amt",!0),J("stage",n.colStage,"h-stade"),J("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:rt,children:Je})]}),t.jsxs("aside",{className:"readpane"+((Me?nt(Me):!p&&we)?" is-edito":""),"aria-label":x==="fr"?"Dossier":"File",children:[we&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===we.id,onClick:()=>r({type:"focus",id:we.id}),children:b==="ops"?n.doEdito:n.doBrief}),j&&a.focusId===j.id?t.jsx("div",{className:"zoom",children:t.jsx(os,{})}):i.pipe?t.jsx(Gl,{o:Me}):t.jsx(so,{o:Me,extra:Me?null:p})]})]}):t.jsx("div",{className:rt,children:Je}),(()=>{const N=ae||[["pt"+a.ptab,W]];let $=0,V=0;for(const[ue,ce]of N){V+=ce.length;let he=a.shown[ue]||E();ce.length-he<=4&&(he=ce.length),$+=Math.min(ce.length,he)}const le=V-$;return le<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>N.forEach(([ue,ce])=>r({type:"more",group:ue,by:ce.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(le,le)}),t.jsx("span",{className:"more-meta",children:n.moreMeta($,V)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),I&&b==="ops"&&a.dens!=="maxi"&&t.jsx($l,{on:!!ae,rev:(ae||[]).map(([N,$])=>N+$.length).join("|")})]})}function br(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ed(e,a){const r=li(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function td(e,a){const n=[a.head.split("|").map(br).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",ed(i,a.plabels),Zt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(br).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ad(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const nd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function et({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function rd({o:e,qa:a}){const{t:r,lang:n,fund:i}=U(),o=(e.cribleStatus||"").trim().toUpperCase()||(Zt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=pt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(et,{k:r.cdSector,v:e.sector}),t.jsx(et,{k:r.cdStage,v:e.stage}),t.jsx(et,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(et,{k:r.cdSite,v:e.domain||e.website}),t.jsx(et,{k:r.cdName,v:e.contactName}),t.jsx(et,{k:r.cdEmail,v:e.contactEmail}),t.jsx(et,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(et,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(et,{k:r.cdAngle,v:e.angle}),t.jsx(et,{k:r.cdDetected,v:nd(e.date,n)})]}),c.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,x])=>x).map(([x,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:s})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function od(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=U(),[d,c]=m.useState({}),x=25,s=m.useMemo(()=>n.slice(0,x),[n]);m.useEffect(()=>{s.length&&di(r,s.map(b=>b.name)).then(c)},[r,s]);const h=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),h&&typeof h.screened=="number"&&t.jsxs("p",{children:[u(h.screened)," ",e.funScreened(""),typeof h.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(h.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(h.screened/o.marketEstimate*100)," %"]})]})]}),s.map(b=>t.jsx(rd,{o:b,qa:d[b.name]},b.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const id=50;function jn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=U(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[x,s]=m.useState(""),[h,u]=m.useState(0),[b,p]=m.useState(""),[g,y]=m.useState(!1),f=m.useRef(null);m.useEffect(()=>()=>{f.current&&window.clearInterval(f.current)},[]);const j=async k=>{c(!0),s("");const A=await a();if(c(!1),A.ok){l(A);return}if(A.busy){s(i.alertPreviewBusy);return}if(!k){s(i.alertPreviewFail);return}u(id),f.current=window.setInterval(()=>{u(R=>R>1?R-1:(f.current&&window.clearInterval(f.current),j(!1),0))},1e3)},E=async()=>{if(n||g)return;y(!0),p("");const k=await r();y(!1),p(k.ok?i.alertTestOk(k.sentTo||""):k.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||h>0,onClick:()=>{j(!0)},children:d?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{E()},children:g?"…":i.alertTest})]}),h>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(h)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const qt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Be({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=U();return Ot.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function sd(){const{st:e}=U();switch(e.modal){case"chain":return t.jsx(dd,{});case"space":return t.jsx(cd,{});case"alert":return t.jsx(pd,{});case"queue":return t.jsx(hd,{});case"export":return t.jsx(gd,{});case"plug":return t.jsx(yd,{});case"recharge":return t.jsx(kd,{});case"cover":return t.jsx(Nd,{});case"dossier":return t.jsx(jd,{});case"crit":return t.jsx(Sd,{});case"tuto":return t.jsx(Ed,{});case"rdv":return t.jsx(ld,{});case"memoalert":return t.jsx(bd,{});default:return null}}function ld(){const{dispatch:e,fund:a,t:r}=U(),n=a||r.rdvCoFallback;return Ot.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Mr,children:hn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${va}`,children:va})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Mi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function dd(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:d,caps:c,memoQueued:x,doAnalyse:s}=U(),h=o==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,p=u[b],g=b>=u.length;return Ot.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[Pt(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(st(p.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:_e(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Dt(p.amountEur,i)})]}),Te(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Nt,{o:p,lg:!0})," ",t.jsx(Aa,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),h&&Ie(p)&&t.jsxs("div",{className:"vbox",style:{"--c":vt(p)==="retenu"?"var(--brand)":vt(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:vt(p)==="retenu"?"✓ "+n.kept:vt(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&p&&c.pipe&&ze(p)===1&&!x.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&p&&!(h&&Ie(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function cd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=U(),o=i==="client",l=m.useMemo(()=>o?r.filter(h=>Ie(h)):[],[r,o]),d=m.useMemo(()=>fn(l.filter(h=>vt(h)==="retenu"),{key:"signal",dir:-1}),[l]),c=m.useMemo(()=>l.filter(h=>vt(h)==="ecarte"),[l]),x=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Be,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(h=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof h.score=="number"&&h.score>0?h.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:h.name}),t.jsx("div",{className:"rr",children:h.reasoning||h.tagline||""})]})]},h.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function pd(){const{mode:e}=U();return e==="client"||e==="apercu"?t.jsx(ud,{}):t.jsx(xd,{})}function ud(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=U(),[o,l]=m.useState("d"),d=i!=="client";return t.jsxs(Be,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(md,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="w"&&t.jsx(fd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="m"&&t.jsx(lo,{})]})}function md({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[x,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),Pn(a).then(g=>{p&&(g?l(g):c(!0))}),()=>{p=!1}},[a,x]);const h=p=>{r||Pn(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),b=p=>{const g=o.sections||e.alertSec.map(([y])=>y);h({sections:u(p)?g.filter(y=>y!==p):[...g,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>h({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>h({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>h({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>b(p)}),t.jsxs("span",{children:[g,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(jn,{label:e.alertPreview,readOnly:r,onPreview:()=>vi(a),onTest:()=>bi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function fd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[x,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),Dn(a).then(g=>{p&&(g?l(g):c(!0))}),()=>{p=!1}},[a,x]);const h=p=>{r||Dn(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>h({dow:Number(p.target.value)}),children:e.alertDow.map((p,g)=>t.jsx("option",{value:g,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(jn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>wi(a),onTest:()=>yi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function lo(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=U(),[l,d]=m.useState(o||""),[c,x]=m.useState(!1),[s,h]=m.useState(!1);m.useEffect(()=>{o&&d(o)},[o]);const u=e.filters,b=m.useMemo(()=>n.filter(f=>Te(f)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){h(!0);try{await fetch(`${dn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{h(!1)}}},y=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>_e(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Pt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:f=>d(f.target.value),onKeyDown:f=>{f.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function xd(){const{t:e}=U();return t.jsx(Be,{title:e.alertTitle,icon:"🔔",children:t.jsx(lo,{})})}function hd(){var M,C;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:d,dispatch:c,liveMemos:x}=U(),[s,h]=m.useState(null),[u,b]=m.useState([]),[p,g]=m.useState(0),y=n==="client",f=m.useMemo(()=>{const S=new Map;return i.forEach(P=>{const I=(P.name||"").trim().toLowerCase();I&&!S.has(I)&&S.set(I,P)}),S},[i]);m.useEffect(()=>{let S=!0;return(async()=>{const[P,I]=await Promise.all([pn(r),jr(a)]);S&&(P&&h(P),b(I))})(),()=>{S=!1}},[a,r,p]);const j=(s==null?void 0:s.per_day)??0,E=((M=s==null?void 0:s.analyzed_today)==null?void 0:M.length)??0,k=s==null?void 0:s.offre,A=(s==null?void 0:s.pool_meta)||[],R=m.useMemo(()=>{const S=new Map;for(const P of(s==null?void 0:s.scheduled)||[])for(const I of P.names||[])S.has(I)||S.set(I,{label:P.day_label,date:P.date});return S},[s==null?void 0:s.scheduled]),T=(s==null?void 0:s.in_progress)||[];return t.jsxs(Be,{title:e.queueTitle,wide:!0,children:[k&&t.jsxs("div",{className:"qoffre"+(k.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:k.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:k.delai})]}),t.jsx("span",{className:"osp"}),k.rythme>0?t.jsx("span",{className:"or",children:e.qRate(k.rythme)}):k.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(k.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((C=s==null?void 0:s.pool_order)==null?void 0:C.length)??0))}})}),k&&t.jsxs("div",{className:"qeta",children:[k.file===0?e.qEtaDone:k.rythme<=0?e.qEtaPaused:e.qEta(k.file,k.rythme,k.jours_restants),k.en_retard&&t.jsxs("em",{children:[" ",e.qLate(k.delai,k.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(k==null?void 0:k.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(T.length>0||x.items.some(S=>S.status==="boot"||S.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[x.items.filter(S=>S.status==="boot"||S.status==="running"||S.status==="error").map(S=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:S.name}),t.jsx("span",{className:"qd",children:S.memoType||""}),t.jsx(Yt,{item:S,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+S.name)),T.filter(S=>!x.liveOf(S.name)).map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.name}),t.jsxs("span",{className:"qd",children:[S.memo_type||"",S.age_min?` · ${Math.round(S.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:S.state||""})]},"ip-"+S.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.company}),t.jsxs("span",{className:"qd",children:[S.memo_type,typeof S.est_min=="number"?` · ~${S.est_min} min`:""]}),t.jsx("span",{className:"qt",children:S.status}),S.url&&t.jsx("a",{className:"qgo",href:S.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),y&&S.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{On(a,S.company,"retry").then(()=>g(P=>P+1))},children:e.queueRetry}),y&&S.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{On(a,S.company,"delete").then(()=>g(P=>P+1))},children:e.queueDelete})]},S.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(A.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[A.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),A.map((S,P)=>{const I=R.get(S.name),q=f.get((S.name||"").trim().toLowerCase()),D=x.liveOf(S.name),v=!!(q&&l.has(q.id))||!!(D&&(D.status==="boot"||D.status==="running")),L=!!(q&&ze(q)===1&&!q.memoUrl)&&!D;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",P+1]}),I?t.jsx("span",{className:"qwhen"+(I.label==="demain"?" soon":""),children:I.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:S.name}),S.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof S.score=="number"&&t.jsx("span",{className:"qs2",children:S.score}),D&&(D.status==="boot"||D.status==="running")&&t.jsx(Yt,{item:D,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),L&&(d.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:v,onClick:()=>{o(q),g(G=>G+1)},children:v?e.actAnalyseQueued:e.actAnalyse})),S.excerpt&&t.jsx("span",{className:"qex",children:S.excerpt})]},S.name+":"+P)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([S,P])=>t.jsxs("li",{children:[t.jsx("b",{children:S})," — ",P]},S))})]})}function gd(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=U(),d=`${qt}/cibles/list.csv?token=${a}`,c=`${qt}/cibles/list.json?token=${a}`,x=`${qt}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,h=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:x,href:x}],b=!i.lockActions&&n.length>0,p=()=>{ad(td(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Be,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:f,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>h(f),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function bd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=U(),o=i!=="client",[l,d]=m.useState(null),[c,x]=m.useState(!1),[s,h]=m.useState(0),[u,b]=m.useState(!1);m.useEffect(()=>{let f=!0;return x(!1),Fn(a).then(j=>{f&&(j?d(j):x(!0))}),()=>{f=!1}},[a,s]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=f=>{if(o||!l)return;const j={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??p()};b(!0),Fn(a,j).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}d(E),r(e.memoAlertSaved)})};if(c)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=p();return t.jsxs(Be,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(vd,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>g({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:o||u,onChange:()=>g({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:j})]},f))}),t.jsx(jn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>pi(a,y),onTest:()=>ci(a,y)})]})}function vd({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const d=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:x=>l(x.target.value),onKeyDown:x=>{x.key==="Enter"&&d&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:n})]})]})}function yd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=U(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[x,s]=m.useState(null),[h,u]=m.useState(""),[b,p]=m.useState(0);m.useEffect(()=>{let E=!0;return c(!1),Va(a).then(k=>{E&&(k?l({configured:k.configured,url_hint:k.url_hint}):c(!0))}),fi(a).then(k=>{E&&s(k)}),()=>{E=!1}},[a,b]);const g=(E,k)=>{i&&Va(a,E).then(A=>{if(!A||A.ok===!1){n(e.actErr);return}E.test&&A.sent===!1?n(e.plugTestThrottled):r(k),p(R=>R+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${qt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Be,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:h,disabled:!i,onChange:E=>u(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!h.trim(),onClick:()=>g({url:h.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(wd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function wd(){const{t:e,token:a,lang:r}=U(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[d,c]=m.useState(null),[x,s]=m.useState(null),[h,u]=m.useState(!1),[b,p]=m.useState(!1),[g,y]=m.useState(null),[f,j]=m.useState(null),[E,k]=m.useState(null),A=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Va(a).then(I=>{j(I&&I.configured?I.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),s(null),u(!1),y(null);try{const I=JSON.parse(localStorage.getItem(A)||"null");k(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{k(null)}},[A]);const R=async()=>{l(!0),u(!1),y(null);const I=await hi(a,n);c(I),s(I.ok?n:null),l(!1)},T=m.useRef(!1),M=async()=>{if(T.current)return;T.current=!0,p(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let q;try{q=await gi(a,n,"webhook",void 0,I)}finally{T.current=!1}if(p(!1),u(!1),y(q),q.ok&&(q.pushed||0)>0){const D={t:new Date().toISOString(),n:q.pushed||0};k(D);try{localStorage.setItem(A,JSON.stringify(D))}catch{}}},C=d!=null&&d.ok&&d.ready||0,S=!!(d!=null&&d.ok)&&x===n&&C>0&&!!f&&!E,P=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>i(I.target.value),children:e.plugBulkTabs.map(([I,q])=>t.jsx("option",{value:I,children:q},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{R()},children:o?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(P,E.n)}),!E&&!!(d!=null&&d.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),S&&!h&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),S&&h&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(C,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{M()},children:b?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function kd(){const{t:e,data:a,lang:r}=U(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const x=await(await fetch(`${dn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Be,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function jd(){const{t:e}=U();return t.jsx(Be,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(od,{})})}function Nd(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:d}=U(),[c,x]=m.useState(null),[s,h]=m.useState(!1);m.useEffect(()=>{let C=!0;if(o)return pn(o).then(S=>{C&&S&&typeof S.per_day=="number"&&x(S.per_day)}),()=>{C=!1}},[o]);const[u,b]=m.useState(null);m.useEffect(()=>{if(!i)return;let C=!0;return mi(i).then(S=>{C&&b(S)}),()=>{C=!1}},[i]);const p=r.stats,g=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(C=>C.kind==="target"&&Ie(C)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(g/y*100)):null,j=(p==null?void 0:p.window_days)||30,E=g>0?g/j:0,k=y>0?Math.max(0,y-g):0,R=y>0&&E>0&&g>=100?Math.round(k/E):null,T=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),M=C=>{s||!l||(h(!0),xi(i,C).then(S=>{if(h(!1),S===null){d(e.actErr);return}x(S),d(e.alertSaved)}))};return t.jsxs(Be,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(T(g))}),y>0&&t.jsx("span",{children:e.covOf(T(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),R!==null&&t.jsx("p",{className:"mnote",children:e.covEta(R)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(T(E))}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:T(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:T(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:T(p.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((C,S)=>t.jsxs("tr",{className:C.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[C.code,C.geo?` · ${C.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof C.n=="number"?T(C.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:C.source}),C.elargi&&t.jsx("em",{children:e.covWide(String(C.demande||""))}),C.erreur&&t.jsx("em",{children:e.covMissing})]})]},S)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:T(u.total||y)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:c===C?"on":"",disabled:s,onClick:()=>M(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Sd(){var f,j,E;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:d}=U(),c=n==="client",x=m.useMemo(()=>{const k=new Set;return a.forEach(A=>{A.angle&&k.add(A.angle)}),[...k]},[a]),[s,h]=m.useState(""),[u,b]=m.useState(""),[p,g]=m.useState(!1),y=async()=>{const k=s.trim();if(!(!k||p||!c)){g(!0),b("");try{const R=await(await fetch(`${qt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(R.reply&&b(String(R.reply)),R.job_id){b(e.critChatRunning);const T=async()=>{const M=await fetch(`${qt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:R.job_id})}).then(C=>C.json()).catch(()=>null);if(M&&M.done){b(String(M.reply||M.clarification||M.summary||"✓")),g(!1),M.applied&&i(e.alertSaved);return}setTimeout(()=>{T()},8e3)};setTimeout(()=>{T()},8e3),h("");return}h("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(Be,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((f=o.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=o==null?void 0:o.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(k=>{var A,R;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((A=k.look)!=null&&A.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(T=>t.jsx("li",{children:T},T))})]}),!!((R=k.out)!=null&&R.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(T=>t.jsx("li",{children:T},T))})]})]})]},k.title)})]}),!!((E=o==null?void 0:o.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||p,onChange:k=>h(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!c||p||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ui,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(oo[k]||"v-cons"),children:k}),t.jsx("span",{children:A})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",A]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ed(){const{t:e,dispatch:a,startTour:r}=U(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Be,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const co="atl2:mapfold",Cd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(co);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},zd=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},po=m.createContext(null),U=()=>{const e=m.useContext(po);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Nt({o:e,lg:a}){const{lang:r}=U(),n=Te(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ha(n,r),children:[n.emoji," ",Ha(n,r)]}):null}function Aa({o:e,src:a}){const{lang:r,t:n}=U(),i=Te(e);if(!i)return null;const o=Ci(i),l=zi(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(mn(i,r))+" · "+n.win7(ha(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Ad(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Le(a);if(i)return e.find(o=>Le(o.name)===i)||e.find(o=>{const l=Le(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function Td(){const{scoped:e,t:a,st:r,dispatch:n}=U(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(h=>!nt(h)),d=l.length,c=l.filter(h=>!h.noCo).length,x=l.filter(h=>!!h.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const h=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:h,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",x," ",a.zoomPulseExplore]})]})]})}function uo({o:e}){const{lang:a}=U(),r=Ei(e.cc),n=e.cc?Pt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const vr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Ld=!1;function qd(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const mo=e=>`atl2:tour:${e||"anon"}`;function Md(e){try{return localStorage.getItem(mo(e))==="1"}catch{return!0}}function yr(e){try{localStorage.setItem(mo(e),"1")}catch{}}function Rd(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Id({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var O;const{lang:l}=ki(),d=Bi[l],c=Ji(e,l,a),[x,s]=m.useReducer(es,void 0,()=>Xi((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?zd():Cd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),h=m.useRef(!0);m.useEffect(()=>{if(h.current){h.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(co,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var w;(w=u.current)==null||w.call(u,x.filters)},[x.filters]);const[b,p]=m.useState(null),[g,y]=m.useState(null),[f,j]=m.useState(null),[E,k]=m.useState({kept:0,dropped:0}),[A,R]=m.useState(!1),[T,M]=m.useState(""),[C,S]=m.useState(!1),[P,I]=m.useState(null),[q,D]=m.useState(!1),[v,L]=m.useState(!1),[,G]=m.useState(0),_=()=>G(w=>w+1),H=m.useRef([]),oe=m.useRef(new Set),Z=m.useRef(new Set),[W,se]=m.useState([]),[te,ge]=m.useState([]),[Y,de]=m.useState(0),ye=m.useRef(new Map),Se=m.useRef(null),{mode:be}=c,ne=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),re=ne.pipe,ee=c.session.token||"",Q=be==="client"&&!e;m.useEffect(()=>{if(!ee||!re)return;let w=!0;const F=async()=>{const K=await Ai(ee);!w||!K||(ge(K.runs),de(Date.now()/1e3-K.now),se(X=>X.filter(ie=>!K.runs.some(Fe=>Le(Fe.company)===Le(ie.name)))))};F();const z=W.length>0||te.some(K=>K.status==="running"),B=window.setInterval(()=>{F()},z?8e3:25e3);return()=>{w=!1,window.clearInterval(B)}},[ee,re,W.length,te.some(w=>w.status==="running")]);const me=m.useMemo(()=>{const w=[],F=new Set;for(const z of W){const B=Le(z.name);!B||F.has(B)||(F.add(B),w.push({name:z.name,id:z.id,status:"boot",started:z.started,estMin:z.estMin,memoType:"instant"}))}for(const z of te){const B=Le(z.company);if(!B||F.has(B))continue;F.add(B);const K=z.status==="error"?"error":z.status==="done"?"done":"running";w.push({name:z.company,status:K,started:z.started||0,estMin:z.est_min||(z.memo_type==="detailed"?40:15),url:z.url,error:z.error,memoType:z.memo_type})}return w},[W,te]),ke=w=>me.find(F=>Le(F.name)===Le(w))||null,Ne=(w,F)=>{se(z=>z.some(B=>Le(B.name)===Le(w.name))?z:[...z,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:F==="detailed"?40:15}]),oe.current.add(w.id),_()};m.useEffect(()=>{if(document.querySelector(`link[href="${vr}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=vr,document.head.appendChild(w)},[]);const J=(w,F=!1)=>{M(w),S(F),Se.current&&clearTimeout(Se.current),Se.current=setTimeout(()=>M(""),F?4200:2400)},ae=w=>J(w,!0),Pe=m.useMemo(()=>{const w=new Map;return c.dossiers.forEach(F=>{F.id&&w.set(F.id,F)}),w},[c.dossiers]),qe=m.useMemo(()=>c.dossiers.filter(w=>Ar(w,x,re)),[c.dossiers,x,re]),Ae=m.useRef(!1);m.useEffect(()=>{if(Ae.current||e||c.loading||!c.dossiers.length)return;if(!ne.showFunnel||Md(c.session.token||"")){Ae.current=!0;return}Ae.current=!0;const w=window.setTimeout(()=>{yr(c.session.token||""),D(!0)},700);return()=>window.clearTimeout(w)},[e,c.loading,c.dossiers.length,ne.showFunnel,c.session.token]);const we=m.useMemo(()=>c.dossiers.filter(w=>ts(w,x,re,c.favIds)),[c.dossiers,x,re,c.favIds]),Me=m.useMemo(()=>ji(qe,c.favIds),[qe,c.favIds]),xe=m.useRef(!1);m.useEffect(()=>{if(xe.current)return;if(!re||a==="ops"){xe.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){xe.current=!0;return}if(c.loading)return;xe.current=!0;const w=Ni(Me);w!==x.ptab&&s({type:"ptab",tab:w})},[re,a,n==null?void 0:n.ptab,c.loading,Me,x.ptab]);const lt=m.useMemo(()=>{const w=Fr(c.dossiers);return w?st(w)===0?d.tourToday:Or(w,l):d.tourNoRun},[c.dossiers,d,l]),Re=m.useMemo(()=>c.dossiers.some(w=>!!w.memoUrl||!!w.summary||Mt(w)),[c.dossiers]),[rt,Je]=m.useState(!1);m.useEffect(()=>{if(c.loading){Je(!1);return}if(c.dossiers.length>0||c.error){Je(!0);return}const w=window.setTimeout(()=>Je(!0),6e3);return()=>window.clearTimeout(w)},[c.loading,c.dossiers.length,c.error]);const ut=(c.marketEstimate||0)>0||typeof((O=c.stats)==null?void 0:O.screened)=="number"&&c.stats.screened>0,dt=m.useMemo(()=>[1,0,2,4,5,3].find(w=>(Me[w]||0)>0)??0,[Me]),Ue=un.find(w=>w.key===x.continent),mt=x.continent==="monde"?d.contWorld:(l==="fr"?Ue==null?void 0:Ue.fr:Ue==null?void 0:Ue.en)||"";m.useEffect(()=>{const w=F=>{var B;const z=(((B=F.detail)==null?void 0:B.name)||"").trim();z&&ft(null,z)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),m.useEffect(()=>{if(a!=="ops")return;const w=F=>{const z=F.detail||{},B=String(z.id||"").trim(),K=String(z.name||"").trim(),X=String(z.url||"").trim(),ie=B&&Pe.get(B)||Ad(c.dossiers,K,X);if(ie){y(null),window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:ie.id}),(ie.noCo||["media","nominations","recrutements"].includes(ie.engine||""))&&(ie.url||ie.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:ie.url||"",text:[ie.headline,ie.tagline].filter(Boolean).join(`
`)}})):ie.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ie.name,url:ie.url||"",website:ie.website||"",domain:ie.domain||""}}));return}!K&&!X||(s({type:"focus",id:null}),y({name:K,headline:String(z.text||"").trim()||K,url:X,card:z.card}),X&&(ga(K)||!K)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:X,text:String(z.text||"").trim()}})):K&&!ga(K)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:K}})))};return window.addEventListener("ppmap:focus",w),()=>window.removeEventListener("ppmap:focus",w)}),m.useEffect(()=>{const w=B=>{const K={},X=String((B==null?void 0:B.sector)||"").trim();X&&(K.sector=[X]);const ie=String((B==null?void 0:B.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(ie)&&(K.day=ie);const Fe=String((B==null?void 0:B.search)||"").trim();Fe&&(K.search=Fe);const fe=String((B==null?void 0:B.dealKind)||"").trim();(fe==="ma"||fe==="levee"||fe==="other")&&(K.dealKind=[fe]),Object.keys(K).length&&s({type:"filters",patch:K})},F=B=>w(B.detail),z=B=>{B.data&&B.data.type==="pp-filter"&&w(B.data)};return window.addEventListener("ppmap:filter",F),window.addEventListener("message",z),()=>{window.removeEventListener("ppmap:filter",F),window.removeEventListener("message",z)}},[]),m.useEffect(()=>{const w=F=>{var K;const z=(((K=F.detail)==null?void 0:K.name)||"").trim().toLowerCase();if(!z)return;const B=c.dossiers.find(X=>(X.name||"").trim().toLowerCase()===z);B&&s(a==="ops"?{type:"focus",id:B.id}:{type:"popup",id:B.id})};return window.addEventListener("ppmap:similar",w),()=>window.removeEventListener("ppmap:similar",w)});const ft=(w,F)=>{const z=((w==null?void 0:w.name)||F||"").trim();if(!Q){j({kicker:z});return}!z||A||(R(!0),(async()=>{try{let B=z;const K=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(K)B=K;else try{const fe=await Sr(z);if(fe!=null&&fe.website)B=fe.website;else if(((fe==null?void 0:fe.candidates)||[]).length===1)B=fe.candidates[0].url;else if(((fe==null?void 0:fe.candidates)||[]).length>1){H.current=[{name:z,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(fe.candidates||[]).slice(0,5)},...H.current].slice(0,8),_();return}}catch{}const X=await Er(ee,B,"atelier2"),ie={name:X.company||z,verdict:X.verdict,reason:X.reason||"",remaining:X.remaining??null};H.current=[ie,...H.current].slice(0,8),X.verdict==="kept"&&k(fe=>({...fe,kept:fe.kept+1})),X.verdict==="ruled_out"&&k(fe=>({...fe,dropped:fe.dropped+1}));const Fe=w||c.dossiers.find(fe=>(fe.name||"").toLowerCase()===z.toLowerCase());Fe&&(X.verdict==="kept"?Fe.verdict=Fe.verdict||"MATCH":X.verdict==="ruled_out"&&(Fe.verdict="NO MATCH"),X.reason&&(Fe.reasoning=X.reason)),_()}finally{R(!1)}})())},N=w=>{if(!Q){j({kicker:w.name});return}Ne(w,"instant"),Bt(ee,"fast_request",w.name||"",""),J(d.memoInstantSent(w.name))},$=w=>ye.current.get(w.id)??c.thumbs.get((w.name||"").trim().toLowerCase()),V=(w,F)=>s({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:F}}),le=async(w,F,z)=>{const B=w.ceoStatus||"";w.ceoStatus=F,_();const K=await Ma(ee,{status:F,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(z==null?void 0:z.note)!==void 0?{note:z.note}:{},...z!=null&&z.via?{via:z.via}:{}});return K.ok?K.skipped?(w.ceoStatus=B,_(),ae(d.actNotPersisted),!1):((z==null?void 0:z.undo)!==!1&&V(w,B),z!=null&&z.msg&&J(z.msg),(F==="Validé"||F==="Écarté")&&!w.ceoNote&&(z==null?void 0:z.note)===void 0&&I({o:w,yes:F==="Validé"}),!0):(w.ceoStatus=B,_(),ae(d.actErr),!1)},ue=async(w,F)=>{const z=await Ma(ee,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:F,via:"note"});return!z.ok||z.skipped?(ae(z.skipped?d.actNotPersisted:d.actErr),!1):(w.ceoNote=F,_(),!0)},ce=m.useRef(new Map),he=w=>ce.current.has(w.id)?ce.current.get(w.id):c.stages.get((w.name||"").trim().toLowerCase()),Ke=(w,F)=>{ce.current.set(w.id,F),_()},Et=(w,F)=>{Q&&le(w,F?"Validé":"Écarté",{msg:F?d.decidedYes(w.name):d.decidedNo(w.name)})},xt=w=>{Q&&le(w,"À trancher",{msg:d.promoted(w.name)})},Ct=w=>{Q&&(async()=>{const F=w.ceoStatus||"";w.ceoStatus="Retenu",_();const z=await Ma(ee,{status:"Retenu",check_id:w.checkId,company:w.name});if(!z.ok||z.skipped){w.ceoStatus=F,_(),ae(z.skipped?d.actNotPersisted:d.actErr);return}V(w,F),J(d.repeched(w.name))})()},ct=()=>{const w=x.undo[x.undo.length-1];if(!w){J(d.undoNone);return}const F=Pe.get(w.id);if(!F){s({type:"undoPop"}),J(d.undoNone);return}let z=w.prevCeoStatus;if(!z)if((F.verdict||"").toUpperCase().includes("CALL"))z="À trancher";else{J(d.undoLockedTitle);return}(async()=>await le(F,z,{undo:!1})&&(s({type:"undoPop"}),F.ceoStatus=w.prevCeoStatus,_(),J(d.undoDone(F.name))))()},zt=w=>{Q&&(Z.current.add(w.id),_(),(async()=>{const F=await Ti(ee,w.name,"email");if(!F||F.ok===!1){Z.current.delete(w.id),_(),ae(d.actErr);return}Bt(ee,"approach",w.name||"",""),J(d.actApproachSent)})())},He=(w,F)=>{Q&&(async()=>{if(!(await Bt(ee,F?"yes":"no",w.name||"","")).ok){ae(d.actErr);return}ye.current.set(w.id,F?"yes":"no"),_(),J(F?d.thumbUpDone:d.thumbDnDone)})()},De=w=>{!Q||!Mt(w)||(Ne(w,"detailed"),Bt(ee,"detailed_request",w.name||"",""),J(d.memoDeepSent(w.name)))},ht=w=>{const F=new Set(c.favIds),z=F.has(w.id);z?F.delete(w.id):F.add(w.id),c.setFavIds(F),Q&&Li(ee,{id:w.id,co:w.name},z)},Qe=()=>{!Q||v||window.confirm(d.identSyncConfirm)&&(L(!0),(async()=>{const w=await qi(ee);L(!1),w?J(d.identSyncDone):ae(d.actErr)})())},At=/proplace/i.test(c.fund||""),It=w=>{!Q||!At||(Bt(ee,"onboard_request",w.name||"",""),J(d.onboardSent(w.name)))},Ta={st:x,dispatch:s,t:d,lang:l,mode:be,caps:ne,pipe:re,token:ee,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:Ct,thumbOf:$,canWrite:Q,commitStatus:le,saveNote:ue,stageOf:he,setStage:Ke,flashErr:ae,startTour:()=>D(!0),dossiers:c.dossiers,scopedAll:qe,scoped:we,counts:Me,byId:Pe,contName:mt,favIds:c.favIds,toggleFav:ht,askEvaluate:ft,doAnalyse:N,doDecide:Et,doPromote:xt,doApproach:zt,doThumb:He,doDeep:De,doUndo:ct,doSync:Qe,doOnboard:It,outbound:At,memoQueued:oe.current,liveMemos:{items:me,serverOff:Y,liveOf:ke},approachDone:Z.current,sessTally:E,evalCards:H.current,evalBusy:A,markRow:p,markedId:b,flash:J,focusExtra:g};m.useEffect(()=>{const w=F=>{F.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const La=w=>ee?t.jsx(ns,{token:ee,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(po.Provider,{value:Ta,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ee?" cibles":""),children:[t.jsx("style",{children:Ui}),La(t.jsxs("div",{className:"app"+(re?" pipe":"")+(ee?" has-thesis":""),children:[ne.showTicker&&t.jsx(Xe,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ee?" live-stack--cibles":""),children:[t.jsx(ds,{}),!!ee&&t.jsx(rs,{})]})}),ne.showIdent&&t.jsx(Xe,{name:"identite",children:t.jsx(ws,{})}),!1,Ld,ne.showFunnel&&t.jsx(Xe,{name:"entonnoir",children:t.jsx(Fd,{})}),!x.mapFolded&&t.jsx(Xe,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(ao,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Td,{}),t.jsx(vl,{}),t.jsx(to,{})]})]})}),ne.showDemand&&re&&t.jsx(Xe,{name:"direct",children:t.jsx(Pi,{items:me,serverOff:Y,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),ne.showDemand&&t.jsx(Xe,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(El,{})})}),ne.showDemand&&x.memoConsole&&t.jsx(Xe,{name:"console",children:t.jsx(zl,{})}),t.jsx(Xe,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(Zl,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),x.popupId&&x.dens!=="liste"&&a!=="ops"&&t.jsx(Xe,{name:"fiche",children:t.jsx(Ol,{})}),t.jsx(Xe,{name:"modales",children:t.jsx(sd,{})}),t.jsx(us,{}),P&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:P.o.name}),t.jsx(gs,{placeholder:P.yes?d.whyYesPh:d.whyNoPh,onDone:w=>{const F=P.o;I(null),w&&ue(F,w).then(z=>{z&&J(d.csNoteSaved)})}})]}),q&&rt&&t.jsx(vs,{steps:Rd(d,lt,Re,dt,ut),onClose:()=>{D(!1),yr(ee)}}),t.jsx(qd,{}),ne.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Mr,children:hn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${va}`,children:va})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),T&&t.jsx("div",{className:"flash on"+(C?" err":""),children:T}),f&&t.jsx(Si,{variant:"acquirer",initialCompany:wr().co,initialWebsite:wr().site,onClose:()=>j(null)})]})})}function Fd(){const{t:e}=U(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function wr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Od(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{uo as FlagCell,Nt as SigBadge,Aa as SigWin,Id as default,Od as fmtShort,U as useV2};
