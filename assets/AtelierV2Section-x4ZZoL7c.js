...
`,zs=Es+Ss+Cs;function sn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function As(){const e=sn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function qs(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=As();return r==="0"?"client":r==="1"||sn("embed")==="1"&&sn("chrome")==="1"?"apercu":"client"}const Ts={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ls=e=>Ts[e];function Ea(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Et=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Xr(a)||Ea(a))&&(e.noCo=!0)}return Object.assign(e,{continent:mi(e.cc)})};function Va(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Rs=60*60*1e3;function Fs(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Rs?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ms=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Os(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:ai(),[e,n]),i=p.useMemo(()=>n?"visiteur":qs(e,o),[e,o,n]),s=p.useMemo(()=>Ls(i),[i]),l=i!=="visiteur",c=Ms(r),[h,d]=p.useState([]),[x,u]=p.useState(""),[b,m]=p.useState(null),[v,k]=p.useState(null),[f,y]=p.useState(null),[j,w]=p.useState(()=>new Map),[N,C]=p.useState(()=>new Map),[S,T]=p.useState(""),[A,R]=p.useState(new Set),[M,$]=p.useState(null),[L,F]=p.useState(!0),[g,q]=p.useState(!1),[P,J]=p.useState(0),[I,O]=p.useState(0),B=p.useRef(0),W=p.useMemo(()=>{var X;if(i!=="client")return"";try{return((X=ni())==null?void 0:X.email)||""}catch{return""}},[i]);p.useEffect(()=>{const X=++B.current;let ge=!0;const Y=()=>ge&&X===B.current,ce=(l&&o.token?o.token:"pub:"+a)+(c?":"+c:""),le=Fs(ce);return le?(d(le.objs.map(Et)),le.fund&&u(le.fund),m(le.marketEstimate??null),k(le.criteria??null),y(le.stats??null),T(le.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const be=await _a(),me=((be==null?void 0:be.recent_ops)||[]).map(de=>{const pe=va(de.company_name||de.title?de:{...de,title:(de.headline_fr||de.headline||"").slice(0,120)},a),xe=String(de.rubrique||"").toLowerCase();return pe&&(xe==="nominations"||xe==="recrutements")&&(pe.engine=xe),pe&&!String(de.company_name||"").trim()&&(pe.noCo=!0),pe}).filter(de=>!!de).map(de=>(Xr((de.name||"").trim())||(de.noCo=!0),de));try{const de=ri(),pe=await oi(),xe=((pe==null?void 0:pe.date)||"").slice(0,10),G=de?de.doc:pe,re=ii(G),fe=((de==null?void 0:de.day)||(G==null?void 0:G.date)||xe||"").slice(0,10);if(fe&&re.length){const ke=new Set;for(const ne of me){if((ne.date||"").slice(0,10)!==fe)continue;const ve=_n(re,ke,ne.name,"");ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}for(const ne of me){if(ne.decryptHtml||(ne.date||"").slice(0,10)!==fe)continue;const ve=_n(re,ke,"",ne.headline||ne.tagline||ne.name);ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}}if(fe){const ke=((G==null?void 0:G.title_fr)||"").trim(),ne=((G==null?void 0:G.lead_fr)||"").trim(),ve=si(G),oe=((G==null?void 0:G.url)||"").trim();ke&&(ve||oe)&&me.unshift({id:`edito:${fe}`,kind:"op",name:ke,cc:null,date:fe,engine:"edito",dealKind:"other",headline:ke,tagline:ne||ke,decryptHtml:ve||void 0,url:oe,noCo:!0})}}catch{}if(!Y())return;d(me.map(Et)),ca(ce,{objs:me})}else if(typeof r=="object"){const me=(await $n()||[]).filter(pe=>(pe.slug||"")===r.research).map(pe=>Un(pe,a)).filter(pe=>!!pe),de=Va(await Hn(me,a));if(!Y())return;d(de.map(Et)),ca(ce,{objs:de})}else if(l&&o.token){const be=li(o.token),me=_a(),de=di(o.token),pe=ci(o.token),xe=pi(o.token),G=await be;let re=G?G.targets:[];Y()&&G&&(u(G.fund||""),m(G.marketEstimate??null),k(G.criteria??null),y(G.stats??null),T(G.generatedAt||""),d(re.map(Et)),F(!1),q(!1));const[fe,ke,ne,ve]=await Promise.all([me,de,pe,xe]),oe=((fe==null?void 0:fe.recent_ops)||[]).map(he=>va(he,a)).filter(he=>!!he),Ee=new Set(re.map(he=>he.id));if(re=[...re,...oe.filter(he=>!Ee.has(he.id)&&(Ee.add(he.id),!0))],!Y())return;d(re.map(Et));const Ke=new Set;for(const he of ke){const Se=(he.id||he.co||"").toString().trim().toLowerCase();Se&&Ke.add(Se.startsWith("t:")?Se:"t:"+Se)}R(Ke),w(ne),C(ve),G&&ca(ce,{fund:G.fund,marketEstimate:G.marketEstimate,criteria:G.criteria,stats:G.stats,generatedAt:G.generatedAt,objs:re})}else{const be=ui(),me=$n(),de=_a(),pe=await be;Y()&&pe.length&&(d(Va(pe).map(Et)),F(!1),q(!1));const[xe,G]=await Promise.all([me,de]),re=(xe||[]).map(ve=>Un(ve,a)).filter(ve=>!!ve),fe=await Hn(re,a),ke=((G==null?void 0:G.recent_ops)||[]).map(ve=>va(ve,a)).filter(ve=>!!ve),ne=Va([...pe,...fe,...ke]);if(!Y())return;d(ne.map(Et)),ca(ce,{objs:ne})}Y()&&q(!1)}catch{Y()&&!le&&q(!0)}finally{Y()&&F(!1)}})(),()=>{ge=!1}},[l,o.token,a,P,c]),p.useEffect(()=>{if(!s.showCredits||!W){$(null);return}let X=!0;return(async()=>{try{const ge=await fetch(`${Da}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:W})});if(!ge.ok)return;const Y=await ge.json();X&&Y&&Y.ok!==!1&&$(Y)}catch{}})(),()=>{X=!1}},[s.showCredits,W,I]);const K=p.useCallback(X=>R(new Set(X)),[]);return{session:o,mode:i,caps:s,fund:x,email:W,marketEstimate:b,generatedAt:S,criteria:v,stats:f,thumbs:j,stages:N,dossiers:h,favIds:A,setFavIds:K,credits:M,reloadCredits:()=>O(X=>X+1),loading:L,error:g,refresh:()=>J(X=>X+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ya=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Sa(e){return ya.has(e.engine||"")}function Ve(e){return!!e.noCo||Sa(e)&&!!e.url}const so=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ds=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...so(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Is=new Set(["signal","amount","score","crible","memo"]);function Ps(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:so(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Is.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??lo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const lo=80;function Ca(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Nn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ht(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ct(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ea(e,a,r){return We(e)?Ca(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ca(e,a.filters,r)}function Bs(e,a,r,n){return!(!ea(e,a,r)||r&&!fi(e,a.ptab,n))}function zn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-ht(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return xi(o);case"memo":return hi(o);case"signal":{const i=Me(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const s=n(o),l=n(i);return s<l?-a.dir:s>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Wa={},or=(Wa==null?void 0:Wa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function ir(){return new Date().toISOString().slice(0,10)}const An=p.createContext(null);function co(){return p.useContext(An)}function _s(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),s=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),l.querySelectorAll("*").forEach(c=>{const h=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),h&&/^https?:\/\//i.test(h)&&(c.setAttribute("href",h),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function $s(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),s=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(s);!l&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function sr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),s=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),s&&n.setAttribute("class",s),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function lr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${i} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${i} ${r[1]}`}function po(){const e=p.useContext(An);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Us({token:e,children:a}){const{dispatch:r,st:n,lang:o}=V(),[i,s]=p.useState(()=>n.filters.day||ir()),[l,c]=p.useState(null),[h,d]=p.useState(!1),x=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){s(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{s(ir());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=k=>{var y;const f=(y=k.detail)==null?void 0:y.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[x]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&s(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;d(!0);const k=new URLSearchParams({token:e,date:i});return fetch(`${or}/cibles/edition.json?${k}`).then(f=>f.json()).then(f=>{v||c(f)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||d(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${or}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:l,loading:h,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,h,x,u,n.filters.day,b,o]);return t.jsx(An.Provider,{value:m,children:a})}function Hs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=po(),[o,i]=p.useState(()=>n||Zr());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const s=l=>{var c;return i(!!((c=l.detail)!=null&&c.open))};return window.addEventListener(ja,s),()=>window.removeEventListener(ja,s)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(gi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Vs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function dr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function cr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Ws(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=po(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,c=a&&!a.ok,h=p.useRef(null),[d,x]=p.useState("fonds"),[u,b]=p.useState(null),[m,v]=p.useState("idle"),k=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),k.current=!1,x("fonds")},[e]),p.useEffect(()=>{if(d!=="jour"||k.current)return;k.current=!0;let N=!0;return v("load"),Vs(e).then(C=>{N&&(b(C),v("fait"))}),()=>{N=!1}},[d,e]);const f=p.useMemo(()=>$s((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=p.useRef(null);p.useEffect(()=>{const N=y.current;if(!N||!f)return;let C=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(C||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{C=!0}},[f]);const j=p.useMemo(()=>sr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),w=p.useMemo(()=>sr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const N=h.current;if(!N||!j)return;let C=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(C||!N.isConnected)&&(S.beautifyEditoRows(N),S.mountCardFits(N))}),()=>{C=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?dr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:lr(e,!0)}),"."]}):dr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:lr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&s&&j?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,d==="fonds"&&s&&w?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:w}}):null,d==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:cr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:cr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Gs=300,pa=7,Ys={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},uo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Qs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(wi(r)&&r!=="media")return"news:"+r;const n=Me(e);return n?"sig:"+(n.theme&&uo.fr[n.theme]?n.theme:"other"):"actualites"}function Ks(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:s,fund:l}=V(),c=co(),h=s==="en",[d,x]=p.useState("all"),[u,b]=p.useState(!1),m=p.useMemo(()=>{var ge;const g=(a.filters.day||"").slice(0,10),q=Y=>!(!i&&a.continent!=="monde"&&Y.continent!==a.continent||g&&(Y.date||"").slice(0,10)!==g),P=e.filter(Y=>q(Y)&&Me(Y)&&(!i||Y.kind!=="target"||ze(Y)!==5)),J=i&&(((ge=c==null?void 0:c.ed)==null?void 0:ge.ops)||[]).length?c.ed.ops.map(Y=>va(Y,s)).filter(Y=>!!Y).map(Y=>(Y.briefOnly=!0,Y)).filter(Y=>!g||(Y.date||"").slice(0,10)===g):[],I=e.filter(Y=>q(Y)&&Y.kind==="op"&&(g?!0:ht(Y.date)<=pa)),O=i?J.length?J:I.filter(Y=>{const ce=(l||"").trim().toLowerCase();if(!ce)return!1;const le=Y.match||null;return le?Object.keys(le).map(be=>be.trim().toLowerCase()).includes(ce):!1}):I,B=g||new Date().toISOString().slice(0,10),W=Y=>{const ce=Ga(Y);return ce==="ma"?0:ce==="levees"?1:2};O.sort((Y,ce)=>{const le=W(Y)-W(ce);if(le)return le;const be=(Y.date||"").slice(0,10)===B?0:1,me=(ce.date||"").slice(0,10)===B?0:1;return be!==me?be-me:(ce.amountEur||0)-(Y.amountEur||0)});const K=new Set,X=[];for(const Y of[...O,...zn(P,{key:"signal",dir:-1})]){const ce=Y.id||Y.name;!ce||K.has(ce)||(K.add(ce),X.push(Y))}return i&&X.length===0?e.filter(ce=>q(ce)&&ht(ce.date)<=pa).sort((ce,le)=>(le.date||"").localeCompare(ce.date||"")).slice(0,80):X},[e,a.continent,a.filters.day,i,l,s,c]),v=p.useMemo(()=>{const g={};for(const q of m){const P=Ga(q);g[P]=(g[P]||0)+1}return g},[m]),k=p.useMemo(()=>d==="all"?m:m.filter(g=>Ga(g)===d),[m,d]),f=p.useMemo(()=>k.slice(0,Gs),[k]),y=k.length-f.length,j=p.useRef(null);p.useEffect(()=>{var O,B;const g=j.current;if(!g)return;const q=()=>{const W=g.scrollWidth;W<200||(g.style.animationDuration=Math.max(18,Math.round(W/130))+"s")};q();const P=requestAnimationFrame(q),J=window.setTimeout(q,1200);let I=!0;return(B=(O=document.fonts)==null?void 0:O.ready)==null||B.then(()=>{I&&q()}),()=>{I=!1,cancelAnimationFrame(P),window.clearTimeout(J)}},[f.length,d]);const w=g=>g==="all"?m.length:v[g]||0,N=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return uo[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const q=g.slice(5);return vi[q]?yi(q,h?"en":"fr"):g}return Ys[h?"en":"fr"][g]},C=[{k:"all"}],S=["ma","levees"].filter(g=>w(g)>0||g===d);if(S.length){C.push({g:h?"Deals":"Opérations"});for(const g of S)C.push({k:g})}const T=["nominations","recrutements"].filter(g=>w(g)>0||g===d),A=bi.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>w(g)>0||g===d),R=w("actualites")>0||d==="actualites"?["actualites"]:[];if(T.length||A.length||R.length){C.push({g:h?"News":"Actualités"});for(const g of T)C.push({k:g});for(const g of A)C.push({k:g});for(const g of R)C.push({k:g})}const M=Qs.map(g=>"sig:"+g).filter(g=>w(g)>0||g===d);if(M.length){C.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of M)C.push({k:g})}const $=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},L=(()=>{const g=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(h?`LIVE covers the events of ${$(g)}.`:`Le LIVE regroupe les événements du ${$(g)}.`)+q:(h?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+q})(),F=g=>f.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ie(q)?" spent":""),onClick:P=>{const J=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:J?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(J||n({type:"focus",id:q.id}),a.dens!=="liste"){const I=P.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:I.left+I.width/2,y:I.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(yt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(Yo,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Tc(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Ia,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(q.id||q.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(g=>!g),children:[N(d),t.jsx("b",{children:w(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:L}),C.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===d,onClick:()=>{x(g.k),b(!1)},children:[N(g.k),t.jsx("b",{children:w(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(Xs,{isEn:h})]})}const Js=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Xs({isEn:e}){const[a,r]=p.useState(()=>Zr());p.useEffect(()=>{const o=i=>{var s;return r(!!((s=i.detail)!=null&&s.open))};return window.addEventListener(ja,o),()=>window.removeEventListener(ja,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ki(!a),children:Js})}const qn="+33 6 83 10 72 86",za="alexandre@proplace.co",mo=`tel:${qn.replace(/[^\d+]/g,"")}`;function Zs(){return null}class rt extends p.Component{constructor(){super(...arguments);Pn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const fo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function pr(e,a){if((wt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return fo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const ur=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",el={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function tl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:s}=V(),[l,c]=p.useState(""),[h,d]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!x)return;const y=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),d(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),v=async y=>{if(l)return;if(y==="Analysé"&&!e.memoUrl){d(!0);return}c(y);const j=(pr(e,a).find(([N])=>N===y)||[y,y])[1],w=await o(e,y,{msg:a.csMoved(e.name,j)});c(""),w&&(d(!1),u(!1))},k=pr(e,a),f=y=>(k.find(([j])=>j===y)||[])[1]||y;return k.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:k.map(([y,j])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(l===y?" busy":""),disabled:!!l,onClick:()=>{v(y)},children:j},y))}):t.jsxs("span",{className:"rstat"+(x||h?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+ur(m),onClick:()=>{u(y=>!y),d(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),x&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:k.map(([y,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===y,className:"rsopt"+(m===y?" on":"")+(l===y?" busy":""),disabled:!!l,onClick:()=>{if(y===m){u(!1);return}v(y)},children:[t.jsx("i",{className:"pt2",style:{background:el[ur(y)]}}),j]},y))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{i(e),d(!1),u(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const y=await o(e,"Analysé");c(""),y&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function al({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=V(),[i,s]=p.useState(""),[l,c]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),d=(wt(e)||"").startsWith("CALL")&&ze(e)===3,x=ze(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(m);const v=await o(e,m);s(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:fo.filter(([m])=>!(x&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(h===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:v},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(nl,{o:e})]})}function nl({o:e}){const{t:a,saveNote:r,flash:n}=V(),[o,i]=p.useState(e.ceoNote||""),[s,l]=p.useState(!1),[c,h]=p.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(s||!d)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:s||!d,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function rl({placeholder:e,onDone:a}){const{t:r}=V(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ol({o:e}){var k;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:s,flashErr:l}=V(),[c,h]=p.useState(!1);if(!n.pipe||!o||n.lockActions||ze(e)!==4)return null;const d=i(e),x=(d==null?void 0:d.stage)||"todo",u=async f=>{if(c||f===x)return;h(!0);const y=d;s(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const j=Math.max(Date.now(),mr+=1);mr=j;const w=await ji(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});h(!1),!w.stale&&(w.ok||(s(e,y),l(a.actErr)))},b=(k=d==null?void 0:d.stamps)==null?void 0:k.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:c,onClick:()=>{u(f)},children:y},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let mr=0;const Wt=8,vt=360;function fr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function hr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(fr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(fr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function il({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=V(),[s,l]=p.useState(0),[c,h]=p.useState(null),[d,x]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const S=b.current;return()=>{m.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,x(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const v=d[s],k=s>=d.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const S=v.click,T=window.setTimeout(()=>{const A=document.querySelector(S);A&&A.getAttribute("aria-selected")!=="true"&&A.click()},60);return()=>window.clearTimeout(T)}},[s,v]);const f=p.useRef(-1),y=p.useCallback(()=>{if(!v){h(null);return}const S=R=>{if(!R)return null;for(const M of document.querySelectorAll(R)){const $=M.getBoundingClientRect();if($.width>1&&$.height>1)return M}return null},T=S(v.sel)||S(v.need);if(!T){h(null);return}f.current!==s&&(f.current=s,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const A=T.getBoundingClientRect();h(R=>R&&Math.abs(R.top-A.top)<1&&Math.abs(R.left-A.left)<1&&Math.abs(R.width-A.width)<1&&Math.abs(R.height-A.height)<1?R:A)},[v,s]);p.useLayoutEffect(()=>{y();const S=[90,300,700,1300].map(R=>window.setTimeout(y,R)),T=window.setInterval(y,400),A=()=>y();return window.addEventListener("scroll",A,!0),window.addEventListener("resize",A),()=>{S.forEach(R=>window.clearTimeout(R)),window.clearInterval(T),window.removeEventListener("scroll",A,!0),window.removeEventListener("resize",A)}},[y]);const j=p.useRef(a);if(j.current=a,p.useEffect(()=>{const S=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),j.current()):T.key==="ArrowRight"?l(A=>A+1):T.key==="ArrowLeft"&&l(A=>Math.max(0,A-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!d.length)return null;let w=null;const N=S=>()=>{m.current=!0,n({type:"modal",modal:null}),S()};if(k){const S=o[3]||0;S>0?w={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?w={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?w={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let C={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:vt};if(!k&&c){const S=c.bottom+14,T=window.innerHeight-S;let A=T>190?S:Math.max(12,c.top-200),R=Math.min(Math.max(12,c.left+c.width/2-vt/2),window.innerWidth-vt-12);T<=190&&c.top<212&&(window.innerWidth-c.right>=vt+40?R=Math.min(c.right+26,window.innerWidth-vt-12):c.left>=vt+40&&(R=Math.max(12,c.left-vt-26)),A=Math.max(12,c.top-Wt)),C={left:R,top:A,width:vt}}return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!k&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Wt,top:c.top-Wt,width:c.width+Wt*2,height:c.height+Wt*2}}),(k||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(k?" fin":""),style:C,children:[k&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(hr,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(hr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(S=>S+1),children:s===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function ho(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function xo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function sl(){var T,A;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:s,data:l,dispatch:c}=V(),h=r?a:e,d=p.useMemo(()=>h.filter(R=>ht(R.date)===0&&R.kind==="target"),[h]),x=p.useMemo(()=>r?a.filter(R=>R.kind==="target"&&ze(R)===0).slice().sort((R,M)=>(M.date||"").localeCompare(R.date||"")):[],[a,r]),u=p.useMemo(()=>d.filter(R=>r?ze(R)===0:!Ie(R)),[d,r]),b=r?x:u,m=r?a.length-x.length:d.length-u.length,v=r?a.length:d.length,k=v?Math.min(100,m/v*100):100,f=p.useMemo(()=>ho(h),[h]),y=!!f&&ht(f)>0,j=p.useMemo(()=>y?h.filter(R=>(R.date||"").slice(0,10)===f):[],[h,f,y]),w=typeof((T=l.stats)==null?void 0:T.kept_today)=="number"?l.stats.kept_today:null,N=typeof((A=l.stats)==null?void 0:A.screened_today)=="number"?l.stats.screened_today:d.length;let C;y?C=o.morningLast(j.length,x.length,xo(f,s)):r?C=o.morningThesis(N,x.length,w):d.length?m===0?C=o.goalSourced(d.length):m>=d.length?C=o.goalCleared:C=o.goalDone(m,d.length):C=o.goalSourced(0);const S=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(R=>R.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:C}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:k+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ll(){var P,J;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:s,dossiers:l,mode:c,doSync:h,startTour:d,flash:x,flashErr:u}=V(),[b,m]=p.useState(null),[v,k]=p.useState(!0),[f,y]=p.useState([]),j=c==="client";p.useEffect(()=>{if(!o||!i)return;let I=!0;return k(!0),(async()=>{const[O,B]=await Promise.all([En(i),eo(o)]);I&&(O&&m(O),k(!1),y(B))})(),()=>{I=!1}},[o,i]);const[w,N]=p.useState(!1),C=()=>{!j||w||!i||(N(!0),Ni(i).then(I=>{N(!1),I?x(e.identRepubDone):u(e.actErr)}))},S=(b==null?void 0:b.per_day)??null,T=((P=b==null?void 0:b.pool_order)==null?void 0:P.length)??0,A=f.filter(I=>I.status==="running").length,R=p.useMemo(()=>l.filter(I=>I.kind==="target"&&Ie(I)).length,[l]),M=s.marketEstimate,$=typeof((J=s.stats)==null?void 0:J.screened)=="number"?s.stats.screened:R,L=M&&M>0?Math.min(100,Math.round($/M*100)):null,F=I=>I.toLocaleString(a==="en"?"en-US":"fr-FR"),g=(i||"P").split(/\s+/).map(I=>I[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const I=Date.parse(s.generatedAt||"");if(Number.isNaN(I))return"";const O=new Date(I),B=W=>String(W).padStart(2,"0");return`${B(O.getDate())}/${B(O.getMonth()+1)} à ${B(O.getHours())}:${B(O.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?g:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:F($)})})]}),L!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),S!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:S})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),S===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),A>0&&t.jsxs("span",{className:"ev",children:["⏳ ",A]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(T)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:I=>{I.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||w,onClick:C,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:h,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:I=>n({type:"filters",patch:{search:I.target.value}})})]})]})]})}class qt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],s=a+i,l=Math.abs(a)<Math.abs(i)?a-(s-i):i-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,o=a[--r],s=n+o,i=o-(s-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=s+o,o==n-s&&(s=n))}return s}}function*dl(e){for(const a of e)yield*a}function go(e){return Array.from(dl(e))}var we=1e-6,ue=Math.PI,et=ue/2,xr=ue/4,at=ue*2,mt=180/ue,Ye=ue/180,Ce=Math.abs,cl=Math.atan,ta=Math.atan2,Te=Math.cos,Le=Math.sin,pl=Math.sign||function(e){return e>0?1:e<0?-1:0},Lt=Math.sqrt;function ul(e){return e>1?0:e<-1?ue:Math.acos(e)}function aa(e){return e>1?et:e<-1?-et:Math.asin(e)}function tt(){}function Aa(e,a){e&&br.hasOwnProperty(e.type)&&br[e.type](e,a)}var gr={Feature:function(e,a){Aa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Aa(r[n].geometry,a)}},br={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ln(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ln(r[n],a,0)},Polygon:function(e,a){vr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)vr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Aa(r[n],a)}};function ln(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function vr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ln(e[r],a,1);a.polygonEnd()}function Mt(e,a){e&&gr.hasOwnProperty(e.type)?gr[e.type](e,a):Aa(e,a)}function dn(e){return[ta(e[1],e[0]),aa(e[2])]}function It(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*Le(a),Le(r)]}function ua(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ya(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ma(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function cn(e){var a=Lt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function pn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function un(e,a){return Ce(e)>ue&&(e-=Math.round(e/at)*at),[e,a]}un.invert=un;function ml(e,a,r){return(e%=at)?a||r?pn(wr(e),kr(a,r)):wr(e):a||r?kr(a,r):un}function yr(e){return function(a,r){return a+=e,Ce(a)>ue&&(a-=Math.round(a/at)*at),[a,r]}}function wr(e){var a=yr(e);return a.invert=yr(-e),a}function kr(e,a){var r=Te(e),n=Le(e),o=Te(a),i=Le(a);function s(l,c){var h=Te(c),d=Te(l)*h,x=Le(l)*h,u=Le(c),b=u*r+d*n;return[ta(x*o-b*i,d*r-u*n),aa(b*o+x*i)]}return s.invert=function(l,c){var h=Te(c),d=Te(l)*h,x=Le(l)*h,u=Le(c),b=u*o-x*i;return[ta(x*o+u*i,d*r+b*n),aa(b*r-d*n)]},s}function fl(e,a,r,n,o,i){if(r){var s=Te(a),l=Le(a),c=n*r;o==null?(o=a+n*at,i=a-c/2):(o=jr(s,o),i=jr(s,i),(n>0?o<i:o>i)&&(o+=n*at));for(var h,d=o;n>0?d>i:d<i;d-=c)h=dn([s,-l*Te(d),-l*Le(d)]),e.point(h[0],h[1])}}function jr(e,a){a=It(a),a[0]-=e,cn(a);var r=ul(-a[1]);return((-a[2]<0?-r:r)+at-we)%at}function bo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:tt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function wa(e,a){return Ce(e[0]-a[0])<we&&Ce(e[1]-a[1])<we}function fa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function vo(e,a,r,n,o){var i=[],s=[],l,c;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,k=m[0],f=m[v],y;if(wa(k,f)){if(!k[2]&&!f[2]){for(o.lineStart(),l=0;l<v;++l)o.point((k=m[l])[0],k[1]);o.lineEnd();return}f[0]+=2*we}i.push(y=new fa(k,m,null,!0)),s.push(y.o=new fa(k,null,y,!1)),i.push(y=new fa(f,m,null,!1)),s.push(y.o=new fa(f,null,y,!0))}}),!!i.length){for(s.sort(a),Nr(i),Nr(s),l=0,c=s.length;l<c;++l)s[l].e=r=!r;for(var h=i[0],d,x;;){for(var u=h,b=!0;u.v;)if((u=u.n)===h)return;d=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,c=d.length;l<c;++l)o.point((x=d[l])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(d=u.p.z,l=d.length-1;l>=0;--l)o.point((x=d[l])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Nr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Qa(e){return Ce(e[0])<=ue?e[0]:pl(e[0])*((Ce(e[0])+ue)%at-ue)}function hl(e,a){var r=Qa(a),n=a[1],o=Le(n),i=[Le(r),-Te(r),0],s=0,l=0,c=new qt;o===1?n=et+we:o===-1&&(n=-et-we);for(var h=0,d=e.length;h<d;++h)if(u=(x=e[h]).length)for(var x,u,b=x[u-1],m=Qa(b),v=b[1]/2+xr,k=Le(v),f=Te(v),y=0;y<u;++y,m=w,k=C,f=S,b=j){var j=x[y],w=Qa(j),N=j[1]/2+xr,C=Le(N),S=Te(N),T=w-m,A=T>=0?1:-1,R=A*T,M=R>ue,$=k*C;if(c.add(ta($*A*Le(R),f*S+$*Te(R))),s+=M?T+A*at:T,M^m>=r^w>=r){var L=qa(It(b),It(j));cn(L);var F=qa(i,L);cn(F);var g=(M^T>=0?-1:1)*aa(F[2]);(n>g||n===g&&(L[0]||L[1]))&&(l+=M^T>=0?1:-1)}}return(s<-we||s<we&&c<-1e-12)^l&1}function yo(e,a,r,n){return function(o){var i=a(o),s=bo(),l=a(s),c=!1,h,d,x,u={point:b,lineStart:v,lineEnd:k,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=j,d=[],h=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=k,d=go(d);var w=hl(h,n);d.length?(c||(o.polygonStart(),c=!0),vo(d,gl,w,r,o)):w&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),d=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(w,N){e(w,N)&&o.point(w,N)}function m(w,N){i.point(w,N)}function v(){u.point=m,i.lineStart()}function k(){u.point=b,i.lineEnd()}function f(w,N){x.push([w,N]),l.point(w,N)}function y(){l.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),l.lineEnd();var w=l.clean(),N=s.result(),C,S=N.length,T,A,R;if(x.pop(),h.push(x),x=null,!!S){if(w&1){if(A=N[0],(T=A.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),C=0;C<T;++C)o.point((R=A[C])[0],R[1]);o.lineEnd()}return}S>1&&w&2&&N.push(N.pop().concat(N.shift())),d.push(N.filter(xl))}}return u}}function xl(e){return e.length>1}function gl(e,a){return((e=e.x)[0]<0?e[1]-et-we:et-e[1])-((a=a.x)[0]<0?a[1]-et-we:et-a[1])}const Er=yo(function(){return!0},bl,yl,[-ue,-et]);function bl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,s){var l=i>0?ue:-ue,c=Ce(i-a);Ce(c-ue)<we?(e.point(a,r=(r+s)/2>0?et:-et),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&c>=ue&&(Ce(a-n)<we&&(a-=n*we),Ce(i-l)<we&&(i-=l*we),r=vl(a,r,i,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function vl(e,a,r,n){var o,i,s=Le(e-r);return Ce(s)>we?cl((Le(a)*(i=Te(n))*Le(r)-Le(n)*(o=Te(a))*Le(e))/(o*i*s)):(a+n)/2}function yl(e,a,r,n){var o;if(e==null)o=r*et,n.point(-ue,o),n.point(0,o),n.point(ue,o),n.point(ue,0),n.point(ue,-o),n.point(0,-o),n.point(-ue,-o),n.point(-ue,0),n.point(-ue,o);else if(Ce(e[0]-a[0])>we){var i=e[0]<a[0]?ue:-ue;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function wl(e){var a=Te(e),r=2*Ye,n=a>0,o=Ce(a)>we;function i(d,x,u,b){fl(b,e,r,u,d,x)}function s(d,x){return Te(d)*Te(x)>a}function l(d){var x,u,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(k,f){var y=[k,f],j,w=s(k,f),N=n?w?0:h(k,f):w?h(k+(k<0?ue:-ue),f):0;if(!x&&(m=b=w)&&d.lineStart(),w!==b&&(j=c(x,y),(!j||wa(x,j)||wa(y,j))&&(y[2]=1)),w!==b)v=0,w?(d.lineStart(),j=c(y,x),d.point(j[0],j[1])):(j=c(x,y),d.point(j[0],j[1],2),d.lineEnd()),x=j;else if(o&&x&&n^w){var C;!(N&u)&&(C=c(y,x,!0))&&(v=0,n?(d.lineStart(),d.point(C[0][0],C[0][1]),d.point(C[1][0],C[1][1]),d.lineEnd()):(d.point(C[1][0],C[1][1]),d.lineEnd(),d.lineStart(),d.point(C[0][0],C[0][1],3)))}w&&(!x||!wa(x,y))&&d.point(y[0],y[1]),x=y,b=w,u=N},lineEnd:function(){b&&d.lineEnd(),x=null},clean:function(){return v|(m&&b)<<1}}}function c(d,x,u){var b=It(d),m=It(x),v=[1,0,0],k=qa(b,m),f=ua(k,k),y=k[0],j=f-y*y;if(!j)return!u&&d;var w=a*f/j,N=-a*y/j,C=qa(v,k),S=ma(v,w),T=ma(k,N);Ya(S,T);var A=C,R=ua(S,A),M=ua(A,A),$=R*R-M*(ua(S,S)-1);if(!($<0)){var L=Lt($),F=ma(A,(-R-L)/M);if(Ya(F,S),F=dn(F),!u)return F;var g=d[0],q=x[0],P=d[1],J=x[1],I;q<g&&(I=g,g=q,q=I);var O=q-g,B=Ce(O-ue)<we,W=B||O<we;if(!B&&J<P&&(I=P,P=J,J=I),W?B?P+J>0^F[1]<(Ce(F[0]-g)<we?P:J):P<=F[1]&&F[1]<=J:O>ue^(g<=F[0]&&F[0]<=q)){var K=ma(A,(-R+L)/M);return Ya(K,S),[F,dn(K)]}}}function h(d,x){var u=n?e:ue-e,b=0;return d<-u?b|=1:d>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return yo(s,l,i,n?[0,-e]:[-ue,e-ue])}function kl(e,a,r,n,o,i){var s=e[0],l=e[1],c=a[0],h=a[1],d=0,x=1,u=c-s,b=h-l,m;if(m=r-s,!(!u&&m>0)){if(m/=u,u<0){if(m<d)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>d&&(d=m)}if(m=o-s,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>d&&(d=m)}else if(u>0){if(m<d)return;m<x&&(x=m)}if(m=n-l,!(!b&&m>0)){if(m/=b,b<0){if(m<d)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>d&&(d=m)}if(m=i-l,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>d&&(d=m)}else if(b>0){if(m<d)return;m<x&&(x=m)}return d>0&&(e[0]=s+d*u,e[1]=l+d*b),x<1&&(a[0]=s+x*u,a[1]=l+x*b),!0}}}}}var Gt=1e9,ha=-Gt;function jl(e,a,r,n){function o(h,d){return e<=h&&h<=r&&a<=d&&d<=n}function i(h,d,x,u){var b=0,m=0;if(h==null||(b=s(h,x))!==(m=s(d,x))||c(h,d)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(d[0],d[1])}function s(h,d){return Ce(h[0]-e)<we?d>0?0:3:Ce(h[0]-r)<we?d>0?2:1:Ce(h[1]-a)<we?d>0?1:0:d>0?3:2}function l(h,d){return c(h.x,d.x)}function c(h,d){var x=s(h,1),u=s(d,1);return x!==u?x-u:x===0?d[1]-h[1]:x===1?h[0]-d[0]:x===2?h[1]-d[1]:d[0]-h[0]}return function(h){var d=h,x=bo(),u,b,m,v,k,f,y,j,w,N,C,S={point:T,lineStart:$,lineEnd:L,polygonStart:R,polygonEnd:M};function T(g,q){o(g,q)&&d.point(g,q)}function A(){for(var g=0,q=0,P=b.length;q<P;++q)for(var J=b[q],I=1,O=J.length,B=J[0],W,K,X=B[0],ge=B[1];I<O;++I)W=X,K=ge,B=J[I],X=B[0],ge=B[1],K<=n?ge>n&&(X-W)*(n-K)>(ge-K)*(e-W)&&++g:ge<=n&&(X-W)*(n-K)<(ge-K)*(e-W)&&--g;return g}function R(){d=x,u=[],b=[],C=!0}function M(){var g=A(),q=C&&g,P=(u=go(u)).length;(q||P)&&(h.polygonStart(),q&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),P&&vo(u,l,g,i,h),h.polygonEnd()),d=h,u=b=m=null}function $(){S.point=F,b&&b.push(m=[]),N=!0,w=!1,y=j=NaN}function L(){u&&(F(v,k),f&&w&&x.rejoin(),u.push(x.result())),S.point=T,w&&d.lineEnd()}function F(g,q){var P=o(g,q);if(b&&m.push([g,q]),N)v=g,k=q,f=P,N=!1,P&&(d.lineStart(),d.point(g,q));else if(P&&w)d.point(g,q);else{var J=[y=Math.max(ha,Math.min(Gt,y)),j=Math.max(ha,Math.min(Gt,j))],I=[g=Math.max(ha,Math.min(Gt,g)),q=Math.max(ha,Math.min(Gt,q))];kl(J,I,e,a,r,n)?(w||(d.lineStart(),d.point(J[0],J[1])),d.point(I[0],I[1]),P||d.lineEnd(),C=!1):P&&(d.lineStart(),d.point(g,q),C=!1)}y=g,j=q,w=P}return S}}const mn=e=>e;var Ka=new qt,fn=new qt,wo,ko,hn,xn,ft={point:tt,lineStart:tt,lineEnd:tt,polygonStart:function(){ft.lineStart=Nl,ft.lineEnd=Sl},polygonEnd:function(){ft.lineStart=ft.lineEnd=ft.point=tt,Ka.add(Ce(fn)),fn=new qt},result:function(){var e=Ka/2;return Ka=new qt,e}};function Nl(){ft.point=El}function El(e,a){ft.point=jo,wo=hn=e,ko=xn=a}function jo(e,a){fn.add(xn*e-hn*a),hn=e,xn=a}function Sl(){jo(wo,ko)}var Pt=1/0,Ta=Pt,na=-Pt,La=na,Ra={point:Cl,lineStart:tt,lineEnd:tt,polygonStart:tt,polygonEnd:tt,result:function(){var e=[[Pt,Ta],[na,La]];return na=La=-(Ta=Pt=1/0),e}};function Cl(e,a){e<Pt&&(Pt=e),e>na&&(na=e),a<Ta&&(Ta=a),a>La&&(La=a)}var gn=0,bn=0,Yt=0,Fa=0,Ma=0,Ot=0,vn=0,yn=0,Qt=0,No,Eo,ct,pt,Ze={point:Tt,lineStart:Sr,lineEnd:Cr,polygonStart:function(){Ze.lineStart=ql,Ze.lineEnd=Tl},polygonEnd:function(){Ze.point=Tt,Ze.lineStart=Sr,Ze.lineEnd=Cr},result:function(){var e=Qt?[vn/Qt,yn/Qt]:Ot?[Fa/Ot,Ma/Ot]:Yt?[gn/Yt,bn/Yt]:[NaN,NaN];return gn=bn=Yt=Fa=Ma=Ot=vn=yn=Qt=0,e}};function Tt(e,a){gn+=e,bn+=a,++Yt}function Sr(){Ze.point=zl}function zl(e,a){Ze.point=Al,Tt(ct=e,pt=a)}function Al(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Ot+=o,Tt(ct=e,pt=a)}function Cr(){Ze.point=Tt}function ql(){Ze.point=Ll}function Tl(){So(No,Eo)}function Ll(e,a){Ze.point=So,Tt(No=ct=e,Eo=pt=a)}function So(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Ot+=o,o=pt*e-ct*a,vn+=o*(ct+e),yn+=o*(pt+a),Qt+=o*3,Tt(ct=e,pt=a)}function Co(e){this._context=e}Co.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,at);break}}},result:tt};var wn=new qt,Ja,zo,Ao,Kt,Jt,ra={point:tt,lineStart:function(){ra.point=Rl},lineEnd:function(){Ja&&qo(zo,Ao),ra.point=tt},polygonStart:function(){Ja=!0},polygonEnd:function(){Ja=null},result:function(){var e=+wn;return wn=new qt,e}};function Rl(e,a){ra.point=qo,zo=Kt=e,Ao=Jt=a}function qo(e,a){Kt-=e,Jt-=a,wn.add(Lt(Kt*Kt+Jt*Jt)),Kt=e,Jt=a}let zr,Oa,Ar,qr;class Tr{constructor(a){this._append=a==null?To:Fl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Ar||this._append!==Oa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Ar=n,Oa=this._append,qr=this._,this._=o}this._+=qr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function To(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Fl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return To;if(a!==zr){const r=10**a;zr=a,Oa=function(o){let i=1;this._+=o[0];for(const s=o.length;i<s;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Oa}function Ml(e,a){let r=3,n=4.5,o,i;function s(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Mt(l,o(i))),i.result()}return s.area=function(l){return Mt(l,o(ft)),ft.result()},s.measure=function(l){return Mt(l,o(ra)),ra.result()},s.bounds=function(l){return Mt(l,o(Ra)),Ra.result()},s.centroid=function(l){return Mt(l,o(Ze)),Ze.result()},s.projection=function(l){return arguments.length?(o=l==null?(e=null,mn):(e=l).stream,s):e},s.context=function(l){return arguments.length?(i=l==null?(a=null,new Tr(r)):new Co(a=l),typeof n!="function"&&i.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const c=Math.floor(l);if(!(c>=0))throw new RangeError(`invalid digits: ${l}`);r=c}return a===null&&(i=new Tr(r)),s},s.projection(e).digits(r).context(a)}function Tn(e){return function(a){var r=new kn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function kn(){}kn.prototype={constructor:kn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ln(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Mt(r,e.stream(Ra)),a(Ra.result()),n!=null&&e.clipExtent(n),e}function Lo(e,a,r){return Ln(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],s=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-s*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,c])},r)}function Ol(e,a,r){return Lo(e,[[0,0],a],r)}function Dl(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),s=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([s,l])},r)}function Il(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),s=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([s,l])},r)}var Lr=16,Pl=Te(30*Ye);function Rr(e,a){return+a?_l(e,a):Bl(e)}function Bl(e){return Tn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function _l(e,a){function r(n,o,i,s,l,c,h,d,x,u,b,m,v,k){var f=h-n,y=d-o,j=f*f+y*y;if(j>4*a&&v--){var w=s+u,N=l+b,C=c+m,S=Lt(w*w+N*N+C*C),T=aa(C/=S),A=Ce(Ce(C)-1)<we||Ce(i-x)<we?(i+x)/2:ta(N,w),R=e(A,T),M=R[0],$=R[1],L=M-n,F=$-o,g=y*L-f*F;(g*g/j>a||Ce((f*L+y*F)/j-.5)>.3||s*u+l*b+c*m<Pl)&&(r(n,o,i,s,l,c,M,$,A,w/=S,N/=S,C,v,k),k.point(M,$),r(M,$,A,w,N,C,h,d,x,u,b,m,v,k))}}return function(n){var o,i,s,l,c,h,d,x,u,b,m,v,k={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),k.lineStart=N},polygonEnd:function(){n.polygonEnd(),k.lineStart=y}};function f(T,A){T=e(T,A),n.point(T[0],T[1])}function y(){x=NaN,k.point=j,n.lineStart()}function j(T,A){var R=It([T,A]),M=e(T,A);r(x,u,d,b,m,v,x=M[0],u=M[1],d=T,b=R[0],m=R[1],v=R[2],Lr,n),n.point(x,u)}function w(){k.point=f,n.lineEnd()}function N(){y(),k.point=C,k.lineEnd=S}function C(T,A){j(o=T,A),i=x,s=u,l=b,c=m,h=v,k.point=j}function S(){r(x,u,d,b,m,v,i,s,o,l,c,h,Lr,n),k.lineEnd=w,w()}return k}}var $l=Tn({point:function(e,a){this.stream.point(e*Ye,a*Ye)}});function Ul(e){return Tn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Hl(e,a,r,n,o){function i(s,l){return s*=n,l*=o,[a+e*s,r-e*l]}return i.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*o]},i}function Fr(e,a,r,n,o,i){if(!i)return Hl(e,a,r,n,o);var s=Te(i),l=Le(i),c=s*e,h=l*e,d=s/e,x=l/e,u=(l*r-s*a)/e,b=(l*a+s*r)/e;function m(v,k){return v*=n,k*=o,[c*v-h*k+a,r-h*v-c*k]}return m.invert=function(v,k){return[n*(d*v-x*k+u),o*(b-x*v-d*k)]},m}function Vl(e){return Wl(function(){return e})()}function Wl(e){var a,r=150,n=480,o=250,i=0,s=0,l=0,c=0,h=0,d,x=0,u=1,b=1,m=null,v=Er,k=null,f,y,j,w=mn,N=.5,C,S,T,A,R;function M(g){return T(g[0]*Ye,g[1]*Ye)}function $(g){return g=T.invert(g[0],g[1]),g&&[g[0]*mt,g[1]*mt]}M.stream=function(g){return A&&R===g?A:A=$l(Ul(d)(v(C(w(R=g)))))},M.preclip=function(g){return arguments.length?(v=g,m=void 0,F()):v},M.postclip=function(g){return arguments.length?(w=g,k=f=y=j=null,F()):w},M.clipAngle=function(g){return arguments.length?(v=+g?wl(m=g*Ye):(m=null,Er),F()):m*mt},M.clipExtent=function(g){return arguments.length?(w=g==null?(k=f=y=j=null,mn):jl(k=+g[0][0],f=+g[0][1],y=+g[1][0],j=+g[1][1]),F()):k==null?null:[[k,f],[y,j]]},M.scale=function(g){return arguments.length?(r=+g,L()):r},M.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],L()):[n,o]},M.center=function(g){return arguments.length?(i=g[0]%360*Ye,s=g[1]%360*Ye,L()):[i*mt,s*mt]},M.rotate=function(g){return arguments.length?(l=g[0]%360*Ye,c=g[1]%360*Ye,h=g.length>2?g[2]%360*Ye:0,L()):[l*mt,c*mt,h*mt]},M.angle=function(g){return arguments.length?(x=g%360*Ye,L()):x*mt},M.reflectX=function(g){return arguments.length?(u=g?-1:1,L()):u<0},M.reflectY=function(g){return arguments.length?(b=g?-1:1,L()):b<0},M.precision=function(g){return arguments.length?(C=Rr(S,N=g*g),F()):Lt(N)},M.fitExtent=function(g,q){return Lo(M,g,q)},M.fitSize=function(g,q){return Ol(M,g,q)},M.fitWidth=function(g,q){return Dl(M,g,q)},M.fitHeight=function(g,q){return Il(M,g,q)};function L(){var g=Fr(r,0,0,u,b,x).apply(null,a(i,s)),q=Fr(r,n-g[0],o-g[1],u,b,x);return d=ml(l,c,h),S=pn(a,q),T=pn(d,S),C=Rr(S,N),F()}function F(){return A=R=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&$,L()}}function Ro(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Ro.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,s=i*i;r-=o=(r*(1.007226+i*(.015085+s*(-.044475+.028874*i-.005916*s)))-a)/(1.007226+i*(.015085*3+s*(-.044475*7+.028874*9*i-.005916*11*s)))}while(Ce(o)>we&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Gl(){return Vl(Ro).scale(175.295)}function Yl(e){return e}function Ql(e){if(e==null)return Yl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],s=e.translate[1];return function(l,c){c||(a=r=0);var h=2,d=l.length,x=new Array(d);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+s;h<d;)x[h]=l[h],++h;return x}}function Kl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Jl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Mr(e,r)})}:Mr(e,a)}function Mr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Xl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Xl(e,a){var r=Ql(e.transform),n=e.arcs;function o(d,x){x.length&&x.pop();for(var u=n[d<0?~d:d],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));d<0&&Kl(x,m)}function i(d){return r(d)}function s(d){for(var x=[],u=0,b=d.length;u<b;++u)o(d[u],x);return x.length<2&&x.push(x[0]),x}function l(d){for(var x=s(d);x.length<4;)x.push(x[0]);return x}function c(d){return d.map(l)}function h(d){var x=d.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:d.geometries.map(h)};case"Point":u=i(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(i);break;case"LineString":u=s(d.arcs);break;case"MultiLineString":u=d.arcs.map(s);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return h(a)}const Fo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Zl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ed(e,a,r){const n=Fo[e];if(!n||!n.length)return-1;const o=Zl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(s=>o.includes(s)))return i}return Math.floor(r*n.length)%n.length}let xa=null;function td(){return xa||(xa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Jl(r,n),i=Gl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=Ml(i),l=(o.features||[]).filter(d=>{var x;return(((x=d.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(d=>{var b;const x=((b=d.properties)==null?void 0:b.name)||"",u=s(d)||"";return u?{i2:Ei(x)||null,n:x,d:u}:null}).filter(d=>!!d);if(!l.length)return null;const c={};for(const[d,x]of Object.entries(Si)){const u=i(x);u&&(c[d]={x:u[0],y:u[1]})}const h={};for(const[d,x]of Object.entries(Fo)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(h[d]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:c,metros:h}}catch{return null}})(),xa)}function ad(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return td().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const nd="8 40 984 210",rd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Or=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Dr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function od(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const s=()=>{var h;if(!o)return;const c=(h=e.current)==null?void 0:h.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function Ir({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],s)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function id(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:s,lang:l,t:c,data:h,dossiers:d,source:x}=V(),u=h.loading&&!d.length,b=p.useRef(null),m=p.useRef(null),v=ad(e.continent==="monde"),k=e.continent==="monde"?v:Sn.find(g=>g.key===e.continent)||null,f=od(b,e.continent+":"+e.mapFolded+":"+!!k),[y,j]=p.useState(new Map),[w,N]=p.useState(null);p.useEffect(()=>{const g=b.current;if(!g)return;const q=new Map;g.querySelectorAll("path[data-i2]").forEach(P=>{const J=P.dataset.i2;if(J)try{const I=P.getBBox();I.width>0&&q.set(J,{x:I.x,y:I.y,w:I.width,h:I.height})}catch{}}),j(q)},[e.continent,f,k]);const C=p.useMemo(()=>r.filter(g=>g.cc),[r]),S=p.useMemo(()=>{const g=new Map;return C.forEach(q=>g.set(q.cc,(g.get(q.cc)||0)+1)),g},[C]),T=e.continent==="monde"&&v?v.anchors:null,A=e.continent==="monde"&&v?v.metros:null,R=p.useMemo(()=>C.map(g=>{const q=Dr(g.name||g.id||""),P=Dr((g.id||g.name||"")+"·y");if(T&&g.cc){const W=A?A[g.cc]:void 0;if(W&&W.length){const X=ed(g.cc,g.city,q);if(X>=0&&W[X])return{d:g,x:W[X].x+(q-.5)*5,y:W[X].y+(P-.5)*5}}const K=T[g.cc];if(K)return{d:g,x:K.x+(q-.5)*10,y:K.y+(P-.5)*10}}const J=g.cc?y.get(g.cc):void 0;if(!J)return null;const I=rd[`${e.continent}:${g.cc||""}`];if(I)return{d:g,x:J.x+J.w*(I.fx+(q-.5)*I.sx),y:J.y+J.h*(I.fy+(P-.5)*I.sy)};const O=(q-.5)*Math.min(J.w*.55,60),B=(P-.5)*Math.min(J.h*.55,60);return{d:g,x:J.x+J.w/2+O,y:J.y+J.h/2+B}}).filter(g=>!!g),[C,y,T,A,e.continent]),M=g=>f>0?g/f:g,$=p.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:Or[g],fr:c.plabels[g].toUpperCase(),en:c.plabels[g].toUpperCase(),n:r.filter(q=>q.kind==="target"&&ze(q)===g).length})).filter(g=>g.n>0):Vn.map((g,q)=>({...g,n:r.filter(P=>Wn(P)===q).length})),[r,n,c.plabels]),L=i?s.get(i):null,F=L?R.find(g=>g.d.id===L.id):null;return k?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Ir,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?nd:k.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?k.fr:k.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:k.countries.map((g,q)=>t.jsx("g",{className:"ct"+(g.i2&&S.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},q))}),t.jsx("g",{children:R.map(g=>{const q=Vn[Wn(g.d)],P=!!Me(g.d),J=g.d.kind==="target",I=n&&J?Or[ze(g.d)]:q.c,O=!n&&Ie(g.d);return t.jsxs("g",{className:"co"+(O?" done":""),onMouseEnter:()=>{var K,X;const B=(K=m.current)==null?void 0:K.getBoundingClientRect(),W=(X=b.current)==null?void 0:X.createSVGPoint();if(W&&b.current&&B){W.x=g.x,W.y=g.y;const ge=W.matrixTransform(b.current.getScreenCTM());N({x:ge.x-B.left,y:ge.y-B.top,label:g.d.name+" · "+($t(g.d.cc,l)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var K;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const B=(K=b.current)==null?void 0:K.createSVGPoint();let W=null;if(B&&b.current){B.x=g.x,B.y=g.y;const X=B.matrixTransform(b.current.getScreenCTM());W={x:X.x,y:X.y}}a({type:"popup",id:g.d.id,anchor:W})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:M(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:M(q.px),fill:I,stroke:P?"#DC2626":"#ffffff",strokeWidth:M(P?2.2:1.3)})]},g.d.id||g.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:$.map((g,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),l==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},q))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Ir,{msgs:c.loadMsgs})})}function sd(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Mo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:s,lang:l}=V(),c=a.filters,[h,d]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null),m=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),k=F=>v.filter(g=>F!=="country"&&c.country.length&&!c.country.includes(g.cc||"")?!1:Ca(g,c,i,F==="country"?void 0:F)),f=F=>!i||F.kind!=="op",y=p.useMemo(()=>{const F=k("win").filter(f),g=q=>F.filter(P=>(P.date?Math.max(0,Math.floor((Date.now()-Date.parse(P.date))/864e5)):9999)<=q).length;return[g(0),g(7),g(30),F.length]},[v,c,i]),j=p.useMemo(()=>c.day?k("win").filter(f).filter(F=>(F.date||"").slice(0,10)===c.day).length:0,[v,c,i]),w=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,N=w+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),p.useEffect(()=>{if(!h&&!x)return;const F=q=>{var J,I;const P=q.target;h&&!((J=b.current)!=null&&J.contains(P))&&d(!1),x&&!((I=m.current)!=null&&I.contains(P))&&u(!1)},g=q=>{q.key==="Escape"&&(d(!1),u(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",g)}},[h,x]);const C=(F,g,q,P="fbtn")=>t.jsxs("button",{type:"button",className:P,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:g}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},F),S=["1","7","30","all"],T=Math.max(0,S.indexOf(c.win||"all")),A=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(sd(c.day,l))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:y[T]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((F,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),u(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:y[g]})]},F))})]}):t.jsx("div",{className:"seg",children:S.map((F,g)=>t.jsxs("button",{type:"button","aria-pressed":c.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:y[g]})]},F))}),R=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),M=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):C("sec",o.fSector,c.sector.length),C("pay",o.fCountry,c.country.length),C("det",o.fEngine,c.engine.length),C("sta",o.fStage,c.stage.length),i&&C("ang","Angle",c.angle.length),i&&C("mem","Mémo",c.memoLevel.length)]}),$=(F=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(w?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{d(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),w>0&&t.jsx("span",{className:"n",children:w}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:M})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:A}),t.jsxs("div",{className:"fstrip-b",children:[R,L,$(!1)]})]}),a.openFacet&&t.jsx(Pr,{poolFor:k})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[A,R,M,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx(Pr,{poolFor:k})]})}function Pr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=V(),i=a.filters,s=a.openFacet,{title:l,cols:c,options:h}=p.useMemo(()=>{if(s==="sig"){const m=e("signal").filter(f=>Me(f)),v=new Map;m.forEach(f=>{const y=f.engine||"";v.set(y,(v.get(y)||0)+1)});const k=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...rn([...v.keys()],o).map(f=>({v:f,label:At(f)+" "+Qe(f,o),n:v.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:k}}if(s==="sec"){const m=e("sector"),v=new Map;return m.forEach(k=>{k.sector&&v.set(k.sector,(v.get(k.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k,n:f,html:!1,on:i.sector.includes(k)}))}}if(s==="pay"){const m=e("country"),v=new Map;return m.forEach(k=>{k.cc&&v.set(k.cc,(v.get(k.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:$t(k,o)||k,n:f,html:!1,on:i.country.includes(k)}))}}if(s==="det"){const m=e("engine"),v=new Map;return m.forEach(k=>{k.engine&&v.set(k.engine,(v.get(k.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:rn([...v.keys()],o).map(k=>({v:k,label:At(k)+" "+Qe(k,o)+' <span style="color:var(--dim);font-size:10px">· '+Ci(zi(k),o)+"</span>",n:v.get(k)||0,html:!0,on:i.engine.includes(k)}))}}if(s==="ang"){const m=e("angle"),v=new Map;return m.forEach(k=>{k.angle&&v.set(k.angle,(v.get(k.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(k)}))}}if(s==="mem"){const m=e("memoLevel"),v=new Map;m.forEach(f=>{if(f.kind==="target"){const y=Nn(f);v.set(y,(v.get(y)||0)+1)}});const k=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:k[f],n:v.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const u=e("stage"),b=new Map;return u.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,v)=>v[1]-m[1]).map(([m,v])=>({v:m,label:m,n:v,html:!1,on:i.stage.includes(m)}))}},[s,a,o]),d=u=>{if(s==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(u)?i.signalEngines.filter(v=>v!==u):[...i.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:u})},x=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:h.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Oo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:s,t:l}=V(),c=p.useMemo(()=>{const b={};return r.forEach(m=>{Ca(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[h,d]=p.useState(!1),x=p.useRef(null);p.useEffect(()=>{if(!h)return;const b=v=>{var k;(k=x.current)!=null&&k.contains(v.target)||d(!1)},m=v=>{v.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[h]);const u=b=>{const m=Sn.find(v=>v.key===b);return b==="monde"?l.contWorld:s==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>d(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Gn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),d(!1)},children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[Gn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function jn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function Do(e){return"atl2:evalq:"+(e||"anon")}function ld(e,a){const r=Do(e),n=jn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const s=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(s)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Io(){const{t:e,data:a}=V(),r=a.session.token||"",n=Do(r),[o,i]=p.useState(()=>jn(n)),s=p.useRef(!1),[l,c]=p.useState(!1);p.useEffect(()=>{try{const y=o.slice(0,30).map(({descBusy:j,evalBusy:w,...N})=>N);localStorage.setItem(n,JSON.stringify(y)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[o,n]),p.useEffect(()=>{const y=()=>{if(s.current)return;const j=jn(n);i(w=>JSON.stringify(w.map(({descBusy:N,evalBusy:C,...S})=>S))===JSON.stringify(j)?w:j)};return window.addEventListener("atl2:evalq",y),window.addEventListener("storage",y),()=>{window.removeEventListener("atl2:evalq",y),window.removeEventListener("storage",y)}},[n]);const h=p.useCallback((y,j)=>i(w=>w.map((N,C)=>C===y?{...N,...j}:N)),[]),d=p.useCallback((y,j)=>{const w=j.trim();w&&(h(y,{name:w,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Cn(w).then(N=>{const C=N.candidates||[];N.website?h(y,{site:N.website,status:"ready"}):C.length===1?h(y,{site:C[0].url,status:"ready"}):C.length>1?h(y,{status:"pick",candidates:C.slice(0,4)}):h(y,{status:"ready"})}).catch(()=>h(y,{status:"ready"})))},[h]),x=p.useCallback((y,j,w)=>{h(y,{descBusy:!0}),to(r,j,w).then(N=>{if(N.quota){c(!0),h(y,{descBusy:!1,descDone:!0});return}const C=N.blocs||{},S=(C.synthese||C.value_prop||C.produit||C.modele||"").trim();h(y,{descBusy:!1,descDone:!0,desc:S})}).catch(()=>h(y,{descBusy:!1,descDone:!0}))},[h,r]);p.useEffect(()=>{const y=o.findIndex(w=>w.auto&&w.name.trim()&&w.status==="");if(y>=0){d(y,o[y].name);return}if(l)return;const j=o.findIndex(w=>w.status==="ready"&&w.site&&!w.descDone&&!w.descBusy);j>=0&&x(j,o[j].name,o[j].site)},[o,d,x,l]);const[u,b]=p.useState(!1),m=p.useCallback(async(y,j)=>{h(y,{evalBusy:!0});const w=await ao(r,(j.site||j.name).trim(),"atelier2");return w.verdict==="quota"?(h(y,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:w.reason||"",remaining:0}})),!1):(h(y,{evalBusy:!1,status:w.verdict==="kept"?"kept":"out",reason:w.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:w.company||j.name,verdict:w.verdict,reason:w.reason||"",remaining:w.remaining??null}})),!0)},[h,r]),v=async()=>{if(u)return;const y=o.map((j,w)=>({r:j,i:w})).filter(({r:j})=>j.name.trim()&&j.status!=="kept"&&j.status!=="out"&&j.status!=="resolving");if(y.length){b(!0);for(const{r:j,i:w}of y)if(!await m(w,j))break;b(!1)}},k=o.filter(y=>y.name.trim()&&y.status!=="kept"&&y.status!=="out").length,f=y=>y.name.trim()&&y.status!=="kept"&&y.status!=="out"&&y.status!=="resolving"&&!y.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),o.map((y,j)=>t.jsxs("div",{className:"eq-row"+(y.status==="kept"?" r-kept":y.status==="out"?" r-out":""),children:[t.jsx("input",{value:y.name,placeholder:e.eqNamePh,onChange:w=>{const N=w.target.value.split(`
`).map(C=>C.trim()).filter(Boolean);N.length>1?i(C=>{const S=[...C];return S.splice(j,1,...N.map(T=>({name:T,site:"",status:"",auto:!0}))),S.slice(0,30)}):h(j,{name:w.target.value})},onBlur:()=>{y.name.trim()&&!y.site&&y.status!=="resolving"&&y.status!=="pick"&&d(j,y.name)},onKeyDown:w=>{w.key==="Enter"&&d(j,y.name)}}),t.jsxs("span",{className:"eq-site",children:[y.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),y.status==="pick"&&(y.candidates||[]).map(w=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>h(j,{site:w.url,status:"ready",candidates:void 0}),children:(w.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},w.url)),y.status!=="resolving"&&y.status!=="pick"&&(y.site?t.jsxs("a",{href:y.site.startsWith("http")?y.site:"https://"+y.site,target:"_blank",rel:"nofollow noopener",children:[y.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:y.name.trim()&&y.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:y.desc||"",children:y.descBusy?t.jsx("i",{children:e.eqDescBusy}):y.desc?y.desc:t.jsx("em",{children:y.descDone?l?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(y.status||"vide"),title:y.reason||"",children:y.status==="kept"?"✓ "+e.kept:y.status==="out"?"✗ "+e.dropped:y.status==="ready"?e.eqReady:y.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!f(y)||u,onClick:()=>{m(j,y)},children:y.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>i(w=>w.filter((N,C)=>C!==j)),children:"×"})]},j)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>i(y=>[...y,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!k,onClick:()=>{v()},children:[t.jsx("span",{className:"fill"}),u?e.eqRunning:e.eqGo(k)]}),t.jsx("span",{className:"hint",children:e.eqHint}),o.some(y=>y.status==="kept"||y.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>i(y=>y.filter(j=>j.status!=="kept"&&j.status!=="out")),children:e.eqClearDone})]})]})}function Po(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function dd(e){var o;const a=[],r=new Set,n=i=>{const s=(i||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Br({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:s}){const{t:l}=V();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:l.rsEvalOne})]},c.name))})]}):null}function Bo({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=V(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Br,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Br,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function cd({card:e,onEvaluate:a,onAddAll:r}){var l,c,h;const{t:n}=V(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Po(e.summary_md||"").map((d,x)=>t.jsx("p",{children:d},x))})]}),t.jsx(Bo,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function pd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ud({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:s}=V(),l=o,[c,h]=p.useState(null),[d,x]=p.useState(null),[u,b]=p.useState(null),[m,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const y=await no({email:s,cbToken:l});f&&h(y)})(),()=>{f=!1}},[s,l,n]);const k=f=>{x(f),b(null),v(!0),(async()=>{const y=await Ai(f.id);b(y),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>k(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[pd(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(cd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ka=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Xt(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?Xt(a)?a:ka.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function md(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function fd(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:s,evalBusy:l,evalCards:c,caps:h,data:d,canWrite:x,source:u,dossiers:b,doAnalyse:m,liveMemos:v,pipe:k}=V(),f=a==="client",y=p.useMemo(()=>r||(u!=="default"?qi():""),[r,u]),[j,w]=p.useState(""),[N,C]=p.useState(!1),[S,T]=p.useState(""),[A,R]=p.useState(""),[M,$]=p.useState(""),[L,F]=p.useState(!1),[g,q]=p.useState(!1),[P,J]=p.useState([]);p.useEffect(()=>{const D=ee=>{const ie=ee.detail;ie&&J(Z=>[ie,...Z].slice(0,8))};return window.addEventListener("ppmap:evalcard",D),()=>window.removeEventListener("ppmap:evalcard",D)},[]);const[I,O]=p.useState(!1),[B,W]=p.useState(!1),[K,X]=p.useState(!1),ge=p.useRef(!1),[Y,ce]=p.useState(""),[le,be]=p.useState(""),[me,de]=p.useState(!1),[pe,xe]=p.useState(!1),[G,re]=p.useState(0),[fe,ke]=p.useState(""),[ne,ve]=p.useState(null),[oe,Ee]=p.useState(null),[Ke,he]=p.useState(!1),[Se,Rt]=p.useState(null),[Pe,Je]=p.useState(0),qe=p.useRef(!1),it=j.trim()?ka.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const D=new URLSearchParams(window.location.search),ee=(D.get("rs")||"").trim(),ie=(D.get("rstext")||"").trim();ee&&/^https?:\/\//i.test(ee)&&ce(ee),ie&&be(ie),(ee&&/^https?:\/\//i.test(ee)||ie)&&O(!0)},[]),p.useEffect(()=>{const D=ee=>{const ie=ee.detail||{},Z=String(ie.url||"").trim(),je=String(ie.text||"").trim();Z&&/^https?:\/\//i.test(Z)&&ce(Z),je&&be(je),(Z&&/^https?:\/\//i.test(Z)||je)&&(O(!0),w(""),T(""),de(!0),window.setTimeout(()=>de(!1),900))};return window.addEventListener("ppmap:research",D),()=>window.removeEventListener("ppmap:research",D)},[]),p.useEffect(()=>{const D=ee=>{const ie=ee.detail||{},Z=String(ie.name||"").trim();if(!Z)return;O(!1),w(Z),T(Z);const je=lt(String(ie.website||ie.domain||""));R(je),$(lt(String(ie.url||""))),F(!je),C(!0),window.setTimeout(()=>C(!1),900)};return window.addEventListener("ppmap:prefill",D),()=>window.removeEventListener("ppmap:prefill",D)},[]),p.useEffect(()=>{const D=(S||"").trim();if(!D||I||A){(A||!D||I)&&F(!1);return}const ee=b.find(je=>_e(je.name)===_e(D)),ie=lt((ee==null?void 0:ee.website)||"")||lt((ee==null?void 0:ee.domain)||"");if(ie){R(ie),F(!1);return}let Z=!0;return F(!0),Cn(D).then(je=>{var $e,Ae;if(!Z)return;const De=lt(je.website||"")||lt(((Ae=($e=je.candidates)==null?void 0:$e[0])==null?void 0:Ae.url)||"");De&&R(De)}).catch(()=>{}).finally(()=>{Z&&F(!1)}),()=>{Z=!1}},[S,I,A,b]),p.useEffect(()=>{const D=ee=>{var Z;const ie=String(((Z=ee.detail)==null?void 0:Z.url)||"").trim();Xt(ie)&&window.open(ie,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",D),()=>window.removeEventListener("ppmap:view",D)},[]),p.useEffect(()=>{if(ge.current===I)return;ge.current=I,X(!0);const D=window.setTimeout(()=>X(!1),560);return()=>window.clearTimeout(D)},[I]),p.useEffect(()=>{if(typeof window>"u")return;const D=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ee=document.querySelector(".atl2.ops, .atl2.cibles");if(!D||!ee)return;const ie=()=>ee.style.setProperty("--demand-h",`${D.offsetHeight}px`);ie();const Z=new ResizeObserver(ie);return Z.observe(D),()=>Z.disconnect()},[u,N,me,g,I,K,L]),p.useEffect(()=>{if(!x&&!y){Rt(null);return}let D=!0;return(async()=>{const ee=await no({email:n,cbToken:y});D&&Rt(ee.length)})(),()=>{D=!1}},[x,y,n,Pe]);const kt=P.length?P:c,Oe=d.credits,xt=p.useCallback(D=>{ld(r,D)&&q(!0)},[r]);p.useEffect(()=>{if(!pe)return;re(0);const D=window.setInterval(()=>re(ee=>ee+1),1e3);return()=>window.clearInterval(D)},[pe]);const ut=p.useMemo(()=>{const D=j.trim().toLowerCase();return!D||!k?null:b.find(ee=>_e(ee.name)===D&&ze(ee)===1)||null},[j,b,k]),Xe=()=>{const D=j.trim();if(D){if(ut){m(ut);return}o(null,D),f&&w("")}},jt=async()=>{var ie,Z,je;if(qe.current)return;const D=Y.trim().replace(/\s+/g,""),ee=le.trim();if(!D&&!ee){ke(e.rsNeed);return}if(!f&&!y){o(null,D||ee.slice(0,80));return}qe.current=!0,ke(""),ve(null),Ee(null),xe(!0);try{const De=await Li({url:D,text:ee,email:n,cbToken:y});if(xe(!1),!De||De.status!=="success"){ke((De==null?void 0:De.message)||"Erreur");return}ve(De),O(!1),xt((((ie=De.prospective)==null?void 0:ie.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),Ee({state:"pending"});const $e=await Ri(De,{email:n,cbToken:y});Ee($e.ok?{state:"ok",scopeLabel:((Z=$e.summary)==null?void 0:Z.scope_label)||"",scope:((je=$e.summary)==null?void 0:je.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&Je(Ae=>Ae+1)}finally{qe.current=!1,xe(!1)}},gt=[ne==null?void 0:ne.industry,...(ne==null?void 0:ne.market_tags)||[],ne==null?void 0:ne.author].map(D=>(D||"").trim()).filter(Boolean),bt=(oe==null?void 0:oe.state)==="pending",Ft=oe&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),Nt=dd(ne).length,Re=I,nt=(S||j).trim(),z=b.find(D=>_e(D.name)===_e(nt)),_=lt(j)||A||lt((z==null?void 0:z.website)||"")||lt((z==null?void 0:z.domain)||""),H=M||lt((z==null?void 0:z.url)||""),ae=ut?e.actAnalyse:nt?e.evalGoOn(nt.length>22?nt.slice(0,21)+"…":nt):e.evalGo,ye=pe?`${Ti(Y.trim())==="youtube"&&Y.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(G)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Re?" rs-mode":"")+(S&&j.trim()===S||N||me?" pair":"")+(N||me||K?" echo":"")+(K?" swap":""),children:[t.jsxs("div",{className:"drow"+((Re?me:N)||K?" flash":"")+((Re?Y.trim():ka.test(j.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Re?Y:j,placeholder:Re?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Re?600:200,spellCheck:Re?!1:void 0,inputMode:Re?"url":void 0,onChange:D=>{if(Re){ce(D.target.value);return}w(D.target.value),S&&D.target.value.trim()!==S&&(T(""),R(""),$(""),F(!1))},onKeyDown:D=>{D.key==="Enter"&&(Re?jt():Xe())}}),t.jsx("span",{className:"detect"+(Re?" off":"")+(ka.test(j.trim())?" url":""),children:it})]}),t.jsx("span",{className:"dacts",children:Re?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(pe?" loading":""),disabled:pe||bt||!Y.trim()&&!le.trim(),onClick:()=>{jt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ye})]}),t.jsxs("a",{className:"viewbtn"+(Xt(Y)?"":" off"),href:Xt(Y)?Y.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:D=>{Xt(Y)||D.preventDefault()},children:[t.jsx(md,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ut?" analyse":"")+(l?" loading":""),disabled:l,onClick:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ae})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":_?"":" off"),href:_||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:D=>{_||D.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(H?"":" off"),href:H||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:D=>{H||D.preventDefault()},children:e.viewSrc})]})}),h.showCredits&&Oe&&t.jsxs("button",{type:"button",className:"credits"+(Oe.total_available<=0&&!Oe.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Oe.unlimited?"∞":Oe.total_available}),!Oe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Oe.daily_grant+Oe.purchased]}),Oe.total_available<=0&&!Oe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>q(!g),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(I?" on":""),onClick:()=>O(!I),children:e.rsOpen}),Se!==null&&Se>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Ke?" on":""),onClick:()=>he(!Ke),children:e.rsArchOpen(Se)})]}),Ke&&t.jsx(ud,{bump:Pe,cbToken:y,onClose:()=>he(!1),onEvaluate:D=>o(null,D),onAddAll:xt}),t.jsx("div",{className:"rsp slim"+(I?" on":" off"),"aria-hidden":!I,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:I?void 0:-1,onClick:()=>W(D=>!D),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:B?"▴":"▾"})]}),B&&t.jsx("textarea",{className:"rstext",value:le,placeholder:e.rsTextPh,tabIndex:I?void 0:-1,onChange:D=>be(D.target.value)})]})}),fe&&t.jsx("div",{className:"rserr",children:fe}),ne&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ne.title}),ne.source_url&&t.jsx("a",{href:ne.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ve(null),Ee(null)},children:"×"})]}),ne.market&&t.jsx("p",{className:"rsmk",children:ne.market}),gt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),gt.map(D=>t.jsx("span",{children:D},D))]}),t.jsxs("div",{className:"rsbody",children:[ne.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ne.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Po(ne.summary_md||"").map((D,ee)=>t.jsx("p",{children:D},ee))})]}),t.jsx(Bo,{card:ne,onEvaluate:D=>o(null,D),onAddAll:xt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Nt)}),Ft]})]}),g&&t.jsx(Io,{}),kt.slice(0,1).map((D,ee)=>{const ie=D.verdict==="kept",Z=D.verdict==="quota",je=D.verdict==="unresolved",De=ie?"var(--brand)":Z?"var(--bolt)":je?"var(--blue)":"var(--red)",$e=ie?"var(--brand-l)":Z?"#FEF3C7":je?"#EEF4FF":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":De,"--bgc":$e},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ie?"✓ "+e.kept:Z?"⏳":je?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),D.name&&t.jsx("span",{className:"rn",children:D.name}),t.jsx("span",{className:"rr",children:D.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",D.reason]}):null}),!!(D.candidates&&D.candidates.length)&&t.jsx("span",{className:"sitepick",children:D.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,Ae.url,D.name),children:e.evalPickGo})]},Ae.url))}),!Z&&!je&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ie?1:5});const Ae=(D.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ue=[...document.querySelectorAll(".atl2 .list .row")].find(Pa=>{var la;return(((la=Pa.querySelector(".rnm"))==null?void 0:la.textContent)||"").trim().toLowerCase().includes(Ae)});Ue&&(Ue.scrollIntoView({behavior:"smooth",block:"center"}),Ue.classList.add("flashrow"),window.setTimeout(()=>Ue.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ie?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),f&&(i.kept+i.dropped>0||kt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function hd(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function xd(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=V(),i=e.memoConsole?r.get(e.memoConsole):null,s=p.useMemo(()=>i?[i.reasoning||"",hd(i.summary||"")].filter(Boolean).join(`
...
`).map((h,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Dt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Rn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=V(),[s,l]=p.useState(!1),[c,h]=p.useState(null),d=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!d||s)return;l(!0);const u=await Fi(r,e);if(l(!1),!u){i(a.actErr);return}h(u.results||[])};return p.useEffect(()=>{if(!d)return;const u=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,d]),p.useEffect(()=>{if(d)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,d]),d?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{x()},children:s?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const gd=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ga=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function bd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ga(a.slice(n));break}r+=ga(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ga(a.slice(o));break}const s=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),c=l?l[2].toLowerCase():"";l&&gd.has(c)?r+=`<${l[1]}${c}>`:r+=ga(a.slice(o,i+1)),n=i+1}return r}const vd=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),_r={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function _o(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(vd.has(o)){n.remove();continue}for(const s of Array.from(n.attributes)){const l=s.name.toLowerCase();(!(_r["*"].has(l)||((r=_r[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(s.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const s=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");s!==i&&(s?n.setAttribute("style",s):n.removeAttribute("style"))}if(o==="a"){const s=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(s)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const s=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(s)){n.remove();continue}n.setAttribute("loading","lazy")}_o(n)}}function Xa(e){const a=e.cloneNode(!0);return _o(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Za=new Map;function yd(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=Za.get(a);return r||(r=wd(a).catch(()=>null),r.then(n=>{n||Za.delete(a)}),Za.set(a,r)),r}async function wd(e){var x,u;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=b=>{var m;return(((m=r.querySelector(b))==null?void 0:m.textContent)||"").trim()},o=r.querySelector(".sb-score"),i=((x=Array.from((o==null?void 0:o.classList)||[]).find(b=>b.startsWith("sb-score-")))==null?void 0:x.slice(9))||"",s=[];let l=null;const c=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const b of c){if(b.classList.contains("sb-nav-heading")){l={label:(b.textContent||"").trim(),items:[]},s.push(l);continue}const m=b.getAttribute("href")||"";if(!m.startsWith("#"))continue;const v=m.slice(1),k=kd(r,v);k&&(l||(l={label:"",items:[]},s.push(l)),l.items.push({id:v,title:(b.textContent||"").trim(),html:k,poids:k.length}))}const h=((u=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:u[1])||"",d={score:n(".sb-score"),scoreTone:i,tags:Array.from(r.querySelectorAll(".sb-tag")).map(b=>(b.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:s.filter(b=>b.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?h:""};return d.groups.length?d:null}const $r={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function kd(e,a){const r=e.getElementById(a),n=r?Ur(e,r):"";if(n)return n;const o=$r[a]?e.querySelector($r[a]):null;return o&&o!==r?Ur(e,o):""}function Ur(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Xa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(c=>/^h3$/i.test(c.tagName))[0]===a)for(const c of i){if(c===a)break;/^h2$/i.test(c.tagName)||o.appendChild(c.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?Xa(o):""}return Xa(a)}const en=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ot({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Hr(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Vr({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const tn=new Map;function jd(e,a){const{token:r}=V(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let s=tn.get(i);s||(s=Mi(r,e.name,e.checkId),tn.set(i,s),s.then(c=>{(!c||!c.reasoning&&!c.summaryHtml)&&tn.delete(i)}));let l=!0;return s.then(c=>{l&&c&&o({id:e.id,d:c})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Nd=6e4;function Ed({o:e}){const{t:a,doDeep:r}=V(),[n,o]=p.useState(null),[i,s]=p.useState(e.memoUrl?"load":"off"),[l,c]=p.useState(()=>new Set),[h,d]=p.useState(!1),x=p.useRef(new Map);p.useEffect(()=>{let v=!0;if(c(new Set),d(!1),x.current=new Map,!e.memoUrl){s("off"),o(null);return}return s("load"),o(null),yd(e.memoUrl).then(k=>{v&&(o(k),s(k?"ok":"err"))}),()=>{v=!1}},[e.memoUrl]);const u=wt(e),b=v=>{var k;return(k=x.current.get(v))==null?void 0:k.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[Dt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:v=>{v.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const v=[e.reasoning||"",Hr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[v.length?v.join(`

`).split(`

`).map((k,f)=>t.jsx("p",{className:"cdtxt",children:k},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(i!=="ok"){const v=[e.reasoning||"",Hr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),v.length>0&&v.join(`

`).split(`

`).map((k,f)=>t.jsx("p",{className:"cdtxt",children:k},f)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:k=>{k.stopPropagation(),d(f=>!f)},children:h?a.memoHideHere:a.memoReadHere})}),h&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:k=>k.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(v=>t.jsx("span",{className:"md-tag",children:v},v)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(v=>v.items.map(k=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),b(k.id)},children:k.title},k.id)))}),n.groups.map((v,k)=>t.jsxs("div",{className:"md-grp",children:[v.label&&t.jsx("div",{className:"md-grp-h",children:v.label}),v.items.map(f=>{const y=f.poids>Nd&&!l.has(f.id),j=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:w=>{w&&x.current.set(f.id,w)},children:[t.jsx("h4",{className:"md-h",children:f.title}),j&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:w=>w.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"LinkedIn"})]}),y?t.jsx("button",{type:"button",className:"abtn md-more",onClick:w=>{w.stopPropagation(),c(N=>new Set(N).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:f.html}}),!y&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Da}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:w=>w.stopPropagation()})]})]},f.id)})]},v.label||k)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}function Fn({o:e}){var j;const{t:a,lang:r,dispatch:n,caps:o}=V(),i=ia(e),s=wt(e),l=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,h=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(l?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Dt(e)?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:h},{k:"suivi",lib:a.cdSuivi,n:d}].filter(w=>w.n>0),[e,a,o,l,s,c,h,d]),[u,b]=p.useState(""),m=x.some(w=>w.k===u)?u:((j=x[0])==null?void 0:j.k)||"",v=jd(e,m==="eval"||m==="conv");if(!x.length)return null;const k=((v==null?void 0:v.reasoning)||"").length>(e.reasoning||"").length?v.reasoning:e.reasoning||"",f=((v==null?void 0:v.summaryHtml)||"").length>(e.summary||"").length?v.summaryHtml:e.summary||"",y=(v==null?void 0:v.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(w=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===w.k,"data-tour":"tab-"+w.k,className:m===w.k?"on":"",onClick:N=>{N.stopPropagation(),b(w.k)},children:w.lib},w.k))}),t.jsxs("div",{className:"cdbody",onClick:w=>w.stopPropagation(),children:[m==="eval"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(Vr,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),k&&k.split(`

`).map((w,N)=>t.jsx("p",{className:"cdtxt",children:w},N)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Sd,{o:e})]}),m==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof y=="number"&&t.jsx(Vr,{v:y,sur:100,k:a.cdConvScore}),en(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",en(e.verdictDate,r)]})]}),f&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:bd(f)}})]}),m==="memo"&&t.jsx(Ed,{o:e}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdSector,v:e.sector}),t.jsx(ot,{k:a.cdStage,v:e.stage}),t.jsx(ot,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ot,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ot,{k:a.cdAngle,v:e.angle}),t.jsx(ot,{k:a.cdDetected,v:en(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdName,v:e.contactName}),t.jsx(ot,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(ot,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}const ba=new Map;function Sd({o:e}){const{t:a,token:r}=V(),[n,o]=p.useState(!1),[i,s]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let u=ba.get(x);u||(u=ro(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),ba.set(x,u),u.then(m=>{(!m||!m.ok)&&ba.delete(x)}));let b=!0;return u.then(m=>{b&&m&&m.ok&&s(m)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const x=await to(r,e.name,e.website||e.domain||"");s(x),x.ok&&ba.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},c=(i==null?void 0:i.blocs)||{},h=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],d=h.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[h.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function sa({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let s=!1;const l=()=>{const h=Math.max(280,Math.min(560,i.clientWidth||320));Yn({kind:"op",card:e},h).then(d=>{!s&&d&&i.isConnected&&i.replaceChildren(d)})},c=window.requestAnimationFrame(l);return()=>{s=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let s=!1;Yn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!s&&c&&i.isConnected&&i.replaceChildren(c)});const l=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{s=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&_t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Cd=`
...
`;function zd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function Ad(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:s,askEvaluate:l,doAnalyse:c,doDecide:h,doPromote:d,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:v,evalBusy:k}=V(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=Me(f),j=ze(f),w=wt(f),N=ia(f),C=f.kind==="target",S=T=>{a({type:"filters",patch:T}),a({type:"popup",id:null})};return _t.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Cd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:zd(e.popupAnchor,!!f.card),onClick:T=>T.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ht(f.date)),Qe(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[f.cc]}),children:($t(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Ut(f.amountEur,o)})]}),i.pipe&&C&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[At(f.engine)," ",t.jsx("b",{children:Qe(f.engine,o)})," — ",Oi(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(yt,{o:f,lg:!0})," ",t.jsx(Ia,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(oo(y,o))," · ",n.win7(io(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(sa,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&C&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&C&&t.jsx(Fn,{o:f})]}),t.jsx(Rn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(f,!1),a({type:"popup",id:null})},children:n.actNo}),Dt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var T;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(T=document.querySelector(".atl2 .demand"))==null||T.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:k,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function qd(){const{lang:e,token:a,dossiers:r,caps:n}=V(),o=a||"home",{names:i,verdicts:s}=p.useMemo(()=>{const c=[],h={};return r.forEach(d=>{d.kind!=="target"||!d.name||(c.push(d.name),h[d.name]=Di(d)||"")}),{names:c,verdicts:h}},[r]);return{diff:p.useMemo(()=>i.length?Ii(o,i,s,e):null,[o,i.length]),names:i,verdicts:s,scope:o,caps:n}}function Td(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:s,caps:l}=V(),[c,h]=p.useState(!1),[d,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!c)return;const j=w=>{u.current&&!u.current.contains(w.target)&&h(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[c]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!s.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const k=j=>{const w=v.current[j],N=w!==void 0?r[j]-w:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zt[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j].toUpperCase(),j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[j],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},j)},f=(j,w,N)=>t.jsxs("button",{type:"button",className:"off"+(w?" view":""),style:{"--c":`var(${Zt[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:N.toUpperCase()}),t.jsx("span",{className:"n",children:r[j]})]},j),y=(j,w,N,C=!1)=>t.jsx("button",{type:"button",className:"tool",title:w,disabled:C,onClick:N,children:j},w);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(k)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[y("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(d?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":c,title:n.toolSort,onClick:()=>h(j=>!j),children:"⇅"}),c&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,w])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[w,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),y("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),y("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Ld(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:s}=V(),l=p.useRef(null),[c,h]=p.useState(60);p.useEffect(()=>{let m=0;const v=()=>{var w;const k=l.current;if(!k)return;const f=(w=k.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!f)return;const y=f.getBoundingClientRect(),j=k.getBoundingClientRect();h(Math.max(20,Math.min(y.left+y.width/2-j.left,j.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const d=e.ptab;let x=r.tuto[d].p;if(d===3){const m=n.filter(f=>f.kind==="target"&&ze(f)===3),v=m.filter(f=>on(f)==="auto").length,k=m.filter(f=>on(f)==="cd").length;x=r.tutoPending(v,k,m.length)}const u=(()=>{if(s!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(d===1){const m=n.filter(v=>v.kind==="target"&&ze(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=Pi(d);return t.jsxs("div",{ref:l,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Zt[d]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const an=600,St=62,Wr="atl2:fstats";function Rd(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=V(),[s,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Wr)==="on"}catch{return!1}}),c=r.stats,h=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((N,C)=>Math.max(N,C.s||0),0),m=h.length?an/h.length:0,v=Math.max(4,m-4),k=h.length>=5&&b>0,f=r.marketEstimate||0,y=x(new Date().toISOString().slice(0,10)),j=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&d&&w.push({cle:"fenetre",periode:e.funPerWindow(x(d),y),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:j(c.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[w.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([C,S],T)=>t.jsxs("span",{className:"fst-t",children:[T>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(C)}),t.jsx("i",{children:S})]},N.cle+S)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),N.cle===w[w.length-1].cle&&k&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const C=!s;l(C),C&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Wr,C?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},N.cle)),s&&k&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${an} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((N,C)=>{const S=(N.s||0)/b*(St-4),T=(N.m||0)/b*(St-4),A=C*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:St-2-S,width:v,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:St-2-T,width:v,height:T,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:an,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const $o={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Mn({o:e,locked:a=!1}){const{t:r}=V(),n=ia(e),o=wt(e),i=ze(e),s=on(e),l=Bi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+($o[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(tl,{o:e})]})}const Bt=e=>e.length>22?e.slice(0,21)+"…":e;function oa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Uo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Fd({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const s=()=>{var m,v,k;const l=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const h=l.getBoundingClientRect(),d=c?c.getBoundingClientRect().bottom:h.top;i({top:Math.round(d),left:Math.round(h.left),width:Math.round(h.width)});const x=[...l.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const y=f.querySelector(".grp-h");y&&y.getBoundingClientRect().bottom<=d+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((k=b.querySelector(".s"))==null?void 0:k.textContent)||"").trim()})};return s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",s),window.removeEventListener("resize",s)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Md(e){const r=()=>{const n=Uo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Gr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=V(),[i,s]=p.useState(!1);if(p.useEffect(()=>{n||s(!1)},[n]),Ie(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}function On({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:s,doPromote:l,doRepeche:c,doApproach:h,dispatch:d,liveMemos:x}=V(),u=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=u(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=ze(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Sa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Gr,{o:e})});const b=ze(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Gr,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:u(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>h(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Od({o:e}){const{t:a,doThumb:r,thumbOf:n}=V(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Dd({o:e}){const{lang:a}=V();return Me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(yt,{o:e}),t.jsx(Ia,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[At(e.engine||"")," ",Qe(e.engine||"",a)]})})}function Id({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:s,fresh:l}){const{dispatch:c,caps:h,markRow:d,markedId:x,favIds:u,toggleFav:b,t:m}=V(),v=ze(e),k=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,y=f<=0?0:f<=7?1:f<=30?2:3,j=h.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:k[y],w=u.has(e.id),N=C=>{if(a)return;if(s){s(e.id);return}if(h.pipe||e.kind==="op"){n();return}const S=C.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(h.pipe&&e.kind==="target"?" p"+v:"")+(w?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(Yo,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),Me(e)&&t.jsx(yt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[h.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:w?1:.35,padding:0,marginRight:4},onClick:C=>{C.stopPropagation(),b(e)},children:w?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ve(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(C=>C&&C!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:C=>{C.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Bt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(Pd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Dd,{o:e}),h.pipe&&t.jsx(Mn,{o:e,locked:a}),h.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(On,{o:e}),h.showThumbs&&t.jsx(Od,{o:e})]}),r&&!a&&!s&&t.jsx($d,{o:e})]})}function Pd({o:e}){const{lang:a,caps:r}=V();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ut(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Bd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=V(),s=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Ut(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ie(e),x=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Ve(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),oa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Bt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(sa,{spec:e.card})})]})}function _d({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=V();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Qe(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(On,{o:e})}),t.jsx(Fn,{o:e})]})}function Ho({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:s,caps:l,dossiers:c}=V(),h=p.useRef(null),d=We(e);if(p.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const g=h.current;if(!g)return;let q=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async P=>{await P.ensureEditoCss(),!(q||!g.isConnected)&&(P.beautifyEditoRows(g),P.mountCardFits(g))}),()=>{q=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const g=c.find(We);if(g)return t.jsx(Ho,{o:g})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!x||Ea(x),k=(e==null?void 0:e.engine)||"",f=We(e),y=e?Ut(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(We),C=((N==null?void 0:N.url)||"").trim(),S=!!u&&!!C&&(u===C||u.endsWith(C)||C.endsWith(u)),T=(g,q=!1)=>P=>{P.stopPropagation(),q&&s({type:"continent",key:"monde"}),s({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const A=()=>{x&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:x}}))},R=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},M=()=>{oa({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},$=e?Ie(e):!1,L=$&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",F=f?r.doEdito.replace(/^📖\s*/,""):k?Qe(k,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[F,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(v||Sa({engine:k}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(sa,{spec:m})}),(u&&!S&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!S&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),s({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[$?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!v&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:g=>{g.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Bt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(v||Sa({engine:k}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&x?" ghost":""),onClick:g=>{g.stopPropagation(),M()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Bt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&x&&l.pipe&&t.jsx(Rn,{name:x})]})]})}function $d({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:s}=V();return!o.pipe&&e.kind==="op"?t.jsx(Bd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Fn,{o:e}),t.jsx(al,{o:e}),t.jsx(ol,{o:e}),t.jsx(Rn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Mn,{o:e})})]}),e.card&&t.jsx(sa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[At(e.engine||"")," ",Qe(e.engine||"",r)]}),Me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(yt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function Ud({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:s,doDecide:l,lang:c}=V();if(!s.pipe&&e.kind==="op"){const x=Ut(e.amountEur,c),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>k=>{k.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(sa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[At(e.engine||"")," ",Qe(e.engine||"",c)]}),Me(e)&&t.jsx(yt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(On,{o:e})})]})}const h=ze(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Mn,{o:e}),Me(e)&&t.jsx(yt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&s.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function Hd(){const{t:e}=V(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Vd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=V(),i=o==="en",s=d=>n.plabels[d]||"",l=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=l.includes(0)?0:l.sort((d,x)=>(e[x]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:i?`${h} ${h>1?"files":"file"} in “${s(c)}”`:`${h} dossier${h>1?"s":""} dans « ${s(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+s(c)," →"]})]})}function Wd(){var bt,Ft,Nt,Re,nt;const e=V(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:s,scopedAll:l,markRow:c,lang:h,sessTally:d,data:x,dossiers:u,source:b,focusExtra:m,byId:v,token:k}=e,f=co(),y=p.useMemo(()=>{var H,ae,ye,D;if(!k||b==="ops")return null;const z=(((H=f==null?void 0:f.ed)==null?void 0:H.date)||(f==null?void 0:f.day)||"").slice(0,10),_=[(ae=f==null?void 0:f.ed)==null?void 0:ae.html,(ye=f==null?void 0:f.ed)==null?void 0:ye.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((D=f==null?void 0:f.ed)==null?void 0:D.date)||z,decryptHtml:_||void 0,date:z,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[k,b,h,(bt=f==null?void 0:f.ed)==null?void 0:bt.html,(Ft=f==null?void 0:f.ed)==null?void 0:Ft.acquirers_html,(Nt=f==null?void 0:f.ed)==null?void 0:Nt.date,f==null?void 0:f.day]),j=z=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:lo,[w,N]=p.useState(new Set);p.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[C,S]=p.useState(null);p.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[T,A]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){A(!1);return}const z=document.getElementById("atl2-stage");if(!z){A(!1);return}const _=new IntersectionObserver(([H])=>A(!!H&&H.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return _.observe(z),()=>_.disconnect()},[a.mapFolded]);const R=a.mapFolded||!T,M=z=>N(_=>{const H=new Set(_);return H.has(z)?H.delete(z):H.add(z),H}),$=b==="ops"||o.pipe,[L,F]=p.useState("all"),[g,q]=p.useState(!1),[P,J]=p.useState(null),[I,O]=p.useState(!1),B=p.useRef(!0);p.useEffect(()=>{if(B.current){B.current=!1;return}F("all"),O(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!I)return;const z=_=>{var H,ae;(ae=(H=_.target)==null?void 0:H.closest)!=null&&ae.call(H,".atl2 .doable")||O(!1)};return document.addEventListener("click",z,!0),()=>document.removeEventListener("click",z,!0)},[I]);const W=p.useMemo(()=>{var _;const z=new Map;for(const H of _s(((_=f==null?void 0:f.ed)==null?void 0:_.html)||""))z.has(H.t)||z.set(H.t,H.html);return z},[(Re=f==null?void 0:f.ed)==null?void 0:Re.html]),K=p.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!W.size)return;const _=(z.name||"").trim().toLowerCase();if(_.length<3)return;const H=W.get(_);if(H)return H;for(const[ae,ye]of W)if(ae.includes(_)||_.includes(ae))return ye},[W]),{diff:X}=qd(),[ge,Y]=p.useState(!1),ce=a.filters.win==="1"&&!a.filters.day,[le,be]=p.useState(!1),me=p.useMemo(()=>new Set(((X==null?void 0:X.added)||[]).map(z=>z.trim().toLowerCase()).filter(Boolean)),[X]),de=p.useMemo(()=>{if(!me.size)return 0;const z={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(_=>!We(_)&&me.has((_.name||"").trim().toLowerCase())&&ea(_,z,o.pipe)).length},[u,me,a,o.pipe]);p.useEffect(()=>{const z=()=>{be(!1),q(!1),F("all"),O(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",z),()=>window.removeEventListener("ppmap:tunnel",z)},[]),p.useEffect(()=>{be(!1),q(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const pe=p.useMemo(()=>{const z=l.filter(H=>!We(H)&&Ve(H));let _="";for(const H of z){const ae=(H.date||"").slice(0,10);ae&&(!_||ae<_)&&(_=ae)}return{n:z.length,since:_?_.split("-").reverse().slice(0,2).join("/"):""}},[l]),xe=pe.n,G=p.useMemo(()=>{const _=le&&me.size>0||a.filters.signalOnly||L!=="all"||g?l:s;let H=zn(_,a.sort);return H=H.filter(ae=>!We(ae)),le&&me.size&&(H=H.filter(ae=>me.has((ae.name||"").trim().toLowerCase()))),g||L==="explore"?H=H.filter(Ve):L==="eval"?H=H.filter(ae=>!Ve(ae)&&!ae.noCo&&(ae.kind==="op"||!Ie(ae))):o.pipe&&(H=H.filter(ae=>!Ve(ae))),H},[s,l,a.sort,L,le,me,g,o.pipe]),fe=p.useMemo(()=>o.pipe?u.filter(z=>z.kind==="target"&&!We(z)&&Me(z)&&(a.continent==="monde"||z.continent===a.continent)):G.filter(z=>Me(z)&&!Ie(z)),[o.pipe,u,G,a.continent]).length,ke=p.useMemo(()=>o.pipe?G:G.filter(z=>!Ie(z)&&!z.noCo&&!Ve(z)),[G,o.pipe]),ne=b==="ops"?G.filter(Ve).length:0,ve=le?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,oe=a.filters,Ee=[];if(oe.day)Ee.push({k:"day",lib:n.fDay(oe.day.slice(8,10)+"/"+oe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(oe.win&&oe.win!=="all"){const z=["1","7","30"].indexOf(oe.win);z>=0&&Ee.push({k:"win",lib:n.dates[z],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ke=z=>z.length<=2?z.join(", "):`${z.length} ${n.fSelected}`;for(const z of["sector","country","engine"]){const _=oe[z];_&&_.length&&Ee.push({k:z,lib:Ke(_),off:()=>r({type:"clearFacet",facet:z})})}oe.search&&Ee.push({k:"search",lib:"🔍 "+oe.search,off:()=>r({type:"filters",patch:{search:""}})}),le&&me.size&&Ee.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>be(!1)}),oe.signalOnly&&Ee.push({k:"sig",lib:"🔴 "+n.sigDock(fe||oe.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const he=(z,_,H="",ae=!1)=>t.jsxs("button",{type:"button","data-s":z,className:H,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:ae?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[_,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),Se=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const z=new Map;G.forEach(ae=>{const ye=ae.engine||"?";z.has(ye)||z.set(ye,[]),z.get(ye).push(ae)});const _={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},H=rn([...z.keys()],h);return[...z.entries()].sort((ae,ye)=>{const D=_[ae[0]]??10+H.indexOf(ae[0]),ee=_[ye[0]]??10+H.indexOf(ye[0]);return D-ee})},[G,o.pipe,a.groupBy,h]),Rt=Se?Se.filter(([z])=>ya.has(z)).length:0,Pe=(()=>{var _;return((_=(Se?Se.flatMap(([,H])=>H):G)[0])==null?void 0:_.id)??null})(),Je=p.useRef(!1),qe=p.useMemo(()=>u.find(We)||y,[u,y]);p.useEffect(()=>{const z=()=>{Je.current=!0,be(!1)};return window.addEventListener("ppmap:reveal",z),window.addEventListener("ppmap:focus",z),()=>{window.removeEventListener("ppmap:reveal",z),window.removeEventListener("ppmap:focus",z)}},[]),p.useEffect(()=>{const z=()=>{qe&&r({type:"focus",id:qe.id})};return window.addEventListener("ppmap:edito",z),()=>window.removeEventListener("ppmap:edito",z)},[qe,r]),p.useEffect(()=>{if(!a.focusId)return;J(a.focusId);const z=window.setTimeout(()=>J(null),900);return()=>window.clearTimeout(z)},[a.focusId]),p.useEffect(()=>{if($&&!(a.focusId&&(G.some(z=>z.id===a.focusId)||u.some(z=>z.id===a.focusId)||a.focusId===(qe==null?void 0:qe.id)))&&!m){if(qe){r({type:"focus",id:qe.id});return}Pe&&r({type:"focus",id:Pe})}},[$,a.focusId,G,Pe,m,r,u,b,qe]),p.useEffect(()=>{if(!$||!a.focusId||qe&&a.focusId===qe.id||G.some(_=>_.id===a.focusId))return;const z=u.find(_=>_.id===a.focusId);if(z){if(Je.current){z.kind==="op"?F(Ve(z)?"explore":"eval"):L!=="all"&&F("all");return}L!=="all"&&Pe&&r({type:"focus",id:Pe})}},[$,a.focusId,L,G,u,Pe,r,qe]),p.useEffect(()=>{if(!$||!a.focusId||!Je.current)return;const z=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!z){const ye=G.findIndex(D=>D.id===a.focusId);if(ye>=0){const D=Se?"":"pt"+a.ptab;if(D){const ee=a.shown[D]||j();ye>=ee&&r({type:"more",group:D,by:ye-ee+8})}}return}Je.current=!1;const _=Uo(),H=z.getBoundingClientRect();H.top>=_-2&&H.bottom<=window.innerHeight-4||Md(z)},[$,a.focusId,a.ptab,G,a.shown,Se,r]),p.useEffect(()=>{if(typeof window>"u")return;const z=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),_=document.querySelector(".atl2.ops, .atl2.cibles");if(!z||!_)return;const H=()=>_.style.setProperty("--listhead-h",`${z.offsetHeight}px`);H();const ae=new ResizeObserver(H);return ae.observe(z),()=>ae.disconnect()},[R,a.dens,a.mapFolded]);const it=p.useMemo(()=>{if(!$||!a.focusId)return null;if(y&&a.focusId===y.id)return y;const z=G.find(H=>H.id===a.focusId)||u.find(H=>H.id===a.focusId)||null;if(!z)return null;const _=K(z);return _&&_!==z.decryptHtml?{...z,decryptHtml:_}:z},[$,a.focusId,G,u,K,y]),kt=o.lockRowsAfter;let Oe=0;const xt=(z,_)=>{let H=a.shown[_]||j();return z.length-H<=4&&(H=z.length),z.slice(0,H).map(D=>{const ee=kt!==null&&Oe>=kt;Oe++;const ie=K(D),Z=ie&&ie!==D.decryptHtml?{...D,decryptHtml:ie}:D,je=!$&&a.dens!=="maxi"&&(a.dens==="deplie"||(C?C==="open":!!ie)),De=w.has(D.id)?!je:je,$e=$?Ae=>{Je.current=!0,r({type:"focus",id:Ae});const Ue=v.get(Ae);Ue&&(Ve(Ue)?oa(Ue):Ue.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ue.name,url:Ue.url||"",website:Ue.website||"",domain:Ue.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Ud,{o:Z,locked:ee,selected:$&&a.focusId===D.id,onSelect:$e},D.id):t.jsx(Id,{o:Z,locked:ee,open:De,onToggle:()=>M(D.id),selected:$&&a.focusId===D.id,echo:P===D.id,fresh:me.has((D.name||"").trim().toLowerCase()),onSelect:$e},D.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(G.length?"":" list-empty"),Xe=t.jsxs(t.Fragment,{children:[Se?Se.map(([z,_])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:At(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:z==="ma"?n.grpMa:z==="fundraising"?n.grpLev:ya.has(z)&&Rt<=1?n.grpNews:z==="nominations"?n.grpNom:z==="media"?n.grpNewsOther:z==="recrutements"?n.grpHire:ya.has(z)?n.grpNews+" · "+Qe(z,h):Qe(z,h)}),t.jsx("div",{className:"s",children:n.grpCount(_.filter(H=>!Ie(H)).length,_.length)})]})]}),xt(_,z)]},z)):xt(G,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Hd,{}),o.pipe&&a.ptab===0&&!g&&!le&&L==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(Io,{}),!G.length&&!(x.loading&&!u.length)&&(o.pipe&&L==="all"?t.jsx(Vd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),jt=t.jsxs(t.Fragment,{children:[!le&&!g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:G.length})," ",ve]}),g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:G.length})," ",n.newsWord]}),(!le||g)&&t.jsx("span",{className:"dot",children:"·"}),R&&t.jsx(Oo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[R?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),Ee.map(z=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:_=>{_.stopPropagation(),z.off()},children:[z.lib,t.jsx("i",{children:"×"})]},z.k)),b==="ops"&&G.length>0&&!R&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",G.length-ne," ",n.zoomPulseEval,ne>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",ne," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),gt=t.jsxs("div",{className:"listhead"+(R?" mapoff":""),children:[R&&t.jsx("div",{className:"lh-tools",children:t.jsx(Mo,{compact:!0})}),o.showFunnel&&ge&&ce&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(sl,{}),t.jsx(Rd,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:jt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Td,{}),t.jsx(Ld,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ce?" on":""),"aria-pressed":ce,title:n.morningDockTitle,onClick:()=>{if(ce){r({type:"filters",patch:{win:"all",day:""}}),Y(!1);return}be(!1),q(!1),F("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),Y(!0)},children:["📊 ",n.morningDock(typeof((nt=x.stats)==null?void 0:nt.screened_today)=="number"?x.stats.screened_today:0)]}),X&&!X.firstVisit&&(X.added.length>0||X.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(le?" on":""),"aria-pressed":le,title:n.sinceSub,onClick:()=>{const z=!le;be(z),q(!1),Y(!1),F("all"),z&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(de),X!=null&&X.lastDate?` · ${n.sinceSince(X.lastDate)}`:""]}),fe>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{be(!1),q(!1),Y(!1),F("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(fe)]}),o.pipe&&xe>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(g?" on":""),"aria-pressed":g,title:n.newsDockHint,onClick:()=>{const z=!g;q(z),be(!1),Y(!1),F("all"),z&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(xe),pe.since?` · ${n.newsSince(pe.since)}`:""]})]}),!o.showFunnel&&jt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,_])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:_})]},z))}),!$&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":C==="open",onClick:()=>{S("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":C==="closed",onClick:()=>{S("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var ie;const z={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},_=u.filter(Z=>ea(Z,z,o.pipe)&&!We(Z)),H=_.filter(Z=>!Ve(Z)&&!Z.noCo&&(Z.kind==="op"||!Ie(Z))).length,ae=_.filter(Ve).length,ye=o.pipe?_.filter(Z=>Z.kind!=="op"&&ze(Z)===1).length:0,D=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ye?` ${ye}`:""}`]]:[],["eval",`${n.doEval}${H?` ${H}`:""}`],["explore",`${n.doExplore}${ae?` ${ae}`:""}`]],ee=((ie=D.find(([Z])=>Z===L))==null?void 0:ie[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":I,onClick:()=>O(Z=>!Z),children:[ee,t.jsx("i",{children:"▾"})]}),I&&t.jsx("div",{className:"dolist",children:D.map(([Z,je])=>t.jsx("button",{type:"button","aria-pressed":L===Z,onClick:()=>{if(O(!1),Z==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}F(Z),Z!=="all"&&(be(!1),q(!1),Y(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:je},Z))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([z,_])=>t.jsx("option",{value:z,children:_},z))})]}),o.showChain&&ke.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ke.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ke.length):n.chainAll(ke.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!$&&gt,a.dens!=="maxi"&&!$&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),he("country",n.colCountry),he("name",n.colCompany),he("amount",n.colAmount,"h-amt",!0),he("stage",n.colStage,"h-stade"),he("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[he("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),he("memo",n.colMemo)]}),o.pipe&&he("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),$?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[gt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),he("country",n.colCountry),he("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[he("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),he("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:Xe})]}),t.jsxs("aside",{className:"readpane"+((it?We(it):!m&&qe)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[qe&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===qe.id,onClick:()=>r({type:"focus",id:qe.id}),children:n.doEdito}),y&&a.focusId===y.id?t.jsx("div",{className:"zoom",children:t.jsx(Ws,{})}):it&&o.pipe?t.jsx(_d,{o:it}):t.jsx(Ho,{o:it,extra:it?null:m})]})]}):t.jsx("div",{className:ut,children:Xe}),(()=>{const z=Se||[["pt"+a.ptab,G]];let _=0,H=0;for(const[ye,D]of z){H+=D.length;let ee=a.shown[ye]||j();D.length-ee<=4&&(ee=D.length),_+=Math.min(D.length,ee)}const ae=H-_;return ae<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([ye,D])=>r({type:"more",group:ye,by:D.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(ae,ae)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(_,H)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),$&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Fd,{on:!!Se,rev:(Se||[]).map(([z,_])=>z+_.length).join("|")})]})}function Yr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Gd(e,a){const r=_i(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Yd(e,a){const n=[a.head.split("|").map(Yr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Gd(o,a.plabels),ia(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Yr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Qd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Kd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Jd({o:e,qa:a}){const{t:r,lang:n,fund:o}=V(),i=(e.cribleStatus||"").trim().toUpperCase()||(ia(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=wt(e),l=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:Kd(e.date,n)})]}),c.some(([,h])=>h)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,h])=>h).map(([h,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:h}),t.jsx("p",{children:d})]},h))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Xd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:s}=V(),[l,c]=p.useState({}),h=25,d=p.useMemo(()=>n.slice(0,h),[n]);p.useEffect(()=>{d.length&&ro(r,d.map(b=>b.name)).then(c)},[r,d]);const x=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>h&&t.jsx("span",{className:"mnote dim",children:e.dsCap(h,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(Jd,{o:b,qa:l[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Zd=50;function Dn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=V(),[i,s]=p.useState(null),[l,c]=p.useState(!1),[h,d]=p.useState(""),[x,u]=p.useState(0),[b,m]=p.useState(""),[v,k]=p.useState(!1),[f,y]=p.useState(0),j=p.useRef(null),w=p.useRef(null),N=()=>{y(0),w.current&&window.clearInterval(w.current),w.current=window.setInterval(()=>y(A=>A+1),1e3)},C=()=>{w.current&&(window.clearInterval(w.current),w.current=null)};p.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),w.current&&window.clearInterval(w.current)},[]);const S=async A=>{c(!0),d(""),N();const R=await a();if(c(!1),C(),R.ok){s(R);return}if(R.busy){d(o.alertPreviewBusy);return}if(!A){d(o.alertPreviewFail);return}u(Zd),C(),j.current=window.setInterval(()=>{u(M=>M>1?M-1:(j.current&&window.clearInterval(j.current),S(!1),0))},1e3)},T=async()=>{if(n||v||l)return;k(!0),m(""),N();const A=await r();k(!1),C(),m(A.ok?o.alertTestOk(A.sentTo||""):A.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||v||x>0,onClick:()=>{S(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||l,onClick:()=>{T()},children:v?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),h&&t.jsx("p",{className:"mnote warn",children:h}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const zt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ge({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=V();return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function ec(){const{st:e}=V();switch(e.modal){case"chain":return t.jsx(ac,{});case"space":return t.jsx(nc,{});case"alert":return t.jsx(rc,{});case"queue":return t.jsx(dc,{});case"export":return t.jsx(cc,{});case"plug":return t.jsx(mc,{});case"recharge":return t.jsx(xc,{});case"cover":return t.jsx(bc,{});case"dossier":return t.jsx(gc,{});case"crit":return t.jsx(vc,{});case"tuto":return t.jsx(yc,{});case"rdv":return t.jsx(tc,{});case"memoalert":return t.jsx(pc,{});default:return null}}function tc(){const{dispatch:e,fund:a,t:r}=V(),n=a||r.rdvCoFallback;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:mo,children:qn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],s)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(s+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(ps,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function ac(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:s,evalBusy:l,caps:c,memoQueued:h,doAnalyse:d}=V(),x=i==="client",u=e.chain.queue.map(k=>r.get(k)).filter(k=>!!k),b=e.chain.idx,m=u[b],v=b>=u.length;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[$t(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(ht(m.date))].filter(Boolean).map(k=>String(k).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Qe(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Ut(m.amountEur,o)})]}),Me(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(yt,{o:m,lg:!0})," ",t.jsx(Ia,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&Ie(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&Ie(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Ct(m)==="retenu"?"var(--brand)":Ct(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ct(m)==="retenu"?"✓ "+n.kept:Ct(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&c.pipe&&ze(m)===1&&!h.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(x&&Ie(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var k;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(k=document.querySelector(".atl2 .demand"))==null||k.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function nc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=V(),i=o==="client",s=p.useMemo(()=>i?r.filter(x=>Ie(x)):[],[r,i]),l=p.useMemo(()=>zn(s.filter(x=>Ct(x)==="retenu"),{key:"signal",dir:-1}),[s]),c=p.useMemo(()=>s.filter(x=>Ct(x)==="ecarte"),[s]),h=e.spaceTab==="retenu"?l:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ge,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function rc(){const{mode:e}=V();return e==="client"||e==="apercu"?t.jsx(oc,{}):t.jsx(lc,{})}function oc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),[i,s]=p.useState("d"),l=o!=="client";return t.jsxs(Ge,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(ic,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(sc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(Vo,{})]})}function ic({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,c]=p.useState(!1),[h,d]=p.useState(0);p.useEffect(()=>{let T=!0;return c(!1),Zn(a).then(A=>{T&&(A?s(A):c(!0))}),()=>{T=!1}},[a,h]);const x=p.useRef({}),[u,b]=p.useState({}),[m,v]=p.useState(!1),[k,f]=p.useState(!1),y=p.useRef(null);p.useEffect(()=>()=>{y.current&&window.clearTimeout(y.current)},[]);const j=T=>{const A=x.current;Object.keys(A).length&&(v(!0),Zn(a,A).then(R=>{if(!R){v(!1),o(e.actErr);return}if(R.throttled&&T<3){y.current=window.setTimeout(()=>j(T+1),5400);return}if(x.current={},b({}),s(R),v(!1),R.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},w=T=>{r||(x.current={...x.current,...T},b(A=>({...A,...T})),y.current&&window.clearTimeout(y.current),y.current=window.setTimeout(()=>j(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(T=>T+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...u},C=T=>!N.sections||N.sections.includes(T),S=T=>{const A=N.sections||e.alertSec.map(([R])=>R);w({sections:C(T)?A.filter(R=>R!==T):[...A,T]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>w({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>w({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&k&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([T,A])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:C(T),disabled:r,onChange:()=>S(T)}),t.jsxs("span",{children:[A,T==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},T))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Dn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ji(a),onTest:()=>Ki(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function sc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,c]=p.useState(!1),[h,d]=p.useState(0);p.useEffect(()=>{let m=!0;return c(!1),er(a).then(v=>{m&&(v?s(v):c(!0))}),()=>{m=!1}},[a,h]);const x=m=>{r||er(a,m).then(v=>{if(!v){o(e.actErr);return}s(v),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Dn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Zi(a),onTest:()=>Xi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Vo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=V(),[s,l]=p.useState(i||""),[c,h]=p.useState(!1),[d,x]=p.useState(!1);p.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(f=>Me(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(s)||d)){x(!0);try{await fetch(`${Da}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{x(!1)}}},k=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Qe(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>$t(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:k.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function lc(){const{t:e}=V();return t.jsx(Ge,{title:e.alertTitle,icon:"🔔",children:t.jsx(Vo,{})})}function dc(){var M,$;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:s,caps:l,dispatch:c,liveMemos:h}=V(),[d,x]=p.useState(()=>$a(r)),[u,b]=p.useState(()=>!$a(r)),[m,v]=p.useState([]),[k,f]=p.useState(0),y=n==="client",j=p.useMemo(()=>{const L=new Map;return o.forEach(F=>{const g=(F.name||"").trim().toLowerCase();g&&!L.has(g)&&L.set(g,F)}),L},[o]);p.useEffect(()=>{let L=!0;return(!$a(r)||k>0)&&b(!0),(async()=>{const[F,g]=await Promise.all([En(r,k>0),eo(a)]);L&&(F&&x(F),b(!1),v(g))})(),()=>{L=!1}},[a,r,k]);const w=u&&!d,N=(d==null?void 0:d.per_day)??0,C=((M=d==null?void 0:d.analyzed_today)==null?void 0:M.length)??0,S=d==null?void 0:d.offre,T=(d==null?void 0:d.pool_meta)||[],A=p.useMemo(()=>{const L=new Map;for(const F of(d==null?void 0:d.scheduled)||[])for(const g of F.names||[])L.has(g)||L.set(g,{label:F.day_label,date:F.date});return L},[d==null?void 0:d.scheduled]),R=(d==null?void 0:d.in_progress)||[];return t.jsxs(Ge,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:w?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(C,C+((($=d==null?void 0:d.pool_order)==null?void 0:$.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!w&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(R.length>0||h.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(Na,{item:L,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),R.filter(L=>!h.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(L.memo_type)}),y&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Jn(a,L.company,"retry").then(()=>f(F=>F+1))},children:e.queueRetry}),y&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Jn(a,L.company,"delete").then(()=>f(F=>F+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",w?e.qUpNextWait:e.qUpNext(T.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[w&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!w&&T.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),T.map((L,F)=>{const g=A.get(L.name),q=j.get((L.name||"").trim().toLowerCase()),P=h.liveOf(L.name),J=!!(q&&s.has(q.id))||!!(P&&(P.status==="boot"||P.status==="running")),I=!!(q&&ze(q)===1&&!q.memoUrl)&&!P;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",F+1]}),g?t.jsx("span",{className:"qwhen"+(g.label==="demain"?" soon":""),children:g.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),P&&(P.status==="boot"||P.status==="running")&&t.jsx(Na,{item:P,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),I&&(l.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:J,onClick:()=>{i(q),f(O=>O+1)},children:J?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+F)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,F])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",F]},L))})]})}function cc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:s}=V(),l=`${zt}/cibles/list.csv?token=${a}`,c=`${zt}/cibles/list.json?token=${a}`,h=`${zt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${l}")`,x=k=>{var f;(f=navigator.clipboard)==null||f.writeText(k).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:h,href:h}],b=!o.lockActions&&n.length>0,m=()=>{Qd(Yd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:k=>(e.stg.find(([f])=>f===k)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ge,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:k,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:k[0]}),t.jsxs("div",{children:[t.jsx("b",{children:k[1]}),t.jsx("p",{children:k[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},k[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function pc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),i=o!=="client",[s,l]=p.useState(null),[c,h]=p.useState(!1),[d,x]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return h(!1),Qn(a).then(y=>{f&&(y?l(y):h(!0))}),()=>{f=!1}},[a,d]);const m=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(i||!s)return;const y={enabled:f.enabled??!!s.enabled,email:f.email??(s.email||""),sections:f.sections??m()};b(!0),Qn(a,y).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}l(j),r(e.memoAlertSaved)})};if(c)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!s)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const k=m();return t.jsxs(Ge,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:i||u,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(uc,{value:s.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!k[f],disabled:i||u,onChange:()=>v({sections:{...k,[f]:!k[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Dn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Ui(a,k),onTest:()=>$i(a,k)})]})}function uc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,s]=p.useState(e);p.useEffect(()=>{s(e)},[e]);const l=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:h=>s(h.target.value),onKeyDown:h=>{h.key==="Enter"&&l&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!c,onClick:()=>o(i.trim()),children:n})]})]})}function mc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=V(),[i,s]=p.useState(null),[l,c]=p.useState(!1),[h,d]=p.useState(null),[x,u]=p.useState(!1),[b,m]=p.useState(""),[v,k]=p.useState(0),[f,y]=p.useState("webhook"),[j,w]=p.useState(""),N=p.useRef(!1);p.useEffect(()=>{let M=!0;return c(!1),Kn(a).then($=>{M&&($?s({configured:$.configured,url_hint:$.url_hint}):c(!0))}),Wi(a).then($=>{if(M){if(!$){u(!0);return}u(!1),d($),N.current||(N.current=!0,$.destination==="instantly"&&y(L=>L==="webhook"?"instantly":L),$.campaign_id&&w(L=>L||$.campaign_id||""))}}),()=>{M=!1}},[a,v]);const C=(M,$)=>{o&&Kn(a,M).then(L=>{if(!L||L.ok===!1){n(e.actErr);return}M.test&&L.sent===!1?n(e.plugTestThrottled):r($),k(F=>F+1)})},S='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',T=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),A=`curl -X POST ${zt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,R=`curl -X POST ${zt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ge,{title:e.plugTitle,icon:"🔌",wide:!0,children:[h&&t.jsx("p",{className:"mnote"+(h.enabled?" warn":""),children:h.enabled?e.plugAutoOn(h.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>k(M=>M+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:M=>m(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>C({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>C({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>C({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:T}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(T).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(hc,{destKind:f,setDestKind:y,camp:j,setCamp:w,whHint:i!=null&&i.configured?i.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(fc,{auto:h,autoKo:x,destKind:f,camp:j,onRetry:()=>k(M=>M+1),onDone:M=>{d(M),u(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:A}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(A).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:R}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var M;(M=navigator.clipboard)==null||M.writeText(R).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function fc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:s,token:l,flash:c,flashErr:h,canWrite:d}=V(),[x,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:s.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[s.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:s.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?s.plugAutoNeed:"":n.trim()?"":s.plugCampNeed),v=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,k=()=>{if(x||!d||m)return;u(!0),(b?Xn(l,!1):Xn(l,!0,r,n.trim()||void 0)).then(y=>{if(u(!1),!y){h(s.actErr);return}o(y),c(y.enabled?s.plugAutoSavedOn:s.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:s.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:s.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!d||!!m,onClick:k,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:s.plugAutoOnLbl})]}),!!m&&t.jsx("p",{className:"mnote warn",children:m}),v&&t.jsx("p",{className:"mnote warn",children:s.plugAutoBroken})]})}function hc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:s,lang:l,canWrite:c}=V(),[h,d]=p.useState("valides"),[x,u]=p.useState(!1),[b,m]=p.useState(null),[v,k]=p.useState(null),[f,y]=p.useState(!1),[j,w]=p.useState(!1),[N,C]=p.useState(null),[S,T]=p.useState(null),A=`atl2:bulk:${s}:${h}:${e}`;p.useEffect(()=>{m(null),k(null),y(!1),C(null);try{const O=localStorage.getItem(A)||localStorage.getItem(`atl2:bulk:${s}:${h}`),B=JSON.parse(O||"null");T(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{T(null)}},[A,h,s]);const R=e==="instantly"&&!r.trim(),M=`${h}|${e}|${r.trim()}`,$=async()=>{if(R||!c)return;u(!0),y(!1),C(null);const O=await Yi(s,h,e,r.trim()||void 0);m(O),k(O.ok?M:null),u(!1)},L=p.useRef(!1);if(!c)return null;const F=async()=>{if(L.current||!c)return;L.current=!0,w(!0);const O=`${s}:${h}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let B;try{B=await Qi(s,h,e,r.trim()||void 0,O)}finally{L.current=!1}if(w(!1),y(!1),C(B),B.ok&&(B.pushed||0)>0){const W={t:new Date().toISOString(),n:B.pushed||0};T(W);try{localStorage.setItem(A,JSON.stringify(W))}catch{}}};f&&v!==null&&v!==M&&y(!1);const g=o,q=b!=null&&b.ok&&b.ready||0,P=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":g||"",J=!!(b!=null&&b.ok)&&v===M&&q>0&&!!P&&!S,I=S?new Date(S.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:h,onChange:O=>d(O.target.value),children:i.plugBulkTabs.map(([O,B])=>t.jsx("option",{value:O,children:B},O))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:O=>a(O.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:O=>n(O.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||R,onClick:()=>{$()},children:x?"…":i.plugBulkPreview})]}),R&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),S&&t.jsx("p",{className:"mnote",children:i.bulkLocked(I,S.n)}),!S&&!!(b!=null&&b.ok)&&!P&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!S&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),J&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>y(!0),children:i.bulkArm}),J&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(q,P)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{F()},children:j?i.bulkSending:i.bulkConfirm(P)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>y(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function xc(){const{t:e,data:a,lang:r}=V(),n=a.credits,o=a.email,i=async s=>{if(!o)return;const l=window.location.href.split("?")[0];try{const h=await(await fetch(`${Da}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Ge,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function gc(){const{t:e}=V();return t.jsx(Ge,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Xd,{})})}function bc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:s,flash:l}=V(),[c,h]=p.useState(null),[d,x]=p.useState(!1);p.useEffect(()=>{let A=!0;if(i)return En(i).then(R=>{A&&R&&typeof R.per_day=="number"&&h(R.per_day)}),()=>{A=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let A=!0;return Vi(o).then(R=>{A&&b(R)}),()=>{A=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(A=>A.kind==="target"&&Ie(A)).length,k=r.marketEstimate||0,f=k>0?Math.min(100,Math.round(v/k*100)):null,y=(m==null?void 0:m.window_days)||30,j=v>0?v/y:0,w=k>0?Math.max(0,k-v):0,C=k>0&&j>0&&v>=100?Math.round(w/j):null,S=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),T=A=>{d||!s||(x(!0),Gi(o,A).then(R=>{if(x(!1),R===null){l(e.actErr);return}h(R),l(e.alertSaved)}))};return t.jsxs(Ge,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(v))}),k>0&&t.jsx("span",{children:e.covOf(S(k))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),C!==null&&t.jsx("p",{className:"mnote",children:e.covEta(C)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(j))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((A,R)=>t.jsxs("tr",{className:A.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[A.code,A.geo?` · ${A.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof A.n=="number"?S(A.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:A.source}),A.elargi&&t.jsx("em",{children:e.covWide(String(A.demande||""))}),A.erreur&&t.jsx("em",{children:e.covMissing})]})]},R)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(u.total||k)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),s&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:c===A?"on":"",disabled:d,onClick:()=>T(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function vc(){var f,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:s,lang:l}=V(),c=n==="client",h=p.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[d,x]=p.useState(""),[u,b]=p.useState(""),[m,v]=p.useState(!1),k=async()=>{const w=d.trim();if(!(!w||m||!c)){v(!0),b("");try{const C=await(await fetch(`${zt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&b(String(C.reply)),C.job_id){b(e.critChatRunning);const S=async()=>{const T=await fetch(`${zt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(A=>A.json()).catch(()=>null);if(T&&T.done){b(String(T.reply||T.clarification||T.summary||"✓")),v(!1),T.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs(Ge,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var N,C;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((C=w.out)!=null&&C.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},w.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||m,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&k()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!d.trim(),onClick:()=>void k(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Hi,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+($o[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function yc(){const{t:e,dispatch:a,startTour:r}=V(),n=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(Ge,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const Wo="atl2:mapfold",wc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Wo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},kc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Go=p.createContext(null),V=()=>{const e=p.useContext(Go);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function yt({o:e,lg:a}){const{lang:r}=V(),n=Me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:tr(n,r),children:[n.emoji," ",tr(n,r)]}):null}function Ia({o:e,src:a}){const{lang:r,t:n}=V(),o=Me(e);if(!o)return null;const i=os(o),s=is(o);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(oo(o,r))+" · "+n.win7(io(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function jc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(s=>(s.url||"")===n);if(i)return i}const o=_e(a);if(o)return e.find(i=>_e(i.name)===o)||e.find(i=>{const s=_e(i.name);return s.length>=3&&(o.includes(s)||s.includes(o))})}function Nc(){const{scoped:e,t:a,st:r,dispatch:n}=V(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,s=e.filter(x=>!We(x)),l=s.length,c=s.filter(x=>!x.noCo).length,h=s.filter(x=>!!x.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function Ec(){const{t:e,lang:a,data:r,dispatch:n}=V(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const s=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:s>0?e.covOf(i(s)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function Yo({o:e}){const{lang:a}=V(),r=rs(e.cc),n=e.cc?$t(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Qr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Sc=!1;function Cc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Qo=e=>`atl2:tour:${e||"anon"}`;function zc(e){try{return localStorage.getItem(Qo(e))==="1"}catch{return!0}}function Kr(e){try{localStorage.setItem(Qo(e),"1")}catch{}}function Ac(e,a,r,n,o,i){const s=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Fc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var In;const{lang:s}=es(),l=Ns[s],c=Os(e,s,a),[h,d]=p.useReducer(Ps,void 0,()=>Ds((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?kc():wc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=p.useRef(!0);p.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Wo,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const E=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return E(),window.addEventListener("resize",E),()=>window.removeEventListener("resize",E)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var E;(E=u.current)==null||E.call(u,h.filters)},[h.filters]);const[b,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const E=localStorage.getItem("atl2:chrome-mode");if(E==="eval"||E==="filt"||E==="both")return E;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,k]=p.useState(null),[f,y]=p.useState(null),[j,w]=p.useState(null),[N,C]=p.useState({kept:0,dropped:0}),[S,T]=p.useState(!1),[A,R]=p.useState(""),[M,$]=p.useState(!1),[L,F]=p.useState(null),[g,q]=p.useState(!1),[P,J]=p.useState(!1),[,I]=p.useState(0),O=()=>I(E=>E+1),B=p.useRef([]),W=p.useRef(new Set),K=p.useRef(new Set),[X,ge]=p.useState([]),[Y,ce]=p.useState([]),[le,be]=p.useState(0),me=p.useRef(new Map),de=p.useRef(null),{mode:pe}=c,xe=p.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),G=xe.pipe,re=c.session.token||"",fe=pe==="client"&&!e;p.useEffect(()=>{if(!re||!G)return;let E=!0;const Q=async()=>{const se=await ss(re);!E||!se||(ce(se.runs),be(Date.now()/1e3-se.now),ge(He=>He.filter(Ne=>!se.runs.some(Be=>_e(Be.company)===_e(Ne.name)))))};Q();const U=X.length>0||Y.some(se=>se.status==="running"),te=window.setInterval(()=>{Q()},U?8e3:25e3);return()=>{E=!1,window.clearInterval(te)}},[re,G,X.length,Y.some(E=>E.status==="running")]);const ke=p.useMemo(()=>{const E=[],Q=new Set;for(const U of X){const te=_e(U.name);!te||Q.has(te)||(Q.add(te),E.push({name:U.name,id:U.id,status:"boot",started:U.started,estMin:U.estMin,memoType:"instant"}))}for(const U of Y){const te=_e(U.company);if(!te||Q.has(te))continue;Q.add(te);const se=U.status==="error"?"error":U.status==="done"?"done":"running";E.push({name:U.company,status:se,started:U.started||0,estMin:U.est_min||(U.memo_type==="detailed"?40:15),url:U.url,error:U.error,memoType:U.memo_type,note:U.note})}return E},[X,Y]),ne=E=>ke.find(Q=>_e(Q.name)===_e(E))||null,ve=(E,Q)=>{ge(U=>U.some(te=>_e(te.name)===_e(E.name))?U:[...U,{name:E.name,id:E.id,started:Date.now()/1e3,estMin:Q==="detailed"?40:15}]),W.current.add(E.id),O()};p.useEffect(()=>{if(document.querySelector(`link[href="${Qr}"]`))return;const E=document.createElement("link");E.rel="stylesheet",E.href=Qr,document.head.appendChild(E)},[]);const oe=(E,Q=!1)=>{R(E),$(Q),de.current&&clearTimeout(de.current),de.current=setTimeout(()=>R(""),Q?4200:2400)},Ee=E=>oe(E,!0),Ke=p.useMemo(()=>{const E=new Map;return c.dossiers.forEach(Q=>{Q.id&&E.set(Q.id,Q)}),E},[c.dossiers]),he=p.useMemo(()=>c.dossiers.filter(E=>ea(E,h,G)),[c.dossiers,h,G]),Se=p.useRef(!1);p.useEffect(()=>{if(Se.current||e||c.loading||!c.dossiers.length)return;if(!xe.showFunnel||zc(c.session.token||"")){Se.current=!0;return}Se.current=!0;const E=window.setTimeout(()=>{Kr(c.session.token||""),q(!0)},700);return()=>window.clearTimeout(E)},[e,c.loading,c.dossiers.length,xe.showFunnel,c.session.token]);const Rt=p.useMemo(()=>c.dossiers.filter(E=>Bs(E,h,G,c.favIds)),[c.dossiers,h,G,c.favIds]),Pe=p.useMemo(()=>ts(he.filter(E=>!Ve(E)),c.favIds),[he,c.favIds]),Je=p.useRef(!1);p.useEffect(()=>{if(Je.current)return;if(!G||a==="ops"){Je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Je.current=!0;return}if(c.loading)return;Je.current=!0;const E=as(Pe);E!==h.ptab&&d({type:"ptab",tab:E})},[G,a,n==null?void 0:n.ptab,c.loading,Pe,h.ptab]);const qe=p.useMemo(()=>{const E=ho(c.dossiers);return E?ht(E)===0?l.tourToday:xo(E,s):l.tourNoRun},[c.dossiers,l,s]),it=p.useMemo(()=>c.dossiers.some(E=>!!E.memoUrl||!!E.summary||Dt(E)),[c.dossiers]),[kt,Oe]=p.useState(!1);p.useEffect(()=>{if(c.loading){Oe(!1);return}if(c.dossiers.length>0||c.error){Oe(!0);return}const E=window.setTimeout(()=>Oe(!0),6e3);return()=>window.clearTimeout(E)},[c.loading,c.dossiers.length,c.error]);const xt=(c.marketEstimate||0)>0||typeof((In=c.stats)==null?void 0:In.screened)=="number"&&c.stats.screened>0,ut=p.useMemo(()=>[1,0,2,4,5,3].find(E=>(Pe[E]||0)>0)??0,[Pe]),Xe=Sn.find(E=>E.key===h.continent),jt=h.continent==="monde"?l.contWorld:(s==="fr"?Xe==null?void 0:Xe.fr:Xe==null?void 0:Xe.en)||"";p.useEffect(()=>{const E=Q=>{var te;const U=(((te=Q.detail)==null?void 0:te.name)||"").trim();U&&gt(null,U)};return window.addEventListener("ppmap:evaluate",E),()=>window.removeEventListener("ppmap:evaluate",E)}),p.useEffect(()=>{const E=Q=>{const U=Q.detail||{},te=String(U.id||"").trim(),se=String(U.name||"").trim(),He=String(U.url||"").trim(),Ne=te&&Ke.get(te)||jc(c.dossiers,se,He);if(Ne){if(y(null),ea(Ne,h,G)||(h.continent!=="monde"&&Ne.continent!==h.continent&&d({type:"continent",key:Ne.continent||"monde"}),d({type:"reset"})),G&&Ne.kind!=="op"){const st=ze(Ne);typeof st=="number"&&st!==h.ptab&&d({type:"ptab",tab:st})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:Ne.id}),(Ne.noCo||["media","nominations","recrutements"].includes(Ne.engine||""))&&(Ne.url||Ne.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ne.url||"",text:[Ne.headline,Ne.tagline].filter(Boolean).join(`
`)}})):Ne.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ne.name,url:Ne.url||"",website:Ne.website||"",domain:Ne.domain||""}}));return}!se&&!He||(d({type:"focus",id:te||null}),y({name:se,headline:String(U.text||"").trim()||se,url:He,card:U.card}),He&&(Ea(se)||!se)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:He,text:String(U.text||"").trim()}})):se&&!Ea(se)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:se}})))};return window.addEventListener("ppmap:focus",E),()=>window.removeEventListener("ppmap:focus",E)}),p.useEffect(()=>{const E=te=>{const se={},He=String((te==null?void 0:te.sector)||"").trim();He&&(se.sector=[He]);const Ne=String((te==null?void 0:te.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ne)&&(se.day=Ne);const Be=String((te==null?void 0:te.search)||"").trim();Be&&(se.search=Be);const st=String((te==null?void 0:te.dealKind)||"").trim();(st==="ma"||st==="levee"||st==="other")&&(se.dealKind=[st]),Object.keys(se).length&&d({type:"filters",patch:se})},Q=te=>E(te.detail),U=te=>{te.data&&te.data.type==="pp-filter"&&E(te.data)};return window.addEventListener("ppmap:filter",Q),window.addEventListener("message",U),()=>{window.removeEventListener("ppmap:filter",Q),window.removeEventListener("message",U)}},[]),p.useEffect(()=>{const E=Q=>{var se;const U=(((se=Q.detail)==null?void 0:se.name)||"").trim().toLowerCase();if(!U)return;const te=c.dossiers.find(He=>(He.name||"").trim().toLowerCase()===U);te&&d(a==="ops"?{type:"focus",id:te.id}:{type:"popup",id:te.id})};return window.addEventListener("ppmap:similar",E),()=>window.removeEventListener("ppmap:similar",E)});const gt=(E,Q,U)=>{const te=(U||(E==null?void 0:E.name)||Q||"").trim();if(!fe){w({kicker:te});return}!te||S||(T(!0),(async()=>{try{let se=(Q||te).trim();const He=((E==null?void 0:E.website)||(E==null?void 0:E.domain)||"").trim();if(!(/^https?:\/\//i.test(se)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(se)&&!/\s/.test(se)))if(He)se=He;else try{const Fe=await Cn(te);if(Fe!=null&&Fe.website)se=Fe.website;else if(((Fe==null?void 0:Fe.candidates)||[]).length===1)se=Fe.candidates[0].url;else if(((Fe==null?void 0:Fe.candidates)||[]).length>1){B.current=[{name:te,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(Fe.candidates||[]).slice(0,5)},...B.current].slice(0,8),O();return}}catch{}const Be=await ao(re,se,"atelier2"),st={name:Be.company||te,verdict:Be.verdict,reason:Be.reason||"",remaining:Be.remaining??null};B.current=[st,...B.current].slice(0,8),Be.verdict==="kept"&&C(Fe=>({...Fe,kept:Fe.kept+1})),Be.verdict==="ruled_out"&&C(Fe=>({...Fe,dropped:Fe.dropped+1}));const Ht=E||c.dossiers.find(Fe=>(Fe.name||"").toLowerCase()===te.toLowerCase());Ht&&(Be.verdict==="kept"?Ht.verdict=Ht.verdict||"MATCH":Be.verdict==="ruled_out"&&(Ht.verdict="NO MATCH"),Be.reason&&(Ht.reasoning=Be.reason)),O()}finally{T(!1)}})())},bt=E=>{if(!fe){w({kicker:E.name});return}ve(E,"instant"),Vt(re,"fast_request",E.name||"",""),oe(l.memoInstantSent(E.name))},Ft=E=>me.current.get(E.id)??c.thumbs.get((E.name||"").trim().toLowerCase()),Nt=(E,Q)=>d({type:"undoPush",entry:{id:E.id,name:E.name,prevCeoStatus:Q}}),Re=async(E,Q,U)=>{const te=E.ceoStatus||"";E.ceoStatus=Q,O();const se=await Ua(re,{status:Q,airtable_id:E.airtableId,check_id:E.checkId,company:E.name,...(U==null?void 0:U.note)!==void 0?{note:U.note}:{},...U!=null&&U.via?{via:U.via}:{}});return se.ok?se.skipped?(E.ceoStatus=te,O(),Ee(l.actNotPersisted),!1):((U==null?void 0:U.undo)!==!1&&Nt(E,te),U!=null&&U.msg&&oe(U.msg),(Q==="Validé"||Q==="Écarté")&&!E.ceoNote&&(U==null?void 0:U.note)===void 0&&F({o:E,yes:Q==="Validé"}),!0):(E.ceoStatus=te,O(),Ee(l.actErr),!1)},nt=async(E,Q)=>{const U=await Ua(re,{status:E.ceoStatus||"Retenu",airtable_id:E.airtableId,check_id:E.checkId,company:E.name,note:Q,via:"note"});return!U.ok||U.skipped?(Ee(U.skipped?l.actNotPersisted:l.actErr),!1):(E.ceoNote=Q,O(),!0)},z=p.useRef(new Map),_=E=>z.current.has(E.id)?z.current.get(E.id):c.stages.get((E.name||"").trim().toLowerCase()),H=(E,Q)=>{z.current.set(E.id,Q),O()},ae=(E,Q)=>{fe&&Re(E,Q?"Validé":"Écarté",{msg:Q?l.decidedYes(E.name):l.decidedNo(E.name)})},ye=E=>{fe&&Re(E,"À trancher",{msg:l.promoted(E.name)})},D=E=>{fe&&(async()=>{const Q=E.ceoStatus||"";E.ceoStatus="Retenu",O();const U=await Ua(re,{status:"Retenu",check_id:E.checkId,company:E.name});if(!U.ok||U.skipped){E.ceoStatus=Q,O(),Ee(U.skipped?l.actNotPersisted:l.actErr);return}Nt(E,Q),oe(l.repeched(E.name))})()},ee=()=>{const E=h.undo[h.undo.length-1];if(!E){oe(l.undoNone);return}const Q=Ke.get(E.id);if(!Q){d({type:"undoPop"}),oe(l.undoNone);return}let U=E.prevCeoStatus;if(!U)if((Q.verdict||"").toUpperCase().includes("CALL"))U="À trancher";else{oe(l.undoLockedTitle);return}(async()=>await Re(Q,U,{undo:!1})&&(d({type:"undoPop"}),Q.ceoStatus=E.prevCeoStatus,O(),oe(l.undoDone(Q.name))))()},ie=E=>{fe&&(K.current.add(E.id),O(),(async()=>{const Q=await ls(re,E.name,"email");if(!Q||Q.ok===!1){K.current.delete(E.id),O(),Ee(l.actErr);return}Vt(re,"approach",E.name||"",""),oe(l.actApproachSent)})())},Z=(E,Q)=>{fe&&(async()=>{if(!(await Vt(re,Q?"yes":"no",E.name||"","")).ok){Ee(l.actErr);return}me.current.set(E.id,Q?"yes":"no"),O(),oe(Q?l.thumbUpDone:l.thumbDnDone)})()},je=E=>{!fe||!Dt(E)||(ve(E,"detailed"),Vt(re,"detailed_request",E.name||"",""),oe(l.memoDeepSent(E.name)))},De=E=>{const Q=new Set(c.favIds),U=Q.has(E.id);U?Q.delete(E.id):Q.add(E.id),c.setFavIds(Q),fe&&ds(re,{id:E.id,co:E.name},U)},$e=()=>{!fe||P||window.confirm(l.identSyncConfirm)&&(J(!0),(async()=>{const E=await cs(re);J(!1),E?oe(l.identSyncDone):Ee(l.actErr)})())},Ae=/proplace/i.test(c.fund||""),Ue=E=>{!fe||!Ae||(Vt(re,"onboard_request",E.name||"",""),oe(l.onboardSent(E.name)))},Pa={st:h,dispatch:d,t:l,lang:s,mode:pe,caps:xe,pipe:G,token:re,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:D,thumbOf:Ft,canWrite:fe,commitStatus:Re,saveNote:nt,stageOf:_,setStage:H,flashErr:Ee,startTour:()=>q(!0),dossiers:c.dossiers,scopedAll:he,scoped:Rt,counts:Pe,byId:Ke,contName:jt,favIds:c.favIds,toggleFav:De,askEvaluate:gt,doAnalyse:bt,doDecide:ae,doPromote:ye,doApproach:ie,doThumb:Z,doDeep:je,doUndo:ee,doSync:$e,doOnboard:Ue,outbound:Ae,memoQueued:W.current,liveMemos:{items:ke,serverOff:le,liveOf:ne},approachDone:K.current,sessTally:N,evalCards:B.current,evalBusy:S,markRow:k,markedId:v,flash:oe,focusExtra:f};p.useEffect(()=>{const E=Q=>{Q.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)},[]);const la=E=>re?t.jsx(Us,{token:re,children:E}):t.jsx(t.Fragment,{children:E});return t.jsx(Go.Provider,{value:Pa,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(re?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:zs}),la(t.jsxs("div",{className:"app"+(G?" pipe":"")+(re?" has-thesis":""),children:[xe.showTicker&&t.jsx(rt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(re?" live-stack--cibles":""),children:[t.jsx(Ks,{}),!!re&&t.jsx(Hs,{})]})}),xe.showIdent&&t.jsx(rt,{name:"identite",children:t.jsx(ll,{})}),!1,Sc,xe.showFunnel&&t.jsx(rt,{name:"entonnoir",children:t.jsx(qc,{})}),!h.mapFolded&&t.jsx(rt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Oo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Nc,{}),a!=="ops"&&xe.showFunnel&&t.jsx(Ec,{}),t.jsx(id,{}),t.jsx(Mo,{})]})]})}),xe.showDemand&&G&&t.jsx(rt,{name:"direct",children:t.jsx(hs,{items:ke,serverOff:le,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([E,Q])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===E,onClick:()=>{m(E);try{localStorage.setItem("atl2:chrome-mode",E)}catch{}},children:Q},E))}),xe.showDemand&&t.jsx(rt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(fd,{})})}),xe.showDemand&&h.memoConsole&&t.jsx(rt,{name:"console",children:t.jsx(xd,{})}),xe.pipe&&!!re&&t.jsx(rt,{name:"moteurs",children:t.jsx(ws,{})}),t.jsx(rt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(Wd,{})}),c.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:l.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(rt,{name:"fiche",children:t.jsx(Ad,{})}),t.jsx(rt,{name:"modales",children:t.jsx(ec,{})}),t.jsx(Zs,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(rl,{placeholder:L.yes?l.whyYesPh:l.whyNoPh,onDone:E=>{const Q=L.o;F(null),E&&nt(Q,E).then(U=>{U&&oe(l.csNoteSaved)})}})]}),g&&kt&&t.jsx(il,{steps:Ac(l,qe,it,ut,xt,Pe[3]||0),onClose:()=>{q(!1),Kr(re)}}),t.jsx(Cc,{}),xe.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:mo,children:qn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),A&&t.jsx("div",{className:"flash on"+(M?" err":""),children:A}),j&&t.jsx(ns,{variant:"acquirer",initialCompany:Jr().co,initialWebsite:Jr().site,onClose:()=>w(null)})]})})}function qc(){const{t:e}=V(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Jr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Tc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Yo as FlagCell,yt as SigBadge,Ia as SigWin,Fc as default,Tc as fmtShort,V as useV2};
