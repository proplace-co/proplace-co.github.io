...
`;class ge extends h.Component{constructor(){super(...arguments);Pa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ui=8;function mi(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,p]=h.useState(!1),[g,d]=h.useState(!1),[m,u]=h.useState(!1),x=r||"home",{names:c,verdicts:b}=h.useMemo(()=>{const w=[],C={};return n.forEach(A=>{A.kind!=="target"||!A.name||(w.push(A.name),C[A.name]=Yr(A)||"")}),{names:w,verdicts:C}},[n]),v=h.useMemo(()=>c.length?Wr(x,c,b,a):null,[x,c.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const f=g?v.added:v.added.slice(0,ui),y=v.added.length-f.length,k=w=>{const C=n.find(A=>A.name===w);C&&(o(C.id),l({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Gr(x,c,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[f.map(w=>t.jsx("button",{type:"button",onClick:()=>k(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),m&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const ea=600,Ge=62,en="atl2:fstats";function fi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(en)==="on"}catch{return!1}}),p=r.stats,g=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const m=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),x=g.reduce((y,k)=>Math.max(y,k.s||0),0),c=g.length?ea/g.length:0,b=Math.max(4,c-4),v=g.length>=5&&x>0,f=[[p.screened,e.funScreened(m(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[f.map(([y,k,w],C)=>t.jsxs("span",{className:"fst-t",children:[C>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:k}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},k)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(en,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ea} ${Ge}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((y,k)=>{const w=(y.s||0)/x*(Ge-4),C=(y.m||0)/x*(Ge-4),A=k*c+(c-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:Ge-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:Ge-2-C,width:b,height:C,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ge-1.5,x2:ea,y2:Ge-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const xi=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function hi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(et(e)||"").startsWith("CALL")&&ke(e)===3,m=ke(e)>=2,u=async c=>{if(o||c==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(c);const b=await i(e,c);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},x=d?[["Validé",a.csYes],["Écarté",a.csNo]]:xi.filter(([c])=>!(m&&c==="Retenu")).map(([c,b])=>[c,a[b]]);return t.jsxs("div",{className:"csp",onClick:c=>c.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),x.map(([c,b])=>t.jsx("button",{type:"button",className:"csb"+(g===c?" on":"")+(o===c?" busy":""),disabled:!!o,onClick:()=>{u(c)},children:b},c)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(gi,{o:e})]})}function gi({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,g]=h.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{m()},children:p?a.csNoteSaved:a.csNoteOk})]})}function bi({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function vi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[p,g]=h.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const d=o(e),m=(d==null?void 0:d.stage)||"todo",u=async f=>{if(p||f===m)return;g(!0);const y=d;l(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const k=Math.max(Date.now(),tn+=1);tn=k;const w=await Kr(r,{company:e.name||"",stage:f,cts:k,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},x=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,c=x?Math.floor((Date.now()-Date.parse(x))/864e5):0,b=m==="sent"&&x&&c>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(m===f?" on":""),disabled:p,onClick:()=>{u(f)},children:y},f)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(c)})]})}let tn=0;const Ct=8,Et=360;function an({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function nn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(an,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(an,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function yi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=h.useState(0),[p,g]=h.useState(null),[d,m]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,m(e.filter(k=>!!document.querySelector(k.need||k.sel))))},[e]);const x=d[l],c=l>=d.length;h.useEffect(()=>{if(x&&(x.ptab!==void 0&&o.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&o.dens!==x.dens&&n({type:"dens",dens:x.dens}),o.modal!==(x.modal??null)&&n({type:"modal",modal:x.modal??null}),x.click)){const k=x.click,w=window.setTimeout(()=>{const C=document.querySelector(k);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(w)}},[l,x]);const b=h.useCallback(()=>{if(!x){g(null);return}const k=document.querySelector(x.sel);if(!k){g(null);return}k.scrollIntoView({block:"nearest",behavior:"smooth"}),g(k.getBoundingClientRect())},[x]);h.useLayoutEffect(()=>{b();const k=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(k),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=h.useRef(a);if(v.current=a,h.useEffect(()=>{const k=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(C=>C+1):w.key==="ArrowLeft"&&s(C=>Math.max(0,C-1))};return document.addEventListener("keydown",k,!0),()=>document.removeEventListener("keydown",k,!0)},[]),!d.length)return null;let f=null;if(c){const k=i[3]||0;k>0?f={title:k===1?r.ahaATitle1:r.ahaATitleN(k),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?f={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:f={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Et};if(!c&&p){const k=p.bottom+14,C=window.innerHeight-k>190?k:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-Et/2),window.innerWidth-Et-12),top:C,width:Et}}return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!c&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-Ct,top:p.top-Ct,width:p.width+Ct*2,height:p.height+Ct*2}}),(c||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(c?" fin":""),style:y,children:[c&&f?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:f.title}),t.jsx(nn,{text:f.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:f.go,children:f.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx(nn,{text:(x==null?void 0:x.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(k=>Math.max(0,k-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(k=>k+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Gn(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Kn(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function wi(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,dispatch:s}=F(),p=r?a:e,g=h.useMemo(()=>p.filter(C=>Ve(C.date)===0&&C.kind==="target"),[p]),d=h.useMemo(()=>r?a.filter(C=>ke(C)===0).slice().sort((C,A)=>(A.date||"").localeCompare(C.date||"")):[],[a,r]),m=h.useMemo(()=>g.filter(C=>r?ke(C)===0:!Ee(C)),[g,r]),u=r?d:m,x=r?a.length-d.length:g.length-m.length,c=r?a.length:g.length,b=c?Math.min(100,x/c*100):100,v=h.useMemo(()=>Gn(p),[p]),f=!!v&&Ve(v)>0,y=h.useMemo(()=>f?p.filter(C=>(C.date||"").slice(0,10)===v):[],[p,v,f]);let k;f?k=i.morningLast(y.length,d.length,Kn(v,l)):r?k=i.morningThesis(g.length,d.length):g.length?x===0?k=i.goalSourced(g.length):x>=g.length?k=i.goalCleared:k=i.goalDone(x,g.length):k=i.goalSourced(0);const w=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&d.length&&s({type:"chainStart",queue:d.map(C=>C.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:k}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:b+"%"}})}),u.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:w,children:r?i.morningEval(u.length):o.pileMode?i.goalContinue(u.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ki(){var q,M;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:g,startTour:d}=F(),[m,u]=h.useState(null),[x,c]=h.useState([]),b=p==="client";h.useEffect(()=>{if(!i||!o)return;let L=!0;return(async()=>{const[U,j]=await Promise.all([Aa(o),Dn(i)]);L&&(U&&u(U),c(j))})(),()=>{L=!1}},[i,o]);const v=(m==null?void 0:m.per_day)??null,f=((q=m==null?void 0:m.pool_order)==null?void 0:q.length)??0,y=x.filter(L=>L.status==="running").length,k=h.useMemo(()=>s.filter(L=>L.kind==="target"&&Ee(L)).length,[s]),w=l.marketEstimate,C=typeof((M=l.stats)==null?void 0:M.screened)=="number"?l.stats.screened:k,A=w&&w>0?Math.min(100,Math.round(C/w*100)):null,R=L=>L.toLocaleString(a==="en"?"en-US":"fr-FR"),B=(o||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const L=Date.parse(l.generatedAt||"");if(Number.isNaN(L))return"";const U=new Date(L),j=S=>String(S).padStart(2,"0");return`${j(U.getDate())}/${j(U.getMonth()+1)} à ${j(U.getHours())}:${j(U.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:B}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),E&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(E)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&C>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(C)})})]}),A!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(C,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(f)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function ji(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const Ni=["--p0","--p1","--p2","--p3","--p4"];function Si(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,p=h.useRef({});h.useEffect(()=>{p.current={...r}},[r]);const g=u=>{const x=p.current[u],c=x!==void 0?r[u]-x:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ni[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[u],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},u)},d=(u,x,c)=>t.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,x,c,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:c,children:u},x);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Ci=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ei(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=h.useRef(null),[p,g]=h.useState(60);h.useEffect(()=>{let x=0;const c=()=>{var k;const b=s.current;if(!b)return;const v=(k=b.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!v)return;const f=v.getBoundingClientRect(),y=b.getBoundingClientRect();g(Math.max(20,Math.min(f.left+f.width/2-y.left,y.width-30)))};return x=requestAnimationFrame(c),window.addEventListener("resize",c),()=>{cancelAnimationFrame(x),window.removeEventListener("resize",c)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const x=n.filter(v=>v.kind==="target"&&ke(v)===3),c=x.filter(v=>ia(v)==="auto").length,b=x.filter(v=>ia(v)==="cd").length;m=r.tutoPending(c,b,x.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(x=>x.id)})};if(d===1){const x=n.filter(c=>c.kind==="target"&&ke(c)===1&&!i.has(c.id)).slice(0,10);if(x.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:x.map(c=>c.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Ci[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Je{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Ai(e){for(const a of e)yield*a}function Qn(e){return Array.from(Ai(e))}var ne=1e-6,J=Math.PI,Te=J/2,rn=J/4,Re=J*2,$e=180/J,Ce=J/180,ie=Math.abs,zi=Math.atan,vt=Math.atan2,de=Math.cos,ce=Math.sin,Ti=Math.sign||function(e){return e>0?1:e<0?-1:0},tt=Math.sqrt;function Li(e){return e>1?0:e<-1?J:Math.acos(e)}function yt(e){return e>1?Te:e<-1?-Te:Math.asin(e)}function Le(){}function Ot(e,a){e&&sn.hasOwnProperty(e.type)&&sn[e.type](e,a)}var on={Feature:function(e,a){Ot(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Ot(r[n].geometry,a)}},sn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ca(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ca(r[n],a,0)},Polygon:function(e,a){ln(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ln(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Ot(r[n],a)}};function ca(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function ln(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ca(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&on.hasOwnProperty(e.type)?on[e.type](e,a):Ot(e,a)}function pa(e){return[vt(e[1],e[0]),yt(e[2])]}function it(e){var a=e[0],r=e[1],n=de(r);return[n*de(a),n*ce(a),ce(r)]}function At(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ft(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function zt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ua(e){var a=tt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ma(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function fa(e,a){return ie(e)>J&&(e-=Math.round(e/Re)*Re),[e,a]}fa.invert=fa;function Ri(e,a,r){return(e%=Re)?a||r?ma(cn(e),pn(a,r)):cn(e):a||r?pn(a,r):fa}function dn(e){return function(a,r){return a+=e,ie(a)>J&&(a-=Math.round(a/Re)*Re),[a,r]}}function cn(e){var a=dn(e);return a.invert=dn(-e),a}function pn(e,a){var r=de(e),n=ce(e),i=de(a),o=ce(a);function l(s,p){var g=de(p),d=de(s)*g,m=ce(s)*g,u=ce(p),x=u*r+d*n;return[vt(m*i-x*o,d*r-u*n),yt(x*i+m*o)]}return l.invert=function(s,p){var g=de(p),d=de(s)*g,m=ce(s)*g,u=ce(p),x=u*i-m*o;return[vt(m*i+u*o,d*r+x*n),yt(x*r-d*n)]},l}function qi(e,a,r,n,i,o){if(r){var l=de(a),s=ce(a),p=n*r;i==null?(i=a+n*Re,o=a-p/2):(i=un(l,i),o=un(l,o),(n>0?i<o:i>o)&&(i+=n*Re));for(var g,d=i;n>0?d>o:d<o;d-=p)g=pa([l,-s*de(d),-s*ce(d)]),e.point(g[0],g[1])}}function un(e,a){a=it(a),a[0]-=e,ua(a);var r=Li(-a[1]);return((-a[2]<0?-r:r)+Re-ne)%Re}function Jn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Le,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Mt(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Tt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Xn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(c){if(!((b=c.length-1)<=0)){var b,v=c[0],f=c[b],y;if(Mt(v,f)){if(!v[2]&&!f[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=c[s])[0],v[1]);i.lineEnd();return}f[0]+=2*ne}o.push(y=new Tt(v,c,null,!0)),l.push(y.o=new Tt(v,null,y,!1)),o.push(y=new Tt(f,c,null,!1)),l.push(y.o=new Tt(f,null,y,!0))}}),!!o.length){for(l.sort(a),mn(o),mn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var g=o[0],d,m;;){for(var u=g,x=!0;u.v;)if((u=u.n)===g)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(x)for(s=0,p=d.length;s<p;++s)i.point((m=d[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(x)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((m=d[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,x=!x}while(!u.v);i.lineEnd()}}}function mn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function aa(e){return ie(e[0])<=J?e[0]:Ti(e[0])*((ie(e[0])+J)%Re-J)}function Mi(e,a){var r=aa(a),n=a[1],i=ce(n),o=[ce(r),-de(r),0],l=0,s=0,p=new Je;i===1?n=Te+ne:i===-1&&(n=-Te-ne);for(var g=0,d=e.length;g<d;++g)if(u=(m=e[g]).length)for(var m,u,x=m[u-1],c=aa(x),b=x[1]/2+rn,v=ce(b),f=de(b),y=0;y<u;++y,c=w,v=A,f=R,x=k){var k=m[y],w=aa(k),C=k[1]/2+rn,A=ce(C),R=de(C),B=w-c,E=B>=0?1:-1,q=E*B,M=q>J,L=v*A;if(p.add(vt(L*E*ce(q),f*R+L*de(q))),l+=M?B+E*Re:B,M^c>=r^w>=r){var U=Ft(it(x),it(k));ua(U);var j=Ft(o,U);ua(j);var S=(M^B>=0?-1:1)*yt(j[2]);(n>S||n===S&&(U[0]||U[1]))&&(s+=M^B>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function Zn(e,a,r,n){return function(i){var o=a(i),l=Jn(),s=a(l),p=!1,g,d,m,u={point:x,lineStart:b,lineEnd:v,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=k,d=[],g=[]},polygonEnd:function(){u.point=x,u.lineStart=b,u.lineEnd=v,d=Qn(d);var w=Mi(g,n);d.length?(p||(i.polygonStart(),p=!0),Xn(d,Fi,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),d=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function x(w,C){e(w,C)&&i.point(w,C)}function c(w,C){o.point(w,C)}function b(){u.point=c,o.lineStart()}function v(){u.point=x,o.lineEnd()}function f(w,C){m.push([w,C]),s.point(w,C)}function y(){s.lineStart(),m=[]}function k(){f(m[0][0],m[0][1]),s.lineEnd();var w=s.clean(),C=l.result(),A,R=C.length,B,E,q;if(m.pop(),g.push(m),m=null,!!R){if(w&1){if(E=C[0],(B=E.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),A=0;A<B;++A)i.point((q=E[A])[0],q[1]);i.lineEnd()}return}R>1&&w&2&&C.push(C.pop().concat(C.shift())),d.push(C.filter(Oi))}}return u}}function Oi(e){return e.length>1}function Fi(e,a){return((e=e.x)[0]<0?e[1]-Te-ne:Te-e[1])-((a=a.x)[0]<0?a[1]-Te-ne:Te-a[1])}const fn=Zn(function(){return!0},Pi,Ii,[-J,-Te]);function Pi(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?J:-J,p=ie(o-a);ie(p-J)<ne?(e.point(a,r=(r+l)/2>0?Te:-Te),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=J&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=Di(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Di(e,a,r,n){var i,o,l=ce(e-r);return ie(l)>ne?zi((ce(a)*(o=de(n))*ce(r)-ce(n)*(i=de(a))*ce(e))/(i*o*l)):(a+n)/2}function Ii(e,a,r,n){var i;if(e==null)i=r*Te,n.point(-J,i),n.point(0,i),n.point(J,i),n.point(J,0),n.point(J,-i),n.point(0,-i),n.point(-J,-i),n.point(-J,0),n.point(-J,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?J:-J;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function $i(e){var a=de(e),r=2*Ce,n=a>0,i=ie(a)>ne;function o(d,m,u,x){qi(x,e,r,u,d,m)}function l(d,m){return de(d)*de(m)>a}function s(d){var m,u,x,c,b;return{lineStart:function(){c=x=!1,b=1},point:function(v,f){var y=[v,f],k,w=l(v,f),C=n?w?0:g(v,f):w?g(v+(v<0?J:-J),f):0;if(!m&&(c=x=w)&&d.lineStart(),w!==x&&(k=p(m,y),(!k||Mt(m,k)||Mt(y,k))&&(y[2]=1)),w!==x)b=0,w?(d.lineStart(),k=p(y,m),d.point(k[0],k[1])):(k=p(m,y),d.point(k[0],k[1],2),d.lineEnd()),m=k;else if(i&&m&&n^w){var A;!(C&u)&&(A=p(y,m,!0))&&(b=0,n?(d.lineStart(),d.point(A[0][0],A[0][1]),d.point(A[1][0],A[1][1]),d.lineEnd()):(d.point(A[1][0],A[1][1]),d.lineEnd(),d.lineStart(),d.point(A[0][0],A[0][1],3)))}w&&(!m||!Mt(m,y))&&d.point(y[0],y[1]),m=y,x=w,u=C},lineEnd:function(){x&&d.lineEnd(),m=null},clean:function(){return b|(c&&x)<<1}}}function p(d,m,u){var x=it(d),c=it(m),b=[1,0,0],v=Ft(x,c),f=At(v,v),y=v[0],k=f-y*y;if(!k)return!u&&d;var w=a*f/k,C=-a*y/k,A=Ft(b,v),R=zt(b,w),B=zt(v,C);ta(R,B);var E=A,q=At(R,E),M=At(E,E),L=q*q-M*(At(R,R)-1);if(!(L<0)){var U=tt(L),j=zt(E,(-q-U)/M);if(ta(j,R),j=pa(j),!u)return j;var S=d[0],T=m[0],H=d[1],G=m[1],Z;T<S&&(Z=S,S=T,T=Z);var z=T-S,O=ie(z-J)<ne,$=O||z<ne;if(!O&&G<H&&(Z=H,H=G,G=Z),$?O?H+G>0^j[1]<(ie(j[0]-S)<ne?H:G):H<=j[1]&&j[1]<=G:z>J^(S<=j[0]&&j[0]<=T)){var P=zt(E,(-q+U)/M);return ta(P,R),[j,pa(P)]}}}function g(d,m){var u=n?e:J-e,x=0;return d<-u?x|=1:d>u&&(x|=2),m<-u?x|=4:m>u&&(x|=8),x}return Zn(l,s,o,n?[0,-e]:[-J,e-J])}function Bi(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],g=a[1],d=0,m=1,u=p-l,x=g-s,c;if(c=r-l,!(!u&&c>0)){if(c/=u,u<0){if(c<d)return;c<m&&(m=c)}else if(u>0){if(c>m)return;c>d&&(d=c)}if(c=i-l,!(!u&&c<0)){if(c/=u,u<0){if(c>m)return;c>d&&(d=c)}else if(u>0){if(c<d)return;c<m&&(m=c)}if(c=n-s,!(!x&&c>0)){if(c/=x,x<0){if(c<d)return;c<m&&(m=c)}else if(x>0){if(c>m)return;c>d&&(d=c)}if(c=o-s,!(!x&&c<0)){if(c/=x,x<0){if(c>m)return;c>d&&(d=c)}else if(x>0){if(c<d)return;c<m&&(m=c)}return d>0&&(e[0]=l+d*u,e[1]=s+d*x),m<1&&(a[0]=l+m*u,a[1]=s+m*x),!0}}}}}var mt=1e9,Lt=-mt;function Ui(e,a,r,n){function i(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function o(g,d,m,u){var x=0,c=0;if(g==null||(x=l(g,m))!==(c=l(d,m))||p(g,d)<0^m>0)do u.point(x===0||x===3?e:r,x>1?n:a);while((x=(x+m+4)%4)!==c);else u.point(d[0],d[1])}function l(g,d){return ie(g[0]-e)<ne?d>0?0:3:ie(g[0]-r)<ne?d>0?2:1:ie(g[1]-a)<ne?d>0?1:0:d>0?3:2}function s(g,d){return p(g.x,d.x)}function p(g,d){var m=l(g,1),u=l(d,1);return m!==u?m-u:m===0?d[1]-g[1]:m===1?g[0]-d[0]:m===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,m=Jn(),u,x,c,b,v,f,y,k,w,C,A,R={point:B,lineStart:L,lineEnd:U,polygonStart:q,polygonEnd:M};function B(S,T){i(S,T)&&d.point(S,T)}function E(){for(var S=0,T=0,H=x.length;T<H;++T)for(var G=x[T],Z=1,z=G.length,O=G[0],$,P,D=O[0],_=O[1];Z<z;++Z)$=D,P=_,O=G[Z],D=O[0],_=O[1],P<=n?_>n&&(D-$)*(n-P)>(_-P)*(e-$)&&++S:_<=n&&(D-$)*(n-P)<(_-P)*(e-$)&&--S;return S}function q(){d=m,u=[],x=[],A=!0}function M(){var S=E(),T=A&&S,H=(u=Qn(u)).length;(T||H)&&(g.polygonStart(),T&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),H&&Xn(u,s,S,o,g),g.polygonEnd()),d=g,u=x=c=null}function L(){R.point=j,x&&x.push(c=[]),C=!0,w=!1,y=k=NaN}function U(){u&&(j(b,v),f&&w&&m.rejoin(),u.push(m.result())),R.point=B,w&&d.lineEnd()}function j(S,T){var H=i(S,T);if(x&&c.push([S,T]),C)b=S,v=T,f=H,C=!1,H&&(d.lineStart(),d.point(S,T));else if(H&&w)d.point(S,T);else{var G=[y=Math.max(Lt,Math.min(mt,y)),k=Math.max(Lt,Math.min(mt,k))],Z=[S=Math.max(Lt,Math.min(mt,S)),T=Math.max(Lt,Math.min(mt,T))];Bi(G,Z,e,a,r,n)?(w||(d.lineStart(),d.point(G[0],G[1])),d.point(Z[0],Z[1]),H||d.lineEnd(),A=!1):H&&(d.lineStart(),d.point(S,T),A=!1)}y=S,k=T,w=H}return R}}const xa=e=>e;var na=new Je,ha=new Je,er,tr,ga,ba,Be={point:Le,lineStart:Le,lineEnd:Le,polygonStart:function(){Be.lineStart=_i,Be.lineEnd=Hi},polygonEnd:function(){Be.lineStart=Be.lineEnd=Be.point=Le,na.add(ie(ha)),ha=new Je},result:function(){var e=na/2;return na=new Je,e}};function _i(){Be.point=Vi}function Vi(e,a){Be.point=ar,er=ga=e,tr=ba=a}function ar(e,a){ha.add(ba*e-ga*a),ga=e,ba=a}function Hi(){ar(er,tr)}var st=1/0,Pt=st,wt=-st,Dt=wt,It={point:Yi,lineStart:Le,lineEnd:Le,polygonStart:Le,polygonEnd:Le,result:function(){var e=[[st,Pt],[wt,Dt]];return wt=Dt=-(Pt=st=1/0),e}};function Yi(e,a){e<st&&(st=e),e>wt&&(wt=e),a<Pt&&(Pt=a),a>Dt&&(Dt=a)}var va=0,ya=0,ft=0,$t=0,Bt=0,rt=0,wa=0,ka=0,xt=0,nr,rr,Pe,De,ze={point:Xe,lineStart:xn,lineEnd:hn,polygonStart:function(){ze.lineStart=Ki,ze.lineEnd=Qi},polygonEnd:function(){ze.point=Xe,ze.lineStart=xn,ze.lineEnd=hn},result:function(){var e=xt?[wa/xt,ka/xt]:rt?[$t/rt,Bt/rt]:ft?[va/ft,ya/ft]:[NaN,NaN];return va=ya=ft=$t=Bt=rt=wa=ka=xt=0,e}};function Xe(e,a){va+=e,ya+=a,++ft}function xn(){ze.point=Wi}function Wi(e,a){ze.point=Gi,Xe(Pe=e,De=a)}function Gi(e,a){var r=e-Pe,n=a-De,i=tt(r*r+n*n);$t+=i*(Pe+e)/2,Bt+=i*(De+a)/2,rt+=i,Xe(Pe=e,De=a)}function hn(){ze.point=Xe}function Ki(){ze.point=Ji}function Qi(){or(nr,rr)}function Ji(e,a){ze.point=or,Xe(nr=Pe=e,rr=De=a)}function or(e,a){var r=e-Pe,n=a-De,i=tt(r*r+n*n);$t+=i*(Pe+e)/2,Bt+=i*(De+a)/2,rt+=i,i=De*e-Pe*a,wa+=i*(Pe+e),ka+=i*(De+a),xt+=i*3,Xe(Pe=e,De=a)}function ir(e){this._context=e}ir.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Re);break}}},result:Le};var ja=new Je,ra,sr,lr,ht,gt,kt={point:Le,lineStart:function(){kt.point=Xi},lineEnd:function(){ra&&dr(sr,lr),kt.point=Le},polygonStart:function(){ra=!0},polygonEnd:function(){ra=null},result:function(){var e=+ja;return ja=new Je,e}};function Xi(e,a){kt.point=dr,sr=ht=e,lr=gt=a}function dr(e,a){ht-=e,gt-=a,ja.add(tt(ht*ht+gt*gt)),ht=e,gt=a}let gn,Ut,bn,vn;class yn{constructor(a){this._append=a==null?cr:Zi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==bn||this._append!==Ut){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,bn=n,Ut=this._append,vn=this._,this._=i}this._+=vn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function cr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Zi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return cr;if(a!==gn){const r=10**a;gn=a,Ut=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Ut}function es(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),nt(s,i(o))),o.result()}return l.area=function(s){return nt(s,i(Be)),Be.result()},l.measure=function(s){return nt(s,i(kt)),kt.result()},l.bounds=function(s){return nt(s,i(It)),It.result()},l.centroid=function(s){return nt(s,i(ze)),ze.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new yn(r)):new ir(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new yn(r)),l},l.projection(e).digits(r).context(a)}function Ra(e){return function(a){var r=new Na;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Na(){}Na.prototype={constructor:Na,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function qa(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream(It)),a(It.result()),n!=null&&e.clipExtent(n),e}function pr(e,a,r){return qa(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function ts(e,a,r){return pr(e,[[0,0],a],r)}function as(e,a,r){return qa(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function ns(e,a,r){return qa(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var wn=16,rs=de(30*Ce);function kn(e,a){return+a?is(e,a):os(e)}function os(e){return Ra({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function is(e,a){function r(n,i,o,l,s,p,g,d,m,u,x,c,b,v){var f=g-n,y=d-i,k=f*f+y*y;if(k>4*a&&b--){var w=l+u,C=s+x,A=p+c,R=tt(w*w+C*C+A*A),B=yt(A/=R),E=ie(ie(A)-1)<ne||ie(o-m)<ne?(o+m)/2:vt(C,w),q=e(E,B),M=q[0],L=q[1],U=M-n,j=L-i,S=y*U-f*j;(S*S/k>a||ie((f*U+y*j)/k-.5)>.3||l*u+s*x+p*c<rs)&&(r(n,i,o,l,s,p,M,L,E,w/=R,C/=R,A,b,v),v.point(M,L),r(M,L,E,w,C,A,g,d,m,u,x,c,b,v))}}return function(n){var i,o,l,s,p,g,d,m,u,x,c,b,v={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=C},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function f(B,E){B=e(B,E),n.point(B[0],B[1])}function y(){m=NaN,v.point=k,n.lineStart()}function k(B,E){var q=it([B,E]),M=e(B,E);r(m,u,d,x,c,b,m=M[0],u=M[1],d=B,x=q[0],c=q[1],b=q[2],wn,n),n.point(m,u)}function w(){v.point=f,n.lineEnd()}function C(){y(),v.point=A,v.lineEnd=R}function A(B,E){k(i=B,E),o=m,l=u,s=x,p=c,g=b,v.point=k}function R(){r(m,u,d,x,c,b,o,l,i,s,p,g,wn,n),v.lineEnd=w,w()}return v}}var ss=Ra({point:function(e,a){this.stream.point(e*Ce,a*Ce)}});function ls(e){return Ra({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ds(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function jn(e,a,r,n,i,o){if(!o)return ds(e,a,r,n,i);var l=de(o),s=ce(o),p=l*e,g=s*e,d=l/e,m=s/e,u=(s*r-l*a)/e,x=(s*a+l*r)/e;function c(b,v){return b*=n,v*=i,[p*b-g*v+a,r-g*b-p*v]}return c.invert=function(b,v){return[n*(d*b-m*v+u),i*(x-m*b-d*v)]},c}function cs(e){return ps(function(){return e})()}function ps(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,g=0,d,m=0,u=1,x=1,c=null,b=fn,v=null,f,y,k,w=xa,C=.5,A,R,B,E,q;function M(S){return B(S[0]*Ce,S[1]*Ce)}function L(S){return S=B.invert(S[0],S[1]),S&&[S[0]*$e,S[1]*$e]}M.stream=function(S){return E&&q===S?E:E=ss(ls(d)(b(A(w(q=S)))))},M.preclip=function(S){return arguments.length?(b=S,c=void 0,j()):b},M.postclip=function(S){return arguments.length?(w=S,v=f=y=k=null,j()):w},M.clipAngle=function(S){return arguments.length?(b=+S?$i(c=S*Ce):(c=null,fn),j()):c*$e},M.clipExtent=function(S){return arguments.length?(w=S==null?(v=f=y=k=null,xa):Ui(v=+S[0][0],f=+S[0][1],y=+S[1][0],k=+S[1][1]),j()):v==null?null:[[v,f],[y,k]]},M.scale=function(S){return arguments.length?(r=+S,U()):r},M.translate=function(S){return arguments.length?(n=+S[0],i=+S[1],U()):[n,i]},M.center=function(S){return arguments.length?(o=S[0]%360*Ce,l=S[1]%360*Ce,U()):[o*$e,l*$e]},M.rotate=function(S){return arguments.length?(s=S[0]%360*Ce,p=S[1]%360*Ce,g=S.length>2?S[2]%360*Ce:0,U()):[s*$e,p*$e,g*$e]},M.angle=function(S){return arguments.length?(m=S%360*Ce,U()):m*$e},M.reflectX=function(S){return arguments.length?(u=S?-1:1,U()):u<0},M.reflectY=function(S){return arguments.length?(x=S?-1:1,U()):x<0},M.precision=function(S){return arguments.length?(A=kn(R,C=S*S),j()):tt(C)},M.fitExtent=function(S,T){return pr(M,S,T)},M.fitSize=function(S,T){return ts(M,S,T)},M.fitWidth=function(S,T){return as(M,S,T)},M.fitHeight=function(S,T){return ns(M,S,T)};function U(){var S=jn(r,0,0,u,x,m).apply(null,a(o,l)),T=jn(r,n-S[0],i-S[1],u,x,m);return d=Ri(s,p,g),R=ma(a,T),B=ma(d,R),A=kn(R,C),j()}function j(){return E=q=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&L,U()}}function ur(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}ur.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function us(){return cs(ur).scale(175.295)}function ms(e){return e}function fs(e){if(e==null)return ms;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var g=2,d=s.length,m=new Array(d);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;g<d;)m[g]=s[g],++g;return m}}function xs(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function hs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Nn(e,r)})}:Nn(e,a)}function Nn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=gs(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function gs(e,a){var r=fs(e.transform),n=e.arcs;function i(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],x=0,c=u.length;x<c;++x)m.push(r(u[x],x));d<0&&xs(m,c)}function o(d){return r(d)}function l(d){for(var m=[],u=0,x=d.length;u<x;++u)i(d[u],m);return m.length<2&&m.push(m[0]),m}function s(d){for(var m=l(d);m.length<4;)m.push(m[0]);return m}function p(d){return d.map(s)}function g(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(g)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:m,coordinates:u}}return g(a)}const mr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},bs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function vs(e,a,r){const n=mr[e];if(!n||!n.length)return-1;const i=bs(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Rt=null;function ys(){return Rt||(Rt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=hs(r,n),o=us().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=es(o),s=(i.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var x;const m=((x=d.properties)==null?void 0:x.name)||"",u=l(d)||"";return u?{i2:Qr(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,m]of Object.entries(Jr)){const u=o(m);u&&(p[d]={x:u[0],y:u[1]})}const g={};for(const[d,m]of Object.entries(mr)){const u=m.map(x=>o(x.ll)).filter(x=>!!x).map(([x,c])=>({x,y:c}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:g}}catch{return null}})(),Rt)}function ws(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return ys().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const ks={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Sn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Cn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function js(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Ns(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:g,dossiers:d}=F(),m=g.loading&&!d.length,u=h.useRef(null),x=h.useRef(null),c=ws(e.continent==="monde"),b=e.continent==="monde"?c:za.find(j=>j.key===e.continent)||null,v=js(u,e.continent+":"+e.mapFolded+":"+!!b),[f,y]=h.useState(new Map),[k,w]=h.useState(null);h.useEffect(()=>{const j=u.current;if(!j)return;const S=new Map;j.querySelectorAll("path[data-i2]").forEach(T=>{const H=T.dataset.i2;if(H)try{const G=T.getBBox();G.width>0&&S.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(S)},[e.continent,v,b]);const C=h.useMemo(()=>r.filter(j=>j.cc),[r]),A=h.useMemo(()=>{const j=new Map;return C.forEach(S=>j.set(S.cc,(j.get(S.cc)||0)+1)),j},[C]),R=e.continent==="monde"&&c?c.anchors:null,B=e.continent==="monde"&&c?c.metros:null,E=h.useMemo(()=>C.map(j=>{const S=Cn(j.name||j.id||""),T=Cn((j.id||j.name||"")+"·y");if(R&&j.cc){const O=B?B[j.cc]:void 0;if(O&&O.length){const P=vs(j.cc,j.city,S);if(P>=0&&O[P])return{d:j,x:O[P].x+(S-.5)*5,y:O[P].y+(T-.5)*5}}const $=R[j.cc];if($)return{d:j,x:$.x+(S-.5)*10,y:$.y+(T-.5)*10}}const H=j.cc?f.get(j.cc):void 0;if(!H)return null;const G=ks[`${e.continent}:${j.cc||""}`];if(G)return{d:j,x:H.x+H.w*(G.fx+(S-.5)*G.sx),y:H.y+H.h*(G.fy+(T-.5)*G.sy)};const Z=(S-.5)*Math.min(H.w*.55,60),z=(T-.5)*Math.min(H.h*.55,60);return{d:j,x:H.x+H.w/2+Z,y:H.y+H.h/2+z}}).filter(j=>!!j),[C,f,R,B,e.continent]),q=j=>v>0?j/v:j,M=h.useMemo(()=>n?[0,1,2,3,4,5].map(j=>({c:Sn[j],fr:p.plabels[j].toUpperCase(),en:p.plabels[j].toUpperCase(),n:r.filter(S=>S.kind==="target"&&ke(S)===j).length})).filter(j=>j.n>0):_a.map((j,S)=>({...j,n:r.filter(T=>Va(T)===S).length})),[r,n,p.plabels]),L=o?l.get(o):null,U=L?E.find(j=>j.d.id===L.id):null;return b?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:x,children:[t.jsxs("svg",{ref:u,viewBox:b.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?b.fr:b.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:b.countries.map((j,S)=>t.jsx("g",{className:"ct"+(j.i2&&A.get(j.i2)?"":" empty"),children:t.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},S))}),t.jsx("g",{children:E.map(j=>{const S=_a[Va(j.d)],T=!!he(j.d),H=j.d.kind==="target",G=n&&H?Sn[ke(j.d)]:S.c,Z=!n&&Ee(j.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var $,P;const z=($=x.current)==null?void 0:$.getBoundingClientRect(),O=(P=u.current)==null?void 0:P.createSVGPoint();if(O&&u.current&&z){O.x=j.x,O.y=j.y;const D=O.matrixTransform(u.current.getScreenCTM());w({x:D.x-z.left,y:D.y-z.top,label:j.d.name+" · "+(dt(j.d.cc,s)||j.d.countryLabel||"")})}i(j.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var $;const z=($=u.current)==null?void 0:$.createSVGPoint();let O=null;if(z&&u.current){z.x=j.x,z.y=j.y;const P=z.matrixTransform(u.current.getScreenCTM());O={x:P.x,y:P.y}}a({type:"popup",id:j.d.id,anchor:O})},children:[t.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:q(Math.max(11,S.px+7))}),t.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:q(S.px),fill:G,stroke:T?"#DC2626":"#ffffff",strokeWidth:q(T?2.2:1.3)})]},j.d.id||j.d.name)})}),U&&t.jsx("circle",{className:"ring on",cx:U.x,cy:U.y,r:q(13),fill:"none",stroke:"#0F172A",strokeWidth:q(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:M.map((j,S)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":j.c}}),s==="fr"?j.fr:j.en," ",t.jsx("b",{children:j.n})]},S))}),r.some(j=>!j.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(j=>!j.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:x})}function Ss(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Cs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(c=>c.continent===e.continent),[r,e.continent]),g=c=>p.filter(b=>c!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Ta(b,s,i,c==="country"?void 0:c)),d=h.useMemo(()=>{const c=g("win"),b=v=>c.filter(f=>(f.date?Math.max(0,Math.floor((Date.now()-Date.parse(f.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),c.length]},[p,s,i]),m=h.useMemo(()=>s.day?g("win").filter(c=>(c.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),x=(c,b,v,f="fbtn")=>t.jsxs("button",{type:"button",className:f,"aria-expanded":e.openFacet===c,onClick:()=>a({type:"openFacet",facet:c}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},c);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Ss(s.day,l)),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((c,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===c,onClick:()=>a({type:"filters",patch:{win:c}}),children:[n.dates[b],t.jsx("b",{children:d[b]})]},c))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:c=>a({type:"filters",patch:{search:c.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):x("sec",n.fSector,s.sector.length),x("pay",n.fCountry,s.country.length),x("det",n.fEngine,s.engine.length),x("sta",n.fStage,s.stage.length),i&&x("ang","Angle",s.angle.length),i&&x("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Es,{poolFor:g})]})}function Es({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:g}=h.useMemo(()=>{if(l==="sig"){const c=e("signal").filter(f=>he(f)),b=new Map;c.forEach(f=>{const y=f.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:c.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...sa([...b.keys()],i).map(f=>({v:f,label:Qe(f)+" "+Ie(f,i),n:b.get(f)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const c=e("sector"),b=new Map;return c.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v,n:f,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const c=e("country"),b=new Map;return c.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:dt(v,i)||v,n:f,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const c=e("engine"),b=new Map;return c.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:sa([...b.keys()],i).map(v=>({v,label:Qe(v)+" "+Ie(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Xr(Zr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const c=e("angle"),b=new Map;return c.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v.replace(/[_-]+/g," "),n:f,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const c=e("memoLevel"),b=new Map;c.forEach(f=>{if(f.kind==="target"){const y=Ea(f);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:v[f],n:b.get(f)||0,html:!1,on:o.memoLevel.includes(f)}))}}const u=e("stage"),x=new Map;return u.forEach(c=>{c.stage&&x.set(c.stage,(x.get(c.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...x.entries()].sort((c,b)=>b[1]-c[1]).map(([c,b])=>({v:c,label:c,n:b,html:!1,on:o.stage.includes(c)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const c=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:c}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function fr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function As(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function En({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function xr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(En,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(En,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function zs({card:e,onEvaluate:a,onAddAll:r}){var s,p,g;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:fr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(xr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Ts(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Ls({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[p,g]=h.useState(null),[d,m]=h.useState(null),[u,x]=h.useState(null),[c,b]=h.useState(!1);h.useEffect(()=>{let f=!0;return(async()=>{const y=await In({email:l,cbToken:s});f&&g(y)})(),()=>{f=!1}},[l,s,n]);const v=f=>{m(f),x(null),b(!0),(async()=>{const y=await eo(f.id);x(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),x(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Ts(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?o.rsPub:o.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),c&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!c&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!c&&u&&t.jsx(zs,{card:u,onEvaluate:a,onAddAll:r})]})]})}const An=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Rs(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:g,data:d,canWrite:m,source:u}=F(),x=a==="client",c=h.useMemo(()=>r||(u!=="default"?to():""),[r,u]),[b,v]=h.useState(""),[f,y]=h.useState(!1),[k,w]=h.useState(""),[C,A]=h.useState(!1),[R,B]=h.useState(""),[E,q]=h.useState([]),M=h.useRef(!1),[L,U]=h.useState(!1),[j,S]=h.useState(""),[T,H]=h.useState(""),[G,Z]=h.useState(!1),[z,O]=h.useState(0),[$,P]=h.useState(""),[D,_]=h.useState(null),[W,X]=h.useState(null),[re,xe]=h.useState(!1),[pe,K]=h.useState(null),[te,be]=h.useState(0),ee=h.useRef(!1),se=b.trim()?An.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,Q=h.useMemo(()=>k.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[k]);h.useEffect(()=>{if(typeof window>"u")return;const I=(new URLSearchParams(window.location.search).get("rs")||"").trim();!I||!/^https?:\/\//i.test(I)||(S(I),U(!0))},[]),h.useEffect(()=>{const I=ae=>{var ye;const oe=String(((ye=ae.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(S(oe),U(!0))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),h.useEffect(()=>{if(!m&&!c){K(null);return}let I=!0;return(async()=>{const ae=await In({email:n,cbToken:c});I&&K(ae.length)})(),()=>{I=!1}},[m,c,n,te]);const Ue=E.length?E:p,fe=d.credits,ve=h.useCallback(I=>{const ae=I.map(oe=>(oe||"").trim()).filter(Boolean);ae.length&&(w(oe=>{const ye=oe.split(`
