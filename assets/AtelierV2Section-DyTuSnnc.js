...
`,Zt=Jt+Xt;function ea(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function ta(t,a){return t||a.mode!=="client"||!a.token?"visiteur":ea("teaser")==="1"?"apercu":"client"}const aa={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},ra=t=>aa[t],oe=t=>Object.assign(t,{continent:At(t.cc)});function Ne(t){const a=new Set,n=[];for(const r of t){const o=(r.name||"").toLowerCase();!o||a.has(o)||(a.add(o),n.push(r))}return n}const na=60*60*1e3;function oa(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>na?null:a}catch{return null}}function he(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const la=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function ia(t,a,n="default"){const r=n!=="default",o=f.useMemo(()=>t||r?{mode:"anon"}:Nt(),[t,r]),s=f.useMemo(()=>r?"visiteur":ta(t,o),[t,o,r]),d=f.useMemo(()=>ra(s),[s]),c=s!=="visiteur",u=la(n),[p,x]=f.useState([]),[i,b]=f.useState(""),[h,g]=f.useState(null),[v,l]=f.useState(""),[y,j]=f.useState(new Set),[w,C]=f.useState(null),[A,q]=f.useState(!0),[P,m]=f.useState(!1),[N,T]=f.useState(0),[F,O]=f.useState(0),L=f.useRef(0),z=f.useMemo(()=>{var E;if(s!=="client")return"";try{return((E=Ct())==null?void 0:E.email)||""}catch{return""}},[s]);f.useEffect(()=>{const E=++L.current;let D=!0;const B=()=>D&&E===L.current,Y=(c&&o.token?o.token:"pub:"+a)+(u?":"+u:""),ee=oa(Y);return ee?(x(ee.objs.map(oe)),ee.fund&&b(ee.fund),g(ee.marketEstimate??null),l(ee.generatedAt||""),q(!1)):q(!0),(async()=>{try{if(n==="ops"){const K=await we(),G=((K==null?void 0:K.recent_ops)||[]).map(H=>ke(H,a)).filter(H=>!!H);if(!B())return;x(G.map(oe)),he(Y,{objs:G})}else if(typeof n=="object"){const G=(await Ie()||[]).filter(I=>(I.slug||"")===n.research).map(I=>Be(I,a)).filter(I=>!!I),H=Ne(await Pe(G,a));if(!B())return;x(H.map(oe)),he(Y,{objs:H})}else if(c&&o.token){const K=zt(o.token),G=we(),H=St(o.token),I=await K;let te=I?I.targets:[];B()&&I&&(b(I.fund||""),g(I.marketEstimate??null),l(I.generatedAt||""),x(te.map(oe)),q(!1),m(!1));const[Q,ce]=await Promise.all([G,H]),ue=((Q==null?void 0:Q.recent_ops)||[]).map(W=>ke(W,a)).filter(W=>!!W);if(te=[...te,...ue],!B())return;x(te.map(oe));const le=new Set;for(const W of ce){const $=(W.id||W.co||"").toString().trim().toLowerCase();$&&le.add($.startsWith("t:")?$:"t:"+$)}j(le),I&&he(Y,{fund:I.fund,marketEstimate:I.marketEstimate,generatedAt:I.generatedAt,objs:te})}else{const K=Et(),G=Ie(),H=we(),I=await K;B()&&I.length&&(x(Ne(I).map(oe)),q(!1),m(!1));const[te,Q]=await Promise.all([G,H]),ce=(te||[]).map($=>Be($,a)).filter($=>!!$),ue=await Pe(ce,a),le=((Q==null?void 0:Q.recent_ops)||[]).map($=>ke($,a)).filter($=>!!$),W=Ne([...I,...ue,...le]);if(!B())return;x(W.map(oe)),he(Y,{objs:W})}B()&&m(!1)}catch{B()&&!ee&&m(!0)}finally{B()&&q(!1)}})(),()=>{D=!1}},[c,o.token,a,N,u]),f.useEffect(()=>{if(!d.showCredits||!z){C(null);return}let E=!0;return(async()=>{try{const D=await fetch(`${Se}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:z})});if(!D.ok)return;const B=await D.json();E&&B&&B.ok!==!1&&C(B)}catch{}})(),()=>{E=!1}},[d.showCredits,z,F]);const M=f.useCallback(E=>j(new Set(E)),[]);return{session:o,mode:s,caps:d,fund:i,email:z,marketEstimate:h,generatedAt:v,dossiers:p,favIds:y,setFavIds:M,credits:w,reloadCredits:()=>O(E=>E+1),loading:A,error:P,refresh:()=>T(E=>E+1)}}const st=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),sa=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...st(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function da(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(o=>o!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(o=>o!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:st(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||be)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const be=60;function Oe(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!_(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Ee(t)))return!1;if(r!=="win"&&a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(se(t.date)>o)return!1}if(r!=="status"&&!n&&a.status!=="all"&&re(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(o))return!1}return!0}function dt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:Oe(t,a.filters,n)}function pa(t,a,n,r){return!(!dt(t,a,n)||n&&!Tt(t,a.ptab,r))}function Le(t,a){const n=a.key,r=o=>{switch(n){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-se(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const s=_(o);return s?100-(s.left??0):-1}}};return[...t].sort((o,s)=>{const d=r(o),c=r(s);return d<c?-a.dir:d>c?a.dir:(o.name||"").localeCompare(s.name||"")})}function ca(){const{dossiers:t,st:a,t:n,dispatch:r,contName:o,pipe:s}=S(),d=f.useMemo(()=>{const u=i=>s?!0:i.continent===a.continent,p=t.filter(i=>u(i)&&_(i)),x=t.filter(i=>u(i)&&i.kind==="op"&&!_(i)&&(i.dealKind==="ma"||i.dealKind==="levee")&&se(i.date)<=2);return x.sort((i,b)=>(b.amountEur||0)-(i.amountEur||0)),[...Le(p,{key:"signal",dir:-1}),...x].slice(0,40)},[t,a.continent,s]),c=u=>d.map(p=>e.jsxs("button",{type:"button",className:"tk"+(U(p)?" spent":""),onClick:x=>{const i=x.currentTarget.getBoundingClientRect();r({type:"popup",id:p.id,anchor:{x:i.left+i.width/2,y:i.bottom}})},title:p.name+(p.tagline?" — "+p.tagline:""),children:[e.jsx(pe,{o:p}),e.jsxs("span",{className:"who",children:[e.jsx(ft,{o:p}),e.jsx("span",{className:"co",children:p.name})]}),typeof p.amountEur=="number"&&p.amountEur>0&&e.jsx("span",{className:"am",children:or(p.amountEur)}),p.sector&&e.jsx("span",{className:"mt",children:p.sector}),e.jsx(ye,{o:p}),e.jsx("span",{className:"tkgo",children:"→"})]},u+(p.id||p.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:d.length})]}),e.jsx("div",{className:"win",children:d.length?e.jsxs("div",{className:"run",children:[c(0),c(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(o)})})})]})}const ua="aDx8z7Hzksus",pt="+33 6 83 10 72 86",We="alexandre@proplace.co",fa=`tel:${pt.replace(/[^\d+]/g,"")}`,Ke="pp-rdv-slot";function xa(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ma(){const{t,caps:a,fund:n}=S(),r=a.showOnb,o=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:ha}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:fa,children:pt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${We}`,children:We})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(o).map(([s,d],c)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(c+1)}),e.jsx("b",{children:s}),e.jsx("span",{children:d})]},s))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Gt,{filloutId:ua,parameters:n?{company_name:n}:void 0})})]})}function ga(){const[t,a]=f.useState(()=>typeof document>"u"?null:document.getElementById(Ke));return f.useEffect(()=>{t||a(document.getElementById(Ke))},[t]),t?ve.createPortal(e.jsx(ma,{}),t):null}const ha=`
...
`;function ba(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:o}=S(),s=f.useMemo(()=>t.filter(i=>se(i.date)===0&&i.kind==="target"),[t]),d=f.useMemo(()=>s.filter(i=>a?X(i)===0:!U(i)),[s,a]),c=s.length-d.length,u=s.length?Math.min(100,c/s.length*100):100;let p;a?p=n.morningThesis(s.length,c,d.length):s.length?c===0?p=n.goalSourced(s.length):c>=s.length?p=n.goalCleared:p=n.goalDone(c,s.length):p=n.goalSourced(0);const x=()=>{a?(o({type:"ptab",tab:0}),o({type:"filters",patch:{win:"1"}})):o({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:p}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:u+"%"}})}),d.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:x,children:a?n.morningEval(d.length):r.pileMode?n.goalContinue(d.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function va(){var N;const{t,st:a,dispatch:n,token:r,fund:o,data:s,dossiers:d,mode:c,doSync:u}=S(),[p,x]=f.useState(null),[i,b]=f.useState([]),[h,g]=f.useState(!1),v=c==="client";f.useEffect(()=>{if(!r||!o)return;let T=!0;return(async()=>{const[F,O]=await Promise.all([at(o),rt(r)]);T&&(F&&x(F),b(O))})(),()=>{T=!1}},[r,o]);const l=(p==null?void 0:p.per_day)??null,y=((N=p==null?void 0:p.pool_order)==null?void 0:N.length)??0,j=i.filter(T=>T.status==="running").length,w=T=>{if(!v||l===null||h)return;const F=Math.max(0,Math.min(10,l+T));F!==l&&(g(!0),x(O=>O&&{...O,per_day:F}),nt(r,F).then(O=>{g(!1),x(O===null?L=>L&&{...L,per_day:l}:L=>L&&{...L,per_day:O})}))},C=f.useMemo(()=>d.filter(T=>T.kind==="target"&&U(T)).length,[d]),A=s.marketEstimate,q=A&&A>0?Math.min(100,Math.round(C/A*100)):null,P=(o||"P").split(/\s+/).map(T=>T[0]).join("").slice(0,2).toUpperCase(),m=(()=>{const T=Date.parse(s.generatedAt||"");if(Number.isNaN(T))return"";const F=new Date(T),O=L=>String(L).padStart(2,"0");return`${O(F.getDate())}/${O(F.getMonth()+1)} à ${O(F.getHours())}:${O(F.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:P}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),m&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(m)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.identTuto,onClick:()=>n({type:"modal",modal:"tuto"}),children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[q!==null&&A&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:q+"%"}})}),e.jsxs("b",{children:[q," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(C,A)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),l!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:T=>{T.stopPropagation(),w(-1)},children:"−"}),e.jsx("b",{className:"q",children:l})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:T=>{T.stopPropagation(),w(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),l===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),j>0&&e.jsxs("span",{className:"ev",children:["⏳ ",j]}),e.jsx("span",{className:"ego",children:t.identPending(y)})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!v,onClick:u,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:T=>n({type:"filters",patch:{search:T.target.value}})})]})]})]})}function ya(){const{t,counts:a,dispatch:n}=S();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,o],s)=>{const d=s===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(d?" go":""),children:[e.jsx("span",{className:"s4n",children:s+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:o}),d&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},s)})})]})}const wa=["--p0","--p1","--p2","--p3","--p4"];function ka(){const{st:t,dispatch:a,counts:n,t:r,doUndo:o}=S(),s=f.useRef({});f.useEffect(()=>{s.current={...n}},[n]);const d=p=>{const x=s.current[p],i=x!==void 0?n[p]-x:0;return e.jsxs("button",{type:"button",className:"step"+(p===3&&n[3]>0?" wait":""),style:{"--c":`var(${wa[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===p,title:r.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[e.jsxs("span",{className:"l",children:[r.plabels[p].toUpperCase(),p===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(i>0?" up":i<0?" down":""),children:[n[p],i!==0&&e.jsxs("em",{className:"delta",children:[i>0?"+":"−",Math.abs(i)]})]})]},p)},c=(p,x,i)=>e.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":p===5?"var(--p5)":p===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===p,title:r.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[e.jsx("span",{className:"l",children:i.toUpperCase()}),e.jsx("span",{className:"n",children:n[p]})]},p),u=(p,x,i,b=!1)=>e.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:i,children:p},x);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(d)}),e.jsxs("div",{className:"offtrack",children:[c(5,!1,r.plabels[5]),c(7,!0,r.plabels[7]),c(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[u("↩",r.toolUndo,o,t.undo.length===0),u("↺",r.toolReset,()=>{a({type:"reset"})}),u("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),u("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),u("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const ja=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Na(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:o,doAnalyse:s,mode:d}=S(),c=f.useRef(null),[u,p]=f.useState(60);f.useEffect(()=>{let h=0;const g=()=>{var w;const v=c.current;if(!v)return;const l=(w=v.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!l)return;const y=l.getBoundingClientRect(),j=v.getBoundingClientRect();p(Math.max(20,Math.min(y.left+y.width/2-j.left,j.width-30)))};return h=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(h),window.removeEventListener("resize",g)}},[t.ptab]);const x=t.ptab;let i=n.tuto[x].p;if(x===3){const h=r.filter(l=>l.kind==="target"&&X(l)===3),g=h.filter(l=>Ce(l)==="auto").length,v=h.filter(l=>Ce(l)==="cd").length;i=n.tutoPending(g,v,h.length)}const b=(()=>{if(d!=="client")return null;if(x===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(h=>h.id)})};if(x===1){const h=r.filter(g=>g.kind==="target"&&X(g)===1&&!o.has(g.id)).slice(0,10);if(h.length)return{label:n.tuto[1].a,run:()=>h.forEach(g=>s(g))}}return null})();return e.jsxs("div",{ref:c,className:"tuto mini",style:{"--bg":ja[x],"--ax":u+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[x].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:i}})]})}),b&&e.jsx("button",{type:"button",className:"tprim",onClick:b.run,children:b.label})]})}const Qe=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Je(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Ca(t,a){const[n,r]=f.useState(1);return f.useEffect(()=>{let o=!0,s=0;const d=()=>{var p;if(!o)return;const u=(p=t.current)==null?void 0:p.getScreenCTM();u&&u.a>0?r(u.a):s=requestAnimationFrame(d)};d();const c=new ResizeObserver(()=>d());return t.current&&c.observe(t.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(s),c.disconnect(),window.removeEventListener("resize",d)}},[t,a]),n}function za(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:o,markedId:s,byId:d,lang:c,t:u}=S(),p=f.useRef(null),x=f.useRef(null),i=Ae.find(m=>m.key===t.continent),b=Ca(p,t.continent+":"+t.mapFolded),[h,g]=f.useState(new Map),[v,l]=f.useState(null);f.useEffect(()=>{const m=p.current;if(!m)return;const N=new Map;m.querySelectorAll("path[data-i2]").forEach(T=>{const F=T.dataset.i2;if(F)try{const O=T.getBBox();O.width>0&&N.set(F,{x:O.x,y:O.y,w:O.width,h:O.height})}catch{}}),g(N)},[t.continent,b]);const y=f.useMemo(()=>n.filter(m=>m.cc),[n]),j=f.useMemo(()=>{const m=new Map;return y.forEach(N=>m.set(N.cc,(m.get(N.cc)||0)+1)),m},[y]),w=f.useMemo(()=>y.map(m=>{const N=m.cc?h.get(m.cc):void 0;if(!N)return null;const T=Je(m.name||m.id||""),F=Je((m.id||m.name||"")+"·y"),O=(T-.5)*Math.min(N.w*.55,60),L=(F-.5)*Math.min(N.h*.55,60);return{d:m,x:N.x+N.w/2+O,y:N.y+N.h/2+L}}).filter(m=>!!m),[y,h]),C=m=>b>0?m/b:m,A=f.useMemo(()=>r?[0,1,2,3,4,5].map(m=>({c:Qe[m],fr:u.plabels[m].toUpperCase(),en:u.plabels[m].toUpperCase(),n:n.filter(N=>N.kind==="target"&&X(N)===m).length})).filter(m=>m.n>0):_e.map((m,N)=>({...m,n:n.filter(T=>$e(T)===N).length})),[n,r,u.plabels]),q=s?d.get(s):null,P=q?w.find(m=>m.d.id===q.id):null;return e.jsxs("div",{className:"mapzone",ref:x,children:[e.jsxs("svg",{ref:p,viewBox:i.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":c==="fr"?i.fr:i.en,onMouseLeave:()=>{l(null),o(null)},children:[e.jsx("g",{children:i.countries.map((m,N)=>e.jsx("g",{className:"ct"+(m.i2&&j.get(m.i2)?"":" empty"),children:e.jsx("path",{d:m.d,"data-i2":m.i2||void 0})},N))}),e.jsx("g",{children:w.map(m=>{const N=_e[$e(m.d)],T=!!_(m.d),F=m.d.kind==="target",O=r&&F?Qe[X(m.d)]:N.c,L=!r&&U(m.d);return e.jsxs("g",{className:"co"+(L?" done":""),onMouseEnter:()=>{var E,D;const z=(E=x.current)==null?void 0:E.getBoundingClientRect(),M=(D=p.current)==null?void 0:D.createSVGPoint();if(M&&p.current&&z){M.x=m.x,M.y=m.y;const B=M.matrixTransform(p.current.getScreenCTM());l({x:B.x-z.left,y:B.y-z.top,label:m.d.name+" · "+(de(m.d.cc,c)||m.d.countryLabel||"")})}o(m.d.id)},onMouseLeave:()=>{l(null),o(null)},onClick:()=>{var E;const z=(E=p.current)==null?void 0:E.createSVGPoint();let M=null;if(z&&p.current){z.x=m.x,z.y=m.y;const D=z.matrixTransform(p.current.getScreenCTM());M={x:D.x,y:D.y}}a({type:"popup",id:m.d.id,anchor:M})},children:[e.jsx("circle",{className:"h",cx:m.x,cy:m.y,r:C(Math.max(11,N.px+7))}),e.jsx("circle",{className:"v",cx:m.x,cy:m.y,r:C(N.px),fill:O,stroke:T?"#DC2626":"#ffffff",strokeWidth:C(T?2.2:1.3)})]},m.d.id||m.d.name)})}),P&&e.jsx("circle",{className:"ring on",cx:P.x,cy:P.y,r:C(13),fill:"none",stroke:"#0F172A",strokeWidth:C(2)})]}),e.jsx("div",{className:"hov"+(v?" on":""),style:v?{left:v.x,top:v.y}:void 0,children:v==null?void 0:v.label}),e.jsx("div",{className:"legend",children:A.map((m,N)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":m.c}}),c==="fr"?m.fr:m.en," ",e.jsx("b",{children:m.n})]},N))}),n.some(m=>!m.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",u.notLocated," ",e.jsx("b",{children:n.filter(m=>!m.cc).length})]})})]})}function Sa(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:o,contName:s}=S(),d=t.filters,c=f.useMemo(()=>n.filter(h=>h.continent===t.continent),[n,t.continent]),u=h=>c.filter(g=>h!=="country"&&d.country.length&&!d.country.includes(g.cc||"")?!1:Oe(g,d,o,h==="country"?void 0:h)),p=f.useMemo(()=>{const h=u("win"),g=v=>h.filter(l=>(l.date?Math.max(0,Math.floor((Date.now()-Date.parse(l.date))/864e5)):9999)<=v).length;return[g(0),g(7),g(30),h.length]},[c,d,o]),x=f.useMemo(()=>{if(o)return null;const h=u("status"),g={all:h.length,todo:0,retenu:0,pending:0,ecarte:0};return h.forEach(v=>{g[re(v)]+=1}),g},[c,d,o]),i=d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length+(d.signalOnly?1:0)+(d.win!=="all"?1:0)+(!o&&d.status!=="all"?1:0)+(d.search.trim()?1:0),b=(h,g,v,l="fbtn")=>e.jsxs("button",{type:"button",className:l,"aria-expanded":t.openFacet===h,onClick:()=>a({type:"openFacet",facet:h}),children:[e.jsx("span",{className:"fl",children:g}),v>0&&e.jsx("span",{className:"n",children:v}),e.jsx("span",{className:"cv",children:"▾"})]},h);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((h,g)=>e.jsxs("button",{type:"button","aria-pressed":d.win===h,onClick:()=>a({type:"filters",patch:{win:h}}),children:[r.dates[g],e.jsx("b",{children:p[g]})]},h))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:d.search,onChange:h=>a({type:"filters",patch:{search:h.target.value}})})]}),!o&&x&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([h,g])=>e.jsxs("button",{type:"button","aria-pressed":d.status===h,onClick:()=>a({type:"filters",patch:{status:h}}),children:[g,e.jsx("b",{children:x[h]??0})]},h))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),d.signalOnly&&e.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),b("sec",r.fSector,d.sector.length),b("pay",r.fCountry,d.country.length),b("det",r.fEngine,d.engine.length),b("sta",r.fStage,d.stage.length),o&&b("ang","Angle",d.angle.length),o&&b("mem","Mémo",d.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),i>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(c.length,s),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(i)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(Ea,{poolFor:u})]})}function Ea({poolFor:t}){const{st:a,dispatch:n,t:r,lang:o}=S(),s=a.filters,d=a.openFacet,{title:c,cols:u,options:p}=f.useMemo(()=>{if(d==="sig"){const g=t("signal").filter(y=>_(y)),v=new Map;g.forEach(y=>{const j=y.engine||"";v.set(j,(v.get(j)||0)+1)});const l=[{v:"*",label:r.fpSigAll,n:g.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...Ue([...v.keys()],o).map(y=>({v:y,label:ie(y)+" "+ae(y,o),n:v.get(y)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(y)}))];return{title:r.fpSigTitle,cols:2,options:l}}if(d==="sec"){const g=t("sector"),v=new Map;return g.forEach(l=>{l.sector&&v.set(l.sector,(v.get(l.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((l,y)=>y[1]-l[1]).map(([l,y])=>({v:l,label:l,n:y,html:!1,on:s.sector.includes(l)}))}}if(d==="pay"){const g=t("country"),v=new Map;return g.forEach(l=>{l.cc&&v.set(l.cc,(v.get(l.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((l,y)=>y[1]-l[1]).map(([l,y])=>({v:l,label:de(l,o)||l,n:y,html:!1,on:s.country.includes(l)}))}}if(d==="det"){const g=t("engine"),v=new Map;return g.forEach(l=>{l.engine&&v.set(l.engine,(v.get(l.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:Ue([...v.keys()],o).map(l=>({v:l,label:ie(l)+" "+ae(l,o)+' <span style="color:var(--dim);font-size:10px">· '+Ft(Mt(l),o)+"</span>",n:v.get(l)||0,html:!0,on:s.engine.includes(l)}))}}if(d==="ang"){const g=t("angle"),v=new Map;return g.forEach(l=>{l.angle&&v.set(l.angle,(v.get(l.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((l,y)=>y[1]-l[1]).map(([l,y])=>({v:l,label:l.replace(/[_-]+/g," "),n:y,html:!1,on:s.angle.includes(l)}))}}if(d==="mem"){const g=t("memoLevel"),v=new Map;g.forEach(y=>{if(y.kind==="target"){const j=Ee(y);v.set(j,(v.get(j)||0)+1)}});const l=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(y=>({v:String(y),label:l[y],n:v.get(y)||0,html:!1,on:s.memoLevel.includes(y)}))}}const b=t("stage"),h=new Map;return b.forEach(g=>{g.stage&&h.set(g.stage,(h.get(g.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((g,v)=>v[1]-g[1]).map(([g,v])=>({v:g,label:g,n:v,html:!1,on:s.stage.includes(g)}))}},[d,a,o]),x=b=>{if(d==="sig"){if(b==="*")n({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const g=s.signalEngines.includes(b)?s.signalEngines.filter(v=>v!==b):[...s.signalEngines,b];n({type:"filters",patch:{signalOnly:!0,signalEngines:g}})}return}if(d==="mem"){n({type:"toggleMemoLevel",value:Number(b)});return}n({type:"toggleFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage",value:b})},i=()=>{n(d==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:d==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:c}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:i,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(u===2?" two":""),children:p.map(b=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":b.on,onClick:()=>x(b.v),children:[e.jsx("span",{className:"bx"}),b.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:b.label}}):e.jsx("span",{className:"l",children:b.label}),e.jsx("span",{className:"n",children:b.n})]},b.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const Xe=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Aa(){const{t,mode:a,token:n,askEvaluate:r,sessTally:o,dispatch:s,evalBusy:d,evalCards:c,caps:u,data:p}=S(),x=a==="client",[i,b]=f.useState(""),[h,g]=f.useState(!1),[v,l]=f.useState(""),[y,j]=f.useState(!1),[w,C]=f.useState(""),[A,q]=f.useState([]),P=f.useRef(!1),m=i.trim()?Xe.test(i.trim())?t.evalUrl:t.evalName:t.evalWaiting,N=f.useMemo(()=>v.split(`
`).map(z=>z.trim()).filter(Boolean).slice(0,15),[v]),T=A.length?A:c,F=p.credits,O=()=>{const z=i.trim();z&&(r(null,z),b(""))},L=async()=>{if(!x){r(null,N[0]||"");return}if(!N.length||y)return;j(!0),P.current=!1;const z=[];for(let M=0;M<N.length&&!P.current;M++){C(t.evaluating(M+1,N.length,N[M]));const E=await ot(n,N[M],"atelier2");if(z.unshift({name:E.company||N[M],verdict:E.verdict,reason:E.reason||"",remaining:E.remaining??null}),q([...z]),E.verdict==="quota"){z.unshift({name:"",verdict:"quota",reason:t.quota(N.length-M-1),remaining:0}),q([...z]);break}}C(""),l(""),j(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:i,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:z=>b(z.target.value),onKeyDown:z=>{z.key==="Enter"&&O()}}),e.jsx("span",{className:"detect"+(Xe.test(i.trim())?" url":""),children:m})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),disabled:d,onClick:O,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),u.showCredits&&F&&e.jsxs("button",{type:"button",className:"credits"+(F.total_available<=0&&!F.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:F.unlimited?"∞":F.total_available}),!F.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",F.daily_grant+F.purchased]}),F.total_available<=0&&!F.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>g(!h),children:t.evalMulti})}),h&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:v,placeholder:t.bulkPh,onChange:z=>l(z.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(y?" loading":""),style:{justifyContent:"center"},disabled:y||!N.length,onClick:()=>{L()},children:[e.jsx("span",{className:"fill"}),y&&w?w:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(N.length)})]})]}),T.slice(0,1).map((z,M)=>{const E=z.verdict==="kept",D=z.verdict==="quota",B=E?"var(--brand)":D?"var(--bolt)":"var(--red)",Y=E?"var(--brand-l)":D?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":B,"--bgc":Y},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:E?"✓ "+t.kept:D?"⏳":"✗ "+t.dropped})}),z.name&&e.jsx("span",{className:"rn",children:z.name}),e.jsx("span",{className:"rr",children:z.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",z.reason]}):null}),!D&&e.jsx("button",{type:"button",className:"go",onClick:()=>s({type:"modal",modal:"space"}),children:t.seeSpace(E?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},M)}),x&&(o.kept+o.dropped>0||T.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(o.kept,o.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Ta(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Fa(){const{st:t,dispatch:a,byId:n,t:r,doDeep:o}=S(),s=t.memoConsole?n.get(t.memoConsole):null,d=f.useMemo(()=>s?[s.reasoning||"",Ta(s.summary||"")].filter(Boolean).join(`

`):"",[s]);if(!s)return null;const c=Te(s),u=Ee(s);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:s.name}),c&&e.jsx("span",{className:"vv",children:c}),typeof s.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[s.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:d?d.split(`

`).map((p,x)=>e.jsx("p",{style:{margin:"0 0 10px"},children:p},x)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[Fe(s)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>o(s),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:u===2?r.critMemoKinds:""}),s.memoUrl&&e.jsx("a",{className:"go",href:s.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const ct={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function De({o:t}){const{t:a}=S(),n=ze(t),r=Te(t),o=X(t),s=Ce(t),d=Ot(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(ct[r]||"v-cons"),title:a.vt[r],children:r}):o===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,o===3&&s==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),o===3&&s==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),o===3&&d!==null&&e.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:a.waitTitle(d),children:a.waitChip(d)})]})}function Ze({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:o}=S(),[s,d]=f.useState(!1);if(f.useEffect(()=>{r||d(!1)},[r]),U(t)){const p=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":p?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[p?"✓":"✗"," ",e.jsx("b",{children:p?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const u=s&&r;return e.jsxs("button",{type:"button",className:"rev"+(u?" loading":""),disabled:r,onClick:p=>{p.stopPropagation(),d(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function Ma({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:o,doAnalyse:s,doDecide:d,doPromote:c,doApproach:u,dispatch:p}=S();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),p({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Ze,{o:t})});const x=X(t),i=b=>h=>{h.stopPropagation(),b()};if(x===0)return e.jsx("span",{className:"cell",children:e.jsx(Ze,{o:t})});if(x===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:i(()=>s(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(x===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:i(()=>d(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:i(()=>d(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:i(()=>p({type:"memoConsole",id:t.id})),children:"📄"})]})});if(x===4){const b=o.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:i(()=>u(t)),children:b?a.actApproachSent:a.actApproach})})}return x===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:i(()=>c(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:i(()=>p({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:i(()=>p({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function Oa({o:t}){const{t:a,doThumb:n}=S();return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up",title:a.thumbUp,onClick:r=>{r.stopPropagation(),n(t,!0),r.currentTarget.classList.add("on")},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn",title:a.thumbDn,onClick:r=>{r.stopPropagation(),n(t,!1),r.currentTarget.classList.add("on")},children:"👎"})]})}function La({o:t}){const{lang:a}=S();return _(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(pe,{o:t}),e.jsx(ye,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ie(t.engine||"")," ",ae(t.engine||"",a)]})})}function Da({o:t,locked:a,open:n,onToggle:r}){const{st:o,dispatch:s,caps:d,markRow:c,markedId:u,favIds:p,toggleFav:x}=S(),i=X(t),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],h=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,g=h<=0?0:h<=7?1:h<=30?2:3,v=d.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][i]:b[g],l=p.has(t.id),y=j=>{if(a)return;if(d.pipe){r();return}const w=j.currentTarget.getBoundingClientRect();s({type:"popup",id:t.id,anchor:{x:w.left+Math.min(280,w.width/3),y:w.bottom}})};return e.jsxs(f.Fragment,{children:[e.jsxs("div",{className:"row"+(u===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>c(t.id),onMouseLeave:()=>c(null),onClick:y,children:[e.jsx("span",{className:"pt",style:{"--c":v}}),e.jsx(ft,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[d.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:l?1:.35,padding:0,marginRight:4},onClick:j=>{j.stopPropagation(),x(t)},children:l?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(j=>j&&j!==t.name)||""})]}),e.jsx(Ra,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(La,{o:t}),d.pipe&&e.jsx(De,{o:t}),d.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(Ma,{o:t}),d.showThumbs&&e.jsx(Oa,{o:t})]}),(n||o.dens==="deplie")&&!a&&e.jsx(qa,{o:t})]})}function Ra({o:t}){const{lang:a,caps:n}=S();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=Me(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function qa({o:t}){const{t:a,lang:n,dispatch:r,caps:o,outbound:s,doOnboard:d}=S();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(ze(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:ze(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(De,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ie(t.engine||"")," ",ae(t.engine||"",n)]}),_(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(pe,{o:t})})]}),o.pipe&&(t.memoUrl||s)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),s&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(t),children:a.actOnboard})]})]})]})}function Ia({o:t,locked:a}){const{t:n,dispatch:r,caps:o,doDecide:s}=S(),d=X(t),c=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][d];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":c},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(De,{o:t}),_(t)&&e.jsx(pe,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&o.pipe&&d===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>s(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function Ba(){const t=S(),{st:a,dispatch:n,t:r,caps:o,scoped:s,lang:d,sessTally:c}=t,[u,p]=f.useState(new Set);f.useEffect(()=>{p(new Set)},[a.ptab,a.continent]);const x=w=>p(C=>{const A=new Set(C);return A.has(w)?A.delete(w):A.add(w),A}),i=f.useMemo(()=>Le(s,a.sort),[s,a.sort]),b=f.useMemo(()=>i.filter(w=>_(w)&&!U(w)).length,[i]),h=o.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,g=(w,C,A="",q=!1)=>e.jsxs("button",{type:"button","data-s":w,className:A,"aria-sort":a.sort.key===w?a.sort.dir===1?"ascending":"descending":"none",style:q?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:w}),children:[C,e.jsx("span",{className:"ar",children:a.sort.key===w&&a.sort.dir===1?"▴":"▾"})]},w),v=f.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const w=new Map;return i.forEach(C=>{const A=C.engine||"?";w.has(A)||w.set(A,[]),w.get(A).push(C)}),[...w.entries()]},[i,o.pipe,a.groupBy]),l=o.lockRowsAfter;let y=0;const j=(w,C)=>{const A=a.shown[C]||be,P=w.slice(0,A).map(m=>{const N=l!==null&&y>=l;return y++,a.dens==="maxi"?e.jsx(Ia,{o:m,locked:N},m.id):e.jsx(Da,{o:m,locked:N,open:u.has(m.id),onToggle:()=>x(m.id)},m.id)});return w.length>A&&P.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:C,by:be}),children:r.more(Math.min(be,w.length-A),w.length-A)},C+":more")),P};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:i.length})," ",h]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,o.pipe&&t.fund?" · "+t.fund:""]}),o.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),o.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([w,C])=>e.jsxs("button",{type:"button","data-d":w,"aria-pressed":a.dens===w,onClick:()=>n({type:"dens",dens:w}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:C})]},w))}),o.showChain&&i.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:i.filter(w=>o.pipe?!0:!U(w)).map(w=>w.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",o.pipe?r.browse(i.length):r.chainAll(i.filter(w=>!U(w)).length)]})]}),b>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(b)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),g("country",r.colCountry),g("name",r.colCompany),g("amount",r.colAmount,"h-amt",!0),g("stage",r.colStage,"h-stade"),g("signal",r.colSignal,"h-sig"),o.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),o.pipe&&g("score",r.colScore,"h-sc",!0),e.jsx("span",{}),o.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[v?v.map(([w,C])=>e.jsxs(f.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ie(w)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:ae(w,d)}),e.jsx("div",{className:"s",children:r.grpCount(C.filter(A=>!U(A)).length,C.length)})]})]}),j(C,w)]},w)):j(i,"pt"+a.ptab),!i.length&&e.jsx("div",{className:"void",children:o.pipe?r.emptyTab:r.emptyScope})]}),o.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(c.kept>0||c.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(c.kept,c.dropped)}})]})}const Pa=`
...
`;function _a(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,o=window.innerHeight,s=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let d=t.y+10;return d+n>o-8&&(d=Math.max(8,t.y-n-14)),d<8&&(d=8),{left:s,top:d}}function $a(){const{st:t,dispatch:a,byId:n,t:r,lang:o,caps:s,mode:d,askEvaluate:c,doAnalyse:u,doDecide:p,doPromote:x,doApproach:i,doDeep:b,doOnboard:h,outbound:g,evalBusy:v}=S(),l=t.popupId?n.get(t.popupId):null;if(!l)return null;const y=_(l),j=X(l),w=Te(l),C=l.kind==="target",A=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return ve.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Pa}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:_a(t.popupAnchor),onClick:q=>q.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:l.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(se(l.date)),ae(l.engine,o))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[l.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[l.cc]}),children:(de(l.cc,o)||l.countryLabel||"").toUpperCase()}),l.sector&&e.jsx("button",{type:"button",onClick:()=>A({sector:[l.sector]}),children:l.sector.toUpperCase()}),l.stage&&e.jsx("button",{type:"button",onClick:()=>A({stage:[l.stage]}),children:l.stage.toUpperCase()}),typeof l.amountEur=="number"&&l.amountEur>0&&e.jsx("span",{className:"am2",children:Me(l.amountEur,o)})]}),(l.tagline||l.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:l.tagline||l.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[ie(l.engine)," ",e.jsx("b",{children:ae(l.engine,o)})," — ",Lt(l.engine,o),l.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",l.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(pe,{o:l,lg:!0})," ",e.jsx(ye,{o:l,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(lt(y,o))," · ",r.win7(it(y,o))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),l.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:s.pipe&&j>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:l.reasoning})]}),s.pipe&&C&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof l.score=="number"&&l.score>0?" · "+r.score(l.score):""]})})]}),e.jsxs("div",{className:"pf",children:[s.lockActions||d!=="client"&&s.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):s.pipe?e.jsxs(e.Fragment,{children:[j===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>c(l),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),j===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{u(l),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),j===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(l),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),j===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(l,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{p(l,!1),a({type:"popup",id:null})},children:r.actNo}),Fe(l)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(l),a({type:"popup",id:null})},children:r.memoDeep})]}),j===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{i(l),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),j===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(l),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),"↩ ",r.statusKeep.replace("✅ ","")]}),l.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:l.id}),a({type:"popup",id:null})},children:"📄"}),g&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{h(l),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>c(l),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),l.website&&e.jsx("a",{className:"psite",href:l.website.startsWith("http")?l.website:"https://"+l.website,target:"_blank",rel:"noopener noreferrer",title:l.website,children:"🌐"})]})]})]}),document.body)}const xe="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Z({title:t,icon:a,children:n,wide:r}){const{dispatch:o}=S();return ve.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&o({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function Ua(){const{st:t}=S();switch(t.modal){case"chain":return e.jsx(Va,{});case"space":return e.jsx(Ya,{});case"alert":return e.jsx(Ga,{});case"queue":return e.jsx(Qa,{});case"export":return e.jsx(Ja,{});case"plug":return e.jsx(Xa,{});case"recharge":return e.jsx(Za,{});case"cover":return e.jsx(er,{});case"crit":return e.jsx(tr,{});case"tuto":return e.jsx(ar,{});case"rdv":return e.jsx(Ha,{});default:return null}}function Ha(){const{dispatch:t,fund:a}=S(),n=typeof document<"u"&&!!document.getElementById("rdv");return f.useEffect(()=>{n&&(t({type:"modal",modal:null}),xa())},[n,t]),n?null:e.jsx(Dt,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function Va(){const{st:t,dispatch:a,byId:n,t:r,lang:o,mode:s,askEvaluate:d,evalBusy:c}=S(),u=s==="client",p=t.chain.queue.map(h=>n.get(h)).filter(h=>!!h),x=t.chain.idx,i=p[x],b=x>=p.length;return ve.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:b?r.finished:`${x+1} / ${p.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(b?100:x/Math.max(1,p.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:b||!i?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(p.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:i.name}),e.jsx("div",{className:"sub",children:[de(i.cc,o)||i.countryLabel,i.sector,i.stage,r.daysAgo(se(i.date))].filter(Boolean).map(h=>String(h).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:ae(i.engine,o).toUpperCase()}),typeof i.amountEur=="number"&&i.amountEur>0&&e.jsx("span",{children:Me(i.amountEur,o)})]}),_(i)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(pe,{o:i,lg:!0})," ",e.jsx(ye,{o:i,src:!0})]}),(i.tagline||i.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:i.tagline||i.headline})]}),i.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:i.reasoning})]}),u&&U(i)&&e.jsxs("div",{className:"vbox",style:{"--c":re(i)==="retenu"?"var(--brand)":re(i)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:re(i)==="retenu"?"✓ "+r.kept:re(i)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:i.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!b&&i&&!(u&&U(i))&&e.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:c,onClick:()=>{d(i)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?r.closeBtn:r.skip})]})]})})}),document.body)}function Ya(){const{st:t,dispatch:a,dossiers:n,t:r,mode:o}=S(),s=o==="client",d=f.useMemo(()=>s?n.filter(i=>U(i)):[],[n,s]),c=f.useMemo(()=>Le(d.filter(i=>re(i)==="retenu"),{key:"signal",dir:-1}),[d]),u=f.useMemo(()=>d.filter(i=>re(i)==="ecarte"),[d]),p=t.spaceTab==="retenu"?c:u,x=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(Z,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:c.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:u.length})]})]}),p.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),p.slice(0,40).map(i=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":x},children:typeof i.score=="number"&&i.score>0?i.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:i.name}),e.jsx("div",{className:"rr",children:i.reasoning||i.tagline||""})]})]},i.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function Ga(){const{mode:t}=S();return t==="client"||t==="apercu"?e.jsx(Wa,{}):e.jsx(Ka,{})}function Wa(){const{t,token:a,flash:n,mode:r}=S(),[o,s]=f.useState(null),d=r!=="client";f.useEffect(()=>{let u=!0;return Ye(a).then(p=>{u&&s(p)}),()=>{u=!1}},[a]);const c=u=>{d||Ye(a,u).then(p=>{p&&(s(p),n(t.alertSaved))})};return e.jsx(Z,{title:t.alertTitle,icon:"🔔",children:o?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:d,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>c({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>c({hour:Math.max(6,(o.hour??7)-1)}),disabled:d,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>c({hour:Math.min(21,(o.hour??7)+1)}),disabled:d,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:d,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:d,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"daily"}),children:t.alertEveryday})]})]}),o.email_lead&&e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]})]}):e.jsx("div",{className:"sp-empty",children:"…"})})}function Ka(){const{st:t,t:a,lang:n,scoped:r,contName:o}=S(),[s,d]=f.useState(""),[c,u]=f.useState(!1),[p,x]=f.useState(!1),i=t.filters,b=f.useMemo(()=>r.filter(l=>_(l)).length,[r]),h=i.win==="1"?0:i.win==="7"?1:i.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(s)||p)){x(!0);try{await fetch(`${Se}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:i.sector,countries:i.country,source:"atelier2",website:""})}),u(!0)}finally{x(!1)}}},v=[[a.amRows.continent,o],[a.amRows.since,a.amSince[h]],[a.amRows.signal,i.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,i.engine.length?i.engine.map(l=>ae(l,n)).join(", "):a.amAllEngines],[a.amRows.sectors,i.sector.length?i.sector.join(", "):a.amAllSectors],[a.amRows.countries,i.country.length?i.country.map(l=>de(l,n)||l).join(", "):a.amAllCountries],[a.amRows.stages,i.stage.length?i.stage.join(", "):a.amAllStages]];return e.jsx(Z,{title:a.alertTitle,icon:"🔔",children:c?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:v.map(([l,y])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:l}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},l))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,onChange:l=>d(l.target.value),onKeyDown:l=>{l.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,b)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function Qa(){var v,l,y;const{t,token:a,fund:n,mode:r,flash:o}=S(),[s,d]=f.useState(null),[c,u]=f.useState([]),[p,x]=f.useState(0),i=r==="client";f.useEffect(()=>{let j=!0;return(async()=>{const[w,C]=await Promise.all([at(n),rt(a)]);j&&(w&&d(w),u(C))})(),()=>{j=!1}},[a,n,p]);const b=(s==null?void 0:s.per_day)??2,h=((v=s==null?void 0:s.analyzed_today)==null?void 0:v.length)??0,g=(l=s==null?void 0:s.tomorrow)!=null&&l.length?s.tomorrow:((s==null?void 0:s.pool_meta)||[]).slice(0,10);return e.jsxs(Z,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(h,h+(((y=s==null?void 0:s.pool_order)==null?void 0:y.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(j=>e.jsx("button",{type:"button",className:"qr"+(b===j?" on":""),disabled:!i,onClick:()=>{nt(a,j).then(w=>{w!==null&&(x(C=>C+1),o(t.alertSaved))})},children:e.jsxs("b",{children:[j,"/j"]})},j))})]}),c.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:c.map(j=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:j.company}),e.jsxs("span",{className:"qd",children:[j.memo_type,typeof j.est_min=="number"?` · ~${j.est_min} min`:""]}),e.jsx("span",{className:"qt",children:j.status}),j.url&&e.jsx("a",{className:"qgo",href:j.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),i&&j.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Ve(a,j.company,"retry").then(()=>x(w=>w+1))},children:t.queueRetry}),i&&j.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{Ve(a,j.company,"delete").then(()=>x(w=>w+1))},children:t.queueDelete})]},j.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[g.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),g.slice(0,10).map((j,w)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",w+1]}),e.jsx("b",{children:j.name}),typeof j.score=="number"&&e.jsx("span",{className:"qs2",children:j.score})]},j.name))]})]})}function Ja(){const{t,token:a,flash:n}=S(),r=`${xe}/cibles/list.csv?token=${a}`,o=`${xe}/cibles/list.json?token=${a}`,s=`${xe}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${r}")`,c=p=>{var x;(x=navigator.clipboard)==null||x.writeText(p).then(()=>n(t.exportCopied))},u=[{def:t.exportCsv,value:r,href:r},{def:t.exportSheet,value:d},{def:t.exportLive,value:o,href:o},{def:t.exportXlsx,value:s,href:s}];return e.jsxs(Z,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),e.jsx("div",{className:"expl",children:u.map(({def:p,value:x,href:i})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:p[0]}),e.jsxs("div",{children:[e.jsx("b",{children:p[1]}),e.jsx("p",{children:p[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>c(x),children:t.exportCopy}),i&&e.jsx("a",{className:"exb",href:i,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},p[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function Xa(){const{t,token:a,flash:n,mode:r}=S(),[o,s]=f.useState(null),[d,c]=f.useState(""),u=r==="client";f.useEffect(()=>{let i=!0;return He(a).then(b=>{i&&b&&s(b)}),()=>{i=!1}},[a]);const p=(i,b)=>{u&&He(a,i).then(h=>{h&&h.ok!==!1&&(n(b),s({configured:!i.remove&&(i.url?!0:o==null?void 0:o.configured),url_hint:h.url_hint}))})},x='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(Z,{title:t.plugTitle,icon:"🔌",children:[e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugWebhook}),e.jsxs("p",{children:[t.plugWebhookHint,o!=null&&o.configured?` — ${t.plugConfigured}${o.url_hint?` (${o.url_hint})`:""}`:""]}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:"https://…",value:d,onChange:i=>c(i.target.value),disabled:!u}),e.jsx("button",{type:"button",className:"abtn p",disabled:!u||!d.trim(),onClick:()=>p({url:d.trim()},t.alertSaved),children:t.plugSave}),e.jsx("button",{type:"button",className:"abtn",disabled:!u||!(o!=null&&o.configured),onClick:()=>p({test:!0},t.plugTest+" ✓"),children:t.plugTest}),e.jsx("button",{type:"button",className:"abtn",disabled:!u||!(o!=null&&o.configured),onClick:()=>p({remove:!0},t.plugRemove+" ✓"),children:t.plugRemove})]})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugMcp}),e.jsx("p",{children:t.plugMcpHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{readOnly:!0,value:x}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var i;(i=navigator.clipboard)==null||i.writeText(x).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Za(){const{t,data:a,lang:n}=S(),r=a.credits,o=a.email,s=async d=>{if(!o)return;const c=window.location.href.split("?")[0];try{const p=await(await fetch(`${Se}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:c+"?credits=ok",cancel_url:c+"?credits=cancel"})})).json();p.url&&(window.location.href=p.url)}catch{}};return e.jsxs(Z,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(d=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(d.credits,d.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{s(d.lookup_key)},children:t.rechargeBuy})]},d.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function er(){const{t,data:a,dossiers:n}=S(),r=n.filter(s=>s.kind==="target"&&U(s)).length,o=a.marketEstimate||0;return e.jsx(Z,{title:t.coverTitle,icon:"🌍",children:o>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,o)}}):e.jsx("p",{children:t.coverScreened(r)})})}function tr(){const{t,dossiers:a,token:n,mode:r,flash:o}=S(),s=r==="client",d=f.useMemo(()=>{const l=new Set;return a.forEach(y=>{y.angle&&l.add(y.angle)}),[...l]},[a]),[c,u]=f.useState(null);f.useEffect(()=>{let l=!0;return Rt(n).then(y=>{l&&u(y.thumbs)}),()=>{l=!1}},[n]);const[p,x]=f.useState(""),[i,b]=f.useState(""),[h,g]=f.useState(!1),v=async()=>{const l=p.trim();if(!(!l||h||!s)){g(!0),b("");try{const j=await(await fetch(`${xe}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:l,who:"atelier2"})})).json().catch(()=>({}));if(j.reply&&b(String(j.reply)),j.job_id){b(t.critChatRunning);const w=async()=>{const C=await fetch(`${xe}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:j.job_id})}).then(A=>A.json()).catch(()=>null);if(C&&C.done){b(String(C.reply||C.clarification||C.summary||"✓")),g(!1),C.applied&&o(t.alertSaved);return}setTimeout(()=>{w()},8e3)};setTimeout(()=>{w()},8e3),x("");return}x("")}finally{i.startsWith("⏳")||g(!1)}}};return e.jsxs(Z,{title:t.critTitle,icon:"⚙",wide:!0,children:[d.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:d.map(l=>e.jsx("li",{style:{marginBottom:5},children:l.replace(/[_-]+/g," ")},l))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:p,disabled:!s||h,onChange:l=>x(l.target.value),onKeyDown:l=>{l.key==="Enter"&&v()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(h?" loading":""),style:{padding:"12px 18px"},disabled:!s||h||!p.trim(),onClick:()=>void v(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),i&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:i})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((l,y)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:l.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:l.company}),e.jsx("span",{className:"qd",children:(l.ts||"").slice(0,10)})]},y))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([l,y])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(ct[l]||"v-cons"),children:l}),e.jsx("span",{children:y})]},l))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([l,y])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:l}),e.jsxs("span",{children:["← ",y]})]},l))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function ar(){const{t}=S();return e.jsx(Z,{title:t.tutoTitle,icon:"▶",children:e.jsx("ol",{className:"steps2",children:t.tutoSteps.map(([a,n],r)=>e.jsxs("li",{children:[e.jsx("b",{children:a}),e.jsx("span",{children:n})]},r))})})}const ut=f.createContext(null),S=()=>{const t=f.useContext(ut);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function pe({o:t,lg:a}){const{lang:n}=S(),r=_(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ge(r,n),children:[r.emoji," ",Ge(r,n)]}):null}function ye({o:t,src:a}){const{lang:n,t:r}=S(),o=_(t);if(!o)return null;const s=_t(o),d=$t(o);return e.jsxs("em",{className:"sigwin"+(d?" hot":""),title:r.signaledOn(lt(o,n))+" · "+r.win7(it(o,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(c,u)=>e.jsx("i",{className:u<s?"on":""},u))}),e.jsx("span",{className:"lb",children:d?r.lastDay:r.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&e.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:c=>c.stopPropagation(),children:"↗"})]})}function ft({o:t}){const{lang:a}=S(),n=Pt(t.cc),r=t.cc?de(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const et="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap";function ir({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:o,onFiltersChange:s}){const{lang:d}=qt(),c=Qt[d],u=ia(t,d,a),[p,x]=f.useReducer(da,void 0,()=>sa((r==null?void 0:r.continent)??"europe",t,{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),i=f.useRef(s);i.current=s,f.useEffect(()=>{var k;(k=i.current)==null||k.call(i,p.filters)},[p.filters]);const[b,h]=f.useState(null),[g,v]=f.useState(null),[l,y]=f.useState({kept:0,dropped:0}),[j,w]=f.useState(!1),[C,A]=f.useState(""),[,q]=f.useState(0),P=()=>q(k=>k+1),m=f.useRef([]),N=f.useRef(new Set),T=f.useRef(new Set),F=f.useRef(null),{mode:O}=u,L=f.useMemo(()=>o?{...u.caps,...o}:u.caps,[u.caps,o]),z=L.pipe,M=u.session.token||"",E=O==="client"&&!t;f.useEffect(()=>{if(document.querySelector(`link[href="${et}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=et,document.head.appendChild(k)},[]);const D=k=>{A(k),F.current&&clearTimeout(F.current),F.current=setTimeout(()=>A(""),2400)},B=f.useMemo(()=>{const k=new Map;return u.dossiers.forEach(R=>{R.id&&k.set(R.id,R)}),k},[u.dossiers]),Y=f.useMemo(()=>u.dossiers.filter(k=>dt(k,p,z)),[u.dossiers,p,z]),ee=f.useMemo(()=>u.dossiers.filter(k=>pa(k,p,z,u.favIds)),[u.dossiers,p,z,u.favIds]),K=f.useMemo(()=>It(Y,u.favIds),[Y,u.favIds]),G=Ae.find(k=>k.key===p.continent),H=d==="fr"?G.fr:G.en,I=(k,R)=>{const V=((k==null?void 0:k.name)||R||"").trim();if(!E){v({kicker:V});return}!V||j||(w(!0),(async()=>{try{const J=await ot(M,V,"atelier2"),vt={name:J.company||V,verdict:J.verdict,reason:J.reason||"",remaining:J.remaining??null};m.current=[vt,...m.current].slice(0,8),J.verdict==="kept"&&y(ne=>({...ne,kept:ne.kept+1})),J.verdict==="ruled_out"&&y(ne=>({...ne,dropped:ne.dropped+1}));const fe=k||u.dossiers.find(ne=>(ne.name||"").toLowerCase()===V.toLowerCase());fe&&(J.verdict==="kept"?fe.verdict=fe.verdict||"MATCH":J.verdict==="ruled_out"&&(fe.verdict="NO MATCH"),J.reason&&(fe.reasoning=J.reason)),P()}finally{w(!1)}})())},te=k=>{if(!E){v({kicker:k.name});return}N.current.add(k.id),ge(M,"fast_request",k.name||"",""),D(c.memoInstantSent(k.name)),P()},Q=k=>x({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:k.ceoStatus||""}}),ce=(k,R)=>{E&&(Q(k),je(M,{status:R?"Validé":"Écarté",airtable_id:k.airtableId,check_id:k.checkId,company:k.name}),k.ceoStatus=R?"Validé":"Écarté",P())},ue=k=>{E&&(Q(k),je(M,{status:"À trancher",airtable_id:k.airtableId,check_id:k.checkId,company:k.name}),k.ceoStatus="À trancher",D(c.promoted(k.name)),P())},le=()=>{const k=p.undo[p.undo.length-1];if(!k){D(c.undoNone);return}const R=B.get(k.id);if(x({type:"undoPop"}),!R){D(c.undoNone);return}let V=k.prevCeoStatus;if(!V)if((R.verdict||"").toUpperCase().includes("CALL"))V="À trancher";else{D(c.undoLockedTitle);return}je(M,{status:V,airtable_id:R.airtableId,check_id:R.checkId,company:R.name}),R.ceoStatus=k.prevCeoStatus,D(c.undoDone(R.name)),P()},W=k=>{E&&(T.current.add(k.id),P(),(async()=>{const R=await Ut(M,k.name,"email");D(R&&R.ok!==!1?c.actApproachSent:c.loadError)})())},$=(k,R)=>{E&&(ge(M,R?"yes":"no",k.name||"",""),D(R?c.thumbUpDone:c.thumbDnDone))},xt=k=>{!E||!Fe(k)||(ge(M,"detailed_request",k.name||"",""),D(c.memoDeepSent(k.name)))},mt=k=>{const R=new Set(u.favIds),V=R.has(k.id);V?R.delete(k.id):R.add(k.id),u.setFavIds(R),E&&Ht(M,{id:k.id,co:k.name},V)},gt=()=>{E&&(Vt(M),D(c.identSyncDone))},Re=/proplace/i.test(u.fund||""),ht=k=>{!E||!Re||(ge(M,"onboard_request",k.name||"",""),D(c.onboardSent(k.name)))},bt={st:p,dispatch:x,t:c,lang:d,mode:O,caps:L,pipe:z,token:M,fund:u.fund,email:u.email,data:u,dossiers:u.dossiers,scopedAll:Y,scoped:ee,counts:K,byId:B,contName:H,favIds:u.favIds,toggleFav:mt,askEvaluate:I,doAnalyse:te,doDecide:ce,doPromote:ue,doApproach:W,doThumb:$,doDeep:xt,doUndo:le,doSync:gt,doOnboard:ht,outbound:Re,memoQueued:N.current,approachDone:T.current,sessTally:l,evalCards:m.current,evalBusy:j,markRow:h,markedId:b,flash:D};return f.useEffect(()=>{const k=R=>{R.key==="Escape"&&(x({type:"popup",id:null}),x({type:"modal",modal:null}),x({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]),e.jsx(ut.Provider,{value:bt,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Zt}),e.jsxs("div",{className:"app"+(z?" pipe":""),children:[L.showTicker&&e.jsx(ca,{}),L.showIdent&&e.jsx(va,{}),L.showOnb&&e.jsx(ya,{}),e.jsx(ba,{}),L.showFunnel&&e.jsx(rr,{}),L.showFunnel&&e.jsx(ka,{}),L.showFunnel&&e.jsx(Na,{}),e.jsxs("div",{className:"fzone",children:[e.jsx(nr,{}),e.jsxs("div",{className:"stage"+(p.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(za,{}),e.jsx(Sa,{})]})]}),L.showDemand&&e.jsx(Aa,{}),L.showDemand&&p.memoConsole&&e.jsx(Fa,{}),e.jsx(Ba,{}),u.loading&&e.jsx("div",{className:"void",children:c.loadingV2}),u.error&&!u.loading&&e.jsxs("div",{className:"void",children:[c.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:u.refresh,children:c.retry})]})]}),L.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:c.lockbarText}),e.jsx("button",{type:"button",onClick:()=>x({type:"modal",modal:"rdv"}),children:c.lockbarCta})]}),p.popupId&&e.jsx($a,{}),e.jsx(Ua,{}),e.jsx(ga,{}),C&&e.jsx("div",{className:"flash on",children:C}),g&&e.jsx(Bt,{variant:"acquirer",initialCompany:tt().co,initialWebsite:tt().site,onClose:()=>v(null)})]})})}function rr(){const{t}=S(),[a,n]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function nr(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:o,t:s}=S(),d=f.useMemo(()=>{const c={};return t.forEach(u=>{u.continent&&Oe(u,a.filters,r)&&(c[u.continent]=(c[u.continent]||0)+1)}),c},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Yt.map(c=>{const u=Ae.find(p=>p.key===c);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===c,onClick:()=>n({type:"continent",key:c}),children:[o==="fr"?u.fr:u.en,e.jsx("span",{className:"n",children:d[c]||0})]},c)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?s.showMap:s.hideMap})})]})}function tt(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function or(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{ft as FlagCell,pe as SigBadge,ye as SigWin,ir as default,or as fmtShort,S as useV2};
