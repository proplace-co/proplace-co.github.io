...
`,Vi=Ui+Hi;function Wa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Wi(){const e=Wa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Yi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Wi();return r==="0"?"client":r==="1"||Wa("embed")==="1"&&Wa("chrome")==="1"?"apercu":"client"}const Gi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ki=e=>Gi[e];function fa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const xt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!jr(a)||fa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:qo(e.cc)})};function qa(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Qi=60*60*1e3;function Ji(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Qi?null:a}catch{return null}}function ea(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Xi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Zi(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:wo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Yi(e,i),[e,i,n]),l=m.useMemo(()=>Ki(o),[o]),d=o!=="visiteur",c=Xi(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[h,p]=m.useState(null),[b,y]=m.useState(null),[g,j]=m.useState(null),[N,w]=m.useState(()=>new Map),[C,T]=m.useState(()=>new Map),[A,L]=m.useState(""),[z,S]=m.useState(new Set),[R,I]=m.useState(null),[M,F]=m.useState(!0),[v,q]=m.useState(!1),[H,B]=m.useState(0),[_,V]=m.useState(0),G=m.useRef(0),ee=m.useMemo(()=>{var te;if(o!=="client")return"";try{return((te=ko())==null?void 0:te.email)||""}catch{return""}},[o]);m.useEffect(()=>{const te=++G.current;let we=!0;const K=()=>we&&te===G.current,re=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),me=Ji(re);return me?(s(me.objs.map(xt)),me.fund&&u(me.fund),p(me.marketEstimate??null),y(me.criteria??null),j(me.stats??null),L(me.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const ve=await Ta(),ye=((ve==null?void 0:ve.recent_ops)||[]).map(Q=>{const X=ca(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),Y=String(Q.rubrique||"").toLowerCase();return X&&(Y==="nominations"||Y==="recrutements")&&(X.engine=Y),X&&!String(Q.company_name||"").trim()&&(X.noCo=!0),X}).filter(Q=>!!Q).map(Q=>(jr((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=jo(),X=Q&&Q.doc||await No(),Y=So(X),Z=((Q==null?void 0:Q.day)||(X==null?void 0:X.date)||"").slice(0,10);if(Z&&Y.length){const ke=new Set;for(const oe of ye){if((oe.date||"").slice(0,10)!==Z)continue;const pe=En(Y,ke,oe.name,"");pe>=0&&(ke.add(pe),oe.decryptHtml=Y[pe].html)}for(const oe of ye){if(oe.decryptHtml||(oe.date||"").slice(0,10)!==Z)continue;const pe=En(Y,ke,"",oe.headline||oe.tagline||oe.name);pe>=0&&(ke.add(pe),oe.decryptHtml=Y[pe].html)}}if(Z){const ke=((X==null?void 0:X.title_fr)||"").trim(),oe=((X==null?void 0:X.lead_fr)||"").trim(),pe=Eo(X),fe=((X==null?void 0:X.url)||"").trim();ke&&(pe||fe)&&ye.unshift({id:`edito:${Z}`,kind:"op",name:ke,cc:null,date:Z,engine:"edito",dealKind:"other",headline:oe||ke,tagline:oe||ke,decryptHtml:pe||void 0,url:fe,noCo:!0})}}catch{}if(!K())return;s(ye.map(xt)),ea(re,{objs:ye})}else if(typeof r=="object"){const ye=(await Cn()||[]).filter(X=>(X.slug||"")===r.research).map(X=>zn(X,a)).filter(X=>!!X),Q=qa(await An(ye,a));if(!K())return;s(Q.map(xt)),ea(re,{objs:Q})}else if(d&&i.token){const ve=Co(i.token),ye=Ta(),Q=zo(i.token),X=Ao(i.token),Y=To(i.token),Z=await ve;let ke=Z?Z.targets:[];K()&&Z&&(u(Z.fund||""),p(Z.marketEstimate??null),y(Z.criteria??null),j(Z.stats??null),L(Z.generatedAt||""),s(ke.map(xt)),F(!1),q(!1));const[oe,pe,fe,ae]=await Promise.all([ye,Q,X,Y]),Fe=((oe==null?void 0:oe.recent_ops)||[]).map(Ae=>ca(Ae,a)).filter(Ae=>!!Ae);if(ke=[...ke,...Fe],!K())return;s(ke.map(xt));const Ne=new Set;for(const Ae of pe){const $e=(Ae.id||Ae.co||"").toString().trim().toLowerCase();$e&&Ne.add($e.startsWith("t:")?$e:"t:"+$e)}S(Ne),w(fe),T(ae),Z&&ea(re,{fund:Z.fund,marketEstimate:Z.marketEstimate,criteria:Z.criteria,stats:Z.stats,generatedAt:Z.generatedAt,objs:ke})}else{const ve=Lo(),ye=Cn(),Q=Ta(),X=await ve;K()&&X.length&&(s(qa(X).map(xt)),F(!1),q(!1));const[Y,Z]=await Promise.all([ye,Q]),ke=(Y||[]).map(ae=>zn(ae,a)).filter(ae=>!!ae),oe=await An(ke,a),pe=((Z==null?void 0:Z.recent_ops)||[]).map(ae=>ca(ae,a)).filter(ae=>!!ae),fe=qa([...X,...oe,...pe]);if(!K())return;s(fe.map(xt)),ea(re,{objs:fe})}K()&&q(!1)}catch{K()&&!me&&q(!0)}finally{K()&&F(!1)}})(),()=>{we=!1}},[d,i.token,a,H,c]),m.useEffect(()=>{if(!l.showCredits||!ee){I(null);return}let te=!0;return(async()=>{try{const we=await fetch(`${dn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ee})});if(!we.ok)return;const K=await we.json();te&&K&&K.ok!==!1&&I(K)}catch{}})(),()=>{te=!1}},[l.showCredits,ee,_]);const le=m.useCallback(te=>S(new Set(te)),[]);return{session:i,mode:o,caps:l,fund:x,email:ee,marketEstimate:h,generatedAt:A,criteria:b,stats:g,thumbs:N,stages:C,dossiers:f,favIds:z,setFavIds:le,credits:R,reloadCredits:()=>V(te=>te+1),loading:M,error:v,refresh:()=>B(te=>te+1)}}function it(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Cr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),es=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Cr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ts=new Set(["signal","amount","score","crible","memo"]);function as(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Cr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ts.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??zr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const zr=80;function xa(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Re(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(cn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(ct(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&gt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Ar(e,a,r){return it(e)?xa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:xa(e,a.filters,r)}function ns(e,a,r,n){return!(!Ar(e,a,r)||r&&!Mo(e,a.ptab,n))}function fn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ct(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Fo(i);case"memo":return Ro(i);case"signal":{const o=Re(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const Ma={},In=(Ma==null?void 0:Ma.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Bn(){return new Date().toISOString().slice(0,10)}const xn=m.createContext(null);function Tr(){return m.useContext(xn)}function rs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const f=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(c.setAttribute("href",f),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function $n(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Lr(){const e=m.useContext(xn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function os({token:e,children:a}){const{dispatch:r,st:n,lang:i}=$(),[o,l]=m.useState(()=>n.filters.day||Bn()),[d,c]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(Bn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var j;const g=(j=y.detail)==null?void 0:j.day;typeof g=="string"&&x(g)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${In}/cibles/edition.json?${y}`).then(g=>g.json()).then(g=>{b||c(g)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const h=m.useMemo(()=>`${In}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:d,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:h,isEn:i==="en"}),[e,o,d,f,x,u,n.filters.day,h,i]);return t.jsx(xn.Provider,{value:p,children:a})}function is(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Lr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Oo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})]})}function ss(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Lr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:$n(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:$n(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const ls=300,ta=7,ds={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},qr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},cs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ra(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Bo(r)&&r!=="media")return"news:"+r;const n=Re(e);return n?"sig:"+(n.theme&&qr.fr[n.theme]?n.theme:"other"):"actualites"}function ps(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=$(),c=Tr(),f=l==="en",[s,x]=m.useState("all"),[u,h]=m.useState(!1),p=m.useMemo(()=>{var we;const v=(a.filters.day||"").slice(0,10),q=K=>!(!o&&a.continent!=="monde"&&K.continent!==a.continent||v&&(K.date||"").slice(0,10)!==v),H=e.filter(K=>q(K)&&Re(K)&&(!o||K.kind!=="target"||qe(K)!==5)),B=o&&(((we=c==null?void 0:c.ed)==null?void 0:we.ops)||[]).length?c.ed.ops.map(K=>ca(K,l)).filter(K=>!!K).filter(K=>!v||(K.date||"").slice(0,10)===v):[],_=e.filter(K=>q(K)&&K.kind==="op"&&(v?!0:ct(K.date)<=ta)),V=o?B.length?B:_.filter(K=>{const re=(d||"").trim().toLowerCase();if(!re)return!1;const me=K.match||null;return me?Object.keys(me).map(ve=>ve.trim().toLowerCase()).includes(re):!1}):_,G=v||new Date().toISOString().slice(0,10),ee=K=>{const re=Ra(K);return re==="ma"?0:re==="levees"?1:2};V.sort((K,re)=>{const me=ee(K)-ee(re);if(me)return me;const ve=(K.date||"").slice(0,10)===G?0:1,ye=(re.date||"").slice(0,10)===G?0:1;return ve!==ye?ve-ye:(re.amountEur||0)-(K.amountEur||0)});const le=new Set,te=[];for(const K of[...V,...fn(H,{key:"signal",dir:-1})]){const re=K.id||K.name;!re||le.has(re)||(le.add(re),te.push(K))}return o&&te.length===0?e.filter(re=>q(re)&&ct(re.date)<=ta).sort((re,me)=>(me.date||"").localeCompare(re.date||"")).slice(0,80):te},[e,a.continent,a.filters.day,o,d,l,c]),b=m.useMemo(()=>{const v={};for(const q of p){const H=Ra(q);v[H]=(v[H]||0)+1}return v},[p]),y=m.useMemo(()=>s==="all"?p:p.filter(v=>Ra(v)===s),[p,s]),g=m.useMemo(()=>y.slice(0,ls),[y]),j=y.length-g.length,N=m.useRef(null);m.useEffect(()=>{var V,G;const v=N.current;if(!v)return;const q=()=>{const ee=v.scrollWidth;ee<200||(v.style.animationDuration=Math.max(18,Math.round(ee/130))+"s")};q();const H=requestAnimationFrame(q),B=window.setTimeout(q,1200);let _=!0;return(G=(V=document.fonts)==null?void 0:V.ready)==null||G.then(()=>{_&&q()}),()=>{_=!1,cancelAnimationFrame(H),window.clearTimeout(B)}},[g.length,s]);const w=v=>v==="all"?p.length:b[v]||0,C=v=>{if(v==="all")return f?"All":"Tout";if(v.startsWith("sig:"))return qr[f?"en":"fr"][v.slice(4)]||"🔔";if(v.startsWith("news:")){const q=v.slice(5);return Do[q]?Io(q,f?"en":"fr"):v}return ds[f?"en":"fr"][v]},T=[{k:"all"}],A=["ma","levees"].filter(v=>w(v)>0||v===s);if(A.length){T.push({g:f?"Deals":"Opérations"});for(const v of A)T.push({k:v})}const L=["nominations","recrutements"].filter(v=>w(v)>0||v===s),z=Po.filter(v=>v!=="media").map(v=>"news:"+v).filter(v=>w(v)>0||v===s),S=w("actualites")>0||s==="actualites"?["actualites"]:[];if(L.length||z.length||S.length){T.push({g:f?"News":"Actualités"});for(const v of L)T.push({k:v});for(const v of z)T.push({k:v});for(const v of S)T.push({k:v})}const R=cs.map(v=>"sig:"+v).filter(v=>w(v)>0||v===s);if(R.length){T.push({g:f?"Signals (your engines)":"Signaux (vos moteurs)"});for(const v of R)T.push({k:v})}const I=v=>{try{return new Date(v+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return v}},M=(()=>{const v=(a.filters.day||"").slice(0,10),q=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return v?(f?`LIVE covers the events of ${I(v)}.`:`Le LIVE regroupe les événements du ${I(v)}.`)+q:(f?`LIVE covers the still-open signals and the deals of the last ${ta} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ta} derniers jours.`)+q})(),F=v=>g.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ie(q)?" spent":""),onClick:H=>{if(n({type:"focus",id:q.id}),a.dens!=="liste"){const B=H.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:B.left+B.width/2,y:B.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(wt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(mo,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Dd(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Ea,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},v+(q.id||q.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},v+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:v=>{v.currentTarget.contains(v.relatedTarget)||h(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>h(v=>!v),children:[C(s),t.jsx("b",{children:w(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:M}),T.map(v=>"g"in v?t.jsx("span",{className:"tkfilg",children:v.g},v.g):t.jsxs("button",{type:"button","aria-pressed":v.k===s,onClick:()=>{x(v.k),h(!1)},children:[C(v.k),t.jsx("b",{children:w(v.k)})]},v.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",ref:N,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsx(ms,{isEn:f})]})}const us=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ms({isEn:e}){const[a,r]=m.useState(()=>$o());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(Tn,i),()=>window.removeEventListener(Tn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>_o(!a),children:us})}const hn="+33 6 83 10 72 86",ha="alexandre@proplace.co",Mr=`tel:${hn.replace(/[^\d+]/g,"")}`;function fs(){return null}class Pe extends m.Component{constructor(){super(...arguments);Nn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Fa=600,ht=62,_n="atl2:fstats";function xs(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=$(),[l,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(_n)==="on"}catch{return!1}}),c=r.stats,f=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=C=>a==="en"?C.slice(5,10):`${C.slice(8,10)}/${C.slice(5,7)}`,u=C=>C.toLocaleString(a==="en"?"en-US":"fr-FR"),h=f.reduce((C,T)=>Math.max(C,T.s||0),0),p=f.length?Fa/f.length:0,b=Math.max(4,p-4),y=f.length>=5&&h>0,g=r.marketEstimate||0,j=x(new Date().toISOString().slice(0,10)),N=C=>[...typeof C=="number"?[[C,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&s&&w.push({cle:"fenetre",periode:e.funPerWindow(x(s),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:N(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(C=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:C.periode}),C.etapes.map(([T,A],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(T)}),t.jsx("i",{children:A})]},C.cle+A)),C.cle==="total"&&g>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(g),Math.min(100,Math.round((c.screened||0)/g*100)))})]}),C.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!l;d(T),T&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(_n,T?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},C.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Fa} ${ht}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((C,T)=>{const A=(C.s||0)/h*(ht-4),L=(C.m||0)/h*(ht-4),z=T*p+(p-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(C.d)} — ${C.s} ${e.actScreened} · ${C.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:ht-2-A,width:b,height:A,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:ht-2-L,width:b,height:L,fill:"#185c38"})]},C.d)}),t.jsx("line",{x1:0,y1:ht-1.5,x2:Fa,y2:ht-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Rr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function hs(e,a){if((ut(e)||"").startsWith("CALL")&&qe(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=qe(e)>=2;return Rr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function gs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=$(),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),p=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){u(!0);return}s(b);const y=await i(e,b);s(""),y&&(c(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),u(!1)},children:[h||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]}):hs(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(h===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{p(b)},children:y},b))})]})}function bs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=$(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(ut(e)||"").startsWith("CALL")&&qe(e)===3,x=qe(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const b=await i(e,p);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},h=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Rr.filter(([p])=>!(x&&p==="Retenu")).map(([p,b])=>[p,a[b]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([p,b])=>t.jsx("button",{type:"button",className:"csb"+(f===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:b},p)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(vs,{o:e})]})}function vs({o:e}){const{t:a,saveNote:r,flash:n}=$(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;d(!0);const u=await r(e,i.trim());d(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function ys({placeholder:e,onDone:a}){const{t:r}=$(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ws({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=$(),[c,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||qe(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",u=async g=>{if(c||g===x)return;f(!0);const j=s;l(e,{stage:g,stamps:(s==null?void 0:s.stamps)||{}});const N=Math.max(Date.now(),Un+=1);Un=N;const w=await Uo(r,{company:e.name||"",stage:g,cts:N,deal_id:e.airtableId,check_id:e.checkId});f(!1),!w.stale&&(w.ok||(l(e,j),d(a.actErr)))},h=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,p=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,b=x==="sent"&&h&&p>=4;return t.jsxs("div",{className:"stg",onClick:g=>g.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([g,j])=>t.jsx("button",{type:"button",className:"stgb"+(x===g?" on":""),disabled:c,onClick:()=>{u(g)},children:j},g)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let Un=0;const aa=8,na=360;function Hn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Vn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Hn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Hn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ks({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=$(),[l,d]=m.useState(0),[c,f]=m.useState(null),[s,x]=m.useState([]),u=m.useRef(!1),h=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const A=h.current;return()=>{p.current||(n({type:"ptab",tab:A.ptab}),n({type:"dens",dens:A.dens}),n({type:"modal",modal:A.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,x(e.filter(A=>!!document.querySelector(A.need||A.sel))))},[e]);const b=s[l],y=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const A=b.click,L=window.setTimeout(()=>{const z=document.querySelector(A);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(L)}},[l,b]);const g=m.useRef(-1),j=m.useCallback(()=>{if(!b){f(null);return}const A=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!A){f(null);return}g.current!==l&&(g.current=l,A.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=A.getBoundingClientRect();f(z=>z&&Math.abs(z.top-L.top)<1&&Math.abs(z.left-L.left)<1&&Math.abs(z.width-L.width)<1&&Math.abs(z.height-L.height)<1?z:L)},[b,l]);m.useLayoutEffect(()=>{j();const A=[90,300,700,1300].map(z=>window.setTimeout(j,z)),L=()=>j();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{A.forEach(z=>window.clearTimeout(z)),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[j]);const N=m.useRef(a);if(N.current=a,m.useEffect(()=>{const A=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),N.current()):L.key==="ArrowRight"?d(z=>z+1):L.key==="ArrowLeft"&&d(z=>Math.max(0,z-1))};return document.addEventListener("keydown",A,!0),()=>document.removeEventListener("keydown",A,!0)},[]),!s.length)return null;let w=null;const C=A=>()=>{p.current=!0,n({type:"modal",modal:null}),A()};if(y){const A=i[3]||0;A>0?w={title:A===1?r.ahaATitle1:r.ahaATitleN(A),body:r.ahaABody,btn:r.ahaABtn,go:C(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:C(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:C(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:C(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:na};if(!y&&c){const A=c.bottom+14,z=window.innerHeight-A>190?A:Math.max(12,c.top-200);T={left:Math.min(Math.max(12,c.left+c.width/2-na/2),window.innerWidth-na-12),top:z,width:na}}return Rt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-aa,top:c.top-aa,width:c.width+aa*2,height:c.height+aa*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:T,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(Vn,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Vn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(A=>Math.max(0,A-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(A=>A+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Fr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Or(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function js(){var L,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=$(),f=r?a:e,s=m.useMemo(()=>f.filter(S=>ct(S.date)===0&&S.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(S=>S.kind==="target"&&qe(S)===0).slice().sort((S,R)=>(R.date||"").localeCompare(S.date||"")):[],[a,r]),u=m.useMemo(()=>s.filter(S=>r?qe(S)===0:!Ie(S)),[s,r]),h=r?x:u,p=r?a.length-x.length:s.length-u.length,b=r?a.length:s.length,y=b?Math.min(100,p/b*100):100,g=m.useMemo(()=>Fr(f),[f]),j=!!g&&ct(g)>0,N=m.useMemo(()=>j?f.filter(S=>(S.date||"").slice(0,10)===g):[],[f,g,j]),w=typeof((L=d.stats)==null?void 0:L.kept_today)=="number"?d.stats.kept_today:null,C=typeof((z=d.stats)==null?void 0:z.screened_today)=="number"?d.stats.screened_today:s.length;let T;j?T=i.morningLast(N.length,x.length,Or(g,l)):r?T=i.morningThesis(C,x.length,w):s.length?p===0?T=i.goalSourced(s.length):p>=s.length?T=i.goalCleared:T=i.goalDone(p,s.length):T=i.goalSourced(0);const A=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(S=>S.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),h.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:A,children:r?i.morningEval(h.length):o.pileMode?i.goalContinue(h.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ns(){var H,B;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:f,startTour:s,flash:x,flashErr:u}=$(),[h,p]=m.useState(null),[b,y]=m.useState(!0),[g,j]=m.useState([]),N=c==="client";m.useEffect(()=>{if(!i||!o)return;let _=!0;return y(!0),(async()=>{const[V,G]=await Promise.all([pn(o),Nr(i)]);_&&(V&&p(V),y(!1),j(G))})(),()=>{_=!1}},[i,o]);const[w,C]=m.useState(!1),T=()=>{!N||w||!o||(C(!0),Ho(o).then(_=>{C(!1),_?x(e.identRepubDone):u(e.actErr)}))},A=(h==null?void 0:h.per_day)??null,L=((H=h==null?void 0:h.pool_order)==null?void 0:H.length)??0,z=g.filter(_=>_.status==="running").length,S=m.useMemo(()=>d.filter(_=>_.kind==="target"&&Ie(_)).length,[d]),R=l.marketEstimate,I=typeof((B=l.stats)==null?void 0:B.screened)=="number"?l.stats.screened:S,M=R&&R>0?Math.min(100,Math.round(I/R*100)):null,F=_=>_.toLocaleString(a==="en"?"en-US":"fr-FR"),v=(o||"P").split(/\s+/).map(_=>_[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const _=Date.parse(l.generatedAt||"");if(Number.isNaN(_))return"";const V=new Date(_),G=ee=>String(ee).padStart(2,"0");return`${G(V.getDate())}/${G(V.getMonth()+1)} à ${G(V.getHours())}:${G(V.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?v:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[M===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:F(I)})})]}),M!==null&&R&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:M+"%"}})}),t.jsxs("b",{children:[M," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,R)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),A!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:A})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),A===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:_=>{_.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!N||w,onClick:T,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!N,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:_=>n({type:"filters",patch:{search:_.target.value}})})]})]})]})}function Ss(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=$(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const f=u=>{const h=c.current[u],p=h!==void 0?r[u]-h:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${$a[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},s=(u,h,p)=>t.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":`var(${$a[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),x=(u,h,p,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:h,disabled:b,onClick:p,children:u},h);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Es(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=$(),d=m.useRef(null),[c,f]=m.useState(60);m.useEffect(()=>{let p=0;const b=()=>{var w;const y=d.current;if(!y)return;const g=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!g)return;const j=g.getBoundingClientRect(),N=y.getBoundingClientRect();f(Math.max(20,Math.min(j.left+j.width/2-N.left,N.width-30)))};return p=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const p=n.filter(g=>g.kind==="target"&&qe(g)===3),b=p.filter(g=>_a(g)==="auto").length,y=p.filter(g=>_a(g)==="cd").length;x=r.tutoPending(b,y,p.length)}const u=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(s===1){const p=n.filter(b=>b.kind==="target"&&qe(b)===1&&!i.has(b.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(b=>b.id)})}}return null})(),h=Vo(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(h?"":" on-dark"),style:{"--bg":`var(${$a[s]})`,"--ax":c+"px","--stc":h?"var(--ink)":"#fff","--stt":h?"#fff":"var(--ink)","--tc":h?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class vt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Cs(e){for(const a of e)yield*a}function Pr(e){return Array.from(Cs(e))}var be=1e-6,ce=Math.PI,Ge=ce/2,Wn=ce/4,Qe=ce*2,lt=180/ce,_e=ce/180,Ee=Math.abs,zs=Math.atan,Wt=Math.atan2,Te=Math.cos,Le=Math.sin,As=Math.sign||function(e){return e>0?1:e<0?-1:0},kt=Math.sqrt;function Ts(e){return e>1?0:e<-1?ce:Math.acos(e)}function Yt(e){return e>1?Ge:e<-1?-Ge:Math.asin(e)}function Ke(){}function ga(e,a){e&&Gn.hasOwnProperty(e.type)&&Gn[e.type](e,a)}var Yn={Feature:function(e,a){ga(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)ga(r[n].geometry,a)}},Gn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Ya(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Ya(r[n],a,0)},Polygon:function(e,a){Kn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Kn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)ga(r[n],a)}};function Ya(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Kn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Ya(e[r],a,1);a.polygonEnd()}function Ct(e,a){e&&Yn.hasOwnProperty(e.type)?Yn[e.type](e,a):ga(e,a)}function Ga(e){return[Wt(e[1],e[0]),Yt(e[2])]}function Lt(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*Le(a),Le(r)]}function ra(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function ba(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Oa(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function oa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Ka(e){var a=kt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Qa(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ja(e,a){return Ee(e)>ce&&(e-=Math.round(e/Qe)*Qe),[e,a]}Ja.invert=Ja;function Ls(e,a,r){return(e%=Qe)?a||r?Qa(Jn(e),Xn(a,r)):Jn(e):a||r?Xn(a,r):Ja}function Qn(e){return function(a,r){return a+=e,Ee(a)>ce&&(a-=Math.round(a/Qe)*Qe),[a,r]}}function Jn(e){var a=Qn(e);return a.invert=Qn(-e),a}function Xn(e,a){var r=Te(e),n=Le(e),i=Te(a),o=Le(a);function l(d,c){var f=Te(c),s=Te(d)*f,x=Le(d)*f,u=Le(c),h=u*r+s*n;return[Wt(x*i-h*o,s*r-u*n),Yt(h*i+x*o)]}return l.invert=function(d,c){var f=Te(c),s=Te(d)*f,x=Le(d)*f,u=Le(c),h=u*i-x*o;return[Wt(x*i+u*o,s*r+h*n),Yt(h*r-s*n)]},l}function qs(e,a,r,n,i,o){if(r){var l=Te(a),d=Le(a),c=n*r;i==null?(i=a+n*Qe,o=a-c/2):(i=Zn(l,i),o=Zn(l,o),(n>0?i<o:i>o)&&(i+=n*Qe));for(var f,s=i;n>0?s>o:s<o;s-=c)f=Ga([l,-d*Te(s),-d*Le(s)]),e.point(f[0],f[1])}}function Zn(e,a){a=Lt(a),a[0]-=e,Ka(a);var r=Ts(-a[1]);return((-a[2]<0?-r:r)+Qe-be)%Qe}function Dr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ke,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function pa(e,a){return Ee(e[0]-a[0])<be&&Ee(e[1]-a[1])<be}function ia(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ir(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(p){if(!((b=p.length-1)<=0)){var b,y=p[0],g=p[b],j;if(pa(y,g)){if(!y[2]&&!g[2]){for(i.lineStart(),d=0;d<b;++d)i.point((y=p[d])[0],y[1]);i.lineEnd();return}g[0]+=2*be}o.push(j=new ia(y,p,null,!0)),l.push(j.o=new ia(y,null,j,!1)),o.push(j=new ia(g,p,null,!1)),l.push(j.o=new ia(g,null,j,!0))}}),!!o.length){for(l.sort(a),er(o),er(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var f=o[0],s,x;;){for(var u=f,h=!0;u.v;)if((u=u.n)===f)return;s=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(h)for(d=0,c=s.length;d<c;++d)i.point((x=s[d])[0],x[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(h)for(s=u.p.z,d=s.length-1;d>=0;--d)i.point((x=s[d])[0],x[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,s=u.z,h=!h}while(!u.v);i.lineEnd()}}}function er(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Pa(e){return Ee(e[0])<=ce?e[0]:As(e[0])*((Ee(e[0])+ce)%Qe-ce)}function Ms(e,a){var r=Pa(a),n=a[1],i=Le(n),o=[Le(r),-Te(r),0],l=0,d=0,c=new vt;i===1?n=Ge+be:i===-1&&(n=-Ge-be);for(var f=0,s=e.length;f<s;++f)if(u=(x=e[f]).length)for(var x,u,h=x[u-1],p=Pa(h),b=h[1]/2+Wn,y=Le(b),g=Te(b),j=0;j<u;++j,p=w,y=T,g=A,h=N){var N=x[j],w=Pa(N),C=N[1]/2+Wn,T=Le(C),A=Te(C),L=w-p,z=L>=0?1:-1,S=z*L,R=S>ce,I=y*T;if(c.add(Wt(I*z*Le(S),g*A+I*Te(S))),l+=R?L+z*Qe:L,R^p>=r^w>=r){var M=ba(Lt(h),Lt(N));Ka(M);var F=ba(o,M);Ka(F);var v=(R^L>=0?-1:1)*Yt(F[2]);(n>v||n===v&&(M[0]||M[1]))&&(d+=R^L>=0?1:-1)}}return(l<-be||l<be&&c<-1e-12)^d&1}function Br(e,a,r,n){return function(i){var o=a(i),l=Dr(),d=a(l),c=!1,f,s,x,u={point:h,lineStart:b,lineEnd:y,polygonStart:function(){u.point=g,u.lineStart=j,u.lineEnd=N,s=[],f=[]},polygonEnd:function(){u.point=h,u.lineStart=b,u.lineEnd=y,s=Pr(s);var w=Ms(f,n);s.length?(c||(i.polygonStart(),c=!0),Ir(s,Fs,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function h(w,C){e(w,C)&&i.point(w,C)}function p(w,C){o.point(w,C)}function b(){u.point=p,o.lineStart()}function y(){u.point=h,o.lineEnd()}function g(w,C){x.push([w,C]),d.point(w,C)}function j(){d.lineStart(),x=[]}function N(){g(x[0][0],x[0][1]),d.lineEnd();var w=d.clean(),C=l.result(),T,A=C.length,L,z,S;if(x.pop(),f.push(x),x=null,!!A){if(w&1){if(z=C[0],(L=z.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),T=0;T<L;++T)i.point((S=z[T])[0],S[1]);i.lineEnd()}return}A>1&&w&2&&C.push(C.pop().concat(C.shift())),s.push(C.filter(Rs))}}return u}}function Rs(e){return e.length>1}function Fs(e,a){return((e=e.x)[0]<0?e[1]-Ge-be:Ge-e[1])-((a=a.x)[0]<0?a[1]-Ge-be:Ge-a[1])}const tr=Br(function(){return!0},Os,Ds,[-ce,-Ge]);function Os(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?ce:-ce,c=Ee(o-a);Ee(c-ce)<be?(e.point(a,r=(r+l)/2>0?Ge:-Ge),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=ce&&(Ee(a-n)<be&&(a-=n*be),Ee(o-d)<be&&(o-=d*be),r=Ps(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ps(e,a,r,n){var i,o,l=Le(e-r);return Ee(l)>be?zs((Le(a)*(o=Te(n))*Le(r)-Le(n)*(i=Te(a))*Le(e))/(i*o*l)):(a+n)/2}function Ds(e,a,r,n){var i;if(e==null)i=r*Ge,n.point(-ce,i),n.point(0,i),n.point(ce,i),n.point(ce,0),n.point(ce,-i),n.point(0,-i),n.point(-ce,-i),n.point(-ce,0),n.point(-ce,i);else if(Ee(e[0]-a[0])>be){var o=e[0]<a[0]?ce:-ce;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Is(e){var a=Te(e),r=2*_e,n=a>0,i=Ee(a)>be;function o(s,x,u,h){qs(h,e,r,u,s,x)}function l(s,x){return Te(s)*Te(x)>a}function d(s){var x,u,h,p,b;return{lineStart:function(){p=h=!1,b=1},point:function(y,g){var j=[y,g],N,w=l(y,g),C=n?w?0:f(y,g):w?f(y+(y<0?ce:-ce),g):0;if(!x&&(p=h=w)&&s.lineStart(),w!==h&&(N=c(x,j),(!N||pa(x,N)||pa(j,N))&&(j[2]=1)),w!==h)b=0,w?(s.lineStart(),N=c(j,x),s.point(N[0],N[1])):(N=c(x,j),s.point(N[0],N[1],2),s.lineEnd()),x=N;else if(i&&x&&n^w){var T;!(C&u)&&(T=c(j,x,!0))&&(b=0,n?(s.lineStart(),s.point(T[0][0],T[0][1]),s.point(T[1][0],T[1][1]),s.lineEnd()):(s.point(T[1][0],T[1][1]),s.lineEnd(),s.lineStart(),s.point(T[0][0],T[0][1],3)))}w&&(!x||!pa(x,j))&&s.point(j[0],j[1]),x=j,h=w,u=C},lineEnd:function(){h&&s.lineEnd(),x=null},clean:function(){return b|(p&&h)<<1}}}function c(s,x,u){var h=Lt(s),p=Lt(x),b=[1,0,0],y=ba(h,p),g=ra(y,y),j=y[0],N=g-j*j;if(!N)return!u&&s;var w=a*g/N,C=-a*j/N,T=ba(b,y),A=oa(b,w),L=oa(y,C);Oa(A,L);var z=T,S=ra(A,z),R=ra(z,z),I=S*S-R*(ra(A,A)-1);if(!(I<0)){var M=kt(I),F=oa(z,(-S-M)/R);if(Oa(F,A),F=Ga(F),!u)return F;var v=s[0],q=x[0],H=s[1],B=x[1],_;q<v&&(_=v,v=q,q=_);var V=q-v,G=Ee(V-ce)<be,ee=G||V<be;if(!G&&B<H&&(_=H,H=B,B=_),ee?G?H+B>0^F[1]<(Ee(F[0]-v)<be?H:B):H<=F[1]&&F[1]<=B:V>ce^(v<=F[0]&&F[0]<=q)){var le=oa(z,(-S+M)/R);return Oa(le,A),[F,Ga(le)]}}}function f(s,x){var u=n?e:ce-e,h=0;return s<-u?h|=1:s>u&&(h|=2),x<-u?h|=4:x>u&&(h|=8),h}return Br(l,d,o,n?[0,-e]:[-ce,e-ce])}function Bs(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],f=a[1],s=0,x=1,u=c-l,h=f-d,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<s)return;p<x&&(x=p)}else if(u>0){if(p>x)return;p>s&&(s=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>x)return;p>s&&(s=p)}else if(u>0){if(p<s)return;p<x&&(x=p)}if(p=n-d,!(!h&&p>0)){if(p/=h,h<0){if(p<s)return;p<x&&(x=p)}else if(h>0){if(p>x)return;p>s&&(s=p)}if(p=o-d,!(!h&&p<0)){if(p/=h,h<0){if(p>x)return;p>s&&(s=p)}else if(h>0){if(p<s)return;p<x&&(x=p)}return s>0&&(e[0]=l+s*u,e[1]=d+s*h),x<1&&(a[0]=l+x*u,a[1]=d+x*h),!0}}}}}var Bt=1e9,sa=-Bt;function $s(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,u){var h=0,p=0;if(f==null||(h=l(f,x))!==(p=l(s,x))||c(f,s)<0^x>0)do u.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+x+4)%4)!==p);else u.point(s[0],s[1])}function l(f,s){return Ee(f[0]-e)<be?s>0?0:3:Ee(f[0]-r)<be?s>0?2:1:Ee(f[1]-a)<be?s>0?1:0:s>0?3:2}function d(f,s){return c(f.x,s.x)}function c(f,s){var x=l(f,1),u=l(s,1);return x!==u?x-u:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=Dr(),u,h,p,b,y,g,j,N,w,C,T,A={point:L,lineStart:I,lineEnd:M,polygonStart:S,polygonEnd:R};function L(v,q){i(v,q)&&s.point(v,q)}function z(){for(var v=0,q=0,H=h.length;q<H;++q)for(var B=h[q],_=1,V=B.length,G=B[0],ee,le,te=G[0],we=G[1];_<V;++_)ee=te,le=we,G=B[_],te=G[0],we=G[1],le<=n?we>n&&(te-ee)*(n-le)>(we-le)*(e-ee)&&++v:we<=n&&(te-ee)*(n-le)<(we-le)*(e-ee)&&--v;return v}function S(){s=x,u=[],h=[],T=!0}function R(){var v=z(),q=T&&v,H=(u=Pr(u)).length;(q||H)&&(f.polygonStart(),q&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),H&&Ir(u,d,v,o,f),f.polygonEnd()),s=f,u=h=p=null}function I(){A.point=F,h&&h.push(p=[]),C=!0,w=!1,j=N=NaN}function M(){u&&(F(b,y),g&&w&&x.rejoin(),u.push(x.result())),A.point=L,w&&s.lineEnd()}function F(v,q){var H=i(v,q);if(h&&p.push([v,q]),C)b=v,y=q,g=H,C=!1,H&&(s.lineStart(),s.point(v,q));else if(H&&w)s.point(v,q);else{var B=[j=Math.max(sa,Math.min(Bt,j)),N=Math.max(sa,Math.min(Bt,N))],_=[v=Math.max(sa,Math.min(Bt,v)),q=Math.max(sa,Math.min(Bt,q))];Bs(B,_,e,a,r,n)?(w||(s.lineStart(),s.point(B[0],B[1])),s.point(_[0],_[1]),H||s.lineEnd(),T=!1):H&&(s.lineStart(),s.point(v,q),T=!1)}j=v,N=q,w=H}return A}}const Xa=e=>e;var Da=new vt,Za=new vt,$r,_r,en,tn,dt={point:Ke,lineStart:Ke,lineEnd:Ke,polygonStart:function(){dt.lineStart=_s,dt.lineEnd=Hs},polygonEnd:function(){dt.lineStart=dt.lineEnd=dt.point=Ke,Da.add(Ee(Za)),Za=new vt},result:function(){var e=Da/2;return Da=new vt,e}};function _s(){dt.point=Us}function Us(e,a){dt.point=Ur,$r=en=e,_r=tn=a}function Ur(e,a){Za.add(tn*e-en*a),en=e,tn=a}function Hs(){Ur($r,_r)}var qt=1/0,va=qt,Gt=-qt,ya=Gt,wa={point:Vs,lineStart:Ke,lineEnd:Ke,polygonStart:Ke,polygonEnd:Ke,result:function(){var e=[[qt,va],[Gt,ya]];return Gt=ya=-(va=qt=1/0),e}};function Vs(e,a){e<qt&&(qt=e),e>Gt&&(Gt=e),a<va&&(va=a),a>ya&&(ya=a)}var an=0,nn=0,$t=0,ka=0,ja=0,zt=0,rn=0,on=0,_t=0,Hr,Vr,rt,ot,Ye={point:yt,lineStart:ar,lineEnd:nr,polygonStart:function(){Ye.lineStart=Gs,Ye.lineEnd=Ks},polygonEnd:function(){Ye.point=yt,Ye.lineStart=ar,Ye.lineEnd=nr},result:function(){var e=_t?[rn/_t,on/_t]:zt?[ka/zt,ja/zt]:$t?[an/$t,nn/$t]:[NaN,NaN];return an=nn=$t=ka=ja=zt=rn=on=_t=0,e}};function yt(e,a){an+=e,nn+=a,++$t}function ar(){Ye.point=Ws}function Ws(e,a){Ye.point=Ys,yt(rt=e,ot=a)}function Ys(e,a){var r=e-rt,n=a-ot,i=kt(r*r+n*n);ka+=i*(rt+e)/2,ja+=i*(ot+a)/2,zt+=i,yt(rt=e,ot=a)}function nr(){Ye.point=yt}function Gs(){Ye.point=Qs}function Ks(){Wr(Hr,Vr)}function Qs(e,a){Ye.point=Wr,yt(Hr=rt=e,Vr=ot=a)}function Wr(e,a){var r=e-rt,n=a-ot,i=kt(r*r+n*n);ka+=i*(rt+e)/2,ja+=i*(ot+a)/2,zt+=i,i=ot*e-rt*a,rn+=i*(rt+e),on+=i*(ot+a),_t+=i*3,yt(rt=e,ot=a)}function Yr(e){this._context=e}Yr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Qe);break}}},result:Ke};var sn=new vt,Ia,Gr,Kr,Ut,Ht,Kt={point:Ke,lineStart:function(){Kt.point=Js},lineEnd:function(){Ia&&Qr(Gr,Kr),Kt.point=Ke},polygonStart:function(){Ia=!0},polygonEnd:function(){Ia=null},result:function(){var e=+sn;return sn=new vt,e}};function Js(e,a){Kt.point=Qr,Gr=Ut=e,Kr=Ht=a}function Qr(e,a){Ut-=e,Ht-=a,sn.add(kt(Ut*Ut+Ht*Ht)),Ut=e,Ht=a}let rr,Na,or,ir;class sr{constructor(a){this._append=a==null?Jr:Xs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==or||this._append!==Na){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,or=n,Na=this._append,ir=this._,this._=i}this._+=ir;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Jr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Xs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Jr;if(a!==rr){const r=10**a;rr=a,Na=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Na}function Zs(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Ct(d,i(o))),o.result()}return l.area=function(d){return Ct(d,i(dt)),dt.result()},l.measure=function(d){return Ct(d,i(Kt)),Kt.result()},l.bounds=function(d){return Ct(d,i(wa)),wa.result()},l.centroid=function(d){return Ct(d,i(Ye)),Ye.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,Xa):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new sr(r)):new Yr(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new sr(r)),l},l.projection(e).digits(r).context(a)}function gn(e){return function(a){var r=new ln;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ln(){}ln.prototype={constructor:ln,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function bn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ct(r,e.stream(wa)),a(wa.result()),n!=null&&e.clipExtent(n),e}function Xr(e,a,r){return bn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function el(e,a,r){return Xr(e,[[0,0],a],r)}function tl(e,a,r){return bn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function al(e,a,r){return bn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var lr=16,nl=Te(30*_e);function dr(e,a){return+a?ol(e,a):rl(e)}function rl(e){return gn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ol(e,a){function r(n,i,o,l,d,c,f,s,x,u,h,p,b,y){var g=f-n,j=s-i,N=g*g+j*j;if(N>4*a&&b--){var w=l+u,C=d+h,T=c+p,A=kt(w*w+C*C+T*T),L=Yt(T/=A),z=Ee(Ee(T)-1)<be||Ee(o-x)<be?(o+x)/2:Wt(C,w),S=e(z,L),R=S[0],I=S[1],M=R-n,F=I-i,v=j*M-g*F;(v*v/N>a||Ee((g*M+j*F)/N-.5)>.3||l*u+d*h+c*p<nl)&&(r(n,i,o,l,d,c,R,I,z,w/=A,C/=A,T,b,y),y.point(R,I),r(R,I,z,w,C,T,f,s,x,u,h,p,b,y))}}return function(n){var i,o,l,d,c,f,s,x,u,h,p,b,y={point:g,lineStart:j,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=C},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function g(L,z){L=e(L,z),n.point(L[0],L[1])}function j(){x=NaN,y.point=N,n.lineStart()}function N(L,z){var S=Lt([L,z]),R=e(L,z);r(x,u,s,h,p,b,x=R[0],u=R[1],s=L,h=S[0],p=S[1],b=S[2],lr,n),n.point(x,u)}function w(){y.point=g,n.lineEnd()}function C(){j(),y.point=T,y.lineEnd=A}function T(L,z){N(i=L,z),o=x,l=u,d=h,c=p,f=b,y.point=N}function A(){r(x,u,s,h,p,b,o,l,i,d,c,f,lr,n),y.lineEnd=w,w()}return y}}var il=gn({point:function(e,a){this.stream.point(e*_e,a*_e)}});function sl(e){return gn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ll(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function cr(e,a,r,n,i,o){if(!o)return ll(e,a,r,n,i);var l=Te(o),d=Le(o),c=l*e,f=d*e,s=l/e,x=d/e,u=(d*r-l*a)/e,h=(d*a+l*r)/e;function p(b,y){return b*=n,y*=i,[c*b-f*y+a,r-f*b-c*y]}return p.invert=function(b,y){return[n*(s*b-x*y+u),i*(h-x*b-s*y)]},p}function dl(e){return cl(function(){return e})()}function cl(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,f=0,s,x=0,u=1,h=1,p=null,b=tr,y=null,g,j,N,w=Xa,C=.5,T,A,L,z,S;function R(v){return L(v[0]*_e,v[1]*_e)}function I(v){return v=L.invert(v[0],v[1]),v&&[v[0]*lt,v[1]*lt]}R.stream=function(v){return z&&S===v?z:z=il(sl(s)(b(T(w(S=v)))))},R.preclip=function(v){return arguments.length?(b=v,p=void 0,F()):b},R.postclip=function(v){return arguments.length?(w=v,y=g=j=N=null,F()):w},R.clipAngle=function(v){return arguments.length?(b=+v?Is(p=v*_e):(p=null,tr),F()):p*lt},R.clipExtent=function(v){return arguments.length?(w=v==null?(y=g=j=N=null,Xa):$s(y=+v[0][0],g=+v[0][1],j=+v[1][0],N=+v[1][1]),F()):y==null?null:[[y,g],[j,N]]},R.scale=function(v){return arguments.length?(r=+v,M()):r},R.translate=function(v){return arguments.length?(n=+v[0],i=+v[1],M()):[n,i]},R.center=function(v){return arguments.length?(o=v[0]%360*_e,l=v[1]%360*_e,M()):[o*lt,l*lt]},R.rotate=function(v){return arguments.length?(d=v[0]%360*_e,c=v[1]%360*_e,f=v.length>2?v[2]%360*_e:0,M()):[d*lt,c*lt,f*lt]},R.angle=function(v){return arguments.length?(x=v%360*_e,M()):x*lt},R.reflectX=function(v){return arguments.length?(u=v?-1:1,M()):u<0},R.reflectY=function(v){return arguments.length?(h=v?-1:1,M()):h<0},R.precision=function(v){return arguments.length?(T=dr(A,C=v*v),F()):kt(C)},R.fitExtent=function(v,q){return Xr(R,v,q)},R.fitSize=function(v,q){return el(R,v,q)},R.fitWidth=function(v,q){return tl(R,v,q)},R.fitHeight=function(v,q){return al(R,v,q)};function M(){var v=cr(r,0,0,u,h,x).apply(null,a(o,l)),q=cr(r,n-v[0],i-v[1],u,h,x);return s=Ls(d,c,f),A=Qa(a,q),L=Qa(s,A),T=dr(A,C),F()}function F(){return z=S=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&I,M()}}function Zr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Zr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(Ee(i)>be&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function pl(){return dl(Zr).scale(175.295)}function ul(e){return e}function ml(e){if(e==null)return ul;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var f=2,s=d.length,x=new Array(s);for(x[0]=(a+=d[0])*n+o,x[1]=(r+=d[1])*i+l;f<s;)x[f]=d[f],++f;return x}}function fl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function xl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return pr(e,r)})}:pr(e,a)}function pr(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=hl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function hl(e,a){var r=ml(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var u=n[s<0?~s:s],h=0,p=u.length;h<p;++h)x.push(r(u[h],h));s<0&&fl(x,p)}function o(s){return r(s)}function l(s){for(var x=[],u=0,h=s.length;u<h;++u)i(s[u],x);return x.length<2&&x.push(x[0]),x}function d(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function c(s){return s.map(d)}function f(s){var x=s.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":u=o(s.coordinates);break;case"MultiPoint":u=s.coordinates.map(o);break;case"LineString":u=l(s.arcs);break;case"MultiLineString":u=s.arcs.map(l);break;case"Polygon":u=c(s.arcs);break;case"MultiPolygon":u=s.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return f(a)}const eo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},gl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function bl(e,a,r){const n=eo[e];if(!n||!n.length)return-1;const i=gl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let la=null;function vl(){return la||(la=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=xl(r,n),o=pl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Zs(o),d=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var h;const x=((h=s.properties)==null?void 0:h.name)||"",u=l(s)||"";return u?{i2:Wo(x)||null,n:x,d:u}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,x]of Object.entries(Yo)){const u=o(x);u&&(c[s]={x:u[0],y:u[1]})}const f={};for(const[s,x]of Object.entries(eo)){const u=x.map(h=>o(h.ll)).filter(h=>!!h).map(([h,p])=>({x:h,y:p}));u.length&&(f[s]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:d,anchors:c,metros:f}}catch{return null}})(),la)}function yl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return vl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const wl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},ur=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function mr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function kl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const c=(f=e.current)==null?void 0:f.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function fr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function jl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:f,dossiers:s,source:x}=$(),u=f.loading&&!s.length,h=m.useRef(null),p=m.useRef(null),b=yl(e.continent==="monde"),y=e.continent==="monde"?b:un.find(v=>v.key===e.continent)||null,g=kl(h,e.continent+":"+e.mapFolded+":"+!!y),[j,N]=m.useState(new Map),[w,C]=m.useState(null);m.useEffect(()=>{const v=h.current;if(!v)return;const q=new Map;v.querySelectorAll("path[data-i2]").forEach(H=>{const B=H.dataset.i2;if(B)try{const _=H.getBBox();_.width>0&&q.set(B,{x:_.x,y:_.y,w:_.width,h:_.height})}catch{}}),N(q)},[e.continent,g,y]);const T=m.useMemo(()=>r.filter(v=>v.cc),[r]),A=m.useMemo(()=>{const v=new Map;return T.forEach(q=>v.set(q.cc,(v.get(q.cc)||0)+1)),v},[T]),L=e.continent==="monde"&&b?b.anchors:null,z=e.continent==="monde"&&b?b.metros:null,S=m.useMemo(()=>T.map(v=>{const q=mr(v.name||v.id||""),H=mr((v.id||v.name||"")+"·y");if(L&&v.cc){const ee=z?z[v.cc]:void 0;if(ee&&ee.length){const te=bl(v.cc,v.city,q);if(te>=0&&ee[te])return{d:v,x:ee[te].x+(q-.5)*5,y:ee[te].y+(H-.5)*5}}const le=L[v.cc];if(le)return{d:v,x:le.x+(q-.5)*10,y:le.y+(H-.5)*10}}const B=v.cc?j.get(v.cc):void 0;if(!B)return null;const _=wl[`${e.continent}:${v.cc||""}`];if(_)return{d:v,x:B.x+B.w*(_.fx+(q-.5)*_.sx),y:B.y+B.h*(_.fy+(H-.5)*_.sy)};const V=(q-.5)*Math.min(B.w*.55,60),G=(H-.5)*Math.min(B.h*.55,60);return{d:v,x:B.x+B.w/2+V,y:B.y+B.h/2+G}}).filter(v=>!!v),[T,j,L,z,e.continent]),R=v=>g>0?v/g:v,I=m.useMemo(()=>n?[0,1,2,3,4,5].map(v=>({c:ur[v],fr:c.plabels[v].toUpperCase(),en:c.plabels[v].toUpperCase(),n:r.filter(q=>q.kind==="target"&&qe(q)===v).length})).filter(v=>v.n>0):Ln.map((v,q)=>({...v,n:r.filter(H=>qn(H)===q).length})),[r,n,c.plabels]),M=o?l.get(o):null,F=M?S.find(v=>v.d.id===M.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(fr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:h,viewBox:y.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{C(null),i(null)},children:[t.jsx("g",{children:y.countries.map((v,q)=>t.jsx("g",{className:"ct"+(v.i2&&A.get(v.i2)?"":" empty"),children:t.jsx("path",{d:v.d,"data-i2":v.i2||void 0})},q))}),t.jsx("g",{children:S.map(v=>{const q=Ln[qn(v.d)],H=!!Re(v.d),B=v.d.kind==="target",_=n&&B?ur[qe(v.d)]:q.c,V=!n&&Ie(v.d);return t.jsxs("g",{className:"co"+(V?" done":""),onMouseEnter:()=>{var le,te;const G=(le=p.current)==null?void 0:le.getBoundingClientRect(),ee=(te=h.current)==null?void 0:te.createSVGPoint();if(ee&&h.current&&G){ee.x=v.x,ee.y=v.y;const we=ee.matrixTransform(h.current.getScreenCTM());C({x:we.x-G.left,y:we.y-G.top,label:v.d.name+" · "+(Ft(v.d.cc,d)||v.d.countryLabel||"")})}i(v.d.id)},onMouseLeave:()=>{C(null),i(null)},onClick:()=>{var le;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:v.d.id}),(v.d.noCo||["media","nominations","recrutements"].includes(v.d.engine||""))&&(v.d.url||v.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:v.d.url||"",text:[v.d.headline,v.d.tagline].filter(Boolean).join(`
`)}})):v.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:v.d.name}}));return}const G=(le=h.current)==null?void 0:le.createSVGPoint();let ee=null;if(G&&h.current){G.x=v.x,G.y=v.y;const te=G.matrixTransform(h.current.getScreenCTM());ee={x:te.x,y:te.y}}a({type:"popup",id:v.d.id,anchor:ee})},children:[t.jsx("circle",{className:"h",cx:v.x,cy:v.y,r:R(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:v.x,cy:v.y,r:R(q.px),fill:_,stroke:H?"#DC2626":"#ffffff",strokeWidth:R(H?2.2:1.3)})]},v.d.id||v.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:R(13),fill:"none",stroke:"#0F172A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:I.map((v,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":v.c}}),d==="fr"?v.fr:v.en," ",t.jsx("b",{children:v.n})]},q))}),r.some(v=>!v.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(v=>!v.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(fr,{msgs:c.loadMsgs})})}function Nl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function to({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=$(),c=a.filters,[f,s]=m.useState(!1),[x,u]=m.useState(!1),h=m.useRef(null),p=m.useRef(null),b=m.useMemo(()=>a.continent==="monde"?n:n.filter(M=>M.continent===a.continent),[n,a.continent]),y=M=>b.filter(F=>M!=="country"&&c.country.length&&!c.country.includes(F.cc||"")?!1:xa(F,c,o,M==="country"?void 0:M)),g=m.useMemo(()=>{const M=y("win"),F=v=>M.filter(q=>(q.date?Math.max(0,Math.floor((Date.now()-Date.parse(q.date))/864e5)):9999)<=v).length;return[F(0),F(7),F(30),M.length]},[b,c,o]),j=m.useMemo(()=>c.day?y("win").filter(M=>(M.date||"").slice(0,10)===c.day).length:0,[b,c,o]),N=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,w=N+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f&&!x)return;const M=v=>{var H,B;const q=v.target;f&&!((H=h.current)!=null&&H.contains(q))&&s(!1),x&&!((B=p.current)!=null&&B.contains(q))&&u(!1)},F=v=>{v.key==="Escape"&&(s(!1),u(!1))};return document.addEventListener("mousedown",M),document.addEventListener("keydown",F),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("keydown",F)}},[f,x]);const C=(M,F,v,q="fbtn")=>t.jsxs("button",{type:"button",className:q,"aria-expanded":a.openFacet===M,onClick:()=>r({type:"openFacet",facet:M}),children:[t.jsx("span",{className:"fl",children:F}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},M),T=["1","7","30","all"],A=Math.max(0,T.indexOf(c.win||"all")),L=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(Nl(c.day,d))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:p,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(M=>!M),children:[t.jsx("span",{className:"winpick-k",children:i.winMenu}),t.jsx("span",{className:"winpick-v",children:i.datesShort[A]}),t.jsx("b",{children:g[A]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:T.map((M,F)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===M,onClick:()=>{r({type:"filters",patch:{win:M}}),u(!1)},children:[i.datesShort[F],t.jsx("span",{className:"n",children:g[F]})]},M))})]}):t.jsx("div",{className:"seg",children:T.map((M,F)=>t.jsxs("button",{type:"button","aria-pressed":c.win===M,onClick:()=>r({type:"filters",patch:{win:M}}),children:[t.jsx("span",{className:"sl",children:i.dates[F]}),t.jsx("b",{children:g[F]})]},M))}),z=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:M=>r({type:"filters",patch:{search:M.target.value}})})]}),S=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):C("sec",i.fSector,c.sector.length),C("pay",i.fCountry,c.country.length),C("det",i.fEngine,c.engine.length),C("sta",i.fStage,c.stage.length),o&&C("ang","Angle",c.angle.length),o&&C("mem","Mémo",c.memoLevel.length)]}),R=(M=!1)=>t.jsxs("div",{className:"frow2",children:[w>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(b.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(w)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),M&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),I=t.jsxs("div",{className:"fmenu",ref:h,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(N?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(M=>!M),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),N>0&&t.jsx("span",{className:"n",children:N}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:S})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[z,I,R(!1)]})]}),a.openFacet&&t.jsx(xr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,z,S,t.jsx("span",{className:"fgrow"}),R()]}),a.openFacet&&t.jsx(xr,{poolFor:y})]})}function xr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:f}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(g=>Re(g)),b=new Map;p.forEach(g=>{const j=g.engine||"";b.set(j,(b.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Ua([...b.keys()],i).map(g=>({v:g,label:bt(g)+" "+Ue(g,i),n:b.get(g)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(g)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const p=e("sector"),b=new Map;return p.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,g)=>g[1]-y[1]).map(([y,g])=>({v:y,label:y,n:g,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const p=e("country"),b=new Map;return p.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,g)=>g[1]-y[1]).map(([y,g])=>({v:y,label:Ft(y,i)||y,n:g,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const p=e("engine"),b=new Map;return p.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Ua([...b.keys()],i).map(y=>({v:y,label:bt(y)+" "+Ue(y,i)+' <span style="color:var(--dim);font-size:10px">· '+Go(Ko(y),i)+"</span>",n:b.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const p=e("angle"),b=new Map;return p.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,g)=>g[1]-y[1]).map(([y,g])=>({v:y,label:y.replace(/[_-]+/g," "),n:g,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const p=e("memoLevel"),b=new Map;p.forEach(g=>{if(g.kind==="target"){const j=cn(g);b.set(j,(b.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(g=>({v:String(g),label:y[g],n:b.get(g)||0,html:!1,on:o.memoLevel.includes(g)}))}}const u=e("stage"),h=new Map;return u.forEach(p=>{p.stage&&h.set(p.stage,(h.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((p,b)=>b[1]-p[1]).map(([p,b])=>({v:p,label:p,n:b,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),s=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>s(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function ao({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=$(),c=m.useMemo(()=>{const h={};return r.forEach(p=>{xa(p,n.filters,o)&&(h.monde=(h.monde||0)+1,p.continent&&(h[p.continent]=(h[p.continent]||0)+1))}),h},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const h=b=>{var y;(y=x.current)!=null&&y.contains(b.target)||s(!1)},p=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",h),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",h),document.removeEventListener("keydown",p)}},[f]);const u=h=>{const p=un.find(b=>b.key===h);return h==="monde"?d.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(h=>!h),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Mn.map(h=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===h,onClick:()=>{i({type:"continent",key:h}),s(!1)},children:[u(h),t.jsx("span",{className:"n",children:c[h]||0})]},h))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Mn.map(h=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===h,onClick:()=>i({type:"continent",key:h}),children:[u(h),t.jsx("span",{className:"n",children:c[h]||0})]},h)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function no(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Sl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function hr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=$();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function ro({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=$(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(hr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(hr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function El({card:e,onEvaluate:a,onAddAll:r}){var d,c,f;const{t:n}=$(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:no(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(ro,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Cl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function zl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=$(),d=i,[c,f]=m.useState(null),[s,x]=m.useState(null),[u,h]=m.useState(null),[p,b]=m.useState(!1);m.useEffect(()=>{let g=!0;return(async()=>{const j=await Sr({email:l,cbToken:d});g&&f(j)})(),()=>{g=!1}},[l,d,n]);const y=g=>{x(g),h(null),b(!0),(async()=>{const j=await Qo(g.id);h(j),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),h(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(g=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(g),children:[t.jsx("span",{className:"ti",children:g.title}),t.jsxs("span",{className:"me",children:[Cl(g.created_at),g.industry?` · ${g.industry}`:"",g.author?` · ${g.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(g.cited_n||0,g.evaluate_n||0)}),t.jsx("span",{className:"st"+(g.published?" on":""),children:g.published?o.rsPub:o.rsPriv})]},g.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(El,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function It(e){return/^https?:\/\//i.test((e||"").trim())}function Al(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Tl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:f,data:s,canWrite:x,source:u,dossiers:h,doAnalyse:p,liveMemos:b,pipe:y}=$(),g=a==="client",j=m.useMemo(()=>r||(u!=="default"?Jo():""),[r,u]),[N,w]=m.useState(""),[C,T]=m.useState(!1),[A,L]=m.useState(""),[z,S]=m.useState(!1),[R,I]=m.useState(""),[M,F]=m.useState(!1),[v,q]=m.useState(""),[H,B]=m.useState([]),_=m.useRef(!1),[V,G]=m.useState(!1),[ee,le]=m.useState(!1),[te,we]=m.useState(!1),K=m.useRef(!1),[re,me]=m.useState(""),[ve,ye]=m.useState(""),[Q,X]=m.useState(!1),[Y,Z]=m.useState(!1),[ke,oe]=m.useState(0),[pe,fe]=m.useState(""),[ae,Fe]=m.useState(null),[Ne,Ae]=m.useState(null),[$e,Je]=m.useState(!1),[Xe,mt]=m.useState(null),[ft,jt]=m.useState(0),tt=m.useRef(!1),E=N.trim()?Ba.test(N.trim())?e.evalUrl:e.evalName:e.evalWaiting,P=m.useMemo(()=>R.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[R]);m.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),ne=(O.get("rs")||"").trim(),se=(O.get("rstext")||"").trim();ne&&/^https?:\/\//i.test(ne)&&me(ne),se&&(ye(se),le(!0)),(ne&&/^https?:\/\//i.test(ne)||se)&&G(!0)},[]),m.useEffect(()=>{const O=ne=>{const se=ne.detail||{},xe=String(se.url||"").trim(),He=String(se.text||"").trim();xe&&/^https?:\/\//i.test(xe)&&me(xe),He&&(ye(He),le(!0)),(xe&&/^https?:\/\//i.test(xe)||He)&&(G(!0),w(""),L(""),X(!0),window.setTimeout(()=>X(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),m.useEffect(()=>{const O=ne=>{const se=ne.detail||{},xe=String(se.name||"").trim();xe&&(G(!1),w(xe),L(xe),T(!0),window.setTimeout(()=>T(!1),900))};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),m.useEffect(()=>{const O=ne=>{var xe;const se=String(((xe=ne.detail)==null?void 0:xe.url)||"").trim();It(se)&&window.open(se,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",O),()=>window.removeEventListener("ppmap:view",O)},[]),m.useEffect(()=>{if(K.current===V)return;K.current=V,we(!0);const O=window.setTimeout(()=>we(!1),560);return()=>window.clearTimeout(O)},[V]),m.useEffect(()=>{if(typeof window>"u"||u!=="ops")return;const O=document.querySelector(".atl2.ops .eval-stick")||document.querySelector(".atl2.ops .demand"),ne=document.querySelector(".atl2.ops");if(!O||!ne)return;const se=()=>ne.style.setProperty("--demand-h",`${O.offsetHeight}px`);se();const xe=new ResizeObserver(se);return xe.observe(O),()=>xe.disconnect()},[u,C,Q,z,V,te]),m.useEffect(()=>{if(!x&&!j){mt(null);return}let O=!0;return(async()=>{const ne=await Sr({email:n,cbToken:j});O&&mt(ne.length)})(),()=>{O=!1}},[x,j,n,ft]);const W=H.length?H:c,ie=s.credits,Ce=m.useCallback(O=>{const ne=O.map(se=>(se||"").trim()).filter(Boolean);ne.length&&(I(se=>{const xe=se.split(`
`).map(ze=>ze.trim()).filter(Boolean),He=new Set(xe.map(ze=>ze.toLowerCase())),Oe=ne.filter(ze=>!He.has(ze.toLowerCase()));return[...xe,...Oe].slice(0,15).join(`
`)}),S(!0))},[]);m.useEffect(()=>{if(!Y)return;oe(0);const O=window.setInterval(()=>oe(ne=>ne+1),1e3);return()=>window.clearInterval(O)},[Y]);const ue=m.useMemo(()=>{const O=N.trim().toLowerCase();return!O||!y?null:h.find(ne=>We(ne.name)===O&&qe(ne)===1)||null},[N,h,y]),he=()=>{const O=N.trim();if(O){if(ue){p(ue);return}i(null,O),g&&w("")}},Ze=async()=>{if(!g){i(null,P[0]||"");return}if(!P.length||M)return;F(!0),_.current=!1;const O=[];for(let ne=0;ne<P.length&&!_.current;ne++){q(e.evaluating(ne+1,P.length,P[ne]));const se=await Er(r,P[ne],"atelier2");if(O.unshift({name:se.company||P[ne],verdict:se.verdict,reason:se.reason||"",remaining:se.remaining??null}),B([...O]),se.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(P.length-ne-1),remaining:0}),B([...O]),I(P.slice(ne+1).join(`
`)),q(""),F(!1);return}}q(""),I(_.current?P.slice(O.length).join(`
`):""),F(!1)},at=async()=>{var se,xe,He;if(tt.current)return;const O=re.trim().replace(/\s+/g,""),ne=ve.trim();if(!O&&!ne){fe(e.rsNeed);return}if(!g&&!j){i(null,O||ne.slice(0,80));return}tt.current=!0,fe(""),Fe(null),Ae(null),Z(!0);try{const Oe=await Zo({url:O,text:ne,email:n,cbToken:j});if(Z(!1),!Oe||Oe.status!=="success"){fe((Oe==null?void 0:Oe.message)||"Erreur");return}Fe(Oe),G(!1),Ce((((se=Oe.prospective)==null?void 0:se.companies_to_evaluate)||[]).map(Ve=>(Ve==null?void 0:Ve.name)||"")),Ae({state:"pending"});const ze=await ei(Oe,{email:n,cbToken:j});Ae(ze.ok?{state:"ok",scopeLabel:((xe=ze.summary)==null?void 0:xe.scope_label)||"",scope:((He=ze.summary)==null?void 0:He.scope)||""}:{state:"fail",msg:ze.error||""}),ze.ok&&jt(Ve=>Ve+1)}finally{tt.current=!1,Z(!1)}},pt=[ae==null?void 0:ae.industry,...(ae==null?void 0:ae.market_tags)||[],ae==null?void 0:ae.author].map(O=>(O||"").trim()).filter(Boolean),st=(Ne==null?void 0:Ne.state)==="pending",Nt=Ne&&(st?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Ne.state==="ok"?t.jsx("span",{className:"rslink ok",children:Ne.scope&&Ne.scope!=="public"?e.rsSavedIn(Ne.scopeLabel||Ne.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Ne.msg,children:e.rsSaveFail})),St=Sl(ae).length,ge=V,Et=(A||N).trim(),Ca=ue?e.actAnalyse:Et?e.evalGoOn(Et.length>22?Et.slice(0,21)+"…":Et):e.evalGo,za=Y?`${Xo(re.trim())==="youtube"&&re.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ke)}`:st?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(ge?" rs-mode":"")+(A&&N.trim()===A||C||Q?" pair":"")+(C||Q||te?" echo":"")+(te?" swap":""),children:[t.jsxs("div",{className:"drow"+((ge?Q:C)||te?" flash":"")+((ge?re.trim():Ba.test(N.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:ge?re:N,placeholder:ge?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:ge?600:200,spellCheck:ge?!1:void 0,inputMode:ge?"url":void 0,onChange:O=>{if(ge){me(O.target.value);return}w(O.target.value),A&&O.target.value.trim()!==A&&L("")},onKeyDown:O=>{O.key==="Enter"&&(ge?at():he())}}),t.jsx("span",{className:"detect"+(ge?" off":"")+(Ba.test(N.trim())?" url":""),children:E})]}),t.jsxs("span",{className:"dacts"+(ge?" rs":" ev"),children:[t.jsx("span",{className:"dacts-ev","aria-hidden":ge,children:t.jsxs("button",{type:"button",className:"evalbtn"+(ue?" analyse":"")+(d?" loading":""),tabIndex:ge?-1:void 0,disabled:ge||d,onClick:he,children:[t.jsx("span",{className:"fill"}),Ca]})}),t.jsxs("span",{className:"dacts-rs","aria-hidden":!ge,children:[t.jsxs("a",{className:"viewbtn"+(It(re)?"":" off"),href:It(re)?re.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,tabIndex:!ge||!It(re)?-1:void 0,onClick:O=>{It(re)||O.preventDefault()},children:[t.jsx(Al,{}),e.viewLink]}),t.jsxs("button",{type:"button",className:"evalbtn"+(Y?" loading":""),tabIndex:ge?void 0:-1,disabled:!ge||Y||st||!re.trim()&&!ve.trim(),onClick:()=>{at()},children:[t.jsx("span",{className:"fill"}),za]})]})]}),f.showCredits&&ie&&t.jsxs("button",{type:"button",className:"credits"+(ie.total_available<=0&&!ie.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ie.unlimited?"∞":ie.total_available}),!ie.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ie.daily_grant+ie.purchased]}),ie.total_available<=0&&!ie.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(O=>O.status==="boot"||O.status==="running").map(O=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:O.name}),t.jsx(Vt,{item:O,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+O.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>S(!z),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(V?" on":""),onClick:()=>G(!V),children:e.rsOpen}),Xe!==null&&Xe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+($e?" on":""),onClick:()=>Je(!$e),children:e.rsArchOpen(Xe)})]}),$e&&t.jsx(zl,{bump:ft,cbToken:j,onClose:()=>Je(!1),onEvaluate:O=>i(null,O),onAddAll:Ce}),t.jsx("div",{className:"rsp slim"+(V?" on":" off")+(ee||ve.trim()?" wide":""),"aria-hidden":!V,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:V?void 0:-1,onClick:()=>le(O=>!O),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:ee||ve.trim()?"▴":"▾"})]}),(ee||!!ve.trim())&&t.jsx("textarea",{className:"rstext",value:ve,placeholder:e.rsTextPh,tabIndex:V?void 0:-1,onChange:O=>ye(O.target.value)})]})}),pe&&t.jsx("div",{className:"rserr",children:pe}),ae&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ae.title}),ae.source_url&&t.jsx("a",{href:ae.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{Fe(null),Ae(null)},children:"×"})]}),ae.market&&t.jsx("p",{className:"rsmk",children:ae.market}),pt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),pt.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[ae.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ae.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:no(ae.summary_md||"").map((O,ne)=>t.jsx("p",{children:O},ne))})]}),t.jsx(ro,{card:ae,onEvaluate:O=>i(null,O),onAddAll:Ce}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(St)}),Nt]})]}),z&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:R,placeholder:e.bulkPh,onChange:O=>I(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(M?" loading":""),style:{justifyContent:"center"},disabled:M||!P.length,onClick:()=>{Ze()},children:[t.jsx("span",{className:"fill"}),M&&v?v:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(P.length)})]})]}),W.slice(0,1).map((O,ne)=>{const se=O.verdict==="kept",xe=O.verdict==="quota",He=se?"var(--brand)":xe?"var(--bolt)":"var(--red)",Oe=se?"var(--brand-l)":xe?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":He,"--bgc":Oe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:se?"✓ "+e.kept:xe?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map(ze=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:ze.url.startsWith("http")?ze.url:`https://${ze.url}`,target:"_blank",rel:"nofollow noopener",children:[(ze.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,ze.url),children:e.evalPickGo})]},ze.url))}),!xe&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:se?1:5});const ze=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ve=[...document.querySelectorAll(".atl2 .list .row")].find(Aa=>{var Pt;return(((Pt=Aa.querySelector(".rnm"))==null?void 0:Pt.textContent)||"").trim().toLowerCase().includes(ze)});Ve&&(Ve.scrollIntoView({behavior:"smooth",block:"center"}),Ve.classList.add("flashrow"),window.setTimeout(()=>Ve.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(se?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),g&&(o.kept+o.dropped>0||W.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ll(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ql(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=$(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",Ll(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const d=ut(o),c=cn(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((f,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Tt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function vn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=$(),[l,d]=m.useState(!1),[c,f]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,x=async()=>{if(!s||l)return;d(!0);const u=await ti(r,e);if(d(!1),!u){o(a.actErr);return}f(u.results||[])};return m.useEffect(()=>{if(!s)return;const u=h=>{var b;const p=String(((b=h.detail)==null?void 0:b.name)||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,s]),m.useEffect(()=>{if(s)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Ml=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),da=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Rl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=da(a.slice(n));break}r+=da(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=da(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Ml.has(c)?r+=`<${d[1]}${c}>`:r+=da(a.slice(i,o+1)),n=o+1}return r}const gr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function De({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Fl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ol({o:e}){const{t:a,doDeep:r}=$(),[n,i]=m.useState(!1),o=ut(e),l=[e.reasoning||"",Fl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Tt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function yn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=$(),o=Jt(e),l=ut(e),d=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Tt(e)?1:0}].filter(b=>b.n>0),[e,a,d,l,c,f,s]),[u,h]=m.useState("");if(!x.length)return null;const p=x.some(b=>b.k===u)?u:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===b.k,"data-tour":"tab-"+b.k,className:p===b.k?"on":"",onClick:y=>{y.stopPropagation(),h(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(De,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(De,{k:a.cdVerdictDate,v:gr(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Rl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Pl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdSector,v:e.sector}),t.jsx(De,{k:a.cdStage,v:e.stage}),t.jsx(De,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(De,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(De,{k:a.cdAngle,v:e.angle}),t.jsx(De,{k:a.cdDetected,v:gr(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdName,v:e.contactName}),t.jsx(De,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(Ol,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(De,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Pl({o:e}){const{t:a,token:r}=$(),[n,i]=m.useState(!1),[o,l]=m.useState(null),d=async()=>{n||(i(!0),l(await ai(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=f.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[f.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Xt({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const d=()=>{const f=Math.max(280,Math.min(560,o.clientWidth||320));Rn({kind:"op",card:e},f).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Rn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const d=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&Rt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Dl=`
...
`;function Il(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let d=e.y+10;return d+n>o-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function Bl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:f,doPromote:s,doRepeche:x,doApproach:u,doDeep:h,doOnboard:p,outbound:b,evalBusy:y}=$(),g=e.popupId?r.get(e.popupId):null;if(!g)return null;const j=Re(g),N=qe(g),w=ut(g),C=Jt(g),T=g.kind==="target",A=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Rt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Dl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Il(e.popupAnchor,!!g.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:g.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ct(g.date)),Ue(g.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[g.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[g.cc]}),children:(Ft(g.cc,i)||g.countryLabel||"").toUpperCase()}),g.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[g.sector]}),children:g.sector.toUpperCase()}),g.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[g.stage]}),children:g.stage.toUpperCase()}),typeof g.amountEur=="number"&&g.amountEur>0&&t.jsx("span",{className:"am2",children:Ot(g.amountEur,i)})]}),o.pipe&&T&&t.jsxs("div",{className:"pstat",children:[C&&t.jsx("span",{className:"vd "+(C==="MATCH"?"v-ok":"v-no"),title:n.vt[C],children:C}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[N]}),g.ceoStatus&&t.jsx("span",{className:"pstep own",children:g.ceoStatus})]}),(g.tagline||g.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:g.tagline||g.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[bt(g.engine)," ",t.jsx("b",{children:Ue(g.engine,i)})," — ",ni(g.engine,i),g.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",g.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:g,lg:!0})," ",t.jsx(Ea,{o:g,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(mn(j,i))," · ",n.win7(ma(j,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),g.card?t.jsx(Xt,{spec:g.card}):null,g.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&N>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:g.reasoning})]}),o.pipe&&T&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof g.score=="number"&&g.score>0?" · "+n.score(g.score):""]})}),o.pipe&&T&&t.jsx(yn,{o:g})]}),t.jsx(vn,{name:g.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[N===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)]}),N===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),N===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),N===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(g,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(g,!1),a({type:"popup",id:null})},children:n.actNo}),Tt(g)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{h(g),a({type:"popup",id:null})},children:n.memoDeep})]}),N===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),N===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),g.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:g.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(g),a({type:"popup",id:null})},children:"🚀"})]}):g.engine==="media"&&g.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(g.name),onClick:()=>d(g),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)," →"]}),g.website&&t.jsx("a",{className:"psite",href:g.website.startsWith("http")?g.website:"https://"+g.website,target:"_blank",rel:"noopener noreferrer",title:g.website,children:"🌐"})]})]})]}),document.body)}const $l=8;function _l(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=$(),[d,c]=m.useState(!1),[f,s]=m.useState(!1),[x,u]=m.useState(!1),h=`atl2:sincemini:${r||"home"}`,[p,b]=m.useState(()=>{try{return localStorage.getItem(h)==="1"}catch{return!1}}),y=()=>{b(L=>{try{localStorage.setItem(h,L?"0":"1")}catch{}return!L})},g=r||"home",{names:j,verdicts:N}=m.useMemo(()=>{const L=[],z={};return n.forEach(S=>{S.kind!=="target"||!S.name||(L.push(S.name),z[S.name]=ri(S)||"")}),{names:L,verdicts:z}},[n]),w=m.useMemo(()=>j.length?oi(g,j,N,a):null,[g,j.length]);if(!i.pipe||d||!w||w.firstVisit||!w.added.length&&!w.gone.length)return null;const C=f?w.added:w.added.slice(0,$l),T=w.added.length-C.length,A=L=>{const z=n.find(S=>S.name===L);z&&(o(z.id),l({type:"popup",id:z.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(w.added.length,w.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:y,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),ii(g,j,N,w.fp,a)},children:"×"})]}),!!w.added.length&&t.jsxs("div",{className:"sg-c",children:[C.map(L=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>A(L),children:t.jsx("b",{children:L})},L)),T>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>s(!0),children:e.sinceMore(T)})]}),!!w.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(L=>!L),children:e.sinceOut(w.gone.length)}),x&&w.gone.slice(0,20).map(L=>t.jsx("span",{className:"gone",children:L},L))]})]})}const oo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function wn({o:e,locked:a=!1}){const{t:r}=$(),n=Jt(e),i=ut(e),o=qe(e),l=_a(e),d=li(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(oo[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(gs,{o:e})]})}const Mt=e=>e.length>22?e.slice(0,21)+"…":e,ua=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Sa(e){return ua.has(e.engine||"")}function io(e){return!!e.noCo||Sa(e)&&!!e.url}function Qt(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function so(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Ul({on:e,rev:a}){const[r,n]=m.useState(null),[i,o]=m.useState({top:0,left:0,width:0});return m.useEffect(()=>{if(!e){n(null);return}const l=()=>{var p,b,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const f=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:f.top;o({top:Math.round(s),left:Math.round(f.left),width:Math.round(f.width)});const x=[...d.querySelectorAll(":scope .grp")];let u=null;for(const g of x){const j=g.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=s+2&&(u=g)}if(!u){n(null);return}const h=u.querySelector(".grp-h");if(!h){n(null);return}n({ic:(((p=h.querySelector(".ic"))==null?void 0:p.textContent)||"").trim(),t:(((b=h.querySelector(".t"))==null?void 0:b.textContent)||"").trim(),s:(((y=h.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||i.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:i.top,left:i.left,width:i.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Hl(e){const r=()=>{const n=so(),i=e.getBoundingClientRect().top-n-8;Math.abs(i)<2||window.scrollBy({top:i,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function br({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=$(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),Ie(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Mt(e.name))})]})}function kn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:f,dispatch:s,liveMemos:x}=$();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),s({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Qt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return Sa(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Qt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(br,{o:e})});const u=qe(e),h=p=>b=>{b.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(br,{o:e})});if(u===1){const p=x.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Vt,{item:p,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:h(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:h(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:h(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:h(()=>f(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:h(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Vl({o:e}){const{t:a,doThumb:r,thumbOf:n}=$(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Wl({o:e}){const{lang:a}=$();return Re(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(Ea,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[bt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function Yl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:d,caps:c,markRow:f,markedId:s,favIds:x,toggleFav:u,t:h}=$(),p=qe(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,g=y<=0?0:y<=7?1:y<=30?2:3,j=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][p]:b[g],N=x.has(e.id),w=C=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const T=C.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:T.left+Math.min(280,T.width/3),y:T.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>f(e.id),onMouseLeave:()=>f(null),onClick:w,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(mo,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:N?1:.35,padding:0,marginRight:4},onClick:C=>{C.stopPropagation(),u(e)},children:N?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(C=>C&&C!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:h.acqSee(e.acquirer),onClick:C=>{C.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",Mt(e.acquirer)]}),it(e)?t.jsx("span",{className:"rdec",title:h.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:h.zoomNewsMark,children:"📰"}):null]}),t.jsx(Gl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Wl,{o:e}),c.pipe&&t.jsx(wn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(kn,{o:e}),c.showThumbs&&t.jsx(Vl,{o:e})]}),r&&!a&&!l&&t.jsx(Jl,{o:e})]})}function Gl({o:e}){const{lang:a,caps:r}=$();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ot(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Kl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=$(),l=(u,h=!1)=>p=>{p.stopPropagation(),h&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Ot(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Ie(e),x=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):io(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),Qt(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Mt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Mt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Xt,{spec:e.card})})]})}function Ql({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=$();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ue(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(kn,{o:e})}),t.jsx(yn,{o:e})]})}function lo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:d,dossiers:c}=$();if(!e&&!a){const M=c.find(it);if(M)return t.jsx(lo,{o:M})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),s=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),x=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),h=e?!!e.noCo:!f||fa(f),p=(e==null?void 0:e.engine)||"",b=it(e),y=e?Ot(e.amountEur,n):"",g=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),j=(()=>{const M=/https?:\/\/(?:www\.)?([^/]+)/.exec(s);return M?M[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(it),w=((N==null?void 0:N.url)||"").trim(),C=!!s&&!!w&&(s===w||s.endsWith(w)||w.endsWith(s)),T=(M,F=!1)=>v=>{v.stopPropagation(),F&&l({type:"continent",key:"monde"}),l({type:"filters",patch:M})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const A=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},L=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},z=()=>{Qt({url:s,headline:x,tagline:e==null?void 0:e.tagline,name:f})},S=e?Ie(e):!1,R=S&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",I=b?r.doEdito.replace(/^📖\s*/,""):p?Ue(p,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[I,g?` · ${g}`:""]}),t.jsx("h3",{className:"zoom-h",children:x}),s&&!b&&(h||Sa({engine:p}))&&t.jsxs("a",{className:"zoom-ext",href:s,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:M=>M.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,j?t.jsx("em",{children:j}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(Xt,{spec:u})}),(s&&!C&&!b||N&&!b)&&t.jsxs("div",{className:"zoom-srcbox",children:[s&&!C&&!b&&t.jsxs("a",{className:"zoom-src",href:s,target:"_blank",rel:"nofollow noopener",onClick:M=>M.stopPropagation(),children:[r.zoomSrc,j?` · ${j}`:""," ↗"]}),N&&!b&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:M=>{M.stopPropagation(),l({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[S?t.jsxs("span",{className:"verdict",style:{"--c":R?"var(--brand)":"var(--red)"},children:[R?"✓":"✗"," ",t.jsx("b",{children:R?r.kept:r.dropped})]}):!h&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:M=>{M.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Mt(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,s&&!b&&(h||Sa({engine:p}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!h&&f?" ghost":""),onClick:M=>{M.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!h&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:M=>{M.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:M=>{M.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Mt(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!h&&f&&d.pipe&&t.jsx(vn,{name:f})]})]})}function Jl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=$();return!i.pipe&&e.kind==="op"?t.jsx(Kl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(yn,{o:e}),t.jsx(bs,{o:e}),t.jsx(ws,{o:e}),t.jsx(vn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(wn,{o:e})})]}),e.card&&t.jsx(Xt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[bt(e.engine||"")," ",Ue(e.engine||"",r)]}),Re(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Xl({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:d,lang:c}=$();if(!l.pipe&&e.kind==="op"){const x=Ot(e.amountEur,c),u=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),h=(p,b=!1)=>y=>{y.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Xt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:h({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:h({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:h({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[bt(e.engine||"")," ",Ue(e.engine||"",c)]}),Re(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(kn,{o:e})})]})}const f=qe(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][f];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(wn,{o:e}),Re(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&f===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function Zl(){const{t:e}=$(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ed({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=i==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,x)=>(e[x]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(c)}”`:`${f} dossier${f>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function td(){var jt,tt;const e=$(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:d,markRow:c,lang:f,sessTally:s,data:x,dossiers:u,source:h,focusExtra:p,byId:b}=e,y=E=>i.lockRowsAfter!==null||h==="ops"?Number.MAX_SAFE_INTEGER:zr,[g,j]=m.useState(new Set);m.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[N,w]=m.useState(null);m.useEffect(()=>{w(null)},[a.ptab,a.continent]);const[C,T]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){T(!1);return}const E=document.getElementById("atl2-stage");if(!E){T(!1);return}const P=new IntersectionObserver(([W])=>T(!!W&&W.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return P.observe(E),()=>P.disconnect()},[a.mapFolded]);const A=a.mapFolded||!C,L=E=>j(P=>{const W=new Set(P);return W.has(E)?W.delete(E):W.add(E),W}),z=h==="ops"||i.pipe,[S,R]=m.useState("all"),[I,M]=m.useState(null),[F,v]=m.useState(!1),q=m.useRef(!0);m.useEffect(()=>{if(q.current){q.current=!1;return}R("all"),v(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!F)return;const E=P=>{var W,ie;(ie=(W=P.target)==null?void 0:W.closest)!=null&&ie.call(W,".atl2 .doable")||v(!1)};return document.addEventListener("click",E),()=>document.removeEventListener("click",E)},[F]);const H=Tr(),B=m.useMemo(()=>{var P;const E=new Map;for(const W of rs(((P=H==null?void 0:H.ed)==null?void 0:P.html)||""))E.has(W.t)||E.set(W.t,W.html);return E},[(jt=H==null?void 0:H.ed)==null?void 0:jt.html]),_=m.useCallback(E=>{if(E.decryptHtml)return E.decryptHtml;if(!B.size)return;const P=(E.name||"").trim().toLowerCase();if(P.length<3)return;const W=B.get(P);if(W)return W;for(const[ie,Ce]of B)if(ie.includes(P)||P.includes(ie))return Ce},[B]),V=m.useMemo(()=>{let E=fn(l,a.sort);return E=E.filter(P=>!it(P)),S==="explore"?E=E.filter(P=>!!P.noCo):S==="eval"&&(E=E.filter(P=>!P.noCo)),E},[l,a.sort,S,_]),G=m.useMemo(()=>i.pipe?d.filter(E=>Re(E)&&si(E)):V.filter(E=>Re(E)&&!Ie(E)),[i.pipe,d,V]),ee=G.length,[le,te]=m.useState(!1),[we,K]=m.useState(!1),re=`atl2:sigmini:${((tt=x.session)==null?void 0:tt.token)||"home"}`,[me,ve]=m.useState(()=>{try{return localStorage.getItem(re)==="1"}catch{return!1}}),ye=m.useMemo(()=>i.pipe?V:V.filter(E=>!Ie(E)&&!E.noCo),[V,i.pipe]),Q=h==="ops"?V.filter(E=>E.noCo).length:0,X=i.pipe?n.plabels[a.ptab].toLowerCase():h==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,Y=a.filters,Z=[];if(Y.day)Z.push({k:"day",lib:n.fDay(Y.day.slice(8,10)+"/"+Y.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(Y.win&&Y.win!=="all"){const E=["1","7","30"].indexOf(Y.win);E>=0&&Z.push({k:"win",lib:n.dates[E],off:()=>r({type:"filters",patch:{win:"all"}})})}const ke=E=>E.length<=2?E.join(", "):`${E.length} ${n.fSelected}`;for(const E of["sector","country","engine"]){const P=Y[E];P&&P.length&&Z.push({k:E,lib:ke(P),off:()=>r({type:"clearFacet",facet:E})})}Y.search&&Z.push({k:"search",lib:"🔍 "+Y.search,off:()=>r({type:"filters",patch:{search:""}})});const oe=(E,P,W="",ie=!1)=>t.jsxs("button",{type:"button","data-s":E,className:W,"aria-sort":a.sort.key===E?a.sort.dir===1?"ascending":"descending":"none",style:ie?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:E}),children:[P,t.jsx("span",{className:"ar",children:a.sort.key===E&&a.sort.dir===1?"▴":"▾"})]},E),pe=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const E=new Map;V.forEach(ie=>{const Ce=ie.engine||"?";E.has(Ce)||E.set(Ce,[]),E.get(Ce).push(ie)});const P={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},W=Ua([...E.keys()],f);return[...E.entries()].sort((ie,Ce)=>{const ue=P[ie[0]]??10+W.indexOf(ie[0]),he=P[Ce[0]]??10+W.indexOf(Ce[0]);return ue-he})},[V,i.pipe,a.groupBy,f]),fe=pe?pe.filter(([E])=>ua.has(E)).length:0,ae=(()=>{var P;return((P=(pe?pe.flatMap(([,W])=>W):V)[0])==null?void 0:P.id)??null})(),Fe=m.useRef(!1),Ne=m.useMemo(()=>u.find(it)||null,[u]);m.useEffect(()=>{const E=()=>{Fe.current=!0};return window.addEventListener("ppmap:reveal",E),window.addEventListener("ppmap:focus",E),()=>{window.removeEventListener("ppmap:reveal",E),window.removeEventListener("ppmap:focus",E)}},[]),m.useEffect(()=>{const E=()=>{Ne&&r({type:"focus",id:Ne.id})};return window.addEventListener("ppmap:edito",E),()=>window.removeEventListener("ppmap:edito",E)},[Ne,r]),m.useEffect(()=>{if(!a.focusId)return;M(a.focusId);const E=window.setTimeout(()=>M(null),900);return()=>window.clearTimeout(E)},[a.focusId]),m.useEffect(()=>{z&&(a.focusId&&(V.some(E=>E.id===a.focusId)||u.some(E=>E.id===a.focusId))||p||ae&&r({type:"focus",id:ae}))},[z,a.focusId,V,ae,p,r,u]),m.useEffect(()=>{if(!(!z||!a.focusId)&&S!=="all"&&!V.some(E=>E.id===a.focusId)&&u.some(E=>E.id===a.focusId)){if(Fe.current){R("all");return}ae&&r({type:"focus",id:ae})}},[z,a.focusId,S,V,u,ae,r]),m.useEffect(()=>{if(!z||!a.focusId||!Fe.current)return;Fe.current=!1;const E=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel");if(!E)return;const P=so(),W=E.getBoundingClientRect();W.top>=P-2&&W.bottom<=window.innerHeight-4||Hl(E)},[z,a.focusId]),m.useEffect(()=>{if(typeof window>"u")return;const E=document.querySelector(".atl2.ops .listhead"),P=document.querySelector(".atl2.ops");if(!E||!P)return;const W=()=>P.style.setProperty("--listhead-h",`${E.offsetHeight}px`);W();const ie=new ResizeObserver(W);return ie.observe(E),()=>ie.disconnect()},[A,a.dens,a.mapFolded]);const Ae=m.useMemo(()=>{if(!z||!a.focusId)return null;const E=V.find(W=>W.id===a.focusId)||u.find(W=>W.id===a.focusId)||null;if(!E)return null;const P=_(E);return P&&P!==E.decryptHtml?{...E,decryptHtml:P}:E},[z,a.focusId,V,u,_]),$e=i.lockRowsAfter;let Je=0;const Xe=(E,P)=>{let W=a.shown[P]||y();return E.length-W<=4&&(W=E.length),E.slice(0,W).map(ue=>{const he=$e!==null&&Je>=$e;Je++;const Ze=_(ue),at=Ze&&Ze!==ue.decryptHtml?{...ue,decryptHtml:Ze}:ue,pt=!z&&a.dens!=="maxi"&&(a.dens==="deplie"||(N?N==="open":!!Ze)),st=g.has(ue.id)?!pt:pt,Nt=z?St=>{Fe.current=!0,r({type:"focus",id:St});const ge=b.get(St);ge&&(io(ge)?Qt(ge):ge.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ge.name}})))}:void 0;return a.dens==="maxi"?t.jsx(Xl,{o:at,locked:he,selected:z&&a.focusId===ue.id,onSelect:Nt},ue.id):t.jsx(Yl,{o:at,locked:he,open:st,onToggle:()=>L(ue.id),selected:z&&a.focusId===ue.id,echo:I===ue.id,onSelect:Nt},ue.id)})},mt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(h==="ops"?" opsl":"")+(V.length?"":" list-empty"),ft=t.jsxs(t.Fragment,{children:[pe?pe.map(([E,P])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:bt(E)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:E==="ma"?n.grpMa:E==="fundraising"?n.grpLev:ua.has(E)&&fe<=1?n.grpNews:E==="nominations"?n.grpNom:E==="media"?n.grpNewsOther:E==="recrutements"?n.grpHire:ua.has(E)?n.grpNews+" · "+Ue(E,f):Ue(E,f)}),t.jsx("div",{className:"s",children:n.grpCount(P.filter(W=>!Ie(W)).length,P.length)})]})]}),Xe(P,E)]},E)):Xe(V,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Zl,{}),!V.length&&!(x.loading&&!u.length)&&(i.pipe?t.jsx(ed,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(A?" mapoff":""),children:[t.jsxs("div",{className:"lh-top",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:V.length})," ",X]}),t.jsx("span",{className:"dot",children:"·"}),A&&t.jsx(ao,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[A?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),Z.map(E=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:P=>{P.stopPropagation(),E.off()},children:[E.lib,t.jsx("i",{children:"×"})]},E.k)),h==="ops"&&V.length>0&&!A&&" — "+n.edSplit(V.length-Q,Q)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||h==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([E,P])=>t.jsxs("button",{type:"button","data-d":E,"aria-pressed":a.dens===E||E==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:E}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:P})]},E))}),!z&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":N==="open",onClick:()=>{w("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":N==="closed",onClick:()=>{w("closed"),j(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||h==="ops")&&(()=>{var ue;const E=l.filter(he=>!it(he)),P=E.filter(he=>!he.noCo).length,W=E.filter(he=>!!he.noCo).length,ie=[["all",n.doAll],["eval",`${n.doEval}${P?` ${P}`:""}`],["explore",`${n.doExplore}${W?` ${W}`:""}`]],Ce=((ue=ie.find(([he])=>he===S))==null?void 0:ue[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":F,onClick:()=>v(he=>!he),children:[Ce,t.jsx("i",{children:"▾"})]}),F&&t.jsx("div",{className:"dolist",children:ie.map(([he,Ze])=>t.jsx("button",{type:"button","aria-pressed":S===he,onClick:()=>{R(he),v(!1)},children:Ze},he))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:E=>r({type:"sort",key:E.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([E,P])=>t.jsx("option",{value:E,children:P},E))})]}),i.showChain&&ye.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ye.map(E=>E.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(ye.length):n.chainAll(ye.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]}),A&&t.jsx("div",{className:"lh-tools",children:t.jsx(to,{compact:!0})})]}),t.jsx(_l,{}),ee>0&&!a.filters.signalOnly&&!we&&t.jsxs("div",{className:"sigstrip"+(me?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(ee)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!me,title:me?n.boxExpand:n.boxCollapse,onClick:()=>ve(E=>{try{localStorage.setItem(re,E?"0":"1")}catch{}return!E}),children:me?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>K(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(le?G:G.slice(0,12)).map(E=>{const P=Re(E);return P?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(mn(P,f),ma(P,f)),onClick:()=>{c(E.id),r({type:"popup",id:E.id})},children:[t.jsx("b",{children:E.name}),t.jsxs("i",{children:[P.emoji," ",Ha(P,f)]}),t.jsx("em",{children:ma(P,f)})]},"sg-"+E.id):null}),!le&&G.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>te(!0),children:n.sigStripMore(G.length-12)})]})]}),a.dens!=="maxi"&&!z&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),oe("country",n.colCountry),oe("name",n.colCompany),oe("amount",n.colAmount,"h-amt",!0),oe("stage",n.colStage,"h-stade"),oe("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[oe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),oe("memo",n.colMemo)]}),i.pipe&&oe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),z?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),oe("country",n.colCountry),oe("name",n.colCompany),oe("amount",n.colAmount,"h-amt",!0),oe("stage",n.colStage,"h-stade"),oe("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:mt,children:ft})]}),t.jsxs("aside",{className:"readpane"+(h==="ops"&&(Ae?it(Ae):!p)?" is-edito":""),"aria-label":f==="fr"?"Dossier":"File",children:[h==="ops"&&Ne&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===Ne.id,onClick:()=>r({type:"focus",id:Ne.id}),children:n.doEdito}),i.pipe?t.jsx(Ql,{o:Ae}):t.jsx(lo,{o:Ae,extra:Ae?null:p})]})]}):t.jsx("div",{className:mt,children:ft}),(()=>{const E=pe||[["pt"+a.ptab,V]];let P=0,W=0;for(const[Ce,ue]of E){W+=ue.length;let he=a.shown[Ce]||y();ue.length-he<=4&&(he=ue.length),P+=Math.min(ue.length,he)}const ie=W-P;return ie<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>E.forEach(([Ce,ue])=>r({type:"more",group:Ce,by:ue.length,base:y()})),children:[t.jsx("span",{className:"more-label",children:n.more(ie,ie)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(P,W)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),z&&h==="ops"&&a.dens!=="maxi"&&t.jsx(Ul,{on:!!pe,rev:(pe||[]).map(([E,P])=>E+P.length).join("|")})]})}function vr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ad(e,a){const r=di(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function nd(e,a){const n=[a.head.split("|").map(vr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",ad(i,a.plabels),Jt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(vr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function rd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const od=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function nt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function id({o:e,qa:a}){const{t:r,lang:n,fund:i}=$(),o=(e.cribleStatus||"").trim().toUpperCase()||(Jt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=ut(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(nt,{k:r.cdSector,v:e.sector}),t.jsx(nt,{k:r.cdStage,v:e.stage}),t.jsx(nt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(nt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(nt,{k:r.cdName,v:e.contactName}),t.jsx(nt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(nt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(nt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(nt,{k:r.cdAngle,v:e.angle}),t.jsx(nt,{k:r.cdDetected,v:od(e.date,n)})]}),c.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,f])=>f).map(([f,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:s})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function sd(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=$(),[d,c]=m.useState({}),f=25,s=m.useMemo(()=>n.slice(0,f),[n]);m.useEffect(()=>{s.length&&ci(r,s.map(h=>h.name)).then(c)},[r,s]);const x=o.stats,u=h=>h.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(x.screened/o.marketEstimate*100)," %"]})]})]}),s.map(h=>t.jsx(id,{o:h,qa:d[h.name]},h.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ld=50;function jn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=$(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(0),[h,p]=m.useState(""),[b,y]=m.useState(!1),g=m.useRef(null);m.useEffect(()=>()=>{g.current&&window.clearInterval(g.current)},[]);const j=async w=>{c(!0),s("");const C=await a();if(c(!1),C.ok){l(C);return}if(C.busy){s(i.alertPreviewBusy);return}if(!w){s(i.alertPreviewFail);return}u(ld),g.current=window.setInterval(()=>{u(T=>T>1?T-1:(g.current&&window.clearInterval(g.current),j(!1),0))},1e3)},N=async()=>{if(n||b)return;y(!0),p("");const w=await r();y(!1),p(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||x>0,onClick:()=>{j(!0)},children:d?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{N()},children:b?"…":i.alertTest})]}),x>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(x)}),f&&t.jsx("p",{className:"mnote warn",children:f}),h&&t.jsx("p",{className:"mnote",children:h}),!h&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const At="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Be({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=$();return Rt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function dd(){const{st:e}=$();switch(e.modal){case"chain":return t.jsx(pd,{});case"space":return t.jsx(ud,{});case"alert":return t.jsx(md,{});case"queue":return t.jsx(bd,{});case"export":return t.jsx(vd,{});case"plug":return t.jsx(kd,{});case"recharge":return t.jsx(Nd,{});case"cover":return t.jsx(Ed,{});case"dossier":return t.jsx(Sd,{});case"crit":return t.jsx(Cd,{});case"tuto":return t.jsx(zd,{});case"rdv":return t.jsx(cd,{});case"memoalert":return t.jsx(yd,{});default:return null}}function cd(){const{dispatch:e,fund:a,t:r}=$(),n=a||r.rdvCoFallback;return Rt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Mr,children:hn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ha}`,children:ha})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Fi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function pd(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:d,caps:c,memoQueued:f,doAnalyse:s}=$(),x=o==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),h=e.chain.idx,p=u[h],b=h>=u.length;return Rt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${h+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:h/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[Ft(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(ct(p.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Ot(p.amountEur,i)})]}),Re(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:p,lg:!0})," ",t.jsx(Ea,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),x&&Ie(p)&&t.jsxs("div",{className:"vbox",style:{"--c":gt(p)==="retenu"?"var(--brand)":gt(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:gt(p)==="retenu"?"✓ "+n.kept:gt(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&p&&c.pipe&&qe(p)===1&&!f.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&p&&!(x&&Ie(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function ud(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=$(),o=i==="client",l=m.useMemo(()=>o?r.filter(x=>Ie(x)):[],[r,o]),d=m.useMemo(()=>fn(l.filter(x=>gt(x)==="retenu"),{key:"signal",dir:-1}),[l]),c=m.useMemo(()=>l.filter(x=>gt(x)==="ecarte"),[l]),f=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Be,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function md(){const{mode:e}=$();return e==="client"||e==="apercu"?t.jsx(fd,{}):t.jsx(gd,{})}function fd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),[o,l]=m.useState("d"),d=i!=="client";return t.jsxs(Be,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(xd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="w"&&t.jsx(hd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="m"&&t.jsx(co,{})]})}function xd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),Pn(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||Pn(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),h=p=>{const b=o.sections||e.alertSec.map(([y])=>y);x({sections:u(p)?b.filter(y=>y!==p):[...b,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>h(p)}),t.jsxs("span",{children:[b,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(jn,{label:e.alertPreview,readOnly:r,onPreview:()=>yi(a),onTest:()=>vi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function hd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),Dn(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||Dn(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,h=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>x({dow:Number(p.target.value)}),children:e.alertDow.map((p,b)=>t.jsx("option",{value:b,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,h-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[h," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,h+1)}),disabled:r,children:"＋"})]})]}),t.jsx(jn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ki(a),onTest:()=>wi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function co(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=$(),[l,d]=m.useState(o||""),[c,f]=m.useState(!1),[s,x]=m.useState(!1);m.useEffect(()=>{o&&d(o)},[o]);const u=e.filters,h=m.useMemo(()=>n.filter(g=>Re(g)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){x(!0);try{await fetch(`${dn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{x(!1)}}},y=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(g=>Ue(g,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(g=>Ft(g,r)||g).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([g,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:g}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},g))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,h)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function gd(){const{t:e}=$();return t.jsx(Be,{title:e.alertTitle,icon:"🔔",children:t.jsx(co,{})})}function bd(){var L,z;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:d,dispatch:c,liveMemos:f}=$(),[s,x]=m.useState(null),[u,h]=m.useState([]),[p,b]=m.useState(0),y=n==="client",g=m.useMemo(()=>{const S=new Map;return i.forEach(R=>{const I=(R.name||"").trim().toLowerCase();I&&!S.has(I)&&S.set(I,R)}),S},[i]);m.useEffect(()=>{let S=!0;return(async()=>{const[R,I]=await Promise.all([pn(r),Nr(a)]);S&&(R&&x(R),h(I))})(),()=>{S=!1}},[a,r,p]);const j=(s==null?void 0:s.per_day)??0,N=((L=s==null?void 0:s.analyzed_today)==null?void 0:L.length)??0,w=s==null?void 0:s.offre,C=(s==null?void 0:s.pool_meta)||[],T=m.useMemo(()=>{const S=new Map;for(const R of(s==null?void 0:s.scheduled)||[])for(const I of R.names||[])S.has(I)||S.set(I,{label:R.day_label,date:R.date});return S},[s==null?void 0:s.scheduled]),A=(s==null?void 0:s.in_progress)||[];return t.jsxs(Be,{title:e.queueTitle,wide:!0,children:[w&&t.jsxs("div",{className:"qoffre"+(w.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:w.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:w.delai})]}),t.jsx("span",{className:"osp"}),w.rythme>0?t.jsx("span",{className:"or",children:e.qRate(w.rythme)}):w.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(w.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(N,N+(((z=s==null?void 0:s.pool_order)==null?void 0:z.length)??0))}})}),w&&t.jsxs("div",{className:"qeta",children:[w.file===0?e.qEtaDone:w.rythme<=0?e.qEtaPaused:e.qEta(w.file,w.rythme,w.jours_restants),w.en_retard&&t.jsxs("em",{children:[" ",e.qLate(w.delai,w.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(w==null?void 0:w.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(A.length>0||f.items.some(S=>S.status==="boot"||S.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(S=>S.status==="boot"||S.status==="running"||S.status==="error").map(S=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:S.name}),t.jsx("span",{className:"qd",children:S.memoType||""}),t.jsx(Vt,{item:S,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+S.name)),A.filter(S=>!f.liveOf(S.name)).map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.name}),t.jsxs("span",{className:"qd",children:[S.memo_type||"",S.age_min?` · ${Math.round(S.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:S.state||""})]},"ip-"+S.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.company}),t.jsxs("span",{className:"qd",children:[S.memo_type,typeof S.est_min=="number"?` · ~${S.est_min} min`:""]}),t.jsx("span",{className:"qt",children:S.status}),S.url&&t.jsx("a",{className:"qgo",href:S.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),y&&S.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{On(a,S.company,"retry").then(()=>b(R=>R+1))},children:e.queueRetry}),y&&S.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{On(a,S.company,"delete").then(()=>b(R=>R+1))},children:e.queueDelete})]},S.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(C.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[C.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),C.map((S,R)=>{const I=T.get(S.name),M=g.get((S.name||"").trim().toLowerCase()),F=f.liveOf(S.name),v=!!(M&&l.has(M.id))||!!(F&&(F.status==="boot"||F.status==="running")),q=!!(M&&qe(M)===1&&!M.memoUrl)&&!F;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),I?t.jsx("span",{className:"qwhen"+(I.label==="demain"?" soon":""),children:I.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:S.name}),S.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof S.score=="number"&&t.jsx("span",{className:"qs2",children:S.score}),F&&(F.status==="boot"||F.status==="running")&&t.jsx(Vt,{item:F,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),q&&(d.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:v,onClick:()=>{o(M),b(H=>H+1)},children:v?e.actAnalyseQueued:e.actAnalyse})),S.excerpt&&t.jsx("span",{className:"qex",children:S.excerpt})]},S.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([S,R])=>t.jsxs("li",{children:[t.jsx("b",{children:S})," — ",R]},S))})]})}function vd(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=$(),d=`${At}/cibles/list.csv?token=${a}`,c=`${At}/cibles/list.json?token=${a}`,f=`${At}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,x=y=>{var g;(g=navigator.clipboard)==null||g.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:f,href:f}],h=!i.lockActions&&n.length>0,p=()=>{rd(nd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:y=>(e.stg.find(([g])=>g===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Be,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:g,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(g),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function yd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),o=i!=="client",[l,d]=m.useState(null),[c,f]=m.useState(!1),[s,x]=m.useState(0),[u,h]=m.useState(!1);m.useEffect(()=>{let g=!0;return f(!1),Fn(a).then(j=>{g&&(j?d(j):f(!0))}),()=>{g=!1}},[a,s]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=g=>{if(o||!l)return;const j={enabled:g.enabled??!!l.enabled,email:g.email??(l.email||""),sections:g.sections??p()};h(!0),Fn(a,j).then(N=>{if(h(!1),!N){n(e.memoAlertErr);return}d(N),r(e.memoAlertSaved)})};if(c)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(g=>g+1),children:e.retry})]})});if(!l)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=p();return t.jsxs(Be,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(wd,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:g=>b({email:g})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([g,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[g],disabled:o||u,onChange:()=>b({sections:{...y,[g]:!y[g]}})}),t.jsx("span",{children:j})]},g))}),t.jsx(jn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>ui(a,y),onTest:()=>pi(a,y)})]})}function wd({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const d=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&d&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:n})]})]})}function kd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=$(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(null),[x,u]=m.useState(""),[h,p]=m.useState(0);m.useEffect(()=>{let N=!0;return c(!1),Va(a).then(w=>{N&&(w?l({configured:w.configured,url_hint:w.url_hint}):c(!0))}),xi(a).then(w=>{N&&s(w)}),()=>{N=!1}},[a,h]);const b=(N,w)=>{i&&Va(a,N).then(C=>{if(!C||C.ok===!1){n(e.actErr);return}N.test&&C.sent===!1?n(e.plugTestThrottled):r(w),p(T=>T+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',g=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${At}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Be,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(N=>N+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!i,onChange:N=>u(N.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:g}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(g).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(jd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function jd(){const{t:e,token:a,lang:r}=$(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[d,c]=m.useState(null),[f,s]=m.useState(null),[x,u]=m.useState(!1),[h,p]=m.useState(!1),[b,y]=m.useState(null),[g,j]=m.useState(null),[N,w]=m.useState(null),C=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Va(a).then(I=>{j(I&&I.configured?I.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),s(null),u(!1),y(null);try{const I=JSON.parse(localStorage.getItem(C)||"null");w(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{w(null)}},[C]);const T=async()=>{l(!0),u(!1),y(null);const I=await gi(a,n);c(I),s(I.ok?n:null),l(!1)},A=m.useRef(!1),L=async()=>{if(A.current)return;A.current=!0,p(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await bi(a,n,"webhook",void 0,I)}finally{A.current=!1}if(p(!1),u(!1),y(M),M.ok&&(M.pushed||0)>0){const F={t:new Date().toISOString(),n:M.pushed||0};w(F);try{localStorage.setItem(C,JSON.stringify(F))}catch{}}},z=d!=null&&d.ok&&d.ready||0,S=!!(d!=null&&d.ok)&&f===n&&z>0&&!!g&&!N,R=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>i(I.target.value),children:e.plugBulkTabs.map(([I,M])=>t.jsx("option",{value:I,children:M},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(R,N.n)}),!N&&!!(d!=null&&d.ok)&&!g&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),S&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),S&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,g||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{L()},children:h?e.bulkSending:e.bulkConfirm(g||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Nd(){const{t:e,data:a,lang:r}=$(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const f=await(await fetch(`${dn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(Be,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Sd(){const{t:e}=$();return t.jsx(Be,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(sd,{})})}function Ed(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:d}=$(),[c,f]=m.useState(null),[s,x]=m.useState(!1);m.useEffect(()=>{let z=!0;if(o)return pn(o).then(S=>{z&&S&&typeof S.per_day=="number"&&f(S.per_day)}),()=>{z=!1}},[o]);const[u,h]=m.useState(null);m.useEffect(()=>{if(!i)return;let z=!0;return fi(i).then(S=>{z&&h(S)}),()=>{z=!1}},[i]);const p=r.stats,b=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(z=>z.kind==="target"&&Ie(z)).length,y=r.marketEstimate||0,g=y>0?Math.min(100,Math.round(b/y*100)):null,j=(p==null?void 0:p.window_days)||30,N=b>0?b/j:0,w=y>0?Math.max(0,y-b):0,T=y>0&&N>0&&b>=100?Math.round(w/N):null,A=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),L=z=>{s||!l||(x(!0),hi(i,z).then(S=>{if(x(!1),S===null){d(e.actErr);return}f(S),d(e.alertSaved)}))};return t.jsxs(Be,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(A(b))}),y>0&&t.jsx("span",{children:e.covOf(A(y))})]}),g!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:g+"%"}}),t.jsxs("em",{children:[g," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),N>=1&&t.jsx("p",{className:"mnote",children:e.covPace(A(N))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((z,S)=>t.jsxs("tr",{className:z.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[z.code,z.geo?` · ${z.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof z.n=="number"?A(z.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:z.source}),z.elargi&&t.jsx("em",{children:e.covWide(String(z.demande||""))}),z.erreur&&t.jsx("em",{children:e.covMissing})]})]},S)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:A(u.total||y)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:A(p.shown)})," ",e.funShown]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:c===z?"on":"",disabled:s,onClick:()=>L(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Cd(){var g,j,N;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:d}=$(),c=n==="client",f=m.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[s,x]=m.useState(""),[u,h]=m.useState(""),[p,b]=m.useState(!1),y=async()=>{const w=s.trim();if(!(!w||p||!c)){b(!0),h("");try{const T=await(await fetch(`${At}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&h(String(T.reply)),T.job_id){h(e.critChatRunning);const A=async()=>{const L=await fetch(`${At}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(z=>z.json()).catch(()=>null);if(L&&L.done){h(String(L.reply||L.clarification||L.summary||"✓")),b(!1),L.applied&&i(e.alertSaved);return}setTimeout(()=>{A()},8e3)};setTimeout(()=>{A()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(Be,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((g=o.points)!=null&&g.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=o==null?void 0:o.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var C,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(A=>t.jsx("li",{children:A},A))})]}),!!((T=w.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(A=>t.jsx("li",{children:A},A))})]})]})]},w.title)})]}),!!((N=o==null?void 0:o.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||p,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!c||p||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(mi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(oo[w]||"v-cons"),children:w}),t.jsx("span",{children:C})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",C]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function zd(){const{t:e,dispatch:a,startTour:r}=$(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Be,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const po="atl2:mapfold",Ad=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(po);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Td=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},uo=m.createContext(null),$=()=>{const e=m.useContext(uo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=$(),n=Re(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ha(n,r),children:[n.emoji," ",Ha(n,r)]}):null}function Ea({o:e,src:a}){const{lang:r,t:n}=$(),i=Re(e);if(!i)return null;const o=zi(i),l=Ai(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(mn(i,r))+" · "+n.win7(ma(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Ld(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=We(a);if(i)return e.find(o=>We(o.name)===i)||e.find(o=>{const l=We(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function qd(){const{scoped:e,t:a,st:r,dispatch:n}=$(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(x=>!it(x)),d=l.length,c=l.filter(x=>!x.noCo).length,f=l.filter(x=>!!x.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const x=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",f," ",a.zoomPulseExplore]})]})]})}function mo({o:e}){const{lang:a}=$(),r=Ci(e.cc),n=e.cc?Ft(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const yr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Md=!1;function Rd(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const fo=e=>`atl2:tour:${e||"anon"}`;function Fd(e){try{return localStorage.getItem(fo(e))==="1"}catch{return!0}}function wr(e){try{localStorage.setItem(fo(e),"1")}catch{}}function Od(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function $d({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var Pt;const{lang:l}=ji(),d=_i[l],c=Zi(e,l,a),[f,s]=m.useReducer(as,void 0,()=>es((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Td():Ad()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=m.useRef(!0);m.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(po,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var k;(k=u.current)==null||k.call(u,f.filters)},[f.filters]);const[h,p]=m.useState(null),[b,y]=m.useState(null),[g,j]=m.useState(null),[N,w]=m.useState({kept:0,dropped:0}),[C,T]=m.useState(!1),[A,L]=m.useState(""),[z,S]=m.useState(!1),[R,I]=m.useState(null),[M,F]=m.useState(!1),[v,q]=m.useState(!1),[,H]=m.useState(0),B=()=>H(k=>k+1),_=m.useRef([]),V=m.useRef(new Set),G=m.useRef(new Set),[ee,le]=m.useState([]),[te,we]=m.useState([]),[K,re]=m.useState(0),me=m.useRef(new Map),ve=m.useRef(null),{mode:ye}=c,Q=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),X=Q.pipe,Y=c.session.token||"",Z=ye==="client"&&!e;m.useEffect(()=>{if(!Y||!X)return;let k=!0;const U=async()=>{const de=await Ti(Y);!k||!de||(we(de.runs),re(Date.now()/1e3-de.now),le(Se=>Se.filter(Me=>!de.runs.some(et=>We(et.company)===We(Me.name)))))};U();const D=ee.length>0||te.some(de=>de.status==="running"),J=window.setInterval(()=>{U()},D?8e3:25e3);return()=>{k=!1,window.clearInterval(J)}},[Y,X,ee.length,te.some(k=>k.status==="running")]);const ke=m.useMemo(()=>{const k=[],U=new Set;for(const D of ee){const J=We(D.name);!J||U.has(J)||(U.add(J),k.push({name:D.name,id:D.id,status:"boot",started:D.started,estMin:D.estMin,memoType:"instant"}))}for(const D of te){const J=We(D.company);if(!J||U.has(J))continue;U.add(J);const de=D.status==="error"?"error":D.status==="done"?"done":"running";k.push({name:D.company,status:de,started:D.started||0,estMin:D.est_min||(D.memo_type==="detailed"?40:15),url:D.url,error:D.error,memoType:D.memo_type})}return k},[ee,te]),oe=k=>ke.find(U=>We(U.name)===We(k))||null,pe=(k,U)=>{le(D=>D.some(J=>We(J.name)===We(k.name))?D:[...D,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:U==="detailed"?40:15}]),V.current.add(k.id),B()};m.useEffect(()=>{if(document.querySelector(`link[href="${yr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=yr,document.head.appendChild(k)},[]);const fe=(k,U=!1)=>{L(k),S(U),ve.current&&clearTimeout(ve.current),ve.current=setTimeout(()=>L(""),U?4200:2400)},ae=k=>fe(k,!0),Fe=m.useMemo(()=>{const k=new Map;return c.dossiers.forEach(U=>{U.id&&k.set(U.id,U)}),k},[c.dossiers]),Ne=m.useMemo(()=>c.dossiers.filter(k=>Ar(k,f,X)),[c.dossiers,f,X]),Ae=m.useRef(!1);m.useEffect(()=>{if(Ae.current||e||c.loading||!c.dossiers.length)return;if(!Q.showFunnel||Fd(c.session.token||"")){Ae.current=!0;return}Ae.current=!0;const k=window.setTimeout(()=>{wr(c.session.token||""),F(!0)},700);return()=>window.clearTimeout(k)},[e,c.loading,c.dossiers.length,Q.showFunnel,c.session.token]);const $e=m.useMemo(()=>c.dossiers.filter(k=>ns(k,f,X,c.favIds)),[c.dossiers,f,X,c.favIds]),Je=m.useMemo(()=>Ni(Ne,c.favIds),[Ne,c.favIds]),Xe=m.useRef(!1);m.useEffect(()=>{if(Xe.current)return;if(!X||a==="ops"){Xe.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Xe.current=!0;return}if(c.loading)return;Xe.current=!0;const k=Si(Je);k!==f.ptab&&s({type:"ptab",tab:k})},[X,a,n==null?void 0:n.ptab,c.loading,Je,f.ptab]);const mt=m.useMemo(()=>{const k=Fr(c.dossiers);return k?ct(k)===0?d.tourToday:Or(k,l):d.tourNoRun},[c.dossiers,d,l]),ft=m.useMemo(()=>c.dossiers.some(k=>!!k.memoUrl||!!k.summary||Tt(k)),[c.dossiers]),[jt,tt]=m.useState(!1);m.useEffect(()=>{if(c.loading){tt(!1);return}if(c.dossiers.length>0||c.error){tt(!0);return}const k=window.setTimeout(()=>tt(!0),6e3);return()=>window.clearTimeout(k)},[c.loading,c.dossiers.length,c.error]);const E=(c.marketEstimate||0)>0||typeof((Pt=c.stats)==null?void 0:Pt.screened)=="number"&&c.stats.screened>0,P=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(Je[k]||0)>0)??0,[Je]),W=un.find(k=>k.key===f.continent),ie=f.continent==="monde"?d.contWorld:(l==="fr"?W==null?void 0:W.fr:W==null?void 0:W.en)||"";m.useEffect(()=>{const k=U=>{var J;const D=(((J=U.detail)==null?void 0:J.name)||"").trim();D&&Ce(null,D)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{if(a!=="ops")return;const k=U=>{const D=U.detail||{},J=String(D.id||"").trim(),de=String(D.name||"").trim(),Se=String(D.url||"").trim(),Me=J&&Fe.get(J)||Ld(c.dossiers,de,Se);if(Me){y(null),window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Me.id}),(Me.noCo||["media","nominations","recrutements"].includes(Me.engine||""))&&(Me.url||Me.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Me.url||"",text:[Me.headline,Me.tagline].filter(Boolean).join(`
`)}})):Me.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Me.name}}));return}!de&&!Se||(s({type:"focus",id:null}),y({name:de,headline:String(D.text||"").trim()||de,url:Se,card:D.card}),Se&&(fa(de)||!de)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Se,text:String(D.text||"").trim()}})):de&&!fa(de)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:de,url:Se}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=J=>{const de={},Se=String((J==null?void 0:J.sector)||"").trim();Se&&(de.sector=[Se]);const Me=String((J==null?void 0:J.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Me)&&(de.day=Me);const et=String((J==null?void 0:J.search)||"").trim();et&&(de.search=et);const je=String((J==null?void 0:J.dealKind)||"").trim();(je==="ma"||je==="levee"||je==="other")&&(de.dealKind=[je]),Object.keys(de).length&&s({type:"filters",patch:de})},U=J=>k(J.detail),D=J=>{J.data&&J.data.type==="pp-filter"&&k(J.data)};return window.addEventListener("ppmap:filter",U),window.addEventListener("message",D),()=>{window.removeEventListener("ppmap:filter",U),window.removeEventListener("message",D)}},[]),m.useEffect(()=>{const k=U=>{var de;const D=(((de=U.detail)==null?void 0:de.name)||"").trim().toLowerCase();if(!D)return;const J=c.dossiers.find(Se=>(Se.name||"").trim().toLowerCase()===D);J&&s(a==="ops"?{type:"focus",id:J.id}:{type:"popup",id:J.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const Ce=(k,U)=>{const D=((k==null?void 0:k.name)||U||"").trim();if(!Z){j({kicker:D});return}!D||C||(T(!0),(async()=>{try{let J=D;const de=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(de)J=de;else try{const je=await Li(D);if(je!=null&&je.website)J=je.website;else if(((je==null?void 0:je.candidates)||[]).length===1)J=je.candidates[0].url;else if(((je==null?void 0:je.candidates)||[]).length>1){_.current=[{name:D,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(je.candidates||[]).slice(0,5)},..._.current].slice(0,8),B();return}}catch{}const Se=await Er(Y,J,"atelier2"),Me={name:Se.company||D,verdict:Se.verdict,reason:Se.reason||"",remaining:Se.remaining??null};_.current=[Me,..._.current].slice(0,8),Se.verdict==="kept"&&w(je=>({...je,kept:je.kept+1})),Se.verdict==="ruled_out"&&w(je=>({...je,dropped:je.dropped+1}));const et=k||c.dossiers.find(je=>(je.name||"").toLowerCase()===D.toLowerCase());et&&(Se.verdict==="kept"?et.verdict=et.verdict||"MATCH":Se.verdict==="ruled_out"&&(et.verdict="NO MATCH"),Se.reason&&(et.reasoning=Se.reason)),B()}finally{T(!1)}})())},ue=k=>{if(!Z){j({kicker:k.name});return}pe(k,"instant"),Dt(Y,"fast_request",k.name||"",""),fe(d.memoInstantSent(k.name))},he=k=>me.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),Ze=(k,U)=>s({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:U}}),at=async(k,U,D)=>{const J=k.ceoStatus||"";k.ceoStatus=U,B();const de=await La(Y,{status:U,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(D==null?void 0:D.note)!==void 0?{note:D.note}:{},...D!=null&&D.via?{via:D.via}:{}});return de.ok?de.skipped?(k.ceoStatus=J,B(),ae(d.actNotPersisted),!1):((D==null?void 0:D.undo)!==!1&&Ze(k,J),D!=null&&D.msg&&fe(D.msg),(U==="Validé"||U==="Écarté")&&!k.ceoNote&&(D==null?void 0:D.note)===void 0&&I({o:k,yes:U==="Validé"}),!0):(k.ceoStatus=J,B(),ae(d.actErr),!1)},pt=async(k,U)=>{const D=await La(Y,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:U,via:"note"});return!D.ok||D.skipped?(ae(D.skipped?d.actNotPersisted:d.actErr),!1):(k.ceoNote=U,B(),!0)},st=m.useRef(new Map),Nt=k=>st.current.has(k.id)?st.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),St=(k,U)=>{st.current.set(k.id,U),B()},ge=(k,U)=>{Z&&at(k,U?"Validé":"Écarté",{msg:U?d.decidedYes(k.name):d.decidedNo(k.name)})},Et=k=>{Z&&at(k,"À trancher",{msg:d.promoted(k.name)})},Ca=k=>{Z&&(async()=>{const U=k.ceoStatus||"";k.ceoStatus="Retenu",B();const D=await La(Y,{status:"Retenu",check_id:k.checkId,company:k.name});if(!D.ok||D.skipped){k.ceoStatus=U,B(),ae(D.skipped?d.actNotPersisted:d.actErr);return}Ze(k,U),fe(d.repeched(k.name))})()},za=()=>{const k=f.undo[f.undo.length-1];if(!k){fe(d.undoNone);return}const U=Fe.get(k.id);if(!U){s({type:"undoPop"}),fe(d.undoNone);return}let D=k.prevCeoStatus;if(!D)if((U.verdict||"").toUpperCase().includes("CALL"))D="À trancher";else{fe(d.undoLockedTitle);return}(async()=>await at(U,D,{undo:!1})&&(s({type:"undoPop"}),U.ceoStatus=k.prevCeoStatus,B(),fe(d.undoDone(U.name))))()},O=k=>{Z&&(G.current.add(k.id),B(),(async()=>{const U=await qi(Y,k.name,"email");if(!U||U.ok===!1){G.current.delete(k.id),B(),ae(d.actErr);return}Dt(Y,"approach",k.name||"",""),fe(d.actApproachSent)})())},ne=(k,U)=>{Z&&(async()=>{if(!(await Dt(Y,U?"yes":"no",k.name||"","")).ok){ae(d.actErr);return}me.current.set(k.id,U?"yes":"no"),B(),fe(U?d.thumbUpDone:d.thumbDnDone)})()},se=k=>{!Z||!Tt(k)||(pe(k,"detailed"),Dt(Y,"detailed_request",k.name||"",""),fe(d.memoDeepSent(k.name)))},xe=k=>{const U=new Set(c.favIds),D=U.has(k.id);D?U.delete(k.id):U.add(k.id),c.setFavIds(U),Z&&Mi(Y,{id:k.id,co:k.name},D)},He=()=>{!Z||v||window.confirm(d.identSyncConfirm)&&(q(!0),(async()=>{const k=await Ri(Y);q(!1),k?fe(d.identSyncDone):ae(d.actErr)})())},Oe=/proplace/i.test(c.fund||""),ze=k=>{!Z||!Oe||(Dt(Y,"onboard_request",k.name||"",""),fe(d.onboardSent(k.name)))},Ve={st:f,dispatch:s,t:d,lang:l,mode:ye,caps:Q,pipe:X,token:Y,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:Ca,thumbOf:he,canWrite:Z,commitStatus:at,saveNote:pt,stageOf:Nt,setStage:St,flashErr:ae,startTour:()=>F(!0),dossiers:c.dossiers,scopedAll:Ne,scoped:$e,counts:Je,byId:Fe,contName:ie,favIds:c.favIds,toggleFav:xe,askEvaluate:Ce,doAnalyse:ue,doDecide:ge,doPromote:Et,doApproach:O,doThumb:ne,doDeep:se,doUndo:za,doSync:He,doOnboard:ze,outbound:Oe,memoQueued:V.current,liveMemos:{items:ke,serverOff:K,liveOf:oe},approachDone:G.current,sessTally:N,evalCards:_.current,evalBusy:C,markRow:p,markedId:h,flash:fe,focusExtra:b};m.useEffect(()=>{const k=U=>{U.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const Aa=k=>Y?t.jsx(os,{token:Y,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(uo.Provider,{value:Ve,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(Y?" cibles":""),children:[t.jsx("style",{children:Vi}),Q.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Mr,children:hn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${ha}`,children:ha})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),Aa(t.jsxs("div",{className:"app"+(X?" pipe":"")+(Y?" has-thesis":""),children:[Q.showTicker&&t.jsx(Pe,{name:"live",children:t.jsxs("div",{className:"live-stack"+(Y?" live-stack--cibles":""),children:[t.jsx(ps,{}),!!Y&&t.jsx(is,{})]})}),Q.showIdent&&t.jsx(Pe,{name:"identite",children:t.jsx(Ns,{})}),!1,!!Y&&t.jsx(Pe,{name:"brief",children:t.jsx(ss,{})}),Md,Q.showMorning&&t.jsx(Pe,{name:"matin",children:t.jsx(js,{})}),t.jsx(Pe,{name:"mesure",children:t.jsx(xs,{})}),Q.showFunnel&&t.jsx(Pe,{name:"entonnoir",children:t.jsx(Pd,{})}),Q.showFunnel&&t.jsx(Pe,{name:"tunnel",children:t.jsx(Ss,{})}),Q.showFunnel&&t.jsx(Pe,{name:"tuto",children:t.jsx(Es,{})}),!f.mapFolded&&t.jsx(Pe,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(ao,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(qd,{}),t.jsx(jl,{}),t.jsx(to,{})]})]})}),Q.showDemand&&X&&t.jsx(Pe,{name:"direct",children:t.jsx(Ii,{items:ke,serverOff:K,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),Q.showDemand&&t.jsx(Pe,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Tl,{})})}),Q.showDemand&&f.memoConsole&&t.jsx(Pe,{name:"console",children:t.jsx(ql,{})}),t.jsx(Pe,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(td,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(Pe,{name:"fiche",children:t.jsx(Bl,{})}),t.jsx(Pe,{name:"modales",children:t.jsx(dd,{})}),t.jsx(fs,{}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(ys,{placeholder:R.yes?d.whyYesPh:d.whyNoPh,onDone:k=>{const U=R.o;I(null),k&&pt(U,k).then(D=>{D&&fe(d.csNoteSaved)})}})]}),M&&jt&&t.jsx(ks,{steps:Od(d,mt,ft,P,E),onClose:()=>{F(!1),wr(Y)}}),t.jsx(Rd,{}),A&&t.jsx("div",{className:"flash on"+(z?" err":""),children:A}),g&&t.jsx(Ei,{variant:"acquirer",initialCompany:kr().co,initialWebsite:kr().site,onClose:()=>j(null)})]})})}function Pd(){const{t:e}=$(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function kr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Dd(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{mo as FlagCell,wt as SigBadge,Ea as SigWin,$d as default,Dd as fmtShort,$ as useV2};
