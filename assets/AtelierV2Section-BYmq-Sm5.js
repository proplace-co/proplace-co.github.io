...
· Le compteur ci-dessus dit combien partent par jour et ce qui attend.`,fhintTabAna:`Les dossiers dont le mémo est déjà lancé.
...
· The counter above says how many go out per day and what is waiting.`,fhintTabAna:`The files whose memo is already running.
...
`,Xs=Ys+Qs+Ks+Js;function sn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Zs(){const e=sn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function el(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Zs();return r==="0"?"client":r==="1"||sn("embed")==="1"&&sn("chrome")==="1"?"apercu":"client"}const tl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},al=e=>tl[e];function Sa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const At=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!no(a)||Sa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:qi(e.cc)})};function Va(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const nl=60*60*1e3;function rl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>nl?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ol=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function il(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:vi(),[e,n]),i=c.useMemo(()=>n?"visiteur":el(e,o),[e,o,n]),d=c.useMemo(()=>al(i),[i]),s=i!=="visiteur",l=ol(r),[h,p]=c.useState([]),[x,u]=c.useState(""),[b,m]=c.useState(null),[w,y]=c.useState(null),[f,v]=c.useState(null),[j,k]=c.useState(()=>new Map),[E,S]=c.useState(()=>new Map),[C,L]=c.useState(""),[q,M]=c.useState(new Set),[R,$]=c.useState(null),[F,O]=c.useState(!0),[g,A]=c.useState(!1),[U,ee]=c.useState(0),[N,I]=c.useState(0),D=c.useRef(0),B=c.useMemo(()=>{var ae;if(i!=="client")return"";try{return((ae=wi())==null?void 0:ae.email)||""}catch{return""}},[i]);c.useEffect(()=>{const ae=++D.current;let be=!0;const J=()=>be&&ae===D.current,he=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),ue=rl(he);return ue?(p(ue.objs.map(At)),ue.fund&&u(ue.fund),m(ue.marketEstimate??null),y(ue.criteria??null),v(ue.stats??null),L(ue.generatedAt||""),O(!1)):O(!0),(async()=>{try{if(r==="ops"){const ge=await Ba(),_=((ge==null?void 0:ge.recent_ops)||[]).map(K=>{const V=wa(K.company_name||K.title?K:{...K,title:(K.headline_fr||K.headline||"").slice(0,120)},a),ne=String(K.rubrique||"").toLowerCase();return V&&(ne==="nominations"||ne==="recrutements")&&(V.engine=ne),V&&!String(K.company_name||"").trim()&&(V.noCo=!0),V}).filter(K=>!!K).map(K=>(no((K.name||"").trim())||(K.noCo=!0),K));try{const K=yi(),V=await ki(),ne=((V==null?void 0:V.date)||"").slice(0,10),H=K?K.doc:V,se=ji(H),le=((K==null?void 0:K.day)||(H==null?void 0:H.date)||ne||"").slice(0,10);if(le&&se.length){const oe=new Set;for(const re of _){if((re.date||"").slice(0,10)!==le)continue;const we=Un(se,oe,re.name,"");we>=0&&(oe.add(we),re.decryptHtml=se[we].html)}for(const re of _){if(re.decryptHtml||(re.date||"").slice(0,10)!==le)continue;const we=Un(se,oe,"",re.headline||re.tagline||re.name);we>=0&&(oe.add(we),re.decryptHtml=se[we].html)}}if(le){const oe=((H==null?void 0:H.title_fr)||"").trim(),re=((H==null?void 0:H.lead_fr)||"").trim(),we=Ei(H),me=((H==null?void 0:H.url)||"").trim();oe&&(we||me)&&_.unshift({id:`edito:${le}`,kind:"op",name:oe,cc:null,date:le,engine:"edito",dealKind:"other",headline:oe,tagline:re||oe,decryptHtml:we||void 0,url:me,noCo:!0})}}catch{}if(!J())return;p(_.map(At)),ca(he,{objs:_})}else if(typeof r=="object"){const _=(await Hn()||[]).filter(V=>(V.slug||"")===r.research).map(V=>Vn(V,a)).filter(V=>!!V),K=Va(await Wn(_,a));if(!J())return;p(K.map(At)),ca(he,{objs:K})}else if(s&&o.token){const ge=Ni(o.token),_=Ba(),K=Si(o.token),V=Ci(o.token),ne=zi(o.token),H=await ge;let se=H?H.targets:[];J()&&H&&(u(H.fund||""),m(H.marketEstimate??null),y(H.criteria??null),v(H.stats??null),L(H.generatedAt||""),p(se.map(At)),O(!1),A(!1));const[le,oe,re,we]=await Promise.all([_,K,V,ne]),me=((le==null?void 0:le.recent_ops)||[]).map(Ce=>wa(Ce,a)).filter(Ce=>!!Ce),We=new Set(se.map(Ce=>Ce.id));if(se=[...se,...me.filter(Ce=>!We.has(Ce.id)&&(We.add(Ce.id),!0))],!J())return;p(se.map(At));const ye=new Set;for(const Ce of oe){const Ne=(Ce.id||Ce.co||"").toString().trim().toLowerCase();Ne&&ye.add(Ne.startsWith("t:")?Ne:"t:"+Ne)}M(ye),k(re),S(we),H&&ca(he,{fund:H.fund,marketEstimate:H.marketEstimate,criteria:H.criteria,stats:H.stats,generatedAt:H.generatedAt,objs:se})}else{const ge=Ai(),_=Hn(),K=Ba(),V=await ge;J()&&V.length&&(p(Va(V).map(At)),O(!1),A(!1));const[ne,H]=await Promise.all([_,K]),se=(ne||[]).map(we=>Vn(we,a)).filter(we=>!!we),le=await Wn(se,a),oe=((H==null?void 0:H.recent_ops)||[]).map(we=>wa(we,a)).filter(we=>!!we),re=Va([...V,...le,...oe]);if(!J())return;p(re.map(At)),ca(he,{objs:re})}J()&&A(!1)}catch{J()&&!ue&&A(!0)}finally{J()&&O(!1)}})(),()=>{be=!1}},[s,o.token,a,U,l]),c.useEffect(()=>{if(!d.showCredits||!B){$(null);return}let ae=!0;return(async()=>{try{const be=await fetch(`${Ia}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:B})});if(!be.ok)return;const J=await be.json();ae&&J&&J.ok!==!1&&$(J)}catch{}})(),()=>{ae=!1}},[d.showCredits,B,N]);const te=c.useCallback(ae=>M(new Set(ae)),[]);return{session:o,mode:i,caps:d,fund:x,email:B,marketEstimate:b,generatedAt:C,criteria:w,stats:f,thumbs:j,stages:E,dossiers:h,patchStatuses:(ae,be)=>{p(J=>{let he=!1;const ue=J.map(ge=>{if(!ge.checkId)return ge;const _=ae.get(ge.checkId);return!_||_===(ge.ceoStatus||"")||!be(ge.id)?ge:(he=!0,{...ge,ceoStatus:_})});return he?ue:J})},favIds:q,setFavIds:te,credits:R,reloadCredits:()=>I(ae=>ae+1),loading:F,error:g,refresh:()=>ee(ae=>ae+1)}}function Ye(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ya=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ca(e){return ya.has(e.engine||"")}function Ge(e){return!!e.noCo||Ca(e)&&!!e.url}const go=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),sl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...go(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,memoTab:0,undo:[],mapFolded:a}),ll=new Set(["signal","amount","score","crible","memo"]);function dl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:go(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ll.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??xo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const xo=80;function za(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!De(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(En(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(bt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Tt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(oo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function ta(e,a,r){return Ye(e)?za(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:za(e,a.filters,r)}function pl(e,a,r,n){return!(!ta(e,a,r)||r&&!ro(e,a.ptab,n))}function zn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-bt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Li(o)||null;case"memo":return Ti(o)||null;case"signal":{const i=De(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),s=n(i);return d===null||s===null?d===s?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<s?-a.dir:d>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const Wa={},dr=(Wa==null?void 0:Wa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function pr(){return new Date().toISOString().slice(0,10)}const An=c.createContext(null);function bo(){return c.useContext(An)}function cl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const h=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(p=>l.removeAttribute(p.name)),h&&/^https?:\/\//i.test(h)&&(l.setAttribute("href",h),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:s.outerHTML})}}catch{}return a}function ul(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function cr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function ur(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function vo(){const e=c.useContext(An);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ml({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Q(),[i,d]=c.useState(()=>n.filters.day||pr()),[s,l]=c.useState(null),[h,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),u=c.useCallback(()=>{d(pr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=y=>{var v;const f=(v=y.detail)==null?void 0:v.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${dr}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{w||l(f)}).catch(()=>{w||l({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${dr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=c.useMemo(()=>({token:e,day:i,ed:s,loading:h,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,h,x,u,n.filters.day,b,o]);return t.jsx(An.Provider,{value:m,children:a})}function fl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=vo(),[o,i]=c.useState(()=>n||io());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(Ea,d),()=>window.removeEventListener(Ea,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Fi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function hl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function mr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function fr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function gl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=vo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!d,l=a&&!a.ok,h=c.useRef(null),[p,x]=c.useState("fonds"),[u,b]=c.useState(null),[m,w]=c.useState("idle"),y=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),y.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||y.current)return;y.current=!0;let E=!0;return w("load"),hl(e).then(S=>{E&&(b(S),w("fait"))}),()=>{E=!1}},[p,e]);const f=c.useMemo(()=>ul((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),v=c.useRef(null);c.useEffect(()=>{const E=v.current;if(!E||!f)return;let S=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(S||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{S=!0}},[f]);const j=c.useMemo(()=>cr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=c.useMemo(()=>cr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const E=h.current;if(!E||!j)return;let S=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(S||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{S=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?mr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:ur(e,!0)}),"."]}):mr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:ur(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&j?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,p==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,p==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:fr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:fr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const xl=300,ua=7,bl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},wo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},vl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Di(r)&&r!=="media")return"news:"+r;const n=De(e);return n?"sig:"+(n.theme&&wo.fr[n.theme]?n.theme:"other"):"actualites"}function wl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:s}=Q(),l=bo(),h=d==="en",[p,x]=c.useState("all"),[u,b]=c.useState(!1),m=c.useMemo(()=>{var be;const g=(a.filters.day||"").slice(0,10),A=J=>!(!i&&a.continent!=="monde"&&J.continent!==a.continent||g&&(J.date||"").slice(0,10)!==g),U=e.filter(J=>A(J)&&De(J)&&(!i||J.kind!=="target"||Ee(J)!==5)),ee=i&&(((be=l==null?void 0:l.ed)==null?void 0:be.ops)||[]).length?l.ed.ops.map(J=>wa(J,d)).filter(J=>!!J).map(J=>(J.briefOnly=!0,J)).filter(J=>!g||(J.date||"").slice(0,10)===g):[],N=e.filter(J=>A(J)&&J.kind==="op"&&(g?!0:bt(J.date)<=ua)),I=i?ee.length?ee:N.filter(J=>{const he=(s||"").trim().toLowerCase();if(!he)return!1;const ue=J.match||null;return ue?Object.keys(ue).map(ge=>ge.trim().toLowerCase()).includes(he):!1}):N,D=g||new Date().toISOString().slice(0,10),B=J=>{const he=Ga(J);return he==="ma"?0:he==="levees"?1:2};I.sort((J,he)=>{const ue=B(J)-B(he);if(ue)return ue;const ge=(J.date||"").slice(0,10)===D?0:1,_=(he.date||"").slice(0,10)===D?0:1;return ge!==_?ge-_:(he.amountEur||0)-(J.amountEur||0)});const te=new Set,ae=[];for(const J of[...I,...zn(U,{key:"signal",dir:-1})]){const he=J.id||J.name;!he||te.has(he)||(te.add(he),ae.push(J))}return i&&ae.length===0?e.filter(he=>A(he)&&bt(he.date)<=ua).sort((he,ue)=>(ue.date||"").localeCompare(he.date||"")).slice(0,80):ae},[e,a.continent,a.filters.day,i,s,d,l]),w=c.useMemo(()=>{const g={};for(const A of m){const U=Ga(A);g[U]=(g[U]||0)+1}return g},[m]),y=c.useMemo(()=>p==="all"?m:m.filter(g=>Ga(g)===p),[m,p]),f=c.useMemo(()=>y.slice(0,xl),[y]),v=y.length-f.length,j=c.useRef(null);c.useEffect(()=>{var I,D;const g=j.current;if(!g)return;const A=()=>{const B=g.scrollWidth;B<200||(g.style.animationDuration=Math.max(18,Math.round(B/130))+"s")};A();const U=requestAnimationFrame(A),ee=window.setTimeout(A,1200);let N=!0;return(D=(I=document.fonts)==null?void 0:I.ready)==null||D.then(()=>{N&&A()}),()=>{N=!1,cancelAnimationFrame(U),window.clearTimeout(ee)}},[f.length,p]);const k=g=>g==="all"?m.length:w[g]||0,E=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return wo[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const A=g.slice(5);return Oi[A]?Mi(A,h?"en":"fr"):g}return bl[h?"en":"fr"][g]},S=[{k:"all"}],C=["ma","levees"].filter(g=>k(g)>0||g===p);if(C.length){S.push({g:h?"Deals":"Opérations"});for(const g of C)S.push({k:g})}const L=["nominations","recrutements"].filter(g=>k(g)>0||g===p),q=Ri.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>k(g)>0||g===p),M=k("actualites")>0||p==="actualites"?["actualites"]:[];if(L.length||q.length||M.length){S.push({g:h?"News":"Actualités"});for(const g of L)S.push({k:g});for(const g of q)S.push({k:g});for(const g of M)S.push({k:g})}const R=vl.map(g=>"sig:"+g).filter(g=>k(g)>0||g===p);if(R.length){S.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of R)S.push({k:g})}const $=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},F=(()=>{const g=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(h?`LIVE covers the events of ${$(g)}.`:`Le LIVE regroupe les événements du ${$(g)}.`)+A:(h?`LIVE covers the still-open signals and the deals of the last ${ua} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ua} derniers jours.`)+A})(),O=g=>f.map(A=>t.jsxs("button",{type:"button",className:"tk"+(_e(A)?" spent":""),onClick:U=>{const ee=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:ee?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(ee||n({type:"focus",id:A.id}),a.dens!=="liste"){const N=U.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:N.left+N.width/2,y:N.bottom}})}},title:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(Et,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(ni,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:rc(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(Pa,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(A.id||A.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(g=>!g),children:[E(p),t.jsx("b",{children:k(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:F}),S.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===p,onClick:()=>{x(g.k),b(!1)},children:[E(g.k),t.jsx("b",{children:k(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[O(0),O(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(kl,{isEn:h})]})}const yl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function kl({isEn:e}){const[a,r]=c.useState(()=>io());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Ea,o),()=>window.removeEventListener(Ea,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Ii(!a),children:yl})}const qn="+33 6 83 10 72 86",Aa="alexandre@proplace.co",yo=`tel:${qn.replace(/[^\d+]/g,"")}`;function jl(){return null}class st extends c.Component{constructor(){super(...arguments);_n(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ko=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function hr(e,a){if((Nt(e)||"").startsWith("CALL")&&Ee(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ee(e)>=2;return ko.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const gr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",El={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Nl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Q(),[s,l]=c.useState(""),[h,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const v=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),p(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),w=async v=>{if(s)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}l(v);const j=(hr(e,a).find(([E])=>E===v)||[v,v])[1],k=await o(e,v,{msg:a.csMoved(e.name,j)});l(""),k&&(p(!1),u(!1))},y=hr(e,a),f=v=>(y.find(([j])=>j===v)||[])[1]||v;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:y.map(([v,j])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(s===v?" busy":""),disabled:!!s,onClick:()=>{w(v)},children:j},v))}):t.jsxs("span",{className:"rstat"+(x||h?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!s,title:a.csLabel,className:"rsel rs-"+gr(m),onClick:()=>{u(v=>!v),p(!1)},children:s?f(s)+"…":m?f(m):a.csNone}),x&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([v,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===v,className:"rsopt"+(m===v?" on":"")+(s===v?" busy":""),disabled:!!s,onClick:()=>{if(v===m){u(!1);return}w(v)},children:[t.jsx("i",{className:"pt2",style:{background:El[gr(v)]}}),j]},v))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const v=await o(e,"Analysé");l(""),v&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function Sl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Q(),[i,d]=c.useState(""),[s,l]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),p=(Nt(e)||"").startsWith("CALL")&&Ee(e)===3,x=Ee(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const w=await o(e,m);d(""),w&&(l(!0),setTimeout(()=>l(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:ko.filter(([m])=>!(x&&m==="Retenu")).map(([m,w])=>[m,a[w]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,w])=>t.jsx("button",{type:"button",className:"csb"+(h===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:w},m)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Cl,{o:e})]})}function Cl({o:e}){const{t:a,saveNote:r,flash:n}=Q(),[o,i]=c.useState(e.ceoNote||""),[d,s]=c.useState(!1),[l,h]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:l?a.csNoteSaved:a.csNoteOk})]})}function xr({placeholder:e,onDone:a}){const{t:r}=Q(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function zl({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:s}=Q(),[l,h]=c.useState(!1);if(!n.pipe||!o||n.lockActions||Ee(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",u=async f=>{if(l||f===x)return;h(!0);const v=p;d(e,{stage:f,stamps:(p==null?void 0:p.stamps)||{}});const j=Math.max(Date.now(),br+=1);br=j;const k=await Pi(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});h(!1),!k.stale&&(k.ok||(d(e,v),s(a.actErr)))},b=(y=p==null?void 0:p.stamps)==null?void 0:y.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:l,onClick:()=>{u(f)},children:v},f)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let br=0;const Gt=8,jt=360;function vr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function wr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(vr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(vr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Al({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Q(),[d,s]=c.useState(0),[l,h]=c.useState(null),[p,x]=c.useState([]),u=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=c.useRef(!1);c.useEffect(()=>{const C=b.current;return()=>{m.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),c.useEffect(()=>{u.current||(u.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const w=p[d],y=d>=p.length;c.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const C=w.click,L=window.setTimeout(()=>{const q=document.querySelector(C);q&&q.getAttribute("aria-selected")!=="true"&&q.click()},60);return()=>window.clearTimeout(L)}},[d,w]);const f=c.useRef(-1),v=c.useCallback(()=>{if(!w){h(null);return}const C=M=>{if(!M)return null;for(const R of document.querySelectorAll(M)){const $=R.getBoundingClientRect();if($.width>1&&$.height>1)return R}return null},L=C(w.sel)||C(w.need);if(!L){h(null);return}f.current!==d&&(f.current=d,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=L.getBoundingClientRect();h(M=>M&&Math.abs(M.top-q.top)<1&&Math.abs(M.left-q.left)<1&&Math.abs(M.width-q.width)<1&&Math.abs(M.height-q.height)<1?M:q)},[w,d]);c.useLayoutEffect(()=>{v();const C=[90,300,700,1300].map(M=>window.setTimeout(v,M)),L=window.setInterval(v,400),q=()=>v();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{C.forEach(M=>window.clearTimeout(M)),window.clearInterval(L),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[v]);const j=c.useRef(a);if(j.current=a,c.useEffect(()=>{const C=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),j.current()):L.key==="ArrowRight"?s(q=>q+1):L.key==="ArrowLeft"&&s(q=>Math.max(0,q-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!p.length)return null;let k=null;const E=C=>()=>{m.current=!0,n({type:"modal",modal:null}),C()};if(y){const C=o[3]||0;C>0?k={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let S={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:jt};if(!y&&l){const C=l.bottom+14,L=window.innerHeight-C;let q=L>190?C:Math.max(12,l.top-200),M=Math.min(Math.max(12,l.left+l.width/2-jt/2),window.innerWidth-jt-12);L<=190&&l.top<212&&(window.innerWidth-l.right>=jt+40?M=Math.min(l.right+26,window.innerWidth-jt-12):l.left>=jt+40&&(M=Math.max(12,l.left-jt-26)),q=Math.max(12,l.top-Gt)),S={left:M,top:q,width:jt}}return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-Gt,top:l.top-Gt,width:l.width+Gt*2,height:l.height+Gt*2}}),(y||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:S,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(wr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(wr,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>s(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(C=>C+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function jo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Eo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ql(){var L,q;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:s,dispatch:l}=Q(),h=r?a:e,p=c.useMemo(()=>h.filter(M=>bt(M.date)===0&&M.kind==="target"),[h]),x=c.useMemo(()=>r?a.filter(M=>M.kind==="target"&&Ee(M)===0).slice().sort((M,R)=>(R.date||"").localeCompare(M.date||"")):[],[a,r]),u=c.useMemo(()=>p.filter(M=>r?Ee(M)===0:!_e(M)),[p,r]),b=r?x:u,m=r?a.length-x.length:p.length-u.length,w=r?a.length:p.length,y=w?Math.min(100,m/w*100):100,f=c.useMemo(()=>jo(h),[h]),v=!!f&&bt(f)>0,j=c.useMemo(()=>v?h.filter(M=>(M.date||"").slice(0,10)===f):[],[h,f,v]),k=typeof((L=s.stats)==null?void 0:L.kept_today)=="number"?s.stats.kept_today:null,E=typeof((q=s.stats)==null?void 0:q.screened_today)=="number"?s.stats.screened_today:p.length;let S;v?S=o.morningLast(j.length,x.length,Eo(f,d)):r?S=o.morningThesis(E,x.length,k):p.length?m===0?S=o.goalSourced(p.length):m>=p.length?S=o.goalCleared:S=o.goalDone(m,p.length):S=o.goalSourced(0);const C=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&x.length&&l({type:"chainStart",queue:x.map(M=>M.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:S}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Tl(){var U,ee;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,dossiers:s,mode:l,doSync:h,startTour:p,flash:x,flashErr:u}=Q(),[b,m]=c.useState(null),[w,y]=c.useState(!0),[f,v]=c.useState([]),j=l==="client";c.useEffect(()=>{if(!o||!i)return;let N=!0;return y(!0),(async()=>{const[I,D]=await Promise.all([Nn(i),so(o)]);N&&(I&&m(I),y(!1),v(D))})(),()=>{N=!1}},[o,i]);const[k,E]=c.useState(!1),S=()=>{!j||k||!i||(E(!0),_i(i).then(N=>{E(!1),N?x(e.identRepubDone):u(e.actErr)}))},C=(b==null?void 0:b.per_day)??null,L=((U=b==null?void 0:b.pool_order)==null?void 0:U.length)??0,q=f.filter(N=>N.status==="running").length,M=c.useMemo(()=>s.filter(N=>N.kind==="target"&&_e(N)).length,[s]),R=d.marketEstimate,$=typeof((ee=d.stats)==null?void 0:ee.screened)=="number"?d.stats.screened:M,F=R&&R>0?Math.min(100,Math.round($/R*100)):null,O=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),g=(i||"P").split(/\s+/).map(N=>N[0]).join("").slice(0,2).toUpperCase(),A=(()=>{const N=Date.parse(d.generatedAt||"");if(Number.isNaN(N))return"";const I=new Date(N),D=B=>String(B).padStart(2,"0");return`${D(I.getDate())}/${D(I.getMonth()+1)} à ${D(I.getHours())}:${D(I.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?g:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),A?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(A)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||k,onClick:S,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:h,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:p,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:N=>n({type:"filters",patch:{search:N.target.value}})})]})]}),t.jsxs("div",{className:"idmain",children:[F===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:O($)})})]}),F!==null&&R&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:F+"%"}})}),t.jsxs("b",{children:[F," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,R)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),q>0&&t.jsxs("span",{className:"ev",children:["⏳ ",q]})]}),t.jsxs("span",{className:"filec",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:a==="en"?"Queue":"File"}),t.jsx("span",{className:"ego",children:w?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:N=>{N.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]})]})]})}class Ft{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,s=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);s&&(r[n++]=s),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*Ll(e){for(const a of e)yield*a}function No(e){return Array.from(Ll(e))}var je=1e-6,ve=Math.PI,tt=ve/2,yr=ve/4,nt=ve*2,ht=180/ve,Qe=ve/180,ze=Math.abs,Fl=Math.atan,aa=Math.atan2,Le=Math.cos,Fe=Math.sin,Rl=Math.sign||function(e){return e>0?1:e<0?-1:0},Ot=Math.sqrt;function Ol(e){return e>1?0:e<-1?ve:Math.acos(e)}function na(e){return e>1?tt:e<-1?-tt:Math.asin(e)}function at(){}function qa(e,a){e&&jr.hasOwnProperty(e.type)&&jr[e.type](e,a)}var kr={Feature:function(e,a){qa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)qa(r[n].geometry,a)}},jr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ln(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ln(r[n],a,0)},Polygon:function(e,a){Er(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Er(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)qa(r[n],a)}};function ln(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Er(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ln(e[r],a,1);a.polygonEnd()}function Dt(e,a){e&&kr.hasOwnProperty(e.type)?kr[e.type](e,a):qa(e,a)}function dn(e){return[aa(e[1],e[0]),na(e[2])]}function _t(e){var a=e[0],r=e[1],n=Le(r);return[n*Le(a),n*Fe(a),Fe(r)]}function ma(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ta(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ya(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function fa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function pn(e){var a=Ot(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function cn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function un(e,a){return ze(e)>ve&&(e-=Math.round(e/nt)*nt),[e,a]}un.invert=un;function Ml(e,a,r){return(e%=nt)?a||r?cn(Sr(e),Cr(a,r)):Sr(e):a||r?Cr(a,r):un}function Nr(e){return function(a,r){return a+=e,ze(a)>ve&&(a-=Math.round(a/nt)*nt),[a,r]}}function Sr(e){var a=Nr(e);return a.invert=Nr(-e),a}function Cr(e,a){var r=Le(e),n=Fe(e),o=Le(a),i=Fe(a);function d(s,l){var h=Le(l),p=Le(s)*h,x=Fe(s)*h,u=Fe(l),b=u*r+p*n;return[aa(x*o-b*i,p*r-u*n),na(b*o+x*i)]}return d.invert=function(s,l){var h=Le(l),p=Le(s)*h,x=Fe(s)*h,u=Fe(l),b=u*o-x*i;return[aa(x*o+u*i,p*r+b*n),na(b*r-p*n)]},d}function Dl(e,a,r,n,o,i){if(r){var d=Le(a),s=Fe(a),l=n*r;o==null?(o=a+n*nt,i=a-l/2):(o=zr(d,o),i=zr(d,i),(n>0?o<i:o>i)&&(o+=n*nt));for(var h,p=o;n>0?p>i:p<i;p-=l)h=dn([d,-s*Le(p),-s*Fe(p)]),e.point(h[0],h[1])}}function zr(e,a){a=_t(a),a[0]-=e,pn(a);var r=Ol(-a[1]);return((-a[2]<0?-r:r)+nt-je)%nt}function So(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:at,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ka(e,a){return ze(e[0]-a[0])<je&&ze(e[1]-a[1])<je}function ha(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Co(e,a,r,n,o){var i=[],d=[],s,l;if(e.forEach(function(m){if(!((w=m.length-1)<=0)){var w,y=m[0],f=m[w],v;if(ka(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),s=0;s<w;++s)o.point((y=m[s])[0],y[1]);o.lineEnd();return}f[0]+=2*je}i.push(v=new ha(y,m,null,!0)),d.push(v.o=new ha(y,null,v,!1)),i.push(v=new ha(f,m,null,!1)),d.push(v.o=new ha(f,null,v,!0))}}),!!i.length){for(d.sort(a),Ar(i),Ar(d),s=0,l=d.length;s<l;++s)d[s].e=r=!r;for(var h=i[0],p,x;;){for(var u=h,b=!0;u.v;)if((u=u.n)===h)return;p=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,l=p.length;s<l;++s)o.point((x=p[s])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(p=u.p.z,s=p.length-1;s>=0;--s)o.point((x=p[s])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,p=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Ar(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Qa(e){return ze(e[0])<=ve?e[0]:Rl(e[0])*((ze(e[0])+ve)%nt-ve)}function Il(e,a){var r=Qa(a),n=a[1],o=Fe(n),i=[Fe(r),-Le(r),0],d=0,s=0,l=new Ft;o===1?n=tt+je:o===-1&&(n=-tt-je);for(var h=0,p=e.length;h<p;++h)if(u=(x=e[h]).length)for(var x,u,b=x[u-1],m=Qa(b),w=b[1]/2+yr,y=Fe(w),f=Le(w),v=0;v<u;++v,m=k,y=S,f=C,b=j){var j=x[v],k=Qa(j),E=j[1]/2+yr,S=Fe(E),C=Le(E),L=k-m,q=L>=0?1:-1,M=q*L,R=M>ve,$=y*S;if(l.add(aa($*q*Fe(M),f*C+$*Le(M))),d+=R?L+q*nt:L,R^m>=r^k>=r){var F=Ta(_t(b),_t(j));pn(F);var O=Ta(i,F);pn(O);var g=(R^L>=0?-1:1)*na(O[2]);(n>g||n===g&&(F[0]||F[1]))&&(s+=R^L>=0?1:-1)}}return(d<-je||d<je&&l<-1e-12)^s&1}function zo(e,a,r,n){return function(o){var i=a(o),d=So(),s=a(d),l=!1,h,p,x,u={point:b,lineStart:w,lineEnd:y,polygonStart:function(){u.point=f,u.lineStart=v,u.lineEnd=j,p=[],h=[]},polygonEnd:function(){u.point=b,u.lineStart=w,u.lineEnd=y,p=No(p);var k=Il(h,n);p.length?(l||(o.polygonStart(),l=!0),Co(p,_l,k,r,o)):k&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),p=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,E){e(k,E)&&o.point(k,E)}function m(k,E){i.point(k,E)}function w(){u.point=m,i.lineStart()}function y(){u.point=b,i.lineEnd()}function f(k,E){x.push([k,E]),s.point(k,E)}function v(){s.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),s.lineEnd();var k=s.clean(),E=d.result(),S,C=E.length,L,q,M;if(x.pop(),h.push(x),x=null,!!C){if(k&1){if(q=E[0],(L=q.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),S=0;S<L;++S)o.point((M=q[S])[0],M[1]);o.lineEnd()}return}C>1&&k&2&&E.push(E.pop().concat(E.shift())),p.push(E.filter(Pl))}}return u}}function Pl(e){return e.length>1}function _l(e,a){return((e=e.x)[0]<0?e[1]-tt-je:tt-e[1])-((a=a.x)[0]<0?a[1]-tt-je:tt-a[1])}const qr=zo(function(){return!0},Bl,Ul,[-ve,-tt]);function Bl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var s=i>0?ve:-ve,l=ze(i-a);ze(l-ve)<je?(e.point(a,r=(r+d)/2>0?tt:-tt),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=ve&&(ze(a-n)<je&&(a-=n*je),ze(i-s)<je&&(i-=s*je),r=$l(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=d),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function $l(e,a,r,n){var o,i,d=Fe(e-r);return ze(d)>je?Fl((Fe(a)*(i=Le(n))*Fe(r)-Fe(n)*(o=Le(a))*Fe(e))/(o*i*d)):(a+n)/2}function Ul(e,a,r,n){var o;if(e==null)o=r*tt,n.point(-ve,o),n.point(0,o),n.point(ve,o),n.point(ve,0),n.point(ve,-o),n.point(0,-o),n.point(-ve,-o),n.point(-ve,0),n.point(-ve,o);else if(ze(e[0]-a[0])>je){var i=e[0]<a[0]?ve:-ve;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Hl(e){var a=Le(e),r=2*Qe,n=a>0,o=ze(a)>je;function i(p,x,u,b){Dl(b,e,r,u,p,x)}function d(p,x){return Le(p)*Le(x)>a}function s(p){var x,u,b,m,w;return{lineStart:function(){m=b=!1,w=1},point:function(y,f){var v=[y,f],j,k=d(y,f),E=n?k?0:h(y,f):k?h(y+(y<0?ve:-ve),f):0;if(!x&&(m=b=k)&&p.lineStart(),k!==b&&(j=l(x,v),(!j||ka(x,j)||ka(v,j))&&(v[2]=1)),k!==b)w=0,k?(p.lineStart(),j=l(v,x),p.point(j[0],j[1])):(j=l(x,v),p.point(j[0],j[1],2),p.lineEnd()),x=j;else if(o&&x&&n^k){var S;!(E&u)&&(S=l(v,x,!0))&&(w=0,n?(p.lineStart(),p.point(S[0][0],S[0][1]),p.point(S[1][0],S[1][1]),p.lineEnd()):(p.point(S[1][0],S[1][1]),p.lineEnd(),p.lineStart(),p.point(S[0][0],S[0][1],3)))}k&&(!x||!ka(x,v))&&p.point(v[0],v[1]),x=v,b=k,u=E},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return w|(m&&b)<<1}}}function l(p,x,u){var b=_t(p),m=_t(x),w=[1,0,0],y=Ta(b,m),f=ma(y,y),v=y[0],j=f-v*v;if(!j)return!u&&p;var k=a*f/j,E=-a*v/j,S=Ta(w,y),C=fa(w,k),L=fa(y,E);Ya(C,L);var q=S,M=ma(C,q),R=ma(q,q),$=M*M-R*(ma(C,C)-1);if(!($<0)){var F=Ot($),O=fa(q,(-M-F)/R);if(Ya(O,C),O=dn(O),!u)return O;var g=p[0],A=x[0],U=p[1],ee=x[1],N;A<g&&(N=g,g=A,A=N);var I=A-g,D=ze(I-ve)<je,B=D||I<je;if(!D&&ee<U&&(N=U,U=ee,ee=N),B?D?U+ee>0^O[1]<(ze(O[0]-g)<je?U:ee):U<=O[1]&&O[1]<=ee:I>ve^(g<=O[0]&&O[0]<=A)){var te=fa(q,(-M+F)/R);return Ya(te,C),[O,dn(te)]}}}function h(p,x){var u=n?e:ve-e,b=0;return p<-u?b|=1:p>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return zo(d,s,i,n?[0,-e]:[-ve,e-ve])}function Vl(e,a,r,n,o,i){var d=e[0],s=e[1],l=a[0],h=a[1],p=0,x=1,u=l-d,b=h-s,m;if(m=r-d,!(!u&&m>0)){if(m/=u,u<0){if(m<p)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>p&&(p=m)}if(m=o-d,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>p&&(p=m)}else if(u>0){if(m<p)return;m<x&&(x=m)}if(m=n-s,!(!b&&m>0)){if(m/=b,b<0){if(m<p)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>p&&(p=m)}if(m=i-s,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>p&&(p=m)}else if(b>0){if(m<p)return;m<x&&(x=m)}return p>0&&(e[0]=d+p*u,e[1]=s+p*b),x<1&&(a[0]=d+x*u,a[1]=s+x*b),!0}}}}}var Yt=1e9,ga=-Yt;function Wl(e,a,r,n){function o(h,p){return e<=h&&h<=r&&a<=p&&p<=n}function i(h,p,x,u){var b=0,m=0;if(h==null||(b=d(h,x))!==(m=d(p,x))||l(h,p)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(p[0],p[1])}function d(h,p){return ze(h[0]-e)<je?p>0?0:3:ze(h[0]-r)<je?p>0?2:1:ze(h[1]-a)<je?p>0?1:0:p>0?3:2}function s(h,p){return l(h.x,p.x)}function l(h,p){var x=d(h,1),u=d(p,1);return x!==u?x-u:x===0?p[1]-h[1]:x===1?h[0]-p[0]:x===2?h[1]-p[1]:p[0]-h[0]}return function(h){var p=h,x=So(),u,b,m,w,y,f,v,j,k,E,S,C={point:L,lineStart:$,lineEnd:F,polygonStart:M,polygonEnd:R};function L(g,A){o(g,A)&&p.point(g,A)}function q(){for(var g=0,A=0,U=b.length;A<U;++A)for(var ee=b[A],N=1,I=ee.length,D=ee[0],B,te,ae=D[0],be=D[1];N<I;++N)B=ae,te=be,D=ee[N],ae=D[0],be=D[1],te<=n?be>n&&(ae-B)*(n-te)>(be-te)*(e-B)&&++g:be<=n&&(ae-B)*(n-te)<(be-te)*(e-B)&&--g;return g}function M(){p=x,u=[],b=[],S=!0}function R(){var g=q(),A=S&&g,U=(u=No(u)).length;(A||U)&&(h.polygonStart(),A&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),U&&Co(u,s,g,i,h),h.polygonEnd()),p=h,u=b=m=null}function $(){C.point=O,b&&b.push(m=[]),E=!0,k=!1,v=j=NaN}function F(){u&&(O(w,y),f&&k&&x.rejoin(),u.push(x.result())),C.point=L,k&&p.lineEnd()}function O(g,A){var U=o(g,A);if(b&&m.push([g,A]),E)w=g,y=A,f=U,E=!1,U&&(p.lineStart(),p.point(g,A));else if(U&&k)p.point(g,A);else{var ee=[v=Math.max(ga,Math.min(Yt,v)),j=Math.max(ga,Math.min(Yt,j))],N=[g=Math.max(ga,Math.min(Yt,g)),A=Math.max(ga,Math.min(Yt,A))];Vl(ee,N,e,a,r,n)?(k||(p.lineStart(),p.point(ee[0],ee[1])),p.point(N[0],N[1]),U||p.lineEnd(),S=!1):U&&(p.lineStart(),p.point(g,A),S=!1)}v=g,j=A,k=U}return C}}const mn=e=>e;var Ka=new Ft,fn=new Ft,Ao,qo,hn,gn,gt={point:at,lineStart:at,lineEnd:at,polygonStart:function(){gt.lineStart=Gl,gt.lineEnd=Ql},polygonEnd:function(){gt.lineStart=gt.lineEnd=gt.point=at,Ka.add(ze(fn)),fn=new Ft},result:function(){var e=Ka/2;return Ka=new Ft,e}};function Gl(){gt.point=Yl}function Yl(e,a){gt.point=To,Ao=hn=e,qo=gn=a}function To(e,a){fn.add(gn*e-hn*a),hn=e,gn=a}function Ql(){To(Ao,qo)}var Bt=1/0,La=Bt,ra=-Bt,Fa=ra,Ra={point:Kl,lineStart:at,lineEnd:at,polygonStart:at,polygonEnd:at,result:function(){var e=[[Bt,La],[ra,Fa]];return ra=Fa=-(La=Bt=1/0),e}};function Kl(e,a){e<Bt&&(Bt=e),e>ra&&(ra=e),a<La&&(La=a),a>Fa&&(Fa=a)}var xn=0,bn=0,Qt=0,Oa=0,Ma=0,It=0,vn=0,wn=0,Kt=0,Lo,Fo,mt,ft,et={point:Rt,lineStart:Tr,lineEnd:Lr,polygonStart:function(){et.lineStart=Zl,et.lineEnd=ed},polygonEnd:function(){et.point=Rt,et.lineStart=Tr,et.lineEnd=Lr},result:function(){var e=Kt?[vn/Kt,wn/Kt]:It?[Oa/It,Ma/It]:Qt?[xn/Qt,bn/Qt]:[NaN,NaN];return xn=bn=Qt=Oa=Ma=It=vn=wn=Kt=0,e}};function Rt(e,a){xn+=e,bn+=a,++Qt}function Tr(){et.point=Jl}function Jl(e,a){et.point=Xl,Rt(mt=e,ft=a)}function Xl(e,a){var r=e-mt,n=a-ft,o=Ot(r*r+n*n);Oa+=o*(mt+e)/2,Ma+=o*(ft+a)/2,It+=o,Rt(mt=e,ft=a)}function Lr(){et.point=Rt}function Zl(){et.point=td}function ed(){Ro(Lo,Fo)}function td(e,a){et.point=Ro,Rt(Lo=mt=e,Fo=ft=a)}function Ro(e,a){var r=e-mt,n=a-ft,o=Ot(r*r+n*n);Oa+=o*(mt+e)/2,Ma+=o*(ft+a)/2,It+=o,o=ft*e-mt*a,vn+=o*(mt+e),wn+=o*(ft+a),Kt+=o*3,Rt(mt=e,ft=a)}function Oo(e){this._context=e}Oo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,nt);break}}},result:at};var yn=new Ft,Ja,Mo,Do,Jt,Xt,oa={point:at,lineStart:function(){oa.point=ad},lineEnd:function(){Ja&&Io(Mo,Do),oa.point=at},polygonStart:function(){Ja=!0},polygonEnd:function(){Ja=null},result:function(){var e=+yn;return yn=new Ft,e}};function ad(e,a){oa.point=Io,Mo=Jt=e,Do=Xt=a}function Io(e,a){Jt-=e,Xt-=a,yn.add(Ot(Jt*Jt+Xt*Xt)),Jt=e,Xt=a}let Fr,Da,Rr,Or;class Mr{constructor(a){this._append=a==null?Po:nd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Rr||this._append!==Da){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Rr=n,Da=this._append,Or=this._,this._=o}this._+=Or;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Po(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function nd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Po;if(a!==Fr){const r=10**a;Fr=a,Da=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Da}function rd(e,a){let r=3,n=4.5,o,i;function d(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Dt(s,o(i))),i.result()}return d.area=function(s){return Dt(s,o(gt)),gt.result()},d.measure=function(s){return Dt(s,o(oa)),oa.result()},d.bounds=function(s){return Dt(s,o(Ra)),Ra.result()},d.centroid=function(s){return Dt(s,o(et)),et.result()},d.projection=function(s){return arguments.length?(o=s==null?(e=null,mn):(e=s).stream,d):e},d.context=function(s){return arguments.length?(i=s==null?(a=null,new Mr(r)):new Oo(a=s),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),d):n},d.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new Mr(r)),d},d.projection(e).digits(r).context(a)}function Tn(e){return function(a){var r=new kn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function kn(){}kn.prototype={constructor:kn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ln(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Dt(r,e.stream(Ra)),a(Ra.result()),n!=null&&e.clipExtent(n),e}function _o(e,a,r){return Ln(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([s,l])},r)}function od(e,a,r){return _o(e,[[0,0],a],r)}function id(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([d,s])},r)}function sd(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,s])},r)}var Dr=16,ld=Le(30*Qe);function Ir(e,a){return+a?pd(e,a):dd(e)}function dd(e){return Tn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function pd(e,a){function r(n,o,i,d,s,l,h,p,x,u,b,m,w,y){var f=h-n,v=p-o,j=f*f+v*v;if(j>4*a&&w--){var k=d+u,E=s+b,S=l+m,C=Ot(k*k+E*E+S*S),L=na(S/=C),q=ze(ze(S)-1)<je||ze(i-x)<je?(i+x)/2:aa(E,k),M=e(q,L),R=M[0],$=M[1],F=R-n,O=$-o,g=v*F-f*O;(g*g/j>a||ze((f*F+v*O)/j-.5)>.3||d*u+s*b+l*m<ld)&&(r(n,o,i,d,s,l,R,$,q,k/=C,E/=C,S,w,y),y.point(R,$),r(R,$,q,k,E,S,h,p,x,u,b,m,w,y))}}return function(n){var o,i,d,s,l,h,p,x,u,b,m,w,y={point:f,lineStart:v,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=E},polygonEnd:function(){n.polygonEnd(),y.lineStart=v}};function f(L,q){L=e(L,q),n.point(L[0],L[1])}function v(){x=NaN,y.point=j,n.lineStart()}function j(L,q){var M=_t([L,q]),R=e(L,q);r(x,u,p,b,m,w,x=R[0],u=R[1],p=L,b=M[0],m=M[1],w=M[2],Dr,n),n.point(x,u)}function k(){y.point=f,n.lineEnd()}function E(){v(),y.point=S,y.lineEnd=C}function S(L,q){j(o=L,q),i=x,d=u,s=b,l=m,h=w,y.point=j}function C(){r(x,u,p,b,m,w,i,d,o,s,l,h,Dr,n),y.lineEnd=k,k()}return y}}var cd=Tn({point:function(e,a){this.stream.point(e*Qe,a*Qe)}});function ud(e){return Tn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function md(e,a,r,n,o){function i(d,s){return d*=n,s*=o,[a+e*d,r-e*s]}return i.invert=function(d,s){return[(d-a)/e*n,(r-s)/e*o]},i}function Pr(e,a,r,n,o,i){if(!i)return md(e,a,r,n,o);var d=Le(i),s=Fe(i),l=d*e,h=s*e,p=d/e,x=s/e,u=(s*r-d*a)/e,b=(s*a+d*r)/e;function m(w,y){return w*=n,y*=o,[l*w-h*y+a,r-h*w-l*y]}return m.invert=function(w,y){return[n*(p*w-x*y+u),o*(b-x*w-p*y)]},m}function fd(e){return hd(function(){return e})()}function hd(e){var a,r=150,n=480,o=250,i=0,d=0,s=0,l=0,h=0,p,x=0,u=1,b=1,m=null,w=qr,y=null,f,v,j,k=mn,E=.5,S,C,L,q,M;function R(g){return L(g[0]*Qe,g[1]*Qe)}function $(g){return g=L.invert(g[0],g[1]),g&&[g[0]*ht,g[1]*ht]}R.stream=function(g){return q&&M===g?q:q=cd(ud(p)(w(S(k(M=g)))))},R.preclip=function(g){return arguments.length?(w=g,m=void 0,O()):w},R.postclip=function(g){return arguments.length?(k=g,y=f=v=j=null,O()):k},R.clipAngle=function(g){return arguments.length?(w=+g?Hl(m=g*Qe):(m=null,qr),O()):m*ht},R.clipExtent=function(g){return arguments.length?(k=g==null?(y=f=v=j=null,mn):Wl(y=+g[0][0],f=+g[0][1],v=+g[1][0],j=+g[1][1]),O()):y==null?null:[[y,f],[v,j]]},R.scale=function(g){return arguments.length?(r=+g,F()):r},R.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],F()):[n,o]},R.center=function(g){return arguments.length?(i=g[0]%360*Qe,d=g[1]%360*Qe,F()):[i*ht,d*ht]},R.rotate=function(g){return arguments.length?(s=g[0]%360*Qe,l=g[1]%360*Qe,h=g.length>2?g[2]%360*Qe:0,F()):[s*ht,l*ht,h*ht]},R.angle=function(g){return arguments.length?(x=g%360*Qe,F()):x*ht},R.reflectX=function(g){return arguments.length?(u=g?-1:1,F()):u<0},R.reflectY=function(g){return arguments.length?(b=g?-1:1,F()):b<0},R.precision=function(g){return arguments.length?(S=Ir(C,E=g*g),O()):Ot(E)},R.fitExtent=function(g,A){return _o(R,g,A)},R.fitSize=function(g,A){return od(R,g,A)},R.fitWidth=function(g,A){return id(R,g,A)},R.fitHeight=function(g,A){return sd(R,g,A)};function F(){var g=Pr(r,0,0,u,b,x).apply(null,a(i,d)),A=Pr(r,n-g[0],o-g[1],u,b,x);return p=Ml(s,l,h),C=cn(a,A),L=cn(p,C),S=Ir(C,E),O()}function O(){return q=M=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&$,F()}}function Bo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Bo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(ze(o)>je&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function gd(){return fd(Bo).scale(175.295)}function xd(e){return e}function bd(e){if(e==null)return xd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(s,l){l||(a=r=0);var h=2,p=s.length,x=new Array(p);for(x[0]=(a+=s[0])*n+i,x[1]=(r+=s[1])*o+d;h<p;)x[h]=s[h],++h;return x}}function vd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function wd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return _r(e,r)})}:_r(e,a)}function _r(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=yd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function yd(e,a){var r=bd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var u=n[p<0?~p:p],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));p<0&&vd(x,m)}function i(p){return r(p)}function d(p){for(var x=[],u=0,b=p.length;u<b;++u)o(p[u],x);return x.length<2&&x.push(x[0]),x}function s(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function l(p){return p.map(s)}function h(p){var x=p.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(h)};case"Point":u=i(p.coordinates);break;case"MultiPoint":u=p.coordinates.map(i);break;case"LineString":u=d(p.arcs);break;case"MultiLineString":u=p.arcs.map(d);break;case"Polygon":u=l(p.arcs);break;case"MultiPolygon":u=p.arcs.map(l);break;default:return null}return{type:x,coordinates:u}}return h(a)}const $o={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},kd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function jd(e,a,r){const n=$o[e];if(!n||!n.length)return-1;const o=kd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let xa=null;function Ed(){return xa||(xa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=wd(r,n),i=gd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=rd(i),s=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",u=d(p)||"";return u?{i2:Bi(x)||null,n:x,d:u}:null}).filter(p=>!!p);if(!s.length)return null;const l={};for(const[p,x]of Object.entries($i)){const u=i(x);u&&(l[p]={x:u[0],y:u[1]})}const h={};for(const[p,x]of Object.entries($o)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(h[p]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:h}}catch{return null}})(),xa)}function Nd(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return Ed().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Sd="8 40 984 210",Cd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Br=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function $r(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function zd(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var h;if(!o)return;const l=(h=e.current)==null?void 0:h.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return e.current&&s.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function Ur({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Ad(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:s,t:l,data:h,dossiers:p,source:x}=Q(),u=h.loading&&!p.length,b=c.useRef(null),m=c.useRef(null),w=Nd(e.continent==="monde"),y=e.continent==="monde"?w:Sn.find(g=>g.key===e.continent)||null,f=zd(b,e.continent+":"+e.mapFolded+":"+!!y),[v,j]=c.useState(new Map),[k,E]=c.useState(null);c.useEffect(()=>{const g=b.current;if(!g)return;const A=new Map;g.querySelectorAll("path[data-i2]").forEach(U=>{const ee=U.dataset.i2;if(ee)try{const N=U.getBBox();N.width>0&&A.set(ee,{x:N.x,y:N.y,w:N.width,h:N.height})}catch{}}),j(A)},[e.continent,f,y]);const S=c.useMemo(()=>r.filter(g=>g.cc),[r]),C=c.useMemo(()=>{const g=new Map;return S.forEach(A=>g.set(A.cc,(g.get(A.cc)||0)+1)),g},[S]),L=e.continent==="monde"&&w?w.anchors:null,q=e.continent==="monde"&&w?w.metros:null,M=c.useMemo(()=>S.map(g=>{const A=$r(g.name||g.id||""),U=$r((g.id||g.name||"")+"·y");if(L&&g.cc){const B=q?q[g.cc]:void 0;if(B&&B.length){const ae=jd(g.cc,g.city,A);if(ae>=0&&B[ae])return{d:g,x:B[ae].x+(A-.5)*5,y:B[ae].y+(U-.5)*5}}const te=L[g.cc];if(te)return{d:g,x:te.x+(A-.5)*10,y:te.y+(U-.5)*10}}const ee=g.cc?v.get(g.cc):void 0;if(!ee)return null;const N=Cd[`${e.continent}:${g.cc||""}`];if(N)return{d:g,x:ee.x+ee.w*(N.fx+(A-.5)*N.sx),y:ee.y+ee.h*(N.fy+(U-.5)*N.sy)};const I=(A-.5)*Math.min(ee.w*.55,60),D=(U-.5)*Math.min(ee.h*.55,60);return{d:g,x:ee.x+ee.w/2+I,y:ee.y+ee.h/2+D}}).filter(g=>!!g),[S,v,L,q,e.continent]),R=g=>f>0?g/f:g,$=c.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:Br[g],fr:l.plabels[g],en:l.plabels[g],n:r.filter(A=>A.kind==="target"&&Ee(A)===g).length})).filter(g=>g.n>0):Gn.map((g,A)=>({...g,n:r.filter(U=>Yn(U)===A).length})),[r,n,l.plabels]),F=i?d.get(i):null,O=F?M.find(g=>g.d.id===F.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Ur,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Sd:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?y.fr:y.en,onMouseLeave:()=>{E(null),o(null)},children:[t.jsx("g",{children:y.countries.map((g,A)=>t.jsx("g",{className:"ct"+(g.i2&&C.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},A))}),t.jsx("g",{children:M.map(g=>{const A=Gn[Yn(g.d)],U=!!De(g.d),ee=g.d.kind==="target",N=n&&ee?Br[Ee(g.d)]:A.c,I=!n&&_e(g.d);return t.jsxs("g",{className:"co"+(I?" done":""),onMouseEnter:()=>{var te,ae;const D=(te=m.current)==null?void 0:te.getBoundingClientRect(),B=(ae=b.current)==null?void 0:ae.createSVGPoint();if(B&&b.current&&D){B.x=g.x,B.y=g.y;const be=B.matrixTransform(b.current.getScreenCTM());E({x:be.x-D.left,y:be.y-D.top,label:g.d.name+" · "+(Ht(g.d.cc,s)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{E(null),o(null)},onClick:()=>{var te;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const D=(te=b.current)==null?void 0:te.createSVGPoint();let B=null;if(D&&b.current){D.x=g.x,D.y=g.y;const ae=D.matrixTransform(b.current.getScreenCTM());B={x:ae.x,y:ae.y}}a({type:"popup",id:g.d.id,anchor:B})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:R(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:R(A.px),fill:N,stroke:U?"#E5484D":"#ffffff",strokeWidth:R(U?2.2:1.3)})]},g.d.id||g.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:R(13),fill:"none",stroke:"#16233A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:$.map((g,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),s==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},A))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Ur,{msgs:l.loadMsgs})})}function qd(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Uo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:s}=Q(),l=a.filters,[h,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null),m=c.useRef(null),w=c.useMemo(()=>a.continent==="monde"?n:n.filter(O=>O.continent===a.continent),[n,a.continent]),y=O=>w.filter(g=>O!=="country"&&l.country.length&&!l.country.includes(g.cc||"")?!1:za(g,l,i,O==="country"?void 0:O)),f=O=>!i||O.kind!=="op",v=c.useMemo(()=>{const O=y("win").filter(f),g=A=>O.filter(U=>(U.date?Math.max(0,Math.floor((Date.now()-Date.parse(U.date))/864e5)):9999)<=A).length;return[g(0),g(7),g(30),O.length]},[w,l,i]),j=c.useMemo(()=>l.day?y("win").filter(f).filter(O=>(O.date||"").slice(0,10)===l.day).length:0,[w,l,i]),k=(l.signalOnly?1:0)+l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,E=k+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!h&&!x)return;const O=A=>{var ee,N;const U=A.target;h&&!((ee=b.current)!=null&&ee.contains(U))&&p(!1),x&&!((N=m.current)!=null&&N.contains(U))&&u(!1)},g=A=>{A.key==="Escape"&&(p(!1),u(!1))};return document.addEventListener("mousedown",O),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",O),document.removeEventListener("keydown",g)}},[h,x]);const S=(O,g,A,U="fbtn")=>t.jsxs("button",{type:"button",className:U,"aria-expanded":a.openFacet===O,onClick:()=>r({type:"openFacet",facet:O}),children:[t.jsx("span",{className:"fl",children:g}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},O),C=["1","7","30","all"],L=Math.max(0,C.indexOf(l.win||"all")),q=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(qd(l.day,s))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(O=>!O),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:v[L]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((O,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===O,onClick:()=>{r({type:"filters",patch:{win:O}}),u(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:v[g]})]},O))})]}):t.jsx("div",{className:"seg",children:C.map((O,g)=>t.jsxs("button",{type:"button","aria-pressed":l.win===O,onClick:()=>r({type:"filters",patch:{win:O}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:v[g]})]},O))}),M=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:O=>r({type:"filters",patch:{search:O.target.value}})})]}),R=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):S("sec",o.fSector,l.sector.length),S("pay",o.fCountry,l.country.length),S("det",o.fEngine,l.engine.length),S("sta",o.fStage,l.stage.length),i&&S("crib",o.fVerdict,l.crible.length),i&&S("ang","Angle",l.angle.length),i&&S("mem","Mémo",l.memoLevel.length)]}),$=(O=!1)=>t.jsxs("div",{className:"frow2",children:[E>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(E)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),O&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),F=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{p(O=>!O),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:R})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:q}),t.jsxs("div",{className:"fstrip-b",children:[M,F,$(!1)]})]}),a.openFacet&&t.jsx(Hr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[q,M,R,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx(Hr,{poolFor:y})]})}function Hr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Q(),s=a.filters,l=a.openFacet,{title:h,cols:p,options:x}=c.useMemo(()=>{if(l==="sig"){const y=e("signal").filter(j=>De(j)),f=new Map;y.forEach(j=>{const k=j.engine||"";f.set(k,(f.get(k)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:y.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...rn([...f.keys()],o).map(j=>({v:j,label:Lt(j)+" "+Ke(j,o),n:f.get(j)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="crib"){const y=e("crible").filter(v=>!i||ro(v,a.ptab,d.favIds)),f=new Map;return y.forEach(v=>{const j=oo(v);j&&j!=="NEW"&&f.set(j,(f.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((v,j)=>(Qn[v[0]]??9)-(Qn[j[0]]??9)||j[1]-v[1]).map(([v,j])=>({v,label:'<span class="fdot" style="background:'+(Ui[v]||"#94A3B8")+'"></span>'+v,n:j,html:!0,on:s.crible.includes(v)}))}}if(l==="sec"){const y=e("sector"),f=new Map;return y.forEach(v=>{v.sector&&f.set(v.sector,(f.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:s.sector.includes(v)}))}}if(l==="pay"){const y=e("country"),f=new Map;return y.forEach(v=>{v.cc&&f.set(v.cc,(f.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:Ht(v,o)||v,n:j,html:!1,on:s.country.includes(v)}))}}if(l==="det"){const y=e("engine"),f=new Map;return y.forEach(v=>{v.engine&&f.set(v.engine,(f.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:rn([...f.keys()],o).map(v=>({v,label:Lt(v)+" "+Ke(v,o)+' <span style="color:var(--dim);font-size:10px">· '+Hi(Vi(v),o)+"</span>",n:f.get(v)||0,html:!0,on:s.engine.includes(v)}))}}if(l==="ang"){const y=e("angle"),f=new Map;return y.forEach(v=>{v.angle&&f.set(v.angle,(f.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v.replace(/[_-]+/g," "),n:j,html:!1,on:s.angle.includes(v)}))}}if(l==="mem"){const y=e("memoLevel"),f=new Map;y.forEach(j=>{if(j.kind==="target"){const k=En(j);f.set(k,(f.get(k)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:v[j],n:f.get(j)||0,html:!1,on:s.memoLevel.includes(j)}))}}const m=e("stage"),w=new Map;return m.forEach(y=>{y.stage&&w.set(y.stage,(w.get(y.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:s.stage.includes(y)}))}},[l,a,o]),u=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const y=s.signalEngines.includes(m)?s.signalEngines.filter(f=>f!==m):[...s.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:y}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:m})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:h}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Ho({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:s}=Q(),l=c.useMemo(()=>{const b={};return r.forEach(m=>{za(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[h,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!h)return;const b=w=>{var y;(y=x.current)!=null&&y.contains(w.target)||p(!1)},m=w=>{w.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[h]);const u=b=>{const m=Sn.find(w=>w.key===b);return b==="monde"?s.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Kn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[Kn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function jn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function Vo(e){return"atl2:evalq:"+(e||"anon")}function Td(e,a){const r=Vo(e),n=jn(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Wo(){const{t:e,data:a,dossiers:r}=Q(),n=a.session.token||"",o=Vo(n),[i,d]=c.useState(()=>jn(o)),s=c.useRef(!1),[l,h]=c.useState(!1);c.useEffect(()=>{try{const N=i.slice(0,30).map(({descBusy:I,evalBusy:D,...B})=>B);localStorage.setItem(o,JSON.stringify(N)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[i,o]),c.useEffect(()=>{const N=()=>{if(s.current)return;const I=jn(o);d(D=>JSON.stringify(D.map(({descBusy:B,evalBusy:te,...ae})=>ae))===JSON.stringify(I)?D:I)};return window.addEventListener("atl2:evalq",N),window.addEventListener("storage",N),()=>{window.removeEventListener("atl2:evalq",N),window.removeEventListener("storage",N)}},[o]);const[p,x]=c.useState([]),[u,b]=c.useState(""),[m,w]=c.useState(!1),[y,f]=c.useState(!1),[v,j]=c.useState(""),k=c.useCallback((N,I)=>d(D=>D.map((B,te)=>te===N?{...B,...I}:B)),[]),E=c.useCallback((N,I)=>{const D=I.trim();D&&(k(N,{name:D,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Cn(D).then(B=>{const te=B.candidates||[];B.website?k(N,{site:B.website,status:"ready"}):te.length===1?k(N,{site:te[0].url,status:"ready"}):te.length>1?k(N,{status:"pick",candidates:te.slice(0,4)}):k(N,{status:"ready"})}).catch(()=>k(N,{status:"ready"})))},[k]),S=c.useCallback((N,I,D)=>{k(N,{descBusy:!0}),lo(n,I,D).then(B=>{if(B.quota){h(!0),k(N,{descBusy:!1,descDone:!0});return}const te=B.blocs||{},ae=(te.synthese||te.value_prop||te.produit||te.modele||"").trim();k(N,{descBusy:!1,descDone:!0,desc:ae})}).catch(()=>k(N,{descBusy:!1,descDone:!0}))},[k,n]);c.useEffect(()=>{const N=i.findIndex(D=>D.auto&&D.name.trim()&&D.status==="");if(N>=0){E(N,i[N].name);return}if(l)return;const I=i.findIndex(D=>D.status==="ready"&&D.site&&!D.descDone&&!D.descBusy);I>=0&&S(I,i[I].name,i[I].site)},[i,E,S,l]);const[C,L]=c.useState(!1),q=c.useCallback(async(N,I)=>{k(N,{evalBusy:!0});const D=await po(n,(I.site||I.name).trim(),"atelier2");return D.verdict==="quota"?(k(N,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:D.reason||"",remaining:0}})),!1):(k(N,{evalBusy:!1,status:D.verdict==="kept"?"kept":"out",reason:D.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:D.company||I.name,verdict:D.verdict,reason:D.reason||"",remaining:D.remaining??null}})),!0)},[k,n]),M=async()=>{if(C)return;const N=i.map((I,D)=>({r:I,i:D})).filter(({r:I})=>I.name.trim()&&I.status!=="kept"&&I.status!=="out"&&I.status!=="resolving");if(N.length){L(!0);for(const{r:I,i:D}of N)if(!await q(D,I))break;L(!1)}},R=c.useMemo(()=>{const N=new Set,I=[];return i.filter(D=>D.status==="kept").forEach(D=>{const B=D.name.trim().toLowerCase();B&&!N.has(B)&&(N.add(B),I.push(D.name.trim()))}),r.filter(D=>Ee(D)>=1&&Ee(D)<=4&&(D.website||D.domain)).forEach(D=>{const B=(D.name||"").trim().toLowerCase();B&&!N.has(B)&&(N.add(B),I.push((D.name||"").trim()))}),I},[i,r]),$=c.useMemo(()=>{const N=new Set;return r.forEach(I=>{const D=(I.name||"").trim().toLowerCase();D&&N.add(D)}),i.forEach(I=>{const D=I.name.trim().toLowerCase();D&&N.add(D)}),N},[r,i]),F=async()=>{if(u||!R.length)return;f(!1);const N=[];for(const I of R.slice(0,2)){b(I);const D=await co(n,I);if(D){if(D.verdict==="quota"){w(!0);break}(D.results||[]).forEach(B=>{const te=(B.company||"").trim().toLowerCase();!te||$.has(te)||N.some(ae=>ae.name.toLowerCase()===te)||N.push({name:(B.company||"").trim(),verdict:B.verdict||"",reason:B.reason,from:I})})}}b(""),f(!0),x(I=>[...N,...I].slice(0,24))},O=async(N,I)=>{if(u)return;f(!1),b(N==="thesis"?e.pxThesis:I);const D=await Wi(n,N,I,6);if(b(""),f(!0),!D)return;if(D.verdict==="quota"){w(!0);return}const B=[];(D.results||[]).forEach(te=>{const ae=(te.company||"").trim().toLowerCase();!ae||$.has(ae)||B.some(be=>be.name.toLowerCase()===ae)||B.push({name:(te.company||"").trim(),verdict:te.verdict||"",reason:te.reason,from:N==="thesis"?e.pxThesis:I})}),x(te=>[...B,...te].slice(0,24))},g=()=>{const N=v.trim();N.length<3||O(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(N)?"registry":"keyword",N)},A=N=>{d(I=>[...I,{name:N.name,site:"",status:"",auto:!0}].slice(0,30)),x(I=>I.filter(D=>D.name!==N.name))},U=i.filter(N=>N.name.trim()&&N.status!=="kept"&&N.status!=="out").length,ee=N=>N.name.trim()&&N.status!=="kept"&&N.status!=="out"&&N.status!=="resolving"&&!N.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((N,I)=>t.jsxs("div",{className:"eq-row"+(N.status==="kept"?" r-kept":N.status==="out"?" r-out":""),children:[t.jsx("input",{value:N.name,placeholder:e.eqNamePh,onChange:D=>{const B=D.target.value.split(`
`).map(te=>te.trim()).filter(Boolean);B.length>1?d(te=>{const ae=[...te];return ae.splice(I,1,...B.map(be=>({name:be,site:"",status:"",auto:!0}))),ae.slice(0,30)}):k(I,{name:D.target.value})},onBlur:()=>{N.name.trim()&&!N.site&&N.status!=="resolving"&&N.status!=="pick"&&E(I,N.name)},onKeyDown:D=>{D.key==="Enter"&&E(I,N.name)}}),t.jsxs("span",{className:"eq-site",children:[N.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),N.status==="pick"&&(N.candidates||[]).map(D=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>k(I,{site:D.url,status:"ready",candidates:void 0}),children:(D.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},D.url)),N.status!=="resolving"&&N.status!=="pick"&&(N.site?t.jsxs("a",{href:N.site.startsWith("http")?N.site:"https://"+N.site,target:"_blank",rel:"nofollow noopener",children:[N.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:N.name.trim()&&N.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:N.desc||"",children:N.descBusy?t.jsx("i",{children:e.eqDescBusy}):N.desc?N.desc:t.jsx("em",{children:N.descDone?l?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(N.status||"vide"),title:N.reason||"",children:N.status==="kept"?"✓ "+e.kept:N.status==="out"?"✗ "+e.dropped:N.status==="ready"?e.eqReady:N.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!ee(N)||C,onClick:()=>{q(I,N)},children:N.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>d(D=>D.filter((B,te)=>te!==I)),children:"×"})]},I)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>d(N=>[...N,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]}),t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{O("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:v,placeholder:e.pxPlace,onChange:N=>j(N.target.value),onKeyDown:N=>{N.key==="Enter"&&g()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||v.trim().length<3,onClick:g,children:e.pxGoFree}),!!R.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{F()},children:u&&u!==e.pxThesis&&u!==v?e.sgBusy(u):e.sgGo}),!!R.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(R[0],R.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),y&&!p.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),p.map(N=>t.jsxs("span",{className:"eq-sc"+(N.verdict==="kept"?" ok":""),title:(N.reason||"")+" — "+e.sgVia(N.from),children:[t.jsx("b",{children:N.name}),N.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>A(N),children:"+"})]},N.name))]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(C?" loading":""),style:{justifyContent:"center"},disabled:C||!U,onClick:()=>{M()},children:[t.jsx("span",{className:"fill"}),C?e.eqRunning:e.eqGo(U)]}),t.jsx("span",{className:"hint",children:e.eqHint}),i.some(N=>N.status==="kept"||N.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>d(N=>N.filter(I=>I.status!=="kept"&&I.status!=="out")),children:e.eqClearDone})]})]})}function Go(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ld(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Vr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:s}=Q();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function Yo({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Q(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Vr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Vr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Fd({card:e,onEvaluate:a,onAddAll:r}){var s,l,h;const{t:n}=Q(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Go(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx(Yo,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function Rd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Od({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Q(),s=o,[l,h]=c.useState(null),[p,x]=c.useState(null),[u,b]=c.useState(null),[m,w]=c.useState(!1);c.useEffect(()=>{let f=!0;return(async()=>{const v=await uo({email:d,cbToken:s});f&&h(v)})(),()=>{f=!1}},[d,s,n]);const y=f=>{x(f),b(null),w(!0),(async()=>{const v=await Gi(f.id);b(v),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Rd(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(Fd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ja=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Zt(e){return/^https?:\/\//i.test((e||"").trim())}function ct(e){const a=(e||"").trim();return a?Zt(a)?a:ja.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Md(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Dd(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:d,evalBusy:s,evalCards:l,caps:h,data:p,canWrite:x,source:u,dossiers:b,doAnalyse:m,liveMemos:w,pipe:y}=Q(),f=a==="client",v=c.useMemo(()=>r||(u!=="default"?Yi():""),[r,u]),[j,k]=c.useState(""),[E,S]=c.useState(!1),[C,L]=c.useState(""),[q,M]=c.useState(""),[R,$]=c.useState(""),[F,O]=c.useState(!1),[g,A]=c.useState(!1),[U,ee]=c.useState([]);c.useEffect(()=>{const P=Z=>{const de=Z.detail;de&&ee(xe=>[de,...xe].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[N,I]=c.useState(!1),[D,B]=c.useState(!1),[te,ae]=c.useState(!1),be=c.useRef(!1),[J,he]=c.useState(""),[ue,ge]=c.useState(""),[_,K]=c.useState(!1),[V,ne]=c.useState(!1),[H,se]=c.useState(0),[le,oe]=c.useState(""),[re,we]=c.useState(null),[me,We]=c.useState(null),[ye,Ce]=c.useState(!1),[Ne,Oe]=c.useState(null),[vt,lt]=c.useState(0),Me=c.useRef(!1),Se=j.trim()?ja.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),Z=(P.get("rs")||"").trim(),de=(P.get("rstext")||"").trim();Z&&/^https?:\/\//i.test(Z)&&he(Z),de&&ge(de),(Z&&/^https?:\/\//i.test(Z)||de)&&I(!0)},[]),c.useEffect(()=>{const P=Z=>{const de=Z.detail||{},xe=String(de.url||"").trim(),ce=String(de.text||"").trim();xe&&/^https?:\/\//i.test(xe)&&he(xe),ce&&ge(ce),(xe&&/^https?:\/\//i.test(xe)||ce)&&(I(!0),k(""),L(""),K(!0),window.setTimeout(()=>K(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),c.useEffect(()=>{const P=Z=>{const de=Z.detail||{},xe=String(de.name||"").trim();if(!xe)return;I(!1),k(xe),L(xe);const ce=ct(String(de.website||de.domain||""));M(ce),$(ct(String(de.url||""))),O(!ce),S(!0),window.setTimeout(()=>S(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),c.useEffect(()=>{const P=(C||"").trim();if(!P||N||q){(q||!P||N)&&O(!1);return}const Z=b.find(ce=>Ue(ce.name)===Ue(P)),de=ct((Z==null?void 0:Z.website)||"")||ct((Z==null?void 0:Z.domain)||"");if(de){M(de),O(!1);return}let xe=!0;return O(!0),Cn(P).then(ce=>{var Be,Ae;if(!xe)return;const qe=ct(ce.website||"")||ct(((Ae=(Be=ce.candidates)==null?void 0:Be[0])==null?void 0:Ae.url)||"");qe&&M(qe)}).catch(()=>{}).finally(()=>{xe&&O(!1)}),()=>{xe=!1}},[C,N,q,b]),c.useEffect(()=>{const P=Z=>{var xe;const de=String(((xe=Z.detail)==null?void 0:xe.url)||"").trim();Zt(de)&&window.open(de,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),c.useEffect(()=>{if(be.current===N)return;be.current=N,ae(!0);const P=window.setTimeout(()=>ae(!1),560);return()=>window.clearTimeout(P)},[N]),c.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),Z=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!Z)return;const de=()=>Z.style.setProperty("--demand-h",`${P.offsetHeight}px`);de();const xe=new ResizeObserver(de);return xe.observe(P),()=>xe.disconnect()},[u,E,_,g,N,te,F]),c.useEffect(()=>{if(!x&&!v){Oe(null);return}let P=!0;return(async()=>{const Z=await uo({email:n,cbToken:v});P&&Oe(Z.length)})(),()=>{P=!1}},[x,v,n,vt]);const rt=U.length?U:l,He=p.credits,wt=c.useCallback(P=>{Td(r,P)&&A(!0)},[r]);c.useEffect(()=>{if(!V)return;se(0);const P=window.setInterval(()=>se(Z=>Z+1),1e3);return()=>window.clearInterval(P)},[V]);const ot=c.useMemo(()=>{const P=j.trim().toLowerCase();return!P||!y?null:b.find(Z=>Ue(Z.name)===P&&Ee(Z)===1)||null},[j,b,y]),St=()=>{const P=j.trim();if(P){if(ot){m(ot);return}o(null,P),f&&k("")}},Ct=async()=>{var de,xe,ce;if(Me.current)return;const P=J.trim().replace(/\s+/g,""),Z=ue.trim();if(!P&&!Z){oe(e.rsNeed);return}if(!f&&!v){o(null,P||Z.slice(0,80));return}Me.current=!0,oe(""),we(null),We(null),ne(!0);try{const qe=await Ki({url:P,text:Z,email:n,cbToken:v});if(ne(!1),!qe||qe.status!=="success"){oe((qe==null?void 0:qe.message)||"Erreur");return}we(qe),I(!1),wt((((de=qe.prospective)==null?void 0:de.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),We({state:"pending"});const Be=await Ji(qe,{email:n,cbToken:v});We(Be.ok?{state:"ok",scopeLabel:((xe=Be.summary)==null?void 0:xe.scope_label)||"",scope:((ce=Be.summary)==null?void 0:ce.scope)||""}:{state:"fail",msg:Be.error||""}),Be.ok&&lt(Ae=>Ae+1)}finally{Me.current=!1,ne(!1)}},Je=[re==null?void 0:re.industry,...(re==null?void 0:re.market_tags)||[],re==null?void 0:re.author].map(P=>(P||"").trim()).filter(Boolean),yt=(me==null?void 0:me.state)==="pending",zt=me&&(yt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):me.state==="ok"?t.jsx("span",{className:"rslink ok",children:me.scope&&me.scope!=="public"?e.rsSavedIn(me.scopeLabel||me.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:me.msg,children:e.rsSaveFail})),Mt=Ld(re).length,Ie=N,it=(C||j).trim(),Pe=b.find(P=>Ue(P.name)===Ue(it)),T=ct(j)||q||ct((Pe==null?void 0:Pe.website)||"")||ct((Pe==null?void 0:Pe.domain)||""),W=R||ct((Pe==null?void 0:Pe.url)||""),X=ot?e.actAnalyse:it?e.evalGoOn(it.length>22?it.slice(0,21)+"…":it):e.evalGo,pe=V?`${Qi(J.trim())==="youtube"&&J.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(H)}`:yt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ie?" rs-mode":"")+(C&&j.trim()===C||E||_?" pair":"")+(E||_||te?" echo":"")+(te?" swap":""),children:[t.jsxs("div",{className:"drow"+((Ie?_:E)||te?" flash":"")+((Ie?J.trim():ja.test(j.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ie?J:j,placeholder:Ie?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ie?600:200,spellCheck:Ie?!1:void 0,inputMode:Ie?"url":void 0,onChange:P=>{if(Ie){he(P.target.value);return}k(P.target.value),C&&P.target.value.trim()!==C&&(L(""),M(""),$(""),O(!1))},onKeyDown:P=>{P.key==="Enter"&&(Ie?Ct():St())}}),t.jsx("span",{className:"detect"+(Ie?" off":"")+(ja.test(j.trim())?" url":""),children:Se})]}),t.jsx("span",{className:"dacts",children:Ie?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(V?" loading":""),disabled:V||yt||!J.trim()&&!ue.trim(),onClick:()=>{Ct()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:pe})]}),t.jsxs("a",{className:"viewbtn"+(Zt(J)?"":" off"),href:Zt(J)?J.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{Zt(J)||P.preventDefault()},children:[t.jsx(Md,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ot?" analyse":"")+(s?" loading":""),disabled:s,onClick:St,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:X})]}),t.jsxs("a",{className:"viewbtn sm"+(F?" searching":T?"":" off"),href:T||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{T||P.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(W?"":" off"),href:W||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{W||P.preventDefault()},children:e.viewSrc})]})}),h.showCredits&&He&&t.jsxs("button",{type:"button",className:"credits"+(He.total_available<=0&&!He.unlimited?" empty":""),onClick:()=>d({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:He.unlimited?"∞":He.total_available}),!He.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",He.daily_grant+He.purchased]}),He.total_available<=0&&!He.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>A(!g),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(N?" on":""),onClick:()=>I(!N),children:e.rsOpen}),Ne!==null&&Ne>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ye?" on":""),onClick:()=>Ce(!ye),children:e.rsArchOpen(Ne)})]}),ye&&t.jsx(Od,{bump:vt,cbToken:v,onClose:()=>Ce(!1),onEvaluate:P=>o(null,P),onAddAll:wt}),t.jsx("div",{className:"rsp slim"+(N?" on":" off"),"aria-hidden":!N,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:N?void 0:-1,onClick:()=>B(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:D?"▴":"▾"})]}),D&&t.jsx("textarea",{className:"rstext",value:ue,placeholder:e.rsTextPh,tabIndex:N?void 0:-1,onChange:P=>ge(P.target.value)})]})}),le&&t.jsx("div",{className:"rserr",children:le}),re&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:re.title}),re.source_url&&t.jsx("a",{href:re.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{we(null),We(null)},children:"×"})]}),re.market&&t.jsx("p",{className:"rsmk",children:re.market}),Je.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Je.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[re.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${re.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Go(re.summary_md||"").map((P,Z)=>t.jsx("p",{children:P},Z))})]}),t.jsx(Yo,{card:re,onEvaluate:P=>o(null,P),onAddAll:wt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Mt)}),zt]})]}),g&&t.jsx(Wo,{}),rt.slice(0,1).map((P,Z)=>{const de=P.verdict==="kept",xe=P.verdict==="quota",ce=P.verdict==="unresolved",qe=de?"var(--brand)":xe?"var(--bolt)":ce?"var(--blue)":"var(--red)",Be=de?"var(--brand-l)":xe?"#FFF3D6":ce?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":qe,"--bgc":Be},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:de?"✓ "+e.kept:xe?"⏳":ce?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,Ae.url,P.name),children:e.evalPickGo})]},Ae.url))}),!xe&&!ce&&t.jsx("button",{type:"button",className:"go",onClick:()=>{d({type:"ptab",tab:de?1:5});const Ae=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const dt=[...document.querySelectorAll(".atl2 .list .row")].find(Xe=>{var da;return(((da=Xe.querySelector(".rnm"))==null?void 0:da.textContent)||"").trim().toLowerCase().includes(Ae)});dt&&(dt.scrollIntoView({behavior:"smooth",block:"center"}),dt.classList.add("flashrow"),window.setTimeout(()=>dt.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(de?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},Z)}),f&&(i.kept+i.dropped>0||rt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>d({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Id(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Pd(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Q(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",Id(i.summary||"")].filter(Boolean).join(`
...
`;function Xd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:d,top:s}}function Zd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:s,doAnalyse:l,doDecide:h,doPromote:p,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:w,evalBusy:y}=Q(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const v=De(f),j=Ee(f),k=Nt(f),E=sa(f),S=f.kind==="target",C=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Ut.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Jd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Xd(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(bt(f.date)),Ke(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[f.cc]}),children:(Ht(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Vt(f.amountEur,o)})]}),i.pipe&&S&&t.jsxs("div",{className:"pstat",children:[E&&t.jsx("span",{className:"vd "+(E==="MATCH"?"v-ok":"v-no"),title:n.vt[E],children:E}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Lt(f.engine)," ",t.jsx("b",{children:Ke(f.engine,o)})," — ",Zi(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),v?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Et,{o:f,lg:!0})," ",t.jsx(Pa,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(fo(v,o))," · ",n.win7(ho(v,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(la,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&S&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&S&&t.jsx(Rn,{o:f})]}),t.jsx(Fn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{l(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(f,!1),a({type:"popup",id:null})},children:n.actNo}),Pt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function ep(){const{lang:e,token:a,dossiers:r,caps:n}=Q(),o=a||"home",{names:i,verdicts:d}=c.useMemo(()=>{const l=[],h={};return r.forEach(p=>{p.kind!=="target"||!p.name||(l.push(p.name),h[p.name]=es(p)||"")}),{names:l,verdicts:h}},[r]);return{diff:c.useMemo(()=>i.length?ts(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function tp(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:s}=Q(),[l,h]=c.useState(!1),[p,x]=c.useState(!1),u=c.useRef(null);c.useEffect(()=>{if(!l)return;const j=k=>{u.current&&!u.current.contains(k.target)&&h(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[l]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...s.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!d.length,w=c.useRef({});c.useEffect(()=>{w.current={...r}},[r]);const y=j=>{const k=w.current[j],E=k!==void 0?r[j]-k:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${ea[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j],j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(E>0?" up":E<0?" down":""),children:[r[j],E!==0&&t.jsxs("em",{className:"delta",children:[E>0?"+":"−",Math.abs(E)]})]})]},j)},f=(j,k,E)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),style:{"--c":`var(${ea[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:E}),t.jsx("span",{className:"n",children:r[j]})]},j),v=(j,k,E,S=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:S,onClick:E,children:j},k);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(y)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[v("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(p?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":l,title:n.toolSort,onClick:()=>h(j=>!j),children:"⇅"}),l&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[k,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),v("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),v("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function ap(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,doAnalyse:s,mode:l}=Q(),h=c.useRef(null),[p,x]=c.useState(60);c.useEffect(()=>{let j=0;const k=()=>{var q;const E=h.current;if(!E)return;const S=(q=E.parentElement)==null?void 0:q.querySelector('.funnel [aria-selected="true"]');if(!S)return;const C=S.getBoundingClientRect(),L=E.getBoundingClientRect();x(Math.max(20,Math.min(C.left+C.width/2-L.left,L.width-30)))};return j=requestAnimationFrame(k),window.addEventListener("resize",k),()=>{cancelAnimationFrame(j),window.removeEventListener("resize",k)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const j=i.filter(S=>S.kind==="target"&&Ee(S)===3),k=j.filter(S=>on(S)==="auto").length,E=j.filter(S=>on(S)==="cd").length;b=r.tutoPending(k,E,j.length)}const m=(()=>{if(l!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:i.map(j=>j.id)})};if(u===1){const j=i.filter(k=>k.kind==="target"&&Ee(k)===1&&!d.has(k.id)).slice(0,10);if(j.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:j.map(k=>k.id)})}}return null})(),w=as(u),y=u===1||u===2,f=r.plabels[u]+" · "+(o[u]??0),v=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:h,className:"tuto mini"+(w?"":" on-dark")+(y?" etape-on":""),style:{"--bg":`var(${ea[u]})`,"--ax":p+"px","--stc":w?"var(--ink)":"#fff","--stt":w?"#fff":"var(--ink)","--tc":w?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:f}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:v})]})}const an=600,qt=62,Jr="atl2:fstats";function np(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Q(),[d,s]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Jr)==="on"}catch{return!1}}),l=r.stats,h=c.useMemo(()=>((l==null?void 0:l.by_day)||[]).slice(-30),[l]),p=(l==null?void 0:l.since)||"";if(!n.showFunnel||!l||typeof l.screened!="number")return null;const x=E=>a==="en"?E.slice(5,10):`${E.slice(8,10)}/${E.slice(5,7)}`,u=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((E,S)=>Math.max(E,S.s||0),0),m=h.length?an/h.length:0,w=Math.max(4,m-4),y=h.length>=5&&b>0,f=r.marketEstimate||0,v=x(new Date().toISOString().slice(0,10)),j=E=>[...typeof E=="number"?[[E,e.funScreened("","")]]:[],...typeof l.kept=="number"?[[l.kept,e.funKept]]:[],...typeof l.analyzed=="number"?[[l.analyzed,e.funAnalyzed]]:[],...typeof l.shown=="number"?[[l.shown,e.funShown]]:[]],k=[];return typeof l.screened_window=="number"&&p&&k.push({cle:"fenetre",periode:e.funPerWindow(x(p),v),etapes:[[l.screened_window,e.funScreened("","")]]}),typeof l.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:j(l.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(E=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:E.periode}),E.etapes.map(([S,C],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(S)}),t.jsx("i",{children:C})]},E.cle+C)),E.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((l.screened||0)/f*100)))})]}),E.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const S=!d;s(S),S&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Jr,S?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},E.cle)),d&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${an} ${qt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((E,S)=>{const C=(E.s||0)/b*(qt-4),L=(E.m||0)/b*(qt-4),q=S*m+(m-w)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(E.d)} — ${E.s} ${e.actScreened} · ${E.m} ${e.actKept}`}),t.jsx("rect",{x:q,y:qt-2-C,width:w,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:q,y:qt-2-L,width:w,height:L,fill:"#0E7F3F"})]},E.d)}),t.jsx("line",{x1:0,y1:qt-1.5,x2:an,y2:qt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}function Xr(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}const Ko={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function On({o:e,locked:a=!1}){const{t:r}=Q(),n=sa(e),o=Nt(e),i=Ee(e),d=on(e),s=ns(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Ko[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(Nl,{o:e})]})}const $t=e=>e.length>22?e.slice(0,21)+"…":e;function ia(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Jo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function rp({on:e,rev:a}){const[r,n]=c.useState(null),[o,i]=c.useState({top:0,left:0,width:0});return c.useEffect(()=>{if(!e){n(null);return}const d=()=>{var m,w,y;const s=document.querySelector(".atl2.ops .desk-list"),l=document.querySelector(".atl2.ops .listhead");if(!s){n(null);return}const h=s.getBoundingClientRect(),p=l?l.getBoundingClientRect().bottom:h.top;i({top:Math.round(p),left:Math.round(h.left),width:Math.round(h.width)});const x=[...s.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const v=f.querySelector(".grp-h");v&&v.getBoundingClientRect().bottom<=p+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function op(e){const r=()=>{const n=Jo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Zr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Q(),[i,d]=c.useState(!1);if(c.useEffect(()=>{n||d(!1)},[n]),_e(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const l=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(l?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn($t(e.name))})]})}function Mn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:d,doPromote:s,doRepeche:l,doApproach:h,dispatch:p,liveMemos:x}=Q(),u=m=>w=>{w.stopPropagation(),m()};if(r.lockActions){const m=u(()=>p({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const w=Ee(e);return w===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn($t(e.name))})]})}):w===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):w===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):w===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):w===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):w===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ia(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Ca(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ia(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Zr,{o:e})});const b=Ee(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Zr,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const w=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:w,onClick:u(()=>i(e)),children:w?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>d(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>d(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>h(e)),children:m?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:u(()=>p({type:"modal",modal:"plug"})),children:a.actConn})]})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>p({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function ip({o:e}){const{t:a,doThumb:r,thumbOf:n}=Q(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function sp({o:e}){const{lang:a}=Q();return De(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Et,{o:e}),t.jsx(Pa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Lt(e.engine||"")," ",Ke(e.engine||"",a)]})})}function lp({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:s}){const{dispatch:l,caps:h,markRow:p,markedId:x,favIds:u,toggleFav:b,t:m}=Q(),w=Ee(e),y=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=f<=0?0:f<=7?1:f<=30?2:3,j=h.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:y[v],k=u.has(e.id),E=S=>{if(a)return;if(d){d(e.id);return}if(h.pipe||e.kind==="op"){n();return}const C=S.currentTarget.getBoundingClientRect();l({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(c.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(h.pipe&&e.kind==="target"?" p"+w:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>p(e.id),onMouseLeave:()=>p(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(ni,{o:e}),t.jsxs("span",{className:"nd",children:[s&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),De(e)&&t.jsx(Et,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[h.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:S=>{S.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ge(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(S=>S&&S!==e.name)||""]}),h.pipe&&!h.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:S=>S.stopPropagation(),children:[e.website&&t.jsx("a",{href:Xr(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowSite,title:m.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:Xr(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowLi,title:m.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":m.rowMail,title:m.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":m.rowTel,title:m.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:S=>{S.stopPropagation(),l({type:"acquirer",value:e.acquirer||""})},children:["← ",$t(e.acquirer)]}),Ye(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(dp,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(sp,{o:e}),h.pipe&&t.jsx(On,{o:e,locked:a}),h.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Mn,{o:e}),h.showThumbs&&t.jsx(ip,{o:e})]}),r&&!a&&!d&&t.jsx(up,{o:e})]})}function dp({o:e}){const{lang:a,caps:r}=Q();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Vt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function pp({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Q(),d=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),l=Vt(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=_e(e),x=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),l&&t.jsx("span",{className:"oc-amt",children:l}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Ge(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),ia(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn($t(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(la,{spec:e.card})})]})}function cp({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Q();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ke(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Mn,{o:e})}),t.jsx(Rn,{o:e})]})}function Xo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:s,dossiers:l}=Q(),h=c.useRef(null),p=Ye(e);if(c.useEffect(()=>{if(!p||!(e!=null&&e.decryptHtml))return;const g=h.current;if(!g)return;let A=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async U=>{await U.ensureEditoCss(),!(A||!g.isConnected)&&(U.beautifyEditoRows(g),U.mountCardFits(g))}),()=>{A=!0}},[p,e==null?void 0:e.decryptHtml]),!e&&!a){const g=l.find(Ye);if(g)return t.jsx(Xo,{o:g})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!x||Sa(x),y=(e==null?void 0:e.engine)||"",f=Ye(e),v=e?Vt(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),E=l.find(Ye),S=((E==null?void 0:E.url)||"").trim(),C=!!u&&!!S&&(u===S||u.endsWith(S)||S.endsWith(u)),L=(g,A=!1)=>U=>{U.stopPropagation(),A&&d({type:"continent",key:"monde"}),d({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const q=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},M=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},R=()=>{ia({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},$=e?_e(e):!1,F=$&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",O=f?r.doEdito.replace(/^📖\s*/,""):y?Ke(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[O,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(w||Ca({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(la,{spec:m})}),(u&&!C&&!f||E&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!C&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),E&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),d({type:"focus",id:E.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[$?t.jsxs("span",{className:"verdict",style:{"--c":F?"var(--brand)":"var(--red)"},children:[F?"✓":"✗"," ",t.jsx("b",{children:F?r.kept:r.dropped})]}):!w&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:g=>{g.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn($t(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(w||Ca({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&x?" ghost":""),onClick:g=>{g.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!s.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),M()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),q()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:$t(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&x&&s.pipe&&t.jsx(Fn,{name:x})]})]})}function up({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=Q();return!o.pipe&&e.kind==="op"?t.jsx(pp,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Rn,{o:e}),t.jsx(Sl,{o:e}),t.jsx(zl,{o:e}),t.jsx(Fn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(On,{o:e})})]}),e.card&&t.jsx(la,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Lt(e.engine||"")," ",Ke(e.engine||"",r)]}),De(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Et,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function mp({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:s,lang:l}=Q();if(!d.pipe&&e.kind==="op"){const x=Vt(e.amountEur,l),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,w=!1)=>y=>{y.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(la,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Lt(e.engine||"")," ",Ke(e.engine||"",l)]}),De(e)&&t.jsx(Et,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Mn,{o:e})})]})}const h=Ee(e),p=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":p},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(On,{o:e}),De(e)&&t.jsx(Et,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>s(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function fp(){const{t:e}=Q(),[a,r]=c.useState(0);return c.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function hp({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Q(),i=o==="en",d=p=>n.plabels[p]||"",s=[0,1,2,3,4,5,6,7].filter(p=>p!==a.ptab&&(e[p]||0)>0),l=s.includes(0)?0:s.sort((p,x)=>(e[x]||0)-(e[p]||0))[0];if(l===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[l]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:l===0?i?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:i?`${h} ${h>1?"files":"file"} in “${d(l)}”`:`${h} dossier${h>1?"s":""} dans « ${d(l)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:l}),children:[(i?"Open ":"Ouvrir ")+d(l)," →"]})]})}function gp(){var zt,Mt,Ie,it,Pe;const e=Q(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:s,markRow:l,lang:h,sessTally:p,data:x,dossiers:u,source:b,focusExtra:m,byId:w,token:y}=e,f=bo(),v=c.useMemo(()=>{var X,pe,P,Z;if(!y||b==="ops")return null;const T=(((X=f==null?void 0:f.ed)==null?void 0:X.date)||(f==null?void 0:f.day)||"").slice(0,10),W=[(pe=f==null?void 0:f.ed)==null?void 0:pe.html,(P=f==null?void 0:f.ed)==null?void 0:P.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((Z=f==null?void 0:f.ed)==null?void 0:Z.date)||T,decryptHtml:W||void 0,date:T,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,h,(zt=f==null?void 0:f.ed)==null?void 0:zt.html,(Mt=f==null?void 0:f.ed)==null?void 0:Mt.acquirers_html,(Ie=f==null?void 0:f.ed)==null?void 0:Ie.date,f==null?void 0:f.day]),j=T=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:xo,[k,E]=c.useState(new Set);c.useEffect(()=>{E(new Set)},[a.ptab,a.continent]);const[S,C]=c.useState(null);c.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[L,q]=c.useState(!a.mapFolded);c.useEffect(()=>{if(a.mapFolded){q(!1);return}const T=document.getElementById("atl2-stage");if(!T){q(!1);return}const W=new IntersectionObserver(([X])=>q(!!X&&X.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return W.observe(T),()=>W.disconnect()},[a.mapFolded]);const M=a.mapFolded||!L,R=T=>E(W=>{const X=new Set(W);return X.has(T)?X.delete(T):X.add(T),X}),$=b==="ops"||o.pipe,[F,O]=c.useState("all"),[g,A]=c.useState(!1),[U,ee]=c.useState(null),[N,I]=c.useState(!1),D=c.useRef(!0);c.useEffect(()=>{if(D.current){D.current=!1;return}O("all"),I(!1)},[a.ptab,a.continent]),c.useEffect(()=>{if(!N)return;const T=W=>{var X,pe;(pe=(X=W.target)==null?void 0:X.closest)!=null&&pe.call(X,".atl2 .doable")||I(!1)};return document.addEventListener("click",T,!0),()=>document.removeEventListener("click",T,!0)},[N]);const B=c.useMemo(()=>{var W;const T=new Map;for(const X of cl(((W=f==null?void 0:f.ed)==null?void 0:W.html)||""))T.has(X.t)||T.set(X.t,X.html);return T},[(it=f==null?void 0:f.ed)==null?void 0:it.html]),te=c.useCallback(T=>{if(T.decryptHtml)return T.decryptHtml;if(!B.size)return;const W=(T.name||"").trim().toLowerCase();if(W.length<3)return;const X=B.get(W);if(X)return X;for(const[pe,P]of B)if(pe.includes(W)||W.includes(pe))return P},[B]),{diff:ae}=ep(),[be,J]=c.useState(!1),he=a.filters.win==="1"&&!a.filters.day,[ue,ge]=c.useState(!1),_=c.useMemo(()=>new Set(((ae==null?void 0:ae.added)||[]).map(T=>T.trim().toLowerCase()).filter(Boolean)),[ae]),K=c.useMemo(()=>{if(!_.size)return 0;const T={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(W=>!Ye(W)&&_.has((W.name||"").trim().toLowerCase())&&ta(W,T,o.pipe)).length},[u,_,a,o.pipe]);c.useEffect(()=>{const T=()=>{ge(!1),A(!1),O("all"),I(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",T),()=>window.removeEventListener("ppmap:tunnel",T)},[]),c.useEffect(()=>{ge(!1),A(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const V=c.useMemo(()=>{const T=s.filter(X=>!Ye(X)&&Ge(X));let W="";for(const X of T){const pe=(X.date||"").slice(0,10);pe&&(!W||pe<W)&&(W=pe)}return{n:T.length,since:W?W.split("-").reverse().slice(0,2).join("/"):""}},[s]),ne=V.n,H=c.useMemo(()=>{const W=ue&&_.size>0||a.filters.signalOnly||F!=="all"||g?s:d;let X=zn(W,a.sort);return X=X.filter(pe=>!Ye(pe)),ue&&_.size&&(X=X.filter(pe=>_.has((pe.name||"").trim().toLowerCase()))),g||F==="explore"?X=X.filter(Ge):F==="eval"?X=X.filter(pe=>!Ge(pe)&&!pe.noCo&&(pe.kind==="op"||!_e(pe))):o.pipe&&(X=X.filter(pe=>!Ge(pe))),X},[d,s,a.sort,F,ue,_,g,o.pipe]),le=c.useMemo(()=>o.pipe?u.filter(T=>T.kind==="target"&&!Ye(T)&&De(T)&&(a.continent==="monde"||T.continent===a.continent)):H.filter(T=>De(T)&&!_e(T)),[o.pipe,u,H,a.continent]).length,oe=c.useMemo(()=>o.pipe?H:H.filter(T=>!_e(T)&&!T.noCo&&!Ge(T)),[H,o.pipe]),re=b==="ops"?H.filter(Ge).length:0,we=ue?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,me=a.filters,We=me.sector.length+me.country.length+me.engine.length+me.stage.length+me.crible.length+me.angle.length+me.memoLevel.length+me.dealKind.length+(me.signalOnly?1:0)+(me.acquirer.trim()?1:0)+(me.search.trim()?1:0),ye=[];if(me.day)ye.push({k:"day",lib:n.fDay(me.day.slice(8,10)+"/"+me.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(me.win&&me.win!=="all"){const T=["1","7","30"].indexOf(me.win);T>=0&&ye.push({k:"win",lib:n.dates[T],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ce=T=>T.length<=2?T.join(", "):`${T.length} ${n.fSelected}`;for(const T of["sector","country","engine","crible"]){const W=me[T];W&&W.length&&ye.push({k:T,lib:Ce(W),off:()=>r({type:"clearFacet",facet:T})})}me.search&&ye.push({k:"search",lib:"🔍 "+me.search,off:()=>r({type:"filters",patch:{search:""}})}),ue&&_.size&&ye.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>ge(!1)}),me.signalOnly&&ye.push({k:"sig",lib:"🔴 "+n.sigDock(le||me.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const Ne=(T,W,X="",pe=!1)=>t.jsxs("button",{type:"button","data-s":T,className:X,"aria-sort":a.sort.key===T?a.sort.dir===1?"ascending":"descending":"none",style:pe?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:T}),children:[W,t.jsx("span",{className:"ar",children:a.sort.key===T&&a.sort.dir===1?"▴":"▾"})]},T),Oe=c.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const T=new Map;H.forEach(pe=>{const P=pe.engine||"?";T.has(P)||T.set(P,[]),T.get(P).push(pe)});const W={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},X=rn([...T.keys()],h);return[...T.entries()].sort((pe,P)=>{const Z=W[pe[0]]??10+X.indexOf(pe[0]),de=W[P[0]]??10+X.indexOf(P[0]);return Z-de})},[H,o.pipe,a.groupBy,h]),vt=Oe?Oe.filter(([T])=>ya.has(T)).length:0,lt=(()=>{var W;return((W=(Oe?Oe.flatMap(([,X])=>X):H)[0])==null?void 0:W.id)??null})(),Me=c.useRef(!1),Se=c.useMemo(()=>u.find(Ye)||v,[u,v]);c.useEffect(()=>{const T=()=>{Me.current=!0,ge(!1)};return window.addEventListener("ppmap:reveal",T),window.addEventListener("ppmap:focus",T),()=>{window.removeEventListener("ppmap:reveal",T),window.removeEventListener("ppmap:focus",T)}},[]),c.useEffect(()=>{const T=()=>{Se&&r({type:"focus",id:Se.id})};return window.addEventListener("ppmap:edito",T),()=>window.removeEventListener("ppmap:edito",T)},[Se,r]),c.useEffect(()=>{if(!a.focusId)return;ee(a.focusId);const T=window.setTimeout(()=>ee(null),900);return()=>window.clearTimeout(T)},[a.focusId]),c.useEffect(()=>{if($&&!(a.focusId&&(H.some(T=>T.id===a.focusId)||u.some(T=>T.id===a.focusId)||a.focusId===(Se==null?void 0:Se.id)))&&!m){if(Se){r({type:"focus",id:Se.id});return}lt&&r({type:"focus",id:lt})}},[$,a.focusId,H,lt,m,r,u,b,Se]),c.useEffect(()=>{if(!$||!a.focusId||Se&&a.focusId===Se.id||H.some(W=>W.id===a.focusId))return;const T=u.find(W=>W.id===a.focusId);if(T){if(Me.current){T.kind==="op"?O(Ge(T)?"explore":"eval"):F!=="all"&&O("all");return}F!=="all"&&lt&&r({type:"focus",id:lt})}},[$,a.focusId,F,H,u,lt,r,Se]),c.useEffect(()=>{if(!$||!a.focusId||!Me.current)return;const T=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!T){const P=H.findIndex(Z=>Z.id===a.focusId);if(P>=0){const Z=Oe?"":"pt"+a.ptab;if(Z){const de=a.shown[Z]||j();P>=de&&r({type:"more",group:Z,by:P-de+8})}}return}Me.current=!1;const W=Jo(),X=T.getBoundingClientRect();X.top>=W-2&&X.bottom<=window.innerHeight-4||op(T)},[$,a.focusId,a.ptab,H,a.shown,Oe,r]),c.useEffect(()=>{if(typeof window>"u")return;const T=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),W=document.querySelector(".atl2.ops, .atl2.cibles");if(!T||!W)return;const X=()=>W.style.setProperty("--listhead-h",`${T.offsetHeight}px`);X();const pe=new ResizeObserver(X);return pe.observe(T),()=>pe.disconnect()},[M,a.dens,a.mapFolded]);const rt=c.useMemo(()=>{if(!$||!a.focusId)return null;if(v&&a.focusId===v.id)return v;const T=H.find(X=>X.id===a.focusId)||u.find(X=>X.id===a.focusId)||null;if(!T)return null;const W=te(T);return W&&W!==T.decryptHtml?{...T,decryptHtml:W}:T},[$,a.focusId,H,u,te,v]),He=o.lockRowsAfter;let wt=0;const ot=(T,W)=>{let X=a.shown[W]||j();return T.length-X<=4&&(X=T.length),T.slice(0,X).map(Z=>{const de=He!==null&&wt>=He;wt++;const xe=te(Z),ce=xe&&xe!==Z.decryptHtml?{...Z,decryptHtml:xe}:Z,qe=!$&&a.dens!=="maxi"&&(a.dens==="deplie"||(S?S==="open":!!xe)),Be=k.has(Z.id)?!qe:qe,Ae=$?dt=>{Me.current=!0,r({type:"focus",id:dt});const Xe=w.get(dt);Xe&&(Ge(Xe)?ia(Xe):Xe.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Xe.name,url:Xe.url||"",website:Xe.website||"",domain:Xe.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(mp,{o:ce,locked:de,selected:$&&a.focusId===Z.id,onSelect:Ae},Z.id):t.jsx(lp,{o:ce,locked:de,open:Be,onToggle:()=>R(Z.id),selected:$&&a.focusId===Z.id,echo:U===Z.id,fresh:_.has((Z.name||"").trim().toLowerCase()),onSelect:Ae},Z.id)})},St="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(H.length?"":" list-empty"),Ct=t.jsxs(t.Fragment,{children:[Oe?Oe.map(([T,W])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Lt(T)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:T==="ma"?n.grpMa:T==="fundraising"?n.grpLev:ya.has(T)&&vt<=1?n.grpNews:T==="nominations"?n.grpNom:T==="media"?n.grpNewsOther:T==="recrutements"?n.grpHire:ya.has(T)?n.grpNews+" · "+Ke(T,h):Ke(T,h)}),t.jsx("div",{className:"s",children:n.grpCount(W.filter(X=>!_e(X)).length,W.length)})]})]}),ot(W,T)]},T)):ot(H,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(fp,{}),o.pipe&&a.ptab===0&&!g&&!ue&&F==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(Wo,{}),!H.length&&!(x.loading&&!u.length)&&(o.pipe&&F==="all"?t.jsx(hp,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(me.win!=="all"||!!me.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),We>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(We)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),Je=t.jsxs(t.Fragment,{children:[!ue&&!g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ea[a.ptab]+")"},children:H.length})," ",we]}),g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ea[a.ptab]+")"},children:H.length})," ",n.newsWord]}),(!ue||g)&&t.jsx("span",{className:"dot",children:"·"}),M&&t.jsx(Ho,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[M?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ye.map(T=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:W=>{W.stopPropagation(),T.off()},children:[T.lib,t.jsx("i",{children:"×"})]},T.k)),b==="ops"&&H.length>0&&!M&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",H.length-re," ",n.zoomPulseEval,re>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",re," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),yt=t.jsxs("div",{className:"listhead"+(M?" mapoff":""),children:[M&&t.jsx("div",{className:"lh-tools",children:t.jsx(Uo,{compact:!0})}),o.showFunnel&&be&&he&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(ql,{}),t.jsx(np,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:Je}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(tp,{}),t.jsx(ap,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(he?" on":""),"aria-pressed":he,title:n.morningDockTitle,onClick:()=>{if(he){r({type:"filters",patch:{win:"all",day:""}}),J(!1);return}ge(!1),A(!1),O("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),J(!0)},children:["📊 ",n.morningDock(typeof((Pe=x.stats)==null?void 0:Pe.screened_today)=="number"?x.stats.screened_today:0)]}),ae&&!ae.firstVisit&&(ae.added.length>0||ae.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ue?" on":""),"aria-pressed":ue,title:n.sinceSub,onClick:()=>{const T=!ue;ge(T),A(!1),J(!1),O("all"),T&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(K),ae!=null&&ae.lastDate?` · ${n.sinceSince(ae.lastDate)}`:""]}),le>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{ge(!1),A(!1),J(!1),O("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(le)]}),o.pipe&&ne>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(g?" on":""),"aria-pressed":g,title:n.newsDockHint,onClick:()=>{const T=!g;A(T),ge(!1),J(!1),O("all"),T&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ne),V.since?` · ${n.newsSince(V.since)}`:""]})]}),!o.showFunnel&&Je,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([T,W])=>t.jsxs("button",{type:"button","data-d":T,"aria-pressed":a.dens===T||T==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:T}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:W})]},T))}),!$&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":S==="open",onClick:()=>{C("open"),E(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":S==="closed",onClick:()=>{C("closed"),E(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var xe;const T={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},W=u.filter(ce=>ta(ce,T,o.pipe)&&!Ye(ce)),X=W.filter(ce=>!Ge(ce)&&!ce.noCo&&(ce.kind==="op"||!_e(ce))).length,pe=W.filter(Ge).length,P=o.pipe?W.filter(ce=>ce.kind!=="op"&&Ee(ce)===1).length:0,Z=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${P?` ${P}`:""}`]]:[],["eval",`${n.doEval}${X?` ${X}`:""}`],["explore",`${n.doExplore}${pe?` ${pe}`:""}`]],de=((xe=Z.find(([ce])=>ce===F))==null?void 0:xe[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":N,onClick:()=>I(ce=>!ce),children:[de,t.jsx("i",{children:"▾"})]}),N&&t.jsx("div",{className:"dolist",children:Z.map(([ce,qe])=>t.jsx("button",{type:"button","aria-pressed":F===ce,onClick:()=>{if(I(!1),ce==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}O(ce),ce!=="all"&&(ge(!1),A(!1),J(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:qe},ce))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:T=>r({type:"sort",key:T.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([T,W])=>t.jsx("option",{value:T,children:W},T))})]}),o.showChain&&oe.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:oe.map(T=>T.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(oe.length):n.chainAll(oe.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!$&&yt,a.dens!=="maxi"&&!$&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ne("country",n.colCountry),Ne("name",n.colCompany),Ne("amount",n.colAmount,"h-amt",!0),Ne("stage",n.colStage,"h-stade"),Ne("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ne("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ne("memo",n.colMemo)]}),o.pipe&&Ne("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),$?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[yt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Ne("country",n.colCountry),Ne("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Ne("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Ne("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:St,children:Ct})]}),t.jsxs("aside",{className:"readpane"+((rt?Ye(rt):!m&&Se)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[Se&&(()=>{const T=a.focusId===Se.id,W=(Se.headline||Se.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":T,onClick:()=>r({type:"focus",id:Se.id}),children:[t.jsx("span",{className:"eg-t",children:h==="en"?"Today’s editorial":"Édito du jour"}),W&&t.jsx("span",{className:"eg-sub",children:W}),t.jsx("span",{className:"eg-chev",children:T?h==="en"?"Collapse ▴":"Replier ▴":h==="en"?"Read ▾":"Lire ▾"})]})})(),v&&a.focusId===v.id?t.jsx("div",{className:"zoom",children:t.jsx(gl,{})}):rt&&o.pipe?t.jsx(cp,{o:rt}):t.jsx(Xo,{o:rt,extra:rt?null:m})]})]}):t.jsx("div",{className:St,children:Ct}),(()=>{const T=Oe||[["pt"+a.ptab,H]];let W=0,X=0;for(const[P,Z]of T){X+=Z.length;let de=a.shown[P]||j();Z.length-de<=4&&(de=Z.length),W+=Math.min(Z.length,de)}const pe=X-W;return pe<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>T.forEach(([P,Z])=>r({type:"more",group:P,by:Z.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(pe,pe)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(W,X)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}}),$&&b==="ops"&&a.dens!=="maxi"&&t.jsx(rp,{on:!!Oe,rev:(Oe||[]).map(([T,W])=>T+W.length).join("|")})]})}function eo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function xp(e,a){const r=rs(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function bp(e,a){const n=[a.head.split("|").map(eo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",xp(o,a.plabels),sa(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(eo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function vp(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const wp=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ut({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function yp({o:e,qa:a}){const{t:r,lang:n,fund:o}=Q(),i=(e.cribleStatus||"").trim().toUpperCase()||(sa(e)==="NO MATCH"?"NO MATCH":"MATCH"),d=Nt(e),s=(a==null?void 0:a.blocs)||{},l=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,d&&t.jsx("em",{children:d})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(ut,{k:r.cdSector,v:e.sector}),t.jsx(ut,{k:r.cdStage,v:e.stage}),t.jsx(ut,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ut,{k:r.cdSite,v:e.domain||e.website}),t.jsx(ut,{k:r.cdName,v:e.contactName}),t.jsx(ut,{k:r.cdEmail,v:e.contactEmail}),t.jsx(ut,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ut,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ut,{k:r.cdAngle,v:e.angle}),t.jsx(ut,{k:r.cdDetected,v:wp(e.date,n)})]}),l.some(([,h])=>h)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),l.filter(([,h])=>h).map(([h,p])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:h}),t.jsx("p",{children:p})]},h))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function kp(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d}=Q(),[s,l]=c.useState({}),h=25,p=c.useMemo(()=>n.slice(0,h),[n]);c.useEffect(()=>{p.length&&mo(r,p.map(b=>b.name)).then(l)},[r,p]);const x=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(p.length)}),n.length>h&&t.jsx("span",{className:"mnote dim",children:e.dsCap(h,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),p.map(b=>t.jsx(yp,{o:b,qa:s[b.name]},b.id)),!p.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const jp=50;function Dn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Q(),[i,d]=c.useState(null),[s,l]=c.useState(!1),[h,p]=c.useState(""),[x,u]=c.useState(0),[b,m]=c.useState(""),[w,y]=c.useState(!1),[f,v]=c.useState(0),j=c.useRef(null),k=c.useRef(null),E=()=>{v(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>v(q=>q+1),1e3)},S=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};c.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),k.current&&window.clearInterval(k.current)},[]);const C=async q=>{l(!0),p(""),E();const M=await a();if(l(!1),S(),M.ok){d(M);return}if(M.busy){p(o.alertPreviewBusy);return}if(!q){p(o.alertPreviewFail);return}u(jp),S(),j.current=window.setInterval(()=>{u(R=>R>1?R-1:(j.current&&window.clearInterval(j.current),C(!1),0))},1e3)},L=async()=>{if(n||w||s)return;y(!0),m(""),E();const q=await r();y(!1),S(),m(q.ok?o.alertTestOk(q.sentTo||""):q.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||w||x>0,onClick:()=>{C(!0)},children:s?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||s,onClick:()=>{L()},children:w?o.alertBtnTestBusy:o.alertTest})]}),s&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),h&&t.jsx("p",{className:"mnote warn",children:h}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const xt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ve({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=Q();return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Ep(){const{st:e}=Q();switch(e.modal){case"chain":return t.jsx(Sp,{});case"space":return t.jsx(Cp,{});case"alert":return t.jsx(zp,{});case"queue":return t.jsx(Fp,{});case"export":return t.jsx(Rp,{});case"plug":return t.jsx(Dp,{});case"approach":return t.jsx(Ip,{});case"recharge":return t.jsx(Bp,{});case"cover":return t.jsx(Up,{});case"dossier":return t.jsx($p,{});case"crit":return t.jsx(Wp,{});case"tuto":return t.jsx(Gp,{});case"rdv":return t.jsx(Np,{});case"memoalert":return t.jsx(Op,{});default:return null}}function Np(){const{dispatch:e,fund:a,t:r}=Q(),n=a||r.rdvCoFallback;return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:yo,children:qn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Aa}`,children:Aa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Ls,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Sp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:s,caps:l,memoQueued:h,doAnalyse:p}=Q(),x=i==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,m=u[b],w=b>=u.length;return Ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Ht(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(bt(m.date))].filter(Boolean).map(y=>String(y)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ke(m.engine,o)}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Vt(m.amountEur,o)})]}),De(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Et,{o:m,lg:!0})," ",t.jsx(Pa,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&_e(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&_e(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Tt(m)==="retenu"?"var(--brand)":Tt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Tt(m)==="retenu"?"✓ "+n.kept:Tt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&m&&l.pipe&&Ee(m)===1&&!h.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{p(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&m&&!(x&&_e(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{d(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function Cp(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Q(),i=o==="client",d=c.useMemo(()=>i?r.filter(x=>_e(x)):[],[r,i]),s=c.useMemo(()=>zn(d.filter(x=>Tt(x)==="retenu"),{key:"signal",dir:-1}),[d]),l=c.useMemo(()=>d.filter(x=>Tt(x)==="ecarte"),[d]),h=e.spaceTab==="retenu"?s:l,p=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ve,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:l.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":p},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function zp(){const{mode:e}=Q();return e==="client"||e==="apercu"?t.jsx(Ap,{}):t.jsx(Lp,{})}function Ap(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Q(),[i,d]=c.useState("d"),s=o!=="client";return t.jsxs(Ve,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(qp,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(Tp,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(Zo,{})]})}function qp({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[s,l]=c.useState(!1),[h,p]=c.useState(0);c.useEffect(()=>{let L=!0;return l(!1),nr(a).then(q=>{L&&(q?d(q):l(!0))}),()=>{L=!1}},[a,h]);const x=c.useRef({}),[u,b]=c.useState({}),[m,w]=c.useState(!1),[y,f]=c.useState(!1),v=c.useRef(null);c.useEffect(()=>()=>{v.current&&window.clearTimeout(v.current)},[]);const j=L=>{const q=x.current;Object.keys(q).length&&(w(!0),nr(a,q).then(M=>{if(!M){w(!1),o(e.actErr);return}if(M.throttled&&L<3){v.current=window.setTimeout(()=>j(L+1),5400);return}if(x.current={},b({}),d(M),w(!1),M.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=L=>{r||(x.current={...x.current,...L},b(q=>({...q,...L})),v.current&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>j(1),700))};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const E={...i,...u},S=L=>!E.sections||E.sections.includes(L),C=L=>{const q=E.sections||e.alertSec.map(([M])=>M);k({sections:S(L)?q.filter(M=>M!==L):[...q,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":E.enabled===!0,disabled:r,style:E.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!E.enabled}),children:E.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(E.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[E.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(E.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,q])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:S(L),disabled:r,onChange:()=>C(L)}),t.jsxs("span",{children:[q,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Dn,{label:e.alertPreview,readOnly:r,onPreview:()=>xs(a),onTest:()=>gs(a)}),E.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),E.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",E.email_lead,E.last_sent?` · ${e.updatedAt(E.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Tp({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[s,l]=c.useState(!1),[h,p]=c.useState(0);c.useEffect(()=>{let m=!0;return l(!1),rr(a).then(w=>{m&&(w?d(w):l(!0))}),()=>{m=!1}},[a,h]);const x=m=>{r||rr(a,m).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,w)=>t.jsx("option",{value:w,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Dn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>vs(a),onTest:()=>bs(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Zo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Q(),[d,s]=c.useState(i||""),[l,h]=c.useState(!1),[p,x]=c.useState(!1);c.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,b=c.useMemo(()=>n.filter(f=>De(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||p)){x(!0);try{await fetch(`${Ia}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{x(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Ke(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Ht(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,v])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:v}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Lp(){const{t:e}=Q();return t.jsx(Ve,{title:e.alertTitle,icon:"🔔",children:t.jsx(Zo,{})})}function Fp(){var R,$;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:s,dispatch:l,liveMemos:h}=Q(),[p,x]=c.useState(()=>$a(r)),[u,b]=c.useState(()=>!$a(r)),[m,w]=c.useState([]),[y,f]=c.useState(0),v=n==="client",j=c.useMemo(()=>{const F=new Map;return o.forEach(O=>{const g=(O.name||"").trim().toLowerCase();g&&!F.has(g)&&F.set(g,O)}),F},[o]);c.useEffect(()=>{let F=!0;return(!$a(r)||y>0)&&b(!0),(async()=>{const[O,g]=await Promise.all([Nn(r,y>0),so(a)]);F&&(O&&x(O),b(!1),w(g))})(),()=>{F=!1}},[a,r,y]);const k=u&&!p,E=(p==null?void 0:p.per_day)??0,S=((R=p==null?void 0:p.analyzed_today)==null?void 0:R.length)??0,C=p==null?void 0:p.offre,L=(p==null?void 0:p.pool_meta)||[],q=c.useMemo(()=>{const F=new Map;for(const O of(p==null?void 0:p.scheduled)||[])for(const g of O.names||[])F.has(g)||F.set(g,{label:O.day_label,date:O.date});return F},[p==null?void 0:p.scheduled]),M=(p==null?void 0:p.in_progress)||[];return t.jsxs(Ve,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(S,S+((($=p==null?void 0:p.pool_order)==null?void 0:$.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(E)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(M.length>0||h.items.some(F=>F.status==="boot"||F.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(F=>F.status==="boot"||F.status==="running"||F.status==="error").map(F=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:F.name}),t.jsx("span",{className:"qd",children:F.memoType||""}),t.jsx(Na,{item:F,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+F.name)),M.filter(F=>!h.liveOf(F.name)).map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.name}),t.jsxs("span",{className:"qd",children:[F.memo_type||"",F.age_min?` · ${Math.round(F.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:F.state||""})]},"ip-"+F.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.company}),t.jsxs("span",{className:"qd",children:[F.memo_type,typeof F.est_min=="number"?` · ~${F.est_min} min`:""]}),t.jsx("span",{className:"qt",children:F.status}),F.url&&t.jsx("a",{className:"qgo",href:F.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(F.memo_type)}),v&&F.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{tr(a,F.company,"retry").then(()=>f(O=>O+1))},children:e.queueRetry}),v&&F.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{tr(a,F.company,"delete").then(()=>f(O=>O+1))},children:e.queueDelete})]},F.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((F,O)=>{const g=q.get(F.name),A=j.get((F.name||"").trim().toLowerCase()),U=h.liveOf(F.name),ee=!!(A&&d.has(A.id))||!!(U&&(U.status==="boot"||U.status==="running")),N=!!(A&&Ee(A)===1&&!A.memoUrl)&&!U;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",O+1]}),g?t.jsx("span",{className:"qwhen"+(g.label==="demain"?" soon":""),children:g.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:F.name}),F.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof F.score=="number"&&t.jsx("span",{className:"qs2",children:F.score}),U&&(U.status==="boot"||U.status==="running")&&t.jsx(Na,{item:U,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),N&&(s.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>l({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:ee,onClick:()=>{i(A),f(I=>I+1)},children:ee?e.actAnalyseQueued:e.actAnalyse})),F.excerpt&&t.jsx("span",{className:"qex",children:F.excerpt})]},F.name+":"+O)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([F,O])=>t.jsxs("li",{children:[t.jsx("b",{children:F})," — ",O]},F))})]})}function Rp(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=Q(),s=`${xt}/cibles/list.csv?token=${a}`,l=`${xt}/cibles/list.json?token=${a}`,h=`${xt}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${s}")`,x=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:p},{def:e.exportLive,value:l,href:l},{def:e.exportXlsx,value:h,href:h}],b=!o.lockActions&&n.length>0,m=()=>{vp(bp(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ve,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:f,href:v})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),v&&t.jsx("a",{className:"exb",href:v,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Op(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Q(),i=o!=="client",[d,s]=c.useState(null),[l,h]=c.useState(!1),[p,x]=c.useState(0),[u,b]=c.useState(!1);c.useEffect(()=>{let f=!0;return h(!1),Zn(a).then(v=>{f&&(v?s(v):h(!0))}),()=>{f=!1}},[a,p]);const m=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=f=>{if(i||!d)return;const v={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??m()};b(!0),Zn(a,v).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(l)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(Ve,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Mp,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>w({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||u,onChange:()=>w({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:v})]},f))}),t.jsx(Dn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>is(a,y),onTest:()=>os(a,y)})]})}function Mp({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=c.useState(e);c.useEffect(()=>{d(e)},[e]);const s=i.trim()!==e.trim(),l=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&s&&l&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!l,onClick:()=>o(i.trim()),children:n})]})]})}function Dp(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Q(),[i,d]=c.useState(null),[s,l]=c.useState(!1),[h,p]=c.useState(null),[x,u]=c.useState(!1),[b,m]=c.useState(""),[w,y]=c.useState(0),[f,v]=c.useState("webhook"),[j,k]=c.useState(""),E=c.useRef(!1);c.useEffect(()=>{let R=!0;return l(!1),er(a).then($=>{R&&($?d({configured:$.configured,url_hint:$.url_hint}):l(!0))}),ps(a).then($=>{if(R){if(!$){u(!0);return}u(!1),p($),E.current||(E.current=!0,$.destination==="instantly"&&v(F=>F==="webhook"?"instantly":F),$.campaign_id&&k(F=>F||$.campaign_id||""))}}),()=>{R=!1}},[a,w]);const S=(R,$)=>{o&&er(a,R).then(F=>{if(!F||F.ok===!1){n(e.actErr);return}R.test&&F.sent===!1?n(e.plugTestThrottled):r($),y(O=>O+1)})},C='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',L=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),q=`curl -X POST ${xt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,M=`curl -X POST ${xt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ve,{title:e.plugTitle,icon:"🔌",wide:!0,children:[h&&t.jsx("p",{className:"mnote"+(h.enabled?" warn":""),children:h.enabled?e.plugAutoOn(h.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>y(R=>R+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:R=>m(R.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>S({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>S({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>S({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(_p,{destKind:f,setDestKind:v,camp:j,setCamp:k,whHint:i!=null&&i.configured?i.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(Pp,{auto:h,autoKo:x,destKind:f,camp:j,onRetry:()=>y(R=>R+1),onDone:R=>{p(R),u(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:q}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(q).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Ip(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:s}=Q(),l=c.useMemo(()=>r.find(g=>g.id===n.approachId)||null,[r,n.approachId]),[h,p]=c.useState("email"),[x,u]=c.useState(0),[b,m]=c.useState({}),[w,y]=c.useState(!1),[f,v]=c.useState(""),[j,k]=c.useState({});if(c.useEffect(()=>{!l||b[h]||w||(y(!0),v(""),ds(a,l.name,h).then(g=>{if(y(!1),!g||g.ok===!1){v((g==null?void 0:g.error)||e.apprFail);return}m(A=>({...A,[h]:g}))}))},[l,h,a]),!l)return null;const E=b[h],S=(E==null?void 0:E.sequence)||[],C=S[x],L=g=>`${h}|${x}|${g}`,q=g=>{const A=L(g);return A in j?j[A]:String(((C==null?void 0:C[g])??"")||"")},M=(g,A)=>k(U=>({...U,[L(g)]:A})),R=L("subject")in j||L("body")in j||L("message")in j,$=q(h==="email"?"body":"message"),F=q("subject"),O=h==="email"&&F?`${F}

${$}`:$;return t.jsxs(Ve,{title:e.apprT(l.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(g=>t.jsx("button",{type:"button",className:"apch"+(h===g?" on":""),"aria-pressed":h===g,onClick:()=>{p(g),u(0)},children:g==="email"?e.apprChEmail:e.apprChLi},g)),t.jsx("span",{className:"sp"}),S.map((g,A)=>t.jsxs("button",{type:"button",className:"apday"+(x===A?" on":""),"aria-pressed":x===A,onClick:()=>u(A),children:[g.day||`J${A}`,[`${h}|${A}|subject`,`${h}|${A}|body`,`${h}|${A}|message`].some(U=>U in j)&&t.jsx("i",{children:"✎"})]},g.day||A))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,E!=null&&E.sender?" · "+e.apprSender(E.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!w&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(g=>{const A={...g};return delete A[h],A}),v("")},children:e.retry})]}),!w&&!f&&!C&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),C&&t.jsxs(t.Fragment,{children:[h==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:F,onChange:g=>M("subject",g.target.value)})]}),h==="linkedin"&&x===0&&(E==null?void 0:E.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:$,onChange:g=>M(h==="email"?"body":"message",g.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var g;(g=navigator.clipboard)==null||g.writeText(O).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),h==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(l.contactEmail||"")}?subject=${encodeURIComponent(F)}&body=${encodeURIComponent($)}`,children:e.apprMailto}),R&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Pp({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:s,flash:l,flashErr:h,canWrite:p}=Q(),[x,u]=c.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,y=()=>{if(x||!p||m)return;u(!0),(b?ar(s,!1):ar(s,!0,r,n.trim()||void 0)).then(v=>{if(u(!1),!v){h(d.actErr);return}o(v),l(v.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!p||!!m,title:m||void 0,onClick:y,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),m===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function _p({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:s,canWrite:l}=Q(),[h,p]=c.useState("valides"),[x,u]=c.useState(!1),[b,m]=c.useState(null),[w,y]=c.useState(null),[f,v]=c.useState(!1),[j,k]=c.useState(!1),[E,S]=c.useState(null),[C,L]=c.useState(null),q=`atl2:bulk:${d}:${h}:${e}`;c.useEffect(()=>{m(null),y(null),v(!1),S(null);try{const I=localStorage.getItem(q)||localStorage.getItem(`atl2:bulk:${d}:${h}`),D=JSON.parse(I||"null");L(D&&Date.now()-Date.parse(D.t)<24*3600*1e3?D:null)}catch{L(null)}},[q,h,d]);const M=e==="instantly"&&!r.trim(),R=`${h}|${e}|${r.trim()}`,$=async()=>{if(M||!l)return;u(!0),v(!1),S(null);const I=await fs(d,h,e,r.trim()||void 0);m(I),y(I.ok?R:null),u(!1)},F=c.useRef(!1);if(!l)return null;const O=async()=>{if(F.current||!l)return;F.current=!0,k(!0);const I=`${d}:${h}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let D;try{D=await hs(d,h,e,r.trim()||void 0,I)}finally{F.current=!1}if(k(!1),v(!1),S(D),D.ok&&(D.pushed||0)>0){const B={t:new Date().toISOString(),n:D.pushed||0};L(B);try{localStorage.setItem(q,JSON.stringify(B))}catch{}}};f&&w!==null&&w!==R&&v(!1);const g=o,A=b!=null&&b.ok&&b.ready||0,U=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":g||"",ee=!!(b!=null&&b.ok)&&w===R&&A>0&&!!U&&!C,N=C?new Date(C.t).toLocaleString(s==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:h,onChange:I=>p(I.target.value),children:i.plugBulkTabs.map(([I,D])=>t.jsx("option",{value:I,children:D},I))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:I=>a(I.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:I=>n(I.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||M,onClick:()=>{$()},children:x?"…":i.plugBulkPreview})]}),M&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),C&&t.jsx("p",{className:"mnote",children:i.bulkLocked(N,C.n)}),!C&&!!(b!=null&&b.ok)&&!U&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!C&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),ee&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:i.bulkArm}),ee&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(A,U)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{O()},children:j?i.bulkSending:i.bulkConfirm(U)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>v(!1),children:i.bulkCancel})]}),E&&(E.ok?E.replayed?t.jsx("p",{className:"mnote",children:E.pending?i.bulkPending:i.bulkReplayed}):(E.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(E.pushed||0,E.linkedinReady||0,E.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:E.error||i.actErr}))]})}function Bp(){const{t:e,data:a,lang:r}=Q(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const s=window.location.href.split("?")[0];try{const h=await(await fetch(`${Ia}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Ve,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(d.credits,d.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function $p(){const{t:e}=Q();return t.jsx(Ve,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(kp,{})})}function Up(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:s}=Q(),[l,h]=c.useState(null),[p,x]=c.useState(!1);c.useEffect(()=>{let q=!0;if(i)return Nn(i).then(M=>{q&&M&&typeof M.per_day=="number"&&h(M.per_day)}),()=>{q=!1}},[i]);const[u,b]=c.useState(null);c.useEffect(()=>{if(!o)return;let q=!0;return ls(o).then(M=>{q&&b(M)}),()=>{q=!1}},[o]);const m=r.stats,w=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(q=>q.kind==="target"&&_e(q)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(w/y*100)):null,v=(m==null?void 0:m.window_days)||30,j=w>0?w/v:0,k=y>0?Math.max(0,y-w):0,S=y>0&&j>0&&w>=100?Math.round(k/j):null,C=q=>Math.round(q).toLocaleString(a==="en"?"en-US":"fr-FR"),L=q=>{p||!d||(x(!0),us(o,q).then(M=>{if(x(!1),M===null){s(e.actErr);return}h(M),s(e.alertSaved)}))};return t.jsxs(Ve,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(w))}),y>0&&t.jsx("span",{children:e.covOf(C(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),S!==null&&t.jsx("p",{className:"mnote",children:e.covEta(S)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(j))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((q,M)=>t.jsxs("tr",{className:q.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[q.code,q.geo?` · ${q.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof q.n=="number"?C(q.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:q.source}),q.elargi&&t.jsx("em",{children:e.covWide(String(q.demande||""))}),q.erreur&&t.jsx("em",{children:e.covMissing})]})]},M)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(u.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&l!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(l)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(q=>t.jsx("button",{type:"button",className:l===q?"on":"",disabled:p,onClick:()=>L(q),children:q===0?"⏸":q},q))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function ei(e,a,r){const n=await fetch(`${xt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${xt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Hp(){const{t:e,token:a,canWrite:r}=Q(),[n,o]=c.useState(null),[i,d]=c.useState(""),[s,l]=c.useState(""),[h,p]=c.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=c.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(x)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(c.useEffect(()=>{if(!r)return;let m=!0;return cs(a).then(w=>{m&&o(w)}),()=>{m=!1}},[a,r]),!r||h||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),ei(a,n.instruction||"","atelier2-avis").then(m=>{if(d(m.applied?"ok":"ko"),m.applied||l(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:s||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{p(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Vp(){var E;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=Q(),[i,d]=c.useState(!1),[s,l]=c.useState(null),[h,p]=c.useState(!1),[x,u]=c.useState([]),[b,m]=c.useState(null),[w,y]=c.useState([]);if(!r)return null;const f=()=>{d(!0),p(!1),u([]),y([]),ms(a).then(S=>{if(d(!1),!S){p(!0),l(null);return}l(S)})},v=S=>{b||(m(S.title),ei(a,S.instruction,"atelier2-prop").then(C=>{m(null),C.applied?(y(L=>[...L,S.title]),n(e.propApplied)):C.encours?n(e.propSlow):o(C.reply||e.propApplyFail)}))},j=((s==null?void 0:s.proposals)||[]).filter(S=>!x.includes(S.title)&&!w.includes(S.title)),k=((E=s==null?void 0:s.counts)==null?void 0:E.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&h&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!h&&s&&!(s.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:s.reason==="not_enough_signals"?e.propFew(k):e.propNone}),j.map(S=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[S.section]||S.section}),t.jsx("p",{className:"propt",children:S.title}),S.why&&t.jsx("p",{className:"mnote dim",children:S.why}),S.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",S.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>v(S),children:b===S.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(C=>[...C,S.title]),children:e.propSkip})]})]},S.title))]})}function Wp(){var f,v,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:s}=Q(),l=n==="client",h=c.useMemo(()=>{const k=new Set;return a.forEach(E=>{E.angle&&k.add(E.angle)}),[...k]},[a]),[p,x]=c.useState(""),[u,b]=c.useState(""),[m,w]=c.useState(!1),y=async()=>{const k=p.trim();if(!(!k||m||!l)){w(!0),b("");try{const S=await(await fetch(`${xt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&b(String(S.reply)),S.job_id){b(e.critChatRunning);const C=async()=>{const L=await fetch(`${xt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(q=>q.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),w(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||w(!1)}}};return t.jsxs(Ve,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((v=i==null?void 0:i.angles)!=null&&v.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var E,S;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((E=k.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((S=k.out)!=null&&S.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},k.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(Hp,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:p,disabled:!l||m,onChange:k=>x(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!l||m||!p.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Vp,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ss,{fund:d,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Ko[k]||"v-cons"),children:k}),t.jsx("span",{children:E})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",E]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Gp(){const{t:e,dispatch:a,startTour:r}=Q(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ve,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const ti="atl2:mapfold",Yp=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(ti);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Qp=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},ai=c.createContext(null),Q=()=>{const e=c.useContext(ai);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Et({o:e,lg:a}){const{lang:r}=Q(),n=De(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:or(n,r),children:[n.emoji," ",or(n,r)]}):null}function Pa({o:e,src:a}){const{lang:r,t:n}=Q(),o=De(e);if(!o)return null;const i=Ns(o),d=Ss(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(fo(o,r))+" · "+n.win7(ho(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,l)=>t.jsx("i",{className:l<i?"on":""},l))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Kp(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ue(a);if(o)return e.find(i=>Ue(i.name)===o)||e.find(i=>{const d=Ue(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Jp(){const{scoped:e,t:a,st:r,dispatch:n}=Q(),o=c.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!Ye(x)),s=d.length,l=d.filter(x=>!x.noCo).length,h=d.filter(x=>!!x.noCo).length,p=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:p?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:s}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",l," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function Xp(){const{t:e,lang:a,data:r,dispatch:n}=Q(),o=r.stats,i=s=>s.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const d=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:d>0?e.covOf(i(d)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function ni({o:e}){const{lang:a}=Q(),r=Es(e.cc),n=e.cc?Ht(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Zp=!1;function ec(){const[e,a]=c.useState(!1);return c.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ri=e=>`atl2:tour:${e||"anon"}`;function tc(e){try{return localStorage.getItem(ri(e))==="1"}catch{return!0}}function to(e){try{localStorage.setItem(ri(e),"1")}catch{}}function ac(e,a,r,n,o,i,d,s){const l=e.tourT,h=e.howto;return[{sel:".atl2 .ident",title:l.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:l.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:l.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:l.live,body:e.fhintLive},{sel:".atl2 .goal",title:l.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:l.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:l.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:l.tuto,body:h[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:l.demand,body:h[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:l.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:l.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:l.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:l.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:l.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:l.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:l.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:l.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,...[2,4,5].filter(p=>(s[p]||0)>0).map(p=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:p===2?l.tabAna:p===4?l.tabValid:l.tabRej,body:p===2?e.fhintTabAna:p===4?e.fhintTabValid:e.fhintTabRej,ptab:p})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:l.rank,body:e.fhintRank},{sel:".atl2 .learn",title:l.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:l.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:l.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:l.tools,body:h[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:l.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:l.crit,body:h[0][0],modal:"crit"}].filter(Boolean)}function sc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Pn;const{lang:d}=ws(),s=Gs[d],l=il(e,d,a),[h,p]=c.useReducer(dl,void 0,()=>sl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Qp():Yp()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=c.useRef(!0);c.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(ti,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),c.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const z=()=>{window.innerWidth<=760&&p({type:"mapFold",folded:!0})};return z(),window.addEventListener("resize",z),()=>window.removeEventListener("resize",z)},[a]);const u=c.useRef(i);u.current=i,c.useEffect(()=>{var z;(z=u.current)==null||z.call(u,h.filters)},[h.filters]);const[b,m]=c.useState(()=>{if(typeof window>"u")return"both";try{const z=localStorage.getItem("atl2:chrome-mode");if(z==="eval"||z==="filt"||z==="both")return z;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,y]=c.useState(null),[f,v]=c.useState(null),[j,k]=c.useState(null),[E,S]=c.useState({kept:0,dropped:0}),[C,L]=c.useState(!1),[q,M]=c.useState(""),[R,$]=c.useState(!1),[F,O]=c.useState(null),[g,A]=c.useState(null),[U,ee]=c.useState(!1),[N,I]=c.useState(!1),[,D]=c.useState(0),B=()=>D(z=>z+1),te=c.useRef([]),ae=c.useRef(new Set),be=c.useRef(new Set),[J,he]=c.useState([]),[ue,ge]=c.useState([]),[_,K]=c.useState(0),V=c.useRef(new Map),ne=c.useRef(null),{mode:H}=l,se=c.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),le=se.pipe,oe=l.session.token||"",re=H==="client"&&!e;c.useEffect(()=>{if(!oe||!le)return;let z=!0;const Y=async()=>{const fe=await Cs(oe);!z||!fe||(ge(fe.runs),K(Date.now()/1e3-fe.now),he(Te=>Te.filter(ke=>!fe.runs.some($e=>Ue($e.company)===Ue(ke.name)))))};Y();const G=J.length>0||ue.some(fe=>fe.status==="running"),ie=window.setInterval(()=>{Y()},G?8e3:25e3);return()=>{z=!1,window.clearInterval(ie)}},[oe,le,J.length,ue.some(z=>z.status==="running")]),c.useEffect(()=>{if(!oe||!le||!re)return;let z=!0;const Y=async()=>{const ie=await zs(oe);if(!z||!ie.length)return;const fe=new Map;ie.forEach(Te=>{const ke=String(Te.ceo_status||"").trim();ke&&Te.check_id&&fe.set(String(Te.check_id),ke)}),l.patchStatuses(fe,Te=>Date.now()-(qe.current.get(Te)||0)>9e4)};Y();const G=window.setInterval(()=>{Y()},6e4);return()=>{z=!1,window.clearInterval(G)}},[oe,le,re]);const we=c.useMemo(()=>{const z=[],Y=new Set;for(const G of J){const ie=Ue(G.name);!ie||Y.has(ie)||(Y.add(ie),z.push({name:G.name,id:G.id,status:"boot",started:G.started,estMin:G.estMin,memoType:"instant"}))}for(const G of ue){const ie=Ue(G.company);if(!ie||Y.has(ie))continue;Y.add(ie);const fe=G.status==="error"?"error":G.status==="done"?"done":"running";z.push({name:G.company,status:fe,started:G.started||0,estMin:G.est_min||(G.memo_type==="detailed"?40:15),url:G.url,error:G.error,memoType:G.memo_type,note:G.note})}return z},[J,ue]),me=z=>we.find(Y=>Ue(Y.name)===Ue(z))||null,We=(z,Y)=>{he(G=>G.some(ie=>Ue(ie.name)===Ue(z.name))?G:[...G,{name:z.name,id:z.id,started:Date.now()/1e3,estMin:Y==="detailed"?40:15}]),ae.current.add(z.id),B()},ye=(z,Y=!1)=>{M(z),$(Y),ne.current&&clearTimeout(ne.current),ne.current=setTimeout(()=>M(""),Y?4200:2400)},Ce=z=>ye(z,!0),Ne=c.useMemo(()=>{const z=new Map;return l.dossiers.forEach(Y=>{Y.id&&z.set(Y.id,Y)}),z},[l.dossiers]),Oe=c.useMemo(()=>l.dossiers.filter(z=>ta(z,h,le)),[l.dossiers,h,le]),vt=c.useRef(!1);c.useEffect(()=>{if(vt.current||e||l.loading||!l.dossiers.length)return;if(!se.showFunnel||tc(l.session.token||"")){vt.current=!0;return}vt.current=!0;const z=window.setTimeout(()=>{to(l.session.token||""),ee(!0)},700);return()=>window.clearTimeout(z)},[e,l.loading,l.dossiers.length,se.showFunnel,l.session.token]);const lt=c.useMemo(()=>l.dossiers.filter(z=>pl(z,h,le,l.favIds)),[l.dossiers,h,le,l.favIds]),Me=c.useMemo(()=>ys(Oe.filter(z=>!Ge(z)),l.favIds),[Oe,l.favIds]),Se=c.useRef(!1);c.useEffect(()=>{if(Se.current)return;if(!le||a==="ops"){Se.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Se.current=!0;return}if(l.loading)return;Se.current=!0;const z=ks(Me);z!==h.ptab&&p({type:"ptab",tab:z})},[le,a,n==null?void 0:n.ptab,l.loading,Me,h.ptab]);const rt=c.useMemo(()=>{const z=jo(l.dossiers);return z?bt(z)===0?s.tourToday:Eo(z,d):s.tourNoRun},[l.dossiers,s,d]),He=c.useMemo(()=>l.dossiers.some(z=>!!z.memoUrl||!!z.summary||Pt(z)),[l.dossiers]),[wt,ot]=c.useState(!1);c.useEffect(()=>{if(l.loading){ot(!1);return}if(l.dossiers.length>0||l.error){ot(!0);return}const z=window.setTimeout(()=>ot(!0),6e3);return()=>window.clearTimeout(z)},[l.loading,l.dossiers.length,l.error]);const St=(l.marketEstimate||0)>0||typeof((Pn=l.stats)==null?void 0:Pn.screened)=="number"&&l.stats.screened>0,Ct=c.useMemo(()=>[1,0,2,4,5,3].find(z=>(Me[z]||0)>0)??0,[Me]),Je=Sn.find(z=>z.key===h.continent),yt=h.continent==="monde"?s.contWorld:(d==="fr"?Je==null?void 0:Je.fr:Je==null?void 0:Je.en)||"";c.useEffect(()=>{const z=Y=>{var ie;const G=(((ie=Y.detail)==null?void 0:ie.name)||"").trim();G&&zt(null,G)};return window.addEventListener("ppmap:evaluate",z),()=>window.removeEventListener("ppmap:evaluate",z)}),c.useEffect(()=>{const z=Y=>{const G=Y.detail||{},ie=String(G.id||"").trim(),fe=String(G.name||"").trim(),Te=String(G.url||"").trim(),ke=ie&&Ne.get(ie)||Kp(l.dossiers,fe,Te);if(ke){if(v(null),ta(ke,h,le)||(h.continent!=="monde"&&ke.continent!==h.continent&&p({type:"continent",key:ke.continent||"monde"}),p({type:"reset"})),le&&ke.kind!=="op"){const pt=Ee(ke);typeof pt=="number"&&pt!==h.ptab&&p({type:"ptab",tab:pt})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),p({type:"focus",id:ke.id}),(ke.noCo||["media","nominations","recrutements"].includes(ke.engine||""))&&(ke.url||ke.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:ke.url||"",text:[ke.headline,ke.tagline].filter(Boolean).join(`
`)}})):ke.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ke.name,url:ke.url||"",website:ke.website||"",domain:ke.domain||""}}));return}!fe&&!Te||(p({type:"focus",id:ie||null}),v({name:fe,headline:String(G.text||"").trim()||fe,url:Te,card:G.card}),Te&&(Sa(fe)||!fe)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Te,text:String(G.text||"").trim()}})):fe&&!Sa(fe)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:fe}})))};return window.addEventListener("ppmap:focus",z),()=>window.removeEventListener("ppmap:focus",z)}),c.useEffect(()=>{const z=ie=>{const fe={},Te=String((ie==null?void 0:ie.sector)||"").trim();Te&&(fe.sector=[Te]);const ke=String((ie==null?void 0:ie.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(ke)&&(fe.day=ke);const $e=String((ie==null?void 0:ie.search)||"").trim();$e&&(fe.search=$e);const pt=String((ie==null?void 0:ie.dealKind)||"").trim();(pt==="ma"||pt==="levee"||pt==="other")&&(fe.dealKind=[pt]),Object.keys(fe).length&&p({type:"filters",patch:fe})},Y=ie=>z(ie.detail),G=ie=>{ie.data&&ie.data.type==="pp-filter"&&z(ie.data)};return window.addEventListener("ppmap:filter",Y),window.addEventListener("message",G),()=>{window.removeEventListener("ppmap:filter",Y),window.removeEventListener("message",G)}},[]),c.useEffect(()=>{const z=Y=>{var fe;const G=(((fe=Y.detail)==null?void 0:fe.name)||"").trim().toLowerCase();if(!G)return;const ie=l.dossiers.find(Te=>(Te.name||"").trim().toLowerCase()===G);ie&&p(a==="ops"?{type:"focus",id:ie.id}:{type:"popup",id:ie.id})};return window.addEventListener("ppmap:similar",z),()=>window.removeEventListener("ppmap:similar",z)});const zt=(z,Y,G)=>{const ie=(G||(z==null?void 0:z.name)||Y||"").trim();if(!re){k({kicker:ie});return}!ie||C||(L(!0),(async()=>{try{let fe=(Y||ie).trim();const Te=((z==null?void 0:z.website)||(z==null?void 0:z.domain)||"").trim();if(!(/^https?:\/\//i.test(fe)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(fe)&&!/\s/.test(fe)))if(Te)fe=Te;else try{const Re=await Cn(ie);if(Re!=null&&Re.website)fe=Re.website;else if(((Re==null?void 0:Re.candidates)||[]).length===1)fe=Re.candidates[0].url;else if(((Re==null?void 0:Re.candidates)||[]).length>1){te.current=[{name:ie,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Re.candidates||[]).slice(0,5)},...te.current].slice(0,8),B();return}}catch{}const $e=await po(oe,fe,"atelier2"),pt={name:$e.company||ie,verdict:$e.verdict,reason:$e.reason||"",remaining:$e.remaining??null};te.current=[pt,...te.current].slice(0,8),$e.verdict==="kept"&&S(Re=>({...Re,kept:Re.kept+1})),$e.verdict==="ruled_out"&&S(Re=>({...Re,dropped:Re.dropped+1}));const Wt=z||l.dossiers.find(Re=>(Re.name||"").toLowerCase()===ie.toLowerCase());Wt&&($e.verdict==="kept"?Wt.verdict=Wt.verdict||"MATCH":$e.verdict==="ruled_out"&&(Wt.verdict="NO MATCH"),$e.reason&&(Wt.reasoning=$e.reason)),B()}finally{L(!1)}})())},Mt=z=>{if(!re){k({kicker:z.name});return}We(z,"instant"),kt(oe,"fast_request",z.name||"",""),ye(s.memoInstantSent(z.name))},Ie=z=>V.current.get(z.id)??l.thumbs.get((z.name||"").trim().toLowerCase()),it=(z,Y)=>p({type:"undoPush",entry:{id:z.id,name:z.name,prevCeoStatus:Y}}),Pe=async(z,Y,G)=>{const ie=z.ceoStatus||"";qe.current.set(z.id,Date.now()),z.ceoStatus=Y,B();const fe=await Ua(oe,{status:Y,airtable_id:z.airtableId,check_id:z.checkId,company:z.name,...(G==null?void 0:G.note)!==void 0?{note:G.note}:{},...G!=null&&G.via?{via:G.via}:{}});return fe.ok?fe.skipped?(z.ceoStatus=ie,B(),Ce(s.actNotPersisted),!1):((G==null?void 0:G.undo)!==!1&&it(z,ie),G!=null&&G.msg&&ye(G.msg),(Y==="Validé"||Y==="Écarté")&&!z.ceoNote&&(G==null?void 0:G.note)===void 0&&O({o:z,yes:Y==="Validé"}),!0):(z.ceoStatus=ie,B(),Ce(s.actErr),!1)},T=async(z,Y)=>{const G=await Ua(oe,{status:z.ceoStatus||"Retenu",airtable_id:z.airtableId,check_id:z.checkId,company:z.name,note:Y,via:"note"});return!G.ok||G.skipped?(Ce(G.skipped?s.actNotPersisted:s.actErr),!1):(z.ceoNote=Y,B(),!0)},W=c.useRef(new Map),X=z=>W.current.has(z.id)?W.current.get(z.id):l.stages.get((z.name||"").trim().toLowerCase()),pe=(z,Y)=>{W.current.set(z.id,Y),B()},P=(z,Y)=>{re&&Pe(z,Y?"Validé":"Écarté",{msg:Y?s.decidedYes(z.name):s.decidedNo(z.name)})},Z=z=>{re&&Pe(z,"À trancher",{msg:s.promoted(z.name)})},de=z=>{re&&(async()=>{const Y=z.ceoStatus||"";z.ceoStatus="Retenu",B();const G=await Ua(oe,{status:"Retenu",check_id:z.checkId,company:z.name});if(!G.ok||G.skipped){z.ceoStatus=Y,B(),Ce(G.skipped?s.actNotPersisted:s.actErr);return}it(z,Y),ye(s.repeched(z.name))})()},xe=()=>{const z=h.undo[h.undo.length-1];if(!z){ye(s.undoNone);return}const Y=Ne.get(z.id);if(!Y){p({type:"undoPop"}),ye(s.undoNone);return}let G=z.prevCeoStatus;if(!G)if((Y.verdict||"").toUpperCase().includes("CALL"))G="À trancher";else{ye(s.undoLockedTitle);return}(async()=>await Pe(Y,G,{undo:!1})&&(p({type:"undoPop"}),Y.ceoStatus=z.prevCeoStatus,B(),ye(s.undoDone(Y.name))))()},ce=z=>{re&&(be.current.add(z.id),B(),p({type:"approachOpen",id:z.id}),kt(oe,"approach",z.name||"",""))},qe=c.useRef(new Map),Be=c.useRef(!1),[Ae,dt]=c.useState(0);c.useEffect(()=>{if(!oe||e||!re||Be.current)return;Be.current=!0;const z=new Date().toISOString().slice(0,10),Y=`atl2:vue:${oe}:${z}`;try{if(localStorage.getItem(Y))return}catch{}kt(oe,"view","","").then(G=>{if(!G.ok){Be.current=!1;return}try{localStorage.setItem(Y,"1")}catch{}})},[oe,e]),c.useEffect(()=>{if(!oe||!le||e||!re||!l.generatedAt)return;let z=!0;const Y=()=>{document.hidden||As(oe,l.generatedAt||"").then(ie=>{z&&dt(ie)})};Y();const G=window.setInterval(Y,6e4);return()=>{z=!1,window.clearInterval(G)}},[oe,le,e,l.generatedAt]);const Xe=(z,Y)=>{re&&(async()=>{if(!(await kt(oe,Y?"yes":"no",z.name||"",(z.ceoNote||"").slice(0,400),z.sector||"")).ok){Ce(s.actErr);return}V.current.set(z.id,Y?"yes":"no"),B(),ye(Y?s.thumbUpDone:s.thumbDnDone),A({o:z,up:Y})})()},da=z=>{!re||!Pt(z)||(We(z,"detailed"),kt(oe,"detailed_request",z.name||"",""),ye(s.memoDeepSent(z.name)))},oi=z=>{!re||!z.memoUrl||window.confirm(s.memoRegenAsk(z.name))&&(We(z,"detailed"),kt(oe,"detailed_regen",z.name||"",""),ye(s.memoDeepSent(z.name)))},ii=z=>{const Y=new Set(l.favIds),G=Y.has(z.id);G?Y.delete(z.id):Y.add(z.id),l.setFavIds(Y),re&&qs(oe,{id:z.id,co:z.name},G)},si=()=>{!re||N||window.confirm(s.identSyncConfirm)&&(I(!0),(async()=>{const z=await Ts(oe);I(!1),z?ye(s.identSyncDone):Ce(s.actErr)})())},In=/proplace/i.test(l.fund||""),li=z=>{!re||!In||(kt(oe,"onboard_request",z.name||"",""),ye(s.onboardSent(z.name)))},di={st:h,dispatch:p,t:s,lang:d,mode:H,caps:se,pipe:le,token:oe,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:de,thumbOf:Ie,canWrite:re,commitStatus:Pe,saveNote:T,stageOf:X,setStage:pe,flashErr:Ce,startTour:()=>ee(!0),dossiers:l.dossiers,scopedAll:Oe,scoped:lt,counts:Me,byId:Ne,contName:yt,favIds:l.favIds,toggleFav:ii,askEvaluate:zt,doAnalyse:Mt,doDecide:P,doPromote:Z,doApproach:ce,doThumb:Xe,doDeep:da,doRegen:oi,doUndo:xe,doSync:si,doOnboard:li,outbound:In,memoQueued:ae.current,liveMemos:{items:we,serverOff:_,liveOf:me},approachDone:be.current,sessTally:E,evalCards:te.current,evalBusy:C,markRow:y,markedId:w,flash:ye,focusExtra:f};c.useEffect(()=>{const z=Y=>{Y.key==="Escape"&&(p({type:"popup",id:null}),p({type:"modal",modal:null}),p({type:"openFacet",facet:null}))};return window.addEventListener("keydown",z),()=>window.removeEventListener("keydown",z)},[]);const pi=z=>oe?t.jsx(ml,{token:oe,children:z}):t.jsx(t.Fragment,{children:z});return t.jsx(ai.Provider,{value:di,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(oe?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Xs}),pi(t.jsxs("div",{className:"app"+(le?" pipe":"")+(oe?" has-thesis":""),children:[se.showTicker&&t.jsx(st,{name:"live",children:t.jsxs("div",{className:"live-stack"+(oe?" live-stack--cibles":""),children:[t.jsx(wl,{}),!!oe&&t.jsx(fl,{})]})}),se.showIdent&&t.jsx(st,{name:"identite",children:t.jsx(Tl,{})}),!1,Zp,se.showFunnel&&t.jsx(st,{name:"entonnoir",children:t.jsx(nc,{})}),!h.mapFolded&&t.jsx(st,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Ho,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Jp,{}),a!=="ops"&&se.showFunnel&&t.jsx(Xp,{}),t.jsx(Ad,{}),t.jsx(Uo,{})]})]})}),se.showDemand&&le&&t.jsx(st,{name:"direct",children:t.jsx(Ms,{items:we,serverOff:_,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>p({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([z,Y])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===z,onClick:()=>{m(z);try{localStorage.setItem("atl2:chrome-mode",z)}catch{}},children:Y},z))}),se.showDemand&&t.jsx(st,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Dd,{})})}),se.showDemand&&h.memoConsole&&t.jsx(st,{name:"console",children:t.jsx(Pd,{})}),se.pipe&&!!oe&&t.jsx(st,{name:"moteurs",children:t.jsx(Hs,{})}),Ae>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{dt(0),l.refresh()},children:s.freshGo})]}),t.jsx(st,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(gp,{})}),se.pipe&&!!oe&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(st,{name:"fiche",children:t.jsx(Zd,{})}),t.jsx(st,{name:"modales",children:t.jsx(Ep,{})}),t.jsx(jl,{}),g&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:g.o.name}),t.jsx(xr,{placeholder:g.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:z=>{const Y=g.o;A(null),z&&kt(oe,"note",Y.name||"",z,Y.sector||"").then(G=>{G.ok&&ye(s.csNoteSaved)})}})]}),F&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:F.o.name}),t.jsx(xr,{placeholder:F.yes?s.whyYesPh:s.whyNoPh,onDone:z=>{const Y=F.o;O(null),z&&T(Y,z).then(G=>{G&&ye(s.csNoteSaved)})}})]}),U&&wt&&t.jsx(Al,{steps:ac(s,rt,He,Ct,St,Me[3]||0,Me[4]||0,Me),onClose:()=>{ee(!1),to(oe)}}),t.jsx(ec,{}),se.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:yo,children:qn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Aa}`,children:Aa})]}),t.jsx("button",{type:"button",onClick:()=>p({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),q&&t.jsx("div",{className:"flash on"+(R?" err":""),children:q}),j&&t.jsx(js,{variant:"acquirer",initialCompany:ao().co,initialWebsite:ao().site,onClose:()=>k(null)})]})})}function nc(){const{t:e}=Q(),[a,r]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function ao(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function rc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{ni as FlagCell,Et as SigBadge,Pa as SigWin,sc as default,rc as fmtShort,Q as useV2};
