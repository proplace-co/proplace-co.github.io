...
.atl2 .bulk .side .hint{white-space:nowrap}`,Vo=`
...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Ho=_o+Vo;function da(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Wo(){const e=da("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Yo(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Wo();return r==="0"?"client":r==="1"||da("embed")==="1"&&da("chrome")==="1"?"apercu":"client"}const Go={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ko=e=>Go[e];function Qo(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Ye=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!In(a)||Qo(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Yr(e.cc)})};function Xt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Jo=60*60*1e3;function Xo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Jo?null:a}catch{return null}}function Et(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Zo=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ei(e,a,r="default"){const n=r!=="default",i=x.useMemo(()=>e||n?{mode:"anon"}:Dr(),[e,n]),o=x.useMemo(()=>n?"visiteur":Yo(e,i),[e,i,n]),l=x.useMemo(()=>Ko(o),[o]),s=o!=="visiteur",c=Zo(r),[h,d]=x.useState([]),[m,u]=x.useState(""),[b,p]=x.useState(null),[g,v]=x.useState(null),[f,y]=x.useState(null),[S,w]=x.useState(()=>new Map),[E,z]=x.useState(()=>new Map),[A,T]=x.useState(""),[j,M]=x.useState(new Set),[q,B]=x.useState(null),[H,k]=x.useState(!0),[N,R]=x.useState(!1),[V,G]=x.useState(0),[X,L]=x.useState(0),O=x.useRef(0),$=x.useMemo(()=>{var D;if(o!=="client")return"";try{return((D=Ir())==null?void 0:D.email)||""}catch{return""}},[o]);x.useEffect(()=>{const D=++O.current;let U=!0;const Y=()=>U&&D===O.current,J=(s&&i.token?i.token:"pub:"+a)+(c?":"+c:""),re=Xo(J);return re?(d(re.objs.map(Ye)),re.fund&&u(re.fund),p(re.marketEstimate??null),v(re.criteria??null),y(re.stats??null),T(re.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const xe=await Kt(),ue=((xe==null?void 0:xe.recent_ops)||[]).map(K=>{const ee=Qt(K.company_name||K.title?K:{...K,title:(K.headline_fr||K.headline||"").slice(0,120)},a),he=String(K.rubrique||"").toLowerCase();return ee&&(he==="nominations"||he==="recrutements")&&(ee.engine=he),ee&&!String(K.company_name||"").trim()&&(ee.noCo=!0),ee}).filter(K=>!!K).map(K=>(In((K.name||"").trim())||(K.noCo=!0),K));try{const K=await $r(),ee=Br(K),he=((K==null?void 0:K.date)||"").slice(0,10);if(ee.length&&he){const Z=new Set;for(const se of ue){if(se.noCo||(se.date||"").slice(0,10)!==he)continue;const te=Ba(ee,Z,se.name,"");te>=0&&(Z.add(te),se.decryptHtml=ee[te].html)}for(const se of ue){if(se.decryptHtml||(se.date||"").slice(0,10)!==he)continue;const te=Ba(ee,Z,"",se.headline||se.tagline||se.name);te>=0&&(Z.add(te),se.decryptHtml=ee[te].html)}}}catch{}if(!Y())return;d(ue.map(Ye)),Et(J,{objs:ue})}else if(typeof r=="object"){const ue=(await Ua()||[]).filter(ee=>(ee.slug||"")===r.research).map(ee=>_a(ee,a)).filter(ee=>!!ee),K=Xt(await Va(ue,a));if(!Y())return;d(K.map(Ye)),Et(J,{objs:K})}else if(s&&i.token){const xe=Ur(i.token),ue=Kt(),K=_r(i.token),ee=Vr(i.token),he=Hr(i.token),Z=await xe;let se=Z?Z.targets:[];Y()&&Z&&(u(Z.fund||""),p(Z.marketEstimate??null),v(Z.criteria??null),y(Z.stats??null),T(Z.generatedAt||""),d(se.map(Ye)),k(!1),R(!1));const[te,Ue,le,ve]=await Promise.all([ue,K,ee,he]),We=((te==null?void 0:te.recent_ops)||[]).map(Re=>Qt(Re,a)).filter(Re=>!!Re);if(se=[...se,...We],!Y())return;d(se.map(Ye));const at=new Set;for(const Re of Ue){const qe=(Re.id||Re.co||"").toString().trim().toLowerCase();qe&&at.add(qe.startsWith("t:")?qe:"t:"+qe)}M(at),w(le),z(ve),Z&&Et(J,{fund:Z.fund,marketEstimate:Z.marketEstimate,criteria:Z.criteria,stats:Z.stats,generatedAt:Z.generatedAt,objs:se})}else{const xe=Wr(),ue=Ua(),K=Kt(),ee=await xe;Y()&&ee.length&&(d(Xt(ee).map(Ye)),k(!1),R(!1));const[he,Z]=await Promise.all([ue,K]),se=(he||[]).map(ve=>_a(ve,a)).filter(ve=>!!ve),te=await Va(se,a),Ue=((Z==null?void 0:Z.recent_ops)||[]).map(ve=>Qt(ve,a)).filter(ve=>!!ve),le=Xt([...ee,...te,...Ue]);if(!Y())return;d(le.map(Ye)),Et(J,{objs:le})}Y()&&R(!1)}catch{Y()&&!re&&R(!0)}finally{Y()&&k(!1)}})(),()=>{U=!1}},[s,i.token,a,V,c]),x.useEffect(()=>{if(!l.showCredits||!$){B(null);return}let D=!0;return(async()=>{try{const U=await fetch(`${Ca}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$})});if(!U.ok)return;const Y=await U.json();D&&Y&&Y.ok!==!1&&B(Y)}catch{}})(),()=>{D=!1}},[l.showCredits,$,X]);const P=x.useCallback(D=>M(new Set(D)),[]);return{session:i,mode:o,caps:l,fund:m,email:$,marketEstimate:b,generatedAt:A,criteria:g,stats:f,thumbs:S,stages:E,dossiers:h,favIds:j,setFavIds:P,credits:q,reloadCredits:()=>L(D=>D+1),loading:H,error:N,refresh:()=>G(D=>D+1)}}const Hn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),ti=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Hn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function ai(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Hn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Wn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Wn=40;function Ta(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ge(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ea(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(He(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ke(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Yn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ta(e,a.filters,r)}function ni(e,a,r,n){return!(!Yn(e,a,r)||r&&!Gr(e,a.ptab,n))}function La(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-He(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=ge(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const ri=["ma","levees","nominations","recrutements","actualites"],oi=300,Zt=7,ii={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Gn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},si=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Za(e){const a=ge(e);if(a)return"sig:"+(a.theme&&Gn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function li(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=F(),s=l==="en",[c,h]=x.useState("all"),[d,m]=x.useState(!1),u=x.useMemo(()=>{const j=(a.filters.day||"").slice(0,10),M=k=>!(!o&&a.continent!=="monde"&&k.continent!==a.continent||j&&(k.date||"").slice(0,10)!==j),q=e.filter(k=>M(k)&&ge(k)),B=e.filter(k=>M(k)&&k.kind==="op"&&!ge(k)&&(j?!0:He(k.date)<=Zt)),H=j||new Date().toISOString().slice(0,10);return B.sort((k,N)=>{const R=(k.date||"").slice(0,10)===H?0:1,V=(N.date||"").slice(0,10)===H?0:1;return R!==V?R-V:(N.amountEur||0)-(k.amountEur||0)}),[...La(q,{key:"signal",dir:-1}),...B]},[e,a.continent,a.filters.day,o]),b=x.useMemo(()=>{const j={};for(const M of u){const q=Za(M);j[q]=(j[q]||0)+1}return j},[u]),p=x.useMemo(()=>c==="all"?u:u.filter(j=>Za(j)===c),[u,c]),g=x.useMemo(()=>p.slice(0,oi),[p]),v=p.length-g.length,f=j=>j==="all"?u.length:b[j]||0,y=j=>j==="all"?s?"All":"Tout":j.startsWith("sig:")?Gn[s?"en":"fr"][j.slice(4)]||"🔔":ii[s?"en":"fr"][j],S=[{k:"all"}],w=ri.filter(j=>f(j)>0||j===c);if(w.length){S.push({g:s?"DEALS":"OPÉRATIONS"});for(const j of w)S.push({k:j})}const E=si.map(j=>"sig:"+j).filter(j=>f(j)>0||j===c);if(E.length){S.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const j of E)S.push({k:j})}const z=j=>{try{return new Date(j+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return j}},A=(()=>{const j=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return j?(s?`LIVE covers the events of ${z(j)}.`:`Le LIVE regroupe les événements du ${z(j)}.`)+M:(s?`LIVE covers the still-open signals and the deals of the last ${Zt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Zt} derniers jours.`)+M})(),T=j=>g.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Ce(M)?" spent":""),onClick:q=>{const B=q.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:B.left+B.width/2,y:B.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Ze,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(Sr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Ul(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Yt,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},j+(M.id||M.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},j+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:j=>{j.currentTarget.contains(j.relatedTarget)||m(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":d,onClick:()=>m(j=>!j),children:[y(c),t.jsx("b",{children:f(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!d,children:[t.jsx("span",{className:"tkfilscope",children:A}),S.map(j=>"g"in j?t.jsx("span",{className:"tkfilg",children:j.g},j.g):t.jsxs("button",{type:"button","aria-pressed":j.k===c,onClick:()=>{h(j.k),m(!1)},children:[y(j.k),t.jsx("b",{children:f(j.k)})]},j.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",children:[T(0),T(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const di="aDx8z7Hzksus",Kn="+33 6 83 10 72 86",en="alexandre@proplace.co",ci=`tel:${Kn.replace(/[^\d+]/g,"")}`,tn="pp-rdv-slot";function pi(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ui(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:fi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:ci,children:Kn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${en}`,children:en})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Io,{filloutId:di,parameters:r?{company_name:r}:void 0})})]})}function mi(){const[e,a]=x.useState(()=>typeof document>"u"?null:document.getElementById(tn));return x.useEffect(()=>{e||a(document.getElementById(tn))},[e]),e?lt.createPortal(t.jsx(ui,{}),e):null}const fi=`
...
`;class be extends x.Component{constructor(){super(...arguments);Ia(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const xi=8;function hi(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,c]=x.useState(!1),[h,d]=x.useState(!1),[m,u]=x.useState(!1),b=r||"home",{names:p,verdicts:g}=x.useMemo(()=>{const w=[],E={};return n.forEach(z=>{z.kind!=="target"||!z.name||(w.push(z.name),E[z.name]=Kr(z)||"")}),{names:w,verdicts:E}},[n]),v=x.useMemo(()=>p.length?Qr(b,p,g,a):null,[b,p.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const f=h?v.added:v.added.slice(0,xi),y=v.added.length-f.length,S=w=>{const E=n.find(z=>z.name===w);E&&(o(E.id),l({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),Jr(b,p,g,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[f.map(w=>t.jsx("button",{type:"button",onClick:()=>S(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),m&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const ea=600,Ge=62,an="atl2:fstats";function gi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=x.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(an)==="on"}catch{return!1}}),c=r.stats,h=x.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=x.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!n.showFunnel||!c||typeof c.screened!="number")return null;const m=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((y,S)=>Math.max(y,S.s||0),0),p=h.length?ea/h.length:0,g=Math.max(4,p-4),v=h.length>=5&&b>0,f=[[c.screened,e.funScreened(m(d)),c.screened_today],...typeof c.kept=="number"?[[c.kept,e.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[f.map(([y,S,w],E)=>t.jsxs("span",{className:"fst-t",children:[E>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:S}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},S)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(an,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ea} ${Ge}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((y,S)=>{const w=(y.s||0)/b*(Ge-4),E=(y.m||0)/b*(Ge-4),z=S*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:Ge-2-w,width:g,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:Ge-2-E,width:g,height:E,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ge-1.5,x2:ea,y2:Ge-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const bi=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function vi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=x.useState(""),[s,c]=x.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),d=(et(e)||"").startsWith("CALL")&&ke(e)===3,m=ke(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const g=await i(e,p);l(""),g&&(c(!0),setTimeout(()=>c(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:bi.filter(([p])=>!(m&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(h===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(yi,{o:e})]})}function yi({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=x.useState(e.ceoNote||""),[l,s]=x.useState(!1),[c,h]=x.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{m()},children:c?a.csNoteSaved:a.csNoteOk})]})}function wi({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=x.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ki({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[c,h]=x.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const d=o(e),m=(d==null?void 0:d.stage)||"todo",u=async f=>{if(c||f===m)return;h(!0);const y=d;l(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const S=Math.max(Date.now(),nn+=1);nn=S;const w=await Xr(r,{company:e.name||"",stage:f,cts:S,deal_id:e.airtableId,check_id:e.checkId});h(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},b=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(m===f?" on":""),disabled:c,onClick:()=>{u(f)},children:y},f)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let nn=0;const At=8,zt=360;function rn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function on({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(rn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(rn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ji({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=x.useState(0),[c,h]=x.useState(null),[d,m]=x.useState([]),u=x.useRef(!1),b=x.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=x.useRef(!1);x.useEffect(()=>{const A=b.current;return()=>{p.current||(n({type:"ptab",tab:A.ptab}),n({type:"dens",dens:A.dens}),n({type:"modal",modal:A.modal}))}},[]),x.useEffect(()=>{u.current||(u.current=!0,m(e.filter(A=>!!document.querySelector(A.need||A.sel))))},[e]);const g=d[l],v=l>=d.length;x.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const A=g.click,T=window.setTimeout(()=>{const j=document.querySelector(A);j&&j.getAttribute("aria-selected")!=="true"&&j.click()},60);return()=>window.clearTimeout(T)}},[l,g]);const f=x.useRef(-1),y=x.useCallback(()=>{if(!g){h(null);return}const A=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!A){h(null);return}f.current!==l&&(f.current=l,A.scrollIntoView({block:"nearest",behavior:"smooth"}));const T=A.getBoundingClientRect();h(j=>j&&Math.abs(j.top-T.top)<1&&Math.abs(j.left-T.left)<1&&Math.abs(j.width-T.width)<1&&Math.abs(j.height-T.height)<1?j:T)},[g,l]);x.useLayoutEffect(()=>{y();const A=[90,300,700,1300].map(j=>window.setTimeout(y,j)),T=()=>y();return window.addEventListener("scroll",T,!0),window.addEventListener("resize",T),()=>{A.forEach(j=>window.clearTimeout(j)),window.removeEventListener("scroll",T,!0),window.removeEventListener("resize",T)}},[y]);const S=x.useRef(a);if(S.current=a,x.useEffect(()=>{const A=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),S.current()):T.key==="ArrowRight"?s(j=>j+1):T.key==="ArrowLeft"&&s(j=>Math.max(0,j-1))};return document.addEventListener("keydown",A,!0),()=>document.removeEventListener("keydown",A,!0)},[]),!d.length)return null;let w=null;const E=A=>()=>{p.current=!0,A()};if(v){const A=i[3]||0;A>0?w={title:A===1?r.ahaATitle1:r.ahaATitleN(A),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let z={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:zt};if(!v&&c){const A=c.bottom+14,j=window.innerHeight-A>190?A:Math.max(12,c.top-200);z={left:Math.min(Math.max(12,c.left+c.width/2-zt/2),window.innerWidth-zt-12),top:j,width:zt}}return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-At,top:c.top-At,width:c.width+At*2,height:c.height+At*2}}),(v||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:z,children:[v&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(on,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(on,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(A=>Math.max(0,A-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(A=>A+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Qn(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Jn(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Ni(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,dispatch:s}=F(),c=r?a:e,h=x.useMemo(()=>c.filter(E=>He(E.date)===0&&E.kind==="target"),[c]),d=x.useMemo(()=>r?a.filter(E=>ke(E)===0).slice().sort((E,z)=>(z.date||"").localeCompare(E.date||"")):[],[a,r]),m=x.useMemo(()=>h.filter(E=>r?ke(E)===0:!Ce(E)),[h,r]),u=r?d:m,b=r?a.length-d.length:h.length-m.length,p=r?a.length:h.length,g=p?Math.min(100,b/p*100):100,v=x.useMemo(()=>Qn(c),[c]),f=!!v&&He(v)>0,y=x.useMemo(()=>f?c.filter(E=>(E.date||"").slice(0,10)===v):[],[c,v,f]);let S;f?S=i.morningLast(y.length,d.length,Jn(v,l)):r?S=i.morningThesis(h.length,d.length):h.length?b===0?S=i.goalSourced(h.length):b>=h.length?S=i.goalCleared:S=i.goalDone(b,h.length):S=i.goalSourced(0);const w=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&d.length&&s({type:"chainStart",queue:d.map(E=>E.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:S}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:g+"%"}})}),u.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:w,children:r?i.morningEval(u.length):o.pileMode?i.goalContinue(u.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Si(){var B,H;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:c,doSync:h,startTour:d}=F(),[m,u]=x.useState(null),[b,p]=x.useState(!0),[g,v]=x.useState([]),f=c==="client";x.useEffect(()=>{if(!i||!o)return;let k=!0;return p(!0),(async()=>{const[N,R]=await Promise.all([Aa(o),$n(i)]);k&&(N&&u(N),p(!1),v(R))})(),()=>{k=!1}},[i,o]);const y=(m==null?void 0:m.per_day)??null,S=((B=m==null?void 0:m.pool_order)==null?void 0:B.length)??0,w=g.filter(k=>k.status==="running").length,E=x.useMemo(()=>s.filter(k=>k.kind==="target"&&Ce(k)).length,[s]),z=l.marketEstimate,A=typeof((H=l.stats)==null?void 0:H.screened)=="number"?l.stats.screened:E,T=z&&z>0?Math.min(100,Math.round(A/z*100)):null,j=k=>k.toLocaleString(a==="en"?"en-US":"fr-FR"),M=(o||"P").split(/\s+/).map(k=>k[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const k=Date.parse(l.generatedAt||"");if(Number.isNaN(k))return"";const N=new Date(k),R=V=>String(V).padStart(2,"0");return`${R(N.getDate())}/${R(N.getMonth()+1)} à ${R(N.getHours())}:${R(N.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:M}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),q&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[T===null&&A>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:j(A)})})]}),T!==null&&z&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:T+"%"}})}),t.jsxs("b",{children:[T," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(A,z)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),y!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:y})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),y===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),w>0&&t.jsxs("span",{className:"ev",children:["⏳ ",w]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:k=>{k.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!f,onClick:h,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:k=>n({type:"filters",patch:{search:k.target.value}})})]})]})]})}function Ci(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const Ei=["--p0","--p1","--p2","--p3","--p4"];function Ai(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,c=x.useRef({});x.useEffect(()=>{c.current={...r}},[r]);const h=u=>{const b=c.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ei[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},d=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(h)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const zi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ti(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=x.useRef(null),[c,h]=x.useState(60);x.useEffect(()=>{let b=0;const p=()=>{var S;const g=s.current;if(!g)return;const v=(S=g.parentElement)==null?void 0:S.querySelector('.funnel [aria-selected="true"]');if(!v)return;const f=v.getBoundingClientRect(),y=g.getBoundingClientRect();h(Math.max(20,Math.min(f.left+f.width/2-y.left,y.width-30)))};return b=requestAnimationFrame(p),window.addEventListener("resize",p),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",p)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const b=n.filter(v=>v.kind==="target"&&ke(v)===3),p=b.filter(v=>ia(v)==="auto").length,g=b.filter(v=>ia(v)==="cd").length;m=r.tutoPending(p,g,b.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(b=>b.id)})};if(d===1){const b=n.filter(p=>p.kind==="target"&&ke(p)===1&&!i.has(p.id)).slice(0,10);if(b.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:b.map(p=>p.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":zi[d],"--ax":c+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Je{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Li(e){for(const a of e)yield*a}function Xn(e){return Array.from(Li(e))}var ne=1e-6,Q=Math.PI,ze=Q/2,sn=Q/4,Le=Q*2,$e=180/Q,Se=Q/180,ie=Math.abs,Ri=Math.atan,vt=Math.atan2,ce=Math.cos,pe=Math.sin,Mi=Math.sign||function(e){return e>0?1:e<0?-1:0},tt=Math.sqrt;function qi(e){return e>1?0:e<-1?Q:Math.acos(e)}function yt(e){return e>1?ze:e<-1?-ze:Math.asin(e)}function Te(){}function Pt(e,a){e&&dn.hasOwnProperty(e.type)&&dn[e.type](e,a)}var ln={Feature:function(e,a){Pt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Pt(r[n].geometry,a)}},dn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ca(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ca(r[n],a,0)},Polygon:function(e,a){cn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)cn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Pt(r[n],a)}};function ca(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function cn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ca(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&ln.hasOwnProperty(e.type)?ln[e.type](e,a):Pt(e,a)}function pa(e){return[vt(e[1],e[0]),yt(e[2])]}function it(e){var a=e[0],r=e[1],n=ce(r);return[n*ce(a),n*pe(a),pe(r)]}function Tt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Dt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Lt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ua(e){var a=tt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ma(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function fa(e,a){return ie(e)>Q&&(e-=Math.round(e/Le)*Le),[e,a]}fa.invert=fa;function Oi(e,a,r){return(e%=Le)?a||r?ma(un(e),mn(a,r)):un(e):a||r?mn(a,r):fa}function pn(e){return function(a,r){return a+=e,ie(a)>Q&&(a-=Math.round(a/Le)*Le),[a,r]}}function un(e){var a=pn(e);return a.invert=pn(-e),a}function mn(e,a){var r=ce(e),n=pe(e),i=ce(a),o=pe(a);function l(s,c){var h=ce(c),d=ce(s)*h,m=pe(s)*h,u=pe(c),b=u*r+d*n;return[vt(m*i-b*o,d*r-u*n),yt(b*i+m*o)]}return l.invert=function(s,c){var h=ce(c),d=ce(s)*h,m=pe(s)*h,u=pe(c),b=u*i-m*o;return[vt(m*i+u*o,d*r+b*n),yt(b*r-d*n)]},l}function Fi(e,a,r,n,i,o){if(r){var l=ce(a),s=pe(a),c=n*r;i==null?(i=a+n*Le,o=a-c/2):(i=fn(l,i),o=fn(l,o),(n>0?i<o:i>o)&&(i+=n*Le));for(var h,d=i;n>0?d>o:d<o;d-=c)h=pa([l,-s*ce(d),-s*pe(d)]),e.point(h[0],h[1])}}function fn(e,a){a=it(a),a[0]-=e,ua(a);var r=qi(-a[1]);return((-a[2]<0?-r:r)+Le-ne)%Le}function Zn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Te,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ft(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Rt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function er(e,a,r,n,i){var o=[],l=[],s,c;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],f=p[g],y;if(Ft(v,f)){if(!v[2]&&!f[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=p[s])[0],v[1]);i.lineEnd();return}f[0]+=2*ne}o.push(y=new Rt(v,p,null,!0)),l.push(y.o=new Rt(v,null,y,!1)),o.push(y=new Rt(f,p,null,!1)),l.push(y.o=new Rt(f,null,y,!0))}}),!!o.length){for(l.sort(a),xn(o),xn(l),s=0,c=l.length;s<c;++s)l[s].e=r=!r;for(var h=o[0],d,m;;){for(var u=h,b=!0;u.v;)if((u=u.n)===h)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,c=d.length;s<c;++s)i.point((m=d[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((m=d[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);i.lineEnd()}}}function xn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function aa(e){return ie(e[0])<=Q?e[0]:Mi(e[0])*((ie(e[0])+Q)%Le-Q)}function Pi(e,a){var r=aa(a),n=a[1],i=pe(n),o=[pe(r),-ce(r),0],l=0,s=0,c=new Je;i===1?n=ze+ne:i===-1&&(n=-ze-ne);for(var h=0,d=e.length;h<d;++h)if(u=(m=e[h]).length)for(var m,u,b=m[u-1],p=aa(b),g=b[1]/2+sn,v=pe(g),f=ce(g),y=0;y<u;++y,p=w,v=z,f=A,b=S){var S=m[y],w=aa(S),E=S[1]/2+sn,z=pe(E),A=ce(E),T=w-p,j=T>=0?1:-1,M=j*T,q=M>Q,B=v*z;if(c.add(vt(B*j*pe(M),f*A+B*ce(M))),l+=q?T+j*Le:T,q^p>=r^w>=r){var H=Dt(it(b),it(S));ua(H);var k=Dt(o,H);ua(k);var N=(q^T>=0?-1:1)*yt(k[2]);(n>N||n===N&&(H[0]||H[1]))&&(s+=q^T>=0?1:-1)}}return(l<-ne||l<ne&&c<-1e-12)^s&1}function tr(e,a,r,n){return function(i){var o=a(i),l=Zn(),s=a(l),c=!1,h,d,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=S,d=[],h=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,d=Xn(d);var w=Pi(h,n);d.length?(c||(i.polygonStart(),c=!0),er(d,Ii,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),d=h=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(w,E){e(w,E)&&i.point(w,E)}function p(w,E){o.point(w,E)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function f(w,E){m.push([w,E]),s.point(w,E)}function y(){s.lineStart(),m=[]}function S(){f(m[0][0],m[0][1]),s.lineEnd();var w=s.clean(),E=l.result(),z,A=E.length,T,j,M;if(m.pop(),h.push(m),m=null,!!A){if(w&1){if(j=E[0],(T=j.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),z=0;z<T;++z)i.point((M=j[z])[0],M[1]);i.lineEnd()}return}A>1&&w&2&&E.push(E.pop().concat(E.shift())),d.push(E.filter(Di))}}return u}}function Di(e){return e.length>1}function Ii(e,a){return((e=e.x)[0]<0?e[1]-ze-ne:ze-e[1])-((a=a.x)[0]<0?a[1]-ze-ne:ze-a[1])}const hn=tr(function(){return!0},$i,Ui,[-Q,-ze]);function $i(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?Q:-Q,c=ie(o-a);ie(c-Q)<ne?(e.point(a,r=(r+l)/2>0?ze:-ze),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&c>=Q&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=Bi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Bi(e,a,r,n){var i,o,l=pe(e-r);return ie(l)>ne?Ri((pe(a)*(o=ce(n))*pe(r)-pe(n)*(i=ce(a))*pe(e))/(i*o*l)):(a+n)/2}function Ui(e,a,r,n){var i;if(e==null)i=r*ze,n.point(-Q,i),n.point(0,i),n.point(Q,i),n.point(Q,0),n.point(Q,-i),n.point(0,-i),n.point(-Q,-i),n.point(-Q,0),n.point(-Q,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?Q:-Q;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function _i(e){var a=ce(e),r=2*Se,n=a>0,i=ie(a)>ne;function o(d,m,u,b){Fi(b,e,r,u,d,m)}function l(d,m){return ce(d)*ce(m)>a}function s(d){var m,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,f){var y=[v,f],S,w=l(v,f),E=n?w?0:h(v,f):w?h(v+(v<0?Q:-Q),f):0;if(!m&&(p=b=w)&&d.lineStart(),w!==b&&(S=c(m,y),(!S||Ft(m,S)||Ft(y,S))&&(y[2]=1)),w!==b)g=0,w?(d.lineStart(),S=c(y,m),d.point(S[0],S[1])):(S=c(m,y),d.point(S[0],S[1],2),d.lineEnd()),m=S;else if(i&&m&&n^w){var z;!(E&u)&&(z=c(y,m,!0))&&(g=0,n?(d.lineStart(),d.point(z[0][0],z[0][1]),d.point(z[1][0],z[1][1]),d.lineEnd()):(d.point(z[1][0],z[1][1]),d.lineEnd(),d.lineStart(),d.point(z[0][0],z[0][1],3)))}w&&(!m||!Ft(m,y))&&d.point(y[0],y[1]),m=y,b=w,u=E},lineEnd:function(){b&&d.lineEnd(),m=null},clean:function(){return g|(p&&b)<<1}}}function c(d,m,u){var b=it(d),p=it(m),g=[1,0,0],v=Dt(b,p),f=Tt(v,v),y=v[0],S=f-y*y;if(!S)return!u&&d;var w=a*f/S,E=-a*y/S,z=Dt(g,v),A=Lt(g,w),T=Lt(v,E);ta(A,T);var j=z,M=Tt(A,j),q=Tt(j,j),B=M*M-q*(Tt(A,A)-1);if(!(B<0)){var H=tt(B),k=Lt(j,(-M-H)/q);if(ta(k,A),k=pa(k),!u)return k;var N=d[0],R=m[0],V=d[1],G=m[1],X;R<N&&(X=N,N=R,R=X);var L=R-N,O=ie(L-Q)<ne,$=O||L<ne;if(!O&&G<V&&(X=V,V=G,G=X),$?O?V+G>0^k[1]<(ie(k[0]-N)<ne?V:G):V<=k[1]&&k[1]<=G:L>Q^(N<=k[0]&&k[0]<=R)){var P=Lt(j,(-M+H)/q);return ta(P,A),[k,pa(P)]}}}function h(d,m){var u=n?e:Q-e,b=0;return d<-u?b|=1:d>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return tr(l,s,o,n?[0,-e]:[-Q,e-Q])}function Vi(e,a,r,n,i,o){var l=e[0],s=e[1],c=a[0],h=a[1],d=0,m=1,u=c-l,b=h-s,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<d)return;p<m&&(m=p)}else if(u>0){if(p>m)return;p>d&&(d=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>m)return;p>d&&(d=p)}else if(u>0){if(p<d)return;p<m&&(m=p)}if(p=n-s,!(!b&&p>0)){if(p/=b,b<0){if(p<d)return;p<m&&(m=p)}else if(b>0){if(p>m)return;p>d&&(d=p)}if(p=o-s,!(!b&&p<0)){if(p/=b,b<0){if(p>m)return;p>d&&(d=p)}else if(b>0){if(p<d)return;p<m&&(m=p)}return d>0&&(e[0]=l+d*u,e[1]=s+d*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var mt=1e9,Mt=-mt;function Hi(e,a,r,n){function i(h,d){return e<=h&&h<=r&&a<=d&&d<=n}function o(h,d,m,u){var b=0,p=0;if(h==null||(b=l(h,m))!==(p=l(d,m))||c(h,d)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==p);else u.point(d[0],d[1])}function l(h,d){return ie(h[0]-e)<ne?d>0?0:3:ie(h[0]-r)<ne?d>0?2:1:ie(h[1]-a)<ne?d>0?1:0:d>0?3:2}function s(h,d){return c(h.x,d.x)}function c(h,d){var m=l(h,1),u=l(d,1);return m!==u?m-u:m===0?d[1]-h[1]:m===1?h[0]-d[0]:m===2?h[1]-d[1]:d[0]-h[0]}return function(h){var d=h,m=Zn(),u,b,p,g,v,f,y,S,w,E,z,A={point:T,lineStart:B,lineEnd:H,polygonStart:M,polygonEnd:q};function T(N,R){i(N,R)&&d.point(N,R)}function j(){for(var N=0,R=0,V=b.length;R<V;++R)for(var G=b[R],X=1,L=G.length,O=G[0],$,P,D=O[0],U=O[1];X<L;++X)$=D,P=U,O=G[X],D=O[0],U=O[1],P<=n?U>n&&(D-$)*(n-P)>(U-P)*(e-$)&&++N:U<=n&&(D-$)*(n-P)<(U-P)*(e-$)&&--N;return N}function M(){d=m,u=[],b=[],z=!0}function q(){var N=j(),R=z&&N,V=(u=Xn(u)).length;(R||V)&&(h.polygonStart(),R&&(h.lineStart(),o(null,null,1,h),h.lineEnd()),V&&er(u,s,N,o,h),h.polygonEnd()),d=h,u=b=p=null}function B(){A.point=k,b&&b.push(p=[]),E=!0,w=!1,y=S=NaN}function H(){u&&(k(g,v),f&&w&&m.rejoin(),u.push(m.result())),A.point=T,w&&d.lineEnd()}function k(N,R){var V=i(N,R);if(b&&p.push([N,R]),E)g=N,v=R,f=V,E=!1,V&&(d.lineStart(),d.point(N,R));else if(V&&w)d.point(N,R);else{var G=[y=Math.max(Mt,Math.min(mt,y)),S=Math.max(Mt,Math.min(mt,S))],X=[N=Math.max(Mt,Math.min(mt,N)),R=Math.max(Mt,Math.min(mt,R))];Vi(G,X,e,a,r,n)?(w||(d.lineStart(),d.point(G[0],G[1])),d.point(X[0],X[1]),V||d.lineEnd(),z=!1):V&&(d.lineStart(),d.point(N,R),z=!1)}y=N,S=R,w=V}return A}}const xa=e=>e;var na=new Je,ha=new Je,ar,nr,ga,ba,Be={point:Te,lineStart:Te,lineEnd:Te,polygonStart:function(){Be.lineStart=Wi,Be.lineEnd=Gi},polygonEnd:function(){Be.lineStart=Be.lineEnd=Be.point=Te,na.add(ie(ha)),ha=new Je},result:function(){var e=na/2;return na=new Je,e}};function Wi(){Be.point=Yi}function Yi(e,a){Be.point=rr,ar=ga=e,nr=ba=a}function rr(e,a){ha.add(ba*e-ga*a),ga=e,ba=a}function Gi(){rr(ar,nr)}var st=1/0,It=st,wt=-st,$t=wt,Bt={point:Ki,lineStart:Te,lineEnd:Te,polygonStart:Te,polygonEnd:Te,result:function(){var e=[[st,It],[wt,$t]];return wt=$t=-(It=st=1/0),e}};function Ki(e,a){e<st&&(st=e),e>wt&&(wt=e),a<It&&(It=a),a>$t&&($t=a)}var va=0,ya=0,ft=0,Ut=0,_t=0,rt=0,wa=0,ka=0,xt=0,or,ir,Pe,De,Ae={point:Xe,lineStart:gn,lineEnd:bn,polygonStart:function(){Ae.lineStart=Xi,Ae.lineEnd=Zi},polygonEnd:function(){Ae.point=Xe,Ae.lineStart=gn,Ae.lineEnd=bn},result:function(){var e=xt?[wa/xt,ka/xt]:rt?[Ut/rt,_t/rt]:ft?[va/ft,ya/ft]:[NaN,NaN];return va=ya=ft=Ut=_t=rt=wa=ka=xt=0,e}};function Xe(e,a){va+=e,ya+=a,++ft}function gn(){Ae.point=Qi}function Qi(e,a){Ae.point=Ji,Xe(Pe=e,De=a)}function Ji(e,a){var r=e-Pe,n=a-De,i=tt(r*r+n*n);Ut+=i*(Pe+e)/2,_t+=i*(De+a)/2,rt+=i,Xe(Pe=e,De=a)}function bn(){Ae.point=Xe}function Xi(){Ae.point=es}function Zi(){sr(or,ir)}function es(e,a){Ae.point=sr,Xe(or=Pe=e,ir=De=a)}function sr(e,a){var r=e-Pe,n=a-De,i=tt(r*r+n*n);Ut+=i*(Pe+e)/2,_t+=i*(De+a)/2,rt+=i,i=De*e-Pe*a,wa+=i*(Pe+e),ka+=i*(De+a),xt+=i*3,Xe(Pe=e,De=a)}function lr(e){this._context=e}lr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Le);break}}},result:Te};var ja=new Je,ra,dr,cr,ht,gt,kt={point:Te,lineStart:function(){kt.point=ts},lineEnd:function(){ra&&pr(dr,cr),kt.point=Te},polygonStart:function(){ra=!0},polygonEnd:function(){ra=null},result:function(){var e=+ja;return ja=new Je,e}};function ts(e,a){kt.point=pr,dr=ht=e,cr=gt=a}function pr(e,a){ht-=e,gt-=a,ja.add(tt(ht*ht+gt*gt)),ht=e,gt=a}let vn,Vt,yn,wn;class kn{constructor(a){this._append=a==null?ur:as(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==yn||this._append!==Vt){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,yn=n,Vt=this._append,wn=this._,this._=i}this._+=wn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ur(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function as(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ur;if(a!==vn){const r=10**a;vn=a,Vt=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Vt}function ns(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),nt(s,i(o))),o.result()}return l.area=function(s){return nt(s,i(Be)),Be.result()},l.measure=function(s){return nt(s,i(kt)),kt.result()},l.bounds=function(s){return nt(s,i(Bt)),Bt.result()},l.centroid=function(s){return nt(s,i(Ae)),Ae.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new kn(r)):new lr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const c=Math.floor(s);if(!(c>=0))throw new RangeError(`invalid digits: ${s}`);r=c}return a===null&&(o=new kn(r)),l},l.projection(e).digits(r).context(a)}function Ra(e){return function(a){var r=new Na;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Na(){}Na.prototype={constructor:Na,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ma(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream(Bt)),a(Bt.result()),n!=null&&e.clipExtent(n),e}function mr(e,a,r){return Ma(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,c])},r)}function rs(e,a,r){return mr(e,[[0,0],a],r)}function os(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function is(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var jn=16,ss=ce(30*Se);function Nn(e,a){return+a?ds(e,a):ls(e)}function ls(e){return Ra({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ds(e,a){function r(n,i,o,l,s,c,h,d,m,u,b,p,g,v){var f=h-n,y=d-i,S=f*f+y*y;if(S>4*a&&g--){var w=l+u,E=s+b,z=c+p,A=tt(w*w+E*E+z*z),T=yt(z/=A),j=ie(ie(z)-1)<ne||ie(o-m)<ne?(o+m)/2:vt(E,w),M=e(j,T),q=M[0],B=M[1],H=q-n,k=B-i,N=y*H-f*k;(N*N/S>a||ie((f*H+y*k)/S-.5)>.3||l*u+s*b+c*p<ss)&&(r(n,i,o,l,s,c,q,B,j,w/=A,E/=A,z,g,v),v.point(q,B),r(q,B,j,w,E,z,h,d,m,u,b,p,g,v))}}return function(n){var i,o,l,s,c,h,d,m,u,b,p,g,v={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=E},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function f(T,j){T=e(T,j),n.point(T[0],T[1])}function y(){m=NaN,v.point=S,n.lineStart()}function S(T,j){var M=it([T,j]),q=e(T,j);r(m,u,d,b,p,g,m=q[0],u=q[1],d=T,b=M[0],p=M[1],g=M[2],jn,n),n.point(m,u)}function w(){v.point=f,n.lineEnd()}function E(){y(),v.point=z,v.lineEnd=A}function z(T,j){S(i=T,j),o=m,l=u,s=b,c=p,h=g,v.point=S}function A(){r(m,u,d,b,p,g,o,l,i,s,c,h,jn,n),v.lineEnd=w,w()}return v}}var cs=Ra({point:function(e,a){this.stream.point(e*Se,a*Se)}});function ps(e){return Ra({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function us(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function Sn(e,a,r,n,i,o){if(!o)return us(e,a,r,n,i);var l=ce(o),s=pe(o),c=l*e,h=s*e,d=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function p(g,v){return g*=n,v*=i,[c*g-h*v+a,r-h*g-c*v]}return p.invert=function(g,v){return[n*(d*g-m*v+u),i*(b-m*g-d*v)]},p}function ms(e){return fs(function(){return e})()}function fs(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,c=0,h=0,d,m=0,u=1,b=1,p=null,g=hn,v=null,f,y,S,w=xa,E=.5,z,A,T,j,M;function q(N){return T(N[0]*Se,N[1]*Se)}function B(N){return N=T.invert(N[0],N[1]),N&&[N[0]*$e,N[1]*$e]}q.stream=function(N){return j&&M===N?j:j=cs(ps(d)(g(z(w(M=N)))))},q.preclip=function(N){return arguments.length?(g=N,p=void 0,k()):g},q.postclip=function(N){return arguments.length?(w=N,v=f=y=S=null,k()):w},q.clipAngle=function(N){return arguments.length?(g=+N?_i(p=N*Se):(p=null,hn),k()):p*$e},q.clipExtent=function(N){return arguments.length?(w=N==null?(v=f=y=S=null,xa):Hi(v=+N[0][0],f=+N[0][1],y=+N[1][0],S=+N[1][1]),k()):v==null?null:[[v,f],[y,S]]},q.scale=function(N){return arguments.length?(r=+N,H()):r},q.translate=function(N){return arguments.length?(n=+N[0],i=+N[1],H()):[n,i]},q.center=function(N){return arguments.length?(o=N[0]%360*Se,l=N[1]%360*Se,H()):[o*$e,l*$e]},q.rotate=function(N){return arguments.length?(s=N[0]%360*Se,c=N[1]%360*Se,h=N.length>2?N[2]%360*Se:0,H()):[s*$e,c*$e,h*$e]},q.angle=function(N){return arguments.length?(m=N%360*Se,H()):m*$e},q.reflectX=function(N){return arguments.length?(u=N?-1:1,H()):u<0},q.reflectY=function(N){return arguments.length?(b=N?-1:1,H()):b<0},q.precision=function(N){return arguments.length?(z=Nn(A,E=N*N),k()):tt(E)},q.fitExtent=function(N,R){return mr(q,N,R)},q.fitSize=function(N,R){return rs(q,N,R)},q.fitWidth=function(N,R){return os(q,N,R)},q.fitHeight=function(N,R){return is(q,N,R)};function H(){var N=Sn(r,0,0,u,b,m).apply(null,a(o,l)),R=Sn(r,n-N[0],i-N[1],u,b,m);return d=Oi(s,c,h),A=ma(a,R),T=ma(d,A),z=Nn(A,E),k()}function k(){return j=M=null,q}return function(){return a=e.apply(this,arguments),q.invert=a.invert&&B,H()}}function fr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}fr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function xs(){return ms(fr).scale(175.295)}function hs(e){return e}function gs(e){if(e==null)return hs;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,c){c||(a=r=0);var h=2,d=s.length,m=new Array(d);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;h<d;)m[h]=s[h],++h;return m}}function bs(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function vs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Cn(e,r)})}:Cn(e,a)}function Cn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ys(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ys(e,a){var r=gs(e.transform),n=e.arcs;function i(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],b=0,p=u.length;b<p;++b)m.push(r(u[b],b));d<0&&bs(m,p)}function o(d){return r(d)}function l(d){for(var m=[],u=0,b=d.length;u<b;++u)i(d[u],m);return m.length<2&&m.push(m[0]),m}function s(d){for(var m=l(d);m.length<4;)m.push(m[0]);return m}function c(d){return d.map(s)}function h(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(h)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:m,coordinates:u}}return h(a)}const xr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ws=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ks(e,a,r){const n=xr[e];if(!n||!n.length)return-1;const i=ws(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let qt=null;function js(){return qt||(qt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=vs(r,n),o=xs().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=ns(o),s=(i.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var b;const m=((b=d.properties)==null?void 0:b.name)||"",u=l(d)||"";return u?{i2:Zr(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const c={};for(const[d,m]of Object.entries(eo)){const u=o(m);u&&(c[d]={x:u[0],y:u[1]})}const h={};for(const[d,m]of Object.entries(xr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(h[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:c,metros:h}}catch{return null}})(),qt)}function Ns(e){const[a,r]=x.useState(null);return x.useEffect(()=>{if(!e||a)return;let n=!1;return js().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const Ss={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},En=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function An(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Cs(e,a){const[r,n]=x.useState(1);return x.useEffect(()=>{let i=!0,o=0;const l=()=>{var h;if(!i)return;const c=(h=e.current)==null?void 0:h.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Es(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:c,data:h,dossiers:d}=F(),m=h.loading&&!d.length,u=x.useRef(null),b=x.useRef(null),p=Ns(e.continent==="monde"),g=e.continent==="monde"?p:za.find(k=>k.key===e.continent)||null,v=Cs(u,e.continent+":"+e.mapFolded+":"+!!g),[f,y]=x.useState(new Map),[S,w]=x.useState(null);x.useEffect(()=>{const k=u.current;if(!k)return;const N=new Map;k.querySelectorAll("path[data-i2]").forEach(R=>{const V=R.dataset.i2;if(V)try{const G=R.getBBox();G.width>0&&N.set(V,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(N)},[e.continent,v,g]);const E=x.useMemo(()=>r.filter(k=>k.cc),[r]),z=x.useMemo(()=>{const k=new Map;return E.forEach(N=>k.set(N.cc,(k.get(N.cc)||0)+1)),k},[E]),A=e.continent==="monde"&&p?p.anchors:null,T=e.continent==="monde"&&p?p.metros:null,j=x.useMemo(()=>E.map(k=>{const N=An(k.name||k.id||""),R=An((k.id||k.name||"")+"·y");if(A&&k.cc){const O=T?T[k.cc]:void 0;if(O&&O.length){const P=ks(k.cc,k.city,N);if(P>=0&&O[P])return{d:k,x:O[P].x+(N-.5)*5,y:O[P].y+(R-.5)*5}}const $=A[k.cc];if($)return{d:k,x:$.x+(N-.5)*10,y:$.y+(R-.5)*10}}const V=k.cc?f.get(k.cc):void 0;if(!V)return null;const G=Ss[`${e.continent}:${k.cc||""}`];if(G)return{d:k,x:V.x+V.w*(G.fx+(N-.5)*G.sx),y:V.y+V.h*(G.fy+(R-.5)*G.sy)};const X=(N-.5)*Math.min(V.w*.55,60),L=(R-.5)*Math.min(V.h*.55,60);return{d:k,x:V.x+V.w/2+X,y:V.y+V.h/2+L}}).filter(k=>!!k),[E,f,A,T,e.continent]),M=k=>v>0?k/v:k,q=x.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:En[k],fr:c.plabels[k].toUpperCase(),en:c.plabels[k].toUpperCase(),n:r.filter(N=>N.kind==="target"&&ke(N)===k).length})).filter(k=>k.n>0):Ha.map((k,N)=>({...k,n:r.filter(R=>Wa(R)===N).length})),[r,n,c.plabels]),B=o?l.get(o):null,H=B?j.find(k=>k.d.id===B.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:g.countries.map((k,N)=>t.jsx("g",{className:"ct"+(k.i2&&z.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},N))}),t.jsx("g",{children:j.map(k=>{const N=Ha[Wa(k.d)],R=!!ge(k.d),V=k.d.kind==="target",G=n&&V?En[ke(k.d)]:N.c,X=!n&&Ce(k.d);return t.jsxs("g",{className:"co"+(X?" done":""),onMouseEnter:()=>{var $,P;const L=($=b.current)==null?void 0:$.getBoundingClientRect(),O=(P=u.current)==null?void 0:P.createSVGPoint();if(O&&u.current&&L){O.x=k.x,O.y=k.y;const D=O.matrixTransform(u.current.getScreenCTM());w({x:D.x-L.left,y:D.y-L.top,label:k.d.name+" · "+(dt(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var $;const L=($=u.current)==null?void 0:$.createSVGPoint();let O=null;if(L&&u.current){L.x=k.x,L.y=k.y;const P=L.matrixTransform(u.current.getScreenCTM());O={x:P.x,y:P.y}}a({type:"popup",id:k.d.id,anchor:O})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:M(Math.max(11,N.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:M(N.px),fill:G,stroke:R?"#DC2626":"#ffffff",strokeWidth:M(R?2.2:1.3)})]},k.d.id||k.d.name)})}),H&&t.jsx("circle",{className:"ring on",cx:H.x,cy:H.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(S?" on":""),style:S?{left:S.x,top:S.y}:void 0,children:S==null?void 0:S.label}),t.jsx("div",{className:"legend",children:q.map((k,N)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},N))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:b})}function As(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function zs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,c=x.useMemo(()=>e.continent==="monde"?r:r.filter(p=>p.continent===e.continent),[r,e.continent]),h=p=>c.filter(g=>p!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Ta(g,s,i,p==="country"?void 0:p)),d=x.useMemo(()=>{const p=h("win"),g=v=>p.filter(f=>(f.date?Math.max(0,Math.floor((Date.now()-Date.parse(f.date))/864e5)):9999)<=v).length;return[g(0),g(7),g(30),p.length]},[c,s,i]),m=x.useMemo(()=>s.day?h("win").filter(p=>(p.date||"").slice(0,10)===s.day).length:0,[c,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),b=(p,g,v,f="fbtn")=>t.jsxs("button",{type:"button",className:f,"aria-expanded":e.openFacet===p,onClick:()=>a({type:"openFacet",facet:p}),children:[t.jsx("span",{className:"fl",children:g}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},p);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(As(s.day,l)),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((p,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===p,onClick:()=>a({type:"filters",patch:{win:p}}),children:[n.dates[g],t.jsx("b",{children:d[g]})]},p))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:p=>a({type:"filters",patch:{search:p.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):b("sec",n.fSector,s.sector.length),b("pay",n.fCountry,s.country.length),b("det",n.fEngine,s.engine.length),b("sta",n.fStage,s.stage.length),i&&b("ang","Angle",s.angle.length),i&&b("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(c.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Ts,{poolFor:h})]})}function Ts({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:c,options:h}=x.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(f=>ge(f)),g=new Map;p.forEach(f=>{const y=f.engine||"";g.set(y,(g.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...sa([...g.keys()],i).map(f=>({v:f,label:Qe(f)+" "+Ie(f,i),n:g.get(f)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v,n:f,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:dt(v,i)||v,n:f,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:sa([...g.keys()],i).map(v=>({v,label:Qe(v)+" "+Ie(v,i)+' <span style="color:var(--dim);font-size:10px">· '+to(ao(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v.replace(/[_-]+/g," "),n:f,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(f=>{if(f.kind==="target"){const y=Ea(f);g.set(y,(g.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:v[f],n:g.get(f)||0,html:!1,on:o.memoLevel.includes(f)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:h.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function hr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ls(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function zn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:s.rsEvalOne})]},c.name))})]}):null}function gr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(zn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(zn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Rs({card:e,onEvaluate:a,onAddAll:r}){var s,c,h;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(gr,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Ms(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function qs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[c,h]=x.useState(null),[d,m]=x.useState(null),[u,b]=x.useState(null),[p,g]=x.useState(!1);x.useEffect(()=>{let f=!0;return(async()=>{const y=await Bn({email:l,cbToken:s});f&&h(y)})(),()=>{f=!1}},[l,s,n]);const v=f=>{m(f),b(null),g(!0),(async()=>{const y=await no(f.id);b(y),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Ms(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?o.rsPub:o.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(Rs,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Tn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Os(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:c,caps:h,data:d,canWrite:m,source:u}=F(),b=a==="client",p=x.useMemo(()=>r||(u!=="default"?ro():""),[r,u]),[g,v]=x.useState(""),[f,y]=x.useState(!1),[S,w]=x.useState(""),[E,z]=x.useState(!1),[A,T]=x.useState(""),[j,M]=x.useState([]),q=x.useRef(!1),[B,H]=x.useState(!1),[k,N]=x.useState(""),[R,V]=x.useState(""),[G,X]=x.useState(!1),[L,O]=x.useState(0),[$,P]=x.useState(""),[D,U]=x.useState(null),[Y,J]=x.useState(null),[re,xe]=x.useState(!1),[ue,K]=x.useState(null),[ee,he]=x.useState(0),Z=x.useRef(!1),se=g.trim()?Tn.test(g.trim())?e.evalUrl:e.evalName:e.evalWaiting,te=x.useMemo(()=>S.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[S]);x.useEffect(()=>{if(typeof window>"u")return;const I=(new URLSearchParams(window.location.search).get("rs")||"").trim();!I||!/^https?:\/\//i.test(I)||(N(I),H(!0))},[]),x.useEffect(()=>{const I=ae=>{var ye;const oe=String(((ye=ae.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(N(oe),H(!0))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),x.useEffect(()=>{if(!m&&!p){K(null);return}let I=!0;return(async()=>{const ae=await Bn({email:n,cbToken:p});I&&K(ae.length)})(),()=>{I=!1}},[m,p,n,ee]);const Ue=j.length?j:c,le=d.credits,ve=x.useCallback(I=>{const ae=I.map(oe=>(oe||"").trim()).filter(Boolean);ae.length&&(w(oe=>{const ye=oe.split(`
`).map(de=>de.trim()).filter(Boolean),Ve=new Set(ye.map(de=>de.toLowerCase())),je=ae.filter(de=>!Ve.has(de.toLowerCase()));return[...ye,...je].slice(0,15).join(`
`)}),y(!0))},[]);x.useEffect(()=>{if(!G)return;O(0);const I=window.setInterval(()=>O(ae=>ae+1),1e3);return()=>window.clearInterval(I)},[G]);const We=()=>{const I=g.trim();I&&(i(null,I),v(""))},at=async()=>{if(!b){i(null,te[0]||"");return}if(!te.length||E)return;z(!0),q.current=!1;const I=[];for(let ae=0;ae<te.length&&!q.current;ae++){T(e.evaluating(ae+1,te.length,te[ae]));const oe=await Un(r,te[ae],"atelier2");if(I.unshift({name:oe.company||te[ae],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),M([...I]),oe.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(te.length-ae-1),remaining:0}),M([...I]),w(te.slice(ae+1).join(`
`)),T(""),z(!1);return}}T(""),w(q.current?te.slice(I.length).join(`
`):""),z(!1)},Re=async()=>{var oe,ye,Ve;if(Z.current)return;const I=k.trim().replace(/\s+/g,""),ae=R.trim();if(!I&&!ae){P(e.rsNeed);return}if(!b&&!p){i(null,I||ae.slice(0,80));return}Z.current=!0,P(""),U(null),J(null),X(!0);try{const je=await io({url:I,text:ae,email:n,cbToken:p});if(X(!1),!je||je.status!=="success"){P((je==null?void 0:je.message)||"Erreur");return}U(je),H(!1),ve((((oe=je.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Ee=>(Ee==null?void 0:Ee.name)||"")),J({state:"pending"});const de=await so(je,{email:n,cbToken:p});J(de.ok?{state:"ok",scopeLabel:((ye=de.summary)==null?void 0:ye.scope_label)||"",scope:((Ve=de.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:de.error||""}),de.ok&&he(Ee=>Ee+1)}finally{Z.current=!1,X(!1)}},qe=[D==null?void 0:D.industry,...(D==null?void 0:D.market_tags)||[],D==null?void 0:D.author].map(I=>(I||"").trim()).filter(Boolean),_e=(Y==null?void 0:Y.state)==="pending",Nt=Y&&(_e?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Y.state==="ok"?t.jsx("span",{className:"rslink ok",children:Y.scope&&Y.scope!=="public"?e.rsSavedIn(Y.scopeLabel||Y.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Y.msg,children:e.rsSaveFail})),ct=Ls(D).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:g,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:I=>v(I.target.value),onKeyDown:I=>{I.key==="Enter"&&We()}}),t.jsx("span",{className:"detect"+(Tn.test(g.trim())?" url":""),children:se})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:We,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),h.showCredits&&le&&t.jsxs("button",{type:"button",className:"credits"+(le.total_available<=0&&!le.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:le.unlimited?"∞":le.total_available}),!le.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",le.daily_grant+le.purchased]}),le.total_available<=0&&!le.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(B?" on":""),onClick:()=>H(!B),children:e.rsOpen}),ue!==null&&ue>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>xe(!re),children:e.rsArchOpen(ue)})]}),re&&t.jsx(qs,{bump:ee,cbToken:p,onClose:()=>xe(!1),onEvaluate:I=>i(null,I),onAddAll:ve}),B&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:k,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:I=>N(I.target.value),onKeyDown:I=>{I.key==="Enter"&&Re()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:R,placeholder:e.rsTextPh,onChange:I=>V(I.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||_e||!k.trim()&&!R.trim(),onClick:()=>{Re()},children:[t.jsx("span",{className:"fill"}),G?`${oo(k.trim())==="youtube"&&k.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(L)}`:_e?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),$&&t.jsx("div",{className:"rserr",children:$}),D&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:D.title}),D.source_url&&t.jsx("a",{href:D.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{U(null),J(null)},children:"×"})]}),D.market&&t.jsx("p",{className:"rsmk",children:D.market}),qe.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),qe.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[D.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${D.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hr(D.summary_md||"").map((I,ae)=>t.jsx("p",{children:I},ae))})]}),t.jsx(gr,{card:D,onEvaluate:I=>i(null,I),onAddAll:ve}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(ct)}),Nt]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:S,placeholder:e.bulkPh,onChange:I=>w(I.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(E?" loading":""),style:{justifyContent:"center"},disabled:E||!te.length,onClick:()=>{at()},children:[t.jsx("span",{className:"fill"}),E&&A?A:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(te.length)})]})]}),Ue.slice(0,1).map((I,ae)=>{const oe=I.verdict==="kept",ye=I.verdict==="quota",Ve=oe?"var(--brand)":ye?"var(--bolt)":"var(--red)",je=oe?"var(--brand-l)":ye?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":je},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:ye?"⏳":"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(de=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:de.url.startsWith("http")?de.url:`https://${de.url}`,target:"_blank",rel:"nofollow noopener",children:[(de.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,de.url),children:e.evalPickGo})]},de.url))}),!ye&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const de=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ee=[...document.querySelectorAll(".atl2 .list .row")].find(Gt=>{var St;return(((St=Gt.querySelector(".rnm"))==null?void 0:St.textContent)||"").trim().toLowerCase().includes(de)});Ee&&(Ee.scrollIntoView({behavior:"smooth",block:"center"}),Ee.classList.add("flashrow"),window.setTimeout(()=>Ee.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),b&&(o.kept+o.dropped>0||Ue.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Fs(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ps(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=F(),o=e.memoConsole?r.get(e.memoConsole):null,l=x.useMemo(()=>o?[o.reasoning||"",Fs(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=et(o),c=Ea(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((h,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[ot(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const oa={},Ln=(oa==null?void 0:oa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Rn(){return new Date().toISOString().slice(0,10)}const qa=x.createContext(null);function Ds(){return x.useContext(qa)}function Is(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(i=>/en bref/i.test(i.textContent||"")&&i.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(i=>(i.textContent||"").replace(/\s+/g," ").trim()).filter(i=>i.length>3).slice(0,4)}catch{return[]}}function $s(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),s.querySelectorAll("*").forEach(c=>{const h=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),h&&/^https?:\/\//i.test(h)&&(c.setAttribute("href",h),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Bs(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Us(){const{ed:e,isEn:a,day:r,loading:n}=br(),i=x.useMemo(()=>Is((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const o=Bs(r,a);return i.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+o}),t.jsx("ul",{children:i.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${o}.`:`Édition du ${o}.`})]})}function br(){const e=x.useContext(qa);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function _s({token:e,children:a}){const{dispatch:r,st:n,lang:i}=F(),[o,l]=x.useState(()=>n.filters.day||Rn()),[s,c]=x.useState(null),[h,d]=x.useState(!1),m=x.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=x.useCallback(()=>{l(Rn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);x.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),x.useEffect(()=>{const g=v=>{var y;const f=(y=v.detail)==null?void 0:y.day;typeof f=="string"&&m(f)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[m]),x.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),x.useEffect(()=>{if(!e||!o)return;let g=!1;d(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Ln}/cibles/edition.json?${v}`).then(f=>f.json()).then(f=>{g||c(f)}).catch(()=>{g||c({ok:!1,error:"network"})}).finally(()=>{g||d(!1)}),()=>{g=!0}},[e,o]);const b=x.useMemo(()=>`${Ln}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=x.useMemo(()=>({token:e,day:o,ed:s,loading:h,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,h,m,u,n.filters.day,b,i]);return t.jsx(qa.Provider,{value:p,children:a})}function Vs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=br();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(lo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function vr({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=F(),[l,s]=x.useState(!1),[c,h]=x.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const d=async()=>{if(l)return;s(!0);const m=await co(r,e);if(s(!1),!m){o(a.actErr);return}h(m.results||[])};return t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{d()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function Wt({spec:e}){const a=x.useRef(null),r=x.useRef(null),[n,i]=x.useState(!1);return x.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;return Ya({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{l=!0,o.replaceChildren()}},[e]),x.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Ya({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const s=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Hs=`
...
`;function Ws(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function Ys(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:c,doDecide:h,doPromote:d,doRepeche:m,doApproach:u,doDeep:b,doOnboard:p,outbound:g,evalBusy:v}=F(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=ge(f),S=ke(f),w=et(f),E=f.kind==="target",z=A=>{a({type:"filters",patch:A}),a({type:"popup",id:null})};return lt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Hs}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Ws(e.popupAnchor,!!f.card),onClick:A=>A.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(He(f.date)),Ie(f.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>z({country:[f.cc]}),children:(dt(f.cc,i)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>z({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>z({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:jt(f.amountEur,i)})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Qe(f.engine)," ",t.jsx("b",{children:Ie(f.engine,i)})," — ",po(f.engine,i),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ze,{o:f,lg:!0})," ",t.jsx(Yt,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(_n(y,i))," · ",n.win7(Vn(y,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(Wt,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&S>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),o.pipe&&E&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})})]}),t.jsx(vr,{name:f.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[S===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),S===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),S===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),S===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(f,!1),a({type:"popup",id:null})},children:n.actNo}),ot(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),S===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),S===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var A;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(A=document.querySelector(".atl2 .demand"))==null||A.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}const Gs=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ot=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Ks(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Ot(a.slice(n));break}r+=Ot(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Ot(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=s?s[2].toLowerCase():"";s&&Gs.has(c)?r+=`<${s[1]}${c}>`:r+=Ot(a.slice(i,o+1)),n=o+1}return r}const Mn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function we({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Qs(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Js({o:e}){const{t:a,doDeep:r}=F(),n=et(e),i=[e.reasoning||"",Qs(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),i.length?i.join(`

`).split(`

`).map((o,l)=>t.jsx("p",{className:"cdtxt",children:o},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[ot(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:o=>{o.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:o=>o.stopPropagation(),children:a.memoOpenFull})]})]})}function Xs({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=F(),o=Ht(e),l=et(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,h=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),m=x.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:h},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||ot(e)?1:0}].filter(g=>g.n>0),[e,a,s,l,c,h,d]),[u,b]=x.useState("");if(!m.length)return null;const p=m.some(g=>g.k===u)?u:m[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:m.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===g.k,"data-tour":"tab-"+g.k,className:p===g.k?"on":"",onClick:v=>{v.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(we,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(we,{k:a.cdVerdictDate,v:Mn(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Ks(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Zs,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdSector,v:e.sector}),t.jsx(we,{k:a.cdStage,v:e.stage}),t.jsx(we,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(we,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(we,{k:a.cdAngle,v:e.angle}),t.jsx(we,{k:a.cdDetected,v:Mn(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdName,v:e.contactName}),t.jsx(we,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(Js,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(we,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Zs({o:e}){const{t:a,token:r}=F(),[n,i]=x.useState(!1),[o,l]=x.useState(null),s=async()=>{n||(i(!0),l(await uo(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},h=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],d=h.some(([,m])=>m);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&d&&t.jsxs(t.Fragment,{children:[h.filter(([,m])=>m).map(([m,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:m}),t.jsx("p",{children:u})]},m)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!d&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const yr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Oa({o:e}){const{t:a}=F(),r=Ht(e),n=et(e),i=ke(e),o=ia(e),l=mo(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(yr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const Sa=e=>e.length>22?e.slice(0,21)+"…":e;function qn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=F(),[o,l]=x.useState(!1);if(x.useEffect(()=>{n||l(!1)},[n]),Ce(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Sa(e.name))})]})}function wr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:c,doApproach:h,dispatch:d}=F();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var p;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(p=document.querySelector(".atl2 .demand"))==null||p.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var p;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(p=document.querySelector(".atl2 .demand"))==null||p.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(qn,{o:e})});const m=ke(e),u=b=>p=>{p.stopPropagation(),b()};if(m===0)return t.jsx("span",{className:"cell",children:t.jsx(qn,{o:e})});if(m===1){const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:u(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(m===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(m===4){const b=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:b,onClick:u(()=>h(e)),children:b?a.actApproachSent:a.actApproach})})}return m===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):m===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function el({o:e}){const{t:a,doThumb:r,thumbOf:n}=F(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function tl({o:e}){const{lang:a}=F();return ge(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ze,{o:e}),t.jsx(Yt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Qe(e.engine||"")," ",Ie(e.engine||"",a)]})})}function al({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:c,favIds:h,toggleFav:d}=F(),m=ke(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,p=b<=0?0:b<=7?1:b<=30?2:3,g=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][m]:u[p],v=h.has(e.id),f=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const S=y.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(x.Fragment,{children:[t.jsxs("div",{className:"row"+(c===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:f,children:[t.jsx("span",{className:"pt",style:{"--c":g}}),t.jsx(Sr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(nl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(tl,{o:e}),l.pipe&&t.jsx(Oa,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(wr,{o:e}),l.showThumbs&&t.jsx(el,{o:e})]}),r&&!a&&t.jsx(ol,{o:e})]})}function nl({o:e}){const{lang:a,caps:r}=F();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=jt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function rl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=F(),l=(u,b=!1)=>p=>{p.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=jt(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ce(e),m=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Wt,{spec:e.card})})]})}function ol({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=F();return!i.pipe&&e.kind==="op"?t.jsx(rl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Xs,{o:e}),t.jsx(vi,{o:e}),t.jsx(ki,{o:e}),t.jsx(vr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Oa,{o:e})})]}),e.card&&t.jsx(Wt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Qe(e.engine||"")," ",Ie(e.engine||"",r)]}),ge(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ze,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function il({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=F();if(!i.pipe&&e.kind==="op"){const h=jt(e.amountEur,l),d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),m=(u,b=!1)=>p=>{p.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Wt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:m({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:m({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:m({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Qe(e.engine||"")," ",Ie(e.engine||"",l)]}),ge(e)&&t.jsx(Ze,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(wr,{o:e})})]})}const s=ke(e),c=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":c},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Oa,{o:e}),ge(e)&&t.jsx(Ze,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function sl(){const{t:e}=F(),[a,r]=x.useState(0);return x.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ll({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=i==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=s.includes(0)?0:s.sort((d,m)=>(e[m]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:o?`${h} ${h>1?"files":"file"} in “${l(c)}”`:`${h} dossier${h>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function dl(){var X;const e=F(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:c,data:h,dossiers:d,source:m}=e,u=m==="ops"?8:Wn,[b,p]=x.useState(new Set);x.useEffect(()=>{p(new Set)},[a.ptab,a.continent]);const[g,v]=x.useState(null);x.useEffect(()=>{v(null)},[a.ptab,a.continent]);const f=L=>p(O=>{const $=new Set(O);return $.has(L)?$.delete(L):$.add(L),$}),[y,S]=x.useState("all"),[w,E]=x.useState(!1);x.useEffect(()=>{S("all"),E(!1)},[a.ptab,a.continent]),x.useEffect(()=>{if(!w)return;const L=O=>{var $,P;(P=($=O.target)==null?void 0:$.closest)!=null&&P.call($,".atl2 .doable")||E(!1)};return document.addEventListener("click",L),()=>document.removeEventListener("click",L)},[w]);const z=Ds(),A=x.useMemo(()=>{var O;const L=new Map;for(const $ of $s(((O=z==null?void 0:z.ed)==null?void 0:O.html)||""))L.has($.t)||L.set($.t,$.html);return L},[(X=z==null?void 0:z.ed)==null?void 0:X.html]),T=x.useCallback(L=>{if(L.decryptHtml)return L.decryptHtml;if(!A.size)return;const O=(L.name||"").trim().toLowerCase();if(O.length<3)return;const $=A.get(O);if($)return $;for(const[P,D]of A)if(P.includes(O)||O.includes(P))return D},[A]),j=x.useMemo(()=>{const L=La(l,a.sort);return y==="all"?L:L.filter(O=>y==="explore"?!!O.noCo:!O.noCo)},[l,a.sort,m,y]),M=x.useMemo(()=>j.filter(L=>ge(L)&&!Ce(L)).length,[j]),q=x.useMemo(()=>i.pipe?j:j.filter(L=>!Ce(L)&&!L.noCo),[j,i.pipe]),B=m==="ops"?j.filter(L=>L.noCo).length:0,H=i.pipe?n.plabels[a.ptab].toLowerCase():m==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,k=(L,O,$="",P=!1)=>t.jsxs("button",{type:"button","data-s":L,className:$,"aria-sort":a.sort.key===L?a.sort.dir===1?"ascending":"descending":"none",style:P?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:L}),children:[O,t.jsx("span",{className:"ar",children:a.sort.key===L&&a.sort.dir===1?"▴":"▾"})]},L),N=x.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const L=new Map;j.forEach(P=>{const D=P.engine||"?";L.has(D)||L.set(D,[]),L.get(D).push(P)});const O={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},$=sa([...L.keys()],s);return[...L.entries()].sort((P,D)=>{const U=O[P[0]]??10+$.indexOf(P[0]),Y=O[D[0]]??10+$.indexOf(D[0]);return U-Y})},[j,i.pipe,a.groupBy,s]),R=i.lockRowsAfter;let V=0;const G=(L,O)=>{let $=a.shown[O]||u;return L.length-$<=4&&($=L.length),L.slice(0,$).map(U=>{const Y=R!==null&&V>=R;V++;const J=T(U),re=J&&J!==U.decryptHtml?{...U,decryptHtml:J}:U,xe=a.dens!=="maxi"&&(a.dens==="deplie"||(g?g==="open":!!J)),ue=b.has(U.id)?!xe:xe;return a.dens==="maxi"?t.jsx(il,{o:re,locked:Y},U.id):t.jsx(al,{o:re,locked:Y,open:ue,onToggle:()=>f(U.id)},U.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:j.length})," ",H]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",m==="ops"&&j.length>0&&" — "+n.edSplit(j.length-B,B)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||m==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([L,O])=>t.jsxs("button",{type:"button","data-d":L,"aria-pressed":a.dens===L||L==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:L}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:O})]},L))}),(i.showFunnel||m==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":g==="open",onClick:()=>{v("open"),p(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":g==="closed",onClick:()=>{v("closed"),p(new Set)},children:n.foldAllLbl}),m==="ops"&&t.jsxs("button",{type:"button","aria-pressed":g===null,onClick:()=>{v(null),p(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||m==="ops")&&(()=>{var $;const L=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],O=(($=L.find(([P])=>P===y))==null?void 0:$[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":w,onClick:()=>E(P=>!P),children:[O,t.jsx("i",{children:"▾"})]}),w&&t.jsx("div",{className:"dolist",children:L.map(([P,D])=>t.jsx("button",{type:"button","aria-pressed":y===P,onClick:()=>{S(P),E(!1)},children:D},P))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:L=>r({type:"sort",key:L.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([L,O])=>t.jsx("option",{value:L,children:O},L))})]}),i.showChain&&q.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:q.map(L=>L.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(q.length):n.chainAll(q.length)]})]}),M>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(M)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),k("country",n.colCountry),k("name",n.colCompany),k("amount",n.colAmount,"h-amt",!0),k("stage",n.colStage,"h-stade"),k("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&k("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(m==="ops"?" opsl":"")+(j.length?"":" list-empty"),children:[N?N.map(([L,O])=>t.jsxs(x.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Qe(L)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Ie(L,s)}),t.jsx("div",{className:"s",children:n.grpCount(O.filter($=>!Ce($)).length,O.length)})]})]}),G(O,L)]},L)):G(j,"pt"+a.ptab),h.loading&&!d.length&&t.jsx(sl,{}),!j.length&&!(h.loading&&!d.length)&&(i.pipe?t.jsx(ll,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const L=N||[["pt"+a.ptab,j]];let O=0,$=0;for(const[D,U]of L){$+=U.length;let Y=a.shown[D]||u;U.length-Y<=4&&(Y=U.length),O+=Math.min(U.length,Y)}const P=$-O;return P<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>L.forEach(([D,U])=>r({type:"more",group:D,by:U.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(P,P)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(O,$)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}})]})}function On(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function cl(e,a){const r=fo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function pl(e,a){const n=[a.head.split("|").map(On).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",cl(i,a.plabels),Ht(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(On).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ul(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const ml=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Fe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function fl({o:e,qa:a}){const{t:r,lang:n,fund:i}=F(),o=(e.cribleStatus||"").trim().toUpperCase()||(Ht(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=et(e),s=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Fe,{k:r.cdSector,v:e.sector}),t.jsx(Fe,{k:r.cdStage,v:e.stage}),t.jsx(Fe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Fe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Fe,{k:r.cdName,v:e.contactName}),t.jsx(Fe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Fe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Fe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Fe,{k:r.cdAngle,v:e.angle}),t.jsx(Fe,{k:r.cdDetected,v:ml(e.date,n)})]}),c.some(([,h])=>h)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,h])=>h).map(([h,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:h}),t.jsx("p",{children:d})]},h))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function xl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=F(),[s,c]=x.useState({}),h=25,d=x.useMemo(()=>n.slice(0,h),[n]);x.useEffect(()=>{d.length&&xo(r,d.map(b=>b.name)).then(c)},[r,d]);const m=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>h&&t.jsx("span",{className:"mnote dim",children:e.dsCap(h,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[u(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(m.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(m.screened/o.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(fl,{o:b,qa:s[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const hl=50;function Fa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=F(),[o,l]=x.useState(null),[s,c]=x.useState(!1),[h,d]=x.useState(""),[m,u]=x.useState(0),[b,p]=x.useState(""),[g,v]=x.useState(!1),f=x.useRef(null);x.useEffect(()=>()=>{f.current&&window.clearInterval(f.current)},[]);const y=async w=>{c(!0),d("");const E=await a();if(c(!1),E.ok){l(E);return}if(E.busy){d(i.alertPreviewBusy);return}if(!w){d(i.alertPreviewFail);return}u(hl),f.current=window.setInterval(()=>{u(z=>z>1?z-1:(f.current&&window.clearInterval(f.current),y(!1),0))},1e3)},S=async()=>{if(n||g)return;v(!0),p("");const w=await r();v(!1),p(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||m>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{S()},children:g?"…":i.alertTest})]}),m>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(m)}),h&&t.jsx("p",{className:"mnote warn",children:h}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const bt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ne({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=F();return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function gl(){const{st:e}=F();switch(e.modal){case"chain":return t.jsx(vl,{});case"space":return t.jsx(yl,{});case"alert":return t.jsx(wl,{});case"queue":return t.jsx(Cl,{});case"export":return t.jsx(El,{});case"plug":return t.jsx(Tl,{});case"recharge":return t.jsx(Rl,{});case"cover":return t.jsx(ql,{});case"dossier":return t.jsx(Ml,{});case"crit":return t.jsx(Ol,{});case"tuto":return t.jsx(Fl,{});case"rdv":return t.jsx(bl,{});case"memoalert":return t.jsx(Al,{});default:return null}}function bl(){const{dispatch:e,fund:a}=F(),r=typeof document<"u"&&!!document.getElementById("rdv");return x.useEffect(()=>{r&&(e({type:"modal",modal:null}),pi())},[r,e]),r?null:t.jsx(bo,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function vl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s,caps:c,memoQueued:h,doAnalyse:d}=F(),m=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,p=u[b],g=b>=u.length;return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[dt(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(He(p.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ie(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:jt(p.amountEur,i)})]}),ge(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ze,{o:p,lg:!0})," ",t.jsx(Yt,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),m&&Ce(p)&&t.jsxs("div",{className:"vbox",style:{"--c":Ke(p)==="retenu"?"var(--brand)":Ke(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ke(p)==="retenu"?"✓ "+n.kept:Ke(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&p&&c.pipe&&ke(p)===1&&!h.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&p&&!(m&&Ce(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function yl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=F(),o=i==="client",l=x.useMemo(()=>o?r.filter(m=>Ce(m)):[],[r,o]),s=x.useMemo(()=>La(l.filter(m=>Ke(m)==="retenu"),{key:"signal",dir:-1}),[l]),c=x.useMemo(()=>l.filter(m=>Ke(m)==="ecarte"),[l]),h=e.spaceTab==="retenu"?s:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ne,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(m=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof m.score=="number"&&m.score>0?m.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:m.name}),t.jsx("div",{className:"rr",children:m.reasoning||m.tagline||""})]})]},m.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function wl(){const{mode:e}=F();return e==="client"||e==="apercu"?t.jsx(kl,{}):t.jsx(Sl,{})}function kl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),[o,l]=x.useState("d"),s=i!=="client";return t.jsxs(Ne,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(jl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(Nl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(kr,{})]})}function jl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=x.useState(null),[s,c]=x.useState(!1),[h,d]=x.useState(0);x.useEffect(()=>{let p=!0;return c(!1),Qa(a).then(g=>{p&&(g?l(g):c(!0))}),()=>{p=!1}},[a,h]);const m=p=>{r||Qa(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),b=p=>{const g=o.sections||e.alertSec.map(([v])=>v);m({sections:u(p)?g.filter(v=>v!==p):[...g,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>b(p)}),t.jsxs("span",{children:[g,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Fa,{label:e.alertPreview,readOnly:r,onPreview:()=>So(a),onTest:()=>No(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Nl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=x.useState(null),[s,c]=x.useState(!1),[h,d]=x.useState(0);x.useEffect(()=>{let p=!0;return c(!1),Ja(a).then(g=>{p&&(g?l(g):c(!0))}),()=>{p=!1}},[a,h]);const m=p=>{r||Ja(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>m({dow:Number(p.target.value)}),children:e.alertDow.map((p,g)=>t.jsx("option",{value:g,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Fa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Eo(a),onTest:()=>Co(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function kr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=F(),[l,s]=x.useState(o||""),[c,h]=x.useState(!1),[d,m]=x.useState(!1);x.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,b=x.useMemo(()=>n.filter(f=>ge(f)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){m(!0);try{await fetch(`${Ca}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{m(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Ie(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>dt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Sl(){const{t:e}=F();return t.jsx(Ne,{title:e.alertTitle,icon:"🔔",children:t.jsx(kr,{})})}function Cl(){var g,v,f;const{t:e,token:a,fund:r,mode:n,flash:i}=F(),[o,l]=x.useState(null),[s,c]=x.useState([]),[h,d]=x.useState(0),m=n==="client";x.useEffect(()=>{let y=!0;return(async()=>{const[S,w]=await Promise.all([Aa(r),$n(a)]);y&&(S&&l(S),c(w))})(),()=>{y=!1}},[a,r,h]);const u=(o==null?void 0:o.per_day)??2,b=((g=o==null?void 0:o.analyzed_today)==null?void 0:g.length)??0,p=(v=o==null?void 0:o.tomorrow)!=null&&v.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(Ne,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(b,b+(((f=o==null?void 0:o.pool_order)==null?void 0:f.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),m&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Ka(a,y.company,"retry").then(()=>d(S=>S+1))},children:e.queueRetry}),m&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Ka(a,y.company,"delete").then(()=>d(S=>S+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[p.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),p.slice(0,10).map((y,S)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",S+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function El(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=F(),s=`${bt}/cibles/list.csv?token=${a}`,c=`${bt}/cibles/list.json?token=${a}`,h=`${bt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,m=v=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:h,href:h}],b=!i.lockActions&&n.length>0,p=()=>{ul(pl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([f])=>f===v)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ne,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>m(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Al(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),o=i!=="client",[l,s]=x.useState(null),[c,h]=x.useState(!1),[d,m]=x.useState(0),[u,b]=x.useState(!1);x.useEffect(()=>{let f=!0;return h(!1),Ga(a).then(y=>{f&&(y?s(y):h(!0))}),()=>{f=!1}},[a,d]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=f=>{if(o||!l)return;const y={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??p()};b(!0),Ga(a,y).then(S=>{if(b(!1),!S){n(e.memoAlertErr);return}s(S),r(e.memoAlertSaved)})};if(c)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=p();return t.jsxs(Ne,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(zl,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>g({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[f],disabled:o||u,onChange:()=>g({sections:{...v,[f]:!v[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Fa,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>go(a,v),onTest:()=>ho(a,v)})]})}function zl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=x.useState(e);x.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:h=>l(h.target.value),onKeyDown:h=>{h.key==="Enter"&&s&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!c,onClick:()=>i(o.trim()),children:n})]})]})}function Tl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=F(),[o,l]=x.useState(null),[s,c]=x.useState(!1),[h,d]=x.useState(null),[m,u]=x.useState(""),[b,p]=x.useState(0);x.useEffect(()=>{let f=!0;return c(!1),la(a).then(y=>{f&&(y?l({configured:y.configured,url_hint:y.url_hint}):c(!0))}),yo(a).then(y=>{f&&d(y)}),()=>{f=!1}},[a,b]);const g=(f,y)=>{i&&la(a,f).then(S=>{if(!S||S.ok===!1){n(e.actErr);return}f.test&&S.sent===!1?n(e.plugTestThrottled):r(y),p(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(Ne,{title:e.plugTitle,icon:"🔌",wide:!0,children:[h&&t.jsx("p",{className:"mnote"+(h.enabled?" warn":""),children:h.enabled?e.plugAutoOn(h.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(f=>f+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:m,disabled:!i,onChange:f=>u(f.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!m.trim(),onClick:()=>g({url:m.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(Ll,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function Ll(){const{t:e,token:a,lang:r}=F(),[n,i]=x.useState("valides"),[o,l]=x.useState(!1),[s,c]=x.useState(null),[h,d]=x.useState(null),[m,u]=x.useState(!1),[b,p]=x.useState(!1),[g,v]=x.useState(null),[f,y]=x.useState(null),[S,w]=x.useState(null),E=`atl2:bulk:${a}:${n}`;x.useEffect(()=>{la(a).then(B=>{y(B&&B.configured?B.url_hint||"webhook":null)})},[a]),x.useEffect(()=>{c(null),d(null),u(!1),v(null);try{const B=JSON.parse(localStorage.getItem(E)||"null");w(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{w(null)}},[E]);const z=async()=>{l(!0),u(!1),v(null);const B=await ko(a,n);c(B),d(B.ok?n:null),l(!1)},A=x.useRef(!1),T=async()=>{if(A.current)return;A.current=!0,p(!0);const B=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let H;try{H=await jo(a,n,"webhook",void 0,B)}finally{A.current=!1}if(p(!1),u(!1),v(H),H.ok&&(H.pushed||0)>0){const k={t:new Date().toISOString(),n:H.pushed||0};w(k);try{localStorage.setItem(E,JSON.stringify(k))}catch{}}},j=s!=null&&s.ok&&s.ready||0,M=!!(s!=null&&s.ok)&&h===n&&j>0&&!!f&&!S,q=S?new Date(S.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:B=>i(B.target.value),children:e.plugBulkTabs.map(([B,H])=>t.jsx("option",{value:B,children:H},B))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{z()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),S&&t.jsx("p",{className:"mnote",children:e.bulkLocked(q,S.n)}),!S&&!!(s!=null&&s.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!S&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),M&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),M&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(j,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{T()},children:b?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function Rl(){const{t:e,data:a,lang:r}=F(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const h=await(await fetch(`${Ca}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Ne,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ml(){const{t:e}=F();return t.jsx(Ne,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(xl,{})})}function ql(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:s}=F(),[c,h]=x.useState(null),[d,m]=x.useState(!1);x.useEffect(()=>{let A=!0;if(o)return Aa(o).then(T=>{A&&T&&typeof T.per_day=="number"&&h(T.per_day)}),()=>{A=!1}},[o]);const u=r.stats,b=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(A=>A.kind==="target"&&Ce(A)).length,p=r.marketEstimate||0,g=p>0?Math.min(100,Math.round(b/p*100)):null,v=(u==null?void 0:u.window_days)||30,f=b>0?b/v:0,y=p>0?Math.max(0,p-b):0,w=p>0&&f>0&&b>=100?Math.round(y/f):null,E=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),z=A=>{d||!l||(m(!0),wo(i,A).then(T=>{if(m(!1),T===null){s(e.actErr);return}h(T),s(e.alertSaved)}))};return t.jsxs(Ne,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(E(b))}),p>0&&t.jsx("span",{children:e.covOf(E(p))})]}),g!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:g+"%"}}),t.jsxs("em",{children:[g," %"]})]}),w!==null&&t.jsx("p",{className:"mnote",children:e.covEta(w)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),f>=1&&t.jsx("p",{className:"mnote",children:e.covPace(E(f))}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(u.shown)})," ",e.covShown]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:c===A?"on":"",disabled:d,onClick:()=>z(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Ol(){var f,y,S;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:s}=F(),c=n==="client",h=x.useMemo(()=>{const w=new Set;return a.forEach(E=>{E.angle&&w.add(E.angle)}),[...w]},[a]),[d,m]=x.useState(""),[u,b]=x.useState(""),[p,g]=x.useState(!1),v=async()=>{const w=d.trim();if(!(!w||p||!c)){g(!0),b("");try{const z=await(await fetch(`${bt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(z.reply&&b(String(z.reply)),z.job_id){b(e.critChatRunning);const A=async()=>{const T=await fetch(`${bt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:z.job_id})}).then(j=>j.json()).catch(()=>null);if(T&&T.done){b(String(T.reply||T.clarification||T.summary||"✓")),g(!1),T.applied&&i(e.alertSaved);return}setTimeout(()=>{A()},8e3)};setTimeout(()=>{A()},8e3),m("");return}m("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(Ne,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((f=o.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var E,z;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((E=w.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(A=>t.jsx("li",{children:A},A))})]}),!!((z=w.out)!=null&&z.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(A=>t.jsx("li",{children:A},A))})]})]})]},w.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||p,onChange:w=>m(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!c||p||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(vo,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(yr[w]||"v-cons"),children:w}),t.jsx("span",{children:E})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",E]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Fl(){const{t:e,dispatch:a,startTour:r}=F(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ne,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const jr="atl2:mapfold",Pl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(jr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Nr=x.createContext(null),F=()=>{const e=x.useContext(Nr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ze({o:e,lg:a}){const{lang:r}=F(),n=ge(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Xa(n,r),children:[n.emoji," ",Xa(n,r)]}):null}function Yt({o:e,src:a}){const{lang:r,t:n}=F(),i=ge(e);if(!i)return null;const o=Ro(i),l=Mo(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(_n(i,r))+" · "+n.win7(Vn(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Sr({o:e}){const{lang:a}=F(),r=Lo(e.cc),n=e.cc?dt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Fn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Cr=e=>`atl2:tour:${e||"anon"}`;function Dl(e){try{return localStorage.getItem(Cr(e))==="1"}catch{return!0}}function Pn(e){try{localStorage.setItem(Cr(e),"1")}catch{}}function Il(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Hl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var Da;const{lang:l}=Ao(),s=Uo[l],c=ei(e,l,a),[h,d]=x.useReducer(ai,void 0,()=>ti((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Pl(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),m=x.useRef(!0);x.useEffect(()=>{if(m.current){m.current=!1;return}if(!e)try{localStorage.setItem(jr,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e]);const u=x.useRef(o);u.current=o,x.useEffect(()=>{var C;(C=u.current)==null||C.call(u,h.filters)},[h.filters]);const[b,p]=x.useState(null),[g,v]=x.useState(null),[f,y]=x.useState({kept:0,dropped:0}),[S,w]=x.useState(!1),[E,z]=x.useState(""),[A,T]=x.useState(!1),[j,M]=x.useState(null),[q,B]=x.useState(!1),[H,k]=x.useState(!1),[,N]=x.useState(0),R=()=>N(C=>C+1),V=x.useRef([]),G=x.useRef(new Set),X=x.useRef(new Set),L=x.useRef(new Map),O=x.useRef(null),{mode:$}=c,P=x.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),D=P.pipe,U=c.session.token||"",Y=$==="client"&&!e;x.useEffect(()=>{if(document.querySelector(`link[href="${Fn}"]`))return;const C=document.createElement("link");C.rel="stylesheet",C.href=Fn,document.head.appendChild(C)},[]);const J=(C,_=!1)=>{z(C),T(_),O.current&&clearTimeout(O.current),O.current=setTimeout(()=>z(""),_?4200:2400)},re=C=>J(C,!0),xe=x.useMemo(()=>{const C=new Map;return c.dossiers.forEach(_=>{_.id&&C.set(_.id,_)}),C},[c.dossiers]),ue=x.useMemo(()=>c.dossiers.filter(C=>Yn(C,h,D)),[c.dossiers,h,D]),K=x.useRef(!1);x.useEffect(()=>{if(K.current||e||c.loading||!c.dossiers.length)return;if(!P.showFunnel||Dl(c.session.token||"")){K.current=!0;return}K.current=!0;const C=window.setTimeout(()=>{Pn(c.session.token||""),B(!0)},700);return()=>window.clearTimeout(C)},[e,c.loading,c.dossiers.length,P.showFunnel,c.session.token]);const ee=x.useMemo(()=>c.dossiers.filter(C=>ni(C,h,D,c.favIds)),[c.dossiers,h,D,c.favIds]),he=x.useMemo(()=>zo(ue,c.favIds),[ue,c.favIds]),Z=x.useMemo(()=>{const C=Qn(c.dossiers);return C?He(C)===0?s.tourToday:Jn(C,l):s.tourNoRun},[c.dossiers,s,l]),se=x.useMemo(()=>c.dossiers.some(C=>!!C.memoUrl||!!C.summary||ot(C)),[c.dossiers]),te=(c.marketEstimate||0)>0||typeof((Da=c.stats)==null?void 0:Da.screened)=="number"&&c.stats.screened>0,Ue=x.useMemo(()=>[1,0,2,4,5,3].find(C=>(he[C]||0)>0)??0,[he]),le=za.find(C=>C.key===h.continent),ve=h.continent==="monde"?s.contWorld:(l==="fr"?le==null?void 0:le.fr:le==null?void 0:le.en)||"";x.useEffect(()=>{const C=_=>{var me;const W=(((me=_.detail)==null?void 0:me.name)||"").trim();W&&We(null,W)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)}),x.useEffect(()=>{const C=me=>{const Me=String(me||"").trim();Me&&d({type:"filters",patch:{sector:[Me]}})},_=me=>{var Me;return C((Me=me.detail)==null?void 0:Me.sector)},W=me=>{me.data&&me.data.type==="pp-filter"&&C(me.data.sector)};return window.addEventListener("ppmap:filter",_),window.addEventListener("message",W),()=>{window.removeEventListener("ppmap:filter",_),window.removeEventListener("message",W)}},[]);const We=(C,_)=>{const W=((C==null?void 0:C.name)||_||"").trim();if(!Y){v({kicker:W});return}!W||S||(w(!0),(async()=>{try{let me=W;const Me=((C==null?void 0:C.website)||(C==null?void 0:C.domain)||"").trim();if(Me)me=Me;else try{const fe=await qo(W);if(fe!=null&&fe.website)me=fe.website;else if(((fe==null?void 0:fe.candidates)||[]).length===1)me=fe.candidates[0].url;else if(((fe==null?void 0:fe.candidates)||[]).length>1){V.current=[{name:W,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(fe.candidates||[]).slice(0,5)},...V.current].slice(0,8),R();return}}catch{}const Oe=await Un(U,me,"atelier2"),Lr={name:Oe.company||W,verdict:Oe.verdict,reason:Oe.reason||"",remaining:Oe.remaining??null};V.current=[Lr,...V.current].slice(0,8),Oe.verdict==="kept"&&y(fe=>({...fe,kept:fe.kept+1})),Oe.verdict==="ruled_out"&&y(fe=>({...fe,dropped:fe.dropped+1}));const pt=C||c.dossiers.find(fe=>(fe.name||"").toLowerCase()===W.toLowerCase());pt&&(Oe.verdict==="kept"?pt.verdict=pt.verdict||"MATCH":Oe.verdict==="ruled_out"&&(pt.verdict="NO MATCH"),Oe.reason&&(pt.reasoning=Oe.reason)),R()}finally{w(!1)}})())},at=C=>{if(!Y){v({kicker:C.name});return}G.current.add(C.id),ut(U,"fast_request",C.name||"",""),J(s.memoInstantSent(C.name)),R()},Re=C=>L.current.get(C.id)??c.thumbs.get((C.name||"").trim().toLowerCase()),qe=(C,_)=>d({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:_}}),_e=async(C,_,W)=>{const me=C.ceoStatus||"";C.ceoStatus=_,R();const Me=await Jt(U,{status:_,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...(W==null?void 0:W.note)!==void 0?{note:W.note}:{},...W!=null&&W.via?{via:W.via}:{}});return Me.ok?Me.skipped?(C.ceoStatus=me,R(),re(s.actNotPersisted),!1):((W==null?void 0:W.undo)!==!1&&qe(C,me),W!=null&&W.msg&&J(W.msg),(_==="Validé"||_==="Écarté")&&!C.ceoNote&&(W==null?void 0:W.note)===void 0&&M({o:C,yes:_==="Validé"}),!0):(C.ceoStatus=me,R(),re(s.actErr),!1)},Nt=async(C,_)=>{const W=await Jt(U,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:_,via:"note"});return!W.ok||W.skipped?(re(W.skipped?s.actNotPersisted:s.actErr),!1):(C.ceoNote=_,R(),!0)},ct=x.useRef(new Map),I=C=>ct.current.has(C.id)?ct.current.get(C.id):c.stages.get((C.name||"").trim().toLowerCase()),ae=(C,_)=>{ct.current.set(C.id,_),R()},oe=(C,_)=>{Y&&_e(C,_?"Validé":"Écarté",{msg:_?s.decidedYes(C.name):s.decidedNo(C.name)})},ye=C=>{Y&&_e(C,"À trancher",{msg:s.promoted(C.name)})},Ve=C=>{Y&&(async()=>{const _=C.ceoStatus||"";C.ceoStatus="Retenu",R();const W=await Jt(U,{status:"Retenu",check_id:C.checkId,company:C.name});if(!W.ok||W.skipped){C.ceoStatus=_,R(),re(W.skipped?s.actNotPersisted:s.actErr);return}qe(C,_),J(s.repeched(C.name))})()},je=()=>{const C=h.undo[h.undo.length-1];if(!C){J(s.undoNone);return}const _=xe.get(C.id);if(!_){d({type:"undoPop"}),J(s.undoNone);return}let W=C.prevCeoStatus;if(!W)if((_.verdict||"").toUpperCase().includes("CALL"))W="À trancher";else{J(s.undoLockedTitle);return}(async()=>await _e(_,W,{undo:!1})&&(d({type:"undoPop"}),_.ceoStatus=C.prevCeoStatus,R(),J(s.undoDone(_.name))))()},de=C=>{Y&&(X.current.add(C.id),R(),(async()=>{const _=await Oo(U,C.name,"email");if(!_||_.ok===!1){X.current.delete(C.id),R(),re(s.actErr);return}ut(U,"approach",C.name||"",""),J(s.actApproachSent)})())},Ee=(C,_)=>{Y&&(async()=>{if(!(await ut(U,_?"yes":"no",C.name||"","")).ok){re(s.actErr);return}L.current.set(C.id,_?"yes":"no"),R(),J(_?s.thumbUpDone:s.thumbDnDone)})()},Gt=C=>{!Y||!ot(C)||(ut(U,"detailed_request",C.name||"",""),J(s.memoDeepSent(C.name)))},St=C=>{const _=new Set(c.favIds),W=_.has(C.id);W?_.delete(C.id):_.add(C.id),c.setFavIds(_),Y&&Fo(U,{id:C.id,co:C.name},W)},Er=()=>{!Y||H||window.confirm(s.identSyncConfirm)&&(k(!0),(async()=>{const C=await Po(U);k(!1),C?J(s.identSyncDone):re(s.actErr)})())},Pa=/proplace/i.test(c.fund||""),Ar=C=>{!Y||!Pa||(ut(U,"onboard_request",C.name||"",""),J(s.onboardSent(C.name)))},zr={st:h,dispatch:d,t:s,lang:l,mode:$,caps:P,pipe:D,token:U,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:Ve,thumbOf:Re,canWrite:Y,commitStatus:_e,saveNote:Nt,stageOf:I,setStage:ae,flashErr:re,startTour:()=>B(!0),dossiers:c.dossiers,scopedAll:ue,scoped:ee,counts:he,byId:xe,contName:ve,favIds:c.favIds,toggleFav:St,askEvaluate:We,doAnalyse:at,doDecide:oe,doPromote:ye,doApproach:de,doThumb:Ee,doDeep:Gt,doUndo:je,doSync:Er,doOnboard:Ar,outbound:Pa,memoQueued:G.current,approachDone:X.current,sessTally:f,evalCards:V.current,evalBusy:S,markRow:p,markedId:b,flash:J};x.useEffect(()=>{const C=_=>{_.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const Tr=C=>U?t.jsx(_s,{token:U,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(Nr.Provider,{value:zr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Ho}),Tr(t.jsxs("div",{className:"app"+(D?" pipe":"")+(U?" has-thesis":""),children:[P.showTicker&&t.jsx(be,{name:"live",children:t.jsxs("div",{className:"live-stack"+(U?" live-stack--cibles":""),children:[t.jsx(li,{}),!!U&&t.jsx(Vs,{})]})}),P.showIdent&&t.jsx(be,{name:"identite",children:t.jsx(Si,{})}),!!U&&t.jsx(be,{name:"lead",children:t.jsx(Us,{})}),P.showOnb&&t.jsx(be,{name:"onboarding",children:t.jsx(Ci,{})}),P.showMorning&&t.jsx(be,{name:"matin",children:t.jsx(Ni,{})}),t.jsx(be,{name:"fraicheur",children:t.jsx(hi,{})}),t.jsx(be,{name:"mesure",children:t.jsx(gi,{})}),P.showFunnel&&t.jsx(be,{name:"entonnoir",children:t.jsx($l,{})}),P.showFunnel&&t.jsx(be,{name:"tunnel",children:t.jsx(Ai,{})}),P.showFunnel&&t.jsx(be,{name:"tuto",children:t.jsx(Ti,{})}),t.jsx(be,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Bl,{}),t.jsxs("div",{className:"stage"+(h.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Es,{}),t.jsx(zs,{})]})]})}),P.showDemand&&t.jsx(be,{name:"evaluation",children:t.jsx(Os,{})}),P.showDemand&&h.memoConsole&&t.jsx(be,{name:"console",children:t.jsx(Ps,{})}),t.jsx(be,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(dl,{})}),c.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:s.retry})]})]})),P.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),h.popupId&&t.jsx(be,{name:"fiche",children:t.jsx(Ys,{})}),t.jsx(be,{name:"modales",children:t.jsx(gl,{})}),t.jsx(mi,{}),j&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:j.o.name}),t.jsx(wi,{placeholder:j.yes?s.whyYesPh:s.whyNoPh,onDone:C=>{const _=j.o;M(null),C&&Nt(_,C).then(W=>{W&&J(s.csNoteSaved)})}})]}),q&&!c.loading&&t.jsx(ji,{steps:Il(s,Z,se,Ue,te),onClose:()=>{B(!1),Pn(U)}}),E&&t.jsx("div",{className:"flash on"+(A?" err":""),children:E}),g&&t.jsx(To,{variant:"acquirer",initialCompany:Dn().co,initialWebsite:Dn().site,onClose:()=>v(null)})]})})}function $l(){const{t:e}=F(),[a,r]=x.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Bl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=F(),l=x.useMemo(()=>{const s={};return e.forEach(c=>{Ta(c,a.filters,n)&&(s.monde=(s.monde||0)+1,c.continent&&(s[c.continent]=(s[c.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[Do.map(s=>{const c=za.find(d=>d.key===s),h=s==="monde"?o.contWorld:i==="fr"?c.fr:c.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[h,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Dn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ul(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Sr as FlagCell,Ze as SigBadge,Yt as SigWin,Hl as default,Ul as fmtShort,F as useV2};
