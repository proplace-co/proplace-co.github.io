...
.atl2 .bulk .side .hint{white-space:nowrap}`,Cl=`
...
`,Tl=zl+Cl+Al+ql;function bn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ll(){const e=bn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Fl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ll();return r==="0"?"client":r==="1"||bn("embed")==="1"&&bn("chrome")==="1"?"apercu":"client"}const Rl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ol=e=>Rl[e];function Ia(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Lt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!vo(a)||Ia(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ji(e.cc)})};function an(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ml=60*60*1e3;function Dl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ml?null:a}catch{return null}}function va(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Il=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Pl(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:_i(),[e,n]),i=p.useMemo(()=>n?"visiteur":Fl(e,o),[e,o,n]),d=p.useMemo(()=>Ol(i),[i]),s=i!=="visiteur",l=Il(r),[m,c]=p.useState([]),[g,u]=p.useState(""),[b,h]=p.useState(null),[v,y]=p.useState(null),[f,w]=p.useState(null),[E,k]=p.useState(()=>new Map),[j,N]=p.useState(()=>new Map),[q,T]=p.useState(""),[S,R]=p.useState(new Set),[M,U]=p.useState(null),[H,B]=p.useState(!0),[x,L]=p.useState(!1),[C,$]=p.useState(0),[G,z]=p.useState(0),I=p.useRef(0),D=p.useMemo(()=>{var V;if(i!=="client")return"";try{return((V=Bi())==null?void 0:V.email)||""}catch{return""}},[i]);p.useEffect(()=>{const V=++I.current;let ce=!0;const te=()=>ce&&V===I.current,le=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),xe=Dl(le);return xe?(c(xe.objs.map(Lt)),xe.fund&&u(xe.fund),h(xe.marketEstimate??null),y(xe.criteria??null),w(xe.stats??null),T(xe.generatedAt||""),B(!1)):B(!0),(async()=>{try{if(r==="ops"){const he=await Xa(),we=((he==null?void 0:he.recent_ops)||[]).map(pe=>{const Ne=Aa(pe.company_name||pe.title?pe:{...pe,title:(pe.headline_fr||pe.headline||"").slice(0,120)},a),Ce=String(pe.rubrique||"").toLowerCase();return Ne&&(Ce==="nominations"||Ce==="recrutements")&&(Ne.engine=Ce),Ne&&!String(pe.company_name||"").trim()&&(Ne.noCo=!0),Ne}).filter(pe=>!!pe).map(pe=>(vo((pe.name||"").trim())||(pe.noCo=!0),pe));try{const pe=$i(),Ne=await Ui(),Ce=((Ne==null?void 0:Ne.date)||"").slice(0,10),ue=pe?pe.doc:Ne,be=Hi(ue),ye=((pe==null?void 0:pe.day)||(ue==null?void 0:ue.date)||Ce||"").slice(0,10);if(ye&&be.length){const ee=new Set;for(const P of we){if((P.date||"").slice(0,10)!==ye)continue;const J=tr(be,ee,P.name,"");J>=0&&(ee.add(J),P.decryptHtml=be[J].html)}for(const P of we){if(P.decryptHtml||(P.date||"").slice(0,10)!==ye)continue;const J=tr(be,ee,"",P.headline||P.tagline||P.name);J>=0&&(ee.add(J),P.decryptHtml=be[J].html)}}if(ye){const ee=((ue==null?void 0:ue.title_fr)||"").trim(),P=((ue==null?void 0:ue.lead_fr)||"").trim(),J=Vi(ue),ie=((ue==null?void 0:ue.url)||"").trim();ee&&(J||ie)&&we.unshift({id:`edito:${ye}`,kind:"op",name:ee,cc:null,date:ye,engine:"edito",dealKind:"other",headline:ee,tagline:P||ee,decryptHtml:J||void 0,url:ie,noCo:!0})}}catch{}if(!te())return;c(we.map(Lt)),va(le,{objs:we})}else if(typeof r=="object"){const we=(await ar()||[]).filter(Ne=>(Ne.slug||"")===r.research).map(Ne=>nr(Ne,a)).filter(Ne=>!!Ne),pe=an(await rr(we,a));if(!te())return;c(pe.map(Lt)),va(le,{objs:pe})}else if(s&&o.token){const he=Wi(o.token),we=Xa(),pe=Gi(o.token),Ne=Yi(o.token),Ce=Qi(o.token),ue=await he;let be=ue?ue.targets:[];te()&&ue&&(u(ue.fund||""),h(ue.marketEstimate??null),y(ue.criteria??null),w(ue.stats??null),T(ue.generatedAt||""),c(be.map(Lt)),B(!1),L(!1));const[ye,ee,P,J]=await Promise.all([we,pe,Ne,Ce]),ie=((ye==null?void 0:ye.recent_ops)||[]).map(W=>Aa(W,a)).filter(W=>!!W),oe=new Set(be.map(W=>W.id));if(be=[...be,...ie.filter(W=>!oe.has(W.id)&&(oe.add(W.id),!0))],!te())return;c(be.map(Lt));const me=new Set;for(const W of ee){const se=(W.id||W.co||"").toString().trim().toLowerCase();se&&me.add(se.startsWith("t:")?se:"t:"+se)}R(me),k(P),N(J),ue&&va(le,{fund:ue.fund,marketEstimate:ue.marketEstimate,criteria:ue.criteria,stats:ue.stats,generatedAt:ue.generatedAt,objs:be})}else{const he=Ki(),we=ar(),pe=Xa(),Ne=await he;te()&&Ne.length&&(c(an(Ne).map(Lt)),B(!1),L(!1));const[Ce,ue]=await Promise.all([we,pe]),be=(Ce||[]).map(J=>nr(J,a)).filter(J=>!!J),ye=await rr(be,a),ee=((ue==null?void 0:ue.recent_ops)||[]).map(J=>Aa(J,a)).filter(J=>!!J),P=an([...Ne,...ye,...ee]);if(!te())return;c(P.map(Lt)),va(le,{objs:P})}te()&&L(!1)}catch{te()&&!xe&&L(!0)}finally{te()&&B(!1)}})(),()=>{ce=!1}},[s,o.token,a,C,l]),p.useEffect(()=>{if(!d.showCredits||!D){U(null);return}let V=!0;return(async()=>{try{const ce=await fetch(`${ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:D})});if(!ce.ok)return;const te=await ce.json();V&&te&&te.ok!==!1&&U(te)}catch{}})(),()=>{V=!1}},[d.showCredits,D,G]);const Q=p.useCallback(V=>R(new Set(V)),[]);return{session:o,mode:i,caps:d,fund:g,email:D,marketEstimate:b,generatedAt:q,criteria:v,thesisMode:String((v==null?void 0:v.mode)||""),stats:f,thumbs:E,stages:j,dossiers:m,patchStatuses:(V,ce)=>{c(te=>{let le=!1;const xe=te.map(he=>{if(!he.checkId)return he;const we=V.get(he.checkId);return!we||we===(he.ceoStatus||"")||!ce(he.id)?he:(le=!0,{...he,ceoStatus:we})});return le?xe:te})},favIds:S,setFavIds:Q,credits:M,reloadCredits:()=>z(V=>V+1),loading:H,error:x,refresh:()=>$(V=>V+1)}}function Be(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const qa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Pa(e){return qa.has(e.engine||"")}function Ke(e){return!!e.noCo||Pa(e)&&!!e.url}const Po=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),_l=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Po(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Bl=new Set(["signal","amount","score","crible","memo"]);function $l(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Po(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Bl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??_o)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const _o=80;function _a(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!_e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Mn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ut(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ft(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(yo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function Rt(e,a,r){return Be(e)?_a(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:_a(e,a.filters,r)}function Ul(e,a,r,n){return!(!Rt(e,a,r)||r&&!wo(e,a.ptab,n))}function Bn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-ut(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Zi(o)||null;case"memo":return Xi(o)||null;case"signal":{const i=_e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),s=n(i);return d===null||s===null?d===s?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<s?-a.dir:d>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const nn={},Er=(nn==null?void 0:nn.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function jr(){return new Date().toISOString().slice(0,10)}const $n=p.createContext(null);function Bo(){return p.useContext($n)}function Hl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const m=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(c=>l.removeAttribute(c.name)),m&&/^https?:\/\//i.test(m)&&(l.setAttribute("href",m),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:s.outerHTML})}}catch{}return a}function $o(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Vl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),$o(r),r.innerHTML):e}catch{return e}}function Nr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),$o(r),r.innerHTML):e}catch{return e}}function Sr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Uo(){const e=p.useContext($n);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Wl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Z(),[i,d]=p.useState(()=>n.filters.day||jr()),[s,l]=p.useState(null),[m,c]=p.useState(!1),g=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){d(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{d(jr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=y=>{var w;const f=(w=y.detail)==null?void 0:w.day;typeof f=="string"&&g(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[g]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;c(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Er}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{v||l(f)}).catch(()=>{v||l({ok:!1,error:"network"})}).finally(()=>{v||c(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${Er}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),h=p.useMemo(()=>({token:e,day:i,ed:s,loading:m,pickDay:g,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,m,g,u,n.filters.day,b,o]);return t.jsx($n.Provider,{value:h,children:a})}function Gl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Uo(),[o,i]=p.useState(()=>n||ko());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(Ra,d),()=>window.removeEventListener(Ra,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(es,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Yl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function zr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Cr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Ql(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Uo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!d,l=a&&!a.ok,m=p.useRef(null),[c,g]=p.useState("fonds"),[u,b]=p.useState(null),[h,v]=p.useState("idle"),y=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),y.current=!1,g("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||y.current)return;y.current=!0;let j=!0;return v("load"),Yl(e).then(N=>{j&&(b(N),v("fait"))}),()=>{j=!1}},[c,e]);const f=p.useMemo(()=>Vl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),w=p.useRef(null);p.useEffect(()=>{const j=w.current;if(!j||!f)return;let N=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async q=>{await q.ensureEditoCss(),!(N||!j.isConnected)&&(q.beautifyEditoRows(j),q.mountCardFits(j))}),()=>{N=!0}},[f]);const E=p.useMemo(()=>Nr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>Nr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const j=m.current;if(!j||!E)return;let N=!1;return hn(()=>import("./fit-DX-mzLKR.js"),[]).then(async q=>{await q.ensureEditoCss(),!(N||!j.isConnected)&&(q.beautifyEditoRows(j),q.mountCardFits(j))}),()=>{N=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>g("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>g("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?zr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Sr(e,!0)}),"."]}):zr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Sr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>g("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&E?t.jsx("div",{ref:m,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:u.title}),t.jsx("div",{ref:w,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:h==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:h!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Cr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Cr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Kl=300,wa=7,Jl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Ho={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Xl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function ya(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(rs(r)&&r!=="media")return"news:"+r;const n=_e(e);return n?"sig:"+(n.theme&&Ho.fr[n.theme]?n.theme:"other"):"actualites"}function Zl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:s}=Z(),l=Bo(),m=d==="en",[c,g]=p.useState("all"),[u,b]=p.useState(!1),h=p.useMemo(()=>{var ce;const x=(a.filters.day||"").slice(0,10),L=te=>!(!i&&a.continent!=="monde"&&te.continent!==a.continent||x&&(te.date||"").slice(0,10)!==x),C=e.filter(te=>L(te)&&_e(te)&&(!i||te.kind!=="target"||Te(te)!==5)),$=i&&(((ce=l==null?void 0:l.ed)==null?void 0:ce.ops)||[]).length?l.ed.ops.map(te=>Aa(te,d)).filter(te=>!!te).map(te=>(te.briefOnly=!0,te)).filter(te=>!x||(te.date||"").slice(0,10)===x):[],G=e.filter(te=>L(te)&&te.kind==="op"&&(x?!0:ut(te.date)<=wa)),z=i?$.length?$:G.filter(te=>{const le=(s||"").trim().toLowerCase();if(!le)return!1;const xe=te.match||null;return xe?Object.keys(xe).map(he=>he.trim().toLowerCase()).includes(le):!1}):G,I=x||new Date().toISOString().slice(0,10),D=te=>{const le=ya(te);return le==="ma"?0:le==="levees"?1:2};z.sort((te,le)=>{const xe=D(te)-D(le);if(xe)return xe;const he=(te.date||"").slice(0,10)===I?0:1,we=(le.date||"").slice(0,10)===I?0:1;return he!==we?he-we:(le.amountEur||0)-(te.amountEur||0)});const Q=new Set,V=[];for(const te of[...z,...Bn(C,{key:"signal",dir:-1})]){const le=te.id||te.name;!le||Q.has(le)||(Q.add(le),V.push(te))}return i&&V.length===0?e.filter(le=>L(le)&&ut(le.date)<=wa).sort((le,xe)=>(xe.date||"").localeCompare(le.date||"")).slice(0,80):V},[e,a.continent,a.filters.day,i,s,d,l]),v=p.useMemo(()=>{const x={};for(const L of h){const C=ya(L);x[C]=(x[C]||0)+1}return x},[h]),y=p.useMemo(()=>c==="all"?h:h.filter(x=>ya(x)===c),[h,c]),f=p.useMemo(()=>y.slice(0,Kl),[y]),w=y.length-f.length,E=p.useRef(null);p.useEffect(()=>{var z,I;const x=E.current;if(!x)return;const L=()=>{const D=x.scrollWidth;D<200||(x.style.animationDuration=Math.max(18,Math.round(D/130))+"s")};L();const C=requestAnimationFrame(L),$=window.setTimeout(L,1200);let G=!0;return(I=(z=document.fonts)==null?void 0:z.ready)==null||I.then(()=>{G&&L()}),()=>{G=!1,cancelAnimationFrame(C),window.clearTimeout($)}},[f.length,c]);const k=x=>x==="all"?h.length:v[x]||0,j=x=>{if(x==="all")return m?"All":"Tout";if(x.startsWith("sig:"))return Ho[m?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const L=x.slice(5);return as[L]?ns(L,m?"en":"fr"):x}return Jl[m?"en":"fr"][x]},N=[{k:"all"}],q=["ma","levees"].filter(x=>k(x)>0||x===c);if(q.length){N.push({g:m?"Deals":"Opérations"});for(const x of q)N.push({k:x})}const T=["nominations","recrutements"].filter(x=>k(x)>0||x===c),S=ts.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===c),R=k("actualites")>0||c==="actualites"?["actualites"]:[];if(T.length||S.length||R.length){N.push({g:m?"News":"Actualités"});for(const x of T)N.push({k:x});for(const x of S)N.push({k:x});for(const x of R)N.push({k:x})}const M=Xl.map(x=>"sig:"+x).filter(x=>k(x)>0||x===c);if(M.length){N.push({g:m?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of M)N.push({k:x})}const U=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(m?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},H=(()=>{const x=(a.filters.day||"").slice(0,10),L=!i&&a.continent!=="monde"&&o?m?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(m?`LIVE covers the events of ${U(x)}.`:`Le LIVE regroupe les événements du ${U(x)}.`)+L:(m?`LIVE covers the still-open signals and the deals of the last ${wa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${wa} derniers jours.`)+L})(),B=x=>f.map(L=>t.jsxs("button",{type:"button",className:"tk"+(Ue(L)?" spent":""),onClick:C=>{const $=L.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:$?"":L.id,name:L.name,url:L.url||"",text:L.tagline||L.headline||"",card:L.card}}))}catch{}if($||n({type:"focus",id:L.id}),a.dens!=="liste"){const G=C.currentTarget.getBoundingClientRect();n({type:"popup",id:L.id,anchor:{x:G.left+G.width/2,y:G.bottom}})}},title:Ue(L)?m?`${L.name} — already screened (dimmed)`:`${L.name} — déjà évaluée (grisée)`:L.name+(L.tagline?" — "+L.tagline:""),children:[t.jsx(zt,{o:L}),t.jsxs("span",{className:"who",children:[t.jsx(zi,{o:L}),t.jsx("span",{className:"co",children:L.name})]}),(()=>{const C=(L.tagline||L.headline||"").trim();if(C&&C!==L.name)return t.jsx("span",{className:"what",children:C});const $=ya(L),G=$==="ma"?m?"M&A deal":"opération M&A":$==="levees"?m?"fundraising":"levée de fonds":$==="nominations"?m?"appointment":"nomination":$==="recrutements"?m?"hiring":"recrutement":$.startsWith("sig:")?m?"engine signal":"signal moteur":$.startsWith("news:")?m?"news":"actualité":L.kind==="target"?m?"sourced target":"cible sourcée":m?"news item":"actualité";return t.jsx("span",{className:"what dim",children:G})})(),typeof L.amountEur=="number"&&L.amountEur>0&&t.jsx("span",{className:"am",children:Zc(L.amountEur)}),L.sector&&t.jsx("span",{className:"mt",children:L.sector}),t.jsx(Ka,{o:L}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(L.id||L.name))).concat(w>0?[t.jsx("span",{className:"tk quiet",children:m?`+ ${w} more — filter by section to see them`:`+ ${w} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(x=>!x),children:[j(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:H}),N.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===c,onClick:()=>{g(x.k),b(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:E,children:[B(0),B(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:m?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",m?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(td,{isEn:m})]})}const ed=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function td({isEn:e}){const[a,r]=p.useState(()=>ko());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Ra,o),()=>window.removeEventListener(Ra,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>os(!a),children:ed})}class pt extends p.Component{constructor(){super(...arguments);Xn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Vo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Ar(e,a){if((Ct(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Vo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const qr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",ad={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function nd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Z(),[s,l]=p.useState(""),[m,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!g)return;const w=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),c(!1))};return document.addEventListener("click",w,!0),()=>document.removeEventListener("click",w,!0)},[g]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const h=(e.ceoStatus||"").trim(),v=async w=>{if(s)return;if(w==="Analysé"&&!e.memoUrl){c(!0);return}l(w);const E=(Ar(e,a).find(([j])=>j===w)||[w,w])[1],k=await o(e,w,{msg:a.csMoved(e.name,E)});l(""),k&&(c(!1),u(!1))},y=Ar(e,a),f=w=>(y.find(([E])=>E===w)||[])[1]||w;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:w=>w.stopPropagation(),children:y.map(([w,E])=>t.jsx("button",{type:"button",className:"rsd "+(w==="Validé"?"yes":"no")+(s===w?" busy":""),disabled:!!s,onClick:()=>{v(w)},children:E},w))}):t.jsxs("span",{className:"rstat"+(g||m?" rs-open":""),ref:b,onClick:w=>w.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":g,disabled:!!s,title:a.csLabel,className:"rsel rs-"+qr(h),onClick:()=>{u(w=>!w),c(!1)},children:s?f(s)+"…":h?f(h):a.csNone}),g&&!m&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([w,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":h===w,className:"rsopt"+(h===w?" on":"")+(s===w?" busy":""),disabled:!!s,onClick:()=>{if(w===h){u(!1);return}v(w)},children:[t.jsx("i",{className:"pt2",style:{background:ad[qr(w)]}}),E]},w))}),m&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const w=await o(e,"Analysé");l(""),w&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function rd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Z(),[i,d]=p.useState(""),[s,l]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const m=(e.ceoStatus||"").trim(),c=(Ct(e)||"").startsWith("CALL")&&Te(e)===3,g=Te(e)>=2,u=async h=>{if(i||h==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(h);const v=await o(e,h);d(""),v&&(l(!0),setTimeout(()=>l(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:Vo.filter(([h])=>!(g&&h==="Retenu")).map(([h,v])=>[h,a[v]]);return t.jsxs("div",{className:"csp",onClick:h=>h.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([h,v])=>t.jsx("button",{type:"button",className:"csb"+(m===h?" on":"")+(i===h?" busy":""),disabled:!!i,onClick:()=>{u(h)},children:v},h)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(od,{o:e})]})}function od({o:e}){const{t:a,saveNote:r,flash:n}=Z(),[o,i]=p.useState(e.ceoNote||""),[d,s]=p.useState(!1),[l,m]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),g=async()=>{if(d||!c)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(m(!0),setTimeout(()=>m(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&g()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{g()},children:l?a.csNoteSaved:a.csNoteOk})]})}function Tr({placeholder:e,onDone:a}){const{t:r}=Z(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function id({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:s}=Z(),[l,m]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const c=i(e),g=(c==null?void 0:c.stage)||"todo",u=async f=>{if(l||f===g)return;m(!0);const w=c;d(e,{stage:f,stamps:(c==null?void 0:c.stamps)||{}});const E=Math.max(Date.now(),Lr+=1);Lr=E;const k=await is(r,{company:e.name||"",stage:f,cts:E,deal_id:e.airtableId,check_id:e.checkId});m(!1),!k.stale&&(k.ok||(d(e,w),s(a.actErr)))},b=(y=c==null?void 0:c.stamps)==null?void 0:y.sent,h=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=g==="sent"&&b&&h>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,w])=>t.jsx("button",{type:"button",className:"stgb"+(g===f?" on":""),disabled:l,onClick:()=>{u(f)},children:w},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(h)})]})}let Lr=0;const Zt=8,Nt=360;function Fr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Rr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Fr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Fr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function sd({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Z(),[d,s]=p.useState(0),[l,m]=p.useState(null),[c,g]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),h=p.useRef(!1);p.useEffect(()=>{const q=b.current;return()=>{h.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,g(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const v=c[d],y=d>=c.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const q=v.click,T=window.setTimeout(()=>{const S=document.querySelector(q);S&&S.getAttribute("aria-selected")!=="true"&&S.click()},60);return()=>window.clearTimeout(T)}},[d,v]);const f=p.useRef(-1),w=p.useCallback(()=>{if(!v){m(null);return}const q=R=>{if(!R)return null;for(const M of document.querySelectorAll(R)){const U=M.getBoundingClientRect();if(U.width>1&&U.height>1)return M}return null},T=q(v.sel)||q(v.need);if(!T){m(null);return}f.current!==d&&(f.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=T.getBoundingClientRect();m(R=>R&&Math.abs(R.top-S.top)<1&&Math.abs(R.left-S.left)<1&&Math.abs(R.width-S.width)<1&&Math.abs(R.height-S.height)<1?R:S)},[v,d]);p.useLayoutEffect(()=>{w();const q=[90,300,700,1300].map(R=>window.setTimeout(w,R)),T=window.setInterval(w,400),S=()=>w();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{q.forEach(R=>window.clearTimeout(R)),window.clearInterval(T),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[w]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const q=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),E.current()):T.key==="ArrowRight"?s(S=>S+1):T.key==="ArrowLeft"&&s(S=>Math.max(0,S-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!c.length)return null;let k=null;const j=q=>()=>{h.current=!0,n({type:"modal",modal:null}),q()};if(y){const q=o[3]||0;q>0?k={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Nt};if(!y&&l){const q=l.bottom+14,T=window.innerHeight-q;let S=T>190?q:Math.max(12,l.top-200),R=Math.min(Math.max(12,l.left+l.width/2-Nt/2),window.innerWidth-Nt-12);T<=190&&l.top<212&&(window.innerWidth-l.right>=Nt+40?R=Math.min(l.right+26,window.innerWidth-Nt-12):l.left>=Nt+40&&(R=Math.max(12,l.left-Nt-26)),S=Math.max(12,l.top-Zt)),N={left:R,top:S,width:Nt}}return Qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-Zt,top:l.top-Zt,width:l.width+Zt*2,height:l.height+Zt*2}}),(y||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:N,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Rr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(Rr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>s(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(q=>q+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Wo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Go(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ld(){var T,S;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:s,dispatch:l}=Z(),m=r?a:e,c=p.useMemo(()=>m.filter(R=>ut(R.date)===0&&R.kind==="target"),[m]),g=p.useMemo(()=>r?a.filter(R=>R.kind==="target"&&Te(R)===0).slice().sort((R,M)=>(M.date||"").localeCompare(R.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(R=>r?Te(R)===0:!Ue(R)),[c,r]),b=r?g:u,h=r?a.length-g.length:c.length-u.length,v=r?a.length:c.length,y=v?Math.min(100,h/v*100):100,f=p.useMemo(()=>Wo(m),[m]),w=!!f&&ut(f)>0,E=p.useMemo(()=>w?m.filter(R=>(R.date||"").slice(0,10)===f):[],[m,f,w]),k=typeof((T=s.stats)==null?void 0:T.kept_today)=="number"?s.stats.kept_today:null,j=typeof((S=s.stats)==null?void 0:S.screened_today)=="number"?s.stats.screened_today:c.length;let N;w?N=o.morningLast(E.length,g.length,Go(f,d)):r?N=o.morningThesis(j,g.length,k):c.length?h===0?N=o.goalSourced(c.length):h>=c.length?N=o.goalCleared:N=o.goalDone(h,c.length):N=o.goalSourced(0);const q=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(R=>R.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function dd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:s}=Z(),l=i==="client",[m,c]=p.useState(!1),[g,u]=p.useState(""),b=()=>{!l||m||!n||(c(!0),u(""),ss(n).then(y=>{if(c(!1),y.pending){u(e.refreshSlow);return}if(!y.ok){y.error&&console.warn("[republish]",y.error),u(e.refreshKo);return}const f=y.entered??0,w=y.left??0;u(y.unchanged||!f&&!w?e.refreshSame:e.refreshDone(f,w)),o.refresh()}))},h=(n||"P").split(/\s+/).map(y=>y[0]).join("").slice(0,2).toUpperCase(),v=(()=>{const y=Date.parse(o.generatedAt||"");if(Number.isNaN(y))return"";const f=new Date(y),w=E=>String(E).padStart(2,"0");return`${w(f.getDate())}/${w(f.getMonth()+1)} à ${w(f.getHours())}:${w(f.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),v?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(v)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!l||m,onClick:b,children:m?"⏳":"📰"}),(m||!!g)&&t.jsxs("span",{className:"repubst",children:[m?e.refreshRun:g,!m&&t.jsx("button",{type:"button",onClick:()=>u(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!l,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:y=>r({type:"filters",patch:{search:y.target.value}})})]})]})})}class Mt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,s=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);s&&(r[n++]=s),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*pd(e){for(const a of e)yield*a}function Yo(e){return Array.from(pd(e))}var Le=1e-6,Se=Math.PI,it=Se/2,Or=Se/4,lt=Se*2,vt=180/Se,et=Se/180,Fe=Math.abs,cd=Math.atan,da=Math.atan2,Oe=Math.cos,Me=Math.sin,ud=Math.sign||function(e){return e>0?1:e<0?-1:0},_t=Math.sqrt;function md(e){return e>1?0:e<-1?Se:Math.acos(e)}function pa(e){return e>1?it:e<-1?-it:Math.asin(e)}function st(){}function Ba(e,a){e&&Dr.hasOwnProperty(e.type)&&Dr[e.type](e,a)}var Mr={Feature:function(e,a){Ba(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ba(r[n].geometry,a)}},Dr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){vn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)vn(r[n],a,0)},Polygon:function(e,a){Ir(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Ir(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ba(r[n],a)}};function vn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Ir(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)vn(e[r],a,1);a.polygonEnd()}function Ut(e,a){e&&Mr.hasOwnProperty(e.type)?Mr[e.type](e,a):Ba(e,a)}function wn(e){return[da(e[1],e[0]),pa(e[2])]}function Wt(e){var a=e[0],r=e[1],n=Oe(r);return[n*Oe(a),n*Me(a),Me(r)]}function ka(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function $a(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function rn(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Ea(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function yn(e){var a=_t(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function kn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function En(e,a){return Fe(e)>Se&&(e-=Math.round(e/lt)*lt),[e,a]}En.invert=En;function fd(e,a,r){return(e%=lt)?a||r?kn(_r(e),Br(a,r)):_r(e):a||r?Br(a,r):En}function Pr(e){return function(a,r){return a+=e,Fe(a)>Se&&(a-=Math.round(a/lt)*lt),[a,r]}}function _r(e){var a=Pr(e);return a.invert=Pr(-e),a}function Br(e,a){var r=Oe(e),n=Me(e),o=Oe(a),i=Me(a);function d(s,l){var m=Oe(l),c=Oe(s)*m,g=Me(s)*m,u=Me(l),b=u*r+c*n;return[da(g*o-b*i,c*r-u*n),pa(b*o+g*i)]}return d.invert=function(s,l){var m=Oe(l),c=Oe(s)*m,g=Me(s)*m,u=Me(l),b=u*o-g*i;return[da(g*o+u*i,c*r+b*n),pa(b*r-c*n)]},d}function hd(e,a,r,n,o,i){if(r){var d=Oe(a),s=Me(a),l=n*r;o==null?(o=a+n*lt,i=a-l/2):(o=$r(d,o),i=$r(d,i),(n>0?o<i:o>i)&&(o+=n*lt));for(var m,c=o;n>0?c>i:c<i;c-=l)m=wn([d,-s*Oe(c),-s*Me(c)]),e.point(m[0],m[1])}}function $r(e,a){a=Wt(a),a[0]-=e,yn(a);var r=md(-a[1]);return((-a[2]<0?-r:r)+lt-Le)%lt}function Qo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:st,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ta(e,a){return Fe(e[0]-a[0])<Le&&Fe(e[1]-a[1])<Le}function ja(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ko(e,a,r,n,o){var i=[],d=[],s,l;if(e.forEach(function(h){if(!((v=h.length-1)<=0)){var v,y=h[0],f=h[v],w;if(Ta(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),s=0;s<v;++s)o.point((y=h[s])[0],y[1]);o.lineEnd();return}f[0]+=2*Le}i.push(w=new ja(y,h,null,!0)),d.push(w.o=new ja(y,null,w,!1)),i.push(w=new ja(f,h,null,!1)),d.push(w.o=new ja(f,null,w,!0))}}),!!i.length){for(d.sort(a),Ur(i),Ur(d),s=0,l=d.length;s<l;++s)d[s].e=r=!r;for(var m=i[0],c,g;;){for(var u=m,b=!0;u.v;)if((u=u.n)===m)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,l=c.length;s<l;++s)o.point((g=c[s])[0],g[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)o.point((g=c[s])[0],g[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Ur(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function on(e){return Fe(e[0])<=Se?e[0]:ud(e[0])*((Fe(e[0])+Se)%lt-Se)}function gd(e,a){var r=on(a),n=a[1],o=Me(n),i=[Me(r),-Oe(r),0],d=0,s=0,l=new Mt;o===1?n=it+Le:o===-1&&(n=-it-Le);for(var m=0,c=e.length;m<c;++m)if(u=(g=e[m]).length)for(var g,u,b=g[u-1],h=on(b),v=b[1]/2+Or,y=Me(v),f=Oe(v),w=0;w<u;++w,h=k,y=N,f=q,b=E){var E=g[w],k=on(E),j=E[1]/2+Or,N=Me(j),q=Oe(j),T=k-h,S=T>=0?1:-1,R=S*T,M=R>Se,U=y*N;if(l.add(da(U*S*Me(R),f*q+U*Oe(R))),d+=M?T+S*lt:T,M^h>=r^k>=r){var H=$a(Wt(b),Wt(E));yn(H);var B=$a(i,H);yn(B);var x=(M^T>=0?-1:1)*pa(B[2]);(n>x||n===x&&(H[0]||H[1]))&&(s+=M^T>=0?1:-1)}}return(d<-Le||d<Le&&l<-1e-12)^s&1}function Jo(e,a,r,n){return function(o){var i=a(o),d=Qo(),s=a(d),l=!1,m,c,g,u={point:b,lineStart:v,lineEnd:y,polygonStart:function(){u.point=f,u.lineStart=w,u.lineEnd=E,c=[],m=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=y,c=Yo(c);var k=gd(m,n);c.length?(l||(o.polygonStart(),l=!0),Ko(c,bd,k,r,o)):k&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),c=m=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function h(k,j){i.point(k,j)}function v(){u.point=h,i.lineStart()}function y(){u.point=b,i.lineEnd()}function f(k,j){g.push([k,j]),s.point(k,j)}function w(){s.lineStart(),g=[]}function E(){f(g[0][0],g[0][1]),s.lineEnd();var k=s.clean(),j=d.result(),N,q=j.length,T,S,R;if(g.pop(),m.push(g),g=null,!!q){if(k&1){if(S=j[0],(T=S.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),N=0;N<T;++N)o.point((R=S[N])[0],R[1]);o.lineEnd()}return}q>1&&k&2&&j.push(j.pop().concat(j.shift())),c.push(j.filter(xd))}}return u}}function xd(e){return e.length>1}function bd(e,a){return((e=e.x)[0]<0?e[1]-it-Le:it-e[1])-((a=a.x)[0]<0?a[1]-it-Le:it-a[1])}const Hr=Jo(function(){return!0},vd,yd,[-Se,-it]);function vd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var s=i>0?Se:-Se,l=Fe(i-a);Fe(l-Se)<Le?(e.point(a,r=(r+d)/2>0?it:-it),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=Se&&(Fe(a-n)<Le&&(a-=n*Le),Fe(i-s)<Le&&(i-=s*Le),r=wd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=d),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function wd(e,a,r,n){var o,i,d=Me(e-r);return Fe(d)>Le?cd((Me(a)*(i=Oe(n))*Me(r)-Me(n)*(o=Oe(a))*Me(e))/(o*i*d)):(a+n)/2}function yd(e,a,r,n){var o;if(e==null)o=r*it,n.point(-Se,o),n.point(0,o),n.point(Se,o),n.point(Se,0),n.point(Se,-o),n.point(0,-o),n.point(-Se,-o),n.point(-Se,0),n.point(-Se,o);else if(Fe(e[0]-a[0])>Le){var i=e[0]<a[0]?Se:-Se;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function kd(e){var a=Oe(e),r=2*et,n=a>0,o=Fe(a)>Le;function i(c,g,u,b){hd(b,e,r,u,c,g)}function d(c,g){return Oe(c)*Oe(g)>a}function s(c){var g,u,b,h,v;return{lineStart:function(){h=b=!1,v=1},point:function(y,f){var w=[y,f],E,k=d(y,f),j=n?k?0:m(y,f):k?m(y+(y<0?Se:-Se),f):0;if(!g&&(h=b=k)&&c.lineStart(),k!==b&&(E=l(g,w),(!E||Ta(g,E)||Ta(w,E))&&(w[2]=1)),k!==b)v=0,k?(c.lineStart(),E=l(w,g),c.point(E[0],E[1])):(E=l(g,w),c.point(E[0],E[1],2),c.lineEnd()),g=E;else if(o&&g&&n^k){var N;!(j&u)&&(N=l(w,g,!0))&&(v=0,n?(c.lineStart(),c.point(N[0][0],N[0][1]),c.point(N[1][0],N[1][1]),c.lineEnd()):(c.point(N[1][0],N[1][1]),c.lineEnd(),c.lineStart(),c.point(N[0][0],N[0][1],3)))}k&&(!g||!Ta(g,w))&&c.point(w[0],w[1]),g=w,b=k,u=j},lineEnd:function(){b&&c.lineEnd(),g=null},clean:function(){return v|(h&&b)<<1}}}function l(c,g,u){var b=Wt(c),h=Wt(g),v=[1,0,0],y=$a(b,h),f=ka(y,y),w=y[0],E=f-w*w;if(!E)return!u&&c;var k=a*f/E,j=-a*w/E,N=$a(v,y),q=Ea(v,k),T=Ea(y,j);rn(q,T);var S=N,R=ka(q,S),M=ka(S,S),U=R*R-M*(ka(q,q)-1);if(!(U<0)){var H=_t(U),B=Ea(S,(-R-H)/M);if(rn(B,q),B=wn(B),!u)return B;var x=c[0],L=g[0],C=c[1],$=g[1],G;L<x&&(G=x,x=L,L=G);var z=L-x,I=Fe(z-Se)<Le,D=I||z<Le;if(!I&&$<C&&(G=C,C=$,$=G),D?I?C+$>0^B[1]<(Fe(B[0]-x)<Le?C:$):C<=B[1]&&B[1]<=$:z>Se^(x<=B[0]&&B[0]<=L)){var Q=Ea(S,(-R+H)/M);return rn(Q,q),[B,wn(Q)]}}}function m(c,g){var u=n?e:Se-e,b=0;return c<-u?b|=1:c>u&&(b|=2),g<-u?b|=4:g>u&&(b|=8),b}return Jo(d,s,i,n?[0,-e]:[-Se,e-Se])}function Ed(e,a,r,n,o,i){var d=e[0],s=e[1],l=a[0],m=a[1],c=0,g=1,u=l-d,b=m-s,h;if(h=r-d,!(!u&&h>0)){if(h/=u,u<0){if(h<c)return;h<g&&(g=h)}else if(u>0){if(h>g)return;h>c&&(c=h)}if(h=o-d,!(!u&&h<0)){if(h/=u,u<0){if(h>g)return;h>c&&(c=h)}else if(u>0){if(h<c)return;h<g&&(g=h)}if(h=n-s,!(!b&&h>0)){if(h/=b,b<0){if(h<c)return;h<g&&(g=h)}else if(b>0){if(h>g)return;h>c&&(c=h)}if(h=i-s,!(!b&&h<0)){if(h/=b,b<0){if(h>g)return;h>c&&(c=h)}else if(b>0){if(h<c)return;h<g&&(g=h)}return c>0&&(e[0]=d+c*u,e[1]=s+c*b),g<1&&(a[0]=d+g*u,a[1]=s+g*b),!0}}}}}var ta=1e9,Na=-ta;function jd(e,a,r,n){function o(m,c){return e<=m&&m<=r&&a<=c&&c<=n}function i(m,c,g,u){var b=0,h=0;if(m==null||(b=d(m,g))!==(h=d(c,g))||l(m,c)<0^g>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+g+4)%4)!==h);else u.point(c[0],c[1])}function d(m,c){return Fe(m[0]-e)<Le?c>0?0:3:Fe(m[0]-r)<Le?c>0?2:1:Fe(m[1]-a)<Le?c>0?1:0:c>0?3:2}function s(m,c){return l(m.x,c.x)}function l(m,c){var g=d(m,1),u=d(c,1);return g!==u?g-u:g===0?c[1]-m[1]:g===1?m[0]-c[0]:g===2?m[1]-c[1]:c[0]-m[0]}return function(m){var c=m,g=Qo(),u,b,h,v,y,f,w,E,k,j,N,q={point:T,lineStart:U,lineEnd:H,polygonStart:R,polygonEnd:M};function T(x,L){o(x,L)&&c.point(x,L)}function S(){for(var x=0,L=0,C=b.length;L<C;++L)for(var $=b[L],G=1,z=$.length,I=$[0],D,Q,V=I[0],ce=I[1];G<z;++G)D=V,Q=ce,I=$[G],V=I[0],ce=I[1],Q<=n?ce>n&&(V-D)*(n-Q)>(ce-Q)*(e-D)&&++x:ce<=n&&(V-D)*(n-Q)<(ce-Q)*(e-D)&&--x;return x}function R(){c=g,u=[],b=[],N=!0}function M(){var x=S(),L=N&&x,C=(u=Yo(u)).length;(L||C)&&(m.polygonStart(),L&&(m.lineStart(),i(null,null,1,m),m.lineEnd()),C&&Ko(u,s,x,i,m),m.polygonEnd()),c=m,u=b=h=null}function U(){q.point=B,b&&b.push(h=[]),j=!0,k=!1,w=E=NaN}function H(){u&&(B(v,y),f&&k&&g.rejoin(),u.push(g.result())),q.point=T,k&&c.lineEnd()}function B(x,L){var C=o(x,L);if(b&&h.push([x,L]),j)v=x,y=L,f=C,j=!1,C&&(c.lineStart(),c.point(x,L));else if(C&&k)c.point(x,L);else{var $=[w=Math.max(Na,Math.min(ta,w)),E=Math.max(Na,Math.min(ta,E))],G=[x=Math.max(Na,Math.min(ta,x)),L=Math.max(Na,Math.min(ta,L))];Ed($,G,e,a,r,n)?(k||(c.lineStart(),c.point($[0],$[1])),c.point(G[0],G[1]),C||c.lineEnd(),N=!1):C&&(c.lineStart(),c.point(x,L),N=!1)}w=x,E=L,k=C}return q}}const jn=e=>e;var sn=new Mt,Nn=new Mt,Xo,Zo,Sn,zn,yt={point:st,lineStart:st,lineEnd:st,polygonStart:function(){yt.lineStart=Nd,yt.lineEnd=zd},polygonEnd:function(){yt.lineStart=yt.lineEnd=yt.point=st,sn.add(Fe(Nn)),Nn=new Mt},result:function(){var e=sn/2;return sn=new Mt,e}};function Nd(){yt.point=Sd}function Sd(e,a){yt.point=ei,Xo=Sn=e,Zo=zn=a}function ei(e,a){Nn.add(zn*e-Sn*a),Sn=e,zn=a}function zd(){ei(Xo,Zo)}var Gt=1/0,Ua=Gt,ca=-Gt,Ha=ca,Va={point:Cd,lineStart:st,lineEnd:st,polygonStart:st,polygonEnd:st,result:function(){var e=[[Gt,Ua],[ca,Ha]];return ca=Ha=-(Ua=Gt=1/0),e}};function Cd(e,a){e<Gt&&(Gt=e),e>ca&&(ca=e),a<Ua&&(Ua=a),a>Ha&&(Ha=a)}var Cn=0,An=0,aa=0,Wa=0,Ga=0,Ht=0,qn=0,Tn=0,na=0,ti,ai,gt,xt,ot={point:Dt,lineStart:Vr,lineEnd:Wr,polygonStart:function(){ot.lineStart=Td,ot.lineEnd=Ld},polygonEnd:function(){ot.point=Dt,ot.lineStart=Vr,ot.lineEnd=Wr},result:function(){var e=na?[qn/na,Tn/na]:Ht?[Wa/Ht,Ga/Ht]:aa?[Cn/aa,An/aa]:[NaN,NaN];return Cn=An=aa=Wa=Ga=Ht=qn=Tn=na=0,e}};function Dt(e,a){Cn+=e,An+=a,++aa}function Vr(){ot.point=Ad}function Ad(e,a){ot.point=qd,Dt(gt=e,xt=a)}function qd(e,a){var r=e-gt,n=a-xt,o=_t(r*r+n*n);Wa+=o*(gt+e)/2,Ga+=o*(xt+a)/2,Ht+=o,Dt(gt=e,xt=a)}function Wr(){ot.point=Dt}function Td(){ot.point=Fd}function Ld(){ni(ti,ai)}function Fd(e,a){ot.point=ni,Dt(ti=gt=e,ai=xt=a)}function ni(e,a){var r=e-gt,n=a-xt,o=_t(r*r+n*n);Wa+=o*(gt+e)/2,Ga+=o*(xt+a)/2,Ht+=o,o=xt*e-gt*a,qn+=o*(gt+e),Tn+=o*(xt+a),na+=o*3,Dt(gt=e,xt=a)}function ri(e){this._context=e}ri.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,lt);break}}},result:st};var Ln=new Mt,ln,oi,ii,ra,oa,ua={point:st,lineStart:function(){ua.point=Rd},lineEnd:function(){ln&&si(oi,ii),ua.point=st},polygonStart:function(){ln=!0},polygonEnd:function(){ln=null},result:function(){var e=+Ln;return Ln=new Mt,e}};function Rd(e,a){ua.point=si,oi=ra=e,ii=oa=a}function si(e,a){ra-=e,oa-=a,Ln.add(_t(ra*ra+oa*oa)),ra=e,oa=a}let Gr,Ya,Yr,Qr;class Kr{constructor(a){this._append=a==null?li:Od(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Yr||this._append!==Ya){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Yr=n,Ya=this._append,Qr=this._,this._=o}this._+=Qr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function li(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Od(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return li;if(a!==Gr){const r=10**a;Gr=a,Ya=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ya}function Md(e,a){let r=3,n=4.5,o,i;function d(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Ut(s,o(i))),i.result()}return d.area=function(s){return Ut(s,o(yt)),yt.result()},d.measure=function(s){return Ut(s,o(ua)),ua.result()},d.bounds=function(s){return Ut(s,o(Va)),Va.result()},d.centroid=function(s){return Ut(s,o(ot)),ot.result()},d.projection=function(s){return arguments.length?(o=s==null?(e=null,jn):(e=s).stream,d):e},d.context=function(s){return arguments.length?(i=s==null?(a=null,new Kr(r)):new ri(a=s),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),d):n},d.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new Kr(r)),d},d.projection(e).digits(r).context(a)}function Un(e){return function(a){var r=new Fn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Fn(){}Fn.prototype={constructor:Fn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Hn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ut(r,e.stream(Va)),a(Va.result()),n!=null&&e.clipExtent(n),e}function di(e,a,r){return Hn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([s,l])},r)}function Dd(e,a,r){return di(e,[[0,0],a],r)}function Id(e,a,r){return Hn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([d,s])},r)}function Pd(e,a,r){return Hn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,s])},r)}var Jr=16,_d=Oe(30*et);function Xr(e,a){return+a?$d(e,a):Bd(e)}function Bd(e){return Un({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function $d(e,a){function r(n,o,i,d,s,l,m,c,g,u,b,h,v,y){var f=m-n,w=c-o,E=f*f+w*w;if(E>4*a&&v--){var k=d+u,j=s+b,N=l+h,q=_t(k*k+j*j+N*N),T=pa(N/=q),S=Fe(Fe(N)-1)<Le||Fe(i-g)<Le?(i+g)/2:da(j,k),R=e(S,T),M=R[0],U=R[1],H=M-n,B=U-o,x=w*H-f*B;(x*x/E>a||Fe((f*H+w*B)/E-.5)>.3||d*u+s*b+l*h<_d)&&(r(n,o,i,d,s,l,M,U,S,k/=q,j/=q,N,v,y),y.point(M,U),r(M,U,S,k,j,N,m,c,g,u,b,h,v,y))}}return function(n){var o,i,d,s,l,m,c,g,u,b,h,v,y={point:f,lineStart:w,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=j},polygonEnd:function(){n.polygonEnd(),y.lineStart=w}};function f(T,S){T=e(T,S),n.point(T[0],T[1])}function w(){g=NaN,y.point=E,n.lineStart()}function E(T,S){var R=Wt([T,S]),M=e(T,S);r(g,u,c,b,h,v,g=M[0],u=M[1],c=T,b=R[0],h=R[1],v=R[2],Jr,n),n.point(g,u)}function k(){y.point=f,n.lineEnd()}function j(){w(),y.point=N,y.lineEnd=q}function N(T,S){E(o=T,S),i=g,d=u,s=b,l=h,m=v,y.point=E}function q(){r(g,u,c,b,h,v,i,d,o,s,l,m,Jr,n),y.lineEnd=k,k()}return y}}var Ud=Un({point:function(e,a){this.stream.point(e*et,a*et)}});function Hd(e){return Un({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Vd(e,a,r,n,o){function i(d,s){return d*=n,s*=o,[a+e*d,r-e*s]}return i.invert=function(d,s){return[(d-a)/e*n,(r-s)/e*o]},i}function Zr(e,a,r,n,o,i){if(!i)return Vd(e,a,r,n,o);var d=Oe(i),s=Me(i),l=d*e,m=s*e,c=d/e,g=s/e,u=(s*r-d*a)/e,b=(s*a+d*r)/e;function h(v,y){return v*=n,y*=o,[l*v-m*y+a,r-m*v-l*y]}return h.invert=function(v,y){return[n*(c*v-g*y+u),o*(b-g*v-c*y)]},h}function Wd(e){return Gd(function(){return e})()}function Gd(e){var a,r=150,n=480,o=250,i=0,d=0,s=0,l=0,m=0,c,g=0,u=1,b=1,h=null,v=Hr,y=null,f,w,E,k=jn,j=.5,N,q,T,S,R;function M(x){return T(x[0]*et,x[1]*et)}function U(x){return x=T.invert(x[0],x[1]),x&&[x[0]*vt,x[1]*vt]}M.stream=function(x){return S&&R===x?S:S=Ud(Hd(c)(v(N(k(R=x)))))},M.preclip=function(x){return arguments.length?(v=x,h=void 0,B()):v},M.postclip=function(x){return arguments.length?(k=x,y=f=w=E=null,B()):k},M.clipAngle=function(x){return arguments.length?(v=+x?kd(h=x*et):(h=null,Hr),B()):h*vt},M.clipExtent=function(x){return arguments.length?(k=x==null?(y=f=w=E=null,jn):jd(y=+x[0][0],f=+x[0][1],w=+x[1][0],E=+x[1][1]),B()):y==null?null:[[y,f],[w,E]]},M.scale=function(x){return arguments.length?(r=+x,H()):r},M.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],H()):[n,o]},M.center=function(x){return arguments.length?(i=x[0]%360*et,d=x[1]%360*et,H()):[i*vt,d*vt]},M.rotate=function(x){return arguments.length?(s=x[0]%360*et,l=x[1]%360*et,m=x.length>2?x[2]%360*et:0,H()):[s*vt,l*vt,m*vt]},M.angle=function(x){return arguments.length?(g=x%360*et,H()):g*vt},M.reflectX=function(x){return arguments.length?(u=x?-1:1,H()):u<0},M.reflectY=function(x){return arguments.length?(b=x?-1:1,H()):b<0},M.precision=function(x){return arguments.length?(N=Xr(q,j=x*x),B()):_t(j)},M.fitExtent=function(x,L){return di(M,x,L)},M.fitSize=function(x,L){return Dd(M,x,L)},M.fitWidth=function(x,L){return Id(M,x,L)},M.fitHeight=function(x,L){return Pd(M,x,L)};function H(){var x=Zr(r,0,0,u,b,g).apply(null,a(i,d)),L=Zr(r,n-x[0],o-x[1],u,b,g);return c=fd(s,l,m),q=kn(a,L),T=kn(c,q),N=Xr(q,j),B()}function B(){return S=R=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&U,H()}}function pi(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}pi.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Fe(o)>Le&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Yd(){return Wd(pi).scale(175.295)}function Qd(e){return e}function Kd(e){if(e==null)return Qd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(s,l){l||(a=r=0);var m=2,c=s.length,g=new Array(c);for(g[0]=(a+=s[0])*n+i,g[1]=(r+=s[1])*o+d;m<c;)g[m]=s[m],++m;return g}}function Jd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Xd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return eo(e,r)})}:eo(e,a)}function eo(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Zd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Zd(e,a){var r=Kd(e.transform),n=e.arcs;function o(c,g){g.length&&g.pop();for(var u=n[c<0?~c:c],b=0,h=u.length;b<h;++b)g.push(r(u[b],b));c<0&&Jd(g,h)}function i(c){return r(c)}function d(c){for(var g=[],u=0,b=c.length;u<b;++u)o(c[u],g);return g.length<2&&g.push(g[0]),g}function s(c){for(var g=d(c);g.length<4;)g.push(g[0]);return g}function l(c){return c.map(s)}function m(c){var g=c.type,u;switch(g){case"GeometryCollection":return{type:g,geometries:c.geometries.map(m)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=d(c.arcs);break;case"MultiLineString":u=c.arcs.map(d);break;case"Polygon":u=l(c.arcs);break;case"MultiPolygon":u=c.arcs.map(l);break;default:return null}return{type:g,coordinates:u}}return m(a)}const ci={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ep=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function tp(e,a,r){const n=ci[e];if(!n||!n.length)return-1;const o=ep(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let Sa=null;function ap(){return Sa||(Sa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Xd(r,n),i=Yd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Md(i),s=(o.features||[]).filter(c=>{var g;return(((g=c.properties)==null?void 0:g.name)||"")!=="Antarctica"}).map(c=>{var b;const g=((b=c.properties)==null?void 0:b.name)||"",u=d(c)||"";return u?{i2:ls(g)||null,n:g,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const l={};for(const[c,g]of Object.entries(ds)){const u=i(g);u&&(l[c]={x:u[0],y:u[1]})}const m={};for(const[c,g]of Object.entries(ci)){const u=g.map(b=>i(b.ll)).filter(b=>!!b).map(([b,h])=>({x:b,y:h}));u.length&&(m[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:m}}catch{return null}})(),Sa)}function np(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return ap().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const rp="8 40 984 210",op={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},to=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function ao(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ip(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var m;if(!o)return;const l=(m=e.current)==null?void 0:m.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return e.current&&s.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function no({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function sp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:s,t:l,data:m,dossiers:c,source:g}=Z(),u=m.loading&&!c.length,b=p.useRef(null),h=p.useRef(null),v=np(e.continent==="monde"),y=e.continent==="monde"?v:Dn.find(x=>x.key===e.continent)||null,f=ip(b,e.continent+":"+e.mapFolded+":"+!!y),[w,E]=p.useState(new Map),[k,j]=p.useState(null);p.useEffect(()=>{const x=b.current;if(!x)return;const L=new Map;x.querySelectorAll("path[data-i2]").forEach(C=>{const $=C.dataset.i2;if($)try{const G=C.getBBox();G.width>0&&L.set($,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),E(L)},[e.continent,f,y]);const N=p.useMemo(()=>r.filter(x=>x.cc),[r]),q=p.useMemo(()=>{const x=new Map;return N.forEach(L=>x.set(L.cc,(x.get(L.cc)||0)+1)),x},[N]),T=e.continent==="monde"&&v?v.anchors:null,S=e.continent==="monde"&&v?v.metros:null,R=p.useMemo(()=>N.map(x=>{const L=ao(x.name||x.id||""),C=ao((x.id||x.name||"")+"·y");if(T&&x.cc){const D=S?S[x.cc]:void 0;if(D&&D.length){const V=tp(x.cc,x.city,L);if(V>=0&&D[V])return{d:x,x:D[V].x+(L-.5)*5,y:D[V].y+(C-.5)*5}}const Q=T[x.cc];if(Q)return{d:x,x:Q.x+(L-.5)*10,y:Q.y+(C-.5)*10}}const $=x.cc?w.get(x.cc):void 0;if(!$)return null;const G=op[`${e.continent}:${x.cc||""}`];if(G)return{d:x,x:$.x+$.w*(G.fx+(L-.5)*G.sx),y:$.y+$.h*(G.fy+(C-.5)*G.sy)};const z=(L-.5)*Math.min($.w*.55,60),I=(C-.5)*Math.min($.h*.55,60);return{d:x,x:$.x+$.w/2+z,y:$.y+$.h/2+I}}).filter(x=>!!x),[N,w,T,S,e.continent]),M=x=>f>0?x/f:x,U=p.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:to[x],fr:l.plabels[x],en:l.plabels[x],n:r.filter(L=>L.kind==="target"&&Te(L)===x).length})).filter(x=>x.n>0):or.map((x,L)=>({...x,n:r.filter(C=>ir(C)===L).length})),[r,n,l.plabels]),H=i?d.get(i):null,B=H?R.find(x=>x.d.id===H.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:[u&&t.jsx(no,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?rp:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?y.fr:y.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:y.countries.map((x,L)=>t.jsx("g",{className:"ct"+(x.i2&&q.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},L))}),t.jsx("g",{children:R.map(x=>{const L=or[ir(x.d)],C=!!_e(x.d),$=x.d.kind==="target",G=n&&$?to[Te(x.d)]:L.c,z=!n&&Ue(x.d);return t.jsxs("g",{className:"co"+(z?" done":""),onMouseEnter:()=>{var Q,V;const I=(Q=h.current)==null?void 0:Q.getBoundingClientRect(),D=(V=b.current)==null?void 0:V.createSVGPoint();if(D&&b.current&&I){D.x=x.x,D.y=x.y;const ce=D.matrixTransform(b.current.getScreenCTM());j({x:ce.x-I.left,y:ce.y-I.top,label:x.d.name+" · "+(Kt(x.d.cc,s)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var Q;if(g==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const I=(Q=b.current)==null?void 0:Q.createSVGPoint();let D=null;if(I&&b.current){I.x=x.x,I.y=x.y;const V=I.matrixTransform(b.current.getScreenCTM());D={x:V.x,y:V.y}}a({type:"popup",id:x.d.id,anchor:D})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:M(Math.max(11,L.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:M(L.px),fill:G,stroke:C?"#E5484D":"#ffffff",strokeWidth:M(C?2.2:1.3)})]},x.d.id||x.d.name)})}),B&&t.jsx("circle",{className:"ring on",cx:B.x,cy:B.y,r:M(13),fill:"none",stroke:"#16233A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:U.map((x,L)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),s==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},L))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:t.jsx(no,{msgs:l.loadMsgs})})}function lp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function ui({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:s}=Z(),l=a.filters,[m,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null),h=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(B=>B.continent===a.continent),[n,a.continent]),y=B=>v.filter(x=>B!=="country"&&l.country.length&&!l.country.includes(x.cc||"")?!1:_a(x,l,i,B==="country"?void 0:B)),f=B=>!i||B.kind!=="op",w=p.useMemo(()=>{const B=y("win").filter(f),x=L=>B.filter(C=>(C.date?Math.max(0,Math.floor((Date.now()-Date.parse(C.date))/864e5)):9999)<=L).length;return[x(0),x(7),x(30),B.length]},[v,l,i]),E=p.useMemo(()=>l.day?y("win").filter(f).filter(B=>(B.date||"").slice(0,10)===l.day).length:0,[v,l,i]),k=(l.signalOnly?1:0)+l.sector.length+l.market.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,j=k+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!m&&!g)return;const B=L=>{var $,G;const C=L.target;m&&!(($=b.current)!=null&&$.contains(C))&&c(!1),g&&!((G=h.current)!=null&&G.contains(C))&&u(!1)},x=L=>{L.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",B),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",B),document.removeEventListener("keydown",x)}},[m,g]);const N=(B,x,L,C="fbtn")=>t.jsxs("button",{type:"button",className:C,"aria-expanded":a.openFacet===B,onClick:()=>r({type:"openFacet",facet:B}),children:[t.jsx("span",{className:"fl",children:x}),L>0&&t.jsx("span",{className:"n",children:L}),t.jsx("span",{className:"cv",children:"▾"})]},B),q=["1","7","30","all"],T=Math.max(0,q.indexOf(l.win||"all")),S=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(lp(l.day,s))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:h,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>u(B=>!B),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:w[T]}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:q.map((B,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===B,onClick:()=>{r({type:"filters",patch:{win:B}}),u(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:w[x]})]},B))})]}):t.jsx("div",{className:"seg",children:q.map((B,x)=>t.jsxs("button",{type:"button","aria-pressed":l.win===B,onClick:()=>r({type:"filters",patch:{win:B}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:w[x]})]},B))}),R=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:B=>r({type:"filters",patch:{search:B.target.value}})})]}),M=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,l.sector.length),(n.some(B=>!!B.market)||l.market.length>0)&&N("mar",o.fMarket,l.market.length),N("pay",o.fCountry,l.country.length),N("det",o.fEngine,l.engine.length),N("sta",o.fStage,l.stage.length),i&&N("crib",o.fVerdict,l.crible.length),i&&N("ang","Angle",l.angle.length),i&&N("mem","Mémo",l.memoLevel.length)]}),U=(B=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),B&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),H=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":m,"aria-haspopup":"true",onClick:()=>{c(B=>!B),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:m?"▴":"▾"})]}),m&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:M})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:S}),t.jsxs("div",{className:"fstrip-b",children:[R,H,U(!1)]})]}),a.openFacet&&t.jsx(ro,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[S,R,M,t.jsx("span",{className:"fgrow"}),U()]}),a.openFacet&&t.jsx(ro,{poolFor:y})]})}function ro({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Z(),s=a.filters,l=a.openFacet,{title:m,cols:c,options:g}=p.useMemo(()=>{if(l==="sig"){const y=e("signal").filter(E=>_e(E)),f=new Map;y.forEach(E=>{const k=E.engine||"";f.set(k,(f.get(k)||0)+1)});const w=[{v:"*",label:n.fpSigAll,n:y.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...gn([...f.keys()],o).map(E=>({v:E,label:Ot(E)+" "+tt(E,o),n:f.get(E)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:w}}if(l==="crib"){const y=e("crible").filter(w=>!i||wo(w,a.ptab,d.favIds)),f=new Map;return y.forEach(w=>{const E=yo(w);E&&E!=="NEW"&&f.set(E,(f.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((w,E)=>(sr[w[0]]??9)-(sr[E[0]]??9)||E[1]-w[1]).map(([w,E])=>({v:w,label:'<span class="fdot" style="background:'+(ps[w]||"#94A3B8")+'"></span>'+w,n:E,html:!0,on:s.crible.includes(w)}))}}if(l==="sec"){const y=e("sector"),f=new Map;return y.forEach(w=>{w.sector&&f.set(w.sector,(f.get(w.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:w,n:E,html:!1,on:s.sector.includes(w)}))}}if(l==="mar"){const y=e("market"),f=new Map;return y.forEach(w=>{w.market&&f.set(w.market,(f.get(w.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...f.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:w,n:E,html:!1,on:s.market.includes(w)}))}}if(l==="pay"){const y=e("country"),f=new Map;return y.forEach(w=>{w.cc&&f.set(w.cc,(f.get(w.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:Kt(w,o)||w,n:E,html:!1,on:s.country.includes(w)}))}}if(l==="det"){const y=e("engine"),f=new Map;return y.forEach(w=>{w.engine&&f.set(w.engine,(f.get(w.engine)||0)+1)}),{title:n.fEngine,cols:2,options:gn([...f.keys()],o).map(w=>({v:w,label:Ot(w)+" "+tt(w,o)+' <span style="color:var(--dim);font-size:10px">· '+cs(us(w),o)+"</span>",n:f.get(w)||0,html:!0,on:s.engine.includes(w)}))}}if(l==="ang"){const y=e("angle"),f=new Map;return y.forEach(w=>{w.angle&&f.set(w.angle,(f.get(w.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:w.replace(/[_-]+/g," "),n:E,html:!1,on:s.angle.includes(w)}))}}if(l==="mem"){const y=e("memoLevel"),f=new Map;y.forEach(E=>{if(E.kind==="target"){const k=Mn(E);f.set(k,(f.get(k)||0)+1)}});const w=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:w[E],n:f.get(E)||0,html:!1,on:s.memoLevel.includes(E)}))}}const h=e("stage"),v=new Map;return h.forEach(y=>{y.stage&&v.set(y.stage,(v.get(y.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:s.stage.includes(y)}))}},[l,a,o]),u=h=>{if(l==="sig"){if(h==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const y=s.signalEngines.includes(h)?s.signalEngines.filter(f=>f!==h):[...s.signalEngines,h];r({type:"filters",patch:{signalOnly:!0,signalEngines:y}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(h)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:h})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:m}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(h=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":h.on,onClick:()=>u(h.v),children:[t.jsx("span",{className:"bx"}),h.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:h.label}}):t.jsx("span",{className:"l",children:h.label}),t.jsx("span",{className:"n",children:h.n})]},h.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function mi({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:s}=Z(),l=p.useMemo(()=>{const b={};return r.forEach(h=>{_a(h,n.filters,i)&&(b.monde=(b.monde||0)+1,h.continent&&(b[h.continent]=(b[h.continent]||0)+1))}),b},[r,n.filters,i]),[m,c]=p.useState(!1),g=p.useRef(null);p.useEffect(()=>{if(!m)return;const b=v=>{var y;(y=g.current)!=null&&y.contains(v.target)||c(!1)},h=v=>{v.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",h)}},[m]);const u=b=>{const h=Dn.find(v=>v.key===b);return b==="monde"?s.contWorld:d==="fr"?h.fr:h.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:g,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":m,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:m?"▴":"▾"})]}),m&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:lr.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[lr.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]})]})}function Rn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function fi(e){return"atl2:evalq:"+(e||"anon")}function dp(e,a){const r=fi(e),n=Rn(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function pp(){const{t:e,lang:a,data:r,dossiers:n}=Z(),o=r.session.token||"",i=fi(o),[d,s]=p.useState(()=>Rn(i)),l=p.useRef(!1),[m,c]=p.useState(!1);p.useEffect(()=>{try{const z=d.slice(0,30).map(({descBusy:I,evalBusy:D,...Q})=>Q);localStorage.setItem(i,JSON.stringify(z)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[d,i]),p.useEffect(()=>{const z=()=>{if(l.current)return;const I=Rn(i);s(D=>JSON.stringify(D.map(({descBusy:Q,evalBusy:V,...ce})=>ce))===JSON.stringify(I)?D:I)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[i]);const[g,u]=p.useState([]),[b,h]=p.useState(""),[v,y]=p.useState(!1),[f,w]=p.useState(!1),[E,k]=p.useState(""),j=p.useCallback((z,I)=>s(D=>D.map((Q,V)=>V===z?{...Q,...I}:Q)),[]),N=p.useCallback((z,I)=>{const D=I.trim();D&&(j(z,{name:D,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),In(D).then(Q=>{const V=Q.candidates||[];Q.website?j(z,{site:Q.website,status:"ready"}):V.length===1?j(z,{site:V[0].url,status:"ready"}):V.length>1?j(z,{status:"pick",candidates:V.slice(0,6)}):j(z,{status:"ready"})}).catch(()=>j(z,{status:"ready"})))},[j]),q=p.useCallback((z,I,D)=>{j(z,{descBusy:!0}),Eo(o,I,D).then(Q=>{if(Q.quota){c(!0),j(z,{descBusy:!1,descDone:!0});return}const V=Q.blocs||{},ce=(V.synthese||V.value_prop||V.produit||V.modele||"").trim();j(z,{descBusy:!1,descDone:!0,desc:ce})}).catch(()=>j(z,{descBusy:!1,descDone:!0}))},[j,o]);p.useEffect(()=>{const z=d.findIndex(D=>D.auto&&D.name.trim()&&D.status==="");if(z>=0){N(z,d[z].name);return}if(m)return;const I=d.findIndex(D=>D.status==="ready"&&D.site&&!D.descDone&&!D.descBusy);I>=0&&q(I,d[I].name,d[I].site)},[d,N,q,m]);const[T,S]=p.useState(!1),R=p.useCallback(async(z,I)=>{j(z,{evalBusy:!0});const D=(I.site||I.name).trim(),Q=await jo(o,D,"atelier2");return Q.verdict==="quota"?(j(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:Q.reason||"",remaining:0}})),!1):(j(z,{evalBusy:!1,status:Q.verdict==="kept"?"kept":"out",reason:Q.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:Q.company||I.name,verdict:Q.verdict,reason:Q.reason||"",remaining:Q.remaining??null}})),!0)},[j,o]),M=async()=>{if(T)return;const z=d.map((I,D)=>({r:I,i:D})).filter(({r:I})=>I.name.trim()&&I.status!=="kept"&&I.status!=="out"&&I.status!=="resolving");if(z.length){S(!0);for(const{r:I,i:D}of z)if(!await R(D,I))break;S(!1)}},U=p.useMemo(()=>{const z=new Set,I=[];return d.filter(D=>D.status==="kept").forEach(D=>{const Q=D.name.trim().toLowerCase();Q&&!z.has(Q)&&(z.add(Q),I.push(D.name.trim()))}),n.filter(D=>Te(D)>=1&&Te(D)<=4&&(D.website||D.domain)).forEach(D=>{const Q=(D.name||"").trim().toLowerCase();Q&&!z.has(Q)&&(z.add(Q),I.push((D.name||"").trim()))}),I},[d,n]),H=p.useMemo(()=>{const z=new Set;return n.forEach(I=>{const D=(I.name||"").trim().toLowerCase();D&&z.add(D)}),d.forEach(I=>{const D=I.name.trim().toLowerCase();D&&z.add(D)}),z},[n,d]),B=async()=>{if(b||!U.length)return;w(!1);const z=[];for(const I of U.slice(0,2)){h(I);const D=await No(o,I);if(D){if(D.verdict==="quota"){y(!0);break}(D.results||[]).forEach(Q=>{const V=(Q.company||"").trim().toLowerCase();!V||H.has(V)||z.some(ce=>ce.name.toLowerCase()===V)||z.push({name:(Q.company||"").trim(),verdict:Q.verdict||"",reason:Q.reason,from:I})})}}h(""),w(!0),u(I=>[...z,...I].slice(0,24))},x=async(z,I)=>{if(b)return;w(!1),h(z==="thesis"?e.pxThesis:I);const D=await fs(o,z,I,6);if(h(""),w(!0),!D)return;if(D.verdict==="quota"){y(!0);return}const Q=[];(D.results||[]).forEach(V=>{const ce=(V.company||"").trim().toLowerCase();!ce||H.has(ce)||Q.some(te=>te.name.toLowerCase()===ce)||Q.push({name:(V.company||"").trim(),verdict:V.verdict||"",reason:V.reason,from:z==="thesis"?e.pxThesis:I})}),u(V=>[...Q,...V].slice(0,24))},L=()=>{const z=E.trim();z.length<3||x(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},C=z=>{s(I=>[...I,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),u(I=>I.filter(D=>D.name!==z.name))},$=d.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,G=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{className:"eq-h-go",children:e.eqRunOneShort})]}),d.map((z,I)=>t.jsxs("div",{className:"eq-item"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:D=>{const Q=D.target.value.split(`
`).map(V=>V.trim()).filter(Boolean);Q.length>1?s(V=>{const ce=[...V];return ce.splice(I,1,...Q.map(te=>({name:te,site:"",status:"",auto:!0}))),ce.slice(0,30)}):j(I,{name:D.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&N(I,z.name)},onKeyDown:D=>{D.key==="Enter"&&N(I,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:D=>{const Q=D.target.value;Q&&j(I,{site:Q,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(z.candidates||[]).map(D=>t.jsx("option",{value:D.url,children:(D.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},D.url))]}),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?m?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>s(D=>D.filter((Q,V)=>V!==I)),children:"×"}),(z.name.trim()||z.site)&&z.status!=="kept"&&z.status!=="out"?t.jsxs(Qa,{lang:a,storeKey:(z.site||z.name).trim(),className:"eq-go",title:e.eqRunOne,disabled:!G(z)||T,confirmLabel:"⚡ "+e.eqRunOneShort,onConfirm:()=>{R(I,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}):t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!G(z)||T,onClick:()=>{R(I,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]})]}),(z.name.trim()||z.site)&&z.status!=="kept"&&z.status!=="out"&&t.jsx(ms,{lang:a,variant:"row",storeKey:(z.site||z.name).trim()})]},I)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>s(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{x("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:z=>k(z.target.value),onKeyDown:z=>{z.key==="Enter"&&L()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:L,children:e.pxGoFree}),!!U.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{B()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!U.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(U[0],U.length)}),v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),f&&!g.length&&!v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),g.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>C(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>s(z=>z.filter(I=>I.status!=="kept"&&I.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(T?" loading":""),style:{justifyContent:"center"},disabled:T||!$,onClick:()=>{M()},children:[t.jsx("span",{className:"fill"}),T?e.eqRunning:e.eqGo($)]})]})]})]})}const cp={deals:"ma-deals",news:"veille"};function oo(e){return(e.url||e.title||"").trim()}function up(e){const a=(e.title||"").replace(/\s+/g," ").trim();if(!a)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const r=/^(.{2,72}?)[:–—|]/.exec(a);return r?r[1].trim():(a.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||a).slice(0,72).trim()}function mp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i,flash:d}=Z(),[s,l]=p.useState(null),[m,c]=p.useState({deals:[],news:[]}),[g,u]=p.useState({deals:!1,news:!1}),[b,h]=p.useState(null),[v,y]=p.useState(""),f=p.useCallback(async S=>{if(!o)return[];if(g[S])return m[S];h(S),y("");const R=Date.now(),M=await hs(cp[S],o,n),U=700-(Date.now()-R);return U>0&&await new Promise(H=>window.setTimeout(H,U)),h(null),!M.ok&&M.error?(y(M.error),[]):(c(H=>({...H,[S]:M.items})),u(H=>({...H,[S]:!0})),M.items)},[o,n,g,m]);p.useEffect(()=>{s&&f(s)},[s,f]);const w=p.useCallback(S=>m[S].map(oo).filter(Boolean),[m]),E=p.useMemo(()=>{var M,U;if(!o)return{deals:[],news:[]};const S={deals:w("deals"),news:w("news")},R=Do("feed:"+o,S);return{deals:((M=R.deals)==null?void 0:M.noms)||[],news:((U=R.news)==null?void 0:U.noms)||[]}},[o,w]),k=p.useRef(null);p.useEffect(()=>{k.current&&!s&&o&&Io("feed:"+o,{deals:w("deals"),news:w("news")}),k.current=s},[s,o,w]);const j=S=>{const R=S.map(up).filter(Boolean);R.length&&(a(R),l(null),d(r.feedSent(R.length)))},N=(S,R)=>{const M=(S.url||"").trim();if(R==="news"&&M&&/^https?:\/\//i.test(M)){window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:M}})),l(null),d(r.feedExtractReady);return}j([S])},q=S=>{l(R=>R===S?null:S)},T=S=>{const R=m[S],M=new Set(E[S].map(H=>H.toLowerCase())),U=b===S||s===S&&!g[S]&&!v;return t.jsxs("div",{className:"dfpane"+(s===S?" on":""),hidden:s!==S,children:[t.jsxs("div",{className:"dfhow",children:[t.jsx("p",{className:"dfh",children:S==="deals"?r.feedDealsH:r.feedNewsH}),t.jsx("p",{className:"dfh2",children:S==="deals"?r.feedDealsHow:r.feedNewsHow})]}),U&&t.jsxs("div",{className:"dfwait",role:"status","aria-live":"polite",children:[t.jsx("i",{className:"dfspin","aria-hidden":"true"}),t.jsxs("div",{children:[t.jsx("b",{children:S==="deals"?r.feedWaitDeals:r.feedWaitNews}),t.jsx("span",{className:"dfbar",children:t.jsx("i",{})})]})]}),s===S&&!!v&&t.jsx("p",{className:"dferr",children:v}),g[S]&&!R.length&&!b&&t.jsx("p",{className:"dfempty",children:S==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!R.length&&!U&&t.jsxs(t.Fragment,{children:[S==="deals"&&i&&R.length>1&&t.jsxs("button",{type:"button",className:"dfall",onClick:()=>j(R),children:[r.feedPutAll," (",R.length,")"]}),t.jsx("ul",{className:"dflist",children:R.map((H,B)=>{const x=oo(H),L=M.has(x.toLowerCase()),C=(H.url||"").trim();return t.jsxs("li",{className:L?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:H.title||C}),t.jsx("span",{children:[H.source,H.sector_fr,(H.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[C&&t.jsx("a",{href:C,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>N(H,S),children:S==="deals"?r.feedPutEval:r.rowExtract})]})]},x||B)})})]})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(S=>{const R=E[S].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(S==="deals"?"ddeals":"dnews")+(s===S?" on":"")+(b===S?" busy":""),title:S==="deals"?r.feedDealsH:r.feedNewsH,"aria-busy":b===S||void 0,onClick:()=>q(S),children:[b===S?n==="en"?"Loading…":"Chargement…":S==="deals"?r.feedDeals:r.feedNews,R>0&&b!==S&&t.jsx("em",{title:r.feedHint,children:r.feedNew(R)})]},S)}),s&&T(s)]})}function hi(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function fp(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function io({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:s}=Z();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(m=>t.jsx("span",{className:"ch",children:m},m))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function gi({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Z(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(io,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(io,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function hp({card:e,onEvaluate:a,onAddAll:r}){var s,l,m;const{t:n}=Z(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hi(e.summary_md||"").map((c,g)=>t.jsx("p",{children:c},g))})]}),t.jsx(gi,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((m=e.prospective)==null?void 0:m.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function gp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function xp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Z(),s=o,[l,m]=p.useState(null),[c,g]=p.useState(null),[u,b]=p.useState(null),[h,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const w=await So({email:d,cbToken:s});f&&m(w)})(),()=>{f=!1}},[d,s,n]);const y=f=>{g(f),b(null),v(!0),(async()=>{const w=await gs(f.id);b(w),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{g(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[gp(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),h&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!h&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!h&&u&&t.jsx(hp,{card:u,onEvaluate:a,onAddAll:r})]})]})}const La=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ia(e){return/^https?:\/\//i.test((e||"").trim())}function ct(e){const a=(e||"").trim();return a?ia(a)?a:La.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function bp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function vp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:s,evalBusy:l,evalCards:m,caps:c,data:g,canWrite:u,source:b,dossiers:h,doAnalyse:v,liveMemos:y,pipe:f}=Z(),w=r==="client",E=p.useMemo(()=>n||(b!=="default"?xs():""),[n,b]),[k,j]=p.useState(""),[N,q]=p.useState(!1),[T,S]=p.useState(""),[R,M]=p.useState(""),[U,H]=p.useState(""),[B,x]=p.useState(!1),[L,C]=p.useState(!1),[$,G]=p.useState([]);p.useEffect(()=>{const F=_=>{const Y=_.detail;Y&&G(ae=>[Y,...ae].slice(0,8))};return window.addEventListener("ppmap:evalcard",F),()=>window.removeEventListener("ppmap:evalcard",F)},[]);const[z,I]=p.useState(!1),[D,Q]=p.useState(!1),[V,ce]=p.useState(!1),te=p.useRef(!1),[le,xe]=p.useState(""),[he,we]=p.useState(""),[pe,Ne]=p.useState(!1),[Ce,ue]=p.useState(!1),[be,ye]=p.useState(0),[ee,P]=p.useState(""),[J,ie]=p.useState(null),[oe,me]=p.useState(null),[W,se]=p.useState(!1),[ve,ke]=p.useState(null),[Ee,ge]=p.useState(0),Pe=p.useRef(!1),Je=k.trim()?La.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const F=new URLSearchParams(window.location.search),_=(F.get("rs")||"").trim(),Y=(F.get("rstext")||"").trim();_&&/^https?:\/\//i.test(_)&&xe(_),Y&&we(Y),(_&&/^https?:\/\//i.test(_)||Y)&&I(!0)},[]),p.useEffect(()=>{const F=_=>{const Y=_.detail||{},ae=String(Y.url||"").trim(),re=String(Y.text||"").trim();ae&&/^https?:\/\//i.test(ae)&&xe(ae),re&&we(re),(ae&&/^https?:\/\//i.test(ae)||re)&&(I(!0),j(""),S(""),Ne(!0),window.setTimeout(()=>Ne(!1),900))};return window.addEventListener("ppmap:research",F),()=>window.removeEventListener("ppmap:research",F)},[]),p.useEffect(()=>{const F=_=>{const Y=_.detail||{},ae=String(Y.name||"").trim();if(!ae)return;I(!1),j(ae),S(ae);const re=ct(String(Y.website||Y.domain||""));M(re),H(ct(String(Y.url||""))),x(!re),q(!0),window.setTimeout(()=>q(!1),900)};return window.addEventListener("ppmap:prefill",F),()=>window.removeEventListener("ppmap:prefill",F)},[]),p.useEffect(()=>{const F=(T||"").trim();if(!F||z||R){(R||!F||z)&&x(!1);return}const _=$e(F),Y=h.find(Ae=>$e(Ae.name)===_)||h.find(Ae=>{const de=$e(Ae.name);return de.length>=3&&(_.includes(de)||de.includes(_))}),ae=ct((Y==null?void 0:Y.website)||"")||ct((Y==null?void 0:Y.domain)||""),re=ct((Y==null?void 0:Y.url)||"");if(re&&H(Ae=>Ae||re),ae){M(ae),x(!1);return}let je=!0;return x(!0),In(F).then(Ae=>{var He,jt;if(!je)return;const de=ct(Ae.website||"")||ct(((jt=(He=Ae.candidates)==null?void 0:He[0])==null?void 0:jt.url)||"");de&&M(de)}).catch(()=>{}).finally(()=>{je&&x(!1)}),()=>{je=!1}},[T,z,R,h]),p.useEffect(()=>{const F=_=>{var ae;const Y=String(((ae=_.detail)==null?void 0:ae.url)||"").trim();ia(Y)&&window.open(Y,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",F),()=>window.removeEventListener("ppmap:view",F)},[]),p.useEffect(()=>{if(te.current===z)return;te.current=z,ce(!0);const F=window.setTimeout(()=>ce(!1),560);return()=>window.clearTimeout(F)},[z]),p.useEffect(()=>{if(typeof window>"u")return;const F=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),_=document.querySelector(".atl2.ops, .atl2.cibles");if(!F||!_)return;const Y=_.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,ae=()=>{const je=parseFloat(window.getComputedStyle(F).top)||0,Ae=F.getBoundingClientRect().top<=je+1;F.classList.toggle("is-stuck",Ae),_.classList.toggle("url-stuck",Ae);const de=Math.round(F.getBoundingClientRect().height);_.style.setProperty("--demand-h",`${de}px`);const He=window.matchMedia("(min-width: 861px)").matches;Y&&He?_.style.setProperty("--pp-live-h",`${Math.round(Y.getBoundingClientRect().height)}px`):_.classList.contains("cibles")&&_.style.setProperty("--pp-live-h","0px")};ae();const re=new ResizeObserver(ae);return re.observe(F),Y&&re.observe(Y),window.addEventListener("scroll",ae,!0),window.addEventListener("resize",ae),()=>{re.disconnect(),F.classList.remove("is-stuck"),_.classList.remove("url-stuck"),window.removeEventListener("scroll",ae,!0),window.removeEventListener("resize",ae)}},[b,N,pe,L,z,V,B]),p.useEffect(()=>{if(!u&&!E){ke(null);return}let F=!0;return(async()=>{const _=await So({email:o,cbToken:E});F&&ke(_.length)})(),()=>{F=!1}},[u,E,o,Ee]);const at=$.length?$:m,ze=g.credits,dt=p.useCallback(F=>{dp(n,F)&&(C(!1),s({type:"ptab",tab:0}),requestAnimationFrame(()=>{const _=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!_)return;const Y=window.scrollY+_.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,Y),behavior:"smooth"})}))},[n,s]);p.useEffect(()=>{if(!Ce)return;ye(0);const F=window.setInterval(()=>ye(_=>_+1),1e3);return()=>window.clearInterval(F)},[Ce]);const nt=p.useMemo(()=>{const F=k.trim().toLowerCase();return!F||!f?null:h.find(_=>$e(_.name)===F&&Te(_)===1)||null},[k,h,f]),Xe=()=>{const F=k.trim();if(F){if(nt){v(nt);return}i(null,F),w&&j("")}},rt=async()=>{var Y,ae,re;if(Pe.current)return;const F=le.trim().replace(/\s+/g,""),_=he.trim();if(!F&&!_){P(e.rsNeed);return}if(!w&&!E){i(null,F||_.slice(0,80));return}Pe.current=!0,P(""),ie(null),me(null),ue(!0);try{const je=await vs({url:F,text:_,email:o,cbToken:E});if(ue(!1),!je||je.status!=="success"){P((je==null?void 0:je.message)||"Erreur");return}ie(je),I(!1),dt((((Y=je.prospective)==null?void 0:Y.companies_to_evaluate)||[]).map(de=>(de==null?void 0:de.name)||"")),me({state:"pending"});const Ae=await ws(je,{email:o,cbToken:E});me(Ae.ok?{state:"ok",scopeLabel:((ae=Ae.summary)==null?void 0:ae.scope_label)||"",scope:((re=Ae.summary)==null?void 0:re.scope)||""}:{state:"fail",msg:Ae.error||""}),Ae.ok&&ge(de=>de+1)}finally{Pe.current=!1,ue(!1)}},At=[J==null?void 0:J.industry,...(J==null?void 0:J.market_tags)||[],J==null?void 0:J.author].map(F=>(F||"").trim()).filter(Boolean),bt=(oe==null?void 0:oe.state)==="pending",Bt=oe&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),$t=fp(J).length,De=z,Ze=(T||k).trim(),Ge=h.find(F=>$e(F.name)===$e(Ze)),mt=ct(k)||R||ct((Ge==null?void 0:Ge.website)||"")||ct((Ge==null?void 0:Ge.domain)||""),Et=U||ct((Ge==null?void 0:Ge.url)||""),qt=nt?e.actAnalyse:Ze?e.evalGoOn(Ze.length>22?Ze.slice(0,21)+"…":Ze):e.evalGo,O=Ce?`${bs(le.trim())==="youtube"&&le.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(be)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(De?" rs-mode":"")+(T&&k.trim()===T||N||pe?" pair":"")+(N||pe||V?" echo":"")+(V?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:De?a==="en"?"Extract companies from an article":"Extraire les sociétés d’un article":a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:De?a==="en"?"Paste an article or video URL — Stan lists the companies, then you pick which ones to screen.":"Collez l’URL d’un article ou d’une vidéo — Stan en sort les sociétés, vous choisissez lesquelles évaluer.":a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((De?pe:N)||V?" flash":"")+((De?le.trim():La.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:De?le:k,placeholder:De?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:De?600:200,spellCheck:De?!1:void 0,inputMode:De?"url":void 0,onChange:F=>{if(De){xe(F.target.value);return}j(F.target.value),T&&F.target.value.trim()!==T&&(S(""),M(""),H(""),x(!1))},onKeyDown:F=>{F.key==="Enter"&&(De?rt():Xe())}}),t.jsx("span",{className:"detect"+(De?" off":"")+(La.test(k.trim())?" url":""),children:Je})]}),t.jsx("span",{className:"dacts",children:De?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Ce?" loading":""),disabled:Ce||bt||!le.trim()&&!he.trim(),onClick:()=>{rt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:O})]}),t.jsxs("a",{className:"viewbtn"+(ia(le)?"":" off"),href:ia(le)?le.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:F=>{ia(le)||F.preventDefault()},children:[t.jsx(bp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(Qa,{lang:a,storeKey:((nt==null?void 0:nt.name)||k).trim(),className:"evalbtn"+(nt?" analyse":"")+(l?" loading":""),disabled:l,confirmLabel:qt,onConfirm:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:qt})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(B?" searching":mt?"":" off"),href:mt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":B||void 0,title:B?e.viewSiteBusyHint:e.viewSiteHint,onClick:F=>{mt||F.preventDefault()},children:[B&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),B?e.viewSiteBusy:e.viewSite,!B&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(Et?"":" off"),href:Et||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:F=>{Et||F.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),c.showCredits&&ze&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(ze.total_available<=0&&!ze.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ze.unlimited?"∞":ze.total_available}),!ze.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ze.daily_grant+ze.purchased]}),ze.total_available<=0&&!ze.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{s({type:"ptab",tab:0}),C(!1),requestAnimationFrame(()=>{const F=document.querySelector(".atl2.cibles .desk-list");if(!F)return;const _=window.scrollY+F.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,_),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(z?" on":""),title:e.rsOpenHint,onClick:()=>I(!z),children:e.rsOpen}),ve!==null&&ve>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(W?" on":""),onClick:()=>se(!W),children:e.rsArchOpen(ve)}),c.pipe&&!!n&&t.jsx(mp,{pageToken:E,onAddNames:dt})]}),W&&t.jsx(xp,{bump:Ee,cbToken:E,onClose:()=>se(!1),onEvaluate:F=>i(null,F),onAddAll:dt}),t.jsx("div",{className:"rsp slim"+(z?" on":" off"),"aria-hidden":!z,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:z?void 0:-1,onClick:()=>Q(F=>!F),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:D?"▴":"▾"})]}),D&&t.jsx("textarea",{className:"rstext",value:he,placeholder:e.rsTextPh,tabIndex:z?void 0:-1,onChange:F=>we(F.target.value)})]})}),ee&&t.jsx("div",{className:"rserr",children:ee}),J&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:J.title}),J.source_url&&t.jsx("a",{href:J.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ie(null),me(null)},children:"×"})]}),J.market&&t.jsx("p",{className:"rsmk",children:J.market}),At.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),At.map(F=>t.jsx("span",{children:F},F))]}),t.jsxs("div",{className:"rsbody",children:[J.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${J.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:hi(J.summary_md||"").map((F,_)=>t.jsx("p",{children:F},_))})]}),t.jsx(gi,{card:J,onEvaluate:F=>i(null,F),onAddAll:dt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound($t)}),Bt]})]}),at.slice(0,1).map((F,_)=>{const Y=F.verdict==="kept",ae=F.verdict==="quota",re=F.verdict==="unresolved",je=Y?"var(--brand)":ae?"var(--bolt)":re?"var(--blue)":"var(--red)",Ae=Y?"var(--brand-l)":ae?"#FFF3D6":re?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":je,"--bgc":Ae},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:Y?"✓ "+e.kept:ae?"⏳":re?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),F.name&&t.jsx("span",{className:"rn",children:F.name}),t.jsx("span",{className:"rr",children:F.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",F.reason]}):null}),!!(F.candidates&&F.candidates.length)&&t.jsx("span",{className:"sitepick",children:F.candidates.map(de=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:de.url.startsWith("http")?de.url:`https://${de.url}`,target:"_blank",rel:"nofollow noopener",children:[(de.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,de.url,F.name),children:e.evalPickGo})]},de.url))}),!ae&&!re&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:Y?1:5});const de=(F.name||"").trim().toLowerCase();window.setTimeout(()=>{const He=[...document.querySelectorAll(".atl2 .list .row")].find(jt=>{var Tt;return(((Tt=jt.querySelector(".rnm"))==null?void 0:Tt.textContent)||"").trim().toLowerCase().includes(de)});He&&(He.scrollIntoView({behavior:"smooth",block:"center"}),He.classList.add("flashrow"),window.setTimeout(()=>He.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(Y?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},_)}),w&&(d.kept+d.dropped>0||at.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function wp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function yp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Z(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",wp(i.summary||"")].filter(Boolean).join(`
