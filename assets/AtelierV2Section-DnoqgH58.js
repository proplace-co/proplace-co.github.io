...
.atl2 .bulk .side .hint{white-space:nowrap}`,Fo=`
...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Po=Oo+Fo;function da(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Do(){const e=da("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Io(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Do();return r==="0"?"client":r==="1"||da("embed")==="1"&&da("chrome")==="1"?"apercu":"client"}const $o={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Bo=e=>$o[e];function Uo(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Ye=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Fn(a)||Uo(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ir(e.cc)})};function Xt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const _o=60*60*1e3;function Vo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>_o?null:a}catch{return null}}function St(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ho=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Yo(e,a,r="default"){const n=r!=="default",i=h.useMemo(()=>e||n?{mode:"anon"}:Tr(),[e,n]),o=h.useMemo(()=>n?"visiteur":Io(e,i),[e,i,n]),l=h.useMemo(()=>Bo(o),[o]),s=o!=="visiteur",p=Ho(r),[g,d]=h.useState([]),[f,u]=h.useState(""),[x,c]=h.useState(null),[b,v]=h.useState(null),[m,y]=h.useState(null),[j,w]=h.useState(()=>new Map),[A,E]=h.useState(()=>new Map),[R,B]=h.useState(""),[C,q]=h.useState(new Set),[M,L]=h.useState(null),[U,k]=h.useState(!0),[N,T]=h.useState(!1),[H,G]=h.useState(0),[Z,z]=h.useState(0),O=h.useRef(0),$=h.useMemo(()=>{var D;if(o!=="client")return"";try{return((D=Lr())==null?void 0:D.email)||""}catch{return""}},[o]);h.useEffect(()=>{const D=++O.current;let _=!0;const W=()=>_&&D===O.current,X=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),re=Vo(X);return re?(d(re.objs.map(Ye)),re.fund&&u(re.fund),c(re.marketEstimate??null),v(re.criteria??null),y(re.stats??null),B(re.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const me=await Kt(),pe=((me==null?void 0:me.recent_ops)||[]).map(Q=>{const te=Qt(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),ve=String(Q.rubrique||"").toLowerCase();return te&&(ve==="nominations"||ve==="recrutements")&&(te.engine=ve),te&&!String(Q.company_name||"").trim()&&(te.noCo=!0),te}).filter(Q=>!!Q).map(Q=>(Fn((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=await Rr(),te=qr(Q),ve=((Q==null?void 0:Q.date)||"").slice(0,10);if(te.length&&ve){const K=new Set;for(const se of pe){if(se.noCo||(se.date||"").slice(0,10)!==ve)continue;const ee=Ia(te,K,se.name,"");ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}for(const se of pe){if(se.decryptHtml||(se.date||"").slice(0,10)!==ve)continue;const ee=Ia(te,K,"",se.headline||se.tagline||se.name);ee>=0&&(K.add(ee),se.decryptHtml=te[ee].html)}}}catch{}if(!W())return;d(pe.map(Ye)),St(X,{objs:pe})}else if(typeof r=="object"){const pe=(await $a()||[]).filter(te=>(te.slug||"")===r.research).map(te=>Ba(te,a)).filter(te=>!!te),Q=Xt(await Ua(pe,a));if(!W())return;d(Q.map(Ye)),St(X,{objs:Q})}else if(s&&i.token){const me=Mr(i.token),pe=Kt(),Q=Or(i.token),te=Fr(i.token),ve=Pr(i.token),K=await me;let se=K?K.targets:[];W()&&K&&(u(K.fund||""),c(K.marketEstimate??null),v(K.criteria??null),y(K.stats??null),B(K.generatedAt||""),d(se.map(Ye)),k(!1),T(!1));const[ee,_e,xe,ge]=await Promise.all([pe,Q,te,ve]),Ie=((ee==null?void 0:ee.recent_ops)||[]).map(Se=>Qt(Se,a)).filter(Se=>!!Se);if(se=[...se,...Ie],!W())return;d(se.map(Ye));const He=new Set;for(const Se of _e){const $e=(Se.id||Se.co||"").toString().trim().toLowerCase();$e&&He.add($e.startsWith("t:")?$e:"t:"+$e)}q(He),w(xe),E(ge),K&&St(X,{fund:K.fund,marketEstimate:K.marketEstimate,criteria:K.criteria,stats:K.stats,generatedAt:K.generatedAt,objs:se})}else{const me=Dr(),pe=$a(),Q=Kt(),te=await me;W()&&te.length&&(d(Xt(te).map(Ye)),k(!1),T(!1));const[ve,K]=await Promise.all([pe,Q]),se=(ve||[]).map(ge=>Ba(ge,a)).filter(ge=>!!ge),ee=await Ua(se,a),_e=((K==null?void 0:K.recent_ops)||[]).map(ge=>Qt(ge,a)).filter(ge=>!!ge),xe=Xt([...te,...ee,..._e]);if(!W())return;d(xe.map(Ye)),St(X,{objs:xe})}W()&&T(!1)}catch{W()&&!re&&T(!0)}finally{W()&&k(!1)}})(),()=>{_=!1}},[s,i.token,a,H,p]),h.useEffect(()=>{if(!l.showCredits||!$){L(null);return}let D=!0;return(async()=>{try{const _=await fetch(`${Ca}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$})});if(!_.ok)return;const W=await _.json();D&&W&&W.ok!==!1&&L(W)}catch{}})(),()=>{D=!1}},[l.showCredits,$,Z]);const P=h.useCallback(D=>q(new Set(D)),[]);return{session:i,mode:o,caps:l,fund:f,email:$,marketEstimate:x,generatedAt:R,criteria:b,stats:m,thumbs:j,stages:A,dossiers:g,favIds:C,setFavIds:P,credits:M,reloadCredits:()=>z(D=>D+1),loading:U,error:N,refresh:()=>G(D=>D+1)}}const Un=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Wo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Un(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Go(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Un(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??_n)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const _n=40;function Ta(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!he(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ea(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ot(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ge(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Vn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ta(e,a.filters,r)}function Ko(e,a,r,n){return!(!Vn(e,a,r)||r&&!$r(e,a.ptab,n))}function La(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ot(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=he(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const Qo=["ma","levees","nominations","recrutements","actualites"],Jo=300,Zt=7,Xo={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Hn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Zo=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ja(e){const a=he(e);if(a)return"sig:"+(a.theme&&Hn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function ei(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=F(),s=l==="en",[p,g]=h.useState("all"),[d,f]=h.useState(!1),u=h.useMemo(()=>{const C=(a.filters.day||"").slice(0,10),q=k=>!(!o&&a.continent!=="monde"&&k.continent!==a.continent||C&&(k.date||"").slice(0,10)!==C),M=e.filter(k=>q(k)&&he(k)),L=e.filter(k=>q(k)&&k.kind==="op"&&!he(k)&&(C?!0:ot(k.date)<=Zt)),U=C||new Date().toISOString().slice(0,10);return L.sort((k,N)=>{const T=(k.date||"").slice(0,10)===U?0:1,H=(N.date||"").slice(0,10)===U?0:1;return T!==H?T-H:(N.amountEur||0)-(k.amountEur||0)}),[...La(M,{key:"signal",dir:-1}),...L]},[e,a.continent,a.filters.day,o]),x=h.useMemo(()=>{const C={};for(const q of u){const M=Ja(q);C[M]=(C[M]||0)+1}return C},[u]),c=h.useMemo(()=>p==="all"?u:u.filter(C=>Ja(C)===p),[u,p]),b=h.useMemo(()=>c.slice(0,Jo),[c]),v=c.length-b.length,m=C=>C==="all"?u.length:x[C]||0,y=C=>C==="all"?s?"All":"Tout":C.startsWith("sig:")?Hn[s?"en":"fr"][C.slice(4)]||"🔔":Xo[s?"en":"fr"][C],j=[{k:"all"}],w=Qo.filter(C=>m(C)>0||C===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const C of w)j.push({k:C})}const A=Zo.map(C=>"sig:"+C).filter(C=>m(C)>0||C===p);if(A.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const C of A)j.push({k:C})}const E=C=>{try{return new Date(C+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return C}},R=(()=>{const C=(a.filters.day||"").slice(0,10),q=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return C?(s?`LIVE covers the events of ${E(C)}.`:`Le LIVE regroupe les événements du ${E(C)}.`)+q:(s?`LIVE covers the still-open signals and the deals of the last ${Zt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Zt} derniers jours.`)+q})(),B=C=>b.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ae(q)?" spent":""),onClick:M=>{const L=M.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:L.left+L.width/2,y:L.bottom}})},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(Xe,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(yr,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Ml(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Ht,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},C+(q.id||q.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},C+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:C=>{C.currentTarget.contains(C.relatedTarget)||f(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":d,onClick:()=>f(C=>!C),children:[y(p),t.jsx("b",{children:m(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!d,children:[t.jsx("span",{className:"tkfilscope",children:R}),j.map(C=>"g"in C?t.jsx("span",{className:"tkfilg",children:C.g},C.g):t.jsxs("button",{type:"button","aria-pressed":C.k===p,onClick:()=>{g(C.k),f(!1)},children:[y(C.k),t.jsx("b",{children:m(C.k)})]},C.k))]})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[B(0),B(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const ti="aDx8z7Hzksus",Yn="+33 6 83 10 72 86",Xa="alexandre@proplace.co",ai=`tel:${Yn.replace(/[^\d+]/g,"")}`,Za="pp-rdv-slot";function ni(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ri(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:ii}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:ai,children:Yn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Xa}`,children:Xa})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Lo,{filloutId:ti,parameters:r?{company_name:r}:void 0})})]})}function oi(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById(Za));return h.useEffect(()=>{e||a(document.getElementById(Za))},[e]),e?it.createPortal(t.jsx(ri,{}),e):null}const ii=`
...
`;class be extends h.Component{constructor(){super(...arguments);Pa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const si=8;function li(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,p]=h.useState(!1),[g,d]=h.useState(!1),[f,u]=h.useState(!1),x=r||"home",{names:c,verdicts:b}=h.useMemo(()=>{const w=[],A={};return n.forEach(E=>{E.kind!=="target"||!E.name||(w.push(E.name),A[E.name]=Br(E)||"")}),{names:w,verdicts:A}},[n]),v=h.useMemo(()=>c.length?Ur(x,c,b,a):null,[x,c.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const m=g?v.added:v.added.slice(0,si),y=v.added.length-m.length,j=w=>{const A=n.find(E=>E.name===w);A&&(o(A.id),l({type:"popup",id:A.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),_r(x,c,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[m.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),f&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const ea=600,We=62,en="atl2:fstats";function di(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(en)==="on"}catch{return!1}}),p=r.stats,g=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const f=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),x=g.reduce((y,j)=>Math.max(y,j.s||0),0),c=g.length?ea/g.length:0,b=Math.max(4,c-4),v=g.length>=5&&x>0,m=[[p.screened,e.funScreened(f(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[m.map(([y,j,w],A)=>t.jsxs("span",{className:"fst-t",children:[A>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(en,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ea} ${We}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((y,j)=>{const w=(y.s||0)/x*(We-4),A=(y.m||0)/x*(We-4),E=j*c+(c-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:E,y:We-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:E,y:We-2-A,width:b,height:A,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:We-1.5,x2:ea,y2:We-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const ci=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function pi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(Ze(e)||"").startsWith("CALL")&&ke(e)===3,f=ke(e)>=2,u=async c=>{if(o||c==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(c);const b=await i(e,c);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},x=d?[["Validé",a.csYes],["Écarté",a.csNo]]:ci.filter(([c])=>!(f&&c==="Retenu")).map(([c,b])=>[c,a[b]]);return t.jsxs("div",{className:"csp",onClick:c=>c.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),x.map(([c,b])=>t.jsx("button",{type:"button",className:"csb"+(g===c?" on":"")+(o===c?" busy":""),disabled:!!o,onClick:()=>{u(c)},children:b},c)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ui,{o:e})]})}function ui({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,g]=h.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{f()},children:p?a.csNoteSaved:a.csNoteOk})]})}function fi({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function mi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[p,g]=h.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const d=o(e),f=(d==null?void 0:d.stage)||"todo",u=async m=>{if(p||m===f)return;g(!0);const y=d;l(e,{stage:m,stamps:(d==null?void 0:d.stamps)||{}});const j=Math.max(Date.now(),tn+=1);tn=j;const w=await Vr(r,{company:e.name||"",stage:m,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},x=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,c=x?Math.floor((Date.now()-Date.parse(x))/864e5):0,b=f==="sent"&&x&&c>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(f===m?" on":""),disabled:p,onClick:()=>{u(m)},children:y},m)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(c)})]})}let tn=0;const Ct=8,Et=340;function an({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function xi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=h.useState(0),[p,g]=h.useState(null),[d,f]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,f(e.filter(j=>!!document.querySelector(j.need||j.sel))))},[e]);const x=d[l],c=l>=d.length;h.useEffect(()=>{x&&(x.ptab!==void 0&&o.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&o.dens!==x.dens&&n({type:"dens",dens:x.dens}),o.modal!==(x.modal??null)&&n({type:"modal",modal:x.modal??null}))},[l,x]);const b=h.useCallback(()=>{if(!x){g(null);return}const j=document.querySelector(x.sel);if(!j){g(null);return}j.scrollIntoView({block:"nearest",behavior:"smooth"}),g(j.getBoundingClientRect())},[x]);h.useLayoutEffect(()=>{b();const j=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(j),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=h.useRef(a);if(v.current=a,h.useEffect(()=>{const j=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(A=>A+1):w.key==="ArrowLeft"&&s(A=>Math.max(0,A-1))};return document.addEventListener("keydown",j,!0),()=>document.removeEventListener("keydown",j,!0)},[]),!d.length)return null;let m=null;if(c){const j=i[3]||0;j>0?m={title:j===1?r.ahaATitle1:r.ahaATitleN(j),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?m={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:m={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Et};if(!c&&p){const j=p.bottom+14,A=window.innerHeight-j>190?j:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-Et/2),window.innerWidth-Et-12),top:A,width:Et}}return it.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!c&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-Ct,top:p.top-Ct,width:p.width+Ct*2,height:p.height+Ct*2}}),(c||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(c?" fin":""),style:y,children:[c&&m?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:m.title}),t.jsx("p",{children:t.jsx(an,{text:m.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:m.go,children:m.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(l+1,d.length)}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx("p",{children:t.jsx(an,{text:(x==null?void 0:x.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(j=>Math.max(0,j-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(j=>j+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function hi(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=F(),s=r?a:e,p=h.useMemo(()=>s.filter(m=>ot(m.date)===0&&m.kind==="target"),[s]),g=h.useMemo(()=>r?a.filter(m=>ke(m)===0).slice().sort((m,y)=>(y.date||"").localeCompare(m.date||"")):[],[a,r]),d=h.useMemo(()=>p.filter(m=>r?ke(m)===0:!Ae(m)),[p,r]),f=r?g:d,u=r?a.length-g.length:p.length-d.length,x=r?a.length:p.length,c=x?Math.min(100,u/x*100):100;let b;r?b=i.morningThesis(p.length,g.length):p.length?u===0?b=i.goalSourced(p.length):u>=p.length?b=i.goalCleared:b=i.goalDone(u,p.length):b=i.goalSourced(0);const v=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(m=>m.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:c+"%"}})}),f.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:v,children:r?i.morningEval(f.length):o.pileMode?i.goalContinue(f.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function gi(){var q,M;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:g,startTour:d}=F(),[f,u]=h.useState(null),[x,c]=h.useState([]),b=p==="client";h.useEffect(()=>{if(!i||!o)return;let L=!0;return(async()=>{const[U,k]=await Promise.all([Aa(o),Pn(i)]);L&&(U&&u(U),c(k))})(),()=>{L=!1}},[i,o]);const v=(f==null?void 0:f.per_day)??null,m=((q=f==null?void 0:f.pool_order)==null?void 0:q.length)??0,y=x.filter(L=>L.status==="running").length,j=h.useMemo(()=>s.filter(L=>L.kind==="target"&&Ae(L)).length,[s]),w=l.marketEstimate,A=typeof((M=l.stats)==null?void 0:M.screened)=="number"?l.stats.screened:j,E=w&&w>0?Math.min(100,Math.round(A/w*100)):null,R=L=>L.toLocaleString(a==="en"?"en-US":"fr-FR"),B=(o||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),C=(()=>{const L=Date.parse(l.generatedAt||"");if(Number.isNaN(L))return"";const U=new Date(L),k=N=>String(N).padStart(2,"0");return`${k(U.getDate())}/${k(U.getMonth()+1)} à ${k(U.getHours())}:${k(U.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:B}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),C&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(C)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[E===null&&A>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(A)})})]}),E!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:E+"%"}})}),t.jsxs("b",{children:[E," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(A,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(m)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function bi(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const vi=["--p0","--p1","--p2","--p3","--p4"];function yi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,p=h.useRef({});h.useEffect(()=>{p.current={...r}},[r]);const g=u=>{const x=p.current[u],c=x!==void 0?r[u]-x:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${vi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[u],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},u)},d=(u,x,c)=>t.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),f=(u,x,c,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:c,children:u},x);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const wi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function ki(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=h.useRef(null),[p,g]=h.useState(60);h.useEffect(()=>{let x=0;const c=()=>{var j;const b=s.current;if(!b)return;const v=(j=b.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!v)return;const m=v.getBoundingClientRect(),y=b.getBoundingClientRect();g(Math.max(20,Math.min(m.left+m.width/2-y.left,y.width-30)))};return x=requestAnimationFrame(c),window.addEventListener("resize",c),()=>{cancelAnimationFrame(x),window.removeEventListener("resize",c)}},[e.ptab]);const d=e.ptab;let f=r.tuto[d].p;if(d===3){const x=n.filter(v=>v.kind==="target"&&ke(v)===3),c=x.filter(v=>ia(v)==="auto").length,b=x.filter(v=>ia(v)==="cd").length;f=r.tutoPending(c,b,x.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(x=>x.id)})};if(d===1){const x=n.filter(c=>c.kind==="target"&&ke(c)===1&&!i.has(c.id)).slice(0,10);if(x.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:x.map(c=>c.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":wi[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:f}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Qe{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*ji(e){for(const a of e)yield*a}function Wn(e){return Array.from(ji(e))}var ne=1e-6,J=Math.PI,Te=J/2,nn=J/4,Re=J*2,Be=180/J,Ee=J/180,ie=Math.abs,Ni=Math.atan,gt=Math.atan2,de=Math.cos,ce=Math.sin,Si=Math.sign||function(e){return e>0?1:e<0?-1:0},et=Math.sqrt;function Ci(e){return e>1?0:e<-1?J:Math.acos(e)}function bt(e){return e>1?Te:e<-1?-Te:Math.asin(e)}function Le(){}function Ot(e,a){e&&on.hasOwnProperty(e.type)&&on[e.type](e,a)}var rn={Feature:function(e,a){Ot(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Ot(r[n].geometry,a)}},on={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ca(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ca(r[n],a,0)},Polygon:function(e,a){sn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)sn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Ot(r[n],a)}};function ca(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function sn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ca(e[r],a,1);a.polygonEnd()}function tt(e,a){e&&rn.hasOwnProperty(e.type)?rn[e.type](e,a):Ot(e,a)}function pa(e){return[gt(e[1],e[0]),bt(e[2])]}function nt(e){var a=e[0],r=e[1],n=de(r);return[n*de(a),n*ce(a),ce(r)]}function At(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ft(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function zt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ua(e){var a=et(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function fa(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function ma(e,a){return ie(e)>J&&(e-=Math.round(e/Re)*Re),[e,a]}ma.invert=ma;function Ei(e,a,r){return(e%=Re)?a||r?fa(dn(e),cn(a,r)):dn(e):a||r?cn(a,r):ma}function ln(e){return function(a,r){return a+=e,ie(a)>J&&(a-=Math.round(a/Re)*Re),[a,r]}}function dn(e){var a=ln(e);return a.invert=ln(-e),a}function cn(e,a){var r=de(e),n=ce(e),i=de(a),o=ce(a);function l(s,p){var g=de(p),d=de(s)*g,f=ce(s)*g,u=ce(p),x=u*r+d*n;return[gt(f*i-x*o,d*r-u*n),bt(x*i+f*o)]}return l.invert=function(s,p){var g=de(p),d=de(s)*g,f=ce(s)*g,u=ce(p),x=u*i-f*o;return[gt(f*i+u*o,d*r+x*n),bt(x*r-d*n)]},l}function Ai(e,a,r,n,i,o){if(r){var l=de(a),s=ce(a),p=n*r;i==null?(i=a+n*Re,o=a-p/2):(i=pn(l,i),o=pn(l,o),(n>0?i<o:i>o)&&(i+=n*Re));for(var g,d=i;n>0?d>o:d<o;d-=p)g=pa([l,-s*de(d),-s*ce(d)]),e.point(g[0],g[1])}}function pn(e,a){a=nt(a),a[0]-=e,ua(a);var r=Ci(-a[1]);return((-a[2]<0?-r:r)+Re-ne)%Re}function Gn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Le,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Mt(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Tt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Kn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(c){if(!((b=c.length-1)<=0)){var b,v=c[0],m=c[b],y;if(Mt(v,m)){if(!v[2]&&!m[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=c[s])[0],v[1]);i.lineEnd();return}m[0]+=2*ne}o.push(y=new Tt(v,c,null,!0)),l.push(y.o=new Tt(v,null,y,!1)),o.push(y=new Tt(m,c,null,!1)),l.push(y.o=new Tt(m,null,y,!0))}}),!!o.length){for(l.sort(a),un(o),un(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var g=o[0],d,f;;){for(var u=g,x=!0;u.v;)if((u=u.n)===g)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(x)for(s=0,p=d.length;s<p;++s)i.point((f=d[s])[0],f[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(x)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((f=d[s])[0],f[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,x=!x}while(!u.v);i.lineEnd()}}}function un(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function aa(e){return ie(e[0])<=J?e[0]:Si(e[0])*((ie(e[0])+J)%Re-J)}function zi(e,a){var r=aa(a),n=a[1],i=ce(n),o=[ce(r),-de(r),0],l=0,s=0,p=new Qe;i===1?n=Te+ne:i===-1&&(n=-Te-ne);for(var g=0,d=e.length;g<d;++g)if(u=(f=e[g]).length)for(var f,u,x=f[u-1],c=aa(x),b=x[1]/2+nn,v=ce(b),m=de(b),y=0;y<u;++y,c=w,v=E,m=R,x=j){var j=f[y],w=aa(j),A=j[1]/2+nn,E=ce(A),R=de(A),B=w-c,C=B>=0?1:-1,q=C*B,M=q>J,L=v*E;if(p.add(gt(L*C*ce(q),m*R+L*de(q))),l+=M?B+C*Re:B,M^c>=r^w>=r){var U=Ft(nt(x),nt(j));ua(U);var k=Ft(o,U);ua(k);var N=(M^B>=0?-1:1)*bt(k[2]);(n>N||n===N&&(U[0]||U[1]))&&(s+=M^B>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function Qn(e,a,r,n){return function(i){var o=a(i),l=Gn(),s=a(l),p=!1,g,d,f,u={point:x,lineStart:b,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=j,d=[],g=[]},polygonEnd:function(){u.point=x,u.lineStart=b,u.lineEnd=v,d=Wn(d);var w=zi(g,n);d.length?(p||(i.polygonStart(),p=!0),Kn(d,Li,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),d=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function x(w,A){e(w,A)&&i.point(w,A)}function c(w,A){o.point(w,A)}function b(){u.point=c,o.lineStart()}function v(){u.point=x,o.lineEnd()}function m(w,A){f.push([w,A]),s.point(w,A)}function y(){s.lineStart(),f=[]}function j(){m(f[0][0],f[0][1]),s.lineEnd();var w=s.clean(),A=l.result(),E,R=A.length,B,C,q;if(f.pop(),g.push(f),f=null,!!R){if(w&1){if(C=A[0],(B=C.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),E=0;E<B;++E)i.point((q=C[E])[0],q[1]);i.lineEnd()}return}R>1&&w&2&&A.push(A.pop().concat(A.shift())),d.push(A.filter(Ti))}}return u}}function Ti(e){return e.length>1}function Li(e,a){return((e=e.x)[0]<0?e[1]-Te-ne:Te-e[1])-((a=a.x)[0]<0?a[1]-Te-ne:Te-a[1])}const fn=Qn(function(){return!0},Ri,Mi,[-J,-Te]);function Ri(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?J:-J,p=ie(o-a);ie(p-J)<ne?(e.point(a,r=(r+l)/2>0?Te:-Te),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=J&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=qi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function qi(e,a,r,n){var i,o,l=ce(e-r);return ie(l)>ne?Ni((ce(a)*(o=de(n))*ce(r)-ce(n)*(i=de(a))*ce(e))/(i*o*l)):(a+n)/2}function Mi(e,a,r,n){var i;if(e==null)i=r*Te,n.point(-J,i),n.point(0,i),n.point(J,i),n.point(J,0),n.point(J,-i),n.point(0,-i),n.point(-J,-i),n.point(-J,0),n.point(-J,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?J:-J;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Oi(e){var a=de(e),r=2*Ee,n=a>0,i=ie(a)>ne;function o(d,f,u,x){Ai(x,e,r,u,d,f)}function l(d,f){return de(d)*de(f)>a}function s(d){var f,u,x,c,b;return{lineStart:function(){c=x=!1,b=1},point:function(v,m){var y=[v,m],j,w=l(v,m),A=n?w?0:g(v,m):w?g(v+(v<0?J:-J),m):0;if(!f&&(c=x=w)&&d.lineStart(),w!==x&&(j=p(f,y),(!j||Mt(f,j)||Mt(y,j))&&(y[2]=1)),w!==x)b=0,w?(d.lineStart(),j=p(y,f),d.point(j[0],j[1])):(j=p(f,y),d.point(j[0],j[1],2),d.lineEnd()),f=j;else if(i&&f&&n^w){var E;!(A&u)&&(E=p(y,f,!0))&&(b=0,n?(d.lineStart(),d.point(E[0][0],E[0][1]),d.point(E[1][0],E[1][1]),d.lineEnd()):(d.point(E[1][0],E[1][1]),d.lineEnd(),d.lineStart(),d.point(E[0][0],E[0][1],3)))}w&&(!f||!Mt(f,y))&&d.point(y[0],y[1]),f=y,x=w,u=A},lineEnd:function(){x&&d.lineEnd(),f=null},clean:function(){return b|(c&&x)<<1}}}function p(d,f,u){var x=nt(d),c=nt(f),b=[1,0,0],v=Ft(x,c),m=At(v,v),y=v[0],j=m-y*y;if(!j)return!u&&d;var w=a*m/j,A=-a*y/j,E=Ft(b,v),R=zt(b,w),B=zt(v,A);ta(R,B);var C=E,q=At(R,C),M=At(C,C),L=q*q-M*(At(R,R)-1);if(!(L<0)){var U=et(L),k=zt(C,(-q-U)/M);if(ta(k,R),k=pa(k),!u)return k;var N=d[0],T=f[0],H=d[1],G=f[1],Z;T<N&&(Z=N,N=T,T=Z);var z=T-N,O=ie(z-J)<ne,$=O||z<ne;if(!O&&G<H&&(Z=H,H=G,G=Z),$?O?H+G>0^k[1]<(ie(k[0]-N)<ne?H:G):H<=k[1]&&k[1]<=G:z>J^(N<=k[0]&&k[0]<=T)){var P=zt(C,(-q+U)/M);return ta(P,R),[k,pa(P)]}}}function g(d,f){var u=n?e:J-e,x=0;return d<-u?x|=1:d>u&&(x|=2),f<-u?x|=4:f>u&&(x|=8),x}return Qn(l,s,o,n?[0,-e]:[-J,e-J])}function Fi(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],g=a[1],d=0,f=1,u=p-l,x=g-s,c;if(c=r-l,!(!u&&c>0)){if(c/=u,u<0){if(c<d)return;c<f&&(f=c)}else if(u>0){if(c>f)return;c>d&&(d=c)}if(c=i-l,!(!u&&c<0)){if(c/=u,u<0){if(c>f)return;c>d&&(d=c)}else if(u>0){if(c<d)return;c<f&&(f=c)}if(c=n-s,!(!x&&c>0)){if(c/=x,x<0){if(c<d)return;c<f&&(f=c)}else if(x>0){if(c>f)return;c>d&&(d=c)}if(c=o-s,!(!x&&c<0)){if(c/=x,x<0){if(c>f)return;c>d&&(d=c)}else if(x>0){if(c<d)return;c<f&&(f=c)}return d>0&&(e[0]=l+d*u,e[1]=s+d*x),f<1&&(a[0]=l+f*u,a[1]=s+f*x),!0}}}}}var pt=1e9,Lt=-pt;function Pi(e,a,r,n){function i(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function o(g,d,f,u){var x=0,c=0;if(g==null||(x=l(g,f))!==(c=l(d,f))||p(g,d)<0^f>0)do u.point(x===0||x===3?e:r,x>1?n:a);while((x=(x+f+4)%4)!==c);else u.point(d[0],d[1])}function l(g,d){return ie(g[0]-e)<ne?d>0?0:3:ie(g[0]-r)<ne?d>0?2:1:ie(g[1]-a)<ne?d>0?1:0:d>0?3:2}function s(g,d){return p(g.x,d.x)}function p(g,d){var f=l(g,1),u=l(d,1);return f!==u?f-u:f===0?d[1]-g[1]:f===1?g[0]-d[0]:f===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,f=Gn(),u,x,c,b,v,m,y,j,w,A,E,R={point:B,lineStart:L,lineEnd:U,polygonStart:q,polygonEnd:M};function B(N,T){i(N,T)&&d.point(N,T)}function C(){for(var N=0,T=0,H=x.length;T<H;++T)for(var G=x[T],Z=1,z=G.length,O=G[0],$,P,D=O[0],_=O[1];Z<z;++Z)$=D,P=_,O=G[Z],D=O[0],_=O[1],P<=n?_>n&&(D-$)*(n-P)>(_-P)*(e-$)&&++N:_<=n&&(D-$)*(n-P)<(_-P)*(e-$)&&--N;return N}function q(){d=f,u=[],x=[],E=!0}function M(){var N=C(),T=E&&N,H=(u=Wn(u)).length;(T||H)&&(g.polygonStart(),T&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),H&&Kn(u,s,N,o,g),g.polygonEnd()),d=g,u=x=c=null}function L(){R.point=k,x&&x.push(c=[]),A=!0,w=!1,y=j=NaN}function U(){u&&(k(b,v),m&&w&&f.rejoin(),u.push(f.result())),R.point=B,w&&d.lineEnd()}function k(N,T){var H=i(N,T);if(x&&c.push([N,T]),A)b=N,v=T,m=H,A=!1,H&&(d.lineStart(),d.point(N,T));else if(H&&w)d.point(N,T);else{var G=[y=Math.max(Lt,Math.min(pt,y)),j=Math.max(Lt,Math.min(pt,j))],Z=[N=Math.max(Lt,Math.min(pt,N)),T=Math.max(Lt,Math.min(pt,T))];Fi(G,Z,e,a,r,n)?(w||(d.lineStart(),d.point(G[0],G[1])),d.point(Z[0],Z[1]),H||d.lineEnd(),E=!1):H&&(d.lineStart(),d.point(N,T),E=!1)}y=N,j=T,w=H}return R}}const xa=e=>e;var na=new Qe,ha=new Qe,Jn,Xn,ga,ba,Ue={point:Le,lineStart:Le,lineEnd:Le,polygonStart:function(){Ue.lineStart=Di,Ue.lineEnd=$i},polygonEnd:function(){Ue.lineStart=Ue.lineEnd=Ue.point=Le,na.add(ie(ha)),ha=new Qe},result:function(){var e=na/2;return na=new Qe,e}};function Di(){Ue.point=Ii}function Ii(e,a){Ue.point=Zn,Jn=ga=e,Xn=ba=a}function Zn(e,a){ha.add(ba*e-ga*a),ga=e,ba=a}function $i(){Zn(Jn,Xn)}var rt=1/0,Pt=rt,vt=-rt,Dt=vt,It={point:Bi,lineStart:Le,lineEnd:Le,polygonStart:Le,polygonEnd:Le,result:function(){var e=[[rt,Pt],[vt,Dt]];return vt=Dt=-(Pt=rt=1/0),e}};function Bi(e,a){e<rt&&(rt=e),e>vt&&(vt=e),a<Pt&&(Pt=a),a>Dt&&(Dt=a)}var va=0,ya=0,ut=0,$t=0,Bt=0,at=0,wa=0,ka=0,ft=0,er,tr,Fe,Pe,ze={point:Je,lineStart:mn,lineEnd:xn,polygonStart:function(){ze.lineStart=Vi,ze.lineEnd=Hi},polygonEnd:function(){ze.point=Je,ze.lineStart=mn,ze.lineEnd=xn},result:function(){var e=ft?[wa/ft,ka/ft]:at?[$t/at,Bt/at]:ut?[va/ut,ya/ut]:[NaN,NaN];return va=ya=ut=$t=Bt=at=wa=ka=ft=0,e}};function Je(e,a){va+=e,ya+=a,++ut}function mn(){ze.point=Ui}function Ui(e,a){ze.point=_i,Je(Fe=e,Pe=a)}function _i(e,a){var r=e-Fe,n=a-Pe,i=et(r*r+n*n);$t+=i*(Fe+e)/2,Bt+=i*(Pe+a)/2,at+=i,Je(Fe=e,Pe=a)}function xn(){ze.point=Je}function Vi(){ze.point=Yi}function Hi(){ar(er,tr)}function Yi(e,a){ze.point=ar,Je(er=Fe=e,tr=Pe=a)}function ar(e,a){var r=e-Fe,n=a-Pe,i=et(r*r+n*n);$t+=i*(Fe+e)/2,Bt+=i*(Pe+a)/2,at+=i,i=Pe*e-Fe*a,wa+=i*(Fe+e),ka+=i*(Pe+a),ft+=i*3,Je(Fe=e,Pe=a)}function nr(e){this._context=e}nr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Re);break}}},result:Le};var ja=new Qe,ra,rr,or,mt,xt,yt={point:Le,lineStart:function(){yt.point=Wi},lineEnd:function(){ra&&ir(rr,or),yt.point=Le},polygonStart:function(){ra=!0},polygonEnd:function(){ra=null},result:function(){var e=+ja;return ja=new Qe,e}};function Wi(e,a){yt.point=ir,rr=mt=e,or=xt=a}function ir(e,a){mt-=e,xt-=a,ja.add(et(mt*mt+xt*xt)),mt=e,xt=a}let hn,Ut,gn,bn;class vn{constructor(a){this._append=a==null?sr:Gi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==gn||this._append!==Ut){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,gn=n,Ut=this._append,bn=this._,this._=i}this._+=bn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function sr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Gi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return sr;if(a!==hn){const r=10**a;hn=a,Ut=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Ut}function Ki(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),tt(s,i(o))),o.result()}return l.area=function(s){return tt(s,i(Ue)),Ue.result()},l.measure=function(s){return tt(s,i(yt)),yt.result()},l.bounds=function(s){return tt(s,i(It)),It.result()},l.centroid=function(s){return tt(s,i(ze)),ze.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new vn(r)):new nr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new vn(r)),l},l.projection(e).digits(r).context(a)}function Ra(e){return function(a){var r=new Na;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Na(){}Na.prototype={constructor:Na,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function qa(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),tt(r,e.stream(It)),a(It.result()),n!=null&&e.clipExtent(n),e}function lr(e,a,r){return qa(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Qi(e,a,r){return lr(e,[[0,0],a],r)}function Ji(e,a,r){return qa(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Xi(e,a,r){return qa(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var yn=16,Zi=de(30*Ee);function wn(e,a){return+a?ts(e,a):es(e)}function es(e){return Ra({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ts(e,a){function r(n,i,o,l,s,p,g,d,f,u,x,c,b,v){var m=g-n,y=d-i,j=m*m+y*y;if(j>4*a&&b--){var w=l+u,A=s+x,E=p+c,R=et(w*w+A*A+E*E),B=bt(E/=R),C=ie(ie(E)-1)<ne||ie(o-f)<ne?(o+f)/2:gt(A,w),q=e(C,B),M=q[0],L=q[1],U=M-n,k=L-i,N=y*U-m*k;(N*N/j>a||ie((m*U+y*k)/j-.5)>.3||l*u+s*x+p*c<Zi)&&(r(n,i,o,l,s,p,M,L,C,w/=R,A/=R,E,b,v),v.point(M,L),r(M,L,C,w,A,E,g,d,f,u,x,c,b,v))}}return function(n){var i,o,l,s,p,g,d,f,u,x,c,b,v={point:m,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=A},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function m(B,C){B=e(B,C),n.point(B[0],B[1])}function y(){f=NaN,v.point=j,n.lineStart()}function j(B,C){var q=nt([B,C]),M=e(B,C);r(f,u,d,x,c,b,f=M[0],u=M[1],d=B,x=q[0],c=q[1],b=q[2],yn,n),n.point(f,u)}function w(){v.point=m,n.lineEnd()}function A(){y(),v.point=E,v.lineEnd=R}function E(B,C){j(i=B,C),o=f,l=u,s=x,p=c,g=b,v.point=j}function R(){r(f,u,d,x,c,b,o,l,i,s,p,g,yn,n),v.lineEnd=w,w()}return v}}var as=Ra({point:function(e,a){this.stream.point(e*Ee,a*Ee)}});function ns(e){return Ra({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function rs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function kn(e,a,r,n,i,o){if(!o)return rs(e,a,r,n,i);var l=de(o),s=ce(o),p=l*e,g=s*e,d=l/e,f=s/e,u=(s*r-l*a)/e,x=(s*a+l*r)/e;function c(b,v){return b*=n,v*=i,[p*b-g*v+a,r-g*b-p*v]}return c.invert=function(b,v){return[n*(d*b-f*v+u),i*(x-f*b-d*v)]},c}function os(e){return is(function(){return e})()}function is(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,g=0,d,f=0,u=1,x=1,c=null,b=fn,v=null,m,y,j,w=xa,A=.5,E,R,B,C,q;function M(N){return B(N[0]*Ee,N[1]*Ee)}function L(N){return N=B.invert(N[0],N[1]),N&&[N[0]*Be,N[1]*Be]}M.stream=function(N){return C&&q===N?C:C=as(ns(d)(b(E(w(q=N)))))},M.preclip=function(N){return arguments.length?(b=N,c=void 0,k()):b},M.postclip=function(N){return arguments.length?(w=N,v=m=y=j=null,k()):w},M.clipAngle=function(N){return arguments.length?(b=+N?Oi(c=N*Ee):(c=null,fn),k()):c*Be},M.clipExtent=function(N){return arguments.length?(w=N==null?(v=m=y=j=null,xa):Pi(v=+N[0][0],m=+N[0][1],y=+N[1][0],j=+N[1][1]),k()):v==null?null:[[v,m],[y,j]]},M.scale=function(N){return arguments.length?(r=+N,U()):r},M.translate=function(N){return arguments.length?(n=+N[0],i=+N[1],U()):[n,i]},M.center=function(N){return arguments.length?(o=N[0]%360*Ee,l=N[1]%360*Ee,U()):[o*Be,l*Be]},M.rotate=function(N){return arguments.length?(s=N[0]%360*Ee,p=N[1]%360*Ee,g=N.length>2?N[2]%360*Ee:0,U()):[s*Be,p*Be,g*Be]},M.angle=function(N){return arguments.length?(f=N%360*Ee,U()):f*Be},M.reflectX=function(N){return arguments.length?(u=N?-1:1,U()):u<0},M.reflectY=function(N){return arguments.length?(x=N?-1:1,U()):x<0},M.precision=function(N){return arguments.length?(E=wn(R,A=N*N),k()):et(A)},M.fitExtent=function(N,T){return lr(M,N,T)},M.fitSize=function(N,T){return Qi(M,N,T)},M.fitWidth=function(N,T){return Ji(M,N,T)},M.fitHeight=function(N,T){return Xi(M,N,T)};function U(){var N=kn(r,0,0,u,x,f).apply(null,a(o,l)),T=kn(r,n-N[0],i-N[1],u,x,f);return d=Ei(s,p,g),R=fa(a,T),B=fa(d,R),E=wn(R,A),k()}function k(){return C=q=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&L,U()}}function dr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}dr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ss(){return os(dr).scale(175.295)}function ls(e){return e}function ds(e){if(e==null)return ls;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var g=2,d=s.length,f=new Array(d);for(f[0]=(a+=s[0])*n+o,f[1]=(r+=s[1])*i+l;g<d;)f[g]=s[g],++g;return f}}function cs(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ps(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return jn(e,r)})}:jn(e,a)}function jn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=us(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function us(e,a){var r=ds(e.transform),n=e.arcs;function i(d,f){f.length&&f.pop();for(var u=n[d<0?~d:d],x=0,c=u.length;x<c;++x)f.push(r(u[x],x));d<0&&cs(f,c)}function o(d){return r(d)}function l(d){for(var f=[],u=0,x=d.length;u<x;++u)i(d[u],f);return f.length<2&&f.push(f[0]),f}function s(d){for(var f=l(d);f.length<4;)f.push(f[0]);return f}function p(d){return d.map(s)}function g(d){var f=d.type,u;switch(f){case"GeometryCollection":return{type:f,geometries:d.geometries.map(g)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:f,coordinates:u}}return g(a)}const cr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},fs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ms(e,a,r){const n=cr[e];if(!n||!n.length)return-1;const i=fs(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Rt=null;function xs(){return Rt||(Rt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ps(r,n),o=ss().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Ki(o),s=(i.features||[]).filter(d=>{var f;return(((f=d.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(d=>{var x;const f=((x=d.properties)==null?void 0:x.name)||"",u=l(d)||"";return u?{i2:Hr(f)||null,n:f,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,f]of Object.entries(Yr)){const u=o(f);u&&(p[d]={x:u[0],y:u[1]})}const g={};for(const[d,f]of Object.entries(cr)){const u=f.map(x=>o(x.ll)).filter(x=>!!x).map(([x,c])=>({x,y:c}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:g}}catch{return null}})(),Rt)}function hs(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return xs().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const gs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Nn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Sn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function bs(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function vs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:g,dossiers:d}=F(),f=g.loading&&!d.length,u=h.useRef(null),x=h.useRef(null),c=hs(e.continent==="monde"),b=e.continent==="monde"?c:za.find(k=>k.key===e.continent)||null,v=bs(u,e.continent+":"+e.mapFolded+":"+!!b),[m,y]=h.useState(new Map),[j,w]=h.useState(null);h.useEffect(()=>{const k=u.current;if(!k)return;const N=new Map;k.querySelectorAll("path[data-i2]").forEach(T=>{const H=T.dataset.i2;if(H)try{const G=T.getBBox();G.width>0&&N.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(N)},[e.continent,v,b]);const A=h.useMemo(()=>r.filter(k=>k.cc),[r]),E=h.useMemo(()=>{const k=new Map;return A.forEach(N=>k.set(N.cc,(k.get(N.cc)||0)+1)),k},[A]),R=e.continent==="monde"&&c?c.anchors:null,B=e.continent==="monde"&&c?c.metros:null,C=h.useMemo(()=>A.map(k=>{const N=Sn(k.name||k.id||""),T=Sn((k.id||k.name||"")+"·y");if(R&&k.cc){const O=B?B[k.cc]:void 0;if(O&&O.length){const P=ms(k.cc,k.city,N);if(P>=0&&O[P])return{d:k,x:O[P].x+(N-.5)*5,y:O[P].y+(T-.5)*5}}const $=R[k.cc];if($)return{d:k,x:$.x+(N-.5)*10,y:$.y+(T-.5)*10}}const H=k.cc?m.get(k.cc):void 0;if(!H)return null;const G=gs[`${e.continent}:${k.cc||""}`];if(G)return{d:k,x:H.x+H.w*(G.fx+(N-.5)*G.sx),y:H.y+H.h*(G.fy+(T-.5)*G.sy)};const Z=(N-.5)*Math.min(H.w*.55,60),z=(T-.5)*Math.min(H.h*.55,60);return{d:k,x:H.x+H.w/2+Z,y:H.y+H.h/2+z}}).filter(k=>!!k),[A,m,R,B,e.continent]),q=k=>v>0?k/v:k,M=h.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:Nn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(N=>N.kind==="target"&&ke(N)===k).length})).filter(k=>k.n>0):_a.map((k,N)=>({...k,n:r.filter(T=>Va(T)===N).length})),[r,n,p.plabels]),L=o?l.get(o):null,U=L?C.find(k=>k.d.id===L.id):null;return b?t.jsxs("div",{className:"mapzone"+(f?" waiting":""),ref:x,children:[t.jsxs("svg",{ref:u,viewBox:b.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?b.fr:b.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:b.countries.map((k,N)=>t.jsx("g",{className:"ct"+(k.i2&&E.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},N))}),t.jsx("g",{children:C.map(k=>{const N=_a[Va(k.d)],T=!!he(k.d),H=k.d.kind==="target",G=n&&H?Nn[ke(k.d)]:N.c,Z=!n&&Ae(k.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var $,P;const z=($=x.current)==null?void 0:$.getBoundingClientRect(),O=(P=u.current)==null?void 0:P.createSVGPoint();if(O&&u.current&&z){O.x=k.x,O.y=k.y;const D=O.matrixTransform(u.current.getScreenCTM());w({x:D.x-z.left,y:D.y-z.top,label:k.d.name+" · "+(st(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var $;const z=($=u.current)==null?void 0:$.createSVGPoint();let O=null;if(z&&u.current){z.x=k.x,z.y=k.y;const P=z.matrixTransform(u.current.getScreenCTM());O={x:P.x,y:P.y}}a({type:"popup",id:k.d.id,anchor:O})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:q(Math.max(11,N.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:q(N.px),fill:G,stroke:T?"#DC2626":"#ffffff",strokeWidth:q(T?2.2:1.3)})]},k.d.id||k.d.name)})}),U&&t.jsx("circle",{className:"ring on",cx:U.x,cy:U.y,r:q(13),fill:"none",stroke:"#0F172A",strokeWidth:q(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:M.map((k,N)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},N))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:x})}function ys(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function ws(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(c=>c.continent===e.continent),[r,e.continent]),g=c=>p.filter(b=>c!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Ta(b,s,i,c==="country"?void 0:c)),d=h.useMemo(()=>{const c=g("win"),b=v=>c.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),c.length]},[p,s,i]),f=h.useMemo(()=>s.day?g("win").filter(c=>(c.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),x=(c,b,v,m="fbtn")=>t.jsxs("button",{type:"button",className:m,"aria-expanded":e.openFacet===c,onClick:()=>a({type:"openFacet",facet:c}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},c);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(ys(s.day,l)),t.jsx("b",{children:f})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((c,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===c,onClick:()=>a({type:"filters",patch:{win:c}}),children:[n.dates[b],t.jsx("b",{children:d[b]})]},c))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:c=>a({type:"filters",patch:{search:c.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):x("sec",n.fSector,s.sector.length),x("pay",n.fCountry,s.country.length),x("det",n.fEngine,s.engine.length),x("sta",n.fStage,s.stage.length),i&&x("ang","Angle",s.angle.length),i&&x("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(ks,{poolFor:g})]})}function ks({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:g}=h.useMemo(()=>{if(l==="sig"){const c=e("signal").filter(m=>he(m)),b=new Map;c.forEach(m=>{const y=m.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:c.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...sa([...b.keys()],i).map(m=>({v:m,label:Ke(m)+" "+De(m,i),n:b.get(m)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(m)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const c=e("sector"),b=new Map;return c.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const c=e("country"),b=new Map;return c.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:st(v,i)||v,n:m,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const c=e("engine"),b=new Map;return c.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:sa([...b.keys()],i).map(v=>({v,label:Ke(v)+" "+De(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Wr(Gr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const c=e("angle"),b=new Map;return c.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v.replace(/[_-]+/g," "),n:m,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const c=e("memoLevel"),b=new Map;c.forEach(m=>{if(m.kind==="target"){const y=Ea(m);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(m=>({v:String(m),label:v[m],n:b.get(m)||0,html:!1,on:o.memoLevel.includes(m)}))}}const u=e("stage"),x=new Map;return u.forEach(c=>{c.stage&&x.set(c.stage,(x.get(c.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...x.entries()].sort((c,b)=>b[1]-c[1]).map(([c,b])=>({v:c,label:c,n:b,html:!1,on:o.stage.includes(c)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const c=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:c}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},f=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function pr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function js(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Cn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function ur({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Cn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Cn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Ns({card:e,onEvaluate:a,onAddAll:r}){var s,p,g;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:pr(e.summary_md||"").map((d,f)=>t.jsx("p",{children:d},f))})]}),t.jsx(ur,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Ss(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Cs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[p,g]=h.useState(null),[d,f]=h.useState(null),[u,x]=h.useState(null),[c,b]=h.useState(!1);h.useEffect(()=>{let m=!0;return(async()=>{const y=await Dn({email:l,cbToken:s});m&&g(y)})(),()=>{m=!1}},[l,s,n]);const v=m=>{f(m),x(null),b(!0),(async()=>{const y=await Kr(m.id);x(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),x(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[Ss(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?o.rsPub:o.rsPriv})]},m.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),c&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!c&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!c&&u&&t.jsx(Ns,{card:u,onEvaluate:a,onAddAll:r})]})]})}const En=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Es(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:g,data:d,canWrite:f,source:u}=F(),x=a==="client",c=h.useMemo(()=>r||(u!=="default"?Qr():""),[r,u]),[b,v]=h.useState(""),[m,y]=h.useState(!1),[j,w]=h.useState(""),[A,E]=h.useState(!1),[R,B]=h.useState(""),[C,q]=h.useState([]),M=h.useRef(!1),[L,U]=h.useState(!1),[k,N]=h.useState(""),[T,H]=h.useState(""),[G,Z]=h.useState(!1),[z,O]=h.useState(0),[$,P]=h.useState(""),[D,_]=h.useState(null),[W,X]=h.useState(null),[re,me]=h.useState(!1),[pe,Q]=h.useState(null),[te,ve]=h.useState(0),K=h.useRef(!1),se=b.trim()?En.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,ee=h.useMemo(()=>j.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[j]);h.useEffect(()=>{if(typeof window>"u")return;const I=(new URLSearchParams(window.location.search).get("rs")||"").trim();!I||!/^https?:\/\//i.test(I)||(N(I),U(!0))},[]),h.useEffect(()=>{const I=ae=>{var ye;const oe=String(((ye=ae.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(N(oe),U(!0))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),h.useEffect(()=>{if(!f&&!c){Q(null);return}let I=!0;return(async()=>{const ae=await Dn({email:n,cbToken:c});I&&Q(ae.length)})(),()=>{I=!1}},[f,c,n,te]);const _e=C.length?C:p,xe=d.credits,ge=h.useCallback(I=>{const ae=I.map(oe=>(oe||"").trim()).filter(Boolean);ae.length&&(w(oe=>{const ye=oe.split(`
`).map(le=>le.trim()).filter(Boolean),Ve=new Set(ye.map(le=>le.toLowerCase())),je=ae.filter(le=>!Ve.has(le.toLowerCase()));return[...ye,...je].slice(0,15).join(`
`)}),y(!0))},[]);h.useEffect(()=>{if(!G)return;O(0);const I=window.setInterval(()=>O(ae=>ae+1),1e3);return()=>window.clearInterval(I)},[G]);const Ie=()=>{const I=b.trim();I&&(i(null,I),v(""))},He=async()=>{if(!x){i(null,ee[0]||"");return}if(!ee.length||A)return;E(!0),M.current=!1;const I=[];for(let ae=0;ae<ee.length&&!M.current;ae++){B(e.evaluating(ae+1,ee.length,ee[ae]));const oe=await In(r,ee[ae],"atelier2");if(I.unshift({name:oe.company||ee[ae],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),q([...I]),oe.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(ee.length-ae-1),remaining:0}),q([...I]),w(ee.slice(ae+1).join(`
`)),B(""),E(!1);return}}B(""),w(M.current?ee.slice(I.length).join(`
`):""),E(!1)},Se=async()=>{var oe,ye,Ve;if(K.current)return;const I=k.trim().replace(/\s+/g,""),ae=T.trim();if(!I&&!ae){P(e.rsNeed);return}if(!x&&!c){i(null,I||ae.slice(0,80));return}K.current=!0,P(""),_(null),X(null),Z(!0);try{const je=await Xr({url:I,text:ae,email:n,cbToken:c});if(Z(!1),!je||je.status!=="success"){P((je==null?void 0:je.message)||"Erreur");return}_(je),U(!1),ge((((oe=je.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Ce=>(Ce==null?void 0:Ce.name)||"")),X({state:"pending"});const le=await Zr(je,{email:n,cbToken:c});X(le.ok?{state:"ok",scopeLabel:((ye=le.summary)==null?void 0:ye.scope_label)||"",scope:((Ve=le.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:le.error||""}),le.ok&&ve(Ce=>Ce+1)}finally{K.current=!1,Z(!1)}},$e=[D==null?void 0:D.industry,...(D==null?void 0:D.market_tags)||[],D==null?void 0:D.author].map(I=>(I||"").trim()).filter(Boolean),lt=(W==null?void 0:W.state)==="pending",Yt=W&&(lt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):W.state==="ok"?t.jsx("span",{className:"rslink ok",children:W.scope&&W.scope!=="public"?e.rsSavedIn(W.scopeLabel||W.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:W.msg,children:e.rsSaveFail})),Wt=js(D).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:I=>v(I.target.value),onKeyDown:I=>{I.key==="Enter"&&Ie()}}),t.jsx("span",{className:"detect"+(En.test(b.trim())?" url":""),children:se})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:Ie,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),g.showCredits&&xe&&t.jsxs("button",{type:"button",className:"credits"+(xe.total_available<=0&&!xe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:xe.unlimited?"∞":xe.total_available}),!xe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",xe.daily_grant+xe.purchased]}),xe.total_available<=0&&!xe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!m),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(L?" on":""),onClick:()=>U(!L),children:e.rsOpen}),pe!==null&&pe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>me(!re),children:e.rsArchOpen(pe)})]}),re&&t.jsx(Cs,{bump:te,cbToken:c,onClose:()=>me(!1),onEvaluate:I=>i(null,I),onAddAll:ge}),L&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:k,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:I=>N(I.target.value),onKeyDown:I=>{I.key==="Enter"&&Se()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:T,placeholder:e.rsTextPh,onChange:I=>H(I.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||lt||!k.trim()&&!T.trim(),onClick:()=>{Se()},children:[t.jsx("span",{className:"fill"}),G?`${Jr(k.trim())==="youtube"&&k.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(z)}`:lt?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),$&&t.jsx("div",{className:"rserr",children:$}),D&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:D.title}),D.source_url&&t.jsx("a",{href:D.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{_(null),X(null)},children:"×"})]}),D.market&&t.jsx("p",{className:"rsmk",children:D.market}),$e.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),$e.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[D.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${D.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:pr(D.summary_md||"").map((I,ae)=>t.jsx("p",{children:I},ae))})]}),t.jsx(ur,{card:D,onEvaluate:I=>i(null,I),onAddAll:ge}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Wt)}),Yt]})]}),m&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:j,placeholder:e.bulkPh,onChange:I=>w(I.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(A?" loading":""),style:{justifyContent:"center"},disabled:A||!ee.length,onClick:()=>{He()},children:[t.jsx("span",{className:"fill"}),A&&R?R:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(ee.length)})]})]}),_e.slice(0,1).map((I,ae)=>{const oe=I.verdict==="kept",ye=I.verdict==="quota",Ve=oe?"var(--brand)":ye?"var(--bolt)":"var(--red)",je=oe?"var(--brand-l)":ye?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":je},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:ye?"⏳":"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(le=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:le.url.startsWith("http")?le.url:`https://${le.url}`,target:"_blank",rel:"nofollow noopener",children:[(le.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,le.url),children:e.evalPickGo})]},le.url))}),!ye&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const le=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ce=[...document.querySelectorAll(".atl2 .list .row")].find(Gt=>{var jt;return(((jt=Gt.querySelector(".rnm"))==null?void 0:jt.textContent)||"").trim().toLowerCase().includes(le)});Ce&&(Ce.scrollIntoView({behavior:"smooth",block:"center"}),Ce.classList.add("flashrow"),window.setTimeout(()=>Ce.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),x&&(o.kept+o.dropped>0||_e.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function As(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function zs(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=F(),o=e.memoConsole?r.get(e.memoConsole):null,l=h.useMemo(()=>o?[o.reasoning||"",As(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=Ze(o),p=Ea(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[wt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const oa={},An=(oa==null?void 0:oa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function zn(){return new Date().toISOString().slice(0,10)}const Ma=h.createContext(null);function Ts(){return h.useContext(Ma)}function Ls(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(i=>/en bref/i.test(i.textContent||"")&&i.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(i=>(i.textContent||"").replace(/\s+/g," ").trim()).filter(i=>i.length>3).slice(0,4)}catch{return[]}}function Rs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),s.querySelectorAll("*").forEach(p=>{const g=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(d=>p.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(p.setAttribute("href",g),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function qs(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Ms(){const{ed:e,isEn:a,day:r,loading:n}=fr(),i=h.useMemo(()=>Ls((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const o=qs(r,a);return i.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+o}),t.jsx("ul",{children:i.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${o}.`:`Édition du ${o}.`})]})}function fr(){const e=h.useContext(Ma);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Os({token:e,children:a}){const{dispatch:r,st:n,lang:i}=F(),[o,l]=h.useState(()=>n.filters.day||zn()),[s,p]=h.useState(null),[g,d]=h.useState(!1),f=h.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=h.useCallback(()=>{l(zn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);h.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),h.useEffect(()=>{const b=v=>{var y;const m=(y=v.detail)==null?void 0:y.day;typeof m=="string"&&f(m)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[f]),h.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),h.useEffect(()=>{if(!e||!o)return;let b=!1;d(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${An}/cibles/edition.json?${v}`).then(m=>m.json()).then(m=>{b||p(m)}).catch(()=>{b||p({ok:!1,error:"network"})}).finally(()=>{b||d(!1)}),()=>{b=!0}},[e,o]);const x=h.useMemo(()=>`${An}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),c=h.useMemo(()=>({token:e,day:o,ed:s,loading:g,pickDay:f,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:x,isEn:i==="en"}),[e,o,s,g,f,u,n.filters.day,x,i]);return t.jsx(Ma.Provider,{value:c,children:a})}function Fs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=fr();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(eo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function mr({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=F(),[l,s]=h.useState(!1),[p,g]=h.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const d=async()=>{if(l)return;s(!0);const f=await to(r,e);if(s(!1),!f){o(a.actErr);return}g(f.results||[])};return t.jsxs("div",{className:"simb",onClick:f=>f.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{d()},children:l?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(f=>t.jsxs("li",{children:[t.jsx("b",{className:f.verdict==="kept"?"ok":"ko",children:f.company}),f.reason&&t.jsx("span",{children:f.reason})]},f.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function Vt({spec:e}){const a=h.useRef(null),r=h.useRef(null),[n,i]=h.useState(!1);return h.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;return Ha({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{l=!0,o.replaceChildren()}},[e]),h.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Ha({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!l&&p&&o.isConnected&&o.replaceChildren(p)});const s=p=>{p.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&it.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Ps=`
...
`;function Ds(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function Is(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:g,doPromote:d,doRepeche:f,doApproach:u,doDeep:x,doOnboard:c,outbound:b,evalBusy:v}=F(),m=e.popupId?r.get(e.popupId):null;if(!m)return null;const y=he(m),j=ke(m),w=Ze(m),A=m.kind==="target",E=R=>{a({type:"filters",patch:R}),a({type:"popup",id:null})};return it.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Ps}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Ds(e.popupAnchor,!!m.card),onClick:R=>R.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:m.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ot(m.date)),De(m.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[m.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>E({country:[m.cc]}),children:(st(m.cc,i)||m.countryLabel||"").toUpperCase()}),m.sector&&t.jsx("button",{type:"button",onClick:()=>E({sector:[m.sector]}),children:m.sector.toUpperCase()}),m.stage&&t.jsx("button",{type:"button",onClick:()=>E({stage:[m.stage]}),children:m.stage.toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{className:"am2",children:kt(m.amountEur,i)})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ke(m.engine)," ",t.jsx("b",{children:De(m.engine,i)})," — ",ao(m.engine,i),m.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",m.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Xe,{o:m,lg:!0})," ",t.jsx(Ht,{o:m,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn($n(y,i))," · ",n.win7(Bn(y,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),m.card?t.jsx(Vt,{spec:m.card}):null,m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),o.pipe&&A&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof m.score=="number"&&m.score>0?" · "+n.score(m.score):""]})})]}),t.jsx(mr,{name:m.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(m,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(m,!1),a({type:"popup",id:null})},children:n.actNo}),wt(m)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{x(m),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),m.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:m.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{c(m),a({type:"popup",id:null})},children:"🚀"})]}):m.engine==="media"&&m.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var R;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"popup",id:null}),(R=document.querySelector(".atl2 .demand"))==null||R.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(m.name),onClick:()=>s(m),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)," →"]}),m.website&&t.jsx("a",{className:"psite",href:m.website.startsWith("http")?m.website:"https://"+m.website,target:"_blank",rel:"noopener noreferrer",title:m.website,children:"🌐"})]})]})]}),document.body)}const $s=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),qt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Bs(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=qt(a.slice(n));break}r+=qt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=qt(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&$s.has(p)?r+=`<${s[1]}${p}>`:r+=qt(a.slice(i,o+1)),n=o+1}return r}const Tn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function we({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Us(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function _s({o:e}){const{t:a,doDeep:r}=F(),n=Ze(e),i=[e.reasoning||"",Us(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),i.length?i.join(`

`).split(`

`).map((o,l)=>t.jsx("p",{className:"cdtxt",children:o},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[wt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:o=>{o.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:o=>o.stopPropagation(),children:a.memoOpenFull})]})]})}function Vs({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=F(),o=_t(e),l=Ze(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=h.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||wt(e)?1:0}].filter(b=>b.n>0),[e,a,s,l,p,g,d]),[u,x]=h.useState("");if(!f.length)return null;const c=f.some(b=>b.k===u)?u:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":c===b.k,className:c===b.k?"on":"",onClick:v=>{v.stopPropagation(),x(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[c==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(we,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(we,{k:a.cdVerdictDate,v:Tn(e.verdictDate,r)})]})]}),c==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Bs(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Hs,{o:e})]}),c==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdSector,v:e.sector}),t.jsx(we,{k:a.cdStage,v:e.stage}),t.jsx(we,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(we,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(we,{k:a.cdAngle,v:e.angle}),t.jsx(we,{k:a.cdDetected,v:Tn(e.date,r)})]}),c==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdName,v:e.contactName}),t.jsx(we,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),c==="memo"&&t.jsx(_s,{o:e}),c==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(we,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Hs({o:e}){const{t:a,token:r}=F(),[n,i]=h.useState(!1),[o,l]=h.useState(null),s=async()=>{n||(i(!0),l(await no(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},g=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=g.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,f])=>f).map(([f,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:u})]},f)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!d&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const xr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Oa({o:e}){const{t:a}=F(),r=_t(e),n=Ze(e),i=ke(e),o=ia(e),l=ro(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(xr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const Sa=e=>e.length>22?e.slice(0,21)+"…":e;function Ln({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=F(),[o,l]=h.useState(!1);if(h.useEffect(()=>{n||l(!1)},[n]),Ae(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Sa(e.name))})]})}function hr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:g,dispatch:d}=F();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:x=>{x.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:x=>{var c;x.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:x=>{var c;x.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Ln,{o:e})});const f=ke(e),u=x=>c=>{c.stopPropagation(),x()};if(f===0)return t.jsx("span",{className:"cell",children:t.jsx(Ln,{o:e})});if(f===1){const x=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:x,onClick:u(()=>o(e)),children:x?a.actAnalyseQueued:a.actAnalyse})})}if(f===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(f===4){const x=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:x,onClick:u(()=>g(e)),children:x?a.actApproachSent:a.actApproach})})}return f===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):f===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Ys({o:e}){const{t:a,doThumb:r,thumbOf:n}=F(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Ws({o:e}){const{lang:a}=F();return he(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Xe,{o:e}),t.jsx(Ht,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ke(e.engine||"")," ",De(e.engine||"",a)]})})}function Gs({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:g,toggleFav:d}=F(),f=ke(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],x=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,c=x<=0?0:x<=7?1:x<=30?2:3,b=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][f]:u[c],v=g.has(e.id),m=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const j=y.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:j.left+Math.min(280,j.width/3),y:j.bottom}})};return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:m,children:[t.jsx("span",{className:"pt",style:{"--c":b}}),t.jsx(yr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Ks,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Ws,{o:e}),l.pipe&&t.jsx(Oa,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(hr,{o:e}),l.showThumbs&&t.jsx(Ys,{o:e})]}),r&&!a&&t.jsx(Js,{o:e})]})}function Ks({o:e}){const{lang:a,caps:r}=F();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=kt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Qs({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=F(),l=(u,x=!1)=>c=>{c.stopPropagation(),x&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=kt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ae(e),f=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var x;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(x=document.querySelector(".atl2 .demand"))==null||x.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Vt,{spec:e.card})})]})}function Js({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=F();return!i.pipe&&e.kind==="op"?t.jsx(Qs,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Vs,{o:e}),t.jsx(pi,{o:e}),t.jsx(mi,{o:e}),t.jsx(mr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Oa,{o:e})})]}),e.card&&t.jsx(Vt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ke(e.engine||"")," ",De(e.engine||"",r)]}),he(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Xe,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Xs({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=F();if(!i.pipe&&e.kind==="op"){const g=kt(e.amountEur,l),d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),f=(u,x=!1)=>c=>{c.stopPropagation(),x&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Vt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:f({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:f({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:f({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ke(e.engine||"")," ",De(e.engine||"",l)]}),he(e)&&t.jsx(Xe,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(hr,{o:e})})]})}const s=ke(e),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":p},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Oa,{o:e}),he(e)&&t.jsx(Xe,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Zs(){const{t:e}=F(),[a,r]=h.useState(0);return h.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function el({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=i==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),p=s.includes(0)?0:s.sort((d,f)=>(e[f]||0)-(e[d]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:o?`${g} ${g>1?"files":"file"} in “${l(p)}”`:`${g} dossier${g>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function tl(){var Z;const e=F(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:p,data:g,dossiers:d,source:f}=e,u=f==="ops"?8:_n,[x,c]=h.useState(new Set);h.useEffect(()=>{c(new Set)},[a.ptab,a.continent]);const[b,v]=h.useState(null);h.useEffect(()=>{v(null)},[a.ptab,a.continent]);const m=z=>c(O=>{const $=new Set(O);return $.has(z)?$.delete(z):$.add(z),$}),[y,j]=h.useState("all"),[w,A]=h.useState(!1);h.useEffect(()=>{j("all"),A(!1)},[a.ptab,a.continent]),h.useEffect(()=>{if(!w)return;const z=O=>{var $,P;(P=($=O.target)==null?void 0:$.closest)!=null&&P.call($,".atl2 .doable")||A(!1)};return document.addEventListener("click",z),()=>document.removeEventListener("click",z)},[w]);const E=Ts(),R=h.useMemo(()=>{var O;const z=new Map;for(const $ of Rs(((O=E==null?void 0:E.ed)==null?void 0:O.html)||""))z.has($.t)||z.set($.t,$.html);return z},[(Z=E==null?void 0:E.ed)==null?void 0:Z.html]),B=h.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!R.size)return;const O=(z.name||"").trim().toLowerCase();if(O.length<3)return;const $=R.get(O);if($)return $;for(const[P,D]of R)if(P.includes(O)||O.includes(P))return D},[R]),C=h.useMemo(()=>{const z=La(l,a.sort);return y==="all"?z:z.filter(O=>y==="explore"?!!O.noCo:!O.noCo)},[l,a.sort,f,y]),q=h.useMemo(()=>C.filter(z=>he(z)&&!Ae(z)).length,[C]),M=h.useMemo(()=>i.pipe?C:C.filter(z=>!Ae(z)&&!z.noCo),[C,i.pipe]),L=f==="ops"?C.filter(z=>z.noCo).length:0,U=i.pipe?n.plabels[a.ptab].toLowerCase():f==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,k=(z,O,$="",P=!1)=>t.jsxs("button",{type:"button","data-s":z,className:$,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:P?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[O,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),N=h.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const z=new Map;C.forEach(P=>{const D=P.engine||"?";z.has(D)||z.set(D,[]),z.get(D).push(P)});const O={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},$=sa([...z.keys()],s);return[...z.entries()].sort((P,D)=>{const _=O[P[0]]??10+$.indexOf(P[0]),W=O[D[0]]??10+$.indexOf(D[0]);return _-W})},[C,i.pipe,a.groupBy,s]),T=i.lockRowsAfter;let H=0;const G=(z,O)=>{let $=a.shown[O]||u;return z.length-$<=4&&($=z.length),z.slice(0,$).map(_=>{const W=T!==null&&H>=T;H++;const X=B(_),re=X&&X!==_.decryptHtml?{..._,decryptHtml:X}:_,me=a.dens!=="maxi"&&(a.dens==="deplie"||(b?b==="open":!!X)),pe=x.has(_.id)?!me:me;return a.dens==="maxi"?t.jsx(Xs,{o:re,locked:W},_.id):t.jsx(Gs,{o:re,locked:W,open:pe,onToggle:()=>m(_.id)},_.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:C.length})," ",U]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",f==="ops"&&C.length>0&&" — "+n.edSplit(C.length-L,L)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||f==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,O])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:O})]},z))}),(i.showFunnel||f==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":b==="open",onClick:()=>{v("open"),c(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":b==="closed",onClick:()=>{v("closed"),c(new Set)},children:n.foldAllLbl}),f==="ops"&&t.jsxs("button",{type:"button","aria-pressed":b===null,onClick:()=>{v(null),c(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||f==="ops")&&(()=>{var $;const z=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],O=(($=z.find(([P])=>P===y))==null?void 0:$[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":w,onClick:()=>A(P=>!P),children:[O,t.jsx("i",{children:"▾"})]}),w&&t.jsx("div",{className:"dolist",children:z.map(([P,D])=>t.jsx("button",{type:"button","aria-pressed":y===P,onClick:()=>{j(P),A(!1)},children:D},P))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([z,O])=>t.jsx("option",{value:z,children:O},z))})]}),i.showChain&&M.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:M.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(M.length):n.chainAll(M.length)]})]}),q>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(q)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),k("country",n.colCountry),k("name",n.colCompany),k("amount",n.colAmount,"h-amt",!0),k("stage",n.colStage,"h-stade"),k("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&k("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(f==="ops"?" opsl":"")+(C.length?"":" list-empty"),children:[N?N.map(([z,O])=>t.jsxs(h.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ke(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:De(z,s)}),t.jsx("div",{className:"s",children:n.grpCount(O.filter($=>!Ae($)).length,O.length)})]})]}),G(O,z)]},z)):G(C,"pt"+a.ptab),g.loading&&!d.length&&t.jsx(Zs,{}),!C.length&&!(g.loading&&!d.length)&&(i.pipe?t.jsx(el,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const z=N||[["pt"+a.ptab,C]];let O=0,$=0;for(const[D,_]of z){$+=_.length;let W=a.shown[D]||u;_.length-W<=4&&(W=_.length),O+=Math.min(_.length,W)}const P=$-O;return P<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([D,_])=>r({type:"more",group:D,by:_.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(P,P)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(O,$)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function Rn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function al(e,a){const r=oo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function nl(e,a){const n=[a.head.split("|").map(Rn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",al(i,a.plabels),_t(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Rn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function rl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const ol=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Oe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function il({o:e,qa:a}){const{t:r,lang:n,fund:i}=F(),o=(e.cribleStatus||"").trim().toUpperCase()||(_t(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Ze(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Oe,{k:r.cdSector,v:e.sector}),t.jsx(Oe,{k:r.cdStage,v:e.stage}),t.jsx(Oe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Oe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Oe,{k:r.cdName,v:e.contactName}),t.jsx(Oe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Oe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Oe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Oe,{k:r.cdAngle,v:e.angle}),t.jsx(Oe,{k:r.cdDetected,v:ol(e.date,n)})]}),p.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function sl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=F(),[s,p]=h.useState({}),g=25,d=h.useMemo(()=>n.slice(0,g),[n]);h.useEffect(()=>{d.length&&io(r,d.map(x=>x.name)).then(p)},[r,d]);const f=o.stats,u=x=>x.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[u(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(f.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(f.screened/o.marketEstimate*100)," %"]})]})]}),d.map(x=>t.jsx(il,{o:x,qa:s[x.name]},x.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ll=50;function Fa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=F(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(""),[f,u]=h.useState(0),[x,c]=h.useState(""),[b,v]=h.useState(!1),m=h.useRef(null);h.useEffect(()=>()=>{m.current&&window.clearInterval(m.current)},[]);const y=async w=>{p(!0),d("");const A=await a();if(p(!1),A.ok){l(A);return}if(A.busy){d(i.alertPreviewBusy);return}if(!w){d(i.alertPreviewFail);return}u(ll),m.current=window.setInterval(()=>{u(E=>E>1?E-1:(m.current&&window.clearInterval(m.current),y(!1),0))},1e3)},j=async()=>{if(n||b)return;v(!0),c("");const w=await r();v(!1),c(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||f>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{j()},children:b?"…":i.alertTest})]}),f>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(f)}),g&&t.jsx("p",{className:"mnote warn",children:g}),x&&t.jsx("p",{className:"mnote",children:x}),!x&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ht="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ne({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=F();return it.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function dl(){const{st:e}=F();switch(e.modal){case"chain":return t.jsx(pl,{});case"space":return t.jsx(ul,{});case"alert":return t.jsx(fl,{});case"queue":return t.jsx(bl,{});case"export":return t.jsx(vl,{});case"plug":return t.jsx(kl,{});case"recharge":return t.jsx(Nl,{});case"cover":return t.jsx(Cl,{});case"dossier":return t.jsx(Sl,{});case"crit":return t.jsx(El,{});case"tuto":return t.jsx(Al,{});case"rdv":return t.jsx(cl,{});case"memoalert":return t.jsx(yl,{});default:return null}}function cl(){const{dispatch:e,fund:a}=F(),r=typeof document<"u"&&!!document.getElementById("rdv");return h.useEffect(()=>{r&&(e({type:"modal",modal:null}),ni())},[r,e]),r?null:t.jsx(co,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function pl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s,caps:p,memoQueued:g,doAnalyse:d}=F(),f=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),x=e.chain.idx,c=u[x],b=x>=u.length;return it.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${x+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:x/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:c.name}),t.jsx("div",{className:"sub",children:[st(c.cc,i)||c.countryLabel,c.sector,c.stage,n.daysAgo(ot(c.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:De(c.engine,i).toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&t.jsx("span",{children:kt(c.amountEur,i)})]}),he(c)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Xe,{o:c,lg:!0})," ",t.jsx(Ht,{o:c,src:!0})]}),(c.tagline||c.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:c.tagline||c.headline})]}),c.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:c.reasoning})]}),f&&Ae(c)&&t.jsxs("div",{className:"vbox",style:{"--c":Ge(c)==="retenu"?"var(--brand)":Ge(c)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ge(c)==="retenu"?"✓ "+n.kept:Ge(c)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:c.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&c&&p.pipe&&ke(c)===1&&!g.has(c.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(c),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&c&&!(f&&Ae(c))&&(c.noCo&&c.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:c.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(c)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function ul(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=F(),o=i==="client",l=h.useMemo(()=>o?r.filter(f=>Ae(f)):[],[r,o]),s=h.useMemo(()=>La(l.filter(f=>Ge(f)==="retenu"),{key:"signal",dir:-1}),[l]),p=h.useMemo(()=>l.filter(f=>Ge(f)==="ecarte"),[l]),g=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ne,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function fl(){const{mode:e}=F();return e==="client"||e==="apercu"?t.jsx(ml,{}):t.jsx(gl,{})}function ml(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),[o,l]=h.useState("d"),s=i!=="client";return t.jsxs(Ne,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(xl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(hl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(gr,{})]})}function xl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(0);h.useEffect(()=>{let c=!0;return p(!1),Ga(a).then(b=>{c&&(b?l(b):p(!0))}),()=>{c=!1}},[a,g]);const f=c=>{r||Ga(a,c).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=c=>!o.sections||o.sections.includes(c),x=c=>{const b=o.sections||e.alertSec.map(([v])=>v);f({sections:u(c)?b.filter(v=>v!==c):[...b,c]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([c,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(c),disabled:r,onChange:()=>x(c)}),t.jsxs("span",{children:[b,c==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},c))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Fa,{label:e.alertPreview,readOnly:r,onPreview:()=>go(a),onTest:()=>ho(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function hl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(0);h.useEffect(()=>{let c=!0;return p(!1),Ka(a).then(b=>{c&&(b?l(b):p(!0))}),()=>{c=!1}},[a,g]);const f=c=>{r||Ka(a,c).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,x=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:c=>f({dow:Number(c.target.value)}),children:e.alertDow.map((c,b)=>t.jsx("option",{value:b,children:c},c))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,x-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[x," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,x+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Fa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>vo(a),onTest:()=>bo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function gr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=F(),[l,s]=h.useState(o||""),[p,g]=h.useState(!1),[d,f]=h.useState(!1);h.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,x=h.useMemo(()=>n.filter(m=>he(m)).length,[n]),c=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){f(!0);try{await fetch(`${Ca}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{f(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[c]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(m=>De(m,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(m=>st(m,r)||m).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([m,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:m}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},m))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:m=>s(m.target.value),onKeyDown:m=>{m.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,x)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function gl(){const{t:e}=F();return t.jsx(Ne,{title:e.alertTitle,icon:"🔔",children:t.jsx(gr,{})})}function bl(){var b,v,m;const{t:e,token:a,fund:r,mode:n,flash:i}=F(),[o,l]=h.useState(null),[s,p]=h.useState([]),[g,d]=h.useState(0),f=n==="client";h.useEffect(()=>{let y=!0;return(async()=>{const[j,w]=await Promise.all([Aa(r),Pn(a)]);y&&(j&&l(j),p(w))})(),()=>{y=!1}},[a,r,g]);const u=(o==null?void 0:o.per_day)??2,x=((b=o==null?void 0:o.analyzed_today)==null?void 0:b.length)??0,c=(v=o==null?void 0:o.tomorrow)!=null&&v.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(Ne,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(x,x+(((m=o==null?void 0:o.pool_order)==null?void 0:m.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),f&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Wa(a,y.company,"retry").then(()=>d(j=>j+1))},children:e.queueRetry}),f&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Wa(a,y.company,"delete").then(()=>d(j=>j+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[c.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),c.slice(0,10).map((y,j)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",j+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function vl(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=F(),s=`${ht}/cibles/list.csv?token=${a}`,p=`${ht}/cibles/list.json?token=${a}`,g=`${ht}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,f=v=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:g,href:g}],x=!i.lockActions&&n.length>0,c=()=>{rl(nl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([m])=>m===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ne,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:c,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:m,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(m),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function yl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),o=i!=="client",[l,s]=h.useState(null),[p,g]=h.useState(!1),[d,f]=h.useState(0),[u,x]=h.useState(!1);h.useEffect(()=>{let m=!0;return g(!1),Ya(a).then(y=>{m&&(y?s(y):g(!0))}),()=>{m=!1}},[a,d]);const c=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=m=>{if(o||!l)return;const y={enabled:m.enabled??!!l.enabled,email:m.email??(l.email||""),sections:m.sections??c()};x(!0),Ya(a,y).then(j=>{if(x(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(p)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(m=>m+1),children:e.retry})]})});if(!l)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=c();return t.jsxs(Ne,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(wl,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:m=>b({email:m})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([m,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[m],disabled:o||u,onChange:()=>b({sections:{...v,[m]:!v[m]}})}),t.jsx("span",{children:y})]},m))}),t.jsx(Fa,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>lo(a,v),onTest:()=>so(a,v)})]})}function wl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=h.useState(e);h.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function kl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=F(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(null),[f,u]=h.useState(""),[x,c]=h.useState(0);h.useEffect(()=>{let m=!0;return p(!1),la(a).then(y=>{m&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),uo(a).then(y=>{m&&d(y)}),()=>{m=!1}},[a,x]);const b=(m,y)=>{i&&la(a,m).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}m.test&&j.sent===!1?n(e.plugTestThrottled):r(y),c(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(Ne,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(m=>m+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!i,onChange:m=>u(m.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!f.trim(),onClick:()=>b({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(jl,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function jl(){const{t:e,token:a,lang:r}=F(),[n,i]=h.useState("valides"),[o,l]=h.useState(!1),[s,p]=h.useState(null),[g,d]=h.useState(null),[f,u]=h.useState(!1),[x,c]=h.useState(!1),[b,v]=h.useState(null),[m,y]=h.useState(null),[j,w]=h.useState(null),A=`atl2:bulk:${a}:${n}`;h.useEffect(()=>{la(a).then(L=>{y(L&&L.configured?L.url_hint||"webhook":null)})},[a]),h.useEffect(()=>{p(null),d(null),u(!1),v(null);try{const L=JSON.parse(localStorage.getItem(A)||"null");w(L&&Date.now()-Date.parse(L.t)<24*3600*1e3?L:null)}catch{w(null)}},[A]);const E=async()=>{l(!0),u(!1),v(null);const L=await mo(a,n);p(L),d(L.ok?n:null),l(!1)},R=h.useRef(!1),B=async()=>{if(R.current)return;R.current=!0,c(!0);const L=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let U;try{U=await xo(a,n,"webhook",void 0,L)}finally{R.current=!1}if(c(!1),u(!1),v(U),U.ok&&(U.pushed||0)>0){const k={t:new Date().toISOString(),n:U.pushed||0};w(k);try{localStorage.setItem(A,JSON.stringify(k))}catch{}}},C=s!=null&&s.ok&&s.ready||0,q=!!(s!=null&&s.ok)&&g===n&&C>0&&!!m&&!j,M=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:L=>i(L.target.value),children:e.plugBulkTabs.map(([L,U])=>t.jsx("option",{value:L,children:U},L))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{E()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(M,j.n)}),!j&&!!(s!=null&&s.ok)&&!m&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),q&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),q&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(C,m||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:x,onClick:()=>{B()},children:x?e.bulkSending:e.bulkConfirm(m||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:x,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Nl(){const{t:e,data:a,lang:r}=F(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${Ca}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ne,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Sl(){const{t:e}=F();return t.jsx(Ne,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(sl,{})})}function Cl(){const{t:e,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:l}=F(),[s,p]=h.useState(null),[g,d]=h.useState(!1);h.useEffect(()=>{let E=!0;return Aa(i).then(R=>{E&&R&&typeof R.per_day=="number"&&p(R.per_day)}),()=>{E=!1}},[i]);const f=r.stats,u=typeof(f==null?void 0:f.screened)=="number"?f.screened:n.filter(E=>E.kind==="target"&&Ae(E)).length,x=r.marketEstimate||0,c=x>0?Math.min(100,Math.round(u/x*100)):null,b=(f==null?void 0:f.window_days)||30,v=u>0?u/b:0,m=x>0?Math.max(0,x-u):0,j=x>0&&v>0&&u>=100?Math.round(m/v):null,w=E=>Math.round(E).toLocaleString(a==="en"?"en-US":"fr-FR"),A=E=>{g||!o||(d(!0),fo(i,E).then(R=>{if(d(!1),R===null){l(e.actErr);return}p(R),l(e.alertSaved)}))};return t.jsxs(Ne,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(u))}),x>0&&t.jsx("span",{children:e.covOf(w(x))})]}),c!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:c+"%"}}),t.jsxs("em",{children:[c," %"]})]}),j!==null&&t.jsx("p",{className:"mnote",children:e.covEta(j)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),v>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(v))}),f&&t.jsxs("div",{className:"covf",children:[typeof f.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(f.kept)})," ",e.covKept]}),typeof f.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(f.analyzed)})," ",e.covAna]}),typeof f.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(f.shown)})," ",e.covShown]})]}),o&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(E=>t.jsx("button",{type:"button",className:s===E?"on":"",disabled:g,onClick:()=>A(E),children:E===0?"⏸":E},E))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function El(){var m,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:s}=F(),p=n==="client",g=h.useMemo(()=>{const w=new Set;return a.forEach(A=>{A.angle&&w.add(A.angle)}),[...w]},[a]),[d,f]=h.useState(""),[u,x]=h.useState(""),[c,b]=h.useState(!1),v=async()=>{const w=d.trim();if(!(!w||c||!p)){b(!0),x("");try{const E=await(await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(E.reply&&x(String(E.reply)),E.job_id){x(e.critChatRunning);const R=async()=>{const B=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:E.job_id})}).then(C=>C.json()).catch(()=>null);if(B&&B.done){x(String(B.reply||B.clarification||B.summary||"✓")),b(!1),B.applied&&i(e.alertSaved);return}setTimeout(()=>{R()},8e3)};setTimeout(()=>{R()},8e3),f("");return}f("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(Ne,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((m=o.points)!=null&&m.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var A,E;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((A=w.look)!=null&&A.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(R=>t.jsx("li",{children:R},R))})]}),!!((E=w.out)!=null&&E.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(R=>t.jsx("li",{children:R},R))})]})]})]},w.title)})]}),!!((j=o==null?void 0:o.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!p||c,onChange:w=>f(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},disabled:!p||c||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(po,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(xr[w]||"v-cons"),children:w}),t.jsx("span",{children:A})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",A]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Al(){const{t:e,dispatch:a,startTour:r}=F(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ne,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const br="atl2:mapfold",zl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(br);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},vr=h.createContext(null),F=()=>{const e=h.useContext(vr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Xe({o:e,lg:a}){const{lang:r}=F(),n=he(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Qa(n,r),children:[n.emoji," ",Qa(n,r)]}):null}function Ht({o:e,src:a}){const{lang:r,t:n}=F(),i=he(e);if(!i)return null;const o=No(i),l=So(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn($n(i,r))+" · "+n.win7(Bn(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<o?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function yr({o:e}){const{lang:a}=F(),r=jo(e.cc),n=e.cc?st(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const qn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",wr=e=>`atl2:tour:${e||"anon"}`;function Tl(e){try{return localStorage.getItem(wr(e))==="1"}catch{return!0}}function Mn(e){try{localStorage.setItem(wr(e),"1")}catch{}}function Ll(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:a.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:a.tools,body:r[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:a.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:a.crit,body:r[0][0],modal:"crit"}]}function Pl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){const{lang:l}=yo(),s=Mo[l],p=Yo(e,l,a),[g,d]=h.useReducer(Go,void 0,()=>Wo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||zl(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),f=h.useRef(!0);h.useEffect(()=>{if(f.current){f.current=!1;return}if(!e)try{localStorage.setItem(br,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e]);const u=h.useRef(o);u.current=o,h.useEffect(()=>{var S;(S=u.current)==null||S.call(u,g.filters)},[g.filters]);const[x,c]=h.useState(null),[b,v]=h.useState(null),[m,y]=h.useState({kept:0,dropped:0}),[j,w]=h.useState(!1),[A,E]=h.useState(""),[R,B]=h.useState(!1),[C,q]=h.useState(null),[M,L]=h.useState(!1),[U,k]=h.useState(!1),[,N]=h.useState(0),T=()=>N(S=>S+1),H=h.useRef([]),G=h.useRef(new Set),Z=h.useRef(new Set),z=h.useRef(new Map),O=h.useRef(null),{mode:$}=p,P=h.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[p.caps,i,a]),D=P.pipe,_=p.session.token||"",W=$==="client"&&!e;h.useEffect(()=>{if(document.querySelector(`link[href="${qn}"]`))return;const S=document.createElement("link");S.rel="stylesheet",S.href=qn,document.head.appendChild(S)},[]);const X=(S,V=!1)=>{E(S),B(V),O.current&&clearTimeout(O.current),O.current=setTimeout(()=>E(""),V?4200:2400)},re=S=>X(S,!0),me=h.useMemo(()=>{const S=new Map;return p.dossiers.forEach(V=>{V.id&&S.set(V.id,V)}),S},[p.dossiers]),pe=h.useMemo(()=>p.dossiers.filter(S=>Vn(S,g,D)),[p.dossiers,g,D]),Q=h.useRef(!1);h.useEffect(()=>{if(Q.current||e||p.loading||!p.dossiers.length)return;if(!P.showFunnel||Tl(p.session.token||"")){Q.current=!0;return}Q.current=!0;const S=window.setTimeout(()=>{Mn(p.session.token||""),L(!0)},700);return()=>window.clearTimeout(S)},[e,p.loading,p.dossiers.length,P.showFunnel,p.session.token]);const te=h.useMemo(()=>p.dossiers.filter(S=>Ko(S,g,D,p.favIds)),[p.dossiers,g,D,p.favIds]),ve=h.useMemo(()=>wo(pe,p.favIds),[pe,p.favIds]),K=za.find(S=>S.key===g.continent),se=g.continent==="monde"?s.contWorld:(l==="fr"?K==null?void 0:K.fr:K==null?void 0:K.en)||"";h.useEffect(()=>{const S=V=>{var ue;const Y=(((ue=V.detail)==null?void 0:ue.name)||"").trim();Y&&ee(null,Y)};return window.addEventListener("ppmap:evaluate",S),()=>window.removeEventListener("ppmap:evaluate",S)}),h.useEffect(()=>{const S=ue=>{const qe=String(ue||"").trim();qe&&d({type:"filters",patch:{sector:[qe]}})},V=ue=>{var qe;return S((qe=ue.detail)==null?void 0:qe.sector)},Y=ue=>{ue.data&&ue.data.type==="pp-filter"&&S(ue.data.sector)};return window.addEventListener("ppmap:filter",V),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",V),window.removeEventListener("message",Y)}},[]);const ee=(S,V)=>{const Y=((S==null?void 0:S.name)||V||"").trim();if(!W){v({kicker:Y});return}!Y||j||(w(!0),(async()=>{try{let ue=Y;const qe=((S==null?void 0:S.website)||(S==null?void 0:S.domain)||"").trim();if(qe)ue=qe;else try{const fe=await Co(Y);if(fe!=null&&fe.website)ue=fe.website;else if(((fe==null?void 0:fe.candidates)||[]).length===1)ue=fe.candidates[0].url;else if(((fe==null?void 0:fe.candidates)||[]).length>1){H.current=[{name:Y,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(fe.candidates||[]).slice(0,5)},...H.current].slice(0,8),T();return}}catch{}const Me=await In(_,ue,"atelier2"),jr={name:Me.company||Y,verdict:Me.verdict,reason:Me.reason||"",remaining:Me.remaining??null};H.current=[jr,...H.current].slice(0,8),Me.verdict==="kept"&&y(fe=>({...fe,kept:fe.kept+1})),Me.verdict==="ruled_out"&&y(fe=>({...fe,dropped:fe.dropped+1}));const dt=S||p.dossiers.find(fe=>(fe.name||"").toLowerCase()===Y.toLowerCase());dt&&(Me.verdict==="kept"?dt.verdict=dt.verdict||"MATCH":Me.verdict==="ruled_out"&&(dt.verdict="NO MATCH"),Me.reason&&(dt.reasoning=Me.reason)),T()}finally{w(!1)}})())},_e=S=>{if(!W){v({kicker:S.name});return}G.current.add(S.id),ct(_,"fast_request",S.name||"",""),X(s.memoInstantSent(S.name)),T()},xe=S=>z.current.get(S.id)??p.thumbs.get((S.name||"").trim().toLowerCase()),ge=(S,V)=>d({type:"undoPush",entry:{id:S.id,name:S.name,prevCeoStatus:V}}),Ie=async(S,V,Y)=>{const ue=S.ceoStatus||"";S.ceoStatus=V,T();const qe=await Jt(_,{status:V,airtable_id:S.airtableId,check_id:S.checkId,company:S.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return qe.ok?qe.skipped?(S.ceoStatus=ue,T(),re(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&ge(S,ue),Y!=null&&Y.msg&&X(Y.msg),(V==="Validé"||V==="Écarté")&&!S.ceoNote&&(Y==null?void 0:Y.note)===void 0&&q({o:S,yes:V==="Validé"}),!0):(S.ceoStatus=ue,T(),re(s.actErr),!1)},He=async(S,V)=>{const Y=await Jt(_,{status:S.ceoStatus||"Retenu",airtable_id:S.airtableId,check_id:S.checkId,company:S.name,note:V,via:"note"});return!Y.ok||Y.skipped?(re(Y.skipped?s.actNotPersisted:s.actErr),!1):(S.ceoNote=V,T(),!0)},Se=h.useRef(new Map),$e=S=>Se.current.has(S.id)?Se.current.get(S.id):p.stages.get((S.name||"").trim().toLowerCase()),lt=(S,V)=>{Se.current.set(S.id,V),T()},Yt=(S,V)=>{W&&Ie(S,V?"Validé":"Écarté",{msg:V?s.decidedYes(S.name):s.decidedNo(S.name)})},Wt=S=>{W&&Ie(S,"À trancher",{msg:s.promoted(S.name)})},I=S=>{W&&(async()=>{const V=S.ceoStatus||"";S.ceoStatus="Retenu",T();const Y=await Jt(_,{status:"Retenu",check_id:S.checkId,company:S.name});if(!Y.ok||Y.skipped){S.ceoStatus=V,T(),re(Y.skipped?s.actNotPersisted:s.actErr);return}ge(S,V),X(s.repeched(S.name))})()},ae=()=>{const S=g.undo[g.undo.length-1];if(!S){X(s.undoNone);return}const V=me.get(S.id);if(!V){d({type:"undoPop"}),X(s.undoNone);return}let Y=S.prevCeoStatus;if(!Y)if((V.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{X(s.undoLockedTitle);return}(async()=>await Ie(V,Y,{undo:!1})&&(d({type:"undoPop"}),V.ceoStatus=S.prevCeoStatus,T(),X(s.undoDone(V.name))))()},oe=S=>{W&&(Z.current.add(S.id),T(),(async()=>{const V=await Eo(_,S.name,"email");if(!V||V.ok===!1){Z.current.delete(S.id),T(),re(s.actErr);return}ct(_,"approach",S.name||"",""),X(s.actApproachSent)})())},ye=(S,V)=>{W&&(async()=>{if(!(await ct(_,V?"yes":"no",S.name||"","")).ok){re(s.actErr);return}z.current.set(S.id,V?"yes":"no"),T(),X(V?s.thumbUpDone:s.thumbDnDone)})()},Ve=S=>{!W||!wt(S)||(ct(_,"detailed_request",S.name||"",""),X(s.memoDeepSent(S.name)))},je=S=>{const V=new Set(p.favIds),Y=V.has(S.id);Y?V.delete(S.id):V.add(S.id),p.setFavIds(V),W&&Ao(_,{id:S.id,co:S.name},Y)},le=()=>{!W||U||window.confirm(s.identSyncConfirm)&&(k(!0),(async()=>{const S=await zo(_);k(!1),S?X(s.identSyncDone):re(s.actErr)})())},Ce=/proplace/i.test(p.fund||""),Gt=S=>{!W||!Ce||(ct(_,"onboard_request",S.name||"",""),X(s.onboardSent(S.name)))},jt={st:g,dispatch:d,t:s,lang:l,mode:$,caps:P,pipe:D,token:_,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:I,thumbOf:xe,canWrite:W,commitStatus:Ie,saveNote:He,stageOf:$e,setStage:lt,flashErr:re,startTour:()=>L(!0),dossiers:p.dossiers,scopedAll:pe,scoped:te,counts:ve,byId:me,contName:se,favIds:p.favIds,toggleFav:je,askEvaluate:ee,doAnalyse:_e,doDecide:Yt,doPromote:Wt,doApproach:oe,doThumb:ye,doDeep:Ve,doUndo:ae,doSync:le,doOnboard:Gt,outbound:Ce,memoQueued:G.current,approachDone:Z.current,sessTally:m,evalCards:H.current,evalBusy:j,markRow:c,markedId:x,flash:X};h.useEffect(()=>{const S=V=>{V.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",S),()=>window.removeEventListener("keydown",S)},[]);const kr=S=>_?t.jsx(Os,{token:_,children:S}):t.jsx(t.Fragment,{children:S});return t.jsx(vr.Provider,{value:jt,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Po}),kr(t.jsxs("div",{className:"app"+(D?" pipe":"")+(_?" has-thesis":""),children:[P.showTicker&&t.jsx(be,{name:"live",children:t.jsxs("div",{className:"live-stack"+(_?" live-stack--cibles":""),children:[t.jsx(ei,{}),!!_&&t.jsx(Fs,{})]})}),P.showIdent&&t.jsx(be,{name:"identite",children:t.jsx(gi,{})}),!!_&&t.jsx(be,{name:"lead",children:t.jsx(Ms,{})}),P.showOnb&&t.jsx(be,{name:"onboarding",children:t.jsx(bi,{})}),P.showMorning&&t.jsx(be,{name:"matin",children:t.jsx(hi,{})}),t.jsx(be,{name:"fraicheur",children:t.jsx(li,{})}),t.jsx(be,{name:"mesure",children:t.jsx(di,{})}),P.showFunnel&&t.jsx(be,{name:"entonnoir",children:t.jsx(Rl,{})}),P.showFunnel&&t.jsx(be,{name:"tunnel",children:t.jsx(yi,{})}),P.showFunnel&&t.jsx(be,{name:"tuto",children:t.jsx(ki,{})}),t.jsx(be,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(ql,{}),t.jsxs("div",{className:"stage"+(g.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(vs,{}),t.jsx(ws,{})]})]})}),P.showDemand&&t.jsx(be,{name:"evaluation",children:t.jsx(Es,{})}),P.showDemand&&g.memoConsole&&t.jsx(be,{name:"console",children:t.jsx(zs,{})}),t.jsx(be,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(tl,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),P.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),g.popupId&&t.jsx(be,{name:"fiche",children:t.jsx(Is,{})}),t.jsx(be,{name:"modales",children:t.jsx(dl,{})}),t.jsx(oi,{}),C&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:C.o.name}),t.jsx(fi,{placeholder:C.yes?s.whyYesPh:s.whyNoPh,onDone:S=>{const V=C.o;q(null),S&&He(V,S).then(Y=>{Y&&X(s.csNoteSaved)})}})]}),M&&t.jsx(xi,{steps:Ll(s),onClose:()=>{L(!1),Mn(_)}}),A&&t.jsx("div",{className:"flash on"+(R?" err":""),children:A}),b&&t.jsx(ko,{variant:"acquirer",initialCompany:On().co,initialWebsite:On().site,onClose:()=>v(null)})]})})}function Rl(){const{t:e}=F(),[a,r]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function ql(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=F(),l=h.useMemo(()=>{const s={};return e.forEach(p=>{Ta(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[To.map(s=>{const p=za.find(d=>d.key===s),g=s==="monde"?o.contWorld:i==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[g,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function On(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ml(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{yr as FlagCell,Xe as SigBadge,Ht as SigWin,Pl as default,Ml as fmtShort,F as useV2};
