...
.atl2 .bulk .side .hint{white-space:nowrap}`,Sl=`
...
/* ExtraFields hors des lignes. La carte liste REMPLIT la colonne gauche
   (avant, ExtraFields gonflait le shrink-wrap jusqu'à l'édito ; une fois
   retiré, le cadre se collait à gauche). Analyser reste compact. */
.atl2.cibles .desk{width:100%;min-width:0}
.atl2.cibles .desk-list{width:100%!important;min-width:0;max-width:none;
  justify-self:stretch}
.atl2.cibles .desk-list .listhead,
.atl2.cibles .desk-list .list,
.atl2.cibles .desk-list .cols,
.atl2.cibles .desk-list .row{width:100%;box-sizing:border-box}
...
/* Sticky : même recette que /actualites — un seul scroll = la fenêtre.
   overflow:hidden sur .atl2 (proto) et sur html/body (embed chrome)
   empêchait eval-stick / listhead / readpane de coller. */
body.pp-desk .atl2.cibles,
body.pp-desk .atl2.cibles .app{height:auto!important;max-height:none!important;
  overflow:visible!important}
body.pp-desk .atl2.cibles .desk,
body.pp-desk .atl2.cibles .desk-list,
body.pp-desk .atl2.cibles .list,
body.pp-desk .atl2.cibles .grp{overflow:visible!important}
@media (max-width:1240px){
  .atl2.cibles .desk-list .row,
  .atl2.cibles .desk-list .cols{
    grid-template-columns:11px 20px minmax(0,1fr) max-content max-content!important}
...
`,Al=Nl+Sl+Cl+zl;function gn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function ql(){const e=gn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Tl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=ql();return r==="0"?"client":r==="1"||gn("embed")==="1"&&gn("chrome")==="1"?"apercu":"client"}const Ll={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Fl=e=>Ll[e];function Fa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Tt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!bo(a)||Fa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ji(e.cc)})};function Za(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Rl=60*60*1e3;function Ol(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Rl?null:a}catch{return null}}function ga(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ml=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Dl(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:_i(),[e,n]),i=c.useMemo(()=>n?"visiteur":Tl(e,o),[e,o,n]),d=c.useMemo(()=>Fl(i),[i]),l=i!=="visiteur",s=Ml(r),[h,p]=c.useState([]),[x,m]=c.useState(""),[b,f]=c.useState(null),[w,y]=c.useState(null),[u,v]=c.useState(null),[j,k]=c.useState(()=>new Map),[E,N]=c.useState(()=>new Map),[C,q]=c.useState(""),[S,L]=c.useState(new Set),[I,$]=c.useState(null),[R,M]=c.useState(!0),[g,T]=c.useState(!1),[O,J]=c.useState(0),[te,z]=c.useState(0),B=c.useRef(0),D=c.useMemo(()=>{var U;if(i!=="client")return"";try{return((U=Bi())==null?void 0:U.email)||""}catch{return""}},[i]);c.useEffect(()=>{const U=++B.current;let ue=!0;const ae=()=>ue&&U===B.current,de=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),xe=Ol(de);return xe?(p(xe.objs.map(Tt)),xe.fund&&m(xe.fund),f(xe.marketEstimate??null),y(xe.criteria??null),v(xe.stats??null),q(xe.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const me=await Qa(),we=((me==null?void 0:me.recent_ops)||[]).map(be=>{const Ne=Na(be.company_name||be.title?be:{...be,title:(be.headline_fr||be.headline||"").slice(0,120)},a),Re=String(be.rubrique||"").toLowerCase();return Ne&&(Re==="nominations"||Re==="recrutements")&&(Ne.engine=Re),Ne&&!String(be.company_name||"").trim()&&(Ne.noCo=!0),Ne}).filter(be=>!!be).map(be=>(bo((be.name||"").trim())||(be.noCo=!0),be));try{const be=$i(),Ne=await Ui(),Re=((Ne==null?void 0:Ne.date)||"").slice(0,10),ne=be?be.doc:Ne,ke=Hi(ne),ve=((be==null?void 0:be.day)||(ne==null?void 0:ne.date)||Re||"").slice(0,10);if(ve&&ke.length){const oe=new Set;for(const _ of we){if((_.date||"").slice(0,10)!==ve)continue;const W=er(ke,oe,_.name,"");W>=0&&(oe.add(W),_.decryptHtml=ke[W].html)}for(const _ of we){if(_.decryptHtml||(_.date||"").slice(0,10)!==ve)continue;const W=er(ke,oe,"",_.headline||_.tagline||_.name);W>=0&&(oe.add(W),_.decryptHtml=ke[W].html)}}if(ve){const oe=((ne==null?void 0:ne.title_fr)||"").trim(),_=((ne==null?void 0:ne.lead_fr)||"").trim(),W=Vi(ne),Z=((ne==null?void 0:ne.url)||"").trim();oe&&(W||Z)&&we.unshift({id:`edito:${ve}`,kind:"op",name:oe,cc:null,date:ve,engine:"edito",dealKind:"other",headline:oe,tagline:_||oe,decryptHtml:W||void 0,url:Z,noCo:!0})}}catch{}if(!ae())return;p(we.map(Tt)),ga(de,{objs:we})}else if(typeof r=="object"){const we=(await tr()||[]).filter(Ne=>(Ne.slug||"")===r.research).map(Ne=>ar(Ne,a)).filter(Ne=>!!Ne),be=Za(await nr(we,a));if(!ae())return;p(be.map(Tt)),ga(de,{objs:be})}else if(l&&o.token){const me=Wi(o.token),we=Qa(),be=Gi(o.token),Ne=Yi(o.token),Re=Qi(o.token),ne=await me;let ke=ne?ne.targets:[];ae()&&ne&&(m(ne.fund||""),f(ne.marketEstimate??null),y(ne.criteria??null),v(ne.stats??null),q(ne.generatedAt||""),p(ke.map(Tt)),M(!1),T(!1));const[ve,oe,_,W]=await Promise.all([we,be,Ne,Re]),Z=((ve==null?void 0:ve.recent_ops)||[]).map(re=>Na(re,a)).filter(re=>!!re),le=new Set(ke.map(re=>re.id));if(ke=[...ke,...Z.filter(re=>!le.has(re.id)&&(le.add(re.id),!0))],!ae())return;p(ke.map(Tt));const pe=new Set;for(const re of oe){const ie=(re.id||re.co||"").toString().trim().toLowerCase();ie&&pe.add(ie.startsWith("t:")?ie:"t:"+ie)}L(pe),k(_),N(W),ne&&ga(de,{fund:ne.fund,marketEstimate:ne.marketEstimate,criteria:ne.criteria,stats:ne.stats,generatedAt:ne.generatedAt,objs:ke})}else{const me=Ki(),we=tr(),be=Qa(),Ne=await me;ae()&&Ne.length&&(p(Za(Ne).map(Tt)),M(!1),T(!1));const[Re,ne]=await Promise.all([we,be]),ke=(Re||[]).map(W=>ar(W,a)).filter(W=>!!W),ve=await nr(ke,a),oe=((ne==null?void 0:ne.recent_ops)||[]).map(W=>Na(W,a)).filter(W=>!!W),_=Za([...Ne,...ve,...oe]);if(!ae())return;p(_.map(Tt)),ga(de,{objs:_})}ae()&&T(!1)}catch{ae()&&!xe&&T(!0)}finally{ae()&&M(!1)}})(),()=>{ue=!1}},[l,o.token,a,O,s]),c.useEffect(()=>{if(!d.showCredits||!D){$(null);return}let U=!0;return(async()=>{try{const ue=await fetch(`${Va}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:D})});if(!ue.ok)return;const ae=await ue.json();U&&ae&&ae.ok!==!1&&$(ae)}catch{}})(),()=>{U=!1}},[d.showCredits,D,te]);const V=c.useCallback(U=>L(new Set(U)),[]);return{session:o,mode:i,caps:d,fund:x,email:D,marketEstimate:b,generatedAt:C,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:u,thumbs:j,stages:E,dossiers:h,patchStatuses:(U,ue)=>{p(ae=>{let de=!1;const xe=ae.map(me=>{if(!me.checkId)return me;const we=U.get(me.checkId);return!we||we===(me.ceoStatus||"")||!ue(me.id)?me:(de=!0,{...me,ceoStatus:we})});return de?xe:ae})},favIds:S,setFavIds:V,credits:I,reloadCredits:()=>z(U=>U+1),loading:R,error:g,refresh:()=>J(U=>U+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Sa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Ra(e){return Sa.has(e.engine||"")}function Xe(e){return!!e.noCo||Ra(e)&&!!e.url}const Mo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Il=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Mo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Pl=new Set(["signal","amount","score","crible","memo"]);function _l(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Mo(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Pl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Do)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Do=80;function Oa(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!$e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Rn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(jt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Lt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(wo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function sa(e,a,r){return We(e)?Oa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Oa(e,a.filters,r)}function Bl(e,a,r,n){return!(!sa(e,a,r)||r&&!vo(e,a.ptab,n))}function Pn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-jt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Zi(o)||null;case"memo":return Xi(o)||null;case"signal":{const i=$e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const en={},kr=(en==null?void 0:en.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Er(){return new Date().toISOString().slice(0,10)}const _n=c.createContext(null);function Io(){return c.useContext(_n)}function $l(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const h=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(p=>s.removeAttribute(p.name)),h&&/^https?:\/\//i.test(h)&&(s.setAttribute("href",h),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Po(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Ul(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Po(r),r.innerHTML):e}catch{return e}}function jr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Po(r),r.innerHTML):e}catch{return e}}function Nr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function _o(){const e=c.useContext(_n);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Hl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Q(),[i,d]=c.useState(()=>n.filters.day||Er()),[l,s]=c.useState(null),[h,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),m=c.useCallback(()=>{d(Er());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=y=>{var v;const u=(v=y.detail)==null?void 0:v.day;typeof u=="string"&&x(u)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${kr}/cibles/edition.json?${y}`).then(u=>u.json()).then(u=>{w||s(u)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${kr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),f=c.useMemo(()=>({token:e,day:i,ed:l,loading:h,pickDay:x,pickWindow:m,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,h,x,m,n.filters.day,b,o]);return t.jsx(_n.Provider,{value:f,children:a})}function Vl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=_o(),[o,i]=c.useState(()=>n||yo());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(qa,d),()=>window.removeEventListener(qa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(es,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Wl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Sr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Cr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Gl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=_o(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,h=c.useRef(null),[p,x]=c.useState("fonds"),[m,b]=c.useState(null),[f,w]=c.useState("idle"),y=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),y.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||y.current)return;y.current=!0;let E=!0;return w("load"),Wl(e).then(N=>{E&&(b(N),w("fait"))}),()=>{E=!1}},[p,e]);const u=c.useMemo(()=>Ul((m==null?void 0:m.html)||""),[m==null?void 0:m.html]),v=c.useRef(null);c.useEffect(()=>{const E=v.current;if(!E||!u)return;let N=!1;return mn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{N=!0}},[u]);const j=c.useMemo(()=>jr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=c.useMemo(()=>jr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const E=h.current;if(!E||!j)return;let N=!1;return mn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{N=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
