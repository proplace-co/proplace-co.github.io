...
· « Mémo détaillé » relance une analyse approfondie — **1 crédit**, une société à la fois.`,fhintCover:`Combien de votre marché vous avez déjà regardé.
...
· “Detailed memo” runs a deeper analysis — **1 credit**, one company at a time.`,fhintCover:`How much of your market you have already looked at.
...
.atl2 .bulk .side .hint{white-space:nowrap}`,Bo=`
...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Uo=$o+Bo;function ca(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function _o(){const e=ca("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Vo(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=_o();return r==="0"?"client":r==="1"||ca("embed")==="1"&&ca("chrome")==="1"?"apercu":"client"}const Ho={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Yo=e=>Ho[e];function Wo(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const We=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Pn(a)||Wo(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Vr(e.cc)})};function Xt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Go=60*60*1e3;function Ko(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Go?null:a}catch{return null}}function St(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Qo=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Jo(e,a,r="default"){const n=r!=="default",i=h.useMemo(()=>e||n?{mode:"anon"}:Or(),[e,n]),o=h.useMemo(()=>n?"visiteur":Vo(e,i),[e,i,n]),l=h.useMemo(()=>Yo(o),[o]),s=o!=="visiteur",p=Qo(r),[g,c]=h.useState([]),[m,u]=h.useState(""),[x,d]=h.useState(null),[b,v]=h.useState(null),[f,y]=h.useState(null),[k,w]=h.useState(()=>new Map),[C,A]=h.useState(()=>new Map),[R,B]=h.useState(""),[E,M]=h.useState(new Set),[q,L]=h.useState(null),[U,j]=h.useState(!0),[S,T]=h.useState(!1),[H,G]=h.useState(0),[Z,z]=h.useState(0),O=h.useRef(0),$=h.useMemo(()=>{var D;if(o!=="client")return"";try{return((D=Fr())==null?void 0:D.email)||""}catch{return""}},[o]);h.useEffect(()=>{const D=++O.current;let _=!0;const W=()=>_&&D===O.current,X=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),re=Ko(X);return re?(c(re.objs.map(We)),re.fund&&u(re.fund),d(re.marketEstimate??null),v(re.criteria??null),y(re.stats??null),B(re.generatedAt||""),j(!1)):j(!0),(async()=>{try{if(r==="ops"){const xe=await Kt(),pe=((xe==null?void 0:xe.recent_ops)||[]).map(K=>{const te=Qt(K.company_name||K.title?K:{...K,title:(K.headline_fr||K.headline||"").slice(0,120)},a),be=String(K.rubrique||"").toLowerCase();return te&&(be==="nominations"||be==="recrutements")&&(te.engine=be),te&&!String(K.company_name||"").trim()&&(te.noCo=!0),te}).filter(K=>!!K).map(K=>(Pn((K.name||"").trim())||(K.noCo=!0),K));try{const K=await Pr(),te=Dr(K),be=((K==null?void 0:K.date)||"").slice(0,10);if(te.length&&be){const ee=new Set;for(const se of pe){if(se.noCo||(se.date||"").slice(0,10)!==be)continue;const Q=Ia(te,ee,se.name,"");Q>=0&&(ee.add(Q),se.decryptHtml=te[Q].html)}for(const se of pe){if(se.decryptHtml||(se.date||"").slice(0,10)!==be)continue;const Q=Ia(te,ee,"",se.headline||se.tagline||se.name);Q>=0&&(ee.add(Q),se.decryptHtml=te[Q].html)}}}catch{}if(!W())return;c(pe.map(We)),St(X,{objs:pe})}else if(typeof r=="object"){const pe=(await $a()||[]).filter(te=>(te.slug||"")===r.research).map(te=>Ba(te,a)).filter(te=>!!te),K=Xt(await Ua(pe,a));if(!W())return;c(K.map(We)),St(X,{objs:K})}else if(s&&i.token){const xe=Ir(i.token),pe=Kt(),K=$r(i.token),te=Br(i.token),be=Ur(i.token),ee=await xe;let se=ee?ee.targets:[];W()&&ee&&(u(ee.fund||""),d(ee.marketEstimate??null),v(ee.criteria??null),y(ee.stats??null),B(ee.generatedAt||""),c(se.map(We)),j(!1),T(!1));const[Q,Ue,fe,ve]=await Promise.all([pe,K,te,be]),at=((Q==null?void 0:Q.recent_ops)||[]).map(je=>Qt(je,a)).filter(je=>!!je);if(se=[...se,...at],!W())return;c(se.map(We));const He=new Set;for(const je of Ue){const qe=(je.id||je.co||"").toString().trim().toLowerCase();qe&&He.add(qe.startsWith("t:")?qe:"t:"+qe)}M(He),w(fe),A(ve),ee&&St(X,{fund:ee.fund,marketEstimate:ee.marketEstimate,criteria:ee.criteria,stats:ee.stats,generatedAt:ee.generatedAt,objs:se})}else{const xe=_r(),pe=$a(),K=Kt(),te=await xe;W()&&te.length&&(c(Xt(te).map(We)),j(!1),T(!1));const[be,ee]=await Promise.all([pe,K]),se=(be||[]).map(ve=>Ba(ve,a)).filter(ve=>!!ve),Q=await Ua(se,a),Ue=((ee==null?void 0:ee.recent_ops)||[]).map(ve=>Qt(ve,a)).filter(ve=>!!ve),fe=Xt([...te,...Q,...Ue]);if(!W())return;c(fe.map(We)),St(X,{objs:fe})}W()&&T(!1)}catch{W()&&!re&&T(!0)}finally{W()&&j(!1)}})(),()=>{_=!1}},[s,i.token,a,H,p]),h.useEffect(()=>{if(!l.showCredits||!$){L(null);return}let D=!0;return(async()=>{try{const _=await fetch(`${Ca}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:$})});if(!_.ok)return;const W=await _.json();D&&W&&W.ok!==!1&&L(W)}catch{}})(),()=>{D=!1}},[l.showCredits,$,Z]);const P=h.useCallback(D=>M(new Set(D)),[]);return{session:i,mode:o,caps:l,fund:m,email:$,marketEstimate:x,generatedAt:R,criteria:b,stats:f,thumbs:k,stages:C,dossiers:g,favIds:E,setFavIds:P,credits:q,reloadCredits:()=>z(D=>D+1),loading:U,error:S,refresh:()=>G(D=>D+1)}}const _n=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Xo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{..._n(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Zo(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:_n(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Vn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Vn=40;function Ta(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!he(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ea(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(Ve(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ke(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Hn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ta(e,a.filters,r)}function ei(e,a,r,n){return!(!Hn(e,a,r)||r&&!Hr(e,a.ptab,n))}function La(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-Ve(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=he(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const ti=["ma","levees","nominations","recrutements","actualites"],ai=300,Zt=7,ni={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Yn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},ri=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ja(e){const a=he(e);if(a)return"sig:"+(a.theme&&Yn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function oi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=F(),s=l==="en",[p,g]=h.useState("all"),[c,m]=h.useState(!1),u=h.useMemo(()=>{const E=(a.filters.day||"").slice(0,10),M=j=>!(!o&&a.continent!=="monde"&&j.continent!==a.continent||E&&(j.date||"").slice(0,10)!==E),q=e.filter(j=>M(j)&&he(j)),L=e.filter(j=>M(j)&&j.kind==="op"&&!he(j)&&(E?!0:Ve(j.date)<=Zt)),U=E||new Date().toISOString().slice(0,10);return L.sort((j,S)=>{const T=(j.date||"").slice(0,10)===U?0:1,H=(S.date||"").slice(0,10)===U?0:1;return T!==H?T-H:(S.amountEur||0)-(j.amountEur||0)}),[...La(q,{key:"signal",dir:-1}),...L]},[e,a.continent,a.filters.day,o]),x=h.useMemo(()=>{const E={};for(const M of u){const q=Ja(M);E[q]=(E[q]||0)+1}return E},[u]),d=h.useMemo(()=>p==="all"?u:u.filter(E=>Ja(E)===p),[u,p]),b=h.useMemo(()=>d.slice(0,ai),[d]),v=d.length-b.length,f=E=>E==="all"?u.length:x[E]||0,y=E=>E==="all"?s?"All":"Tout":E.startsWith("sig:")?Yn[s?"en":"fr"][E.slice(4)]||"🔔":ni[s?"en":"fr"][E],k=[{k:"all"}],w=ti.filter(E=>f(E)>0||E===p);if(w.length){k.push({g:s?"DEALS":"OPÉRATIONS"});for(const E of w)k.push({k:E})}const C=ri.map(E=>"sig:"+E).filter(E=>f(E)>0||E===p);if(C.length){k.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const E of C)k.push({k:E})}const A=E=>{try{return new Date(E+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return E}},R=(()=>{const E=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return E?(s?`LIVE covers the events of ${A(E)}.`:`Le LIVE regroupe les événements du ${A(E)}.`)+M:(s?`LIVE covers the still-open signals and the deals of the last ${Zt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Zt} derniers jours.`)+M})(),B=E=>b.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Ee(M)?" spent":""),onClick:q=>{const L=q.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:L.left+L.width/2,y:L.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Ze,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(jr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Il(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Ht,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},E+(M.id||M.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},E+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:E=>{E.currentTarget.contains(E.relatedTarget)||m(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":c,onClick:()=>m(E=>!E),children:[y(p),t.jsx("b",{children:f(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!c,children:[t.jsx("span",{className:"tkfilscope",children:R}),k.map(E=>"g"in E?t.jsx("span",{className:"tkfilg",children:E.g},E.g):t.jsxs("button",{type:"button","aria-pressed":E.k===p,onClick:()=>{g(E.k),m(!1)},children:[y(E.k),t.jsx("b",{children:f(E.k)})]},E.k))]})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[B(0),B(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const ii="aDx8z7Hzksus",Wn="+33 6 83 10 72 86",Xa="alexandre@proplace.co",si=`tel:${Wn.replace(/[^\d+]/g,"")}`,Za="pp-rdv-slot";function li(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ci(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:pi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:si,children:Wn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Xa}`,children:Xa})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Fo,{filloutId:ii,parameters:r?{company_name:r}:void 0})})]})}function di(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById(Za));return h.useEffect(()=>{e||a(document.getElementById(Za))},[e]),e?lt.createPortal(t.jsx(ci,{}),e):null}const pi=`
...
`;class ge extends h.Component{constructor(){super(...arguments);Pa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ui=8;function mi(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,p]=h.useState(!1),[g,c]=h.useState(!1),[m,u]=h.useState(!1),x=r||"home",{names:d,verdicts:b}=h.useMemo(()=>{const w=[],C={};return n.forEach(A=>{A.kind!=="target"||!A.name||(w.push(A.name),C[A.name]=Yr(A)||"")}),{names:w,verdicts:C}},[n]),v=h.useMemo(()=>d.length?Wr(x,d,b,a):null,[x,d.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const f=g?v.added:v.added.slice(0,ui),y=v.added.length-f.length,k=w=>{const C=n.find(A=>A.name===w);C&&(o(C.id),l({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Gr(x,d,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[f.map(w=>t.jsx("button",{type:"button",onClick:()=>k(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>c(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),m&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const ea=600,Ge=62,en="atl2:fstats";function fi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(en)==="on"}catch{return!1}}),p=r.stats,g=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),c=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const m=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),x=g.reduce((y,k)=>Math.max(y,k.s||0),0),d=g.length?ea/g.length:0,b=Math.max(4,d-4),v=g.length>=5&&x>0,f=[[p.screened,e.funScreened(m(c)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[f.map(([y,k,w],C)=>t.jsxs("span",{className:"fst-t",children:[C>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:k}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},k)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(en,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ea} ${Ge}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((y,k)=>{const w=(y.s||0)/x*(Ge-4),C=(y.m||0)/x*(Ge-4),A=k*d+(d-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:Ge-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:Ge-2-C,width:b,height:C,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ge-1.5,x2:ea,y2:Ge-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const xi=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function hi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),c=(et(e)||"").startsWith("CALL")&&ke(e)===3,m=ke(e)>=2,u=async d=>{if(o||d==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(d);const b=await i(e,d);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},x=c?[["Validé",a.csYes],["Écarté",a.csNo]]:xi.filter(([d])=>!(m&&d==="Retenu")).map(([d,b])=>[d,a[b]]);return t.jsxs("div",{className:"csp",onClick:d=>d.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),x.map(([d,b])=>t.jsx("button",{type:"button",className:"csb"+(g===d?" on":"")+(o===d?" busy":""),disabled:!!o,onClick:()=>{u(d)},children:b},d)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(gi,{o:e})]})}function gi({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,g]=h.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{m()},children:p?a.csNoteSaved:a.csNoteOk})]})}function bi({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function vi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[p,g]=h.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const c=o(e),m=(c==null?void 0:c.stage)||"todo",u=async f=>{if(p||f===m)return;g(!0);const y=c;l(e,{stage:f,stamps:(c==null?void 0:c.stamps)||{}});const k=Math.max(Date.now(),tn+=1);tn=k;const w=await Kr(r,{company:e.name||"",stage:f,cts:k,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},x=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,d=x?Math.floor((Date.now()-Date.parse(x))/864e5):0,b=m==="sent"&&x&&d>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(m===f?" on":""),disabled:p,onClick:()=>{u(f)},children:y},f)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(d)})]})}let tn=0;const Ct=8,Et=360;function an({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function nn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(an,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(an,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function yi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=h.useState(0),[p,g]=h.useState(null),[c,m]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,m(e.filter(k=>!!document.querySelector(k.need||k.sel))))},[e]);const x=c[l],d=l>=c.length;h.useEffect(()=>{if(x&&(x.ptab!==void 0&&o.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&o.dens!==x.dens&&n({type:"dens",dens:x.dens}),o.modal!==(x.modal??null)&&n({type:"modal",modal:x.modal??null}),x.click)){const k=x.click,w=window.setTimeout(()=>{const C=document.querySelector(k);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(w)}},[l,x]);const b=h.useCallback(()=>{if(!x){g(null);return}const k=document.querySelector(x.sel);if(!k){g(null);return}k.scrollIntoView({block:"nearest",behavior:"smooth"}),g(k.getBoundingClientRect())},[x]);h.useLayoutEffect(()=>{b();const k=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(k),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=h.useRef(a);if(v.current=a,h.useEffect(()=>{const k=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(C=>C+1):w.key==="ArrowLeft"&&s(C=>Math.max(0,C-1))};return document.addEventListener("keydown",k,!0),()=>document.removeEventListener("keydown",k,!0)},[]),!c.length)return null;let f=null;if(d){const k=i[3]||0;k>0?f={title:k===1?r.ahaATitle1:r.ahaATitleN(k),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?f={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:f={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Et};if(!d&&p){const k=p.bottom+14,C=window.innerHeight-k>190?k:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-Et/2),window.innerWidth-Et-12),top:C,width:Et}}return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!d&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-Ct,top:p.top-Ct,width:p.width+Ct*2,height:p.height+Ct*2}}),(d||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(d?" fin":""),style:y,children:[d&&f?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:f.title}),t.jsx(nn,{text:f.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:f.go,children:f.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx(nn,{text:(x==null?void 0:x.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(k=>Math.max(0,k-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(k=>k+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Gn(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Kn(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function wi(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,dispatch:s}=F(),p=r?a:e,g=h.useMemo(()=>p.filter(C=>Ve(C.date)===0&&C.kind==="target"),[p]),c=h.useMemo(()=>r?a.filter(C=>ke(C)===0).slice().sort((C,A)=>(A.date||"").localeCompare(C.date||"")):[],[a,r]),m=h.useMemo(()=>g.filter(C=>r?ke(C)===0:!Ee(C)),[g,r]),u=r?c:m,x=r?a.length-c.length:g.length-m.length,d=r?a.length:g.length,b=d?Math.min(100,x/d*100):100,v=h.useMemo(()=>Gn(p),[p]),f=!!v&&Ve(v)>0,y=h.useMemo(()=>f?p.filter(C=>(C.date||"").slice(0,10)===v):[],[p,v,f]);let k;f?k=i.morningLast(y.length,c.length,Kn(v,l)):r?k=i.morningThesis(g.length,c.length):g.length?x===0?k=i.goalSourced(g.length):x>=g.length?k=i.goalCleared:k=i.goalDone(x,g.length):k=i.goalSourced(0);const w=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&c.length&&s({type:"chainStart",queue:c.map(C=>C.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:k}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:b+"%"}})}),u.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:w,children:r?i.morningEval(u.length):o.pileMode?i.goalContinue(u.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ki(){var M,q;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:g,startTour:c}=F(),[m,u]=h.useState(null),[x,d]=h.useState([]),b=p==="client";h.useEffect(()=>{if(!i||!o)return;let L=!0;return(async()=>{const[U,j]=await Promise.all([Aa(o),Dn(i)]);L&&(U&&u(U),d(j))})(),()=>{L=!1}},[i,o]);const v=(m==null?void 0:m.per_day)??null,f=((M=m==null?void 0:m.pool_order)==null?void 0:M.length)??0,y=x.filter(L=>L.status==="running").length,k=h.useMemo(()=>s.filter(L=>L.kind==="target"&&Ee(L)).length,[s]),w=l.marketEstimate,C=typeof((q=l.stats)==null?void 0:q.screened)=="number"?l.stats.screened:k,A=w&&w>0?Math.min(100,Math.round(C/w*100)):null,R=L=>L.toLocaleString(a==="en"?"en-US":"fr-FR"),B=(o||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const L=Date.parse(l.generatedAt||"");if(Number.isNaN(L))return"";const U=new Date(L),j=S=>String(S).padStart(2,"0");return`${j(U.getDate())}/${j(U.getMonth()+1)} à ${j(U.getHours())}:${j(U.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:B}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),E&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(E)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&C>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(C)})})]}),A!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(C,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(f)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function ji(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const Ni=["--p0","--p1","--p2","--p3","--p4"];function Si(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,p=h.useRef({});h.useEffect(()=>{p.current={...r}},[r]);const g=u=>{const x=p.current[u],d=x!==void 0?r[u]-x:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ni[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(d>0?" up":d<0?" down":""),children:[r[u],d!==0&&t.jsxs("em",{className:"delta",children:[d>0?"+":"−",Math.abs(d)]})]})]},u)},c=(u,x,d)=>t.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:d.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,x,d,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:d,children:u},x);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Ci=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ei(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=h.useRef(null),[p,g]=h.useState(60);h.useEffect(()=>{let x=0;const d=()=>{var k;const b=s.current;if(!b)return;const v=(k=b.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!v)return;const f=v.getBoundingClientRect(),y=b.getBoundingClientRect();g(Math.max(20,Math.min(f.left+f.width/2-y.left,y.width-30)))};return x=requestAnimationFrame(d),window.addEventListener("resize",d),()=>{cancelAnimationFrame(x),window.removeEventListener("resize",d)}},[e.ptab]);const c=e.ptab;let m=r.tuto[c].p;if(c===3){const x=n.filter(v=>v.kind==="target"&&ke(v)===3),d=x.filter(v=>ia(v)==="auto").length,b=x.filter(v=>ia(v)==="cd").length;m=r.tutoPending(d,b,x.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(x=>x.id)})};if(c===1){const x=n.filter(d=>d.kind==="target"&&ke(d)===1&&!i.has(d.id)).slice(0,10);if(x.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:x.map(d=>d.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Ci[c],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Je{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Ai(e){for(const a of e)yield*a}function Qn(e){return Array.from(Ai(e))}var ne=1e-6,J=Math.PI,Te=J/2,rn=J/4,Re=J*2,$e=180/J,Ce=J/180,ie=Math.abs,zi=Math.atan,vt=Math.atan2,ce=Math.cos,de=Math.sin,Ti=Math.sign||function(e){return e>0?1:e<0?-1:0},tt=Math.sqrt;function Li(e){return e>1?0:e<-1?J:Math.acos(e)}function yt(e){return e>1?Te:e<-1?-Te:Math.asin(e)}function Le(){}function Ot(e,a){e&&sn.hasOwnProperty(e.type)&&sn[e.type](e,a)}var on={Feature:function(e,a){Ot(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Ot(r[n].geometry,a)}},sn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){da(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)da(r[n],a,0)},Polygon:function(e,a){ln(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ln(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Ot(r[n],a)}};function da(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function ln(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)da(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&on.hasOwnProperty(e.type)?on[e.type](e,a):Ot(e,a)}function pa(e){return[vt(e[1],e[0]),yt(e[2])]}function it(e){var a=e[0],r=e[1],n=ce(r);return[n*ce(a),n*de(a),de(r)]}function At(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ft(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function zt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ua(e){var a=tt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ma(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function fa(e,a){return ie(e)>J&&(e-=Math.round(e/Re)*Re),[e,a]}fa.invert=fa;function Ri(e,a,r){return(e%=Re)?a||r?ma(dn(e),pn(a,r)):dn(e):a||r?pn(a,r):fa}function cn(e){return function(a,r){return a+=e,ie(a)>J&&(a-=Math.round(a/Re)*Re),[a,r]}}function dn(e){var a=cn(e);return a.invert=cn(-e),a}function pn(e,a){var r=ce(e),n=de(e),i=ce(a),o=de(a);function l(s,p){var g=ce(p),c=ce(s)*g,m=de(s)*g,u=de(p),x=u*r+c*n;return[vt(m*i-x*o,c*r-u*n),yt(x*i+m*o)]}return l.invert=function(s,p){var g=ce(p),c=ce(s)*g,m=de(s)*g,u=de(p),x=u*i-m*o;return[vt(m*i+u*o,c*r+x*n),yt(x*r-c*n)]},l}function Mi(e,a,r,n,i,o){if(r){var l=ce(a),s=de(a),p=n*r;i==null?(i=a+n*Re,o=a-p/2):(i=un(l,i),o=un(l,o),(n>0?i<o:i>o)&&(i+=n*Re));for(var g,c=i;n>0?c>o:c<o;c-=p)g=pa([l,-s*ce(c),-s*de(c)]),e.point(g[0],g[1])}}function un(e,a){a=it(a),a[0]-=e,ua(a);var r=Li(-a[1]);return((-a[2]<0?-r:r)+Re-ne)%Re}function Jn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Le,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function qt(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Tt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Xn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(d){if(!((b=d.length-1)<=0)){var b,v=d[0],f=d[b],y;if(qt(v,f)){if(!v[2]&&!f[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=d[s])[0],v[1]);i.lineEnd();return}f[0]+=2*ne}o.push(y=new Tt(v,d,null,!0)),l.push(y.o=new Tt(v,null,y,!1)),o.push(y=new Tt(f,d,null,!1)),l.push(y.o=new Tt(f,null,y,!0))}}),!!o.length){for(l.sort(a),mn(o),mn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var g=o[0],c,m;;){for(var u=g,x=!0;u.v;)if((u=u.n)===g)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(x)for(s=0,p=c.length;s<p;++s)i.point((m=c[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(x)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((m=c[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,x=!x}while(!u.v);i.lineEnd()}}}function mn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function aa(e){return ie(e[0])<=J?e[0]:Ti(e[0])*((ie(e[0])+J)%Re-J)}function qi(e,a){var r=aa(a),n=a[1],i=de(n),o=[de(r),-ce(r),0],l=0,s=0,p=new Je;i===1?n=Te+ne:i===-1&&(n=-Te-ne);for(var g=0,c=e.length;g<c;++g)if(u=(m=e[g]).length)for(var m,u,x=m[u-1],d=aa(x),b=x[1]/2+rn,v=de(b),f=ce(b),y=0;y<u;++y,d=w,v=A,f=R,x=k){var k=m[y],w=aa(k),C=k[1]/2+rn,A=de(C),R=ce(C),B=w-d,E=B>=0?1:-1,M=E*B,q=M>J,L=v*A;if(p.add(vt(L*E*de(M),f*R+L*ce(M))),l+=q?B+E*Re:B,q^d>=r^w>=r){var U=Ft(it(x),it(k));ua(U);var j=Ft(o,U);ua(j);var S=(q^B>=0?-1:1)*yt(j[2]);(n>S||n===S&&(U[0]||U[1]))&&(s+=q^B>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function Zn(e,a,r,n){return function(i){var o=a(i),l=Jn(),s=a(l),p=!1,g,c,m,u={point:x,lineStart:b,lineEnd:v,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=k,c=[],g=[]},polygonEnd:function(){u.point=x,u.lineStart=b,u.lineEnd=v,c=Qn(c);var w=qi(g,n);c.length?(p||(i.polygonStart(),p=!0),Xn(c,Fi,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),c=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function x(w,C){e(w,C)&&i.point(w,C)}function d(w,C){o.point(w,C)}function b(){u.point=d,o.lineStart()}function v(){u.point=x,o.lineEnd()}function f(w,C){m.push([w,C]),s.point(w,C)}function y(){s.lineStart(),m=[]}function k(){f(m[0][0],m[0][1]),s.lineEnd();var w=s.clean(),C=l.result(),A,R=C.length,B,E,M;if(m.pop(),g.push(m),m=null,!!R){if(w&1){if(E=C[0],(B=E.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),A=0;A<B;++A)i.point((M=E[A])[0],M[1]);i.lineEnd()}return}R>1&&w&2&&C.push(C.pop().concat(C.shift())),c.push(C.filter(Oi))}}return u}}function Oi(e){return e.length>1}function Fi(e,a){return((e=e.x)[0]<0?e[1]-Te-ne:Te-e[1])-((a=a.x)[0]<0?a[1]-Te-ne:Te-a[1])}const fn=Zn(function(){return!0},Pi,Ii,[-J,-Te]);function Pi(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?J:-J,p=ie(o-a);ie(p-J)<ne?(e.point(a,r=(r+l)/2>0?Te:-Te),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=J&&(ie(a-n)<ne&&(a-=n*ne),ie(o-s)<ne&&(o-=s*ne),r=Di(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Di(e,a,r,n){var i,o,l=de(e-r);return ie(l)>ne?zi((de(a)*(o=ce(n))*de(r)-de(n)*(i=ce(a))*de(e))/(i*o*l)):(a+n)/2}function Ii(e,a,r,n){var i;if(e==null)i=r*Te,n.point(-J,i),n.point(0,i),n.point(J,i),n.point(J,0),n.point(J,-i),n.point(0,-i),n.point(-J,-i),n.point(-J,0),n.point(-J,i);else if(ie(e[0]-a[0])>ne){var o=e[0]<a[0]?J:-J;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function $i(e){var a=ce(e),r=2*Ce,n=a>0,i=ie(a)>ne;function o(c,m,u,x){Mi(x,e,r,u,c,m)}function l(c,m){return ce(c)*ce(m)>a}function s(c){var m,u,x,d,b;return{lineStart:function(){d=x=!1,b=1},point:function(v,f){var y=[v,f],k,w=l(v,f),C=n?w?0:g(v,f):w?g(v+(v<0?J:-J),f):0;if(!m&&(d=x=w)&&c.lineStart(),w!==x&&(k=p(m,y),(!k||qt(m,k)||qt(y,k))&&(y[2]=1)),w!==x)b=0,w?(c.lineStart(),k=p(y,m),c.point(k[0],k[1])):(k=p(m,y),c.point(k[0],k[1],2),c.lineEnd()),m=k;else if(i&&m&&n^w){var A;!(C&u)&&(A=p(y,m,!0))&&(b=0,n?(c.lineStart(),c.point(A[0][0],A[0][1]),c.point(A[1][0],A[1][1]),c.lineEnd()):(c.point(A[1][0],A[1][1]),c.lineEnd(),c.lineStart(),c.point(A[0][0],A[0][1],3)))}w&&(!m||!qt(m,y))&&c.point(y[0],y[1]),m=y,x=w,u=C},lineEnd:function(){x&&c.lineEnd(),m=null},clean:function(){return b|(d&&x)<<1}}}function p(c,m,u){var x=it(c),d=it(m),b=[1,0,0],v=Ft(x,d),f=At(v,v),y=v[0],k=f-y*y;if(!k)return!u&&c;var w=a*f/k,C=-a*y/k,A=Ft(b,v),R=zt(b,w),B=zt(v,C);ta(R,B);var E=A,M=At(R,E),q=At(E,E),L=M*M-q*(At(R,R)-1);if(!(L<0)){var U=tt(L),j=zt(E,(-M-U)/q);if(ta(j,R),j=pa(j),!u)return j;var S=c[0],T=m[0],H=c[1],G=m[1],Z;T<S&&(Z=S,S=T,T=Z);var z=T-S,O=ie(z-J)<ne,$=O||z<ne;if(!O&&G<H&&(Z=H,H=G,G=Z),$?O?H+G>0^j[1]<(ie(j[0]-S)<ne?H:G):H<=j[1]&&j[1]<=G:z>J^(S<=j[0]&&j[0]<=T)){var P=zt(E,(-M+U)/q);return ta(P,R),[j,pa(P)]}}}function g(c,m){var u=n?e:J-e,x=0;return c<-u?x|=1:c>u&&(x|=2),m<-u?x|=4:m>u&&(x|=8),x}return Zn(l,s,o,n?[0,-e]:[-J,e-J])}function Bi(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],g=a[1],c=0,m=1,u=p-l,x=g-s,d;if(d=r-l,!(!u&&d>0)){if(d/=u,u<0){if(d<c)return;d<m&&(m=d)}else if(u>0){if(d>m)return;d>c&&(c=d)}if(d=i-l,!(!u&&d<0)){if(d/=u,u<0){if(d>m)return;d>c&&(c=d)}else if(u>0){if(d<c)return;d<m&&(m=d)}if(d=n-s,!(!x&&d>0)){if(d/=x,x<0){if(d<c)return;d<m&&(m=d)}else if(x>0){if(d>m)return;d>c&&(c=d)}if(d=o-s,!(!x&&d<0)){if(d/=x,x<0){if(d>m)return;d>c&&(c=d)}else if(x>0){if(d<c)return;d<m&&(m=d)}return c>0&&(e[0]=l+c*u,e[1]=s+c*x),m<1&&(a[0]=l+m*u,a[1]=s+m*x),!0}}}}}var mt=1e9,Lt=-mt;function Ui(e,a,r,n){function i(g,c){return e<=g&&g<=r&&a<=c&&c<=n}function o(g,c,m,u){var x=0,d=0;if(g==null||(x=l(g,m))!==(d=l(c,m))||p(g,c)<0^m>0)do u.point(x===0||x===3?e:r,x>1?n:a);while((x=(x+m+4)%4)!==d);else u.point(c[0],c[1])}function l(g,c){return ie(g[0]-e)<ne?c>0?0:3:ie(g[0]-r)<ne?c>0?2:1:ie(g[1]-a)<ne?c>0?1:0:c>0?3:2}function s(g,c){return p(g.x,c.x)}function p(g,c){var m=l(g,1),u=l(c,1);return m!==u?m-u:m===0?c[1]-g[1]:m===1?g[0]-c[0]:m===2?g[1]-c[1]:c[0]-g[0]}return function(g){var c=g,m=Jn(),u,x,d,b,v,f,y,k,w,C,A,R={point:B,lineStart:L,lineEnd:U,polygonStart:M,polygonEnd:q};function B(S,T){i(S,T)&&c.point(S,T)}function E(){for(var S=0,T=0,H=x.length;T<H;++T)for(var G=x[T],Z=1,z=G.length,O=G[0],$,P,D=O[0],_=O[1];Z<z;++Z)$=D,P=_,O=G[Z],D=O[0],_=O[1],P<=n?_>n&&(D-$)*(n-P)>(_-P)*(e-$)&&++S:_<=n&&(D-$)*(n-P)<(_-P)*(e-$)&&--S;return S}function M(){c=m,u=[],x=[],A=!0}function q(){var S=E(),T=A&&S,H=(u=Qn(u)).length;(T||H)&&(g.polygonStart(),T&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),H&&Xn(u,s,S,o,g),g.polygonEnd()),c=g,u=x=d=null}function L(){R.point=j,x&&x.push(d=[]),C=!0,w=!1,y=k=NaN}function U(){u&&(j(b,v),f&&w&&m.rejoin(),u.push(m.result())),R.point=B,w&&c.lineEnd()}function j(S,T){var H=i(S,T);if(x&&d.push([S,T]),C)b=S,v=T,f=H,C=!1,H&&(c.lineStart(),c.point(S,T));else if(H&&w)c.point(S,T);else{var G=[y=Math.max(Lt,Math.min(mt,y)),k=Math.max(Lt,Math.min(mt,k))],Z=[S=Math.max(Lt,Math.min(mt,S)),T=Math.max(Lt,Math.min(mt,T))];Bi(G,Z,e,a,r,n)?(w||(c.lineStart(),c.point(G[0],G[1])),c.point(Z[0],Z[1]),H||c.lineEnd(),A=!1):H&&(c.lineStart(),c.point(S,T),A=!1)}y=S,k=T,w=H}return R}}const xa=e=>e;var na=new Je,ha=new Je,er,tr,ga,ba,Be={point:Le,lineStart:Le,lineEnd:Le,polygonStart:function(){Be.lineStart=_i,Be.lineEnd=Hi},polygonEnd:function(){Be.lineStart=Be.lineEnd=Be.point=Le,na.add(ie(ha)),ha=new Je},result:function(){var e=na/2;return na=new Je,e}};function _i(){Be.point=Vi}function Vi(e,a){Be.point=ar,er=ga=e,tr=ba=a}function ar(e,a){ha.add(ba*e-ga*a),ga=e,ba=a}function Hi(){ar(er,tr)}var st=1/0,Pt=st,wt=-st,Dt=wt,It={point:Yi,lineStart:Le,lineEnd:Le,polygonStart:Le,polygonEnd:Le,result:function(){var e=[[st,Pt],[wt,Dt]];return wt=Dt=-(Pt=st=1/0),e}};function Yi(e,a){e<st&&(st=e),e>wt&&(wt=e),a<Pt&&(Pt=a),a>Dt&&(Dt=a)}var va=0,ya=0,ft=0,$t=0,Bt=0,rt=0,wa=0,ka=0,xt=0,nr,rr,Pe,De,ze={point:Xe,lineStart:xn,lineEnd:hn,polygonStart:function(){ze.lineStart=Ki,ze.lineEnd=Qi},polygonEnd:function(){ze.point=Xe,ze.lineStart=xn,ze.lineEnd=hn},result:function(){var e=xt?[wa/xt,ka/xt]:rt?[$t/rt,Bt/rt]:ft?[va/ft,ya/ft]:[NaN,NaN];return va=ya=ft=$t=Bt=rt=wa=ka=xt=0,e}};function Xe(e,a){va+=e,ya+=a,++ft}function xn(){ze.point=Wi}function Wi(e,a){ze.point=Gi,Xe(Pe=e,De=a)}function Gi(e,a){var r=e-Pe,n=a-De,i=tt(r*r+n*n);$t+=i*(Pe+e)/2,Bt+=i*(De+a)/2,rt+=i,Xe(Pe=e,De=a)}function hn(){ze.point=Xe}function Ki(){ze.point=Ji}function Qi(){or(nr,rr)}function Ji(e,a){ze.point=or,Xe(nr=Pe=e,rr=De=a)}function or(e,a){var r=e-Pe,n=a-De,i=tt(r*r+n*n);$t+=i*(Pe+e)/2,Bt+=i*(De+a)/2,rt+=i,i=De*e-Pe*a,wa+=i*(Pe+e),ka+=i*(De+a),xt+=i*3,Xe(Pe=e,De=a)}function ir(e){this._context=e}ir.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Re);break}}},result:Le};var ja=new Je,ra,sr,lr,ht,gt,kt={point:Le,lineStart:function(){kt.point=Xi},lineEnd:function(){ra&&cr(sr,lr),kt.point=Le},polygonStart:function(){ra=!0},polygonEnd:function(){ra=null},result:function(){var e=+ja;return ja=new Je,e}};function Xi(e,a){kt.point=cr,sr=ht=e,lr=gt=a}function cr(e,a){ht-=e,gt-=a,ja.add(tt(ht*ht+gt*gt)),ht=e,gt=a}let gn,Ut,bn,vn;class yn{constructor(a){this._append=a==null?dr:Zi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==bn||this._append!==Ut){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,bn=n,Ut=this._append,vn=this._,this._=i}this._+=vn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function dr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Zi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return dr;if(a!==gn){const r=10**a;gn=a,Ut=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Ut}function es(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),nt(s,i(o))),o.result()}return l.area=function(s){return nt(s,i(Be)),Be.result()},l.measure=function(s){return nt(s,i(kt)),kt.result()},l.bounds=function(s){return nt(s,i(It)),It.result()},l.centroid=function(s){return nt(s,i(ze)),ze.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new yn(r)):new ir(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new yn(r)),l},l.projection(e).digits(r).context(a)}function Ra(e){return function(a){var r=new Na;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Na(){}Na.prototype={constructor:Na,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ma(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream(It)),a(It.result()),n!=null&&e.clipExtent(n),e}function pr(e,a,r){return Ma(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function ts(e,a,r){return pr(e,[[0,0],a],r)}function as(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function ns(e,a,r){return Ma(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var wn=16,rs=ce(30*Ce);function kn(e,a){return+a?is(e,a):os(e)}function os(e){return Ra({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function is(e,a){function r(n,i,o,l,s,p,g,c,m,u,x,d,b,v){var f=g-n,y=c-i,k=f*f+y*y;if(k>4*a&&b--){var w=l+u,C=s+x,A=p+d,R=tt(w*w+C*C+A*A),B=yt(A/=R),E=ie(ie(A)-1)<ne||ie(o-m)<ne?(o+m)/2:vt(C,w),M=e(E,B),q=M[0],L=M[1],U=q-n,j=L-i,S=y*U-f*j;(S*S/k>a||ie((f*U+y*j)/k-.5)>.3||l*u+s*x+p*d<rs)&&(r(n,i,o,l,s,p,q,L,E,w/=R,C/=R,A,b,v),v.point(q,L),r(q,L,E,w,C,A,g,c,m,u,x,d,b,v))}}return function(n){var i,o,l,s,p,g,c,m,u,x,d,b,v={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=C},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function f(B,E){B=e(B,E),n.point(B[0],B[1])}function y(){m=NaN,v.point=k,n.lineStart()}function k(B,E){var M=it([B,E]),q=e(B,E);r(m,u,c,x,d,b,m=q[0],u=q[1],c=B,x=M[0],d=M[1],b=M[2],wn,n),n.point(m,u)}function w(){v.point=f,n.lineEnd()}function C(){y(),v.point=A,v.lineEnd=R}function A(B,E){k(i=B,E),o=m,l=u,s=x,p=d,g=b,v.point=k}function R(){r(m,u,c,x,d,b,o,l,i,s,p,g,wn,n),v.lineEnd=w,w()}return v}}var ss=Ra({point:function(e,a){this.stream.point(e*Ce,a*Ce)}});function ls(e){return Ra({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function cs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function jn(e,a,r,n,i,o){if(!o)return cs(e,a,r,n,i);var l=ce(o),s=de(o),p=l*e,g=s*e,c=l/e,m=s/e,u=(s*r-l*a)/e,x=(s*a+l*r)/e;function d(b,v){return b*=n,v*=i,[p*b-g*v+a,r-g*b-p*v]}return d.invert=function(b,v){return[n*(c*b-m*v+u),i*(x-m*b-c*v)]},d}function ds(e){return ps(function(){return e})()}function ps(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,g=0,c,m=0,u=1,x=1,d=null,b=fn,v=null,f,y,k,w=xa,C=.5,A,R,B,E,M;function q(S){return B(S[0]*Ce,S[1]*Ce)}function L(S){return S=B.invert(S[0],S[1]),S&&[S[0]*$e,S[1]*$e]}q.stream=function(S){return E&&M===S?E:E=ss(ls(c)(b(A(w(M=S)))))},q.preclip=function(S){return arguments.length?(b=S,d=void 0,j()):b},q.postclip=function(S){return arguments.length?(w=S,v=f=y=k=null,j()):w},q.clipAngle=function(S){return arguments.length?(b=+S?$i(d=S*Ce):(d=null,fn),j()):d*$e},q.clipExtent=function(S){return arguments.length?(w=S==null?(v=f=y=k=null,xa):Ui(v=+S[0][0],f=+S[0][1],y=+S[1][0],k=+S[1][1]),j()):v==null?null:[[v,f],[y,k]]},q.scale=function(S){return arguments.length?(r=+S,U()):r},q.translate=function(S){return arguments.length?(n=+S[0],i=+S[1],U()):[n,i]},q.center=function(S){return arguments.length?(o=S[0]%360*Ce,l=S[1]%360*Ce,U()):[o*$e,l*$e]},q.rotate=function(S){return arguments.length?(s=S[0]%360*Ce,p=S[1]%360*Ce,g=S.length>2?S[2]%360*Ce:0,U()):[s*$e,p*$e,g*$e]},q.angle=function(S){return arguments.length?(m=S%360*Ce,U()):m*$e},q.reflectX=function(S){return arguments.length?(u=S?-1:1,U()):u<0},q.reflectY=function(S){return arguments.length?(x=S?-1:1,U()):x<0},q.precision=function(S){return arguments.length?(A=kn(R,C=S*S),j()):tt(C)},q.fitExtent=function(S,T){return pr(q,S,T)},q.fitSize=function(S,T){return ts(q,S,T)},q.fitWidth=function(S,T){return as(q,S,T)},q.fitHeight=function(S,T){return ns(q,S,T)};function U(){var S=jn(r,0,0,u,x,m).apply(null,a(o,l)),T=jn(r,n-S[0],i-S[1],u,x,m);return c=Ri(s,p,g),R=ma(a,T),B=ma(c,R),A=kn(R,C),j()}function j(){return E=M=null,q}return function(){return a=e.apply(this,arguments),q.invert=a.invert&&L,U()}}function ur(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}ur.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ie(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function us(){return ds(ur).scale(175.295)}function ms(e){return e}function fs(e){if(e==null)return ms;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var g=2,c=s.length,m=new Array(c);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;g<c;)m[g]=s[g],++g;return m}}function xs(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function hs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Nn(e,r)})}:Nn(e,a)}function Nn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=gs(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function gs(e,a){var r=fs(e.transform),n=e.arcs;function i(c,m){m.length&&m.pop();for(var u=n[c<0?~c:c],x=0,d=u.length;x<d;++x)m.push(r(u[x],x));c<0&&xs(m,d)}function o(c){return r(c)}function l(c){for(var m=[],u=0,x=c.length;u<x;++u)i(c[u],m);return m.length<2&&m.push(m[0]),m}function s(c){for(var m=l(c);m.length<4;)m.push(m[0]);return m}function p(c){return c.map(s)}function g(c){var m=c.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:c.geometries.map(g)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=p(c.arcs);break;case"MultiPolygon":u=c.arcs.map(p);break;default:return null}return{type:m,coordinates:u}}return g(a)}const mr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},bs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function vs(e,a,r){const n=mr[e];if(!n||!n.length)return-1;const i=bs(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Rt=null;function ys(){return Rt||(Rt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=hs(r,n),o=us().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=es(o),s=(i.features||[]).filter(c=>{var m;return(((m=c.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(c=>{var x;const m=((x=c.properties)==null?void 0:x.name)||"",u=l(c)||"";return u?{i2:Qr(m)||null,n:m,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const p={};for(const[c,m]of Object.entries(Jr)){const u=o(m);u&&(p[c]={x:u[0],y:u[1]})}const g={};for(const[c,m]of Object.entries(mr)){const u=m.map(x=>o(x.ll)).filter(x=>!!x).map(([x,d])=>({x,y:d}));u.length&&(g[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:g}}catch{return null}})(),Rt)}function ws(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return ys().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const ks={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Sn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Cn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function js(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Ns(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:g,dossiers:c}=F(),m=g.loading&&!c.length,u=h.useRef(null),x=h.useRef(null),d=ws(e.continent==="monde"),b=e.continent==="monde"?d:za.find(j=>j.key===e.continent)||null,v=js(u,e.continent+":"+e.mapFolded+":"+!!b),[f,y]=h.useState(new Map),[k,w]=h.useState(null);h.useEffect(()=>{const j=u.current;if(!j)return;const S=new Map;j.querySelectorAll("path[data-i2]").forEach(T=>{const H=T.dataset.i2;if(H)try{const G=T.getBBox();G.width>0&&S.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(S)},[e.continent,v,b]);const C=h.useMemo(()=>r.filter(j=>j.cc),[r]),A=h.useMemo(()=>{const j=new Map;return C.forEach(S=>j.set(S.cc,(j.get(S.cc)||0)+1)),j},[C]),R=e.continent==="monde"&&d?d.anchors:null,B=e.continent==="monde"&&d?d.metros:null,E=h.useMemo(()=>C.map(j=>{const S=Cn(j.name||j.id||""),T=Cn((j.id||j.name||"")+"·y");if(R&&j.cc){const O=B?B[j.cc]:void 0;if(O&&O.length){const P=vs(j.cc,j.city,S);if(P>=0&&O[P])return{d:j,x:O[P].x+(S-.5)*5,y:O[P].y+(T-.5)*5}}const $=R[j.cc];if($)return{d:j,x:$.x+(S-.5)*10,y:$.y+(T-.5)*10}}const H=j.cc?f.get(j.cc):void 0;if(!H)return null;const G=ks[`${e.continent}:${j.cc||""}`];if(G)return{d:j,x:H.x+H.w*(G.fx+(S-.5)*G.sx),y:H.y+H.h*(G.fy+(T-.5)*G.sy)};const Z=(S-.5)*Math.min(H.w*.55,60),z=(T-.5)*Math.min(H.h*.55,60);return{d:j,x:H.x+H.w/2+Z,y:H.y+H.h/2+z}}).filter(j=>!!j),[C,f,R,B,e.continent]),M=j=>v>0?j/v:j,q=h.useMemo(()=>n?[0,1,2,3,4,5].map(j=>({c:Sn[j],fr:p.plabels[j].toUpperCase(),en:p.plabels[j].toUpperCase(),n:r.filter(S=>S.kind==="target"&&ke(S)===j).length})).filter(j=>j.n>0):_a.map((j,S)=>({...j,n:r.filter(T=>Va(T)===S).length})),[r,n,p.plabels]),L=o?l.get(o):null,U=L?E.find(j=>j.d.id===L.id):null;return b?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:x,children:[t.jsxs("svg",{ref:u,viewBox:b.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?b.fr:b.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:b.countries.map((j,S)=>t.jsx("g",{className:"ct"+(j.i2&&A.get(j.i2)?"":" empty"),children:t.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},S))}),t.jsx("g",{children:E.map(j=>{const S=_a[Va(j.d)],T=!!he(j.d),H=j.d.kind==="target",G=n&&H?Sn[ke(j.d)]:S.c,Z=!n&&Ee(j.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var $,P;const z=($=x.current)==null?void 0:$.getBoundingClientRect(),O=(P=u.current)==null?void 0:P.createSVGPoint();if(O&&u.current&&z){O.x=j.x,O.y=j.y;const D=O.matrixTransform(u.current.getScreenCTM());w({x:D.x-z.left,y:D.y-z.top,label:j.d.name+" · "+(ct(j.d.cc,s)||j.d.countryLabel||"")})}i(j.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var $;const z=($=u.current)==null?void 0:$.createSVGPoint();let O=null;if(z&&u.current){z.x=j.x,z.y=j.y;const P=z.matrixTransform(u.current.getScreenCTM());O={x:P.x,y:P.y}}a({type:"popup",id:j.d.id,anchor:O})},children:[t.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:M(Math.max(11,S.px+7))}),t.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:M(S.px),fill:G,stroke:T?"#DC2626":"#ffffff",strokeWidth:M(T?2.2:1.3)})]},j.d.id||j.d.name)})}),U&&t.jsx("circle",{className:"ring on",cx:U.x,cy:U.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:q.map((j,S)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":j.c}}),s==="fr"?j.fr:j.en," ",t.jsx("b",{children:j.n})]},S))}),r.some(j=>!j.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(j=>!j.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:x})}function Ss(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Cs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(d=>d.continent===e.continent),[r,e.continent]),g=d=>p.filter(b=>d!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Ta(b,s,i,d==="country"?void 0:d)),c=h.useMemo(()=>{const d=g("win"),b=v=>d.filter(f=>(f.date?Math.max(0,Math.floor((Date.now()-Date.parse(f.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),d.length]},[p,s,i]),m=h.useMemo(()=>s.day?g("win").filter(d=>(d.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),x=(d,b,v,f="fbtn")=>t.jsxs("button",{type:"button",className:f,"aria-expanded":e.openFacet===d,onClick:()=>a({type:"openFacet",facet:d}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},d);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Ss(s.day,l)),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((d,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===d,onClick:()=>a({type:"filters",patch:{win:d}}),children:[n.dates[b],t.jsx("b",{children:c[b]})]},d))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:d=>a({type:"filters",patch:{search:d.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):x("sec",n.fSector,s.sector.length),x("pay",n.fCountry,s.country.length),x("det",n.fEngine,s.engine.length),x("sta",n.fStage,s.stage.length),i&&x("ang","Angle",s.angle.length),i&&x("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Es,{poolFor:g})]})}function Es({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:g}=h.useMemo(()=>{if(l==="sig"){const d=e("signal").filter(f=>he(f)),b=new Map;d.forEach(f=>{const y=f.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:d.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...sa([...b.keys()],i).map(f=>({v:f,label:Qe(f)+" "+Ie(f,i),n:b.get(f)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const d=e("sector"),b=new Map;return d.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v,n:f,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const d=e("country"),b=new Map;return d.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:ct(v,i)||v,n:f,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const d=e("engine"),b=new Map;return d.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:sa([...b.keys()],i).map(v=>({v,label:Qe(v)+" "+Ie(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Xr(Zr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const d=e("angle"),b=new Map;return d.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v.replace(/[_-]+/g," "),n:f,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const d=e("memoLevel"),b=new Map;d.forEach(f=>{if(f.kind==="target"){const y=Ea(f);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:v[f],n:b.get(f)||0,html:!1,on:o.memoLevel.includes(f)}))}}const u=e("stage"),x=new Map;return u.forEach(d=>{d.stage&&x.set(d.stage,(x.get(d.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...x.entries()].sort((d,b)=>b[1]-d[1]).map(([d,b])=>({v:d,label:d,n:b,html:!1,on:o.stage.includes(d)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const d=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:d}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function fr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function As(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function En({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function xr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(En,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(En,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function zs({card:e,onEvaluate:a,onAddAll:r}){var s,p,g;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:fr(e.summary_md||"").map((c,m)=>t.jsx("p",{children:c},m))})]}),t.jsx(xr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function Ts(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Ls({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[p,g]=h.useState(null),[c,m]=h.useState(null),[u,x]=h.useState(null),[d,b]=h.useState(!1);h.useEffect(()=>{let f=!0;return(async()=>{const y=await In({email:l,cbToken:s});f&&g(y)})(),()=>{f=!1}},[l,s,n]);const v=f=>{m(f),x(null),b(!0),(async()=>{const y=await eo(f.id);x(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),x(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Ts(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?o.rsPub:o.rsPriv})]},f.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),d&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!d&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!d&&u&&t.jsx(zs,{card:u,onEvaluate:a,onAddAll:r})]})]})}const An=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Rs(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:g,data:c,canWrite:m,source:u}=F(),x=a==="client",d=h.useMemo(()=>r||(u!=="default"?to():""),[r,u]),[b,v]=h.useState(""),[f,y]=h.useState(!1),[k,w]=h.useState(""),[C,A]=h.useState(!1),[R,B]=h.useState(""),[E,M]=h.useState([]),q=h.useRef(!1),[L,U]=h.useState(!1),[j,S]=h.useState(""),[T,H]=h.useState(""),[G,Z]=h.useState(!1),[z,O]=h.useState(0),[$,P]=h.useState(""),[D,_]=h.useState(null),[W,X]=h.useState(null),[re,xe]=h.useState(!1),[pe,K]=h.useState(null),[te,be]=h.useState(0),ee=h.useRef(!1),se=b.trim()?An.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,Q=h.useMemo(()=>k.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[k]);h.useEffect(()=>{if(typeof window>"u")return;const I=(new URLSearchParams(window.location.search).get("rs")||"").trim();!I||!/^https?:\/\//i.test(I)||(S(I),U(!0))},[]),h.useEffect(()=>{const I=ae=>{var ye;const oe=String(((ye=ae.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(S(oe),U(!0))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),h.useEffect(()=>{if(!m&&!d){K(null);return}let I=!0;return(async()=>{const ae=await In({email:n,cbToken:d});I&&K(ae.length)})(),()=>{I=!1}},[m,d,n,te]);const Ue=E.length?E:p,fe=c.credits,ve=h.useCallback(I=>{const ae=I.map(oe=>(oe||"").trim()).filter(Boolean);ae.length&&(w(oe=>{const ye=oe.split(`
`).map(le=>le.trim()).filter(Boolean),_e=new Set(ye.map(le=>le.toLowerCase())),Ne=ae.filter(le=>!_e.has(le.toLowerCase()));return[...ye,...Ne].slice(0,15).join(`
`)}),y(!0))},[]);h.useEffect(()=>{if(!G)return;O(0);const I=window.setInterval(()=>O(ae=>ae+1),1e3);return()=>window.clearInterval(I)},[G]);const at=()=>{const I=b.trim();I&&(i(null,I),v(""))},He=async()=>{if(!x){i(null,Q[0]||"");return}if(!Q.length||C)return;A(!0),q.current=!1;const I=[];for(let ae=0;ae<Q.length&&!q.current;ae++){B(e.evaluating(ae+1,Q.length,Q[ae]));const oe=await $n(r,Q[ae],"atelier2");if(I.unshift({name:oe.company||Q[ae],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),M([...I]),oe.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(Q.length-ae-1),remaining:0}),M([...I]),w(Q.slice(ae+1).join(`
`)),B(""),A(!1);return}}B(""),w(q.current?Q.slice(I.length).join(`
`):""),A(!1)},je=async()=>{var oe,ye,_e;if(ee.current)return;const I=j.trim().replace(/\s+/g,""),ae=T.trim();if(!I&&!ae){P(e.rsNeed);return}if(!x&&!d){i(null,I||ae.slice(0,80));return}ee.current=!0,P(""),_(null),X(null),Z(!0);try{const Ne=await no({url:I,text:ae,email:n,cbToken:d});if(Z(!1),!Ne||Ne.status!=="success"){P((Ne==null?void 0:Ne.message)||"Erreur");return}_(Ne),U(!1),ve((((oe=Ne.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),X({state:"pending"});const le=await ro(Ne,{email:n,cbToken:d});X(le.ok?{state:"ok",scopeLabel:((ye=le.summary)==null?void 0:ye.scope_label)||"",scope:((_e=le.summary)==null?void 0:_e.scope)||""}:{state:"fail",msg:le.error||""}),le.ok&&be(Ae=>Ae+1)}finally{ee.current=!1,Z(!1)}},qe=[D==null?void 0:D.industry,...(D==null?void 0:D.market_tags)||[],D==null?void 0:D.author].map(I=>(I||"").trim()).filter(Boolean),Ye=(W==null?void 0:W.state)==="pending",Yt=W&&(Ye?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):W.state==="ok"?t.jsx("span",{className:"rslink ok",children:W.scope&&W.scope!=="public"?e.rsSavedIn(W.scopeLabel||W.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:W.msg,children:e.rsSaveFail})),Wt=As(D).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:I=>v(I.target.value),onKeyDown:I=>{I.key==="Enter"&&at()}}),t.jsx("span",{className:"detect"+(An.test(b.trim())?" url":""),children:se})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:at,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),g.showCredits&&fe&&t.jsxs("button",{type:"button",className:"credits"+(fe.total_available<=0&&!fe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:fe.unlimited?"∞":fe.total_available}),!fe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",fe.daily_grant+fe.purchased]}),fe.total_available<=0&&!fe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(L?" on":""),onClick:()=>U(!L),children:e.rsOpen}),pe!==null&&pe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>xe(!re),children:e.rsArchOpen(pe)})]}),re&&t.jsx(Ls,{bump:te,cbToken:d,onClose:()=>xe(!1),onEvaluate:I=>i(null,I),onAddAll:ve}),L&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:j,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:I=>S(I.target.value),onKeyDown:I=>{I.key==="Enter"&&je()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:T,placeholder:e.rsTextPh,onChange:I=>H(I.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||Ye||!j.trim()&&!T.trim(),onClick:()=>{je()},children:[t.jsx("span",{className:"fill"}),G?`${ao(j.trim())==="youtube"&&j.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(z)}`:Ye?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),$&&t.jsx("div",{className:"rserr",children:$}),D&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:D.title}),D.source_url&&t.jsx("a",{href:D.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{_(null),X(null)},children:"×"})]}),D.market&&t.jsx("p",{className:"rsmk",children:D.market}),qe.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),qe.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[D.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${D.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:fr(D.summary_md||"").map((I,ae)=>t.jsx("p",{children:I},ae))})]}),t.jsx(xr,{card:D,onEvaluate:I=>i(null,I),onAddAll:ve}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Wt)}),Yt]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:k,placeholder:e.bulkPh,onChange:I=>w(I.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(C?" loading":""),style:{justifyContent:"center"},disabled:C||!Q.length,onClick:()=>{He()},children:[t.jsx("span",{className:"fill"}),C&&R?R:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(Q.length)})]})]}),Ue.slice(0,1).map((I,ae)=>{const oe=I.verdict==="kept",ye=I.verdict==="quota",_e=oe?"var(--brand)":ye?"var(--bolt)":"var(--red)",Ne=oe?"var(--brand-l)":ye?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":_e,"--bgc":Ne},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:ye?"⏳":"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(le=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:le.url.startsWith("http")?le.url:`https://${le.url}`,target:"_blank",rel:"nofollow noopener",children:[(le.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,le.url),children:e.evalPickGo})]},le.url))}),!ye&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const le=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ae=[...document.querySelectorAll(".atl2 .list .row")].find(Gt=>{var dt;return(((dt=Gt.querySelector(".rnm"))==null?void 0:dt.textContent)||"").trim().toLowerCase().includes(le)});Ae&&(Ae.scrollIntoView({behavior:"smooth",block:"center"}),Ae.classList.add("flashrow"),window.setTimeout(()=>Ae.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),x&&(o.kept+o.dropped>0||Ue.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ms(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function qs(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=F(),o=e.memoConsole?r.get(e.memoConsole):null,l=h.useMemo(()=>o?[o.reasoning||"",Ms(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=et(o),p=Ea(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[ot(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const oa={},zn=(oa==null?void 0:oa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Tn(){return new Date().toISOString().slice(0,10)}const qa=h.createContext(null);function Os(){return h.useContext(qa)}function Fs(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(i=>/en bref/i.test(i.textContent||"")&&i.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(i=>(i.textContent||"").replace(/\s+/g," ").trim()).filter(i=>i.length>3).slice(0,4)}catch{return[]}}function Ps(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),s.querySelectorAll("*").forEach(p=>{const g=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(c=>p.removeAttribute(c.name)),g&&/^https?:\/\//i.test(g)&&(p.setAttribute("href",g),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Ds(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Is(){const{ed:e,isEn:a,day:r,loading:n}=hr(),i=h.useMemo(()=>Fs((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const o=Ds(r,a);return i.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+o}),t.jsx("ul",{children:i.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${o}.`:`Édition du ${o}.`})]})}function hr(){const e=h.useContext(qa);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function $s({token:e,children:a}){const{dispatch:r,st:n,lang:i}=F(),[o,l]=h.useState(()=>n.filters.day||Tn()),[s,p]=h.useState(null),[g,c]=h.useState(!1),m=h.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=h.useCallback(()=>{l(Tn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);h.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),h.useEffect(()=>{const b=v=>{var y;const f=(y=v.detail)==null?void 0:y.day;typeof f=="string"&&m(f)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[m]),h.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),h.useEffect(()=>{if(!e||!o)return;let b=!1;c(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${zn}/cibles/edition.json?${v}`).then(f=>f.json()).then(f=>{b||p(f)}).catch(()=>{b||p({ok:!1,error:"network"})}).finally(()=>{b||c(!1)}),()=>{b=!0}},[e,o]);const x=h.useMemo(()=>`${zn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),d=h.useMemo(()=>({token:e,day:o,ed:s,loading:g,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:x,isEn:i==="en"}),[e,o,s,g,m,u,n.filters.day,x,i]);return t.jsx(qa.Provider,{value:d,children:a})}function Bs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=hr();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(oo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function gr({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=F(),[l,s]=h.useState(!1),[p,g]=h.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const c=async()=>{if(l)return;s(!0);const m=await io(r,e);if(s(!1),!m){o(a.actErr);return}g(m.results||[])};return t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{c()},children:l?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function Vt({spec:e}){const a=h.useRef(null),r=h.useRef(null),[n,i]=h.useState(!1);return h.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;return Ha({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{l=!0,o.replaceChildren()}},[e]),h.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Ha({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!l&&p&&o.isConnected&&o.replaceChildren(p)});const s=p=>{p.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Us=`
...
`;function _s(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function Vs(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:g,doPromote:c,doRepeche:m,doApproach:u,doDeep:x,doOnboard:d,outbound:b,evalBusy:v}=F(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=he(f),k=ke(f),w=et(f),C=f.kind==="target",A=R=>{a({type:"filters",patch:R}),a({type:"popup",id:null})};return lt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Us}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:_s(e.popupAnchor,!!f.card),onClick:R=>R.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Ve(f.date)),Ie(f.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[f.cc]}),children:(ct(f.cc,i)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:jt(f.amountEur,i)})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Qe(f.engine)," ",t.jsx("b",{children:Ie(f.engine,i)})," — ",so(f.engine,i),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ze,{o:f,lg:!0})," ",t.jsx(Ht,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Bn(y,i))," · ",n.win7(Un(y,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(Vt,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&k>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),o.pipe&&C&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})})]}),t.jsx(gr,{name:f.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[k===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),k===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),k===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),k===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),ot(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{x(f),a({type:"popup",id:null})},children:n.memoDeep})]}),k===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),k===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{d(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var R;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(R=document.querySelector(".atl2 .demand"))==null||R.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}const Hs=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Mt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Ys(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Mt(a.slice(n));break}r+=Mt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Mt(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&Hs.has(p)?r+=`<${s[1]}${p}>`:r+=Mt(a.slice(i,o+1)),n=o+1}return r}const Ln=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function we({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ws(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Gs({o:e}){const{t:a,doDeep:r}=F(),n=et(e),i=[e.reasoning||"",Ws(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),i.length?i.join(`

`).split(`

`).map((o,l)=>t.jsx("p",{className:"cdtxt",children:o},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[ot(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:o=>{o.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:o=>o.stopPropagation(),children:a.memoOpenFull})]})]})}function Ks({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=F(),o=_t(e),l=et(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,c=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),m=h.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:c},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||ot(e)?1:0}].filter(b=>b.n>0),[e,a,s,l,p,g,c]),[u,x]=h.useState("");if(!m.length)return null;const d=m.some(b=>b.k===u)?u:m[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:m.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":d===b.k,"data-tour":"tab-"+b.k,className:d===b.k?"on":"",onClick:v=>{v.stopPropagation(),x(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[d==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(we,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(we,{k:a.cdVerdictDate,v:Ln(e.verdictDate,r)})]})]}),d==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Ys(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Qs,{o:e})]}),d==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdSector,v:e.sector}),t.jsx(we,{k:a.cdStage,v:e.stage}),t.jsx(we,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(we,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(we,{k:a.cdAngle,v:e.angle}),t.jsx(we,{k:a.cdDetected,v:Ln(e.date,r)})]}),d==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdName,v:e.contactName}),t.jsx(we,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),d==="memo"&&t.jsx(Gs,{o:e}),d==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(we,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Qs({o:e}){const{t:a,token:r}=F(),[n,i]=h.useState(!1),[o,l]=h.useState(null),s=async()=>{n||(i(!0),l(await lo(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},g=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],c=g.some(([,m])=>m);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&c&&t.jsxs(t.Fragment,{children:[g.filter(([,m])=>m).map(([m,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:m}),t.jsx("p",{children:u})]},m)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!c&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const br={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Oa({o:e}){const{t:a}=F(),r=_t(e),n=et(e),i=ke(e),o=ia(e),l=co(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(br[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const Sa=e=>e.length>22?e.slice(0,21)+"…":e;function Rn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=F(),[o,l]=h.useState(!1);if(h.useEffect(()=>{n||l(!1)},[n]),Ee(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Sa(e.name))})]})}function vr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:g,dispatch:c}=F();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:x=>{x.stopPropagation(),c({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:x=>{var d;x.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(d=document.querySelector(".atl2 .demand"))==null||d.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:x=>{var d;x.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(d=document.querySelector(".atl2 .demand"))==null||d.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Rn,{o:e})});const m=ke(e),u=x=>d=>{d.stopPropagation(),x()};if(m===0)return t.jsx("span",{className:"cell",children:t.jsx(Rn,{o:e})});if(m===1){const x=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:x,onClick:u(()=>o(e)),children:x?a.actAnalyseQueued:a.actAnalyse})})}if(m===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})});if(m===4){const x=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:x,onClick:u(()=>g(e)),children:x?a.actApproachSent:a.actApproach})})}return m===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):m===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>c({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Js({o:e}){const{t:a,doThumb:r,thumbOf:n}=F(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Xs({o:e}){const{lang:a}=F();return he(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ze,{o:e}),t.jsx(Ht,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Qe(e.engine||"")," ",Ie(e.engine||"",a)]})})}function Zs({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:g,toggleFav:c}=F(),m=ke(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],x=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,d=x<=0?0:x<=7?1:x<=30?2:3,b=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][m]:u[d],v=g.has(e.id),f=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const k=y.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:k.left+Math.min(280,k.width/3),y:k.bottom}})};return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:f,children:[t.jsx("span",{className:"pt",style:{"--c":b}}),t.jsx(jr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),c(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(el,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Xs,{o:e}),l.pipe&&t.jsx(Oa,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(vr,{o:e}),l.showThumbs&&t.jsx(Js,{o:e})]}),r&&!a&&t.jsx(al,{o:e})]})}function el({o:e}){const{lang:a,caps:r}=F();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=jt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function tl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=F(),l=(u,x=!1)=>d=>{d.stopPropagation(),x&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=jt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Ee(e),m=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var x;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(x=document.querySelector(".atl2 .demand"))==null||x.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Vt,{spec:e.card})})]})}function al({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=F();return!i.pipe&&e.kind==="op"?t.jsx(tl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Ks,{o:e}),t.jsx(hi,{o:e}),t.jsx(vi,{o:e}),t.jsx(gr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Oa,{o:e})})]}),e.card&&t.jsx(Vt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Qe(e.engine||"")," ",Ie(e.engine||"",r)]}),he(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ze,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function nl({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=F();if(!i.pipe&&e.kind==="op"){const g=jt(e.amountEur,l),c=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),m=(u,x=!1)=>d=>{d.stopPropagation(),x&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Vt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:m({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:m({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:m({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Qe(e.engine||"")," ",Ie(e.engine||"",l)]}),he(e)&&t.jsx(Ze,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(vr,{o:e})})]})}const s=ke(e),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":p},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Oa,{o:e}),he(e)&&t.jsx(Ze,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function rl(){const{t:e}=F(),[a,r]=h.useState(0);return h.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ol({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=i==="en",l=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),p=s.includes(0)?0:s.sort((c,m)=>(e[m]||0)-(e[c]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:o?`${g} ${g>1?"files":"file"} in “${l(p)}”`:`${g} dossier${g>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function il(){var Z;const e=F(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:p,data:g,dossiers:c,source:m}=e,u=m==="ops"?8:Vn,[x,d]=h.useState(new Set);h.useEffect(()=>{d(new Set)},[a.ptab,a.continent]);const[b,v]=h.useState(null);h.useEffect(()=>{v(null)},[a.ptab,a.continent]);const f=z=>d(O=>{const $=new Set(O);return $.has(z)?$.delete(z):$.add(z),$}),[y,k]=h.useState("all"),[w,C]=h.useState(!1);h.useEffect(()=>{k("all"),C(!1)},[a.ptab,a.continent]),h.useEffect(()=>{if(!w)return;const z=O=>{var $,P;(P=($=O.target)==null?void 0:$.closest)!=null&&P.call($,".atl2 .doable")||C(!1)};return document.addEventListener("click",z),()=>document.removeEventListener("click",z)},[w]);const A=Os(),R=h.useMemo(()=>{var O;const z=new Map;for(const $ of Ps(((O=A==null?void 0:A.ed)==null?void 0:O.html)||""))z.has($.t)||z.set($.t,$.html);return z},[(Z=A==null?void 0:A.ed)==null?void 0:Z.html]),B=h.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!R.size)return;const O=(z.name||"").trim().toLowerCase();if(O.length<3)return;const $=R.get(O);if($)return $;for(const[P,D]of R)if(P.includes(O)||O.includes(P))return D},[R]),E=h.useMemo(()=>{const z=La(l,a.sort);return y==="all"?z:z.filter(O=>y==="explore"?!!O.noCo:!O.noCo)},[l,a.sort,m,y]),M=h.useMemo(()=>E.filter(z=>he(z)&&!Ee(z)).length,[E]),q=h.useMemo(()=>i.pipe?E:E.filter(z=>!Ee(z)&&!z.noCo),[E,i.pipe]),L=m==="ops"?E.filter(z=>z.noCo).length:0,U=i.pipe?n.plabels[a.ptab].toLowerCase():m==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,j=(z,O,$="",P=!1)=>t.jsxs("button",{type:"button","data-s":z,className:$,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:P?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[O,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),S=h.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const z=new Map;E.forEach(P=>{const D=P.engine||"?";z.has(D)||z.set(D,[]),z.get(D).push(P)});const O={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},$=sa([...z.keys()],s);return[...z.entries()].sort((P,D)=>{const _=O[P[0]]??10+$.indexOf(P[0]),W=O[D[0]]??10+$.indexOf(D[0]);return _-W})},[E,i.pipe,a.groupBy,s]),T=i.lockRowsAfter;let H=0;const G=(z,O)=>{let $=a.shown[O]||u;return z.length-$<=4&&($=z.length),z.slice(0,$).map(_=>{const W=T!==null&&H>=T;H++;const X=B(_),re=X&&X!==_.decryptHtml?{..._,decryptHtml:X}:_,xe=a.dens!=="maxi"&&(a.dens==="deplie"||(b?b==="open":!!X)),pe=x.has(_.id)?!xe:xe;return a.dens==="maxi"?t.jsx(nl,{o:re,locked:W},_.id):t.jsx(Zs,{o:re,locked:W,open:pe,onToggle:()=>f(_.id)},_.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:E.length})," ",U]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",m==="ops"&&E.length>0&&" — "+n.edSplit(E.length-L,L)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||m==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,O])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:O})]},z))}),(i.showFunnel||m==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":b==="open",onClick:()=>{v("open"),d(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":b==="closed",onClick:()=>{v("closed"),d(new Set)},children:n.foldAllLbl}),m==="ops"&&t.jsxs("button",{type:"button","aria-pressed":b===null,onClick:()=>{v(null),d(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||m==="ops")&&(()=>{var $;const z=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],O=(($=z.find(([P])=>P===y))==null?void 0:$[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":w,onClick:()=>C(P=>!P),children:[O,t.jsx("i",{children:"▾"})]}),w&&t.jsx("div",{className:"dolist",children:z.map(([P,D])=>t.jsx("button",{type:"button","aria-pressed":y===P,onClick:()=>{k(P),C(!1)},children:D},P))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([z,O])=>t.jsx("option",{value:z,children:O},z))})]}),i.showChain&&q.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:q.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(q.length):n.chainAll(q.length)]})]}),M>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(M)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),j("country",n.colCountry),j("name",n.colCompany),j("amount",n.colAmount,"h-amt",!0),j("stage",n.colStage,"h-stade"),j("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&j("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(m==="ops"?" opsl":"")+(E.length?"":" list-empty"),children:[S?S.map(([z,O])=>t.jsxs(h.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Qe(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Ie(z,s)}),t.jsx("div",{className:"s",children:n.grpCount(O.filter($=>!Ee($)).length,O.length)})]})]}),G(O,z)]},z)):G(E,"pt"+a.ptab),g.loading&&!c.length&&t.jsx(rl,{}),!E.length&&!(g.loading&&!c.length)&&(i.pipe?t.jsx(ol,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const z=S||[["pt"+a.ptab,E]];let O=0,$=0;for(const[D,_]of z){$+=_.length;let W=a.shown[D]||u;_.length-W<=4&&(W=_.length),O+=Math.min(_.length,W)}const P=$-O;return P<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([D,_])=>r({type:"more",group:D,by:_.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(P,P)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(O,$)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function Mn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function sl(e,a){const r=po(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function ll(e,a){const n=[a.head.split("|").map(Mn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",sl(i,a.plabels),_t(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Mn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function cl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const dl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Fe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function pl({o:e,qa:a}){const{t:r,lang:n,fund:i}=F(),o=(e.cribleStatus||"").trim().toUpperCase()||(_t(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=et(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Fe,{k:r.cdSector,v:e.sector}),t.jsx(Fe,{k:r.cdStage,v:e.stage}),t.jsx(Fe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Fe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Fe,{k:r.cdName,v:e.contactName}),t.jsx(Fe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Fe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Fe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Fe,{k:r.cdAngle,v:e.angle}),t.jsx(Fe,{k:r.cdDetected,v:dl(e.date,n)})]}),p.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,g])=>g).map(([g,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:c})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function ul(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=F(),[s,p]=h.useState({}),g=25,c=h.useMemo(()=>n.slice(0,g),[n]);h.useEffect(()=>{c.length&&uo(r,c.map(x=>x.name)).then(p)},[r,c]);const m=o.stats,u=x=>x.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[u(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(m.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(m.screened/o.marketEstimate*100)," %"]})]})]}),c.map(x=>t.jsx(pl,{o:x,qa:s[x.name]},x.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ml=50;function Fa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=F(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,c]=h.useState(""),[m,u]=h.useState(0),[x,d]=h.useState(""),[b,v]=h.useState(!1),f=h.useRef(null);h.useEffect(()=>()=>{f.current&&window.clearInterval(f.current)},[]);const y=async w=>{p(!0),c("");const C=await a();if(p(!1),C.ok){l(C);return}if(C.busy){c(i.alertPreviewBusy);return}if(!w){c(i.alertPreviewFail);return}u(ml),f.current=window.setInterval(()=>{u(A=>A>1?A-1:(f.current&&window.clearInterval(f.current),y(!1),0))},1e3)},k=async()=>{if(n||b)return;v(!0),d("");const w=await r();v(!1),d(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||m>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{k()},children:b?"…":i.alertTest})]}),m>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(m)}),g&&t.jsx("p",{className:"mnote warn",children:g}),x&&t.jsx("p",{className:"mnote",children:x}),!x&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const bt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Se({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=F();return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function fl(){const{st:e}=F();switch(e.modal){case"chain":return t.jsx(hl,{});case"space":return t.jsx(gl,{});case"alert":return t.jsx(bl,{});case"queue":return t.jsx(jl,{});case"export":return t.jsx(Nl,{});case"plug":return t.jsx(El,{});case"recharge":return t.jsx(zl,{});case"cover":return t.jsx(Ll,{});case"dossier":return t.jsx(Tl,{});case"crit":return t.jsx(Rl,{});case"tuto":return t.jsx(Ml,{});case"rdv":return t.jsx(xl,{});case"memoalert":return t.jsx(Sl,{});default:return null}}function xl(){const{dispatch:e,fund:a}=F(),r=typeof document<"u"&&!!document.getElementById("rdv");return h.useEffect(()=>{r&&(e({type:"modal",modal:null}),li())},[r,e]),r?null:t.jsx(xo,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function hl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s,caps:p,memoQueued:g,doAnalyse:c}=F(),m=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),x=e.chain.idx,d=u[x],b=x>=u.length;return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${x+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:x/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:d.name}),t.jsx("div",{className:"sub",children:[ct(d.cc,i)||d.countryLabel,d.sector,d.stage,n.daysAgo(Ve(d.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ie(d.engine,i).toUpperCase()}),typeof d.amountEur=="number"&&d.amountEur>0&&t.jsx("span",{children:jt(d.amountEur,i)})]}),he(d)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ze,{o:d,lg:!0})," ",t.jsx(Ht,{o:d,src:!0})]}),(d.tagline||d.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:d.tagline||d.headline})]}),d.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:d.reasoning})]}),m&&Ee(d)&&t.jsxs("div",{className:"vbox",style:{"--c":Ke(d)==="retenu"?"var(--brand)":Ke(d)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ke(d)==="retenu"?"✓ "+n.kept:Ke(d)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:d.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&d&&p.pipe&&ke(d)===1&&!g.has(d.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(d),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&d&&!(m&&Ee(d))&&(d.noCo&&d.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:d.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(d)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function gl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=F(),o=i==="client",l=h.useMemo(()=>o?r.filter(m=>Ee(m)):[],[r,o]),s=h.useMemo(()=>La(l.filter(m=>Ke(m)==="retenu"),{key:"signal",dir:-1}),[l]),p=h.useMemo(()=>l.filter(m=>Ke(m)==="ecarte"),[l]),g=e.spaceTab==="retenu"?s:p,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Se,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(m=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof m.score=="number"&&m.score>0?m.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:m.name}),t.jsx("div",{className:"rr",children:m.reasoning||m.tagline||""})]})]},m.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function bl(){const{mode:e}=F();return e==="client"||e==="apercu"?t.jsx(vl,{}):t.jsx(kl,{})}function vl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),[o,l]=h.useState("d"),s=i!=="client";return t.jsxs(Se,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(yl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(wl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(yr,{})]})}function yl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,c]=h.useState(0);h.useEffect(()=>{let d=!0;return p(!1),Ga(a).then(b=>{d&&(b?l(b):p(!0))}),()=>{d=!1}},[a,g]);const m=d=>{r||Ga(a,d).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(d=>d+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=d=>!o.sections||o.sections.includes(d),x=d=>{const b=o.sections||e.alertSec.map(([v])=>v);m({sections:u(d)?b.filter(v=>v!==d):[...b,d]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([d,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(d),disabled:r,onChange:()=>x(d)}),t.jsxs("span",{children:[b,d==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},d))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Fa,{label:e.alertPreview,readOnly:r,onPreview:()=>ko(a),onTest:()=>wo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function wl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,c]=h.useState(0);h.useEffect(()=>{let d=!0;return p(!1),Ka(a).then(b=>{d&&(b?l(b):p(!0))}),()=>{d=!1}},[a,g]);const m=d=>{r||Ka(a,d).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(d=>d+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,x=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:d=>m({dow:Number(d.target.value)}),children:e.alertDow.map((d,b)=>t.jsx("option",{value:b,children:d},d))}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,x-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[x," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,x+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Fa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>No(a),onTest:()=>jo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function yr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=F(),[l,s]=h.useState(o||""),[p,g]=h.useState(!1),[c,m]=h.useState(!1);h.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,x=h.useMemo(()=>n.filter(f=>he(f)).length,[n]),d=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||c)){m(!0);try{await fetch(`${Ca}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{m(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[d]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Ie(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>ct(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,x)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function kl(){const{t:e}=F();return t.jsx(Se,{title:e.alertTitle,icon:"🔔",children:t.jsx(yr,{})})}function jl(){var b,v,f;const{t:e,token:a,fund:r,mode:n,flash:i}=F(),[o,l]=h.useState(null),[s,p]=h.useState([]),[g,c]=h.useState(0),m=n==="client";h.useEffect(()=>{let y=!0;return(async()=>{const[k,w]=await Promise.all([Aa(r),Dn(a)]);y&&(k&&l(k),p(w))})(),()=>{y=!1}},[a,r,g]);const u=(o==null?void 0:o.per_day)??2,x=((b=o==null?void 0:o.analyzed_today)==null?void 0:b.length)??0,d=(v=o==null?void 0:o.tomorrow)!=null&&v.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(Se,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(x,x+(((f=o==null?void 0:o.pool_order)==null?void 0:f.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),m&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Wa(a,y.company,"retry").then(()=>c(k=>k+1))},children:e.queueRetry}),m&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Wa(a,y.company,"delete").then(()=>c(k=>k+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[d.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),d.slice(0,10).map((y,k)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",k+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Nl(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=F(),s=`${bt}/cibles/list.csv?token=${a}`,p=`${bt}/cibles/list.json?token=${a}`,g=`${bt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,m=v=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:g,href:g}],x=!i.lockActions&&n.length>0,d=()=>{cl(ll(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([f])=>f===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Se,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:d,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>m(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Sl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),o=i!=="client",[l,s]=h.useState(null),[p,g]=h.useState(!1),[c,m]=h.useState(0),[u,x]=h.useState(!1);h.useEffect(()=>{let f=!0;return g(!1),Ya(a).then(y=>{f&&(y?s(y):g(!0))}),()=>{f=!1}},[a,c]);const d=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=f=>{if(o||!l)return;const y={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??d()};x(!0),Ya(a,y).then(k=>{if(x(!1),!k){n(e.memoAlertErr);return}s(k),r(e.memoAlertSaved)})};if(p)return t.jsx(Se,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(Se,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=d();return t.jsxs(Se,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Cl,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>b({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[f],disabled:o||u,onChange:()=>b({sections:{...v,[f]:!v[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Fa,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>fo(a,v),onTest:()=>mo(a,v)})]})}function Cl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=h.useState(e);h.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function El(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=F(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,c]=h.useState(null),[m,u]=h.useState(""),[x,d]=h.useState(0);h.useEffect(()=>{let f=!0;return p(!1),la(a).then(y=>{f&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),go(a).then(y=>{f&&c(y)}),()=>{f=!1}},[a,x]);const b=(f,y)=>{i&&la(a,f).then(k=>{if(!k||k.ok===!1){n(e.actErr);return}f.test&&k.sent===!1?n(e.plugTestThrottled):r(y),d(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(Se,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:m,disabled:!i,onChange:f=>u(f.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!m.trim(),onClick:()=>b({url:m.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(Al,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function Al(){const{t:e,token:a,lang:r}=F(),[n,i]=h.useState("valides"),[o,l]=h.useState(!1),[s,p]=h.useState(null),[g,c]=h.useState(null),[m,u]=h.useState(!1),[x,d]=h.useState(!1),[b,v]=h.useState(null),[f,y]=h.useState(null),[k,w]=h.useState(null),C=`atl2:bulk:${a}:${n}`;h.useEffect(()=>{la(a).then(L=>{y(L&&L.configured?L.url_hint||"webhook":null)})},[a]),h.useEffect(()=>{p(null),c(null),u(!1),v(null);try{const L=JSON.parse(localStorage.getItem(C)||"null");w(L&&Date.now()-Date.parse(L.t)<24*3600*1e3?L:null)}catch{w(null)}},[C]);const A=async()=>{l(!0),u(!1),v(null);const L=await vo(a,n);p(L),c(L.ok?n:null),l(!1)},R=h.useRef(!1),B=async()=>{if(R.current)return;R.current=!0,d(!0);const L=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let U;try{U=await yo(a,n,"webhook",void 0,L)}finally{R.current=!1}if(d(!1),u(!1),v(U),U.ok&&(U.pushed||0)>0){const j={t:new Date().toISOString(),n:U.pushed||0};w(j);try{localStorage.setItem(C,JSON.stringify(j))}catch{}}},E=s!=null&&s.ok&&s.ready||0,M=!!(s!=null&&s.ok)&&g===n&&E>0&&!!f&&!k,q=k?new Date(k.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:L=>i(L.target.value),children:e.plugBulkTabs.map(([L,U])=>t.jsx("option",{value:L,children:U},L))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{A()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),k&&t.jsx("p",{className:"mnote",children:e.bulkLocked(q,k.n)}),!k&&!!(s!=null&&s.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!k&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),M&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),M&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(E,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:x,onClick:()=>{B()},children:x?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:x,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function zl(){const{t:e,data:a,lang:r}=F(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${Ca}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Se,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Tl(){const{t:e}=F();return t.jsx(Se,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(ul,{})})}function Ll(){const{t:e,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:l}=F(),[s,p]=h.useState(null),[g,c]=h.useState(!1);h.useEffect(()=>{let A=!0;return Aa(i).then(R=>{A&&R&&typeof R.per_day=="number"&&p(R.per_day)}),()=>{A=!1}},[i]);const m=r.stats,u=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(A=>A.kind==="target"&&Ee(A)).length,x=r.marketEstimate||0,d=x>0?Math.min(100,Math.round(u/x*100)):null,b=(m==null?void 0:m.window_days)||30,v=u>0?u/b:0,f=x>0?Math.max(0,x-u):0,k=x>0&&v>0&&u>=100?Math.round(f/v):null,w=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),C=A=>{g||!o||(c(!0),bo(i,A).then(R=>{if(c(!1),R===null){l(e.actErr);return}p(R),l(e.alertSaved)}))};return t.jsxs(Se,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(u))}),x>0&&t.jsx("span",{children:e.covOf(w(x))})]}),d!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:d+"%"}}),t.jsxs("em",{children:[d," %"]})]}),k!==null&&t.jsx("p",{className:"mnote",children:e.covEta(k)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),v>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(v))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(m.shown)})," ",e.covShown]})]}),o&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:s===A?"on":"",disabled:g,onClick:()=>C(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Rl(){var f,y,k;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:s}=F(),p=n==="client",g=h.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[c,m]=h.useState(""),[u,x]=h.useState(""),[d,b]=h.useState(!1),v=async()=>{const w=c.trim();if(!(!w||d||!p)){b(!0),x("");try{const A=await(await fetch(`${bt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&x(String(A.reply)),A.job_id){x(e.critChatRunning);const R=async()=>{const B=await fetch(`${bt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(E=>E.json()).catch(()=>null);if(B&&B.done){x(String(B.reply||B.clarification||B.summary||"✓")),b(!1),B.applied&&i(e.alertSaved);return}setTimeout(()=>{R()},8e3)};setTimeout(()=>{R()},8e3),m("");return}m("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(Se,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((f=o.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var C,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(R=>t.jsx("li",{children:R},R))})]}),!!((A=w.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(R=>t.jsx("li",{children:R},R))})]})]})]},w.title)})]}),!!((k=o==null?void 0:o.gate)!=null&&k.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!p||d,onChange:w=>m(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},disabled:!p||d||!c.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ho,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(br[w]||"v-cons"),children:w}),t.jsx("span",{children:C})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,C])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",C]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ml(){const{t:e,dispatch:a,startTour:r}=F(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Se,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const wr="atl2:mapfold",ql=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(wr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},kr=h.createContext(null),F=()=>{const e=h.useContext(kr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ze({o:e,lg:a}){const{lang:r}=F(),n=he(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Qa(n,r),children:[n.emoji," ",Qa(n,r)]}):null}function Ht({o:e,src:a}){const{lang:r,t:n}=F(),i=he(e);if(!i)return null;const o=zo(i),l=To(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Bn(i,r))+" · "+n.win7(Un(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<o?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function jr({o:e}){const{lang:a}=F(),r=Ao(e.cc),n=e.cc?ct(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const qn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Nr=e=>`atl2:tour:${e||"anon"}`;function Ol(e){try{return localStorage.getItem(Nr(e))==="1"}catch{return!0}}function On(e){try{localStorage.setItem(Nr(e),"1")}catch{}}function Fl(e,a,r){const n=e.tourT,i=e.howto;return[{sel:".atl2 .ident",title:n.ident,body:e.tourIntro},{sel:".atl2 .cover",title:n.cover,body:e.fhintCover},{sel:".atl2 .engine",title:n.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:n.live,body:e.fhintLive},{sel:".atl2 .goal",title:n.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:n.funnel,body:e.fhintFunnel,ptab:1},{sel:".atl2 .tuto",title:n.tuto,body:i[3][0],ptab:3},{sel:".atl2 .demand",title:n.demand,body:i[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:n.chips,body:e.fhintChips,ptab:1,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:n.dec,body:e.fhintDec,ptab:1,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:n.memo,body:e.fhintMemo,ptab:1,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:n.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:n.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:n.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:n.tools,body:i[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:n.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:n.crit,body:i[0][0],modal:"crit"}].filter(Boolean)}function Ul({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){const{lang:l}=So(),s=Io[l],p=Jo(e,l,a),[g,c]=h.useReducer(Zo,void 0,()=>Xo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||ql(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),m=h.useRef(!0);h.useEffect(()=>{if(m.current){m.current=!1;return}if(!e)try{localStorage.setItem(wr,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e]);const u=h.useRef(o);u.current=o,h.useEffect(()=>{var N;(N=u.current)==null||N.call(u,g.filters)},[g.filters]);const[x,d]=h.useState(null),[b,v]=h.useState(null),[f,y]=h.useState({kept:0,dropped:0}),[k,w]=h.useState(!1),[C,A]=h.useState(""),[R,B]=h.useState(!1),[E,M]=h.useState(null),[q,L]=h.useState(!1),[U,j]=h.useState(!1),[,S]=h.useState(0),T=()=>S(N=>N+1),H=h.useRef([]),G=h.useRef(new Set),Z=h.useRef(new Set),z=h.useRef(new Map),O=h.useRef(null),{mode:$}=p,P=h.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[p.caps,i,a]),D=P.pipe,_=p.session.token||"",W=$==="client"&&!e;h.useEffect(()=>{if(document.querySelector(`link[href="${qn}"]`))return;const N=document.createElement("link");N.rel="stylesheet",N.href=qn,document.head.appendChild(N)},[]);const X=(N,V=!1)=>{A(N),B(V),O.current&&clearTimeout(O.current),O.current=setTimeout(()=>A(""),V?4200:2400)},re=N=>X(N,!0),xe=h.useMemo(()=>{const N=new Map;return p.dossiers.forEach(V=>{V.id&&N.set(V.id,V)}),N},[p.dossiers]),pe=h.useMemo(()=>p.dossiers.filter(N=>Hn(N,g,D)),[p.dossiers,g,D]),K=h.useRef(!1);h.useEffect(()=>{if(K.current||e||p.loading||!p.dossiers.length)return;if(!P.showFunnel||Ol(p.session.token||"")){K.current=!0;return}K.current=!0;const N=window.setTimeout(()=>{On(p.session.token||""),L(!0)},700);return()=>window.clearTimeout(N)},[e,p.loading,p.dossiers.length,P.showFunnel,p.session.token]);const te=h.useMemo(()=>p.dossiers.filter(N=>ei(N,g,D,p.favIds)),[p.dossiers,g,D,p.favIds]),be=h.useMemo(()=>Co(pe,p.favIds),[pe,p.favIds]),ee=h.useMemo(()=>{const N=Gn(p.dossiers);return N?Ve(N)===0?s.tourToday:Kn(N,l):s.tourNoRun},[p.dossiers,s,l]),se=h.useMemo(()=>p.dossiers.some(N=>!!N.memoUrl||!!N.summary||ot(N)),[p.dossiers]),Q=za.find(N=>N.key===g.continent),Ue=g.continent==="monde"?s.contWorld:(l==="fr"?Q==null?void 0:Q.fr:Q==null?void 0:Q.en)||"";h.useEffect(()=>{const N=V=>{var ue;const Y=(((ue=V.detail)==null?void 0:ue.name)||"").trim();Y&&fe(null,Y)};return window.addEventListener("ppmap:evaluate",N),()=>window.removeEventListener("ppmap:evaluate",N)}),h.useEffect(()=>{const N=ue=>{const Me=String(ue||"").trim();Me&&c({type:"filters",patch:{sector:[Me]}})},V=ue=>{var Me;return N((Me=ue.detail)==null?void 0:Me.sector)},Y=ue=>{ue.data&&ue.data.type==="pp-filter"&&N(ue.data.sector)};return window.addEventListener("ppmap:filter",V),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",V),window.removeEventListener("message",Y)}},[]);const fe=(N,V)=>{const Y=((N==null?void 0:N.name)||V||"").trim();if(!W){v({kicker:Y});return}!Y||k||(w(!0),(async()=>{try{let ue=Y;const Me=((N==null?void 0:N.website)||(N==null?void 0:N.domain)||"").trim();if(Me)ue=Me;else try{const me=await Lo(Y);if(me!=null&&me.website)ue=me.website;else if(((me==null?void 0:me.candidates)||[]).length===1)ue=me.candidates[0].url;else if(((me==null?void 0:me.candidates)||[]).length>1){H.current=[{name:Y,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(me.candidates||[]).slice(0,5)},...H.current].slice(0,8),T();return}}catch{}const Oe=await $n(_,ue,"atelier2"),Ar={name:Oe.company||Y,verdict:Oe.verdict,reason:Oe.reason||"",remaining:Oe.remaining??null};H.current=[Ar,...H.current].slice(0,8),Oe.verdict==="kept"&&y(me=>({...me,kept:me.kept+1})),Oe.verdict==="ruled_out"&&y(me=>({...me,dropped:me.dropped+1}));const pt=N||p.dossiers.find(me=>(me.name||"").toLowerCase()===Y.toLowerCase());pt&&(Oe.verdict==="kept"?pt.verdict=pt.verdict||"MATCH":Oe.verdict==="ruled_out"&&(pt.verdict="NO MATCH"),Oe.reason&&(pt.reasoning=Oe.reason)),T()}finally{w(!1)}})())},ve=N=>{if(!W){v({kicker:N.name});return}G.current.add(N.id),ut(_,"fast_request",N.name||"",""),X(s.memoInstantSent(N.name)),T()},at=N=>z.current.get(N.id)??p.thumbs.get((N.name||"").trim().toLowerCase()),He=(N,V)=>c({type:"undoPush",entry:{id:N.id,name:N.name,prevCeoStatus:V}}),je=async(N,V,Y)=>{const ue=N.ceoStatus||"";N.ceoStatus=V,T();const Me=await Jt(_,{status:V,airtable_id:N.airtableId,check_id:N.checkId,company:N.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return Me.ok?Me.skipped?(N.ceoStatus=ue,T(),re(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&He(N,ue),Y!=null&&Y.msg&&X(Y.msg),(V==="Validé"||V==="Écarté")&&!N.ceoNote&&(Y==null?void 0:Y.note)===void 0&&M({o:N,yes:V==="Validé"}),!0):(N.ceoStatus=ue,T(),re(s.actErr),!1)},qe=async(N,V)=>{const Y=await Jt(_,{status:N.ceoStatus||"Retenu",airtable_id:N.airtableId,check_id:N.checkId,company:N.name,note:V,via:"note"});return!Y.ok||Y.skipped?(re(Y.skipped?s.actNotPersisted:s.actErr),!1):(N.ceoNote=V,T(),!0)},Ye=h.useRef(new Map),Yt=N=>Ye.current.has(N.id)?Ye.current.get(N.id):p.stages.get((N.name||"").trim().toLowerCase()),Wt=(N,V)=>{Ye.current.set(N.id,V),T()},I=(N,V)=>{W&&je(N,V?"Validé":"Écarté",{msg:V?s.decidedYes(N.name):s.decidedNo(N.name)})},ae=N=>{W&&je(N,"À trancher",{msg:s.promoted(N.name)})},oe=N=>{W&&(async()=>{const V=N.ceoStatus||"";N.ceoStatus="Retenu",T();const Y=await Jt(_,{status:"Retenu",check_id:N.checkId,company:N.name});if(!Y.ok||Y.skipped){N.ceoStatus=V,T(),re(Y.skipped?s.actNotPersisted:s.actErr);return}He(N,V),X(s.repeched(N.name))})()},ye=()=>{const N=g.undo[g.undo.length-1];if(!N){X(s.undoNone);return}const V=xe.get(N.id);if(!V){c({type:"undoPop"}),X(s.undoNone);return}let Y=N.prevCeoStatus;if(!Y)if((V.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{X(s.undoLockedTitle);return}(async()=>await je(V,Y,{undo:!1})&&(c({type:"undoPop"}),V.ceoStatus=N.prevCeoStatus,T(),X(s.undoDone(V.name))))()},_e=N=>{W&&(Z.current.add(N.id),T(),(async()=>{const V=await Ro(_,N.name,"email");if(!V||V.ok===!1){Z.current.delete(N.id),T(),re(s.actErr);return}ut(_,"approach",N.name||"",""),X(s.actApproachSent)})())},Ne=(N,V)=>{W&&(async()=>{if(!(await ut(_,V?"yes":"no",N.name||"","")).ok){re(s.actErr);return}z.current.set(N.id,V?"yes":"no"),T(),X(V?s.thumbUpDone:s.thumbDnDone)})()},le=N=>{!W||!ot(N)||(ut(_,"detailed_request",N.name||"",""),X(s.memoDeepSent(N.name)))},Ae=N=>{const V=new Set(p.favIds),Y=V.has(N.id);Y?V.delete(N.id):V.add(N.id),p.setFavIds(V),W&&Mo(_,{id:N.id,co:N.name},Y)},Gt=()=>{!W||U||window.confirm(s.identSyncConfirm)&&(j(!0),(async()=>{const N=await qo(_);j(!1),N?X(s.identSyncDone):re(s.actErr)})())},dt=/proplace/i.test(p.fund||""),Sr=N=>{!W||!dt||(ut(_,"onboard_request",N.name||"",""),X(s.onboardSent(N.name)))},Cr={st:g,dispatch:c,t:s,lang:l,mode:$,caps:P,pipe:D,token:_,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:oe,thumbOf:at,canWrite:W,commitStatus:je,saveNote:qe,stageOf:Yt,setStage:Wt,flashErr:re,startTour:()=>L(!0),dossiers:p.dossiers,scopedAll:pe,scoped:te,counts:be,byId:xe,contName:Ue,favIds:p.favIds,toggleFav:Ae,askEvaluate:fe,doAnalyse:ve,doDecide:I,doPromote:ae,doApproach:_e,doThumb:Ne,doDeep:le,doUndo:ye,doSync:Gt,doOnboard:Sr,outbound:dt,memoQueued:G.current,approachDone:Z.current,sessTally:f,evalCards:H.current,evalBusy:k,markRow:d,markedId:x,flash:X};h.useEffect(()=>{const N=V=>{V.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",N),()=>window.removeEventListener("keydown",N)},[]);const Er=N=>_?t.jsx($s,{token:_,children:N}):t.jsx(t.Fragment,{children:N});return t.jsx(kr.Provider,{value:Cr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Uo}),Er(t.jsxs("div",{className:"app"+(D?" pipe":"")+(_?" has-thesis":""),children:[P.showTicker&&t.jsx(ge,{name:"live",children:t.jsxs("div",{className:"live-stack"+(_?" live-stack--cibles":""),children:[t.jsx(oi,{}),!!_&&t.jsx(Bs,{})]})}),P.showIdent&&t.jsx(ge,{name:"identite",children:t.jsx(ki,{})}),!!_&&t.jsx(ge,{name:"lead",children:t.jsx(Is,{})}),P.showOnb&&t.jsx(ge,{name:"onboarding",children:t.jsx(ji,{})}),P.showMorning&&t.jsx(ge,{name:"matin",children:t.jsx(wi,{})}),t.jsx(ge,{name:"fraicheur",children:t.jsx(mi,{})}),t.jsx(ge,{name:"mesure",children:t.jsx(fi,{})}),P.showFunnel&&t.jsx(ge,{name:"entonnoir",children:t.jsx(Pl,{})}),P.showFunnel&&t.jsx(ge,{name:"tunnel",children:t.jsx(Si,{})}),P.showFunnel&&t.jsx(ge,{name:"tuto",children:t.jsx(Ei,{})}),t.jsx(ge,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Dl,{}),t.jsxs("div",{className:"stage"+(g.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Ns,{}),t.jsx(Cs,{})]})]})}),P.showDemand&&t.jsx(ge,{name:"evaluation",children:t.jsx(Rs,{})}),P.showDemand&&g.memoConsole&&t.jsx(ge,{name:"console",children:t.jsx(qs,{})}),t.jsx(ge,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(il,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),P.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),g.popupId&&t.jsx(ge,{name:"fiche",children:t.jsx(Vs,{})}),t.jsx(ge,{name:"modales",children:t.jsx(fl,{})}),t.jsx(di,{}),E&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:E.o.name}),t.jsx(bi,{placeholder:E.yes?s.whyYesPh:s.whyNoPh,onDone:N=>{const V=E.o;M(null),N&&qe(V,N).then(Y=>{Y&&X(s.csNoteSaved)})}})]}),q&&t.jsx(yi,{steps:Fl(s,ee,se),onClose:()=>{L(!1),On(_)}}),C&&t.jsx("div",{className:"flash on"+(R?" err":""),children:C}),b&&t.jsx(Eo,{variant:"acquirer",initialCompany:Fn().co,initialWebsite:Fn().site,onClose:()=>v(null)})]})})}function Pl(){const{t:e}=F(),[a,r]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Dl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=F(),l=h.useMemo(()=>{const s={};return e.forEach(p=>{Ta(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[Oo.map(s=>{const p=za.find(c=>c.key===s),g=s==="monde"?o.contWorld:i==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[g,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Fn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Il(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{jr as FlagCell,Ze as SigBadge,Ht as SigWin,Ul as default,Il as fmtShort,F as useV2};
