...
.atl2 .bulk .side .hint{white-space:nowrap}`,Gi=`
...
/* languette mobile : toujours au-dessus de la liste, sous LIVE */ 
.atl2 .chrome-tog{display:none}
@media (max-width:760px){
  body.pp-desk .atl2.ops .chrome-tog{
    display:flex;align-items:center;justify-content:center;gap:8px;
    position:sticky;z-index:38;order:4;flex:none;width:100%;
    height:32px;margin:0;padding:0 12px;border:0;border-bottom:1px solid var(--line,#e2e8f0);
    background:#F8FAFC;color:#475569;font:inherit;font-size:12px;font-weight:650;
    cursor:pointer;letter-spacing:.01em;
    top:calc(var(--pp-gap,48px) + var(--pp-live-h,44px) + var(--demand-h,56px) + var(--listhead-h,52px))}
  body.pp-desk .atl2.ops .chrome-tog i{
    display:block;width:36px;height:4px;border-radius:99px;background:#CBD5E1;flex:none}
  body.pp-desk .atl2.ops .chrome-tog:hover{background:#F1F5F9;color:#0F172A}
  body.pp-desk .atl2.ops.chrome-min .eval-stick,
  body.pp-desk .atl2.ops.chrome-min .listhead{display:none!important}
  body.pp-desk .atl2.ops.chrome-min .chrome-tog{
    top:calc(var(--pp-gap,48px) + var(--pp-live-h,44px));
    box-shadow:0 1px 0 var(--line,#e2e8f0)}
}
...
`,Ki=Yi+Gi;function Ka(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Qi(){const e=Ka("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ji(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Qi();return r==="0"?"client":r==="1"||Ka("embed")==="1"&&Ka("chrome")==="1"?"apercu":"client"}const Xi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Zi=e=>Xi[e];function wa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const vt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Er(a)||wa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Io(e.cc)})};function Da(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const es=60*60*1e3;function ts(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>es?null:a}catch{return null}}function ia(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const as=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ns(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:zo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Ji(e,i),[e,i,n]),l=m.useMemo(()=>Zi(o),[o]),d=o!=="visiteur",c=as(r),[h,s]=m.useState([]),[f,p]=m.useState(""),[v,u]=m.useState(null),[b,y]=m.useState(null),[x,j]=m.useState(null),[S,w]=m.useState(()=>new Map),[N,T]=m.useState(()=>new Map),[A,L]=m.useState(""),[q,E]=m.useState(new Set),[O,I]=m.useState(null),[F,P]=m.useState(!0),[g,z]=m.useState(!1),[H,G]=m.useState(0),[W,J]=m.useState(0),X=m.useRef(0),K=m.useMemo(()=>{var ae;if(o!=="client")return"";try{return((ae=Ao())==null?void 0:ae.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ae=++X.current;let ce=!0;const V=()=>ce&&ae===X.current,re=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),ee=ts(re);return ee?(s(ee.objs.map(vt)),ee.fund&&p(ee.fund),u(ee.marketEstimate??null),y(ee.criteria??null),j(ee.stats??null),L(ee.generatedAt||""),P(!1)):P(!0),(async()=>{try{if(r==="ops"){const Le=await Ra(),je=((Le==null?void 0:Le.recent_ops)||[]).map(oe=>{const me=ha(oe.company_name||oe.title?oe:{...oe,title:(oe.headline_fr||oe.headline||"").slice(0,120)},a),de=String(oe.rubrique||"").toLowerCase();return me&&(de==="nominations"||de==="recrutements")&&(me.engine=de),me&&!String(oe.company_name||"").trim()&&(me.noCo=!0),me}).filter(oe=>!!oe).map(oe=>(Er((oe.name||"").trim())||(oe.noCo=!0),oe));try{const oe=To(),me=await qo(),de=((me==null?void 0:me.date)||"").slice(0,10),Y=oe?oe.doc:me,Z=Lo(Y),he=((oe==null?void 0:oe.day)||(Y==null?void 0:Y.date)||de||"").slice(0,10);if(he&&Z.length){const se=new Set;for(const fe of je){if((fe.date||"").slice(0,10)!==he)continue;const ge=zn(Z,se,fe.name,"");ge>=0&&(se.add(ge),fe.decryptHtml=Z[ge].html)}for(const fe of je){if(fe.decryptHtml||(fe.date||"").slice(0,10)!==he)continue;const ge=zn(Z,se,"",fe.headline||fe.tagline||fe.name);ge>=0&&(se.add(ge),fe.decryptHtml=Z[ge].html)}}if(he){const se=((Y==null?void 0:Y.title_fr)||"").trim(),fe=((Y==null?void 0:Y.lead_fr)||"").trim(),ge=Fo(Y),be=((Y==null?void 0:Y.url)||"").trim();se&&(ge||be)&&je.unshift({id:`edito:${he}`,kind:"op",name:se,cc:null,date:he,engine:"edito",dealKind:"other",headline:se,tagline:fe||se,decryptHtml:ge||void 0,url:be,noCo:!0})}}catch{}if(!V())return;s(je.map(vt)),ia(re,{objs:je})}else if(typeof r=="object"){const je=(await An()||[]).filter(me=>(me.slug||"")===r.research).map(me=>Tn(me,a)).filter(me=>!!me),oe=Da(await qn(je,a));if(!V())return;s(oe.map(vt)),ia(re,{objs:oe})}else if(d&&i.token){const Le=Mo(i.token),je=Ra(),oe=Ro(i.token),me=Oo(i.token),de=Do(i.token),Y=await Le;let Z=Y?Y.targets:[];V()&&Y&&(p(Y.fund||""),u(Y.marketEstimate??null),y(Y.criteria??null),j(Y.stats??null),L(Y.generatedAt||""),s(Z.map(vt)),P(!1),z(!1));const[he,se,fe,ge]=await Promise.all([je,oe,me,de]),be=((he==null?void 0:he.recent_ops)||[]).map(ve=>ha(ve,a)).filter(ve=>!!ve);if(Z=[...Z,...be],!V())return;s(Z.map(vt));const qe=new Set;for(const ve of se){const Fe=(ve.id||ve.co||"").toString().trim().toLowerCase();Fe&&qe.add(Fe.startsWith("t:")?Fe:"t:"+Fe)}E(qe),w(fe),T(ge),Y&&ia(re,{fund:Y.fund,marketEstimate:Y.marketEstimate,criteria:Y.criteria,stats:Y.stats,generatedAt:Y.generatedAt,objs:Z})}else{const Le=Po(),je=An(),oe=Ra(),me=await Le;V()&&me.length&&(s(Da(me).map(vt)),P(!1),z(!1));const[de,Y]=await Promise.all([je,oe]),Z=(de||[]).map(ge=>Tn(ge,a)).filter(ge=>!!ge),he=await qn(Z,a),se=((Y==null?void 0:Y.recent_ops)||[]).map(ge=>ha(ge,a)).filter(ge=>!!ge),fe=Da([...me,...he,...se]);if(!V())return;s(fe.map(vt)),ia(re,{objs:fe})}V()&&z(!1)}catch{V()&&!ee&&z(!0)}finally{V()&&P(!1)}})(),()=>{ce=!1}},[d,i.token,a,H,c]),m.useEffect(()=>{if(!l.showCredits||!K){I(null);return}let ae=!0;return(async()=>{try{const ce=await fetch(`${un}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K})});if(!ce.ok)return;const V=await ce.json();ae&&V&&V.ok!==!1&&I(V)}catch{}})(),()=>{ae=!1}},[l.showCredits,K,W]);const ie=m.useCallback(ae=>E(new Set(ae)),[]);return{session:i,mode:o,caps:l,fund:f,email:K,marketEstimate:v,generatedAt:A,criteria:b,stats:x,thumbs:S,stages:N,dossiers:h,favIds:q,setFavIds:ie,credits:O,reloadCredits:()=>J(ae=>ae+1),loading:F,error:g,refresh:()=>G(ae=>ae+1)}}function Ze(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Rr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),rs=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Rr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),os=new Set(["signal","amount","score","crible","memo"]);function is(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Rr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:os.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Or)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Or=80;function ka(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Re(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(mn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(ct(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&kt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Dr(e,a,r){return Ze(e)?ka(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ka(e,a.filters,r)}function ss(e,a,r,n){return!(!Dr(e,a,r)||r&&!Bo(e,a.ptab,n))}function hn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ct(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return _o(i);case"memo":return $o(i);case"signal":{const o=Re(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const Pa={},$n=(Pa==null?void 0:Pa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function _n(){return new Date().toISOString().slice(0,10)}const gn=m.createContext(null);function Pr(){return m.useContext(gn)}function ls(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const h=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),h&&/^https?:\/\//i.test(h)&&(c.setAttribute("href",h),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function Un(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const i=n.tagName==="A"?n.getAttribute("href"):null;[...n.attributes].forEach(o=>n.removeAttribute(o.name)),i&&/^https?:\/\//i.test(i)&&(n.setAttribute("href",i),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("div,section,p")]){const i=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(i)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Hn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Ir(){const e=m.useContext(gn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ds({token:e,children:a}){const{dispatch:r,st:n,lang:i}=U(),[o,l]=m.useState(()=>n.filters.day||_n()),[d,c]=m.useState(null),[h,s]=m.useState(!1),f=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),p=m.useCallback(()=>{l(_n());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var j;const x=(j=y.detail)==null?void 0:j.day;typeof x=="string"&&f(x)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[f]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${$n}/cibles/edition.json?${y}`).then(x=>x.json()).then(x=>{b||c(x)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const v=m.useMemo(()=>`${$n}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),u=m.useMemo(()=>({token:e,day:o,ed:d,loading:h,pickDay:f,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:v,isEn:i==="en"}),[e,o,d,h,f,p,n.filters.day,v,i]);return t.jsx(gn.Provider,{value:u,children:a})}function cs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Ir(),[i,o]=m.useState(()=>n||Cr());return m.useEffect(()=>{n&&o(!0)},[n]),m.useEffect(()=>{const l=d=>{var c;return o(!!((c=d.detail)!=null&&c.open))};return window.addEventListener(ya,l),()=>window.removeEventListener(ya,l)},[]),i?t.jsx("div",{className:"thesis-days",children:t.jsx(Uo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}function ps(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Ir(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok,h=m.useRef(null),s=m.useMemo(()=>Un((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),f=m.useMemo(()=>Un((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return m.useEffect(()=>{const p=h.current;if(!p||!s)return;let v=!1;return zr(()=>import("./fit-BnaWm7z_.js"),[]).then(async u=>{await u.ensureEditoCss(),!(v||!p.isConnected)&&(u.beautifyEditoRows(p),u.mountCardFits(p))}),()=>{v=!0}},[s]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:Hn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:Hn(e)}),"."]})}),l&&s?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:s}}):null,l&&f?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:f}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const us=300,sa=7,ms={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Br={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},fs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ia(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Yo(r)&&r!=="media")return"news:"+r;const n=Re(e);return n?"sig:"+(n.theme&&Br.fr[n.theme]?n.theme:"other"):"actualites"}function xs(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=U(),c=Pr(),h=l==="en",[s,f]=m.useState("all"),[p,v]=m.useState(!1),u=m.useMemo(()=>{var ce;const g=(a.filters.day||"").slice(0,10),z=V=>!(!o&&a.continent!=="monde"&&V.continent!==a.continent||g&&(V.date||"").slice(0,10)!==g),H=e.filter(V=>z(V)&&Re(V)&&(!o||V.kind!=="target"||ze(V)!==5)),G=o&&(((ce=c==null?void 0:c.ed)==null?void 0:ce.ops)||[]).length?c.ed.ops.map(V=>ha(V,l)).filter(V=>!!V).filter(V=>!g||(V.date||"").slice(0,10)===g):[],W=e.filter(V=>z(V)&&V.kind==="op"&&(g?!0:ct(V.date)<=sa)),J=o?G.length?G:W.filter(V=>{const re=(d||"").trim().toLowerCase();if(!re)return!1;const ee=V.match||null;return ee?Object.keys(ee).map(Le=>Le.trim().toLowerCase()).includes(re):!1}):W,X=g||new Date().toISOString().slice(0,10),K=V=>{const re=Ia(V);return re==="ma"?0:re==="levees"?1:2};J.sort((V,re)=>{const ee=K(V)-K(re);if(ee)return ee;const Le=(V.date||"").slice(0,10)===X?0:1,je=(re.date||"").slice(0,10)===X?0:1;return Le!==je?Le-je:(re.amountEur||0)-(V.amountEur||0)});const ie=new Set,ae=[];for(const V of[...J,...hn(H,{key:"signal",dir:-1})]){const re=V.id||V.name;!re||ie.has(re)||(ie.add(re),ae.push(V))}return o&&ae.length===0?e.filter(re=>z(re)&&ct(re.date)<=sa).sort((re,ee)=>(ee.date||"").localeCompare(re.date||"")).slice(0,80):ae},[e,a.continent,a.filters.day,o,d,l,c]),b=m.useMemo(()=>{const g={};for(const z of u){const H=Ia(z);g[H]=(g[H]||0)+1}return g},[u]),y=m.useMemo(()=>s==="all"?u:u.filter(g=>Ia(g)===s),[u,s]),x=m.useMemo(()=>y.slice(0,us),[y]),j=y.length-x.length,S=m.useRef(null);m.useEffect(()=>{var J,X;const g=S.current;if(!g)return;const z=()=>{const K=g.scrollWidth;K<200||(g.style.animationDuration=Math.max(18,Math.round(K/130))+"s")};z();const H=requestAnimationFrame(z),G=window.setTimeout(z,1200);let W=!0;return(X=(J=document.fonts)==null?void 0:J.ready)==null||X.then(()=>{W&&z()}),()=>{W=!1,cancelAnimationFrame(H),window.clearTimeout(G)}},[x.length,s]);const w=g=>g==="all"?u.length:b[g]||0,N=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return Br[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const z=g.slice(5);return Vo[z]?Wo(z,h?"en":"fr"):g}return ms[h?"en":"fr"][g]},T=[{k:"all"}],A=["ma","levees"].filter(g=>w(g)>0||g===s);if(A.length){T.push({g:h?"Deals":"Opérations"});for(const g of A)T.push({k:g})}const L=["nominations","recrutements"].filter(g=>w(g)>0||g===s),q=Ho.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>w(g)>0||g===s),E=w("actualites")>0||s==="actualites"?["actualites"]:[];if(L.length||q.length||E.length){T.push({g:h?"News":"Actualités"});for(const g of L)T.push({k:g});for(const g of q)T.push({k:g});for(const g of E)T.push({k:g})}const O=fs.map(g=>"sig:"+g).filter(g=>w(g)>0||g===s);if(O.length){T.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of O)T.push({k:g})}const I=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},F=(()=>{const g=(a.filters.day||"").slice(0,10),z=!o&&a.continent!=="monde"&&i?h?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return g?(h?`LIVE covers the events of ${I(g)}.`:`Le LIVE regroupe les événements du ${I(g)}.`)+z:(h?`LIVE covers the still-open signals and the deals of the last ${sa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${sa} derniers jours.`)+z})(),P=g=>x.map(z=>t.jsxs("button",{type:"button",className:"tk"+(Ie(z)?" spent":""),onClick:H=>{try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:z.id,name:z.name,url:z.url||"",text:z.tagline||z.headline||"",card:z.card}}))}catch{}if(n({type:"focus",id:z.id}),a.dens!=="liste"){const G=H.currentTarget.getBoundingClientRect();n({type:"popup",id:z.id,anchor:{x:G.left+G.width/2,y:G.bottom}})}},title:z.name+(z.tagline?" — "+z.tagline:""),children:[t.jsx(Ct,{o:z}),t.jsxs("span",{className:"who",children:[t.jsx(yo,{o:z}),t.jsx("span",{className:"co",children:z.name})]}),typeof z.amountEur=="number"&&z.amountEur>0&&t.jsx("span",{className:"am",children:_d(z.amountEur)}),z.sector&&t.jsx("span",{className:"mt",children:z.sector}),t.jsx(Fa,{o:z}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(z.id||z.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||v(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>v(g=>!g),children:[N(s),t.jsx("b",{children:w(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:F}),T.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===s,onClick:()=>{f(g.k),v(!1)},children:[N(g.k),t.jsx("b",{children:w(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:x.length?t.jsxs("div",{className:"run",ref:S,children:[P(0),P(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(gs,{isEn:h})]})}const hs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function gs({isEn:e}){const[a,r]=m.useState(()=>Cr());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(ya,i),()=>window.removeEventListener(ya,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Go(!a),children:hs})}const bn="+33 6 83 10 72 86",ja="alexandre@proplace.co",$r=`tel:${bn.replace(/[^\d+]/g,"")}`;function bs(){return null}class at extends m.Component{constructor(){super(...arguments);En(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const _r=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function vs(e,a){if((mt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return _r.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function ys({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=U(),[d,c]=m.useState(!1),[h,s]=m.useState(""),[f,p]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const v=(e.ceoStatus||"").trim(),u=async b=>{if(h)return;if(b==="Analysé"&&!e.memoUrl){p(!0);return}s(b);const y=await i(e,b);s(""),y&&(c(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),p(!1)},children:[v||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:f?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),p(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(c(!1),p(!1))})()},children:a.csAnaAnyway})]}):vs(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(v===b?" on":"")+(h===b?" busy":""),disabled:!!h,onClick:()=>{u(b)},children:y},b))})]})}function ws({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=U(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),s=(mt(e)||"").startsWith("CALL")&&ze(e)===3,f=ze(e)>=2,p=async u=>{if(o||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(u);const b=await i(e,u);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},v=s?[["Validé",a.csYes],["Écarté",a.csNo]]:_r.filter(([u])=>!(f&&u==="Retenu")).map(([u,b])=>[u,a[b]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([u,b])=>t.jsx("button",{type:"button",className:"csb"+(h===u?" on":"")+(o===u?" busy":""),disabled:!!o,onClick:()=>{p(u)},children:b},u)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ks,{o:e})]})}function ks({o:e}){const{t:a,saveNote:r,flash:n}=U(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,h]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(l||!s)return;d(!0);const p=await r(e,i.trim());d(!1),p&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:p=>o(p.target.value),onKeyDown:p=>{p.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{f()},children:c?a.csNoteSaved:a.csNoteOk})]})}function js({placeholder:e,onDone:a}){const{t:r}=U(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Ns({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=U(),[c,h]=m.useState(!1);if(!n.pipe||!i||n.lockActions||ze(e)!==4)return null;const s=o(e),f=(s==null?void 0:s.stage)||"todo",p=async x=>{if(c||x===f)return;h(!0);const j=s;l(e,{stage:x,stamps:(s==null?void 0:s.stamps)||{}});const S=Math.max(Date.now(),Vn+=1);Vn=S;const w=await Ko(r,{company:e.name||"",stage:x,cts:S,deal_id:e.airtableId,check_id:e.checkId});h(!1),!w.stale&&(w.ok||(l(e,j),d(a.actErr)))},v=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,u=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,b=f==="sent"&&v&&u>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,j])=>t.jsx("button",{type:"button",className:"stgb"+(f===x?" on":""),disabled:c,onClick:()=>{p(x)},children:j},x)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let Vn=0;const la=8,da=360;function Wn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Yn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Wn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Wn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function Ss({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=U(),[l,d]=m.useState(0),[c,h]=m.useState(null),[s,f]=m.useState([]),p=m.useRef(!1),v=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),u=m.useRef(!1);m.useEffect(()=>{const A=v.current;return()=>{u.current||(n({type:"ptab",tab:A.ptab}),n({type:"dens",dens:A.dens}),n({type:"modal",modal:A.modal}))}},[]),m.useEffect(()=>{p.current||(p.current=!0,f(e.filter(A=>!!document.querySelector(A.need||A.sel))))},[e]);const b=s[l],y=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const A=b.click,L=window.setTimeout(()=>{const q=document.querySelector(A);q&&q.getAttribute("aria-selected")!=="true"&&q.click()},60);return()=>window.clearTimeout(L)}},[l,b]);const x=m.useRef(-1),j=m.useCallback(()=>{if(!b){h(null);return}const A=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!A){h(null);return}x.current!==l&&(x.current=l,A.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=A.getBoundingClientRect();h(q=>q&&Math.abs(q.top-L.top)<1&&Math.abs(q.left-L.left)<1&&Math.abs(q.width-L.width)<1&&Math.abs(q.height-L.height)<1?q:L)},[b,l]);m.useLayoutEffect(()=>{j();const A=[90,300,700,1300].map(q=>window.setTimeout(j,q)),L=()=>j();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{A.forEach(q=>window.clearTimeout(q)),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[j]);const S=m.useRef(a);if(S.current=a,m.useEffect(()=>{const A=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),S.current()):L.key==="ArrowRight"?d(q=>q+1):L.key==="ArrowLeft"&&d(q=>Math.max(0,q-1))};return document.addEventListener("keydown",A,!0),()=>document.removeEventListener("keydown",A,!0)},[]),!s.length)return null;let w=null;const N=A=>()=>{u.current=!0,n({type:"modal",modal:null}),A()};if(y){const A=i[3]||0;A>0?w={title:A===1?r.ahaATitle1:r.ahaATitleN(A),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:da};if(!y&&c){const A=c.bottom+14,q=window.innerHeight-A>190?A:Math.max(12,c.top-200);T={left:Math.min(Math.max(12,c.left+c.width/2-da/2),window.innerWidth-da-12),top:q,width:da}}return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-la,top:c.top-la,width:c.width+la*2,height:c.height+la*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:T,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(Yn,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Yn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(A=>Math.max(0,A-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(A=>A+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Ur(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Hr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Es(){var L,q;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=U(),h=r?a:e,s=m.useMemo(()=>h.filter(E=>ct(E.date)===0&&E.kind==="target"),[h]),f=m.useMemo(()=>r?a.filter(E=>E.kind==="target"&&ze(E)===0).slice().sort((E,O)=>(O.date||"").localeCompare(E.date||"")):[],[a,r]),p=m.useMemo(()=>s.filter(E=>r?ze(E)===0:!Ie(E)),[s,r]),v=r?f:p,u=r?a.length-f.length:s.length-p.length,b=r?a.length:s.length,y=b?Math.min(100,u/b*100):100,x=m.useMemo(()=>Ur(h),[h]),j=!!x&&ct(x)>0,S=m.useMemo(()=>j?h.filter(E=>(E.date||"").slice(0,10)===x):[],[h,x,j]),w=typeof((L=d.stats)==null?void 0:L.kept_today)=="number"?d.stats.kept_today:null,N=typeof((q=d.stats)==null?void 0:q.screened_today)=="number"?d.stats.screened_today:s.length;let T;j?T=i.morningLast(S.length,f.length,Hr(x,l)):r?T=i.morningThesis(N,f.length,w):s.length?u===0?T=i.goalSourced(s.length):u>=s.length?T=i.goalCleared:T=i.goalDone(u,s.length):T=i.goalSourced(0);const A=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&f.length&&c({type:"chainStart",queue:f.map(E=>E.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),v.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:A,children:r?i.morningEval(v.length):o.pileMode?i.goalContinue(v.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Cs(){var H,G;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:h,startTour:s,flash:f,flashErr:p}=U(),[v,u]=m.useState(null),[b,y]=m.useState(!0),[x,j]=m.useState([]),S=c==="client";m.useEffect(()=>{if(!i||!o)return;let W=!0;return y(!0),(async()=>{const[J,X]=await Promise.all([fn(o),Ar(i)]);W&&(J&&u(J),y(!1),j(X))})(),()=>{W=!1}},[i,o]);const[w,N]=m.useState(!1),T=()=>{!S||w||!o||(N(!0),Qo(o).then(W=>{N(!1),W?f(e.identRepubDone):p(e.actErr)}))},A=(v==null?void 0:v.per_day)??null,L=((H=v==null?void 0:v.pool_order)==null?void 0:H.length)??0,q=x.filter(W=>W.status==="running").length,E=m.useMemo(()=>d.filter(W=>W.kind==="target"&&Ie(W)).length,[d]),O=l.marketEstimate,I=typeof((G=l.stats)==null?void 0:G.screened)=="number"?l.stats.screened:E,F=O&&O>0?Math.min(100,Math.round(I/O*100)):null,P=W=>W.toLocaleString(a==="en"?"en-US":"fr-FR"),g=(o||"P").split(/\s+/).map(W=>W[0]).join("").slice(0,2).toUpperCase(),z=(()=>{const W=Date.parse(l.generatedAt||"");if(Number.isNaN(W))return"";const J=new Date(W),X=K=>String(K).padStart(2,"0");return`${X(J.getDate())}/${X(J.getMonth()+1)} à ${X(J.getHours())}:${X(J.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?g:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),z?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(z)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[F===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:P(I)})})]}),F!==null&&O&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:F+"%"}})}),t.jsxs("b",{children:[F," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,O)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),A!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:A})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),A===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),q>0&&t.jsxs("span",{className:"ev",children:["⏳ ",q]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:W=>{W.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!S||w,onClick:T,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!S,onClick:h,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:W=>n({type:"filters",patch:{search:W.target.value}})})]})]})]})}class Nt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*zs(e){for(const a of e)yield*a}function Vr(e){return Array.from(zs(e))}var ke=1e-6,ue=Math.PI,Ye=ue/2,Gn=ue/4,Ke=ue*2,lt=180/ue,_e=ue/180,Ce=Math.abs,As=Math.atan,Jt=Math.atan2,Ae=Math.cos,Te=Math.sin,Ts=Math.sign||function(e){return e>0?1:e<0?-1:0},zt=Math.sqrt;function qs(e){return e>1?0:e<-1?ue:Math.acos(e)}function Xt(e){return e>1?Ye:e<-1?-Ye:Math.asin(e)}function Ge(){}function Na(e,a){e&&Qn.hasOwnProperty(e.type)&&Qn[e.type](e,a)}var Kn={Feature:function(e,a){Na(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Na(r[n].geometry,a)}},Qn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Qa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Qa(r[n],a,0)},Polygon:function(e,a){Jn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Jn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Na(r[n],a)}};function Qa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Jn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Qa(e[r],a,1);a.polygonEnd()}function Lt(e,a){e&&Kn.hasOwnProperty(e.type)?Kn[e.type](e,a):Na(e,a)}function Ja(e){return[Jt(e[1],e[0]),Xt(e[2])]}function Ot(e){var a=e[0],r=e[1],n=Ae(r);return[n*Ae(a),n*Te(a),Te(r)]}function ca(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Sa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ba(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function pa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Xa(e){var a=zt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Za(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function en(e,a){return Ce(e)>ue&&(e-=Math.round(e/Ke)*Ke),[e,a]}en.invert=en;function Ls(e,a,r){return(e%=Ke)?a||r?Za(Zn(e),er(a,r)):Zn(e):a||r?er(a,r):en}function Xn(e){return function(a,r){return a+=e,Ce(a)>ue&&(a-=Math.round(a/Ke)*Ke),[a,r]}}function Zn(e){var a=Xn(e);return a.invert=Xn(-e),a}function er(e,a){var r=Ae(e),n=Te(e),i=Ae(a),o=Te(a);function l(d,c){var h=Ae(c),s=Ae(d)*h,f=Te(d)*h,p=Te(c),v=p*r+s*n;return[Jt(f*i-v*o,s*r-p*n),Xt(v*i+f*o)]}return l.invert=function(d,c){var h=Ae(c),s=Ae(d)*h,f=Te(d)*h,p=Te(c),v=p*i-f*o;return[Jt(f*i+p*o,s*r+v*n),Xt(v*r-s*n)]},l}function Fs(e,a,r,n,i,o){if(r){var l=Ae(a),d=Te(a),c=n*r;i==null?(i=a+n*Ke,o=a-c/2):(i=tr(l,i),o=tr(l,o),(n>0?i<o:i>o)&&(i+=n*Ke));for(var h,s=i;n>0?s>o:s<o;s-=c)h=Ja([l,-d*Ae(s),-d*Te(s)]),e.point(h[0],h[1])}}function tr(e,a){a=Ot(a),a[0]-=e,Xa(a);var r=qs(-a[1]);return((-a[2]<0?-r:r)+Ke-ke)%Ke}function Wr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ge,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ga(e,a){return Ce(e[0]-a[0])<ke&&Ce(e[1]-a[1])<ke}function ua(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Yr(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(u){if(!((b=u.length-1)<=0)){var b,y=u[0],x=u[b],j;if(ga(y,x)){if(!y[2]&&!x[2]){for(i.lineStart(),d=0;d<b;++d)i.point((y=u[d])[0],y[1]);i.lineEnd();return}x[0]+=2*ke}o.push(j=new ua(y,u,null,!0)),l.push(j.o=new ua(y,null,j,!1)),o.push(j=new ua(x,u,null,!1)),l.push(j.o=new ua(x,null,j,!0))}}),!!o.length){for(l.sort(a),ar(o),ar(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var h=o[0],s,f;;){for(var p=h,v=!0;p.v;)if((p=p.n)===h)return;s=p.z,i.lineStart();do{if(p.v=p.o.v=!0,p.e){if(v)for(d=0,c=s.length;d<c;++d)i.point((f=s[d])[0],f[1]);else n(p.x,p.n.x,1,i);p=p.n}else{if(v)for(s=p.p.z,d=s.length-1;d>=0;--d)i.point((f=s[d])[0],f[1]);else n(p.x,p.p.x,-1,i);p=p.p}p=p.o,s=p.z,v=!v}while(!p.v);i.lineEnd()}}}function ar(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function $a(e){return Ce(e[0])<=ue?e[0]:Ts(e[0])*((Ce(e[0])+ue)%Ke-ue)}function Ms(e,a){var r=$a(a),n=a[1],i=Te(n),o=[Te(r),-Ae(r),0],l=0,d=0,c=new Nt;i===1?n=Ye+ke:i===-1&&(n=-Ye-ke);for(var h=0,s=e.length;h<s;++h)if(p=(f=e[h]).length)for(var f,p,v=f[p-1],u=$a(v),b=v[1]/2+Gn,y=Te(b),x=Ae(b),j=0;j<p;++j,u=w,y=T,x=A,v=S){var S=f[j],w=$a(S),N=S[1]/2+Gn,T=Te(N),A=Ae(N),L=w-u,q=L>=0?1:-1,E=q*L,O=E>ue,I=y*T;if(c.add(Jt(I*q*Te(E),x*A+I*Ae(E))),l+=O?L+q*Ke:L,O^u>=r^w>=r){var F=Sa(Ot(v),Ot(S));Xa(F);var P=Sa(o,F);Xa(P);var g=(O^L>=0?-1:1)*Xt(P[2]);(n>g||n===g&&(F[0]||F[1]))&&(d+=O^L>=0?1:-1)}}return(l<-ke||l<ke&&c<-1e-12)^d&1}function Gr(e,a,r,n){return function(i){var o=a(i),l=Wr(),d=a(l),c=!1,h,s,f,p={point:v,lineStart:b,lineEnd:y,polygonStart:function(){p.point=x,p.lineStart=j,p.lineEnd=S,s=[],h=[]},polygonEnd:function(){p.point=v,p.lineStart=b,p.lineEnd=y,s=Vr(s);var w=Ms(h,n);s.length?(c||(i.polygonStart(),c=!0),Yr(s,Os,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=h=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function v(w,N){e(w,N)&&i.point(w,N)}function u(w,N){o.point(w,N)}function b(){p.point=u,o.lineStart()}function y(){p.point=v,o.lineEnd()}function x(w,N){f.push([w,N]),d.point(w,N)}function j(){d.lineStart(),f=[]}function S(){x(f[0][0],f[0][1]),d.lineEnd();var w=d.clean(),N=l.result(),T,A=N.length,L,q,E;if(f.pop(),h.push(f),f=null,!!A){if(w&1){if(q=N[0],(L=q.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),T=0;T<L;++T)i.point((E=q[T])[0],E[1]);i.lineEnd()}return}A>1&&w&2&&N.push(N.pop().concat(N.shift())),s.push(N.filter(Rs))}}return p}}function Rs(e){return e.length>1}function Os(e,a){return((e=e.x)[0]<0?e[1]-Ye-ke:Ye-e[1])-((a=a.x)[0]<0?a[1]-Ye-ke:Ye-a[1])}const nr=Gr(function(){return!0},Ds,Is,[-ue,-Ye]);function Ds(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?ue:-ue,c=Ce(o-a);Ce(c-ue)<ke?(e.point(a,r=(r+l)/2>0?Ye:-Ye),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=ue&&(Ce(a-n)<ke&&(a-=n*ke),Ce(o-d)<ke&&(o-=d*ke),r=Ps(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ps(e,a,r,n){var i,o,l=Te(e-r);return Ce(l)>ke?As((Te(a)*(o=Ae(n))*Te(r)-Te(n)*(i=Ae(a))*Te(e))/(i*o*l)):(a+n)/2}function Is(e,a,r,n){var i;if(e==null)i=r*Ye,n.point(-ue,i),n.point(0,i),n.point(ue,i),n.point(ue,0),n.point(ue,-i),n.point(0,-i),n.point(-ue,-i),n.point(-ue,0),n.point(-ue,i);else if(Ce(e[0]-a[0])>ke){var o=e[0]<a[0]?ue:-ue;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Bs(e){var a=Ae(e),r=2*_e,n=a>0,i=Ce(a)>ke;function o(s,f,p,v){Fs(v,e,r,p,s,f)}function l(s,f){return Ae(s)*Ae(f)>a}function d(s){var f,p,v,u,b;return{lineStart:function(){u=v=!1,b=1},point:function(y,x){var j=[y,x],S,w=l(y,x),N=n?w?0:h(y,x):w?h(y+(y<0?ue:-ue),x):0;if(!f&&(u=v=w)&&s.lineStart(),w!==v&&(S=c(f,j),(!S||ga(f,S)||ga(j,S))&&(j[2]=1)),w!==v)b=0,w?(s.lineStart(),S=c(j,f),s.point(S[0],S[1])):(S=c(f,j),s.point(S[0],S[1],2),s.lineEnd()),f=S;else if(i&&f&&n^w){var T;!(N&p)&&(T=c(j,f,!0))&&(b=0,n?(s.lineStart(),s.point(T[0][0],T[0][1]),s.point(T[1][0],T[1][1]),s.lineEnd()):(s.point(T[1][0],T[1][1]),s.lineEnd(),s.lineStart(),s.point(T[0][0],T[0][1],3)))}w&&(!f||!ga(f,j))&&s.point(j[0],j[1]),f=j,v=w,p=N},lineEnd:function(){v&&s.lineEnd(),f=null},clean:function(){return b|(u&&v)<<1}}}function c(s,f,p){var v=Ot(s),u=Ot(f),b=[1,0,0],y=Sa(v,u),x=ca(y,y),j=y[0],S=x-j*j;if(!S)return!p&&s;var w=a*x/S,N=-a*j/S,T=Sa(b,y),A=pa(b,w),L=pa(y,N);Ba(A,L);var q=T,E=ca(A,q),O=ca(q,q),I=E*E-O*(ca(A,A)-1);if(!(I<0)){var F=zt(I),P=pa(q,(-E-F)/O);if(Ba(P,A),P=Ja(P),!p)return P;var g=s[0],z=f[0],H=s[1],G=f[1],W;z<g&&(W=g,g=z,z=W);var J=z-g,X=Ce(J-ue)<ke,K=X||J<ke;if(!X&&G<H&&(W=H,H=G,G=W),K?X?H+G>0^P[1]<(Ce(P[0]-g)<ke?H:G):H<=P[1]&&P[1]<=G:J>ue^(g<=P[0]&&P[0]<=z)){var ie=pa(q,(-E+F)/O);return Ba(ie,A),[P,Ja(ie)]}}}function h(s,f){var p=n?e:ue-e,v=0;return s<-p?v|=1:s>p&&(v|=2),f<-p?v|=4:f>p&&(v|=8),v}return Gr(l,d,o,n?[0,-e]:[-ue,e-ue])}function $s(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],h=a[1],s=0,f=1,p=c-l,v=h-d,u;if(u=r-l,!(!p&&u>0)){if(u/=p,p<0){if(u<s)return;u<f&&(f=u)}else if(p>0){if(u>f)return;u>s&&(s=u)}if(u=i-l,!(!p&&u<0)){if(u/=p,p<0){if(u>f)return;u>s&&(s=u)}else if(p>0){if(u<s)return;u<f&&(f=u)}if(u=n-d,!(!v&&u>0)){if(u/=v,v<0){if(u<s)return;u<f&&(f=u)}else if(v>0){if(u>f)return;u>s&&(s=u)}if(u=o-d,!(!v&&u<0)){if(u/=v,v<0){if(u>f)return;u>s&&(s=u)}else if(v>0){if(u<s)return;u<f&&(f=u)}return s>0&&(e[0]=l+s*p,e[1]=d+s*v),f<1&&(a[0]=l+f*p,a[1]=d+f*v),!0}}}}}var Ht=1e9,ma=-Ht;function _s(e,a,r,n){function i(h,s){return e<=h&&h<=r&&a<=s&&s<=n}function o(h,s,f,p){var v=0,u=0;if(h==null||(v=l(h,f))!==(u=l(s,f))||c(h,s)<0^f>0)do p.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+f+4)%4)!==u);else p.point(s[0],s[1])}function l(h,s){return Ce(h[0]-e)<ke?s>0?0:3:Ce(h[0]-r)<ke?s>0?2:1:Ce(h[1]-a)<ke?s>0?1:0:s>0?3:2}function d(h,s){return c(h.x,s.x)}function c(h,s){var f=l(h,1),p=l(s,1);return f!==p?f-p:f===0?s[1]-h[1]:f===1?h[0]-s[0]:f===2?h[1]-s[1]:s[0]-h[0]}return function(h){var s=h,f=Wr(),p,v,u,b,y,x,j,S,w,N,T,A={point:L,lineStart:I,lineEnd:F,polygonStart:E,polygonEnd:O};function L(g,z){i(g,z)&&s.point(g,z)}function q(){for(var g=0,z=0,H=v.length;z<H;++z)for(var G=v[z],W=1,J=G.length,X=G[0],K,ie,ae=X[0],ce=X[1];W<J;++W)K=ae,ie=ce,X=G[W],ae=X[0],ce=X[1],ie<=n?ce>n&&(ae-K)*(n-ie)>(ce-ie)*(e-K)&&++g:ce<=n&&(ae-K)*(n-ie)<(ce-ie)*(e-K)&&--g;return g}function E(){s=f,p=[],v=[],T=!0}function O(){var g=q(),z=T&&g,H=(p=Vr(p)).length;(z||H)&&(h.polygonStart(),z&&(h.lineStart(),o(null,null,1,h),h.lineEnd()),H&&Yr(p,d,g,o,h),h.polygonEnd()),s=h,p=v=u=null}function I(){A.point=P,v&&v.push(u=[]),N=!0,w=!1,j=S=NaN}function F(){p&&(P(b,y),x&&w&&f.rejoin(),p.push(f.result())),A.point=L,w&&s.lineEnd()}function P(g,z){var H=i(g,z);if(v&&u.push([g,z]),N)b=g,y=z,x=H,N=!1,H&&(s.lineStart(),s.point(g,z));else if(H&&w)s.point(g,z);else{var G=[j=Math.max(ma,Math.min(Ht,j)),S=Math.max(ma,Math.min(Ht,S))],W=[g=Math.max(ma,Math.min(Ht,g)),z=Math.max(ma,Math.min(Ht,z))];$s(G,W,e,a,r,n)?(w||(s.lineStart(),s.point(G[0],G[1])),s.point(W[0],W[1]),H||s.lineEnd(),T=!1):H&&(s.lineStart(),s.point(g,z),T=!1)}j=g,S=z,w=H}return A}}const tn=e=>e;var _a=new Nt,an=new Nt,Kr,Qr,nn,rn,dt={point:Ge,lineStart:Ge,lineEnd:Ge,polygonStart:function(){dt.lineStart=Us,dt.lineEnd=Vs},polygonEnd:function(){dt.lineStart=dt.lineEnd=dt.point=Ge,_a.add(Ce(an)),an=new Nt},result:function(){var e=_a/2;return _a=new Nt,e}};function Us(){dt.point=Hs}function Hs(e,a){dt.point=Jr,Kr=nn=e,Qr=rn=a}function Jr(e,a){an.add(rn*e-nn*a),nn=e,rn=a}function Vs(){Jr(Kr,Qr)}var Dt=1/0,Ea=Dt,Zt=-Dt,Ca=Zt,za={point:Ws,lineStart:Ge,lineEnd:Ge,polygonStart:Ge,polygonEnd:Ge,result:function(){var e=[[Dt,Ea],[Zt,Ca]];return Zt=Ca=-(Ea=Dt=1/0),e}};function Ws(e,a){e<Dt&&(Dt=e),e>Zt&&(Zt=e),a<Ea&&(Ea=a),a>Ca&&(Ca=a)}var on=0,sn=0,Vt=0,Aa=0,Ta=0,Ft=0,ln=0,dn=0,Wt=0,Xr,Zr,ot,it,We={point:St,lineStart:rr,lineEnd:or,polygonStart:function(){We.lineStart=Ks,We.lineEnd=Qs},polygonEnd:function(){We.point=St,We.lineStart=rr,We.lineEnd=or},result:function(){var e=Wt?[ln/Wt,dn/Wt]:Ft?[Aa/Ft,Ta/Ft]:Vt?[on/Vt,sn/Vt]:[NaN,NaN];return on=sn=Vt=Aa=Ta=Ft=ln=dn=Wt=0,e}};function St(e,a){on+=e,sn+=a,++Vt}function rr(){We.point=Ys}function Ys(e,a){We.point=Gs,St(ot=e,it=a)}function Gs(e,a){var r=e-ot,n=a-it,i=zt(r*r+n*n);Aa+=i*(ot+e)/2,Ta+=i*(it+a)/2,Ft+=i,St(ot=e,it=a)}function or(){We.point=St}function Ks(){We.point=Js}function Qs(){eo(Xr,Zr)}function Js(e,a){We.point=eo,St(Xr=ot=e,Zr=it=a)}function eo(e,a){var r=e-ot,n=a-it,i=zt(r*r+n*n);Aa+=i*(ot+e)/2,Ta+=i*(it+a)/2,Ft+=i,i=it*e-ot*a,ln+=i*(ot+e),dn+=i*(it+a),Wt+=i*3,St(ot=e,it=a)}function to(e){this._context=e}to.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Ke);break}}},result:Ge};var cn=new Nt,Ua,ao,no,Yt,Gt,ea={point:Ge,lineStart:function(){ea.point=Xs},lineEnd:function(){Ua&&ro(ao,no),ea.point=Ge},polygonStart:function(){Ua=!0},polygonEnd:function(){Ua=null},result:function(){var e=+cn;return cn=new Nt,e}};function Xs(e,a){ea.point=ro,ao=Yt=e,no=Gt=a}function ro(e,a){Yt-=e,Gt-=a,cn.add(zt(Yt*Yt+Gt*Gt)),Yt=e,Gt=a}let ir,qa,sr,lr;class dr{constructor(a){this._append=a==null?oo:Zs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==sr||this._append!==qa){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,sr=n,qa=this._append,lr=this._,this._=i}this._+=lr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function oo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Zs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return oo;if(a!==ir){const r=10**a;ir=a,qa=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return qa}function el(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Lt(d,i(o))),o.result()}return l.area=function(d){return Lt(d,i(dt)),dt.result()},l.measure=function(d){return Lt(d,i(ea)),ea.result()},l.bounds=function(d){return Lt(d,i(za)),za.result()},l.centroid=function(d){return Lt(d,i(We)),We.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,tn):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new dr(r)):new to(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new dr(r)),l},l.projection(e).digits(r).context(a)}function vn(e){return function(a){var r=new pn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function pn(){}pn.prototype={constructor:pn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function yn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Lt(r,e.stream(za)),a(za.result()),n!=null&&e.clipExtent(n),e}function io(e,a,r){return yn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function tl(e,a,r){return io(e,[[0,0],a],r)}function al(e,a,r){return yn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function nl(e,a,r){return yn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var cr=16,rl=Ae(30*_e);function pr(e,a){return+a?il(e,a):ol(e)}function ol(e){return vn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function il(e,a){function r(n,i,o,l,d,c,h,s,f,p,v,u,b,y){var x=h-n,j=s-i,S=x*x+j*j;if(S>4*a&&b--){var w=l+p,N=d+v,T=c+u,A=zt(w*w+N*N+T*T),L=Xt(T/=A),q=Ce(Ce(T)-1)<ke||Ce(o-f)<ke?(o+f)/2:Jt(N,w),E=e(q,L),O=E[0],I=E[1],F=O-n,P=I-i,g=j*F-x*P;(g*g/S>a||Ce((x*F+j*P)/S-.5)>.3||l*p+d*v+c*u<rl)&&(r(n,i,o,l,d,c,O,I,q,w/=A,N/=A,T,b,y),y.point(O,I),r(O,I,q,w,N,T,h,s,f,p,v,u,b,y))}}return function(n){var i,o,l,d,c,h,s,f,p,v,u,b,y={point:x,lineStart:j,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=N},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function x(L,q){L=e(L,q),n.point(L[0],L[1])}function j(){f=NaN,y.point=S,n.lineStart()}function S(L,q){var E=Ot([L,q]),O=e(L,q);r(f,p,s,v,u,b,f=O[0],p=O[1],s=L,v=E[0],u=E[1],b=E[2],cr,n),n.point(f,p)}function w(){y.point=x,n.lineEnd()}function N(){j(),y.point=T,y.lineEnd=A}function T(L,q){S(i=L,q),o=f,l=p,d=v,c=u,h=b,y.point=S}function A(){r(f,p,s,v,u,b,o,l,i,d,c,h,cr,n),y.lineEnd=w,w()}return y}}var sl=vn({point:function(e,a){this.stream.point(e*_e,a*_e)}});function ll(e){return vn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function dl(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function ur(e,a,r,n,i,o){if(!o)return dl(e,a,r,n,i);var l=Ae(o),d=Te(o),c=l*e,h=d*e,s=l/e,f=d/e,p=(d*r-l*a)/e,v=(d*a+l*r)/e;function u(b,y){return b*=n,y*=i,[c*b-h*y+a,r-h*b-c*y]}return u.invert=function(b,y){return[n*(s*b-f*y+p),i*(v-f*b-s*y)]},u}function cl(e){return pl(function(){return e})()}function pl(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,h=0,s,f=0,p=1,v=1,u=null,b=nr,y=null,x,j,S,w=tn,N=.5,T,A,L,q,E;function O(g){return L(g[0]*_e,g[1]*_e)}function I(g){return g=L.invert(g[0],g[1]),g&&[g[0]*lt,g[1]*lt]}O.stream=function(g){return q&&E===g?q:q=sl(ll(s)(b(T(w(E=g)))))},O.preclip=function(g){return arguments.length?(b=g,u=void 0,P()):b},O.postclip=function(g){return arguments.length?(w=g,y=x=j=S=null,P()):w},O.clipAngle=function(g){return arguments.length?(b=+g?Bs(u=g*_e):(u=null,nr),P()):u*lt},O.clipExtent=function(g){return arguments.length?(w=g==null?(y=x=j=S=null,tn):_s(y=+g[0][0],x=+g[0][1],j=+g[1][0],S=+g[1][1]),P()):y==null?null:[[y,x],[j,S]]},O.scale=function(g){return arguments.length?(r=+g,F()):r},O.translate=function(g){return arguments.length?(n=+g[0],i=+g[1],F()):[n,i]},O.center=function(g){return arguments.length?(o=g[0]%360*_e,l=g[1]%360*_e,F()):[o*lt,l*lt]},O.rotate=function(g){return arguments.length?(d=g[0]%360*_e,c=g[1]%360*_e,h=g.length>2?g[2]%360*_e:0,F()):[d*lt,c*lt,h*lt]},O.angle=function(g){return arguments.length?(f=g%360*_e,F()):f*lt},O.reflectX=function(g){return arguments.length?(p=g?-1:1,F()):p<0},O.reflectY=function(g){return arguments.length?(v=g?-1:1,F()):v<0},O.precision=function(g){return arguments.length?(T=pr(A,N=g*g),P()):zt(N)},O.fitExtent=function(g,z){return io(O,g,z)},O.fitSize=function(g,z){return tl(O,g,z)},O.fitWidth=function(g,z){return al(O,g,z)},O.fitHeight=function(g,z){return nl(O,g,z)};function F(){var g=ur(r,0,0,p,v,f).apply(null,a(o,l)),z=ur(r,n-g[0],i-g[1],p,v,f);return s=Ls(d,c,h),A=Za(a,z),L=Za(s,A),T=pr(A,N),P()}function P(){return q=E=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&I,F()}}function so(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}so.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(Ce(i)>ke&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ul(){return cl(so).scale(175.295)}function ml(e){return e}function fl(e){if(e==null)return ml;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var h=2,s=d.length,f=new Array(s);for(f[0]=(a+=d[0])*n+o,f[1]=(r+=d[1])*i+l;h<s;)f[h]=d[h],++h;return f}}function xl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function hl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return mr(e,r)})}:mr(e,a)}function mr(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=gl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function gl(e,a){var r=fl(e.transform),n=e.arcs;function i(s,f){f.length&&f.pop();for(var p=n[s<0?~s:s],v=0,u=p.length;v<u;++v)f.push(r(p[v],v));s<0&&xl(f,u)}function o(s){return r(s)}function l(s){for(var f=[],p=0,v=s.length;p<v;++p)i(s[p],f);return f.length<2&&f.push(f[0]),f}function d(s){for(var f=l(s);f.length<4;)f.push(f[0]);return f}function c(s){return s.map(d)}function h(s){var f=s.type,p;switch(f){case"GeometryCollection":return{type:f,geometries:s.geometries.map(h)};case"Point":p=o(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(o);break;case"LineString":p=l(s.arcs);break;case"MultiLineString":p=s.arcs.map(l);break;case"Polygon":p=c(s.arcs);break;case"MultiPolygon":p=s.arcs.map(c);break;default:return null}return{type:f,coordinates:p}}return h(a)}const lo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},bl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function vl(e,a,r){const n=lo[e];if(!n||!n.length)return-1;const i=bl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let fa=null;function yl(){return fa||(fa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=hl(r,n),o=ul().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=el(o),d=(i.features||[]).filter(s=>{var f;return(((f=s.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(s=>{var v;const f=((v=s.properties)==null?void 0:v.name)||"",p=l(s)||"";return p?{i2:Jo(f)||null,n:f,d:p}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,f]of Object.entries(Xo)){const p=o(f);p&&(c[s]={x:p[0],y:p[1]})}const h={};for(const[s,f]of Object.entries(lo)){const p=f.map(v=>o(v.ll)).filter(v=>!!v).map(([v,u])=>({x:v,y:u}));p.length&&(h[s]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:d,anchors:c,metros:h}}catch{return null}})(),fa)}function wl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return yl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const kl="8 40 984 210",jl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},fr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function xr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Nl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var h;if(!i)return;const c=(h=e.current)==null?void 0:h.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function hr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Sl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:h,dossiers:s,source:f}=U(),p=h.loading&&!s.length,v=m.useRef(null),u=m.useRef(null),b=wl(e.continent==="monde"),y=e.continent==="monde"?b:xn.find(g=>g.key===e.continent)||null,x=Nl(v,e.continent+":"+e.mapFolded+":"+!!y),[j,S]=m.useState(new Map),[w,N]=m.useState(null);m.useEffect(()=>{const g=v.current;if(!g)return;const z=new Map;g.querySelectorAll("path[data-i2]").forEach(H=>{const G=H.dataset.i2;if(G)try{const W=H.getBBox();W.width>0&&z.set(G,{x:W.x,y:W.y,w:W.width,h:W.height})}catch{}}),S(z)},[e.continent,x,y]);const T=m.useMemo(()=>r.filter(g=>g.cc),[r]),A=m.useMemo(()=>{const g=new Map;return T.forEach(z=>g.set(z.cc,(g.get(z.cc)||0)+1)),g},[T]),L=e.continent==="monde"&&b?b.anchors:null,q=e.continent==="monde"&&b?b.metros:null,E=m.useMemo(()=>T.map(g=>{const z=xr(g.name||g.id||""),H=xr((g.id||g.name||"")+"·y");if(L&&g.cc){const K=q?q[g.cc]:void 0;if(K&&K.length){const ae=vl(g.cc,g.city,z);if(ae>=0&&K[ae])return{d:g,x:K[ae].x+(z-.5)*5,y:K[ae].y+(H-.5)*5}}const ie=L[g.cc];if(ie)return{d:g,x:ie.x+(z-.5)*10,y:ie.y+(H-.5)*10}}const G=g.cc?j.get(g.cc):void 0;if(!G)return null;const W=jl[`${e.continent}:${g.cc||""}`];if(W)return{d:g,x:G.x+G.w*(W.fx+(z-.5)*W.sx),y:G.y+G.h*(W.fy+(H-.5)*W.sy)};const J=(z-.5)*Math.min(G.w*.55,60),X=(H-.5)*Math.min(G.h*.55,60);return{d:g,x:G.x+G.w/2+J,y:G.y+G.h/2+X}}).filter(g=>!!g),[T,j,L,q,e.continent]),O=g=>x>0?g/x:g,I=m.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:fr[g],fr:c.plabels[g].toUpperCase(),en:c.plabels[g].toUpperCase(),n:r.filter(z=>z.kind==="target"&&ze(z)===g).length})).filter(g=>g.n>0):Ln.map((g,z)=>({...g,n:r.filter(H=>Fn(H)===z).length})),[r,n,c.plabels]),F=o?l.get(o):null,P=F?E.find(g=>g.d.id===F.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:[p&&t.jsx(hr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:v,viewBox:f==="ops"&&e.continent==="monde"?kl:y.viewBox,preserveAspectRatio:f==="ops"&&e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{N(null),i(null)},children:[t.jsx("g",{children:y.countries.map((g,z)=>t.jsx("g",{className:"ct"+(g.i2&&A.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},z))}),t.jsx("g",{children:E.map(g=>{const z=Ln[Fn(g.d)],H=!!Re(g.d),G=g.d.kind==="target",W=n&&G?fr[ze(g.d)]:z.c,J=!n&&Ie(g.d);return t.jsxs("g",{className:"co"+(J?" done":""),onMouseEnter:()=>{var ie,ae;const X=(ie=u.current)==null?void 0:ie.getBoundingClientRect(),K=(ae=v.current)==null?void 0:ae.createSVGPoint();if(K&&v.current&&X){K.x=g.x,K.y=g.y;const ce=K.matrixTransform(v.current.getScreenCTM());N({x:ce.x-X.left,y:ce.y-X.top,label:g.d.name+" · "+(It(g.d.cc,d)||g.d.countryLabel||"")})}i(g.d.id)},onMouseLeave:()=>{N(null),i(null)},onClick:()=>{var ie;if(f==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const X=(ie=v.current)==null?void 0:ie.createSVGPoint();let K=null;if(X&&v.current){X.x=g.x,X.y=g.y;const ae=X.matrixTransform(v.current.getScreenCTM());K={x:ae.x,y:ae.y}}a({type:"popup",id:g.d.id,anchor:K})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:O(Math.max(11,z.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:O(z.px),fill:W,stroke:H?"#DC2626":"#ffffff",strokeWidth:O(H?2.2:1.3)})]},g.d.id||g.d.name)})}),P&&t.jsx("circle",{className:"ring on",cx:P.x,cy:P.y,r:O(13),fill:"none",stroke:"#0F172A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:I.map((g,z)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),d==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},z))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:t.jsx(hr,{msgs:c.loadMsgs})})}function El(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function co({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=U(),c=a.filters,[h,s]=m.useState(!1),[f,p]=m.useState(!1),v=m.useRef(null),u=m.useRef(null),b=m.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),y=F=>b.filter(P=>F!=="country"&&c.country.length&&!c.country.includes(P.cc||"")?!1:ka(P,c,o,F==="country"?void 0:F)),x=m.useMemo(()=>{const F=y("win"),P=g=>F.filter(z=>(z.date?Math.max(0,Math.floor((Date.now()-Date.parse(z.date))/864e5)):9999)<=g).length;return[P(0),P(7),P(30),F.length]},[b,c,o]),j=m.useMemo(()=>c.day?y("win").filter(F=>(F.date||"").slice(0,10)===c.day).length:0,[b,c,o]),S=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,w=S+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!h&&!f)return;const F=g=>{var H,G;const z=g.target;h&&!((H=v.current)!=null&&H.contains(z))&&s(!1),f&&!((G=u.current)!=null&&G.contains(z))&&p(!1)},P=g=>{g.key==="Escape"&&(s(!1),p(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",P),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",P)}},[h,f]);const N=(F,P,g,z="fbtn")=>t.jsxs("button",{type:"button",className:z,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:P}),g>0&&t.jsx("span",{className:"n",children:g}),t.jsx("span",{className:"cv",children:"▾"})]},F),T=["1","7","30","all"],A=Math.max(0,T.indexOf(c.win||"all")),L=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(El(c.day,d))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:u,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>p(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:i.winMenu}),t.jsx("span",{className:"winpick-v",children:i.datesShort[A]}),t.jsx("b",{children:x[A]}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:T.map((F,P)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),p(!1)},children:[i.datesShort[P],t.jsx("span",{className:"n",children:x[P]})]},F))})]}):t.jsx("div",{className:"seg",children:T.map((F,P)=>t.jsxs("button",{type:"button","aria-pressed":c.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:i.dates[P]}),t.jsx("b",{children:x[P]})]},F))}),q=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),E=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,c.sector.length),N("pay",i.fCountry,c.country.length),N("det",i.fEngine,c.engine.length),N("sta",i.fStage,c.stage.length),o&&N("ang","Angle",c.angle.length),o&&N("mem","Mémo",c.memoLevel.length)]}),O=(F=!1)=>t.jsxs("div",{className:"frow2",children:[w>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(b.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(w)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),I=t.jsxs("div",{className:"fmenu",ref:v,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(S?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{s(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),S>0&&t.jsx("span",{className:"n",children:S}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:E})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[q,I,O(!1)]})]}),a.openFacet&&t.jsx(gr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,q,E,t.jsx("span",{className:"fgrow"}),O()]}),a.openFacet&&t.jsx(gr,{poolFor:y})]})}function gr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=U(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:h}=m.useMemo(()=>{if(l==="sig"){const u=e("signal").filter(x=>Re(x)),b=new Map;u.forEach(x=>{const j=x.engine||"";b.set(j,(b.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:u.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Va([...b.keys()],i).map(x=>({v:x,label:jt(x)+" "+Ue(x,i),n:b.get(x)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const u=e("sector"),b=new Map;return u.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:y,n:x,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const u=e("country"),b=new Map;return u.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:It(y,i)||y,n:x,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const u=e("engine"),b=new Map;return u.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Va([...b.keys()],i).map(y=>({v:y,label:jt(y)+" "+Ue(y,i)+' <span style="color:var(--dim);font-size:10px">· '+Zo(ei(y),i)+"</span>",n:b.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const u=e("angle"),b=new Map;return u.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:y.replace(/[_-]+/g," "),n:x,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const u=e("memoLevel"),b=new Map;u.forEach(x=>{if(x.kind==="target"){const j=mn(x);b.set(j,(b.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:y[x],n:b.get(x)||0,html:!1,on:o.memoLevel.includes(x)}))}}const p=e("stage"),v=new Map;return p.forEach(u=>{u.stage&&v.set(u.stage,(v.get(u.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((u,b)=>b[1]-u[1]).map(([u,b])=>({v:u,label:u,n:b,html:!1,on:o.stage.includes(u)}))}},[l,a,i]),s=p=>{if(l==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const u=o.signalEngines.includes(p)?o.signalEngines.filter(b=>b!==p):[...o.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:u}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:p})},f=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:h.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function po({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=U(),c=m.useMemo(()=>{const v={};return r.forEach(u=>{ka(u,n.filters,o)&&(v.monde=(v.monde||0)+1,u.continent&&(v[u.continent]=(v[u.continent]||0)+1))}),v},[r,n.filters,o]),[h,s]=m.useState(!1),f=m.useRef(null);m.useEffect(()=>{if(!h)return;const v=b=>{var y;(y=f.current)!=null&&y.contains(b.target)||s(!1)},u=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",v),document.addEventListener("keydown",u),()=>{document.removeEventListener("mousedown",v),document.removeEventListener("keydown",u)}},[h]);const p=v=>{const u=xn.find(b=>b.key===v);return v==="monde"?d.contWorld:l==="fr"?u.fr:u.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:f,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>s(v=>!v),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Mn.map(v=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===v,onClick:()=>{i({type:"continent",key:v}),s(!1)},children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Mn.map(v=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===v,onClick:()=>i({type:"continent",key:v}),children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function uo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Cl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function br({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=U();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function mo({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=U(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(br,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(br,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function zl({card:e,onEvaluate:a,onAddAll:r}){var d,c,h;const{t:n}=U(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:uo(e.summary_md||"").map((s,f)=>t.jsx("p",{children:s},f))})]}),t.jsx(mo,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Al(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Tl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=U(),d=i,[c,h]=m.useState(null),[s,f]=m.useState(null),[p,v]=m.useState(null),[u,b]=m.useState(!1);m.useEffect(()=>{let x=!0;return(async()=>{const j=await Tr({email:l,cbToken:d});x&&h(j)})(),()=>{x=!1}},[l,d,n]);const y=x=>{f(x),v(null),b(!0),(async()=>{const j=await ti(x.id);v(j),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),v(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(x=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(x),children:[t.jsx("span",{className:"ti",children:x.title}),t.jsxs("span",{className:"me",children:[Al(x.created_at),x.industry?` · ${x.industry}`:"",x.author?` · ${x.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(x.cited_n||0,x.evaluate_n||0)}),t.jsx("span",{className:"st"+(x.published?" on":""),children:x.published?o.rsPub:o.rsPriv})]},x.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!u&&!p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!u&&p&&t.jsx(zl,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Kt(e){return/^https?:\/\//i.test((e||"").trim())}function nt(e){const a=(e||"").trim();return a?Kt(a)?a:ba.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function ql(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Ll(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:h,data:s,canWrite:f,source:p,dossiers:v,doAnalyse:u,liveMemos:b,pipe:y}=U(),x=a==="client",j=m.useMemo(()=>r||(p!=="default"?ai():""),[r,p]),[S,w]=m.useState(""),[N,T]=m.useState(!1),[A,L]=m.useState(""),[q,E]=m.useState(""),[O,I]=m.useState(""),[F,P]=m.useState(!1),[g,z]=m.useState(!1),[H,G]=m.useState(""),[W,J]=m.useState(!1),[X,K]=m.useState(""),[ie,ae]=m.useState([]),ce=m.useRef(!1),[V,re]=m.useState(!1),[ee,Le]=m.useState(!1),[je,oe]=m.useState(!1),me=m.useRef(!1),[de,Y]=m.useState(""),[Z,he]=m.useState(""),[se,fe]=m.useState(!1),[ge,be]=m.useState(!1),[qe,ve]=m.useState(0),[Fe,et]=m.useState(""),[Ne,He]=m.useState(null),[Me,st]=m.useState(null),[pt,ft]=m.useState(!1),[tt,xt]=m.useState(null),[ht,Qe]=m.useState(0),C=m.useRef(!1),_=S.trim()?ba.test(S.trim())?e.evalUrl:e.evalName:e.evalWaiting,$=m.useMemo(()=>H.split(`
`).map(R=>R.trim()).filter(Boolean).slice(0,15),[H]);m.useEffect(()=>{if(typeof window>"u")return;const R=new URLSearchParams(window.location.search),Q=(R.get("rs")||"").trim(),ne=(R.get("rstext")||"").trim();Q&&/^https?:\/\//i.test(Q)&&Y(Q),ne&&he(ne),(Q&&/^https?:\/\//i.test(Q)||ne)&&re(!0)},[]),m.useEffect(()=>{const R=Q=>{const ne=Q.detail||{},k=String(ne.url||"").trim(),D=String(ne.text||"").trim();k&&/^https?:\/\//i.test(k)&&Y(k),D&&he(D),(k&&/^https?:\/\//i.test(k)||D)&&(re(!0),w(""),L(""),fe(!0),window.setTimeout(()=>fe(!1),900))};return window.addEventListener("ppmap:research",R),()=>window.removeEventListener("ppmap:research",R)},[]),m.useEffect(()=>{const R=Q=>{const ne=Q.detail||{},k=String(ne.name||"").trim();if(!k)return;re(!1),w(k),L(k);const D=nt(String(ne.website||ne.domain||""));E(D),I(nt(String(ne.url||""))),P(!D),T(!0),window.setTimeout(()=>T(!1),900)};return window.addEventListener("ppmap:prefill",R),()=>window.removeEventListener("ppmap:prefill",R)},[]),m.useEffect(()=>{const R=(A||"").trim();if(!R||V||q){(q||!R||V)&&P(!1);return}const Q=v.find(D=>Oe(D.name)===Oe(R)),ne=nt((Q==null?void 0:Q.website)||"")||nt((Q==null?void 0:Q.domain)||"");if(ne){E(ne),P(!1);return}let k=!0;return P(!0),qr(R).then(D=>{var B,te;if(!k)return;const M=nt(D.website||"")||nt(((te=(B=D.candidates)==null?void 0:B[0])==null?void 0:te.url)||"");M&&E(M)}).catch(()=>{}).finally(()=>{k&&P(!1)}),()=>{k=!1}},[A,V,q,v]),m.useEffect(()=>{const R=Q=>{var k;const ne=String(((k=Q.detail)==null?void 0:k.url)||"").trim();Kt(ne)&&window.open(ne,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",R),()=>window.removeEventListener("ppmap:view",R)},[]),m.useEffect(()=>{if(me.current===V)return;me.current=V,oe(!0);const R=window.setTimeout(()=>oe(!1),560);return()=>window.clearTimeout(R)},[V]),m.useEffect(()=>{if(typeof window>"u")return;const R=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),Q=document.querySelector(".atl2.ops, .atl2.cibles");if(!R||!Q)return;const ne=()=>Q.style.setProperty("--demand-h",`${R.offsetHeight}px`);ne();const k=new ResizeObserver(ne);return k.observe(R),()=>k.disconnect()},[p,N,se,g,V,je,F]),m.useEffect(()=>{if(!f&&!j){xt(null);return}let R=!0;return(async()=>{const Q=await Tr({email:n,cbToken:j});R&&xt(Q.length)})(),()=>{R=!1}},[f,j,n,ht]);const pe=ie.length?ie:c,xe=s.credits,le=m.useCallback(R=>{const Q=R.map(ne=>(ne||"").trim()).filter(Boolean);Q.length&&(G(ne=>{const k=ne.split(`
`).map(B=>B.trim()).filter(Boolean),D=new Set(k.map(B=>B.toLowerCase())),M=Q.filter(B=>!D.has(B.toLowerCase()));return[...k,...M].slice(0,15).join(`
`)}),z(!0))},[]);m.useEffect(()=>{if(!ge)return;ve(0);const R=window.setInterval(()=>ve(Q=>Q+1),1e3);return()=>window.clearInterval(R)},[ge]);const ye=m.useMemo(()=>{const R=S.trim().toLowerCase();return!R||!y?null:v.find(Q=>Oe(Q.name)===R&&ze(Q)===1)||null},[S,v,y]),$e=()=>{const R=S.trim();if(R){if(ye){u(ye);return}i(null,R),x&&w("")}},At=async()=>{if(!x){i(null,$[0]||"");return}if(!$.length||W)return;J(!0),ce.current=!1;const R=[];for(let Q=0;Q<$.length&&!ce.current;Q++){K(e.evaluating(Q+1,$.length,$[Q]));const ne=await Lr(r,$[Q],"atelier2");if(R.unshift({name:ne.company||$[Q],verdict:ne.verdict,reason:ne.reason||"",remaining:ne.remaining??null}),ae([...R]),ne.verdict==="quota"){R.unshift({name:"",verdict:"quota",reason:e.quota($.length-Q-1),remaining:0}),ae([...R]),G($.slice(Q+1).join(`
`)),K(""),J(!1);return}}K(""),G(ce.current?$.slice(R.length).join(`
`):""),J(!1)},gt=async()=>{var ne,k,D;if(C.current)return;const R=de.trim().replace(/\s+/g,""),Q=Z.trim();if(!R&&!Q){et(e.rsNeed);return}if(!x&&!j){i(null,R||Q.slice(0,80));return}C.current=!0,et(""),He(null),st(null),be(!0);try{const M=await ri({url:R,text:Q,email:n,cbToken:j});if(be(!1),!M||M.status!=="success"){et((M==null?void 0:M.message)||"Erreur");return}He(M),re(!1),le((((ne=M.prospective)==null?void 0:ne.companies_to_evaluate)||[]).map(te=>(te==null?void 0:te.name)||"")),st({state:"pending"});const B=await oi(M,{email:n,cbToken:j});st(B.ok?{state:"ok",scopeLabel:((k=B.summary)==null?void 0:k.scope_label)||"",scope:((D=B.summary)==null?void 0:D.scope)||""}:{state:"fail",msg:B.error||""}),B.ok&&Qe(te=>te+1)}finally{C.current=!1,be(!1)}},Tt=[Ne==null?void 0:Ne.industry,...(Ne==null?void 0:Ne.market_tags)||[],Ne==null?void 0:Ne.author].map(R=>(R||"").trim()).filter(Boolean),ut=(Me==null?void 0:Me.state)==="pending",qt=Me&&(ut?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Me.state==="ok"?t.jsx("span",{className:"rslink ok",children:Me.scope&&Me.scope!=="public"?e.rsSavedIn(Me.scopeLabel||Me.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Me.msg,children:e.rsSaveFail})),Ve=Cl(Ne).length,Pe=V,bt=(A||S).trim(),Je=v.find(R=>Oe(R.name)===Oe(bt)),$t=nt(S)||q||nt((Je==null?void 0:Je.website)||"")||nt((Je==null?void 0:Je.domain)||""),_t=O||nt((Je==null?void 0:Je.url)||""),ra=ye?e.actAnalyse:bt?e.evalGoOn(bt.length>22?bt.slice(0,21)+"…":bt):e.evalGo,Ma=ge?`${ni(de.trim())==="youtube"&&de.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(qe)}`:ut?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Pe?" rs-mode":"")+(A&&S.trim()===A||N||se?" pair":"")+(N||se||je?" echo":"")+(je?" swap":""),children:[t.jsxs("div",{className:"drow"+((Pe?se:N)||je?" flash":"")+((Pe?de.trim():ba.test(S.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Pe?de:S,placeholder:Pe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Pe?600:200,spellCheck:Pe?!1:void 0,inputMode:Pe?"url":void 0,onChange:R=>{if(Pe){Y(R.target.value);return}w(R.target.value),A&&R.target.value.trim()!==A&&(L(""),E(""),I(""),P(!1))},onKeyDown:R=>{R.key==="Enter"&&(Pe?gt():$e())}}),t.jsx("span",{className:"detect"+(Pe?" off":"")+(ba.test(S.trim())?" url":""),children:_})]}),t.jsx("span",{className:"dacts",children:Pe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ge?" loading":""),disabled:ge||ut||!de.trim()&&!Z.trim(),onClick:()=>{gt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ma})]}),t.jsxs("a",{className:"viewbtn"+(Kt(de)?"":" off"),href:Kt(de)?de.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:R=>{Kt(de)||R.preventDefault()},children:[t.jsx(ql,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ye?" analyse":"")+(d?" loading":""),disabled:d,onClick:$e,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ra})]}),t.jsxs("a",{className:"viewbtn sm"+(F?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:R=>{$t||R.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(_t?"":" off"),href:_t||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:R=>{_t||R.preventDefault()},children:e.viewSrc})]})}),h.showCredits&&xe&&t.jsxs("button",{type:"button",className:"credits"+(xe.total_available<=0&&!xe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:xe.unlimited?"∞":xe.total_available}),!xe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",xe.daily_grant+xe.purchased]}),xe.total_available<=0&&!xe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(R=>R.status==="boot"||R.status==="running").map(R=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:R.name}),t.jsx(Qt,{item:R,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+R.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>z(!g),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(V?" on":""),onClick:()=>re(!V),children:e.rsOpen}),tt!==null&&tt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(pt?" on":""),onClick:()=>ft(!pt),children:e.rsArchOpen(tt)})]}),pt&&t.jsx(Tl,{bump:ht,cbToken:j,onClose:()=>ft(!1),onEvaluate:R=>i(null,R),onAddAll:le}),t.jsx("div",{className:"rsp slim"+(V?" on":" off"),"aria-hidden":!V,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:V?void 0:-1,onClick:()=>Le(R=>!R),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:ee?"▴":"▾"})]}),ee&&t.jsx("textarea",{className:"rstext",value:Z,placeholder:e.rsTextPh,tabIndex:V?void 0:-1,onChange:R=>he(R.target.value)})]})}),Fe&&t.jsx("div",{className:"rserr",children:Fe}),Ne&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Ne.title}),Ne.source_url&&t.jsx("a",{href:Ne.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{He(null),st(null)},children:"×"})]}),Ne.market&&t.jsx("p",{className:"rsmk",children:Ne.market}),Tt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Tt.map(R=>t.jsx("span",{children:R},R))]}),t.jsxs("div",{className:"rsbody",children:[Ne.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Ne.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:uo(Ne.summary_md||"").map((R,Q)=>t.jsx("p",{children:R},Q))})]}),t.jsx(mo,{card:Ne,onEvaluate:R=>i(null,R),onAddAll:le}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Ve)}),qt]})]}),g&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:H,placeholder:e.bulkPh,onChange:R=>G(R.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(W?" loading":""),style:{justifyContent:"center"},disabled:W||!$.length,onClick:()=>{At()},children:[t.jsx("span",{className:"fill"}),W&&X?X:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount($.length)})]})]}),pe.slice(0,1).map((R,Q)=>{const ne=R.verdict==="kept",k=R.verdict==="quota",D=ne?"var(--brand)":k?"var(--bolt)":"var(--red)",M=ne?"var(--brand-l)":k?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":D,"--bgc":M},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ne?"✓ "+e.kept:k?"⏳":"✗ "+e.dropped})}),R.name&&t.jsx("span",{className:"rn",children:R.name}),t.jsx("span",{className:"rr",children:R.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",R.reason]}):null}),!!(R.candidates&&R.candidates.length)&&t.jsx("span",{className:"sitepick",children:R.candidates.map(B=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:B.url.startsWith("http")?B.url:`https://${B.url}`,target:"_blank",rel:"nofollow noopener",children:[(B.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,B.url),children:e.evalPickGo})]},B.url))}),!k&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:ne?1:5});const B=(R.name||"").trim().toLowerCase();window.setTimeout(()=>{const te=[...document.querySelectorAll(".atl2 .list .row")].find(Se=>{var Ee;return(((Ee=Se.querySelector(".rnm"))==null?void 0:Ee.textContent)||"").trim().toLowerCase().includes(B)});te&&(te.scrollIntoView({behavior:"smooth",block:"center"}),te.classList.add("flashrow"),window.setTimeout(()=>te.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ne?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},Q)}),x&&(o.kept+o.dropped>0||pe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Fl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ml(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=U(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",Fl(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const d=mt(o),c=mn(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((h,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Rt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function wn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=U(),[l,d]=m.useState(!1),[c,h]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,f=async()=>{if(!s||l)return;d(!0);const p=await ii(r,e);if(d(!1),!p){o(a.actErr);return}h(p.results||[])};return m.useEffect(()=>{if(!s)return;const p=v=>{var b;const u=String(((b=v.detail)==null?void 0:b.name)||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&f()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,s]),m.useEffect(()=>{if(s)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),f())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{f()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Rl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),xa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Ol(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=xa(a.slice(n));break}r+=xa(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=xa(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Rl.has(c)?r+=`<${d[1]}${c}>`:r+=xa(a.slice(i,o+1)),n=o+1}return r}const vr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function De({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Dl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Pl({o:e}){const{t:a,doDeep:r}=U(),[n,i]=m.useState(!1),o=mt(e),l=[e.reasoning||"",Dl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Rt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function kn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=U(),o=aa(e),l=mt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,h=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:h},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Rt(e)?1:0}].filter(b=>b.n>0),[e,a,d,l,c,h,s]),[p,v]=m.useState("");if(!f.length)return null;const u=f.some(b=>b.k===p)?p:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":u===b.k,"data-tour":"tab-"+b.k,className:u===b.k?"on":"",onClick:y=>{y.stopPropagation(),v(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[u==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(De,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(De,{k:a.cdVerdictDate,v:vr(e.verdictDate,r)})]})]}),u==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Ol(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Il,{o:e})]}),u==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdSector,v:e.sector}),t.jsx(De,{k:a.cdStage,v:e.stage}),t.jsx(De,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(De,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(De,{k:a.cdAngle,v:e.angle}),t.jsx(De,{k:a.cdDetected,v:vr(e.date,r)})]}),u==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdName,v:e.contactName}),t.jsx(De,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),u==="memo"&&t.jsx(Pl,{o:e}),u==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(De,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Il({o:e}){const{t:a,token:r}=U(),[n,i]=m.useState(!1),[o,l]=m.useState(null),d=async()=>{n||(i(!0),l(await si(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},h=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=h.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[h.filter(([,f])=>f).map(([f,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:p})]},f)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function na({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const d=()=>{const h=Math.max(280,Math.min(560,o.clientWidth||320));Rn({kind:"op",card:e},h).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Rn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const d=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Bl=`
...
`;function $l(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let d=e.y+10;return d+n>o-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function _l(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:h,doPromote:s,doRepeche:f,doApproach:p,doDeep:v,doOnboard:u,outbound:b,evalBusy:y}=U(),x=e.popupId?r.get(e.popupId):null;if(!x)return null;const j=Re(x),S=ze(x),w=mt(x),N=aa(x),T=x.kind==="target",A=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Pt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Bl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:$l(e.popupAnchor,!!x.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:x.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ct(x.date)),Ue(x.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[x.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[x.cc]}),children:(It(x.cc,i)||x.countryLabel||"").toUpperCase()}),x.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[x.sector]}),children:x.sector.toUpperCase()}),x.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[x.stage]}),children:x.stage.toUpperCase()}),typeof x.amountEur=="number"&&x.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(x.amountEur,i)})]}),o.pipe&&T&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[S]}),x.ceoStatus&&t.jsx("span",{className:"pstep own",children:x.ceoStatus})]}),(x.tagline||x.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:x.tagline||x.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[jt(x.engine)," ",t.jsx("b",{children:Ue(x.engine,i)})," — ",li(x.engine,i),x.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",x.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ct,{o:x,lg:!0})," ",t.jsx(Fa,{o:x,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Fr(j,i))," · ",n.win7(Mr(j,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),x.card?t.jsx(na,{spec:x.card}):null,x.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&S>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:x.reasoning})]}),o.pipe&&T&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof x.score=="number"&&x.score>0?" · "+n.score(x.score):""]})}),o.pipe&&T&&t.jsx(kn,{o:x})]}),t.jsx(wn,{name:x.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[S===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)]}),S===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),S===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),S===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(x,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(x,!1),a({type:"popup",id:null})},children:n.actNo}),Rt(x)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(x),a({type:"popup",id:null})},children:n.memoDeep})]}),S===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),S===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),x.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:x.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{u(x),a({type:"popup",id:null})},children:"🚀"})]}):x.engine==="media"&&x.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(x.name),onClick:()=>d(x),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)," →"]}),x.website&&t.jsx("a",{className:"psite",href:x.website.startsWith("http")?x.website:"https://"+x.website,target:"_blank",rel:"noopener noreferrer",title:x.website,children:"🌐"})]})]})]}),document.body)}function Ul(){const{lang:e,token:a,dossiers:r,caps:n}=U(),i=a||"home",{names:o,verdicts:l}=m.useMemo(()=>{const c=[],h={};return r.forEach(s=>{s.kind!=="target"||!s.name||(c.push(s.name),h[s.name]=di(s)||"")}),{names:c,verdicts:h}},[r]);return{diff:m.useMemo(()=>o.length?ci(i,o,l,e):null,[i,o.length]),names:o,verdicts:l,scope:i,caps:n}}function Hl(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=U(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const h=p=>{const v=c.current[p],u=v!==void 0?r[p]-v:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Wa[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[r[p],u!==0&&t.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},p)},s=(p,v,u)=>t.jsxs("button",{type:"button",className:"off"+(v?" view":""),style:{"--c":`var(${Wa[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:u.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),f=(p,v,u,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:v,disabled:b,onClick:u,children:p},v);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(h)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Vl(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=U(),d=m.useRef(null),[c,h]=m.useState(60);m.useEffect(()=>{let u=0;const b=()=>{var w;const y=d.current;if(!y)return;const x=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!x)return;const j=x.getBoundingClientRect(),S=y.getBoundingClientRect();h(Math.max(20,Math.min(j.left+j.width/2-S.left,S.width-30)))};return u=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(u),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let f=r.tuto[s].p;if(s===3){const u=n.filter(x=>x.kind==="target"&&ze(x)===3),b=u.filter(x=>Ya(x)==="auto").length,y=u.filter(x=>Ya(x)==="cd").length;f=r.tutoPending(b,y,u.length)}const p=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(u=>u.id)})};if(s===1){const u=n.filter(b=>b.kind==="target"&&ze(b)===1&&!i.has(b.id)).slice(0,10);if(u.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:u.map(b=>b.id)})}}return null})(),v=pi(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(v?"":" on-dark"),style:{"--bg":`var(${Wa[s]})`,"--ax":c+"px","--stc":v?"var(--ink)":"#fff","--stt":v?"#fff":"var(--ink)","--tc":v?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:f}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Ha=600,yt=62,yr="atl2:fstats";function Wl(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=U(),[l,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(yr)==="on"}catch{return!1}}),c=r.stats,h=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const f=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,p=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),v=h.reduce((N,T)=>Math.max(N,T.s||0),0),u=h.length?Ha/h.length:0,b=Math.max(4,u-4),y=h.length>=5&&v>0,x=r.marketEstimate||0,j=f(new Date().toISOString().slice(0,10)),S=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&s&&w.push({cle:"fenetre",periode:e.funPerWindow(f(s),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:S(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([T,A],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(T)}),t.jsx("i",{children:A})]},N.cle+A)),N.cle==="total"&&x>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(x),Math.min(100,Math.round((c.screened||0)/x*100)))})]}),N.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!l;d(T),T&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(yr,T?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},N.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ha} ${yt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((N,T)=>{const A=(N.s||0)/v*(yt-4),L=(N.m||0)/v*(yt-4),q=T*u+(u-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:q,y:yt-2-A,width:b,height:A,fill:"#cfe0d6"}),t.jsx("rect",{x:q,y:yt-2-L,width:b,height:L,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:yt-1.5,x2:Ha,y2:yt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const fo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function jn({o:e,locked:a=!1}){const{t:r}=U(),n=aa(e),i=mt(e),o=ze(e),l=Ya(e),d=mi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(fo[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(ys,{o:e})]})}const Et=e=>e.length>22?e.slice(0,21)+"…":e,va=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function La(e){return va.has(e.engine||"")}function wt(e){return!!e.noCo||La(e)&&!!e.url}function ta(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function xo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Yl({on:e,rev:a}){const[r,n]=m.useState(null),[i,o]=m.useState({top:0,left:0,width:0});return m.useEffect(()=>{if(!e){n(null);return}const l=()=>{var u,b,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const h=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:h.top;o({top:Math.round(s),left:Math.round(h.left),width:Math.round(h.width)});const f=[...d.querySelectorAll(":scope .grp")];let p=null;for(const x of f){const j=x.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=s+2&&(p=x)}if(!p){n(null);return}const v=p.querySelector(".grp-h");if(!v){n(null);return}n({ic:(((u=v.querySelector(".ic"))==null?void 0:u.textContent)||"").trim(),t:(((b=v.querySelector(".t"))==null?void 0:b.textContent)||"").trim(),s:(((y=v.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||i.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:i.top,left:i.left,width:i.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Gl(e){const r=()=>{const n=xo(),i=e.getBoundingClientRect().top-n-8;Math.abs(i)<2||window.scrollBy({top:i,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function wr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=U(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),Ie(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Et(e.name))})]})}function Nn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:h,dispatch:s,liveMemos:f}=U(),p=u=>b=>{b.stopPropagation(),u()};if(r.lockActions){const u=p(()=>s({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const b=ze(e);return b===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Et(e.name))})]})}):b===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:u,children:a.actAnalyse})}):b===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:u,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:u,children:a.actNo})]})}):b===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actPromote})}):b===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:u,children:a.actApproach})}):b===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:u,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return La(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ta(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(wr,{o:e})});const v=ze(e);if(v===0)return t.jsx("span",{className:"cell",children:t.jsx(wr,{o:e})});if(v===1){const u=f.liveOf(e.name);if(u&&(u.status==="boot"||u.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Qt,{item:u,serverOff:f.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:p(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(v===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(v===4){const u=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:u,onClick:p(()=>h(e)),children:u?a.actApproachSent:a.actApproach})})}return v===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):v===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Kl({o:e}){const{t:a,doThumb:r,thumbOf:n}=U(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Ql({o:e}){const{lang:a}=U();return Re(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ct,{o:e}),t.jsx(Fa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[jt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function Jl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:d,caps:c,markRow:h,markedId:s,favIds:f,toggleFav:p,t:v}=U(),u=ze(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,x=y<=0?0:y<=7?1:y<=30?2:3,j=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:b[x],S=f.has(e.id),w=N=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const T=N.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:T.left+Math.min(280,T.width/3),y:T.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>h(e.id),onMouseLeave:()=>h(null),onClick:w,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(yo,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:S?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),p(e)},children:S?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:v.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",Et(e.acquirer)]}),Ze(e)?t.jsx("span",{className:"rdec",title:v.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:v.zoomNewsMark,children:"📰"}):null]}),t.jsx(Xl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Ql,{o:e}),c.pipe&&t.jsx(jn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Nn,{o:e}),c.showThumbs&&t.jsx(Kl,{o:e})]}),r&&!a&&!l&&t.jsx(td,{o:e})]})}function Xl({o:e}){const{lang:a,caps:r}=U();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Zl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=U(),l=(p,v=!1)=>u=>{u.stopPropagation(),v&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})},d=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=Bt(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Ie(e),f=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):wt(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),ta(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Et(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Et(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(na,{spec:e.card})})]})}function ed({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=U();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ue(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Nn,{o:e})}),t.jsx(kn,{o:e})]})}function ho({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:d,dossiers:c}=U(),h=m.useRef(null),s=Ze(e);if(m.useEffect(()=>{if(!s||!(e!=null&&e.decryptHtml))return;const g=h.current;if(!g)return;let z=!1;return zr(()=>import("./fit-BnaWm7z_.js"),[]).then(async H=>{await H.ensureEditoCss(),!(z||!g.isConnected)&&(H.beautifyEditoRows(g),H.mountCardFits(g))}),()=>{z=!0}},[s,e==null?void 0:e.decryptHtml]),!e&&!a){const g=c.find(Ze);if(g)return t.jsx(ho,{o:g})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),v=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),b=e?!!e.noCo:!f||wa(f),y=(e==null?void 0:e.engine)||"",x=Ze(e),j=e?Bt(e.amountEur,n):"",S=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(Ze),T=((N==null?void 0:N.url)||"").trim(),A=!!p&&!!T&&(p===T||p.endsWith(T)||T.endsWith(p)),L=(g,z=!1)=>H=>{H.stopPropagation(),z&&l({type:"continent",key:"monde"}),l({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const q=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},E=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},O=()=>{ta({url:p,headline:v,tagline:e==null?void 0:e.tagline,name:f})},I=e?Ie(e):!1,F=I&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",P=x?r.doEdito.replace(/^📖\s*/,""):y?Ue(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[P,S?` · ${S}`:""]}),t.jsx("h3",{className:"zoom-h",children:v}),p&&!x&&(b||La({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(x?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),j&&t.jsx("span",{className:"oc-amt",children:j})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(na,{spec:u})}),(p&&!A&&!x||N&&!x)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!A&&!x&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),N&&!x&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),l({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[I?t.jsxs("span",{className:"verdict",style:{"--c":F?"var(--brand)":"var(--red)"},children:[F?"✓":"✗"," ",t.jsx("b",{children:F?r.kept:r.dropped})]}):!b&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:g=>{g.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Et(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!x&&(b||La({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!b&&f?" ghost":""),onClick:g=>{g.stopPropagation(),O()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!b&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),E()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),q()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Et(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!b&&f&&d.pipe&&t.jsx(wn,{name:f})]})]})}function td({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=U();return!i.pipe&&e.kind==="op"?t.jsx(Zl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(kn,{o:e}),t.jsx(ws,{o:e}),t.jsx(Ns,{o:e}),t.jsx(wn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(jn,{o:e})})]}),e.card&&t.jsx(na,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[jt(e.engine||"")," ",Ue(e.engine||"",r)]}),Re(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ct,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function ad({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:d,lang:c}=U();if(!l.pipe&&e.kind==="op"){const f=Bt(e.amountEur,c),p=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),v=(u,b=!1)=>y=>{y.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(na,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:v({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:v({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:v({stage:[e.stage]}),children:e.stage}),f&&t.jsx("span",{className:"damt",children:f})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[jt(e.engine||"")," ",Ue(e.engine||"",c)]}),Re(e)&&t.jsx(Ct,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Nn,{o:e})})]})}const h=ze(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(jn,{o:e}),Re(e)&&t.jsx(Ct,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function nd(){const{t:e}=U(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function rd({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=U(),o=i==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,f)=>(e[f]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:o?`${h} ${h>1?"files":"file"} in “${l(c)}”`:`${h} dossier${h>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function od(){var ft,tt,xt,ht,Qe;const e=U(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:d,markRow:c,lang:h,sessTally:s,data:f,dossiers:p,source:v,focusExtra:u,byId:b,token:y}=e,x=Pr(),j=m.useMemo(()=>{var $,pe,xe,le;if(!y||v==="ops")return null;const C=((($=x==null?void 0:x.ed)==null?void 0:$.date)||(x==null?void 0:x.day)||"").slice(0,10),_=[(pe=x==null?void 0:x.ed)==null?void 0:pe.html,(xe=x==null?void 0:x.ed)==null?void 0:xe.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((le=x==null?void 0:x.ed)==null?void 0:le.date)||C,decryptHtml:_||void 0,date:C,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,v,h,(ft=x==null?void 0:x.ed)==null?void 0:ft.html,(tt=x==null?void 0:x.ed)==null?void 0:tt.acquirers_html,(xt=x==null?void 0:x.ed)==null?void 0:xt.date,x==null?void 0:x.day]),S=C=>i.lockRowsAfter!==null||v==="ops"?Number.MAX_SAFE_INTEGER:Or,[w,N]=m.useState(new Set);m.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[T,A]=m.useState(null);m.useEffect(()=>{A(null)},[a.ptab,a.continent]);const[L,q]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){q(!1);return}const C=document.getElementById("atl2-stage");if(!C){q(!1);return}const _=new IntersectionObserver(([$])=>q(!!$&&$.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return _.observe(C),()=>_.disconnect()},[a.mapFolded]);const E=a.mapFolded||!L,O=C=>N(_=>{const $=new Set(_);return $.has(C)?$.delete(C):$.add(C),$}),I=v==="ops"||i.pipe,[F,P]=m.useState("all"),[g,z]=m.useState(null),[H,G]=m.useState(!1),W=m.useRef(!0);m.useEffect(()=>{if(W.current){W.current=!1;return}P("all"),G(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!H)return;const C=_=>{var $,pe;(pe=($=_.target)==null?void 0:$.closest)!=null&&pe.call($,".atl2 .doable")||G(!1)};return document.addEventListener("click",C),()=>document.removeEventListener("click",C)},[H]);const J=m.useMemo(()=>{var _;const C=new Map;for(const $ of ls(((_=x==null?void 0:x.ed)==null?void 0:_.html)||""))C.has($.t)||C.set($.t,$.html);return C},[(ht=x==null?void 0:x.ed)==null?void 0:ht.html]),X=m.useCallback(C=>{if(C.decryptHtml)return C.decryptHtml;if(!J.size)return;const _=(C.name||"").trim().toLowerCase();if(_.length<3)return;const $=J.get(_);if($)return $;for(const[pe,xe]of J)if(pe.includes(_)||_.includes(pe))return xe},[J]),{diff:K}=Ul(),[ie,ae]=m.useState(!1),[ce,V]=m.useState(!1),re=m.useMemo(()=>new Set(((K==null?void 0:K.added)||[]).map(C=>C.trim().toLowerCase()).filter(Boolean)),[K]),ee=m.useMemo(()=>{const C=ce&&re.size?d:l;let _=hn(C,a.sort);return _=_.filter($=>!Ze($)),ce&&re.size&&(_=_.filter($=>re.has(($.name||"").trim().toLowerCase()))),F==="explore"?_=_.filter(wt):F==="eval"&&(_=_.filter($=>!wt($)&&!$.noCo)),_},[l,d,a.sort,F,ce,re]),je=m.useMemo(()=>i.pipe?d.filter(C=>Re(C)&&ui(C)):ee.filter(C=>Re(C)&&!Ie(C)),[i.pipe,d,ee]).length,oe=m.useMemo(()=>i.pipe?ee:ee.filter(C=>!Ie(C)&&!C.noCo),[ee,i.pipe]),me=v==="ops"?ee.filter(wt).length:0,de=ce?n.sinceDock(ee.length):i.pipe?n.plabels[a.ptab].toLowerCase():v==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,Y=a.filters,Z=[];if(Y.day)Z.push({k:"day",lib:n.fDay(Y.day.slice(8,10)+"/"+Y.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(Y.win&&Y.win!=="all"){const C=["1","7","30"].indexOf(Y.win);C>=0&&Z.push({k:"win",lib:n.dates[C],off:()=>r({type:"filters",patch:{win:"all"}})})}const he=C=>C.length<=2?C.join(", "):`${C.length} ${n.fSelected}`;for(const C of["sector","country","engine"]){const _=Y[C];_&&_.length&&Z.push({k:C,lib:he(_),off:()=>r({type:"clearFacet",facet:C})})}Y.search&&Z.push({k:"search",lib:"🔍 "+Y.search,off:()=>r({type:"filters",patch:{search:""}})}),ce&&re.size&&Z.push({k:"since",lib:"✨ "+n.sinceDock(re.size),off:()=>V(!1)}),Y.signalOnly&&Z.push({k:"sig",lib:"🔴 "+n.sigDock(je||Y.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const se=(C,_,$="",pe=!1)=>t.jsxs("button",{type:"button","data-s":C,className:$,"aria-sort":a.sort.key===C?a.sort.dir===1?"ascending":"descending":"none",style:pe?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:C}),children:[_,t.jsx("span",{className:"ar",children:a.sort.key===C&&a.sort.dir===1?"▴":"▾"})]},C),fe=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const C=new Map;ee.forEach(pe=>{const xe=pe.engine||"?";C.has(xe)||C.set(xe,[]),C.get(xe).push(pe)});const _={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},$=Va([...C.keys()],h);return[...C.entries()].sort((pe,xe)=>{const le=_[pe[0]]??10+$.indexOf(pe[0]),ye=_[xe[0]]??10+$.indexOf(xe[0]);return le-ye})},[ee,i.pipe,a.groupBy,h]),ge=fe?fe.filter(([C])=>va.has(C)).length:0,be=(()=>{var _;return((_=(fe?fe.flatMap(([,$])=>$):ee)[0])==null?void 0:_.id)??null})(),qe=m.useRef(!1),ve=m.useMemo(()=>p.find(Ze)||j,[p,j]);m.useEffect(()=>{const C=()=>{qe.current=!0};return window.addEventListener("ppmap:reveal",C),window.addEventListener("ppmap:focus",C),()=>{window.removeEventListener("ppmap:reveal",C),window.removeEventListener("ppmap:focus",C)}},[]),m.useEffect(()=>{const C=()=>{ve&&r({type:"focus",id:ve.id})};return window.addEventListener("ppmap:edito",C),()=>window.removeEventListener("ppmap:edito",C)},[ve,r]),m.useEffect(()=>{if(!a.focusId)return;z(a.focusId);const C=window.setTimeout(()=>z(null),900);return()=>window.clearTimeout(C)},[a.focusId]),m.useEffect(()=>{if(I&&!(a.focusId&&(ee.some(C=>C.id===a.focusId)||p.some(C=>C.id===a.focusId)||a.focusId===(ve==null?void 0:ve.id)))&&!u){if(ve){r({type:"focus",id:ve.id});return}be&&r({type:"focus",id:be})}},[I,a.focusId,ee,be,u,r,p,v,ve]),m.useEffect(()=>{if(!(!I||!a.focusId)&&F!=="all"&&!(ve&&a.focusId===ve.id)&&!ee.some(C=>C.id===a.focusId)&&p.some(C=>C.id===a.focusId)){if(qe.current){P("all");return}be&&r({type:"focus",id:be})}},[I,a.focusId,F,ee,p,be,r]),m.useEffect(()=>{if(!I||!a.focusId||!qe.current)return;const C=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!C)return;qe.current=!1;const _=xo(),$=C.getBoundingClientRect();$.top>=_-2&&$.bottom<=window.innerHeight-4||Gl(C)},[I,a.focusId,a.ptab,ee]),m.useEffect(()=>{if(typeof window>"u")return;const C=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),_=document.querySelector(".atl2.ops, .atl2.cibles");if(!C||!_)return;const $=()=>_.style.setProperty("--listhead-h",`${C.offsetHeight}px`);$();const pe=new ResizeObserver($);return pe.observe(C),()=>pe.disconnect()},[E,a.dens,a.mapFolded]);const Fe=m.useMemo(()=>{if(!I||!a.focusId)return null;if(j&&a.focusId===j.id)return j;const C=ee.find($=>$.id===a.focusId)||p.find($=>$.id===a.focusId)||null;if(!C)return null;const _=X(C);return _&&_!==C.decryptHtml?{...C,decryptHtml:_}:C},[I,a.focusId,ee,p,X,j]),et=i.lockRowsAfter;let Ne=0;const He=(C,_)=>{let $=a.shown[_]||S();return C.length-$<=4&&($=C.length),C.slice(0,$).map(le=>{const ye=et!==null&&Ne>=et;Ne++;const $e=X(le),At=$e&&$e!==le.decryptHtml?{...le,decryptHtml:$e}:le,gt=!I&&a.dens!=="maxi"&&(a.dens==="deplie"||(T?T==="open":!!$e)),Tt=w.has(le.id)?!gt:gt,ut=I?qt=>{qe.current=!0,r({type:"focus",id:qt});const Ve=b.get(qt);Ve&&(wt(Ve)?ta(Ve):Ve.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ve.name,url:Ve.url||"",website:Ve.website||"",domain:Ve.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(ad,{o:At,locked:ye,selected:I&&a.focusId===le.id,onSelect:ut},le.id):t.jsx(Jl,{o:At,locked:ye,open:Tt,onToggle:()=>O(le.id),selected:I&&a.focusId===le.id,echo:g===le.id,onSelect:ut},le.id)})},Me="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(v==="ops"?" opsl":"")+(ee.length?"":" list-empty"),st=t.jsxs(t.Fragment,{children:[fe?fe.map(([C,_])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:jt(C)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:C==="ma"?n.grpMa:C==="fundraising"?n.grpLev:va.has(C)&&ge<=1?n.grpNews:C==="nominations"?n.grpNom:C==="media"?n.grpNewsOther:C==="recrutements"?n.grpHire:va.has(C)?n.grpNews+" · "+Ue(C,h):Ue(C,h)}),t.jsx("div",{className:"s",children:n.grpCount(_.filter($=>!Ie($)).length,_.length)})]})]}),He(_,C)]},C)):He(ee,"pt"+a.ptab),f.loading&&!p.length&&t.jsx(nd,{}),!ee.length&&!(f.loading&&!p.length)&&(i.pipe?t.jsx(rd,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),pt=t.jsxs("div",{className:"listhead"+(E?" mapoff":""),children:[E&&t.jsx("div",{className:"lh-tools",children:t.jsx(co,{compact:!0})}),i.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ie?" on":""),"aria-expanded":ie,onClick:()=>ae(C=>!C),children:["📊 ",n.morningDock(typeof((Qe=f.stats)==null?void 0:Qe.screened_today)=="number"?f.stats.screened_today:0)]}),K&&!K.firstVisit&&(K.added.length>0||K.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ce?" on":""),"aria-pressed":ce,title:n.sinceSub,onClick:()=>V(C=>!C),children:["✨ ",n.sinceDock(K.added.length)]}),je>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[]}}),children:["🔴 ",n.sigDock(je)]})]}),i.showFunnel&&ie&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(Es,{}),t.jsx(Wl,{})]}),i.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Hl,{}),t.jsx(Vl,{})]}),t.jsxs("div",{className:"lh-top",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:ee.length})," ",de]}),t.jsx("span",{className:"dot",children:"·"}),E&&t.jsx(po,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[E?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),Z.map(C=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:_=>{_.stopPropagation(),C.off()},children:[C.lib,t.jsx("i",{children:"×"})]},C.k)),v==="ops"&&ee.length>0&&!E&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ee.length-me," ",n.zoomPulseEval,me>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",me," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(i.showFunnel||v==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([C,_])=>t.jsxs("button",{type:"button","data-d":C,"aria-pressed":a.dens===C||C==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:C}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:_})]},C))}),!I&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":T==="open",onClick:()=>{A("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":T==="closed",onClick:()=>{A("closed"),N(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||v==="ops")&&(()=>{var le;const C=l.filter(ye=>!Ze(ye)),_=C.filter(ye=>!wt(ye)&&!ye.noCo).length,$=C.filter(wt).length,pe=[["all",n.doAll],["eval",`${n.doEval}${_?` ${_}`:""}`],["explore",`${n.doExplore}${$?` ${$}`:""}`]],xe=((le=pe.find(([ye])=>ye===F))==null?void 0:le[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":H,onClick:()=>G(ye=>!ye),children:[xe,t.jsx("i",{children:"▾"})]}),H&&t.jsx("div",{className:"dolist",children:pe.map(([ye,$e])=>t.jsx("button",{type:"button","aria-pressed":F===ye,onClick:()=>{P(ye),G(!1)},children:$e},ye))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:C=>r({type:"sort",key:C.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([C,_])=>t.jsx("option",{value:C,children:_},C))})]}),i.showChain&&oe.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:oe.map(C=>C.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(oe.length):n.chainAll(oe.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!I&&pt,a.dens!=="maxi"&&!I&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),se("country",n.colCountry),se("name",n.colCompany),se("amount",n.colAmount,"h-amt",!0),se("stage",n.colStage,"h-stade"),se("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[se("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),se("memo",n.colMemo)]}),i.pipe&&se("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),I?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[pt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),se("country",n.colCountry),se("name",n.colCompany),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[se("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),se("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Me,children:st})]}),t.jsxs("aside",{className:"readpane"+((Fe?Ze(Fe):!u&&ve)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[ve&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===ve.id,onClick:()=>r({type:"focus",id:ve.id}),children:n.doEdito}),j&&a.focusId===j.id?t.jsx("div",{className:"zoom",children:t.jsx(ps,{})}):Fe&&i.pipe?t.jsx(ed,{o:Fe}):t.jsx(ho,{o:Fe,extra:Fe?null:u})]})]}):t.jsx("div",{className:Me,children:st}),(()=>{const C=fe||[["pt"+a.ptab,ee]];let _=0,$=0;for(const[xe,le]of C){$+=le.length;let ye=a.shown[xe]||S();le.length-ye<=4&&(ye=le.length),_+=Math.min(le.length,ye)}const pe=$-_;return pe<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>C.forEach(([xe,le])=>r({type:"more",group:xe,by:le.length,base:S()})),children:[t.jsx("span",{className:"more-label",children:n.more(pe,pe)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(_,$)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),I&&v==="ops"&&a.dens!=="maxi"&&t.jsx(Yl,{on:!!fe,rev:(fe||[]).map(([C,_])=>C+_.length).join("|")})]})}function kr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function id(e,a){const r=fi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function sd(e,a){const n=[a.head.split("|").map(kr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",id(i,a.plabels),aa(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(kr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ld(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const dd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function rt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function cd({o:e,qa:a}){const{t:r,lang:n,fund:i}=U(),o=(e.cribleStatus||"").trim().toUpperCase()||(aa(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=mt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(rt,{k:r.cdSector,v:e.sector}),t.jsx(rt,{k:r.cdStage,v:e.stage}),t.jsx(rt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(rt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(rt,{k:r.cdName,v:e.contactName}),t.jsx(rt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(rt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(rt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(rt,{k:r.cdAngle,v:e.angle}),t.jsx(rt,{k:r.cdDetected,v:dd(e.date,n)})]}),c.some(([,h])=>h)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,h])=>h).map(([h,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:h}),t.jsx("p",{children:s})]},h))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function pd(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=U(),[d,c]=m.useState({}),h=25,s=m.useMemo(()=>n.slice(0,h),[n]);m.useEffect(()=>{s.length&&xi(r,s.map(v=>v.name)).then(c)},[r,s]);const f=o.stats,p=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>h&&t.jsx("span",{className:"mnote dim",children:e.dsCap(h,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[p(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(f.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(o.marketEstimate)),", ",Math.round(f.screened/o.marketEstimate*100)," %"]})]})]}),s.map(v=>t.jsx(cd,{o:v,qa:d[v.name]},v.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ud=50;function Sn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=U(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[h,s]=m.useState(""),[f,p]=m.useState(0),[v,u]=m.useState(""),[b,y]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>()=>{x.current&&window.clearInterval(x.current)},[]);const j=async w=>{c(!0),s("");const N=await a();if(c(!1),N.ok){l(N);return}if(N.busy){s(i.alertPreviewBusy);return}if(!w){s(i.alertPreviewFail);return}p(ud),x.current=window.setInterval(()=>{p(T=>T>1?T-1:(x.current&&window.clearInterval(x.current),j(!1),0))},1e3)},S=async()=>{if(n||b)return;y(!0),u("");const w=await r();y(!1),u(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||f>0,onClick:()=>{j(!0)},children:d?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{S()},children:b?"…":i.alertTest})]}),f>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(f)}),h&&t.jsx("p",{className:"mnote warn",children:h}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const Mt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Be({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=U();return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function md(){const{st:e}=U();switch(e.modal){case"chain":return t.jsx(xd,{});case"space":return t.jsx(hd,{});case"alert":return t.jsx(gd,{});case"queue":return t.jsx(kd,{});case"export":return t.jsx(jd,{});case"plug":return t.jsx(Ed,{});case"recharge":return t.jsx(zd,{});case"cover":return t.jsx(Td,{});case"dossier":return t.jsx(Ad,{});case"crit":return t.jsx(qd,{});case"tuto":return t.jsx(Ld,{});case"rdv":return t.jsx(fd,{});case"memoalert":return t.jsx(Nd,{});default:return null}}function fd(){const{dispatch:e,fund:a,t:r}=U(),n=a||r.rdvCoFallback;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:$r,children:bn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Ii,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function xd(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:d,caps:c,memoQueued:h,doAnalyse:s}=U(),f=o==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),v=e.chain.idx,u=p[v],b=v>=p.length;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${v+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:v/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!u?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:u.name}),t.jsx("div",{className:"sub",children:[It(u.cc,i)||u.countryLabel,u.sector,u.stage,n.daysAgo(ct(u.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(u.engine,i).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{children:Bt(u.amountEur,i)})]}),Re(u)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ct,{o:u,lg:!0})," ",t.jsx(Fa,{o:u,src:!0})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),f&&Ie(u)&&t.jsxs("div",{className:"vbox",style:{"--c":kt(u)==="retenu"?"var(--brand)":kt(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:kt(u)==="retenu"?"✓ "+n.kept:kt(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&u&&c.pipe&&ze(u)===1&&!h.has(u.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(u),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&u&&!(f&&Ie(u))&&(u.noCo&&u.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(u)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function hd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=U(),o=i==="client",l=m.useMemo(()=>o?r.filter(f=>Ie(f)):[],[r,o]),d=m.useMemo(()=>hn(l.filter(f=>kt(f)==="retenu"),{key:"signal",dir:-1}),[l]),c=m.useMemo(()=>l.filter(f=>kt(f)==="ecarte"),[l]),h=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Be,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function gd(){const{mode:e}=U();return e==="client"||e==="apercu"?t.jsx(bd,{}):t.jsx(wd,{})}function bd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=U(),[o,l]=m.useState("d"),d=i!=="client";return t.jsxs(Be,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(vd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="w"&&t.jsx(yd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="m"&&t.jsx(go,{})]})}function vd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[h,s]=m.useState(0);m.useEffect(()=>{let u=!0;return c(!1),Pn(a).then(b=>{u&&(b?l(b):c(!0))}),()=>{u=!1}},[a,h]);const f=u=>{r||Pn(a,u).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=u=>!o.sections||o.sections.includes(u),v=u=>{const b=o.sections||e.alertSec.map(([y])=>y);f({sections:p(u)?b.filter(y=>y!==u):[...b,u]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([u,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:p(u),disabled:r,onChange:()=>v(u)}),t.jsxs("span",{children:[b,u==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},u))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Sn,{label:e.alertPreview,readOnly:r,onPreview:()=>Si(a),onTest:()=>Ni(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function yd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[h,s]=m.useState(0);m.useEffect(()=>{let u=!0;return c(!1),In(a).then(b=>{u&&(b?l(b):c(!0))}),()=>{u=!1}},[a,h]);const f=u=>{r||In(a,u).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=o.dow??0,v=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:u=>f({dow:Number(u.target.value)}),children:e.alertDow.map((u,b)=>t.jsx("option",{value:b,children:u},u))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,v+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Sn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ci(a),onTest:()=>Ei(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function go(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=U(),[l,d]=m.useState(o||""),[c,h]=m.useState(!1),[s,f]=m.useState(!1);m.useEffect(()=>{o&&d(o)},[o]);const p=e.filters,v=m.useMemo(()=>n.filter(x=>Re(x)).length,[n]),u=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){f(!0);try{await fetch(`${un}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:p.sector,countries:p.country,source:o?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{f(!1)}}},y=[[a.amRows.continent,i],[a.amRows.since,a.amSince[u]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(x=>Ue(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(x=>It(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([x,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:x=>d(x.target.value),onKeyDown:x=>{x.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function wd(){const{t:e}=U();return t.jsx(Be,{title:e.alertTitle,icon:"🔔",children:t.jsx(go,{})})}function kd(){var L,q;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:d,dispatch:c,liveMemos:h}=U(),[s,f]=m.useState(null),[p,v]=m.useState([]),[u,b]=m.useState(0),y=n==="client",x=m.useMemo(()=>{const E=new Map;return i.forEach(O=>{const I=(O.name||"").trim().toLowerCase();I&&!E.has(I)&&E.set(I,O)}),E},[i]);m.useEffect(()=>{let E=!0;return(async()=>{const[O,I]=await Promise.all([fn(r),Ar(a)]);E&&(O&&f(O),v(I))})(),()=>{E=!1}},[a,r,u]);const j=(s==null?void 0:s.per_day)??0,S=((L=s==null?void 0:s.analyzed_today)==null?void 0:L.length)??0,w=s==null?void 0:s.offre,N=(s==null?void 0:s.pool_meta)||[],T=m.useMemo(()=>{const E=new Map;for(const O of(s==null?void 0:s.scheduled)||[])for(const I of O.names||[])E.has(I)||E.set(I,{label:O.day_label,date:O.date});return E},[s==null?void 0:s.scheduled]),A=(s==null?void 0:s.in_progress)||[];return t.jsxs(Be,{title:e.queueTitle,wide:!0,children:[w&&t.jsxs("div",{className:"qoffre"+(w.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:w.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:w.delai})]}),t.jsx("span",{className:"osp"}),w.rythme>0?t.jsx("span",{className:"or",children:e.qRate(w.rythme)}):w.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(w.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(S,S+(((q=s==null?void 0:s.pool_order)==null?void 0:q.length)??0))}})}),w&&t.jsxs("div",{className:"qeta",children:[w.file===0?e.qEtaDone:w.rythme<=0?e.qEtaPaused:e.qEta(w.file,w.rythme,w.jours_restants),w.en_retard&&t.jsxs("em",{children:[" ",e.qLate(w.delai,w.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(w==null?void 0:w.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(A.length>0||h.items.some(E=>E.status==="boot"||E.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(E=>E.status==="boot"||E.status==="running"||E.status==="error").map(E=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:E.name}),t.jsx("span",{className:"qd",children:E.memoType||""}),t.jsx(Qt,{item:E,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+E.name)),A.filter(E=>!h.liveOf(E.name)).map(E=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:E.name}),t.jsxs("span",{className:"qd",children:[E.memo_type||"",E.age_min?` · ${Math.round(E.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:E.state||""})]},"ip-"+E.name))]})]}),p.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:p.map(E=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:E.company}),t.jsxs("span",{className:"qd",children:[E.memo_type,typeof E.est_min=="number"?` · ~${E.est_min} min`:""]}),t.jsx("span",{className:"qt",children:E.status}),E.url&&t.jsx("a",{className:"qgo",href:E.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),y&&E.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Dn(a,E.company,"retry").then(()=>b(O=>O+1))},children:e.queueRetry}),y&&E.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Dn(a,E.company,"delete").then(()=>b(O=>O+1))},children:e.queueDelete})]},E.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(N.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[N.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),N.map((E,O)=>{const I=T.get(E.name),F=x.get((E.name||"").trim().toLowerCase()),P=h.liveOf(E.name),g=!!(F&&l.has(F.id))||!!(P&&(P.status==="boot"||P.status==="running")),z=!!(F&&ze(F)===1&&!F.memoUrl)&&!P;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",O+1]}),I?t.jsx("span",{className:"qwhen"+(I.label==="demain"?" soon":""),children:I.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:E.name}),E.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof E.score=="number"&&t.jsx("span",{className:"qs2",children:E.score}),P&&(P.status==="boot"||P.status==="running")&&t.jsx(Qt,{item:P,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),z&&(d.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:g,onClick:()=>{o(F),b(H=>H+1)},children:g?e.actAnalyseQueued:e.actAnalyse})),E.excerpt&&t.jsx("span",{className:"qex",children:E.excerpt})]},E.name+":"+O)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([E,O])=>t.jsxs("li",{children:[t.jsx("b",{children:E})," — ",O]},E))})]})}function jd(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=U(),d=`${Mt}/cibles/list.csv?token=${a}`,c=`${Mt}/cibles/list.json?token=${a}`,h=`${Mt}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,f=y=>{var x;(x=navigator.clipboard)==null||x.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:h,href:h}],v=!i.lockActions&&n.length>0,u=()=>{ld(sd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:y=>(e.stg.find(([x])=>x===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Be,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:u,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:x,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(x),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Nd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=U(),o=i!=="client",[l,d]=m.useState(null),[c,h]=m.useState(!1),[s,f]=m.useState(0),[p,v]=m.useState(!1);m.useEffect(()=>{let x=!0;return h(!1),On(a).then(j=>{x&&(j?d(j):h(!0))}),()=>{x=!1}},[a,s]);const u=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=x=>{if(o||!l)return;const j={enabled:x.enabled??!!l.enabled,email:x.email??(l.email||""),sections:x.sections??u()};v(!0),On(a,j).then(S=>{if(v(!1),!S){n(e.memoAlertErr);return}d(S),r(e.memoAlertSaved)})};if(c)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(x=>x+1),children:e.retry})]})});if(!l)return t.jsx(Be,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=u();return t.jsxs(Be,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||p,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Sd,{value:l.email||"",readOnly:o||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>b({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[x],disabled:o||p,onChange:()=>b({sections:{...y,[x]:!y[x]}})}),t.jsx("span",{children:j})]},x))}),t.jsx(Sn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>gi(a,y),onTest:()=>hi(a,y)})]})}function Sd({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const d=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:h=>l(h.target.value),onKeyDown:h=>{h.key==="Enter"&&d&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:n})]})]})}function Ed(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=U(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[h,s]=m.useState(null),[f,p]=m.useState(""),[v,u]=m.useState(0);m.useEffect(()=>{let S=!0;return c(!1),Ga(a).then(w=>{S&&(w?l({configured:w.configured,url_hint:w.url_hint}):c(!0))}),yi(a).then(w=>{S&&s(w)}),()=>{S=!1}},[a,v]);const b=(S,w)=>{i&&Ga(a,S).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}S.test&&N.sent===!1?n(e.plugTestThrottled):r(w),u(T=>T+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',x=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${Mt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Be,{title:e.plugTitle,icon:"🔌",wide:!0,children:[h&&t.jsx("p",{className:"mnote"+(h.enabled?" warn":""),children:h.enabled?e.plugAutoOn(h.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>u(S=>S+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!i,onChange:S=>p(S.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!f.trim(),onClick:()=>b({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:x}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(x).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Cd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Cd(){const{t:e,token:a,lang:r}=U(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[d,c]=m.useState(null),[h,s]=m.useState(null),[f,p]=m.useState(!1),[v,u]=m.useState(!1),[b,y]=m.useState(null),[x,j]=m.useState(null),[S,w]=m.useState(null),N=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Ga(a).then(I=>{j(I&&I.configured?I.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),s(null),p(!1),y(null);try{const I=JSON.parse(localStorage.getItem(N)||"null");w(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{w(null)}},[N]);const T=async()=>{l(!0),p(!1),y(null);const I=await ki(a,n);c(I),s(I.ok?n:null),l(!1)},A=m.useRef(!1),L=async()=>{if(A.current)return;A.current=!0,u(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let F;try{F=await ji(a,n,"webhook",void 0,I)}finally{A.current=!1}if(u(!1),p(!1),y(F),F.ok&&(F.pushed||0)>0){const P={t:new Date().toISOString(),n:F.pushed||0};w(P);try{localStorage.setItem(N,JSON.stringify(P))}catch{}}},q=d!=null&&d.ok&&d.ready||0,E=!!(d!=null&&d.ok)&&h===n&&q>0&&!!x&&!S,O=S?new Date(S.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>i(I.target.value),children:e.plugBulkTabs.map(([I,F])=>t.jsx("option",{value:I,children:F},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),S&&t.jsx("p",{className:"mnote",children:e.bulkLocked(O,S.n)}),!S&&!!(d!=null&&d.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!S&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),E&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),E&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(q,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{L()},children:v?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>p(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function zd(){const{t:e,data:a,lang:r}=U(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const h=await(await fetch(`${un}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Be,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ad(){const{t:e}=U();return t.jsx(Be,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(pd,{})})}function Td(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:d}=U(),[c,h]=m.useState(null),[s,f]=m.useState(!1);m.useEffect(()=>{let q=!0;if(o)return fn(o).then(E=>{q&&E&&typeof E.per_day=="number"&&h(E.per_day)}),()=>{q=!1}},[o]);const[p,v]=m.useState(null);m.useEffect(()=>{if(!i)return;let q=!0;return vi(i).then(E=>{q&&v(E)}),()=>{q=!1}},[i]);const u=r.stats,b=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(q=>q.kind==="target"&&Ie(q)).length,y=r.marketEstimate||0,x=y>0?Math.min(100,Math.round(b/y*100)):null,j=(u==null?void 0:u.window_days)||30,S=b>0?b/j:0,w=y>0?Math.max(0,y-b):0,T=y>0&&S>0&&b>=100?Math.round(w/S):null,A=q=>Math.round(q).toLocaleString(a==="en"?"en-US":"fr-FR"),L=q=>{s||!l||(f(!0),wi(i,q).then(E=>{if(f(!1),E===null){d(e.actErr);return}h(E),d(e.alertSaved)}))};return t.jsxs(Be,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(A(b))}),y>0&&t.jsx("span",{children:e.covOf(A(y))})]}),x!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:x+"%"}}),t.jsxs("em",{children:[x," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),S>=1&&t.jsx("p",{className:"mnote",children:e.covPace(A(S))}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&u.shown!==u.kept&&t.jsxs("span",{children:[t.jsx("b",{children:A(u.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((q,E)=>t.jsxs("tr",{className:q.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[q.code,q.geo?` · ${q.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof q.n=="number"?A(q.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:q.source}),q.elargi&&t.jsx("em",{children:e.covWide(String(q.demande||""))}),q.erreur&&t.jsx("em",{children:e.covMissing})]})]},E)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:A(p.total||y)})}),t.jsx("td",{className:"cs"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(q=>t.jsx("button",{type:"button",className:c===q?"on":"",disabled:s,onClick:()=>L(q),children:q===0?"⏸":q},q))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function qd(){var x,j,S;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:d}=U(),c=n==="client",h=m.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[s,f]=m.useState(""),[p,v]=m.useState(""),[u,b]=m.useState(!1),y=async()=>{const w=s.trim();if(!(!w||u||!c)){b(!0),v("");try{const T=await(await fetch(`${Mt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&v(String(T.reply)),T.job_id){v(e.critChatRunning);const A=async()=>{const L=await fetch(`${Mt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(q=>q.json()).catch(()=>null);if(L&&L.done){v(String(L.reply||L.clarification||L.summary||"✓")),b(!1),L.applied&&i(e.alertSaved);return}setTimeout(()=>{A()},8e3)};setTimeout(()=>{A()},8e3),f("");return}f("")}finally{p.startsWith("⏳")||b(!1)}}};return t.jsxs(Be,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((x=o.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=o==null?void 0:o.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var N,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(A=>t.jsx("li",{children:A},A))})]}),!!((T=w.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(A=>t.jsx("li",{children:A},A))})]})]})]},w.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||u,onChange:w=>f(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},disabled:!c||u||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(bi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(fo[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ld(){const{t:e,dispatch:a,startTour:r}=U(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Be,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const bo="atl2:mapfold",Fd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(bo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Md=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},vo=m.createContext(null),U=()=>{const e=m.useContext(vo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ct({o:e,lg:a}){const{lang:r}=U(),n=Re(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Bn(n,r),children:[n.emoji," ",Bn(n,r)]}):null}function Fa({o:e,src:a}){const{lang:r,t:n}=U(),i=Re(e);if(!i)return null;const o=Fi(i),l=Mi(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Fr(i,r))+" · "+n.win7(Mr(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Rd(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Oe(a);if(i)return e.find(o=>Oe(o.name)===i)||e.find(o=>{const l=Oe(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function Od(){const{scoped:e,t:a,st:r,dispatch:n}=U(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(f=>!Ze(f)),d=l.length,c=l.filter(f=>!f.noCo).length,h=l.filter(f=>!!f.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const f=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:f,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function yo({o:e}){const{lang:a}=U(),r=Li(e.cc),n=e.cc?It(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const jr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Dd=!1;function Pd(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const wo=e=>`atl2:tour:${e||"anon"}`;function Id(e){try{return localStorage.getItem(wo(e))==="1"}catch{return!0}}function Nr(e){try{localStorage.setItem(wo(e),"1")}catch{}}function Bd(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Vd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var ne;const{lang:l}=zi(),d=Wi[l],c=ns(e,l,a),[h,s]=m.useReducer(is,void 0,()=>rs((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Md():Fd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),f=m.useRef(!0);m.useEffect(()=>{if(f.current){f.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(bo,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),m.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const k=()=>{window.innerWidth<=760&&s({type:"mapFold",folded:!0})};return k(),window.addEventListener("resize",k),()=>window.removeEventListener("resize",k)},[a]);const p=m.useRef(o);p.current=o,m.useEffect(()=>{var k;(k=p.current)==null||k.call(p,h.filters)},[h.filters]);const[v,u]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:chrome-min")==="1"}catch{return!1}}),[b,y]=m.useState(null),[x,j]=m.useState(null),[S,w]=m.useState(null),[N,T]=m.useState({kept:0,dropped:0}),[A,L]=m.useState(!1),[q,E]=m.useState(""),[O,I]=m.useState(!1),[F,P]=m.useState(null),[g,z]=m.useState(!1),[H,G]=m.useState(!1),[,W]=m.useState(0),J=()=>W(k=>k+1),X=m.useRef([]),K=m.useRef(new Set),ie=m.useRef(new Set),[ae,ce]=m.useState([]),[V,re]=m.useState([]),[ee,Le]=m.useState(0),je=m.useRef(new Map),oe=m.useRef(null),{mode:me}=c,de=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),Y=de.pipe,Z=c.session.token||"",he=me==="client"&&!e;m.useEffect(()=>{if(!Z||!Y)return;let k=!0;const D=async()=>{const te=await Ri(Z);!k||!te||(re(te.runs),Le(Date.now()/1e3-te.now),ce(Se=>Se.filter(Ee=>!te.runs.some(Xe=>Oe(Xe.company)===Oe(Ee.name)))))};D();const M=ae.length>0||V.some(te=>te.status==="running"),B=window.setInterval(()=>{D()},M?8e3:25e3);return()=>{k=!1,window.clearInterval(B)}},[Z,Y,ae.length,V.some(k=>k.status==="running")]);const se=m.useMemo(()=>{const k=[],D=new Set;for(const M of ae){const B=Oe(M.name);!B||D.has(B)||(D.add(B),k.push({name:M.name,id:M.id,status:"boot",started:M.started,estMin:M.estMin,memoType:"instant"}))}for(const M of V){const B=Oe(M.company);if(!B||D.has(B))continue;D.add(B);const te=M.status==="error"?"error":M.status==="done"?"done":"running";k.push({name:M.company,status:te,started:M.started||0,estMin:M.est_min||(M.memo_type==="detailed"?40:15),url:M.url,error:M.error,memoType:M.memo_type})}return k},[ae,V]),fe=k=>se.find(D=>Oe(D.name)===Oe(k))||null,ge=(k,D)=>{ce(M=>M.some(B=>Oe(B.name)===Oe(k.name))?M:[...M,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:D==="detailed"?40:15}]),K.current.add(k.id),J()};m.useEffect(()=>{if(document.querySelector(`link[href="${jr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=jr,document.head.appendChild(k)},[]);const be=(k,D=!1)=>{E(k),I(D),oe.current&&clearTimeout(oe.current),oe.current=setTimeout(()=>E(""),D?4200:2400)},qe=k=>be(k,!0),ve=m.useMemo(()=>{const k=new Map;return c.dossiers.forEach(D=>{D.id&&k.set(D.id,D)}),k},[c.dossiers]),Fe=m.useMemo(()=>c.dossiers.filter(k=>Dr(k,h,Y)),[c.dossiers,h,Y]),et=m.useRef(!1);m.useEffect(()=>{if(et.current||e||c.loading||!c.dossiers.length)return;if(!de.showFunnel||Id(c.session.token||"")){et.current=!0;return}et.current=!0;const k=window.setTimeout(()=>{Nr(c.session.token||""),z(!0)},700);return()=>window.clearTimeout(k)},[e,c.loading,c.dossiers.length,de.showFunnel,c.session.token]);const Ne=m.useMemo(()=>c.dossiers.filter(k=>ss(k,h,Y,c.favIds)),[c.dossiers,h,Y,c.favIds]),He=m.useMemo(()=>Ai(Fe,c.favIds),[Fe,c.favIds]),Me=m.useRef(!1);m.useEffect(()=>{if(Me.current)return;if(!Y||a==="ops"){Me.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Me.current=!0;return}if(c.loading)return;Me.current=!0;const k=Ti(He);k!==h.ptab&&s({type:"ptab",tab:k})},[Y,a,n==null?void 0:n.ptab,c.loading,He,h.ptab]);const st=m.useMemo(()=>{const k=Ur(c.dossiers);return k?ct(k)===0?d.tourToday:Hr(k,l):d.tourNoRun},[c.dossiers,d,l]),pt=m.useMemo(()=>c.dossiers.some(k=>!!k.memoUrl||!!k.summary||Rt(k)),[c.dossiers]),[ft,tt]=m.useState(!1);m.useEffect(()=>{if(c.loading){tt(!1);return}if(c.dossiers.length>0||c.error){tt(!0);return}const k=window.setTimeout(()=>tt(!0),6e3);return()=>window.clearTimeout(k)},[c.loading,c.dossiers.length,c.error]);const xt=(c.marketEstimate||0)>0||typeof((ne=c.stats)==null?void 0:ne.screened)=="number"&&c.stats.screened>0,ht=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(He[k]||0)>0)??0,[He]),Qe=xn.find(k=>k.key===h.continent),C=h.continent==="monde"?d.contWorld:(l==="fr"?Qe==null?void 0:Qe.fr:Qe==null?void 0:Qe.en)||"";m.useEffect(()=>{const k=D=>{var B;const M=(((B=D.detail)==null?void 0:B.name)||"").trim();M&&_(null,M)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{const k=D=>{const M=D.detail||{},B=String(M.id||"").trim(),te=String(M.name||"").trim(),Se=String(M.url||"").trim(),Ee=B&&ve.get(B)||Rd(c.dossiers,te,Se);if(Ee){if(j(null),Y){const we=ze(Ee);typeof we=="number"&&we!==h.ptab&&s({type:"ptab",tab:we})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Ee.id}),(Ee.noCo||["media","nominations","recrutements"].includes(Ee.engine||""))&&(Ee.url||Ee.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee.url||"",text:[Ee.headline,Ee.tagline].filter(Boolean).join(`
`)}})):Ee.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ee.name,url:Ee.url||"",website:Ee.website||"",domain:Ee.domain||""}}));return}!te&&!Se||(s({type:"focus",id:B||null}),j({name:te,headline:String(M.text||"").trim()||te,url:Se,card:M.card}),Se&&(wa(te)||!te)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Se,text:String(M.text||"").trim()}})):te&&!wa(te)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:te}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=B=>{const te={},Se=String((B==null?void 0:B.sector)||"").trim();Se&&(te.sector=[Se]);const Ee=String((B==null?void 0:B.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ee)&&(te.day=Ee);const Xe=String((B==null?void 0:B.search)||"").trim();Xe&&(te.search=Xe);const we=String((B==null?void 0:B.dealKind)||"").trim();(we==="ma"||we==="levee"||we==="other")&&(te.dealKind=[we]),Object.keys(te).length&&s({type:"filters",patch:te})},D=B=>k(B.detail),M=B=>{B.data&&B.data.type==="pp-filter"&&k(B.data)};return window.addEventListener("ppmap:filter",D),window.addEventListener("message",M),()=>{window.removeEventListener("ppmap:filter",D),window.removeEventListener("message",M)}},[]),m.useEffect(()=>{const k=D=>{var te;const M=(((te=D.detail)==null?void 0:te.name)||"").trim().toLowerCase();if(!M)return;const B=c.dossiers.find(Se=>(Se.name||"").trim().toLowerCase()===M);B&&s(a==="ops"?{type:"focus",id:B.id}:{type:"popup",id:B.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const _=(k,D)=>{const M=((k==null?void 0:k.name)||D||"").trim();if(!he){w({kicker:M});return}!M||A||(L(!0),(async()=>{try{let B=M;const te=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(te)B=te;else try{const we=await qr(M);if(we!=null&&we.website)B=we.website;else if(((we==null?void 0:we.candidates)||[]).length===1)B=we.candidates[0].url;else if(((we==null?void 0:we.candidates)||[]).length>1){X.current=[{name:M,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(we.candidates||[]).slice(0,5)},...X.current].slice(0,8),J();return}}catch{}const Se=await Lr(Z,B,"atelier2"),Ee={name:Se.company||M,verdict:Se.verdict,reason:Se.reason||"",remaining:Se.remaining??null};X.current=[Ee,...X.current].slice(0,8),Se.verdict==="kept"&&T(we=>({...we,kept:we.kept+1})),Se.verdict==="ruled_out"&&T(we=>({...we,dropped:we.dropped+1}));const Xe=k||c.dossiers.find(we=>(we.name||"").toLowerCase()===M.toLowerCase());Xe&&(Se.verdict==="kept"?Xe.verdict=Xe.verdict||"MATCH":Se.verdict==="ruled_out"&&(Xe.verdict="NO MATCH"),Se.reason&&(Xe.reasoning=Se.reason)),J()}finally{L(!1)}})())},$=k=>{if(!he){w({kicker:k.name});return}ge(k,"instant"),Ut(Z,"fast_request",k.name||"",""),be(d.memoInstantSent(k.name))},pe=k=>je.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),xe=(k,D)=>s({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:D}}),le=async(k,D,M)=>{const B=k.ceoStatus||"";k.ceoStatus=D,J();const te=await Oa(Z,{status:D,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(M==null?void 0:M.note)!==void 0?{note:M.note}:{},...M!=null&&M.via?{via:M.via}:{}});return te.ok?te.skipped?(k.ceoStatus=B,J(),qe(d.actNotPersisted),!1):((M==null?void 0:M.undo)!==!1&&xe(k,B),M!=null&&M.msg&&be(M.msg),(D==="Validé"||D==="Écarté")&&!k.ceoNote&&(M==null?void 0:M.note)===void 0&&P({o:k,yes:D==="Validé"}),!0):(k.ceoStatus=B,J(),qe(d.actErr),!1)},ye=async(k,D)=>{const M=await Oa(Z,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:D,via:"note"});return!M.ok||M.skipped?(qe(M.skipped?d.actNotPersisted:d.actErr),!1):(k.ceoNote=D,J(),!0)},$e=m.useRef(new Map),At=k=>$e.current.has(k.id)?$e.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),gt=(k,D)=>{$e.current.set(k.id,D),J()},Tt=(k,D)=>{he&&le(k,D?"Validé":"Écarté",{msg:D?d.decidedYes(k.name):d.decidedNo(k.name)})},ut=k=>{he&&le(k,"À trancher",{msg:d.promoted(k.name)})},qt=k=>{he&&(async()=>{const D=k.ceoStatus||"";k.ceoStatus="Retenu",J();const M=await Oa(Z,{status:"Retenu",check_id:k.checkId,company:k.name});if(!M.ok||M.skipped){k.ceoStatus=D,J(),qe(M.skipped?d.actNotPersisted:d.actErr);return}xe(k,D),be(d.repeched(k.name))})()},Ve=()=>{const k=h.undo[h.undo.length-1];if(!k){be(d.undoNone);return}const D=ve.get(k.id);if(!D){s({type:"undoPop"}),be(d.undoNone);return}let M=k.prevCeoStatus;if(!M)if((D.verdict||"").toUpperCase().includes("CALL"))M="À trancher";else{be(d.undoLockedTitle);return}(async()=>await le(D,M,{undo:!1})&&(s({type:"undoPop"}),D.ceoStatus=k.prevCeoStatus,J(),be(d.undoDone(D.name))))()},Pe=k=>{he&&(ie.current.add(k.id),J(),(async()=>{const D=await Oi(Z,k.name,"email");if(!D||D.ok===!1){ie.current.delete(k.id),J(),qe(d.actErr);return}Ut(Z,"approach",k.name||"",""),be(d.actApproachSent)})())},bt=(k,D)=>{he&&(async()=>{if(!(await Ut(Z,D?"yes":"no",k.name||"","")).ok){qe(d.actErr);return}je.current.set(k.id,D?"yes":"no"),J(),be(D?d.thumbUpDone:d.thumbDnDone)})()},Je=k=>{!he||!Rt(k)||(ge(k,"detailed"),Ut(Z,"detailed_request",k.name||"",""),be(d.memoDeepSent(k.name)))},$t=k=>{const D=new Set(c.favIds),M=D.has(k.id);M?D.delete(k.id):D.add(k.id),c.setFavIds(D),he&&Di(Z,{id:k.id,co:k.name},M)},_t=()=>{!he||H||window.confirm(d.identSyncConfirm)&&(G(!0),(async()=>{const k=await Pi(Z);G(!1),k?be(d.identSyncDone):qe(d.actErr)})())},ra=/proplace/i.test(c.fund||""),Ma=k=>{!he||!ra||(Ut(Z,"onboard_request",k.name||"",""),be(d.onboardSent(k.name)))},R={st:h,dispatch:s,t:d,lang:l,mode:me,caps:de,pipe:Y,token:Z,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:qt,thumbOf:pe,canWrite:he,commitStatus:le,saveNote:ye,stageOf:At,setStage:gt,flashErr:qe,startTour:()=>z(!0),dossiers:c.dossiers,scopedAll:Fe,scoped:Ne,counts:He,byId:ve,contName:C,favIds:c.favIds,toggleFav:$t,askEvaluate:_,doAnalyse:$,doDecide:Tt,doPromote:ut,doApproach:Pe,doThumb:bt,doDeep:Je,doUndo:Ve,doSync:_t,doOnboard:Ma,outbound:ra,memoQueued:K.current,liveMemos:{items:se,serverOff:ee,liveOf:fe},approachDone:ie.current,sessTally:N,evalCards:X.current,evalBusy:A,markRow:y,markedId:b,flash:be,focusExtra:x};m.useEffect(()=>{const k=D=>{D.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const Q=k=>Z?t.jsx(ds,{token:Z,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(vo.Provider,{value:R,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(Z?" cibles":"")+(v?" chrome-min":""),children:[t.jsx("style",{children:Ki}),Q(t.jsxs("div",{className:"app"+(Y?" pipe":"")+(Z?" has-thesis":""),children:[de.showTicker&&t.jsx(at,{name:"live",children:t.jsxs("div",{className:"live-stack"+(Z?" live-stack--cibles":""),children:[t.jsx(xs,{}),!!Z&&t.jsx(cs,{})]})}),de.showIdent&&t.jsx(at,{name:"identite",children:t.jsx(Cs,{})}),!1,Dd,de.showFunnel&&t.jsx(at,{name:"entonnoir",children:t.jsx($d,{})}),!h.mapFolded&&t.jsx(at,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(po,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Od,{}),t.jsx(Sl,{}),t.jsx(co,{})]})]})}),de.showDemand&&Y&&t.jsx(at,{name:"direct",children:t.jsx(Ui,{items:se,serverOff:ee,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),de.showDemand&&t.jsx(at,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Ll,{})})}),a==="ops"&&t.jsxs("button",{type:"button",className:"chrome-tog","aria-expanded":!v,onClick:()=>{u(k=>{const D=!k;try{localStorage.setItem("atl2:chrome-min",D?"1":"0")}catch{}return D})},children:[t.jsx("i",{}),v?d.chromeShow:d.chromeHide]}),de.showDemand&&h.memoConsole&&t.jsx(at,{name:"console",children:t.jsx(Ml,{})}),t.jsx(at,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(od,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(at,{name:"fiche",children:t.jsx(_l,{})}),t.jsx(at,{name:"modales",children:t.jsx(md,{})}),t.jsx(bs,{}),F&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:F.o.name}),t.jsx(js,{placeholder:F.yes?d.whyYesPh:d.whyNoPh,onDone:k=>{const D=F.o;P(null),k&&ye(D,k).then(M=>{M&&be(d.csNoteSaved)})}})]}),g&&ft&&t.jsx(Ss,{steps:Bd(d,st,pt,ht,xt),onClose:()=>{z(!1),Nr(Z)}}),t.jsx(Pd,{}),de.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:$r,children:bn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${ja}`,children:ja})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),q&&t.jsx("div",{className:"flash on"+(O?" err":""),children:q}),S&&t.jsx(qi,{variant:"acquirer",initialCompany:Sr().co,initialWebsite:Sr().site,onClose:()=>w(null)})]})})}function $d(){const{t:e}=U(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Sr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function _d(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{yo as FlagCell,Ct as SigBadge,Fa as SigWin,Vd as default,_d as fmtShort,U as useV2};
