...
.atl2 .bulk .side .hint{white-space:nowrap}`,ho=`
...
`,go=xo+ho;function Zt(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function bo(){const e=Zt("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function vo(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=bo();return r==="0"?"client":r==="1"||Zt("embed")==="1"&&Zt("chrome")==="1"?"apercu":"client"}const yo={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},wo=e=>yo[e],Ie=e=>Object.assign(e,{continent:kr(e.cc)});function Ut(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const ko=60*60*1e3;function jo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ko?null:a}catch{return null}}function ht(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const No=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function So(e,a,r="default"){const n=r!=="default",o=g.useMemo(()=>e||n?{mode:"anon"}:mr(),[e,n]),i=g.useMemo(()=>n?"visiteur":vo(e,o),[e,o,n]),l=g.useMemo(()=>wo(i),[i]),s=i!=="visiteur",p=No(r),[u,d]=g.useState([]),[c,m]=g.useState(""),[h,f]=g.useState(null),[v,b]=g.useState(null),[x,y]=g.useState(null),[N,w]=g.useState(()=>new Map),[S,k]=g.useState(()=>new Map),[z,R]=g.useState(""),[j,T]=g.useState(new Set),[A,L]=g.useState(null),[F,P]=g.useState(!0),[E,M]=g.useState(!1),[H,W]=g.useState(0),[Z,me]=g.useState(0),B=g.useRef(0),ie=g.useMemo(()=>{var Y;if(i!=="client")return"";try{return((Y=xr())==null?void 0:Y.email)||""}catch{return""}},[i]);g.useEffect(()=>{const Y=++B.current;let $=!0;const G=()=>$&&Y===B.current,U=(s&&o.token?o.token:"pub:"+a)+(p?":"+p:""),ne=jo(U);return ne?(d(ne.objs.map(Ie)),ne.fund&&m(ne.fund),f(ne.marketEstimate??null),b(ne.criteria??null),y(ne.stats??null),R(ne.generatedAt||""),P(!1)):P(!0),(async()=>{try{if(r==="ops"){const ae=await Bt(),pe=((ae==null?void 0:ae.recent_ops)||[]).filter(se=>hr((se.company_name||se.title||"").trim())).map(se=>$t(se,a)).filter(se=>!!se);if(!G())return;d(pe.map(Ie)),ht(U,{objs:pe})}else if(typeof r=="object"){const pe=(await Aa()||[]).filter(ce=>(ce.slug||"")===r.research).map(ce=>La(ce,a)).filter(ce=>!!ce),se=Ut(await Ra(pe,a));if(!G())return;d(se.map(Ie)),ht(U,{objs:se})}else if(s&&o.token){const ae=gr(o.token),pe=Bt(),se=br(o.token),ce=vr(o.token),Me=yr(o.token),K=await ae;let ge=K?K.targets:[];G()&&K&&(m(K.fund||""),f(K.marketEstimate??null),b(K.criteria??null),y(K.stats??null),R(K.generatedAt||""),d(ge.map(Ie)),P(!1),M(!1));const[Ne,qe,Te,q]=await Promise.all([pe,se,ce,Me]),Q=((Ne==null?void 0:Ne.recent_ops)||[]).map(J=>$t(J,a)).filter(J=>!!J);if(ge=[...ge,...Q],!G())return;d(ge.map(Ie));const te=new Set;for(const J of qe){const Se=(J.id||J.co||"").toString().trim().toLowerCase();Se&&te.add(Se.startsWith("t:")?Se:"t:"+Se)}T(te),w(Te),k(q),K&&ht(U,{fund:K.fund,marketEstimate:K.marketEstimate,criteria:K.criteria,stats:K.stats,generatedAt:K.generatedAt,objs:ge})}else{const ae=wr(),pe=Aa(),se=Bt(),ce=await ae;G()&&ce.length&&(d(Ut(ce).map(Ie)),P(!1),M(!1));const[Me,K]=await Promise.all([pe,se]),ge=(Me||[]).map(q=>La(q,a)).filter(q=>!!q),Ne=await Ra(ge,a),qe=((K==null?void 0:K.recent_ops)||[]).map(q=>$t(q,a)).filter(q=>!!q),Te=Ut([...ce,...Ne,...qe]);if(!G())return;d(Te.map(Ie)),ht(U,{objs:Te})}G()&&M(!1)}catch{G()&&!ne&&M(!0)}finally{G()&&P(!1)}})(),()=>{$=!1}},[s,o.token,a,H,p]),g.useEffect(()=>{if(!l.showCredits||!ie){L(null);return}let Y=!0;return(async()=>{try{const $=await fetch(`${xa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ie})});if(!$.ok)return;const G=await $.json();Y&&G&&G.ok!==!1&&L(G)}catch{}})(),()=>{Y=!1}},[l.showCredits,ie,Z]);const _=g.useCallback(Y=>T(new Set(Y)),[]);return{session:o,mode:i,caps:l,fund:c,email:ie,marketEstimate:h,generatedAt:z,criteria:v,stats:x,thumbs:N,stages:S,dossiers:u,favIds:j,setFavIds:_,credits:A,reloadCredits:()=>me(Y=>Y+1),loading:F,error:E,refresh:()=>W(Y=>Y+1)}}const Cn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Co=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Cn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Eo(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Cn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]||St)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const St=40;function wa(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!fe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(ha(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(Qe(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&$e(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(o))return!1}return!0}function En(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:wa(e,a.filters,r)}function zo(e,a,r,n){return!(!En(e,a,r)||r&&!jr(e,a.ptab,n))}function ka(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-Qe(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const i=fe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),s=n(i);return l<s?-a.dir:l>s?a.dir:(o.name||"").localeCompare(i.name||"")})}function To(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i}=O(),l=g.useMemo(()=>{const p=(a.filters.day||"").slice(0,10),u=h=>!(!i&&a.continent!=="monde"&&h.continent!==a.continent||p&&(h.date||"").slice(0,10)!==p),d=e.filter(h=>u(h)&&fe(h)),c=e.filter(h=>u(h)&&h.kind==="op"&&!fe(h)&&(p?!0:Qe(h.date)<=7)),m=p||new Date().toISOString().slice(0,10);return c.sort((h,f)=>{const v=(h.date||"").slice(0,10)===m?0:1,b=(f.date||"").slice(0,10)===m?0:1;return v!==b?v-b:(f.amountEur||0)-(h.amountEur||0)}),[...ka(d,{key:"signal",dir:-1}),...c].slice(0,48)},[e,a.continent,a.filters.day,i]),s=p=>l.map(u=>t.jsxs("button",{type:"button",className:"tk"+(ke(u)?" spent":""),onClick:d=>{const c=d.currentTarget.getBoundingClientRect();n({type:"popup",id:u.id,anchor:{x:c.left+c.width/2,y:c.bottom}})},title:u.name+(u.tagline?" — "+u.tagline:""),children:[t.jsx(Ze,{o:u}),t.jsxs("span",{className:"who",children:[t.jsx(Zn,{o:u}),t.jsx("span",{className:"co",children:u.name})]}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{className:"am",children:Qs(u.amountEur)}),u.sector&&t.jsx("span",{className:"mt",children:u.sector}),t.jsx(Pt,{o:u}),t.jsx("span",{className:"tkgo",children:"→"})]},p+(u.id||u.name)));return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live,t.jsx("span",{className:"cnt",children:l.length})]}),t.jsx("div",{className:"win",children:l.length?t.jsxs("div",{className:"run",children:[s(0),s(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})})]})}const Ao="aDx8z7Hzksus",zn="+33 6 83 10 72 86",Ba="alexandre@proplace.co",Lo=`tel:${zn.replace(/[^\d+]/g,"")}`,$a="pp-rdv-slot";function Ro(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Mo(){const{t:e,caps:a,fund:r}=O();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:Oo}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Lo,children:zn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Ba}`,children:Ba})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(po,{filloutId:Ao,parameters:r?{company_name:r}:void 0})})]})}function qo(){const[e,a]=g.useState(()=>typeof document>"u"?null:document.getElementById($a));return g.useEffect(()=>{e||a(document.getElementById($a))},[e]),e?ut.createPortal(t.jsx(Mo,{}),e):null}const Oo=`
...
`;class de extends g.Component{constructor(){super(...arguments);za(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Fo=8;function Po(){const{t:e,lang:a,token:r,dossiers:n,caps:o,markRow:i,dispatch:l}=O(),[s,p]=g.useState(!1),[u,d]=g.useState(!1),[c,m]=g.useState(!1),h=r||"home",{names:f,verdicts:v}=g.useMemo(()=>{const w=[],S={};return n.forEach(k=>{k.kind!=="target"||!k.name||(w.push(k.name),S[k.name]=Nr(k)||"")}),{names:w,verdicts:S}},[n]),b=g.useMemo(()=>f.length?Sr(h,f,v,a):null,[h,f.length]);if(!o.pipe||s||!b||b.firstVisit||!b.added.length&&!b.gone.length)return null;const x=u?b.added:b.added.slice(0,Fo),y=b.added.length-x.length,N=w=>{const S=n.find(k=>k.name===w);S&&(i(S.id),l({type:"popup",id:S.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(b.added.length,b.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Cr(h,f,v,b.fp,a)},children:"×"})]}),!!b.added.length&&t.jsxs("div",{className:"since-c",children:[x.map(w=>t.jsx("button",{type:"button",onClick:()=>N(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!b.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>m(w=>!w),children:e.sinceOut(b.gone.length)}),c&&b.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Vt=600,Be=62,_a="atl2:fstats";function Do(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=O(),[l,s]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(_a)==="on"}catch{return!1}}),p=r.stats,u=g.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=g.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const c=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,m=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),h=u.reduce((y,N)=>Math.max(y,N.s||0),0),f=u.length?Vt/u.length:0,v=Math.max(4,f-4),b=u.length>=5&&h>0,x=[[p.screened,e.funScreened(c(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[x.map(([y,N,w],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(y)}),t.jsx("i",{children:N}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},N)),b&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(_a,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&b&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Vt} ${Be}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[u.map((y,N)=>{const w=(y.s||0)/h*(Be-4),S=(y.m||0)/h*(Be-4),k=N*f+(f-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${c(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:k,y:Be-2-w,width:v,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:k,y:Be-2-S,width:v,height:S,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Be-1.5,x2:Vt,y2:Be-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:c(u[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Io=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Bo({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=O(),[i,l]=g.useState(""),[s,p]=g.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const u=(e.ceoStatus||"").trim(),d=(Je(e)||"").startsWith("CALL")&&he(e)===3,c=he(e)>=2,m=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(f);const v=await o(e,f);l(""),v&&(p(!0),setTimeout(()=>p(!1),2200))},h=d?[["Validé",a.csYes],["Écarté",a.csNo]]:Io.filter(([f])=>!(c&&f==="Retenu")).map(([f,v])=>[f,a[v]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([f,v])=>t.jsx("button",{type:"button",className:"csb"+(u===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{m(f)},children:v},f)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx($o,{o:e})]})}function $o({o:e}){const{t:a,saveNote:r,flash:n}=O(),[o,i]=g.useState(e.ceoNote||""),[l,s]=g.useState(!1),[p,u]=g.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),c=async()=>{if(l||!d)return;s(!0);const m=await r(e,o.trim());s(!1),m&&(u(!0),setTimeout(()=>u(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&c()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{c()},children:p?a.csNoteSaved:a.csNoteOk})]})}function _o({placeholder:e,onDone:a}){const{t:r}=O(),[n,o]=g.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Uo({o:e}){var b;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:s}=O(),[p,u]=g.useState(!1);if(!n.pipe||!o||n.lockActions||he(e)!==4)return null;const d=i(e),c=(d==null?void 0:d.stage)||"todo",m=async x=>{if(p||x===c)return;u(!0);const y=d;l(e,{stage:x,stamps:(d==null?void 0:d.stamps)||{}});const N=Math.max(Date.now(),Ua+=1);Ua=N;const w=await Er(r,{company:e.name||"",stage:x,cts:N,deal_id:e.airtableId,check_id:e.checkId});u(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},h=(b=d==null?void 0:d.stamps)==null?void 0:b.sent,f=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,v=c==="sent"&&h&&f>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,y])=>t.jsx("button",{type:"button",className:"stgb"+(c===x?" on":""),disabled:p,onClick:()=>{m(x)},children:y},x)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let Ua=0;const gt=8,bt=340;function Va({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Vo({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,scoped:i,byId:l,st:s}=O(),[p,u]=g.useState(0),[d,c]=g.useState(null),[m,h]=g.useState([]),f=g.useRef(!1);g.useEffect(()=>{f.current||(f.current=!0,h(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const v=m[p],b=p>=m.length;g.useEffect(()=>{v&&(v.ptab!==void 0&&s.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&s.dens!==v.dens&&n({type:"dens",dens:v.dens}))},[p,v]);const x=g.useCallback(()=>{if(!v){c(null);return}const S=document.querySelector(v.sel);if(!S){c(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),c(S.getBoundingClientRect())},[v]);g.useLayoutEffect(()=>{x();const S=window.setTimeout(x,260),k=()=>x();return window.addEventListener("scroll",k,!0),window.addEventListener("resize",k),()=>{window.clearTimeout(S),window.removeEventListener("scroll",k,!0),window.removeEventListener("resize",k)}},[x]);const y=g.useRef(a);if(y.current=a,g.useEffect(()=>{const S=k=>{k.key==="Escape"?(k.preventDefault(),k.stopPropagation(),y.current()):k.key==="ArrowRight"?u(z=>z+1):k.key==="ArrowLeft"&&u(z=>Math.max(0,z-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!m.length)return null;let N=null;if(b){const S=o[3]||0,k=i.find(z=>z.memoUrl)||[...l.values()].find(z=>z.memoUrl);S>0?N={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:k?N={title:r.ahaBTitle,body:r.ahaBBody(k.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:k.id}),a()}}:N={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:bt};if(!b&&d){const S=d.bottom+14,z=window.innerHeight-S>190?S:Math.max(12,d.top-200);w={left:Math.min(Math.max(12,d.left+d.width/2-bt/2),window.innerWidth-bt-12),top:z,width:bt}}return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!b&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-gt,top:d.top-gt,width:d.width+gt*2,height:d.height+gt*2}}),(b||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(b?" fin":""),style:w,children:[b&&N?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:N.title}),t.jsx("p",{children:t.jsx(Va,{text:N.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>u(m.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:N.go,children:N.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(p+1,m.length)}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx("p",{children:t.jsx(Va,{text:(v==null?void 0:v.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>u(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>u(S=>S+1),children:p===m.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Ho(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,dispatch:l}=O(),s=r?a:e,p=g.useMemo(()=>s.filter(x=>Qe(x.date)===0&&x.kind==="target"),[s]),u=g.useMemo(()=>r?a.filter(x=>he(x)===0).slice().sort((x,y)=>(y.date||"").localeCompare(x.date||"")):[],[a,r]),d=g.useMemo(()=>p.filter(x=>r?he(x)===0:!ke(x)),[p,r]),c=r?u:d,m=r?a.length-u.length:p.length-d.length,h=r?a.length:p.length,f=h?Math.min(100,m/h*100):100;let v;r?v=o.morningThesis(p.length,u.length):p.length?m===0?v=o.goalSourced(p.length):m>=p.length?v=o.goalCleared:v=o.goalDone(m,p.length):v=o.goalSourced(0);const b=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&u.length&&l({type:"chainStart",queue:u.map(x=>x.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:v}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:f+"%"}})}),c.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:b,children:r?o.morningEval(c.length):i.pileMode?o.goalContinue(c.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Yo(){var T,A;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:s,mode:p,doSync:u,startTour:d}=O(),[c,m]=g.useState(null),[h,f]=g.useState([]),v=p==="client";g.useEffect(()=>{if(!o||!i)return;let L=!0;return(async()=>{const[F,P]=await Promise.all([ga(i),kn(o)]);L&&(F&&m(F),f(P))})(),()=>{L=!1}},[o,i]);const b=(c==null?void 0:c.per_day)??null,x=((T=c==null?void 0:c.pool_order)==null?void 0:T.length)??0,y=h.filter(L=>L.status==="running").length,N=g.useMemo(()=>s.filter(L=>L.kind==="target"&&ke(L)).length,[s]),w=l.marketEstimate,S=typeof((A=l.stats)==null?void 0:A.screened)=="number"?l.stats.screened:N,k=w&&w>0?Math.min(100,Math.round(S/w*100)):null,z=L=>L.toLocaleString(a==="en"?"en-US":"fr-FR"),R=(i||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),j=(()=>{const L=Date.parse(l.generatedAt||"");if(Number.isNaN(L))return"";const F=new Date(L),P=E=>String(E).padStart(2,"0");return`${P(F.getDate())}/${P(F.getMonth()+1)} à ${P(F.getHours())}:${P(F.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:R}),t.jsx("i",{children:i})]}),t.jsx("h1",{children:e.identTitle(i||"…")}),t.jsx("span",{className:"idsp"}),j&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(j)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[k===null&&S>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:z(S)})})]}),k!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:k+"%"}})}),t.jsxs("b",{children:[k," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(S,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),b!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:b})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),b===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(x)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!v,onClick:u,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function Wo(){const{t:e,counts:a,dispatch:r}=O();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,o],i)=>{const l=i===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:i+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:o}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},i)})})]})}const Go=["--p0","--p1","--p2","--p3","--p4"];function Ko(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o}=O(),i=g.useRef({});g.useEffect(()=>{i.current={...r}},[r]);const l=u=>{const d=i.current[u],c=d!==void 0?r[u]-d:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Go[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[u],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},u)},s=(u,d,c)=>t.jsxs("button",{type:"button",className:"off"+(d?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),p=(u,d,c,m=!1)=>t.jsx("button",{type:"button",className:"tool",title:d,disabled:m,onClick:c,children:u},d);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,o,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Qo=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Jo(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=O(),s=g.useRef(null),[p,u]=g.useState(60);g.useEffect(()=>{let h=0;const f=()=>{var N;const v=s.current;if(!v)return;const b=(N=v.parentElement)==null?void 0:N.querySelector('.funnel [aria-selected="true"]');if(!b)return;const x=b.getBoundingClientRect(),y=v.getBoundingClientRect();u(Math.max(20,Math.min(x.left+x.width/2-y.left,y.width-30)))};return h=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(h),window.removeEventListener("resize",f)}},[e.ptab]);const d=e.ptab;let c=r.tuto[d].p;if(d===3){const h=n.filter(b=>b.kind==="target"&&he(b)===3),f=h.filter(b=>Qt(b)==="auto").length,v=h.filter(b=>Qt(b)==="cd").length;c=r.tutoPending(f,v,h.length)}const m=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(h=>h.id)})};if(d===1){const h=n.filter(f=>f.kind==="target"&&he(f)===1&&!o.has(f.id)).slice(0,10);if(h.length)return{label:r.tuto[1].a,run:()=>h.forEach(f=>i(f))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Qo[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:c}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label})]})}class _e{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,s=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*Xo(e){for(const a of e)yield*a}function Tn(e){return Array.from(Xo(e))}var X=1e-6,V=Math.PI,ye=V/2,Ha=V/4,je=V*2,Ae=180/V,be=V/180,ee=Math.abs,Zo=Math.atan,lt=Math.atan2,re=Math.cos,oe=Math.sin,ei=Math.sign||function(e){return e>0?1:e<0?-1:0},Ve=Math.sqrt;function ti(e){return e>1?0:e<-1?V:Math.acos(e)}function ct(e){return e>1?ye:e<-1?-ye:Math.asin(e)}function we(){}function Et(e,a){e&&Wa.hasOwnProperty(e.type)&&Wa[e.type](e,a)}var Ya={Feature:function(e,a){Et(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Et(r[n].geometry,a)}},Wa={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ea(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ea(r[n],a,0)},Polygon:function(e,a){Ga(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Ga(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Et(r[n],a)}};function ea(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Ga(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ea(e[r],a,1);a.polygonEnd()}function He(e,a){e&&Ya.hasOwnProperty(e.type)?Ya[e.type](e,a):Et(e,a)}function ta(e){return[lt(e[1],e[0]),ct(e[2])]}function Ge(e){var a=e[0],r=e[1],n=re(r);return[n*re(a),n*oe(a),oe(r)]}function vt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function zt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ht(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function yt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function aa(e){var a=Ve(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function na(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function ra(e,a){return ee(e)>V&&(e-=Math.round(e/je)*je),[e,a]}ra.invert=ra;function ai(e,a,r){return(e%=je)?a||r?na(Qa(e),Ja(a,r)):Qa(e):a||r?Ja(a,r):ra}function Ka(e){return function(a,r){return a+=e,ee(a)>V&&(a-=Math.round(a/je)*je),[a,r]}}function Qa(e){var a=Ka(e);return a.invert=Ka(-e),a}function Ja(e,a){var r=re(e),n=oe(e),o=re(a),i=oe(a);function l(s,p){var u=re(p),d=re(s)*u,c=oe(s)*u,m=oe(p),h=m*r+d*n;return[lt(c*o-h*i,d*r-m*n),ct(h*o+c*i)]}return l.invert=function(s,p){var u=re(p),d=re(s)*u,c=oe(s)*u,m=oe(p),h=m*o-c*i;return[lt(c*o+m*i,d*r+h*n),ct(h*r-d*n)]},l}function ni(e,a,r,n,o,i){if(r){var l=re(a),s=oe(a),p=n*r;o==null?(o=a+n*je,i=a-p/2):(o=Xa(l,o),i=Xa(l,i),(n>0?o<i:o>i)&&(o+=n*je));for(var u,d=o;n>0?d>i:d<i;d-=p)u=ta([l,-s*re(d),-s*oe(d)]),e.point(u[0],u[1])}}function Xa(e,a){a=Ge(a),a[0]-=e,aa(a);var r=ti(-a[1]);return((-a[2]<0?-r:r)+je-X)%je}function An(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:we,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ct(e,a){return ee(e[0]-a[0])<X&&ee(e[1]-a[1])<X}function wt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ln(e,a,r,n,o){var i=[],l=[],s,p;if(e.forEach(function(f){if(!((v=f.length-1)<=0)){var v,b=f[0],x=f[v],y;if(Ct(b,x)){if(!b[2]&&!x[2]){for(o.lineStart(),s=0;s<v;++s)o.point((b=f[s])[0],b[1]);o.lineEnd();return}x[0]+=2*X}i.push(y=new wt(b,f,null,!0)),l.push(y.o=new wt(b,null,y,!1)),i.push(y=new wt(x,f,null,!1)),l.push(y.o=new wt(x,null,y,!0))}}),!!i.length){for(l.sort(a),Za(i),Za(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var u=i[0],d,c;;){for(var m=u,h=!0;m.v;)if((m=m.n)===u)return;d=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(h)for(s=0,p=d.length;s<p;++s)o.point((c=d[s])[0],c[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(h)for(d=m.p.z,s=d.length-1;s>=0;--s)o.point((c=d[s])[0],c[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,d=m.z,h=!h}while(!m.v);o.lineEnd()}}}function Za(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Yt(e){return ee(e[0])<=V?e[0]:ei(e[0])*((ee(e[0])+V)%je-V)}function ri(e,a){var r=Yt(a),n=a[1],o=oe(n),i=[oe(r),-re(r),0],l=0,s=0,p=new _e;o===1?n=ye+X:o===-1&&(n=-ye-X);for(var u=0,d=e.length;u<d;++u)if(m=(c=e[u]).length)for(var c,m,h=c[m-1],f=Yt(h),v=h[1]/2+Ha,b=oe(v),x=re(v),y=0;y<m;++y,f=w,b=k,x=z,h=N){var N=c[y],w=Yt(N),S=N[1]/2+Ha,k=oe(S),z=re(S),R=w-f,j=R>=0?1:-1,T=j*R,A=T>V,L=b*k;if(p.add(lt(L*j*oe(T),x*z+L*re(T))),l+=A?R+j*je:R,A^f>=r^w>=r){var F=zt(Ge(h),Ge(N));aa(F);var P=zt(i,F);aa(P);var E=(A^R>=0?-1:1)*ct(P[2]);(n>E||n===E&&(F[0]||F[1]))&&(s+=A^R>=0?1:-1)}}return(l<-X||l<X&&p<-1e-12)^s&1}function Rn(e,a,r,n){return function(o){var i=a(o),l=An(),s=a(l),p=!1,u,d,c,m={point:h,lineStart:v,lineEnd:b,polygonStart:function(){m.point=x,m.lineStart=y,m.lineEnd=N,d=[],u=[]},polygonEnd:function(){m.point=h,m.lineStart=v,m.lineEnd=b,d=Tn(d);var w=ri(u,n);d.length?(p||(o.polygonStart(),p=!0),Ln(d,ii,w,r,o)):w&&(p||(o.polygonStart(),p=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),p&&(o.polygonEnd(),p=!1),d=u=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function h(w,S){e(w,S)&&o.point(w,S)}function f(w,S){i.point(w,S)}function v(){m.point=f,i.lineStart()}function b(){m.point=h,i.lineEnd()}function x(w,S){c.push([w,S]),s.point(w,S)}function y(){s.lineStart(),c=[]}function N(){x(c[0][0],c[0][1]),s.lineEnd();var w=s.clean(),S=l.result(),k,z=S.length,R,j,T;if(c.pop(),u.push(c),c=null,!!z){if(w&1){if(j=S[0],(R=j.length-1)>0){for(p||(o.polygonStart(),p=!0),o.lineStart(),k=0;k<R;++k)o.point((T=j[k])[0],T[1]);o.lineEnd()}return}z>1&&w&2&&S.push(S.pop().concat(S.shift())),d.push(S.filter(oi))}}return m}}function oi(e){return e.length>1}function ii(e,a){return((e=e.x)[0]<0?e[1]-ye-X:ye-e[1])-((a=a.x)[0]<0?a[1]-ye-X:ye-a[1])}const en=Rn(function(){return!0},si,ci,[-V,-ye]);function si(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var s=i>0?V:-V,p=ee(i-a);ee(p-V)<X?(e.point(a,r=(r+l)/2>0?ye:-ye),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&p>=V&&(ee(a-n)<X&&(a-=n*X),ee(i-s)<X&&(i-=s*X),r=li(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function li(e,a,r,n){var o,i,l=oe(e-r);return ee(l)>X?Zo((oe(a)*(i=re(n))*oe(r)-oe(n)*(o=re(a))*oe(e))/(o*i*l)):(a+n)/2}function ci(e,a,r,n){var o;if(e==null)o=r*ye,n.point(-V,o),n.point(0,o),n.point(V,o),n.point(V,0),n.point(V,-o),n.point(0,-o),n.point(-V,-o),n.point(-V,0),n.point(-V,o);else if(ee(e[0]-a[0])>X){var i=e[0]<a[0]?V:-V;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function di(e){var a=re(e),r=2*be,n=a>0,o=ee(a)>X;function i(d,c,m,h){ni(h,e,r,m,d,c)}function l(d,c){return re(d)*re(c)>a}function s(d){var c,m,h,f,v;return{lineStart:function(){f=h=!1,v=1},point:function(b,x){var y=[b,x],N,w=l(b,x),S=n?w?0:u(b,x):w?u(b+(b<0?V:-V),x):0;if(!c&&(f=h=w)&&d.lineStart(),w!==h&&(N=p(c,y),(!N||Ct(c,N)||Ct(y,N))&&(y[2]=1)),w!==h)v=0,w?(d.lineStart(),N=p(y,c),d.point(N[0],N[1])):(N=p(c,y),d.point(N[0],N[1],2),d.lineEnd()),c=N;else if(o&&c&&n^w){var k;!(S&m)&&(k=p(y,c,!0))&&(v=0,n?(d.lineStart(),d.point(k[0][0],k[0][1]),d.point(k[1][0],k[1][1]),d.lineEnd()):(d.point(k[1][0],k[1][1]),d.lineEnd(),d.lineStart(),d.point(k[0][0],k[0][1],3)))}w&&(!c||!Ct(c,y))&&d.point(y[0],y[1]),c=y,h=w,m=S},lineEnd:function(){h&&d.lineEnd(),c=null},clean:function(){return v|(f&&h)<<1}}}function p(d,c,m){var h=Ge(d),f=Ge(c),v=[1,0,0],b=zt(h,f),x=vt(b,b),y=b[0],N=x-y*y;if(!N)return!m&&d;var w=a*x/N,S=-a*y/N,k=zt(v,b),z=yt(v,w),R=yt(b,S);Ht(z,R);var j=k,T=vt(z,j),A=vt(j,j),L=T*T-A*(vt(z,z)-1);if(!(L<0)){var F=Ve(L),P=yt(j,(-T-F)/A);if(Ht(P,z),P=ta(P),!m)return P;var E=d[0],M=c[0],H=d[1],W=c[1],Z;M<E&&(Z=E,E=M,M=Z);var me=M-E,B=ee(me-V)<X,ie=B||me<X;if(!B&&W<H&&(Z=H,H=W,W=Z),ie?B?H+W>0^P[1]<(ee(P[0]-E)<X?H:W):H<=P[1]&&P[1]<=W:me>V^(E<=P[0]&&P[0]<=M)){var _=yt(j,(-T+F)/A);return Ht(_,z),[P,ta(_)]}}}function u(d,c){var m=n?e:V-e,h=0;return d<-m?h|=1:d>m&&(h|=2),c<-m?h|=4:c>m&&(h|=8),h}return Rn(l,s,i,n?[0,-e]:[-V,e-V])}function pi(e,a,r,n,o,i){var l=e[0],s=e[1],p=a[0],u=a[1],d=0,c=1,m=p-l,h=u-s,f;if(f=r-l,!(!m&&f>0)){if(f/=m,m<0){if(f<d)return;f<c&&(c=f)}else if(m>0){if(f>c)return;f>d&&(d=f)}if(f=o-l,!(!m&&f<0)){if(f/=m,m<0){if(f>c)return;f>d&&(d=f)}else if(m>0){if(f<d)return;f<c&&(c=f)}if(f=n-s,!(!h&&f>0)){if(f/=h,h<0){if(f<d)return;f<c&&(c=f)}else if(h>0){if(f>c)return;f>d&&(d=f)}if(f=i-s,!(!h&&f<0)){if(f/=h,h<0){if(f>c)return;f>d&&(d=f)}else if(h>0){if(f<d)return;f<c&&(c=f)}return d>0&&(e[0]=l+d*m,e[1]=s+d*h),c<1&&(a[0]=l+c*m,a[1]=s+c*h),!0}}}}}var at=1e9,kt=-at;function ui(e,a,r,n){function o(u,d){return e<=u&&u<=r&&a<=d&&d<=n}function i(u,d,c,m){var h=0,f=0;if(u==null||(h=l(u,c))!==(f=l(d,c))||p(u,d)<0^c>0)do m.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+c+4)%4)!==f);else m.point(d[0],d[1])}function l(u,d){return ee(u[0]-e)<X?d>0?0:3:ee(u[0]-r)<X?d>0?2:1:ee(u[1]-a)<X?d>0?1:0:d>0?3:2}function s(u,d){return p(u.x,d.x)}function p(u,d){var c=l(u,1),m=l(d,1);return c!==m?c-m:c===0?d[1]-u[1]:c===1?u[0]-d[0]:c===2?u[1]-d[1]:d[0]-u[0]}return function(u){var d=u,c=An(),m,h,f,v,b,x,y,N,w,S,k,z={point:R,lineStart:L,lineEnd:F,polygonStart:T,polygonEnd:A};function R(E,M){o(E,M)&&d.point(E,M)}function j(){for(var E=0,M=0,H=h.length;M<H;++M)for(var W=h[M],Z=1,me=W.length,B=W[0],ie,_,Y=B[0],$=B[1];Z<me;++Z)ie=Y,_=$,B=W[Z],Y=B[0],$=B[1],_<=n?$>n&&(Y-ie)*(n-_)>($-_)*(e-ie)&&++E:$<=n&&(Y-ie)*(n-_)<($-_)*(e-ie)&&--E;return E}function T(){d=c,m=[],h=[],k=!0}function A(){var E=j(),M=k&&E,H=(m=Tn(m)).length;(M||H)&&(u.polygonStart(),M&&(u.lineStart(),i(null,null,1,u),u.lineEnd()),H&&Ln(m,s,E,i,u),u.polygonEnd()),d=u,m=h=f=null}function L(){z.point=P,h&&h.push(f=[]),S=!0,w=!1,y=N=NaN}function F(){m&&(P(v,b),x&&w&&c.rejoin(),m.push(c.result())),z.point=R,w&&d.lineEnd()}function P(E,M){var H=o(E,M);if(h&&f.push([E,M]),S)v=E,b=M,x=H,S=!1,H&&(d.lineStart(),d.point(E,M));else if(H&&w)d.point(E,M);else{var W=[y=Math.max(kt,Math.min(at,y)),N=Math.max(kt,Math.min(at,N))],Z=[E=Math.max(kt,Math.min(at,E)),M=Math.max(kt,Math.min(at,M))];pi(W,Z,e,a,r,n)?(w||(d.lineStart(),d.point(W[0],W[1])),d.point(Z[0],Z[1]),H||d.lineEnd(),k=!1):H&&(d.lineStart(),d.point(E,M),k=!1)}y=E,N=M,w=H}return z}}const oa=e=>e;var Wt=new _e,ia=new _e,Mn,qn,sa,la,Le={point:we,lineStart:we,lineEnd:we,polygonStart:function(){Le.lineStart=fi,Le.lineEnd=xi},polygonEnd:function(){Le.lineStart=Le.lineEnd=Le.point=we,Wt.add(ee(ia)),ia=new _e},result:function(){var e=Wt/2;return Wt=new _e,e}};function fi(){Le.point=mi}function mi(e,a){Le.point=On,Mn=sa=e,qn=la=a}function On(e,a){ia.add(la*e-sa*a),sa=e,la=a}function xi(){On(Mn,qn)}var Ke=1/0,Tt=Ke,dt=-Ke,At=dt,Lt={point:hi,lineStart:we,lineEnd:we,polygonStart:we,polygonEnd:we,result:function(){var e=[[Ke,Tt],[dt,At]];return dt=At=-(Tt=Ke=1/0),e}};function hi(e,a){e<Ke&&(Ke=e),e>dt&&(dt=e),a<Tt&&(Tt=a),a>At&&(At=a)}var ca=0,da=0,nt=0,Rt=0,Mt=0,Ye=0,pa=0,ua=0,rt=0,Fn,Pn,Ee,ze,ve={point:Ue,lineStart:tn,lineEnd:an,polygonStart:function(){ve.lineStart=vi,ve.lineEnd=yi},polygonEnd:function(){ve.point=Ue,ve.lineStart=tn,ve.lineEnd=an},result:function(){var e=rt?[pa/rt,ua/rt]:Ye?[Rt/Ye,Mt/Ye]:nt?[ca/nt,da/nt]:[NaN,NaN];return ca=da=nt=Rt=Mt=Ye=pa=ua=rt=0,e}};function Ue(e,a){ca+=e,da+=a,++nt}function tn(){ve.point=gi}function gi(e,a){ve.point=bi,Ue(Ee=e,ze=a)}function bi(e,a){var r=e-Ee,n=a-ze,o=Ve(r*r+n*n);Rt+=o*(Ee+e)/2,Mt+=o*(ze+a)/2,Ye+=o,Ue(Ee=e,ze=a)}function an(){ve.point=Ue}function vi(){ve.point=wi}function yi(){Dn(Fn,Pn)}function wi(e,a){ve.point=Dn,Ue(Fn=Ee=e,Pn=ze=a)}function Dn(e,a){var r=e-Ee,n=a-ze,o=Ve(r*r+n*n);Rt+=o*(Ee+e)/2,Mt+=o*(ze+a)/2,Ye+=o,o=ze*e-Ee*a,pa+=o*(Ee+e),ua+=o*(ze+a),rt+=o*3,Ue(Ee=e,ze=a)}function In(e){this._context=e}In.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,je);break}}},result:we};var fa=new _e,Gt,Bn,$n,ot,it,pt={point:we,lineStart:function(){pt.point=ki},lineEnd:function(){Gt&&_n(Bn,$n),pt.point=we},polygonStart:function(){Gt=!0},polygonEnd:function(){Gt=null},result:function(){var e=+fa;return fa=new _e,e}};function ki(e,a){pt.point=_n,Bn=ot=e,$n=it=a}function _n(e,a){ot-=e,it-=a,fa.add(Ve(ot*ot+it*it)),ot=e,it=a}let nn,qt,rn,on;class sn{constructor(a){this._append=a==null?Un:ji(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==rn||this._append!==qt){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,rn=n,qt=this._append,on=this._,this._=o}this._+=on;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Un(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function ji(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Un;if(a!==nn){const r=10**a;nn=a,qt=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return qt}function Ni(e,a){let r=3,n=4.5,o,i;function l(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),He(s,o(i))),i.result()}return l.area=function(s){return He(s,o(Le)),Le.result()},l.measure=function(s){return He(s,o(pt)),pt.result()},l.bounds=function(s){return He(s,o(Lt)),Lt.result()},l.centroid=function(s){return He(s,o(ve)),ve.result()},l.projection=function(s){return arguments.length?(o=s==null?(e=null,oa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(i=s==null?(a=null,new sn(r)):new In(a=s),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(i=new sn(r)),l},l.projection(e).digits(r).context(a)}function ja(e){return function(a){var r=new ma;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ma(){}ma.prototype={constructor:ma,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Na(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),He(r,e.stream(Lt)),a(Lt.result()),n!=null&&e.clipExtent(n),e}function Vn(e,a,r){return Na(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Si(e,a,r){return Vn(e,[[0,0],a],r)}function Ci(e,a,r){return Na(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([l,s])},r)}function Ei(e,a,r){return Na(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,s])},r)}var ln=16,zi=re(30*be);function cn(e,a){return+a?Ai(e,a):Ti(e)}function Ti(e){return ja({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Ai(e,a){function r(n,o,i,l,s,p,u,d,c,m,h,f,v,b){var x=u-n,y=d-o,N=x*x+y*y;if(N>4*a&&v--){var w=l+m,S=s+h,k=p+f,z=Ve(w*w+S*S+k*k),R=ct(k/=z),j=ee(ee(k)-1)<X||ee(i-c)<X?(i+c)/2:lt(S,w),T=e(j,R),A=T[0],L=T[1],F=A-n,P=L-o,E=y*F-x*P;(E*E/N>a||ee((x*F+y*P)/N-.5)>.3||l*m+s*h+p*f<zi)&&(r(n,o,i,l,s,p,A,L,j,w/=z,S/=z,k,v,b),b.point(A,L),r(A,L,j,w,S,k,u,d,c,m,h,f,v,b))}}return function(n){var o,i,l,s,p,u,d,c,m,h,f,v,b={point:x,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),b.lineStart=S},polygonEnd:function(){n.polygonEnd(),b.lineStart=y}};function x(R,j){R=e(R,j),n.point(R[0],R[1])}function y(){c=NaN,b.point=N,n.lineStart()}function N(R,j){var T=Ge([R,j]),A=e(R,j);r(c,m,d,h,f,v,c=A[0],m=A[1],d=R,h=T[0],f=T[1],v=T[2],ln,n),n.point(c,m)}function w(){b.point=x,n.lineEnd()}function S(){y(),b.point=k,b.lineEnd=z}function k(R,j){N(o=R,j),i=c,l=m,s=h,p=f,u=v,b.point=N}function z(){r(c,m,d,h,f,v,i,l,o,s,p,u,ln,n),b.lineEnd=w,w()}return b}}var Li=ja({point:function(e,a){this.stream.point(e*be,a*be)}});function Ri(e){return ja({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Mi(e,a,r,n,o){function i(l,s){return l*=n,s*=o,[a+e*l,r-e*s]}return i.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*o]},i}function dn(e,a,r,n,o,i){if(!i)return Mi(e,a,r,n,o);var l=re(i),s=oe(i),p=l*e,u=s*e,d=l/e,c=s/e,m=(s*r-l*a)/e,h=(s*a+l*r)/e;function f(v,b){return v*=n,b*=o,[p*v-u*b+a,r-u*v-p*b]}return f.invert=function(v,b){return[n*(d*v-c*b+m),o*(h-c*v-d*b)]},f}function qi(e){return Oi(function(){return e})()}function Oi(e){var a,r=150,n=480,o=250,i=0,l=0,s=0,p=0,u=0,d,c=0,m=1,h=1,f=null,v=en,b=null,x,y,N,w=oa,S=.5,k,z,R,j,T;function A(E){return R(E[0]*be,E[1]*be)}function L(E){return E=R.invert(E[0],E[1]),E&&[E[0]*Ae,E[1]*Ae]}A.stream=function(E){return j&&T===E?j:j=Li(Ri(d)(v(k(w(T=E)))))},A.preclip=function(E){return arguments.length?(v=E,f=void 0,P()):v},A.postclip=function(E){return arguments.length?(w=E,b=x=y=N=null,P()):w},A.clipAngle=function(E){return arguments.length?(v=+E?di(f=E*be):(f=null,en),P()):f*Ae},A.clipExtent=function(E){return arguments.length?(w=E==null?(b=x=y=N=null,oa):ui(b=+E[0][0],x=+E[0][1],y=+E[1][0],N=+E[1][1]),P()):b==null?null:[[b,x],[y,N]]},A.scale=function(E){return arguments.length?(r=+E,F()):r},A.translate=function(E){return arguments.length?(n=+E[0],o=+E[1],F()):[n,o]},A.center=function(E){return arguments.length?(i=E[0]%360*be,l=E[1]%360*be,F()):[i*Ae,l*Ae]},A.rotate=function(E){return arguments.length?(s=E[0]%360*be,p=E[1]%360*be,u=E.length>2?E[2]%360*be:0,F()):[s*Ae,p*Ae,u*Ae]},A.angle=function(E){return arguments.length?(c=E%360*be,F()):c*Ae},A.reflectX=function(E){return arguments.length?(m=E?-1:1,F()):m<0},A.reflectY=function(E){return arguments.length?(h=E?-1:1,F()):h<0},A.precision=function(E){return arguments.length?(k=cn(z,S=E*E),P()):Ve(S)},A.fitExtent=function(E,M){return Vn(A,E,M)},A.fitSize=function(E,M){return Si(A,E,M)},A.fitWidth=function(E,M){return Ci(A,E,M)},A.fitHeight=function(E,M){return Ei(A,E,M)};function F(){var E=dn(r,0,0,m,h,c).apply(null,a(i,l)),M=dn(r,n-E[0],o-E[1],m,h,c);return d=ai(s,p,u),z=na(a,M),R=na(d,z),k=cn(z,S),P()}function P(){return j=T=null,A}return function(){return a=e.apply(this,arguments),A.invert=a.invert&&L,F()}}function Hn(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Hn.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(ee(o)>X&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Fi(){return qi(Hn).scale(175.295)}function Pi(e){return e}function Di(e){if(e==null)return Pi;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var u=2,d=s.length,c=new Array(d);for(c[0]=(a+=s[0])*n+i,c[1]=(r+=s[1])*o+l;u<d;)c[u]=s[u],++u;return c}}function Ii(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Bi(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return pn(e,r)})}:pn(e,a)}function pn(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=$i(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function $i(e,a){var r=Di(e.transform),n=e.arcs;function o(d,c){c.length&&c.pop();for(var m=n[d<0?~d:d],h=0,f=m.length;h<f;++h)c.push(r(m[h],h));d<0&&Ii(c,f)}function i(d){return r(d)}function l(d){for(var c=[],m=0,h=d.length;m<h;++m)o(d[m],c);return c.length<2&&c.push(c[0]),c}function s(d){for(var c=l(d);c.length<4;)c.push(c[0]);return c}function p(d){return d.map(s)}function u(d){var c=d.type,m;switch(c){case"GeometryCollection":return{type:c,geometries:d.geometries.map(u)};case"Point":m=i(d.coordinates);break;case"MultiPoint":m=d.coordinates.map(i);break;case"LineString":m=l(d.arcs);break;case"MultiLineString":m=d.arcs.map(l);break;case"Polygon":m=p(d.arcs);break;case"MultiPolygon":m=d.arcs.map(p);break;default:return null}return{type:c,coordinates:m}}return u(a)}let jt=null;function _i(){return jt||(jt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Bi(r,n),i=Fi().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Ni(i),s=(o.features||[]).filter(p=>{var u;return(((u=p.properties)==null?void 0:u.name)||"")!=="Antarctica"}).map(p=>{var c;const u=((c=p.properties)==null?void 0:c.name)||"",d=l(p)||"";return d?{i2:zr(u)||null,n:u,d}:null}).filter(p=>!!p);return s.length?{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s}:null}catch{return null}})(),jt)}function Ui(e){const[a,r]=g.useState(null);return g.useEffect(()=>{if(!e||a)return;let n=!1;return _i().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const un=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function fn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Vi(e,a){const[r,n]=g.useState(1);return g.useEffect(()=>{let o=!0,i=0;const l=()=>{var u;if(!o)return;const p=(u=e.current)==null?void 0:u.getScreenCTM();p&&p.a>0?n(p.a):i=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Hi(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:s,t:p}=O(),u=g.useRef(null),d=g.useRef(null),c=Ui(e.continent==="monde"),m=e.continent==="monde"?c:ba.find(j=>j.key===e.continent)||null,h=Vi(u,e.continent+":"+e.mapFolded+":"+!!m),[f,v]=g.useState(new Map),[b,x]=g.useState(null);g.useEffect(()=>{const j=u.current;if(!j)return;const T=new Map;j.querySelectorAll("path[data-i2]").forEach(A=>{const L=A.dataset.i2;if(L)try{const F=A.getBBox();F.width>0&&T.set(L,{x:F.x,y:F.y,w:F.width,h:F.height})}catch{}}),v(T)},[e.continent,h,m]);const y=g.useMemo(()=>r.filter(j=>j.cc),[r]),N=g.useMemo(()=>{const j=new Map;return y.forEach(T=>j.set(T.cc,(j.get(T.cc)||0)+1)),j},[y]),w=g.useMemo(()=>y.map(j=>{const T=j.cc?f.get(j.cc):void 0;if(!T)return null;const A=fn(j.name||j.id||""),L=fn((j.id||j.name||"")+"·y"),F=(A-.5)*Math.min(T.w*.55,60),P=(L-.5)*Math.min(T.h*.55,60);return{d:j,x:T.x+T.w/2+F,y:T.y+T.h/2+P}}).filter(j=>!!j),[y,f]),S=j=>h>0?j/h:j,k=g.useMemo(()=>n?[0,1,2,3,4,5].map(j=>({c:un[j],fr:p.plabels[j].toUpperCase(),en:p.plabels[j].toUpperCase(),n:r.filter(T=>T.kind==="target"&&he(T)===j).length})).filter(j=>j.n>0):Ma.map((j,T)=>({...j,n:r.filter(A=>qa(A)===T).length})),[r,n,p.plabels]),z=i?l.get(i):null,R=z?w.find(j=>j.d.id===z.id):null;return m?t.jsxs("div",{className:"mapzone",ref:d,children:[t.jsxs("svg",{ref:u,viewBox:m.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?m.fr:m.en,onMouseLeave:()=>{x(null),o(null)},children:[t.jsx("g",{children:m.countries.map((j,T)=>t.jsx("g",{className:"ct"+(j.i2&&N.get(j.i2)?"":" empty"),children:t.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},T))}),t.jsx("g",{children:w.map(j=>{const T=Ma[qa(j.d)],A=!!fe(j.d),L=j.d.kind==="target",F=n&&L?un[he(j.d)]:T.c,P=!n&&ke(j.d);return t.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var H,W;const E=(H=d.current)==null?void 0:H.getBoundingClientRect(),M=(W=u.current)==null?void 0:W.createSVGPoint();if(M&&u.current&&E){M.x=j.x,M.y=j.y;const Z=M.matrixTransform(u.current.getScreenCTM());x({x:Z.x-E.left,y:Z.y-E.top,label:j.d.name+" · "+(Xe(j.d.cc,s)||j.d.countryLabel||"")})}o(j.d.id)},onMouseLeave:()=>{x(null),o(null)},onClick:()=>{var H;const E=(H=u.current)==null?void 0:H.createSVGPoint();let M=null;if(E&&u.current){E.x=j.x,E.y=j.y;const W=E.matrixTransform(u.current.getScreenCTM());M={x:W.x,y:W.y}}a({type:"popup",id:j.d.id,anchor:M})},children:[t.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:S(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:S(T.px),fill:F,stroke:A?"#DC2626":"#ffffff",strokeWidth:S(A?2.2:1.3)})]},j.d.id||j.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:S(13),fill:"none",stroke:"#0F172A",strokeWidth:S(2)})]}),t.jsx("div",{className:"hov"+(b?" on":""),style:b?{left:b.x,top:b.y}:void 0,children:b==null?void 0:b.label}),t.jsx("div",{className:"legend",children:k.map((j,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":j.c}}),s==="fr"?j.fr:j.en," ",t.jsx("b",{children:j.n})]},T))}),r.some(j=>!j.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(j=>!j.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:d})}function Yi(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Wi(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:o,contName:i,lang:l}=O(),s=e.filters,p=g.useMemo(()=>e.continent==="monde"?r:r.filter(f=>f.continent===e.continent),[r,e.continent]),u=f=>p.filter(v=>f!=="country"&&s.country.length&&!s.country.includes(v.cc||"")?!1:wa(v,s,o,f==="country"?void 0:f)),d=g.useMemo(()=>{const f=u("win"),v=b=>f.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=b).length;return[v(0),v(7),v(30),f.length]},[p,s,o]),c=g.useMemo(()=>s.day?u("win").filter(f=>(f.date||"").slice(0,10)===s.day).length:0,[p,s,o]),m=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),h=(f,v,b,x="fbtn")=>t.jsxs("button",{type:"button",className:x,"aria-expanded":e.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[t.jsx("span",{className:"fl",children:v}),b>0&&t.jsx("span",{className:"n",children:b}),t.jsx("span",{className:"cv",children:"▾"})]},f);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Yi(s.day,l)),t.jsx("b",{children:c})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,v)=>t.jsxs("button",{type:"button","aria-pressed":s.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[n.dates[v],t.jsx("b",{children:d[v]})]},f))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):h("sec",n.fSector,s.sector.length),h("pay",n.fCountry,s.country.length),h("det",n.fEngine,s.engine.length),h("sta",n.fStage,s.stage.length),o&&h("ang","Angle",s.angle.length),o&&h("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),m>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,i),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(m)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Gi,{poolFor:u})]})}function Gi({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=O(),i=a.filters,l=a.openFacet,{title:s,cols:p,options:u}=g.useMemo(()=>{if(l==="sig"){const f=e("signal").filter(x=>fe(x)),v=new Map;f.forEach(x=>{const y=x.engine||"";v.set(y,(v.get(y)||0)+1)});const b=[{v:"*",label:n.fpSigAll,n:f.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Jt([...v.keys()],o).map(x=>({v:x,label:We(x)+" "+Re(x,o),n:v.get(x)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:b}}if(l==="sec"){const f=e("sector"),v=new Map;return f.forEach(b=>{b.sector&&v.set(b.sector,(v.get(b.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((b,x)=>x[1]-b[1]).map(([b,x])=>({v:b,label:b,n:x,html:!1,on:i.sector.includes(b)}))}}if(l==="pay"){const f=e("country"),v=new Map;return f.forEach(b=>{b.cc&&v.set(b.cc,(v.get(b.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((b,x)=>x[1]-b[1]).map(([b,x])=>({v:b,label:Xe(b,o)||b,n:x,html:!1,on:i.country.includes(b)}))}}if(l==="det"){const f=e("engine"),v=new Map;return f.forEach(b=>{b.engine&&v.set(b.engine,(v.get(b.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Jt([...v.keys()],o).map(b=>({v:b,label:We(b)+" "+Re(b,o)+' <span style="color:var(--dim);font-size:10px">· '+Tr(Ar(b),o)+"</span>",n:v.get(b)||0,html:!0,on:i.engine.includes(b)}))}}if(l==="ang"){const f=e("angle"),v=new Map;return f.forEach(b=>{b.angle&&v.set(b.angle,(v.get(b.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((b,x)=>x[1]-b[1]).map(([b,x])=>({v:b,label:b.replace(/[_-]+/g," "),n:x,html:!1,on:i.angle.includes(b)}))}}if(l==="mem"){const f=e("memoLevel"),v=new Map;f.forEach(x=>{if(x.kind==="target"){const y=ha(x);v.set(y,(v.get(y)||0)+1)}});const b=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:b[x],n:v.get(x)||0,html:!1,on:i.memoLevel.includes(x)}))}}const m=e("stage"),h=new Map;return m.forEach(f=>{f.stage&&h.set(f.stage,(h.get(f.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((f,v)=>v[1]-f[1]).map(([f,v])=>({v:f,label:f,n:v,html:!1,on:i.stage.includes(f)}))}},[l,a,o]),d=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const f=i.signalEngines.includes(m)?i.signalEngines.filter(v=>v!==m):[...i.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:m})},c=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:c,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:u.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>d(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}const mn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Ki(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Qi(){var Te;const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:s,evalCards:p,caps:u,data:d}=O(),c=a==="client",[m,h]=g.useState(""),[f,v]=g.useState(!1),[b,x]=g.useState(""),[y,N]=g.useState(!1),[w,S]=g.useState(""),[k,z]=g.useState([]),R=g.useRef(!1),[j,T]=g.useState(!1),[A,L]=g.useState(""),[F,P]=g.useState(""),[E,M]=g.useState(!1),[H,W]=g.useState(0),[Z,me]=g.useState(""),[B,ie]=g.useState(null),[_,Y]=g.useState(null),$=g.useRef(!1),G=m.trim()?mn.test(m.trim())?e.evalUrl:e.evalName:e.evalWaiting,U=g.useMemo(()=>b.split(`
`).map(q=>q.trim()).filter(Boolean).slice(0,15),[b]);g.useEffect(()=>{if(typeof window>"u")return;const q=(new URLSearchParams(window.location.search).get("rs")||"").trim();!q||!/^https?:\/\//i.test(q)||(L(q),T(!0))},[]),g.useEffect(()=>{const q=Q=>{var J;const te=String(((J=Q.detail)==null?void 0:J.url)||"").trim();!te||!/^https?:\/\//i.test(te)||(L(te),T(!0))};return window.addEventListener("ppmap:research",q),()=>window.removeEventListener("ppmap:research",q)},[]);const ne=k.length?k:p,ae=d.credits;g.useEffect(()=>{if(!E)return;W(0);const q=window.setInterval(()=>W(Q=>Q+1),1e3);return()=>window.clearInterval(q)},[E]);const pe=()=>{const q=m.trim();q&&(o(null,q),h(""))},se=async()=>{if(!c){o(null,U[0]||"");return}if(!U.length||y)return;N(!0),R.current=!1;const q=[];for(let Q=0;Q<U.length&&!R.current;Q++){S(e.evaluating(Q+1,U.length,U[Q]));const te=await jn(r,U[Q],"atelier2");if(q.unshift({name:te.company||U[Q],verdict:te.verdict,reason:te.reason||"",remaining:te.remaining??null}),z([...q]),te.verdict==="quota"){q.unshift({name:"",verdict:"quota",reason:e.quota(U.length-Q-1),remaining:0}),z([...q]),x(U.slice(Q+1).join(`
`)),S(""),N(!1);return}}S(""),x(R.current?U.slice(q.length).join(`
`):""),N(!1)},ce=async()=>{var te;if($.current)return;const q=A.trim().replace(/\s+/g,""),Q=F.trim();if(!q&&!Q){me(e.rsNeed);return}if(!c){o(null,q||Q.slice(0,80));return}$.current=!0,me(""),ie(null),Y(null),M(!0);try{const J=await Rr({url:q,text:Q,email:n,cbToken:r});if(M(!1),!J||J.status!=="success"){me((J==null?void 0:J.message)||"Erreur");return}ie(J),T(!1);const Se=(((te=J.prospective)==null?void 0:te.companies_to_evaluate)||[]).map(Fe=>((Fe==null?void 0:Fe.name)||"").trim()).filter(Boolean);Se.length&&(x(Fe=>{const ft=Fe.split(`
`).map(Pe=>Pe.trim()).filter(Boolean),Dt=new Set(ft.map(Pe=>Pe.toLowerCase())),It=Se.filter(Pe=>!Dt.has(Pe.toLowerCase()));return[...ft,...It].slice(0,15).join(`
`)}),v(!0)),Y({state:"pending"});const Oe=await Mr(J,{email:n,cbToken:r});Y(Oe.ok&&Oe.url?{state:"ok",url:Oe.url}:{state:"fail",msg:Oe.error||""})}finally{$.current=!1,M(!1)}},Me=(((Te=B==null?void 0:B.prospective)==null?void 0:Te.companies_to_evaluate)||[]).filter(q=>q&&q.name),K=[B==null?void 0:B.industry,...(B==null?void 0:B.market_tags)||[],B==null?void 0:B.author].map(q=>(q||"").trim()).filter(Boolean),ge=(_==null?void 0:_.state)==="pending",Ne=_&&(ge?t.jsx("span",{className:"rslink pend",children:e.rsPublishing}):_.state==="ok"?t.jsx("a",{className:"rslink",href:_.url,target:"_blank",rel:"noopener noreferrer",children:e.rsLink}):t.jsx("span",{className:"rslink fail",title:_.msg,children:e.rsPublishFail})),qe=f&&Me.length>0;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:m,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:q=>h(q.target.value),onKeyDown:q=>{q.key==="Enter"&&pe()}}),t.jsx("span",{className:"detect"+(mn.test(m.trim())?" url":""),children:G})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:pe,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),u.showCredits&&ae&&t.jsxs("button",{type:"button",className:"credits"+(ae.total_available<=0&&!ae.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ae.unlimited?"∞":ae.total_available}),!ae.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ae.daily_grant+ae.purchased]}),ae.total_available<=0&&!ae.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>v(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(j?" on":""),onClick:()=>T(!j),children:e.rsOpen})]}),j&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:A,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:q=>L(q.target.value),onKeyDown:q=>{q.key==="Enter"&&ce()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:F,placeholder:e.rsTextPh,onChange:q=>P(q.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(E?" loading":""),style:{justifyContent:"center"},disabled:E||ge||!A.trim()&&!F.trim(),onClick:()=>{ce()},children:[t.jsx("span",{className:"fill"}),E?`${Lr(A.trim())==="youtube"&&A.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(H)}`:ge?e.rsPublishing:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),Z&&t.jsx("div",{className:"rserr",children:Z}),B&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:B.title}),B.source_url&&t.jsx("a",{href:B.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ie(null),Y(null)},children:"×"})]}),B.market&&t.jsx("p",{className:"rsmk",children:B.market}),K.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),K.map(q=>t.jsx("span",{children:q},q))]}),t.jsxs("div",{className:"rsbody",children:[B.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${B.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ki(B.summary_md||"").map((q,Q)=>t.jsx("p",{children:q},Q))})]}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Me.length)}),!qe&&Ne]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:b,placeholder:e.bulkPh,onChange:q=>x(q.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(y?" loading":""),style:{justifyContent:"center"},disabled:y||!U.length,onClick:()=>{se()},children:[t.jsx("span",{className:"fill"}),y&&w?w:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(U.length)}),qe&&Ne]})]}),ne.slice(0,1).map((q,Q)=>{const te=q.verdict==="kept",J=q.verdict==="quota",Se=te?"var(--brand)":J?"var(--bolt)":"var(--red)",Oe=te?"var(--brand-l)":J?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Se,"--bgc":Oe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:te?"✓ "+e.kept:J?"⏳":"✗ "+e.dropped})}),q.name&&t.jsx("span",{className:"rn",children:q.name}),t.jsx("span",{className:"rr",children:q.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",q.reason]}):null}),!J&&t.jsx("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"space"}),children:e.seeSpace(te?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},Q)}),c&&(i.kept+i.dropped>0||ne.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ji(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Xi(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=O(),i=e.memoConsole?r.get(e.memoConsole):null,l=g.useMemo(()=>i?[i.reasoning||"",Ji(i.summary||"")].filter(Boolean).join(`
...
`).map((u,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:u},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[va(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const Zi=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Nt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function es(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=Nt(a.slice(n));break}r+=Nt(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=Nt(a.slice(o));break}const l=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&Zi.has(p)?r+=`<${s[1]}${p}>`:r+=Nt(a.slice(o,i+1)),n=i+1}return r}const xn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ue({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function ts({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=O(),i=Ft(e),l=Je(e),s=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,u=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),c=g.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:u},{k:"suivi",lib:a.cdSuivi,n:d}].filter(v=>v.n>0),[e,a,s,l,p,u,d]),[m,h]=g.useState("");if(!c.length)return null;const f=c.some(v=>v.k===m)?m:c[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:c.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":f===v.k,className:f===v.k?"on":"",onClick:b=>{b.stopPropagation(),h(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[f==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(ue,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ue,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ue,{k:a.cdVerdictDate,v:xn(e.verdictDate,r)})]})]}),f==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:es(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(as,{o:e})]}),f==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ue,{k:a.cdSector,v:e.sector}),t.jsx(ue,{k:a.cdStage,v:e.stage}),t.jsx(ue,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ue,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ue,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ue,{k:a.cdAngle,v:e.angle}),t.jsx(ue,{k:a.cdDetected,v:xn(e.date,r)})]}),f==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ue,{k:a.cdName,v:e.contactName}),t.jsx(ue,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ue,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),f==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(ue,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(ue,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function as({o:e}){const{t:a,token:r}=O(),[n,o]=g.useState(!1),[i,l]=g.useState(null),s=async()=>{n||(o(!0),l(await qr(r,e.name,e.website||e.domain||"")),o(!1))},p=(i==null?void 0:i.blocs)||{},u=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=u.some(([,c])=>c);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[u.filter(([,c])=>c).map(([c,m])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:c}),t.jsx("p",{children:m})]},c)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function Yn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=O(),[l,s]=g.useState(!1),[p,u]=g.useState(null);if(!n.pipe||o!=="client"||n.lockActions)return null;const d=async()=>{if(l)return;s(!0);const c=await Or(r,e);if(s(!1),!c){i(a.actErr);return}u(c.results||[])};return t.jsxs("div",{className:"simb",onClick:c=>c.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{d()},children:l?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(c=>t.jsxs("li",{children:[t.jsx("b",{className:c.verdict==="kept"?"ok":"ko",children:c.company}),c.reason&&t.jsx("span",{children:c.reason})]},c.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Wn={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Sa({o:e}){const{t:a}=O(),r=Ft(e),n=Je(e),o=he(e),i=Qt(e),l=Fr(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(Wn[n]||"v-cons"),title:a.vt[n],children:n}):o===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,o===3&&i==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),o===3&&i==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),o===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}function hn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=O(),[i,l]=g.useState(!1);if(g.useEffect(()=>{n||l(!1)},[n]),ke(e)){const u=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":u?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[u?"✓":"✗"," ",t.jsx("b",{children:u?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,onClick:u=>{u.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),a.evalGo]})}function ns({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:l,doPromote:s,doRepeche:p,doApproach:u,dispatch:d}=O();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:h=>{h.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return t.jsx("span",{className:"cell",children:t.jsx(hn,{o:e})});const c=he(e),m=h=>f=>{f.stopPropagation(),h()};if(c===0)return t.jsx("span",{className:"cell",children:t.jsx(hn,{o:e})});if(c===1){const h=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:h,onClick:m(()=>i(e)),children:h?a.actAnalyseQueued:a.actAnalyse})})}if(c===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:m(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:m(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(c===4){const h=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:h,onClick:m(()=>u(e)),children:h?a.actApproachSent:a.actApproach})})}return c===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):c===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:m(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function rs({o:e}){const{t:a,doThumb:r,thumbOf:n}=O(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function os({o:e}){const{lang:a}=O();return fe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ze,{o:e}),t.jsx(Pt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[We(e.engine||"")," ",Re(e.engine||"",a)]})})}function is({o:e,locked:a,open:r,onToggle:n}){const{st:o,dispatch:i,caps:l,markRow:s,markedId:p,favIds:u,toggleFav:d}=O(),c=he(e),m=["#0F172A","#475C6E","#8798A8","#B9C6D2"],h=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,f=h<=0?0:h<=7?1:h<=30?2:3,v=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][c]:m[f],b=u.has(e.id),x=y=>{if(a)return;if(l.pipe){n();return}const N=y.currentTarget.getBoundingClientRect();i({type:"popup",id:e.id,anchor:{x:N.left+Math.min(280,N.width/3),y:N.bottom}})};return t.jsxs(g.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:x,children:[t.jsx("span",{className:"pt",style:{"--c":v}}),t.jsx(Zn,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:b?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:b?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""})]}),t.jsx(ss,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(os,{o:e}),l.pipe&&t.jsx(Sa,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(ns,{o:e}),l.showThumbs&&t.jsx(rs,{o:e})]}),(r||o.dens==="deplie")&&!a&&t.jsx(ls,{o:e})]})}function ss({o:e}){const{lang:a,caps:r}=O();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=ya(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function ls({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:l}=O();return t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),t.jsx(ts,{o:e}),t.jsx(Bo,{o:e}),t.jsx(Uo,{o:e}),t.jsx(Yn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("span",{children:e.sector}),e.stage&&t.jsx("span",{children:e.stage}),e.countryLabel&&t.jsx("span",{children:e.countryLabel}),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Sa,{o:e})})]}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[We(e.engine||"")," ",Re(e.engine||"",r)]}),fe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ze,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsxs("div",{className:"sec2 acts2",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})]})]})]})}function cs({o:e,locked:a}){const{t:r,dispatch:n,caps:o,doDecide:i}=O(),l=he(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":s},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Sa,{o:e}),fe(e)&&t.jsx(Ze,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&o.pipe&&l===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>i(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>i(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function ds(){const e=O(),{st:a,dispatch:r,t:n,caps:o,scoped:i,lang:l,sessTally:s,data:p,dossiers:u}=e,[d,c]=g.useState(new Set);g.useEffect(()=>{c(new Set)},[a.ptab,a.continent]);const m=k=>c(z=>{const R=new Set(z);return R.has(k)?R.delete(k):R.add(k),R}),h=g.useMemo(()=>ka(i,a.sort),[i,a.sort]),f=g.useMemo(()=>h.filter(k=>fe(k)&&!ke(k)).length,[h]),v=g.useMemo(()=>o.pipe?h:h.filter(k=>!ke(k)),[h,o.pipe]),b=o.pipe?n.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,x=(k,z,R="",j=!1)=>t.jsxs("button",{type:"button","data-s":k,className:R,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:j?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:k}),children:[z,t.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),y=g.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const k=new Map;h.forEach(j=>{const T=j.engine||"?";k.has(T)||k.set(T,[]),k.get(T).push(j)});const z={ma:0,fundraising:1,media:2},R=Jt([...k.keys()],l);return[...k.entries()].sort((j,T)=>{const A=z[j[0]]??10+R.indexOf(j[0]),L=z[T[0]]??10+R.indexOf(T[0]);return A-L})},[h,o.pipe,a.groupBy,l]),N=o.lockRowsAfter;let w=0;const S=(k,z)=>{const R=a.shown[z]||St,T=k.slice(0,R).map(A=>{const L=N!==null&&w>=N;return w++,a.dens==="maxi"?t.jsx(cs,{o:A,locked:L},A.id):t.jsx(is,{o:A,locked:L,open:d.has(A.id),onToggle:()=>m(A.id)},A.id)});if(k.length>R){const A=Math.min(St,k.length-R),L=k.length-R;T.push(t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:z,by:St}),children:[t.jsx("span",{className:"more-label",children:n.more(A,L)}),t.jsxs("span",{className:"more-meta",children:[n.moreMeta(R,k.length)," · ",L," ",l==="en"?"remaining":"restantes"]})]},z+":more"))}return T};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:h.length})," ",b]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),o.showFunnel&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["deplie",n.densOpen],["maxi",n.densMaxi]].map(([k,z])=>t.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>r({type:"dens",dens:k}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:z})]},k))}),o.showChain&&v.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:v.map(k=>k.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(v.length):n.chainAll(v.length)]})]}),f>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(f)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),x("country",n.colCountry),x("name",n.colCompany),x("amount",n.colAmount,"h-amt",!0),x("stage",n.colStage,"h-stade"),x("signal",n.colSignal,"h-sig"),o.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),o.pipe&&x("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[y?y.map(([k,z])=>t.jsxs(g.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:We(k)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Re(k,l)}),t.jsx("div",{className:"s",children:n.grpCount(z.filter(R=>!ke(R)).length,z.length)})]})]}),S(z,k)]},k)):S(h,"pt"+a.ptab),!h.length&&!(p.loading&&!u.length)&&t.jsx("div",{className:"void",children:o.pipe?n.emptyTab:n.emptyScope})]}),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}function ps({spec:e}){const a=g.useRef(null);return g.useEffect(()=>{const r=a.current;if(!r)return;let n=!1;return Dr({kind:"op",card:e},Math.max(240,r.clientWidth||320)).then(o=>{!n&&o&&r.isConnected&&r.replaceChildren(o)}),()=>{n=!0,r.replaceChildren()}},[e]),t.jsx("div",{ref:a,style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden"}})}const us=`
...
`;function fs(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function ms(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:l,askEvaluate:s,doAnalyse:p,doDecide:u,doPromote:d,doRepeche:c,doApproach:m,doDeep:h,doOnboard:f,outbound:v,evalBusy:b}=O(),x=e.popupId?r.get(e.popupId):null;if(!x)return null;const y=fe(x),N=he(x),w=Je(x),S=x.kind==="target",k=z=>{a({type:"filters",patch:z}),a({type:"popup",id:null})};return ut.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:us}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:fs(e.popupAnchor,!!x.card),onClick:z=>z.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:x.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Qe(x.date)),Re(x.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[x.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>k({country:[x.cc]}),children:(Xe(x.cc,o)||x.countryLabel||"").toUpperCase()}),x.sector&&t.jsx("button",{type:"button",onClick:()=>k({sector:[x.sector]}),children:x.sector.toUpperCase()}),x.stage&&t.jsx("button",{type:"button",onClick:()=>k({stage:[x.stage]}),children:x.stage.toUpperCase()}),typeof x.amountEur=="number"&&x.amountEur>0&&t.jsx("span",{className:"am2",children:ya(x.amountEur,o)})]}),(x.tagline||x.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:x.tagline||x.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[We(x.engine)," ",t.jsx("b",{children:Re(x.engine,o)})," — ",Pr(x.engine,o),x.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",x.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ze,{o:x,lg:!0})," ",t.jsx(Pt,{o:x,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Nn(y,o))," · ",n.win7(Sn(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),x.card?t.jsx(ps,{spec:x.card}):null,x.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&N>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:x.reasoning})]}),i.pipe&&S&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof x.score=="number"&&x.score>0?" · "+n.score(x.score):""]})})]}),t.jsx(Yn,{name:x.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||l!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[N===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:b,onClick:()=>s(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)]}),N===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),N===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),N===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(x,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{u(x,!1),a({type:"popup",id:null})},children:n.actNo}),va(x)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{h(x),a({type:"popup",id:null})},children:n.memoDeep})]}),N===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),N===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),x.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:x.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{f(x),a({type:"popup",id:null})},children:"🚀"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:b,onClick:()=>s(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)," →"]}),i.showDemand&&x.url&&x.engine==="media"&&t.jsx("button",{type:"button",className:"abtn",title:n.rsOpen,onClick:()=>{var z;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.url}}))}catch{}a({type:"popup",id:null}),(z=document.querySelector(".atl2 .demand"))==null||z.scrollIntoView({behavior:"smooth",block:"center"})},children:"🔎"}),x.website&&t.jsx("a",{className:"psite",href:x.website.startsWith("http")?x.website:"https://"+x.website,target:"_blank",rel:"noopener noreferrer",title:x.website,children:"🌐"})]})]})]}),document.body)}function gn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function xs(e,a){const r=Ir(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function hs(e,a){const n=[a.head.split("|").map(gn).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",xs(o,a.plabels),Ft(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(gn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function gs(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const bs=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ce({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function vs({o:e,qa:a}){const{t:r,lang:n,fund:o}=O(),i=(e.cribleStatus||"").trim().toUpperCase()||(Ft(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Je(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Ce,{k:r.cdSector,v:e.sector}),t.jsx(Ce,{k:r.cdStage,v:e.stage}),t.jsx(Ce,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ce,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Ce,{k:r.cdName,v:e.contactName}),t.jsx(Ce,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Ce,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ce,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ce,{k:r.cdAngle,v:e.angle}),t.jsx(Ce,{k:r.cdDetected,v:bs(e.date,n)})]}),p.some(([,u])=>u)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,u])=>u).map(([u,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:u}),t.jsx("p",{children:d})]},u))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function ys(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=O(),[s,p]=g.useState({}),u=25,d=g.useMemo(()=>n.slice(0,u),[n]);g.useEffect(()=>{d.length&&Br(r,d.map(h=>h.name)).then(p)},[r,d]);const c=i.stats,m=h=>h.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),c&&typeof c.screened=="number"&&t.jsxs("p",{children:[m(c.screened)," ",e.funScreened(""),typeof c.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",m(c.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(m(i.marketEstimate)),", ",Math.round(c.screened/i.marketEstimate*100)," %"]})]})]}),d.map(h=>t.jsx(vs,{o:h,qa:s[h.name]},h.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ws=50;function Ca({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=O(),[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(""),[c,m]=g.useState(0),[h,f]=g.useState(""),[v,b]=g.useState(!1),x=g.useRef(null);g.useEffect(()=>()=>{x.current&&window.clearInterval(x.current)},[]);const y=async w=>{p(!0),d("");const S=await a();if(p(!1),S.ok){l(S);return}if(S.busy){d(o.alertPreviewBusy);return}if(!w){d(o.alertPreviewFail);return}m(ws),x.current=window.setInterval(()=>{m(k=>k>1?k-1:(x.current&&window.clearInterval(x.current),y(!1),0))},1e3)},N=async()=>{if(n||v)return;b(!0),f("");const w=await r();b(!1),f(w.ok?o.alertTestOk(w.sentTo||""):w.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||c>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v,onClick:()=>{N()},children:v?"…":o.alertTest})]}),c>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(c)}),u&&t.jsx("p",{className:"mnote warn",children:u}),h&&t.jsx("p",{className:"mnote",children:h}),!h&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const st="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function xe({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=O();return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function ks(){const{st:e}=O();switch(e.modal){case"chain":return t.jsx(Ns,{});case"space":return t.jsx(Ss,{});case"alert":return t.jsx(Cs,{});case"queue":return t.jsx(Ls,{});case"export":return t.jsx(Rs,{});case"plug":return t.jsx(Os,{});case"recharge":return t.jsx(Ps,{});case"cover":return t.jsx(Is,{});case"dossier":return t.jsx(Ds,{});case"crit":return t.jsx(Bs,{});case"tuto":return t.jsx($s,{});case"rdv":return t.jsx(js,{});case"memoalert":return t.jsx(Ms,{});default:return null}}function js(){const{dispatch:e,fund:a}=O(),r=typeof document<"u"&&!!document.getElementById("rdv");return g.useEffect(()=>{r&&(e({type:"modal",modal:null}),Ro())},[r,e]),r?null:t.jsx(Ur,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Ns(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:s}=O(),p=i==="client",u=e.chain.queue.map(h=>r.get(h)).filter(h=>!!h),d=e.chain.idx,c=u[d],m=d>=u.length;return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:m?n.finished:`${d+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(m?100:d/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:m||!c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:c.name}),t.jsx("div",{className:"sub",children:[Xe(c.cc,o)||c.countryLabel,c.sector,c.stage,n.daysAgo(Qe(c.date))].filter(Boolean).map(h=>String(h).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Re(c.engine,o).toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&t.jsx("span",{children:ya(c.amountEur,o)})]}),fe(c)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ze,{o:c,lg:!0})," ",t.jsx(Pt,{o:c,src:!0})]}),(c.tagline||c.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:c.tagline||c.headline})]}),c.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:c.reasoning})]}),p&&ke(c)&&t.jsxs("div",{className:"vbox",style:{"--c":$e(c)==="retenu"?"var(--brand)":$e(c)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:$e(c)==="retenu"?"✓ "+n.kept:$e(c)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:c.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!m&&c&&!(p&&ke(c))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(c)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(m?{type:"modal",modal:null}:{type:"chainNext"}),children:m?n.closeBtn:n.skip})]})]})})}),document.body)}function Ss(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=O(),i=o==="client",l=g.useMemo(()=>i?r.filter(c=>ke(c)):[],[r,i]),s=g.useMemo(()=>ka(l.filter(c=>$e(c)==="retenu"),{key:"signal",dir:-1}),[l]),p=g.useMemo(()=>l.filter(c=>$e(c)==="ecarte"),[l]),u=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(xe,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),u.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),u.slice(0,40).map(c=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof c.score=="number"&&c.score>0?c.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:c.name}),t.jsx("div",{className:"rr",children:c.reasoning||c.tagline||""})]})]},c.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Cs(){const{mode:e}=O();return e==="client"||e==="apercu"?t.jsx(Es,{}):t.jsx(As,{})}function Es(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=O(),[i,l]=g.useState("d"),s=o!=="client";return t.jsxs(xe,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(zs,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(Ts,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(Gn,{})]})}function zs({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),Pa(a).then(v=>{f&&(v?l(v):p(!0))}),()=>{f=!1}},[a,u]);const c=f=>{r||Pa(a,f).then(v=>{if(!v){o(e.actErr);return}l(v),v.throttled?o(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=f=>!i.sections||i.sections.includes(f),h=f=>{const v=i.sections||e.alertSec.map(([b])=>b);c({sections:m(f)?v.filter(b=>b!==f):[...v,f]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>c({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>c({hour:Math.max(6,(i.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[i.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.min(21,(i.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:m(f),disabled:r,onChange:()=>h(f)}),t.jsxs("span",{children:[v,f==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},f))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ca,{label:e.alertPreview,readOnly:r,onPreview:()=>Qr(a),onTest:()=>Kr(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ts({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(0);g.useEffect(()=>{let f=!0;return p(!1),Da(a).then(v=>{f&&(v?l(v):p(!0))}),()=>{f=!1}},[a,u]);const c=f=>{r||Da(a,f).then(v=>{if(!v){o(e.actErr);return}l(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=i.dow??0,h=i.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>c({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:f=>c({dow:Number(f.target.value)}),children:e.alertDow.map((f,v)=>t.jsx("option",{value:v,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.max(6,h-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[h," h"]}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.min(21,h+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ca,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Xr(a),onTest:()=>Jr(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Gn(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=O(),[l,s]=g.useState(i||""),[p,u]=g.useState(!1),[d,c]=g.useState(!1);g.useEffect(()=>{i&&s(i)},[i]);const m=e.filters,h=g.useMemo(()=>n.filter(x=>fe(x)).length,[n]),f=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){c(!0);try{await fetch(`${xa}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:m.sector,countries:m.country,source:i?"atelier2-client":"atelier2",website:""})}),u(!0)}finally{c(!1)}}},b=[[a.amRows.continent,o],[a.amRows.since,a.amSince[f]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(x=>Re(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(x=>Xe(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:b.map(([x,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,h)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function As(){const{t:e}=O();return t.jsx(xe,{title:e.alertTitle,icon:"🔔",children:t.jsx(Gn,{})})}function Ls(){var v,b,x;const{t:e,token:a,fund:r,mode:n,flash:o}=O(),[i,l]=g.useState(null),[s,p]=g.useState([]),[u,d]=g.useState(0),c=n==="client";g.useEffect(()=>{let y=!0;return(async()=>{const[N,w]=await Promise.all([ga(r),kn(a)]);y&&(N&&l(N),p(w))})(),()=>{y=!1}},[a,r,u]);const m=(i==null?void 0:i.per_day)??2,h=((v=i==null?void 0:i.analyzed_today)==null?void 0:v.length)??0,f=(b=i==null?void 0:i.tomorrow)!=null&&b.length?i.tomorrow:((i==null?void 0:i.pool_meta)||[]).slice(0,10);return t.jsxs(xe,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(h,h+(((x=i==null?void 0:i.pool_order)==null?void 0:x.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(m)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),c&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Fa(a,y.company,"retry").then(()=>d(N=>N+1))},children:e.queueRetry}),c&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Fa(a,y.company,"delete").then(()=>d(N=>N+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[f.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),f.slice(0,10).map((y,N)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",N+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Rs(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=O(),s=`${st}/cibles/list.csv?token=${a}`,p=`${st}/cibles/list.json?token=${a}`,u=`${st}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,c=b=>{var x;(x=navigator.clipboard)==null||x.writeText(b).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:u,href:u}],h=!o.lockActions&&n.length>0,f=()=>{gs(hs(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:b=>(e.stg.find(([x])=>x===b)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(xe,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:b,value:x,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:b[0]}),t.jsxs("div",{children:[t.jsx("b",{children:b[1]}),t.jsx("p",{children:b[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c(x),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},b[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ms(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=O(),i=o!=="client",[l,s]=g.useState(null),[p,u]=g.useState(!1),[d,c]=g.useState(0),[m,h]=g.useState(!1);g.useEffect(()=>{let x=!0;return u(!1),Oa(a).then(y=>{x&&(y?s(y):u(!0))}),()=>{x=!1}},[a,d]);const f=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=x=>{if(i||!l)return;const y={enabled:x.enabled??!!l.enabled,email:x.email??(l.email||""),sections:x.sections??f()};h(!0),Oa(a,y).then(N=>{if(h(!1),!N){n(e.memoAlertErr);return}s(N),r(e.memoAlertSaved)})};if(p)return t.jsx(xe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(x=>x+1),children:e.retry})]})});if(!l)return t.jsx(xe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const b=f();return t.jsxs(xe,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||m,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(qs,{value:l.email||"",readOnly:i||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>v({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!b[x],disabled:i||m,onChange:()=>v({sections:{...b,[x]:!b[x]}})}),t.jsx("span",{children:y})]},x))}),t.jsx(Ca,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>_r(a,b),onTest:()=>$r(a,b)})]})}function qs({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=g.useState(e);g.useEffect(()=>{l(e)},[e]);const s=i.trim()!==e.trim(),p=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:u=>l(u.target.value),onKeyDown:u=>{u.key==="Enter"&&s&&p&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>o(i.trim()),children:n})]})]})}function Os(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=O(),[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,d]=g.useState(null),[c,m]=g.useState(""),[h,f]=g.useState(0);g.useEffect(()=>{let x=!0;return p(!1),Xt(a).then(y=>{x&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),Hr(a).then(y=>{x&&d(y)}),()=>{x=!1}},[a,h]);const v=(x,y)=>{o&&Xt(a,x).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}x.test&&N.sent===!1?n(e.plugTestThrottled):r(y),f(w=>w+1)})},b='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(xe,{title:e.plugTitle,icon:"🔌",wide:!0,children:[u&&t.jsx("p",{className:"mnote"+(u.enabled?" warn":""),children:u.enabled?e.plugAutoOn(u.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(x=>x+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:c,disabled:!o,onChange:x=>m(x.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!c.trim(),onClick:()=>v({url:c.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(Fs,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:b}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(b).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function Fs(){const{t:e,token:a,lang:r}=O(),[n,o]=g.useState("valides"),[i,l]=g.useState(!1),[s,p]=g.useState(null),[u,d]=g.useState(null),[c,m]=g.useState(!1),[h,f]=g.useState(!1),[v,b]=g.useState(null),[x,y]=g.useState(null),[N,w]=g.useState(null),S=`atl2:bulk:${a}:${n}`;g.useEffect(()=>{Xt(a).then(L=>{y(L&&L.configured?L.url_hint||"webhook":null)})},[a]),g.useEffect(()=>{p(null),d(null),m(!1),b(null);try{const L=JSON.parse(localStorage.getItem(S)||"null");w(L&&Date.now()-Date.parse(L.t)<24*3600*1e3?L:null)}catch{w(null)}},[S]);const k=async()=>{l(!0),m(!1),b(null);const L=await Wr(a,n);p(L),d(L.ok?n:null),l(!1)},z=g.useRef(!1),R=async()=>{if(z.current)return;z.current=!0,f(!0);const L=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let F;try{F=await Gr(a,n,"webhook",void 0,L)}finally{z.current=!1}if(f(!1),m(!1),b(F),F.ok&&(F.pushed||0)>0){const P={t:new Date().toISOString(),n:F.pushed||0};w(P);try{localStorage.setItem(S,JSON.stringify(P))}catch{}}},j=s!=null&&s.ok&&s.ready||0,T=!!(s!=null&&s.ok)&&u===n&&j>0&&!!x&&!N,A=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:L=>o(L.target.value),children:e.plugBulkTabs.map(([L,F])=>t.jsx("option",{value:L,children:F},L))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{k()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(A,N.n)}),!N&&!!(s!=null&&s.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),T&&!c&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>m(!0),children:e.bulkArm}),T&&c&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(j,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{R()},children:h?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>m(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function Ps(){const{t:e,data:a,lang:r}=O(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const s=window.location.href.split("?")[0];try{const u=await(await fetch(`${xa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();u.url&&(window.location.href=u.url)}catch{}};return t.jsxs(xe,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ds(){const{t:e}=O();return t.jsx(xe,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(ys,{})})}function Is(){const{t:e,lang:a,data:r,dossiers:n,token:o,canWrite:i,flash:l}=O(),[s,p]=g.useState(null),[u,d]=g.useState(!1);g.useEffect(()=>{let k=!0;return ga(o).then(z=>{k&&z&&typeof z.per_day=="number"&&p(z.per_day)}),()=>{k=!1}},[o]);const c=r.stats,m=typeof(c==null?void 0:c.screened)=="number"?c.screened:n.filter(k=>k.kind==="target"&&ke(k)).length,h=r.marketEstimate||0,f=h>0?Math.min(100,Math.round(m/h*100)):null,v=(c==null?void 0:c.window_days)||30,b=m>0?m/v:0,x=h>0?Math.max(0,h-m):0,N=h>0&&b>0&&m>=100?Math.round(x/b):null,w=k=>Math.round(k).toLocaleString(a==="en"?"en-US":"fr-FR"),S=k=>{u||!i||(d(!0),Yr(o,k).then(z=>{if(d(!1),z===null){l(e.actErr);return}p(z),l(e.alertSaved)}))};return t.jsxs(xe,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(m))}),h>0&&t.jsx("span",{children:e.covOf(w(h))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),b>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(b))}),c&&t.jsxs("div",{className:"covf",children:[typeof c.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.kept)})," ",e.covKept]}),typeof c.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.analyzed)})," ",e.covAna]}),typeof c.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.shown)})," ",e.covShown]})]}),i&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(k=>t.jsx("button",{type:"button",className:s===k?"on":"",disabled:u,onClick:()=>S(k),children:k===0?"⏸":k},k))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Bs(){var x,y,N;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i}=O(),l=n==="client",s=g.useMemo(()=>{const w=new Set;return a.forEach(S=>{S.angle&&w.add(S.angle)}),[...w]},[a]),[p,u]=g.useState(null);g.useEffect(()=>{let w=!0;return Vr(r).then(S=>{w&&u(S.thumbs)}),()=>{w=!1}},[r]);const[d,c]=g.useState(""),[m,h]=g.useState(""),[f,v]=g.useState(!1),b=async()=>{const w=d.trim();if(!(!w||f||!l)){v(!0),h("");try{const k=await(await fetch(`${st}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(k.reply&&h(String(k.reply)),k.job_id){h(e.critChatRunning);const z=async()=>{const R=await fetch(`${st}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:k.job_id})}).then(j=>j.json()).catch(()=>null);if(R&&R.done){h(String(R.reply||R.clarification||R.summary||"✓")),v(!1),R.applied&&o(e.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),c("");return}c("")}finally{m.startsWith("⏳")||v(!1)}}};return t.jsxs(xe,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((x=i.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var S,k;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((S=w.look)!=null&&S.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(z=>t.jsx("li",{children:z},z))})]}),!!((k=w.out)!=null&&k.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(z=>t.jsx("li",{children:z},z))})]})]})]},w.title)})]}),!!((N=i==null?void 0:i.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!l||f,onChange:w=>c(w.target.value),onKeyDown:w=>{w.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!l||f||!d.trim(),onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,S)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},S))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,S])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Wn[w]||"v-cons"),children:w}),t.jsx("span",{children:S})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,S])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",S]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function $s(){const{t:e,dispatch:a,startTour:r}=O(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(xe,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const Kt={},bn=(Kt==null?void 0:Kt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ot(){return new Date().toISOString().slice(0,10)}const Kn=g.createContext(null);function Qn(){const e=g.useContext(Kn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function _s({token:e,children:a}){const{dispatch:r,st:n,lang:o}=O(),[i,l]=g.useState(()=>n.filters.day||Ot()),[s,p]=g.useState(null),[u,d]=g.useState(!1),c=g.useCallback(f=>{if(/^\d{4}-\d{2}-\d{2}$/.test(f)){l(f);try{r({type:"filters",patch:{day:f,win:"all"}})}catch{}}},[r]);g.useEffect(()=>{n.filters.day||c(Ot())},[]),g.useEffect(()=>{const f=v=>{var x;const b=(x=v.detail)==null?void 0:x.day;typeof b=="string"&&c(b)};return window.addEventListener("pp-edition-day",f),()=>window.removeEventListener("pp-edition-day",f)},[c]),g.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),g.useEffect(()=>{if(!e||!i)return;let f=!1;d(!0);const v=new URLSearchParams({token:e,date:i});return fetch(`${bn}/cibles/edition.json?${v}`).then(b=>b.json()).then(b=>{f||p(b)}).catch(()=>{f||p({ok:!1,error:"network"})}).finally(()=>{f||d(!1)}),()=>{f=!0}},[e,i]);const m=g.useMemo(()=>`${bn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),h=g.useMemo(()=>({token:e,day:i,ed:s,loading:u,pickDay:c,daysUrl:m,isEn:o==="en"}),[e,i,s,u,c,m,o]);return t.jsx(Kn.Provider,{value:h,children:a})}function Us(){const{day:e,daysUrl:a,pickDay:r,isEn:n}=Qn();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsx("p",{className:"thesis-days__h",children:n?"Thesis brief · pick a day":"Brief thèse · choisir un jour"}),t.jsx(Zr,{mode:"local",theme:"light",month:e.slice(0,7),current:e,daysUrl:a,onPick:r})]})}function Vs(){const{day:e,ed:a,loading:r,pickDay:n,isEn:o}=Qn(),i=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!i,s=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!i&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),s&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),l&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["No thesis brief for ",t.jsx("b",{children:e})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):t.jsxs(t.Fragment,{children:["Pas encore de brief de thèse pour le ",t.jsx("b",{children:e}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),i&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,i&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,e&&e!==Ot()&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:()=>n(Ot()),children:o?"← Back to today":"← Revenir à aujourd’hui"})]})}const Jn="atl2:mapfold",Hs=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Jn);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Xn=g.createContext(null),O=()=>{const e=g.useContext(Xn);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ze({o:e,lg:a}){const{lang:r}=O(),n=fe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ia(n,r),children:[n.emoji," ",Ia(n,r)]}):null}function Pt({o:e,src:a}){const{lang:r,t:n}=O(),o=fe(e);if(!o)return null;const i=ro(o),l=oo(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Nn(o,r))+" · "+n.win7(Sn(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<i?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Zn({o:e}){const{lang:a}=O(),r=no(e.cc),n=e.cc?Xe(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const vn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",er=e=>`atl2:tour:${e||"anon"}`;function Ys(e){try{return localStorage.getItem(er(e))==="1"}catch{return!0}}function yn(e){try{localStorage.setItem(er(e),"1")}catch{}}function Ws(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function Zs({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){const{lang:l}=eo(),s=mo[l],p=So(e,l,a),[u,d]=g.useReducer(Eo,void 0,()=>Co((n==null?void 0:n.continent)??"europe",e||Hs(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),c=g.useRef(!0);g.useEffect(()=>{if(c.current){c.current=!1;return}if(!e)try{localStorage.setItem(Jn,u.mapFolded?"on":"off")}catch{}},[u.mapFolded,e]);const m=g.useRef(i);m.current=i,g.useEffect(()=>{var C;(C=m.current)==null||C.call(m,u.filters)},[u.filters]);const[h,f]=g.useState(null),[v,b]=g.useState(null),[x,y]=g.useState({kept:0,dropped:0}),[N,w]=g.useState(!1),[S,k]=g.useState(""),[z,R]=g.useState(!1),[j,T]=g.useState(null),[A,L]=g.useState(!1),[F,P]=g.useState(!1),[,E]=g.useState(0),M=()=>E(C=>C+1),H=g.useRef([]),W=g.useRef(new Set),Z=g.useRef(new Set),me=g.useRef(new Map),B=g.useRef(null),{mode:ie}=p,_=g.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[p.caps,o,a]),Y=_.pipe,$=p.session.token||"",G=ie==="client"&&!e;g.useEffect(()=>{if(document.querySelector(`link[href="${vn}"]`))return;const C=document.createElement("link");C.rel="stylesheet",C.href=vn,document.head.appendChild(C)},[]);const U=(C,D=!1)=>{k(C),R(D),B.current&&clearTimeout(B.current),B.current=setTimeout(()=>k(""),D?4200:2400)},ne=C=>U(C,!0),ae=g.useMemo(()=>{const C=new Map;return p.dossiers.forEach(D=>{D.id&&C.set(D.id,D)}),C},[p.dossiers]),pe=g.useMemo(()=>p.dossiers.filter(C=>En(C,u,Y)),[p.dossiers,u,Y]),se=g.useRef(!1);g.useEffect(()=>{if(se.current||e||p.loading||!p.dossiers.length)return;if(!_.showFunnel||Ys(p.session.token||"")){se.current=!0;return}se.current=!0;const C=window.setTimeout(()=>{yn(p.session.token||""),L(!0)},700);return()=>window.clearTimeout(C)},[e,p.loading,p.dossiers.length,_.showFunnel,p.session.token]);const ce=g.useMemo(()=>p.dossiers.filter(C=>zo(C,u,Y,p.favIds)),[p.dossiers,u,Y,p.favIds]),Me=g.useMemo(()=>to(pe,p.favIds),[pe,p.favIds]),K=ba.find(C=>C.key===u.continent),ge=u.continent==="monde"?s.contWorld:(l==="fr"?K==null?void 0:K.fr:K==null?void 0:K.en)||"";g.useEffect(()=>{const C=D=>{var le;const I=(((le=D.detail)==null?void 0:le.name)||"").trim();I&&Ne(null,I)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)});const Ne=(C,D)=>{const I=((C==null?void 0:C.name)||D||"").trim();if(!G){b({kicker:I});return}!I||N||(w(!0),(async()=>{try{const le=await jn($,I,"atelier2"),mt={name:le.company||I,verdict:le.verdict,reason:le.reason||"",remaining:le.remaining??null};H.current=[mt,...H.current].slice(0,8),le.verdict==="kept"&&y(De=>({...De,kept:De.kept+1})),le.verdict==="ruled_out"&&y(De=>({...De,dropped:De.dropped+1}));const et=C||p.dossiers.find(De=>(De.name||"").toLowerCase()===I.toLowerCase());et&&(le.verdict==="kept"?et.verdict=et.verdict||"MATCH":le.verdict==="ruled_out"&&(et.verdict="NO MATCH"),le.reason&&(et.reasoning=le.reason)),M()}finally{w(!1)}})())},qe=C=>{if(!G){b({kicker:C.name});return}W.current.add(C.id),tt($,"fast_request",C.name||"",""),U(s.memoInstantSent(C.name)),M()},Te=C=>me.current.get(C.id)??p.thumbs.get((C.name||"").trim().toLowerCase()),q=(C,D)=>d({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:D}}),Q=async(C,D,I)=>{const le=C.ceoStatus||"";C.ceoStatus=D,M();const mt=await _t($,{status:D,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...(I==null?void 0:I.note)!==void 0?{note:I.note}:{},...I!=null&&I.via?{via:I.via}:{}});return mt.ok?mt.skipped?(C.ceoStatus=le,M(),ne(s.actNotPersisted),!1):((I==null?void 0:I.undo)!==!1&&q(C,le),I!=null&&I.msg&&U(I.msg),(D==="Validé"||D==="Écarté")&&!C.ceoNote&&(I==null?void 0:I.note)===void 0&&T({o:C,yes:D==="Validé"}),!0):(C.ceoStatus=le,M(),ne(s.actErr),!1)},te=async(C,D)=>{const I=await _t($,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:D,via:"note"});return!I.ok||I.skipped?(ne(I.skipped?s.actNotPersisted:s.actErr),!1):(C.ceoNote=D,M(),!0)},J=g.useRef(new Map),Se=C=>J.current.has(C.id)?J.current.get(C.id):p.stages.get((C.name||"").trim().toLowerCase()),Oe=(C,D)=>{J.current.set(C.id,D),M()},Fe=(C,D)=>{G&&Q(C,D?"Validé":"Écarté",{msg:D?s.decidedYes(C.name):s.decidedNo(C.name)})},ft=C=>{G&&Q(C,"À trancher",{msg:s.promoted(C.name)})},Dt=C=>{G&&(async()=>{const D=C.ceoStatus||"";C.ceoStatus="Retenu",M();const I=await _t($,{status:"Retenu",check_id:C.checkId,company:C.name});if(!I.ok||I.skipped){C.ceoStatus=D,M(),ne(I.skipped?s.actNotPersisted:s.actErr);return}q(C,D),U(s.repeched(C.name))})()},It=()=>{const C=u.undo[u.undo.length-1];if(!C){U(s.undoNone);return}const D=ae.get(C.id);if(!D){d({type:"undoPop"}),U(s.undoNone);return}let I=C.prevCeoStatus;if(!I)if((D.verdict||"").toUpperCase().includes("CALL"))I="À trancher";else{U(s.undoLockedTitle);return}(async()=>await Q(D,I,{undo:!1})&&(d({type:"undoPop"}),D.ceoStatus=C.prevCeoStatus,M(),U(s.undoDone(D.name))))()},Pe=C=>{G&&(Z.current.add(C.id),M(),(async()=>{const D=await io($,C.name,"email");if(!D||D.ok===!1){Z.current.delete(C.id),M(),ne(s.actErr);return}tt($,"approach",C.name||"",""),U(s.actApproachSent)})())},tr=(C,D)=>{G&&(async()=>{if(!(await tt($,D?"yes":"no",C.name||"","")).ok){ne(s.actErr);return}me.current.set(C.id,D?"yes":"no"),M(),U(D?s.thumbUpDone:s.thumbDnDone)})()},ar=C=>{!G||!va(C)||(tt($,"detailed_request",C.name||"",""),U(s.memoDeepSent(C.name)))},nr=C=>{const D=new Set(p.favIds),I=D.has(C.id);I?D.delete(C.id):D.add(C.id),p.setFavIds(D),G&&so($,{id:C.id,co:C.name},I)},rr=()=>{!G||F||window.confirm(s.identSyncConfirm)&&(P(!0),(async()=>{const C=await lo($);P(!1),C?U(s.identSyncDone):ne(s.actErr)})())},Ea=/proplace/i.test(p.fund||""),or=C=>{!G||!Ea||(tt($,"onboard_request",C.name||"",""),U(s.onboardSent(C.name)))},ir={st:u,dispatch:d,t:s,lang:l,mode:ie,caps:_,pipe:Y,token:$,fund:p.fund,email:p.email,criteria:p.criteria,data:p,doRepeche:Dt,thumbOf:Te,canWrite:G,commitStatus:Q,saveNote:te,stageOf:Se,setStage:Oe,flashErr:ne,startTour:()=>L(!0),dossiers:p.dossiers,scopedAll:pe,scoped:ce,counts:Me,byId:ae,contName:ge,favIds:p.favIds,toggleFav:nr,askEvaluate:Ne,doAnalyse:qe,doDecide:Fe,doPromote:ft,doApproach:Pe,doThumb:tr,doDeep:ar,doUndo:It,doSync:rr,doOnboard:or,outbound:Ea,memoQueued:W.current,approachDone:Z.current,sessTally:x,evalCards:H.current,evalBusy:N,markRow:f,markedId:h,flash:U};g.useEffect(()=>{const C=D=>{D.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const sr=C=>$?t.jsx(_s,{token:$,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(Xn.Provider,{value:ir,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:go}),sr(t.jsxs("div",{className:"app"+(Y?" pipe":"")+($?" has-thesis":""),children:[_.showTicker&&t.jsx(de,{name:"live",children:t.jsxs("div",{className:"live-stack"+($?" live-stack--cibles":""),children:[t.jsx(To,{}),!!$&&t.jsx(Us,{})]})}),_.showIdent&&t.jsx(de,{name:"identite",children:t.jsx(Yo,{})}),_.showOnb&&t.jsx(de,{name:"onboarding",children:t.jsx(Wo,{})}),_.showMorning&&t.jsx(de,{name:"matin",children:t.jsx(Ho,{})}),t.jsx(de,{name:"fraicheur",children:t.jsx(Po,{})}),t.jsx(de,{name:"mesure",children:t.jsx(Do,{})}),_.showFunnel&&t.jsx(de,{name:"entonnoir",children:t.jsx(Gs,{})}),_.showFunnel&&t.jsx(de,{name:"tunnel",children:t.jsx(Ko,{})}),_.showFunnel&&t.jsx(de,{name:"tuto",children:t.jsx(Jo,{})}),t.jsx(de,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Ks,{}),t.jsxs("div",{className:"stage"+(u.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Hi,{}),t.jsx(Wi,{})]})]})}),_.showDemand&&t.jsx(de,{name:"evaluation",children:t.jsx(Qi,{})}),_.showDemand&&u.memoConsole&&t.jsx(de,{name:"console",children:t.jsx(Xi,{})}),t.jsx(de,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(ds,{})}),!!$&&t.jsx(de,{name:"edition",children:t.jsx(Vs,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),_.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),u.popupId&&t.jsx(de,{name:"fiche",children:t.jsx(ms,{})}),t.jsx(de,{name:"modales",children:t.jsx(ks,{})}),t.jsx(qo,{}),j&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:j.o.name}),t.jsx(_o,{placeholder:j.yes?s.whyYesPh:s.whyNoPh,onDone:C=>{const D=j.o;T(null),C&&te(D,C).then(I=>{I&&U(s.csNoteSaved)})}})]}),A&&t.jsx(Vo,{steps:Ws(s),onClose:()=>{L(!1),yn($)}}),S&&t.jsx("div",{className:"flash on"+(z?" err":""),children:S}),v&&t.jsx(ao,{variant:"acquirer",initialCompany:wn().co,initialWebsite:wn().site,onClose:()=>b(null)})]})})}function Gs(){const{t:e}=O(),[a,r]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Ks(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:o,t:i}=O(),l=g.useMemo(()=>{const s={};return e.forEach(p=>{wa(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[co.map(s=>{const p=ba.find(d=>d.key===s),u=s==="monde"?i.contWorld:o==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[u,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?i.showMap:i.hideMap})})]})}function wn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Qs(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Zn as FlagCell,Ze as SigBadge,Pt as SigWin,Zs as default,Qs as fmtShort,O as useV2};
