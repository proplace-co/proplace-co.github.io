...
/* Sticky : uniquement au-dessus de la liste, 2 rangées.
   1) compte + Tout + Évaluer   2) recherche / filtres / alerte */
body.pp-desk .atl2.ops .listhead.mapoff{
  flex-wrap:wrap;align-items:center;gap:8px 10px;padding:8px 14px 10px}
...
body.pp-desk .atl2.ops .listhead.mapoff .fstrip{
  flex:1 0 100%;width:100%;display:flex;flex-direction:row;flex-wrap:nowrap;
  align-items:center;gap:8px;padding:8px 0 0;margin:0;border-top:1px solid var(--line);
  order:9}
