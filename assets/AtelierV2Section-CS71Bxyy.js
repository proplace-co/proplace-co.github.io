...
.atl2 .bulk .side .hint{white-space:nowrap}`,ar=`
...
`,rr=tr+ar;function nr(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function or(t,a){return t||a.mode!=="client"||!a.token?"visiteur":nr("teaser")==="1"?"apercu":"client"}const ir={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},lr=t=>ir[t],me=t=>Object.assign(t,{continent:ha(t.cc)});function He(t){const a=new Set,n=[];for(const r of t){const i=(r.name||"").toLowerCase();!i||a.has(i)||(a.add(i),n.push(r))}return n}const sr=60*60*1e3;function dr(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>sr?null:a}catch{return null}}function Me(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const cr=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function pr(t,a,n="default"){const r=n!=="default",i=p.useMemo(()=>t||r?{mode:"anon"}:ca(),[t,r]),o=p.useMemo(()=>r?"visiteur":or(t,i),[t,i,r]),d=p.useMemo(()=>lr(o),[o]),l=o!=="visiteur",c=cr(n),[m,h]=p.useState([]),[s,b]=p.useState(""),[v,g]=p.useState(null),[f,x]=p.useState(null),[u,y]=p.useState(null),[C,w]=p.useState(()=>new Map),[k,N]=p.useState(()=>new Map),[z,S]=p.useState(""),[T,M]=p.useState(new Set),[D,E]=p.useState(null),[P,L]=p.useState(!0),[I,F]=p.useState(!1),[_,ie]=p.useState(0),[ce,Oe]=p.useState(0),ge=p.useRef(0),pe=p.useMemo(()=>{var V;if(o!=="client")return"";try{return((V=pa())==null?void 0:V.email)||""}catch{return""}},[o]);p.useEffect(()=>{const V=++ge.current;let U=!0;const q=()=>U&&V===ge.current,B=(l&&i.token?i.token:"pub:"+a)+(c?":"+c:""),H=dr(B);return H?(h(H.objs.map(me)),H.fund&&b(H.fund),g(H.marketEstimate??null),x(H.criteria??null),y(H.stats??null),S(H.generatedAt||""),L(!1)):L(!0),(async()=>{try{if(n==="ops"){const ne=await $e(),ae=((ne==null?void 0:ne.recent_ops)||[]).map(J=>Ve(J,a)).filter(J=>!!J);if(!q())return;h(ae.map(me)),Me(B,{objs:ae})}else if(typeof n=="object"){const ae=(await st()||[]).filter(X=>(X.slug||"")===n.research).map(X=>dt(X,a)).filter(X=>!!X),J=He(await ct(ae,a));if(!q())return;h(J.map(me)),Me(B,{objs:J})}else if(l&&i.token){const ne=ua(i.token),ae=$e(),J=fa(i.token),X=ma(i.token),Ne=xa(i.token),$=await ne;let le=$?$.targets:[];q()&&$&&(b($.fund||""),g($.marketEstimate??null),x($.criteria??null),y($.stats??null),S($.generatedAt||""),h(le.map(me)),L(!1),F(!1));const[ue,Se,he,re]=await Promise.all([ae,J,X,Ne]),be=((ue==null?void 0:ue.recent_ops)||[]).map(oe=>Ve(oe,a)).filter(oe=>!!oe);if(le=[...le,...be],!q())return;h(le.map(me));const Ce=new Set;for(const oe of Se){const ve=(oe.id||oe.co||"").toString().trim().toLowerCase();ve&&Ce.add(ve.startsWith("t:")?ve:"t:"+ve)}M(Ce),w(he),N(re),$&&Me(B,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:le})}else{const ne=ga(),ae=st(),J=$e(),X=await ne;q()&&X.length&&(h(He(X).map(me)),L(!1),F(!1));const[Ne,$]=await Promise.all([ae,J]),le=(Ne||[]).map(re=>dt(re,a)).filter(re=>!!re),ue=await ct(le,a),Se=(($==null?void 0:$.recent_ops)||[]).map(re=>Ve(re,a)).filter(re=>!!re),he=He([...X,...ue,...Se]);if(!q())return;h(he.map(me)),Me(B,{objs:he})}q()&&F(!1)}catch{q()&&!H&&F(!0)}finally{q()&&L(!1)}})(),()=>{U=!1}},[l,i.token,a,_,c]),p.useEffect(()=>{if(!d.showCredits||!pe){E(null);return}let V=!0;return(async()=>{try{const U=await fetch(`${Ge}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:pe})});if(!U.ok)return;const q=await U.json();V&&q&&q.ok!==!1&&E(q)}catch{}})(),()=>{V=!1}},[d.showCredits,pe,ce]);const Y=p.useCallback(V=>M(new Set(V)),[]);return{session:i,mode:o,caps:d,fund:s,email:pe,marketEstimate:v,generatedAt:z,criteria:f,stats:u,thumbs:C,stages:k,dossiers:m,favIds:T,setFavIds:Y,credits:D,reloadCredits:()=>Oe(V=>V+1),loading:P,error:I,refresh:()=>ie(V=>V+1)}}const qt=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),ur=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...qt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function fr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:qt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ie)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ie=60;function tt(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!Q(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Ke(t)))return!1;if(r!=="win"){if(a.day){if((t.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(we(t.date)>i)return!1}}if(r!=="status"&&!n&&a.status!=="all"&&de(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Pt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:tt(t,a.filters,n)}function mr(t,a,n,r){return!(!Pt(t,a,n)||n&&!ba(t,a.ptab,r))}function at(t,a){const n=a.key,r=i=>{switch(n){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-we(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=Q(i);return o?100-(o.left??0):-1}}};return[...t].sort((i,o)=>{const d=r(i),l=r(o);return d<l?-a.dir:d>l?a.dir:(i.name||"").localeCompare(o.name||"")})}function xr(){const{dossiers:t,st:a,t:n,dispatch:r,contName:i,pipe:o}=A(),d=p.useMemo(()=>{const c=s=>o?!0:s.continent===a.continent,m=t.filter(s=>c(s)&&Q(s)),h=t.filter(s=>c(s)&&s.kind==="op"&&!Q(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&we(s.date)<=2);return h.sort((s,b)=>(b.amountEur||0)-(s.amountEur||0)),[...at(m,{key:"signal",dir:-1}),...h].slice(0,40)},[t,a.continent,o]),l=c=>d.map(m=>e.jsxs("button",{type:"button",className:"tk"+(Z(m)?" spent":""),onClick:h=>{const s=h.currentTarget.getBoundingClientRect();r({type:"popup",id:m.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:m.name+(m.tagline?" — "+m.tagline:""),children:[e.jsx(je,{o:m}),e.jsxs("span",{className:"who",children:[e.jsx(Ht,{o:m}),e.jsx("span",{className:"co",children:m.name})]}),typeof m.amountEur=="number"&&m.amountEur>0&&e.jsx("span",{className:"am",children:Mn(m.amountEur)}),m.sector&&e.jsx("span",{className:"mt",children:m.sector}),e.jsx(Be,{o:m}),e.jsx("span",{className:"tkgo",children:"→"})]},c+(m.id||m.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:d.length})]}),e.jsx("div",{className:"win",children:d.length?e.jsxs("div",{className:"run",children:[l(0),l(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(i)})})})]})}const gr="aDx8z7Hzksus",It="+33 6 83 10 72 86",vt="alexandre@proplace.co",hr=`tel:${It.replace(/[^\d+]/g,"")}`,yt="pp-rdv-slot";function br(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function vr(){const{t,caps:a,fund:n}=A(),r=a.showOnb,i=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:wr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:hr,children:It}),t.rdvSubMid,e.jsx("a",{href:`mailto:${vt}`,children:vt})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(i).map(([o,d],l)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(l+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:d})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Ja,{filloutId:gr,parameters:n?{company_name:n}:void 0})})]})}function yr(){const[t,a]=p.useState(()=>typeof document>"u"?null:document.getElementById(yt));return p.useEffect(()=>{t||a(document.getElementById(yt))},[t]),t?Ae.createPortal(e.jsx(vr,{}),t):null}const wr=`
...
`;class G extends p.Component{constructor(){super(...arguments);it(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const kr=8;function jr(){const{t,lang:a,token:n,dossiers:r,caps:i,markRow:o,dispatch:d}=A(),[l,c]=p.useState(!1),[m,h]=p.useState(!1),[s,b]=p.useState(!1),v=n||"home",{names:g,verdicts:f}=p.useMemo(()=>{const w=[],k={};return r.forEach(N=>{N.kind!=="target"||!N.name||(w.push(N.name),k[N.name]=va(N)||"")}),{names:w,verdicts:k}},[r]),x=p.useMemo(()=>g.length?ya(v,g,f,a):null,[v,g.length]);if(!i.pipe||l||!x||x.firstVisit||!x.added.length&&!x.gone.length)return null;const u=m?x.added:x.added.slice(0,kr),y=x.added.length-u.length,C=w=>{const k=r.find(N=>N.name===w);k&&(o(k.id),d({type:"popup",id:k.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(x.added.length,x.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{c(!0),wa(v,g,f,x.fp,a)},children:"×"})]}),!!x.added.length&&e.jsxs("div",{className:"since-c",children:[u.map(w=>e.jsx("button",{type:"button",onClick:()=>C(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(y)})]}),!!x.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>b(w=>!w),children:t.sinceOut(x.gone.length)}),s&&x.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const _e=600,xe=62,wt="atl2:fstats";function Nr(){const{t,lang:a,data:n,caps:r,st:i,dispatch:o}=A(),[d,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(wt)==="on"}catch{return!1}}),c=n.stats,m=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),h=p.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!r.showFunnel||!c||typeof c.screened!="number")return null;const s=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,b=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=m.reduce((y,C)=>Math.max(y,C.s||0),0),g=m.length?_e/m.length:0,f=Math.max(4,g-4),x=m.length>=5&&v>0,u=[[c.screened,t.funScreened(s(h)),c.screened_today],...typeof c.kept=="number"?[[c.kept,t.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,t.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(d?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[u.map(([y,C,w],k)=>e.jsxs("span",{className:"fst-t",children:[k>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:b(y)}),e.jsx("i",{children:C}),d&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},C)),x&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!d;l(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(wt,y?"on":"off")}catch{}},children:d?"⌃":"⌄"})]}),d&&x&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${_e} ${xe}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[m.map((y,C)=>{const w=(y.s||0)/v*(xe-4),k=(y.m||0)/v*(xe-4),N=C*g+(g-f)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${s(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:N,y:xe-2-w,width:f,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:N,y:xe-2-k,width:f,height:k,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:xe-1.5,x2:_e,y2:xe-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:s(m[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const Sr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Cr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:i}=A(),[o,d]=p.useState(""),[l,c]=p.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const m=(t.ceoStatus||"").trim(),h=(Le(t)||"").startsWith("CALL")&&te(t)===3,s=te(t)>=2,b=async g=>{if(o||g==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(g);const f=await i(t,g);d(""),f&&(c(!0),setTimeout(()=>c(!1),2200))},v=h?[["Validé",a.csYes],["Écarté",a.csNo]]:Sr.filter(([g])=>!(s&&g==="Retenu")).map(([g,f])=>[g,a[f]]);return e.jsxs("div",{className:"csp",onClick:g=>g.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([g,f])=>e.jsx("button",{type:"button",className:"csb"+(m===g?" on":"")+(o===g?" busy":""),disabled:!!o,onClick:()=>{b(g)},children:f},g)),l&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(zr,{o:t})]})}function zr({o:t}){const{t:a,saveNote:n,flash:r}=A(),[i,o]=p.useState(t.ceoNote||""),[d,l]=p.useState(!1),[c,m]=p.useState(!1),h=i.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(d||!h)return;l(!0);const b=await n(t,i.trim());l(!1),b&&(m(!0),setTimeout(()=>m(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:d,onChange:b=>o(b.target.value),onKeyDown:b=>{b.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:d||!h,onClick:()=>{s()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Er({placeholder:t,onDone:a}){const{t:n}=A(),[r,i]=p.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Tr({o:t}){var x;const{t:a,token:n,caps:r,canWrite:i,stageOf:o,setStage:d,flashErr:l}=A(),[c,m]=p.useState(!1);if(!r.pipe||!i||r.lockActions||te(t)!==4)return null;const h=o(t),s=(h==null?void 0:h.stage)||"todo",b=async u=>{if(c||u===s)return;m(!0);const y=h;d(t,{stage:u,stamps:(h==null?void 0:h.stamps)||{}});const C=Math.max(Date.now(),kt+=1);kt=C;const w=await ka(n,{company:t.name||"",stage:u,cts:C,deal_id:t.airtableId,check_id:t.checkId});m(!1),!w.stale&&(w.ok||(d(t,y),l(a.actErr)))},v=(x=h==null?void 0:h.stamps)==null?void 0:x.sent,g=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,f=s==="sent"&&v&&g>=4;return e.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,y])=>e.jsx("button",{type:"button",className:"stgb"+(s===u?" on":""),disabled:c,onClick:()=>{b(u)},children:y},u)),f&&e.jsx("span",{className:"stgj4",children:a.j4Badge(g)})]})}let kt=0;const De=8,qe=340;function jt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Ar({steps:t,onClose:a}){const{t:n,dispatch:r,counts:i,scoped:o,byId:d,st:l}=A(),[c,m]=p.useState(0),[h,s]=p.useState(null),[b,v]=p.useState([]),g=p.useRef(!1);p.useEffect(()=>{g.current||(g.current=!0,v(t.filter(k=>!!document.querySelector(k.need||k.sel))))},[t]);const f=b[c],x=c>=b.length;p.useEffect(()=>{f&&(f.ptab!==void 0&&l.ptab!==f.ptab&&r({type:"ptab",tab:f.ptab}),f.dens&&l.dens!==f.dens&&r({type:"dens",dens:f.dens}))},[c,f]);const u=p.useCallback(()=>{if(!f){s(null);return}const k=document.querySelector(f.sel);if(!k){s(null);return}k.scrollIntoView({block:"nearest",behavior:"smooth"}),s(k.getBoundingClientRect())},[f]);p.useLayoutEffect(()=>{u();const k=window.setTimeout(u,260),N=()=>u();return window.addEventListener("scroll",N,!0),window.addEventListener("resize",N),()=>{window.clearTimeout(k),window.removeEventListener("scroll",N,!0),window.removeEventListener("resize",N)}},[u]);const y=p.useRef(a);if(y.current=a,p.useEffect(()=>{const k=N=>{N.key==="Escape"?(N.preventDefault(),N.stopPropagation(),y.current()):N.key==="ArrowRight"?m(z=>z+1):N.key==="ArrowLeft"&&m(z=>Math.max(0,z-1))};return document.addEventListener("keydown",k,!0),()=>document.removeEventListener("keydown",k,!0)},[]),!b.length)return null;let C=null;if(x){const k=i[3]||0,N=o.find(z=>z.memoUrl)||[...d.values()].find(z=>z.memoUrl);k>0?C={title:k===1?n.ahaATitle1:n.ahaATitleN(k),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:N?C={title:n.ahaBTitle,body:n.ahaBBody(N.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:N.id}),a()}}:C={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:qe};if(!x&&h){const k=h.bottom+14,z=window.innerHeight-k>190?k:Math.max(12,h.top-200);w={left:Math.min(Math.max(12,h.left+h.width/2-qe/2),window.innerWidth-qe-12),top:z,width:qe}}return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!x&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-De,top:h.top-De,width:h.width+De*2,height:h.height+De*2}}),(x||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(x?" fin":""),style:w,children:[x&&C?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:C.title}),e.jsx("p",{children:e.jsx(jt,{text:C.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>m(b.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:C.go,children:C.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(c+1,b.length)}),e.jsx("h3",{children:f==null?void 0:f.title}),e.jsx("p",{children:e.jsx(jt,{text:(f==null?void 0:f.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>m(k=>Math.max(0,k-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>m(k=>k+1),children:c===b.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Lr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:i}=A(),o=p.useMemo(()=>t.filter(s=>we(s.date)===0&&s.kind==="target"),[t]),d=p.useMemo(()=>o.filter(s=>a?te(s)===0:!Z(s)),[o,a]),l=o.length-d.length,c=o.length?Math.min(100,l/o.length*100):100;let m;a?m=n.morningThesis(o.length,l,d.length):o.length?l===0?m=n.goalSourced(o.length):l>=o.length?m=n.goalCleared:m=n.goalDone(l,o.length):m=n.goalSourced(0);const h=()=>{a?(i({type:"ptab",tab:0}),i({type:"filters",patch:{win:"1"}})):i({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:m}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:c+"%"}})}),d.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?n.morningEval(d.length):r.pileMode?n.goalContinue(d.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Or(){var M,D;const{t,lang:a,st:n,dispatch:r,token:i,fund:o,data:d,dossiers:l,mode:c,doSync:m,startTour:h}=A(),[s,b]=p.useState(null),[v,g]=p.useState([]),f=c==="client";p.useEffect(()=>{if(!i||!o)return;let E=!0;return(async()=>{const[P,L]=await Promise.all([Qe(o),Rt(i)]);E&&(P&&b(P),g(L))})(),()=>{E=!1}},[i,o]);const x=(s==null?void 0:s.per_day)??null,u=((M=s==null?void 0:s.pool_order)==null?void 0:M.length)??0,y=v.filter(E=>E.status==="running").length,C=p.useMemo(()=>l.filter(E=>E.kind==="target"&&Z(E)).length,[l]),w=d.marketEstimate,k=typeof((D=d.stats)==null?void 0:D.screened)=="number"?d.stats.screened:C,N=w&&w>0?Math.min(100,Math.round(k/w*100)):null,z=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),S=(o||"P").split(/\s+/).map(E=>E[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const E=Date.parse(d.generatedAt||"");if(Number.isNaN(E))return"";const P=new Date(E),L=I=>String(I).padStart(2,"0");return`${L(P.getDate())}/${L(P.getMonth()+1)} à ${L(P.getHours())}:${L(P.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:S}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),T&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(T)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:h,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[N===null&&k>0&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsx("span",{className:"ev",children:e.jsx("b",{children:z(k)})})]}),N!==null&&w&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:N+"%"}})}),e.jsxs("b",{children:[N," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(k,w)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>r({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),x!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"q",children:x})," ",t.identPerDay]}),e.jsx("span",{className:"edv"})]}),x===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),y>0&&e.jsxs("span",{className:"ev",children:["⏳ ",y]}),e.jsx("span",{className:"ego",children:t.identPending(u)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:E=>{E.stopPropagation(),r({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!f,onClick:m,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:n.filters.search,onChange:E=>r({type:"filters",patch:{search:E.target.value}})})]})]})]})}function Rr(){const{t,counts:a,dispatch:n}=A();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,i],o)=>{const d=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(d?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:i}),d&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Fr=["--p0","--p1","--p2","--p3","--p4"];function Mr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:i}=A(),o=p.useRef({});p.useEffect(()=>{o.current={...n}},[n]);const d=m=>{const h=o.current[m],s=h!==void 0?n[m]-h:0;return e.jsxs("button",{type:"button",className:"step"+(m===3&&n[3]>0?" wait":""),style:{"--c":`var(${Fr[m]})`,"--tc":m<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===m,title:r.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsxs("span",{className:"l",children:[r.plabels[m].toUpperCase(),m===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[m],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},m)},l=(m,h,s)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":m===5?"var(--p5)":m===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===m,title:r.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[m]})]},m),c=(m,h,s,b=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:b,onClick:s,children:m},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(d)}),e.jsxs("div",{className:"offtrack",children:[l(5,!1,r.plabels[5]),l(7,!0,r.plabels[7]),l(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",r.toolUndo,i,t.undo.length===0),c("↺",r.toolReset,()=>{a({type:"reset"})}),c("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Dr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function qr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:i,doAnalyse:o,mode:d}=A(),l=p.useRef(null),[c,m]=p.useState(60);p.useEffect(()=>{let v=0;const g=()=>{var C;const f=l.current;if(!f)return;const x=(C=f.parentElement)==null?void 0:C.querySelector('.funnel [aria-selected="true"]');if(!x)return;const u=x.getBoundingClientRect(),y=f.getBoundingClientRect();m(Math.max(20,Math.min(u.left+u.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",g)}},[t.ptab]);const h=t.ptab;let s=n.tuto[h].p;if(h===3){const v=r.filter(x=>x.kind==="target"&&te(x)===3),g=v.filter(x=>Ye(x)==="auto").length,f=v.filter(x=>Ye(x)==="cd").length;s=n.tutoPending(g,f,v.length)}const b=(()=>{if(d!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(v=>v.id)})};if(h===1){const v=r.filter(g=>g.kind==="target"&&te(g)===1&&!i.has(g.id)).slice(0,10);if(v.length)return{label:n.tuto[1].a,run:()=>v.forEach(g=>o(g))}}return null})();return e.jsxs("div",{ref:l,className:"tuto mini",style:{"--bg":Dr[h],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),b&&e.jsx("button",{type:"button",className:"tprim",onClick:b.run,children:b.label})]})}const Nt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function St(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Pr(t,a){const[n,r]=p.useState(1);return p.useEffect(()=>{let i=!0,o=0;const d=()=>{var m;if(!i)return;const c=(m=t.current)==null?void 0:m.getScreenCTM();c&&c.a>0?r(c.a):o=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return t.current&&l.observe(t.current),window.addEventListener("resize",d),()=>{i=!1,cancelAnimationFrame(o),l.disconnect(),window.removeEventListener("resize",d)}},[t,a]),n}function Ir(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:i,markedId:o,byId:d,lang:l,t:c}=A(),m=p.useRef(null),h=p.useRef(null),s=Je.find(S=>S.key===t.continent),b=Pr(m,t.continent+":"+t.mapFolded),[v,g]=p.useState(new Map),[f,x]=p.useState(null);p.useEffect(()=>{const S=m.current;if(!S)return;const T=new Map;S.querySelectorAll("path[data-i2]").forEach(M=>{const D=M.dataset.i2;if(D)try{const E=M.getBBox();E.width>0&&T.set(D,{x:E.x,y:E.y,w:E.width,h:E.height})}catch{}}),g(T)},[t.continent,b]);const u=p.useMemo(()=>n.filter(S=>S.cc),[n]),y=p.useMemo(()=>{const S=new Map;return u.forEach(T=>S.set(T.cc,(S.get(T.cc)||0)+1)),S},[u]),C=p.useMemo(()=>u.map(S=>{const T=S.cc?v.get(S.cc):void 0;if(!T)return null;const M=St(S.name||S.id||""),D=St((S.id||S.name||"")+"·y"),E=(M-.5)*Math.min(T.w*.55,60),P=(D-.5)*Math.min(T.h*.55,60);return{d:S,x:T.x+T.w/2+E,y:T.y+T.h/2+P}}).filter(S=>!!S),[u,v]),w=S=>b>0?S/b:S,k=p.useMemo(()=>r?[0,1,2,3,4,5].map(S=>({c:Nt[S],fr:c.plabels[S].toUpperCase(),en:c.plabels[S].toUpperCase(),n:n.filter(T=>T.kind==="target"&&te(T)===S).length})).filter(S=>S.n>0):pt.map((S,T)=>({...S,n:n.filter(M=>ut(M)===T).length})),[n,r,c.plabels]),N=o?d.get(o):null,z=N?C.find(S=>S.d.id===N.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:m,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":l==="fr"?s.fr:s.en,onMouseLeave:()=>{x(null),i(null)},children:[e.jsx("g",{children:s.countries.map((S,T)=>e.jsx("g",{className:"ct"+(S.i2&&y.get(S.i2)?"":" empty"),children:e.jsx("path",{d:S.d,"data-i2":S.i2||void 0})},T))}),e.jsx("g",{children:C.map(S=>{const T=pt[ut(S.d)],M=!!Q(S.d),D=S.d.kind==="target",E=r&&D?Nt[te(S.d)]:T.c,P=!r&&Z(S.d);return e.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var F,_;const L=(F=h.current)==null?void 0:F.getBoundingClientRect(),I=(_=m.current)==null?void 0:_.createSVGPoint();if(I&&m.current&&L){I.x=S.x,I.y=S.y;const ie=I.matrixTransform(m.current.getScreenCTM());x({x:ie.x-L.left,y:ie.y-L.top,label:S.d.name+" · "+(ke(S.d.cc,l)||S.d.countryLabel||"")})}i(S.d.id)},onMouseLeave:()=>{x(null),i(null)},onClick:()=>{var F;const L=(F=m.current)==null?void 0:F.createSVGPoint();let I=null;if(L&&m.current){L.x=S.x,L.y=S.y;const _=L.matrixTransform(m.current.getScreenCTM());I={x:_.x,y:_.y}}a({type:"popup",id:S.d.id,anchor:I})},children:[e.jsx("circle",{className:"h",cx:S.x,cy:S.y,r:w(Math.max(11,T.px+7))}),e.jsx("circle",{className:"v",cx:S.x,cy:S.y,r:w(T.px),fill:E,stroke:M?"#DC2626":"#ffffff",strokeWidth:w(M?2.2:1.3)})]},S.d.id||S.d.name)})}),z&&e.jsx("circle",{className:"ring on",cx:z.x,cy:z.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(f?" on":""),style:f?{left:f.x,top:f.y}:void 0,children:f==null?void 0:f.label}),e.jsx("div",{className:"legend",children:k.map((S,T)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":S.c}}),l==="fr"?S.fr:S.en," ",e.jsx("b",{children:S.n})]},T))}),n.some(S=>!S.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:n.filter(S=>!S.cc).length})]})})]})}function Br(t,a){const n=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t);if(!n)return t;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(n[2])-1]||n[2],o=Number(n[3]);return a==="en"?`${i} ${o}, ${n[1]}`:`${o} ${i} ${n[1]}`}function $r(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:i,contName:o,lang:d}=A(),l=t.filters,c=p.useMemo(()=>n.filter(f=>f.continent===t.continent),[n,t.continent]),m=f=>c.filter(x=>f!=="country"&&l.country.length&&!l.country.includes(x.cc||"")?!1:tt(x,l,i,f==="country"?void 0:f)),h=p.useMemo(()=>{const f=m("win"),x=u=>f.filter(y=>(y.date?Math.max(0,Math.floor((Date.now()-Date.parse(y.date))/864e5)):9999)<=u).length;return[x(0),x(7),x(30),f.length]},[c,l,i]),s=p.useMemo(()=>l.day?m("win").filter(f=>(f.date||"").slice(0,10)===l.day).length:0,[c,l,i]),b=p.useMemo(()=>{if(i)return null;const f=m("status"),x={all:f.length,todo:0,retenu:0,pending:0,ecarte:0};return f.forEach(u=>{x[de(u)]+=1}),x},[c,l,i]),v=l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+(l.signalOnly?1:0)+(l.day||l.win!=="all"?1:0)+(!i&&l.status!=="all"?1:0)+(l.search.trim()?1:0),g=(f,x,u,y="fbtn")=>e.jsxs("button",{type:"button",className:y,"aria-expanded":t.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[e.jsx("span",{className:"fl",children:x}),u>0&&e.jsx("span",{className:"n",children:u}),e.jsx("span",{className:"cv",children:"▾"})]},f);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[l.day?e.jsxs("div",{className:"seg",children:[e.jsxs("button",{type:"button","aria-pressed":!0,children:[r.fDay(Br(l.day,d)),e.jsx("b",{children:s})]}),e.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:r.fDayOff})]}):e.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,x)=>e.jsxs("button",{type:"button","aria-pressed":l.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[r.dates[x],e.jsx("b",{children:h[x]})]},f))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:l.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),!i&&b&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([f,x])=>e.jsxs("button",{type:"button","aria-pressed":l.status===f,onClick:()=>a({type:"filters",patch:{status:f}}),children:[x,e.jsx("b",{children:b[f]??0})]},f))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),l.signalOnly&&e.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),g("sec",r.fSector,l.sector.length),g("pay",r.fCountry,l.country.length),g("det",r.fEngine,l.engine.length),g("sta",r.fStage,l.stage.length),i&&g("ang","Angle",l.angle.length),i&&g("mem","Mémo",l.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),v>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(c.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(v)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(Vr,{poolFor:m})]})}function Vr({poolFor:t}){const{st:a,dispatch:n,t:r,lang:i}=A(),o=a.filters,d=a.openFacet,{title:l,cols:c,options:m}=p.useMemo(()=>{if(d==="sig"){const g=t("signal").filter(u=>Q(u)),f=new Map;g.forEach(u=>{const y=u.engine||"";f.set(y,(f.get(y)||0)+1)});const x=[{v:"*",label:r.fpSigAll,n:g.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ft([...f.keys()],i).map(u=>({v:u,label:ye(u)+" "+se(u,i),n:f.get(u)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(u)}))];return{title:r.fpSigTitle,cols:2,options:x}}if(d==="sec"){const g=t("sector"),f=new Map;return g.forEach(x=>{x.sector&&f.set(x.sector,(f.get(x.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...f.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x,n:u,html:!1,on:o.sector.includes(x)}))}}if(d==="pay"){const g=t("country"),f=new Map;return g.forEach(x=>{x.cc&&f.set(x.cc,(f.get(x.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...f.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:ke(x,i)||x,n:u,html:!1,on:o.country.includes(x)}))}}if(d==="det"){const g=t("engine"),f=new Map;return g.forEach(x=>{x.engine&&f.set(x.engine,(f.get(x.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:ft([...f.keys()],i).map(x=>({v:x,label:ye(x)+" "+se(x,i)+' <span style="color:var(--dim);font-size:10px">· '+ja(Na(x),i)+"</span>",n:f.get(x)||0,html:!0,on:o.engine.includes(x)}))}}if(d==="ang"){const g=t("angle"),f=new Map;return g.forEach(x=>{x.angle&&f.set(x.angle,(f.get(x.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x.replace(/[_-]+/g," "),n:u,html:!1,on:o.angle.includes(x)}))}}if(d==="mem"){const g=t("memoLevel"),f=new Map;g.forEach(u=>{if(u.kind==="target"){const y=Ke(u);f.set(y,(f.get(y)||0)+1)}});const x=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:x[u],n:f.get(u)||0,html:!1,on:o.memoLevel.includes(u)}))}}const b=t("stage"),v=new Map;return b.forEach(g=>{g.stage&&v.set(g.stage,(v.get(g.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((g,f)=>f[1]-g[1]).map(([g,f])=>({v:g,label:g,n:f,html:!1,on:o.stage.includes(g)}))}},[d,a,i]),h=b=>{if(d==="sig"){if(b==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const g=o.signalEngines.includes(b)?o.signalEngines.filter(f=>f!==b):[...o.signalEngines,b];n({type:"filters",patch:{signalOnly:!0,signalEngines:g}})}return}if(d==="mem"){n({type:"toggleMemoLevel",value:Number(b)});return}n({type:"toggleFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage",value:b})},s=()=>{n(d==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:d==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:l}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:m.map(b=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":b.on,onClick:()=>h(b.v),children:[e.jsx("span",{className:"bx"}),b.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:b.label}}):e.jsx("span",{className:"l",children:b.label}),e.jsx("span",{className:"n",children:b.n})]},b.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const Ct=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Ur(){const{t,mode:a,token:n,askEvaluate:r,sessTally:i,dispatch:o,evalBusy:d,evalCards:l,caps:c,data:m}=A(),h=a==="client",[s,b]=p.useState(""),[v,g]=p.useState(!1),[f,x]=p.useState(""),[u,y]=p.useState(!1),[C,w]=p.useState(""),[k,N]=p.useState([]),z=p.useRef(!1),S=s.trim()?Ct.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,T=p.useMemo(()=>f.split(`
`).map(L=>L.trim()).filter(Boolean).slice(0,15),[f]),M=k.length?k:l,D=m.credits,E=()=>{const L=s.trim();L&&(r(null,L),b(""))},P=async()=>{if(!h){r(null,T[0]||"");return}if(!T.length||u)return;y(!0),z.current=!1;const L=[];for(let I=0;I<T.length&&!z.current;I++){w(t.evaluating(I+1,T.length,T[I]));const F=await Ft(n,T[I],"atelier2");if(L.unshift({name:F.company||T[I],verdict:F.verdict,reason:F.reason||"",remaining:F.remaining??null}),N([...L]),F.verdict==="quota"){L.unshift({name:"",verdict:"quota",reason:t.quota(T.length-I-1),remaining:0}),N([...L]);break}}w(""),x(""),y(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:L=>b(L.target.value),onKeyDown:L=>{L.key==="Enter"&&E()}}),e.jsx("span",{className:"detect"+(Ct.test(s.trim())?" url":""),children:S})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),disabled:d,onClick:E,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),c.showCredits&&D&&e.jsxs("button",{type:"button",className:"credits"+(D.total_available<=0&&!D.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:D.unlimited?"∞":D.total_available}),!D.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",D.daily_grant+D.purchased]}),D.total_available<=0&&!D.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>g(!v),children:t.evalMulti})}),v&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:f,placeholder:t.bulkPh,onChange:L=>x(L.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!T.length,onClick:()=>{P()},children:[e.jsx("span",{className:"fill"}),u&&C?C:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(T.length)})]})]}),M.slice(0,1).map((L,I)=>{const F=L.verdict==="kept",_=L.verdict==="quota",ie=F?"var(--brand)":_?"var(--bolt)":"var(--red)",ce=F?"var(--brand-l)":_?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":ie,"--bgc":ce},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:F?"✓ "+t.kept:_?"⏳":"✗ "+t.dropped})}),L.name&&e.jsx("span",{className:"rn",children:L.name}),e.jsx("span",{className:"rr",children:L.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",L.reason]}):null}),!_&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(F?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},I)}),h&&(i.kept+i.dropped>0||M.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(i.kept,i.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Hr(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function _r(){const{st:t,dispatch:a,byId:n,t:r,doDeep:i}=A(),o=t.memoConsole?n.get(t.memoConsole):null,d=p.useMemo(()=>o?[o.reasoning||"",Hr(o.summary||"")].filter(Boolean).join(`
...
`).map((m,h)=>e.jsx("p",{style:{margin:"0 0 10px"},children:m},h)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[Xe(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:c===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const Yr=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Pe=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Wr(t){const a=String(t||"");if(!a)return"";let n="",r=0;for(;r<a.length;){const i=a.indexOf("<",r);if(i<0){n+=Pe(a.slice(r));break}n+=Pe(a.slice(r,i));const o=a.indexOf(">",i);if(o<0){n+=Pe(a.slice(i));break}const d=a.slice(i+1,o).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(d),c=l?l[2].toLowerCase():"";l&&Yr.has(c)?n+=`<${l[1]}${c}>`:n+=Pe(a.slice(i,o+1)),r=o+1}return n}const zt=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function K({k:t,v:a,href:n}){return a==null||a===""?null:e.jsxs("div",{className:"cdl",children:[e.jsx("span",{className:"cdk",children:t}),n?e.jsx("a",{className:"cdv",href:n,target:"_blank",rel:"noopener noreferrer",children:String(a)}):e.jsx("span",{className:"cdv",children:String(a)})]})}function Gr({o:t}){const{t:a,lang:n,dispatch:r,caps:i}=A(),o=Ze(t),d=Le(t),l=(t.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[t.sector,t.stage,t.countryLabel,t.city,t.website,t.domain,t.linkedinCompany,t.angle,t.date].filter(Boolean).length,m=[t.contactName,t.contactEmail,t.contactLinkedin].filter(Boolean).length,h=[t.ceoStatus,t.ceoNote,i.pipe?t.memoUrl:"",i.pipe?t.memoPdfUrl:""].filter(Boolean).length+(typeof t.engagement=="number"&&t.engagement>0?1:0),s=p.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(l?1:0)+(t.reasoning?1:0)+(d?1:0)},{k:"ana",lib:a.cdAnalyse,n:t.summary?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:m},{k:"suivi",lib:a.cdSuivi,n:h}].filter(f=>f.n>0),[t,a,l,d,c,m,h]),[b,v]=p.useState("");if(!s.length)return null;const g=s.some(f=>f.k===b)?b:s[0].k;return e.jsxs("div",{className:"cdtabs",children:[e.jsx("div",{className:"cdnav",role:"tablist",children:s.map(f=>e.jsx("button",{type:"button",role:"tab","aria-selected":g===f.k,className:g===f.k?"on":"",onClick:x=>{x.stopPropagation(),v(f.k)},children:f.lib},f.k))}),e.jsxs("div",{className:"cdbody",onClick:f=>f.stopPropagation(),children:[g==="conv"&&e.jsxs(e.Fragment,{children:[l&&e.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[e.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),e.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.reasoning&&e.jsx("p",{className:"cdtxt",children:t.reasoning}),d&&e.jsxs("div",{className:"cdv1 memo",children:[e.jsx("b",{children:d}),e.jsx("span",{className:"cdw",children:a.cdMemo(t.memoType||"")})]}),e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(K,{k:a.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(K,{k:a.cdVerdictDate,v:zt(t.verdictDate,n)})]})]}),g==="ana"&&t.summary&&e.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Wr(t.summary)}}),g==="soc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdSector,v:t.sector}),e.jsx(K,{k:a.cdStage,v:t.stage}),e.jsx(K,{k:a.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(K,{k:a.cdSite,v:t.domain||t.website,href:t.website||void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.linkedinCompany?"LinkedIn":"",href:t.linkedinCompany}),e.jsx(K,{k:a.cdAngle,v:t.angle}),e.jsx(K,{k:a.cdDetected,v:zt(t.date,n)})]}),g==="ctc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdName,v:t.contactName}),e.jsx(K,{k:a.cdEmail,v:t.contactEmail,href:t.contactEmail?`mailto:${t.contactEmail}`:void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.contactLinkedin?"LinkedIn":"",href:t.contactLinkedin})]}),g==="suivi"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdCeoStatus,v:t.ceoStatus}),e.jsx(K,{k:a.cdEngagement,v:typeof t.engagement=="number"&&t.engagement>0?t.engagement:""})]}),t.ceoNote&&e.jsxs("p",{className:"cdtxt",children:["💬 ",t.ceoNote]}),i.pipe&&(t.memoUrl||t.memoPdfUrl)&&e.jsxs("div",{className:"cdacts",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),t.memoPdfUrl&&e.jsx("a",{className:"abtn",href:t.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Bt({name:t}){const{t:a,token:n,caps:r,mode:i,flashErr:o}=A(),[d,l]=p.useState(!1),[c,m]=p.useState(null);if(!r.pipe||i!=="client"||r.lockActions)return null;const h=async()=>{if(d)return;l(!0);const s=await Sa(n,t);if(l(!1),!s){o(a.actErr);return}m(s.results||[])};return e.jsxs("div",{className:"simb",onClick:s=>s.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{h()},children:d?a.similarBusy:a.similar}),c&&(c.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:c.map(s=>e.jsxs("li",{children:[e.jsx("b",{className:s.verdict==="kept"?"ok":"ko",children:s.company}),s.reason&&e.jsx("span",{children:s.reason})]},s.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const $t={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function rt({o:t}){const{t:a}=A(),n=Ze(t),r=Le(t),i=te(t),o=Ye(t),d=Ca(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+($t[r]||"v-cons"),title:a.vt[r],children:r}):i===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&d!==null&&e.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:a.waitTitle(d),children:a.waitChip(d)})]})}function Et({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:i}=A(),[o,d]=p.useState(!1);if(p.useEffect(()=>{r||d(!1)},[r]),Z(t)){const m=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[m?"✓":"✗"," ",e.jsx("b",{children:m?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const c=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:r,onClick:m=>{m.stopPropagation(),d(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function Kr({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:i,doAnalyse:o,doDecide:d,doPromote:l,doRepeche:c,doApproach:m,dispatch:h}=A();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:v=>{v.stopPropagation(),h({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Et,{o:t})});const s=te(t),b=v=>g=>{g.stopPropagation(),v()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(Et,{o:t})});if(s===1){const v=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:b(()=>o(t)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>d(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>d(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const v=i.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:v,onClick:b(()=>m(t)),children:v?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:b(()=>l(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:b(()=>c(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>h({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function Qr({o:t}){const{t:a,doThumb:n,thumbOf:r}=A(),i=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function Jr({o:t}){const{lang:a}=A();return Q(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(je,{o:t}),e.jsx(Be,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ye(t.engine||"")," ",se(t.engine||"",a)]})})}function Xr({o:t,locked:a,open:n,onToggle:r}){const{st:i,dispatch:o,caps:d,markRow:l,markedId:c,favIds:m,toggleFav:h}=A(),s=te(t),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,g=v<=0?0:v<=7?1:v<=30?2:3,f=d.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:b[g],x=m.has(t.id),u=y=>{if(a)return;if(d.pipe){r();return}const C=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"row"+(c===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>l(t.id),onMouseLeave:()=>l(null),onClick:u,children:[e.jsx("span",{className:"pt",style:{"--c":f}}),e.jsx(Ht,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[d.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:x?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),h(t)},children:x?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(Zr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(Jr,{o:t}),d.pipe&&e.jsx(rt,{o:t}),d.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(Kr,{o:t}),d.showThumbs&&e.jsx(Qr,{o:t})]}),(n||i.dens==="deplie")&&!a&&e.jsx(en,{o:t})]})}function Zr({o:t}){const{lang:a,caps:n}=A();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=et(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function en({o:t}){const{t:a,lang:n,dispatch:r,caps:i,outbound:o,doOnboard:d}=A();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),e.jsx(Gr,{o:t}),e.jsx(Cr,{o:t}),e.jsx(Tr,{o:t}),e.jsx(Bt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(rt,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ye(t.engine||"")," ",se(t.engine||"",n)]}),Q(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(je,{o:t})})]}),i.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(t),children:a.actOnboard})]})]})]})}function tn({o:t,locked:a}){const{t:n,dispatch:r,caps:i,doDecide:o}=A(),d=te(t),l=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][d];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":l},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(rt,{o:t}),Q(t)&&e.jsx(je,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&i.pipe&&d===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function an(){const t=A(),{st:a,dispatch:n,t:r,caps:i,scoped:o,lang:d,sessTally:l,data:c,dossiers:m}=t,[h,s]=p.useState(new Set);p.useEffect(()=>{s(new Set)},[a.ptab,a.continent]);const b=k=>s(N=>{const z=new Set(N);return z.has(k)?z.delete(k):z.add(k),z}),v=p.useMemo(()=>at(o,a.sort),[o,a.sort]),g=p.useMemo(()=>v.filter(k=>Q(k)&&!Z(k)).length,[v]),f=i.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,x=(k,N,z="",S=!1)=>e.jsxs("button",{type:"button","data-s":k,className:z,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:S?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:k}),children:[N,e.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),u=p.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const k=new Map;return v.forEach(N=>{const z=N.engine||"?";k.has(z)||k.set(z,[]),k.get(z).push(N)}),[...k.entries()]},[v,i.pipe,a.groupBy]),y=i.lockRowsAfter;let C=0;const w=(k,N)=>{const z=a.shown[N]||Ie,T=k.slice(0,z).map(M=>{const D=y!==null&&C>=y;return C++,a.dens==="maxi"?e.jsx(tn,{o:M,locked:D},M.id):e.jsx(Xr,{o:M,locked:D,open:h.has(M.id),onToggle:()=>b(M.id)},M.id)});return k.length>z&&T.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:N,by:Ie}),children:r.more(Math.min(Ie,k.length-z),k.length-z)},N+":more")),T};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:v.length})," ",f]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,i.pipe&&t.fund?" · "+t.fund:""]}),i.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),i.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([k,N])=>e.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>n({type:"dens",dens:k}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:N})]},k))}),i.showChain&&v.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:v.filter(k=>i.pipe?!0:!Z(k)).map(k=>k.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",i.pipe?r.browse(v.length):r.chainAll(v.filter(k=>!Z(k)).length)]})]}),g>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(g)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),x("country",r.colCountry),x("name",r.colCompany),x("amount",r.colAmount,"h-amt",!0),x("stage",r.colStage,"h-stade"),x("signal",r.colSignal,"h-sig"),i.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),i.pipe&&x("score",r.colScore,"h-sc",!0),e.jsx("span",{}),i.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[u?u.map(([k,N])=>e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ye(k)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:se(k,d)}),e.jsx("div",{className:"s",children:r.grpCount(N.filter(z=>!Z(z)).length,N.length)})]})]}),w(N,k)]},k)):w(v,"pt"+a.ptab),!v.length&&!(c.loading&&!m.length)&&e.jsx("div",{className:"void",children:i.pipe?r.emptyTab:r.emptyScope})]}),i.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(l.kept>0||l.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(l.kept,l.dropped)}})]})}const rn=`
...
`;function nn(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,i=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let d=t.y+10;return d+n>i-8&&(d=Math.max(8,t.y-n-14)),d<8&&(d=8),{left:o,top:d}}function on(){const{st:t,dispatch:a,byId:n,t:r,lang:i,caps:o,mode:d,askEvaluate:l,doAnalyse:c,doDecide:m,doPromote:h,doRepeche:s,doApproach:b,doDeep:v,doOnboard:g,outbound:f,evalBusy:x}=A(),u=t.popupId?n.get(t.popupId):null;if(!u)return null;const y=Q(u),C=te(u),w=Le(u),k=u.kind==="target",N=z=>{a({type:"filters",patch:z}),a({type:"popup",id:null})};return Ae.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:rn}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:nn(t.popupAnchor),onClick:z=>z.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:u.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(we(u.date)),se(u.engine,i))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[u.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>N({country:[u.cc]}),children:(ke(u.cc,i)||u.countryLabel||"").toUpperCase()}),u.sector&&e.jsx("button",{type:"button",onClick:()=>N({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&e.jsx("button",{type:"button",onClick:()=>N({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am2",children:et(u.amountEur,i)})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[ye(u.engine)," ",e.jsx("b",{children:se(u.engine,i)})," — ",za(u.engine,i),u.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",u.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(je,{o:u,lg:!0})," ",e.jsx(Be,{o:u,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(Mt(y,i))," · ",r.win7(Dt(y,i))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&C>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),o.pipe&&k&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof u.score=="number"&&u.score>0?" · "+r.score(u.score):""]})})]}),e.jsx(Bt,{name:u.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||d!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[C===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>l(u),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),C===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),C===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),C===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(u,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{m(u,!1),a({type:"popup",id:null})},children:r.actNo}),Xe(u)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{v(u),a({type:"popup",id:null})},children:r.memoDeep})]}),C===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{b(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),C===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),u.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),f&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{g(u),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>l(u),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),u.website&&e.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}function Tt(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ln(t,a){const n=Ea(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function sn(t,a){const r=[a.head.split("|").map(Tt).join(";")];for(const i of t){const o=a.stageOf(i);r.push([i.name||"",ln(i,a.plabels),Ze(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Tt).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function dn(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const cn=50;function nt({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:i}=A(),[o,d]=p.useState(null),[l,c]=p.useState(!1),[m,h]=p.useState(""),[s,b]=p.useState(0),[v,g]=p.useState(""),[f,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>()=>{u.current&&window.clearInterval(u.current)},[]);const y=async w=>{c(!0),h("");const k=await a();if(c(!1),k.ok){d(k);return}if(k.busy){h(i.alertPreviewBusy);return}if(!w){h(i.alertPreviewFail);return}b(cn),u.current=window.setInterval(()=>{b(N=>N>1?N-1:(u.current&&window.clearInterval(u.current),y(!1),0))},1e3)},C=async()=>{if(r||f)return;x(!0),g("");const w=await n();x(!1),g(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:l||s>0,onClick:()=>{y(!0)},children:l?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||f,onClick:()=>{C()},children:f?"…":i.alertTest})]}),s>0&&e.jsx("p",{className:"mnote",children:i.alertPreviewRetry(s)}),m&&e.jsx("p",{className:"mnote warn",children:m}),v&&e.jsx("p",{className:"mnote",children:v}),!v&&e.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Te="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function ee({title:t,icon:a,children:n,wide:r}){const{dispatch:i}=A();return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function pn(){const{st:t}=A();switch(t.modal){case"chain":return e.jsx(fn,{});case"space":return e.jsx(mn,{});case"alert":return e.jsx(xn,{});case"queue":return e.jsx(yn,{});case"export":return e.jsx(wn,{});case"plug":return e.jsx(Nn,{});case"recharge":return e.jsx(Cn,{});case"cover":return e.jsx(zn,{});case"crit":return e.jsx(En,{});case"tuto":return e.jsx(Tn,{});case"rdv":return e.jsx(un,{});case"memoalert":return e.jsx(kn,{});default:return null}}function un(){const{dispatch:t,fund:a}=A(),n=typeof document<"u"&&!!document.getElementById("rdv");return p.useEffect(()=>{n&&(t({type:"modal",modal:null}),br())},[n,t]),n?null:e.jsx(La,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function fn(){const{st:t,dispatch:a,byId:n,t:r,lang:i,mode:o,askEvaluate:d,evalBusy:l}=A(),c=o==="client",m=t.chain.queue.map(v=>n.get(v)).filter(v=>!!v),h=t.chain.idx,s=m[h],b=h>=m.length;return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:b?r.finished:`${h+1} / ${m.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(b?100:h/Math.max(1,m.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:b||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(m.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[ke(s.cc,i)||s.countryLabel,s.sector,s.stage,r.daysAgo(we(s.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:se(s.engine,i).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:et(s.amountEur,i)})]}),Q(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(je,{o:s,lg:!0})," ",e.jsx(Be,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),c&&Z(s)&&e.jsxs("div",{className:"vbox",style:{"--c":de(s)==="retenu"?"var(--brand)":de(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:de(s)==="retenu"?"✓ "+r.kept:de(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!b&&s&&!(c&&Z(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?r.closeBtn:r.skip})]})]})})}),document.body)}function mn(){const{st:t,dispatch:a,dossiers:n,t:r,mode:i}=A(),o=i==="client",d=p.useMemo(()=>o?n.filter(s=>Z(s)):[],[n,o]),l=p.useMemo(()=>at(d.filter(s=>de(s)==="retenu"),{key:"signal",dir:-1}),[d]),c=p.useMemo(()=>d.filter(s=>de(s)==="ecarte"),[d]),m=t.spaceTab==="retenu"?l:c,h=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(ee,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:l.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),m.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),m.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":h},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function xn(){const{mode:t}=A();return t==="client"||t==="apercu"?e.jsx(gn,{}):e.jsx(vn,{})}function gn(){const{t,token:a,flash:n,flashErr:r,mode:i}=A(),[o,d]=p.useState("d"),l=i!=="client";return e.jsxs(ee,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>d("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>d("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(hn,{t,token:a,readOnly:l,flash:n,flashErr:r}):e.jsx(bn,{t,token:a,readOnly:l,flash:n,flashErr:r})]})}function hn({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,d]=p.useState(null),[l,c]=p.useState(!1),[m,h]=p.useState(0);p.useEffect(()=>{let g=!0;return c(!1),gt(a).then(f=>{g&&(f?d(f):c(!0))}),()=>{g=!1}},[a,m]);const s=g=>{n||gt(a,g).then(f=>{if(!f){i(t.actErr);return}d(f),f.throttled?i(t.alertThrottled):r(t.alertSaved)})};if(l)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(g=>g+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const b=g=>!o.sections||o.sections.includes(g),v=g=>{const f=o.sections||t.alertSec.map(([x])=>x);s({sections:b(g)?f.filter(x=>x!==g):[...f,g]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([g,f])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:b(g),disabled:n,onChange:()=>v(g)}),e.jsxs("span",{children:[f,g==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},g))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(nt,{label:t.alertPreview,readOnly:n,onPreview:()=>Pa(a),onTest:()=>qa(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function bn({t,token:a,readOnly:n,flash:r,flashErr:i}){const[o,d]=p.useState(null),[l,c]=p.useState(!1),[m,h]=p.useState(0);p.useEffect(()=>{let g=!0;return c(!1),ht(a).then(f=>{g&&(f?d(f):c(!0))}),()=>{g=!1}},[a,m]);const s=g=>{n||ht(a,g).then(f=>{if(!f){i(t.actErr);return}d(f),r(t.alertSaved)})};if(l)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(g=>g+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const b=o.dow??0,v=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:b,disabled:n,onChange:g=>s({dow:Number(g.target.value)}),children:t.alertDow.map((g,f)=>e.jsx("option",{value:f,children:g},g))}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,v-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[v," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,v+1)}),disabled:n,children:"＋"})]})]}),e.jsx(nt,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>Ba(a),onTest:()=>Ia(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function vn(){const{st:t,t:a,lang:n,scoped:r,contName:i}=A(),[o,d]=p.useState(""),[l,c]=p.useState(!1),[m,h]=p.useState(!1),s=t.filters,b=p.useMemo(()=>r.filter(x=>Q(x)).length,[r]),v=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(o)||m)){h(!0);try{await fetch(`${Ge}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),c(!0)}finally{h(!1)}}},f=[[a.amRows.continent,i],[a.amRows.since,a.amSince[v]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(x=>se(x,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(x=>ke(x,n)||x).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(ee,{title:a.alertTitle,icon:"🔔",children:l?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:f.map(([x,u])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:x}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:u}})]},x))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:x=>d(x.target.value),onKeyDown:x=>{x.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,b)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function yn(){var f,x,u;const{t,token:a,fund:n,mode:r,flash:i}=A(),[o,d]=p.useState(null),[l,c]=p.useState([]),[m,h]=p.useState(0),s=r==="client";p.useEffect(()=>{let y=!0;return(async()=>{const[C,w]=await Promise.all([Qe(n),Rt(a)]);y&&(C&&d(C),c(w))})(),()=>{y=!1}},[a,n,m]);const b=(o==null?void 0:o.per_day)??2,v=((f=o==null?void 0:o.analyzed_today)==null?void 0:f.length)??0,g=(x=o==null?void 0:o.tomorrow)!=null&&x.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(ee,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(v,v+(((u=o==null?void 0:o.pool_order)==null?void 0:u.length)??0))}})}),e.jsxs("div",{className:"qrate",children:[t.covRate," — ",e.jsx("b",{children:t.covRateNow(b)})]})]}),l.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:l.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{xt(a,y.company,"retry").then(()=>h(C=>C+1))},children:t.queueRetry}),s&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{xt(a,y.company,"delete").then(()=>h(C=>C+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[g.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),g.slice(0,10).map((y,C)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",C+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function wn(){const{t,token:a,flash:n,scoped:r,caps:i,stageOf:o,dispatch:d}=A(),l=`${Te}/cibles/list.csv?token=${a}`,c=`${Te}/cibles/list.json?token=${a}`,m=`${Te}/cibles/export.xlsx?token=${a}&scope=full`,h=`=IMPORTDATA("${l}")`,s=x=>{var u;(u=navigator.clipboard)==null||u.writeText(x).then(()=>n(t.exportCopied))},b=[{def:t.exportCsv,value:l,href:l},{def:t.exportSheet,value:h},{def:t.exportLive,value:c,href:c},{def:t.exportXlsx,value:m,href:m}],v=!i.lockActions&&r.length>0,g=()=>{dn(sn(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:x=>(t.stg.find(([u])=>u===x)||["",""])[1]})),n(t.exportViewDone(r.length))},f=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(ee,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:f,children:t.printBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:g,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:b.map(({def:x,value:u,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:x[0]}),e.jsxs("div",{children:[e.jsx("b",{children:x[1]}),e.jsx("p",{children:x[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>s(u),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},x[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function kn(){const{t,token:a,flash:n,flashErr:r,mode:i}=A(),o=i!=="client",[d,l]=p.useState(null),[c,m]=p.useState(!1),[h,s]=p.useState(0),[b,v]=p.useState(!1);p.useEffect(()=>{let u=!0;return m(!1),mt(a).then(y=>{u&&(y?l(y):m(!0))}),()=>{u=!1}},[a,h]);const g=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},f=u=>{if(o||!d)return;const y={enabled:u.enabled??!!d.enabled,email:u.email??(d.email||""),sections:u.sections??g()};v(!0),mt(a,y).then(C=>{if(v(!1),!C){r(t.memoAlertErr);return}l(C),n(t.memoAlertSaved)})};if(c)return e.jsx(ee,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:t.retry})]})});if(!d)return e.jsx(ee,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const x=g();return e.jsxs(ee,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:o||b,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),e.jsx(jn,{value:d.email||"",readOnly:o||b,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:u=>f({email:u})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([u,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!x[u],disabled:o||b,onChange:()=>f({sections:{...x,[u]:!x[u]}})}),e.jsx("span",{children:y})]},u))}),e.jsx(nt,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Aa(a,x),onTest:()=>Ta(a,x)})]})}function jn({value:t,readOnly:a,label:n,okLabel:r,onSave:i}){const[o,d]=p.useState(t);p.useEffect(()=>{d(t)},[t]);const l=o.trim()!==t.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:m=>d(m.target.value),onKeyDown:m=>{m.key==="Enter"&&l&&c&&i(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!c,onClick:()=>i(o.trim()),children:r})]})]})}function Nn(){const{t,token:a,flash:n,flashErr:r,canWrite:i}=A(),[o,d]=p.useState(null),[l,c]=p.useState(!1),[m,h]=p.useState(null),[s,b]=p.useState(""),[v,g]=p.useState(0);p.useEffect(()=>{let u=!0;return c(!1),We(a).then(y=>{u&&(y?d({configured:y.configured,url_hint:y.url_hint}):c(!0))}),Ra(a).then(y=>{u&&h(y)}),()=>{u=!1}},[a,v]);const f=(u,y)=>{i&&We(a,u).then(C=>{if(!C||C.ok===!1){r(t.actErr);return}u.test&&C.sent===!1?r(t.plugTestThrottled):n(y),g(w=>w+1)})},x='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(ee,{title:t.plugTitle,icon:"🔌",wide:!0,children:[m&&e.jsx("p",{className:"mnote"+(m.enabled?" warn":""),children:m.enabled?t.plugAutoOn(m.destination||"webhook"):t.plugAutoOff}),l?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>g(u=>u+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:s,disabled:!i,onChange:u=>b(u.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!i||!s.trim(),onClick:()=>f({url:s.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>f({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>f({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Sn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:x}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var u;(u=navigator.clipboard)==null||u.writeText(x).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Sn(){const{t,token:a,lang:n}=A(),[r,i]=p.useState("valides"),[o,d]=p.useState(!1),[l,c]=p.useState(null),[m,h]=p.useState(null),[s,b]=p.useState(!1),[v,g]=p.useState(!1),[f,x]=p.useState(null),[u,y]=p.useState(null),[C,w]=p.useState(null),k=`atl2:bulk:${a}:${r}`;p.useEffect(()=>{We(a).then(E=>{y(E&&E.configured?E.url_hint||"webhook":null)})},[a]),p.useEffect(()=>{c(null),h(null),b(!1),x(null);try{const E=JSON.parse(localStorage.getItem(k)||"null");w(E&&Date.now()-Date.parse(E.t)<24*3600*1e3?E:null)}catch{w(null)}},[k]);const N=async()=>{d(!0),b(!1),x(null);const E=await Ma(a,r);c(E),h(E.ok?r:null),d(!1)},z=p.useRef(!1),S=async()=>{if(z.current)return;z.current=!0,g(!0);const E=`${a}:${r}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let P;try{P=await Da(a,r,"webhook",void 0,E)}finally{z.current=!1}if(g(!1),b(!1),x(P),P.ok&&(P.pushed||0)>0){const L={t:new Date().toISOString(),n:P.pushed||0};w(L);try{localStorage.setItem(k,JSON.stringify(L))}catch{}}},T=l!=null&&l.ok&&l.ready||0,M=!!(l!=null&&l.ok)&&m===r&&T>0&&!!u&&!C,D=C?new Date(C.t).toLocaleString(n==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:r,onChange:E=>i(E.target.value),children:t.plugBulkTabs.map(([E,P])=>e.jsx("option",{value:E,children:P},E))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{N()},children:o?"…":t.plugBulkPreview})]}),l&&(l.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(l!=null&&l.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),C&&e.jsx("p",{className:"mnote",children:t.bulkLocked(D,C.n)}),!C&&!!(l!=null&&l.ok)&&!u&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!C&&!l&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),M&&!s&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>b(!0),children:t.bulkArm}),M&&s&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(T,u||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{S()},children:v?t.bulkSending:t.bulkConfirm(u||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>b(!1),children:t.bulkCancel})]}),f&&(f.ok?f.replayed?e.jsx("p",{className:"mnote",children:f.pending?t.bulkPending:t.bulkReplayed}):(f.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(f.pushed||0,f.linkedinReady||0,f.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:f.error||t.actErr}))]})}function Cn(){const{t,data:a,lang:n}=A(),r=a.credits,i=a.email,o=async d=>{if(!i)return;const l=window.location.href.split("?")[0];try{const m=await(await fetch(`${Ge}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();m.url&&(window.location.href=m.url)}catch{}};return e.jsxs(ee,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(d=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(d.credits,d.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(d.lookup_key)},children:t.rechargeBuy})]},d.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function zn(){const{t,lang:a,data:n,dossiers:r,token:i,canWrite:o,flash:d}=A(),[l,c]=p.useState(null),[m,h]=p.useState(!1);p.useEffect(()=>{let N=!0;return Qe(i).then(z=>{N&&z&&typeof z.per_day=="number"&&c(z.per_day)}),()=>{N=!1}},[i]);const s=n.stats,b=typeof(s==null?void 0:s.screened)=="number"?s.screened:r.filter(N=>N.kind==="target"&&Z(N)).length,v=n.marketEstimate||0,g=v>0?Math.min(100,Math.round(b/v*100)):null,f=(s==null?void 0:s.window_days)||30,x=b>0?b/f:0,u=v>0?Math.max(0,v-b):0,C=v>0&&x>0&&b>=100?Math.round(u/x):null,w=N=>Math.round(N).toLocaleString(a==="en"?"en-US":"fr-FR"),k=N=>{m||!o||(h(!0),Fa(i,N).then(z=>{if(h(!1),z===null){d(t.actErr);return}c(z),d(t.alertSaved)}))};return e.jsxs(ee,{title:t.coverTitle,icon:"🌍",children:[e.jsxs("div",{className:"covg",children:[e.jsx("b",{children:t.covScreened(w(b))}),v>0&&e.jsx("span",{children:t.covOf(w(v))})]}),g!==null?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"covbar",children:[e.jsx("i",{style:{width:g+"%"}}),e.jsxs("em",{children:[g," %"]})]}),C!==null&&e.jsx("p",{className:"mnote",children:t.covEta(C)})]}):e.jsx("p",{className:"mnote dim",children:t.covNoEst}),x>=1&&e.jsx("p",{className:"mnote",children:t.covPace(w(x))}),s&&e.jsxs("div",{className:"covf",children:[typeof s.kept=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(s.kept)})," ",t.covKept]}),typeof s.analyzed=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(s.analyzed)})," ",t.covAna]}),typeof s.shown=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(s.shown)})," ",t.covShown]})]}),o&&l!==null&&e.jsxs("div",{className:"covr",children:[e.jsxs("div",{className:"covrh",children:[e.jsx("span",{children:t.covRate}),e.jsx("b",{children:t.covRateNow(l)})]}),e.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(N=>e.jsx("button",{type:"button",className:l===N?"on":"",disabled:m,onClick:()=>k(N),children:N===0?"⏸":N},N))}),e.jsx("p",{className:"mnote dim",children:t.covRateHint})]})]})}function En(){var u,y,C;const{t,dossiers:a,token:n,mode:r,flash:i,criteria:o}=A(),d=r==="client",l=p.useMemo(()=>{const w=new Set;return a.forEach(k=>{k.angle&&w.add(k.angle)}),[...w]},[a]),[c,m]=p.useState(null);p.useEffect(()=>{let w=!0;return Oa(n).then(k=>{w&&m(k.thumbs)}),()=>{w=!1}},[n]);const[h,s]=p.useState(""),[b,v]=p.useState(""),[g,f]=p.useState(!1),x=async()=>{const w=h.trim();if(!(!w||g||!d)){f(!0),v("");try{const N=await(await fetch(`${Te}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:w,who:"atelier2"})})).json().catch(()=>({}));if(N.reply&&v(String(N.reply)),N.job_id){v(t.critChatRunning);const z=async()=>{const S=await fetch(`${Te}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:N.job_id})}).then(T=>T.json()).catch(()=>null);if(S&&S.done){v(String(S.reply||S.clarification||S.summary||"✓")),f(!1),S.applied&&i(t.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),s("");return}s("")}finally{b.startsWith("⏳")||f(!1)}}};return e.jsxs(ee,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((u=o.points)!=null&&u.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(w=>{var k,N;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((k=w.look)!=null&&k.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(z=>e.jsx("li",{children:z},z))})]}),!!((N=w.out)!=null&&N.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(z=>e.jsx("li",{children:z},z))})]})]})]},w.title)})]}),!!((C=o==null?void 0:o.gate)!=null&&C.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),l.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:l.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:h,disabled:!d||g,onChange:w=>s(w.target.value),onKeyDown:w=>{w.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(g?" loading":""),style:{padding:"12px 18px"},disabled:!d||g||!h.trim(),onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),b&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:b})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((w,k)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},k))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,k])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+($t[w]||"v-cons"),children:w}),e.jsx("span",{children:k})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,k])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",k]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Tn(){const{t,dispatch:a,startTour:n}=A(),r=i=>{var o,d;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return e.jsxs(ee,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([i,o],d)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:d+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+d))})]})}const Vt="atl2:mapfold",An=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(Vt);if(t==="on")return!0;if(t==="off")return!1}catch{}return window.innerHeight<1e3},Ut=p.createContext(null),A=()=>{const t=p.useContext(Ut);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function je({o:t,lg:a}){const{lang:n}=A(),r=Q(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:bt(r,n),children:[r.emoji," ",bt(r,n)]}):null}function Be({o:t,src:a}){const{lang:n,t:r}=A(),i=Q(t);if(!i)return null;const o=_a(i),d=Ya(i);return e.jsxs("em",{className:"sigwin"+(d?" hot":""),title:r.signaledOn(Mt(i,n))+" · "+r.win7(Dt(i,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(l,c)=>e.jsx("i",{className:c<o?"on":""},c))}),e.jsx("span",{className:"lb",children:d?r.lastDay:r.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&e.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Ht({o:t}){const{lang:a}=A(),n=Ha(t.cc),r=t.cc?ke(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const At="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",_t=t=>`atl2:tour:${t||"anon"}`;function Ln(t){try{return localStorage.getItem(_t(t))==="1"}catch{return!0}}function Lt(t){try{localStorage.setItem(_t(t),"1")}catch{}}function On(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function Pn({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:i,onFiltersChange:o}){const{lang:d}=$a(),l=er[d],c=pr(t,d,a),[m,h]=p.useReducer(fr,void 0,()=>ur((r==null?void 0:r.continent)??"europe",t||An(),{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=p.useRef(!0);p.useEffect(()=>{if(s.current){s.current=!1;return}if(!t)try{localStorage.setItem(Vt,m.mapFolded?"on":"off")}catch{}},[m.mapFolded,t]);const b=p.useRef(o);b.current=o,p.useEffect(()=>{var j;(j=b.current)==null||j.call(b,m.filters)},[m.filters]);const[v,g]=p.useState(null),[f,x]=p.useState(null),[u,y]=p.useState({kept:0,dropped:0}),[C,w]=p.useState(!1),[k,N]=p.useState(""),[z,S]=p.useState(!1),[T,M]=p.useState(null),[D,E]=p.useState(!1),[P,L]=p.useState(!1),[,I]=p.useState(0),F=()=>I(j=>j+1),_=p.useRef([]),ie=p.useRef(new Set),ce=p.useRef(new Set),Oe=p.useRef(new Map),ge=p.useRef(null),{mode:pe}=c,Y=p.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),V=Y.pipe,U=c.session.token||"",q=pe==="client"&&!t;p.useEffect(()=>{if(document.querySelector(`link[href="${At}"]`))return;const j=document.createElement("link");j.rel="stylesheet",j.href=At,document.head.appendChild(j)},[]);const B=(j,O=!1)=>{N(j),S(O),ge.current&&clearTimeout(ge.current),ge.current=setTimeout(()=>N(""),O?4200:2400)},H=j=>B(j,!0),ne=p.useMemo(()=>{const j=new Map;return c.dossiers.forEach(O=>{O.id&&j.set(O.id,O)}),j},[c.dossiers]),ae=p.useMemo(()=>c.dossiers.filter(j=>Pt(j,m,V)),[c.dossiers,m,V]),J=p.useRef(!1);p.useEffect(()=>{if(J.current||t||c.loading||!c.dossiers.length)return;if(!Y.showFunnel||Ln(c.session.token||"")){J.current=!0;return}J.current=!0;const j=window.setTimeout(()=>{Lt(c.session.token||""),E(!0)},700);return()=>window.clearTimeout(j)},[t,c.loading,c.dossiers.length,Y.showFunnel,c.session.token]);const X=p.useMemo(()=>c.dossiers.filter(j=>mr(j,m,V,c.favIds)),[c.dossiers,m,V,c.favIds]),Ne=p.useMemo(()=>Va(ae,c.favIds),[ae,c.favIds]),$=Je.find(j=>j.key===m.continent),le=d==="fr"?$.fr:$.en,ue=(j,O)=>{const R=((j==null?void 0:j.name)||O||"").trim();if(!q){x({kicker:R});return}!R||C||(w(!0),(async()=>{try{const W=await Ft(U,R,"atelier2"),Re={name:W.company||R,verdict:W.verdict,reason:W.reason||"",remaining:W.remaining??null};_.current=[Re,..._.current].slice(0,8),W.verdict==="kept"&&y(fe=>({...fe,kept:fe.kept+1})),W.verdict==="ruled_out"&&y(fe=>({...fe,dropped:fe.dropped+1}));const ze=j||c.dossiers.find(fe=>(fe.name||"").toLowerCase()===R.toLowerCase());ze&&(W.verdict==="kept"?ze.verdict=ze.verdict||"MATCH":W.verdict==="ruled_out"&&(ze.verdict="NO MATCH"),W.reason&&(ze.reasoning=W.reason)),F()}finally{w(!1)}})())},Se=j=>{if(!q){x({kicker:j.name});return}ie.current.add(j.id),Ee(U,"fast_request",j.name||"",""),B(l.memoInstantSent(j.name)),F()},he=j=>Oe.current.get(j.id)??c.thumbs.get((j.name||"").trim().toLowerCase()),re=(j,O)=>h({type:"undoPush",entry:{id:j.id,name:j.name,prevCeoStatus:O}}),be=async(j,O,R)=>{const W=j.ceoStatus||"";j.ceoStatus=O,F();const Re=await Ue(U,{status:O,airtable_id:j.airtableId,check_id:j.checkId,company:j.name,...(R==null?void 0:R.note)!==void 0?{note:R.note}:{},...R!=null&&R.via?{via:R.via}:{}});return Re.ok?Re.skipped?(j.ceoStatus=W,F(),H(l.actNotPersisted),!1):((R==null?void 0:R.undo)!==!1&&re(j,W),R!=null&&R.msg&&B(R.msg),(O==="Validé"||O==="Écarté")&&!j.ceoNote&&(R==null?void 0:R.note)===void 0&&M({o:j,yes:O==="Validé"}),!0):(j.ceoStatus=W,F(),H(l.actErr),!1)},Ce=async(j,O)=>{const R=await Ue(U,{status:j.ceoStatus||"Retenu",airtable_id:j.airtableId,check_id:j.checkId,company:j.name,note:O,via:"note"});return!R.ok||R.skipped?(H(R.skipped?l.actNotPersisted:l.actErr),!1):(j.ceoNote=O,F(),!0)},oe=p.useRef(new Map),ve=j=>oe.current.has(j.id)?oe.current.get(j.id):c.stages.get((j.name||"").trim().toLowerCase()),Yt=(j,O)=>{oe.current.set(j.id,O),F()},Wt=(j,O)=>{q&&be(j,O?"Validé":"Écarté",{msg:O?l.decidedYes(j.name):l.decidedNo(j.name)})},Gt=j=>{q&&be(j,"À trancher",{msg:l.promoted(j.name)})},Kt=j=>{q&&(async()=>{const O=j.ceoStatus||"";j.ceoStatus="Retenu",F();const R=await Ue(U,{status:"Retenu",check_id:j.checkId,company:j.name});if(!R.ok||R.skipped){j.ceoStatus=O,F(),H(R.skipped?l.actNotPersisted:l.actErr);return}re(j,O),B(l.repeched(j.name))})()},Qt=()=>{const j=m.undo[m.undo.length-1];if(!j){B(l.undoNone);return}const O=ne.get(j.id);if(!O){h({type:"undoPop"}),B(l.undoNone);return}let R=j.prevCeoStatus;if(!R)if((O.verdict||"").toUpperCase().includes("CALL"))R="À trancher";else{B(l.undoLockedTitle);return}(async()=>await be(O,R,{undo:!1})&&(h({type:"undoPop"}),O.ceoStatus=j.prevCeoStatus,F(),B(l.undoDone(O.name))))()},Jt=j=>{q&&(ce.current.add(j.id),F(),(async()=>{const O=await Wa(U,j.name,"email");if(!O||O.ok===!1){ce.current.delete(j.id),F(),H(l.actErr);return}Ee(U,"approach",j.name||"",""),B(l.actApproachSent)})())},Xt=(j,O)=>{q&&(async()=>{if(!(await Ee(U,O?"yes":"no",j.name||"","")).ok){H(l.actErr);return}Oe.current.set(j.id,O?"yes":"no"),F(),B(O?l.thumbUpDone:l.thumbDnDone)})()},Zt=j=>{!q||!Xe(j)||(Ee(U,"detailed_request",j.name||"",""),B(l.memoDeepSent(j.name)))},ea=j=>{const O=new Set(c.favIds),R=O.has(j.id);R?O.delete(j.id):O.add(j.id),c.setFavIds(O),q&&Ga(U,{id:j.id,co:j.name},R)},ta=()=>{!q||P||window.confirm(l.identSyncConfirm)&&(L(!0),(async()=>{const j=await Ka(U);L(!1),j?B(l.identSyncDone):H(l.actErr)})())},ot=/proplace/i.test(c.fund||""),aa=j=>{!q||!ot||(Ee(U,"onboard_request",j.name||"",""),B(l.onboardSent(j.name)))},ra={st:m,dispatch:h,t:l,lang:d,mode:pe,caps:Y,pipe:V,token:U,fund:c.fund,email:c.email,criteria:c.criteria,data:c,doRepeche:Kt,thumbOf:he,canWrite:q,commitStatus:be,saveNote:Ce,stageOf:ve,setStage:Yt,flashErr:H,startTour:()=>E(!0),dossiers:c.dossiers,scopedAll:ae,scoped:X,counts:Ne,byId:ne,contName:le,favIds:c.favIds,toggleFav:ea,askEvaluate:ue,doAnalyse:Se,doDecide:Wt,doPromote:Gt,doApproach:Jt,doThumb:Xt,doDeep:Zt,doUndo:Qt,doSync:ta,doOnboard:aa,outbound:ot,memoQueued:ie.current,approachDone:ce.current,sessTally:u,evalCards:_.current,evalBusy:C,markRow:g,markedId:v,flash:B};return p.useEffect(()=>{const j=O=>{O.key==="Escape"&&(h({type:"popup",id:null}),h({type:"modal",modal:null}),h({type:"openFacet",facet:null}))};return window.addEventListener("keydown",j),()=>window.removeEventListener("keydown",j)},[]),e.jsx(Ut.Provider,{value:ra,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:rr}),e.jsxs("div",{className:"app"+(V?" pipe":""),children:[Y.showTicker&&e.jsx(G,{name:"live",children:e.jsx(xr,{})}),Y.showIdent&&e.jsx(G,{name:"identite",children:e.jsx(Or,{})}),Y.showOnb&&e.jsx(G,{name:"onboarding",children:e.jsx(Rr,{})}),Y.showMorning&&e.jsx(G,{name:"matin",children:e.jsx(Lr,{})}),e.jsx(G,{name:"fraicheur",children:e.jsx(jr,{})}),e.jsx(G,{name:"mesure",children:e.jsx(Nr,{})}),Y.showFunnel&&e.jsx(G,{name:"entonnoir",children:e.jsx(Rn,{})}),Y.showFunnel&&e.jsx(G,{name:"tunnel",children:e.jsx(Mr,{})}),Y.showFunnel&&e.jsx(G,{name:"tuto",children:e.jsx(qr,{})}),e.jsx(G,{name:"carte",fallback:e.jsx("div",{className:"void",children:l.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(Fn,{}),e.jsxs("div",{className:"stage"+(m.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Ir,{}),e.jsx($r,{})]})]})}),Y.showDemand&&e.jsx(G,{name:"evaluation",children:e.jsx(Ur,{})}),Y.showDemand&&m.memoConsole&&e.jsx(G,{name:"console",children:e.jsx(_r,{})}),e.jsx(G,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[l.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:e.jsx(an,{})}),c.loading&&e.jsx("div",{className:"void",children:l.loadingV2}),c.error&&!c.loading&&e.jsxs("div",{className:"void",children:[l.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:l.retry})]})]}),Y.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:l.lockbarText}),e.jsx("button",{type:"button",onClick:()=>h({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),m.popupId&&e.jsx(G,{name:"fiche",children:e.jsx(on,{})}),e.jsx(G,{name:"modales",children:e.jsx(pn,{})}),e.jsx(yr,{}),T&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:T.o.name}),e.jsx(Er,{placeholder:T.yes?l.whyYesPh:l.whyNoPh,onDone:j=>{const O=T.o;M(null),j&&Ce(O,j).then(R=>{R&&B(l.csNoteSaved)})}})]}),D&&e.jsx(Ar,{steps:On(l),onClose:()=>{E(!1),Lt(U)}}),k&&e.jsx("div",{className:"flash on"+(z?" err":""),children:k}),f&&e.jsx(Ua,{variant:"acquirer",initialCompany:Ot().co,initialWebsite:Ot().site,onClose:()=>x(null)})]})})}function Rn(){const{t}=A(),[a,n]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Fn(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:i,t:o}=A(),d=p.useMemo(()=>{const l={};return t.forEach(c=>{c.continent&&tt(c,a.filters,r)&&(l[c.continent]=(l[c.continent]||0)+1)}),l},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Qa.map(l=>{const c=Je.find(m=>m.key===l);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===l,onClick:()=>n({type:"continent",key:l}),children:[i==="fr"?c.fr:c.en,e.jsx("span",{className:"n",children:d[l]||0})]},l)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ot(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Mn(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Ht as FlagCell,je as SigBadge,Be as SigWin,Pn as default,Mn as fmtShort,A as useV2};
