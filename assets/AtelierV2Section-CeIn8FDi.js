...
`,Ci=Si+Ei;function ja(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ai(){const e=ja("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ti(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ai();return r==="0"?"client":r==="1"||ja("embed")==="1"&&ja("chrome")==="1"?"apercu":"client"}const zi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},qi=e=>zi[e];function rr(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Xe=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ga(a)||rr(a))&&(e.noCo=!0)}return Object.assign(e,{continent:vo(e.cc)})};function ca(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Li=60*60*1e3;function Ri(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Li?null:a}catch{return null}}function Mt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Mi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Oi(e,a,r="default"){const n=r!=="default",i=f.useMemo(()=>e||n?{mode:"anon"}:lo(),[e,n]),o=f.useMemo(()=>n?"visiteur":Ti(e,i),[e,i,n]),l=f.useMemo(()=>qi(o),[o]),s=o!=="visiteur",d=Mi(r),[x,c]=f.useState([]),[m,u]=f.useState(""),[b,p]=f.useState(null),[g,v]=f.useState(null),[h,N]=f.useState(null),[j,y]=f.useState(()=>new Map),[z,R]=f.useState(()=>new Map),[L,S]=f.useState(""),[E,k]=f.useState(new Set),[M,T]=f.useState(null),[O,C]=f.useState(!0),[A,F]=f.useState(!1),[U,G]=f.useState(0),[W,V]=f.useState(0),K=f.useRef(0),Q=f.useMemo(()=>{var ee;if(o!=="client")return"";try{return((ee=co())==null?void 0:ee.email)||""}catch{return""}},[o]);f.useEffect(()=>{const ee=++K.current;let fe=!0;const ge=()=>fe&&ee===K.current,xe=(s&&i.token?i.token:"pub:"+a)+(d?":"+d:""),Z=Ri(xe);return Z?(c(Z.objs.map(Xe)),Z.fund&&u(Z.fund),p(Z.marketEstimate??null),v(Z.criteria??null),N(Z.stats??null),S(Z.generatedAt||""),C(!1)):C(!0),(async()=>{try{if(r==="ops"){const ie=await sa(),ae=((ie==null?void 0:ie.recent_ops)||[]).map(H=>{const J=Ut(H.company_name||H.title?H:{...H,title:(H.headline_fr||H.headline||"").slice(0,120)},a),ue=String(H.rubrique||"").toLowerCase();return J&&(ue==="nominations"||ue==="recrutements")&&(J.engine=ue),J&&!String(H.company_name||"").trim()&&(J.noCo=!0),J}).filter(H=>!!H).map(H=>(ga((H.name||"").trim())||(H.noCo=!0),H));try{const H=po(),J=H&&H.doc||await uo(),ue=mo(J),q=((H==null?void 0:H.day)||(J==null?void 0:J.date)||"").slice(0,10);if(ue.length&&q){const $=new Set;for(const D of ae){if(D.noCo||(D.date||"").slice(0,10)!==q)continue;const Y=an(ue,$,D.name,"");Y>=0&&($.add(Y),D.decryptHtml=ue[Y].html)}for(const D of ae){if(D.decryptHtml||(D.date||"").slice(0,10)!==q)continue;const Y=an(ue,$,"",D.headline||D.tagline||D.name);Y>=0&&($.add(Y),D.decryptHtml=ue[Y].html)}ue.forEach((D,Y)=>{if($.has(Y))return;const ne=(D.t||"").trim(),X=ne.split(/[:–—]/)[0].trim().slice(0,80)||ne.slice(0,40);if(!X)return;const se=ne+" "+D.html,Ee=/\b(acquiert|rachat|rachet|fusion|buyout|offre sur)\b/i.test(se),ce=/\b(l[eè]ve|lev[ée]e|raises?|funding|s[eé]rie [a-z]|series [a-z])\b/i.test(se);ae.push({id:`edito:${q}:${Y}`,kind:"op",name:X,cc:null,date:q,engine:Ee?"ma":ce?"fundraising":"media",dealKind:Ee?"ma":ce?"levee":"other",headline:ne,decryptHtml:D.html,noCo:!ga(X)||rr(X)})})}}catch{}if(!ge())return;c(ae.map(Xe)),Mt(xe,{objs:ae})}else if(typeof r=="object"){const ae=(await nn()||[]).filter(J=>(J.slug||"")===r.research).map(J=>rn(J,a)).filter(J=>!!J),H=ca(await on(ae,a));if(!ge())return;c(H.map(Xe)),Mt(xe,{objs:H})}else if(s&&i.token){const ie=fo(i.token),ae=sa(),H=xo(i.token),J=ho(i.token),ue=go(i.token),q=await ie;let $=q?q.targets:[];ge()&&q&&(u(q.fund||""),p(q.marketEstimate??null),v(q.criteria??null),N(q.stats??null),S(q.generatedAt||""),c($.map(Xe)),C(!1),F(!1));const[D,Y,ne,X]=await Promise.all([ae,H,J,ue]),se=((D==null?void 0:D.recent_ops)||[]).map(ce=>Ut(ce,a)).filter(ce=>!!ce);if($=[...$,...se],!ge())return;c($.map(Xe));const Ee=new Set;for(const ce of Y){const Le=(ce.id||ce.co||"").toString().trim().toLowerCase();Le&&Ee.add(Le.startsWith("t:")?Le:"t:"+Le)}k(Ee),y(ne),R(X),q&&Mt(xe,{fund:q.fund,marketEstimate:q.marketEstimate,criteria:q.criteria,stats:q.stats,generatedAt:q.generatedAt,objs:$})}else{const ie=bo(),ae=nn(),H=sa(),J=await ie;ge()&&J.length&&(c(ca(J).map(Xe)),C(!1),F(!1));const[ue,q]=await Promise.all([ae,H]),$=(ue||[]).map(X=>rn(X,a)).filter(X=>!!X),D=await on($,a),Y=((q==null?void 0:q.recent_ops)||[]).map(X=>Ut(X,a)).filter(X=>!!X),ne=ca([...J,...D,...Y]);if(!ge())return;c(ne.map(Xe)),Mt(xe,{objs:ne})}ge()&&F(!1)}catch{ge()&&!Z&&F(!0)}finally{ge()&&C(!1)}})(),()=>{fe=!1}},[s,i.token,a,U,d]),f.useEffect(()=>{if(!l.showCredits||!Q){T(null);return}let ee=!0;return(async()=>{try{const fe=await fetch(`${Ia}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Q})});if(!fe.ok)return;const ge=await fe.json();ee&&ge&&ge.ok!==!1&&T(ge)}catch{}})(),()=>{ee=!1}},[l.showCredits,Q,W]);const te=f.useCallback(ee=>k(new Set(ee)),[]);return{session:i,mode:o,caps:l,fund:m,email:Q,marketEstimate:b,generatedAt:L,criteria:g,stats:h,thumbs:j,stages:z,dossiers:x,favIds:E,setFavIds:te,credits:M,reloadCredits:()=>V(ee=>ee+1),loading:O,error:A,refresh:()=>G(ee=>ee+1)}}const or=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Fi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...or(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Di=new Set(["signal","amount","score","crible","memo"]);function Pi(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:or(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Di.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??ir)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const ir=40;function Va(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!je(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes($a(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(Ke(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&et(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function sr(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Va(e,a.filters,r)}function Ii(e,a,r,n){return!(!sr(e,a,r)||r&&!yo(e,a.ptab,n))}function Ha(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-Ke(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return ko(i);case"memo":return wo(i);case"signal":{const o=je(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const da={},fn=(da==null?void 0:da.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function xn(){return new Date().toISOString().slice(0,10)}const Wa=f.createContext(null);function lr(){return f.useContext(Wa)}function $i(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),s.querySelectorAll("*").forEach(d=>{const x=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(c=>d.removeAttribute(c.name)),x&&/^https?:\/\//i.test(x)&&(d.setAttribute("href",x),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function hn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function cr(){const e=f.useContext(Wa);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Bi({token:e,children:a}){const{dispatch:r,st:n,lang:i}=B(),[o,l]=f.useState(()=>n.filters.day||xn()),[s,d]=f.useState(null),[x,c]=f.useState(!1),m=f.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=f.useCallback(()=>{l(xn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);f.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),f.useEffect(()=>{const g=v=>{var N;const h=(N=v.detail)==null?void 0:N.day;typeof h=="string"&&m(h)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[m]),f.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),f.useEffect(()=>{if(!e||!o)return;let g=!1;c(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${fn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{g||d(h)}).catch(()=>{g||d({ok:!1,error:"network"})}).finally(()=>{g||c(!1)}),()=>{g=!0}},[e,o]);const b=f.useMemo(()=>`${fn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=f.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,x,m,u,n.filters.day,b,i]);return t.jsx(Wa.Provider,{value:p,children:a})}function _i(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=cr(),[i,o]=f.useState(n);return f.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(jo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Ui(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=cr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:hn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:hn(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const Vi=["ma","levees","nominations","recrutements","actualites"],Hi=300,pa=7,Wi={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},dr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Yi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function gn(e){const a=je(e);if(a)return"sig:"+(a.theme&&dr.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Gi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:s}=B(),d=lr(),x=l==="en",[c,m]=f.useState("all"),[u,b]=f.useState(!1),p=f.useMemo(()=>{var W;const T=(a.filters.day||"").slice(0,10),O=V=>!(!o&&a.continent!=="monde"&&V.continent!==a.continent||T&&(V.date||"").slice(0,10)!==T),C=e.filter(V=>O(V)&&je(V)&&(!o||V.kind!=="target"||ke(V)!==5)),A=o&&(((W=d==null?void 0:d.ed)==null?void 0:W.ops)||[]).length?d.ed.ops.map(V=>Ut(V,l)).filter(V=>!!V).filter(V=>!T||(V.date||"").slice(0,10)===T):[],F=e.filter(V=>O(V)&&V.kind==="op"&&!je(V)&&(T?!0:Ke(V.date)<=pa)),U=o?A.length?A:F.filter(V=>{const K=(s||"").trim().toLowerCase();if(!K)return!1;const Q=V.match||null;return Q?Object.keys(Q).map(te=>te.trim().toLowerCase()).includes(K):!1}):F,G=T||new Date().toISOString().slice(0,10);return U.sort((V,K)=>{const Q=(V.date||"").slice(0,10)===G?0:1,te=(K.date||"").slice(0,10)===G?0:1;return Q!==te?Q-te:(K.amountEur||0)-(V.amountEur||0)}),[...Ha(C,{key:"signal",dir:-1}),...U]},[e,a.continent,a.filters.day,o,s,l,d]),g=f.useMemo(()=>{const T={};for(const O of p){const C=gn(O);T[C]=(T[C]||0)+1}return T},[p]),v=f.useMemo(()=>c==="all"?p:p.filter(T=>gn(T)===c),[p,c]),h=f.useMemo(()=>v.slice(0,Hi),[v]),N=v.length-h.length,j=f.useRef(null);f.useEffect(()=>{var U,G;const T=j.current;if(!T)return;const O=()=>{const W=T.scrollWidth;W<200||(T.style.animationDuration=Math.max(18,Math.round(W/130))+"s")};O();const C=requestAnimationFrame(O),A=window.setTimeout(O,1200);let F=!0;return(G=(U=document.fonts)==null?void 0:U.ready)==null||G.then(()=>{F&&O()}),()=>{F=!1,cancelAnimationFrame(C),window.clearTimeout(A)}},[h.length,c]);const y=T=>T==="all"?p.length:g[T]||0,z=T=>T==="all"?x?"All":"Tout":T.startsWith("sig:")?dr[x?"en":"fr"][T.slice(4)]||"🔔":Wi[x?"en":"fr"][T],R=[{k:"all"}],L=Vi.filter(T=>y(T)>0||T===c);if(L.length){R.push({g:x?"DEALS":"OPÉRATIONS"});for(const T of L)R.push({k:T})}const S=Yi.map(T=>"sig:"+T).filter(T=>y(T)>0||T===c);if(S.length){R.push({g:x?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const T of S)R.push({k:T})}const E=T=>{try{return new Date(T+"T12:00:00Z").toLocaleDateString(x?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return T}},k=(()=>{const T=(a.filters.day||"").slice(0,10),O=!o&&a.continent!=="monde"&&i?x?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return T?(x?`LIVE covers the events of ${E(T)}.`:`Le LIVE regroupe les événements du ${E(T)}.`)+O:(x?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+O})(),M=T=>h.map(O=>t.jsxs("button",{type:"button",className:"tk"+(qe(O)?" spent":""),onClick:C=>{const A=C.currentTarget.getBoundingClientRect();n({type:"popup",id:O.id,anchor:{x:A.left+A.width/2,y:A.bottom}})},title:O.name+(O.tagline?" — "+O.tagline:""),children:[t.jsx(rt,{o:O}),t.jsxs("span",{className:"who",children:[t.jsx(Vr,{o:O}),t.jsx("span",{className:"co",children:O.name})]}),typeof O.amountEur=="number"&&O.amountEur>0&&t.jsx("span",{className:"am",children:hc(O.amountEur)}),O.sector&&t.jsx("span",{className:"mt",children:O.sector}),t.jsx(na,{o:O}),t.jsx("span",{className:"tkgo",children:"→"})]},T+(O.id||O.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:x?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},T+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:T=>{T.currentTarget.contains(T.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(T=>!T),children:[z(c),t.jsx("b",{children:y(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:k}),R.map(T=>"g"in T?t.jsx("span",{className:"tkfilg",children:T.g},T.g):t.jsxs("button",{type:"button","aria-pressed":T.k===c,onClick:()=>{m(T.k),b(!1)},children:[z(T.k),t.jsx("b",{children:y(T.k)})]},T.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:j,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const Ki="aDx8z7Hzksus",Ya="+33 6 83 10 72 86",Wt="alexandre@proplace.co",pr=`tel:${Ya.replace(/[^\d+]/g,"")}`,bn="pp-rdv-slot";function Qi(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Ji(){const{t:e,caps:a,fund:r}=B();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:Zi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:pr,children:Ya}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Wt}`,children:Wt})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(gi,{filloutId:Ki,parameters:r?{company_name:r}:void 0})})]})}function Xi(){const[e,a]=f.useState(()=>typeof document>"u"?null:document.getElementById(bn));return f.useEffect(()=>{e||a(document.getElementById(bn))},[e]),e?mt.createPortal(t.jsx(Ji,{}),e):null}const Zi=`
...
`;class Ce extends f.Component{constructor(){super(...arguments);en(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ua=600,Ze=62,vn="atl2:fstats";function es(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=B(),[l,s]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(vn)==="on"}catch{return!1}}),d=r.stats,x=f.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),c=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const m=z=>a==="en"?z.slice(5,10):`${z.slice(8,10)}/${z.slice(5,7)}`,u=z=>z.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((z,R)=>Math.max(z,R.s||0),0),p=x.length?ua/x.length:0,g=Math.max(4,p-4),v=x.length>=5&&b>0,h=r.marketEstimate||0,N=m(new Date().toISOString().slice(0,10)),j=z=>[...typeof z=="number"?[[z,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&c&&y.push({cle:"fenetre",periode:e.funPerWindow(m(c),N),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:j(d.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(z=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:z.periode}),z.etapes.map(([R,L],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(R)}),t.jsx("i",{children:L})]},z.cle+L)),z.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((d.screened||0)/h*100)))})]}),z.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const R=!l;s(R),R&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(vn,R?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},z.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ua} ${Ze}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((z,R)=>{const L=(z.s||0)/b*(Ze-4),S=(z.m||0)/b*(Ze-4),E=R*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(z.d)} — ${z.s} ${e.actScreened} · ${z.m} ${e.actKept}`}),t.jsx("rect",{x:E,y:Ze-2-L,width:g,height:L,fill:"#cfe0d6"}),t.jsx("rect",{x:E,y:Ze-2-S,width:g,height:S,fill:"#185c38"})]},z.d)}),t.jsx("line",{x1:0,y1:Ze-1.5,x2:ua,y2:Ze-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const ur=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ts(e,a){if((Qe(e)||"").startsWith("CALL")&&ke(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ke(e)>=2;return ur.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function as({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=B(),[s,d]=f.useState(!1),[x,c]=f.useState(""),[m,u]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),p=async g=>{if(x)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}c(g);const v=await i(e,g);c(""),v&&(d(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:m?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),d(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const g=await i(e,"Analysé");c(""),g&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]}):ts(e,a).map(([g,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(x===g?" busy":""),disabled:!!x,onClick:()=>{p(g)},children:v},g))})]})}function ns({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=B(),[o,l]=f.useState(""),[s,d]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),c=(Qe(e)||"").startsWith("CALL")&&ke(e)===3,m=ke(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const g=await i(e,p);l(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:ur.filter(([p])=>!(m&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(x===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(rs,{o:e})]})}function rs({o:e}){const{t:a,saveNote:r,flash:n}=B(),[i,o]=f.useState(e.ceoNote||""),[l,s]=f.useState(!1),[d,x]=f.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{m()},children:d?a.csNoteSaved:a.csNoteOk})]})}function os({placeholder:e,onDone:a}){const{t:r}=B(),[n,i]=f.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function is({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=B(),[d,x]=f.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const c=o(e),m=(c==null?void 0:c.stage)||"todo",u=async h=>{if(d||h===m)return;x(!0);const N=c;l(e,{stage:h,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),yn+=1);yn=j;const y=await No(r,{company:e.name||"",stage:h,cts:j,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(l(e,N),s(a.actErr)))},b=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,N])=>t.jsx("button",{type:"button",className:"stgb"+(m===h?" on":""),disabled:d,onClick:()=>{u(h)},children:N},h)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let yn=0;const Ot=8,Ft=360;function wn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function kn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(wn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(wn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ss({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=B(),[l,s]=f.useState(0),[d,x]=f.useState(null),[c,m]=f.useState([]),u=f.useRef(!1),b=f.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=f.useRef(!1);f.useEffect(()=>{const L=b.current;return()=>{p.current||(n({type:"ptab",tab:L.ptab}),n({type:"dens",dens:L.dens}),n({type:"modal",modal:L.modal}))}},[]),f.useEffect(()=>{u.current||(u.current=!0,m(e.filter(L=>!!document.querySelector(L.need||L.sel))))},[e]);const g=c[l],v=l>=c.length;f.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const L=g.click,S=window.setTimeout(()=>{const E=document.querySelector(L);E&&E.getAttribute("aria-selected")!=="true"&&E.click()},60);return()=>window.clearTimeout(S)}},[l,g]);const h=f.useRef(-1),N=f.useCallback(()=>{if(!g){x(null);return}const L=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!L){x(null);return}h.current!==l&&(h.current=l,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=L.getBoundingClientRect();x(E=>E&&Math.abs(E.top-S.top)<1&&Math.abs(E.left-S.left)<1&&Math.abs(E.width-S.width)<1&&Math.abs(E.height-S.height)<1?E:S)},[g,l]);f.useLayoutEffect(()=>{N();const L=[90,300,700,1300].map(E=>window.setTimeout(N,E)),S=()=>N();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{L.forEach(E=>window.clearTimeout(E)),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[N]);const j=f.useRef(a);if(j.current=a,f.useEffect(()=>{const L=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),j.current()):S.key==="ArrowRight"?s(E=>E+1):S.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",L,!0),()=>document.removeEventListener("keydown",L,!0)},[]),!c.length)return null;let y=null;const z=L=>()=>{p.current=!0,n({type:"modal",modal:null}),L()};if(v){const L=i[3]||0;L>0?y={title:L===1?r.ahaATitle1:r.ahaATitleN(L),body:r.ahaABody,btn:r.ahaABtn,go:z(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:z(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:z(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:z(()=>{n({type:"modal",modal:"crit"}),a()})}}let R={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Ft};if(!v&&d){const L=d.bottom+14,E=window.innerHeight-L>190?L:Math.max(12,d.top-200);R={left:Math.min(Math.max(12,d.left+d.width/2-Ft/2),window.innerWidth-Ft-12),top:E,width:Ft}}return mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Ot,top:d.top-Ot,width:d.width+Ot*2,height:d.height+Ot*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:R,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(kn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(kn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(L=>Math.max(0,L-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(L=>L+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function mr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function fr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ls(){var S,E;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:s,dispatch:d}=B(),x=r?a:e,c=f.useMemo(()=>x.filter(k=>Ke(k.date)===0&&k.kind==="target"),[x]),m=f.useMemo(()=>r?a.filter(k=>k.kind==="target"&&ke(k)===0).slice().sort((k,M)=>(M.date||"").localeCompare(k.date||"")):[],[a,r]),u=f.useMemo(()=>c.filter(k=>r?ke(k)===0:!qe(k)),[c,r]),b=r?m:u,p=r?a.length-m.length:c.length-u.length,g=r?a.length:c.length,v=g?Math.min(100,p/g*100):100,h=f.useMemo(()=>mr(x),[x]),N=!!h&&Ke(h)>0,j=f.useMemo(()=>N?x.filter(k=>(k.date||"").slice(0,10)===h):[],[x,h,N]),y=typeof((S=s.stats)==null?void 0:S.kept_today)=="number"?s.stats.kept_today:null,z=typeof((E=s.stats)==null?void 0:E.screened_today)=="number"?s.stats.screened_today:c.length;let R;N?R=i.morningLast(j.length,m.length,fr(h,l)):r?R=i.morningThesis(z,m.length,y):c.length?p===0?R=i.goalSourced(c.length):p>=c.length?R=i.goalCleared:R=i.goalDone(p,c.length):R=i.goalSourced(0);const L=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&m.length&&d({type:"chainStart",queue:m.map(k=>k.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:R}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:L,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function cs(){var U,G;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:d,doSync:x,startTour:c,flash:m,flashErr:u}=B(),[b,p]=f.useState(null),[g,v]=f.useState(!0),[h,N]=f.useState([]),j=d==="client";f.useEffect(()=>{if(!i||!o)return;let W=!0;return v(!0),(async()=>{const[V,K]=await Promise.all([Ba(o),tr(i)]);W&&(V&&p(V),v(!1),N(K))})(),()=>{W=!1}},[i,o]);const[y,z]=f.useState(!1),R=()=>{!j||y||!o||(z(!0),So(o).then(W=>{z(!1),W?m(e.identRepubDone):u(e.actErr)}))},L=(b==null?void 0:b.per_day)??null,S=((U=b==null?void 0:b.pool_order)==null?void 0:U.length)??0,E=h.filter(W=>W.status==="running").length,k=f.useMemo(()=>s.filter(W=>W.kind==="target"&&qe(W)).length,[s]),M=l.marketEstimate,T=typeof((G=l.stats)==null?void 0:G.screened)=="number"?l.stats.screened:k,O=M&&M>0?Math.min(100,Math.round(T/M*100)):null,C=W=>W.toLocaleString(a==="en"?"en-US":"fr-FR"),A=(o||"P").split(/\s+/).map(W=>W[0]).join("").slice(0,2).toUpperCase(),F=(()=>{const W=Date.parse(l.generatedAt||"");if(Number.isNaN(W))return"";const V=new Date(W),K=Q=>String(Q).padStart(2,"0");return`${K(V.getDate())}/${K(V.getMonth()+1)} à ${K(V.getHours())}:${K(V.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?A:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),F?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(F)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[O===null&&T>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:C(T)})})]}),O!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:O+"%"}})}),t.jsxs("b",{children:[O," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(T,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),L!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:L})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),L===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),E>0&&t.jsxs("span",{className:"ev",children:["⏳ ",E]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:W=>{W.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||y,onClick:R,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:W=>n({type:"filters",patch:{search:W.target.value}})})]})]})]})}function ds(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=B(),s=o.loading&&!l.length,d=f.useRef({});f.useEffect(()=>{d.current={...r}},[r]);const x=u=>{const b=d.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${ba[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},c=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${ba[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function ps(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=B(),s=f.useRef(null),[d,x]=f.useState(60);f.useEffect(()=>{let p=0;const g=()=>{var y;const v=s.current;if(!v)return;const h=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!h)return;const N=h.getBoundingClientRect(),j=v.getBoundingClientRect();x(Math.max(20,Math.min(N.left+N.width/2-j.left,j.width-30)))};return p=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",g)}},[e.ptab]);const c=e.ptab;let m=r.tuto[c].p;if(c===3){const p=n.filter(h=>h.kind==="target"&&ke(h)===3),g=p.filter(h=>va(h)==="auto").length,v=p.filter(h=>va(h)==="cd").length;m=r.tutoPending(g,v,p.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(c===1){const p=n.filter(g=>g.kind==="target"&&ke(g)===1&&!i.has(g.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(g=>g.id)})}}return null})(),b=Eo(c);return t.jsxs("div",{ref:s,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${ba[c]})`,"--ax":d+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class at{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*us(e){for(const a of e)yield*a}function xr(e){return Array.from(us(e))}var de=1e-6,re=Math.PI,Fe=re/2,jn=re/4,Pe=re*2,We=180/re,ze=re/180,me=Math.abs,ms=Math.atan,jt=Math.atan2,be=Math.cos,ve=Math.sin,fs=Math.sign||function(e){return e>0?1:e<0?-1:0},ot=Math.sqrt;function xs(e){return e>1?0:e<-1?re:Math.acos(e)}function Nt(e){return e>1?Fe:e<-1?-Fe:Math.asin(e)}function De(){}function Yt(e,a){e&&Sn.hasOwnProperty(e.type)&&Sn[e.type](e,a)}var Nn={Feature:function(e,a){Yt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Yt(r[n].geometry,a)}},Sn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Na(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Na(r[n],a,0)},Polygon:function(e,a){En(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)En(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Yt(r[n],a)}};function Na(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function En(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Na(e[r],a,1);a.polygonEnd()}function st(e,a){e&&Nn.hasOwnProperty(e.type)?Nn[e.type](e,a):Yt(e,a)}function Sa(e){return[jt(e[1],e[0]),Nt(e[2])]}function pt(e){var a=e[0],r=e[1],n=be(r);return[n*be(a),n*ve(a),ve(r)]}function Dt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Gt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ma(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Pt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Ea(e){var a=ot(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ca(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Aa(e,a){return me(e)>re&&(e-=Math.round(e/Pe)*Pe),[e,a]}Aa.invert=Aa;function hs(e,a,r){return(e%=Pe)?a||r?Ca(An(e),Tn(a,r)):An(e):a||r?Tn(a,r):Aa}function Cn(e){return function(a,r){return a+=e,me(a)>re&&(a-=Math.round(a/Pe)*Pe),[a,r]}}function An(e){var a=Cn(e);return a.invert=Cn(-e),a}function Tn(e,a){var r=be(e),n=ve(e),i=be(a),o=ve(a);function l(s,d){var x=be(d),c=be(s)*x,m=ve(s)*x,u=ve(d),b=u*r+c*n;return[jt(m*i-b*o,c*r-u*n),Nt(b*i+m*o)]}return l.invert=function(s,d){var x=be(d),c=be(s)*x,m=ve(s)*x,u=ve(d),b=u*i-m*o;return[jt(m*i+u*o,c*r+b*n),Nt(b*r-c*n)]},l}function gs(e,a,r,n,i,o){if(r){var l=be(a),s=ve(a),d=n*r;i==null?(i=a+n*Pe,o=a-d/2):(i=zn(l,i),o=zn(l,o),(n>0?i<o:i>o)&&(i+=n*Pe));for(var x,c=i;n>0?c>o:c<o;c-=d)x=Sa([l,-s*be(c),-s*ve(c)]),e.point(x[0],x[1])}}function zn(e,a){a=pt(a),a[0]-=e,Ea(a);var r=xs(-a[1]);return((-a[2]<0?-r:r)+Pe-de)%Pe}function hr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:De,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Vt(e,a){return me(e[0]-a[0])<de&&me(e[1]-a[1])<de}function It(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function gr(e,a,r,n,i){var o=[],l=[],s,d;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],h=p[g],N;if(Vt(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=p[s])[0],v[1]);i.lineEnd();return}h[0]+=2*de}o.push(N=new It(v,p,null,!0)),l.push(N.o=new It(v,null,N,!1)),o.push(N=new It(h,p,null,!1)),l.push(N.o=new It(h,null,N,!0))}}),!!o.length){for(l.sort(a),qn(o),qn(l),s=0,d=l.length;s<d;++s)l[s].e=r=!r;for(var x=o[0],c,m;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,d=c.length;s<d;++s)i.point((m=c[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((m=c[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);i.lineEnd()}}}function qn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function fa(e){return me(e[0])<=re?e[0]:fs(e[0])*((me(e[0])+re)%Pe-re)}function bs(e,a){var r=fa(a),n=a[1],i=ve(n),o=[ve(r),-be(r),0],l=0,s=0,d=new at;i===1?n=Fe+de:i===-1&&(n=-Fe-de);for(var x=0,c=e.length;x<c;++x)if(u=(m=e[x]).length)for(var m,u,b=m[u-1],p=fa(b),g=b[1]/2+jn,v=ve(g),h=be(g),N=0;N<u;++N,p=y,v=R,h=L,b=j){var j=m[N],y=fa(j),z=j[1]/2+jn,R=ve(z),L=be(z),S=y-p,E=S>=0?1:-1,k=E*S,M=k>re,T=v*R;if(d.add(jt(T*E*ve(k),h*L+T*be(k))),l+=M?S+E*Pe:S,M^p>=r^y>=r){var O=Gt(pt(b),pt(j));Ea(O);var C=Gt(o,O);Ea(C);var A=(M^S>=0?-1:1)*Nt(C[2]);(n>A||n===A&&(O[0]||O[1]))&&(s+=M^S>=0?1:-1)}}return(l<-de||l<de&&d<-1e-12)^s&1}function br(e,a,r,n){return function(i){var o=a(i),l=hr(),s=a(l),d=!1,x,c,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=N,u.lineEnd=j,c=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,c=xr(c);var y=bs(x,n);c.length?(d||(i.polygonStart(),d=!0),gr(c,ys,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),c=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,z){e(y,z)&&i.point(y,z)}function p(y,z){o.point(y,z)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,z){m.push([y,z]),s.point(y,z)}function N(){s.lineStart(),m=[]}function j(){h(m[0][0],m[0][1]),s.lineEnd();var y=s.clean(),z=l.result(),R,L=z.length,S,E,k;if(m.pop(),x.push(m),m=null,!!L){if(y&1){if(E=z[0],(S=E.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),R=0;R<S;++R)i.point((k=E[R])[0],k[1]);i.lineEnd()}return}L>1&&y&2&&z.push(z.pop().concat(z.shift())),c.push(z.filter(vs))}}return u}}function vs(e){return e.length>1}function ys(e,a){return((e=e.x)[0]<0?e[1]-Fe-de:Fe-e[1])-((a=a.x)[0]<0?a[1]-Fe-de:Fe-a[1])}const Ln=br(function(){return!0},ws,js,[-re,-Fe]);function ws(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?re:-re,d=me(o-a);me(d-re)<de?(e.point(a,r=(r+l)/2>0?Fe:-Fe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&d>=re&&(me(a-n)<de&&(a-=n*de),me(o-s)<de&&(o-=s*de),r=ks(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function ks(e,a,r,n){var i,o,l=ve(e-r);return me(l)>de?ms((ve(a)*(o=be(n))*ve(r)-ve(n)*(i=be(a))*ve(e))/(i*o*l)):(a+n)/2}function js(e,a,r,n){var i;if(e==null)i=r*Fe,n.point(-re,i),n.point(0,i),n.point(re,i),n.point(re,0),n.point(re,-i),n.point(0,-i),n.point(-re,-i),n.point(-re,0),n.point(-re,i);else if(me(e[0]-a[0])>de){var o=e[0]<a[0]?re:-re;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ns(e){var a=be(e),r=2*ze,n=a>0,i=me(a)>de;function o(c,m,u,b){gs(b,e,r,u,c,m)}function l(c,m){return be(c)*be(m)>a}function s(c){var m,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,h){var N=[v,h],j,y=l(v,h),z=n?y?0:x(v,h):y?x(v+(v<0?re:-re),h):0;if(!m&&(p=b=y)&&c.lineStart(),y!==b&&(j=d(m,N),(!j||Vt(m,j)||Vt(N,j))&&(N[2]=1)),y!==b)g=0,y?(c.lineStart(),j=d(N,m),c.point(j[0],j[1])):(j=d(m,N),c.point(j[0],j[1],2),c.lineEnd()),m=j;else if(i&&m&&n^y){var R;!(z&u)&&(R=d(N,m,!0))&&(g=0,n?(c.lineStart(),c.point(R[0][0],R[0][1]),c.point(R[1][0],R[1][1]),c.lineEnd()):(c.point(R[1][0],R[1][1]),c.lineEnd(),c.lineStart(),c.point(R[0][0],R[0][1],3)))}y&&(!m||!Vt(m,N))&&c.point(N[0],N[1]),m=N,b=y,u=z},lineEnd:function(){b&&c.lineEnd(),m=null},clean:function(){return g|(p&&b)<<1}}}function d(c,m,u){var b=pt(c),p=pt(m),g=[1,0,0],v=Gt(b,p),h=Dt(v,v),N=v[0],j=h-N*N;if(!j)return!u&&c;var y=a*h/j,z=-a*N/j,R=Gt(g,v),L=Pt(g,y),S=Pt(v,z);ma(L,S);var E=R,k=Dt(L,E),M=Dt(E,E),T=k*k-M*(Dt(L,L)-1);if(!(T<0)){var O=ot(T),C=Pt(E,(-k-O)/M);if(ma(C,L),C=Sa(C),!u)return C;var A=c[0],F=m[0],U=c[1],G=m[1],W;F<A&&(W=A,A=F,F=W);var V=F-A,K=me(V-re)<de,Q=K||V<de;if(!K&&G<U&&(W=U,U=G,G=W),Q?K?U+G>0^C[1]<(me(C[0]-A)<de?U:G):U<=C[1]&&C[1]<=G:V>re^(A<=C[0]&&C[0]<=F)){var te=Pt(E,(-k+O)/M);return ma(te,L),[C,Sa(te)]}}}function x(c,m){var u=n?e:re-e,b=0;return c<-u?b|=1:c>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return br(l,s,o,n?[0,-e]:[-re,e-re])}function Ss(e,a,r,n,i,o){var l=e[0],s=e[1],d=a[0],x=a[1],c=0,m=1,u=d-l,b=x-s,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<c)return;p<m&&(m=p)}else if(u>0){if(p>m)return;p>c&&(c=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>m)return;p>c&&(c=p)}else if(u>0){if(p<c)return;p<m&&(m=p)}if(p=n-s,!(!b&&p>0)){if(p/=b,b<0){if(p<c)return;p<m&&(m=p)}else if(b>0){if(p>m)return;p>c&&(c=p)}if(p=o-s,!(!b&&p<0)){if(p/=b,b<0){if(p>m)return;p>c&&(c=p)}else if(b>0){if(p<c)return;p<m&&(m=p)}return c>0&&(e[0]=l+c*u,e[1]=s+c*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var gt=1e9,$t=-gt;function Es(e,a,r,n){function i(x,c){return e<=x&&x<=r&&a<=c&&c<=n}function o(x,c,m,u){var b=0,p=0;if(x==null||(b=l(x,m))!==(p=l(c,m))||d(x,c)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==p);else u.point(c[0],c[1])}function l(x,c){return me(x[0]-e)<de?c>0?0:3:me(x[0]-r)<de?c>0?2:1:me(x[1]-a)<de?c>0?1:0:c>0?3:2}function s(x,c){return d(x.x,c.x)}function d(x,c){var m=l(x,1),u=l(c,1);return m!==u?m-u:m===0?c[1]-x[1]:m===1?x[0]-c[0]:m===2?x[1]-c[1]:c[0]-x[0]}return function(x){var c=x,m=hr(),u,b,p,g,v,h,N,j,y,z,R,L={point:S,lineStart:T,lineEnd:O,polygonStart:k,polygonEnd:M};function S(A,F){i(A,F)&&c.point(A,F)}function E(){for(var A=0,F=0,U=b.length;F<U;++F)for(var G=b[F],W=1,V=G.length,K=G[0],Q,te,ee=K[0],fe=K[1];W<V;++W)Q=ee,te=fe,K=G[W],ee=K[0],fe=K[1],te<=n?fe>n&&(ee-Q)*(n-te)>(fe-te)*(e-Q)&&++A:fe<=n&&(ee-Q)*(n-te)<(fe-te)*(e-Q)&&--A;return A}function k(){c=m,u=[],b=[],R=!0}function M(){var A=E(),F=R&&A,U=(u=xr(u)).length;(F||U)&&(x.polygonStart(),F&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),U&&gr(u,s,A,o,x),x.polygonEnd()),c=x,u=b=p=null}function T(){L.point=C,b&&b.push(p=[]),z=!0,y=!1,N=j=NaN}function O(){u&&(C(g,v),h&&y&&m.rejoin(),u.push(m.result())),L.point=S,y&&c.lineEnd()}function C(A,F){var U=i(A,F);if(b&&p.push([A,F]),z)g=A,v=F,h=U,z=!1,U&&(c.lineStart(),c.point(A,F));else if(U&&y)c.point(A,F);else{var G=[N=Math.max($t,Math.min(gt,N)),j=Math.max($t,Math.min(gt,j))],W=[A=Math.max($t,Math.min(gt,A)),F=Math.max($t,Math.min(gt,F))];Ss(G,W,e,a,r,n)?(y||(c.lineStart(),c.point(G[0],G[1])),c.point(W[0],W[1]),U||c.lineEnd(),R=!1):U&&(c.lineStart(),c.point(A,F),R=!1)}N=A,j=F,y=U}return L}}const Ta=e=>e;var xa=new at,za=new at,vr,yr,qa,La,Ge={point:De,lineStart:De,lineEnd:De,polygonStart:function(){Ge.lineStart=Cs,Ge.lineEnd=Ts},polygonEnd:function(){Ge.lineStart=Ge.lineEnd=Ge.point=De,xa.add(me(za)),za=new at},result:function(){var e=xa/2;return xa=new at,e}};function Cs(){Ge.point=As}function As(e,a){Ge.point=wr,vr=qa=e,yr=La=a}function wr(e,a){za.add(La*e-qa*a),qa=e,La=a}function Ts(){wr(vr,yr)}var ut=1/0,Kt=ut,St=-ut,Qt=St,Jt={point:zs,lineStart:De,lineEnd:De,polygonStart:De,polygonEnd:De,result:function(){var e=[[ut,Kt],[St,Qt]];return St=Qt=-(Kt=ut=1/0),e}};function zs(e,a){e<ut&&(ut=e),e>St&&(St=e),a<Kt&&(Kt=a),a>Qt&&(Qt=a)}var Ra=0,Ma=0,bt=0,Xt=0,Zt=0,lt=0,Oa=0,Fa=0,vt=0,kr,jr,Be,_e,Oe={point:nt,lineStart:Rn,lineEnd:Mn,polygonStart:function(){Oe.lineStart=Rs,Oe.lineEnd=Ms},polygonEnd:function(){Oe.point=nt,Oe.lineStart=Rn,Oe.lineEnd=Mn},result:function(){var e=vt?[Oa/vt,Fa/vt]:lt?[Xt/lt,Zt/lt]:bt?[Ra/bt,Ma/bt]:[NaN,NaN];return Ra=Ma=bt=Xt=Zt=lt=Oa=Fa=vt=0,e}};function nt(e,a){Ra+=e,Ma+=a,++bt}function Rn(){Oe.point=qs}function qs(e,a){Oe.point=Ls,nt(Be=e,_e=a)}function Ls(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Xt+=i*(Be+e)/2,Zt+=i*(_e+a)/2,lt+=i,nt(Be=e,_e=a)}function Mn(){Oe.point=nt}function Rs(){Oe.point=Os}function Ms(){Nr(kr,jr)}function Os(e,a){Oe.point=Nr,nt(kr=Be=e,jr=_e=a)}function Nr(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Xt+=i*(Be+e)/2,Zt+=i*(_e+a)/2,lt+=i,i=_e*e-Be*a,Oa+=i*(Be+e),Fa+=i*(_e+a),vt+=i*3,nt(Be=e,_e=a)}function Sr(e){this._context=e}Sr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Pe);break}}},result:De};var Da=new at,ha,Er,Cr,yt,wt,Et={point:De,lineStart:function(){Et.point=Fs},lineEnd:function(){ha&&Ar(Er,Cr),Et.point=De},polygonStart:function(){ha=!0},polygonEnd:function(){ha=null},result:function(){var e=+Da;return Da=new at,e}};function Fs(e,a){Et.point=Ar,Er=yt=e,Cr=wt=a}function Ar(e,a){yt-=e,wt-=a,Da.add(ot(yt*yt+wt*wt)),yt=e,wt=a}let On,ea,Fn,Dn;class Pn{constructor(a){this._append=a==null?Tr:Ds(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Fn||this._append!==ea){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Fn=n,ea=this._append,Dn=this._,this._=i}this._+=Dn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Tr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ds(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Tr;if(a!==On){const r=10**a;On=a,ea=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ea}function Ps(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),st(s,i(o))),o.result()}return l.area=function(s){return st(s,i(Ge)),Ge.result()},l.measure=function(s){return st(s,i(Et)),Et.result()},l.bounds=function(s){return st(s,i(Jt)),Jt.result()},l.centroid=function(s){return st(s,i(Oe)),Oe.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,Ta):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new Pn(r)):new Sr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const d=Math.floor(s);if(!(d>=0))throw new RangeError(`invalid digits: ${s}`);r=d}return a===null&&(o=new Pn(r)),l},l.projection(e).digits(r).context(a)}function Ga(e){return function(a){var r=new Pa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Pa(){}Pa.prototype={constructor:Pa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ka(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),st(r,e.stream(Jt)),a(Jt.result()),n!=null&&e.clipExtent(n),e}function zr(e,a,r){return Ka(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,d])},r)}function Is(e,a,r){return zr(e,[[0,0],a],r)}function $s(e,a,r){return Ka(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Bs(e,a,r){return Ka(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var In=16,_s=be(30*ze);function $n(e,a){return+a?Vs(e,a):Us(e)}function Us(e){return Ga({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Vs(e,a){function r(n,i,o,l,s,d,x,c,m,u,b,p,g,v){var h=x-n,N=c-i,j=h*h+N*N;if(j>4*a&&g--){var y=l+u,z=s+b,R=d+p,L=ot(y*y+z*z+R*R),S=Nt(R/=L),E=me(me(R)-1)<de||me(o-m)<de?(o+m)/2:jt(z,y),k=e(E,S),M=k[0],T=k[1],O=M-n,C=T-i,A=N*O-h*C;(A*A/j>a||me((h*O+N*C)/j-.5)>.3||l*u+s*b+d*p<_s)&&(r(n,i,o,l,s,d,M,T,E,y/=L,z/=L,R,g,v),v.point(M,T),r(M,T,E,y,z,R,x,c,m,u,b,p,g,v))}}return function(n){var i,o,l,s,d,x,c,m,u,b,p,g,v={point:h,lineStart:N,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=z},polygonEnd:function(){n.polygonEnd(),v.lineStart=N}};function h(S,E){S=e(S,E),n.point(S[0],S[1])}function N(){m=NaN,v.point=j,n.lineStart()}function j(S,E){var k=pt([S,E]),M=e(S,E);r(m,u,c,b,p,g,m=M[0],u=M[1],c=S,b=k[0],p=k[1],g=k[2],In,n),n.point(m,u)}function y(){v.point=h,n.lineEnd()}function z(){N(),v.point=R,v.lineEnd=L}function R(S,E){j(i=S,E),o=m,l=u,s=b,d=p,x=g,v.point=j}function L(){r(m,u,c,b,p,g,o,l,i,s,d,x,In,n),v.lineEnd=y,y()}return v}}var Hs=Ga({point:function(e,a){this.stream.point(e*ze,a*ze)}});function Ws(e){return Ga({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ys(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function Bn(e,a,r,n,i,o){if(!o)return Ys(e,a,r,n,i);var l=be(o),s=ve(o),d=l*e,x=s*e,c=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function p(g,v){return g*=n,v*=i,[d*g-x*v+a,r-x*g-d*v]}return p.invert=function(g,v){return[n*(c*g-m*v+u),i*(b-m*g-c*v)]},p}function Gs(e){return Ks(function(){return e})()}function Ks(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,d=0,x=0,c,m=0,u=1,b=1,p=null,g=Ln,v=null,h,N,j,y=Ta,z=.5,R,L,S,E,k;function M(A){return S(A[0]*ze,A[1]*ze)}function T(A){return A=S.invert(A[0],A[1]),A&&[A[0]*We,A[1]*We]}M.stream=function(A){return E&&k===A?E:E=Hs(Ws(c)(g(R(y(k=A)))))},M.preclip=function(A){return arguments.length?(g=A,p=void 0,C()):g},M.postclip=function(A){return arguments.length?(y=A,v=h=N=j=null,C()):y},M.clipAngle=function(A){return arguments.length?(g=+A?Ns(p=A*ze):(p=null,Ln),C()):p*We},M.clipExtent=function(A){return arguments.length?(y=A==null?(v=h=N=j=null,Ta):Es(v=+A[0][0],h=+A[0][1],N=+A[1][0],j=+A[1][1]),C()):v==null?null:[[v,h],[N,j]]},M.scale=function(A){return arguments.length?(r=+A,O()):r},M.translate=function(A){return arguments.length?(n=+A[0],i=+A[1],O()):[n,i]},M.center=function(A){return arguments.length?(o=A[0]%360*ze,l=A[1]%360*ze,O()):[o*We,l*We]},M.rotate=function(A){return arguments.length?(s=A[0]%360*ze,d=A[1]%360*ze,x=A.length>2?A[2]%360*ze:0,O()):[s*We,d*We,x*We]},M.angle=function(A){return arguments.length?(m=A%360*ze,O()):m*We},M.reflectX=function(A){return arguments.length?(u=A?-1:1,O()):u<0},M.reflectY=function(A){return arguments.length?(b=A?-1:1,O()):b<0},M.precision=function(A){return arguments.length?(R=$n(L,z=A*A),C()):ot(z)},M.fitExtent=function(A,F){return zr(M,A,F)},M.fitSize=function(A,F){return Is(M,A,F)},M.fitWidth=function(A,F){return $s(M,A,F)},M.fitHeight=function(A,F){return Bs(M,A,F)};function O(){var A=Bn(r,0,0,u,b,m).apply(null,a(o,l)),F=Bn(r,n-A[0],i-A[1],u,b,m);return c=hs(s,d,x),L=Ca(a,F),S=Ca(c,L),R=$n(L,z),C()}function C(){return E=k=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&T,O()}}function qr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}qr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(me(i)>de&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function Qs(){return Gs(qr).scale(175.295)}function Js(e){return e}function Xs(e){if(e==null)return Js;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,d){d||(a=r=0);var x=2,c=s.length,m=new Array(c);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;x<c;)m[x]=s[x],++x;return m}}function Zs(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function el(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return _n(e,r)})}:_n(e,a)}function _n(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=tl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function tl(e,a){var r=Xs(e.transform),n=e.arcs;function i(c,m){m.length&&m.pop();for(var u=n[c<0?~c:c],b=0,p=u.length;b<p;++b)m.push(r(u[b],b));c<0&&Zs(m,p)}function o(c){return r(c)}function l(c){for(var m=[],u=0,b=c.length;u<b;++u)i(c[u],m);return m.length<2&&m.push(m[0]),m}function s(c){for(var m=l(c);m.length<4;)m.push(m[0]);return m}function d(c){return c.map(s)}function x(c){var m=c.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:c.geometries.map(x)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=d(c.arcs);break;case"MultiPolygon":u=c.arcs.map(d);break;default:return null}return{type:m,coordinates:u}}return x(a)}const Lr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},al=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function nl(e,a,r){const n=Lr[e];if(!n||!n.length)return-1;const i=al(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Bt=null;function rl(){return Bt||(Bt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=el(r,n),o=Qs().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Ps(o),s=(i.features||[]).filter(c=>{var m;return(((m=c.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(c=>{var b;const m=((b=c.properties)==null?void 0:b.name)||"",u=l(c)||"";return u?{i2:Co(m)||null,n:m,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const d={};for(const[c,m]of Object.entries(Ao)){const u=o(m);u&&(d[c]={x:u[0],y:u[1]})}const x={};for(const[c,m]of Object.entries(Lr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(x[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:d,metros:x}}catch{return null}})(),Bt)}function ol(e){const[a,r]=f.useState(null);return f.useEffect(()=>{if(!e||a)return;let n=!1;return rl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const il={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Un=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Vn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function sl(e,a){const[r,n]=f.useState(1);return f.useEffect(()=>{let i=!0,o=0;const l=()=>{var x;if(!i)return;const d=(x=e.current)==null?void 0:x.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Hn({msgs:e}){const[a,r]=f.useState(0);f.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function ll(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:d,data:x,dossiers:c}=B(),m=x.loading&&!c.length,u=f.useRef(null),b=f.useRef(null),p=ol(e.continent==="monde"),g=e.continent==="monde"?p:_a.find(C=>C.key===e.continent)||null,v=sl(u,e.continent+":"+e.mapFolded+":"+!!g),[h,N]=f.useState(new Map),[j,y]=f.useState(null);f.useEffect(()=>{const C=u.current;if(!C)return;const A=new Map;C.querySelectorAll("path[data-i2]").forEach(F=>{const U=F.dataset.i2;if(U)try{const G=F.getBBox();G.width>0&&A.set(U,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),N(A)},[e.continent,v,g]);const z=f.useMemo(()=>r.filter(C=>C.cc),[r]),R=f.useMemo(()=>{const C=new Map;return z.forEach(A=>C.set(A.cc,(C.get(A.cc)||0)+1)),C},[z]),L=e.continent==="monde"&&p?p.anchors:null,S=e.continent==="monde"&&p?p.metros:null,E=f.useMemo(()=>z.map(C=>{const A=Vn(C.name||C.id||""),F=Vn((C.id||C.name||"")+"·y");if(L&&C.cc){const K=S?S[C.cc]:void 0;if(K&&K.length){const te=nl(C.cc,C.city,A);if(te>=0&&K[te])return{d:C,x:K[te].x+(A-.5)*5,y:K[te].y+(F-.5)*5}}const Q=L[C.cc];if(Q)return{d:C,x:Q.x+(A-.5)*10,y:Q.y+(F-.5)*10}}const U=C.cc?h.get(C.cc):void 0;if(!U)return null;const G=il[`${e.continent}:${C.cc||""}`];if(G)return{d:C,x:U.x+U.w*(G.fx+(A-.5)*G.sx),y:U.y+U.h*(G.fy+(F-.5)*G.sy)};const W=(A-.5)*Math.min(U.w*.55,60),V=(F-.5)*Math.min(U.h*.55,60);return{d:C,x:U.x+U.w/2+W,y:U.y+U.h/2+V}}).filter(C=>!!C),[z,h,L,S,e.continent]),k=C=>v>0?C/v:C,M=f.useMemo(()=>n?[0,1,2,3,4,5].map(C=>({c:Un[C],fr:d.plabels[C].toUpperCase(),en:d.plabels[C].toUpperCase(),n:r.filter(A=>A.kind==="target"&&ke(A)===C).length})).filter(C=>C.n>0):sn.map((C,A)=>({...C,n:r.filter(F=>ln(F)===A).length})),[r,n,d.plabels]),T=o?l.get(o):null,O=T?E.find(C=>C.d.id===T.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[m&&t.jsx(Hn,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((C,A)=>t.jsx("g",{className:"ct"+(C.i2&&R.get(C.i2)?"":" empty"),children:t.jsx("path",{d:C.d,"data-i2":C.i2||void 0})},A))}),t.jsx("g",{children:E.map(C=>{const A=sn[ln(C.d)],F=!!je(C.d),U=C.d.kind==="target",G=n&&U?Un[ke(C.d)]:A.c,W=!n&&qe(C.d);return t.jsxs("g",{className:"co"+(W?" done":""),onMouseEnter:()=>{var Q,te;const V=(Q=b.current)==null?void 0:Q.getBoundingClientRect(),K=(te=u.current)==null?void 0:te.createSVGPoint();if(K&&u.current&&V){K.x=C.x,K.y=C.y;const ee=K.matrixTransform(u.current.getScreenCTM());y({x:ee.x-V.left,y:ee.y-V.top,label:C.d.name+" · "+(ft(C.d.cc,s)||C.d.countryLabel||"")})}i(C.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var Q;const V=(Q=u.current)==null?void 0:Q.createSVGPoint();let K=null;if(V&&u.current){V.x=C.x,V.y=C.y;const te=V.matrixTransform(u.current.getScreenCTM());K={x:te.x,y:te.y}}a({type:"popup",id:C.d.id,anchor:K})},children:[t.jsx("circle",{className:"h",cx:C.x,cy:C.y,r:k(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:C.x,cy:C.y,r:k(A.px),fill:G,stroke:F?"#DC2626":"#ffffff",strokeWidth:k(F?2.2:1.3)})]},C.d.id||C.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:k(13),fill:"none",stroke:"#0F172A",strokeWidth:k(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:M.map((C,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":C.c}}),s==="fr"?C.fr:C.en," ",t.jsx("b",{children:C.n})]},A))}),r.some(C=>!C.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(C=>!C.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:t.jsx(Hn,{msgs:d.loadMsgs})})}function cl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Rr({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:s}=B(),d=a.filters,[x,c]=f.useState(!1),m=f.useRef(null),u=f.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),b=S=>u.filter(E=>S!=="country"&&d.country.length&&!d.country.includes(E.cc||"")?!1:Va(E,d,o,S==="country"?void 0:S)),p=f.useMemo(()=>{const S=b("win"),E=k=>S.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=k).length;return[E(0),E(7),E(30),S.length]},[u,d,o]),g=f.useMemo(()=>d.day?b("win").filter(S=>(S.date||"").slice(0,10)===d.day).length:0,[u,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,h=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);f.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),f.useEffect(()=>{if(!x)return;const S=k=>{var M;(M=m.current)!=null&&M.contains(k.target)||c(!1)},E=k=>{k.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",S),document.addEventListener("keydown",E),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",E)}},[x]);const N=(S,E,k,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:E}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:"▾"})]},S),j=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(cl(d.day,s))}),t.jsx("b",{children:g})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((S,E)=>t.jsxs("button",{type:"button","aria-pressed":d.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:i.dates[E]}),t.jsx("b",{children:p[E]})]},S))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),z=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,d.sector.length),N("pay",i.fCountry,d.country.length),N("det",i.fEngine,d.engine.length),N("sta",i.fStage,d.stage.length),o&&N("ang","Angle",d.angle.length),o&&N("mem","Mémo",d.memoLevel.length)]}),R=t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn})]}),L=t.jsxs("div",{className:"fmenu",ref:m,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{c(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:z})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip",children:[t.jsx("div",{className:"fstrip-a",children:j}),t.jsxs("div",{className:"fstrip-b",children:[y,L,R]})]}),a.openFacet&&t.jsx(Wn,{poolFor:b})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[j,y,z,t.jsx("span",{className:"fgrow"}),R]}),a.openFacet&&t.jsx(Wn,{poolFor:b})]})}function Wn({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=B(),o=a.filters,l=a.openFacet,{title:s,cols:d,options:x}=f.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(h=>je(h)),g=new Map;p.forEach(h=>{const N=h.engine||"";g.set(N,(g.get(N)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ya([...g.keys()],i).map(h=>({v:h,label:tt(h)+" "+Ue(h,i),n:g.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:ft(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ya([...g.keys()],i).map(v=>({v,label:tt(v)+" "+Ue(v,i)+' <span style="color:var(--dim);font-size:10px">· '+To(zo(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(h=>{if(h.kind==="target"){const N=$a(h);g.set(N,(g.get(N)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:g.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Mr({mapToggle:e=!0}){const{dossiers:a,st:r,dispatch:n,pipe:i,lang:o,t:l}=B(),s=f.useMemo(()=>{const d={};return a.forEach(x=>{Va(x,r.filters,i)&&(d.monde=(d.monde||0)+1,x.continent&&(d[x.continent]=(d[x.continent]||0)+1))}),d},[a,r.filters,i]);return t.jsxs("div",{className:"conts",children:[qo.map(d=>{const x=_a.find(m=>m.key===d),c=d==="monde"?l.contWorld:o==="fr"?x.fr:x.en;return t.jsxs("button",{type:"button",className:"cbtn","aria-selected":r.continent===d,onClick:()=>n({type:"continent",key:d}),children:[c,t.jsx("span",{className:"n",children:s[d]||0})]},d)}),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!r.mapFolded}),children:r.mapFolded?l.showMap:l.hideMap})})]})}function Or(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function dl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Yn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=B();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:s.rsEvalOne})]},d.name))})]}):null}function Fr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=B(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Yn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Yn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function pl({card:e,onEvaluate:a,onAddAll:r}){var s,d,x;const{t:n}=B(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Or(e.summary_md||"").map((c,m)=>t.jsx("p",{children:c},m))})]}),t.jsx(Fr,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function ul(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ml({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=B(),s=i,[d,x]=f.useState(null),[c,m]=f.useState(null),[u,b]=f.useState(null),[p,g]=f.useState(!1);f.useEffect(()=>{let h=!0;return(async()=>{const N=await ar({email:l,cbToken:s});h&&x(N)})(),()=>{h=!1}},[l,s,n]);const v=h=>{m(h),b(null),g(!0),(async()=>{const N=await Lo(h.id);b(N),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[ul(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(pl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Gn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function fl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:d,caps:x,data:c,canWrite:m,source:u,dossiers:b,doAnalyse:p,liveMemos:g,pipe:v}=B(),h=a==="client",N=f.useMemo(()=>r||(u!=="default"?Ro():""),[r,u]),[j,y]=f.useState(""),[z,R]=f.useState(!1),[L,S]=f.useState(""),[E,k]=f.useState(!1),[M,T]=f.useState(""),[O,C]=f.useState([]),A=f.useRef(!1),[F,U]=f.useState(!1),[G,W]=f.useState(""),[V,K]=f.useState(""),[Q,te]=f.useState(!1),[ee,fe]=f.useState(0),[ge,xe]=f.useState(""),[Z,ie]=f.useState(null),[ae,H]=f.useState(null),[J,ue]=f.useState(!1),[q,$]=f.useState(null),[D,Y]=f.useState(0),ne=f.useRef(!1),X=j.trim()?Gn.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting,se=f.useMemo(()=>L.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[L]);f.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(W(P),U(!0))},[]),f.useEffect(()=>{const P=le=>{var Ne;const pe=String(((Ne=le.detail)==null?void 0:Ne.url)||"").trim();!pe||!/^https?:\/\//i.test(pe)||(W(pe),U(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),f.useEffect(()=>{if(!m&&!N){$(null);return}let P=!0;return(async()=>{const le=await ar({email:n,cbToken:N});P&&$(le.length)})(),()=>{P=!1}},[m,N,n,D]);const Ee=O.length?O:d,ce=c.credits,Le=f.useCallback(P=>{const le=P.map(pe=>(pe||"").trim()).filter(Boolean);le.length&&(S(pe=>{const Ne=pe.split(`
