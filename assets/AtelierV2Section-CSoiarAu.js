...
`;class ve extends x.Component{constructor(){super(...arguments);Da(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const mi=8;function fi(){const{t:e,lang:a,token:r,dossiers:n,caps:o,markRow:i,dispatch:l}=P(),[s,p]=x.useState(!1),[h,d]=x.useState(!1),[m,u]=x.useState(!1),b=r||"home",{names:c,verdicts:g}=x.useMemo(()=>{const w=[],A={};return n.forEach(C=>{C.kind!=="target"||!C.name||(w.push(C.name),A[C.name]=Wr(C)||"")}),{names:w,verdicts:A}},[n]),v=x.useMemo(()=>c.length?Gr(b,c,g,a):null,[b,c.length]);if(!o.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const f=h?v.added:v.added.slice(0,mi),y=v.added.length-f.length,j=w=>{const A=n.find(C=>C.name===w);A&&(i(A.id),l({type:"popup",id:A.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Kr(b,c,g,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[f.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),m&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const ea=600,Ye=62,tn="atl2:fstats";function xi(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=P(),[l,s]=x.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(tn)==="on"}catch{return!1}}),p=r.stats,h=x.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=x.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const m=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((y,j)=>Math.max(y,j.s||0),0),c=h.length?ea/h.length:0,g=Math.max(4,c-4),v=h.length>=5&&b>0,f=[[p.screened,e.funScreened(m(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[f.map(([y,j,w],A)=>t.jsxs("span",{className:"fst-t",children:[A>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(tn,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ea} ${Ye}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((y,j)=>{const w=(y.s||0)/b*(Ye-4),A=(y.m||0)/b*(Ye-4),C=j*c+(c-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:C,y:Ye-2-w,width:g,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:Ye-2-A,width:g,height:A,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ye-1.5,x2:ea,y2:Ye-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const hi=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function gi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=P(),[i,l]=x.useState(""),[s,p]=x.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),d=(Xe(e)||"").startsWith("CALL")&&ke(e)===3,m=ke(e)>=2,u=async c=>{if(i||c==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(c);const g=await o(e,c);l(""),g&&(p(!0),setTimeout(()=>p(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:hi.filter(([c])=>!(m&&c==="Retenu")).map(([c,g])=>[c,a[g]]);return t.jsxs("div",{className:"csp",onClick:c=>c.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([c,g])=>t.jsx("button",{type:"button",className:"csb"+(h===c?" on":"")+(i===c?" busy":""),disabled:!!i,onClick:()=>{u(c)},children:g},c)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(bi,{o:e})]})}function bi({o:e}){const{t:a,saveNote:r,flash:n}=P(),[o,i]=x.useState(e.ceoNote||""),[l,s]=x.useState(!1),[p,h]=x.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!d)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{m()},children:p?a.csNoteSaved:a.csNoteOk})]})}function vi({placeholder:e,onDone:a}){const{t:r}=P(),[n,o]=x.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function yi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:s}=P(),[p,h]=x.useState(!1);if(!n.pipe||!o||n.lockActions||ke(e)!==4)return null;const d=i(e),m=(d==null?void 0:d.stage)||"todo",u=async f=>{if(p||f===m)return;h(!0);const y=d;l(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const j=Math.max(Date.now(),an+=1);an=j;const w=await Qr(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});h(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},b=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,c=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&c>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(m===f?" on":""),disabled:p,onClick:()=>{u(f)},children:y},f)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(c)})]})}let an=0;const Et=8,At=360;function nn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function rn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(nn,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(nn,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function wi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=P(),[l,s]=x.useState(0),[p,h]=x.useState(null),[d,m]=x.useState([]),u=x.useRef(!1),b=x.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),c=x.useRef(!1);x.useEffect(()=>{const C=b.current;return()=>{c.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),x.useEffect(()=>{u.current||(u.current=!0,m(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const g=d[l],v=l>=d.length;x.useEffect(()=>{if(g&&(g.ptab!==void 0&&i.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&i.dens!==g.dens&&n({type:"dens",dens:g.dens}),i.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const C=g.click,z=window.setTimeout(()=>{const L=document.querySelector(C);L&&L.getAttribute("aria-selected")!=="true"&&L.click()},60);return()=>window.clearTimeout(z)}},[l,g]);const f=x.useCallback(()=>{if(!g){h(null);return}const C=document.querySelector(g.sel);if(!C){h(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),h(C.getBoundingClientRect())},[g]);x.useLayoutEffect(()=>{f();const C=[90,300,700,1300].map(L=>window.setTimeout(f,L)),z=()=>f();return window.addEventListener("scroll",z,!0),window.addEventListener("resize",z),()=>{C.forEach(L=>window.clearTimeout(L)),window.removeEventListener("scroll",z,!0),window.removeEventListener("resize",z)}},[f]);const y=x.useRef(a);if(y.current=a,x.useEffect(()=>{const C=z=>{z.key==="Escape"?(z.preventDefault(),z.stopPropagation(),y.current()):z.key==="ArrowRight"?s(L=>L+1):z.key==="ArrowLeft"&&s(L=>Math.max(0,L-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!d.length)return null;let j=null;const w=C=>()=>{c.current=!0,C()};if(v){const C=o[3]||0;C>0?j={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:w(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?j={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:w(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?j={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:w(()=>{n({type:"ptab",tab:0}),a()})}:j={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:w(()=>{n({type:"modal",modal:"crit"}),a()})}}let A={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:At};if(!v&&p){const C=p.bottom+14,L=window.innerHeight-C>190?C:Math.max(12,p.top-200);A={left:Math.min(Math.max(12,p.left+p.width/2-At/2),window.innerWidth-At-12),top:L,width:At}}return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-Et,top:p.top-Et,width:p.width+Et*2,height:p.height+Et*2}}),(v||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:A,children:[v&&j?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:j.title}),t.jsx(rn,{text:j.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:j.go,children:j.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(rn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(C=>C+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Kn(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Qn(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ki(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:l,dispatch:s}=P(),p=r?a:e,h=x.useMemo(()=>p.filter(A=>Ve(A.date)===0&&A.kind==="target"),[p]),d=x.useMemo(()=>r?a.filter(A=>ke(A)===0).slice().sort((A,C)=>(C.date||"").localeCompare(A.date||"")):[],[a,r]),m=x.useMemo(()=>h.filter(A=>r?ke(A)===0:!Ee(A)),[h,r]),u=r?d:m,b=r?a.length-d.length:h.length-m.length,c=r?a.length:h.length,g=c?Math.min(100,b/c*100):100,v=x.useMemo(()=>Kn(p),[p]),f=!!v&&Ve(v)>0,y=x.useMemo(()=>f?p.filter(A=>(A.date||"").slice(0,10)===v):[],[p,v,f]);let j;f?j=o.morningLast(y.length,d.length,Qn(v,l)):r?j=o.morningThesis(h.length,d.length):h.length?b===0?j=o.goalSourced(h.length):b>=h.length?j=o.goalCleared:j=o.goalDone(b,h.length):j=o.goalSourced(0);const w=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&d.length&&s({type:"chainStart",queue:d.map(A=>A.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:j}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:g+"%"}})}),u.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:w,children:r?o.morningEval(u.length):i.pileMode?o.goalContinue(u.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ji(){var q,O;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:s,mode:p,doSync:h,startTour:d}=P(),[m,u]=x.useState(null),[b,c]=x.useState([]),g=p==="client";x.useEffect(()=>{if(!o||!i)return;let M=!0;return(async()=>{const[U,k]=await Promise.all([Aa(i),In(o)]);M&&(U&&u(U),c(k))})(),()=>{M=!1}},[o,i]);const v=(m==null?void 0:m.per_day)??null,f=((q=m==null?void 0:m.pool_order)==null?void 0:q.length)??0,y=b.filter(M=>M.status==="running").length,j=x.useMemo(()=>s.filter(M=>M.kind==="target"&&Ee(M)).length,[s]),w=l.marketEstimate,A=typeof((O=l.stats)==null?void 0:O.screened)=="number"?l.stats.screened:j,C=w&&w>0?Math.min(100,Math.round(A/w*100)):null,z=M=>M.toLocaleString(a==="en"?"en-US":"fr-FR"),L=(i||"P").split(/\s+/).map(M=>M[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const M=Date.parse(l.generatedAt||"");if(Number.isNaN(M))return"";const U=new Date(M),k=S=>String(S).padStart(2,"0");return`${k(U.getDate())}/${k(U.getMonth()+1)} à ${k(U.getHours())}:${k(U.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:L}),t.jsx("i",{children:i})]}),t.jsx("h1",{children:e.identTitle(i||"…")}),t.jsx("span",{className:"idsp"}),E&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(E)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[C===null&&A>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:z(A)})})]}),C!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:C+"%"}})}),t.jsxs("b",{children:[C," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(A,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(f)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:M=>{M.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!g,onClick:h,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:M=>n({type:"filters",patch:{search:M.target.value}})})]})]})]})}function Ni(){const{t:e,counts:a,dispatch:r}=P();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,o],i)=>{const l=i===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:i+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:o}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},i)})})]})}const Si=["--p0","--p1","--p2","--p3","--p4"];function Ci(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:l}=P(),s=i.loading&&!l.length,p=x.useRef({});x.useEffect(()=>{p.current={...r}},[r]);const h=u=>{const b=p.current[u],c=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Si[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[u],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},u)},d=(u,b,c)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,c,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:c,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(h)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,o,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Ei=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ai(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=P(),s=x.useRef(null),[p,h]=x.useState(60);x.useEffect(()=>{let b=0;const c=()=>{var j;const g=s.current;if(!g)return;const v=(j=g.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!v)return;const f=v.getBoundingClientRect(),y=g.getBoundingClientRect();h(Math.max(20,Math.min(f.left+f.width/2-y.left,y.width-30)))};return b=requestAnimationFrame(c),window.addEventListener("resize",c),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",c)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const b=n.filter(v=>v.kind==="target"&&ke(v)===3),c=b.filter(v=>ia(v)==="auto").length,g=b.filter(v=>ia(v)==="cd").length;m=r.tutoPending(c,g,b.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(b=>b.id)})};if(d===1){const b=n.filter(c=>c.kind==="target"&&ke(c)===1&&!o.has(c.id)).slice(0,10);if(b.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:b.map(c=>c.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Ei[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Ke{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,s=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*zi(e){for(const a of e)yield*a}function Jn(e){return Array.from(zi(e))}var ne=1e-6,Q=Math.PI,Re=Q/2,on=Q/4,qe=Q*2,Be=180/Q,Ce=Q/180,ie=Math.abs,Ti=Math.atan,vt=Math.atan2,de=Math.cos,ce=Math.sin,Li=Math.sign||function(e){return e>0?1:e<0?-1:0},Ze=Math.sqrt;function Ri(e){return e>1?0:e<-1?Q:Math.acos(e)}function yt(e){return e>1?Re:e<-1?-Re:Math.asin(e)}function Me(){}function Ft(e,a){e&&ln.hasOwnProperty(e.type)&&ln[e.type](e,a)}var sn={Feature:function(e,a){Ft(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ft(r[n].geometry,a)}},ln={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ca(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ca(r[n],a,0)},Polygon:function(e,a){dn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)dn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ft(r[n],a)}};function ca(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function dn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ca(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&sn.hasOwnProperty(e.type)?sn[e.type](e,a):Ft(e,a)}function pa(e){return[vt(e[1],e[0]),yt(e[2])]}function it(e){var a=e[0],r=e[1],n=de(r);return[n*de(a),n*ce(a),ce(r)]}function zt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Pt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ta(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Tt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ua(e){var a=Ze(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ma(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function fa(e,a){return ie(e)>Q&&(e-=Math.round(e/qe)*qe),[e,a]}fa.invert=fa;function Mi(e,a,r){return(e%=qe)?a||r?ma(pn(e),un(a,r)):pn(e):a||r?un(a,r):fa}function cn(e){return function(a,r){return a+=e,ie(a)>Q&&(a-=Math.round(a/qe)*qe),[a,r]}}function pn(e){var a=cn(e);return a.invert=cn(-e),a}function un(e,a){var r=de(e),n=ce(e),o=de(a),i=ce(a);function l(s,p){var h=de(p),d=de(s)*h,m=ce(s)*h,u=ce(p),b=u*r+d*n;return[vt(m*o-b*i,d*r-u*n),yt(b*o+m*i)]}return l.invert=function(s,p){var h=de(p),d=de(s)*h,m=ce(s)*h,u=ce(p),b=u*o-m*i;return[vt(m*o+u*i,d*r+b*n),yt(b*r-d*n)]},l}function qi(e,a,r,n,o,i){if(r){var l=de(a),s=ce(a),p=n*r;o==null?(o=a+n*qe,i=a-p/2):(o=mn(l,o),i=mn(l,i),(n>0?o<i:o>i)&&(o+=n*qe));for(var h,d=o;n>0?d>i:d<i;d-=p)h=pa([l,-s*de(d),-s*ce(d)]),e.point(h[0],h[1])}}function mn(e,a){a=it(a),a[0]-=e,ua(a);var r=Ri(-a[1]);return((-a[2]<0?-r:r)+qe-ne)%qe}function Xn(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Me,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ot(e,a){return ie(e[0]-a[0])<ne&&ie(e[1]-a[1])<ne}function Lt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Zn(e,a,r,n,o){var i=[],l=[],s,p;if(e.forEach(function(c){if(!((g=c.length-1)<=0)){var g,v=c[0],f=c[g],y;if(Ot(v,f)){if(!v[2]&&!f[2]){for(o.lineStart(),s=0;s<g;++s)o.point((v=c[s])[0],v[1]);o.lineEnd();return}f[0]+=2*ne}i.push(y=new Lt(v,c,null,!0)),l.push(y.o=new Lt(v,null,y,!1)),i.push(y=new Lt(f,c,null,!1)),l.push(y.o=new Lt(f,null,y,!0))}}),!!i.length){for(l.sort(a),fn(i),fn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var h=i[0],d,m;;){for(var u=h,b=!0;u.v;)if((u=u.n)===h)return;d=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,p=d.length;s<p;++s)o.point((m=d[s])[0],m[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)o.point((m=d[s])[0],m[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);o.lineEnd()}}}function fn(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function aa(e){return ie(e[0])<=Q?e[0]:Li(e[0])*((ie(e[0])+Q)%qe-Q)}function Oi(e,a){var r=aa(a),n=a[1],o=ce(n),i=[ce(r),-de(r),0],l=0,s=0,p=new Ke;o===1?n=Re+ne:o===-1&&(n=-Re-ne);for(var h=0,d=e.length;h<d;++h)if(u=(m=e[h]).length)for(var m,u,b=m[u-1],c=aa(b),g=b[1]/2+on,v=ce(g),f=de(g),y=0;y<u;++y,c=w,v=C,f=z,b=j){var j=m[y],w=aa(j),A=j[1]/2+on,C=ce(A),z=de(A),L=w-c,E=L>=0?1:-1,q=E*L,O=q>Q,M=v*C;if(p.add(vt(M*E*ce(q),f*z+M*de(q))),l+=O?L+E*qe:L,O^c>=r^w>=r){var U=Pt(it(b),it(j));ua(U);var k=Pt(i,U);ua(k);var S=(O^L>=0?-1:1)*yt(k[2]);(n>S||n===S&&(U[0]||U[1]))&&(s+=O^L>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function er(e,a,r,n){return function(o){var i=a(o),l=Xn(),s=a(l),p=!1,h,d,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=j,d=[],h=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,d=Jn(d);var w=Oi(h,n);d.length?(p||(o.polygonStart(),p=!0),Zn(d,Pi,w,r,o)):w&&(p||(o.polygonStart(),p=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),p&&(o.polygonEnd(),p=!1),d=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(w,A){e(w,A)&&o.point(w,A)}function c(w,A){i.point(w,A)}function g(){u.point=c,i.lineStart()}function v(){u.point=b,i.lineEnd()}function f(w,A){m.push([w,A]),s.point(w,A)}function y(){s.lineStart(),m=[]}function j(){f(m[0][0],m[0][1]),s.lineEnd();var w=s.clean(),A=l.result(),C,z=A.length,L,E,q;if(m.pop(),h.push(m),m=null,!!z){if(w&1){if(E=A[0],(L=E.length-1)>0){for(p||(o.polygonStart(),p=!0),o.lineStart(),C=0;C<L;++C)o.point((q=E[C])[0],q[1]);o.lineEnd()}return}z>1&&w&2&&A.push(A.pop().concat(A.shift())),d.push(A.filter(Fi))}}return u}}function Fi(e){return e.length>1}function Pi(e,a){return((e=e.x)[0]<0?e[1]-Re-ne:Re-e[1])-((a=a.x)[0]<0?a[1]-Re-ne:Re-a[1])}const xn=er(function(){return!0},Di,$i,[-Q,-Re]);function Di(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var s=i>0?Q:-Q,p=ie(i-a);ie(p-Q)<ne?(e.point(a,r=(r+l)/2>0?Re:-Re),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&p>=Q&&(ie(a-n)<ne&&(a-=n*ne),ie(i-s)<ne&&(i-=s*ne),r=Ii(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Ii(e,a,r,n){var o,i,l=ce(e-r);return ie(l)>ne?Ti((ce(a)*(i=de(n))*ce(r)-ce(n)*(o=de(a))*ce(e))/(o*i*l)):(a+n)/2}function $i(e,a,r,n){var o;if(e==null)o=r*Re,n.point(-Q,o),n.point(0,o),n.point(Q,o),n.point(Q,0),n.point(Q,-o),n.point(0,-o),n.point(-Q,-o),n.point(-Q,0),n.point(-Q,o);else if(ie(e[0]-a[0])>ne){var i=e[0]<a[0]?Q:-Q;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Bi(e){var a=de(e),r=2*Ce,n=a>0,o=ie(a)>ne;function i(d,m,u,b){qi(b,e,r,u,d,m)}function l(d,m){return de(d)*de(m)>a}function s(d){var m,u,b,c,g;return{lineStart:function(){c=b=!1,g=1},point:function(v,f){var y=[v,f],j,w=l(v,f),A=n?w?0:h(v,f):w?h(v+(v<0?Q:-Q),f):0;if(!m&&(c=b=w)&&d.lineStart(),w!==b&&(j=p(m,y),(!j||Ot(m,j)||Ot(y,j))&&(y[2]=1)),w!==b)g=0,w?(d.lineStart(),j=p(y,m),d.point(j[0],j[1])):(j=p(m,y),d.point(j[0],j[1],2),d.lineEnd()),m=j;else if(o&&m&&n^w){var C;!(A&u)&&(C=p(y,m,!0))&&(g=0,n?(d.lineStart(),d.point(C[0][0],C[0][1]),d.point(C[1][0],C[1][1]),d.lineEnd()):(d.point(C[1][0],C[1][1]),d.lineEnd(),d.lineStart(),d.point(C[0][0],C[0][1],3)))}w&&(!m||!Ot(m,y))&&d.point(y[0],y[1]),m=y,b=w,u=A},lineEnd:function(){b&&d.lineEnd(),m=null},clean:function(){return g|(c&&b)<<1}}}function p(d,m,u){var b=it(d),c=it(m),g=[1,0,0],v=Pt(b,c),f=zt(v,v),y=v[0],j=f-y*y;if(!j)return!u&&d;var w=a*f/j,A=-a*y/j,C=Pt(g,v),z=Tt(g,w),L=Tt(v,A);ta(z,L);var E=C,q=zt(z,E),O=zt(E,E),M=q*q-O*(zt(z,z)-1);if(!(M<0)){var U=Ze(M),k=Tt(E,(-q-U)/O);if(ta(k,z),k=pa(k),!u)return k;var S=d[0],R=m[0],H=d[1],G=m[1],X;R<S&&(X=S,S=R,R=X);var T=R-S,F=ie(T-Q)<ne,B=F||T<ne;if(!F&&G<H&&(X=H,H=G,G=X),B?F?H+G>0^k[1]<(ie(k[0]-S)<ne?H:G):H<=k[1]&&k[1]<=G:T>Q^(S<=k[0]&&k[0]<=R)){var D=Tt(E,(-q+U)/O);return ta(D,z),[k,pa(D)]}}}function h(d,m){var u=n?e:Q-e,b=0;return d<-u?b|=1:d>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return er(l,s,i,n?[0,-e]:[-Q,e-Q])}function Ui(e,a,r,n,o,i){var l=e[0],s=e[1],p=a[0],h=a[1],d=0,m=1,u=p-l,b=h-s,c;if(c=r-l,!(!u&&c>0)){if(c/=u,u<0){if(c<d)return;c<m&&(m=c)}else if(u>0){if(c>m)return;c>d&&(d=c)}if(c=o-l,!(!u&&c<0)){if(c/=u,u<0){if(c>m)return;c>d&&(d=c)}else if(u>0){if(c<d)return;c<m&&(m=c)}if(c=n-s,!(!b&&c>0)){if(c/=b,b<0){if(c<d)return;c<m&&(m=c)}else if(b>0){if(c>m)return;c>d&&(d=c)}if(c=i-s,!(!b&&c<0)){if(c/=b,b<0){if(c>m)return;c>d&&(d=c)}else if(b>0){if(c<d)return;c<m&&(m=c)}return d>0&&(e[0]=l+d*u,e[1]=s+d*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var mt=1e9,Rt=-mt;function _i(e,a,r,n){function o(h,d){return e<=h&&h<=r&&a<=d&&d<=n}function i(h,d,m,u){var b=0,c=0;if(h==null||(b=l(h,m))!==(c=l(d,m))||p(h,d)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==c);else u.point(d[0],d[1])}function l(h,d){return ie(h[0]-e)<ne?d>0?0:3:ie(h[0]-r)<ne?d>0?2:1:ie(h[1]-a)<ne?d>0?1:0:d>0?3:2}function s(h,d){return p(h.x,d.x)}function p(h,d){var m=l(h,1),u=l(d,1);return m!==u?m-u:m===0?d[1]-h[1]:m===1?h[0]-d[0]:m===2?h[1]-d[1]:d[0]-h[0]}return function(h){var d=h,m=Xn(),u,b,c,g,v,f,y,j,w,A,C,z={point:L,lineStart:M,lineEnd:U,polygonStart:q,polygonEnd:O};function L(S,R){o(S,R)&&d.point(S,R)}function E(){for(var S=0,R=0,H=b.length;R<H;++R)for(var G=b[R],X=1,T=G.length,F=G[0],B,D,I=F[0],_=F[1];X<T;++X)B=I,D=_,F=G[X],I=F[0],_=F[1],D<=n?_>n&&(I-B)*(n-D)>(_-D)*(e-B)&&++S:_<=n&&(I-B)*(n-D)<(_-D)*(e-B)&&--S;return S}function q(){d=m,u=[],b=[],C=!0}function O(){var S=E(),R=C&&S,H=(u=Jn(u)).length;(R||H)&&(h.polygonStart(),R&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),H&&Zn(u,s,S,i,h),h.polygonEnd()),d=h,u=b=c=null}function M(){z.point=k,b&&b.push(c=[]),A=!0,w=!1,y=j=NaN}function U(){u&&(k(g,v),f&&w&&m.rejoin(),u.push(m.result())),z.point=L,w&&d.lineEnd()}function k(S,R){var H=o(S,R);if(b&&c.push([S,R]),A)g=S,v=R,f=H,A=!1,H&&(d.lineStart(),d.point(S,R));else if(H&&w)d.point(S,R);else{var G=[y=Math.max(Rt,Math.min(mt,y)),j=Math.max(Rt,Math.min(mt,j))],X=[S=Math.max(Rt,Math.min(mt,S)),R=Math.max(Rt,Math.min(mt,R))];Ui(G,X,e,a,r,n)?(w||(d.lineStart(),d.point(G[0],G[1])),d.point(X[0],X[1]),H||d.lineEnd(),C=!1):H&&(d.lineStart(),d.point(S,R),C=!1)}y=S,j=R,w=H}return z}}const xa=e=>e;var na=new Ke,ha=new Ke,tr,ar,ga,ba,Ue={point:Me,lineStart:Me,lineEnd:Me,polygonStart:function(){Ue.lineStart=Vi,Ue.lineEnd=Yi},polygonEnd:function(){Ue.lineStart=Ue.lineEnd=Ue.point=Me,na.add(ie(ha)),ha=new Ke},result:function(){var e=na/2;return na=new Ke,e}};function Vi(){Ue.point=Hi}function Hi(e,a){Ue.point=nr,tr=ga=e,ar=ba=a}function nr(e,a){ha.add(ba*e-ga*a),ga=e,ba=a}function Yi(){nr(tr,ar)}var st=1/0,Dt=st,wt=-st,It=wt,$t={point:Wi,lineStart:Me,lineEnd:Me,polygonStart:Me,polygonEnd:Me,result:function(){var e=[[st,Dt],[wt,It]];return wt=It=-(Dt=st=1/0),e}};function Wi(e,a){e<st&&(st=e),e>wt&&(wt=e),a<Dt&&(Dt=a),a>It&&(It=a)}var va=0,ya=0,ft=0,Bt=0,Ut=0,rt=0,wa=0,ka=0,xt=0,rr,or,De,Ie,Le={point:Qe,lineStart:hn,lineEnd:gn,polygonStart:function(){Le.lineStart=Qi,Le.lineEnd=Ji},polygonEnd:function(){Le.point=Qe,Le.lineStart=hn,Le.lineEnd=gn},result:function(){var e=xt?[wa/xt,ka/xt]:rt?[Bt/rt,Ut/rt]:ft?[va/ft,ya/ft]:[NaN,NaN];return va=ya=ft=Bt=Ut=rt=wa=ka=xt=0,e}};function Qe(e,a){va+=e,ya+=a,++ft}function hn(){Le.point=Gi}function Gi(e,a){Le.point=Ki,Qe(De=e,Ie=a)}function Ki(e,a){var r=e-De,n=a-Ie,o=Ze(r*r+n*n);Bt+=o*(De+e)/2,Ut+=o*(Ie+a)/2,rt+=o,Qe(De=e,Ie=a)}function gn(){Le.point=Qe}function Qi(){Le.point=Xi}function Ji(){ir(rr,or)}function Xi(e,a){Le.point=ir,Qe(rr=De=e,or=Ie=a)}function ir(e,a){var r=e-De,n=a-Ie,o=Ze(r*r+n*n);Bt+=o*(De+e)/2,Ut+=o*(Ie+a)/2,rt+=o,o=Ie*e-De*a,wa+=o*(De+e),ka+=o*(Ie+a),xt+=o*3,Qe(De=e,Ie=a)}function sr(e){this._context=e}sr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,qe);break}}},result:Me};var ja=new Ke,ra,lr,dr,ht,gt,kt={point:Me,lineStart:function(){kt.point=Zi},lineEnd:function(){ra&&cr(lr,dr),kt.point=Me},polygonStart:function(){ra=!0},polygonEnd:function(){ra=null},result:function(){var e=+ja;return ja=new Ke,e}};function Zi(e,a){kt.point=cr,lr=ht=e,dr=gt=a}function cr(e,a){ht-=e,gt-=a,ja.add(Ze(ht*ht+gt*gt)),ht=e,gt=a}let bn,_t,vn,yn;class wn{constructor(a){this._append=a==null?pr:es(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==vn||this._append!==_t){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,vn=n,_t=this._append,yn=this._,this._=o}this._+=yn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function pr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function es(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return pr;if(a!==bn){const r=10**a;bn=a,_t=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return _t}function ts(e,a){let r=3,n=4.5,o,i;function l(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),nt(s,o(i))),i.result()}return l.area=function(s){return nt(s,o(Ue)),Ue.result()},l.measure=function(s){return nt(s,o(kt)),kt.result()},l.bounds=function(s){return nt(s,o($t)),$t.result()},l.centroid=function(s){return nt(s,o(Le)),Le.result()},l.projection=function(s){return arguments.length?(o=s==null?(e=null,xa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(i=s==null?(a=null,new wn(r)):new sr(a=s),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(i=new wn(r)),l},l.projection(e).digits(r).context(a)}function Ra(e){return function(a){var r=new Na;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Na(){}Na.prototype={constructor:Na,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ma(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream($t)),a($t.result()),n!=null&&e.clipExtent(n),e}function ur(e,a,r){return Ma(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function as(e,a,r){return ur(e,[[0,0],a],r)}function ns(e,a,r){return Ma(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([l,s])},r)}function rs(e,a,r){return Ma(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,s])},r)}var kn=16,os=de(30*Ce);function jn(e,a){return+a?ss(e,a):is(e)}function is(e){return Ra({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ss(e,a){function r(n,o,i,l,s,p,h,d,m,u,b,c,g,v){var f=h-n,y=d-o,j=f*f+y*y;if(j>4*a&&g--){var w=l+u,A=s+b,C=p+c,z=Ze(w*w+A*A+C*C),L=yt(C/=z),E=ie(ie(C)-1)<ne||ie(i-m)<ne?(i+m)/2:vt(A,w),q=e(E,L),O=q[0],M=q[1],U=O-n,k=M-o,S=y*U-f*k;(S*S/j>a||ie((f*U+y*k)/j-.5)>.3||l*u+s*b+p*c<os)&&(r(n,o,i,l,s,p,O,M,E,w/=z,A/=z,C,g,v),v.point(O,M),r(O,M,E,w,A,C,h,d,m,u,b,c,g,v))}}return function(n){var o,i,l,s,p,h,d,m,u,b,c,g,v={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=A},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function f(L,E){L=e(L,E),n.point(L[0],L[1])}function y(){m=NaN,v.point=j,n.lineStart()}function j(L,E){var q=it([L,E]),O=e(L,E);r(m,u,d,b,c,g,m=O[0],u=O[1],d=L,b=q[0],c=q[1],g=q[2],kn,n),n.point(m,u)}function w(){v.point=f,n.lineEnd()}function A(){y(),v.point=C,v.lineEnd=z}function C(L,E){j(o=L,E),i=m,l=u,s=b,p=c,h=g,v.point=j}function z(){r(m,u,d,b,c,g,i,l,o,s,p,h,kn,n),v.lineEnd=w,w()}return v}}var ls=Ra({point:function(e,a){this.stream.point(e*Ce,a*Ce)}});function ds(e){return Ra({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function cs(e,a,r,n,o){function i(l,s){return l*=n,s*=o,[a+e*l,r-e*s]}return i.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*o]},i}function Nn(e,a,r,n,o,i){if(!i)return cs(e,a,r,n,o);var l=de(i),s=ce(i),p=l*e,h=s*e,d=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function c(g,v){return g*=n,v*=o,[p*g-h*v+a,r-h*g-p*v]}return c.invert=function(g,v){return[n*(d*g-m*v+u),o*(b-m*g-d*v)]},c}function ps(e){return us(function(){return e})()}function us(e){var a,r=150,n=480,o=250,i=0,l=0,s=0,p=0,h=0,d,m=0,u=1,b=1,c=null,g=xn,v=null,f,y,j,w=xa,A=.5,C,z,L,E,q;function O(S){return L(S[0]*Ce,S[1]*Ce)}function M(S){return S=L.invert(S[0],S[1]),S&&[S[0]*Be,S[1]*Be]}O.stream=function(S){return E&&q===S?E:E=ls(ds(d)(g(C(w(q=S)))))},O.preclip=function(S){return arguments.length?(g=S,c=void 0,k()):g},O.postclip=function(S){return arguments.length?(w=S,v=f=y=j=null,k()):w},O.clipAngle=function(S){return arguments.length?(g=+S?Bi(c=S*Ce):(c=null,xn),k()):c*Be},O.clipExtent=function(S){return arguments.length?(w=S==null?(v=f=y=j=null,xa):_i(v=+S[0][0],f=+S[0][1],y=+S[1][0],j=+S[1][1]),k()):v==null?null:[[v,f],[y,j]]},O.scale=function(S){return arguments.length?(r=+S,U()):r},O.translate=function(S){return arguments.length?(n=+S[0],o=+S[1],U()):[n,o]},O.center=function(S){return arguments.length?(i=S[0]%360*Ce,l=S[1]%360*Ce,U()):[i*Be,l*Be]},O.rotate=function(S){return arguments.length?(s=S[0]%360*Ce,p=S[1]%360*Ce,h=S.length>2?S[2]%360*Ce:0,U()):[s*Be,p*Be,h*Be]},O.angle=function(S){return arguments.length?(m=S%360*Ce,U()):m*Be},O.reflectX=function(S){return arguments.length?(u=S?-1:1,U()):u<0},O.reflectY=function(S){return arguments.length?(b=S?-1:1,U()):b<0},O.precision=function(S){return arguments.length?(C=jn(z,A=S*S),k()):Ze(A)},O.fitExtent=function(S,R){return ur(O,S,R)},O.fitSize=function(S,R){return as(O,S,R)},O.fitWidth=function(S,R){return ns(O,S,R)},O.fitHeight=function(S,R){return rs(O,S,R)};function U(){var S=Nn(r,0,0,u,b,m).apply(null,a(i,l)),R=Nn(r,n-S[0],o-S[1],u,b,m);return d=Mi(s,p,h),z=ma(a,R),L=ma(d,z),C=jn(z,A),k()}function k(){return E=q=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&M,U()}}function mr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}mr.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(ie(o)>ne&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function ms(){return ps(mr).scale(175.295)}function fs(e){return e}function xs(e){if(e==null)return fs;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var h=2,d=s.length,m=new Array(d);for(m[0]=(a+=s[0])*n+i,m[1]=(r+=s[1])*o+l;h<d;)m[h]=s[h],++h;return m}}function hs(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function gs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Sn(e,r)})}:Sn(e,a)}function Sn(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=bs(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function bs(e,a){var r=xs(e.transform),n=e.arcs;function o(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],b=0,c=u.length;b<c;++b)m.push(r(u[b],b));d<0&&hs(m,c)}function i(d){return r(d)}function l(d){for(var m=[],u=0,b=d.length;u<b;++u)o(d[u],m);return m.length<2&&m.push(m[0]),m}function s(d){for(var m=l(d);m.length<4;)m.push(m[0]);return m}function p(d){return d.map(s)}function h(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(h)};case"Point":u=i(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(i);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:m,coordinates:u}}return h(a)}const fr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},vs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ys(e,a,r){const n=fr[e];if(!n||!n.length)return-1;const o=vs(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(l=>o.includes(l)))return i}return Math.floor(r*n.length)%n.length}let Mt=null;function ws(){return Mt||(Mt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=gs(r,n),i=ms().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=ts(i),s=(o.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var b;const m=((b=d.properties)==null?void 0:b.name)||"",u=l(d)||"";return u?{i2:Jr(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,m]of Object.entries(Xr)){const u=i(m);u&&(p[d]={x:u[0],y:u[1]})}const h={};for(const[d,m]of Object.entries(fr)){const u=m.map(b=>i(b.ll)).filter(b=>!!b).map(([b,c])=>({x:b,y:c}));u.length&&(h[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:h}}catch{return null}})(),Mt)}function ks(e){const[a,r]=x.useState(null);return x.useEffect(()=>{if(!e||a)return;let n=!1;return ws().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const js={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Cn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function En(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Ns(e,a){const[r,n]=x.useState(1);return x.useEffect(()=>{let o=!0,i=0;const l=()=>{var h;if(!o)return;const p=(h=e.current)==null?void 0:h.getScreenCTM();p&&p.a>0?n(p.a):i=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Ss(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:s,t:p,data:h,dossiers:d}=P(),m=h.loading&&!d.length,u=x.useRef(null),b=x.useRef(null),c=ks(e.continent==="monde"),g=e.continent==="monde"?c:za.find(k=>k.key===e.continent)||null,v=Ns(u,e.continent+":"+e.mapFolded+":"+!!g),[f,y]=x.useState(new Map),[j,w]=x.useState(null);x.useEffect(()=>{const k=u.current;if(!k)return;const S=new Map;k.querySelectorAll("path[data-i2]").forEach(R=>{const H=R.dataset.i2;if(H)try{const G=R.getBBox();G.width>0&&S.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(S)},[e.continent,v,g]);const A=x.useMemo(()=>r.filter(k=>k.cc),[r]),C=x.useMemo(()=>{const k=new Map;return A.forEach(S=>k.set(S.cc,(k.get(S.cc)||0)+1)),k},[A]),z=e.continent==="monde"&&c?c.anchors:null,L=e.continent==="monde"&&c?c.metros:null,E=x.useMemo(()=>A.map(k=>{const S=En(k.name||k.id||""),R=En((k.id||k.name||"")+"·y");if(z&&k.cc){const F=L?L[k.cc]:void 0;if(F&&F.length){const D=ys(k.cc,k.city,S);if(D>=0&&F[D])return{d:k,x:F[D].x+(S-.5)*5,y:F[D].y+(R-.5)*5}}const B=z[k.cc];if(B)return{d:k,x:B.x+(S-.5)*10,y:B.y+(R-.5)*10}}const H=k.cc?f.get(k.cc):void 0;if(!H)return null;const G=js[`${e.continent}:${k.cc||""}`];if(G)return{d:k,x:H.x+H.w*(G.fx+(S-.5)*G.sx),y:H.y+H.h*(G.fy+(R-.5)*G.sy)};const X=(S-.5)*Math.min(H.w*.55,60),T=(R-.5)*Math.min(H.h*.55,60);return{d:k,x:H.x+H.w/2+X,y:H.y+H.h/2+T}}).filter(k=>!!k),[A,f,z,L,e.continent]),q=k=>v>0?k/v:k,O=x.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:Cn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(S=>S.kind==="target"&&ke(S)===k).length})).filter(k=>k.n>0):Va.map((k,S)=>({...k,n:r.filter(R=>Ha(R)===S).length})),[r,n,p.plabels]),M=i?l.get(i):null,U=M?E.find(k=>k.d.id===M.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{w(null),o(null)},children:[t.jsx("g",{children:g.countries.map((k,S)=>t.jsx("g",{className:"ct"+(k.i2&&C.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},S))}),t.jsx("g",{children:E.map(k=>{const S=Va[Ha(k.d)],R=!!ge(k.d),H=k.d.kind==="target",G=n&&H?Cn[ke(k.d)]:S.c,X=!n&&Ee(k.d);return t.jsxs("g",{className:"co"+(X?" done":""),onMouseEnter:()=>{var B,D;const T=(B=b.current)==null?void 0:B.getBoundingClientRect(),F=(D=u.current)==null?void 0:D.createSVGPoint();if(F&&u.current&&T){F.x=k.x,F.y=k.y;const I=F.matrixTransform(u.current.getScreenCTM());w({x:I.x-T.left,y:I.y-T.top,label:k.d.name+" · "+(dt(k.d.cc,s)||k.d.countryLabel||"")})}o(k.d.id)},onMouseLeave:()=>{w(null),o(null)},onClick:()=>{var B;const T=(B=u.current)==null?void 0:B.createSVGPoint();let F=null;if(T&&u.current){T.x=k.x,T.y=k.y;const D=T.matrixTransform(u.current.getScreenCTM());F={x:D.x,y:D.y}}a({type:"popup",id:k.d.id,anchor:F})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:q(Math.max(11,S.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:q(S.px),fill:G,stroke:R?"#DC2626":"#ffffff",strokeWidth:q(R?2.2:1.3)})]},k.d.id||k.d.name)})}),U&&t.jsx("circle",{className:"ring on",cx:U.x,cy:U.y,r:q(13),fill:"none",stroke:"#0F172A",strokeWidth:q(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:O.map((k,S)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},S))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:b})}function Cs(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Es(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:o,contName:i,lang:l}=P(),s=e.filters,p=x.useMemo(()=>e.continent==="monde"?r:r.filter(c=>c.continent===e.continent),[r,e.continent]),h=c=>p.filter(g=>c!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Ta(g,s,o,c==="country"?void 0:c)),d=x.useMemo(()=>{const c=h("win"),g=v=>c.filter(f=>(f.date?Math.max(0,Math.floor((Date.now()-Date.parse(f.date))/864e5)):9999)<=v).length;return[g(0),g(7),g(30),c.length]},[p,s,o]),m=x.useMemo(()=>s.day?h("win").filter(c=>(c.date||"").slice(0,10)===s.day).length:0,[p,s,o]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),b=(c,g,v,f="fbtn")=>t.jsxs("button",{type:"button",className:f,"aria-expanded":e.openFacet===c,onClick:()=>a({type:"openFacet",facet:c}),children:[t.jsx("span",{className:"fl",children:g}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},c);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(Cs(s.day,l)),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((c,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===c,onClick:()=>a({type:"filters",patch:{win:c}}),children:[n.dates[g],t.jsx("b",{children:d[g]})]},c))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:c=>a({type:"filters",patch:{search:c.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):b("sec",n.fSector,s.sector.length),b("pay",n.fCountry,s.country.length),b("det",n.fEngine,s.engine.length),b("sta",n.fStage,s.stage.length),o&&b("ang","Angle",s.angle.length),o&&b("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,i),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(As,{poolFor:h})]})}function As({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=P(),i=a.filters,l=a.openFacet,{title:s,cols:p,options:h}=x.useMemo(()=>{if(l==="sig"){const c=e("signal").filter(f=>ge(f)),g=new Map;c.forEach(f=>{const y=f.engine||"";g.set(y,(g.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:c.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...sa([...g.keys()],o).map(f=>({v:f,label:Ge(f)+" "+$e(f,o),n:g.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const c=e("sector"),g=new Map;return c.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v,n:f,html:!1,on:i.sector.includes(v)}))}}if(l==="pay"){const c=e("country"),g=new Map;return c.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:dt(v,o)||v,n:f,html:!1,on:i.country.includes(v)}))}}if(l==="det"){const c=e("engine"),g=new Map;return c.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:sa([...g.keys()],o).map(v=>({v,label:Ge(v)+" "+$e(v,o)+' <span style="color:var(--dim);font-size:10px">· '+Zr(eo(v),o)+"</span>",n:g.get(v)||0,html:!0,on:i.engine.includes(v)}))}}if(l==="ang"){const c=e("angle"),g=new Map;return c.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(v)}))}}if(l==="mem"){const c=e("memoLevel"),g=new Map;c.forEach(f=>{if(f.kind==="target"){const y=Ea(f);g.set(y,(g.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:v[f],n:g.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const u=e("stage"),b=new Map;return u.forEach(c=>{c.stage&&b.set(c.stage,(b.get(c.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((c,g)=>g[1]-c[1]).map(([c,g])=>({v:c,label:c,n:g,html:!1,on:i.stage.includes(c)}))}},[l,a,o]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const c=i.signalEngines.includes(u)?i.signalEngines.filter(g=>g!==u):[...i.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:c}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:h.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function xr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function zs(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function An({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:s}=P();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function hr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=P(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(An,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(An,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Ts({card:e,onEvaluate:a,onAddAll:r}){var s,p,h;const{t:n}=P(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(hr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Ls(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Rs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:l}=P(),s=o,[p,h]=x.useState(null),[d,m]=x.useState(null),[u,b]=x.useState(null),[c,g]=x.useState(!1);x.useEffect(()=>{let f=!0;return(async()=>{const y=await $n({email:l,cbToken:s});f&&h(y)})(),()=>{f=!1}},[l,s,n]);const v=f=>{m(f),b(null),g(!0),(async()=>{const y=await to(f.id);b(y),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(p||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Ls(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),c&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!c&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!c&&u&&t.jsx(Ts,{card:u,onEvaluate:a,onAddAll:r})]})]})}const zn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Ms(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:s,evalCards:p,caps:h,data:d,canWrite:m,source:u}=P(),b=a==="client",c=x.useMemo(()=>r||(u!=="default"?ao():""),[r,u]),[g,v]=x.useState(""),[f,y]=x.useState(!1),[j,w]=x.useState(""),[A,C]=x.useState(!1),[z,L]=x.useState(""),[E,q]=x.useState([]),O=x.useRef(!1),[M,U]=x.useState(!1),[k,S]=x.useState(""),[R,H]=x.useState(""),[G,X]=x.useState(!1),[T,F]=x.useState(0),[B,D]=x.useState(""),[I,_]=x.useState(null),[W,J]=x.useState(null),[re,fe]=x.useState(!1),[pe,K]=x.useState(null),[ee,xe]=x.useState(0),Z=x.useRef(!1),se=g.trim()?zn.test(g.trim())?e.evalUrl:e.evalName:e.evalWaiting,te=x.useMemo(()=>j.split(`
`).map($=>$.trim()).filter(Boolean).slice(0,15),[j]);x.useEffect(()=>{if(typeof window>"u")return;const $=(new URLSearchParams(window.location.search).get("rs")||"").trim();!$||!/^https?:\/\//i.test($)||(S($),U(!0))},[]),x.useEffect(()=>{const $=ae=>{var ye;const oe=String(((ye=ae.detail)==null?void 0:ye.url)||"").trim();!oe||!/^https?:\/\//i.test(oe)||(S(oe),U(!0))};return window.addEventListener("ppmap:research",$),()=>window.removeEventListener("ppmap:research",$)},[]),x.useEffect(()=>{if(!m&&!c){K(null);return}let $=!0;return(async()=>{const ae=await $n({email:n,cbToken:c});$&&K(ae.length)})(),()=>{$=!1}},[m,c,n,ee]);const Se=E.length?E:p,he=d.credits,be=x.useCallback($=>{const ae=$.map(oe=>(oe||"").trim()).filter(Boolean);ae.length&&(w(oe=>{const ye=oe.split(`
...
`).map((h,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[ot(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const oa={},Tn=(oa==null?void 0:oa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ln(){return new Date().toISOString().slice(0,10)}const qa=x.createContext(null);function Fs(){return x.useContext(qa)}function Ps(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(o=>/en bref/i.test(o.textContent||"")&&o.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(o=>(o.textContent||"").replace(/\s+/g," ").trim()).filter(o=>o.length>3).slice(0,4)}catch{return[]}}function Ds(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),l=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),s.querySelectorAll("*").forEach(p=>{const h=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(d=>p.removeAttribute(d.name)),h&&/^https?:\/\//i.test(h)&&(p.setAttribute("href",h),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Is(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${i} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${i} ${r[1]}`}function $s(){const{ed:e,isEn:a,day:r,loading:n}=gr(),o=x.useMemo(()=>Ps((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const i=Is(r,a);return o.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+i}),t.jsx("ul",{children:o.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${i}.`:`Édition du ${i}.`})]})}function gr(){const e=x.useContext(qa);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Bs({token:e,children:a}){const{dispatch:r,st:n,lang:o}=P(),[i,l]=x.useState(()=>n.filters.day||Ln()),[s,p]=x.useState(null),[h,d]=x.useState(!1),m=x.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=x.useCallback(()=>{l(Ln());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);x.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),x.useEffect(()=>{const g=v=>{var y;const f=(y=v.detail)==null?void 0:y.day;typeof f=="string"&&m(f)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[m]),x.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),x.useEffect(()=>{if(!e||!i)return;let g=!1;d(!0);const v=new URLSearchParams({token:e,date:i});return fetch(`${Tn}/cibles/edition.json?${v}`).then(f=>f.json()).then(f=>{g||p(f)}).catch(()=>{g||p({ok:!1,error:"network"})}).finally(()=>{g||d(!1)}),()=>{g=!0}},[e,i]);const b=x.useMemo(()=>`${Tn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),c=x.useMemo(()=>({token:e,day:i,ed:s,loading:h,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,h,m,u,n.filters.day,b,o]);return t.jsx(qa.Provider,{value:c,children:a})}function Us(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=gr();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(io,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function br({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=P(),[l,s]=x.useState(!1),[p,h]=x.useState(null);if(!n.pipe||o!=="client"||n.lockActions)return null;const d=async()=>{if(l)return;s(!0);const m=await so(r,e);if(s(!1),!m){i(a.actErr);return}h(m.results||[])};return t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{d()},children:l?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function Ht({spec:e}){const a=x.useRef(null),r=x.useRef(null),[n,o]=x.useState(!1);return x.useEffect(()=>{const i=a.current;if(!i)return;let l=!1;return Ya({kind:"op",card:e},Math.max(240,i.clientWidth||320)).then(s=>{!l&&s&&i.isConnected&&i.replaceChildren(s)}),()=>{l=!0,i.replaceChildren()}},[e]),x.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let l=!1;Ya({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!l&&p&&i.isConnected&&i.replaceChildren(p)});const s=p=>{p.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>o(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const _s=`
...
`;function Vs(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function Hs(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:l,askEvaluate:s,doAnalyse:p,doDecide:h,doPromote:d,doRepeche:m,doApproach:u,doDeep:b,doOnboard:c,outbound:g,evalBusy:v}=P(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=ge(f),j=ke(f),w=Xe(f),A=f.kind==="target",C=z=>{a({type:"filters",patch:z}),a({type:"popup",id:null})};return lt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:_s}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Vs(e.popupAnchor,!!f.card),onClick:z=>z.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Ve(f.date)),$e(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[f.cc]}),children:(dt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:jt(f.amountEur,o)})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ge(f.engine)," ",t.jsx("b",{children:$e(f.engine,o)})," — ",lo(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Je,{o:f,lg:!0})," ",t.jsx(Yt,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Un(y,o))," · ",n.win7(_n(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(Ht,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&A&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})})]}),t.jsx(br,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||l!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(f,!1),a({type:"popup",id:null})},children:n.actNo}),ot(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{c(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var z;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(z=document.querySelector(".atl2 .demand"))==null||z.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}const Ys=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),qt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Ws(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=qt(a.slice(n));break}r+=qt(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=qt(a.slice(o));break}const l=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&Ys.has(p)?r+=`<${s[1]}${p}>`:r+=qt(a.slice(o,i+1)),n=i+1}return r}const Rn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function we({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Gs(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ks({o:e}){const{t:a,doDeep:r}=P(),n=Xe(e),o=[e.reasoning||"",Gs(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),o.length?o.join(`

`).split(`

`).map((i,l)=>t.jsx("p",{className:"cdtxt",children:i},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[ot(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:i=>{i.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:i=>i.stopPropagation(),children:a.memoOpenFull})]})]})}function Qs({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=P(),i=Vt(e),l=Xe(e),s=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,h=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),m=x.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:h},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||ot(e)?1:0}].filter(g=>g.n>0),[e,a,s,l,p,h,d]),[u,b]=x.useState("");if(!m.length)return null;const c=m.some(g=>g.k===u)?u:m[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:m.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":c===g.k,"data-tour":"tab-"+g.k,className:c===g.k?"on":"",onClick:v=>{v.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[c==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(we,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(we,{k:a.cdVerdictDate,v:Rn(e.verdictDate,r)})]})]}),c==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Ws(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(Js,{o:e})]}),c==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdSector,v:e.sector}),t.jsx(we,{k:a.cdStage,v:e.stage}),t.jsx(we,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(we,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(we,{k:a.cdAngle,v:e.angle}),t.jsx(we,{k:a.cdDetected,v:Rn(e.date,r)})]}),c==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdName,v:e.contactName}),t.jsx(we,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(we,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),c==="memo"&&t.jsx(Ks,{o:e}),c==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(we,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(we,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Js({o:e}){const{t:a,token:r}=P(),[n,o]=x.useState(!1),[i,l]=x.useState(null),s=async()=>{n||(o(!0),l(await co(r,e.name,e.website||e.domain||"")),o(!1))},p=(i==null?void 0:i.blocs)||{},h=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=h.some(([,m])=>m);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[h.filter(([,m])=>m).map(([m,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:m}),t.jsx("p",{children:u})]},m)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}const vr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Oa({o:e}){const{t:a}=P(),r=Vt(e),n=Xe(e),o=ke(e),i=ia(e),l=po(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(vr[n]||"v-cons"),title:a.vt[n],children:n}):o===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,o===3&&i==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),o===3&&i==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),o===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const Sa=e=>e.length>22?e.slice(0,21)+"…":e;function Mn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=P(),[i,l]=x.useState(!1);if(x.useEffect(()=>{n||l(!1)},[n]),Ee(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Sa(e.name))})]})}function yr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:l,doPromote:s,doRepeche:p,doApproach:h,dispatch:d}=P();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var c;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var c;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Mn,{o:e})});const m=ke(e),u=b=>c=>{c.stopPropagation(),b()};if(m===0)return t.jsx("span",{className:"cell",children:t.jsx(Mn,{o:e})});if(m===1){const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:u(()=>i(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(m===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(m===4){const b=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:b,onClick:u(()=>h(e)),children:b?a.actApproachSent:a.actApproach})})}return m===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):m===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Xs({o:e}){const{t:a,doThumb:r,thumbOf:n}=P(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Zs({o:e}){const{lang:a}=P();return ge(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Je,{o:e}),t.jsx(Yt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ge(e.engine||"")," ",$e(e.engine||"",a)]})})}function el({o:e,locked:a,open:r,onToggle:n}){const{st:o,dispatch:i,caps:l,markRow:s,markedId:p,favIds:h,toggleFav:d}=P(),m=ke(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,c=b<=0?0:b<=7?1:b<=30?2:3,g=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][m]:u[c],v=h.has(e.id),f=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const j=y.currentTarget.getBoundingClientRect();i({type:"popup",id:e.id,anchor:{x:j.left+Math.min(280,j.width/3),y:j.bottom}})};return t.jsxs(x.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:f,children:[t.jsx("span",{className:"pt",style:{"--c":g}}),t.jsx(Nr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(tl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Zs,{o:e}),l.pipe&&t.jsx(Oa,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(yr,{o:e}),l.showThumbs&&t.jsx(Xs,{o:e})]}),r&&!a&&t.jsx(nl,{o:e})]})}function tl({o:e}){const{lang:a,caps:r}=P();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=jt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function al({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=P(),l=(u,b=!1)=>c=>{c.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=jt(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ee(e),m=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Sa(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Ht,{spec:e.card})})]})}function nl({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:l}=P();return!o.pipe&&e.kind==="op"?t.jsx(al,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Qs,{o:e}),t.jsx(gi,{o:e}),t.jsx(yi,{o:e}),t.jsx(br,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Oa,{o:e})})]}),e.card&&t.jsx(Ht,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ge(e.engine||"")," ",$e(e.engine||"",r)]}),ge(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Je,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function rl({o:e,locked:a}){const{t:r,dispatch:n,caps:o,doDecide:i,lang:l}=P();if(!o.pipe&&e.kind==="op"){const h=jt(e.amountEur,l),d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),m=(u,b=!1)=>c=>{c.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Ht,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:m({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:m({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:m({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ge(e.engine||"")," ",$e(e.engine||"",l)]}),ge(e)&&t.jsx(Je,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(yr,{o:e})})]})}const s=ke(e),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":p},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Oa,{o:e}),ge(e)&&t.jsx(Je,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&o.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>i(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>i(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function ol(){const{t:e}=P(),[a,r]=x.useState(0);return x.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function il({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=P(),i=o==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),p=s.includes(0)?0:s.sort((d,m)=>(e[m]||0)-(e[d]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?i?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:i?`${h} ${h>1?"files":"file"} in “${l(p)}”`:`${h} dossier${h>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(i?"Open ":"Ouvrir ")+l(p)," →"]})]})}function sl(){var X;const e=P(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:l,lang:s,sessTally:p,data:h,dossiers:d,source:m}=e,u=m==="ops"?8:Hn,[b,c]=x.useState(new Set);x.useEffect(()=>{c(new Set)},[a.ptab,a.continent]);const[g,v]=x.useState(null);x.useEffect(()=>{v(null)},[a.ptab,a.continent]);const f=T=>c(F=>{const B=new Set(F);return B.has(T)?B.delete(T):B.add(T),B}),[y,j]=x.useState("all"),[w,A]=x.useState(!1);x.useEffect(()=>{j("all"),A(!1)},[a.ptab,a.continent]),x.useEffect(()=>{if(!w)return;const T=F=>{var B,D;(D=(B=F.target)==null?void 0:B.closest)!=null&&D.call(B,".atl2 .doable")||A(!1)};return document.addEventListener("click",T),()=>document.removeEventListener("click",T)},[w]);const C=Fs(),z=x.useMemo(()=>{var F;const T=new Map;for(const B of Ds(((F=C==null?void 0:C.ed)==null?void 0:F.html)||""))T.has(B.t)||T.set(B.t,B.html);return T},[(X=C==null?void 0:C.ed)==null?void 0:X.html]),L=x.useCallback(T=>{if(T.decryptHtml)return T.decryptHtml;if(!z.size)return;const F=(T.name||"").trim().toLowerCase();if(F.length<3)return;const B=z.get(F);if(B)return B;for(const[D,I]of z)if(D.includes(F)||F.includes(D))return I},[z]),E=x.useMemo(()=>{const T=La(l,a.sort);return y==="all"?T:T.filter(F=>y==="explore"?!!F.noCo:!F.noCo)},[l,a.sort,m,y]),q=x.useMemo(()=>E.filter(T=>ge(T)&&!Ee(T)).length,[E]),O=x.useMemo(()=>o.pipe?E:E.filter(T=>!Ee(T)&&!T.noCo),[E,o.pipe]),M=m==="ops"?E.filter(T=>T.noCo).length:0,U=o.pipe?n.plabels[a.ptab].toLowerCase():m==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,k=(T,F,B="",D=!1)=>t.jsxs("button",{type:"button","data-s":T,className:B,"aria-sort":a.sort.key===T?a.sort.dir===1?"ascending":"descending":"none",style:D?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:T}),children:[F,t.jsx("span",{className:"ar",children:a.sort.key===T&&a.sort.dir===1?"▴":"▾"})]},T),S=x.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const T=new Map;E.forEach(D=>{const I=D.engine||"?";T.has(I)||T.set(I,[]),T.get(I).push(D)});const F={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},B=sa([...T.keys()],s);return[...T.entries()].sort((D,I)=>{const _=F[D[0]]??10+B.indexOf(D[0]),W=F[I[0]]??10+B.indexOf(I[0]);return _-W})},[E,o.pipe,a.groupBy,s]),R=o.lockRowsAfter;let H=0;const G=(T,F)=>{let B=a.shown[F]||u;return T.length-B<=4&&(B=T.length),T.slice(0,B).map(_=>{const W=R!==null&&H>=R;H++;const J=L(_),re=J&&J!==_.decryptHtml?{..._,decryptHtml:J}:_,fe=a.dens!=="maxi"&&(a.dens==="deplie"||(g?g==="open":!!J)),pe=b.has(_.id)?!fe:fe;return a.dens==="maxi"?t.jsx(rl,{o:re,locked:W},_.id):t.jsx(el,{o:re,locked:W,open:pe,onToggle:()=>f(_.id)},_.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:E.length})," ",U]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,o.pipe&&e.fund?" · "+e.fund:"",m==="ops"&&E.length>0&&" — "+n.edSplit(E.length-M,M)]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(o.showFunnel||m==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([T,F])=>t.jsxs("button",{type:"button","data-d":T,"aria-pressed":a.dens===T||T==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:T}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:F})]},T))}),(o.showFunnel||m==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":g==="open",onClick:()=>{v("open"),c(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":g==="closed",onClick:()=>{v("closed"),c(new Set)},children:n.foldAllLbl}),m==="ops"&&t.jsxs("button",{type:"button","aria-pressed":g===null,onClick:()=>{v(null),c(new Set)},children:["📖 ",n.foldArts]})]}),(o.showFunnel||m==="ops")&&(()=>{var B;const T=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],F=((B=T.find(([D])=>D===y))==null?void 0:B[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":w,onClick:()=>A(D=>!D),children:[F,t.jsx("i",{children:"▾"})]}),w&&t.jsx("div",{className:"dolist",children:T.map(([D,I])=>t.jsx("button",{type:"button","aria-pressed":y===D,onClick:()=>{j(D),A(!1)},children:I},D))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:T=>r({type:"sort",key:T.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([T,F])=>t.jsx("option",{value:T,children:F},T))})]}),o.showChain&&O.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:O.map(T=>T.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(O.length):n.chainAll(O.length)]})]}),q>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(q)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),k("country",n.colCountry),k("name",n.colCompany),k("amount",n.colAmount,"h-amt",!0),k("stage",n.colStage,"h-stade"),k("signal",n.colSignal,"h-sig"),o.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),o.pipe&&k("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(m==="ops"?" opsl":"")+(E.length?"":" list-empty"),children:[S?S.map(([T,F])=>t.jsxs(x.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ge(T)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:$e(T,s)}),t.jsx("div",{className:"s",children:n.grpCount(F.filter(B=>!Ee(B)).length,F.length)})]})]}),G(F,T)]},T)):G(E,"pt"+a.ptab),h.loading&&!d.length&&t.jsx(ol,{}),!E.length&&!(h.loading&&!d.length)&&(o.pipe?t.jsx(il,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const T=S||[["pt"+a.ptab,E]];let F=0,B=0;for(const[I,_]of T){B+=_.length;let W=a.shown[I]||u;_.length-W<=4&&(W=_.length),F+=Math.min(_.length,W)}const D=B-F;return D<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>T.forEach(([I,_])=>r({type:"more",group:I,by:_.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(D,D)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(F,B)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function qn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ll(e,a){const r=uo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function dl(e,a){const n=[a.head.split("|").map(qn).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",ll(o,a.plabels),Vt(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(qn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function cl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const pl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Pe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function ul({o:e,qa:a}){const{t:r,lang:n,fund:o}=P(),i=(e.cribleStatus||"").trim().toUpperCase()||(Vt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Xe(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Pe,{k:r.cdSector,v:e.sector}),t.jsx(Pe,{k:r.cdStage,v:e.stage}),t.jsx(Pe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Pe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Pe,{k:r.cdName,v:e.contactName}),t.jsx(Pe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Pe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Pe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Pe,{k:r.cdAngle,v:e.angle}),t.jsx(Pe,{k:r.cdDetected,v:pl(e.date,n)})]}),p.some(([,h])=>h)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,h])=>h).map(([h,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:h}),t.jsx("p",{children:d})]},h))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function ml(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=P(),[s,p]=x.useState({}),h=25,d=x.useMemo(()=>n.slice(0,h),[n]);x.useEffect(()=>{d.length&&mo(r,d.map(b=>b.name)).then(p)},[r,d]);const m=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>h&&t.jsx("span",{className:"mnote dim",children:e.dsCap(h,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[u(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(m.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(m.screened/i.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(ul,{o:b,qa:s[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const fl=50;function Fa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=P(),[i,l]=x.useState(null),[s,p]=x.useState(!1),[h,d]=x.useState(""),[m,u]=x.useState(0),[b,c]=x.useState(""),[g,v]=x.useState(!1),f=x.useRef(null);x.useEffect(()=>()=>{f.current&&window.clearInterval(f.current)},[]);const y=async w=>{p(!0),d("");const A=await a();if(p(!1),A.ok){l(A);return}if(A.busy){d(o.alertPreviewBusy);return}if(!w){d(o.alertPreviewFail);return}u(fl),f.current=window.setInterval(()=>{u(C=>C>1?C-1:(f.current&&window.clearInterval(f.current),y(!1),0))},1e3)},j=async()=>{if(n||g)return;v(!0),c("");const w=await r();v(!1),c(w.ok?o.alertTestOk(w.sentTo||""):w.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||m>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{j()},children:g?"…":o.alertTest})]}),m>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(m)}),h&&t.jsx("p",{className:"mnote warn",children:h}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const bt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ne({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=P();return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function xl(){const{st:e}=P();switch(e.modal){case"chain":return t.jsx(gl,{});case"space":return t.jsx(bl,{});case"alert":return t.jsx(vl,{});case"queue":return t.jsx(Nl,{});case"export":return t.jsx(Sl,{});case"plug":return t.jsx(Al,{});case"recharge":return t.jsx(Tl,{});case"cover":return t.jsx(Rl,{});case"dossier":return t.jsx(Ll,{});case"crit":return t.jsx(Ml,{});case"tuto":return t.jsx(ql,{});case"rdv":return t.jsx(hl,{});case"memoalert":return t.jsx(Cl,{});default:return null}}function hl(){const{dispatch:e,fund:a}=P(),r=typeof document<"u"&&!!document.getElementById("rdv");return x.useEffect(()=>{r&&(e({type:"modal",modal:null}),di())},[r,e]),r?null:t.jsx(ho,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function gl(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:s,caps:p,memoQueued:h,doAnalyse:d}=P(),m=i==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,c=u[b],g=b>=u.length;return lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:c.name}),t.jsx("div",{className:"sub",children:[dt(c.cc,o)||c.countryLabel,c.sector,c.stage,n.daysAgo(Ve(c.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:$e(c.engine,o).toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&t.jsx("span",{children:jt(c.amountEur,o)})]}),ge(c)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Je,{o:c,lg:!0})," ",t.jsx(Yt,{o:c,src:!0})]}),(c.tagline||c.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:c.tagline||c.headline})]}),c.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:c.reasoning})]}),m&&Ee(c)&&t.jsxs("div",{className:"vbox",style:{"--c":We(c)==="retenu"?"var(--brand)":We(c)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:We(c)==="retenu"?"✓ "+n.kept:We(c)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:c.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&c&&p.pipe&&ke(c)===1&&!h.has(c.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(c),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&c&&!(m&&Ee(c))&&(c.noCo&&c.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:c.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(c)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function bl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=P(),i=o==="client",l=x.useMemo(()=>i?r.filter(m=>Ee(m)):[],[r,i]),s=x.useMemo(()=>La(l.filter(m=>We(m)==="retenu"),{key:"signal",dir:-1}),[l]),p=x.useMemo(()=>l.filter(m=>We(m)==="ecarte"),[l]),h=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ne,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(m=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof m.score=="number"&&m.score>0?m.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:m.name}),t.jsx("div",{className:"rr",children:m.reasoning||m.tagline||""})]})]},m.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function vl(){const{mode:e}=P();return e==="client"||e==="apercu"?t.jsx(yl,{}):t.jsx(jl,{})}function yl(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=P(),[i,l]=x.useState("d"),s=o!=="client";return t.jsxs(Ne,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(wl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(kl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(wr,{})]})}function wl({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=x.useState(null),[s,p]=x.useState(!1),[h,d]=x.useState(0);x.useEffect(()=>{let c=!0;return p(!1),Ka(a).then(g=>{c&&(g?l(g):p(!0))}),()=>{c=!1}},[a,h]);const m=c=>{r||Ka(a,c).then(g=>{if(!g){o(e.actErr);return}l(g),g.throttled?o(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=c=>!i.sections||i.sections.includes(c),b=c=>{const g=i.sections||e.alertSec.map(([v])=>v);m({sections:u(c)?g.filter(v=>v!==c):[...g,c]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,(i.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[i.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,(i.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([c,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(c),disabled:r,onChange:()=>b(c)}),t.jsxs("span",{children:[g,c==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},c))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Fa,{label:e.alertPreview,readOnly:r,onPreview:()=>jo(a),onTest:()=>ko(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function kl({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=x.useState(null),[s,p]=x.useState(!1),[h,d]=x.useState(0);x.useEffect(()=>{let c=!0;return p(!1),Qa(a).then(g=>{c&&(g?l(g):p(!0))}),()=>{c=!1}},[a,h]);const m=c=>{r||Qa(a,c).then(g=>{if(!g){o(e.actErr);return}l(g),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:c=>m({dow:Number(c.target.value)}),children:e.alertDow.map((c,g)=>t.jsx("option",{value:g,children:c},c))}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Fa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>So(a),onTest:()=>No(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function wr(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=P(),[l,s]=x.useState(i||""),[p,h]=x.useState(!1),[d,m]=x.useState(!1);x.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,b=x.useMemo(()=>n.filter(f=>ge(f)).length,[n]),c=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){m(!0);try{await fetch(`${Ca}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{m(!1)}}},v=[[a.amRows.continent,o],[a.amRows.since,a.amSince[c]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>$e(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>dt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function jl(){const{t:e}=P();return t.jsx(Ne,{title:e.alertTitle,icon:"🔔",children:t.jsx(wr,{})})}function Nl(){var g,v,f;const{t:e,token:a,fund:r,mode:n,flash:o}=P(),[i,l]=x.useState(null),[s,p]=x.useState([]),[h,d]=x.useState(0),m=n==="client";x.useEffect(()=>{let y=!0;return(async()=>{const[j,w]=await Promise.all([Aa(r),In(a)]);y&&(j&&l(j),p(w))})(),()=>{y=!1}},[a,r,h]);const u=(i==null?void 0:i.per_day)??2,b=((g=i==null?void 0:i.analyzed_today)==null?void 0:g.length)??0,c=(v=i==null?void 0:i.tomorrow)!=null&&v.length?i.tomorrow:((i==null?void 0:i.pool_meta)||[]).slice(0,10);return t.jsxs(Ne,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(b,b+(((f=i==null?void 0:i.pool_order)==null?void 0:f.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),m&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Ga(a,y.company,"retry").then(()=>d(j=>j+1))},children:e.queueRetry}),m&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Ga(a,y.company,"delete").then(()=>d(j=>j+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[c.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),c.slice(0,10).map((y,j)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",j+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Sl(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=P(),s=`${bt}/cibles/list.csv?token=${a}`,p=`${bt}/cibles/list.json?token=${a}`,h=`${bt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,m=v=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:h,href:h}],b=!o.lockActions&&n.length>0,c=()=>{cl(dl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:v=>(e.stg.find(([f])=>f===v)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ne,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:c,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>m(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Cl(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=P(),i=o!=="client",[l,s]=x.useState(null),[p,h]=x.useState(!1),[d,m]=x.useState(0),[u,b]=x.useState(!1);x.useEffect(()=>{let f=!0;return h(!1),Wa(a).then(y=>{f&&(y?s(y):h(!0))}),()=>{f=!1}},[a,d]);const c=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=f=>{if(i||!l)return;const y={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??c()};b(!0),Wa(a,y).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(p)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=c();return t.jsxs(Ne,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(El,{value:l.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>g({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[f],disabled:i||u,onChange:()=>g({sections:{...v,[f]:!v[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Fa,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>xo(a,v),onTest:()=>fo(a,v)})]})}function El({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=x.useState(e);x.useEffect(()=>{l(e)},[e]);const s=i.trim()!==e.trim(),p=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:h=>l(h.target.value),onKeyDown:h=>{h.key==="Enter"&&s&&p&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>o(i.trim()),children:n})]})]})}function Al(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=P(),[i,l]=x.useState(null),[s,p]=x.useState(!1),[h,d]=x.useState(null),[m,u]=x.useState(""),[b,c]=x.useState(0);x.useEffect(()=>{let f=!0;return p(!1),la(a).then(y=>{f&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),bo(a).then(y=>{f&&d(y)}),()=>{f=!1}},[a,b]);const g=(f,y)=>{o&&la(a,f).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}f.test&&j.sent===!1?n(e.plugTestThrottled):r(y),c(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(Ne,{title:e.plugTitle,icon:"🔌",wide:!0,children:[h&&t.jsx("p",{className:"mnote"+(h.enabled?" warn":""),children:h.enabled?e.plugAutoOn(h.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(f=>f+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:m,disabled:!o,onChange:f=>u(f.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!m.trim(),onClick:()=>g({url:m.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(zl,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function zl(){const{t:e,token:a,lang:r}=P(),[n,o]=x.useState("valides"),[i,l]=x.useState(!1),[s,p]=x.useState(null),[h,d]=x.useState(null),[m,u]=x.useState(!1),[b,c]=x.useState(!1),[g,v]=x.useState(null),[f,y]=x.useState(null),[j,w]=x.useState(null),A=`atl2:bulk:${a}:${n}`;x.useEffect(()=>{la(a).then(M=>{y(M&&M.configured?M.url_hint||"webhook":null)})},[a]),x.useEffect(()=>{p(null),d(null),u(!1),v(null);try{const M=JSON.parse(localStorage.getItem(A)||"null");w(M&&Date.now()-Date.parse(M.t)<24*3600*1e3?M:null)}catch{w(null)}},[A]);const C=async()=>{l(!0),u(!1),v(null);const M=await yo(a,n);p(M),d(M.ok?n:null),l(!1)},z=x.useRef(!1),L=async()=>{if(z.current)return;z.current=!0,c(!0);const M=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let U;try{U=await wo(a,n,"webhook",void 0,M)}finally{z.current=!1}if(c(!1),u(!1),v(U),U.ok&&(U.pushed||0)>0){const k={t:new Date().toISOString(),n:U.pushed||0};w(k);try{localStorage.setItem(A,JSON.stringify(k))}catch{}}},E=s!=null&&s.ok&&s.ready||0,q=!!(s!=null&&s.ok)&&h===n&&E>0&&!!f&&!j,O=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:M=>o(M.target.value),children:e.plugBulkTabs.map(([M,U])=>t.jsx("option",{value:M,children:U},M))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{C()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(O,j.n)}),!j&&!!(s!=null&&s.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),q&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),q&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(E,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{L()},children:b?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function Tl(){const{t:e,data:a,lang:r}=P(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const s=window.location.href.split("?")[0];try{const h=await(await fetch(`${Ca}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Ne,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ll(){const{t:e}=P();return t.jsx(Ne,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(ml,{})})}function Rl(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:l,flash:s}=P(),[p,h]=x.useState(null),[d,m]=x.useState(!1);x.useEffect(()=>{let z=!0;if(i)return Aa(i).then(L=>{z&&L&&typeof L.per_day=="number"&&h(L.per_day)}),()=>{z=!1}},[i]);const u=r.stats,b=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(z=>z.kind==="target"&&Ee(z)).length,c=r.marketEstimate||0,g=c>0?Math.min(100,Math.round(b/c*100)):null,v=(u==null?void 0:u.window_days)||30,f=b>0?b/v:0,y=c>0?Math.max(0,c-b):0,w=c>0&&f>0&&b>=100?Math.round(y/f):null,A=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),C=z=>{d||!l||(m(!0),vo(o,z).then(L=>{if(m(!1),L===null){s(e.actErr);return}h(L),s(e.alertSaved)}))};return t.jsxs(Ne,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(A(b))}),c>0&&t.jsx("span",{children:e.covOf(A(c))})]}),g!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:g+"%"}}),t.jsxs("em",{children:[g," %"]})]}),w!==null&&t.jsx("p",{className:"mnote",children:e.covEta(w)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),f>=1&&t.jsx("p",{className:"mnote",children:e.covPace(A(f))}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(u.shown)})," ",e.covShown]})]}),l&&p!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(p)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:p===z?"on":"",disabled:d,onClick:()=>C(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Ml(){var f,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:l,lang:s}=P(),p=n==="client",h=x.useMemo(()=>{const w=new Set;return a.forEach(A=>{A.angle&&w.add(A.angle)}),[...w]},[a]),[d,m]=x.useState(""),[u,b]=x.useState(""),[c,g]=x.useState(!1),v=async()=>{const w=d.trim();if(!(!w||c||!p)){g(!0),b("");try{const C=await(await fetch(`${bt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&b(String(C.reply)),C.job_id){b(e.critChatRunning);const z=async()=>{const L=await fetch(`${bt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(E=>E.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),g(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),m("");return}m("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(Ne,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var A,C;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((A=w.look)!=null&&A.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(z=>t.jsx("li",{children:z},z))})]}),!!((C=w.out)!=null&&C.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(z=>t.jsx("li",{children:z},z))})]})]})]},w.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!p||c,onChange:w=>m(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},disabled:!p||c||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(go,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(vr[w]||"v-cons"),children:w}),t.jsx("span",{children:A})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",A]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function ql(){const{t:e,dispatch:a,startTour:r}=P(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ne,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const kr="atl2:mapfold",Ol=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(kr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},jr=x.createContext(null),P=()=>{const e=x.useContext(jr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Je({o:e,lg:a}){const{lang:r}=P(),n=ge(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ja(n,r),children:[n.emoji," ",Ja(n,r)]}):null}function Yt({o:e,src:a}){const{lang:r,t:n}=P(),o=ge(e);if(!o)return null;const i=To(o),l=Lo(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Un(o,r))+" · "+n.win7(_n(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<i?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Nr({o:e}){const{lang:a}=P(),r=zo(e.cc),n=e.cc?dt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const On="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Sr=e=>`atl2:tour:${e||"anon"}`;function Fl(e){try{return localStorage.getItem(Sr(e))==="1"}catch{return!0}}function Fn(e){try{localStorage.setItem(Sr(e),"1")}catch{}}function Pl(e,a,r,n){const o=e.tourT,i=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},{sel:".atl2 .cover",title:o.cover,body:e.fhintCover},{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:i[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:i[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:i[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:i[0][0],modal:"crit"}].filter(Boolean)}function _l({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){const{lang:l}=Co(),s=$o[l],p=Xo(e,l,a),[h,d]=x.useReducer(ei,void 0,()=>Zo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Ol(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),m=x.useRef(!0);x.useEffect(()=>{if(m.current){m.current=!1;return}if(!e)try{localStorage.setItem(kr,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e]);const u=x.useRef(i);u.current=i,x.useEffect(()=>{var N;(N=u.current)==null||N.call(u,h.filters)},[h.filters]);const[b,c]=x.useState(null),[g,v]=x.useState(null),[f,y]=x.useState({kept:0,dropped:0}),[j,w]=x.useState(!1),[A,C]=x.useState(""),[z,L]=x.useState(!1),[E,q]=x.useState(null),[O,M]=x.useState(!1),[U,k]=x.useState(!1),[,S]=x.useState(0),R=()=>S(N=>N+1),H=x.useRef([]),G=x.useRef(new Set),X=x.useRef(new Set),T=x.useRef(new Map),F=x.useRef(null),{mode:B}=p,D=x.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[p.caps,o,a]),I=D.pipe,_=p.session.token||"",W=B==="client"&&!e;x.useEffect(()=>{if(document.querySelector(`link[href="${On}"]`))return;const N=document.createElement("link");N.rel="stylesheet",N.href=On,document.head.appendChild(N)},[]);const J=(N,V=!1)=>{C(N),L(V),F.current&&clearTimeout(F.current),F.current=setTimeout(()=>C(""),V?4200:2400)},re=N=>J(N,!0),fe=x.useMemo(()=>{const N=new Map;return p.dossiers.forEach(V=>{V.id&&N.set(V.id,V)}),N},[p.dossiers]),pe=x.useMemo(()=>p.dossiers.filter(N=>Yn(N,h,I)),[p.dossiers,h,I]),K=x.useRef(!1);x.useEffect(()=>{if(K.current||e||p.loading||!p.dossiers.length)return;if(!D.showFunnel||Fl(p.session.token||"")){K.current=!0;return}K.current=!0;const N=window.setTimeout(()=>{Fn(p.session.token||""),M(!0)},700);return()=>window.clearTimeout(N)},[e,p.loading,p.dossiers.length,D.showFunnel,p.session.token]);const ee=x.useMemo(()=>p.dossiers.filter(N=>ti(N,h,I,p.favIds)),[p.dossiers,h,I,p.favIds]),xe=x.useMemo(()=>Eo(pe,p.favIds),[pe,p.favIds]),Z=x.useMemo(()=>{const N=Kn(p.dossiers);return N?Ve(N)===0?s.tourToday:Qn(N,l):s.tourNoRun},[p.dossiers,s,l]),se=x.useMemo(()=>p.dossiers.some(N=>!!N.memoUrl||!!N.summary||ot(N)),[p.dossiers]),te=x.useMemo(()=>[1,0,2,4,5,3].find(N=>(xe[N]||0)>0)??0,[xe]),Se=za.find(N=>N.key===h.continent),he=h.continent==="monde"?s.contWorld:(l==="fr"?Se==null?void 0:Se.fr:Se==null?void 0:Se.en)||"";x.useEffect(()=>{const N=V=>{var ue;const Y=(((ue=V.detail)==null?void 0:ue.name)||"").trim();Y&&be(null,Y)};return window.addEventListener("ppmap:evaluate",N),()=>window.removeEventListener("ppmap:evaluate",N)}),x.useEffect(()=>{const N=ue=>{const Oe=String(ue||"").trim();Oe&&d({type:"filters",patch:{sector:[Oe]}})},V=ue=>{var Oe;return N((Oe=ue.detail)==null?void 0:Oe.sector)},Y=ue=>{ue.data&&ue.data.type==="pp-filter"&&N(ue.data.sector)};return window.addEventListener("ppmap:filter",V),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",V),window.removeEventListener("message",Y)}},[]);const be=(N,V)=>{const Y=((N==null?void 0:N.name)||V||"").trim();if(!W){v({kicker:Y});return}!Y||j||(w(!0),(async()=>{try{let ue=Y;const Oe=((N==null?void 0:N.website)||(N==null?void 0:N.domain)||"").trim();if(Oe)ue=Oe;else try{const me=await Ro(Y);if(me!=null&&me.website)ue=me.website;else if(((me==null?void 0:me.candidates)||[]).length===1)ue=me.candidates[0].url;else if(((me==null?void 0:me.candidates)||[]).length>1){H.current=[{name:Y,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(me.candidates||[]).slice(0,5)},...H.current].slice(0,8),R();return}}catch{}const Fe=await Bn(_,ue,"atelier2"),zr={name:Fe.company||Y,verdict:Fe.verdict,reason:Fe.reason||"",remaining:Fe.remaining??null};H.current=[zr,...H.current].slice(0,8),Fe.verdict==="kept"&&y(me=>({...me,kept:me.kept+1})),Fe.verdict==="ruled_out"&&y(me=>({...me,dropped:me.dropped+1}));const pt=N||p.dossiers.find(me=>(me.name||"").toLowerCase()===Y.toLowerCase());pt&&(Fe.verdict==="kept"?pt.verdict=pt.verdict||"MATCH":Fe.verdict==="ruled_out"&&(pt.verdict="NO MATCH"),Fe.reason&&(pt.reasoning=Fe.reason)),R()}finally{w(!1)}})())},et=N=>{if(!W){v({kicker:N.name});return}G.current.add(N.id),ut(_,"fast_request",N.name||"",""),J(s.memoInstantSent(N.name)),R()},tt=N=>T.current.get(N.id)??p.thumbs.get((N.name||"").trim().toLowerCase()),Ae=(N,V)=>d({type:"undoPush",entry:{id:N.id,name:N.name,prevCeoStatus:V}}),ze=async(N,V,Y)=>{const ue=N.ceoStatus||"";N.ceoStatus=V,R();const Oe=await Jt(_,{status:V,airtable_id:N.airtableId,check_id:N.checkId,company:N.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return Oe.ok?Oe.skipped?(N.ceoStatus=ue,R(),re(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&Ae(N,ue),Y!=null&&Y.msg&&J(Y.msg),(V==="Validé"||V==="Écarté")&&!N.ceoNote&&(Y==null?void 0:Y.note)===void 0&&q({o:N,yes:V==="Validé"}),!0):(N.ceoStatus=ue,R(),re(s.actErr),!1)},at=async(N,V)=>{const Y=await Jt(_,{status:N.ceoStatus||"Retenu",airtable_id:N.airtableId,check_id:N.checkId,company:N.name,note:V,via:"note"});return!Y.ok||Y.skipped?(re(Y.skipped?s.actNotPersisted:s.actErr),!1):(N.ceoNote=V,R(),!0)},ct=x.useRef(new Map),Wt=N=>ct.current.has(N.id)?ct.current.get(N.id):p.stages.get((N.name||"").trim().toLowerCase()),$=(N,V)=>{ct.current.set(N.id,V),R()},ae=(N,V)=>{W&&ze(N,V?"Validé":"Écarté",{msg:V?s.decidedYes(N.name):s.decidedNo(N.name)})},oe=N=>{W&&ze(N,"À trancher",{msg:s.promoted(N.name)})},ye=N=>{W&&(async()=>{const V=N.ceoStatus||"";N.ceoStatus="Retenu",R();const Y=await Jt(_,{status:"Retenu",check_id:N.checkId,company:N.name});if(!Y.ok||Y.skipped){N.ceoStatus=V,R(),re(Y.skipped?s.actNotPersisted:s.actErr);return}Ae(N,V),J(s.repeched(N.name))})()},_e=()=>{const N=h.undo[h.undo.length-1];if(!N){J(s.undoNone);return}const V=fe.get(N.id);if(!V){d({type:"undoPop"}),J(s.undoNone);return}let Y=N.prevCeoStatus;if(!Y)if((V.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{J(s.undoLockedTitle);return}(async()=>await ze(V,Y,{undo:!1})&&(d({type:"undoPop"}),V.ceoStatus=N.prevCeoStatus,R(),J(s.undoDone(V.name))))()},je=N=>{W&&(X.current.add(N.id),R(),(async()=>{const V=await Mo(_,N.name,"email");if(!V||V.ok===!1){X.current.delete(N.id),R(),re(s.actErr);return}ut(_,"approach",N.name||"",""),J(s.actApproachSent)})())},le=(N,V)=>{W&&(async()=>{if(!(await ut(_,V?"yes":"no",N.name||"","")).ok){re(s.actErr);return}T.current.set(N.id,V?"yes":"no"),R(),J(V?s.thumbUpDone:s.thumbDnDone)})()},Te=N=>{!W||!ot(N)||(ut(_,"detailed_request",N.name||"",""),J(s.memoDeepSent(N.name)))},Gt=N=>{const V=new Set(p.favIds),Y=V.has(N.id);Y?V.delete(N.id):V.add(N.id),p.setFavIds(V),W&&qo(_,{id:N.id,co:N.name},Y)},Nt=()=>{!W||U||window.confirm(s.identSyncConfirm)&&(k(!0),(async()=>{const N=await Oo(_);k(!1),N?J(s.identSyncDone):re(s.actErr)})())},Pa=/proplace/i.test(p.fund||""),Cr=N=>{!W||!Pa||(ut(_,"onboard_request",N.name||"",""),J(s.onboardSent(N.name)))},Er={st:h,dispatch:d,t:s,lang:l,mode:B,caps:D,pipe:I,token:_,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:ye,thumbOf:tt,canWrite:W,commitStatus:ze,saveNote:at,stageOf:Wt,setStage:$,flashErr:re,startTour:()=>M(!0),dossiers:p.dossiers,scopedAll:pe,scoped:ee,counts:xe,byId:fe,contName:he,favIds:p.favIds,toggleFav:Gt,askEvaluate:be,doAnalyse:et,doDecide:ae,doPromote:oe,doApproach:je,doThumb:le,doDeep:Te,doUndo:_e,doSync:Nt,doOnboard:Cr,outbound:Pa,memoQueued:G.current,approachDone:X.current,sessTally:f,evalCards:H.current,evalBusy:j,markRow:c,markedId:b,flash:J};x.useEffect(()=>{const N=V=>{V.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",N),()=>window.removeEventListener("keydown",N)},[]);const Ar=N=>_?t.jsx(Bs,{token:_,children:N}):t.jsx(t.Fragment,{children:N});return t.jsx(jr.Provider,{value:Er,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:_o}),Ar(t.jsxs("div",{className:"app"+(I?" pipe":"")+(_?" has-thesis":""),children:[D.showTicker&&t.jsx(ve,{name:"live",children:t.jsxs("div",{className:"live-stack"+(_?" live-stack--cibles":""),children:[t.jsx(ii,{}),!!_&&t.jsx(Us,{})]})}),D.showIdent&&t.jsx(ve,{name:"identite",children:t.jsx(ji,{})}),!!_&&t.jsx(ve,{name:"lead",children:t.jsx($s,{})}),D.showOnb&&t.jsx(ve,{name:"onboarding",children:t.jsx(Ni,{})}),D.showMorning&&t.jsx(ve,{name:"matin",children:t.jsx(ki,{})}),t.jsx(ve,{name:"fraicheur",children:t.jsx(fi,{})}),t.jsx(ve,{name:"mesure",children:t.jsx(xi,{})}),D.showFunnel&&t.jsx(ve,{name:"entonnoir",children:t.jsx(Dl,{})}),D.showFunnel&&t.jsx(ve,{name:"tunnel",children:t.jsx(Ci,{})}),D.showFunnel&&t.jsx(ve,{name:"tuto",children:t.jsx(Ai,{})}),t.jsx(ve,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Il,{}),t.jsxs("div",{className:"stage"+(h.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Ss,{}),t.jsx(Es,{})]})]})}),D.showDemand&&t.jsx(ve,{name:"evaluation",children:t.jsx(Ms,{})}),D.showDemand&&h.memoConsole&&t.jsx(ve,{name:"console",children:t.jsx(Os,{})}),t.jsx(ve,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(sl,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),D.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),h.popupId&&t.jsx(ve,{name:"fiche",children:t.jsx(Hs,{})}),t.jsx(ve,{name:"modales",children:t.jsx(xl,{})}),t.jsx(pi,{}),E&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:E.o.name}),t.jsx(vi,{placeholder:E.yes?s.whyYesPh:s.whyNoPh,onDone:N=>{const V=E.o;q(null),N&&at(V,N).then(Y=>{Y&&J(s.csNoteSaved)})}})]}),O&&t.jsx(wi,{steps:Pl(s,Z,se,te),onClose:()=>{M(!1),Fn(_)}}),A&&t.jsx("div",{className:"flash on"+(z?" err":""),children:A}),g&&t.jsx(Ao,{variant:"acquirer",initialCompany:Pn().co,initialWebsite:Pn().site,onClose:()=>v(null)})]})})}function Dl(){const{t:e}=P(),[a,r]=x.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Il(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:o,t:i}=P(),l=x.useMemo(()=>{const s={};return e.forEach(p=>{Ta(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[Fo.map(s=>{const p=za.find(d=>d.key===s),h=s==="monde"?i.contWorld:o==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[h,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?i.showMap:i.hideMap})})]})}function Pn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function $l(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Nr as FlagCell,Je as SigBadge,Yt as SigWin,_l as default,$l as fmtShort,P as useV2};
