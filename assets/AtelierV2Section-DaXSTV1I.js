...
`)}),y(!0))},[]);h.useEffect(()=>{if(!G)return;O(0);const I=window.setInterval(()=>O(ae=>ae+1),1e3);return()=>window.clearInterval(I)},[G]);const et=()=>{const I=b.trim();I&&(o(null,I),v(""))},tt=async()=>{if(!x){o(null,te[0]||"");return}if(!te.length||C)return;A(!0),q.current=!1;const I=[];for(let ae=0;ae<te.length&&!q.current;ae++){B(e.evaluating(ae+1,te.length,te[ae]));const oe=await Bn(r,te[ae],"atelier2");if(I.unshift({name:oe.company||te[ae],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),M([...I]),oe.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(te.length-ae-1),remaining:0}),M([...I]),w(te.slice(ae+1).join(`
`)),B(""),A(!1);return}}B(""),w(q.current?te.slice(I.length).join(`
`):""),A(!1)},Ae=async()=>{var oe,ye,_e;if(Z.current)return;const I=j.trim().replace(/\s+/g,""),ae=T.trim();if(!I&&!ae){P(e.rsNeed);return}if(!x&&!c){o(null,I||ae.slice(0,80));return}Z.current=!0,P(""),_(null),J(null),X(!0);try{const je=await ro({url:I,text:ae,email:n,cbToken:c});if(X(!1),!je||je.status!=="success"){P((je==null?void 0:je.message)||"Erreur");return}_(je),U(!1),be((((oe=je.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Te=>(Te==null?void 0:Te.name)||"")),J({state:"pending"});const le=await oo(je,{email:n,cbToken:c});J(le.ok?{state:"ok",scopeLabel:((ye=le.summary)==null?void 0:ye.scope_label)||"",scope:((_e=le.summary)==null?void 0:_e.scope)||""}:{state:"fail",msg:le.error||""}),le.ok&&xe(Te=>Te+1)}finally{Z.current=!1,X(!1)}},ze=[D==null?void 0:D.industry,...(D==null?void 0:D.market_tags)||[],D==null?void 0:D.author].map(I=>(I||"").trim()).filter(Boolean),at=(W==null?void 0:W.state)==="pending",ct=W&&(at?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):W.state==="ok"?t.jsx("span",{className:"rslink ok",children:W.scope&&W.scope!=="public"?e.rsSavedIn(W.scopeLabel||W.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:W.msg,children:e.rsSaveFail})),Wt=zs(D).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:I=>v(I.target.value),onKeyDown:I=>{I.key==="Enter"&&et()}}),t.jsx("span",{className:"detect"+(zn.test(b.trim())?" url":""),children:se})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:et,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),g.showCredits&&he&&t.jsxs("button",{type:"button",className:"credits"+(he.total_available<=0&&!he.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:he.unlimited?"∞":he.total_available}),!he.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",he.daily_grant+he.purchased]}),he.total_available<=0&&!he.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(L?" on":""),onClick:()=>U(!L),children:e.rsOpen}),pe!==null&&pe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>fe(!re),children:e.rsArchOpen(pe)})]}),re&&t.jsx(Rs,{bump:ee,cbToken:c,onClose:()=>fe(!1),onEvaluate:I=>o(null,I),onAddAll:be}),L&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:j,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:I=>S(I.target.value),onKeyDown:I=>{I.key==="Enter"&&Ae()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:T,placeholder:e.rsTextPh,onChange:I=>H(I.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||at||!j.trim()&&!T.trim(),onClick:()=>{Ae()},children:[t.jsx("span",{className:"fill"}),G?`${no(j.trim())==="youtube"&&j.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(z)}`:at?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),$&&t.jsx("div",{className:"rserr",children:$}),D&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:D.title}),D.source_url&&t.jsx("a",{href:D.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{_(null),J(null)},children:"×"})]}),D.market&&t.jsx("p",{className:"rsmk",children:D.market}),ze.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),ze.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[D.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${D.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xr(D.summary_md||"").map((I,ae)=>t.jsx("p",{children:I},ae))})]}),t.jsx(hr,{card:D,onEvaluate:I=>o(null,I),onAddAll:be}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Wt)}),ct]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:k,placeholder:e.bulkPh,onChange:I=>w(I.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(C?" loading":""),style:{justifyContent:"center"},disabled:C||!te.length,onClick:()=>{tt()},children:[t.jsx("span",{className:"fill"}),C&&R?R:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(te.length)})]})]}),Se.slice(0,1).map((I,ae)=>{const oe=I.verdict==="kept",ye=I.verdict==="quota",_e=oe?"var(--brand)":ye?"var(--bolt)":"var(--red)",je=oe?"var(--brand-l)":ye?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":_e,"--bgc":je},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:ye?"⏳":"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(le=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:le.url.startsWith("http")?le.url:`https://${le.url}`,target:"_blank",rel:"nofollow noopener",children:[(le.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,le.url),children:e.evalPickGo})]},le.url))}),!ye&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const le=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const Te=[...document.querySelectorAll(".atl2 .list .row")].find(Gt=>{var Nt;return(((Nt=Gt.querySelector(".rnm"))==null?void 0:Nt.textContent)||"").trim().toLowerCase().includes(le)});Te&&(Te.scrollIntoView({behavior:"smooth",block:"center"}),Te.classList.add("flashrow"),window.setTimeout(()=>Te.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),x&&(i.kept+i.dropped>0||Se.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function qs(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Os(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=F(),i=e.memoConsole?r.get(e.memoConsole):null,l=h.useMemo(()=>i?[i.reasoning||"",qs(i.summary||"")].filter(Boolean).join(`
