...
/* Drapeaux : 20×14, rayon 2 — plus le rayon 8 px du proto (capsule) ni
   l'ombre sur l'image qui dessinait un carré clair autour. */
body.pp-desk .atl2.cibles .desk-list .row .c-flag,
.atl2.cibles .desk-list .row .c-flag{width:20px;height:14px;padding:0;
  border-radius:2px;overflow:hidden;background:transparent;
  box-shadow:0 0 0 1px rgba(15,29,51,.14);display:block;line-height:0}
body.pp-desk .atl2.cibles .desk-list .row .c-flag img,
.atl2.cibles .desk-list .row .c-flag img{width:20px!important;height:14px!important;
...
`,Cl=El+jl+Nl+Sl;function fn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function zl(){const e=fn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Al(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=zl();return r==="0"?"client":r==="1"||fn("embed")==="1"&&fn("chrome")==="1"?"apercu":"client"}const ql={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Tl=e=>ql[e];function La(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Tt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!go(a)||La(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Qi(e.cc)})};function Ja(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ll=60*60*1e3;function Fl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ll?null:a}catch{return null}}function ha(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Rl=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ol(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:Ii(),[e,n]),i=c.useMemo(()=>n?"visiteur":Al(e,o),[e,o,n]),d=c.useMemo(()=>Tl(i),[i]),l=i!=="visiteur",s=Rl(r),[h,p]=c.useState([]),[x,u]=c.useState(""),[b,m]=c.useState(null),[w,k]=c.useState(null),[f,v]=c.useState(null),[E,y]=c.useState(()=>new Map),[N,j]=c.useState(()=>new Map),[C,L]=c.useState(""),[S,T]=c.useState(new Set),[O,H]=c.useState(null),[R,M]=c.useState(!0),[g,q]=c.useState(!1),[D,Q]=c.useState(0),[z,P]=c.useState(0),I=c.useRef(0),U=c.useMemo(()=>{var $;if(i!=="client")return"";try{return(($=Pi())==null?void 0:$.email)||""}catch{return""}},[i]);c.useEffect(()=>{const $=++I.current;let pe=!0;const J=()=>pe&&$===I.current,le=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),ge=Fl(le);return ge?(p(ge.objs.map(Tt)),ge.fund&&u(ge.fund),m(ge.marketEstimate??null),k(ge.criteria??null),v(ge.stats??null),L(ge.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const ue=await Ga(),ye=((ue==null?void 0:ue.recent_ops)||[]).map(be=>{const je=ja(be.company_name||be.title?be:{...be,title:(be.headline_fr||be.headline||"").slice(0,120)},a),Fe=String(be.rubrique||"").toLowerCase();return je&&(Fe==="nominations"||Fe==="recrutements")&&(je.engine=Fe),je&&!String(be.company_name||"").trim()&&(je.noCo=!0),je}).filter(be=>!!be).map(be=>(go((be.name||"").trim())||(be.noCo=!0),be));try{const be=_i(),je=await Bi(),Fe=((je==null?void 0:je.date)||"").slice(0,10),ne=be?be.doc:je,Ne=$i(ne),ve=((be==null?void 0:be.day)||(ne==null?void 0:ne.date)||Fe||"").slice(0,10);if(ve&&Ne.length){const oe=new Set;for(const B of ye){if((B.date||"").slice(0,10)!==ve)continue;const W=Xn(Ne,oe,B.name,"");W>=0&&(oe.add(W),B.decryptHtml=Ne[W].html)}for(const B of ye){if(B.decryptHtml||(B.date||"").slice(0,10)!==ve)continue;const W=Xn(Ne,oe,"",B.headline||B.tagline||B.name);W>=0&&(oe.add(W),B.decryptHtml=Ne[W].html)}}if(ve){const oe=((ne==null?void 0:ne.title_fr)||"").trim(),B=((ne==null?void 0:ne.lead_fr)||"").trim(),W=Ui(ne),ee=((ne==null?void 0:ne.url)||"").trim();oe&&(W||ee)&&ye.unshift({id:`edito:${ve}`,kind:"op",name:oe,cc:null,date:ve,engine:"edito",dealKind:"other",headline:oe,tagline:B||oe,decryptHtml:W||void 0,url:ee,noCo:!0})}}catch{}if(!J())return;p(ye.map(Tt)),ha(le,{objs:ye})}else if(typeof r=="object"){const ye=(await Zn()||[]).filter(je=>(je.slug||"")===r.research).map(je=>er(je,a)).filter(je=>!!je),be=Ja(await tr(ye,a));if(!J())return;p(be.map(Tt)),ha(le,{objs:be})}else if(l&&o.token){const ue=Hi(o.token),ye=Ga(),be=Vi(o.token),je=Wi(o.token),Fe=Gi(o.token),ne=await ue;let Ne=ne?ne.targets:[];J()&&ne&&(u(ne.fund||""),m(ne.marketEstimate??null),k(ne.criteria??null),v(ne.stats??null),L(ne.generatedAt||""),p(Ne.map(Tt)),M(!1),q(!1));const[ve,oe,B,W]=await Promise.all([ye,be,je,Fe]),ee=((ve==null?void 0:ve.recent_ops)||[]).map(re=>ja(re,a)).filter(re=>!!re),de=new Set(Ne.map(re=>re.id));if(Ne=[...Ne,...ee.filter(re=>!de.has(re.id)&&(de.add(re.id),!0))],!J())return;p(Ne.map(Tt));const ce=new Set;for(const re of oe){const ie=(re.id||re.co||"").toString().trim().toLowerCase();ie&&ce.add(ie.startsWith("t:")?ie:"t:"+ie)}T(ce),y(B),j(W),ne&&ha(le,{fund:ne.fund,marketEstimate:ne.marketEstimate,criteria:ne.criteria,stats:ne.stats,generatedAt:ne.generatedAt,objs:Ne})}else{const ue=Yi(),ye=Zn(),be=Ga(),je=await ue;J()&&je.length&&(p(Ja(je).map(Tt)),M(!1),q(!1));const[Fe,ne]=await Promise.all([ye,be]),Ne=(Fe||[]).map(W=>er(W,a)).filter(W=>!!W),ve=await tr(Ne,a),oe=((ne==null?void 0:ne.recent_ops)||[]).map(W=>ja(W,a)).filter(W=>!!W),B=Ja([...je,...ve,...oe]);if(!J())return;p(B.map(Tt)),ha(le,{objs:B})}J()&&q(!1)}catch{J()&&!ge&&q(!0)}finally{J()&&M(!1)}})(),()=>{pe=!1}},[l,o.token,a,D,s]),c.useEffect(()=>{if(!d.showCredits||!U){H(null);return}let $=!0;return(async()=>{try{const pe=await fetch(`${Ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:U})});if(!pe.ok)return;const J=await pe.json();$&&J&&J.ok!==!1&&H(J)}catch{}})(),()=>{$=!1}},[d.showCredits,U,z]);const te=c.useCallback($=>T(new Set($)),[]);return{session:o,mode:i,caps:d,fund:x,email:U,marketEstimate:b,generatedAt:C,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:f,thumbs:E,stages:N,dossiers:h,patchStatuses:($,pe)=>{p(J=>{let le=!1;const ge=J.map(ue=>{if(!ue.checkId)return ue;const ye=$.get(ue.checkId);return!ye||ye===(ue.ceoStatus||"")||!pe(ue.id)?ue:(le=!0,{...ue,ceoStatus:ye})});return le?ge:J})},favIds:S,setFavIds:te,credits:O,reloadCredits:()=>P($=>$+1),loading:R,error:g,refresh:()=>Q($=>$+1)}}function He(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Na=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Fa(e){return Na.has(e.engine||"")}function Je(e){return!!e.noCo||Fa(e)&&!!e.url}const Ro=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ml=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Ro(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Dl=new Set(["signal","amount","score","crible","memo"]);function Il(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Ro(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Dl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Oo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Oo=80;function Ra(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!$e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ln(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(jt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Lt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(bo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function oa(e,a,r){return He(e)?Ra(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ra(e,a.filters,r)}function Pl(e,a,r,n){return!(!oa(e,a,r)||r&&!xo(e,a.ptab,n))}function Dn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-jt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Ji(o)||null;case"memo":return Ki(o)||null;case"signal":{const i=$e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Xa={},yr=(Xa==null?void 0:Xa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function wr(){return new Date().toISOString().slice(0,10)}const In=c.createContext(null);function Mo(){return c.useContext(In)}function _l(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const h=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(p=>s.removeAttribute(p.name)),h&&/^https?:\/\//i.test(h)&&(s.setAttribute("href",h),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Do(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Bl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Do(r),r.innerHTML):e}catch{return e}}function kr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Do(r),r.innerHTML):e}catch{return e}}function Er(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Io(){const e=c.useContext(In);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function $l({token:e,children:a}){const{dispatch:r,st:n,lang:o}=K(),[i,d]=c.useState(()=>n.filters.day||wr()),[l,s]=c.useState(null),[h,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),u=c.useCallback(()=>{d(wr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=k=>{var v;const f=(v=k.detail)==null?void 0:v.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const k=new URLSearchParams({token:e,date:i});return fetch(`${yr}/cibles/edition.json?${k}`).then(f=>f.json()).then(f=>{w||s(f)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${yr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=c.useMemo(()=>({token:e,day:i,ed:l,loading:h,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,h,x,u,n.filters.day,b,o]);return t.jsx(In.Provider,{value:m,children:a})}function Ul(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Io(),[o,i]=c.useState(()=>n||vo());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Aa,d),()=>window.removeEventListener(Aa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Xi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Hl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function jr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Nr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Vl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Io(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,h=c.useRef(null),[p,x]=c.useState("fonds"),[u,b]=c.useState(null),[m,w]=c.useState("idle"),k=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),k.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||k.current)return;k.current=!0;let N=!0;return w("load"),Hl(e).then(j=>{N&&(b(j),w("fait"))}),()=>{N=!1}},[p,e]);const f=c.useMemo(()=>Bl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),v=c.useRef(null);c.useEffect(()=>{const N=v.current;if(!N||!f)return;let j=!1;return cn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(j||!N.isConnected)&&(C.beautifyEditoRows(N),C.mountCardFits(N))}),()=>{j=!0}},[f]);const E=c.useMemo(()=>kr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),y=c.useMemo(()=>kr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const N=h.current;if(!N||!E)return;let j=!1;return cn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(j||!N.isConnected)&&(C.beautifyEditoRows(N),C.mountCardFits(N))}),()=>{j=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const N=(a==null?void 0:a.date)||e,j=/^(\d{4})-(\d{2})-(\d{2})/.exec(N);return j?i?`${j[2]}/${j[3]}/${j[1]}`:`${j[3]}/${j[2]}/${j[1]}`:N})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?jr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Er(e,!0)}),"."]}):jr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Er(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&E?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,p==="fonds"&&d&&y?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:y}}):null,p==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Nr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Nr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Wl=300,ga=7,Gl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Po={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Yl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Za(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(as(r)&&r!=="media")return"news:"+r;const n=$e(e);return n?"sig:"+(n.theme&&Po.fr[n.theme]?n.theme:"other"):"actualites"}function Ql(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=K(),s=Mo(),h=d==="en",[p,x]=c.useState("all"),[u,b]=c.useState(!1),m=c.useMemo(()=>{var pe;const g=(a.filters.day||"").slice(0,10),q=J=>!(!i&&a.continent!=="monde"&&J.continent!==a.continent||g&&(J.date||"").slice(0,10)!==g),D=e.filter(J=>q(J)&&$e(J)&&(!i||J.kind!=="target"||Le(J)!==5)),Q=i&&(((pe=s==null?void 0:s.ed)==null?void 0:pe.ops)||[]).length?s.ed.ops.map(J=>ja(J,d)).filter(J=>!!J).map(J=>(J.briefOnly=!0,J)).filter(J=>!g||(J.date||"").slice(0,10)===g):[],z=e.filter(J=>q(J)&&J.kind==="op"&&(g?!0:jt(J.date)<=ga)),P=i?Q.length?Q:z.filter(J=>{const le=(l||"").trim().toLowerCase();if(!le)return!1;const ge=J.match||null;return ge?Object.keys(ge).map(ue=>ue.trim().toLowerCase()).includes(le):!1}):z,I=g||new Date().toISOString().slice(0,10),U=J=>{const le=Za(J);return le==="ma"?0:le==="levees"?1:2};P.sort((J,le)=>{const ge=U(J)-U(le);if(ge)return ge;const ue=(J.date||"").slice(0,10)===I?0:1,ye=(le.date||"").slice(0,10)===I?0:1;return ue!==ye?ue-ye:(le.amountEur||0)-(J.amountEur||0)});const te=new Set,$=[];for(const J of[...P,...Dn(D,{key:"signal",dir:-1})]){const le=J.id||J.name;!le||te.has(le)||(te.add(le),$.push(J))}return i&&$.length===0?e.filter(le=>q(le)&&jt(le.date)<=ga).sort((le,ge)=>(ge.date||"").localeCompare(le.date||"")).slice(0,80):$},[e,a.continent,a.filters.day,i,l,d,s]),w=c.useMemo(()=>{const g={};for(const q of m){const D=Za(q);g[D]=(g[D]||0)+1}return g},[m]),k=c.useMemo(()=>p==="all"?m:m.filter(g=>Za(g)===p),[m,p]),f=c.useMemo(()=>k.slice(0,Wl),[k]),v=k.length-f.length,E=c.useRef(null);c.useEffect(()=>{var P,I;const g=E.current;if(!g)return;const q=()=>{const U=g.scrollWidth;U<200||(g.style.animationDuration=Math.max(18,Math.round(U/130))+"s")};q();const D=requestAnimationFrame(q),Q=window.setTimeout(q,1200);let z=!0;return(I=(P=document.fonts)==null?void 0:P.ready)==null||I.then(()=>{z&&q()}),()=>{z=!1,cancelAnimationFrame(D),window.clearTimeout(Q)}},[f.length,p]);const y=g=>g==="all"?m.length:w[g]||0,N=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return Po[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const q=g.slice(5);return es[q]?ts(q,h?"en":"fr"):g}return Gl[h?"en":"fr"][g]},j=[{k:"all"}],C=["ma","levees"].filter(g=>y(g)>0||g===p);if(C.length){j.push({g:h?"Deals":"Opérations"});for(const g of C)j.push({k:g})}const L=["nominations","recrutements"].filter(g=>y(g)>0||g===p),S=Zi.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>y(g)>0||g===p),T=y("actualites")>0||p==="actualites"?["actualites"]:[];if(L.length||S.length||T.length){j.push({g:h?"News":"Actualités"});for(const g of L)j.push({k:g});for(const g of S)j.push({k:g});for(const g of T)j.push({k:g})}const O=Yl.map(g=>"sig:"+g).filter(g=>y(g)>0||g===p);if(O.length){j.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of O)j.push({k:g})}const H=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},R=(()=>{const g=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(h?`LIVE covers the events of ${H(g)}.`:`Le LIVE regroupe les événements du ${H(g)}.`)+q:(h?`LIVE covers the still-open signals and the deals of the last ${ga} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ga} derniers jours.`)+q})(),M=g=>f.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ge(q)?" spent":""),onClick:D=>{const Q=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:Q?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(Q||n({type:"focus",id:q.id}),a.dens!=="liste"){const z=D.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:z.left+z.width/2,y:z.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(Ct,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(Ei,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Kc(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Va,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(q.id||q.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(g=>!g),children:[N(p),t.jsx("b",{children:y(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:R}),j.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===p,onClick:()=>{x(g.k),b(!1)},children:[N(g.k),t.jsx("b",{children:y(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:E,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(Jl,{isEn:h})]})}const Kl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Jl({isEn:e}){const[a,r]=c.useState(()=>vo());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Aa,o),()=>window.removeEventListener(Aa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ns(!a),children:Kl})}const Pn="+33 6 83 10 72 86",Oa="alexandre@proplace.co",_o=`tel:${Pn.replace(/[^\d+]/g,"")}`;function Xl(){return null}class dt extends c.Component{constructor(){super(...arguments);Qn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Bo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Sr(e,a){if((zt(e)||"").startsWith("CALL")&&Le(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Le(e)>=2;return Bo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Cr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Zl={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function ed({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=K(),[l,s]=c.useState(""),[h,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const v=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),p(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),w=async v=>{if(l)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}s(v);const E=(Sr(e,a).find(([N])=>N===v)||[v,v])[1],y=await o(e,v,{msg:a.csMoved(e.name,E)});s(""),y&&(p(!1),u(!1))},k=Sr(e,a),f=v=>(k.find(([E])=>E===v)||[])[1]||v;return k.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:k.map(([v,E])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(l===v?" busy":""),disabled:!!l,onClick:()=>{w(v)},children:E},v))}):t.jsxs("span",{className:"rstat"+(x||h?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+Cr(m),onClick:()=>{u(v=>!v),p(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),x&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:k.map(([v,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===v,className:"rsopt"+(m===v?" on":"")+(l===v?" busy":""),disabled:!!l,onClick:()=>{if(v===m){u(!1);return}w(v)},children:[t.jsx("i",{className:"pt2",style:{background:Zl[Cr(v)]}}),E]},v))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const v=await o(e,"Analysé");s(""),v&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function td({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=K(),[i,d]=c.useState(""),[l,s]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),p=(zt(e)||"").startsWith("CALL")&&Le(e)===3,x=Le(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(m);const w=await o(e,m);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:Bo.filter(([m])=>!(x&&m==="Retenu")).map(([m,w])=>[m,a[w]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,w])=>t.jsx("button",{type:"button",className:"csb"+(h===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:w},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ad,{o:e})]})}function ad({o:e}){const{t:a,saveNote:r,flash:n}=K(),[o,i]=c.useState(e.ceoNote||""),[d,l]=c.useState(!1),[s,h]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:s?a.csNoteSaved:a.csNoteOk})]})}function zr({placeholder:e,onDone:a}){const{t:r}=K(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function nd({o:e}){var k;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=K(),[s,h]=c.useState(!1);if(!n.pipe||!o||n.lockActions||Le(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",u=async f=>{if(s||f===x)return;h(!0);const v=p;d(e,{stage:f,stamps:(p==null?void 0:p.stamps)||{}});const E=Math.max(Date.now(),Ar+=1);Ar=E;const y=await rs(r,{company:e.name||"",stage:f,cts:E,deal_id:e.airtableId,check_id:e.checkId});h(!1),!y.stale&&(y.ok||(d(e,v),l(a.actErr)))},b=(k=p==null?void 0:p.stamps)==null?void 0:k.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:s,onClick:()=>{u(f)},children:v},f)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let Ar=0;const Kt=8,Nt=360;function qr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Tr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(qr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(qr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function rd({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=K(),[d,l]=c.useState(0),[s,h]=c.useState(null),[p,x]=c.useState([]),u=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=c.useRef(!1);c.useEffect(()=>{const C=b.current;return()=>{m.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),c.useEffect(()=>{u.current||(u.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const w=p[d],k=d>=p.length;c.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const C=w.click,L=window.setTimeout(()=>{const S=document.querySelector(C);S&&S.getAttribute("aria-selected")!=="true"&&S.click()},60);return()=>window.clearTimeout(L)}},[d,w]);const f=c.useRef(-1),v=c.useCallback(()=>{if(!w){h(null);return}const C=T=>{if(!T)return null;for(const O of document.querySelectorAll(T)){const H=O.getBoundingClientRect();if(H.width>1&&H.height>1)return O}return null},L=C(w.sel)||C(w.need);if(!L){h(null);return}f.current!==d&&(f.current=d,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=L.getBoundingClientRect();h(T=>T&&Math.abs(T.top-S.top)<1&&Math.abs(T.left-S.left)<1&&Math.abs(T.width-S.width)<1&&Math.abs(T.height-S.height)<1?T:S)},[w,d]);c.useLayoutEffect(()=>{v();const C=[90,300,700,1300].map(T=>window.setTimeout(v,T)),L=window.setInterval(v,400),S=()=>v();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{C.forEach(T=>window.clearTimeout(T)),window.clearInterval(L),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[v]);const E=c.useRef(a);if(E.current=a,c.useEffect(()=>{const C=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),E.current()):L.key==="ArrowRight"?l(S=>S+1):L.key==="ArrowLeft"&&l(S=>Math.max(0,S-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!p.length)return null;let y=null;const N=C=>()=>{m.current=!0,n({type:"modal",modal:null}),C()};if(k){const C=o[3]||0;C>0?y={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?y={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?y={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let j={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Nt};if(!k&&s){const C=s.bottom+14,L=window.innerHeight-C;let S=L>190?C:Math.max(12,s.top-200),T=Math.min(Math.max(12,s.left+s.width/2-Nt/2),window.innerWidth-Nt-12);L<=190&&s.top<212&&(window.innerWidth-s.right>=Nt+40?T=Math.min(s.right+26,window.innerWidth-Nt-12):s.left>=Nt+40&&(T=Math.max(12,s.left-Nt-26)),S=Math.max(12,s.top-Kt)),j={left:T,top:S,width:Nt}}return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!k&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-Kt,top:s.top-Kt,width:s.width+Kt*2,height:s.height+Kt*2}}),(k||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(k?" fin":""),style:j,children:[k&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(Tr,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(Tr,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(C=>C+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function $o(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Uo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function od(){var L,S;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=K(),h=r?a:e,p=c.useMemo(()=>h.filter(T=>jt(T.date)===0&&T.kind==="target"),[h]),x=c.useMemo(()=>r?a.filter(T=>T.kind==="target"&&Le(T)===0).slice().sort((T,O)=>(O.date||"").localeCompare(T.date||"")):[],[a,r]),u=c.useMemo(()=>p.filter(T=>r?Le(T)===0:!Ge(T)),[p,r]),b=r?x:u,m=r?a.length-x.length:p.length-u.length,w=r?a.length:p.length,k=w?Math.min(100,m/w*100):100,f=c.useMemo(()=>$o(h),[h]),v=!!f&&jt(f)>0,E=c.useMemo(()=>v?h.filter(T=>(T.date||"").slice(0,10)===f):[],[h,f,v]),y=typeof((L=l.stats)==null?void 0:L.kept_today)=="number"?l.stats.kept_today:null,N=typeof((S=l.stats)==null?void 0:S.screened_today)=="number"?l.stats.screened_today:p.length;let j;v?j=o.morningLast(E.length,x.length,Uo(f,d)):r?j=o.morningThesis(N,x.length,y):p.length?m===0?j=o.goalSourced(p.length):m>=p.length?j=o.goalCleared:j=o.goalDone(m,p.length):j=o.goalSourced(0);const C=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&x.length&&s({type:"chainStart",queue:x.map(T=>T.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:j}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:k+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}const id=[0,1,2,3,5,10];function sd(){var te;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:d,scopedAll:l,mode:s,doSync:h,startTour:p,flash:x,flashErr:u}=K(),[b,m]=c.useState(null),[w,k]=c.useState(!0),[f,v]=c.useState([]),E=s==="client";c.useEffect(()=>{if(!o||!i)return;let $=!0;return k(!0),(async()=>{const[pe,J]=await Promise.all([Fn(i),yo(o)]);$&&(pe&&m(pe),k(!1),v(J))})(),()=>{$=!1}},[o,i]);const[y,N]=c.useState(!1),[j,C]=c.useState(""),L=()=>{!E||y||!i||(N(!0),C(""),os(i).then($=>{if(N(!1),$.pending){C(e.refreshSlow);return}if(!$.ok){$.error&&console.warn("[republish]",$.error),C(e.refreshKo);return}const pe=$.entered??0,J=$.left??0;C($.unchanged||!pe&&!J?e.refreshSame:e.refreshDone(pe,J)),d.refresh()}))},S=(b==null?void 0:b.per_day)??null,T=((te=b==null?void 0:b.pool_order)==null?void 0:te.length)??0,O=f.filter($=>$.status==="running").length,[H,R]=c.useState(!1),M=$=>{!E||H||!o||(R(!0),wo(o,$).then(pe=>{if(R(!1),pe===null){u(e.actErr);return}m(J=>J&&{...J,per_day:pe}),x(e.alertSaved)}))},g=d.marketEstimate,q=c.useMemo(()=>l.filter($=>!He($)).length,[l]),D=g&&g>0?Math.min(100,Math.round(q/g*100)):null,Q=$=>$.toLocaleString(a==="en"?"en-US":"fr-FR"),z=b==null?void 0:b.offre,P=z&&z.rythme>0&&z.file>0?z.jours_restants:null,I=(i||"P").split(/\s+/).map($=>$[0]).join("").slice(0,2).toUpperCase(),U=(()=>{const $=Date.parse(d.generatedAt||"");if(Number.isNaN($))return"";const pe=new Date($),J=le=>String(le).padStart(2,"0");return`${J(pe.getDate())}/${J(pe.getMonth()+1)} à ${J(pe.getHours())}:${J(pe.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?I:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),U?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(U)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||y,onClick:L,children:y?"⏳":"📰"}),(y||!!j)&&t.jsxs("span",{className:"repubst",children:[y?e.refreshRun:j,!y&&t.jsx("button",{type:"button",onClick:()=>C(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:h,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:p,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:$=>n({type:"filters",patch:{search:$.target.value}})})]})]}),t.jsxs("div",{className:"idmain",children:[t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),D!==null&&g?t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:D+"%"}})}),t.jsx("b",{children:Q(q)})]}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(q,g)}})]}):t.jsx("span",{className:"ev",children:t.jsx("b",{children:Q(q)})}),z&&t.jsxs("span",{className:"eeta",children:[z.libelle," · ",z.delai,P!=null?` · ${e.identEtaDays(P)}`:S===0?` · ${e.qEtaPaused}`:""]}),S!==null&&t.jsx("span",{className:"ev covrb erate",role:"group","aria-label":e.covRate,onClick:$=>$.stopPropagation(),children:id.map($=>t.jsx("button",{type:"button",className:S===$?"on":"",disabled:!E||H,title:$===0?e.identPauseTitle:e.covRateNow($),onClick:()=>M($),children:$===0?"⏸":$},$))})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),S!==null&&t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:S})," ",e.identPerDay]}),S===0&&t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),O>0&&t.jsxs("span",{className:"ev",children:["⏳ ",O]}),t.jsx("span",{className:"ego",children:w?e.identPendingWait:e.identPending(T)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:$=>{$.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]})]})]})}class Rt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*ld(e){for(const a of e)yield*a}function Ho(e){return Array.from(ld(e))}var qe=1e-6,Se=Math.PI,ot=Se/2,Lr=Se/4,st=Se*2,yt=180/Se,et=Se/180,Re=Math.abs,dd=Math.atan,ia=Math.atan2,Ie=Math.cos,Pe=Math.sin,pd=Math.sign||function(e){return e>0?1:e<0?-1:0},Dt=Math.sqrt;function cd(e){return e>1?0:e<-1?Se:Math.acos(e)}function sa(e){return e>1?ot:e<-1?-ot:Math.asin(e)}function it(){}function Ma(e,a){e&&Rr.hasOwnProperty(e.type)&&Rr[e.type](e,a)}var Fr={Feature:function(e,a){Ma(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ma(r[n].geometry,a)}},Rr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){hn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)hn(r[n],a,0)},Polygon:function(e,a){Or(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Or(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ma(r[n],a)}};function hn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Or(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)hn(e[r],a,1);a.polygonEnd()}function _t(e,a){e&&Fr.hasOwnProperty(e.type)?Fr[e.type](e,a):Ma(e,a)}function gn(e){return[ia(e[1],e[0]),sa(e[2])]}function Ut(e){var a=e[0],r=e[1],n=Ie(r);return[n*Ie(a),n*Pe(a),Pe(r)]}function xa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Da(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function en(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ba(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function xn(e){var a=Dt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function bn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function vn(e,a){return Re(e)>Se&&(e-=Math.round(e/st)*st),[e,a]}vn.invert=vn;function ud(e,a,r){return(e%=st)?a||r?bn(Dr(e),Ir(a,r)):Dr(e):a||r?Ir(a,r):vn}function Mr(e){return function(a,r){return a+=e,Re(a)>Se&&(a-=Math.round(a/st)*st),[a,r]}}function Dr(e){var a=Mr(e);return a.invert=Mr(-e),a}function Ir(e,a){var r=Ie(e),n=Pe(e),o=Ie(a),i=Pe(a);function d(l,s){var h=Ie(s),p=Ie(l)*h,x=Pe(l)*h,u=Pe(s),b=u*r+p*n;return[ia(x*o-b*i,p*r-u*n),sa(b*o+x*i)]}return d.invert=function(l,s){var h=Ie(s),p=Ie(l)*h,x=Pe(l)*h,u=Pe(s),b=u*o-x*i;return[ia(x*o+u*i,p*r+b*n),sa(b*r-p*n)]},d}function md(e,a,r,n,o,i){if(r){var d=Ie(a),l=Pe(a),s=n*r;o==null?(o=a+n*st,i=a-s/2):(o=Pr(d,o),i=Pr(d,i),(n>0?o<i:o>i)&&(o+=n*st));for(var h,p=o;n>0?p>i:p<i;p-=s)h=gn([d,-l*Ie(p),-l*Pe(p)]),e.point(h[0],h[1])}}function Pr(e,a){a=Ut(a),a[0]-=e,xn(a);var r=cd(-a[1]);return((-a[2]<0?-r:r)+st-qe)%st}function Vo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:it,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Sa(e,a){return Re(e[0]-a[0])<qe&&Re(e[1]-a[1])<qe}function va(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Wo(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(m){if(!((w=m.length-1)<=0)){var w,k=m[0],f=m[w],v;if(Sa(k,f)){if(!k[2]&&!f[2]){for(o.lineStart(),l=0;l<w;++l)o.point((k=m[l])[0],k[1]);o.lineEnd();return}f[0]+=2*qe}i.push(v=new va(k,m,null,!0)),d.push(v.o=new va(k,null,v,!1)),i.push(v=new va(f,m,null,!1)),d.push(v.o=new va(f,null,v,!0))}}),!!i.length){for(d.sort(a),_r(i),_r(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var h=i[0],p,x;;){for(var u=h,b=!0;u.v;)if((u=u.n)===h)return;p=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,s=p.length;l<s;++l)o.point((x=p[l])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(p=u.p.z,l=p.length-1;l>=0;--l)o.point((x=p[l])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,p=u.z,b=!b}while(!u.v);o.lineEnd()}}}function _r(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function tn(e){return Re(e[0])<=Se?e[0]:pd(e[0])*((Re(e[0])+Se)%st-Se)}function fd(e,a){var r=tn(a),n=a[1],o=Pe(n),i=[Pe(r),-Ie(r),0],d=0,l=0,s=new Rt;o===1?n=ot+qe:o===-1&&(n=-ot-qe);for(var h=0,p=e.length;h<p;++h)if(u=(x=e[h]).length)for(var x,u,b=x[u-1],m=tn(b),w=b[1]/2+Lr,k=Pe(w),f=Ie(w),v=0;v<u;++v,m=y,k=j,f=C,b=E){var E=x[v],y=tn(E),N=E[1]/2+Lr,j=Pe(N),C=Ie(N),L=y-m,S=L>=0?1:-1,T=S*L,O=T>Se,H=k*j;if(s.add(ia(H*S*Pe(T),f*C+H*Ie(T))),d+=O?L+S*st:L,O^m>=r^y>=r){var R=Da(Ut(b),Ut(E));xn(R);var M=Da(i,R);xn(M);var g=(O^L>=0?-1:1)*sa(M[2]);(n>g||n===g&&(R[0]||R[1]))&&(l+=O^L>=0?1:-1)}}return(d<-qe||d<qe&&s<-1e-12)^l&1}function Go(e,a,r,n){return function(o){var i=a(o),d=Vo(),l=a(d),s=!1,h,p,x,u={point:b,lineStart:w,lineEnd:k,polygonStart:function(){u.point=f,u.lineStart=v,u.lineEnd=E,p=[],h=[]},polygonEnd:function(){u.point=b,u.lineStart=w,u.lineEnd=k,p=Ho(p);var y=fd(h,n);p.length?(s||(o.polygonStart(),s=!0),Wo(p,gd,y,r,o)):y&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),p=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(y,N){e(y,N)&&o.point(y,N)}function m(y,N){i.point(y,N)}function w(){u.point=m,i.lineStart()}function k(){u.point=b,i.lineEnd()}function f(y,N){x.push([y,N]),l.point(y,N)}function v(){l.lineStart(),x=[]}function E(){f(x[0][0],x[0][1]),l.lineEnd();var y=l.clean(),N=d.result(),j,C=N.length,L,S,T;if(x.pop(),h.push(x),x=null,!!C){if(y&1){if(S=N[0],(L=S.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),j=0;j<L;++j)o.point((T=S[j])[0],T[1]);o.lineEnd()}return}C>1&&y&2&&N.push(N.pop().concat(N.shift())),p.push(N.filter(hd))}}return u}}function hd(e){return e.length>1}function gd(e,a){return((e=e.x)[0]<0?e[1]-ot-qe:ot-e[1])-((a=a.x)[0]<0?a[1]-ot-qe:ot-a[1])}const Br=Go(function(){return!0},xd,vd,[-Se,-ot]);function xd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?Se:-Se,s=Re(i-a);Re(s-Se)<qe?(e.point(a,r=(r+d)/2>0?ot:-ot),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=Se&&(Re(a-n)<qe&&(a-=n*qe),Re(i-l)<qe&&(i-=l*qe),r=bd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function bd(e,a,r,n){var o,i,d=Pe(e-r);return Re(d)>qe?dd((Pe(a)*(i=Ie(n))*Pe(r)-Pe(n)*(o=Ie(a))*Pe(e))/(o*i*d)):(a+n)/2}function vd(e,a,r,n){var o;if(e==null)o=r*ot,n.point(-Se,o),n.point(0,o),n.point(Se,o),n.point(Se,0),n.point(Se,-o),n.point(0,-o),n.point(-Se,-o),n.point(-Se,0),n.point(-Se,o);else if(Re(e[0]-a[0])>qe){var i=e[0]<a[0]?Se:-Se;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function yd(e){var a=Ie(e),r=2*et,n=a>0,o=Re(a)>qe;function i(p,x,u,b){md(b,e,r,u,p,x)}function d(p,x){return Ie(p)*Ie(x)>a}function l(p){var x,u,b,m,w;return{lineStart:function(){m=b=!1,w=1},point:function(k,f){var v=[k,f],E,y=d(k,f),N=n?y?0:h(k,f):y?h(k+(k<0?Se:-Se),f):0;if(!x&&(m=b=y)&&p.lineStart(),y!==b&&(E=s(x,v),(!E||Sa(x,E)||Sa(v,E))&&(v[2]=1)),y!==b)w=0,y?(p.lineStart(),E=s(v,x),p.point(E[0],E[1])):(E=s(x,v),p.point(E[0],E[1],2),p.lineEnd()),x=E;else if(o&&x&&n^y){var j;!(N&u)&&(j=s(v,x,!0))&&(w=0,n?(p.lineStart(),p.point(j[0][0],j[0][1]),p.point(j[1][0],j[1][1]),p.lineEnd()):(p.point(j[1][0],j[1][1]),p.lineEnd(),p.lineStart(),p.point(j[0][0],j[0][1],3)))}y&&(!x||!Sa(x,v))&&p.point(v[0],v[1]),x=v,b=y,u=N},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return w|(m&&b)<<1}}}function s(p,x,u){var b=Ut(p),m=Ut(x),w=[1,0,0],k=Da(b,m),f=xa(k,k),v=k[0],E=f-v*v;if(!E)return!u&&p;var y=a*f/E,N=-a*v/E,j=Da(w,k),C=ba(w,y),L=ba(k,N);en(C,L);var S=j,T=xa(C,S),O=xa(S,S),H=T*T-O*(xa(C,C)-1);if(!(H<0)){var R=Dt(H),M=ba(S,(-T-R)/O);if(en(M,C),M=gn(M),!u)return M;var g=p[0],q=x[0],D=p[1],Q=x[1],z;q<g&&(z=g,g=q,q=z);var P=q-g,I=Re(P-Se)<qe,U=I||P<qe;if(!I&&Q<D&&(z=D,D=Q,Q=z),U?I?D+Q>0^M[1]<(Re(M[0]-g)<qe?D:Q):D<=M[1]&&M[1]<=Q:P>Se^(g<=M[0]&&M[0]<=q)){var te=ba(S,(-T+R)/O);return en(te,C),[M,gn(te)]}}}function h(p,x){var u=n?e:Se-e,b=0;return p<-u?b|=1:p>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return Go(d,l,i,n?[0,-e]:[-Se,e-Se])}function wd(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],h=a[1],p=0,x=1,u=s-d,b=h-l,m;if(m=r-d,!(!u&&m>0)){if(m/=u,u<0){if(m<p)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>p&&(p=m)}if(m=o-d,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>p&&(p=m)}else if(u>0){if(m<p)return;m<x&&(x=m)}if(m=n-l,!(!b&&m>0)){if(m/=b,b<0){if(m<p)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>p&&(p=m)}if(m=i-l,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>p&&(p=m)}else if(b>0){if(m<p)return;m<x&&(x=m)}return p>0&&(e[0]=d+p*u,e[1]=l+p*b),x<1&&(a[0]=d+x*u,a[1]=l+x*b),!0}}}}}var Xt=1e9,ya=-Xt;function kd(e,a,r,n){function o(h,p){return e<=h&&h<=r&&a<=p&&p<=n}function i(h,p,x,u){var b=0,m=0;if(h==null||(b=d(h,x))!==(m=d(p,x))||s(h,p)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(p[0],p[1])}function d(h,p){return Re(h[0]-e)<qe?p>0?0:3:Re(h[0]-r)<qe?p>0?2:1:Re(h[1]-a)<qe?p>0?1:0:p>0?3:2}function l(h,p){return s(h.x,p.x)}function s(h,p){var x=d(h,1),u=d(p,1);return x!==u?x-u:x===0?p[1]-h[1]:x===1?h[0]-p[0]:x===2?h[1]-p[1]:p[0]-h[0]}return function(h){var p=h,x=Vo(),u,b,m,w,k,f,v,E,y,N,j,C={point:L,lineStart:H,lineEnd:R,polygonStart:T,polygonEnd:O};function L(g,q){o(g,q)&&p.point(g,q)}function S(){for(var g=0,q=0,D=b.length;q<D;++q)for(var Q=b[q],z=1,P=Q.length,I=Q[0],U,te,$=I[0],pe=I[1];z<P;++z)U=$,te=pe,I=Q[z],$=I[0],pe=I[1],te<=n?pe>n&&($-U)*(n-te)>(pe-te)*(e-U)&&++g:pe<=n&&($-U)*(n-te)<(pe-te)*(e-U)&&--g;return g}function T(){p=x,u=[],b=[],j=!0}function O(){var g=S(),q=j&&g,D=(u=Ho(u)).length;(q||D)&&(h.polygonStart(),q&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),D&&Wo(u,l,g,i,h),h.polygonEnd()),p=h,u=b=m=null}function H(){C.point=M,b&&b.push(m=[]),N=!0,y=!1,v=E=NaN}function R(){u&&(M(w,k),f&&y&&x.rejoin(),u.push(x.result())),C.point=L,y&&p.lineEnd()}function M(g,q){var D=o(g,q);if(b&&m.push([g,q]),N)w=g,k=q,f=D,N=!1,D&&(p.lineStart(),p.point(g,q));else if(D&&y)p.point(g,q);else{var Q=[v=Math.max(ya,Math.min(Xt,v)),E=Math.max(ya,Math.min(Xt,E))],z=[g=Math.max(ya,Math.min(Xt,g)),q=Math.max(ya,Math.min(Xt,q))];wd(Q,z,e,a,r,n)?(y||(p.lineStart(),p.point(Q[0],Q[1])),p.point(z[0],z[1]),D||p.lineEnd(),j=!1):D&&(p.lineStart(),p.point(g,q),j=!1)}v=g,E=q,y=D}return C}}const yn=e=>e;var an=new Rt,wn=new Rt,Yo,Qo,kn,En,kt={point:it,lineStart:it,lineEnd:it,polygonStart:function(){kt.lineStart=Ed,kt.lineEnd=Nd},polygonEnd:function(){kt.lineStart=kt.lineEnd=kt.point=it,an.add(Re(wn)),wn=new Rt},result:function(){var e=an/2;return an=new Rt,e}};function Ed(){kt.point=jd}function jd(e,a){kt.point=Ko,Yo=kn=e,Qo=En=a}function Ko(e,a){wn.add(En*e-kn*a),kn=e,En=a}function Nd(){Ko(Yo,Qo)}var Ht=1/0,Ia=Ht,la=-Ht,Pa=la,_a={point:Sd,lineStart:it,lineEnd:it,polygonStart:it,polygonEnd:it,result:function(){var e=[[Ht,Ia],[la,Pa]];return la=Pa=-(Ia=Ht=1/0),e}};function Sd(e,a){e<Ht&&(Ht=e),e>la&&(la=e),a<Ia&&(Ia=a),a>Pa&&(Pa=a)}var jn=0,Nn=0,Zt=0,Ba=0,$a=0,Bt=0,Sn=0,Cn=0,ea=0,Jo,Xo,mt,ft,rt={point:Ot,lineStart:$r,lineEnd:Ur,polygonStart:function(){rt.lineStart=Ad,rt.lineEnd=qd},polygonEnd:function(){rt.point=Ot,rt.lineStart=$r,rt.lineEnd=Ur},result:function(){var e=ea?[Sn/ea,Cn/ea]:Bt?[Ba/Bt,$a/Bt]:Zt?[jn/Zt,Nn/Zt]:[NaN,NaN];return jn=Nn=Zt=Ba=$a=Bt=Sn=Cn=ea=0,e}};function Ot(e,a){jn+=e,Nn+=a,++Zt}function $r(){rt.point=Cd}function Cd(e,a){rt.point=zd,Ot(mt=e,ft=a)}function zd(e,a){var r=e-mt,n=a-ft,o=Dt(r*r+n*n);Ba+=o*(mt+e)/2,$a+=o*(ft+a)/2,Bt+=o,Ot(mt=e,ft=a)}function Ur(){rt.point=Ot}function Ad(){rt.point=Td}function qd(){Zo(Jo,Xo)}function Td(e,a){rt.point=Zo,Ot(Jo=mt=e,Xo=ft=a)}function Zo(e,a){var r=e-mt,n=a-ft,o=Dt(r*r+n*n);Ba+=o*(mt+e)/2,$a+=o*(ft+a)/2,Bt+=o,o=ft*e-mt*a,Sn+=o*(mt+e),Cn+=o*(ft+a),ea+=o*3,Ot(mt=e,ft=a)}function ei(e){this._context=e}ei.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,st);break}}},result:it};var zn=new Rt,nn,ti,ai,ta,aa,da={point:it,lineStart:function(){da.point=Ld},lineEnd:function(){nn&&ni(ti,ai),da.point=it},polygonStart:function(){nn=!0},polygonEnd:function(){nn=null},result:function(){var e=+zn;return zn=new Rt,e}};function Ld(e,a){da.point=ni,ti=ta=e,ai=aa=a}function ni(e,a){ta-=e,aa-=a,zn.add(Dt(ta*ta+aa*aa)),ta=e,aa=a}let Hr,Ua,Vr,Wr;class Gr{constructor(a){this._append=a==null?ri:Fd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Vr||this._append!==Ua){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Vr=n,Ua=this._append,Wr=this._,this._=o}this._+=Wr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ri(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Fd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ri;if(a!==Hr){const r=10**a;Hr=a,Ua=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ua}function Rd(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),_t(l,o(i))),i.result()}return d.area=function(l){return _t(l,o(kt)),kt.result()},d.measure=function(l){return _t(l,o(da)),da.result()},d.bounds=function(l){return _t(l,o(_a)),_a.result()},d.centroid=function(l){return _t(l,o(rt)),rt.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,yn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new Gr(r)):new ei(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new Gr(r)),d},d.projection(e).digits(r).context(a)}function _n(e){return function(a){var r=new An;for(var n in e)r[n]=e[n];return r.stream=a,r}}function An(){}An.prototype={constructor:An,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Bn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),_t(r,e.stream(_a)),a(_a.result()),n!=null&&e.clipExtent(n),e}function oi(e,a,r){return Bn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Od(e,a,r){return oi(e,[[0,0],a],r)}function Md(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Dd(e,a,r){return Bn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var Yr=16,Id=Ie(30*et);function Qr(e,a){return+a?_d(e,a):Pd(e)}function Pd(e){return _n({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function _d(e,a){function r(n,o,i,d,l,s,h,p,x,u,b,m,w,k){var f=h-n,v=p-o,E=f*f+v*v;if(E>4*a&&w--){var y=d+u,N=l+b,j=s+m,C=Dt(y*y+N*N+j*j),L=sa(j/=C),S=Re(Re(j)-1)<qe||Re(i-x)<qe?(i+x)/2:ia(N,y),T=e(S,L),O=T[0],H=T[1],R=O-n,M=H-o,g=v*R-f*M;(g*g/E>a||Re((f*R+v*M)/E-.5)>.3||d*u+l*b+s*m<Id)&&(r(n,o,i,d,l,s,O,H,S,y/=C,N/=C,j,w,k),k.point(O,H),r(O,H,S,y,N,j,h,p,x,u,b,m,w,k))}}return function(n){var o,i,d,l,s,h,p,x,u,b,m,w,k={point:f,lineStart:v,lineEnd:y,polygonStart:function(){n.polygonStart(),k.lineStart=N},polygonEnd:function(){n.polygonEnd(),k.lineStart=v}};function f(L,S){L=e(L,S),n.point(L[0],L[1])}function v(){x=NaN,k.point=E,n.lineStart()}function E(L,S){var T=Ut([L,S]),O=e(L,S);r(x,u,p,b,m,w,x=O[0],u=O[1],p=L,b=T[0],m=T[1],w=T[2],Yr,n),n.point(x,u)}function y(){k.point=f,n.lineEnd()}function N(){v(),k.point=j,k.lineEnd=C}function j(L,S){E(o=L,S),i=x,d=u,l=b,s=m,h=w,k.point=E}function C(){r(x,u,p,b,m,w,i,d,o,l,s,h,Yr,n),k.lineEnd=y,y()}return k}}var Bd=_n({point:function(e,a){this.stream.point(e*et,a*et)}});function $d(e){return _n({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ud(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function Kr(e,a,r,n,o,i){if(!i)return Ud(e,a,r,n,o);var d=Ie(i),l=Pe(i),s=d*e,h=l*e,p=d/e,x=l/e,u=(l*r-d*a)/e,b=(l*a+d*r)/e;function m(w,k){return w*=n,k*=o,[s*w-h*k+a,r-h*w-s*k]}return m.invert=function(w,k){return[n*(p*w-x*k+u),o*(b-x*w-p*k)]},m}function Hd(e){return Vd(function(){return e})()}function Vd(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,h=0,p,x=0,u=1,b=1,m=null,w=Br,k=null,f,v,E,y=yn,N=.5,j,C,L,S,T;function O(g){return L(g[0]*et,g[1]*et)}function H(g){return g=L.invert(g[0],g[1]),g&&[g[0]*yt,g[1]*yt]}O.stream=function(g){return S&&T===g?S:S=Bd($d(p)(w(j(y(T=g)))))},O.preclip=function(g){return arguments.length?(w=g,m=void 0,M()):w},O.postclip=function(g){return arguments.length?(y=g,k=f=v=E=null,M()):y},O.clipAngle=function(g){return arguments.length?(w=+g?yd(m=g*et):(m=null,Br),M()):m*yt},O.clipExtent=function(g){return arguments.length?(y=g==null?(k=f=v=E=null,yn):kd(k=+g[0][0],f=+g[0][1],v=+g[1][0],E=+g[1][1]),M()):k==null?null:[[k,f],[v,E]]},O.scale=function(g){return arguments.length?(r=+g,R()):r},O.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],R()):[n,o]},O.center=function(g){return arguments.length?(i=g[0]%360*et,d=g[1]%360*et,R()):[i*yt,d*yt]},O.rotate=function(g){return arguments.length?(l=g[0]%360*et,s=g[1]%360*et,h=g.length>2?g[2]%360*et:0,R()):[l*yt,s*yt,h*yt]},O.angle=function(g){return arguments.length?(x=g%360*et,R()):x*yt},O.reflectX=function(g){return arguments.length?(u=g?-1:1,R()):u<0},O.reflectY=function(g){return arguments.length?(b=g?-1:1,R()):b<0},O.precision=function(g){return arguments.length?(j=Qr(C,N=g*g),M()):Dt(N)},O.fitExtent=function(g,q){return oi(O,g,q)},O.fitSize=function(g,q){return Od(O,g,q)},O.fitWidth=function(g,q){return Md(O,g,q)},O.fitHeight=function(g,q){return Dd(O,g,q)};function R(){var g=Kr(r,0,0,u,b,x).apply(null,a(i,d)),q=Kr(r,n-g[0],o-g[1],u,b,x);return p=ud(l,s,h),C=bn(a,q),L=bn(p,C),j=Qr(C,N),M()}function M(){return S=T=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&H,R()}}function ii(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}ii.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Re(o)>qe&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Wd(){return Hd(ii).scale(175.295)}function Gd(e){return e}function Yd(e){if(e==null)return Gd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var h=2,p=l.length,x=new Array(p);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+d;h<p;)x[h]=l[h],++h;return x}}function Qd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Kd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Jr(e,r)})}:Jr(e,a)}function Jr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Jd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Jd(e,a){var r=Yd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var u=n[p<0?~p:p],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));p<0&&Qd(x,m)}function i(p){return r(p)}function d(p){for(var x=[],u=0,b=p.length;u<b;++u)o(p[u],x);return x.length<2&&x.push(x[0]),x}function l(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function s(p){return p.map(l)}function h(p){var x=p.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(h)};case"Point":u=i(p.coordinates);break;case"MultiPoint":u=p.coordinates.map(i);break;case"LineString":u=d(p.arcs);break;case"MultiLineString":u=p.arcs.map(d);break;case"Polygon":u=s(p.arcs);break;case"MultiPolygon":u=p.arcs.map(s);break;default:return null}return{type:x,coordinates:u}}return h(a)}const si={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Xd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Zd(e,a,r){const n=si[e];if(!n||!n.length)return-1;const o=Xd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let wa=null;function ep(){return wa||(wa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Kd(r,n),i=Wd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Rd(i),l=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",u=d(p)||"";return u?{i2:is(x)||null,n:x,d:u}:null}).filter(p=>!!p);if(!l.length)return null;const s={};for(const[p,x]of Object.entries(ss)){const u=i(x);u&&(s[p]={x:u[0],y:u[1]})}const h={};for(const[p,x]of Object.entries(si)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(h[p]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:h}}catch{return null}})(),wa)}function tp(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return ep().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const ap="8 40 984 210",np={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Xr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function Zr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function rp(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var h;if(!o)return;const s=(h=e.current)==null?void 0:h.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function eo({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function op(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:h,dossiers:p,source:x}=K(),u=h.loading&&!p.length,b=c.useRef(null),m=c.useRef(null),w=tp(e.continent==="monde"),k=e.continent==="monde"?w:Rn.find(g=>g.key===e.continent)||null,f=rp(b,e.continent+":"+e.mapFolded+":"+!!k),[v,E]=c.useState(new Map),[y,N]=c.useState(null);c.useEffect(()=>{const g=b.current;if(!g)return;const q=new Map;g.querySelectorAll("path[data-i2]").forEach(D=>{const Q=D.dataset.i2;if(Q)try{const z=D.getBBox();z.width>0&&q.set(Q,{x:z.x,y:z.y,w:z.width,h:z.height})}catch{}}),E(q)},[e.continent,f,k]);const j=c.useMemo(()=>r.filter(g=>g.cc),[r]),C=c.useMemo(()=>{const g=new Map;return j.forEach(q=>g.set(q.cc,(g.get(q.cc)||0)+1)),g},[j]),L=e.continent==="monde"&&w?w.anchors:null,S=e.continent==="monde"&&w?w.metros:null,T=c.useMemo(()=>j.map(g=>{const q=Zr(g.name||g.id||""),D=Zr((g.id||g.name||"")+"·y");if(L&&g.cc){const U=S?S[g.cc]:void 0;if(U&&U.length){const $=Zd(g.cc,g.city,q);if($>=0&&U[$])return{d:g,x:U[$].x+(q-.5)*5,y:U[$].y+(D-.5)*5}}const te=L[g.cc];if(te)return{d:g,x:te.x+(q-.5)*10,y:te.y+(D-.5)*10}}const Q=g.cc?v.get(g.cc):void 0;if(!Q)return null;const z=np[`${e.continent}:${g.cc||""}`];if(z)return{d:g,x:Q.x+Q.w*(z.fx+(q-.5)*z.sx),y:Q.y+Q.h*(z.fy+(D-.5)*z.sy)};const P=(q-.5)*Math.min(Q.w*.55,60),I=(D-.5)*Math.min(Q.h*.55,60);return{d:g,x:Q.x+Q.w/2+P,y:Q.y+Q.h/2+I}}).filter(g=>!!g),[j,v,L,S,e.continent]),O=g=>f>0?g/f:g,H=c.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:Xr[g],fr:s.plabels[g],en:s.plabels[g],n:r.filter(q=>q.kind==="target"&&Le(q)===g).length})).filter(g=>g.n>0):ar.map((g,q)=>({...g,n:r.filter(D=>nr(D)===q).length})),[r,n,s.plabels]),R=i?d.get(i):null,M=R?T.find(g=>g.d.id===R.id):null;return k?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(eo,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?ap:k.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?k.fr:k.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:k.countries.map((g,q)=>t.jsx("g",{className:"ct"+(g.i2&&C.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},q))}),t.jsx("g",{children:T.map(g=>{const q=ar[nr(g.d)],D=!!$e(g.d),Q=g.d.kind==="target",z=n&&Q?Xr[Le(g.d)]:q.c,P=!n&&Ge(g.d);return t.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var te,$;const I=(te=m.current)==null?void 0:te.getBoundingClientRect(),U=($=b.current)==null?void 0:$.createSVGPoint();if(U&&b.current&&I){U.x=g.x,U.y=g.y;const pe=U.matrixTransform(b.current.getScreenCTM());N({x:pe.x-I.left,y:pe.y-I.top,label:g.d.name+" · "+(Gt(g.d.cc,l)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var te;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const I=(te=b.current)==null?void 0:te.createSVGPoint();let U=null;if(I&&b.current){I.x=g.x,I.y=g.y;const $=I.matrixTransform(b.current.getScreenCTM());U={x:$.x,y:$.y}}a({type:"popup",id:g.d.id,anchor:U})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:O(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:O(q.px),fill:z,stroke:D?"#E5484D":"#ffffff",strokeWidth:O(D?2.2:1.3)})]},g.d.id||g.d.name)})}),M&&t.jsx("circle",{className:"ring on",cx:M.x,cy:M.y,r:O(13),fill:"none",stroke:"#16233A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:H.map((g,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),l==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},q))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(eo,{msgs:s.loadMsgs})})}function ip(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function li({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=K(),s=a.filters,[h,p]=c.useState(!1),[x,u]=c.useState(!1),b=c.useRef(null),m=c.useRef(null),w=c.useMemo(()=>a.continent==="monde"?n:n.filter(M=>M.continent===a.continent),[n,a.continent]),k=M=>w.filter(g=>M!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Ra(g,s,i,M==="country"?void 0:M)),f=M=>!i||M.kind!=="op",v=c.useMemo(()=>{const M=k("win").filter(f),g=q=>M.filter(D=>(D.date?Math.max(0,Math.floor((Date.now()-Date.parse(D.date))/864e5)):9999)<=q).length;return[g(0),g(7),g(30),M.length]},[w,s,i]),E=c.useMemo(()=>s.day?k("win").filter(f).filter(M=>(M.date||"").slice(0,10)===s.day).length:0,[w,s,i]),y=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,N=y+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!h&&!x)return;const M=q=>{var Q,z;const D=q.target;h&&!((Q=b.current)!=null&&Q.contains(D))&&p(!1),x&&!((z=m.current)!=null&&z.contains(D))&&u(!1)},g=q=>{q.key==="Escape"&&(p(!1),u(!1))};return document.addEventListener("mousedown",M),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("keydown",g)}},[h,x]);const j=(M,g,q,D="fbtn")=>t.jsxs("button",{type:"button",className:D,"aria-expanded":a.openFacet===M,onClick:()=>r({type:"openFacet",facet:M}),children:[t.jsx("span",{className:"fl",children:g}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},M),C=["1","7","30","all"],L=Math.max(0,C.indexOf(s.win||"all")),S=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(ip(s.day,l))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(M=>!M),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:v[L]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((M,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===M,onClick:()=>{r({type:"filters",patch:{win:M}}),u(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:v[g]})]},M))})]}):t.jsx("div",{className:"seg",children:C.map((M,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===M,onClick:()=>r({type:"filters",patch:{win:M}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:v[g]})]},M))}),T=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:M=>r({type:"filters",patch:{search:M.target.value}})})]}),O=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):j("sec",o.fSector,s.sector.length),(n.some(M=>!!M.market)||s.market.length>0)&&j("mar",o.fMarket,s.market.length),j("pay",o.fCountry,s.country.length),j("det",o.fEngine,s.engine.length),j("sta",o.fStage,s.stage.length),i&&j("crib",o.fVerdict,s.crible.length),i&&j("ang","Angle",s.angle.length),i&&j("mem","Mémo",s.memoLevel.length)]}),H=(M=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),M&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),R=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(y?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{p(M=>!M),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),y>0&&t.jsx("span",{className:"n",children:y}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:O})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:S}),t.jsxs("div",{className:"fstrip-b",children:[T,R,H(!1)]})]}),a.openFacet&&t.jsx(to,{poolFor:k})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[S,T,O,t.jsx("span",{className:"fgrow"}),H()]}),a.openFacet&&t.jsx(to,{poolFor:k})]})}function to({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=K(),l=a.filters,s=a.openFacet,{title:h,cols:p,options:x}=c.useMemo(()=>{if(s==="sig"){const k=e("signal").filter(E=>$e(E)),f=new Map;k.forEach(E=>{const y=E.engine||"";f.set(y,(f.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:k.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...un([...f.keys()],o).map(E=>({v:E,label:Ft(E)+" "+tt(E,o),n:f.get(E)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="crib"){const k=e("crible").filter(v=>!i||xo(v,a.ptab,d.favIds)),f=new Map;return k.forEach(v=>{const E=bo(v);E&&E!=="NEW"&&f.set(E,(f.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((v,E)=>(rr[v[0]]??9)-(rr[E[0]]??9)||E[1]-v[1]).map(([v,E])=>({v,label:'<span class="fdot" style="background:'+(ls[v]||"#94A3B8")+'"></span>'+v,n:E,html:!0,on:l.crible.includes(v)}))}}if(s==="sec"){const k=e("sector"),f=new Map;return k.forEach(v=>{v.sector&&f.set(v.sector,(f.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:v,n:E,html:!1,on:l.sector.includes(v)}))}}if(s==="mar"){const k=e("market"),f=new Map;return k.forEach(v=>{v.market&&f.set(v.market,(f.get(v.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...f.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:v,n:E,html:!1,on:l.market.includes(v)}))}}if(s==="pay"){const k=e("country"),f=new Map;return k.forEach(v=>{v.cc&&f.set(v.cc,(f.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:Gt(v,o)||v,n:E,html:!1,on:l.country.includes(v)}))}}if(s==="det"){const k=e("engine"),f=new Map;return k.forEach(v=>{v.engine&&f.set(v.engine,(f.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:un([...f.keys()],o).map(v=>({v,label:Ft(v)+" "+tt(v,o)+' <span style="color:var(--dim);font-size:10px">· '+ds(ps(v),o)+"</span>",n:f.get(v)||0,html:!0,on:l.engine.includes(v)}))}}if(s==="ang"){const k=e("angle"),f=new Map;return k.forEach(v=>{v.angle&&f.set(v.angle,(f.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((v,E)=>E[1]-v[1]).map(([v,E])=>({v,label:v.replace(/[_-]+/g," "),n:E,html:!1,on:l.angle.includes(v)}))}}if(s==="mem"){const k=e("memoLevel"),f=new Map;k.forEach(E=>{if(E.kind==="target"){const y=Ln(E);f.set(y,(f.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:v[E],n:f.get(E)||0,html:!1,on:l.memoLevel.includes(E)}))}}const m=e("stage"),w=new Map;return m.forEach(k=>{k.stage&&w.set(k.stage,(w.get(k.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k,n:f,html:!1,on:l.stage.includes(k)}))}},[s,a,o]),u=m=>{if(s==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const k=l.signalEngines.includes(m)?l.signalEngines.filter(f=>f!==m):[...l.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:k}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:m})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:h}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function di({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=K(),s=c.useMemo(()=>{const b={};return r.forEach(m=>{Ra(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[h,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!h)return;const b=w=>{var k;(k=x.current)!=null&&k.contains(w.target)||p(!1)},m=w=>{w.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[h]);const u=b=>{const m=Rn.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:or.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[or.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]})]})}function qn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function pi(e){return"atl2:evalq:"+(e||"anon")}function sp(e,a){const r=pi(e),n=qn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function lp(){const{t:e,data:a,dossiers:r}=K(),n=a.session.token||"",o=pi(n),[i,d]=c.useState(()=>qn(o)),l=c.useRef(!1),[s,h]=c.useState(!1);c.useEffect(()=>{try{const z=i.slice(0,30).map(({descBusy:P,evalBusy:I,...U})=>U);localStorage.setItem(o,JSON.stringify(z)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[i,o]),c.useEffect(()=>{const z=()=>{if(l.current)return;const P=qn(o);d(I=>JSON.stringify(I.map(({descBusy:U,evalBusy:te,...$})=>$))===JSON.stringify(P)?I:P)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[o]);const[p,x]=c.useState([]),[u,b]=c.useState(""),[m,w]=c.useState(!1),[k,f]=c.useState(!1),[v,E]=c.useState(""),y=c.useCallback((z,P)=>d(I=>I.map((U,te)=>te===z?{...U,...P}:U)),[]),N=c.useCallback((z,P)=>{const I=P.trim();I&&(y(z,{name:I,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),On(I).then(U=>{const te=U.candidates||[];U.website?y(z,{site:U.website,status:"ready"}):te.length===1?y(z,{site:te[0].url,status:"ready"}):te.length>1?y(z,{status:"pick",candidates:te.slice(0,6)}):y(z,{status:"ready"})}).catch(()=>y(z,{status:"ready"})))},[y]),j=c.useCallback((z,P,I)=>{y(z,{descBusy:!0}),ko(n,P,I).then(U=>{if(U.quota){h(!0),y(z,{descBusy:!1,descDone:!0});return}const te=U.blocs||{},$=(te.synthese||te.value_prop||te.produit||te.modele||"").trim();y(z,{descBusy:!1,descDone:!0,desc:$})}).catch(()=>y(z,{descBusy:!1,descDone:!0}))},[y,n]);c.useEffect(()=>{const z=i.findIndex(I=>I.auto&&I.name.trim()&&I.status==="");if(z>=0){N(z,i[z].name);return}if(s)return;const P=i.findIndex(I=>I.status==="ready"&&I.site&&!I.descDone&&!I.descBusy);P>=0&&j(P,i[P].name,i[P].site)},[i,N,j,s]);const[C,L]=c.useState(!1),S=c.useCallback(async(z,P)=>{y(z,{evalBusy:!0});const I=await Eo(n,(P.site||P.name).trim(),"atelier2");return I.verdict==="quota"?(y(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:I.reason||"",remaining:0}})),!1):(y(z,{evalBusy:!1,status:I.verdict==="kept"?"kept":"out",reason:I.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:I.company||P.name,verdict:I.verdict,reason:I.reason||"",remaining:I.remaining??null}})),!0)},[y,n]),T=async()=>{if(C)return;const z=i.map((P,I)=>({r:P,i:I})).filter(({r:P})=>P.name.trim()&&P.status!=="kept"&&P.status!=="out"&&P.status!=="resolving");if(z.length){L(!0);for(const{r:P,i:I}of z)if(!await S(I,P))break;L(!1)}},O=c.useMemo(()=>{const z=new Set,P=[];return i.filter(I=>I.status==="kept").forEach(I=>{const U=I.name.trim().toLowerCase();U&&!z.has(U)&&(z.add(U),P.push(I.name.trim()))}),r.filter(I=>Le(I)>=1&&Le(I)<=4&&(I.website||I.domain)).forEach(I=>{const U=(I.name||"").trim().toLowerCase();U&&!z.has(U)&&(z.add(U),P.push((I.name||"").trim()))}),P},[i,r]),H=c.useMemo(()=>{const z=new Set;return r.forEach(P=>{const I=(P.name||"").trim().toLowerCase();I&&z.add(I)}),i.forEach(P=>{const I=P.name.trim().toLowerCase();I&&z.add(I)}),z},[r,i]),R=async()=>{if(u||!O.length)return;f(!1);const z=[];for(const P of O.slice(0,2)){b(P);const I=await jo(n,P);if(I){if(I.verdict==="quota"){w(!0);break}(I.results||[]).forEach(U=>{const te=(U.company||"").trim().toLowerCase();!te||H.has(te)||z.some($=>$.name.toLowerCase()===te)||z.push({name:(U.company||"").trim(),verdict:U.verdict||"",reason:U.reason,from:P})})}}b(""),f(!0),x(P=>[...z,...P].slice(0,24))},M=async(z,P)=>{if(u)return;f(!1),b(z==="thesis"?e.pxThesis:P);const I=await cs(n,z,P,6);if(b(""),f(!0),!I)return;if(I.verdict==="quota"){w(!0);return}const U=[];(I.results||[]).forEach(te=>{const $=(te.company||"").trim().toLowerCase();!$||H.has($)||U.some(pe=>pe.name.toLowerCase()===$)||U.push({name:(te.company||"").trim(),verdict:te.verdict||"",reason:te.reason,from:z==="thesis"?e.pxThesis:P})}),x(te=>[...U,...te].slice(0,24))},g=()=>{const z=v.trim();z.length<3||M(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},q=z=>{d(P=>[...P,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),x(P=>P.filter(I=>I.name!==z.name))},D=i.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,Q=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((z,P)=>t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:I=>{const U=I.target.value.split(`
`).map(te=>te.trim()).filter(Boolean);U.length>1?d(te=>{const $=[...te];return $.splice(P,1,...U.map(pe=>({name:pe,site:"",status:"",auto:!0}))),$.slice(0,30)}):y(P,{name:I.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&N(P,z.name)},onKeyDown:I=>{I.key==="Enter"&&N(P,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:I=>{const U=I.target.value;U&&y(P,{site:U,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(z.candidates||[]).map(I=>t.jsx("option",{value:I.url,children:(I.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},I.url))]}),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?s?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!Q(z)||C,onClick:()=>{S(P,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>d(I=>I.filter((U,te)=>te!==P)),children:"×"})]},P)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>d(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{M("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:v,placeholder:e.pxPlace,onChange:z=>E(z.target.value),onKeyDown:z=>{z.key==="Enter"&&g()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||v.trim().length<3,onClick:g,children:e.pxGoFree}),!!O.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{R()},children:u&&u!==e.pxThesis&&u!==v?e.sgBusy(u):e.sgGo}),!!O.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(O[0],O.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),k&&!p.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),p.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>q(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),i.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>d(z=>z.filter(P=>P.status!=="kept"&&P.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(C?" loading":""),style:{justifyContent:"center"},disabled:C||!D,onClick:()=>{T()},children:[t.jsx("span",{className:"fill"}),C?e.eqRunning:e.eqGo(D)]})]})]})]})}const dp={deals:"ma-deals",news:"veille"};function ao(e){return(e.url||e.title||"").trim()}function pp(e){const a=(e.title||"").replace(/\s+/g," ").trim();if(!a)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const r=/^(.{2,72}?)[:–—|]/.exec(a);return r?r[1].trim():(a.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||a).slice(0,72).trim()}function cp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i}=K(),[d,l]=c.useState(null),[s,h]=c.useState({deals:[],news:[]}),[p,x]=c.useState({deals:!1,news:!1}),[u,b]=c.useState(null),[m,w]=c.useState(""),k=c.useRef(!1),f=c.useCallback(async S=>{if(!o)return[];if(p[S])return s[S];b(S),w("");const T=await us(dp[S],o,n);return b(null),!T.ok&&T.error?(w(T.error),[]):(h(O=>({...O,[S]:T.items})),x(O=>({...O,[S]:!0})),T.items)},[o,n,p,s]);c.useEffect(()=>{d&&f(d)},[d,f]);const v=c.useCallback(S=>s[S].map(ao).filter(Boolean),[s]),E=c.useMemo(()=>{var O,H;if(!o)return{deals:[],news:[]};const S={deals:v("deals"),news:v("news")},T=Lo("feed:"+o,S);return{deals:((O=T.deals)==null?void 0:O.noms)||[],news:((H=T.news)==null?void 0:H.noms)||[]}},[o,v]),y=c.useRef(null);c.useEffect(()=>{y.current&&!d&&o&&Fo("feed:"+o,{deals:v("deals"),news:v("news")}),y.current=d},[d,o,v]);const N=S=>{const T=S.map(pp).filter(Boolean);T.length&&(a(T),l(null))},j=(S,T)=>{const O=(S.url||"").trim();if(T==="news"&&O&&/^https?:\/\//i.test(O)){window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:O}})),l(null);return}N([S])},C=async S=>{if(d===S){l(null);return}if(k.current)return;k.current=!0;const T=await f(S);if(k.current=!1,S==="deals"&&T.length){N(T);return}l(S)},L=S=>{const T=s[S],O=new Set(E[S].map(H=>H.toLowerCase()));return t.jsxs("div",{className:"dfpane"+(d===S?" on":""),hidden:d!==S,children:[t.jsx("p",{className:"dfh",children:S==="deals"?r.feedDealsH:r.feedNewsH}),u===S&&t.jsx("p",{className:"dfload",children:n==="en"?"Loading…":"Chargement…"}),d===S&&!!m&&t.jsx("p",{className:"dferr",children:m}),p[S]&&!T.length&&!u&&t.jsx("p",{className:"dfempty",children:S==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!T.length&&t.jsx("ul",{className:"dflist",children:T.map((H,R)=>{const M=ao(H),g=O.has(M.toLowerCase()),q=(H.url||"").trim();return t.jsxs("li",{className:g?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:H.title||q}),t.jsx("span",{children:[H.source,H.sector_fr,(H.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[q&&t.jsx("a",{href:q,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>j(H,S),children:S==="deals"?r.feedToEval:r.feedToExtract})]})]},M||R)})})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(S=>{const T=E[S].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(S==="deals"?"ddeals":"dnews")+(d===S?" on":""),onClick:()=>{C(S)},children:[S==="deals"?r.feedDeals:r.feedNews,T>0&&t.jsx("em",{title:r.feedHint,children:r.feedNew(T)})]},S)}),d&&L(d)]})}function ci(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function up(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function no({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=K();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function ui({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=K(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(no,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(no,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function mp({card:e,onEvaluate:a,onAddAll:r}){var l,s,h;const{t:n}=K(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ci(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx(ui,{card:e,onEvaluate:a,onAddAll:r}),(((s=e.prospective)==null?void 0:s.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function fp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function hp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=K(),l=o,[s,h]=c.useState(null),[p,x]=c.useState(null),[u,b]=c.useState(null),[m,w]=c.useState(!1);c.useEffect(()=>{let f=!0;return(async()=>{const v=await No({email:d,cbToken:l});f&&h(v)})(),()=>{f=!1}},[d,l,n]);const k=f=>{x(f),b(null),w(!0),(async()=>{const v=await ms(f.id);b(v),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>k(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[fp(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(mp,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Ca=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function na(e){return/^https?:\/\//i.test((e||"").trim())}function pt(e){const a=(e||"").trim();return a?na(a)?a:Ca.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function gp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function xp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:h,caps:p,data:x,canWrite:u,source:b,dossiers:m,doAnalyse:w,liveMemos:k,pipe:f}=K(),v=r==="client",E=c.useMemo(()=>n||(b!=="default"?fs():""),[n,b]),[y,N]=c.useState(""),[j,C]=c.useState(!1),[L,S]=c.useState(""),[T,O]=c.useState(""),[H,R]=c.useState(""),[M,g]=c.useState(!1),[q,D]=c.useState(!1),[Q,z]=c.useState([]);c.useEffect(()=>{const _=ae=>{const Z=ae.detail;Z&&z(fe=>[Z,...fe].slice(0,8))};return window.addEventListener("ppmap:evalcard",_),()=>window.removeEventListener("ppmap:evalcard",_)},[]);const[P,I]=c.useState(!1),[U,te]=c.useState(!1),[$,pe]=c.useState(!1),J=c.useRef(!1),[le,ge]=c.useState(""),[ue,ye]=c.useState(""),[be,je]=c.useState(!1),[Fe,ne]=c.useState(!1),[Ne,ve]=c.useState(0),[oe,B]=c.useState(""),[W,ee]=c.useState(null),[de,ce]=c.useState(null),[re,ie]=c.useState(!1),[me,we]=c.useState(null),[Ce,Ee]=c.useState(0),ke=c.useRef(!1),ht=y.trim()?Ca.test(y.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const _=new URLSearchParams(window.location.search),ae=(_.get("rs")||"").trim(),Z=(_.get("rstext")||"").trim();ae&&/^https?:\/\//i.test(ae)&&ge(ae),Z&&ye(Z),(ae&&/^https?:\/\//i.test(ae)||Z)&&I(!0)},[]),c.useEffect(()=>{const _=ae=>{const Z=ae.detail||{},fe=String(Z.url||"").trim(),ze=String(Z.text||"").trim();fe&&/^https?:\/\//i.test(fe)&&ge(fe),ze&&ye(ze),(fe&&/^https?:\/\//i.test(fe)||ze)&&(I(!0),N(""),S(""),je(!0),window.setTimeout(()=>je(!1),900))};return window.addEventListener("ppmap:research",_),()=>window.removeEventListener("ppmap:research",_)},[]),c.useEffect(()=>{const _=ae=>{const Z=ae.detail||{},fe=String(Z.name||"").trim();if(!fe)return;I(!1),N(fe),S(fe);const ze=pt(String(Z.website||Z.domain||""));O(ze),R(pt(String(Z.url||""))),g(!ze),C(!0),window.setTimeout(()=>C(!1),900)};return window.addEventListener("ppmap:prefill",_),()=>window.removeEventListener("ppmap:prefill",_)},[]),c.useEffect(()=>{const _=(L||"").trim();if(!_||P||T){(T||!_||P)&&g(!1);return}const ae=Ue(_),Z=m.find(Oe=>Ue(Oe.name)===ae)||m.find(Oe=>{const Te=Ue(Oe.name);return Te.length>=3&&(ae.includes(Te)||Te.includes(ae))}),fe=pt((Z==null?void 0:Z.website)||"")||pt((Z==null?void 0:Z.domain)||""),ze=pt((Z==null?void 0:Z.url)||"");if(ze&&R(Oe=>Oe||ze),fe){O(fe),g(!1);return}let xe=!0;return g(!0),On(_).then(Oe=>{var nt,vt;if(!xe)return;const Te=pt(Oe.website||"")||pt(((vt=(nt=Oe.candidates)==null?void 0:nt[0])==null?void 0:vt.url)||"");Te&&O(Te)}).catch(()=>{}).finally(()=>{xe&&g(!1)}),()=>{xe=!1}},[L,P,T,m]),c.useEffect(()=>{const _=ae=>{var fe;const Z=String(((fe=ae.detail)==null?void 0:fe.url)||"").trim();na(Z)&&window.open(Z,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",_),()=>window.removeEventListener("ppmap:view",_)},[]),c.useEffect(()=>{if(J.current===P)return;J.current=P,pe(!0);const _=window.setTimeout(()=>pe(!1),560);return()=>window.clearTimeout(_)},[P]),c.useEffect(()=>{if(typeof window>"u")return;const _=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ae=document.querySelector(".atl2.ops, .atl2.cibles");if(!_||!ae)return;const Z=()=>ae.style.setProperty("--demand-h",`${_.offsetHeight}px`);Z();const fe=new ResizeObserver(Z);return fe.observe(_),()=>fe.disconnect()},[b,j,be,q,P,$,M]),c.useEffect(()=>{if(!u&&!E){we(null);return}let _=!0;return(async()=>{const ae=await No({email:o,cbToken:E});_&&we(ae.length)})(),()=>{_=!1}},[u,E,o,Ce]);const gt=Q.length?Q:h,Me=x.credits,lt=c.useCallback(_=>{sp(n,_)&&(D(!1),l({type:"ptab",tab:0}),requestAnimationFrame(()=>{const ae=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!ae)return;const Z=window.scrollY+ae.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,Z),behavior:"smooth"})}))},[n,l]);c.useEffect(()=>{if(!Fe)return;ve(0);const _=window.setInterval(()=>ve(ae=>ae+1),1e3);return()=>window.clearInterval(_)},[Fe]);const xt=c.useMemo(()=>{const _=y.trim().toLowerCase();return!_||!f?null:m.find(ae=>Ue(ae.name)===_&&Le(ae)===1)||null},[y,m,f]),At=()=>{const _=y.trim();if(_){if(xt){w(xt);return}i(null,_),v&&N("")}},at=async()=>{var Z,fe,ze;if(ke.current)return;const _=le.trim().replace(/\s+/g,""),ae=ue.trim();if(!_&&!ae){B(e.rsNeed);return}if(!v&&!E){i(null,_||ae.slice(0,80));return}ke.current=!0,B(""),ee(null),ce(null),ne(!0);try{const xe=await gs({url:_,text:ae,email:o,cbToken:E});if(ne(!1),!xe||xe.status!=="success"){B((xe==null?void 0:xe.message)||"Erreur");return}ee(xe),I(!1),lt((((Z=xe.prospective)==null?void 0:Z.companies_to_evaluate)||[]).map(Te=>(Te==null?void 0:Te.name)||"")),ce({state:"pending"});const Oe=await xs(xe,{email:o,cbToken:E});ce(Oe.ok?{state:"ok",scopeLabel:((fe=Oe.summary)==null?void 0:fe.scope_label)||"",scope:((ze=Oe.summary)==null?void 0:ze.scope)||""}:{state:"fail",msg:Oe.error||""}),Oe.ok&&Ee(Te=>Te+1)}finally{ke.current=!1,ne(!1)}},qt=[W==null?void 0:W.industry,...(W==null?void 0:W.market_tags)||[],W==null?void 0:W.author].map(_=>(_||"").trim()).filter(Boolean),bt=(de==null?void 0:de.state)==="pending",It=de&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):de.state==="ok"?t.jsx("span",{className:"rslink ok",children:de.scope&&de.scope!=="public"?e.rsSavedIn(de.scopeLabel||de.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:de.msg,children:e.rsSaveFail})),Pt=up(W).length,Be=P,Xe=(L||y).trim(),Ye=m.find(_=>Ue(_.name)===Ue(Xe)),ct=pt(y)||T||pt((Ye==null?void 0:Ye.website)||"")||pt((Ye==null?void 0:Ye.domain)||""),F=H||pt((Ye==null?void 0:Ye.url)||""),G=xt?e.actAnalyse:Xe?e.evalGoOn(Xe.length>22?Xe.slice(0,21)+"…":Xe):e.evalGo,X=Fe?`${hs(le.trim())==="youtube"&&le.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Ne)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Be?" rs-mode":"")+(L&&y.trim()===L||j||be?" pair":"")+(j||be||$?" echo":"")+($?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Be?be:j)||$?" flash":"")+((Be?le.trim():Ca.test(y.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Be?le:y,placeholder:Be?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Be?600:200,spellCheck:Be?!1:void 0,inputMode:Be?"url":void 0,onChange:_=>{if(Be){ge(_.target.value);return}N(_.target.value),L&&_.target.value.trim()!==L&&(S(""),O(""),R(""),g(!1))},onKeyDown:_=>{_.key==="Enter"&&(Be?at():At())}}),t.jsx("span",{className:"detect"+(Be?" off":"")+(Ca.test(y.trim())?" url":""),children:ht})]}),t.jsx("span",{className:"dacts",children:Be?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Fe?" loading":""),disabled:Fe||bt||!le.trim()&&!ue.trim(),onClick:()=>{at()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:X})]}),t.jsxs("a",{className:"viewbtn"+(na(le)?"":" off"),href:na(le)?le.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:_=>{na(le)||_.preventDefault()},children:[t.jsx(gp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(xt?" analyse":"")+(s?" loading":""),disabled:s,onClick:At,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:G})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(M?" searching":ct?"":" off"),href:ct||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":M||void 0,title:M?e.viewSiteBusyHint:e.viewSiteHint,onClick:_=>{ct||_.preventDefault()},children:[M&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),M?e.viewSiteBusy:e.viewSite,!M&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(F?"":" off"),href:F||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:_=>{F||_.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),p.showCredits&&Me&&t.jsxs("button",{type:"button",className:"credits"+(Me.total_available<=0&&!Me.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Me.unlimited?"∞":Me.total_available}),!Me.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Me.daily_grant+Me.purchased]}),Me.total_available<=0&&!Me.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),D(!1),requestAnimationFrame(()=>{const _=document.querySelector(".atl2.cibles .desk-list");if(!_)return;const ae=window.scrollY+_.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,ae),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(P?" on":""),onClick:()=>I(!P),children:e.rsOpen}),me!==null&&me>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>ie(!re),children:e.rsArchOpen(me)}),p.pipe&&!!n&&t.jsx(cp,{pageToken:E,onAddNames:lt})]}),re&&t.jsx(hp,{bump:Ce,cbToken:E,onClose:()=>ie(!1),onEvaluate:_=>i(null,_),onAddAll:lt}),t.jsx("div",{className:"rsp slim"+(P?" on":" off"),"aria-hidden":!P,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:P?void 0:-1,onClick:()=>te(_=>!_),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:U?"▴":"▾"})]}),U&&t.jsx("textarea",{className:"rstext",value:ue,placeholder:e.rsTextPh,tabIndex:P?void 0:-1,onChange:_=>ye(_.target.value)})]})}),oe&&t.jsx("div",{className:"rserr",children:oe}),W&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:W.title}),W.source_url&&t.jsx("a",{href:W.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ee(null),ce(null)},children:"×"})]}),W.market&&t.jsx("p",{className:"rsmk",children:W.market}),qt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),qt.map(_=>t.jsx("span",{children:_},_))]}),t.jsxs("div",{className:"rsbody",children:[W.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${W.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ci(W.summary_md||"").map((_,ae)=>t.jsx("p",{children:_},ae))})]}),t.jsx(ui,{card:W,onEvaluate:_=>i(null,_),onAddAll:lt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Pt)}),It]})]}),gt.slice(0,1).map((_,ae)=>{const Z=_.verdict==="kept",fe=_.verdict==="quota",ze=_.verdict==="unresolved",xe=Z?"var(--brand)":fe?"var(--bolt)":ze?"var(--blue)":"var(--red)",Oe=Z?"var(--brand-l)":fe?"#FFF3D6":ze?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":xe,"--bgc":Oe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:Z?"✓ "+e.kept:fe?"⏳":ze?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),_.name&&t.jsx("span",{className:"rn",children:_.name}),t.jsx("span",{className:"rr",children:_.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",_.reason]}):null}),!!(_.candidates&&_.candidates.length)&&t.jsx("span",{className:"sitepick",children:_.candidates.map(Te=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Te.url.startsWith("http")?Te.url:`https://${Te.url}`,target:"_blank",rel:"nofollow noopener",children:[(Te.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Te.url,_.name),children:e.evalPickGo})]},Te.url))}),!fe&&!ze&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:Z?1:5});const Te=(_.name||"").trim().toLowerCase();window.setTimeout(()=>{const nt=[...document.querySelectorAll(".atl2 .list .row")].find(vt=>{var Ze;return(((Ze=vt.querySelector(".rnm"))==null?void 0:Ze.textContent)||"").trim().toLowerCase().includes(Te)});nt&&(nt.scrollIntoView({behavior:"smooth",block:"center"}),nt.classList.add("flashrow"),window.setTimeout(()=>nt.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(Z?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),v&&(d.kept+d.dropped>0||gt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function bp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function vp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=K(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",bp(i.summary||"")].filter(Boolean).join(`
...
`;function Up(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function Hp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:s,doDecide:h,doPromote:p,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:w,evalBusy:k}=K(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const v=$e(f),E=Le(f),y=zt(f),N=ua(f),j=f.kind==="target",C=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Wt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:$p}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Up(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(jt(f.date)),tt(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[f.cc]}),children:(Gt(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Yt(f.amountEur,o)})]}),i.pipe&&j&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ft(f.engine)," ",t.jsx("b",{children:tt(f.engine,o)})," — ",vs(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),v?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ct,{o:f,lg:!0})," ",t.jsx(Va,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Co(v,o))," · ",n.win7(zo(v,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ma,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&j&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&j&&t.jsx(Un,{o:f})]}),t.jsx($n,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{s(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(f,!1),a({type:"popup",id:null})},children:n.actNo}),$t(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:k,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Vp(){const{lang:e,token:a,dossiers:r,caps:n}=K(),o=a||"home",{names:i,verdicts:d}=c.useMemo(()=>{const s=[],h={};return r.forEach(p=>{p.kind!=="target"||!p.name||(s.push(p.name),h[p.name]=ys(p)||"")}),{names:s,verdicts:h}},[r]);return{diff:c.useMemo(()=>i.length?ws(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function Wp(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:l}=K(),[s,h]=c.useState(!1),[p,x]=c.useState(!1),u=c.useRef(null);c.useEffect(()=>{if(!s)return;const E=y=>{u.current&&!u.current.contains(y.target)&&h(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[s]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!d.length,w=c.useRef({});c.useEffect(()=>{w.current={...r}},[r]);const k=E=>{const y=w.current[E],N=y!==void 0?r[E]-y:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${ra[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E],E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[E],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},E)},f=(E,y,N)=>t.jsxs("button",{type:"button",className:"off"+(y?" view":""),"data-off":E,style:{"--c":`var(${ra[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:N}),t.jsx("span",{className:"n",children:r[E]})]},E),v=(E,y,N,j=!1)=>t.jsx("button",{type:"button",className:"tool",title:y,disabled:j,onClick:N,children:E},y);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(k)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[v("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(p?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:l.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":s,title:n.toolSort,onClick:()=>h(E=>!E),children:"⇅"}),s&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,y])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[y,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),v("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),v("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Gp(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,mode:l,data:s}=K(),h=c.useRef(null),[p,x]=c.useState(60);c.useEffect(()=>{let C=0;const L=()=>{var R;const S=h.current;if(!S)return;const T=(R=S.parentElement)==null?void 0:R.querySelector('.funnel [aria-selected="true"]');if(!T)return;const O=T.getBoundingClientRect(),H=S.getBoundingClientRect();x(Math.max(20,Math.min(O.left+O.width/2-H.left,H.width-30)))};return C=requestAnimationFrame(L),window.addEventListener("resize",L),()=>{cancelAnimationFrame(C),window.removeEventListener("resize",L)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const C=i.filter(T=>T.kind==="target"&&Le(T)===3),L=C.filter(T=>mn(T)==="auto").length,S=C.filter(T=>mn(T)==="cd").length;b=r.tutoPending(L,S,C.length)}const m=(()=>{var C;if(l!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(L=>L.id)})};if(u===1){const L=i.filter(S=>S.kind==="target"&&Le(S)===1&&!d.has(S.id)).slice(0,10);if(L.length){const S=String(((C=s.credits)==null?void 0:C.plan)||"").toLowerCase(),T=S==="enterprise"||S==="entreprise";return{label:r.tuto[1].a,locked:!T,run:()=>{T&&a({type:"chainStart",queue:L.map(O=>O.id)})}}}}return null})(),w=ks(u),k=u===1||u===2,f=u===5,v=u===7,E=u===6,y=w||f||v,N=r.plabels[u]+" · "+(o[u]??0),j=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:h,className:"tuto mini"+(y?"":" on-dark")+(k?" etape-on":"")+(f?" etape-out":"")+(v?" etape-view":"")+(E?" etape-fav":""),style:{"--bg":`var(${ra[u]})`,"--ax":p+"px","--stc":y?"var(--ink)":"#fff","--stt":y?"#fff":"var(--ink)","--tc":y?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:N}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),m&&t.jsx("button",{type:"button",className:"tprim"+(m.locked?" lock":""),disabled:!!m.locked,title:m.locked?r.analyseLockHint:void 0,onClick:m.run,children:m.locked?"🔒 "+r.analyseLock:m.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:j})]})}const pn=600,St=62,co="atl2:fstats";function Yp(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=K(),[d,l]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(co)==="on"}catch{return!1}}),s=r.stats,h=c.useMemo(()=>((s==null?void 0:s.by_day)||[]).slice(-30),[s]),p=(s==null?void 0:s.since)||"";if(!n.showFunnel||!s||typeof s.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=h.reduce((N,j)=>Math.max(N,j.s||0),0),m=h.length?pn/h.length:0,w=Math.max(4,m-4),k=h.length>=5&&b>0,f=r.marketEstimate||0,v=x(new Date().toISOString().slice(0,10)),E=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof s.kept=="number"?[[s.kept,e.funKept]]:[],...typeof s.analyzed=="number"?[[s.analyzed,e.funAnalyzed]]:[],...typeof s.shown=="number"?[[s.shown,e.funShown]]:[]],y=[];return typeof s.screened_window=="number"&&p&&y.push({cle:"fenetre",periode:e.funPerWindow(x(p),v),etapes:[[s.screened_window,e.funScreened("","")]]}),typeof s.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:E(s.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[y.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([j,C],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(j)}),t.jsx("i",{children:C})]},N.cle+C)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((s.screened||0)/f*100)))})]}),N.cle==="total"&&(s.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),N.cle===y[y.length-1].cle&&k&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const j=!d;l(j),j&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(co,j?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},N.cle)),d&&k&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${pn} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((N,j)=>{const C=(N.s||0)/b*(St-4),L=(N.m||0)/b*(St-4),S=j*m+(m-w)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===N.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}),onKeyDown:T=>{T.key!=="Enter"&&T.key!==" "||(T.preventDefault(),i({type:"filters",patch:o.filters.day===N.d?{day:"",win:"all"}:{day:N.d,win:"all"}}))},children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:S-1,y:0,width:w+2,height:St,fill:"transparent"}),t.jsx("rect",{x:S,y:St-2-C,width:w,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:St-2-L,width:w,height:L,fill:"#0E7F3F"})]},N.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:pn,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const gi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Hn({o:e,locked:a=!1}){const{t:r}=K(),n=ua(e),o=zt(e),i=Le(e),d=mn(e),l=Es(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(gi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(ed,{o:e})]})}const Vt=e=>e.length>22?e.slice(0,21)+"…":e;function ca(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function xi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .fzone:has(.stage.folded), .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .fzone:has(.stage.folded), .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Qp({on:e,rev:a}){const[r,n]=c.useState(null),[o,i]=c.useState({top:0,left:0,width:0});return c.useEffect(()=>{if(!e){n(null);return}const d=()=>{var m,w,k;const l=document.querySelector(".atl2.ops .desk-list"),s=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const h=l.getBoundingClientRect(),p=s?s.getBoundingClientRect().bottom:h.top;i({top:Math.round(p),left:Math.round(h.left),width:Math.round(h.width)});const x=[...l.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const v=f.querySelector(".grp-h");v&&v.getBoundingClientRect().bottom<=p+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((k=b.querySelector(".s"))==null?void 0:k.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Kp(e){const r=()=>{const n=xi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function uo({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=K(),[i,d]=c.useState(!1);if(c.useEffect(()=>{n||d(!1)},[n]),Ge(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const s=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(s?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}function Vn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:d,doPromote:l,doRepeche:s,doApproach:h,dispatch:p,liveMemos:x}=K(),u=m=>w=>{w.stopPropagation(),m()};if(r.lockActions){const m=u(()=>p({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const w=Le(e);return w===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Vt(e.name))})]})}):w===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):w===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):w===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):w===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):w===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Fa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ca(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(uo,{o:e})});const b=Le(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(uo,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ta,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const w=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:w,onClick:u(()=>i(e)),children:w?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>d(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>d(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>h(e)),children:m?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:u(()=>p({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:u(()=>p({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>p({type:"focus",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>p({type:"focus",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Jp({o:e}){const{t:a,doThumb:r,thumbOf:n}=K(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Xp({o:e}){const{lang:a}=K();return $e(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ct,{o:e}),t.jsx(Va,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ft(e.engine||"")," ",tt(e.engine||"",a)]})})}function Zp({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:l}){const{dispatch:s,caps:h,markRow:p,markedId:x,favIds:u,toggleFav:b,t:m}=K(),w=Le(e),k=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=f<=0?0:f<=7?1:f<=30?2:3,E=h.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:k[v],y=u.has(e.id),N=j=>{if(a)return;if(d){d(e.id);return}if(h.pipe||e.kind==="op"){n();return}const C=j.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(c.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(h.pipe&&e.kind==="target"?" p"+w:"")+(y?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>p(e.id),onMouseLeave:()=>p(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(Ei,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),$e(e)&&t.jsx(Ct,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[h.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:y?1:.35,padding:0,marginRight:4},onClick:j=>{j.stopPropagation(),b(e)},children:y?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Je(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(j=>j&&j!==e.name)||""]}),h.pipe&&!h.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:j=>j.stopPropagation(),children:[e.website&&t.jsx("a",{href:pa(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowSite,title:m.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:pa(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":m.rowLi,title:m.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":m.rowMail,title:m.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":m.rowTel,title:m.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:j=>{j.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Vt(e.acquirer)]}),He(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(ec,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Xp,{o:e}),h.pipe&&t.jsx(Hn,{o:e,locked:a}),h.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Vn,{o:e}),h.showThumbs&&t.jsx(Jp,{o:e})]}),r&&!a&&!d&&t.jsx(nc,{o:e})]})}function ec({o:e}){const{lang:a,caps:r}=K();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Yt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function tc({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=K(),d=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),s=Yt(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=Ge(e),x=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),s&&t.jsx("span",{className:"oc-amt",children:s}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Je(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),ca(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Vt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ma,{spec:e.card})})]})}function ac({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=K();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[tt(e.engine||"",r),i?` · ${i}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Vn,{o:e})})]}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx(Un,{o:e})]})}function bi({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:s}=K(),h=c.useRef(null),p=He(e);if(c.useEffect(()=>{if(!p||!(e!=null&&e.decryptHtml))return;const g=h.current;if(!g)return;let q=!1;return cn(()=>import("./fit-DX-mzLKR.js"),[]).then(async D=>{await D.ensureEditoCss(),!(q||!g.isConnected)&&(D.beautifyEditoRows(g),D.mountCardFits(g))}),()=>{q=!0}},[p,e==null?void 0:e.decryptHtml]),!e&&!a){const g=s.find(He);if(g)return t.jsx(bi,{o:g})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!x||La(x),k=(e==null?void 0:e.engine)||"",f=He(e),v=e?Yt(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),y=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),N=s.find(He),j=((N==null?void 0:N.url)||"").trim(),C=!!u&&!!j&&(u===j||u.endsWith(j)||j.endsWith(u)),L=(g,q=!1)=>D=>{D.stopPropagation(),q&&d({type:"continent",key:"monde"}),d({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const S=()=>{x&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:x}}))},T=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},O=()=>{ca({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},H=e?Ge(e):!1,R=H&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",M=f?r.doEdito.replace(/^📖\s*/,""):k?tt(k,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[M,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(w||Fa({engine:k}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,y?t.jsx("em",{children:y}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(ma,{spec:m})}),(u&&!C&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!C&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,y?` · ${y}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),d({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[H?t.jsxs("span",{className:"verdict",style:{"--c":R?"var(--brand)":"var(--red)"},children:[R?"✓":"✗"," ",t.jsx("b",{children:R?r.kept:r.dropped})]}):!w&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:g=>{g.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Vt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(w||Fa({engine:k}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&x?" ghost":""),onClick:g=>{g.stopPropagation(),O()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),S()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Vt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&x&&l.pipe&&t.jsx($n,{name:x})]})]})}function nc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=K();return!o.pipe&&e.kind==="op"?t.jsx(tc,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Un,{o:e}),t.jsx(td,{o:e}),t.jsx(nd,{o:e}),t.jsx($n,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Hn,{o:e})})]}),e.card&&t.jsx(ma,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ft(e.engine||"")," ",tt(e.engine||"",r)]}),$e(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ct,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function rc({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:s}=K();if(!d.pipe&&e.kind==="op"){const x=Yt(e.amountEur,s),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,w=!1)=>k=>{k.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ma,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ft(e.engine||"")," ",tt(e.engine||"",s)]}),$e(e)&&t.jsx(Ct,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Vn,{o:e})})]})}const h=Le(e),p=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":p},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Hn,{o:e}),$e(e)&&t.jsx(Ct,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"focus",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function oc(){const{t:e}=K(),[a,r]=c.useState(0);return c.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ic({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=K(),i=o==="en",d=p=>n.plabels[p]||"",l=[0,1,2,3,4,5,6,7].filter(p=>p!==a.ptab&&(e[p]||0)>0),s=l.includes(0)?0:l.sort((p,x)=>(e[x]||0)-(e[p]||0))[0];if(s===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[s]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:s===0?i?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:i?`${h} ${h>1?"files":"file"} in “${d(s)}”`:`${h} dossier${h>1?"s":""} dans « ${d(s)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:s}),children:[(i?"Open ":"Ouvrir ")+d(s)," →"]})]})}function sc(){var Pt,Be,Xe,Ye,ct;const e=K(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:s,lang:h,sessTally:p,data:x,dossiers:u,source:b,focusExtra:m,byId:w,token:k}=e,f=Mo(),v=c.useMemo(()=>{var X,_,ae,Z;if(!k||b==="ops")return null;const F=(((X=f==null?void 0:f.ed)==null?void 0:X.date)||(f==null?void 0:f.day)||"").slice(0,10),G=[(_=f==null?void 0:f.ed)==null?void 0:_.html,(ae=f==null?void 0:f.ed)==null?void 0:ae.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((Z=f==null?void 0:f.ed)==null?void 0:Z.date)||F,decryptHtml:G||void 0,date:F,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[k,b,h,(Pt=f==null?void 0:f.ed)==null?void 0:Pt.html,(Be=f==null?void 0:f.ed)==null?void 0:Be.acquirers_html,(Xe=f==null?void 0:f.ed)==null?void 0:Xe.date,f==null?void 0:f.day]),E=F=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Oo,[y,N]=c.useState(new Set);c.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[j,C]=c.useState(null);c.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[L,S]=c.useState(!a.mapFolded);c.useEffect(()=>{if(a.mapFolded){S(!1);return}const F=document.getElementById("atl2-stage");if(!F){S(!1);return}const G=new IntersectionObserver(([X])=>S(!!X&&X.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return G.observe(F),()=>G.disconnect()},[a.mapFolded]);const T=!a.mapFolded&&!L,O=F=>N(G=>{const X=new Set(G);return X.has(F)?X.delete(F):X.add(F),X}),H=b==="ops"||o.pipe,[R,M]=c.useState("all"),[g,q]=c.useState(!1),[D,Q]=c.useState(null),[z,P]=c.useState(!1),I=c.useRef(!0);c.useEffect(()=>{if(I.current){I.current=!1;return}M("all"),P(!1)},[a.ptab,a.continent]),c.useEffect(()=>{if(!z)return;const F=G=>{var X,_;(_=(X=G.target)==null?void 0:X.closest)!=null&&_.call(X,".atl2 .doable")||P(!1)};return document.addEventListener("click",F,!0),()=>document.removeEventListener("click",F,!0)},[z]);const U=c.useMemo(()=>{var G;const F=new Map;for(const X of _l(((G=f==null?void 0:f.ed)==null?void 0:G.html)||""))F.has(X.t)||F.set(X.t,X.html);return F},[(Ye=f==null?void 0:f.ed)==null?void 0:Ye.html]),te=c.useCallback(F=>{if(F.decryptHtml)return F.decryptHtml;if(!U.size)return;const G=(F.name||"").trim().toLowerCase();if(G.length<3)return;const X=U.get(G);if(X)return X;for(const[_,ae]of U)if(_.includes(G)||G.includes(_))return ae},[U]),{diff:$}=Vp(),[pe,J]=c.useState(!1),le=a.filters.win==="1"&&!a.filters.day,[ge,ue]=c.useState(!1),ye=c.useMemo(()=>new Set((($==null?void 0:$.added)||[]).map(F=>F.trim().toLowerCase()).filter(Boolean)),[$]),be=c.useMemo(()=>{if(!ye.size)return 0;const F={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(G=>!He(G)&&ye.has((G.name||"").trim().toLowerCase())&&oa(G,F,o.pipe)).length},[u,ye,a,o.pipe]);c.useEffect(()=>{const F=()=>{ue(!1),q(!1),M("all"),P(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",F),()=>window.removeEventListener("ppmap:tunnel",F)},[]),c.useEffect(()=>{ue(!1),q(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const je=c.useMemo(()=>{const F=l.filter(X=>!He(X)&&Je(X));let G="";for(const X of F){const _=(X.date||"").slice(0,10);_&&(!G||_<G)&&(G=_)}return{n:F.length,since:G?G.split("-").reverse().slice(0,2).join("/"):""}},[l]),Fe=je.n,ne=c.useMemo(()=>{const G=ge&&ye.size>0||a.filters.signalOnly||R!=="all"||g?l:d;let X=Dn(G,a.sort);return X=X.filter(_=>!He(_)),ge&&ye.size&&(X=X.filter(_=>ye.has((_.name||"").trim().toLowerCase()))),g||R==="explore"?X=X.filter(Je):R==="eval"?X=X.filter(_=>!Je(_)&&!_.noCo&&(_.kind==="op"||!Ge(_))):o.pipe&&(X=X.filter(_=>!Je(_))),X},[d,l,a.sort,R,ge,ye,g,o.pipe]),ve=c.useMemo(()=>o.pipe?u.filter(F=>F.kind==="target"&&!He(F)&&$e(F)&&(a.continent==="monde"||F.continent===a.continent)):ne.filter(F=>$e(F)&&!Ge(F)),[o.pipe,u,ne,a.continent]).length,oe=c.useMemo(()=>o.pipe?ne:ne.filter(F=>!Ge(F)&&!F.noCo&&!Je(F)),[ne,o.pipe]),B=b==="ops"?ne.filter(Je).length:0,W=ge?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,ee=a.filters,de=ee.sector.length+ee.market.length+ee.country.length+ee.engine.length+ee.stage.length+ee.crible.length+ee.angle.length+ee.memoLevel.length+ee.dealKind.length+(ee.signalOnly?1:0)+(ee.acquirer.trim()?1:0)+(ee.search.trim()?1:0),ce=[];if(ee.day)ce.push({k:"day",lib:n.fDay(ee.day.slice(8,10)+"/"+ee.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(ee.win&&ee.win!=="all"){const F=["1","7","30"].indexOf(ee.win);F>=0&&ce.push({k:"win",lib:n.dates[F],off:()=>r({type:"filters",patch:{win:"all"}})})}const re=F=>F.length<=2?F.join(", "):`${F.length} ${n.fSelected}`;for(const F of["sector","market","country","engine","crible"]){const G=ee[F];G&&G.length&&ce.push({k:F,lib:re(G),off:()=>r({type:"clearFacet",facet:F})})}ee.search&&ce.push({k:"search",lib:"🔍 "+ee.search,off:()=>r({type:"filters",patch:{search:""}})}),ge&&ye.size&&ce.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>ue(!1)}),ee.signalOnly&&ce.push({k:"sig",lib:"🔴 "+n.sigDock(ve||ee.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ie=(F,G,X="",_=!1)=>t.jsxs("button",{type:"button","data-s":F,className:X,"aria-sort":a.sort.key===F?a.sort.dir===1?"ascending":"descending":"none",style:_?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:F}),children:[G,t.jsx("span",{className:"ar",children:a.sort.key===F&&a.sort.dir===1?"▴":"▾"})]},F),me=c.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const F=new Map;ne.forEach(_=>{const ae=_.engine||"?";F.has(ae)||F.set(ae,[]),F.get(ae).push(_)});const G={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},X=un([...F.keys()],h);return[...F.entries()].sort((_,ae)=>{const Z=G[_[0]]??10+X.indexOf(_[0]),fe=G[ae[0]]??10+X.indexOf(ae[0]);return Z-fe})},[ne,o.pipe,a.groupBy,h]),we=me?me.filter(([F])=>Na.has(F)).length:0,Ce=(()=>{var G;return((G=(me?me.flatMap(([,X])=>X):ne)[0])==null?void 0:G.id)??null})(),Ee=c.useRef(!1),ke=c.useMemo(()=>u.find(He)||v,[u,v]),[ht,gt]=c.useState(!1);c.useEffect(()=>{const F=()=>{Ee.current=!0,ue(!1)};return window.addEventListener("ppmap:reveal",F),window.addEventListener("ppmap:focus",F),()=>{window.removeEventListener("ppmap:reveal",F),window.removeEventListener("ppmap:focus",F)}},[]),c.useEffect(()=>{const F=()=>{ke&&r({type:"focus",id:ke.id})};return window.addEventListener("ppmap:edito",F),()=>window.removeEventListener("ppmap:edito",F)},[ke,r]),c.useEffect(()=>{if(!a.focusId)return;Q(a.focusId);const F=window.setTimeout(()=>Q(null),900);return()=>window.clearTimeout(F)},[a.focusId]),c.useEffect(()=>{if(H&&!(a.focusId&&(ne.some(F=>F.id===a.focusId)||u.some(F=>F.id===a.focusId)||a.focusId===(ke==null?void 0:ke.id)))&&!m){if(ke){r({type:"focus",id:ke.id});return}Ce&&r({type:"focus",id:Ce})}},[H,a.focusId,ne,Ce,m,r,u,b,ke]),c.useEffect(()=>{if(!H||!a.focusId||ke&&a.focusId===ke.id||ne.some(G=>G.id===a.focusId))return;const F=u.find(G=>G.id===a.focusId);if(F){if(Ee.current){F.kind==="op"?M(Je(F)?"explore":"eval"):R!=="all"&&M("all");return}R!=="all"&&Ce&&r({type:"focus",id:Ce})}},[H,a.focusId,R,ne,u,Ce,r,ke]),c.useEffect(()=>{if(!H||!a.focusId||!Ee.current)return;const F=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!F){const ae=ne.findIndex(Z=>Z.id===a.focusId);if(ae>=0){const Z=me?"":"pt"+a.ptab;if(Z){const fe=a.shown[Z]||E();ae>=fe&&r({type:"more",group:Z,by:ae-fe+8})}}return}Ee.current=!1;const G=xi(),X=F.getBoundingClientRect();X.top>=G-2&&X.bottom<=window.innerHeight-4||Kp(F)},[H,a.focusId,a.ptab,ne,a.shown,me,r]),c.useEffect(()=>{if(typeof window>"u")return;const F=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),G=document.querySelector(".atl2.ops, .atl2.cibles");if(!F||!G)return;const X=document.querySelector(".atl2 .fzone"),_=()=>{G.style.setProperty("--listhead-h",`${F.offsetHeight}px`);const Z=!!(X&&X.querySelector(".stage.folded"));G.style.setProperty("--fold-h",Z&&X?`${X.offsetHeight}px`:"0px")};_();const ae=new ResizeObserver(_);return ae.observe(F),X&&ae.observe(X),()=>ae.disconnect()},[T,a.dens,a.mapFolded]);const Me=c.useMemo(()=>{if(!H||!a.focusId)return null;if(v&&a.focusId===v.id)return v;const F=ne.find(X=>X.id===a.focusId)||u.find(X=>X.id===a.focusId)||null;if(!F)return null;const G=te(F);return G&&G!==F.decryptHtml?{...F,decryptHtml:G}:F},[H,a.focusId,ne,u,te,v]),lt=o.lockRowsAfter;let xt=0;const At=(F,G)=>{let X=a.shown[G]||E();return F.length-X<=4&&(X=F.length),F.slice(0,X).map(Z=>{const fe=lt!==null&&xt>=lt;xt++;const ze=te(Z),xe=ze&&ze!==Z.decryptHtml?{...Z,decryptHtml:ze}:Z,Oe=!H&&a.dens!=="maxi"&&(a.dens==="deplie"||(j?j==="open":!!ze)),Te=y.has(Z.id)?!Oe:Oe,nt=H?vt=>{Ee.current=!0,r({type:"focus",id:vt});const Ze=w.get(vt);Ze&&(Je(Ze)?ca(Ze):Ze.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ze.name,url:Ze.url||"",website:Ze.website||"",domain:Ze.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(rc,{o:xe,locked:fe,selected:H&&a.focusId===Z.id,onSelect:nt},Z.id):t.jsx(Zp,{o:xe,locked:fe,open:Te,onToggle:()=>O(Z.id),selected:H&&a.focusId===Z.id,echo:D===Z.id,fresh:ye.has((Z.name||"").trim().toLowerCase()),onSelect:nt},Z.id)})},at="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ne.length?"":" list-empty"),qt=t.jsxs(t.Fragment,{children:[me?me.map(([F,G])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ft(F)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:F==="ma"?n.grpMa:F==="fundraising"?n.grpLev:Na.has(F)&&we<=1?n.grpNews:F==="nominations"?n.grpNom:F==="media"?n.grpNewsOther:F==="recrutements"?n.grpHire:Na.has(F)?n.grpNews+" · "+tt(F,h):tt(F,h)}),t.jsx("div",{className:"s",children:n.grpCount(G.filter(X=>!Ge(X)).length,G.length)})]})]}),At(G,F)]},F)):At(ne,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(oc,{}),o.pipe&&a.ptab===0&&!g&&!ge&&R==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(lp,{}),!ne.length&&!(x.loading&&!u.length)&&(o.pipe&&R==="all"?t.jsx(ic,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(ee.win!=="all"||!!ee.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),de>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(de)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),bt=t.jsxs(t.Fragment,{children:[!ge&&!g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ne.length})," ",W]}),g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ra[a.ptab]+")"},children:ne.length})," ",n.newsWord]}),(!ge||g)&&t.jsx("span",{className:"dot",children:"·"}),T&&t.jsx(di,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[T?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ce.map(F=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:G=>{G.stopPropagation(),F.off()},children:[F.lib,t.jsx("i",{children:"×"})]},F.k)),b==="ops"&&ne.length>0&&!T&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ne.length-B," ",n.zoomPulseEval,B>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",B," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),It=t.jsxs("div",{className:"listhead"+(T?" mapoff":""),children:[T&&t.jsx("div",{className:"lh-tools",children:t.jsx(li,{compact:!0})}),o.showFunnel&&pe&&le&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(od,{}),t.jsx(Yp,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:bt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Wp,{}),t.jsx(Gp,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(le?" on":""),"aria-pressed":le,title:n.morningDockTitle,onClick:()=>{if(le){r({type:"filters",patch:{win:"all",day:""}}),J(!1);return}ue(!1),q(!1),M("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),J(!0)},children:["📊 ",n.morningDock(typeof((ct=x.stats)==null?void 0:ct.screened_today)=="number"?x.stats.screened_today:0)]}),$&&!$.firstVisit&&($.added.length>0||$.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ge?" on":""),"aria-pressed":ge,title:n.sinceSub,onClick:()=>{const F=!ge;ue(F),q(!1),J(!1),M("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(be),$!=null&&$.lastDate?` · ${n.sinceSince($.lastDate)}`:""]}),ve>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{ue(!1),q(!1),J(!1),M("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(ve)]}),o.pipe&&Fe>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(g?" on":""),"aria-pressed":g,title:n.newsDockHint,onClick:()=>{const F=!g;q(F),ue(!1),J(!1),M("all"),F&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(Fe),je.since?` · ${n.newsSince(je.since)}`:""]})]}),!o.showFunnel&&bt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([F,G])=>t.jsxs("button",{type:"button","data-d":F,"aria-pressed":a.dens===F||F==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:F}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:G})]},F))}),!H&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":j==="open",onClick:()=>{C("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":j==="closed",onClick:()=>{C("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var ze;const F={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},G=u.filter(xe=>oa(xe,F,o.pipe)&&!He(xe)),X=G.filter(xe=>!Je(xe)&&!xe.noCo&&(xe.kind==="op"||!Ge(xe))).length,_=G.filter(Je).length,ae=o.pipe?G.filter(xe=>xe.kind!=="op"&&Le(xe)===1).length:0,Z=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ae?` ${ae}`:""}`]]:[],["eval",`${n.doEval}${X?` ${X}`:""}`],["explore",`${n.doExplore}${_?` ${_}`:""}`]],fe=((ze=Z.find(([xe])=>xe===R))==null?void 0:ze[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":z,onClick:()=>P(xe=>!xe),children:[fe,t.jsx("i",{children:"▾"})]}),z&&t.jsx("div",{className:"dolist",children:Z.map(([xe,Oe])=>t.jsx("button",{type:"button","aria-pressed":R===xe,onClick:()=>{if(P(!1),xe==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}M(xe),xe!=="all"&&(ue(!1),q(!1),J(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Oe},xe))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:F=>r({type:"sort",key:F.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([F,G])=>t.jsx("option",{value:F,children:G},F))})]}),o.showChain&&t.jsxs("span",{className:"chainwrap"+(oe.length===0?" empty":""),children:[t.jsxs("button",{type:"button",className:"chain",disabled:oe.length===0,title:n.chainHint,onClick:()=>{oe.length&&r({type:"chainStart",queue:oe.map(F=>F.id)})},children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(oe.length):n.chainAll(oe.length)]}),!o.pipe&&t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!H&&It,a.dens!=="maxi"&&!H&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ie("country",n.colCountry),ie("name",n.colCompany),ie("amount",n.colAmount,"h-amt",!0),ie("stage",n.colStage,"h-stade"),ie("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ie("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ie("memo",n.colMemo)]}),o.pipe&&ie("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),H?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[It,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ie("country",n.colCountry),ie("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ie("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ie("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:at,children:qt})]}),t.jsxs("aside",{className:"readpane"+((Me?He(Me):!m&&ke)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[ke&&(()=>{const F=a.focusId===ke.id&&!ht,G=(ke.headline||ke.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":F,onClick:()=>{if(F){gt(!0);return}gt(!1),r({type:"focus",id:ke.id})},children:[t.jsx("span",{className:"eg-t",children:h==="en"?"Today’s editorial":"Édito du jour"}),G&&t.jsx("span",{className:"eg-sub",children:G}),t.jsx("span",{className:"eg-chev",children:F?h==="en"?"Collapse ▴":"Replier ▴":h==="en"?"Read ▾":"Lire ▾"})]})})(),!!(ke&&(Me?He(Me):!m))&&ht?null:v&&a.focusId===v.id?t.jsx("div",{className:"zoom",children:t.jsx(Vl,{})}):Me&&o.pipe?t.jsx(ac,{o:Me}):t.jsx(bi,{o:Me,extra:Me?null:m})]})]}):t.jsx("div",{className:at,children:qt}),(()=>{const F=me||[["pt"+a.ptab,ne]];let G=0,X=0;for(const[ae,Z]of F){X+=Z.length;let fe=a.shown[ae]||E();Z.length-fe<=4&&(fe=Z.length),G+=Math.min(Z.length,fe)}const _=X-G;return _<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>F.forEach(([ae,Z])=>r({type:"more",group:ae,by:Z.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(_,_)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(G,X)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}}),H&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Qp,{on:!!me,rev:(me||[]).map(([F,G])=>F+G.length).join("|")})]})}function mo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function lc(e,a){const r=js(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function dc(e,a){const n=[a.head.split("|").map(mo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",lc(o,a.plabels),ua(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(mo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function pc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const cc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Qe({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function Jt({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function uc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=K(),d=(e.cribleStatus||"").trim().toUpperCase()||(ua(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=zt(e),s=(a==null?void 0:a.blocs)||{},h=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdSector,v:e.sector}),t.jsx(Qe,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Qe,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Qe,{k:n.cdStage,v:e.stage}),t.jsx(Qe,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Qe,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Qe,{k:n.cdName,v:e.contactName}),t.jsx(Qe,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Qe,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Qe,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Qe,{k:n.cdAngle,v:e.angle}),t.jsx(Qe,{k:n.cdDetected,v:cc(e.date,o)})]}),!!(e.provQuery||e.provUrl||qa(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Qe,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Qe,{k:n.cdSrc,v:Tn(e.provUrl||""),href:pa(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Qe,{k:n.cdAngleSrc,v:qa(e)})]})]}),h.some(([,p])=>p)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),h.filter(([,p])=>p).map(([p,x])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:p}),t.jsx("p",{children:x})]},p))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([p,x,u])=>t.jsxs("div",{className:"dssq "+p,children:[t.jsx("b",{children:x}),t.jsx("ul",{children:u.map(b=>t.jsx("li",{children:b},b))})]},p))})]}),t.jsx(Jt,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(Jt,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function mc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:l}=K(),[s,h]=c.useState({}),[p,x]=c.useState({}),u=25,b=12,m=c.useMemo(()=>{if(l.dossierId){const f=n.find(v=>v.id===l.dossierId)||i.dossiers.find(v=>v.id===l.dossierId);return f?[f]:n.slice(0,u)}return n.slice(0,u)},[n,l.dossierId,i.dossiers]);c.useEffect(()=>{m.length&&So(r,m.map(f=>f.name)).then(h)},[r,m]),c.useEffect(()=>{const f=m.filter(y=>!!y.memoUrl).slice(0,b);if(!f.length){x({});return}let v=!1;const E={};return(async()=>{for(const y of f){if(v)return;try{const N=await hi(y.memoUrl||"");if(v)return;N&&Lp(N.comite)&&(E[y.id]=N.comite,x({...E}))}catch{}}})(),()=>{v=!0}},[m]);const w=i.stats,k=f=>f.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(m.length)}),!l.dossierId&&n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),w&&typeof w.screened=="number"&&t.jsxs("p",{children:[k(w.screened)," ",e.funScreened(""),typeof w.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",k(w.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(k(i.marketEstimate)),", ",Math.round(w.screened/i.marketEstimate*100)," %"]})]})]}),m.map(f=>t.jsx(uc,{o:f,qa:s[f.name],comite:p[f.id]},f.id)),!m.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const fc=50;function Wn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=K(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[h,p]=c.useState(""),[x,u]=c.useState(0),[b,m]=c.useState(""),[w,k]=c.useState(!1),[f,v]=c.useState(0),E=c.useRef(null),y=c.useRef(null),N=()=>{v(0),y.current&&window.clearInterval(y.current),y.current=window.setInterval(()=>v(S=>S+1),1e3)},j=()=>{y.current&&(window.clearInterval(y.current),y.current=null)};c.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),y.current&&window.clearInterval(y.current)},[]);const C=async S=>{s(!0),p(""),N();const T=await a();if(s(!1),j(),T.ok){d(T);return}if(T.busy){p(o.alertPreviewBusy);return}if(!S){p(o.alertPreviewFail);return}u(fc),j(),E.current=window.setInterval(()=>{u(O=>O>1?O-1:(E.current&&window.clearInterval(E.current),C(!1),0))},1e3)},L=async()=>{if(n||w||l)return;k(!0),m(""),N();const S=await r();k(!1),j(),m(S.ok?o.alertTestOk(S.sentTo||""):S.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||w||x>0,onClick:()=>{C(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||l,onClick:()=>{L()},children:w?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),h&&t.jsx("p",{className:"mnote warn",children:h}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Et="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ke({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=K(),l=o==="plug"?"min(720px,100%)":"min(760px,100%)";return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:l}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function hc(){const{st:e}=K();switch(e.modal){case"chain":return t.jsx(xc,{});case"space":return t.jsx(bc,{});case"alert":return t.jsx(vc,{});case"queue":return t.jsx(jc,{});case"export":return t.jsx(Nc,{});case"plug":return t.jsx(zc,{});case"approach":return t.jsx(Ac,{});case"recharge":return t.jsx(Lc,{});case"cover":return t.jsx(Rc,{});case"dossier":return t.jsx(Fc,{});case"crit":return t.jsx(Ic,{});case"tuto":return t.jsx(Pc,{});case"rdv":return t.jsx(gc,{});case"memoalert":return t.jsx(Sc,{});default:return null}}function gc(){const{dispatch:e,fund:a,t:r}=K(),n=a||r.rdvCoFallback;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:_o,children:Pn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Xs,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function xc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:s,memoQueued:h,doAnalyse:p}=K(),x=i==="client",u=e.chain.queue.map(k=>r.get(k)).filter(k=>!!k),b=e.chain.idx,m=u[b],w=b>=u.length;return Wt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Gt(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(jt(m.date))].filter(Boolean).map(k=>String(k)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:tt(m.engine,o)}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Yt(m.amountEur,o)})]}),$e(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ct,{o:m,lg:!0})," ",t.jsx(Va,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&Ge(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&Ge(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Lt(m)==="retenu"?"var(--brand)":Lt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Lt(m)==="retenu"?"✓ "+n.kept:Lt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&m&&s.pipe&&Le(m)===1&&!h.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{p(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&m&&!(x&&Ge(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var k;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(k=document.querySelector(".atl2 .demand"))==null||k.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function bc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=K(),i=o==="client",d=c.useMemo(()=>i?r.filter(x=>Ge(x)):[],[r,i]),l=c.useMemo(()=>Dn(d.filter(x=>Lt(x)==="retenu"),{key:"signal",dir:-1}),[d]),s=c.useMemo(()=>d.filter(x=>Lt(x)==="ecarte"),[d]),h=e.spaceTab==="retenu"?l:s,p=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ke,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:s.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":p},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function vc(){const{mode:e}=K();return e==="client"||e==="apercu"?t.jsx(yc,{}):t.jsx(Ec,{})}function yc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),[i,d]=c.useState("d"),l=o!=="client";return t.jsxs(Ke,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(wc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(kc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(vi,{})]})}function wc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[h,p]=c.useState(0);c.useEffect(()=>{let L=!0;return s(!1),ur(a).then(S=>{L&&(S?d(S):s(!0))}),()=>{L=!1}},[a,h]);const x=c.useRef({}),[u,b]=c.useState({}),[m,w]=c.useState(!1),[k,f]=c.useState(!1),v=c.useRef(null);c.useEffect(()=>()=>{v.current&&window.clearTimeout(v.current)},[]);const E=L=>{const S=x.current;Object.keys(S).length&&(w(!0),ur(a,S).then(T=>{if(!T){w(!1),o(e.actErr);return}if(T.throttled&&L<3){v.current=window.setTimeout(()=>E(L+1),5400);return}if(x.current={},b({}),d(T),w(!1),T.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},y=L=>{r||(x.current={...x.current,...L},b(S=>({...S,...L})),v.current&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>E(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...u},j=L=>!N.sections||N.sections.includes(L),C=L=>{const S=N.sections||e.alertSec.map(([T])=>T);y({sections:j(L)?S.filter(T=>T!==L):[...S,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>y({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>y({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>y({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>y({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&k&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,S])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:j(L),disabled:r,onChange:()=>C(L)}),t.jsxs("span",{children:[S,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Wn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ds(a),onTest:()=>Ms(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function kc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=c.useState(null),[l,s]=c.useState(!1),[h,p]=c.useState(0);c.useEffect(()=>{let m=!0;return s(!1),mr(a).then(w=>{m&&(w?d(w):s(!0))}),()=>{m=!1}},[a,h]);const x=m=>{r||mr(a,m).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,w)=>t.jsx("option",{value:w,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Wn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ps(a),onTest:()=>Is(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function vi(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=K(),[d,l]=c.useState(i||""),[s,h]=c.useState(!1),[p,x]=c.useState(!1);c.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,b=c.useMemo(()=>n.filter(f=>$e(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||p)){x(!0);try{await fetch(`${Ha}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{x(!1)}}},k=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>tt(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Gt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return s?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:k.map(([f,v])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:v}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Ec(){const{t:e}=K();return t.jsx(Ke,{title:e.alertTitle,icon:"🔔",children:t.jsx(vi,{})})}function jc(){var O,H;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:s,liveMemos:h}=K(),[p,x]=c.useState(()=>Ya(r)),[u,b]=c.useState(()=>!Ya(r)),[m,w]=c.useState([]),[k,f]=c.useState(0),v=n==="client",E=c.useMemo(()=>{const R=new Map;return o.forEach(M=>{const g=(M.name||"").trim().toLowerCase();g&&!R.has(g)&&R.set(g,M)}),R},[o]);c.useEffect(()=>{let R=!0;return(!Ya(r)||k>0)&&b(!0),(async()=>{const[M,g]=await Promise.all([Fn(r,k>0),yo(a)]);R&&(M&&x(M),b(!1),w(g))})(),()=>{R=!1}},[a,r,k]);const y=u&&!p,N=(p==null?void 0:p.per_day)??0,j=((O=p==null?void 0:p.analyzed_today)==null?void 0:O.length)??0,C=p==null?void 0:p.offre,L=(p==null?void 0:p.pool_meta)||[],S=c.useMemo(()=>{const R=new Map;for(const M of(p==null?void 0:p.scheduled)||[])for(const g of M.names||[])R.has(g)||R.set(g,{label:M.day_label,date:M.date});return R},[p==null?void 0:p.scheduled]),T=(p==null?void 0:p.in_progress)||[];return t.jsxs(Ke,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:y?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(j,j+(((H=p==null?void 0:p.pool_order)==null?void 0:H.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!y&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(T.length>0||h.items.some(R=>R.status==="boot"||R.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(R=>R.status==="boot"||R.status==="running"||R.status==="error").map(R=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:R.name}),t.jsx("span",{className:"qd",children:R.memoType||""}),t.jsx(Ta,{item:R,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+R.name)),T.filter(R=>!h.liveOf(R.name)).map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.name}),t.jsxs("span",{className:"qd",children:[R.memo_type||"",R.age_min?` · ${Math.round(R.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:R.state||""})]},"ip-"+R.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.company}),t.jsxs("span",{className:"qd",children:[R.memo_type,typeof R.est_min=="number"?` · ~${R.est_min} min`:""]}),t.jsx("span",{className:"qt",children:R.status}),R.url&&t.jsx("a",{className:"qgo",href:R.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(R.memo_type)}),v&&R.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{pr(a,R.company,"retry").then(()=>f(M=>M+1))},children:e.queueRetry}),v&&R.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{pr(a,R.company,"delete").then(()=>f(M=>M+1))},children:e.queueDelete})]},R.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",y?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[y&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!y&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((R,M)=>{const g=S.get(R.name),q=E.get((R.name||"").trim().toLowerCase()),D=h.liveOf(R.name),Q=!!(q&&d.has(q.id))||!!(D&&(D.status==="boot"||D.status==="running")),z=!!(q&&Le(q)===1&&!q.memoUrl)&&!D;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),g?t.jsx("span",{className:"qwhen"+(g.label==="demain"?" soon":""),children:g.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:R.name}),R.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof R.score=="number"&&t.jsx("span",{className:"qs2",children:R.score}),D&&(D.status==="boot"||D.status==="running")&&t.jsx(Ta,{item:D,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),z&&(l.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>s({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:Q,onClick:()=>{i(q),f(P=>P+1)},children:Q?e.actAnalyseQueued:e.actAnalyse})),R.excerpt&&t.jsx("span",{className:"qex",children:R.excerpt})]},R.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([R,M])=>t.jsxs("li",{children:[t.jsx("b",{children:R})," — ",M]},R))})]})}function Nc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=K(),l=`${Et}/cibles/list.csv?token=${a}`,s=`${Et}/cibles/list.json?token=${a}`,h=`${Et}/cibles/export.xlsx?token=${a}&scope=full`,p=`=IMPORTDATA("${l}")`,x=k=>{var f;(f=navigator.clipboard)==null||f.writeText(k).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:p},{def:e.exportLive,value:s,href:s},{def:e.exportXlsx,value:h,href:h}],b=!o.lockActions&&n.length>0,m=()=>{pc(dc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:k=>(e.stg.find(([f])=>f===k)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ke,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:k,value:f,href:v})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:k[0]}),t.jsxs("div",{children:[t.jsx("b",{children:k[1]}),t.jsx("p",{children:k[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),v&&t.jsx("a",{className:"exb",href:v,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},k[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Sc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=K(),i=o!=="client",[d,l]=c.useState(null),[s,h]=c.useState(!1),[p,x]=c.useState(0),[u,b]=c.useState(!1);c.useEffect(()=>{let f=!0;return h(!1),lr(a).then(v=>{f&&(v?l(v):h(!0))}),()=>{f=!1}},[a,p]);const m=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=f=>{if(i||!d)return;const v={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??m()};b(!0),lr(a,v).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}l(E),r(e.memoAlertSaved)})};if(s)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(Ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const k=m();return t.jsxs(Ke,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Cc,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>w({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!k[f],disabled:i||u,onChange:()=>w({sections:{...k,[f]:!k[f]}})}),t.jsx("span",{children:v})]},f))}),t.jsx(Wn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Ss(a,k),onTest:()=>Ns(a,k)})]})}function Cc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=c.useState(e);c.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),s=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&l&&s&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!s,onClick:()=>o(i.trim()),children:n})]})]})}function zc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=K(),[i,d]=c.useState(null),[l,s]=c.useState(!1),[h,p]=c.useState(null),[x,u]=c.useState(!1),[b,m]=c.useState(""),[w,k]=c.useState(0),[f,v]=c.useState("webhook"),[E,y]=c.useState("webhook"),[N,j]=c.useState(""),C=c.useRef(!1);c.useEffect(()=>{let D=!0;return s(!1),dr(a).then(Q=>{D&&(Q?d({configured:Q.configured,url_hint:Q.url_hint}):s(!0))}),qs(a).then(Q=>{if(D){if(!Q){u(!0);return}u(!1),p(Q),C.current||(C.current=!0,Q.destination==="instantly"&&(v(z=>z==="webhook"?"instantly":z),y(z=>z==="webhook"?"instantly":z)),Q.campaign_id&&j(z=>z||Q.campaign_id||""))}}),()=>{D=!1}},[a,w]);const L=(D,Q)=>{o&&dr(a,D).then(z=>{if(!z||z.ok===!1){n(e.actErr);return}D.test&&z.sent===!1?n(e.plugTestThrottled):r(Q),k(P=>P+1)})},S='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',T=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),O=`curl -X POST ${Et}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,H=`curl -X POST ${Et}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,R=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugAideInst},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],M=E==="instantly"?e.plugStep2Inst:E==="script"?e.plugStep2Script:e.plugStep2Wh,g=E==="instantly"?e.plugAideInst:E==="script"?e.plugAideScript:e.plugAideWh,q=D=>{y(D),D!=="script"&&v(D)};return t.jsxs(Ke,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[h&&t.jsxs("div",{className:"plugetat"+(h.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:h.enabled?e.plugEtatOn:e.plugEtatOff})]}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>k(D=>D+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:R.map(D=>{const Q=E===D.k;return t.jsxs("button",{type:"button",className:"plugdest"+(Q?" on":""),onClick:()=>q(D.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:D.t}),t.jsx("em",{children:D.s})]},D.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:M})]}),E==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:O}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(O).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):E==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:N,disabled:!o,onChange:D=>j(D.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:D=>m(D.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>L({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>L({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>L({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:g}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(qc,{auto:h,autoKo:x,destKind:f,camp:N,onRetry:()=>k(D=>D+1),onDone:D=>{p(D),u(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:T}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(T).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(Tc,{destKind:f,setDestKind:D=>{v(D),y(D)},camp:N,setCamp:j,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),E!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:O}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(O).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:H}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(H).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Ac(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:l}=K(),s=c.useMemo(()=>r.find(g=>g.id===n.approachId)||null,[r,n.approachId]),[h,p]=c.useState("email"),[x,u]=c.useState(0),[b,m]=c.useState({}),[w,k]=c.useState(!1),[f,v]=c.useState(""),[E,y]=c.useState({});if(c.useEffect(()=>{!s||b[h]||w||(k(!0),v(""),As(a,s.name,h).then(g=>{if(k(!1),!g||g.ok===!1){v((g==null?void 0:g.error)||e.apprFail);return}m(q=>({...q,[h]:g}))}))},[s,h,a]),!s)return null;const N=b[h],j=(N==null?void 0:N.sequence)||[],C=j[x],L=g=>`${h}|${x}|${g}`,S=g=>{const q=L(g);return q in E?E[q]:String(((C==null?void 0:C[g])??"")||"")},T=(g,q)=>y(D=>({...D,[L(g)]:q})),O=L("subject")in E||L("body")in E||L("message")in E,H=S(h==="email"?"body":"message"),R=S("subject"),M=h==="email"&&R?`${R}

${H}`:H;return t.jsxs(Ke,{title:e.apprT(s.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(g=>t.jsx("button",{type:"button",className:"apch"+(h===g?" on":""),"aria-pressed":h===g,onClick:()=>{p(g),u(0)},children:g==="email"?e.apprChEmail:e.apprChLi},g)),t.jsx("span",{className:"sp"}),j.map((g,q)=>t.jsxs("button",{type:"button",className:"apday"+(x===q?" on":""),"aria-pressed":x===q,onClick:()=>u(q),children:[g.day||`J${q}`,[`${h}|${q}|subject`,`${h}|${q}|body`,`${h}|${q}|message`].some(D=>D in E)&&t.jsx("i",{children:"✎"})]},g.day||q))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,N!=null&&N.sender?" · "+e.apprSender(N.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!w&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(g=>{const q={...g};return delete q[h],q}),v("")},children:e.retry})]}),!w&&!f&&!C&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),C&&t.jsxs(t.Fragment,{children:[h==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:R,onChange:g=>T("subject",g.target.value)})]}),h==="linkedin"&&x===0&&(N==null?void 0:N.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:H,onChange:g=>T(h==="email"?"body":"message",g.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var g;(g=navigator.clipboard)==null||g.writeText(M).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),h==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(s.contactEmail||"")}?subject=${encodeURIComponent(R)}&body=${encodeURIComponent(H)}`,children:e.apprMailto}),O&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function qc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:l,flash:s,flashErr:h,canWrite:p}=K(),[x,u]=c.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,k=()=>{if(x||!p||m)return;u(!0),(b?cr(l,!1):cr(l,!0,r,n.trim()||void 0)).then(v=>{if(u(!1),!v){h(d.actErr);return}o(v),s(v.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!p||!!m,title:m||void 0,onClick:k,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),m===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Tc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:l,canWrite:s}=K(),[h,p]=c.useState("valides"),[x,u]=c.useState(!1),[b,m]=c.useState(null),[w,k]=c.useState(null),[f,v]=c.useState(!1),[E,y]=c.useState(!1),[N,j]=c.useState(null),[C,L]=c.useState(null),S=`atl2:bulk:${d}:${h}:${e}`;c.useEffect(()=>{m(null),k(null),v(!1),j(null);try{const P=localStorage.getItem(S)||localStorage.getItem(`atl2:bulk:${d}:${h}`),I=JSON.parse(P||"null");L(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{L(null)}},[S,h,d]);const T=e==="instantly"&&!r.trim(),O=`${h}|${e}|${r.trim()}`,H=async()=>{if(T||!s)return;u(!0),v(!1),j(null);const P=await Rs(d,h,e,r.trim()||void 0);m(P),k(P.ok?O:null),u(!1)},R=c.useRef(!1);if(!s)return null;const M=async()=>{if(R.current||!s)return;R.current=!0,y(!0);const P=`${d}:${h}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let I;try{I=await Os(d,h,e,r.trim()||void 0,P)}finally{R.current=!1}if(y(!1),v(!1),j(I),I.ok&&(I.pushed||0)>0){const U={t:new Date().toISOString(),n:I.pushed||0};L(U);try{localStorage.setItem(S,JSON.stringify(U))}catch{}}};f&&w!==null&&w!==O&&v(!1);const g=o,q=b!=null&&b.ok&&b.ready||0,D=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":g||"",Q=!!(b!=null&&b.ok)&&w===O&&q>0&&!!D&&!C,z=C?new Date(C.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:h,onChange:P=>p(P.target.value),children:i.plugBulkTabs.map(([P,I])=>t.jsx("option",{value:P,children:I},P))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:P=>a(P.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:P=>n(P.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||T,onClick:()=>{H()},children:x?"…":i.plugBulkPreview})]}),T&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),C&&t.jsx("p",{className:"mnote",children:i.bulkLocked(z,C.n)}),!C&&!!(b!=null&&b.ok)&&!D&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!C&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),Q&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:i.bulkArm}),Q&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(q,D)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{M()},children:E?i.bulkSending:i.bulkConfirm(D)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>v(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function Lc(){const{t:e,data:a,lang:r}=K(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const h=await(await fetch(`${Ha}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Ke,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(d.credits,d.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Fc(){const{t:e}=K();return t.jsx(Ke,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(mc,{})})}function Rc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=K(),[s,h]=c.useState(null),[p,x]=c.useState(!1);c.useEffect(()=>{let S=!0;if(i)return Fn(i).then(T=>{S&&T&&typeof T.per_day=="number"&&h(T.per_day)}),()=>{S=!1}},[i]);const[u,b]=c.useState(null);c.useEffect(()=>{if(!o)return;let S=!0;return zs(o).then(T=>{S&&b(T)}),()=>{S=!1}},[o]);const m=r.stats,w=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(S=>S.kind==="target"&&Ge(S)).length,k=r.marketEstimate||0,f=k>0?Math.min(100,Math.round(w/k*100)):null,v=(m==null?void 0:m.window_days)||30,E=w>0?w/v:0,y=k>0?Math.max(0,k-w):0,j=k>0&&E>0&&w>=100?Math.round(y/E):null,C=S=>Math.round(S).toLocaleString(a==="en"?"en-US":"fr-FR"),L=S=>{p||!d||(x(!0),wo(o,S).then(T=>{if(x(!1),T===null){l(e.actErr);return}h(T),l(e.alertSaved)}))};return t.jsxs(Ke,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(w))}),k>0&&t.jsx("span",{children:e.covOf(C(k))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),j!==null&&t.jsx("p",{className:"mnote",children:e.covEta(j)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(E))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((S,T)=>t.jsxs("tr",{className:S.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[S.code,S.geo?` · ${S.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof S.n=="number"?C(S.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:S.source}),S.elargi&&t.jsx("em",{children:e.covWide(String(S.demande||""))}),S.erreur&&t.jsx("em",{children:e.covMissing})]})]},T)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(u.total||k)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:s===S?"on":"",disabled:p,onClick:()=>L(S),children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function yi(e,a,r){const n=await fetch(`${Et}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${Et}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Oc(){const{t:e,token:a,canWrite:r}=K(),[n,o]=c.useState(null),[i,d]=c.useState(""),[l,s]=c.useState(""),[h,p]=c.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=c.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(x)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(c.useEffect(()=>{if(!r)return;let m=!0;return Ls(a).then(w=>{m&&o(w)}),()=>{m=!1}},[a,r]),!r||h||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),yi(a,n.instruction||"","atelier2-avis").then(m=>{if(d(m.applied?"ok":"ko"),m.applied||s(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{p(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Mc(){var N;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=K(),[i,d]=c.useState(!1),[l,s]=c.useState(null),[h,p]=c.useState(!1),[x,u]=c.useState([]),[b,m]=c.useState(null),[w,k]=c.useState([]);if(!r)return null;const f=()=>{d(!0),p(!1),u([]),k([]),Fs(a).then(j=>{if(d(!1),!j){p(!0),s(null);return}s(j)})},v=j=>{b||(m(j.title),yi(a,j.instruction,"atelier2-prop").then(C=>{m(null),C.applied?(k(L=>[...L,j.title]),n(e.propApplied)):C.encours?n(e.propSlow):o(C.reply||e.propApplyFail)}))},E=((l==null?void 0:l.proposals)||[]).filter(j=>!x.includes(j.title)&&!w.includes(j.title)),y=((N=l==null?void 0:l.counts)==null?void 0:N.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&h&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!h&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(y):e.propNone}),E.map(j=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[j.section]||j.section}),t.jsx("p",{className:"propt",children:j.title}),j.why&&t.jsx("p",{className:"mnote dim",children:j.why}),j.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",j.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>v(j),children:b===j.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(C=>[...C,j.title]),children:e.propSkip})]})]},j.title))]})}function Dc(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=K(),[l,s]=c.useState(null),[h,p]=c.useState(!1),[x,u]=c.useState(!1),[b,m]=c.useState(""),[w,k]=c.useState(""),[f,v]=c.useState(!1),E=c.useRef(!1);if(c.useEffect(()=>{if(!a||!r)return;let j=!0;return Ts(a).then(C=>{j&&(p(!0),!(!C||E.current)&&(s(C),m(C.fit),k(C.note)))}),()=>{j=!1}},[a,r]),!r)return null;const y=()=>{if(!(!b||f)){if(l&&l.fit===b&&l.note===w.trim()){u(!1);return}v(!0),wt(a,"thesis_fit",b,w.trim(),"",d.email||"").then(j=>{if(v(!1),!j.ok){o(e.fitKo);return}s({fit:b,note:w.trim(),ts:new Date().toISOString()}),u(!1),n(e.fitSaved)})}},N=j=>j==="yes"?e.fitYes:j==="partial"?e.fitPartial:e.fitNo;if(l&&!x){const j=new Date(String(l.ts||"")),C=Number.isNaN(j.getTime())?"":j.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:N(l.fit)}),l.note?` — ${l.note}`:""]}),!!C&&t.jsx("p",{className:"mnote dim",children:C}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(j=>t.jsx("button",{type:"button","aria-pressed":b===j,className:"fitopt"+(b===j?" on":""),onClick:()=>{E.current=!0,m(j)},children:N(j)},j))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:w,onChange:j=>{E.current=!0,k(j.target.value)},onKeyDown:j=>{j.key==="Enter"&&y()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||f,onClick:y,children:f?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!h&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function Ic(){var f,v,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=K(),s=n==="client",h=c.useMemo(()=>{const y=new Set;return a.forEach(N=>{N.angle&&y.add(N.angle)}),[...y]},[a]),[p,x]=c.useState(""),[u,b]=c.useState(""),[m,w]=c.useState(!1),k=async()=>{const y=p.trim();if(!(!y||m||!s)){w(!0),b("");try{const j=await(await fetch(`${Et}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(j.reply&&b(String(j.reply)),j.job_id){b(e.critChatRunning);const C=async()=>{const L=await fetch(`${Et}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:j.job_id})}).then(S=>S.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),w(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||w(!1)}}};return t.jsxs(Ke,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((v=i==null?void 0:i.angles)!=null&&v.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(y=>{var N,j;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((N=y.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((j=y.out)!=null&&j.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},y.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsx(Dc,{}),t.jsx(Oc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:p,disabled:!s||m,onChange:y=>x(y.target.value),onKeyDown:y=>{y.key==="Enter"&&k()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!s||m||!p.trim(),onClick:()=>void k(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Mc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Cs,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(gi[y]||"v-cons"),children:y}),t.jsx("span",{children:N})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",N]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Pc(){const{t:e,dispatch:a,startTour:r}=K(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ke,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const wi="atl2:mapfold",_c=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(wi);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Bc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},ki=c.createContext(null),K=()=>{const e=c.useContext(ki);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ct({o:e,lg:a}){const{lang:r}=K(),n=$e(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:fr(n,r),children:[n.emoji," ",fr(n,r)]}):null}function Va({o:e,src:a}){const{lang:r,t:n}=K(),o=$e(e);if(!o)return null;const i=Vs(o),d=Ws(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Co(o,r))+" · "+n.win7(zo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,s)=>t.jsx("i",{className:s<i?"on":""},s))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function $c(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ue(a);if(o)return e.find(i=>Ue(i.name)===o)||e.find(i=>{const d=Ue(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Uc(){const{scoped:e,t:a,st:r,dispatch:n}=K(),o=c.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(x=>!He(x)),l=d.length,s=d.filter(x=>!x.noCo).length,h=d.filter(x=>!!x.noCo).length,p=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:p?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",s," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function Hc(){var x;const{t:e,lang:a,data:r,dispatch:n,scopedAll:o,counts:i}=K(),d=u=>u.toLocaleString(a==="en"?"en-US":"fr-FR"),s=o.filter(u=>!He(u)).length,h=typeof((x=r.stats)==null?void 0:x.screened)=="number"?r.stats.screened:0;if(s<=0&&h<=0)return null;const p=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:d(s)}),t.jsx("span",{children:p>0?e.covOf(d(p)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",d(i[1]||0)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",d(i[2]||0)," ",e.covAna]})]})]})}function Ei({o:e}){const{lang:a}=K(),r=Hs(e.cc),n=e.cc?Gt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:20,height:14,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Vc=!1;function Wc(){const[e,a]=c.useState(!1);return c.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ji=e=>`atl2:tour:${e||"anon"}`;function Gc(e){try{return localStorage.getItem(ji(e))==="1"}catch{return!0}}function fo(e){try{localStorage.setItem(ji(e),"1")}catch{}}function Yc(e,a,r,n,o,i,d,l){const s=e.tourT,h=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:h[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:h[1][0]},{sel:".atl2 .dmulti.ddeals",title:s.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:s.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:s.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:s.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(p=>(l[p]||0)>0).map(p=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:p===2?s.tabAna:p===4?s.tabValid:s.tabRej,body:p===2?e.fhintTabAna:p===4?e.fhintTabValid:e.fhintTabRej,ptab:p})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:s.rank,body:e.fhintRank},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:s.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:h[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:h[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:s.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:s.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:s.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function Zc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Yn;const{lang:d}=_s(),l=Ol(e,d,a),s=c.useMemo(()=>({...kl[d],...wl(d,l.thesisMode)}),[d,l.thesisMode]),[h,p]=c.useReducer(Il,void 0,()=>Ml((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Bc():_c()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=c.useRef(!0);c.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(wi,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),c.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const A=()=>{window.innerWidth<=760&&p({type:"mapFold",folded:!0})};return A(),window.addEventListener("resize",A),()=>window.removeEventListener("resize",A)},[a]);const u=c.useRef(i);u.current=i,c.useEffect(()=>{var A;(A=u.current)==null||A.call(u,h.filters)},[h.filters]);const[b,m]=c.useState(()=>{if(typeof window>"u")return"both";try{const A=localStorage.getItem("atl2:chrome-mode");if(A==="eval"||A==="filt"||A==="both")return A;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,k]=c.useState(null),[f,v]=c.useState(null),[E,y]=c.useState(null),[N,j]=c.useState({kept:0,dropped:0}),[C,L]=c.useState(!1),[S,T]=c.useState(""),[O,H]=c.useState(!1),[R,M]=c.useState(null),[g,q]=c.useState(null),[D,Q]=c.useState(!1),[z,P]=c.useState(!1),[,I]=c.useState(0),U=()=>I(A=>A+1),te=c.useRef([]),$=c.useRef(new Set),pe=c.useRef(new Set),[J,le]=c.useState([]),[ge,ue]=c.useState([]),[ye,be]=c.useState(0),je=c.useRef(new Map),Fe=c.useRef(null),{mode:ne}=l,Ne=c.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),ve=Ne.pipe,oe=l.session.token||"",B=ne==="client"&&!e;c.useEffect(()=>{if(!oe||!ve)return;let A=!0;const Y=async()=>{const he=await Gs(oe);!A||!he||(ue(he.runs),be(Date.now()/1e3-he.now),le(De=>De.filter(Ae=>!he.runs.some(Ve=>Ue(Ve.company)===Ue(Ae.name)))))};Y();const V=J.length>0||ge.some(he=>he.status==="running"),se=window.setInterval(()=>{Y()},V?8e3:25e3);return()=>{A=!1,window.clearInterval(se)}},[oe,ve,J.length,ge.some(A=>A.status==="running")]),c.useEffect(()=>{if(!oe||!ve||!B)return;let A=!0;const Y=async()=>{const se=await Ys(oe);if(!A||!se.length)return;const he=new Map;se.forEach(De=>{const Ae=String(De.ceo_status||"").trim();Ae&&De.check_id&&he.set(String(De.check_id),Ae)}),l.patchStatuses(he,De=>Date.now()-(ze.current.get(De)||0)>9e4)};Y();const V=window.setInterval(()=>{Y()},6e4);return()=>{A=!1,window.clearInterval(V)}},[oe,ve,B]);const W=c.useMemo(()=>{const A=[],Y=new Set;for(const V of J){const se=Ue(V.name);!se||Y.has(se)||(Y.add(se),A.push({name:V.name,id:V.id,status:"boot",started:V.started,estMin:V.estMin,memoType:"instant"}))}for(const V of ge){const se=Ue(V.company);if(!se||Y.has(se))continue;Y.add(se);const he=V.status==="error"?"error":V.status==="done"?"done":"running";A.push({name:V.company,status:he,started:V.started||0,estMin:V.est_min||(V.memo_type==="detailed"?40:15),url:V.url,error:V.error,memoType:V.memo_type,note:V.note})}return A},[J,ge]),ee=A=>W.find(Y=>Ue(Y.name)===Ue(A))||null,de=(A,Y)=>{le(V=>V.some(se=>Ue(se.name)===Ue(A.name))?V:[...V,{name:A.name,id:A.id,started:Date.now()/1e3,estMin:Y==="detailed"?40:15}]),$.current.add(A.id),U()},ce=(A,Y=!1)=>{T(A),H(Y),Fe.current&&clearTimeout(Fe.current),Fe.current=setTimeout(()=>T(""),Y?4200:2400)},re=A=>ce(A,!0),ie=c.useMemo(()=>{const A=new Map;return l.dossiers.forEach(Y=>{Y.id&&A.set(Y.id,Y)}),A},[l.dossiers]),me=c.useMemo(()=>l.dossiers.filter(A=>oa(A,h,ve)),[l.dossiers,h,ve]),we=c.useRef(!1);c.useEffect(()=>{if(we.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){we.current=!0;return}if(!Ne.showFunnel||Gc(l.session.token||"")){we.current=!0;return}we.current=!0;const A=window.setTimeout(()=>{fo(l.session.token||""),Q(!0)},700);return()=>window.clearTimeout(A)},[e,l.loading,l.dossiers.length,Ne.showFunnel,l.session.token]);const Ce=c.useMemo(()=>l.dossiers.filter(A=>Pl(A,h,ve,l.favIds)),[l.dossiers,h,ve,l.favIds]),Ee=c.useMemo(()=>Bs(me.filter(A=>!Je(A)),l.favIds),[me,l.favIds]),ke=c.useRef(!1);c.useEffect(()=>{if(ke.current)return;if(!ve||a==="ops"){ke.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){ke.current=!0;return}if(l.loading)return;ke.current=!0;const A=$s(Ee);A!==h.ptab&&p({type:"ptab",tab:A})},[ve,a,n==null?void 0:n.ptab,l.loading,Ee,h.ptab]);const ht=c.useMemo(()=>{const A=$o(l.dossiers);return A?jt(A)===0?s.tourToday:Uo(A,d):s.tourNoRun},[l.dossiers,s,d]),gt=c.useMemo(()=>l.dossiers.some(A=>!!A.memoUrl||!!A.summary||$t(A)),[l.dossiers]),[Me,lt]=c.useState(!1);c.useEffect(()=>{if(l.loading){lt(!1);return}if(l.dossiers.length>0||l.error){lt(!0);return}const A=window.setTimeout(()=>lt(!0),6e3);return()=>window.clearTimeout(A)},[l.loading,l.dossiers.length,l.error]);const xt=(l.marketEstimate||0)>0||typeof((Yn=l.stats)==null?void 0:Yn.screened)=="number"&&l.stats.screened>0,At=c.useMemo(()=>[1,0,2,4,5,3].find(A=>(Ee[A]||0)>0)??0,[Ee]),at=Rn.find(A=>A.key===h.continent),qt=h.continent==="monde"?s.contWorld:(d==="fr"?at==null?void 0:at.fr:at==null?void 0:at.en)||"";c.useEffect(()=>{const A=Y=>{var se;const V=(((se=Y.detail)==null?void 0:se.name)||"").trim();V&&bt(null,V)};return window.addEventListener("ppmap:evaluate",A),()=>window.removeEventListener("ppmap:evaluate",A)}),c.useEffect(()=>{const A=Y=>{const V=Y.detail||{},se=String(V.id||"").trim(),he=String(V.name||"").trim(),De=String(V.url||"").trim(),Ae=se&&ie.get(se)||$c(l.dossiers,he,De);if(Ae){if(v(null),oa(Ae,h,ve)||(h.continent!=="monde"&&Ae.continent!==h.continent&&p({type:"continent",key:Ae.continent||"monde"}),p({type:"reset"})),ve&&Ae.kind!=="op"){const ut=Le(Ae);typeof ut=="number"&&ut!==h.ptab&&p({type:"ptab",tab:ut})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),p({type:"focus",id:Ae.id}),(Ae.noCo||["media","nominations","recrutements"].includes(Ae.engine||""))&&(Ae.url||Ae.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ae.url||"",text:[Ae.headline,Ae.tagline].filter(Boolean).join(`
`)}})):Ae.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ae.name,url:Ae.url||"",website:Ae.website||"",domain:Ae.domain||""}}));return}!he&&!De||(p({type:"focus",id:se||null}),v({name:he,headline:String(V.text||"").trim()||he,url:De,card:V.card}),De&&(La(he)||!he)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:De,text:String(V.text||"").trim()}})):he&&!La(he)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:he}})))};return window.addEventListener("ppmap:focus",A),()=>window.removeEventListener("ppmap:focus",A)}),c.useEffect(()=>{const A=se=>{const he={},De=String((se==null?void 0:se.sector)||"").trim();De&&(he.sector=[De]);const Ae=String((se==null?void 0:se.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ae)&&(he.day=Ae);const Ve=String((se==null?void 0:se.search)||"").trim();Ve&&(he.search=Ve);const ut=String((se==null?void 0:se.dealKind)||"").trim();(ut==="ma"||ut==="levee"||ut==="other")&&(he.dealKind=[ut]),Object.keys(he).length&&p({type:"filters",patch:he})},Y=se=>A(se.detail),V=se=>{se.data&&se.data.type==="pp-filter"&&A(se.data)};return window.addEventListener("ppmap:filter",Y),window.addEventListener("message",V),()=>{window.removeEventListener("ppmap:filter",Y),window.removeEventListener("message",V)}},[]),c.useEffect(()=>{const A=Y=>{var he;const V=(((he=Y.detail)==null?void 0:he.name)||"").trim().toLowerCase();if(!V)return;const se=l.dossiers.find(De=>(De.name||"").trim().toLowerCase()===V);se&&p(a==="ops"?{type:"focus",id:se.id}:{type:"popup",id:se.id})};return window.addEventListener("ppmap:similar",A),()=>window.removeEventListener("ppmap:similar",A)});const bt=(A,Y,V)=>{const se=(V||(A==null?void 0:A.name)||Y||"").trim();if(!B){y({kicker:se});return}!se||C||(L(!0),(async()=>{try{let he=(Y||se).trim();const De=((A==null?void 0:A.website)||(A==null?void 0:A.domain)||"").trim();if(!(/^https?:\/\//i.test(he)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(he)&&!/\s/.test(he)))if(De)he=De;else try{const _e=await On(se);if(_e!=null&&_e.website)he=_e.website;else if(((_e==null?void 0:_e.candidates)||[]).length===1)he=_e.candidates[0].url;else if(((_e==null?void 0:_e.candidates)||[]).length>1){te.current=[{name:se,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(_e.candidates||[]).slice(0,5)},...te.current].slice(0,8),U();return}}catch{}const Ve=await Eo(oe,he,"atelier2"),ut={name:Ve.company||se,verdict:Ve.verdict,reason:Ve.reason||"",remaining:Ve.remaining??null};te.current=[ut,...te.current].slice(0,8),Ve.verdict==="kept"&&j(_e=>({..._e,kept:_e.kept+1})),Ve.verdict==="ruled_out"&&j(_e=>({..._e,dropped:_e.dropped+1}));const Qt=A||l.dossiers.find(_e=>(_e.name||"").toLowerCase()===se.toLowerCase());Qt&&(Ve.verdict==="kept"?Qt.verdict=Qt.verdict||"MATCH":Ve.verdict==="ruled_out"&&(Qt.verdict="NO MATCH"),Ve.reason&&(Qt.reasoning=Ve.reason)),U()}finally{L(!1)}})())},It=A=>{if(!B){y({kicker:A.name});return}de(A,"instant"),wt(oe,"fast_request",A.name||"",""),ce(s.memoInstantSent(A.name))},Pt=A=>je.current.get(A.id)??l.thumbs.get((A.name||"").trim().toLowerCase()),Be=(A,Y)=>p({type:"undoPush",entry:{id:A.id,name:A.name,prevCeoStatus:Y}}),Xe=async(A,Y,V)=>{const se=A.ceoStatus||"";ze.current.set(A.id,Date.now()),A.ceoStatus=Y,U();const he=await Qa(oe,{status:Y,airtable_id:A.airtableId,check_id:A.checkId,company:A.name,...(V==null?void 0:V.note)!==void 0?{note:V.note}:{},...V!=null&&V.via?{via:V.via}:{}});return he.ok?he.skipped?(A.ceoStatus=se,U(),re(s.actNotPersisted),!1):((V==null?void 0:V.undo)!==!1&&Be(A,se),V!=null&&V.msg&&ce(V.msg),(Y==="Validé"||Y==="Écarté")&&!A.ceoNote&&(V==null?void 0:V.note)===void 0&&M({o:A,yes:Y==="Validé"}),!0):(A.ceoStatus=se,U(),re(s.actErr),!1)},Ye=async(A,Y)=>{const V=await Qa(oe,{status:A.ceoStatus||"Retenu",airtable_id:A.airtableId,check_id:A.checkId,company:A.name,note:Y,via:"note"});return!V.ok||V.skipped?(re(V.skipped?s.actNotPersisted:s.actErr),!1):(A.ceoNote=Y,U(),!0)},ct=c.useRef(new Map),F=A=>ct.current.has(A.id)?ct.current.get(A.id):l.stages.get((A.name||"").trim().toLowerCase()),G=(A,Y)=>{ct.current.set(A.id,Y),U()},X=(A,Y)=>{B&&Xe(A,Y?"Validé":"Écarté",{msg:Y?s.decidedYes(A.name):s.decidedNo(A.name)})},_=A=>{B&&Xe(A,"À trancher",{msg:s.promoted(A.name)})},ae=A=>{B&&(async()=>{const Y=A.ceoStatus||"";A.ceoStatus="Retenu",U();const V=await Qa(oe,{status:"Retenu",check_id:A.checkId,company:A.name});if(!V.ok||V.skipped){A.ceoStatus=Y,U(),re(V.skipped?s.actNotPersisted:s.actErr);return}Be(A,Y),ce(s.repeched(A.name))})()},Z=()=>{const A=h.undo[h.undo.length-1];if(!A){ce(s.undoNone);return}const Y=ie.get(A.id);if(!Y){p({type:"undoPop"}),ce(s.undoNone);return}let V=A.prevCeoStatus;if(!V)if((Y.verdict||"").toUpperCase().includes("CALL"))V="À trancher";else{ce(s.undoLockedTitle);return}(async()=>await Xe(Y,V,{undo:!1})&&(p({type:"undoPop"}),Y.ceoStatus=A.prevCeoStatus,U(),ce(s.undoDone(Y.name))))()},fe=A=>{B&&(pe.current.add(A.id),U(),p({type:"approachOpen",id:A.id}),wt(oe,"approach",A.name||"","","",l.email||""))},ze=c.useRef(new Map),xe=c.useRef(!1),[Oe,Te]=c.useState(0);c.useEffect(()=>{if(!oe||e||!B||xe.current)return;xe.current=!0;const A=new Date().toISOString().slice(0,10),Y=l.email||"",V=`cbv_${oe}_${Y}_${A}`,se=`atl2:vue:${oe}:${A}`;try{if(localStorage.getItem(V)||localStorage.getItem(se))return}catch{}wt(oe,"view","","","",Y).then(he=>{if(!he.ok){xe.current=!1;return}try{localStorage.setItem(V,"1")}catch{}})},[oe,e,B,l.email]),c.useEffect(()=>{if(!oe||!ve||e||!B||!l.generatedAt)return;let A=!0;const Y=()=>{document.hidden||Qs(oe,l.generatedAt||"").then(se=>{A&&Te(se)})};Y();const V=window.setInterval(Y,6e4);return()=>{A=!1,window.clearInterval(V)}},[oe,ve,e,l.generatedAt]);const nt=(A,Y)=>{B&&(async()=>{if(!(await wt(oe,Y?"yes":"no",A.name||"",(A.ceoNote||"").slice(0,400),A.sector||"",l.email||"")).ok){re(s.actErr);return}je.current.set(A.id,Y?"yes":"no"),U(),ce(Y?s.thumbUpDone:s.thumbDnDone),q({o:A,up:Y})})()},vt=A=>{!B||!$t(A)||(de(A,"detailed"),wt(oe,"detailed_request",A.name||"","","",l.email||""),ce(s.memoDeepSent(A.name)))},Ze=A=>{!B||!A.memoUrl||window.confirm(s.memoRegenAsk(A.name))&&(de(A,"detailed"),wt(oe,"detailed_regen",A.name||"","","",l.email||""),ce(s.memoDeepSent(A.name)))},Ni=A=>{const Y=new Set(l.favIds),V=Y.has(A.id);V?Y.delete(A.id):Y.add(A.id),l.setFavIds(Y),B&&Ks(oe,{id:A.id,co:A.name},V)},Si=()=>{!B||z||window.confirm(s.identSyncConfirm)&&(P(!0),(async()=>{const A=await Js(oe);P(!1),A?ce(s.identSyncDone):re(s.actErr)})())},Gn=/proplace/i.test(l.fund||""),Ci=A=>{!B||!Gn||(wt(oe,"onboard_request",A.name||"",""),ce(s.onboardSent(A.name)))},zi={st:h,dispatch:p,t:s,lang:d,mode:ne,caps:Ne,pipe:ve,token:oe,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:ae,thumbOf:Pt,canWrite:B,commitStatus:Xe,saveNote:Ye,stageOf:F,setStage:G,flashErr:re,startTour:()=>Q(!0),dossiers:l.dossiers,scopedAll:me,scoped:Ce,counts:Ee,byId:ie,contName:qt,favIds:l.favIds,toggleFav:Ni,askEvaluate:bt,doAnalyse:It,doDecide:X,doPromote:_,doApproach:fe,doThumb:nt,doDeep:vt,doRegen:Ze,doUndo:Z,doSync:Si,doOnboard:Ci,outbound:Gn,memoQueued:$.current,liveMemos:{items:W,serverOff:ye,liveOf:ee},approachDone:pe.current,sessTally:N,evalCards:te.current,evalBusy:C,markRow:k,markedId:w,flash:ce,focusExtra:f};c.useEffect(()=>{const A=Y=>{Y.key==="Escape"&&(p({type:"popup",id:null}),p({type:"modal",modal:null}),p({type:"openFacet",facet:null}))};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[]);const Ai=A=>oe?t.jsx($l,{token:oe,children:A}):t.jsx(t.Fragment,{children:A});return t.jsx(ki.Provider,{value:zi,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(oe?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Cl}),Ai(t.jsxs("div",{className:"app"+(ve?" pipe":"")+(oe?" has-thesis":""),children:[Ne.showTicker&&t.jsx(dt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(oe?" live-stack--cibles":""),children:[t.jsx(Ql,{}),!!oe&&t.jsx(Ul,{})]})}),Ne.showIdent&&t.jsx(dt,{name:"identite",children:t.jsx(sd,{})}),!1,Vc,Ne.showFunnel&&t.jsx(dt,{name:"entonnoir",children:t.jsx(Qc,{})}),t.jsx(dt,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(di,{variant:h.mapFolded?"compact":"tabs"}),t.jsxs("div",{className:"stage"+(h.mapFolded?" folded":""),id:"atl2-stage",children:[!h.mapFolded&&a==="ops"&&t.jsx(Uc,{}),!h.mapFolded&&a!=="ops"&&Ne.showFunnel&&t.jsx(Hc,{}),!h.mapFolded&&t.jsx(op,{}),t.jsx(li,{compact:!!h.mapFolded})]})]})}),Ne.showDemand&&ve&&t.jsx(dt,{name:"direct",children:t.jsx(al,{items:W,serverOff:ye,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>p({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([A,Y])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===A,onClick:()=>{m(A);try{localStorage.setItem("atl2:chrome-mode",A)}catch{}},children:Y},A))}),Ne.showDemand&&t.jsx(dt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(xp,{})})}),Ne.showDemand&&h.memoConsole&&t.jsx(dt,{name:"console",children:t.jsx(vp,{})}),Ne.pipe&&!!oe&&t.jsx(dt,{name:"moteurs",children:t.jsx(hl,{})}),Oe>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Te(0),l.refresh()},children:s.freshGo})]}),t.jsx(dt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(sc,{})}),Ne.pipe&&!!oe&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(dt,{name:"fiche",children:t.jsx(Hp,{})}),t.jsx(dt,{name:"modales",children:t.jsx(hc,{})}),t.jsx(Xl,{}),g&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:g.o.name}),t.jsx(zr,{placeholder:g.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:A=>{const Y=g.o;q(null),A&&wt(oe,"note",Y.name||"",A,Y.sector||"",l.email||"").then(V=>{V.ok&&ce(s.csNoteSaved)})}})]}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(zr,{placeholder:R.yes?s.whyYesPh:s.whyNoPh,onDone:A=>{const Y=R.o;M(null),A&&Ye(Y,A).then(V=>{V&&ce(s.csNoteSaved)})}})]}),D&&Me&&t.jsx(rd,{steps:Yc(s,ht,gt,At,xt,Ee[3]||0,Ee[4]||0,Ee),onClose:()=>{Q(!1),fo(oe)}}),t.jsx(Wc,{}),Ne.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:_o,children:Pn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Oa}`,children:Oa})]}),t.jsx("button",{type:"button",onClick:()=>p({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),S&&t.jsx("div",{className:"flash on"+(O?" err":""),children:S}),E&&t.jsx(Us,{variant:"acquirer",initialCompany:ho().co,initialWebsite:ho().site,onClose:()=>y(null)})]})})}function Qc(){const{t:e}=K(),[a,r]=c.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function ho(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Kc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Ei as FlagCell,Ct as SigBadge,Va as SigWin,Zc as default,Kc as fmtShort,K as useV2};
