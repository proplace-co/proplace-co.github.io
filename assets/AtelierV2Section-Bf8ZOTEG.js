...
`,rr=tr+ar;function nr(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function or(t,a){return t||a.mode!=="client"||!a.token?"visiteur":nr("teaser")==="1"?"apercu":"client"}const lr={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},ir=t=>lr[t],me=t=>Object.assign(t,{continent:ba(t.cc)});function _e(t){const a=new Set,n=[];for(const r of t){const l=(r.name||"").toLowerCase();!l||a.has(l)||(a.add(l),n.push(r))}return n}const sr=60*60*1e3;function dr(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>sr?null:a}catch{return null}}function Re(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const cr=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function pr(t,a,n="default"){const r=n!=="default",l=p.useMemo(()=>t||r?{mode:"anon"}:pa(),[t,r]),o=p.useMemo(()=>r?"visiteur":or(t,l),[t,l,r]),i=p.useMemo(()=>ir(o),[o]),d=o!=="visiteur",c=cr(n),[f,h]=p.useState([]),[s,v]=p.useState(""),[b,m]=p.useState(null),[g,x]=p.useState(null),[u,y]=p.useState(null),[S,j]=p.useState(()=>new Map),[w,C]=p.useState(()=>new Map),[z,N]=p.useState(""),[E,q]=p.useState(new Set),[L,O]=p.useState(null),[M,A]=p.useState(!0),[I,R]=p.useState(!1),[H,le]=p.useState(0),[ce,Oe]=p.useState(0),ge=p.useRef(0),pe=p.useMemo(()=>{var V;if(o!=="client")return"";try{return((V=ua())==null?void 0:V.email)||""}catch{return""}},[o]);p.useEffect(()=>{const V=++ge.current;let U=!0;const P=()=>U&&V===ge.current,B=(d&&l.token?l.token:"pub:"+a)+(c?":"+c:""),_=dr(B);return _?(h(_.objs.map(me)),_.fund&&v(_.fund),m(_.marketEstimate??null),x(_.criteria??null),y(_.stats??null),N(_.generatedAt||""),A(!1)):A(!0),(async()=>{try{if(n==="ops"){const ne=await $e(),ae=((ne==null?void 0:ne.recent_ops)||[]).map(J=>Ve(J,a)).filter(J=>!!J);if(!P())return;h(ae.map(me)),Re(B,{objs:ae})}else if(typeof n=="object"){const ae=(await it()||[]).filter(X=>(X.slug||"")===n.research).map(X=>st(X,a)).filter(X=>!!X),J=_e(await dt(ae,a));if(!P())return;h(J.map(me)),Re(B,{objs:J})}else if(d&&l.token){const ne=fa(l.token),ae=$e(),J=ma(l.token),X=xa(l.token),Ne=ga(l.token),$=await ne;let ie=$?$.targets:[];P()&&$&&(v($.fund||""),m($.marketEstimate??null),x($.criteria??null),y($.stats??null),N($.generatedAt||""),h(ie.map(me)),A(!1),R(!1));const[ue,Se,he,re]=await Promise.all([ae,J,X,Ne]),be=((ue==null?void 0:ue.recent_ops)||[]).map(oe=>Ve(oe,a)).filter(oe=>!!oe);if(ie=[...ie,...be],!P())return;h(ie.map(me));const Ce=new Set;for(const oe of Se){const ve=(oe.id||oe.co||"").toString().trim().toLowerCase();ve&&Ce.add(ve.startsWith("t:")?ve:"t:"+ve)}q(Ce),j(he),C(re),$&&Re(B,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:ie})}else{const ne=ha(),ae=it(),J=$e(),X=await ne;P()&&X.length&&(h(_e(X).map(me)),A(!1),R(!1));const[Ne,$]=await Promise.all([ae,J]),ie=(Ne||[]).map(re=>st(re,a)).filter(re=>!!re),ue=await dt(ie,a),Se=(($==null?void 0:$.recent_ops)||[]).map(re=>Ve(re,a)).filter(re=>!!re),he=_e([...X,...ue,...Se]);if(!P())return;h(he.map(me)),Re(B,{objs:he})}P()&&R(!1)}catch{P()&&!_&&R(!0)}finally{P()&&A(!1)}})(),()=>{U=!1}},[d,l.token,a,H,c]),p.useEffect(()=>{if(!i.showCredits||!pe){O(null);return}let V=!0;return(async()=>{try{const U=await fetch(`${Ge}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:pe})});if(!U.ok)return;const P=await U.json();V&&P&&P.ok!==!1&&O(P)}catch{}})(),()=>{V=!1}},[i.showCredits,pe,ce]);const Y=p.useCallback(V=>q(new Set(V)),[]);return{session:l,mode:o,caps:i,fund:s,email:pe,marketEstimate:b,generatedAt:z,criteria:g,stats:u,thumbs:S,stages:w,dossiers:f,favIds:E,setFavIds:Y,credits:L,reloadCredits:()=>Oe(V=>V+1),loading:M,error:I,refresh:()=>le(V=>V+1)}}const Pt=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),ur=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Pt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function fr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(l=>l!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(l=>l!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Pt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ie)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ie=60;function et(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!Q(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Ke(t)))return!1;if(r!=="win"&&a.win!=="all"){const l=a.win==="1"?0:a.win==="7"?7:30;if(we(t.date)>l)return!1}if(r!=="status"&&!n&&a.status!=="all"&&de(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const l=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(l))return!1}return!0}function It(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:et(t,a.filters,n)}function mr(t,a,n,r){return!(!It(t,a,n)||n&&!va(t,a.ptab,r))}function tt(t,a){const n=a.key,r=l=>{switch(n){case"name":return(l.name||"").toLowerCase();case"country":return l.countryLabel||l.cc||"";case"stage":return l.stage||"";case"amount":return l.amountEur||-1;case"age":return-we(l.date);case"score":return typeof l.score=="number"?l.score:-1;case"signal":{const o=Q(l);return o?100-(o.left??0):-1}}};return[...t].sort((l,o)=>{const i=r(l),d=r(o);return i<d?-a.dir:i>d?a.dir:(l.name||"").localeCompare(o.name||"")})}function xr(){const{dossiers:t,st:a,t:n,dispatch:r,contName:l,pipe:o}=T(),i=p.useMemo(()=>{const c=s=>o?!0:s.continent===a.continent,f=t.filter(s=>c(s)&&Q(s)),h=t.filter(s=>c(s)&&s.kind==="op"&&!Q(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&we(s.date)<=2);return h.sort((s,v)=>(v.amountEur||0)-(s.amountEur||0)),[...tt(f,{key:"signal",dir:-1}),...h].slice(0,40)},[t,a.continent,o]),d=c=>i.map(f=>e.jsxs("button",{type:"button",className:"tk"+(Z(f)?" spent":""),onClick:h=>{const s=h.currentTarget.getBoundingClientRect();r({type:"popup",id:f.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:f.name+(f.tagline?" — "+f.tagline:""),children:[e.jsx(je,{o:f}),e.jsxs("span",{className:"who",children:[e.jsx(Ht,{o:f}),e.jsx("span",{className:"co",children:f.name})]}),typeof f.amountEur=="number"&&f.amountEur>0&&e.jsx("span",{className:"am",children:Dn(f.amountEur)}),f.sector&&e.jsx("span",{className:"mt",children:f.sector}),e.jsx(Be,{o:f}),e.jsx("span",{className:"tkgo",children:"→"})]},c+(f.id||f.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:i.length})]}),e.jsx("div",{className:"win",children:i.length?e.jsxs("div",{className:"run",children:[d(0),d(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(l)})})})]})}const gr="aDx8z7Hzksus",Bt="+33 6 83 10 72 86",bt="alexandre@proplace.co",hr=`tel:${Bt.replace(/[^\d+]/g,"")}`,vt="pp-rdv-slot";function br(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function vr(){const{t,caps:a,fund:n}=T(),r=a.showOnb,l=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:wr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:hr,children:Bt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${bt}`,children:bt})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(l).map(([o,i],d)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(d+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:i})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Ja,{filloutId:gr,parameters:n?{company_name:n}:void 0})})]})}function yr(){const[t,a]=p.useState(()=>typeof document>"u"?null:document.getElementById(vt));return p.useEffect(()=>{t||a(document.getElementById(vt))},[t]),t?Ae.createPortal(e.jsx(vr,{}),t):null}const wr=`
...
`;class G extends p.Component{constructor(){super(...arguments);ot(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const kr=8;function jr(){const{t,lang:a,token:n,dossiers:r,caps:l,markRow:o,dispatch:i}=T(),[d,c]=p.useState(!1),[f,h]=p.useState(!1),[s,v]=p.useState(!1),b=n||"home",{names:m,verdicts:g}=p.useMemo(()=>{const j=[],w={};return r.forEach(C=>{C.kind!=="target"||!C.name||(j.push(C.name),w[C.name]=ya(C)||"")}),{names:j,verdicts:w}},[r]),x=p.useMemo(()=>m.length?wa(b,m,g,a):null,[b,m.length]);if(!l.pipe||d||!x||x.firstVisit||!x.added.length&&!x.gone.length)return null;const u=f?x.added:x.added.slice(0,kr),y=x.added.length-u.length,S=j=>{const w=r.find(C=>C.name===j);w&&(o(w.id),i({type:"popup",id:w.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(x.added.length,x.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{c(!0),ka(b,m,g,x.fp,a)},children:"×"})]}),!!x.added.length&&e.jsxs("div",{className:"since-c",children:[u.map(j=>e.jsx("button",{type:"button",onClick:()=>S(j),children:j},j)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(y)})]}),!!x.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>v(j=>!j),children:t.sinceOut(x.gone.length)}),s&&x.gone.slice(0,20).map(j=>e.jsx("span",{className:"gone",children:j},j))]})]})}const He=600,xe=62,yt="atl2:fstats";function Nr(){const{t,lang:a,data:n,caps:r,st:l,dispatch:o}=T(),[i,d]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(yt)==="on"}catch{return!1}}),c=n.stats,f=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),h=p.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!r.showFunnel||!c||typeof c.screened!="number")return null;const s=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,v=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),b=f.reduce((y,S)=>Math.max(y,S.s||0),0),m=f.length?He/f.length:0,g=Math.max(4,m-4),x=f.length>=5&&b>0,u=[[c.screened,t.funScreened(s(h)),c.screened_today],...typeof c.kept=="number"?[[c.kept,t.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,t.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(i?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[u.map(([y,S,j],w)=>e.jsxs("span",{className:"fst-t",children:[w>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:v(y)}),e.jsx("i",{children:S}),i&&typeof j=="number"&&j>0&&e.jsx("em",{children:t.funToday(j)})]},S)),x&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":i,title:i?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!i;d(y),y&&!l.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(yt,y?"on":"off")}catch{}},children:i?"⌃":"⌄"})]}),i&&x&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${He} ${xe}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[f.map((y,S)=>{const j=(y.s||0)/b*(xe-4),w=(y.m||0)/b*(xe-4),C=S*m+(m-g)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${s(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:C,y:xe-2-j,width:g,height:j,fill:"#cfe0d6"}),e.jsx("rect",{x:C,y:xe-2-w,width:g,height:w,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:xe-1.5,x2:He,y2:xe-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:s(f[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const Sr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Cr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:l}=T(),[o,i]=p.useState(""),[d,c]=p.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const f=(t.ceoStatus||"").trim(),h=(Le(t)||"").startsWith("CALL")&&te(t)===3,s=te(t)>=2,v=async m=>{if(o||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;i(m);const g=await l(t,m);i(""),g&&(c(!0),setTimeout(()=>c(!1),2200))},b=h?[["Validé",a.csYes],["Écarté",a.csNo]]:Sr.filter(([m])=>!(s&&m==="Retenu")).map(([m,g])=>[m,a[g]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,g])=>e.jsx("button",{type:"button",className:"csb"+(f===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{v(m)},children:g},m)),d&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(zr,{o:t})]})}function zr({o:t}){const{t:a,saveNote:n,flash:r}=T(),[l,o]=p.useState(t.ceoNote||""),[i,d]=p.useState(!1),[c,f]=p.useState(!1),h=l.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(i||!h)return;d(!0);const v=await n(t,l.trim());d(!1),v&&(f(!0),setTimeout(()=>f(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:l,disabled:i,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:i||!h,onClick:()=>{s()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Er({placeholder:t,onDone:a}){const{t:n}=T(),[r,l]=p.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>l(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Tr({o:t}){var x;const{t:a,token:n,caps:r,canWrite:l,stageOf:o,setStage:i,flashErr:d}=T(),[c,f]=p.useState(!1);if(!r.pipe||!l||r.lockActions||te(t)!==4)return null;const h=o(t),s=(h==null?void 0:h.stage)||"todo",v=async u=>{if(c||u===s)return;f(!0);const y=h;i(t,{stage:u,stamps:(h==null?void 0:h.stamps)||{}});const S=Math.max(Date.now(),wt+=1);wt=S;const j=await ja(n,{company:t.name||"",stage:u,cts:S,deal_id:t.airtableId,check_id:t.checkId});f(!1),!j.stale&&(j.ok||(i(t,y),d(a.actErr)))},b=(x=h==null?void 0:h.stamps)==null?void 0:x.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=s==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,y])=>e.jsx("button",{type:"button",className:"stgb"+(s===u?" on":""),disabled:c,onClick:()=>{v(u)},children:y},u)),g&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let wt=0;const qe=8,Me=340;function kt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Ar({steps:t,onClose:a}){const{t:n,dispatch:r,counts:l,scoped:o,byId:i,st:d}=T(),[c,f]=p.useState(0),[h,s]=p.useState(null),[v,b]=p.useState([]),m=p.useRef(!1);p.useEffect(()=>{m.current||(m.current=!0,b(t.filter(w=>!!document.querySelector(w.need||w.sel))))},[t]);const g=v[c],x=c>=v.length;p.useEffect(()=>{g&&(g.ptab!==void 0&&d.ptab!==g.ptab&&r({type:"ptab",tab:g.ptab}),g.dens&&d.dens!==g.dens&&r({type:"dens",dens:g.dens}))},[c,g]);const u=p.useCallback(()=>{if(!g){s(null);return}const w=document.querySelector(g.sel);if(!w){s(null);return}w.scrollIntoView({block:"nearest",behavior:"smooth"}),s(w.getBoundingClientRect())},[g]);p.useLayoutEffect(()=>{u();const w=window.setTimeout(u,260),C=()=>u();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(w),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[u]);const y=p.useRef(a);if(y.current=a,p.useEffect(()=>{const w=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),y.current()):C.key==="ArrowRight"?f(z=>z+1):C.key==="ArrowLeft"&&f(z=>Math.max(0,z-1))};return document.addEventListener("keydown",w,!0),()=>document.removeEventListener("keydown",w,!0)},[]),!v.length)return null;let S=null;if(x){const w=l[3]||0,C=o.find(z=>z.memoUrl)||[...i.values()].find(z=>z.memoUrl);w>0?S={title:w===1?n.ahaATitle1:n.ahaATitleN(w),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:C?S={title:n.ahaBTitle,body:n.ahaBBody(C.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:C.id}),a()}}:S={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let j={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Me};if(!x&&h){const w=h.bottom+14,z=window.innerHeight-w>190?w:Math.max(12,h.top-200);j={left:Math.min(Math.max(12,h.left+h.width/2-Me/2),window.innerWidth-Me-12),top:z,width:Me}}return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!x&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-qe,top:h.top-qe,width:h.width+qe*2,height:h.height+qe*2}}),(x||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(x?" fin":""),style:j,children:[x&&S?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:S.title}),e.jsx("p",{children:e.jsx(kt,{text:S.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>f(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:S.go,children:S.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(c+1,v.length)}),e.jsx("h3",{children:g==null?void 0:g.title}),e.jsx("p",{children:e.jsx(kt,{text:(g==null?void 0:g.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>f(w=>Math.max(0,w-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>f(w=>w+1),children:c===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Lr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:l}=T(),o=p.useMemo(()=>t.filter(s=>we(s.date)===0&&s.kind==="target"),[t]),i=p.useMemo(()=>o.filter(s=>a?te(s)===0:!Z(s)),[o,a]),d=o.length-i.length,c=o.length?Math.min(100,d/o.length*100):100;let f;a?f=n.morningThesis(o.length,d,i.length):o.length?d===0?f=n.goalSourced(o.length):d>=o.length?f=n.goalCleared:f=n.goalDone(d,o.length):f=n.goalSourced(0);const h=()=>{a?(l({type:"ptab",tab:0}),l({type:"filters",patch:{win:"1"}})):l({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:f}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:c+"%"}})}),i.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?n.morningEval(i.length):r.pileMode?n.goalContinue(i.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Or(){var q;const{t,st:a,dispatch:n,token:r,fund:l,data:o,dossiers:i,mode:d,doSync:c,startTour:f}=T(),[h,s]=p.useState(null),[v,b]=p.useState([]),[m,g]=p.useState(!1),x=d==="client";p.useEffect(()=>{if(!r||!l)return;let L=!0;return(async()=>{const[O,M]=await Promise.all([Ot(l),Ft(r)]);L&&(O&&s(O),b(M))})(),()=>{L=!1}},[r,l]);const u=(h==null?void 0:h.per_day)??null,y=((q=h==null?void 0:h.pool_order)==null?void 0:q.length)??0,S=v.filter(L=>L.status==="running").length,j=L=>{if(!x||u===null||m)return;const O=Math.max(0,Math.min(10,u+L));O!==u&&(g(!0),s(M=>M&&{...M,per_day:O}),Dt(r,O).then(M=>{g(!1),s(M===null?A=>A&&{...A,per_day:u}:A=>A&&{...A,per_day:M})}))},w=p.useMemo(()=>i.filter(L=>L.kind==="target"&&Z(L)).length,[i]),C=o.marketEstimate,z=C&&C>0?Math.min(100,Math.round(w/C*100)):null,N=(l||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const L=Date.parse(o.generatedAt||"");if(Number.isNaN(L))return"";const O=new Date(L),M=A=>String(A).padStart(2,"0");return`${M(O.getDate())}/${M(O.getMonth()+1)} à ${M(O.getHours())}:${M(O.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:l})]}),e.jsx("h1",{children:t.identTitle(l||"…")}),e.jsx("span",{className:"idsp"}),E&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(E)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:f,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[z!==null&&C&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:z+"%"}})}),e.jsxs("b",{children:[z," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(w,C)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),u!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:L=>{L.stopPropagation(),j(-1)},children:"−"}),e.jsx("b",{className:"q",children:u})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:L=>{L.stopPropagation(),j(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),u===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),S>0&&e.jsxs("span",{className:"ev",children:["⏳ ",S]}),e.jsx("span",{className:"ego",children:t.identPending(y)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!x,onClick:c,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function Fr(){const{t,counts:a,dispatch:n}=T();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,l],o)=>{const i=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(i?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:l}),i&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Dr=["--p0","--p1","--p2","--p3","--p4"];function Rr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:l}=T(),o=p.useRef({});p.useEffect(()=>{o.current={...n}},[n]);const i=f=>{const h=o.current[f],s=h!==void 0?n[f]-h:0;return e.jsxs("button",{type:"button",className:"step"+(f===3&&n[3]>0?" wait":""),style:{"--c":`var(${Dr[f]})`,"--tc":f<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===f,title:r.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[e.jsxs("span",{className:"l",children:[r.plabels[f].toUpperCase(),f===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[f],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},f)},d=(f,h,s)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":f===5?"var(--p5)":f===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===f,title:r.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[f]})]},f),c=(f,h,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:v,onClick:s,children:f},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(i)}),e.jsxs("div",{className:"offtrack",children:[d(5,!1,r.plabels[5]),d(7,!0,r.plabels[7]),d(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",r.toolUndo,l,t.undo.length===0),c("↺",r.toolReset,()=>{a({type:"reset"})}),c("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const qr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Mr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:l,doAnalyse:o,mode:i}=T(),d=p.useRef(null),[c,f]=p.useState(60);p.useEffect(()=>{let b=0;const m=()=>{var S;const g=d.current;if(!g)return;const x=(S=g.parentElement)==null?void 0:S.querySelector('.funnel [aria-selected="true"]');if(!x)return;const u=x.getBoundingClientRect(),y=g.getBoundingClientRect();f(Math.max(20,Math.min(u.left+u.width/2-y.left,y.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const h=t.ptab;let s=n.tuto[h].p;if(h===3){const b=r.filter(x=>x.kind==="target"&&te(x)===3),m=b.filter(x=>Ye(x)==="auto").length,g=b.filter(x=>Ye(x)==="cd").length;s=n.tutoPending(m,g,b.length)}const v=(()=>{if(i!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(h===1){const b=r.filter(m=>m.kind==="target"&&te(m)===1&&!l.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>o(m))}}return null})();return e.jsxs("div",{ref:d,className:"tuto mini",style:{"--bg":qr[h],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const jt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Nt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Pr(t,a){const[n,r]=p.useState(1);return p.useEffect(()=>{let l=!0,o=0;const i=()=>{var f;if(!l)return;const c=(f=t.current)==null?void 0:f.getScreenCTM();c&&c.a>0?r(c.a):o=requestAnimationFrame(i)};i();const d=new ResizeObserver(()=>i());return t.current&&d.observe(t.current),window.addEventListener("resize",i),()=>{l=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",i)}},[t,a]),n}function Ir(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:l,markedId:o,byId:i,lang:d,t:c}=T(),f=p.useRef(null),h=p.useRef(null),s=Qe.find(N=>N.key===t.continent),v=Pr(f,t.continent+":"+t.mapFolded),[b,m]=p.useState(new Map),[g,x]=p.useState(null);p.useEffect(()=>{const N=f.current;if(!N)return;const E=new Map;N.querySelectorAll("path[data-i2]").forEach(q=>{const L=q.dataset.i2;if(L)try{const O=q.getBBox();O.width>0&&E.set(L,{x:O.x,y:O.y,w:O.width,h:O.height})}catch{}}),m(E)},[t.continent,v]);const u=p.useMemo(()=>n.filter(N=>N.cc),[n]),y=p.useMemo(()=>{const N=new Map;return u.forEach(E=>N.set(E.cc,(N.get(E.cc)||0)+1)),N},[u]),S=p.useMemo(()=>u.map(N=>{const E=N.cc?b.get(N.cc):void 0;if(!E)return null;const q=Nt(N.name||N.id||""),L=Nt((N.id||N.name||"")+"·y"),O=(q-.5)*Math.min(E.w*.55,60),M=(L-.5)*Math.min(E.h*.55,60);return{d:N,x:E.x+E.w/2+O,y:E.y+E.h/2+M}}).filter(N=>!!N),[u,b]),j=N=>v>0?N/v:N,w=p.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:jt[N],fr:c.plabels[N].toUpperCase(),en:c.plabels[N].toUpperCase(),n:n.filter(E=>E.kind==="target"&&te(E)===N).length})).filter(N=>N.n>0):ct.map((N,E)=>({...N,n:n.filter(q=>pt(q)===E).length})),[n,r,c.plabels]),C=o?i.get(o):null,z=C?S.find(N=>N.d.id===C.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:f,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?s.fr:s.en,onMouseLeave:()=>{x(null),l(null)},children:[e.jsx("g",{children:s.countries.map((N,E)=>e.jsx("g",{className:"ct"+(N.i2&&y.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},E))}),e.jsx("g",{children:S.map(N=>{const E=ct[pt(N.d)],q=!!Q(N.d),L=N.d.kind==="target",O=r&&L?jt[te(N.d)]:E.c,M=!r&&Z(N.d);return e.jsxs("g",{className:"co"+(M?" done":""),onMouseEnter:()=>{var R,H;const A=(R=h.current)==null?void 0:R.getBoundingClientRect(),I=(H=f.current)==null?void 0:H.createSVGPoint();if(I&&f.current&&A){I.x=N.x,I.y=N.y;const le=I.matrixTransform(f.current.getScreenCTM());x({x:le.x-A.left,y:le.y-A.top,label:N.d.name+" · "+(ke(N.d.cc,d)||N.d.countryLabel||"")})}l(N.d.id)},onMouseLeave:()=>{x(null),l(null)},onClick:()=>{var R;const A=(R=f.current)==null?void 0:R.createSVGPoint();let I=null;if(A&&f.current){A.x=N.x,A.y=N.y;const H=A.matrixTransform(f.current.getScreenCTM());I={x:H.x,y:H.y}}a({type:"popup",id:N.d.id,anchor:I})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:j(Math.max(11,E.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:j(E.px),fill:O,stroke:q?"#DC2626":"#ffffff",strokeWidth:j(q?2.2:1.3)})]},N.d.id||N.d.name)})}),z&&e.jsx("circle",{className:"ring on",cx:z.x,cy:z.y,r:j(13),fill:"none",stroke:"#0F172A",strokeWidth:j(2)})]}),e.jsx("div",{className:"hov"+(g?" on":""),style:g?{left:g.x,top:g.y}:void 0,children:g==null?void 0:g.label}),e.jsx("div",{className:"legend",children:w.map((N,E)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),d==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},E))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function Br(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:l,contName:o}=T(),i=t.filters,d=p.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),c=b=>d.filter(m=>b!=="country"&&i.country.length&&!i.country.includes(m.cc||"")?!1:et(m,i,l,b==="country"?void 0:b)),f=p.useMemo(()=>{const b=c("win"),m=g=>b.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=g).length;return[m(0),m(7),m(30),b.length]},[d,i,l]),h=p.useMemo(()=>{if(l)return null;const b=c("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(g=>{m[de(g)]+=1}),m},[d,i,l]),s=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.win!=="all"?1:0)+(!l&&i.status!=="all"?1:0)+(i.search.trim()?1:0),v=(b,m,g,x="fbtn")=>e.jsxs("button",{type:"button",className:x,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":i.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:f[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:i.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!l&&h&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":i.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:h[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,i.sector.length),v("pay",r.fCountry,i.country.length),v("det",r.fEngine,i.engine.length),v("sta",r.fStage,i.stage.length),l&&v("ang","Angle",i.angle.length),l&&v("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(d.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx($r,{poolFor:c})]})}function $r({poolFor:t}){const{st:a,dispatch:n,t:r,lang:l}=T(),o=a.filters,i=a.openFacet,{title:d,cols:c,options:f}=p.useMemo(()=>{if(i==="sig"){const m=t("signal").filter(u=>Q(u)),g=new Map;m.forEach(u=>{const y=u.engine||"";g.set(y,(g.get(y)||0)+1)});const x=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ut([...g.keys()],l).map(u=>({v:u,label:ye(u)+" "+se(u,l),n:g.get(u)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(u)}))];return{title:r.fpSigTitle,cols:2,options:x}}if(i==="sec"){const m=t("sector"),g=new Map;return m.forEach(x=>{x.sector&&g.set(x.sector,(g.get(x.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x,n:u,html:!1,on:o.sector.includes(x)}))}}if(i==="pay"){const m=t("country"),g=new Map;return m.forEach(x=>{x.cc&&g.set(x.cc,(g.get(x.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:ke(x,l)||x,n:u,html:!1,on:o.country.includes(x)}))}}if(i==="det"){const m=t("engine"),g=new Map;return m.forEach(x=>{x.engine&&g.set(x.engine,(g.get(x.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:ut([...g.keys()],l).map(x=>({v:x,label:ye(x)+" "+se(x,l)+' <span style="color:var(--dim);font-size:10px">· '+Na(Sa(x),l)+"</span>",n:g.get(x)||0,html:!0,on:o.engine.includes(x)}))}}if(i==="ang"){const m=t("angle"),g=new Map;return m.forEach(x=>{x.angle&&g.set(x.angle,(g.get(x.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x.replace(/[_-]+/g," "),n:u,html:!1,on:o.angle.includes(x)}))}}if(i==="mem"){const m=t("memoLevel"),g=new Map;m.forEach(u=>{if(u.kind==="target"){const y=Ke(u);g.set(y,(g.get(y)||0)+1)}});const x=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:x[u],n:g.get(u)||0,html:!1,on:o.memoLevel.includes(u)}))}}const v=t("stage"),b=new Map;return v.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,g)=>g[1]-m[1]).map(([m,g])=>({v:m,label:m,n:g,html:!1,on:o.stage.includes(m)}))}},[i,a,l]),h=v=>{if(i==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(v)?o.signalEngines.filter(g=>g!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(i==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage",value:v})},s=()=>{n(i==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:i==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:d}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>h(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const St=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Vr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:l,dispatch:o,evalBusy:i,evalCards:d,caps:c,data:f}=T(),h=a==="client",[s,v]=p.useState(""),[b,m]=p.useState(!1),[g,x]=p.useState(""),[u,y]=p.useState(!1),[S,j]=p.useState(""),[w,C]=p.useState([]),z=p.useRef(!1),N=s.trim()?St.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,E=p.useMemo(()=>g.split(`
`).map(A=>A.trim()).filter(Boolean).slice(0,15),[g]),q=w.length?w:d,L=f.credits,O=()=>{const A=s.trim();A&&(r(null,A),v(""))},M=async()=>{if(!h){r(null,E[0]||"");return}if(!E.length||u)return;y(!0),z.current=!1;const A=[];for(let I=0;I<E.length&&!z.current;I++){j(t.evaluating(I+1,E.length,E[I]));const R=await Rt(n,E[I],"atelier2");if(A.unshift({name:R.company||E[I],verdict:R.verdict,reason:R.reason||"",remaining:R.remaining??null}),C([...A]),R.verdict==="quota"){A.unshift({name:"",verdict:"quota",reason:t.quota(E.length-I-1),remaining:0}),C([...A]);break}}j(""),x(""),y(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:A=>v(A.target.value),onKeyDown:A=>{A.key==="Enter"&&O()}}),e.jsx("span",{className:"detect"+(St.test(s.trim())?" url":""),children:N})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:O,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),c.showCredits&&L&&e.jsxs("button",{type:"button",className:"credits"+(L.total_available<=0&&!L.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:L.unlimited?"∞":L.total_available}),!L.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",L.daily_grant+L.purchased]}),L.total_available<=0&&!L.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:A=>x(A.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!E.length,onClick:()=>{M()},children:[e.jsx("span",{className:"fill"}),u&&S?S:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(E.length)})]})]}),q.slice(0,1).map((A,I)=>{const R=A.verdict==="kept",H=A.verdict==="quota",le=R?"var(--brand)":H?"var(--bolt)":"var(--red)",ce=R?"var(--brand-l)":H?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":le,"--bgc":ce},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:R?"✓ "+t.kept:H?"⏳":"✗ "+t.dropped})}),A.name&&e.jsx("span",{className:"rn",children:A.name}),e.jsx("span",{className:"rr",children:A.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",A.reason]}):null}),!H&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(R?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},I)}),h&&(l.kept+l.dropped>0||q.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(l.kept,l.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Ur(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function _r(){const{st:t,dispatch:a,byId:n,t:r,doDeep:l}=T(),o=t.memoConsole?n.get(t.memoConsole):null,i=p.useMemo(()=>o?[o.reasoning||"",Ur(o.summary||"")].filter(Boolean).join(`
...
`).map((f,h)=>e.jsx("p",{style:{margin:"0 0 10px"},children:f},h)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[Je(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>l(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:c===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const Hr=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Pe=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Yr(t){const a=String(t||"");if(!a)return"";let n="",r=0;for(;r<a.length;){const l=a.indexOf("<",r);if(l<0){n+=Pe(a.slice(r));break}n+=Pe(a.slice(r,l));const o=a.indexOf(">",l);if(o<0){n+=Pe(a.slice(l));break}const i=a.slice(l+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(i),c=d?d[2].toLowerCase():"";d&&Hr.has(c)?n+=`<${d[1]}${c}>`:n+=Pe(a.slice(l,o+1)),r=o+1}return n}const Ct=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function K({k:t,v:a,href:n}){return a==null||a===""?null:e.jsxs("div",{className:"cdl",children:[e.jsx("span",{className:"cdk",children:t}),n?e.jsx("a",{className:"cdv",href:n,target:"_blank",rel:"noopener noreferrer",children:String(a)}):e.jsx("span",{className:"cdv",children:String(a)})]})}function Wr({o:t}){const{t:a,lang:n,dispatch:r,caps:l}=T(),o=Xe(t),i=Le(t),d=(t.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[t.sector,t.stage,t.countryLabel,t.city,t.website,t.domain,t.linkedinCompany,t.angle,t.date].filter(Boolean).length,f=[t.contactName,t.contactEmail,t.contactLinkedin].filter(Boolean).length,h=[t.ceoStatus,t.ceoNote,l.pipe?t.memoUrl:"",l.pipe?t.memoPdfUrl:""].filter(Boolean).length+(typeof t.engagement=="number"&&t.engagement>0?1:0),s=p.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(t.reasoning?1:0)+(i?1:0)},{k:"ana",lib:a.cdAnalyse,n:t.summary?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:h}].filter(g=>g.n>0),[t,a,d,i,c,f,h]),[v,b]=p.useState("");if(!s.length)return null;const m=s.some(g=>g.k===v)?v:s[0].k;return e.jsxs("div",{className:"cdtabs",children:[e.jsx("div",{className:"cdnav",role:"tablist",children:s.map(g=>e.jsx("button",{type:"button",role:"tab","aria-selected":m===g.k,className:m===g.k?"on":"",onClick:x=>{x.stopPropagation(),b(g.k)},children:g.lib},g.k))}),e.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[m==="conv"&&e.jsxs(e.Fragment,{children:[d&&e.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[e.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),e.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.reasoning&&e.jsx("p",{className:"cdtxt",children:t.reasoning}),i&&e.jsxs("div",{className:"cdv1 memo",children:[e.jsx("b",{children:i}),e.jsx("span",{className:"cdw",children:a.cdMemo(t.memoType||"")})]}),e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(K,{k:a.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(K,{k:a.cdVerdictDate,v:Ct(t.verdictDate,n)})]})]}),m==="ana"&&t.summary&&e.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Yr(t.summary)}}),m==="soc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdSector,v:t.sector}),e.jsx(K,{k:a.cdStage,v:t.stage}),e.jsx(K,{k:a.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(K,{k:a.cdSite,v:t.domain||t.website,href:t.website||void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.linkedinCompany?"LinkedIn":"",href:t.linkedinCompany}),e.jsx(K,{k:a.cdAngle,v:t.angle}),e.jsx(K,{k:a.cdDetected,v:Ct(t.date,n)})]}),m==="ctc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdName,v:t.contactName}),e.jsx(K,{k:a.cdEmail,v:t.contactEmail,href:t.contactEmail?`mailto:${t.contactEmail}`:void 0}),e.jsx(K,{k:a.cdLinkedin,v:t.contactLinkedin?"LinkedIn":"",href:t.contactLinkedin})]}),m==="suivi"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cdgrid",children:[e.jsx(K,{k:a.cdCeoStatus,v:t.ceoStatus}),e.jsx(K,{k:a.cdEngagement,v:typeof t.engagement=="number"&&t.engagement>0?t.engagement:""})]}),t.ceoNote&&e.jsxs("p",{className:"cdtxt",children:["💬 ",t.ceoNote]}),l.pipe&&(t.memoUrl||t.memoPdfUrl)&&e.jsxs("div",{className:"cdacts",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),t.memoPdfUrl&&e.jsx("a",{className:"abtn",href:t.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function $t({name:t}){const{t:a,token:n,caps:r,mode:l,flashErr:o}=T(),[i,d]=p.useState(!1),[c,f]=p.useState(null);if(!r.pipe||l!=="client"||r.lockActions)return null;const h=async()=>{if(i)return;d(!0);const s=await Ca(n,t);if(d(!1),!s){o(a.actErr);return}f(s.results||[])};return e.jsxs("div",{className:"simb",onClick:s=>s.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{h()},children:i?a.similarBusy:a.similar}),c&&(c.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:c.map(s=>e.jsxs("li",{children:[e.jsx("b",{className:s.verdict==="kept"?"ok":"ko",children:s.company}),s.reason&&e.jsx("span",{children:s.reason})]},s.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Vt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function at({o:t}){const{t:a}=T(),n=Xe(t),r=Le(t),l=te(t),o=Ye(t),i=za(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Vt[r]||"v-cons"),title:a.vt[r],children:r}):l===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,l===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),l===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),l===3&&i!==null&&e.jsx("span",{className:"wait2 "+(i>10?"hot":i>=5?"warm":""),title:a.waitTitle(i),children:a.waitChip(i)})]})}function zt({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:l}=T(),[o,i]=p.useState(!1);if(p.useEffect(()=>{r||i(!1)},[r]),Z(t)){const f=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[f?"✓":"✗"," ",e.jsx("b",{children:f?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const c=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:r,onClick:f=>{f.stopPropagation(),i(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function Gr({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:l,doAnalyse:o,doDecide:i,doPromote:d,doRepeche:c,doApproach:f,dispatch:h}=T();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),h({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(zt,{o:t})});const s=te(t),v=b=>m=>{m.stopPropagation(),b()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(zt,{o:t})});if(s===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:v(()=>o(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:v(()=>i(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:v(()=>i(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const b=l.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:v(()=>f(t)),children:b?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>d(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>c(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:v(()=>h({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function Kr({o:t}){const{t:a,doThumb:n,thumbOf:r}=T(),l=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(l==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(l==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function Qr({o:t}){const{lang:a}=T();return Q(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(je,{o:t}),e.jsx(Be,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ye(t.engine||"")," ",se(t.engine||"",a)]})})}function Jr({o:t,locked:a,open:n,onToggle:r}){const{st:l,dispatch:o,caps:i,markRow:d,markedId:c,favIds:f,toggleFav:h}=T(),s=te(t),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,m=b<=0?0:b<=7?1:b<=30?2:3,g=i.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:v[m],x=f.has(t.id),u=y=>{if(a)return;if(i.pipe){r();return}const S=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"row"+(c===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>d(t.id),onMouseLeave:()=>d(null),onClick:u,children:[e.jsx("span",{className:"pt",style:{"--c":g}}),e.jsx(Ht,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[i.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:x?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),h(t)},children:x?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(Xr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(Qr,{o:t}),i.pipe&&e.jsx(at,{o:t}),i.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(Gr,{o:t}),i.showThumbs&&e.jsx(Kr,{o:t})]}),(n||l.dens==="deplie")&&!a&&e.jsx(Zr,{o:t})]})}function Xr({o:t}){const{lang:a,caps:n}=T();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=Ze(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function Zr({o:t}){const{t:a,lang:n,dispatch:r,caps:l,outbound:o,doOnboard:i}=T();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),e.jsx(Wr,{o:t}),e.jsx(Cr,{o:t}),e.jsx(Tr,{o:t}),e.jsx($t,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(at,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ye(t.engine||"")," ",se(t.engine||"",n)]}),Q(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(je,{o:t})})]}),l.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>i(t),children:a.actOnboard})]})]})]})}function en({o:t,locked:a}){const{t:n,dispatch:r,caps:l,doDecide:o}=T(),i=te(t),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][i];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":d},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(at,{o:t}),Q(t)&&e.jsx(je,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&l.pipe&&i===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function tn(){const t=T(),{st:a,dispatch:n,t:r,caps:l,scoped:o,lang:i,sessTally:d,data:c,dossiers:f}=t,[h,s]=p.useState(new Set);p.useEffect(()=>{s(new Set)},[a.ptab,a.continent]);const v=w=>s(C=>{const z=new Set(C);return z.has(w)?z.delete(w):z.add(w),z}),b=p.useMemo(()=>tt(o,a.sort),[o,a.sort]),m=p.useMemo(()=>b.filter(w=>Q(w)&&!Z(w)).length,[b]),g=l.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,x=(w,C,z="",N=!1)=>e.jsxs("button",{type:"button","data-s":w,className:z,"aria-sort":a.sort.key===w?a.sort.dir===1?"ascending":"descending":"none",style:N?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:w}),children:[C,e.jsx("span",{className:"ar",children:a.sort.key===w&&a.sort.dir===1?"▴":"▾"})]},w),u=p.useMemo(()=>{if(l.pipe||a.groupBy==="none")return null;const w=new Map;return b.forEach(C=>{const z=C.engine||"?";w.has(z)||w.set(z,[]),w.get(z).push(C)}),[...w.entries()]},[b,l.pipe,a.groupBy]),y=l.lockRowsAfter;let S=0;const j=(w,C)=>{const z=a.shown[C]||Ie,E=w.slice(0,z).map(q=>{const L=y!==null&&S>=y;return S++,a.dens==="maxi"?e.jsx(en,{o:q,locked:L},q.id):e.jsx(Jr,{o:q,locked:L,open:h.has(q.id),onToggle:()=>v(q.id)},q.id)});return w.length>z&&E.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:C,by:Ie}),children:r.more(Math.min(Ie,w.length-z),w.length-z)},C+":more")),E};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:b.length})," ",g]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,l.pipe&&t.fund?" · "+t.fund:""]}),l.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),l.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([w,C])=>e.jsxs("button",{type:"button","data-d":w,"aria-pressed":a.dens===w,onClick:()=>n({type:"dens",dens:w}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:C})]},w))}),l.showChain&&b.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:b.filter(w=>l.pipe?!0:!Z(w)).map(w=>w.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",l.pipe?r.browse(b.length):r.chainAll(b.filter(w=>!Z(w)).length)]})]}),m>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(m)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),x("country",r.colCountry),x("name",r.colCompany),x("amount",r.colAmount,"h-amt",!0),x("stage",r.colStage,"h-stade"),x("signal",r.colSignal,"h-sig"),l.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),l.pipe&&x("score",r.colScore,"h-sc",!0),e.jsx("span",{}),l.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[u?u.map(([w,C])=>e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ye(w)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:se(w,i)}),e.jsx("div",{className:"s",children:r.grpCount(C.filter(z=>!Z(z)).length,C.length)})]})]}),j(C,w)]},w)):j(b,"pt"+a.ptab),!b.length&&!(c.loading&&!f.length)&&e.jsx("div",{className:"void",children:l.pipe?r.emptyTab:r.emptyScope})]}),l.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(d.kept>0||d.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(d.kept,d.dropped)}})]})}const an=`
...
`;function rn(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,l=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let i=t.y+10;return i+n>l-8&&(i=Math.max(8,t.y-n-14)),i<8&&(i=8),{left:o,top:i}}function nn(){const{st:t,dispatch:a,byId:n,t:r,lang:l,caps:o,mode:i,askEvaluate:d,doAnalyse:c,doDecide:f,doPromote:h,doRepeche:s,doApproach:v,doDeep:b,doOnboard:m,outbound:g,evalBusy:x}=T(),u=t.popupId?n.get(t.popupId):null;if(!u)return null;const y=Q(u),S=te(u),j=Le(u),w=u.kind==="target",C=z=>{a({type:"filters",patch:z}),a({type:"popup",id:null})};return Ae.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:an}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:rn(t.popupAnchor),onClick:z=>z.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:u.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(we(u.date)),se(u.engine,l))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[u.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[u.cc]}),children:(ke(u.cc,l)||u.countryLabel||"").toUpperCase()}),u.sector&&e.jsx("button",{type:"button",onClick:()=>C({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&e.jsx("button",{type:"button",onClick:()=>C({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am2",children:Ze(u.amountEur,l)})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[ye(u.engine)," ",e.jsx("b",{children:se(u.engine,l)})," — ",Ea(u.engine,l),u.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",u.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(je,{o:u,lg:!0})," ",e.jsx(Be,{o:u,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(qt(y,l))," · ",r.win7(Mt(y,l))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&S>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),o.pipe&&w&&j&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[j,typeof u.score=="number"&&u.score>0?" · "+r.score(u.score):""]})})]}),e.jsx($t,{name:u.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||i!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[S===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>d(u),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),S===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),S===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),S===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(u,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(u,!1),a({type:"popup",id:null})},children:r.actNo}),Je(u)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{b(u),a({type:"popup",id:null})},children:r.memoDeep})]}),S===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{v(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),S===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),u.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),g&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{m(u),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>d(u),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),u.website&&e.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}function Et(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function on(t,a){const n=Ta(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function ln(t,a){const r=[a.head.split("|").map(Et).join(";")];for(const l of t){const o=a.stageOf(l);r.push([l.name||"",on(l,a.plabels),Xe(l)||l.verdict||"",typeof l.score=="number"?l.score:"",l.countryLabel||l.cc||"",l.sector||"",o?a.stageLabel(o.stage):"",l.contactName||"",l.contactEmail||"",l.memoUrl||"",(l.date||"").slice(0,10),(l.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Et).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function sn(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const dn=50;function rt({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:l}=T(),[o,i]=p.useState(null),[d,c]=p.useState(!1),[f,h]=p.useState(""),[s,v]=p.useState(0),[b,m]=p.useState(""),[g,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>()=>{u.current&&window.clearInterval(u.current)},[]);const y=async j=>{c(!0),h("");const w=await a();if(c(!1),w.ok){i(w);return}if(w.busy){h(l.alertPreviewBusy);return}if(!j){h(l.alertPreviewFail);return}v(dn),u.current=window.setInterval(()=>{v(C=>C>1?C-1:(u.current&&window.clearInterval(u.current),y(!1),0))},1e3)},S=async()=>{if(r||g)return;x(!0),m("");const j=await n();x(!1),m(j.ok?l.alertTestOk(j.sentTo||""):j.error||l.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:d||s>0,onClick:()=>{y(!0)},children:d?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||g,onClick:()=>{S()},children:g?"…":l.alertTest})]}),s>0&&e.jsx("p",{className:"mnote",children:l.alertPreviewRetry(s)}),f&&e.jsx("p",{className:"mnote warn",children:f}),b&&e.jsx("p",{className:"mnote",children:b}),!b&&e.jsx("p",{className:"mnote dim",children:l.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:l.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:l.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Te="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function ee({title:t,icon:a,children:n,wide:r}){const{dispatch:l}=T();return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&l({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>l({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function cn(){const{st:t}=T();switch(t.modal){case"chain":return e.jsx(un,{});case"space":return e.jsx(fn,{});case"alert":return e.jsx(mn,{});case"queue":return e.jsx(vn,{});case"export":return e.jsx(yn,{});case"plug":return e.jsx(jn,{});case"recharge":return e.jsx(Sn,{});case"cover":return e.jsx(Cn,{});case"crit":return e.jsx(zn,{});case"tuto":return e.jsx(En,{});case"rdv":return e.jsx(pn,{});case"memoalert":return e.jsx(wn,{});default:return null}}function pn(){const{dispatch:t,fund:a}=T(),n=typeof document<"u"&&!!document.getElementById("rdv");return p.useEffect(()=>{n&&(t({type:"modal",modal:null}),br())},[n,t]),n?null:e.jsx(Oa,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function un(){const{st:t,dispatch:a,byId:n,t:r,lang:l,mode:o,askEvaluate:i,evalBusy:d}=T(),c=o==="client",f=t.chain.queue.map(b=>n.get(b)).filter(b=>!!b),h=t.chain.idx,s=f[h],v=h>=f.length;return Ae.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:v?r.finished:`${h+1} / ${f.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(v?100:h/Math.max(1,f.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:v||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(f.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[ke(s.cc,l)||s.countryLabel,s.sector,s.stage,r.daysAgo(we(s.date))].filter(Boolean).map(b=>String(b).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:se(s.engine,l).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:Ze(s.amountEur,l)})]}),Q(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(je,{o:s,lg:!0})," ",e.jsx(Be,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),c&&Z(s)&&e.jsxs("div",{className:"vbox",style:{"--c":de(s)==="retenu"?"var(--brand)":de(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:de(s)==="retenu"?"✓ "+r.kept:de(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!v&&s&&!(c&&Z(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{i(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?r.closeBtn:r.skip})]})]})})}),document.body)}function fn(){const{st:t,dispatch:a,dossiers:n,t:r,mode:l}=T(),o=l==="client",i=p.useMemo(()=>o?n.filter(s=>Z(s)):[],[n,o]),d=p.useMemo(()=>tt(i.filter(s=>de(s)==="retenu"),{key:"signal",dir:-1}),[i]),c=p.useMemo(()=>i.filter(s=>de(s)==="ecarte"),[i]),f=t.spaceTab==="retenu"?d:c,h=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(ee,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:d.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),f.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),f.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":h},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function mn(){const{mode:t}=T();return t==="client"||t==="apercu"?e.jsx(xn,{}):e.jsx(bn,{})}function xn(){const{t,token:a,flash:n,flashErr:r,mode:l}=T(),[o,i]=p.useState("d"),d=l!=="client";return e.jsxs(ee,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>i("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>i("w"),children:t.alertTabWeekly})]}),o==="d"?e.jsx(gn,{t,token:a,readOnly:d,flash:n,flashErr:r}):e.jsx(hn,{t,token:a,readOnly:d,flash:n,flashErr:r})]})}function gn({t,token:a,readOnly:n,flash:r,flashErr:l}){const[o,i]=p.useState(null),[d,c]=p.useState(!1),[f,h]=p.useState(0);p.useEffect(()=>{let m=!0;return c(!1),xt(a).then(g=>{m&&(g?i(g):c(!0))}),()=>{m=!1}},[a,f]);const s=m=>{n||xt(a,m).then(g=>{if(!g){l(t.actErr);return}i(g),g.throttled?l(t.alertThrottled):r(t.alertSaved)})};if(d)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=m=>!o.sections||o.sections.includes(m),b=m=>{const g=o.sections||t.alertSec.map(([x])=>x);s({sections:v(m)?g.filter(x=>x!==m):[...g,m]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>s({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([m,g])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:v(m),disabled:n,onChange:()=>b(m)}),e.jsxs("span",{children:[g,m==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},m))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(rt,{label:t.alertPreview,readOnly:n,onPreview:()=>Pa(a),onTest:()=>Ma(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function hn({t,token:a,readOnly:n,flash:r,flashErr:l}){const[o,i]=p.useState(null),[d,c]=p.useState(!1),[f,h]=p.useState(0);p.useEffect(()=>{let m=!0;return c(!1),gt(a).then(g=>{m&&(g?i(g):c(!0))}),()=>{m=!1}},[a,f]);const s=m=>{n||gt(a,m).then(g=>{if(!g){l(t.actErr);return}i(g),r(t.alertSaved)})};if(d)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>h(m=>m+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const v=o.dow??0,b=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>s({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:v,disabled:n,onChange:m=>s({dow:Number(m.target.value)}),children:t.alertDow.map((m,g)=>e.jsx("option",{value:g,children:m},m))}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.max(6,b-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[b," h"]}),e.jsx("button",{type:"button",onClick:()=>s({hour:Math.min(21,b+1)}),disabled:n,children:"＋"})]})]}),e.jsx(rt,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>Ba(a),onTest:()=>Ia(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function bn(){const{st:t,t:a,lang:n,scoped:r,contName:l}=T(),[o,i]=p.useState(""),[d,c]=p.useState(!1),[f,h]=p.useState(!1),s=t.filters,v=p.useMemo(()=>r.filter(x=>Q(x)).length,[r]),b=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,m=async()=>{if(!(!/.+@.+\..+/.test(o)||f)){h(!0);try{await fetch(`${Ge}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),c(!0)}finally{h(!1)}}},g=[[a.amRows.continent,l],[a.amRows.since,a.amSince[b]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(x=>se(x,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(x=>ke(x,n)||x).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(ee,{title:a.alertTitle,icon:"🔔",children:d?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(o)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:g.map(([x,u])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:x}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:u}})]},x))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:o,onChange:x=>i(x.target.value),onKeyDown:x=>{x.key==="Enter"&&m()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},onClick:()=>void m(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function vn(){var g,x,u;const{t,token:a,fund:n,mode:r,flash:l}=T(),[o,i]=p.useState(null),[d,c]=p.useState([]),[f,h]=p.useState(0),s=r==="client";p.useEffect(()=>{let y=!0;return(async()=>{const[S,j]=await Promise.all([Ot(n),Ft(a)]);y&&(S&&i(S),c(j))})(),()=>{y=!1}},[a,n,f]);const v=(o==null?void 0:o.per_day)??2,b=((g=o==null?void 0:o.analyzed_today)==null?void 0:g.length)??0,m=(x=o==null?void 0:o.tomorrow)!=null&&x.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(ee,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(b,b+(((u=o==null?void 0:o.pool_order)==null?void 0:u.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(y=>e.jsx("button",{type:"button",className:"qr"+(v===y?" on":""),disabled:!s,onClick:()=>{Dt(a,y).then(S=>{S!==null&&(h(j=>j+1),l(t.alertSaved))})},children:e.jsxs("b",{children:[y,"/j"]})},y))})]}),d.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:d.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{mt(a,y.company,"retry").then(()=>h(S=>S+1))},children:t.queueRetry}),s&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{mt(a,y.company,"delete").then(()=>h(S=>S+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[m.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),m.slice(0,10).map((y,S)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",S+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function yn(){const{t,token:a,flash:n,scoped:r,caps:l,stageOf:o,dispatch:i}=T(),d=`${Te}/cibles/list.csv?token=${a}`,c=`${Te}/cibles/list.json?token=${a}`,f=`${Te}/cibles/export.xlsx?token=${a}&scope=full`,h=`=IMPORTDATA("${d}")`,s=x=>{var u;(u=navigator.clipboard)==null||u.writeText(x).then(()=>n(t.exportCopied))},v=[{def:t.exportCsv,value:d,href:d},{def:t.exportSheet,value:h},{def:t.exportLive,value:c,href:c},{def:t.exportXlsx,value:f,href:f}],b=!l.lockActions&&r.length>0,m=()=>{sn(ln(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:x=>(t.stg.find(([u])=>u===x)||["",""])[1]})),n(t.exportViewDone(r.length))},g=()=>{i({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(ee,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),b&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:g,children:t.printBtn})]})}),b&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:m,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:v.map(({def:x,value:u,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:x[0]}),e.jsxs("div",{children:[e.jsx("b",{children:x[1]}),e.jsx("p",{children:x[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>s(u),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},x[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function wn(){const{t,token:a,flash:n,flashErr:r,mode:l}=T(),o=l!=="client",[i,d]=p.useState(null),[c,f]=p.useState(!1),[h,s]=p.useState(0),[v,b]=p.useState(!1);p.useEffect(()=>{let u=!0;return f(!1),ft(a).then(y=>{u&&(y?d(y):f(!0))}),()=>{u=!1}},[a,h]);const m=()=>(i==null?void 0:i.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=u=>{if(o||!i)return;const y={enabled:u.enabled??!!i.enabled,email:u.email??(i.email||""),sections:u.sections??m()};b(!0),ft(a,y).then(S=>{if(b(!1),!S){r(t.memoAlertErr);return}d(S),n(t.memoAlertSaved)})};if(c)return e.jsx(ee,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:t.retry})]})});if(!i)return e.jsx(ee,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const x=m();return e.jsxs(ee,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:o||v,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),e.jsx(kn,{value:i.email||"",readOnly:o||v,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:u=>g({email:u})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([u,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!x[u],disabled:o||v,onChange:()=>g({sections:{...x,[u]:!x[u]}})}),e.jsx("span",{children:y})]},u))}),e.jsx(rt,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>La(a,x),onTest:()=>Aa(a,x)})]})}function kn({value:t,readOnly:a,label:n,okLabel:r,onSave:l}){const[o,i]=p.useState(t);p.useEffect(()=>{i(t)},[t]);const d=o.trim()!==t.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>i(f.target.value),onKeyDown:f=>{f.key==="Enter"&&d&&c&&l(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>l(o.trim()),children:r})]})]})}function jn(){const{t,token:a,flash:n,flashErr:r,canWrite:l}=T(),[o,i]=p.useState(null),[d,c]=p.useState(!1),[f,h]=p.useState(null),[s,v]=p.useState(""),[b,m]=p.useState(0);p.useEffect(()=>{let u=!0;return c(!1),We(a).then(y=>{u&&(y?i({configured:y.configured,url_hint:y.url_hint}):c(!0))}),Da(a).then(y=>{u&&h(y)}),()=>{u=!1}},[a,b]);const g=(u,y)=>{l&&We(a,u).then(S=>{if(!S||S.ok===!1){r(t.actErr);return}u.test&&S.sent===!1?r(t.plugTestThrottled):n(y),m(j=>j+1)})},x='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(ee,{title:t.plugTitle,icon:"🔌",wide:!0,children:[f&&e.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?t.plugAutoOn(f.destination||"webhook"):t.plugAutoOff}),d?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>m(u=>u+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:s,disabled:!l,onChange:u=>v(u.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!l||!s.trim(),onClick:()=>g({url:s.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!l,onClick:()=>g({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!l,onClick:()=>g({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Nn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:x}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var u;(u=navigator.clipboard)==null||u.writeText(x).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Nn(){const{t,token:a,lang:n}=T(),[r,l]=p.useState("valides"),[o,i]=p.useState(!1),[d,c]=p.useState(null),[f,h]=p.useState(null),[s,v]=p.useState(!1),[b,m]=p.useState(!1),[g,x]=p.useState(null),[u,y]=p.useState(null),[S,j]=p.useState(null),w=`atl2:bulk:${a}:${r}`;p.useEffect(()=>{We(a).then(O=>{y(O&&O.configured?O.url_hint||"webhook":null)})},[a]),p.useEffect(()=>{c(null),h(null),v(!1),x(null);try{const O=JSON.parse(localStorage.getItem(w)||"null");j(O&&Date.now()-Date.parse(O.t)<24*3600*1e3?O:null)}catch{j(null)}},[w]);const C=async()=>{i(!0),v(!1),x(null);const O=await Ra(a,r);c(O),h(O.ok?r:null),i(!1)},z=p.useRef(!1),N=async()=>{if(z.current)return;z.current=!0,m(!0);const O=`${a}:${r}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await qa(a,r,"webhook",void 0,O)}finally{z.current=!1}if(m(!1),v(!1),x(M),M.ok&&(M.pushed||0)>0){const A={t:new Date().toISOString(),n:M.pushed||0};j(A);try{localStorage.setItem(w,JSON.stringify(A))}catch{}}},E=d!=null&&d.ok&&d.ready||0,q=!!(d!=null&&d.ok)&&f===r&&E>0&&!!u&&!S,L=S?new Date(S.t).toLocaleString(n==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:r,onChange:O=>l(O.target.value),children:t.plugBulkTabs.map(([O,M])=>e.jsx("option",{value:O,children:M},O))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{C()},children:o?"…":t.plugBulkPreview})]}),d&&(d.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(d!=null&&d.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),S&&e.jsx("p",{className:"mnote",children:t.bulkLocked(L,S.n)}),!S&&!!(d!=null&&d.ok)&&!u&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!S&&!d&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),q&&!s&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:t.bulkArm}),q&&s&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(E,u||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{N()},children:b?t.bulkSending:t.bulkConfirm(u||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>v(!1),children:t.bulkCancel})]}),g&&(g.ok?g.replayed?e.jsx("p",{className:"mnote",children:g.pending?t.bulkPending:t.bulkReplayed}):(g.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:g.error||t.actErr}))]})}function Sn(){const{t,data:a,lang:n}=T(),r=a.credits,l=a.email,o=async i=>{if(!l)return;const d=window.location.href.split("?")[0];try{const f=await(await fetch(`${Ge}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l,lookup_key:i,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return e.jsxs(ee,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(i=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(i.credits,i.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(i.lookup_key)},children:t.rechargeBuy})]},i.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Cn(){const{t,data:a,dossiers:n}=T(),r=n.filter(o=>o.kind==="target"&&Z(o)).length,l=a.marketEstimate||0;return e.jsx(ee,{title:t.coverTitle,icon:"🌍",children:l>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,l)}}):e.jsx("p",{children:t.coverScreened(r)})})}function zn(){var u,y,S;const{t,dossiers:a,token:n,mode:r,flash:l,criteria:o}=T(),i=r==="client",d=p.useMemo(()=>{const j=new Set;return a.forEach(w=>{w.angle&&j.add(w.angle)}),[...j]},[a]),[c,f]=p.useState(null);p.useEffect(()=>{let j=!0;return Fa(n).then(w=>{j&&f(w.thumbs)}),()=>{j=!1}},[n]);const[h,s]=p.useState(""),[v,b]=p.useState(""),[m,g]=p.useState(!1),x=async()=>{const j=h.trim();if(!(!j||m||!i)){g(!0),b("");try{const C=await(await fetch(`${Te}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:j,who:"atelier2"})})).json().catch(()=>({}));if(C.reply&&b(String(C.reply)),C.job_id){b(t.critChatRunning);const z=async()=>{const N=await fetch(`${Te}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:C.job_id})}).then(E=>E.json()).catch(()=>null);if(N&&N.done){b(String(N.reply||N.clarification||N.summary||"✓")),g(!1),N.applied&&l(t.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),s("");return}s("")}finally{v.startsWith("⏳")||g(!1)}}};return e.jsxs(ee,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((u=o.points)!=null&&u.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(j=>e.jsx("li",{children:j},j))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(j=>{var w,C;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:j.title}),j.why&&e.jsx("p",{className:"why",children:j.why}),e.jsxs("div",{className:"lo",children:[!!((w=j.look)!=null&&w.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:j.look.map(z=>e.jsx("li",{children:z},z))})]}),!!((C=j.out)!=null&&C.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:j.out.map(z=>e.jsx("li",{children:z},z))})]})]})]},j.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(j=>e.jsxs("li",{children:[j.k&&e.jsx("b",{children:j.k}),j.t]},j.t))})]}),d.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:d.map(j=>e.jsx("li",{style:{marginBottom:5},children:j.replace(/[_-]+/g," ")},j))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:h,disabled:!i||m,onChange:j=>s(j.target.value),onKeyDown:j=>{j.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!i||m||!h.trim(),onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),v&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:v})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((j,w)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:j.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:j.company}),e.jsx("span",{className:"qd",children:(j.ts||"").slice(0,10)})]},w))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([j,w])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Vt[j]||"v-cons"),children:j}),e.jsx("span",{children:w})]},j))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([j,w])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:j}),e.jsxs("span",{children:["← ",w]})]},j))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function En(){const{t,dispatch:a,startTour:n}=T(),r=l=>{var o,i;a({type:"modal",modal:null}),l==="crit"||l==="plug"||l==="alert"?a({type:"modal",modal:l}):l.startsWith("tab")?a({type:"ptab",tab:Number(l.slice(3))}):l==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(i=document.querySelector(".atl2 .demand input"))==null||i.focus())};return e.jsxs(ee,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([l,o],i)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:i+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:l.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+i))})]})}const Ut="atl2:mapfold",Tn=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(Ut);if(t==="on")return!0;if(t==="off")return!1}catch{}return window.innerHeight<1e3},_t=p.createContext(null),T=()=>{const t=p.useContext(_t);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function je({o:t,lg:a}){const{lang:n}=T(),r=Q(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:ht(r,n),children:[r.emoji," ",ht(r,n)]}):null}function Be({o:t,src:a}){const{lang:n,t:r}=T(),l=Q(t);if(!l)return null;const o=Ha(l),i=Ya(l);return e.jsxs("em",{className:"sigwin"+(i?" hot":""),title:r.signaledOn(qt(l,n))+" · "+r.win7(Mt(l,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>e.jsx("i",{className:c<o?"on":""},c))}),e.jsx("span",{className:"lb",children:i?r.lastDay:r.daysLeft(Math.max(0,l.left??0))}),a&&l.url&&e.jsx("a",{href:l.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Ht({o:t}){const{lang:a}=T(),n=_a(t.cc),r=t.cc?ke(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const Tt="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Yt=t=>`atl2:tour:${t||"anon"}`;function An(t){try{return localStorage.getItem(Yt(t))==="1"}catch{return!0}}function At(t){try{localStorage.setItem(Yt(t),"1")}catch{}}function Ln(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function Mn({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:l,onFiltersChange:o}){const{lang:i}=$a(),d=er[i],c=pr(t,i,a),[f,h]=p.useReducer(fr,void 0,()=>ur((r==null?void 0:r.continent)??"europe",t||Tn(),{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=p.useRef(!0);p.useEffect(()=>{if(s.current){s.current=!1;return}if(!t)try{localStorage.setItem(Ut,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,t]);const v=p.useRef(o);v.current=o,p.useEffect(()=>{var k;(k=v.current)==null||k.call(v,f.filters)},[f.filters]);const[b,m]=p.useState(null),[g,x]=p.useState(null),[u,y]=p.useState({kept:0,dropped:0}),[S,j]=p.useState(!1),[w,C]=p.useState(""),[z,N]=p.useState(!1),[E,q]=p.useState(null),[L,O]=p.useState(!1),[M,A]=p.useState(!1),[,I]=p.useState(0),R=()=>I(k=>k+1),H=p.useRef([]),le=p.useRef(new Set),ce=p.useRef(new Set),Oe=p.useRef(new Map),ge=p.useRef(null),{mode:pe}=c,Y=p.useMemo(()=>l?{...c.caps,...l}:c.caps,[c.caps,l]),V=Y.pipe,U=c.session.token||"",P=pe==="client"&&!t;p.useEffect(()=>{if(document.querySelector(`link[href="${Tt}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=Tt,document.head.appendChild(k)},[]);const B=(k,F=!1)=>{C(k),N(F),ge.current&&clearTimeout(ge.current),ge.current=setTimeout(()=>C(""),F?4200:2400)},_=k=>B(k,!0),ne=p.useMemo(()=>{const k=new Map;return c.dossiers.forEach(F=>{F.id&&k.set(F.id,F)}),k},[c.dossiers]),ae=p.useMemo(()=>c.dossiers.filter(k=>It(k,f,V)),[c.dossiers,f,V]),J=p.useRef(!1);p.useEffect(()=>{if(J.current||t||c.loading||!c.dossiers.length)return;if(!Y.showFunnel||An(c.session.token||"")){J.current=!0;return}J.current=!0;const k=window.setTimeout(()=>{At(c.session.token||""),O(!0)},700);return()=>window.clearTimeout(k)},[t,c.loading,c.dossiers.length,Y.showFunnel,c.session.token]);const X=p.useMemo(()=>c.dossiers.filter(k=>mr(k,f,V,c.favIds)),[c.dossiers,f,V,c.favIds]),Ne=p.useMemo(()=>Va(ae,c.favIds),[ae,c.favIds]),$=Qe.find(k=>k.key===f.continent),ie=i==="fr"?$.fr:$.en,ue=(k,F)=>{const D=((k==null?void 0:k.name)||F||"").trim();if(!P){x({kicker:D});return}!D||S||(j(!0),(async()=>{try{const W=await Rt(U,D,"atelier2"),Fe={name:W.company||D,verdict:W.verdict,reason:W.reason||"",remaining:W.remaining??null};H.current=[Fe,...H.current].slice(0,8),W.verdict==="kept"&&y(fe=>({...fe,kept:fe.kept+1})),W.verdict==="ruled_out"&&y(fe=>({...fe,dropped:fe.dropped+1}));const ze=k||c.dossiers.find(fe=>(fe.name||"").toLowerCase()===D.toLowerCase());ze&&(W.verdict==="kept"?ze.verdict=ze.verdict||"MATCH":W.verdict==="ruled_out"&&(ze.verdict="NO MATCH"),W.reason&&(ze.reasoning=W.reason)),R()}finally{j(!1)}})())},Se=k=>{if(!P){x({kicker:k.name});return}le.current.add(k.id),Ee(U,"fast_request",k.name||"",""),B(d.memoInstantSent(k.name)),R()},he=k=>Oe.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),re=(k,F)=>h({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:F}}),be=async(k,F,D)=>{const W=k.ceoStatus||"";k.ceoStatus=F,R();const Fe=await Ue(U,{status:F,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(D==null?void 0:D.note)!==void 0?{note:D.note}:{},...D!=null&&D.via?{via:D.via}:{}});return Fe.ok?Fe.skipped?(k.ceoStatus=W,R(),_(d.actNotPersisted),!1):((D==null?void 0:D.undo)!==!1&&re(k,W),D!=null&&D.msg&&B(D.msg),(F==="Validé"||F==="Écarté")&&!k.ceoNote&&(D==null?void 0:D.note)===void 0&&q({o:k,yes:F==="Validé"}),!0):(k.ceoStatus=W,R(),_(d.actErr),!1)},Ce=async(k,F)=>{const D=await Ue(U,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:F,via:"note"});return!D.ok||D.skipped?(_(D.skipped?d.actNotPersisted:d.actErr),!1):(k.ceoNote=F,R(),!0)},oe=p.useRef(new Map),ve=k=>oe.current.has(k.id)?oe.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),Wt=(k,F)=>{oe.current.set(k.id,F),R()},Gt=(k,F)=>{P&&be(k,F?"Validé":"Écarté",{msg:F?d.decidedYes(k.name):d.decidedNo(k.name)})},Kt=k=>{P&&be(k,"À trancher",{msg:d.promoted(k.name)})},Qt=k=>{P&&(async()=>{const F=k.ceoStatus||"";k.ceoStatus="Retenu",R();const D=await Ue(U,{status:"Retenu",check_id:k.checkId,company:k.name});if(!D.ok||D.skipped){k.ceoStatus=F,R(),_(D.skipped?d.actNotPersisted:d.actErr);return}re(k,F),B(d.repeched(k.name))})()},Jt=()=>{const k=f.undo[f.undo.length-1];if(!k){B(d.undoNone);return}const F=ne.get(k.id);if(!F){h({type:"undoPop"}),B(d.undoNone);return}let D=k.prevCeoStatus;if(!D)if((F.verdict||"").toUpperCase().includes("CALL"))D="À trancher";else{B(d.undoLockedTitle);return}(async()=>await be(F,D,{undo:!1})&&(h({type:"undoPop"}),F.ceoStatus=k.prevCeoStatus,R(),B(d.undoDone(F.name))))()},Xt=k=>{P&&(ce.current.add(k.id),R(),(async()=>{const F=await Wa(U,k.name,"email");if(!F||F.ok===!1){ce.current.delete(k.id),R(),_(d.actErr);return}Ee(U,"approach",k.name||"",""),B(d.actApproachSent)})())},Zt=(k,F)=>{P&&(async()=>{if(!(await Ee(U,F?"yes":"no",k.name||"","")).ok){_(d.actErr);return}Oe.current.set(k.id,F?"yes":"no"),R(),B(F?d.thumbUpDone:d.thumbDnDone)})()},ea=k=>{!P||!Je(k)||(Ee(U,"detailed_request",k.name||"",""),B(d.memoDeepSent(k.name)))},ta=k=>{const F=new Set(c.favIds),D=F.has(k.id);D?F.delete(k.id):F.add(k.id),c.setFavIds(F),P&&Ga(U,{id:k.id,co:k.name},D)},aa=()=>{!P||M||window.confirm(d.identSyncConfirm)&&(A(!0),(async()=>{const k=await Ka(U);A(!1),k?B(d.identSyncDone):_(d.actErr)})())},nt=/proplace/i.test(c.fund||""),ra=k=>{!P||!nt||(Ee(U,"onboard_request",k.name||"",""),B(d.onboardSent(k.name)))},na={st:f,dispatch:h,t:d,lang:i,mode:pe,caps:Y,pipe:V,token:U,fund:c.fund,email:c.email,criteria:c.criteria,data:c,doRepeche:Qt,thumbOf:he,canWrite:P,commitStatus:be,saveNote:Ce,stageOf:ve,setStage:Wt,flashErr:_,startTour:()=>O(!0),dossiers:c.dossiers,scopedAll:ae,scoped:X,counts:Ne,byId:ne,contName:ie,favIds:c.favIds,toggleFav:ta,askEvaluate:ue,doAnalyse:Se,doDecide:Gt,doPromote:Kt,doApproach:Xt,doThumb:Zt,doDeep:ea,doUndo:Jt,doSync:aa,doOnboard:ra,outbound:nt,memoQueued:le.current,approachDone:ce.current,sessTally:u,evalCards:H.current,evalBusy:S,markRow:m,markedId:b,flash:B};return p.useEffect(()=>{const k=F=>{F.key==="Escape"&&(h({type:"popup",id:null}),h({type:"modal",modal:null}),h({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]),e.jsx(_t.Provider,{value:na,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:rr}),e.jsxs("div",{className:"app"+(V?" pipe":""),children:[Y.showTicker&&e.jsx(G,{name:"live",children:e.jsx(xr,{})}),Y.showIdent&&e.jsx(G,{name:"identite",children:e.jsx(Or,{})}),Y.showOnb&&e.jsx(G,{name:"onboarding",children:e.jsx(Fr,{})}),e.jsx(G,{name:"matin",children:e.jsx(Lr,{})}),e.jsx(G,{name:"fraicheur",children:e.jsx(jr,{})}),e.jsx(G,{name:"mesure",children:e.jsx(Nr,{})}),Y.showFunnel&&e.jsx(G,{name:"entonnoir",children:e.jsx(On,{})}),Y.showFunnel&&e.jsx(G,{name:"tunnel",children:e.jsx(Rr,{})}),Y.showFunnel&&e.jsx(G,{name:"tuto",children:e.jsx(Mr,{})}),e.jsx(G,{name:"carte",fallback:e.jsx("div",{className:"void",children:d.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(Fn,{}),e.jsxs("div",{className:"stage"+(f.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(Ir,{}),e.jsx(Br,{})]})]})}),Y.showDemand&&e.jsx(G,{name:"evaluation",children:e.jsx(Vr,{})}),Y.showDemand&&f.memoConsole&&e.jsx(G,{name:"console",children:e.jsx(_r,{})}),e.jsx(G,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[d.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:e.jsx(tn,{})}),c.loading&&e.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&e.jsxs("div",{className:"void",children:[d.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]}),Y.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:d.lockbarText}),e.jsx("button",{type:"button",onClick:()=>h({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),f.popupId&&e.jsx(G,{name:"fiche",children:e.jsx(nn,{})}),e.jsx(G,{name:"modales",children:e.jsx(cn,{})}),e.jsx(yr,{}),E&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:E.o.name}),e.jsx(Er,{placeholder:E.yes?d.whyYesPh:d.whyNoPh,onDone:k=>{const F=E.o;q(null),k&&Ce(F,k).then(D=>{D&&B(d.csNoteSaved)})}})]}),L&&e.jsx(Ar,{steps:Ln(d),onClose:()=>{O(!1),At(U)}}),w&&e.jsx("div",{className:"flash on"+(z?" err":""),children:w}),g&&e.jsx(Ua,{variant:"acquirer",initialCompany:Lt().co,initialWebsite:Lt().site,onClose:()=>x(null)})]})})}function On(){const{t}=T(),[a,n]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Fn(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:l,t:o}=T(),i=p.useMemo(()=>{const d={};return t.forEach(c=>{c.continent&&et(c,a.filters,r)&&(d[c.continent]=(d[c.continent]||0)+1)}),d},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[Qa.map(d=>{const c=Qe.find(f=>f.key===d);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===d,onClick:()=>n({type:"continent",key:d}),children:[l==="fr"?c.fr:c.en,e.jsx("span",{className:"n",children:i[d]||0})]},d)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Lt(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Dn(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{Ht as FlagCell,je as SigBadge,Be as SigWin,Mn as default,Dn as fmtShort,T as useV2};
