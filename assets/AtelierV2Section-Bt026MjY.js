...
`;class Ee extends f.Component{constructor(){super(...arguments);Za(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const pa=600,Ze=62,xn="atl2:fstats";function Yi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=I(),[l,s]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(xn)==="on"}catch{return!1}}),d=r.stats,x=f.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),c=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const m=z=>a==="en"?z.slice(5,10):`${z.slice(8,10)}/${z.slice(5,7)}`,u=z=>z.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((z,R)=>Math.max(z,R.s||0),0),p=x.length?pa/x.length:0,g=Math.max(4,p-4),v=x.length>=5&&b>0,h=r.marketEstimate||0,E=m(new Date().toISOString().slice(0,10)),j=z=>[...typeof z=="number"?[[z,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&c&&y.push({cle:"fenetre",periode:e.funPerWindow(m(c),E),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:j(d.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(z=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:z.periode}),z.etapes.map(([R,q],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(R)}),t.jsx("i",{children:q})]},z.cle+q)),z.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((d.screened||0)/h*100)))})]}),z.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const R=!l;s(R),R&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(xn,R?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},z.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${pa} ${Ze}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((z,R)=>{const q=(z.s||0)/b*(Ze-4),S=(z.m||0)/b*(Ze-4),A=R*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(z.d)} — ${z.s} ${e.actScreened} · ${z.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:Ze-2-q,width:g,height:q,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:Ze-2-S,width:g,height:S,fill:"#185c38"})]},z.d)}),t.jsx("line",{x1:0,y1:Ze-1.5,x2:pa,y2:Ze-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const cr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Gi(e,a){if((Qe(e)||"").startsWith("CALL")&&ye(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ye(e)>=2;return cr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function Ki({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=I(),[s,d]=f.useState(!1),[x,c]=f.useState(""),[m,u]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),p=async g=>{if(x)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}c(g);const v=await i(e,g);c(""),v&&(d(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:m?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),d(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const g=await i(e,"Analysé");c(""),g&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]}):Gi(e,a).map(([g,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(x===g?" busy":""),disabled:!!x,onClick:()=>{p(g)},children:v},g))})]})}function Qi({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=I(),[o,l]=f.useState(""),[s,d]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),c=(Qe(e)||"").startsWith("CALL")&&ye(e)===3,m=ye(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const g=await i(e,p);l(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:cr.filter(([p])=>!(m&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(x===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Ji,{o:e})]})}function Ji({o:e}){const{t:a,saveNote:r,flash:n}=I(),[i,o]=f.useState(e.ceoNote||""),[l,s]=f.useState(!1),[d,x]=f.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{m()},children:d?a.csNoteSaved:a.csNoteOk})]})}function Xi({placeholder:e,onDone:a}){const{t:r}=I(),[n,i]=f.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Zi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=I(),[d,x]=f.useState(!1);if(!n.pipe||!i||n.lockActions||ye(e)!==4)return null;const c=o(e),m=(c==null?void 0:c.stage)||"todo",u=async h=>{if(d||h===m)return;x(!0);const E=c;l(e,{stage:h,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),hn+=1);hn=j;const y=await yo(r,{company:e.name||"",stage:h,cts:j,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(l(e,E),s(a.actErr)))},b=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,E])=>t.jsx("button",{type:"button",className:"stgb"+(m===h?" on":""),disabled:d,onClick:()=>{u(h)},children:E},h)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let hn=0;const Ot=8,Ft=360;function gn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function bn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(gn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(gn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function es({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=I(),[l,s]=f.useState(0),[d,x]=f.useState(null),[c,m]=f.useState([]),u=f.useRef(!1),b=f.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=f.useRef(!1);f.useEffect(()=>{const q=b.current;return()=>{p.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),f.useEffect(()=>{u.current||(u.current=!0,m(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const g=c[l],v=l>=c.length;f.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const q=g.click,S=window.setTimeout(()=>{const A=document.querySelector(q);A&&A.getAttribute("aria-selected")!=="true"&&A.click()},60);return()=>window.clearTimeout(S)}},[l,g]);const h=f.useRef(-1),E=f.useCallback(()=>{if(!g){x(null);return}const q=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!q){x(null);return}h.current!==l&&(h.current=l,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=q.getBoundingClientRect();x(A=>A&&Math.abs(A.top-S.top)<1&&Math.abs(A.left-S.left)<1&&Math.abs(A.width-S.width)<1&&Math.abs(A.height-S.height)<1?A:S)},[g,l]);f.useLayoutEffect(()=>{E();const q=[90,300,700,1300].map(A=>window.setTimeout(E,A)),S=()=>E();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{q.forEach(A=>window.clearTimeout(A)),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[E]);const j=f.useRef(a);if(j.current=a,f.useEffect(()=>{const q=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),j.current()):S.key==="ArrowRight"?s(A=>A+1):S.key==="ArrowLeft"&&s(A=>Math.max(0,A-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!c.length)return null;let y=null;const z=q=>()=>{p.current=!0,n({type:"modal",modal:null}),q()};if(v){const q=i[3]||0;q>0?y={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:z(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:z(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:z(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:z(()=>{n({type:"modal",modal:"crit"}),a()})}}let R={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Ft};if(!v&&d){const q=d.bottom+14,A=window.innerHeight-q>190?q:Math.max(12,d.top-200);R={left:Math.min(Math.max(12,d.left+d.width/2-Ft/2),window.innerWidth-Ft-12),top:A,width:Ft}}return ut.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Ot,top:d.top-Ot,width:d.width+Ot*2,height:d.height+Ot*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:R,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(bn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(bn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(q=>q+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function dr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function pr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ts(){var S,A;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:s,dispatch:d}=I(),x=r?a:e,c=f.useMemo(()=>x.filter(N=>Ke(N.date)===0&&N.kind==="target"),[x]),m=f.useMemo(()=>r?a.filter(N=>N.kind==="target"&&ye(N)===0).slice().sort((N,w)=>(w.date||"").localeCompare(N.date||"")):[],[a,r]),u=f.useMemo(()=>c.filter(N=>r?ye(N)===0:!qe(N)),[c,r]),b=r?m:u,p=r?a.length-m.length:c.length-u.length,g=r?a.length:c.length,v=g?Math.min(100,p/g*100):100,h=f.useMemo(()=>dr(x),[x]),E=!!h&&Ke(h)>0,j=f.useMemo(()=>E?x.filter(N=>(N.date||"").slice(0,10)===h):[],[x,h,E]),y=typeof((S=s.stats)==null?void 0:S.kept_today)=="number"?s.stats.kept_today:null,z=typeof((A=s.stats)==null?void 0:A.screened_today)=="number"?s.stats.screened_today:c.length;let R;E?R=i.morningLast(j.length,m.length,pr(h,l)):r?R=i.morningThesis(z,m.length,y):c.length?p===0?R=i.goalSourced(c.length):p>=c.length?R=i.goalCleared:R=i.goalDone(p,c.length):R=i.goalSourced(0);const q=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&m.length&&d({type:"chainStart",queue:m.map(N=>N.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:R}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function as(){var U,W;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:d,doSync:x,startTour:c,flash:m,flashErr:u}=I(),[b,p]=f.useState(null),[g,v]=f.useState(!0),[h,E]=f.useState([]),j=d==="client";f.useEffect(()=>{if(!i||!o)return;let H=!0;return v(!0),(async()=>{const[Q,Y]=await Promise.all([$a(o),tr(i)]);H&&(Q&&p(Q),v(!1),E(Y))})(),()=>{H=!1}},[i,o]);const[y,z]=f.useState(!1),R=()=>{!j||y||!o||(z(!0),wo(o).then(H=>{z(!1),H?m(e.identRepubDone):u(e.actErr)}))},q=(b==null?void 0:b.per_day)??null,S=((U=b==null?void 0:b.pool_order)==null?void 0:U.length)??0,A=h.filter(H=>H.status==="running").length,N=f.useMemo(()=>s.filter(H=>H.kind==="target"&&qe(H)).length,[s]),w=l.marketEstimate,M=typeof((W=l.stats)==null?void 0:W.screened)=="number"?l.stats.screened:N,_=w&&w>0?Math.min(100,Math.round(M/w*100)):null,C=H=>H.toLocaleString(a==="en"?"en-US":"fr-FR"),T=(o||"P").split(/\s+/).map(H=>H[0]).join("").slice(0,2).toUpperCase(),O=(()=>{const H=Date.parse(l.generatedAt||"");if(Number.isNaN(H))return"";const Q=new Date(H),Y=J=>String(J).padStart(2,"0");return`${Y(Q.getDate())}/${Y(Q.getMonth()+1)} à ${Y(Q.getHours())}:${Y(Q.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?T:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),O?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(O)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[_===null&&M>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:C(M)})})]}),_!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:_+"%"}})}),t.jsxs("b",{children:[_," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(M,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),q!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:q})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),q===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),A>0&&t.jsxs("span",{className:"ev",children:["⏳ ",A]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:H=>{H.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||y,onClick:R,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:H=>n({type:"filters",patch:{search:H.target.value}})})]})]})]})}function ns(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=I(),s=o.loading&&!l.length,d=f.useRef({});f.useEffect(()=>{d.current={...r}},[r]);const x=u=>{const b=d.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${ga[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},c=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${ga[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function rs(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=I(),s=f.useRef(null),[d,x]=f.useState(60);f.useEffect(()=>{let p=0;const g=()=>{var y;const v=s.current;if(!v)return;const h=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!h)return;const E=h.getBoundingClientRect(),j=v.getBoundingClientRect();x(Math.max(20,Math.min(E.left+E.width/2-j.left,j.width-30)))};return p=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",g)}},[e.ptab]);const c=e.ptab;let m=r.tuto[c].p;if(c===3){const p=n.filter(h=>h.kind==="target"&&ye(h)===3),g=p.filter(h=>ba(h)==="auto").length,v=p.filter(h=>ba(h)==="cd").length;m=r.tutoPending(g,v,p.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(c===1){const p=n.filter(g=>g.kind==="target"&&ye(g)===1&&!i.has(g.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(g=>g.id)})}}return null})(),b=ko(c);return t.jsxs("div",{ref:s,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${ga[c]})`,"--ax":d+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class at{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*os(e){for(const a of e)yield*a}function ur(e){return Array.from(os(e))}var ce=1e-6,ae=Math.PI,Fe=ae/2,vn=ae/4,De=ae*2,He=180/ae,ze=ae/180,ue=Math.abs,is=Math.atan,kt=Math.atan2,be=Math.cos,ve=Math.sin,ss=Math.sign||function(e){return e>0?1:e<0?-1:0},ot=Math.sqrt;function ls(e){return e>1?0:e<-1?ae:Math.acos(e)}function jt(e){return e>1?Fe:e<-1?-Fe:Math.asin(e)}function Pe(){}function Wt(e,a){e&&wn.hasOwnProperty(e.type)&&wn[e.type](e,a)}var yn={Feature:function(e,a){Wt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Wt(r[n].geometry,a)}},wn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ja(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ja(r[n],a,0)},Polygon:function(e,a){kn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)kn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Wt(r[n],a)}};function ja(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function kn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ja(e[r],a,1);a.polygonEnd()}function it(e,a){e&&yn.hasOwnProperty(e.type)?yn[e.type](e,a):Wt(e,a)}function Na(e){return[kt(e[1],e[0]),jt(e[2])]}function dt(e){var a=e[0],r=e[1],n=be(r);return[n*be(a),n*ve(a),ve(r)]}function Pt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Yt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ua(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Dt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Sa(e){var a=ot(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ea(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ca(e,a){return ue(e)>ae&&(e-=Math.round(e/De)*De),[e,a]}Ca.invert=Ca;function cs(e,a,r){return(e%=De)?a||r?Ea(Nn(e),Sn(a,r)):Nn(e):a||r?Sn(a,r):Ca}function jn(e){return function(a,r){return a+=e,ue(a)>ae&&(a-=Math.round(a/De)*De),[a,r]}}function Nn(e){var a=jn(e);return a.invert=jn(-e),a}function Sn(e,a){var r=be(e),n=ve(e),i=be(a),o=ve(a);function l(s,d){var x=be(d),c=be(s)*x,m=ve(s)*x,u=ve(d),b=u*r+c*n;return[kt(m*i-b*o,c*r-u*n),jt(b*i+m*o)]}return l.invert=function(s,d){var x=be(d),c=be(s)*x,m=ve(s)*x,u=ve(d),b=u*i-m*o;return[kt(m*i+u*o,c*r+b*n),jt(b*r-c*n)]},l}function ds(e,a,r,n,i,o){if(r){var l=be(a),s=ve(a),d=n*r;i==null?(i=a+n*De,o=a-d/2):(i=En(l,i),o=En(l,o),(n>0?i<o:i>o)&&(i+=n*De));for(var x,c=i;n>0?c>o:c<o;c-=d)x=Na([l,-s*be(c),-s*ve(c)]),e.point(x[0],x[1])}}function En(e,a){a=dt(a),a[0]-=e,Sa(a);var r=ls(-a[1]);return((-a[2]<0?-r:r)+De-ce)%De}function mr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Pe,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ut(e,a){return ue(e[0]-a[0])<ce&&ue(e[1]-a[1])<ce}function It(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function fr(e,a,r,n,i){var o=[],l=[],s,d;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],h=p[g],E;if(Ut(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=p[s])[0],v[1]);i.lineEnd();return}h[0]+=2*ce}o.push(E=new It(v,p,null,!0)),l.push(E.o=new It(v,null,E,!1)),o.push(E=new It(h,p,null,!1)),l.push(E.o=new It(h,null,E,!0))}}),!!o.length){for(l.sort(a),Cn(o),Cn(l),s=0,d=l.length;s<d;++s)l[s].e=r=!r;for(var x=o[0],c,m;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,d=c.length;s<d;++s)i.point((m=c[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((m=c[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);i.lineEnd()}}}function Cn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function ma(e){return ue(e[0])<=ae?e[0]:ss(e[0])*((ue(e[0])+ae)%De-ae)}function ps(e,a){var r=ma(a),n=a[1],i=ve(n),o=[ve(r),-be(r),0],l=0,s=0,d=new at;i===1?n=Fe+ce:i===-1&&(n=-Fe-ce);for(var x=0,c=e.length;x<c;++x)if(u=(m=e[x]).length)for(var m,u,b=m[u-1],p=ma(b),g=b[1]/2+vn,v=ve(g),h=be(g),E=0;E<u;++E,p=y,v=R,h=q,b=j){var j=m[E],y=ma(j),z=j[1]/2+vn,R=ve(z),q=be(z),S=y-p,A=S>=0?1:-1,N=A*S,w=N>ae,M=v*R;if(d.add(kt(M*A*ve(N),h*q+M*be(N))),l+=w?S+A*De:S,w^p>=r^y>=r){var _=Yt(dt(b),dt(j));Sa(_);var C=Yt(o,_);Sa(C);var T=(w^S>=0?-1:1)*jt(C[2]);(n>T||n===T&&(_[0]||_[1]))&&(s+=w^S>=0?1:-1)}}return(l<-ce||l<ce&&d<-1e-12)^s&1}function xr(e,a,r,n){return function(i){var o=a(i),l=mr(),s=a(l),d=!1,x,c,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=E,u.lineEnd=j,c=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,c=ur(c);var y=ps(x,n);c.length?(d||(i.polygonStart(),d=!0),fr(c,ms,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),c=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,z){e(y,z)&&i.point(y,z)}function p(y,z){o.point(y,z)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,z){m.push([y,z]),s.point(y,z)}function E(){s.lineStart(),m=[]}function j(){h(m[0][0],m[0][1]),s.lineEnd();var y=s.clean(),z=l.result(),R,q=z.length,S,A,N;if(m.pop(),x.push(m),m=null,!!q){if(y&1){if(A=z[0],(S=A.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),R=0;R<S;++R)i.point((N=A[R])[0],N[1]);i.lineEnd()}return}q>1&&y&2&&z.push(z.pop().concat(z.shift())),c.push(z.filter(us))}}return u}}function us(e){return e.length>1}function ms(e,a){return((e=e.x)[0]<0?e[1]-Fe-ce:Fe-e[1])-((a=a.x)[0]<0?a[1]-Fe-ce:Fe-a[1])}const An=xr(function(){return!0},fs,hs,[-ae,-Fe]);function fs(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?ae:-ae,d=ue(o-a);ue(d-ae)<ce?(e.point(a,r=(r+l)/2>0?Fe:-Fe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&d>=ae&&(ue(a-n)<ce&&(a-=n*ce),ue(o-s)<ce&&(o-=s*ce),r=xs(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function xs(e,a,r,n){var i,o,l=ve(e-r);return ue(l)>ce?is((ve(a)*(o=be(n))*ve(r)-ve(n)*(i=be(a))*ve(e))/(i*o*l)):(a+n)/2}function hs(e,a,r,n){var i;if(e==null)i=r*Fe,n.point(-ae,i),n.point(0,i),n.point(ae,i),n.point(ae,0),n.point(ae,-i),n.point(0,-i),n.point(-ae,-i),n.point(-ae,0),n.point(-ae,i);else if(ue(e[0]-a[0])>ce){var o=e[0]<a[0]?ae:-ae;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function gs(e){var a=be(e),r=2*ze,n=a>0,i=ue(a)>ce;function o(c,m,u,b){ds(b,e,r,u,c,m)}function l(c,m){return be(c)*be(m)>a}function s(c){var m,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,h){var E=[v,h],j,y=l(v,h),z=n?y?0:x(v,h):y?x(v+(v<0?ae:-ae),h):0;if(!m&&(p=b=y)&&c.lineStart(),y!==b&&(j=d(m,E),(!j||Ut(m,j)||Ut(E,j))&&(E[2]=1)),y!==b)g=0,y?(c.lineStart(),j=d(E,m),c.point(j[0],j[1])):(j=d(m,E),c.point(j[0],j[1],2),c.lineEnd()),m=j;else if(i&&m&&n^y){var R;!(z&u)&&(R=d(E,m,!0))&&(g=0,n?(c.lineStart(),c.point(R[0][0],R[0][1]),c.point(R[1][0],R[1][1]),c.lineEnd()):(c.point(R[1][0],R[1][1]),c.lineEnd(),c.lineStart(),c.point(R[0][0],R[0][1],3)))}y&&(!m||!Ut(m,E))&&c.point(E[0],E[1]),m=E,b=y,u=z},lineEnd:function(){b&&c.lineEnd(),m=null},clean:function(){return g|(p&&b)<<1}}}function d(c,m,u){var b=dt(c),p=dt(m),g=[1,0,0],v=Yt(b,p),h=Pt(v,v),E=v[0],j=h-E*E;if(!j)return!u&&c;var y=a*h/j,z=-a*E/j,R=Yt(g,v),q=Dt(g,y),S=Dt(v,z);ua(q,S);var A=R,N=Pt(q,A),w=Pt(A,A),M=N*N-w*(Pt(q,q)-1);if(!(M<0)){var _=ot(M),C=Dt(A,(-N-_)/w);if(ua(C,q),C=Na(C),!u)return C;var T=c[0],O=m[0],U=c[1],W=m[1],H;O<T&&(H=T,T=O,O=H);var Q=O-T,Y=ue(Q-ae)<ce,J=Y||Q<ce;if(!Y&&W<U&&(H=U,U=W,W=H),J?Y?U+W>0^C[1]<(ue(C[0]-T)<ce?U:W):U<=C[1]&&C[1]<=W:Q>ae^(T<=C[0]&&C[0]<=O)){var re=Dt(A,(-N+_)/w);return ua(re,q),[C,Na(re)]}}}function x(c,m){var u=n?e:ae-e,b=0;return c<-u?b|=1:c>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return xr(l,s,o,n?[0,-e]:[-ae,e-ae])}function bs(e,a,r,n,i,o){var l=e[0],s=e[1],d=a[0],x=a[1],c=0,m=1,u=d-l,b=x-s,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<c)return;p<m&&(m=p)}else if(u>0){if(p>m)return;p>c&&(c=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>m)return;p>c&&(c=p)}else if(u>0){if(p<c)return;p<m&&(m=p)}if(p=n-s,!(!b&&p>0)){if(p/=b,b<0){if(p<c)return;p<m&&(m=p)}else if(b>0){if(p>m)return;p>c&&(c=p)}if(p=o-s,!(!b&&p<0)){if(p/=b,b<0){if(p>m)return;p>c&&(c=p)}else if(b>0){if(p<c)return;p<m&&(m=p)}return c>0&&(e[0]=l+c*u,e[1]=s+c*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var ht=1e9,$t=-ht;function vs(e,a,r,n){function i(x,c){return e<=x&&x<=r&&a<=c&&c<=n}function o(x,c,m,u){var b=0,p=0;if(x==null||(b=l(x,m))!==(p=l(c,m))||d(x,c)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==p);else u.point(c[0],c[1])}function l(x,c){return ue(x[0]-e)<ce?c>0?0:3:ue(x[0]-r)<ce?c>0?2:1:ue(x[1]-a)<ce?c>0?1:0:c>0?3:2}function s(x,c){return d(x.x,c.x)}function d(x,c){var m=l(x,1),u=l(c,1);return m!==u?m-u:m===0?c[1]-x[1]:m===1?x[0]-c[0]:m===2?x[1]-c[1]:c[0]-x[0]}return function(x){var c=x,m=mr(),u,b,p,g,v,h,E,j,y,z,R,q={point:S,lineStart:M,lineEnd:_,polygonStart:N,polygonEnd:w};function S(T,O){i(T,O)&&c.point(T,O)}function A(){for(var T=0,O=0,U=b.length;O<U;++O)for(var W=b[O],H=1,Q=W.length,Y=W[0],J,re,Z=Y[0],me=Y[1];H<Q;++H)J=Z,re=me,Y=W[H],Z=Y[0],me=Y[1],re<=n?me>n&&(Z-J)*(n-re)>(me-re)*(e-J)&&++T:me<=n&&(Z-J)*(n-re)<(me-re)*(e-J)&&--T;return T}function N(){c=m,u=[],b=[],R=!0}function w(){var T=A(),O=R&&T,U=(u=ur(u)).length;(O||U)&&(x.polygonStart(),O&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),U&&fr(u,s,T,o,x),x.polygonEnd()),c=x,u=b=p=null}function M(){q.point=C,b&&b.push(p=[]),z=!0,y=!1,E=j=NaN}function _(){u&&(C(g,v),h&&y&&m.rejoin(),u.push(m.result())),q.point=S,y&&c.lineEnd()}function C(T,O){var U=i(T,O);if(b&&p.push([T,O]),z)g=T,v=O,h=U,z=!1,U&&(c.lineStart(),c.point(T,O));else if(U&&y)c.point(T,O);else{var W=[E=Math.max($t,Math.min(ht,E)),j=Math.max($t,Math.min(ht,j))],H=[T=Math.max($t,Math.min(ht,T)),O=Math.max($t,Math.min(ht,O))];bs(W,H,e,a,r,n)?(y||(c.lineStart(),c.point(W[0],W[1])),c.point(H[0],H[1]),U||c.lineEnd(),R=!1):U&&(c.lineStart(),c.point(T,O),R=!1)}E=T,j=O,y=U}return q}}const Aa=e=>e;var fa=new at,Ta=new at,hr,gr,za,qa,Ye={point:Pe,lineStart:Pe,lineEnd:Pe,polygonStart:function(){Ye.lineStart=ys,Ye.lineEnd=ks},polygonEnd:function(){Ye.lineStart=Ye.lineEnd=Ye.point=Pe,fa.add(ue(Ta)),Ta=new at},result:function(){var e=fa/2;return fa=new at,e}};function ys(){Ye.point=ws}function ws(e,a){Ye.point=br,hr=za=e,gr=qa=a}function br(e,a){Ta.add(qa*e-za*a),za=e,qa=a}function ks(){br(hr,gr)}var pt=1/0,Gt=pt,Nt=-pt,Kt=Nt,Qt={point:js,lineStart:Pe,lineEnd:Pe,polygonStart:Pe,polygonEnd:Pe,result:function(){var e=[[pt,Gt],[Nt,Kt]];return Nt=Kt=-(Gt=pt=1/0),e}};function js(e,a){e<pt&&(pt=e),e>Nt&&(Nt=e),a<Gt&&(Gt=a),a>Kt&&(Kt=a)}var La=0,Ra=0,gt=0,Jt=0,Xt=0,st=0,Ma=0,Oa=0,bt=0,vr,yr,Be,_e,Oe={point:nt,lineStart:Tn,lineEnd:zn,polygonStart:function(){Oe.lineStart=Es,Oe.lineEnd=Cs},polygonEnd:function(){Oe.point=nt,Oe.lineStart=Tn,Oe.lineEnd=zn},result:function(){var e=bt?[Ma/bt,Oa/bt]:st?[Jt/st,Xt/st]:gt?[La/gt,Ra/gt]:[NaN,NaN];return La=Ra=gt=Jt=Xt=st=Ma=Oa=bt=0,e}};function nt(e,a){La+=e,Ra+=a,++gt}function Tn(){Oe.point=Ns}function Ns(e,a){Oe.point=Ss,nt(Be=e,_e=a)}function Ss(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Jt+=i*(Be+e)/2,Xt+=i*(_e+a)/2,st+=i,nt(Be=e,_e=a)}function zn(){Oe.point=nt}function Es(){Oe.point=As}function Cs(){wr(vr,yr)}function As(e,a){Oe.point=wr,nt(vr=Be=e,yr=_e=a)}function wr(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Jt+=i*(Be+e)/2,Xt+=i*(_e+a)/2,st+=i,i=_e*e-Be*a,Ma+=i*(Be+e),Oa+=i*(_e+a),bt+=i*3,nt(Be=e,_e=a)}function kr(e){this._context=e}kr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,De);break}}},result:Pe};var Fa=new at,xa,jr,Nr,vt,yt,St={point:Pe,lineStart:function(){St.point=Ts},lineEnd:function(){xa&&Sr(jr,Nr),St.point=Pe},polygonStart:function(){xa=!0},polygonEnd:function(){xa=null},result:function(){var e=+Fa;return Fa=new at,e}};function Ts(e,a){St.point=Sr,jr=vt=e,Nr=yt=a}function Sr(e,a){vt-=e,yt-=a,Fa.add(ot(vt*vt+yt*yt)),vt=e,yt=a}let qn,Zt,Ln,Rn;class Mn{constructor(a){this._append=a==null?Er:zs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Ln||this._append!==Zt){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Ln=n,Zt=this._append,Rn=this._,this._=i}this._+=Rn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Er(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function zs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Er;if(a!==qn){const r=10**a;qn=a,Zt=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Zt}function qs(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),it(s,i(o))),o.result()}return l.area=function(s){return it(s,i(Ye)),Ye.result()},l.measure=function(s){return it(s,i(St)),St.result()},l.bounds=function(s){return it(s,i(Qt)),Qt.result()},l.centroid=function(s){return it(s,i(Oe)),Oe.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,Aa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new Mn(r)):new kr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const d=Math.floor(s);if(!(d>=0))throw new RangeError(`invalid digits: ${s}`);r=d}return a===null&&(o=new Mn(r)),l},l.projection(e).digits(r).context(a)}function Wa(e){return function(a){var r=new Pa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Pa(){}Pa.prototype={constructor:Pa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ya(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),it(r,e.stream(Qt)),a(Qt.result()),n!=null&&e.clipExtent(n),e}function Cr(e,a,r){return Ya(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,d])},r)}function Ls(e,a,r){return Cr(e,[[0,0],a],r)}function Rs(e,a,r){return Ya(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Ms(e,a,r){return Ya(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var On=16,Os=be(30*ze);function Fn(e,a){return+a?Ps(e,a):Fs(e)}function Fs(e){return Wa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Ps(e,a){function r(n,i,o,l,s,d,x,c,m,u,b,p,g,v){var h=x-n,E=c-i,j=h*h+E*E;if(j>4*a&&g--){var y=l+u,z=s+b,R=d+p,q=ot(y*y+z*z+R*R),S=jt(R/=q),A=ue(ue(R)-1)<ce||ue(o-m)<ce?(o+m)/2:kt(z,y),N=e(A,S),w=N[0],M=N[1],_=w-n,C=M-i,T=E*_-h*C;(T*T/j>a||ue((h*_+E*C)/j-.5)>.3||l*u+s*b+d*p<Os)&&(r(n,i,o,l,s,d,w,M,A,y/=q,z/=q,R,g,v),v.point(w,M),r(w,M,A,y,z,R,x,c,m,u,b,p,g,v))}}return function(n){var i,o,l,s,d,x,c,m,u,b,p,g,v={point:h,lineStart:E,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=z},polygonEnd:function(){n.polygonEnd(),v.lineStart=E}};function h(S,A){S=e(S,A),n.point(S[0],S[1])}function E(){m=NaN,v.point=j,n.lineStart()}function j(S,A){var N=dt([S,A]),w=e(S,A);r(m,u,c,b,p,g,m=w[0],u=w[1],c=S,b=N[0],p=N[1],g=N[2],On,n),n.point(m,u)}function y(){v.point=h,n.lineEnd()}function z(){E(),v.point=R,v.lineEnd=q}function R(S,A){j(i=S,A),o=m,l=u,s=b,d=p,x=g,v.point=j}function q(){r(m,u,c,b,p,g,o,l,i,s,d,x,On,n),v.lineEnd=y,y()}return v}}var Ds=Wa({point:function(e,a){this.stream.point(e*ze,a*ze)}});function Is(e){return Wa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function $s(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function Pn(e,a,r,n,i,o){if(!o)return $s(e,a,r,n,i);var l=be(o),s=ve(o),d=l*e,x=s*e,c=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function p(g,v){return g*=n,v*=i,[d*g-x*v+a,r-x*g-d*v]}return p.invert=function(g,v){return[n*(c*g-m*v+u),i*(b-m*g-c*v)]},p}function Bs(e){return _s(function(){return e})()}function _s(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,d=0,x=0,c,m=0,u=1,b=1,p=null,g=An,v=null,h,E,j,y=Aa,z=.5,R,q,S,A,N;function w(T){return S(T[0]*ze,T[1]*ze)}function M(T){return T=S.invert(T[0],T[1]),T&&[T[0]*He,T[1]*He]}w.stream=function(T){return A&&N===T?A:A=Ds(Is(c)(g(R(y(N=T)))))},w.preclip=function(T){return arguments.length?(g=T,p=void 0,C()):g},w.postclip=function(T){return arguments.length?(y=T,v=h=E=j=null,C()):y},w.clipAngle=function(T){return arguments.length?(g=+T?gs(p=T*ze):(p=null,An),C()):p*He},w.clipExtent=function(T){return arguments.length?(y=T==null?(v=h=E=j=null,Aa):vs(v=+T[0][0],h=+T[0][1],E=+T[1][0],j=+T[1][1]),C()):v==null?null:[[v,h],[E,j]]},w.scale=function(T){return arguments.length?(r=+T,_()):r},w.translate=function(T){return arguments.length?(n=+T[0],i=+T[1],_()):[n,i]},w.center=function(T){return arguments.length?(o=T[0]%360*ze,l=T[1]%360*ze,_()):[o*He,l*He]},w.rotate=function(T){return arguments.length?(s=T[0]%360*ze,d=T[1]%360*ze,x=T.length>2?T[2]%360*ze:0,_()):[s*He,d*He,x*He]},w.angle=function(T){return arguments.length?(m=T%360*ze,_()):m*He},w.reflectX=function(T){return arguments.length?(u=T?-1:1,_()):u<0},w.reflectY=function(T){return arguments.length?(b=T?-1:1,_()):b<0},w.precision=function(T){return arguments.length?(R=Fn(q,z=T*T),C()):ot(z)},w.fitExtent=function(T,O){return Cr(w,T,O)},w.fitSize=function(T,O){return Ls(w,T,O)},w.fitWidth=function(T,O){return Rs(w,T,O)},w.fitHeight=function(T,O){return Ms(w,T,O)};function _(){var T=Pn(r,0,0,u,b,m).apply(null,a(o,l)),O=Pn(r,n-T[0],i-T[1],u,b,m);return c=cs(s,d,x),q=Ea(a,O),S=Ea(c,q),R=Fn(q,z),C()}function C(){return A=N=null,w}return function(){return a=e.apply(this,arguments),w.invert=a.invert&&M,_()}}function Ar(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Ar.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ue(i)>ce&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function Us(){return Bs(Ar).scale(175.295)}function Vs(e){return e}function Hs(e){if(e==null)return Vs;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,d){d||(a=r=0);var x=2,c=s.length,m=new Array(c);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;x<c;)m[x]=s[x],++x;return m}}function Ws(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function Ys(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Dn(e,r)})}:Dn(e,a)}function Dn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=Gs(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function Gs(e,a){var r=Hs(e.transform),n=e.arcs;function i(c,m){m.length&&m.pop();for(var u=n[c<0?~c:c],b=0,p=u.length;b<p;++b)m.push(r(u[b],b));c<0&&Ws(m,p)}function o(c){return r(c)}function l(c){for(var m=[],u=0,b=c.length;u<b;++u)i(c[u],m);return m.length<2&&m.push(m[0]),m}function s(c){for(var m=l(c);m.length<4;)m.push(m[0]);return m}function d(c){return c.map(s)}function x(c){var m=c.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:c.geometries.map(x)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=d(c.arcs);break;case"MultiPolygon":u=c.arcs.map(d);break;default:return null}return{type:m,coordinates:u}}return x(a)}const Tr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Ks=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Qs(e,a,r){const n=Tr[e];if(!n||!n.length)return-1;const i=Ks(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Bt=null;function Js(){return Bt||(Bt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=Ys(r,n),o=Us().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=qs(o),s=(i.features||[]).filter(c=>{var m;return(((m=c.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(c=>{var b;const m=((b=c.properties)==null?void 0:b.name)||"",u=l(c)||"";return u?{i2:jo(m)||null,n:m,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const d={};for(const[c,m]of Object.entries(No)){const u=o(m);u&&(d[c]={x:u[0],y:u[1]})}const x={};for(const[c,m]of Object.entries(Tr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(x[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:d,metros:x}}catch{return null}})(),Bt)}function Xs(e){const[a,r]=f.useState(null);return f.useEffect(()=>{if(!e||a)return;let n=!1;return Js().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const Zs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},In=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function $n(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function el(e,a){const[r,n]=f.useState(1);return f.useEffect(()=>{let i=!0,o=0;const l=()=>{var x;if(!i)return;const d=(x=e.current)==null?void 0:x.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Bn({msgs:e}){const[a,r]=f.useState(0);f.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function tl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:d,data:x,dossiers:c}=I(),m=x.loading&&!c.length,u=f.useRef(null),b=f.useRef(null),p=Xs(e.continent==="monde"),g=e.continent==="monde"?p:Ba.find(C=>C.key===e.continent)||null,v=el(u,e.continent+":"+e.mapFolded+":"+!!g),[h,E]=f.useState(new Map),[j,y]=f.useState(null);f.useEffect(()=>{const C=u.current;if(!C)return;const T=new Map;C.querySelectorAll("path[data-i2]").forEach(O=>{const U=O.dataset.i2;if(U)try{const W=O.getBBox();W.width>0&&T.set(U,{x:W.x,y:W.y,w:W.width,h:W.height})}catch{}}),E(T)},[e.continent,v,g]);const z=f.useMemo(()=>r.filter(C=>C.cc),[r]),R=f.useMemo(()=>{const C=new Map;return z.forEach(T=>C.set(T.cc,(C.get(T.cc)||0)+1)),C},[z]),q=e.continent==="monde"&&p?p.anchors:null,S=e.continent==="monde"&&p?p.metros:null,A=f.useMemo(()=>z.map(C=>{const T=$n(C.name||C.id||""),O=$n((C.id||C.name||"")+"·y");if(q&&C.cc){const Y=S?S[C.cc]:void 0;if(Y&&Y.length){const re=Qs(C.cc,C.city,T);if(re>=0&&Y[re])return{d:C,x:Y[re].x+(T-.5)*5,y:Y[re].y+(O-.5)*5}}const J=q[C.cc];if(J)return{d:C,x:J.x+(T-.5)*10,y:J.y+(O-.5)*10}}const U=C.cc?h.get(C.cc):void 0;if(!U)return null;const W=Zs[`${e.continent}:${C.cc||""}`];if(W)return{d:C,x:U.x+U.w*(W.fx+(T-.5)*W.sx),y:U.y+U.h*(W.fy+(O-.5)*W.sy)};const H=(T-.5)*Math.min(U.w*.55,60),Q=(O-.5)*Math.min(U.h*.55,60);return{d:C,x:U.x+U.w/2+H,y:U.y+U.h/2+Q}}).filter(C=>!!C),[z,h,q,S,e.continent]),N=C=>v>0?C/v:C,w=f.useMemo(()=>n?[0,1,2,3,4,5].map(C=>({c:In[C],fr:d.plabels[C].toUpperCase(),en:d.plabels[C].toUpperCase(),n:r.filter(T=>T.kind==="target"&&ye(T)===C).length})).filter(C=>C.n>0):on.map((C,T)=>({...C,n:r.filter(O=>sn(O)===T).length})),[r,n,d.plabels]),M=o?l.get(o):null,_=M?A.find(C=>C.d.id===M.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[m&&t.jsx(Bn,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((C,T)=>t.jsx("g",{className:"ct"+(C.i2&&R.get(C.i2)?"":" empty"),children:t.jsx("path",{d:C.d,"data-i2":C.i2||void 0})},T))}),t.jsx("g",{children:A.map(C=>{const T=on[sn(C.d)],O=!!je(C.d),U=C.d.kind==="target",W=n&&U?In[ye(C.d)]:T.c,H=!n&&qe(C.d);return t.jsxs("g",{className:"co"+(H?" done":""),onMouseEnter:()=>{var J,re;const Q=(J=b.current)==null?void 0:J.getBoundingClientRect(),Y=(re=u.current)==null?void 0:re.createSVGPoint();if(Y&&u.current&&Q){Y.x=C.x,Y.y=C.y;const Z=Y.matrixTransform(u.current.getScreenCTM());y({x:Z.x-Q.left,y:Z.y-Q.top,label:C.d.name+" · "+(mt(C.d.cc,s)||C.d.countryLabel||"")})}i(C.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var J;const Q=(J=u.current)==null?void 0:J.createSVGPoint();let Y=null;if(Q&&u.current){Q.x=C.x,Q.y=C.y;const re=Q.matrixTransform(u.current.getScreenCTM());Y={x:re.x,y:re.y}}a({type:"popup",id:C.d.id,anchor:Y})},children:[t.jsx("circle",{className:"h",cx:C.x,cy:C.y,r:N(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:C.x,cy:C.y,r:N(T.px),fill:W,stroke:O?"#DC2626":"#ffffff",strokeWidth:N(O?2.2:1.3)})]},C.d.id||C.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:N(13),fill:"none",stroke:"#0F172A",strokeWidth:N(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:w.map((C,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":C.c}}),s==="fr"?C.fr:C.en," ",t.jsx("b",{children:C.n})]},T))}),r.some(C=>!C.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(C=>!C.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:t.jsx(Bn,{msgs:d.loadMsgs})})}function al(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function zr({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:s}=I(),d=a.filters,[x,c]=f.useState(!1),m=f.useRef(null),u=f.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),b=S=>u.filter(A=>S!=="country"&&d.country.length&&!d.country.includes(A.cc||"")?!1:Ua(A,d,o,S==="country"?void 0:S)),p=f.useMemo(()=>{const S=b("win"),A=N=>S.filter(w=>(w.date?Math.max(0,Math.floor((Date.now()-Date.parse(w.date))/864e5)):9999)<=N).length;return[A(0),A(7),A(30),S.length]},[u,d,o]),g=f.useMemo(()=>d.day?b("win").filter(S=>(S.date||"").slice(0,10)===d.day).length:0,[u,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,h=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);f.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),f.useEffect(()=>{if(!x)return;const S=N=>{var w;(w=m.current)!=null&&w.contains(N.target)||c(!1)},A=N=>{N.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",S),document.addEventListener("keydown",A),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",A)}},[x]);const E=(S,A,N,w="fbtn")=>t.jsxs("button",{type:"button",className:w,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:A}),N>0&&t.jsx("span",{className:"n",children:N}),t.jsx("span",{className:"cv",children:"▾"})]},S),j=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(al(d.day,s))}),t.jsx("b",{children:g})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((S,A)=>t.jsxs("button",{type:"button","aria-pressed":d.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:i.dates[A]}),t.jsx("b",{children:p[A]})]},S))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),z=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):E("sec",i.fSector,d.sector.length),E("pay",i.fCountry,d.country.length),E("det",i.fEngine,d.engine.length),E("sta",i.fStage,d.stage.length),o&&E("ang","Angle",d.angle.length),o&&E("mem","Mémo",d.memoLevel.length)]}),R=t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn})]}),q=t.jsxs("div",{className:"fmenu",ref:m,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{c(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:z})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip",children:[t.jsx("div",{className:"fstrip-a",children:j}),t.jsxs("div",{className:"fstrip-b",children:[y,q,R]})]}),a.openFacet&&t.jsx(_n,{poolFor:b})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[j,y,z,t.jsx("span",{className:"fgrow"}),R]}),a.openFacet&&t.jsx(_n,{poolFor:b})]})}function _n({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=I(),o=a.filters,l=a.openFacet,{title:s,cols:d,options:x}=f.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(h=>je(h)),g=new Map;p.forEach(h=>{const E=h.engine||"";g.set(E,(g.get(E)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...va([...g.keys()],i).map(h=>({v:h,label:tt(h)+" "+Ue(h,i),n:g.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:mt(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:va([...g.keys()],i).map(v=>({v,label:tt(v)+" "+Ue(v,i)+' <span style="color:var(--dim);font-size:10px">· '+So(Eo(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(h=>{if(h.kind==="target"){const E=Ia(h);g.set(E,(g.get(E)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:g.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function qr({mapToggle:e=!0}){const{dossiers:a,st:r,dispatch:n,pipe:i,lang:o,t:l}=I(),s=f.useMemo(()=>{const d={};return a.forEach(x=>{Ua(x,r.filters,i)&&(d.monde=(d.monde||0)+1,x.continent&&(d[x.continent]=(d[x.continent]||0)+1))}),d},[a,r.filters,i]);return t.jsxs("div",{className:"conts",children:[Co.map(d=>{const x=Ba.find(m=>m.key===d),c=d==="monde"?l.contWorld:o==="fr"?x.fr:x.en;return t.jsxs("button",{type:"button",className:"cbtn","aria-selected":r.continent===d,onClick:()=>n({type:"continent",key:d}),children:[c,t.jsx("span",{className:"n",children:s[d]||0})]},d)}),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!r.mapFolded}),children:r.mapFolded?l.showMap:l.hideMap})})]})}function Lr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function nl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Un({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=I();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:s.rsEvalOne})]},d.name))})]}):null}function Rr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=I(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Un,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Un,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function rl({card:e,onEvaluate:a,onAddAll:r}){var s,d,x;const{t:n}=I(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Lr(e.summary_md||"").map((c,m)=>t.jsx("p",{children:c},m))})]}),t.jsx(Rr,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function ol(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function il({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=I(),s=i,[d,x]=f.useState(null),[c,m]=f.useState(null),[u,b]=f.useState(null),[p,g]=f.useState(!1);f.useEffect(()=>{let h=!0;return(async()=>{const E=await ar({email:l,cbToken:s});h&&x(E)})(),()=>{h=!1}},[l,s,n]);const v=h=>{m(h),b(null),g(!0),(async()=>{const E=await Ao(h.id);b(E),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[ol(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(rl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Vn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function sl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:d,caps:x,data:c,canWrite:m,source:u,dossiers:b,doAnalyse:p,liveMemos:g,pipe:v}=I(),h=a==="client",E=f.useMemo(()=>r||(u!=="default"?To():""),[r,u]),[j,y]=f.useState(""),[z,R]=f.useState(!1),[q,S]=f.useState(""),[A,N]=f.useState(!1),[w,M]=f.useState(""),[_,C]=f.useState([]),T=f.useRef(!1),[O,U]=f.useState(!1),[W,H]=f.useState(""),[Q,Y]=f.useState(""),[J,re]=f.useState(!1),[Z,me]=f.useState(0),[he,fe]=f.useState(""),[X,oe]=f.useState(null),[ee,V]=f.useState(null),[G,ge]=f.useState(!1),[L,F]=f.useState(null),[$,K]=f.useState(0),se=f.useRef(!1),te=j.trim()?Vn.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting,le=f.useMemo(()=>q.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[q]);f.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(H(P),U(!0))},[]),f.useEffect(()=>{const P=ie=>{var Ne;const de=String(((Ne=ie.detail)==null?void 0:Ne.url)||"").trim();!de||!/^https?:\/\//i.test(de)||(H(de),U(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),f.useEffect(()=>{if(!m&&!E){F(null);return}let P=!0;return(async()=>{const ie=await ar({email:n,cbToken:E});P&&F(ie.length)})(),()=>{P=!1}},[m,E,n,$]);const Le=_.length?_:d,pe=c.credits,Te=f.useCallback(P=>{const ie=P.map(de=>(de||"").trim()).filter(Boolean);ie.length&&(S(de=>{const Ne=de.split(`
...
`).map((x,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[ct(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const ha={},Hn=(ha==null?void 0:ha.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Wn(){return new Date().toISOString().slice(0,10)}const Ga=f.createContext(null);function dl(){return f.useContext(Ga)}function pl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),s.querySelectorAll("*").forEach(d=>{const x=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(c=>d.removeAttribute(c.name)),x&&/^https?:\/\//i.test(x)&&(d.setAttribute("href",x),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Yn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Mr(){const e=f.useContext(Ga);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ul({token:e,children:a}){const{dispatch:r,st:n,lang:i}=I(),[o,l]=f.useState(()=>n.filters.day||Wn()),[s,d]=f.useState(null),[x,c]=f.useState(!1),m=f.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=f.useCallback(()=>{l(Wn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);f.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),f.useEffect(()=>{const g=v=>{var E;const h=(E=v.detail)==null?void 0:E.day;typeof h=="string"&&m(h)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[m]),f.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),f.useEffect(()=>{if(!e||!o)return;let g=!1;c(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Hn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{g||d(h)}).catch(()=>{g||d({ok:!1,error:"network"})}).finally(()=>{g||c(!1)}),()=>{g=!0}},[e,o]);const b=f.useMemo(()=>`${Hn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=f.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,x,m,u,n.filters.day,b,i]);return t.jsx(Ga.Provider,{value:p,children:a})}function ml(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Mr(),[i,o]=f.useState(n);return f.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Ro,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function fl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Mr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
