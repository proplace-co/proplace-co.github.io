...
.atl2 .tkfil{flex:none;position:relative;display:flex;align-items:center;gap:4px;
  max-width:min(62%,780px);padding:0 8px;border-right:1px solid #1E293B;min-width:0}
.atl2 .tkchips{display:flex;align-items:center;gap:4px;overflow-x:auto;scrollbar-width:none;min-width:0}
.atl2 .tkchips::-webkit-scrollbar{display:none}
.atl2 .tkchip{display:inline-flex;align-items:center;gap:5px;height:26px;padding:0 8px;
  font-family:var(--mono);font-size:8.5px;letter-spacing:.04em;font-weight:600;color:#D5E3F0;
  background:transparent;border:1px solid #1E2C41;border-radius:4px;cursor:pointer;
  white-space:nowrap;flex:none}
.atl2 .tkchip:hover{color:#fff;border-color:#5FD39B}
.atl2 .tkchip[aria-pressed="true"]{background:#0E8A4F;color:#fff;border-color:#0E8A4F}
.atl2 .tkchip b{font-family:var(--mono);font-size:10px;font-weight:700;letter-spacing:0;color:#fff;
  background:rgba(255,255,255,.16);border-radius:3px;padding:1px 5px}
.atl2 .tkchip[aria-pressed="true"] b{background:rgba(255,255,255,.22)}
.atl2 .tkfilb{display:inline-flex;align-items:center;flex:none;font-family:var(--mono);
  font-size:11px;font-weight:600;color:#D5E3F0;background:transparent;
  border:1px solid #1E2C41;border-radius:4px;padding:4px 7px;cursor:pointer;white-space:nowrap}
.atl2 .tkfilb:hover{color:#fff;border-color:#5FD39B}
.atl2 .tkfilm button b{font-family:var(--mono);font-size:10px;font-weight:700;
...
/* Encadré = dalle sticky de la hauteur restante. height (pas seulement
   max-height) : c'est CE bloc qui défile au survol, le kicker reste en tête,
   le gris remplit l'encadré. */
.atl2.ops .readpane{min-width:0;min-height:0;position:sticky;align-self:start;
  z-index:35;top:calc(104px + var(--demand-h,56px));
  height:calc(100dvh - 104px - var(--demand-h,56px));
  max-height:calc(100dvh - 104px - var(--demand-h,56px));
...
/* Kicker collé en tête DU DÉFILEMENT de l'encadré. */
.atl2.ops .readpane .zoom-k{position:sticky;top:0;z-index:3;
  background:#F7F9FB;margin:-22px -26px 10px;padding:18px 26px 10px}
...
.atl2.ops .readpane .pane-edito{position:sticky;top:0;z-index:5;display:block;
  width:calc(100% - 32px);margin:12px 16px 0;text-align:left}
...
.atl2 .viewbtn{flex:none;height:42px;padding:0 14px;background:#fff;color:var(--ink);
...
.atl2 .viewbtn:disabled{opacity:.45;cursor:default}
.atl2 .artview{position:fixed;z-index:50;left:0;right:0;bottom:0;
  top:calc(104px + var(--demand-h,56px));display:flex;flex-direction:column;
  background:#0B1220}
.atl2 .artview-bar{flex:none;display:flex;align-items:center;gap:12px;
  padding:8px 16px;background:#0B1220;color:#fff}
.atl2 .artview-bar b{flex:none;font-size:13px;font-weight:700;letter-spacing:-.01em}
.atl2 .artview-hint{flex:1;min-width:0;font-size:11.5px;color:#9DB2CA;
  overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.atl2 .artview-bar a{flex:none;font-size:12px;color:#7FD8A6;text-decoration:none}
.atl2 .artview-bar a:hover{text-decoration:underline}
.atl2 .artview-x{flex:none;background:none;border:0;color:#fff;font:inherit;
  font-size:22px;line-height:1;cursor:pointer;padding:0 4px}
.atl2 .artview-x:hover{color:#7FD8A6}
.atl2 .artview iframe{flex:1;width:100%;border:0;background:#fff}
...
`,Vi=Ui+Hi;function $a(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Wi(){const e=$a("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Yi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Wi();return r==="0"?"client":r==="1"||$a("embed")==="1"&&$a("chrome")==="1"?"apercu":"client"}const Gi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ki=e=>Gi[e];function ma(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const xt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Nr(a)||ma(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Mo(e.cc)})};function Ca(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Qi=60*60*1e3;function Ji(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Qi?null:a}catch{return null}}function Zt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Xi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Zi(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:ko(),[e,n]),o=m.useMemo(()=>n?"visiteur":Yi(e,i),[e,i,n]),l=m.useMemo(()=>Ki(o),[o]),d=o!=="visiteur",c=Xi(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[h,p]=m.useState(null),[b,v]=m.useState(null),[g,S]=m.useState(null),[z,y]=m.useState(()=>new Map),[T,q]=m.useState(()=>new Map),[L,A]=m.useState(""),[C,N]=m.useState(new Set),[M,$]=m.useState(null),[O,H]=m.useState(!0),[w,k]=m.useState(!1),[F,I]=m.useState(0),[B,W]=m.useState(0),G=m.useRef(0),Q=m.useMemo(()=>{var ne;if(o!=="client")return"";try{return((ne=jo())==null?void 0:ne.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ne=++G.current;let fe=!0;const ye=()=>fe&&ne===G.current,re=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),ee=Ji(re);return ee?(s(ee.objs.map(xt)),ee.fund&&u(ee.fund),p(ee.marketEstimate??null),v(ee.criteria??null),S(ee.stats??null),A(ee.generatedAt||""),H(!1)):H(!0),(async()=>{try{if(r==="ops"){const xe=await Ea(),pe=((xe==null?void 0:xe.recent_ops)||[]).map(K=>{const Z=da(K.company_name||K.title?K:{...K,title:(K.headline_fr||K.headline||"").slice(0,120)},a),J=String(K.rubrique||"").toLowerCase();return Z&&(J==="nominations"||J==="recrutements")&&(Z.engine=J),Z&&!String(K.company_name||"").trim()&&(Z.noCo=!0),Z}).filter(K=>!!K).map(K=>(Nr((K.name||"").trim())||(K.noCo=!0),K));try{const K=No(),Z=K&&K.doc||await Eo(),J=So(Z),te=((K==null?void 0:K.day)||(Z==null?void 0:Z.date)||"").slice(0,10);if(te&&J.length){const he=new Set;for(const Y of pe){if((Y.date||"").slice(0,10)!==te)continue;const ue=En(J,he,Y.name,"");ue>=0&&(he.add(ue),Y.decryptHtml=J[ue].html)}for(const Y of pe){if(Y.decryptHtml||(Y.date||"").slice(0,10)!==te)continue;const ue=En(J,he,"",Y.headline||Y.tagline||Y.name);ue>=0&&(he.add(ue),Y.decryptHtml=J[ue].html)}}if(te){const he=((Z==null?void 0:Z.title_fr)||"").trim(),Y=((Z==null?void 0:Z.lead_fr)||"").trim(),ue=Co(Z),se=((Z==null?void 0:Z.url)||"").trim();he&&(ue||se)&&pe.unshift({id:`edito:${te}`,kind:"op",name:he,cc:null,date:te,engine:"edito",dealKind:"other",headline:Y||he,tagline:Y||he,decryptHtml:ue||void 0,url:se,noCo:!0})}}catch{}if(!ye())return;s(pe.map(xt)),Zt(re,{objs:pe})}else if(typeof r=="object"){const pe=(await Sn()||[]).filter(Z=>(Z.slug||"")===r.research).map(Z=>Cn(Z,a)).filter(Z=>!!Z),K=Ca(await zn(pe,a));if(!ye())return;s(K.map(xt)),Zt(re,{objs:K})}else if(d&&i.token){const xe=zo(i.token),pe=Ea(),K=Ao(i.token),Z=To(i.token),J=Lo(i.token),te=await xe;let he=te?te.targets:[];ye()&&te&&(u(te.fund||""),p(te.marketEstimate??null),v(te.criteria??null),S(te.stats??null),A(te.generatedAt||""),s(he.map(xt)),H(!1),k(!1));const[Y,ue,se,ge]=await Promise.all([pe,K,Z,J]),Ie=((Y==null?void 0:Y.recent_ops)||[]).map(Se=>da(Se,a)).filter(Se=>!!Se);if(he=[...he,...Ie],!ye())return;s(he.map(xt));const Ve=new Set;for(const Se of ue){const Fe=(Se.id||Se.co||"").toString().trim().toLowerCase();Fe&&Ve.add(Fe.startsWith("t:")?Fe:"t:"+Fe)}N(Ve),y(se),q(ge),te&&Zt(re,{fund:te.fund,marketEstimate:te.marketEstimate,criteria:te.criteria,stats:te.stats,generatedAt:te.generatedAt,objs:he})}else{const xe=qo(),pe=Sn(),K=Ea(),Z=await xe;ye()&&Z.length&&(s(Ca(Z).map(xt)),H(!1),k(!1));const[J,te]=await Promise.all([pe,K]),he=(J||[]).map(ge=>Cn(ge,a)).filter(ge=>!!ge),Y=await zn(he,a),ue=((te==null?void 0:te.recent_ops)||[]).map(ge=>da(ge,a)).filter(ge=>!!ge),se=Ca([...Z,...Y,...ue]);if(!ye())return;s(se.map(xt)),Zt(re,{objs:se})}ye()&&k(!1)}catch{ye()&&!ee&&k(!0)}finally{ye()&&H(!1)}})(),()=>{fe=!1}},[d,i.token,a,F,c]),m.useEffect(()=>{if(!l.showCredits||!Q){$(null);return}let ne=!0;return(async()=>{try{const fe=await fetch(`${on}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Q})});if(!fe.ok)return;const ye=await fe.json();ne&&ye&&ye.ok!==!1&&$(ye)}catch{}})(),()=>{ne=!1}},[l.showCredits,Q,B]);const oe=m.useCallback(ne=>N(new Set(ne)),[]);return{session:i,mode:o,caps:l,fund:x,email:Q,marketEstimate:h,generatedAt:L,criteria:b,stats:g,thumbs:z,stages:T,dossiers:f,favIds:C,setFavIds:oe,credits:M,reloadCredits:()=>W(ne=>ne+1),loading:O,error:w,refresh:()=>I(ne=>ne+1)}}function ut(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const zr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),es=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...zr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ts=new Set(["signal","amount","score","crible","memo"]);function as(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:zr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ts.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Ar)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Ar=80;function fa(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!qe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(sn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(dt(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&gt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Tr(e,a,r){return ut(e)?fa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:fa(e,a.filters,r)}function ns(e,a,r,n){return!(!Tr(e,a,r)||r&&!Ro(e,a.ptab,n))}function pn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-dt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Oo(i);case"memo":return Fo(i);case"signal":{const o=qe(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const za={},In=(za==null?void 0:za.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Bn(){return new Date().toISOString().slice(0,10)}const un=m.createContext(null);function Lr(){return m.useContext(un)}function rs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const f=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(c.setAttribute("href",f),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function $n(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function qr(){const e=m.useContext(un);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function os({token:e,children:a}){const{dispatch:r,st:n,lang:i}=_(),[o,l]=m.useState(()=>n.filters.day||Bn()),[d,c]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(Bn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=v=>{var S;const g=(S=v.detail)==null?void 0:S.day;typeof g=="string"&&x(g)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${In}/cibles/edition.json?${v}`).then(g=>g.json()).then(g=>{b||c(g)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const h=m.useMemo(()=>`${In}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:d,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:h,isEn:i==="en"}),[e,o,d,f,x,u,n.filters.day,h,i]);return t.jsx(un.Provider,{value:p,children:a})}function is(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=qr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Po,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})]})}function ss(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=qr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:$n(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:$n(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const ls=300,ea=7,ds={fr:{ma:"M&A",levees:"Levées de fonds",nominations:"Nominations",recrutements:"Offres d'emploi",actualites:"Autres actualités"},en:{ma:"M&A",levees:"Fundraising",nominations:"Appointments",recrutements:"Job offers",actualites:"Other news"}},_a={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},cs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Aa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Bo(r)&&r!=="media")return"news:"+r;const n=qe(e);return n?"sig:"+(n.theme&&_a.fr[n.theme]?n.theme:"other"):"actualites"}function ps(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=_(),c=Lr(),f=l==="en",[s,x]=m.useState("all"),[u,h]=m.useState(!1),p=m.useMemo(()=>{var ye;const k=(a.filters.day||"").slice(0,10),F=re=>!(!o&&a.continent!=="monde"&&re.continent!==a.continent||k&&(re.date||"").slice(0,10)!==k),I=e.filter(re=>F(re)&&qe(re)&&(!o||re.kind!=="target"||Ae(re)!==5)),B=o&&(((ye=c==null?void 0:c.ed)==null?void 0:ye.ops)||[]).length?c.ed.ops.map(re=>da(re,l)).filter(re=>!!re).filter(re=>!k||(re.date||"").slice(0,10)===k):[],W=e.filter(re=>F(re)&&re.kind==="op"&&(k?!0:dt(re.date)<=ea)),G=o?B.length?B:W.filter(re=>{const ee=(d||"").trim().toLowerCase();if(!ee)return!1;const xe=re.match||null;return xe?Object.keys(xe).map(pe=>pe.trim().toLowerCase()).includes(ee):!1}):W,Q=k||new Date().toISOString().slice(0,10),oe=re=>{const ee=Aa(re);return ee==="ma"?0:ee==="levees"?1:2};G.sort((re,ee)=>{const xe=oe(re)-oe(ee);if(xe)return xe;const pe=(re.date||"").slice(0,10)===Q?0:1,K=(ee.date||"").slice(0,10)===Q?0:1;return pe!==K?pe-K:(ee.amountEur||0)-(re.amountEur||0)});const ne=new Set,fe=[];for(const re of[...G,...pn(I,{key:"signal",dir:-1})]){const ee=re.id||re.name;!ee||ne.has(ee)||(ne.add(ee),fe.push(re))}return o&&fe.length===0?e.filter(ee=>F(ee)&&dt(ee.date)<=ea).sort((ee,xe)=>(xe.date||"").localeCompare(ee.date||"")).slice(0,80):fe},[e,a.continent,a.filters.day,o,d,l,c]),b=m.useMemo(()=>{const k={};for(const F of p){const I=Aa(F);k[I]=(k[I]||0)+1}return k},[p]),v=m.useMemo(()=>s==="all"?p:p.filter(k=>Aa(k)===s),[p,s]),g=m.useMemo(()=>v.slice(0,ls),[v]),S=v.length-g.length,z=m.useRef(null);m.useEffect(()=>{var G,Q;const k=z.current;if(!k)return;const F=()=>{const oe=k.scrollWidth;oe<200||(k.style.animationDuration=Math.max(18,Math.round(oe/130))+"s")};F();const I=requestAnimationFrame(F),B=window.setTimeout(F,1200);let W=!0;return(Q=(G=document.fonts)==null?void 0:G.ready)==null||Q.then(()=>{W&&F()}),()=>{W=!1,cancelAnimationFrame(I),window.clearTimeout(B)}},[g.length,s]);const y=k=>k==="all"?p.length:b[k]||0,T=k=>{if(k==="all")return f?"All":"Tout";if(k.startsWith("sig:"))return _a[f?"en":"fr"][k.slice(4)]||"🔔";if(k.startsWith("news:")){const F=k.slice(5);return An[F]?Io(F,f?"en":"fr"):k}return ds[f?"en":"fr"][k]},q=k=>{if(k==="all")return f?"All":"Tout";if(k==="ma")return"M&A";if(k==="levees")return f?"Raises":"Levées";if(k==="nominations")return f?"Appointed":"Nominations";if(k==="recrutements")return f?"Hiring":"Recrute";if(k==="actualites")return f?"Other":"Autres";if(k.startsWith("news:")){const F=k.slice(5),I=An[F];return I?I.emoji+" "+(f?I.en:I.fr).split(/[&·]/)[0].trim():k}return k.startsWith("sig:")?_a[f?"en":"fr"][k.slice(4)]||"🔔":T(k)},L=[{k:"all"}],A=["ma","levees"].filter(k=>y(k)>0||k===s);if(A.length){L.push({g:f?"Deals":"Opérations"});for(const k of A)L.push({k})}const C=["nominations","recrutements"].filter(k=>y(k)>0||k===s),N=Do.filter(k=>k!=="media").map(k=>"news:"+k).filter(k=>y(k)>0||k===s),M=y("actualites")>0||s==="actualites"?["actualites"]:[];if(C.length||N.length||M.length){L.push({g:f?"News":"Actualités"});for(const k of C)L.push({k});for(const k of N)L.push({k});for(const k of M)L.push({k})}const $=cs.map(k=>"sig:"+k).filter(k=>y(k)>0||k===s);if($.length){L.push({g:f?"Signals (your engines)":"Signaux (vos moteurs)"});for(const k of $)L.push({k})}const O=k=>{try{return new Date(k+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return k}},H=(()=>{const k=(a.filters.day||"").slice(0,10),F=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return k?(f?`LIVE covers the events of ${O(k)}.`:`Le LIVE regroupe les événements du ${O(k)}.`)+F:(f?`LIVE covers the still-open signals and the deals of the last ${ea} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ea} derniers jours.`)+F})(),w=k=>g.map(F=>t.jsxs("button",{type:"button",className:"tk"+($e(F)?" spent":""),onClick:I=>{if(n({type:"focus",id:F.id}),a.dens!=="liste"){const B=I.currentTarget.getBoundingClientRect();n({type:"popup",id:F.id,anchor:{x:B.left+B.width/2,y:B.bottom}})}},title:F.name+(F.tagline?" — "+F.tagline:""),children:[t.jsx(wt,{o:F}),t.jsxs("span",{className:"who",children:[t.jsx(uo,{o:F}),t.jsx("span",{className:"co",children:F.name})]}),typeof F.amountEur=="number"&&F.amountEur>0&&t.jsx("span",{className:"am",children:Dd(F.amountEur)}),F.sector&&t.jsx("span",{className:"mt",children:F.sector}),t.jsx(Na,{o:F}),t.jsx("span",{className:"tkgo",children:"→"})]},k+(F.id||F.name))).concat(S>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${S} more — filter by section to see them`:`+ ${S} autres — filtrez par rubrique pour les voir`},k+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:k=>{k.currentTarget.contains(k.relatedTarget)||h(!1)},children:[t.jsx("span",{className:"tkchips",children:L.filter(k=>"k"in k).map(k=>y(k.k)===0&&k.k!==s&&k.k!=="all"?null:t.jsxs("button",{type:"button",className:"tkchip","aria-pressed":k.k===s,title:T(k.k),onClick:()=>{x(k.k),h(!1)},children:[q(k.k),t.jsx("b",{children:y(k.k)})]},k.k))}),t.jsx("button",{type:"button",className:"tkfilb","aria-expanded":u,"aria-label":f?"All sections":"Toutes les rubriques",onClick:()=>h(k=>!k),children:"▾"}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:H}),L.map(k=>"g"in k?t.jsx("span",{className:"tkfilg",children:k.g},k.g):t.jsxs("button",{type:"button","aria-pressed":k.k===s,onClick:()=>{x(k.k),h(!1)},children:[T(k.k),t.jsx("b",{children:y(k.k)})]},"m"+k.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",ref:z,children:[w(0),w(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsx(ms,{isEn:f})]})}const us=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ms({isEn:e}){const[a,r]=m.useState(()=>$o());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(Tn,i),()=>window.removeEventListener(Tn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>_o(!a),children:us})}const mn="+33 6 83 10 72 86",xa="alexandre@proplace.co",Mr=`tel:${mn.replace(/[^\d+]/g,"")}`;function fs(){return null}class Pe extends m.Component{constructor(){super(...arguments);jn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Ta=600,ht=62,_n="atl2:fstats";function xs(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=_(),[l,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(_n)==="on"}catch{return!1}}),c=r.stats,f=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=T=>a==="en"?T.slice(5,10):`${T.slice(8,10)}/${T.slice(5,7)}`,u=T=>T.toLocaleString(a==="en"?"en-US":"fr-FR"),h=f.reduce((T,q)=>Math.max(T,q.s||0),0),p=f.length?Ta/f.length:0,b=Math.max(4,p-4),v=f.length>=5&&h>0,g=r.marketEstimate||0,S=x(new Date().toISOString().slice(0,10)),z=T=>[...typeof T=="number"?[[T,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],y=[];return typeof c.screened_window=="number"&&s&&y.push({cle:"fenetre",periode:e.funPerWindow(x(s),S),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:z(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(T=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:T.periode}),T.etapes.map(([q,L],A)=>t.jsxs("span",{className:"fst-t",children:[A>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(q)}),t.jsx("i",{children:L})]},T.cle+L)),T.cle==="total"&&g>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(g),Math.min(100,Math.round((c.screened||0)/g*100)))})]}),T.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const q=!l;d(q),q&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(_n,q?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},T.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ta} ${ht}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((T,q)=>{const L=(T.s||0)/h*(ht-4),A=(T.m||0)/h*(ht-4),C=q*p+(p-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(T.d)} — ${T.s} ${e.actScreened} · ${T.m} ${e.actKept}`}),t.jsx("rect",{x:C,y:ht-2-L,width:b,height:L,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:ht-2-A,width:b,height:A,fill:"#185c38"})]},T.d)}),t.jsx("line",{x1:0,y1:ht-1.5,x2:Ta,y2:ht-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Rr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function hs(e,a){if((mt(e)||"").startsWith("CALL")&&Ae(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ae(e)>=2;return Rr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function gs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=_(),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),p=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){u(!0);return}s(b);const v=await i(e,b);s(""),v&&(c(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),u(!1)},children:[h||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]}):hs(e,a).map(([b,v])=>t.jsx("button",{type:"button",className:"rsti"+(h===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{p(b)},children:v},b))})]})}function bs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=_(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(mt(e)||"").startsWith("CALL")&&Ae(e)===3,x=Ae(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const b=await i(e,p);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},h=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Rr.filter(([p])=>!(x&&p==="Retenu")).map(([p,b])=>[p,a[b]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([p,b])=>t.jsx("button",{type:"button",className:"csb"+(f===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:b},p)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(vs,{o:e})]})}function vs({o:e}){const{t:a,saveNote:r,flash:n}=_(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;d(!0);const u=await r(e,i.trim());d(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function ys({placeholder:e,onDone:a}){const{t:r}=_(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ws({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=_(),[c,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||Ae(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",u=async g=>{if(c||g===x)return;f(!0);const S=s;l(e,{stage:g,stamps:(s==null?void 0:s.stamps)||{}});const z=Math.max(Date.now(),Un+=1);Un=z;const y=await Uo(r,{company:e.name||"",stage:g,cts:z,deal_id:e.airtableId,check_id:e.checkId});f(!1),!y.stale&&(y.ok||(l(e,S),d(a.actErr)))},h=(v=s==null?void 0:s.stamps)==null?void 0:v.sent,p=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,b=x==="sent"&&h&&p>=4;return t.jsxs("div",{className:"stg",onClick:g=>g.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([g,S])=>t.jsx("button",{type:"button",className:"stgb"+(x===g?" on":""),disabled:c,onClick:()=>{u(g)},children:S},g)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let Un=0;const ta=8,aa=360;function Hn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Vn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Hn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Hn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ks({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=_(),[l,d]=m.useState(0),[c,f]=m.useState(null),[s,x]=m.useState([]),u=m.useRef(!1),h=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const L=h.current;return()=>{p.current||(n({type:"ptab",tab:L.ptab}),n({type:"dens",dens:L.dens}),n({type:"modal",modal:L.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,x(e.filter(L=>!!document.querySelector(L.need||L.sel))))},[e]);const b=s[l],v=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const L=b.click,A=window.setTimeout(()=>{const C=document.querySelector(L);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(A)}},[l,b]);const g=m.useRef(-1),S=m.useCallback(()=>{if(!b){f(null);return}const L=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!L){f(null);return}g.current!==l&&(g.current=l,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const A=L.getBoundingClientRect();f(C=>C&&Math.abs(C.top-A.top)<1&&Math.abs(C.left-A.left)<1&&Math.abs(C.width-A.width)<1&&Math.abs(C.height-A.height)<1?C:A)},[b,l]);m.useLayoutEffect(()=>{S();const L=[90,300,700,1300].map(C=>window.setTimeout(S,C)),A=()=>S();return window.addEventListener("scroll",A,!0),window.addEventListener("resize",A),()=>{L.forEach(C=>window.clearTimeout(C)),window.removeEventListener("scroll",A,!0),window.removeEventListener("resize",A)}},[S]);const z=m.useRef(a);if(z.current=a,m.useEffect(()=>{const L=A=>{A.key==="Escape"?(A.preventDefault(),A.stopPropagation(),z.current()):A.key==="ArrowRight"?d(C=>C+1):A.key==="ArrowLeft"&&d(C=>Math.max(0,C-1))};return document.addEventListener("keydown",L,!0),()=>document.removeEventListener("keydown",L,!0)},[]),!s.length)return null;let y=null;const T=L=>()=>{p.current=!0,n({type:"modal",modal:null}),L()};if(v){const L=i[3]||0;L>0?y={title:L===1?r.ahaATitle1:r.ahaATitleN(L),body:r.ahaABody,btn:r.ahaABtn,go:T(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:T(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:T(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:T(()=>{n({type:"modal",modal:"crit"}),a()})}}let q={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:aa};if(!v&&c){const L=c.bottom+14,C=window.innerHeight-L>190?L:Math.max(12,c.top-200);q={left:Math.min(Math.max(12,c.left+c.width/2-aa/2),window.innerWidth-aa-12),top:C,width:aa}}return Mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-ta,top:c.top-ta,width:c.width+ta*2,height:c.height+ta*2}}),(v||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:q,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(Vn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Vn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(L=>Math.max(0,L-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(L=>L+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Fr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Or(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function js(){var A,C;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=_(),f=r?a:e,s=m.useMemo(()=>f.filter(N=>dt(N.date)===0&&N.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(N=>N.kind==="target"&&Ae(N)===0).slice().sort((N,M)=>(M.date||"").localeCompare(N.date||"")):[],[a,r]),u=m.useMemo(()=>s.filter(N=>r?Ae(N)===0:!$e(N)),[s,r]),h=r?x:u,p=r?a.length-x.length:s.length-u.length,b=r?a.length:s.length,v=b?Math.min(100,p/b*100):100,g=m.useMemo(()=>Fr(f),[f]),S=!!g&&dt(g)>0,z=m.useMemo(()=>S?f.filter(N=>(N.date||"").slice(0,10)===g):[],[f,g,S]),y=typeof((A=d.stats)==null?void 0:A.kept_today)=="number"?d.stats.kept_today:null,T=typeof((C=d.stats)==null?void 0:C.screened_today)=="number"?d.stats.screened_today:s.length;let q;S?q=i.morningLast(z.length,x.length,Or(g,l)):r?q=i.morningThesis(T,x.length,y):s.length?p===0?q=i.goalSourced(s.length):p>=s.length?q=i.goalCleared:q=i.goalDone(p,s.length):q=i.goalSourced(0);const L=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(N=>N.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:q}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),h.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:L,children:r?i.morningEval(h.length):o.pileMode?i.goalContinue(h.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ns(){var F,I;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:f,startTour:s,flash:x,flashErr:u}=_(),[h,p]=m.useState(null),[b,v]=m.useState(!0),[g,S]=m.useState([]),z=c==="client";m.useEffect(()=>{if(!i||!o)return;let B=!0;return v(!0),(async()=>{const[W,G]=await Promise.all([ln(o),Er(i)]);B&&(W&&p(W),v(!1),S(G))})(),()=>{B=!1}},[i,o]);const[y,T]=m.useState(!1),q=()=>{!z||y||!o||(T(!0),Ho(o).then(B=>{T(!1),B?x(e.identRepubDone):u(e.actErr)}))},L=(h==null?void 0:h.per_day)??null,A=((F=h==null?void 0:h.pool_order)==null?void 0:F.length)??0,C=g.filter(B=>B.status==="running").length,N=m.useMemo(()=>d.filter(B=>B.kind==="target"&&$e(B)).length,[d]),M=l.marketEstimate,$=typeof((I=l.stats)==null?void 0:I.screened)=="number"?l.stats.screened:N,O=M&&M>0?Math.min(100,Math.round($/M*100)):null,H=B=>B.toLocaleString(a==="en"?"en-US":"fr-FR"),w=(o||"P").split(/\s+/).map(B=>B[0]).join("").slice(0,2).toUpperCase(),k=(()=>{const B=Date.parse(l.generatedAt||"");if(Number.isNaN(B))return"";const W=new Date(B),G=Q=>String(Q).padStart(2,"0");return`${G(W.getDate())}/${G(W.getMonth()+1)} à ${G(W.getHours())}:${G(W.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?w:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),k?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(k)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[O===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:H($)})})]}),O!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:O+"%"}})}),t.jsxs("b",{children:[O," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),L!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:L})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),L===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),C>0&&t.jsxs("span",{className:"ev",children:["⏳ ",C]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(A)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:B=>{B.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!z||y,onClick:q,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!z,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:B=>n({type:"filters",patch:{search:B.target.value}})})]})]})]})}function Es(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=_(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const f=u=>{const h=c.current[u],p=h!==void 0?r[u]-h:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Oa[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},s=(u,h,p)=>t.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":`var(${Oa[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),x=(u,h,p,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:h,disabled:b,onClick:p,children:u},h);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Ss(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=_(),d=m.useRef(null),[c,f]=m.useState(60);m.useEffect(()=>{let p=0;const b=()=>{var y;const v=d.current;if(!v)return;const g=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!g)return;const S=g.getBoundingClientRect(),z=v.getBoundingClientRect();f(Math.max(20,Math.min(S.left+S.width/2-z.left,z.width-30)))};return p=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const p=n.filter(g=>g.kind==="target"&&Ae(g)===3),b=p.filter(g=>Pa(g)==="auto").length,v=p.filter(g=>Pa(g)==="cd").length;x=r.tutoPending(b,v,p.length)}const u=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(s===1){const p=n.filter(b=>b.kind==="target"&&Ae(b)===1&&!i.has(b.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(b=>b.id)})}}return null})(),h=Vo(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(h?"":" on-dark"),style:{"--bg":`var(${Oa[s]})`,"--ax":c+"px","--stc":h?"var(--ink)":"#fff","--stt":h?"#fff":"var(--ink)","--tc":h?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class vt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Cs(e){for(const a of e)yield*a}function Pr(e){return Array.from(Cs(e))}var ve=1e-6,ce=Math.PI,Qe=ce/2,Wn=ce/4,Xe=ce*2,st=180/ce,Ue=ce/180,je=Math.abs,zs=Math.atan,Ut=Math.atan2,Ce=Math.cos,ze=Math.sin,As=Math.sign||function(e){return e>0?1:e<0?-1:0},kt=Math.sqrt;function Ts(e){return e>1?0:e<-1?ce:Math.acos(e)}function Ht(e){return e>1?Qe:e<-1?-Qe:Math.asin(e)}function Je(){}function ha(e,a){e&&Gn.hasOwnProperty(e.type)&&Gn[e.type](e,a)}var Yn={Feature:function(e,a){ha(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)ha(r[n].geometry,a)}},Gn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Ua(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Ua(r[n],a,0)},Polygon:function(e,a){Kn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Kn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)ha(r[n],a)}};function Ua(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Kn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Ua(e[r],a,1);a.polygonEnd()}function St(e,a){e&&Yn.hasOwnProperty(e.type)?Yn[e.type](e,a):ha(e,a)}function Ha(e){return[Ut(e[1],e[0]),Ht(e[2])]}function Tt(e){var a=e[0],r=e[1],n=Ce(r);return[n*Ce(a),n*ze(a),ze(r)]}function na(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function ga(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function La(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ra(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Va(e){var a=kt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Wa(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ya(e,a){return je(e)>ce&&(e-=Math.round(e/Xe)*Xe),[e,a]}Ya.invert=Ya;function Ls(e,a,r){return(e%=Xe)?a||r?Wa(Jn(e),Xn(a,r)):Jn(e):a||r?Xn(a,r):Ya}function Qn(e){return function(a,r){return a+=e,je(a)>ce&&(a-=Math.round(a/Xe)*Xe),[a,r]}}function Jn(e){var a=Qn(e);return a.invert=Qn(-e),a}function Xn(e,a){var r=Ce(e),n=ze(e),i=Ce(a),o=ze(a);function l(d,c){var f=Ce(c),s=Ce(d)*f,x=ze(d)*f,u=ze(c),h=u*r+s*n;return[Ut(x*i-h*o,s*r-u*n),Ht(h*i+x*o)]}return l.invert=function(d,c){var f=Ce(c),s=Ce(d)*f,x=ze(d)*f,u=ze(c),h=u*i-x*o;return[Ut(x*i+u*o,s*r+h*n),Ht(h*r-s*n)]},l}function qs(e,a,r,n,i,o){if(r){var l=Ce(a),d=ze(a),c=n*r;i==null?(i=a+n*Xe,o=a-c/2):(i=Zn(l,i),o=Zn(l,o),(n>0?i<o:i>o)&&(i+=n*Xe));for(var f,s=i;n>0?s>o:s<o;s-=c)f=Ha([l,-d*Ce(s),-d*ze(s)]),e.point(f[0],f[1])}}function Zn(e,a){a=Tt(a),a[0]-=e,Va(a);var r=Ts(-a[1]);return((-a[2]<0?-r:r)+Xe-ve)%Xe}function Dr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Je,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ca(e,a){return je(e[0]-a[0])<ve&&je(e[1]-a[1])<ve}function oa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Ir(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(p){if(!((b=p.length-1)<=0)){var b,v=p[0],g=p[b],S;if(ca(v,g)){if(!v[2]&&!g[2]){for(i.lineStart(),d=0;d<b;++d)i.point((v=p[d])[0],v[1]);i.lineEnd();return}g[0]+=2*ve}o.push(S=new oa(v,p,null,!0)),l.push(S.o=new oa(v,null,S,!1)),o.push(S=new oa(g,p,null,!1)),l.push(S.o=new oa(g,null,S,!0))}}),!!o.length){for(l.sort(a),er(o),er(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var f=o[0],s,x;;){for(var u=f,h=!0;u.v;)if((u=u.n)===f)return;s=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(h)for(d=0,c=s.length;d<c;++d)i.point((x=s[d])[0],x[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(h)for(s=u.p.z,d=s.length-1;d>=0;--d)i.point((x=s[d])[0],x[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,s=u.z,h=!h}while(!u.v);i.lineEnd()}}}function er(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function qa(e){return je(e[0])<=ce?e[0]:As(e[0])*((je(e[0])+ce)%Xe-ce)}function Ms(e,a){var r=qa(a),n=a[1],i=ze(n),o=[ze(r),-Ce(r),0],l=0,d=0,c=new vt;i===1?n=Qe+ve:i===-1&&(n=-Qe-ve);for(var f=0,s=e.length;f<s;++f)if(u=(x=e[f]).length)for(var x,u,h=x[u-1],p=qa(h),b=h[1]/2+Wn,v=ze(b),g=Ce(b),S=0;S<u;++S,p=y,v=q,g=L,h=z){var z=x[S],y=qa(z),T=z[1]/2+Wn,q=ze(T),L=Ce(T),A=y-p,C=A>=0?1:-1,N=C*A,M=N>ce,$=v*q;if(c.add(Ut($*C*ze(N),g*L+$*Ce(N))),l+=M?A+C*Xe:A,M^p>=r^y>=r){var O=ga(Tt(h),Tt(z));Va(O);var H=ga(o,O);Va(H);var w=(M^A>=0?-1:1)*Ht(H[2]);(n>w||n===w&&(O[0]||O[1]))&&(d+=M^A>=0?1:-1)}}return(l<-ve||l<ve&&c<-1e-12)^d&1}function Br(e,a,r,n){return function(i){var o=a(i),l=Dr(),d=a(l),c=!1,f,s,x,u={point:h,lineStart:b,lineEnd:v,polygonStart:function(){u.point=g,u.lineStart=S,u.lineEnd=z,s=[],f=[]},polygonEnd:function(){u.point=h,u.lineStart=b,u.lineEnd=v,s=Pr(s);var y=Ms(f,n);s.length?(c||(i.polygonStart(),c=!0),Ir(s,Fs,y,r,i)):y&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function h(y,T){e(y,T)&&i.point(y,T)}function p(y,T){o.point(y,T)}function b(){u.point=p,o.lineStart()}function v(){u.point=h,o.lineEnd()}function g(y,T){x.push([y,T]),d.point(y,T)}function S(){d.lineStart(),x=[]}function z(){g(x[0][0],x[0][1]),d.lineEnd();var y=d.clean(),T=l.result(),q,L=T.length,A,C,N;if(x.pop(),f.push(x),x=null,!!L){if(y&1){if(C=T[0],(A=C.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),q=0;q<A;++q)i.point((N=C[q])[0],N[1]);i.lineEnd()}return}L>1&&y&2&&T.push(T.pop().concat(T.shift())),s.push(T.filter(Rs))}}return u}}function Rs(e){return e.length>1}function Fs(e,a){return((e=e.x)[0]<0?e[1]-Qe-ve:Qe-e[1])-((a=a.x)[0]<0?a[1]-Qe-ve:Qe-a[1])}const tr=Br(function(){return!0},Os,Ds,[-ce,-Qe]);function Os(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?ce:-ce,c=je(o-a);je(c-ce)<ve?(e.point(a,r=(r+l)/2>0?Qe:-Qe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=ce&&(je(a-n)<ve&&(a-=n*ve),je(o-d)<ve&&(o-=d*ve),r=Ps(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ps(e,a,r,n){var i,o,l=ze(e-r);return je(l)>ve?zs((ze(a)*(o=Ce(n))*ze(r)-ze(n)*(i=Ce(a))*ze(e))/(i*o*l)):(a+n)/2}function Ds(e,a,r,n){var i;if(e==null)i=r*Qe,n.point(-ce,i),n.point(0,i),n.point(ce,i),n.point(ce,0),n.point(ce,-i),n.point(0,-i),n.point(-ce,-i),n.point(-ce,0),n.point(-ce,i);else if(je(e[0]-a[0])>ve){var o=e[0]<a[0]?ce:-ce;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Is(e){var a=Ce(e),r=2*Ue,n=a>0,i=je(a)>ve;function o(s,x,u,h){qs(h,e,r,u,s,x)}function l(s,x){return Ce(s)*Ce(x)>a}function d(s){var x,u,h,p,b;return{lineStart:function(){p=h=!1,b=1},point:function(v,g){var S=[v,g],z,y=l(v,g),T=n?y?0:f(v,g):y?f(v+(v<0?ce:-ce),g):0;if(!x&&(p=h=y)&&s.lineStart(),y!==h&&(z=c(x,S),(!z||ca(x,z)||ca(S,z))&&(S[2]=1)),y!==h)b=0,y?(s.lineStart(),z=c(S,x),s.point(z[0],z[1])):(z=c(x,S),s.point(z[0],z[1],2),s.lineEnd()),x=z;else if(i&&x&&n^y){var q;!(T&u)&&(q=c(S,x,!0))&&(b=0,n?(s.lineStart(),s.point(q[0][0],q[0][1]),s.point(q[1][0],q[1][1]),s.lineEnd()):(s.point(q[1][0],q[1][1]),s.lineEnd(),s.lineStart(),s.point(q[0][0],q[0][1],3)))}y&&(!x||!ca(x,S))&&s.point(S[0],S[1]),x=S,h=y,u=T},lineEnd:function(){h&&s.lineEnd(),x=null},clean:function(){return b|(p&&h)<<1}}}function c(s,x,u){var h=Tt(s),p=Tt(x),b=[1,0,0],v=ga(h,p),g=na(v,v),S=v[0],z=g-S*S;if(!z)return!u&&s;var y=a*g/z,T=-a*S/z,q=ga(b,v),L=ra(b,y),A=ra(v,T);La(L,A);var C=q,N=na(L,C),M=na(C,C),$=N*N-M*(na(L,L)-1);if(!($<0)){var O=kt($),H=ra(C,(-N-O)/M);if(La(H,L),H=Ha(H),!u)return H;var w=s[0],k=x[0],F=s[1],I=x[1],B;k<w&&(B=w,w=k,k=B);var W=k-w,G=je(W-ce)<ve,Q=G||W<ve;if(!G&&I<F&&(B=F,F=I,I=B),Q?G?F+I>0^H[1]<(je(H[0]-w)<ve?F:I):F<=H[1]&&H[1]<=I:W>ce^(w<=H[0]&&H[0]<=k)){var oe=ra(C,(-N+O)/M);return La(oe,L),[H,Ha(oe)]}}}function f(s,x){var u=n?e:ce-e,h=0;return s<-u?h|=1:s>u&&(h|=2),x<-u?h|=4:x>u&&(h|=8),h}return Br(l,d,o,n?[0,-e]:[-ce,e-ce])}function Bs(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],f=a[1],s=0,x=1,u=c-l,h=f-d,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<s)return;p<x&&(x=p)}else if(u>0){if(p>x)return;p>s&&(s=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>x)return;p>s&&(s=p)}else if(u>0){if(p<s)return;p<x&&(x=p)}if(p=n-d,!(!h&&p>0)){if(p/=h,h<0){if(p<s)return;p<x&&(x=p)}else if(h>0){if(p>x)return;p>s&&(s=p)}if(p=o-d,!(!h&&p<0)){if(p/=h,h<0){if(p>x)return;p>s&&(s=p)}else if(h>0){if(p<s)return;p<x&&(x=p)}return s>0&&(e[0]=l+s*u,e[1]=d+s*h),x<1&&(a[0]=l+x*u,a[1]=d+x*h),!0}}}}}var Pt=1e9,ia=-Pt;function $s(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,u){var h=0,p=0;if(f==null||(h=l(f,x))!==(p=l(s,x))||c(f,s)<0^x>0)do u.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+x+4)%4)!==p);else u.point(s[0],s[1])}function l(f,s){return je(f[0]-e)<ve?s>0?0:3:je(f[0]-r)<ve?s>0?2:1:je(f[1]-a)<ve?s>0?1:0:s>0?3:2}function d(f,s){return c(f.x,s.x)}function c(f,s){var x=l(f,1),u=l(s,1);return x!==u?x-u:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=Dr(),u,h,p,b,v,g,S,z,y,T,q,L={point:A,lineStart:$,lineEnd:O,polygonStart:N,polygonEnd:M};function A(w,k){i(w,k)&&s.point(w,k)}function C(){for(var w=0,k=0,F=h.length;k<F;++k)for(var I=h[k],B=1,W=I.length,G=I[0],Q,oe,ne=G[0],fe=G[1];B<W;++B)Q=ne,oe=fe,G=I[B],ne=G[0],fe=G[1],oe<=n?fe>n&&(ne-Q)*(n-oe)>(fe-oe)*(e-Q)&&++w:fe<=n&&(ne-Q)*(n-oe)<(fe-oe)*(e-Q)&&--w;return w}function N(){s=x,u=[],h=[],q=!0}function M(){var w=C(),k=q&&w,F=(u=Pr(u)).length;(k||F)&&(f.polygonStart(),k&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),F&&Ir(u,d,w,o,f),f.polygonEnd()),s=f,u=h=p=null}function $(){L.point=H,h&&h.push(p=[]),T=!0,y=!1,S=z=NaN}function O(){u&&(H(b,v),g&&y&&x.rejoin(),u.push(x.result())),L.point=A,y&&s.lineEnd()}function H(w,k){var F=i(w,k);if(h&&p.push([w,k]),T)b=w,v=k,g=F,T=!1,F&&(s.lineStart(),s.point(w,k));else if(F&&y)s.point(w,k);else{var I=[S=Math.max(ia,Math.min(Pt,S)),z=Math.max(ia,Math.min(Pt,z))],B=[w=Math.max(ia,Math.min(Pt,w)),k=Math.max(ia,Math.min(Pt,k))];Bs(I,B,e,a,r,n)?(y||(s.lineStart(),s.point(I[0],I[1])),s.point(B[0],B[1]),F||s.lineEnd(),q=!1):F&&(s.lineStart(),s.point(w,k),q=!1)}S=w,z=k,y=F}return L}}const Ga=e=>e;var Ma=new vt,Ka=new vt,$r,_r,Qa,Ja,lt={point:Je,lineStart:Je,lineEnd:Je,polygonStart:function(){lt.lineStart=_s,lt.lineEnd=Hs},polygonEnd:function(){lt.lineStart=lt.lineEnd=lt.point=Je,Ma.add(je(Ka)),Ka=new vt},result:function(){var e=Ma/2;return Ma=new vt,e}};function _s(){lt.point=Us}function Us(e,a){lt.point=Ur,$r=Qa=e,_r=Ja=a}function Ur(e,a){Ka.add(Ja*e-Qa*a),Qa=e,Ja=a}function Hs(){Ur($r,_r)}var Lt=1/0,ba=Lt,Vt=-Lt,va=Vt,ya={point:Vs,lineStart:Je,lineEnd:Je,polygonStart:Je,polygonEnd:Je,result:function(){var e=[[Lt,ba],[Vt,va]];return Vt=va=-(ba=Lt=1/0),e}};function Vs(e,a){e<Lt&&(Lt=e),e>Vt&&(Vt=e),a<ba&&(ba=a),a>va&&(va=a)}var Xa=0,Za=0,Dt=0,wa=0,ka=0,Ct=0,en=0,tn=0,It=0,Hr,Vr,nt,rt,Ke={point:yt,lineStart:ar,lineEnd:nr,polygonStart:function(){Ke.lineStart=Gs,Ke.lineEnd=Ks},polygonEnd:function(){Ke.point=yt,Ke.lineStart=ar,Ke.lineEnd=nr},result:function(){var e=It?[en/It,tn/It]:Ct?[wa/Ct,ka/Ct]:Dt?[Xa/Dt,Za/Dt]:[NaN,NaN];return Xa=Za=Dt=wa=ka=Ct=en=tn=It=0,e}};function yt(e,a){Xa+=e,Za+=a,++Dt}function ar(){Ke.point=Ws}function Ws(e,a){Ke.point=Ys,yt(nt=e,rt=a)}function Ys(e,a){var r=e-nt,n=a-rt,i=kt(r*r+n*n);wa+=i*(nt+e)/2,ka+=i*(rt+a)/2,Ct+=i,yt(nt=e,rt=a)}function nr(){Ke.point=yt}function Gs(){Ke.point=Qs}function Ks(){Wr(Hr,Vr)}function Qs(e,a){Ke.point=Wr,yt(Hr=nt=e,Vr=rt=a)}function Wr(e,a){var r=e-nt,n=a-rt,i=kt(r*r+n*n);wa+=i*(nt+e)/2,ka+=i*(rt+a)/2,Ct+=i,i=rt*e-nt*a,en+=i*(nt+e),tn+=i*(rt+a),It+=i*3,yt(nt=e,rt=a)}function Yr(e){this._context=e}Yr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Xe);break}}},result:Je};var an=new vt,Ra,Gr,Kr,Bt,$t,Wt={point:Je,lineStart:function(){Wt.point=Js},lineEnd:function(){Ra&&Qr(Gr,Kr),Wt.point=Je},polygonStart:function(){Ra=!0},polygonEnd:function(){Ra=null},result:function(){var e=+an;return an=new vt,e}};function Js(e,a){Wt.point=Qr,Gr=Bt=e,Kr=$t=a}function Qr(e,a){Bt-=e,$t-=a,an.add(kt(Bt*Bt+$t*$t)),Bt=e,$t=a}let rr,ja,or,ir;class sr{constructor(a){this._append=a==null?Jr:Xs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==or||this._append!==ja){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,or=n,ja=this._append,ir=this._,this._=i}this._+=ir;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Jr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Xs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Jr;if(a!==rr){const r=10**a;rr=a,ja=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ja}function Zs(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),St(d,i(o))),o.result()}return l.area=function(d){return St(d,i(lt)),lt.result()},l.measure=function(d){return St(d,i(Wt)),Wt.result()},l.bounds=function(d){return St(d,i(ya)),ya.result()},l.centroid=function(d){return St(d,i(Ke)),Ke.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,Ga):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new sr(r)):new Yr(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new sr(r)),l},l.projection(e).digits(r).context(a)}function fn(e){return function(a){var r=new nn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function nn(){}nn.prototype={constructor:nn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function xn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),St(r,e.stream(ya)),a(ya.result()),n!=null&&e.clipExtent(n),e}function Xr(e,a,r){return xn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function el(e,a,r){return Xr(e,[[0,0],a],r)}function tl(e,a,r){return xn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function al(e,a,r){return xn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var lr=16,nl=Ce(30*Ue);function dr(e,a){return+a?ol(e,a):rl(e)}function rl(e){return fn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ol(e,a){function r(n,i,o,l,d,c,f,s,x,u,h,p,b,v){var g=f-n,S=s-i,z=g*g+S*S;if(z>4*a&&b--){var y=l+u,T=d+h,q=c+p,L=kt(y*y+T*T+q*q),A=Ht(q/=L),C=je(je(q)-1)<ve||je(o-x)<ve?(o+x)/2:Ut(T,y),N=e(C,A),M=N[0],$=N[1],O=M-n,H=$-i,w=S*O-g*H;(w*w/z>a||je((g*O+S*H)/z-.5)>.3||l*u+d*h+c*p<nl)&&(r(n,i,o,l,d,c,M,$,C,y/=L,T/=L,q,b,v),v.point(M,$),r(M,$,C,y,T,q,f,s,x,u,h,p,b,v))}}return function(n){var i,o,l,d,c,f,s,x,u,h,p,b,v={point:g,lineStart:S,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=T},polygonEnd:function(){n.polygonEnd(),v.lineStart=S}};function g(A,C){A=e(A,C),n.point(A[0],A[1])}function S(){x=NaN,v.point=z,n.lineStart()}function z(A,C){var N=Tt([A,C]),M=e(A,C);r(x,u,s,h,p,b,x=M[0],u=M[1],s=A,h=N[0],p=N[1],b=N[2],lr,n),n.point(x,u)}function y(){v.point=g,n.lineEnd()}function T(){S(),v.point=q,v.lineEnd=L}function q(A,C){z(i=A,C),o=x,l=u,d=h,c=p,f=b,v.point=z}function L(){r(x,u,s,h,p,b,o,l,i,d,c,f,lr,n),v.lineEnd=y,y()}return v}}var il=fn({point:function(e,a){this.stream.point(e*Ue,a*Ue)}});function sl(e){return fn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ll(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function cr(e,a,r,n,i,o){if(!o)return ll(e,a,r,n,i);var l=Ce(o),d=ze(o),c=l*e,f=d*e,s=l/e,x=d/e,u=(d*r-l*a)/e,h=(d*a+l*r)/e;function p(b,v){return b*=n,v*=i,[c*b-f*v+a,r-f*b-c*v]}return p.invert=function(b,v){return[n*(s*b-x*v+u),i*(h-x*b-s*v)]},p}function dl(e){return cl(function(){return e})()}function cl(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,f=0,s,x=0,u=1,h=1,p=null,b=tr,v=null,g,S,z,y=Ga,T=.5,q,L,A,C,N;function M(w){return A(w[0]*Ue,w[1]*Ue)}function $(w){return w=A.invert(w[0],w[1]),w&&[w[0]*st,w[1]*st]}M.stream=function(w){return C&&N===w?C:C=il(sl(s)(b(q(y(N=w)))))},M.preclip=function(w){return arguments.length?(b=w,p=void 0,H()):b},M.postclip=function(w){return arguments.length?(y=w,v=g=S=z=null,H()):y},M.clipAngle=function(w){return arguments.length?(b=+w?Is(p=w*Ue):(p=null,tr),H()):p*st},M.clipExtent=function(w){return arguments.length?(y=w==null?(v=g=S=z=null,Ga):$s(v=+w[0][0],g=+w[0][1],S=+w[1][0],z=+w[1][1]),H()):v==null?null:[[v,g],[S,z]]},M.scale=function(w){return arguments.length?(r=+w,O()):r},M.translate=function(w){return arguments.length?(n=+w[0],i=+w[1],O()):[n,i]},M.center=function(w){return arguments.length?(o=w[0]%360*Ue,l=w[1]%360*Ue,O()):[o*st,l*st]},M.rotate=function(w){return arguments.length?(d=w[0]%360*Ue,c=w[1]%360*Ue,f=w.length>2?w[2]%360*Ue:0,O()):[d*st,c*st,f*st]},M.angle=function(w){return arguments.length?(x=w%360*Ue,O()):x*st},M.reflectX=function(w){return arguments.length?(u=w?-1:1,O()):u<0},M.reflectY=function(w){return arguments.length?(h=w?-1:1,O()):h<0},M.precision=function(w){return arguments.length?(q=dr(L,T=w*w),H()):kt(T)},M.fitExtent=function(w,k){return Xr(M,w,k)},M.fitSize=function(w,k){return el(M,w,k)},M.fitWidth=function(w,k){return tl(M,w,k)},M.fitHeight=function(w,k){return al(M,w,k)};function O(){var w=cr(r,0,0,u,h,x).apply(null,a(o,l)),k=cr(r,n-w[0],i-w[1],u,h,x);return s=Ls(d,c,f),L=Wa(a,k),A=Wa(s,L),q=dr(L,T),H()}function H(){return C=N=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&$,O()}}function Zr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Zr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(je(i)>ve&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function pl(){return dl(Zr).scale(175.295)}function ul(e){return e}function ml(e){if(e==null)return ul;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var f=2,s=d.length,x=new Array(s);for(x[0]=(a+=d[0])*n+o,x[1]=(r+=d[1])*i+l;f<s;)x[f]=d[f],++f;return x}}function fl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function xl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return pr(e,r)})}:pr(e,a)}function pr(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=hl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function hl(e,a){var r=ml(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var u=n[s<0?~s:s],h=0,p=u.length;h<p;++h)x.push(r(u[h],h));s<0&&fl(x,p)}function o(s){return r(s)}function l(s){for(var x=[],u=0,h=s.length;u<h;++u)i(s[u],x);return x.length<2&&x.push(x[0]),x}function d(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function c(s){return s.map(d)}function f(s){var x=s.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":u=o(s.coordinates);break;case"MultiPoint":u=s.coordinates.map(o);break;case"LineString":u=l(s.arcs);break;case"MultiLineString":u=s.arcs.map(l);break;case"Polygon":u=c(s.arcs);break;case"MultiPolygon":u=s.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return f(a)}const eo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},gl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function bl(e,a,r){const n=eo[e];if(!n||!n.length)return-1;const i=gl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let sa=null;function vl(){return sa||(sa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=xl(r,n),o=pl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Zs(o),d=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var h;const x=((h=s.properties)==null?void 0:h.name)||"",u=l(s)||"";return u?{i2:Wo(x)||null,n:x,d:u}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,x]of Object.entries(Yo)){const u=o(x);u&&(c[s]={x:u[0],y:u[1]})}const f={};for(const[s,x]of Object.entries(eo)){const u=x.map(h=>o(h.ll)).filter(h=>!!h).map(([h,p])=>({x:h,y:p}));u.length&&(f[s]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:d,anchors:c,metros:f}}catch{return null}})(),sa)}function yl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return vl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const wl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},ur=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function mr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function kl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const c=(f=e.current)==null?void 0:f.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function fr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function jl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:f,dossiers:s,source:x}=_(),u=f.loading&&!s.length,h=m.useRef(null),p=m.useRef(null),b=yl(e.continent==="monde"),v=e.continent==="monde"?b:dn.find(w=>w.key===e.continent)||null,g=kl(h,e.continent+":"+e.mapFolded+":"+!!v),[S,z]=m.useState(new Map),[y,T]=m.useState(null);m.useEffect(()=>{const w=h.current;if(!w)return;const k=new Map;w.querySelectorAll("path[data-i2]").forEach(F=>{const I=F.dataset.i2;if(I)try{const B=F.getBBox();B.width>0&&k.set(I,{x:B.x,y:B.y,w:B.width,h:B.height})}catch{}}),z(k)},[e.continent,g,v]);const q=m.useMemo(()=>r.filter(w=>w.cc),[r]),L=m.useMemo(()=>{const w=new Map;return q.forEach(k=>w.set(k.cc,(w.get(k.cc)||0)+1)),w},[q]),A=e.continent==="monde"&&b?b.anchors:null,C=e.continent==="monde"&&b?b.metros:null,N=m.useMemo(()=>q.map(w=>{const k=mr(w.name||w.id||""),F=mr((w.id||w.name||"")+"·y");if(A&&w.cc){const Q=C?C[w.cc]:void 0;if(Q&&Q.length){const ne=bl(w.cc,w.city,k);if(ne>=0&&Q[ne])return{d:w,x:Q[ne].x+(k-.5)*5,y:Q[ne].y+(F-.5)*5}}const oe=A[w.cc];if(oe)return{d:w,x:oe.x+(k-.5)*10,y:oe.y+(F-.5)*10}}const I=w.cc?S.get(w.cc):void 0;if(!I)return null;const B=wl[`${e.continent}:${w.cc||""}`];if(B)return{d:w,x:I.x+I.w*(B.fx+(k-.5)*B.sx),y:I.y+I.h*(B.fy+(F-.5)*B.sy)};const W=(k-.5)*Math.min(I.w*.55,60),G=(F-.5)*Math.min(I.h*.55,60);return{d:w,x:I.x+I.w/2+W,y:I.y+I.h/2+G}}).filter(w=>!!w),[q,S,A,C,e.continent]),M=w=>g>0?w/g:w,$=m.useMemo(()=>n?[0,1,2,3,4,5].map(w=>({c:ur[w],fr:c.plabels[w].toUpperCase(),en:c.plabels[w].toUpperCase(),n:r.filter(k=>k.kind==="target"&&Ae(k)===w).length})).filter(w=>w.n>0):Ln.map((w,k)=>({...w,n:r.filter(F=>qn(F)===k).length})),[r,n,c.plabels]),O=o?l.get(o):null,H=O?N.find(w=>w.d.id===O.id):null;return v?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(fr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:h,viewBox:v.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?v.fr:v.en,onMouseLeave:()=>{T(null),i(null)},children:[t.jsx("g",{children:v.countries.map((w,k)=>t.jsx("g",{className:"ct"+(w.i2&&L.get(w.i2)?"":" empty"),children:t.jsx("path",{d:w.d,"data-i2":w.i2||void 0})},k))}),t.jsx("g",{children:N.map(w=>{const k=Ln[qn(w.d)],F=!!qe(w.d),I=w.d.kind==="target",B=n&&I?ur[Ae(w.d)]:k.c,W=!n&&$e(w.d);return t.jsxs("g",{className:"co"+(W?" done":""),onMouseEnter:()=>{var oe,ne;const G=(oe=p.current)==null?void 0:oe.getBoundingClientRect(),Q=(ne=h.current)==null?void 0:ne.createSVGPoint();if(Q&&h.current&&G){Q.x=w.x,Q.y=w.y;const fe=Q.matrixTransform(h.current.getScreenCTM());T({x:fe.x-G.left,y:fe.y-G.top,label:w.d.name+" · "+(Rt(w.d.cc,d)||w.d.countryLabel||"")})}i(w.d.id)},onMouseLeave:()=>{T(null),i(null)},onClick:()=>{var oe;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:w.d.id}),(w.d.noCo||["media","nominations","recrutements"].includes(w.d.engine||""))&&(w.d.url||w.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:w.d.url||"",text:[w.d.headline,w.d.tagline].filter(Boolean).join(`
`)}})):w.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:w.d.name}}));return}const G=(oe=h.current)==null?void 0:oe.createSVGPoint();let Q=null;if(G&&h.current){G.x=w.x,G.y=w.y;const ne=G.matrixTransform(h.current.getScreenCTM());Q={x:ne.x,y:ne.y}}a({type:"popup",id:w.d.id,anchor:Q})},children:[t.jsx("circle",{className:"h",cx:w.x,cy:w.y,r:M(Math.max(11,k.px+7))}),t.jsx("circle",{className:"v",cx:w.x,cy:w.y,r:M(k.px),fill:B,stroke:F?"#DC2626":"#ffffff",strokeWidth:M(F?2.2:1.3)})]},w.d.id||w.d.name)})}),H&&t.jsx("circle",{className:"ring on",cx:H.x,cy:H.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:$.map((w,k)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":w.c}}),d==="fr"?w.fr:w.en," ",t.jsx("b",{children:w.n})]},k))}),r.some(w=>!w.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(w=>!w.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(fr,{msgs:c.loadMsgs})})}function Nl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function to({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=_(),c=a.filters,[f,s]=m.useState(!1),x=m.useRef(null),u=m.useMemo(()=>a.continent==="monde"?n:n.filter(A=>A.continent===a.continent),[n,a.continent]),h=A=>u.filter(C=>A!=="country"&&c.country.length&&!c.country.includes(C.cc||"")?!1:fa(C,c,o,A==="country"?void 0:A)),p=m.useMemo(()=>{const A=h("win"),C=N=>A.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=N).length;return[C(0),C(7),C(30),A.length]},[u,c,o]),b=m.useMemo(()=>c.day?h("win").filter(A=>(A.date||"").slice(0,10)===c.day).length:0,[u,c,o]),v=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,g=v+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f)return;const A=N=>{var M;(M=x.current)!=null&&M.contains(N.target)||s(!1)},C=N=>{N.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",A),document.addEventListener("keydown",C),()=>{document.removeEventListener("mousedown",A),document.removeEventListener("keydown",C)}},[f]);const S=(A,C,N,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===A,onClick:()=>r({type:"openFacet",facet:A}),children:[t.jsx("span",{className:"fl",children:C}),N>0&&t.jsx("span",{className:"n",children:N}),t.jsx("span",{className:"cv",children:"▾"})]},A),z=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(Nl(c.day,d))}),t.jsx("b",{children:b})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((A,C)=>t.jsxs("button",{type:"button","aria-pressed":c.win===A,onClick:()=>r({type:"filters",patch:{win:A}}),children:[t.jsx("span",{className:"sl",children:i.dates[C]}),t.jsx("b",{children:p[C]})]},A))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:A=>r({type:"filters",patch:{search:A.target.value}})})]}),T=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):S("sec",i.fSector,c.sector.length),S("pay",i.fCountry,c.country.length),S("det",i.fEngine,c.engine.length),S("sta",i.fStage,c.stage.length),o&&S("ang","Angle",c.angle.length),o&&S("mem","Mémo",c.memoLevel.length)]}),q=(A=!1)=>t.jsxs("div",{className:"frow2",children:[g>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(g)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),A&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:x,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(A=>!A),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:T})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[!c.day&&t.jsx("div",{className:"fstrip-a",children:z}),t.jsxs("div",{className:"fstrip-b",children:[y,L,q(a.mapFolded)]})]}),a.openFacet&&t.jsx(xr,{poolFor:h})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[z,y,T,t.jsx("span",{className:"fgrow"}),q()]}),a.openFacet&&t.jsx(xr,{poolFor:h})]})}function xr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=_(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:f}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(g=>qe(g)),b=new Map;p.forEach(g=>{const S=g.engine||"";b.set(S,(b.get(S)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Da([...b.keys()],i).map(g=>({v:g,label:bt(g)+" "+He(g,i),n:b.get(g)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(g)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),b=new Map;return p.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:v,n:g,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),b=new Map;return p.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:Rt(v,i)||v,n:g,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),b=new Map;return p.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Da([...b.keys()],i).map(v=>({v,label:bt(v)+" "+He(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Go(Ko(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),b=new Map;return p.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:v.replace(/[_-]+/g," "),n:g,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),b=new Map;p.forEach(g=>{if(g.kind==="target"){const S=sn(g);b.set(S,(b.get(S)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(g=>({v:String(g),label:v[g],n:b.get(g)||0,html:!1,on:o.memoLevel.includes(g)}))}}const u=e("stage"),h=new Map;return u.forEach(p=>{p.stage&&h.set(p.stage,(h.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((p,b)=>b[1]-p[1]).map(([p,b])=>({v:p,label:p,n:b,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),s=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>s(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function ao({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=_(),c=m.useMemo(()=>{const h={};return r.forEach(p=>{fa(p,n.filters,o)&&(h.monde=(h.monde||0)+1,p.continent&&(h[p.continent]=(h[p.continent]||0)+1))}),h},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const h=b=>{var v;(v=x.current)!=null&&v.contains(b.target)||s(!1)},p=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",h),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",h),document.removeEventListener("keydown",p)}},[f]);const u=h=>{const p=dn.find(b=>b.key===h);return h==="monde"?d.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(h=>!h),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Mn.map(h=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===h,onClick:()=>{i({type:"continent",key:h}),s(!1)},children:[u(h),t.jsx("span",{className:"n",children:c[h]||0})]},h))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Mn.map(h=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===h,onClick:()=>i({type:"continent",key:h}),children:[u(h),t.jsx("span",{className:"n",children:c[h]||0})]},h)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function no(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function El(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function hr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=_();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function ro({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=_(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(hr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(hr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Sl({card:e,onEvaluate:a,onAddAll:r}){var d,c,f;const{t:n}=_(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:no(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(ro,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Cl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function zl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=_(),d=i,[c,f]=m.useState(null),[s,x]=m.useState(null),[u,h]=m.useState(null),[p,b]=m.useState(!1);m.useEffect(()=>{let g=!0;return(async()=>{const S=await Sr({email:l,cbToken:d});g&&f(S)})(),()=>{g=!1}},[l,d,n]);const v=g=>{x(g),h(null),b(!0),(async()=>{const S=await Qo(g.id);h(S),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),h(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(g=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(g),children:[t.jsx("span",{className:"ti",children:g.title}),t.jsxs("span",{className:"me",children:[Cl(g.created_at),g.industry?` · ${g.industry}`:"",g.author?` · ${g.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(g.cited_n||0,g.evaluate_n||0)}),t.jsx("span",{className:"st"+(g.published?" on":""),children:g.published?o.rsPub:o.rsPriv})]},g.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(Sl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Fa=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function gr(e){return/^https?:\/\//i.test((e||"").trim())}function Al(e){const a=(e||"").trim(),r=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/i.exec(a);return r?`https://www.youtube.com/embed/${r[1]}?rel=0`:a}function Tl(e){try{return new URL(e).hostname.replace(/^www\./,"")}catch{return e}}function Ll(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:f,data:s,canWrite:x,source:u,dossiers:h,doAnalyse:p,liveMemos:b,pipe:v}=_(),g=a==="client",S=m.useMemo(()=>r||(u!=="default"?Jo():""),[r,u]),[z,y]=m.useState(""),[T,q]=m.useState(!1),[L,A]=m.useState(""),[C,N]=m.useState(!1),[M,$]=m.useState(""),[O,H]=m.useState(!1),[w,k]=m.useState(""),[F,I]=m.useState([]),B=m.useRef(!1),[W,G]=m.useState(!1),[Q,oe]=m.useState(""),[ne,fe]=m.useState(""),[ye,re]=m.useState(!1),[ee,xe]=m.useState(""),[pe,K]=m.useState(!1),[Z,J]=m.useState(0),[te,he]=m.useState(""),[Y,ue]=m.useState(null),[se,ge]=m.useState(null),[Ie,Ve]=m.useState(!1),[Se,Fe]=m.useState(null),[Ze,ot]=m.useState(0),ct=m.useRef(!1),jt=z.trim()?Fa.test(z.trim())?e.evalUrl:e.evalName:e.evalWaiting,Me=m.useMemo(()=>M.split(`
`).map(R=>R.trim()).filter(Boolean).slice(0,15),[M]);m.useEffect(()=>{if(typeof window>"u")return;const R=new URLSearchParams(window.location.search),ae=(R.get("rs")||"").trim(),le=(R.get("rstext")||"").trim();ae&&/^https?:\/\//i.test(ae)&&oe(ae),le&&fe(le),(ae&&/^https?:\/\//i.test(ae)||le)&&G(!0)},[]),m.useEffect(()=>{const R=ae=>{const le=ae.detail||{},me=String(le.url||"").trim(),We=String(le.text||"").trim();me&&/^https?:\/\//i.test(me)&&oe(me),We&&fe(We),(me&&/^https?:\/\//i.test(me)||We)&&(G(!0),y(""),A(""),re(!0),window.setTimeout(()=>re(!1),900))};return window.addEventListener("ppmap:research",R),()=>window.removeEventListener("ppmap:research",R)},[]),m.useEffect(()=>{const R=ae=>{const le=ae.detail||{},me=String(le.name||"").trim();me&&(G(!1),y(me),A(me),q(!0),window.setTimeout(()=>q(!1),900))};return window.addEventListener("ppmap:prefill",R),()=>window.removeEventListener("ppmap:prefill",R)},[]),m.useEffect(()=>{const R=ae=>{var me;const le=String(((me=ae.detail)==null?void 0:me.url)||"").trim();gr(le)&&xe(le)};return window.addEventListener("ppmap:view",R),()=>window.removeEventListener("ppmap:view",R)},[]),m.useEffect(()=>{if(!ee)return;const R=ae=>{ae.key==="Escape"&&xe("")};return document.addEventListener("keydown",R),()=>document.removeEventListener("keydown",R)},[ee]),m.useEffect(()=>{if(typeof window>"u"||u!=="ops")return;const R=document.querySelector(".atl2.ops .eval-stick")||document.querySelector(".atl2.ops .demand"),ae=document.querySelector(".atl2.ops");if(!R||!ae)return;const le=()=>ae.style.setProperty("--demand-h",`${R.offsetHeight}px`);le();const me=new ResizeObserver(le);return me.observe(R),()=>me.disconnect()},[u,T,ye,C,W]),m.useEffect(()=>{if(!x&&!S){Fe(null);return}let R=!0;return(async()=>{const ae=await Sr({email:n,cbToken:S});R&&Fe(ae.length)})(),()=>{R=!1}},[x,S,n,Ze]);const it=F.length?F:c,Oe=s.credits,E=m.useCallback(R=>{const ae=R.map(le=>(le||"").trim()).filter(Boolean);ae.length&&($(le=>{const me=le.split(`
`).map(Ee=>Ee.trim()).filter(Boolean),We=new Set(me.map(Ee=>Ee.toLowerCase())),Be=ae.filter(Ee=>!We.has(Ee.toLowerCase()));return[...me,...Be].slice(0,15).join(`
`)}),N(!0))},[]);m.useEffect(()=>{if(!pe)return;J(0);const R=window.setInterval(()=>J(ae=>ae+1),1e3);return()=>window.clearInterval(R)},[pe]);const D=m.useMemo(()=>{const R=z.trim().toLowerCase();return!R||!v?null:h.find(ae=>Ge(ae.name)===R&&Ae(ae)===1)||null},[z,h,v]),V=()=>{const R=z.trim();if(R){if(D){p(D);return}i(null,R),g&&y("")}},ie=async()=>{if(!g){i(null,Me[0]||"");return}if(!Me.length||O)return;H(!0),B.current=!1;const R=[];for(let ae=0;ae<Me.length&&!B.current;ae++){k(e.evaluating(ae+1,Me.length,Me[ae]));const le=await Cr(r,Me[ae],"atelier2");if(R.unshift({name:le.company||Me[ae],verdict:le.verdict,reason:le.reason||"",remaining:le.remaining??null}),I([...R]),le.verdict==="quota"){R.unshift({name:"",verdict:"quota",reason:e.quota(Me.length-ae-1),remaining:0}),I([...R]),$(Me.slice(ae+1).join(`
`)),k(""),H(!1);return}}k(""),$(B.current?Me.slice(R.length).join(`
`):""),H(!1)},Ne=async()=>{var le,me,We;if(ct.current)return;const R=Q.trim().replace(/\s+/g,""),ae=ne.trim();if(!R&&!ae){he(e.rsNeed);return}if(!g&&!S){i(null,R||ae.slice(0,80));return}ct.current=!0,he(""),ue(null),ge(null),K(!0);try{const Be=await Zo({url:R,text:ae,email:n,cbToken:S});if(K(!1),!Be||Be.status!=="success"){he((Be==null?void 0:Be.message)||"Erreur");return}ue(Be),G(!1),E((((le=Be.prospective)==null?void 0:le.companies_to_evaluate)||[]).map(Ye=>(Ye==null?void 0:Ye.name)||"")),ge({state:"pending"});const Ee=await ei(Be,{email:n,cbToken:S});ge(Ee.ok?{state:"ok",scopeLabel:((me=Ee.summary)==null?void 0:me.scope_label)||"",scope:((We=Ee.summary)==null?void 0:We.scope)||""}:{state:"fail",msg:Ee.error||""}),Ee.ok&&ot(Ye=>Ye+1)}finally{ct.current=!1,K(!1)}},be=[Y==null?void 0:Y.industry,...(Y==null?void 0:Y.market_tags)||[],Y==null?void 0:Y.author].map(R=>(R||"").trim()).filter(Boolean),Re=(se==null?void 0:se.state)==="pending",et=se&&(Re?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):se.state==="ok"?t.jsx("span",{className:"rslink ok",children:se.scope&&se.scope!=="public"?e.rsSavedIn(se.scopeLabel||se.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:se.msg,children:e.rsSaveFail})),ft=El(Y).length,Te=W,pt=(L||z).trim(),Nt=D?e.actAnalyse:pt?e.evalGoOn(pt.length>22?pt.slice(0,21)+"…":pt):e.evalGo,Et=pe?`${Xo(Q.trim())==="youtube"&&Q.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Z)}`:Re?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Te?" rs-mode":"")+(L&&z.trim()===L||T||ye?" pair":"")+(T||ye?" echo":""),children:[t.jsxs("div",{className:"drow"+((Te?ye:T)?" flash":"")+((Te?Q.trim():Fa.test(z.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Te?Q:z,placeholder:Te?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Te?600:200,spellCheck:Te?!1:void 0,inputMode:Te?"url":void 0,onChange:R=>{if(Te){oe(R.target.value);return}y(R.target.value),L&&R.target.value.trim()!==L&&A("")},onKeyDown:R=>{R.key==="Enter"&&(Te?Ne():V())}}),!Te&&t.jsx("span",{className:"detect"+(Fa.test(z.trim())?" url":""),children:jt})]}),Te?t.jsxs(t.Fragment,{children:[t.jsx("button",{type:"button",className:"viewbtn"+(ee?" on":""),disabled:!gr(Q),title:ee?e.viewLinkClose:e.viewLink,onClick:()=>xe(ee?"":Q.trim()),children:ee?e.viewLinkClose:e.viewLink}),t.jsxs("button",{type:"button",className:"evalbtn"+(pe?" loading":""),disabled:pe||Re||!Q.trim()&&!ne.trim(),onClick:()=>{Ne()},children:[t.jsx("span",{className:"fill"}),Et]})]}):t.jsxs("button",{type:"button",className:"evalbtn"+(D?" analyse":"")+(d?" loading":""),disabled:d,onClick:V,children:[t.jsx("span",{className:"fill"}),Nt]}),f.showCredits&&Oe&&t.jsxs("button",{type:"button",className:"credits"+(Oe.total_available<=0&&!Oe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Oe.unlimited?"∞":Oe.total_available}),!Oe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Oe.daily_grant+Oe.purchased]}),Oe.total_available<=0&&!Oe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(R=>R.status==="boot"||R.status==="running").map(R=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:R.name}),t.jsx(_t,{item:R,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+R.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>N(!C),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(W?" on":""),onClick:()=>G(!W),children:e.rsOpen}),Se!==null&&Se>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Ie?" on":""),onClick:()=>Ve(!Ie),children:e.rsArchOpen(Se)})]}),Ie&&t.jsx(zl,{bump:Ze,cbToken:S,onClose:()=>Ve(!1),onEvaluate:R=>i(null,R),onAddAll:E}),W&&t.jsxs("div",{className:"rsp on slim",children:[t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:ne,placeholder:e.rsTextPh,onChange:R=>fe(R.target.value)})]}),te&&t.jsx("div",{className:"rserr",children:te}),Y&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Y.title}),Y.source_url&&t.jsx("a",{href:Y.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ue(null),ge(null)},children:"×"})]}),Y.market&&t.jsx("p",{className:"rsmk",children:Y.market}),be.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),be.map(R=>t.jsx("span",{children:R},R))]}),t.jsxs("div",{className:"rsbody",children:[Y.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Y.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:no(Y.summary_md||"").map((R,ae)=>t.jsx("p",{children:R},ae))})]}),t.jsx(ro,{card:Y,onEvaluate:R=>i(null,R),onAddAll:E}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(ft)}),et]})]}),C&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:M,placeholder:e.bulkPh,onChange:R=>$(R.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(O?" loading":""),style:{justifyContent:"center"},disabled:O||!Me.length,onClick:()=>{ie()},children:[t.jsx("span",{className:"fill"}),O&&w?w:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(Me.length)})]})]}),it.slice(0,1).map((R,ae)=>{const le=R.verdict==="kept",me=R.verdict==="quota",We=le?"var(--brand)":me?"var(--bolt)":"var(--red)",Be=le?"var(--brand-l)":me?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":We,"--bgc":Be},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:le?"✓ "+e.kept:me?"⏳":"✗ "+e.dropped})}),R.name&&t.jsx("span",{className:"rn",children:R.name}),t.jsx("span",{className:"rr",children:R.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",R.reason]}):null}),!!(R.candidates&&R.candidates.length)&&t.jsx("span",{className:"sitepick",children:R.candidates.map(Ee=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ee.url.startsWith("http")?Ee.url:`https://${Ee.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ee.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Ee.url),children:e.evalPickGo})]},Ee.url))}),!me&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:le?1:5});const Ee=(R.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ye=[...document.querySelectorAll(".atl2 .list .row")].find(Qt=>{var Jt;return(((Jt=Qt.querySelector(".rnm"))==null?void 0:Jt.textContent)||"").trim().toLowerCase().includes(Ee)});Ye&&(Ye.scrollIntoView({behavior:"smooth",block:"center"}),Ye.classList.add("flashrow"),window.setTimeout(()=>Ye.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(le?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),g&&(o.kept+o.dropped>0||it.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]}),ee&&t.jsxs("div",{className:"artview",role:"dialog","aria-label":e.viewLink,children:[t.jsxs("div",{className:"artview-bar",children:[t.jsx("b",{children:Tl(ee)}),t.jsx("span",{className:"artview-hint",children:e.viewLinkHint}),t.jsxs("a",{href:ee,target:"_blank",rel:"noopener noreferrer",children:[e.viewLinkTab," ↗"]}),t.jsx("button",{type:"button",className:"artview-x",onClick:()=>xe(""),"aria-label":e.viewLinkClose,children:"×"})]}),t.jsx("iframe",{src:Al(ee),title:e.viewLink,sandbox:"allow-scripts allow-same-origin allow-popups allow-forms allow-presentation",referrerPolicy:"no-referrer-when-downgrade"})]})]})}function ql(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ml(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=_(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",ql(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const d=mt(o),c=sn(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((f,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[At(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function hn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=_(),[l,d]=m.useState(!1),[c,f]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,x=async()=>{if(!s||l)return;d(!0);const u=await ti(r,e);if(d(!1),!u){o(a.actErr);return}f(u.results||[])};return m.useEffect(()=>{if(!s)return;const u=h=>{var b;const p=String(((b=h.detail)==null?void 0:b.name)||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,s]),m.useEffect(()=>{if(s)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Rl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),la=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Fl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=la(a.slice(n));break}r+=la(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=la(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Rl.has(c)?r+=`<${d[1]}${c}>`:r+=la(a.slice(i,o+1)),n=o+1}return r}const br=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function De({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ol(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Pl({o:e}){const{t:a,doDeep:r}=_(),[n,i]=m.useState(!1),o=mt(e),l=[e.reasoning||"",Ol(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[At(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function gn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=_(),o=Gt(e),l=mt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||At(e)?1:0}].filter(b=>b.n>0),[e,a,d,l,c,f,s]),[u,h]=m.useState("");if(!x.length)return null;const p=x.some(b=>b.k===u)?u:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===b.k,"data-tour":"tab-"+b.k,className:p===b.k?"on":"",onClick:v=>{v.stopPropagation(),h(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(De,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(De,{k:a.cdVerdictDate,v:br(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Fl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Dl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdSector,v:e.sector}),t.jsx(De,{k:a.cdStage,v:e.stage}),t.jsx(De,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(De,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(De,{k:a.cdAngle,v:e.angle}),t.jsx(De,{k:a.cdDetected,v:br(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdName,v:e.contactName}),t.jsx(De,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(Pl,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(De,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Dl({o:e}){const{t:a,token:r}=_(),[n,i]=m.useState(!1),[o,l]=m.useState(null),d=async()=>{n||(i(!0),l(await ai(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=f.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[f.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Kt({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const d=()=>{const f=Math.max(280,Math.min(560,o.clientWidth||320));Rn({kind:"op",card:e},f).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Rn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const d=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&Mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Il=`
...
`;function Bl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let d=e.y+10;return d+n>o-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function $l(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:f,doPromote:s,doRepeche:x,doApproach:u,doDeep:h,doOnboard:p,outbound:b,evalBusy:v}=_(),g=e.popupId?r.get(e.popupId):null;if(!g)return null;const S=qe(g),z=Ae(g),y=mt(g),T=Gt(g),q=g.kind==="target",L=A=>{a({type:"filters",patch:A}),a({type:"popup",id:null})};return Mt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Il}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Bl(e.popupAnchor,!!g.card),onClick:A=>A.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:g.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(dt(g.date)),He(g.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[g.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>L({country:[g.cc]}),children:(Rt(g.cc,i)||g.countryLabel||"").toUpperCase()}),g.sector&&t.jsx("button",{type:"button",onClick:()=>L({sector:[g.sector]}),children:g.sector.toUpperCase()}),g.stage&&t.jsx("button",{type:"button",onClick:()=>L({stage:[g.stage]}),children:g.stage.toUpperCase()}),typeof g.amountEur=="number"&&g.amountEur>0&&t.jsx("span",{className:"am2",children:Ft(g.amountEur,i)})]}),o.pipe&&q&&t.jsxs("div",{className:"pstat",children:[T&&t.jsx("span",{className:"vd "+(T==="MATCH"?"v-ok":"v-no"),title:n.vt[T],children:T}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[z]}),g.ceoStatus&&t.jsx("span",{className:"pstep own",children:g.ceoStatus})]}),(g.tagline||g.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:g.tagline||g.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[bt(g.engine)," ",t.jsx("b",{children:He(g.engine,i)})," — ",ni(g.engine,i),g.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",g.noteTitle]})]}),S?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:g,lg:!0})," ",t.jsx(Na,{o:g,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(cn(S,i))," · ",n.win7(ua(S,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),g.card?t.jsx(Kt,{spec:g.card}):null,g.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&z>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:g.reasoning})]}),o.pipe&&q&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof g.score=="number"&&g.score>0?" · "+n.score(g.score):""]})}),o.pipe&&q&&t.jsx(gn,{o:g})]}),t.jsx(hn,{name:g.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[z===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>d(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)]}),z===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),z===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),z===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(g,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(g,!1),a({type:"popup",id:null})},children:n.actNo}),At(g)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{h(g),a({type:"popup",id:null})},children:n.memoDeep})]}),z===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),z===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),g.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:g.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(g),a({type:"popup",id:null})},children:"🚀"})]}):g.engine==="media"&&g.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var A;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.url}}))}catch{}a({type:"popup",id:null}),(A=document.querySelector(".atl2 .demand"))==null||A.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(g.name),onClick:()=>d(g),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>d(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)," →"]}),g.website&&t.jsx("a",{className:"psite",href:g.website.startsWith("http")?g.website:"https://"+g.website,target:"_blank",rel:"noopener noreferrer",title:g.website,children:"🌐"})]})]})]}),document.body)}const _l=8;function Ul(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=_(),[d,c]=m.useState(!1),[f,s]=m.useState(!1),[x,u]=m.useState(!1),h=`atl2:sincemini:${r||"home"}`,[p,b]=m.useState(()=>{try{return localStorage.getItem(h)==="1"}catch{return!1}}),v=()=>{b(A=>{try{localStorage.setItem(h,A?"0":"1")}catch{}return!A})},g=r||"home",{names:S,verdicts:z}=m.useMemo(()=>{const A=[],C={};return n.forEach(N=>{N.kind!=="target"||!N.name||(A.push(N.name),C[N.name]=ri(N)||"")}),{names:A,verdicts:C}},[n]),y=m.useMemo(()=>S.length?oi(g,S,z,a):null,[g,S.length]);if(!i.pipe||d||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const T=f?y.added:y.added.slice(0,_l),q=y.added.length-T.length,L=A=>{const C=n.find(N=>N.name===A);C&&(o(C.id),l({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:v,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{c(!0),ii(g,S,z,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[T.map(A=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>L(A),children:t.jsx("b",{children:A})},A)),q>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>s(!0),children:e.sinceMore(q)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(A=>!A),children:e.sinceOut(y.gone.length)}),x&&y.gone.slice(0,20).map(A=>t.jsx("span",{className:"gone",children:A},A))]})]})}const oo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function bn({o:e,locked:a=!1}){const{t:r}=_(),n=Gt(e),i=mt(e),o=Ae(e),l=Pa(e),d=li(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(oo[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(gs,{o:e})]})}const qt=e=>e.length>22?e.slice(0,21)+"…":e,pa=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function vn(e){return pa.has(e.engine||"")}function rn(e){return!!e.noCo||vn(e)&&!!e.url}function Yt(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function io(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Hl(e){const r=()=>{const n=io(),i=e.getBoundingClientRect().top-n-8;Math.abs(i)<2||window.scrollBy({top:i,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function vr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=_(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),$e(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(qt(e.name))})]})}function yn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:f,dispatch:s,liveMemos:x}=_();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),s({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Yt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return vn(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Yt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(vr,{o:e})});const u=Ae(e),h=p=>b=>{b.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(vr,{o:e})});if(u===1){const p=x.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(_t,{item:p,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:h(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:h(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:h(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:h(()=>f(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:h(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Vl({o:e}){const{t:a,doThumb:r,thumbOf:n}=_(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Wl({o:e}){const{lang:a}=_();return qe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(Na,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[bt(e.engine||"")," ",He(e.engine||"",a)]})})}function Yl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:d,caps:c,markRow:f,markedId:s,favIds:x,toggleFav:u,t:h}=_(),p=Ae(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,g=v<=0?0:v<=7?1:v<=30?2:3,S=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][p]:b[g],z=x.has(e.id),y=T=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const q=T.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:q.left+Math.min(280,q.width/3),y:q.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>f(e.id),onMouseLeave:()=>f(null),onClick:y,children:[t.jsx("span",{className:"pt",style:{"--c":S}}),t.jsx(uo,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:z?1:.35,padding:0,marginRight:4},onClick:T=>{T.stopPropagation(),u(e)},children:z?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(T=>T&&T!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:h.acqSee(e.acquirer),onClick:T=>{T.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",qt(e.acquirer)]}),ut(e)?t.jsx("span",{className:"rdec",title:h.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:h.zoomNewsMark,children:"📰"}):null]}),t.jsx(Gl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Wl,{o:e}),c.pipe&&t.jsx(bn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(yn,{o:e}),c.showThumbs&&t.jsx(Vl,{o:e})]}),r&&!a&&!l&&t.jsx(Jl,{o:e})]})}function Gl({o:e}){const{lang:a,caps:r}=_();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ft(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Kl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=_(),l=(u,h=!1)=>p=>{p.stopPropagation(),h&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Ft(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=$e(e),x=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):rn(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),Yt(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(qt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(qt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Kt,{spec:e.card})})]})}function Ql({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=_();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[He(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(yn,{o:e})}),t.jsx(gn,{o:e})]})}function so({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:d,dossiers:c}=_();if(!e&&!a){const O=c.find(ut);if(O)return t.jsx(so,{o:O})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),s=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),x=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),h=e?!!e.noCo:!f||ma(f),p=(e==null?void 0:e.engine)||"",b=ut(e),v=e?Ft(e.amountEur,n):"",g=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),S=(()=>{const O=/https?:\/\/(?:www\.)?([^/]+)/.exec(s);return O?O[1].replace(/^www\./,"").slice(0,40):""})(),z=c.find(ut),y=((z==null?void 0:z.url)||"").trim(),T=!!s&&!!y&&(s===y||s.endsWith(y)||y.endsWith(s)),q=(O,H=!1)=>w=>{w.stopPropagation(),H&&l({type:"continent",key:"monde"}),l({type:"filters",patch:O})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const L=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},A=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},C=()=>{Yt({url:s,headline:x,tagline:e==null?void 0:e.tagline,name:f})},N=e?$e(e):!1,M=N&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",$=b?r.doEdito.replace(/^📖\s*/,""):p?He(p,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[$,g?` · ${g}`:""]}),t.jsx("h3",{className:"zoom-h",children:x}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(Kt,{spec:u})}),(s&&!T||y)&&t.jsxs("div",{className:"zoom-srcbox",children:[s&&!T&&t.jsxs("a",{className:"zoom-src",href:s,target:"_blank",rel:"nofollow noopener",onClick:O=>O.stopPropagation(),children:[r.zoomSrc,S?` · ${S}`:""," ↗"]}),z&&!b&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:O=>{O.stopPropagation(),l({type:"focus",id:z.id})},children:[r.doEdito," →"]}),y&&b&&t.jsxs("a",{className:"zoom-src zoom-src-art",href:y,target:"_blank",rel:"noopener noreferrer",onClick:O=>O.stopPropagation(),children:[r.zoomArt," ↗"]})]}),t.jsxs("div",{className:"zoom-acts",children:[N?t.jsxs("span",{className:"verdict",style:{"--c":M?"var(--brand)":"var(--red)"},children:[M?"✓":"✗"," ",t.jsx("b",{children:M?r.kept:r.dropped})]}):!h&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:O=>{O.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(qt(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,s&&(h||vn({engine:p}))&&t.jsxs("div",{className:"zp-pair",children:[t.jsxs("button",{type:"button",className:"zp-go ghost",onClick:O=>{O.stopPropagation(),window.dispatchEvent(new CustomEvent("ppmap:view",{detail:{url:s}}))},children:[t.jsx("span",{className:"zp-ico",children:"👁"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.viewLink}),t.jsx("em",{children:S||r.zoomSrc})]})]}),t.jsxs("button",{type:"button",className:"zp-go"+(!h&&f?" ghost":""),onClick:O=>{O.stopPropagation(),C()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]})]}),!h&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:O=>{O.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:O=>{O.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:qt(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!h&&f&&d.pipe&&t.jsx(hn,{name:f})]})]})}function Jl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=_();return!i.pipe&&e.kind==="op"?t.jsx(Kl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(gn,{o:e}),t.jsx(bs,{o:e}),t.jsx(ws,{o:e}),t.jsx(hn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(bn,{o:e})})]}),e.card&&t.jsx(Kt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[bt(e.engine||"")," ",He(e.engine||"",r)]}),qe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Xl({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:d,lang:c}=_();if(!l.pipe&&e.kind==="op"){const x=Ft(e.amountEur,c),u=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),h=(p,b=!1)=>v=>{v.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Kt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:h({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:h({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:h({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[bt(e.engine||"")," ",He(e.engine||"",c)]}),qe(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(yn,{o:e})})]})}const f=Ae(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][f];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(bn,{o:e}),qe(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&f===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function Zl(){const{t:e}=_(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ed({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=_(),o=i==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,x)=>(e[x]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(c)}”`:`${f} dossier${f>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function td(){var it,Oe;const e=_(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:d,markRow:c,lang:f,sessTally:s,data:x,dossiers:u,source:h,focusExtra:p,byId:b}=e,v=E=>i.lockRowsAfter!==null||h==="ops"?Number.MAX_SAFE_INTEGER:Ar,[g,S]=m.useState(new Set);m.useEffect(()=>{S(new Set)},[a.ptab,a.continent]);const[z,y]=m.useState(null);m.useEffect(()=>{y(null)},[a.ptab,a.continent]);const[T,q]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){q(!1);return}const E=document.getElementById("atl2-stage");if(!E){q(!1);return}const D=new IntersectionObserver(([V])=>q(!!V&&V.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return D.observe(E),()=>D.disconnect()},[a.mapFolded]);const L=a.mapFolded||!T,A=E=>S(D=>{const V=new Set(D);return V.has(E)?V.delete(E):V.add(E),V}),C=h==="ops"||i.pipe,[N,M]=m.useState("all"),[$,O]=m.useState(null),[H,w]=m.useState(!1),k=m.useRef(!0);m.useEffect(()=>{if(k.current){k.current=!1;return}M("all"),w(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!H)return;const E=D=>{var V,ie;(ie=(V=D.target)==null?void 0:V.closest)!=null&&ie.call(V,".atl2 .doable")||w(!1)};return document.addEventListener("click",E),()=>document.removeEventListener("click",E)},[H]);const F=Lr(),I=m.useMemo(()=>{var D;const E=new Map;for(const V of rs(((D=F==null?void 0:F.ed)==null?void 0:D.html)||""))E.has(V.t)||E.set(V.t,V.html);return E},[(it=F==null?void 0:F.ed)==null?void 0:it.html]),B=m.useCallback(E=>{if(E.decryptHtml)return E.decryptHtml;if(!I.size)return;const D=(E.name||"").trim().toLowerCase();if(D.length<3)return;const V=I.get(D);if(V)return V;for(const[ie,Ne]of I)if(ie.includes(D)||D.includes(ie))return Ne},[I]),W=m.useMemo(()=>{let E=pn(l,a.sort);return E=E.filter(D=>!ut(D)),N==="explore"?E=E.filter(rn):N==="eval"&&(E=E.filter(D=>!D.noCo)),E},[l,a.sort,N,B]),G=m.useMemo(()=>i.pipe?d.filter(E=>qe(E)&&si(E)):W.filter(E=>qe(E)&&!$e(E)),[i.pipe,d,W]),Q=G.length,[oe,ne]=m.useState(!1),[fe,ye]=m.useState(!1),re=`atl2:sigmini:${((Oe=x.session)==null?void 0:Oe.token)||"home"}`,[ee,xe]=m.useState(()=>{try{return localStorage.getItem(re)==="1"}catch{return!1}}),pe=m.useMemo(()=>i.pipe?W:W.filter(E=>!$e(E)&&!E.noCo),[W,i.pipe]),K=h==="ops"?W.filter(E=>E.noCo).length:0,Z=i.pipe?n.plabels[a.ptab].toLowerCase():h==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,J=a.filters,te=[];if(J.day)te.push({k:"day",lib:n.fDay(J.day.slice(8,10)+"/"+J.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(J.win&&J.win!=="all"){const E=["1","7","30"].indexOf(J.win);E>=0&&te.push({k:"win",lib:n.dates[E],off:()=>r({type:"filters",patch:{win:"all"}})})}const he=E=>E.length<=2?E.join(", "):`${E.length} ${n.fSelected}`;for(const E of["sector","country","engine"]){const D=J[E];D&&D.length&&te.push({k:E,lib:he(D),off:()=>r({type:"clearFacet",facet:E})})}J.search&&te.push({k:"search",lib:"🔍 "+J.search,off:()=>r({type:"filters",patch:{search:""}})});const Y=(E,D,V="",ie=!1)=>t.jsxs("button",{type:"button","data-s":E,className:V,"aria-sort":a.sort.key===E?a.sort.dir===1?"ascending":"descending":"none",style:ie?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:E}),children:[D,t.jsx("span",{className:"ar",children:a.sort.key===E&&a.sort.dir===1?"▴":"▾"})]},E),ue=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const E=new Map;W.forEach(ie=>{const Ne=ie.engine||"?";E.has(Ne)||E.set(Ne,[]),E.get(Ne).push(ie)});const D={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},V=Da([...E.keys()],f);return[...E.entries()].sort((ie,Ne)=>{const be=D[ie[0]]??10+V.indexOf(ie[0]),Re=D[Ne[0]]??10+V.indexOf(Ne[0]);return be-Re})},[W,i.pipe,a.groupBy,f]),se=ue?ue.filter(([E])=>pa.has(E)).length:0,ge=(()=>{var D;return((D=(ue?ue.flatMap(([,V])=>V):W)[0])==null?void 0:D.id)??null})(),Ie=m.useRef(!1),Ve=m.useRef(null),Se=m.useMemo(()=>u.find(ut)||null,[u]);m.useEffect(()=>{const E=()=>{Ie.current=!0};return window.addEventListener("ppmap:reveal",E),window.addEventListener("ppmap:focus",E),()=>{window.removeEventListener("ppmap:reveal",E),window.removeEventListener("ppmap:focus",E)}},[]),m.useEffect(()=>{if(!a.focusId)return;O(a.focusId);const E=window.setTimeout(()=>O(null),900);return()=>window.clearTimeout(E)},[a.focusId]),m.useEffect(()=>{C&&(a.focusId&&(W.some(E=>E.id===a.focusId)||u.some(E=>E.id===a.focusId))||p||ge&&r({type:"focus",id:ge}))},[C,a.focusId,W,ge,p,r,u]),m.useEffect(()=>{!C||!a.focusId||N!=="all"&&!W.some(E=>E.id===a.focusId)&&u.some(E=>E.id===a.focusId)&&M("all")},[C,a.focusId,N,W,u]),m.useEffect(()=>{if(!C||!a.focusId||!Ie.current)return;Ie.current=!1;const E=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel");if(!E)return;const D=io(),V=E.getBoundingClientRect();V.top>=D-2&&V.bottom<=window.innerHeight-4||Hl(E)},[C,a.focusId]),m.useEffect(()=>{if(typeof window>"u")return;const E=document.querySelector(".atl2.ops .listhead"),D=document.querySelector(".atl2.ops");if(!E||!D)return;const V=()=>D.style.setProperty("--listhead-h",`${E.offsetHeight}px`);V();const ie=new ResizeObserver(V);return ie.observe(E),()=>ie.disconnect()},[L,a.dens,a.mapFolded]);const Fe=m.useMemo(()=>{if(!C||!a.focusId)return null;const E=W.find(V=>V.id===a.focusId)||u.find(V=>V.id===a.focusId)||null;if(!E)return null;const D=B(E);return D&&D!==E.decryptHtml?{...E,decryptHtml:D}:E},[C,a.focusId,W,u,B]);m.useEffect(()=>{const E=Ve.current;if(!E)return;const D=V=>{const ie=E.scrollHeight>E.clientHeight+2,Ne=V.deltaY>0,be=E.scrollTop+E.clientHeight>=E.scrollHeight-1,Re=E.scrollTop<=0;(!ie||Ne&&be||!Ne&&Re)&&(V.preventDefault(),window.scrollBy(0,V.deltaY))};return E.addEventListener("wheel",D,{passive:!1}),()=>E.removeEventListener("wheel",D)},[C,Fe==null?void 0:Fe.id]);const Ze=i.lockRowsAfter;let ot=0;const ct=(E,D)=>{let V=a.shown[D]||v();return E.length-V<=4&&(V=E.length),E.slice(0,V).map(be=>{const Re=Ze!==null&&ot>=Ze;ot++;const et=B(be),ft=et&&et!==be.decryptHtml?{...be,decryptHtml:et}:be,Te=!C&&a.dens!=="maxi"&&(a.dens==="deplie"||(z?z==="open":!!et)),pt=g.has(be.id)?!Te:Te,Nt=C?Et=>{Ie.current=!0,r({type:"focus",id:Et});const R=b.get(Et);R&&(rn(R)?Yt(R):R.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:R.name}})))}:void 0;return a.dens==="maxi"?t.jsx(Xl,{o:ft,locked:Re,selected:C&&a.focusId===be.id,onSelect:Nt},be.id):t.jsx(Yl,{o:ft,locked:Re,open:pt,onToggle:()=>A(be.id),selected:C&&a.focusId===be.id,echo:$===be.id,onSelect:Nt},be.id)})},jt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(h==="ops"?" opsl":"")+(W.length?"":" list-empty"),Me=t.jsxs(t.Fragment,{children:[ue?ue.map(([E,D])=>t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:bt(E)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:E==="ma"?n.grpMa:E==="fundraising"?n.grpLev:pa.has(E)&&se<=1?n.grpNews:E==="nominations"?n.grpNom:E==="media"?n.grpNewsOther:E==="recrutements"?n.grpHire:pa.has(E)?n.grpNews+" · "+He(E,f):He(E,f)}),t.jsx("div",{className:"s",children:n.grpCount(D.filter(V=>!$e(V)).length,D.length)})]})]}),ct(D,E)]},E)):ct(W,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Zl,{}),!W.length&&!(x.loading&&!u.length)&&(i.pipe?t.jsx(ed,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(L?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:W.length})," ",Z]}),t.jsx("span",{className:"dot",children:"·"}),L&&t.jsx(ao,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[L?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),te.map(E=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:D=>{D.stopPropagation(),E.off()},children:[E.lib,t.jsx("i",{children:"×"})]},E.k)),h==="ops"&&W.length>0&&" — "+n.edSplit(W.length-K,K)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||h==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([E,D])=>t.jsxs("button",{type:"button","data-d":E,"aria-pressed":a.dens===E||E==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:E}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:D})]},E))}),!C&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":z==="open",onClick:()=>{y("open"),S(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":z==="closed",onClick:()=>{y("closed"),S(new Set)},children:n.foldAllLbl})]}),h==="ops"&&Se&&t.jsx("button",{type:"button",className:"edito-go","aria-pressed":a.focusId===Se.id,title:n.doEdito,onClick:()=>r({type:"focus",id:Se.id}),children:n.doEdito}),(i.showFunnel||h==="ops")&&(()=>{var V;const E=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],D=((V=E.find(([ie])=>ie===N))==null?void 0:V[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":H,onClick:()=>w(ie=>!ie),children:[D,t.jsx("i",{children:"▾"})]}),H&&t.jsx("div",{className:"dolist",children:E.map(([ie,Ne])=>t.jsx("button",{type:"button","aria-pressed":N===ie,onClick:()=>{M(ie),w(!1)},children:Ne},ie))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:E=>r({type:"sort",key:E.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([E,D])=>t.jsx("option",{value:E,children:D},E))})]}),i.showChain&&pe.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:pe.map(E=>E.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(pe.length):n.chainAll(pe.length)]}),L&&t.jsx(to,{compact:!0})]}),t.jsx(Ul,{}),Q>0&&!a.filters.signalOnly&&!fe&&t.jsxs("div",{className:"sigstrip"+(ee?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(Q)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!ee,title:ee?n.boxExpand:n.boxCollapse,onClick:()=>xe(E=>{try{localStorage.setItem(re,E?"0":"1")}catch{}return!E}),children:ee?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>ye(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(oe?G:G.slice(0,12)).map(E=>{const D=qe(E);return D?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(cn(D,f),ua(D,f)),onClick:()=>{c(E.id),r({type:"popup",id:E.id})},children:[t.jsx("b",{children:E.name}),t.jsxs("i",{children:[D.emoji," ",Ia(D,f)]}),t.jsx("em",{children:ua(D,f)})]},"sg-"+E.id):null}),!oe&&G.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>ne(!0),children:n.sigStripMore(G.length-12)})]})]}),a.dens!=="maxi"&&!C&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Y("country",n.colCountry),Y("name",n.colCompany),Y("amount",n.colAmount,"h-amt",!0),Y("stage",n.colStage,"h-stade"),Y("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Y("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Y("memo",n.colMemo)]}),i.pipe&&Y("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),C?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Y("country",n.colCountry),Y("name",n.colCompany),Y("amount",n.colAmount,"h-amt",!0),Y("stage",n.colStage,"h-stade"),Y("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:jt,children:Me})]}),t.jsxs("aside",{ref:Ve,className:"readpane","aria-label":f==="fr"?"Dossier":"File",children:[h==="ops"&&Se&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===Se.id,onClick:()=>r({type:"focus",id:Se.id}),children:n.doEdito}),i.pipe?t.jsx(Ql,{o:Fe}):t.jsx(so,{o:Fe,extra:Fe?null:p})]})]}):t.jsx("div",{className:jt,children:Me}),(()=>{const E=ue||[["pt"+a.ptab,W]];let D=0,V=0;for(const[Ne,be]of E){V+=be.length;let Re=a.shown[Ne]||v();be.length-Re<=4&&(Re=be.length),D+=Math.min(be.length,Re)}const ie=V-D;return ie<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>E.forEach(([Ne,be])=>r({type:"more",group:Ne,by:be.length,base:v()})),children:[t.jsx("span",{className:"more-label",children:n.more(ie,ie)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(D,V)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}function yr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ad(e,a){const r=di(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function nd(e,a){const n=[a.head.split("|").map(yr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",ad(i,a.plabels),Gt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(yr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function rd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const od=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function at({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function id({o:e,qa:a}){const{t:r,lang:n,fund:i}=_(),o=(e.cribleStatus||"").trim().toUpperCase()||(Gt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=mt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(at,{k:r.cdSector,v:e.sector}),t.jsx(at,{k:r.cdStage,v:e.stage}),t.jsx(at,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(at,{k:r.cdSite,v:e.domain||e.website}),t.jsx(at,{k:r.cdName,v:e.contactName}),t.jsx(at,{k:r.cdEmail,v:e.contactEmail}),t.jsx(at,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(at,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(at,{k:r.cdAngle,v:e.angle}),t.jsx(at,{k:r.cdDetected,v:od(e.date,n)})]}),c.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,f])=>f).map(([f,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:s})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function sd(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=_(),[d,c]=m.useState({}),f=25,s=m.useMemo(()=>n.slice(0,f),[n]);m.useEffect(()=>{s.length&&ci(r,s.map(h=>h.name)).then(c)},[r,s]);const x=o.stats,u=h=>h.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(x.screened/o.marketEstimate*100)," %"]})]})]}),s.map(h=>t.jsx(id,{o:h,qa:d[h.name]},h.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ld=50;function wn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=_(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(0),[h,p]=m.useState(""),[b,v]=m.useState(!1),g=m.useRef(null);m.useEffect(()=>()=>{g.current&&window.clearInterval(g.current)},[]);const S=async y=>{c(!0),s("");const T=await a();if(c(!1),T.ok){l(T);return}if(T.busy){s(i.alertPreviewBusy);return}if(!y){s(i.alertPreviewFail);return}u(ld),g.current=window.setInterval(()=>{u(q=>q>1?q-1:(g.current&&window.clearInterval(g.current),S(!1),0))},1e3)},z=async()=>{if(n||b)return;v(!0),p("");const y=await r();v(!1),p(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||x>0,onClick:()=>{S(!0)},children:d?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{z()},children:b?"…":i.alertTest})]}),x>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(x)}),f&&t.jsx("p",{className:"mnote warn",children:f}),h&&t.jsx("p",{className:"mnote",children:h}),!h&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const zt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function _e({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=_();return Mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function dd(){const{st:e}=_();switch(e.modal){case"chain":return t.jsx(pd,{});case"space":return t.jsx(ud,{});case"alert":return t.jsx(md,{});case"queue":return t.jsx(bd,{});case"export":return t.jsx(vd,{});case"plug":return t.jsx(kd,{});case"recharge":return t.jsx(Nd,{});case"cover":return t.jsx(Sd,{});case"dossier":return t.jsx(Ed,{});case"crit":return t.jsx(Cd,{});case"tuto":return t.jsx(zd,{});case"rdv":return t.jsx(cd,{});case"memoalert":return t.jsx(yd,{});default:return null}}function cd(){const{dispatch:e,fund:a,t:r}=_(),n=a||r.rdvCoFallback;return Mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Mr,children:mn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${xa}`,children:xa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Fi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function pd(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:d,caps:c,memoQueued:f,doAnalyse:s}=_(),x=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),h=e.chain.idx,p=u[h],b=h>=u.length;return Mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${h+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:h/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[Rt(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(dt(p.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:He(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Ft(p.amountEur,i)})]}),qe(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:p,lg:!0})," ",t.jsx(Na,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),x&&$e(p)&&t.jsxs("div",{className:"vbox",style:{"--c":gt(p)==="retenu"?"var(--brand)":gt(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:gt(p)==="retenu"?"✓ "+n.kept:gt(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&p&&c.pipe&&Ae(p)===1&&!f.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&p&&!(x&&$e(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function ud(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=_(),o=i==="client",l=m.useMemo(()=>o?r.filter(x=>$e(x)):[],[r,o]),d=m.useMemo(()=>pn(l.filter(x=>gt(x)==="retenu"),{key:"signal",dir:-1}),[l]),c=m.useMemo(()=>l.filter(x=>gt(x)==="ecarte"),[l]),f=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(_e,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function md(){const{mode:e}=_();return e==="client"||e==="apercu"?t.jsx(fd,{}):t.jsx(gd,{})}function fd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=_(),[o,l]=m.useState("d"),d=i!=="client";return t.jsxs(_e,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(xd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="w"&&t.jsx(hd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="m"&&t.jsx(lo,{})]})}function xd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),Pn(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||Pn(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),h=p=>{const b=o.sections||e.alertSec.map(([v])=>v);x({sections:u(p)?b.filter(v=>v!==p):[...b,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>h(p)}),t.jsxs("span",{children:[b,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(wn,{label:e.alertPreview,readOnly:r,onPreview:()=>yi(a),onTest:()=>vi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function hd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),Dn(a).then(b=>{p&&(b?l(b):c(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||Dn(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,h=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>x({dow:Number(p.target.value)}),children:e.alertDow.map((p,b)=>t.jsx("option",{value:b,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,h-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[h," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,h+1)}),disabled:r,children:"＋"})]})]}),t.jsx(wn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ki(a),onTest:()=>wi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function lo(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=_(),[l,d]=m.useState(o||""),[c,f]=m.useState(!1),[s,x]=m.useState(!1);m.useEffect(()=>{o&&d(o)},[o]);const u=e.filters,h=m.useMemo(()=>n.filter(g=>qe(g)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){x(!0);try{await fetch(`${on}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{x(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(g=>He(g,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(g=>Rt(g,r)||g).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([g,S])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:g}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:S}})]},g))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:g=>d(g.target.value),onKeyDown:g=>{g.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,h)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function gd(){const{t:e}=_();return t.jsx(_e,{title:e.alertTitle,icon:"🔔",children:t.jsx(lo,{})})}function bd(){var A,C;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:d,dispatch:c,liveMemos:f}=_(),[s,x]=m.useState(null),[u,h]=m.useState([]),[p,b]=m.useState(0),v=n==="client",g=m.useMemo(()=>{const N=new Map;return i.forEach(M=>{const $=(M.name||"").trim().toLowerCase();$&&!N.has($)&&N.set($,M)}),N},[i]);m.useEffect(()=>{let N=!0;return(async()=>{const[M,$]=await Promise.all([ln(r),Er(a)]);N&&(M&&x(M),h($))})(),()=>{N=!1}},[a,r,p]);const S=(s==null?void 0:s.per_day)??0,z=((A=s==null?void 0:s.analyzed_today)==null?void 0:A.length)??0,y=s==null?void 0:s.offre,T=(s==null?void 0:s.pool_meta)||[],q=m.useMemo(()=>{const N=new Map;for(const M of(s==null?void 0:s.scheduled)||[])for(const $ of M.names||[])N.has($)||N.set($,{label:M.day_label,date:M.date});return N},[s==null?void 0:s.scheduled]),L=(s==null?void 0:s.in_progress)||[];return t.jsxs(_e,{title:e.queueTitle,wide:!0,children:[y&&t.jsxs("div",{className:"qoffre"+(y.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:y.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:y.delai})]}),t.jsx("span",{className:"osp"}),y.rythme>0?t.jsx("span",{className:"or",children:e.qRate(y.rythme)}):y.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(y.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(z,z+(((C=s==null?void 0:s.pool_order)==null?void 0:C.length)??0))}})}),y&&t.jsxs("div",{className:"qeta",children:[y.file===0?e.qEtaDone:y.rythme<=0?e.qEtaPaused:e.qEta(y.file,y.rythme,y.jours_restants),y.en_retard&&t.jsxs("em",{children:[" ",e.qLate(y.delai,y.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(S)}),(y==null?void 0:y.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(L.length>0||f.items.some(N=>N.status==="boot"||N.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(N=>N.status==="boot"||N.status==="running"||N.status==="error").map(N=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:N.name}),t.jsx("span",{className:"qd",children:N.memoType||""}),t.jsx(_t,{item:N,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+N.name)),L.filter(N=>!f.liveOf(N.name)).map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.name}),t.jsxs("span",{className:"qd",children:[N.memo_type||"",N.age_min?` · ${Math.round(N.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:N.state||""})]},"ip-"+N.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.company}),t.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),t.jsx("span",{className:"qt",children:N.status}),N.url&&t.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),v&&N.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{On(a,N.company,"retry").then(()=>b(M=>M+1))},children:e.queueRetry}),v&&N.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{On(a,N.company,"delete").then(()=>b(M=>M+1))},children:e.queueDelete})]},N.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(T.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[T.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),T.map((N,M)=>{const $=q.get(N.name),O=g.get((N.name||"").trim().toLowerCase()),H=f.liveOf(N.name),w=!!(O&&l.has(O.id))||!!(H&&(H.status==="boot"||H.status==="running")),k=!!(O&&Ae(O)===1&&!O.memoUrl)&&!H;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),$?t.jsx("span",{className:"qwhen"+($.label==="demain"?" soon":""),children:$.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:N.name}),N.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof N.score=="number"&&t.jsx("span",{className:"qs2",children:N.score}),H&&(H.status==="boot"||H.status==="running")&&t.jsx(_t,{item:H,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),k&&(d.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:w,onClick:()=>{o(O),b(F=>F+1)},children:w?e.actAnalyseQueued:e.actAnalyse})),N.excerpt&&t.jsx("span",{className:"qex",children:N.excerpt})]},N.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([N,M])=>t.jsxs("li",{children:[t.jsx("b",{children:N})," — ",M]},N))})]})}function vd(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=_(),d=`${zt}/cibles/list.csv?token=${a}`,c=`${zt}/cibles/list.json?token=${a}`,f=`${zt}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,x=v=>{var g;(g=navigator.clipboard)==null||g.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:f,href:f}],h=!i.lockActions&&n.length>0,p=()=>{rd(nd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([g])=>g===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(_e,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:g,href:S})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(g),children:e.exportCopy}),S&&t.jsx("a",{className:"exb",href:S,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function yd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=_(),o=i!=="client",[l,d]=m.useState(null),[c,f]=m.useState(!1),[s,x]=m.useState(0),[u,h]=m.useState(!1);m.useEffect(()=>{let g=!0;return f(!1),Fn(a).then(S=>{g&&(S?d(S):f(!0))}),()=>{g=!1}},[a,s]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=g=>{if(o||!l)return;const S={enabled:g.enabled??!!l.enabled,email:g.email??(l.email||""),sections:g.sections??p()};h(!0),Fn(a,S).then(z=>{if(h(!1),!z){n(e.memoAlertErr);return}d(z),r(e.memoAlertSaved)})};if(c)return t.jsx(_e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(g=>g+1),children:e.retry})]})});if(!l)return t.jsx(_e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=p();return t.jsxs(_e,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(wd,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:g=>b({email:g})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([g,S])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[g],disabled:o||u,onChange:()=>b({sections:{...v,[g]:!v[g]}})}),t.jsx("span",{children:S})]},g))}),t.jsx(wn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>ui(a,v),onTest:()=>pi(a,v)})]})}function wd({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const d=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&d&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:n})]})]})}function kd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=_(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[f,s]=m.useState(null),[x,u]=m.useState(""),[h,p]=m.useState(0);m.useEffect(()=>{let z=!0;return c(!1),Ba(a).then(y=>{z&&(y?l({configured:y.configured,url_hint:y.url_hint}):c(!0))}),xi(a).then(y=>{z&&s(y)}),()=>{z=!1}},[a,h]);const b=(z,y)=>{i&&Ba(a,z).then(T=>{if(!T||T.ok===!1){n(e.actErr);return}z.test&&T.sent===!1?n(e.plugTestThrottled):r(y),p(q=>q+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',g=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),S=`curl -X POST ${zt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(_e,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(z=>z+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!i,onChange:z=>u(z.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:g}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var z;(z=navigator.clipboard)==null||z.writeText(g).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(jd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:S}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var z;(z=navigator.clipboard)==null||z.writeText(S).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var z;(z=navigator.clipboard)==null||z.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function jd(){const{t:e,token:a,lang:r}=_(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[d,c]=m.useState(null),[f,s]=m.useState(null),[x,u]=m.useState(!1),[h,p]=m.useState(!1),[b,v]=m.useState(null),[g,S]=m.useState(null),[z,y]=m.useState(null),T=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Ba(a).then($=>{S($&&$.configured?$.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),s(null),u(!1),v(null);try{const $=JSON.parse(localStorage.getItem(T)||"null");y($&&Date.now()-Date.parse($.t)<24*3600*1e3?$:null)}catch{y(null)}},[T]);const q=async()=>{l(!0),u(!1),v(null);const $=await gi(a,n);c($),s($.ok?n:null),l(!1)},L=m.useRef(!1),A=async()=>{if(L.current)return;L.current=!0,p(!0);const $=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await bi(a,n,"webhook",void 0,$)}finally{L.current=!1}if(p(!1),u(!1),v(O),O.ok&&(O.pushed||0)>0){const H={t:new Date().toISOString(),n:O.pushed||0};y(H);try{localStorage.setItem(T,JSON.stringify(H))}catch{}}},C=d!=null&&d.ok&&d.ready||0,N=!!(d!=null&&d.ok)&&f===n&&C>0&&!!g&&!z,M=z?new Date(z.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:$=>i($.target.value),children:e.plugBulkTabs.map(([$,O])=>t.jsx("option",{value:$,children:O},$))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{q()},children:o?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),z&&t.jsx("p",{className:"mnote",children:e.bulkLocked(M,z.n)}),!z&&!!(d!=null&&d.ok)&&!g&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!z&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),N&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),N&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(C,g||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{A()},children:h?e.bulkSending:e.bulkConfirm(g||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Nd(){const{t:e,data:a,lang:r}=_(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const f=await(await fetch(`${on}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(_e,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Ed(){const{t:e}=_();return t.jsx(_e,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(sd,{})})}function Sd(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:d}=_(),[c,f]=m.useState(null),[s,x]=m.useState(!1);m.useEffect(()=>{let C=!0;if(o)return ln(o).then(N=>{C&&N&&typeof N.per_day=="number"&&f(N.per_day)}),()=>{C=!1}},[o]);const[u,h]=m.useState(null);m.useEffect(()=>{if(!i)return;let C=!0;return fi(i).then(N=>{C&&h(N)}),()=>{C=!1}},[i]);const p=r.stats,b=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(C=>C.kind==="target"&&$e(C)).length,v=r.marketEstimate||0,g=v>0?Math.min(100,Math.round(b/v*100)):null,S=(p==null?void 0:p.window_days)||30,z=b>0?b/S:0,y=v>0?Math.max(0,v-b):0,q=v>0&&z>0&&b>=100?Math.round(y/z):null,L=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),A=C=>{s||!l||(x(!0),hi(i,C).then(N=>{if(x(!1),N===null){d(e.actErr);return}f(N),d(e.alertSaved)}))};return t.jsxs(_e,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(L(b))}),v>0&&t.jsx("span",{children:e.covOf(L(v))})]}),g!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:g+"%"}}),t.jsxs("em",{children:[g," %"]})]}),q!==null&&t.jsx("p",{className:"mnote",children:e.covEta(q)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),z>=1&&t.jsx("p",{className:"mnote",children:e.covPace(L(z))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((C,N)=>t.jsxs("tr",{className:C.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[C.code,C.geo?` · ${C.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof C.n=="number"?L(C.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:C.source}),C.elargi&&t.jsx("em",{children:e.covWide(String(C.demande||""))}),C.erreur&&t.jsx("em",{children:e.covMissing})]})]},N)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:L(u.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:L(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:L(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:L(p.shown)})," ",e.funShown]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:c===C?"on":"",disabled:s,onClick:()=>A(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Cd(){var g,S,z;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:d}=_(),c=n==="client",f=m.useMemo(()=>{const y=new Set;return a.forEach(T=>{T.angle&&y.add(T.angle)}),[...y]},[a]),[s,x]=m.useState(""),[u,h]=m.useState(""),[p,b]=m.useState(!1),v=async()=>{const y=s.trim();if(!(!y||p||!c)){b(!0),h("");try{const q=await(await fetch(`${zt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(q.reply&&h(String(q.reply)),q.job_id){h(e.critChatRunning);const L=async()=>{const A=await fetch(`${zt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:q.job_id})}).then(C=>C.json()).catch(()=>null);if(A&&A.done){h(String(A.reply||A.clarification||A.summary||"✓")),b(!1),A.applied&&i(e.alertSaved);return}setTimeout(()=>{L()},8e3)};setTimeout(()=>{L()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(_e,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((g=o.points)!=null&&g.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((S=o==null?void 0:o.angles)!=null&&S.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var T,q;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((T=y.look)!=null&&T.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(L=>t.jsx("li",{children:L},L))})]}),!!((q=y.out)!=null&&q.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(L=>t.jsx("li",{children:L},L))})]})]})]},y.title)})]}),!!((z=o==null?void 0:o.gate)!=null&&z.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||p,onChange:y=>x(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!c||p||!s.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(mi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,T])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(oo[y]||"v-cons"),children:y}),t.jsx("span",{children:T})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,T])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",T]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function zd(){const{t:e,dispatch:a,startTour:r}=_(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(_e,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const co="atl2:mapfold",Ad=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(co);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Td=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},po=m.createContext(null),_=()=>{const e=m.useContext(po);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=_(),n=qe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ia(n,r),children:[n.emoji," ",Ia(n,r)]}):null}function Na({o:e,src:a}){const{lang:r,t:n}=_(),i=qe(e);if(!i)return null;const o=zi(i),l=Ai(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(cn(i,r))+" · "+n.win7(ua(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Ld(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Ge(a);if(i)return e.find(o=>Ge(o.name)===i)||e.find(o=>{const l=Ge(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function qd(){const{scoped:e,t:a,st:r,dispatch:n}=_(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(x=>!ut(x)),d=l.length,c=l.filter(x=>!x.noCo).length,f=l.filter(x=>!!x.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const x=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",f," ",a.zoomPulseExplore]})]})]})}function uo({o:e}){const{lang:a}=_(),r=Ci(e.cc),n=e.cc?Rt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const wr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Md=!1;function Rd(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const mo=e=>`atl2:tour:${e||"anon"}`;function Fd(e){try{return localStorage.getItem(mo(e))==="1"}catch{return!0}}function kr(e){try{localStorage.setItem(mo(e),"1")}catch{}}function Od(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function $d({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var kn;const{lang:l}=ji(),d=_i[l],c=Zi(e,l,a),[f,s]=m.useReducer(as,void 0,()=>es((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Td():Ad()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=m.useRef(!0);m.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(co,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var j;(j=u.current)==null||j.call(u,f.filters)},[f.filters]);const[h,p]=m.useState(null),[b,v]=m.useState(null),[g,S]=m.useState(null),[z,y]=m.useState({kept:0,dropped:0}),[T,q]=m.useState(!1),[L,A]=m.useState(""),[C,N]=m.useState(!1),[M,$]=m.useState(null),[O,H]=m.useState(!1),[w,k]=m.useState(!1),[,F]=m.useState(0),I=()=>F(j=>j+1),B=m.useRef([]),W=m.useRef(new Set),G=m.useRef(new Set),[Q,oe]=m.useState([]),[ne,fe]=m.useState([]),[ye,re]=m.useState(0),ee=m.useRef(new Map),xe=m.useRef(null),{mode:pe}=c,K=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),Z=K.pipe,J=c.session.token||"",te=pe==="client"&&!e;m.useEffect(()=>{if(!J||!Z)return;let j=!0;const U=async()=>{const de=await Ti(J);!j||!de||(fe(de.runs),re(Date.now()/1e3-de.now),oe(ke=>ke.filter(Le=>!de.runs.some(tt=>Ge(tt.company)===Ge(Le.name)))))};U();const P=Q.length>0||ne.some(de=>de.status==="running"),X=window.setInterval(()=>{U()},P?8e3:25e3);return()=>{j=!1,window.clearInterval(X)}},[J,Z,Q.length,ne.some(j=>j.status==="running")]);const he=m.useMemo(()=>{const j=[],U=new Set;for(const P of Q){const X=Ge(P.name);!X||U.has(X)||(U.add(X),j.push({name:P.name,id:P.id,status:"boot",started:P.started,estMin:P.estMin,memoType:"instant"}))}for(const P of ne){const X=Ge(P.company);if(!X||U.has(X))continue;U.add(X);const de=P.status==="error"?"error":P.status==="done"?"done":"running";j.push({name:P.company,status:de,started:P.started||0,estMin:P.est_min||(P.memo_type==="detailed"?40:15),url:P.url,error:P.error,memoType:P.memo_type})}return j},[Q,ne]),Y=j=>he.find(U=>Ge(U.name)===Ge(j))||null,ue=(j,U)=>{oe(P=>P.some(X=>Ge(X.name)===Ge(j.name))?P:[...P,{name:j.name,id:j.id,started:Date.now()/1e3,estMin:U==="detailed"?40:15}]),W.current.add(j.id),I()};m.useEffect(()=>{if(document.querySelector(`link[href="${wr}"]`))return;const j=document.createElement("link");j.rel="stylesheet",j.href=wr,document.head.appendChild(j)},[]);const se=(j,U=!1)=>{A(j),N(U),xe.current&&clearTimeout(xe.current),xe.current=setTimeout(()=>A(""),U?4200:2400)},ge=j=>se(j,!0),Ie=m.useMemo(()=>{const j=new Map;return c.dossiers.forEach(U=>{U.id&&j.set(U.id,U)}),j},[c.dossiers]),Ve=m.useMemo(()=>c.dossiers.filter(j=>Tr(j,f,Z)),[c.dossiers,f,Z]),Se=m.useRef(!1);m.useEffect(()=>{if(Se.current||e||c.loading||!c.dossiers.length)return;if(!K.showFunnel||Fd(c.session.token||"")){Se.current=!0;return}Se.current=!0;const j=window.setTimeout(()=>{kr(c.session.token||""),H(!0)},700);return()=>window.clearTimeout(j)},[e,c.loading,c.dossiers.length,K.showFunnel,c.session.token]);const Fe=m.useMemo(()=>c.dossiers.filter(j=>ns(j,f,Z,c.favIds)),[c.dossiers,f,Z,c.favIds]),Ze=m.useMemo(()=>Ni(Ve,c.favIds),[Ve,c.favIds]),ot=m.useRef(!1);m.useEffect(()=>{if(ot.current)return;if(!Z||a==="ops"){ot.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){ot.current=!0;return}if(c.loading)return;ot.current=!0;const j=Ei(Ze);j!==f.ptab&&s({type:"ptab",tab:j})},[Z,a,n==null?void 0:n.ptab,c.loading,Ze,f.ptab]);const ct=m.useMemo(()=>{const j=Fr(c.dossiers);return j?dt(j)===0?d.tourToday:Or(j,l):d.tourNoRun},[c.dossiers,d,l]),jt=m.useMemo(()=>c.dossiers.some(j=>!!j.memoUrl||!!j.summary||At(j)),[c.dossiers]),[Me,it]=m.useState(!1);m.useEffect(()=>{if(c.loading){it(!1);return}if(c.dossiers.length>0||c.error){it(!0);return}const j=window.setTimeout(()=>it(!0),6e3);return()=>window.clearTimeout(j)},[c.loading,c.dossiers.length,c.error]);const Oe=(c.marketEstimate||0)>0||typeof((kn=c.stats)==null?void 0:kn.screened)=="number"&&c.stats.screened>0,E=m.useMemo(()=>[1,0,2,4,5,3].find(j=>(Ze[j]||0)>0)??0,[Ze]),D=dn.find(j=>j.key===f.continent),V=f.continent==="monde"?d.contWorld:(l==="fr"?D==null?void 0:D.fr:D==null?void 0:D.en)||"";m.useEffect(()=>{const j=U=>{var X;const P=(((X=U.detail)==null?void 0:X.name)||"").trim();P&&ie(null,P)};return window.addEventListener("ppmap:evaluate",j),()=>window.removeEventListener("ppmap:evaluate",j)}),m.useEffect(()=>{if(a!=="ops")return;const j=U=>{const P=U.detail||{},X=String(P.id||"").trim(),de=String(P.name||"").trim(),ke=String(P.url||"").trim(),Le=X&&Ie.get(X)||Ld(c.dossiers,de,ke);if(Le){v(null),window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Le.id}),(Le.noCo||["media","nominations","recrutements"].includes(Le.engine||""))&&(Le.url||Le.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Le.url||"",text:[Le.headline,Le.tagline].filter(Boolean).join(`
`)}})):Le.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Le.name}}));return}!de&&!ke||(s({type:"focus",id:null}),v({name:de,headline:String(P.text||"").trim()||de,url:ke,card:P.card}),ke&&(ma(de)||!de)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:ke,text:String(P.text||"").trim()}})):de&&!ma(de)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:de,url:ke}})))};return window.addEventListener("ppmap:focus",j),()=>window.removeEventListener("ppmap:focus",j)}),m.useEffect(()=>{const j=X=>{const de={},ke=String((X==null?void 0:X.sector)||"").trim();ke&&(de.sector=[ke]);const Le=String((X==null?void 0:X.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Le)&&(de.day=Le);const tt=String((X==null?void 0:X.search)||"").trim();tt&&(de.search=tt);const we=String((X==null?void 0:X.dealKind)||"").trim();(we==="ma"||we==="levee"||we==="other")&&(de.dealKind=[we]),Object.keys(de).length&&s({type:"filters",patch:de})},U=X=>j(X.detail),P=X=>{X.data&&X.data.type==="pp-filter"&&j(X.data)};return window.addEventListener("ppmap:filter",U),window.addEventListener("message",P),()=>{window.removeEventListener("ppmap:filter",U),window.removeEventListener("message",P)}},[]),m.useEffect(()=>{const j=U=>{var de;const P=(((de=U.detail)==null?void 0:de.name)||"").trim().toLowerCase();if(!P)return;const X=c.dossiers.find(ke=>(ke.name||"").trim().toLowerCase()===P);X&&s(a==="ops"?{type:"focus",id:X.id}:{type:"popup",id:X.id})};return window.addEventListener("ppmap:similar",j),()=>window.removeEventListener("ppmap:similar",j)});const ie=(j,U)=>{const P=((j==null?void 0:j.name)||U||"").trim();if(!te){S({kicker:P});return}!P||T||(q(!0),(async()=>{try{let X=P;const de=((j==null?void 0:j.website)||(j==null?void 0:j.domain)||"").trim();if(de)X=de;else try{const we=await Li(P);if(we!=null&&we.website)X=we.website;else if(((we==null?void 0:we.candidates)||[]).length===1)X=we.candidates[0].url;else if(((we==null?void 0:we.candidates)||[]).length>1){B.current=[{name:P,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(we.candidates||[]).slice(0,5)},...B.current].slice(0,8),I();return}}catch{}const ke=await Cr(J,X,"atelier2"),Le={name:ke.company||P,verdict:ke.verdict,reason:ke.reason||"",remaining:ke.remaining??null};B.current=[Le,...B.current].slice(0,8),ke.verdict==="kept"&&y(we=>({...we,kept:we.kept+1})),ke.verdict==="ruled_out"&&y(we=>({...we,dropped:we.dropped+1}));const tt=j||c.dossiers.find(we=>(we.name||"").toLowerCase()===P.toLowerCase());tt&&(ke.verdict==="kept"?tt.verdict=tt.verdict||"MATCH":ke.verdict==="ruled_out"&&(tt.verdict="NO MATCH"),ke.reason&&(tt.reasoning=ke.reason)),I()}finally{q(!1)}})())},Ne=j=>{if(!te){S({kicker:j.name});return}ue(j,"instant"),Ot(J,"fast_request",j.name||"",""),se(d.memoInstantSent(j.name))},be=j=>ee.current.get(j.id)??c.thumbs.get((j.name||"").trim().toLowerCase()),Re=(j,U)=>s({type:"undoPush",entry:{id:j.id,name:j.name,prevCeoStatus:U}}),et=async(j,U,P)=>{const X=j.ceoStatus||"";j.ceoStatus=U,I();const de=await Sa(J,{status:U,airtable_id:j.airtableId,check_id:j.checkId,company:j.name,...(P==null?void 0:P.note)!==void 0?{note:P.note}:{},...P!=null&&P.via?{via:P.via}:{}});return de.ok?de.skipped?(j.ceoStatus=X,I(),ge(d.actNotPersisted),!1):((P==null?void 0:P.undo)!==!1&&Re(j,X),P!=null&&P.msg&&se(P.msg),(U==="Validé"||U==="Écarté")&&!j.ceoNote&&(P==null?void 0:P.note)===void 0&&$({o:j,yes:U==="Validé"}),!0):(j.ceoStatus=X,I(),ge(d.actErr),!1)},ft=async(j,U)=>{const P=await Sa(J,{status:j.ceoStatus||"Retenu",airtable_id:j.airtableId,check_id:j.checkId,company:j.name,note:U,via:"note"});return!P.ok||P.skipped?(ge(P.skipped?d.actNotPersisted:d.actErr),!1):(j.ceoNote=U,I(),!0)},Te=m.useRef(new Map),pt=j=>Te.current.has(j.id)?Te.current.get(j.id):c.stages.get((j.name||"").trim().toLowerCase()),Nt=(j,U)=>{Te.current.set(j.id,U),I()},Et=(j,U)=>{te&&et(j,U?"Validé":"Écarté",{msg:U?d.decidedYes(j.name):d.decidedNo(j.name)})},R=j=>{te&&et(j,"À trancher",{msg:d.promoted(j.name)})},ae=j=>{te&&(async()=>{const U=j.ceoStatus||"";j.ceoStatus="Retenu",I();const P=await Sa(J,{status:"Retenu",check_id:j.checkId,company:j.name});if(!P.ok||P.skipped){j.ceoStatus=U,I(),ge(P.skipped?d.actNotPersisted:d.actErr);return}Re(j,U),se(d.repeched(j.name))})()},le=()=>{const j=f.undo[f.undo.length-1];if(!j){se(d.undoNone);return}const U=Ie.get(j.id);if(!U){s({type:"undoPop"}),se(d.undoNone);return}let P=j.prevCeoStatus;if(!P)if((U.verdict||"").toUpperCase().includes("CALL"))P="À trancher";else{se(d.undoLockedTitle);return}(async()=>await et(U,P,{undo:!1})&&(s({type:"undoPop"}),U.ceoStatus=j.prevCeoStatus,I(),se(d.undoDone(U.name))))()},me=j=>{te&&(G.current.add(j.id),I(),(async()=>{const U=await qi(J,j.name,"email");if(!U||U.ok===!1){G.current.delete(j.id),I(),ge(d.actErr);return}Ot(J,"approach",j.name||"",""),se(d.actApproachSent)})())},We=(j,U)=>{te&&(async()=>{if(!(await Ot(J,U?"yes":"no",j.name||"","")).ok){ge(d.actErr);return}ee.current.set(j.id,U?"yes":"no"),I(),se(U?d.thumbUpDone:d.thumbDnDone)})()},Be=j=>{!te||!At(j)||(ue(j,"detailed"),Ot(J,"detailed_request",j.name||"",""),se(d.memoDeepSent(j.name)))},Ee=j=>{const U=new Set(c.favIds),P=U.has(j.id);P?U.delete(j.id):U.add(j.id),c.setFavIds(U),te&&Mi(J,{id:j.id,co:j.name},P)},Ye=()=>{!te||w||window.confirm(d.identSyncConfirm)&&(k(!0),(async()=>{const j=await Ri(J);k(!1),j?se(d.identSyncDone):ge(d.actErr)})())},Qt=/proplace/i.test(c.fund||""),Jt=j=>{!te||!Qt||(Ot(J,"onboard_request",j.name||"",""),se(d.onboardSent(j.name)))},fo={st:f,dispatch:s,t:d,lang:l,mode:pe,caps:K,pipe:Z,token:J,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:ae,thumbOf:be,canWrite:te,commitStatus:et,saveNote:ft,stageOf:pt,setStage:Nt,flashErr:ge,startTour:()=>H(!0),dossiers:c.dossiers,scopedAll:Ve,scoped:Fe,counts:Ze,byId:Ie,contName:V,favIds:c.favIds,toggleFav:Ee,askEvaluate:ie,doAnalyse:Ne,doDecide:Et,doPromote:R,doApproach:me,doThumb:We,doDeep:Be,doUndo:le,doSync:Ye,doOnboard:Jt,outbound:Qt,memoQueued:W.current,liveMemos:{items:he,serverOff:ye,liveOf:Y},approachDone:G.current,sessTally:z,evalCards:B.current,evalBusy:T,markRow:p,markedId:h,flash:se,focusExtra:b};m.useEffect(()=>{const j=U=>{U.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",j),()=>window.removeEventListener("keydown",j)},[]);const xo=j=>J?t.jsx(os,{token:J,children:j}):t.jsx(t.Fragment,{children:j});return t.jsx(po.Provider,{value:fo,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(J?" cibles":""),children:[t.jsx("style",{children:Vi}),K.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Mr,children:mn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${xa}`,children:xa})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),xo(t.jsxs("div",{className:"app"+(Z?" pipe":"")+(J?" has-thesis":""),children:[K.showTicker&&t.jsx(Pe,{name:"live",children:t.jsxs("div",{className:"live-stack"+(J?" live-stack--cibles":""),children:[t.jsx(ps,{}),!!J&&t.jsx(is,{})]})}),K.showIdent&&t.jsx(Pe,{name:"identite",children:t.jsx(Ns,{})}),!1,!!J&&t.jsx(Pe,{name:"brief",children:t.jsx(ss,{})}),Md,K.showMorning&&t.jsx(Pe,{name:"matin",children:t.jsx(js,{})}),t.jsx(Pe,{name:"mesure",children:t.jsx(xs,{})}),K.showFunnel&&t.jsx(Pe,{name:"entonnoir",children:t.jsx(Pd,{})}),K.showFunnel&&t.jsx(Pe,{name:"tunnel",children:t.jsx(Es,{})}),K.showFunnel&&t.jsx(Pe,{name:"tuto",children:t.jsx(Ss,{})}),!f.mapFolded&&t.jsx(Pe,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(ao,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(qd,{}),t.jsx(jl,{}),t.jsx(to,{})]})]})}),K.showDemand&&Z&&t.jsx(Pe,{name:"direct",children:t.jsx(Ii,{items:he,serverOff:ye,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),K.showDemand&&t.jsx(Pe,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Ll,{})})}),K.showDemand&&f.memoConsole&&t.jsx(Pe,{name:"console",children:t.jsx(Ml,{})}),t.jsx(Pe,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(td,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(Pe,{name:"fiche",children:t.jsx($l,{})}),t.jsx(Pe,{name:"modales",children:t.jsx(dd,{})}),t.jsx(fs,{}),M&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:M.o.name}),t.jsx(ys,{placeholder:M.yes?d.whyYesPh:d.whyNoPh,onDone:j=>{const U=M.o;$(null),j&&ft(U,j).then(P=>{P&&se(d.csNoteSaved)})}})]}),O&&Me&&t.jsx(ks,{steps:Od(d,ct,jt,E,Oe),onClose:()=>{H(!1),kr(J)}}),t.jsx(Rd,{}),L&&t.jsx("div",{className:"flash on"+(C?" err":""),children:L}),g&&t.jsx(Si,{variant:"acquirer",initialCompany:jr().co,initialWebsite:jr().site,onClose:()=>S(null)})]})})}function Pd(){const{t:e}=_(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function jr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Dd(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{uo as FlagCell,wt as SigBadge,Na as SigWin,$d as default,Dd as fmtShort,_ as useV2};
