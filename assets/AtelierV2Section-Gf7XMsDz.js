...
.atl2 .bulk .side .hint{white-space:nowrap}`,Nl=`
...
`,zl=jl+Nl+Sl+Cl;function hn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Al(){const e=hn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function ql(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Al();return r==="0"?"client":r==="1"||hn("embed")==="1"&&hn("chrome")==="1"?"apercu":"client"}const Tl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ll=e=>Tl[e];function La(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Tt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!xo(a)||La(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ki(e.cc)})};function Xa(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Fl=60*60*1e3;function Rl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Fl?null:a}catch{return null}}function ha(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ol=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ml(e,a,r="default"){const n=r!=="default",o=c.useMemo(()=>e||n?{mode:"anon"}:Pi(),[e,n]),i=c.useMemo(()=>n?"visiteur":ql(e,o),[e,o,n]),d=c.useMemo(()=>Ll(i),[i]),l=i!=="visiteur",s=Ol(r),[h,p]=c.useState([]),[x,m]=c.useState(""),[b,f]=c.useState(null),[w,y]=c.useState(null),[u,v]=c.useState(null),[j,k]=c.useState(()=>new Map),[E,N]=c.useState(()=>new Map),[C,T]=c.useState(""),[S,L]=c.useState(new Set),[I,$]=c.useState(null),[R,M]=c.useState(!0),[g,q]=c.useState(!1),[O,J]=c.useState(0),[ae,z]=c.useState(0),B=c.useRef(0),D=c.useMemo(()=>{var U;if(i!=="client")return"";try{return((U=_i())==null?void 0:U.email)||""}catch{return""}},[i]);c.useEffect(()=>{const U=++B.current;let ue=!0;const te=()=>ue&&U===B.current,de=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),xe=Rl(de);return xe?(p(xe.objs.map(Tt)),xe.fund&&m(xe.fund),f(xe.marketEstimate??null),y(xe.criteria??null),v(xe.stats??null),T(xe.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const me=await Ya(),we=((me==null?void 0:me.recent_ops)||[]).map(be=>{const Ne=ja(be.company_name||be.title?be:{...be,title:(be.headline_fr||be.headline||"").slice(0,120)},a),Re=String(be.rubrique||"").toLowerCase();return Ne&&(Re==="nominations"||Re==="recrutements")&&(Ne.engine=Re),Ne&&!String(be.company_name||"").trim()&&(Ne.noCo=!0),Ne}).filter(be=>!!be).map(be=>(xo((be.name||"").trim())||(be.noCo=!0),be));try{const be=Bi(),Ne=await $i(),Re=((Ne==null?void 0:Ne.date)||"").slice(0,10),ne=be?be.doc:Ne,ke=Ui(ne),ve=((be==null?void 0:be.day)||(ne==null?void 0:ne.date)||Re||"").slice(0,10);if(ve&&ke.length){const oe=new Set;for(const _ of we){if((_.date||"").slice(0,10)!==ve)continue;const W=Zn(ke,oe,_.name,"");W>=0&&(oe.add(W),_.decryptHtml=ke[W].html)}for(const _ of we){if(_.decryptHtml||(_.date||"").slice(0,10)!==ve)continue;const W=Zn(ke,oe,"",_.headline||_.tagline||_.name);W>=0&&(oe.add(W),_.decryptHtml=ke[W].html)}}if(ve){const oe=((ne==null?void 0:ne.title_fr)||"").trim(),_=((ne==null?void 0:ne.lead_fr)||"").trim(),W=Hi(ne),Z=((ne==null?void 0:ne.url)||"").trim();oe&&(W||Z)&&we.unshift({id:`edito:${ve}`,kind:"op",name:oe,cc:null,date:ve,engine:"edito",dealKind:"other",headline:oe,tagline:_||oe,decryptHtml:W||void 0,url:Z,noCo:!0})}}catch{}if(!te())return;p(we.map(Tt)),ha(de,{objs:we})}else if(typeof r=="object"){const we=(await er()||[]).filter(Ne=>(Ne.slug||"")===r.research).map(Ne=>tr(Ne,a)).filter(Ne=>!!Ne),be=Xa(await ar(we,a));if(!te())return;p(be.map(Tt)),ha(de,{objs:be})}else if(l&&o.token){const me=Vi(o.token),we=Ya(),be=Wi(o.token),Ne=Gi(o.token),Re=Yi(o.token),ne=await me;let ke=ne?ne.targets:[];te()&&ne&&(m(ne.fund||""),f(ne.marketEstimate??null),y(ne.criteria??null),v(ne.stats??null),T(ne.generatedAt||""),p(ke.map(Tt)),M(!1),q(!1));const[ve,oe,_,W]=await Promise.all([we,be,Ne,Re]),Z=((ve==null?void 0:ve.recent_ops)||[]).map(re=>ja(re,a)).filter(re=>!!re),le=new Set(ke.map(re=>re.id));if(ke=[...ke,...Z.filter(re=>!le.has(re.id)&&(le.add(re.id),!0))],!te())return;p(ke.map(Tt));const pe=new Set;for(const re of oe){const ie=(re.id||re.co||"").toString().trim().toLowerCase();ie&&pe.add(ie.startsWith("t:")?ie:"t:"+ie)}L(pe),k(_),N(W),ne&&ha(de,{fund:ne.fund,marketEstimate:ne.marketEstimate,criteria:ne.criteria,stats:ne.stats,generatedAt:ne.generatedAt,objs:ke})}else{const me=Qi(),we=er(),be=Ya(),Ne=await me;te()&&Ne.length&&(p(Xa(Ne).map(Tt)),M(!1),q(!1));const[Re,ne]=await Promise.all([we,be]),ke=(Re||[]).map(W=>tr(W,a)).filter(W=>!!W),ve=await ar(ke,a),oe=((ne==null?void 0:ne.recent_ops)||[]).map(W=>ja(W,a)).filter(W=>!!W),_=Xa([...Ne,...ve,...oe]);if(!te())return;p(_.map(Tt)),ha(de,{objs:_})}te()&&q(!1)}catch{te()&&!xe&&q(!0)}finally{te()&&M(!1)}})(),()=>{ue=!1}},[l,o.token,a,O,s]),c.useEffect(()=>{if(!d.showCredits||!D){$(null);return}let U=!0;return(async()=>{try{const ue=await fetch(`${Ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:D})});if(!ue.ok)return;const te=await ue.json();U&&te&&te.ok!==!1&&$(te)}catch{}})(),()=>{U=!1}},[d.showCredits,D,ae]);const V=c.useCallback(U=>L(new Set(U)),[]);return{session:o,mode:i,caps:d,fund:x,email:D,marketEstimate:b,generatedAt:C,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:u,thumbs:j,stages:E,dossiers:h,patchStatuses:(U,ue)=>{p(te=>{let de=!1;const xe=te.map(me=>{if(!me.checkId)return me;const we=U.get(me.checkId);return!we||we===(me.ceoStatus||"")||!ue(me.id)?me:(de=!0,{...me,ceoStatus:we})});return de?xe:te})},favIds:S,setFavIds:V,credits:I,reloadCredits:()=>z(U=>U+1),loading:R,error:g,refresh:()=>J(U=>U+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Na=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Fa(e){return Na.has(e.engine||"")}function Xe(e){return!!e.noCo||Fa(e)&&!!e.url}const Oo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Dl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Oo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Il=new Set(["signal","amount","score","crible","memo"]);function Pl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Oo(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Il.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Mo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Mo=80;function Ra(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!$e(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Fn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(jt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Lt(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(vo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function ia(e,a,r){return We(e)?Ra(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ra(e,a.filters,r)}function _l(e,a,r,n){return!(!ia(e,a,r)||r&&!bo(e,a.ptab,n))}function In(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-jt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return Xi(o)||null;case"memo":return Ji(o)||null;case"signal":{const i=$e(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Za={},yr=(Za==null?void 0:Za.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function kr(){return new Date().toISOString().slice(0,10)}const Pn=c.createContext(null);function Do(){return c.useContext(Pn)}function Bl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const h=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(p=>s.removeAttribute(p.name)),h&&/^https?:\/\//i.test(h)&&(s.setAttribute("href",h),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Io(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function $l(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Io(r),r.innerHTML):e}catch{return e}}function Er(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Io(r),r.innerHTML):e}catch{return e}}function jr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Po(){const e=c.useContext(Pn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ul({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Q(),[i,d]=c.useState(()=>n.filters.day||kr()),[l,s]=c.useState(null),[h,p]=c.useState(!1),x=c.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),m=c.useCallback(()=>{d(kr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);c.useEffect(()=>{const w=y=>{var v;const u=(v=y.detail)==null?void 0:v.day;typeof u=="string"&&x(u)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),c.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),c.useEffect(()=>{if(!e||!i)return;let w=!1;p(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${yr}/cibles/edition.json?${y}`).then(u=>u.json()).then(u=>{w||s(u)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||p(!1)}),()=>{w=!0}},[e,i]);const b=c.useMemo(()=>`${yr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),f=c.useMemo(()=>({token:e,day:i,ed:l,loading:h,pickDay:x,pickWindow:m,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,h,x,m,n.filters.day,b,o]);return t.jsx(Pn.Provider,{value:f,children:a})}function Hl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Po(),[o,i]=c.useState(()=>n||wo());return c.useEffect(()=>{n&&i(!0)},[n]),c.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Aa,d),()=>window.removeEventListener(Aa,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Zi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Vl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Nr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Sr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Wl(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Po(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,h=c.useRef(null),[p,x]=c.useState("fonds"),[m,b]=c.useState(null),[f,w]=c.useState("idle"),y=c.useRef(!1);c.useEffect(()=>{b(null),w("idle"),y.current=!1,x("fonds")},[e]),c.useEffect(()=>{if(p!=="jour"||y.current)return;y.current=!0;let E=!0;return w("load"),Vl(e).then(N=>{E&&(b(N),w("fait"))}),()=>{E=!1}},[p,e]);const u=c.useMemo(()=>$l((m==null?void 0:m.html)||""),[m==null?void 0:m.html]),v=c.useRef(null);c.useEffect(()=>{const E=v.current;if(!E||!u)return;let N=!1;return un(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{N=!0}},[u]);const j=c.useMemo(()=>Er((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=c.useMemo(()=>Er((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return c.useEffect(()=>{const E=h.current;if(!E||!j)return;let N=!1;return un(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{N=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const E=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(E);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:E})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":p==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":p==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),p==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),p==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),p==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Nr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:jr(e,!0)}),"."]}):Nr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:jr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),p==="fonds"&&d&&j?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,p==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,p==="jour"&&(u?t.jsxs(t.Fragment,{children:[(m==null?void 0:m.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:m.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:u}})]}):t.jsx("p",{className:f==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:f!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Sr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Sr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Gl=300,ga=7,Yl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},_o={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ql=["hiring","raised","news","posting","building","community","registry","exodus","other"];function en(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ns(r)&&r!=="media")return"news:"+r;const n=$e(e);return n?"sig:"+(n.theme&&_o.fr[n.theme]?n.theme:"other"):"actualites"}function Kl(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=Q(),s=Do(),h=d==="en",[p,x]=c.useState("all"),[m,b]=c.useState(!1),f=c.useMemo(()=>{var ue;const g=(a.filters.day||"").slice(0,10),q=te=>!(!i&&a.continent!=="monde"&&te.continent!==a.continent||g&&(te.date||"").slice(0,10)!==g),O=e.filter(te=>q(te)&&$e(te)&&(!i||te.kind!=="target"||Le(te)!==5)),J=i&&(((ue=s==null?void 0:s.ed)==null?void 0:ue.ops)||[]).length?s.ed.ops.map(te=>ja(te,d)).filter(te=>!!te).map(te=>(te.briefOnly=!0,te)).filter(te=>!g||(te.date||"").slice(0,10)===g):[],ae=e.filter(te=>q(te)&&te.kind==="op"&&(g?!0:jt(te.date)<=ga)),z=i?J.length?J:ae.filter(te=>{const de=(l||"").trim().toLowerCase();if(!de)return!1;const xe=te.match||null;return xe?Object.keys(xe).map(me=>me.trim().toLowerCase()).includes(de):!1}):ae,B=g||new Date().toISOString().slice(0,10),D=te=>{const de=en(te);return de==="ma"?0:de==="levees"?1:2};z.sort((te,de)=>{const xe=D(te)-D(de);if(xe)return xe;const me=(te.date||"").slice(0,10)===B?0:1,we=(de.date||"").slice(0,10)===B?0:1;return me!==we?me-we:(de.amountEur||0)-(te.amountEur||0)});const V=new Set,U=[];for(const te of[...z,...In(O,{key:"signal",dir:-1})]){const de=te.id||te.name;!de||V.has(de)||(V.add(de),U.push(te))}return i&&U.length===0?e.filter(de=>q(de)&&jt(de.date)<=ga).sort((de,xe)=>(xe.date||"").localeCompare(de.date||"")).slice(0,80):U},[e,a.continent,a.filters.day,i,l,d,s]),w=c.useMemo(()=>{const g={};for(const q of f){const O=en(q);g[O]=(g[O]||0)+1}return g},[f]),y=c.useMemo(()=>p==="all"?f:f.filter(g=>en(g)===p),[f,p]),u=c.useMemo(()=>y.slice(0,Gl),[y]),v=y.length-u.length,j=c.useRef(null);c.useEffect(()=>{var z,B;const g=j.current;if(!g)return;const q=()=>{const D=g.scrollWidth;D<200||(g.style.animationDuration=Math.max(18,Math.round(D/130))+"s")};q();const O=requestAnimationFrame(q),J=window.setTimeout(q,1200);let ae=!0;return(B=(z=document.fonts)==null?void 0:z.ready)==null||B.then(()=>{ae&&q()}),()=>{ae=!1,cancelAnimationFrame(O),window.clearTimeout(J)}},[u.length,p]);const k=g=>g==="all"?f.length:w[g]||0,E=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return _o[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const q=g.slice(5);return ts[q]?as(q,h?"en":"fr"):g}return Yl[h?"en":"fr"][g]},N=[{k:"all"}],C=["ma","levees"].filter(g=>k(g)>0||g===p);if(C.length){N.push({g:h?"Deals":"Opérations"});for(const g of C)N.push({k:g})}const T=["nominations","recrutements"].filter(g=>k(g)>0||g===p),S=es.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>k(g)>0||g===p),L=k("actualites")>0||p==="actualites"?["actualites"]:[];if(T.length||S.length||L.length){N.push({g:h?"News":"Actualités"});for(const g of T)N.push({k:g});for(const g of S)N.push({k:g});for(const g of L)N.push({k:g})}const I=Ql.map(g=>"sig:"+g).filter(g=>k(g)>0||g===p);if(I.length){N.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of I)N.push({k:g})}const $=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},R=(()=>{const g=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(h?`LIVE covers the events of ${$(g)}.`:`Le LIVE regroupe les événements du ${$(g)}.`)+q:(h?`LIVE covers the still-open signals and the deals of the last ${ga} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ga} derniers jours.`)+q})(),M=g=>u.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ge(q)?" spent":""),onClick:O=>{const J=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:J?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(J||n({type:"focus",id:q.id}),a.dens!=="liste"){const ae=O.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:ae.left+ae.width/2,y:ae.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(Ct,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(ji,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),(()=>{const O=(q.tagline||q.headline||"").trim();return O&&O!==q.name?t.jsx("span",{className:"what",children:O}):null})(),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Xc(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Wa,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(q.id||q.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>b(g=>!g),children:[E(p),t.jsx("b",{children:k(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:R}),N.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===p,onClick:()=>{x(g.k),b(!1)},children:[E(g.k),t.jsx("b",{children:k(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:u.length?t.jsxs("div",{className:"run",ref:j,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(Xl,{isEn:h})]})}const Jl=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Xl({isEn:e}){const[a,r]=c.useState(()=>wo());c.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Aa,o),()=>window.removeEventListener(Aa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>rs(!a),children:Jl})}const _n="+33 6 83 10 72 86",Oa="alexandre@proplace.co",Bo=`tel:${_n.replace(/[^\d+]/g,"")}`;function Zl(){return null}class pt extends c.Component{constructor(){super(...arguments);Kn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const $o=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Cr(e,a){if((zt(e)||"").startsWith("CALL")&&Le(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Le(e)>=2;return $o.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const zr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",ed={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function td({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Q(),[l,s]=c.useState(""),[h,p]=c.useState(!1),[x,m]=c.useState(!1),b=c.useRef(null);if(c.useEffect(()=>{if(!x)return;const v=j=>{b.current&&!b.current.contains(j.target)&&(m(!1),p(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const f=(e.ceoStatus||"").trim(),w=async v=>{if(l)return;if(v==="Analysé"&&!e.memoUrl){p(!0);return}s(v);const j=(Cr(e,a).find(([E])=>E===v)||[v,v])[1],k=await o(e,v,{msg:a.csMoved(e.name,j)});s(""),k&&(p(!1),m(!1))},y=Cr(e,a),u=v=>(y.find(([j])=>j===v)||[])[1]||v;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:y.map(([v,j])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(l===v?" busy":""),disabled:!!l,onClick:()=>{w(v)},children:j},v))}):t.jsxs("span",{className:"rstat"+(x||h?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+zr(f),onClick:()=>{m(v=>!v),p(!1)},children:l?u(l)+"…":f?u(f):a.csNone}),x&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([v,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":f===v,className:"rsopt"+(f===v?" on":"")+(l===v?" busy":""),disabled:!!l,onClick:()=>{if(v===f){m(!1);return}w(v)},children:[t.jsx("i",{className:"pt2",style:{background:ed[zr(v)]}}),j]},v))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),p(!1),m(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const v=await o(e,"Analysé");s(""),v&&(p(!1),m(!1))})()},children:a.csAnaAnyway})]})})]})}function ad({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Q(),[i,d]=c.useState(""),[l,s]=c.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),p=(zt(e)||"").startsWith("CALL")&&Le(e)===3,x=Le(e)>=2,m=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(f);const w=await o(e,f);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=p?[["Validé",a.csYes],["Écarté",a.csNo]]:$o.filter(([f])=>!(x&&f==="Retenu")).map(([f,w])=>[f,a[w]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([f,w])=>t.jsx("button",{type:"button",className:"csb"+(h===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{m(f)},children:w},f)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(nd,{o:e})]})}function nd({o:e}){const{t:a,saveNote:r,flash:n}=Q(),[o,i]=c.useState(e.ceoNote||""),[d,l]=c.useState(!1),[s,h]=c.useState(!1),p=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!p)return;l(!0);const m=await r(e,o.trim());l(!1),m&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!p,onClick:()=>{x()},children:s?a.csNoteSaved:a.csNoteOk})]})}function Ar({placeholder:e,onDone:a}){const{t:r}=Q(),[n,o]=c.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function rd({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=Q(),[s,h]=c.useState(!1);if(!n.pipe||!o||n.lockActions||Le(e)!==4)return null;const p=i(e),x=(p==null?void 0:p.stage)||"todo",m=async u=>{if(s||u===x)return;h(!0);const v=p;d(e,{stage:u,stamps:(p==null?void 0:p.stamps)||{}});const j=Math.max(Date.now(),qr+=1);qr=j;const k=await os(r,{company:e.name||"",stage:u,cts:j,deal_id:e.airtableId,check_id:e.checkId});h(!1),!k.stale&&(k.ok||(d(e,v),l(a.actErr)))},b=(y=p==null?void 0:p.stamps)==null?void 0:y.sent,f=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&f>=4;return t.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===u?" on":""),disabled:s,onClick:()=>{m(u)},children:v},u)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let qr=0;const Jt=8,Nt=360;function Tr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Lr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Tr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Tr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function od({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Q(),[d,l]=c.useState(0),[s,h]=c.useState(null),[p,x]=c.useState([]),m=c.useRef(!1),b=c.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),f=c.useRef(!1);c.useEffect(()=>{const C=b.current;return()=>{f.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),c.useEffect(()=>{m.current||(m.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const w=p[d],y=d>=p.length;c.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const C=w.click,T=window.setTimeout(()=>{const S=document.querySelector(C);S&&S.getAttribute("aria-selected")!=="true"&&S.click()},60);return()=>window.clearTimeout(T)}},[d,w]);const u=c.useRef(-1),v=c.useCallback(()=>{if(!w){h(null);return}const C=L=>{if(!L)return null;for(const I of document.querySelectorAll(L)){const $=I.getBoundingClientRect();if($.width>1&&$.height>1)return I}return null},T=C(w.sel)||C(w.need);if(!T){h(null);return}u.current!==d&&(u.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=T.getBoundingClientRect();h(L=>L&&Math.abs(L.top-S.top)<1&&Math.abs(L.left-S.left)<1&&Math.abs(L.width-S.width)<1&&Math.abs(L.height-S.height)<1?L:S)},[w,d]);c.useLayoutEffect(()=>{v();const C=[90,300,700,1300].map(L=>window.setTimeout(v,L)),T=window.setInterval(v,400),S=()=>v();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{C.forEach(L=>window.clearTimeout(L)),window.clearInterval(T),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[v]);const j=c.useRef(a);if(j.current=a,c.useEffect(()=>{const C=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),j.current()):T.key==="ArrowRight"?l(S=>S+1):T.key==="ArrowLeft"&&l(S=>Math.max(0,S-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!p.length)return null;let k=null;const E=C=>()=>{f.current=!0,n({type:"modal",modal:null}),C()};if(y){const C=o[3]||0;C>0?k={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Nt};if(!y&&s){const C=s.bottom+14,T=window.innerHeight-C;let S=T>190?C:Math.max(12,s.top-200),L=Math.min(Math.max(12,s.left+s.width/2-Nt/2),window.innerWidth-Nt-12);T<=190&&s.top<212&&(window.innerWidth-s.right>=Nt+40?L=Math.min(s.right+26,window.innerWidth-Nt-12):s.left>=Nt+40&&(L=Math.max(12,s.left-Nt-26)),S=Math.max(12,s.top-Jt)),N={left:L,top:S,width:Nt}}return Gt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-Jt,top:s.top-Jt,width:s.width+Jt*2,height:s.height+Jt*2}}),(y||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:N,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Lr,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(p.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,p.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/p.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(Lr,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(C=>C+1),children:d===p.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Uo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Ho(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function id(){var T,S;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=Q(),h=r?a:e,p=c.useMemo(()=>h.filter(L=>jt(L.date)===0&&L.kind==="target"),[h]),x=c.useMemo(()=>r?a.filter(L=>L.kind==="target"&&Le(L)===0).slice().sort((L,I)=>(I.date||"").localeCompare(L.date||"")):[],[a,r]),m=c.useMemo(()=>p.filter(L=>r?Le(L)===0:!Ge(L)),[p,r]),b=r?x:m,f=r?a.length-x.length:p.length-m.length,w=r?a.length:p.length,y=w?Math.min(100,f/w*100):100,u=c.useMemo(()=>Uo(h),[h]),v=!!u&&jt(u)>0,j=c.useMemo(()=>v?h.filter(L=>(L.date||"").slice(0,10)===u):[],[h,u,v]),k=typeof((T=l.stats)==null?void 0:T.kept_today)=="number"?l.stats.kept_today:null,E=typeof((S=l.stats)==null?void 0:S.screened_today)=="number"?l.stats.screened_today:p.length;let N;v?N=o.morningLast(j.length,x.length,Ho(u,d)):r?N=o.morningThesis(E,x.length,k):p.length?f===0?N=o.goalSourced(p.length):f>=p.length?N=o.goalCleared:N=o.goalDone(f,p.length):N=o.goalSourced(0);const C=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&x.length&&s({type:"chainStart",queue:x.map(L=>L.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function sd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:l}=Q(),s=i==="client",[h,p]=c.useState(!1),[x,m]=c.useState(""),b=()=>{!s||h||!n||(p(!0),m(""),is(n).then(y=>{if(p(!1),y.pending){m(e.refreshSlow);return}if(!y.ok){y.error&&console.warn("[republish]",y.error),m(e.refreshKo);return}const u=y.entered??0,v=y.left??0;m(y.unchanged||!u&&!v?e.refreshSame:e.refreshDone(u,v)),o.refresh()}))},f=(n||"P").split(/\s+/).map(y=>y[0]).join("").slice(0,2).toUpperCase(),w=(()=>{const y=Date.parse(o.generatedAt||"");if(Number.isNaN(y))return"";const u=new Date(y),v=j=>String(j).padStart(2,"0");return`${v(u.getDate())}/${v(u.getMonth()+1)} à ${v(u.getHours())}:${v(u.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?f:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),w?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(w)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!s||h,onClick:b,children:h?"⏳":"📰"}),(h||!!x)&&t.jsxs("span",{className:"repubst",children:[h?e.refreshRun:x,!h&&t.jsx("button",{type:"button",onClick:()=>m(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!s,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:y=>r({type:"filters",patch:{search:y.target.value}})})]})]})})}class Rt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*ld(e){for(const a of e)yield*a}function Vo(e){return Array.from(ld(e))}var Te=1e-6,Se=Math.PI,it=Se/2,Fr=Se/4,lt=Se*2,wt=180/Se,tt=Se/180,Oe=Math.abs,dd=Math.atan,sa=Math.atan2,Ie=Math.cos,Pe=Math.sin,pd=Math.sign||function(e){return e>0?1:e<0?-1:0},It=Math.sqrt;function cd(e){return e>1?0:e<-1?Se:Math.acos(e)}function la(e){return e>1?it:e<-1?-it:Math.asin(e)}function st(){}function Ma(e,a){e&&Or.hasOwnProperty(e.type)&&Or[e.type](e,a)}var Rr={Feature:function(e,a){Ma(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ma(r[n].geometry,a)}},Or={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){gn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)gn(r[n],a,0)},Polygon:function(e,a){Mr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Mr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ma(r[n],a)}};function gn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Mr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)gn(e[r],a,1);a.polygonEnd()}function Bt(e,a){e&&Rr.hasOwnProperty(e.type)?Rr[e.type](e,a):Ma(e,a)}function xn(e){return[sa(e[1],e[0]),la(e[2])]}function Ht(e){var a=e[0],r=e[1],n=Ie(r);return[n*Ie(a),n*Pe(a),Pe(r)]}function xa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Da(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function tn(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ba(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function bn(e){var a=It(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function vn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function wn(e,a){return Oe(e)>Se&&(e-=Math.round(e/lt)*lt),[e,a]}wn.invert=wn;function ud(e,a,r){return(e%=lt)?a||r?vn(Ir(e),Pr(a,r)):Ir(e):a||r?Pr(a,r):wn}function Dr(e){return function(a,r){return a+=e,Oe(a)>Se&&(a-=Math.round(a/lt)*lt),[a,r]}}function Ir(e){var a=Dr(e);return a.invert=Dr(-e),a}function Pr(e,a){var r=Ie(e),n=Pe(e),o=Ie(a),i=Pe(a);function d(l,s){var h=Ie(s),p=Ie(l)*h,x=Pe(l)*h,m=Pe(s),b=m*r+p*n;return[sa(x*o-b*i,p*r-m*n),la(b*o+x*i)]}return d.invert=function(l,s){var h=Ie(s),p=Ie(l)*h,x=Pe(l)*h,m=Pe(s),b=m*o-x*i;return[sa(x*o+m*i,p*r+b*n),la(b*r-p*n)]},d}function md(e,a,r,n,o,i){if(r){var d=Ie(a),l=Pe(a),s=n*r;o==null?(o=a+n*lt,i=a-s/2):(o=_r(d,o),i=_r(d,i),(n>0?o<i:o>i)&&(o+=n*lt));for(var h,p=o;n>0?p>i:p<i;p-=s)h=xn([d,-l*Ie(p),-l*Pe(p)]),e.point(h[0],h[1])}}function _r(e,a){a=Ht(a),a[0]-=e,bn(a);var r=cd(-a[1]);return((-a[2]<0?-r:r)+lt-Te)%lt}function Wo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:st,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Sa(e,a){return Oe(e[0]-a[0])<Te&&Oe(e[1]-a[1])<Te}function va(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Go(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(f){if(!((w=f.length-1)<=0)){var w,y=f[0],u=f[w],v;if(Sa(y,u)){if(!y[2]&&!u[2]){for(o.lineStart(),l=0;l<w;++l)o.point((y=f[l])[0],y[1]);o.lineEnd();return}u[0]+=2*Te}i.push(v=new va(y,f,null,!0)),d.push(v.o=new va(y,null,v,!1)),i.push(v=new va(u,f,null,!1)),d.push(v.o=new va(u,null,v,!0))}}),!!i.length){for(d.sort(a),Br(i),Br(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var h=i[0],p,x;;){for(var m=h,b=!0;m.v;)if((m=m.n)===h)return;p=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(b)for(l=0,s=p.length;l<s;++l)o.point((x=p[l])[0],x[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(b)for(p=m.p.z,l=p.length-1;l>=0;--l)o.point((x=p[l])[0],x[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,p=m.z,b=!b}while(!m.v);o.lineEnd()}}}function Br(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function an(e){return Oe(e[0])<=Se?e[0]:pd(e[0])*((Oe(e[0])+Se)%lt-Se)}function fd(e,a){var r=an(a),n=a[1],o=Pe(n),i=[Pe(r),-Ie(r),0],d=0,l=0,s=new Rt;o===1?n=it+Te:o===-1&&(n=-it-Te);for(var h=0,p=e.length;h<p;++h)if(m=(x=e[h]).length)for(var x,m,b=x[m-1],f=an(b),w=b[1]/2+Fr,y=Pe(w),u=Ie(w),v=0;v<m;++v,f=k,y=N,u=C,b=j){var j=x[v],k=an(j),E=j[1]/2+Fr,N=Pe(E),C=Ie(E),T=k-f,S=T>=0?1:-1,L=S*T,I=L>Se,$=y*N;if(s.add(sa($*S*Pe(L),u*C+$*Ie(L))),d+=I?T+S*lt:T,I^f>=r^k>=r){var R=Da(Ht(b),Ht(j));bn(R);var M=Da(i,R);bn(M);var g=(I^T>=0?-1:1)*la(M[2]);(n>g||n===g&&(R[0]||R[1]))&&(l+=I^T>=0?1:-1)}}return(d<-Te||d<Te&&s<-1e-12)^l&1}function Yo(e,a,r,n){return function(o){var i=a(o),d=Wo(),l=a(d),s=!1,h,p,x,m={point:b,lineStart:w,lineEnd:y,polygonStart:function(){m.point=u,m.lineStart=v,m.lineEnd=j,p=[],h=[]},polygonEnd:function(){m.point=b,m.lineStart=w,m.lineEnd=y,p=Vo(p);var k=fd(h,n);p.length?(s||(o.polygonStart(),s=!0),Go(p,gd,k,r,o)):k&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),p=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,E){e(k,E)&&o.point(k,E)}function f(k,E){i.point(k,E)}function w(){m.point=f,i.lineStart()}function y(){m.point=b,i.lineEnd()}function u(k,E){x.push([k,E]),l.point(k,E)}function v(){l.lineStart(),x=[]}function j(){u(x[0][0],x[0][1]),l.lineEnd();var k=l.clean(),E=d.result(),N,C=E.length,T,S,L;if(x.pop(),h.push(x),x=null,!!C){if(k&1){if(S=E[0],(T=S.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),N=0;N<T;++N)o.point((L=S[N])[0],L[1]);o.lineEnd()}return}C>1&&k&2&&E.push(E.pop().concat(E.shift())),p.push(E.filter(hd))}}return m}}function hd(e){return e.length>1}function gd(e,a){return((e=e.x)[0]<0?e[1]-it-Te:it-e[1])-((a=a.x)[0]<0?a[1]-it-Te:it-a[1])}const $r=Yo(function(){return!0},xd,vd,[-Se,-it]);function xd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?Se:-Se,s=Oe(i-a);Oe(s-Se)<Te?(e.point(a,r=(r+d)/2>0?it:-it),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=Se&&(Oe(a-n)<Te&&(a-=n*Te),Oe(i-l)<Te&&(i-=l*Te),r=bd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function bd(e,a,r,n){var o,i,d=Pe(e-r);return Oe(d)>Te?dd((Pe(a)*(i=Ie(n))*Pe(r)-Pe(n)*(o=Ie(a))*Pe(e))/(o*i*d)):(a+n)/2}function vd(e,a,r,n){var o;if(e==null)o=r*it,n.point(-Se,o),n.point(0,o),n.point(Se,o),n.point(Se,0),n.point(Se,-o),n.point(0,-o),n.point(-Se,-o),n.point(-Se,0),n.point(-Se,o);else if(Oe(e[0]-a[0])>Te){var i=e[0]<a[0]?Se:-Se;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function wd(e){var a=Ie(e),r=2*tt,n=a>0,o=Oe(a)>Te;function i(p,x,m,b){md(b,e,r,m,p,x)}function d(p,x){return Ie(p)*Ie(x)>a}function l(p){var x,m,b,f,w;return{lineStart:function(){f=b=!1,w=1},point:function(y,u){var v=[y,u],j,k=d(y,u),E=n?k?0:h(y,u):k?h(y+(y<0?Se:-Se),u):0;if(!x&&(f=b=k)&&p.lineStart(),k!==b&&(j=s(x,v),(!j||Sa(x,j)||Sa(v,j))&&(v[2]=1)),k!==b)w=0,k?(p.lineStart(),j=s(v,x),p.point(j[0],j[1])):(j=s(x,v),p.point(j[0],j[1],2),p.lineEnd()),x=j;else if(o&&x&&n^k){var N;!(E&m)&&(N=s(v,x,!0))&&(w=0,n?(p.lineStart(),p.point(N[0][0],N[0][1]),p.point(N[1][0],N[1][1]),p.lineEnd()):(p.point(N[1][0],N[1][1]),p.lineEnd(),p.lineStart(),p.point(N[0][0],N[0][1],3)))}k&&(!x||!Sa(x,v))&&p.point(v[0],v[1]),x=v,b=k,m=E},lineEnd:function(){b&&p.lineEnd(),x=null},clean:function(){return w|(f&&b)<<1}}}function s(p,x,m){var b=Ht(p),f=Ht(x),w=[1,0,0],y=Da(b,f),u=xa(y,y),v=y[0],j=u-v*v;if(!j)return!m&&p;var k=a*u/j,E=-a*v/j,N=Da(w,y),C=ba(w,k),T=ba(y,E);tn(C,T);var S=N,L=xa(C,S),I=xa(S,S),$=L*L-I*(xa(C,C)-1);if(!($<0)){var R=It($),M=ba(S,(-L-R)/I);if(tn(M,C),M=xn(M),!m)return M;var g=p[0],q=x[0],O=p[1],J=x[1],ae;q<g&&(ae=g,g=q,q=ae);var z=q-g,B=Oe(z-Se)<Te,D=B||z<Te;if(!B&&J<O&&(ae=O,O=J,J=ae),D?B?O+J>0^M[1]<(Oe(M[0]-g)<Te?O:J):O<=M[1]&&M[1]<=J:z>Se^(g<=M[0]&&M[0]<=q)){var V=ba(S,(-L+R)/I);return tn(V,C),[M,xn(V)]}}}function h(p,x){var m=n?e:Se-e,b=0;return p<-m?b|=1:p>m&&(b|=2),x<-m?b|=4:x>m&&(b|=8),b}return Yo(d,l,i,n?[0,-e]:[-Se,e-Se])}function yd(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],h=a[1],p=0,x=1,m=s-d,b=h-l,f;if(f=r-d,!(!m&&f>0)){if(f/=m,m<0){if(f<p)return;f<x&&(x=f)}else if(m>0){if(f>x)return;f>p&&(p=f)}if(f=o-d,!(!m&&f<0)){if(f/=m,m<0){if(f>x)return;f>p&&(p=f)}else if(m>0){if(f<p)return;f<x&&(x=f)}if(f=n-l,!(!b&&f>0)){if(f/=b,b<0){if(f<p)return;f<x&&(x=f)}else if(b>0){if(f>x)return;f>p&&(p=f)}if(f=i-l,!(!b&&f<0)){if(f/=b,b<0){if(f>x)return;f>p&&(p=f)}else if(b>0){if(f<p)return;f<x&&(x=f)}return p>0&&(e[0]=d+p*m,e[1]=l+p*b),x<1&&(a[0]=d+x*m,a[1]=l+x*b),!0}}}}}var Zt=1e9,wa=-Zt;function kd(e,a,r,n){function o(h,p){return e<=h&&h<=r&&a<=p&&p<=n}function i(h,p,x,m){var b=0,f=0;if(h==null||(b=d(h,x))!==(f=d(p,x))||s(h,p)<0^x>0)do m.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==f);else m.point(p[0],p[1])}function d(h,p){return Oe(h[0]-e)<Te?p>0?0:3:Oe(h[0]-r)<Te?p>0?2:1:Oe(h[1]-a)<Te?p>0?1:0:p>0?3:2}function l(h,p){return s(h.x,p.x)}function s(h,p){var x=d(h,1),m=d(p,1);return x!==m?x-m:x===0?p[1]-h[1]:x===1?h[0]-p[0]:x===2?h[1]-p[1]:p[0]-h[0]}return function(h){var p=h,x=Wo(),m,b,f,w,y,u,v,j,k,E,N,C={point:T,lineStart:$,lineEnd:R,polygonStart:L,polygonEnd:I};function T(g,q){o(g,q)&&p.point(g,q)}function S(){for(var g=0,q=0,O=b.length;q<O;++q)for(var J=b[q],ae=1,z=J.length,B=J[0],D,V,U=B[0],ue=B[1];ae<z;++ae)D=U,V=ue,B=J[ae],U=B[0],ue=B[1],V<=n?ue>n&&(U-D)*(n-V)>(ue-V)*(e-D)&&++g:ue<=n&&(U-D)*(n-V)<(ue-V)*(e-D)&&--g;return g}function L(){p=x,m=[],b=[],N=!0}function I(){var g=S(),q=N&&g,O=(m=Vo(m)).length;(q||O)&&(h.polygonStart(),q&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),O&&Go(m,l,g,i,h),h.polygonEnd()),p=h,m=b=f=null}function $(){C.point=M,b&&b.push(f=[]),E=!0,k=!1,v=j=NaN}function R(){m&&(M(w,y),u&&k&&x.rejoin(),m.push(x.result())),C.point=T,k&&p.lineEnd()}function M(g,q){var O=o(g,q);if(b&&f.push([g,q]),E)w=g,y=q,u=O,E=!1,O&&(p.lineStart(),p.point(g,q));else if(O&&k)p.point(g,q);else{var J=[v=Math.max(wa,Math.min(Zt,v)),j=Math.max(wa,Math.min(Zt,j))],ae=[g=Math.max(wa,Math.min(Zt,g)),q=Math.max(wa,Math.min(Zt,q))];yd(J,ae,e,a,r,n)?(k||(p.lineStart(),p.point(J[0],J[1])),p.point(ae[0],ae[1]),O||p.lineEnd(),N=!1):O&&(p.lineStart(),p.point(g,q),N=!1)}v=g,j=q,k=O}return C}}const yn=e=>e;var nn=new Rt,kn=new Rt,Qo,Ko,En,jn,kt={point:st,lineStart:st,lineEnd:st,polygonStart:function(){kt.lineStart=Ed,kt.lineEnd=Nd},polygonEnd:function(){kt.lineStart=kt.lineEnd=kt.point=st,nn.add(Oe(kn)),kn=new Rt},result:function(){var e=nn/2;return nn=new Rt,e}};function Ed(){kt.point=jd}function jd(e,a){kt.point=Jo,Qo=En=e,Ko=jn=a}function Jo(e,a){kn.add(jn*e-En*a),En=e,jn=a}function Nd(){Jo(Qo,Ko)}var Vt=1/0,Ia=Vt,da=-Vt,Pa=da,_a={point:Sd,lineStart:st,lineEnd:st,polygonStart:st,polygonEnd:st,result:function(){var e=[[Vt,Ia],[da,Pa]];return da=Pa=-(Ia=Vt=1/0),e}};function Sd(e,a){e<Vt&&(Vt=e),e>da&&(da=e),a<Ia&&(Ia=a),a>Pa&&(Pa=a)}var Nn=0,Sn=0,ea=0,Ba=0,$a=0,$t=0,Cn=0,zn=0,ta=0,Xo,Zo,ft,ht,ot={point:Ot,lineStart:Ur,lineEnd:Hr,polygonStart:function(){ot.lineStart=Ad,ot.lineEnd=qd},polygonEnd:function(){ot.point=Ot,ot.lineStart=Ur,ot.lineEnd=Hr},result:function(){var e=ta?[Cn/ta,zn/ta]:$t?[Ba/$t,$a/$t]:ea?[Nn/ea,Sn/ea]:[NaN,NaN];return Nn=Sn=ea=Ba=$a=$t=Cn=zn=ta=0,e}};function Ot(e,a){Nn+=e,Sn+=a,++ea}function Ur(){ot.point=Cd}function Cd(e,a){ot.point=zd,Ot(ft=e,ht=a)}function zd(e,a){var r=e-ft,n=a-ht,o=It(r*r+n*n);Ba+=o*(ft+e)/2,$a+=o*(ht+a)/2,$t+=o,Ot(ft=e,ht=a)}function Hr(){ot.point=Ot}function Ad(){ot.point=Td}function qd(){ei(Xo,Zo)}function Td(e,a){ot.point=ei,Ot(Xo=ft=e,Zo=ht=a)}function ei(e,a){var r=e-ft,n=a-ht,o=It(r*r+n*n);Ba+=o*(ft+e)/2,$a+=o*(ht+a)/2,$t+=o,o=ht*e-ft*a,Cn+=o*(ft+e),zn+=o*(ht+a),ta+=o*3,Ot(ft=e,ht=a)}function ti(e){this._context=e}ti.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,lt);break}}},result:st};var An=new Rt,rn,ai,ni,aa,na,pa={point:st,lineStart:function(){pa.point=Ld},lineEnd:function(){rn&&ri(ai,ni),pa.point=st},polygonStart:function(){rn=!0},polygonEnd:function(){rn=null},result:function(){var e=+An;return An=new Rt,e}};function Ld(e,a){pa.point=ri,ai=aa=e,ni=na=a}function ri(e,a){aa-=e,na-=a,An.add(It(aa*aa+na*na)),aa=e,na=a}let Vr,Ua,Wr,Gr;class Yr{constructor(a){this._append=a==null?oi:Fd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Wr||this._append!==Ua){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Wr=n,Ua=this._append,Gr=this._,this._=o}this._+=Gr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function oi(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Fd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return oi;if(a!==Vr){const r=10**a;Vr=a,Ua=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ua}function Rd(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Bt(l,o(i))),i.result()}return d.area=function(l){return Bt(l,o(kt)),kt.result()},d.measure=function(l){return Bt(l,o(pa)),pa.result()},d.bounds=function(l){return Bt(l,o(_a)),_a.result()},d.centroid=function(l){return Bt(l,o(ot)),ot.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,yn):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new Yr(r)):new ti(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new Yr(r)),d},d.projection(e).digits(r).context(a)}function Bn(e){return function(a){var r=new qn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function qn(){}qn.prototype={constructor:qn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function $n(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Bt(r,e.stream(_a)),a(_a.result()),n!=null&&e.clipExtent(n),e}function ii(e,a,r){return $n(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Od(e,a,r){return ii(e,[[0,0],a],r)}function Md(e,a,r){return $n(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Dd(e,a,r){return $n(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var Qr=16,Id=Ie(30*tt);function Kr(e,a){return+a?_d(e,a):Pd(e)}function Pd(e){return Bn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function _d(e,a){function r(n,o,i,d,l,s,h,p,x,m,b,f,w,y){var u=h-n,v=p-o,j=u*u+v*v;if(j>4*a&&w--){var k=d+m,E=l+b,N=s+f,C=It(k*k+E*E+N*N),T=la(N/=C),S=Oe(Oe(N)-1)<Te||Oe(i-x)<Te?(i+x)/2:sa(E,k),L=e(S,T),I=L[0],$=L[1],R=I-n,M=$-o,g=v*R-u*M;(g*g/j>a||Oe((u*R+v*M)/j-.5)>.3||d*m+l*b+s*f<Id)&&(r(n,o,i,d,l,s,I,$,S,k/=C,E/=C,N,w,y),y.point(I,$),r(I,$,S,k,E,N,h,p,x,m,b,f,w,y))}}return function(n){var o,i,d,l,s,h,p,x,m,b,f,w,y={point:u,lineStart:v,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=E},polygonEnd:function(){n.polygonEnd(),y.lineStart=v}};function u(T,S){T=e(T,S),n.point(T[0],T[1])}function v(){x=NaN,y.point=j,n.lineStart()}function j(T,S){var L=Ht([T,S]),I=e(T,S);r(x,m,p,b,f,w,x=I[0],m=I[1],p=T,b=L[0],f=L[1],w=L[2],Qr,n),n.point(x,m)}function k(){y.point=u,n.lineEnd()}function E(){v(),y.point=N,y.lineEnd=C}function N(T,S){j(o=T,S),i=x,d=m,l=b,s=f,h=w,y.point=j}function C(){r(x,m,p,b,f,w,i,d,o,l,s,h,Qr,n),y.lineEnd=k,k()}return y}}var Bd=Bn({point:function(e,a){this.stream.point(e*tt,a*tt)}});function $d(e){return Bn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ud(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function Jr(e,a,r,n,o,i){if(!i)return Ud(e,a,r,n,o);var d=Ie(i),l=Pe(i),s=d*e,h=l*e,p=d/e,x=l/e,m=(l*r-d*a)/e,b=(l*a+d*r)/e;function f(w,y){return w*=n,y*=o,[s*w-h*y+a,r-h*w-s*y]}return f.invert=function(w,y){return[n*(p*w-x*y+m),o*(b-x*w-p*y)]},f}function Hd(e){return Vd(function(){return e})()}function Vd(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,h=0,p,x=0,m=1,b=1,f=null,w=$r,y=null,u,v,j,k=yn,E=.5,N,C,T,S,L;function I(g){return T(g[0]*tt,g[1]*tt)}function $(g){return g=T.invert(g[0],g[1]),g&&[g[0]*wt,g[1]*wt]}I.stream=function(g){return S&&L===g?S:S=Bd($d(p)(w(N(k(L=g)))))},I.preclip=function(g){return arguments.length?(w=g,f=void 0,M()):w},I.postclip=function(g){return arguments.length?(k=g,y=u=v=j=null,M()):k},I.clipAngle=function(g){return arguments.length?(w=+g?wd(f=g*tt):(f=null,$r),M()):f*wt},I.clipExtent=function(g){return arguments.length?(k=g==null?(y=u=v=j=null,yn):kd(y=+g[0][0],u=+g[0][1],v=+g[1][0],j=+g[1][1]),M()):y==null?null:[[y,u],[v,j]]},I.scale=function(g){return arguments.length?(r=+g,R()):r},I.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],R()):[n,o]},I.center=function(g){return arguments.length?(i=g[0]%360*tt,d=g[1]%360*tt,R()):[i*wt,d*wt]},I.rotate=function(g){return arguments.length?(l=g[0]%360*tt,s=g[1]%360*tt,h=g.length>2?g[2]%360*tt:0,R()):[l*wt,s*wt,h*wt]},I.angle=function(g){return arguments.length?(x=g%360*tt,R()):x*wt},I.reflectX=function(g){return arguments.length?(m=g?-1:1,R()):m<0},I.reflectY=function(g){return arguments.length?(b=g?-1:1,R()):b<0},I.precision=function(g){return arguments.length?(N=Kr(C,E=g*g),M()):It(E)},I.fitExtent=function(g,q){return ii(I,g,q)},I.fitSize=function(g,q){return Od(I,g,q)},I.fitWidth=function(g,q){return Md(I,g,q)},I.fitHeight=function(g,q){return Dd(I,g,q)};function R(){var g=Jr(r,0,0,m,b,x).apply(null,a(i,d)),q=Jr(r,n-g[0],o-g[1],m,b,x);return p=ud(l,s,h),C=vn(a,q),T=vn(p,C),N=Kr(C,E),M()}function M(){return S=L=null,I}return function(){return a=e.apply(this,arguments),I.invert=a.invert&&$,R()}}function si(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}si.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Oe(o)>Te&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Wd(){return Hd(si).scale(175.295)}function Gd(e){return e}function Yd(e){if(e==null)return Gd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var h=2,p=l.length,x=new Array(p);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+d;h<p;)x[h]=l[h],++h;return x}}function Qd(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Kd(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Xr(e,r)})}:Xr(e,a)}function Xr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Jd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Jd(e,a){var r=Yd(e.transform),n=e.arcs;function o(p,x){x.length&&x.pop();for(var m=n[p<0?~p:p],b=0,f=m.length;b<f;++b)x.push(r(m[b],b));p<0&&Qd(x,f)}function i(p){return r(p)}function d(p){for(var x=[],m=0,b=p.length;m<b;++m)o(p[m],x);return x.length<2&&x.push(x[0]),x}function l(p){for(var x=d(p);x.length<4;)x.push(x[0]);return x}function s(p){return p.map(l)}function h(p){var x=p.type,m;switch(x){case"GeometryCollection":return{type:x,geometries:p.geometries.map(h)};case"Point":m=i(p.coordinates);break;case"MultiPoint":m=p.coordinates.map(i);break;case"LineString":m=d(p.arcs);break;case"MultiLineString":m=p.arcs.map(d);break;case"Polygon":m=s(p.arcs);break;case"MultiPolygon":m=p.arcs.map(s);break;default:return null}return{type:x,coordinates:m}}return h(a)}const li={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Xd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Zd(e,a,r){const n=li[e];if(!n||!n.length)return-1;const o=Xd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let ya=null;function ep(){return ya||(ya=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Kd(r,n),i=Wd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Rd(i),l=(o.features||[]).filter(p=>{var x;return(((x=p.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(p=>{var b;const x=((b=p.properties)==null?void 0:b.name)||"",m=d(p)||"";return m?{i2:ss(x)||null,n:x,d:m}:null}).filter(p=>!!p);if(!l.length)return null;const s={};for(const[p,x]of Object.entries(ls)){const m=i(x);m&&(s[p]={x:m[0],y:m[1]})}const h={};for(const[p,x]of Object.entries(li)){const m=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,f])=>({x:b,y:f}));m.length&&(h[p]=m)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:h}}catch{return null}})(),ya)}function tp(e){const[a,r]=c.useState(null);return c.useEffect(()=>{if(!e||a)return;let n=!1;return ep().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const ap="8 40 984 210",np={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Zr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function eo(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function rp(e,a){const[r,n]=c.useState(1);return c.useEffect(()=>{let o=!0,i=0;const d=()=>{var h;if(!o)return;const s=(h=e.current)==null?void 0:h.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function to({msgs:e}){const[a,r]=c.useState(0);c.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function op(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:h,dossiers:p,source:x}=Q(),m=h.loading&&!p.length,b=c.useRef(null),f=c.useRef(null),w=tp(e.continent==="monde"),y=e.continent==="monde"?w:Rn.find(g=>g.key===e.continent)||null,u=rp(b,e.continent+":"+e.mapFolded+":"+!!y),[v,j]=c.useState(new Map),[k,E]=c.useState(null);c.useEffect(()=>{const g=b.current;if(!g)return;const q=new Map;g.querySelectorAll("path[data-i2]").forEach(O=>{const J=O.dataset.i2;if(J)try{const ae=O.getBBox();ae.width>0&&q.set(J,{x:ae.x,y:ae.y,w:ae.width,h:ae.height})}catch{}}),j(q)},[e.continent,u,y]);const N=c.useMemo(()=>r.filter(g=>g.cc),[r]),C=c.useMemo(()=>{const g=new Map;return N.forEach(q=>g.set(q.cc,(g.get(q.cc)||0)+1)),g},[N]),T=e.continent==="monde"&&w?w.anchors:null,S=e.continent==="monde"&&w?w.metros:null,L=c.useMemo(()=>N.map(g=>{const q=eo(g.name||g.id||""),O=eo((g.id||g.name||"")+"·y");if(T&&g.cc){const D=S?S[g.cc]:void 0;if(D&&D.length){const U=Zd(g.cc,g.city,q);if(U>=0&&D[U])return{d:g,x:D[U].x+(q-.5)*5,y:D[U].y+(O-.5)*5}}const V=T[g.cc];if(V)return{d:g,x:V.x+(q-.5)*10,y:V.y+(O-.5)*10}}const J=g.cc?v.get(g.cc):void 0;if(!J)return null;const ae=np[`${e.continent}:${g.cc||""}`];if(ae)return{d:g,x:J.x+J.w*(ae.fx+(q-.5)*ae.sx),y:J.y+J.h*(ae.fy+(O-.5)*ae.sy)};const z=(q-.5)*Math.min(J.w*.55,60),B=(O-.5)*Math.min(J.h*.55,60);return{d:g,x:J.x+J.w/2+z,y:J.y+J.h/2+B}}).filter(g=>!!g),[N,v,T,S,e.continent]),I=g=>u>0?g/u:g,$=c.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:Zr[g],fr:s.plabels[g],en:s.plabels[g],n:r.filter(q=>q.kind==="target"&&Le(q)===g).length})).filter(g=>g.n>0):nr.map((g,q)=>({...g,n:r.filter(O=>rr(O)===q).length})),[r,n,s.plabels]),R=i?d.get(i):null,M=R?L.find(g=>g.d.id===R.id):null;return y?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),"data-cont":e.continent,ref:f,children:[m&&t.jsx(to,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?ap:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?y.fr:y.en,onMouseLeave:()=>{E(null),o(null)},children:[t.jsx("g",{children:y.countries.map((g,q)=>t.jsx("g",{className:"ct"+(g.i2&&C.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},q))}),t.jsx("g",{children:L.map(g=>{const q=nr[rr(g.d)],O=!!$e(g.d),J=g.d.kind==="target",ae=n&&J?Zr[Le(g.d)]:q.c,z=!n&&Ge(g.d);return t.jsxs("g",{className:"co"+(z?" done":""),onMouseEnter:()=>{var V,U;const B=(V=f.current)==null?void 0:V.getBoundingClientRect(),D=(U=b.current)==null?void 0:U.createSVGPoint();if(D&&b.current&&B){D.x=g.x,D.y=g.y;const ue=D.matrixTransform(b.current.getScreenCTM());E({x:ue.x-B.left,y:ue.y-B.top,label:g.d.name+" · "+(Yt(g.d.cc,l)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{E(null),o(null)},onClick:()=>{var V;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const B=(V=b.current)==null?void 0:V.createSVGPoint();let D=null;if(B&&b.current){B.x=g.x,B.y=g.y;const U=B.matrixTransform(b.current.getScreenCTM());D={x:U.x,y:U.y}}a({type:"popup",id:g.d.id,anchor:D})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:I(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:I(q.px),fill:ae,stroke:O?"#E5484D":"#ffffff",strokeWidth:I(O?2.2:1.3)})]},g.d.id||g.d.name)})}),M&&t.jsx("circle",{className:"ring on",cx:M.x,cy:M.y,r:I(13),fill:"none",stroke:"#16233A",strokeWidth:I(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:$.map((g,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),l==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},q))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),"data-cont":e.continent,ref:f,children:t.jsx(to,{msgs:s.loadMsgs})})}function ip(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function di({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=Q(),s=a.filters,[h,p]=c.useState(!1),[x,m]=c.useState(!1),b=c.useRef(null),f=c.useRef(null),w=c.useMemo(()=>a.continent==="monde"?n:n.filter(M=>M.continent===a.continent),[n,a.continent]),y=M=>w.filter(g=>M!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Ra(g,s,i,M==="country"?void 0:M)),u=M=>!i||M.kind!=="op",v=c.useMemo(()=>{const M=y("win").filter(u),g=q=>M.filter(O=>(O.date?Math.max(0,Math.floor((Date.now()-Date.parse(O.date))/864e5)):9999)<=q).length;return[g(0),g(7),g(30),M.length]},[w,s,i]),j=c.useMemo(()=>s.day?y("win").filter(u).filter(M=>(M.date||"").slice(0,10)===s.day).length:0,[w,s,i]),k=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,E=k+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);c.useEffect(()=>{a.openFacet&&p(!1)},[a.openFacet]),c.useEffect(()=>{if(!h&&!x)return;const M=q=>{var J,ae;const O=q.target;h&&!((J=b.current)!=null&&J.contains(O))&&p(!1),x&&!((ae=f.current)!=null&&ae.contains(O))&&m(!1)},g=q=>{q.key==="Escape"&&(p(!1),m(!1))};return document.addEventListener("mousedown",M),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("keydown",g)}},[h,x]);const N=(M,g,q,O="fbtn")=>t.jsxs("button",{type:"button",className:O,"aria-expanded":a.openFacet===M,onClick:()=>r({type:"openFacet",facet:M}),children:[t.jsx("span",{className:"fl",children:g}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},M),C=["1","7","30","all"],T=Math.max(0,C.indexOf(s.win||"all")),S=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(ip(s.day,l))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:f,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>m(M=>!M),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:v[T]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((M,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===M,onClick:()=>{r({type:"filters",patch:{win:M}}),m(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:v[g]})]},M))})]}):t.jsx("div",{className:"seg",children:C.map((M,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===M,onClick:()=>r({type:"filters",patch:{win:M}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:v[g]})]},M))}),L=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:M=>r({type:"filters",patch:{search:M.target.value}})})]}),I=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,s.sector.length),(n.some(M=>!!M.market)||s.market.length>0)&&N("mar",o.fMarket,s.market.length),N("pay",o.fCountry,s.country.length),N("det",o.fEngine,s.engine.length),N("sta",o.fStage,s.stage.length),i&&N("crib",o.fVerdict,s.crible.length),i&&N("ang","Angle",s.angle.length),i&&N("mem","Mémo",s.memoLevel.length)]}),$=(M=!1)=>t.jsxs("div",{className:"frow2",children:[E>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(E)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),M&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),R=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{p(M=>!M),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:I})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:S}),t.jsxs("div",{className:"fstrip-b",children:[L,R,$(!1)]})]}),a.openFacet&&t.jsx(ao,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[S,L,I,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx(ao,{poolFor:y})]})}function ao({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Q(),l=a.filters,s=a.openFacet,{title:h,cols:p,options:x}=c.useMemo(()=>{if(s==="sig"){const y=e("signal").filter(j=>$e(j)),u=new Map;y.forEach(j=>{const k=j.engine||"";u.set(k,(u.get(k)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:y.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...mn([...u.keys()],o).map(j=>({v:j,label:Ft(j)+" "+at(j,o),n:u.get(j)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="crib"){const y=e("crible").filter(v=>!i||bo(v,a.ptab,d.favIds)),u=new Map;return y.forEach(v=>{const j=vo(v);j&&j!=="NEW"&&u.set(j,(u.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...u.entries()].sort((v,j)=>(or[v[0]]??9)-(or[j[0]]??9)||j[1]-v[1]).map(([v,j])=>({v,label:'<span class="fdot" style="background:'+(ds[v]||"#94A3B8")+'"></span>'+v,n:j,html:!0,on:l.crible.includes(v)}))}}if(s==="sec"){const y=e("sector"),u=new Map;return y.forEach(v=>{v.sector&&u.set(v.sector,(u.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...u.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:l.sector.includes(v)}))}}if(s==="mar"){const y=e("market"),u=new Map;return y.forEach(v=>{v.market&&u.set(v.market,(u.get(v.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...u.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:l.market.includes(v)}))}}if(s==="pay"){const y=e("country"),u=new Map;return y.forEach(v=>{v.cc&&u.set(v.cc,(u.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...u.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:Yt(v,o)||v,n:j,html:!1,on:l.country.includes(v)}))}}if(s==="det"){const y=e("engine"),u=new Map;return y.forEach(v=>{v.engine&&u.set(v.engine,(u.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:mn([...u.keys()],o).map(v=>({v,label:Ft(v)+" "+at(v,o)+' <span style="color:var(--dim);font-size:10px">· '+ps(cs(v),o)+"</span>",n:u.get(v)||0,html:!0,on:l.engine.includes(v)}))}}if(s==="ang"){const y=e("angle"),u=new Map;return y.forEach(v=>{v.angle&&u.set(v.angle,(u.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...u.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v.replace(/[_-]+/g," "),n:j,html:!1,on:l.angle.includes(v)}))}}if(s==="mem"){const y=e("memoLevel"),u=new Map;y.forEach(j=>{if(j.kind==="target"){const k=Fn(j);u.set(k,(u.get(k)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:v[j],n:u.get(j)||0,html:!1,on:l.memoLevel.includes(j)}))}}const f=e("stage"),w=new Map;return f.forEach(y=>{y.stage&&w.set(y.stage,(w.get(y.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((y,u)=>u[1]-y[1]).map(([y,u])=>({v:y,label:y,n:u,html:!1,on:l.stage.includes(y)}))}},[s,a,o]),m=f=>{if(s==="sig"){if(f==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const y=l.signalEngines.includes(f)?l.signalEngines.filter(u=>u!==f):[...l.signalEngines,f];r({type:"filters",patch:{signalOnly:!0,signalEngines:y}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(f)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:f})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:h}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(f=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":f.on,onClick:()=>m(f.v),children:[t.jsx("span",{className:"bx"}),f.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:f.label}}):t.jsx("span",{className:"l",children:f.label}),t.jsx("span",{className:"n",children:f.n})]},f.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function pi({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=Q(),s=c.useMemo(()=>{const b={};return r.forEach(f=>{Ra(f,n.filters,i)&&(b.monde=(b.monde||0)+1,f.continent&&(b[f.continent]=(b[f.continent]||0)+1))}),b},[r,n.filters,i]),[h,p]=c.useState(!1),x=c.useRef(null);c.useEffect(()=>{if(!h)return;const b=w=>{var y;(y=x.current)!=null&&y.contains(w.target)||p(!1)},f=w=>{w.key==="Escape"&&p(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",f),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",f)}},[h]);const m=b=>{const f=Rn.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?f.fr:f.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>p(b=>!b),children:[m(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:ir.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),p(!1)},children:[m(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[ir.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[m(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]})]})}function Tn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function ci(e){return"atl2:evalq:"+(e||"anon")}function sp(e,a){const r=ci(e),n=Tn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function lp(){const{t:e,lang:a,data:r,dossiers:n}=Q(),o=r.session.token||"",i=ci(o),[d,l]=c.useState(()=>Tn(i)),s=c.useRef(!1),[h,p]=c.useState(!1);c.useEffect(()=>{try{const z=d.slice(0,30).map(({descBusy:B,evalBusy:D,...V})=>V);localStorage.setItem(i,JSON.stringify(z)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[d,i]),c.useEffect(()=>{const z=()=>{if(s.current)return;const B=Tn(i);l(D=>JSON.stringify(D.map(({descBusy:V,evalBusy:U,...ue})=>ue))===JSON.stringify(B)?D:B)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[i]);const[x,m]=c.useState([]),[b,f]=c.useState(""),[w,y]=c.useState(!1),[u,v]=c.useState(!1),[j,k]=c.useState(""),E=c.useCallback((z,B)=>l(D=>D.map((V,U)=>U===z?{...V,...B}:V)),[]),N=c.useCallback((z,B)=>{const D=B.trim();D&&(E(z,{name:D,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),On(D).then(V=>{const U=V.candidates||[];V.website?E(z,{site:V.website,status:"ready"}):U.length===1?E(z,{site:U[0].url,status:"ready"}):U.length>1?E(z,{status:"pick",candidates:U.slice(0,6)}):E(z,{status:"ready"})}).catch(()=>E(z,{status:"ready"})))},[E]),C=c.useCallback((z,B,D)=>{E(z,{descBusy:!0}),yo(o,B,D).then(V=>{if(V.quota){p(!0),E(z,{descBusy:!1,descDone:!0});return}const U=V.blocs||{},ue=(U.synthese||U.value_prop||U.produit||U.modele||"").trim();E(z,{descBusy:!1,descDone:!0,desc:ue})}).catch(()=>E(z,{descBusy:!1,descDone:!0}))},[E,o]);c.useEffect(()=>{const z=d.findIndex(D=>D.auto&&D.name.trim()&&D.status==="");if(z>=0){N(z,d[z].name);return}if(h)return;const B=d.findIndex(D=>D.status==="ready"&&D.site&&!D.descDone&&!D.descBusy);B>=0&&C(B,d[B].name,d[B].site)},[d,N,C,h]);const[T,S]=c.useState(!1),L=c.useCallback(async(z,B)=>{E(z,{evalBusy:!0});const D=(B.site||B.name).trim(),V=await ko(o,D,"atelier2");return V.verdict==="quota"?(E(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:V.reason||"",remaining:0}})),!1):(E(z,{evalBusy:!1,status:V.verdict==="kept"?"kept":"out",reason:V.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:V.company||B.name,verdict:V.verdict,reason:V.reason||"",remaining:V.remaining??null}})),!0)},[E,o]),I=async()=>{if(T)return;const z=d.map((B,D)=>({r:B,i:D})).filter(({r:B})=>B.name.trim()&&B.status!=="kept"&&B.status!=="out"&&B.status!=="resolving");if(z.length){S(!0);for(const{r:B,i:D}of z)if(!await L(D,B))break;S(!1)}},$=c.useMemo(()=>{const z=new Set,B=[];return d.filter(D=>D.status==="kept").forEach(D=>{const V=D.name.trim().toLowerCase();V&&!z.has(V)&&(z.add(V),B.push(D.name.trim()))}),n.filter(D=>Le(D)>=1&&Le(D)<=4&&(D.website||D.domain)).forEach(D=>{const V=(D.name||"").trim().toLowerCase();V&&!z.has(V)&&(z.add(V),B.push((D.name||"").trim()))}),B},[d,n]),R=c.useMemo(()=>{const z=new Set;return n.forEach(B=>{const D=(B.name||"").trim().toLowerCase();D&&z.add(D)}),d.forEach(B=>{const D=B.name.trim().toLowerCase();D&&z.add(D)}),z},[n,d]),M=async()=>{if(b||!$.length)return;v(!1);const z=[];for(const B of $.slice(0,2)){f(B);const D=await Eo(o,B);if(D){if(D.verdict==="quota"){y(!0);break}(D.results||[]).forEach(V=>{const U=(V.company||"").trim().toLowerCase();!U||R.has(U)||z.some(ue=>ue.name.toLowerCase()===U)||z.push({name:(V.company||"").trim(),verdict:V.verdict||"",reason:V.reason,from:B})})}}f(""),v(!0),m(B=>[...z,...B].slice(0,24))},g=async(z,B)=>{if(b)return;v(!1),f(z==="thesis"?e.pxThesis:B);const D=await us(o,z,B,6);if(f(""),v(!0),!D)return;if(D.verdict==="quota"){y(!0);return}const V=[];(D.results||[]).forEach(U=>{const ue=(U.company||"").trim().toLowerCase();!ue||R.has(ue)||V.some(te=>te.name.toLowerCase()===ue)||V.push({name:(U.company||"").trim(),verdict:U.verdict||"",reason:U.reason,from:z==="thesis"?e.pxThesis:B})}),m(U=>[...V,...U].slice(0,24))},q=()=>{const z=j.trim();z.length<3||g(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},O=z=>{l(B=>[...B,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),m(B=>B.filter(D=>D.name!==z.name))},J=d.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,ae=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),d.map((z,B)=>t.jsxs("div",{className:"eq-item"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:D=>{const V=D.target.value.split(`
`).map(U=>U.trim()).filter(Boolean);V.length>1?l(U=>{const ue=[...U];return ue.splice(B,1,...V.map(te=>({name:te,site:"",status:"",auto:!0}))),ue.slice(0,30)}):E(B,{name:D.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&N(B,z.name)},onKeyDown:D=>{D.key==="Enter"&&N(B,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:D=>{const V=D.target.value;V&&E(B,{site:V,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(z.candidates||[]).map(D=>t.jsx("option",{value:D.url,children:(D.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},D.url))]}),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?h?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!ae(z)||T,onClick:()=>{L(B,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>l(D=>D.filter((V,U)=>U!==B)),children:"×"})]}),(z.name.trim()||z.site)&&z.status!=="kept"&&z.status!=="out"&&t.jsx(Va,{lang:a,variant:"row",storeKey:(z.site||z.name).trim()})]},B)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>l(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{g("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:j,placeholder:e.pxPlace,onChange:z=>k(z.target.value),onKeyDown:z=>{z.key==="Enter"&&q()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||j.trim().length<3,onClick:q,children:e.pxGoFree}),!!$.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{M()},children:b&&b!==e.pxThesis&&b!==j?e.sgBusy(b):e.sgGo}),!!$.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom($[0],$.length)}),w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),u&&!x.length&&!w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),x.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>O(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>l(z=>z.filter(B=>B.status!=="kept"&&B.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(T?" loading":""),style:{justifyContent:"center"},disabled:T||!J,onClick:()=>{I()},children:[t.jsx("span",{className:"fill"}),T?e.eqRunning:e.eqGo(J)]})]})]})]})}const dp={deals:"ma-deals",news:"veille"};function no(e){return(e.url||e.title||"").trim()}function pp(e){const a=(e.title||"").replace(/\s+/g," ").trim();if(!a)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const r=/^(.{2,72}?)[:–—|]/.exec(a);return r?r[1].trim():(a.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||a).slice(0,72).trim()}function cp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i}=Q(),[d,l]=c.useState(null),[s,h]=c.useState({deals:[],news:[]}),[p,x]=c.useState({deals:!1,news:!1}),[m,b]=c.useState(null),[f,w]=c.useState(""),y=c.useRef(!1),u=c.useCallback(async S=>{if(!o)return[];if(p[S])return s[S];b(S),w("");const L=await ms(dp[S],o,n);return b(null),!L.ok&&L.error?(w(L.error),[]):(h(I=>({...I,[S]:L.items})),x(I=>({...I,[S]:!0})),L.items)},[o,n,p,s]);c.useEffect(()=>{d&&u(d)},[d,u]);const v=c.useCallback(S=>s[S].map(no).filter(Boolean),[s]),j=c.useMemo(()=>{var I,$;if(!o)return{deals:[],news:[]};const S={deals:v("deals"),news:v("news")},L=Fo("feed:"+o,S);return{deals:((I=L.deals)==null?void 0:I.noms)||[],news:(($=L.news)==null?void 0:$.noms)||[]}},[o,v]),k=c.useRef(null);c.useEffect(()=>{k.current&&!d&&o&&Ro("feed:"+o,{deals:v("deals"),news:v("news")}),k.current=d},[d,o,v]);const E=S=>{const L=S.map(pp).filter(Boolean);L.length&&(a(L),l(null))},N=(S,L)=>{const I=(S.url||"").trim();if(L==="news"&&I&&/^https?:\/\//i.test(I)){window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:I}})),l(null);return}E([S])},C=async S=>{if(d===S){l(null);return}if(y.current)return;y.current=!0;const L=await u(S);if(y.current=!1,S==="deals"&&L.length){E(L);return}l(S)},T=S=>{const L=s[S],I=new Set(j[S].map($=>$.toLowerCase()));return t.jsxs("div",{className:"dfpane"+(d===S?" on":""),hidden:d!==S,children:[t.jsx("p",{className:"dfh",children:S==="deals"?r.feedDealsH:r.feedNewsH}),m===S&&t.jsx("p",{className:"dfload",children:n==="en"?"Loading…":"Chargement…"}),d===S&&!!f&&t.jsx("p",{className:"dferr",children:f}),p[S]&&!L.length&&!m&&t.jsx("p",{className:"dfempty",children:S==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!L.length&&t.jsx("ul",{className:"dflist",children:L.map(($,R)=>{const M=no($),g=I.has(M.toLowerCase()),q=($.url||"").trim();return t.jsxs("li",{className:g?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:$.title||q}),t.jsx("span",{children:[$.source,$.sector_fr,($.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[q&&t.jsx("a",{href:q,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>N($,S),children:S==="deals"?r.feedToEval:r.feedToExtract})]})]},M||R)})})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(S=>{const L=j[S].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(S==="deals"?"ddeals":"dnews")+(d===S?" on":""),onClick:()=>{C(S)},children:[S==="deals"?r.feedDeals:r.feedNews,L>0&&t.jsx("em",{title:r.feedHint,children:r.feedNew(L)})]},S)}),d&&T(d)]})}function ui(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function up(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function ro({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=Q();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function mi({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Q(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(ro,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(ro,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function mp({card:e,onEvaluate:a,onAddAll:r}){var l,s,h;const{t:n}=Q(),o=[e.industry,...e.market_tags||[],e.author].map(p=>(p||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(p=>p&&p.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(p=>t.jsx("span",{children:p},p))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ui(e.summary_md||"").map((p,x)=>t.jsx("p",{children:p},x))})]}),t.jsx(mi,{card:e,onEvaluate:a,onAddAll:r}),(((s=e.prospective)==null?void 0:s.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(p=>t.jsx("li",{children:p},p))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(p=>t.jsx("a",{href:p.url,target:"_blank",rel:"noopener noreferrer",children:p.label||p.url},p.url))})]})]})}function fp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function hp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Q(),l=o,[s,h]=c.useState(null),[p,x]=c.useState(null),[m,b]=c.useState(null),[f,w]=c.useState(!1);c.useEffect(()=>{let u=!0;return(async()=>{const v=await jo({email:d,cbToken:l});u&&h(v)})(),()=>{u=!1}},[d,l,n]);const y=u=>{x(u),b(null),w(!0),(async()=>{const v=await fs(u.id);b(v),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[p?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),p&&t.jsx("span",{className:"ti",children:p.title}),!p&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!p&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(u=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(u),children:[t.jsx("span",{className:"ti",children:u.title}),t.jsxs("span",{className:"me",children:[fp(u.created_at),u.industry?` · ${u.industry}`:"",u.author?` · ${u.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(u.cited_n||0,u.evaluate_n||0)}),t.jsx("span",{className:"st"+(u.published?" on":""),children:u.published?i.rsPub:i.rsPriv})]},u.id))]}),p&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[p.source_url&&t.jsx("a",{href:p.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),p.published&&p.page_url&&t.jsx("a",{href:p.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(p.published?" on":""),children:p.published?i.rsPub:i.rsPriv})]}),f&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!f&&!m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!f&&m&&t.jsx(mp,{card:m,onEvaluate:a,onAddAll:r})]})]})}const Ca=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ra(e){return/^https?:\/\//i.test((e||"").trim())}function ct(e){const a=(e||"").trim();return a?ra(a)?a:Ca.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function gp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function xp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:h,caps:p,data:x,canWrite:m,source:b,dossiers:f,doAnalyse:w,liveMemos:y,pipe:u}=Q(),v=r==="client",j=c.useMemo(()=>n||(b!=="default"?hs():""),[n,b]),[k,E]=c.useState(""),[N,C]=c.useState(!1),[T,S]=c.useState(""),[L,I]=c.useState(""),[$,R]=c.useState(""),[M,g]=c.useState(!1),[q,O]=c.useState(!1),[J,ae]=c.useState([]);c.useEffect(()=>{const P=ee=>{const K=ee.detail;K&&ae(ce=>[K,...ce].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[z,B]=c.useState(!1),[D,V]=c.useState(!1),[U,ue]=c.useState(!1),te=c.useRef(!1),[de,xe]=c.useState(""),[me,we]=c.useState(""),[be,Ne]=c.useState(!1),[Re,ne]=c.useState(!1),[ke,ve]=c.useState(0),[oe,_]=c.useState(""),[W,Z]=c.useState(null),[le,pe]=c.useState(null),[re,ie]=c.useState(!1),[fe,ye]=c.useState(null),[Ce,je]=c.useState(0),Ee=c.useRef(!1),gt=k.trim()?Ca.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;c.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),ee=(P.get("rs")||"").trim(),K=(P.get("rstext")||"").trim();ee&&/^https?:\/\//i.test(ee)&&xe(ee),K&&we(K),(ee&&/^https?:\/\//i.test(ee)||K)&&B(!0)},[]),c.useEffect(()=>{const P=ee=>{const K=ee.detail||{},ce=String(K.url||"").trim(),ze=String(K.text||"").trim();ce&&/^https?:\/\//i.test(ce)&&xe(ce),ze&&we(ze),(ce&&/^https?:\/\//i.test(ce)||ze)&&(B(!0),E(""),S(""),Ne(!0),window.setTimeout(()=>Ne(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),c.useEffect(()=>{const P=ee=>{const K=ee.detail||{},ce=String(K.name||"").trim();if(!ce)return;B(!1),E(ce),S(ce);const ze=ct(String(K.website||K.domain||""));I(ze),R(ct(String(K.url||""))),g(!ze),C(!0),window.setTimeout(()=>C(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),c.useEffect(()=>{const P=(T||"").trim();if(!P||z||L){(L||!P||z)&&g(!1);return}const ee=Ue(P),K=f.find(Fe=>Ue(Fe.name)===ee)||f.find(Fe=>{const Ae=Ue(Fe.name);return Ae.length>=3&&(ee.includes(Ae)||Ae.includes(ee))}),ce=ct((K==null?void 0:K.website)||"")||ct((K==null?void 0:K.domain)||""),ze=ct((K==null?void 0:K.url)||"");if(ze&&R(Fe=>Fe||ze),ce){I(ce),g(!1);return}let he=!0;return g(!0),On(P).then(Fe=>{var Je,vt;if(!he)return;const Ae=ct(Fe.website||"")||ct(((vt=(Je=Fe.candidates)==null?void 0:Je[0])==null?void 0:vt.url)||"");Ae&&I(Ae)}).catch(()=>{}).finally(()=>{he&&g(!1)}),()=>{he=!1}},[T,z,L,f]),c.useEffect(()=>{const P=ee=>{var ce;const K=String(((ce=ee.detail)==null?void 0:ce.url)||"").trim();ra(K)&&window.open(K,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),c.useEffect(()=>{if(te.current===z)return;te.current=z,ue(!0);const P=window.setTimeout(()=>ue(!1),560);return()=>window.clearTimeout(P)},[z]),c.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ee=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!ee)return;const K=ee.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,ce=()=>{const he=parseFloat(window.getComputedStyle(P).top)||0,Fe=P.getBoundingClientRect().top<=he+1;P.classList.toggle("is-stuck",Fe);const Ae=Math.round(P.getBoundingClientRect().height);ee.style.setProperty("--demand-h",`${Ae}px`);const Je=window.matchMedia("(min-width: 861px)").matches;K&&Je?ee.style.setProperty("--pp-live-h",`${Math.round(K.getBoundingClientRect().height)}px`):ee.classList.contains("cibles")&&ee.style.setProperty("--pp-live-h","0px")};ce();const ze=new ResizeObserver(ce);return ze.observe(P),K&&ze.observe(K),window.addEventListener("scroll",ce,!0),window.addEventListener("resize",ce),()=>{ze.disconnect(),window.removeEventListener("scroll",ce,!0),window.removeEventListener("resize",ce)}},[b,N,be,q,z,U,M]),c.useEffect(()=>{if(!m&&!j){ye(null);return}let P=!0;return(async()=>{const ee=await jo({email:o,cbToken:j});P&&ye(ee.length)})(),()=>{P=!1}},[m,j,o,Ce]);const xt=J.length?J:h,Me=x.credits,dt=c.useCallback(P=>{sp(n,P)&&(O(!1),l({type:"ptab",tab:0}),requestAnimationFrame(()=>{const ee=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!ee)return;const K=window.scrollY+ee.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,K),behavior:"smooth"})}))},[n,l]);c.useEffect(()=>{if(!Re)return;ve(0);const P=window.setInterval(()=>ve(ee=>ee+1),1e3);return()=>window.clearInterval(P)},[Re]);const nt=c.useMemo(()=>{const P=k.trim().toLowerCase();return!P||!u?null:f.find(ee=>Ue(ee.name)===P&&Le(ee)===1)||null},[k,f,u]),At=()=>{const P=k.trim();if(P){if(nt){w(nt);return}i(null,P),v&&E("")}},rt=async()=>{var K,ce,ze;if(Ee.current)return;const P=de.trim().replace(/\s+/g,""),ee=me.trim();if(!P&&!ee){_(e.rsNeed);return}if(!v&&!j){i(null,P||ee.slice(0,80));return}Ee.current=!0,_(""),Z(null),pe(null),ne(!0);try{const he=await xs({url:P,text:ee,email:o,cbToken:j});if(ne(!1),!he||he.status!=="success"){_((he==null?void 0:he.message)||"Erreur");return}Z(he),B(!1),dt((((K=he.prospective)==null?void 0:K.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),pe({state:"pending"});const Fe=await bs(he,{email:o,cbToken:j});pe(Fe.ok?{state:"ok",scopeLabel:((ce=Fe.summary)==null?void 0:ce.scope_label)||"",scope:((ze=Fe.summary)==null?void 0:ze.scope)||""}:{state:"fail",msg:Fe.error||""}),Fe.ok&&je(Ae=>Ae+1)}finally{Ee.current=!1,ne(!1)}},qt=[W==null?void 0:W.industry,...(W==null?void 0:W.market_tags)||[],W==null?void 0:W.author].map(P=>(P||"").trim()).filter(Boolean),bt=(le==null?void 0:le.state)==="pending",Pt=le&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):le.state==="ok"?t.jsx("span",{className:"rslink ok",children:le.scope&&le.scope!=="public"?e.rsSavedIn(le.scopeLabel||le.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:le.msg,children:e.rsSaveFail})),_t=up(W).length,Be=z,Ze=(T||k).trim(),Ye=f.find(P=>Ue(P.name)===Ue(Ze)),ut=ct(k)||L||ct((Ye==null?void 0:Ye.website)||"")||ct((Ye==null?void 0:Ye.domain)||""),F=$||ct((Ye==null?void 0:Ye.url)||""),G=nt?e.actAnalyse:Ze?e.evalGoOn(Ze.length>22?Ze.slice(0,21)+"…":Ze):e.evalGo,X=Re?`${gs(de.trim())==="youtube"&&de.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ke)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Be?" rs-mode":"")+(T&&k.trim()===T||N||be?" pair":"")+(N||be||U?" echo":"")+(U?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Be?be:N)||U?" flash":"")+((Be?de.trim():Ca.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Be?de:k,placeholder:Be?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Be?600:200,spellCheck:Be?!1:void 0,inputMode:Be?"url":void 0,onChange:P=>{if(Be){xe(P.target.value);return}E(P.target.value),T&&P.target.value.trim()!==T&&(S(""),I(""),R(""),g(!1))},onKeyDown:P=>{P.key==="Enter"&&(Be?rt():At())}}),t.jsx("span",{className:"detect"+(Be?" off":"")+(Ca.test(k.trim())?" url":""),children:gt})]}),t.jsx("span",{className:"dacts",children:Be?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Re?" loading":""),disabled:Re||bt||!de.trim()&&!me.trim(),onClick:()=>{rt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:X})]}),t.jsxs("a",{className:"viewbtn"+(ra(de)?"":" off"),href:ra(de)?de.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{ra(de)||P.preventDefault()},children:[t.jsx(gp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(nt?" analyse":"")+(s?" loading":""),disabled:s,onClick:At,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:G})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(M?" searching":ut?"":" off"),href:ut||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":M||void 0,title:M?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{ut||P.preventDefault()},children:[M&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),M?e.viewSiteBusy:e.viewSite,!M&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(F?"":" off"),href:F||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{F||P.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),p.showCredits&&Me&&t.jsxs("button",{type:"button",className:"credits"+(Me.total_available<=0&&!Me.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Me.unlimited?"∞":Me.total_available}),!Me.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Me.daily_grant+Me.purchased]}),Me.total_available<=0&&!Me.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),!Be&&t.jsx(Va,{lang:a,variant:"bar",storeKey:((nt==null?void 0:nt.name)||k).trim()}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),O(!1),requestAnimationFrame(()=>{const P=document.querySelector(".atl2.cibles .desk-list");if(!P)return;const ee=window.scrollY+P.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,ee),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(z?" on":""),onClick:()=>B(!z),children:e.rsOpen}),fe!==null&&fe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>ie(!re),children:e.rsArchOpen(fe)}),p.pipe&&!!n&&t.jsx(cp,{pageToken:j,onAddNames:dt})]}),re&&t.jsx(hp,{bump:Ce,cbToken:j,onClose:()=>ie(!1),onEvaluate:P=>i(null,P),onAddAll:dt}),t.jsx("div",{className:"rsp slim"+(z?" on":" off"),"aria-hidden":!z,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:z?void 0:-1,onClick:()=>V(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:D?"▴":"▾"})]}),D&&t.jsx("textarea",{className:"rstext",value:me,placeholder:e.rsTextPh,tabIndex:z?void 0:-1,onChange:P=>we(P.target.value)})]})}),oe&&t.jsx("div",{className:"rserr",children:oe}),W&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:W.title}),W.source_url&&t.jsx("a",{href:W.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{Z(null),pe(null)},children:"×"})]}),W.market&&t.jsx("p",{className:"rsmk",children:W.market}),qt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),qt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[W.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${W.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ui(W.summary_md||"").map((P,ee)=>t.jsx("p",{children:P},ee))})]}),t.jsx(mi,{card:W,onEvaluate:P=>i(null,P),onAddAll:dt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(_t)}),Pt]})]}),xt.slice(0,1).map((P,ee)=>{const K=P.verdict==="kept",ce=P.verdict==="quota",ze=P.verdict==="unresolved",he=K?"var(--brand)":ce?"var(--bolt)":ze?"var(--blue)":"var(--red)",Fe=K?"var(--brand-l)":ce?"#FFF3D6":ze?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":he,"--bgc":Fe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:K?"✓ "+e.kept:ce?"⏳":ze?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Ae.url,P.name),children:e.evalPickGo})]},Ae.url))}),!ce&&!ze&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:K?1:5});const Ae=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const Je=[...document.querySelectorAll(".atl2 .list .row")].find(vt=>{var et;return(((et=vt.querySelector(".rnm"))==null?void 0:et.textContent)||"").trim().toLowerCase().includes(Ae)});Je&&(Je.scrollIntoView({behavior:"smooth",block:"center"}),Je.classList.add("flashrow"),window.setTimeout(()=>Je.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(K?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),v&&(d.kept+d.dropped>0||xt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function bp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function vp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Q(),i=e.memoConsole?r.get(e.memoConsole):null,d=c.useMemo(()=>i?[i.reasoning||"",bp(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=zt(i),s=Fn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((h,p)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},p)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Ut(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:s===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Un({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Q(),[d,l]=c.useState(!1),[s,h]=c.useState(null),p=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!p||d)return;l(!0);const m=await Eo(r,e);if(l(!1),!m){i(a.actErr);return}h(m.results||[])};return c.useEffect(()=>{if(!p)return;const m=b=>{var w;const f=String(((w=b.detail)==null?void 0:w.name)||"").trim();f&&f.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",m),()=>window.removeEventListener("ppmap:similar",m)},[e,p]),c.useEffect(()=>{if(p)try{const m=(sessionStorage.getItem("pp:similar")||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,p]),p?t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{x()},children:d?a.similarBusy:a.similar}),s&&(s.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:s.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const wp=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ka=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ca(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function Ln(e){const a=ca(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function yp(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ka(a.slice(n));break}r+=ka(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ka(a.slice(o));break}const d=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(d),s=l?l[2].toLowerCase():"";l&&wp.has(s)?r+=`<${l[1]}${s}>`:r+=ka(a.slice(o,i+1)),n=i+1}return r}const kp=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),oo={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function fi(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(kp.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const l=d.name.toLowerCase();(!(oo["*"].has(l)||((r=oo[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}fi(n)}}function za(e){const a=e.cloneNode(!0);return fi(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Ep={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},jp=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,Np=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function Mt(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function hi(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function on(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?hi(e,n.index):""}function Sp(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const l=r[d],s=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(l),h=s?Mt(s[1]):"";if((d<2||/<th/i.test(l)||jp.test(h))&&n.push(l),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function Cp(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=Sp(o,a);return r=r||i.pruned,i.html}),pruned:r}}function zp(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=hi(e,i.index);let l=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(s=>Mt(s));if(!l.length){const s=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);s&&(l=[Mt(s[1])])}if(l=l.filter(s=>s&&!/not available/i.test(s)&&!/non disponible/i.test(s)).map(s=>s.slice(0,260)).slice(0,4),!l.length)return null;a[n]=l}return a}function Ap(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?Mt(n[1]).slice(0,600):""}function qp(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(Mt(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function io(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function sn(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function Tp(e){const a={...Ep,pruned:[]};if(!e)return a;try{const n=on(e,"swot");n&&(a.swot=zp(n))}catch{}try{a.summary=Ap(e)}catch{}try{const n=on(e,"action-plan");if(n){const o=io(n);a.plan=sn(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of Np)try{let i=qp(e,o,r);if(!i)continue;const d=Cp(i);i=sn(d.html,45e3),Mt(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=on(e,"conviction");if(n){const o=sn(io(n),8e3);Mt(o)&&(a.reco=o)}}catch{}return a}function Lp(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const ln=new Map;function gi(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=ln.get(a);return r||(r=Fp(a).catch(()=>null),r.then(n=>{n||ln.delete(a)}),ln.set(a,r)),r}async function Fp(e){var m,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=f=>{var w;return(((w=n.querySelector(f))==null?void 0:w.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((m=Array.from((i==null?void 0:i.classList)||[]).find(f=>f.startsWith("sb-score-")))==null?void 0:m.slice(9))||"",l=[];let s=null;const h=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const f of h){if(f.classList.contains("sb-nav-heading")){s={label:(f.textContent||"").trim(),items:[]},l.push(s);continue}const w=f.getAttribute("href")||"";if(!w.startsWith("#"))continue;const y=w.slice(1),u=Op(n,y);u&&(s||(s={label:"",items:[]},l.push(s)),s.items.push({id:y,title:(f.textContent||"").trim(),html:u,poids:u.length}))}const p=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",x={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(f=>(f.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:l.filter(f=>f.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?p:"",comite:Rp(n,Tp(r))};return x.groups.length?x:null}function Rp(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,za(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const so={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Op(e,a){const r=e.getElementById(a),n=r?lo(e,r):"";if(n)return n;const o=so[a]?e.querySelector(so[a]):null;return o&&o!==r?lo(e,o):""}function lo(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),za(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(s=>/^h3$/i.test(s.tagName))[0]===a)for(const s of i){if(s===a)break;/^h2$/i.test(s.tagName)||o.appendChild(s.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?za(o):""}return za(a)}const dn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ve({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Mp({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function po(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function co({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const pn=new Map;function Dp(e,a){const{token:r}=Q(),[n,o]=c.useState(null);return c.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=pn.get(i);d||(d=vs(r,e.name,e.checkId),pn.set(i,d),d.then(s=>{(!s||!s.reasoning&&!s.summaryHtml)&&pn.delete(i)}));let l=!0;return d.then(s=>{l&&s&&o({id:e.id,d:s})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Ip=6e4;function Pp({o:e}){const{t:a,doDeep:r}=Q(),[n,o]=c.useState(null),[i,d]=c.useState(e.memoUrl?"load":"off"),[l,s]=c.useState(()=>new Set),[h,p]=c.useState(!1),x=c.useRef(new Map);c.useEffect(()=>{let w=!0;if(s(new Set),p(!1),x.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),gi(e.memoUrl).then(y=>{w&&(o(y),d(y?"ok":"err"))}),()=>{w=!1}},[e.memoUrl]);const m=zt(e),b=w=>{var y;return(y=x.current.get(w))==null?void 0:y.scrollIntoView({behavior:"smooth",block:"start"})},f=t.jsxs("div",{className:"cdacts",children:[Ut(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:w=>{w.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const w=[e.reasoning||"",po(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[w.length?w.join(`
