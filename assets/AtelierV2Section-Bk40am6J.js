...
/* ═══════════════════════════════════════════════════════════════════════════
   ÉCARTÉES = MÊME GESTE QUE LE CHEVRON VERT, EN ROUGE (05/09)
   Le remplissage rose du compteur perdait contre
     body.pp-desk … .offtrack .off { background:#fff } (0,6,1 > 0,5,1) :
   chiffre rouge sur blanc, pas d'étape active, bandeau froid (et --tc:#fff
   rendait le titre blanc). Même grammaire que « À évaluer » : fond saturé,
   libellé plus clair, chiffre blanc — plus un bandeau rose pâle dessous.
   « Parcourir les N » sort de la rangée LISTE/LIGNE/MAXI (hauteur figée).
   ═══════════════════════════════════════════════════════════════════════════ */
...
body.pp-desk .atl2.cibles .desk-list .listhead .lh-funnel .tuto.mini.etape-out{
  background:#FDECEC!important;--stepdot:#E5484D;--stepfg:#C0353A;
  --tc:#16233A}
...
/* hauteur du bandeau figée d'un onglet à l'autre */
body.pp-desk .atl2.cibles .desk-list .listhead .lh-funnel .tuto.mini{
...
/* Parcourir hors de la rangée LISTE/LIGNE/MAXI : la hauteur du bandeau
   reste celle d'« À évaluer », quel que soit le compteur de l'onglet. */
body.pp-desk .atl2.cibles .desk-list .listhead .lh-top .chainwrap,
.atl2.cibles .listhead .lh-top .chainwrap{display:none!important}
body.pp-desk .atl2.cibles .desk-list .listhead .lh-top .lh-acts,
