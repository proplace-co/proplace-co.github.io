...
.atl2 .bulk .side .hint{white-space:nowrap}`,hr=`
...
`,br=gr+hr;function nt(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function vr(){const t=nt("teaser");if(t==="0"||t==="1")return t;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function yr(t,a){if(t||a.mode!=="client"||!a.token)return"visiteur";const r=vr();return r==="0"?"client":r==="1"||nt("embed")==="1"&&nt("chrome")==="1"?"apercu":"client"}const wr={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},kr=t=>wr[t],Se=t=>Object.assign(t,{continent:Ca(t.cc)});function Ze(t){const a=new Set,r=[];for(const n of t){const s=(n.name||"").toLowerCase();!s||a.has(s)||(a.add(s),r.push(n))}return r}const jr=60*60*1e3;function Nr(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>jr?null:a}catch{return null}}function Be(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Sr=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function Cr(t,a,r="default"){const n=r!=="default",s=l.useMemo(()=>t||n?{mode:"anon"}:va(),[t,n]),o=l.useMemo(()=>n?"visiteur":yr(t,s),[t,s,n]),d=l.useMemo(()=>kr(o),[o]),i=o!=="visiteur",c=Sr(r),[m,b]=l.useState([]),[u,h]=l.useState(""),[v,f]=l.useState(null),[x,g]=l.useState(null),[p,y]=l.useState(null),[S,w]=l.useState(()=>new Map),[C,j]=l.useState(()=>new Map),[E,N]=l.useState(""),[q,$]=l.useState(new Set),[D,T]=l.useState(null),[_,F]=l.useState(!0),[Q,P]=l.useState(!1),[ie,me]=l.useState(0),[he,be]=l.useState(0),I=l.useRef(0),ce=l.useMemo(()=>{var U;if(o!=="client")return"";try{return((U=ya())==null?void 0:U.email)||""}catch{return""}},[o]);l.useEffect(()=>{const U=++I.current;let M=!0;const B=()=>M&&U===I.current,O=(i&&s.token?s.token:"pub:"+a)+(c?":"+c:""),K=Nr(O);return K?(b(K.objs.map(Se)),K.fund&&h(K.fund),f(K.marketEstimate??null),g(K.criteria??null),y(K.stats??null),N(K.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const G=await Qe(),ae=((G==null?void 0:G.recent_ops)||[]).map(Z=>Je(Z,a)).filter(Z=>!!Z);if(!B())return;b(ae.map(Se)),Be(O,{objs:ae})}else if(typeof r=="object"){const ae=(await bt()||[]).filter(ee=>(ee.slug||"")===r.research).map(ee=>vt(ee,a)).filter(ee=>!!ee),Z=Ze(await yt(ae,a));if(!B())return;b(Z.map(Se)),Be(O,{objs:Z})}else if(i&&s.token){const G=wa(s.token),ae=Qe(),Z=ka(s.token),ee=ja(s.token),ve=Na(s.token),H=await G;let le=H?H.targets:[];B()&&H&&(h(H.fund||""),f(H.marketEstimate??null),g(H.criteria??null),y(H.stats??null),N(H.generatedAt||""),b(le.map(Se)),F(!1),P(!1));const[pe,ye,xe,A]=await Promise.all([ae,Z,ee,ve]),Y=((pe==null?void 0:pe.recent_ops)||[]).map(W=>Je(W,a)).filter(W=>!!W);if(le=[...le,...Y],!B())return;b(le.map(Se));const J=new Set;for(const W of ye){const ue=(W.id||W.co||"").toString().trim().toLowerCase();ue&&J.add(ue.startsWith("t:")?ue:"t:"+ue)}$(J),w(xe),j(A),H&&Be(O,{fund:H.fund,marketEstimate:H.marketEstimate,criteria:H.criteria,stats:H.stats,generatedAt:H.generatedAt,objs:le})}else{const G=Sa(),ae=bt(),Z=Qe(),ee=await G;B()&&ee.length&&(b(Ze(ee).map(Se)),F(!1),P(!1));const[ve,H]=await Promise.all([ae,Z]),le=(ve||[]).map(A=>vt(A,a)).filter(A=>!!A),pe=await yt(le,a),ye=((H==null?void 0:H.recent_ops)||[]).map(A=>Je(A,a)).filter(A=>!!A),xe=Ze([...ee,...pe,...ye]);if(!B())return;b(xe.map(Se)),Be(O,{objs:xe})}B()&&P(!1)}catch{B()&&!K&&P(!0)}finally{B()&&F(!1)}})(),()=>{M=!1}},[i,s.token,a,ie,c]),l.useEffect(()=>{if(!d.showCredits||!ce){T(null);return}let U=!0;return(async()=>{try{const M=await fetch(`${ot}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ce})});if(!M.ok)return;const B=await M.json();U&&B&&B.ok!==!1&&T(B)}catch{}})(),()=>{U=!1}},[d.showCredits,ce,he]);const V=l.useCallback(U=>$(new Set(U)),[]);return{session:s,mode:o,caps:d,fund:u,email:ce,marketEstimate:v,generatedAt:E,criteria:x,stats:p,thumbs:S,stages:C,dossiers:m,favIds:q,setFavIds:V,credits:D,reloadCredits:()=>be(U=>U+1),loading:_,error:Q,refresh:()=>me(U=>U+1)}}const Gt=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Er=(t="europe",a=!1,r)=>({continent:t,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Gt(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function zr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const r=t.filters[a.facet],n=r.includes(a.value)?r.filter(s=>s!==a.value):[...r,a.value];return{...t,filters:{...t.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=t.filters.memoLevel,n=r.includes(a.value)?r.filter(s=>s!==a.value):[...r,a.value];return{...t,filters:{...t.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Gt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ve)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ve=60;function pt(t,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ne(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(t.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(st(t)))return!1;if(n!=="win"){if(a.day){if((t.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const s=a.win==="1"?0:a.win==="7"?7:30;if(Te(t.date)>s)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ee(t)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const s=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(s))return!1}return!0}function Kt(t,a,r){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:pt(t,a.filters,r)}function Tr(t,a,r,n){return!(!Kt(t,a,r)||r&&!Ea(t,a.ptab,n))}function ut(t,a){const r=a.key,n=s=>{switch(r){case"name":return(s.name||"").toLowerCase();case"country":return s.countryLabel||s.cc||"";case"stage":return s.stage||"";case"amount":return s.amountEur||-1;case"age":return-Te(s.date);case"score":return typeof s.score=="number"?s.score:-1;case"signal":{const o=ne(s);return o?100-(o.left??0):-1}}};return[...t].sort((s,o)=>{const d=n(s),i=n(o);return d<i?-a.dir:d>i?a.dir:(s.name||"").localeCompare(o.name||"")})}function Ar(){const{dossiers:t,st:a,t:r,dispatch:n,contName:s,pipe:o}=z(),d=l.useMemo(()=>{const c=(a.filters.day||"").slice(0,10),m=v=>!(!o&&v.continent!==a.continent||c&&(v.date||"").slice(0,10)!==c),b=t.filter(v=>m(v)&&ne(v)),u=t.filter(v=>m(v)&&v.kind==="op"&&!ne(v)&&(c?!0:Te(v.date)<=7)),h=c||new Date().toISOString().slice(0,10);return u.sort((v,f)=>{const x=(v.date||"").slice(0,10)===h?0:1,g=(f.date||"").slice(0,10)===h?0:1;return x!==g?x-g:(f.amountEur||0)-(v.amountEur||0)}),[...ut(b,{key:"signal",dir:-1}),...u].slice(0,48)},[t,a.continent,a.filters.day,o]),i=c=>d.map(m=>e.jsxs("button",{type:"button",className:"tk"+(de(m)?" spent":""),onClick:b=>{const u=b.currentTarget.getBoundingClientRect();n({type:"popup",id:m.id,anchor:{x:u.left+u.width/2,y:u.bottom}})},title:m.name+(m.tagline?" — "+m.tagline:""),children:[e.jsx(qe,{o:m}),e.jsxs("span",{className:"who",children:[e.jsx(na,{o:m}),e.jsx("span",{className:"co",children:m.name})]}),typeof m.amountEur=="number"&&m.amountEur>0&&e.jsx("span",{className:"am",children:oo(m.amountEur)}),m.sector&&e.jsx("span",{className:"mt",children:m.sector}),e.jsx(We,{o:m}),e.jsx("span",{className:"tkgo",children:"→"})]},c+(m.id||m.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),r.live,e.jsx("span",{className:"cnt",children:d.length})]}),e.jsx("div",{className:"win",children:d.length?e.jsxs("div",{className:"run",children:[i(0),i(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:r.liveQuiet(s)})})})]})}const Lr="aDx8z7Hzksus",Qt="+33 6 83 10 72 86",Tt="alexandre@proplace.co",qr=`tel:${Qt.replace(/[^\d+]/g,"")}`,At="pp-rdv-slot";function Rr(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Or(){const{t,caps:a,fund:r}=z();if(!a.showOnb)return null;const n=r||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[e.jsx("style",{children:Fr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:qr,children:Qt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${Tt}`,children:Tt})]}),e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(n).map(([s,o],d)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(d+1)}),e.jsx("b",{children:s}),e.jsx("span",{children:o})]},s))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(ur,{filloutId:Lr,parameters:r?{company_name:r}:void 0})})]})}function Mr(){const[t,a]=l.useState(()=>typeof document>"u"?null:document.getElementById(At));return l.useEffect(()=>{t||a(document.getElementById(At))},[t]),t?Fe.createPortal(e.jsx(Or,{}),t):null}const Fr=`
...
`;class te extends l.Component{constructor(){super(...arguments);gt(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Dr=8;function Pr(){const{t,lang:a,token:r,dossiers:n,caps:s,markRow:o,dispatch:d}=z(),[i,c]=l.useState(!1),[m,b]=l.useState(!1),[u,h]=l.useState(!1),v=r||"home",{names:f,verdicts:x}=l.useMemo(()=>{const w=[],C={};return n.forEach(j=>{j.kind!=="target"||!j.name||(w.push(j.name),C[j.name]=za(j)||"")}),{names:w,verdicts:C}},[n]),g=l.useMemo(()=>f.length?Ta(v,f,x,a):null,[v,f.length]);if(!s.pipe||i||!g||g.firstVisit||!g.added.length&&!g.gone.length)return null;const p=m?g.added:g.added.slice(0,Dr),y=g.added.length-p.length,S=w=>{const C=n.find(j=>j.name===w);C&&(o(C.id),d({type:"popup",id:C.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(g.added.length,g.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{c(!0),Aa(v,f,x,g.fp,a)},children:"×"})]}),!!g.added.length&&e.jsxs("div",{className:"since-c",children:[p.map(w=>e.jsx("button",{type:"button",onClick:()=>S(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>b(!0),children:t.sinceMore(y)})]}),!!g.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>h(w=>!w),children:t.sinceOut(g.gone.length)}),u&&g.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const et=600,Ce=62,Lt="atl2:fstats";function Ir(){const{t,lang:a,data:r,caps:n,st:s,dispatch:o}=z(),[d,i]=l.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Lt)==="on"}catch{return!1}}),c=r.stats,m=l.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),b=l.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!n.showFunnel||!c||typeof c.screened!="number")return null;const u=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,h=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=m.reduce((y,S)=>Math.max(y,S.s||0),0),f=m.length?et/m.length:0,x=Math.max(4,f-4),g=m.length>=5&&v>0,p=[[c.screened,t.funScreened(u(b)),c.screened_today],...typeof c.kept=="number"?[[c.kept,t.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,t.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(d?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[p.map(([y,S,w],C)=>e.jsxs("span",{className:"fst-t",children:[C>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:h(y)}),e.jsx("i",{children:S}),d&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},S)),g&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!d;i(y),y&&!s.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Lt,y?"on":"off")}catch{}},children:d?"⌃":"⌄"})]}),d&&g&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${et} ${Ce}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[m.map((y,S)=>{const w=(y.s||0)/v*(Ce-4),C=(y.m||0)/v*(Ce-4),j=S*f+(f-x)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${u(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:j,y:Ce-2-w,width:x,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:j,y:Ce-2-C,width:x,height:C,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:Ce-1.5,x2:et,y2:Ce-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:u(m[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const Br=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function $r({o:t}){const{t:a,caps:r,canWrite:n,commitStatus:s}=z(),[o,d]=l.useState(""),[i,c]=l.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const m=(t.ceoStatus||"").trim(),b=(Ae(t)||"").startsWith("CALL")&&se(t)===3,u=se(t)>=2,h=async f=>{if(o||f==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(f);const x=await s(t,f);d(""),x&&(c(!0),setTimeout(()=>c(!1),2200))},v=b?[["Validé",a.csYes],["Écarté",a.csNo]]:Br.filter(([f])=>!(u&&f==="Retenu")).map(([f,x])=>[f,a[x]]);return e.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([f,x])=>e.jsx("button",{type:"button",className:"csb"+(m===f?" on":"")+(o===f?" busy":""),disabled:!!o,onClick:()=>{h(f)},children:x},f)),i&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(_r,{o:t})]})}function _r({o:t}){const{t:a,saveNote:r,flash:n}=z(),[s,o]=l.useState(t.ceoNote||""),[d,i]=l.useState(!1),[c,m]=l.useState(!1),b=s.trim()!==(t.ceoNote||"").trim(),u=async()=>{if(d||!b)return;i(!0);const h=await r(t,s.trim());i(!1),h&&(m(!0),setTimeout(()=>m(!1),2200),n(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:s,disabled:d,onChange:h=>o(h.target.value),onKeyDown:h=>{h.key==="Enter"&&u()}}),e.jsx("button",{type:"button",disabled:d||!b,onClick:()=>{u()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Ur({placeholder:t,onDone:a}){const{t:r}=z(),[n,s]=l.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:n,autoFocus:!0,onChange:o=>s(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Vr({o:t}){var g;const{t:a,token:r,caps:n,canWrite:s,stageOf:o,setStage:d,flashErr:i}=z(),[c,m]=l.useState(!1);if(!n.pipe||!s||n.lockActions||se(t)!==4)return null;const b=o(t),u=(b==null?void 0:b.stage)||"todo",h=async p=>{if(c||p===u)return;m(!0);const y=b;d(t,{stage:p,stamps:(b==null?void 0:b.stamps)||{}});const S=Math.max(Date.now(),qt+=1);qt=S;const w=await La(r,{company:t.name||"",stage:p,cts:S,deal_id:t.airtableId,check_id:t.checkId});m(!1),!w.stale&&(w.ok||(d(t,y),i(a.actErr)))},v=(g=b==null?void 0:b.stamps)==null?void 0:g.sent,f=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,x=u==="sent"&&v&&f>=4;return e.jsxs("div",{className:"stg",onClick:p=>p.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([p,y])=>e.jsx("button",{type:"button",className:"stgb"+(u===p?" on":""),disabled:c,onClick:()=>{h(p)},children:y},p)),x&&e.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let qt=0;const $e=8,_e=340;function Rt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((r,n)=>n%2?e.jsx("b",{children:r},n):e.jsx("span",{children:r},n))})}function Hr({steps:t,onClose:a}){const{t:r,dispatch:n,counts:s,scoped:o,byId:d,st:i}=z(),[c,m]=l.useState(0),[b,u]=l.useState(null),[h,v]=l.useState([]),f=l.useRef(!1);l.useEffect(()=>{f.current||(f.current=!0,v(t.filter(C=>!!document.querySelector(C.need||C.sel))))},[t]);const x=h[c],g=c>=h.length;l.useEffect(()=>{x&&(x.ptab!==void 0&&i.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&i.dens!==x.dens&&n({type:"dens",dens:x.dens}))},[c,x]);const p=l.useCallback(()=>{if(!x){u(null);return}const C=document.querySelector(x.sel);if(!C){u(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),u(C.getBoundingClientRect())},[x]);l.useLayoutEffect(()=>{p();const C=window.setTimeout(p,260),j=()=>p();return window.addEventListener("scroll",j,!0),window.addEventListener("resize",j),()=>{window.clearTimeout(C),window.removeEventListener("scroll",j,!0),window.removeEventListener("resize",j)}},[p]);const y=l.useRef(a);if(y.current=a,l.useEffect(()=>{const C=j=>{j.key==="Escape"?(j.preventDefault(),j.stopPropagation(),y.current()):j.key==="ArrowRight"?m(E=>E+1):j.key==="ArrowLeft"&&m(E=>Math.max(0,E-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!h.length)return null;let S=null;if(g){const C=s[3]||0,j=o.find(E=>E.memoUrl)||[...d.values()].find(E=>E.memoUrl);C>0?S={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:j?S={title:r.ahaBTitle,body:r.ahaBBody(j.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:j.id}),a()}}:S={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:_e};if(!g&&b){const C=b.bottom+14,E=window.innerHeight-C>190?C:Math.max(12,b.top-200);w={left:Math.min(Math.max(12,b.left+b.width/2-_e/2),window.innerWidth-_e-12),top:E,width:_e}}return Fe.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!g&&b&&e.jsx("div",{className:"tour-hole",style:{left:b.left-$e,top:b.top-$e,width:b.width+$e*2,height:b.height+$e*2}}),(g||!b)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(g?" fin":""),style:w,children:[g&&S?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:S.title}),e.jsx("p",{children:e.jsx(Rt,{text:S.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>m(h.length-1),children:r.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:S.go,children:S.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:r.tourStep(c+1,h.length)}),e.jsx("h3",{children:x==null?void 0:x.title}),e.jsx("p",{children:e.jsx(Rt,{text:(x==null?void 0:x.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>m(C=>Math.max(0,C-1)),children:r.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>m(C=>C+1),children:c===h.length-1?r.tourDone:r.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Yr(){const{dossiers:t,scopedAll:a,pipe:r,mode:n,t:s,st:o,dispatch:d}=z(),i=r?a:t,c=l.useMemo(()=>i.filter(p=>Te(p.date)===0&&p.kind==="target"),[i]),m=l.useMemo(()=>r?a.filter(p=>se(p)===0).slice().sort((p,y)=>(y.date||"").localeCompare(p.date||"")):[],[a,r]),b=l.useMemo(()=>c.filter(p=>r?se(p)===0:!de(p)),[c,r]),u=r?m:b,h=r?a.length-m.length:c.length-b.length,v=r?a.length:c.length,f=v?Math.min(100,h/v*100):100;let x;r?x=s.morningThesis(c.length,m.length):c.length?h===0?x=s.goalSourced(c.length):h>=c.length?x=s.goalCleared:x=s.goalDone(h,c.length):x=s.goalSourced(0);const g=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&m.length&&d({type:"chainStart",queue:m.map(p=>p.id)})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:x}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:f+"%"}})}),u.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:g,children:r?s.morningEval(u.length):o.pileMode?s.goalContinue(u.length):s.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Wr(){var $,D;const{t,lang:a,st:r,dispatch:n,token:s,fund:o,data:d,dossiers:i,mode:c,doSync:m,startTour:b}=z(),[u,h]=l.useState(null),[v,f]=l.useState([]),x=c==="client";l.useEffect(()=>{if(!s||!o)return;let T=!0;return(async()=>{const[_,F]=await Promise.all([it(o),Vt(s)]);T&&(_&&h(_),f(F))})(),()=>{T=!1}},[s,o]);const g=(u==null?void 0:u.per_day)??null,p=(($=u==null?void 0:u.pool_order)==null?void 0:$.length)??0,y=v.filter(T=>T.status==="running").length,S=l.useMemo(()=>i.filter(T=>T.kind==="target"&&de(T)).length,[i]),w=d.marketEstimate,C=typeof((D=d.stats)==null?void 0:D.screened)=="number"?d.stats.screened:S,j=w&&w>0?Math.min(100,Math.round(C/w*100)):null,E=T=>T.toLocaleString(a==="en"?"en-US":"fr-FR"),N=(o||"P").split(/\s+/).map(T=>T[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const T=Date.parse(d.generatedAt||"");if(Number.isNaN(T))return"";const _=new Date(T),F=Q=>String(Q).padStart(2,"0");return`${F(_.getDate())}/${F(_.getMonth()+1)} à ${F(_.getHours())}:${F(_.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),q&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(q)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:b,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[j===null&&C>0&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsx("span",{className:"ev",children:e.jsx("b",{children:E(C)})})]}),j!==null&&w&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:j+"%"}})}),e.jsxs("b",{children:[j," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(C,w)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),g!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"q",children:g})," ",t.identPerDay]}),e.jsx("span",{className:"edv"})]}),g===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),y>0&&e.jsxs("span",{className:"ev",children:["⏳ ",y]}),e.jsx("span",{className:"ego",children:t.identPending(p)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:T=>{T.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!x,onClick:m,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:r.filters.search,onChange:T=>n({type:"filters",patch:{search:T.target.value}})})]})]})]})}function Gr(){const{t,counts:a,dispatch:r}=z();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([n,s],o)=>{const d=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(d?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:n}),e.jsx("div",{className:"s4d",children:s}),d&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Kr=["--p0","--p1","--p2","--p3","--p4"];function Qr(){const{st:t,dispatch:a,counts:r,t:n,doUndo:s}=z(),o=l.useRef({});l.useEffect(()=>{o.current={...r}},[r]);const d=m=>{const b=o.current[m],u=b!==void 0?r[m]-b:0;return e.jsxs("button",{type:"button",className:"step"+(m===3&&r[3]>0?" wait":""),style:{"--c":`var(${Kr[m]})`,"--tc":m<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===m,title:n.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsxs("span",{className:"l",children:[n.plabels[m].toUpperCase(),m===3&&r[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[r[m],u!==0&&e.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},m)},i=(m,b,u)=>e.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":m===5?"var(--p5)":m===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===m,title:n.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsx("span",{className:"l",children:u.toUpperCase()}),e.jsx("span",{className:"n",children:r[m]})]},m),c=(m,b,u,h=!1)=>e.jsx("button",{type:"button",className:"tool",title:b,disabled:h,onClick:u,children:m},b);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(d)}),e.jsxs("div",{className:"offtrack",children:[i(5,!1,n.plabels[5]),i(7,!0,n.plabels[7]),i(6,!0,"★ "+n.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",n.toolUndo,s,t.undo.length===0),c("↺",n.toolReset,()=>{a({type:"reset"})}),c("⇅",n.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Jr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Xr(){const{st:t,dispatch:a,t:r,scoped:n,memoQueued:s,doAnalyse:o,mode:d}=z(),i=l.useRef(null),[c,m]=l.useState(60);l.useEffect(()=>{let v=0;const f=()=>{var S;const x=i.current;if(!x)return;const g=(S=x.parentElement)==null?void 0:S.querySelector('.funnel [aria-selected="true"]');if(!g)return;const p=g.getBoundingClientRect(),y=x.getBoundingClientRect();m(Math.max(20,Math.min(p.left+p.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",f)}},[t.ptab]);const b=t.ptab;let u=r.tuto[b].p;if(b===3){const v=n.filter(g=>g.kind==="target"&&se(g)===3),f=v.filter(g=>at(g)==="auto").length,x=v.filter(g=>at(g)==="cd").length;u=r.tutoPending(f,x,v.length)}const h=(()=>{if(d!=="client")return null;if(b===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(v=>v.id)})};if(b===1){const v=n.filter(f=>f.kind==="target"&&se(f)===1&&!s.has(f.id)).slice(0,10);if(v.length)return{label:r.tuto[1].a,run:()=>v.forEach(f=>o(f))}}return null})();return e.jsxs("div",{ref:i,className:"tuto mini",style:{"--bg":Jr[b],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:r.plabels[b].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:u}})]})}),h&&e.jsx("button",{type:"button",className:"tprim",onClick:h.run,children:h.label})]})}const Ot=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Mt(t){let a=2166136261;for(let r=0;r<t.length;r++)a^=t.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Zr(t,a){const[r,n]=l.useState(1);return l.useEffect(()=>{let s=!0,o=0;const d=()=>{var m;if(!s)return;const c=(m=t.current)==null?void 0:m.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(d)};d();const i=new ResizeObserver(()=>d());return t.current&&i.observe(t.current),window.addEventListener("resize",d),()=>{s=!1,cancelAnimationFrame(o),i.disconnect(),window.removeEventListener("resize",d)}},[t,a]),r}function en(){const{st:t,dispatch:a,scoped:r,pipe:n,markRow:s,markedId:o,byId:d,lang:i,t:c}=z(),m=l.useRef(null),b=l.useRef(null),u=lt.find(N=>N.key===t.continent),h=Zr(m,t.continent+":"+t.mapFolded),[v,f]=l.useState(new Map),[x,g]=l.useState(null);l.useEffect(()=>{const N=m.current;if(!N)return;const q=new Map;N.querySelectorAll("path[data-i2]").forEach($=>{const D=$.dataset.i2;if(D)try{const T=$.getBBox();T.width>0&&q.set(D,{x:T.x,y:T.y,w:T.width,h:T.height})}catch{}}),f(q)},[t.continent,h]);const p=l.useMemo(()=>r.filter(N=>N.cc),[r]),y=l.useMemo(()=>{const N=new Map;return p.forEach(q=>N.set(q.cc,(N.get(q.cc)||0)+1)),N},[p]),S=l.useMemo(()=>p.map(N=>{const q=N.cc?v.get(N.cc):void 0;if(!q)return null;const $=Mt(N.name||N.id||""),D=Mt((N.id||N.name||"")+"·y"),T=($-.5)*Math.min(q.w*.55,60),_=(D-.5)*Math.min(q.h*.55,60);return{d:N,x:q.x+q.w/2+T,y:q.y+q.h/2+_}}).filter(N=>!!N),[p,v]),w=N=>h>0?N/h:N,C=l.useMemo(()=>n?[0,1,2,3,4,5].map(N=>({c:Ot[N],fr:c.plabels[N].toUpperCase(),en:c.plabels[N].toUpperCase(),n:r.filter(q=>q.kind==="target"&&se(q)===N).length})).filter(N=>N.n>0):wt.map((N,q)=>({...N,n:r.filter($=>kt($)===q).length})),[r,n,c.plabels]),j=o?d.get(o):null,E=j?S.find(N=>N.d.id===j.id):null;return e.jsxs("div",{className:"mapzone",ref:b,children:[e.jsxs("svg",{ref:m,viewBox:u.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":i==="fr"?u.fr:u.en,onMouseLeave:()=>{g(null),s(null)},children:[e.jsx("g",{children:u.countries.map((N,q)=>e.jsx("g",{className:"ct"+(N.i2&&y.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},q))}),e.jsx("g",{children:S.map(N=>{const q=wt[kt(N.d)],$=!!ne(N.d),D=N.d.kind==="target",T=n&&D?Ot[se(N.d)]:q.c,_=!n&&de(N.d);return e.jsxs("g",{className:"co"+(_?" done":""),onMouseEnter:()=>{var P,ie;const F=(P=b.current)==null?void 0:P.getBoundingClientRect(),Q=(ie=m.current)==null?void 0:ie.createSVGPoint();if(Q&&m.current&&F){Q.x=N.x,Q.y=N.y;const me=Q.matrixTransform(m.current.getScreenCTM());g({x:me.x-F.left,y:me.y-F.top,label:N.d.name+" · "+(Le(N.d.cc,i)||N.d.countryLabel||"")})}s(N.d.id)},onMouseLeave:()=>{g(null),s(null)},onClick:()=>{var P;const F=(P=m.current)==null?void 0:P.createSVGPoint();let Q=null;if(F&&m.current){F.x=N.x,F.y=N.y;const ie=F.matrixTransform(m.current.getScreenCTM());Q={x:ie.x,y:ie.y}}a({type:"popup",id:N.d.id,anchor:Q})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:w(Math.max(11,q.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:w(q.px),fill:T,stroke:$?"#DC2626":"#ffffff",strokeWidth:w($?2.2:1.3)})]},N.d.id||N.d.name)})}),E&&e.jsx("circle",{className:"ring on",cx:E.x,cy:E.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(x?" on":""),style:x?{left:x.x,top:x.y}:void 0,children:x==null?void 0:x.label}),e.jsx("div",{className:"legend",children:C.map((N,q)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),i==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},q))}),r.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:r.filter(N=>!N.cc).length})]})})]})}function tn(t,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t);if(!r)return t;const s=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${s} ${o}, ${r[1]}`:`${o} ${s} ${r[1]}`}function an(){const{st:t,dispatch:a,dossiers:r,t:n,pipe:s,contName:o,lang:d}=z(),i=t.filters,c=l.useMemo(()=>r.filter(f=>f.continent===t.continent),[r,t.continent]),m=f=>c.filter(x=>f!=="country"&&i.country.length&&!i.country.includes(x.cc||"")?!1:pt(x,i,s,f==="country"?void 0:f)),b=l.useMemo(()=>{const f=m("win"),x=g=>f.filter(p=>(p.date?Math.max(0,Math.floor((Date.now()-Date.parse(p.date))/864e5)):9999)<=g).length;return[x(0),x(7),x(30),f.length]},[c,i,s]),u=l.useMemo(()=>i.day?m("win").filter(f=>(f.date||"").slice(0,10)===i.day).length:0,[c,i,s]),h=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.day||i.win!=="all"?1:0)+(i.search.trim()?1:0),v=(f,x,g,p="fbtn")=>e.jsxs("button",{type:"button",className:p,"aria-expanded":t.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[e.jsx("span",{className:"fl",children:x}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},f);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[i.day?e.jsxs("div",{className:"seg",children:[e.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(tn(i.day,d)),e.jsx("b",{children:u})]}),e.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):e.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,x)=>e.jsxs("button",{type:"button","aria-pressed":i.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[n.dates[x],e.jsx("b",{children:b[x]})]},f))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:n.identSearch,value:i.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:n.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),i.sector.length===1?e.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":t.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:i.sector[0],children:[e.jsx("span",{className:"fl",children:n.fSector}),e.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:i.sector[0]}),e.jsx("span",{className:"cv",children:"▾"})]}):v("sec",n.fSector,i.sector.length),v("pay",n.fCountry,i.country.length),v("det",n.fEngine,i.engine.length),v("sta",n.fStage,i.stage.length),s&&v("ang","Angle",i.angle.length),s&&v("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),h>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(c.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:n.clear(h)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),t.openFacet&&e.jsx(rn,{poolFor:m})]})}function rn({poolFor:t}){const{st:a,dispatch:r,t:n,lang:s}=z(),o=a.filters,d=a.openFacet,{title:i,cols:c,options:m}=l.useMemo(()=>{if(d==="sig"){const f=t("signal").filter(p=>ne(p)),x=new Map;f.forEach(p=>{const y=p.engine||"";x.set(y,(x.get(y)||0)+1)});const g=[{v:"*",label:n.fpSigAll,n:f.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...jt([...x.keys()],s).map(p=>({v:p,label:ze(p)+" "+ge(p,s),n:x.get(p)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(p)}))];return{title:n.fpSigTitle,cols:2,options:g}}if(d==="sec"){const f=t("sector"),x=new Map;return f.forEach(g=>{g.sector&&x.set(g.sector,(x.get(g.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...x.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:g,n:p,html:!1,on:o.sector.includes(g)}))}}if(d==="pay"){const f=t("country"),x=new Map;return f.forEach(g=>{g.cc&&x.set(g.cc,(x.get(g.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...x.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:Le(g,s)||g,n:p,html:!1,on:o.country.includes(g)}))}}if(d==="det"){const f=t("engine"),x=new Map;return f.forEach(g=>{g.engine&&x.set(g.engine,(x.get(g.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:jt([...x.keys()],s).map(g=>({v:g,label:ze(g)+" "+ge(g,s)+' <span style="color:var(--dim);font-size:10px">· '+qa(Ra(g),s)+"</span>",n:x.get(g)||0,html:!0,on:o.engine.includes(g)}))}}if(d==="ang"){const f=t("angle"),x=new Map;return f.forEach(g=>{g.angle&&x.set(g.angle,(x.get(g.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...x.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:g.replace(/[_-]+/g," "),n:p,html:!1,on:o.angle.includes(g)}))}}if(d==="mem"){const f=t("memoLevel"),x=new Map;f.forEach(p=>{if(p.kind==="target"){const y=st(p);x.set(y,(x.get(y)||0)+1)}});const g=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(p=>({v:String(p),label:g[p],n:x.get(p)||0,html:!1,on:o.memoLevel.includes(p)}))}}const h=t("stage"),v=new Map;return h.forEach(f=>{f.stage&&v.set(f.stage,(v.get(f.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((f,x)=>x[1]-f[1]).map(([f,x])=>({v:f,label:f,n:x,html:!1,on:o.stage.includes(f)}))}},[d,a,s]),b=h=>{if(d==="sig"){if(h==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const f=o.signalEngines.includes(h)?o.signalEngines.filter(x=>x!==h):[...o.signalEngines,h];r({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(d==="mem"){r({type:"toggleMemoLevel",value:Number(h)});return}r({type:"toggleFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage",value:h})},u=()=>{r(d==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:d==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:i}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:u,children:n.fpNone}),e.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:m.map(h=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":h.on,onClick:()=>b(h.v),children:[e.jsx("span",{className:"bx"}),h.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:h.label}}):e.jsx("span",{className:"l",children:h.label}),e.jsx("span",{className:"n",children:h.n})]},h.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:n.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}const Ft=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function nn(t){return String(t||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function on(){var xe;const{t,mode:a,token:r,email:n,askEvaluate:s,sessTally:o,dispatch:d,evalBusy:i,evalCards:c,caps:m,data:b}=z(),u=a==="client",[h,v]=l.useState(""),[f,x]=l.useState(!1),[g,p]=l.useState(""),[y,S]=l.useState(!1),[w,C]=l.useState(""),[j,E]=l.useState([]),N=l.useRef(!1),[q,$]=l.useState(!1),[D,T]=l.useState(""),[_,F]=l.useState(""),[Q,P]=l.useState(!1),[ie,me]=l.useState(0),[he,be]=l.useState(""),[I,ce]=l.useState(null),[V,U]=l.useState(null),M=l.useRef(!1),B=h.trim()?Ft.test(h.trim())?t.evalUrl:t.evalName:t.evalWaiting,O=l.useMemo(()=>g.split(`
`).map(A=>A.trim()).filter(Boolean).slice(0,15),[g]),K=j.length?j:c,G=b.credits;l.useEffect(()=>{if(!Q)return;me(0);const A=window.setInterval(()=>me(Y=>Y+1),1e3);return()=>window.clearInterval(A)},[Q]);const ae=()=>{const A=h.trim();A&&(s(null,A),v(""))},Z=async()=>{if(!u){s(null,O[0]||"");return}if(!O.length||y)return;S(!0),N.current=!1;const A=[];for(let Y=0;Y<O.length&&!N.current;Y++){C(t.evaluating(Y+1,O.length,O[Y]));const J=await Ht(r,O[Y],"atelier2");if(A.unshift({name:J.company||O[Y],verdict:J.verdict,reason:J.reason||"",remaining:J.remaining??null}),E([...A]),J.verdict==="quota"){A.unshift({name:"",verdict:"quota",reason:t.quota(O.length-Y-1),remaining:0}),E([...A]),p(O.slice(Y+1).join(`
`)),C(""),S(!1);return}}C(""),p(N.current?O.slice(A.length).join(`
`):""),S(!1)},ee=async()=>{var J;if(M.current)return;const A=D.trim().replace(/\s+/g,""),Y=_.trim();if(!A&&!Y){be(t.rsNeed);return}M.current=!0,be(""),ce(null),U(null),P(!0);try{const W=await Ma({url:A,text:Y,email:n,cbToken:r});if(P(!1),!W||W.status!=="success"){be((W==null?void 0:W.message)||"Erreur");return}ce(W),$(!1);const ue=(((J=W.prospective)==null?void 0:J.companies_to_evaluate)||[]).map(ke=>((ke==null?void 0:ke.name)||"").trim()).filter(Boolean);ue.length&&(p(ke=>{const De=ke.split(`
...
`)}),x(!0)),U({state:"pending"});const we=await Fa(W,{email:n,cbToken:r});U(we.ok&&we.url?{state:"ok",url:we.url}:{state:"fail",msg:we.error||""})}finally{M.current=!1,P(!1)}},ve=(((xe=I==null?void 0:I.prospective)==null?void 0:xe.companies_to_evaluate)||[]).filter(A=>A&&A.name),H=[I==null?void 0:I.industry,...(I==null?void 0:I.market_tags)||[],I==null?void 0:I.author].map(A=>(A||"").trim()).filter(Boolean),le=(V==null?void 0:V.state)==="pending",pe=V&&(le?e.jsx("span",{className:"rslink pend",children:t.rsPublishing}):V.state==="ok"?e.jsx("a",{className:"rslink",href:V.url,target:"_blank",rel:"noopener noreferrer",children:t.rsLink}):e.jsx("span",{className:"rslink fail",title:V.msg,children:t.rsPublishFail})),ye=f&&ve.length>0;return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:h,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:A=>v(A.target.value),onKeyDown:A=>{A.key==="Enter"&&ae()}}),e.jsx("span",{className:"detect"+(Ft.test(h.trim())?" url":""),children:B})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:ae,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),m.showCredits&&G&&e.jsxs("button",{type:"button",className:"credits"+(G.total_available<=0&&!G.unlimited?" empty":""),onClick:()=>d({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:G.unlimited?"∞":G.total_available}),!G.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",G.daily_grant+G.purchased]}),G.total_available<=0&&!G.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsxs("div",{className:"dunder",children:[e.jsx("button",{type:"button",className:"dmulti",onClick:()=>x(!f),children:t.evalMulti}),e.jsx("button",{type:"button",className:"dmulti dsearch"+(q?" on":""),onClick:()=>$(!q),children:t.rsOpen})]}),q&&e.jsxs("div",{className:"rsp on",children:[e.jsxs("div",{className:"rsf",children:[e.jsx("input",{className:"rsurl",value:D,placeholder:t.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:A=>T(A.target.value),onKeyDown:A=>{A.key==="Enter"&&ee()}}),e.jsx("span",{className:"rsor",children:t.rsOr}),e.jsx("textarea",{className:"rstext",value:_,placeholder:t.rsTextPh,onChange:A=>F(A.target.value)})]}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(Q?" loading":""),style:{justifyContent:"center"},disabled:Q||le||!D.trim()&&!_.trim(),onClick:()=>{ee()},children:[e.jsx("span",{className:"fill"}),Q?`${Oa(D.trim())==="youtube"&&D.trim()?t.rsRunningVid:t.rsRunning} ${t.rsElapsed(ie)}`:le?t.rsPublishing:t.rsGo]}),e.jsx("span",{className:"hint",children:t.rsHint})]})]}),he&&e.jsx("div",{className:"rserr",children:he}),I&&e.jsxs("div",{className:"rscard",children:[e.jsxs("div",{className:"rsh",children:[e.jsx("b",{children:I.title}),I.source_url&&e.jsx("a",{href:I.source_url,target:"_blank",rel:"noopener noreferrer",children:t.rsSource}),e.jsx("button",{type:"button",className:"rsx",title:t.rsClose,onClick:()=>{ce(null),U(null)},children:"×"})]}),I.market&&e.jsx("p",{className:"rsmk",children:I.market}),H.length>0&&e.jsxs("div",{className:"rstags",children:[e.jsx("em",{children:t.rsTags}),H.map(A=>e.jsx("span",{children:A},A))]}),e.jsxs("div",{className:"rsbody",children:[I.mindmap_png_b64&&e.jsxs("figure",{className:"rsmm",children:[e.jsx("img",{src:`data:image/png;base64,${I.mindmap_png_b64}`,alt:t.rsMindmap}),e.jsx("figcaption",{children:t.rsMindmap})]}),e.jsx("div",{className:"rssum",children:nn(I.summary_md||"").map((A,Y)=>e.jsx("p",{children:A},Y))})]}),e.jsxs("div",{className:"rsfoot",children:[e.jsx("span",{children:t.rsFound(ve.length)}),!ye&&pe]})]}),f&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:A=>p(A.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(y?" loading":""),style:{justifyContent:"center"},disabled:y||!O.length,onClick:()=>{Z()},children:[e.jsx("span",{className:"fill"}),y&&w?w:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(O.length)}),ye&&pe]})]}),K.slice(0,1).map((A,Y)=>{const J=A.verdict==="kept",W=A.verdict==="quota",ue=J?"var(--brand)":W?"var(--bolt)":"var(--red)",we=J?"var(--brand-l)":W?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":ue,"--bgc":we},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:J?"✓ "+t.kept:W?"⏳":"✗ "+t.dropped})}),A.name&&e.jsx("span",{className:"rn",children:A.name}),e.jsx("span",{className:"rr",children:A.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",A.reason]}):null}),!W&&e.jsx("button",{type:"button",className:"go",onClick:()=>d({type:"modal",modal:"space"}),children:t.seeSpace(J?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},Y)}),u&&(o.kept+o.dropped>0||K.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(o.kept,o.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>d({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function sn(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ln(){const{st:t,dispatch:a,byId:r,t:n,doDeep:s}=z(),o=t.memoConsole?r.get(t.memoConsole):null,d=l.useMemo(()=>o?[o.reasoning||"",sn(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const i=Ae(o),c=st(o);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:o.name}),i&&e.jsx("span",{className:"vv",children:i}),typeof o.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),e.jsx("div",{className:"mb2",children:d?d.split(`

`).map((m,b)=>e.jsx("p",{style:{margin:"0 0 10px"},children:m},b)):e.jsx("p",{children:n.memoNone})}),e.jsxs("div",{className:"mf",children:[dt(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:n.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>s(o),children:n.memoDeep})]}):e.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const dn=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ue=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function cn(t){const a=String(t||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const s=a.indexOf("<",n);if(s<0){r+=Ue(a.slice(n));break}r+=Ue(a.slice(n,s));const o=a.indexOf(">",s);if(o<0){r+=Ue(a.slice(s));break}const d=a.slice(s+1,o).trim(),i=/^(\/?)([a-zA-Z0-9]+)/.exec(d),c=i?i[2].toLowerCase():"";i&&dn.has(c)?r+=`<${i[1]}${c}>`:r+=Ue(a.slice(s,o+1)),n=o+1}return r}const Dt=(t,a)=>{const r=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function re({k:t,v:a,href:r}){return a==null||a===""?null:e.jsxs("div",{className:"cdl",children:[e.jsx("span",{className:"cdk",children:t}),r?e.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):e.jsx("span",{className:"cdv",children:String(a)})]})}function pn({o:t}){const{t:a,lang:r,dispatch:n,caps:s}=z(),o=Ye(t),d=Ae(t),i=(t.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[t.sector,t.stage,t.countryLabel,t.city,t.website,t.domain,t.linkedinCompany,t.angle,t.date].filter(Boolean).length,m=[t.contactName,t.contactEmail,t.contactLinkedin].filter(Boolean).length,b=[t.ceoStatus,t.ceoNote,s.pipe?t.memoUrl:"",s.pipe?t.memoPdfUrl:""].filter(Boolean).length+(typeof t.engagement=="number"&&t.engagement>0?1:0),u=l.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(i?1:0)+(t.reasoning?1:0)+(d?1:0)},{k:"ana",lib:a.cdAnalyse,n:(t.summary?1:0)+(s.pipe&&!s.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:m},{k:"suivi",lib:a.cdSuivi,n:b}].filter(x=>x.n>0),[t,a,i,d,c,m,b]),[h,v]=l.useState("");if(!u.length)return null;const f=u.some(x=>x.k===h)?h:u[0].k;return e.jsxs("div",{className:"cdtabs",children:[e.jsx("div",{className:"cdnav",role:"tablist",children:u.map(x=>e.jsx("button",{type:"button",role:"tab","aria-selected":f===x.k,className:f===x.k?"on":"",onClick:g=>{g.stopPropagation(),v(x.k)},children:x.lib},x.k))}),e.jsxs("div",{className:"cdbody",onClick:x=>x.stopPropagation(),children:[f==="conv"&&e.jsxs(e.Fragment,{children:[i&&e.jsxs("div",{className:"cdv1"+(i==="NO MATCH"?" out":""),children:[e.jsx("b",{children:i==="NO MATCH"?a.vOut:a.vKept}),e.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.reasoning&&e.jsx("p",{className:"cdtxt",children:t.reasoning}),d&&e.jsxs("div",{className:"cdv1 memo",children:[e.jsx("b",{children:d}),e.jsx("span",{className:"cdw",children:a.cdMemo(t.memoType||"")})]}),e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(re,{k:a.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(re,{k:a.cdVerdictDate,v:Dt(t.verdictDate,r)})]})]}),f==="ana"&&e.jsxs(e.Fragment,{children:[t.summary&&e.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:cn(t.summary)}}),s.pipe&&!s.lockActions&&e.jsx(un,{o:t})]}),f==="soc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdSector,v:t.sector}),e.jsx(re,{k:a.cdStage,v:t.stage}),e.jsx(re,{k:a.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(re,{k:a.cdSite,v:t.domain||t.website,href:t.website||void 0}),e.jsx(re,{k:a.cdLinkedin,v:t.linkedinCompany?"LinkedIn":"",href:t.linkedinCompany}),e.jsx(re,{k:a.cdAngle,v:t.angle}),e.jsx(re,{k:a.cdDetected,v:Dt(t.date,r)})]}),f==="ctc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdName,v:t.contactName}),e.jsx(re,{k:a.cdEmail,v:t.contactEmail,href:t.contactEmail?`mailto:${t.contactEmail}`:void 0}),e.jsx(re,{k:a.cdLinkedin,v:t.contactLinkedin?"LinkedIn":"",href:t.contactLinkedin})]}),f==="suivi"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdCeoStatus,v:t.ceoStatus}),e.jsx(re,{k:a.cdEngagement,v:typeof t.engagement=="number"&&t.engagement>0?t.engagement:""})]}),t.ceoNote&&e.jsxs("p",{className:"cdtxt",children:["💬 ",t.ceoNote]}),s.pipe&&(t.memoUrl||t.memoPdfUrl)&&e.jsxs("div",{className:"cdacts",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),t.memoPdfUrl&&e.jsx("a",{className:"abtn",href:t.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function un({o:t}){const{t:a,token:r}=z(),[n,s]=l.useState(!1),[o,d]=l.useState(null),i=async()=>{n||(s(!0),d(await Da(r,t.name,t.website||t.domain||"")),s(!1))},c=(o==null?void 0:o.blocs)||{},m=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],b=m.some(([,u])=>u);return e.jsxs("div",{className:"qab",children:[!o&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mnote dim",children:a.qaHint}),e.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{i()},children:n?a.qaBusy:a.qaRun})]}),o&&b&&e.jsxs(e.Fragment,{children:[m.filter(([,u])=>u).map(([u,h])=>e.jsxs("div",{className:"qal",children:[e.jsx("span",{className:"qak",children:u}),e.jsx("p",{children:h})]},u)),!!(o.pages||[]).length&&e.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!b&&e.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Jt({name:t}){const{t:a,token:r,caps:n,mode:s,flashErr:o}=z(),[d,i]=l.useState(!1),[c,m]=l.useState(null);if(!n.pipe||s!=="client"||n.lockActions)return null;const b=async()=>{if(d)return;i(!0);const u=await Pa(r,t);if(i(!1),!u){o(a.actErr);return}m(u.results||[])};return e.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{b()},children:d?a.similarBusy:a.similar}),c&&(c.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:c.map(u=>e.jsxs("li",{children:[e.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&e.jsx("span",{children:u.reason})]},u.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Xt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function mt({o:t}){const{t:a}=z(),r=Ye(t),n=Ae(t),s=se(t),o=at(t),d=Ia(t);return e.jsxs("span",{className:"c-vd",children:[r?e.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):e.jsx("span",{className:"vd wait",children:a.actToEval}),n?e.jsx("span",{className:"vd "+(Xt[n]||"v-cons"),title:a.vt[n],children:n}):s===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,s===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),s===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),s===3&&d!==null&&e.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:a.waitTitle(d),children:a.waitChip(d)})]})}function Pt({o:t}){const{t:a,askEvaluate:r,evalBusy:n,lang:s}=z(),[o,d]=l.useState(!1);if(l.useEffect(()=>{n||d(!1)},[n]),de(t)){const m=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[m?"✓":"✗"," ",e.jsx("b",{children:m?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const c=o&&n;return e.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,onClick:m=>{m.stopPropagation(),d(!0),r(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function mn({o:t}){const{t:a,caps:r,memoQueued:n,approachDone:s,doAnalyse:o,doDecide:d,doPromote:i,doRepeche:c,doApproach:m,dispatch:b}=z();if(r.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:v=>{v.stopPropagation(),b({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Pt,{o:t})});const u=se(t),h=v=>f=>{f.stopPropagation(),v()};if(u===0)return e.jsx("span",{className:"cell",children:e.jsx(Pt,{o:t})});if(u===1){const v=n.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:h(()=>o(t)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:h(()=>d(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:h(()=>d(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})});if(u===4){const v=s.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:v,onClick:h(()=>m(t)),children:v?a.actApproachSent:a.actApproach})})}return u===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:h(()=>i(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):u===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:h(()=>c(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:h(()=>b({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function fn({o:t}){const{t:a,doThumb:r,thumbOf:n}=z(),s=n(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(s==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(s==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(t,!1)},children:"👎"})]})}function xn({o:t}){const{lang:a}=z();return ne(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(qe,{o:t}),e.jsx(We,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ze(t.engine||"")," ",ge(t.engine||"",a)]})})}function gn({o:t,locked:a,open:r,onToggle:n}){const{st:s,dispatch:o,caps:d,markRow:i,markedId:c,favIds:m,toggleFav:b}=z(),u=se(t),h=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,f=v<=0?0:v<=7?1:v<=30?2:3,x=d.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:h[f],g=m.has(t.id),p=y=>{if(a)return;if(d.pipe){n();return}const S=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return e.jsxs(l.Fragment,{children:[e.jsxs("div",{className:"row"+(c===t.id||r?" on":"")+(a?" locked":""),onMouseEnter:()=>i(t.id),onMouseLeave:()=>i(null),onClick:p,children:[e.jsx("span",{className:"pt",style:{"--c":x}}),e.jsx(na,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[d.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:g?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),b(t)},children:g?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(hn,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(xn,{o:t}),d.pipe&&e.jsx(mt,{o:t}),d.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(mn,{o:t}),d.showThumbs&&e.jsx(fn,{o:t})]}),(r||s.dens==="deplie")&&!a&&e.jsx(bn,{o:t})]})}function hn({o:t}){const{lang:a,caps:r}=z();if(r.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const n=ct(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function bn({o:t}){const{t:a,lang:r,dispatch:n,caps:s,outbound:o,doOnboard:d}=z();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),e.jsx(pn,{o:t}),e.jsx($r,{o:t}),e.jsx(Vr,{o:t}),e.jsx(Jt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(mt,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ze(t.engine||"")," ",ge(t.engine||"",r)]}),ne(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(qe,{o:t})})]}),s.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(t),children:a.actOnboard})]})]})]})}function vn({o:t,locked:a}){const{t:r,dispatch:n,caps:s,doDecide:o}=z(),d=se(t),i=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][d];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":i},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(mt,{o:t}),ne(t)&&e.jsx(qe,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&s.pipe&&d===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:r.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:r.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:t.id}),children:[r.actMemo," →"]})]})}function yn(){const t=z(),{st:a,dispatch:r,t:n,caps:s,scoped:o,lang:d,sessTally:i,data:c,dossiers:m}=t,[b,u]=l.useState(new Set);l.useEffect(()=>{u(new Set)},[a.ptab,a.continent]);const h=j=>u(E=>{const N=new Set(E);return N.has(j)?N.delete(j):N.add(j),N}),v=l.useMemo(()=>ut(o,a.sort),[o,a.sort]),f=l.useMemo(()=>v.filter(j=>ne(j)&&!de(j)).length,[v]),x=l.useMemo(()=>s.pipe?v:v.filter(j=>!de(j)),[v,s.pipe]),g=s.pipe?n.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,p=(j,E,N="",q=!1)=>e.jsxs("button",{type:"button","data-s":j,className:N,"aria-sort":a.sort.key===j?a.sort.dir===1?"ascending":"descending":"none",style:q?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:j}),children:[E,e.jsx("span",{className:"ar",children:a.sort.key===j&&a.sort.dir===1?"▴":"▾"})]},j),y=l.useMemo(()=>{if(s.pipe||a.groupBy==="none")return null;const j=new Map;return v.forEach(E=>{const N=E.engine||"?";j.has(N)||j.set(N,[]),j.get(N).push(E)}),[...j.entries()]},[v,s.pipe,a.groupBy]),S=s.lockRowsAfter;let w=0;const C=(j,E)=>{const N=a.shown[E]||Ve,$=j.slice(0,N).map(D=>{const T=S!==null&&w>=S;return w++,a.dens==="maxi"?e.jsx(vn,{o:D,locked:T},D.id):e.jsx(gn,{o:D,locked:T,open:b.has(D.id),onToggle:()=>h(D.id)},D.id)});return j.length>N&&$.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:E,by:Ve}),children:n.more(Math.min(Ve,j.length-N),j.length-N)},E+":more")),$};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:v.length})," ",g]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,s.pipe&&t.fund?" · "+t.fund:""]}),s.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:n.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),s.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",n.densList],["deplie",n.densOpen],["maxi",n.densMaxi]].map(([j,E])=>e.jsxs("button",{type:"button","data-d":j,"aria-pressed":a.dens===j,onClick:()=>r({type:"dens",dens:j}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:E})]},j))}),s.showChain&&x.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:x.map(j=>j.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",s.pipe?n.browse(x.length):n.chainAll(x.length)]})]}),f>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(f)}}),e.jsx("span",{className:"s",children:n.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),p("country",n.colCountry),p("name",n.colCompany),p("amount",n.colAmount,"h-amt",!0),p("stage",n.colStage,"h-stade"),p("signal",n.colSignal,"h-sig"),s.pipe&&e.jsx("span",{className:"h-vd",children:n.colVerdict}),s.pipe&&p("score",n.colScore,"h-sc",!0),e.jsx("span",{}),s.showThumbs&&e.jsx("span",{className:"h-thu",children:n.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[y?y.map(([j,E])=>e.jsxs(l.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ze(j)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:ge(j,d)}),e.jsx("div",{className:"s",children:n.grpCount(E.filter(N=>!de(N)).length,E.length)})]})]}),C(E,j)]},j)):C(v,"pt"+a.ptab),!v.length&&!(c.loading&&!m.length)&&e.jsx("div",{className:"void",children:s.pipe?n.emptyTab:n.emptyScope})]}),s.showThumbs&&e.jsxs("p",{className:"learn",children:[n.learnLine,e.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(i.kept>0||i.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(i.kept,i.dropped)}})]})}const wn=`
...
`;function kn(t){if(!t||typeof window>"u")return;const a=352,r=430,n=window.innerWidth,s=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,n-a-8));let d=t.y+10;return d+r>s-8&&(d=Math.max(8,t.y-r-14)),d<8&&(d=8),{left:o,top:d}}function jn(){const{st:t,dispatch:a,byId:r,t:n,lang:s,caps:o,mode:d,askEvaluate:i,doAnalyse:c,doDecide:m,doPromote:b,doRepeche:u,doApproach:h,doDeep:v,doOnboard:f,outbound:x,evalBusy:g}=z(),p=t.popupId?r.get(t.popupId):null;if(!p)return null;const y=ne(p),S=se(p),w=Ae(p),C=p.kind==="target",j=E=>{a({type:"filters",patch:E}),a({type:"popup",id:null})};return Fe.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:wn}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:kn(t.popupAnchor),onClick:E=>E.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:p.name}),e.jsx("span",{className:"id",children:n.detected(n.daysAgo(Te(p.date)),ge(p.engine,s))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[p.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>j({country:[p.cc]}),children:(Le(p.cc,s)||p.countryLabel||"").toUpperCase()}),p.sector&&e.jsx("button",{type:"button",onClick:()=>j({sector:[p.sector]}),children:p.sector.toUpperCase()}),p.stage&&e.jsx("button",{type:"button",onClick:()=>j({stage:[p.stage]}),children:p.stage.toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&e.jsx("span",{className:"am2",children:ct(p.amountEur,s)})]}),(p.tagline||p.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.desc}),e.jsx("p",{children:p.tagline||p.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.how}),e.jsxs("p",{children:[ze(p.engine)," ",e.jsx("b",{children:ge(p.engine,s)})," — ",Ba(p.engine,s),p.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",p.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(qe,{o:p,lg:!0})," ",e.jsx(We,{o:p,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Yt(y,s))," · ",n.win7(Wt(y,s))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),p.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&S>=1?n.verdictCap:n.memo}),e.jsx("p",{className:"memo",children:p.reasoning})]}),o.pipe&&C&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof p.score=="number"&&p.score>0?" · "+n.score(p.score):""]})})]}),e.jsx(Jt,{name:p.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||d!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[S===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>i(p),children:[e.jsx("span",{className:"fill"}),n.evalGo]}),S===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actAnalyse]}),S===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{b(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actPromote]}),S===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(p,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{m(p,!1),a({type:"popup",id:null})},children:n.actNo}),dt(p)&&e.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(p),a({type:"popup",id:null})},children:n.memoDeep})]}),S===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actApproach]}),S===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),n.actRepeche]}),p.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:p.id}),a({type:"popup",id:null})},children:"📄"}),x&&e.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{f(p),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>i(p),children:[e.jsx("span",{className:"fill"}),n.evalGo," →"]}),p.website&&e.jsx("a",{className:"psite",href:p.website.startsWith("http")?p.website:"https://"+p.website,target:"_blank",rel:"noopener noreferrer",title:p.website,children:"🌐"})]})]})]}),document.body)}function It(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Nn(t,a){const r=$a(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Sn(t,a){const n=[a.head.split("|").map(It).join(";")];for(const s of t){const o=a.stageOf(s);n.push([s.name||"",Nn(s,a.plabels),Ye(s)||s.verdict||"",typeof s.score=="number"?s.score:"",s.countryLabel||s.cc||"",s.sector||"",o?a.stageLabel(o.stage):"",s.contactName||"",s.contactEmail||"",s.memoUrl||"",(s.date||"").slice(0,10),(s.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(It).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Cn(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const En=(t,a)=>{const r=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function fe({k:t,v:a}){return a==null||a===""?null:e.jsxs("div",{className:"dsl",children:[e.jsx("span",{children:t}),e.jsx("b",{children:String(a)})]})}function zn({o:t,qa:a}){const{t:r,lang:n,fund:s}=z(),o=(t.cribleStatus||"").trim().toUpperCase()||(Ye(t)==="NO MATCH"?"NO MATCH":"MATCH"),d=Ae(t),i=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,i.value_prop],[r.qaProduct,i.produit],[r.qaModel,i.modele],[r.qaSummary,i.synthese]];return e.jsxs("article",{className:"dspage",children:[e.jsxs("header",{className:"dsh",children:[e.jsxs("div",{children:[e.jsx("b",{children:t.name}),t.tagline&&e.jsx("p",{children:t.tagline})]}),e.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,d&&e.jsx("em",{children:d})]})]}),t.reasoning&&e.jsxs("section",{children:[e.jsx("h3",{children:r.dsWhy}),e.jsx("p",{className:"dstxt",children:t.reasoning})]}),e.jsxs("section",{className:"dsgrid",children:[e.jsx(fe,{k:r.cdSector,v:t.sector}),e.jsx(fe,{k:r.cdStage,v:t.stage}),e.jsx(fe,{k:r.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(fe,{k:r.cdSite,v:t.domain||t.website}),e.jsx(fe,{k:r.cdName,v:t.contactName}),e.jsx(fe,{k:r.cdEmail,v:t.contactEmail}),e.jsx(fe,{k:r.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(fe,{k:r.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(fe,{k:r.cdAngle,v:t.angle}),e.jsx(fe,{k:r.cdDetected,v:En(t.date,n)})]}),c.some(([,m])=>m)&&e.jsxs("section",{children:[e.jsx("h3",{children:r.dsAnalysis}),c.filter(([,m])=>m).map(([m,b])=>e.jsxs("div",{className:"dsb",children:[e.jsx("span",{children:m}),e.jsx("p",{children:b})]},m))]}),(t.ceoStatus||t.ceoNote)&&e.jsxs("section",{children:[e.jsx("h3",{children:r.dsDecision}),t.ceoStatus&&e.jsx("p",{className:"dstxt",children:e.jsx("b",{children:t.ceoStatus})}),t.ceoNote&&e.jsxs("p",{className:"dstxt",children:["« ",t.ceoNote," »"]})]}),e.jsx("footer",{className:"dsf",children:r.dsFoot(s)})]})}function Tn(){const{t,lang:a,token:r,scoped:n,fund:s,data:o,dispatch:d}=z(),[i,c]=l.useState({}),m=25,b=l.useMemo(()=>n.slice(0,m),[n]);l.useEffect(()=>{b.length&&_a(r,b.map(v=>v.name)).then(c)},[r,b]);const u=o.stats,h=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return e.jsxs("div",{className:"dossier",children:[e.jsxs("div",{className:"dsbar",children:[e.jsx("b",{children:t.dsTitle(b.length)}),n.length>m&&e.jsx("span",{className:"mnote dim",children:t.dsCap(m,n.length)}),e.jsx("span",{className:"dssp"}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:t.printBtn})]}),e.jsxs("div",{className:"dscover",children:[e.jsx("b",{children:s}),u&&typeof u.screened=="number"&&e.jsxs("p",{children:[h(u.screened)," ",t.funScreened(""),typeof u.kept=="number"&&e.jsxs(e.Fragment,{children:[" · ",h(u.kept)," ",t.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&e.jsxs(e.Fragment,{children:[" · ",t.covOf(h(o.marketEstimate)),", ",Math.round(u.screened/o.marketEstimate*100)," %"]})]})]}),b.map(v=>e.jsx(zn,{o:v,qa:i[v.name]},v.id)),!b.length&&e.jsx("p",{className:"mnote",children:t.dsEmpty})]})}const An=50;function ft({label:t,onPreview:a,onTest:r,readOnly:n}){const{t:s}=z(),[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(""),[u,h]=l.useState(0),[v,f]=l.useState(""),[x,g]=l.useState(!1),p=l.useRef(null);l.useEffect(()=>()=>{p.current&&window.clearInterval(p.current)},[]);const y=async w=>{c(!0),b("");const C=await a();if(c(!1),C.ok){d(C);return}if(C.busy){b(s.alertPreviewBusy);return}if(!w){b(s.alertPreviewFail);return}h(An),p.current=window.setInterval(()=>{h(j=>j>1?j-1:(p.current&&window.clearInterval(p.current),y(!1),0))},1e3)},S=async()=>{if(n||x)return;g(!0),f("");const w=await r();g(!1),f(w.ok?s.alertTestOk(w.sentTo||""):w.error||s.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:i||u>0,onClick:()=>{y(!0)},children:i?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:n||x,onClick:()=>{S()},children:x?"…":s.alertTest})]}),u>0&&e.jsx("p",{className:"mnote",children:s.alertPreviewRetry(u)}),m&&e.jsx("p",{className:"mnote warn",children:m}),v&&e.jsx("p",{className:"mnote",children:v}),!v&&e.jsx("p",{className:"mnote dim",children:s.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:s.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:s.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Me="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function oe({title:t,icon:a,children:r,wide:n}){const{dispatch:s}=z();return Fe.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&s({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>s({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Ln(){const{st:t}=z();switch(t.modal){case"chain":return e.jsx(Rn,{});case"space":return e.jsx(On,{});case"alert":return e.jsx(Mn,{});case"queue":return e.jsx(Bn,{});case"export":return e.jsx($n,{});case"plug":return e.jsx(Vn,{});case"recharge":return e.jsx(Yn,{});case"cover":return e.jsx(Gn,{});case"dossier":return e.jsx(Wn,{});case"crit":return e.jsx(Kn,{});case"tuto":return e.jsx(Qn,{});case"rdv":return e.jsx(qn,{});case"memoalert":return e.jsx(_n,{});default:return null}}function qn(){const{dispatch:t,fund:a}=z(),r=typeof document<"u"&&!!document.getElementById("rdv");return l.useEffect(()=>{r&&(t({type:"modal",modal:null}),Rr())},[r,t]),r?null:e.jsx(Ha,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function Rn(){const{st:t,dispatch:a,byId:r,t:n,lang:s,mode:o,askEvaluate:d,evalBusy:i}=z(),c=o==="client",m=t.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=t.chain.idx,u=m[b],h=b>=m.length;return Fe.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:h?n.finished:`${b+1} / ${m.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(h?100:b/Math.max(1,m.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:h||!u?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:n.chainDone}),e.jsx("div",{className:"s",children:n.chainDoneSub(m.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:u.name}),e.jsx("div",{className:"sub",children:[Le(u.cc,s)||u.countryLabel,u.sector,u.stage,n.daysAgo(Te(u.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:ge(u.engine,s).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{children:ct(u.amountEur,s)})]}),ne(u)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(qe,{o:u,lg:!0})," ",e.jsx(We,{o:u,src:!0})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:n.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),c&&de(u)&&e.jsxs("div",{className:"vbox",style:{"--c":Ee(u)==="retenu"?"var(--brand)":Ee(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:Ee(u)==="retenu"?"✓ "+n.kept:Ee(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),e.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!h&&u&&!(c&&de(u))&&e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:i,onClick:()=>{d(u)},children:[e.jsx("span",{className:"fill"}),n.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(h?{type:"modal",modal:null}:{type:"chainNext"}),children:h?n.closeBtn:n.skip})]})]})})}),document.body)}function On(){const{st:t,dispatch:a,dossiers:r,t:n,mode:s}=z(),o=s==="client",d=l.useMemo(()=>o?r.filter(u=>de(u)):[],[r,o]),i=l.useMemo(()=>ut(d.filter(u=>Ee(u)==="retenu"),{key:"signal",dir:-1}),[d]),c=l.useMemo(()=>d.filter(u=>Ee(u)==="ecarte"),[d]),m=t.spaceTab==="retenu"?i:c,b=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(oe,{title:n.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:i.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),m.length===0&&e.jsx("div",{className:"sp-empty",children:n.spEmpty}),m.slice(0,40).map(u=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":b},children:typeof u.score=="number"&&u.score>0?u.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:u.name}),e.jsx("div",{className:"rr",children:u.reasoning||u.tagline||""})]})]},u.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Mn(){const{mode:t}=z();return t==="client"||t==="apercu"?e.jsx(Fn,{}):e.jsx(In,{})}function Fn(){const{t,token:a,flash:r,flashErr:n,mode:s}=z(),[o,d]=l.useState("d"),i=s!=="client";return e.jsxs(oe,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>d("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>d("w"),children:t.alertTabWeekly}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>d("m"),children:t.alertTabMarket})]}),o==="d"&&e.jsx(Dn,{t,token:a,readOnly:i,flash:r,flashErr:n}),o==="w"&&e.jsx(Pn,{t,token:a,readOnly:i,flash:r,flashErr:n}),o==="m"&&e.jsx(Zt,{})]})}function Dn({t,token:a,readOnly:r,flash:n,flashErr:s}){const[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(0);l.useEffect(()=>{let f=!0;return c(!1),Ct(a).then(x=>{f&&(x?d(x):c(!0))}),()=>{f=!1}},[a,m]);const u=f=>{r||Ct(a,f).then(x=>{if(!x){s(t.actErr);return}d(x),x.throttled?s(t.alertThrottled):n(t.alertSaved)})};if(i)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const h=f=>!o.sections||o.sections.includes(f),v=f=>{const x=o.sections||t.alertSec.map(([g])=>g);u({sections:h(f)?x.filter(g=>g!==f):[...x,f]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([f,x])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:h(f),disabled:r,onChange:()=>v(f)}),e.jsxs("span",{children:[x,f==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},f))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(ft,{label:t.alertPreview,readOnly:r,onPreview:()=>Xa(a),onTest:()=>Ja(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Pn({t,token:a,readOnly:r,flash:n,flashErr:s}){const[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(0);l.useEffect(()=>{let f=!0;return c(!1),Et(a).then(x=>{f&&(x?d(x):c(!0))}),()=>{f=!1}},[a,m]);const u=f=>{r||Et(a,f).then(x=>{if(!x){s(t.actErr);return}d(x),n(t.alertSaved)})};if(i)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const h=o.dow??0,v=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:h,disabled:r,onChange:f=>u({dow:Number(f.target.value)}),children:t.alertDow.map((f,x)=>e.jsx("option",{value:x,children:f},f))}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),e.jsxs("b",{children:[v," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,v+1)}),disabled:r,children:"＋"})]})]}),e.jsx(ft,{label:t.alertPreviewWeekly,readOnly:r,onPreview:()=>er(a),onTest:()=>Za(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Zt(){const{st:t,t:a,lang:r,scoped:n,contName:s,email:o}=z(),[d,i]=l.useState(o||""),[c,m]=l.useState(!1),[b,u]=l.useState(!1);l.useEffect(()=>{o&&i(o)},[o]);const h=t.filters,v=l.useMemo(()=>n.filter(p=>ne(p)).length,[n]),f=h.win==="1"?0:h.win==="7"?1:h.win==="30"?2:3,x=async()=>{if(!(!/.+@.+\..+/.test(d)||b)){u(!0);try{await fetch(`${ot}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:h.sector,countries:h.country,source:o?"atelier2-client":"atelier2",website:""})}),m(!0)}finally{u(!1)}}},g=[[a.amRows.continent,s],[a.amRows.since,a.amSince[f]],[a.amRows.signal,h.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,h.engine.length?h.engine.map(p=>ge(p,r)).join(", "):a.amAllEngines],[a.amRows.sectors,h.sector.length?h.sector.join(", "):a.amAllSectors],[a.amRows.countries,h.country.length?h.country.map(p=>Le(p,r)||p).join(", "):a.amAllCountries],[a.amRows.stages,h.stage.length?h.stage.join(", "):a.amAllStages]];return c?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:g.map(([p,y])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:p}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},p))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!o,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(b?" loading":""),style:{padding:"12px 18px"},onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})}function In(){const{t}=z();return e.jsx(oe,{title:t.alertTitle,icon:"🔔",children:e.jsx(Zt,{})})}function Bn(){var x,g,p;const{t,token:a,fund:r,mode:n,flash:s}=z(),[o,d]=l.useState(null),[i,c]=l.useState([]),[m,b]=l.useState(0),u=n==="client";l.useEffect(()=>{let y=!0;return(async()=>{const[S,w]=await Promise.all([it(r),Vt(a)]);y&&(S&&d(S),c(w))})(),()=>{y=!1}},[a,r,m]);const h=(o==null?void 0:o.per_day)??2,v=((x=o==null?void 0:o.analyzed_today)==null?void 0:x.length)??0,f=(g=o==null?void 0:o.tomorrow)!=null&&g.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(oe,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(v,v+(((p=o==null?void 0:o.pool_order)==null?void 0:p.length)??0))}})}),e.jsxs("div",{className:"qrate",children:[t.covRate," — ",e.jsx("b",{children:t.covRateNow(h)})]})]}),i.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:i.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),u&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{St(a,y.company,"retry").then(()=>b(S=>S+1))},children:t.queueRetry}),u&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{St(a,y.company,"delete").then(()=>b(S=>S+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[f.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),f.slice(0,10).map((y,S)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",S+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function $n(){const{t,token:a,flash:r,scoped:n,caps:s,stageOf:o,dispatch:d}=z(),i=`${Me}/cibles/list.csv?token=${a}`,c=`${Me}/cibles/list.json?token=${a}`,m=`${Me}/cibles/export.xlsx?token=${a}&scope=full`,b=`=IMPORTDATA("${i}")`,u=g=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>r(t.exportCopied))},h=[{def:t.exportCsv,value:i,href:i},{def:t.exportSheet,value:b},{def:t.exportLive,value:c,href:c},{def:t.exportXlsx,value:m,href:m}],v=!s.lockActions&&n.length>0,f=()=>{Cn(Sn(n,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:g=>(t.stg.find(([p])=>p===g)||["",""])[1]})),r(t.exportViewDone(n.length))},x=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(oe,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(n.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:x,children:t.printBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🗂"}),e.jsxs("div",{children:[e.jsx("b",{children:t.dsBtn}),e.jsx("p",{children:t.dsHint})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:t.exportViewBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(n.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:f,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:h.map(({def:g,value:p,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:g[0]}),e.jsxs("div",{children:[e.jsx("b",{children:g[1]}),e.jsx("p",{children:g[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>u(p),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},g[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function _n(){const{t,token:a,flash:r,flashErr:n,mode:s}=z(),o=s!=="client",[d,i]=l.useState(null),[c,m]=l.useState(!1),[b,u]=l.useState(0),[h,v]=l.useState(!1);l.useEffect(()=>{let p=!0;return m(!1),Nt(a).then(y=>{p&&(y?i(y):m(!0))}),()=>{p=!1}},[a,b]);const f=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},x=p=>{if(o||!d)return;const y={enabled:p.enabled??!!d.enabled,email:p.email??(d.email||""),sections:p.sections??f()};v(!0),Nt(a,y).then(S=>{if(v(!1),!S){n(t.memoAlertErr);return}i(S),r(t.memoAlertSaved)})};if(c)return e.jsx(oe,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>u(p=>p+1),children:t.retry})]})});if(!d)return e.jsx(oe,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const g=f();return e.jsxs(oe,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:o||h,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),e.jsx(Un,{value:d.email||"",readOnly:o||h,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:p=>x({email:p})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([p,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!g[p],disabled:o||h,onChange:()=>x({sections:{...g,[p]:!g[p]}})}),e.jsx("span",{children:y})]},p))}),e.jsx(ft,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Va(a,g),onTest:()=>Ua(a,g)})]})}function Un({value:t,readOnly:a,label:r,okLabel:n,onSave:s}){const[o,d]=l.useState(t);l.useEffect(()=>{d(t)},[t]);const i=o.trim()!==t.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:r}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:m=>d(m.target.value),onKeyDown:m=>{m.key==="Enter"&&i&&c&&s(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!i||!c,onClick:()=>s(o.trim()),children:n})]})]})}function Vn(){const{t,token:a,flash:r,flashErr:n,canWrite:s}=z(),[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(null),[u,h]=l.useState(""),[v,f]=l.useState(0);l.useEffect(()=>{let p=!0;return c(!1),rt(a).then(y=>{p&&(y?d({configured:y.configured,url_hint:y.url_hint}):c(!0))}),Wa(a).then(y=>{p&&b(y)}),()=>{p=!1}},[a,v]);const x=(p,y)=>{s&&rt(a,p).then(S=>{if(!S||S.ok===!1){n(t.actErr);return}p.test&&S.sent===!1?n(t.plugTestThrottled):r(y),f(w=>w+1)})},g='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(oe,{title:t.plugTitle,icon:"🔌",wide:!0,children:[m&&e.jsx("p",{className:"mnote"+(m.enabled?" warn":""),children:m.enabled?t.plugAutoOn(m.destination||"webhook"):t.plugAutoOff}),i?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>f(p=>p+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:u,disabled:!s,onChange:p=>h(p.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!s||!u.trim(),onClick:()=>x({url:u.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!s,onClick:()=>x({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!s,onClick:()=>x({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Hn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:g}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>r(t.exportCopied))},children:t.exportCopy})]})]})]})}function Hn(){const{t,token:a,lang:r}=z(),[n,s]=l.useState("valides"),[o,d]=l.useState(!1),[i,c]=l.useState(null),[m,b]=l.useState(null),[u,h]=l.useState(!1),[v,f]=l.useState(!1),[x,g]=l.useState(null),[p,y]=l.useState(null),[S,w]=l.useState(null),C=`atl2:bulk:${a}:${n}`;l.useEffect(()=>{rt(a).then(T=>{y(T&&T.configured?T.url_hint||"webhook":null)})},[a]),l.useEffect(()=>{c(null),b(null),h(!1),g(null);try{const T=JSON.parse(localStorage.getItem(C)||"null");w(T&&Date.now()-Date.parse(T.t)<24*3600*1e3?T:null)}catch{w(null)}},[C]);const j=async()=>{d(!0),h(!1),g(null);const T=await Ka(a,n);c(T),b(T.ok?n:null),d(!1)},E=l.useRef(!1),N=async()=>{if(E.current)return;E.current=!0,f(!0);const T=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await Qa(a,n,"webhook",void 0,T)}finally{E.current=!1}if(f(!1),h(!1),g(_),_.ok&&(_.pushed||0)>0){const F={t:new Date().toISOString(),n:_.pushed||0};w(F);try{localStorage.setItem(C,JSON.stringify(F))}catch{}}},q=i!=null&&i.ok&&i.ready||0,$=!!(i!=null&&i.ok)&&m===n&&q>0&&!!p&&!S,D=S?new Date(S.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:n,onChange:T=>s(T.target.value),children:t.plugBulkTabs.map(([T,_])=>e.jsx("option",{value:T,children:_},T))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{j()},children:o?"…":t.plugBulkPreview})]}),i&&(i.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(i.ready||0,i.linkedinReady||0,(i.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(i!=null&&i.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),S&&e.jsx("p",{className:"mnote",children:t.bulkLocked(D,S.n)}),!S&&!!(i!=null&&i.ok)&&!p&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!S&&!i&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),$&&!u&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>h(!0),children:t.bulkArm}),$&&u&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(q,p||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{N()},children:v?t.bulkSending:t.bulkConfirm(p||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>h(!1),children:t.bulkCancel})]}),x&&(x.ok?x.replayed?e.jsx("p",{className:"mnote",children:x.pending?t.bulkPending:t.bulkReplayed}):(x.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(x.pushed||0,x.linkedinReady||0,x.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:x.error||t.actErr}))]})}function Yn(){const{t,data:a,lang:r}=z(),n=a.credits,s=a.email,o=async d=>{if(!s)return;const i=window.location.href.split("?")[0];try{const m=await(await fetch(`${ot}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s,lookup_key:d,success_url:i+"?credits=ok",cancel_url:i+"?credits=cancel"})})).json();m.url&&(window.location.href=m.url)}catch{}};return e.jsxs(oe,{title:t.rechargeTitle,icon:"⚡",children:[n&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(n.daily_grant)}}),n.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(n.costs.instant)," · ② ",t.creditsCost(n.costs.detailed)]}),e.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(d.credits,d.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(d.lookup_key)},children:t.rechargeBuy})]},d.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!n&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Wn(){const{t}=z();return e.jsx(oe,{title:t.dsBtn,icon:"🗂",wide:!0,children:e.jsx(Tn,{})})}function Gn(){const{t,lang:a,data:r,dossiers:n,token:s,canWrite:o,flash:d}=z(),[i,c]=l.useState(null),[m,b]=l.useState(!1);l.useEffect(()=>{let j=!0;return it(s).then(E=>{j&&E&&typeof E.per_day=="number"&&c(E.per_day)}),()=>{j=!1}},[s]);const u=r.stats,h=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(j=>j.kind==="target"&&de(j)).length,v=r.marketEstimate||0,f=v>0?Math.min(100,Math.round(h/v*100)):null,x=(u==null?void 0:u.window_days)||30,g=h>0?h/x:0,p=v>0?Math.max(0,v-h):0,S=v>0&&g>0&&h>=100?Math.round(p/g):null,w=j=>Math.round(j).toLocaleString(a==="en"?"en-US":"fr-FR"),C=j=>{m||!o||(b(!0),Ga(s,j).then(E=>{if(b(!1),E===null){d(t.actErr);return}c(E),d(t.alertSaved)}))};return e.jsxs(oe,{title:t.coverTitle,icon:"🌍",children:[e.jsxs("div",{className:"covg",children:[e.jsx("b",{children:t.covScreened(w(h))}),v>0&&e.jsx("span",{children:t.covOf(w(v))})]}),f!==null?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"covbar",children:[e.jsx("i",{style:{width:f+"%"}}),e.jsxs("em",{children:[f," %"]})]}),S!==null&&e.jsx("p",{className:"mnote",children:t.covEta(S)})]}):e.jsx("p",{className:"mnote dim",children:t.covNoEst}),g>=1&&e.jsx("p",{className:"mnote",children:t.covPace(w(g))}),u&&e.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.kept)})," ",t.covKept]}),typeof u.analyzed=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.analyzed)})," ",t.covAna]}),typeof u.shown=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.shown)})," ",t.covShown]})]}),o&&i!==null&&e.jsxs("div",{className:"covr",children:[e.jsxs("div",{className:"covrh",children:[e.jsx("span",{children:t.covRate}),e.jsx("b",{children:t.covRateNow(i)})]}),e.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(j=>e.jsx("button",{type:"button",className:i===j?"on":"",disabled:m,onClick:()=>C(j),children:j===0?"⏸":j},j))}),e.jsx("p",{className:"mnote dim",children:t.covRateHint})]})]})}function Kn(){var p,y,S;const{t,dossiers:a,token:r,mode:n,flash:s,criteria:o}=z(),d=n==="client",i=l.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[c,m]=l.useState(null);l.useEffect(()=>{let w=!0;return Ya(r).then(C=>{w&&m(C.thumbs)}),()=>{w=!1}},[r]);const[b,u]=l.useState(""),[h,v]=l.useState(""),[f,x]=l.useState(!1),g=async()=>{const w=b.trim();if(!(!w||f||!d)){x(!0),v("");try{const j=await(await fetch(`${Me}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(j.reply&&v(String(j.reply)),j.job_id){v(t.critChatRunning);const E=async()=>{const N=await fetch(`${Me}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:j.job_id})}).then(q=>q.json()).catch(()=>null);if(N&&N.done){v(String(N.reply||N.clarification||N.summary||"✓")),x(!1),N.applied&&s(t.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),u("");return}u("")}finally{h.startsWith("⏳")||x(!1)}}};return e.jsxs(oe,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((p=o.points)!=null&&p.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(w=>{var C,j;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(E=>e.jsx("li",{children:E},E))})]}),!!((j=w.out)!=null&&j.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(E=>e.jsx("li",{children:E},E))})]})]})]},w.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),i.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:i.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:b,disabled:!d||f,onChange:w=>u(w.target.value),onKeyDown:w=>{w.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!d||f||!b.trim(),onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),h&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:h})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((w,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Xt[w]||"v-cons"),children:w}),e.jsx("span",{children:C})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",C]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Qn(){const{t,dispatch:a,startTour:r}=z(),n=s=>{var o,d;a({type:"modal",modal:null}),s==="crit"||s==="plug"||s==="alert"?a({type:"modal",modal:s}):s.startsWith("tab")?a({type:"ptab",tab:Number(s.slice(3))}):s==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return e.jsxs(oe,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([s,o],d)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),n(o))},children:[e.jsx("span",{className:"n",children:d+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+d))})]})}const tt={},Bt=(tt==null?void 0:tt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function He(){return new Date().toISOString().slice(0,10)}const ea=l.createContext(null);function ta(){const t=l.useContext(ea);if(!t)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return t}function Jn({token:t,children:a}){const{dispatch:r,st:n,lang:s}=z(),[o,d]=l.useState(()=>n.filters.day||He()),[i,c]=l.useState(null),[m,b]=l.useState(!1),u=l.useCallback(f=>{if(/^\d{4}-\d{2}-\d{2}$/.test(f)){d(f);try{r({type:"filters",patch:{day:f,win:"all"}})}catch{}}},[r]);l.useEffect(()=>{n.filters.day||u(He())},[]),l.useEffect(()=>{const f=x=>{var p;const g=(p=x.detail)==null?void 0:p.day;typeof g=="string"&&u(g)};return window.addEventListener("pp-edition-day",f),()=>window.removeEventListener("pp-edition-day",f)},[u]),l.useEffect(()=>{n.filters.day&&n.filters.day!==o&&d(n.filters.day)},[n.filters.day]),l.useEffect(()=>{if(!t||!o)return;let f=!1;b(!0);const x=new URLSearchParams({token:t,date:o});return fetch(`${Bt}/cibles/edition.json?${x}`).then(g=>g.json()).then(g=>{f||c(g)}).catch(()=>{f||c({ok:!1,error:"network"})}).finally(()=>{f||b(!1)}),()=>{f=!0}},[t,o]);const h=l.useMemo(()=>`${Bt}/cibles/editions.json?token=${encodeURIComponent(t)}`,[t]),v=l.useMemo(()=>({token:t,day:o,ed:i,loading:m,pickDay:u,daysUrl:h,isEn:s==="en"}),[t,o,i,m,u,h,s]);return e.jsx(ea.Provider,{value:v,children:a})}function Xn(){const{day:t,daysUrl:a,pickDay:r,isEn:n}=ta();return e.jsxs("div",{className:"thesis-days",children:[e.jsx("style",{children:`
      ...
      `}),e.jsx("p",{className:"thesis-days__h",children:n?"Thesis brief · pick a day":"Brief thèse · choisir un jour"}),e.jsx(tr,{mode:"local",theme:"light",month:t.slice(0,7),current:t,daysUrl:a,onPick:r})]})}function Zn(){const{day:t,ed:a,loading:r,pickDay:n,isEn:s}=ta(),o=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!o,i=a&&!a.ok;return e.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||t,"data-fund":(a==null?void 0:a.fund)||"",children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("header",{className:"thesis-brief__hd",children:[e.jsx("span",{className:"thesis-brief__kicker",children:s?"Daily brief":"Brief du jour"}),e.jsxs("h2",{className:"thesis-brief__title",children:[s?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||t)&&e.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||t,children:(a==null?void 0:a.date)||t})]}),e.jsx("p",{className:"thesis-brief__hint",children:s?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!o&&e.jsx("p",{className:"thesis-brief__loading",children:s?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),i&&e.jsxs("p",{className:"thesis-brief__err",children:[s?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&e.jsx("p",{className:"thesis-brief__empty",children:s?e.jsxs(e.Fragment,{children:["No thesis brief for ",e.jsx("b",{children:t})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):e.jsxs(e.Fragment,{children:["Pas encore de brief de thèse pour le ",e.jsx("b",{children:t}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),o&&(a!=null&&a.html)?e.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,o&&(a!=null&&a.acquirers_html)?e.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,t&&t!==He()&&e.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:()=>n(He()),children:s?"← Back to today":"← Revenir à aujourd’hui"})]})}const aa="atl2:mapfold",eo=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(aa);if(t==="on")return!0;if(t==="off")return!1}catch{}return window.innerHeight<1e3},ra=l.createContext(null),z=()=>{const t=l.useContext(ra);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function qe({o:t,lg:a}){const{lang:r}=z(),n=ne(t);return n?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:zt(n,r),children:[n.emoji," ",zt(n,r)]}):null}function We({o:t,src:a}){const{lang:r,t:n}=z(),s=ne(t);if(!s)return null;const o=sr(s),d=ir(s);return e.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Yt(s,r))+" · "+n.win7(Wt(s,r)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(i,c)=>e.jsx("i",{className:c<o?"on":""},c))}),e.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,s.left??0))}),a&&s.url&&e.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:i=>i.stopPropagation(),children:"↗"})]})}function na({o:t}){const{lang:a}=z(),r=or(t.cc),n=t.cc?Le(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:n||void 0,children:r?e.jsx("img",{src:r,width:24,height:18,alt:n||""}):e.jsx("span",{className:"em",children:"🌐"})})}const $t="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",oa=t=>`atl2:tour:${t||"anon"}`;function to(t){try{return localStorage.getItem(oa(t))==="1"}catch{return!0}}function _t(t){try{localStorage.setItem(oa(t),"1")}catch{}}function ao(t){const a=t.tourT,r=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function lo({demo:t=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:s,onFiltersChange:o}){const{lang:d}=ar(),i=xr[d],c=Cr(t,d,a),[m,b]=l.useReducer(zr,void 0,()=>Er((n==null?void 0:n.continent)??"europe",t||eo(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),u=l.useRef(!0);l.useEffect(()=>{if(u.current){u.current=!1;return}if(!t)try{localStorage.setItem(aa,m.mapFolded?"on":"off")}catch{}},[m.mapFolded,t]);const h=l.useRef(o);h.current=o,l.useEffect(()=>{var k;(k=h.current)==null||k.call(h,m.filters)},[m.filters]);const[v,f]=l.useState(null),[x,g]=l.useState(null),[p,y]=l.useState({kept:0,dropped:0}),[S,w]=l.useState(!1),[C,j]=l.useState(""),[E,N]=l.useState(!1),[q,$]=l.useState(null),[D,T]=l.useState(!1),[_,F]=l.useState(!1),[,Q]=l.useState(0),P=()=>Q(k=>k+1),ie=l.useRef([]),me=l.useRef(new Set),he=l.useRef(new Set),be=l.useRef(new Map),I=l.useRef(null),{mode:ce}=c,V=l.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...s||null}),[c.caps,s,a]),U=V.pipe,M=c.session.token||"",B=ce==="client"&&!t;l.useEffect(()=>{if(document.querySelector(`link[href="${$t}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=$t,document.head.appendChild(k)},[]);const O=(k,L=!1)=>{j(k),N(L),I.current&&clearTimeout(I.current),I.current=setTimeout(()=>j(""),L?4200:2400)},K=k=>O(k,!0),G=l.useMemo(()=>{const k=new Map;return c.dossiers.forEach(L=>{L.id&&k.set(L.id,L)}),k},[c.dossiers]),ae=l.useMemo(()=>c.dossiers.filter(k=>Kt(k,m,U)),[c.dossiers,m,U]),Z=l.useRef(!1);l.useEffect(()=>{if(Z.current||t||c.loading||!c.dossiers.length)return;if(!V.showFunnel||to(c.session.token||"")){Z.current=!0;return}Z.current=!0;const k=window.setTimeout(()=>{_t(c.session.token||""),T(!0)},700);return()=>window.clearTimeout(k)},[t,c.loading,c.dossiers.length,V.showFunnel,c.session.token]);const ee=l.useMemo(()=>c.dossiers.filter(k=>Tr(k,m,U,c.favIds)),[c.dossiers,m,U,c.favIds]),ve=l.useMemo(()=>rr(ae,c.favIds),[ae,c.favIds]),H=lt.find(k=>k.key===m.continent),le=d==="fr"?H.fr:H.en;l.useEffect(()=>{const k=L=>{var X;const R=(((X=L.detail)==null?void 0:X.name)||"").trim();R&&pe(null,R)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)});const pe=(k,L)=>{const R=((k==null?void 0:k.name)||L||"").trim();if(!B){g({kicker:R});return}!R||S||(w(!0),(async()=>{try{const X=await Ht(M,R,"atelier2"),Pe={name:X.company||R,verdict:X.verdict,reason:X.reason||"",remaining:X.remaining??null};ie.current=[Pe,...ie.current].slice(0,8),X.verdict==="kept"&&y(Ne=>({...Ne,kept:Ne.kept+1})),X.verdict==="ruled_out"&&y(Ne=>({...Ne,dropped:Ne.dropped+1}));const Re=k||c.dossiers.find(Ne=>(Ne.name||"").toLowerCase()===R.toLowerCase());Re&&(X.verdict==="kept"?Re.verdict=Re.verdict||"MATCH":X.verdict==="ruled_out"&&(Re.verdict="NO MATCH"),X.reason&&(Re.reasoning=X.reason)),P()}finally{w(!1)}})())},ye=k=>{if(!B){g({kicker:k.name});return}me.current.add(k.id),Oe(M,"fast_request",k.name||"",""),O(i.memoInstantSent(k.name)),P()},xe=k=>be.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),A=(k,L)=>b({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:L}}),Y=async(k,L,R)=>{const X=k.ceoStatus||"";k.ceoStatus=L,P();const Pe=await Xe(M,{status:L,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(R==null?void 0:R.note)!==void 0?{note:R.note}:{},...R!=null&&R.via?{via:R.via}:{}});return Pe.ok?Pe.skipped?(k.ceoStatus=X,P(),K(i.actNotPersisted),!1):((R==null?void 0:R.undo)!==!1&&A(k,X),R!=null&&R.msg&&O(R.msg),(L==="Validé"||L==="Écarté")&&!k.ceoNote&&(R==null?void 0:R.note)===void 0&&$({o:k,yes:L==="Validé"}),!0):(k.ceoStatus=X,P(),K(i.actErr),!1)},J=async(k,L)=>{const R=await Xe(M,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:L,via:"note"});return!R.ok||R.skipped?(K(R.skipped?i.actNotPersisted:i.actErr),!1):(k.ceoNote=L,P(),!0)},W=l.useRef(new Map),ue=k=>W.current.has(k.id)?W.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),we=(k,L)=>{W.current.set(k.id,L),P()},ke=(k,L)=>{B&&Y(k,L?"Validé":"Écarté",{msg:L?i.decidedYes(k.name):i.decidedNo(k.name)})},De=k=>{B&&Y(k,"À trancher",{msg:i.promoted(k.name)})},Ge=k=>{B&&(async()=>{const L=k.ceoStatus||"";k.ceoStatus="Retenu",P();const R=await Xe(M,{status:"Retenu",check_id:k.checkId,company:k.name});if(!R.ok||R.skipped){k.ceoStatus=L,P(),K(R.skipped?i.actNotPersisted:i.actErr);return}A(k,L),O(i.repeched(k.name))})()},Ke=()=>{const k=m.undo[m.undo.length-1];if(!k){O(i.undoNone);return}const L=G.get(k.id);if(!L){b({type:"undoPop"}),O(i.undoNone);return}let R=k.prevCeoStatus;if(!R)if((L.verdict||"").toUpperCase().includes("CALL"))R="À trancher";else{O(i.undoLockedTitle);return}(async()=>await Y(L,R,{undo:!1})&&(b({type:"undoPop"}),L.ceoStatus=k.prevCeoStatus,P(),O(i.undoDone(L.name))))()},je=k=>{B&&(he.current.add(k.id),P(),(async()=>{const L=await lr(M,k.name,"email");if(!L||L.ok===!1){he.current.delete(k.id),P(),K(i.actErr);return}Oe(M,"approach",k.name||"",""),O(i.actApproachSent)})())},sa=(k,L)=>{B&&(async()=>{if(!(await Oe(M,L?"yes":"no",k.name||"","")).ok){K(i.actErr);return}be.current.set(k.id,L?"yes":"no"),P(),O(L?i.thumbUpDone:i.thumbDnDone)})()},ia=k=>{!B||!dt(k)||(Oe(M,"detailed_request",k.name||"",""),O(i.memoDeepSent(k.name)))},la=k=>{const L=new Set(c.favIds),R=L.has(k.id);R?L.delete(k.id):L.add(k.id),c.setFavIds(L),B&&dr(M,{id:k.id,co:k.name},R)},da=()=>{!B||_||window.confirm(i.identSyncConfirm)&&(F(!0),(async()=>{const k=await cr(M);F(!1),k?O(i.identSyncDone):K(i.actErr)})())},xt=/proplace/i.test(c.fund||""),ca=k=>{!B||!xt||(Oe(M,"onboard_request",k.name||"",""),O(i.onboardSent(k.name)))},pa={st:m,dispatch:b,t:i,lang:d,mode:ce,caps:V,pipe:U,token:M,fund:c.fund,email:c.email,criteria:c.criteria,data:c,doRepeche:Ge,thumbOf:xe,canWrite:B,commitStatus:Y,saveNote:J,stageOf:ue,setStage:we,flashErr:K,startTour:()=>T(!0),dossiers:c.dossiers,scopedAll:ae,scoped:ee,counts:ve,byId:G,contName:le,favIds:c.favIds,toggleFav:la,askEvaluate:pe,doAnalyse:ye,doDecide:ke,doPromote:De,doApproach:je,doThumb:sa,doDeep:ia,doUndo:Ke,doSync:da,doOnboard:ca,outbound:xt,memoQueued:me.current,approachDone:he.current,sessTally:p,evalCards:ie.current,evalBusy:S,markRow:f,markedId:v,flash:O};l.useEffect(()=>{const k=L=>{L.key==="Escape"&&(b({type:"popup",id:null}),b({type:"modal",modal:null}),b({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const ua=k=>M?e.jsx(Jn,{token:M,children:k}):e.jsx(e.Fragment,{children:k});return e.jsx(ra.Provider,{value:pa,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:br}),ua(e.jsxs("div",{className:"app"+(U?" pipe":"")+(M?" has-thesis":""),children:[V.showTicker&&e.jsx(te,{name:"live",children:e.jsxs("div",{className:"live-stack"+(M?" live-stack--cibles":""),children:[e.jsx(Ar,{}),!!M&&e.jsx(Xn,{})]})}),V.showIdent&&e.jsx(te,{name:"identite",children:e.jsx(Wr,{})}),V.showOnb&&e.jsx(te,{name:"onboarding",children:e.jsx(Gr,{})}),V.showMorning&&e.jsx(te,{name:"matin",children:e.jsx(Yr,{})}),e.jsx(te,{name:"fraicheur",children:e.jsx(Pr,{})}),e.jsx(te,{name:"mesure",children:e.jsx(Ir,{})}),V.showFunnel&&e.jsx(te,{name:"entonnoir",children:e.jsx(ro,{})}),V.showFunnel&&e.jsx(te,{name:"tunnel",children:e.jsx(Qr,{})}),V.showFunnel&&e.jsx(te,{name:"tuto",children:e.jsx(Xr,{})}),e.jsx(te,{name:"carte",fallback:e.jsx("div",{className:"void",children:i.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(no,{}),e.jsxs("div",{className:"stage"+(m.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(en,{}),e.jsx(an,{})]})]})}),V.showDemand&&e.jsx(te,{name:"evaluation",children:e.jsx(on,{})}),V.showDemand&&m.memoConsole&&e.jsx(te,{name:"console",children:e.jsx(ln,{})}),e.jsx(te,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[i.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:i.retry})]}),children:e.jsx(yn,{})}),!!M&&e.jsx(te,{name:"edition",children:e.jsx(Zn,{})}),c.loading&&e.jsx("div",{className:"void",children:i.loadingV2}),c.error&&!c.loading&&e.jsxs("div",{className:"void",children:[i.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:i.retry})]})]})),V.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:i.lockbarText}),e.jsx("button",{type:"button",onClick:()=>b({type:"modal",modal:"rdv"}),children:i.lockbarCta})]}),m.popupId&&e.jsx(te,{name:"fiche",children:e.jsx(jn,{})}),e.jsx(te,{name:"modales",children:e.jsx(Ln,{})}),e.jsx(Mr,{}),q&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:q.o.name}),e.jsx(Ur,{placeholder:q.yes?i.whyYesPh:i.whyNoPh,onDone:k=>{const L=q.o;$(null),k&&J(L,k).then(R=>{R&&O(i.csNoteSaved)})}})]}),D&&e.jsx(Hr,{steps:ao(i),onClose:()=>{T(!1),_t(M)}}),C&&e.jsx("div",{className:"flash on"+(E?" err":""),children:C}),x&&e.jsx(nr,{variant:"acquirer",initialCompany:Ut().co,initialWebsite:Ut().site,onClose:()=>g(null)})]})})}function ro(){const{t}=z(),[a,r]=l.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function no(){const{dossiers:t,st:a,dispatch:r,pipe:n,lang:s,t:o}=z(),d=l.useMemo(()=>{const i={};return t.forEach(c=>{c.continent&&pt(c,a.filters,n)&&(i[c.continent]=(i[c.continent]||0)+1)}),i},[t,a.filters,n]);return e.jsxs("div",{className:"conts",children:[pr.map(i=>{const c=lt.find(m=>m.key===i);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===i,onClick:()=>r({type:"continent",key:i}),children:[s==="fr"?c.fr:c.en,e.jsx("span",{className:"n",children:d[i]||0})]},i)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ut(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function oo(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{na as FlagCell,qe as SigBadge,We as SigWin,lo as default,oo as fmtShort,z as useV2};
;/* deploy-1786483631 */
