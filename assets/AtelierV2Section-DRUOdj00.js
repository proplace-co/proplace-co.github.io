...
`,Xi=Qi+Ji;function Xa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Zi(){const e=Xa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function es(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Zi();return r==="0"?"client":r==="1"||Xa("embed")==="1"&&Xa("chrome")==="1"?"apercu":"client"}const ts={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},as=e=>ts[e];function wa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const jt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Lr(a)||wa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Uo(e.cc)})};function Ia(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const ns=60*60*1e3;function rs(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ns?null:a}catch{return null}}function la(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const os=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function is(e,a,r="default"){const n=r!=="default",o=m.useMemo(()=>e||n?{mode:"anon"}:Lo(),[e,n]),i=m.useMemo(()=>n?"visiteur":es(e,o),[e,o,n]),s=m.useMemo(()=>as(i),[i]),d=i!=="visiteur",c=os(r),[g,l]=m.useState([]),[f,u]=m.useState(""),[b,p]=m.useState(null),[v,y]=m.useState(null),[h,N]=m.useState(null),[C,k]=m.useState(()=>new Map),[j,z]=m.useState(()=>new Map),[E,q]=m.useState(""),[A,F]=m.useState(new Set),[P,I]=m.useState(null),[L,R]=m.useState(!0),[x,T]=m.useState(!1),[B,G]=m.useState(0),[H,Q]=m.useState(0),X=m.useRef(0),K=m.useMemo(()=>{var ee;if(i!=="client")return"";try{return((ee=Fo())==null?void 0:ee.email)||""}catch{return""}},[i]);m.useEffect(()=>{const ee=++X.current;let xe=!0;const _=()=>xe&&ee===X.current,se=(d&&o.token?o.token:"pub:"+a)+(c?":"+c:""),me=rs(se);return me?(l(me.objs.map(jt)),me.fund&&u(me.fund),p(me.marketEstimate??null),y(me.criteria??null),N(me.stats??null),q(me.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const Le=await Oa(),te=((Le==null?void 0:Le.recent_ops)||[]).map(pe=>{const he=xa(pe.company_name||pe.title?pe:{...pe,title:(pe.headline_fr||pe.headline||"").slice(0,120)},a),de=String(pe.rubrique||"").toLowerCase();return he&&(de==="nominations"||de==="recrutements")&&(he.engine=de),he&&!String(pe.company_name||"").trim()&&(he.noCo=!0),he}).filter(pe=>!!pe).map(pe=>(Lr((pe.name||"").trim())||(pe.noCo=!0),pe));try{const pe=Ro(),he=await Mo(),de=((he==null?void 0:he.date)||"").slice(0,10),Y=pe?pe.doc:he,ae=Oo(Y),ie=((pe==null?void 0:pe.day)||(Y==null?void 0:Y.date)||de||"").slice(0,10);if(ie&&ae.length){const ge=new Set;for(const Se of te){if((Se.date||"").slice(0,10)!==ie)continue;const re=qn(ae,ge,Se.name,"");re>=0&&(ge.add(re),Se.decryptHtml=ae[re].html)}for(const Se of te){if(Se.decryptHtml||(Se.date||"").slice(0,10)!==ie)continue;const re=qn(ae,ge,"",Se.headline||Se.tagline||Se.name);re>=0&&(ge.add(re),Se.decryptHtml=ae[re].html)}}if(ie){const ge=((Y==null?void 0:Y.title_fr)||"").trim(),Se=((Y==null?void 0:Y.lead_fr)||"").trim(),re=Do(Y),ce=((Y==null?void 0:Y.url)||"").trim();ge&&(re||ce)&&te.unshift({id:`edito:${ie}`,kind:"op",name:ge,cc:null,date:ie,engine:"edito",dealKind:"other",headline:ge,tagline:Se||ge,decryptHtml:re||void 0,url:ce,noCo:!0})}}catch{}if(!_())return;l(te.map(jt)),la(se,{objs:te})}else if(typeof r=="object"){const te=(await Ln()||[]).filter(he=>(he.slug||"")===r.research).map(he=>Fn(he,a)).filter(he=>!!he),pe=Ia(await Rn(te,a));if(!_())return;l(pe.map(jt)),la(se,{objs:pe})}else if(d&&o.token){const Le=Po(o.token),te=Oa(),pe=Io(o.token),he=Bo(o.token),de=_o(o.token),Y=await Le;let ae=Y?Y.targets:[];_()&&Y&&(u(Y.fund||""),p(Y.marketEstimate??null),y(Y.criteria??null),N(Y.stats??null),q(Y.generatedAt||""),l(ae.map(jt)),R(!1),T(!1));const[ie,ge,Se,re]=await Promise.all([te,pe,he,de]),ce=((ie==null?void 0:ie.recent_ops)||[]).map(Ce=>xa(Ce,a)).filter(Ce=>!!Ce),Ie=new Set(ae.map(Ce=>Ce.id));if(ae=[...ae,...ce.filter(Ce=>!Ie.has(Ce.id)&&(Ie.add(Ce.id),!0))],!_())return;l(ae.map(jt));const Oe=new Set;for(const Ce of ge){const ve=(Ce.id||Ce.co||"").toString().trim().toLowerCase();ve&&Oe.add(ve.startsWith("t:")?ve:"t:"+ve)}F(Oe),k(Se),z(re),Y&&la(se,{fund:Y.fund,marketEstimate:Y.marketEstimate,criteria:Y.criteria,stats:Y.stats,generatedAt:Y.generatedAt,objs:ae})}else{const Le=$o(),te=Ln(),pe=Oa(),he=await Le;_()&&he.length&&(l(Ia(he).map(jt)),R(!1),T(!1));const[de,Y]=await Promise.all([te,pe]),ae=(de||[]).map(re=>Fn(re,a)).filter(re=>!!re),ie=await Rn(ae,a),ge=((Y==null?void 0:Y.recent_ops)||[]).map(re=>xa(re,a)).filter(re=>!!re),Se=Ia([...he,...ie,...ge]);if(!_())return;l(Se.map(jt)),la(se,{objs:Se})}_()&&T(!1)}catch{_()&&!me&&T(!0)}finally{_()&&R(!1)}})(),()=>{xe=!1}},[d,o.token,a,B,c]),m.useEffect(()=>{if(!s.showCredits||!K){I(null);return}let ee=!0;return(async()=>{try{const xe=await fetch(`${hn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K})});if(!xe.ok)return;const _=await xe.json();ee&&_&&_.ok!==!1&&I(_)}catch{}})(),()=>{ee=!1}},[s.showCredits,K,H]);const ue=m.useCallback(ee=>F(new Set(ee)),[]);return{session:o,mode:i,caps:s,fund:f,email:K,marketEstimate:b,generatedAt:E,criteria:v,stats:h,thumbs:C,stages:j,dossiers:g,favIds:A,setFavIds:ue,credits:P,reloadCredits:()=>Q(ee=>ee+1),loading:L,error:x,refresh:()=>G(ee=>ee+1)}}function Ve(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Br=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ss=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Br(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ls=new Set(["signal","amount","score","crible","memo"]);function ds(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Br(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ls.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??_r)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const _r=80;function ka(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Re(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(xn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(pt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Et(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ja(e,a,r){return Ve(e)?ka(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ka(e,a.filters,r)}function cs(e,a,r,n){return!(!ja(e,a,r)||r&&!Ho(e,a.ptab,n))}function vn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-pt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Wo(o);case"memo":return Vo(o);case"signal":{const i=Re(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const s=n(o),d=n(i);return s<d?-a.dir:s>d?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ba={},Hn=(Ba==null?void 0:Ba.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Vn(){return new Date().toISOString().slice(0,10)}const yn=m.createContext(null);function $r(){return m.useContext(yn)}function ps(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),s=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(l=>c.removeAttribute(l.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:d.outerHTML})}}catch{}return a}function us(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),s=o.value,d=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(s);!d&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function Wn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),s=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(d=>n.removeAttribute(d.name)),s&&n.setAttribute("class",s),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Gn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${i} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${i} ${r[1]}`}function Ur(){const e=m.useContext(yn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ms({token:e,children:a}){const{dispatch:r,st:n,lang:o}=W(),[i,s]=m.useState(()=>n.filters.day||Vn()),[d,c]=m.useState(null),[g,l]=m.useState(!1),f=m.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){s(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{s(Vn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const v=y=>{var N;const h=(N=y.detail)==null?void 0:N.day;typeof h=="string"&&f(h)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[f]),m.useEffect(()=>{n.filters.day&&n.filters.day!==i&&s(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!i)return;let v=!1;l(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Hn}/cibles/edition.json?${y}`).then(h=>h.json()).then(h=>{v||c(h)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||l(!1)}),()=>{v=!0}},[e,i]);const b=m.useMemo(()=>`${Hn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:i,ed:d,loading:g,pickDay:f,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,d,g,f,u,n.filters.day,b,o]);return t.jsx(yn.Provider,{value:p,children:a})}function fs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Ur(),[o,i]=m.useState(()=>n||Fr());return m.useEffect(()=>{n&&i(!0)},[n]),m.useEffect(()=>{const s=d=>{var c;return i(!!((c=d.detail)!=null&&c.open))};return window.addEventListener(ya,s),()=>window.removeEventListener(ya,s)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Go,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function hs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Yn(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Kn(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function xs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Ur(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!s,c=a&&!a.ok,g=m.useRef(null),[l,f]=m.useState("fonds"),[u,b]=m.useState(null),[p,v]=m.useState("idle"),y=m.useRef(!1);m.useEffect(()=>{b(null),v("idle"),y.current=!1,f("fonds")},[e]),m.useEffect(()=>{if(l!=="jour"||y.current)return;y.current=!0;let j=!0;return v("load"),hs(e).then(z=>{j&&(b(z),v("fait"))}),()=>{j=!1}},[l,e]);const h=m.useMemo(()=>us((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),N=m.useRef(null);m.useEffect(()=>{const j=N.current;if(!j||!h)return;let z=!1;return Ga(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(z||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{z=!0}},[h]);const C=m.useMemo(()=>Wn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=m.useMemo(()=>Wn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return m.useEffect(()=>{const j=g.current;if(!j||!C)return;let z=!1;return Ga(()=>import("./fit-BnaWm7z_.js"),[]).then(async E=>{await E.ensureEditoCss(),!(z||!j.isConnected)&&(E.beautifyEditoRows(j),E.mountCardFits(j))}),()=>{z=!0}},[C]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":l==="fonds",onClick:()=>f("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":l==="jour",onClick:()=>f("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),l==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),l==="fonds"&&r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),l==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),l==="fonds"&&d&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Yn(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Gn(e,!0)}),"."]}):Yn(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Gn(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>f("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),l==="fonds"&&s&&C?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:C}}):null,l==="fonds"&&s&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,l==="jour"&&(h?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:N,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:h}})]}):t.jsx("p",{className:p==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:p!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Kn(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Kn(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const gs=300,da=7,bs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Hr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},vs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function _a(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Jo(r)&&r!=="media")return"news:"+r;const n=Re(e);return n?"sig:"+(n.theme&&Hr.fr[n.theme]?n.theme:"other"):"actualites"}function ys(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:s,fund:d}=W(),c=$r(),g=s==="en",[l,f]=m.useState("all"),[u,b]=m.useState(!1),p=m.useMemo(()=>{var xe;const x=(a.filters.day||"").slice(0,10),T=_=>!(!i&&a.continent!=="monde"&&_.continent!==a.continent||x&&(_.date||"").slice(0,10)!==x),B=e.filter(_=>T(_)&&Re(_)&&(!i||_.kind!=="target"||Ae(_)!==5)),G=i&&(((xe=c==null?void 0:c.ed)==null?void 0:xe.ops)||[]).length?c.ed.ops.map(_=>xa(_,s)).filter(_=>!!_).map(_=>(_.briefOnly=!0,_)).filter(_=>!x||(_.date||"").slice(0,10)===x):[],H=e.filter(_=>T(_)&&_.kind==="op"&&(x?!0:pt(_.date)<=da)),Q=i?G.length?G:H.filter(_=>{const se=(d||"").trim().toLowerCase();if(!se)return!1;const me=_.match||null;return me?Object.keys(me).map(Le=>Le.trim().toLowerCase()).includes(se):!1}):H,X=x||new Date().toISOString().slice(0,10),K=_=>{const se=_a(_);return se==="ma"?0:se==="levees"?1:2};Q.sort((_,se)=>{const me=K(_)-K(se);if(me)return me;const Le=(_.date||"").slice(0,10)===X?0:1,te=(se.date||"").slice(0,10)===X?0:1;return Le!==te?Le-te:(se.amountEur||0)-(_.amountEur||0)});const ue=new Set,ee=[];for(const _ of[...Q,...vn(B,{key:"signal",dir:-1})]){const se=_.id||_.name;!se||ue.has(se)||(ue.add(se),ee.push(_))}return i&&ee.length===0?e.filter(se=>T(se)&&pt(se.date)<=da).sort((se,me)=>(me.date||"").localeCompare(se.date||"")).slice(0,80):ee},[e,a.continent,a.filters.day,i,d,s,c]),v=m.useMemo(()=>{const x={};for(const T of p){const B=_a(T);x[B]=(x[B]||0)+1}return x},[p]),y=m.useMemo(()=>l==="all"?p:p.filter(x=>_a(x)===l),[p,l]),h=m.useMemo(()=>y.slice(0,gs),[y]),N=y.length-h.length,C=m.useRef(null);m.useEffect(()=>{var Q,X;const x=C.current;if(!x)return;const T=()=>{const K=x.scrollWidth;K<200||(x.style.animationDuration=Math.max(18,Math.round(K/130))+"s")};T();const B=requestAnimationFrame(T),G=window.setTimeout(T,1200);let H=!0;return(X=(Q=document.fonts)==null?void 0:Q.ready)==null||X.then(()=>{H&&T()}),()=>{H=!1,cancelAnimationFrame(B),window.clearTimeout(G)}},[h.length,l]);const k=x=>x==="all"?p.length:v[x]||0,j=x=>{if(x==="all")return g?"All":"Tout";if(x.startsWith("sig:"))return Hr[g?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const T=x.slice(5);return Ko[T]?Qo(T,g?"en":"fr"):x}return bs[g?"en":"fr"][x]},z=[{k:"all"}],E=["ma","levees"].filter(x=>k(x)>0||x===l);if(E.length){z.push({g:g?"Deals":"Opérations"});for(const x of E)z.push({k:x})}const q=["nominations","recrutements"].filter(x=>k(x)>0||x===l),A=Yo.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===l),F=k("actualites")>0||l==="actualites"?["actualites"]:[];if(q.length||A.length||F.length){z.push({g:g?"News":"Actualités"});for(const x of q)z.push({k:x});for(const x of A)z.push({k:x});for(const x of F)z.push({k:x})}const P=vs.map(x=>"sig:"+x).filter(x=>k(x)>0||x===l);if(P.length){z.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of P)z.push({k:x})}const I=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},L=(()=>{const x=(a.filters.day||"").slice(0,10),T=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(g?`LIVE covers the events of ${I(x)}.`:`Le LIVE regroupe les événements du ${I(x)}.`)+T:(g?`LIVE covers the still-open signals and the deals of the last ${da} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${da} derniers jours.`)+T})(),R=x=>h.map(T=>t.jsxs("button",{type:"button",className:"tk"+(_e(T)?" spent":""),onClick:B=>{const G=T.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:G?"":T.id,name:T.name,url:T.url||"",text:T.tagline||T.headline||"",card:T.card}}))}catch{}if(G||n({type:"focus",id:T.id}),a.dens!=="liste"){const H=B.currentTarget.getBoundingClientRect();n({type:"popup",id:T.id,anchor:{x:H.left+H.width/2,y:H.bottom}})}},title:T.name+(T.tagline?" — "+T.tagline:""),children:[t.jsx(xt,{o:T}),t.jsxs("span",{className:"who",children:[t.jsx(No,{o:T}),t.jsx("span",{className:"co",children:T.name})]}),typeof T.amountEur=="number"&&T.amountEur>0&&t.jsx("span",{className:"am",children:Gd(T.amountEur)}),T.sector&&t.jsx("span",{className:"mt",children:T.sector}),t.jsx(Ra,{o:T}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(T.id||T.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(x=>!x),children:[j(l),t.jsx("b",{children:k(l)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:L}),z.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===l,onClick:()=>{f(x.k),b(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:C,children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(ks,{isEn:g})]})}const ws=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ks({isEn:e}){const[a,r]=m.useState(()=>Fr());m.useEffect(()=>{const o=i=>{var s;return r(!!((s=i.detail)!=null&&s.open))};return window.addEventListener(ya,o),()=>window.removeEventListener(ya,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Xo(!a),children:ws})}const wn="+33 6 83 10 72 86",Na="alexandre@proplace.co",Vr=`tel:${wn.replace(/[^\d+]/g,"")}`;function js(){return null}class at extends m.Component{constructor(){super(...arguments);An(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Wr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Qn(e,a){if((gt(e)||"").startsWith("CALL")&&Ae(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ae(e)>=2;return Wr.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}function Ns({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:s}=W(),[d,c]=m.useState(""),[g,l]=m.useState(!1);if(!r.pipe||!n||r.lockActions||e.kind==="op")return null;const f=(e.ceoStatus||"").trim(),u=async p=>{if(d)return;if(p==="Analysé"&&!e.memoUrl){l(!0);return}c(p);const v=(Qn(e,a).find(([h])=>h===p)||[p,p])[1],y=await o(e,p,{msg:a.csMoved(e.name,v)});c(""),y&&l(!1)},b=Qn(e,a);return b.length===2?t.jsx("span",{className:"rstat rst2",onClick:p=>p.stopPropagation(),children:b.map(([p,v])=>t.jsx("button",{type:"button",className:"rsd "+(p==="Validé"?"yes":"no")+(d===p?" busy":""),disabled:!!d,onClick:()=>{u(p)},children:v},p))}):t.jsxs("span",{className:"rstat",onClick:p=>p.stopPropagation(),children:[t.jsxs("select",{className:"rsel rs-"+(f==="Retenu"?"ret":f==="Analysé"?"ana":f==="À trancher"?"tra":f==="Validé"?"val":f==="Écarté"?"eca":"off"),value:f,disabled:!!d,title:a.csLabel,onChange:p=>{const v=p.target.value;v&&v!==f&&u(v)},children:[!f&&t.jsx("option",{value:"",children:a.csNone}),b.map(([p,v])=>t.jsx("option",{value:p,children:v},p))]}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{i(e),l(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const p=await o(e,"Analysé");c(""),p&&l(!1)})()},children:a.csAnaAnyway})]})})]})}function Es({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=W(),[i,s]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),l=(gt(e)||"").startsWith("CALL")&&Ae(e)===3,f=Ae(e)>=2,u=async p=>{if(i||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(p);const v=await o(e,p);s(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=l?[["Validé",a.csYes],["Écarté",a.csNo]]:Wr.filter(([p])=>!(f&&p==="Retenu")).map(([p,v])=>[p,a[v]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,v])=>t.jsx("button",{type:"button",className:"csb"+(g===p?" on":"")+(i===p?" busy":""),disabled:!!i,onClick:()=>{u(p)},children:v},p)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Ss,{o:e})]})}function Ss({o:e}){const{t:a,saveNote:r,flash:n}=W(),[o,i]=m.useState(e.ceoNote||""),[s,d]=m.useState(!1),[c,g]=m.useState(!1),l=o.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(s||!l)return;d(!0);const u=await r(e,o.trim());d(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:s||!l,onClick:()=>{f()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Cs({placeholder:e,onDone:a}){const{t:r}=W(),[n,o]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function zs({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:s,flashErr:d}=W(),[c,g]=m.useState(!1);if(!n.pipe||!o||n.lockActions||Ae(e)!==4)return null;const l=i(e),f=(l==null?void 0:l.stage)||"todo",u=async h=>{if(c||h===f)return;g(!0);const N=l;s(e,{stage:h,stamps:(l==null?void 0:l.stamps)||{}});const C=Math.max(Date.now(),Jn+=1);Jn=C;const k=await Zo(r,{company:e.name||"",stage:h,cts:C,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(s(e,N),d(a.actErr)))},b=(y=l==null?void 0:l.stamps)==null?void 0:y.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=f==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,N])=>t.jsx("button",{type:"button",className:"stgb"+(f===h?" on":""),disabled:c,onClick:()=>{u(h)},children:N},h)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let Jn=0;const Vt=8,ht=360;function Xn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Zn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Xn,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Xn,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function As({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=W(),[s,d]=m.useState(0),[c,g]=m.useState(null),[l,f]=m.useState([]),u=m.useRef(!1),b=m.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),p=m.useRef(!1);m.useEffect(()=>{const E=b.current;return()=>{p.current||(n({type:"ptab",tab:E.ptab}),n({type:"dens",dens:E.dens}),n({type:"modal",modal:E.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,f(e.filter(E=>!!document.querySelector(E.need||E.sel))))},[e]);const v=l[s],y=s>=l.length;m.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const E=v.click,q=window.setTimeout(()=>{const A=document.querySelector(E);A&&A.getAttribute("aria-selected")!=="true"&&A.click()},60);return()=>window.clearTimeout(q)}},[s,v]);const h=m.useRef(-1),N=m.useCallback(()=>{if(!v){g(null);return}const E=F=>{if(!F)return null;for(const P of document.querySelectorAll(F)){const I=P.getBoundingClientRect();if(I.width>1&&I.height>1)return P}return null},q=E(v.sel)||E(v.need);if(!q){g(null);return}h.current!==s&&(h.current=s,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const A=q.getBoundingClientRect();g(F=>F&&Math.abs(F.top-A.top)<1&&Math.abs(F.left-A.left)<1&&Math.abs(F.width-A.width)<1&&Math.abs(F.height-A.height)<1?F:A)},[v,s]);m.useLayoutEffect(()=>{N();const E=[90,300,700,1300].map(F=>window.setTimeout(N,F)),q=window.setInterval(N,400),A=()=>N();return window.addEventListener("scroll",A,!0),window.addEventListener("resize",A),()=>{E.forEach(F=>window.clearTimeout(F)),window.clearInterval(q),window.removeEventListener("scroll",A,!0),window.removeEventListener("resize",A)}},[N]);const C=m.useRef(a);if(C.current=a,m.useEffect(()=>{const E=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),C.current()):q.key==="ArrowRight"?d(A=>A+1):q.key==="ArrowLeft"&&d(A=>Math.max(0,A-1))};return document.addEventListener("keydown",E,!0),()=>document.removeEventListener("keydown",E,!0)},[]),!l.length)return null;let k=null;const j=E=>()=>{p.current=!0,n({type:"modal",modal:null}),E()};if(y){const E=o[3]||0;E>0?k={title:E===1?r.ahaATitle1:r.ahaATitleN(E),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let z={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:ht};if(!y&&c){const E=c.bottom+14,q=window.innerHeight-E;let A=q>190?E:Math.max(12,c.top-200),F=Math.min(Math.max(12,c.left+c.width/2-ht/2),window.innerWidth-ht-12);q<=190&&c.top<212&&(window.innerWidth-c.right>=ht+40?F=Math.min(c.right+26,window.innerWidth-ht-12):c.left>=ht+40&&(F=Math.max(12,c.left-ht-26)),A=Math.max(12,c.top-Vt)),z={left:F,top:A,width:ht}}return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Vt,top:c.top-Vt,width:c.width+Vt*2,height:c.height+Vt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:z,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(Zn,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(l.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,l.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/l.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(Zn,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>d(E=>Math.max(0,E-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(E=>E+1),children:s===l.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Gr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Yr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Ts(){var q,A;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:s,data:d,dispatch:c}=W(),g=r?a:e,l=m.useMemo(()=>g.filter(F=>pt(F.date)===0&&F.kind==="target"),[g]),f=m.useMemo(()=>r?a.filter(F=>F.kind==="target"&&Ae(F)===0).slice().sort((F,P)=>(P.date||"").localeCompare(F.date||"")):[],[a,r]),u=m.useMemo(()=>l.filter(F=>r?Ae(F)===0:!_e(F)),[l,r]),b=r?f:u,p=r?a.length-f.length:l.length-u.length,v=r?a.length:l.length,y=v?Math.min(100,p/v*100):100,h=m.useMemo(()=>Gr(g),[g]),N=!!h&&pt(h)>0,C=m.useMemo(()=>N?g.filter(F=>(F.date||"").slice(0,10)===h):[],[g,h,N]),k=typeof((q=d.stats)==null?void 0:q.kept_today)=="number"?d.stats.kept_today:null,j=typeof((A=d.stats)==null?void 0:A.screened_today)=="number"?d.stats.screened_today:l.length;let z;N?z=o.morningLast(C.length,f.length,Yr(h,s)):r?z=o.morningThesis(j,f.length,k):l.length?p===0?z=o.goalSourced(l.length):p>=l.length?z=o.goalCleared:z=o.goalDone(p,l.length):z=o.goalSourced(0);const E=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&f.length&&c({type:"chainStart",queue:f.map(F=>F.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:z}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:E,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function qs(){var B,G;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:s,dossiers:d,mode:c,doSync:g,startTour:l,flash:f,flashErr:u}=W(),[b,p]=m.useState(null),[v,y]=m.useState(!0),[h,N]=m.useState([]),C=c==="client";m.useEffect(()=>{if(!o||!i)return;let H=!0;return y(!0),(async()=>{const[Q,X]=await Promise.all([gn(i),Rr(o)]);H&&(Q&&p(Q),y(!1),N(X))})(),()=>{H=!1}},[o,i]);const[k,j]=m.useState(!1),z=()=>{!C||k||!i||(j(!0),ei(i).then(H=>{j(!1),H?f(e.identRepubDone):u(e.actErr)}))},E=(b==null?void 0:b.per_day)??null,q=((B=b==null?void 0:b.pool_order)==null?void 0:B.length)??0,A=h.filter(H=>H.status==="running").length,F=m.useMemo(()=>d.filter(H=>H.kind==="target"&&_e(H)).length,[d]),P=s.marketEstimate,I=typeof((G=s.stats)==null?void 0:G.screened)=="number"?s.stats.screened:F,L=P&&P>0?Math.min(100,Math.round(I/P*100)):null,R=H=>H.toLocaleString(a==="en"?"en-US":"fr-FR"),x=(i||"P").split(/\s+/).map(H=>H[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const H=Date.parse(s.generatedAt||"");if(Number.isNaN(H))return"";const Q=new Date(H),X=K=>String(K).padStart(2,"0");return`${X(Q.getDate())}/${X(Q.getMonth()+1)} à ${X(Q.getHours())}:${X(Q.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?x:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),T?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(T)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(I)})})]}),L!==null&&P&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,P)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),E!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:E})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),E===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),A>0&&t.jsxs("span",{className:"ev",children:["⏳ ",A]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:H=>{H.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!C||k,onClick:z,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!C,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:H=>n({type:"filters",patch:{search:H.target.value}})})]})]})]})}class Ct{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],s=a+i,d=Math.abs(a)<Math.abs(i)?a-(s-i):i-(s-a);d&&(r[n++]=d),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,o=a[--r],s=n+o,i=o-(s-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=s+o,o==n-s&&(s=n))}return s}}function*Ls(e){for(const a of e)yield*a}function Kr(e){return Array.from(Ls(e))}var Ne=1e-6,fe=Math.PI,Ye=fe/2,er=fe/4,Qe=fe*2,lt=180/fe,He=fe/180,ze=Math.abs,Fs=Math.atan,Zt=Math.atan2,Te=Math.cos,qe=Math.sin,Rs=Math.sign||function(e){return e>0?1:e<0?-1:0},At=Math.sqrt;function Ms(e){return e>1?0:e<-1?fe:Math.acos(e)}function ea(e){return e>1?Ye:e<-1?-Ye:Math.asin(e)}function Ke(){}function Ea(e,a){e&&ar.hasOwnProperty(e.type)&&ar[e.type](e,a)}var tr={Feature:function(e,a){Ea(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ea(r[n].geometry,a)}},ar={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Za(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Za(r[n],a,0)},Polygon:function(e,a){nr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)nr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ea(r[n],a)}};function Za(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function nr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Za(e[r],a,1);a.polygonEnd()}function qt(e,a){e&&tr.hasOwnProperty(e.type)?tr[e.type](e,a):Ea(e,a)}function en(e){return[Zt(e[1],e[0]),ea(e[2])]}function Mt(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*qe(a),qe(r)]}function ca(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Sa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function $a(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function pa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function tn(e){var a=At(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function an(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function nn(e,a){return ze(e)>fe&&(e-=Math.round(e/Qe)*Qe),[e,a]}nn.invert=nn;function Os(e,a,r){return(e%=Qe)?a||r?an(or(e),ir(a,r)):or(e):a||r?ir(a,r):nn}function rr(e){return function(a,r){return a+=e,ze(a)>fe&&(a-=Math.round(a/Qe)*Qe),[a,r]}}function or(e){var a=rr(e);return a.invert=rr(-e),a}function ir(e,a){var r=Te(e),n=qe(e),o=Te(a),i=qe(a);function s(d,c){var g=Te(c),l=Te(d)*g,f=qe(d)*g,u=qe(c),b=u*r+l*n;return[Zt(f*o-b*i,l*r-u*n),ea(b*o+f*i)]}return s.invert=function(d,c){var g=Te(c),l=Te(d)*g,f=qe(d)*g,u=qe(c),b=u*o-f*i;return[Zt(f*o+u*i,l*r+b*n),ea(b*r-l*n)]},s}function Ds(e,a,r,n,o,i){if(r){var s=Te(a),d=qe(a),c=n*r;o==null?(o=a+n*Qe,i=a-c/2):(o=sr(s,o),i=sr(s,i),(n>0?o<i:o>i)&&(o+=n*Qe));for(var g,l=o;n>0?l>i:l<i;l-=c)g=en([s,-d*Te(l),-d*qe(l)]),e.point(g[0],g[1])}}function sr(e,a){a=Mt(a),a[0]-=e,tn(a);var r=Ms(-a[1]);return((-a[2]<0?-r:r)+Qe-Ne)%Qe}function Qr(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ke,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ga(e,a){return ze(e[0]-a[0])<Ne&&ze(e[1]-a[1])<Ne}function ua(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Jr(e,a,r,n,o){var i=[],s=[],d,c;if(e.forEach(function(p){if(!((v=p.length-1)<=0)){var v,y=p[0],h=p[v],N;if(ga(y,h)){if(!y[2]&&!h[2]){for(o.lineStart(),d=0;d<v;++d)o.point((y=p[d])[0],y[1]);o.lineEnd();return}h[0]+=2*Ne}i.push(N=new ua(y,p,null,!0)),s.push(N.o=new ua(y,null,N,!1)),i.push(N=new ua(h,p,null,!1)),s.push(N.o=new ua(h,null,N,!0))}}),!!i.length){for(s.sort(a),lr(i),lr(s),d=0,c=s.length;d<c;++d)s[d].e=r=!r;for(var g=i[0],l,f;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;l=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(d=0,c=l.length;d<c;++d)o.point((f=l[d])[0],f[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(l=u.p.z,d=l.length-1;d>=0;--d)o.point((f=l[d])[0],f[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,l=u.z,b=!b}while(!u.v);o.lineEnd()}}}function lr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Ua(e){return ze(e[0])<=fe?e[0]:Rs(e[0])*((ze(e[0])+fe)%Qe-fe)}function Ps(e,a){var r=Ua(a),n=a[1],o=qe(n),i=[qe(r),-Te(r),0],s=0,d=0,c=new Ct;o===1?n=Ye+Ne:o===-1&&(n=-Ye-Ne);for(var g=0,l=e.length;g<l;++g)if(u=(f=e[g]).length)for(var f,u,b=f[u-1],p=Ua(b),v=b[1]/2+er,y=qe(v),h=Te(v),N=0;N<u;++N,p=k,y=z,h=E,b=C){var C=f[N],k=Ua(C),j=C[1]/2+er,z=qe(j),E=Te(j),q=k-p,A=q>=0?1:-1,F=A*q,P=F>fe,I=y*z;if(c.add(Zt(I*A*qe(F),h*E+I*Te(F))),s+=P?q+A*Qe:q,P^p>=r^k>=r){var L=Sa(Mt(b),Mt(C));tn(L);var R=Sa(i,L);tn(R);var x=(P^q>=0?-1:1)*ea(R[2]);(n>x||n===x&&(L[0]||L[1]))&&(d+=P^q>=0?1:-1)}}return(s<-Ne||s<Ne&&c<-1e-12)^d&1}function Xr(e,a,r,n){return function(o){var i=a(o),s=Qr(),d=a(s),c=!1,g,l,f,u={point:b,lineStart:v,lineEnd:y,polygonStart:function(){u.point=h,u.lineStart=N,u.lineEnd=C,l=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=y,l=Kr(l);var k=Ps(g,n);l.length?(c||(o.polygonStart(),c=!0),Jr(l,Bs,k,r,o)):k&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),l=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function p(k,j){i.point(k,j)}function v(){u.point=p,i.lineStart()}function y(){u.point=b,i.lineEnd()}function h(k,j){f.push([k,j]),d.point(k,j)}function N(){d.lineStart(),f=[]}function C(){h(f[0][0],f[0][1]),d.lineEnd();var k=d.clean(),j=s.result(),z,E=j.length,q,A,F;if(f.pop(),g.push(f),f=null,!!E){if(k&1){if(A=j[0],(q=A.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),z=0;z<q;++z)o.point((F=A[z])[0],F[1]);o.lineEnd()}return}E>1&&k&2&&j.push(j.pop().concat(j.shift())),l.push(j.filter(Is))}}return u}}function Is(e){return e.length>1}function Bs(e,a){return((e=e.x)[0]<0?e[1]-Ye-Ne:Ye-e[1])-((a=a.x)[0]<0?a[1]-Ye-Ne:Ye-a[1])}const dr=Xr(function(){return!0},_s,Us,[-fe,-Ye]);function _s(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,s){var d=i>0?fe:-fe,c=ze(i-a);ze(c-fe)<Ne?(e.point(a,r=(r+s)/2>0?Ye:-Ye),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(i,r),o=0):n!==d&&c>=fe&&(ze(a-n)<Ne&&(a-=n*Ne),ze(i-d)<Ne&&(i-=d*Ne),r=$s(a,r,i,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),o=0),e.point(a=i,r=s),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function $s(e,a,r,n){var o,i,s=qe(e-r);return ze(s)>Ne?Fs((qe(a)*(i=Te(n))*qe(r)-qe(n)*(o=Te(a))*qe(e))/(o*i*s)):(a+n)/2}function Us(e,a,r,n){var o;if(e==null)o=r*Ye,n.point(-fe,o),n.point(0,o),n.point(fe,o),n.point(fe,0),n.point(fe,-o),n.point(0,-o),n.point(-fe,-o),n.point(-fe,0),n.point(-fe,o);else if(ze(e[0]-a[0])>Ne){var i=e[0]<a[0]?fe:-fe;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Hs(e){var a=Te(e),r=2*He,n=a>0,o=ze(a)>Ne;function i(l,f,u,b){Ds(b,e,r,u,l,f)}function s(l,f){return Te(l)*Te(f)>a}function d(l){var f,u,b,p,v;return{lineStart:function(){p=b=!1,v=1},point:function(y,h){var N=[y,h],C,k=s(y,h),j=n?k?0:g(y,h):k?g(y+(y<0?fe:-fe),h):0;if(!f&&(p=b=k)&&l.lineStart(),k!==b&&(C=c(f,N),(!C||ga(f,C)||ga(N,C))&&(N[2]=1)),k!==b)v=0,k?(l.lineStart(),C=c(N,f),l.point(C[0],C[1])):(C=c(f,N),l.point(C[0],C[1],2),l.lineEnd()),f=C;else if(o&&f&&n^k){var z;!(j&u)&&(z=c(N,f,!0))&&(v=0,n?(l.lineStart(),l.point(z[0][0],z[0][1]),l.point(z[1][0],z[1][1]),l.lineEnd()):(l.point(z[1][0],z[1][1]),l.lineEnd(),l.lineStart(),l.point(z[0][0],z[0][1],3)))}k&&(!f||!ga(f,N))&&l.point(N[0],N[1]),f=N,b=k,u=j},lineEnd:function(){b&&l.lineEnd(),f=null},clean:function(){return v|(p&&b)<<1}}}function c(l,f,u){var b=Mt(l),p=Mt(f),v=[1,0,0],y=Sa(b,p),h=ca(y,y),N=y[0],C=h-N*N;if(!C)return!u&&l;var k=a*h/C,j=-a*N/C,z=Sa(v,y),E=pa(v,k),q=pa(y,j);$a(E,q);var A=z,F=ca(E,A),P=ca(A,A),I=F*F-P*(ca(E,E)-1);if(!(I<0)){var L=At(I),R=pa(A,(-F-L)/P);if($a(R,E),R=en(R),!u)return R;var x=l[0],T=f[0],B=l[1],G=f[1],H;T<x&&(H=x,x=T,T=H);var Q=T-x,X=ze(Q-fe)<Ne,K=X||Q<Ne;if(!X&&G<B&&(H=B,B=G,G=H),K?X?B+G>0^R[1]<(ze(R[0]-x)<Ne?B:G):B<=R[1]&&R[1]<=G:Q>fe^(x<=R[0]&&R[0]<=T)){var ue=pa(A,(-F+L)/P);return $a(ue,E),[R,en(ue)]}}}function g(l,f){var u=n?e:fe-e,b=0;return l<-u?b|=1:l>u&&(b|=2),f<-u?b|=4:f>u&&(b|=8),b}return Xr(s,d,i,n?[0,-e]:[-fe,e-fe])}function Vs(e,a,r,n,o,i){var s=e[0],d=e[1],c=a[0],g=a[1],l=0,f=1,u=c-s,b=g-d,p;if(p=r-s,!(!u&&p>0)){if(p/=u,u<0){if(p<l)return;p<f&&(f=p)}else if(u>0){if(p>f)return;p>l&&(l=p)}if(p=o-s,!(!u&&p<0)){if(p/=u,u<0){if(p>f)return;p>l&&(l=p)}else if(u>0){if(p<l)return;p<f&&(f=p)}if(p=n-d,!(!b&&p>0)){if(p/=b,b<0){if(p<l)return;p<f&&(f=p)}else if(b>0){if(p>f)return;p>l&&(l=p)}if(p=i-d,!(!b&&p<0)){if(p/=b,b<0){if(p>f)return;p>l&&(l=p)}else if(b>0){if(p<l)return;p<f&&(f=p)}return l>0&&(e[0]=s+l*u,e[1]=d+l*b),f<1&&(a[0]=s+f*u,a[1]=d+f*b),!0}}}}}var Wt=1e9,ma=-Wt;function Ws(e,a,r,n){function o(g,l){return e<=g&&g<=r&&a<=l&&l<=n}function i(g,l,f,u){var b=0,p=0;if(g==null||(b=s(g,f))!==(p=s(l,f))||c(g,l)<0^f>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+f+4)%4)!==p);else u.point(l[0],l[1])}function s(g,l){return ze(g[0]-e)<Ne?l>0?0:3:ze(g[0]-r)<Ne?l>0?2:1:ze(g[1]-a)<Ne?l>0?1:0:l>0?3:2}function d(g,l){return c(g.x,l.x)}function c(g,l){var f=s(g,1),u=s(l,1);return f!==u?f-u:f===0?l[1]-g[1]:f===1?g[0]-l[0]:f===2?g[1]-l[1]:l[0]-g[0]}return function(g){var l=g,f=Qr(),u,b,p,v,y,h,N,C,k,j,z,E={point:q,lineStart:I,lineEnd:L,polygonStart:F,polygonEnd:P};function q(x,T){o(x,T)&&l.point(x,T)}function A(){for(var x=0,T=0,B=b.length;T<B;++T)for(var G=b[T],H=1,Q=G.length,X=G[0],K,ue,ee=X[0],xe=X[1];H<Q;++H)K=ee,ue=xe,X=G[H],ee=X[0],xe=X[1],ue<=n?xe>n&&(ee-K)*(n-ue)>(xe-ue)*(e-K)&&++x:xe<=n&&(ee-K)*(n-ue)<(xe-ue)*(e-K)&&--x;return x}function F(){l=f,u=[],b=[],z=!0}function P(){var x=A(),T=z&&x,B=(u=Kr(u)).length;(T||B)&&(g.polygonStart(),T&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),B&&Jr(u,d,x,i,g),g.polygonEnd()),l=g,u=b=p=null}function I(){E.point=R,b&&b.push(p=[]),j=!0,k=!1,N=C=NaN}function L(){u&&(R(v,y),h&&k&&f.rejoin(),u.push(f.result())),E.point=q,k&&l.lineEnd()}function R(x,T){var B=o(x,T);if(b&&p.push([x,T]),j)v=x,y=T,h=B,j=!1,B&&(l.lineStart(),l.point(x,T));else if(B&&k)l.point(x,T);else{var G=[N=Math.max(ma,Math.min(Wt,N)),C=Math.max(ma,Math.min(Wt,C))],H=[x=Math.max(ma,Math.min(Wt,x)),T=Math.max(ma,Math.min(Wt,T))];Vs(G,H,e,a,r,n)?(k||(l.lineStart(),l.point(G[0],G[1])),l.point(H[0],H[1]),B||l.lineEnd(),z=!1):B&&(l.lineStart(),l.point(x,T),z=!1)}N=x,C=T,k=B}return E}}const rn=e=>e;var Ha=new Ct,on=new Ct,Zr,eo,sn,ln,ct={point:Ke,lineStart:Ke,lineEnd:Ke,polygonStart:function(){ct.lineStart=Gs,ct.lineEnd=Ks},polygonEnd:function(){ct.lineStart=ct.lineEnd=ct.point=Ke,Ha.add(ze(on)),on=new Ct},result:function(){var e=Ha/2;return Ha=new Ct,e}};function Gs(){ct.point=Ys}function Ys(e,a){ct.point=to,Zr=sn=e,eo=ln=a}function to(e,a){on.add(ln*e-sn*a),sn=e,ln=a}function Ks(){to(Zr,eo)}var Ot=1/0,Ca=Ot,ta=-Ot,za=ta,Aa={point:Qs,lineStart:Ke,lineEnd:Ke,polygonStart:Ke,polygonEnd:Ke,result:function(){var e=[[Ot,Ca],[ta,za]];return ta=za=-(Ca=Ot=1/0),e}};function Qs(e,a){e<Ot&&(Ot=e),e>ta&&(ta=e),a<Ca&&(Ca=a),a>za&&(za=a)}var dn=0,cn=0,Gt=0,Ta=0,qa=0,Lt=0,pn=0,un=0,Yt=0,ao,no,ot,it,Ge={point:zt,lineStart:cr,lineEnd:pr,polygonStart:function(){Ge.lineStart=Zs,Ge.lineEnd=el},polygonEnd:function(){Ge.point=zt,Ge.lineStart=cr,Ge.lineEnd=pr},result:function(){var e=Yt?[pn/Yt,un/Yt]:Lt?[Ta/Lt,qa/Lt]:Gt?[dn/Gt,cn/Gt]:[NaN,NaN];return dn=cn=Gt=Ta=qa=Lt=pn=un=Yt=0,e}};function zt(e,a){dn+=e,cn+=a,++Gt}function cr(){Ge.point=Js}function Js(e,a){Ge.point=Xs,zt(ot=e,it=a)}function Xs(e,a){var r=e-ot,n=a-it,o=At(r*r+n*n);Ta+=o*(ot+e)/2,qa+=o*(it+a)/2,Lt+=o,zt(ot=e,it=a)}function pr(){Ge.point=zt}function Zs(){Ge.point=tl}function el(){ro(ao,no)}function tl(e,a){Ge.point=ro,zt(ao=ot=e,no=it=a)}function ro(e,a){var r=e-ot,n=a-it,o=At(r*r+n*n);Ta+=o*(ot+e)/2,qa+=o*(it+a)/2,Lt+=o,o=it*e-ot*a,pn+=o*(ot+e),un+=o*(it+a),Yt+=o*3,zt(ot=e,it=a)}function oo(e){this._context=e}oo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Qe);break}}},result:Ke};var mn=new Ct,Va,io,so,Kt,Qt,aa={point:Ke,lineStart:function(){aa.point=al},lineEnd:function(){Va&&lo(io,so),aa.point=Ke},polygonStart:function(){Va=!0},polygonEnd:function(){Va=null},result:function(){var e=+mn;return mn=new Ct,e}};function al(e,a){aa.point=lo,io=Kt=e,so=Qt=a}function lo(e,a){Kt-=e,Qt-=a,mn.add(At(Kt*Kt+Qt*Qt)),Kt=e,Qt=a}let ur,La,mr,fr;class hr{constructor(a){this._append=a==null?co:nl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==mr||this._append!==La){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,mr=n,La=this._append,fr=this._,this._=o}this._+=fr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function co(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function nl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return co;if(a!==ur){const r=10**a;ur=a,La=function(o){let i=1;this._+=o[0];for(const s=o.length;i<s;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return La}function rl(e,a){let r=3,n=4.5,o,i;function s(d){return d&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),qt(d,o(i))),i.result()}return s.area=function(d){return qt(d,o(ct)),ct.result()},s.measure=function(d){return qt(d,o(aa)),aa.result()},s.bounds=function(d){return qt(d,o(Aa)),Aa.result()},s.centroid=function(d){return qt(d,o(Ge)),Ge.result()},s.projection=function(d){return arguments.length?(o=d==null?(e=null,rn):(e=d).stream,s):e},s.context=function(d){return arguments.length?(i=d==null?(a=null,new hr(r)):new oo(a=d),typeof n!="function"&&i.pointRadius(n),s):a},s.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(i.pointRadius(+d),+d),s):n},s.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(i=new hr(r)),s},s.projection(e).digits(r).context(a)}function kn(e){return function(a){var r=new fn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function fn(){}fn.prototype={constructor:fn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function jn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),qt(r,e.stream(Aa)),a(Aa.result()),n!=null&&e.clipExtent(n),e}function po(e,a,r){return jn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],s=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),d=+a[0][0]+(o-s*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([d,c])},r)}function ol(e,a,r){return po(e,[[0,0],a],r)}function il(e,a,r){return jn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),s=(o-i*(n[1][0]+n[0][0]))/2,d=-i*n[0][1];e.scale(150*i).translate([s,d])},r)}function sl(e,a,r){return jn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),s=-i*n[0][0],d=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([s,d])},r)}var xr=16,ll=Te(30*He);function gr(e,a){return+a?cl(e,a):dl(e)}function dl(e){return kn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function cl(e,a){function r(n,o,i,s,d,c,g,l,f,u,b,p,v,y){var h=g-n,N=l-o,C=h*h+N*N;if(C>4*a&&v--){var k=s+u,j=d+b,z=c+p,E=At(k*k+j*j+z*z),q=ea(z/=E),A=ze(ze(z)-1)<Ne||ze(i-f)<Ne?(i+f)/2:Zt(j,k),F=e(A,q),P=F[0],I=F[1],L=P-n,R=I-o,x=N*L-h*R;(x*x/C>a||ze((h*L+N*R)/C-.5)>.3||s*u+d*b+c*p<ll)&&(r(n,o,i,s,d,c,P,I,A,k/=E,j/=E,z,v,y),y.point(P,I),r(P,I,A,k,j,z,g,l,f,u,b,p,v,y))}}return function(n){var o,i,s,d,c,g,l,f,u,b,p,v,y={point:h,lineStart:N,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=j},polygonEnd:function(){n.polygonEnd(),y.lineStart=N}};function h(q,A){q=e(q,A),n.point(q[0],q[1])}function N(){f=NaN,y.point=C,n.lineStart()}function C(q,A){var F=Mt([q,A]),P=e(q,A);r(f,u,l,b,p,v,f=P[0],u=P[1],l=q,b=F[0],p=F[1],v=F[2],xr,n),n.point(f,u)}function k(){y.point=h,n.lineEnd()}function j(){N(),y.point=z,y.lineEnd=E}function z(q,A){C(o=q,A),i=f,s=u,d=b,c=p,g=v,y.point=C}function E(){r(f,u,l,b,p,v,i,s,o,d,c,g,xr,n),y.lineEnd=k,k()}return y}}var pl=kn({point:function(e,a){this.stream.point(e*He,a*He)}});function ul(e){return kn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ml(e,a,r,n,o){function i(s,d){return s*=n,d*=o,[a+e*s,r-e*d]}return i.invert=function(s,d){return[(s-a)/e*n,(r-d)/e*o]},i}function br(e,a,r,n,o,i){if(!i)return ml(e,a,r,n,o);var s=Te(i),d=qe(i),c=s*e,g=d*e,l=s/e,f=d/e,u=(d*r-s*a)/e,b=(d*a+s*r)/e;function p(v,y){return v*=n,y*=o,[c*v-g*y+a,r-g*v-c*y]}return p.invert=function(v,y){return[n*(l*v-f*y+u),o*(b-f*v-l*y)]},p}function fl(e){return hl(function(){return e})()}function hl(e){var a,r=150,n=480,o=250,i=0,s=0,d=0,c=0,g=0,l,f=0,u=1,b=1,p=null,v=dr,y=null,h,N,C,k=rn,j=.5,z,E,q,A,F;function P(x){return q(x[0]*He,x[1]*He)}function I(x){return x=q.invert(x[0],x[1]),x&&[x[0]*lt,x[1]*lt]}P.stream=function(x){return A&&F===x?A:A=pl(ul(l)(v(z(k(F=x)))))},P.preclip=function(x){return arguments.length?(v=x,p=void 0,R()):v},P.postclip=function(x){return arguments.length?(k=x,y=h=N=C=null,R()):k},P.clipAngle=function(x){return arguments.length?(v=+x?Hs(p=x*He):(p=null,dr),R()):p*lt},P.clipExtent=function(x){return arguments.length?(k=x==null?(y=h=N=C=null,rn):Ws(y=+x[0][0],h=+x[0][1],N=+x[1][0],C=+x[1][1]),R()):y==null?null:[[y,h],[N,C]]},P.scale=function(x){return arguments.length?(r=+x,L()):r},P.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],L()):[n,o]},P.center=function(x){return arguments.length?(i=x[0]%360*He,s=x[1]%360*He,L()):[i*lt,s*lt]},P.rotate=function(x){return arguments.length?(d=x[0]%360*He,c=x[1]%360*He,g=x.length>2?x[2]%360*He:0,L()):[d*lt,c*lt,g*lt]},P.angle=function(x){return arguments.length?(f=x%360*He,L()):f*lt},P.reflectX=function(x){return arguments.length?(u=x?-1:1,L()):u<0},P.reflectY=function(x){return arguments.length?(b=x?-1:1,L()):b<0},P.precision=function(x){return arguments.length?(z=gr(E,j=x*x),R()):At(j)},P.fitExtent=function(x,T){return po(P,x,T)},P.fitSize=function(x,T){return ol(P,x,T)},P.fitWidth=function(x,T){return il(P,x,T)},P.fitHeight=function(x,T){return sl(P,x,T)};function L(){var x=br(r,0,0,u,b,f).apply(null,a(i,s)),T=br(r,n-x[0],o-x[1],u,b,f);return l=Os(d,c,g),E=an(a,T),q=an(l,E),z=gr(E,j),R()}function R(){return A=F=null,P}return function(){return a=e.apply(this,arguments),P.invert=a.invert&&I,L()}}function uo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}uo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,s=i*i;r-=o=(r*(1.007226+i*(.015085+s*(-.044475+.028874*i-.005916*s)))-a)/(1.007226+i*(.015085*3+s*(-.044475*7+.028874*9*i-.005916*11*s)))}while(ze(o)>Ne&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function xl(){return fl(uo).scale(175.295)}function gl(e){return e}function bl(e){if(e==null)return gl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],s=e.translate[1];return function(d,c){c||(a=r=0);var g=2,l=d.length,f=new Array(l);for(f[0]=(a+=d[0])*n+i,f[1]=(r+=d[1])*o+s;g<l;)f[g]=d[g],++g;return f}}function vl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function yl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return vr(e,r)})}:vr(e,a)}function vr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=wl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function wl(e,a){var r=bl(e.transform),n=e.arcs;function o(l,f){f.length&&f.pop();for(var u=n[l<0?~l:l],b=0,p=u.length;b<p;++b)f.push(r(u[b],b));l<0&&vl(f,p)}function i(l){return r(l)}function s(l){for(var f=[],u=0,b=l.length;u<b;++u)o(l[u],f);return f.length<2&&f.push(f[0]),f}function d(l){for(var f=s(l);f.length<4;)f.push(f[0]);return f}function c(l){return l.map(d)}function g(l){var f=l.type,u;switch(f){case"GeometryCollection":return{type:f,geometries:l.geometries.map(g)};case"Point":u=i(l.coordinates);break;case"MultiPoint":u=l.coordinates.map(i);break;case"LineString":u=s(l.arcs);break;case"MultiLineString":u=l.arcs.map(s);break;case"Polygon":u=c(l.arcs);break;case"MultiPolygon":u=l.arcs.map(c);break;default:return null}return{type:f,coordinates:u}}return g(a)}const mo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},kl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function jl(e,a,r){const n=mo[e];if(!n||!n.length)return-1;const o=kl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(s=>o.includes(s)))return i}return Math.floor(r*n.length)%n.length}let fa=null;function Nl(){return fa||(fa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=yl(r,n),i=xl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=rl(i),d=(o.features||[]).filter(l=>{var f;return(((f=l.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(l=>{var b;const f=((b=l.properties)==null?void 0:b.name)||"",u=s(l)||"";return u?{i2:ti(f)||null,n:f,d:u}:null}).filter(l=>!!l);if(!d.length)return null;const c={};for(const[l,f]of Object.entries(ai)){const u=i(f);u&&(c[l]={x:u[0],y:u[1]})}const g={};for(const[l,f]of Object.entries(mo)){const u=f.map(b=>i(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(g[l]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:d,anchors:c,metros:g}}catch{return null}})(),fa)}function El(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return Nl().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Sl="8 40 984 210",Cl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},yr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function wr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function zl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let o=!0,i=0;const s=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(s)};s();const d=new ResizeObserver(()=>s());return e.current&&d.observe(e.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),d.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function kr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],s)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Al(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:s,lang:d,t:c,data:g,dossiers:l,source:f}=W(),u=g.loading&&!l.length,b=m.useRef(null),p=m.useRef(null),v=El(e.continent==="monde"),y=e.continent==="monde"?v:bn.find(x=>x.key===e.continent)||null,h=zl(b,e.continent+":"+e.mapFolded+":"+!!y),[N,C]=m.useState(new Map),[k,j]=m.useState(null);m.useEffect(()=>{const x=b.current;if(!x)return;const T=new Map;x.querySelectorAll("path[data-i2]").forEach(B=>{const G=B.dataset.i2;if(G)try{const H=B.getBBox();H.width>0&&T.set(G,{x:H.x,y:H.y,w:H.width,h:H.height})}catch{}}),C(T)},[e.continent,h,y]);const z=m.useMemo(()=>r.filter(x=>x.cc),[r]),E=m.useMemo(()=>{const x=new Map;return z.forEach(T=>x.set(T.cc,(x.get(T.cc)||0)+1)),x},[z]),q=e.continent==="monde"&&v?v.anchors:null,A=e.continent==="monde"&&v?v.metros:null,F=m.useMemo(()=>z.map(x=>{const T=wr(x.name||x.id||""),B=wr((x.id||x.name||"")+"·y");if(q&&x.cc){const K=A?A[x.cc]:void 0;if(K&&K.length){const ee=jl(x.cc,x.city,T);if(ee>=0&&K[ee])return{d:x,x:K[ee].x+(T-.5)*5,y:K[ee].y+(B-.5)*5}}const ue=q[x.cc];if(ue)return{d:x,x:ue.x+(T-.5)*10,y:ue.y+(B-.5)*10}}const G=x.cc?N.get(x.cc):void 0;if(!G)return null;const H=Cl[`${e.continent}:${x.cc||""}`];if(H)return{d:x,x:G.x+G.w*(H.fx+(T-.5)*H.sx),y:G.y+G.h*(H.fy+(B-.5)*H.sy)};const Q=(T-.5)*Math.min(G.w*.55,60),X=(B-.5)*Math.min(G.h*.55,60);return{d:x,x:G.x+G.w/2+Q,y:G.y+G.h/2+X}}).filter(x=>!!x),[z,N,q,A,e.continent]),P=x=>h>0?x/h:x,I=m.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:yr[x],fr:c.plabels[x].toUpperCase(),en:c.plabels[x].toUpperCase(),n:r.filter(T=>T.kind==="target"&&Ae(T)===x).length})).filter(x=>x.n>0):Mn.map((x,T)=>({...x,n:r.filter(B=>On(B)===T).length})),[r,n,c.plabels]),L=i?s.get(i):null,R=L?F.find(x=>x.d.id===L.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(kr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Sl:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:y.countries.map((x,T)=>t.jsx("g",{className:"ct"+(x.i2&&E.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},T))}),t.jsx("g",{children:F.map(x=>{const T=Mn[On(x.d)],B=!!Re(x.d),G=x.d.kind==="target",H=n&&G?yr[Ae(x.d)]:T.c,Q=!n&&_e(x.d);return t.jsxs("g",{className:"co"+(Q?" done":""),onMouseEnter:()=>{var ue,ee;const X=(ue=p.current)==null?void 0:ue.getBoundingClientRect(),K=(ee=b.current)==null?void 0:ee.createSVGPoint();if(K&&b.current&&X){K.x=x.x,K.y=x.y;const xe=K.matrixTransform(b.current.getScreenCTM());j({x:xe.x-X.left,y:xe.y-X.top,label:x.d.name+" · "+(It(x.d.cc,d)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var ue;if(f==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const X=(ue=b.current)==null?void 0:ue.createSVGPoint();let K=null;if(X&&b.current){X.x=x.x,X.y=x.y;const ee=X.matrixTransform(b.current.getScreenCTM());K={x:ee.x,y:ee.y}}a({type:"popup",id:x.d.id,anchor:K})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:P(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:P(T.px),fill:H,stroke:B?"#DC2626":"#ffffff",strokeWidth:P(B?2.2:1.3)})]},x.d.id||x.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:P(13),fill:"none",stroke:"#0F172A",strokeWidth:P(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:I.map((x,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),d==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},T))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(kr,{msgs:c.loadMsgs})})}function Tl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function fo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:s,lang:d}=W(),c=a.filters,[g,l]=m.useState(!1),[f,u]=m.useState(!1),b=m.useRef(null),p=m.useRef(null),v=m.useMemo(()=>a.continent==="monde"?n:n.filter(R=>R.continent===a.continent),[n,a.continent]),y=R=>v.filter(x=>R!=="country"&&c.country.length&&!c.country.includes(x.cc||"")?!1:ka(x,c,i,R==="country"?void 0:R)),h=R=>!i||R.kind!=="op",N=m.useMemo(()=>{const R=y("win").filter(h),x=T=>R.filter(B=>(B.date?Math.max(0,Math.floor((Date.now()-Date.parse(B.date))/864e5)):9999)<=T).length;return[x(0),x(7),x(30),R.length]},[v,c,i]),C=m.useMemo(()=>c.day?y("win").filter(h).filter(R=>(R.date||"").slice(0,10)===c.day).length:0,[v,c,i]),k=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,j=k+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&l(!1)},[a.openFacet]),m.useEffect(()=>{if(!g&&!f)return;const R=T=>{var G,H;const B=T.target;g&&!((G=b.current)!=null&&G.contains(B))&&l(!1),f&&!((H=p.current)!=null&&H.contains(B))&&u(!1)},x=T=>{T.key==="Escape"&&(l(!1),u(!1))};return document.addEventListener("mousedown",R),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",R),document.removeEventListener("keydown",x)}},[g,f]);const z=(R,x,T,B="fbtn")=>t.jsxs("button",{type:"button",className:B,"aria-expanded":a.openFacet===R,onClick:()=>r({type:"openFacet",facet:R}),children:[t.jsx("span",{className:"fl",children:x}),T>0&&t.jsx("span",{className:"n",children:T}),t.jsx("span",{className:"cv",children:"▾"})]},R),E=["1","7","30","all"],q=Math.max(0,E.indexOf(c.win||"all")),A=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(Tl(c.day,d))}),t.jsx("b",{children:C})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:p,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>u(R=>!R),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[q]}),t.jsx("b",{children:N[q]}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:E.map((R,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===R,onClick:()=>{r({type:"filters",patch:{win:R}}),u(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:N[x]})]},R))})]}):t.jsx("div",{className:"seg",children:E.map((R,x)=>t.jsxs("button",{type:"button","aria-pressed":c.win===R,onClick:()=>r({type:"filters",patch:{win:R}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:N[x]})]},R))}),F=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:R=>r({type:"filters",patch:{search:R.target.value}})})]}),P=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):z("sec",o.fSector,c.sector.length),z("pay",o.fCountry,c.country.length),z("det",o.fEngine,c.engine.length),z("sta",o.fStage,c.stage.length),i&&z("ang","Angle",c.angle.length),i&&z("mem","Mémo",c.memoLevel.length)]}),I=(R=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),R&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{l(R=>!R),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:P})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:A}),t.jsxs("div",{className:"fstrip-b",children:[F,L,I(!1)]})]}),a.openFacet&&t.jsx(jr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[A,F,P,t.jsx("span",{className:"fgrow"}),I()]}),a.openFacet&&t.jsx(jr,{poolFor:y})]})}function jr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=W(),i=a.filters,s=a.openFacet,{title:d,cols:c,options:g}=m.useMemo(()=>{if(s==="sig"){const p=e("signal").filter(h=>Re(h)),v=new Map;p.forEach(h=>{const N=h.engine||"";v.set(N,(v.get(N)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Ya([...v.keys()],o).map(h=>({v:h,label:St(h)+" "+We(h,o),n:v.get(h)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="sec"){const p=e("sector"),v=new Map;return p.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y,n:h,html:!1,on:i.sector.includes(y)}))}}if(s==="pay"){const p=e("country"),v=new Map;return p.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:It(y,o)||y,n:h,html:!1,on:i.country.includes(y)}))}}if(s==="det"){const p=e("engine"),v=new Map;return p.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Ya([...v.keys()],o).map(y=>({v:y,label:St(y)+" "+We(y,o)+' <span style="color:var(--dim);font-size:10px">· '+ni(ri(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(s==="ang"){const p=e("angle"),v=new Map;return p.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y.replace(/[_-]+/g," "),n:h,html:!1,on:i.angle.includes(y)}))}}if(s==="mem"){const p=e("memoLevel"),v=new Map;p.forEach(h=>{if(h.kind==="target"){const N=xn(h);v.set(N,(v.get(N)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:y[h],n:v.get(h)||0,html:!1,on:i.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,v)=>v[1]-p[1]).map(([p,v])=>({v:p,label:p,n:v,html:!1,on:i.stage.includes(p)}))}},[s,a,o]),l=u=>{if(s==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const p=i.signalEngines.includes(u)?i.signalEngines.filter(v=>v!==u):[...i.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:u})},f=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>l(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function ho({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:s,t:d}=W(),c=m.useMemo(()=>{const b={};return r.forEach(p=>{ka(p,n.filters,i)&&(b.monde=(b.monde||0)+1,p.continent&&(b[p.continent]=(b[p.continent]||0)+1))}),b},[r,n.filters,i]),[g,l]=m.useState(!1),f=m.useRef(null);m.useEffect(()=>{if(!g)return;const b=v=>{var y;(y=f.current)!=null&&y.contains(v.target)||l(!1)},p=v=>{v.key==="Escape"&&l(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",p)}},[g]);const u=b=>{const p=bn.find(v=>v.key===b);return b==="monde"?d.contWorld:s==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:f,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>l(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Dn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),l(!1)},children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Dn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function xo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function ql(e){var o;const a=[],r=new Set,n=i=>{const s=(i||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Nr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:s}){const{t:d}=W();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function go({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=W(),o=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),i=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Nr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Nr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Ll({card:e,onEvaluate:a,onAddAll:r}){var d,c,g;const{t:n}=W(),o=[e.industry,...e.market_tags||[],e.author].map(l=>(l||"").trim()).filter(Boolean),i=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(l=>l&&l.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(l=>t.jsx("span",{children:l},l))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xo(e.summary_md||"").map((l,f)=>t.jsx("p",{children:l},f))})]}),t.jsx(go,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(l=>t.jsx("li",{children:l},l))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(l=>t.jsx("a",{href:l.url,target:"_blank",rel:"noopener noreferrer",children:l.label||l.url},l.url))})]})]})}function Fl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Rl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:s}=W(),d=o,[c,g]=m.useState(null),[l,f]=m.useState(null),[u,b]=m.useState(null),[p,v]=m.useState(!1);m.useEffect(()=>{let h=!0;return(async()=>{const N=await Mr({email:s,cbToken:d});h&&g(N)})(),()=>{h=!1}},[s,d,n]);const y=h=>{f(h),b(null),v(!0),(async()=>{const N=await oi(h.id);b(N),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[l?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),l&&t.jsx("span",{className:"ti",children:l.title}),!l&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!l&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[Fl(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?i.rsPub:i.rsPriv})]},h.id))]}),l&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[l.source_url&&t.jsx("a",{href:l.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),l.published&&l.page_url&&t.jsx("a",{href:l.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(l.published?" on":""),children:l.published?i.rsPub:i.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!p&&u&&t.jsx(Ll,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ba=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Jt(e){return/^https?:\/\//i.test((e||"").trim())}function nt(e){const a=(e||"").trim();return a?Jt(a)?a:ba.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Ml(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Ol(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:s,evalBusy:d,evalCards:c,caps:g,data:l,canWrite:f,source:u,dossiers:b,doAnalyse:p,liveMemos:v,pipe:y}=W(),h=a==="client",N=m.useMemo(()=>r||(u!=="default"?ii():""),[r,u]),[C,k]=m.useState(""),[j,z]=m.useState(!1),[E,q]=m.useState(""),[A,F]=m.useState(""),[P,I]=m.useState(""),[L,R]=m.useState(!1),[x,T]=m.useState(!1),[B,G]=m.useState(""),[H,Q]=m.useState(!1),[X,K]=m.useState(""),[ue,ee]=m.useState([]),xe=m.useRef(!1),[_,se]=m.useState(!1),[me,Le]=m.useState(!1),[te,pe]=m.useState(!1),he=m.useRef(!1),[de,Y]=m.useState(""),[ae,ie]=m.useState(""),[ge,Se]=m.useState(!1),[re,ce]=m.useState(!1),[Ie,Oe]=m.useState(0),[Ce,ve]=m.useState(""),[ye,Ue]=m.useState(null),[Fe,st]=m.useState(null),[ut,bt]=m.useState(!1),[tt,vt]=m.useState(null),[yt,Je]=m.useState(0),mt=m.useRef(!1),wt=C.trim()?ba.test(C.trim())?e.evalUrl:e.evalName:e.evalWaiting,S=m.useMemo(()=>B.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[B]);m.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),J=(O.get("rs")||"").trim(),oe=(O.get("rstext")||"").trim();J&&/^https?:\/\//i.test(J)&&Y(J),oe&&ie(oe),(J&&/^https?:\/\//i.test(J)||oe)&&se(!0)},[]),m.useEffect(()=>{const O=J=>{const oe=J.detail||{},w=String(oe.url||"").trim(),D=String(oe.text||"").trim();w&&/^https?:\/\//i.test(w)&&Y(w),D&&ie(D),(w&&/^https?:\/\//i.test(w)||D)&&(se(!0),k(""),q(""),Se(!0),window.setTimeout(()=>Se(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),m.useEffect(()=>{const O=J=>{const oe=J.detail||{},w=String(oe.name||"").trim();if(!w)return;se(!1),k(w),q(w);const D=nt(String(oe.website||oe.domain||""));F(D),I(nt(String(oe.url||""))),R(!D),z(!0),window.setTimeout(()=>z(!1),900)};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),m.useEffect(()=>{const O=(E||"").trim();if(!O||_||A){(A||!O||_)&&R(!1);return}const J=b.find(D=>Pe(D.name)===Pe(O)),oe=nt((J==null?void 0:J.website)||"")||nt((J==null?void 0:J.domain)||"");if(oe){F(oe),R(!1);return}let w=!0;return R(!0),Or(O).then(D=>{var U,Z;if(!w)return;const M=nt(D.website||"")||nt(((Z=(U=D.candidates)==null?void 0:U[0])==null?void 0:Z.url)||"");M&&F(M)}).catch(()=>{}).finally(()=>{w&&R(!1)}),()=>{w=!1}},[E,_,A,b]),m.useEffect(()=>{const O=J=>{var w;const oe=String(((w=J.detail)==null?void 0:w.url)||"").trim();Jt(oe)&&window.open(oe,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",O),()=>window.removeEventListener("ppmap:view",O)},[]),m.useEffect(()=>{if(he.current===_)return;he.current=_,pe(!0);const O=window.setTimeout(()=>pe(!1),560);return()=>window.clearTimeout(O)},[_]),m.useEffect(()=>{if(typeof window>"u")return;const O=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),J=document.querySelector(".atl2.ops, .atl2.cibles");if(!O||!J)return;const oe=()=>J.style.setProperty("--demand-h",`${O.offsetHeight}px`);oe();const w=new ResizeObserver(oe);return w.observe(O),()=>w.disconnect()},[u,j,ge,x,_,te,L]),m.useEffect(()=>{if(!f&&!N){vt(null);return}let O=!0;return(async()=>{const J=await Mr({email:n,cbToken:N});O&&vt(J.length)})(),()=>{O=!1}},[f,N,n,yt]);const V=ue.length?ue:c,$=l.credits,ne=m.useCallback(O=>{const J=O.map(oe=>(oe||"").trim()).filter(Boolean);J.length&&(G(oe=>{const w=oe.split(`
`).map(U=>U.trim()).filter(Boolean),D=new Set(w.map(U=>U.toLowerCase())),M=J.filter(U=>!D.has(U.toLowerCase()));return[...w,...M].slice(0,15).join(`
`)}),T(!0))},[]);m.useEffect(()=>{if(!re)return;Oe(0);const O=window.setInterval(()=>Oe(J=>J+1),1e3);return()=>window.clearInterval(O)},[re]);const be=m.useMemo(()=>{const O=C.trim().toLowerCase();return!O||!y?null:b.find(J=>Pe(J.name)===O&&Ae(J)===1)||null},[C,b,y]),le=()=>{const O=C.trim();if(O){if(be){p(be);return}o(null,O),h&&k("")}},je=async()=>{if(!h){o(null,S[0]||"");return}if(!S.length||H)return;Q(!0),xe.current=!1;const O=[];for(let J=0;J<S.length&&!xe.current;J++){K(e.evaluating(J+1,S.length,S[J]));const oe=await Dr(r,S[J],"atelier2");if(O.unshift({name:oe.company||S[J],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),ee([...O]),oe.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(S.length-J-1),remaining:0}),ee([...O]),G(S.slice(J+1).join(`
`)),K(""),Q(!1);return}}K(""),G(xe.current?S.slice(O.length).join(`
`):""),Q(!1)},Xe=async()=>{var oe,w,D;if(mt.current)return;const O=de.trim().replace(/\s+/g,""),J=ae.trim();if(!O&&!J){ve(e.rsNeed);return}if(!h&&!N){o(null,O||J.slice(0,80));return}mt.current=!0,ve(""),Ue(null),st(null),ce(!0);try{const M=await li({url:O,text:J,email:n,cbToken:N});if(ce(!1),!M||M.status!=="success"){ve((M==null?void 0:M.message)||"Erreur");return}Ue(M),se(!1),ne((((oe=M.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(Z=>(Z==null?void 0:Z.name)||"")),st({state:"pending"});const U=await di(M,{email:n,cbToken:N});st(U.ok?{state:"ok",scopeLabel:((w=U.summary)==null?void 0:w.scope_label)||"",scope:((D=U.summary)==null?void 0:D.scope)||""}:{state:"fail",msg:U.error||""}),U.ok&&Je(Z=>Z+1)}finally{mt.current=!1,ce(!1)}},kt=[ye==null?void 0:ye.industry,...(ye==null?void 0:ye.market_tags)||[],ye==null?void 0:ye.author].map(O=>(O||"").trim()).filter(Boolean),ft=(Fe==null?void 0:Fe.state)==="pending",_t=Fe&&(ft?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Fe.state==="ok"?t.jsx("span",{className:"rslink ok",children:Fe.scope&&Fe.scope!=="public"?e.rsSavedIn(Fe.scopeLabel||Fe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Fe.msg,children:e.rsSaveFail})),Tt=ql(ye).length,Me=_,De=(E||C).trim(),Ze=b.find(O=>Pe(O.name)===Pe(De)),$t=nt(C)||A||nt((Ze==null?void 0:Ze.website)||"")||nt((Ze==null?void 0:Ze.domain)||""),Ut=P||nt((Ze==null?void 0:Ze.url)||""),ia=be?e.actAnalyse:De?e.evalGoOn(De.length>22?De.slice(0,21)+"…":De):e.evalGo,Ma=re?`${si(de.trim())==="youtube"&&de.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Ie)}`:ft?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Me?" rs-mode":"")+(E&&C.trim()===E||j||ge?" pair":"")+(j||ge||te?" echo":"")+(te?" swap":""),children:[t.jsxs("div",{className:"drow"+((Me?ge:j)||te?" flash":"")+((Me?de.trim():ba.test(C.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Me?de:C,placeholder:Me?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Me?600:200,spellCheck:Me?!1:void 0,inputMode:Me?"url":void 0,onChange:O=>{if(Me){Y(O.target.value);return}k(O.target.value),E&&O.target.value.trim()!==E&&(q(""),F(""),I(""),R(!1))},onKeyDown:O=>{O.key==="Enter"&&(Me?Xe():le())}}),t.jsx("span",{className:"detect"+(Me?" off":"")+(ba.test(C.trim())?" url":""),children:wt})]}),t.jsx("span",{className:"dacts",children:Me?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(re?" loading":""),disabled:re||ft||!de.trim()&&!ae.trim(),onClick:()=>{Xe()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ma})]}),t.jsxs("a",{className:"viewbtn"+(Jt(de)?"":" off"),href:Jt(de)?de.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:O=>{Jt(de)||O.preventDefault()},children:[t.jsx(Ml,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(be?" analyse":"")+(d?" loading":""),disabled:d,onClick:le,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ia})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":$t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:O=>{$t||O.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(Ut?"":" off"),href:Ut||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:O=>{Ut||O.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&$&&t.jsxs("button",{type:"button",className:"credits"+($.total_available<=0&&!$.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:$.unlimited?"∞":$.total_available}),!$.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",$.daily_grant+$.purchased]}),$.total_available<=0&&!$.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),v.items.filter(O=>O.status==="boot"||O.status==="running").map(O=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:O.name}),t.jsx(Xt,{item:O,serverOff:v.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>s({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+O.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>T(!x),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(_?" on":""),onClick:()=>se(!_),children:e.rsOpen}),tt!==null&&tt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ut?" on":""),onClick:()=>bt(!ut),children:e.rsArchOpen(tt)})]}),ut&&t.jsx(Rl,{bump:yt,cbToken:N,onClose:()=>bt(!1),onEvaluate:O=>o(null,O),onAddAll:ne}),t.jsx("div",{className:"rsp slim"+(_?" on":" off"),"aria-hidden":!_,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:_?void 0:-1,onClick:()=>Le(O=>!O),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:me?"▴":"▾"})]}),me&&t.jsx("textarea",{className:"rstext",value:ae,placeholder:e.rsTextPh,tabIndex:_?void 0:-1,onChange:O=>ie(O.target.value)})]})}),Ce&&t.jsx("div",{className:"rserr",children:Ce}),ye&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ye.title}),ye.source_url&&t.jsx("a",{href:ye.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{Ue(null),st(null)},children:"×"})]}),ye.market&&t.jsx("p",{className:"rsmk",children:ye.market}),kt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),kt.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[ye.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ye.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:xo(ye.summary_md||"").map((O,J)=>t.jsx("p",{children:O},J))})]}),t.jsx(go,{card:ye,onEvaluate:O=>o(null,O),onAddAll:ne}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Tt)}),_t]})]}),x&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:B,placeholder:e.bulkPh,onChange:O=>G(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(H?" loading":""),style:{justifyContent:"center"},disabled:H||!S.length,onClick:()=>{je()},children:[t.jsx("span",{className:"fill"}),H&&X?X:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(S.length)})]})]}),V.slice(0,1).map((O,J)=>{const oe=O.verdict==="kept",w=O.verdict==="quota",D=oe?"var(--brand)":w?"var(--bolt)":"var(--red)",M=oe?"var(--brand-l)":w?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":D,"--bgc":M},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:w?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map(U=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:U.url.startsWith("http")?U.url:`https://${U.url}`,target:"_blank",rel:"nofollow noopener",children:[(U.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,U.url),children:e.evalPickGo})]},U.url))}),!w&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:oe?1:5});const U=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const Z=[...document.querySelectorAll(".atl2 .list .row")].find(Ee=>{var we;return(((we=Ee.querySelector(".rnm"))==null?void 0:we.textContent)||"").trim().toLowerCase().includes(U)});Z&&(Z.scrollIntoView({behavior:"smooth",block:"center"}),Z.classList.add("flashrow"),window.setTimeout(()=>Z.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),h&&(i.kept+i.dropped>0||V.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Dl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Pl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=W(),i=e.memoConsole?r.get(e.memoConsole):null,s=m.useMemo(()=>i?[i.reasoning||"",Dl(i.summary||"")].filter(Boolean).join(`
...
`).map((g,l)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},l)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Rt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Nn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=W(),[s,d]=m.useState(!1),[c,g]=m.useState(null),l=n.pipe&&o==="client"&&!n.lockActions,f=async()=>{if(!l||s)return;d(!0);const u=await ci(r,e);if(d(!1),!u){i(a.actErr);return}g(u.results||[])};return m.useEffect(()=>{if(!l)return;const u=b=>{var v;const p=String(((v=b.detail)==null?void 0:v.name)||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&f()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,l]),m.useEffect(()=>{if(l)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),f())}catch{}},[e,l]),l?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{f()},children:s?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Il=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ha=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Bl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ha(a.slice(n));break}r+=ha(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ha(a.slice(o));break}const s=a.slice(o+1,i).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(s),c=d?d[2].toLowerCase():"";d&&Il.has(c)?r+=`<${d[1]}${c}>`:r+=ha(a.slice(o,i+1)),n=i+1}return r}const Er=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Be({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function _l(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function $l({o:e}){const{t:a,doDeep:r}=W(),[n,o]=m.useState(!1),i=gt(e),s=[e.reasoning||"",_l(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),s.length?s.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Rt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function En({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=W(),i=ra(e),s=gt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,l=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(s?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:l},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Rt(e)?1:0}].filter(v=>v.n>0),[e,a,d,s,c,g,l]),[u,b]=m.useState("");if(!f.length)return null;const p=f.some(v=>v.k===u)?u:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===v.k,"data-tour":"tab-"+v.k,className:p===v.k?"on":"",onClick:y=>{y.stopPropagation(),b(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Be,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Be,{k:a.cdVerdictDate,v:Er(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Bl(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(Ul,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdSector,v:e.sector}),t.jsx(Be,{k:a.cdStage,v:e.stage}),t.jsx(Be,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Be,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Be,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Be,{k:a.cdAngle,v:e.angle}),t.jsx(Be,{k:a.cdDetected,v:Er(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdName,v:e.contactName}),t.jsx(Be,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Be,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx($l,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Be,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Be,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Ul({o:e}){const{t:a,token:r}=W(),[n,o]=m.useState(!1),[i,s]=m.useState(null),d=async()=>{n||(o(!0),s(await pi(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],l=g.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),i&&l&&t.jsxs(t.Fragment,{children:[g.filter(([,f])=>f).map(([f,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:u})]},f)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!l&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function oa({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,o]=m.useState(!1);return m.useEffect(()=>{const i=a.current;if(!i)return;let s=!1;const d=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Pn({kind:"op",card:e},g).then(l=>{!s&&l&&i.isConnected&&i.replaceChildren(l)})},c=window.requestAnimationFrame(d);return()=>{s=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let s=!1;Pn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!s&&c&&i.isConnected&&i.replaceChildren(c)});const d=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",d),()=>{s=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Hl=`
...
`;function Vl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let d=e.y+10;return d+n>i-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:s,top:d}}function Wl(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:s,askEvaluate:d,doAnalyse:c,doDecide:g,doPromote:l,doRepeche:f,doApproach:u,doDeep:b,doOnboard:p,outbound:v,evalBusy:y}=W(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const N=Re(h),C=Ae(h),k=gt(h),j=ra(h),z=h.kind==="target",E=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return Pt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Hl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Vl(e.popupAnchor,!!h.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(pt(h.date)),We(h.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>E({country:[h.cc]}),children:(It(h.cc,o)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>E({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>E({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(h.amountEur,o)})]}),i.pipe&&z&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[C]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[St(h.engine)," ",t.jsx("b",{children:We(h.engine,o)})," — ",ui(h.engine,o),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(xt,{o:h,lg:!0})," ",t.jsx(Ra,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Pr(N,o))," · ",n.win7(Ir(N,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(oa,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&C>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),i.pipe&&z&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),i.pipe&&z&&t.jsx(En,{o:h})]}),t.jsx(Nn,{name:h.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[C===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),C===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),C===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{l(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),C===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(h,!1),a({type:"popup",id:null})},children:n.actNo}),Rt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),C===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),C===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(h.name),onClick:()=>d(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}function Gl(){const{lang:e,token:a,dossiers:r,caps:n}=W(),o=a||"home",{names:i,verdicts:s}=m.useMemo(()=>{const c=[],g={};return r.forEach(l=>{l.kind!=="target"||!l.name||(c.push(l.name),g[l.name]=mi(l)||"")}),{names:c,verdicts:g}},[r]);return{diff:m.useMemo(()=>i.length?fi(o,i,s,e):null,[o,i.length]),names:i,verdicts:s,scope:o,caps:n}}function Yl(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:s}=W(),d=i.loading&&!s.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const g=u=>{const b=c.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ka[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:u})},children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},l=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${Ka[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:u})},children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),f=(u,b,p,v=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:v,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[l(5,!1,n.plabels[5]),l(7,!0,n.plabels[7]),l(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[f("↩",n.toolUndo,o,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Kl(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:s}=W(),d=m.useRef(null),[c,g]=m.useState(60);m.useEffect(()=>{let p=0;const v=()=>{var k;const y=d.current;if(!y)return;const h=(k=y.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!h)return;const N=h.getBoundingClientRect(),C=y.getBoundingClientRect();g(Math.max(20,Math.min(N.left+N.width/2-C.left,C.width-30)))};return p=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",v)}},[e.ptab]);const l=e.ptab;let f=r.tuto[l].p;if(l===3){const p=n.filter(h=>h.kind==="target"&&Ae(h)===3),v=p.filter(h=>Qa(h)==="auto").length,y=p.filter(h=>Qa(h)==="cd").length;f=r.tutoPending(v,y,p.length)}const u=(()=>{if(s!=="client")return null;if(l===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(l===1){const p=n.filter(v=>v.kind==="target"&&Ae(v)===1&&!o.has(v.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(v=>v.id)})}}return null})(),b=hi(l);return t.jsxs("div",{ref:d,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Ka[l]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[l].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:f}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const Wa=600,Nt=62,Sr="atl2:fstats";function Ql(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=W(),[s,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Sr)==="on"}catch{return!1}}),c=r.stats,g=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),l=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const f=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,u=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((j,z)=>Math.max(j,z.s||0),0),p=g.length?Wa/g.length:0,v=Math.max(4,p-4),y=g.length>=5&&b>0,h=r.marketEstimate||0,N=f(new Date().toISOString().slice(0,10)),C=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],k=[];return typeof c.screened_window=="number"&&l&&k.push({cle:"fenetre",periode:e.funPerWindow(f(l),N),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:C(c.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([z,E],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(z)}),t.jsx("i",{children:E})]},j.cle+E)),j.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((c.screened||0)/h*100)))})]}),j.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const z=!s;d(z),z&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Sr,z?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},j.cle)),s&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Wa} ${Nt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((j,z)=>{const E=(j.s||0)/b*(Nt-4),q=(j.m||0)/b*(Nt-4),A=z*p+(p-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:Nt-2-E,width:v,height:E,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:Nt-2-q,width:v,height:q,fill:"#185c38"})]},j.d)}),t.jsx("line",{x1:0,y1:Nt-1.5,x2:Wa,y2:Nt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const bo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Sn({o:e,locked:a=!1}){const{t:r}=W(),n=ra(e),o=gt(e),i=Ae(e),s=Qa(e),d=xi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(bo[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(Ns,{o:e})]})}const Dt=e=>e.length>22?e.slice(0,21)+"…":e,va=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Fa(e){return va.has(e.engine||"")}function dt(e){return!!e.noCo||Fa(e)&&!!e.url}function na(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function vo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Jl({on:e,rev:a}){const[r,n]=m.useState(null),[o,i]=m.useState({top:0,left:0,width:0});return m.useEffect(()=>{if(!e){n(null);return}const s=()=>{var p,v,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const g=d.getBoundingClientRect(),l=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(l),left:Math.round(g.left),width:Math.round(g.width)});const f=[...d.querySelectorAll(":scope .grp")];let u=null;for(const h of f){const N=h.querySelector(".grp-h");N&&N.getBoundingClientRect().bottom<=l+2&&(u=h)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((p=b.querySelector(".ic"))==null?void 0:p.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",s),window.removeEventListener("resize",s)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Xl(e){const r=()=>{const n=vo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Cr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=W(),[i,s]=m.useState(!1);if(m.useEffect(()=>{n||s(!1)},[n]),_e(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Dt(e.name))})]})}function Cn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:s,doPromote:d,doRepeche:c,doApproach:g,dispatch:l,liveMemos:f}=W(),u=p=>v=>{v.stopPropagation(),p()};if(r.lockActions){const p=u(()=>l({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:p,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ae(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:p,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Dt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:p,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:p,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:p,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:p,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:p,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:p,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),na(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return Fa(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),na(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Cr,{o:e})});const b=Ae(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Cr,{o:e})});if(b===1){const p=f.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Xt,{item:p,serverOff:f.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:u(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})});if(b===4){const p=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:u(()=>g(e)),children:p?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>l({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Zl({o:e}){const{t:a,doThumb:r,thumbOf:n}=W(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function ed({o:e}){const{lang:a}=W();return Re(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(xt,{o:e}),t.jsx(Ra,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[St(e.engine||"")," ",We(e.engine||"",a)]})})}function td({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:s,fresh:d}){const{dispatch:c,caps:g,markRow:l,markedId:f,favIds:u,toggleFav:b,t:p}=W(),v=Ae(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],h=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,N=h<=0?0:h<=7?1:h<=30?2:3,C=g.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:y[N],k=u.has(e.id),j=z=>{if(a)return;if(s){s(e.id);return}if(g.pipe||e.kind==="op"){n();return}const E=z.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:E.left+Math.min(280,E.width/3),y:E.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(f===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+v:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>l(e.id),onMouseLeave:()=>l(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":C}}),t.jsx(No,{o:e}),t.jsxs("span",{className:"nd",children:[d&&t.jsx("span",{className:"rfresh",children:"✨"}),Re(e)&&t.jsx(xt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:z=>{z.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(z=>z&&z!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:p.acqSee(e.acquirer),onClick:z=>{z.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Dt(e.acquirer)]}),Ve(e)?t.jsx("span",{className:"rdec",title:p.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:p.zoomNewsMark,children:"📰"}):null]}),t.jsx(ad,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(ed,{o:e}),g.pipe&&t.jsx(Sn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Cn,{o:e}),g.showThumbs&&t.jsx(Zl,{o:e})]}),r&&!a&&!s&&t.jsx(od,{o:e})]})}function ad({o:e}){const{lang:a,caps:r}=W();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function nd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=W(),s=(u,b=!1)=>p=>{p.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Bt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),l=_e(e),f=l&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[l?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):dt(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),na(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Dt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(oa,{spec:e.card})})]})}function rd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=W();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[We(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Cn,{o:e})}),t.jsx(En,{o:e})]})}function yo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:s,caps:d,dossiers:c}=W(),g=m.useRef(null),l=Ve(e);if(m.useEffect(()=>{if(!l||!(e!=null&&e.decryptHtml))return;const x=g.current;if(!x)return;let T=!1;return Ga(()=>import("./fit-BnaWm7z_.js"),[]).then(async B=>{await B.ensureEditoCss(),!(T||!x.isConnected)&&(B.beautifyEditoRows(x),B.mountCardFits(x))}),()=>{T=!0}},[l,e==null?void 0:e.decryptHtml]),!e&&!a){const x=c.find(Ve);if(x)return t.jsx(yo,{o:x})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,p=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!f||wa(f),y=(e==null?void 0:e.engine)||"",h=Ve(e),N=e?Bt(e.amountEur,n):"",C=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),j=c.find(Ve),z=((j==null?void 0:j.url)||"").trim(),E=!!u&&!!z&&(u===z||u.endsWith(z)||z.endsWith(u)),q=(x,T=!1)=>B=>{B.stopPropagation(),T&&s({type:"continent",key:"monde"}),s({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const A=()=>{f&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:f}}))},F=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},P=()=>{na({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:f})},I=e?_e(e):!1,L=I&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",R=h?r.doEdito.replace(/^📖\s*/,""):y?We(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[R,C?` · ${C}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!h&&(v||Fa({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(h?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),N&&t.jsx("span",{className:"oc-amt",children:N})]}),p&&t.jsx("div",{className:"zoom-card",children:t.jsx(oa,{spec:p})}),(u&&!E&&!h||j&&!h)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!E&&!h&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!h&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),s({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[I?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!v&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Dt(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!h&&(v||Fa({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&f?" ghost":""),onClick:x=>{x.stopPropagation(),P()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Dt(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&f&&d.pipe&&t.jsx(Nn,{name:f})]})]})}function od({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:s}=W();return!o.pipe&&e.kind==="op"?t.jsx(nd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(En,{o:e}),t.jsx(Es,{o:e}),t.jsx(zs,{o:e}),t.jsx(Nn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Sn,{o:e})})]}),e.card&&t.jsx(oa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[St(e.engine||"")," ",We(e.engine||"",r)]}),Re(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(xt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function id({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:s,doDecide:d,lang:c}=W();if(!s.pipe&&e.kind==="op"){const f=Bt(e.amountEur,c),u=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),b=(p,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(oa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),f&&t.jsx("span",{className:"damt",children:f})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[St(e.engine||"")," ",We(e.engine||"",c)]}),Re(e)&&t.jsx(xt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Cn,{o:e})})]})}const g=Ae(e),l=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":l},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Sn,{o:e}),Re(e)&&t.jsx(xt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&s.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function sd(){const{t:e}=W(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function ld({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=W(),i=o==="en",s=l=>n.plabels[l]||"",d=[0,1,2,3,4,5,6,7].filter(l=>l!==a.ptab&&(e[l]||0)>0),c=d.includes(0)?0:d.sort((l,f)=>(e[f]||0)-(e[l]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${s(c)}”`:`${g} dossier${g>1?"s":""} dans « ${s(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+s(c)," →"]})]})}function dd(){var vt,yt,Je,mt,wt;const e=W(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:s,scopedAll:d,markRow:c,lang:g,sessTally:l,data:f,dossiers:u,source:b,focusExtra:p,byId:v,token:y}=e,h=$r(),N=m.useMemo(()=>{var $,ne,be,le;if(!y||b==="ops")return null;const S=((($=h==null?void 0:h.ed)==null?void 0:$.date)||(h==null?void 0:h.day)||"").slice(0,10),V=[(ne=h==null?void 0:h.ed)==null?void 0:ne.html,(be=h==null?void 0:h.ed)==null?void 0:be.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((le=h==null?void 0:h.ed)==null?void 0:le.date)||S,decryptHtml:V||void 0,date:S,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,g,(vt=h==null?void 0:h.ed)==null?void 0:vt.html,(yt=h==null?void 0:h.ed)==null?void 0:yt.acquirers_html,(Je=h==null?void 0:h.ed)==null?void 0:Je.date,h==null?void 0:h.day]),C=S=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:_r,[k,j]=m.useState(new Set);m.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[z,E]=m.useState(null);m.useEffect(()=>{E(null)},[a.ptab,a.continent]);const[q,A]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){A(!1);return}const S=document.getElementById("atl2-stage");if(!S){A(!1);return}const V=new IntersectionObserver(([$])=>A(!!$&&$.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return V.observe(S),()=>V.disconnect()},[a.mapFolded]);const F=a.mapFolded||!q,P=S=>j(V=>{const $=new Set(V);return $.has(S)?$.delete(S):$.add(S),$}),I=b==="ops"||o.pipe,[L,R]=m.useState("all"),[x,T]=m.useState(null),[B,G]=m.useState(!1),H=m.useRef(!0);m.useEffect(()=>{if(H.current){H.current=!1;return}R("all"),G(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!B)return;const S=V=>{var $,ne;(ne=($=V.target)==null?void 0:$.closest)!=null&&ne.call($,".atl2 .doable")||G(!1)};return document.addEventListener("click",S),()=>document.removeEventListener("click",S)},[B]);const Q=m.useMemo(()=>{var V;const S=new Map;for(const $ of ps(((V=h==null?void 0:h.ed)==null?void 0:V.html)||""))S.has($.t)||S.set($.t,$.html);return S},[(mt=h==null?void 0:h.ed)==null?void 0:mt.html]),X=m.useCallback(S=>{if(S.decryptHtml)return S.decryptHtml;if(!Q.size)return;const V=(S.name||"").trim().toLowerCase();if(V.length<3)return;const $=Q.get(V);if($)return $;for(const[ne,be]of Q)if(ne.includes(V)||V.includes(ne))return be},[Q]),{diff:K}=Gl(),[ue,ee]=m.useState(!1),xe=a.filters.win==="1"&&!a.filters.day,[_,se]=m.useState(!1),me=m.useMemo(()=>new Set(((K==null?void 0:K.added)||[]).map(S=>S.trim().toLowerCase()).filter(Boolean)),[K]),Le=m.useMemo(()=>{if(!me.size)return 0;const S={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(V=>!Ve(V)&&me.has((V.name||"").trim().toLowerCase())&&ja(V,S,o.pipe)).length},[u,me,a,o.pipe]);m.useEffect(()=>{const S=()=>{se(!1),R("all"),G(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",S),()=>window.removeEventListener("ppmap:tunnel",S)},[]),m.useEffect(()=>{se(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const te=m.useMemo(()=>{const V=_&&me.size>0||a.filters.signalOnly||L!=="all"?d:s;let $=vn(V,a.sort);return $=$.filter(ne=>!Ve(ne)),_&&me.size&&($=$.filter(ne=>me.has((ne.name||"").trim().toLowerCase()))),L==="explore"?$=$.filter(dt):L==="eval"&&($=$.filter(ne=>!dt(ne)&&!ne.noCo)),$},[s,d,a.sort,L,_,me]),he=m.useMemo(()=>o.pipe?u.filter(S=>S.kind==="target"&&!Ve(S)&&Re(S)&&(a.continent==="monde"||S.continent===a.continent)):te.filter(S=>Re(S)&&!_e(S)),[o.pipe,u,te,a.continent]).length,de=m.useMemo(()=>o.pipe?te:te.filter(S=>!_e(S)&&!S.noCo&&!dt(S)),[te,o.pipe]),Y=b==="ops"?te.filter(dt).length:0,ae=_?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,ie=a.filters,ge=[];if(ie.day)ge.push({k:"day",lib:n.fDay(ie.day.slice(8,10)+"/"+ie.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(ie.win&&ie.win!=="all"){const S=["1","7","30"].indexOf(ie.win);S>=0&&ge.push({k:"win",lib:n.dates[S],off:()=>r({type:"filters",patch:{win:"all"}})})}const Se=S=>S.length<=2?S.join(", "):`${S.length} ${n.fSelected}`;for(const S of["sector","country","engine"]){const V=ie[S];V&&V.length&&ge.push({k:S,lib:Se(V),off:()=>r({type:"clearFacet",facet:S})})}ie.search&&ge.push({k:"search",lib:"🔍 "+ie.search,off:()=>r({type:"filters",patch:{search:""}})}),_&&me.size&&ge.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>se(!1)}),ie.signalOnly&&ge.push({k:"sig",lib:"🔴 "+n.sigDock(he||ie.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const re=(S,V,$="",ne=!1)=>t.jsxs("button",{type:"button","data-s":S,className:$,"aria-sort":a.sort.key===S?a.sort.dir===1?"ascending":"descending":"none",style:ne?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:S}),children:[V,t.jsx("span",{className:"ar",children:a.sort.key===S&&a.sort.dir===1?"▴":"▾"})]},S),ce=m.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const S=new Map;te.forEach(ne=>{const be=ne.engine||"?";S.has(be)||S.set(be,[]),S.get(be).push(ne)});const V={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},$=Ya([...S.keys()],g);return[...S.entries()].sort((ne,be)=>{const le=V[ne[0]]??10+$.indexOf(ne[0]),je=V[be[0]]??10+$.indexOf(be[0]);return le-je})},[te,o.pipe,a.groupBy,g]),Ie=ce?ce.filter(([S])=>va.has(S)).length:0,Oe=(()=>{var V;return((V=(ce?ce.flatMap(([,$])=>$):te)[0])==null?void 0:V.id)??null})(),Ce=m.useRef(!1),ve=m.useMemo(()=>u.find(Ve)||N,[u,N]);m.useEffect(()=>{const S=()=>{Ce.current=!0,se(!1)};return window.addEventListener("ppmap:reveal",S),window.addEventListener("ppmap:focus",S),()=>{window.removeEventListener("ppmap:reveal",S),window.removeEventListener("ppmap:focus",S)}},[]),m.useEffect(()=>{const S=()=>{ve&&r({type:"focus",id:ve.id})};return window.addEventListener("ppmap:edito",S),()=>window.removeEventListener("ppmap:edito",S)},[ve,r]),m.useEffect(()=>{if(!a.focusId)return;T(a.focusId);const S=window.setTimeout(()=>T(null),900);return()=>window.clearTimeout(S)},[a.focusId]),m.useEffect(()=>{if(I&&!(a.focusId&&(te.some(S=>S.id===a.focusId)||u.some(S=>S.id===a.focusId)||a.focusId===(ve==null?void 0:ve.id)))&&!p){if(ve){r({type:"focus",id:ve.id});return}Oe&&r({type:"focus",id:Oe})}},[I,a.focusId,te,Oe,p,r,u,b,ve]),m.useEffect(()=>{if(!I||!a.focusId||ve&&a.focusId===ve.id||te.some(V=>V.id===a.focusId))return;const S=u.find(V=>V.id===a.focusId);if(S){if(Ce.current){S.kind==="op"?R(dt(S)?"explore":"eval"):L!=="all"&&R("all");return}L!=="all"&&Oe&&r({type:"focus",id:Oe})}},[I,a.focusId,L,te,u,Oe,r,ve]),m.useEffect(()=>{if(!I||!a.focusId||!Ce.current)return;const S=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!S){const be=te.findIndex(le=>le.id===a.focusId);if(be>=0){const le=ce?"":"pt"+a.ptab;if(le){const je=a.shown[le]||C();be>=je&&r({type:"more",group:le,by:be-je+8})}}return}Ce.current=!1;const V=vo(),$=S.getBoundingClientRect();$.top>=V-2&&$.bottom<=window.innerHeight-4||Xl(S)},[I,a.focusId,a.ptab,te,a.shown,ce,r]),m.useEffect(()=>{if(typeof window>"u")return;const S=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),V=document.querySelector(".atl2.ops, .atl2.cibles");if(!S||!V)return;const $=()=>V.style.setProperty("--listhead-h",`${S.offsetHeight}px`);$();const ne=new ResizeObserver($);return ne.observe(S),()=>ne.disconnect()},[F,a.dens,a.mapFolded]);const ye=m.useMemo(()=>{if(!I||!a.focusId)return null;if(N&&a.focusId===N.id)return N;const S=te.find($=>$.id===a.focusId)||u.find($=>$.id===a.focusId)||null;if(!S)return null;const V=X(S);return V&&V!==S.decryptHtml?{...S,decryptHtml:V}:S},[I,a.focusId,te,u,X,N]),Ue=o.lockRowsAfter;let Fe=0;const st=(S,V)=>{let $=a.shown[V]||C();return S.length-$<=4&&($=S.length),S.slice(0,$).map(le=>{const je=Ue!==null&&Fe>=Ue;Fe++;const Xe=X(le),kt=Xe&&Xe!==le.decryptHtml?{...le,decryptHtml:Xe}:le,ft=!I&&a.dens!=="maxi"&&(a.dens==="deplie"||(z?z==="open":!!Xe)),_t=k.has(le.id)?!ft:ft,Tt=I?Me=>{Ce.current=!0,r({type:"focus",id:Me});const De=v.get(Me);De&&(dt(De)?na(De):De.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:De.name,url:De.url||"",website:De.website||"",domain:De.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(id,{o:kt,locked:je,selected:I&&a.focusId===le.id,onSelect:Tt},le.id):t.jsx(td,{o:kt,locked:je,open:_t,onToggle:()=>P(le.id),selected:I&&a.focusId===le.id,echo:x===le.id,fresh:me.has((le.name||"").trim().toLowerCase()),onSelect:Tt},le.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(te.length?"":" list-empty"),bt=t.jsxs(t.Fragment,{children:[ce?ce.map(([S,V])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:St(S)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:S==="ma"?n.grpMa:S==="fundraising"?n.grpLev:va.has(S)&&Ie<=1?n.grpNews:S==="nominations"?n.grpNom:S==="media"?n.grpNewsOther:S==="recrutements"?n.grpHire:va.has(S)?n.grpNews+" · "+We(S,g):We(S,g)}),t.jsx("div",{className:"s",children:n.grpCount(V.filter($=>!_e($)).length,V.length)})]})]}),st(V,S)]},S)):st(te,"pt"+a.ptab),f.loading&&!u.length&&t.jsx(sd,{}),!te.length&&!(f.loading&&!u.length)&&(o.pipe?t.jsx(ld,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),tt=t.jsxs("div",{className:"listhead"+(F?" mapoff":""),children:[F&&t.jsx("div",{className:"lh-tools",children:t.jsx(fo,{compact:!0})}),o.showFunnel&&ue&&xe&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(Ts,{}),t.jsx(Ql,{})]}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Yl,{}),t.jsx(Kl,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(xe?" on":""),"aria-pressed":xe,title:n.morningDockTitle,onClick:()=>{if(xe){r({type:"filters",patch:{win:"all",day:""}}),ee(!1);return}se(!1),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),ee(!0)},children:["📊 ",n.morningDock(typeof((wt=f.stats)==null?void 0:wt.screened_today)=="number"?f.stats.screened_today:0)]}),K&&!K.firstVisit&&(K.added.length>0||K.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(_?" on":""),"aria-pressed":_,title:n.sinceSub,onClick:()=>{const S=!_;se(S),ee(!1),S&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(Le),K!=null&&K.lastDate?` · ${n.sinceSince(K.lastDate)}`:""]}),he>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{se(!1),ee(!1),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(he)]})]}),!_&&t.jsxs("span",{className:"main",children:[t.jsx("b",{children:te.length})," ",ae]}),t.jsx("span",{className:"dot",children:"·"}),F&&t.jsx(ho,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[F?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ge.map(S=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:V=>{V.stopPropagation(),S.off()},children:[S.lib,t.jsx("i",{children:"×"})]},S.k)),b==="ops"&&te.length>0&&!F&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",te.length-Y," ",n.zoomPulseEval,Y>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Y," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([S,V])=>t.jsxs("button",{type:"button","data-d":S,"aria-pressed":a.dens===S||S==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:S}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:V})]},S))}),!I&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":z==="open",onClick:()=>{E("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":z==="closed",onClick:()=>{E("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var le;const S=d.filter(je=>!Ve(je)),V=S.filter(je=>!dt(je)&&!je.noCo).length,$=S.filter(dt).length,ne=[["all",n.doAll],["eval",`${n.doEval}${V?` ${V}`:""}`],["explore",`${n.doExplore}${$?` ${$}`:""}`]],be=((le=ne.find(([je])=>je===L))==null?void 0:le[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":B,onClick:()=>G(je=>!je),children:[be,t.jsx("i",{children:"▾"})]}),B&&t.jsx("div",{className:"dolist",children:ne.map(([je,Xe])=>t.jsx("button",{type:"button","aria-pressed":L===je,onClick:()=>{R(je),G(!1)},children:Xe},je))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:S=>r({type:"sort",key:S.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([S,V])=>t.jsx("option",{value:S,children:V},S))})]}),o.showChain&&de.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:de.map(S=>S.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(de.length):n.chainAll(de.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!I&&tt,a.dens!=="maxi"&&!I&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),re("country",n.colCountry),re("name",n.colCompany),re("amount",n.colAmount,"h-amt",!0),re("stage",n.colStage,"h-stade"),re("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[re("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),re("memo",n.colMemo)]}),o.pipe&&re("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),I?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[tt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),re("country",n.colCountry),re("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[re("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),re("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:bt})]}),t.jsxs("aside",{className:"readpane"+((ye?Ve(ye):!p&&ve)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[ve&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===ve.id,onClick:()=>r({type:"focus",id:ve.id}),children:n.doEdito}),N&&a.focusId===N.id?t.jsx("div",{className:"zoom",children:t.jsx(xs,{})}):ye&&o.pipe?t.jsx(rd,{o:ye}):t.jsx(yo,{o:ye,extra:ye?null:p})]})]}):t.jsx("div",{className:ut,children:bt}),(()=>{const S=ce||[["pt"+a.ptab,te]];let V=0,$=0;for(const[be,le]of S){$+=le.length;let je=a.shown[be]||C();le.length-je<=4&&(je=le.length),V+=Math.min(le.length,je)}const ne=$-V;return ne<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>S.forEach(([be,le])=>r({type:"more",group:be,by:le.length,base:C()})),children:[t.jsx("span",{className:"more-label",children:n.more(ne,ne)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(V,$)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(l.kept>0||l.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(l.kept,l.dropped)}}),I&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Jl,{on:!!ce,rev:(ce||[]).map(([S,V])=>S+V.length).join("|")})]})}function zr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function cd(e,a){const r=gi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function pd(e,a){const n=[a.head.split("|").map(zr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",cd(o,a.plabels),ra(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(zr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ud(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const md=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function rt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function fd({o:e,qa:a}){const{t:r,lang:n,fund:o}=W(),i=(e.cribleStatus||"").trim().toUpperCase()||(ra(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=gt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(rt,{k:r.cdSector,v:e.sector}),t.jsx(rt,{k:r.cdStage,v:e.stage}),t.jsx(rt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(rt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(rt,{k:r.cdName,v:e.contactName}),t.jsx(rt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(rt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(rt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(rt,{k:r.cdAngle,v:e.angle}),t.jsx(rt,{k:r.cdDetected,v:md(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,l])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:l})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function hd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:s}=W(),[d,c]=m.useState({}),g=25,l=m.useMemo(()=>n.slice(0,g),[n]);m.useEffect(()=>{l.length&&bi(r,l.map(b=>b.name)).then(c)},[r,l]);const f=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(l.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[u(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(f.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(f.screened/i.marketEstimate*100)," %"]})]})]}),l.map(b=>t.jsx(fd,{o:b,qa:d[b.name]},b.id)),!l.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const xd=50;function zn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=W(),[i,s]=m.useState(null),[d,c]=m.useState(!1),[g,l]=m.useState(""),[f,u]=m.useState(0),[b,p]=m.useState(""),[v,y]=m.useState(!1),[h,N]=m.useState(0),C=m.useRef(null),k=m.useRef(null),j=()=>{N(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>N(A=>A+1),1e3)},z=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};m.useEffect(()=>()=>{C.current&&window.clearInterval(C.current),k.current&&window.clearInterval(k.current)},[]);const E=async A=>{c(!0),l(""),j();const F=await a();if(c(!1),z(),F.ok){s(F);return}if(F.busy){l(o.alertPreviewBusy);return}if(!A){l(o.alertPreviewFail);return}u(xd),z(),C.current=window.setInterval(()=>{u(P=>P>1?P-1:(C.current&&window.clearInterval(C.current),E(!1),0))},1e3)},q=async()=>{if(n||v||d)return;y(!0),p(""),j();const A=await r();y(!1),z(),p(A.ok?o.alertTestOk(A.sentTo||""):A.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||v||f>0,onClick:()=>{E(!0)},children:d?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||d,onClick:()=>{q()},children:v?o.alertBtnTestBusy:o.alertTest})]}),d&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(h)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(h)]}),f>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(f)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Ft="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function $e({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=W();return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function gd(){const{st:e}=W();switch(e.modal){case"chain":return t.jsx(vd,{});case"space":return t.jsx(yd,{});case"alert":return t.jsx(wd,{});case"queue":return t.jsx(Sd,{});case"export":return t.jsx(Cd,{});case"plug":return t.jsx(Td,{});case"recharge":return t.jsx(Ld,{});case"cover":return t.jsx(Rd,{});case"dossier":return t.jsx(Fd,{});case"crit":return t.jsx(Md,{});case"tuto":return t.jsx(Od,{});case"rdv":return t.jsx(bd,{});case"memoalert":return t.jsx(zd,{});default:return null}}function bd(){const{dispatch:e,fund:a,t:r}=W(),n=a||r.rdvCoFallback;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Vr,children:wn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Na}`,children:Na})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],s)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(s+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx($i,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function vd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:s,evalBusy:d,caps:c,memoQueued:g,doAnalyse:l}=W(),f=i==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,p=u[b],v=b>=u.length;return Pt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[It(p.cc,o)||p.countryLabel,p.sector,p.stage,n.daysAgo(pt(p.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:We(p.engine,o).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Bt(p.amountEur,o)})]}),Re(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(xt,{o:p,lg:!0})," ",t.jsx(Ra,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&!(f&&_e(p))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),f&&_e(p)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Et(p)==="retenu"?"var(--brand)":Et(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Et(p)==="retenu"?"✓ "+n.kept:Et(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&p&&c.pipe&&Ae(p)===1&&!g.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{l(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&p&&!(f&&_e(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{s(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function yd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=W(),i=o==="client",s=m.useMemo(()=>i?r.filter(f=>_e(f)):[],[r,i]),d=m.useMemo(()=>vn(s.filter(f=>Et(f)==="retenu"),{key:"signal",dir:-1}),[s]),c=m.useMemo(()=>s.filter(f=>Et(f)==="ecarte"),[s]),g=e.spaceTab==="retenu"?d:c,l=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs($e,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":l},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function wd(){const{mode:e}=W();return e==="client"||e==="apercu"?t.jsx(kd,{}):t.jsx(Ed,{})}function kd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=W(),[i,s]=m.useState("d"),d=o!=="client";return t.jsxs($e,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(jd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="w"&&t.jsx(Nd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),i==="m"&&t.jsx(wo,{})]})}function jd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=m.useState(null),[d,c]=m.useState(!1),[g,l]=m.useState(0);m.useEffect(()=>{let q=!0;return c(!1),_n(a).then(A=>{q&&(A?s(A):c(!0))}),()=>{q=!1}},[a,g]);const f=m.useRef({}),[u,b]=m.useState({}),[p,v]=m.useState(!1),[y,h]=m.useState(!1),N=m.useRef(null);m.useEffect(()=>()=>{N.current&&window.clearTimeout(N.current)},[]);const C=q=>{const A=f.current;Object.keys(A).length&&(v(!0),_n(a,A).then(F=>{if(!F){v(!1),o(e.actErr);return}if(F.throttled&&q<3){N.current=window.setTimeout(()=>C(q+1),5400);return}if(f.current={},b({}),s(F),v(!1),F.throttled){o(e.alertThrottled);return}h(!0),window.setTimeout(()=>h(!1),2e3),n(e.alertSaved)}))},k=q=>{r||(f.current={...f.current,...q},b(A=>({...A,...q})),N.current&&window.clearTimeout(N.current),N.current=window.setTimeout(()=>C(1),700))};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...u},z=q=>!j.sections||j.sections.includes(q),E=q=>{const A=j.sections||e.alertSec.map(([F])=>F);k({sections:z(q)?A.filter(F=>F!==q):[...A,q]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,p&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!p&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,A])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:z(q),disabled:r,onChange:()=>E(q)}),t.jsxs("span",{children:[A,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(zn,{label:e.alertPreview,readOnly:r,onPreview:()=>zi(a),onTest:()=>Ci(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Nd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=m.useState(null),[d,c]=m.useState(!1),[g,l]=m.useState(0);m.useEffect(()=>{let p=!0;return c(!1),$n(a).then(v=>{p&&(v?s(v):c(!0))}),()=>{p=!1}},[a,g]);const f=p=>{r||$n(a,p).then(v=>{if(!v){o(e.actErr);return}s(v),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(p=>p+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>f({dow:Number(p.target.value)}),children:e.alertDow.map((p,v)=>t.jsx("option",{value:v,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(zn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ti(a),onTest:()=>Ai(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function wo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=W(),[s,d]=m.useState(i||""),[c,g]=m.useState(!1),[l,f]=m.useState(!1);m.useEffect(()=>{i&&d(i)},[i]);const u=e.filters,b=m.useMemo(()=>n.filter(h=>Re(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(s)||l)){f(!0);try{await fetch(`${hn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{f(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>We(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>It(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([h,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!i,onChange:h=>d(h.target.value),onKeyDown:h=>{h.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Ed(){const{t:e}=W();return t.jsx($e,{title:e.alertTitle,icon:"🔔",children:t.jsx(wo,{})})}function Sd(){var P,I;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:s,caps:d,dispatch:c,liveMemos:g}=W(),[l,f]=m.useState(()=>Da(r)),[u,b]=m.useState(()=>!Da(r)),[p,v]=m.useState([]),[y,h]=m.useState(0),N=n==="client",C=m.useMemo(()=>{const L=new Map;return o.forEach(R=>{const x=(R.name||"").trim().toLowerCase();x&&!L.has(x)&&L.set(x,R)}),L},[o]);m.useEffect(()=>{let L=!0;return(!Da(r)||y>0)&&b(!0),(async()=>{const[R,x]=await Promise.all([gn(r,y>0),Rr(a)]);L&&(R&&f(R),b(!1),v(x))})(),()=>{L=!1}},[a,r,y]);const k=u&&!l,j=(l==null?void 0:l.per_day)??0,z=((P=l==null?void 0:l.analyzed_today)==null?void 0:P.length)??0,E=l==null?void 0:l.offre,q=(l==null?void 0:l.pool_meta)||[],A=m.useMemo(()=>{const L=new Map;for(const R of(l==null?void 0:l.scheduled)||[])for(const x of R.names||[])L.has(x)||L.set(x,{label:R.day_label,date:R.date});return L},[l==null?void 0:l.scheduled]),F=(l==null?void 0:l.in_progress)||[];return t.jsxs($e,{title:e.queueTitle,wide:!0,children:[E&&t.jsxs("div",{className:"qoffre"+(E.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:E.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:E.delai})]}),t.jsx("span",{className:"osp"}),E.rythme>0?t.jsx("span",{className:"or",children:e.qRate(E.rythme)}):E.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(E.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(z,z+(((I=l==null?void 0:l.pool_order)==null?void 0:I.length)??0))}})}),E&&t.jsxs("div",{className:"qeta",children:[E.file===0?e.qEtaDone:E.rythme<=0?e.qEtaPaused:e.qEta(E.file,E.rythme,E.jours_restants),E.en_retard&&t.jsxs("em",{children:[" ",e.qLate(E.delai,E.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(E==null?void 0:E.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(F.length>0||g.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(Xt,{item:L,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),F.filter(L=>!g.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),p.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:p.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),N&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Bn(a,L.company,"retry").then(()=>h(R=>R+1))},children:e.queueRetry}),N&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Bn(a,L.company,"delete").then(()=>h(R=>R+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((L,R)=>{const x=A.get(L.name),T=C.get((L.name||"").trim().toLowerCase()),B=g.liveOf(L.name),G=!!(T&&s.has(T.id))||!!(B&&(B.status==="boot"||B.status==="running")),H=!!(T&&Ae(T)===1&&!T.memoUrl)&&!B;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),x?t.jsx("span",{className:"qwhen"+(x.label==="demain"?" soon":""),children:x.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),B&&(B.status==="boot"||B.status==="running")&&t.jsx(Xt,{item:B,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),H&&(d.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:G,onClick:()=>{i(T),h(Q=>Q+1)},children:G?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,R])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",R]},L))})]})}function Cd(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:s}=W(),d=`${Ft}/cibles/list.csv?token=${a}`,c=`${Ft}/cibles/list.json?token=${a}`,g=`${Ft}/cibles/export.xlsx?token=${a}&scope=full`,l=`=IMPORTDATA("${d}")`,f=y=>{var h;(h=navigator.clipboard)==null||h.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:l},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,p=()=>{ud(pd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([h])=>h===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs($e,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:h,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(h),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function zd(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=W(),i=o!=="client",[s,d]=m.useState(null),[c,g]=m.useState(!1),[l,f]=m.useState(0),[u,b]=m.useState(!1);m.useEffect(()=>{let h=!0;return g(!1),In(a).then(N=>{h&&(N?d(N):g(!0))}),()=>{h=!1}},[a,l]);const p=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=h=>{if(i||!s)return;const N={enabled:h.enabled??!!s.enabled,email:h.email??(s.email||""),sections:h.sections??p()};b(!0),In(a,N).then(C=>{if(b(!1),!C){n(e.memoAlertErr);return}d(C),r(e.memoAlertSaved)})};if(c)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(h=>h+1),children:e.retry})]})});if(!s)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=p();return t.jsxs($e,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:i||u,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(Ad,{value:s.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>v({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[h],disabled:i||u,onChange:()=>v({sections:{...y,[h]:!y[h]}})}),t.jsx("span",{children:N})]},h))}),t.jsx(zn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>yi(a,y),onTest:()=>vi(a,y)})]})}function Ad({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,s]=m.useState(e);m.useEffect(()=>{s(e)},[e]);const d=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>s(g.target.value),onKeyDown:g=>{g.key==="Enter"&&d&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>o(i.trim()),children:n})]})]})}function Td(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=W(),[i,s]=m.useState(null),[d,c]=m.useState(!1),[g,l]=m.useState(null),[f,u]=m.useState(""),[b,p]=m.useState(0);m.useEffect(()=>{let C=!0;return c(!1),Ja(a).then(k=>{C&&(k?s({configured:k.configured,url_hint:k.url_hint}):c(!0))}),ji(a).then(k=>{C&&l(k)}),()=>{C=!1}},[a,b]);const v=(C,k)=>{o&&Ja(a,C).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}C.test&&j.sent===!1?n(e.plugTestThrottled):r(k),p(z=>z+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${Ft}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs($e,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(C=>C+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!o,onChange:C=>u(C.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!f.trim(),onClick:()=>v({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(qd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function qd(){const{t:e,token:a,lang:r}=W(),[n,o]=m.useState("valides"),[i,s]=m.useState(!1),[d,c]=m.useState(null),[g,l]=m.useState(null),[f,u]=m.useState(!1),[b,p]=m.useState(!1),[v,y]=m.useState(null),[h,N]=m.useState(null),[C,k]=m.useState(null),j=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Ja(a).then(I=>{N(I&&I.configured?I.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),l(null),u(!1),y(null);try{const I=JSON.parse(localStorage.getItem(j)||"null");k(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{k(null)}},[j]);const z=async()=>{s(!0),u(!1),y(null);const I=await Ei(a,n);c(I),l(I.ok?n:null),s(!1)},E=m.useRef(!1),q=async()=>{if(E.current)return;E.current=!0,p(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await Si(a,n,"webhook",void 0,I)}finally{E.current=!1}if(p(!1),u(!1),y(L),L.ok&&(L.pushed||0)>0){const R={t:new Date().toISOString(),n:L.pushed||0};k(R);try{localStorage.setItem(j,JSON.stringify(R))}catch{}}},A=d!=null&&d.ok&&d.ready||0,F=!!(d!=null&&d.ok)&&g===n&&A>0&&!!h&&!C,P=C?new Date(C.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>o(I.target.value),children:e.plugBulkTabs.map(([I,L])=>t.jsx("option",{value:I,children:L},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{z()},children:i?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),C&&t.jsx("p",{className:"mnote",children:e.bulkLocked(P,C.n)}),!C&&!!(d!=null&&d.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!C&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),F&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),F&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(A,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{q()},children:b?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function Ld(){const{t:e,data:a,lang:r}=W(),n=a.credits,o=a.email,i=async s=>{if(!o)return;const d=window.location.href.split("?")[0];try{const g=await(await fetch(`${hn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs($e,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Fd(){const{t:e}=W();return t.jsx($e,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(hd,{})})}function Rd(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:s,flash:d}=W(),[c,g]=m.useState(null),[l,f]=m.useState(!1);m.useEffect(()=>{let A=!0;if(i)return gn(i).then(F=>{A&&F&&typeof F.per_day=="number"&&g(F.per_day)}),()=>{A=!1}},[i]);const[u,b]=m.useState(null);m.useEffect(()=>{if(!o)return;let A=!0;return ki(o).then(F=>{A&&b(F)}),()=>{A=!1}},[o]);const p=r.stats,v=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(A=>A.kind==="target"&&_e(A)).length,y=r.marketEstimate||0,h=y>0?Math.min(100,Math.round(v/y*100)):null,N=(p==null?void 0:p.window_days)||30,C=v>0?v/N:0,k=y>0?Math.max(0,y-v):0,z=y>0&&C>0&&v>=100?Math.round(k/C):null,E=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),q=A=>{l||!s||(f(!0),Ni(o,A).then(F=>{if(f(!1),F===null){d(e.actErr);return}g(F),d(e.alertSaved)}))};return t.jsxs($e,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(E(v))}),y>0&&t.jsx("span",{children:e.covOf(E(y))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),z!==null&&t.jsx("p",{className:"mnote",children:e.covEta(z)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),C>=1&&t.jsx("p",{className:"mnote",children:e.covPace(E(C))}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:E(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:E(p.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((A,F)=>t.jsxs("tr",{className:A.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[A.code,A.geo?` · ${A.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof A.n=="number"?E(A.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:A.source}),A.elargi&&t.jsx("em",{children:e.covWide(String(A.demande||""))}),A.erreur&&t.jsx("em",{children:e.covMissing})]})]},F)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:E(u.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),s&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:c===A?"on":"",disabled:l,onClick:()=>q(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Md(){var h,N,C;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:s,lang:d}=W(),c=n==="client",g=m.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[l,f]=m.useState(""),[u,b]=m.useState(""),[p,v]=m.useState(!1),y=async()=>{const k=l.trim();if(!(!k||p||!c)){v(!0),b("");try{const z=await(await fetch(`${Ft}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(z.reply&&b(String(z.reply)),z.job_id){b(e.critChatRunning);const E=async()=>{const q=await fetch(`${Ft}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:z.job_id})}).then(A=>A.json()).catch(()=>null);if(q&&q.done){b(String(q.reply||q.clarification||q.summary||"✓")),v(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),f("");return}f("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs($e,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((h=i.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=i==null?void 0:i.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,z;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(E=>t.jsx("li",{children:E},E))})]}),!!((z=k.out)!=null&&z.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(E=>t.jsx("li",{children:E},E))})]})]})]},k.title)})]}),!!((C=i==null?void 0:i.gate)!=null&&C.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:l,disabled:!c||p,onChange:k=>f(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!c||p||!l.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(wi,{fund:s,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(bo[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Od(){const{t:e,dispatch:a,startTour:r}=W(),n=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs($e,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const ko="atl2:mapfold",Dd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(ko);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Pd=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},jo=m.createContext(null),W=()=>{const e=m.useContext(jo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function xt({o:e,lg:a}){const{lang:r}=W(),n=Re(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Un(n,r),children:[n.emoji," ",Un(n,r)]}):null}function Ra({o:e,src:a}){const{lang:r,t:n}=W(),o=Re(e);if(!o)return null;const i=Oi(o),s=Di(o);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(Pr(o,r))+" · "+n.win7(Ir(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Id(e,a,r){const n=(r||"").trim();if(n){const i=e.find(s=>(s.url||"")===n);if(i)return i}const o=Pe(a);if(o)return e.find(i=>Pe(i.name)===o)||e.find(i=>{const s=Pe(i.name);return s.length>=3&&(o.includes(s)||s.includes(o))})}function Bd(){const{scoped:e,t:a,st:r,dispatch:n}=W(),o=m.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,s=e.filter(f=>!Ve(f)),d=s.length,c=s.filter(f=>!f.noCo).length,g=s.filter(f=>!!f.noCo).length,l=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:l?"7":"all"}});else{const f=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:f,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function _d(){const{t:e,lang:a,data:r,dispatch:n}=W(),o=r.stats,i=d=>d.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const s=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:s>0?e.covOf(i(s)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function No({o:e}){const{lang:a}=W(),r=Mi(e.cc),n=e.cc?It(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Ar="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",$d=!1;function Ud(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Eo=e=>`atl2:tour:${e||"anon"}`;function Hd(e){try{return localStorage.getItem(Eo(e))==="1"}catch{return!0}}function Tr(e){try{localStorage.setItem(Eo(e),"1")}catch{}}function Vd(e,a,r,n,o,i){const s=e.tourT,d=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:d[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:d[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:d[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:d[0][0],modal:"crit"}].filter(Boolean)}function Qd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var oe;const{lang:s}=qi(),d=Ki[s],c=is(e,s,a),[g,l]=m.useReducer(ds,void 0,()=>ss((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Pd():Dd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),f=m.useRef(!0);m.useEffect(()=>{if(f.current){f.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(ko,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),m.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const w=()=>{window.innerWidth<=760&&l({type:"mapFold",folded:!0})};return w(),window.addEventListener("resize",w),()=>window.removeEventListener("resize",w)},[a]);const u=m.useRef(i);u.current=i,m.useEffect(()=>{var w;(w=u.current)==null||w.call(u,g.filters)},[g.filters]);const[b,p]=m.useState(()=>{if(typeof window>"u")return"both";try{const w=localStorage.getItem("atl2:chrome-mode");if(w==="eval"||w==="filt"||w==="both")return w;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=m.useState(null),[h,N]=m.useState(null),[C,k]=m.useState(null),[j,z]=m.useState({kept:0,dropped:0}),[E,q]=m.useState(!1),[A,F]=m.useState(""),[P,I]=m.useState(!1),[L,R]=m.useState(null),[x,T]=m.useState(!1),[B,G]=m.useState(!1),[,H]=m.useState(0),Q=()=>H(w=>w+1),X=m.useRef([]),K=m.useRef(new Set),ue=m.useRef(new Set),[ee,xe]=m.useState([]),[_,se]=m.useState([]),[me,Le]=m.useState(0),te=m.useRef(new Map),pe=m.useRef(null),{mode:he}=c,de=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),Y=de.pipe,ae=c.session.token||"",ie=he==="client"&&!e;m.useEffect(()=>{if(!ae||!Y)return;let w=!0;const D=async()=>{const Z=await Pi(ae);!w||!Z||(se(Z.runs),Le(Date.now()/1e3-Z.now),xe(Ee=>Ee.filter(we=>!Z.runs.some(et=>Pe(et.company)===Pe(we.name)))))};D();const M=ee.length>0||_.some(Z=>Z.status==="running"),U=window.setInterval(()=>{D()},M?8e3:25e3);return()=>{w=!1,window.clearInterval(U)}},[ae,Y,ee.length,_.some(w=>w.status==="running")]);const ge=m.useMemo(()=>{const w=[],D=new Set;for(const M of ee){const U=Pe(M.name);!U||D.has(U)||(D.add(U),w.push({name:M.name,id:M.id,status:"boot",started:M.started,estMin:M.estMin,memoType:"instant"}))}for(const M of _){const U=Pe(M.company);if(!U||D.has(U))continue;D.add(U);const Z=M.status==="error"?"error":M.status==="done"?"done":"running";w.push({name:M.company,status:Z,started:M.started||0,estMin:M.est_min||(M.memo_type==="detailed"?40:15),url:M.url,error:M.error,memoType:M.memo_type})}return w},[ee,_]),Se=w=>ge.find(D=>Pe(D.name)===Pe(w))||null,re=(w,D)=>{xe(M=>M.some(U=>Pe(U.name)===Pe(w.name))?M:[...M,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:D==="detailed"?40:15}]),K.current.add(w.id),Q()};m.useEffect(()=>{if(document.querySelector(`link[href="${Ar}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=Ar,document.head.appendChild(w)},[]);const ce=(w,D=!1)=>{F(w),I(D),pe.current&&clearTimeout(pe.current),pe.current=setTimeout(()=>F(""),D?4200:2400)},Ie=w=>ce(w,!0),Oe=m.useMemo(()=>{const w=new Map;return c.dossiers.forEach(D=>{D.id&&w.set(D.id,D)}),w},[c.dossiers]),Ce=m.useMemo(()=>c.dossiers.filter(w=>ja(w,g,Y)),[c.dossiers,g,Y]),ve=m.useRef(!1);m.useEffect(()=>{if(ve.current||e||c.loading||!c.dossiers.length)return;if(!de.showFunnel||Hd(c.session.token||"")){ve.current=!0;return}ve.current=!0;const w=window.setTimeout(()=>{Tr(c.session.token||""),T(!0)},700);return()=>window.clearTimeout(w)},[e,c.loading,c.dossiers.length,de.showFunnel,c.session.token]);const ye=m.useMemo(()=>c.dossiers.filter(w=>cs(w,g,Y,c.favIds)),[c.dossiers,g,Y,c.favIds]),Ue=m.useMemo(()=>Li(Ce,c.favIds),[Ce,c.favIds]),Fe=m.useRef(!1);m.useEffect(()=>{if(Fe.current)return;if(!Y||a==="ops"){Fe.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Fe.current=!0;return}if(c.loading)return;Fe.current=!0;const w=Fi(Ue);w!==g.ptab&&l({type:"ptab",tab:w})},[Y,a,n==null?void 0:n.ptab,c.loading,Ue,g.ptab]);const st=m.useMemo(()=>{const w=Gr(c.dossiers);return w?pt(w)===0?d.tourToday:Yr(w,s):d.tourNoRun},[c.dossiers,d,s]),ut=m.useMemo(()=>c.dossiers.some(w=>!!w.memoUrl||!!w.summary||Rt(w)),[c.dossiers]),[bt,tt]=m.useState(!1);m.useEffect(()=>{if(c.loading){tt(!1);return}if(c.dossiers.length>0||c.error){tt(!0);return}const w=window.setTimeout(()=>tt(!0),6e3);return()=>window.clearTimeout(w)},[c.loading,c.dossiers.length,c.error]);const vt=(c.marketEstimate||0)>0||typeof((oe=c.stats)==null?void 0:oe.screened)=="number"&&c.stats.screened>0,yt=m.useMemo(()=>[1,0,2,4,5,3].find(w=>(Ue[w]||0)>0)??0,[Ue]),Je=bn.find(w=>w.key===g.continent),mt=g.continent==="monde"?d.contWorld:(s==="fr"?Je==null?void 0:Je.fr:Je==null?void 0:Je.en)||"";m.useEffect(()=>{const w=D=>{var U;const M=(((U=D.detail)==null?void 0:U.name)||"").trim();M&&wt(null,M)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),m.useEffect(()=>{const w=D=>{const M=D.detail||{},U=String(M.id||"").trim(),Z=String(M.name||"").trim(),Ee=String(M.url||"").trim(),we=U&&Oe.get(U)||Id(c.dossiers,Z,Ee);if(we){if(N(null),ja(we,g,Y)||(g.continent!=="monde"&&we.continent!==g.continent&&l({type:"continent",key:we.continent||"monde"}),l({type:"reset"})),Y&&we.kind!=="op"){const ke=Ae(we);typeof ke=="number"&&ke!==g.ptab&&l({type:"ptab",tab:ke})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),l({type:"focus",id:we.id}),(we.noCo||["media","nominations","recrutements"].includes(we.engine||""))&&(we.url||we.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:we.url||"",text:[we.headline,we.tagline].filter(Boolean).join(`
`)}})):we.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:we.name,url:we.url||"",website:we.website||"",domain:we.domain||""}}));return}!Z&&!Ee||(l({type:"focus",id:U||null}),N({name:Z,headline:String(M.text||"").trim()||Z,url:Ee,card:M.card}),Ee&&(wa(Z)||!Z)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee,text:String(M.text||"").trim()}})):Z&&!wa(Z)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Z}})))};return window.addEventListener("ppmap:focus",w),()=>window.removeEventListener("ppmap:focus",w)}),m.useEffect(()=>{const w=U=>{const Z={},Ee=String((U==null?void 0:U.sector)||"").trim();Ee&&(Z.sector=[Ee]);const we=String((U==null?void 0:U.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(we)&&(Z.day=we);const et=String((U==null?void 0:U.search)||"").trim();et&&(Z.search=et);const ke=String((U==null?void 0:U.dealKind)||"").trim();(ke==="ma"||ke==="levee"||ke==="other")&&(Z.dealKind=[ke]),Object.keys(Z).length&&l({type:"filters",patch:Z})},D=U=>w(U.detail),M=U=>{U.data&&U.data.type==="pp-filter"&&w(U.data)};return window.addEventListener("ppmap:filter",D),window.addEventListener("message",M),()=>{window.removeEventListener("ppmap:filter",D),window.removeEventListener("message",M)}},[]),m.useEffect(()=>{const w=D=>{var Z;const M=(((Z=D.detail)==null?void 0:Z.name)||"").trim().toLowerCase();if(!M)return;const U=c.dossiers.find(Ee=>(Ee.name||"").trim().toLowerCase()===M);U&&l(a==="ops"?{type:"focus",id:U.id}:{type:"popup",id:U.id})};return window.addEventListener("ppmap:similar",w),()=>window.removeEventListener("ppmap:similar",w)});const wt=(w,D)=>{const M=((w==null?void 0:w.name)||D||"").trim();if(!ie){k({kicker:M});return}!M||E||(q(!0),(async()=>{try{let U=M;const Z=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(Z)U=Z;else try{const ke=await Or(M);if(ke!=null&&ke.website)U=ke.website;else if(((ke==null?void 0:ke.candidates)||[]).length===1)U=ke.candidates[0].url;else if(((ke==null?void 0:ke.candidates)||[]).length>1){X.current=[{name:M,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(ke.candidates||[]).slice(0,5)},...X.current].slice(0,8),Q();return}}catch{}const Ee=await Dr(ae,U,"atelier2"),we={name:Ee.company||M,verdict:Ee.verdict,reason:Ee.reason||"",remaining:Ee.remaining??null};X.current=[we,...X.current].slice(0,8),Ee.verdict==="kept"&&z(ke=>({...ke,kept:ke.kept+1})),Ee.verdict==="ruled_out"&&z(ke=>({...ke,dropped:ke.dropped+1}));const et=w||c.dossiers.find(ke=>(ke.name||"").toLowerCase()===M.toLowerCase());et&&(Ee.verdict==="kept"?et.verdict=et.verdict||"MATCH":Ee.verdict==="ruled_out"&&(et.verdict="NO MATCH"),Ee.reason&&(et.reasoning=Ee.reason)),Q()}finally{q(!1)}})())},S=w=>{if(!ie){k({kicker:w.name});return}re(w,"instant"),Ht(ae,"fast_request",w.name||"",""),ce(d.memoInstantSent(w.name))},V=w=>te.current.get(w.id)??c.thumbs.get((w.name||"").trim().toLowerCase()),$=(w,D)=>l({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:D}}),ne=async(w,D,M)=>{const U=w.ceoStatus||"";w.ceoStatus=D,Q();const Z=await Pa(ae,{status:D,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(M==null?void 0:M.note)!==void 0?{note:M.note}:{},...M!=null&&M.via?{via:M.via}:{}});return Z.ok?Z.skipped?(w.ceoStatus=U,Q(),Ie(d.actNotPersisted),!1):((M==null?void 0:M.undo)!==!1&&$(w,U),M!=null&&M.msg&&ce(M.msg),(D==="Validé"||D==="Écarté")&&!w.ceoNote&&(M==null?void 0:M.note)===void 0&&R({o:w,yes:D==="Validé"}),!0):(w.ceoStatus=U,Q(),Ie(d.actErr),!1)},be=async(w,D)=>{const M=await Pa(ae,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:D,via:"note"});return!M.ok||M.skipped?(Ie(M.skipped?d.actNotPersisted:d.actErr),!1):(w.ceoNote=D,Q(),!0)},le=m.useRef(new Map),je=w=>le.current.has(w.id)?le.current.get(w.id):c.stages.get((w.name||"").trim().toLowerCase()),Xe=(w,D)=>{le.current.set(w.id,D),Q()},kt=(w,D)=>{ie&&ne(w,D?"Validé":"Écarté",{msg:D?d.decidedYes(w.name):d.decidedNo(w.name)})},ft=w=>{ie&&ne(w,"À trancher",{msg:d.promoted(w.name)})},_t=w=>{ie&&(async()=>{const D=w.ceoStatus||"";w.ceoStatus="Retenu",Q();const M=await Pa(ae,{status:"Retenu",check_id:w.checkId,company:w.name});if(!M.ok||M.skipped){w.ceoStatus=D,Q(),Ie(M.skipped?d.actNotPersisted:d.actErr);return}$(w,D),ce(d.repeched(w.name))})()},Tt=()=>{const w=g.undo[g.undo.length-1];if(!w){ce(d.undoNone);return}const D=Oe.get(w.id);if(!D){l({type:"undoPop"}),ce(d.undoNone);return}let M=w.prevCeoStatus;if(!M)if((D.verdict||"").toUpperCase().includes("CALL"))M="À trancher";else{ce(d.undoLockedTitle);return}(async()=>await ne(D,M,{undo:!1})&&(l({type:"undoPop"}),D.ceoStatus=w.prevCeoStatus,Q(),ce(d.undoDone(D.name))))()},Me=w=>{ie&&(ue.current.add(w.id),Q(),(async()=>{const D=await Ii(ae,w.name,"email");if(!D||D.ok===!1){ue.current.delete(w.id),Q(),Ie(d.actErr);return}Ht(ae,"approach",w.name||"",""),ce(d.actApproachSent)})())},De=(w,D)=>{ie&&(async()=>{if(!(await Ht(ae,D?"yes":"no",w.name||"","")).ok){Ie(d.actErr);return}te.current.set(w.id,D?"yes":"no"),Q(),ce(D?d.thumbUpDone:d.thumbDnDone)})()},Ze=w=>{!ie||!Rt(w)||(re(w,"detailed"),Ht(ae,"detailed_request",w.name||"",""),ce(d.memoDeepSent(w.name)))},$t=w=>{const D=new Set(c.favIds),M=D.has(w.id);M?D.delete(w.id):D.add(w.id),c.setFavIds(D),ie&&Bi(ae,{id:w.id,co:w.name},M)},Ut=()=>{!ie||B||window.confirm(d.identSyncConfirm)&&(G(!0),(async()=>{const w=await _i(ae);G(!1),w?ce(d.identSyncDone):Ie(d.actErr)})())},ia=/proplace/i.test(c.fund||""),Ma=w=>{!ie||!ia||(Ht(ae,"onboard_request",w.name||"",""),ce(d.onboardSent(w.name)))},O={st:g,dispatch:l,t:d,lang:s,mode:he,caps:de,pipe:Y,token:ae,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:_t,thumbOf:V,canWrite:ie,commitStatus:ne,saveNote:be,stageOf:je,setStage:Xe,flashErr:Ie,startTour:()=>T(!0),dossiers:c.dossiers,scopedAll:Ce,scoped:ye,counts:Ue,byId:Oe,contName:mt,favIds:c.favIds,toggleFav:$t,askEvaluate:wt,doAnalyse:S,doDecide:kt,doPromote:ft,doApproach:Me,doThumb:De,doDeep:Ze,doUndo:Tt,doSync:Ut,doOnboard:Ma,outbound:ia,memoQueued:K.current,liveMemos:{items:ge,serverOff:me,liveOf:Se},approachDone:ue.current,sessTally:j,evalCards:X.current,evalBusy:E,markRow:y,markedId:v,flash:ce,focusExtra:h};m.useEffect(()=>{const w=D=>{D.key==="Escape"&&(l({type:"popup",id:null}),l({type:"modal",modal:null}),l({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const J=w=>ae?t.jsx(ms,{token:ae,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(jo.Provider,{value:O,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ae?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Xi}),J(t.jsxs("div",{className:"app"+(Y?" pipe":"")+(ae?" has-thesis":""),children:[de.showTicker&&t.jsx(at,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ae?" live-stack--cibles":""),children:[t.jsx(ys,{}),!!ae&&t.jsx(fs,{})]})}),de.showIdent&&t.jsx(at,{name:"identite",children:t.jsx(qs,{})}),!1,$d,de.showFunnel&&t.jsx(at,{name:"entonnoir",children:t.jsx(Wd,{})}),!g.mapFolded&&t.jsx(at,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(ho,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Bd,{}),a!=="ops"&&de.showFunnel&&t.jsx(_d,{}),t.jsx(Al,{}),t.jsx(fo,{})]})]})}),de.showDemand&&Y&&t.jsx(at,{name:"direct",children:t.jsx(Wi,{items:ge,serverOff:me,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>l({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":d.chromeBoth,children:[["eval",d.chromeEval],["filt",d.chromeFilt],["both",d.chromeBoth]].map(([w,D])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===w,onClick:()=>{p(w);try{localStorage.setItem("atl2:chrome-mode",w)}catch{}},children:D},w))}),de.showDemand&&t.jsx(at,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Ol,{})})}),de.showDemand&&g.memoConsole&&t.jsx(at,{name:"console",children:t.jsx(Pl,{})}),t.jsx(at,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(dd,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(at,{name:"fiche",children:t.jsx(Wl,{})}),t.jsx(at,{name:"modales",children:t.jsx(gd,{})}),t.jsx(js,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(Cs,{placeholder:L.yes?d.whyYesPh:d.whyNoPh,onDone:w=>{const D=L.o;R(null),w&&be(D,w).then(M=>{M&&ce(d.csNoteSaved)})}})]}),x&&bt&&t.jsx(As,{steps:Vd(d,st,ut,yt,vt,Ue[3]||0),onClose:()=>{T(!1),Tr(ae)}}),t.jsx(Ud,{}),de.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Vr,children:wn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${Na}`,children:Na})]}),t.jsx("button",{type:"button",onClick:()=>l({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),A&&t.jsx("div",{className:"flash on"+(P?" err":""),children:A}),C&&t.jsx(Ri,{variant:"acquirer",initialCompany:qr().co,initialWebsite:qr().site,onClose:()=>k(null)})]})})}function Wd(){const{t:e}=W(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function qr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Gd(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{No as FlagCell,xt as SigBadge,Ra as SigWin,Qd as default,Gd as fmtShort,W as useV2};
;/* deploy-1788027925 */
