...
.atl2 .bulk .side .hint{white-space:nowrap}`,Mi=`
...
.atl2.ops .readpane{min-width:0;position:sticky;top:104px;
...
.atl2.ops .stage:not(.folded) .fbar{position:absolute;z-index:4;right:12px;top:12px;
  ...
  box-sizing:border-box;padding:12px 14px;overflow-y:auto;overscroll-behavior:contain;
...
body.pp-desk .atl2.ops .app:has(> .fzone:has(.stage.folded)) .listhead{top:104px}
...
`,Ri=Li+Mi;function za(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Oi(){const e=za("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Fi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Oi();return r==="0"?"client":r==="1"||za("embed")==="1"&&za("chrome")==="1"?"apercu":"client"}const Pi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Di=e=>Pi[e];function sa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const ot=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ka(a)||sa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:No(e.cc)})};function ua(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Ii=60*60*1e3;function $i(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ii?null:a}catch{return null}}function $t(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Bi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function _i(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:fo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Fi(e,i),[e,i,n]),s=m.useMemo(()=>Di(o),[o]),c=o!=="visiteur",d=Bi(r),[f,l]=m.useState([]),[x,p]=m.useState(""),[h,u]=m.useState(null),[b,v]=m.useState(null),[g,j]=m.useState(null),[E,y]=m.useState(()=>new Map),[A,T]=m.useState(()=>new Map),[z,S]=m.useState(""),[C,N]=m.useState(new Set),[R,$]=m.useState(null),[L,M]=m.useState(!0),[w,O]=m.useState(!1),[H,V]=m.useState(0),[U,re]=m.useState(0),ee=m.useRef(0),X=m.useMemo(()=>{var I;if(o!=="client")return"";try{return((I=xo())==null?void 0:I.email)||""}catch{return""}},[o]);m.useEffect(()=>{const I=++ee.current;let ae=!0;const fe=()=>ae&&I===ee.current,xe=(c&&i.token?i.token:"pub:"+a)+(d?":"+d:""),ge=$i(xe);return ge?(l(ge.objs.map(ot)),ge.fund&&p(ge.fund),u(ge.marketEstimate??null),v(ge.criteria??null),j(ge.stats??null),S(ge.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const ze=await da(),K=((ze==null?void 0:ze.recent_ops)||[]).map(W=>{const Q=Kt(W.company_name||W.title?W:{...W,title:(W.headline_fr||W.headline||"").slice(0,120)},a),J=String(W.rubrique||"").toLowerCase();return Q&&(J==="nominations"||J==="recrutements")&&(Q.engine=J),Q&&!String(W.company_name||"").trim()&&(Q.noCo=!0),Q}).filter(W=>!!W).map(W=>(ka((W.name||"").trim())||(W.noCo=!0),W));try{const W=ho(),Q=W&&W.doc||await go(),J=bo(Q),te=((W==null?void 0:W.day)||(Q==null?void 0:Q.date)||"").slice(0,10);if(J.length&&te){const ye=new Set;for(const de of K){if((de.date||"").slice(0,10)!==te)continue;const we=cn(J,ye,de.name,"");we>=0&&(ye.add(we),de.decryptHtml=J[we].html)}for(const de of K){if(de.decryptHtml||(de.date||"").slice(0,10)!==te)continue;const we=cn(J,ye,"",de.headline||de.tagline||de.name);we>=0&&(ye.add(we),de.decryptHtml=J[we].html)}J.forEach((de,we)=>{if(ye.has(we))return;const le=(de.t||"").trim(),pe=le.split(/[:–—]/)[0].trim().slice(0,80)||le.slice(0,40);if(!pe)return;const qe=le+" "+de.html,q=/\b(acquiert|rachat|rachet|fusion|buyout|offre sur)\b/i.test(qe),F=/\b(l[eè]ve|lev[ée]e|raises?|funding|s[eé]rie [a-z]|series [a-z])\b/i.test(qe);K.push({id:`edito:${te}:${we}`,kind:"op",name:pe,cc:null,date:te,engine:"edito",dealKind:q?"ma":F?"levee":"other",headline:le,decryptHtml:de.html,noCo:!ka(pe)||sa(pe)})})}}catch{}if(!fe())return;l(K.map(ot)),$t(xe,{objs:K})}else if(typeof r=="object"){const K=(await dn()||[]).filter(Q=>(Q.slug||"")===r.research).map(Q=>pn(Q,a)).filter(Q=>!!Q),W=ua(await un(K,a));if(!fe())return;l(W.map(ot)),$t(xe,{objs:W})}else if(c&&i.token){const ze=vo(i.token),K=da(),W=yo(i.token),Q=wo(i.token),J=ko(i.token),te=await ze;let ye=te?te.targets:[];fe()&&te&&(p(te.fund||""),u(te.marketEstimate??null),v(te.criteria??null),j(te.stats??null),S(te.generatedAt||""),l(ye.map(ot)),M(!1),O(!1));const[de,we,le,pe]=await Promise.all([K,W,Q,J]),qe=((de==null?void 0:de.recent_ops)||[]).map(F=>Kt(F,a)).filter(F=>!!F);if(ye=[...ye,...qe],!fe())return;l(ye.map(ot));const q=new Set;for(const F of we){const Y=(F.id||F.co||"").toString().trim().toLowerCase();Y&&q.add(Y.startsWith("t:")?Y:"t:"+Y)}N(q),y(le),T(pe),te&&$t(xe,{fund:te.fund,marketEstimate:te.marketEstimate,criteria:te.criteria,stats:te.stats,generatedAt:te.generatedAt,objs:ye})}else{const ze=jo(),K=dn(),W=da(),Q=await ze;fe()&&Q.length&&(l(ua(Q).map(ot)),M(!1),O(!1));const[J,te]=await Promise.all([K,W]),ye=(J||[]).map(pe=>pn(pe,a)).filter(pe=>!!pe),de=await un(ye,a),we=((te==null?void 0:te.recent_ops)||[]).map(pe=>Kt(pe,a)).filter(pe=>!!pe),le=ua([...Q,...de,...we]);if(!fe())return;l(le.map(ot)),$t(xe,{objs:le})}fe()&&O(!1)}catch{fe()&&!ge&&O(!0)}finally{fe()&&M(!1)}})(),()=>{ae=!1}},[c,i.token,a,H,d]),m.useEffect(()=>{if(!s.showCredits||!X){$(null);return}let I=!0;return(async()=>{try{const ae=await fetch(`${Va}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:X})});if(!ae.ok)return;const fe=await ae.json();I&&fe&&fe.ok!==!1&&$(fe)}catch{}})(),()=>{I=!1}},[s.showCredits,X,U]);const oe=m.useCallback(I=>N(new Set(I)),[]);return{session:i,mode:o,caps:s,fund:x,email:X,marketEstimate:h,generatedAt:z,criteria:b,stats:g,thumbs:E,stages:A,dossiers:f,favIds:C,setFavIds:oe,credits:R,reloadCredits:()=>re(I=>I+1),loading:L,error:w,refresh:()=>V(I=>I+1)}}const pr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ui=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...pr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Vi=new Set(["signal","amount","score","crible","memo"]);function Hi(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:pr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Vi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??ur)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const ur=40;function Ka(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Ae(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ha(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(tt(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&st(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function mr(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ka(e,a.filters,r)}function Wi(e,a,r,n){return!(!mr(e,a,r)||r&&!So(e,a.ptab,n))}function Qa(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-tt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Co(i);case"memo":return Eo(i);case"signal":{const o=Ae(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const s=n(i),c=n(o);return s<c?-a.dir:s>c?a.dir:(i.name||"").localeCompare(o.name||"")})}const ma={},kn=(ma==null?void 0:ma.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function jn(){return new Date().toISOString().slice(0,10)}const Ja=m.createContext(null);function fr(){return m.useContext(Ja)}function Yi(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),s=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const c=n.cloneNode(!0);c.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),c.querySelectorAll("*").forEach(d=>{const f=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(l=>d.removeAttribute(l.name)),f&&/^https?:\/\//i.test(f)&&(d.setAttribute("href",f),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:c.outerHTML})}}catch{}return a}function Nn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${o} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${o} ${r[1]}`}function xr(){const e=m.useContext(Ja);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Gi({token:e,children:a}){const{dispatch:r,st:n,lang:i}=B(),[o,s]=m.useState(()=>n.filters.day||jn()),[c,d]=m.useState(null),[f,l]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){s(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),p=m.useCallback(()=>{s(jn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);m.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),m.useEffect(()=>{const b=v=>{var j;const g=(j=v.detail)==null?void 0:j.day;typeof g=="string"&&x(g)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&s(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;l(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${kn}/cibles/edition.json?${v}`).then(g=>g.json()).then(g=>{b||d(g)}).catch(()=>{b||d({ok:!1,error:"network"})}).finally(()=>{b||l(!1)}),()=>{b=!0}},[e,o]);const h=m.useMemo(()=>`${kn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),u=m.useMemo(()=>({token:e,day:o,ed:c,loading:f,pickDay:x,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:h,isEn:i==="en"}),[e,o,c,f,x,p,n.filters.day,h,i]);return t.jsx(Ja.Provider,{value:u,children:a})}function Ki(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=xr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(s=>!s),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(zo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Qi(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=xr(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),c=(a==null?void 0:a.ok)&&!s,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:Nn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:Nn(e)}),"."]})}),s&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,s&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const Ji=300,fa=7,Xi={fr:{ma:"M&A",levees:"Levées de fonds",nominations:"Nominations",recrutements:"Offres d'emploi",actualites:"Presse"},en:{ma:"M&A",levees:"Fundraising",nominations:"Appointments",recrutements:"Job offers",actualites:"Press"}},hr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Zi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function xa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=Ae(e);return r?"sig:"+(r.theme&&hr.fr[r.theme]?r.theme:"other"):"actualites"}function es(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:s,fund:c}=B(),d=fr(),f=s==="en",[l,x]=m.useState("all"),[p,h]=m.useState(!1),u=m.useMemo(()=>{var oe;const L=(a.filters.day||"").slice(0,10),M=I=>!(!o&&a.continent!=="monde"&&I.continent!==a.continent||L&&(I.date||"").slice(0,10)!==L),w=e.filter(I=>M(I)&&Ae(I)&&(!o||I.kind!=="target"||Ce(I)!==5)),O=o&&(((oe=d==null?void 0:d.ed)==null?void 0:oe.ops)||[]).length?d.ed.ops.map(I=>Kt(I,s)).filter(I=>!!I).filter(I=>!L||(I.date||"").slice(0,10)===L):[],H=e.filter(I=>M(I)&&I.kind==="op"&&(L?!0:tt(I.date)<=fa)),V=o?O.length?O:H.filter(I=>{const ae=(c||"").trim().toLowerCase();if(!ae)return!1;const fe=I.match||null;return fe?Object.keys(fe).map(xe=>xe.trim().toLowerCase()).includes(ae):!1}):H,U=L||new Date().toISOString().slice(0,10),re=I=>{const ae=xa(I);return ae==="ma"?0:ae==="levees"?1:2};V.sort((I,ae)=>{const fe=re(I)-re(ae);if(fe)return fe;const xe=(I.date||"").slice(0,10)===U?0:1,ge=(ae.date||"").slice(0,10)===U?0:1;return xe!==ge?xe-ge:(ae.amountEur||0)-(I.amountEur||0)});const ee=new Set,X=[];for(const I of[...V,...Qa(w,{key:"signal",dir:-1})]){const ae=I.id||I.name;!ae||ee.has(ae)||(ee.add(ae),X.push(I))}return X},[e,a.continent,a.filters.day,o,c,s,d]),b=m.useMemo(()=>{const L={};for(const M of u){const w=xa(M);L[w]=(L[w]||0)+1}return L},[u]),v=m.useMemo(()=>l==="all"?u:u.filter(L=>xa(L)===l),[u,l]),g=m.useMemo(()=>v.slice(0,Ji),[v]),j=v.length-g.length,E=m.useRef(null);m.useEffect(()=>{var V,U;const L=E.current;if(!L)return;const M=()=>{const re=L.scrollWidth;re<200||(L.style.animationDuration=Math.max(18,Math.round(re/130))+"s")};M();const w=requestAnimationFrame(M),O=window.setTimeout(M,1200);let H=!0;return(U=(V=document.fonts)==null?void 0:V.ready)==null||U.then(()=>{H&&M()}),()=>{H=!1,cancelAnimationFrame(w),window.clearTimeout(O)}},[g.length,l]);const y=L=>L==="all"?u.length:b[L]||0,A=L=>L==="all"?f?"All":"Tout":L.startsWith("sig:")?hr[f?"en":"fr"][L.slice(4)]||"🔔":Xi[f?"en":"fr"][L],T=[{k:"all"}],z=["ma","levees"].filter(L=>y(L)>0||L===l);if(z.length){T.push({g:f?"Recent deals":"Opérations récentes"});for(const L of z)T.push({k:L})}const S=["nominations","recrutements","actualites"].filter(L=>y(L)>0||L===l),C=Zi.map(L=>"sig:"+L).filter(L=>y(L)>0||L===l);if(S.length||C.length){T.push({g:f?"News (incl. wire)":"Actualités (dont fil)"});for(const L of S)T.push({k:L});for(const L of C)T.push({k:L})}const N=L=>{try{return new Date(L+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return L}},R=(()=>{const L=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return L?(f?`LIVE covers the events of ${N(L)}.`:`Le LIVE regroupe les événements du ${N(L)}.`)+M:(f?`LIVE covers the still-open signals and the deals of the last ${fa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${fa} derniers jours.`)+M})(),$=L=>g.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Re(M)?" spent":""),onClick:w=>{const O=w.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:O.left+O.width/2,y:O.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(pt,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(Kr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Tc(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(la,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},L+(M.id||M.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},L+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:L=>{L.currentTarget.contains(L.relatedTarget)||h(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>h(L=>!L),children:[A(l),t.jsx("b",{children:y(l)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:R}),T.map(L=>"g"in L?t.jsx("span",{className:"tkfilg",children:L.g},L.g):t.jsxs("button",{type:"button","aria-pressed":L.k===l,onClick:()=>{x(L.k),h(!1)},children:[A(L.k),t.jsx("b",{children:y(L.k)})]},L.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",ref:E,children:[$(0),$(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!d&&t.jsx(as,{isEn:f})]})}const ts=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function as({isEn:e}){const[a,r]=m.useState(()=>Ao());m.useEffect(()=>{const i=o=>{var s;return r(!!((s=o.detail)!=null&&s.open))};return window.addEventListener(mn,i),()=>window.removeEventListener(mn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>To(!a),children:ts})}const ns="aDx8z7Hzksus",Xa="+33 6 83 10 72 86",Xt="alexandre@proplace.co",gr=`tel:${Xa.replace(/[^\d+]/g,"")}`,Sn="pp-rdv-slot";function rs(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function os(){const{t:e,caps:a,fund:r}=B();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:ss}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:gr,children:Xa}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Xt}`,children:Xt})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],s)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(s+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Ni,{filloutId:ns,parameters:r?{company_name:r}:void 0})})]})}function is(){const[e,a]=m.useState(()=>typeof document>"u"?null:document.getElementById(Sn));return m.useEffect(()=>{e||a(document.getElementById(Sn))},[e]),e?yt.createPortal(t.jsx(os,{}),e):null}const ss=`
...
`;class Le extends m.Component{constructor(){super(...arguments);sn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ha=600,it=62,En="atl2:fstats";function ls(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=B(),[s,c]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(En)==="on"}catch{return!1}}),d=r.stats,f=m.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),l=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const x=A=>a==="en"?A.slice(5,10):`${A.slice(8,10)}/${A.slice(5,7)}`,p=A=>A.toLocaleString(a==="en"?"en-US":"fr-FR"),h=f.reduce((A,T)=>Math.max(A,T.s||0),0),u=f.length?ha/f.length:0,b=Math.max(4,u-4),v=f.length>=5&&h>0,g=r.marketEstimate||0,j=x(new Date().toISOString().slice(0,10)),E=A=>[...typeof A=="number"?[[A,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&l&&y.push({cle:"fenetre",periode:e.funPerWindow(x(l),j),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:E(d.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[y.map(A=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:A.periode}),A.etapes.map(([T,z],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(T)}),t.jsx("i",{children:z})]},A.cle+z)),A.cle==="total"&&g>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(g),Math.min(100,Math.round((d.screened||0)/g*100)))})]}),A.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!s;c(T),T&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(En,T?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},A.cle)),s&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ha} ${it}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((A,T)=>{const z=(A.s||0)/h*(it-4),S=(A.m||0)/h*(it-4),C=T*u+(u-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(A.d)} — ${A.s} ${e.actScreened} · ${A.m} ${e.actKept}`}),t.jsx("rect",{x:C,y:it-2-z,width:b,height:z,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:it-2-S,width:b,height:S,fill:"#185c38"})]},A.d)}),t.jsx("line",{x1:0,y1:it-1.5,x2:ha,y2:it-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const br=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function cs(e,a){if((at(e)||"").startsWith("CALL")&&Ce(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ce(e)>=2;return br.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function ds({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:s}=B(),[c,d]=m.useState(!1),[f,l]=m.useState(""),[x,p]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),u=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){p(!0);return}l(b);const v=await i(e,b);l(""),v&&(d(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(b=>!b),p(!1)},children:[h||a.csNone,t.jsx("i",{children:"▾"})]}),c&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{o(e),p(!1),d(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const b=await i(e,"Analysé");l(""),b&&(d(!1),p(!1))})()},children:a.csAnaAnyway})]}):cs(e,a).map(([b,v])=>t.jsx("button",{type:"button",className:"rsti"+(h===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{u(b)},children:v},b))})]})}function ps({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=B(),[o,s]=m.useState(""),[c,d]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),l=(at(e)||"").startsWith("CALL")&&Ce(e)===3,x=Ce(e)>=2,p=async u=>{if(o||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(u);const b=await i(e,u);s(""),b&&(d(!0),setTimeout(()=>d(!1),2200))},h=l?[["Validé",a.csYes],["Écarté",a.csNo]]:br.filter(([u])=>!(x&&u==="Retenu")).map(([u,b])=>[u,a[b]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([u,b])=>t.jsx("button",{type:"button",className:"csb"+(f===u?" on":"")+(o===u?" busy":""),disabled:!!o,onClick:()=>{p(u)},children:b},u)),c&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(us,{o:e})]})}function us({o:e}){const{t:a,saveNote:r,flash:n}=B(),[i,o]=m.useState(e.ceoNote||""),[s,c]=m.useState(!1),[d,f]=m.useState(!1),l=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(s||!l)return;c(!0);const p=await r(e,i.trim());c(!1),p&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:s,onChange:p=>o(p.target.value),onKeyDown:p=>{p.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:s||!l,onClick:()=>{x()},children:d?a.csNoteSaved:a.csNoteOk})]})}function ms({placeholder:e,onDone:a}){const{t:r}=B(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function fs({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:s,flashErr:c}=B(),[d,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||Ce(e)!==4)return null;const l=o(e),x=(l==null?void 0:l.stage)||"todo",p=async g=>{if(d||g===x)return;f(!0);const j=l;s(e,{stage:g,stamps:(l==null?void 0:l.stamps)||{}});const E=Math.max(Date.now(),Cn+=1);Cn=E;const y=await qo(r,{company:e.name||"",stage:g,cts:E,deal_id:e.airtableId,check_id:e.checkId});f(!1),!y.stale&&(y.ok||(s(e,j),c(a.actErr)))},h=(v=l==null?void 0:l.stamps)==null?void 0:v.sent,u=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,b=x==="sent"&&h&&u>=4;return t.jsxs("div",{className:"stg",onClick:g=>g.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([g,j])=>t.jsx("button",{type:"button",className:"stgb"+(x===g?" on":""),disabled:d,onClick:()=>{p(g)},children:j},g)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let Cn=0;const Bt=8,_t=360;function zn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function An({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(zn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(zn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function xs({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=B(),[s,c]=m.useState(0),[d,f]=m.useState(null),[l,x]=m.useState([]),p=m.useRef(!1),h=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),u=m.useRef(!1);m.useEffect(()=>{const z=h.current;return()=>{u.current||(n({type:"ptab",tab:z.ptab}),n({type:"dens",dens:z.dens}),n({type:"modal",modal:z.modal}))}},[]),m.useEffect(()=>{p.current||(p.current=!0,x(e.filter(z=>!!document.querySelector(z.need||z.sel))))},[e]);const b=l[s],v=s>=l.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const z=b.click,S=window.setTimeout(()=>{const C=document.querySelector(z);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(S)}},[s,b]);const g=m.useRef(-1),j=m.useCallback(()=>{if(!b){f(null);return}const z=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!z){f(null);return}g.current!==s&&(g.current=s,z.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=z.getBoundingClientRect();f(C=>C&&Math.abs(C.top-S.top)<1&&Math.abs(C.left-S.left)<1&&Math.abs(C.width-S.width)<1&&Math.abs(C.height-S.height)<1?C:S)},[b,s]);m.useLayoutEffect(()=>{j();const z=[90,300,700,1300].map(C=>window.setTimeout(j,C)),S=()=>j();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{z.forEach(C=>window.clearTimeout(C)),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[j]);const E=m.useRef(a);if(E.current=a,m.useEffect(()=>{const z=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),E.current()):S.key==="ArrowRight"?c(C=>C+1):S.key==="ArrowLeft"&&c(C=>Math.max(0,C-1))};return document.addEventListener("keydown",z,!0),()=>document.removeEventListener("keydown",z,!0)},[]),!l.length)return null;let y=null;const A=z=>()=>{u.current=!0,n({type:"modal",modal:null}),z()};if(v){const z=i[3]||0;z>0?y={title:z===1?r.ahaATitle1:r.ahaATitleN(z),body:r.ahaABody,btn:r.ahaABtn,go:A(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:A(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:A(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:A(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:_t};if(!v&&d){const z=d.bottom+14,C=window.innerHeight-z>190?z:Math.max(12,d.top-200);T={left:Math.min(Math.max(12,d.left+d.width/2-_t/2),window.innerWidth-_t-12),top:C,width:_t}}return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Bt,top:d.top-Bt,width:d.width+Bt*2,height:d.height+Bt*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:T,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(An,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>c(l.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,l.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/l.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(An,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>c(z=>Math.max(0,z-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>c(z=>z+1),children:s===l.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function vr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function yr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function hs(){var S,C;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:s,data:c,dispatch:d}=B(),f=r?a:e,l=m.useMemo(()=>f.filter(N=>tt(N.date)===0&&N.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(N=>N.kind==="target"&&Ce(N)===0).slice().sort((N,R)=>(R.date||"").localeCompare(N.date||"")):[],[a,r]),p=m.useMemo(()=>l.filter(N=>r?Ce(N)===0:!Re(N)),[l,r]),h=r?x:p,u=r?a.length-x.length:l.length-p.length,b=r?a.length:l.length,v=b?Math.min(100,u/b*100):100,g=m.useMemo(()=>vr(f),[f]),j=!!g&&tt(g)>0,E=m.useMemo(()=>j?f.filter(N=>(N.date||"").slice(0,10)===g):[],[f,g,j]),y=typeof((S=c.stats)==null?void 0:S.kept_today)=="number"?c.stats.kept_today:null,A=typeof((C=c.stats)==null?void 0:C.screened_today)=="number"?c.stats.screened_today:l.length;let T;j?T=i.morningLast(E.length,x.length,yr(g,s)):r?T=i.morningThesis(A,x.length,y):l.length?u===0?T=i.goalSourced(l.length):u>=l.length?T=i.goalCleared:T=i.goalDone(u,l.length):T=i.goalSourced(0);const z=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&x.length&&d({type:"chainStart",queue:x.map(N=>N.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),h.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:z,children:r?i.morningEval(h.length):o.pileMode?i.goalContinue(h.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function gs(){var H,V;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:s,dossiers:c,mode:d,doSync:f,startTour:l,flash:x,flashErr:p}=B(),[h,u]=m.useState(null),[b,v]=m.useState(!0),[g,j]=m.useState([]),E=d==="client";m.useEffect(()=>{if(!i||!o)return;let U=!0;return v(!0),(async()=>{const[re,ee]=await Promise.all([Wa(o),sr(i)]);U&&(re&&u(re),v(!1),j(ee))})(),()=>{U=!1}},[i,o]);const[y,A]=m.useState(!1),T=()=>{!E||y||!o||(A(!0),Lo(o).then(U=>{A(!1),U?x(e.identRepubDone):p(e.actErr)}))},z=(h==null?void 0:h.per_day)??null,S=((H=h==null?void 0:h.pool_order)==null?void 0:H.length)??0,C=g.filter(U=>U.status==="running").length,N=m.useMemo(()=>c.filter(U=>U.kind==="target"&&Re(U)).length,[c]),R=s.marketEstimate,$=typeof((V=s.stats)==null?void 0:V.screened)=="number"?s.stats.screened:N,L=R&&R>0?Math.min(100,Math.round($/R*100)):null,M=U=>U.toLocaleString(a==="en"?"en-US":"fr-FR"),w=(o||"P").split(/\s+/).map(U=>U[0]).join("").slice(0,2).toUpperCase(),O=(()=>{const U=Date.parse(s.generatedAt||"");if(Number.isNaN(U))return"";const re=new Date(U),ee=X=>String(X).padStart(2,"0");return`${ee(re.getDate())}/${ee(re.getMonth()+1)} à ${ee(re.getHours())}:${ee(re.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?w:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),O?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(O)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:M($)})})]}),L!==null&&R&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,R)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),z!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:z})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),z===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),C>0&&t.jsxs("span",{className:"ev",children:["⏳ ",C]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:U=>{U.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||y,onClick:T,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:U=>n({type:"filters",patch:{search:U.target.value}})})]})]})]})}function bs(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:s}=B(),c=o.loading&&!s.length,d=m.useRef({});m.useEffect(()=>{d.current={...r}},[r]);const f=p=>{const h=d.current[p],u=h!==void 0?r[p]-h:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${ja[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[r[p],u!==0&&t.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},p)},l=(p,h,u)=>t.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":`var(${ja[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:u.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),x=(p,h,u,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:h,disabled:b,onClick:u,children:p},h);return t.jsxs("div",{className:"funnel"+(c?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[l(5,!1,n.plabels[5]),l(7,!0,n.plabels[7]),l(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function vs(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:s}=B(),c=m.useRef(null),[d,f]=m.useState(60);m.useEffect(()=>{let u=0;const b=()=>{var y;const v=c.current;if(!v)return;const g=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!g)return;const j=g.getBoundingClientRect(),E=v.getBoundingClientRect();f(Math.max(20,Math.min(j.left+j.width/2-E.left,E.width-30)))};return u=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(u),window.removeEventListener("resize",b)}},[e.ptab]);const l=e.ptab;let x=r.tuto[l].p;if(l===3){const u=n.filter(g=>g.kind==="target"&&Ce(g)===3),b=u.filter(g=>Na(g)==="auto").length,v=u.filter(g=>Na(g)==="cd").length;x=r.tutoPending(b,v,u.length)}const p=(()=>{if(s!=="client")return null;if(l===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(u=>u.id)})};if(l===1){const u=n.filter(b=>b.kind==="target"&&Ce(b)===1&&!i.has(b.id)).slice(0,10);if(u.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:u.map(b=>b.id)})}}return null})(),h=Mo(l);return t.jsxs("div",{ref:c,className:"tuto mini"+(h?"":" on-dark"),style:{"--bg":`var(${ja[l]})`,"--ax":d+"px","--stc":h?"var(--ink)":"#fff","--stt":h?"#fff":"var(--ink)","--tc":h?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[l].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:x}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}class ct{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],s=a+o,c=Math.abs(a)<Math.abs(o)?a-(s-o):o-(s-a);c&&(r[n++]=c),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,i=a[--r],s=n+i,o=i-(s-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=s+i,i==n-s&&(s=n))}return s}}function*ys(e){for(const a of e)yield*a}function wr(e){return Array.from(ys(e))}var me=1e-6,ie=Math.PI,Ue=ie/2,Tn=ie/4,He=ie*2,Ze=180/ie,Ie=ie/180,ve=Math.abs,ws=Math.atan,qt=Math.atan2,Se=Math.cos,Ee=Math.sin,ks=Math.sign||function(e){return e>0?1:e<0?-1:0},ut=Math.sqrt;function js(e){return e>1?0:e<-1?ie:Math.acos(e)}function Lt(e){return e>1?Ue:e<-1?-Ue:Math.asin(e)}function Ve(){}function Zt(e,a){e&&Ln.hasOwnProperty(e.type)&&Ln[e.type](e,a)}var qn={Feature:function(e,a){Zt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Zt(r[n].geometry,a)}},Ln={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Aa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Aa(r[n],a,0)},Polygon:function(e,a){Mn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Mn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Zt(r[n],a)}};function Aa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Mn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Aa(e[r],a,1);a.polygonEnd()}function ft(e,a){e&&qn.hasOwnProperty(e.type)?qn[e.type](e,a):Zt(e,a)}function Ta(e){return[qt(e[1],e[0]),Lt(e[2])]}function bt(e){var a=e[0],r=e[1],n=Se(r);return[n*Se(a),n*Ee(a),Ee(r)]}function Ut(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function ea(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ga(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Vt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function qa(e){var a=ut(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function La(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ma(e,a){return ve(e)>ie&&(e-=Math.round(e/He)*He),[e,a]}Ma.invert=Ma;function Ns(e,a,r){return(e%=He)?a||r?La(On(e),Fn(a,r)):On(e):a||r?Fn(a,r):Ma}function Rn(e){return function(a,r){return a+=e,ve(a)>ie&&(a-=Math.round(a/He)*He),[a,r]}}function On(e){var a=Rn(e);return a.invert=Rn(-e),a}function Fn(e,a){var r=Se(e),n=Ee(e),i=Se(a),o=Ee(a);function s(c,d){var f=Se(d),l=Se(c)*f,x=Ee(c)*f,p=Ee(d),h=p*r+l*n;return[qt(x*i-h*o,l*r-p*n),Lt(h*i+x*o)]}return s.invert=function(c,d){var f=Se(d),l=Se(c)*f,x=Ee(c)*f,p=Ee(d),h=p*i-x*o;return[qt(x*i+p*o,l*r+h*n),Lt(h*r-l*n)]},s}function Ss(e,a,r,n,i,o){if(r){var s=Se(a),c=Ee(a),d=n*r;i==null?(i=a+n*He,o=a-d/2):(i=Pn(s,i),o=Pn(s,o),(n>0?i<o:i>o)&&(i+=n*He));for(var f,l=i;n>0?l>o:l<o;l-=d)f=Ta([s,-c*Se(l),-c*Ee(l)]),e.point(f[0],f[1])}}function Pn(e,a){a=bt(a),a[0]-=e,qa(a);var r=js(-a[1]);return((-a[2]<0?-r:r)+He-me)%He}function kr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ve,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Qt(e,a){return ve(e[0]-a[0])<me&&ve(e[1]-a[1])<me}function Ht(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function jr(e,a,r,n,i){var o=[],s=[],c,d;if(e.forEach(function(u){if(!((b=u.length-1)<=0)){var b,v=u[0],g=u[b],j;if(Qt(v,g)){if(!v[2]&&!g[2]){for(i.lineStart(),c=0;c<b;++c)i.point((v=u[c])[0],v[1]);i.lineEnd();return}g[0]+=2*me}o.push(j=new Ht(v,u,null,!0)),s.push(j.o=new Ht(v,null,j,!1)),o.push(j=new Ht(g,u,null,!1)),s.push(j.o=new Ht(g,null,j,!0))}}),!!o.length){for(s.sort(a),Dn(o),Dn(s),c=0,d=s.length;c<d;++c)s[c].e=r=!r;for(var f=o[0],l,x;;){for(var p=f,h=!0;p.v;)if((p=p.n)===f)return;l=p.z,i.lineStart();do{if(p.v=p.o.v=!0,p.e){if(h)for(c=0,d=l.length;c<d;++c)i.point((x=l[c])[0],x[1]);else n(p.x,p.n.x,1,i);p=p.n}else{if(h)for(l=p.p.z,c=l.length-1;c>=0;--c)i.point((x=l[c])[0],x[1]);else n(p.x,p.p.x,-1,i);p=p.p}p=p.o,l=p.z,h=!h}while(!p.v);i.lineEnd()}}}function Dn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function ba(e){return ve(e[0])<=ie?e[0]:ks(e[0])*((ve(e[0])+ie)%He-ie)}function Es(e,a){var r=ba(a),n=a[1],i=Ee(n),o=[Ee(r),-Se(r),0],s=0,c=0,d=new ct;i===1?n=Ue+me:i===-1&&(n=-Ue-me);for(var f=0,l=e.length;f<l;++f)if(p=(x=e[f]).length)for(var x,p,h=x[p-1],u=ba(h),b=h[1]/2+Tn,v=Ee(b),g=Se(b),j=0;j<p;++j,u=y,v=T,g=z,h=E){var E=x[j],y=ba(E),A=E[1]/2+Tn,T=Ee(A),z=Se(A),S=y-u,C=S>=0?1:-1,N=C*S,R=N>ie,$=v*T;if(d.add(qt($*C*Ee(N),g*z+$*Se(N))),s+=R?S+C*He:S,R^u>=r^y>=r){var L=ea(bt(h),bt(E));qa(L);var M=ea(o,L);qa(M);var w=(R^S>=0?-1:1)*Lt(M[2]);(n>w||n===w&&(L[0]||L[1]))&&(c+=R^S>=0?1:-1)}}return(s<-me||s<me&&d<-1e-12)^c&1}function Nr(e,a,r,n){return function(i){var o=a(i),s=kr(),c=a(s),d=!1,f,l,x,p={point:h,lineStart:b,lineEnd:v,polygonStart:function(){p.point=g,p.lineStart=j,p.lineEnd=E,l=[],f=[]},polygonEnd:function(){p.point=h,p.lineStart=b,p.lineEnd=v,l=wr(l);var y=Es(f,n);l.length?(d||(i.polygonStart(),d=!0),jr(l,zs,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),l=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function h(y,A){e(y,A)&&i.point(y,A)}function u(y,A){o.point(y,A)}function b(){p.point=u,o.lineStart()}function v(){p.point=h,o.lineEnd()}function g(y,A){x.push([y,A]),c.point(y,A)}function j(){c.lineStart(),x=[]}function E(){g(x[0][0],x[0][1]),c.lineEnd();var y=c.clean(),A=s.result(),T,z=A.length,S,C,N;if(x.pop(),f.push(x),x=null,!!z){if(y&1){if(C=A[0],(S=C.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),T=0;T<S;++T)i.point((N=C[T])[0],N[1]);i.lineEnd()}return}z>1&&y&2&&A.push(A.pop().concat(A.shift())),l.push(A.filter(Cs))}}return p}}function Cs(e){return e.length>1}function zs(e,a){return((e=e.x)[0]<0?e[1]-Ue-me:Ue-e[1])-((a=a.x)[0]<0?a[1]-Ue-me:Ue-a[1])}const In=Nr(function(){return!0},As,qs,[-ie,-Ue]);function As(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,s){var c=o>0?ie:-ie,d=ve(o-a);ve(d-ie)<me?(e.point(a,r=(r+s)/2>0?Ue:-Ue),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),e.point(o,r),i=0):n!==c&&d>=ie&&(ve(a-n)<me&&(a-=n*me),ve(o-c)<me&&(o-=c*me),r=Ts(a,r,o,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),i=0),e.point(a=o,r=s),n=c},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ts(e,a,r,n){var i,o,s=Ee(e-r);return ve(s)>me?ws((Ee(a)*(o=Se(n))*Ee(r)-Ee(n)*(i=Se(a))*Ee(e))/(i*o*s)):(a+n)/2}function qs(e,a,r,n){var i;if(e==null)i=r*Ue,n.point(-ie,i),n.point(0,i),n.point(ie,i),n.point(ie,0),n.point(ie,-i),n.point(0,-i),n.point(-ie,-i),n.point(-ie,0),n.point(-ie,i);else if(ve(e[0]-a[0])>me){var o=e[0]<a[0]?ie:-ie;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ls(e){var a=Se(e),r=2*Ie,n=a>0,i=ve(a)>me;function o(l,x,p,h){Ss(h,e,r,p,l,x)}function s(l,x){return Se(l)*Se(x)>a}function c(l){var x,p,h,u,b;return{lineStart:function(){u=h=!1,b=1},point:function(v,g){var j=[v,g],E,y=s(v,g),A=n?y?0:f(v,g):y?f(v+(v<0?ie:-ie),g):0;if(!x&&(u=h=y)&&l.lineStart(),y!==h&&(E=d(x,j),(!E||Qt(x,E)||Qt(j,E))&&(j[2]=1)),y!==h)b=0,y?(l.lineStart(),E=d(j,x),l.point(E[0],E[1])):(E=d(x,j),l.point(E[0],E[1],2),l.lineEnd()),x=E;else if(i&&x&&n^y){var T;!(A&p)&&(T=d(j,x,!0))&&(b=0,n?(l.lineStart(),l.point(T[0][0],T[0][1]),l.point(T[1][0],T[1][1]),l.lineEnd()):(l.point(T[1][0],T[1][1]),l.lineEnd(),l.lineStart(),l.point(T[0][0],T[0][1],3)))}y&&(!x||!Qt(x,j))&&l.point(j[0],j[1]),x=j,h=y,p=A},lineEnd:function(){h&&l.lineEnd(),x=null},clean:function(){return b|(u&&h)<<1}}}function d(l,x,p){var h=bt(l),u=bt(x),b=[1,0,0],v=ea(h,u),g=Ut(v,v),j=v[0],E=g-j*j;if(!E)return!p&&l;var y=a*g/E,A=-a*j/E,T=ea(b,v),z=Vt(b,y),S=Vt(v,A);ga(z,S);var C=T,N=Ut(z,C),R=Ut(C,C),$=N*N-R*(Ut(z,z)-1);if(!($<0)){var L=ut($),M=Vt(C,(-N-L)/R);if(ga(M,z),M=Ta(M),!p)return M;var w=l[0],O=x[0],H=l[1],V=x[1],U;O<w&&(U=w,w=O,O=U);var re=O-w,ee=ve(re-ie)<me,X=ee||re<me;if(!ee&&V<H&&(U=H,H=V,V=U),X?ee?H+V>0^M[1]<(ve(M[0]-w)<me?H:V):H<=M[1]&&M[1]<=V:re>ie^(w<=M[0]&&M[0]<=O)){var oe=Vt(C,(-N+L)/R);return ga(oe,z),[M,Ta(oe)]}}}function f(l,x){var p=n?e:ie-e,h=0;return l<-p?h|=1:l>p&&(h|=2),x<-p?h|=4:x>p&&(h|=8),h}return Nr(s,c,o,n?[0,-e]:[-ie,e-ie])}function Ms(e,a,r,n,i,o){var s=e[0],c=e[1],d=a[0],f=a[1],l=0,x=1,p=d-s,h=f-c,u;if(u=r-s,!(!p&&u>0)){if(u/=p,p<0){if(u<l)return;u<x&&(x=u)}else if(p>0){if(u>x)return;u>l&&(l=u)}if(u=i-s,!(!p&&u<0)){if(u/=p,p<0){if(u>x)return;u>l&&(l=u)}else if(p>0){if(u<l)return;u<x&&(x=u)}if(u=n-c,!(!h&&u>0)){if(u/=h,h<0){if(u<l)return;u<x&&(x=u)}else if(h>0){if(u>x)return;u>l&&(l=u)}if(u=o-c,!(!h&&u<0)){if(u/=h,h<0){if(u>x)return;u>l&&(l=u)}else if(h>0){if(u<l)return;u<x&&(x=u)}return l>0&&(e[0]=s+l*p,e[1]=c+l*h),x<1&&(a[0]=s+x*p,a[1]=c+x*h),!0}}}}}var St=1e9,Wt=-St;function Rs(e,a,r,n){function i(f,l){return e<=f&&f<=r&&a<=l&&l<=n}function o(f,l,x,p){var h=0,u=0;if(f==null||(h=s(f,x))!==(u=s(l,x))||d(f,l)<0^x>0)do p.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+x+4)%4)!==u);else p.point(l[0],l[1])}function s(f,l){return ve(f[0]-e)<me?l>0?0:3:ve(f[0]-r)<me?l>0?2:1:ve(f[1]-a)<me?l>0?1:0:l>0?3:2}function c(f,l){return d(f.x,l.x)}function d(f,l){var x=s(f,1),p=s(l,1);return x!==p?x-p:x===0?l[1]-f[1]:x===1?f[0]-l[0]:x===2?f[1]-l[1]:l[0]-f[0]}return function(f){var l=f,x=kr(),p,h,u,b,v,g,j,E,y,A,T,z={point:S,lineStart:$,lineEnd:L,polygonStart:N,polygonEnd:R};function S(w,O){i(w,O)&&l.point(w,O)}function C(){for(var w=0,O=0,H=h.length;O<H;++O)for(var V=h[O],U=1,re=V.length,ee=V[0],X,oe,I=ee[0],ae=ee[1];U<re;++U)X=I,oe=ae,ee=V[U],I=ee[0],ae=ee[1],oe<=n?ae>n&&(I-X)*(n-oe)>(ae-oe)*(e-X)&&++w:ae<=n&&(I-X)*(n-oe)<(ae-oe)*(e-X)&&--w;return w}function N(){l=x,p=[],h=[],T=!0}function R(){var w=C(),O=T&&w,H=(p=wr(p)).length;(O||H)&&(f.polygonStart(),O&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),H&&jr(p,c,w,o,f),f.polygonEnd()),l=f,p=h=u=null}function $(){z.point=M,h&&h.push(u=[]),A=!0,y=!1,j=E=NaN}function L(){p&&(M(b,v),g&&y&&x.rejoin(),p.push(x.result())),z.point=S,y&&l.lineEnd()}function M(w,O){var H=i(w,O);if(h&&u.push([w,O]),A)b=w,v=O,g=H,A=!1,H&&(l.lineStart(),l.point(w,O));else if(H&&y)l.point(w,O);else{var V=[j=Math.max(Wt,Math.min(St,j)),E=Math.max(Wt,Math.min(St,E))],U=[w=Math.max(Wt,Math.min(St,w)),O=Math.max(Wt,Math.min(St,O))];Ms(V,U,e,a,r,n)?(y||(l.lineStart(),l.point(V[0],V[1])),l.point(U[0],U[1]),H||l.lineEnd(),T=!1):H&&(l.lineStart(),l.point(w,O),T=!1)}j=w,E=O,y=H}return z}}const Ra=e=>e;var va=new ct,Oa=new ct,Sr,Er,Fa,Pa,et={point:Ve,lineStart:Ve,lineEnd:Ve,polygonStart:function(){et.lineStart=Os,et.lineEnd=Ps},polygonEnd:function(){et.lineStart=et.lineEnd=et.point=Ve,va.add(ve(Oa)),Oa=new ct},result:function(){var e=va/2;return va=new ct,e}};function Os(){et.point=Fs}function Fs(e,a){et.point=Cr,Sr=Fa=e,Er=Pa=a}function Cr(e,a){Oa.add(Pa*e-Fa*a),Fa=e,Pa=a}function Ps(){Cr(Sr,Er)}var vt=1/0,ta=vt,Mt=-vt,aa=Mt,na={point:Ds,lineStart:Ve,lineEnd:Ve,polygonStart:Ve,polygonEnd:Ve,result:function(){var e=[[vt,ta],[Mt,aa]];return Mt=aa=-(ta=vt=1/0),e}};function Ds(e,a){e<vt&&(vt=e),e>Mt&&(Mt=e),a<ta&&(ta=a),a>aa&&(aa=a)}var Da=0,Ia=0,Et=0,ra=0,oa=0,xt=0,$a=0,Ba=0,Ct=0,zr,Ar,Je,Xe,_e={point:dt,lineStart:$n,lineEnd:Bn,polygonStart:function(){_e.lineStart=Bs,_e.lineEnd=_s},polygonEnd:function(){_e.point=dt,_e.lineStart=$n,_e.lineEnd=Bn},result:function(){var e=Ct?[$a/Ct,Ba/Ct]:xt?[ra/xt,oa/xt]:Et?[Da/Et,Ia/Et]:[NaN,NaN];return Da=Ia=Et=ra=oa=xt=$a=Ba=Ct=0,e}};function dt(e,a){Da+=e,Ia+=a,++Et}function $n(){_e.point=Is}function Is(e,a){_e.point=$s,dt(Je=e,Xe=a)}function $s(e,a){var r=e-Je,n=a-Xe,i=ut(r*r+n*n);ra+=i*(Je+e)/2,oa+=i*(Xe+a)/2,xt+=i,dt(Je=e,Xe=a)}function Bn(){_e.point=dt}function Bs(){_e.point=Us}function _s(){Tr(zr,Ar)}function Us(e,a){_e.point=Tr,dt(zr=Je=e,Ar=Xe=a)}function Tr(e,a){var r=e-Je,n=a-Xe,i=ut(r*r+n*n);ra+=i*(Je+e)/2,oa+=i*(Xe+a)/2,xt+=i,i=Xe*e-Je*a,$a+=i*(Je+e),Ba+=i*(Xe+a),Ct+=i*3,dt(Je=e,Xe=a)}function qr(e){this._context=e}qr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,He);break}}},result:Ve};var _a=new ct,ya,Lr,Mr,zt,At,Rt={point:Ve,lineStart:function(){Rt.point=Vs},lineEnd:function(){ya&&Rr(Lr,Mr),Rt.point=Ve},polygonStart:function(){ya=!0},polygonEnd:function(){ya=null},result:function(){var e=+_a;return _a=new ct,e}};function Vs(e,a){Rt.point=Rr,Lr=zt=e,Mr=At=a}function Rr(e,a){zt-=e,At-=a,_a.add(ut(zt*zt+At*At)),zt=e,At=a}let _n,ia,Un,Vn;class Hn{constructor(a){this._append=a==null?Or:Hs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Un||this._append!==ia){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Un=n,ia=this._append,Vn=this._,this._=i}this._+=Vn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Or(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Hs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Or;if(a!==_n){const r=10**a;_n=a,ia=function(i){let o=1;this._+=i[0];for(const s=i.length;o<s;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ia}function Ws(e,a){let r=3,n=4.5,i,o;function s(c){return c&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),ft(c,i(o))),o.result()}return s.area=function(c){return ft(c,i(et)),et.result()},s.measure=function(c){return ft(c,i(Rt)),Rt.result()},s.bounds=function(c){return ft(c,i(na)),na.result()},s.centroid=function(c){return ft(c,i(_e)),_e.result()},s.projection=function(c){return arguments.length?(i=c==null?(e=null,Ra):(e=c).stream,s):e},s.context=function(c){return arguments.length?(o=c==null?(a=null,new Hn(r)):new qr(a=c),typeof n!="function"&&o.pointRadius(n),s):a},s.pointRadius=function(c){return arguments.length?(n=typeof c=="function"?c:(o.pointRadius(+c),+c),s):n},s.digits=function(c){if(!arguments.length)return r;if(c==null)r=null;else{const d=Math.floor(c);if(!(d>=0))throw new RangeError(`invalid digits: ${c}`);r=d}return a===null&&(o=new Hn(r)),s},s.projection(e).digits(r).context(a)}function Za(e){return function(a){var r=new Ua;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Ua(){}Ua.prototype={constructor:Ua,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function en(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),ft(r,e.stream(na)),a(na.result()),n!=null&&e.clipExtent(n),e}function Fr(e,a,r){return en(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],s=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),c=+a[0][0]+(i-s*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([c,d])},r)}function Ys(e,a,r){return Fr(e,[[0,0],a],r)}function Gs(e,a,r){return en(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),s=(i-o*(n[1][0]+n[0][0]))/2,c=-o*n[0][1];e.scale(150*o).translate([s,c])},r)}function Ks(e,a,r){return en(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),s=-o*n[0][0],c=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([s,c])},r)}var Wn=16,Qs=Se(30*Ie);function Yn(e,a){return+a?Xs(e,a):Js(e)}function Js(e){return Za({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Xs(e,a){function r(n,i,o,s,c,d,f,l,x,p,h,u,b,v){var g=f-n,j=l-i,E=g*g+j*j;if(E>4*a&&b--){var y=s+p,A=c+h,T=d+u,z=ut(y*y+A*A+T*T),S=Lt(T/=z),C=ve(ve(T)-1)<me||ve(o-x)<me?(o+x)/2:qt(A,y),N=e(C,S),R=N[0],$=N[1],L=R-n,M=$-i,w=j*L-g*M;(w*w/E>a||ve((g*L+j*M)/E-.5)>.3||s*p+c*h+d*u<Qs)&&(r(n,i,o,s,c,d,R,$,C,y/=z,A/=z,T,b,v),v.point(R,$),r(R,$,C,y,A,T,f,l,x,p,h,u,b,v))}}return function(n){var i,o,s,c,d,f,l,x,p,h,u,b,v={point:g,lineStart:j,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=A},polygonEnd:function(){n.polygonEnd(),v.lineStart=j}};function g(S,C){S=e(S,C),n.point(S[0],S[1])}function j(){x=NaN,v.point=E,n.lineStart()}function E(S,C){var N=bt([S,C]),R=e(S,C);r(x,p,l,h,u,b,x=R[0],p=R[1],l=S,h=N[0],u=N[1],b=N[2],Wn,n),n.point(x,p)}function y(){v.point=g,n.lineEnd()}function A(){j(),v.point=T,v.lineEnd=z}function T(S,C){E(i=S,C),o=x,s=p,c=h,d=u,f=b,v.point=E}function z(){r(x,p,l,h,u,b,o,s,i,c,d,f,Wn,n),v.lineEnd=y,y()}return v}}var Zs=Za({point:function(e,a){this.stream.point(e*Ie,a*Ie)}});function el(e){return Za({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function tl(e,a,r,n,i){function o(s,c){return s*=n,c*=i,[a+e*s,r-e*c]}return o.invert=function(s,c){return[(s-a)/e*n,(r-c)/e*i]},o}function Gn(e,a,r,n,i,o){if(!o)return tl(e,a,r,n,i);var s=Se(o),c=Ee(o),d=s*e,f=c*e,l=s/e,x=c/e,p=(c*r-s*a)/e,h=(c*a+s*r)/e;function u(b,v){return b*=n,v*=i,[d*b-f*v+a,r-f*b-d*v]}return u.invert=function(b,v){return[n*(l*b-x*v+p),i*(h-x*b-l*v)]},u}function al(e){return nl(function(){return e})()}function nl(e){var a,r=150,n=480,i=250,o=0,s=0,c=0,d=0,f=0,l,x=0,p=1,h=1,u=null,b=In,v=null,g,j,E,y=Ra,A=.5,T,z,S,C,N;function R(w){return S(w[0]*Ie,w[1]*Ie)}function $(w){return w=S.invert(w[0],w[1]),w&&[w[0]*Ze,w[1]*Ze]}R.stream=function(w){return C&&N===w?C:C=Zs(el(l)(b(T(y(N=w)))))},R.preclip=function(w){return arguments.length?(b=w,u=void 0,M()):b},R.postclip=function(w){return arguments.length?(y=w,v=g=j=E=null,M()):y},R.clipAngle=function(w){return arguments.length?(b=+w?Ls(u=w*Ie):(u=null,In),M()):u*Ze},R.clipExtent=function(w){return arguments.length?(y=w==null?(v=g=j=E=null,Ra):Rs(v=+w[0][0],g=+w[0][1],j=+w[1][0],E=+w[1][1]),M()):v==null?null:[[v,g],[j,E]]},R.scale=function(w){return arguments.length?(r=+w,L()):r},R.translate=function(w){return arguments.length?(n=+w[0],i=+w[1],L()):[n,i]},R.center=function(w){return arguments.length?(o=w[0]%360*Ie,s=w[1]%360*Ie,L()):[o*Ze,s*Ze]},R.rotate=function(w){return arguments.length?(c=w[0]%360*Ie,d=w[1]%360*Ie,f=w.length>2?w[2]%360*Ie:0,L()):[c*Ze,d*Ze,f*Ze]},R.angle=function(w){return arguments.length?(x=w%360*Ie,L()):x*Ze},R.reflectX=function(w){return arguments.length?(p=w?-1:1,L()):p<0},R.reflectY=function(w){return arguments.length?(h=w?-1:1,L()):h<0},R.precision=function(w){return arguments.length?(T=Yn(z,A=w*w),M()):ut(A)},R.fitExtent=function(w,O){return Fr(R,w,O)},R.fitSize=function(w,O){return Ys(R,w,O)},R.fitWidth=function(w,O){return Gs(R,w,O)},R.fitHeight=function(w,O){return Ks(R,w,O)};function L(){var w=Gn(r,0,0,p,h,x).apply(null,a(o,s)),O=Gn(r,n-w[0],i-w[1],p,h,x);return l=Ns(c,d,f),z=La(a,O),S=La(l,z),T=Yn(z,A),M()}function M(){return C=N=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&$,L()}}function Pr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Pr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,s=o*o;r-=i=(r*(1.007226+o*(.015085+s*(-.044475+.028874*o-.005916*s)))-a)/(1.007226+o*(.015085*3+s*(-.044475*7+.028874*9*o-.005916*11*s)))}while(ve(i)>me&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function rl(){return al(Pr).scale(175.295)}function ol(e){return e}function il(e){if(e==null)return ol;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],s=e.translate[1];return function(c,d){d||(a=r=0);var f=2,l=c.length,x=new Array(l);for(x[0]=(a+=c[0])*n+o,x[1]=(r+=c[1])*i+s;f<l;)x[f]=c[f],++f;return x}}function sl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ll(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Kn(e,r)})}:Kn(e,a)}function Kn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=cl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function cl(e,a){var r=il(e.transform),n=e.arcs;function i(l,x){x.length&&x.pop();for(var p=n[l<0?~l:l],h=0,u=p.length;h<u;++h)x.push(r(p[h],h));l<0&&sl(x,u)}function o(l){return r(l)}function s(l){for(var x=[],p=0,h=l.length;p<h;++p)i(l[p],x);return x.length<2&&x.push(x[0]),x}function c(l){for(var x=s(l);x.length<4;)x.push(x[0]);return x}function d(l){return l.map(c)}function f(l){var x=l.type,p;switch(x){case"GeometryCollection":return{type:x,geometries:l.geometries.map(f)};case"Point":p=o(l.coordinates);break;case"MultiPoint":p=l.coordinates.map(o);break;case"LineString":p=s(l.arcs);break;case"MultiLineString":p=l.arcs.map(s);break;case"Polygon":p=d(l.arcs);break;case"MultiPolygon":p=l.arcs.map(d);break;default:return null}return{type:x,coordinates:p}}return f(a)}const Dr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},dl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function pl(e,a,r){const n=Dr[e];if(!n||!n.length)return-1;const i=dl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(s=>i.includes(s)))return o}return Math.floor(r*n.length)%n.length}let Yt=null;function ul(){return Yt||(Yt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ll(r,n),o=rl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=Ws(o),c=(i.features||[]).filter(l=>{var x;return(((x=l.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(l=>{var h;const x=((h=l.properties)==null?void 0:h.name)||"",p=s(l)||"";return p?{i2:Ro(x)||null,n:x,d:p}:null}).filter(l=>!!l);if(!c.length)return null;const d={};for(const[l,x]of Object.entries(Oo)){const p=o(x);p&&(d[l]={x:p[0],y:p[1]})}const f={};for(const[l,x]of Object.entries(Dr)){const p=x.map(h=>o(h.ll)).filter(h=>!!h).map(([h,u])=>({x:h,y:u}));p.length&&(f[l]=p)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:c,anchors:d,metros:f}}catch{return null}})(),Yt)}function ml(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return ul().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const fl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Qn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Jn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function xl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const s=()=>{var f;if(!i)return;const d=(f=e.current)==null?void 0:f.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(s)};s();const c=new ResizeObserver(()=>s());return e.current&&c.observe(e.current),window.addEventListener("resize",s),()=>{i=!1,cancelAnimationFrame(o),c.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function Xn({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],s)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function hl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:s,lang:c,t:d,data:f,dossiers:l,source:x}=B(),p=f.loading&&!l.length,h=m.useRef(null),u=m.useRef(null),b=ml(e.continent==="monde"),v=e.continent==="monde"?b:Ya.find(w=>w.key===e.continent)||null,g=xl(h,e.continent+":"+e.mapFolded+":"+!!v),[j,E]=m.useState(new Map),[y,A]=m.useState(null);m.useEffect(()=>{const w=h.current;if(!w)return;const O=new Map;w.querySelectorAll("path[data-i2]").forEach(H=>{const V=H.dataset.i2;if(V)try{const U=H.getBBox();U.width>0&&O.set(V,{x:U.x,y:U.y,w:U.width,h:U.height})}catch{}}),E(O)},[e.continent,g,v]);const T=m.useMemo(()=>r.filter(w=>w.cc),[r]),z=m.useMemo(()=>{const w=new Map;return T.forEach(O=>w.set(O.cc,(w.get(O.cc)||0)+1)),w},[T]),S=e.continent==="monde"&&b?b.anchors:null,C=e.continent==="monde"&&b?b.metros:null,N=m.useMemo(()=>T.map(w=>{const O=Jn(w.name||w.id||""),H=Jn((w.id||w.name||"")+"·y");if(S&&w.cc){const X=C?C[w.cc]:void 0;if(X&&X.length){const I=pl(w.cc,w.city,O);if(I>=0&&X[I])return{d:w,x:X[I].x+(O-.5)*5,y:X[I].y+(H-.5)*5}}const oe=S[w.cc];if(oe)return{d:w,x:oe.x+(O-.5)*10,y:oe.y+(H-.5)*10}}const V=w.cc?j.get(w.cc):void 0;if(!V)return null;const U=fl[`${e.continent}:${w.cc||""}`];if(U)return{d:w,x:V.x+V.w*(U.fx+(O-.5)*U.sx),y:V.y+V.h*(U.fy+(H-.5)*U.sy)};const re=(O-.5)*Math.min(V.w*.55,60),ee=(H-.5)*Math.min(V.h*.55,60);return{d:w,x:V.x+V.w/2+re,y:V.y+V.h/2+ee}}).filter(w=>!!w),[T,j,S,C,e.continent]),R=w=>g>0?w/g:w,$=m.useMemo(()=>n?[0,1,2,3,4,5].map(w=>({c:Qn[w],fr:d.plabels[w].toUpperCase(),en:d.plabels[w].toUpperCase(),n:r.filter(O=>O.kind==="target"&&Ce(O)===w).length})).filter(w=>w.n>0):fn.map((w,O)=>({...w,n:r.filter(H=>xn(H)===O).length})),[r,n,d.plabels]),L=o?s.get(o):null,M=L?N.find(w=>w.d.id===L.id):null;return v?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:[p&&t.jsx(Xn,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:h,viewBox:v.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":c==="fr"?v.fr:v.en,onMouseLeave:()=>{A(null),i(null)},children:[t.jsx("g",{children:v.countries.map((w,O)=>t.jsx("g",{className:"ct"+(w.i2&&z.get(w.i2)?"":" empty"),children:t.jsx("path",{d:w.d,"data-i2":w.i2||void 0})},O))}),t.jsx("g",{children:N.map(w=>{const O=fn[xn(w.d)],H=!!Ae(w.d),V=w.d.kind==="target",U=n&&V?Qn[Ce(w.d)]:O.c,re=!n&&Re(w.d);return t.jsxs("g",{className:"co"+(re?" done":""),onMouseEnter:()=>{var oe,I;const ee=(oe=u.current)==null?void 0:oe.getBoundingClientRect(),X=(I=h.current)==null?void 0:I.createSVGPoint();if(X&&h.current&&ee){X.x=w.x,X.y=w.y;const ae=X.matrixTransform(h.current.getScreenCTM());A({x:ae.x-ee.left,y:ae.y-ee.top,label:w.d.name+" · "+(wt(w.d.cc,c)||w.d.countryLabel||"")})}i(w.d.id)},onMouseLeave:()=>{A(null),i(null)},onClick:()=>{var oe;if(x==="ops"){a({type:"focus",id:w.d.id}),w.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:w.d.name}}));return}const ee=(oe=h.current)==null?void 0:oe.createSVGPoint();let X=null;if(ee&&h.current){ee.x=w.x,ee.y=w.y;const I=ee.matrixTransform(h.current.getScreenCTM());X={x:I.x,y:I.y}}a({type:"popup",id:w.d.id,anchor:X})},children:[t.jsx("circle",{className:"h",cx:w.x,cy:w.y,r:R(Math.max(11,O.px+7))}),t.jsx("circle",{className:"v",cx:w.x,cy:w.y,r:R(O.px),fill:U,stroke:H?"#DC2626":"#ffffff",strokeWidth:R(H?2.2:1.3)})]},w.d.id||w.d.name)})}),M&&t.jsx("circle",{className:"ring on",cx:M.x,cy:M.y,r:R(13),fill:"none",stroke:"#0F172A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:$.map((w,O)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":w.c}}),c==="fr"?w.fr:w.en," ",t.jsx("b",{children:w.n})]},O))}),r.some(w=>!w.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(w=>!w.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:t.jsx(Xn,{msgs:d.loadMsgs})})}function gl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Ir({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:s,lang:c}=B(),d=a.filters,[f,l]=m.useState(!1),x=m.useRef(null),p=m.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),h=S=>p.filter(C=>S!=="country"&&d.country.length&&!d.country.includes(C.cc||"")?!1:Ka(C,d,o,S==="country"?void 0:S)),u=m.useMemo(()=>{const S=h("win"),C=N=>S.filter(R=>(R.date?Math.max(0,Math.floor((Date.now()-Date.parse(R.date))/864e5)):9999)<=N).length;return[C(0),C(7),C(30),S.length]},[p,d,o]),b=m.useMemo(()=>d.day?h("win").filter(S=>(S.date||"").slice(0,10)===d.day).length:0,[p,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,g=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&l(!1)},[a.openFacet]),m.useEffect(()=>{if(!f)return;const S=N=>{var R;(R=x.current)!=null&&R.contains(N.target)||l(!1)},C=N=>{N.key==="Escape"&&l(!1)};return document.addEventListener("mousedown",S),document.addEventListener("keydown",C),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",C)}},[f]);const j=(S,C,N,R="fbtn")=>t.jsxs("button",{type:"button",className:R,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:C}),N>0&&t.jsx("span",{className:"n",children:N}),t.jsx("span",{className:"cv",children:"▾"})]},S),E=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(gl(d.day,c))}),t.jsx("b",{children:b})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((S,C)=>t.jsxs("button",{type:"button","aria-pressed":d.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:i.dates[C]}),t.jsx("b",{children:u[C]})]},S))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),A=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):j("sec",i.fSector,d.sector.length),j("pay",i.fCountry,d.country.length),j("det",i.fEngine,d.engine.length),j("sta",i.fStage,d.stage.length),o&&j("ang","Angle",d.angle.length),o&&j("mem","Mémo",d.memoLevel.length)]}),T=(S=!1)=>t.jsxs("div",{className:"frow2",children:[g>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(p.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(g)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),S&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),z=t.jsxs("div",{className:"fmenu",ref:x,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{l(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:A})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[!d.day&&t.jsx("div",{className:"fstrip-a",children:E}),t.jsxs("div",{className:"fstrip-b",children:[y,z,T(!0)]})]}),a.openFacet&&t.jsx(Zn,{poolFor:h})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[E,y,A,t.jsx("span",{className:"fgrow"}),T()]}),a.openFacet&&t.jsx(Zn,{poolFor:h})]})}function Zn({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=B(),o=a.filters,s=a.openFacet,{title:c,cols:d,options:f}=m.useMemo(()=>{if(s==="sig"){const u=e("signal").filter(g=>Ae(g)),b=new Map;u.forEach(g=>{const j=g.engine||"";b.set(j,(b.get(j)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:u.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Sa([...b.keys()],i).map(g=>({v:g,label:lt(g)+" "+Ye(g,i),n:b.get(g)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(g)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(s==="sec"){const u=e("sector"),b=new Map;return u.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:v,n:g,html:!1,on:o.sector.includes(v)}))}}if(s==="pay"){const u=e("country"),b=new Map;return u.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:wt(v,i)||v,n:g,html:!1,on:o.country.includes(v)}))}}if(s==="det"){const u=e("engine"),b=new Map;return u.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Sa([...b.keys()],i).map(v=>({v,label:lt(v)+" "+Ye(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Fo(Po(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(s==="ang"){const u=e("angle"),b=new Map;return u.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:v.replace(/[_-]+/g," "),n:g,html:!1,on:o.angle.includes(v)}))}}if(s==="mem"){const u=e("memoLevel"),b=new Map;u.forEach(g=>{if(g.kind==="target"){const j=Ha(g);b.set(j,(b.get(j)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(g=>({v:String(g),label:v[g],n:b.get(g)||0,html:!1,on:o.memoLevel.includes(g)}))}}const p=e("stage"),h=new Map;return p.forEach(u=>{u.stage&&h.set(u.stage,(h.get(u.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((u,b)=>b[1]-u[1]).map(([u,b])=>({v:u,label:u,n:b,html:!1,on:o.stage.includes(u)}))}},[s,a,i]),l=p=>{if(s==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const u=o.signalEngines.includes(p)?o.signalEngines.filter(b=>b!==p):[...o.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:u}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:p})},x=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:c}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:f.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>l(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function $r({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:s,t:c}=B(),d=m.useMemo(()=>{const h={};return r.forEach(u=>{Ka(u,n.filters,o)&&(h.monde=(h.monde||0)+1,u.continent&&(h[u.continent]=(h[u.continent]||0)+1))}),h},[r,n.filters,o]),[f,l]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const h=b=>{var v;(v=x.current)!=null&&v.contains(b.target)||l(!1)},u=b=>{b.key==="Escape"&&l(!1)};return document.addEventListener("mousedown",h),document.addEventListener("keydown",u),()=>{document.removeEventListener("mousedown",h),document.removeEventListener("keydown",u)}},[f]);const p=h=>{const u=Ya.find(b=>b.key===h);return h==="monde"?c.contWorld:s==="fr"?u.fr:u.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>l(h=>!h),children:[p(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:hn.map(h=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===h,onClick:()=>{i({type:"continent",key:h}),l(!1)},children:[p(h),t.jsx("span",{className:"n",children:d[h]||0})]},h))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})]}):t.jsxs("div",{className:"conts",children:[hn.map(h=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===h,onClick:()=>i({type:"continent",key:h}),children:[p(h),t.jsx("span",{className:"n",children:d[h]||0})]},h)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})})]})}function Br(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function bl(e){var i;const a=[],r=new Set,n=o=>{const s=(o||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function er({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:s}){const{t:c}=B();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:c.rsEvalOne})]},d.name))})]}):null}function _r({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=B(),i=((e==null?void 0:e.companies_cited)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.what||"").trim(),line2:(c.role||"").trim(),chips:[(c.country||"").trim()].filter(Boolean)})),o=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.why||"").trim(),chips:[(c.country||"").trim(),(c.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(er,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(er,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function vl({card:e,onEvaluate:a,onAddAll:r}){var c,d,f;const{t:n}=B(),i=[e.industry,...e.market_tags||[],e.author].map(l=>(l||"").trim()).filter(Boolean),o=(((c=e.prospective)==null?void 0:c.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(l=>l&&l.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(l=>t.jsx("span",{children:l},l))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Br(e.summary_md||"").map((l,x)=>t.jsx("p",{children:l},x))})]}),t.jsx(_r,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(l=>t.jsx("li",{children:l},l))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(l=>t.jsx("a",{href:l.url,target:"_blank",rel:"noopener noreferrer",children:l.label||l.url},l.url))})]})]})}function yl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function wl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:s}=B(),c=i,[d,f]=m.useState(null),[l,x]=m.useState(null),[p,h]=m.useState(null),[u,b]=m.useState(!1);m.useEffect(()=>{let g=!0;return(async()=>{const j=await lr({email:s,cbToken:c});g&&f(j)})(),()=>{g=!1}},[s,c,n]);const v=g=>{x(g),h(null),b(!0),(async()=>{const j=await Do(g.id);h(j),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[l?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),h(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),l&&t.jsx("span",{className:"ti",children:l.title}),!l&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!l&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(g=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(g),children:[t.jsx("span",{className:"ti",children:g.title}),t.jsxs("span",{className:"me",children:[yl(g.created_at),g.industry?` · ${g.industry}`:"",g.author?` · ${g.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(g.cited_n||0,g.evaluate_n||0)}),t.jsx("span",{className:"st"+(g.published?" on":""),children:g.published?o.rsPub:o.rsPriv})]},g.id))]}),l&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[l.source_url&&t.jsx("a",{href:l.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),l.published&&l.page_url&&t.jsx("a",{href:l.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(l.published?" on":""),children:l.published?o.rsPub:o.rsPriv})]}),u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!u&&!p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!u&&p&&t.jsx(vl,{card:p,onEvaluate:a,onAddAll:r})]})]})}const wa=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function kl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:s,evalBusy:c,evalCards:d,caps:f,data:l,canWrite:x,source:p,dossiers:h,doAnalyse:u,liveMemos:b,pipe:v}=B(),g=a==="client",j=m.useMemo(()=>r||(p!=="default"?Io():""),[r,p]),[E,y]=m.useState(""),[A,T]=m.useState(!1),[z,S]=m.useState(!1),[C,N]=m.useState(""),[R,$]=m.useState(!1),[L,M]=m.useState(""),[w,O]=m.useState([]),H=m.useRef(!1),[V,U]=m.useState(!1),[re,ee]=m.useState(""),[X,oe]=m.useState(""),[I,ae]=m.useState(!1),[fe,xe]=m.useState(0),[ge,ze]=m.useState(""),[K,W]=m.useState(null),[Q,J]=m.useState(null),[te,ye]=m.useState(!1),[de,we]=m.useState(null),[le,pe]=m.useState(0),qe=m.useRef(!1),q=E.trim()?wa.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,F=m.useMemo(()=>C.split(`
`).map(D=>D.trim()).filter(Boolean).slice(0,15),[C]);m.useEffect(()=>{if(typeof window>"u")return;const D=new URLSearchParams(window.location.search),ne=(D.get("rs")||"").trim(),ce=(D.get("rstext")||"").trim();ne&&/^https?:\/\//i.test(ne)&&ee(ne),ce&&oe(ce),(ne&&/^https?:\/\//i.test(ne)||ce)&&U(!0)},[]),m.useEffect(()=>{const D=ne=>{const ce=ne.detail||{},be=String(ce.url||"").trim(),De=String(ce.text||"").trim();be&&/^https?:\/\//i.test(be)&&ee(be),De&&oe(De),(be&&/^https?:\/\//i.test(be)||De)&&U(!0)};return window.addEventListener("ppmap:research",D),()=>window.removeEventListener("ppmap:research",D)},[]),m.useEffect(()=>{const D=ne=>{const ce=ne.detail||{},be=String(ce.name||"").trim();be&&(y(be),T(!0),window.setTimeout(()=>T(!1),1400))};return window.addEventListener("ppmap:prefill",D),()=>window.removeEventListener("ppmap:prefill",D)},[]),m.useEffect(()=>{if(!x&&!j){we(null);return}let D=!0;return(async()=>{const ne=await lr({email:n,cbToken:j});D&&we(ne.length)})(),()=>{D=!1}},[x,j,n,le]);const Y=w.length?w:d,Z=l.credits,Ne=m.useCallback(D=>{const ne=D.map(ce=>(ce||"").trim()).filter(Boolean);ne.length&&(N(ce=>{const be=ce.split(`
...
`)}),S(!0))},[]);m.useEffect(()=>{if(!I)return;xe(0);const D=window.setInterval(()=>xe(ne=>ne+1),1e3);return()=>window.clearInterval(D)},[I]);const ue=m.useMemo(()=>{const D=E.trim().toLowerCase();return!D||!v?null:h.find(ne=>Be(ne.name)===D&&Ce(ne)===1)||null},[E,h,v]),Fe=()=>{const D=E.trim();if(D){if(ue){u(ue);return}i(null,D),g&&y("")}},Ge=async()=>{if(!g){i(null,F[0]||"");return}if(!F.length||R)return;$(!0),H.current=!1;const D=[];for(let ne=0;ne<F.length&&!H.current;ne++){M(e.evaluating(ne+1,F.length,F[ne]));const ce=await cr(r,F[ne],"atelier2");if(D.unshift({name:ce.company||F[ne],verdict:ce.verdict,reason:ce.reason||"",remaining:ce.remaining??null}),O([...D]),ce.verdict==="quota"){D.unshift({name:"",verdict:"quota",reason:e.quota(F.length-ne-1),remaining:0}),O([...D]),N(F.slice(ne+1).join(`
`)),M(""),$(!1);return}}M(""),N(H.current?F.slice(D.length).join(`
`):""),$(!1)},nt=async()=>{var ce,be,De;if(qe.current)return;const D=re.trim().replace(/\s+/g,""),ne=X.trim();if(!D&&!ne){ze(e.rsNeed);return}if(!g&&!j){i(null,D||ne.slice(0,80));return}qe.current=!0,ze(""),W(null),J(null),ae(!0);try{const Te=await Bo({url:D,text:ne,email:n,cbToken:j});if(ae(!1),!Te||Te.status!=="success"){ze((Te==null?void 0:Te.message)||"Erreur");return}W(Te),U(!1),Ne((((ce=Te.prospective)==null?void 0:ce.companies_to_evaluate)||[]).map($e=>($e==null?void 0:$e.name)||"")),J({state:"pending"});const ke=await _o(Te,{email:n,cbToken:j});J(ke.ok?{state:"ok",scopeLabel:((be=ke.summary)==null?void 0:be.scope_label)||"",scope:((De=ke.summary)==null?void 0:De.scope)||""}:{state:"fail",msg:ke.error||""}),ke.ok&&pe($e=>$e+1)}finally{qe.current=!1,ae(!1)}},mt=[K==null?void 0:K.industry,...(K==null?void 0:K.market_tags)||[],K==null?void 0:K.author].map(D=>(D||"").trim()).filter(Boolean),Pe=(Q==null?void 0:Q.state)==="pending",jt=Q&&(Pe?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Q.state==="ok"?t.jsx("span",{className:"rslink ok",children:Q.scope&&Q.scope!=="public"?e.rsSavedIn(Q.scopeLabel||Q.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Q.msg,children:e.rsSaveFail})),rt=bl(K).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow"+(A?" flash":"")+(wa.test(E.trim())?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:E,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:D=>y(D.target.value),onKeyDown:D=>{D.key==="Enter"&&Fe()}}),t.jsx("span",{className:"detect"+(wa.test(E.trim())?" url":""),children:q})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(ue?" analyse":"")+(c?" loading":""),disabled:c,onClick:Fe,children:[t.jsx("span",{className:"fill"}),ue?e.actAnalyse:e.evalGo]}),f.showCredits&&Z&&t.jsxs("button",{type:"button",className:"credits"+(Z.total_available<=0&&!Z.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Z.unlimited?"∞":Z.total_available}),!Z.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Z.daily_grant+Z.purchased]}),Z.total_available<=0&&!Z.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(D=>D.status==="boot"||D.status==="running").map(D=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:D.name}),t.jsx(Tt,{item:D,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>s({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+D.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>S(!z),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(V?" on":""),onClick:()=>U(!V),children:e.rsOpen}),de!==null&&de>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(te?" on":""),onClick:()=>ye(!te),children:e.rsArchOpen(de)})]}),te&&t.jsx(wl,{bump:le,cbToken:j,onClose:()=>ye(!1),onEvaluate:D=>i(null,D),onAddAll:Ne}),V&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:re,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:D=>ee(D.target.value),onKeyDown:D=>{D.key==="Enter"&&nt()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:X,placeholder:e.rsTextPh,onChange:D=>oe(D.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(I?" loading":""),style:{justifyContent:"center"},disabled:I||Pe||!re.trim()&&!X.trim(),onClick:()=>{nt()},children:[t.jsx("span",{className:"fill"}),I?`${$o(re.trim())==="youtube"&&re.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(fe)}`:Pe?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),ge&&t.jsx("div",{className:"rserr",children:ge}),K&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:K.title}),K.source_url&&t.jsx("a",{href:K.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{W(null),J(null)},children:"×"})]}),K.market&&t.jsx("p",{className:"rsmk",children:K.market}),mt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),mt.map(D=>t.jsx("span",{children:D},D))]}),t.jsxs("div",{className:"rsbody",children:[K.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${K.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Br(K.summary_md||"").map((D,ne)=>t.jsx("p",{children:D},ne))})]}),t.jsx(_r,{card:K,onEvaluate:D=>i(null,D),onAddAll:Ne}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(rt)}),jt]})]}),z&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:C,placeholder:e.bulkPh,onChange:D=>N(D.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(R?" loading":""),style:{justifyContent:"center"},disabled:R||!F.length,onClick:()=>{Ge()},children:[t.jsx("span",{className:"fill"}),R&&L?L:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(F.length)})]})]}),Y.slice(0,1).map((D,ne)=>{const ce=D.verdict==="kept",be=D.verdict==="quota",De=ce?"var(--brand)":be?"var(--bolt)":"var(--red)",Te=ce?"var(--brand-l)":be?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":De,"--bgc":Te},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ce?"✓ "+e.kept:be?"⏳":"✗ "+e.dropped})}),D.name&&t.jsx("span",{className:"rn",children:D.name}),t.jsx("span",{className:"rr",children:D.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",D.reason]}):null}),!!(D.candidates&&D.candidates.length)&&t.jsx("span",{className:"sitepick",children:D.candidates.map(ke=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:ke.url.startsWith("http")?ke.url:`https://${ke.url}`,target:"_blank",rel:"nofollow noopener",children:[(ke.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,ke.url),children:e.evalPickGo})]},ke.url))}),!be&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ce?1:5});const ke=(D.name||"").trim().toLowerCase();window.setTimeout(()=>{const $e=[...document.querySelectorAll(".atl2 .list .row")].find(ca=>{var Dt;return(((Dt=ca.querySelector(".rnm"))==null?void 0:Dt.textContent)||"").trim().toLowerCase().includes(ke)});$e&&($e.scrollIntoView({behavior:"smooth",block:"center"}),$e.classList.add("flashrow"),window.setTimeout(()=>$e.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ce?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),g&&(o.kept+o.dropped>0||Y.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function jl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Nl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=B(),o=e.memoConsole?r.get(e.memoConsole):null,s=m.useMemo(()=>o?[o.reasoning||"",jl(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const c=at(o),d=Ha(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),c&&t.jsx("span",{className:"vv",children:c}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:s?s.split(`

`).map((f,l)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},l)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[gt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function tn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=B(),[s,c]=m.useState(!1),[d,f]=m.useState(null),l=n.pipe&&i==="client"&&!n.lockActions,x=async()=>{if(!l||s)return;c(!0);const p=await Uo(r,e);if(c(!1),!p){o(a.actErr);return}f(p.results||[])};return m.useEffect(()=>{if(!l)return;const p=h=>{var b;const u=String(((b=h.detail)==null?void 0:b.name)||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,l]),m.useEffect(()=>{if(l)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,l]),l?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{x()},children:s?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Sl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Gt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function El(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Gt(a.slice(n));break}r+=Gt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Gt(a.slice(i));break}const s=a.slice(i+1,o).trim(),c=/^(\/?)([a-zA-Z0-9]+)/.exec(s),d=c?c[2].toLowerCase():"";c&&Sl.has(d)?r+=`<${c[1]}${d}>`:r+=Gt(a.slice(i,o+1)),n=o+1}return r}const tr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Me({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Cl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function zl({o:e}){const{t:a,doDeep:r}=B(),[n,i]=m.useState(!1),o=at(e),s=[e.reasoning||"",Cl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),s.length?s.join(`

`).split(`

`).map((c,d)=>t.jsx("p",{className:"cdtxt",children:c},d)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[gt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:c=>{c.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:c=>{c.stopPropagation(),i(d=>!d)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:c=>c.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:c=>c.stopPropagation()})]})}function Ur({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=B(),o=Ft(e),s=at(e),c=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,l=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(c?1:0)+(e.reasoning?1:0)+(s?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:l},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||gt(e)?1:0}].filter(b=>b.n>0),[e,a,c,s,d,f,l]),[p,h]=m.useState("");if(!x.length)return null;const u=x.some(b=>b.k===p)?p:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":u===b.k,"data-tour":"tab-"+b.k,className:u===b.k?"on":"",onClick:v=>{v.stopPropagation(),h(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[u==="conv"&&t.jsxs(t.Fragment,{children:[c&&t.jsxs("div",{className:"cdv1"+(c==="NO MATCH"?" out":""),children:[t.jsx("b",{children:c==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Me,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Me,{k:a.cdVerdictDate,v:tr(e.verdictDate,r)})]})]}),u==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:El(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Al,{o:e})]}),u==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdSector,v:e.sector}),t.jsx(Me,{k:a.cdStage,v:e.stage}),t.jsx(Me,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Me,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Me,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Me,{k:a.cdAngle,v:e.angle}),t.jsx(Me,{k:a.cdDetected,v:tr(e.date,r)})]}),u==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdName,v:e.contactName}),t.jsx(Me,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Me,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),u==="memo"&&t.jsx(zl,{o:e}),u==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Me,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Al({o:e}){const{t:a,token:r}=B(),[n,i]=m.useState(!1),[o,s]=m.useState(null),c=async()=>{n||(i(!0),s(await Vo(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],l=f.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{c()},children:n?a.qaBusy:a.qaRun})]}),o&&l&&t.jsxs(t.Fragment,{children:[f.filter(([,x])=>x).map(([x,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:p})]},x)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!l&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Pt({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let s=!1;const c=()=>{const f=Math.max(280,Math.min(560,o.clientWidth||320));gn({kind:"op",card:e},f).then(l=>{!s&&l&&o.isConnected&&o.replaceChildren(l)})},d=window.requestAnimationFrame(c);return()=>{s=!0,window.cancelAnimationFrame(d),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let s=!1;gn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!s&&d&&o.isConnected&&o.replaceChildren(d)});const c=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("keydown",c),()=>{s=!0,document.removeEventListener("keydown",c)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Tl=`
...
`;function ql(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let c=e.y+10;return c+n>o-8&&(c=Math.max(8,e.y-n-14)),c<8&&(c=8),{left:s,top:c}}function Ll(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:s,askEvaluate:c,doAnalyse:d,doDecide:f,doPromote:l,doRepeche:x,doApproach:p,doDeep:h,doOnboard:u,outbound:b,evalBusy:v}=B(),g=e.popupId?r.get(e.popupId):null;if(!g)return null;const j=Ae(g),E=Ce(g),y=at(g),A=Ft(g),T=g.kind==="target",z=S=>{a({type:"filters",patch:S}),a({type:"popup",id:null})};return yt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Tl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:ql(e.popupAnchor,!!g.card),onClick:S=>S.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:g.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(tt(g.date)),Ye(g.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[g.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>z({country:[g.cc]}),children:(wt(g.cc,i)||g.countryLabel||"").toUpperCase()}),g.sector&&t.jsx("button",{type:"button",onClick:()=>z({sector:[g.sector]}),children:g.sector.toUpperCase()}),g.stage&&t.jsx("button",{type:"button",onClick:()=>z({stage:[g.stage]}),children:g.stage.toUpperCase()}),typeof g.amountEur=="number"&&g.amountEur>0&&t.jsx("span",{className:"am2",children:kt(g.amountEur,i)})]}),o.pipe&&T&&t.jsxs("div",{className:"pstat",children:[A&&t.jsx("span",{className:"vd "+(A==="MATCH"?"v-ok":"v-no"),title:n.vt[A],children:A}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),g.ceoStatus&&t.jsx("span",{className:"pstep own",children:g.ceoStatus})]}),(g.tagline||g.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:g.tagline||g.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[lt(g.engine)," ",t.jsx("b",{children:Ye(g.engine,i)})," — ",Ho(g.engine,i),g.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",g.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(pt,{o:g,lg:!0})," ",t.jsx(la,{o:g,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ga(j,i))," · ",n.win7(Jt(j,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),g.card?t.jsx(Pt,{spec:g.card}):null,g.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:g.reasoning})]}),o.pipe&&T&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof g.score=="number"&&g.score>0?" · "+n.score(g.score):""]})}),o.pipe&&T&&t.jsx(Ur,{o:g})]}),t.jsx(tn,{name:g.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||s!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>c(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{l(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(g,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(g,!1),a({type:"popup",id:null})},children:n.actNo}),gt(g)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{h(g),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),g.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:g.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{u(g),a({type:"popup",id:null})},children:"🚀"})]}):g.engine==="media"&&g.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var S;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.url}}))}catch{}a({type:"popup",id:null}),(S=document.querySelector(".atl2 .demand"))==null||S.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(g.name),onClick:()=>c(g),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>c(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)," →"]}),g.website&&t.jsx("a",{className:"psite",href:g.website.startsWith("http")?g.website:"https://"+g.website,target:"_blank",rel:"noopener noreferrer",title:g.website,children:"🌐"})]})]})]}),document.body)}const Ml={fr:{nlK:"Recevoir l’édition du matin",nlS:"M&A et levées, chaque jour, selon vos critères.",nlCta:"S’abonner",nlAll:"Par secteur →",tgK:"Découvrir mes cibles",tgS:"Stan part de votre site — 10 premières cibles.",tgPh:"votresite.com",tgCta:"Découvrir mes cibles"},en:{nlK:"Get the morning edition",nlS:"Daily M&A and raises, on your criteria.",nlCta:"Subscribe",nlAll:"By sector →",tgK:"Discover my targets",tgS:"Stan starts from your site — first 10 targets.",tgPh:"yoursite.com",tgCta:"Discover my targets"}};function Rl(){const{lang:e}=dr(),a=Ml[e==="en"?"en":"fr"],[r,n]=m.useState(""),[i,o]=m.useState(""),{state:s,errMsg:c,submit:d,copy:f}=Wo("general");return t.jsxs("div",{className:"ckdock",children:[t.jsxs("form",{className:"ckdock-row",noValidate:!0,onSubmit:async l=>{l.preventDefault(),await d(r,i)&&n("")},children:[t.jsxs("div",{className:"ckdock-k",children:[t.jsx("b",{children:a.nlK}),t.jsx("span",{children:a.nlS})]}),t.jsxs("div",{className:"ckdock-act",children:[t.jsx("input",{type:"email",required:!0,value:r,placeholder:f.placeholder,"aria-label":f.placeholder,onChange:l=>n(l.target.value)}),t.jsx("input",{type:"text",name:"website",value:i,tabIndex:-1,autoComplete:"off","aria-hidden":"true",className:"ckdock-hp",onChange:l=>o(l.target.value)}),t.jsx("button",{type:"submit",disabled:s==="sending",children:s==="sending"?f.sending:a.nlCta}),t.jsx("a",{href:"/actualites/operations/secteurs/",children:a.nlAll})]}),(s==="ok"||s==="err")&&t.jsx("p",{className:"ckdock-msg"+(s==="err"?" err":""),children:s==="ok"?f.ok:c})]}),t.jsxs("div",{className:"ckdock-row",children:[t.jsxs("div",{className:"ckdock-k",children:[t.jsx("b",{children:a.tgK}),t.jsx("span",{children:a.tgS})]}),t.jsx("div",{className:"ckdock-act ckdock-site",children:t.jsx(Yo,{placeholder:a.tgPh,cta:a.tgCta})})]})]})}const Ol=8;function Fl(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:s}=B(),[c,d]=m.useState(!1),[f,l]=m.useState(!1),[x,p]=m.useState(!1),h=`atl2:sincemini:${r||"home"}`,[u,b]=m.useState(()=>{try{return localStorage.getItem(h)==="1"}catch{return!1}}),v=()=>{b(S=>{try{localStorage.setItem(h,S?"0":"1")}catch{}return!S})},g=r||"home",{names:j,verdicts:E}=m.useMemo(()=>{const S=[],C={};return n.forEach(N=>{N.kind!=="target"||!N.name||(S.push(N.name),C[N.name]=Go(N)||"")}),{names:S,verdicts:C}},[n]),y=m.useMemo(()=>j.length?Ko(g,j,E,a):null,[g,j.length]);if(!i.pipe||c||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const A=f?y.added:y.added.slice(0,Ol),T=y.added.length-A.length,z=S=>{const C=n.find(N=>N.name===S);C&&(o(C.id),s({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since"+(u?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!u,title:u?e.boxExpand:e.boxCollapse,onClick:v,children:u?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),Qo(g,j,E,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[A.map(S=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>z(S),children:t.jsx("b",{children:S})},S)),T>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>l(!0),children:e.sinceMore(T)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>p(S=>!S),children:e.sinceOut(y.gone.length)}),x&&y.gone.slice(0,20).map(S=>t.jsx("span",{className:"gone",children:S},S))]})]})}const Vr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function an({o:e,locked:a=!1}){const{t:r}=B(),n=Ft(e),i=at(e),o=Ce(e),s=Na(e),c=Xo(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(Vr[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&c!==null&&t.jsx("span",{className:"wait2 "+(c>10?"hot":c>=5?"warm":""),title:r.waitTitle(c),children:r.waitChip(c)}),!a&&t.jsx(ds,{o:e})]})}const Ot=e=>e.length>22?e.slice(0,21)+"…":e;function ar({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=B(),[o,s]=m.useState(!1);if(m.useEffect(()=>{n||s(!1)},[n]),Re(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Ot(e.name))})]})}function Hr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:s,doPromote:c,doRepeche:d,doApproach:f,dispatch:l,liveMemos:x}=B();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:u=>{u.stopPropagation(),l({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(ar,{o:e})});const p=Ce(e),h=u=>b=>{b.stopPropagation(),u()};if(p===0)return t.jsx("span",{className:"cell",children:t.jsx(ar,{o:e})});if(p===1){const u=x.liveOf(e.name);if(u&&(u.status==="boot"||u.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Tt,{item:u,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:h(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(p===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:h(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:h(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})});if(p===4){const u=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:u,onClick:h(()=>f(e)),children:u?a.actApproachSent:a.actApproach})})}return p===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>c(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})}):p===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:h(()=>l({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Pl({o:e}){const{t:a,doThumb:r,thumbOf:n}=B(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Dl({o:e}){const{lang:a}=B();return Ae(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(pt,{o:e}),t.jsx(la,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[lt(e.engine||"")," ",Ye(e.engine||"",a)]})})}function Il({o:e,locked:a,open:r,onToggle:n,selected:i,onSelect:o}){const{dispatch:s,caps:c,markRow:d,markedId:f,favIds:l,toggleFav:x,t:p}=B(),h=Ce(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=b<=0?0:b<=7?1:b<=30?2:3,g=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][h]:u[v],j=l.has(e.id),E=y=>{if(a)return;if(o){o(e.id);return}if(c.pipe||e.kind==="op"){n();return}const A=y.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:A.left+Math.min(280,A.width/3),y:A.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(f===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":g}}),t.jsx(Kr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:j?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),x(e)},children:j?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:p.acqSee(e.acquirer),onClick:y=>{y.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Ot(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),t.jsx($l,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Dl,{o:e}),c.pipe&&t.jsx(an,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Hr,{o:e}),c.showThumbs&&t.jsx(Pl,{o:e})]}),r&&!a&&!o&&t.jsx(Ul,{o:e})]})}function $l({o:e}){const{lang:a,caps:r}=B();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=kt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Bl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=B(),s=(p,h=!1)=>u=>{u.stopPropagation(),h&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})},c=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),d=kt(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),l=Re(e),x=l&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[l?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{var h;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(h=document.querySelector(".atl2 .demand"))==null||h.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Ot(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Ot(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Pt,{spec:e.card})})]})}function _l({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:s,caps:c}=B(),d=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),f=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),l=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||d,x=(e==null?void 0:e.card)||(a==null?void 0:a.card),p=e?!!e.noCo:!d||sa(d),h=(e==null?void 0:e.engine)||"",u=e?kt(e.amountEur,n):"",b=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),v=(()=>{const z=/https?:\/\/(?:www\.)?([^/]+)/.exec(f);return z?z[1].replace(/^www\./,"").slice(0,40):""})(),g=(z,S=!1)=>C=>{C.stopPropagation(),S&&s({type:"continent",key:"monde"}),s({type:"filters",patch:z})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const j=()=>{d&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:d}}))},E=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},y=()=>{var z;f&&(window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f}})),(z=document.querySelector(".atl2 .demand"))==null||z.scrollIntoView({behavior:"smooth",block:"center"}))},A=e?Re(e):!1,T=A&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[h?Ye(h,n):n==="fr"?"Dossier":"File",b?` · ${b}`:"",e!=null&&e.decryptHtml?n==="fr"?" · Edito du jour":" · Today's editorial":""]}),t.jsx("h3",{className:"zoom-h",children:l}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),f&&t.jsxs("a",{className:"zoom-src",href:f,target:"_blank",rel:"nofollow noopener",onClick:z=>z.stopPropagation(),children:[r.zoomSrc,v?` · ${v}`:""," ↗"]}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:g({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:g({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:g({stage:[e.stage]}),children:e.stage}),u&&t.jsx("span",{className:"oc-amt",children:u})]}),t.jsxs("div",{className:"zoom-cta",children:[A?t.jsxs("span",{className:"verdict",style:{"--c":T?"var(--brand)":"var(--red)"},children:[T?"✓":"✗"," ",t.jsx("b",{children:T?r.kept:r.dropped})]}):!p&&d?t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:z=>{z.stopPropagation(),i(e,d)},children:r.evalGoOn(Ot(d))}):null,f&&(p||h==="media")&&t.jsx("button",{type:"button",className:"oc-ghost",onClick:z=>{z.stopPropagation(),y()},children:r.rowExtract}),!p&&(e==null?void 0:e.sector)&&!c.pipe&&t.jsx("button",{type:"button",className:"oc-ghost",onClick:z=>{z.stopPropagation(),E()},children:r.zoomSimilar}),!p&&d&&t.jsx("button",{type:"button",className:"oc-ghost",onClick:z=>{z.stopPropagation(),j()},children:r.zoomInCockpit}),!p&&d&&c.pipe&&t.jsx(tn,{name:d})]}),x&&t.jsx("div",{className:"zoom-card",children:t.jsx(Pt,{spec:x})})]})}function Ul({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:s}=B();return!i.pipe&&e.kind==="op"?t.jsx(Bl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Ur,{o:e}),t.jsx(ps,{o:e}),t.jsx(fs,{o:e}),t.jsx(tn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(an,{o:e})})]}),e.card&&t.jsx(Pt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[lt(e.engine||"")," ",Ye(e.engine||"",r)]}),Ae(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(pt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function Vl({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:s}=B();if(!i.pipe&&e.kind==="op"){const f=kt(e.amountEur,s),l=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),x=(p,h=!1)=>u=>{u.stopPropagation(),h&&n({type:"continent",key:"monde"}),n({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Pt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:x({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:x({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:x({stage:[e.stage]}),children:e.stage}),f&&t.jsx("span",{className:"damt",children:f})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[lt(e.engine||"")," ",Ye(e.engine||"",s)]}),Ae(e)&&t.jsx(pt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Hr,{o:e})})]})}const c=Ce(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][c];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":d},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(an,{o:e}),Ae(e)&&t.jsx(pt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&c===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Hl(){const{t:e}=B(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Wl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=B(),o=i==="en",s=l=>n.plabels[l]||"",c=[0,1,2,3,4,5,6,7].filter(l=>l!==a.ptab&&(e[l]||0)>0),d=c.includes(0)?0:c.sort((l,x)=>(e[x]||0)-(e[l]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${s(d)}”`:`${f} dossier${f>1?"s":""} dans « ${s(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+s(d)," →"]})]})}function Yl(){var pe,qe;const e=B(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:s,scopedAll:c,markRow:d,lang:f,sessTally:l,data:x,dossiers:p,source:h,focusExtra:u,byId:b}=e,v=q=>i.lockRowsAfter!==null?Number.MAX_SAFE_INTEGER:h==="ops"?10:ur,[g,j]=m.useState(new Set);m.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[E,y]=m.useState(null);m.useEffect(()=>{y(null)},[a.ptab,a.continent]);const A=q=>j(F=>{const Y=new Set(F);return Y.has(q)?Y.delete(q):Y.add(q),Y}),T=h==="ops"&&a.dens==="liste",[z,S]=m.useState(h==="ops"?"edito":"all"),[C,N]=m.useState(!1);m.useEffect(()=>{S("all"),N(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!C)return;const q=F=>{var Y,Z;(Z=(Y=F.target)==null?void 0:Y.closest)!=null&&Z.call(Y,".atl2 .doable")||N(!1)};return document.addEventListener("click",q),()=>document.removeEventListener("click",q)},[C]);const R=fr(),$=m.useMemo(()=>{var F;const q=new Map;for(const Y of Yi(((F=R==null?void 0:R.ed)==null?void 0:F.html)||""))q.has(Y.t)||q.set(Y.t,Y.html);return q},[(pe=R==null?void 0:R.ed)==null?void 0:pe.html]),L=m.useCallback(q=>{if(q.decryptHtml)return q.decryptHtml;if(!$.size)return;const F=(q.name||"").trim().toLowerCase();if(F.length<3)return;const Y=$.get(F);if(Y)return Y;for(const[Z,Ne]of $)if(Z.includes(F)||F.includes(Z))return Ne},[$]),M=m.useMemo(()=>{let q=Qa(s,a.sort);return z==="edito"?q=q.filter(F=>!!L(F)||F.engine==="edito"||(F.id||"").startsWith("edito:")):z==="explore"?q=q.filter(F=>!!F.noCo):z==="eval"&&(q=q.filter(F=>!F.noCo)),q},[s,a.sort,z,L]),w=m.useMemo(()=>i.pipe?c.filter(q=>Ae(q)&&Jo(q)):M.filter(q=>Ae(q)&&!Re(q)),[i.pipe,c,M]),O=w.length,[H,V]=m.useState(!1),[U,re]=m.useState(!1),ee=`atl2:sigmini:${((qe=x.session)==null?void 0:qe.token)||"home"}`,[X,oe]=m.useState(()=>{try{return localStorage.getItem(ee)==="1"}catch{return!1}}),I=m.useMemo(()=>i.pipe?M:M.filter(q=>!Re(q)&&!q.noCo),[M,i.pipe]),ae=h==="ops"?M.filter(q=>q.noCo).length:0,fe=i.pipe?n.plabels[a.ptab].toLowerCase():h==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,xe=a.filters,ge=[];if(xe.day)ge.push({k:"day",lib:n.fDay(xe.day.slice(8,10)+"/"+xe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(xe.win&&xe.win!=="all"){const q=["1","7","30"].indexOf(xe.win);q>=0&&ge.push({k:"win",lib:n.dates[q],off:()=>r({type:"filters",patch:{win:"all"}})})}const ze=q=>q.length<=2?q.join(", "):`${q.length} ${n.fSelected}`;for(const q of["sector","country","engine"]){const F=xe[q];F&&F.length&&ge.push({k:q,lib:ze(F),off:()=>r({type:"clearFacet",facet:q})})}xe.search&&ge.push({k:"search",lib:"🔍 "+xe.search,off:()=>r({type:"filters",patch:{search:""}})});const K=(q,F,Y="",Z=!1)=>t.jsxs("button",{type:"button","data-s":q,className:Y,"aria-sort":a.sort.key===q?a.sort.dir===1?"ascending":"descending":"none",style:Z?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:q}),children:[F,t.jsx("span",{className:"ar",children:a.sort.key===q&&a.sort.dir===1?"▴":"▾"})]},q),W=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const q=new Map;M.forEach(Z=>{const Ne=Z.engine||"?";q.has(Ne)||q.set(Ne,[]),q.get(Ne).push(Z)});const F={ma:0,fundraising:1,edito:2,nominations:3,recrutements:4,media:5},Y=Sa([...q.keys()],f);return[...q.entries()].sort((Z,Ne)=>{const ue=F[Z[0]]??10+Y.indexOf(Z[0]),Fe=F[Ne[0]]??10+Y.indexOf(Ne[0]);return ue-Fe})},[M,i.pipe,a.groupBy,f]),Q=(()=>{var F,Y;const q=W?W.flatMap(([,Z])=>Z):M;return((F=q.find(Z=>Z.decryptHtml))==null?void 0:F.id)??((Y=q[0])==null?void 0:Y.id)??null})();m.useEffect(()=>{T&&(a.focusId&&M.some(q=>q.id===a.focusId)||u||Q&&r({type:"focus",id:Q}))},[T,a.focusId,M,Q,u,r]),m.useEffect(()=>{if(!T||!a.focusId)return;const q=document.querySelector(".atl2.ops .row.sel");q==null||q.scrollIntoView({block:"nearest"})},[T,a.focusId]);const J=m.useMemo(()=>{if(!T||!a.focusId)return null;const q=M.find(Y=>Y.id===a.focusId)||p.find(Y=>Y.id===a.focusId)||null;if(!q)return null;const F=L(q);return F&&F!==q.decryptHtml?{...q,decryptHtml:F}:q},[T,a.focusId,M,p,L]),te=i.lockRowsAfter;let ye=0;const de=(q,F)=>{let Y=a.shown[F]||v();return q.length-Y<=4&&(Y=q.length),q.slice(0,Y).map(ue=>{const Fe=te!==null&&ye>=te;ye++;const Ge=L(ue),nt=Ge&&Ge!==ue.decryptHtml?{...ue,decryptHtml:Ge}:ue,mt=ue.engine==="ma"||ue.engine==="fundraising",Pe=!T&&a.dens!=="maxi"&&(a.dens==="deplie"||(E?E==="open":!!Ge||h==="ops"&&mt)),jt=g.has(ue.id)?!Pe:Pe;return a.dens==="maxi"?t.jsx(Vl,{o:nt,locked:Fe},ue.id):t.jsx(Il,{o:nt,locked:Fe,open:jt,onToggle:()=>A(ue.id),selected:T&&a.focusId===ue.id,onSelect:T?rt=>{r({type:"focus",id:rt});const D=b.get(rt);D&&!D.noCo&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:D.name}}))}:void 0},ue.id)})},we="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(h==="ops"?" opsl":"")+(M.length?"":" list-empty"),le=t.jsxs(t.Fragment,{children:[W?W.map(([q,F])=>t.jsxs(m.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:lt(q)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Ye(q,f)}),t.jsx("div",{className:"s",children:n.grpCount(F.filter(Y=>!Re(Y)).length,F.length)})]})]}),de(F,q)]},q)):de(M,"pt"+a.ptab),x.loading&&!p.length&&t.jsx(Hl,{}),!M.length&&!(x.loading&&!p.length)&&(i.pipe?t.jsx(Wl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(a.mapFolded?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:M.length})," ",fe]}),t.jsx("span",{className:"dot",children:"·"}),a.mapFolded&&t.jsx($r,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[a.mapFolded?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),ge.map(q=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:F=>{F.stopPropagation(),q.off()},children:[q.lib,t.jsx("i",{children:"×"})]},q.k)),h==="ops"&&M.length>0&&" — "+n.edSplit(M.length-ae,ae)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||h==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([q,F])=>t.jsxs("button",{type:"button","data-d":q,"aria-pressed":a.dens===q||q==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:q}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:F})]},q))}),!T&&(i.showFunnel||h==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":E==="open",onClick:()=>{y("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":E==="closed",onClick:()=>{y("closed"),j(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||h==="ops")&&(()=>{var Y;const q=[["all",n.doAll],...h==="ops"?[["edito",n.doEdito]]:[],["eval",n.doEval],["explore",n.doExplore]],F=((Y=q.find(([Z])=>Z===z))==null?void 0:Y[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":C,onClick:()=>N(Z=>!Z),children:[F,t.jsx("i",{children:"▾"})]}),C&&t.jsx("div",{className:"dolist",children:q.map(([Z,Ne])=>t.jsx("button",{type:"button","aria-pressed":z===Z,onClick:()=>{S(Z),N(!1)},children:Ne},Z))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:q=>r({type:"sort",key:q.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([q,F])=>t.jsx("option",{value:q,children:F},q))})]}),i.showChain&&I.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:I.map(q=>q.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(I.length):n.chainAll(I.length)]}),a.mapFolded&&t.jsx(Ir,{compact:!0})]}),t.jsx(Fl,{}),O>0&&!a.filters.signalOnly&&!U&&t.jsxs("div",{className:"sigstrip"+(X?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(O)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!X,title:X?n.boxExpand:n.boxCollapse,onClick:()=>oe(q=>{try{localStorage.setItem(ee,q?"0":"1")}catch{}return!q}),children:X?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>re(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(H?w:w.slice(0,12)).map(q=>{const F=Ae(q);return F?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(Ga(F,f),Jt(F,f)),onClick:()=>{d(q.id),r({type:"popup",id:q.id})},children:[t.jsx("b",{children:q.name}),t.jsxs("i",{children:[F.emoji," ",Ea(F,f)]}),t.jsx("em",{children:Jt(F,f)})]},"sg-"+q.id):null}),!H&&w.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>V(!0),children:n.sigStripMore(w.length-12)})]})]}),a.dens!=="maxi"&&!T&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),K("country",n.colCountry),K("name",n.colCompany),K("amount",n.colAmount,"h-amt",!0),K("stage",n.colStage,"h-stade"),K("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[K("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),K("memo",n.colMemo)]}),i.pipe&&K("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),T?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),K("country",n.colCountry),K("name",n.colCompany),K("amount",n.colAmount,"h-amt",!0),K("stage",n.colStage,"h-stade"),K("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:we,children:le})]}),t.jsx("aside",{className:"readpane","aria-label":f==="fr"?"Dossier":"File",children:t.jsx(_l,{o:J,extra:J?null:u})})]}):t.jsx("div",{className:we,children:le}),(()=>{const q=W||[["pt"+a.ptab,M]];let F=0,Y=0;for(const[Ne,ue]of q){Y+=ue.length;let Fe=a.shown[Ne]||v();ue.length-Fe<=4&&(Fe=ue.length),F+=Math.min(ue.length,Fe)}const Z=Y-F;return Z<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>q.forEach(([Ne,ue])=>r({type:"more",group:Ne,by:ue.length,base:v()})),children:[t.jsx("span",{className:"more-label",children:n.more(Z,Z)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(F,Y)})]})})(),h==="ops"&&t.jsx(Rl,{}),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(l.kept>0||l.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(l.kept,l.dropped)}})]})}function nr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Gl(e,a){const r=Zo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Kl(e,a){const n=[a.head.split("|").map(nr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Gl(i,a.plabels),Ft(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(nr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Ql(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Jl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Qe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Xl({o:e,qa:a}){const{t:r,lang:n,fund:i}=B(),o=(e.cribleStatus||"").trim().toUpperCase()||(Ft(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=at(e),c=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,c.value_prop],[r.qaProduct,c.produit],[r.qaModel,c.modele],[r.qaSummary,c.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Qe,{k:r.cdSector,v:e.sector}),t.jsx(Qe,{k:r.cdStage,v:e.stage}),t.jsx(Qe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Qe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Qe,{k:r.cdName,v:e.contactName}),t.jsx(Qe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Qe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Qe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Qe,{k:r.cdAngle,v:e.angle}),t.jsx(Qe,{k:r.cdDetected,v:Jl(e.date,n)})]}),d.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,f])=>f).map(([f,l])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:l})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Zl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:s}=B(),[c,d]=m.useState({}),f=25,l=m.useMemo(()=>n.slice(0,f),[n]);m.useEffect(()=>{l.length&&ei(r,l.map(h=>h.name)).then(d)},[r,l]);const x=o.stats,p=h=>h.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(l.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[p(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(x.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(o.marketEstimate)),", ",Math.round(x.screened/o.marketEstimate*100)," %"]})]})]}),l.map(h=>t.jsx(Xl,{o:h,qa:c[h.name]},h.id)),!l.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ec=50;function nn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=B(),[o,s]=m.useState(null),[c,d]=m.useState(!1),[f,l]=m.useState(""),[x,p]=m.useState(0),[h,u]=m.useState(""),[b,v]=m.useState(!1),g=m.useRef(null);m.useEffect(()=>()=>{g.current&&window.clearInterval(g.current)},[]);const j=async y=>{d(!0),l("");const A=await a();if(d(!1),A.ok){s(A);return}if(A.busy){l(i.alertPreviewBusy);return}if(!y){l(i.alertPreviewFail);return}p(ec),g.current=window.setInterval(()=>{p(T=>T>1?T-1:(g.current&&window.clearInterval(g.current),j(!1),0))},1e3)},E=async()=>{if(n||b)return;v(!0),u("");const y=await r();v(!1),u(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||x>0,onClick:()=>{j(!0)},children:c?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{E()},children:b?"…":i.alertTest})]}),x>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(x)}),f&&t.jsx("p",{className:"mnote warn",children:f}),h&&t.jsx("p",{className:"mnote",children:h}),!h&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ht="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Oe({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=B();return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function tc(){const{st:e}=B();switch(e.modal){case"chain":return t.jsx(nc,{});case"space":return t.jsx(rc,{});case"alert":return t.jsx(oc,{});case"queue":return t.jsx(dc,{});case"export":return t.jsx(pc,{});case"plug":return t.jsx(fc,{});case"recharge":return t.jsx(hc,{});case"cover":return t.jsx(bc,{});case"dossier":return t.jsx(gc,{});case"crit":return t.jsx(vc,{});case"tuto":return t.jsx(yc,{});case"rdv":return t.jsx(ac,{});case"memoalert":return t.jsx(uc,{});default:return null}}function ac(){const{dispatch:e,fund:a}=B(),r=typeof document<"u"&&!!document.getElementById("rdv");return m.useEffect(()=>{r&&(e({type:"modal",modal:null}),rs())},[r,e]),r?null:t.jsx(ni,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function nc(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:s,evalBusy:c,caps:d,memoQueued:f,doAnalyse:l}=B(),x=o==="client",p=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),h=e.chain.idx,u=p[h],b=h>=p.length;return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${h+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:h/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!u?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:u.name}),t.jsx("div",{className:"sub",children:[wt(u.cc,i)||u.countryLabel,u.sector,u.stage,n.daysAgo(tt(u.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ye(u.engine,i).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{children:kt(u.amountEur,i)})]}),Ae(u)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(pt,{o:u,lg:!0})," ",t.jsx(la,{o:u,src:!0})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),x&&Re(u)&&t.jsxs("div",{className:"vbox",style:{"--c":st(u)==="retenu"?"var(--brand)":st(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:st(u)==="retenu"?"✓ "+n.kept:st(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&u&&d.pipe&&Ce(u)===1&&!f.has(u.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{l(u),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&u&&!(x&&Re(u))&&(u.noCo&&u.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:c,onClick:()=>{s(u)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function rc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=B(),o=i==="client",s=m.useMemo(()=>o?r.filter(x=>Re(x)):[],[r,o]),c=m.useMemo(()=>Qa(s.filter(x=>st(x)==="retenu"),{key:"signal",dir:-1}),[s]),d=m.useMemo(()=>s.filter(x=>st(x)==="ecarte"),[s]),f=e.spaceTab==="retenu"?c:d,l=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Oe,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:c.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":l},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function oc(){const{mode:e}=B();return e==="client"||e==="apercu"?t.jsx(ic,{}):t.jsx(cc,{})}function ic(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=B(),[o,s]=m.useState("d"),c=i!=="client";return t.jsxs(Oe,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(sc,{t:e,token:a,readOnly:c,flash:r,flashErr:n}),o==="w"&&t.jsx(lc,{t:e,token:a,readOnly:c,flash:r,flashErr:n}),o==="m"&&t.jsx(Wr,{})]})}function sc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,s]=m.useState(null),[c,d]=m.useState(!1),[f,l]=m.useState(0);m.useEffect(()=>{let u=!0;return d(!1),yn(a).then(b=>{u&&(b?s(b):d(!0))}),()=>{u=!1}},[a,f]);const x=u=>{r||yn(a,u).then(b=>{if(!b){i(e.actErr);return}s(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(c)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=u=>!o.sections||o.sections.includes(u),h=u=>{const b=o.sections||e.alertSec.map(([v])=>v);x({sections:p(u)?b.filter(v=>v!==u):[...b,u]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([u,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:p(u),disabled:r,onChange:()=>h(u)}),t.jsxs("span",{children:[b,u==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},u))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(nn,{label:e.alertPreview,readOnly:r,onPreview:()=>pi(a),onTest:()=>di(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function lc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,s]=m.useState(null),[c,d]=m.useState(!1),[f,l]=m.useState(0);m.useEffect(()=>{let u=!0;return d(!1),wn(a).then(b=>{u&&(b?s(b):d(!0))}),()=>{u=!1}},[a,f]);const x=u=>{r||wn(a,u).then(b=>{if(!b){i(e.actErr);return}s(b),n(e.alertSaved)})};if(c)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=o.dow??0,h=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:u=>x({dow:Number(u.target.value)}),children:e.alertDow.map((u,b)=>t.jsx("option",{value:b,children:u},u))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,h-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[h," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,h+1)}),disabled:r,children:"＋"})]})]}),t.jsx(nn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>mi(a),onTest:()=>ui(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Wr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=B(),[s,c]=m.useState(o||""),[d,f]=m.useState(!1),[l,x]=m.useState(!1);m.useEffect(()=>{o&&c(o)},[o]);const p=e.filters,h=m.useMemo(()=>n.filter(g=>Ae(g)).length,[n]),u=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(s)||l)){x(!0);try{await fetch(`${Va}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:p.sector,countries:p.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{x(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[u]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(g=>Ye(g,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(g=>wt(g,r)||g).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([g,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:g}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},g))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!o,onChange:g=>c(g.target.value),onKeyDown:g=>{g.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,h)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function cc(){const{t:e}=B();return t.jsx(Oe,{title:e.alertTitle,icon:"🔔",children:t.jsx(Wr,{})})}function dc(){var S,C;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:s,caps:c,dispatch:d,liveMemos:f}=B(),[l,x]=m.useState(null),[p,h]=m.useState([]),[u,b]=m.useState(0),v=n==="client",g=m.useMemo(()=>{const N=new Map;return i.forEach(R=>{const $=(R.name||"").trim().toLowerCase();$&&!N.has($)&&N.set($,R)}),N},[i]);m.useEffect(()=>{let N=!0;return(async()=>{const[R,$]=await Promise.all([Wa(r),sr(a)]);N&&(R&&x(R),h($))})(),()=>{N=!1}},[a,r,u]);const j=(l==null?void 0:l.per_day)??0,E=((S=l==null?void 0:l.analyzed_today)==null?void 0:S.length)??0,y=l==null?void 0:l.offre,A=(l==null?void 0:l.pool_meta)||[],T=m.useMemo(()=>{const N=new Map;for(const R of(l==null?void 0:l.scheduled)||[])for(const $ of R.names||[])N.has($)||N.set($,{label:R.day_label,date:R.date});return N},[l==null?void 0:l.scheduled]),z=(l==null?void 0:l.in_progress)||[];return t.jsxs(Oe,{title:e.queueTitle,wide:!0,children:[y&&t.jsxs("div",{className:"qoffre"+(y.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:y.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:y.delai})]}),t.jsx("span",{className:"osp"}),y.rythme>0?t.jsx("span",{className:"or",children:e.qRate(y.rythme)}):y.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(y.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((C=l==null?void 0:l.pool_order)==null?void 0:C.length)??0))}})}),y&&t.jsxs("div",{className:"qeta",children:[y.file===0?e.qEtaDone:y.rythme<=0?e.qEtaPaused:e.qEta(y.file,y.rythme,y.jours_restants),y.en_retard&&t.jsxs("em",{children:[" ",e.qLate(y.delai,y.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(y==null?void 0:y.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(z.length>0||f.items.some(N=>N.status==="boot"||N.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(N=>N.status==="boot"||N.status==="running"||N.status==="error").map(N=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:N.name}),t.jsx("span",{className:"qd",children:N.memoType||""}),t.jsx(Tt,{item:N,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+N.name)),z.filter(N=>!f.liveOf(N.name)).map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.name}),t.jsxs("span",{className:"qd",children:[N.memo_type||"",N.age_min?` · ${Math.round(N.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:N.state||""})]},"ip-"+N.name))]})]}),p.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:p.map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.company}),t.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),t.jsx("span",{className:"qt",children:N.status}),N.url&&t.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),v&&N.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{vn(a,N.company,"retry").then(()=>b(R=>R+1))},children:e.queueRetry}),v&&N.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{vn(a,N.company,"delete").then(()=>b(R=>R+1))},children:e.queueDelete})]},N.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(A.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[A.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),A.map((N,R)=>{const $=T.get(N.name),L=g.get((N.name||"").trim().toLowerCase()),M=f.liveOf(N.name),w=!!(L&&s.has(L.id))||!!(M&&(M.status==="boot"||M.status==="running")),O=!!(L&&Ce(L)===1&&!L.memoUrl)&&!M;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),$?t.jsx("span",{className:"qwhen"+($.label==="demain"?" soon":""),children:$.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:N.name}),N.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof N.score=="number"&&t.jsx("span",{className:"qs2",children:N.score}),M&&(M.status==="boot"||M.status==="running")&&t.jsx(Tt,{item:M,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),O&&(c.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:w,onClick:()=>{o(L),b(H=>H+1)},children:w?e.actAnalyseQueued:e.actAnalyse})),N.excerpt&&t.jsx("span",{className:"qex",children:N.excerpt})]},N.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([N,R])=>t.jsxs("li",{children:[t.jsx("b",{children:N})," — ",R]},N))})]})}function pc(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:s}=B(),c=`${ht}/cibles/list.csv?token=${a}`,d=`${ht}/cibles/list.json?token=${a}`,f=`${ht}/cibles/export.xlsx?token=${a}&scope=full`,l=`=IMPORTDATA("${c}")`,x=v=>{var g;(g=navigator.clipboard)==null||g.writeText(v).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:c,href:c},{def:e.exportSheet,value:l},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:f,href:f}],h=!i.lockActions&&n.length>0,u=()=>{Ql(Kl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([g])=>g===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Oe,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:u,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:v,value:g,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(g),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function uc(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=B(),o=i!=="client",[s,c]=m.useState(null),[d,f]=m.useState(!1),[l,x]=m.useState(0),[p,h]=m.useState(!1);m.useEffect(()=>{let g=!0;return f(!1),bn(a).then(j=>{g&&(j?c(j):f(!0))}),()=>{g=!1}},[a,l]);const u=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=g=>{if(o||!s)return;const j={enabled:g.enabled??!!s.enabled,email:g.email??(s.email||""),sections:g.sections??u()};h(!0),bn(a,j).then(E=>{if(h(!1),!E){n(e.memoAlertErr);return}c(E),r(e.memoAlertSaved)})};if(d)return t.jsx(Oe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(g=>g+1),children:e.retry})]})});if(!s)return t.jsx(Oe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=u();return t.jsxs(Oe,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:o||p,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(mc,{value:s.email||"",readOnly:o||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:g=>b({email:g})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([g,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[g],disabled:o||p,onChange:()=>b({sections:{...v,[g]:!v[g]}})}),t.jsx("span",{children:j})]},g))}),t.jsx(nn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>ai(a,v),onTest:()=>ti(a,v)})]})}function mc({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,s]=m.useState(e);m.useEffect(()=>{s(e)},[e]);const c=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&c&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!c||!d,onClick:()=>i(o.trim()),children:n})]})]})}function fc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=B(),[o,s]=m.useState(null),[c,d]=m.useState(!1),[f,l]=m.useState(null),[x,p]=m.useState(""),[h,u]=m.useState(0);m.useEffect(()=>{let E=!0;return d(!1),Ca(a).then(y=>{E&&(y?s({configured:y.configured,url_hint:y.url_hint}):d(!0))}),ii(a).then(y=>{E&&l(y)}),()=>{E=!1}},[a,h]);const b=(E,y)=>{i&&Ca(a,E).then(A=>{if(!A||A.ok===!1){n(e.actErr);return}E.test&&A.sent===!1?n(e.plugTestThrottled):r(y),u(T=>T+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',g=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${ht}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Oe,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),c?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>u(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!i,onChange:E=>p(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:g}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(g).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(xc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function xc(){const{t:e,token:a,lang:r}=B(),[n,i]=m.useState("valides"),[o,s]=m.useState(!1),[c,d]=m.useState(null),[f,l]=m.useState(null),[x,p]=m.useState(!1),[h,u]=m.useState(!1),[b,v]=m.useState(null),[g,j]=m.useState(null),[E,y]=m.useState(null),A=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Ca(a).then($=>{j($&&$.configured?$.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{d(null),l(null),p(!1),v(null);try{const $=JSON.parse(localStorage.getItem(A)||"null");y($&&Date.now()-Date.parse($.t)<24*3600*1e3?$:null)}catch{y(null)}},[A]);const T=async()=>{s(!0),p(!1),v(null);const $=await li(a,n);d($),l($.ok?n:null),s(!1)},z=m.useRef(!1),S=async()=>{if(z.current)return;z.current=!0,u(!0);const $=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await ci(a,n,"webhook",void 0,$)}finally{z.current=!1}if(u(!1),p(!1),v(L),L.ok&&(L.pushed||0)>0){const M={t:new Date().toISOString(),n:L.pushed||0};y(M);try{localStorage.setItem(A,JSON.stringify(M))}catch{}}},C=c!=null&&c.ok&&c.ready||0,N=!!(c!=null&&c.ok)&&f===n&&C>0&&!!g&&!E,R=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:$=>i($.target.value),children:e.plugBulkTabs.map(([$,L])=>t.jsx("option",{value:$,children:L},$))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),c&&(c.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(c.ready||0,c.linkedinReady||0,(c.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(c!=null&&c.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(R,E.n)}),!E&&!!(c!=null&&c.ok)&&!g&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!c&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),N&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),N&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(C,g||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{S()},children:h?e.bulkSending:e.bulkConfirm(g||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>p(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function hc(){const{t:e,data:a,lang:r}=B(),n=a.credits,i=a.email,o=async s=>{if(!i)return;const c=window.location.href.split("?")[0];try{const f=await(await fetch(`${Va}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:s,success_url:c+"?credits=ok",cancel_url:c+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(Oe,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function gc(){const{t:e}=B();return t.jsx(Oe,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Zl,{})})}function bc(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:s,flash:c}=B(),[d,f]=m.useState(null),[l,x]=m.useState(!1);m.useEffect(()=>{let C=!0;if(o)return Wa(o).then(N=>{C&&N&&typeof N.per_day=="number"&&f(N.per_day)}),()=>{C=!1}},[o]);const[p,h]=m.useState(null);m.useEffect(()=>{if(!i)return;let C=!0;return oi(i).then(N=>{C&&h(N)}),()=>{C=!1}},[i]);const u=r.stats,b=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(C=>C.kind==="target"&&Re(C)).length,v=r.marketEstimate||0,g=v>0?Math.min(100,Math.round(b/v*100)):null,j=(u==null?void 0:u.window_days)||30,E=b>0?b/j:0,y=v>0?Math.max(0,v-b):0,T=v>0&&E>0&&b>=100?Math.round(y/E):null,z=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),S=C=>{l||!s||(x(!0),si(i,C).then(N=>{if(x(!1),N===null){c(e.actErr);return}f(N),c(e.alertSaved)}))};return t.jsxs(Oe,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(z(b))}),v>0&&t.jsx("span",{children:e.covOf(z(v))})]}),g!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:g+"%"}}),t.jsxs("em",{children:[g," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(z(E))}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((C,N)=>t.jsxs("tr",{className:C.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[C.code,C.geo?` · ${C.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof C.n=="number"?z(C.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:C.source}),C.elargi&&t.jsx("em",{children:e.covWide(String(C.demande||""))}),C.erreur&&t.jsx("em",{children:e.covMissing})]})]},N)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:z(p.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&u.shown!==u.kept&&t.jsxs("span",{children:[t.jsx("b",{children:z(u.shown)})," ",e.funShown]})]}),s&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:d===C?"on":"",disabled:l,onClick:()=>S(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function vc(){var g,j,E;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:s,lang:c}=B(),d=n==="client",f=m.useMemo(()=>{const y=new Set;return a.forEach(A=>{A.angle&&y.add(A.angle)}),[...y]},[a]),[l,x]=m.useState(""),[p,h]=m.useState(""),[u,b]=m.useState(!1),v=async()=>{const y=l.trim();if(!(!y||u||!d)){b(!0),h("");try{const T=await(await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&h(String(T.reply)),T.job_id){h(e.critChatRunning);const z=async()=>{const S=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(C=>C.json()).catch(()=>null);if(S&&S.done){h(String(S.reply||S.clarification||S.summary||"✓")),b(!1),S.applied&&i(e.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),x("");return}x("")}finally{p.startsWith("⏳")||b(!1)}}};return t.jsxs(Oe,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((g=o.points)!=null&&g.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=o==null?void 0:o.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var A,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((A=y.look)!=null&&A.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(z=>t.jsx("li",{children:z},z))})]}),!!((T=y.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(z=>t.jsx("li",{children:z},z))})]})]})]},y.title)})]}),!!((E=o==null?void 0:o.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:l,disabled:!d||u,onChange:y=>x(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},disabled:!d||u||!l.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ri,{fund:s,lang:c,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Vr[y]||"v-cons"),children:y}),t.jsx("span",{children:A})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",A]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function yc(){const{t:e,dispatch:a,startTour:r}=B(),n=i=>{var o,s;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(Oe,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+s))})]})}const Yr="atl2:mapfold",wc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Yr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},kc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},Gr=m.createContext(null),B=()=>{const e=m.useContext(Gr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function pt({o:e,lg:a}){const{lang:r}=B(),n=Ae(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ea(n,r),children:[n.emoji," ",Ea(n,r)]}):null}function la({o:e,src:a}){const{lang:r,t:n}=B(),i=Ae(e);if(!i)return null;const o=gi(i),s=bi(i);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(Ga(i,r))+" · "+n.win7(Jt(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(c,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:c=>c.stopPropagation(),children:"↗"})]})}function jc(e,a,r){const n=(r||"").trim();if(n){const o=e.find(s=>(s.url||"")===n);if(o)return o}const i=Be(a);if(i)return e.find(o=>Be(o.name)===i)||e.find(o=>{const s=Be(o.name);return s.length>=3&&(i.includes(s)||s.includes(i))})}function Nc(){const{scoped:e,t:a,st:r,dispatch:n}=B(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,s=e.length,c=e.filter(f=>!f.noCo).length,d=e.filter(f=>!!f.decryptHtml).length;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:a.zoomPulseBtn,onClick:()=>{o?n({type:"filters",patch:{day:"",win:"all"}}):i.current&&n({type:"filters",patch:{day:i.current,win:"all"}})},children:[t.jsx("em",{children:a.zoomPulseBtn}),t.jsx("b",{children:s}),t.jsx("span",{children:a.zoomPulseEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",s-c," ",a.zoomPulseExplore]}),t.jsxs("li",{children:["📖 ",d," ",a.zoomPulseArts]})]})]})}function Kr({o:e}){const{lang:a}=B(),r=hi(e.cc),n=e.cc?wt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const rr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Sc=!1;function Ec(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Qr=e=>`atl2:tour:${e||"anon"}`;function Cc(e){try{return localStorage.getItem(Qr(e))==="1"}catch{return!0}}function or(e){try{localStorage.setItem(Qr(e),"1")}catch{}}function zc(e,a,r,n,i){const o=e.tourT,s=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:s[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:s[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:s[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:s[0][0],modal:"crit"}].filter(Boolean)}function Mc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var on;const{lang:s}=dr(),c=qi[s],d=_i(e,s,a),[f,l]=m.useReducer(Hi,void 0,()=>Ui((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?kc():wc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??(a==="ops"?"liste":void 0),filters:r,modal:n==null?void 0:n.modal})),x=m.useRef(!0);m.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Yr,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]);const p=m.useRef(o);p.current=o,m.useEffect(()=>{var k;(k=p.current)==null||k.call(p,f.filters)},[f.filters]);const[h,u]=m.useState(null),[b,v]=m.useState(null),[g,j]=m.useState(null),[E,y]=m.useState({kept:0,dropped:0}),[A,T]=m.useState(!1),[z,S]=m.useState(""),[C,N]=m.useState(!1),[R,$]=m.useState(null),[L,M]=m.useState(!1),[w,O]=m.useState(!1),[,H]=m.useState(0),V=()=>H(k=>k+1),U=m.useRef([]),re=m.useRef(new Set),ee=m.useRef(new Set),[X,oe]=m.useState([]),[I,ae]=m.useState([]),[fe,xe]=m.useState(0),ge=m.useRef(new Map),ze=m.useRef(null),{mode:K}=d,W=m.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),Q=W.pipe,J=d.session.token||"",te=K==="client"&&!e;m.useEffect(()=>{if(!J||!Q)return;let k=!0;const _=async()=>{const se=await vi(J);!k||!se||(ae(se.runs),xe(Date.now()/1e3-se.now),oe(je=>je.filter(We=>!se.runs.some(Ke=>Be(Ke.company)===Be(We.name)))))};_();const P=X.length>0||I.some(se=>se.status==="running"),G=window.setInterval(()=>{_()},P?8e3:25e3);return()=>{k=!1,window.clearInterval(G)}},[J,Q,X.length,I.some(k=>k.status==="running")]);const ye=m.useMemo(()=>{const k=[],_=new Set;for(const P of X){const G=Be(P.name);!G||_.has(G)||(_.add(G),k.push({name:P.name,id:P.id,status:"boot",started:P.started,estMin:P.estMin,memoType:"instant"}))}for(const P of I){const G=Be(P.company);if(!G||_.has(G))continue;_.add(G);const se=P.status==="error"?"error":P.status==="done"?"done":"running";k.push({name:P.company,status:se,started:P.started||0,estMin:P.est_min||(P.memo_type==="detailed"?40:15),url:P.url,error:P.error,memoType:P.memo_type})}return k},[X,I]),de=k=>ye.find(_=>Be(_.name)===Be(k))||null,we=(k,_)=>{oe(P=>P.some(G=>Be(G.name)===Be(k.name))?P:[...P,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:_==="detailed"?40:15}]),re.current.add(k.id),V()};m.useEffect(()=>{if(document.querySelector(`link[href="${rr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=rr,document.head.appendChild(k)},[]);const le=(k,_=!1)=>{S(k),N(_),ze.current&&clearTimeout(ze.current),ze.current=setTimeout(()=>S(""),_?4200:2400)},pe=k=>le(k,!0),qe=m.useMemo(()=>{const k=new Map;return d.dossiers.forEach(_=>{_.id&&k.set(_.id,_)}),k},[d.dossiers]),q=m.useMemo(()=>d.dossiers.filter(k=>mr(k,f,Q)),[d.dossiers,f,Q]),F=m.useRef(!1);m.useEffect(()=>{if(F.current||e||d.loading||!d.dossiers.length)return;if(!W.showFunnel||Cc(d.session.token||"")){F.current=!0;return}F.current=!0;const k=window.setTimeout(()=>{or(d.session.token||""),M(!0)},700);return()=>window.clearTimeout(k)},[e,d.loading,d.dossiers.length,W.showFunnel,d.session.token]);const Y=m.useMemo(()=>d.dossiers.filter(k=>Wi(k,f,Q,d.favIds)),[d.dossiers,f,Q,d.favIds]),Z=m.useMemo(()=>fi(q,d.favIds),[q,d.favIds]),Ne=m.useMemo(()=>{const k=vr(d.dossiers);return k?tt(k)===0?c.tourToday:yr(k,s):c.tourNoRun},[d.dossiers,c,s]),ue=m.useMemo(()=>d.dossiers.some(k=>!!k.memoUrl||!!k.summary||gt(k)),[d.dossiers]),[Fe,Ge]=m.useState(!1);m.useEffect(()=>{if(d.loading){Ge(!1);return}if(d.dossiers.length>0||d.error){Ge(!0);return}const k=window.setTimeout(()=>Ge(!0),6e3);return()=>window.clearTimeout(k)},[d.loading,d.dossiers.length,d.error]);const nt=(d.marketEstimate||0)>0||typeof((on=d.stats)==null?void 0:on.screened)=="number"&&d.stats.screened>0,mt=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(Z[k]||0)>0)??0,[Z]),Pe=Ya.find(k=>k.key===f.continent),jt=f.continent==="monde"?c.contWorld:(s==="fr"?Pe==null?void 0:Pe.fr:Pe==null?void 0:Pe.en)||"";m.useEffect(()=>{const k=_=>{var G;const P=(((G=_.detail)==null?void 0:G.name)||"").trim();P&&rt(null,P)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{if(a!=="ops")return;const k=_=>{const P=_.detail||{},G=String(P.id||"").trim(),se=String(P.name||"").trim(),je=String(P.url||"").trim(),We=G&&qe.get(G)||jc(d.dossiers,se,je);if(We){v(null),l({type:"focus",id:We.id}),We.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:We.name}}));return}!se&&!je||(l({type:"focus",id:null}),v({name:se,headline:String(P.text||"").trim()||se,url:je,card:P.card}),se&&!sa(se)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:se,url:je}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=G=>{const se={},je=String((G==null?void 0:G.sector)||"").trim();je&&(se.sector=[je]);const We=String((G==null?void 0:G.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(We)&&(se.day=We);const Ke=String((G==null?void 0:G.search)||"").trim();Ke&&(se.search=Ke);const he=String((G==null?void 0:G.dealKind)||"").trim();(he==="ma"||he==="levee"||he==="other")&&(se.dealKind=[he]),Object.keys(se).length&&l({type:"filters",patch:se})},_=G=>k(G.detail),P=G=>{G.data&&G.data.type==="pp-filter"&&k(G.data)};return window.addEventListener("ppmap:filter",_),window.addEventListener("message",P),()=>{window.removeEventListener("ppmap:filter",_),window.removeEventListener("message",P)}},[]),m.useEffect(()=>{const k=_=>{var se;const P=(((se=_.detail)==null?void 0:se.name)||"").trim().toLowerCase();if(!P)return;const G=d.dossiers.find(je=>(je.name||"").trim().toLowerCase()===P);G&&l(a==="ops"?{type:"focus",id:G.id}:{type:"popup",id:G.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const rt=(k,_)=>{const P=((k==null?void 0:k.name)||_||"").trim();if(!te){j({kicker:P});return}!P||A||(T(!0),(async()=>{try{let G=P;const se=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(se)G=se;else try{const he=await yi(P);if(he!=null&&he.website)G=he.website;else if(((he==null?void 0:he.candidates)||[]).length===1)G=he.candidates[0].url;else if(((he==null?void 0:he.candidates)||[]).length>1){U.current=[{name:P,verdict:"unresolved",remaining:null,reason:c.evalPickSite,candidates:(he.candidates||[]).slice(0,5)},...U.current].slice(0,8),V();return}}catch{}const je=await cr(J,G,"atelier2"),We={name:je.company||P,verdict:je.verdict,reason:je.reason||"",remaining:je.remaining??null};U.current=[We,...U.current].slice(0,8),je.verdict==="kept"&&y(he=>({...he,kept:he.kept+1})),je.verdict==="ruled_out"&&y(he=>({...he,dropped:he.dropped+1}));const Ke=k||d.dossiers.find(he=>(he.name||"").toLowerCase()===P.toLowerCase());Ke&&(je.verdict==="kept"?Ke.verdict=Ke.verdict||"MATCH":je.verdict==="ruled_out"&&(Ke.verdict="NO MATCH"),je.reason&&(Ke.reasoning=je.reason)),V()}finally{T(!1)}})())},D=k=>{if(!te){j({kicker:k.name});return}we(k,"instant"),Nt(J,"fast_request",k.name||"",""),le(c.memoInstantSent(k.name))},ne=k=>ge.current.get(k.id)??d.thumbs.get((k.name||"").trim().toLowerCase()),ce=(k,_)=>l({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:_}}),be=async(k,_,P)=>{const G=k.ceoStatus||"";k.ceoStatus=_,V();const se=await pa(J,{status:_,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(P==null?void 0:P.note)!==void 0?{note:P.note}:{},...P!=null&&P.via?{via:P.via}:{}});return se.ok?se.skipped?(k.ceoStatus=G,V(),pe(c.actNotPersisted),!1):((P==null?void 0:P.undo)!==!1&&ce(k,G),P!=null&&P.msg&&le(P.msg),(_==="Validé"||_==="Écarté")&&!k.ceoNote&&(P==null?void 0:P.note)===void 0&&$({o:k,yes:_==="Validé"}),!0):(k.ceoStatus=G,V(),pe(c.actErr),!1)},De=async(k,_)=>{const P=await pa(J,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:_,via:"note"});return!P.ok||P.skipped?(pe(P.skipped?c.actNotPersisted:c.actErr),!1):(k.ceoNote=_,V(),!0)},Te=m.useRef(new Map),ke=k=>Te.current.has(k.id)?Te.current.get(k.id):d.stages.get((k.name||"").trim().toLowerCase()),$e=(k,_)=>{Te.current.set(k.id,_),V()},ca=(k,_)=>{te&&be(k,_?"Validé":"Écarté",{msg:_?c.decidedYes(k.name):c.decidedNo(k.name)})},Dt=k=>{te&&be(k,"À trancher",{msg:c.promoted(k.name)})},Jr=k=>{te&&(async()=>{const _=k.ceoStatus||"";k.ceoStatus="Retenu",V();const P=await pa(J,{status:"Retenu",check_id:k.checkId,company:k.name});if(!P.ok||P.skipped){k.ceoStatus=_,V(),pe(P.skipped?c.actNotPersisted:c.actErr);return}ce(k,_),le(c.repeched(k.name))})()},Xr=()=>{const k=f.undo[f.undo.length-1];if(!k){le(c.undoNone);return}const _=qe.get(k.id);if(!_){l({type:"undoPop"}),le(c.undoNone);return}let P=k.prevCeoStatus;if(!P)if((_.verdict||"").toUpperCase().includes("CALL"))P="À trancher";else{le(c.undoLockedTitle);return}(async()=>await be(_,P,{undo:!1})&&(l({type:"undoPop"}),_.ceoStatus=k.prevCeoStatus,V(),le(c.undoDone(_.name))))()},Zr=k=>{te&&(ee.current.add(k.id),V(),(async()=>{const _=await wi(J,k.name,"email");if(!_||_.ok===!1){ee.current.delete(k.id),V(),pe(c.actErr);return}Nt(J,"approach",k.name||"",""),le(c.actApproachSent)})())},eo=(k,_)=>{te&&(async()=>{if(!(await Nt(J,_?"yes":"no",k.name||"","")).ok){pe(c.actErr);return}ge.current.set(k.id,_?"yes":"no"),V(),le(_?c.thumbUpDone:c.thumbDnDone)})()},to=k=>{!te||!gt(k)||(we(k,"detailed"),Nt(J,"detailed_request",k.name||"",""),le(c.memoDeepSent(k.name)))},ao=k=>{const _=new Set(d.favIds),P=_.has(k.id);P?_.delete(k.id):_.add(k.id),d.setFavIds(_),te&&ki(J,{id:k.id,co:k.name},P)},no=()=>{!te||w||window.confirm(c.identSyncConfirm)&&(O(!0),(async()=>{const k=await ji(J);O(!1),k?le(c.identSyncDone):pe(c.actErr)})())},rn=/proplace/i.test(d.fund||""),ro=k=>{!te||!rn||(Nt(J,"onboard_request",k.name||"",""),le(c.onboardSent(k.name)))},oo={st:f,dispatch:l,t:c,lang:s,mode:K,caps:W,pipe:Q,token:J,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:Jr,thumbOf:ne,canWrite:te,commitStatus:be,saveNote:De,stageOf:ke,setStage:$e,flashErr:pe,startTour:()=>M(!0),dossiers:d.dossiers,scopedAll:q,scoped:Y,counts:Z,byId:qe,contName:jt,favIds:d.favIds,toggleFav:ao,askEvaluate:rt,doAnalyse:D,doDecide:ca,doPromote:Dt,doApproach:Zr,doThumb:eo,doDeep:to,doUndo:Xr,doSync:no,doOnboard:ro,outbound:rn,memoQueued:re.current,liveMemos:{items:ye,serverOff:fe,liveOf:de},approachDone:ee.current,sessTally:E,evalCards:U.current,evalBusy:A,markRow:u,markedId:h,flash:le,focusExtra:b};m.useEffect(()=>{const k=_=>{_.key==="Escape"&&(l({type:"popup",id:null}),l({type:"modal",modal:null}),l({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const io=k=>J?t.jsx(Gi,{token:J,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(Gr.Provider,{value:oo,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":""),children:[t.jsx("style",{children:Ri}),W.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:c.lockbarText}),t.jsxs("span",{className:"lb-c",children:[c.lockbarContactBefore,t.jsx("a",{href:gr,children:Xa}),c.lockbarContactMid,t.jsx("a",{href:`mailto:${Xt}`,children:Xt})]}),t.jsx("button",{type:"button",onClick:()=>l({type:"modal",modal:"rdv"}),children:c.lockbarCta})]}),io(t.jsxs("div",{className:"app"+(Q?" pipe":"")+(J?" has-thesis":""),children:[W.showTicker&&t.jsx(Le,{name:"live",children:t.jsxs("div",{className:"live-stack"+(J?" live-stack--cibles":""),children:[t.jsx(es,{}),!!J&&t.jsx(Ki,{})]})}),W.showIdent&&t.jsx(Le,{name:"identite",children:t.jsx(gs,{})}),!1,!!J&&t.jsx(Le,{name:"brief",children:t.jsx(Qi,{})}),Sc,W.showMorning&&t.jsx(Le,{name:"matin",children:t.jsx(hs,{})}),t.jsx(Le,{name:"mesure",children:t.jsx(ls,{})}),W.showFunnel&&t.jsx(Le,{name:"entonnoir",children:t.jsx(Ac,{})}),W.showFunnel&&t.jsx(Le,{name:"tunnel",children:t.jsx(bs,{})}),W.showFunnel&&t.jsx(Le,{name:"tuto",children:t.jsx(vs,{})}),!f.mapFolded&&t.jsx(Le,{name:"carte",fallback:t.jsx("div",{className:"void",children:c.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx($r,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Nc,{}),t.jsx(hl,{}),t.jsx(Ir,{})]})]})}),W.showDemand&&Q&&t.jsx(Le,{name:"direct",children:t.jsx(zi,{items:ye,serverOff:fe,labels:{strip:c.liveStrip,boot:c.liveBoot,end:c.liveEnd,open:c.liveOpenQueue,memo:c.actMemo},onOpen:()=>l({type:"modal",modal:"queue"})})}),W.showDemand&&t.jsx(Le,{name:"evaluation",children:t.jsx(kl,{})}),W.showDemand&&f.memoConsole&&t.jsx(Le,{name:"console",children:t.jsx(Nl,{})}),t.jsx(Le,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[c.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:c.retry})]}),children:t.jsx(Yl,{})}),d.loading&&t.jsx("div",{className:"void",children:c.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[c.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:c.retry})]})]})),f.popupId&&a!=="ops"&&t.jsx(Le,{name:"fiche",children:t.jsx(Ll,{})}),t.jsx(Le,{name:"modales",children:t.jsx(tc,{})}),t.jsx(is,{}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(ms,{placeholder:R.yes?c.whyYesPh:c.whyNoPh,onDone:k=>{const _=R.o;$(null),k&&De(_,k).then(P=>{P&&le(c.csNoteSaved)})}})]}),L&&Fe&&t.jsx(xs,{steps:zc(c,Ne,ue,mt,nt),onClose:()=>{M(!1),or(J)}}),t.jsx(Ec,{}),z&&t.jsx("div",{className:"flash on"+(C?" err":""),children:z}),g&&t.jsx(xi,{variant:"acquirer",initialCompany:ir().co,initialWebsite:ir().site,onClose:()=>j(null)})]})})}function Ac(){const{t:e}=B(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function ir(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Tc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Kr as FlagCell,pt as SigBadge,la as SigWin,Mc as default,Tc as fmtShort,B as useV2};
