...
`,Za=Ja+Xa;function er(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function tr(t,a){return t||a.mode!=="client"||!a.token?"visiteur":er("teaser")==="1"?"apercu":"client"}const ar={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},rr=t=>ar[t],fe=t=>Object.assign(t,{continent:xa(t.cc)});function Ue(t){const a=new Set,n=[];for(const r of t){const i=(r.name||"").toLowerCase();!i||a.has(i)||(a.add(i),n.push(r))}return n}const nr=60*60*1e3;function or(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>nr?null:a}catch{return null}}function Fe(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ir=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function lr(t,a,n="default"){const r=n!=="default",i=p.useMemo(()=>t||r?{mode:"anon"}:sa(),[t,r]),o=p.useMemo(()=>r?"visiteur":tr(t,i),[t,i,r]),l=p.useMemo(()=>rr(o),[o]),f=o!=="visiteur",d=ir(n),[u,h]=p.useState([]),[s,v]=p.useState(""),[b,m]=p.useState(null),[g,x]=p.useState(null),[c,y]=p.useState(null),[k,w]=p.useState(()=>new Map),[S,C]=p.useState(()=>new Map),[F,N]=p.useState(""),[E,P]=p.useState(new Set),[O,M]=p.useState(null),[D,T]=p.useState(!0),[B,R]=p.useState(!1),[H,oe]=p.useState(0),[de,Ae]=p.useState(0),xe=p.useRef(0),ce=p.useMemo(()=>{var V;if(o!=="client")return"";try{return((V=da())==null?void 0:V.email)||""}catch{return""}},[o]);p.useEffect(()=>{const V=++xe.current;let U=!0;const q=()=>U&&V===xe.current,I=(f&&i.token?i.token:"pub:"+a)+(d?":"+d:""),_=or(I);return _?(h(_.objs.map(fe)),_.fund&&v(_.fund),m(_.marketEstimate??null),x(_.criteria??null),y(_.stats??null),N(_.generatedAt||""),T(!1)):T(!0),(async()=>{try{if(n==="ops"){const re=await Ie(),te=((re==null?void 0:re.recent_ops)||[]).map(Q=>$e(Q,a)).filter(Q=>!!Q);if(!q())return;h(te.map(fe)),Fe(I,{objs:te})}else if(typeof n=="object"){const te=(await nt()||[]).filter(J=>(J.slug||"")===n.research).map(J=>ot(J,a)).filter(J=>!!J),Q=Ue(await it(te,a));if(!q())return;h(Q.map(fe)),Fe(I,{objs:Q})}else if(f&&i.token){const re=ca(i.token),te=Ie(),Q=pa(i.token),J=ua(i.token),je=fa(i.token),$=await re;let ie=$?$.targets:[];q()&&$&&(v($.fund||""),m($.marketEstimate??null),x($.criteria??null),y($.stats??null),N($.generatedAt||""),h(ie.map(fe)),T(!1),R(!1));const[pe,Ne,ge,ae]=await Promise.all([te,Q,J,je]),he=((pe==null?void 0:pe.recent_ops)||[]).map(ne=>$e(ne,a)).filter(ne=>!!ne);if(ie=[...ie,...he],!q())return;h(ie.map(fe));const Se=new Set;for(const ne of Ne){const be=(ne.id||ne.co||"").toString().trim().toLowerCase();be&&Se.add(be.startsWith("t:")?be:"t:"+be)}P(Se),w(ge),C(ae),$&&Fe(I,{fund:$.fund,marketEstimate:$.marketEstimate,criteria:$.criteria,stats:$.stats,generatedAt:$.generatedAt,objs:ie})}else{const re=ma(),te=nt(),Q=Ie(),J=await re;q()&&J.length&&(h(Ue(J).map(fe)),T(!1),R(!1));const[je,$]=await Promise.all([te,Q]),ie=(je||[]).map(ae=>ot(ae,a)).filter(ae=>!!ae),pe=await it(ie,a),Ne=(($==null?void 0:$.recent_ops)||[]).map(ae=>$e(ae,a)).filter(ae=>!!ae),ge=Ue([...J,...pe,...Ne]);if(!q())return;h(ge.map(fe)),Fe(I,{objs:ge})}q()&&R(!1)}catch{q()&&!_&&R(!0)}finally{q()&&T(!1)}})(),()=>{U=!1}},[f,i.token,a,H,d]),p.useEffect(()=>{if(!l.showCredits||!ce){M(null);return}let V=!0;return(async()=>{try{const U=await fetch(`${Ye}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ce})});if(!U.ok)return;const q=await U.json();V&&q&&q.ok!==!1&&M(q)}catch{}})(),()=>{V=!1}},[l.showCredits,ce,de]);const Y=p.useCallback(V=>P(new Set(V)),[]);return{session:i,mode:o,caps:l,fund:s,email:ce,marketEstimate:b,generatedAt:F,criteria:g,stats:c,thumbs:k,stages:S,dossiers:u,favIds:E,setFavIds:Y,credits:O,reloadCredits:()=>Ae(V=>V+1),loading:D,error:B,refresh:()=>oe(V=>V+1)}}const Mt=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),sr=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Mt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function dr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(i=>i!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Mt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||qe)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const qe=60;function Je(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!K(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(We(t)))return!1;if(r!=="win"&&a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ye(t.date)>i)return!1}if(r!=="status"&&!n&&a.status!=="all"&&se(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(i))return!1}return!0}function qt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:Je(t,a.filters,n)}function cr(t,a,n,r){return!(!qt(t,a,n)||n&&!ga(t,a.ptab,r))}function Xe(t,a){const n=a.key,r=i=>{switch(n){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ye(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=K(i);return o?100-(o.left??0):-1}}};return[...t].sort((i,o)=>{const l=r(i),f=r(o);return l<f?-a.dir:l>f?a.dir:(i.name||"").localeCompare(o.name||"")})}function pr(){const{dossiers:t,st:a,t:n,dispatch:r,contName:i,pipe:o}=z(),l=p.useMemo(()=>{const d=s=>o?!0:s.continent===a.continent,u=t.filter(s=>d(s)&&K(s)),h=t.filter(s=>d(s)&&s.kind==="op"&&!K(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&ye(s.date)<=2);return h.sort((s,v)=>(v.amountEur||0)-(s.amountEur||0)),[...Xe(u,{key:"signal",dir:-1}),...h].slice(0,40)},[t,a.continent,o]),f=d=>l.map(u=>e.jsxs("button",{type:"button",className:"tk"+(X(u)?" spent":""),onClick:h=>{const s=h.currentTarget.getBoundingClientRect();r({type:"popup",id:u.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:u.name+(u.tagline?" — "+u.tagline:""),children:[e.jsx(ke,{o:u}),e.jsxs("span",{className:"who",children:[e.jsx(Vt,{o:u}),e.jsx("span",{className:"co",children:u.name})]}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am",children:zn(u.amountEur)}),u.sector&&e.jsx("span",{className:"mt",children:u.sector}),e.jsx(Be,{o:u}),e.jsx("span",{className:"tkgo",children:"→"})]},d+(u.id||u.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:l.length})]}),e.jsx("div",{className:"win",children:l.length?e.jsxs("div",{className:"run",children:[f(0),f(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(i)})})})]})}const ur="aDx8z7Hzksus",Dt="+33 6 83 10 72 86",gt="alexandre@proplace.co",fr=`tel:${Dt.replace(/[^\d+]/g,"")}`,ht="pp-rdv-slot";function mr(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function xr(){const{t,caps:a,fund:n}=z(),r=a.showOnb,i=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:hr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:fr,children:Dt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${gt}`,children:gt})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(i).map(([o,l],f)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(f+1)}),e.jsx("b",{children:o}),e.jsx("span",{children:l})]},o))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(Wa,{filloutId:ur,parameters:n?{company_name:n}:void 0})})]})}function gr(){const[t,a]=p.useState(()=>typeof document>"u"?null:document.getElementById(ht));return p.useEffect(()=>{t||a(document.getElementById(ht))},[t]),t?Te.createPortal(e.jsx(xr,{}),t):null}const hr=`
...
`;class G extends p.Component{constructor(){super(...arguments);at(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const br=8;function vr(){const{t,lang:a,token:n,dossiers:r,caps:i,markRow:o,dispatch:l}=z(),[f,d]=p.useState(!1),[u,h]=p.useState(!1),[s,v]=p.useState(!1),b=n||"home",{names:m,verdicts:g}=p.useMemo(()=>{const w=[],S={};return r.forEach(C=>{C.kind!=="target"||!C.name||(w.push(C.name),S[C.name]=ha(C)||"")}),{names:w,verdicts:S}},[r]),x=p.useMemo(()=>m.length?ba(b,m,g,a):null,[b,m.length]);if(!i.pipe||f||!x||x.firstVisit||!x.added.length&&!x.gone.length)return null;const c=u?x.added:x.added.slice(0,br),y=x.added.length-c.length,k=w=>{const S=r.find(C=>C.name===w);S&&(o(S.id),l({type:"popup",id:S.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(x.added.length,x.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{d(!0),va(b,m,g,x.fp,a)},children:"×"})]}),!!x.added.length&&e.jsxs("div",{className:"since-c",children:[c.map(w=>e.jsx("button",{type:"button",onClick:()=>k(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>h(!0),children:t.sinceMore(y)})]}),!!x.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>v(w=>!w),children:t.sinceOut(x.gone.length)}),s&&x.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const _e=600,me=62,bt="atl2:fstats";function yr(){const{t,lang:a,data:n,caps:r,st:i,dispatch:o}=z(),[l,f]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(bt)==="on"}catch{return!1}}),d=n.stats,u=p.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),h=p.useMemo(()=>{if(d!=null&&d.since)return d.since;const y=new Date;return y.setDate(y.getDate()-((d==null?void 0:d.window_days)||30)),y.toISOString().slice(0,10)},[d==null?void 0:d.since,d==null?void 0:d.window_days]);if(!r.showFunnel||!d||typeof d.screened!="number")return null;const s=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,v=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),b=u.reduce((y,k)=>Math.max(y,k.s||0),0),m=u.length?_e/u.length:0,g=Math.max(4,m-4),x=u.length>=5&&b>0,c=[[d.screened,t.funScreened(s(h)),d.screened_today],...typeof d.kept=="number"?[[d.kept,t.funKept,d.kept_today]]:[],...typeof d.analyzed=="number"?[[d.analyzed,t.funAnalyzed,d.analyzed_today]]:[],...typeof d.shown=="number"?[[d.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(l?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[c.map(([y,k,w],S)=>e.jsxs("span",{className:"fst-t",children:[S>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:v(y)}),e.jsx("i",{children:k}),l&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},k)),x&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!l;f(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(bt,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&x&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${_e} ${me}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[u.map((y,k)=>{const w=(y.s||0)/b*(me-4),S=(y.m||0)/b*(me-4),C=k*m+(m-g)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${s(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:C,y:me-2-w,width:g,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:C,y:me-2-S,width:g,height:S,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:me-1.5,x2:_e,y2:me-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:s(u[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const wr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function kr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:i}=z(),[o,l]=p.useState(""),[f,d]=p.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const u=(t.ceoStatus||"").trim(),h=(Pe(t)||"").startsWith("CALL")&&ee(t)===3,s=ee(t)>=2,v=async m=>{if(o||m==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const g=await i(t,m);l(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=h?[["Validé",a.csYes],["Écarté",a.csNo]]:wr.filter(([m])=>!(s&&m==="Retenu")).map(([m,g])=>[m,a[g]]);return e.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,g])=>e.jsx("button",{type:"button",className:"csb"+(u===m?" on":"")+(o===m?" busy":""),disabled:!!o,onClick:()=>{v(m)},children:g},m)),f&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(jr,{o:t})]})}function jr({o:t}){const{t:a,saveNote:n,flash:r}=z(),[i,o]=p.useState(t.ceoNote||""),[l,f]=p.useState(!1),[d,u]=p.useState(!1),h=i.trim()!==(t.ceoNote||"").trim(),s=async()=>{if(l||!h)return;f(!0);const v=await n(t,i.trim());f(!1),v&&(u(!0),setTimeout(()=>u(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:v=>o(v.target.value),onKeyDown:v=>{v.key==="Enter"&&s()}}),e.jsx("button",{type:"button",disabled:l||!h,onClick:()=>{s()},children:d?a.csNoteSaved:a.csNoteOk})]})}function Nr({placeholder:t,onDone:a}){const{t:n}=z(),[r,i]=p.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Sr({o:t}){var x;const{t:a,token:n,caps:r,canWrite:i,stageOf:o,setStage:l,flashErr:f}=z(),[d,u]=p.useState(!1);if(!r.pipe||!i||r.lockActions||ee(t)!==4)return null;const h=o(t),s=(h==null?void 0:h.stage)||"todo",v=async c=>{if(d||c===s)return;u(!0);const y=h;l(t,{stage:c,stamps:(h==null?void 0:h.stamps)||{}});const k=Math.max(Date.now(),vt+=1);vt=k;const w=await ya(n,{company:t.name||"",stage:c,cts:k,deal_id:t.airtableId,check_id:t.checkId});u(!1),!w.stale&&(w.ok||(l(t,y),f(a.actErr)))},b=(x=h==null?void 0:h.stamps)==null?void 0:x.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=s==="sent"&&b&&m>=4;return e.jsxs("div",{className:"stg",onClick:c=>c.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([c,y])=>e.jsx("button",{type:"button",className:"stgb"+(s===c?" on":""),disabled:d,onClick:()=>{v(c)},children:y},c)),g&&e.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let vt=0;const Re=8,Me=340;function yt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Cr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:i,scoped:o,byId:l,st:f}=z(),[d,u]=p.useState(0),[h,s]=p.useState(null),[v,b]=p.useState([]),m=p.useRef(!1);p.useEffect(()=>{m.current||(m.current=!0,b(t.filter(S=>!!document.querySelector(S.need||S.sel))))},[t]);const g=v[d],x=d>=v.length;p.useEffect(()=>{g&&(g.ptab!==void 0&&f.ptab!==g.ptab&&r({type:"ptab",tab:g.ptab}),g.dens&&f.dens!==g.dens&&r({type:"dens",dens:g.dens}))},[d,g]);const c=p.useCallback(()=>{if(!g){s(null);return}const S=document.querySelector(g.sel);if(!S){s(null);return}S.scrollIntoView({block:"nearest",behavior:"smooth"}),s(S.getBoundingClientRect())},[g]);p.useLayoutEffect(()=>{c();const S=window.setTimeout(c,260),C=()=>c();return window.addEventListener("scroll",C,!0),window.addEventListener("resize",C),()=>{window.clearTimeout(S),window.removeEventListener("scroll",C,!0),window.removeEventListener("resize",C)}},[c]);const y=p.useRef(a);if(y.current=a,p.useEffect(()=>{const S=C=>{C.key==="Escape"?(C.preventDefault(),C.stopPropagation(),y.current()):C.key==="ArrowRight"?u(F=>F+1):C.key==="ArrowLeft"&&u(F=>Math.max(0,F-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!v.length)return null;let k=null;if(x){const S=i[3]||0,C=o.find(F=>F.memoUrl)||[...l.values()].find(F=>F.memoUrl);S>0?k={title:S===1?n.ahaATitle1:n.ahaATitleN(S),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:C?k={title:n.ahaBTitle,body:n.ahaBBody(C.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:C.id}),a()}}:k={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Me};if(!x&&h){const S=h.bottom+14,F=window.innerHeight-S>190?S:Math.max(12,h.top-200);w={left:Math.min(Math.max(12,h.left+h.width/2-Me/2),window.innerWidth-Me-12),top:F,width:Me}}return Te.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!x&&h&&e.jsx("div",{className:"tour-hole",style:{left:h.left-Re,top:h.top-Re,width:h.width+Re*2,height:h.height+Re*2}}),(x||!h)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(x?" fin":""),style:w,children:[x&&k?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:k.title}),e.jsx("p",{children:e.jsx(yt,{text:k.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>u(v.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(d+1,v.length)}),e.jsx("h3",{children:g==null?void 0:g.title}),e.jsx("p",{children:e.jsx(yt,{text:(g==null?void 0:g.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>u(S=>Math.max(0,S-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>u(S=>S+1),children:d===v.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function zr(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:i}=z(),o=p.useMemo(()=>t.filter(s=>ye(s.date)===0&&s.kind==="target"),[t]),l=p.useMemo(()=>o.filter(s=>a?ee(s)===0:!X(s)),[o,a]),f=o.length-l.length,d=o.length?Math.min(100,f/o.length*100):100;let u;a?u=n.morningThesis(o.length,f,l.length):o.length?f===0?u=n.goalSourced(o.length):f>=o.length?u=n.goalCleared:u=n.goalDone(f,o.length):u=n.goalSourced(0);const h=()=>{a?(i({type:"ptab",tab:0}),i({type:"filters",patch:{win:"1"}})):i({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:u}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:d+"%"}})}),l.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:a?n.morningEval(l.length):r.pileMode?n.goalContinue(l.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Er(){var P;const{t,st:a,dispatch:n,token:r,fund:i,data:o,dossiers:l,mode:f,doSync:d,startTour:u}=z(),[h,s]=p.useState(null),[v,b]=p.useState([]),[m,g]=p.useState(!1),x=f==="client";p.useEffect(()=>{if(!r||!i)return;let O=!0;return(async()=>{const[M,D]=await Promise.all([Tt(i),At(r)]);O&&(M&&s(M),b(D))})(),()=>{O=!1}},[r,i]);const c=(h==null?void 0:h.per_day)??null,y=((P=h==null?void 0:h.pool_order)==null?void 0:P.length)??0,k=v.filter(O=>O.status==="running").length,w=O=>{if(!x||c===null||m)return;const M=Math.max(0,Math.min(10,c+O));M!==c&&(g(!0),s(D=>D&&{...D,per_day:M}),Ot(r,M).then(D=>{g(!1),s(D===null?T=>T&&{...T,per_day:c}:T=>T&&{...T,per_day:D})}))},S=p.useMemo(()=>l.filter(O=>O.kind==="target"&&X(O)).length,[l]),C=o.marketEstimate,F=C&&C>0?Math.min(100,Math.round(S/C*100)):null,N=(i||"P").split(/\s+/).map(O=>O[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const O=Date.parse(o.generatedAt||"");if(Number.isNaN(O))return"";const M=new Date(O),D=T=>String(T).padStart(2,"0");return`${D(M.getDate())}/${D(M.getMonth()+1)} à ${D(M.getHours())}:${D(M.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:i})]}),e.jsx("h1",{children:t.identTitle(i||"…")}),e.jsx("span",{className:"idsp"}),E&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(E)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:u,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[F!==null&&C&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:F+"%"}})}),e.jsxs("b",{children:[F," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(S,C)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),c!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),w(-1)},children:"−"}),e.jsx("b",{className:"q",children:c})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:O=>{O.stopPropagation(),w(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),c===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),k>0&&e.jsxs("span",{className:"ev",children:["⏳ ",k]}),e.jsx("span",{className:"ego",children:t.identPending(y)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:O=>{O.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!x,onClick:d,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:O=>n({type:"filters",patch:{search:O.target.value}})})]})]})]})}function Tr(){const{t,counts:a,dispatch:n}=z();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,i],o)=>{const l=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(l?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:i}),l&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Ar=["--p0","--p1","--p2","--p3","--p4"];function Or(){const{st:t,dispatch:a,counts:n,t:r,doUndo:i}=z(),o=p.useRef({});p.useEffect(()=>{o.current={...n}},[n]);const l=u=>{const h=o.current[u],s=h!==void 0?n[u]-h:0;return e.jsxs("button",{type:"button",className:"step"+(u===3&&n[3]>0?" wait":""),style:{"--c":`var(${Ar[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===u,title:r.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsxs("span",{className:"l",children:[r.plabels[u].toUpperCase(),u===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[u],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},u)},f=(u,h,s)=>e.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===u,title:r.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[u]})]},u),d=(u,h,s,v=!1)=>e.jsx("button",{type:"button",className:"tool",title:h,disabled:v,onClick:s,children:u},h);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),e.jsxs("div",{className:"offtrack",children:[f(5,!1,r.plabels[5]),f(7,!0,r.plabels[7]),f(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[d("↩",r.toolUndo,i,t.undo.length===0),d("↺",r.toolReset,()=>{a({type:"reset"})}),d("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),d("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),d("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Lr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Fr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:i,doAnalyse:o,mode:l}=z(),f=p.useRef(null),[d,u]=p.useState(60);p.useEffect(()=>{let b=0;const m=()=>{var k;const g=f.current;if(!g)return;const x=(k=g.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!x)return;const c=x.getBoundingClientRect(),y=g.getBoundingClientRect();u(Math.max(20,Math.min(c.left+c.width/2-y.left,y.width-30)))};return b=requestAnimationFrame(m),window.addEventListener("resize",m),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",m)}},[t.ptab]);const h=t.ptab;let s=n.tuto[h].p;if(h===3){const b=r.filter(x=>x.kind==="target"&&ee(x)===3),m=b.filter(x=>He(x)==="auto").length,g=b.filter(x=>He(x)==="cd").length;s=n.tutoPending(m,g,b.length)}const v=(()=>{if(l!=="client")return null;if(h===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(b=>b.id)})};if(h===1){const b=r.filter(m=>m.kind==="target"&&ee(m)===1&&!i.has(m.id)).slice(0,10);if(b.length)return{label:n.tuto[1].a,run:()=>b.forEach(m=>o(m))}}return null})();return e.jsxs("div",{ref:f,className:"tuto mini",style:{"--bg":Lr[h],"--ax":d+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[h].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),v&&e.jsx("button",{type:"button",className:"tprim",onClick:v.run,children:v.label})]})}const wt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function kt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Rr(t,a){const[n,r]=p.useState(1);return p.useEffect(()=>{let i=!0,o=0;const l=()=>{var u;if(!i)return;const d=(u=t.current)==null?void 0:u.getScreenCTM();d&&d.a>0?r(d.a):o=requestAnimationFrame(l)};l();const f=new ResizeObserver(()=>l());return t.current&&f.observe(t.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),f.disconnect(),window.removeEventListener("resize",l)}},[t,a]),n}function Mr(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:i,markedId:o,byId:l,lang:f,t:d}=z(),u=p.useRef(null),h=p.useRef(null),s=Ge.find(N=>N.key===t.continent),v=Rr(u,t.continent+":"+t.mapFolded),[b,m]=p.useState(new Map),[g,x]=p.useState(null);p.useEffect(()=>{const N=u.current;if(!N)return;const E=new Map;N.querySelectorAll("path[data-i2]").forEach(P=>{const O=P.dataset.i2;if(O)try{const M=P.getBBox();M.width>0&&E.set(O,{x:M.x,y:M.y,w:M.width,h:M.height})}catch{}}),m(E)},[t.continent,v]);const c=p.useMemo(()=>n.filter(N=>N.cc),[n]),y=p.useMemo(()=>{const N=new Map;return c.forEach(E=>N.set(E.cc,(N.get(E.cc)||0)+1)),N},[c]),k=p.useMemo(()=>c.map(N=>{const E=N.cc?b.get(N.cc):void 0;if(!E)return null;const P=kt(N.name||N.id||""),O=kt((N.id||N.name||"")+"·y"),M=(P-.5)*Math.min(E.w*.55,60),D=(O-.5)*Math.min(E.h*.55,60);return{d:N,x:E.x+E.w/2+M,y:E.y+E.h/2+D}}).filter(N=>!!N),[c,b]),w=N=>v>0?N/v:N,S=p.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:wt[N],fr:d.plabels[N].toUpperCase(),en:d.plabels[N].toUpperCase(),n:n.filter(E=>E.kind==="target"&&ee(E)===N).length})).filter(N=>N.n>0):lt.map((N,E)=>({...N,n:n.filter(P=>st(P)===E).length})),[n,r,d.plabels]),C=o?l.get(o):null,F=C?k.find(N=>N.d.id===C.id):null;return e.jsxs("div",{className:"mapzone",ref:h,children:[e.jsxs("svg",{ref:u,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":f==="fr"?s.fr:s.en,onMouseLeave:()=>{x(null),i(null)},children:[e.jsx("g",{children:s.countries.map((N,E)=>e.jsx("g",{className:"ct"+(N.i2&&y.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},E))}),e.jsx("g",{children:k.map(N=>{const E=lt[st(N.d)],P=!!K(N.d),O=N.d.kind==="target",M=r&&O?wt[ee(N.d)]:E.c,D=!r&&X(N.d);return e.jsxs("g",{className:"co"+(D?" done":""),onMouseEnter:()=>{var R,H;const T=(R=h.current)==null?void 0:R.getBoundingClientRect(),B=(H=u.current)==null?void 0:H.createSVGPoint();if(B&&u.current&&T){B.x=N.x,B.y=N.y;const oe=B.matrixTransform(u.current.getScreenCTM());x({x:oe.x-T.left,y:oe.y-T.top,label:N.d.name+" · "+(we(N.d.cc,f)||N.d.countryLabel||"")})}i(N.d.id)},onMouseLeave:()=>{x(null),i(null)},onClick:()=>{var R;const T=(R=u.current)==null?void 0:R.createSVGPoint();let B=null;if(T&&u.current){T.x=N.x,T.y=N.y;const H=T.matrixTransform(u.current.getScreenCTM());B={x:H.x,y:H.y}}a({type:"popup",id:N.d.id,anchor:B})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:w(Math.max(11,E.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:w(E.px),fill:M,stroke:P?"#DC2626":"#ffffff",strokeWidth:w(P?2.2:1.3)})]},N.d.id||N.d.name)})}),F&&e.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(g?" on":""),style:g?{left:g.x,top:g.y}:void 0,children:g==null?void 0:g.label}),e.jsx("div",{className:"legend",children:S.map((N,E)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),f==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},E))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",d.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function qr(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:i,contName:o}=z(),l=t.filters,f=p.useMemo(()=>n.filter(b=>b.continent===t.continent),[n,t.continent]),d=b=>f.filter(m=>b!=="country"&&l.country.length&&!l.country.includes(m.cc||"")?!1:Je(m,l,i,b==="country"?void 0:b)),u=p.useMemo(()=>{const b=d("win"),m=g=>b.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=g).length;return[m(0),m(7),m(30),b.length]},[f,l,i]),h=p.useMemo(()=>{if(i)return null;const b=d("status"),m={all:b.length,todo:0,retenu:0,pending:0,ecarte:0};return b.forEach(g=>{m[se(g)]+=1}),m},[f,l,i]),s=l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+(l.signalOnly?1:0)+(l.win!=="all"?1:0)+(!i&&l.status!=="all"?1:0)+(l.search.trim()?1:0),v=(b,m,g,x="fbtn")=>e.jsxs("button",{type:"button",className:x,"aria-expanded":t.openFacet===b,onClick:()=>a({type:"openFacet",facet:b}),children:[e.jsx("span",{className:"fl",children:m}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},b);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((b,m)=>e.jsxs("button",{type:"button","aria-pressed":l.win===b,onClick:()=>a({type:"filters",patch:{win:b}}),children:[r.dates[m],e.jsx("b",{children:u[m]})]},b))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:l.search,onChange:b=>a({type:"filters",patch:{search:b.target.value}})})]}),!i&&h&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([b,m])=>e.jsxs("button",{type:"button","aria-pressed":l.status===b,onClick:()=>a({type:"filters",patch:{status:b}}),children:[m,e.jsx("b",{children:h[b]??0})]},b))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),l.signalOnly&&e.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),v("sec",r.fSector,l.sector.length),v("pay",r.fCountry,l.country.length),v("det",r.fEngine,l.engine.length),v("sta",r.fStage,l.stage.length),i&&v("ang","Angle",l.angle.length),i&&v("mem","Mémo",l.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(f.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(Dr,{poolFor:d})]})}function Dr({poolFor:t}){const{st:a,dispatch:n,t:r,lang:i}=z(),o=a.filters,l=a.openFacet,{title:f,cols:d,options:u}=p.useMemo(()=>{if(l==="sig"){const m=t("signal").filter(c=>K(c)),g=new Map;m.forEach(c=>{const y=c.engine||"";g.set(y,(g.get(y)||0)+1)});const x=[{v:"*",label:r.fpSigAll,n:m.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...dt([...g.keys()],i).map(c=>({v:c,label:ve(c)+" "+le(c,i),n:g.get(c)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(c)}))];return{title:r.fpSigTitle,cols:2,options:x}}if(l==="sec"){const m=t("sector"),g=new Map;return m.forEach(x=>{x.sector&&g.set(x.sector,(g.get(x.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((x,c)=>c[1]-x[1]).map(([x,c])=>({v:x,label:x,n:c,html:!1,on:o.sector.includes(x)}))}}if(l==="pay"){const m=t("country"),g=new Map;return m.forEach(x=>{x.cc&&g.set(x.cc,(g.get(x.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((x,c)=>c[1]-x[1]).map(([x,c])=>({v:x,label:we(x,i)||x,n:c,html:!1,on:o.country.includes(x)}))}}if(l==="det"){const m=t("engine"),g=new Map;return m.forEach(x=>{x.engine&&g.set(x.engine,(g.get(x.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:dt([...g.keys()],i).map(x=>({v:x,label:ve(x)+" "+le(x,i)+' <span style="color:var(--dim);font-size:10px">· '+wa(ka(x),i)+"</span>",n:g.get(x)||0,html:!0,on:o.engine.includes(x)}))}}if(l==="ang"){const m=t("angle"),g=new Map;return m.forEach(x=>{x.angle&&g.set(x.angle,(g.get(x.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((x,c)=>c[1]-x[1]).map(([x,c])=>({v:x,label:x.replace(/[_-]+/g," "),n:c,html:!1,on:o.angle.includes(x)}))}}if(l==="mem"){const m=t("memoLevel"),g=new Map;m.forEach(c=>{if(c.kind==="target"){const y=We(c);g.set(y,(g.get(y)||0)+1)}});const x=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(c=>({v:String(c),label:x[c],n:g.get(c)||0,html:!1,on:o.memoLevel.includes(c)}))}}const v=t("stage"),b=new Map;return v.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,g)=>g[1]-m[1]).map(([m,g])=>({v:m,label:m,n:g,html:!1,on:o.stage.includes(m)}))}},[l,a,i]),h=v=>{if(l==="sig"){if(v==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const m=o.signalEngines.includes(v)?o.signalEngines.filter(g=>g!==v):[...o.signalEngines,v];n({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){n({type:"toggleMemoLevel",value:Number(v)});return}n({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:v})},s=()=>{n(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:f}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(d===2?" two":""),children:u.map(v=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":v.on,onClick:()=>h(v.v),children:[e.jsx("span",{className:"bx"}),v.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:v.label}}):e.jsx("span",{className:"l",children:v.label}),e.jsx("span",{className:"n",children:v.n})]},v.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const jt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Pr(){const{t,mode:a,token:n,askEvaluate:r,sessTally:i,dispatch:o,evalBusy:l,evalCards:f,caps:d,data:u}=z(),h=a==="client",[s,v]=p.useState(""),[b,m]=p.useState(!1),[g,x]=p.useState(""),[c,y]=p.useState(!1),[k,w]=p.useState(""),[S,C]=p.useState([]),F=p.useRef(!1),N=s.trim()?jt.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,E=p.useMemo(()=>g.split(`
`).map(T=>T.trim()).filter(Boolean).slice(0,15),[g]),P=S.length?S:f,O=u.credits,M=()=>{const T=s.trim();T&&(r(null,T),v(""))},D=async()=>{if(!h){r(null,E[0]||"");return}if(!E.length||c)return;y(!0),F.current=!1;const T=[];for(let B=0;B<E.length&&!F.current;B++){w(t.evaluating(B+1,E.length,E[B]));const R=await Lt(n,E[B],"atelier2");if(T.unshift({name:R.company||E[B],verdict:R.verdict,reason:R.reason||"",remaining:R.remaining??null}),C([...T]),R.verdict==="quota"){T.unshift({name:"",verdict:"quota",reason:t.quota(E.length-B-1),remaining:0}),C([...T]);break}}w(""),x(""),y(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:T=>v(T.target.value),onKeyDown:T=>{T.key==="Enter"&&M()}}),e.jsx("span",{className:"detect"+(jt.test(s.trim())?" url":""),children:N})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),disabled:l,onClick:M,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),d.showCredits&&O&&e.jsxs("button",{type:"button",className:"credits"+(O.total_available<=0&&!O.unlimited?" empty":""),onClick:()=>o({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:O.unlimited?"∞":O.total_available}),!O.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",O.daily_grant+O.purchased]}),O.total_available<=0&&!O.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>m(!b),children:t.evalMulti})}),b&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:T=>x(T.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{justifyContent:"center"},disabled:c||!E.length,onClick:()=>{D()},children:[e.jsx("span",{className:"fill"}),c&&k?k:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(E.length)})]})]}),P.slice(0,1).map((T,B)=>{const R=T.verdict==="kept",H=T.verdict==="quota",oe=R?"var(--brand)":H?"var(--bolt)":"var(--red)",de=R?"var(--brand-l)":H?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":oe,"--bgc":de},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:R?"✓ "+t.kept:H?"⏳":"✗ "+t.dropped})}),T.name&&e.jsx("span",{className:"rn",children:T.name}),e.jsx("span",{className:"rr",children:T.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",T.reason]}):null}),!H&&e.jsx("button",{type:"button",className:"go",onClick:()=>o({type:"modal",modal:"space"}),children:t.seeSpace(R?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},B)}),h&&(i.kept+i.dropped>0||P.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(i.kept,i.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>o({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Br(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ir(){const{st:t,dispatch:a,byId:n,t:r,doDeep:i}=z(),o=t.memoConsole?n.get(t.memoConsole):null,l=p.useMemo(()=>o?[o.reasoning||"",Br(o.summary||"")].filter(Boolean).join(`
...
`).map((u,h)=>e.jsx("p",{style:{margin:"0 0 10px"},children:u},h)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[Ke(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:d===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}function Pt({name:t}){const{t:a,token:n,caps:r,mode:i,flashErr:o}=z(),[l,f]=p.useState(!1),[d,u]=p.useState(null);if(!r.pipe||i!=="client"||r.lockActions)return null;const h=async()=>{if(l)return;f(!0);const s=await ja(n,t);if(f(!1),!s){o(a.actErr);return}u(s.results||[])};return e.jsxs("div",{className:"simb",onClick:s=>s.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{h()},children:l?a.similarBusy:a.similar}),d&&(d.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:d.map(s=>e.jsxs("li",{children:[e.jsx("b",{className:s.verdict==="kept"?"ok":"ko",children:s.company}),s.reason&&e.jsx("span",{children:s.reason})]},s.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Bt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ze({o:t}){const{t:a}=z(),n=De(t),r=Pe(t),i=ee(t),o=He(t),l=Na(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Bt[r]||"v-cons"),title:a.vt[r],children:r}):i===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&e.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}function Nt({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:i}=z(),[o,l]=p.useState(!1);if(p.useEffect(()=>{r||l(!1)},[r]),X(t)){const u=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":u?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[u?"✓":"✗"," ",e.jsx("b",{children:u?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const d=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:r,onClick:u=>{u.stopPropagation(),l(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function $r({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:i,doAnalyse:o,doDecide:l,doPromote:f,doRepeche:d,doApproach:u,dispatch:h}=z();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:b=>{b.stopPropagation(),h({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Nt,{o:t})});const s=ee(t),v=b=>m=>{m.stopPropagation(),b()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(Nt,{o:t})});if(s===1){const b=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:v(()=>o(t)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:v(()=>l(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:v(()=>l(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const b=i.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:b,onClick:v(()=>u(t)),children:b?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>f(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:v(()=>d(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:v(()=>h({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:v(()=>h({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function Vr({o:t}){const{t:a,doThumb:n,thumbOf:r}=z(),i=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function Ur({o:t}){const{lang:a}=z();return K(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(ke,{o:t}),e.jsx(Be,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ve(t.engine||"")," ",le(t.engine||"",a)]})})}function _r({o:t,locked:a,open:n,onToggle:r}){const{st:i,dispatch:o,caps:l,markRow:f,markedId:d,favIds:u,toggleFav:h}=z(),s=ee(t),v=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,m=b<=0?0:b<=7?1:b<=30?2:3,g=l.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:v[m],x=u.has(t.id),c=y=>{if(a)return;if(l.pipe){r();return}const k=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:k.left+Math.min(280,k.width/3),y:k.bottom}})};return e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"row"+(d===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>f(t.id),onMouseLeave:()=>f(null),onClick:c,children:[e.jsx("span",{className:"pt",style:{"--c":g}}),e.jsx(Vt,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[l.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:x?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),h(t)},children:x?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(Hr,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(Ur,{o:t}),l.pipe&&e.jsx(Ze,{o:t}),l.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx($r,{o:t}),l.showThumbs&&e.jsx(Vr,{o:t})]}),(n||i.dens==="deplie")&&!a&&e.jsx(Yr,{o:t})]})}function Hr({o:t}){const{lang:a,caps:n}=z();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=Qe(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function Yr({o:t}){const{t:a,lang:n,dispatch:r,caps:i,outbound:o,doOnboard:l}=z();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(De(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:De(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsx(kr,{o:t}),e.jsx(Sr,{o:t}),e.jsx(Pt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(Ze,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ve(t.engine||"")," ",le(t.engine||"",n)]}),K(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(ke,{o:t})})]}),i.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(t),children:a.actOnboard})]})]})]})}function Wr({o:t,locked:a}){const{t:n,dispatch:r,caps:i,doDecide:o}=z(),l=ee(t),f=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":f},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(Ze,{o:t}),K(t)&&e.jsx(ke,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&i.pipe&&l===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function Gr(){const t=z(),{st:a,dispatch:n,t:r,caps:i,scoped:o,lang:l,sessTally:f}=t,[d,u]=p.useState(new Set);p.useEffect(()=>{u(new Set)},[a.ptab,a.continent]);const h=k=>u(w=>{const S=new Set(w);return S.has(k)?S.delete(k):S.add(k),S}),s=p.useMemo(()=>Xe(o,a.sort),[o,a.sort]),v=p.useMemo(()=>s.filter(k=>K(k)&&!X(k)).length,[s]),b=i.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,m=(k,w,S="",C=!1)=>e.jsxs("button",{type:"button","data-s":k,className:S,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:C?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:k}),children:[w,e.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),g=p.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const k=new Map;return s.forEach(w=>{const S=w.engine||"?";k.has(S)||k.set(S,[]),k.get(S).push(w)}),[...k.entries()]},[s,i.pipe,a.groupBy]),x=i.lockRowsAfter;let c=0;const y=(k,w)=>{const S=a.shown[w]||qe,F=k.slice(0,S).map(N=>{const E=x!==null&&c>=x;return c++,a.dens==="maxi"?e.jsx(Wr,{o:N,locked:E},N.id):e.jsx(_r,{o:N,locked:E,open:d.has(N.id),onToggle:()=>h(N.id)},N.id)});return k.length>S&&F.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:w,by:qe}),children:r.more(Math.min(qe,k.length-S),k.length-S)},w+":more")),F};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:s.length})," ",b]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,i.pipe&&t.fund?" · "+t.fund:""]}),i.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),i.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([k,w])=>e.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>n({type:"dens",dens:k}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:w})]},k))}),i.showChain&&s.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:s.filter(k=>i.pipe?!0:!X(k)).map(k=>k.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",i.pipe?r.browse(s.length):r.chainAll(s.filter(k=>!X(k)).length)]})]}),v>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(v)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),m("country",r.colCountry),m("name",r.colCompany),m("amount",r.colAmount,"h-amt",!0),m("stage",r.colStage,"h-stade"),m("signal",r.colSignal,"h-sig"),i.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),i.pipe&&m("score",r.colScore,"h-sc",!0),e.jsx("span",{}),i.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[g?g.map(([k,w])=>e.jsxs(p.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ve(k)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:le(k,l)}),e.jsx("div",{className:"s",children:r.grpCount(w.filter(S=>!X(S)).length,w.length)})]})]}),y(w,k)]},k)):y(s,"pt"+a.ptab),!s.length&&e.jsx("div",{className:"void",children:i.pipe?r.emptyTab:r.emptyScope})]}),i.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(f.kept>0||f.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(f.kept,f.dropped)}})]})}const Kr=`
