...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ss=`
...
.atl2 .eq-head{padding:0 0 2px;font-family:var(--mono);font-size:9px;letter-spacing:.09em;
  text-transform:uppercase;color:var(--dim)}
.atl2 .eq-row.r-kept{background:rgba(14,138,79,.05);border-radius:7px}
.atl2 .eq-row.r-out{background:rgba(220,38,38,.04);border-radius:7px}
...
.atl2 .bulk.evalq .side .hint{white-space:normal;text-align:left;line-height:1.5;
...
.atl2 .md-toc{display:flex;flex-wrap:wrap;gap:4px;margin:0 0 4px;padding:8px;
  ...
  position:sticky;top:0;z-index:8;box-shadow:0 4px 10px rgba(15,23,42,.06)}
...
.atl2 .apsw.on .apr{background:#0F6E3F}
...
.atl2 .plugcrmq .mnote b{color:#0F6E3F}
.atl2 .plugcrm .plugex,.atl2 .plugcrmq .plugex{margin:8px 0 0}
`,zs=Es+Ss+Cs;function sn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function As(){const e=sn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function qs(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=As();return r==="0"?"client":r==="1"||sn("embed")==="1"&&sn("chrome")==="1"?"apercu":"client"}const Ts={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ls=e=>Ts[e];function Ea(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Et=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Xr(a)||Ea(a))&&(e.noCo=!0)}return Object.assign(e,{continent:fi(e.cc)})};function Va(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Rs=60*60*1e3;function Fs(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Rs?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ms=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Os(e,a,r="default"){const n=r!=="default",o=u.useMemo(()=>e||n?{mode:"anon"}:ni(),[e,n]),i=u.useMemo(()=>n?"visiteur":qs(e,o),[e,o,n]),s=u.useMemo(()=>Ls(i),[i]),l=i!=="visiteur",p=Ms(r),[g,d]=u.useState([]),[x,m]=u.useState(""),[b,f]=u.useState(null),[v,y]=u.useState(null),[h,k]=u.useState(null),[E,w]=u.useState(()=>new Map),[N,q]=u.useState(()=>new Map),[C,L]=u.useState(""),[z,M]=u.useState(new Set),[D,$]=u.useState(null),[R,O]=u.useState(!0),[c,j]=u.useState(!1),[T,B]=u.useState(0),[P,F]=u.useState(0),_=u.useRef(0),G=u.useMemo(()=>{var X;if(i!=="client")return"";try{return((X=ri())==null?void 0:X.email)||""}catch{return""}},[i]);u.useEffect(()=>{const X=++_.current;let ge=!0;const Q=()=>ge&&X===_.current,ce=(l&&o.token?o.token:"pub:"+a)+(p?":"+p:""),le=Fs(ce);return le?(d(le.objs.map(Et)),le.fund&&m(le.fund),f(le.marketEstimate??null),y(le.criteria??null),k(le.stats??null),L(le.generatedAt||""),O(!1)):O(!0),(async()=>{try{if(r==="ops"){const be=await _a(),me=((be==null?void 0:be.recent_ops)||[]).map(de=>{const pe=va(de.company_name||de.title?de:{...de,title:(de.headline_fr||de.headline||"").slice(0,120)},a),xe=String(de.rubrique||"").toLowerCase();return pe&&(xe==="nominations"||xe==="recrutements")&&(pe.engine=xe),pe&&!String(de.company_name||"").trim()&&(pe.noCo=!0),pe}).filter(de=>!!de).map(de=>(Xr((de.name||"").trim())||(de.noCo=!0),de));try{const de=oi(),pe=await ii(),xe=((pe==null?void 0:pe.date)||"").slice(0,10),Y=de?de.doc:pe,re=si(Y),fe=((de==null?void 0:de.day)||(Y==null?void 0:Y.date)||xe||"").slice(0,10);if(fe&&re.length){const ke=new Set;for(const ne of me){if((ne.date||"").slice(0,10)!==fe)continue;const ve=_n(re,ke,ne.name,"");ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}for(const ne of me){if(ne.decryptHtml||(ne.date||"").slice(0,10)!==fe)continue;const ve=_n(re,ke,"",ne.headline||ne.tagline||ne.name);ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}}if(fe){const ke=((Y==null?void 0:Y.title_fr)||"").trim(),ne=((Y==null?void 0:Y.lead_fr)||"").trim(),ve=li(Y),oe=((Y==null?void 0:Y.url)||"").trim();ke&&(ve||oe)&&me.unshift({id:`edito:${fe}`,kind:"op",name:ke,cc:null,date:fe,engine:"edito",dealKind:"other",headline:ke,tagline:ne||ke,decryptHtml:ve||void 0,url:oe,noCo:!0})}}catch{}if(!Q())return;d(me.map(Et)),ca(ce,{objs:me})}else if(typeof r=="object"){const me=(await $n()||[]).filter(pe=>(pe.slug||"")===r.research).map(pe=>Un(pe,a)).filter(pe=>!!pe),de=Va(await Hn(me,a));if(!Q())return;d(de.map(Et)),ca(ce,{objs:de})}else if(l&&o.token){const be=di(o.token),me=_a(),de=ci(o.token),pe=pi(o.token),xe=ui(o.token),Y=await be;let re=Y?Y.targets:[];Q()&&Y&&(m(Y.fund||""),f(Y.marketEstimate??null),y(Y.criteria??null),k(Y.stats??null),L(Y.generatedAt||""),d(re.map(Et)),O(!1),j(!1));const[fe,ke,ne,ve]=await Promise.all([me,de,pe,xe]),oe=((fe==null?void 0:fe.recent_ops)||[]).map(he=>va(he,a)).filter(he=>!!he),Se=new Set(re.map(he=>he.id));if(re=[...re,...oe.filter(he=>!Se.has(he.id)&&(Se.add(he.id),!0))],!Q())return;d(re.map(Et));const Ke=new Set;for(const he of ke){const Ce=(he.id||he.co||"").toString().trim().toLowerCase();Ce&&Ke.add(Ce.startsWith("t:")?Ce:"t:"+Ce)}M(Ke),w(ne),q(ve),Y&&ca(ce,{fund:Y.fund,marketEstimate:Y.marketEstimate,criteria:Y.criteria,stats:Y.stats,generatedAt:Y.generatedAt,objs:re})}else{const be=mi(),me=$n(),de=_a(),pe=await be;Q()&&pe.length&&(d(Va(pe).map(Et)),O(!1),j(!1));const[xe,Y]=await Promise.all([me,de]),re=(xe||[]).map(ve=>Un(ve,a)).filter(ve=>!!ve),fe=await Hn(re,a),ke=((Y==null?void 0:Y.recent_ops)||[]).map(ve=>va(ve,a)).filter(ve=>!!ve),ne=Va([...pe,...fe,...ke]);if(!Q())return;d(ne.map(Et)),ca(ce,{objs:ne})}Q()&&j(!1)}catch{Q()&&!le&&j(!0)}finally{Q()&&O(!1)}})(),()=>{ge=!1}},[l,o.token,a,T,p]),u.useEffect(()=>{if(!s.showCredits||!G){$(null);return}let X=!0;return(async()=>{try{const ge=await fetch(`${Da}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:G})});if(!ge.ok)return;const Q=await ge.json();X&&Q&&Q.ok!==!1&&$(Q)}catch{}})(),()=>{X=!1}},[s.showCredits,G,P]);const J=u.useCallback(X=>M(new Set(X)),[]);return{session:o,mode:i,caps:s,fund:x,email:G,marketEstimate:b,generatedAt:C,criteria:v,stats:h,thumbs:E,stages:N,dossiers:g,favIds:z,setFavIds:J,credits:D,reloadCredits:()=>F(X=>X+1),loading:R,error:c,refresh:()=>B(X=>X+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ya=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Sa(e){return ya.has(e.engine||"")}function Ve(e){return!!e.noCo||Sa(e)&&!!e.url}const lo=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ds=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...lo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Is=new Set(["signal","amount","score","crible","memo"]);function Ps(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:lo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Is.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??co)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const co=80;function Ca(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Nn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ht(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ct(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ea(e,a,r){return We(e)?Ca(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ca(e,a.filters,r)}function Bs(e,a,r,n){return!(!ea(e,a,r)||r&&!hi(e,a.ptab,n))}function zn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-ht(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return gi(o);case"memo":return xi(o);case"signal":{const i=Me(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const s=n(o),l=n(i);return s<l?-a.dir:s>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Wa={},or=(Wa==null?void 0:Wa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function ir(){return new Date().toISOString().slice(0,10)}const An=u.createContext(null);function po(){return u.useContext(An)}function _s(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),s=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),l.querySelectorAll("*").forEach(p=>{const g=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(d=>p.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(p.setAttribute("href",g),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function $s(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),s=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),p=(i==="href"||i==="src")&&/^https?:\/\//i.test(s);!l&&!p&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function sr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),s=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),s&&n.setAttribute("class",s),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function lr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${i} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${i} ${r[1]}`}function uo(){const e=u.useContext(An);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Us({token:e,children:a}){const{dispatch:r,st:n,lang:o}=W(),[i,s]=u.useState(()=>n.filters.day||ir()),[l,p]=u.useState(null),[g,d]=u.useState(!1),x=u.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){s(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),m=u.useCallback(()=>{s(ir());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);u.useEffect(()=>{const v=y=>{var k;const h=(k=y.detail)==null?void 0:k.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[x]),u.useEffect(()=>{n.filters.day&&n.filters.day!==i&&s(n.filters.day)},[n.filters.day]),u.useEffect(()=>{if(!e||!i)return;let v=!1;d(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${or}/cibles/edition.json?${y}`).then(h=>h.json()).then(h=>{v||p(h)}).catch(()=>{v||p({ok:!1,error:"network"})}).finally(()=>{v||d(!1)}),()=>{v=!0}},[e,i]);const b=u.useMemo(()=>`${or}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),f=u.useMemo(()=>({token:e,day:i,ed:l,loading:g,pickDay:x,pickWindow:m,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,g,x,m,n.filters.day,b,o]);return t.jsx(An.Provider,{value:f,children:a})}function Hs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=uo(),[o,i]=u.useState(()=>n||Zr());return u.useEffect(()=>{n&&i(!0)},[n]),u.useEffect(()=>{const s=l=>{var p;return i(!!((p=l.detail)!=null&&p.open))};return window.addEventListener(ja,s),()=>window.removeEventListener(ja,s)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(bi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Vs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function dr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function cr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Ws(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=uo(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,p=a&&!a.ok,g=u.useRef(null),[d,x]=u.useState("fonds"),[m,b]=u.useState(null),[f,v]=u.useState("idle"),y=u.useRef(!1);u.useEffect(()=>{b(null),v("idle"),y.current=!1,x("fonds")},[e]),u.useEffect(()=>{if(d!=="jour"||y.current)return;y.current=!0;let N=!0;return v("load"),Vs(e).then(q=>{N&&(b(q),v("fait"))}),()=>{N=!1}},[d,e]);const h=u.useMemo(()=>$s((m==null?void 0:m.html)||""),[m==null?void 0:m.html]),k=u.useRef(null);u.useEffect(()=>{const N=k.current;if(!N||!h)return;let q=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(q||!N.isConnected)&&(C.beautifyEditoRows(N),C.mountCardFits(N))}),()=>{q=!0}},[h]);const E=u.useMemo(()=>sr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),w=u.useMemo(()=>sr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return u.useEffect(()=>{const N=g.current;if(!N||!E)return;let q=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(q||!N.isConnected)&&(C.beautifyEditoRows(N),C.mountCardFits(N))}),()=>{q=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&p&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?dr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:lr(e,!0)}),"."]}):dr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:lr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&s&&E?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,d==="fonds"&&s&&w?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:w}}):null,d==="jour"&&(h?t.jsxs(t.Fragment,{children:[(m==null?void 0:m.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:m.title}),t.jsx("div",{ref:k,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:h}})]}):t.jsx("p",{className:f==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:f!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:cr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:cr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Gs=300,pa=7,Ys={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},mo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Qs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ki(r)&&r!=="media")return"news:"+r;const n=Me(e);return n?"sig:"+(n.theme&&mo.fr[n.theme]?n.theme:"other"):"actualites"}function Ks(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:s,fund:l}=W(),p=po(),g=s==="en",[d,x]=u.useState("all"),[m,b]=u.useState(!1),f=u.useMemo(()=>{var ge;const c=(a.filters.day||"").slice(0,10),j=Q=>!(!i&&a.continent!=="monde"&&Q.continent!==a.continent||c&&(Q.date||"").slice(0,10)!==c),T=e.filter(Q=>j(Q)&&Me(Q)&&(!i||Q.kind!=="target"||Ne(Q)!==5)),B=i&&(((ge=p==null?void 0:p.ed)==null?void 0:ge.ops)||[]).length?p.ed.ops.map(Q=>va(Q,s)).filter(Q=>!!Q).map(Q=>(Q.briefOnly=!0,Q)).filter(Q=>!c||(Q.date||"").slice(0,10)===c):[],P=e.filter(Q=>j(Q)&&Q.kind==="op"&&(c?!0:ht(Q.date)<=pa)),F=i?B.length?B:P.filter(Q=>{const ce=(l||"").trim().toLowerCase();if(!ce)return!1;const le=Q.match||null;return le?Object.keys(le).map(be=>be.trim().toLowerCase()).includes(ce):!1}):P,_=c||new Date().toISOString().slice(0,10),G=Q=>{const ce=Ga(Q);return ce==="ma"?0:ce==="levees"?1:2};F.sort((Q,ce)=>{const le=G(Q)-G(ce);if(le)return le;const be=(Q.date||"").slice(0,10)===_?0:1,me=(ce.date||"").slice(0,10)===_?0:1;return be!==me?be-me:(ce.amountEur||0)-(Q.amountEur||0)});const J=new Set,X=[];for(const Q of[...F,...zn(T,{key:"signal",dir:-1})]){const ce=Q.id||Q.name;!ce||J.has(ce)||(J.add(ce),X.push(Q))}return i&&X.length===0?e.filter(ce=>j(ce)&&ht(ce.date)<=pa).sort((ce,le)=>(le.date||"").localeCompare(ce.date||"")).slice(0,80):X},[e,a.continent,a.filters.day,i,l,s,p]),v=u.useMemo(()=>{const c={};for(const j of f){const T=Ga(j);c[T]=(c[T]||0)+1}return c},[f]),y=u.useMemo(()=>d==="all"?f:f.filter(c=>Ga(c)===d),[f,d]),h=u.useMemo(()=>y.slice(0,Gs),[y]),k=y.length-h.length,E=u.useRef(null);u.useEffect(()=>{var F,_;const c=E.current;if(!c)return;const j=()=>{const G=c.scrollWidth;G<200||(c.style.animationDuration=Math.max(18,Math.round(G/130))+"s")};j();const T=requestAnimationFrame(j),B=window.setTimeout(j,1200);let P=!0;return(_=(F=document.fonts)==null?void 0:F.ready)==null||_.then(()=>{P&&j()}),()=>{P=!1,cancelAnimationFrame(T),window.clearTimeout(B)}},[h.length,d]);const w=c=>c==="all"?f.length:v[c]||0,N=c=>{if(c==="all")return g?"All":"Tout";if(c.startsWith("sig:"))return mo[g?"en":"fr"][c.slice(4)]||"🔔";if(c.startsWith("news:")){const j=c.slice(5);return yi[j]?wi(j,g?"en":"fr"):c}return Ys[g?"en":"fr"][c]},q=[{k:"all"}],C=["ma","levees"].filter(c=>w(c)>0||c===d);if(C.length){q.push({g:g?"Deals":"Opérations"});for(const c of C)q.push({k:c})}const L=["nominations","recrutements"].filter(c=>w(c)>0||c===d),z=vi.filter(c=>c!=="media").map(c=>"news:"+c).filter(c=>w(c)>0||c===d),M=w("actualites")>0||d==="actualites"?["actualites"]:[];if(L.length||z.length||M.length){q.push({g:g?"News":"Actualités"});for(const c of L)q.push({k:c});for(const c of z)q.push({k:c});for(const c of M)q.push({k:c})}const D=Qs.map(c=>"sig:"+c).filter(c=>w(c)>0||c===d);if(D.length){q.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const c of D)q.push({k:c})}const $=c=>{try{return new Date(c+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return c}},R=(()=>{const c=(a.filters.day||"").slice(0,10),j=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return c?(g?`LIVE covers the events of ${$(c)}.`:`Le LIVE regroupe les événements du ${$(c)}.`)+j:(g?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+j})(),O=c=>h.map(j=>t.jsxs("button",{type:"button",className:"tk"+(Ie(j)?" spent":""),onClick:T=>{const B=j.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:B?"":j.id,name:j.name,url:j.url||"",text:j.tagline||j.headline||"",card:j.card}}))}catch{}if(B||n({type:"focus",id:j.id}),a.dens!=="liste"){const P=T.currentTarget.getBoundingClientRect();n({type:"popup",id:j.id,anchor:{x:P.left+P.width/2,y:P.bottom}})}},title:j.name+(j.tagline?" — "+j.tagline:""),children:[t.jsx(yt,{o:j}),t.jsxs("span",{className:"who",children:[t.jsx(Qo,{o:j}),t.jsx("span",{className:"co",children:j.name})]}),typeof j.amountEur=="number"&&j.amountEur>0&&t.jsx("span",{className:"am",children:Tc(j.amountEur)}),j.sector&&t.jsx("span",{className:"mt",children:j.sector}),t.jsx(Ia,{o:j}),t.jsx("span",{className:"tkgo",children:"→"})]},c+(j.id||j.name))).concat(k>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${k} more — filter by section to see them`:`+ ${k} autres — filtrez par rubrique pour les voir`},c+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:c=>{c.currentTarget.contains(c.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>b(c=>!c),children:[N(d),t.jsx("b",{children:w(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:R}),q.map(c=>"g"in c?t.jsx("span",{className:"tkfilg",children:c.g},c.g):t.jsxs("button",{type:"button","aria-pressed":c.k===d,onClick:()=>{x(c.k),b(!1)},children:[N(c.k),t.jsx("b",{children:w(c.k)})]},c.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:E,children:[O(0),O(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!p&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!p&&t.jsx(Xs,{isEn:g})]})}const Js=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Xs({isEn:e}){const[a,r]=u.useState(()=>Zr());u.useEffect(()=>{const o=i=>{var s;return r(!!((s=i.detail)!=null&&s.open))};return window.addEventListener(ja,o),()=>window.removeEventListener(ja,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ji(!a),children:Js})}const qn="+33 6 83 10 72 86",za="alexandre@proplace.co",fo=`tel:${qn.replace(/[^\d+]/g,"")}`;function Zs(){return null}class rt extends u.Component{constructor(){super(...arguments);Pn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ho=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function pr(e,a){if((wt(e)||"").startsWith("CALL")&&Ne(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ne(e)>=2;return ho.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const ur=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",el={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function tl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:s}=W(),[l,p]=u.useState(""),[g,d]=u.useState(!1),[x,m]=u.useState(!1),b=u.useRef(null);if(u.useEffect(()=>{if(!x)return;const k=E=>{b.current&&!b.current.contains(E.target)&&(m(!1),d(!1))};return document.addEventListener("click",k,!0),()=>document.removeEventListener("click",k,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const f=(e.ceoStatus||"").trim(),v=async k=>{if(l)return;if(k==="Analysé"&&!e.memoUrl){d(!0);return}p(k);const E=(pr(e,a).find(([N])=>N===k)||[k,k])[1],w=await o(e,k,{msg:a.csMoved(e.name,E)});p(""),w&&(d(!1),m(!1))},y=pr(e,a),h=k=>(y.find(([E])=>E===k)||[])[1]||k;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:k=>k.stopPropagation(),children:y.map(([k,E])=>t.jsx("button",{type:"button",className:"rsd "+(k==="Validé"?"yes":"no")+(l===k?" busy":""),disabled:!!l,onClick:()=>{v(k)},children:E},k))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:k=>k.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+ur(f),onClick:()=>{m(k=>!k),d(!1)},children:l?h(l)+"…":f?h(f):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([k,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":f===k,className:"rsopt"+(f===k?" on":"")+(l===k?" busy":""),disabled:!!l,onClick:()=>{if(k===f){m(!1);return}v(k)},children:[t.jsx("i",{className:"pt2",style:{background:el[ur(k)]}}),E]},k))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{i(e),d(!1),m(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{p("Analysé");const k=await o(e,"Analysé");p(""),k&&(d(!1),m(!1))})()},children:a.csAnaAnyway})]})})]})}function al({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=W(),[i,s]=u.useState(""),[l,p]=u.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(wt(e)||"").startsWith("CALL")&&Ne(e)===3,x=Ne(e)>=2,m=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(f);const v=await o(e,f);s(""),v&&(p(!0),setTimeout(()=>p(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:ho.filter(([f])=>!(x&&f==="Retenu")).map(([f,v])=>[f,a[v]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([f,v])=>t.jsx("button",{type:"button",className:"csb"+(g===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{m(f)},children:v},f)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(nl,{o:e})]})}function nl({o:e}){const{t:a,saveNote:r,flash:n}=W(),[o,i]=u.useState(e.ceoNote||""),[s,l]=u.useState(!1),[p,g]=u.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(s||!d)return;l(!0);const m=await r(e,o.trim());l(!1),m&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:m=>i(m.target.value),onKeyDown:m=>{m.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:s||!d,onClick:()=>{x()},children:p?a.csNoteSaved:a.csNoteOk})]})}function rl({placeholder:e,onDone:a}){const{t:r}=W(),[n,o]=u.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ol({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:s,flashErr:l}=W(),[p,g]=u.useState(!1);if(!n.pipe||!o||n.lockActions||Ne(e)!==4)return null;const d=i(e),x=(d==null?void 0:d.stage)||"todo",m=async h=>{if(p||h===x)return;g(!0);const k=d;s(e,{stage:h,stamps:(d==null?void 0:d.stamps)||{}});const E=Math.max(Date.now(),mr+=1);mr=E;const w=await Ni(r,{company:e.name||"",stage:h,cts:E,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(s(e,k),l(a.actErr)))},b=(y=d==null?void 0:d.stamps)==null?void 0:y.sent,f=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=x==="sent"&&b&&f>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,k])=>t.jsx("button",{type:"button",className:"stgb"+(x===h?" on":""),disabled:p,onClick:()=>{m(h)},children:k},h)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let mr=0;const Wt=8,vt=360;function fr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function hr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(fr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(fr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function il({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=W(),[s,l]=u.useState(0),[p,g]=u.useState(null),[d,x]=u.useState([]),m=u.useRef(!1),b=u.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),f=u.useRef(!1);u.useEffect(()=>{const C=b.current;return()=>{f.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),u.useEffect(()=>{m.current||(m.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const v=d[s],y=s>=d.length;u.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const C=v.click,L=window.setTimeout(()=>{const z=document.querySelector(C);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(L)}},[s,v]);const h=u.useRef(-1),k=u.useCallback(()=>{if(!v){g(null);return}const C=M=>{if(!M)return null;for(const D of document.querySelectorAll(M)){const $=D.getBoundingClientRect();if($.width>1&&$.height>1)return D}return null},L=C(v.sel)||C(v.need);if(!L){g(null);return}h.current!==s&&(h.current=s,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const z=L.getBoundingClientRect();g(M=>M&&Math.abs(M.top-z.top)<1&&Math.abs(M.left-z.left)<1&&Math.abs(M.width-z.width)<1&&Math.abs(M.height-z.height)<1?M:z)},[v,s]);u.useLayoutEffect(()=>{k();const C=[90,300,700,1300].map(M=>window.setTimeout(k,M)),L=window.setInterval(k,400),z=()=>k();return window.addEventListener("scroll",z,!0),window.addEventListener("resize",z),()=>{C.forEach(M=>window.clearTimeout(M)),window.clearInterval(L),window.removeEventListener("scroll",z,!0),window.removeEventListener("resize",z)}},[k]);const E=u.useRef(a);if(E.current=a,u.useEffect(()=>{const C=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),E.current()):L.key==="ArrowRight"?l(z=>z+1):L.key==="ArrowLeft"&&l(z=>Math.max(0,z-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!d.length)return null;let w=null;const N=C=>()=>{f.current=!0,n({type:"modal",modal:null}),C()};if(y){const C=o[3]||0;C>0?w={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?w={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?w={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let q={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:vt};if(!y&&p){const C=p.bottom+14,L=window.innerHeight-C;let z=L>190?C:Math.max(12,p.top-200),M=Math.min(Math.max(12,p.left+p.width/2-vt/2),window.innerWidth-vt-12);L<=190&&p.top<212&&(window.innerWidth-p.right>=vt+40?M=Math.min(p.right+26,window.innerWidth-vt-12):p.left>=vt+40&&(M=Math.max(12,p.left-vt-26)),z=Math.max(12,p.top-Wt)),q={left:M,top:z,width:vt}}return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-Wt,top:p.top-Wt,width:p.width+Wt*2,height:p.height+Wt*2}}),(y||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:q,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(hr,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(hr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(C=>C+1),children:s===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function xo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function go(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function sl(){var L,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:s,data:l,dispatch:p}=W(),g=r?a:e,d=u.useMemo(()=>g.filter(M=>ht(M.date)===0&&M.kind==="target"),[g]),x=u.useMemo(()=>r?a.filter(M=>M.kind==="target"&&Ne(M)===0).slice().sort((M,D)=>(D.date||"").localeCompare(M.date||"")):[],[a,r]),m=u.useMemo(()=>d.filter(M=>r?Ne(M)===0:!Ie(M)),[d,r]),b=r?x:m,f=r?a.length-x.length:d.length-m.length,v=r?a.length:d.length,y=v?Math.min(100,f/v*100):100,h=u.useMemo(()=>xo(g),[g]),k=!!h&&ht(h)>0,E=u.useMemo(()=>k?g.filter(M=>(M.date||"").slice(0,10)===h):[],[g,h,k]),w=typeof((L=l.stats)==null?void 0:L.kept_today)=="number"?l.stats.kept_today:null,N=typeof((z=l.stats)==null?void 0:z.screened_today)=="number"?l.stats.screened_today:d.length;let q;k?q=o.morningLast(E.length,x.length,go(h,s)):r?q=o.morningThesis(N,x.length,w):d.length?f===0?q=o.goalSourced(d.length):f>=d.length?q=o.goalCleared:q=o.goalDone(f,d.length):q=o.goalSourced(0);const C=()=>{if(!r){p({type:"pile",on:!0});return}p({type:"ptab",tab:0}),n==="client"&&x.length&&p({type:"chainStart",queue:x.map(M=>M.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:q}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ll(){var T,B;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:s,dossiers:l,mode:p,doSync:g,startTour:d,flash:x,flashErr:m}=W(),[b,f]=u.useState(null),[v,y]=u.useState(!0),[h,k]=u.useState([]),E=p==="client";u.useEffect(()=>{if(!o||!i)return;let P=!0;return y(!0),(async()=>{const[F,_]=await Promise.all([En(i),eo(o)]);P&&(F&&f(F),y(!1),k(_))})(),()=>{P=!1}},[o,i]);const[w,N]=u.useState(!1),q=()=>{!E||w||!i||(N(!0),Ei(i).then(P=>{N(!1),P?x(e.identRepubDone):m(e.actErr)}))},C=(b==null?void 0:b.per_day)??null,L=((T=b==null?void 0:b.pool_order)==null?void 0:T.length)??0,z=h.filter(P=>P.status==="running").length,M=u.useMemo(()=>l.filter(P=>P.kind==="target"&&Ie(P)).length,[l]),D=s.marketEstimate,$=typeof((B=s.stats)==null?void 0:B.screened)=="number"?s.stats.screened:M,R=D&&D>0?Math.min(100,Math.round($/D*100)):null,O=P=>P.toLocaleString(a==="en"?"en-US":"fr-FR"),c=(i||"P").split(/\s+/).map(P=>P[0]).join("").slice(0,2).toUpperCase(),j=(()=>{const P=Date.parse(s.generatedAt||"");if(Number.isNaN(P))return"";const F=new Date(P),_=G=>String(G).padStart(2,"0");return`${_(F.getDate())}/${_(F.getMonth()+1)} à ${_(F.getHours())}:${_(F.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?c:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),j?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(j)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[R===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:O($)})})]}),R!==null&&D&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:R+"%"}})}),t.jsxs("b",{children:[R," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,D)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:P=>{P.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||w,onClick:q,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:P=>n({type:"filters",patch:{search:P.target.value}})})]})]})]})}class qt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],s=a+i,l=Math.abs(a)<Math.abs(i)?a-(s-i):i-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,o=a[--r],s=n+o,i=o-(s-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=s+o,o==n-s&&(s=n))}return s}}function*dl(e){for(const a of e)yield*a}function bo(e){return Array.from(dl(e))}var we=1e-6,ue=Math.PI,et=ue/2,xr=ue/4,at=ue*2,mt=180/ue,Ye=ue/180,ze=Math.abs,cl=Math.atan,ta=Math.atan2,Te=Math.cos,Le=Math.sin,pl=Math.sign||function(e){return e>0?1:e<0?-1:0},Lt=Math.sqrt;function ul(e){return e>1?0:e<-1?ue:Math.acos(e)}function aa(e){return e>1?et:e<-1?-et:Math.asin(e)}function tt(){}function Aa(e,a){e&&br.hasOwnProperty(e.type)&&br[e.type](e,a)}var gr={Feature:function(e,a){Aa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Aa(r[n].geometry,a)}},br={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ln(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ln(r[n],a,0)},Polygon:function(e,a){vr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)vr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Aa(r[n],a)}};function ln(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function vr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ln(e[r],a,1);a.polygonEnd()}function Mt(e,a){e&&gr.hasOwnProperty(e.type)?gr[e.type](e,a):Aa(e,a)}function dn(e){return[ta(e[1],e[0]),aa(e[2])]}function It(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*Le(a),Le(r)]}function ua(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ya(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ma(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function cn(e){var a=Lt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function pn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function un(e,a){return ze(e)>ue&&(e-=Math.round(e/at)*at),[e,a]}un.invert=un;function ml(e,a,r){return(e%=at)?a||r?pn(wr(e),kr(a,r)):wr(e):a||r?kr(a,r):un}function yr(e){return function(a,r){return a+=e,ze(a)>ue&&(a-=Math.round(a/at)*at),[a,r]}}function wr(e){var a=yr(e);return a.invert=yr(-e),a}function kr(e,a){var r=Te(e),n=Le(e),o=Te(a),i=Le(a);function s(l,p){var g=Te(p),d=Te(l)*g,x=Le(l)*g,m=Le(p),b=m*r+d*n;return[ta(x*o-b*i,d*r-m*n),aa(b*o+x*i)]}return s.invert=function(l,p){var g=Te(p),d=Te(l)*g,x=Le(l)*g,m=Le(p),b=m*o-x*i;return[ta(x*o+m*i,d*r+b*n),aa(b*r-d*n)]},s}function fl(e,a,r,n,o,i){if(r){var s=Te(a),l=Le(a),p=n*r;o==null?(o=a+n*at,i=a-p/2):(o=jr(s,o),i=jr(s,i),(n>0?o<i:o>i)&&(o+=n*at));for(var g,d=o;n>0?d>i:d<i;d-=p)g=dn([s,-l*Te(d),-l*Le(d)]),e.point(g[0],g[1])}}function jr(e,a){a=It(a),a[0]-=e,cn(a);var r=ul(-a[1]);return((-a[2]<0?-r:r)+at-we)%at}function vo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:tt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function wa(e,a){return ze(e[0]-a[0])<we&&ze(e[1]-a[1])<we}function fa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function yo(e,a,r,n,o){var i=[],s=[],l,p;if(e.forEach(function(f){if(!((v=f.length-1)<=0)){var v,y=f[0],h=f[v],k;if(wa(y,h)){if(!y[2]&&!h[2]){for(o.lineStart(),l=0;l<v;++l)o.point((y=f[l])[0],y[1]);o.lineEnd();return}h[0]+=2*we}i.push(k=new fa(y,f,null,!0)),s.push(k.o=new fa(y,null,k,!1)),i.push(k=new fa(h,f,null,!1)),s.push(k.o=new fa(h,null,k,!0))}}),!!i.length){for(s.sort(a),Nr(i),Nr(s),l=0,p=s.length;l<p;++l)s[l].e=r=!r;for(var g=i[0],d,x;;){for(var m=g,b=!0;m.v;)if((m=m.n)===g)return;d=m.z,o.lineStart();do{if(m.v=m.o.v=!0,m.e){if(b)for(l=0,p=d.length;l<p;++l)o.point((x=d[l])[0],x[1]);else n(m.x,m.n.x,1,o);m=m.n}else{if(b)for(d=m.p.z,l=d.length-1;l>=0;--l)o.point((x=d[l])[0],x[1]);else n(m.x,m.p.x,-1,o);m=m.p}m=m.o,d=m.z,b=!b}while(!m.v);o.lineEnd()}}}function Nr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Qa(e){return ze(e[0])<=ue?e[0]:pl(e[0])*((ze(e[0])+ue)%at-ue)}function hl(e,a){var r=Qa(a),n=a[1],o=Le(n),i=[Le(r),-Te(r),0],s=0,l=0,p=new qt;o===1?n=et+we:o===-1&&(n=-et-we);for(var g=0,d=e.length;g<d;++g)if(m=(x=e[g]).length)for(var x,m,b=x[m-1],f=Qa(b),v=b[1]/2+xr,y=Le(v),h=Te(v),k=0;k<m;++k,f=w,y=q,h=C,b=E){var E=x[k],w=Qa(E),N=E[1]/2+xr,q=Le(N),C=Te(N),L=w-f,z=L>=0?1:-1,M=z*L,D=M>ue,$=y*q;if(p.add(ta($*z*Le(M),h*C+$*Te(M))),s+=D?L+z*at:L,D^f>=r^w>=r){var R=qa(It(b),It(E));cn(R);var O=qa(i,R);cn(O);var c=(D^L>=0?-1:1)*aa(O[2]);(n>c||n===c&&(R[0]||R[1]))&&(l+=D^L>=0?1:-1)}}return(s<-we||s<we&&p<-1e-12)^l&1}function wo(e,a,r,n){return function(o){var i=a(o),s=vo(),l=a(s),p=!1,g,d,x,m={point:b,lineStart:v,lineEnd:y,polygonStart:function(){m.point=h,m.lineStart=k,m.lineEnd=E,d=[],g=[]},polygonEnd:function(){m.point=b,m.lineStart=v,m.lineEnd=y,d=bo(d);var w=hl(g,n);d.length?(p||(o.polygonStart(),p=!0),yo(d,gl,w,r,o)):w&&(p||(o.polygonStart(),p=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),p&&(o.polygonEnd(),p=!1),d=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(w,N){e(w,N)&&o.point(w,N)}function f(w,N){i.point(w,N)}function v(){m.point=f,i.lineStart()}function y(){m.point=b,i.lineEnd()}function h(w,N){x.push([w,N]),l.point(w,N)}function k(){l.lineStart(),x=[]}function E(){h(x[0][0],x[0][1]),l.lineEnd();var w=l.clean(),N=s.result(),q,C=N.length,L,z,M;if(x.pop(),g.push(x),x=null,!!C){if(w&1){if(z=N[0],(L=z.length-1)>0){for(p||(o.polygonStart(),p=!0),o.lineStart(),q=0;q<L;++q)o.point((M=z[q])[0],M[1]);o.lineEnd()}return}C>1&&w&2&&N.push(N.pop().concat(N.shift())),d.push(N.filter(xl))}}return m}}function xl(e){return e.length>1}function gl(e,a){return((e=e.x)[0]<0?e[1]-et-we:et-e[1])-((a=a.x)[0]<0?a[1]-et-we:et-a[1])}const Er=wo(function(){return!0},bl,yl,[-ue,-et]);function bl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,s){var l=i>0?ue:-ue,p=ze(i-a);ze(p-ue)<we?(e.point(a,r=(r+s)/2>0?et:-et),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&p>=ue&&(ze(a-n)<we&&(a-=n*we),ze(i-l)<we&&(i-=l*we),r=vl(a,r,i,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function vl(e,a,r,n){var o,i,s=Le(e-r);return ze(s)>we?cl((Le(a)*(i=Te(n))*Le(r)-Le(n)*(o=Te(a))*Le(e))/(o*i*s)):(a+n)/2}function yl(e,a,r,n){var o;if(e==null)o=r*et,n.point(-ue,o),n.point(0,o),n.point(ue,o),n.point(ue,0),n.point(ue,-o),n.point(0,-o),n.point(-ue,-o),n.point(-ue,0),n.point(-ue,o);else if(ze(e[0]-a[0])>we){var i=e[0]<a[0]?ue:-ue;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function wl(e){var a=Te(e),r=2*Ye,n=a>0,o=ze(a)>we;function i(d,x,m,b){fl(b,e,r,m,d,x)}function s(d,x){return Te(d)*Te(x)>a}function l(d){var x,m,b,f,v;return{lineStart:function(){f=b=!1,v=1},point:function(y,h){var k=[y,h],E,w=s(y,h),N=n?w?0:g(y,h):w?g(y+(y<0?ue:-ue),h):0;if(!x&&(f=b=w)&&d.lineStart(),w!==b&&(E=p(x,k),(!E||wa(x,E)||wa(k,E))&&(k[2]=1)),w!==b)v=0,w?(d.lineStart(),E=p(k,x),d.point(E[0],E[1])):(E=p(x,k),d.point(E[0],E[1],2),d.lineEnd()),x=E;else if(o&&x&&n^w){var q;!(N&m)&&(q=p(k,x,!0))&&(v=0,n?(d.lineStart(),d.point(q[0][0],q[0][1]),d.point(q[1][0],q[1][1]),d.lineEnd()):(d.point(q[1][0],q[1][1]),d.lineEnd(),d.lineStart(),d.point(q[0][0],q[0][1],3)))}w&&(!x||!wa(x,k))&&d.point(k[0],k[1]),x=k,b=w,m=N},lineEnd:function(){b&&d.lineEnd(),x=null},clean:function(){return v|(f&&b)<<1}}}function p(d,x,m){var b=It(d),f=It(x),v=[1,0,0],y=qa(b,f),h=ua(y,y),k=y[0],E=h-k*k;if(!E)return!m&&d;var w=a*h/E,N=-a*k/E,q=qa(v,y),C=ma(v,w),L=ma(y,N);Ya(C,L);var z=q,M=ua(C,z),D=ua(z,z),$=M*M-D*(ua(C,C)-1);if(!($<0)){var R=Lt($),O=ma(z,(-M-R)/D);if(Ya(O,C),O=dn(O),!m)return O;var c=d[0],j=x[0],T=d[1],B=x[1],P;j<c&&(P=c,c=j,j=P);var F=j-c,_=ze(F-ue)<we,G=_||F<we;if(!_&&B<T&&(P=T,T=B,B=P),G?_?T+B>0^O[1]<(ze(O[0]-c)<we?T:B):T<=O[1]&&O[1]<=B:F>ue^(c<=O[0]&&O[0]<=j)){var J=ma(z,(-M+R)/D);return Ya(J,C),[O,dn(J)]}}}function g(d,x){var m=n?e:ue-e,b=0;return d<-m?b|=1:d>m&&(b|=2),x<-m?b|=4:x>m&&(b|=8),b}return wo(s,l,i,n?[0,-e]:[-ue,e-ue])}function kl(e,a,r,n,o,i){var s=e[0],l=e[1],p=a[0],g=a[1],d=0,x=1,m=p-s,b=g-l,f;if(f=r-s,!(!m&&f>0)){if(f/=m,m<0){if(f<d)return;f<x&&(x=f)}else if(m>0){if(f>x)return;f>d&&(d=f)}if(f=o-s,!(!m&&f<0)){if(f/=m,m<0){if(f>x)return;f>d&&(d=f)}else if(m>0){if(f<d)return;f<x&&(x=f)}if(f=n-l,!(!b&&f>0)){if(f/=b,b<0){if(f<d)return;f<x&&(x=f)}else if(b>0){if(f>x)return;f>d&&(d=f)}if(f=i-l,!(!b&&f<0)){if(f/=b,b<0){if(f>x)return;f>d&&(d=f)}else if(b>0){if(f<d)return;f<x&&(x=f)}return d>0&&(e[0]=s+d*m,e[1]=l+d*b),x<1&&(a[0]=s+x*m,a[1]=l+x*b),!0}}}}}var Gt=1e9,ha=-Gt;function jl(e,a,r,n){function o(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function i(g,d,x,m){var b=0,f=0;if(g==null||(b=s(g,x))!==(f=s(d,x))||p(g,d)<0^x>0)do m.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==f);else m.point(d[0],d[1])}function s(g,d){return ze(g[0]-e)<we?d>0?0:3:ze(g[0]-r)<we?d>0?2:1:ze(g[1]-a)<we?d>0?1:0:d>0?3:2}function l(g,d){return p(g.x,d.x)}function p(g,d){var x=s(g,1),m=s(d,1);return x!==m?x-m:x===0?d[1]-g[1]:x===1?g[0]-d[0]:x===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,x=vo(),m,b,f,v,y,h,k,E,w,N,q,C={point:L,lineStart:$,lineEnd:R,polygonStart:M,polygonEnd:D};function L(c,j){o(c,j)&&d.point(c,j)}function z(){for(var c=0,j=0,T=b.length;j<T;++j)for(var B=b[j],P=1,F=B.length,_=B[0],G,J,X=_[0],ge=_[1];P<F;++P)G=X,J=ge,_=B[P],X=_[0],ge=_[1],J<=n?ge>n&&(X-G)*(n-J)>(ge-J)*(e-G)&&++c:ge<=n&&(X-G)*(n-J)<(ge-J)*(e-G)&&--c;return c}function M(){d=x,m=[],b=[],q=!0}function D(){var c=z(),j=q&&c,T=(m=bo(m)).length;(j||T)&&(g.polygonStart(),j&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),T&&yo(m,l,c,i,g),g.polygonEnd()),d=g,m=b=f=null}function $(){C.point=O,b&&b.push(f=[]),N=!0,w=!1,k=E=NaN}function R(){m&&(O(v,y),h&&w&&x.rejoin(),m.push(x.result())),C.point=L,w&&d.lineEnd()}function O(c,j){var T=o(c,j);if(b&&f.push([c,j]),N)v=c,y=j,h=T,N=!1,T&&(d.lineStart(),d.point(c,j));else if(T&&w)d.point(c,j);else{var B=[k=Math.max(ha,Math.min(Gt,k)),E=Math.max(ha,Math.min(Gt,E))],P=[c=Math.max(ha,Math.min(Gt,c)),j=Math.max(ha,Math.min(Gt,j))];kl(B,P,e,a,r,n)?(w||(d.lineStart(),d.point(B[0],B[1])),d.point(P[0],P[1]),T||d.lineEnd(),q=!1):T&&(d.lineStart(),d.point(c,j),q=!1)}k=c,E=j,w=T}return C}}const mn=e=>e;var Ka=new qt,fn=new qt,ko,jo,hn,xn,ft={point:tt,lineStart:tt,lineEnd:tt,polygonStart:function(){ft.lineStart=Nl,ft.lineEnd=Sl},polygonEnd:function(){ft.lineStart=ft.lineEnd=ft.point=tt,Ka.add(ze(fn)),fn=new qt},result:function(){var e=Ka/2;return Ka=new qt,e}};function Nl(){ft.point=El}function El(e,a){ft.point=No,ko=hn=e,jo=xn=a}function No(e,a){fn.add(xn*e-hn*a),hn=e,xn=a}function Sl(){No(ko,jo)}var Pt=1/0,Ta=Pt,na=-Pt,La=na,Ra={point:Cl,lineStart:tt,lineEnd:tt,polygonStart:tt,polygonEnd:tt,result:function(){var e=[[Pt,Ta],[na,La]];return na=La=-(Ta=Pt=1/0),e}};function Cl(e,a){e<Pt&&(Pt=e),e>na&&(na=e),a<Ta&&(Ta=a),a>La&&(La=a)}var gn=0,bn=0,Yt=0,Fa=0,Ma=0,Ot=0,vn=0,yn=0,Qt=0,Eo,So,ct,pt,Ze={point:Tt,lineStart:Sr,lineEnd:Cr,polygonStart:function(){Ze.lineStart=ql,Ze.lineEnd=Tl},polygonEnd:function(){Ze.point=Tt,Ze.lineStart=Sr,Ze.lineEnd=Cr},result:function(){var e=Qt?[vn/Qt,yn/Qt]:Ot?[Fa/Ot,Ma/Ot]:Yt?[gn/Yt,bn/Yt]:[NaN,NaN];return gn=bn=Yt=Fa=Ma=Ot=vn=yn=Qt=0,e}};function Tt(e,a){gn+=e,bn+=a,++Yt}function Sr(){Ze.point=zl}function zl(e,a){Ze.point=Al,Tt(ct=e,pt=a)}function Al(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Ot+=o,Tt(ct=e,pt=a)}function Cr(){Ze.point=Tt}function ql(){Ze.point=Ll}function Tl(){Co(Eo,So)}function Ll(e,a){Ze.point=Co,Tt(Eo=ct=e,So=pt=a)}function Co(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Ot+=o,o=pt*e-ct*a,vn+=o*(ct+e),yn+=o*(pt+a),Qt+=o*3,Tt(ct=e,pt=a)}function zo(e){this._context=e}zo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,at);break}}},result:tt};var wn=new qt,Ja,Ao,qo,Kt,Jt,ra={point:tt,lineStart:function(){ra.point=Rl},lineEnd:function(){Ja&&To(Ao,qo),ra.point=tt},polygonStart:function(){Ja=!0},polygonEnd:function(){Ja=null},result:function(){var e=+wn;return wn=new qt,e}};function Rl(e,a){ra.point=To,Ao=Kt=e,qo=Jt=a}function To(e,a){Kt-=e,Jt-=a,wn.add(Lt(Kt*Kt+Jt*Jt)),Kt=e,Jt=a}let zr,Oa,Ar,qr;class Tr{constructor(a){this._append=a==null?Lo:Fl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Ar||this._append!==Oa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Ar=n,Oa=this._append,qr=this._,this._=o}this._+=qr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Lo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Fl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Lo;if(a!==zr){const r=10**a;zr=a,Oa=function(o){let i=1;this._+=o[0];for(const s=o.length;i<s;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Oa}function Ml(e,a){let r=3,n=4.5,o,i;function s(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Mt(l,o(i))),i.result()}return s.area=function(l){return Mt(l,o(ft)),ft.result()},s.measure=function(l){return Mt(l,o(ra)),ra.result()},s.bounds=function(l){return Mt(l,o(Ra)),Ra.result()},s.centroid=function(l){return Mt(l,o(Ze)),Ze.result()},s.projection=function(l){return arguments.length?(o=l==null?(e=null,mn):(e=l).stream,s):e},s.context=function(l){return arguments.length?(i=l==null?(a=null,new Tr(r)):new zo(a=l),typeof n!="function"&&i.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const p=Math.floor(l);if(!(p>=0))throw new RangeError(`invalid digits: ${l}`);r=p}return a===null&&(i=new Tr(r)),s},s.projection(e).digits(r).context(a)}function Tn(e){return function(a){var r=new kn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function kn(){}kn.prototype={constructor:kn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ln(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Mt(r,e.stream(Ra)),a(Ra.result()),n!=null&&e.clipExtent(n),e}function Ro(e,a,r){return Ln(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],s=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-s*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(i-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,p])},r)}function Ol(e,a,r){return Ro(e,[[0,0],a],r)}function Dl(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),s=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([s,l])},r)}function Il(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),s=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([s,l])},r)}var Lr=16,Pl=Te(30*Ye);function Rr(e,a){return+a?_l(e,a):Bl(e)}function Bl(e){return Tn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function _l(e,a){function r(n,o,i,s,l,p,g,d,x,m,b,f,v,y){var h=g-n,k=d-o,E=h*h+k*k;if(E>4*a&&v--){var w=s+m,N=l+b,q=p+f,C=Lt(w*w+N*N+q*q),L=aa(q/=C),z=ze(ze(q)-1)<we||ze(i-x)<we?(i+x)/2:ta(N,w),M=e(z,L),D=M[0],$=M[1],R=D-n,O=$-o,c=k*R-h*O;(c*c/E>a||ze((h*R+k*O)/E-.5)>.3||s*m+l*b+p*f<Pl)&&(r(n,o,i,s,l,p,D,$,z,w/=C,N/=C,q,v,y),y.point(D,$),r(D,$,z,w,N,q,g,d,x,m,b,f,v,y))}}return function(n){var o,i,s,l,p,g,d,x,m,b,f,v,y={point:h,lineStart:k,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=N},polygonEnd:function(){n.polygonEnd(),y.lineStart=k}};function h(L,z){L=e(L,z),n.point(L[0],L[1])}function k(){x=NaN,y.point=E,n.lineStart()}function E(L,z){var M=It([L,z]),D=e(L,z);r(x,m,d,b,f,v,x=D[0],m=D[1],d=L,b=M[0],f=M[1],v=M[2],Lr,n),n.point(x,m)}function w(){y.point=h,n.lineEnd()}function N(){k(),y.point=q,y.lineEnd=C}function q(L,z){E(o=L,z),i=x,s=m,l=b,p=f,g=v,y.point=E}function C(){r(x,m,d,b,f,v,i,s,o,l,p,g,Lr,n),y.lineEnd=w,w()}return y}}var $l=Tn({point:function(e,a){this.stream.point(e*Ye,a*Ye)}});function Ul(e){return Tn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Hl(e,a,r,n,o){function i(s,l){return s*=n,l*=o,[a+e*s,r-e*l]}return i.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*o]},i}function Fr(e,a,r,n,o,i){if(!i)return Hl(e,a,r,n,o);var s=Te(i),l=Le(i),p=s*e,g=l*e,d=s/e,x=l/e,m=(l*r-s*a)/e,b=(l*a+s*r)/e;function f(v,y){return v*=n,y*=o,[p*v-g*y+a,r-g*v-p*y]}return f.invert=function(v,y){return[n*(d*v-x*y+m),o*(b-x*v-d*y)]},f}function Vl(e){return Wl(function(){return e})()}function Wl(e){var a,r=150,n=480,o=250,i=0,s=0,l=0,p=0,g=0,d,x=0,m=1,b=1,f=null,v=Er,y=null,h,k,E,w=mn,N=.5,q,C,L,z,M;function D(c){return L(c[0]*Ye,c[1]*Ye)}function $(c){return c=L.invert(c[0],c[1]),c&&[c[0]*mt,c[1]*mt]}D.stream=function(c){return z&&M===c?z:z=$l(Ul(d)(v(q(w(M=c)))))},D.preclip=function(c){return arguments.length?(v=c,f=void 0,O()):v},D.postclip=function(c){return arguments.length?(w=c,y=h=k=E=null,O()):w},D.clipAngle=function(c){return arguments.length?(v=+c?wl(f=c*Ye):(f=null,Er),O()):f*mt},D.clipExtent=function(c){return arguments.length?(w=c==null?(y=h=k=E=null,mn):jl(y=+c[0][0],h=+c[0][1],k=+c[1][0],E=+c[1][1]),O()):y==null?null:[[y,h],[k,E]]},D.scale=function(c){return arguments.length?(r=+c,R()):r},D.translate=function(c){return arguments.length?(n=+c[0],o=+c[1],R()):[n,o]},D.center=function(c){return arguments.length?(i=c[0]%360*Ye,s=c[1]%360*Ye,R()):[i*mt,s*mt]},D.rotate=function(c){return arguments.length?(l=c[0]%360*Ye,p=c[1]%360*Ye,g=c.length>2?c[2]%360*Ye:0,R()):[l*mt,p*mt,g*mt]},D.angle=function(c){return arguments.length?(x=c%360*Ye,R()):x*mt},D.reflectX=function(c){return arguments.length?(m=c?-1:1,R()):m<0},D.reflectY=function(c){return arguments.length?(b=c?-1:1,R()):b<0},D.precision=function(c){return arguments.length?(q=Rr(C,N=c*c),O()):Lt(N)},D.fitExtent=function(c,j){return Ro(D,c,j)},D.fitSize=function(c,j){return Ol(D,c,j)},D.fitWidth=function(c,j){return Dl(D,c,j)},D.fitHeight=function(c,j){return Il(D,c,j)};function R(){var c=Fr(r,0,0,m,b,x).apply(null,a(i,s)),j=Fr(r,n-c[0],o-c[1],m,b,x);return d=ml(l,p,g),C=pn(a,j),L=pn(d,C),q=Rr(C,N),O()}function O(){return z=M=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&$,R()}}function Fo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Fo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,s=i*i;r-=o=(r*(1.007226+i*(.015085+s*(-.044475+.028874*i-.005916*s)))-a)/(1.007226+i*(.015085*3+s*(-.044475*7+.028874*9*i-.005916*11*s)))}while(ze(o)>we&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Gl(){return Vl(Fo).scale(175.295)}function Yl(e){return e}function Ql(e){if(e==null)return Yl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],s=e.translate[1];return function(l,p){p||(a=r=0);var g=2,d=l.length,x=new Array(d);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+s;g<d;)x[g]=l[g],++g;return x}}function Kl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Jl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Mr(e,r)})}:Mr(e,a)}function Mr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Xl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Xl(e,a){var r=Ql(e.transform),n=e.arcs;function o(d,x){x.length&&x.pop();for(var m=n[d<0?~d:d],b=0,f=m.length;b<f;++b)x.push(r(m[b],b));d<0&&Kl(x,f)}function i(d){return r(d)}function s(d){for(var x=[],m=0,b=d.length;m<b;++m)o(d[m],x);return x.length<2&&x.push(x[0]),x}function l(d){for(var x=s(d);x.length<4;)x.push(x[0]);return x}function p(d){return d.map(l)}function g(d){var x=d.type,m;switch(x){case"GeometryCollection":return{type:x,geometries:d.geometries.map(g)};case"Point":m=i(d.coordinates);break;case"MultiPoint":m=d.coordinates.map(i);break;case"LineString":m=s(d.arcs);break;case"MultiLineString":m=d.arcs.map(s);break;case"Polygon":m=p(d.arcs);break;case"MultiPolygon":m=d.arcs.map(p);break;default:return null}return{type:x,coordinates:m}}return g(a)}const Mo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Zl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ed(e,a,r){const n=Mo[e];if(!n||!n.length)return-1;const o=Zl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(s=>o.includes(s)))return i}return Math.floor(r*n.length)%n.length}let xa=null;function td(){return xa||(xa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Jl(r,n),i=Gl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=Ml(i),l=(o.features||[]).filter(d=>{var x;return(((x=d.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(d=>{var b;const x=((b=d.properties)==null?void 0:b.name)||"",m=s(d)||"";return m?{i2:Si(x)||null,n:x,d:m}:null}).filter(d=>!!d);if(!l.length)return null;const p={};for(const[d,x]of Object.entries(Ci)){const m=i(x);m&&(p[d]={x:m[0],y:m[1]})}const g={};for(const[d,x]of Object.entries(Mo)){const m=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,f])=>({x:b,y:f}));m.length&&(g[d]=m)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:p,metros:g}}catch{return null}})(),xa)}function ad(e){const[a,r]=u.useState(null);return u.useEffect(()=>{if(!e||a)return;let n=!1;return td().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const nd="8 40 984 210",rd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Or=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Dr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function od(e,a){const[r,n]=u.useState(1);return u.useEffect(()=>{let o=!0,i=0;const s=()=>{var g;if(!o)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):i=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function Ir({msgs:e}){const[a,r]=u.useState(0);u.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],s)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function id(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:s,lang:l,t:p,data:g,dossiers:d,source:x}=W(),m=g.loading&&!d.length,b=u.useRef(null),f=u.useRef(null),v=ad(e.continent==="monde"),y=e.continent==="monde"?v:Sn.find(c=>c.key===e.continent)||null,h=od(b,e.continent+":"+e.mapFolded+":"+!!y),[k,E]=u.useState(new Map),[w,N]=u.useState(null);u.useEffect(()=>{const c=b.current;if(!c)return;const j=new Map;c.querySelectorAll("path[data-i2]").forEach(T=>{const B=T.dataset.i2;if(B)try{const P=T.getBBox();P.width>0&&j.set(B,{x:P.x,y:P.y,w:P.width,h:P.height})}catch{}}),E(j)},[e.continent,h,y]);const q=u.useMemo(()=>r.filter(c=>c.cc),[r]),C=u.useMemo(()=>{const c=new Map;return q.forEach(j=>c.set(j.cc,(c.get(j.cc)||0)+1)),c},[q]),L=e.continent==="monde"&&v?v.anchors:null,z=e.continent==="monde"&&v?v.metros:null,M=u.useMemo(()=>q.map(c=>{const j=Dr(c.name||c.id||""),T=Dr((c.id||c.name||"")+"·y");if(L&&c.cc){const G=z?z[c.cc]:void 0;if(G&&G.length){const X=ed(c.cc,c.city,j);if(X>=0&&G[X])return{d:c,x:G[X].x+(j-.5)*5,y:G[X].y+(T-.5)*5}}const J=L[c.cc];if(J)return{d:c,x:J.x+(j-.5)*10,y:J.y+(T-.5)*10}}const B=c.cc?k.get(c.cc):void 0;if(!B)return null;const P=rd[`${e.continent}:${c.cc||""}`];if(P)return{d:c,x:B.x+B.w*(P.fx+(j-.5)*P.sx),y:B.y+B.h*(P.fy+(T-.5)*P.sy)};const F=(j-.5)*Math.min(B.w*.55,60),_=(T-.5)*Math.min(B.h*.55,60);return{d:c,x:B.x+B.w/2+F,y:B.y+B.h/2+_}}).filter(c=>!!c),[q,k,L,z,e.continent]),D=c=>h>0?c/h:c,$=u.useMemo(()=>n?[0,1,2,3,4,5].map(c=>({c:Or[c],fr:p.plabels[c].toUpperCase(),en:p.plabels[c].toUpperCase(),n:r.filter(j=>j.kind==="target"&&Ne(j)===c).length})).filter(c=>c.n>0):Vn.map((c,j)=>({...c,n:r.filter(T=>Wn(T)===j).length})),[r,n,p.plabels]),R=i?s.get(i):null,O=R?M.find(c=>c.d.id===R.id):null;return y?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:f,children:[m&&t.jsx(Ir,{msgs:p.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?nd:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?y.fr:y.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:y.countries.map((c,j)=>t.jsx("g",{className:"ct"+(c.i2&&C.get(c.i2)?"":" empty"),children:t.jsx("path",{d:c.d,"data-i2":c.i2||void 0})},j))}),t.jsx("g",{children:M.map(c=>{const j=Vn[Wn(c.d)],T=!!Me(c.d),B=c.d.kind==="target",P=n&&B?Or[Ne(c.d)]:j.c,F=!n&&Ie(c.d);return t.jsxs("g",{className:"co"+(F?" done":""),onMouseEnter:()=>{var J,X;const _=(J=f.current)==null?void 0:J.getBoundingClientRect(),G=(X=b.current)==null?void 0:X.createSVGPoint();if(G&&b.current&&_){G.x=c.x,G.y=c.y;const ge=G.matrixTransform(b.current.getScreenCTM());N({x:ge.x-_.left,y:ge.y-_.top,label:c.d.name+" · "+($t(c.d.cc,l)||c.d.countryLabel||"")})}o(c.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var J;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:c.d.id}),(c.d.noCo||["media","nominations","recrutements"].includes(c.d.engine||""))&&(c.d.url||c.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:c.d.url||"",text:[c.d.headline,c.d.tagline].filter(Boolean).join(`
`)}})):c.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:c.d.name,url:c.d.url||"",website:c.d.website||"",domain:c.d.domain||""}}));return}const _=(J=b.current)==null?void 0:J.createSVGPoint();let G=null;if(_&&b.current){_.x=c.x,_.y=c.y;const X=_.matrixTransform(b.current.getScreenCTM());G={x:X.x,y:X.y}}a({type:"popup",id:c.d.id,anchor:G})},children:[t.jsx("circle",{className:"h",cx:c.x,cy:c.y,r:D(Math.max(11,j.px+7))}),t.jsx("circle",{className:"v",cx:c.x,cy:c.y,r:D(j.px),fill:P,stroke:T?"#DC2626":"#ffffff",strokeWidth:D(T?2.2:1.3)})]},c.d.id||c.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:D(13),fill:"none",stroke:"#0F172A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:$.map((c,j)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":c.c}}),l==="fr"?c.fr:c.en," ",t.jsx("b",{children:c.n})]},j))}),r.some(c=>!c.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(c=>!c.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:f,children:t.jsx(Ir,{msgs:p.loadMsgs})})}function sd(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Oo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:s,lang:l}=W(),p=a.filters,[g,d]=u.useState(!1),[x,m]=u.useState(!1),b=u.useRef(null),f=u.useRef(null),v=u.useMemo(()=>a.continent==="monde"?n:n.filter(O=>O.continent===a.continent),[n,a.continent]),y=O=>v.filter(c=>O!=="country"&&p.country.length&&!p.country.includes(c.cc||"")?!1:Ca(c,p,i,O==="country"?void 0:O)),h=O=>!i||O.kind!=="op",k=u.useMemo(()=>{const O=y("win").filter(h),c=j=>O.filter(T=>(T.date?Math.max(0,Math.floor((Date.now()-Date.parse(T.date))/864e5)):9999)<=j).length;return[c(0),c(7),c(30),O.length]},[v,p,i]),E=u.useMemo(()=>p.day?y("win").filter(h).filter(O=>(O.date||"").slice(0,10)===p.day).length:0,[v,p,i]),w=(p.signalOnly?1:0)+p.sector.length+p.country.length+p.engine.length+p.stage.length+p.angle.length+p.memoLevel.length,N=w+(p.acquirer.trim()?1:0)+(p.day||p.win!=="all"?1:0)+(p.search.trim()?1:0);u.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),u.useEffect(()=>{if(!g&&!x)return;const O=j=>{var B,P;const T=j.target;g&&!((B=b.current)!=null&&B.contains(T))&&d(!1),x&&!((P=f.current)!=null&&P.contains(T))&&m(!1)},c=j=>{j.key==="Escape"&&(d(!1),m(!1))};return document.addEventListener("mousedown",O),document.addEventListener("keydown",c),()=>{document.removeEventListener("mousedown",O),document.removeEventListener("keydown",c)}},[g,x]);const q=(O,c,j,T="fbtn")=>t.jsxs("button",{type:"button",className:T,"aria-expanded":a.openFacet===O,onClick:()=>r({type:"openFacet",facet:O}),children:[t.jsx("span",{className:"fl",children:c}),j>0&&t.jsx("span",{className:"n",children:j}),t.jsx("span",{className:"cv",children:"▾"})]},O),C=["1","7","30","all"],L=Math.max(0,C.indexOf(p.win||"all")),z=p.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(sd(p.day,l))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:f,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>m(O=>!O),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:k[L]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((O,c)=>t.jsxs("button",{type:"button",role:"option","aria-selected":p.win===O,onClick:()=>{r({type:"filters",patch:{win:O}}),m(!1)},children:[o.datesShort[c],t.jsx("span",{className:"n",children:k[c]})]},O))})]}):t.jsx("div",{className:"seg",children:C.map((O,c)=>t.jsxs("button",{type:"button","aria-pressed":p.win===O,onClick:()=>r({type:"filters",patch:{win:O}}),children:[t.jsx("span",{className:"sl",children:o.dates[c]}),t.jsx("b",{children:k[c]})]},O))}),M=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:p.search,onChange:O=>r({type:"filters",patch:{search:O.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),p.signalOnly&&t.jsx("span",{className:"n",children:p.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),p.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:p.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:p.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):q("sec",o.fSector,p.sector.length),q("pay",o.fCountry,p.country.length),q("det",o.fEngine,p.engine.length),q("sta",o.fStage,p.stage.length),i&&q("ang","Angle",p.angle.length),i&&q("mem","Mémo",p.memoLevel.length)]}),$=(O=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),O&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),R=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(w?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{d(O=>!O),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),w>0&&t.jsx("span",{className:"n",children:w}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(p.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:z}),t.jsxs("div",{className:"fstrip-b",children:[M,R,$(!1)]})]}),a.openFacet&&t.jsx(Pr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[z,M,D,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx(Pr,{poolFor:y})]})}function Pr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=W(),i=a.filters,s=a.openFacet,{title:l,cols:p,options:g}=u.useMemo(()=>{if(s==="sig"){const f=e("signal").filter(h=>Me(h)),v=new Map;f.forEach(h=>{const k=h.engine||"";v.set(k,(v.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:f.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...rn([...v.keys()],o).map(h=>({v:h,label:At(h)+" "+Qe(h,o),n:v.get(h)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="sec"){const f=e("sector"),v=new Map;return f.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y,n:h,html:!1,on:i.sector.includes(y)}))}}if(s==="pay"){const f=e("country"),v=new Map;return f.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:$t(y,o)||y,n:h,html:!1,on:i.country.includes(y)}))}}if(s==="det"){const f=e("engine"),v=new Map;return f.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:rn([...v.keys()],o).map(y=>({v:y,label:At(y)+" "+Qe(y,o)+' <span style="color:var(--dim);font-size:10px">· '+zi(Ai(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(s==="ang"){const f=e("angle"),v=new Map;return f.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y.replace(/[_-]+/g," "),n:h,html:!1,on:i.angle.includes(y)}))}}if(s==="mem"){const f=e("memoLevel"),v=new Map;f.forEach(h=>{if(h.kind==="target"){const k=Nn(h);v.set(k,(v.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:y[h],n:v.get(h)||0,html:!1,on:i.memoLevel.includes(h)}))}}const m=e("stage"),b=new Map;return m.forEach(f=>{f.stage&&b.set(f.stage,(b.get(f.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((f,v)=>v[1]-f[1]).map(([f,v])=>({v:f,label:f,n:v,html:!1,on:i.stage.includes(f)}))}},[s,a,o]),d=m=>{if(s==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const f=i.signalEngines.includes(m)?i.signalEngines.filter(v=>v!==m):[...i.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:m})},x=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>d(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Do({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:s,t:l}=W(),p=u.useMemo(()=>{const b={};return r.forEach(f=>{Ca(f,n.filters,i)&&(b.monde=(b.monde||0)+1,f.continent&&(b[f.continent]=(b[f.continent]||0)+1))}),b},[r,n.filters,i]),[g,d]=u.useState(!1),x=u.useRef(null);u.useEffect(()=>{if(!g)return;const b=v=>{var y;(y=x.current)!=null&&y.contains(v.target)||d(!1)},f=v=>{v.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",f),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",f)}},[g]);const m=b=>{const f=Sn.find(v=>v.key===b);return b==="monde"?l.contWorld:s==="fr"?f.fr:f.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>d(b=>!b),children:[m(n.continent),t.jsx("span",{className:"n",children:p[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Gn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),d(!1)},children:[m(b),t.jsx("span",{className:"n",children:p[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[Gn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[m(b),t.jsx("span",{className:"n",children:p[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function jn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function Io(e){return"atl2:evalq:"+(e||"anon")}function ld(e,a){const r=Io(e),n=jn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const s=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(s)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Po(){const{t:e,data:a,dossiers:r}=W(),n=a.session.token||"",o=Io(n),[i,s]=u.useState(()=>jn(o)),l=u.useRef(!1),[p,g]=u.useState(!1);u.useEffect(()=>{try{const c=i.slice(0,30).map(({descBusy:j,evalBusy:T,...B})=>B);localStorage.setItem(o,JSON.stringify(c)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[i,o]),u.useEffect(()=>{const c=()=>{if(l.current)return;const j=jn(o);s(T=>JSON.stringify(T.map(({descBusy:B,evalBusy:P,...F})=>F))===JSON.stringify(j)?T:j)};return window.addEventListener("atl2:evalq",c),window.addEventListener("storage",c),()=>{window.removeEventListener("atl2:evalq",c),window.removeEventListener("storage",c)}},[o]);const[d,x]=u.useState([]),[m,b]=u.useState(""),[f,v]=u.useState(!1),[y,h]=u.useState(!1),k=u.useCallback((c,j)=>s(T=>T.map((B,P)=>P===c?{...B,...j}:B)),[]),E=u.useCallback((c,j)=>{const T=j.trim();T&&(k(c,{name:T,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Cn(T).then(B=>{const P=B.candidates||[];B.website?k(c,{site:B.website,status:"ready"}):P.length===1?k(c,{site:P[0].url,status:"ready"}):P.length>1?k(c,{status:"pick",candidates:P.slice(0,4)}):k(c,{status:"ready"})}).catch(()=>k(c,{status:"ready"})))},[k]),w=u.useCallback((c,j,T)=>{k(c,{descBusy:!0}),to(n,j,T).then(B=>{if(B.quota){g(!0),k(c,{descBusy:!1,descDone:!0});return}const P=B.blocs||{},F=(P.synthese||P.value_prop||P.produit||P.modele||"").trim();k(c,{descBusy:!1,descDone:!0,desc:F})}).catch(()=>k(c,{descBusy:!1,descDone:!0}))},[k,n]);u.useEffect(()=>{const c=i.findIndex(T=>T.auto&&T.name.trim()&&T.status==="");if(c>=0){E(c,i[c].name);return}if(p)return;const j=i.findIndex(T=>T.status==="ready"&&T.site&&!T.descDone&&!T.descBusy);j>=0&&w(j,i[j].name,i[j].site)},[i,E,w,p]);const[N,q]=u.useState(!1),C=u.useCallback(async(c,j)=>{k(c,{evalBusy:!0});const T=await ao(n,(j.site||j.name).trim(),"atelier2");return T.verdict==="quota"?(k(c,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:T.reason||"",remaining:0}})),!1):(k(c,{evalBusy:!1,status:T.verdict==="kept"?"kept":"out",reason:T.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:T.company||j.name,verdict:T.verdict,reason:T.reason||"",remaining:T.remaining??null}})),!0)},[k,n]),L=async()=>{if(N)return;const c=i.map((j,T)=>({r:j,i:T})).filter(({r:j})=>j.name.trim()&&j.status!=="kept"&&j.status!=="out"&&j.status!=="resolving");if(c.length){q(!0);for(const{r:j,i:T}of c)if(!await C(T,j))break;q(!1)}},z=u.useMemo(()=>{const c=new Set,j=[];return i.filter(T=>T.status==="kept").forEach(T=>{const B=T.name.trim().toLowerCase();B&&!c.has(B)&&(c.add(B),j.push(T.name.trim()))}),r.filter(T=>Ne(T)>=1&&Ne(T)<=4&&(T.website||T.domain)).forEach(T=>{const B=(T.name||"").trim().toLowerCase();B&&!c.has(B)&&(c.add(B),j.push((T.name||"").trim()))}),j},[i,r]),M=u.useMemo(()=>{const c=new Set;return r.forEach(j=>{const T=(j.name||"").trim().toLowerCase();T&&c.add(T)}),i.forEach(j=>{const T=j.name.trim().toLowerCase();T&&c.add(T)}),c},[r,i]),D=async()=>{if(m||!z.length)return;h(!1);const c=[];for(const j of z.slice(0,2)){b(j);const T=await no(n,j);if(T){if(T.verdict==="quota"){v(!0);break}(T.results||[]).forEach(B=>{const P=(B.company||"").trim().toLowerCase();!P||M.has(P)||c.some(F=>F.name.toLowerCase()===P)||c.push({name:(B.company||"").trim(),verdict:B.verdict||"",reason:B.reason,from:j})})}}b(""),h(!0),x(j=>[...c,...j].slice(0,24))},$=c=>{s(j=>[...j,{name:c.name,site:"",status:"",auto:!0}].slice(0,30)),x(j=>j.filter(T=>T.name!==c.name))},R=i.filter(c=>c.name.trim()&&c.status!=="kept"&&c.status!=="out").length,O=c=>c.name.trim()&&c.status!=="kept"&&c.status!=="out"&&c.status!=="resolving"&&!c.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((c,j)=>t.jsxs("div",{className:"eq-row"+(c.status==="kept"?" r-kept":c.status==="out"?" r-out":""),children:[t.jsx("input",{value:c.name,placeholder:e.eqNamePh,onChange:T=>{const B=T.target.value.split(`
`).map(P=>P.trim()).filter(Boolean);B.length>1?s(P=>{const F=[...P];return F.splice(j,1,...B.map(_=>({name:_,site:"",status:"",auto:!0}))),F.slice(0,30)}):k(j,{name:T.target.value})},onBlur:()=>{c.name.trim()&&!c.site&&c.status!=="resolving"&&c.status!=="pick"&&E(j,c.name)},onKeyDown:T=>{T.key==="Enter"&&E(j,c.name)}}),t.jsxs("span",{className:"eq-site",children:[c.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),c.status==="pick"&&(c.candidates||[]).map(T=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>k(j,{site:T.url,status:"ready",candidates:void 0}),children:(T.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},T.url)),c.status!=="resolving"&&c.status!=="pick"&&(c.site?t.jsxs("a",{href:c.site.startsWith("http")?c.site:"https://"+c.site,target:"_blank",rel:"nofollow noopener",children:[c.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:c.name.trim()&&c.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:c.desc||"",children:c.descBusy?t.jsx("i",{children:e.eqDescBusy}):c.desc?c.desc:t.jsx("em",{children:c.descDone?p?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(c.status||"vide"),title:c.reason||"",children:c.status==="kept"?"✓ "+e.kept:c.status==="out"?"✗ "+e.dropped:c.status==="ready"?e.eqReady:c.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!O(c)||N,onClick:()=>{C(j,c)},children:c.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>s(T=>T.filter((B,P)=>P!==j)),children:"×"})]},j)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>s(c=>[...c,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]}),!!z.length&&t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!m,onClick:()=>{D()},children:m?e.sgBusy(m):e.sgGo}),t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(z[0],z.length)}),f&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),y&&!d.length&&!f&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),d.map(c=>t.jsxs("span",{className:"eq-sc"+(c.verdict==="kept"?" ok":""),title:(c.reason||"")+" — "+e.sgVia(c.from),children:[t.jsx("b",{children:c.name}),c.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>$(c),children:"+"})]},c.name))]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(N?" loading":""),style:{justifyContent:"center"},disabled:N||!R,onClick:()=>{L()},children:[t.jsx("span",{className:"fill"}),N?e.eqRunning:e.eqGo(R)]}),t.jsx("span",{className:"hint",children:e.eqHint}),i.some(c=>c.status==="kept"||c.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>s(c=>c.filter(j=>j.status!=="kept"&&j.status!=="out")),children:e.eqClearDone})]})]})}function Bo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function dd(e){var o;const a=[],r=new Set,n=i=>{const s=(i||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Br({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:s}){const{t:l}=W();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(p=>p.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(p.name),children:l.rsEvalOne})]},p.name))})]}):null}function _o({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=W(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Br,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Br,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function cd({card:e,onEvaluate:a,onAddAll:r}){var l,p,g;const{t:n}=W(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Bo(e.summary_md||"").map((d,x)=>t.jsx("p",{children:d},x))})]}),t.jsx(_o,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function pd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ud({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:s}=W(),l=o,[p,g]=u.useState(null),[d,x]=u.useState(null),[m,b]=u.useState(null),[f,v]=u.useState(!1);u.useEffect(()=>{let h=!0;return(async()=>{const k=await ro({email:s,cbToken:l});h&&g(k)})(),()=>{h=!1}},[s,l,n]);const y=h=>{x(h),b(null),v(!0),(async()=>{const k=await qi(h.id);b(k),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(p||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[pd(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?i.rsPub:i.rsPriv})]},h.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),f&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!f&&!m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!f&&m&&t.jsx(cd,{card:m,onEvaluate:a,onAddAll:r})]})]})}const ka=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Xt(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?Xt(a)?a:ka.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function md(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function fd(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:s,evalBusy:l,evalCards:p,caps:g,data:d,canWrite:x,source:m,dossiers:b,doAnalyse:f,liveMemos:v,pipe:y}=W(),h=a==="client",k=u.useMemo(()=>r||(m!=="default"?Ti():""),[r,m]),[E,w]=u.useState(""),[N,q]=u.useState(!1),[C,L]=u.useState(""),[z,M]=u.useState(""),[D,$]=u.useState(""),[R,O]=u.useState(!1),[c,j]=u.useState(!1),[T,B]=u.useState([]);u.useEffect(()=>{const I=ee=>{const ie=ee.detail;ie&&B(Z=>[ie,...Z].slice(0,8))};return window.addEventListener("ppmap:evalcard",I),()=>window.removeEventListener("ppmap:evalcard",I)},[]);const[P,F]=u.useState(!1),[_,G]=u.useState(!1),[J,X]=u.useState(!1),ge=u.useRef(!1),[Q,ce]=u.useState(""),[le,be]=u.useState(""),[me,de]=u.useState(!1),[pe,xe]=u.useState(!1),[Y,re]=u.useState(0),[fe,ke]=u.useState(""),[ne,ve]=u.useState(null),[oe,Se]=u.useState(null),[Ke,he]=u.useState(!1),[Ce,Rt]=u.useState(null),[Pe,Je]=u.useState(0),qe=u.useRef(!1),it=E.trim()?ka.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting;u.useEffect(()=>{if(typeof window>"u")return;const I=new URLSearchParams(window.location.search),ee=(I.get("rs")||"").trim(),ie=(I.get("rstext")||"").trim();ee&&/^https?:\/\//i.test(ee)&&ce(ee),ie&&be(ie),(ee&&/^https?:\/\//i.test(ee)||ie)&&F(!0)},[]),u.useEffect(()=>{const I=ee=>{const ie=ee.detail||{},Z=String(ie.url||"").trim(),je=String(ie.text||"").trim();Z&&/^https?:\/\//i.test(Z)&&ce(Z),je&&be(je),(Z&&/^https?:\/\//i.test(Z)||je)&&(F(!0),w(""),L(""),de(!0),window.setTimeout(()=>de(!1),900))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),u.useEffect(()=>{const I=ee=>{const ie=ee.detail||{},Z=String(ie.name||"").trim();if(!Z)return;F(!1),w(Z),L(Z);const je=lt(String(ie.website||ie.domain||""));M(je),$(lt(String(ie.url||""))),O(!je),q(!0),window.setTimeout(()=>q(!1),900)};return window.addEventListener("ppmap:prefill",I),()=>window.removeEventListener("ppmap:prefill",I)},[]),u.useEffect(()=>{const I=(C||"").trim();if(!I||P||z){(z||!I||P)&&O(!1);return}const ee=b.find(je=>_e(je.name)===_e(I)),ie=lt((ee==null?void 0:ee.website)||"")||lt((ee==null?void 0:ee.domain)||"");if(ie){M(ie),O(!1);return}let Z=!0;return O(!0),Cn(I).then(je=>{var $e,Ae;if(!Z)return;const De=lt(je.website||"")||lt(((Ae=($e=je.candidates)==null?void 0:$e[0])==null?void 0:Ae.url)||"");De&&M(De)}).catch(()=>{}).finally(()=>{Z&&O(!1)}),()=>{Z=!1}},[C,P,z,b]),u.useEffect(()=>{const I=ee=>{var Z;const ie=String(((Z=ee.detail)==null?void 0:Z.url)||"").trim();Xt(ie)&&window.open(ie,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",I),()=>window.removeEventListener("ppmap:view",I)},[]),u.useEffect(()=>{if(ge.current===P)return;ge.current=P,X(!0);const I=window.setTimeout(()=>X(!1),560);return()=>window.clearTimeout(I)},[P]),u.useEffect(()=>{if(typeof window>"u")return;const I=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ee=document.querySelector(".atl2.ops, .atl2.cibles");if(!I||!ee)return;const ie=()=>ee.style.setProperty("--demand-h",`${I.offsetHeight}px`);ie();const Z=new ResizeObserver(ie);return Z.observe(I),()=>Z.disconnect()},[m,N,me,c,P,J,R]),u.useEffect(()=>{if(!x&&!k){Rt(null);return}let I=!0;return(async()=>{const ee=await ro({email:n,cbToken:k});I&&Rt(ee.length)})(),()=>{I=!1}},[x,k,n,Pe]);const kt=T.length?T:p,Oe=d.credits,xt=u.useCallback(I=>{ld(r,I)&&j(!0)},[r]);u.useEffect(()=>{if(!pe)return;re(0);const I=window.setInterval(()=>re(ee=>ee+1),1e3);return()=>window.clearInterval(I)},[pe]);const ut=u.useMemo(()=>{const I=E.trim().toLowerCase();return!I||!y?null:b.find(ee=>_e(ee.name)===I&&Ne(ee)===1)||null},[E,b,y]),Xe=()=>{const I=E.trim();if(I){if(ut){f(ut);return}o(null,I),h&&w("")}},jt=async()=>{var ie,Z,je;if(qe.current)return;const I=Q.trim().replace(/\s+/g,""),ee=le.trim();if(!I&&!ee){ke(e.rsNeed);return}if(!h&&!k){o(null,I||ee.slice(0,80));return}qe.current=!0,ke(""),ve(null),Se(null),xe(!0);try{const De=await Ri({url:I,text:ee,email:n,cbToken:k});if(xe(!1),!De||De.status!=="success"){ke((De==null?void 0:De.message)||"Erreur");return}ve(De),F(!1),xt((((ie=De.prospective)==null?void 0:ie.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),Se({state:"pending"});const $e=await Fi(De,{email:n,cbToken:k});Se($e.ok?{state:"ok",scopeLabel:((Z=$e.summary)==null?void 0:Z.scope_label)||"",scope:((je=$e.summary)==null?void 0:je.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&Je(Ae=>Ae+1)}finally{qe.current=!1,xe(!1)}},gt=[ne==null?void 0:ne.industry,...(ne==null?void 0:ne.market_tags)||[],ne==null?void 0:ne.author].map(I=>(I||"").trim()).filter(Boolean),bt=(oe==null?void 0:oe.state)==="pending",Ft=oe&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),Nt=dd(ne).length,Re=P,nt=(C||E).trim(),A=b.find(I=>_e(I.name)===_e(nt)),U=lt(E)||z||lt((A==null?void 0:A.website)||"")||lt((A==null?void 0:A.domain)||""),V=D||lt((A==null?void 0:A.url)||""),ae=ut?e.actAnalyse:nt?e.evalGoOn(nt.length>22?nt.slice(0,21)+"…":nt):e.evalGo,ye=pe?`${Li(Q.trim())==="youtube"&&Q.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Y)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Re?" rs-mode":"")+(C&&E.trim()===C||N||me?" pair":"")+(N||me||J?" echo":"")+(J?" swap":""),children:[t.jsxs("div",{className:"drow"+((Re?me:N)||J?" flash":"")+((Re?Q.trim():ka.test(E.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Re?Q:E,placeholder:Re?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Re?600:200,spellCheck:Re?!1:void 0,inputMode:Re?"url":void 0,onChange:I=>{if(Re){ce(I.target.value);return}w(I.target.value),C&&I.target.value.trim()!==C&&(L(""),M(""),$(""),O(!1))},onKeyDown:I=>{I.key==="Enter"&&(Re?jt():Xe())}}),t.jsx("span",{className:"detect"+(Re?" off":"")+(ka.test(E.trim())?" url":""),children:it})]}),t.jsx("span",{className:"dacts",children:Re?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(pe?" loading":""),disabled:pe||bt||!Q.trim()&&!le.trim(),onClick:()=>{jt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ye})]}),t.jsxs("a",{className:"viewbtn"+(Xt(Q)?"":" off"),href:Xt(Q)?Q.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:I=>{Xt(Q)||I.preventDefault()},children:[t.jsx(md,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ut?" analyse":"")+(l?" loading":""),disabled:l,onClick:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ae})]}),t.jsxs("a",{className:"viewbtn sm"+(R?" searching":U?"":" off"),href:U||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":R||void 0,title:R?e.viewSiteBusyHint:e.viewSiteHint,onClick:I=>{U||I.preventDefault()},children:[R&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),R?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(V?"":" off"),href:V||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:I=>{V||I.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&Oe&&t.jsxs("button",{type:"button",className:"credits"+(Oe.total_available<=0&&!Oe.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Oe.unlimited?"∞":Oe.total_available}),!Oe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Oe.daily_grant+Oe.purchased]}),Oe.total_available<=0&&!Oe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>j(!c),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(P?" on":""),onClick:()=>F(!P),children:e.rsOpen}),Ce!==null&&Ce>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Ke?" on":""),onClick:()=>he(!Ke),children:e.rsArchOpen(Ce)})]}),Ke&&t.jsx(ud,{bump:Pe,cbToken:k,onClose:()=>he(!1),onEvaluate:I=>o(null,I),onAddAll:xt}),t.jsx("div",{className:"rsp slim"+(P?" on":" off"),"aria-hidden":!P,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:P?void 0:-1,onClick:()=>G(I=>!I),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:_?"▴":"▾"})]}),_&&t.jsx("textarea",{className:"rstext",value:le,placeholder:e.rsTextPh,tabIndex:P?void 0:-1,onChange:I=>be(I.target.value)})]})}),fe&&t.jsx("div",{className:"rserr",children:fe}),ne&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ne.title}),ne.source_url&&t.jsx("a",{href:ne.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ve(null),Se(null)},children:"×"})]}),ne.market&&t.jsx("p",{className:"rsmk",children:ne.market}),gt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),gt.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[ne.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ne.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Bo(ne.summary_md||"").map((I,ee)=>t.jsx("p",{children:I},ee))})]}),t.jsx(_o,{card:ne,onEvaluate:I=>o(null,I),onAddAll:xt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Nt)}),Ft]})]}),c&&t.jsx(Po,{}),kt.slice(0,1).map((I,ee)=>{const ie=I.verdict==="kept",Z=I.verdict==="quota",je=I.verdict==="unresolved",De=ie?"var(--brand)":Z?"var(--bolt)":je?"var(--blue)":"var(--red)",$e=ie?"var(--brand-l)":Z?"#FEF3C7":je?"#EEF4FF":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":De,"--bgc":$e},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ie?"✓ "+e.kept:Z?"⏳":je?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,Ae.url,I.name),children:e.evalPickGo})]},Ae.url))}),!Z&&!je&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ie?1:5});const Ae=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ue=[...document.querySelectorAll(".atl2 .list .row")].find(Pa=>{var la;return(((la=Pa.querySelector(".rnm"))==null?void 0:la.textContent)||"").trim().toLowerCase().includes(Ae)});Ue&&(Ue.scrollIntoView({behavior:"smooth",block:"center"}),Ue.classList.add("flashrow"),window.setTimeout(()=>Ue.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ie?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),h&&(i.kept+i.dropped>0||kt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function hd(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function xd(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=W(),i=e.memoConsole?r.get(e.memoConsole):null,s=u.useMemo(()=>i?[i.reasoning||"",hd(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=wt(i),p=Nn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:s?s.split(`

`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Dt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Rn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=W(),[s,l]=u.useState(!1),[p,g]=u.useState(null),d=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!d||s)return;l(!0);const m=await no(r,e);if(l(!1),!m){i(a.actErr);return}g(m.results||[])};return u.useEffect(()=>{if(!d)return;const m=b=>{var v;const f=String(((v=b.detail)==null?void 0:v.name)||"").trim();f&&f.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",m),()=>window.removeEventListener("ppmap:similar",m)},[e,d]),u.useEffect(()=>{if(d)try{const m=(sessionStorage.getItem("pp:similar")||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,d]),d?t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{x()},children:s?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const gd=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ga=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function bd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ga(a.slice(n));break}r+=ga(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ga(a.slice(o));break}const s=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),p=l?l[2].toLowerCase():"";l&&gd.has(p)?r+=`<${l[1]}${p}>`:r+=ga(a.slice(o,i+1)),n=i+1}return r}const vd=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),_r={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function $o(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(vd.has(o)){n.remove();continue}for(const s of Array.from(n.attributes)){const l=s.name.toLowerCase();(!(_r["*"].has(l)||((r=_r[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(s.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const s=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");s!==i&&(s?n.setAttribute("style",s):n.removeAttribute("style"))}if(o==="a"){const s=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(s)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const s=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(s)){n.remove();continue}n.setAttribute("loading","lazy")}$o(n)}}function Xa(e){const a=e.cloneNode(!0);return $o(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Za=new Map;function yd(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=Za.get(a);return r||(r=wd(a).catch(()=>null),r.then(n=>{n||Za.delete(a)}),Za.set(a,r)),r}async function wd(e){var x,m;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=b=>{var f;return(((f=r.querySelector(b))==null?void 0:f.textContent)||"").trim()},o=r.querySelector(".sb-score"),i=((x=Array.from((o==null?void 0:o.classList)||[]).find(b=>b.startsWith("sb-score-")))==null?void 0:x.slice(9))||"",s=[];let l=null;const p=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const b of p){if(b.classList.contains("sb-nav-heading")){l={label:(b.textContent||"").trim(),items:[]},s.push(l);continue}const f=b.getAttribute("href")||"";if(!f.startsWith("#"))continue;const v=f.slice(1),y=kd(r,v);y&&(l||(l={label:"",items:[]},s.push(l)),l.items.push({id:v,title:(b.textContent||"").trim(),html:y,poids:y.length}))}const g=((m=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:m[1])||"",d={score:n(".sb-score"),scoreTone:i,tags:Array.from(r.querySelectorAll(".sb-tag")).map(b=>(b.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:s.filter(b=>b.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?g:""};return d.groups.length?d:null}const $r={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function kd(e,a){const r=e.getElementById(a),n=r?Ur(e,r):"";if(n)return n;const o=$r[a]?e.querySelector($r[a]):null;return o&&o!==r?Ur(e,o):""}function Ur(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Xa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(p=>/^h3$/i.test(p.tagName))[0]===a)for(const p of i){if(p===a)break;/^h2$/i.test(p.tagName)||o.appendChild(p.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?Xa(o):""}return Xa(a)}const en=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ot({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Hr(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Vr({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const tn=new Map;function jd(e,a){const{token:r}=W(),[n,o]=u.useState(null);return u.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let s=tn.get(i);s||(s=Mi(r,e.name,e.checkId),tn.set(i,s),s.then(p=>{(!p||!p.reasoning&&!p.summaryHtml)&&tn.delete(i)}));let l=!0;return s.then(p=>{l&&p&&o({id:e.id,d:p})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Nd=6e4;function Ed({o:e}){const{t:a,doDeep:r}=W(),[n,o]=u.useState(null),[i,s]=u.useState(e.memoUrl?"load":"off"),[l,p]=u.useState(()=>new Set),[g,d]=u.useState(!1),x=u.useRef(new Map);u.useEffect(()=>{let v=!0;if(p(new Set),d(!1),x.current=new Map,!e.memoUrl){s("off"),o(null);return}return s("load"),o(null),yd(e.memoUrl).then(y=>{v&&(o(y),s(y?"ok":"err"))}),()=>{v=!1}},[e.memoUrl]);const m=wt(e),b=v=>{var y;return(y=x.current.get(v))==null?void 0:y.scrollIntoView({behavior:"smooth",block:"start"})},f=t.jsxs("div",{className:"cdacts",children:[Dt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:v=>{v.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const v=[e.reasoning||"",Hr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[v.length?v.join(`

`).split(`

`).map((y,h)=>t.jsx("p",{className:"cdtxt",children:y},h)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),f]})}if(i!=="ok"){const v=[e.reasoning||"",Hr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[m&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:m}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),v.length>0&&v.join(`

`).split(`

`).map((y,h)=>t.jsx("p",{className:"cdtxt",children:y},h)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:y=>{y.stopPropagation(),d(h=>!h)},children:g?a.memoHideHere:a.memoReadHere})}),g&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:y=>y.stopPropagation()}),f,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[m&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:m}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(v=>t.jsx("span",{className:"md-tag",children:v},v)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(v=>v.items.map(y=>t.jsx("button",{type:"button",className:"md-jump",onClick:h=>{h.stopPropagation(),b(y.id)},children:y.title},y.id)))}),n.groups.map((v,y)=>t.jsxs("div",{className:"md-grp",children:[v.label&&t.jsx("div",{className:"md-grp-h",children:v.label}),v.items.map(h=>{const k=h.poids>Nd&&!l.has(h.id),E=h.id==="fiche-contact"||h.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:w=>{w&&x.current.set(h.id,w)},children:[t.jsx("h4",{className:"md-h",children:h.title}),E&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:w=>w.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"LinkedIn"})]}),k?t.jsx("button",{type:"button",className:"abtn md-more",onClick:w=>{w.stopPropagation(),p(N=>new Set(N).add(h.id))},children:a.memoUnfold(Math.round(h.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:h.html}}),!k&&n.mindmapSlug&&h.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Da}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:w=>w.stopPropagation()})]})]},h.id)})]},v.label||y)),f,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}function Fn({o:e}){var E;const{t:a,lang:r,dispatch:n,caps:o}=W(),i=ia(e),s=wt(e),l=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=u.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(l?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Dt(e)?1:0},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:d}].filter(w=>w.n>0),[e,a,o,l,s,p,g,d]),[m,b]=u.useState(""),f=x.some(w=>w.k===m)?m:((E=x[0])==null?void 0:E.k)||"",v=jd(e,f==="eval"||f==="conv");if(!x.length)return null;const y=((v==null?void 0:v.reasoning)||"").length>(e.reasoning||"").length?v.reasoning:e.reasoning||"",h=((v==null?void 0:v.summaryHtml)||"").length>(e.summary||"").length?v.summaryHtml:e.summary||"",k=(v==null?void 0:v.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(w=>t.jsx("button",{type:"button",role:"tab","aria-selected":f===w.k,"data-tour":"tab-"+w.k,className:f===w.k?"on":"",onClick:N=>{N.stopPropagation(),b(w.k)},children:w.lib},w.k))}),t.jsxs("div",{className:"cdbody",onClick:w=>w.stopPropagation(),children:[f==="eval"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(Vr,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),y&&y.split(`

`).map((w,N)=>t.jsx("p",{className:"cdtxt",children:w},N)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Sd,{o:e})]}),f==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(Vr,{v:k,sur:100,k:a.cdConvScore}),en(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",en(e.verdictDate,r)]})]}),h&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:bd(h)}})]}),f==="memo"&&t.jsx(Ed,{o:e}),f==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdSector,v:e.sector}),t.jsx(ot,{k:a.cdStage,v:e.stage}),t.jsx(ot,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ot,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ot,{k:a.cdAngle,v:e.angle}),t.jsx(ot,{k:a.cdDetected,v:en(e.date,r)})]}),f==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdName,v:e.contactName}),t.jsx(ot,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),f==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(ot,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}const ba=new Map;function Sd({o:e}){const{t:a,token:r}=W(),[n,o]=u.useState(!1),[i,s]=u.useState(null);u.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let m=ba.get(x);m||(m=oo(r,[e.name]).then(f=>f[e.name]||Object.values(f)[0]||null).catch(()=>null),ba.set(x,m),m.then(f=>{(!f||!f.ok)&&ba.delete(x)}));let b=!0;return m.then(f=>{b&&f&&f.ok&&s(f)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const x=await to(r,e.name,e.website||e.domain||"");s(x),x.ok&&ba.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},p=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,m])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:m})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function sa({spec:e}){const a=u.useRef(null),r=u.useRef(null),[n,o]=u.useState(!1);return u.useEffect(()=>{const i=a.current;if(!i)return;let s=!1;const l=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Yn({kind:"op",card:e},g).then(d=>{!s&&d&&i.isConnected&&i.replaceChildren(d)})},p=window.requestAnimationFrame(l);return()=>{s=!0,window.cancelAnimationFrame(p),i.replaceChildren()}},[e]),u.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let s=!1;Yn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!s&&p&&i.isConnected&&i.replaceChildren(p)});const l=p=>{p.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{s=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&_t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Cd=`
...
`;function zd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function Ad(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:s,askEvaluate:l,doAnalyse:p,doDecide:g,doPromote:d,doRepeche:x,doApproach:m,doDeep:b,doOnboard:f,outbound:v,evalBusy:y}=W(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const k=Me(h),E=Ne(h),w=wt(h),N=ia(h),q=h.kind==="target",C=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return _t.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Cd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:zd(e.popupAnchor,!!h.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ht(h.date)),Qe(h.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[h.cc]}),children:($t(h.cc,o)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Ut(h.amountEur,o)})]}),i.pipe&&q&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[At(h.engine)," ",t.jsx("b",{children:Qe(h.engine,o)})," — ",Oi(h.engine,o),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),k?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(yt,{o:h,lg:!0})," ",t.jsx(Ia,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(io(k,o))," · ",n.win7(so(k,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(sa,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),i.pipe&&q&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),i.pipe&&q&&t.jsx(Fn,{o:h})]}),t.jsx(Rn,{name:h.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(h,!1),a({type:"popup",id:null})},children:n.actNo}),Dt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{f(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(h.name),onClick:()=>l(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}function qd(){const{lang:e,token:a,dossiers:r,caps:n}=W(),o=a||"home",{names:i,verdicts:s}=u.useMemo(()=>{const p=[],g={};return r.forEach(d=>{d.kind!=="target"||!d.name||(p.push(d.name),g[d.name]=Di(d)||"")}),{names:p,verdicts:g}},[r]);return{diff:u.useMemo(()=>i.length?Ii(o,i,s,e):null,[o,i.length]),names:i,verdicts:s,scope:o,caps:n}}function Td(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:s,caps:l}=W(),[p,g]=u.useState(!1),[d,x]=u.useState(!1),m=u.useRef(null);u.useEffect(()=>{if(!p)return;const E=w=>{m.current&&!m.current.contains(w.target)&&g(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[p]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],f=i.loading&&!s.length,v=u.useRef({});u.useEffect(()=>{v.current={...r}},[r]);const y=E=>{const w=v.current[E],N=w!==void 0?r[E]-w:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zt[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E].toUpperCase(),E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[E],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},E)},h=(E,w,N)=>t.jsxs("button",{type:"button",className:"off"+(w?" view":""),style:{"--c":`var(${Zt[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:N.toUpperCase()}),t.jsx("span",{className:"n",children:r[E]})]},E),k=(E,w,N,q=!1)=>t.jsx("button",{type:"button",className:"tool",title:w,disabled:q,onClick:N,children:E},w);return t.jsxs("div",{className:"funnel"+(f?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(y)}),t.jsxs("div",{className:"offtrack",children:[h(5,!1,n.plabels[5]),h(7,!0,n.plabels[7]),h(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[k("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(d?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:m,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":p,title:n.toolSort,onClick:()=>g(E=>!E),children:"⇅"}),p&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,w])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[w,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),k("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),k("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Ld(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:s}=W(),l=u.useRef(null),[p,g]=u.useState(60);u.useEffect(()=>{let f=0;const v=()=>{var w;const y=l.current;if(!y)return;const h=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!h)return;const k=h.getBoundingClientRect(),E=y.getBoundingClientRect();g(Math.max(20,Math.min(k.left+k.width/2-E.left,E.width-30)))};return f=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(f),window.removeEventListener("resize",v)}},[e.ptab]);const d=e.ptab;let x=r.tuto[d].p;if(d===3){const f=n.filter(h=>h.kind==="target"&&Ne(h)===3),v=f.filter(h=>on(h)==="auto").length,y=f.filter(h=>on(h)==="cd").length;x=r.tutoPending(v,y,f.length)}const m=(()=>{if(s!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(f=>f.id)})};if(d===1){const f=n.filter(v=>v.kind==="target"&&Ne(v)===1&&!o.has(v.id)).slice(0,10);if(f.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:f.map(v=>v.id)})}}return null})(),b=Pi(d);return t.jsxs("div",{ref:l,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Zt[d]})`,"--ax":p+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label})]})}const an=600,St=62,Wr="atl2:fstats";function Rd(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=W(),[s,l]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Wr)==="on"}catch{return!1}}),p=r.stats,g=u.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=(p==null?void 0:p.since)||"";if(!n.showFunnel||!p||typeof p.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,m=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((N,q)=>Math.max(N,q.s||0),0),f=g.length?an/g.length:0,v=Math.max(4,f-4),y=g.length>=5&&b>0,h=r.marketEstimate||0,k=x(new Date().toISOString().slice(0,10)),E=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof p.kept=="number"?[[p.kept,e.funKept]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown]]:[]],w=[];return typeof p.screened_window=="number"&&d&&w.push({cle:"fenetre",periode:e.funPerWindow(x(d),k),etapes:[[p.screened_window,e.funScreened("","")]]}),typeof p.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:E(p.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[w.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([q,C],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(q)}),t.jsx("i",{children:C})]},N.cle+C)),N.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(m(h),Math.min(100,Math.round((p.screened||0)/h*100)))})]}),N.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const q=!s;l(q),q&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Wr,q?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},N.cle)),s&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${an} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((N,q)=>{const C=(N.s||0)/b*(St-4),L=(N.m||0)/b*(St-4),z=q*f+(f-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:St-2-C,width:v,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:St-2-L,width:v,height:L,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:an,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Uo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Mn({o:e,locked:a=!1}){const{t:r}=W(),n=ia(e),o=wt(e),i=Ne(e),s=on(e),l=Bi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Uo[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(tl,{o:e})]})}const Bt=e=>e.length>22?e.slice(0,21)+"…":e;function oa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Ho(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Fd({on:e,rev:a}){const[r,n]=u.useState(null),[o,i]=u.useState({top:0,left:0,width:0});return u.useEffect(()=>{if(!e){n(null);return}const s=()=>{var f,v,y;const l=document.querySelector(".atl2.ops .desk-list"),p=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const g=l.getBoundingClientRect(),d=p?p.getBoundingClientRect().bottom:g.top;i({top:Math.round(d),left:Math.round(g.left),width:Math.round(g.width)});const x=[...l.querySelectorAll(":scope .grp")];let m=null;for(const h of x){const k=h.querySelector(".grp-h");k&&k.getBoundingClientRect().bottom<=d+2&&(m=h)}if(!m){n(null);return}const b=m.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((f=b.querySelector(".ic"))==null?void 0:f.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",s),window.removeEventListener("resize",s)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Md(e){const r=()=>{const n=Ho(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Gr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=W(),[i,s]=u.useState(!1);if(u.useEffect(()=>{n||s(!1)},[n]),Ie(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}function On({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:s,doPromote:l,doRepeche:p,doApproach:g,dispatch:d,liveMemos:x}=W(),m=f=>v=>{v.stopPropagation(),f()};if(r.lockActions){const f=m(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:f,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ne(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:f,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:f,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:f,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:f,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:f,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:f,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:f,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:f,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:f=>{f.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Sa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:f=>{f.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Gr,{o:e})});const b=Ne(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Gr,{o:e})});if(b===1){const f=x.liveOf(e.name);if(f&&(f.status==="boot"||f.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:f,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:m(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:m(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:m(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:m(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const f=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:f,onClick:m(()=>g(e)),children:f?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:m(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:m(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:m(()=>d({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Od({o:e}){const{t:a,doThumb:r,thumbOf:n}=W(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Dd({o:e}){const{lang:a}=W();return Me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(yt,{o:e}),t.jsx(Ia,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[At(e.engine||"")," ",Qe(e.engine||"",a)]})})}function Id({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:s,fresh:l}){const{dispatch:p,caps:g,markRow:d,markedId:x,favIds:m,toggleFav:b,t:f}=W(),v=Ne(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],h=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,k=h<=0?0:h<=7?1:h<=30?2:3,E=g.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:y[k],w=m.has(e.id),N=q=>{if(a)return;if(s){s(e.id);return}if(g.pipe||e.kind==="op"){n();return}const C=q.currentTarget.getBoundingClientRect();p({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(u.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+v:"")+(w?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(Qo,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),Me(e)&&t.jsx(yt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:w?1:.35,padding:0,marginRight:4},onClick:q=>{q.stopPropagation(),b(e)},children:w?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ve(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(q=>q&&q!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:f.acqSee(e.acquirer),onClick:q=>{q.stopPropagation(),p({type:"acquirer",value:e.acquirer||""})},children:["← ",Bt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:f.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:f.zoomNewsMark,children:"📰"}):null]}),t.jsx(Pd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Dd,{o:e}),g.pipe&&t.jsx(Mn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(On,{o:e}),g.showThumbs&&t.jsx(Od,{o:e})]}),r&&!a&&!s&&t.jsx($d,{o:e})]})}function Pd({o:e}){const{lang:a,caps:r}=W();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ut(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Bd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=W(),s=(m,b=!1)=>f=>{f.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})},l=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,40):""})(),p=Ut(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ie(e),x=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Ve(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:m=>{m.stopPropagation(),oa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:m=>{m.stopPropagation(),n(e)},children:a.evalGoOn(Bt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(sa,{spec:e.card})})]})}function _d({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=W();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Qe(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(On,{o:e})}),t.jsx(Fn,{o:e})]})}function Vo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:s,caps:l,dossiers:p}=W(),g=u.useRef(null),d=We(e);if(u.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const c=g.current;if(!c)return;let j=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async T=>{await T.ensureEditoCss(),!(j||!c.isConnected)&&(T.beautifyEditoRows(c),T.mountCardFits(c))}),()=>{j=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const c=p.find(We);if(c)return t.jsx(Vo,{o:c})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),m=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,f=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!x||Ea(x),y=(e==null?void 0:e.engine)||"",h=We(e),k=e?Ut(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const c=/https?:\/\/(?:www\.)?([^/]+)/.exec(m);return c?c[1].replace(/^www\./,"").slice(0,40):""})(),N=p.find(We),q=((N==null?void 0:N.url)||"").trim(),C=!!m&&!!q&&(m===q||m.endsWith(q)||q.endsWith(m)),L=(c,j=!1)=>T=>{T.stopPropagation(),j&&s({type:"continent",key:"monde"}),s({type:"filters",patch:c})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const z=()=>{x&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:x}}))},M=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},D=()=>{oa({url:m,headline:b,tagline:e==null?void 0:e.tagline,name:x})},$=e?Ie(e):!1,R=$&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",O=h?r.doEdito.replace(/^📖\s*/,""):y?Qe(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[O,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),m&&!h&&(v||Sa({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:m,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:c=>c.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(h?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),k&&t.jsx("span",{className:"oc-amt",children:k})]}),f&&t.jsx("div",{className:"zoom-card",children:t.jsx(sa,{spec:f})}),(m&&!C&&!h||N&&!h)&&t.jsxs("div",{className:"zoom-srcbox",children:[m&&!C&&!h&&t.jsxs("a",{className:"zoom-src",href:m,target:"_blank",rel:"nofollow noopener",onClick:c=>c.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),N&&!h&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:c=>{c.stopPropagation(),s({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[$?t.jsxs("span",{className:"verdict",style:{"--c":R?"var(--brand)":"var(--red)"},children:[R?"✓":"✗"," ",t.jsx("b",{children:R?r.kept:r.dropped})]}):!v&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:c=>{c.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Bt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,m&&!h&&(v||Sa({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&x?" ghost":""),onClick:c=>{c.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:c=>{c.stopPropagation(),M()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:c=>{c.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Bt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&x&&l.pipe&&t.jsx(Rn,{name:x})]})]})}function $d({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:s}=W();return!o.pipe&&e.kind==="op"?t.jsx(Bd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Fn,{o:e}),t.jsx(al,{o:e}),t.jsx(ol,{o:e}),t.jsx(Rn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Mn,{o:e})})]}),e.card&&t.jsx(sa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[At(e.engine||"")," ",Qe(e.engine||"",r)]}),Me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(yt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function Ud({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:s,doDecide:l,lang:p}=W();if(!s.pipe&&e.kind==="op"){const x=Ut(e.amountEur,p),m=(()=>{const f=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return f?f[1].slice(0,32):""})(),b=(f,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:f})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(sa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[At(e.engine||"")," ",Qe(e.engine||"",p)]}),Me(e)&&t.jsx(yt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:f=>f.stopPropagation(),children:[(p==="fr"?"lire la source":"read the source")+(m?` · ${m}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(On,{o:e})})]})}const g=Ne(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Mn,{o:e}),Me(e)&&t.jsx(yt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&s.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function Hd(){const{t:e}=W(),[a,r]=u.useState(0);return u.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Vd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=W(),i=o==="en",s=d=>n.plabels[d]||"",l=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),p=l.includes(0)?0:l.sort((d,x)=>(e[x]||0)-(e[d]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${s(p)}”`:`${g} dossier${g>1?"s":""} dans « ${s(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(i?"Open ":"Ouvrir ")+s(p)," →"]})]})}function Wd(){var bt,Ft,Nt,Re,nt;const e=W(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:s,scopedAll:l,markRow:p,lang:g,sessTally:d,data:x,dossiers:m,source:b,focusExtra:f,byId:v,token:y}=e,h=po(),k=u.useMemo(()=>{var V,ae,ye,I;if(!y||b==="ops")return null;const A=(((V=h==null?void 0:h.ed)==null?void 0:V.date)||(h==null?void 0:h.day)||"").slice(0,10),U=[(ae=h==null?void 0:h.ed)==null?void 0:ae.html,(ye=h==null?void 0:h.ed)==null?void 0:ye.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((I=h==null?void 0:h.ed)==null?void 0:I.date)||A,decryptHtml:U||void 0,date:A,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,g,(bt=h==null?void 0:h.ed)==null?void 0:bt.html,(Ft=h==null?void 0:h.ed)==null?void 0:Ft.acquirers_html,(Nt=h==null?void 0:h.ed)==null?void 0:Nt.date,h==null?void 0:h.day]),E=A=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:co,[w,N]=u.useState(new Set);u.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[q,C]=u.useState(null);u.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[L,z]=u.useState(!a.mapFolded);u.useEffect(()=>{if(a.mapFolded){z(!1);return}const A=document.getElementById("atl2-stage");if(!A){z(!1);return}const U=new IntersectionObserver(([V])=>z(!!V&&V.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return U.observe(A),()=>U.disconnect()},[a.mapFolded]);const M=a.mapFolded||!L,D=A=>N(U=>{const V=new Set(U);return V.has(A)?V.delete(A):V.add(A),V}),$=b==="ops"||o.pipe,[R,O]=u.useState("all"),[c,j]=u.useState(!1),[T,B]=u.useState(null),[P,F]=u.useState(!1),_=u.useRef(!0);u.useEffect(()=>{if(_.current){_.current=!1;return}O("all"),F(!1)},[a.ptab,a.continent]),u.useEffect(()=>{if(!P)return;const A=U=>{var V,ae;(ae=(V=U.target)==null?void 0:V.closest)!=null&&ae.call(V,".atl2 .doable")||F(!1)};return document.addEventListener("click",A,!0),()=>document.removeEventListener("click",A,!0)},[P]);const G=u.useMemo(()=>{var U;const A=new Map;for(const V of _s(((U=h==null?void 0:h.ed)==null?void 0:U.html)||""))A.has(V.t)||A.set(V.t,V.html);return A},[(Re=h==null?void 0:h.ed)==null?void 0:Re.html]),J=u.useCallback(A=>{if(A.decryptHtml)return A.decryptHtml;if(!G.size)return;const U=(A.name||"").trim().toLowerCase();if(U.length<3)return;const V=G.get(U);if(V)return V;for(const[ae,ye]of G)if(ae.includes(U)||U.includes(ae))return ye},[G]),{diff:X}=qd(),[ge,Q]=u.useState(!1),ce=a.filters.win==="1"&&!a.filters.day,[le,be]=u.useState(!1),me=u.useMemo(()=>new Set(((X==null?void 0:X.added)||[]).map(A=>A.trim().toLowerCase()).filter(Boolean)),[X]),de=u.useMemo(()=>{if(!me.size)return 0;const A={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return m.filter(U=>!We(U)&&me.has((U.name||"").trim().toLowerCase())&&ea(U,A,o.pipe)).length},[m,me,a,o.pipe]);u.useEffect(()=>{const A=()=>{be(!1),j(!1),O("all"),F(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",A),()=>window.removeEventListener("ppmap:tunnel",A)},[]),u.useEffect(()=>{be(!1),j(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const pe=u.useMemo(()=>{const A=l.filter(V=>!We(V)&&Ve(V));let U="";for(const V of A){const ae=(V.date||"").slice(0,10);ae&&(!U||ae<U)&&(U=ae)}return{n:A.length,since:U?U.split("-").reverse().slice(0,2).join("/"):""}},[l]),xe=pe.n,Y=u.useMemo(()=>{const U=le&&me.size>0||a.filters.signalOnly||R!=="all"||c?l:s;let V=zn(U,a.sort);return V=V.filter(ae=>!We(ae)),le&&me.size&&(V=V.filter(ae=>me.has((ae.name||"").trim().toLowerCase()))),c||R==="explore"?V=V.filter(Ve):R==="eval"?V=V.filter(ae=>!Ve(ae)&&!ae.noCo&&(ae.kind==="op"||!Ie(ae))):o.pipe&&(V=V.filter(ae=>!Ve(ae))),V},[s,l,a.sort,R,le,me,c,o.pipe]),fe=u.useMemo(()=>o.pipe?m.filter(A=>A.kind==="target"&&!We(A)&&Me(A)&&(a.continent==="monde"||A.continent===a.continent)):Y.filter(A=>Me(A)&&!Ie(A)),[o.pipe,m,Y,a.continent]).length,ke=u.useMemo(()=>o.pipe?Y:Y.filter(A=>!Ie(A)&&!A.noCo&&!Ve(A)),[Y,o.pipe]),ne=b==="ops"?Y.filter(Ve).length:0,ve=le?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,oe=a.filters,Se=[];if(oe.day)Se.push({k:"day",lib:n.fDay(oe.day.slice(8,10)+"/"+oe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(oe.win&&oe.win!=="all"){const A=["1","7","30"].indexOf(oe.win);A>=0&&Se.push({k:"win",lib:n.dates[A],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ke=A=>A.length<=2?A.join(", "):`${A.length} ${n.fSelected}`;for(const A of["sector","country","engine"]){const U=oe[A];U&&U.length&&Se.push({k:A,lib:Ke(U),off:()=>r({type:"clearFacet",facet:A})})}oe.search&&Se.push({k:"search",lib:"🔍 "+oe.search,off:()=>r({type:"filters",patch:{search:""}})}),le&&me.size&&Se.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>be(!1)}),oe.signalOnly&&Se.push({k:"sig",lib:"🔴 "+n.sigDock(fe||oe.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const he=(A,U,V="",ae=!1)=>t.jsxs("button",{type:"button","data-s":A,className:V,"aria-sort":a.sort.key===A?a.sort.dir===1?"ascending":"descending":"none",style:ae?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:A}),children:[U,t.jsx("span",{className:"ar",children:a.sort.key===A&&a.sort.dir===1?"▴":"▾"})]},A),Ce=u.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const A=new Map;Y.forEach(ae=>{const ye=ae.engine||"?";A.has(ye)||A.set(ye,[]),A.get(ye).push(ae)});const U={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},V=rn([...A.keys()],g);return[...A.entries()].sort((ae,ye)=>{const I=U[ae[0]]??10+V.indexOf(ae[0]),ee=U[ye[0]]??10+V.indexOf(ye[0]);return I-ee})},[Y,o.pipe,a.groupBy,g]),Rt=Ce?Ce.filter(([A])=>ya.has(A)).length:0,Pe=(()=>{var U;return((U=(Ce?Ce.flatMap(([,V])=>V):Y)[0])==null?void 0:U.id)??null})(),Je=u.useRef(!1),qe=u.useMemo(()=>m.find(We)||k,[m,k]);u.useEffect(()=>{const A=()=>{Je.current=!0,be(!1)};return window.addEventListener("ppmap:reveal",A),window.addEventListener("ppmap:focus",A),()=>{window.removeEventListener("ppmap:reveal",A),window.removeEventListener("ppmap:focus",A)}},[]),u.useEffect(()=>{const A=()=>{qe&&r({type:"focus",id:qe.id})};return window.addEventListener("ppmap:edito",A),()=>window.removeEventListener("ppmap:edito",A)},[qe,r]),u.useEffect(()=>{if(!a.focusId)return;B(a.focusId);const A=window.setTimeout(()=>B(null),900);return()=>window.clearTimeout(A)},[a.focusId]),u.useEffect(()=>{if($&&!(a.focusId&&(Y.some(A=>A.id===a.focusId)||m.some(A=>A.id===a.focusId)||a.focusId===(qe==null?void 0:qe.id)))&&!f){if(qe){r({type:"focus",id:qe.id});return}Pe&&r({type:"focus",id:Pe})}},[$,a.focusId,Y,Pe,f,r,m,b,qe]),u.useEffect(()=>{if(!$||!a.focusId||qe&&a.focusId===qe.id||Y.some(U=>U.id===a.focusId))return;const A=m.find(U=>U.id===a.focusId);if(A){if(Je.current){A.kind==="op"?O(Ve(A)?"explore":"eval"):R!=="all"&&O("all");return}R!=="all"&&Pe&&r({type:"focus",id:Pe})}},[$,a.focusId,R,Y,m,Pe,r,qe]),u.useEffect(()=>{if(!$||!a.focusId||!Je.current)return;const A=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!A){const ye=Y.findIndex(I=>I.id===a.focusId);if(ye>=0){const I=Ce?"":"pt"+a.ptab;if(I){const ee=a.shown[I]||E();ye>=ee&&r({type:"more",group:I,by:ye-ee+8})}}return}Je.current=!1;const U=Ho(),V=A.getBoundingClientRect();V.top>=U-2&&V.bottom<=window.innerHeight-4||Md(A)},[$,a.focusId,a.ptab,Y,a.shown,Ce,r]),u.useEffect(()=>{if(typeof window>"u")return;const A=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),U=document.querySelector(".atl2.ops, .atl2.cibles");if(!A||!U)return;const V=()=>U.style.setProperty("--listhead-h",`${A.offsetHeight}px`);V();const ae=new ResizeObserver(V);return ae.observe(A),()=>ae.disconnect()},[M,a.dens,a.mapFolded]);const it=u.useMemo(()=>{if(!$||!a.focusId)return null;if(k&&a.focusId===k.id)return k;const A=Y.find(V=>V.id===a.focusId)||m.find(V=>V.id===a.focusId)||null;if(!A)return null;const U=J(A);return U&&U!==A.decryptHtml?{...A,decryptHtml:U}:A},[$,a.focusId,Y,m,J,k]),kt=o.lockRowsAfter;let Oe=0;const xt=(A,U)=>{let V=a.shown[U]||E();return A.length-V<=4&&(V=A.length),A.slice(0,V).map(I=>{const ee=kt!==null&&Oe>=kt;Oe++;const ie=J(I),Z=ie&&ie!==I.decryptHtml?{...I,decryptHtml:ie}:I,je=!$&&a.dens!=="maxi"&&(a.dens==="deplie"||(q?q==="open":!!ie)),De=w.has(I.id)?!je:je,$e=$?Ae=>{Je.current=!0,r({type:"focus",id:Ae});const Ue=v.get(Ae);Ue&&(Ve(Ue)?oa(Ue):Ue.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ue.name,url:Ue.url||"",website:Ue.website||"",domain:Ue.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Ud,{o:Z,locked:ee,selected:$&&a.focusId===I.id,onSelect:$e},I.id):t.jsx(Id,{o:Z,locked:ee,open:De,onToggle:()=>D(I.id),selected:$&&a.focusId===I.id,echo:T===I.id,fresh:me.has((I.name||"").trim().toLowerCase()),onSelect:$e},I.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(Y.length?"":" list-empty"),Xe=t.jsxs(t.Fragment,{children:[Ce?Ce.map(([A,U])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:At(A)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:A==="ma"?n.grpMa:A==="fundraising"?n.grpLev:ya.has(A)&&Rt<=1?n.grpNews:A==="nominations"?n.grpNom:A==="media"?n.grpNewsOther:A==="recrutements"?n.grpHire:ya.has(A)?n.grpNews+" · "+Qe(A,g):Qe(A,g)}),t.jsx("div",{className:"s",children:n.grpCount(U.filter(V=>!Ie(V)).length,U.length)})]})]}),xt(U,A)]},A)):xt(Y,"pt"+a.ptab),x.loading&&!m.length&&t.jsx(Hd,{}),o.pipe&&a.ptab===0&&!c&&!le&&R==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(Po,{}),!Y.length&&!(x.loading&&!m.length)&&(o.pipe&&R==="all"?t.jsx(Vd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),jt=t.jsxs(t.Fragment,{children:[!le&&!c&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Y.length})," ",ve]}),c&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Y.length})," ",n.newsWord]}),(!le||c)&&t.jsx("span",{className:"dot",children:"·"}),M&&t.jsx(Do,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[M?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),Se.map(A=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:U=>{U.stopPropagation(),A.off()},children:[A.lib,t.jsx("i",{children:"×"})]},A.k)),b==="ops"&&Y.length>0&&!M&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",Y.length-ne," ",n.zoomPulseEval,ne>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",ne," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),gt=t.jsxs("div",{className:"listhead"+(M?" mapoff":""),children:[M&&t.jsx("div",{className:"lh-tools",children:t.jsx(Oo,{compact:!0})}),o.showFunnel&&ge&&ce&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(sl,{}),t.jsx(Rd,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:jt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Td,{}),t.jsx(Ld,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ce?" on":""),"aria-pressed":ce,title:n.morningDockTitle,onClick:()=>{if(ce){r({type:"filters",patch:{win:"all",day:""}}),Q(!1);return}be(!1),j(!1),O("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),Q(!0)},children:["📊 ",n.morningDock(typeof((nt=x.stats)==null?void 0:nt.screened_today)=="number"?x.stats.screened_today:0)]}),X&&!X.firstVisit&&(X.added.length>0||X.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(le?" on":""),"aria-pressed":le,title:n.sinceSub,onClick:()=>{const A=!le;be(A),j(!1),Q(!1),O("all"),A&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(de),X!=null&&X.lastDate?` · ${n.sinceSince(X.lastDate)}`:""]}),fe>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{be(!1),j(!1),Q(!1),O("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(fe)]}),o.pipe&&xe>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(c?" on":""),"aria-pressed":c,title:n.newsDockHint,onClick:()=>{const A=!c;j(A),be(!1),Q(!1),O("all"),A&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(xe),pe.since?` · ${n.newsSince(pe.since)}`:""]})]}),!o.showFunnel&&jt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([A,U])=>t.jsxs("button",{type:"button","data-d":A,"aria-pressed":a.dens===A||A==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:A}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:U})]},A))}),!$&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":q==="open",onClick:()=>{C("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":q==="closed",onClick:()=>{C("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var ie;const A={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},U=m.filter(Z=>ea(Z,A,o.pipe)&&!We(Z)),V=U.filter(Z=>!Ve(Z)&&!Z.noCo&&(Z.kind==="op"||!Ie(Z))).length,ae=U.filter(Ve).length,ye=o.pipe?U.filter(Z=>Z.kind!=="op"&&Ne(Z)===1).length:0,I=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ye?` ${ye}`:""}`]]:[],["eval",`${n.doEval}${V?` ${V}`:""}`],["explore",`${n.doExplore}${ae?` ${ae}`:""}`]],ee=((ie=I.find(([Z])=>Z===R))==null?void 0:ie[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":P,onClick:()=>F(Z=>!Z),children:[ee,t.jsx("i",{children:"▾"})]}),P&&t.jsx("div",{className:"dolist",children:I.map(([Z,je])=>t.jsx("button",{type:"button","aria-pressed":R===Z,onClick:()=>{if(F(!1),Z==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}O(Z),Z!=="all"&&(be(!1),j(!1),Q(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:je},Z))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:A=>r({type:"sort",key:A.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([A,U])=>t.jsx("option",{value:A,children:U},A))})]}),o.showChain&&ke.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ke.map(A=>A.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ke.length):n.chainAll(ke.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!$&&gt,a.dens!=="maxi"&&!$&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),he("country",n.colCountry),he("name",n.colCompany),he("amount",n.colAmount,"h-amt",!0),he("stage",n.colStage,"h-stade"),he("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[he("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),he("memo",n.colMemo)]}),o.pipe&&he("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),$?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[gt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),he("country",n.colCountry),he("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[he("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),he("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:Xe})]}),t.jsxs("aside",{className:"readpane"+((it?We(it):!f&&qe)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[qe&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===qe.id,onClick:()=>r({type:"focus",id:qe.id}),children:n.doEdito}),k&&a.focusId===k.id?t.jsx("div",{className:"zoom",children:t.jsx(Ws,{})}):it&&o.pipe?t.jsx(_d,{o:it}):t.jsx(Vo,{o:it,extra:it?null:f})]})]}):t.jsx("div",{className:ut,children:Xe}),(()=>{const A=Ce||[["pt"+a.ptab,Y]];let U=0,V=0;for(const[ye,I]of A){V+=I.length;let ee=a.shown[ye]||E();I.length-ee<=4&&(ee=I.length),U+=Math.min(I.length,ee)}const ae=V-U;return ae<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>A.forEach(([ye,I])=>r({type:"more",group:ye,by:I.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(ae,ae)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(U,V)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),$&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Fd,{on:!!Ce,rev:(Ce||[]).map(([A,U])=>A+U.length).join("|")})]})}function Yr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Gd(e,a){const r=_i(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Yd(e,a){const n=[a.head.split("|").map(Yr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Gd(o,a.plabels),ia(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Yr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Qd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Kd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Jd({o:e,qa:a}){const{t:r,lang:n,fund:o}=W(),i=(e.cribleStatus||"").trim().toUpperCase()||(ia(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=wt(e),l=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:Kd(e.date,n)})]}),p.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Xd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:s}=W(),[l,p]=u.useState({}),g=25,d=u.useMemo(()=>n.slice(0,g),[n]);u.useEffect(()=>{d.length&&oo(r,d.map(b=>b.name)).then(p)},[r,d]);const x=i.stats,m=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[m(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",m(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(m(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(Jd,{o:b,qa:l[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Zd=50;function Dn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=W(),[i,s]=u.useState(null),[l,p]=u.useState(!1),[g,d]=u.useState(""),[x,m]=u.useState(0),[b,f]=u.useState(""),[v,y]=u.useState(!1),[h,k]=u.useState(0),E=u.useRef(null),w=u.useRef(null),N=()=>{k(0),w.current&&window.clearInterval(w.current),w.current=window.setInterval(()=>k(z=>z+1),1e3)},q=()=>{w.current&&(window.clearInterval(w.current),w.current=null)};u.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),w.current&&window.clearInterval(w.current)},[]);const C=async z=>{p(!0),d(""),N();const M=await a();if(p(!1),q(),M.ok){s(M);return}if(M.busy){d(o.alertPreviewBusy);return}if(!z){d(o.alertPreviewFail);return}m(Zd),q(),E.current=window.setInterval(()=>{m(D=>D>1?D-1:(E.current&&window.clearInterval(E.current),C(!1),0))},1e3)},L=async()=>{if(n||v||l)return;y(!0),f(""),N();const z=await r();y(!1),q(),f(z.ok?o.alertTestOk(z.sentTo||""):z.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||v||x>0,onClick:()=>{C(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||l,onClick:()=>{L()},children:v?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(h)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(h)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const zt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ge({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=W();return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function ec(){const{st:e}=W();switch(e.modal){case"chain":return t.jsx(ac,{});case"space":return t.jsx(nc,{});case"alert":return t.jsx(rc,{});case"queue":return t.jsx(dc,{});case"export":return t.jsx(cc,{});case"plug":return t.jsx(mc,{});case"recharge":return t.jsx(xc,{});case"cover":return t.jsx(bc,{});case"dossier":return t.jsx(gc,{});case"crit":return t.jsx(vc,{});case"tuto":return t.jsx(yc,{});case"rdv":return t.jsx(tc,{});case"memoalert":return t.jsx(pc,{});default:return null}}function tc(){const{dispatch:e,fund:a,t:r}=W(),n=a||r.rdvCoFallback;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:fo,children:qn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],s)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(s+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(ps,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function ac(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:s,evalBusy:l,caps:p,memoQueued:g,doAnalyse:d}=W(),x=i==="client",m=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,f=m[b],v=b>=m.length;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${m.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,m.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!f?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(m.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:f.name}),t.jsx("div",{className:"sub",children:[$t(f.cc,o)||f.countryLabel,f.sector,f.stage,n.daysAgo(ht(f.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Qe(f.engine,o).toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{children:Ut(f.amountEur,o)})]}),Me(f)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(yt,{o:f,lg:!0})," ",t.jsx(Ia,{o:f,src:!0})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),f.reasoning&&!(x&&Ie(f))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),x&&Ie(f)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Ct(f)==="retenu"?"var(--brand)":Ct(f)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ct(f)==="retenu"?"✓ "+n.kept:Ct(f)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:f.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&f&&p.pipe&&Ne(f)===1&&!g.has(f.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(f),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&f&&!(x&&Ie(f))&&(f.noCo&&f.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(f)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function nc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=W(),i=o==="client",s=u.useMemo(()=>i?r.filter(x=>Ie(x)):[],[r,i]),l=u.useMemo(()=>zn(s.filter(x=>Ct(x)==="retenu"),{key:"signal",dir:-1}),[s]),p=u.useMemo(()=>s.filter(x=>Ct(x)==="ecarte"),[s]),g=e.spaceTab==="retenu"?l:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ge,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function rc(){const{mode:e}=W();return e==="client"||e==="apercu"?t.jsx(oc,{}):t.jsx(lc,{})}function oc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=W(),[i,s]=u.useState("d"),l=o!=="client";return t.jsxs(Ge,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(ic,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(sc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(Wo,{})]})}function ic({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=u.useState(null),[l,p]=u.useState(!1),[g,d]=u.useState(0);u.useEffect(()=>{let L=!0;return p(!1),Zn(a).then(z=>{L&&(z?s(z):p(!0))}),()=>{L=!1}},[a,g]);const x=u.useRef({}),[m,b]=u.useState({}),[f,v]=u.useState(!1),[y,h]=u.useState(!1),k=u.useRef(null);u.useEffect(()=>()=>{k.current&&window.clearTimeout(k.current)},[]);const E=L=>{const z=x.current;Object.keys(z).length&&(v(!0),Zn(a,z).then(M=>{if(!M){v(!1),o(e.actErr);return}if(M.throttled&&L<3){k.current=window.setTimeout(()=>E(L+1),5400);return}if(x.current={},b({}),s(M),v(!1),M.throttled){o(e.alertThrottled);return}h(!0),window.setTimeout(()=>h(!1),2e3),n(e.alertSaved)}))},w=L=>{r||(x.current={...x.current,...L},b(z=>({...z,...L})),k.current&&window.clearTimeout(k.current),k.current=window.setTimeout(()=>E(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...m},q=L=>!N.sections||N.sections.includes(L),C=L=>{const z=N.sections||e.alertSec.map(([M])=>M);w({sections:q(L)?z.filter(M=>M!==L):[...z,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>w({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>w({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,f&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!f&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,z])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:q(L),disabled:r,onChange:()=>C(L)}),t.jsxs("span",{children:[z,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Dn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ji(a),onTest:()=>Ki(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function sc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=u.useState(null),[l,p]=u.useState(!1),[g,d]=u.useState(0);u.useEffect(()=>{let f=!0;return p(!1),er(a).then(v=>{f&&(v?s(v):p(!0))}),()=>{f=!1}},[a,g]);const x=f=>{r||er(a,f).then(v=>{if(!v){o(e.actErr);return}s(v),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const m=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:f=>x({dow:Number(f.target.value)}),children:e.alertDow.map((f,v)=>t.jsx("option",{value:v,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Dn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Zi(a),onTest:()=>Xi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Wo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=W(),[s,l]=u.useState(i||""),[p,g]=u.useState(!1),[d,x]=u.useState(!1);u.useEffect(()=>{i&&l(i)},[i]);const m=e.filters,b=u.useMemo(()=>n.filter(h=>Me(h)).length,[n]),f=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(s)||d)){x(!0);try{await fetch(`${Da}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:m.sector,countries:m.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[f]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(h=>Qe(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(h=>$t(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([h,k])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:k}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!i,onChange:h=>l(h.target.value),onKeyDown:h=>{h.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function lc(){const{t:e}=W();return t.jsx(Ge,{title:e.alertTitle,icon:"🔔",children:t.jsx(Wo,{})})}function dc(){var D,$;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:s,caps:l,dispatch:p,liveMemos:g}=W(),[d,x]=u.useState(()=>$a(r)),[m,b]=u.useState(()=>!$a(r)),[f,v]=u.useState([]),[y,h]=u.useState(0),k=n==="client",E=u.useMemo(()=>{const R=new Map;return o.forEach(O=>{const c=(O.name||"").trim().toLowerCase();c&&!R.has(c)&&R.set(c,O)}),R},[o]);u.useEffect(()=>{let R=!0;return(!$a(r)||y>0)&&b(!0),(async()=>{const[O,c]=await Promise.all([En(r,y>0),eo(a)]);R&&(O&&x(O),b(!1),v(c))})(),()=>{R=!1}},[a,r,y]);const w=m&&!d,N=(d==null?void 0:d.per_day)??0,q=((D=d==null?void 0:d.analyzed_today)==null?void 0:D.length)??0,C=d==null?void 0:d.offre,L=(d==null?void 0:d.pool_meta)||[],z=u.useMemo(()=>{const R=new Map;for(const O of(d==null?void 0:d.scheduled)||[])for(const c of O.names||[])R.has(c)||R.set(c,{label:O.day_label,date:O.date});return R},[d==null?void 0:d.scheduled]),M=(d==null?void 0:d.in_progress)||[];return t.jsxs(Ge,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:w?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(q,q+((($=d==null?void 0:d.pool_order)==null?void 0:$.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!w&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(M.length>0||g.items.some(R=>R.status==="boot"||R.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(R=>R.status==="boot"||R.status==="running"||R.status==="error").map(R=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:R.name}),t.jsx("span",{className:"qd",children:R.memoType||""}),t.jsx(Na,{item:R,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+R.name)),M.filter(R=>!g.liveOf(R.name)).map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.name}),t.jsxs("span",{className:"qd",children:[R.memo_type||"",R.age_min?` · ${Math.round(R.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:R.state||""})]},"ip-"+R.name))]})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:f.map(R=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:R.company}),t.jsxs("span",{className:"qd",children:[R.memo_type,typeof R.est_min=="number"?` · ~${R.est_min} min`:""]}),t.jsx("span",{className:"qt",children:R.status}),R.url&&t.jsx("a",{className:"qgo",href:R.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(R.memo_type)}),k&&R.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Jn(a,R.company,"retry").then(()=>h(O=>O+1))},children:e.queueRetry}),k&&R.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Jn(a,R.company,"delete").then(()=>h(O=>O+1))},children:e.queueDelete})]},R.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",w?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[w&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!w&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((R,O)=>{const c=z.get(R.name),j=E.get((R.name||"").trim().toLowerCase()),T=g.liveOf(R.name),B=!!(j&&s.has(j.id))||!!(T&&(T.status==="boot"||T.status==="running")),P=!!(j&&Ne(j)===1&&!j.memoUrl)&&!T;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",O+1]}),c?t.jsx("span",{className:"qwhen"+(c.label==="demain"?" soon":""),children:c.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:R.name}),R.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof R.score=="number"&&t.jsx("span",{className:"qs2",children:R.score}),T&&(T.status==="boot"||T.status==="running")&&t.jsx(Na,{item:T,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),P&&(l.lockActions||!k?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>p({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:B,onClick:()=>{i(j),h(F=>F+1)},children:B?e.actAnalyseQueued:e.actAnalyse})),R.excerpt&&t.jsx("span",{className:"qex",children:R.excerpt})]},R.name+":"+O)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([R,O])=>t.jsxs("li",{children:[t.jsx("b",{children:R})," — ",O]},R))})]})}function cc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:s}=W(),l=`${zt}/cibles/list.csv?token=${a}`,p=`${zt}/cibles/list.json?token=${a}`,g=`${zt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${l}")`,x=y=>{var h;(h=navigator.clipboard)==null||h.writeText(y).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,f=()=>{Qd(Yd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([h])=>h===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ge,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:y,value:h,href:k})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(h),children:e.exportCopy}),k&&t.jsx("a",{className:"exb",href:k,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function pc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=W(),i=o!=="client",[s,l]=u.useState(null),[p,g]=u.useState(!1),[d,x]=u.useState(0),[m,b]=u.useState(!1);u.useEffect(()=>{let h=!0;return g(!1),Qn(a).then(k=>{h&&(k?l(k):g(!0))}),()=>{h=!1}},[a,d]);const f=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=h=>{if(i||!s)return;const k={enabled:h.enabled??!!s.enabled,email:h.email??(s.email||""),sections:h.sections??f()};b(!0),Qn(a,k).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}l(E),r(e.memoAlertSaved)})};if(p)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(h=>h+1),children:e.retry})]})});if(!s)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=f();return t.jsxs(Ge,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:i||m,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(uc,{value:s.email||"",readOnly:i||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>v({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,k])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[h],disabled:i||m,onChange:()=>v({sections:{...y,[h]:!y[h]}})}),t.jsx("span",{children:k})]},h))}),t.jsx(Dn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Ui(a,y),onTest:()=>$i(a,y)})]})}function uc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,s]=u.useState(e);u.useEffect(()=>{s(e)},[e]);const l=i.trim()!==e.trim(),p=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>s(g.target.value),onKeyDown:g=>{g.key==="Enter"&&l&&p&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!p,onClick:()=>o(i.trim()),children:n})]})]})}function mc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=W(),[i,s]=u.useState(null),[l,p]=u.useState(!1),[g,d]=u.useState(null),[x,m]=u.useState(!1),[b,f]=u.useState(""),[v,y]=u.useState(0),[h,k]=u.useState("webhook"),[E,w]=u.useState(""),N=u.useRef(!1);u.useEffect(()=>{let D=!0;return p(!1),Kn(a).then($=>{D&&($?s({configured:$.configured,url_hint:$.url_hint}):p(!0))}),Wi(a).then($=>{if(D){if(!$){m(!0);return}m(!1),d($),N.current||(N.current=!0,$.destination==="instantly"&&k(R=>R==="webhook"?"instantly":R),$.campaign_id&&w(R=>R||$.campaign_id||""))}}),()=>{D=!1}},[a,v]);const q=(D,$)=>{o&&Kn(a,D).then(R=>{if(!R||R.ok===!1){n(e.actErr);return}D.test&&R.sent===!1?n(e.plugTestThrottled):r($),y(O=>O+1)})},C='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',L=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),z=`curl -X POST ${zt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,M=`curl -X POST ${zt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ge,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>y(D=>D+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:D=>f(D.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>q({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>q({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>q({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(hc,{destKind:h,setDestKind:k,camp:E,setCamp:w,whHint:i!=null&&i.configured?i.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(fc,{auto:g,autoKo:x,destKind:h,camp:E,onRetry:()=>y(D=>D+1),onDone:D=>{d(D),m(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:z}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(z).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var D;(D=navigator.clipboard)==null||D.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function fc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:s,token:l,flash:p,flashErr:g,canWrite:d}=W(),[x,m]=u.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:s.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[s.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:s.retry})]})]}):null;const b=!!e.enabled,f=!b&&(r==="webhook"?e.webhook_ready===!1?s.plugAutoNeed:"":n.trim()?"":s.plugCampNeed),v=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,y=()=>{if(x||!d||f)return;m(!0),(b?Xn(l,!1):Xn(l,!0,r,n.trim()||void 0)).then(k=>{if(m(!1),!k){g(s.actErr);return}o(k),p(k.enabled?s.plugAutoSavedOn:s.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:s.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:s.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!d||!!f,title:f||void 0,onClick:y,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:s.plugAutoOnLbl})]}),f===s.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:f}),v&&t.jsx("p",{className:"mnote warn",children:s.plugAutoBroken})]})}function hc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:s,lang:l,canWrite:p}=W(),[g,d]=u.useState("valides"),[x,m]=u.useState(!1),[b,f]=u.useState(null),[v,y]=u.useState(null),[h,k]=u.useState(!1),[E,w]=u.useState(!1),[N,q]=u.useState(null),[C,L]=u.useState(null),z=`atl2:bulk:${s}:${g}:${e}`;u.useEffect(()=>{f(null),y(null),k(!1),q(null);try{const F=localStorage.getItem(z)||localStorage.getItem(`atl2:bulk:${s}:${g}`),_=JSON.parse(F||"null");L(_&&Date.now()-Date.parse(_.t)<24*3600*1e3?_:null)}catch{L(null)}},[z,g,s]);const M=e==="instantly"&&!r.trim(),D=`${g}|${e}|${r.trim()}`,$=async()=>{if(M||!p)return;m(!0),k(!1),q(null);const F=await Yi(s,g,e,r.trim()||void 0);f(F),y(F.ok?D:null),m(!1)},R=u.useRef(!1);if(!p)return null;const O=async()=>{if(R.current||!p)return;R.current=!0,w(!0);const F=`${s}:${g}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await Qi(s,g,e,r.trim()||void 0,F)}finally{R.current=!1}if(w(!1),k(!1),q(_),_.ok&&(_.pushed||0)>0){const G={t:new Date().toISOString(),n:_.pushed||0};L(G);try{localStorage.setItem(z,JSON.stringify(G))}catch{}}};h&&v!==null&&v!==D&&k(!1);const c=o,j=b!=null&&b.ok&&b.ready||0,T=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":c||"",B=!!(b!=null&&b.ok)&&v===D&&j>0&&!!T&&!C,P=C?new Date(C.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:g,onChange:F=>d(F.target.value),children:i.plugBulkTabs.map(([F,_])=>t.jsx("option",{value:F,children:_},F))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:F=>a(F.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:F=>n(F.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||M,onClick:()=>{$()},children:x?"…":i.plugBulkPreview})]}),M&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),C&&t.jsx("p",{className:"mnote",children:i.bulkLocked(P,C.n)}),!C&&!!(b!=null&&b.ok)&&!T&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!C&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),B&&!h&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>k(!0),children:i.bulkArm}),B&&h&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(j,T)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{O()},children:E?i.bulkSending:i.bulkConfirm(T)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>k(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function xc(){const{t:e,data:a,lang:r}=W(),n=a.credits,o=a.email,i=async s=>{if(!o)return;const l=window.location.href.split("?")[0];try{const g=await(await fetch(`${Da}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ge,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function gc(){const{t:e}=W();return t.jsx(Ge,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Xd,{})})}function bc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:s,flash:l}=W(),[p,g]=u.useState(null),[d,x]=u.useState(!1);u.useEffect(()=>{let z=!0;if(i)return En(i).then(M=>{z&&M&&typeof M.per_day=="number"&&g(M.per_day)}),()=>{z=!1}},[i]);const[m,b]=u.useState(null);u.useEffect(()=>{if(!o)return;let z=!0;return Vi(o).then(M=>{z&&b(M)}),()=>{z=!1}},[o]);const f=r.stats,v=typeof(f==null?void 0:f.screened)=="number"?f.screened:n.filter(z=>z.kind==="target"&&Ie(z)).length,y=r.marketEstimate||0,h=y>0?Math.min(100,Math.round(v/y*100)):null,k=(f==null?void 0:f.window_days)||30,E=v>0?v/k:0,w=y>0?Math.max(0,y-v):0,q=y>0&&E>0&&v>=100?Math.round(w/E):null,C=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),L=z=>{d||!s||(x(!0),Gi(o,z).then(M=>{if(x(!1),M===null){l(e.actErr);return}g(M),l(e.alertSaved)}))};return t.jsxs(Ge,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(v))}),y>0&&t.jsx("span",{children:e.covOf(C(y))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),q!==null&&t.jsx("p",{className:"mnote",children:e.covEta(q)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(E))}),f&&t.jsxs("div",{className:"covf",children:[typeof f.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(f.kept)})," ",e.covKept]}),typeof f.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(f.analyzed)})," ",e.covAna]}),typeof f.shown=="number"&&f.shown!==f.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(f.shown)})," ",e.funShown]})]}),(m==null?void 0:m.ok)&&(m.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),m.perimetre&&t.jsx("p",{className:"mnote",children:m.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(m.detail||[]).map((z,M)=>t.jsxs("tr",{className:z.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[z.code,z.geo?` · ${z.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof z.n=="number"?C(z.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:z.source}),z.elargi&&t.jsx("em",{children:e.covWide(String(z.demande||""))}),z.erreur&&t.jsx("em",{children:e.covMissing})]})]},M)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(m.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(m.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((m.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(m.sources||[]).join(" · "),m.calcule_le?` — ${e.covComputedAt(m.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),s&&p!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(p)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:p===z?"on":"",disabled:d,onClick:()=>L(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function vc(){var h,k,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:s,lang:l}=W(),p=n==="client",g=u.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[d,x]=u.useState(""),[m,b]=u.useState(""),[f,v]=u.useState(!1),y=async()=>{const w=d.trim();if(!(!w||f||!p)){v(!0),b("");try{const q=await(await fetch(`${zt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(q.reply&&b(String(q.reply)),q.job_id){b(e.critChatRunning);const C=async()=>{const L=await fetch(`${zt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:q.job_id})}).then(z=>z.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),v(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{m.startsWith("⏳")||v(!1)}}};return t.jsxs(Ge,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((h=i.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((k=i==null?void 0:i.angles)!=null&&k.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var N,q;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((q=w.out)!=null&&q.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},w.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!p||f,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!p||f||!d.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Hi,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Uo[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function yc(){const{t:e,dispatch:a,startTour:r}=W(),n=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(Ge,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const Go="atl2:mapfold",wc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Go);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},kc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Yo=u.createContext(null),W=()=>{const e=u.useContext(Yo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function yt({o:e,lg:a}){const{lang:r}=W(),n=Me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:tr(n,r),children:[n.emoji," ",tr(n,r)]}):null}function Ia({o:e,src:a}){const{lang:r,t:n}=W(),o=Me(e);if(!o)return null;const i=os(o),s=is(o);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(io(o,r))+" · "+n.win7(so(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,p)=>t.jsx("i",{className:p<i?"on":""},p))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function jc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(s=>(s.url||"")===n);if(i)return i}const o=_e(a);if(o)return e.find(i=>_e(i.name)===o)||e.find(i=>{const s=_e(i.name);return s.length>=3&&(o.includes(s)||s.includes(o))})}function Nc(){const{scoped:e,t:a,st:r,dispatch:n}=W(),o=u.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,s=e.filter(x=>!We(x)),l=s.length,p=s.filter(x=>!x.noCo).length,g=s.filter(x=>!!x.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",p," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Ec(){const{t:e,lang:a,data:r,dispatch:n}=W(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const s=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:s>0?e.covOf(i(s)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function Qo({o:e}){const{lang:a}=W(),r=rs(e.cc),n=e.cc?$t(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Qr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Sc=!1;function Cc(){const[e,a]=u.useState(!1);return u.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Ko=e=>`atl2:tour:${e||"anon"}`;function zc(e){try{return localStorage.getItem(Ko(e))==="1"}catch{return!0}}function Kr(e){try{localStorage.setItem(Ko(e),"1")}catch{}}function Ac(e,a,r,n,o,i){const s=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Fc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var In;const{lang:s}=es(),l=Ns[s],p=Os(e,s,a),[g,d]=u.useReducer(Ps,void 0,()=>Ds((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?kc():wc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=u.useRef(!0);u.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Go,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),u.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const S=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return S(),window.addEventListener("resize",S),()=>window.removeEventListener("resize",S)},[a]);const m=u.useRef(i);m.current=i,u.useEffect(()=>{var S;(S=m.current)==null||S.call(m,g.filters)},[g.filters]);const[b,f]=u.useState(()=>{if(typeof window>"u")return"both";try{const S=localStorage.getItem("atl2:chrome-mode");if(S==="eval"||S==="filt"||S==="both")return S;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=u.useState(null),[h,k]=u.useState(null),[E,w]=u.useState(null),[N,q]=u.useState({kept:0,dropped:0}),[C,L]=u.useState(!1),[z,M]=u.useState(""),[D,$]=u.useState(!1),[R,O]=u.useState(null),[c,j]=u.useState(!1),[T,B]=u.useState(!1),[,P]=u.useState(0),F=()=>P(S=>S+1),_=u.useRef([]),G=u.useRef(new Set),J=u.useRef(new Set),[X,ge]=u.useState([]),[Q,ce]=u.useState([]),[le,be]=u.useState(0),me=u.useRef(new Map),de=u.useRef(null),{mode:pe}=p,xe=u.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[p.caps,o,a]),Y=xe.pipe,re=p.session.token||"",fe=pe==="client"&&!e;u.useEffect(()=>{if(!re||!Y)return;let S=!0;const K=async()=>{const se=await ss(re);!S||!se||(ce(se.runs),be(Date.now()/1e3-se.now),ge(He=>He.filter(Ee=>!se.runs.some(Be=>_e(Be.company)===_e(Ee.name)))))};K();const H=X.length>0||Q.some(se=>se.status==="running"),te=window.setInterval(()=>{K()},H?8e3:25e3);return()=>{S=!1,window.clearInterval(te)}},[re,Y,X.length,Q.some(S=>S.status==="running")]);const ke=u.useMemo(()=>{const S=[],K=new Set;for(const H of X){const te=_e(H.name);!te||K.has(te)||(K.add(te),S.push({name:H.name,id:H.id,status:"boot",started:H.started,estMin:H.estMin,memoType:"instant"}))}for(const H of Q){const te=_e(H.company);if(!te||K.has(te))continue;K.add(te);const se=H.status==="error"?"error":H.status==="done"?"done":"running";S.push({name:H.company,status:se,started:H.started||0,estMin:H.est_min||(H.memo_type==="detailed"?40:15),url:H.url,error:H.error,memoType:H.memo_type,note:H.note})}return S},[X,Q]),ne=S=>ke.find(K=>_e(K.name)===_e(S))||null,ve=(S,K)=>{ge(H=>H.some(te=>_e(te.name)===_e(S.name))?H:[...H,{name:S.name,id:S.id,started:Date.now()/1e3,estMin:K==="detailed"?40:15}]),G.current.add(S.id),F()};u.useEffect(()=>{if(document.querySelector(`link[href="${Qr}"]`))return;const S=document.createElement("link");S.rel="stylesheet",S.href=Qr,document.head.appendChild(S)},[]);const oe=(S,K=!1)=>{M(S),$(K),de.current&&clearTimeout(de.current),de.current=setTimeout(()=>M(""),K?4200:2400)},Se=S=>oe(S,!0),Ke=u.useMemo(()=>{const S=new Map;return p.dossiers.forEach(K=>{K.id&&S.set(K.id,K)}),S},[p.dossiers]),he=u.useMemo(()=>p.dossiers.filter(S=>ea(S,g,Y)),[p.dossiers,g,Y]),Ce=u.useRef(!1);u.useEffect(()=>{if(Ce.current||e||p.loading||!p.dossiers.length)return;if(!xe.showFunnel||zc(p.session.token||"")){Ce.current=!0;return}Ce.current=!0;const S=window.setTimeout(()=>{Kr(p.session.token||""),j(!0)},700);return()=>window.clearTimeout(S)},[e,p.loading,p.dossiers.length,xe.showFunnel,p.session.token]);const Rt=u.useMemo(()=>p.dossiers.filter(S=>Bs(S,g,Y,p.favIds)),[p.dossiers,g,Y,p.favIds]),Pe=u.useMemo(()=>ts(he.filter(S=>!Ve(S)),p.favIds),[he,p.favIds]),Je=u.useRef(!1);u.useEffect(()=>{if(Je.current)return;if(!Y||a==="ops"){Je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Je.current=!0;return}if(p.loading)return;Je.current=!0;const S=as(Pe);S!==g.ptab&&d({type:"ptab",tab:S})},[Y,a,n==null?void 0:n.ptab,p.loading,Pe,g.ptab]);const qe=u.useMemo(()=>{const S=xo(p.dossiers);return S?ht(S)===0?l.tourToday:go(S,s):l.tourNoRun},[p.dossiers,l,s]),it=u.useMemo(()=>p.dossiers.some(S=>!!S.memoUrl||!!S.summary||Dt(S)),[p.dossiers]),[kt,Oe]=u.useState(!1);u.useEffect(()=>{if(p.loading){Oe(!1);return}if(p.dossiers.length>0||p.error){Oe(!0);return}const S=window.setTimeout(()=>Oe(!0),6e3);return()=>window.clearTimeout(S)},[p.loading,p.dossiers.length,p.error]);const xt=(p.marketEstimate||0)>0||typeof((In=p.stats)==null?void 0:In.screened)=="number"&&p.stats.screened>0,ut=u.useMemo(()=>[1,0,2,4,5,3].find(S=>(Pe[S]||0)>0)??0,[Pe]),Xe=Sn.find(S=>S.key===g.continent),jt=g.continent==="monde"?l.contWorld:(s==="fr"?Xe==null?void 0:Xe.fr:Xe==null?void 0:Xe.en)||"";u.useEffect(()=>{const S=K=>{var te;const H=(((te=K.detail)==null?void 0:te.name)||"").trim();H&&gt(null,H)};return window.addEventListener("ppmap:evaluate",S),()=>window.removeEventListener("ppmap:evaluate",S)}),u.useEffect(()=>{const S=K=>{const H=K.detail||{},te=String(H.id||"").trim(),se=String(H.name||"").trim(),He=String(H.url||"").trim(),Ee=te&&Ke.get(te)||jc(p.dossiers,se,He);if(Ee){if(k(null),ea(Ee,g,Y)||(g.continent!=="monde"&&Ee.continent!==g.continent&&d({type:"continent",key:Ee.continent||"monde"}),d({type:"reset"})),Y&&Ee.kind!=="op"){const st=Ne(Ee);typeof st=="number"&&st!==g.ptab&&d({type:"ptab",tab:st})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:Ee.id}),(Ee.noCo||["media","nominations","recrutements"].includes(Ee.engine||""))&&(Ee.url||Ee.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee.url||"",text:[Ee.headline,Ee.tagline].filter(Boolean).join(`
`)}})):Ee.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ee.name,url:Ee.url||"",website:Ee.website||"",domain:Ee.domain||""}}));return}!se&&!He||(d({type:"focus",id:te||null}),k({name:se,headline:String(H.text||"").trim()||se,url:He,card:H.card}),He&&(Ea(se)||!se)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:He,text:String(H.text||"").trim()}})):se&&!Ea(se)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:se}})))};return window.addEventListener("ppmap:focus",S),()=>window.removeEventListener("ppmap:focus",S)}),u.useEffect(()=>{const S=te=>{const se={},He=String((te==null?void 0:te.sector)||"").trim();He&&(se.sector=[He]);const Ee=String((te==null?void 0:te.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ee)&&(se.day=Ee);const Be=String((te==null?void 0:te.search)||"").trim();Be&&(se.search=Be);const st=String((te==null?void 0:te.dealKind)||"").trim();(st==="ma"||st==="levee"||st==="other")&&(se.dealKind=[st]),Object.keys(se).length&&d({type:"filters",patch:se})},K=te=>S(te.detail),H=te=>{te.data&&te.data.type==="pp-filter"&&S(te.data)};return window.addEventListener("ppmap:filter",K),window.addEventListener("message",H),()=>{window.removeEventListener("ppmap:filter",K),window.removeEventListener("message",H)}},[]),u.useEffect(()=>{const S=K=>{var se;const H=(((se=K.detail)==null?void 0:se.name)||"").trim().toLowerCase();if(!H)return;const te=p.dossiers.find(He=>(He.name||"").trim().toLowerCase()===H);te&&d(a==="ops"?{type:"focus",id:te.id}:{type:"popup",id:te.id})};return window.addEventListener("ppmap:similar",S),()=>window.removeEventListener("ppmap:similar",S)});const gt=(S,K,H)=>{const te=(H||(S==null?void 0:S.name)||K||"").trim();if(!fe){w({kicker:te});return}!te||C||(L(!0),(async()=>{try{let se=(K||te).trim();const He=((S==null?void 0:S.website)||(S==null?void 0:S.domain)||"").trim();if(!(/^https?:\/\//i.test(se)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(se)&&!/\s/.test(se)))if(He)se=He;else try{const Fe=await Cn(te);if(Fe!=null&&Fe.website)se=Fe.website;else if(((Fe==null?void 0:Fe.candidates)||[]).length===1)se=Fe.candidates[0].url;else if(((Fe==null?void 0:Fe.candidates)||[]).length>1){_.current=[{name:te,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(Fe.candidates||[]).slice(0,5)},..._.current].slice(0,8),F();return}}catch{}const Be=await ao(re,se,"atelier2"),st={name:Be.company||te,verdict:Be.verdict,reason:Be.reason||"",remaining:Be.remaining??null};_.current=[st,..._.current].slice(0,8),Be.verdict==="kept"&&q(Fe=>({...Fe,kept:Fe.kept+1})),Be.verdict==="ruled_out"&&q(Fe=>({...Fe,dropped:Fe.dropped+1}));const Ht=S||p.dossiers.find(Fe=>(Fe.name||"").toLowerCase()===te.toLowerCase());Ht&&(Be.verdict==="kept"?Ht.verdict=Ht.verdict||"MATCH":Be.verdict==="ruled_out"&&(Ht.verdict="NO MATCH"),Be.reason&&(Ht.reasoning=Be.reason)),F()}finally{L(!1)}})())},bt=S=>{if(!fe){w({kicker:S.name});return}ve(S,"instant"),Vt(re,"fast_request",S.name||"",""),oe(l.memoInstantSent(S.name))},Ft=S=>me.current.get(S.id)??p.thumbs.get((S.name||"").trim().toLowerCase()),Nt=(S,K)=>d({type:"undoPush",entry:{id:S.id,name:S.name,prevCeoStatus:K}}),Re=async(S,K,H)=>{const te=S.ceoStatus||"";S.ceoStatus=K,F();const se=await Ua(re,{status:K,airtable_id:S.airtableId,check_id:S.checkId,company:S.name,...(H==null?void 0:H.note)!==void 0?{note:H.note}:{},...H!=null&&H.via?{via:H.via}:{}});return se.ok?se.skipped?(S.ceoStatus=te,F(),Se(l.actNotPersisted),!1):((H==null?void 0:H.undo)!==!1&&Nt(S,te),H!=null&&H.msg&&oe(H.msg),(K==="Validé"||K==="Écarté")&&!S.ceoNote&&(H==null?void 0:H.note)===void 0&&O({o:S,yes:K==="Validé"}),!0):(S.ceoStatus=te,F(),Se(l.actErr),!1)},nt=async(S,K)=>{const H=await Ua(re,{status:S.ceoStatus||"Retenu",airtable_id:S.airtableId,check_id:S.checkId,company:S.name,note:K,via:"note"});return!H.ok||H.skipped?(Se(H.skipped?l.actNotPersisted:l.actErr),!1):(S.ceoNote=K,F(),!0)},A=u.useRef(new Map),U=S=>A.current.has(S.id)?A.current.get(S.id):p.stages.get((S.name||"").trim().toLowerCase()),V=(S,K)=>{A.current.set(S.id,K),F()},ae=(S,K)=>{fe&&Re(S,K?"Validé":"Écarté",{msg:K?l.decidedYes(S.name):l.decidedNo(S.name)})},ye=S=>{fe&&Re(S,"À trancher",{msg:l.promoted(S.name)})},I=S=>{fe&&(async()=>{const K=S.ceoStatus||"";S.ceoStatus="Retenu",F();const H=await Ua(re,{status:"Retenu",check_id:S.checkId,company:S.name});if(!H.ok||H.skipped){S.ceoStatus=K,F(),Se(H.skipped?l.actNotPersisted:l.actErr);return}Nt(S,K),oe(l.repeched(S.name))})()},ee=()=>{const S=g.undo[g.undo.length-1];if(!S){oe(l.undoNone);return}const K=Ke.get(S.id);if(!K){d({type:"undoPop"}),oe(l.undoNone);return}let H=S.prevCeoStatus;if(!H)if((K.verdict||"").toUpperCase().includes("CALL"))H="À trancher";else{oe(l.undoLockedTitle);return}(async()=>await Re(K,H,{undo:!1})&&(d({type:"undoPop"}),K.ceoStatus=S.prevCeoStatus,F(),oe(l.undoDone(K.name))))()},ie=S=>{fe&&(J.current.add(S.id),F(),(async()=>{const K=await ls(re,S.name,"email");if(!K||K.ok===!1){J.current.delete(S.id),F(),Se(l.actErr);return}Vt(re,"approach",S.name||"",""),oe(l.actApproachSent)})())},Z=(S,K)=>{fe&&(async()=>{if(!(await Vt(re,K?"yes":"no",S.name||"","")).ok){Se(l.actErr);return}me.current.set(S.id,K?"yes":"no"),F(),oe(K?l.thumbUpDone:l.thumbDnDone)})()},je=S=>{!fe||!Dt(S)||(ve(S,"detailed"),Vt(re,"detailed_request",S.name||"",""),oe(l.memoDeepSent(S.name)))},De=S=>{const K=new Set(p.favIds),H=K.has(S.id);H?K.delete(S.id):K.add(S.id),p.setFavIds(K),fe&&ds(re,{id:S.id,co:S.name},H)},$e=()=>{!fe||T||window.confirm(l.identSyncConfirm)&&(B(!0),(async()=>{const S=await cs(re);B(!1),S?oe(l.identSyncDone):Se(l.actErr)})())},Ae=/proplace/i.test(p.fund||""),Ue=S=>{!fe||!Ae||(Vt(re,"onboard_request",S.name||"",""),oe(l.onboardSent(S.name)))},Pa={st:g,dispatch:d,t:l,lang:s,mode:pe,caps:xe,pipe:Y,token:re,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:I,thumbOf:Ft,canWrite:fe,commitStatus:Re,saveNote:nt,stageOf:U,setStage:V,flashErr:Se,startTour:()=>j(!0),dossiers:p.dossiers,scopedAll:he,scoped:Rt,counts:Pe,byId:Ke,contName:jt,favIds:p.favIds,toggleFav:De,askEvaluate:gt,doAnalyse:bt,doDecide:ae,doPromote:ye,doApproach:ie,doThumb:Z,doDeep:je,doUndo:ee,doSync:$e,doOnboard:Ue,outbound:Ae,memoQueued:G.current,liveMemos:{items:ke,serverOff:le,liveOf:ne},approachDone:J.current,sessTally:N,evalCards:_.current,evalBusy:C,markRow:y,markedId:v,flash:oe,focusExtra:h};u.useEffect(()=>{const S=K=>{K.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",S),()=>window.removeEventListener("keydown",S)},[]);const la=S=>re?t.jsx(Us,{token:re,children:S}):t.jsx(t.Fragment,{children:S});return t.jsx(Yo.Provider,{value:Pa,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(re?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:zs}),la(t.jsxs("div",{className:"app"+(Y?" pipe":"")+(re?" has-thesis":""),children:[xe.showTicker&&t.jsx(rt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(re?" live-stack--cibles":""),children:[t.jsx(Ks,{}),!!re&&t.jsx(Hs,{})]})}),xe.showIdent&&t.jsx(rt,{name:"identite",children:t.jsx(ll,{})}),!1,Sc,xe.showFunnel&&t.jsx(rt,{name:"entonnoir",children:t.jsx(qc,{})}),!g.mapFolded&&t.jsx(rt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Do,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Nc,{}),a!=="ops"&&xe.showFunnel&&t.jsx(Ec,{}),t.jsx(id,{}),t.jsx(Oo,{})]})]})}),xe.showDemand&&Y&&t.jsx(rt,{name:"direct",children:t.jsx(hs,{items:ke,serverOff:le,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([S,K])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===S,onClick:()=>{f(S);try{localStorage.setItem("atl2:chrome-mode",S)}catch{}},children:K},S))}),xe.showDemand&&t.jsx(rt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(fd,{})})}),xe.showDemand&&g.memoConsole&&t.jsx(rt,{name:"console",children:t.jsx(xd,{})}),xe.pipe&&!!re&&t.jsx(rt,{name:"moteurs",children:t.jsx(ws,{})}),t.jsx(rt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(Wd,{})}),p.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:l.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(rt,{name:"fiche",children:t.jsx(Ad,{})}),t.jsx(rt,{name:"modales",children:t.jsx(ec,{})}),t.jsx(Zs,{}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(rl,{placeholder:R.yes?l.whyYesPh:l.whyNoPh,onDone:S=>{const K=R.o;O(null),S&&nt(K,S).then(H=>{H&&oe(l.csNoteSaved)})}})]}),c&&kt&&t.jsx(il,{steps:Ac(l,qe,it,ut,xt,Pe[3]||0),onClose:()=>{j(!1),Kr(re)}}),t.jsx(Cc,{}),xe.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:fo,children:qn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),z&&t.jsx("div",{className:"flash on"+(D?" err":""),children:z}),E&&t.jsx(ns,{variant:"acquirer",initialCompany:Jr().co,initialWebsite:Jr().site,onClose:()=>w(null)})]})})}function qc(){const{t:e}=W(),[a,r]=u.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Jr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Tc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Qo as FlagCell,yt as SigBadge,Ia as SigWin,Fc as default,Tc as fmtShort,W as useV2};
