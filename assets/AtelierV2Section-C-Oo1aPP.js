...
.atl2 .bulk .side .hint{white-space:nowrap}`,Fl=`
...
`,Ml=Ll+Fl+Rl+Ol;function En(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Dl(){const e=En("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Il(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Dl();return r==="0"?"client":r==="1"||En("embed")==="1"&&En("chrome")==="1"?"apercu":"client"}const Pl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},_l=e=>Pl[e];function Qt(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Dt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Xa(a)||Qt(a))&&(e.noCo=!0)}return Object.assign(e,{continent:as(e.cc)})};function sn(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Bl=60*60*1e3;function $l(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Bl?null:a}catch{return null}}function Ea(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ul=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Hl(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:Vi(),[e,n]),i=p.useMemo(()=>n?"visiteur":Il(e,o),[e,o,n]),d=p.useMemo(()=>_l(i),[i]),s=i!=="visiteur",l=Ul(r),[m,c]=p.useState([]),[g,u]=p.useState(""),[b,h]=p.useState(null),[v,y]=p.useState(null),[f,w]=p.useState(null),[E,k]=p.useState(()=>new Map),[j,N]=p.useState(()=>new Map),[A,L]=p.useState(""),[T,z]=p.useState(new Set),[R,B]=p.useState(null),[H,M]=p.useState(!0),[x,F]=p.useState(!1),[C,_]=p.useState(0),[G,Z]=p.useState(0),re=p.useRef(0),S=p.useMemo(()=>{var I;if(i!=="client")return"";try{return((I=Wi())==null?void 0:I.email)||""}catch{return""}},[i]);p.useEffect(()=>{const I=++re.current;let ee=!0;const U=()=>ee&&I===re.current,oe=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),me=$l(oe);return me?(c(me.objs.map(Dt)),me.fund&&u(me.fund),h(me.marketEstimate??null),y(me.criteria??null),w(me.stats??null),L(me.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const xe=await an(),ye=((xe==null?void 0:xe.recent_ops)||[]).map(ce=>{const ze=Fa(ce.company_name||ce.title?ce:{...ce,title:(ce.headline_fr||ce.headline||"").slice(0,120)},a),Ae=String(ce.rubrique||"").toLowerCase();return ze&&(Ae==="nominations"||Ae==="recrutements")&&(ze.engine=Ae),ze&&!String(ce.company_name||"").trim()&&(ze.noCo=!0),ze}).filter(ce=>!!ce).map(ce=>(Xa((ce.name||"").trim())||(ce.noCo=!0),ce));try{const ce=Gi(),ze=await Yi(),Ae=((ze==null?void 0:ze.date)||"").slice(0,10),ue=ce?ce.doc:ze,ve=Qi(ue),ke=((ce==null?void 0:ce.day)||(ue==null?void 0:ue.date)||Ae||"").slice(0,10);if(ke&&ve.length){const te=new Set;for(const P of ye){if((P.date||"").slice(0,10)!==ke)continue;const K=sr(ve,te,P.name,"");K>=0&&(te.add(K),P.decryptHtml=ve[K].html)}for(const P of ye){if(P.decryptHtml||(P.date||"").slice(0,10)!==ke)continue;const K=sr(ve,te,"",P.headline||P.tagline||P.name);K>=0&&(te.add(K),P.decryptHtml=ve[K].html)}}if(ke){const te=((ue==null?void 0:ue.title_fr)||"").trim(),P=((ue==null?void 0:ue.lead_fr)||"").trim(),K=Ki(ue),le=((ue==null?void 0:ue.url)||"").trim();te&&(K||le)&&ye.unshift({id:`edito:${ke}`,kind:"op",name:te,cc:null,date:ke,engine:"edito",dealKind:"other",headline:te,tagline:P||te,decryptHtml:K||void 0,url:le,noCo:!0})}}catch{}if(!U())return;c(ye.map(Dt)),Ea(oe,{objs:ye})}else if(typeof r=="object"){const ye=(await lr()||[]).filter(ze=>(ze.slug||"")===r.research).map(ze=>dr(ze,a)).filter(ze=>!!ze),ce=sn(await pr(ye,a));if(!U())return;c(ce.map(Dt)),Ea(oe,{objs:ce})}else if(s&&o.token){const xe=Ji(o.token),ye=an(),ce=Xi(o.token),ze=Zi(o.token),Ae=es(o.token),ue=await xe;let ve=ue?ue.targets:[];U()&&ue&&(u(ue.fund||""),h(ue.marketEstimate??null),y(ue.criteria??null),w(ue.stats??null),L(ue.generatedAt||""),c(ve.map(Dt)),M(!1),F(!1));const[ke,te,P,K]=await Promise.all([ye,ce,ze,Ae]),le=((ke==null?void 0:ke.recent_ops)||[]).map(V=>Fa(V,a)).filter(V=>!!V),se=new Set(ve.map(V=>V.id));if(ve=[...ve,...le.filter(V=>!se.has(V.id)&&(se.add(V.id),!0))],!U())return;c(ve.map(Dt));const fe=new Set;for(const V of te){const de=(V.id||V.co||"").toString().trim().toLowerCase();de&&fe.add(de.startsWith("t:")?de:"t:"+de)}z(fe),k(P),N(K),ue&&Ea(oe,{fund:ue.fund,marketEstimate:ue.marketEstimate,criteria:ue.criteria,stats:ue.stats,generatedAt:ue.generatedAt,objs:ve})}else{const xe=ts(),ye=lr(),ce=an(),ze=await xe;U()&&ze.length&&(c(sn(ze).map(Dt)),M(!1),F(!1));const[Ae,ue]=await Promise.all([ye,ce]),ve=(Ae||[]).map(K=>dr(K,a)).filter(K=>!!K),ke=await pr(ve,a),te=((ue==null?void 0:ue.recent_ops)||[]).map(K=>Fa(K,a)).filter(K=>!!K),P=sn([...ze,...ke,...te]);if(!U())return;c(P.map(Dt)),Ea(oe,{objs:P})}U()&&F(!1)}catch{U()&&!me&&F(!0)}finally{U()&&M(!1)}})(),()=>{ee=!1}},[s,o.token,a,C,l]),p.useEffect(()=>{if(!d.showCredits||!S){B(null);return}let I=!0;return(async()=>{try{const ee=await fetch(`${wa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:S})});if(!ee.ok)return;const U=await ee.json();I&&U&&U.ok!==!1&&B(U)}catch{}})(),()=>{I=!1}},[d.showCredits,S,G]);const $=p.useCallback(I=>z(new Set(I)),[]);return{session:o,mode:i,caps:d,fund:g,email:S,marketEstimate:b,generatedAt:A,criteria:v,thesisMode:String((v==null?void 0:v.mode)||""),stats:f,thumbs:E,stages:j,dossiers:m,patchStatuses:(I,ee)=>{c(U=>{let oe=!1;const me=U.map(xe=>{if(!xe.checkId)return xe;const ye=I.get(xe.checkId);return!ye||ye===(xe.ceoStatus||"")||!ee(xe.id)?xe:(oe=!0,{...xe,ceoStatus:ye})});return oe?me:U})},favIds:T,setFavIds:$,credits:R,reloadCredits:()=>Z(I=>I+1),loading:H,error:x,refresh:()=>_(I=>I+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Ra=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function $a(e){return Ra.has(e.engine||"")}function at(e){return!!e.noCo||$a(e)&&!!e.url}const Vo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Vl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Vo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Wl=new Set(["signal","amount","score","crible","memo"]);function Gl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Vo(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Wl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Wo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Wo=80;function Ua(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!He(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes($n(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(gt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&It(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(zo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function Pt(e,a,r){return We(e)?Ua(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ua(e,a.filters,r)}function Yl(e,a,r,n){return!(!Pt(e,a,r)||r&&!So(e,a.ptab,n))}function Gn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-gt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return rs(o)||null;case"memo":return ns(o)||null;case"signal":{const i=He(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),s=n(i);return d===null||s===null?d===s?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<s?-a.dir:d>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const ln={},Ar=(ln==null?void 0:ln.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function qr(){return new Date().toISOString().slice(0,10)}const Yn=p.createContext(null);function Go(){return p.useContext(Yn)}function Ql(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const m=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(c=>l.removeAttribute(c.name)),m&&/^https?:\/\//i.test(m)&&(l.setAttribute("href",m),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Yo(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Kl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Yo(r),r.innerHTML):e}catch{return e}}function Tr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Yo(r),r.innerHTML):e}catch{return e}}function Lr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Qo(){const e=p.useContext(Yn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Jl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=X(),[i,d]=p.useState(()=>n.filters.day||qr()),[s,l]=p.useState(null),[m,c]=p.useState(!1),g=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){d(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{d(qr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=y=>{var w;const f=(w=y.detail)==null?void 0:w.day;typeof f=="string"&&g(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[g]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;c(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Ar}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{v||l(f)}).catch(()=>{v||l({ok:!1,error:"network"})}).finally(()=>{v||c(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${Ar}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),h=p.useMemo(()=>({token:e,day:i,ed:s,loading:m,pickDay:g,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,m,g,u,n.filters.day,b,o]);return t.jsx(Yn.Provider,{value:h,children:a})}function Xl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Qo(),[o,i]=p.useState(()=>n||Co());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(Ia,d),()=>window.removeEventListener(Ia,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(os,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Zl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Fr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Rr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function ed(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Qo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!d,l=a&&!a.ok,m=p.useRef(null),[c,g]=p.useState("fonds"),[u,b]=p.useState(null),[h,v]=p.useState("idle"),y=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),y.current=!1,g("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||y.current)return;y.current=!0;let j=!0;return v("load"),Zl(e).then(N=>{j&&(b(N),v("fait"))}),()=>{j=!1}},[c,e]);const f=p.useMemo(()=>Kl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),w=p.useRef(null);p.useEffect(()=>{const j=w.current;if(!j||!f)return;let N=!1;return wn(()=>import("./fit-DX-mzLKR.js"),[]).then(async A=>{await A.ensureEditoCss(),!(N||!j.isConnected)&&(A.beautifyEditoRows(j),A.mountCardFits(j))}),()=>{N=!0}},[f]);const E=p.useMemo(()=>Tr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>Tr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const j=m.current;if(!j||!E)return;let N=!1;return wn(()=>import("./fit-DX-mzLKR.js"),[]).then(async A=>{await A.ensureEditoCss(),!(N||!j.isConnected)&&(A.beautifyEditoRows(j),A.mountCardFits(j))}),()=>{N=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>g("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>g("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Fr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Lr(e,!0)}),"."]}):Fr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Lr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>g("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&E?t.jsx("div",{ref:m,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:u.title}),t.jsx("div",{ref:w,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:h==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:h!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Rr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Rr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const td=300,ja=7,ad={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Ko={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},nd=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Na(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ds(r)&&r!=="media")return"news:"+r;const n=He(e);return n?"sig:"+(n.theme&&Ko.fr[n.theme]?n.theme:"other"):"actualites"}function rd(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:s}=X(),l=Go(),m=d==="en",[c,g]=p.useState("all"),[u,b]=p.useState(!1),h=p.useMemo(()=>{var ee;const x=(a.filters.day||"").slice(0,10),F=U=>!(!i&&a.continent!=="monde"&&U.continent!==a.continent||x&&(U.date||"").slice(0,10)!==x),C=e.filter(U=>F(U)&&He(U)&&(!i||U.kind!=="target"||Te(U)!==5)),_=i&&(((ee=l==null?void 0:l.ed)==null?void 0:ee.ops)||[]).length?l.ed.ops.map(U=>Fa(U,d)).filter(U=>!!U).map(U=>(U.briefOnly=!0,U)).filter(U=>!x||(U.date||"").slice(0,10)===x):[],G=e.filter(U=>F(U)&&U.kind==="op"&&(x?!0:gt(U.date)<=ja)),Z=i?_.length?_:G.filter(U=>{const oe=(s||"").trim().toLowerCase();if(!oe)return!1;const me=U.match||null;return me?Object.keys(me).map(xe=>xe.trim().toLowerCase()).includes(oe):!1}):G,re=x||new Date().toISOString().slice(0,10),S=U=>{const oe=Na(U);return oe==="ma"?0:oe==="levees"?1:2};Z.sort((U,oe)=>{const me=S(U)-S(oe);if(me)return me;const xe=(U.date||"").slice(0,10)===re?0:1,ye=(oe.date||"").slice(0,10)===re?0:1;return xe!==ye?xe-ye:(oe.amountEur||0)-(U.amountEur||0)});const $=new Set,I=[];for(const U of[...Z,...Gn(C,{key:"signal",dir:-1})]){const oe=U.id||U.name;!oe||$.has(oe)||($.add(oe),I.push(U))}return i&&I.length===0?e.filter(oe=>F(oe)&&gt(oe.date)<=ja).sort((oe,me)=>(me.date||"").localeCompare(oe.date||"")).slice(0,80):I},[e,a.continent,a.filters.day,i,s,d,l]),v=p.useMemo(()=>{const x={};for(const F of h){const C=Na(F);x[C]=(x[C]||0)+1}return x},[h]),y=p.useMemo(()=>c==="all"?h:h.filter(x=>Na(x)===c),[h,c]),f=p.useMemo(()=>y.slice(0,td),[y]),w=y.length-f.length,E=p.useRef(null);p.useEffect(()=>{var Z,re;const x=E.current;if(!x)return;const F=()=>{const S=x.scrollWidth;S<200||(x.style.animationDuration=Math.max(18,Math.round(S/130))+"s")};F();const C=requestAnimationFrame(F),_=window.setTimeout(F,1200);let G=!0;return(re=(Z=document.fonts)==null?void 0:Z.ready)==null||re.then(()=>{G&&F()}),()=>{G=!1,cancelAnimationFrame(C),window.clearTimeout(_)}},[f.length,c]);const k=x=>x==="all"?h.length:v[x]||0,j=x=>{if(x==="all")return m?"All":"Tout";if(x.startsWith("sig:"))return Ko[m?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const F=x.slice(5);return ss[F]?ls(F,m?"en":"fr"):x}return ad[m?"en":"fr"][x]},N=[{k:"all"}],A=["ma","levees"].filter(x=>k(x)>0||x===c);if(A.length){N.push({g:m?"Deals":"Opérations"});for(const x of A)N.push({k:x})}const L=["nominations","recrutements"].filter(x=>k(x)>0||x===c),T=is.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===c),z=k("actualites")>0||c==="actualites"?["actualites"]:[];if(L.length||T.length||z.length){N.push({g:m?"News":"Actualités"});for(const x of L)N.push({k:x});for(const x of T)N.push({k:x});for(const x of z)N.push({k:x})}const R=nd.map(x=>"sig:"+x).filter(x=>k(x)>0||x===c);if(R.length){N.push({g:m?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of R)N.push({k:x})}const B=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(m?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},H=(()=>{const x=(a.filters.day||"").slice(0,10),F=!i&&a.continent!=="monde"&&o?m?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(m?`LIVE covers the events of ${B(x)}.`:`Le LIVE regroupe les événements du ${B(x)}.`)+F:(m?`LIVE covers the still-open signals and the deals of the last ${ja} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ja} derniers jours.`)+F})(),M=x=>f.map(F=>t.jsxs("button",{type:"button",className:"tk"+(Ye(F)?" spent":""),onClick:C=>{const _=F.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:_?"":F.id,name:F.name,url:F.url||"",text:F.tagline||F.headline||"",card:F.card}}))}catch{}if(_||n({type:"focus",id:F.id}),a.dens!=="liste"){const G=C.currentTarget.getBoundingClientRect();n({type:"popup",id:F.id,anchor:{x:G.left+G.width/2,y:G.bottom}})}},title:Ye(F)?m?`${F.name} — already screened (dimmed)`:`${F.name} — déjà évaluée (grisée)`:F.name+(F.tagline?" — "+F.tagline:""),children:[t.jsx(Lt,{o:F}),t.jsxs("span",{className:"who",children:[t.jsx(Ri,{o:F}),t.jsx("span",{className:"co",children:F.name})]}),(()=>{const C=(F.tagline||F.headline||"").trim();if(C&&C!==F.name)return t.jsx("span",{className:"what",children:C});const _=Na(F),G=_==="ma"?m?"M&A deal":"opération M&A":_==="levees"?m?"fundraising":"levée de fonds":_==="nominations"?m?"appointment":"nomination":_==="recrutements"?m?"hiring":"recrutement":_.startsWith("sig:")?m?"engine signal":"signal moteur":_.startsWith("news:")?m?"news":"actualité":F.kind==="target"?m?"sourced target":"cible sourcée":m?"news item":"actualité";return t.jsx("span",{className:"what dim",children:G})})(),typeof F.amountEur=="number"&&F.amountEur>0&&t.jsx("span",{className:"am",children:ou(F.amountEur)}),F.sector&&t.jsx("span",{className:"mt",children:F.sector}),t.jsx(en,{o:F}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(F.id||F.name))).concat(w>0?[t.jsx("span",{className:"tk quiet",children:m?`+ ${w} more — filter by section to see them`:`+ ${w} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(x=>!x),children:[j(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:H}),N.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===c,onClick:()=>{g(x.k),b(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:E,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:m?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",m?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(id,{isEn:m})]})}const od=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function id({isEn:e}){const[a,r]=p.useState(()=>Co());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Ia,o),()=>window.removeEventListener(Ia,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ps(!a),children:od})}class ft extends p.Component{constructor(){super(...arguments);rr(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Jo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Or(e,a){if((Ft(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Jo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Mr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",sd={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function ld({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=X(),[s,l]=p.useState(""),[m,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!g)return;const w=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),c(!1))};return document.addEventListener("click",w,!0),()=>document.removeEventListener("click",w,!0)},[g]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const h=(e.ceoStatus||"").trim(),v=async w=>{if(s)return;if(w==="Analysé"&&!e.memoUrl){c(!0);return}l(w);const E=(Or(e,a).find(([j])=>j===w)||[w,w])[1],k=await o(e,w,{msg:a.csMoved(e.name,E)});l(""),k&&(c(!1),u(!1))},y=Or(e,a),f=w=>(y.find(([E])=>E===w)||[])[1]||w;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:w=>w.stopPropagation(),children:y.map(([w,E])=>t.jsx("button",{type:"button",className:"rsd "+(w==="Validé"?"yes":"no")+(s===w?" busy":""),disabled:!!s,onClick:()=>{v(w)},children:E},w))}):t.jsxs("span",{className:"rstat"+(g||m?" rs-open":""),ref:b,onClick:w=>w.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":g,disabled:!!s,title:a.csLabel,className:"rsel rs-"+Mr(h),onClick:()=>{u(w=>!w),c(!1)},children:s?f(s)+"…":h?f(h):a.csNone}),g&&!m&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([w,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":h===w,className:"rsopt"+(h===w?" on":"")+(s===w?" busy":""),disabled:!!s,onClick:()=>{if(w===h){u(!1);return}v(w)},children:[t.jsx("i",{className:"pt2",style:{background:sd[Mr(w)]}}),E]},w))}),m&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const w=await o(e,"Analysé");l(""),w&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function dd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=X(),[i,d]=p.useState(""),[s,l]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const m=(e.ceoStatus||"").trim(),c=(Ft(e)||"").startsWith("CALL")&&Te(e)===3,g=Te(e)>=2,u=async h=>{if(i||h==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(h);const v=await o(e,h);d(""),v&&(l(!0),setTimeout(()=>l(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:Jo.filter(([h])=>!(g&&h==="Retenu")).map(([h,v])=>[h,a[v]]);return t.jsxs("div",{className:"csp",onClick:h=>h.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([h,v])=>t.jsx("button",{type:"button",className:"csb"+(m===h?" on":"")+(i===h?" busy":""),disabled:!!i,onClick:()=>{u(h)},children:v},h)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(pd,{o:e})]})}function pd({o:e}){const{t:a,saveNote:r,flash:n}=X(),[o,i]=p.useState(e.ceoNote||""),[d,s]=p.useState(!1),[l,m]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),g=async()=>{if(d||!c)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(m(!0),setTimeout(()=>m(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&g()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{g()},children:l?a.csNoteSaved:a.csNoteOk})]})}function Dr({placeholder:e,onDone:a}){const{t:r}=X(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function cd({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:s}=X(),[l,m]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const c=i(e),g=(c==null?void 0:c.stage)||"todo",u=async f=>{if(l||f===g)return;m(!0);const w=c;d(e,{stage:f,stamps:(c==null?void 0:c.stamps)||{}});const E=Math.max(Date.now(),Ir+=1);Ir=E;const k=await cs(r,{company:e.name||"",stage:f,cts:E,deal_id:e.airtableId,check_id:e.checkId});m(!1),!k.stale&&(k.ok||(d(e,w),s(a.actErr)))},b=(y=c==null?void 0:c.stamps)==null?void 0:y.sent,h=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=g==="sent"&&b&&h>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,w])=>t.jsx("button",{type:"button",className:"stgb"+(g===f?" on":""),disabled:l,onClick:()=>{u(f)},children:w},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(h)})]})}let Ir=0;const ra=8,qt=360;function Pr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function _r({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Pr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Pr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function ud({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=X(),[d,s]=p.useState(0),[l,m]=p.useState(null),[c,g]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),h=p.useRef(!1);p.useEffect(()=>{const A=b.current;return()=>{h.current||(n({type:"ptab",tab:A.ptab}),n({type:"dens",dens:A.dens}),n({type:"modal",modal:A.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,g(e.filter(A=>!!document.querySelector(A.need||A.sel))))},[e]);const v=c[d],y=d>=c.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const A=v.click,L=window.setTimeout(()=>{const T=document.querySelector(A);T&&T.getAttribute("aria-selected")!=="true"&&T.click()},60);return()=>window.clearTimeout(L)}},[d,v]);const f=p.useRef(-1),w=p.useCallback(()=>{if(!v){m(null);return}const A=z=>{if(!z)return null;for(const R of document.querySelectorAll(z)){const B=R.getBoundingClientRect();if(B.width>1&&B.height>1)return R}return null},L=A(v.sel)||A(v.need);if(!L){m(null);return}f.current!==d&&(f.current=d,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const T=L.getBoundingClientRect();m(z=>z&&Math.abs(z.top-T.top)<1&&Math.abs(z.left-T.left)<1&&Math.abs(z.width-T.width)<1&&Math.abs(z.height-T.height)<1?z:T)},[v,d]);p.useLayoutEffect(()=>{w();const A=[90,300,700,1300].map(z=>window.setTimeout(w,z)),L=window.setInterval(w,400),T=()=>w();return window.addEventListener("scroll",T,!0),window.addEventListener("resize",T),()=>{A.forEach(z=>window.clearTimeout(z)),window.clearInterval(L),window.removeEventListener("scroll",T,!0),window.removeEventListener("resize",T)}},[w]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const A=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),E.current()):L.key==="ArrowRight"?s(T=>T+1):L.key==="ArrowLeft"&&s(T=>Math.max(0,T-1))};return document.addEventListener("keydown",A,!0),()=>document.removeEventListener("keydown",A,!0)},[]),!c.length)return null;let k=null;const j=A=>()=>{h.current=!0,n({type:"modal",modal:null}),A()};if(y){const A=o[3]||0;A>0?k={title:A===1?r.ahaATitle1:r.ahaATitleN(A),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:qt};if(!y&&l){const A=l.bottom+14,L=window.innerHeight-A;let T=L>190?A:Math.max(12,l.top-200),z=Math.min(Math.max(12,l.left+l.width/2-qt/2),window.innerWidth-qt-12);L<=190&&l.top<212&&(window.innerWidth-l.right>=qt+40?z=Math.min(l.right+26,window.innerWidth-qt-12):l.left>=qt+40&&(z=Math.max(12,l.left-qt-26)),T=Math.max(12,l.top-ra)),N={left:z,top:T,width:qt}}return Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-ra,top:l.top-ra,width:l.width+ra*2,height:l.height+ra*2}}),(y||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:N,children:[y&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(_r,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(_r,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>s(A=>Math.max(0,A-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(A=>A+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Xo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Zo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function md(){var L,T;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:s,dispatch:l}=X(),m=r?a:e,c=p.useMemo(()=>m.filter(z=>gt(z.date)===0&&z.kind==="target"),[m]),g=p.useMemo(()=>r?a.filter(z=>z.kind==="target"&&Te(z)===0).slice().sort((z,R)=>(R.date||"").localeCompare(z.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(z=>r?Te(z)===0:!Ye(z)),[c,r]),b=r?g:u,h=r?a.length-g.length:c.length-u.length,v=r?a.length:c.length,y=v?Math.min(100,h/v*100):100,f=p.useMemo(()=>Xo(m),[m]),w=!!f&&gt(f)>0,E=p.useMemo(()=>w?m.filter(z=>(z.date||"").slice(0,10)===f):[],[m,f,w]),k=typeof((L=s.stats)==null?void 0:L.kept_today)=="number"?s.stats.kept_today:null,j=typeof((T=s.stats)==null?void 0:T.screened_today)=="number"?s.stats.screened_today:c.length;let N;w?N=o.morningLast(E.length,g.length,Zo(f,d)):r?N=o.morningThesis(j,g.length,k):c.length?h===0?N=o.goalSourced(c.length):h>=c.length?N=o.goalCleared:N=o.goalDone(h,c.length):N=o.goalSourced(0);const A=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(z=>z.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:A,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function fd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:s}=X(),l=i==="client",[m,c]=p.useState(!1),[g,u]=p.useState(""),b=()=>{!l||m||!n||(c(!0),u(""),us(n).then(y=>{if(c(!1),y.pending){u(e.refreshSlow);return}if(!y.ok){y.error&&console.warn("[republish]",y.error),u(e.refreshKo);return}const f=y.entered??0,w=y.left??0;u(y.unchanged||!f&&!w?e.refreshSame:e.refreshDone(f,w)),o.refresh()}))},h=(n||"P").split(/\s+/).map(y=>y[0]).join("").slice(0,2).toUpperCase(),v=(()=>{const y=Date.parse(o.generatedAt||"");if(Number.isNaN(y))return"";const f=new Date(y),w=E=>String(E).padStart(2,"0");return`${w(f.getDate())}/${w(f.getMonth()+1)} à ${w(f.getHours())}:${w(f.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),v?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(v)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!l||m,onClick:b,children:m?"⏳":"📰"}),(m||!!g)&&t.jsxs("span",{className:"repubst",children:[m?e.refreshRun:g,!m&&t.jsx("button",{type:"button",onClick:()=>u(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!l,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:y=>r({type:"filters",patch:{search:y.target.value}})})]})]})})}class Bt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,s=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);s&&(r[n++]=s),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*hd(e){for(const a of e)yield*a}function ei(e){return Array.from(hd(e))}var Le=1e-6,Ce=Math.PI,dt=Ce/2,Br=Ce/4,ct=Ce*2,Et=180/Ce,nt=Ce/180,Oe=Math.abs,gd=Math.atan,fa=Math.atan2,De=Math.cos,Ie=Math.sin,xd=Math.sign||function(e){return e>0?1:e<0?-1:0},Vt=Math.sqrt;function bd(e){return e>1?0:e<-1?Ce:Math.acos(e)}function ha(e){return e>1?dt:e<-1?-dt:Math.asin(e)}function pt(){}function Ha(e,a){e&&Ur.hasOwnProperty(e.type)&&Ur[e.type](e,a)}var $r={Feature:function(e,a){Ha(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ha(r[n].geometry,a)}},Ur={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){jn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)jn(r[n],a,0)},Polygon:function(e,a){Hr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Hr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ha(r[n],a)}};function jn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Hr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)jn(e[r],a,1);a.polygonEnd()}function Wt(e,a){e&&$r.hasOwnProperty(e.type)?$r[e.type](e,a):Ha(e,a)}function Nn(e){return[fa(e[1],e[0]),ha(e[2])]}function Kt(e){var a=e[0],r=e[1],n=De(r);return[n*De(a),n*Ie(a),Ie(r)]}function Sa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Va(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function dn(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function za(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Sn(e){var a=Vt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function zn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function Cn(e,a){return Oe(e)>Ce&&(e-=Math.round(e/ct)*ct),[e,a]}Cn.invert=Cn;function vd(e,a,r){return(e%=ct)?a||r?zn(Wr(e),Gr(a,r)):Wr(e):a||r?Gr(a,r):Cn}function Vr(e){return function(a,r){return a+=e,Oe(a)>Ce&&(a-=Math.round(a/ct)*ct),[a,r]}}function Wr(e){var a=Vr(e);return a.invert=Vr(-e),a}function Gr(e,a){var r=De(e),n=Ie(e),o=De(a),i=Ie(a);function d(s,l){var m=De(l),c=De(s)*m,g=Ie(s)*m,u=Ie(l),b=u*r+c*n;return[fa(g*o-b*i,c*r-u*n),ha(b*o+g*i)]}return d.invert=function(s,l){var m=De(l),c=De(s)*m,g=Ie(s)*m,u=Ie(l),b=u*o-g*i;return[fa(g*o+u*i,c*r+b*n),ha(b*r-c*n)]},d}function wd(e,a,r,n,o,i){if(r){var d=De(a),s=Ie(a),l=n*r;o==null?(o=a+n*ct,i=a-l/2):(o=Yr(d,o),i=Yr(d,i),(n>0?o<i:o>i)&&(o+=n*ct));for(var m,c=o;n>0?c>i:c<i;c-=l)m=Nn([d,-s*De(c),-s*Ie(c)]),e.point(m[0],m[1])}}function Yr(e,a){a=Kt(a),a[0]-=e,Sn(a);var r=bd(-a[1]);return((-a[2]<0?-r:r)+ct-Le)%ct}function ti(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:pt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Oa(e,a){return Oe(e[0]-a[0])<Le&&Oe(e[1]-a[1])<Le}function Ca(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function ai(e,a,r,n,o){var i=[],d=[],s,l;if(e.forEach(function(h){if(!((v=h.length-1)<=0)){var v,y=h[0],f=h[v],w;if(Oa(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),s=0;s<v;++s)o.point((y=h[s])[0],y[1]);o.lineEnd();return}f[0]+=2*Le}i.push(w=new Ca(y,h,null,!0)),d.push(w.o=new Ca(y,null,w,!1)),i.push(w=new Ca(f,h,null,!1)),d.push(w.o=new Ca(f,null,w,!0))}}),!!i.length){for(d.sort(a),Qr(i),Qr(d),s=0,l=d.length;s<l;++s)d[s].e=r=!r;for(var m=i[0],c,g;;){for(var u=m,b=!0;u.v;)if((u=u.n)===m)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,l=c.length;s<l;++s)o.point((g=c[s])[0],g[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)o.point((g=c[s])[0],g[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Qr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function pn(e){return Oe(e[0])<=Ce?e[0]:xd(e[0])*((Oe(e[0])+Ce)%ct-Ce)}function yd(e,a){var r=pn(a),n=a[1],o=Ie(n),i=[Ie(r),-De(r),0],d=0,s=0,l=new Bt;o===1?n=dt+Le:o===-1&&(n=-dt-Le);for(var m=0,c=e.length;m<c;++m)if(u=(g=e[m]).length)for(var g,u,b=g[u-1],h=pn(b),v=b[1]/2+Br,y=Ie(v),f=De(v),w=0;w<u;++w,h=k,y=N,f=A,b=E){var E=g[w],k=pn(E),j=E[1]/2+Br,N=Ie(j),A=De(j),L=k-h,T=L>=0?1:-1,z=T*L,R=z>Ce,B=y*N;if(l.add(fa(B*T*Ie(z),f*A+B*De(z))),d+=R?L+T*ct:L,R^h>=r^k>=r){var H=Va(Kt(b),Kt(E));Sn(H);var M=Va(i,H);Sn(M);var x=(R^L>=0?-1:1)*ha(M[2]);(n>x||n===x&&(H[0]||H[1]))&&(s+=R^L>=0?1:-1)}}return(d<-Le||d<Le&&l<-1e-12)^s&1}function ni(e,a,r,n){return function(o){var i=a(o),d=ti(),s=a(d),l=!1,m,c,g,u={point:b,lineStart:v,lineEnd:y,polygonStart:function(){u.point=f,u.lineStart=w,u.lineEnd=E,c=[],m=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=y,c=ei(c);var k=yd(m,n);c.length?(l||(o.polygonStart(),l=!0),ai(c,Ed,k,r,o)):k&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),c=m=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function h(k,j){i.point(k,j)}function v(){u.point=h,i.lineStart()}function y(){u.point=b,i.lineEnd()}function f(k,j){g.push([k,j]),s.point(k,j)}function w(){s.lineStart(),g=[]}function E(){f(g[0][0],g[0][1]),s.lineEnd();var k=s.clean(),j=d.result(),N,A=j.length,L,T,z;if(g.pop(),m.push(g),g=null,!!A){if(k&1){if(T=j[0],(L=T.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),N=0;N<L;++N)o.point((z=T[N])[0],z[1]);o.lineEnd()}return}A>1&&k&2&&j.push(j.pop().concat(j.shift())),c.push(j.filter(kd))}}return u}}function kd(e){return e.length>1}function Ed(e,a){return((e=e.x)[0]<0?e[1]-dt-Le:dt-e[1])-((a=a.x)[0]<0?a[1]-dt-Le:dt-a[1])}const Kr=ni(function(){return!0},jd,Sd,[-Ce,-dt]);function jd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var s=i>0?Ce:-Ce,l=Oe(i-a);Oe(l-Ce)<Le?(e.point(a,r=(r+d)/2>0?dt:-dt),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=Ce&&(Oe(a-n)<Le&&(a-=n*Le),Oe(i-s)<Le&&(i-=s*Le),r=Nd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=d),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Nd(e,a,r,n){var o,i,d=Ie(e-r);return Oe(d)>Le?gd((Ie(a)*(i=De(n))*Ie(r)-Ie(n)*(o=De(a))*Ie(e))/(o*i*d)):(a+n)/2}function Sd(e,a,r,n){var o;if(e==null)o=r*dt,n.point(-Ce,o),n.point(0,o),n.point(Ce,o),n.point(Ce,0),n.point(Ce,-o),n.point(0,-o),n.point(-Ce,-o),n.point(-Ce,0),n.point(-Ce,o);else if(Oe(e[0]-a[0])>Le){var i=e[0]<a[0]?Ce:-Ce;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function zd(e){var a=De(e),r=2*nt,n=a>0,o=Oe(a)>Le;function i(c,g,u,b){wd(b,e,r,u,c,g)}function d(c,g){return De(c)*De(g)>a}function s(c){var g,u,b,h,v;return{lineStart:function(){h=b=!1,v=1},point:function(y,f){var w=[y,f],E,k=d(y,f),j=n?k?0:m(y,f):k?m(y+(y<0?Ce:-Ce),f):0;if(!g&&(h=b=k)&&c.lineStart(),k!==b&&(E=l(g,w),(!E||Oa(g,E)||Oa(w,E))&&(w[2]=1)),k!==b)v=0,k?(c.lineStart(),E=l(w,g),c.point(E[0],E[1])):(E=l(g,w),c.point(E[0],E[1],2),c.lineEnd()),g=E;else if(o&&g&&n^k){var N;!(j&u)&&(N=l(w,g,!0))&&(v=0,n?(c.lineStart(),c.point(N[0][0],N[0][1]),c.point(N[1][0],N[1][1]),c.lineEnd()):(c.point(N[1][0],N[1][1]),c.lineEnd(),c.lineStart(),c.point(N[0][0],N[0][1],3)))}k&&(!g||!Oa(g,w))&&c.point(w[0],w[1]),g=w,b=k,u=j},lineEnd:function(){b&&c.lineEnd(),g=null},clean:function(){return v|(h&&b)<<1}}}function l(c,g,u){var b=Kt(c),h=Kt(g),v=[1,0,0],y=Va(b,h),f=Sa(y,y),w=y[0],E=f-w*w;if(!E)return!u&&c;var k=a*f/E,j=-a*w/E,N=Va(v,y),A=za(v,k),L=za(y,j);dn(A,L);var T=N,z=Sa(A,T),R=Sa(T,T),B=z*z-R*(Sa(A,A)-1);if(!(B<0)){var H=Vt(B),M=za(T,(-z-H)/R);if(dn(M,A),M=Nn(M),!u)return M;var x=c[0],F=g[0],C=c[1],_=g[1],G;F<x&&(G=x,x=F,F=G);var Z=F-x,re=Oe(Z-Ce)<Le,S=re||Z<Le;if(!re&&_<C&&(G=C,C=_,_=G),S?re?C+_>0^M[1]<(Oe(M[0]-x)<Le?C:_):C<=M[1]&&M[1]<=_:Z>Ce^(x<=M[0]&&M[0]<=F)){var $=za(T,(-z+H)/R);return dn($,A),[M,Nn($)]}}}function m(c,g){var u=n?e:Ce-e,b=0;return c<-u?b|=1:c>u&&(b|=2),g<-u?b|=4:g>u&&(b|=8),b}return ni(d,s,i,n?[0,-e]:[-Ce,e-Ce])}function Cd(e,a,r,n,o,i){var d=e[0],s=e[1],l=a[0],m=a[1],c=0,g=1,u=l-d,b=m-s,h;if(h=r-d,!(!u&&h>0)){if(h/=u,u<0){if(h<c)return;h<g&&(g=h)}else if(u>0){if(h>g)return;h>c&&(c=h)}if(h=o-d,!(!u&&h<0)){if(h/=u,u<0){if(h>g)return;h>c&&(c=h)}else if(u>0){if(h<c)return;h<g&&(g=h)}if(h=n-s,!(!b&&h>0)){if(h/=b,b<0){if(h<c)return;h<g&&(g=h)}else if(b>0){if(h>g)return;h>c&&(c=h)}if(h=i-s,!(!b&&h<0)){if(h/=b,b<0){if(h>g)return;h>c&&(c=h)}else if(b>0){if(h<c)return;h<g&&(g=h)}return c>0&&(e[0]=d+c*u,e[1]=s+c*b),g<1&&(a[0]=d+g*u,a[1]=s+g*b),!0}}}}}var ia=1e9,Aa=-ia;function Ad(e,a,r,n){function o(m,c){return e<=m&&m<=r&&a<=c&&c<=n}function i(m,c,g,u){var b=0,h=0;if(m==null||(b=d(m,g))!==(h=d(c,g))||l(m,c)<0^g>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+g+4)%4)!==h);else u.point(c[0],c[1])}function d(m,c){return Oe(m[0]-e)<Le?c>0?0:3:Oe(m[0]-r)<Le?c>0?2:1:Oe(m[1]-a)<Le?c>0?1:0:c>0?3:2}function s(m,c){return l(m.x,c.x)}function l(m,c){var g=d(m,1),u=d(c,1);return g!==u?g-u:g===0?c[1]-m[1]:g===1?m[0]-c[0]:g===2?m[1]-c[1]:c[0]-m[0]}return function(m){var c=m,g=ti(),u,b,h,v,y,f,w,E,k,j,N,A={point:L,lineStart:B,lineEnd:H,polygonStart:z,polygonEnd:R};function L(x,F){o(x,F)&&c.point(x,F)}function T(){for(var x=0,F=0,C=b.length;F<C;++F)for(var _=b[F],G=1,Z=_.length,re=_[0],S,$,I=re[0],ee=re[1];G<Z;++G)S=I,$=ee,re=_[G],I=re[0],ee=re[1],$<=n?ee>n&&(I-S)*(n-$)>(ee-$)*(e-S)&&++x:ee<=n&&(I-S)*(n-$)<(ee-$)*(e-S)&&--x;return x}function z(){c=g,u=[],b=[],N=!0}function R(){var x=T(),F=N&&x,C=(u=ei(u)).length;(F||C)&&(m.polygonStart(),F&&(m.lineStart(),i(null,null,1,m),m.lineEnd()),C&&ai(u,s,x,i,m),m.polygonEnd()),c=m,u=b=h=null}function B(){A.point=M,b&&b.push(h=[]),j=!0,k=!1,w=E=NaN}function H(){u&&(M(v,y),f&&k&&g.rejoin(),u.push(g.result())),A.point=L,k&&c.lineEnd()}function M(x,F){var C=o(x,F);if(b&&h.push([x,F]),j)v=x,y=F,f=C,j=!1,C&&(c.lineStart(),c.point(x,F));else if(C&&k)c.point(x,F);else{var _=[w=Math.max(Aa,Math.min(ia,w)),E=Math.max(Aa,Math.min(ia,E))],G=[x=Math.max(Aa,Math.min(ia,x)),F=Math.max(Aa,Math.min(ia,F))];Cd(_,G,e,a,r,n)?(k||(c.lineStart(),c.point(_[0],_[1])),c.point(G[0],G[1]),C||c.lineEnd(),N=!1):C&&(c.lineStart(),c.point(x,F),N=!1)}w=x,E=F,k=C}return A}}const An=e=>e;var cn=new Bt,qn=new Bt,ri,oi,Tn,Ln,Nt={point:pt,lineStart:pt,lineEnd:pt,polygonStart:function(){Nt.lineStart=qd,Nt.lineEnd=Ld},polygonEnd:function(){Nt.lineStart=Nt.lineEnd=Nt.point=pt,cn.add(Oe(qn)),qn=new Bt},result:function(){var e=cn/2;return cn=new Bt,e}};function qd(){Nt.point=Td}function Td(e,a){Nt.point=ii,ri=Tn=e,oi=Ln=a}function ii(e,a){qn.add(Ln*e-Tn*a),Tn=e,Ln=a}function Ld(){ii(ri,oi)}var Jt=1/0,Wa=Jt,ga=-Jt,Ga=ga,Ya={point:Fd,lineStart:pt,lineEnd:pt,polygonStart:pt,polygonEnd:pt,result:function(){var e=[[Jt,Wa],[ga,Ga]];return ga=Ga=-(Wa=Jt=1/0),e}};function Fd(e,a){e<Jt&&(Jt=e),e>ga&&(ga=e),a<Wa&&(Wa=a),a>Ga&&(Ga=a)}var Fn=0,Rn=0,sa=0,Qa=0,Ka=0,Gt=0,On=0,Mn=0,la=0,si,li,bt,vt,lt={point:$t,lineStart:Jr,lineEnd:Xr,polygonStart:function(){lt.lineStart=Md,lt.lineEnd=Dd},polygonEnd:function(){lt.point=$t,lt.lineStart=Jr,lt.lineEnd=Xr},result:function(){var e=la?[On/la,Mn/la]:Gt?[Qa/Gt,Ka/Gt]:sa?[Fn/sa,Rn/sa]:[NaN,NaN];return Fn=Rn=sa=Qa=Ka=Gt=On=Mn=la=0,e}};function $t(e,a){Fn+=e,Rn+=a,++sa}function Jr(){lt.point=Rd}function Rd(e,a){lt.point=Od,$t(bt=e,vt=a)}function Od(e,a){var r=e-bt,n=a-vt,o=Vt(r*r+n*n);Qa+=o*(bt+e)/2,Ka+=o*(vt+a)/2,Gt+=o,$t(bt=e,vt=a)}function Xr(){lt.point=$t}function Md(){lt.point=Id}function Dd(){di(si,li)}function Id(e,a){lt.point=di,$t(si=bt=e,li=vt=a)}function di(e,a){var r=e-bt,n=a-vt,o=Vt(r*r+n*n);Qa+=o*(bt+e)/2,Ka+=o*(vt+a)/2,Gt+=o,o=vt*e-bt*a,On+=o*(bt+e),Mn+=o*(vt+a),la+=o*3,$t(bt=e,vt=a)}function pi(e){this._context=e}pi.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,ct);break}}},result:pt};var Dn=new Bt,un,ci,ui,da,pa,xa={point:pt,lineStart:function(){xa.point=Pd},lineEnd:function(){un&&mi(ci,ui),xa.point=pt},polygonStart:function(){un=!0},polygonEnd:function(){un=null},result:function(){var e=+Dn;return Dn=new Bt,e}};function Pd(e,a){xa.point=mi,ci=da=e,ui=pa=a}function mi(e,a){da-=e,pa-=a,Dn.add(Vt(da*da+pa*pa)),da=e,pa=a}let Zr,Ja,eo,to;class ao{constructor(a){this._append=a==null?fi:_d(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==eo||this._append!==Ja){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,eo=n,Ja=this._append,to=this._,this._=o}this._+=to;break}}}result(){const a=this._;return this._="",a.length?a:null}}function fi(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function _d(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return fi;if(a!==Zr){const r=10**a;Zr=a,Ja=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ja}function Bd(e,a){let r=3,n=4.5,o,i;function d(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Wt(s,o(i))),i.result()}return d.area=function(s){return Wt(s,o(Nt)),Nt.result()},d.measure=function(s){return Wt(s,o(xa)),xa.result()},d.bounds=function(s){return Wt(s,o(Ya)),Ya.result()},d.centroid=function(s){return Wt(s,o(lt)),lt.result()},d.projection=function(s){return arguments.length?(o=s==null?(e=null,An):(e=s).stream,d):e},d.context=function(s){return arguments.length?(i=s==null?(a=null,new ao(r)):new pi(a=s),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),d):n},d.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new ao(r)),d},d.projection(e).digits(r).context(a)}function Qn(e){return function(a){var r=new In;for(var n in e)r[n]=e[n];return r.stream=a,r}}function In(){}In.prototype={constructor:In,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Kn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Wt(r,e.stream(Ya)),a(Ya.result()),n!=null&&e.clipExtent(n),e}function hi(e,a,r){return Kn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([s,l])},r)}function $d(e,a,r){return hi(e,[[0,0],a],r)}function Ud(e,a,r){return Kn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([d,s])},r)}function Hd(e,a,r){return Kn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,s])},r)}var no=16,Vd=De(30*nt);function ro(e,a){return+a?Gd(e,a):Wd(e)}function Wd(e){return Qn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Gd(e,a){function r(n,o,i,d,s,l,m,c,g,u,b,h,v,y){var f=m-n,w=c-o,E=f*f+w*w;if(E>4*a&&v--){var k=d+u,j=s+b,N=l+h,A=Vt(k*k+j*j+N*N),L=ha(N/=A),T=Oe(Oe(N)-1)<Le||Oe(i-g)<Le?(i+g)/2:fa(j,k),z=e(T,L),R=z[0],B=z[1],H=R-n,M=B-o,x=w*H-f*M;(x*x/E>a||Oe((f*H+w*M)/E-.5)>.3||d*u+s*b+l*h<Vd)&&(r(n,o,i,d,s,l,R,B,T,k/=A,j/=A,N,v,y),y.point(R,B),r(R,B,T,k,j,N,m,c,g,u,b,h,v,y))}}return function(n){var o,i,d,s,l,m,c,g,u,b,h,v,y={point:f,lineStart:w,lineEnd:k,polygonStart:function(){n.polygonStart(),y.lineStart=j},polygonEnd:function(){n.polygonEnd(),y.lineStart=w}};function f(L,T){L=e(L,T),n.point(L[0],L[1])}function w(){g=NaN,y.point=E,n.lineStart()}function E(L,T){var z=Kt([L,T]),R=e(L,T);r(g,u,c,b,h,v,g=R[0],u=R[1],c=L,b=z[0],h=z[1],v=z[2],no,n),n.point(g,u)}function k(){y.point=f,n.lineEnd()}function j(){w(),y.point=N,y.lineEnd=A}function N(L,T){E(o=L,T),i=g,d=u,s=b,l=h,m=v,y.point=E}function A(){r(g,u,c,b,h,v,i,d,o,s,l,m,no,n),y.lineEnd=k,k()}return y}}var Yd=Qn({point:function(e,a){this.stream.point(e*nt,a*nt)}});function Qd(e){return Qn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Kd(e,a,r,n,o){function i(d,s){return d*=n,s*=o,[a+e*d,r-e*s]}return i.invert=function(d,s){return[(d-a)/e*n,(r-s)/e*o]},i}function oo(e,a,r,n,o,i){if(!i)return Kd(e,a,r,n,o);var d=De(i),s=Ie(i),l=d*e,m=s*e,c=d/e,g=s/e,u=(s*r-d*a)/e,b=(s*a+d*r)/e;function h(v,y){return v*=n,y*=o,[l*v-m*y+a,r-m*v-l*y]}return h.invert=function(v,y){return[n*(c*v-g*y+u),o*(b-g*v-c*y)]},h}function Jd(e){return Xd(function(){return e})()}function Xd(e){var a,r=150,n=480,o=250,i=0,d=0,s=0,l=0,m=0,c,g=0,u=1,b=1,h=null,v=Kr,y=null,f,w,E,k=An,j=.5,N,A,L,T,z;function R(x){return L(x[0]*nt,x[1]*nt)}function B(x){return x=L.invert(x[0],x[1]),x&&[x[0]*Et,x[1]*Et]}R.stream=function(x){return T&&z===x?T:T=Yd(Qd(c)(v(N(k(z=x)))))},R.preclip=function(x){return arguments.length?(v=x,h=void 0,M()):v},R.postclip=function(x){return arguments.length?(k=x,y=f=w=E=null,M()):k},R.clipAngle=function(x){return arguments.length?(v=+x?zd(h=x*nt):(h=null,Kr),M()):h*Et},R.clipExtent=function(x){return arguments.length?(k=x==null?(y=f=w=E=null,An):Ad(y=+x[0][0],f=+x[0][1],w=+x[1][0],E=+x[1][1]),M()):y==null?null:[[y,f],[w,E]]},R.scale=function(x){return arguments.length?(r=+x,H()):r},R.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],H()):[n,o]},R.center=function(x){return arguments.length?(i=x[0]%360*nt,d=x[1]%360*nt,H()):[i*Et,d*Et]},R.rotate=function(x){return arguments.length?(s=x[0]%360*nt,l=x[1]%360*nt,m=x.length>2?x[2]%360*nt:0,H()):[s*Et,l*Et,m*Et]},R.angle=function(x){return arguments.length?(g=x%360*nt,H()):g*Et},R.reflectX=function(x){return arguments.length?(u=x?-1:1,H()):u<0},R.reflectY=function(x){return arguments.length?(b=x?-1:1,H()):b<0},R.precision=function(x){return arguments.length?(N=ro(A,j=x*x),M()):Vt(j)},R.fitExtent=function(x,F){return hi(R,x,F)},R.fitSize=function(x,F){return $d(R,x,F)},R.fitWidth=function(x,F){return Ud(R,x,F)},R.fitHeight=function(x,F){return Hd(R,x,F)};function H(){var x=oo(r,0,0,u,b,g).apply(null,a(i,d)),F=oo(r,n-x[0],o-x[1],u,b,g);return c=vd(s,l,m),A=zn(a,F),L=zn(c,A),N=ro(A,j),M()}function M(){return T=z=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&B,H()}}function gi(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}gi.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Oe(o)>Le&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Zd(){return Jd(gi).scale(175.295)}function ep(e){return e}function tp(e){if(e==null)return ep;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(s,l){l||(a=r=0);var m=2,c=s.length,g=new Array(c);for(g[0]=(a+=s[0])*n+i,g[1]=(r+=s[1])*o+d;m<c;)g[m]=s[m],++m;return g}}function ap(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function np(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return io(e,r)})}:io(e,a)}function io(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=rp(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function rp(e,a){var r=tp(e.transform),n=e.arcs;function o(c,g){g.length&&g.pop();for(var u=n[c<0?~c:c],b=0,h=u.length;b<h;++b)g.push(r(u[b],b));c<0&&ap(g,h)}function i(c){return r(c)}function d(c){for(var g=[],u=0,b=c.length;u<b;++u)o(c[u],g);return g.length<2&&g.push(g[0]),g}function s(c){for(var g=d(c);g.length<4;)g.push(g[0]);return g}function l(c){return c.map(s)}function m(c){var g=c.type,u;switch(g){case"GeometryCollection":return{type:g,geometries:c.geometries.map(m)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=d(c.arcs);break;case"MultiLineString":u=c.arcs.map(d);break;case"Polygon":u=l(c.arcs);break;case"MultiPolygon":u=c.arcs.map(l);break;default:return null}return{type:g,coordinates:u}}return m(a)}const xi={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},op=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ip(e,a,r){const n=xi[e];if(!n||!n.length)return-1;const o=op(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let qa=null;function sp(){return qa||(qa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=np(r,n),i=Zd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Bd(i),s=(o.features||[]).filter(c=>{var g;return(((g=c.properties)==null?void 0:g.name)||"")!=="Antarctica"}).map(c=>{var b;const g=((b=c.properties)==null?void 0:b.name)||"",u=d(c)||"";return u?{i2:ms(g)||null,n:g,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const l={};for(const[c,g]of Object.entries(fs)){const u=i(g);u&&(l[c]={x:u[0],y:u[1]})}const m={};for(const[c,g]of Object.entries(xi)){const u=g.map(b=>i(b.ll)).filter(b=>!!b).map(([b,h])=>({x:b,y:h}));u.length&&(m[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:m}}catch{return null}})(),qa)}function lp(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return sp().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const dp="8 40 984 210",pp={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},so=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function lo(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function cp(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var m;if(!o)return;const l=(m=e.current)==null?void 0:m.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(d)};d();const s=new ResizeObserver(()=>d());return e.current&&s.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function po({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function up(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:s,t:l,data:m,dossiers:c,source:g}=X(),u=m.loading&&!c.length,b=p.useRef(null),h=p.useRef(null),v=lp(e.continent==="monde"),y=e.continent==="monde"?v:Un.find(x=>x.key===e.continent)||null,f=cp(b,e.continent+":"+e.mapFolded+":"+!!y),[w,E]=p.useState(new Map),[k,j]=p.useState(null);p.useEffect(()=>{const x=b.current;if(!x)return;const F=new Map;x.querySelectorAll("path[data-i2]").forEach(C=>{const _=C.dataset.i2;if(_)try{const G=C.getBBox();G.width>0&&F.set(_,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),E(F)},[e.continent,f,y]);const N=p.useMemo(()=>r.filter(x=>x.cc),[r]),A=p.useMemo(()=>{const x=new Map;return N.forEach(F=>x.set(F.cc,(x.get(F.cc)||0)+1)),x},[N]),L=e.continent==="monde"&&v?v.anchors:null,T=e.continent==="monde"&&v?v.metros:null,z=p.useMemo(()=>N.map(x=>{const F=lo(x.name||x.id||""),C=lo((x.id||x.name||"")+"·y");if(L&&x.cc){const S=T?T[x.cc]:void 0;if(S&&S.length){const I=ip(x.cc,x.city,F);if(I>=0&&S[I])return{d:x,x:S[I].x+(F-.5)*5,y:S[I].y+(C-.5)*5}}const $=L[x.cc];if($)return{d:x,x:$.x+(F-.5)*10,y:$.y+(C-.5)*10}}const _=x.cc?w.get(x.cc):void 0;if(!_)return null;const G=pp[`${e.continent}:${x.cc||""}`];if(G)return{d:x,x:_.x+_.w*(G.fx+(F-.5)*G.sx),y:_.y+_.h*(G.fy+(C-.5)*G.sy)};const Z=(F-.5)*Math.min(_.w*.55,60),re=(C-.5)*Math.min(_.h*.55,60);return{d:x,x:_.x+_.w/2+Z,y:_.y+_.h/2+re}}).filter(x=>!!x),[N,w,L,T,e.continent]),R=x=>f>0?x/f:x,B=p.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:so[x],fr:l.plabels[x],en:l.plabels[x],n:r.filter(F=>F.kind==="target"&&Te(F)===x).length})).filter(x=>x.n>0):cr.map((x,F)=>({...x,n:r.filter(C=>ur(C)===F).length})),[r,n,l.plabels]),H=i?d.get(i):null,M=H?z.find(x=>x.d.id===H.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:[u&&t.jsx(po,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?dp:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?y.fr:y.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:y.countries.map((x,F)=>t.jsx("g",{className:"ct"+(x.i2&&A.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},F))}),t.jsx("g",{children:z.map(x=>{const F=cr[ur(x.d)],C=!!He(x.d),_=x.d.kind==="target",G=n&&_?so[Te(x.d)]:F.c,Z=!n&&Ye(x.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var $,I;const re=($=h.current)==null?void 0:$.getBoundingClientRect(),S=(I=b.current)==null?void 0:I.createSVGPoint();if(S&&b.current&&re){S.x=x.x,S.y=x.y;const ee=S.matrixTransform(b.current.getScreenCTM());j({x:ee.x-re.left,y:ee.y-re.top,label:x.d.name+" · "+(ea(x.d.cc,s)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var $;if(g==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const re=($=b.current)==null?void 0:$.createSVGPoint();let S=null;if(re&&b.current){re.x=x.x,re.y=x.y;const I=re.matrixTransform(b.current.getScreenCTM());S={x:I.x,y:I.y}}a({type:"popup",id:x.d.id,anchor:S})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:R(Math.max(11,F.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:R(F.px),fill:G,stroke:C?"#E5484D":"#ffffff",strokeWidth:R(C?2.2:1.3)})]},x.d.id||x.d.name)})}),M&&t.jsx("circle",{className:"ring on",cx:M.x,cy:M.y,r:R(13),fill:"none",stroke:"#16233A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:B.map((x,F)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),s==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},F))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:t.jsx(po,{msgs:l.loadMsgs})})}function mp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function bi({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:s}=X(),l=a.filters,[m,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null),h=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(M=>M.continent===a.continent),[n,a.continent]),y=M=>v.filter(x=>M!=="country"&&l.country.length&&!l.country.includes(x.cc||"")?!1:Ua(x,l,i,M==="country"?void 0:M)),f=M=>!i||M.kind!=="op",w=p.useMemo(()=>{const M=y("win").filter(f),x=F=>M.filter(C=>(C.date?Math.max(0,Math.floor((Date.now()-Date.parse(C.date))/864e5)):9999)<=F).length;return[x(0),x(7),x(30),M.length]},[v,l,i]),E=p.useMemo(()=>l.day?y("win").filter(f).filter(M=>(M.date||"").slice(0,10)===l.day).length:0,[v,l,i]),k=(l.signalOnly?1:0)+l.sector.length+l.market.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,j=k+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!m&&!g)return;const M=F=>{var _,G;const C=F.target;m&&!((_=b.current)!=null&&_.contains(C))&&c(!1),g&&!((G=h.current)!=null&&G.contains(C))&&u(!1)},x=F=>{F.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",M),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("keydown",x)}},[m,g]);const N=(M,x,F,C="fbtn")=>t.jsxs("button",{type:"button",className:C,"aria-expanded":a.openFacet===M,onClick:()=>r({type:"openFacet",facet:M}),children:[t.jsx("span",{className:"fl",children:x}),F>0&&t.jsx("span",{className:"n",children:F}),t.jsx("span",{className:"cv",children:"▾"})]},M),A=["1","7","30","all"],L=Math.max(0,A.indexOf(l.win||"all")),T=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(mp(l.day,s))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:h,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>u(M=>!M),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:w[L]}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:A.map((M,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===M,onClick:()=>{r({type:"filters",patch:{win:M}}),u(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:w[x]})]},M))})]}):t.jsx("div",{className:"seg",children:A.map((M,x)=>t.jsxs("button",{type:"button","aria-pressed":l.win===M,onClick:()=>r({type:"filters",patch:{win:M}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:w[x]})]},M))}),z=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:M=>r({type:"filters",patch:{search:M.target.value}})})]}),R=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,l.sector.length),(n.some(M=>!!M.market)||l.market.length>0)&&N("mar",o.fMarket,l.market.length),N("pay",o.fCountry,l.country.length),N("det",o.fEngine,l.engine.length),N("sta",o.fStage,l.stage.length),i&&N("crib",o.fVerdict,l.crible.length),i&&N("ang","Angle",l.angle.length),i&&N("mem","Mémo",l.memoLevel.length)]}),B=(M=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),M&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),H=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":m,"aria-haspopup":"true",onClick:()=>{c(M=>!M),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:m?"▴":"▾"})]}),m&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:R})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:T}),t.jsxs("div",{className:"fstrip-b",children:[z,H,B(!1)]})]}),a.openFacet&&t.jsx(co,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[T,z,R,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx(co,{poolFor:y})]})}function co({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=X(),s=a.filters,l=a.openFacet,{title:m,cols:c,options:g}=p.useMemo(()=>{if(l==="sig"){const y=e("signal").filter(E=>He(E)),f=new Map;y.forEach(E=>{const k=E.engine||"";f.set(k,(f.get(k)||0)+1)});const w=[{v:"*",label:n.fpSigAll,n:y.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...yn([...f.keys()],o).map(E=>({v:E,label:_t(E)+" "+rt(E,o),n:f.get(E)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:w}}if(l==="crib"){const y=e("crible").filter(w=>!i||So(w,a.ptab,d.favIds)),f=new Map;return y.forEach(w=>{const E=zo(w);E&&E!=="NEW"&&f.set(E,(f.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((w,E)=>(mr[w[0]]??9)-(mr[E[0]]??9)||E[1]-w[1]).map(([w,E])=>({v:w,label:'<span class="fdot" style="background:'+(hs[w]||"#94A3B8")+'"></span>'+w,n:E,html:!0,on:s.crible.includes(w)}))}}if(l==="sec"){const y=e("sector"),f=new Map;return y.forEach(w=>{w.sector&&f.set(w.sector,(f.get(w.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:w,n:E,html:!1,on:s.sector.includes(w)}))}}if(l==="mar"){const y=e("market"),f=new Map;return y.forEach(w=>{w.market&&f.set(w.market,(f.get(w.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...f.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:w,n:E,html:!1,on:s.market.includes(w)}))}}if(l==="pay"){const y=e("country"),f=new Map;return y.forEach(w=>{w.cc&&f.set(w.cc,(f.get(w.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:ea(w,o)||w,n:E,html:!1,on:s.country.includes(w)}))}}if(l==="det"){const y=e("engine"),f=new Map;return y.forEach(w=>{w.engine&&f.set(w.engine,(f.get(w.engine)||0)+1)}),{title:n.fEngine,cols:2,options:yn([...f.keys()],o).map(w=>({v:w,label:_t(w)+" "+rt(w,o)+' <span style="color:var(--dim);font-size:10px">· '+gs(xs(w),o)+"</span>",n:f.get(w)||0,html:!0,on:s.engine.includes(w)}))}}if(l==="ang"){const y=e("angle"),f=new Map;return y.forEach(w=>{w.angle&&f.set(w.angle,(f.get(w.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((w,E)=>E[1]-w[1]).map(([w,E])=>({v:w,label:w.replace(/[_-]+/g," "),n:E,html:!1,on:s.angle.includes(w)}))}}if(l==="mem"){const y=e("memoLevel"),f=new Map;y.forEach(E=>{if(E.kind==="target"){const k=$n(E);f.set(k,(f.get(k)||0)+1)}});const w=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:w[E],n:f.get(E)||0,html:!1,on:s.memoLevel.includes(E)}))}}const h=e("stage"),v=new Map;return h.forEach(y=>{y.stage&&v.set(y.stage,(v.get(y.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:s.stage.includes(y)}))}},[l,a,o]),u=h=>{if(l==="sig"){if(h==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const y=s.signalEngines.includes(h)?s.signalEngines.filter(f=>f!==h):[...s.signalEngines,h];r({type:"filters",patch:{signalOnly:!0,signalEngines:y}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(h)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:h})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="mar"?"market":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:m}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(h=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":h.on,onClick:()=>u(h.v),children:[t.jsx("span",{className:"bx"}),h.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:h.label}}):t.jsx("span",{className:"l",children:h.label}),t.jsx("span",{className:"n",children:h.n})]},h.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function vi({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:s}=X(),l=p.useMemo(()=>{const b={};return r.forEach(h=>{Ua(h,n.filters,i)&&(b.monde=(b.monde||0)+1,h.continent&&(b[h.continent]=(b[h.continent]||0)+1))}),b},[r,n.filters,i]),[m,c]=p.useState(!1),g=p.useRef(null);p.useEffect(()=>{if(!m)return;const b=v=>{var y;(y=g.current)!=null&&y.contains(v.target)||c(!1)},h=v=>{v.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",h)}},[m]);const u=b=>{const h=Un.find(v=>v.key===b);return b==="monde"?s.contWorld:d==="fr"?h.fr:h.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:g,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":m,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:m?"▴":"▾"})]}),m&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:fr.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[fr.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:s.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:s.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]})]})}function Pn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function wi(e){return"atl2:evalq:"+(e||"anon")}function fp(e,a){const r=wi(e),n=Pn(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}let _n=null;function hp(e){_n=e;try{window.dispatchEvent(new CustomEvent("atl2:extract-note",{detail:e}))}catch{}}function gp(){const{t:e,lang:a,data:r,dossiers:n}=X(),o=r.session.token||"",i=wi(o),[d,s]=p.useState(()=>Pn(i)),l=p.useRef(!1),[m,c]=p.useState(!1);p.useEffect(()=>{try{const S=d.slice(0,30).map(({descBusy:$,evalBusy:I,...ee})=>ee);localStorage.setItem(i,JSON.stringify(S)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[d,i]),p.useEffect(()=>{const S=()=>{if(l.current)return;const $=Pn(i);s(I=>JSON.stringify(I.map(({descBusy:ee,evalBusy:U,...oe})=>oe))===JSON.stringify($)?I:$)};return window.addEventListener("atl2:evalq",S),window.addEventListener("storage",S),()=>{window.removeEventListener("atl2:evalq",S),window.removeEventListener("storage",S)}},[i]);const[g,u]=p.useState([]),[b,h]=p.useState(""),[v,y]=p.useState(!1),[f,w]=p.useState(!1),[E,k]=p.useState(""),[j,N]=p.useState(()=>_n);p.useEffect(()=>{const S=$=>{var ee,U;const I=$.detail;I&&((ee=I.cited)!=null&&ee.length||(U=I.match)!=null&&U.length||I.title)&&N(I)};return window.addEventListener("atl2:extract-note",S),()=>window.removeEventListener("atl2:extract-note",S)},[]);const A=p.useCallback((S,$)=>s(I=>I.map((ee,U)=>U===S?{...ee,...$}:ee)),[]),L=p.useCallback((S,$)=>{const I=$.trim();I&&(A(S,{name:I,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Hn(I).then(ee=>{const U=ee.candidates||[];ee.website?A(S,{site:ee.website,status:"ready"}):U.length===1?A(S,{site:U[0].url,status:"ready"}):U.length>1?A(S,{status:"pick",candidates:U.slice(0,6)}):A(S,{status:"ready"})}).catch(()=>A(S,{status:"ready"})))},[A]),T=p.useCallback((S,$,I)=>{A(S,{descBusy:!0}),Ao(o,$,I).then(ee=>{if(ee.quota){c(!0),A(S,{descBusy:!1,descDone:!0});return}const U=ee.blocs||{},oe=(U.synthese||U.value_prop||U.produit||U.modele||"").trim();A(S,{descBusy:!1,descDone:!0,desc:oe})}).catch(()=>A(S,{descBusy:!1,descDone:!0}))},[A,o]);p.useEffect(()=>{const S=d.findIndex(I=>I.auto&&I.name.trim()&&I.status==="");if(S>=0){L(S,d[S].name);return}if(m)return;const $=d.findIndex(I=>I.status==="ready"&&I.site&&!I.descDone&&!I.descBusy);$>=0&&T($,d[$].name,d[$].site)},[d,L,T,m]);const[z,R]=p.useState(!1),B=p.useCallback(async(S,$)=>{A(S,{evalBusy:!0});const I=($.site||$.name).trim(),ee=await qo(o,I,"atelier2");return ee.verdict==="quota"?(A(S,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:ee.reason||"",remaining:0}})),!1):(A(S,{evalBusy:!1,status:ee.verdict==="kept"?"kept":"out",reason:ee.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:ee.company||$.name,verdict:ee.verdict,reason:ee.reason||"",remaining:ee.remaining??null}})),!0)},[A,o]),H=async()=>{if(z)return;const S=d.map(($,I)=>({r:$,i:I})).filter(({r:$})=>$.name.trim()&&$.status!=="kept"&&$.status!=="out"&&$.status!=="resolving");if(S.length){R(!0);for(const{r:$,i:I}of S)if(!await B(I,$))break;R(!1)}},M=p.useMemo(()=>{const S=new Set,$=[];return d.filter(I=>I.status==="kept").forEach(I=>{const ee=I.name.trim().toLowerCase();ee&&!S.has(ee)&&(S.add(ee),$.push(I.name.trim()))}),n.filter(I=>Te(I)>=1&&Te(I)<=4&&(I.website||I.domain)).forEach(I=>{const ee=(I.name||"").trim().toLowerCase();ee&&!S.has(ee)&&(S.add(ee),$.push((I.name||"").trim()))}),$},[d,n]),x=p.useMemo(()=>{const S=new Set;return n.forEach($=>{const I=($.name||"").trim().toLowerCase();I&&S.add(I)}),d.forEach($=>{const I=$.name.trim().toLowerCase();I&&S.add(I)}),S},[n,d]),F=async()=>{if(b||!M.length)return;w(!1);const S=[];for(const $ of M.slice(0,2)){h($);const I=await To(o,$);if(I){if(I.verdict==="quota"){y(!0);break}(I.results||[]).forEach(ee=>{const U=(ee.company||"").trim().toLowerCase();!U||x.has(U)||S.some(oe=>oe.name.toLowerCase()===U)||S.push({name:(ee.company||"").trim(),verdict:ee.verdict||"",reason:ee.reason,from:$})})}}h(""),w(!0),u($=>[...S,...$].slice(0,24))},C=async(S,$)=>{if(b)return;w(!1),h(S==="thesis"?e.pxThesis:$);const I=await vs(o,S,$,6);if(h(""),w(!0),!I)return;if(I.verdict==="quota"){y(!0);return}const ee=[];(I.results||[]).forEach(U=>{const oe=(U.company||"").trim().toLowerCase();!oe||x.has(oe)||ee.some(me=>me.name.toLowerCase()===oe)||ee.push({name:(U.company||"").trim(),verdict:U.verdict||"",reason:U.reason,from:S==="thesis"?e.pxThesis:$})}),u(U=>[...ee,...U].slice(0,24))},_=()=>{const S=E.trim();S.length<3||C(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(S)?"registry":"keyword",S)},G=S=>{s($=>[...$,{name:S.name,site:"",status:"",auto:!0}].slice(0,30)),u($=>$.filter(I=>I.name!==S.name))},Z=d.filter(S=>S.name.trim()&&S.status!=="kept"&&S.status!=="out").length,re=S=>S.name.trim()&&S.status!=="kept"&&S.status!=="out"&&S.status!=="resolving"&&!S.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[j&&t.jsxs("div",{className:"eq-note"+(j.fallback?" fb":""),children:[t.jsxs("b",{children:[j.fallback?e.rsNoteFallback:e.rsNoteRead,j.title?` « ${j.title.length>90?j.title.slice(0,89)+"…":j.title} »`:""]}),!!j.cited.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteCited," ",t.jsx("i",{children:j.cited.join(" · ")})]}),!!j.match.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteMatch," ",t.jsx("i",{children:j.match.join(" · ")})]}),!j.match.length&&!!j.cited.length&&t.jsx("p",{className:"eq-nl",children:e.rsNoteNoMatch}),t.jsx("p",{className:"eq-nl",children:e.rsNoteAdded(j.added)}),t.jsx("button",{type:"button",className:"eq-note-x",onClick:()=>{_n=null,N(null)},title:e.rsClose,children:"×"})]}),t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{className:"eq-h-go",children:e.eqRunOneShort})]}),d.map((S,$)=>t.jsxs("div",{className:"eq-item"+(S.status==="kept"?" r-kept":S.status==="out"?" r-out":""),children:[t.jsxs("div",{className:"eq-row"+(S.status==="kept"?" r-kept":S.status==="out"?" r-out":""),children:[t.jsx("input",{value:S.name,placeholder:e.eqNamePh,onChange:I=>{const ee=I.target.value.split(`
`).map(U=>U.trim()).filter(Boolean);ee.length>1?s(U=>{const oe=[...U];return oe.splice($,1,...ee.map(me=>({name:me,site:"",status:"",auto:!0}))),oe.slice(0,30)}):A($,{name:I.target.value})},onBlur:()=>{S.name.trim()&&!S.site&&S.status!=="resolving"&&S.status!=="pick"&&L($,S.name)},onKeyDown:I=>{I.key==="Enter"&&L($,S.name)}}),t.jsxs("span",{className:"eq-site",children:[S.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),S.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:I=>{const ee=I.target.value;ee&&A($,{site:ee,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(S.candidates||[]).map(I=>t.jsx("option",{value:I.url,children:(I.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},I.url))]}),S.status!=="resolving"&&S.status!=="pick"&&(S.site?t.jsxs("a",{href:S.site.startsWith("http")?S.site:"https://"+S.site,target:"_blank",rel:"nofollow noopener",children:[S.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:S.name.trim()&&S.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:S.desc||"",children:S.descBusy?t.jsx("i",{children:e.eqDescBusy}):S.desc?S.desc:t.jsx("em",{children:S.descDone?m?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(S.status||"vide"),title:S.reason||"",children:S.status==="kept"?"✓ "+e.kept:S.status==="out"?"✗ "+e.dropped:S.status==="ready"?e.eqReady:S.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>s(I=>I.filter((ee,U)=>U!==$)),children:"×"}),(S.name.trim()||S.site)&&S.status!=="kept"&&S.status!=="out"?t.jsxs(Za,{lang:a,storeKey:(S.site||S.name).trim(),className:"eq-go",title:e.eqRunOne,disabled:!re(S)||z,confirmLabel:"⚡ "+e.eqRunOneShort,onConfirm:()=>{B($,S)},children:[S.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}):t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!re(S)||z,onClick:()=>{B($,S)},children:[S.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]})]}),(S.name.trim()||S.site)&&S.status!=="kept"&&S.status!=="out"&&t.jsx(bs,{lang:a,variant:"row",storeKey:(S.site||S.name).trim()})]},$)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>s(S=>[...S,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{C("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:S=>k(S.target.value),onKeyDown:S=>{S.key==="Enter"&&_()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:_,children:e.pxGoFree}),!!M.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{F()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!M.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(M[0],M.length)}),v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),f&&!g.length&&!v&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),g.map(S=>t.jsxs("span",{className:"eq-sc"+(S.verdict==="kept"?" ok":""),title:(S.reason||"")+" — "+e.sgVia(S.from),children:[t.jsx("b",{children:S.name}),S.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>G(S),children:"+"})]},S.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(S=>S.status==="kept"||S.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>s(S=>S.filter($=>$.status!=="kept"&&$.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(z?" loading":""),style:{justifyContent:"center"},disabled:z||!Z,onClick:()=>{H()},children:[t.jsx("span",{className:"fill"}),z?e.eqRunning:e.eqGo(Z)]})]})]})]})}const xp={deals:"ma-deals",news:"veille"},yi=/^(deals?|news|breaking|live|update|analysis|markets?|opinion|icymi)$/i,bp=/\b(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\b/i;function uo(e){return(e.url||e.title||"").trim()}function mn(e){const a=(e.kind||"").toLowerCase(),r=(e.ingest_kind||"").toLowerCase();if(a==="article"||a==="news"||a==="media"||r==="url"||r==="youtube")return!0;const n=(e.title||"").replace(/\s+/g," ").trim();return n?Qt(n)||bp.test(n)?!0:!Xa(n):!!(e.url||"").trim()}function Jn(e){let a=(e||"").replace(/\s+/g," ").trim();a=a.replace(/^\s*(?:deals?|news|breaking|live|update|analysis)\s*[:–—|]\s*/i,"");const r=[],n=l=>{let m=(l||"").replace(/[\u2018\u2019\u201c\u201d'"«»]/g,"").trim();m=m.replace(/^(the|le|la|les|l['’])\s+/i,"").trim(),m=m.replace(/\s+(?:'s|retirement|business|unit|division|arm|operations?)\b.*$/i,"").trim(),!(!m||m.length<2||m.length>48)&&(yi.test(m)||Qt(m)||!Xa(m)||r.some(c=>c.toLowerCase()===m.toLowerCase())||r.push(m))},o=a.match(/^(.{2,48}?)\s+(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\s+(.{2,60}?)(?:\s+(?:for|pour|en|in|at|à|from|de)\b|$)/i);if(o&&(n(o[1]),n(o[2]),r.length))return r;const i=a.match(/^(.{2,48}?)\s*[:–—]/);if(i&&n(i[1]),r.length)return r;const s=(a.split(/[:–—,]/)[0]||a).trim().match(/^((?:[A-ZÀ-Ö][\w&.-]*(?:\s+[A-ZÀ-Ö][\w&.-]*){0,3}))/);return s&&n(s[1]),r}function mo(e){const a=Jn(e.title||"");if(a.length)return a[0];const r=(e.title||"").replace(/\s+/g," ").trim();if(!r)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const n=/^(.{2,72}?)[:–—|]/.exec(r);return n&&!yi.test(n[1].trim())?n[1].trim():(r.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||r).slice(0,72).trim()}function vp({pageToken:e,onAddNames:a}){const{t:r,lang:n,token:o,canWrite:i,flash:d}=X(),[s,l]=p.useState(null),[m,c]=p.useState({deals:[],news:[]}),[g,u]=p.useState({deals:!1,news:!1}),[b,h]=p.useState(null),[v,y]=p.useState(""),f=p.useCallback(async z=>{if(!o)return[];if(g[z])return m[z];h(z),y("");const R=Date.now(),B=await ws(xp[z],o,n),H=700-(Date.now()-R);return H>0&&await new Promise(M=>window.setTimeout(M,H)),h(null),!B.ok&&B.error?(y(B.error),[]):(c(M=>({...M,[z]:B.items})),u(M=>({...M,[z]:!0})),B.items)},[o,n,g,m]);p.useEffect(()=>{s&&f(s)},[s,f]);const w=p.useCallback(z=>m[z].map(uo).filter(Boolean),[m]),E=p.useMemo(()=>{var B,H;if(!o)return{deals:[],news:[]};const z={deals:w("deals"),news:w("news")},R=Uo("feed:"+o,z);return{deals:((B=R.deals)==null?void 0:B.noms)||[],news:((H=R.news)==null?void 0:H.noms)||[]}},[o,w]),k=p.useRef(null);p.useEffect(()=>{k.current&&!s&&o&&Ho("feed:"+o,{deals:w("deals"),news:w("news")}),k.current=s},[s,o,w]);const j=z=>{const R=[],B=new Set,H=M=>{const x=M.trim();!x||B.has(x.toLowerCase())||(B.add(x.toLowerCase()),R.push(x))};z.forEach(M=>{mn(M)?Jn(M.title||"").forEach(H):H(mo(M))}),R.length&&(a(R),l(null),d(r.feedSent(R.length)))},N=z=>{const R=mo(z);R&&(window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:R,url:(z.url||"").trim()}})),l(null),d(r.feedPasted(R)),requestAnimationFrame(()=>{var B;(B=document.querySelector(".atl2 .eval-stick, .atl2 .demand"))==null||B.scrollIntoView({block:"center",behavior:"smooth"})}))},A=z=>{if(mn(z)){const R=(z.url||"").trim(),B=(z.title||"").trim();if(!R&&!B)return;window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:R,text:B,auto:!0}})),l(null),d(r.feedExtracting);return}N(z)},L=z=>{l(R=>R===z?null:z)},T=z=>{const R=m[z],B=new Set(E[z].map(M=>M.toLowerCase())),H=b===z||s===z&&!g[z]&&!v;return t.jsxs("div",{className:"dfpane"+(s===z?" on":""),hidden:s!==z,children:[t.jsxs("div",{className:"dfhow",children:[t.jsx("p",{className:"dfh",children:z==="deals"?r.feedDealsH:r.feedNewsH}),t.jsx("p",{className:"dfh2",children:z==="deals"?r.feedDealsHow:r.feedNewsHow})]}),H&&t.jsxs("div",{className:"dfwait",role:"status","aria-live":"polite",children:[t.jsx("i",{className:"dfspin","aria-hidden":"true"}),t.jsxs("div",{children:[t.jsx("b",{children:z==="deals"?r.feedWaitDeals:r.feedWaitNews}),t.jsx("span",{className:"dfbar",children:t.jsx("i",{})})]})]}),s===z&&!!v&&t.jsx("p",{className:"dferr",children:v}),g[z]&&!R.length&&!b&&t.jsx("p",{className:"dfempty",children:z==="deals"?r.feedEmptyDeals:r.feedEmptyNews}),!!R.length&&!H&&t.jsxs(t.Fragment,{children:[z==="deals"&&i&&R.length>1&&t.jsxs("button",{type:"button",className:"dfall",onClick:()=>j(R),children:[r.feedPutAll," (",R.length,")"]}),t.jsx("ul",{className:"dflist",children:R.map((M,x)=>{const F=uo(M),C=B.has(F.toLowerCase()),_=(M.url||"").trim();return t.jsxs("li",{className:C?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:M.title||_}),t.jsx("span",{children:[M.source,M.sector_fr,(M.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[_&&t.jsx("a",{href:_,target:"_blank",rel:"noopener noreferrer",children:r.feedOpen}),i&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>A(M),children:mn(M)?r.rowExtract:r.feedPutEval})]})]},F||x)})})]})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(z=>{const R=E[z].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(z==="deals"?"ddeals":"dnews")+(s===z?" on":"")+(b===z?" busy":""),title:z==="deals"?r.feedDealsH:r.feedNewsH,"aria-busy":b===z||void 0,onClick:()=>L(z),children:[b===z?n==="en"?"Loading…":"Chargement…":z==="deals"?r.feedDeals:r.feedNews,R>0&&b!==z&&t.jsx("em",{title:r.feedHint,children:r.feedNew(R)})]},z)}),s&&T(s)]})}function ki(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function wp(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function fo({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:s}=X();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(m=>t.jsx("span",{className:"ch",children:m},m))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function Ei({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=X(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(fo,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(fo,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function yp({card:e,onEvaluate:a,onAddAll:r}){var s,l,m;const{t:n}=X(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ki(e.summary_md||"").map((c,g)=>t.jsx("p",{children:c},g))})]}),t.jsx(Ei,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((m=e.prospective)==null?void 0:m.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function kp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Ep({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=X(),s=o,[l,m]=p.useState(null),[c,g]=p.useState(null),[u,b]=p.useState(null),[h,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const w=await Lo({email:d,cbToken:s});f&&m(w)})(),()=>{f=!1}},[d,s,n]);const y=f=>{g(f),b(null),v(!0),(async()=>{const w=await ys(f.id);b(w),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{g(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[kp(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),h&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!h&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!h&&u&&t.jsx(yp,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Ma=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ca(e){return/^https?:\/\//i.test((e||"").trim())}function ht(e){const a=(e||"").trim();return a?ca(a)?a:Ma.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function jp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Np(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:s,evalBusy:l,evalCards:m,caps:c,data:g,canWrite:u,source:b,dossiers:h,doAnalyse:v,liveMemos:y,pipe:f}=X(),w=r==="client",E=p.useMemo(()=>n||(b!=="default"?ks():""),[n,b]),[k,j]=p.useState(""),[N,A]=p.useState(!1),[L,T]=p.useState(""),[z,R]=p.useState(""),[B,H]=p.useState(""),[M,x]=p.useState(!1),[F,C]=p.useState(!1),[_,G]=p.useState([]);p.useEffect(()=>{const D=ne=>{const W=ne.detail;W&&G(pe=>[W,...pe].slice(0,8))};return window.addEventListener("ppmap:evalcard",D),()=>window.removeEventListener("ppmap:evalcard",D)},[]);const[Z,re]=p.useState(!1),[S,$]=p.useState(!1),[I,ee]=p.useState(!1),U=p.useRef(!1),[oe,me]=p.useState(""),[xe,ye]=p.useState(""),[ce,ze]=p.useState(!1),[Ae,ue]=p.useState(!1),[ve,ke]=p.useState(0),[te,P]=p.useState(""),[K,le]=p.useState(null),[se,fe]=p.useState(null),[V,de]=p.useState(!1),[we,Ee]=p.useState(null),[je,be]=p.useState(0),Be=p.useRef(!1),et=p.useRef(()=>{}),ut=k.trim()?Ma.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const D=new URLSearchParams(window.location.search),ne=(D.get("rs")||"").trim(),W=(D.get("rstext")||"").trim();ne&&/^https?:\/\//i.test(ne)&&me(ne),W&&ye(W),(ne&&/^https?:\/\//i.test(ne)||W)&&re(!0)},[]),p.useEffect(()=>{const D=ne=>{const W=ne.detail||{},pe=String(W.url||"").trim(),Ne=String(W.text||"").trim(),he=pe&&/^https?:\/\//i.test(pe)?pe:"";he&&me(he),Ne&&ye(Ne),(he||Ne)&&(re(!0),j(""),T(""),P(""),ze(!0),window.setTimeout(()=>ze(!1),900),W.auto&&window.setTimeout(()=>{et.current({url:he,text:Ne})},0))};return window.addEventListener("ppmap:research",D),()=>window.removeEventListener("ppmap:research",D)},[]),p.useEffect(()=>{const D=ne=>{const W=ne.detail||{},pe=String(W.name||"").trim();if(!pe)return;re(!1),j(pe),T(pe);const Ne=ht(String(W.website||W.domain||""));R(Ne),H(ht(String(W.url||""))),x(!Ne),A(!0),window.setTimeout(()=>A(!1),900)};return window.addEventListener("ppmap:prefill",D),()=>window.removeEventListener("ppmap:prefill",D)},[]),p.useEffect(()=>{const D=(L||"").trim();if(!D||Z||z){(z||!D||Z)&&x(!1);return}const ne=Ge(D),W=h.find(Se=>Ge(Se.name)===ne)||h.find(Se=>{const Re=Ge(Se.name);return Re.length>=3&&(ne.includes(Re)||Re.includes(ne))}),pe=ht((W==null?void 0:W.website)||"")||ht((W==null?void 0:W.domain)||""),Ne=ht((W==null?void 0:W.url)||"");if(Ne&&H(Se=>Se||Ne),pe){R(pe),x(!1);return}let he=!0;return x(!0),Hn(D).then(Se=>{var Qe,mt;if(!he)return;const Re=ht(Se.website||"")||ht(((mt=(Qe=Se.candidates)==null?void 0:Qe[0])==null?void 0:mt.url)||"");Re&&R(Re)}).catch(()=>{}).finally(()=>{he&&x(!1)}),()=>{he=!1}},[L,Z,z,h]),p.useEffect(()=>{const D=ne=>{var pe;const W=String(((pe=ne.detail)==null?void 0:pe.url)||"").trim();ca(W)&&window.open(W,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",D),()=>window.removeEventListener("ppmap:view",D)},[]),p.useEffect(()=>{if(U.current===Z)return;U.current=Z,ee(!0);const D=window.setTimeout(()=>ee(!1),560);return()=>window.clearTimeout(D)},[Z]),p.useEffect(()=>{if(typeof window>"u")return;const D=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ne=document.querySelector(".atl2.ops, .atl2.cibles");if(!D||!ne)return;const W=ne.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,pe=()=>{const he=parseFloat(window.getComputedStyle(D).top)||0,Se=D.getBoundingClientRect().top<=he+1;D.classList.toggle("is-stuck",Se),ne.classList.toggle("url-stuck",Se);const Re=Math.round(D.getBoundingClientRect().height);ne.style.setProperty("--demand-h",`${Re}px`);const Qe=window.matchMedia("(min-width: 861px)").matches;W&&Qe?ne.style.setProperty("--pp-live-h",`${Math.round(W.getBoundingClientRect().height)}px`):ne.classList.contains("cibles")&&ne.style.setProperty("--pp-live-h","0px")};pe();const Ne=new ResizeObserver(pe);return Ne.observe(D),W&&Ne.observe(W),window.addEventListener("scroll",pe,!0),window.addEventListener("resize",pe),()=>{Ne.disconnect(),D.classList.remove("is-stuck"),ne.classList.remove("url-stuck"),window.removeEventListener("scroll",pe,!0),window.removeEventListener("resize",pe)}},[b,N,ce,F,Z,I,M]),p.useEffect(()=>{if(!u&&!E){Ee(null);return}let D=!0;return(async()=>{const ne=await Lo({email:o,cbToken:E});D&&Ee(ne.length)})(),()=>{D=!1}},[u,E,o,je]);const Fe=_.length?_:m,Ve=g.credits,wt=p.useCallback(D=>{const ne=fp(n,D);return C(!1),s({type:"ptab",tab:0}),requestAnimationFrame(()=>{const W=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!W)return;const pe=window.scrollY+W.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,pe),behavior:"smooth"})}),ne},[n,s]);p.useEffect(()=>{if(!Ae)return;ke(0);const D=window.setInterval(()=>ke(ne=>ne+1),1e3);return()=>window.clearInterval(D)},[Ae]);const Ue=p.useMemo(()=>{const D=k.trim().toLowerCase();return!D||!f?null:h.find(ne=>Ge(ne.name)===D&&Te(ne)===1)||null},[k,h,f]),ot=()=>{const D=k.trim();if(D){if(Ue){v(Ue);return}i(null,D),w&&j("")}},Rt=(D,ne,W,pe)=>{const Ne=W.length?W:ne,he=wt(Ne)||0;hp({title:(D.title||"").trim(),url:(D.source_url||"").trim(),cited:ne,match:W,added:he,fallback:pe})},yt=async D=>{var pe,Ne,he;if(Be.current)return;const ne=((D==null?void 0:D.url)??oe).trim().replace(/\s+/g,""),W=((D==null?void 0:D.text)??xe).trim();if(!ne&&!W){P(e.rsNeed);return}if(!w&&!E){i(null,ne||W.slice(0,80));return}Be.current=!0,P(""),le(null),fe(null),ue(!0);try{const Se=await js({url:ne,text:W,email:o,cbToken:E});ue(!1);const Re=st=>(st||[]).map(At=>((At==null?void 0:At.name)||"").trim()).filter(Boolean);if(!Se||Se.status!=="success"){const st=Jn(W||(Se==null?void 0:Se.title)||"");if(st.length){const At={status:"success",title:W||ne,source_url:ne,summary_md:e.rsNoteFallback,companies_cited:st.map(aa=>({name:aa})),prospective:{companies_to_evaluate:st.map(aa=>({name:aa}))}};P(""),le(At),re(!1),Rt(At,st,st,!0);return}P((Se==null?void 0:Se.message)||"Erreur");return}le(Se),re(!1);const Qe=Re(Se.companies_cited),mt=Re((pe=Se.prospective)==null?void 0:pe.companies_to_evaluate);Rt(Se,Qe,mt,!1),fe({state:"pending"});const $e=await Ns(Se,{email:o,cbToken:E});fe($e.ok?{state:"ok",scopeLabel:((Ne=$e.summary)==null?void 0:Ne.scope_label)||"",scope:((he=$e.summary)==null?void 0:he.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&be(st=>st+1)}finally{Be.current=!1,ue(!1)}};et.current=D=>{yt(D)};const Ot=[K==null?void 0:K.industry,...(K==null?void 0:K.market_tags)||[],K==null?void 0:K.author].map(D=>(D||"").trim()).filter(Boolean),zt=(se==null?void 0:se.state)==="pending",Mt=se&&(zt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):se.state==="ok"?t.jsx("span",{className:"rslink ok",children:se.scope&&se.scope!=="public"?e.rsSavedIn(se.scopeLabel||se.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:se.msg,children:e.rsSaveFail})),kt=wp(K).length,Pe=Z,it=(L||k).trim(),tt=h.find(D=>Ge(D.name)===Ge(it)),Ct=ht(k)||z||ht((tt==null?void 0:tt.website)||"")||ht((tt==null?void 0:tt.domain)||""),O=B||ht((tt==null?void 0:tt.url)||""),Y=Ue?e.actAnalyse:it?e.evalGoOn(it.length>22?it.slice(0,21)+"…":it):e.evalGo,ae=Ae?`${Es(oe.trim())==="youtube"&&oe.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ve)}`:zt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Pe?" rs-mode":"")+(L&&k.trim()===L||N||ce?" pair":"")+(N||ce||I?" echo":"")+(I?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:Pe?a==="en"?"Extract companies from an article":"Extraire les sociétés d’un article":a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:Pe?a==="en"?"Paste an article or video URL — Stan lists the companies, then you pick which ones to screen.":"Collez l’URL d’un article ou d’une vidéo — Stan en sort les sociétés, vous choisissez lesquelles évaluer.":a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Pe?ce:N)||I?" flash":"")+((Pe?oe.trim():Ma.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Pe?oe:k,placeholder:Pe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Pe?600:200,spellCheck:Pe?!1:void 0,inputMode:Pe?"url":void 0,onChange:D=>{if(Pe){me(D.target.value);return}j(D.target.value),L&&D.target.value.trim()!==L&&(T(""),R(""),H(""),x(!1))},onKeyDown:D=>{D.key==="Enter"&&(Pe?yt():ot())}}),t.jsx("span",{className:"detect"+(Pe?" off":"")+(Ma.test(k.trim())?" url":""),children:ut})]}),t.jsx("span",{className:"dacts",children:Pe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Ae?" loading":""),disabled:Ae||zt||!oe.trim()&&!xe.trim(),onClick:()=>{yt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ae})]}),t.jsxs("a",{className:"viewbtn"+(ca(oe)?"":" off"),href:ca(oe)?oe.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:D=>{ca(oe)||D.preventDefault()},children:[t.jsx(jp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(Za,{lang:a,storeKey:((Ue==null?void 0:Ue.name)||k).trim(),className:"evalbtn"+(Ue?" analyse":"")+(l?" loading":""),disabled:l,confirmLabel:Y,onConfirm:ot,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Y})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(M?" searching":Ct?"":" off"),href:Ct||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":M||void 0,title:M?e.viewSiteBusyHint:e.viewSiteHint,onClick:D=>{Ct||D.preventDefault()},children:[M&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),M?e.viewSiteBusy:e.viewSite,!M&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(O?"":" off"),href:O||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:D=>{O||D.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),c.showCredits&&Ve&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(Ve.total_available<=0&&!Ve.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Ve.unlimited?"∞":Ve.total_available}),!Ve.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Ve.daily_grant+Ve.purchased]}),Ve.total_available<=0&&!Ve.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{s({type:"ptab",tab:0}),C(!1),requestAnimationFrame(()=>{const D=document.querySelector(".atl2.cibles .desk-list");if(!D)return;const ne=window.scrollY+D.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,ne),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(Z?" on":""),title:e.rsOpenHint,onClick:()=>re(!Z),children:e.rsOpen}),we!==null&&we>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(V?" on":""),onClick:()=>de(!V),children:e.rsArchOpen(we)}),c.pipe&&!!n&&t.jsx(vp,{pageToken:E,onAddNames:wt})]}),V&&t.jsx(Ep,{bump:je,cbToken:E,onClose:()=>de(!1),onEvaluate:D=>i(null,D),onAddAll:wt}),t.jsx("div",{className:"rsp slim"+(Z?" on":" off"),"aria-hidden":!Z,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:Z?void 0:-1,onClick:()=>$(D=>!D),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:S?"▴":"▾"})]}),S&&t.jsx("textarea",{className:"rstext",value:xe,placeholder:e.rsTextPh,tabIndex:Z?void 0:-1,onChange:D=>ye(D.target.value)})]})}),te&&t.jsx("div",{className:"rserr",children:te}),K&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:K.title}),K.source_url&&t.jsx("a",{href:K.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{le(null),fe(null)},children:"×"})]}),K.market&&t.jsx("p",{className:"rsmk",children:K.market}),Ot.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Ot.map(D=>t.jsx("span",{children:D},D))]}),t.jsxs("div",{className:"rsbody",children:[K.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${K.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ki(K.summary_md||"").map((D,ne)=>t.jsx("p",{children:D},ne))})]}),t.jsx(Ei,{card:K,onEvaluate:D=>i(null,D),onAddAll:wt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(kt)}),Mt]})]}),Fe.slice(0,1).map((D,ne)=>{const W=D.verdict==="kept",pe=D.verdict==="quota",Ne=D.verdict==="unresolved",he=W?"var(--brand)":pe?"var(--bolt)":Ne?"var(--blue)":"var(--red)",Se=W?"var(--brand-l)":pe?"#FFF3D6":Ne?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":he,"--bgc":Se},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:W?"✓ "+e.kept:pe?"⏳":Ne?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),D.name&&t.jsx("span",{className:"rn",children:D.name}),t.jsx("span",{className:"rr",children:D.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",D.reason]}):null}),!!(D.candidates&&D.candidates.length)&&t.jsx("span",{className:"sitepick",children:D.candidates.map(Re=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Re.url.startsWith("http")?Re.url:`https://${Re.url}`,target:"_blank",rel:"nofollow noopener",children:[(Re.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Re.url,D.name),children:e.evalPickGo})]},Re.url))}),!pe&&!Ne&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:W?1:5});const Re=(D.name||"").trim().toLowerCase();window.setTimeout(()=>{const Qe=[...document.querySelectorAll(".atl2 .list .row")].find(mt=>{var $e;return((($e=mt.querySelector(".rnm"))==null?void 0:$e.textContent)||"").trim().toLowerCase().includes(Re)});Qe&&(Qe.scrollIntoView({behavior:"smooth",block:"center"}),Qe.classList.add("flashrow"),window.setTimeout(()=>Qe.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(W?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),w&&(d.kept+d.dropped>0||Fe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Sp(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function zp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=X(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",Sp(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const s=Ft(i),l=$n(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((m,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:m},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Yt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:l===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Xn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=X(),[d,s]=p.useState(!1),[l,m]=p.useState(null),c=n.pipe&&o==="client"&&!n.lockActions,g=async()=>{if(!c||d)return;s(!0);const u=await To(r,e);if(s(!1),!u){i(a.actErr);return}m(u.results||[])};return p.useEffect(()=>{if(!c)return;const u=b=>{var v;const h=String(((v=b.detail)==null?void 0:v.name)||"").trim();h&&h.toLowerCase()===e.toLowerCase()&&g()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,c]),p.useEffect(()=>{if(c)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),g())}catch{}},[e,c]),c?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{g()},children:d?a.similarBusy:a.similar}),l&&(l.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:l.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Cp=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ta=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ba(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function Bn(e){const a=ba(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function Ap(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=Ta(a.slice(n));break}r+=Ta(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=Ta(a.slice(o));break}const d=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(d),l=s?s[2].toLowerCase():"";s&&Cp.has(l)?r+=`<${s[1]}${l}>`:r+=Ta(a.slice(o,i+1)),n=i+1}return r}const qp=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),ho={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function ji(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(qp.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const s=d.name.toLowerCase();(!(ho["*"].has(s)||((r=ho[o])==null?void 0:r.has(s)))||s.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(s=>s.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(s)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}ji(n)}}function Da(e){const a=e.cloneNode(!0);return ji(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Tp={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},Lp=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,Fp=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function Ut(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function Ni(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function fn(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?Ni(e,n.index):""}function Rp(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const s=r[d],l=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(s),m=l?Ut(l[1]):"";if((d<2||/<th/i.test(s)||Lp.test(m))&&n.push(s),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function Op(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=Rp(o,a);return r=r||i.pruned,i.html}),pruned:r}}function Mp(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=Ni(e,i.index);let s=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(l=>Ut(l));if(!s.length){const l=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);l&&(s=[Ut(l[1])])}if(s=s.filter(l=>l&&!/not available/i.test(l)&&!/non disponible/i.test(l)).map(l=>l.slice(0,260)).slice(0,4),!s.length)return null;a[n]=s}return a}function Dp(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?Ut(n[1]).slice(0,600):""}function Ip(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(Ut(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function go(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function hn(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function Pp(e){const a={...Tp,pruned:[]};if(!e)return a;try{const n=fn(e,"swot");n&&(a.swot=Mp(n))}catch{}try{a.summary=Dp(e)}catch{}try{const n=fn(e,"action-plan");if(n){const o=go(n);a.plan=hn(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of Fp)try{let i=Ip(e,o,r);if(!i)continue;const d=Op(i);i=hn(d.html,45e3),Ut(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=fn(e,"conviction");if(n){const o=hn(go(n),8e3);Ut(o)&&(a.reco=o)}}catch{}return a}function _p(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const gn=new Map;function Si(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=gn.get(a);return r||(r=Bp(a).catch(()=>null),r.then(n=>{n||gn.delete(a)}),gn.set(a,r)),r}async function Bp(e){var u,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=h=>{var v;return(((v=n.querySelector(h))==null?void 0:v.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((u=Array.from((i==null?void 0:i.classList)||[]).find(h=>h.startsWith("sb-score-")))==null?void 0:u.slice(9))||"",s=[];let l=null;const m=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const h of m){if(h.classList.contains("sb-nav-heading")){l={label:(h.textContent||"").trim(),items:[]},s.push(l);continue}const v=h.getAttribute("href")||"";if(!v.startsWith("#"))continue;const y=v.slice(1),f=Up(n,y);f&&(l||(l={label:"",items:[]},s.push(l)),l.items.push({id:y,title:(h.textContent||"").trim(),html:f,poids:f.length}))}const c=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",g={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(h=>(h.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:s.filter(h=>h.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?c:"",comite:$p(n,Pp(r))};return g.groups.length?g:null}function $p(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,Da(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const xo={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Up(e,a){const r=e.getElementById(a),n=r?bo(e,r):"";if(n)return n;const o=xo[a]?e.querySelector(xo[a]):null;return o&&o!==r?bo(e,o):""}function bo(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Da(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(l=>/^h3$/i.test(l.tagName))[0]===a)for(const l of i){if(l===a)break;/^h2$/i.test(l.tagName)||o.appendChild(l.cloneNode(!0))}let s=a.nextElementSibling;for(;s&&!/^h3$/i.test(s.tagName);)o.appendChild(s.cloneNode(!0)),s=s.nextElementSibling;return o.children.length?Da(o):""}return Da(a)}const xn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Je({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Hp({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function vo(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function wo({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const bn=new Map;function Vp(e,a){const{token:r}=X(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=bn.get(i);d||(d=Ss(r,e.name,e.checkId),bn.set(i,d),d.then(l=>{(!l||!l.reasoning&&!l.summaryHtml)&&bn.delete(i)}));let s=!0;return d.then(l=>{s&&l&&o({id:e.id,d:l})}),()=>{s=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Wp=6e4;function Gp({o:e}){const{t:a,doDeep:r}=X(),[n,o]=p.useState(null),[i,d]=p.useState(e.memoUrl?"load":"off"),[s,l]=p.useState(()=>new Set),[m,c]=p.useState(!1),g=p.useRef(new Map);p.useEffect(()=>{let v=!0;if(l(new Set),c(!1),g.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),Si(e.memoUrl).then(y=>{v&&(o(y),d(y?"ok":"err"))}),()=>{v=!1}},[e.memoUrl]);const u=Ft(e),b=v=>{var y;return(y=g.current.get(v))==null?void 0:y.scrollIntoView({behavior:"smooth",block:"start"})},h=t.jsxs("div",{className:"cdacts",children:[Yt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:v=>{v.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const v=[e.reasoning||"",vo(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[v.length?v.join(`

`).split(`

`).map((y,f)=>t.jsx("p",{className:"cdtxt",children:y},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),h]})}if(i!=="ok"){const v=[e.reasoning||"",vo(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),v.length>0&&v.join(`

`).split(`

`).map((y,f)=>t.jsx("p",{className:"cdtxt",children:y},f)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:y=>{y.stopPropagation(),c(f=>!f)},children:m?a.memoHideHere:a.memoReadHere})}),m&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:y=>y.stopPropagation()}),h,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(v=>t.jsx("span",{className:"md-tag",children:v},v)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(v=>v.items.map(y=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),b(y.id)},children:y.title},y.id)))}),n.groups.map((v,y)=>t.jsxs("div",{className:"md-grp",children:[v.label&&t.jsx("div",{className:"md-grp-h",children:v.label}),v.items.map(f=>{const w=f.poids>Wp&&!s.has(f.id),E=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&g.current.set(f.id,k)},children:[t.jsx("h4",{className:"md-h",children:f.title}),E&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),w?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),l(j=>new Set(j).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:E?f.html.replace(/>\s*unavailable(\s+unavailable)*\s*</gi,"><"):f.html}}),!w&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${wa}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},f.id)})]},v.label||y)),h,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}function Yp({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:s}=X(),[l,m]=p.useState(!1),[c,g]=p.useState(!1),[u,b]=p.useState(!1),[h,v]=p.useState(null),[y,f]=p.useState(""),[w,E]=p.useState(null),[k,j]=p.useState(""),N={airtableId:e.airtableId,checkId:e.checkId},A=!!(e.airtableId||e.checkId),L=h&&h.id===e.id?h.entries:[],T=!!h&&h.id===e.id;if(p.useEffect(()=>{f(""),E(null),b(!1)},[e.id]),p.useEffect(()=>{if(!l||T||!A||!o)return;let R=!0;g(!0),b(!1);const B=e.id;return hr(r,"list",N).then(H=>{if(!(!R||B!==e.id)){if(g(!1),!H.ok){b(!0);return}v({id:B,entries:H.entries})}}),()=>{R=!1}},[l,T,A,r,e.id,o]),!n.pipe||!o||!A)return null;const z=(R,B)=>{g(!0);const H=e.id;hr(r,R,N,B).then(M=>{if(H===e.id){if(g(!1),!M.ok){d(a.notesErr);return}v({id:H,entries:M.entries}),b(!1),R==="add"&&(f(""),i(a.notesAdded)),R==="edit"&&E(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":l,onClick:R=>{R.stopPropagation(),m(B=>!B)},children:[t.jsx("b",{children:a.notesT}),L.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(L.length)}),t.jsx("i",{children:l?"▾":"▸"})]}),l&&t.jsxs("div",{className:"dn-b",onClick:R=>R.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),c&&!L.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!c&&!u&&T&&!L.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),L.map(R=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:s==="fr"?R.date.split("-").reverse().join("/"):R.date}),w===R.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:B=>j(B.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||!k.trim(),onClick:()=>z("edit",{entryId:R.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>E(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:R.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{E(R.id),j(R.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:c,onClick:()=>{window.confirm(a.notesDelAsk)&&z("delete",{entryId:R.id})},children:a.notesDel})]})]})]},R.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:y,onChange:R=>f(R.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:c||!y.trim(),onClick:()=>z("add",{text:y.trim()}),children:a.notesAdd})]})]})]})}function Zn({o:e}){var j;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=X(),s=ya(e),l=Ft(e),m=(e.cribleStatus||"").trim().toUpperCase()||(s==="NO MATCH"?"NO MATCH":s==="MATCH"?"MATCH":""),c=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,Bn(e.provUrl||""),Pa(e),e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,u=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(m?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Yt(e)?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:u}].filter(N=>N.n>0),[e,a,o,m,l,c,g,u]),[h,v]=p.useState(""),y=b.some(N=>N.k===h)?h:((j=b[0])==null?void 0:j.k)||"";p.useEffect(()=>{const N=A=>{var T;const L=String(((T=A.detail)==null?void 0:T.tab)||"");L&&b.some(z=>z.k===L)&&v(L)};return window.addEventListener("ppmap:card-tab",N),()=>window.removeEventListener("ppmap:card-tab",N)},[b]);const f=Vp(e,y==="eval"||y==="conv");if(!b.length)return null;const w=((f==null?void 0:f.reasoning)||"").length>(e.reasoning||"").length?f.reasoning:e.reasoning||"",E=((f==null?void 0:f.summaryHtml)||"").length>(e.summary||"").length?f.summaryHtml:e.summary||"",k=(f==null?void 0:f.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":y===N.k,"data-tour":"tab-"+N.k,className:y===N.k?"on":"",onClick:A=>{A.stopPropagation(),v(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[y==="eval"&&t.jsxs(t.Fragment,{children:[m&&t.jsxs("div",{className:"cdv1"+(m==="NO MATCH"?" out":""),children:[t.jsx("b",{children:m==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(wo,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),w&&w.split(`

`).map((N,A)=>t.jsx("p",{className:"cdtxt",children:N},A)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Qp,{o:e})]}),y==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(wo,{v:k,sur:100,k:a.cdConvScore}),xn(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",xn(e.verdictDate,r)]})]}),E&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Ap(E)}})]}),y==="memo"&&t.jsx(Gp,{o:e}),y==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Je,{k:a.cdSector,v:e.sector}),t.jsx(Je,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(Hp,{k:a.cdTags,vals:e.tags}),t.jsx(Je,{k:a.cdStage,v:e.stage}),t.jsx(Je,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Je,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Je,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Je,{k:a.cdAngle,v:e.angle}),t.jsx(Je,{k:a.cdDetected,v:xn(e.date,r)}),t.jsx(Je,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(Je,{k:a.cdSrc,v:Bn(e.provUrl||""),href:ba(e.provUrl||"")}),t.jsx(Je,{k:a.cdAngleSrc,v:Pa(e)})]}),y==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Je,{k:a.cdName,v:e.contactName}),t.jsx(Je,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Je,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(Je,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),y==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(Je,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(Yp,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const La=new Map;function Qp({o:e}){const{t:a,token:r}=X(),[n,o]=p.useState(!1),[i,d]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const g=`${r}:${e.name.toLowerCase()}`;let u=La.get(g);u||(u=Fo(r,[e.name]).then(h=>h[e.name]||Object.values(h)[0]||null).catch(()=>null),La.set(g,u),u.then(h=>{(!h||!h.ok)&&La.delete(g)}));let b=!0;return u.then(h=>{b&&h&&h.ok&&d(h)}),()=>{b=!1}},[r,e.id,e.name]);const s=async()=>{if(n)return;o(!0);const g=await Ao(r,e.name,e.website||e.domain||"");d(g),g.ok&&La.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(g)),o(!1)},l=(i==null?void 0:i.blocs)||{},m=[[a.qaVP,l.value_prop],[a.qaProduct,l.produit],[a.qaModel,l.modele],[a.qaSummary,l.synthese]],c=m.some(([,g])=>g);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&c&&t.jsxs(t.Fragment,{children:[m.filter(([,g])=>g).map(([g,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:g}),t.jsx("p",{children:u})]},g)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!c&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function ta({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const s=()=>{const m=Math.max(280,Math.min(560,i.clientWidth||320));gr({kind:"op",card:e},m).then(c=>{!d&&c&&i.isConnected&&i.replaceChildren(c)})},l=window.requestAnimationFrame(s);return()=>{d=!0,window.cancelAnimationFrame(l),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;gr({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(l=>{!d&&l&&i.isConnected&&i.replaceChildren(l)});const s=l=>{l.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{d=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Kp=`
...
`;function Jp(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:d,top:s}}function Xp(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:s,doAnalyse:l,doDecide:m,doPromote:c,doRepeche:g,doApproach:u,doDeep:b,doOnboard:h,outbound:v,evalBusy:y}=X(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const w=He(f),E=Te(f),k=Ft(f),j=ya(f),N=f.kind==="target",A=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return Zt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Kp}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Jp(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(gt(f.date)),rt(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[f.cc]}),children:(ea(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Ht(f.amountEur,o)})]}),i.pipe&&N&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[_t(f.engine)," ",t.jsx("b",{children:rt(f.engine,o)})," — ",zs(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),w?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Lt,{o:f,lg:!0})," ",t.jsx(en,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ro(w,o))," · ",n.win7(Oo(w,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(ta,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&N&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&N&&t.jsx(Zn,{o:f})]}),t.jsx(Xn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),E===1&&t.jsxs(Za,{lang:o,storeKey:f.name,className:"evalbtn memo",style:{flex:1,justifyContent:"center"},confirmLabel:n.actAnalyse,onConfirm:()=>{l(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{m(f,!1),a({type:"popup",id:null})},children:n.actNo}),Yt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{h(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Zp(){const{lang:e,token:a,dossiers:r,caps:n}=X(),o=a||"home",{names:i,verdicts:d}=p.useMemo(()=>{const l=[],m={};return r.forEach(c=>{c.kind!=="target"||!c.name||(l.push(c.name),m[c.name]=Cs(c)||"")}),{names:l,verdicts:m}},[r]);return{diff:p.useMemo(()=>i.length?As(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function ec(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:s}=X(),[l,m]=p.useState(!1),[c,g]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!l)return;const E=k=>{u.current&&!u.current.contains(k.target)&&m(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[l]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...s.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],h=i.loading&&!d.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const y=E=>{const k=v.current[E],j=k!==void 0?r[E]-k:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${ma[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E],E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(j>0?" up":j<0?" down":""),children:[r[E],j!==0&&t.jsxs("em",{className:"delta",children:[j>0?"+":"−",Math.abs(j)]})]})]},E)},f=(E,k,j)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),"data-off":E,style:{"--c":`var(${ma[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:j}),t.jsx("span",{className:"n",children:r[E]})]},E),w=(E,k,j,N=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:N,onClick:j,children:E},k);return t.jsxs("div",{className:"funnel"+(h?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(y)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[w("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(c?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:s.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}g(!0),window.setTimeout(()=>g(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":l,title:n.toolSort,onClick:()=>m(E=>!E),children:"⇅"}),l&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[k,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),w("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),w("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function tc(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,mode:s,data:l}=X(),m=p.useRef(null),[c,g]=p.useState(60);p.useEffect(()=>{let A=0;const L=()=>{var H;const T=m.current;if(!T)return;const z=(H=T.parentElement)==null?void 0:H.querySelector('.funnel [aria-selected="true"]');if(!z)return;const R=z.getBoundingClientRect(),B=T.getBoundingClientRect();g(Math.max(20,Math.min(R.left+R.width/2-B.left,B.width-30)))};return A=requestAnimationFrame(L),window.addEventListener("resize",L),()=>{cancelAnimationFrame(A),window.removeEventListener("resize",L)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const A=i.filter(z=>z.kind==="target"&&Te(z)===3),L=A.filter(z=>kn(z)==="auto").length,T=A.filter(z=>kn(z)==="cd").length;b=r.tutoPending(L,T,A.length)}const h=(()=>{var A;if(s!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(L=>L.id)})};if(u===1){const L=i.filter(T=>T.kind==="target"&&Te(T)===1&&!d.has(T.id)).slice(0,10);if(L.length){const T=String(((A=l.credits)==null?void 0:A.plan)||"").toLowerCase(),z=T==="enterprise"||T==="entreprise";return{label:r.tuto[1].a,locked:!z,run:()=>{z&&a({type:"chainStart",queue:L.map(R=>R.id)})}}}}return null})(),v=qs(u),y=u===1||u===2,f=u===5,w=u===7,E=u===6,k=v||f||w,j=r.plabels[u]+" · "+(o[u]??0),N=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:m,className:"tuto mini"+(k?"":" on-dark")+(y?" etape-on":"")+(f?" etape-out":"")+(w?" etape-view":"")+(E?" etape-fav":""),style:{"--bg":`var(${ma[u]})`,"--ax":c+"px","--stc":k?"var(--ink)":"#fff","--stt":k?"#fff":"var(--ink)","--tc":k?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:j}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),h&&t.jsx("button",{type:"button",className:"tprim"+(h.locked?" lock":""),disabled:!!h.locked,title:h.locked?r.analyseLockHint:void 0,onClick:h.run,children:h.locked?"🔒 "+r.analyseLock:h.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:N})]})}const vn=600,Tt=62,yo="atl2:fstats";function ac(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=X(),[d,s]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(yo)==="on"}catch{return!1}}),l=r.stats,m=p.useMemo(()=>((l==null?void 0:l.by_day)||[]).slice(-30),[l]),c=(l==null?void 0:l.since)||"";if(!n.showFunnel||!l||typeof l.screened!="number")return null;const g=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,u=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=m.reduce((j,N)=>Math.max(j,N.s||0),0),h=m.length?vn/m.length:0,v=Math.max(4,h-4),y=m.length>=5&&b>0,f=r.marketEstimate||0,w=g(new Date().toISOString().slice(0,10)),E=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof l.kept=="number"?[[l.kept,e.funKept]]:[],...typeof l.analyzed=="number"?[[l.analyzed,e.funAnalyzed]]:[],...typeof l.shown=="number"?[[l.shown,e.funShown]]:[]],k=[];return typeof l.screened_window=="number"&&c&&k.push({cle:"fenetre",periode:e.funPerWindow(g(c),w),etapes:[[l.screened_window,e.funScreened("","")]]}),typeof l.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:E(l.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([N,A],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(N)}),t.jsx("i",{children:A})]},j.cle+A)),j.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((l.screened||0)/f*100)))})]}),j.cle==="total"&&(l.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),j.cle===k[k.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const N=!d;s(N),N&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(yo,N?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},j.cle)),d&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${vn} ${Tt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[m.map((j,N)=>{const A=(j.s||0)/b*(Tt-4),L=(j.m||0)/b*(Tt-4),T=N*h+(h-v)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===j.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}),onKeyDown:z=>{z.key!=="Enter"&&z.key!==" "||(z.preventDefault(),i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}))},children:[t.jsx("title",{children:`${g(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:T-1,y:0,width:v+2,height:Tt,fill:"transparent"}),t.jsx("rect",{x:T,y:Tt-2-A,width:v,height:A,fill:"#cfe0d6"}),t.jsx("rect",{x:T,y:Tt-2-L,width:v,height:L,fill:"#0E7F3F"})]},j.d)}),t.jsx("line",{x1:0,y1:Tt-1.5,x2:vn,y2:Tt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:g(m[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const zi={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function er({o:e,locked:a=!1}){const{t:r}=X(),n=ya(e),o=Ft(e),i=Te(e),d=kn(e),s=Ts(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(zi[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(ld,{o:e})]})}const Xt=e=>e.length>22?e.slice(0,21)+"…":e;function va(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Ci(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .fzone:has(.stage.folded), .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .fzone:has(.stage.folded), .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function nc({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const d=()=>{var h,v,y;const s=document.querySelector(".atl2.ops .desk-list"),l=document.querySelector(".atl2.ops .listhead");if(!s){n(null);return}const m=s.getBoundingClientRect(),c=l?l.getBoundingClientRect().bottom:m.top;i({top:Math.round(c),left:Math.round(m.left),width:Math.round(m.width)});const g=[...s.querySelectorAll(":scope .grp")];let u=null;for(const f of g){const w=f.querySelector(".grp-h");w&&w.getBoundingClientRect().bottom<=c+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((h=b.querySelector(".ic"))==null?void 0:h.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function rc(e){const r=()=>{const n=Ci(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function ko({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=X(),[i,d]=p.useState(!1);if(p.useEffect(()=>{n||d(!1)},[n]),Ye(e)){const m=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const l=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(l?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:m=>{m.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Xt(e.name))})]})}function ua(e,a){e({type:"focus",id:a.id}),window.setTimeout(()=>{var r;window.dispatchEvent(new CustomEvent("ppmap:card-tab",{detail:{tab:"memo"}})),(r=document.querySelector(".atl2 .readpane"))==null||r.scrollIntoView({block:"nearest"})},40)}function tr({o:e}){const{t:a,lang:r,caps:n,memoQueued:o,approachDone:i,doAnalyse:d,doDecide:s,doPromote:l,doRepeche:m,doApproach:c,dispatch:g,liveMemos:u}=X(),b=v=>y=>{y.stopPropagation(),v()};if(n.lockActions){const v=b(()=>g({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:v,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const y=Te(e);return y===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:v,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Xt(e.name))})]})}):y===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:v,children:a.actAnalyse})}):y===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:v,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:v,children:a.actNo})]})}):y===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:v,children:a.actPromote})}):y===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:v,children:a.actApproach})}):y===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:v,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:v,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:v=>{v.stopPropagation(),va(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if($a(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:v=>{v.stopPropagation(),va(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!n.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(ko,{o:e})});const h=Te(e);if(h===0)return t.jsx("span",{className:"cell",children:t.jsx(ko,{o:e})});if(h===1){const v=u.liveOf(e.name);if(v&&(v.status==="boot"||v.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ba,{item:v,serverOff:u.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const y=o.has(e.id);return t.jsx("span",{className:"cell cell-an",children:t.jsx(Za,{lang:r,storeKey:e.name,className:"memobtn",disabled:y,confirmLabel:a.actAnalyse,onConfirm:()=>d(e),children:y?a.actAnalyseQueued:a.actAnalyse})})}if(h===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ua(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(h===4){const v=i.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:v,onClick:b(()=>c(e)),children:v?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:b(()=>g({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:b(()=>g({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return h===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ua(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):h===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>m(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ua(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>ua(g,e)),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function oc({o:e}){const{t:a,doThumb:r,thumbOf:n}=X(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function ic({o:e}){const{lang:a}=X();return He(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Lt,{o:e}),t.jsx(en,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[_t(e.engine||"")," ",rt(e.engine||"",a)]})})}function sc({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:s}){const{dispatch:l,caps:m,markRow:c,markedId:g,favIds:u,toggleFav:b,t:h}=X(),v=Te(e),y=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,w=f<=0?0:f<=7?1:f<=30?2:3,E=m.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][v]:y[w],k=u.has(e.id),j=N=>{if(a)return;if(d){d(e.id);return}if(m.pipe||e.kind==="op"){n();return}const A=N.currentTarget.getBoundingClientRect();l({type:"popup",id:e.id,anchor:{x:A.left+Math.min(280,A.width/3),y:A.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(g===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(m.pipe&&e.kind==="target"?" p"+v:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>c(e.id),onMouseLeave:()=>c(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(Ri,{o:e}),t.jsxs("span",{className:"nd",children:[s&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${h.cdEngagement} ${Math.round(e.engagement*10)/10} · ${h.cdEngagementHint}`,children:"🔥"}),He(e)&&t.jsx(Lt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[m.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[at(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""]}),m.pipe&&!m.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:N=>N.stopPropagation(),children:[e.website&&t.jsx("a",{href:ba(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":h.rowSite,title:h.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:ba(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":h.rowLi,title:h.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":h.rowMail,title:h.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":h.rowTel,title:h.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:h.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),l({type:"acquirer",value:e.acquirer||""})},children:["← ",Xt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:h.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:h.zoomNewsMark,children:"📰"}):null]}),t.jsx(lc,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(ic,{o:e}),m.pipe&&t.jsx(er,{o:e,locked:a}),m.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(tr,{o:e}),m.showThumbs&&t.jsx(oc,{o:e})]}),r&&!a&&!d&&t.jsx(cc,{o:e})]})}function lc({o:e}){const{lang:a,caps:r}=X();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ht(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function dc({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=X(),d=(u,b=!1)=>h=>{h.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),l=Ht(e.amountEur,r),m=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Ye(e),g=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),l&&t.jsx("span",{className:"oc-amt",children:l}),m&&t.jsx("span",{children:m})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped})]}):at(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),va(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Xt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ta,{spec:e.card})})]})}function pc({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=X();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=[e.tagline,e.headline,e.reasoning].find(m=>m&&m!==e.name)||"",s=Ht(e.amountEur,r),l=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].replace(/^www\./,"").slice(0,40):""})();return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[rt(e.engine||"",r),i?` · ${i}`:"",s?` · ${s}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(tr,{o:e})})]}),(e.sector||e.countryLabel||e.stage||e.acquirer)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null,e.acquirer?t.jsxs("span",{children:["← ",e.acquirer]}):null]}),(d||e.decryptHtml||e.url||e.card)&&t.jsxs("div",{className:"zoom-news",children:[d?t.jsx("p",{className:"zoom-lead",children:d}):null,e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):null,e.card?t.jsx("div",{className:"zoom-card",children:t.jsx(ta,{spec:e.card})}):null,e.url?t.jsxs("a",{className:"zoom-src",href:e.url,target:"_blank",rel:"nofollow noopener",children:[a.zoomSrc,l?` · ${l}`:""," ↗"]}):null]}),t.jsx(Zn,{o:e})]})}function Ai({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:s,dossiers:l}=X(),m=p.useRef(null),c=We(e);if(p.useEffect(()=>{if(!c||!(e!=null&&e.decryptHtml))return;const x=m.current;if(!x)return;let F=!1;return wn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(F||!x.isConnected)&&(C.beautifyEditoRows(x),C.mountCardFits(x))}),()=>{F=!0}},[c,e==null?void 0:e.decryptHtml]),!e&&!a){const x=l.find(We);if(x)return t.jsx(Ai,{o:x})}const g=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||g,h=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!g||Qt(g),y=(e==null?void 0:e.engine)||"",f=We(e),w=e?Ht(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),j=l.find(We),N=((j==null?void 0:j.url)||"").trim(),A=!!u&&!!N&&(u===N||u.endsWith(N)||N.endsWith(u)),L=(x,F=!1)=>C=>{C.stopPropagation(),F&&d({type:"continent",key:"monde"}),d({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{g&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:g}}))},z=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},R=()=>{va({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:g})},B=e?Ye(e):!1,H=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",M=f?r.doEdito.replace(/^📖\s*/,""):y?rt(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[M,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(v||$a({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:m,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),w&&t.jsx("span",{className:"oc-amt",children:w})]}),h&&t.jsx("div",{className:"zoom-card",children:t.jsx(ta,{spec:h})}),(u&&!A&&!f||j&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!A&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),d({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":H?"var(--brand)":"var(--red)"},children:[H?"✓":"✗"," ",t.jsx("b",{children:H?r.kept:r.dropped})]}):!v&&g?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,g)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Xt(g))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(v||$a({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&g?" ghost":""),onClick:x=>{x.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&g&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!s.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Xt(g)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&g&&s.pipe&&t.jsx(Xn,{name:g})]})]})}function cc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=X();return!o.pipe&&e.kind==="op"?t.jsx(dc,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Zn,{o:e}),t.jsx(dd,{o:e}),t.jsx(cd,{o:e}),t.jsx(Xn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(er,{o:e})})]}),e.card&&t.jsx(ta,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[_t(e.engine||"")," ",rt(e.engine||"",r)]}),He(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Lt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function uc({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:s,lang:l}=X();if(!d.pipe&&e.kind==="op"){const g=Ht(e.amountEur,l),u=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return h?h[1].slice(0,32):""})(),b=(h,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:h})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ta,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[_t(e.engine||"")," ",rt(e.engine||"",l)]}),He(e)&&t.jsx(Lt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(tr,{o:e})})]})}const m=Te(e),c=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][m];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":c},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(er,{o:e}),He(e)&&t.jsx(Lt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&m===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>s(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>ua(i,e),children:[o.actMemoOf(e.memoType)," →"]})]})}function mc(){const{t:e}=X(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function fc({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=X(),i=o==="en",d=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),l=s.includes(0)?0:s.sort((c,g)=>(e[g]||0)-(e[c]||0))[0];if(l===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const m=e[l]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:l===0?i?`${m} ${m>1?"files are":"file is"} waiting for your screening`:`${m} dossier${m>1?"s":""} attende${m>1?"nt":""} votre évaluation`:i?`${m} ${m>1?"files":"file"} in “${d(l)}”`:`${m} dossier${m>1?"s":""} dans « ${d(l)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:l}),children:[(i?"Open ":"Ouvrir ")+d(l)," →"]})]})}function hc(){var Pe,it,tt,Ct;const e=X(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:s,markRow:l,lang:m,sessTally:c,data:g,dossiers:u,source:b,focusExtra:h,byId:v,token:y}=e,f=Go(),w=p.useMemo(()=>{var ae,D,ne,W;if(!y||b==="ops")return null;const O=(((ae=f==null?void 0:f.ed)==null?void 0:ae.date)||(f==null?void 0:f.day)||"").slice(0,10),Y=[(D=f==null?void 0:f.ed)==null?void 0:D.html,(ne=f==null?void 0:f.ed)==null?void 0:ne.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:m==="en"?"Today's brief":"Brief du jour",headline:m==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((W=f==null?void 0:f.ed)==null?void 0:W.date)||O,decryptHtml:Y||void 0,date:O,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,m,(Pe=f==null?void 0:f.ed)==null?void 0:Pe.html,(it=f==null?void 0:f.ed)==null?void 0:it.acquirers_html,(tt=f==null?void 0:f.ed)==null?void 0:tt.date,f==null?void 0:f.day]),E=O=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Wo,[k,j]=p.useState(new Set);p.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[N,A]=p.useState(null);p.useEffect(()=>{A(null)},[a.ptab,a.continent]);const[L,T]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){T(!1);return}const O=document.getElementById("atl2-stage");if(!O){T(!1);return}const Y=new IntersectionObserver(([ae])=>T(!!ae&&ae.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return Y.observe(O),()=>Y.disconnect()},[a.mapFolded]);const z=a.mapFolded||!L,R=O=>j(Y=>{const ae=new Set(Y);return ae.has(O)?ae.delete(O):ae.add(O),ae}),B=b==="ops"||o.pipe,[H,M]=p.useState("all"),[x,F]=p.useState(!1),[C,_]=p.useState(null),[G,Z]=p.useState(!1),re=p.useRef(!0);p.useEffect(()=>{if(re.current){re.current=!1;return}M("all"),Z(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!G)return;const O=Y=>{var ae,D;(D=(ae=Y.target)==null?void 0:ae.closest)!=null&&D.call(ae,".atl2 .doable")||Z(!1)};return document.addEventListener("click",O,!0),()=>document.removeEventListener("click",O,!0)},[G]);const S=p.useMemo(()=>{var Y;const O=new Map;for(const ae of Ql(((Y=f==null?void 0:f.ed)==null?void 0:Y.html)||""))O.has(ae.t)||O.set(ae.t,ae.html);return O},[(Ct=f==null?void 0:f.ed)==null?void 0:Ct.html]),$=p.useCallback(O=>{if(O.decryptHtml)return O.decryptHtml;if(!S.size)return;const Y=(O.name||"").trim().toLowerCase();if(Y.length<3)return;const ae=S.get(Y);if(ae)return ae;for(const[D,ne]of S)if(D.includes(Y)||Y.includes(D))return ne},[S]),{diff:I}=Zp(),[ee,U]=p.useState(!1),oe=a.filters.win==="1"&&!a.filters.day,[me,xe]=p.useState(!1),[ye,ce]=p.useState(!1),ze=p.useMemo(()=>{const O={...a,filters:{...a.filters,win:"all",day:""}};return u.filter(Y=>!We(Y)&&gt(Y.date)===0&&Pt(Y,O,o.pipe)).length},[u,a,o.pipe]),Ae=p.useMemo(()=>new Set(((I==null?void 0:I.added)||[]).map(O=>O.trim().toLowerCase()).filter(Boolean)),[I]),ue=p.useMemo(()=>{if(!Ae.size)return 0;const O={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(Y=>!We(Y)&&Ae.has((Y.name||"").trim().toLowerCase())&&Pt(Y,O,o.pipe)).length},[u,Ae,a,o.pipe]);p.useEffect(()=>{const O=()=>{ce(!1),F(!1),xe(!1),M("all"),Z(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",O),()=>window.removeEventListener("ppmap:tunnel",O)},[]),p.useEffect(()=>{ce(!1),F(!1),xe(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ve=p.useMemo(()=>{const O=s.filter(ae=>!We(ae)&&at(ae));let Y="";for(const ae of O){const D=(ae.date||"").slice(0,10);D&&(!Y||D<Y)&&(Y=D)}return{n:O.length,since:Y?Y.split("-").reverse().slice(0,2).join("/"):""}},[s]),ke=ve.n,te=p.useMemo(()=>{const Y=ye&&Ae.size>0||a.filters.signalOnly||H!=="all"||x||me?s:d;let ae=Gn(Y,a.sort);return ae=ae.filter(D=>!We(D)),me&&(ae=ae.filter(D=>gt(D.date)===0)),ye&&Ae.size&&(ae=ae.filter(D=>Ae.has((D.name||"").trim().toLowerCase()))),x||H==="explore"?ae=ae.filter(at):H==="eval"?ae=ae.filter(D=>!at(D)&&!D.noCo&&(D.kind==="op"||!Ye(D))):o.pipe&&(ae=ae.filter(D=>!at(D))),ae},[d,s,a.sort,H,ye,Ae,x,me,o.pipe]),K=p.useMemo(()=>o.pipe?u.filter(O=>O.kind==="target"&&!We(O)&&He(O)&&(a.continent==="monde"||O.continent===a.continent)):te.filter(O=>He(O)&&!Ye(O)),[o.pipe,u,te,a.continent]).length,le=p.useMemo(()=>o.pipe?te:te.filter(O=>!Ye(O)&&!O.noCo&&!at(O)),[te,o.pipe]),se=b==="ops"?te.filter(at).length:0,fe=me?n.morningList:ye?n.sinceList:o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,V=a.filters,de=V.sector.length+V.market.length+V.country.length+V.engine.length+V.stage.length+V.crible.length+V.angle.length+V.memoLevel.length+V.dealKind.length+(V.signalOnly?1:0)+(V.acquirer.trim()?1:0)+(V.search.trim()?1:0),we=[];if(V.day)we.push({k:"day",lib:n.fDay(V.day.slice(8,10)+"/"+V.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(V.win&&V.win!=="all"){const O=["1","7","30"].indexOf(V.win);O>=0&&we.push({k:"win",lib:n.dates[O],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ee=O=>O.length<=2?O.join(", "):`${O.length} ${n.fSelected}`;for(const O of["sector","market","country","engine","crible"]){const Y=V[O];Y&&Y.length&&we.push({k:O,lib:Ee(Y),off:()=>r({type:"clearFacet",facet:O})})}V.search&&we.push({k:"search",lib:"🔍 "+V.search,off:()=>r({type:"filters",patch:{search:""}})}),ye&&Ae.size&&we.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>ce(!1)}),V.signalOnly&&we.push({k:"sig",lib:"🔴 "+n.sigDock(K||V.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const je=(O,Y,ae="",D=!1)=>t.jsxs("button",{type:"button","data-s":O,className:ae,"aria-sort":a.sort.key===O?a.sort.dir===1?"ascending":"descending":"none",style:D?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:O}),children:[Y,t.jsx("span",{className:"ar",children:a.sort.key===O&&a.sort.dir===1?"▴":"▾"})]},O),be=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const O=new Map;te.forEach(D=>{const ne=D.engine||"?";O.has(ne)||O.set(ne,[]),O.get(ne).push(D)});const Y={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},ae=yn([...O.keys()],m);return[...O.entries()].sort((D,ne)=>{const W=Y[D[0]]??10+ae.indexOf(D[0]),pe=Y[ne[0]]??10+ae.indexOf(ne[0]);return W-pe})},[te,o.pipe,a.groupBy,m]),Be=be?be.filter(([O])=>Ra.has(O)).length:0,et=(()=>{var Y;return((Y=(be?be.flatMap(([,ae])=>ae):te)[0])==null?void 0:Y.id)??null})(),ut=p.useRef(!1),Fe=p.useMemo(()=>u.find(We)||w,[u,w]),[Ve,wt]=p.useState(!1);p.useEffect(()=>{const O=()=>{ut.current=!0,ce(!1)};return window.addEventListener("ppmap:reveal",O),window.addEventListener("ppmap:focus",O),()=>{window.removeEventListener("ppmap:reveal",O),window.removeEventListener("ppmap:focus",O)}},[]),p.useEffect(()=>{const O=()=>{Fe&&r({type:"focus",id:Fe.id})};return window.addEventListener("ppmap:edito",O),()=>window.removeEventListener("ppmap:edito",O)},[Fe,r]),p.useEffect(()=>{if(!a.focusId)return;_(a.focusId);const O=window.setTimeout(()=>_(null),900);return()=>window.clearTimeout(O)},[a.focusId]),p.useEffect(()=>{if(B&&!(a.focusId&&(te.some(O=>O.id===a.focusId)||u.some(O=>O.id===a.focusId)||a.focusId===(Fe==null?void 0:Fe.id)))&&!h){if(Fe){r({type:"focus",id:Fe.id});return}et&&r({type:"focus",id:et})}},[B,a.focusId,te,et,h,r,u,b,Fe]),p.useEffect(()=>{if(!B||!a.focusId||Fe&&a.focusId===Fe.id||te.some(Y=>Y.id===a.focusId))return;const O=u.find(Y=>Y.id===a.focusId);if(O){if(ut.current){O.kind==="op"?M(at(O)?"explore":"eval"):H!=="all"&&M("all");return}H!=="all"&&et&&r({type:"focus",id:et})}},[B,a.focusId,H,te,u,et,r,Fe]),p.useEffect(()=>{if(!B||!a.focusId||!ut.current)return;const O=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!O){const ne=te.findIndex(W=>W.id===a.focusId);if(ne>=0){const W=be?"":"pt"+a.ptab;if(W){const pe=a.shown[W]||E();ne>=pe&&r({type:"more",group:W,by:ne-pe+8})}}return}ut.current=!1;const Y=Ci(),ae=O.getBoundingClientRect();ae.top>=Y-2&&ae.bottom<=window.innerHeight-4||rc(O)},[B,a.focusId,a.ptab,te,a.shown,be,r]),p.useEffect(()=>{if(typeof window>"u")return;const O=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),Y=document.querySelector(".atl2.ops, .atl2.cibles");if(!O||!Y)return;const ae=document.querySelector(".atl2 .fzone"),D=()=>{Y.style.setProperty("--listhead-h",`${O.offsetHeight}px`);const W=!!(ae&&ae.querySelector(".stage.folded"));Y.style.setProperty("--fold-h",W&&ae?`${ae.offsetHeight}px`:"0px")};D();const ne=new ResizeObserver(D);return ne.observe(O),ae&&ne.observe(ae),()=>ne.disconnect()},[z,a.dens,a.mapFolded]);const Ue=p.useMemo(()=>{if(!B||!a.focusId)return null;if(w&&a.focusId===w.id)return w;const O=te.find(ae=>ae.id===a.focusId)||u.find(ae=>ae.id===a.focusId)||null;if(!O)return null;const Y=$(O);return Y&&Y!==O.decryptHtml?{...O,decryptHtml:Y}:O},[B,a.focusId,te,u,$,w]),ot=o.lockRowsAfter;let Rt=0;const yt=(O,Y)=>{let ae=a.shown[Y]||E();return O.length-ae<=4&&(ae=O.length),O.slice(0,ae).map(W=>{const pe=ot!==null&&Rt>=ot;Rt++;const Ne=$(W),he=Ne&&Ne!==W.decryptHtml?{...W,decryptHtml:Ne}:W,Se=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(N?N==="open":!!Ne)),Re=k.has(W.id)?!Se:Se,Qe=B?mt=>{ut.current=!0,r({type:"focus",id:mt});const $e=v.get(mt);$e&&(at($e)?va($e):$e.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:$e.name,url:$e.url||"",website:$e.website||"",domain:$e.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(uc,{o:he,locked:pe,selected:B&&a.focusId===W.id,onSelect:Qe},W.id):t.jsx(sc,{o:he,locked:pe,open:Re,onToggle:()=>R(W.id),selected:B&&a.focusId===W.id,echo:C===W.id,fresh:Ae.has((W.name||"").trim().toLowerCase()),onSelect:Qe},W.id)})},Ot="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(te.length?"":" list-empty"),zt=t.jsxs(t.Fragment,{children:[be?be.map(([O,Y])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:_t(O)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:O==="ma"?n.grpMa:O==="fundraising"?n.grpLev:Ra.has(O)&&Be<=1?n.grpNews:O==="nominations"?n.grpNom:O==="media"?n.grpNewsOther:O==="recrutements"?n.grpHire:Ra.has(O)?n.grpNews+" · "+rt(O,m):rt(O,m)}),t.jsx("div",{className:"s",children:n.grpCount(Y.filter(ae=>!Ye(ae)).length,Y.length)})]})]}),yt(Y,O)]},O)):yt(te,"pt"+a.ptab),g.loading&&!u.length&&t.jsx(mc,{}),o.pipe&&a.ptab===0&&!x&&!ye&&!me&&H==="all"&&!a.filters.signalOnly&&!g.loading&&t.jsx(gp,{}),!te.length&&!(g.loading&&!u.length)&&(o.pipe&&H==="all"?t.jsx(fc,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(V.win!=="all"||!!V.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),de>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(de)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),Mt=t.jsxs(t.Fragment,{children:[!x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ma[a.ptab]+")"},children:te.length})," ",fe]}),x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ma[a.ptab]+")"},children:te.length})," ",n.newsWord]}),t.jsx("span",{className:"dot",children:"·"}),z&&!a.mapFolded&&t.jsx(vi,{variant:"compact",mapToggle:!1}),t.jsxs("span",{className:"ctx",children:[z?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),we.map(O=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:Y=>{Y.stopPropagation(),O.off()},children:[O.lib,t.jsx("i",{children:"×"})]},O.k)),b==="ops"&&te.length>0&&!z&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",te.length-se," ",n.zoomPulseEval,se>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",se," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),kt=t.jsxs("div",{className:"listhead"+(z?" mapoff":""),children:[z&&t.jsx("div",{className:"lh-tools",children:t.jsx(bi,{compact:!0})}),o.showFunnel&&ee&&oe&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(md,{}),t.jsx(ac,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:Mt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(ec,{}),t.jsx(tc,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(me?" on":""),"aria-pressed":me,title:n.morningDockTitle,onClick:()=>{if(me){xe(!1),U(!1);return}ce(!1),F(!1),M("all"),xe(!0),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}}),U(!1)},children:["📊 ",n.morningDock(ze)]}),I&&!I.firstVisit&&(I.added.length>0||I.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ye?" on":""),"aria-pressed":ye,title:n.sinceSub,onClick:()=>{const O=!ye;ce(O),F(!1),xe(!1),U(!1),M("all"),O&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(ue),I!=null&&I.lastDate?` · ${n.sinceSince(I.lastDate)}`:""]}),K>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{ce(!1),F(!1),xe(!1),U(!1),M("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(K)]}),o.pipe&&ke>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(x?" on":""),"aria-pressed":x,title:n.newsDockHint,onClick:()=>{const O=!x;F(O),ce(!1),xe(!1),U(!1),M("all"),O&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ke),ve.since?` · ${n.newsSince(ve.since)}`:""]})]}),!o.showFunnel&&Mt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([O,Y])=>t.jsxs("button",{type:"button","data-d":O,"aria-pressed":a.dens===O||O==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:O}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:Y})]},O))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":N==="open",onClick:()=>{A("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":N==="closed",onClick:()=>{A("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Ne;const O={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},Y=u.filter(he=>Pt(he,O,o.pipe)&&!We(he)),ae=Y.filter(he=>!at(he)&&!he.noCo&&(he.kind==="op"||!Ye(he))).length,D=Y.filter(at).length,ne=o.pipe?Y.filter(he=>he.kind!=="op"&&Te(he)===1).length:0,W=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ne?` ${ne}`:""}`]]:[],["eval",`${n.doEval}${ae?` ${ae}`:""}`],["explore",`${n.doExplore}${D?` ${D}`:""}`]],pe=((Ne=W.find(([he])=>he===H))==null?void 0:Ne[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":G,onClick:()=>Z(he=>!he),children:[pe,t.jsx("i",{children:"▾"})]}),G&&t.jsx("div",{className:"dolist",children:W.map(([he,Se])=>t.jsx("button",{type:"button","aria-pressed":H===he,onClick:()=>{if(Z(!1),he==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}M(he),he!=="all"&&(ce(!1),F(!1),U(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Se},he))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:O=>r({type:"sort",key:O.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([O,Y])=>t.jsx("option",{value:O,children:Y},O))})]}),o.showChain&&t.jsxs("span",{className:"chainwrap"+(le.length===0?" empty":""),children:[t.jsxs("button",{type:"button",className:"chain",disabled:le.length===0,title:n.chainHint,onClick:()=>{le.length&&r({type:"chainStart",queue:le.map(O=>O.id)})},children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(le.length):n.chainAll(le.length)]}),!o.pipe&&t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&kt,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),je("country",n.colCountry),je("name",n.colCompany),je("amount",n.colAmount,"h-amt",!0),je("stage",n.colStage,"h-stade"),je("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[je("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),je("memo",n.colMemo)]}),o.pipe&&je("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[kt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),je("country",n.colCountry),je("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[je("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),je("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Ot,children:zt})]}),t.jsxs("aside",{className:"readpane"+((Ue?We(Ue):!h&&Fe)?" is-edito":""),"aria-label":m==="fr"?"Dossier":"File",children:[Fe&&(()=>{const O=a.focusId===Fe.id&&!Ve,Y=(Fe.headline||Fe.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":O,onClick:()=>{if(O){wt(!0);return}wt(!1),r({type:"focus",id:Fe.id})},children:[t.jsx("span",{className:"eg-t",children:m==="en"?"Today’s editorial":"Édito du jour"}),Y&&t.jsx("span",{className:"eg-sub",children:Y}),t.jsx("span",{className:"eg-chev",children:O?m==="en"?"Collapse ▴":"Replier ▴":m==="en"?"Read ▾":"Lire ▾"})]})})(),!!(Fe&&(Ue?We(Ue):!h))&&Ve?null:w&&a.focusId===w.id?t.jsx("div",{className:"zoom",children:t.jsx(ed,{})}):Ue&&o.pipe?t.jsx(pc,{o:Ue}):t.jsx(Ai,{o:Ue,extra:Ue?null:h})]})]}):t.jsx("div",{className:Ot,children:zt}),(()=>{const O=be||[["pt"+a.ptab,te]];let Y=0,ae=0;for(const[ne,W]of O){ae+=W.length;let pe=a.shown[ne]||E();W.length-pe<=4&&(pe=W.length),Y+=Math.min(W.length,pe)}const D=ae-Y;return D<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>O.forEach(([ne,W])=>r({type:"more",group:ne,by:W.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(D,D)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(Y,ae)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}}),B&&b==="ops"&&a.dens!=="maxi"&&t.jsx(nc,{on:!!be,rev:(be||[]).map(([O,Y])=>O+Y.length).join("|")})]})}function Eo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function gc(e,a){const r=Ls(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function xc(e,a){const n=[a.head.split("|").map(Eo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",gc(o,a.plabels),ya(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Eo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function bc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const vc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Xe({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function oa({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function wc({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=X(),d=(e.cribleStatus||"").trim().toUpperCase()||(ya(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=Ft(e),l=(a==null?void 0:a.blocs)||{},m=[[n.qaVP,l.value_prop],[n.qaProduct,l.produit],[n.qaModel,l.modele],[n.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Xe,{k:n.cdSector,v:e.sector}),t.jsx(Xe,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Xe,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Xe,{k:n.cdStage,v:e.stage}),t.jsx(Xe,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Xe,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Xe,{k:n.cdName,v:e.contactName}),t.jsx(Xe,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Xe,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Xe,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Xe,{k:n.cdAngle,v:e.angle}),t.jsx(Xe,{k:n.cdDetected,v:vc(e.date,o)})]}),!!(e.provQuery||e.provUrl||Pa(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Xe,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Xe,{k:n.cdSrc,v:Bn(e.provUrl||""),href:ba(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Xe,{k:n.cdAngleSrc,v:Pa(e)})]})]}),m.some(([,c])=>c)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),m.filter(([,c])=>c).map(([c,g])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:c}),t.jsx("p",{children:g})]},c))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([c,g,u])=>t.jsxs("div",{className:"dssq "+c,children:[t.jsx("b",{children:g}),t.jsx("ul",{children:u.map(b=>t.jsx("li",{children:b},b))})]},c))})]}),t.jsx(oa,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(oa,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(oa,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(oa,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(oa,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function yc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:s}=X(),[l,m]=p.useState({}),[c,g]=p.useState({}),u=25,b=12,h=p.useMemo(()=>{if(s.dossierId){const f=n.find(w=>w.id===s.dossierId)||i.dossiers.find(w=>w.id===s.dossierId);return f?[f]:n.slice(0,u)}return n.slice(0,u)},[n,s.dossierId,i.dossiers]);p.useEffect(()=>{h.length&&Fo(r,h.map(f=>f.name)).then(m)},[r,h]),p.useEffect(()=>{const f=h.filter(k=>!!k.memoUrl).slice(0,b);if(!f.length){g({});return}let w=!1;const E={};return(async()=>{for(const k of f){if(w)return;try{const j=await Si(k.memoUrl||"");if(w)return;j&&_p(j.comite)&&(E[k.id]=j.comite,g({...E}))}catch{}}})(),()=>{w=!0}},[h]);const v=i.stats,y=f=>f.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(h.length)}),!s.dossierId&&n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),v&&typeof v.screened=="number"&&t.jsxs("p",{children:[y(v.screened)," ",e.funScreened(""),typeof v.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",y(v.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(y(i.marketEstimate)),", ",Math.round(v.screened/i.marketEstimate*100)," %"]})]})]}),h.map(f=>t.jsx(wc,{o:f,qa:l[f.name],comite:c[f.id]},f.id)),!h.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const kc=50;function ar({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=X(),[i,d]=p.useState(null),[s,l]=p.useState(!1),[m,c]=p.useState(""),[g,u]=p.useState(0),[b,h]=p.useState(""),[v,y]=p.useState(!1),[f,w]=p.useState(0),E=p.useRef(null),k=p.useRef(null),j=()=>{w(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>w(T=>T+1),1e3)},N=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),k.current&&window.clearInterval(k.current)},[]);const A=async T=>{l(!0),c(""),j();const z=await a();if(l(!1),N(),z.ok){d(z);return}if(z.busy){c(o.alertPreviewBusy);return}if(!T){c(o.alertPreviewFail);return}u(kc),N(),E.current=window.setInterval(()=>{u(R=>R>1?R-1:(E.current&&window.clearInterval(E.current),A(!1),0))},1e3)},L=async()=>{if(n||v||s)return;y(!0),h(""),j();const T=await r();y(!1),N(),h(T.ok?o.alertTestOk(T.sentTo||""):T.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||v||g>0,onClick:()=>{A(!0)},children:s?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||s,onClick:()=>{L()},children:v?o.alertBtnTestBusy:o.alertTest})]}),s&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),g>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(g)}),m&&t.jsx("p",{className:"mnote warn",children:m}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const St="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ze({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=X(),s=o==="plug"?"min(720px,100%)":"min(760px,100%)";return Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:l=>{l.target===l.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:s}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Ec(){const{st:e}=X();switch(e.modal){case"chain":return t.jsx(Nc,{});case"space":return t.jsx(Sc,{});case"alert":return t.jsx(zc,{});case"queue":return t.jsx(Lc,{});case"export":return t.jsx(Fc,{});case"plug":return t.jsx(Mc,{});case"approach":return t.jsx(Dc,{});case"recharge":return t.jsx(_c,{});case"cover":return t.jsx($c,{});case"dossier":return t.jsx(Bc,{});case"crit":return t.jsx(Wc,{});case"tuto":return t.jsx(Gc,{});case"rdv":return t.jsx(jc,{});case"memoalert":return t.jsx(Rc,{});default:return null}}function jc(){const{dispatch:e,fund:a,t:r}=X(),n=a||r.rdvCoFallback;return Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Do,children:Mo}),r.rdvSubMid,t.jsx("a",{href:`mailto:${_a}`,children:_a})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(sl,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Nc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:s,caps:l,memoQueued:m,doAnalyse:c}=X(),g=i==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,h=u[b],v=b>=u.length;return Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!h?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:h.name}),t.jsx("div",{className:"sub",children:[ea(h.cc,o)||h.countryLabel,h.sector,h.stage,n.daysAgo(gt(h.date))].filter(Boolean).map(y=>String(y)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:rt(h.engine,o)}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{children:Ht(h.amountEur,o)})]}),He(h)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Lt,{o:h,lg:!0})," ",t.jsx(en,{o:h,src:!0})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),h.reasoning&&!(g&&Ye(h))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),g&&Ye(h)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":It(h)==="retenu"?"var(--brand)":It(h)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:It(h)==="retenu"?"✓ "+n.kept:It(h)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:h.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&h&&l.pipe&&Te(h)===1&&!m.has(h.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(h),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&h&&!(g&&Ye(h))&&(h.noCo&&h.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{d(h)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function Sc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=X(),i=o==="client",d=p.useMemo(()=>i?r.filter(g=>Ye(g)):[],[r,i]),s=p.useMemo(()=>Gn(d.filter(g=>It(g)==="retenu"),{key:"signal",dir:-1}),[d]),l=p.useMemo(()=>d.filter(g=>It(g)==="ecarte"),[d]),m=e.spaceTab==="retenu"?s:l,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ze,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:l.length})]})]}),m.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),m.slice(0,40).map(g=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof g.score=="number"&&g.score>0?g.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:g.name}),t.jsx("div",{className:"rr",children:g.reasoning||g.tagline||""})]})]},g.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function zc(){const{mode:e}=X();return e==="client"||e==="apercu"?t.jsx(Cc,{}):t.jsx(Tc,{})}function Cc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=X(),[i,d]=p.useState("d"),s=o!=="client";return t.jsxs(Ze,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Ac,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(qc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(qi,{})]})}function Ac({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[s,l]=p.useState(!1),[m,c]=p.useState(0);p.useEffect(()=>{let L=!0;return l(!1),yr(a).then(T=>{L&&(T?d(T):l(!0))}),()=>{L=!1}},[a,m]);const g=p.useRef({}),[u,b]=p.useState({}),[h,v]=p.useState(!1),[y,f]=p.useState(!1),w=p.useRef(null);p.useEffect(()=>()=>{w.current&&window.clearTimeout(w.current)},[]);const E=L=>{const T=g.current;Object.keys(T).length&&(v(!0),yr(a,T).then(z=>{if(!z){v(!1),o(e.actErr);return}if(z.throttled&&L<3){w.current=window.setTimeout(()=>E(L+1),5400);return}if(g.current={},b({}),d(z),v(!1),z.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=L=>{r||(g.current={...g.current,...L},b(T=>({...T,...L})),w.current&&window.clearTimeout(w.current),w.current=window.setTimeout(()=>E(1),700))};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...u},N=L=>!j.sections||j.sections.includes(L),A=L=>{const T=j.sections||e.alertSec.map(([z])=>z);k({sections:N(L)?T.filter(z=>z!==L):[...T,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,h&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!h&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,T])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:N(L),disabled:r,onChange:()=>A(L)}),t.jsxs("span",{children:[T,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(ar,{label:e.alertPreview,readOnly:r,onPreview:()=>Vs(a),onTest:()=>Hs(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function qc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[s,l]=p.useState(!1),[m,c]=p.useState(0);p.useEffect(()=>{let h=!0;return l(!1),kr(a).then(v=>{h&&(v?d(v):l(!0))}),()=>{h=!1}},[a,m]);const g=h=>{r||kr(a,h).then(v=>{if(!v){o(e.actErr);return}d(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(h=>h+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:h=>g({dow:Number(h.target.value)}),children:e.alertDow.map((h,v)=>t.jsx("option",{value:v,children:h},h))}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(ar,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Gs(a),onTest:()=>Ws(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function qi(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=X(),[d,s]=p.useState(i||""),[l,m]=p.useState(!1),[c,g]=p.useState(!1);p.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(f=>He(f)).length,[n]),h=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(d)||c)){g(!0);try{await fetch(`${wa}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),m(!0)}finally{g(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[h]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>rt(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>ea(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,w])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:w}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Tc(){const{t:e}=X();return t.jsx(Ze,{title:e.alertTitle,icon:"🔔",children:t.jsx(qi,{})})}function Lc(){var x,F;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:s,dispatch:l,liveMemos:m,data:c,flash:g}=X(),[u,b]=p.useState(()=>nn(r)),[h,v]=p.useState(()=>!nn(r)),[y,f]=p.useState([]),[w,E]=p.useState(0),[k,j]=p.useState(!1),N=n==="client",A=p.useMemo(()=>{const C=new Map;return o.forEach(_=>{const G=(_.name||"").trim().toLowerCase();G&&!C.has(G)&&C.set(G,_)}),C},[o]);p.useEffect(()=>{let C=!0;return(!nn(r)||w>0)&&v(!0),(async()=>{const[_,G]=await Promise.all([Vn(r,w>0),Io(a)]);C&&(_&&b(_),v(!1),f(G))})(),()=>{C=!1}},[a,r,w]);const L=h&&!u,T=(u==null?void 0:u.per_day)??0,z=((x=u==null?void 0:u.analyzed_today)==null?void 0:x.length)??0,R=u==null?void 0:u.offre,B=(u==null?void 0:u.pool_meta)||[],H=p.useMemo(()=>{const C=new Map;for(const _ of(u==null?void 0:u.scheduled)||[])for(const G of _.names||[])C.has(G)||C.set(G,{label:_.day_label,date:_.date});return C},[u==null?void 0:u.scheduled]),M=(u==null?void 0:u.in_progress)||[];return t.jsxs(Ze,{title:e.queueTitle,wide:!0,children:[R&&t.jsxs("div",{className:"qoffre"+(R.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:R.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:R.delai})]}),t.jsx("span",{className:"osp"}),R.rythme>0?t.jsx("span",{className:"or",children:e.qRate(R.rythme)}):R.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(R.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:L?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(z,z+(((F=u==null?void 0:u.pool_order)==null?void 0:F.length)??0))}})}),R&&t.jsxs("div",{className:"qeta",children:[R.file===0?e.qEtaDone:R.rythme<=0?e.qEtaPaused:e.qEta(R.file,R.rythme,R.jours_restants),R.en_retard&&t.jsxs("em",{children:[" ",e.qLate(R.delai,R.plafond)]})]}),!L&&t.jsxs("div",{className:"qrate",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate})," — ",t.jsx("b",{children:e.covRateNow(T)}),(R==null?void 0:R.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]}),N&&t.jsx("div",{className:"covrb",role:"group","aria-label":e.covRate,children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:T===C?"on":"",disabled:k,title:C===0?e.identPauseTitle:e.covRateNow(C),onClick:()=>{k||!a||(j(!0),Po(a,C).then(_=>{j(!1),_!==null&&(b(G=>G&&{...G,per_day:_}),g(e.alertSaved))}))},children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint}),!!c.credits&&!c.credits.unlimited&&!!(c.credits.packs||[]).length&&t.jsxs("div",{className:"qpacks-mini",children:[t.jsxs("span",{children:[e.creditsCap," ",c.credits.total_available,"/",c.credits.daily_grant+c.credits.purchased," · ",e.creditsPacksLbl]}),t.jsx("div",{children:c.credits.packs.map(C=>t.jsxs("button",{type:"button",className:"qpack-mini",onClick:()=>{const _=c.email;if(!_)return;const G=window.location.href.split("?")[0];fetch(`${wa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:_,lookup_key:C.lookup_key,success_url:G+"?credits=ok",cancel_url:G+"?credits=cancel"})}).then(Z=>Z.json()).then(Z=>{Z.url&&(window.location.href=Z.url)}).catch(()=>{})},children:[C.credits," · ",C.price_eur," €"]},C.lookup_key))})]})]})]}),(M.length>0||m.items.some(C=>C.status==="boot"||C.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[m.items.filter(C=>C.status==="boot"||C.status==="running"||C.status==="error").map(C=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:C.name}),t.jsx("span",{className:"qd",children:C.memoType||""}),t.jsx(Ba,{item:C,serverOff:m.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+C.name)),M.filter(C=>!m.liveOf(C.name)).map(C=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:C.name}),t.jsxs("span",{className:"qd",children:[C.memo_type||"",C.age_min?` · ${Math.round(C.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:C.state||""})]},"ip-"+C.name))]})]}),y.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:y.map(C=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:C.company}),t.jsxs("span",{className:"qd",children:[C.memo_type,typeof C.est_min=="number"?` · ~${C.est_min} min`:""]}),t.jsx("span",{className:"qt",children:C.status}),C.url&&t.jsx("a",{className:"qgo",href:C.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(C.memo_type)}),N&&C.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{vr(a,C.company,"retry").then(()=>E(_=>_+1))},children:e.queueRetry}),N&&C.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{vr(a,C.company,"delete").then(()=>E(_=>_+1))},children:e.queueDelete})]},C.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",L?e.qUpNextWait:e.qUpNext(B.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[L&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!L&&B.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),B.map((C,_)=>{const G=H.get(C.name),Z=A.get((C.name||"").trim().toLowerCase()),re=m.liveOf(C.name),S=!!(Z&&d.has(Z.id))||!!(re&&(re.status==="boot"||re.status==="running")),$=!!(Z&&Te(Z)===1&&!Z.memoUrl)&&!re;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",_+1]}),G?t.jsx("span",{className:"qwhen"+(G.label==="demain"?" soon":""),children:G.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:C.name}),C.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof C.score=="number"&&t.jsx("span",{className:"qs2",children:C.score}),re&&(re.status==="boot"||re.status==="running")&&t.jsx(Ba,{item:re,serverOff:m.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),$&&(s.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>l({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:S,onClick:()=>{i(Z),E(I=>I+1)},children:S?e.actAnalyseQueued:e.actAnalyse})),C.excerpt&&t.jsx("span",{className:"qex",children:C.excerpt})]},C.name+":"+_)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([C,_])=>t.jsxs("li",{children:[t.jsx("b",{children:C})," — ",_]},C))})]})}function Fc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=X(),s=`${St}/cibles/list.csv?token=${a}`,l=`${St}/cibles/list.json?token=${a}`,m=`${St}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,g=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:l,href:l},{def:e.exportXlsx,value:m,href:m}],b=!o.lockActions&&n.length>0,h=()=>{bc(xc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ze,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:h,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:f,href:w})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>g(f),children:e.exportCopy}),w&&t.jsx("a",{className:"exb",href:w,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Rc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=X(),i=o!=="client",[d,s]=p.useState(null),[l,m]=p.useState(!1),[c,g]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return m(!1),xr(a).then(w=>{f&&(w?s(w):m(!0))}),()=>{f=!1}},[a,c]);const h=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(i||!d)return;const w={enabled:f.enabled??!!d.enabled,email:f.email??(d.email||""),sections:f.sections??h()};b(!0),xr(a,w).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}s(E),r(e.memoAlertSaved)})};if(l)return t.jsx(Ze,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>g(f=>f+1),children:e.retry})]})});if(!d)return t.jsx(Ze,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=h();return t.jsxs(Ze,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Oc,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,w])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||u,onChange:()=>v({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:w})]},f))}),t.jsx(ar,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Rs(a,y),onTest:()=>Fs(a,y)})]})}function Oc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=p.useState(e);p.useEffect(()=>{d(e)},[e]);const s=i.trim()!==e.trim(),l=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:m=>d(m.target.value),onKeyDown:m=>{m.key==="Enter"&&s&&l&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!l,onClick:()=>o(i.trim()),children:n})]})]})}function Mc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=X(),[i,d]=p.useState(null),[s,l]=p.useState(!1),[m,c]=p.useState(null),[g,u]=p.useState(!1),[b,h]=p.useState(""),[v,y]=p.useState(0),[f,w]=p.useState("webhook"),[E,k]=p.useState("webhook"),[j,N]=p.useState(""),A=p.useRef(!1);p.useEffect(()=>{let C=!0;return l(!1),br(a).then(_=>{C&&(_?d({configured:_.configured,url_hint:_.url_hint}):l(!0))}),Is(a).then(_=>{if(C){if(!_){u(!0);return}u(!1),c(_),A.current||(A.current=!0,_.destination==="instantly"&&(w(G=>G==="webhook"?"instantly":G),k(G=>G==="webhook"?"instantly":G)),_.campaign_id&&N(G=>G||_.campaign_id||""))}}),()=>{C=!1}},[a,v]);const L=(C,_)=>{o&&br(a,C).then(G=>{if(!G||G.ok===!1){n(e.actErr);return}C.test&&G.sent===!1?n(e.plugTestThrottled):r(_),y(Z=>Z+1)})},T='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',z=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),R=`curl -X POST ${St}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,B=`curl -X POST ${St}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,H=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugAideInst},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],M=E==="instantly"?e.plugStep2Inst:E==="script"?e.plugStep2Script:e.plugStep2Wh,x=E==="instantly"?e.plugAideInst:E==="script"?e.plugAideScript:e.plugAideWh,F=C=>{k(C),C!=="script"&&w(C)};return t.jsxs(Ze,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[m&&t.jsxs("div",{className:"plugetat"+(m.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:m.enabled?e.plugEtatOn:e.plugEtatOff})]}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>y(C=>C+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:H.map(C=>{const _=E===C.k;return t.jsxs("button",{type:"button",className:"plugdest"+(_?" on":""),onClick:()=>F(C.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:C.t}),t.jsx("em",{children:C.s})]},C.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:M})]}),E==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:R}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(R).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):E==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:j,disabled:!o,onChange:C=>N(C.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:C=>h(C.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>L({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>L({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>L({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:x}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(Ic,{auto:m,autoKo:g,destKind:f,camp:j,onRetry:()=>y(C=>C+1),onDone:C=>{c(C),u(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:z}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(z).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(Pc,{destKind:f,setDestKind:C=>{w(C),k(C)},camp:j,setCamp:N,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),E!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:R}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(R).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:T}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(T).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:B}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(B).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Dc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:s}=X(),l=p.useMemo(()=>r.find(x=>x.id===n.approachId)||null,[r,n.approachId]),[m,c]=p.useState("email"),[g,u]=p.useState(0),[b,h]=p.useState({}),[v,y]=p.useState(!1),[f,w]=p.useState(""),[E,k]=p.useState({});if(p.useEffect(()=>{!l||b[m]||v||(y(!0),w(""),Ds(a,l.name,m).then(x=>{if(y(!1),!x||x.ok===!1){w((x==null?void 0:x.error)||e.apprFail);return}h(F=>({...F,[m]:x}))}))},[l,m,a]),!l)return null;const j=b[m],N=(j==null?void 0:j.sequence)||[],A=N[g],L=x=>`${m}|${g}|${x}`,T=x=>{const F=L(x);return F in E?E[F]:String(((A==null?void 0:A[x])??"")||"")},z=(x,F)=>k(C=>({...C,[L(x)]:F})),R=L("subject")in E||L("body")in E||L("message")in E,B=T(m==="email"?"body":"message"),H=T("subject"),M=m==="email"&&H?`${H}

${B}`:B;return t.jsxs(Ze,{title:e.apprT(l.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(x=>t.jsx("button",{type:"button",className:"apch"+(m===x?" on":""),"aria-pressed":m===x,onClick:()=>{c(x),u(0)},children:x==="email"?e.apprChEmail:e.apprChLi},x)),t.jsx("span",{className:"sp"}),N.map((x,F)=>t.jsxs("button",{type:"button",className:"apday"+(g===F?" on":""),"aria-pressed":g===F,onClick:()=>u(F),children:[x.day||`J${F}`,[`${m}|${F}|subject`,`${m}|${F}|body`,`${m}|${F}|message`].some(C=>C in E)&&t.jsx("i",{children:"✎"})]},x.day||F))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,j!=null&&j.sender?" · "+e.apprSender(j.sender):""]}),v&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!v&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{h(x=>{const F={...x};return delete F[m],F}),w("")},children:e.retry})]}),!v&&!f&&!A&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),A&&t.jsxs(t.Fragment,{children:[m==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:H,onChange:x=>z("subject",x.target.value)})]}),m==="linkedin"&&g===0&&(j==null?void 0:j.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:B,onChange:x=>z(m==="email"?"body":"message",x.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(M).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),m==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(l.contactEmail||"")}?subject=${encodeURIComponent(H)}&body=${encodeURIComponent(B)}`,children:e.apprMailto}),R&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Ic({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:s,flash:l,flashErr:m,canWrite:c}=X(),[g,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,h=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),v=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,y=()=>{if(g||!c||h)return;u(!0),(b?wr(s,!1):wr(s,!0,r,n.trim()||void 0)).then(w=>{if(u(!1),!w){m(d.actErr);return}o(w),l(w.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:g||!c||!!h,title:h||void 0,onClick:y,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),h===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:h}),v&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Pc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:s,canWrite:l}=X(),[m,c]=p.useState("valides"),[g,u]=p.useState(!1),[b,h]=p.useState(null),[v,y]=p.useState(null),[f,w]=p.useState(!1),[E,k]=p.useState(!1),[j,N]=p.useState(null),[A,L]=p.useState(null),T=`atl2:bulk:${d}:${m}:${e}`;p.useEffect(()=>{h(null),y(null),w(!1),N(null);try{const Z=localStorage.getItem(T)||localStorage.getItem(`atl2:bulk:${d}:${m}`),re=JSON.parse(Z||"null");L(re&&Date.now()-Date.parse(re.t)<24*3600*1e3?re:null)}catch{L(null)}},[T,m,d]);const z=e==="instantly"&&!r.trim(),R=`${m}|${e}|${r.trim()}`,B=async()=>{if(z||!l)return;u(!0),w(!1),N(null);const Z=await $s(d,m,e,r.trim()||void 0);h(Z),y(Z.ok?R:null),u(!1)},H=p.useRef(!1);if(!l)return null;const M=async()=>{if(H.current||!l)return;H.current=!0,k(!0);const Z=`${d}:${m}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let re;try{re=await Us(d,m,e,r.trim()||void 0,Z)}finally{H.current=!1}if(k(!1),w(!1),N(re),re.ok&&(re.pushed||0)>0){const S={t:new Date().toISOString(),n:re.pushed||0};L(S);try{localStorage.setItem(T,JSON.stringify(S))}catch{}}};f&&v!==null&&v!==R&&w(!1);const x=o,F=b!=null&&b.ok&&b.ready||0,C=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":x||"",_=!!(b!=null&&b.ok)&&v===R&&F>0&&!!C&&!A,G=A?new Date(A.t).toLocaleString(s==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:m,onChange:Z=>c(Z.target.value),children:i.plugBulkTabs.map(([Z,re])=>t.jsx("option",{value:Z,children:re},Z))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:Z=>a(Z.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:Z=>n(Z.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:g||z,onClick:()=>{B()},children:g?"…":i.plugBulkPreview})]}),z&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),A&&t.jsx("p",{className:"mnote",children:i.bulkLocked(G,A.n)}),!A&&!!(b!=null&&b.ok)&&!C&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!A&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),_&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>w(!0),children:i.bulkArm}),_&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(F,C)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{M()},children:E?i.bulkSending:i.bulkConfirm(C)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>w(!1),children:i.bulkCancel})]}),j&&(j.ok?j.replayed?t.jsx("p",{className:"mnote",children:j.pending?i.bulkPending:i.bulkReplayed}):(j.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(j.pushed||0,j.linkedinReady||0,j.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:j.error||i.actErr}))]})}function _c(){const{t:e,data:a,lang:r}=X(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const s=window.location.href.split("?")[0];try{const m=await(await fetch(`${wa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();m.url&&(window.location.href=m.url)}catch{}};return t.jsxs(Ze,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("b",{className:"pk-n",children:d.credits}),t.jsx("span",{className:"pk-u",children:e.creditsUnit}),t.jsxs("span",{className:"pk-p",children:[d.price_eur," €"]}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Bc(){const{t:e}=X();return t.jsx(Ze,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(yc,{})})}function $c(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:s}=X(),[l,m]=p.useState(null),[c,g]=p.useState(!1);p.useEffect(()=>{let T=!0;if(i)return Vn(i).then(z=>{T&&z&&typeof z.per_day=="number"&&m(z.per_day)}),()=>{T=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let T=!0;return Ms(o).then(z=>{T&&b(z)}),()=>{T=!1}},[o]);const h=r.stats,v=typeof(h==null?void 0:h.screened)=="number"?h.screened:n.filter(T=>T.kind==="target"&&Ye(T)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(v/y*100)):null,w=(h==null?void 0:h.window_days)||30,E=v>0?v/w:0,k=y>0?Math.max(0,y-v):0,N=y>0&&E>0&&v>=100?Math.round(k/E):null,A=T=>Math.round(T).toLocaleString(a==="en"?"en-US":"fr-FR"),L=T=>{c||!d||(g(!0),Po(o,T).then(z=>{if(g(!1),z===null){s(e.actErr);return}m(z),s(e.alertSaved)}))};return t.jsxs(Ze,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(A(v))}),y>0&&t.jsx("span",{children:e.covOf(A(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(A(E))}),h&&t.jsxs("div",{className:"covf",children:[typeof h.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(h.kept)})," ",e.covKept]}),typeof h.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(h.analyzed)})," ",e.covAna]}),typeof h.shown=="number"&&h.shown!==h.kept&&t.jsxs("span",{children:[t.jsx("b",{children:A(h.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((T,z)=>t.jsxs("tr",{className:T.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[T.code,T.geo?` · ${T.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof T.n=="number"?A(T.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:T.source}),T.elargi&&t.jsx("em",{children:e.covWide(String(T.demande||""))}),T.erreur&&t.jsx("em",{children:e.covMissing})]})]},z)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:A(u.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&l!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(l)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(T=>t.jsx("button",{type:"button",className:l===T?"on":"",disabled:c,onClick:()=>L(T),children:T===0?"⏸":T},T))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function Ti(e,a,r){const n=await fetch(`${St}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${St}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Uc(){const{t:e,token:a,canWrite:r}=X(),[n,o]=p.useState(null),[i,d]=p.useState(""),[s,l]=p.useState(""),[m,c]=p.useState(!1),g=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=p.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const h=JSON.parse(localStorage.getItem(g)||"null");return!!h&&Date.now()-(h.t||0)<14*24*3600*1e3}catch{return!1}},[g,n==null?void 0:n.pattern]);if(p.useEffect(()=>{if(!r)return;let h=!0;return _s(a).then(v=>{h&&o(v)}),()=>{h=!1}},[a,r]),!r||m||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),Ti(a,n.instruction||"","atelier2-avis").then(h=>{if(d(h.applied?"ok":"ko"),h.applied||l(h.encours?e.propSlow:h.reply),h.applied)try{localStorage.setItem(g,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:s||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{c(!0);try{localStorage.setItem(g,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Hc(){var j;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=X(),[i,d]=p.useState(!1),[s,l]=p.useState(null),[m,c]=p.useState(!1),[g,u]=p.useState([]),[b,h]=p.useState(null),[v,y]=p.useState([]);if(!r)return null;const f=()=>{d(!0),c(!1),u([]),y([]),Bs(a).then(N=>{if(d(!1),!N){c(!0),l(null);return}l(N)})},w=N=>{b||(h(N.title),Ti(a,N.instruction,"atelier2-prop").then(A=>{h(null),A.applied?(y(L=>[...L,N.title]),n(e.propApplied)):A.encours?n(e.propSlow):o(A.reply||e.propApplyFail)}))},E=((s==null?void 0:s.proposals)||[]).filter(N=>!g.includes(N.title)&&!v.includes(N.title)),k=((j=s==null?void 0:s.counts)==null?void 0:j.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&m&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!m&&s&&!(s.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:s.reason==="not_enough_signals"?e.propFew(k):e.propNone}),E.map(N=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[N.section]||N.section}),t.jsx("p",{className:"propt",children:N.title}),N.why&&t.jsx("p",{className:"mnote dim",children:N.why}),N.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",N.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>w(N),children:b===N.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(A=>[...A,N.title]),children:e.propSkip})]})]},N.title))]})}function Vc(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=X(),[s,l]=p.useState(null),[m,c]=p.useState(!1),[g,u]=p.useState(!1),[b,h]=p.useState(""),[v,y]=p.useState(""),[f,w]=p.useState(!1),E=p.useRef(!1);if(p.useEffect(()=>{if(!a||!r)return;let N=!0;return Ps(a).then(A=>{N&&(c(!0),!(!A||E.current)&&(l(A),h(A.fit),y(A.note)))}),()=>{N=!1}},[a,r]),!r)return null;const k=()=>{if(!(!b||f)){if(s&&s.fit===b&&s.note===v.trim()){u(!1);return}w(!0),jt(a,"thesis_fit",b,v.trim(),"",d.email||"").then(N=>{if(w(!1),!N.ok){o(e.fitKo);return}l({fit:b,note:v.trim(),ts:new Date().toISOString()}),u(!1),n(e.fitSaved)})}},j=N=>N==="yes"?e.fitYes:N==="partial"?e.fitPartial:e.fitNo;if(s&&!g){const N=new Date(String(s.ts||"")),A=Number.isNaN(N.getTime())?"":N.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:j(s.fit)}),s.note?` — ${s.note}`:""]}),!!A&&t.jsx("p",{className:"mnote dim",children:A}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(N=>t.jsx("button",{type:"button","aria-pressed":b===N,className:"fitopt"+(b===N?" on":""),onClick:()=>{E.current=!0,h(N)},children:j(N)},N))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:v,onChange:N=>{E.current=!0,y(N.target.value)},onKeyDown:N=>{N.key==="Enter"&&k()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||f,onClick:k,children:f?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!m&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function Wc(){var f,w,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:s}=X(),l=n==="client",m=p.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[c,g]=p.useState(""),[u,b]=p.useState(""),[h,v]=p.useState(!1),y=async()=>{const k=c.trim();if(!(!k||h||!l)){v(!0),b("");try{const N=await(await fetch(`${St}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(N.reply&&b(String(N.reply)),N.job_id){b(e.critChatRunning);const A=async()=>{const L=await fetch(`${St}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:N.job_id})}).then(T=>T.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),v(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{A()},8e3)};setTimeout(()=>{A()},8e3),g("");return}g("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs(Ze,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((w=i==null?void 0:i.angles)!=null&&w.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,N;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(A=>t.jsx("li",{children:A},A))})]}),!!((N=k.out)!=null&&N.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(A=>t.jsx("li",{children:A},A))})]})]})]},k.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:m.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(Vc,{}),t.jsx(Uc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!l||h,onChange:k=>g(k.target.value),onKeyDown:k=>{k.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(h?" loading":""),style:{padding:"12px 18px"},disabled:!l||h||!c.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Hc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Os,{fund:d,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(zi[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Gc(){const{t:e,dispatch:a,startTour:r}=X(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ze,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const Li="atl2:mapfold",Yc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Li);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Qc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Fi=p.createContext(null),X=()=>{const e=p.useContext(Fi);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Lt({o:e,lg:a}){const{lang:r}=X(),n=He(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Er(n,r),children:[n.emoji," ",Er(n,r)]}):null}function en({o:e,src:a}){const{lang:r,t:n}=X(),o=He(e);if(!o)return null;const i=el(o),d=tl(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Ro(o,r))+" · "+n.win7(Oo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,l)=>t.jsx("i",{className:l<i?"on":""},l))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Kc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ge(a);if(o)return e.find(i=>Ge(i.name)===o)||e.find(i=>{const d=Ge(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function Jc(){const{scoped:e,t:a,st:r,dispatch:n}=X(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(g=>!We(g)),s=d.length,l=d.filter(g=>!g.noCo).length,m=d.filter(g=>!!g.noCo).length,c=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:c?"7":"all"}});else{const g=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:g,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:s}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",l," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",m," ",a.zoomPulseExplore]})]})]})}function Xc(){var v;const{t:e,lang:a,data:r,dispatch:n,dossiers:o,st:i,caps:d}=X(),s=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),l={...i,filters:{...i.filters,win:"all",day:""}},m=o.filter(y=>!We(y)&&Pt(y,l,d.pipe)),c=m.length,g=m.filter(y=>Te(y)===1).length,u=m.filter(y=>Te(y)===2).length,b=typeof((v=r.stats)==null?void 0:v.screened)=="number"?r.stats.screened:0;if(c<=0&&b<=0)return null;const h=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:s(c)}),t.jsx("span",{children:h>0?e.covOf(s(h)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",s(g)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",s(u)," ",e.covAna]})]})]})}function Zc(){var y;const{t:e,token:a,fund:r,dispatch:n,data:o}=X(),[i,d]=p.useState(null),[s,l]=p.useState(!0),[m,c]=p.useState([]),g=o.credits,u=!!g&&!g.unlimited;p.useEffect(()=>{if(!a||!r)return;let f=!0;return l(!0),(async()=>{const[w,E]=await Promise.all([Vn(r),Io(a)]);f&&(w&&d(w),l(!1),c(E))})(),()=>{f=!1}},[a,r]);const b=(i==null?void 0:i.per_day)??null,h=((y=i==null?void 0:i.pool_order)==null?void 0:y.length)??0,v=m.filter(f=>f.status==="running").length;return t.jsxs("div",{className:"map-pulse map-engine",children:[t.jsxs("button",{type:"button",className:"map-engine-hit",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("em",{children:e.identEngine}),t.jsx("b",{children:b===null?"—":b}),t.jsx("span",{children:e.identPerDay}),t.jsxs("ul",{children:[b===0&&t.jsx("li",{children:t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause})}),v>0&&t.jsxs("li",{children:["⏳ ",v]}),t.jsx("li",{children:s?e.identPendingWait:e.identPending(h)})]})]}),t.jsxs("button",{type:"button",className:"map-engine-alert",title:e.memoAlertSub,onClick:()=>n({type:"modal",modal:"memoalert"}),children:["🔔 ",e.memoAlertBtn]}),u&&g&&t.jsxs("div",{className:"map-engine-credits",children:[t.jsx("em",{children:e.creditsCap}),t.jsxs("b",{children:[g.total_available,t.jsxs("span",{children:[" / ",g.daily_grant+g.purchased]})]}),t.jsx("span",{children:e.creditsToday})]})]})}function Ri({o:e}){const{lang:a}=X(),r=Zs(e.cc),n=e.cc?ea(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:16,height:16,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const eu=!1;function tu(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Oi=e=>`atl2:tour:${e||"anon"}`;function au(e){try{return localStorage.getItem(Oi(e))==="1"}catch{return!0}}function jo(e){try{localStorage.setItem(Oi(e),"1")}catch{}}function nu(e,a,r,n,o,i,d,s){const l=e.tourT,m=e.howto;return[{sel:".atl2 .ident",title:l.ident,body:e.fhintIdent},o?{sel:".atl2 .map-pulse",title:l.cover,body:e.fhintCover,need:".atl2 .map-hud"}:null,{sel:".atl2 .map-engine",title:l.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:l.live,body:e.fhintLive},{sel:".atl2 .goal",title:l.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:l.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:l.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:l.tuto,body:m[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:l.demand,body:m[1][0]},{sel:".atl2 .dmulti.ddeals",title:l.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:l.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:l.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:l.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:l.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:l.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:l.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:l.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:l.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:l.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:l.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:l.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(c=>(s[c]||0)>0).map(c=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:c===2?l.tabAna:c===4?l.tabValid:l.tabRej,body:c===2?e.fhintTabAna:c===4?e.fhintTabValid:e.fhintTabRej,ptab:c})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:l.rank,body:e.fhintRank},{sel:".atl2 .learn",title:l.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:l.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:l.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:l.tools,body:m[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:l.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:l.crit,body:m[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:l.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:l.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:l.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function lu({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var nr;const{lang:d}=Ys(),s=Hl(e,d,a),l=p.useMemo(()=>({...Tl[d],...ql(d,s.thesisMode)}),[d,s.thesisMode]),[m,c]=p.useReducer(Gl,void 0,()=>Vl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Qc():Yc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),g=p.useRef(!0);p.useEffect(()=>{if(g.current){g.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Li,m.mapFolded?"on":"off")}catch{}},[m.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const q=()=>{window.innerWidth<=760&&c({type:"mapFold",folded:!0})};return q(),window.addEventListener("resize",q),()=>window.removeEventListener("resize",q)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var q;(q=u.current)==null||q.call(u,m.filters)},[m.filters]);const[b,h]=p.useState(()=>{if(typeof window>"u")return"both";try{const q=localStorage.getItem("atl2:chrome-mode");if(q==="eval"||q==="filt"||q==="both")return q;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=p.useState(null),[f,w]=p.useState(null),[E,k]=p.useState(null),[j,N]=p.useState({kept:0,dropped:0}),[A,L]=p.useState(!1),[T,z]=p.useState(""),[R,B]=p.useState(!1),[H,M]=p.useState(null),[x,F]=p.useState(null),[C,_]=p.useState(!1),[G,Z]=p.useState(!1),[,re]=p.useState(0),S=()=>re(q=>q+1),$=p.useRef([]),I=p.useRef(new Set),ee=p.useRef(new Set),[U,oe]=p.useState([]),[me,xe]=p.useState([]),[ye,ce]=p.useState(0),ze=p.useRef(new Map),Ae=p.useRef(null),{mode:ue}=s,ve=p.useMemo(()=>({...s.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[s.caps,o,a]),ke=ve.pipe,te=s.session.token||"",P=ue==="client"&&!e;p.useEffect(()=>{if(!te||!ke)return;let q=!0;const J=async()=>{const ge=await al(te);!q||!ge||(xe(ge.runs),ce(Date.now()/1e3-ge.now),oe(Me=>Me.filter(qe=>!ge.runs.some(Ke=>Ge(Ke.company)===Ge(qe.name)))))};J();const Q=U.length>0||me.some(ge=>ge.status==="running"),ie=window.setInterval(()=>{J()},Q?8e3:25e3);return()=>{q=!1,window.clearInterval(ie)}},[te,ke,U.length,me.some(q=>q.status==="running")]),p.useEffect(()=>{if(!te||!ke||!P)return;let q=!0;const J=async()=>{const ie=await nl(te);if(!q||!ie.length)return;const ge=new Map;ie.forEach(Me=>{const qe=String(Me.ceo_status||"").trim();qe&&Me.check_id&&ge.set(String(Me.check_id),qe)}),s.patchStatuses(ge,Me=>Date.now()-(W.current.get(Me)||0)>9e4)};J();const Q=window.setInterval(()=>{J()},6e4);return()=>{q=!1,window.clearInterval(Q)}},[te,ke,P]);const K=p.useMemo(()=>{const q=[],J=new Set;for(const Q of U){const ie=Ge(Q.name);!ie||J.has(ie)||(J.add(ie),q.push({name:Q.name,id:Q.id,status:"boot",started:Q.started,estMin:Q.estMin,memoType:"instant"}))}for(const Q of me){const ie=Ge(Q.company);if(!ie||J.has(ie))continue;J.add(ie);const ge=Q.status==="error"?"error":Q.status==="done"?"done":"running";q.push({name:Q.company,status:ge,started:Q.started||0,estMin:Q.est_min||(Q.memo_type==="detailed"?40:15),url:Q.url,error:Q.error,memoType:Q.memo_type,note:Q.note})}return q},[U,me]),le=q=>K.find(J=>Ge(J.name)===Ge(q))||null,se=(q,J)=>{oe(Q=>Q.some(ie=>Ge(ie.name)===Ge(q.name))?Q:[...Q,{name:q.name,id:q.id,started:Date.now()/1e3,estMin:J==="detailed"?40:15}]),I.current.add(q.id),S()},fe=(q,J=!1)=>{z(q),B(J),Ae.current&&clearTimeout(Ae.current),Ae.current=setTimeout(()=>z(""),J?4200:2400)},V=q=>fe(q,!0),de=p.useMemo(()=>{const q=new Map;return s.dossiers.forEach(J=>{J.id&&q.set(J.id,J)}),q},[s.dossiers]),we=p.useMemo(()=>s.dossiers.filter(q=>Pt(q,m,ke)),[s.dossiers,m,ke]),Ee=p.useRef(!1);p.useEffect(()=>{if(Ee.current||s.loading||!s.dossiers.length)return;if(e&&!s.session.token){Ee.current=!0;return}if(!ve.showFunnel||au(s.session.token||"")){Ee.current=!0;return}Ee.current=!0;const q=window.setTimeout(()=>{jo(s.session.token||""),_(!0)},700);return()=>window.clearTimeout(q)},[e,s.loading,s.dossiers.length,ve.showFunnel,s.session.token]);const je=p.useMemo(()=>s.dossiers.filter(q=>Yl(q,m,ke,s.favIds)),[s.dossiers,m,ke,s.favIds]),be=p.useMemo(()=>Qs(we.filter(q=>!at(q)),s.favIds),[we,s.favIds]),Be=p.useRef(!1);p.useEffect(()=>{if(Be.current)return;if(!ke||a==="ops"){Be.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Be.current=!0;return}if(s.loading)return;Be.current=!0;const q=Ks(be);q!==m.ptab&&c({type:"ptab",tab:q})},[ke,a,n==null?void 0:n.ptab,s.loading,be,m.ptab]);const et=p.useMemo(()=>{const q=Xo(s.dossiers);return q?gt(q)===0?l.tourToday:Zo(q,d):l.tourNoRun},[s.dossiers,l,d]),ut=p.useMemo(()=>s.dossiers.some(q=>!!q.memoUrl||!!q.summary||Yt(q)),[s.dossiers]),[Fe,Ve]=p.useState(!1);p.useEffect(()=>{if(s.loading){Ve(!1);return}if(s.dossiers.length>0||s.error){Ve(!0);return}const q=window.setTimeout(()=>Ve(!0),6e3);return()=>window.clearTimeout(q)},[s.loading,s.dossiers.length,s.error]);const wt=(s.marketEstimate||0)>0||typeof((nr=s.stats)==null?void 0:nr.screened)=="number"&&s.stats.screened>0,Ue=p.useMemo(()=>[1,0,2,4,5,3].find(q=>(be[q]||0)>0)??0,[be]),ot=Un.find(q=>q.key===m.continent),Rt=m.continent==="monde"?l.contWorld:(d==="fr"?ot==null?void 0:ot.fr:ot==null?void 0:ot.en)||"";p.useEffect(()=>{const q=J=>{var ie;const Q=(((ie=J.detail)==null?void 0:ie.name)||"").trim();Q&&yt(null,Q)};return window.addEventListener("ppmap:evaluate",q),()=>window.removeEventListener("ppmap:evaluate",q)}),p.useEffect(()=>{const q=J=>{const Q=J.detail||{},ie=String(Q.id||"").trim(),ge=String(Q.name||"").trim(),Me=String(Q.url||"").trim(),qe=ie&&de.get(ie)||Kc(s.dossiers,ge,Me);if(qe){if(w(null),Pt(qe,m,ke)||(m.continent!=="monde"&&qe.continent!==m.continent&&c({type:"continent",key:qe.continent||"monde"}),c({type:"reset"})),ke&&qe.kind!=="op"){const xt=Te(qe);typeof xt=="number"&&xt!==m.ptab&&c({type:"ptab",tab:xt})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),c({type:"focus",id:qe.id}),(qe.noCo||["media","nominations","recrutements"].includes(qe.engine||""))&&(qe.url||qe.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:qe.url||"",text:[qe.headline,qe.tagline].filter(Boolean).join(`
`)}})):qe.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:qe.name,url:qe.url||"",website:qe.website||"",domain:qe.domain||""}}));return}!ge&&!Me||(c({type:"focus",id:ie||null}),w({name:ge,headline:String(Q.text||"").trim()||ge,url:Me,card:Q.card}),Me&&(Qt(ge)||!ge)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Me,text:String(Q.text||"").trim()}})):ge&&!Qt(ge)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ge}})))};return window.addEventListener("ppmap:focus",q),()=>window.removeEventListener("ppmap:focus",q)}),p.useEffect(()=>{const q=ie=>{const ge={},Me=String((ie==null?void 0:ie.sector)||"").trim();Me&&(ge.sector=[Me]);const qe=String((ie==null?void 0:ie.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(qe)&&(ge.day=qe);const Ke=String((ie==null?void 0:ie.search)||"").trim();Ke&&(ge.search=Ke);const xt=String((ie==null?void 0:ie.dealKind)||"").trim();(xt==="ma"||xt==="levee"||xt==="other")&&(ge.dealKind=[xt]),Object.keys(ge).length&&c({type:"filters",patch:ge})},J=ie=>q(ie.detail),Q=ie=>{ie.data&&ie.data.type==="pp-filter"&&q(ie.data)};return window.addEventListener("ppmap:filter",J),window.addEventListener("message",Q),()=>{window.removeEventListener("ppmap:filter",J),window.removeEventListener("message",Q)}},[]),p.useEffect(()=>{const q=J=>{var ge;const Q=(((ge=J.detail)==null?void 0:ge.name)||"").trim().toLowerCase();if(!Q)return;const ie=s.dossiers.find(Me=>(Me.name||"").trim().toLowerCase()===Q);ie&&c(a==="ops"?{type:"focus",id:ie.id}:{type:"popup",id:ie.id})};return window.addEventListener("ppmap:similar",q),()=>window.removeEventListener("ppmap:similar",q)});const yt=(q,J,Q)=>{const ie=(Q||(q==null?void 0:q.name)||J||"").trim();if(!P){k({kicker:ie});return}!ie||A||(L(!0),(async()=>{try{let ge=(J||ie).trim();const Me=((q==null?void 0:q.website)||(q==null?void 0:q.domain)||"").trim();if(!(/^https?:\/\//i.test(ge)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(ge)&&!/\s/.test(ge)))if(Me)ge=Me;else try{const _e=await Hn(ie);if(_e!=null&&_e.website)ge=_e.website;else if(((_e==null?void 0:_e.candidates)||[]).length===1)ge=_e.candidates[0].url;else if(((_e==null?void 0:_e.candidates)||[]).length>1){$.current=[{name:ie,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(_e.candidates||[]).slice(0,5)},...$.current].slice(0,8),S();return}}catch{}const Ke=await qo(te,ge,"atelier2"),xt={name:Ke.company||ie,verdict:Ke.verdict,reason:Ke.reason||"",remaining:Ke.remaining??null};$.current=[xt,...$.current].slice(0,8),Ke.verdict==="kept"&&N(_e=>({..._e,kept:_e.kept+1})),Ke.verdict==="ruled_out"&&N(_e=>({..._e,dropped:_e.dropped+1}));const na=q||s.dossiers.find(_e=>(_e.name||"").toLowerCase()===ie.toLowerCase());na&&(Ke.verdict==="kept"?na.verdict=na.verdict||"MATCH":Ke.verdict==="ruled_out"&&(na.verdict="NO MATCH"),Ke.reason&&(na.reasoning=Ke.reason)),S()}finally{L(!1)}})())},Ot=q=>{if(!P){k({kicker:q.name});return}se(q,"instant"),jt(te,"fast_request",q.name||"",""),fe(l.memoInstantSent(q.name))},zt=q=>ze.current.get(q.id)??s.thumbs.get((q.name||"").trim().toLowerCase()),Mt=(q,J)=>c({type:"undoPush",entry:{id:q.id,name:q.name,prevCeoStatus:J}}),kt=async(q,J,Q)=>{const ie=q.ceoStatus||"";W.current.set(q.id,Date.now()),q.ceoStatus=J,S();const ge=await rn(te,{status:J,airtable_id:q.airtableId,check_id:q.checkId,company:q.name,...(Q==null?void 0:Q.note)!==void 0?{note:Q.note}:{},...Q!=null&&Q.via?{via:Q.via}:{}});return ge.ok?ge.skipped?(q.ceoStatus=ie,S(),V(l.actNotPersisted),!1):((Q==null?void 0:Q.undo)!==!1&&Mt(q,ie),Q!=null&&Q.msg&&fe(Q.msg),(J==="Validé"||J==="Écarté")&&!q.ceoNote&&(Q==null?void 0:Q.note)===void 0&&M({o:q,yes:J==="Validé"}),!0):(q.ceoStatus=ie,S(),V(l.actErr),!1)},Pe=async(q,J)=>{const Q=await rn(te,{status:q.ceoStatus||"Retenu",airtable_id:q.airtableId,check_id:q.checkId,company:q.name,note:J,via:"note"});return!Q.ok||Q.skipped?(V(Q.skipped?l.actNotPersisted:l.actErr),!1):(q.ceoNote=J,S(),!0)},it=p.useRef(new Map),tt=q=>it.current.has(q.id)?it.current.get(q.id):s.stages.get((q.name||"").trim().toLowerCase()),Ct=(q,J)=>{it.current.set(q.id,J),S()},O=(q,J)=>{P&&kt(q,J?"Validé":"Écarté",{msg:J?l.decidedYes(q.name):l.decidedNo(q.name)})},Y=q=>{P&&kt(q,"À trancher",{msg:l.promoted(q.name)})},ae=q=>{P&&(async()=>{const J=q.ceoStatus||"";q.ceoStatus="Retenu",S();const Q=await rn(te,{status:"Retenu",check_id:q.checkId,company:q.name});if(!Q.ok||Q.skipped){q.ceoStatus=J,S(),V(Q.skipped?l.actNotPersisted:l.actErr);return}Mt(q,J),fe(l.repeched(q.name))})()},D=()=>{const q=m.undo[m.undo.length-1];if(!q){fe(l.undoNone);return}const J=de.get(q.id);if(!J){c({type:"undoPop"}),fe(l.undoNone);return}let Q=q.prevCeoStatus;if(!Q)if((J.verdict||"").toUpperCase().includes("CALL"))Q="À trancher";else{fe(l.undoLockedTitle);return}(async()=>await kt(J,Q,{undo:!1})&&(c({type:"undoPop"}),J.ceoStatus=q.prevCeoStatus,S(),fe(l.undoDone(J.name))))()},ne=q=>{P&&(ee.current.add(q.id),S(),c({type:"approachOpen",id:q.id}),jt(te,"approach",q.name||"","","",s.email||""))},W=p.useRef(new Map),pe=p.useRef(!1),[Ne,he]=p.useState(0);p.useEffect(()=>{if(!te||e||!P||pe.current)return;pe.current=!0;const q=new Date().toISOString().slice(0,10),J=s.email||"",Q=`cbv_${te}_${J}_${q}`,ie=`atl2:vue:${te}:${q}`;try{if(localStorage.getItem(Q)||localStorage.getItem(ie))return}catch{}jt(te,"view","","","",J).then(ge=>{if(!ge.ok){pe.current=!1;return}try{localStorage.setItem(Q,"1")}catch{}})},[te,e,P,s.email]),p.useEffect(()=>{if(!te||!ke||e||!P||!s.generatedAt)return;let q=!0;const J=()=>{document.hidden||rl(te,s.generatedAt||"").then(ie=>{q&&he(ie)})};J();const Q=window.setInterval(J,6e4);return()=>{q=!1,window.clearInterval(Q)}},[te,ke,e,s.generatedAt]);const Se=(q,J)=>{P&&(async()=>{if(!(await jt(te,J?"yes":"no",q.name||"",(q.ceoNote||"").slice(0,400),q.sector||"",s.email||"")).ok){V(l.actErr);return}ze.current.set(q.id,J?"yes":"no"),S(),fe(J?l.thumbUpDone:l.thumbDnDone),F({o:q,up:J})})()},Re=q=>{!P||!Yt(q)||(se(q,"detailed"),jt(te,"detailed_request",q.name||"","","",s.email||""),fe(l.memoDeepSent(q.name)))},Qe=q=>{!P||!q.memoUrl||window.confirm(l.memoRegenAsk(q.name))&&(se(q,"detailed"),jt(te,"detailed_regen",q.name||"","","",s.email||""),fe(l.memoDeepSent(q.name)))},mt=q=>{const J=new Set(s.favIds),Q=J.has(q.id);Q?J.delete(q.id):J.add(q.id),s.setFavIds(J),P&&ol(te,{id:q.id,co:q.name},Q)},$e=()=>{!P||G||window.confirm(l.identSyncConfirm)&&(Z(!0),(async()=>{const q=await il(te);Z(!1),q?fe(l.identSyncDone):V(l.actErr)})())},st=/proplace/i.test(s.fund||""),At=q=>{!P||!st||(jt(te,"onboard_request",q.name||"",""),fe(l.onboardSent(q.name)))},aa={st:m,dispatch:c,t:l,lang:d,mode:ue,caps:ve,pipe:ke,token:te,fund:s.fund,email:s.email,criteria:s.criteria,source:a||"default",data:s,doRepeche:ae,thumbOf:zt,canWrite:P,commitStatus:kt,saveNote:Pe,stageOf:tt,setStage:Ct,flashErr:V,startTour:()=>_(!0),dossiers:s.dossiers,scopedAll:we,scoped:je,counts:be,byId:de,contName:Rt,favIds:s.favIds,toggleFav:mt,askEvaluate:yt,doAnalyse:Ot,doDecide:O,doPromote:Y,doApproach:ne,doThumb:Se,doDeep:Re,doRegen:Qe,doUndo:D,doSync:$e,doOnboard:At,outbound:st,memoQueued:I.current,liveMemos:{items:K,serverOff:ye,liveOf:le},approachDone:ee.current,sessTally:j,evalCards:$.current,evalBusy:A,markRow:y,markedId:v,flash:fe,focusExtra:f};p.useEffect(()=>{const q=J=>{J.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",q),()=>window.removeEventListener("keydown",q)},[]);const Mi=q=>te?t.jsx(Jl,{token:te,children:q}):t.jsx(t.Fragment,{children:q});return t.jsx(Fi.Provider,{value:aa,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(te?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Ml}),Mi(t.jsxs("div",{className:"app"+(ke?" pipe":"")+(te?" has-thesis":""),children:[ve.showTicker&&t.jsx(ft,{name:"live",children:t.jsxs("div",{className:"live-stack"+(te?" live-stack--cibles":""),children:[t.jsx(rd,{}),!!te&&t.jsx(Xl,{})]})}),ve.showIdent&&t.jsx(ft,{name:"identite",children:t.jsx(fd,{})}),!1,eu,ve.showFunnel&&t.jsx(ft,{name:"entonnoir",children:t.jsx(ru,{})}),t.jsx(ft,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(vi,{variant:"tabs"}),!m.mapFolded&&t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Jc,{}),a!=="ops"&&(ve.showFunnel||ve.showIdent)&&t.jsxs("div",{className:"map-hud",children:[ve.showFunnel&&t.jsx(Xc,{}),ve.showIdent&&t.jsx(Zc,{})]}),t.jsx(up,{}),t.jsx(bi,{})]})]})}),ve.showDemand&&ke&&t.jsx(ft,{name:"direct",children:t.jsx(cl,{items:K,serverOff:ye,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([q,J])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===q,onClick:()=>{h(q);try{localStorage.setItem("atl2:chrome-mode",q)}catch{}},children:J},q))}),ve.showDemand&&t.jsx(ft,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Np,{})})}),ve.showDemand&&m.memoConsole&&t.jsx(ft,{name:"console",children:t.jsx(zp,{})}),ve.pipe&&!!te&&t.jsx(ft,{name:"moteurs",children:t.jsx(jl,{})}),Ne>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:l.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{he(0),s.refresh()},children:l.freshGo})]}),t.jsx(ft,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(hc,{})}),ve.pipe&&!!te&&t.jsx("p",{className:"privnote",children:l.privLink}),s.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),s.error&&!s.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:s.refresh,children:l.retry})]})]})),m.popupId&&m.dens!=="liste"&&a!=="ops"&&t.jsx(ft,{name:"fiche",children:t.jsx(Xp,{})}),t.jsx(ft,{name:"modales",children:t.jsx(Ec,{})}),t.jsx(Js,{}),x&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:x.o.name}),t.jsx(Dr,{placeholder:x.up?l.thumbWhyUpPh:l.thumbWhyDnPh,onDone:q=>{const J=x.o;F(null),q&&jt(te,"note",J.name||"",q,J.sector||"",s.email||"").then(Q=>{Q.ok&&fe(l.csNoteSaved)})}})]}),H&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:H.o.name}),t.jsx(Dr,{placeholder:H.yes?l.whyYesPh:l.whyNoPh,onDone:q=>{const J=H.o;M(null),q&&Pe(J,q).then(Q=>{Q&&fe(l.csNoteSaved)})}})]}),C&&Fe&&t.jsx(ud,{steps:nu(l,et,ut,Ue,wt,be[3]||0,be[4]||0,be),onClose:()=>{_(!1),jo(te)}}),t.jsx(tu,{}),ve.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:Do,children:Mo}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${_a}`,children:_a})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),T&&t.jsx("div",{className:"flash on"+(R?" err":""),children:T}),E&&t.jsx(Xs,{variant:"acquirer",initialCompany:No().co,initialWebsite:No().site,onClose:()=>k(null)})]})})}function ru(){const{t:e}=X(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function No(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function ou(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Ri as FlagCell,Lt as SigBadge,en as SigWin,lu as default,ou as fmtShort,X as useV2};
