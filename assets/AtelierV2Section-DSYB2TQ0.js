...
.atl2.ops .readpane{min-width:0;position:sticky;
  top:calc(104px + var(--demand-h,56px));
  max-height:calc(100dvh - 112px - var(--demand-h,56px));overflow-y:auto;
  overscroll-behavior:contain;background:#F7F9FB;border-left:1px solid var(--line)}
...
`,Ri=Li+Mi;function za(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Oi(){const e=za("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Fi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Oi();return r==="0"?"client":r==="1"||za("embed")==="1"&&za("chrome")==="1"?"apercu":"client"}const Pi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Di=e=>Pi[e];function Ka(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const ot=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!lr(a)||Ka(a))&&(e.noCo=!0)}return Object.assign(e,{continent:So(e.cc)})};function fa(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Ii=60*60*1e3;function $i(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ii?null:a}catch{return null}}function Bt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Bi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function _i(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:fo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Fi(e,i),[e,i,n]),l=m.useMemo(()=>Di(o),[o]),c=o!=="visiteur",d=Bi(r),[f,s]=m.useState([]),[x,p]=m.useState(""),[h,u]=m.useState(null),[b,v]=m.useState(null),[g,N]=m.useState(null),[E,y]=m.useState(()=>new Map),[T,q]=m.useState(()=>new Map),[L,S]=m.useState(""),[z,j]=m.useState(new Set),[M,D]=m.useState(null),[A,R]=m.useState(!0),[w,O]=m.useState(!1),[G,H]=m.useState(0),[_,ne]=m.useState(0),te=m.useRef(0),ee=m.useMemo(()=>{var I;if(o!=="client")return"";try{return((I=xo())==null?void 0:I.email)||""}catch{return""}},[o]);m.useEffect(()=>{const I=++te.current;let X=!0;const ce=()=>X&&I===te.current,Ae=(c&&i.token?i.token:"pub:"+a)+(d?":"+d:""),de=$i(Ae);return de?(s(de.objs.map(ot)),de.fund&&p(de.fund),u(de.marketEstimate??null),v(de.criteria??null),N(de.stats??null),S(de.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const ke=await ua(),ae=((ke==null?void 0:ke.recent_ops)||[]).map(V=>{const W=Jt(V.company_name||V.title?V:{...V,title:(V.headline_fr||V.headline||"").slice(0,120)},a),Q=String(V.rubrique||"").toLowerCase();return W&&(Q==="nominations"||Q==="recrutements")&&(W.engine=Q),W&&!String(V.company_name||"").trim()&&(W.noCo=!0),W}).filter(V=>!!V).map(V=>(lr((V.name||"").trim())||(V.noCo=!0),V));try{const V=ho(),W=V&&V.doc||await go(),Q=bo(W),J=((V==null?void 0:V.day)||(W==null?void 0:W.date)||"").slice(0,10);if(J&&Q.length){const fe=new Set;for(const pe of ae){if((pe.date||"").slice(0,10)!==J)continue;const ye=pn(Q,fe,pe.name,"");ye>=0&&(fe.add(ye),pe.decryptHtml=Q[ye].html)}for(const pe of ae){if(pe.decryptHtml||(pe.date||"").slice(0,10)!==J)continue;const ye=pn(Q,fe,"",pe.headline||pe.tagline||pe.name);ye>=0&&(fe.add(ye),pe.decryptHtml=Q[ye].html)}}if(J){const fe=((W==null?void 0:W.title_fr)||"").trim(),pe=((W==null?void 0:W.lead_fr)||"").trim(),ye=vo(W),ue=((W==null?void 0:W.url)||"").trim();fe&&ye&&ae.unshift({id:`edito:${J}`,kind:"op",name:fe,cc:null,date:J,engine:"edito",dealKind:"other",headline:pe||fe,tagline:pe||fe,decryptHtml:ye,url:ue,noCo:!0})}}catch{}if(!ce())return;s(ae.map(ot)),Bt(Ae,{objs:ae})}else if(typeof r=="object"){const ae=(await un()||[]).filter(W=>(W.slug||"")===r.research).map(W=>mn(W,a)).filter(W=>!!W),V=fa(await fn(ae,a));if(!ce())return;s(V.map(ot)),Bt(Ae,{objs:V})}else if(c&&i.token){const ke=yo(i.token),ae=ua(),V=wo(i.token),W=ko(i.token),Q=jo(i.token),J=await ke;let fe=J?J.targets:[];ce()&&J&&(p(J.fund||""),u(J.marketEstimate??null),v(J.criteria??null),N(J.stats??null),S(J.generatedAt||""),s(fe.map(ot)),R(!1),O(!1));const[pe,ye,ue,we]=await Promise.all([ae,V,W,Q]),De=((pe==null?void 0:pe.recent_ops)||[]).map(C=>Jt(C,a)).filter(C=>!!C);if(fe=[...fe,...De],!ce())return;s(fe.map(ot));const Ye=new Set;for(const C of ye){const U=(C.id||C.co||"").toString().trim().toLowerCase();U&&Ye.add(U.startsWith("t:")?U:"t:"+U)}j(Ye),y(ue),q(we),J&&Bt(Ae,{fund:J.fund,marketEstimate:J.marketEstimate,criteria:J.criteria,stats:J.stats,generatedAt:J.generatedAt,objs:fe})}else{const ke=No(),ae=un(),V=ua(),W=await ke;ce()&&W.length&&(s(fa(W).map(ot)),R(!1),O(!1));const[Q,J]=await Promise.all([ae,V]),fe=(Q||[]).map(we=>mn(we,a)).filter(we=>!!we),pe=await fn(fe,a),ye=((J==null?void 0:J.recent_ops)||[]).map(we=>Jt(we,a)).filter(we=>!!we),ue=fa([...W,...pe,...ye]);if(!ce())return;s(ue.map(ot)),Bt(Ae,{objs:ue})}ce()&&O(!1)}catch{ce()&&!de&&O(!0)}finally{ce()&&R(!1)}})(),()=>{X=!1}},[c,i.token,a,G,d]),m.useEffect(()=>{if(!l.showCredits||!ee){D(null);return}let I=!0;return(async()=>{try{const X=await fetch(`${Ha}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ee})});if(!X.ok)return;const ce=await X.json();I&&ce&&ce.ok!==!1&&D(ce)}catch{}})(),()=>{I=!1}},[l.showCredits,ee,_]);const re=m.useCallback(I=>j(new Set(I)),[]);return{session:i,mode:o,caps:l,fund:x,email:ee,marketEstimate:h,generatedAt:L,criteria:b,stats:g,thumbs:E,stages:T,dossiers:f,favIds:z,setFavIds:re,credits:M,reloadCredits:()=>ne(I=>I+1),loading:A,error:w,refresh:()=>H(I=>I+1)}}function vt(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const mr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Ui=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...mr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Hi=new Set(["signal","amount","score","crible","memo"]);function Vi(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:mr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Hi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??fr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const fr=40;function ea(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!ze(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Va(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(at(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&st(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function xr(e,a,r){return vt(e)?ea(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ea(e,a.filters,r)}function Wi(e,a,r,n){return!(!xr(e,a,r)||r&&!Eo(e,a.ptab,n))}function Qa(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-at(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return zo(i);case"memo":return Co(i);case"signal":{const o=ze(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),c=n(o);return l<c?-a.dir:l>c?a.dir:(i.name||"").localeCompare(o.name||"")})}const xa={},Nn=(xa==null?void 0:xa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Sn(){return new Date().toISOString().slice(0,10)}const Ja=m.createContext(null);function hr(){return m.useContext(Ja)}function Yi(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const c=n.cloneNode(!0);c.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),c.querySelectorAll("*").forEach(d=>{const f=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(s=>d.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(d.setAttribute("href",f),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:c.outerHTML})}}catch{}return a}function En(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function gr(){const e=m.useContext(Ja);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Gi({token:e,children:a}){const{dispatch:r,st:n,lang:i}=$(),[o,l]=m.useState(()=>n.filters.day||Sn()),[c,d]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),p=m.useCallback(()=>{l(Sn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);m.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),m.useEffect(()=>{const b=v=>{var N;const g=(N=v.detail)==null?void 0:N.day;typeof g=="string"&&x(g)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Nn}/cibles/edition.json?${v}`).then(g=>g.json()).then(g=>{b||d(g)}).catch(()=>{b||d({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const h=m.useMemo(()=>`${Nn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),u=m.useMemo(()=>({token:e,day:o,ed:c,loading:f,pickDay:x,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:h,isEn:i==="en"}),[e,o,c,f,x,p,n.filters.day,h,i]);return t.jsx(Ja.Provider,{value:u,children:a})}function Ki(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=gr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Ao,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Qi(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=gr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),c=(a==null?void 0:a.ok)&&!l,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:En(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:En(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const Ji=300,_t=7,Xi={fr:{ma:"M&A",levees:"Levées de fonds",nominations:"Nominations",recrutements:"Offres d'emploi",actualites:"Presse"},en:{ma:"M&A",levees:"Fundraising",nominations:"Appointments",recrutements:"Job offers",actualites:"Press"}},br={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Zi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function ha(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=ze(e);return r?"sig:"+(r.theme&&br.fr[r.theme]?r.theme:"other"):"actualites"}function es(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:c}=$(),d=hr(),f=l==="en",[s,x]=m.useState("all"),[p,h]=m.useState(!1),u=m.useMemo(()=>{var re;const A=(a.filters.day||"").slice(0,10),R=I=>!(!o&&a.continent!=="monde"&&I.continent!==a.continent||A&&(I.date||"").slice(0,10)!==A),w=e.filter(I=>R(I)&&ze(I)&&(!o||I.kind!=="target"||Ce(I)!==5)),O=o&&(((re=d==null?void 0:d.ed)==null?void 0:re.ops)||[]).length?d.ed.ops.map(I=>Jt(I,l)).filter(I=>!!I).filter(I=>!A||(I.date||"").slice(0,10)===A):[],G=e.filter(I=>R(I)&&I.kind==="op"&&(A?!0:at(I.date)<=_t)),H=o?O.length?O:G.filter(I=>{const X=(c||"").trim().toLowerCase();if(!X)return!1;const ce=I.match||null;return ce?Object.keys(ce).map(Ae=>Ae.trim().toLowerCase()).includes(X):!1}):G,_=A||new Date().toISOString().slice(0,10),ne=I=>{const X=ha(I);return X==="ma"?0:X==="levees"?1:2};H.sort((I,X)=>{const ce=ne(I)-ne(X);if(ce)return ce;const Ae=(I.date||"").slice(0,10)===_?0:1,de=(X.date||"").slice(0,10)===_?0:1;return Ae!==de?Ae-de:(X.amountEur||0)-(I.amountEur||0)});const te=new Set,ee=[];for(const I of[...H,...Qa(w,{key:"signal",dir:-1})]){const X=I.id||I.name;!X||te.has(X)||(te.add(X),ee.push(I))}return o&&ee.length===0?e.filter(X=>R(X)&&at(X.date)<=_t).sort((X,ce)=>(ce.date||"").localeCompare(X.date||"")).slice(0,80):ee},[e,a.continent,a.filters.day,o,c,l,d]),b=m.useMemo(()=>{const A={};for(const R of u){const w=ha(R);A[w]=(A[w]||0)+1}return A},[u]),v=m.useMemo(()=>s==="all"?u:u.filter(A=>ha(A)===s),[u,s]),g=m.useMemo(()=>v.slice(0,Ji),[v]),N=v.length-g.length,E=m.useRef(null);m.useEffect(()=>{var H,_;const A=E.current;if(!A)return;const R=()=>{const ne=A.scrollWidth;ne<200||(A.style.animationDuration=Math.max(18,Math.round(ne/130))+"s")};R();const w=requestAnimationFrame(R),O=window.setTimeout(R,1200);let G=!0;return(_=(H=document.fonts)==null?void 0:H.ready)==null||_.then(()=>{G&&R()}),()=>{G=!1,cancelAnimationFrame(w),window.clearTimeout(O)}},[g.length,s]);const y=A=>A==="all"?u.length:b[A]||0,T=A=>A==="all"?f?"All":"Tout":A.startsWith("sig:")?br[f?"en":"fr"][A.slice(4)]||"🔔":Xi[f?"en":"fr"][A],q=[{k:"all"}],L=["ma","levees"].filter(A=>y(A)>0||A===s);if(L.length){q.push({g:f?"Recent deals":"Opérations récentes"});for(const A of L)q.push({k:A})}const S=["nominations","recrutements","actualites"].filter(A=>y(A)>0||A===s),z=Zi.map(A=>"sig:"+A).filter(A=>y(A)>0||A===s);if(S.length||z.length){q.push({g:f?"News (incl. wire)":"Actualités (dont fil)"});for(const A of S)q.push({k:A});for(const A of z)q.push({k:A})}const j=A=>{try{return new Date(A+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return A}},M=(()=>{const A=(a.filters.day||"").slice(0,10),R=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return A?(f?`LIVE covers the events of ${j(A)}.`:`Le LIVE regroupe les événements du ${j(A)}.`)+R:(f?`LIVE covers the still-open signals and the deals of the last ${_t} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${_t} derniers jours.`)+R})(),D=A=>g.map(R=>t.jsxs("button",{type:"button",className:"tk"+(Re(R)?" spent":""),onClick:w=>{if(n({type:"focus",id:R.id}),a.dens!=="liste"){const O=w.currentTarget.getBoundingClientRect();n({type:"popup",id:R.id,anchor:{x:O.left+O.width/2,y:O.bottom}})}},title:R.name+(R.tagline?" — "+R.tagline:""),children:[t.jsx(pt,{o:R}),t.jsxs("span",{className:"who",children:[t.jsx(Kr,{o:R}),t.jsx("span",{className:"co",children:R.name})]}),typeof R.amountEur=="number"&&R.amountEur>0&&t.jsx("span",{className:"am",children:Cc(R.amountEur)}),R.sector&&t.jsx("span",{className:"mt",children:R.sector}),t.jsx(da,{o:R}),t.jsx("span",{className:"tkgo",children:"→"})]},A+(R.id||R.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},A+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:A=>{A.currentTarget.contains(A.relatedTarget)||h(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>h(A=>!A),children:[T(s),t.jsx("b",{children:y(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:M}),q.map(A=>"g"in A?t.jsx("span",{className:"tkfilg",children:A.g},A.g):t.jsxs("button",{type:"button","aria-pressed":A.k===s,onClick:()=>{x(A.k),h(!1)},children:[T(A.k),t.jsx("b",{children:y(A.k)})]},A.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",ref:E,children:[D(0),D(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!d&&t.jsx(as,{isEn:f})]})}const ts=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function as({isEn:e}){const[a,r]=m.useState(()=>To());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(xn,i),()=>window.removeEventListener(xn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>qo(!a),children:ts})}const Xa="+33 6 83 10 72 86",ta="alexandre@proplace.co",vr=`tel:${Xa.replace(/[^\d+]/g,"")}`;function ns(){return null}class qe extends m.Component{constructor(){super(...arguments);cn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ga=600,it=62,Cn="atl2:fstats";function rs(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=$(),[l,c]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Cn)==="on"}catch{return!1}}),d=r.stats,f=m.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),s=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const x=T=>a==="en"?T.slice(5,10):`${T.slice(8,10)}/${T.slice(5,7)}`,p=T=>T.toLocaleString(a==="en"?"en-US":"fr-FR"),h=f.reduce((T,q)=>Math.max(T,q.s||0),0),u=f.length?ga/f.length:0,b=Math.max(4,u-4),v=f.length>=5&&h>0,g=r.marketEstimate||0,N=x(new Date().toISOString().slice(0,10)),E=T=>[...typeof T=="number"?[[T,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&s&&y.push({cle:"fenetre",periode:e.funPerWindow(x(s),N),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:E(d.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(T=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:T.periode}),T.etapes.map(([q,L],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(q)}),t.jsx("i",{children:L})]},T.cle+L)),T.cle==="total"&&g>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(g),Math.min(100,Math.round((d.screened||0)/g*100)))})]}),T.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const q=!l;c(q),q&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Cn,q?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},T.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ga} ${it}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((T,q)=>{const L=(T.s||0)/h*(it-4),S=(T.m||0)/h*(it-4),z=q*u+(u-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(T.d)} — ${T.s} ${e.actScreened} · ${T.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:it-2-L,width:b,height:L,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:it-2-S,width:b,height:S,fill:"#185c38"})]},T.d)}),t.jsx("line",{x1:0,y1:it-1.5,x2:ga,y2:it-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const yr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function os(e,a){if((nt(e)||"").startsWith("CALL")&&Ce(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ce(e)>=2;return yr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function is({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=$(),[c,d]=m.useState(!1),[f,s]=m.useState(""),[x,p]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),u=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){p(!0);return}s(b);const v=await i(e,b);s(""),v&&(d(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(b=>!b),p(!1)},children:[h||a.csNone,t.jsx("i",{children:"▾"})]}),c&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),p(!1),d(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(d(!1),p(!1))})()},children:a.csAnaAnyway})]}):os(e,a).map(([b,v])=>t.jsx("button",{type:"button",className:"rsti"+(h===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{u(b)},children:v},b))})]})}function ss({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=$(),[o,l]=m.useState(""),[c,d]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(nt(e)||"").startsWith("CALL")&&Ce(e)===3,x=Ce(e)>=2,p=async u=>{if(o||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(u);const b=await i(e,u);l(""),b&&(d(!0),setTimeout(()=>d(!1),2200))},h=s?[["Validé",a.csYes],["Écarté",a.csNo]]:yr.filter(([u])=>!(x&&u==="Retenu")).map(([u,b])=>[u,a[b]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([u,b])=>t.jsx("button",{type:"button",className:"csb"+(f===u?" on":"")+(o===u?" busy":""),disabled:!!o,onClick:()=>{p(u)},children:b},u)),c&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ls,{o:e})]})}function ls({o:e}){const{t:a,saveNote:r,flash:n}=$(),[i,o]=m.useState(e.ceoNote||""),[l,c]=m.useState(!1),[d,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;c(!0);const p=await r(e,i.trim());c(!1),p&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:p=>o(p.target.value),onKeyDown:p=>{p.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:d?a.csNoteSaved:a.csNoteOk})]})}function cs({placeholder:e,onDone:a}){const{t:r}=$(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ds({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:c}=$(),[d,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||Ce(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",p=async g=>{if(d||g===x)return;f(!0);const N=s;l(e,{stage:g,stamps:(s==null?void 0:s.stamps)||{}});const E=Math.max(Date.now(),zn+=1);zn=E;const y=await Lo(r,{company:e.name||"",stage:g,cts:E,deal_id:e.airtableId,check_id:e.checkId});f(!1),!y.stale&&(y.ok||(l(e,N),c(a.actErr)))},h=(v=s==null?void 0:s.stamps)==null?void 0:v.sent,u=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,b=x==="sent"&&h&&u>=4;return t.jsxs("div",{className:"stg",onClick:g=>g.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([g,N])=>t.jsx("button",{type:"button",className:"stgb"+(x===g?" on":""),disabled:d,onClick:()=>{p(g)},children:N},g)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let zn=0;const Ut=8,Ht=360;function An({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Tn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(An,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(An,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ps({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=$(),[l,c]=m.useState(0),[d,f]=m.useState(null),[s,x]=m.useState([]),p=m.useRef(!1),h=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),u=m.useRef(!1);m.useEffect(()=>{const L=h.current;return()=>{u.current||(n({type:"ptab",tab:L.ptab}),n({type:"dens",dens:L.dens}),n({type:"modal",modal:L.modal}))}},[]),m.useEffect(()=>{p.current||(p.current=!0,x(e.filter(L=>!!document.querySelector(L.need||L.sel))))},[e]);const b=s[l],v=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const L=b.click,S=window.setTimeout(()=>{const z=document.querySelector(L);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(S)}},[l,b]);const g=m.useRef(-1),N=m.useCallback(()=>{if(!b){f(null);return}const L=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!L){f(null);return}g.current!==l&&(g.current=l,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=L.getBoundingClientRect();f(z=>z&&Math.abs(z.top-S.top)<1&&Math.abs(z.left-S.left)<1&&Math.abs(z.width-S.width)<1&&Math.abs(z.height-S.height)<1?z:S)},[b,l]);m.useLayoutEffect(()=>{N();const L=[90,300,700,1300].map(z=>window.setTimeout(N,z)),S=()=>N();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{L.forEach(z=>window.clearTimeout(z)),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[N]);const E=m.useRef(a);if(E.current=a,m.useEffect(()=>{const L=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),E.current()):S.key==="ArrowRight"?c(z=>z+1):S.key==="ArrowLeft"&&c(z=>Math.max(0,z-1))};return document.addEventListener("keydown",L,!0),()=>document.removeEventListener("keydown",L,!0)},[]),!s.length)return null;let y=null;const T=L=>()=>{u.current=!0,n({type:"modal",modal:null}),L()};if(v){const L=i[3]||0;L>0?y={title:L===1?r.ahaATitle1:r.ahaATitleN(L),body:r.ahaABody,btn:r.ahaABtn,go:T(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:T(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:T(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:T(()=>{n({type:"modal",modal:"crit"}),a()})}}let q={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Ht};if(!v&&d){const L=d.bottom+14,z=window.innerHeight-L>190?L:Math.max(12,d.top-200);q={left:Math.min(Math.max(12,d.left+d.width/2-Ht/2),window.innerWidth-Ht-12),top:z,width:Ht}}return jt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Ut,top:d.top-Ut,width:d.width+Ut*2,height:d.height+Ut*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:q,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(Tn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>c(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Tn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>c(L=>Math.max(0,L-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>c(L=>L+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function wr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function kr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function us(){var S,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:c,dispatch:d}=$(),f=r?a:e,s=m.useMemo(()=>f.filter(j=>at(j.date)===0&&j.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(j=>j.kind==="target"&&Ce(j)===0).slice().sort((j,M)=>(M.date||"").localeCompare(j.date||"")):[],[a,r]),p=m.useMemo(()=>s.filter(j=>r?Ce(j)===0:!Re(j)),[s,r]),h=r?x:p,u=r?a.length-x.length:s.length-p.length,b=r?a.length:s.length,v=b?Math.min(100,u/b*100):100,g=m.useMemo(()=>wr(f),[f]),N=!!g&&at(g)>0,E=m.useMemo(()=>N?f.filter(j=>(j.date||"").slice(0,10)===g):[],[f,g,N]),y=typeof((S=c.stats)==null?void 0:S.kept_today)=="number"?c.stats.kept_today:null,T=typeof((z=c.stats)==null?void 0:z.screened_today)=="number"?c.stats.screened_today:s.length;let q;N?q=i.morningLast(E.length,x.length,kr(g,l)):r?q=i.morningThesis(T,x.length,y):s.length?u===0?q=i.goalSourced(s.length):u>=s.length?q=i.goalCleared:q=i.goalDone(u,s.length):q=i.goalSourced(0);const L=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&x.length&&d({type:"chainStart",queue:x.map(j=>j.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:q}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),h.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:L,children:r?i.morningEval(h.length):o.pileMode?i.goalContinue(h.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ms(){var G,H;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:c,mode:d,doSync:f,startTour:s,flash:x,flashErr:p}=$(),[h,u]=m.useState(null),[b,v]=m.useState(!0),[g,N]=m.useState([]),E=d==="client";m.useEffect(()=>{if(!i||!o)return;let _=!0;return v(!0),(async()=>{const[ne,te]=await Promise.all([Wa(o),cr(i)]);_&&(ne&&u(ne),v(!1),N(te))})(),()=>{_=!1}},[i,o]);const[y,T]=m.useState(!1),q=()=>{!E||y||!o||(T(!0),Mo(o).then(_=>{T(!1),_?x(e.identRepubDone):p(e.actErr)}))},L=(h==null?void 0:h.per_day)??null,S=((G=h==null?void 0:h.pool_order)==null?void 0:G.length)??0,z=g.filter(_=>_.status==="running").length,j=m.useMemo(()=>c.filter(_=>_.kind==="target"&&Re(_)).length,[c]),M=l.marketEstimate,D=typeof((H=l.stats)==null?void 0:H.screened)=="number"?l.stats.screened:j,A=M&&M>0?Math.min(100,Math.round(D/M*100)):null,R=_=>_.toLocaleString(a==="en"?"en-US":"fr-FR"),w=(o||"P").split(/\s+/).map(_=>_[0]).join("").slice(0,2).toUpperCase(),O=(()=>{const _=Date.parse(l.generatedAt||"");if(Number.isNaN(_))return"";const ne=new Date(_),te=ee=>String(ee).padStart(2,"0");return`${te(ne.getDate())}/${te(ne.getMonth()+1)} à ${te(ne.getHours())}:${te(ne.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?w:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),O?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(O)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&D>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(D)})})]}),A!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(D,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),L!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:L})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),L===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:_=>{_.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||y,onClick:q,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:_=>n({type:"filters",patch:{search:_.target.value}})})]})]})]})}function fs(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=$(),c=o.loading&&!l.length,d=m.useRef({});m.useEffect(()=>{d.current={...r}},[r]);const f=p=>{const h=d.current[p],u=h!==void 0?r[p]-h:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${ja[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[r[p],u!==0&&t.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},p)},s=(p,h,u)=>t.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":`var(${ja[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:u.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),x=(p,h,u,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:h,disabled:b,onClick:u,children:p},h);return t.jsxs("div",{className:"funnel"+(c?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function xs(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=$(),c=m.useRef(null),[d,f]=m.useState(60);m.useEffect(()=>{let u=0;const b=()=>{var y;const v=c.current;if(!v)return;const g=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!g)return;const N=g.getBoundingClientRect(),E=v.getBoundingClientRect();f(Math.max(20,Math.min(N.left+N.width/2-E.left,E.width-30)))};return u=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(u),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const u=n.filter(g=>g.kind==="target"&&Ce(g)===3),b=u.filter(g=>Na(g)==="auto").length,v=u.filter(g=>Na(g)==="cd").length;x=r.tutoPending(b,v,u.length)}const p=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(u=>u.id)})};if(s===1){const u=n.filter(b=>b.kind==="target"&&Ce(b)===1&&!i.has(b.id)).slice(0,10);if(u.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:u.map(b=>b.id)})}}return null})(),h=Ro(s);return t.jsxs("div",{ref:c,className:"tuto mini"+(h?"":" on-dark"),style:{"--bg":`var(${ja[s]})`,"--ax":d+"px","--stc":h?"var(--ink)":"#fff","--stt":h?"#fff":"var(--ink)","--tc":h?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:x}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}class ct{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,c=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);c&&(r[n++]=c),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*hs(e){for(const a of e)yield*a}function jr(e){return Array.from(hs(e))}var he=1e-6,se=Math.PI,Ue=se/2,qn=se/4,We=se*2,et=180/se,Pe=se/180,ve=Math.abs,gs=Math.atan,Mt=Math.atan2,Se=Math.cos,Ee=Math.sin,bs=Math.sign||function(e){return e>0?1:e<0?-1:0},ut=Math.sqrt;function vs(e){return e>1?0:e<-1?se:Math.acos(e)}function Rt(e){return e>1?Ue:e<-1?-Ue:Math.asin(e)}function He(){}function aa(e,a){e&&Mn.hasOwnProperty(e.type)&&Mn[e.type](e,a)}var Ln={Feature:function(e,a){aa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)aa(r[n].geometry,a)}},Mn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Aa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Aa(r[n],a,0)},Polygon:function(e,a){Rn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Rn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)aa(r[n],a)}};function Aa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Rn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Aa(e[r],a,1);a.polygonEnd()}function xt(e,a){e&&Ln.hasOwnProperty(e.type)?Ln[e.type](e,a):aa(e,a)}function Ta(e){return[Mt(e[1],e[0]),Rt(e[2])]}function yt(e){var a=e[0],r=e[1],n=Se(r);return[n*Se(a),n*Ee(a),Ee(r)]}function Vt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function na(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ba(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Wt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function qa(e){var a=ut(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function La(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ma(e,a){return ve(e)>se&&(e-=Math.round(e/We)*We),[e,a]}Ma.invert=Ma;function ys(e,a,r){return(e%=We)?a||r?La(Fn(e),Pn(a,r)):Fn(e):a||r?Pn(a,r):Ma}function On(e){return function(a,r){return a+=e,ve(a)>se&&(a-=Math.round(a/We)*We),[a,r]}}function Fn(e){var a=On(e);return a.invert=On(-e),a}function Pn(e,a){var r=Se(e),n=Ee(e),i=Se(a),o=Ee(a);function l(c,d){var f=Se(d),s=Se(c)*f,x=Ee(c)*f,p=Ee(d),h=p*r+s*n;return[Mt(x*i-h*o,s*r-p*n),Rt(h*i+x*o)]}return l.invert=function(c,d){var f=Se(d),s=Se(c)*f,x=Ee(c)*f,p=Ee(d),h=p*i-x*o;return[Mt(x*i+p*o,s*r+h*n),Rt(h*r-s*n)]},l}function ws(e,a,r,n,i,o){if(r){var l=Se(a),c=Ee(a),d=n*r;i==null?(i=a+n*We,o=a-d/2):(i=Dn(l,i),o=Dn(l,o),(n>0?i<o:i>o)&&(i+=n*We));for(var f,s=i;n>0?s>o:s<o;s-=d)f=Ta([l,-c*Se(s),-c*Ee(s)]),e.point(f[0],f[1])}}function Dn(e,a){a=yt(a),a[0]-=e,qa(a);var r=vs(-a[1]);return((-a[2]<0?-r:r)+We-he)%We}function Nr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:He,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Xt(e,a){return ve(e[0]-a[0])<he&&ve(e[1]-a[1])<he}function Yt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Sr(e,a,r,n,i){var o=[],l=[],c,d;if(e.forEach(function(u){if(!((b=u.length-1)<=0)){var b,v=u[0],g=u[b],N;if(Xt(v,g)){if(!v[2]&&!g[2]){for(i.lineStart(),c=0;c<b;++c)i.point((v=u[c])[0],v[1]);i.lineEnd();return}g[0]+=2*he}o.push(N=new Yt(v,u,null,!0)),l.push(N.o=new Yt(v,null,N,!1)),o.push(N=new Yt(g,u,null,!1)),l.push(N.o=new Yt(g,null,N,!0))}}),!!o.length){for(l.sort(a),In(o),In(l),c=0,d=l.length;c<d;++c)l[c].e=r=!r;for(var f=o[0],s,x;;){for(var p=f,h=!0;p.v;)if((p=p.n)===f)return;s=p.z,i.lineStart();do{if(p.v=p.o.v=!0,p.e){if(h)for(c=0,d=s.length;c<d;++c)i.point((x=s[c])[0],x[1]);else n(p.x,p.n.x,1,i);p=p.n}else{if(h)for(s=p.p.z,c=s.length-1;c>=0;--c)i.point((x=s[c])[0],x[1]);else n(p.x,p.p.x,-1,i);p=p.p}p=p.o,s=p.z,h=!h}while(!p.v);i.lineEnd()}}}function In(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function va(e){return ve(e[0])<=se?e[0]:bs(e[0])*((ve(e[0])+se)%We-se)}function ks(e,a){var r=va(a),n=a[1],i=Ee(n),o=[Ee(r),-Se(r),0],l=0,c=0,d=new ct;i===1?n=Ue+he:i===-1&&(n=-Ue-he);for(var f=0,s=e.length;f<s;++f)if(p=(x=e[f]).length)for(var x,p,h=x[p-1],u=va(h),b=h[1]/2+qn,v=Ee(b),g=Se(b),N=0;N<p;++N,u=y,v=q,g=L,h=E){var E=x[N],y=va(E),T=E[1]/2+qn,q=Ee(T),L=Se(T),S=y-u,z=S>=0?1:-1,j=z*S,M=j>se,D=v*q;if(d.add(Mt(D*z*Ee(j),g*L+D*Se(j))),l+=M?S+z*We:S,M^u>=r^y>=r){var A=na(yt(h),yt(E));qa(A);var R=na(o,A);qa(R);var w=(M^S>=0?-1:1)*Rt(R[2]);(n>w||n===w&&(A[0]||A[1]))&&(c+=M^S>=0?1:-1)}}return(l<-he||l<he&&d<-1e-12)^c&1}function Er(e,a,r,n){return function(i){var o=a(i),l=Nr(),c=a(l),d=!1,f,s,x,p={point:h,lineStart:b,lineEnd:v,polygonStart:function(){p.point=g,p.lineStart=N,p.lineEnd=E,s=[],f=[]},polygonEnd:function(){p.point=h,p.lineStart=b,p.lineEnd=v,s=jr(s);var y=ks(f,n);s.length?(d||(i.polygonStart(),d=!0),Sr(s,Ns,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function h(y,T){e(y,T)&&i.point(y,T)}function u(y,T){o.point(y,T)}function b(){p.point=u,o.lineStart()}function v(){p.point=h,o.lineEnd()}function g(y,T){x.push([y,T]),c.point(y,T)}function N(){c.lineStart(),x=[]}function E(){g(x[0][0],x[0][1]),c.lineEnd();var y=c.clean(),T=l.result(),q,L=T.length,S,z,j;if(x.pop(),f.push(x),x=null,!!L){if(y&1){if(z=T[0],(S=z.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),q=0;q<S;++q)i.point((j=z[q])[0],j[1]);i.lineEnd()}return}L>1&&y&2&&T.push(T.pop().concat(T.shift())),s.push(T.filter(js))}}return p}}function js(e){return e.length>1}function Ns(e,a){return((e=e.x)[0]<0?e[1]-Ue-he:Ue-e[1])-((a=a.x)[0]<0?a[1]-Ue-he:Ue-a[1])}const $n=Er(function(){return!0},Ss,Cs,[-se,-Ue]);function Ss(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var c=o>0?se:-se,d=ve(o-a);ve(d-se)<he?(e.point(a,r=(r+l)/2>0?Ue:-Ue),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),e.point(o,r),i=0):n!==c&&d>=se&&(ve(a-n)<he&&(a-=n*he),ve(o-c)<he&&(o-=c*he),r=Es(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),i=0),e.point(a=o,r=l),n=c},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Es(e,a,r,n){var i,o,l=Ee(e-r);return ve(l)>he?gs((Ee(a)*(o=Se(n))*Ee(r)-Ee(n)*(i=Se(a))*Ee(e))/(i*o*l)):(a+n)/2}function Cs(e,a,r,n){var i;if(e==null)i=r*Ue,n.point(-se,i),n.point(0,i),n.point(se,i),n.point(se,0),n.point(se,-i),n.point(0,-i),n.point(-se,-i),n.point(-se,0),n.point(-se,i);else if(ve(e[0]-a[0])>he){var o=e[0]<a[0]?se:-se;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function zs(e){var a=Se(e),r=2*Pe,n=a>0,i=ve(a)>he;function o(s,x,p,h){ws(h,e,r,p,s,x)}function l(s,x){return Se(s)*Se(x)>a}function c(s){var x,p,h,u,b;return{lineStart:function(){u=h=!1,b=1},point:function(v,g){var N=[v,g],E,y=l(v,g),T=n?y?0:f(v,g):y?f(v+(v<0?se:-se),g):0;if(!x&&(u=h=y)&&s.lineStart(),y!==h&&(E=d(x,N),(!E||Xt(x,E)||Xt(N,E))&&(N[2]=1)),y!==h)b=0,y?(s.lineStart(),E=d(N,x),s.point(E[0],E[1])):(E=d(x,N),s.point(E[0],E[1],2),s.lineEnd()),x=E;else if(i&&x&&n^y){var q;!(T&p)&&(q=d(N,x,!0))&&(b=0,n?(s.lineStart(),s.point(q[0][0],q[0][1]),s.point(q[1][0],q[1][1]),s.lineEnd()):(s.point(q[1][0],q[1][1]),s.lineEnd(),s.lineStart(),s.point(q[0][0],q[0][1],3)))}y&&(!x||!Xt(x,N))&&s.point(N[0],N[1]),x=N,h=y,p=T},lineEnd:function(){h&&s.lineEnd(),x=null},clean:function(){return b|(u&&h)<<1}}}function d(s,x,p){var h=yt(s),u=yt(x),b=[1,0,0],v=na(h,u),g=Vt(v,v),N=v[0],E=g-N*N;if(!E)return!p&&s;var y=a*g/E,T=-a*N/E,q=na(b,v),L=Wt(b,y),S=Wt(v,T);ba(L,S);var z=q,j=Vt(L,z),M=Vt(z,z),D=j*j-M*(Vt(L,L)-1);if(!(D<0)){var A=ut(D),R=Wt(z,(-j-A)/M);if(ba(R,L),R=Ta(R),!p)return R;var w=s[0],O=x[0],G=s[1],H=x[1],_;O<w&&(_=w,w=O,O=_);var ne=O-w,te=ve(ne-se)<he,ee=te||ne<he;if(!te&&H<G&&(_=G,G=H,H=_),ee?te?G+H>0^R[1]<(ve(R[0]-w)<he?G:H):G<=R[1]&&R[1]<=H:ne>se^(w<=R[0]&&R[0]<=O)){var re=Wt(z,(-j+A)/M);return ba(re,L),[R,Ta(re)]}}}function f(s,x){var p=n?e:se-e,h=0;return s<-p?h|=1:s>p&&(h|=2),x<-p?h|=4:x>p&&(h|=8),h}return Er(l,c,o,n?[0,-e]:[-se,e-se])}function As(e,a,r,n,i,o){var l=e[0],c=e[1],d=a[0],f=a[1],s=0,x=1,p=d-l,h=f-c,u;if(u=r-l,!(!p&&u>0)){if(u/=p,p<0){if(u<s)return;u<x&&(x=u)}else if(p>0){if(u>x)return;u>s&&(s=u)}if(u=i-l,!(!p&&u<0)){if(u/=p,p<0){if(u>x)return;u>s&&(s=u)}else if(p>0){if(u<s)return;u<x&&(x=u)}if(u=n-c,!(!h&&u>0)){if(u/=h,h<0){if(u<s)return;u<x&&(x=u)}else if(h>0){if(u>x)return;u>s&&(s=u)}if(u=o-c,!(!h&&u<0)){if(u/=h,h<0){if(u>x)return;u>s&&(s=u)}else if(h>0){if(u<s)return;u<x&&(x=u)}return s>0&&(e[0]=l+s*p,e[1]=c+s*h),x<1&&(a[0]=l+x*p,a[1]=c+x*h),!0}}}}}var Ct=1e9,Gt=-Ct;function Ts(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,p){var h=0,u=0;if(f==null||(h=l(f,x))!==(u=l(s,x))||d(f,s)<0^x>0)do p.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+x+4)%4)!==u);else p.point(s[0],s[1])}function l(f,s){return ve(f[0]-e)<he?s>0?0:3:ve(f[0]-r)<he?s>0?2:1:ve(f[1]-a)<he?s>0?1:0:s>0?3:2}function c(f,s){return d(f.x,s.x)}function d(f,s){var x=l(f,1),p=l(s,1);return x!==p?x-p:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=Nr(),p,h,u,b,v,g,N,E,y,T,q,L={point:S,lineStart:D,lineEnd:A,polygonStart:j,polygonEnd:M};function S(w,O){i(w,O)&&s.point(w,O)}function z(){for(var w=0,O=0,G=h.length;O<G;++O)for(var H=h[O],_=1,ne=H.length,te=H[0],ee,re,I=te[0],X=te[1];_<ne;++_)ee=I,re=X,te=H[_],I=te[0],X=te[1],re<=n?X>n&&(I-ee)*(n-re)>(X-re)*(e-ee)&&++w:X<=n&&(I-ee)*(n-re)<(X-re)*(e-ee)&&--w;return w}function j(){s=x,p=[],h=[],q=!0}function M(){var w=z(),O=q&&w,G=(p=jr(p)).length;(O||G)&&(f.polygonStart(),O&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),G&&Sr(p,c,w,o,f),f.polygonEnd()),s=f,p=h=u=null}function D(){L.point=R,h&&h.push(u=[]),T=!0,y=!1,N=E=NaN}function A(){p&&(R(b,v),g&&y&&x.rejoin(),p.push(x.result())),L.point=S,y&&s.lineEnd()}function R(w,O){var G=i(w,O);if(h&&u.push([w,O]),T)b=w,v=O,g=G,T=!1,G&&(s.lineStart(),s.point(w,O));else if(G&&y)s.point(w,O);else{var H=[N=Math.max(Gt,Math.min(Ct,N)),E=Math.max(Gt,Math.min(Ct,E))],_=[w=Math.max(Gt,Math.min(Ct,w)),O=Math.max(Gt,Math.min(Ct,O))];As(H,_,e,a,r,n)?(y||(s.lineStart(),s.point(H[0],H[1])),s.point(_[0],_[1]),G||s.lineEnd(),q=!1):G&&(s.lineStart(),s.point(w,O),q=!1)}N=w,E=O,y=G}return L}}const Ra=e=>e;var ya=new ct,Oa=new ct,Cr,zr,Fa,Pa,tt={point:He,lineStart:He,lineEnd:He,polygonStart:function(){tt.lineStart=qs,tt.lineEnd=Ms},polygonEnd:function(){tt.lineStart=tt.lineEnd=tt.point=He,ya.add(ve(Oa)),Oa=new ct},result:function(){var e=ya/2;return ya=new ct,e}};function qs(){tt.point=Ls}function Ls(e,a){tt.point=Ar,Cr=Fa=e,zr=Pa=a}function Ar(e,a){Oa.add(Pa*e-Fa*a),Fa=e,Pa=a}function Ms(){Ar(Cr,zr)}var wt=1/0,ra=wt,Ot=-wt,oa=Ot,ia={point:Rs,lineStart:He,lineEnd:He,polygonStart:He,polygonEnd:He,result:function(){var e=[[wt,ra],[Ot,oa]];return Ot=oa=-(ra=wt=1/0),e}};function Rs(e,a){e<wt&&(wt=e),e>Ot&&(Ot=e),a<ra&&(ra=a),a>oa&&(oa=a)}var Da=0,Ia=0,zt=0,sa=0,la=0,ht=0,$a=0,Ba=0,At=0,Tr,qr,Je,Xe,_e={point:dt,lineStart:Bn,lineEnd:_n,polygonStart:function(){_e.lineStart=Ps,_e.lineEnd=Ds},polygonEnd:function(){_e.point=dt,_e.lineStart=Bn,_e.lineEnd=_n},result:function(){var e=At?[$a/At,Ba/At]:ht?[sa/ht,la/ht]:zt?[Da/zt,Ia/zt]:[NaN,NaN];return Da=Ia=zt=sa=la=ht=$a=Ba=At=0,e}};function dt(e,a){Da+=e,Ia+=a,++zt}function Bn(){_e.point=Os}function Os(e,a){_e.point=Fs,dt(Je=e,Xe=a)}function Fs(e,a){var r=e-Je,n=a-Xe,i=ut(r*r+n*n);sa+=i*(Je+e)/2,la+=i*(Xe+a)/2,ht+=i,dt(Je=e,Xe=a)}function _n(){_e.point=dt}function Ps(){_e.point=Is}function Ds(){Lr(Tr,qr)}function Is(e,a){_e.point=Lr,dt(Tr=Je=e,qr=Xe=a)}function Lr(e,a){var r=e-Je,n=a-Xe,i=ut(r*r+n*n);sa+=i*(Je+e)/2,la+=i*(Xe+a)/2,ht+=i,i=Xe*e-Je*a,$a+=i*(Je+e),Ba+=i*(Xe+a),At+=i*3,dt(Je=e,Xe=a)}function Mr(e){this._context=e}Mr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,We);break}}},result:He};var _a=new ct,wa,Rr,Or,Tt,qt,Ft={point:He,lineStart:function(){Ft.point=$s},lineEnd:function(){wa&&Fr(Rr,Or),Ft.point=He},polygonStart:function(){wa=!0},polygonEnd:function(){wa=null},result:function(){var e=+_a;return _a=new ct,e}};function $s(e,a){Ft.point=Fr,Rr=Tt=e,Or=qt=a}function Fr(e,a){Tt-=e,qt-=a,_a.add(ut(Tt*Tt+qt*qt)),Tt=e,qt=a}let Un,ca,Hn,Vn;class Wn{constructor(a){this._append=a==null?Pr:Bs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Hn||this._append!==ca){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Hn=n,ca=this._append,Vn=this._,this._=i}this._+=Vn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Pr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Bs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Pr;if(a!==Un){const r=10**a;Un=a,ca=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ca}function _s(e,a){let r=3,n=4.5,i,o;function l(c){return c&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),xt(c,i(o))),o.result()}return l.area=function(c){return xt(c,i(tt)),tt.result()},l.measure=function(c){return xt(c,i(Ft)),Ft.result()},l.bounds=function(c){return xt(c,i(ia)),ia.result()},l.centroid=function(c){return xt(c,i(_e)),_e.result()},l.projection=function(c){return arguments.length?(i=c==null?(e=null,Ra):(e=c).stream,l):e},l.context=function(c){return arguments.length?(o=c==null?(a=null,new Wn(r)):new Mr(a=c),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(c){return arguments.length?(n=typeof c=="function"?c:(o.pointRadius(+c),+c),l):n},l.digits=function(c){if(!arguments.length)return r;if(c==null)r=null;else{const d=Math.floor(c);if(!(d>=0))throw new RangeError(`invalid digits: ${c}`);r=d}return a===null&&(o=new Wn(r)),l},l.projection(e).digits(r).context(a)}function Za(e){return function(a){var r=new Ua;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Ua(){}Ua.prototype={constructor:Ua,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function en(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),xt(r,e.stream(ia)),a(ia.result()),n!=null&&e.clipExtent(n),e}function Dr(e,a,r){return en(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),c=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([c,d])},r)}function Us(e,a,r){return Dr(e,[[0,0],a],r)}function Hs(e,a,r){return en(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,c=-o*n[0][1];e.scale(150*o).translate([l,c])},r)}function Vs(e,a,r){return en(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],c=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,c])},r)}var Yn=16,Ws=Se(30*Pe);function Gn(e,a){return+a?Gs(e,a):Ys(e)}function Ys(e){return Za({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Gs(e,a){function r(n,i,o,l,c,d,f,s,x,p,h,u,b,v){var g=f-n,N=s-i,E=g*g+N*N;if(E>4*a&&b--){var y=l+p,T=c+h,q=d+u,L=ut(y*y+T*T+q*q),S=Rt(q/=L),z=ve(ve(q)-1)<he||ve(o-x)<he?(o+x)/2:Mt(T,y),j=e(z,S),M=j[0],D=j[1],A=M-n,R=D-i,w=N*A-g*R;(w*w/E>a||ve((g*A+N*R)/E-.5)>.3||l*p+c*h+d*u<Ws)&&(r(n,i,o,l,c,d,M,D,z,y/=L,T/=L,q,b,v),v.point(M,D),r(M,D,z,y,T,q,f,s,x,p,h,u,b,v))}}return function(n){var i,o,l,c,d,f,s,x,p,h,u,b,v={point:g,lineStart:N,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=T},polygonEnd:function(){n.polygonEnd(),v.lineStart=N}};function g(S,z){S=e(S,z),n.point(S[0],S[1])}function N(){x=NaN,v.point=E,n.lineStart()}function E(S,z){var j=yt([S,z]),M=e(S,z);r(x,p,s,h,u,b,x=M[0],p=M[1],s=S,h=j[0],u=j[1],b=j[2],Yn,n),n.point(x,p)}function y(){v.point=g,n.lineEnd()}function T(){N(),v.point=q,v.lineEnd=L}function q(S,z){E(i=S,z),o=x,l=p,c=h,d=u,f=b,v.point=E}function L(){r(x,p,s,h,u,b,o,l,i,c,d,f,Yn,n),v.lineEnd=y,y()}return v}}var Ks=Za({point:function(e,a){this.stream.point(e*Pe,a*Pe)}});function Qs(e){return Za({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Js(e,a,r,n,i){function o(l,c){return l*=n,c*=i,[a+e*l,r-e*c]}return o.invert=function(l,c){return[(l-a)/e*n,(r-c)/e*i]},o}function Kn(e,a,r,n,i,o){if(!o)return Js(e,a,r,n,i);var l=Se(o),c=Ee(o),d=l*e,f=c*e,s=l/e,x=c/e,p=(c*r-l*a)/e,h=(c*a+l*r)/e;function u(b,v){return b*=n,v*=i,[d*b-f*v+a,r-f*b-d*v]}return u.invert=function(b,v){return[n*(s*b-x*v+p),i*(h-x*b-s*v)]},u}function Xs(e){return Zs(function(){return e})()}function Zs(e){var a,r=150,n=480,i=250,o=0,l=0,c=0,d=0,f=0,s,x=0,p=1,h=1,u=null,b=$n,v=null,g,N,E,y=Ra,T=.5,q,L,S,z,j;function M(w){return S(w[0]*Pe,w[1]*Pe)}function D(w){return w=S.invert(w[0],w[1]),w&&[w[0]*et,w[1]*et]}M.stream=function(w){return z&&j===w?z:z=Ks(Qs(s)(b(q(y(j=w)))))},M.preclip=function(w){return arguments.length?(b=w,u=void 0,R()):b},M.postclip=function(w){return arguments.length?(y=w,v=g=N=E=null,R()):y},M.clipAngle=function(w){return arguments.length?(b=+w?zs(u=w*Pe):(u=null,$n),R()):u*et},M.clipExtent=function(w){return arguments.length?(y=w==null?(v=g=N=E=null,Ra):Ts(v=+w[0][0],g=+w[0][1],N=+w[1][0],E=+w[1][1]),R()):v==null?null:[[v,g],[N,E]]},M.scale=function(w){return arguments.length?(r=+w,A()):r},M.translate=function(w){return arguments.length?(n=+w[0],i=+w[1],A()):[n,i]},M.center=function(w){return arguments.length?(o=w[0]%360*Pe,l=w[1]%360*Pe,A()):[o*et,l*et]},M.rotate=function(w){return arguments.length?(c=w[0]%360*Pe,d=w[1]%360*Pe,f=w.length>2?w[2]%360*Pe:0,A()):[c*et,d*et,f*et]},M.angle=function(w){return arguments.length?(x=w%360*Pe,A()):x*et},M.reflectX=function(w){return arguments.length?(p=w?-1:1,A()):p<0},M.reflectY=function(w){return arguments.length?(h=w?-1:1,A()):h<0},M.precision=function(w){return arguments.length?(q=Gn(L,T=w*w),R()):ut(T)},M.fitExtent=function(w,O){return Dr(M,w,O)},M.fitSize=function(w,O){return Us(M,w,O)},M.fitWidth=function(w,O){return Hs(M,w,O)},M.fitHeight=function(w,O){return Vs(M,w,O)};function A(){var w=Kn(r,0,0,p,h,x).apply(null,a(o,l)),O=Kn(r,n-w[0],i-w[1],p,h,x);return s=ys(c,d,f),L=La(a,O),S=La(s,L),q=Gn(L,T),R()}function R(){return z=j=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&D,A()}}function Ir(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Ir.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ve(i)>he&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function el(){return Xs(Ir).scale(175.295)}function tl(e){return e}function al(e){if(e==null)return tl;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(c,d){d||(a=r=0);var f=2,s=c.length,x=new Array(s);for(x[0]=(a+=c[0])*n+o,x[1]=(r+=c[1])*i+l;f<s;)x[f]=c[f],++f;return x}}function nl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function rl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Qn(e,r)})}:Qn(e,a)}function Qn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ol(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ol(e,a){var r=al(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var p=n[s<0?~s:s],h=0,u=p.length;h<u;++h)x.push(r(p[h],h));s<0&&nl(x,u)}function o(s){return r(s)}function l(s){for(var x=[],p=0,h=s.length;p<h;++p)i(s[p],x);return x.length<2&&x.push(x[0]),x}function c(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function d(s){return s.map(c)}function f(s){var x=s.type,p;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":p=o(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(o);break;case"LineString":p=l(s.arcs);break;case"MultiLineString":p=s.arcs.map(l);break;case"Polygon":p=d(s.arcs);break;case"MultiPolygon":p=s.arcs.map(d);break;default:return null}return{type:x,coordinates:p}}return f(a)}const $r={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},il=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function sl(e,a,r){const n=$r[e];if(!n||!n.length)return-1;const i=il(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Kt=null;function ll(){return Kt||(Kt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=rl(r,n),o=el().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=_s(o),c=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var h;const x=((h=s.properties)==null?void 0:h.name)||"",p=l(s)||"";return p?{i2:Oo(x)||null,n:x,d:p}:null}).filter(s=>!!s);if(!c.length)return null;const d={};for(const[s,x]of Object.entries(Fo)){const p=o(x);p&&(d[s]={x:p[0],y:p[1]})}const f={};for(const[s,x]of Object.entries($r)){const p=x.map(h=>o(h.ll)).filter(h=>!!h).map(([h,u])=>({x:h,y:u}));p.length&&(f[s]=p)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:c,anchors:d,metros:f}}catch{return null}})(),Kt)}function cl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return ll().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const dl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Jn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Xn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function pl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const d=(f=e.current)==null?void 0:f.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(l)};l();const c=new ResizeObserver(()=>l());return e.current&&c.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),c.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Zn({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function ul(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:c,t:d,data:f,dossiers:s,source:x}=$(),p=f.loading&&!s.length,h=m.useRef(null),u=m.useRef(null),b=cl(e.continent==="monde"),v=e.continent==="monde"?b:Ya.find(w=>w.key===e.continent)||null,g=pl(h,e.continent+":"+e.mapFolded+":"+!!v),[N,E]=m.useState(new Map),[y,T]=m.useState(null);m.useEffect(()=>{const w=h.current;if(!w)return;const O=new Map;w.querySelectorAll("path[data-i2]").forEach(G=>{const H=G.dataset.i2;if(H)try{const _=G.getBBox();_.width>0&&O.set(H,{x:_.x,y:_.y,w:_.width,h:_.height})}catch{}}),E(O)},[e.continent,g,v]);const q=m.useMemo(()=>r.filter(w=>w.cc),[r]),L=m.useMemo(()=>{const w=new Map;return q.forEach(O=>w.set(O.cc,(w.get(O.cc)||0)+1)),w},[q]),S=e.continent==="monde"&&b?b.anchors:null,z=e.continent==="monde"&&b?b.metros:null,j=m.useMemo(()=>q.map(w=>{const O=Xn(w.name||w.id||""),G=Xn((w.id||w.name||"")+"·y");if(S&&w.cc){const ee=z?z[w.cc]:void 0;if(ee&&ee.length){const I=sl(w.cc,w.city,O);if(I>=0&&ee[I])return{d:w,x:ee[I].x+(O-.5)*5,y:ee[I].y+(G-.5)*5}}const re=S[w.cc];if(re)return{d:w,x:re.x+(O-.5)*10,y:re.y+(G-.5)*10}}const H=w.cc?N.get(w.cc):void 0;if(!H)return null;const _=dl[`${e.continent}:${w.cc||""}`];if(_)return{d:w,x:H.x+H.w*(_.fx+(O-.5)*_.sx),y:H.y+H.h*(_.fy+(G-.5)*_.sy)};const ne=(O-.5)*Math.min(H.w*.55,60),te=(G-.5)*Math.min(H.h*.55,60);return{d:w,x:H.x+H.w/2+ne,y:H.y+H.h/2+te}}).filter(w=>!!w),[q,N,S,z,e.continent]),M=w=>g>0?w/g:w,D=m.useMemo(()=>n?[0,1,2,3,4,5].map(w=>({c:Jn[w],fr:d.plabels[w].toUpperCase(),en:d.plabels[w].toUpperCase(),n:r.filter(O=>O.kind==="target"&&Ce(O)===w).length})).filter(w=>w.n>0):hn.map((w,O)=>({...w,n:r.filter(G=>gn(G)===O).length})),[r,n,d.plabels]),A=o?l.get(o):null,R=A?j.find(w=>w.d.id===A.id):null;return v?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:[p&&t.jsx(Zn,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:h,viewBox:v.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":c==="fr"?v.fr:v.en,onMouseLeave:()=>{T(null),i(null)},children:[t.jsx("g",{children:v.countries.map((w,O)=>t.jsx("g",{className:"ct"+(w.i2&&L.get(w.i2)?"":" empty"),children:t.jsx("path",{d:w.d,"data-i2":w.i2||void 0})},O))}),t.jsx("g",{children:j.map(w=>{const O=hn[gn(w.d)],G=!!ze(w.d),H=w.d.kind==="target",_=n&&H?Jn[Ce(w.d)]:O.c,ne=!n&&Re(w.d);return t.jsxs("g",{className:"co"+(ne?" done":""),onMouseEnter:()=>{var re,I;const te=(re=u.current)==null?void 0:re.getBoundingClientRect(),ee=(I=h.current)==null?void 0:I.createSVGPoint();if(ee&&h.current&&te){ee.x=w.x,ee.y=w.y;const X=ee.matrixTransform(h.current.getScreenCTM());T({x:X.x-te.left,y:X.y-te.top,label:w.d.name+" · "+(Nt(w.d.cc,c)||w.d.countryLabel||"")})}i(w.d.id)},onMouseLeave:()=>{T(null),i(null)},onClick:()=>{var re;if(x==="ops"){a({type:"focus",id:w.d.id}),w.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:w.d.name}}));return}const te=(re=h.current)==null?void 0:re.createSVGPoint();let ee=null;if(te&&h.current){te.x=w.x,te.y=w.y;const I=te.matrixTransform(h.current.getScreenCTM());ee={x:I.x,y:I.y}}a({type:"popup",id:w.d.id,anchor:ee})},children:[t.jsx("circle",{className:"h",cx:w.x,cy:w.y,r:M(Math.max(11,O.px+7))}),t.jsx("circle",{className:"v",cx:w.x,cy:w.y,r:M(O.px),fill:_,stroke:G?"#DC2626":"#ffffff",strokeWidth:M(G?2.2:1.3)})]},w.d.id||w.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:D.map((w,O)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":w.c}}),c==="fr"?w.fr:w.en," ",t.jsx("b",{children:w.n})]},O))}),r.some(w=>!w.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(w=>!w.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:t.jsx(Zn,{msgs:d.loadMsgs})})}function ml(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Br({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:c}=$(),d=a.filters,[f,s]=m.useState(!1),x=m.useRef(null),p=m.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),h=S=>p.filter(z=>S!=="country"&&d.country.length&&!d.country.includes(z.cc||"")?!1:ea(z,d,o,S==="country"?void 0:S)),u=m.useMemo(()=>{const S=h("win"),z=j=>S.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=j).length;return[z(0),z(7),z(30),S.length]},[p,d,o]),b=m.useMemo(()=>d.day?h("win").filter(S=>(S.date||"").slice(0,10)===d.day).length:0,[p,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,g=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f)return;const S=j=>{var M;(M=x.current)!=null&&M.contains(j.target)||s(!1)},z=j=>{j.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",S),document.addEventListener("keydown",z),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",z)}},[f]);const N=(S,z,j,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:z}),j>0&&t.jsx("span",{className:"n",children:j}),t.jsx("span",{className:"cv",children:"▾"})]},S),E=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(ml(d.day,c))}),t.jsx("b",{children:b})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((S,z)=>t.jsxs("button",{type:"button","aria-pressed":d.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:i.dates[z]}),t.jsx("b",{children:u[z]})]},S))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),T=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,d.sector.length),N("pay",i.fCountry,d.country.length),N("det",i.fEngine,d.engine.length),N("sta",i.fStage,d.stage.length),o&&N("ang","Angle",d.angle.length),o&&N("mem","Mémo",d.memoLevel.length)]}),q=(S=!1)=>t.jsxs("div",{className:"frow2",children:[g>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(p.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(g)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),S&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:x,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:T})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[!d.day&&t.jsx("div",{className:"fstrip-a",children:E}),t.jsxs("div",{className:"fstrip-b",children:[y,L,q(!0)]})]}),a.openFacet&&t.jsx(er,{poolFor:h})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[E,y,T,t.jsx("span",{className:"fgrow"}),q()]}),a.openFacet&&t.jsx(er,{poolFor:h})]})}function er({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=a.filters,l=a.openFacet,{title:c,cols:d,options:f}=m.useMemo(()=>{if(l==="sig"){const u=e("signal").filter(g=>ze(g)),b=new Map;u.forEach(g=>{const N=g.engine||"";b.set(N,(b.get(N)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:u.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Sa([...b.keys()],i).map(g=>({v:g,label:lt(g)+" "+Ve(g,i),n:b.get(g)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(g)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const u=e("sector"),b=new Map;return u.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:v,n:g,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const u=e("country"),b=new Map;return u.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:Nt(v,i)||v,n:g,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const u=e("engine"),b=new Map;return u.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Sa([...b.keys()],i).map(v=>({v,label:lt(v)+" "+Ve(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Po(Do(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const u=e("angle"),b=new Map;return u.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:v.replace(/[_-]+/g," "),n:g,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const u=e("memoLevel"),b=new Map;u.forEach(g=>{if(g.kind==="target"){const N=Va(g);b.set(N,(b.get(N)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(g=>({v:String(g),label:v[g],n:b.get(g)||0,html:!1,on:o.memoLevel.includes(g)}))}}const p=e("stage"),h=new Map;return p.forEach(u=>{u.stage&&h.set(u.stage,(h.get(u.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((u,b)=>b[1]-u[1]).map(([u,b])=>({v:u,label:u,n:b,html:!1,on:o.stage.includes(u)}))}},[l,a,i]),s=p=>{if(l==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const u=o.signalEngines.includes(p)?o.signalEngines.filter(b=>b!==p):[...o.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:u}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:p})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:c}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:f.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function _r({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:c}=$(),d=m.useMemo(()=>{const h={};return r.forEach(u=>{ea(u,n.filters,o)&&(h.monde=(h.monde||0)+1,u.continent&&(h[u.continent]=(h[u.continent]||0)+1))}),h},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const h=b=>{var v;(v=x.current)!=null&&v.contains(b.target)||s(!1)},u=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",h),document.addEventListener("keydown",u),()=>{document.removeEventListener("mousedown",h),document.removeEventListener("keydown",u)}},[f]);const p=h=>{const u=Ya.find(b=>b.key===h);return h==="monde"?c.contWorld:l==="fr"?u.fr:u.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(h=>!h),children:[p(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:bn.map(h=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===h,onClick:()=>{i({type:"continent",key:h}),s(!1)},children:[p(h),t.jsx("span",{className:"n",children:d[h]||0})]},h))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})]}):t.jsxs("div",{className:"conts",children:[bn.map(h=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===h,onClick:()=>i({type:"continent",key:h}),children:[p(h),t.jsx("span",{className:"n",children:d[h]||0})]},h)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})})]})}function Ur(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function fl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function tr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:c}=$();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:c.rsEvalOne})]},d.name))})]}):null}function Hr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=$(),i=((e==null?void 0:e.companies_cited)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.what||"").trim(),line2:(c.role||"").trim(),chips:[(c.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.why||"").trim(),chips:[(c.country||"").trim(),(c.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(tr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(tr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function xl({card:e,onEvaluate:a,onAddAll:r}){var c,d,f;const{t:n}=$(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((c=e.prospective)==null?void 0:c.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ur(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(Hr,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function hl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function gl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=$(),c=i,[d,f]=m.useState(null),[s,x]=m.useState(null),[p,h]=m.useState(null),[u,b]=m.useState(!1);m.useEffect(()=>{let g=!0;return(async()=>{const N=await dr({email:l,cbToken:c});g&&f(N)})(),()=>{g=!1}},[l,c,n]);const v=g=>{x(g),h(null),b(!0),(async()=>{const N=await Io(g.id);h(N),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),h(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(g=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(g),children:[t.jsx("span",{className:"ti",children:g.title}),t.jsxs("span",{className:"me",children:[hl(g.created_at),g.industry?` · ${g.industry}`:"",g.author?` · ${g.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(g.cited_n||0,g.evaluate_n||0)}),t.jsx("span",{className:"st"+(g.published?" on":""),children:g.published?o.rsPub:o.rsPriv})]},g.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!u&&!p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!u&&p&&t.jsx(xl,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ka=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function bl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:c,evalCards:d,caps:f,data:s,canWrite:x,source:p,dossiers:h,doAnalyse:u,liveMemos:b,pipe:v}=$(),g=a==="client",N=m.useMemo(()=>r||(p!=="default"?$o():""),[r,p]),[E,y]=m.useState(""),[T,q]=m.useState(!1),[L,S]=m.useState(!1),[z,j]=m.useState(""),[M,D]=m.useState(!1),[A,R]=m.useState(""),[w,O]=m.useState([]),G=m.useRef(!1),[H,_]=m.useState(!1),[ne,te]=m.useState(""),[ee,re]=m.useState(""),[I,X]=m.useState(!1),[ce,Ae]=m.useState(0),[de,ke]=m.useState(""),[ae,V]=m.useState(null),[W,Q]=m.useState(null),[J,fe]=m.useState(!1),[pe,ye]=m.useState(null),[ue,we]=m.useState(0),De=m.useRef(!1),Ye=E.trim()?ka.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,C=m.useMemo(()=>z.split(`
