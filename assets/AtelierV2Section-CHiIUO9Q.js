...
.atl2 .bulk .side .hint{white-space:nowrap}`,la=`
...
`,ia=oa+la;function sa(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function da(t,a){return t||a.mode!=="client"||!a.token?"visiteur":sa("teaser")==="1"?"apercu":"client"}const pa={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0}},ca=t=>pa[t],ce=t=>Object.assign(t,{continent:qt(t.cc)});function Ae(t){const a=new Set,n=[];for(const r of t){const o=(r.name||"").toLowerCase();!o||a.has(o)||(a.add(o),n.push(r))}return n}const ua=60*60*1e3;function fa(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ua?null:a}catch{return null}}function Ne(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const xa=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function ma(t,a,n="default"){const r=n!=="default",o=f.useMemo(()=>t||r?{mode:"anon"}:Ft(),[t,r]),l=f.useMemo(()=>r?"visiteur":da(t,o),[t,o,r]),i=f.useMemo(()=>ca(l),[l]),p=l!=="visiteur",c=xa(n),[d,m]=f.useState([]),[s,y]=f.useState(""),[g,b]=f.useState(null),[k,x]=f.useState(null),[u,N]=f.useState(()=>new Map),[j,w]=f.useState(""),[z,R]=f.useState(new Set),[D,h]=f.useState(null),[C,S]=f.useState(!0),[M,F]=f.useState(!1),[P,A]=f.useState(0),[I,L]=f.useState(0),$=f.useRef(0),B=f.useMemo(()=>{var q;if(l!=="client")return"";try{return((q=Mt())==null?void 0:q.email)||""}catch{return""}},[l]);f.useEffect(()=>{const q=++$.current;let J=!0;const _=()=>J&&q===$.current,ne=(p&&o.token?o.token:"pub:"+a)+(c?":"+c:""),ee=fa(ne);return ee?(m(ee.objs.map(ce)),ee.fund&&y(ee.fund),b(ee.marketEstimate??null),x(ee.criteria??null),w(ee.generatedAt||""),S(!1)):S(!0),(async()=>{try{if(n==="ops"){const te=await Ee(),X=((te==null?void 0:te.recent_ops)||[]).map(K=>Te(K,a)).filter(K=>!!K);if(!_())return;m(X.map(ce)),Ne(ne,{objs:X})}else if(typeof n=="object"){const X=(await He()||[]).filter(G=>(G.slug||"")===n.research).map(G=>Ve(G,a)).filter(G=>!!G),K=Ae(await Ye(X,a));if(!_())return;m(K.map(ce)),Ne(ne,{objs:K})}else if(p&&o.token){const te=Ot(o.token),X=Ee(),K=Lt(o.token),G=Rt(o.token),U=await te;let Z=U?U.targets:[];_()&&U&&(y(U.fund||""),b(U.marketEstimate??null),x(U.criteria??null),w(U.generatedAt||""),m(Z.map(ce)),S(!1),F(!1));const[le,de,be]=await Promise.all([X,K,G]),ue=((le==null?void 0:le.recent_ops)||[]).map(ie=>Te(ie,a)).filter(ie=>!!ie);if(Z=[...Z,...ue],!_())return;m(Z.map(ce));const Q=new Set;for(const ie of de){const fe=(ie.id||ie.co||"").toString().trim().toLowerCase();fe&&Q.add(fe.startsWith("t:")?fe:"t:"+fe)}R(Q),N(be),U&&Ne(ne,{fund:U.fund,marketEstimate:U.marketEstimate,criteria:U.criteria,generatedAt:U.generatedAt,objs:Z})}else{const te=Dt(),X=He(),K=Ee(),G=await te;_()&&G.length&&(m(Ae(G).map(ce)),S(!1),F(!1));const[U,Z]=await Promise.all([X,K]),le=(U||[]).map(Q=>Ve(Q,a)).filter(Q=>!!Q),de=await Ye(le,a),be=((Z==null?void 0:Z.recent_ops)||[]).map(Q=>Te(Q,a)).filter(Q=>!!Q),ue=Ae([...G,...de,...be]);if(!_())return;m(ue.map(ce)),Ne(ne,{objs:ue})}_()&&F(!1)}catch{_()&&!ee&&F(!0)}finally{_()&&S(!1)}})(),()=>{J=!1}},[p,o.token,a,P,c]),f.useEffect(()=>{if(!i.showCredits||!B){h(null);return}let q=!0;return(async()=>{try{const J=await fetch(`${Oe}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:B})});if(!J.ok)return;const _=await J.json();q&&_&&_.ok!==!1&&h(_)}catch{}})(),()=>{q=!1}},[i.showCredits,B,I]);const H=f.useCallback(q=>R(new Set(q)),[]);return{session:o,mode:l,caps:i,fund:s,email:B,marketEstimate:g,generatedAt:j,criteria:k,thumbs:u,dossiers:d,favIds:z,setFavIds:H,credits:D,reloadCredits:()=>L(q=>q+1),loading:C,error:M,refresh:()=>A(q=>q+1)}}const mt=()=>({win:"all",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),ga=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...mt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function ha(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(o=>o!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(o=>o!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:mt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ce)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ce=60;function Be(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!Y(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(Le(t)))return!1;if(r!=="win"&&a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(me(t.date)>o)return!1}if(r!=="status"&&!n&&a.status!=="all"&&se(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(o))return!1}return!0}function gt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:Be(t,a.filters,n)}function ba(t,a,n,r){return!(!gt(t,a,n)||n&&!It(t,a.ptab,r))}function Pe(t,a){const n=a.key,r=o=>{switch(n){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-me(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const l=Y(o);return l?100-(l.left??0):-1}}};return[...t].sort((o,l)=>{const i=r(o),p=r(l);return i<p?-a.dir:i>p?a.dir:(o.name||"").localeCompare(l.name||"")})}function va(){const{dossiers:t,st:a,t:n,dispatch:r,contName:o,pipe:l}=E(),i=f.useMemo(()=>{const c=s=>l?!0:s.continent===a.continent,d=t.filter(s=>c(s)&&Y(s)),m=t.filter(s=>c(s)&&s.kind==="op"&&!Y(s)&&(s.dealKind==="ma"||s.dealKind==="levee")&&me(s.date)<=2);return m.sort((s,y)=>(y.amountEur||0)-(s.amountEur||0)),[...Pe(d,{key:"signal",dir:-1}),...m].slice(0,40)},[t,a.continent,l]),p=c=>i.map(d=>e.jsxs("button",{type:"button",className:"tk"+(W(d)?" spent":""),onClick:m=>{const s=m.currentTarget.getBoundingClientRect();r({type:"popup",id:d.id,anchor:{x:s.left+s.width/2,y:s.bottom}})},title:d.name+(d.tagline?" — "+d.tagline:""),children:[e.jsx(he,{o:d}),e.jsxs("span",{className:"who",children:[e.jsx(yt,{o:d}),e.jsx("span",{className:"co",children:d.name})]}),typeof d.amountEur=="number"&&d.amountEur>0&&e.jsx("span",{className:"am",children:fr(d.amountEur)}),d.sector&&e.jsx("span",{className:"mt",children:d.sector}),e.jsx(Se,{o:d}),e.jsx("span",{className:"tkgo",children:"→"})]},c+(d.id||d.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:i.length})]}),e.jsx("div",{className:"win",children:i.length?e.jsxs("div",{className:"run",children:[p(0),p(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(o)})})})]})}const ya="aDx8z7Hzksus",ht="+33 6 83 10 72 86",tt="alexandre@proplace.co",wa=`tel:${ht.replace(/[^\d+]/g,"")}`,at="pp-rdv-slot";function ka(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ja(){const{t,caps:a,fund:n}=E(),r=a.showOnb,o=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:`pp-rdv${r?" is-teaser":""}`,children:[e.jsx("style",{children:Ca}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:wa,children:ht}),t.rdvSubMid,e.jsx("a",{href:`mailto:${tt}`,children:tt})]}),r&&e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(o).map(([l,i],p)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(p+1)}),e.jsx("b",{children:l}),e.jsx("span",{children:i})]},l))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(ta,{filloutId:ya,parameters:n?{company_name:n}:void 0})})]})}function Na(){const[t,a]=f.useState(()=>typeof document>"u"?null:document.getElementById(at));return f.useEffect(()=>{t||a(document.getElementById(at))},[t]),t?ze.createPortal(e.jsx(ja,{}),t):null}const Ca=`
...
`;function za(){const{dossiers:t,pipe:a,t:n,st:r,dispatch:o}=E(),l=f.useMemo(()=>t.filter(s=>me(s.date)===0&&s.kind==="target"),[t]),i=f.useMemo(()=>l.filter(s=>a?ae(s)===0:!W(s)),[l,a]),p=l.length-i.length,c=l.length?Math.min(100,p/l.length*100):100;let d;a?d=n.morningThesis(l.length,p,i.length):l.length?p===0?d=n.goalSourced(l.length):p>=l.length?d=n.goalCleared:d=n.goalDone(p,l.length):d=n.goalSourced(0);const m=()=>{a?(o({type:"ptab",tab:0}),o({type:"filters",patch:{win:"1"}})):o({type:"pile",on:!0})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:d}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:c+"%"}})}),i.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:m,children:a?n.morningEval(i.length):r.pileMode?n.goalContinue(i.length):n.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Sa(){var C;const{t,st:a,dispatch:n,token:r,fund:o,data:l,dossiers:i,mode:p,doSync:c}=E(),[d,m]=f.useState(null),[s,y]=f.useState([]),[g,b]=f.useState(!1),k=p==="client";f.useEffect(()=>{if(!r||!o)return;let S=!0;return(async()=>{const[M,F]=await Promise.all([dt(o),pt(r)]);S&&(M&&m(M),y(F))})(),()=>{S=!1}},[r,o]);const x=(d==null?void 0:d.per_day)??null,u=((C=d==null?void 0:d.pool_order)==null?void 0:C.length)??0,N=s.filter(S=>S.status==="running").length,j=S=>{if(!k||x===null||g)return;const M=Math.max(0,Math.min(10,x+S));M!==x&&(b(!0),m(F=>F&&{...F,per_day:M}),ct(r,M).then(F=>{b(!1),m(F===null?P=>P&&{...P,per_day:x}:P=>P&&{...P,per_day:F})}))},w=f.useMemo(()=>i.filter(S=>S.kind==="target"&&W(S)).length,[i]),z=l.marketEstimate,R=z&&z>0?Math.min(100,Math.round(w/z*100)):null,D=(o||"P").split(/\s+/).map(S=>S[0]).join("").slice(0,2).toUpperCase(),h=(()=>{const S=Date.parse(l.generatedAt||"");if(Number.isNaN(S))return"";const M=new Date(S),F=P=>String(P).padStart(2,"0");return`${F(M.getDate())}/${F(M.getMonth()+1)} à ${F(M.getHours())}:${F(M.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:D}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),h&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(h)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.identTuto,onClick:()=>n({type:"modal",modal:"tuto"}),children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[R!==null&&z&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:R+"%"}})}),e.jsxs("b",{children:[R," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(w,z)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),x!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"mi",onClick:S=>{S.stopPropagation(),j(-1)},children:"−"}),e.jsx("b",{className:"q",children:x})," ",t.identPerDay,e.jsx("b",{className:"mi",onClick:S=>{S.stopPropagation(),j(1)},children:"+"})]}),e.jsx("span",{className:"edv"})]}),x===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),N>0&&e.jsxs("span",{className:"ev",children:["⏳ ",N]}),e.jsx("span",{className:"ego",children:t.identPending(u)})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!k,onClick:c,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:a.filters.search,onChange:S=>n({type:"filters",patch:{search:S.target.value}})})]})]})]})}function Ea(){const{t,counts:a,dispatch:n}=E();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,o],l)=>{const i=l===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(i?" go":""),children:[e.jsx("span",{className:"s4n",children:l+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:o}),i&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},l)})})]})}const Ta=["--p0","--p1","--p2","--p3","--p4"];function Aa(){const{st:t,dispatch:a,counts:n,t:r,doUndo:o}=E(),l=f.useRef({});f.useEffect(()=>{l.current={...n}},[n]);const i=d=>{const m=l.current[d],s=m!==void 0?n[d]-m:0;return e.jsxs("button",{type:"button",className:"step"+(d===3&&n[3]>0?" wait":""),style:{"--c":`var(${Ta[d]})`,"--tc":d<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===d,title:r.phelp[d],onClick:()=>a({type:"ptab",tab:d}),children:[e.jsxs("span",{className:"l",children:[r.plabels[d].toUpperCase(),d===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(s>0?" up":s<0?" down":""),children:[n[d],s!==0&&e.jsxs("em",{className:"delta",children:[s>0?"+":"−",Math.abs(s)]})]})]},d)},p=(d,m,s)=>e.jsxs("button",{type:"button",className:"off"+(m?" view":""),style:{"--c":d===5?"var(--p5)":d===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===d,title:r.phelp[d],onClick:()=>a({type:"ptab",tab:d}),children:[e.jsx("span",{className:"l",children:s.toUpperCase()}),e.jsx("span",{className:"n",children:n[d]})]},d),c=(d,m,s,y=!1)=>e.jsx("button",{type:"button",className:"tool",title:m,disabled:y,onClick:s,children:d},m);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(i)}),e.jsxs("div",{className:"offtrack",children:[p(5,!1,r.plabels[5]),p(7,!0,r.plabels[7]),p(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",r.toolUndo,o,t.undo.length===0),c("↺",r.toolReset,()=>{a({type:"reset"})}),c("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Fa=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Ma(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:o,doAnalyse:l,mode:i}=E(),p=f.useRef(null),[c,d]=f.useState(60);f.useEffect(()=>{let g=0;const b=()=>{var j;const k=p.current;if(!k)return;const x=(j=k.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!x)return;const u=x.getBoundingClientRect(),N=k.getBoundingClientRect();d(Math.max(20,Math.min(u.left+u.width/2-N.left,N.width-30)))};return g=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(g),window.removeEventListener("resize",b)}},[t.ptab]);const m=t.ptab;let s=n.tuto[m].p;if(m===3){const g=r.filter(x=>x.kind==="target"&&ae(x)===3),b=g.filter(x=>Fe(x)==="auto").length,k=g.filter(x=>Fe(x)==="cd").length;s=n.tutoPending(b,k,g.length)}const y=(()=>{if(i!=="client")return null;if(m===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(g=>g.id)})};if(m===1){const g=r.filter(b=>b.kind==="target"&&ae(b)===1&&!o.has(b.id)).slice(0,10);if(g.length)return{label:n.tuto[1].a,run:()=>g.forEach(b=>l(b))}}return null})();return e.jsxs("div",{ref:p,className:"tuto mini",style:{"--bg":Fa[m],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[m].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s}})]})}),y&&e.jsx("button",{type:"button",className:"tprim",onClick:y.run,children:y.label})]})}const rt=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function nt(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Oa(t,a){const[n,r]=f.useState(1);return f.useEffect(()=>{let o=!0,l=0;const i=()=>{var d;if(!o)return;const c=(d=t.current)==null?void 0:d.getScreenCTM();c&&c.a>0?r(c.a):l=requestAnimationFrame(i)};i();const p=new ResizeObserver(()=>i());return t.current&&p.observe(t.current),window.addEventListener("resize",i),()=>{o=!1,cancelAnimationFrame(l),p.disconnect(),window.removeEventListener("resize",i)}},[t,a]),n}function La(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:o,markedId:l,byId:i,lang:p,t:c}=E(),d=f.useRef(null),m=f.useRef(null),s=Re.find(h=>h.key===t.continent),y=Oa(d,t.continent+":"+t.mapFolded),[g,b]=f.useState(new Map),[k,x]=f.useState(null);f.useEffect(()=>{const h=d.current;if(!h)return;const C=new Map;h.querySelectorAll("path[data-i2]").forEach(S=>{const M=S.dataset.i2;if(M)try{const F=S.getBBox();F.width>0&&C.set(M,{x:F.x,y:F.y,w:F.width,h:F.height})}catch{}}),b(C)},[t.continent,y]);const u=f.useMemo(()=>n.filter(h=>h.cc),[n]),N=f.useMemo(()=>{const h=new Map;return u.forEach(C=>h.set(C.cc,(h.get(C.cc)||0)+1)),h},[u]),j=f.useMemo(()=>u.map(h=>{const C=h.cc?g.get(h.cc):void 0;if(!C)return null;const S=nt(h.name||h.id||""),M=nt((h.id||h.name||"")+"·y"),F=(S-.5)*Math.min(C.w*.55,60),P=(M-.5)*Math.min(C.h*.55,60);return{d:h,x:C.x+C.w/2+F,y:C.y+C.h/2+P}}).filter(h=>!!h),[u,g]),w=h=>y>0?h/y:h,z=f.useMemo(()=>r?[0,1,2,3,4,5].map(h=>({c:rt[h],fr:c.plabels[h].toUpperCase(),en:c.plabels[h].toUpperCase(),n:n.filter(C=>C.kind==="target"&&ae(C)===h).length})).filter(h=>h.n>0):Ge.map((h,C)=>({...h,n:n.filter(S=>We(S)===C).length})),[n,r,c.plabels]),R=l?i.get(l):null,D=R?j.find(h=>h.d.id===R.id):null;return e.jsxs("div",{className:"mapzone",ref:m,children:[e.jsxs("svg",{ref:d,viewBox:s.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":p==="fr"?s.fr:s.en,onMouseLeave:()=>{x(null),o(null)},children:[e.jsx("g",{children:s.countries.map((h,C)=>e.jsx("g",{className:"ct"+(h.i2&&N.get(h.i2)?"":" empty"),children:e.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},C))}),e.jsx("g",{children:j.map(h=>{const C=Ge[We(h.d)],S=!!Y(h.d),M=h.d.kind==="target",F=r&&M?rt[ae(h.d)]:C.c,P=!r&&W(h.d);return e.jsxs("g",{className:"co"+(P?" done":""),onMouseEnter:()=>{var L,$;const A=(L=m.current)==null?void 0:L.getBoundingClientRect(),I=($=d.current)==null?void 0:$.createSVGPoint();if(I&&d.current&&A){I.x=h.x,I.y=h.y;const B=I.matrixTransform(d.current.getScreenCTM());x({x:B.x-A.left,y:B.y-A.top,label:h.d.name+" · "+(ge(h.d.cc,p)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{x(null),o(null)},onClick:()=>{var L;const A=(L=d.current)==null?void 0:L.createSVGPoint();let I=null;if(A&&d.current){A.x=h.x,A.y=h.y;const $=A.matrixTransform(d.current.getScreenCTM());I={x:$.x,y:$.y}}a({type:"popup",id:h.d.id,anchor:I})},children:[e.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:w(Math.max(11,C.px+7))}),e.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:w(C.px),fill:F,stroke:S?"#DC2626":"#ffffff",strokeWidth:w(S?2.2:1.3)})]},h.d.id||h.d.name)})}),D&&e.jsx("circle",{className:"ring on",cx:D.x,cy:D.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),e.jsx("div",{className:"legend",children:z.map((h,C)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":h.c}}),p==="fr"?h.fr:h.en," ",e.jsx("b",{children:h.n})]},C))}),n.some(h=>!h.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:n.filter(h=>!h.cc).length})]})})]})}function Ra(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:o,contName:l}=E(),i=t.filters,p=f.useMemo(()=>n.filter(g=>g.continent===t.continent),[n,t.continent]),c=g=>p.filter(b=>g!=="country"&&i.country.length&&!i.country.includes(b.cc||"")?!1:Be(b,i,o,g==="country"?void 0:g)),d=f.useMemo(()=>{const g=c("win"),b=k=>g.filter(x=>(x.date?Math.max(0,Math.floor((Date.now()-Date.parse(x.date))/864e5)):9999)<=k).length;return[b(0),b(7),b(30),g.length]},[p,i,o]),m=f.useMemo(()=>{if(o)return null;const g=c("status"),b={all:g.length,todo:0,retenu:0,pending:0,ecarte:0};return g.forEach(k=>{b[se(k)]+=1}),b},[p,i,o]),s=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.win!=="all"?1:0)+(!o&&i.status!=="all"?1:0)+(i.search.trim()?1:0),y=(g,b,k,x="fbtn")=>e.jsxs("button",{type:"button",className:x,"aria-expanded":t.openFacet===g,onClick:()=>a({type:"openFacet",facet:g}),children:[e.jsx("span",{className:"fl",children:b}),k>0&&e.jsx("span",{className:"n",children:k}),e.jsx("span",{className:"cv",children:"▾"})]},g);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[e.jsx("div",{className:"seg",children:["1","7","30","all"].map((g,b)=>e.jsxs("button",{type:"button","aria-pressed":i.win===g,onClick:()=>a({type:"filters",patch:{win:g}}),children:[r.dates[b],e.jsx("b",{children:d[b]})]},g))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:i.search,onChange:g=>a({type:"filters",patch:{search:g.target.value}})})]}),!o&&m&&e.jsx("div",{className:"statusf",children:[["all",r.statusAll],["todo",r.statusTodo],["retenu",r.statusKeep],["pending",r.statusPending],["ecarte",r.statusDrop]].map(([g,b])=>e.jsxs("button",{type:"button","aria-pressed":i.status===g,onClick:()=>a({type:"filters",patch:{status:g}}),children:[b,e.jsx("b",{children:m[g]??0})]},g))}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),y("sec",r.fSector,i.sector.length),y("pay",r.fCountry,i.country.length),y("det",r.fEngine,i.engine.length),y("sta",r.fStage,i.stage.length),o&&y("ang","Angle",i.angle.length),o&&y("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),s>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(p.length,l),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(s)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(Da,{poolFor:c})]})}function Da({poolFor:t}){const{st:a,dispatch:n,t:r,lang:o}=E(),l=a.filters,i=a.openFacet,{title:p,cols:c,options:d}=f.useMemo(()=>{if(i==="sig"){const b=t("signal").filter(u=>Y(u)),k=new Map;b.forEach(u=>{const N=u.engine||"";k.set(N,(k.get(N)||0)+1)});const x=[{v:"*",label:r.fpSigAll,n:b.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...Ke([...k.keys()],o).map(u=>({v:u,label:xe(u)+" "+oe(u,o),n:k.get(u)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(u)}))];return{title:r.fpSigTitle,cols:2,options:x}}if(i==="sec"){const b=t("sector"),k=new Map;return b.forEach(x=>{x.sector&&k.set(x.sector,(k.get(x.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...k.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x,n:u,html:!1,on:l.sector.includes(x)}))}}if(i==="pay"){const b=t("country"),k=new Map;return b.forEach(x=>{x.cc&&k.set(x.cc,(k.get(x.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...k.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:ge(x,o)||x,n:u,html:!1,on:l.country.includes(x)}))}}if(i==="det"){const b=t("engine"),k=new Map;return b.forEach(x=>{x.engine&&k.set(x.engine,(k.get(x.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:Ke([...k.keys()],o).map(x=>({v:x,label:xe(x)+" "+oe(x,o)+' <span style="color:var(--dim);font-size:10px">· '+Bt(Pt(x),o)+"</span>",n:k.get(x)||0,html:!0,on:l.engine.includes(x)}))}}if(i==="ang"){const b=t("angle"),k=new Map;return b.forEach(x=>{x.angle&&k.set(x.angle,(k.get(x.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...k.entries()].sort((x,u)=>u[1]-x[1]).map(([x,u])=>({v:x,label:x.replace(/[_-]+/g," "),n:u,html:!1,on:l.angle.includes(x)}))}}if(i==="mem"){const b=t("memoLevel"),k=new Map;b.forEach(u=>{if(u.kind==="target"){const N=Le(u);k.set(N,(k.get(N)||0)+1)}});const x=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:x[u],n:k.get(u)||0,html:!1,on:l.memoLevel.includes(u)}))}}const y=t("stage"),g=new Map;return y.forEach(b=>{b.stage&&g.set(b.stage,(g.get(b.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...g.entries()].sort((b,k)=>k[1]-b[1]).map(([b,k])=>({v:b,label:b,n:k,html:!1,on:l.stage.includes(b)}))}},[i,a,o]),m=y=>{if(i==="sig"){if(y==="*")n({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const b=l.signalEngines.includes(y)?l.signalEngines.filter(k=>k!==y):[...l.signalEngines,y];n({type:"filters",patch:{signalOnly:!0,signalEngines:b}})}return}if(i==="mem"){n({type:"toggleMemoLevel",value:Number(y)});return}n({type:"toggleFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage",value:y})},s=()=>{n(i==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:i==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:i==="sec"?"sector":i==="pay"?"country":i==="det"?"engine":i==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:p}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:s,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:d.map(y=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":y.on,onClick:()=>m(y.v),children:[e.jsx("span",{className:"bx"}),y.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:y.label}}):e.jsx("span",{className:"l",children:y.label}),e.jsx("span",{className:"n",children:y.n})]},y.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const ot=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function qa(){const{t,mode:a,token:n,askEvaluate:r,sessTally:o,dispatch:l,evalBusy:i,evalCards:p,caps:c,data:d}=E(),m=a==="client",[s,y]=f.useState(""),[g,b]=f.useState(!1),[k,x]=f.useState(""),[u,N]=f.useState(!1),[j,w]=f.useState(""),[z,R]=f.useState([]),D=f.useRef(!1),h=s.trim()?ot.test(s.trim())?t.evalUrl:t.evalName:t.evalWaiting,C=f.useMemo(()=>k.split(`
`).map(A=>A.trim()).filter(Boolean).slice(0,15),[k]),S=z.length?z:p,M=d.credits,F=()=>{const A=s.trim();A&&(r(null,A),y(""))},P=async()=>{if(!m){r(null,C[0]||"");return}if(!C.length||u)return;N(!0),D.current=!1;const A=[];for(let I=0;I<C.length&&!D.current;I++){w(t.evaluating(I+1,C.length,C[I]));const L=await ut(n,C[I],"atelier2");if(A.unshift({name:L.company||C[I],verdict:L.verdict,reason:L.reason||"",remaining:L.remaining??null}),R([...A]),L.verdict==="quota"){A.unshift({name:"",verdict:"quota",reason:t.quota(C.length-I-1),remaining:0}),R([...A]);break}}w(""),x(""),N(!1)};return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:s,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:A=>y(A.target.value),onKeyDown:A=>{A.key==="Enter"&&F()}}),e.jsx("span",{className:"detect"+(ot.test(s.trim())?" url":""),children:h})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:F,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),c.showCredits&&M&&e.jsxs("button",{type:"button",className:"credits"+(M.total_available<=0&&!M.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:M.unlimited?"∞":M.total_available}),!M.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",M.daily_grant+M.purchased]}),M.total_available<=0&&!M.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsx("div",{className:"dunder",children:e.jsx("button",{type:"button",className:"dmulti",onClick:()=>b(!g),children:t.evalMulti})}),g&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:k,placeholder:t.bulkPh,onChange:A=>x(A.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!C.length,onClick:()=>{P()},children:[e.jsx("span",{className:"fill"}),u&&j?j:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(C.length)})]})]}),S.slice(0,1).map((A,I)=>{const L=A.verdict==="kept",$=A.verdict==="quota",B=L?"var(--brand)":$?"var(--bolt)":"var(--red)",H=L?"var(--brand-l)":$?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":B,"--bgc":H},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:L?"✓ "+t.kept:$?"⏳":"✗ "+t.dropped})}),A.name&&e.jsx("span",{className:"rn",children:A.name}),e.jsx("span",{className:"rr",children:A.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",A.reason]}):null}),!$&&e.jsx("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"space"}),children:t.seeSpace(L?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},I)}),m&&(o.kept+o.dropped>0||S.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(o.kept,o.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function Ia(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ba(){const{st:t,dispatch:a,byId:n,t:r,doDeep:o}=E(),l=t.memoConsole?n.get(t.memoConsole):null,i=f.useMemo(()=>l?[l.reasoning||"",Ia(l.summary||"")].filter(Boolean).join(`

`):"",[l]);if(!l)return null;const p=De(l),c=Le(l);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:l.name}),p&&e.jsx("span",{className:"vv",children:p}),typeof l.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[l.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:i?i.split(`

`).map((d,m)=>e.jsx("p",{style:{margin:"0 0 10px"},children:d},m)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[qe(l)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>o(l),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:c===2?r.critMemoKinds:""}),l.memoUrl&&e.jsx("a",{className:"go",href:l.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const bt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function $e({o:t}){const{t:a}=E(),n=Me(t),r=De(t),o=ae(t),l=Fe(t),i=$t(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(bt[r]||"v-cons"),title:a.vt[r],children:r}):o===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,o===3&&l==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),o===3&&l==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),o===3&&i!==null&&e.jsx("span",{className:"wait2 "+(i>10?"hot":i>=5?"warm":""),title:a.waitTitle(i),children:a.waitChip(i)})]})}function lt({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:o}=E(),[l,i]=f.useState(!1);if(f.useEffect(()=>{r||i(!1)},[r]),W(t)){const d=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":d?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[d?"✓":"✗"," ",e.jsx("b",{children:d?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const c=l&&r;return e.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:r,onClick:d=>{d.stopPropagation(),i(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function Pa({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:o,doAnalyse:l,doDecide:i,doPromote:p,doRepeche:c,doApproach:d,dispatch:m}=E();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:g=>{g.stopPropagation(),m({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(lt,{o:t})});const s=ae(t),y=g=>b=>{b.stopPropagation(),g()};if(s===0)return e.jsx("span",{className:"cell",children:e.jsx(lt,{o:t})});if(s===1){const g=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:g,onClick:y(()=>l(t)),children:g?a.actAnalyseQueued:a.actAnalyse})})}if(s===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:y(()=>i(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:y(()=>i(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:y(()=>m({type:"memoConsole",id:t.id})),children:"📄"})]})});if(s===4){const g=o.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:g,onClick:y(()=>d(t)),children:g?a.actApproachSent:a.actApproach})})}return s===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:y(()=>p(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:y(()=>m({type:"memoConsole",id:t.id})),children:"📄"})]})}):s===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:y(()=>c(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:y(()=>m({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:y(()=>m({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function $a({o:t}){const{t:a,doThumb:n,thumbOf:r}=E(),o=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:l=>{l.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:l=>{l.stopPropagation(),n(t,!1)},children:"👎"})]})}function _a({o:t}){const{lang:a}=E();return Y(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(he,{o:t}),e.jsx(Se,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[xe(t.engine||"")," ",oe(t.engine||"",a)]})})}function Ua({o:t,locked:a,open:n,onToggle:r}){const{st:o,dispatch:l,caps:i,markRow:p,markedId:c,favIds:d,toggleFav:m}=E(),s=ae(t),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],g=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,b=g<=0?0:g<=7?1:g<=30?2:3,k=i.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][s]:y[b],x=d.has(t.id),u=N=>{if(a)return;if(i.pipe){r();return}const j=N.currentTarget.getBoundingClientRect();l({type:"popup",id:t.id,anchor:{x:j.left+Math.min(280,j.width/3),y:j.bottom}})};return e.jsxs(f.Fragment,{children:[e.jsxs("div",{className:"row"+(c===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>p(t.id),onMouseLeave:()=>p(null),onClick:u,children:[e.jsx("span",{className:"pt",style:{"--c":k}}),e.jsx(yt,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[i.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:x?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),m(t)},children:x?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(N=>N&&N!==t.name)||""})]}),e.jsx(Ha,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(_a,{o:t}),i.pipe&&e.jsx($e,{o:t}),i.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(Pa,{o:t}),i.showThumbs&&e.jsx($a,{o:t})]}),(n||o.dens==="deplie")&&!a&&e.jsx(Va,{o:t})]})}function Ha({o:t}){const{lang:a,caps:n}=E();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=Ie(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function Va({o:t}){const{t:a,lang:n,dispatch:r,caps:o,outbound:l,doOnboard:i}=E();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),t.reasoning&&e.jsxs("div",{className:"dec"+(Me(t)==="NO MATCH"?" out":""),title:t.reasoning,children:[e.jsx("em",{children:Me(t)==="NO MATCH"?a.vOut:a.vKept}),t.reasoning.length>340?`${t.reasoning.slice(0,340)}…`:t.reasoning]}),t.ceoNote&&e.jsxs("div",{className:"ceonote",children:["💬 ",e.jsx("i",{children:t.ceoNote})]}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx($e,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[xe(t.engine||"")," ",oe(t.engine||"",n)]}),Y(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(he,{o:t})})]}),o.pipe&&(t.memoUrl||l)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),l&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>i(t),children:a.actOnboard})]})]})]})}function Ya({o:t,locked:a}){const{t:n,dispatch:r,caps:o,doDecide:l}=E(),i=ae(t),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][i];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":p},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx($e,{o:t}),Y(t)&&e.jsx(he,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&o.pipe&&i===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function Ga(){const t=E(),{st:a,dispatch:n,t:r,caps:o,scoped:l,lang:i,sessTally:p}=t,[c,d]=f.useState(new Set);f.useEffect(()=>{d(new Set)},[a.ptab,a.continent]);const m=j=>d(w=>{const z=new Set(w);return z.has(j)?z.delete(j):z.add(j),z}),s=f.useMemo(()=>Pe(l,a.sort),[l,a.sort]),y=f.useMemo(()=>s.filter(j=>Y(j)&&!W(j)).length,[s]),g=o.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,b=(j,w,z="",R=!1)=>e.jsxs("button",{type:"button","data-s":j,className:z,"aria-sort":a.sort.key===j?a.sort.dir===1?"ascending":"descending":"none",style:R?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:j}),children:[w,e.jsx("span",{className:"ar",children:a.sort.key===j&&a.sort.dir===1?"▴":"▾"})]},j),k=f.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const j=new Map;return s.forEach(w=>{const z=w.engine||"?";j.has(z)||j.set(z,[]),j.get(z).push(w)}),[...j.entries()]},[s,o.pipe,a.groupBy]),x=o.lockRowsAfter;let u=0;const N=(j,w)=>{const z=a.shown[w]||Ce,D=j.slice(0,z).map(h=>{const C=x!==null&&u>=x;return u++,a.dens==="maxi"?e.jsx(Ya,{o:h,locked:C},h.id):e.jsx(Ua,{o:h,locked:C,open:c.has(h.id),onToggle:()=>m(h.id)},h.id)});return j.length>z&&D.push(e.jsx("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:w,by:Ce}),children:r.more(Math.min(Ce,j.length-z),j.length-z)},w+":more")),D};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:s.length})," ",g]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,o.pipe&&t.fund?" · "+t.fund:""]}),o.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),o.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([j,w])=>e.jsxs("button",{type:"button","data-d":j,"aria-pressed":a.dens===j,onClick:()=>n({type:"dens",dens:j}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:w})]},j))}),o.showChain&&s.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:s.filter(j=>o.pipe?!0:!W(j)).map(j=>j.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",o.pipe?r.browse(s.length):r.chainAll(s.filter(j=>!W(j)).length)]})]}),y>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(y)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),b("country",r.colCountry),b("name",r.colCompany),b("amount",r.colAmount,"h-amt",!0),b("stage",r.colStage,"h-stade"),b("signal",r.colSignal,"h-sig"),o.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),o.pipe&&b("score",r.colScore,"h-sc",!0),e.jsx("span",{}),o.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[k?k.map(([j,w])=>e.jsxs(f.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:xe(j)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:oe(j,i)}),e.jsx("div",{className:"s",children:r.grpCount(w.filter(z=>!W(z)).length,w.length)})]})]}),N(w,j)]},j)):N(s,"pt"+a.ptab),!s.length&&e.jsx("div",{className:"void",children:o.pipe?r.emptyTab:r.emptyScope})]}),o.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(p.kept>0||p.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(p.kept,p.dropped)}})]})}const Wa=`
...
`;function Ka(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let i=t.y+10;return i+n>o-8&&(i=Math.max(8,t.y-n-14)),i<8&&(i=8),{left:l,top:i}}function Qa(){const{st:t,dispatch:a,byId:n,t:r,lang:o,caps:l,mode:i,askEvaluate:p,doAnalyse:c,doDecide:d,doPromote:m,doRepeche:s,doApproach:y,doDeep:g,doOnboard:b,outbound:k,evalBusy:x}=E(),u=t.popupId?n.get(t.popupId):null;if(!u)return null;const N=Y(u),j=ae(u),w=De(u),z=u.kind==="target",R=D=>{a({type:"filters",patch:D}),a({type:"popup",id:null})};return ze.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Wa}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Ka(t.popupAnchor),onClick:D=>D.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:u.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(me(u.date)),oe(u.engine,o))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[u.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>R({country:[u.cc]}),children:(ge(u.cc,o)||u.countryLabel||"").toUpperCase()}),u.sector&&e.jsx("button",{type:"button",onClick:()=>R({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&e.jsx("button",{type:"button",onClick:()=>R({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{className:"am2",children:Ie(u.amountEur,o)})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[xe(u.engine)," ",e.jsx("b",{children:oe(u.engine,o)})," — ",_t(u.engine,o),u.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",u.noteTitle]})]}),N?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(he,{o:u,lg:!0})," ",e.jsx(Se,{o:u,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(ft(N,o))," · ",r.win7(xt(N,o))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:l.pipe&&j>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),l.pipe&&z&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof u.score=="number"&&u.score>0?" · "+r.score(u.score):""]})})]}),e.jsxs("div",{className:"pf",children:[l.lockActions||i!=="client"&&l.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):l.pipe?e.jsxs(e.Fragment,{children:[j===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>p(u),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),j===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),j===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),j===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(u,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{d(u,!1),a({type:"popup",id:null})},children:r.actNo}),qe(u)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{g(u),a({type:"popup",id:null})},children:r.memoDeep})]}),j===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{y(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),j===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(u),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),u.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),k&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{b(u),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:x,onClick:()=>p(u),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),u.website&&e.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}const we="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function re({title:t,icon:a,children:n,wide:r}){const{dispatch:o}=E();return ze.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:l=>{l.target===l.currentTarget&&o({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function Ja(){const{st:t}=E();switch(t.modal){case"chain":return e.jsx(Za,{});case"space":return e.jsx(er,{});case"alert":return e.jsx(tr,{});case"queue":return e.jsx(nr,{});case"export":return e.jsx(or,{});case"plug":return e.jsx(lr,{});case"recharge":return e.jsx(ir,{});case"cover":return e.jsx(sr,{});case"crit":return e.jsx(dr,{});case"tuto":return e.jsx(pr,{});case"rdv":return e.jsx(Xa,{});default:return null}}function Xa(){const{dispatch:t,fund:a}=E(),n=typeof document<"u"&&!!document.getElementById("rdv");return f.useEffect(()=>{n&&(t({type:"modal",modal:null}),ka())},[n,t]),n?null:e.jsx(Ut,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function Za(){const{st:t,dispatch:a,byId:n,t:r,lang:o,mode:l,askEvaluate:i,evalBusy:p}=E(),c=l==="client",d=t.chain.queue.map(g=>n.get(g)).filter(g=>!!g),m=t.chain.idx,s=d[m],y=m>=d.length;return ze.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:y?r.finished:`${m+1} / ${d.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(y?100:m/Math.max(1,d.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:y||!s?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(d.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:s.name}),e.jsx("div",{className:"sub",children:[ge(s.cc,o)||s.countryLabel,s.sector,s.stage,r.daysAgo(me(s.date))].filter(Boolean).map(g=>String(g).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:oe(s.engine,o).toUpperCase()}),typeof s.amountEur=="number"&&s.amountEur>0&&e.jsx("span",{children:Ie(s.amountEur,o)})]}),Y(s)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(he,{o:s,lg:!0})," ",e.jsx(Se,{o:s,src:!0})]}),(s.tagline||s.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:s.tagline||s.headline})]}),s.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:s.reasoning})]}),c&&W(s)&&e.jsxs("div",{className:"vbox",style:{"--c":se(s)==="retenu"?"var(--brand)":se(s)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:se(s)==="retenu"?"✓ "+r.kept:se(s)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:s.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!y&&s&&!(c&&W(s))&&e.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:p,onClick:()=>{i(s)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(y?{type:"modal",modal:null}:{type:"chainNext"}),children:y?r.closeBtn:r.skip})]})]})})}),document.body)}function er(){const{st:t,dispatch:a,dossiers:n,t:r,mode:o}=E(),l=o==="client",i=f.useMemo(()=>l?n.filter(s=>W(s)):[],[n,l]),p=f.useMemo(()=>Pe(i.filter(s=>se(s)==="retenu"),{key:"signal",dir:-1}),[i]),c=f.useMemo(()=>i.filter(s=>se(s)==="ecarte"),[i]),d=t.spaceTab==="retenu"?p:c,m=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(re,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:p.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),d.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),d.slice(0,40).map(s=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":m},children:typeof s.score=="number"&&s.score>0?s.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:s.name}),e.jsx("div",{className:"rr",children:s.reasoning||s.tagline||""})]})]},s.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function tr(){const{mode:t}=E();return t==="client"||t==="apercu"?e.jsx(ar,{}):e.jsx(rr,{})}function ar(){const{t,token:a,flash:n,mode:r}=E(),[o,l]=f.useState(null),i=r!=="client";f.useEffect(()=>{let c=!0;return Xe(a).then(d=>{c&&l(d)}),()=>{c=!1}},[a]);const p=c=>{i||Xe(a,c).then(d=>{d&&(l(d),n(t.alertSaved))})};return e.jsx(re,{title:t.alertTitle,icon:"🔔",children:o?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:i,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>p({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>p({hour:Math.max(6,(o.hour??7)-1)}),disabled:i,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>p({hour:Math.min(21,(o.hour??7)+1)}),disabled:i,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:i,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>p({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:i,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>p({days:"daily"}),children:t.alertEveryday})]})]}),o.email_lead&&e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]})]}):e.jsx("div",{className:"sp-empty",children:"…"})})}function rr(){const{st:t,t:a,lang:n,scoped:r,contName:o}=E(),[l,i]=f.useState(""),[p,c]=f.useState(!1),[d,m]=f.useState(!1),s=t.filters,y=f.useMemo(()=>r.filter(x=>Y(x)).length,[r]),g=s.win==="1"?0:s.win==="7"?1:s.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){m(!0);try{await fetch(`${Oe}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:s.sector,countries:s.country,source:"atelier2",website:""})}),c(!0)}finally{m(!1)}}},k=[[a.amRows.continent,o],[a.amRows.since,a.amSince[g]],[a.amRows.signal,s.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,s.engine.length?s.engine.map(x=>oe(x,n)).join(", "):a.amAllEngines],[a.amRows.sectors,s.sector.length?s.sector.join(", "):a.amAllSectors],[a.amRows.countries,s.country.length?s.country.map(x=>ge(x,n)||x).join(", "):a.amAllCountries],[a.amRows.stages,s.stage.length?s.stage.join(", "):a.amAllStages]];return e.jsx(re,{title:a.alertTitle,icon:"🔔",children:p?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:k.map(([x,u])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:x}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:u}})]},x))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,onChange:x=>i(x.target.value),onKeyDown:x=>{x.key==="Enter"&&b()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,y)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})})}function nr(){var k,x,u;const{t,token:a,fund:n,mode:r,flash:o}=E(),[l,i]=f.useState(null),[p,c]=f.useState([]),[d,m]=f.useState(0),s=r==="client";f.useEffect(()=>{let N=!0;return(async()=>{const[j,w]=await Promise.all([dt(n),pt(a)]);N&&(j&&i(j),c(w))})(),()=>{N=!1}},[a,n,d]);const y=(l==null?void 0:l.per_day)??2,g=((k=l==null?void 0:l.analyzed_today)==null?void 0:k.length)??0,b=(x=l==null?void 0:l.tomorrow)!=null&&x.length?l.tomorrow:((l==null?void 0:l.pool_meta)||[]).slice(0,10);return e.jsxs(re,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(g,g+(((u=l==null?void 0:l.pool_order)==null?void 0:u.length)??0))}})}),e.jsx("div",{className:"qrate",children:t.queueRate}),e.jsx("div",{className:"qrates",children:[1,2,3,5,10].map(N=>e.jsx("button",{type:"button",className:"qr"+(y===N?" on":""),disabled:!s,onClick:()=>{ct(a,N).then(j=>{j!==null&&(m(w=>w+1),o(t.alertSaved))})},children:e.jsxs("b",{children:[N,"/j"]})},N))})]}),p.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:p.map(N=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:N.company}),e.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),e.jsx("span",{className:"qt",children:N.status}),N.url&&e.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),s&&N.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Je(a,N.company,"retry").then(()=>m(j=>j+1))},children:t.queueRetry}),s&&N.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{Je(a,N.company,"delete").then(()=>m(j=>j+1))},children:t.queueDelete})]},N.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[b.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),b.slice(0,10).map((N,j)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",j+1]}),e.jsx("b",{children:N.name}),typeof N.score=="number"&&e.jsx("span",{className:"qs2",children:N.score})]},N.name))]})]})}function or(){const{t,token:a,flash:n}=E(),r=`${we}/cibles/list.csv?token=${a}`,o=`${we}/cibles/list.json?token=${a}`,l=`${we}/cibles/export.xlsx?token=${a}&scope=full`,i=`=IMPORTDATA("${r}")`,p=d=>{var m;(m=navigator.clipboard)==null||m.writeText(d).then(()=>n(t.exportCopied))},c=[{def:t.exportCsv,value:r,href:r},{def:t.exportSheet,value:i},{def:t.exportLive,value:o,href:o},{def:t.exportXlsx,value:l,href:l}];return e.jsxs(re,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),e.jsx("div",{className:"expl",children:c.map(({def:d,value:m,href:s})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:d[0]}),e.jsxs("div",{children:[e.jsx("b",{children:d[1]}),e.jsx("p",{children:d[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>p(m),children:t.exportCopy}),s&&e.jsx("a",{className:"exb",href:s,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},d[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function lr(){const{t,token:a,flash:n,mode:r}=E(),[o,l]=f.useState(null),[i,p]=f.useState(""),c=r==="client";f.useEffect(()=>{let s=!0;return Qe(a).then(y=>{s&&y&&l(y)}),()=>{s=!1}},[a]);const d=(s,y)=>{c&&Qe(a,s).then(g=>{g&&g.ok!==!1&&(n(y),l({configured:!s.remove&&(s.url?!0:o==null?void 0:o.configured),url_hint:g.url_hint}))})},m='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(re,{title:t.plugTitle,icon:"🔌",children:[e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugWebhook}),e.jsxs("p",{children:[t.plugWebhookHint,o!=null&&o.configured?` — ${t.plugConfigured}${o.url_hint?` (${o.url_hint})`:""}`:""]}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:"https://…",value:i,onChange:s=>p(s.target.value),disabled:!c}),e.jsx("button",{type:"button",className:"abtn p",disabled:!c||!i.trim(),onClick:()=>d({url:i.trim()},t.alertSaved),children:t.plugSave}),e.jsx("button",{type:"button",className:"abtn",disabled:!c||!(o!=null&&o.configured),onClick:()=>d({test:!0},t.plugTest+" ✓"),children:t.plugTest}),e.jsx("button",{type:"button",className:"abtn",disabled:!c||!(o!=null&&o.configured),onClick:()=>d({remove:!0},t.plugRemove+" ✓"),children:t.plugRemove})]})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.plugMcp}),e.jsx("p",{children:t.plugMcpHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{readOnly:!0,value:m}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var s;(s=navigator.clipboard)==null||s.writeText(m).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function ir(){const{t,data:a,lang:n}=E(),r=a.credits,o=a.email,l=async i=>{if(!o)return;const p=window.location.href.split("?")[0];try{const d=await(await fetch(`${Oe}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:i,success_url:p+"?credits=ok",cancel_url:p+"?credits=cancel"})})).json();d.url&&(window.location.href=d.url)}catch{}};return e.jsxs(re,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(i=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(i.credits,i.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{l(i.lookup_key)},children:t.rechargeBuy})]},i.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function sr(){const{t,data:a,dossiers:n}=E(),r=n.filter(l=>l.kind==="target"&&W(l)).length,o=a.marketEstimate||0;return e.jsx(re,{title:t.coverTitle,icon:"🌍",children:o>0?e.jsx("p",{dangerouslySetInnerHTML:{__html:t.coverBody(r,o)}}):e.jsx("p",{children:t.coverScreened(r)})})}function dr(){var u,N,j;const{t,dossiers:a,token:n,mode:r,flash:o,criteria:l}=E(),i=r==="client",p=f.useMemo(()=>{const w=new Set;return a.forEach(z=>{z.angle&&w.add(z.angle)}),[...w]},[a]),[c,d]=f.useState(null);f.useEffect(()=>{let w=!0;return Ht(n).then(z=>{w&&d(z.thumbs)}),()=>{w=!1}},[n]);const[m,s]=f.useState(""),[y,g]=f.useState(""),[b,k]=f.useState(!1),x=async()=>{const w=m.trim();if(!(!w||b||!i)){k(!0),g("");try{const R=await(await fetch(`${we}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:w,who:"atelier2"})})).json().catch(()=>({}));if(R.reply&&g(String(R.reply)),R.job_id){g(t.critChatRunning);const D=async()=>{const h=await fetch(`${we}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:R.job_id})}).then(C=>C.json()).catch(()=>null);if(h&&h.done){g(String(h.reply||h.clarification||h.summary||"✓")),k(!1),h.applied&&o(t.alertSaved);return}setTimeout(()=>{D()},8e3)};setTimeout(()=>{D()},8e3),s("");return}s("")}finally{y.startsWith("⏳")||k(!1)}}};return e.jsxs(re,{title:t.critTitle,icon:"⚙",wide:!0,children:[(l==null?void 0:l.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:l.lead}),!!((u=l.points)!=null&&u.length)&&e.jsx("ul",{className:"critpts",children:l.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((N=l==null?void 0:l.angles)!=null&&N.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:l.method||t.critProfilsSub}),l.angles.map(w=>{var z,R;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((z=w.look)!=null&&z.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(D=>e.jsx("li",{children:D},D))})]}),!!((R=w.out)!=null&&R.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(D=>e.jsx("li",{children:D},D))})]})]})]},w.title)})]}),!!((j=l==null?void 0:l.gate)!=null&&j.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),l.gate.length===1&&!l.gate[0].k?e.jsx("p",{className:"gate1",children:l.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:l.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),p.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:p.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:m,disabled:!i||b,onChange:w=>s(w.target.value),onKeyDown:w=>{w.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(b?" loading":""),style:{padding:"12px 18px"},disabled:!i||b||!m.trim(),onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),y&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:y})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((w,z)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},z))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,z])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(bt[w]||"v-cons"),children:w}),e.jsx("span",{children:z})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,z])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",z]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function pr(){const{t}=E();return e.jsx(re,{title:t.tutoTitle,icon:"▶",children:e.jsx("ol",{className:"steps2",children:t.tutoSteps.map(([a,n],r)=>e.jsxs("li",{children:[e.jsx("b",{children:a}),e.jsx("span",{children:n})]},r))})})}const vt=f.createContext(null),E=()=>{const t=f.useContext(vt);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function he({o:t,lg:a}){const{lang:n}=E(),r=Y(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ze(r,n),children:[r.emoji," ",Ze(r,n)]}):null}function Se({o:t,src:a}){const{lang:n,t:r}=E(),o=Y(t);if(!o)return null;const l=Kt(o),i=Qt(o);return e.jsxs("em",{className:"sigwin"+(i?" hot":""),title:r.signaledOn(ft(o,n))+" · "+r.win7(xt(o,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(p,c)=>e.jsx("i",{className:c<l?"on":""},c))}),e.jsx("span",{className:"lb",children:i?r.lastDay:r.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&e.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:p=>p.stopPropagation(),children:"↗"})]})}function yt({o:t}){const{lang:a}=E(),n=Wt(t.cc),r=t.cc?ge(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const it="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap";function mr({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:o,onFiltersChange:l}){const{lang:i}=Vt(),p=na[i],c=ma(t,i,a),[d,m]=f.useReducer(ha,void 0,()=>ga((r==null?void 0:r.continent)??"europe",t,{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),s=f.useRef(l);s.current=l,f.useEffect(()=>{var v;(v=s.current)==null||v.call(s,d.filters)},[d.filters]);const[y,g]=f.useState(null),[b,k]=f.useState(null),[x,u]=f.useState({kept:0,dropped:0}),[N,j]=f.useState(!1),[w,z]=f.useState(""),[R,D]=f.useState(!1),[,h]=f.useState(0),C=()=>h(v=>v+1),S=f.useRef([]),M=f.useRef(new Set),F=f.useRef(new Set),P=f.useRef(new Map),A=f.useRef(null),{mode:I}=c,L=f.useMemo(()=>o?{...c.caps,...o}:c.caps,[c.caps,o]),$=L.pipe,B=c.session.token||"",H=I==="client"&&!t;f.useEffect(()=>{if(document.querySelector(`link[href="${it}"]`))return;const v=document.createElement("link");v.rel="stylesheet",v.href=it,document.head.appendChild(v)},[]);const q=(v,T=!1)=>{z(v),D(T),A.current&&clearTimeout(A.current),A.current=setTimeout(()=>z(""),T?4200:2400)},J=v=>q(v,!0),_=f.useMemo(()=>{const v=new Map;return c.dossiers.forEach(T=>{T.id&&v.set(T.id,T)}),v},[c.dossiers]),ne=f.useMemo(()=>c.dossiers.filter(v=>gt(v,d,$)),[c.dossiers,d,$]),ee=f.useMemo(()=>c.dossiers.filter(v=>ba(v,d,$,c.favIds)),[c.dossiers,d,$,c.favIds]),te=f.useMemo(()=>Yt(ne,c.favIds),[ne,c.favIds]),X=Re.find(v=>v.key===d.continent),K=i==="fr"?X.fr:X.en,G=(v,T)=>{const O=((v==null?void 0:v.name)||T||"").trim();if(!H){k({kicker:O});return}!O||N||(j(!0),(async()=>{try{const V=await ut(B,O,"atelier2"),ke={name:V.company||O,verdict:V.verdict,reason:V.reason||"",remaining:V.remaining??null};S.current=[ke,...S.current].slice(0,8),V.verdict==="kept"&&u(pe=>({...pe,kept:pe.kept+1})),V.verdict==="ruled_out"&&u(pe=>({...pe,dropped:pe.dropped+1}));const ve=v||c.dossiers.find(pe=>(pe.name||"").toLowerCase()===O.toLowerCase());ve&&(V.verdict==="kept"?ve.verdict=ve.verdict||"MATCH":V.verdict==="ruled_out"&&(ve.verdict="NO MATCH"),V.reason&&(ve.reasoning=V.reason)),C()}finally{j(!1)}})())},U=v=>{if(!H){k({kicker:v.name});return}M.current.add(v.id),ye(B,"fast_request",v.name||"",""),q(p.memoInstantSent(v.name)),C()},Z=v=>P.current.get(v.id)??c.thumbs.get((v.name||"").trim().toLowerCase()),le=(v,T)=>m({type:"undoPush",entry:{id:v.id,name:v.name,prevCeoStatus:T}}),de=async(v,T,O)=>{const V=v.ceoStatus||"";v.ceoStatus=T,C();const ke=await et(B,{status:T,airtable_id:v.airtableId,check_id:v.checkId,company:v.name,...(O==null?void 0:O.note)!==void 0?{note:O.note}:{},...O!=null&&O.via?{via:O.via}:{}});return ke.ok?ke.skipped?(v.ceoStatus=V,C(),J(p.actNotPersisted),!1):((O==null?void 0:O.undo)!==!1&&le(v,V),O!=null&&O.msg&&q(O.msg),!0):(v.ceoStatus=V,C(),J(p.actErr),!1)},be=(v,T)=>{H&&de(v,T?"Validé":"Écarté",{msg:T?p.decidedYes(v.name):p.decidedNo(v.name)})},ue=v=>{H&&de(v,"À trancher",{msg:p.promoted(v.name)})},Q=v=>{H&&(async()=>{const T=v.ceoStatus||"";v.ceoStatus="Retenu",C();const O=await et(B,{status:"Retenu",check_id:v.checkId,company:v.name});if(!O.ok||O.skipped){v.ceoStatus=T,C(),J(O.skipped?p.actNotPersisted:p.actErr);return}le(v,T),q(p.repeched(v.name))})()},ie=()=>{const v=d.undo[d.undo.length-1];if(!v){q(p.undoNone);return}const T=_.get(v.id);if(!T){m({type:"undoPop"}),q(p.undoNone);return}let O=v.prevCeoStatus;if(!O)if((T.verdict||"").toUpperCase().includes("CALL"))O="À trancher";else{q(p.undoLockedTitle);return}(async()=>await de(T,O,{undo:!1})&&(m({type:"undoPop"}),T.ceoStatus=v.prevCeoStatus,C(),q(p.undoDone(T.name))))()},fe=v=>{H&&(F.current.add(v.id),C(),(async()=>{const T=await Jt(B,v.name,"email");if(!T||T.ok===!1){F.current.delete(v.id),C(),J(p.actErr);return}ye(B,"approach",v.name||"",""),q(p.actApproachSent)})())},wt=(v,T)=>{H&&(async()=>{if(!(await ye(B,T?"yes":"no",v.name||"","")).ok){J(p.actErr);return}P.current.set(v.id,T?"yes":"no"),C(),q(T?p.thumbUpDone:p.thumbDnDone)})()},kt=v=>{!H||!qe(v)||(ye(B,"detailed_request",v.name||"",""),q(p.memoDeepSent(v.name)))},jt=v=>{const T=new Set(c.favIds),O=T.has(v.id);O?T.delete(v.id):T.add(v.id),c.setFavIds(T),H&&Xt(B,{id:v.id,co:v.name},O)},Nt=()=>{H&&(Zt(B),q(p.identSyncDone))},_e=/proplace/i.test(c.fund||""),Ct=v=>{!H||!_e||(ye(B,"onboard_request",v.name||"",""),q(p.onboardSent(v.name)))},zt={st:d,dispatch:m,t:p,lang:i,mode:I,caps:L,pipe:$,token:B,fund:c.fund,email:c.email,criteria:c.criteria,data:c,doRepeche:Q,thumbOf:Z,dossiers:c.dossiers,scopedAll:ne,scoped:ee,counts:te,byId:_,contName:K,favIds:c.favIds,toggleFav:jt,askEvaluate:G,doAnalyse:U,doDecide:be,doPromote:ue,doApproach:fe,doThumb:wt,doDeep:kt,doUndo:ie,doSync:Nt,doOnboard:Ct,outbound:_e,memoQueued:M.current,approachDone:F.current,sessTally:x,evalCards:S.current,evalBusy:N,markRow:g,markedId:y,flash:q};return f.useEffect(()=>{const v=T=>{T.key==="Escape"&&(m({type:"popup",id:null}),m({type:"modal",modal:null}),m({type:"openFacet",facet:null}))};return window.addEventListener("keydown",v),()=>window.removeEventListener("keydown",v)},[]),e.jsx(vt.Provider,{value:zt,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:ia}),e.jsxs("div",{className:"app"+($?" pipe":""),children:[L.showTicker&&e.jsx(va,{}),L.showIdent&&e.jsx(Sa,{}),L.showOnb&&e.jsx(Ea,{}),e.jsx(za,{}),L.showFunnel&&e.jsx(cr,{}),L.showFunnel&&e.jsx(Aa,{}),L.showFunnel&&e.jsx(Ma,{}),e.jsxs("div",{className:"fzone",children:[e.jsx(ur,{}),e.jsxs("div",{className:"stage"+(d.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(La,{}),e.jsx(Ra,{})]})]}),L.showDemand&&e.jsx(qa,{}),L.showDemand&&d.memoConsole&&e.jsx(Ba,{}),e.jsx(Ga,{}),c.loading&&e.jsx("div",{className:"void",children:p.loadingV2}),c.error&&!c.loading&&e.jsxs("div",{className:"void",children:[p.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:p.retry})]})]}),L.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:p.lockbarText}),e.jsx("button",{type:"button",onClick:()=>m({type:"modal",modal:"rdv"}),children:p.lockbarCta})]}),d.popupId&&e.jsx(Qa,{}),e.jsx(Ja,{}),e.jsx(Na,{}),w&&e.jsx("div",{className:"flash on"+(R?" err":""),children:w}),b&&e.jsx(Gt,{variant:"acquirer",initialCompany:st().co,initialWebsite:st().site,onClose:()=>k(null)})]})})}function cr(){const{t}=E(),[a,n]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function ur(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:o,t:l}=E(),i=f.useMemo(()=>{const p={};return t.forEach(c=>{c.continent&&Be(c,a.filters,r)&&(p[c.continent]=(p[c.continent]||0)+1)}),p},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[ea.map(p=>{const c=Re.find(d=>d.key===p);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===p,onClick:()=>n({type:"continent",key:p}),children:[o==="fr"?c.fr:c.en,e.jsx("span",{className:"n",children:i[p]||0})]},p)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?l.showMap:l.hideMap})})]})}function st(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function fr(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{yt as FlagCell,he as SigBadge,Se as SigWin,mr as default,fr as fmtShort,E as useV2};
