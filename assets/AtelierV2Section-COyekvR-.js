...
`,Ui=Bi+_i;function Ia(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Hi(){const e=Ia("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Vi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Hi();return r==="0"?"client":r==="1"||Ia("embed")==="1"&&Ia("chrome")==="1"?"apercu":"client"}const Wi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Yi=e=>Wi[e];function ca(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const ft=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!yr(a)||ca(a))&&(e.noCo=!0)}return Object.assign(e,{continent:To(e.cc)})};function Sa(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Gi=60*60*1e3;function Ki(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Gi?null:a}catch{return null}}function Qt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Qi=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ji(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:vo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Vi(e,i),[e,i,n]),l=m.useMemo(()=>Yi(o),[o]),d=o!=="visiteur",c=Qi(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[g,p]=m.useState(null),[b,y]=m.useState(null),[h,N]=m.useState(null),[C,w]=m.useState(()=>new Map),[A,q]=m.useState(()=>new Map),[T,z]=m.useState(""),[S,j]=m.useState(new Set),[M,P]=m.useState(null),[F,_]=m.useState(!0),[v,L]=m.useState(!1),[V,U]=m.useState(0),[I,W]=m.useState(0),K=m.useRef(0),X=m.useMemo(()=>{var ae;if(o!=="client")return"";try{return((ae=yo())==null?void 0:ae.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ae=++K.current;let xe=!0;const Y=()=>xe&&ae===K.current,le=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),ce=Ki(le);return ce?(s(ce.objs.map(ft)),ce.fund&&u(ce.fund),p(ce.marketEstimate??null),y(ce.criteria??null),N(ce.stats??null),z(ce.generatedAt||""),_(!1)):_(!0),(async()=>{try{if(r==="ops"){const Ne=await ja(),ye=((Ne==null?void 0:Ne.recent_ops)||[]).map(ee=>{const Z=ia(ee.company_name||ee.title?ee:{...ee,title:(ee.headline_fr||ee.headline||"").slice(0,120)},a),Q=String(ee.rubrique||"").toLowerCase();return Z&&(Q==="nominations"||Q==="recrutements")&&(Z.engine=Q),Z&&!String(ee.company_name||"").trim()&&(Z.noCo=!0),Z}).filter(ee=>!!ee).map(ee=>(yr((ee.name||"").trim())||(ee.noCo=!0),ee));try{const ee=wo(),Z=ee&&ee.doc||await ko(),Q=jo(Z),H=((ee==null?void 0:ee.day)||(Z==null?void 0:Z.date)||"").slice(0,10);if(H&&Q.length){const me=new Set;for(const te of ye){if((te.date||"").slice(0,10)!==H)continue;const pe=jn(Q,me,te.name,"");pe>=0&&(me.add(pe),te.decryptHtml=Q[pe].html)}for(const te of ye){if(te.decryptHtml||(te.date||"").slice(0,10)!==H)continue;const pe=jn(Q,me,"",te.headline||te.tagline||te.name);pe>=0&&(me.add(pe),te.decryptHtml=Q[pe].html)}}if(H){const me=((Z==null?void 0:Z.title_fr)||"").trim(),te=((Z==null?void 0:Z.lead_fr)||"").trim(),pe=No(Z),ue=((Z==null?void 0:Z.url)||"").trim();me&&pe&&ye.unshift({id:`edito:${H}`,kind:"op",name:me,cc:null,date:H,engine:"edito",dealKind:"other",headline:te||me,tagline:te||me,decryptHtml:pe,url:ue,noCo:!0})}}catch{}if(!Y())return;s(ye.map(ft)),Qt(le,{objs:ye})}else if(typeof r=="object"){const ye=(await Nn()||[]).filter(Z=>(Z.slug||"")===r.research).map(Z=>Sn(Z,a)).filter(Z=>!!Z),ee=Sa(await En(ye,a));if(!Y())return;s(ee.map(ft)),Qt(le,{objs:ee})}else if(d&&i.token){const Ne=So(i.token),ye=ja(),ee=Eo(i.token),Z=Co(i.token),Q=zo(i.token),H=await Ne;let me=H?H.targets:[];Y()&&H&&(u(H.fund||""),p(H.marketEstimate??null),y(H.criteria??null),N(H.stats??null),z(H.generatedAt||""),s(me.map(ft)),_(!1),L(!1));const[te,pe,ue,he]=await Promise.all([ye,ee,Z,Q]),$e=((te==null?void 0:te.recent_ops)||[]).map(Me=>ia(Me,a)).filter(Me=>!!Me);if(me=[...me,...$e],!Y())return;s(me.map(ft));const Ue=new Set;for(const Me of pe){const Xe=(Me.id||Me.co||"").toString().trim().toLowerCase();Xe&&Ue.add(Xe.startsWith("t:")?Xe:"t:"+Xe)}j(Ue),w(ue),q(he),H&&Qt(le,{fund:H.fund,marketEstimate:H.marketEstimate,criteria:H.criteria,stats:H.stats,generatedAt:H.generatedAt,objs:me})}else{const Ne=Ao(),ye=Nn(),ee=ja(),Z=await Ne;Y()&&Z.length&&(s(Sa(Z).map(ft)),_(!1),L(!1));const[Q,H]=await Promise.all([ye,ee]),me=(Q||[]).map(he=>Sn(he,a)).filter(he=>!!he),te=await En(me,a),pe=((H==null?void 0:H.recent_ops)||[]).map(he=>ia(he,a)).filter(he=>!!he),ue=Sa([...Z,...te,...pe]);if(!Y())return;s(ue.map(ft)),Qt(le,{objs:ue})}Y()&&L(!1)}catch{Y()&&!ce&&L(!0)}finally{Y()&&_(!1)}})(),()=>{xe=!1}},[d,i.token,a,V,c]),m.useEffect(()=>{if(!l.showCredits||!X){P(null);return}let ae=!0;return(async()=>{try{const xe=await fetch(`${an}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:X})});if(!xe.ok)return;const Y=await xe.json();ae&&Y&&Y.ok!==!1&&P(Y)}catch{}})(),()=>{ae=!1}},[l.showCredits,X,I]);const re=m.useCallback(ae=>j(new Set(ae)),[]);return{session:i,mode:o,caps:l,fund:x,email:X,marketEstimate:g,generatedAt:T,criteria:b,stats:h,thumbs:C,stages:A,dossiers:f,favIds:S,setFavIds:re,credits:M,reloadCredits:()=>W(ae=>ae+1),loading:F,error:v,refresh:()=>U(ae=>ae+1)}}function gt(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Nr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Xi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Nr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Zi=new Set(["signal","amount","score","crible","memo"]);function es(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Nr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Zi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Sr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Sr=80;function pa(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!qe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(nn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(dt(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&ht(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Er(e,a,r){return gt(e)?pa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:pa(e,a.filters,r)}function ts(e,a,r,n){return!(!Er(e,a,r)||r&&!qo(e,a.ptab,n))}function ln(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-dt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Mo(i);case"memo":return Lo(i);case"signal":{const o=qe(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const Ea={},On=(Ea==null?void 0:Ea.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Pn(){return new Date().toISOString().slice(0,10)}const dn=m.createContext(null);function Cr(){return m.useContext(dn)}function as(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const f=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(c.setAttribute("href",f),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function Dn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function zr(){const e=m.useContext(dn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ns({token:e,children:a}){const{dispatch:r,st:n,lang:i}=D(),[o,l]=m.useState(()=>n.filters.day||Pn()),[d,c]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(Pn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var N;const h=(N=y.detail)==null?void 0:N.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${On}/cibles/edition.json?${y}`).then(h=>h.json()).then(h=>{b||c(h)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const g=m.useMemo(()=>`${On}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:d,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:g,isEn:i==="en"}),[e,o,d,f,x,u,n.filters.day,g,i]);return t.jsx(dn.Provider,{value:p,children:a})}function rs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=zr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Ro,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})]})}function os(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=zr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:Dn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:Dn(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const is=300,Jt=7,ss={fr:{ma:"M&A",levees:"Levées de fonds",nominations:"Nominations",recrutements:"Offres d'emploi",actualites:"Presse"},en:{ma:"M&A",levees:"Fundraising",nominations:"Appointments",recrutements:"Job offers",actualites:"Press"}},Ar={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},ls=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ca(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Do(r)&&r!=="media")return"news:"+r;const n=qe(e);return n?"sig:"+(n.theme&&Ar.fr[n.theme]?n.theme:"other"):"actualites"}function ds(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=D(),c=Cr(),f=l==="en",[s,x]=m.useState("all"),[u,g]=m.useState(!1),p=m.useMemo(()=>{var xe;const v=(a.filters.day||"").slice(0,10),L=Y=>!(!o&&a.continent!=="monde"&&Y.continent!==a.continent||v&&(Y.date||"").slice(0,10)!==v),V=e.filter(Y=>L(Y)&&qe(Y)&&(!o||Y.kind!=="target"||ze(Y)!==5)),U=o&&(((xe=c==null?void 0:c.ed)==null?void 0:xe.ops)||[]).length?c.ed.ops.map(Y=>ia(Y,l)).filter(Y=>!!Y).filter(Y=>!v||(Y.date||"").slice(0,10)===v):[],I=e.filter(Y=>L(Y)&&Y.kind==="op"&&(v?!0:dt(Y.date)<=Jt)),W=o?U.length?U:I.filter(Y=>{const le=(d||"").trim().toLowerCase();if(!le)return!1;const ce=Y.match||null;return ce?Object.keys(ce).map(Ne=>Ne.trim().toLowerCase()).includes(le):!1}):I,K=v||new Date().toISOString().slice(0,10),X=Y=>{const le=Ca(Y);return le==="ma"?0:le==="levees"?1:2};W.sort((Y,le)=>{const ce=X(Y)-X(le);if(ce)return ce;const Ne=(Y.date||"").slice(0,10)===K?0:1,ye=(le.date||"").slice(0,10)===K?0:1;return Ne!==ye?Ne-ye:(le.amountEur||0)-(Y.amountEur||0)});const re=new Set,ae=[];for(const Y of[...W,...ln(V,{key:"signal",dir:-1})]){const le=Y.id||Y.name;!le||re.has(le)||(re.add(le),ae.push(Y))}return o&&ae.length===0?e.filter(le=>L(le)&&dt(le.date)<=Jt).sort((le,ce)=>(ce.date||"").localeCompare(le.date||"")).slice(0,80):ae},[e,a.continent,a.filters.day,o,d,l,c]),b=m.useMemo(()=>{const v={};for(const L of p){const V=Ca(L);v[V]=(v[V]||0)+1}return v},[p]),y=m.useMemo(()=>s==="all"?p:p.filter(v=>Ca(v)===s),[p,s]),h=m.useMemo(()=>y.slice(0,is),[y]),N=y.length-h.length,C=m.useRef(null);m.useEffect(()=>{var W,K;const v=C.current;if(!v)return;const L=()=>{const X=v.scrollWidth;X<200||(v.style.animationDuration=Math.max(18,Math.round(X/130))+"s")};L();const V=requestAnimationFrame(L),U=window.setTimeout(L,1200);let I=!0;return(K=(W=document.fonts)==null?void 0:W.ready)==null||K.then(()=>{I&&L()}),()=>{I=!1,cancelAnimationFrame(V),window.clearTimeout(U)}},[h.length,s]);const w=v=>v==="all"?p.length:b[v]||0,A=v=>{if(v==="all")return f?"All":"Tout";if(v.startsWith("sig:"))return Ar[f?"en":"fr"][v.slice(4)]||"🔔";if(v.startsWith("news:")){const L=v.slice(5);return Oo[L]?Po(L,f?"en":"fr"):v}return ss[f?"en":"fr"][v]},q=[{k:"all"}],T=["ma","levees"].filter(v=>w(v)>0||v===s);if(T.length){q.push({g:f?"Recent deals":"Opérations récentes"});for(const v of T)q.push({k:v})}const z=["nominations","recrutements"].filter(v=>w(v)>0||v===s),S=Fo.filter(v=>v!=="media").map(v=>"news:"+v).filter(v=>w(v)>0||v===s),j=w("actualites")>0||s==="actualites"?["actualites"]:[],M=ls.map(v=>"sig:"+v).filter(v=>w(v)>0||v===s);if(z.length||S.length||j.length||M.length){q.push({g:f?"News (incl. wire)":"Actualités (dont fil)"});for(const v of z)q.push({k:v});for(const v of S)q.push({k:v});for(const v of j)q.push({k:v});for(const v of M)q.push({k:v})}const P=v=>{try{return new Date(v+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return v}},F=(()=>{const v=(a.filters.day||"").slice(0,10),L=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return v?(f?`LIVE covers the events of ${P(v)}.`:`Le LIVE regroupe les événements du ${P(v)}.`)+L:(f?`LIVE covers the still-open signals and the deals of the last ${Jt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Jt} derniers jours.`)+L})(),_=v=>h.map(L=>t.jsxs("button",{type:"button",className:"tk"+(De(L)?" spent":""),onClick:V=>{if(n({type:"focus",id:L.id}),a.dens!=="liste"){const U=V.currentTarget.getBoundingClientRect();n({type:"popup",id:L.id,anchor:{x:U.left+U.width/2,y:U.bottom}})}},title:L.name+(L.tagline?" — "+L.tagline:""),children:[t.jsx(wt,{o:L}),t.jsxs("span",{className:"who",children:[t.jsx(so,{o:L}),t.jsx("span",{className:"co",children:L.name})]}),typeof L.amountEur=="number"&&L.amountEur>0&&t.jsx("span",{className:"am",children:Md(L.amountEur)}),L.sector&&t.jsx("span",{className:"mt",children:L.sector}),t.jsx(wa,{o:L}),t.jsx("span",{className:"tkgo",children:"→"})]},v+(L.id||L.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},v+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:v=>{v.currentTarget.contains(v.relatedTarget)||g(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>g(v=>!v),children:[A(s),t.jsx("b",{children:w(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:F}),q.map(v=>"g"in v?t.jsx("span",{className:"tkfilg",children:v.g},v.g):t.jsxs("button",{type:"button","aria-pressed":v.k===s,onClick:()=>{x(v.k),g(!1)},children:[A(v.k),t.jsx("b",{children:w(v.k)})]},v.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:C,children:[_(0),_(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsx(ps,{isEn:f})]})}const cs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ps({isEn:e}){const[a,r]=m.useState(()=>Io());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(Cn,i),()=>window.removeEventListener(Cn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>$o(!a),children:cs})}const cn="+33 6 83 10 72 86",ua="alexandre@proplace.co",Tr=`tel:${cn.replace(/[^\d+]/g,"")}`;function us(){return null}class Re extends m.Component{constructor(){super(...arguments);wn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const za=600,xt=62,In="atl2:fstats";function ms(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=D(),[l,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(In)==="on"}catch{return!1}}),c=r.stats,f=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=A=>a==="en"?A.slice(5,10):`${A.slice(8,10)}/${A.slice(5,7)}`,u=A=>A.toLocaleString(a==="en"?"en-US":"fr-FR"),g=f.reduce((A,q)=>Math.max(A,q.s||0),0),p=f.length?za/f.length:0,b=Math.max(4,p-4),y=f.length>=5&&g>0,h=r.marketEstimate||0,N=x(new Date().toISOString().slice(0,10)),C=A=>[...typeof A=="number"?[[A,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&s&&w.push({cle:"fenetre",periode:e.funPerWindow(x(s),N),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:C(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(A=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:A.periode}),A.etapes.map(([q,T],z)=>t.jsxs("span",{className:"fst-t",children:[z>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(q)}),t.jsx("i",{children:T})]},A.cle+T)),A.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((c.screened||0)/h*100)))})]}),A.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const q=!l;d(q),q&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(In,q?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},A.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${za} ${xt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((A,q)=>{const T=(A.s||0)/g*(xt-4),z=(A.m||0)/g*(xt-4),S=q*p+(p-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(A.d)} — ${A.s} ${e.actScreened} · ${A.m} ${e.actKept}`}),t.jsx("rect",{x:S,y:xt-2-T,width:b,height:T,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:xt-2-z,width:b,height:z,fill:"#185c38"})]},A.d)}),t.jsx("line",{x1:0,y1:xt-1.5,x2:za,y2:xt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const qr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function fs(e,a){if((pt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return qr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function xs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=D(),[d,c]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){u(!0);return}s(b);const y=await i(e,b);s(""),y&&(c(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),u(!1)},children:[g||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]}):fs(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(g===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{p(b)},children:y},b))})]})}function hs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=D(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(pt(e)||"").startsWith("CALL")&&ze(e)===3,x=ze(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const b=await i(e,p);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},g=s?[["Validé",a.csYes],["Écarté",a.csNo]]:qr.filter(([p])=>!(x&&p==="Retenu")).map(([p,b])=>[p,a[b]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),g.map(([p,b])=>t.jsx("button",{type:"button",className:"csb"+(f===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:b},p)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(gs,{o:e})]})}function gs({o:e}){const{t:a,saveNote:r,flash:n}=D(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;d(!0);const u=await r(e,i.trim());d(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function bs({placeholder:e,onDone:a}){const{t:r}=D(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function vs({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=D(),[c,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||ze(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",u=async h=>{if(c||h===x)return;f(!0);const N=s;l(e,{stage:h,stamps:(s==null?void 0:s.stamps)||{}});const C=Math.max(Date.now(),$n+=1);$n=C;const w=await Bo(r,{company:e.name||"",stage:h,cts:C,deal_id:e.airtableId,check_id:e.checkId});f(!1),!w.stale&&(w.ok||(l(e,N),d(a.actErr)))},g=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,p=g?Math.floor((Date.now()-Date.parse(g))/864e5):0,b=x==="sent"&&g&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,N])=>t.jsx("button",{type:"button",className:"stgb"+(x===h?" on":""),disabled:c,onClick:()=>{u(h)},children:N},h)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let $n=0;const Xt=8,Zt=360;function Bn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function _n({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Bn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Bn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ys({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=D(),[l,d]=m.useState(0),[c,f]=m.useState(null),[s,x]=m.useState([]),u=m.useRef(!1),g=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const T=g.current;return()=>{p.current||(n({type:"ptab",tab:T.ptab}),n({type:"dens",dens:T.dens}),n({type:"modal",modal:T.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,x(e.filter(T=>!!document.querySelector(T.need||T.sel))))},[e]);const b=s[l],y=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const T=b.click,z=window.setTimeout(()=>{const S=document.querySelector(T);S&&S.getAttribute("aria-selected")!=="true"&&S.click()},60);return()=>window.clearTimeout(z)}},[l,b]);const h=m.useRef(-1),N=m.useCallback(()=>{if(!b){f(null);return}const T=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!T){f(null);return}h.current!==l&&(h.current=l,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const z=T.getBoundingClientRect();f(S=>S&&Math.abs(S.top-z.top)<1&&Math.abs(S.left-z.left)<1&&Math.abs(S.width-z.width)<1&&Math.abs(S.height-z.height)<1?S:z)},[b,l]);m.useLayoutEffect(()=>{N();const T=[90,300,700,1300].map(S=>window.setTimeout(N,S)),z=()=>N();return window.addEventListener("scroll",z,!0),window.addEventListener("resize",z),()=>{T.forEach(S=>window.clearTimeout(S)),window.removeEventListener("scroll",z,!0),window.removeEventListener("resize",z)}},[N]);const C=m.useRef(a);if(C.current=a,m.useEffect(()=>{const T=z=>{z.key==="Escape"?(z.preventDefault(),z.stopPropagation(),C.current()):z.key==="ArrowRight"?d(S=>S+1):z.key==="ArrowLeft"&&d(S=>Math.max(0,S-1))};return document.addEventListener("keydown",T,!0),()=>document.removeEventListener("keydown",T,!0)},[]),!s.length)return null;let w=null;const A=T=>()=>{p.current=!0,n({type:"modal",modal:null}),T()};if(y){const T=i[3]||0;T>0?w={title:T===1?r.ahaATitle1:r.ahaATitleN(T),body:r.ahaABody,btn:r.ahaABtn,go:A(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:A(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:A(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:A(()=>{n({type:"modal",modal:"crit"}),a()})}}let q={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Zt};if(!y&&c){const T=c.bottom+14,S=window.innerHeight-T>190?T:Math.max(12,c.top-200);q={left:Math.min(Math.max(12,c.left+c.width/2-Zt/2),window.innerWidth-Zt-12),top:S,width:Zt}}return qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Xt,top:c.top-Xt,width:c.width+Xt*2,height:c.height+Xt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:q,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(_n,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(_n,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(T=>Math.max(0,T-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(T=>T+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Lr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Mr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ws(){var z,S;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=D(),f=r?a:e,s=m.useMemo(()=>f.filter(j=>dt(j.date)===0&&j.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(j=>j.kind==="target"&&ze(j)===0).slice().sort((j,M)=>(M.date||"").localeCompare(j.date||"")):[],[a,r]),u=m.useMemo(()=>s.filter(j=>r?ze(j)===0:!De(j)),[s,r]),g=r?x:u,p=r?a.length-x.length:s.length-u.length,b=r?a.length:s.length,y=b?Math.min(100,p/b*100):100,h=m.useMemo(()=>Lr(f),[f]),N=!!h&&dt(h)>0,C=m.useMemo(()=>N?f.filter(j=>(j.date||"").slice(0,10)===h):[],[f,h,N]),w=typeof((z=d.stats)==null?void 0:z.kept_today)=="number"?d.stats.kept_today:null,A=typeof((S=d.stats)==null?void 0:S.screened_today)=="number"?d.stats.screened_today:s.length;let q;N?q=i.morningLast(C.length,x.length,Mr(h,l)):r?q=i.morningThesis(A,x.length,w):s.length?p===0?q=i.goalSourced(s.length):p>=s.length?q=i.goalCleared:q=i.goalDone(p,s.length):q=i.goalSourced(0);const T=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(j=>j.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:q}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),g.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:T,children:r?i.morningEval(g.length):o.pileMode?i.goalContinue(g.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ks(){var V,U;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:f,startTour:s,flash:x,flashErr:u}=D(),[g,p]=m.useState(null),[b,y]=m.useState(!0),[h,N]=m.useState([]),C=c==="client";m.useEffect(()=>{if(!i||!o)return;let I=!0;return y(!0),(async()=>{const[W,K]=await Promise.all([rn(o),wr(i)]);I&&(W&&p(W),y(!1),N(K))})(),()=>{I=!1}},[i,o]);const[w,A]=m.useState(!1),q=()=>{!C||w||!o||(A(!0),_o(o).then(I=>{A(!1),I?x(e.identRepubDone):u(e.actErr)}))},T=(g==null?void 0:g.per_day)??null,z=((V=g==null?void 0:g.pool_order)==null?void 0:V.length)??0,S=h.filter(I=>I.status==="running").length,j=m.useMemo(()=>d.filter(I=>I.kind==="target"&&De(I)).length,[d]),M=l.marketEstimate,P=typeof((U=l.stats)==null?void 0:U.screened)=="number"?l.stats.screened:j,F=M&&M>0?Math.min(100,Math.round(P/M*100)):null,_=I=>I.toLocaleString(a==="en"?"en-US":"fr-FR"),v=(o||"P").split(/\s+/).map(I=>I[0]).join("").slice(0,2).toUpperCase(),L=(()=>{const I=Date.parse(l.generatedAt||"");if(Number.isNaN(I))return"";const W=new Date(I),K=X=>String(X).padStart(2,"0");return`${K(W.getDate())}/${K(W.getMonth()+1)} à ${K(W.getHours())}:${K(W.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?v:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),L?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(L)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[F===null&&P>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:_(P)})})]}),F!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:F+"%"}})}),t.jsxs("b",{children:[F," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(P,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),T!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:T})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),T===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),S>0&&t.jsxs("span",{className:"ev",children:["⏳ ",S]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(z)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:I=>{I.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!C||w,onClick:q,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!C,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:I=>n({type:"filters",patch:{search:I.target.value}})})]})]})]})}function js(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=D(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const f=u=>{const g=c.current[u],p=g!==void 0?r[u]-g:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ra[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},s=(u,g,p)=>t.jsxs("button",{type:"button",className:"off"+(g?" view":""),style:{"--c":`var(${Ra[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),x=(u,g,p,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:g,disabled:b,onClick:p,children:u},g);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Ns(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=D(),d=m.useRef(null),[c,f]=m.useState(60);m.useEffect(()=>{let p=0;const b=()=>{var w;const y=d.current;if(!y)return;const h=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!h)return;const N=h.getBoundingClientRect(),C=y.getBoundingClientRect();f(Math.max(20,Math.min(N.left+N.width/2-C.left,C.width-30)))};return p=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const p=n.filter(h=>h.kind==="target"&&ze(h)===3),b=p.filter(h=>Fa(h)==="auto").length,y=p.filter(h=>Fa(h)==="cd").length;x=r.tutoPending(b,y,p.length)}const u=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(s===1){const p=n.filter(b=>b.kind==="target"&&ze(b)===1&&!i.has(b.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(b=>b.id)})}}return null})(),g=Uo(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(g?"":" on-dark"),style:{"--bg":`var(${Ra[s]})`,"--ax":c+"px","--stc":g?"var(--ink)":"#fff","--stt":g?"#fff":"var(--ink)","--tc":g?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class vt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Ss(e){for(const a of e)yield*a}function Rr(e){return Array.from(Ss(e))}var fe=1e-6,se=Math.PI,Ke=se/2,Un=se/4,Je=se*2,st=180/se,Be=se/180,je=Math.abs,Es=Math.atan,Bt=Math.atan2,Ee=Math.cos,Ce=Math.sin,Cs=Math.sign||function(e){return e>0?1:e<0?-1:0},kt=Math.sqrt;function zs(e){return e>1?0:e<-1?se:Math.acos(e)}function _t(e){return e>1?Ke:e<-1?-Ke:Math.asin(e)}function Qe(){}function ma(e,a){e&&Vn.hasOwnProperty(e.type)&&Vn[e.type](e,a)}var Hn={Feature:function(e,a){ma(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)ma(r[n].geometry,a)}},Vn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){$a(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)$a(r[n],a,0)},Polygon:function(e,a){Wn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Wn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)ma(r[n],a)}};function $a(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Wn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)$a(e[r],a,1);a.polygonEnd()}function Nt(e,a){e&&Hn.hasOwnProperty(e.type)?Hn[e.type](e,a):ma(e,a)}function Ba(e){return[Bt(e[1],e[0]),_t(e[2])]}function zt(e){var a=e[0],r=e[1],n=Ee(r);return[n*Ee(a),n*Ce(a),Ce(r)]}function ea(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function fa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Aa(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ta(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function _a(e){var a=kt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ua(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ha(e,a){return je(e)>se&&(e-=Math.round(e/Je)*Je),[e,a]}Ha.invert=Ha;function As(e,a,r){return(e%=Je)?a||r?Ua(Gn(e),Kn(a,r)):Gn(e):a||r?Kn(a,r):Ha}function Yn(e){return function(a,r){return a+=e,je(a)>se&&(a-=Math.round(a/Je)*Je),[a,r]}}function Gn(e){var a=Yn(e);return a.invert=Yn(-e),a}function Kn(e,a){var r=Ee(e),n=Ce(e),i=Ee(a),o=Ce(a);function l(d,c){var f=Ee(c),s=Ee(d)*f,x=Ce(d)*f,u=Ce(c),g=u*r+s*n;return[Bt(x*i-g*o,s*r-u*n),_t(g*i+x*o)]}return l.invert=function(d,c){var f=Ee(c),s=Ee(d)*f,x=Ce(d)*f,u=Ce(c),g=u*i-x*o;return[Bt(x*i+u*o,s*r+g*n),_t(g*r-s*n)]},l}function Ts(e,a,r,n,i,o){if(r){var l=Ee(a),d=Ce(a),c=n*r;i==null?(i=a+n*Je,o=a-c/2):(i=Qn(l,i),o=Qn(l,o),(n>0?i<o:i>o)&&(i+=n*Je));for(var f,s=i;n>0?s>o:s<o;s-=c)f=Ba([l,-d*Ee(s),-d*Ce(s)]),e.point(f[0],f[1])}}function Qn(e,a){a=zt(a),a[0]-=e,_a(a);var r=zs(-a[1]);return((-a[2]<0?-r:r)+Je-fe)%Je}function Fr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Qe,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function sa(e,a){return je(e[0]-a[0])<fe&&je(e[1]-a[1])<fe}function aa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Or(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(p){if(!((b=p.length-1)<=0)){var b,y=p[0],h=p[b],N;if(sa(y,h)){if(!y[2]&&!h[2]){for(i.lineStart(),d=0;d<b;++d)i.point((y=p[d])[0],y[1]);i.lineEnd();return}h[0]+=2*fe}o.push(N=new aa(y,p,null,!0)),l.push(N.o=new aa(y,null,N,!1)),o.push(N=new aa(h,p,null,!1)),l.push(N.o=new aa(h,null,N,!0))}}),!!o.length){for(l.sort(a),Jn(o),Jn(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var f=o[0],s,x;;){for(var u=f,g=!0;u.v;)if((u=u.n)===f)return;s=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(g)for(d=0,c=s.length;d<c;++d)i.point((x=s[d])[0],x[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(g)for(s=u.p.z,d=s.length-1;d>=0;--d)i.point((x=s[d])[0],x[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,s=u.z,g=!g}while(!u.v);i.lineEnd()}}}function Jn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Ta(e){return je(e[0])<=se?e[0]:Cs(e[0])*((je(e[0])+se)%Je-se)}function qs(e,a){var r=Ta(a),n=a[1],i=Ce(n),o=[Ce(r),-Ee(r),0],l=0,d=0,c=new vt;i===1?n=Ke+fe:i===-1&&(n=-Ke-fe);for(var f=0,s=e.length;f<s;++f)if(u=(x=e[f]).length)for(var x,u,g=x[u-1],p=Ta(g),b=g[1]/2+Un,y=Ce(b),h=Ee(b),N=0;N<u;++N,p=w,y=q,h=T,g=C){var C=x[N],w=Ta(C),A=C[1]/2+Un,q=Ce(A),T=Ee(A),z=w-p,S=z>=0?1:-1,j=S*z,M=j>se,P=y*q;if(c.add(Bt(P*S*Ce(j),h*T+P*Ee(j))),l+=M?z+S*Je:z,M^p>=r^w>=r){var F=fa(zt(g),zt(C));_a(F);var _=fa(o,F);_a(_);var v=(M^z>=0?-1:1)*_t(_[2]);(n>v||n===v&&(F[0]||F[1]))&&(d+=M^z>=0?1:-1)}}return(l<-fe||l<fe&&c<-1e-12)^d&1}function Pr(e,a,r,n){return function(i){var o=a(i),l=Fr(),d=a(l),c=!1,f,s,x,u={point:g,lineStart:b,lineEnd:y,polygonStart:function(){u.point=h,u.lineStart=N,u.lineEnd=C,s=[],f=[]},polygonEnd:function(){u.point=g,u.lineStart=b,u.lineEnd=y,s=Rr(s);var w=qs(f,n);s.length?(c||(i.polygonStart(),c=!0),Or(s,Ms,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function g(w,A){e(w,A)&&i.point(w,A)}function p(w,A){o.point(w,A)}function b(){u.point=p,o.lineStart()}function y(){u.point=g,o.lineEnd()}function h(w,A){x.push([w,A]),d.point(w,A)}function N(){d.lineStart(),x=[]}function C(){h(x[0][0],x[0][1]),d.lineEnd();var w=d.clean(),A=l.result(),q,T=A.length,z,S,j;if(x.pop(),f.push(x),x=null,!!T){if(w&1){if(S=A[0],(z=S.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),q=0;q<z;++q)i.point((j=S[q])[0],j[1]);i.lineEnd()}return}T>1&&w&2&&A.push(A.pop().concat(A.shift())),s.push(A.filter(Ls))}}return u}}function Ls(e){return e.length>1}function Ms(e,a){return((e=e.x)[0]<0?e[1]-Ke-fe:Ke-e[1])-((a=a.x)[0]<0?a[1]-Ke-fe:Ke-a[1])}const Xn=Pr(function(){return!0},Rs,Os,[-se,-Ke]);function Rs(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?se:-se,c=je(o-a);je(c-se)<fe?(e.point(a,r=(r+l)/2>0?Ke:-Ke),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=se&&(je(a-n)<fe&&(a-=n*fe),je(o-d)<fe&&(o-=d*fe),r=Fs(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Fs(e,a,r,n){var i,o,l=Ce(e-r);return je(l)>fe?Es((Ce(a)*(o=Ee(n))*Ce(r)-Ce(n)*(i=Ee(a))*Ce(e))/(i*o*l)):(a+n)/2}function Os(e,a,r,n){var i;if(e==null)i=r*Ke,n.point(-se,i),n.point(0,i),n.point(se,i),n.point(se,0),n.point(se,-i),n.point(0,-i),n.point(-se,-i),n.point(-se,0),n.point(-se,i);else if(je(e[0]-a[0])>fe){var o=e[0]<a[0]?se:-se;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ps(e){var a=Ee(e),r=2*Be,n=a>0,i=je(a)>fe;function o(s,x,u,g){Ts(g,e,r,u,s,x)}function l(s,x){return Ee(s)*Ee(x)>a}function d(s){var x,u,g,p,b;return{lineStart:function(){p=g=!1,b=1},point:function(y,h){var N=[y,h],C,w=l(y,h),A=n?w?0:f(y,h):w?f(y+(y<0?se:-se),h):0;if(!x&&(p=g=w)&&s.lineStart(),w!==g&&(C=c(x,N),(!C||sa(x,C)||sa(N,C))&&(N[2]=1)),w!==g)b=0,w?(s.lineStart(),C=c(N,x),s.point(C[0],C[1])):(C=c(x,N),s.point(C[0],C[1],2),s.lineEnd()),x=C;else if(i&&x&&n^w){var q;!(A&u)&&(q=c(N,x,!0))&&(b=0,n?(s.lineStart(),s.point(q[0][0],q[0][1]),s.point(q[1][0],q[1][1]),s.lineEnd()):(s.point(q[1][0],q[1][1]),s.lineEnd(),s.lineStart(),s.point(q[0][0],q[0][1],3)))}w&&(!x||!sa(x,N))&&s.point(N[0],N[1]),x=N,g=w,u=A},lineEnd:function(){g&&s.lineEnd(),x=null},clean:function(){return b|(p&&g)<<1}}}function c(s,x,u){var g=zt(s),p=zt(x),b=[1,0,0],y=fa(g,p),h=ea(y,y),N=y[0],C=h-N*N;if(!C)return!u&&s;var w=a*h/C,A=-a*N/C,q=fa(b,y),T=ta(b,w),z=ta(y,A);Aa(T,z);var S=q,j=ea(T,S),M=ea(S,S),P=j*j-M*(ea(T,T)-1);if(!(P<0)){var F=kt(P),_=ta(S,(-j-F)/M);if(Aa(_,T),_=Ba(_),!u)return _;var v=s[0],L=x[0],V=s[1],U=x[1],I;L<v&&(I=v,v=L,L=I);var W=L-v,K=je(W-se)<fe,X=K||W<fe;if(!K&&U<V&&(I=V,V=U,U=I),X?K?V+U>0^_[1]<(je(_[0]-v)<fe?V:U):V<=_[1]&&_[1]<=U:W>se^(v<=_[0]&&_[0]<=L)){var re=ta(S,(-j+F)/M);return Aa(re,T),[_,Ba(re)]}}}function f(s,x){var u=n?e:se-e,g=0;return s<-u?g|=1:s>u&&(g|=2),x<-u?g|=4:x>u&&(g|=8),g}return Pr(l,d,o,n?[0,-e]:[-se,e-se])}function Ds(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],f=a[1],s=0,x=1,u=c-l,g=f-d,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<s)return;p<x&&(x=p)}else if(u>0){if(p>x)return;p>s&&(s=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>x)return;p>s&&(s=p)}else if(u>0){if(p<s)return;p<x&&(x=p)}if(p=n-d,!(!g&&p>0)){if(p/=g,g<0){if(p<s)return;p<x&&(x=p)}else if(g>0){if(p>x)return;p>s&&(s=p)}if(p=o-d,!(!g&&p<0)){if(p/=g,g<0){if(p>x)return;p>s&&(s=p)}else if(g>0){if(p<s)return;p<x&&(x=p)}return s>0&&(e[0]=l+s*u,e[1]=d+s*g),x<1&&(a[0]=l+x*u,a[1]=d+x*g),!0}}}}}var Ft=1e9,na=-Ft;function Is(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,u){var g=0,p=0;if(f==null||(g=l(f,x))!==(p=l(s,x))||c(f,s)<0^x>0)do u.point(g===0||g===3?e:r,g>1?n:a);while((g=(g+x+4)%4)!==p);else u.point(s[0],s[1])}function l(f,s){return je(f[0]-e)<fe?s>0?0:3:je(f[0]-r)<fe?s>0?2:1:je(f[1]-a)<fe?s>0?1:0:s>0?3:2}function d(f,s){return c(f.x,s.x)}function c(f,s){var x=l(f,1),u=l(s,1);return x!==u?x-u:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=Fr(),u,g,p,b,y,h,N,C,w,A,q,T={point:z,lineStart:P,lineEnd:F,polygonStart:j,polygonEnd:M};function z(v,L){i(v,L)&&s.point(v,L)}function S(){for(var v=0,L=0,V=g.length;L<V;++L)for(var U=g[L],I=1,W=U.length,K=U[0],X,re,ae=K[0],xe=K[1];I<W;++I)X=ae,re=xe,K=U[I],ae=K[0],xe=K[1],re<=n?xe>n&&(ae-X)*(n-re)>(xe-re)*(e-X)&&++v:xe<=n&&(ae-X)*(n-re)<(xe-re)*(e-X)&&--v;return v}function j(){s=x,u=[],g=[],q=!0}function M(){var v=S(),L=q&&v,V=(u=Rr(u)).length;(L||V)&&(f.polygonStart(),L&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),V&&Or(u,d,v,o,f),f.polygonEnd()),s=f,u=g=p=null}function P(){T.point=_,g&&g.push(p=[]),A=!0,w=!1,N=C=NaN}function F(){u&&(_(b,y),h&&w&&x.rejoin(),u.push(x.result())),T.point=z,w&&s.lineEnd()}function _(v,L){var V=i(v,L);if(g&&p.push([v,L]),A)b=v,y=L,h=V,A=!1,V&&(s.lineStart(),s.point(v,L));else if(V&&w)s.point(v,L);else{var U=[N=Math.max(na,Math.min(Ft,N)),C=Math.max(na,Math.min(Ft,C))],I=[v=Math.max(na,Math.min(Ft,v)),L=Math.max(na,Math.min(Ft,L))];Ds(U,I,e,a,r,n)?(w||(s.lineStart(),s.point(U[0],U[1])),s.point(I[0],I[1]),V||s.lineEnd(),q=!1):V&&(s.lineStart(),s.point(v,L),q=!1)}N=v,C=L,w=V}return T}}const Va=e=>e;var qa=new vt,Wa=new vt,Dr,Ir,Ya,Ga,lt={point:Qe,lineStart:Qe,lineEnd:Qe,polygonStart:function(){lt.lineStart=$s,lt.lineEnd=_s},polygonEnd:function(){lt.lineStart=lt.lineEnd=lt.point=Qe,qa.add(je(Wa)),Wa=new vt},result:function(){var e=qa/2;return qa=new vt,e}};function $s(){lt.point=Bs}function Bs(e,a){lt.point=$r,Dr=Ya=e,Ir=Ga=a}function $r(e,a){Wa.add(Ga*e-Ya*a),Ya=e,Ga=a}function _s(){$r(Dr,Ir)}var At=1/0,xa=At,Ut=-At,ha=Ut,ga={point:Us,lineStart:Qe,lineEnd:Qe,polygonStart:Qe,polygonEnd:Qe,result:function(){var e=[[At,xa],[Ut,ha]];return Ut=ha=-(xa=At=1/0),e}};function Us(e,a){e<At&&(At=e),e>Ut&&(Ut=e),a<xa&&(xa=a),a>ha&&(ha=a)}var Ka=0,Qa=0,Ot=0,ba=0,va=0,St=0,Ja=0,Xa=0,Pt=0,Br,_r,nt,rt,Ge={point:yt,lineStart:Zn,lineEnd:er,polygonStart:function(){Ge.lineStart=Ws,Ge.lineEnd=Ys},polygonEnd:function(){Ge.point=yt,Ge.lineStart=Zn,Ge.lineEnd=er},result:function(){var e=Pt?[Ja/Pt,Xa/Pt]:St?[ba/St,va/St]:Ot?[Ka/Ot,Qa/Ot]:[NaN,NaN];return Ka=Qa=Ot=ba=va=St=Ja=Xa=Pt=0,e}};function yt(e,a){Ka+=e,Qa+=a,++Ot}function Zn(){Ge.point=Hs}function Hs(e,a){Ge.point=Vs,yt(nt=e,rt=a)}function Vs(e,a){var r=e-nt,n=a-rt,i=kt(r*r+n*n);ba+=i*(nt+e)/2,va+=i*(rt+a)/2,St+=i,yt(nt=e,rt=a)}function er(){Ge.point=yt}function Ws(){Ge.point=Gs}function Ys(){Ur(Br,_r)}function Gs(e,a){Ge.point=Ur,yt(Br=nt=e,_r=rt=a)}function Ur(e,a){var r=e-nt,n=a-rt,i=kt(r*r+n*n);ba+=i*(nt+e)/2,va+=i*(rt+a)/2,St+=i,i=rt*e-nt*a,Ja+=i*(nt+e),Xa+=i*(rt+a),Pt+=i*3,yt(nt=e,rt=a)}function Hr(e){this._context=e}Hr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Je);break}}},result:Qe};var Za=new vt,La,Vr,Wr,Dt,It,Ht={point:Qe,lineStart:function(){Ht.point=Ks},lineEnd:function(){La&&Yr(Vr,Wr),Ht.point=Qe},polygonStart:function(){La=!0},polygonEnd:function(){La=null},result:function(){var e=+Za;return Za=new vt,e}};function Ks(e,a){Ht.point=Yr,Vr=Dt=e,Wr=It=a}function Yr(e,a){Dt-=e,It-=a,Za.add(kt(Dt*Dt+It*It)),Dt=e,It=a}let tr,ya,ar,nr;class rr{constructor(a){this._append=a==null?Gr:Qs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==ar||this._append!==ya){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,ar=n,ya=this._append,nr=this._,this._=i}this._+=nr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Gr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Qs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Gr;if(a!==tr){const r=10**a;tr=a,ya=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ya}function Js(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Nt(d,i(o))),o.result()}return l.area=function(d){return Nt(d,i(lt)),lt.result()},l.measure=function(d){return Nt(d,i(Ht)),Ht.result()},l.bounds=function(d){return Nt(d,i(ga)),ga.result()},l.centroid=function(d){return Nt(d,i(Ge)),Ge.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,Va):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new rr(r)):new Hr(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new rr(r)),l},l.projection(e).digits(r).context(a)}function pn(e){return function(a){var r=new en;for(var n in e)r[n]=e[n];return r.stream=a,r}}function en(){}en.prototype={constructor:en,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function un(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Nt(r,e.stream(ga)),a(ga.result()),n!=null&&e.clipExtent(n),e}function Kr(e,a,r){return un(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function Xs(e,a,r){return Kr(e,[[0,0],a],r)}function Zs(e,a,r){return un(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function el(e,a,r){return un(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var or=16,tl=Ee(30*Be);function ir(e,a){return+a?nl(e,a):al(e)}function al(e){return pn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function nl(e,a){function r(n,i,o,l,d,c,f,s,x,u,g,p,b,y){var h=f-n,N=s-i,C=h*h+N*N;if(C>4*a&&b--){var w=l+u,A=d+g,q=c+p,T=kt(w*w+A*A+q*q),z=_t(q/=T),S=je(je(q)-1)<fe||je(o-x)<fe?(o+x)/2:Bt(A,w),j=e(S,z),M=j[0],P=j[1],F=M-n,_=P-i,v=N*F-h*_;(v*v/C>a||je((h*F+N*_)/C-.5)>.3||l*u+d*g+c*p<tl)&&(r(n,i,o,l,d,c,M,P,S,w/=T,A/=T,q,b,y),y.point(M,P),r(M,P,S,w,A,q,f,s,x,u,g,p,b,y))}}return function(n){var i,o,l,d,c,f,s,x,u,g,p,b,y={point:h,lineStart:N,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=A},polygonEnd:function(){n.polygonEnd(),y.lineStart=N}};function h(z,S){z=e(z,S),n.point(z[0],z[1])}function N(){x=NaN,y.point=C,n.lineStart()}function C(z,S){var j=zt([z,S]),M=e(z,S);r(x,u,s,g,p,b,x=M[0],u=M[1],s=z,g=j[0],p=j[1],b=j[2],or,n),n.point(x,u)}function w(){y.point=h,n.lineEnd()}function A(){N(),y.point=q,y.lineEnd=T}function q(z,S){C(i=z,S),o=x,l=u,d=g,c=p,f=b,y.point=C}function T(){r(x,u,s,g,p,b,o,l,i,d,c,f,or,n),y.lineEnd=w,w()}return y}}var rl=pn({point:function(e,a){this.stream.point(e*Be,a*Be)}});function ol(e){return pn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function il(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function sr(e,a,r,n,i,o){if(!o)return il(e,a,r,n,i);var l=Ee(o),d=Ce(o),c=l*e,f=d*e,s=l/e,x=d/e,u=(d*r-l*a)/e,g=(d*a+l*r)/e;function p(b,y){return b*=n,y*=i,[c*b-f*y+a,r-f*b-c*y]}return p.invert=function(b,y){return[n*(s*b-x*y+u),i*(g-x*b-s*y)]},p}function sl(e){return ll(function(){return e})()}function ll(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,f=0,s,x=0,u=1,g=1,p=null,b=Xn,y=null,h,N,C,w=Va,A=.5,q,T,z,S,j;function M(v){return z(v[0]*Be,v[1]*Be)}function P(v){return v=z.invert(v[0],v[1]),v&&[v[0]*st,v[1]*st]}M.stream=function(v){return S&&j===v?S:S=rl(ol(s)(b(q(w(j=v)))))},M.preclip=function(v){return arguments.length?(b=v,p=void 0,_()):b},M.postclip=function(v){return arguments.length?(w=v,y=h=N=C=null,_()):w},M.clipAngle=function(v){return arguments.length?(b=+v?Ps(p=v*Be):(p=null,Xn),_()):p*st},M.clipExtent=function(v){return arguments.length?(w=v==null?(y=h=N=C=null,Va):Is(y=+v[0][0],h=+v[0][1],N=+v[1][0],C=+v[1][1]),_()):y==null?null:[[y,h],[N,C]]},M.scale=function(v){return arguments.length?(r=+v,F()):r},M.translate=function(v){return arguments.length?(n=+v[0],i=+v[1],F()):[n,i]},M.center=function(v){return arguments.length?(o=v[0]%360*Be,l=v[1]%360*Be,F()):[o*st,l*st]},M.rotate=function(v){return arguments.length?(d=v[0]%360*Be,c=v[1]%360*Be,f=v.length>2?v[2]%360*Be:0,F()):[d*st,c*st,f*st]},M.angle=function(v){return arguments.length?(x=v%360*Be,F()):x*st},M.reflectX=function(v){return arguments.length?(u=v?-1:1,F()):u<0},M.reflectY=function(v){return arguments.length?(g=v?-1:1,F()):g<0},M.precision=function(v){return arguments.length?(q=ir(T,A=v*v),_()):kt(A)},M.fitExtent=function(v,L){return Kr(M,v,L)},M.fitSize=function(v,L){return Xs(M,v,L)},M.fitWidth=function(v,L){return Zs(M,v,L)},M.fitHeight=function(v,L){return el(M,v,L)};function F(){var v=sr(r,0,0,u,g,x).apply(null,a(o,l)),L=sr(r,n-v[0],i-v[1],u,g,x);return s=As(d,c,f),T=Ua(a,L),z=Ua(s,T),q=ir(T,A),_()}function _(){return S=j=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&P,F()}}function Qr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Qr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(je(i)>fe&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function dl(){return sl(Qr).scale(175.295)}function cl(e){return e}function pl(e){if(e==null)return cl;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var f=2,s=d.length,x=new Array(s);for(x[0]=(a+=d[0])*n+o,x[1]=(r+=d[1])*i+l;f<s;)x[f]=d[f],++f;return x}}function ul(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function ml(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return lr(e,r)})}:lr(e,a)}function lr(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=fl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function fl(e,a){var r=pl(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var u=n[s<0?~s:s],g=0,p=u.length;g<p;++g)x.push(r(u[g],g));s<0&&ul(x,p)}function o(s){return r(s)}function l(s){for(var x=[],u=0,g=s.length;u<g;++u)i(s[u],x);return x.length<2&&x.push(x[0]),x}function d(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function c(s){return s.map(d)}function f(s){var x=s.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":u=o(s.coordinates);break;case"MultiPoint":u=s.coordinates.map(o);break;case"LineString":u=l(s.arcs);break;case"MultiLineString":u=s.arcs.map(l);break;case"Polygon":u=c(s.arcs);break;case"MultiPolygon":u=s.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return f(a)}const Jr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},xl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function hl(e,a,r){const n=Jr[e];if(!n||!n.length)return-1;const i=xl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let ra=null;function gl(){return ra||(ra=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=ml(r,n),o=dl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Js(o),d=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var g;const x=((g=s.properties)==null?void 0:g.name)||"",u=l(s)||"";return u?{i2:Ho(x)||null,n:x,d:u}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,x]of Object.entries(Vo)){const u=o(x);u&&(c[s]={x:u[0],y:u[1]})}const f={};for(const[s,x]of Object.entries(Jr)){const u=x.map(g=>o(g.ll)).filter(g=>!!g).map(([g,p])=>({x:g,y:p}));u.length&&(f[s]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:d,anchors:c,metros:f}}catch{return null}})(),ra)}function bl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return gl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const vl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},dr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function cr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function yl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const c=(f=e.current)==null?void 0:f.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function pr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function wl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:f,dossiers:s,source:x}=D(),u=f.loading&&!s.length,g=m.useRef(null),p=m.useRef(null),b=bl(e.continent==="monde"),y=e.continent==="monde"?b:on.find(v=>v.key===e.continent)||null,h=yl(g,e.continent+":"+e.mapFolded+":"+!!y),[N,C]=m.useState(new Map),[w,A]=m.useState(null);m.useEffect(()=>{const v=g.current;if(!v)return;const L=new Map;v.querySelectorAll("path[data-i2]").forEach(V=>{const U=V.dataset.i2;if(U)try{const I=V.getBBox();I.width>0&&L.set(U,{x:I.x,y:I.y,w:I.width,h:I.height})}catch{}}),C(L)},[e.continent,h,y]);const q=m.useMemo(()=>r.filter(v=>v.cc),[r]),T=m.useMemo(()=>{const v=new Map;return q.forEach(L=>v.set(L.cc,(v.get(L.cc)||0)+1)),v},[q]),z=e.continent==="monde"&&b?b.anchors:null,S=e.continent==="monde"&&b?b.metros:null,j=m.useMemo(()=>q.map(v=>{const L=cr(v.name||v.id||""),V=cr((v.id||v.name||"")+"·y");if(z&&v.cc){const X=S?S[v.cc]:void 0;if(X&&X.length){const ae=hl(v.cc,v.city,L);if(ae>=0&&X[ae])return{d:v,x:X[ae].x+(L-.5)*5,y:X[ae].y+(V-.5)*5}}const re=z[v.cc];if(re)return{d:v,x:re.x+(L-.5)*10,y:re.y+(V-.5)*10}}const U=v.cc?N.get(v.cc):void 0;if(!U)return null;const I=vl[`${e.continent}:${v.cc||""}`];if(I)return{d:v,x:U.x+U.w*(I.fx+(L-.5)*I.sx),y:U.y+U.h*(I.fy+(V-.5)*I.sy)};const W=(L-.5)*Math.min(U.w*.55,60),K=(V-.5)*Math.min(U.h*.55,60);return{d:v,x:U.x+U.w/2+W,y:U.y+U.h/2+K}}).filter(v=>!!v),[q,N,z,S,e.continent]),M=v=>h>0?v/h:v,P=m.useMemo(()=>n?[0,1,2,3,4,5].map(v=>({c:dr[v],fr:c.plabels[v].toUpperCase(),en:c.plabels[v].toUpperCase(),n:r.filter(L=>L.kind==="target"&&ze(L)===v).length})).filter(v=>v.n>0):zn.map((v,L)=>({...v,n:r.filter(V=>An(V)===L).length})),[r,n,c.plabels]),F=o?l.get(o):null,_=F?j.find(v=>v.d.id===F.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(pr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:g,viewBox:y.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{A(null),i(null)},children:[t.jsx("g",{children:y.countries.map((v,L)=>t.jsx("g",{className:"ct"+(v.i2&&T.get(v.i2)?"":" empty"),children:t.jsx("path",{d:v.d,"data-i2":v.i2||void 0})},L))}),t.jsx("g",{children:j.map(v=>{const L=zn[An(v.d)],V=!!qe(v.d),U=v.d.kind==="target",I=n&&U?dr[ze(v.d)]:L.c,W=!n&&De(v.d);return t.jsxs("g",{className:"co"+(W?" done":""),onMouseEnter:()=>{var re,ae;const K=(re=p.current)==null?void 0:re.getBoundingClientRect(),X=(ae=g.current)==null?void 0:ae.createSVGPoint();if(X&&g.current&&K){X.x=v.x,X.y=v.y;const xe=X.matrixTransform(g.current.getScreenCTM());A({x:xe.x-K.left,y:xe.y-K.top,label:v.d.name+" · "+(Lt(v.d.cc,d)||v.d.countryLabel||"")})}i(v.d.id)},onMouseLeave:()=>{A(null),i(null)},onClick:()=>{var re;if(x==="ops"){a({type:"focus",id:v.d.id}),(v.d.noCo||["media","nominations","recrutements"].includes(v.d.engine||""))&&(v.d.url||v.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:v.d.url||"",text:[v.d.headline,v.d.tagline].filter(Boolean).join(`
`)}})):v.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:v.d.name}}));return}const K=(re=g.current)==null?void 0:re.createSVGPoint();let X=null;if(K&&g.current){K.x=v.x,K.y=v.y;const ae=K.matrixTransform(g.current.getScreenCTM());X={x:ae.x,y:ae.y}}a({type:"popup",id:v.d.id,anchor:X})},children:[t.jsx("circle",{className:"h",cx:v.x,cy:v.y,r:M(Math.max(11,L.px+7))}),t.jsx("circle",{className:"v",cx:v.x,cy:v.y,r:M(L.px),fill:I,stroke:V?"#DC2626":"#ffffff",strokeWidth:M(V?2.2:1.3)})]},v.d.id||v.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:P.map((v,L)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":v.c}}),d==="fr"?v.fr:v.en," ",t.jsx("b",{children:v.n})]},L))}),r.some(v=>!v.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(v=>!v.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(pr,{msgs:c.loadMsgs})})}function kl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Xr({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=D(),c=a.filters,[f,s]=m.useState(!1),x=m.useRef(null),u=m.useMemo(()=>a.continent==="monde"?n:n.filter(z=>z.continent===a.continent),[n,a.continent]),g=z=>u.filter(S=>z!=="country"&&c.country.length&&!c.country.includes(S.cc||"")?!1:pa(S,c,o,z==="country"?void 0:z)),p=m.useMemo(()=>{const z=g("win"),S=j=>z.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=j).length;return[S(0),S(7),S(30),z.length]},[u,c,o]),b=m.useMemo(()=>c.day?g("win").filter(z=>(z.date||"").slice(0,10)===c.day).length:0,[u,c,o]),y=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,h=y+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f)return;const z=j=>{var M;(M=x.current)!=null&&M.contains(j.target)||s(!1)},S=j=>{j.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",z),document.addEventListener("keydown",S),()=>{document.removeEventListener("mousedown",z),document.removeEventListener("keydown",S)}},[f]);const N=(z,S,j,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===z,onClick:()=>r({type:"openFacet",facet:z}),children:[t.jsx("span",{className:"fl",children:S}),j>0&&t.jsx("span",{className:"n",children:j}),t.jsx("span",{className:"cv",children:"▾"})]},z),C=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(kl(c.day,d))}),t.jsx("b",{children:b})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((z,S)=>t.jsxs("button",{type:"button","aria-pressed":c.win===z,onClick:()=>r({type:"filters",patch:{win:z}}),children:[t.jsx("span",{className:"sl",children:i.dates[S]}),t.jsx("b",{children:p[S]})]},z))}),w=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:z=>r({type:"filters",patch:{search:z.target.value}})})]}),A=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,c.sector.length),N("pay",i.fCountry,c.country.length),N("det",i.fEngine,c.engine.length),N("sta",i.fStage,c.stage.length),o&&N("ang","Angle",c.angle.length),o&&N("mem","Mémo",c.memoLevel.length)]}),q=(z=!1)=>t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),z&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),T=t.jsxs("div",{className:"fmenu",ref:x,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(y?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(z=>!z),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),y>0&&t.jsx("span",{className:"n",children:y}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:A})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[!c.day&&t.jsx("div",{className:"fstrip-a",children:C}),t.jsxs("div",{className:"fstrip-b",children:[w,T,q(a.mapFolded)]})]}),a.openFacet&&t.jsx(ur,{poolFor:g})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[C,w,A,t.jsx("span",{className:"fgrow"}),q()]}),a.openFacet&&t.jsx(ur,{poolFor:g})]})}function ur({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=D(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:f}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(h=>qe(h)),b=new Map;p.forEach(h=>{const N=h.engine||"";b.set(N,(b.get(N)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Oa([...b.keys()],i).map(h=>({v:h,label:bt(h)+" "+_e(h,i),n:b.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const p=e("sector"),b=new Map;return p.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y,n:h,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const p=e("country"),b=new Map;return p.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:Lt(y,i)||y,n:h,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const p=e("engine"),b=new Map;return p.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Oa([...b.keys()],i).map(y=>({v:y,label:bt(y)+" "+_e(y,i)+' <span style="color:var(--dim);font-size:10px">· '+Wo(Yo(y),i)+"</span>",n:b.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const p=e("angle"),b=new Map;return p.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const p=e("memoLevel"),b=new Map;p.forEach(h=>{if(h.kind==="target"){const N=nn(h);b.set(N,(b.get(N)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:y[h],n:b.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),g=new Map;return u.forEach(p=>{p.stage&&g.set(p.stage,(g.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...g.entries()].sort((p,b)=>b[1]-p[1]).map(([p,b])=>({v:p,label:p,n:b,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),s=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:f.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>s(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Zr({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=D(),c=m.useMemo(()=>{const g={};return r.forEach(p=>{pa(p,n.filters,o)&&(g.monde=(g.monde||0)+1,p.continent&&(g[p.continent]=(g[p.continent]||0)+1))}),g},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const g=b=>{var y;(y=x.current)!=null&&y.contains(b.target)||s(!1)},p=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",g),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",g),document.removeEventListener("keydown",p)}},[f]);const u=g=>{const p=on.find(b=>b.key===g);return g==="monde"?d.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(g=>!g),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Tn.map(g=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===g,onClick:()=>{i({type:"continent",key:g}),s(!1)},children:[u(g),t.jsx("span",{className:"n",children:c[g]||0})]},g))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Tn.map(g=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===g,onClick:()=>i({type:"continent",key:g}),children:[u(g),t.jsx("span",{className:"n",children:c[g]||0})]},g)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function eo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function jl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function mr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=D();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function to({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=D(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(mr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(mr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Nl({card:e,onEvaluate:a,onAddAll:r}){var d,c,f;const{t:n}=D(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:eo(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(to,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function Sl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function El({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=D(),d=i,[c,f]=m.useState(null),[s,x]=m.useState(null),[u,g]=m.useState(null),[p,b]=m.useState(!1);m.useEffect(()=>{let h=!0;return(async()=>{const N=await kr({email:l,cbToken:d});h&&f(N)})(),()=>{h=!1}},[l,d,n]);const y=h=>{x(h),g(null),b(!0),(async()=>{const N=await Go(h.id);g(N),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),g(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[Sl(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(Nl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Ma=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Cl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:f,data:s,canWrite:x,source:u,dossiers:g,doAnalyse:p,liveMemos:b,pipe:y}=D(),h=a==="client",N=m.useMemo(()=>r||(u!=="default"?Ko():""),[r,u]),[C,w]=m.useState(""),[A,q]=m.useState(!1),[T,z]=m.useState(""),[S,j]=m.useState(!1),[M,P]=m.useState(""),[F,_]=m.useState(!1),[v,L]=m.useState(""),[V,U]=m.useState([]),I=m.useRef(!1),[W,K]=m.useState(!1),[X,re]=m.useState(""),[ae,xe]=m.useState(""),[Y,le]=m.useState(!1),[ce,Ne]=m.useState(!1),[ye,ee]=m.useState(0),[Z,Q]=m.useState(""),[H,me]=m.useState(null),[te,pe]=m.useState(null),[ue,he]=m.useState(!1),[$e,Ue]=m.useState(null),[Me,Xe]=m.useState(0),He=m.useRef(!1),ot=C.trim()?Ma.test(C.trim())?e.evalUrl:e.evalName:e.evalWaiting,Le=m.useMemo(()=>M.split(`
`).map(O=>O.trim()).filter(Boolean).slice(0,15),[M]);m.useEffect(()=>{if(typeof window>"u")return;const O=new URLSearchParams(window.location.search),ne=(O.get("rs")||"").trim(),de=(O.get("rstext")||"").trim();ne&&/^https?:\/\//i.test(ne)&&re(ne),de&&xe(de),(ne&&/^https?:\/\//i.test(ne)||de)&&K(!0)},[]),m.useEffect(()=>{const O=ne=>{const de=ne.detail||{},be=String(de.url||"").trim(),Ve=String(de.text||"").trim();be&&/^https?:\/\//i.test(be)&&re(be),Ve&&xe(Ve),(be&&/^https?:\/\//i.test(be)||Ve)&&(K(!0),w(""),z(""),le(!0),window.setTimeout(()=>le(!1),900))};return window.addEventListener("ppmap:research",O),()=>window.removeEventListener("ppmap:research",O)},[]),m.useEffect(()=>{const O=ne=>{const de=ne.detail||{},be=String(de.name||"").trim();be&&(K(!1),w(be),z(be),q(!0),window.setTimeout(()=>q(!1),900))};return window.addEventListener("ppmap:prefill",O),()=>window.removeEventListener("ppmap:prefill",O)},[]),m.useEffect(()=>{if(typeof window>"u"||u!=="ops")return;const O=document.querySelector(".atl2.ops .eval-stick")||document.querySelector(".atl2.ops .demand"),ne=document.querySelector(".atl2.ops");if(!O||!ne)return;const de=()=>ne.style.setProperty("--demand-h",`${O.offsetHeight}px`);de();const be=new ResizeObserver(de);return be.observe(O),()=>be.disconnect()},[u,A,Y,S,W]),m.useEffect(()=>{if(!x&&!N){Ue(null);return}let O=!0;return(async()=>{const ne=await kr({email:n,cbToken:N});O&&Ue(ne.length)})(),()=>{O=!1}},[x,N,n,Me]);const ut=V.length?V:c,E=s.credits,$=m.useCallback(O=>{const ne=O.map(de=>(de||"").trim()).filter(Boolean);ne.length&&(P(de=>{const be=de.split(`
...
`)}),j(!0))},[]);m.useEffect(()=>{if(!ce)return;ee(0);const O=window.setInterval(()=>ee(ne=>ne+1),1e3);return()=>window.clearInterval(O)},[ce]);const G=m.useMemo(()=>{const O=C.trim().toLowerCase();return!O||!y?null:g.find(ne=>Ye(ne.name)===O&&ze(ne)===1)||null},[C,g,y]),oe=()=>{const O=C.trim();if(O){if(G){p(G);return}i(null,O),h&&w("")}},we=async()=>{if(!h){i(null,Le[0]||"");return}if(!Le.length||F)return;_(!0),I.current=!1;const O=[];for(let ne=0;ne<Le.length&&!I.current;ne++){L(e.evaluating(ne+1,Le.length,Le[ne]));const de=await jr(r,Le[ne],"atelier2");if(O.unshift({name:de.company||Le[ne],verdict:de.verdict,reason:de.reason||"",remaining:de.remaining??null}),U([...O]),de.verdict==="quota"){O.unshift({name:"",verdict:"quota",reason:e.quota(Le.length-ne-1),remaining:0}),U([...O]),P(Le.slice(ne+1).join(`
`)),L(""),_(!1);return}}L(""),P(I.current?Le.slice(O.length).join(`
`):""),_(!1)},ge=async()=>{var de,be,Ve;if(He.current)return;const O=X.trim().replace(/\s+/g,""),ne=ae.trim();if(!O&&!ne){Q(e.rsNeed);return}if(!h&&!N){i(null,O||ne.slice(0,80));return}He.current=!0,Q(""),me(null),pe(null),Ne(!0);try{const Pe=await Jo({url:O,text:ne,email:n,cbToken:N});if(Ne(!1),!Pe||Pe.status!=="success"){Q((Pe==null?void 0:Pe.message)||"Erreur");return}me(Pe),K(!1),$((((de=Pe.prospective)==null?void 0:de.companies_to_evaluate)||[]).map(We=>(We==null?void 0:We.name)||"")),pe({state:"pending"});const Se=await Xo(Pe,{email:n,cbToken:N});pe(Se.ok?{state:"ok",scopeLabel:((be=Se.summary)==null?void 0:be.scope_label)||"",scope:((Ve=Se.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:Se.error||""}),Se.ok&&Xe(We=>We+1)}finally{He.current=!1,Ne(!1)}},Oe=[H==null?void 0:H.industry,...(H==null?void 0:H.market_tags)||[],H==null?void 0:H.author].map(O=>(O||"").trim()).filter(Boolean),et=(te==null?void 0:te.state)==="pending",jt=te&&(et?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):te.state==="ok"?t.jsx("span",{className:"rslink ok",children:te.scope&&te.scope!=="public"?e.rsSavedIn(te.scopeLabel||te.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:te.msg,children:e.rsSaveFail})),mt=jl(H).length,Ae=W,tt=(T||C).trim(),ct=G?e.actAnalyse:tt?e.evalGoOn(tt.length>22?tt.slice(0,21)+"…":tt):e.evalGo,it=ce?`${Qo(X.trim())==="youtube"&&X.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ye)}`:et?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ae?" rs-mode":"")+(T&&C.trim()===T||A||Y?" pair":"")+(A||Y?" echo":""),children:[t.jsxs("div",{className:"drow"+((Ae?Y:A)?" flash":"")+((Ae?X.trim():Ma.test(C.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ae?X:C,placeholder:Ae?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ae?600:200,spellCheck:Ae?!1:void 0,inputMode:Ae?"url":void 0,onChange:O=>{if(Ae){re(O.target.value);return}w(O.target.value),T&&O.target.value.trim()!==T&&z("")},onKeyDown:O=>{O.key==="Enter"&&(Ae?ge():oe())}}),!Ae&&t.jsx("span",{className:"detect"+(Ma.test(C.trim())?" url":""),children:ot})]}),Ae?t.jsxs("button",{type:"button",className:"evalbtn"+(ce?" loading":""),disabled:ce||et||!X.trim()&&!ae.trim(),onClick:()=>{ge()},children:[t.jsx("span",{className:"fill"}),it]}):t.jsxs("button",{type:"button",className:"evalbtn"+(G?" analyse":"")+(d?" loading":""),disabled:d,onClick:oe,children:[t.jsx("span",{className:"fill"}),ct]}),f.showCredits&&E&&t.jsxs("button",{type:"button",className:"credits"+(E.total_available<=0&&!E.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:E.unlimited?"∞":E.total_available}),!E.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",E.daily_grant+E.purchased]}),E.total_available<=0&&!E.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(O=>O.status==="boot"||O.status==="running").map(O=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:O.name}),t.jsx($t,{item:O,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+O.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>j(!S),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(W?" on":""),onClick:()=>K(!W),children:e.rsOpen}),$e!==null&&$e>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(ue?" on":""),onClick:()=>he(!ue),children:e.rsArchOpen($e)})]}),ue&&t.jsx(El,{bump:Me,cbToken:N,onClose:()=>he(!1),onEvaluate:O=>i(null,O),onAddAll:$}),W&&t.jsxs("div",{className:"rsp on slim",children:[t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:ae,placeholder:e.rsTextPh,onChange:O=>xe(O.target.value)})]}),Z&&t.jsx("div",{className:"rserr",children:Z}),H&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:H.title}),H.source_url&&t.jsx("a",{href:H.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{me(null),pe(null)},children:"×"})]}),H.market&&t.jsx("p",{className:"rsmk",children:H.market}),Oe.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Oe.map(O=>t.jsx("span",{children:O},O))]}),t.jsxs("div",{className:"rsbody",children:[H.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${H.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:eo(H.summary_md||"").map((O,ne)=>t.jsx("p",{children:O},ne))})]}),t.jsx(to,{card:H,onEvaluate:O=>i(null,O),onAddAll:$}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(mt)}),jt]})]}),S&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:M,placeholder:e.bulkPh,onChange:O=>P(O.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(F?" loading":""),style:{justifyContent:"center"},disabled:F||!Le.length,onClick:()=>{we()},children:[t.jsx("span",{className:"fill"}),F&&v?v:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(Le.length)})]})]}),ut.slice(0,1).map((O,ne)=>{const de=O.verdict==="kept",be=O.verdict==="quota",Ve=de?"var(--brand)":be?"var(--bolt)":"var(--red)",Pe=de?"var(--brand-l)":be?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":Pe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:de?"✓ "+e.kept:be?"⏳":"✗ "+e.dropped})}),O.name&&t.jsx("span",{className:"rn",children:O.name}),t.jsx("span",{className:"rr",children:O.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",O.reason]}):null}),!!(O.candidates&&O.candidates.length)&&t.jsx("span",{className:"sitepick",children:O.candidates.map(Se=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Se.url.startsWith("http")?Se.url:`https://${Se.url}`,target:"_blank",rel:"nofollow noopener",children:[(Se.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Se.url),children:e.evalPickGo})]},Se.url))}),!be&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:de?1:5});const Se=(O.name||"").trim().toLowerCase();window.setTimeout(()=>{const We=[...document.querySelectorAll(".atl2 .list .row")].find(ka=>{var Gt;return(((Gt=ka.querySelector(".rnm"))==null?void 0:Gt.textContent)||"").trim().toLowerCase().includes(Se)});We&&(We.scrollIntoView({behavior:"smooth",block:"center"}),We.classList.add("flashrow"),window.setTimeout(()=>We.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(de?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),h&&(o.kept+o.dropped>0||ut.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function zl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Al(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=D(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",zl(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const d=pt(o),c=nn(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),d&&t.jsx("span",{className:"vv",children:d}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((f,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Ct(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function mn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=D(),[l,d]=m.useState(!1),[c,f]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,x=async()=>{if(!s||l)return;d(!0);const u=await Zo(r,e);if(d(!1),!u){o(a.actErr);return}f(u.results||[])};return m.useEffect(()=>{if(!s)return;const u=g=>{var b;const p=String(((b=g.detail)==null?void 0:b.name)||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,s]),m.useEffect(()=>{if(s)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Tl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),oa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ql(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=oa(a.slice(n));break}r+=oa(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=oa(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Tl.has(c)?r+=`<${d[1]}${c}>`:r+=oa(a.slice(i,o+1)),n=o+1}return r}const fr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Fe({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ll(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ml({o:e}){const{t:a,doDeep:r}=D(),[n,i]=m.useState(!1),o=pt(e),l=[e.reasoning||"",Ll(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Ct(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function fn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=D(),o=Wt(e),l=pt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Ct(e)?1:0}].filter(b=>b.n>0),[e,a,d,l,c,f,s]),[u,g]=m.useState("");if(!x.length)return null;const p=x.some(b=>b.k===u)?u:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===b.k,"data-tour":"tab-"+b.k,className:p===b.k?"on":"",onClick:y=>{y.stopPropagation(),g(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Fe,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Fe,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Fe,{k:a.cdVerdictDate,v:fr(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:ql(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Rl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Fe,{k:a.cdSector,v:e.sector}),t.jsx(Fe,{k:a.cdStage,v:e.stage}),t.jsx(Fe,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Fe,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Fe,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Fe,{k:a.cdAngle,v:e.angle}),t.jsx(Fe,{k:a.cdDetected,v:fr(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Fe,{k:a.cdName,v:e.contactName}),t.jsx(Fe,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Fe,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(Ml,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Fe,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Fe,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Rl({o:e}){const{t:a,token:r}=D(),[n,i]=m.useState(!1),[o,l]=m.useState(null),d=async()=>{n||(i(!0),l(await ei(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=f.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[f.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Yt({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const d=()=>{const f=Math.max(280,Math.min(560,o.clientWidth||320));qn({kind:"op",card:e},f).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;qn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const d=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&qt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Fl=`
