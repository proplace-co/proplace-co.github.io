...
.atl2 .app > .fzone:has(.stage.folded){position:sticky;top:var(--pp-gap,68px);
  z-index:33;background:var(--panel);box-shadow:0 4px 12px rgba(15,23,42,.06)}
.atl2:has(> .lockbar.on) .app > .fzone:has(.stage.folded){
  top:calc(var(--pp-gap,68px) + 46px)}
body.pp-navfold .atl2 .app > .fzone:has(.stage.folded){top:26px}
/* l'en-tête de liste se cale SOUS elle, sinon les deux se superposent */
.atl2 .app:has(.stage.folded) .listhead{top:calc(var(--pp-gap,68px) + 118px)}
.atl2:has(> .lockbar.on) .app:has(.stage.folded) .listhead{
  top:calc(var(--pp-gap,68px) + 164px)}
...
/* ── LA BOX VERTE, ALIGNÉE COMME LA ROUGE : même axe, mêmes marges, mêmes
   contrôles à droite. Les deux se lisent l'une sous l'autre, donc elles doivent
   s'aligner ou l'œil décroche. */
.atl2 .since{margin:0 0 8px}
.atl2 .since-h{gap:9px}
.atl2 .since-h b{flex:1 1 auto;min-width:0}
.atl2 .since-c{display:flex;flex-wrap:wrap;gap:5px;margin-top:8px}
...
`,ei=Xo+Zo;function ma(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function ti(){const e=ma("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function ai(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=ti();return r==="0"?"client":r==="1"||ma("embed")==="1"&&ma("chrome")==="1"?"apercu":"client"}const ni={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},ri=e=>ni[e];function oi(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Ke=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Vn(a)||oi(a))&&(e.noCo=!0)}return Object.assign(e,{continent:eo(e.cc)})};function ta(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const ii=60*60*1e3;function si(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>ii?null:a}catch{return null}}function At(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const li=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function ci(e,a,r="default"){const n=r!=="default",i=f.useMemo(()=>e||n?{mode:"anon"}:Hr(),[e,n]),o=f.useMemo(()=>n?"visiteur":ai(e,i),[e,i,n]),l=f.useMemo(()=>ri(o),[o]),s=o!=="visiteur",p=li(r),[x,d]=f.useState([]),[m,u]=f.useState(""),[b,c]=f.useState(null),[g,v]=f.useState(null),[h,j]=f.useState(null),[w,y]=f.useState(()=>new Map),[k,L]=f.useState(()=>new Map),[q,z]=f.useState(""),[A,O]=f.useState(new Set),[E,M]=f.useState(null),[$,N]=f.useState(!0),[C,R]=f.useState(!1),[B,V]=f.useState(0),[U,Z]=f.useState(0),Y=f.useRef(0),ee=f.useMemo(()=>{var _;if(o!=="client")return"";try{return((_=Wr())==null?void 0:_.email)||""}catch{return""}},[o]);f.useEffect(()=>{const _=++Y.current;let G=!0;const Q=()=>G&&_===Y.current,te=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),le=si(te);return le?(d(le.objs.map(Ke)),le.fund&&u(le.fund),c(le.marketEstimate??null),v(le.criteria??null),j(le.stats??null),z(le.generatedAt||""),N(!1)):N(!0),(async()=>{try{if(r==="ops"){const we=await Xt(),ue=((we==null?void 0:we.recent_ops)||[]).map(X=>{const oe=Zt(X.company_name||X.title?X:{...X,title:(X.headline_fr||X.headline||"").slice(0,120)},a),he=String(X.rubrique||"").toLowerCase();return oe&&(he==="nominations"||he==="recrutements")&&(oe.engine=he),oe&&!String(X.company_name||"").trim()&&(oe.noCo=!0),oe}).filter(X=>!!X).map(X=>(Vn((X.name||"").trim())||(X.noCo=!0),X));try{const X=await Yr(),oe=Gr(X),he=((X==null?void 0:X.date)||"").slice(0,10);if(oe.length&&he){const T=new Set;for(const F of ue){if(F.noCo||(F.date||"").slice(0,10)!==he)continue;const I=Wa(oe,T,F.name,"");I>=0&&(T.add(I),F.decryptHtml=oe[I].html)}for(const F of ue){if(F.decryptHtml||(F.date||"").slice(0,10)!==he)continue;const I=Wa(oe,T,"",F.headline||F.tagline||F.name);I>=0&&(T.add(I),F.decryptHtml=oe[I].html)}}}catch{}if(!Q())return;d(ue.map(Ke)),At(te,{objs:ue})}else if(typeof r=="object"){const ue=(await Ya()||[]).filter(oe=>(oe.slug||"")===r.research).map(oe=>Ga(oe,a)).filter(oe=>!!oe),X=ta(await Ka(ue,a));if(!Q())return;d(X.map(Ke)),At(te,{objs:X})}else if(s&&i.token){const we=Kr(i.token),ue=Xt(),X=Qr(i.token),oe=Jr(i.token),he=Xr(i.token),T=await we;let F=T?T.targets:[];Q()&&T&&(u(T.fund||""),c(T.marketEstimate??null),v(T.criteria??null),j(T.stats??null),z(T.generatedAt||""),d(F.map(Ke)),N(!1),R(!1));const[I,J,ae,ne]=await Promise.all([ue,X,oe,he]),xe=((I==null?void 0:I.recent_ops)||[]).map(ke=>Zt(ke,a)).filter(ke=>!!ke);if(F=[...F,...xe],!Q())return;d(F.map(Ke));const Fe=new Set;for(const ke of J){const ze=(ke.id||ke.co||"").toString().trim().toLowerCase();ze&&Fe.add(ze.startsWith("t:")?ze:"t:"+ze)}O(Fe),y(ae),L(ne),T&&At(te,{fund:T.fund,marketEstimate:T.marketEstimate,criteria:T.criteria,stats:T.stats,generatedAt:T.generatedAt,objs:F})}else{const we=Zr(),ue=Ya(),X=Xt(),oe=await we;Q()&&oe.length&&(d(ta(oe).map(Ke)),N(!1),R(!1));const[he,T]=await Promise.all([ue,X]),F=(he||[]).map(ne=>Ga(ne,a)).filter(ne=>!!ne),I=await Ka(F,a),J=((T==null?void 0:T.recent_ops)||[]).map(ne=>Zt(ne,a)).filter(ne=>!!ne),ae=ta([...oe,...I,...J]);if(!Q())return;d(ae.map(Ke)),At(te,{objs:ae})}Q()&&R(!1)}catch{Q()&&!le&&R(!0)}finally{Q()&&N(!1)}})(),()=>{G=!1}},[s,i.token,a,B,p]),f.useEffect(()=>{if(!l.showCredits||!ee){M(null);return}let _=!0;return(async()=>{try{const G=await fetch(`${Ta}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ee})});if(!G.ok)return;const Q=await G.json();_&&Q&&Q.ok!==!1&&M(Q)}catch{}})(),()=>{_=!1}},[l.showCredits,ee,U]);const K=f.useCallback(_=>O(new Set(_)),[]);return{session:i,mode:o,caps:l,fund:m,email:ee,marketEstimate:b,generatedAt:q,criteria:g,stats:h,thumbs:w,stages:k,dossiers:x,favIds:A,setFavIds:K,credits:E,reloadCredits:()=>Z(_=>_+1),loading:$,error:C,refresh:()=>V(_=>_+1)}}const Gn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),di=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Gn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function pi(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Gn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Kn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Kn=40;function Ma(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ve(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(za(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(We(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Je(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function Qn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ma(e,a.filters,r)}function ui(e,a,r,n){return!(!Qn(e,a,r)||r&&!to(e,a.ptab,n))}function Oa(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-We(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=ve(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const mi=["ma","levees","nominations","recrutements","actualites"],fi=300,aa=7,hi={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Jn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},xi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function nn(e){const a=ve(e);if(a)return"sig:"+(a.theme&&Jn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function gi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:s}=P(),p=l==="en",[x,d]=f.useState("all"),[m,u]=f.useState(!1),b=f.useMemo(()=>{const E=(a.filters.day||"").slice(0,10),M=R=>{if(!o&&a.continent!=="monde"&&R.continent!==a.continent||E&&(R.date||"").slice(0,10)!==E)return!1;if(o&&R.kind==="op"){const B=(s||"").trim().toLowerCase();if(!B)return!1;const V=R.match||null;if(!V||!Object.keys(V).map(Z=>Z.trim().toLowerCase()).includes(B))return!1}return!0},$=e.filter(R=>M(R)&&ve(R)&&(!o||R.kind!=="target"||ye(R)!==5)),N=e.filter(R=>M(R)&&R.kind==="op"&&!ve(R)&&(E?!0:We(R.date)<=aa)),C=E||new Date().toISOString().slice(0,10);return N.sort((R,B)=>{const V=(R.date||"").slice(0,10)===C?0:1,U=(B.date||"").slice(0,10)===C?0:1;return V!==U?V-U:(B.amountEur||0)-(R.amountEur||0)}),[...Oa($,{key:"signal",dir:-1}),...N]},[e,a.continent,a.filters.day,o,s]),c=f.useMemo(()=>{const E={};for(const M of b){const $=nn(M);E[$]=(E[$]||0)+1}return E},[b]),g=f.useMemo(()=>x==="all"?b:b.filter(E=>nn(E)===x),[b,x]),v=f.useMemo(()=>g.slice(0,fi),[g]),h=g.length-v.length,j=f.useRef(null);f.useEffect(()=>{var R,B;const E=j.current;if(!E)return;const M=()=>{const V=E.scrollWidth;V<200||(E.style.animationDuration=Math.max(18,Math.round(V/130))+"s")};M();const $=requestAnimationFrame(M),N=window.setTimeout(M,1200);let C=!0;return(B=(R=document.fonts)==null?void 0:R.ready)==null||B.then(()=>{C&&M()}),()=>{C=!1,cancelAnimationFrame($),window.clearTimeout(N)}},[v.length,x]);const w=E=>E==="all"?b.length:c[E]||0,y=E=>E==="all"?p?"All":"Tout":E.startsWith("sig:")?Jn[p?"en":"fr"][E.slice(4)]||"🔔":hi[p?"en":"fr"][E],k=[{k:"all"}],L=mi.filter(E=>w(E)>0||E===x);if(L.length){k.push({g:p?"DEALS":"OPÉRATIONS"});for(const E of L)k.push({k:E})}const q=xi.map(E=>"sig:"+E).filter(E=>w(E)>0||E===x);if(q.length){k.push({g:p?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const E of q)k.push({k:E})}const z=E=>{try{return new Date(E+"T12:00:00Z").toLocaleDateString(p?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return E}},A=(()=>{const E=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?p?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return E?(p?`LIVE covers the events of ${z(E)}.`:`Le LIVE regroupe les événements du ${z(E)}.`)+M:(p?`LIVE covers the still-open signals and the deals of the last ${aa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${aa} derniers jours.`)+M})(),O=E=>v.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Te(M)?" spent":""),onClick:$=>{const N=$.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:N.left+N.width/2,y:N.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(tt,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(zr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Kl(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Qt,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},E+(M.id||M.name))).concat(h>0?[t.jsx("span",{className:"tk quiet",children:p?`+ ${h} more — filter by section to see them`:`+ ${h} autres — filtrez par rubrique pour les voir`},E+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:E=>{E.currentTarget.contains(E.relatedTarget)||u(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>u(E=>!E),children:[y(x),t.jsx("b",{children:w(x)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:A}),k.map(E=>"g"in E?t.jsx("span",{className:"tkfilg",children:E.g},E.g):t.jsxs("button",{type:"button","aria-pressed":E.k===x,onClick:()=>{d(E.k),u(!1)},children:[y(E.k),t.jsx("b",{children:w(E.k)})]},E.k))]})]}),t.jsx("div",{className:"win",children:v.length?t.jsxs("div",{className:"run",ref:j,children:[O(0),O(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const bi="aDx8z7Hzksus",Fa="+33 6 83 10 72 86",It="alexandre@proplace.co",Xn=`tel:${Fa.replace(/[^\d+]/g,"")}`,rn="pp-rdv-slot";function vi(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function yi(){const{t:e,caps:a,fund:r}=P();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:ki}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Xn,children:Fa}),e.rdvSubMid,t.jsx("a",{href:`mailto:${It}`,children:It})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Go,{filloutId:bi,parameters:r?{company_name:r}:void 0})})]})}function wi(){const[e,a]=f.useState(()=>typeof document>"u"?null:document.getElementById(rn));return f.useEffect(()=>{e||a(document.getElementById(rn))},[e]),e?dt.createPortal(t.jsx(yi,{}),e):null}const ki=`
...
`;class Ee extends f.Component{constructor(){super(...arguments);Va(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const na=600,Qe=62,on="atl2:fstats";function ji(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=P(),[l,s]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(on)==="on"}catch{return!1}}),p=r.stats,x=f.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=(p==null?void 0:p.since)||"";if(!n.showFunnel||!p||typeof p.screened!="number")return null;const m=k=>a==="en"?k.slice(5,10):`${k.slice(8,10)}/${k.slice(5,7)}`,u=k=>k.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((k,L)=>Math.max(k,L.s||0),0),c=x.length?na/x.length:0,g=Math.max(4,c-4),v=x.length>=5&&b>0,h=r.marketEstimate||0,j=m(new Date().toISOString().slice(0,10)),w=k=>[...typeof k=="number"?[[k,e.funScreened("","")]]:[],...typeof p.kept=="number"?[[p.kept,e.funKept]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown]]:[]],y=[];return typeof p.screened_window=="number"&&d&&y.push({cle:"fenetre",periode:e.funPerWindow(m(d),j),etapes:[[p.screened_window,e.funScreened("","")]]}),typeof p.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:w(p.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(k=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:k.periode}),k.etapes.map(([L,q],z)=>t.jsxs("span",{className:"fst-t",children:[z>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(L)}),t.jsx("i",{children:q})]},k.cle+q)),k.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((p.screened||0)/h*100)))})]}),k.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const L=!l;s(L),L&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(on,L?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},k.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${na} ${Qe}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((k,L)=>{const q=(k.s||0)/b*(Qe-4),z=(k.m||0)/b*(Qe-4),A=L*c+(c-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(k.d)} — ${k.s} ${e.actScreened} · ${k.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:Qe-2-q,width:g,height:q,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:Qe-2-z,width:g,height:z,fill:"#185c38"})]},k.d)}),t.jsx("line",{x1:0,y1:Qe-1.5,x2:na,y2:Qe-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Zn=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Ni(e,a){if((Ye(e)||"").startsWith("CALL")&&ye(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ye(e)>=2;return Zn.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function Si({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=P(),[s,p]=f.useState(!1),[x,d]=f.useState(""),[m,u]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),c=async g=>{if(x)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}d(g);const v=await i(e,g);d(""),v&&(p(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{p(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:m?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),p(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{d("Analysé");const g=await i(e,"Analysé");d(""),g&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]}):Ni(e,a).map(([g,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(x===g?" busy":""),disabled:!!x,onClick:()=>{c(g)},children:v},g))})]})}function Ei({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=P(),[o,l]=f.useState(""),[s,p]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),d=(Ye(e)||"").startsWith("CALL")&&ye(e)===3,m=ye(e)>=2,u=async c=>{if(o||c==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(c);const g=await i(e,c);l(""),g&&(p(!0),setTimeout(()=>p(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:Zn.filter(([c])=>!(m&&c==="Retenu")).map(([c,g])=>[c,a[g]]);return t.jsxs("div",{className:"csp",onClick:c=>c.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([c,g])=>t.jsx("button",{type:"button",className:"csb"+(x===c?" on":"")+(o===c?" busy":""),disabled:!!o,onClick:()=>{u(c)},children:g},c)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Ci,{o:e})]})}function Ci({o:e}){const{t:a,saveNote:r,flash:n}=P(),[i,o]=f.useState(e.ceoNote||""),[l,s]=f.useState(!1),[p,x]=f.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{m()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Ai({placeholder:e,onDone:a}){const{t:r}=P(),[n,i]=f.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function Ti({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=P(),[p,x]=f.useState(!1);if(!n.pipe||!i||n.lockActions||ye(e)!==4)return null;const d=o(e),m=(d==null?void 0:d.stage)||"todo",u=async h=>{if(p||h===m)return;x(!0);const j=d;l(e,{stage:h,stamps:(d==null?void 0:d.stamps)||{}});const w=Math.max(Date.now(),sn+=1);sn=w;const y=await ao(r,{company:e.name||"",stage:h,cts:w,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(l(e,j),s(a.actErr)))},b=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,c=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&c>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,j])=>t.jsx("button",{type:"button",className:"stgb"+(m===h?" on":""),disabled:p,onClick:()=>{u(h)},children:j},h)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(c)})]})}let sn=0;const Tt=8,zt=360;function ln({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function cn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(ln,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(ln,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function zi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=P(),[l,s]=f.useState(0),[p,x]=f.useState(null),[d,m]=f.useState([]),u=f.useRef(!1),b=f.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),c=f.useRef(!1);f.useEffect(()=>{const q=b.current;return()=>{c.current||(n({type:"ptab",tab:q.ptab}),n({type:"dens",dens:q.dens}),n({type:"modal",modal:q.modal}))}},[]),f.useEffect(()=>{u.current||(u.current=!0,m(e.filter(q=>!!document.querySelector(q.need||q.sel))))},[e]);const g=d[l],v=l>=d.length;f.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const q=g.click,z=window.setTimeout(()=>{const A=document.querySelector(q);A&&A.getAttribute("aria-selected")!=="true"&&A.click()},60);return()=>window.clearTimeout(z)}},[l,g]);const h=f.useRef(-1),j=f.useCallback(()=>{if(!g){x(null);return}const q=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!q){x(null);return}h.current!==l&&(h.current=l,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const z=q.getBoundingClientRect();x(A=>A&&Math.abs(A.top-z.top)<1&&Math.abs(A.left-z.left)<1&&Math.abs(A.width-z.width)<1&&Math.abs(A.height-z.height)<1?A:z)},[g,l]);f.useLayoutEffect(()=>{j();const q=[90,300,700,1300].map(A=>window.setTimeout(j,A)),z=()=>j();return window.addEventListener("scroll",z,!0),window.addEventListener("resize",z),()=>{q.forEach(A=>window.clearTimeout(A)),window.removeEventListener("scroll",z,!0),window.removeEventListener("resize",z)}},[j]);const w=f.useRef(a);if(w.current=a,f.useEffect(()=>{const q=z=>{z.key==="Escape"?(z.preventDefault(),z.stopPropagation(),w.current()):z.key==="ArrowRight"?s(A=>A+1):z.key==="ArrowLeft"&&s(A=>Math.max(0,A-1))};return document.addEventListener("keydown",q,!0),()=>document.removeEventListener("keydown",q,!0)},[]),!d.length)return null;let y=null;const k=q=>()=>{c.current=!0,n({type:"modal",modal:null}),q()};if(v){const q=i[3]||0;q>0?y={title:q===1?r.ahaATitle1:r.ahaATitleN(q),body:r.ahaABody,btn:r.ahaABtn,go:k(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:k(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:k(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:k(()=>{n({type:"modal",modal:"crit"}),a()})}}let L={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:zt};if(!v&&p){const q=p.bottom+14,A=window.innerHeight-q>190?q:Math.max(12,p.top-200);L={left:Math.min(Math.max(12,p.left+p.width/2-zt/2),window.innerWidth-zt-12),top:A,width:zt}}return dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-Tt,top:p.top-Tt,width:p.width+Tt*2,height:p.height+Tt*2}}),(v||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:L,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(cn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(cn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(q=>Math.max(0,q-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(q=>q+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function er(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function tr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function qi(){var z,A;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:s,dispatch:p}=P(),x=r?a:e,d=f.useMemo(()=>x.filter(O=>We(O.date)===0&&O.kind==="target"),[x]),m=f.useMemo(()=>r?a.filter(O=>O.kind==="target"&&ye(O)===0).slice().sort((O,E)=>(E.date||"").localeCompare(O.date||"")):[],[a,r]),u=f.useMemo(()=>d.filter(O=>r?ye(O)===0:!Te(O)),[d,r]),b=r?m:u,c=r?a.length-m.length:d.length-u.length,g=r?a.length:d.length,v=g?Math.min(100,c/g*100):100,h=f.useMemo(()=>er(x),[x]),j=!!h&&We(h)>0,w=f.useMemo(()=>j?x.filter(O=>(O.date||"").slice(0,10)===h):[],[x,h,j]),y=typeof((z=s.stats)==null?void 0:z.kept_today)=="number"?s.stats.kept_today:null,k=typeof((A=s.stats)==null?void 0:A.screened_today)=="number"?s.stats.screened_today:d.length;let L;j?L=i.morningLast(w.length,m.length,tr(h,l)):r?L=i.morningThesis(k,m.length,y):d.length?c===0?L=i.goalSourced(d.length):c>=d.length?L=i.goalCleared:L=i.goalDone(c,d.length):L=i.goalSourced(0);const q=()=>{if(!r){p({type:"pile",on:!0});return}p({type:"ptab",tab:0}),n==="client"&&m.length&&p({type:"chainStart",queue:m.map(O=>O.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:L}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:q,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Li(){var B,V;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:x,startTour:d,flash:m,flashErr:u}=P(),[b,c]=f.useState(null),[g,v]=f.useState(!0),[h,j]=f.useState([]),w=p==="client";f.useEffect(()=>{if(!i||!o)return;let U=!0;return v(!0),(async()=>{const[Z,Y]=await Promise.all([qa(o),Hn(i)]);U&&(Z&&c(Z),v(!1),j(Y))})(),()=>{U=!1}},[i,o]);const[y,k]=f.useState(!1),L=()=>{!w||y||!o||(k(!0),no(o).then(U=>{k(!1),U?m(e.identRepubDone):u(e.actErr)}))},q=(b==null?void 0:b.per_day)??null,z=((B=b==null?void 0:b.pool_order)==null?void 0:B.length)??0,A=h.filter(U=>U.status==="running").length,O=f.useMemo(()=>s.filter(U=>U.kind==="target"&&Te(U)).length,[s]),E=l.marketEstimate,M=typeof((V=l.stats)==null?void 0:V.screened)=="number"?l.stats.screened:O,$=E&&E>0?Math.min(100,Math.round(M/E*100)):null,N=U=>U.toLocaleString(a==="en"?"en-US":"fr-FR"),C=(o||"P").split(/\s+/).map(U=>U[0]).join("").slice(0,2).toUpperCase(),R=(()=>{const U=Date.parse(l.generatedAt||"");if(Number.isNaN(U))return"";const Z=new Date(U),Y=ee=>String(ee).padStart(2,"0");return`${Y(Z.getDate())}/${Y(Z.getMonth()+1)} à ${Y(Z.getHours())}:${Y(Z.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?C:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),R?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(R)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[$===null&&M>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:N(M)})})]}),$!==null&&E&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:$+"%"}})}),t.jsxs("b",{children:[$," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(M,E)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),q!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:q})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),q===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),A>0&&t.jsxs("span",{className:"ev",children:["⏳ ",A]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(z)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:U=>{U.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!w||y,onClick:L,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!w,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:U=>n({type:"filters",patch:{search:U.target.value}})})]})]})]})}const Ri=["--p0","--p1","--p2","--p3","--p4"];function Mi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=P(),s=o.loading&&!l.length,p=f.useRef({});f.useEffect(()=>{p.current={...r}},[r]);const x=u=>{const b=p.current[u],c=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Ri[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[u],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},u)},d=(u,b,c)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,c,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:c,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Oi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Fi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=P(),s=f.useRef(null),[p,x]=f.useState(60);f.useEffect(()=>{let b=0;const c=()=>{var w;const g=s.current;if(!g)return;const v=(w=g.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!v)return;const h=v.getBoundingClientRect(),j=g.getBoundingClientRect();x(Math.max(20,Math.min(h.left+h.width/2-j.left,j.width-30)))};return b=requestAnimationFrame(c),window.addEventListener("resize",c),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",c)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const b=n.filter(v=>v.kind==="target"&&ye(v)===3),c=b.filter(v=>ca(v)==="auto").length,g=b.filter(v=>ca(v)==="cd").length;m=r.tutoPending(c,g,b.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(b=>b.id)})};if(d===1){const b=n.filter(c=>c.kind==="target"&&ye(c)===1&&!i.has(c.id)).slice(0,10);if(b.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:b.map(c=>c.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Oi[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Ze{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Pi(e){for(const a of e)yield*a}function ar(e){return Array.from(Pi(e))}var se=1e-6,re=Math.PI,Re=re/2,dn=re/4,Oe=re*2,Ue=180/re,Ae=re/180,de=Math.abs,Di=Math.atan,vt=Math.atan2,me=Math.cos,fe=Math.sin,Ii=Math.sign||function(e){return e>0?1:e<0?-1:0},at=Math.sqrt;function $i(e){return e>1?0:e<-1?re:Math.acos(e)}function yt(e){return e>1?Re:e<-1?-Re:Math.asin(e)}function Me(){}function $t(e,a){e&&un.hasOwnProperty(e.type)&&un[e.type](e,a)}var pn={Feature:function(e,a){$t(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)$t(r[n].geometry,a)}},un={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){fa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)fa(r[n],a,0)},Polygon:function(e,a){mn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)mn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)$t(r[n],a)}};function fa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function mn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)fa(e[r],a,1);a.polygonEnd()}function rt(e,a){e&&pn.hasOwnProperty(e.type)?pn[e.type](e,a):$t(e,a)}function ha(e){return[vt(e[1],e[0]),yt(e[2])]}function lt(e){var a=e[0],r=e[1],n=me(r);return[n*me(a),n*fe(a),fe(r)]}function qt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Bt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ra(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Lt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function xa(e){var a=at(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ga(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function ba(e,a){return de(e)>re&&(e-=Math.round(e/Oe)*Oe),[e,a]}ba.invert=ba;function Bi(e,a,r){return(e%=Oe)?a||r?ga(hn(e),xn(a,r)):hn(e):a||r?xn(a,r):ba}function fn(e){return function(a,r){return a+=e,de(a)>re&&(a-=Math.round(a/Oe)*Oe),[a,r]}}function hn(e){var a=fn(e);return a.invert=fn(-e),a}function xn(e,a){var r=me(e),n=fe(e),i=me(a),o=fe(a);function l(s,p){var x=me(p),d=me(s)*x,m=fe(s)*x,u=fe(p),b=u*r+d*n;return[vt(m*i-b*o,d*r-u*n),yt(b*i+m*o)]}return l.invert=function(s,p){var x=me(p),d=me(s)*x,m=fe(s)*x,u=fe(p),b=u*i-m*o;return[vt(m*i+u*o,d*r+b*n),yt(b*r-d*n)]},l}function _i(e,a,r,n,i,o){if(r){var l=me(a),s=fe(a),p=n*r;i==null?(i=a+n*Oe,o=a-p/2):(i=gn(l,i),o=gn(l,o),(n>0?i<o:i>o)&&(i+=n*Oe));for(var x,d=i;n>0?d>o:d<o;d-=p)x=ha([l,-s*me(d),-s*fe(d)]),e.point(x[0],x[1])}}function gn(e,a){a=lt(a),a[0]-=e,xa(a);var r=$i(-a[1]);return((-a[2]<0?-r:r)+Oe-se)%Oe}function nr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Me,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Pt(e,a){return de(e[0]-a[0])<se&&de(e[1]-a[1])<se}function Rt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function rr(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(c){if(!((g=c.length-1)<=0)){var g,v=c[0],h=c[g],j;if(Pt(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=c[s])[0],v[1]);i.lineEnd();return}h[0]+=2*se}o.push(j=new Rt(v,c,null,!0)),l.push(j.o=new Rt(v,null,j,!1)),o.push(j=new Rt(h,c,null,!1)),l.push(j.o=new Rt(h,null,j,!0))}}),!!o.length){for(l.sort(a),bn(o),bn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var x=o[0],d,m;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,p=d.length;s<p;++s)i.point((m=d[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((m=d[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);i.lineEnd()}}}function bn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function oa(e){return de(e[0])<=re?e[0]:Ii(e[0])*((de(e[0])+re)%Oe-re)}function Ui(e,a){var r=oa(a),n=a[1],i=fe(n),o=[fe(r),-me(r),0],l=0,s=0,p=new Ze;i===1?n=Re+se:i===-1&&(n=-Re-se);for(var x=0,d=e.length;x<d;++x)if(u=(m=e[x]).length)for(var m,u,b=m[u-1],c=oa(b),g=b[1]/2+dn,v=fe(g),h=me(g),j=0;j<u;++j,c=y,v=L,h=q,b=w){var w=m[j],y=oa(w),k=w[1]/2+dn,L=fe(k),q=me(k),z=y-c,A=z>=0?1:-1,O=A*z,E=O>re,M=v*L;if(p.add(vt(M*A*fe(O),h*q+M*me(O))),l+=E?z+A*Oe:z,E^c>=r^y>=r){var $=Bt(lt(b),lt(w));xa($);var N=Bt(o,$);xa(N);var C=(E^z>=0?-1:1)*yt(N[2]);(n>C||n===C&&($[0]||$[1]))&&(s+=E^z>=0?1:-1)}}return(l<-se||l<se&&p<-1e-12)^s&1}function or(e,a,r,n){return function(i){var o=a(i),l=nr(),s=a(l),p=!1,x,d,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=j,u.lineEnd=w,d=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,d=ar(d);var y=Ui(x,n);d.length?(p||(i.polygonStart(),p=!0),rr(d,Hi,y,r,i)):y&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),d=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,k){e(y,k)&&i.point(y,k)}function c(y,k){o.point(y,k)}function g(){u.point=c,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,k){m.push([y,k]),s.point(y,k)}function j(){s.lineStart(),m=[]}function w(){h(m[0][0],m[0][1]),s.lineEnd();var y=s.clean(),k=l.result(),L,q=k.length,z,A,O;if(m.pop(),x.push(m),m=null,!!q){if(y&1){if(A=k[0],(z=A.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),L=0;L<z;++L)i.point((O=A[L])[0],O[1]);i.lineEnd()}return}q>1&&y&2&&k.push(k.pop().concat(k.shift())),d.push(k.filter(Vi))}}return u}}function Vi(e){return e.length>1}function Hi(e,a){return((e=e.x)[0]<0?e[1]-Re-se:Re-e[1])-((a=a.x)[0]<0?a[1]-Re-se:Re-a[1])}const vn=or(function(){return!0},Wi,Gi,[-re,-Re]);function Wi(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?re:-re,p=de(o-a);de(p-re)<se?(e.point(a,r=(r+l)/2>0?Re:-Re),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=re&&(de(a-n)<se&&(a-=n*se),de(o-s)<se&&(o-=s*se),r=Yi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Yi(e,a,r,n){var i,o,l=fe(e-r);return de(l)>se?Di((fe(a)*(o=me(n))*fe(r)-fe(n)*(i=me(a))*fe(e))/(i*o*l)):(a+n)/2}function Gi(e,a,r,n){var i;if(e==null)i=r*Re,n.point(-re,i),n.point(0,i),n.point(re,i),n.point(re,0),n.point(re,-i),n.point(0,-i),n.point(-re,-i),n.point(-re,0),n.point(-re,i);else if(de(e[0]-a[0])>se){var o=e[0]<a[0]?re:-re;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ki(e){var a=me(e),r=2*Ae,n=a>0,i=de(a)>se;function o(d,m,u,b){_i(b,e,r,u,d,m)}function l(d,m){return me(d)*me(m)>a}function s(d){var m,u,b,c,g;return{lineStart:function(){c=b=!1,g=1},point:function(v,h){var j=[v,h],w,y=l(v,h),k=n?y?0:x(v,h):y?x(v+(v<0?re:-re),h):0;if(!m&&(c=b=y)&&d.lineStart(),y!==b&&(w=p(m,j),(!w||Pt(m,w)||Pt(j,w))&&(j[2]=1)),y!==b)g=0,y?(d.lineStart(),w=p(j,m),d.point(w[0],w[1])):(w=p(m,j),d.point(w[0],w[1],2),d.lineEnd()),m=w;else if(i&&m&&n^y){var L;!(k&u)&&(L=p(j,m,!0))&&(g=0,n?(d.lineStart(),d.point(L[0][0],L[0][1]),d.point(L[1][0],L[1][1]),d.lineEnd()):(d.point(L[1][0],L[1][1]),d.lineEnd(),d.lineStart(),d.point(L[0][0],L[0][1],3)))}y&&(!m||!Pt(m,j))&&d.point(j[0],j[1]),m=j,b=y,u=k},lineEnd:function(){b&&d.lineEnd(),m=null},clean:function(){return g|(c&&b)<<1}}}function p(d,m,u){var b=lt(d),c=lt(m),g=[1,0,0],v=Bt(b,c),h=qt(v,v),j=v[0],w=h-j*j;if(!w)return!u&&d;var y=a*h/w,k=-a*j/w,L=Bt(g,v),q=Lt(g,y),z=Lt(v,k);ra(q,z);var A=L,O=qt(q,A),E=qt(A,A),M=O*O-E*(qt(q,q)-1);if(!(M<0)){var $=at(M),N=Lt(A,(-O-$)/E);if(ra(N,q),N=ha(N),!u)return N;var C=d[0],R=m[0],B=d[1],V=m[1],U;R<C&&(U=C,C=R,R=U);var Z=R-C,Y=de(Z-re)<se,ee=Y||Z<se;if(!Y&&V<B&&(U=B,B=V,V=U),ee?Y?B+V>0^N[1]<(de(N[0]-C)<se?B:V):B<=N[1]&&N[1]<=V:Z>re^(C<=N[0]&&N[0]<=R)){var K=Lt(A,(-O+$)/E);return ra(K,q),[N,ha(K)]}}}function x(d,m){var u=n?e:re-e,b=0;return d<-u?b|=1:d>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return or(l,s,o,n?[0,-e]:[-re,e-re])}function Qi(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],x=a[1],d=0,m=1,u=p-l,b=x-s,c;if(c=r-l,!(!u&&c>0)){if(c/=u,u<0){if(c<d)return;c<m&&(m=c)}else if(u>0){if(c>m)return;c>d&&(d=c)}if(c=i-l,!(!u&&c<0)){if(c/=u,u<0){if(c>m)return;c>d&&(d=c)}else if(u>0){if(c<d)return;c<m&&(m=c)}if(c=n-s,!(!b&&c>0)){if(c/=b,b<0){if(c<d)return;c<m&&(m=c)}else if(b>0){if(c>m)return;c>d&&(d=c)}if(c=o-s,!(!b&&c<0)){if(c/=b,b<0){if(c>m)return;c>d&&(d=c)}else if(b>0){if(c<d)return;c<m&&(m=c)}return d>0&&(e[0]=l+d*u,e[1]=s+d*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var ft=1e9,Mt=-ft;function Ji(e,a,r,n){function i(x,d){return e<=x&&x<=r&&a<=d&&d<=n}function o(x,d,m,u){var b=0,c=0;if(x==null||(b=l(x,m))!==(c=l(d,m))||p(x,d)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==c);else u.point(d[0],d[1])}function l(x,d){return de(x[0]-e)<se?d>0?0:3:de(x[0]-r)<se?d>0?2:1:de(x[1]-a)<se?d>0?1:0:d>0?3:2}function s(x,d){return p(x.x,d.x)}function p(x,d){var m=l(x,1),u=l(d,1);return m!==u?m-u:m===0?d[1]-x[1]:m===1?x[0]-d[0]:m===2?x[1]-d[1]:d[0]-x[0]}return function(x){var d=x,m=nr(),u,b,c,g,v,h,j,w,y,k,L,q={point:z,lineStart:M,lineEnd:$,polygonStart:O,polygonEnd:E};function z(C,R){i(C,R)&&d.point(C,R)}function A(){for(var C=0,R=0,B=b.length;R<B;++R)for(var V=b[R],U=1,Z=V.length,Y=V[0],ee,K,_=Y[0],G=Y[1];U<Z;++U)ee=_,K=G,Y=V[U],_=Y[0],G=Y[1],K<=n?G>n&&(_-ee)*(n-K)>(G-K)*(e-ee)&&++C:G<=n&&(_-ee)*(n-K)<(G-K)*(e-ee)&&--C;return C}function O(){d=m,u=[],b=[],L=!0}function E(){var C=A(),R=L&&C,B=(u=ar(u)).length;(R||B)&&(x.polygonStart(),R&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),B&&rr(u,s,C,o,x),x.polygonEnd()),d=x,u=b=c=null}function M(){q.point=N,b&&b.push(c=[]),k=!0,y=!1,j=w=NaN}function $(){u&&(N(g,v),h&&y&&m.rejoin(),u.push(m.result())),q.point=z,y&&d.lineEnd()}function N(C,R){var B=i(C,R);if(b&&c.push([C,R]),k)g=C,v=R,h=B,k=!1,B&&(d.lineStart(),d.point(C,R));else if(B&&y)d.point(C,R);else{var V=[j=Math.max(Mt,Math.min(ft,j)),w=Math.max(Mt,Math.min(ft,w))],U=[C=Math.max(Mt,Math.min(ft,C)),R=Math.max(Mt,Math.min(ft,R))];Qi(V,U,e,a,r,n)?(y||(d.lineStart(),d.point(V[0],V[1])),d.point(U[0],U[1]),B||d.lineEnd(),L=!1):B&&(d.lineStart(),d.point(C,R),L=!1)}j=C,w=R,y=B}return q}}const va=e=>e;var ia=new Ze,ya=new Ze,ir,sr,wa,ka,Ve={point:Me,lineStart:Me,lineEnd:Me,polygonStart:function(){Ve.lineStart=Xi,Ve.lineEnd=es},polygonEnd:function(){Ve.lineStart=Ve.lineEnd=Ve.point=Me,ia.add(de(ya)),ya=new Ze},result:function(){var e=ia/2;return ia=new Ze,e}};function Xi(){Ve.point=Zi}function Zi(e,a){Ve.point=lr,ir=wa=e,sr=ka=a}function lr(e,a){ya.add(ka*e-wa*a),wa=e,ka=a}function es(){lr(ir,sr)}var ct=1/0,_t=ct,wt=-ct,Ut=wt,Vt={point:ts,lineStart:Me,lineEnd:Me,polygonStart:Me,polygonEnd:Me,result:function(){var e=[[ct,_t],[wt,Ut]];return wt=Ut=-(_t=ct=1/0),e}};function ts(e,a){e<ct&&(ct=e),e>wt&&(wt=e),a<_t&&(_t=a),a>Ut&&(Ut=a)}var ja=0,Na=0,ht=0,Ht=0,Wt=0,ot=0,Sa=0,Ea=0,xt=0,cr,dr,$e,Be,Le={point:et,lineStart:yn,lineEnd:wn,polygonStart:function(){Le.lineStart=rs,Le.lineEnd=os},polygonEnd:function(){Le.point=et,Le.lineStart=yn,Le.lineEnd=wn},result:function(){var e=xt?[Sa/xt,Ea/xt]:ot?[Ht/ot,Wt/ot]:ht?[ja/ht,Na/ht]:[NaN,NaN];return ja=Na=ht=Ht=Wt=ot=Sa=Ea=xt=0,e}};function et(e,a){ja+=e,Na+=a,++ht}function yn(){Le.point=as}function as(e,a){Le.point=ns,et($e=e,Be=a)}function ns(e,a){var r=e-$e,n=a-Be,i=at(r*r+n*n);Ht+=i*($e+e)/2,Wt+=i*(Be+a)/2,ot+=i,et($e=e,Be=a)}function wn(){Le.point=et}function rs(){Le.point=is}function os(){pr(cr,dr)}function is(e,a){Le.point=pr,et(cr=$e=e,dr=Be=a)}function pr(e,a){var r=e-$e,n=a-Be,i=at(r*r+n*n);Ht+=i*($e+e)/2,Wt+=i*(Be+a)/2,ot+=i,i=Be*e-$e*a,Sa+=i*($e+e),Ea+=i*(Be+a),xt+=i*3,et($e=e,Be=a)}function ur(e){this._context=e}ur.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Oe);break}}},result:Me};var Ca=new Ze,sa,mr,fr,gt,bt,kt={point:Me,lineStart:function(){kt.point=ss},lineEnd:function(){sa&&hr(mr,fr),kt.point=Me},polygonStart:function(){sa=!0},polygonEnd:function(){sa=null},result:function(){var e=+Ca;return Ca=new Ze,e}};function ss(e,a){kt.point=hr,mr=gt=e,fr=bt=a}function hr(e,a){gt-=e,bt-=a,Ca.add(at(gt*gt+bt*bt)),gt=e,bt=a}let kn,Yt,jn,Nn;class Sn{constructor(a){this._append=a==null?xr:ls(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==jn||this._append!==Yt){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,jn=n,Yt=this._append,Nn=this._,this._=i}this._+=Nn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function xr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function ls(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return xr;if(a!==kn){const r=10**a;kn=a,Yt=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Yt}function cs(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),rt(s,i(o))),o.result()}return l.area=function(s){return rt(s,i(Ve)),Ve.result()},l.measure=function(s){return rt(s,i(kt)),kt.result()},l.bounds=function(s){return rt(s,i(Vt)),Vt.result()},l.centroid=function(s){return rt(s,i(Le)),Le.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,va):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new Sn(r)):new ur(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new Sn(r)),l},l.projection(e).digits(r).context(a)}function Pa(e){return function(a){var r=new Aa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Aa(){}Aa.prototype={constructor:Aa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Da(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),rt(r,e.stream(Vt)),a(Vt.result()),n!=null&&e.clipExtent(n),e}function gr(e,a,r){return Da(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function ds(e,a,r){return gr(e,[[0,0],a],r)}function ps(e,a,r){return Da(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function us(e,a,r){return Da(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var En=16,ms=me(30*Ae);function Cn(e,a){return+a?hs(e,a):fs(e)}function fs(e){return Pa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function hs(e,a){function r(n,i,o,l,s,p,x,d,m,u,b,c,g,v){var h=x-n,j=d-i,w=h*h+j*j;if(w>4*a&&g--){var y=l+u,k=s+b,L=p+c,q=at(y*y+k*k+L*L),z=yt(L/=q),A=de(de(L)-1)<se||de(o-m)<se?(o+m)/2:vt(k,y),O=e(A,z),E=O[0],M=O[1],$=E-n,N=M-i,C=j*$-h*N;(C*C/w>a||de((h*$+j*N)/w-.5)>.3||l*u+s*b+p*c<ms)&&(r(n,i,o,l,s,p,E,M,A,y/=q,k/=q,L,g,v),v.point(E,M),r(E,M,A,y,k,L,x,d,m,u,b,c,g,v))}}return function(n){var i,o,l,s,p,x,d,m,u,b,c,g,v={point:h,lineStart:j,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=k},polygonEnd:function(){n.polygonEnd(),v.lineStart=j}};function h(z,A){z=e(z,A),n.point(z[0],z[1])}function j(){m=NaN,v.point=w,n.lineStart()}function w(z,A){var O=lt([z,A]),E=e(z,A);r(m,u,d,b,c,g,m=E[0],u=E[1],d=z,b=O[0],c=O[1],g=O[2],En,n),n.point(m,u)}function y(){v.point=h,n.lineEnd()}function k(){j(),v.point=L,v.lineEnd=q}function L(z,A){w(i=z,A),o=m,l=u,s=b,p=c,x=g,v.point=w}function q(){r(m,u,d,b,c,g,o,l,i,s,p,x,En,n),v.lineEnd=y,y()}return v}}var xs=Pa({point:function(e,a){this.stream.point(e*Ae,a*Ae)}});function gs(e){return Pa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function bs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function An(e,a,r,n,i,o){if(!o)return bs(e,a,r,n,i);var l=me(o),s=fe(o),p=l*e,x=s*e,d=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function c(g,v){return g*=n,v*=i,[p*g-x*v+a,r-x*g-p*v]}return c.invert=function(g,v){return[n*(d*g-m*v+u),i*(b-m*g-d*v)]},c}function vs(e){return ys(function(){return e})()}function ys(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,x=0,d,m=0,u=1,b=1,c=null,g=vn,v=null,h,j,w,y=va,k=.5,L,q,z,A,O;function E(C){return z(C[0]*Ae,C[1]*Ae)}function M(C){return C=z.invert(C[0],C[1]),C&&[C[0]*Ue,C[1]*Ue]}E.stream=function(C){return A&&O===C?A:A=xs(gs(d)(g(L(y(O=C)))))},E.preclip=function(C){return arguments.length?(g=C,c=void 0,N()):g},E.postclip=function(C){return arguments.length?(y=C,v=h=j=w=null,N()):y},E.clipAngle=function(C){return arguments.length?(g=+C?Ki(c=C*Ae):(c=null,vn),N()):c*Ue},E.clipExtent=function(C){return arguments.length?(y=C==null?(v=h=j=w=null,va):Ji(v=+C[0][0],h=+C[0][1],j=+C[1][0],w=+C[1][1]),N()):v==null?null:[[v,h],[j,w]]},E.scale=function(C){return arguments.length?(r=+C,$()):r},E.translate=function(C){return arguments.length?(n=+C[0],i=+C[1],$()):[n,i]},E.center=function(C){return arguments.length?(o=C[0]%360*Ae,l=C[1]%360*Ae,$()):[o*Ue,l*Ue]},E.rotate=function(C){return arguments.length?(s=C[0]%360*Ae,p=C[1]%360*Ae,x=C.length>2?C[2]%360*Ae:0,$()):[s*Ue,p*Ue,x*Ue]},E.angle=function(C){return arguments.length?(m=C%360*Ae,$()):m*Ue},E.reflectX=function(C){return arguments.length?(u=C?-1:1,$()):u<0},E.reflectY=function(C){return arguments.length?(b=C?-1:1,$()):b<0},E.precision=function(C){return arguments.length?(L=Cn(q,k=C*C),N()):at(k)},E.fitExtent=function(C,R){return gr(E,C,R)},E.fitSize=function(C,R){return ds(E,C,R)},E.fitWidth=function(C,R){return ps(E,C,R)},E.fitHeight=function(C,R){return us(E,C,R)};function $(){var C=An(r,0,0,u,b,m).apply(null,a(o,l)),R=An(r,n-C[0],i-C[1],u,b,m);return d=Bi(s,p,x),q=ga(a,R),z=ga(d,q),L=Cn(q,k),N()}function N(){return A=O=null,E}return function(){return a=e.apply(this,arguments),E.invert=a.invert&&M,$()}}function br(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}br.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(de(i)>se&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ws(){return vs(br).scale(175.295)}function ks(e){return e}function js(e){if(e==null)return ks;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var x=2,d=s.length,m=new Array(d);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;x<d;)m[x]=s[x],++x;return m}}function Ns(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function Ss(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Tn(e,r)})}:Tn(e,a)}function Tn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=Es(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function Es(e,a){var r=js(e.transform),n=e.arcs;function i(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],b=0,c=u.length;b<c;++b)m.push(r(u[b],b));d<0&&Ns(m,c)}function o(d){return r(d)}function l(d){for(var m=[],u=0,b=d.length;u<b;++u)i(d[u],m);return m.length<2&&m.push(m[0]),m}function s(d){for(var m=l(d);m.length<4;)m.push(m[0]);return m}function p(d){return d.map(s)}function x(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(x)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:m,coordinates:u}}return x(a)}const vr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Cs=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function As(e,a,r){const n=vr[e];if(!n||!n.length)return-1;const i=Cs(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Ot=null;function Ts(){return Ot||(Ot=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=Ss(r,n),o=ws().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=cs(o),s=(i.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var b;const m=((b=d.properties)==null?void 0:b.name)||"",u=l(d)||"";return u?{i2:ro(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,m]of Object.entries(oo)){const u=o(m);u&&(p[d]={x:u[0],y:u[1]})}const x={};for(const[d,m]of Object.entries(vr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,c])=>({x:b,y:c}));u.length&&(x[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:x}}catch{return null}})(),Ot)}function zs(e){const[a,r]=f.useState(null);return f.useEffect(()=>{if(!e||a)return;let n=!1;return Ts().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const qs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},zn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function qn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Ls(e,a){const[r,n]=f.useState(1);return f.useEffect(()=>{let i=!0,o=0;const l=()=>{var x;if(!i)return;const p=(x=e.current)==null?void 0:x.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Ln({msgs:e}){const[a,r]=f.useState(0);f.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Rs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:x,dossiers:d}=P(),m=x.loading&&!d.length,u=f.useRef(null),b=f.useRef(null),c=zs(e.continent==="monde"),g=e.continent==="monde"?c:La.find(N=>N.key===e.continent)||null,v=Ls(u,e.continent+":"+e.mapFolded+":"+!!g),[h,j]=f.useState(new Map),[w,y]=f.useState(null);f.useEffect(()=>{const N=u.current;if(!N)return;const C=new Map;N.querySelectorAll("path[data-i2]").forEach(R=>{const B=R.dataset.i2;if(B)try{const V=R.getBBox();V.width>0&&C.set(B,{x:V.x,y:V.y,w:V.width,h:V.height})}catch{}}),j(C)},[e.continent,v,g]);const k=f.useMemo(()=>r.filter(N=>N.cc),[r]),L=f.useMemo(()=>{const N=new Map;return k.forEach(C=>N.set(C.cc,(N.get(C.cc)||0)+1)),N},[k]),q=e.continent==="monde"&&c?c.anchors:null,z=e.continent==="monde"&&c?c.metros:null,A=f.useMemo(()=>k.map(N=>{const C=qn(N.name||N.id||""),R=qn((N.id||N.name||"")+"·y");if(q&&N.cc){const Y=z?z[N.cc]:void 0;if(Y&&Y.length){const K=As(N.cc,N.city,C);if(K>=0&&Y[K])return{d:N,x:Y[K].x+(C-.5)*5,y:Y[K].y+(R-.5)*5}}const ee=q[N.cc];if(ee)return{d:N,x:ee.x+(C-.5)*10,y:ee.y+(R-.5)*10}}const B=N.cc?h.get(N.cc):void 0;if(!B)return null;const V=qs[`${e.continent}:${N.cc||""}`];if(V)return{d:N,x:B.x+B.w*(V.fx+(C-.5)*V.sx),y:B.y+B.h*(V.fy+(R-.5)*V.sy)};const U=(C-.5)*Math.min(B.w*.55,60),Z=(R-.5)*Math.min(B.h*.55,60);return{d:N,x:B.x+B.w/2+U,y:B.y+B.h/2+Z}}).filter(N=>!!N),[k,h,q,z,e.continent]),O=N=>v>0?N/v:N,E=f.useMemo(()=>n?[0,1,2,3,4,5].map(N=>({c:zn[N],fr:p.plabels[N].toUpperCase(),en:p.plabels[N].toUpperCase(),n:r.filter(C=>C.kind==="target"&&ye(C)===N).length})).filter(N=>N.n>0):Qa.map((N,C)=>({...N,n:r.filter(R=>Ja(R)===C).length})),[r,n,p.plabels]),M=o?l.get(o):null,$=M?A.find(N=>N.d.id===M.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[m&&t.jsx(Ln,{msgs:p.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((N,C)=>t.jsx("g",{className:"ct"+(N.i2&&L.get(N.i2)?"":" empty"),children:t.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},C))}),t.jsx("g",{children:A.map(N=>{const C=Qa[Ja(N.d)],R=!!ve(N.d),B=N.d.kind==="target",V=n&&B?zn[ye(N.d)]:C.c,U=!n&&Te(N.d);return t.jsxs("g",{className:"co"+(U?" done":""),onMouseEnter:()=>{var ee,K;const Z=(ee=b.current)==null?void 0:ee.getBoundingClientRect(),Y=(K=u.current)==null?void 0:K.createSVGPoint();if(Y&&u.current&&Z){Y.x=N.x,Y.y=N.y;const _=Y.matrixTransform(u.current.getScreenCTM());y({x:_.x-Z.left,y:_.y-Z.top,label:N.d.name+" · "+(pt(N.d.cc,s)||N.d.countryLabel||"")})}i(N.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var ee;const Z=(ee=u.current)==null?void 0:ee.createSVGPoint();let Y=null;if(Z&&u.current){Z.x=N.x,Z.y=N.y;const K=Z.matrixTransform(u.current.getScreenCTM());Y={x:K.x,y:K.y}}a({type:"popup",id:N.d.id,anchor:Y})},children:[t.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:O(Math.max(11,C.px+7))}),t.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:O(C.px),fill:V,stroke:R?"#DC2626":"#ffffff",strokeWidth:O(R?2.2:1.3)})]},N.d.id||N.d.name)})}),$&&t.jsx("circle",{className:"ring on",cx:$.x,cy:$.y,r:O(13),fill:"none",stroke:"#0F172A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:E.map((N,C)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":N.c}}),s==="fr"?N.fr:N.en," ",t.jsx("b",{children:N.n})]},C))}),r.some(N=>!N.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(N=>!N.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:t.jsx(Ln,{msgs:p.loadMsgs})})}function Ms(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Os(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=P(),s=e.filters,p=f.useMemo(()=>e.continent==="monde"?r:r.filter(c=>c.continent===e.continent),[r,e.continent]),x=c=>p.filter(g=>c!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Ma(g,s,i,c==="country"?void 0:c)),d=f.useMemo(()=>{const c=x("win"),g=v=>c.filter(h=>(h.date?Math.max(0,Math.floor((Date.now()-Date.parse(h.date))/864e5)):9999)<=v).length;return[g(0),g(7),g(30),c.length]},[p,s,i]),m=f.useMemo(()=>s.day?x("win").filter(c=>(c.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=(s.acquirer.trim()?1:0)+s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),b=(c,g,v,h="fbtn")=>t.jsxs("button",{type:"button",className:h,"aria-expanded":e.openFacet===c,onClick:()=>a({type:"openFacet",facet:c}),children:[t.jsx("span",{className:"fl",children:g}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},c);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:n.fDay(Ms(s.day,l))}),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((c,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===c,onClick:()=>a({type:"filters",patch:{win:c}}),children:[t.jsx("span",{className:"sl",children:n.dates[g]}),t.jsx("b",{children:d[g]})]},c))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:c=>a({type:"filters",patch:{search:c.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):b("sec",n.fSector,s.sector.length),b("pay",n.fCountry,s.country.length),b("det",n.fEngine,s.engine.length),b("sta",n.fStage,s.stage.length),i&&b("ang","Angle",s.angle.length),i&&b("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Fs,{poolFor:x})]})}function Fs({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=P(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:x}=f.useMemo(()=>{if(l==="sig"){const c=e("signal").filter(h=>ve(h)),g=new Map;c.forEach(h=>{const j=h.engine||"";g.set(j,(g.get(j)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:c.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...da([...g.keys()],i).map(h=>({v:h,label:Xe(h)+" "+_e(h,i),n:g.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const c=e("sector"),g=new Map;return c.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const c=e("country"),g=new Map;return c.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:pt(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const c=e("engine"),g=new Map;return c.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:da([...g.keys()],i).map(v=>({v,label:Xe(v)+" "+_e(v,i)+' <span style="color:var(--dim);font-size:10px">· '+io(so(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const c=e("angle"),g=new Map;return c.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const c=e("memoLevel"),g=new Map;c.forEach(h=>{if(h.kind==="target"){const j=za(h);g.set(j,(g.get(j)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:g.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(c=>{c.stage&&b.set(c.stage,(b.get(c.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((c,g)=>g[1]-c[1]).map(([c,g])=>({v:c,label:c,n:g,html:!1,on:o.stage.includes(c)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const c=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:c}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function yr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ps(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Rn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=P();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function wr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=P(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Rn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Rn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Ds({card:e,onEvaluate:a,onAddAll:r}){var s,p,x;const{t:n}=P(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:yr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(wr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Is(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function $s({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=P(),s=i,[p,x]=f.useState(null),[d,m]=f.useState(null),[u,b]=f.useState(null),[c,g]=f.useState(!1);f.useEffect(()=>{let h=!0;return(async()=>{const j=await Wn({email:l,cbToken:s});h&&x(j)})(),()=>{h=!1}},[l,s,n]);const v=h=>{m(h),b(null),g(!0),(async()=>{const j=await lo(h.id);b(j),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[Is(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),c&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!c&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!c&&u&&t.jsx(Ds,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Mn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Bs(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:x,data:d,canWrite:m,source:u}=P(),b=a==="client",c=f.useMemo(()=>r||(u!=="default"?co():""),[r,u]),[g,v]=f.useState(""),[h,j]=f.useState(!1),[w,y]=f.useState(""),[k,L]=f.useState(!1),[q,z]=f.useState(""),[A,O]=f.useState([]),E=f.useRef(!1),[M,$]=f.useState(!1),[N,C]=f.useState(""),[R,B]=f.useState(""),[V,U]=f.useState(!1),[Z,Y]=f.useState(0),[ee,K]=f.useState(""),[_,G]=f.useState(null),[Q,te]=f.useState(null),[le,we]=f.useState(!1),[ue,X]=f.useState(null),[oe,he]=f.useState(0),T=f.useRef(!1),F=g.trim()?Mn.test(g.trim())?e.evalUrl:e.evalName:e.evalWaiting,I=f.useMemo(()=>w.split(`
...
`).map((x,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[st(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const la={},On=(la==null?void 0:la.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Fn(){return new Date().toISOString().slice(0,10)}const Ia=f.createContext(null);function Vs(){return f.useContext(Ia)}function Hs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),s.querySelectorAll("*").forEach(p=>{const x=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(d=>p.removeAttribute(d.name)),x&&/^https?:\/\//i.test(x)&&(p.setAttribute("href",x),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Pn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function kr(){const e=f.useContext(Ia);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ws({token:e,children:a}){const{dispatch:r,st:n,lang:i}=P(),[o,l]=f.useState(()=>n.filters.day||Fn()),[s,p]=f.useState(null),[x,d]=f.useState(!1),m=f.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=f.useCallback(()=>{l(Fn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);f.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),f.useEffect(()=>{const g=v=>{var j;const h=(j=v.detail)==null?void 0:j.day;typeof h=="string"&&m(h)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[m]),f.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),f.useEffect(()=>{if(!e||!o)return;let g=!1;d(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${On}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{g||p(h)}).catch(()=>{g||p({ok:!1,error:"network"})}).finally(()=>{g||d(!1)}),()=>{g=!0}},[e,o]);const b=f.useMemo(()=>`${On}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),c=f.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,x,m,u,n.filters.day,b,i]);return t.jsx(Ia.Provider,{value:c,children:a})}function Ys(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=kr(),[i,o]=f.useState(n);return f.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(fo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Gs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=kr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,p=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
