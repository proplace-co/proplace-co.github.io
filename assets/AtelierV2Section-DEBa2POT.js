...
.atl2.ops .zoom-body{margin:18px 0 0;padding-top:16px;border-top:1px solid var(--line)}
.atl2.ops .zoom-body h4{display:none}
...
.atl2 .demand .dfield.flash input{border-color:var(--brand)!important;
  box-shadow:0 0 0 3px rgba(14,138,79,.24);transition:box-shadow .2s,border-color .2s}
@keyframes pp-prefill{0%{transform:translateY(-3px)}60%{transform:translateY(0)}}
.atl2 .demand .dfield.flash{animation:pp-prefill .45s ease}
...
`,Li=Ti+qi;function Ea(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Mi(){const e=Ea("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ri(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Mi();return r==="0"?"client":r==="1"||Ea("embed")==="1"&&Ea("chrome")==="1"?"apercu":"client"}const Oi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Fi=e=>Oi[e];function sa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const it=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ya(a)||sa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:jo(e.cc)})};function ua(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Pi=60*60*1e3;function Di(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Pi?null:a}catch{return null}}function $t(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ii=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function $i(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:mo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Ri(e,i),[e,i,n]),c=m.useMemo(()=>Fi(o),[o]),s=o!=="visiteur",d=Ii(r),[x,l]=m.useState([]),[f,p]=m.useState(""),[h,u]=m.useState(null),[b,v]=m.useState(null),[g,j]=m.useState(null),[C,y]=m.useState(()=>new Map),[A,T]=m.useState(()=>new Map),[z,S]=m.useState(""),[E,N]=m.useState(new Set),[R,I]=m.useState(null),[q,O]=m.useState(!0),[w,M]=m.useState(!1),[W,U]=m.useState(0),[_,re]=m.useState(0),V=m.useRef(0),X=m.useMemo(()=>{var Y;if(o!=="client")return"";try{return((Y=fo())==null?void 0:Y.email)||""}catch{return""}},[o]);m.useEffect(()=>{const Y=++V.current;let be=!0;const ve=()=>be&&Y===V.current,Pe=(s&&i.token?i.token:"pub:"+a)+(d?":"+d:""),Ae=Di(Pe);return Ae?(l(Ae.objs.map(it)),Ae.fund&&p(Ae.fund),u(Ae.marketEstimate??null),v(Ae.criteria??null),j(Ae.stats??null),S(Ae.generatedAt||""),O(!1)):O(!0),(async()=>{try{if(r==="ops"){const me=await da(),ee=((me==null?void 0:me.recent_ops)||[]).map(Q=>{const H=Kt(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),G=String(Q.rubrique||"").toLowerCase();return H&&(G==="nominations"||G==="recrutements")&&(H.engine=G),H&&!String(Q.company_name||"").trim()&&(H.noCo=!0),H}).filter(Q=>!!Q).map(Q=>(ya((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=xo(),H=Q&&Q.doc||await ho(),G=go(H),Z=((Q==null?void 0:Q.day)||(H==null?void 0:H.date)||"").slice(0,10);if(G.length&&Z){const ye=new Set;for(const ce of ee){if(ce.noCo||(ce.date||"").slice(0,10)!==Z)continue;const we=sn(G,ye,ce.name,"");we>=0&&(ye.add(we),ce.decryptHtml=G[we].html)}for(const ce of ee){if(ce.decryptHtml||(ce.date||"").slice(0,10)!==Z)continue;const we=sn(G,ye,"",ce.headline||ce.tagline||ce.name);we>=0&&(ye.add(we),ce.decryptHtml=G[we].html)}G.forEach((ce,we)=>{if(ye.has(we))return;const le=(ce.t||"").trim(),pe=le.split(/[:–—]/)[0].trim().slice(0,80)||le.slice(0,40);if(!pe)return;const qe=le+" "+ce.html,Re=/\b(acquiert|rachat|rachet|fusion|buyout|offre sur)\b/i.test(qe),de=/\b(l[eè]ve|lev[ée]e|raises?|funding|s[eé]rie [a-z]|series [a-z])\b/i.test(qe);ee.push({id:`edito:${Z}:${we}`,kind:"op",name:pe,cc:null,date:Z,engine:Re?"ma":de?"fundraising":"media",dealKind:Re?"ma":de?"levee":"other",headline:le,decryptHtml:ce.html,noCo:!ya(pe)||sa(pe)})})}}catch{}if(!ve())return;l(ee.map(it)),$t(Pe,{objs:ee})}else if(typeof r=="object"){const ee=(await ln()||[]).filter(H=>(H.slug||"")===r.research).map(H=>cn(H,a)).filter(H=>!!H),Q=ua(await dn(ee,a));if(!ve())return;l(Q.map(it)),$t(Pe,{objs:Q})}else if(s&&i.token){const me=bo(i.token),ee=da(),Q=vo(i.token),H=yo(i.token),G=wo(i.token),Z=await me;let ye=Z?Z.targets:[];ve()&&Z&&(p(Z.fund||""),u(Z.marketEstimate??null),v(Z.criteria??null),j(Z.stats??null),S(Z.generatedAt||""),l(ye.map(it)),O(!1),M(!1));const[ce,we,le,pe]=await Promise.all([ee,Q,H,G]),qe=((ce==null?void 0:ce.recent_ops)||[]).map(de=>Kt(de,a)).filter(de=>!!de);if(ye=[...ye,...qe],!ve())return;l(ye.map(it));const Re=new Set;for(const de of we){const L=(de.id||de.co||"").toString().trim().toLowerCase();L&&Re.add(L.startsWith("t:")?L:"t:"+L)}N(Re),y(le),T(pe),Z&&$t(Pe,{fund:Z.fund,marketEstimate:Z.marketEstimate,criteria:Z.criteria,stats:Z.stats,generatedAt:Z.generatedAt,objs:ye})}else{const me=ko(),ee=ln(),Q=da(),H=await me;ve()&&H.length&&(l(ua(H).map(it)),O(!1),M(!1));const[G,Z]=await Promise.all([ee,Q]),ye=(G||[]).map(pe=>cn(pe,a)).filter(pe=>!!pe),ce=await dn(ye,a),we=((Z==null?void 0:Z.recent_ops)||[]).map(pe=>Kt(pe,a)).filter(pe=>!!pe),le=ua([...H,...ce,...we]);if(!ve())return;l(le.map(it)),$t(Pe,{objs:le})}ve()&&M(!1)}catch{ve()&&!Ae&&M(!0)}finally{ve()&&O(!1)}})(),()=>{be=!1}},[s,i.token,a,W,d]),m.useEffect(()=>{if(!c.showCredits||!X){I(null);return}let Y=!0;return(async()=>{try{const be=await fetch(`${_a}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:X})});if(!be.ok)return;const ve=await be.json();Y&&ve&&ve.ok!==!1&&I(ve)}catch{}})(),()=>{Y=!1}},[c.showCredits,X,_]);const ae=m.useCallback(Y=>N(new Set(Y)),[]);return{session:i,mode:o,caps:c,fund:f,email:X,marketEstimate:h,generatedAt:z,criteria:b,stats:g,thumbs:C,stages:A,dossiers:x,favIds:E,setFavIds:ae,credits:R,reloadCredits:()=>re(Y=>Y+1),loading:q,error:w,refresh:()=>U(Y=>Y+1)}}const dr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Bi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...dr(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),_i=new Set(["signal","amount","score","crible","memo"]);function Ui(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:dr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:_i.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??pr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const pr=40;function Ya(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ze(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ua(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(nt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&lt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ur(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ya(e,a.filters,r)}function Vi(e,a,r,n){return!(!ur(e,a,r)||r&&!No(e,a.ptab,n))}function Ga(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-nt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Eo(i);case"memo":return So(i);case"signal":{const o=ze(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const c=n(i),s=n(o);return c<s?-a.dir:c>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const ma={},yn=(ma==null?void 0:ma.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function wn(){return new Date().toISOString().slice(0,10)}const Ka=m.createContext(null);function mr(){return m.useContext(Ka)}function Hi(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),c=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!c||c.length<2||c.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),s.querySelectorAll("*").forEach(d=>{const x=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(l=>d.removeAttribute(l.name)),x&&/^https?:\/\//i.test(x)&&(d.setAttribute("href",x),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:c.toLowerCase(),html:s.outerHTML})}}catch{}return a}function kn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",c=String(Number(r[3]));return a?`${o} ${c}, ${r[1]}`:`${c==="1"?"1ᵉʳ":c} ${o} ${r[1]}`}function fr(){const e=m.useContext(Ka);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Wi({token:e,children:a}){const{dispatch:r,st:n,lang:i}=$(),[o,c]=m.useState(()=>n.filters.day||wn()),[s,d]=m.useState(null),[x,l]=m.useState(!1),f=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){c(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),p=m.useCallback(()=>{c(wn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);m.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),m.useEffect(()=>{const b=v=>{var j;const g=(j=v.detail)==null?void 0:j.day;typeof g=="string"&&f(g)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[f]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&c(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;l(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${yn}/cibles/edition.json?${v}`).then(g=>g.json()).then(g=>{b||d(g)}).catch(()=>{b||d({ok:!1,error:"network"})}).finally(()=>{b||l(!1)}),()=>{b=!0}},[e,o]);const h=m.useMemo(()=>`${yn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),u=m.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:f,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:h,isEn:i==="en"}),[e,o,s,x,f,p,n.filters.day,h,i]);return t.jsx(Ka.Provider,{value:u,children:a})}function Yi(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=fr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!c&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:kn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:kn(e)}),"."]})}),c&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,c&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const Ki=300,fa=7,Qi={fr:{ma:"M&A",levees:"Levées de fonds",nominations:"Nominations",recrutements:"Offres d'emploi",actualites:"Presse"},en:{ma:"M&A",levees:"Fundraising",nominations:"Appointments",recrutements:"Job offers",actualites:"Press"}},xr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ji=["hiring","raised","news","posting","building","community","registry","exodus","other"];function jn(e){const a=ze(e);if(a)return"sig:"+(a.theme&&xr.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Xi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:c,fund:s}=$(),d=mr(),x=c==="en",[l,f]=m.useState("all"),[p,h]=m.useState(!1),u=m.useMemo(()=>{var re;const q=(a.filters.day||"").slice(0,10),O=V=>!(!o&&a.continent!=="monde"&&V.continent!==a.continent||q&&(V.date||"").slice(0,10)!==q),w=e.filter(V=>O(V)&&ze(V)&&(!o||V.kind!=="target"||Ce(V)!==5)),M=o&&(((re=d==null?void 0:d.ed)==null?void 0:re.ops)||[]).length?d.ed.ops.map(V=>Kt(V,c)).filter(V=>!!V).filter(V=>!q||(V.date||"").slice(0,10)===q):[],W=e.filter(V=>O(V)&&V.kind==="op"&&!ze(V)&&(q?!0:nt(V.date)<=fa)),U=o?M.length?M:W.filter(V=>{const X=(s||"").trim().toLowerCase();if(!X)return!1;const ae=V.match||null;return ae?Object.keys(ae).map(Y=>Y.trim().toLowerCase()).includes(X):!1}):W,_=q||new Date().toISOString().slice(0,10);return U.sort((V,X)=>{const ae=(V.date||"").slice(0,10)===_?0:1,Y=(X.date||"").slice(0,10)===_?0:1;return ae!==Y?ae-Y:(X.amountEur||0)-(V.amountEur||0)}),[...Ga(w,{key:"signal",dir:-1}),...U]},[e,a.continent,a.filters.day,o,s,c,d]),b=m.useMemo(()=>{const q={};for(const O of u){const w=jn(O);q[w]=(q[w]||0)+1}return q},[u]),v=m.useMemo(()=>l==="all"?u:u.filter(q=>jn(q)===l),[u,l]),g=m.useMemo(()=>v.slice(0,Ki),[v]),j=v.length-g.length,C=m.useRef(null);m.useEffect(()=>{var U,_;const q=C.current;if(!q)return;const O=()=>{const re=q.scrollWidth;re<200||(q.style.animationDuration=Math.max(18,Math.round(re/130))+"s")};O();const w=requestAnimationFrame(O),M=window.setTimeout(O,1200);let W=!0;return(_=(U=document.fonts)==null?void 0:U.ready)==null||_.then(()=>{W&&O()}),()=>{W=!1,cancelAnimationFrame(w),window.clearTimeout(M)}},[g.length,l]);const y=q=>q==="all"?u.length:b[q]||0,A=q=>q==="all"?x?"All":"Tout":q.startsWith("sig:")?xr[x?"en":"fr"][q.slice(4)]||"🔔":Qi[x?"en":"fr"][q],T=[{k:"all"}],z=["ma","levees"].filter(q=>y(q)>0||q===l);if(z.length){T.push({g:x?"Recent deals":"Opérations récentes"});for(const q of z)T.push({k:q})}const S=["nominations","recrutements","actualites"].filter(q=>y(q)>0||q===l),E=Ji.map(q=>"sig:"+q).filter(q=>y(q)>0||q===l);if(S.length||E.length){T.push({g:x?"News (incl. wire)":"Actualités (dont fil)"});for(const q of S)T.push({k:q});for(const q of E)T.push({k:q})}const N=q=>{try{return new Date(q+"T12:00:00Z").toLocaleDateString(x?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return q}},R=(()=>{const q=(a.filters.day||"").slice(0,10),O=!o&&a.continent!=="monde"&&i?x?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return q?(x?`LIVE covers the events of ${N(q)}.`:`Le LIVE regroupe les événements du ${N(q)}.`)+O:(x?`LIVE covers the still-open signals and the deals of the last ${fa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${fa} derniers jours.`)+O})(),I=q=>g.map(O=>t.jsxs("button",{type:"button",className:"tk"+(Oe(O)?" spent":""),onClick:w=>{const M=w.currentTarget.getBoundingClientRect();n({type:"popup",id:O.id,anchor:{x:M.left+M.width/2,y:M.bottom}})},title:O.name+(O.tagline?" — "+O.tagline:""),children:[t.jsx(ut,{o:O}),t.jsxs("span",{className:"who",children:[t.jsx(Gr,{o:O}),t.jsx("span",{className:"co",children:O.name})]}),typeof O.amountEur=="number"&&O.amountEur>0&&t.jsx("span",{className:"am",children:Ec(O.amountEur)}),O.sector&&t.jsx("span",{className:"mt",children:O.sector}),t.jsx(la,{o:O}),t.jsx("span",{className:"tkgo",children:"→"})]},q+(O.id||O.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:x?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},q+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:q=>{q.currentTarget.contains(q.relatedTarget)||h(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>h(q=>!q),children:[A(l),t.jsx("b",{children:y(l)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:R}),T.map(q=>"g"in q?t.jsx("span",{className:"tkfilg",children:q.g},q.g):t.jsxs("button",{type:"button","aria-pressed":q.k===l,onClick:()=>{f(q.k),h(!1)},children:[A(q.k),t.jsx("b",{children:y(q.k)})]},q.k))]})]}),t.jsx("div",{className:"win",children:g.length?t.jsxs("div",{className:"run",ref:C,children:[I(0),I(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!d&&t.jsx(es,{isEn:x})]})}const Zi=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function es({isEn:e}){const[a,r]=m.useState(()=>zo());m.useEffect(()=>{const i=o=>{var c;return r(!!((c=o.detail)!=null&&c.open))};return window.addEventListener(pn,i),()=>window.removeEventListener(pn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Ao(!a),children:Zi})}const ts="aDx8z7Hzksus",Qa="+33 6 83 10 72 86",Xt="alexandre@proplace.co",hr=`tel:${Qa.replace(/[^\d+]/g,"")}`,Nn="pp-rdv-slot";function as(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ns(){const{t:e,caps:a,fund:r}=$();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:os}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:hr,children:Qa}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Xt}`,children:Xt})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],c)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(c+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(ki,{filloutId:ts,parameters:r?{company_name:r}:void 0})})]})}function rs(){const[e,a]=m.useState(()=>typeof document>"u"?null:document.getElementById(Nn));return m.useEffect(()=>{e||a(document.getElementById(Nn))},[e]),e?yt.createPortal(t.jsx(ns,{}),e):null}const os=`
...
`;class Le extends m.Component{constructor(){super(...arguments);rn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const xa=600,st=62,Sn="atl2:fstats";function is(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=$(),[c,s]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Sn)==="on"}catch{return!1}}),d=r.stats,x=m.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),l=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const f=A=>a==="en"?A.slice(5,10):`${A.slice(8,10)}/${A.slice(5,7)}`,p=A=>A.toLocaleString(a==="en"?"en-US":"fr-FR"),h=x.reduce((A,T)=>Math.max(A,T.s||0),0),u=x.length?xa/x.length:0,b=Math.max(4,u-4),v=x.length>=5&&h>0,g=r.marketEstimate||0,j=f(new Date().toISOString().slice(0,10)),C=A=>[...typeof A=="number"?[[A,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&l&&y.push({cle:"fenetre",periode:e.funPerWindow(f(l),j),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:C(d.screened)}),t.jsxs("div",{className:"fstats"+(c?" on":""),children:[y.map(A=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:A.periode}),A.etapes.map(([T,z],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(T)}),t.jsx("i",{children:z})]},A.cle+z)),A.cle==="total"&&g>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(g),Math.min(100,Math.round((d.screened||0)/g*100)))})]}),A.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":c,title:c?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!c;s(T),T&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Sn,T?"on":"off")}catch{}},children:c?"⌃":"⌄"})]},A.cle)),c&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${xa} ${st}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((A,T)=>{const z=(A.s||0)/h*(st-4),S=(A.m||0)/h*(st-4),E=T*u+(u-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(A.d)} — ${A.s} ${e.actScreened} · ${A.m} ${e.actKept}`}),t.jsx("rect",{x:E,y:st-2-z,width:b,height:z,fill:"#cfe0d6"}),t.jsx("rect",{x:E,y:st-2-S,width:b,height:S,fill:"#185c38"})]},A.d)}),t.jsx("line",{x1:0,y1:st-1.5,x2:xa,y2:st-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const gr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ss(e,a){if((rt(e)||"").startsWith("CALL")&&Ce(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ce(e)>=2;return gr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function ls({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:c}=$(),[s,d]=m.useState(!1),[x,l]=m.useState(""),[f,p]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),u=async b=>{if(x)return;if(b==="Analysé"&&!e.memoUrl){p(!0);return}l(b);const v=await i(e,b);l(""),v&&(d(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(b=>!b),p(!1)},children:[h||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:f?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:c.has(e.id),onClick:()=>{o(e),p(!1),d(!1)},children:c.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const b=await i(e,"Analysé");l(""),b&&(d(!1),p(!1))})()},children:a.csAnaAnyway})]}):ss(e,a).map(([b,v])=>t.jsx("button",{type:"button",className:"rsti"+(h===b?" on":"")+(x===b?" busy":""),disabled:!!x,onClick:()=>{u(b)},children:v},b))})]})}function cs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=$(),[o,c]=m.useState(""),[s,d]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),l=(rt(e)||"").startsWith("CALL")&&Ce(e)===3,f=Ce(e)>=2,p=async u=>{if(o||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;c(u);const b=await i(e,u);c(""),b&&(d(!0),setTimeout(()=>d(!1),2200))},h=l?[["Validé",a.csYes],["Écarté",a.csNo]]:gr.filter(([u])=>!(f&&u==="Retenu")).map(([u,b])=>[u,a[b]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),h.map(([u,b])=>t.jsx("button",{type:"button",className:"csb"+(x===u?" on":"")+(o===u?" busy":""),disabled:!!o,onClick:()=>{p(u)},children:b},u)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ds,{o:e})]})}function ds({o:e}){const{t:a,saveNote:r,flash:n}=$(),[i,o]=m.useState(e.ceoNote||""),[c,s]=m.useState(!1),[d,x]=m.useState(!1),l=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(c||!l)return;s(!0);const p=await r(e,i.trim());s(!1),p&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:c,onChange:p=>o(p.target.value),onKeyDown:p=>{p.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:c||!l,onClick:()=>{f()},children:d?a.csNoteSaved:a.csNoteOk})]})}function ps({placeholder:e,onDone:a}){const{t:r}=$(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function us({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:c,flashErr:s}=$(),[d,x]=m.useState(!1);if(!n.pipe||!i||n.lockActions||Ce(e)!==4)return null;const l=o(e),f=(l==null?void 0:l.stage)||"todo",p=async g=>{if(d||g===f)return;x(!0);const j=l;c(e,{stage:g,stamps:(l==null?void 0:l.stamps)||{}});const C=Math.max(Date.now(),En+=1);En=C;const y=await To(r,{company:e.name||"",stage:g,cts:C,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(c(e,j),s(a.actErr)))},h=(v=l==null?void 0:l.stamps)==null?void 0:v.sent,u=h?Math.floor((Date.now()-Date.parse(h))/864e5):0,b=f==="sent"&&h&&u>=4;return t.jsxs("div",{className:"stg",onClick:g=>g.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([g,j])=>t.jsx("button",{type:"button",className:"stgb"+(f===g?" on":""),disabled:d,onClick:()=>{p(g)},children:j},g)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let En=0;const Bt=8,_t=360;function Cn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function zn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Cn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Cn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ms({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=$(),[c,s]=m.useState(0),[d,x]=m.useState(null),[l,f]=m.useState([]),p=m.useRef(!1),h=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),u=m.useRef(!1);m.useEffect(()=>{const z=h.current;return()=>{u.current||(n({type:"ptab",tab:z.ptab}),n({type:"dens",dens:z.dens}),n({type:"modal",modal:z.modal}))}},[]),m.useEffect(()=>{p.current||(p.current=!0,f(e.filter(z=>!!document.querySelector(z.need||z.sel))))},[e]);const b=l[c],v=c>=l.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const z=b.click,S=window.setTimeout(()=>{const E=document.querySelector(z);E&&E.getAttribute("aria-selected")!=="true"&&E.click()},60);return()=>window.clearTimeout(S)}},[c,b]);const g=m.useRef(-1),j=m.useCallback(()=>{if(!b){x(null);return}const z=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!z){x(null);return}g.current!==c&&(g.current=c,z.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=z.getBoundingClientRect();x(E=>E&&Math.abs(E.top-S.top)<1&&Math.abs(E.left-S.left)<1&&Math.abs(E.width-S.width)<1&&Math.abs(E.height-S.height)<1?E:S)},[b,c]);m.useLayoutEffect(()=>{j();const z=[90,300,700,1300].map(E=>window.setTimeout(j,E)),S=()=>j();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{z.forEach(E=>window.clearTimeout(E)),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[j]);const C=m.useRef(a);if(C.current=a,m.useEffect(()=>{const z=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),C.current()):S.key==="ArrowRight"?s(E=>E+1):S.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",z,!0),()=>document.removeEventListener("keydown",z,!0)},[]),!l.length)return null;let y=null;const A=z=>()=>{u.current=!0,n({type:"modal",modal:null}),z()};if(v){const z=i[3]||0;z>0?y={title:z===1?r.ahaATitle1:r.ahaATitleN(z),body:r.ahaABody,btn:r.ahaABtn,go:A(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:A(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:A(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:A(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:_t};if(!v&&d){const z=d.bottom+14,E=window.innerHeight-z>190?z:Math.max(12,d.top-200);T={left:Math.min(Math.max(12,d.left+d.width/2-_t/2),window.innerWidth-_t-12),top:E,width:_t}}return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Bt,top:d.top-Bt,width:d.width+Bt*2,height:d.height+Bt*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:T,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(zn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(l.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(c+1,l.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(c+1)/l.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(zn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>s(z=>Math.max(0,z-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(z=>z+1),children:c===l.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function br(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function vr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function fs(){var S,E;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:c,data:s,dispatch:d}=$(),x=r?a:e,l=m.useMemo(()=>x.filter(N=>nt(N.date)===0&&N.kind==="target"),[x]),f=m.useMemo(()=>r?a.filter(N=>N.kind==="target"&&Ce(N)===0).slice().sort((N,R)=>(R.date||"").localeCompare(N.date||"")):[],[a,r]),p=m.useMemo(()=>l.filter(N=>r?Ce(N)===0:!Oe(N)),[l,r]),h=r?f:p,u=r?a.length-f.length:l.length-p.length,b=r?a.length:l.length,v=b?Math.min(100,u/b*100):100,g=m.useMemo(()=>br(x),[x]),j=!!g&&nt(g)>0,C=m.useMemo(()=>j?x.filter(N=>(N.date||"").slice(0,10)===g):[],[x,g,j]),y=typeof((S=s.stats)==null?void 0:S.kept_today)=="number"?s.stats.kept_today:null,A=typeof((E=s.stats)==null?void 0:E.screened_today)=="number"?s.stats.screened_today:l.length;let T;j?T=i.morningLast(C.length,f.length,vr(g,c)):r?T=i.morningThesis(A,f.length,y):l.length?u===0?T=i.goalSourced(l.length):u>=l.length?T=i.goalCleared:T=i.goalDone(u,l.length):T=i.goalSourced(0);const z=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&f.length&&d({type:"chainStart",queue:f.map(N=>N.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),h.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:z,children:r?i.morningEval(h.length):o.pileMode?i.goalContinue(h.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function xs(){var W,U;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:c,dossiers:s,mode:d,doSync:x,startTour:l,flash:f,flashErr:p}=$(),[h,u]=m.useState(null),[b,v]=m.useState(!0),[g,j]=m.useState([]),C=d==="client";m.useEffect(()=>{if(!i||!o)return;let _=!0;return v(!0),(async()=>{const[re,V]=await Promise.all([Va(o),sr(i)]);_&&(re&&u(re),v(!1),j(V))})(),()=>{_=!1}},[i,o]);const[y,A]=m.useState(!1),T=()=>{!C||y||!o||(A(!0),qo(o).then(_=>{A(!1),_?f(e.identRepubDone):p(e.actErr)}))},z=(h==null?void 0:h.per_day)??null,S=((W=h==null?void 0:h.pool_order)==null?void 0:W.length)??0,E=g.filter(_=>_.status==="running").length,N=m.useMemo(()=>s.filter(_=>_.kind==="target"&&Oe(_)).length,[s]),R=c.marketEstimate,I=typeof((U=c.stats)==null?void 0:U.screened)=="number"?c.stats.screened:N,q=R&&R>0?Math.min(100,Math.round(I/R*100)):null,O=_=>_.toLocaleString(a==="en"?"en-US":"fr-FR"),w=(o||"P").split(/\s+/).map(_=>_[0]).join("").slice(0,2).toUpperCase(),M=(()=>{const _=Date.parse(c.generatedAt||"");if(Number.isNaN(_))return"";const re=new Date(_),V=X=>String(X).padStart(2,"0");return`${V(re.getDate())}/${V(re.getMonth()+1)} à ${V(re.getHours())}:${V(re.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?w:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),M?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(M)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[q===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:O(I)})})]}),q!==null&&R&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:q+"%"}})}),t.jsxs("b",{children:[q," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,R)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),z!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:z})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),z===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),E>0&&t.jsxs("span",{className:"ev",children:["⏳ ",E]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:_=>{_.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!C||y,onClick:T,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!C,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:_=>n({type:"filters",patch:{search:_.target.value}})})]})]})]})}function hs(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:c}=$(),s=o.loading&&!c.length,d=m.useRef({});m.useEffect(()=>{d.current={...r}},[r]);const x=p=>{const h=d.current[p],u=h!==void 0?r[p]-h:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${wa[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[r[p],u!==0&&t.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},p)},l=(p,h,u)=>t.jsxs("button",{type:"button",className:"off"+(h?" view":""),style:{"--c":`var(${wa[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:u.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),f=(p,h,u,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:h,disabled:b,onClick:u,children:p},h);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[l(5,!1,n.plabels[5]),l(7,!0,n.plabels[7]),l(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function gs(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:c}=$(),s=m.useRef(null),[d,x]=m.useState(60);m.useEffect(()=>{let u=0;const b=()=>{var y;const v=s.current;if(!v)return;const g=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!g)return;const j=g.getBoundingClientRect(),C=v.getBoundingClientRect();x(Math.max(20,Math.min(j.left+j.width/2-C.left,C.width-30)))};return u=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(u),window.removeEventListener("resize",b)}},[e.ptab]);const l=e.ptab;let f=r.tuto[l].p;if(l===3){const u=n.filter(g=>g.kind==="target"&&Ce(g)===3),b=u.filter(g=>ka(g)==="auto").length,v=u.filter(g=>ka(g)==="cd").length;f=r.tutoPending(b,v,u.length)}const p=(()=>{if(c!=="client")return null;if(l===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(u=>u.id)})};if(l===1){const u=n.filter(b=>b.kind==="target"&&Ce(b)===1&&!i.has(b.id)).slice(0,10);if(u.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:u.map(b=>b.id)})}}return null})(),h=Lo(l);return t.jsxs("div",{ref:s,className:"tuto mini"+(h?"":" on-dark"),style:{"--bg":`var(${wa[l]})`,"--ax":d+"px","--stc":h?"var(--ink)":"#fff","--stt":h?"#fff":"var(--ink)","--tc":h?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[l].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:f}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}class dt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],c=a+o,s=Math.abs(a)<Math.abs(o)?a-(c-o):o-(c-a);s&&(r[n++]=s),a=c}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,c=0;if(r>0){for(c=a[--r];r>0&&(n=c,i=a[--r],c=n+i,o=i-(c-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=c+i,i==n-c&&(c=n))}return c}}function*bs(e){for(const a of e)yield*a}function yr(e){return Array.from(bs(e))}var ue=1e-6,ie=Math.PI,He=ie/2,An=ie/4,Ye=ie*2,tt=180/ie,Be=ie/180,ge=Math.abs,vs=Math.atan,qt=Math.atan2,Ne=Math.cos,Se=Math.sin,ys=Math.sign||function(e){return e>0?1:e<0?-1:0},mt=Math.sqrt;function ws(e){return e>1?0:e<-1?ie:Math.acos(e)}function Lt(e){return e>1?He:e<-1?-He:Math.asin(e)}function We(){}function Zt(e,a){e&&qn.hasOwnProperty(e.type)&&qn[e.type](e,a)}var Tn={Feature:function(e,a){Zt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Zt(r[n].geometry,a)}},qn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Ca(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Ca(r[n],a,0)},Polygon:function(e,a){Ln(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Ln(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Zt(r[n],a)}};function Ca(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Ln(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Ca(e[r],a,1);a.polygonEnd()}function ft(e,a){e&&Tn.hasOwnProperty(e.type)?Tn[e.type](e,a):Zt(e,a)}function za(e){return[qt(e[1],e[0]),Lt(e[2])]}function bt(e){var a=e[0],r=e[1],n=Ne(r);return[n*Ne(a),n*Se(a),Se(r)]}function Ut(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function ea(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ha(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Vt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Aa(e){var a=mt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ta(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function qa(e,a){return ge(e)>ie&&(e-=Math.round(e/Ye)*Ye),[e,a]}qa.invert=qa;function ks(e,a,r){return(e%=Ye)?a||r?Ta(Rn(e),On(a,r)):Rn(e):a||r?On(a,r):qa}function Mn(e){return function(a,r){return a+=e,ge(a)>ie&&(a-=Math.round(a/Ye)*Ye),[a,r]}}function Rn(e){var a=Mn(e);return a.invert=Mn(-e),a}function On(e,a){var r=Ne(e),n=Se(e),i=Ne(a),o=Se(a);function c(s,d){var x=Ne(d),l=Ne(s)*x,f=Se(s)*x,p=Se(d),h=p*r+l*n;return[qt(f*i-h*o,l*r-p*n),Lt(h*i+f*o)]}return c.invert=function(s,d){var x=Ne(d),l=Ne(s)*x,f=Se(s)*x,p=Se(d),h=p*i-f*o;return[qt(f*i+p*o,l*r+h*n),Lt(h*r-l*n)]},c}function js(e,a,r,n,i,o){if(r){var c=Ne(a),s=Se(a),d=n*r;i==null?(i=a+n*Ye,o=a-d/2):(i=Fn(c,i),o=Fn(c,o),(n>0?i<o:i>o)&&(i+=n*Ye));for(var x,l=i;n>0?l>o:l<o;l-=d)x=za([c,-s*Ne(l),-s*Se(l)]),e.point(x[0],x[1])}}function Fn(e,a){a=bt(a),a[0]-=e,Aa(a);var r=ws(-a[1]);return((-a[2]<0?-r:r)+Ye-ue)%Ye}function wr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:We,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Qt(e,a){return ge(e[0]-a[0])<ue&&ge(e[1]-a[1])<ue}function Ht(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function kr(e,a,r,n,i){var o=[],c=[],s,d;if(e.forEach(function(u){if(!((b=u.length-1)<=0)){var b,v=u[0],g=u[b],j;if(Qt(v,g)){if(!v[2]&&!g[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=u[s])[0],v[1]);i.lineEnd();return}g[0]+=2*ue}o.push(j=new Ht(v,u,null,!0)),c.push(j.o=new Ht(v,null,j,!1)),o.push(j=new Ht(g,u,null,!1)),c.push(j.o=new Ht(g,null,j,!0))}}),!!o.length){for(c.sort(a),Pn(o),Pn(c),s=0,d=c.length;s<d;++s)c[s].e=r=!r;for(var x=o[0],l,f;;){for(var p=x,h=!0;p.v;)if((p=p.n)===x)return;l=p.z,i.lineStart();do{if(p.v=p.o.v=!0,p.e){if(h)for(s=0,d=l.length;s<d;++s)i.point((f=l[s])[0],f[1]);else n(p.x,p.n.x,1,i);p=p.n}else{if(h)for(l=p.p.z,s=l.length-1;s>=0;--s)i.point((f=l[s])[0],f[1]);else n(p.x,p.p.x,-1,i);p=p.p}p=p.o,l=p.z,h=!h}while(!p.v);i.lineEnd()}}}function Pn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function ga(e){return ge(e[0])<=ie?e[0]:ys(e[0])*((ge(e[0])+ie)%Ye-ie)}function Ns(e,a){var r=ga(a),n=a[1],i=Se(n),o=[Se(r),-Ne(r),0],c=0,s=0,d=new dt;i===1?n=He+ue:i===-1&&(n=-He-ue);for(var x=0,l=e.length;x<l;++x)if(p=(f=e[x]).length)for(var f,p,h=f[p-1],u=ga(h),b=h[1]/2+An,v=Se(b),g=Ne(b),j=0;j<p;++j,u=y,v=T,g=z,h=C){var C=f[j],y=ga(C),A=C[1]/2+An,T=Se(A),z=Ne(A),S=y-u,E=S>=0?1:-1,N=E*S,R=N>ie,I=v*T;if(d.add(qt(I*E*Se(N),g*z+I*Ne(N))),c+=R?S+E*Ye:S,R^u>=r^y>=r){var q=ea(bt(h),bt(C));Aa(q);var O=ea(o,q);Aa(O);var w=(R^S>=0?-1:1)*Lt(O[2]);(n>w||n===w&&(q[0]||q[1]))&&(s+=R^S>=0?1:-1)}}return(c<-ue||c<ue&&d<-1e-12)^s&1}function jr(e,a,r,n){return function(i){var o=a(i),c=wr(),s=a(c),d=!1,x,l,f,p={point:h,lineStart:b,lineEnd:v,polygonStart:function(){p.point=g,p.lineStart=j,p.lineEnd=C,l=[],x=[]},polygonEnd:function(){p.point=h,p.lineStart=b,p.lineEnd=v,l=yr(l);var y=Ns(x,n);l.length?(d||(i.polygonStart(),d=!0),kr(l,Es,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),l=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function h(y,A){e(y,A)&&i.point(y,A)}function u(y,A){o.point(y,A)}function b(){p.point=u,o.lineStart()}function v(){p.point=h,o.lineEnd()}function g(y,A){f.push([y,A]),s.point(y,A)}function j(){s.lineStart(),f=[]}function C(){g(f[0][0],f[0][1]),s.lineEnd();var y=s.clean(),A=c.result(),T,z=A.length,S,E,N;if(f.pop(),x.push(f),f=null,!!z){if(y&1){if(E=A[0],(S=E.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),T=0;T<S;++T)i.point((N=E[T])[0],N[1]);i.lineEnd()}return}z>1&&y&2&&A.push(A.pop().concat(A.shift())),l.push(A.filter(Ss))}}return p}}function Ss(e){return e.length>1}function Es(e,a){return((e=e.x)[0]<0?e[1]-He-ue:He-e[1])-((a=a.x)[0]<0?a[1]-He-ue:He-a[1])}const Dn=jr(function(){return!0},Cs,As,[-ie,-He]);function Cs(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,c){var s=o>0?ie:-ie,d=ge(o-a);ge(d-ie)<ue?(e.point(a,r=(r+c)/2>0?He:-He),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&d>=ie&&(ge(a-n)<ue&&(a-=n*ue),ge(o-s)<ue&&(o-=s*ue),r=zs(a,r,o,c),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=c),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function zs(e,a,r,n){var i,o,c=Se(e-r);return ge(c)>ue?vs((Se(a)*(o=Ne(n))*Se(r)-Se(n)*(i=Ne(a))*Se(e))/(i*o*c)):(a+n)/2}function As(e,a,r,n){var i;if(e==null)i=r*He,n.point(-ie,i),n.point(0,i),n.point(ie,i),n.point(ie,0),n.point(ie,-i),n.point(0,-i),n.point(-ie,-i),n.point(-ie,0),n.point(-ie,i);else if(ge(e[0]-a[0])>ue){var o=e[0]<a[0]?ie:-ie;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ts(e){var a=Ne(e),r=2*Be,n=a>0,i=ge(a)>ue;function o(l,f,p,h){js(h,e,r,p,l,f)}function c(l,f){return Ne(l)*Ne(f)>a}function s(l){var f,p,h,u,b;return{lineStart:function(){u=h=!1,b=1},point:function(v,g){var j=[v,g],C,y=c(v,g),A=n?y?0:x(v,g):y?x(v+(v<0?ie:-ie),g):0;if(!f&&(u=h=y)&&l.lineStart(),y!==h&&(C=d(f,j),(!C||Qt(f,C)||Qt(j,C))&&(j[2]=1)),y!==h)b=0,y?(l.lineStart(),C=d(j,f),l.point(C[0],C[1])):(C=d(f,j),l.point(C[0],C[1],2),l.lineEnd()),f=C;else if(i&&f&&n^y){var T;!(A&p)&&(T=d(j,f,!0))&&(b=0,n?(l.lineStart(),l.point(T[0][0],T[0][1]),l.point(T[1][0],T[1][1]),l.lineEnd()):(l.point(T[1][0],T[1][1]),l.lineEnd(),l.lineStart(),l.point(T[0][0],T[0][1],3)))}y&&(!f||!Qt(f,j))&&l.point(j[0],j[1]),f=j,h=y,p=A},lineEnd:function(){h&&l.lineEnd(),f=null},clean:function(){return b|(u&&h)<<1}}}function d(l,f,p){var h=bt(l),u=bt(f),b=[1,0,0],v=ea(h,u),g=Ut(v,v),j=v[0],C=g-j*j;if(!C)return!p&&l;var y=a*g/C,A=-a*j/C,T=ea(b,v),z=Vt(b,y),S=Vt(v,A);ha(z,S);var E=T,N=Ut(z,E),R=Ut(E,E),I=N*N-R*(Ut(z,z)-1);if(!(I<0)){var q=mt(I),O=Vt(E,(-N-q)/R);if(ha(O,z),O=za(O),!p)return O;var w=l[0],M=f[0],W=l[1],U=f[1],_;M<w&&(_=w,w=M,M=_);var re=M-w,V=ge(re-ie)<ue,X=V||re<ue;if(!V&&U<W&&(_=W,W=U,U=_),X?V?W+U>0^O[1]<(ge(O[0]-w)<ue?W:U):W<=O[1]&&O[1]<=U:re>ie^(w<=O[0]&&O[0]<=M)){var ae=Vt(E,(-N+q)/R);return ha(ae,z),[O,za(ae)]}}}function x(l,f){var p=n?e:ie-e,h=0;return l<-p?h|=1:l>p&&(h|=2),f<-p?h|=4:f>p&&(h|=8),h}return jr(c,s,o,n?[0,-e]:[-ie,e-ie])}function qs(e,a,r,n,i,o){var c=e[0],s=e[1],d=a[0],x=a[1],l=0,f=1,p=d-c,h=x-s,u;if(u=r-c,!(!p&&u>0)){if(u/=p,p<0){if(u<l)return;u<f&&(f=u)}else if(p>0){if(u>f)return;u>l&&(l=u)}if(u=i-c,!(!p&&u<0)){if(u/=p,p<0){if(u>f)return;u>l&&(l=u)}else if(p>0){if(u<l)return;u<f&&(f=u)}if(u=n-s,!(!h&&u>0)){if(u/=h,h<0){if(u<l)return;u<f&&(f=u)}else if(h>0){if(u>f)return;u>l&&(l=u)}if(u=o-s,!(!h&&u<0)){if(u/=h,h<0){if(u>f)return;u>l&&(l=u)}else if(h>0){if(u<l)return;u<f&&(f=u)}return l>0&&(e[0]=c+l*p,e[1]=s+l*h),f<1&&(a[0]=c+f*p,a[1]=s+f*h),!0}}}}}var St=1e9,Wt=-St;function Ls(e,a,r,n){function i(x,l){return e<=x&&x<=r&&a<=l&&l<=n}function o(x,l,f,p){var h=0,u=0;if(x==null||(h=c(x,f))!==(u=c(l,f))||d(x,l)<0^f>0)do p.point(h===0||h===3?e:r,h>1?n:a);while((h=(h+f+4)%4)!==u);else p.point(l[0],l[1])}function c(x,l){return ge(x[0]-e)<ue?l>0?0:3:ge(x[0]-r)<ue?l>0?2:1:ge(x[1]-a)<ue?l>0?1:0:l>0?3:2}function s(x,l){return d(x.x,l.x)}function d(x,l){var f=c(x,1),p=c(l,1);return f!==p?f-p:f===0?l[1]-x[1]:f===1?x[0]-l[0]:f===2?x[1]-l[1]:l[0]-x[0]}return function(x){var l=x,f=wr(),p,h,u,b,v,g,j,C,y,A,T,z={point:S,lineStart:I,lineEnd:q,polygonStart:N,polygonEnd:R};function S(w,M){i(w,M)&&l.point(w,M)}function E(){for(var w=0,M=0,W=h.length;M<W;++M)for(var U=h[M],_=1,re=U.length,V=U[0],X,ae,Y=V[0],be=V[1];_<re;++_)X=Y,ae=be,V=U[_],Y=V[0],be=V[1],ae<=n?be>n&&(Y-X)*(n-ae)>(be-ae)*(e-X)&&++w:be<=n&&(Y-X)*(n-ae)<(be-ae)*(e-X)&&--w;return w}function N(){l=f,p=[],h=[],T=!0}function R(){var w=E(),M=T&&w,W=(p=yr(p)).length;(M||W)&&(x.polygonStart(),M&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),W&&kr(p,s,w,o,x),x.polygonEnd()),l=x,p=h=u=null}function I(){z.point=O,h&&h.push(u=[]),A=!0,y=!1,j=C=NaN}function q(){p&&(O(b,v),g&&y&&f.rejoin(),p.push(f.result())),z.point=S,y&&l.lineEnd()}function O(w,M){var W=i(w,M);if(h&&u.push([w,M]),A)b=w,v=M,g=W,A=!1,W&&(l.lineStart(),l.point(w,M));else if(W&&y)l.point(w,M);else{var U=[j=Math.max(Wt,Math.min(St,j)),C=Math.max(Wt,Math.min(St,C))],_=[w=Math.max(Wt,Math.min(St,w)),M=Math.max(Wt,Math.min(St,M))];qs(U,_,e,a,r,n)?(y||(l.lineStart(),l.point(U[0],U[1])),l.point(_[0],_[1]),W||l.lineEnd(),T=!1):W&&(l.lineStart(),l.point(w,M),T=!1)}j=w,C=M,y=W}return z}}const La=e=>e;var ba=new dt,Ma=new dt,Nr,Sr,Ra,Oa,at={point:We,lineStart:We,lineEnd:We,polygonStart:function(){at.lineStart=Ms,at.lineEnd=Os},polygonEnd:function(){at.lineStart=at.lineEnd=at.point=We,ba.add(ge(Ma)),Ma=new dt},result:function(){var e=ba/2;return ba=new dt,e}};function Ms(){at.point=Rs}function Rs(e,a){at.point=Er,Nr=Ra=e,Sr=Oa=a}function Er(e,a){Ma.add(Oa*e-Ra*a),Ra=e,Oa=a}function Os(){Er(Nr,Sr)}var vt=1/0,ta=vt,Mt=-vt,aa=Mt,na={point:Fs,lineStart:We,lineEnd:We,polygonStart:We,polygonEnd:We,result:function(){var e=[[vt,ta],[Mt,aa]];return Mt=aa=-(ta=vt=1/0),e}};function Fs(e,a){e<vt&&(vt=e),e>Mt&&(Mt=e),a<ta&&(ta=a),a>aa&&(aa=a)}var Fa=0,Pa=0,Et=0,ra=0,oa=0,xt=0,Da=0,Ia=0,Ct=0,Cr,zr,Xe,Ze,Ve={point:pt,lineStart:In,lineEnd:$n,polygonStart:function(){Ve.lineStart=Is,Ve.lineEnd=$s},polygonEnd:function(){Ve.point=pt,Ve.lineStart=In,Ve.lineEnd=$n},result:function(){var e=Ct?[Da/Ct,Ia/Ct]:xt?[ra/xt,oa/xt]:Et?[Fa/Et,Pa/Et]:[NaN,NaN];return Fa=Pa=Et=ra=oa=xt=Da=Ia=Ct=0,e}};function pt(e,a){Fa+=e,Pa+=a,++Et}function In(){Ve.point=Ps}function Ps(e,a){Ve.point=Ds,pt(Xe=e,Ze=a)}function Ds(e,a){var r=e-Xe,n=a-Ze,i=mt(r*r+n*n);ra+=i*(Xe+e)/2,oa+=i*(Ze+a)/2,xt+=i,pt(Xe=e,Ze=a)}function $n(){Ve.point=pt}function Is(){Ve.point=Bs}function $s(){Ar(Cr,zr)}function Bs(e,a){Ve.point=Ar,pt(Cr=Xe=e,zr=Ze=a)}function Ar(e,a){var r=e-Xe,n=a-Ze,i=mt(r*r+n*n);ra+=i*(Xe+e)/2,oa+=i*(Ze+a)/2,xt+=i,i=Ze*e-Xe*a,Da+=i*(Xe+e),Ia+=i*(Ze+a),Ct+=i*3,pt(Xe=e,Ze=a)}function Tr(e){this._context=e}Tr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Ye);break}}},result:We};var $a=new dt,va,qr,Lr,zt,At,Rt={point:We,lineStart:function(){Rt.point=_s},lineEnd:function(){va&&Mr(qr,Lr),Rt.point=We},polygonStart:function(){va=!0},polygonEnd:function(){va=null},result:function(){var e=+$a;return $a=new dt,e}};function _s(e,a){Rt.point=Mr,qr=zt=e,Lr=At=a}function Mr(e,a){zt-=e,At-=a,$a.add(mt(zt*zt+At*At)),zt=e,At=a}let Bn,ia,_n,Un;class Vn{constructor(a){this._append=a==null?Rr:Us(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==_n||this._append!==ia){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,_n=n,ia=this._append,Un=this._,this._=i}this._+=Un;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Rr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Us(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Rr;if(a!==Bn){const r=10**a;Bn=a,ia=function(i){let o=1;this._+=i[0];for(const c=i.length;o<c;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ia}function Vs(e,a){let r=3,n=4.5,i,o;function c(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),ft(s,i(o))),o.result()}return c.area=function(s){return ft(s,i(at)),at.result()},c.measure=function(s){return ft(s,i(Rt)),Rt.result()},c.bounds=function(s){return ft(s,i(na)),na.result()},c.centroid=function(s){return ft(s,i(Ve)),Ve.result()},c.projection=function(s){return arguments.length?(i=s==null?(e=null,La):(e=s).stream,c):e},c.context=function(s){return arguments.length?(o=s==null?(a=null,new Vn(r)):new Tr(a=s),typeof n!="function"&&o.pointRadius(n),c):a},c.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),c):n},c.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const d=Math.floor(s);if(!(d>=0))throw new RangeError(`invalid digits: ${s}`);r=d}return a===null&&(o=new Vn(r)),c},c.projection(e).digits(r).context(a)}function Ja(e){return function(a){var r=new Ba;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Ba(){}Ba.prototype={constructor:Ba,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Xa(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),ft(r,e.stream(na)),a(na.result()),n!=null&&e.clipExtent(n),e}function Or(e,a,r){return Xa(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],c=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-c*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-c*(n[1][1]+n[0][1]))/2;e.scale(150*c).translate([s,d])},r)}function Hs(e,a,r){return Or(e,[[0,0],a],r)}function Ws(e,a,r){return Xa(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),c=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([c,s])},r)}function Ys(e,a,r){return Xa(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),c=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([c,s])},r)}var Hn=16,Gs=Ne(30*Be);function Wn(e,a){return+a?Qs(e,a):Ks(e)}function Ks(e){return Ja({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Qs(e,a){function r(n,i,o,c,s,d,x,l,f,p,h,u,b,v){var g=x-n,j=l-i,C=g*g+j*j;if(C>4*a&&b--){var y=c+p,A=s+h,T=d+u,z=mt(y*y+A*A+T*T),S=Lt(T/=z),E=ge(ge(T)-1)<ue||ge(o-f)<ue?(o+f)/2:qt(A,y),N=e(E,S),R=N[0],I=N[1],q=R-n,O=I-i,w=j*q-g*O;(w*w/C>a||ge((g*q+j*O)/C-.5)>.3||c*p+s*h+d*u<Gs)&&(r(n,i,o,c,s,d,R,I,E,y/=z,A/=z,T,b,v),v.point(R,I),r(R,I,E,y,A,T,x,l,f,p,h,u,b,v))}}return function(n){var i,o,c,s,d,x,l,f,p,h,u,b,v={point:g,lineStart:j,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=A},polygonEnd:function(){n.polygonEnd(),v.lineStart=j}};function g(S,E){S=e(S,E),n.point(S[0],S[1])}function j(){f=NaN,v.point=C,n.lineStart()}function C(S,E){var N=bt([S,E]),R=e(S,E);r(f,p,l,h,u,b,f=R[0],p=R[1],l=S,h=N[0],u=N[1],b=N[2],Hn,n),n.point(f,p)}function y(){v.point=g,n.lineEnd()}function A(){j(),v.point=T,v.lineEnd=z}function T(S,E){C(i=S,E),o=f,c=p,s=h,d=u,x=b,v.point=C}function z(){r(f,p,l,h,u,b,o,c,i,s,d,x,Hn,n),v.lineEnd=y,y()}return v}}var Js=Ja({point:function(e,a){this.stream.point(e*Be,a*Be)}});function Xs(e){return Ja({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Zs(e,a,r,n,i){function o(c,s){return c*=n,s*=i,[a+e*c,r-e*s]}return o.invert=function(c,s){return[(c-a)/e*n,(r-s)/e*i]},o}function Yn(e,a,r,n,i,o){if(!o)return Zs(e,a,r,n,i);var c=Ne(o),s=Se(o),d=c*e,x=s*e,l=c/e,f=s/e,p=(s*r-c*a)/e,h=(s*a+c*r)/e;function u(b,v){return b*=n,v*=i,[d*b-x*v+a,r-x*b-d*v]}return u.invert=function(b,v){return[n*(l*b-f*v+p),i*(h-f*b-l*v)]},u}function el(e){return tl(function(){return e})()}function tl(e){var a,r=150,n=480,i=250,o=0,c=0,s=0,d=0,x=0,l,f=0,p=1,h=1,u=null,b=Dn,v=null,g,j,C,y=La,A=.5,T,z,S,E,N;function R(w){return S(w[0]*Be,w[1]*Be)}function I(w){return w=S.invert(w[0],w[1]),w&&[w[0]*tt,w[1]*tt]}R.stream=function(w){return E&&N===w?E:E=Js(Xs(l)(b(T(y(N=w)))))},R.preclip=function(w){return arguments.length?(b=w,u=void 0,O()):b},R.postclip=function(w){return arguments.length?(y=w,v=g=j=C=null,O()):y},R.clipAngle=function(w){return arguments.length?(b=+w?Ts(u=w*Be):(u=null,Dn),O()):u*tt},R.clipExtent=function(w){return arguments.length?(y=w==null?(v=g=j=C=null,La):Ls(v=+w[0][0],g=+w[0][1],j=+w[1][0],C=+w[1][1]),O()):v==null?null:[[v,g],[j,C]]},R.scale=function(w){return arguments.length?(r=+w,q()):r},R.translate=function(w){return arguments.length?(n=+w[0],i=+w[1],q()):[n,i]},R.center=function(w){return arguments.length?(o=w[0]%360*Be,c=w[1]%360*Be,q()):[o*tt,c*tt]},R.rotate=function(w){return arguments.length?(s=w[0]%360*Be,d=w[1]%360*Be,x=w.length>2?w[2]%360*Be:0,q()):[s*tt,d*tt,x*tt]},R.angle=function(w){return arguments.length?(f=w%360*Be,q()):f*tt},R.reflectX=function(w){return arguments.length?(p=w?-1:1,q()):p<0},R.reflectY=function(w){return arguments.length?(h=w?-1:1,q()):h<0},R.precision=function(w){return arguments.length?(T=Wn(z,A=w*w),O()):mt(A)},R.fitExtent=function(w,M){return Or(R,w,M)},R.fitSize=function(w,M){return Hs(R,w,M)},R.fitWidth=function(w,M){return Ws(R,w,M)},R.fitHeight=function(w,M){return Ys(R,w,M)};function q(){var w=Yn(r,0,0,p,h,f).apply(null,a(o,c)),M=Yn(r,n-w[0],i-w[1],p,h,f);return l=ks(s,d,x),z=Ta(a,M),S=Ta(l,z),T=Wn(z,A),O()}function O(){return E=N=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&I,q()}}function Fr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Fr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,c=o*o;r-=i=(r*(1.007226+o*(.015085+c*(-.044475+.028874*o-.005916*c)))-a)/(1.007226+o*(.015085*3+c*(-.044475*7+.028874*9*o-.005916*11*c)))}while(ge(i)>ue&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function al(){return el(Fr).scale(175.295)}function nl(e){return e}function rl(e){if(e==null)return nl;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],c=e.translate[1];return function(s,d){d||(a=r=0);var x=2,l=s.length,f=new Array(l);for(f[0]=(a+=s[0])*n+o,f[1]=(r+=s[1])*i+c;x<l;)f[x]=s[x],++x;return f}}function ol(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function il(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Gn(e,r)})}:Gn(e,a)}function Gn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=sl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function sl(e,a){var r=rl(e.transform),n=e.arcs;function i(l,f){f.length&&f.pop();for(var p=n[l<0?~l:l],h=0,u=p.length;h<u;++h)f.push(r(p[h],h));l<0&&ol(f,u)}function o(l){return r(l)}function c(l){for(var f=[],p=0,h=l.length;p<h;++p)i(l[p],f);return f.length<2&&f.push(f[0]),f}function s(l){for(var f=c(l);f.length<4;)f.push(f[0]);return f}function d(l){return l.map(s)}function x(l){var f=l.type,p;switch(f){case"GeometryCollection":return{type:f,geometries:l.geometries.map(x)};case"Point":p=o(l.coordinates);break;case"MultiPoint":p=l.coordinates.map(o);break;case"LineString":p=c(l.arcs);break;case"MultiLineString":p=l.arcs.map(c);break;case"Polygon":p=d(l.arcs);break;case"MultiPolygon":p=l.arcs.map(d);break;default:return null}return{type:f,coordinates:p}}return x(a)}const Pr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ll=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function cl(e,a,r){const n=Pr[e];if(!n||!n.length)return-1;const i=ll(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(c=>i.includes(c)))return o}return Math.floor(r*n.length)%n.length}let Yt=null;function dl(){return Yt||(Yt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=il(r,n),o=al().fitExtent([[8,8],[992,492]],{type:"Sphere"}),c=Vs(o),s=(i.features||[]).filter(l=>{var f;return(((f=l.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(l=>{var h;const f=((h=l.properties)==null?void 0:h.name)||"",p=c(l)||"";return p?{i2:Mo(f)||null,n:f,d:p}:null}).filter(l=>!!l);if(!s.length)return null;const d={};for(const[l,f]of Object.entries(Ro)){const p=o(f);p&&(d[l]={x:p[0],y:p[1]})}const x={};for(const[l,f]of Object.entries(Pr)){const p=f.map(h=>o(h.ll)).filter(h=>!!h).map(([h,u])=>({x:h,y:u}));p.length&&(x[l]=p)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:d,metros:x}}catch{return null}})(),Yt)}function pl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return dl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const ul={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Kn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Qn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ml(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const c=()=>{var x;if(!i)return;const d=(x=e.current)==null?void 0:x.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(c)};c();const s=new ResizeObserver(()=>c());return e.current&&s.observe(e.current),window.addEventListener("resize",c),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",c)}},[e,a]),r}function Jn({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],c)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":c*.18+"s"}},c)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function fl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:c,lang:s,t:d,data:x,dossiers:l,source:f}=$(),p=x.loading&&!l.length,h=m.useRef(null),u=m.useRef(null),b=pl(e.continent==="monde"),v=e.continent==="monde"?b:Ha.find(w=>w.key===e.continent)||null,g=ml(h,e.continent+":"+e.mapFolded+":"+!!v),[j,C]=m.useState(new Map),[y,A]=m.useState(null);m.useEffect(()=>{const w=h.current;if(!w)return;const M=new Map;w.querySelectorAll("path[data-i2]").forEach(W=>{const U=W.dataset.i2;if(U)try{const _=W.getBBox();_.width>0&&M.set(U,{x:_.x,y:_.y,w:_.width,h:_.height})}catch{}}),C(M)},[e.continent,g,v]);const T=m.useMemo(()=>r.filter(w=>w.cc),[r]),z=m.useMemo(()=>{const w=new Map;return T.forEach(M=>w.set(M.cc,(w.get(M.cc)||0)+1)),w},[T]),S=e.continent==="monde"&&b?b.anchors:null,E=e.continent==="monde"&&b?b.metros:null,N=m.useMemo(()=>T.map(w=>{const M=Qn(w.name||w.id||""),W=Qn((w.id||w.name||"")+"·y");if(S&&w.cc){const X=E?E[w.cc]:void 0;if(X&&X.length){const Y=cl(w.cc,w.city,M);if(Y>=0&&X[Y])return{d:w,x:X[Y].x+(M-.5)*5,y:X[Y].y+(W-.5)*5}}const ae=S[w.cc];if(ae)return{d:w,x:ae.x+(M-.5)*10,y:ae.y+(W-.5)*10}}const U=w.cc?j.get(w.cc):void 0;if(!U)return null;const _=ul[`${e.continent}:${w.cc||""}`];if(_)return{d:w,x:U.x+U.w*(_.fx+(M-.5)*_.sx),y:U.y+U.h*(_.fy+(W-.5)*_.sy)};const re=(M-.5)*Math.min(U.w*.55,60),V=(W-.5)*Math.min(U.h*.55,60);return{d:w,x:U.x+U.w/2+re,y:U.y+U.h/2+V}}).filter(w=>!!w),[T,j,S,E,e.continent]),R=w=>g>0?w/g:w,I=m.useMemo(()=>n?[0,1,2,3,4,5].map(w=>({c:Kn[w],fr:d.plabels[w].toUpperCase(),en:d.plabels[w].toUpperCase(),n:r.filter(M=>M.kind==="target"&&Ce(M)===w).length})).filter(w=>w.n>0):un.map((w,M)=>({...w,n:r.filter(W=>mn(W)===M).length})),[r,n,d.plabels]),q=o?c.get(o):null,O=q?N.find(w=>w.d.id===q.id):null;return v?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:[p&&t.jsx(Jn,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:h,viewBox:v.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?v.fr:v.en,onMouseLeave:()=>{A(null),i(null)},children:[t.jsx("g",{children:v.countries.map((w,M)=>t.jsx("g",{className:"ct"+(w.i2&&z.get(w.i2)?"":" empty"),children:t.jsx("path",{d:w.d,"data-i2":w.i2||void 0})},M))}),t.jsx("g",{children:N.map(w=>{const M=un[mn(w.d)],W=!!ze(w.d),U=w.d.kind==="target",_=n&&U?Kn[Ce(w.d)]:M.c,re=!n&&Oe(w.d);return t.jsxs("g",{className:"co"+(re?" done":""),onMouseEnter:()=>{var ae,Y;const V=(ae=u.current)==null?void 0:ae.getBoundingClientRect(),X=(Y=h.current)==null?void 0:Y.createSVGPoint();if(X&&h.current&&V){X.x=w.x,X.y=w.y;const be=X.matrixTransform(h.current.getScreenCTM());A({x:be.x-V.left,y:be.y-V.top,label:w.d.name+" · "+(wt(w.d.cc,s)||w.d.countryLabel||"")})}i(w.d.id)},onMouseLeave:()=>{A(null),i(null)},onClick:()=>{var ae;if(f==="ops"){a({type:"focus",id:w.d.id}),w.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:w.d.name}}));return}const V=(ae=h.current)==null?void 0:ae.createSVGPoint();let X=null;if(V&&h.current){V.x=w.x,V.y=w.y;const Y=V.matrixTransform(h.current.getScreenCTM());X={x:Y.x,y:Y.y}}a({type:"popup",id:w.d.id,anchor:X})},children:[t.jsx("circle",{className:"h",cx:w.x,cy:w.y,r:R(Math.max(11,M.px+7))}),t.jsx("circle",{className:"v",cx:w.x,cy:w.y,r:R(M.px),fill:_,stroke:W?"#DC2626":"#ffffff",strokeWidth:R(W?2.2:1.3)})]},w.d.id||w.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:R(13),fill:"none",stroke:"#0F172A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:I.map((w,M)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":w.c}}),s==="fr"?w.fr:w.en," ",t.jsx("b",{children:w.n})]},M))}),r.some(w=>!w.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(w=>!w.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:t.jsx(Jn,{msgs:d.loadMsgs})})}function xl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Dr({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:c,lang:s}=$(),d=a.filters,[x,l]=m.useState(!1),f=m.useRef(null),p=m.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),h=S=>p.filter(E=>S!=="country"&&d.country.length&&!d.country.includes(E.cc||"")?!1:Ya(E,d,o,S==="country"?void 0:S)),u=m.useMemo(()=>{const S=h("win"),E=N=>S.filter(R=>(R.date?Math.max(0,Math.floor((Date.now()-Date.parse(R.date))/864e5)):9999)<=N).length;return[E(0),E(7),E(30),S.length]},[p,d,o]),b=m.useMemo(()=>d.day?h("win").filter(S=>(S.date||"").slice(0,10)===d.day).length:0,[p,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,g=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&l(!1)},[a.openFacet]),m.useEffect(()=>{if(!x)return;const S=N=>{var R;(R=f.current)!=null&&R.contains(N.target)||l(!1)},E=N=>{N.key==="Escape"&&l(!1)};return document.addEventListener("mousedown",S),document.addEventListener("keydown",E),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",E)}},[x]);const j=(S,E,N,R="fbtn")=>t.jsxs("button",{type:"button",className:R,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:E}),N>0&&t.jsx("span",{className:"n",children:N}),t.jsx("span",{className:"cv",children:"▾"})]},S),C=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(xl(d.day,s))}),t.jsx("b",{children:b})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((S,E)=>t.jsxs("button",{type:"button","aria-pressed":d.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:i.dates[E]}),t.jsx("b",{children:u[E]})]},S))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),A=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):j("sec",i.fSector,d.sector.length),j("pay",i.fCountry,d.country.length),j("det",i.fEngine,d.engine.length),j("sta",i.fStage,d.stage.length),o&&j("ang","Angle",d.angle.length),o&&j("mem","Mémo",d.memoLevel.length)]}),T=(S=!1)=>t.jsxs("div",{className:"frow2",children:[g>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(p.length,c),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(g)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),S&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),z=t.jsxs("div",{className:"fmenu",ref:f,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{l(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:A})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[!d.day&&t.jsx("div",{className:"fstrip-a",children:C}),t.jsxs("div",{className:"fstrip-b",children:[y,z,T(!0)]})]}),a.openFacet&&t.jsx(Xn,{poolFor:h})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[C,y,A,t.jsx("span",{className:"fgrow"}),T()]}),a.openFacet&&t.jsx(Xn,{poolFor:h})]})}function Xn({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=a.filters,c=a.openFacet,{title:s,cols:d,options:x}=m.useMemo(()=>{if(c==="sig"){const u=e("signal").filter(g=>ze(g)),b=new Map;u.forEach(g=>{const j=g.engine||"";b.set(j,(b.get(j)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:u.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ja([...b.keys()],i).map(g=>({v:g,label:ct(g)+" "+Ke(g,i),n:b.get(g)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(g)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(c==="sec"){const u=e("sector"),b=new Map;return u.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:v,n:g,html:!1,on:o.sector.includes(v)}))}}if(c==="pay"){const u=e("country"),b=new Map;return u.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:wt(v,i)||v,n:g,html:!1,on:o.country.includes(v)}))}}if(c==="det"){const u=e("engine"),b=new Map;return u.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ja([...b.keys()],i).map(v=>({v,label:ct(v)+" "+Ke(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Oo(Fo(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(c==="ang"){const u=e("angle"),b=new Map;return u.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,g)=>g[1]-v[1]).map(([v,g])=>({v,label:v.replace(/[_-]+/g," "),n:g,html:!1,on:o.angle.includes(v)}))}}if(c==="mem"){const u=e("memoLevel"),b=new Map;u.forEach(g=>{if(g.kind==="target"){const j=Ua(g);b.set(j,(b.get(j)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(g=>({v:String(g),label:v[g],n:b.get(g)||0,html:!1,on:o.memoLevel.includes(g)}))}}const p=e("stage"),h=new Map;return p.forEach(u=>{u.stage&&h.set(u.stage,(h.get(u.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...h.entries()].sort((u,b)=>b[1]-u[1]).map(([u,b])=>({v:u,label:u,n:b,html:!1,on:o.stage.includes(u)}))}},[c,a,i]),l=p=>{if(c==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const u=o.signalEngines.includes(p)?o.signalEngines.filter(b=>b!==p):[...o.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:u}})}return}if(c==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage",value:p})},f=()=>{r(c==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:c==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:c==="sec"?"sector":c==="pay"?"country":c==="det"?"engine":c==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:x.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>l(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Ir({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:c,t:s}=$(),d=m.useMemo(()=>{const h={};return r.forEach(u=>{Ya(u,n.filters,o)&&(h.monde=(h.monde||0)+1,u.continent&&(h[u.continent]=(h[u.continent]||0)+1))}),h},[r,n.filters,o]),[x,l]=m.useState(!1),f=m.useRef(null);m.useEffect(()=>{if(!x)return;const h=b=>{var v;(v=f.current)!=null&&v.contains(b.target)||l(!1)},u=b=>{b.key==="Escape"&&l(!1)};return document.addEventListener("mousedown",h),document.addEventListener("keydown",u),()=>{document.removeEventListener("mousedown",h),document.removeEventListener("keydown",u)}},[x]);const p=h=>{const u=Ha.find(b=>b.key===h);return h==="monde"?s.contWorld:c==="fr"?u.fr:u.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:f,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>l(h=>!h),children:[p(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:fn.map(h=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===h,onClick:()=>{i({type:"continent",key:h}),l(!1)},children:[p(h),t.jsx("span",{className:"n",children:d[h]||0})]},h))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[fn.map(h=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===h,onClick:()=>i({type:"continent",key:h}),children:[p(h),t.jsx("span",{className:"n",children:d[h]||0})]},h)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function $r(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function hl(e){var i;const a=[],r=new Set,n=o=>{const c=(o||"").trim();!c||r.has(c.toLowerCase())||(r.add(c.toLowerCase()),a.push(c))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Zn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:c}){const{t:s}=$();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),c&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>c(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:s.rsEvalOne})]},d.name))})]}):null}function Br({card:e,onEvaluate:a,onAddAll:r}){var c;const{t:n}=$(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((c=e==null?void 0:e.prospective)==null?void 0:c.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Zn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Zn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function gl({card:e,onEvaluate:a,onAddAll:r}){var s,d,x;const{t:n}=$(),i=[e.industry,...e.market_tags||[],e.author].map(l=>(l||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),c=(e.sources||[]).filter(l=>l&&l.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(l=>t.jsx("span",{children:l},l))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:$r(e.summary_md||"").map((l,f)=>t.jsx("p",{children:l},f))})]}),t.jsx(Br,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(l=>t.jsx("li",{children:l},l))})]})]}),c.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:c.length})]}),t.jsx("div",{className:"rssrc",children:c.map(l=>t.jsx("a",{href:l.url,target:"_blank",rel:"noopener noreferrer",children:l.label||l.url},l.url))})]})]})}function bl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function vl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:c}=$(),s=i,[d,x]=m.useState(null),[l,f]=m.useState(null),[p,h]=m.useState(null),[u,b]=m.useState(!1);m.useEffect(()=>{let g=!0;return(async()=>{const j=await lr({email:c,cbToken:s});g&&x(j)})(),()=>{g=!1}},[c,s,n]);const v=g=>{f(g),h(null),b(!0),(async()=>{const j=await Po(g.id);h(j),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[l?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),h(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),l&&t.jsx("span",{className:"ti",children:l.title}),!l&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!l&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(g=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(g),children:[t.jsx("span",{className:"ti",children:g.title}),t.jsxs("span",{className:"me",children:[bl(g.created_at),g.industry?` · ${g.industry}`:"",g.author?` · ${g.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(g.cited_n||0,g.evaluate_n||0)}),t.jsx("span",{className:"st"+(g.published?" on":""),children:g.published?o.rsPub:o.rsPriv})]},g.id))]}),l&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[l.source_url&&t.jsx("a",{href:l.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),l.published&&l.page_url&&t.jsx("a",{href:l.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(l.published?" on":""),children:l.published?o.rsPub:o.rsPriv})]}),u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!u&&!p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!u&&p&&t.jsx(gl,{card:p,onEvaluate:a,onAddAll:r})]})]})}const er=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function yl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:c,evalBusy:s,evalCards:d,caps:x,data:l,canWrite:f,source:p,dossiers:h,doAnalyse:u,liveMemos:b,pipe:v}=$(),g=a==="client",j=m.useMemo(()=>r||(p!=="default"?Do():""),[r,p]),[C,y]=m.useState(""),[A,T]=m.useState(!1),[z,S]=m.useState(!1),[E,N]=m.useState(""),[R,I]=m.useState(!1),[q,O]=m.useState(""),[w,M]=m.useState([]),W=m.useRef(!1),[U,_]=m.useState(!1),[re,V]=m.useState(""),[X,ae]=m.useState(""),[Y,be]=m.useState(!1),[ve,Pe]=m.useState(0),[Ae,me]=m.useState(""),[ee,Q]=m.useState(null),[H,G]=m.useState(null),[Z,ye]=m.useState(!1),[ce,we]=m.useState(null),[le,pe]=m.useState(0),qe=m.useRef(!1),Re=C.trim()?er.test(C.trim())?e.evalUrl:e.evalName:e.evalWaiting,de=m.useMemo(()=>E.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[E]);m.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),te=(P.get("rs")||"").trim(),oe=(P.get("rstext")||"").trim();te&&/^https?:\/\//i.test(te)&&V(te),oe&&ae(oe),(te&&/^https?:\/\//i.test(te)||oe)&&_(!0)},[]),m.useEffect(()=>{const P=te=>{const oe=te.detail||{},he=String(oe.url||"").trim(),$e=String(oe.text||"").trim();he&&/^https?:\/\//i.test(he)&&V(he),$e&&ae($e),(he&&/^https?:\/\//i.test(he)||$e)&&_(!0)};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),m.useEffect(()=>{const P=te=>{const oe=te.detail||{},he=String(oe.name||"").trim();he&&(y(he),T(!0),window.setTimeout(()=>T(!1),1400))};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),m.useEffect(()=>{if(!f&&!j){we(null);return}let P=!0;return(async()=>{const te=await lr({email:n,cbToken:j});P&&we(te.length)})(),()=>{P=!1}},[f,j,n,le]);const L=w.length?w:d,D=l.credits,J=m.useCallback(P=>{const te=P.map(oe=>(oe||"").trim()).filter(Boolean);te.length&&(N(oe=>{const he=oe.split(`
`).map(ke=>ke.trim()).filter(Boolean),$e=new Set(he.map(ke=>ke.toLowerCase())),Te=te.filter(ke=>!$e.has(ke.toLowerCase()));return[...he,...Te].slice(0,15).join(`
`)}),S(!0))},[]);m.useEffect(()=>{if(!Y)return;Pe(0);const P=window.setInterval(()=>Pe(te=>te+1),1e3);return()=>window.clearInterval(P)},[Y]);const ne=m.useMemo(()=>{const P=C.trim().toLowerCase();return!P||!v?null:h.find(te=>Ue(te.name)===P&&Ce(te)===1)||null},[C,h,v]),Ee=()=>{const P=C.trim();if(P){if(ne){u(ne);return}i(null,P),g&&y("")}},fe=async()=>{if(!g){i(null,de[0]||"");return}if(!de.length||R)return;I(!0),W.current=!1;const P=[];for(let te=0;te<de.length&&!W.current;te++){O(e.evaluating(te+1,de.length,de[te]));const oe=await cr(r,de[te],"atelier2");if(P.unshift({name:oe.company||de[te],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),M([...P]),oe.verdict==="quota"){P.unshift({name:"",verdict:"quota",reason:e.quota(de.length-te-1),remaining:0}),M([...P]),N(de.slice(te+1).join(`
`)),O(""),I(!1);return}}O(""),N(W.current?de.slice(P.length).join(`
`):""),I(!1)},De=async()=>{var oe,he,$e;if(qe.current)return;const P=re.trim().replace(/\s+/g,""),te=X.trim();if(!P&&!te){me(e.rsNeed);return}if(!g&&!j){i(null,P||te.slice(0,80));return}qe.current=!0,me(""),Q(null),G(null),be(!0);try{const Te=await $o({url:P,text:te,email:n,cbToken:j});if(be(!1),!Te||Te.status!=="success"){me((Te==null?void 0:Te.message)||"Erreur");return}Q(Te),_(!1),J((((oe=Te.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(_e=>(_e==null?void 0:_e.name)||"")),G({state:"pending"});const ke=await Bo(Te,{email:n,cbToken:j});G(ke.ok?{state:"ok",scopeLabel:((he=ke.summary)==null?void 0:he.scope_label)||"",scope:(($e=ke.summary)==null?void 0:$e.scope)||""}:{state:"fail",msg:ke.error||""}),ke.ok&&pe(_e=>_e+1)}finally{qe.current=!1,be(!1)}},et=[ee==null?void 0:ee.industry,...(ee==null?void 0:ee.market_tags)||[],ee==null?void 0:ee.author].map(P=>(P||"").trim()).filter(Boolean),Ie=(H==null?void 0:H.state)==="pending",jt=H&&(Ie?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):H.state==="ok"?t.jsx("span",{className:"rslink ok",children:H.scope&&H.scope!=="public"?e.rsSavedIn(H.scopeLabel||H.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:H.msg,children:e.rsSaveFail})),ot=hl(ee).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield"+(A?" flash":""),children:[t.jsx("input",{value:C,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:P=>y(P.target.value),onKeyDown:P=>{P.key==="Enter"&&Ee()}}),t.jsx("span",{className:"detect"+(er.test(C.trim())?" url":""),children:Re})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(ne?" analyse":"")+(s?" loading":""),disabled:s,onClick:Ee,children:[t.jsx("span",{className:"fill"}),ne?e.actAnalyse:e.evalGo]}),x.showCredits&&D&&t.jsxs("button",{type:"button",className:"credits"+(D.total_available<=0&&!D.unlimited?" empty":""),onClick:()=>c({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:D.unlimited?"∞":D.total_available}),!D.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",D.daily_grant+D.purchased]}),D.total_available<=0&&!D.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(P=>P.status==="boot"||P.status==="running").map(P=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:P.name}),t.jsx(Tt,{item:P,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>c({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+P.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>S(!z),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(U?" on":""),onClick:()=>_(!U),children:e.rsOpen}),ce!==null&&ce>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Z?" on":""),onClick:()=>ye(!Z),children:e.rsArchOpen(ce)})]}),Z&&t.jsx(vl,{bump:le,cbToken:j,onClose:()=>ye(!1),onEvaluate:P=>i(null,P),onAddAll:J}),U&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:re,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:P=>V(P.target.value),onKeyDown:P=>{P.key==="Enter"&&De()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:X,placeholder:e.rsTextPh,onChange:P=>ae(P.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Y?" loading":""),style:{justifyContent:"center"},disabled:Y||Ie||!re.trim()&&!X.trim(),onClick:()=>{De()},children:[t.jsx("span",{className:"fill"}),Y?`${Io(re.trim())==="youtube"&&re.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ve)}`:Ie?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),Ae&&t.jsx("div",{className:"rserr",children:Ae}),ee&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ee.title}),ee.source_url&&t.jsx("a",{href:ee.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{Q(null),G(null)},children:"×"})]}),ee.market&&t.jsx("p",{className:"rsmk",children:ee.market}),et.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),et.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[ee.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ee.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:$r(ee.summary_md||"").map((P,te)=>t.jsx("p",{children:P},te))})]}),t.jsx(Br,{card:ee,onEvaluate:P=>i(null,P),onAddAll:J}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(ot)}),jt]})]}),z&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:E,placeholder:e.bulkPh,onChange:P=>N(P.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(R?" loading":""),style:{justifyContent:"center"},disabled:R||!de.length,onClick:()=>{fe()},children:[t.jsx("span",{className:"fill"}),R&&q?q:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(de.length)})]})]}),L.slice(0,1).map((P,te)=>{const oe=P.verdict==="kept",he=P.verdict==="quota",$e=oe?"var(--brand)":he?"var(--bolt)":"var(--red)",Te=oe?"var(--brand-l)":he?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":$e,"--bgc":Te},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:he?"⏳":"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(ke=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:ke.url.startsWith("http")?ke.url:`https://${ke.url}`,target:"_blank",rel:"nofollow noopener",children:[(ke.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,ke.url),children:e.evalPickGo})]},ke.url))}),!he&&t.jsx("button",{type:"button",className:"go",onClick:()=>{c({type:"ptab",tab:oe?1:5});const ke=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const _e=[...document.querySelectorAll(".atl2 .list .row")].find(ca=>{var Dt;return(((Dt=ca.querySelector(".rnm"))==null?void 0:Dt.textContent)||"").trim().toLowerCase().includes(ke)});_e&&(_e.scrollIntoView({behavior:"smooth",block:"center"}),_e.classList.add("flashrow"),window.setTimeout(()=>_e.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},te)}),g&&(o.kept+o.dropped>0||L.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>c({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function wl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function kl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=$(),o=e.memoConsole?r.get(e.memoConsole):null,c=m.useMemo(()=>o?[o.reasoning||"",wl(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=rt(o),d=Ua(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:c?c.split(`

`).map((x,l)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},l)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[gt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Za({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=$(),[c,s]=m.useState(!1),[d,x]=m.useState(null),l=n.pipe&&i==="client"&&!n.lockActions,f=async()=>{if(!l||c)return;s(!0);const p=await _o(r,e);if(s(!1),!p){o(a.actErr);return}x(p.results||[])};return m.useEffect(()=>{if(!l)return;const p=h=>{var b;const u=String(((b=h.detail)==null?void 0:b.name)||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&f()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,l]),m.useEffect(()=>{if(l)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),f())}catch{}},[e,l]),l?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:c,onClick:()=>{f()},children:c?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const jl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Gt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Nl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Gt(a.slice(n));break}r+=Gt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Gt(a.slice(i));break}const c=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(c),d=s?s[2].toLowerCase():"";s&&jl.has(d)?r+=`<${s[1]}${d}>`:r+=Gt(a.slice(i,o+1)),n=o+1}return r}const tr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Me({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Sl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function El({o:e}){const{t:a,doDeep:r}=$(),[n,i]=m.useState(!1),o=rt(e),c=[e.reasoning||"",Sl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),c.length?c.join(`

`).split(`

`).map((s,d)=>t.jsx("p",{className:"cdtxt",children:s},d)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[gt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:s=>{s.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:s=>{s.stopPropagation(),i(d=>!d)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:s=>s.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:s=>s.stopPropagation()})]})}function _r({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=$(),o=Ft(e),c=rt(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,l=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(c?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:l},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||gt(e)?1:0}].filter(b=>b.n>0),[e,a,s,c,d,x,l]),[p,h]=m.useState("");if(!f.length)return null;const u=f.some(b=>b.k===p)?p:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":u===b.k,"data-tour":"tab-"+b.k,className:u===b.k?"on":"",onClick:v=>{v.stopPropagation(),h(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[u==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),c&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:c}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Me,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Me,{k:a.cdVerdictDate,v:tr(e.verdictDate,r)})]})]}),u==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Nl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Cl,{o:e})]}),u==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdSector,v:e.sector}),t.jsx(Me,{k:a.cdStage,v:e.stage}),t.jsx(Me,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Me,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Me,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Me,{k:a.cdAngle,v:e.angle}),t.jsx(Me,{k:a.cdDetected,v:tr(e.date,r)})]}),u==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdName,v:e.contactName}),t.jsx(Me,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Me,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),u==="memo"&&t.jsx(El,{o:e}),u==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Me,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Cl({o:e}){const{t:a,token:r}=$(),[n,i]=m.useState(!1),[o,c]=m.useState(null),s=async()=>{n||(i(!0),c(await Uo(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},x=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],l=x.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&l&&t.jsxs(t.Fragment,{children:[x.filter(([,f])=>f).map(([f,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:p})]},f)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!l&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Pt({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let c=!1;const s=()=>{const x=Math.max(280,Math.min(560,o.clientWidth||320));xn({kind:"op",card:e},x).then(l=>{!c&&l&&o.isConnected&&o.replaceChildren(l)})},d=window.requestAnimationFrame(s);return()=>{c=!0,window.cancelAnimationFrame(d),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let c=!1;xn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!c&&d&&o.isConnected&&o.replaceChildren(d)});const s=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{c=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const zl=`
...
`;function Al(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,c=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:c,top:s}}function Tl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:c,askEvaluate:s,doAnalyse:d,doDecide:x,doPromote:l,doRepeche:f,doApproach:p,doDeep:h,doOnboard:u,outbound:b,evalBusy:v}=$(),g=e.popupId?r.get(e.popupId):null;if(!g)return null;const j=ze(g),C=Ce(g),y=rt(g),A=Ft(g),T=g.kind==="target",z=S=>{a({type:"filters",patch:S}),a({type:"popup",id:null})};return yt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:zl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Al(e.popupAnchor,!!g.card),onClick:S=>S.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:g.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(nt(g.date)),Ke(g.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[g.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>z({country:[g.cc]}),children:(wt(g.cc,i)||g.countryLabel||"").toUpperCase()}),g.sector&&t.jsx("button",{type:"button",onClick:()=>z({sector:[g.sector]}),children:g.sector.toUpperCase()}),g.stage&&t.jsx("button",{type:"button",onClick:()=>z({stage:[g.stage]}),children:g.stage.toUpperCase()}),typeof g.amountEur=="number"&&g.amountEur>0&&t.jsx("span",{className:"am2",children:kt(g.amountEur,i)})]}),o.pipe&&T&&t.jsxs("div",{className:"pstat",children:[A&&t.jsx("span",{className:"vd "+(A==="MATCH"?"v-ok":"v-no"),title:n.vt[A],children:A}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[C]}),g.ceoStatus&&t.jsx("span",{className:"pstep own",children:g.ceoStatus})]}),(g.tagline||g.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:g.tagline||g.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[ct(g.engine)," ",t.jsx("b",{children:Ke(g.engine,i)})," — ",Vo(g.engine,i),g.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",g.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(ut,{o:g,lg:!0})," ",t.jsx(la,{o:g,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Wa(j,i))," · ",n.win7(Jt(j,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),g.card?t.jsx(Pt,{spec:g.card}):null,g.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&C>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:g.reasoning})]}),o.pipe&&T&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof g.score=="number"&&g.score>0?" · "+n.score(g.score):""]})}),o.pipe&&T&&t.jsx(_r,{o:g})]}),t.jsx(Za,{name:g.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||c!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[C===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)]}),C===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),C===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{l(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),C===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(g,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(g,!1),a({type:"popup",id:null})},children:n.actNo}),gt(g)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{h(g),a({type:"popup",id:null})},children:n.memoDeep})]}),C===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),C===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(g),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),g.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:g.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{u(g),a({type:"popup",id:null})},children:"🚀"})]}):g.engine==="media"&&g.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var S;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.url}}))}catch{}a({type:"popup",id:null}),(S=document.querySelector(".atl2 .demand"))==null||S.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(g.name),onClick:()=>s(g),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(g),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(g.name.length>22?g.name.slice(0,21)+"…":g.name)," →"]}),g.website&&t.jsx("a",{className:"psite",href:g.website.startsWith("http")?g.website:"https://"+g.website,target:"_blank",rel:"noopener noreferrer",title:g.website,children:"🌐"})]})]})]}),document.body)}const ql=8;function Ll(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:c}=$(),[s,d]=m.useState(!1),[x,l]=m.useState(!1),[f,p]=m.useState(!1),h=`atl2:sincemini:${r||"home"}`,[u,b]=m.useState(()=>{try{return localStorage.getItem(h)==="1"}catch{return!1}}),v=()=>{b(S=>{try{localStorage.setItem(h,S?"0":"1")}catch{}return!S})},g=r||"home",{names:j,verdicts:C}=m.useMemo(()=>{const S=[],E={};return n.forEach(N=>{N.kind!=="target"||!N.name||(S.push(N.name),E[N.name]=Ho(N)||"")}),{names:S,verdicts:E}},[n]),y=m.useMemo(()=>j.length?Wo(g,j,C,a):null,[g,j.length]);if(!i.pipe||s||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const A=x?y.added:y.added.slice(0,ql),T=y.added.length-A.length,z=S=>{const E=n.find(N=>N.name===S);E&&(o(E.id),c({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since"+(u?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!u,title:u?e.boxExpand:e.boxCollapse,onClick:v,children:u?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),Yo(g,j,C,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[A.map(S=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>z(S),children:t.jsx("b",{children:S})},S)),T>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>l(!0),children:e.sinceMore(T)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>p(S=>!S),children:e.sinceOut(y.gone.length)}),f&&y.gone.slice(0,20).map(S=>t.jsx("span",{className:"gone",children:S},S))]})]})}const Ur={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function en({o:e,locked:a=!1}){const{t:r}=$(),n=Ft(e),i=rt(e),o=Ce(e),c=ka(e),s=Ko(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(Ur[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&c==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&c==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(ls,{o:e})]})}const Ot=e=>e.length>22?e.slice(0,21)+"…":e;function ar({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=$(),[o,c]=m.useState(!1);if(m.useEffect(()=>{n||c(!1)},[n]),Oe(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),c(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Ot(e.name))})]})}function Vr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:c,doPromote:s,doRepeche:d,doApproach:x,dispatch:l,liveMemos:f}=$();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:u=>{u.stopPropagation(),l({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(ar,{o:e})});const p=Ce(e),h=u=>b=>{b.stopPropagation(),u()};if(p===0)return t.jsx("span",{className:"cell",children:t.jsx(ar,{o:e})});if(p===1){const u=f.liveOf(e.name);if(u&&(u.status==="boot"||u.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Tt,{item:u,serverOff:f.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:h(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(p===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:h(()=>c(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:h(()=>c(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})});if(p===4){const u=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:u,onClick:h(()=>x(e)),children:u?a.actApproachSent:a.actApproach})})}return p===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})}):p===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:h(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>l({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:h(()=>l({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Ml({o:e}){const{t:a,doThumb:r,thumbOf:n}=$(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Rl({o:e}){const{lang:a}=$();return ze(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(ut,{o:e}),t.jsx(la,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[ct(e.engine||"")," ",Ke(e.engine||"",a)]})})}function Ol({o:e,locked:a,open:r,onToggle:n,selected:i,onSelect:o}){const{dispatch:c,caps:s,markRow:d,markedId:x,favIds:l,toggleFav:f,t:p}=$(),h=Ce(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=b<=0?0:b<=7?1:b<=30?2:3,g=s.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][h]:u[v],j=l.has(e.id),C=y=>{if(a)return;if(o){o(e.id);return}if(s.pipe||e.kind==="op"){n();return}const A=y.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:A.left+Math.min(280,A.width/3),y:A.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:C,children:[t.jsx("span",{className:"pt",style:{"--c":g}}),t.jsx(Gr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[s.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:j?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),f(e)},children:j?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:p.acqSee(e.acquirer),onClick:y=>{y.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Ot(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),t.jsx(Fl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Rl,{o:e}),s.pipe&&t.jsx(en,{o:e,locked:a}),s.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Vr,{o:e}),s.showThumbs&&t.jsx(Ml,{o:e})]}),r&&!a&&!o&&t.jsx(Il,{o:e})]})}function Fl({o:e}){const{lang:a,caps:r}=$();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=kt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Pl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=$(),c=(p,h=!1)=>u=>{u.stopPropagation(),h&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})},s=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),d=kt(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),l=Oe(e),f=l&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:c({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:c({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:c({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[l?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{var h;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(h=document.querySelector(".atl2 .demand"))==null||h.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Ot(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Ot(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Pt,{spec:e.card})})]})}function Dl({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:c,caps:s}=$(),d=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),x=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),l=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||d,f=(e==null?void 0:e.card)||(a==null?void 0:a.card),p=e?!!e.noCo:!d||sa(d),h=(e==null?void 0:e.engine)||"",u=e?kt(e.amountEur,n):"",b=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),v=(()=>{const z=/https?:\/\/(?:www\.)?([^/]+)/.exec(x);return z?z[1].replace(/^www\./,"").slice(0,40):""})(),g=(z,S=!1)=>E=>{E.stopPropagation(),S&&c({type:"continent",key:"monde"}),c({type:"filters",patch:z})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const j=()=>{d&&(c({type:"continent",key:"monde"}),c({type:"filters",patch:{search:d}}))},C=()=>{e!=null&&e.sector&&c({type:"filters",patch:{sector:[e.sector]}})},y=()=>{var z;x&&(window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x}})),(z=document.querySelector(".atl2 .demand"))==null||z.scrollIntoView({behavior:"smooth",block:"center"}))},A=e?Oe(e):!1,T=A&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[h?Ke(h,n):n==="fr"?"Dossier":"File",b?` · ${b}`:""]}),t.jsx("h3",{className:"zoom-h",children:l}),x&&t.jsxs("a",{className:"zoom-src",href:x,target:"_blank",rel:"nofollow noopener",onClick:z=>z.stopPropagation(),children:[r.zoomSrc,v?` · ${v}`:""," ↗"]}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:g({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:g({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:g({stage:[e.stage]}),children:e.stage}),u&&t.jsx("span",{className:"oc-amt",children:u})]}),t.jsxs("div",{className:"zoom-cta",children:[A?t.jsxs("span",{className:"verdict",style:{"--c":T?"var(--brand)":"var(--red)"},children:[T?"✓":"✗"," ",t.jsx("b",{children:T?r.kept:r.dropped})]}):!p&&d?t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:z=>{z.stopPropagation(),i(e,d)},children:r.evalGoOn(Ot(d))}):null,x&&(p||h==="media")&&t.jsx("button",{type:"button",className:"oc-ghost",onClick:z=>{z.stopPropagation(),y()},children:r.rowExtract}),!p&&(e==null?void 0:e.sector)&&!s.pipe&&t.jsx("button",{type:"button",className:"oc-ghost",onClick:z=>{z.stopPropagation(),C()},children:r.zoomSimilar}),!p&&d&&t.jsx("button",{type:"button",className:"oc-ghost",onClick:z=>{z.stopPropagation(),j()},children:r.zoomInCockpit}),!p&&d&&s.pipe&&t.jsx(Za,{name:d})]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),f&&t.jsx("div",{className:"zoom-card",children:t.jsx(Pt,{spec:f})})]})}function Il({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:c}=$();return!i.pipe&&e.kind==="op"?t.jsx(Pl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(_r,{o:e}),t.jsx(cs,{o:e}),t.jsx(us,{o:e}),t.jsx(Za,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(en,{o:e})})]}),e.card&&t.jsx(Pt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[ct(e.engine||"")," ",Ke(e.engine||"",r)]}),ze(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(ut,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>c(e),children:a.actOnboard})})]})]})}function $l({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:c}=$();if(!i.pipe&&e.kind==="op"){const x=kt(e.amountEur,c),l=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),f=(p,h=!1)=>u=>{u.stopPropagation(),h&&n({type:"continent",key:"monde"}),n({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Pt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:f({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:f({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:f({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[ct(e.engine||"")," ",Ke(e.engine||"",c)]}),ze(e)&&t.jsx(ut,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Vr,{o:e})})]})}const s=Ce(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":d},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(en,{o:e}),ze(e)&&t.jsx(ut,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Bl(){const{t:e}=$(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function _l({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=i==="en",c=l=>n.plabels[l]||"",s=[0,1,2,3,4,5,6,7].filter(l=>l!==a.ptab&&(e[l]||0)>0),d=s.includes(0)?0:s.sort((l,f)=>(e[f]||0)-(e[l]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${c(a.ptab)}” for now.`:`0 ${c(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:o?`${x} ${x>1?"files":"file"} in “${c(d)}”`:`${x} dossier${x>1?"s":""} dans « ${c(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+c(d)," →"]})]})}function Ul(){var Re,de;const e=$(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:c,scopedAll:s,markRow:d,lang:x,sessTally:l,data:f,dossiers:p,source:h,focusExtra:u,byId:b}=e,v=L=>i.lockRowsAfter!==null||h==="ops"?Number.MAX_SAFE_INTEGER:pr,[g,j]=m.useState(new Set);m.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[C,y]=m.useState(null);m.useEffect(()=>{y(null)},[a.ptab,a.continent]);const A=L=>j(D=>{const J=new Set(D);return J.has(L)?J.delete(L):J.add(L),J}),T=h==="ops"&&a.dens==="liste",[z,S]=m.useState(!0),[E,N]=m.useState("all"),[R,I]=m.useState(!1);m.useEffect(()=>{N("all"),I(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!R)return;const L=D=>{var J,ne;(ne=(J=D.target)==null?void 0:J.closest)!=null&&ne.call(J,".atl2 .doable")||I(!1)};return document.addEventListener("click",L),()=>document.removeEventListener("click",L)},[R]);const q=mr(),O=m.useMemo(()=>{var D;const L=new Map;for(const J of Hi(((D=q==null?void 0:q.ed)==null?void 0:D.html)||""))L.has(J.t)||L.set(J.t,J.html);return L},[(Re=q==null?void 0:q.ed)==null?void 0:Re.html]),w=m.useCallback(L=>{if(L.decryptHtml)return L.decryptHtml;if(!O.size)return;const D=(L.name||"").trim().toLowerCase();if(D.length<3)return;const J=O.get(D);if(J)return J;for(const[ne,Ee]of O)if(ne.includes(D)||D.includes(ne))return Ee},[O]),M=m.useMemo(()=>{let L=Ga(c,a.sort);return E!=="all"&&(L=L.filter(D=>E==="explore"?!!D.noCo:!D.noCo)),h==="ops"&&!z&&(L=L.filter(D=>D.engine!=="media")),L},[c,a.sort,h,E,z]),W=m.useMemo(()=>i.pipe?s.filter(L=>ze(L)&&Go(L)):M.filter(L=>ze(L)&&!Oe(L)),[i.pipe,s,M]),U=W.length,[_,re]=m.useState(!1),[V,X]=m.useState(!1),ae=`atl2:sigmini:${((de=f.session)==null?void 0:de.token)||"home"}`,[Y,be]=m.useState(()=>{try{return localStorage.getItem(ae)==="1"}catch{return!1}}),ve=m.useMemo(()=>i.pipe?M:M.filter(L=>!Oe(L)&&!L.noCo),[M,i.pipe]),Pe=h==="ops"?M.filter(L=>L.noCo).length:0,Ae=i.pipe?n.plabels[a.ptab].toLowerCase():h==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,me=a.filters,ee=[];if(me.day)ee.push({k:"day",lib:n.fDay(me.day.slice(8,10)+"/"+me.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(me.win&&me.win!=="all"){const L=["1","7","30"].indexOf(me.win);L>=0&&ee.push({k:"win",lib:n.dates[L],off:()=>r({type:"filters",patch:{win:"all"}})})}const Q=L=>L.length<=2?L.join(", "):`${L.length} ${n.fSelected}`;for(const L of["sector","country","engine"]){const D=me[L];D&&D.length&&ee.push({k:L,lib:Q(D),off:()=>r({type:"clearFacet",facet:L})})}me.search&&ee.push({k:"search",lib:"🔍 "+me.search,off:()=>r({type:"filters",patch:{search:""}})});const H=(L,D,J="",ne=!1)=>t.jsxs("button",{type:"button","data-s":L,className:J,"aria-sort":a.sort.key===L?a.sort.dir===1?"ascending":"descending":"none",style:ne?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:L}),children:[D,t.jsx("span",{className:"ar",children:a.sort.key===L&&a.sort.dir===1?"▴":"▾"})]},L),G=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const L=new Map;M.forEach(ne=>{const Ee=ne.engine||"?";L.has(Ee)||L.set(Ee,[]),L.get(Ee).push(ne)});const D={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},J=ja([...L.keys()],x);return[...L.entries()].sort((ne,Ee)=>{const fe=D[ne[0]]??10+J.indexOf(ne[0]),De=D[Ee[0]]??10+J.indexOf(Ee[0]);return fe-De})},[M,i.pipe,a.groupBy,x]),Z=(()=>{var D,J;const L=G?G.flatMap(([,ne])=>ne):M;return((D=L.find(ne=>ne.decryptHtml))==null?void 0:D.id)??((J=L[0])==null?void 0:J.id)??null})();m.useEffect(()=>{T&&(a.focusId&&M.some(L=>L.id===a.focusId)||u||Z&&r({type:"focus",id:Z}))},[T,a.focusId,M,Z,u,r]),m.useEffect(()=>{if(!T||!a.focusId)return;const L=document.querySelector(".atl2.ops .row.sel");L==null||L.scrollIntoView({block:"nearest"})},[T,a.focusId]);const ye=m.useMemo(()=>{if(!T||!a.focusId)return null;const L=M.find(J=>J.id===a.focusId)||p.find(J=>J.id===a.focusId)||null;if(!L)return null;const D=w(L);return D&&D!==L.decryptHtml?{...L,decryptHtml:D}:L},[T,a.focusId,M,p,w]),ce=i.lockRowsAfter;let we=0;const le=(L,D)=>{let J=a.shown[D]||v();return L.length-J<=4&&(J=L.length),L.slice(0,J).map(fe=>{const De=ce!==null&&we>=ce;we++;const et=w(fe),Ie=et&&et!==fe.decryptHtml?{...fe,decryptHtml:et}:fe,jt=fe.engine==="ma"||fe.engine==="fundraising",ot=!T&&a.dens!=="maxi"&&(a.dens==="deplie"||(C?C==="open":!!et||h==="ops"&&jt)),P=g.has(fe.id)?!ot:ot;return a.dens==="maxi"?t.jsx($l,{o:Ie,locked:De},fe.id):t.jsx(Ol,{o:Ie,locked:De,open:P,onToggle:()=>A(fe.id),selected:T&&a.focusId===fe.id,onSelect:T?te=>{r({type:"focus",id:te});const oe=b.get(te);oe&&!oe.noCo&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:oe.name}}))}:void 0},fe.id)})},pe="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(h==="ops"?" opsl":"")+(M.length?"":" list-empty"),qe=t.jsxs(t.Fragment,{children:[G?G.map(([L,D])=>t.jsxs(m.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:ct(L)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Ke(L,x)}),t.jsx("div",{className:"s",children:n.grpCount(D.filter(J=>!Oe(J)).length,D.length)})]})]}),le(D,L)]},L)):le(M,"pt"+a.ptab),f.loading&&!p.length&&t.jsx(Bl,{}),!M.length&&!(f.loading&&!p.length)&&(i.pipe?t.jsx(_l,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(a.mapFolded?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:M.length})," ",Ae]}),t.jsx("span",{className:"dot",children:"·"}),a.mapFolded&&t.jsx(Ir,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[a.mapFolded?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),ee.map(L=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:D=>{D.stopPropagation(),L.off()},children:[L.lib,t.jsx("i",{children:"×"})]},L.k)),h==="ops"&&M.length>0&&" — "+n.edSplit(M.length-Pe,Pe)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||h==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([L,D])=>t.jsxs("button",{type:"button","data-d":L,"aria-pressed":a.dens===L||L==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:L}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:D})]},L))}),h==="ops"&&t.jsxs("button",{type:"button",className:"arttog","aria-pressed":z,title:n.foldArts,onClick:()=>S(L=>!L),children:["📖 ",n.foldArts]}),!T&&(i.showFunnel||h==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":C==="open",onClick:()=>{y("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":C==="closed",onClick:()=>{y("closed"),j(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||h==="ops")&&(()=>{var J;const L=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],D=((J=L.find(([ne])=>ne===E))==null?void 0:J[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":R,onClick:()=>I(ne=>!ne),children:[D,t.jsx("i",{children:"▾"})]}),R&&t.jsx("div",{className:"dolist",children:L.map(([ne,Ee])=>t.jsx("button",{type:"button","aria-pressed":E===ne,onClick:()=>{N(ne),I(!1)},children:Ee},ne))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:L=>r({type:"sort",key:L.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([L,D])=>t.jsx("option",{value:L,children:D},L))})]}),i.showChain&&ve.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:ve.map(L=>L.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(ve.length):n.chainAll(ve.length)]}),a.mapFolded&&t.jsx(Dr,{compact:!0})]}),t.jsx(Ll,{}),U>0&&!a.filters.signalOnly&&!V&&t.jsxs("div",{className:"sigstrip"+(Y?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(U)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!Y,title:Y?n.boxExpand:n.boxCollapse,onClick:()=>be(L=>{try{localStorage.setItem(ae,L?"0":"1")}catch{}return!L}),children:Y?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>X(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(_?W:W.slice(0,12)).map(L=>{const D=ze(L);return D?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(Wa(D,x),Jt(D,x)),onClick:()=>{d(L.id),r({type:"popup",id:L.id})},children:[t.jsx("b",{children:L.name}),t.jsxs("i",{children:[D.emoji," ",Na(D,x)]}),t.jsx("em",{children:Jt(D,x)})]},"sg-"+L.id):null}),!_&&W.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>re(!0),children:n.sigStripMore(W.length-12)})]})]}),a.dens!=="maxi"&&!T&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),H("country",n.colCountry),H("name",n.colCompany),H("amount",n.colAmount,"h-amt",!0),H("stage",n.colStage,"h-stade"),H("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[H("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),H("memo",n.colMemo)]}),i.pipe&&H("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),T?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),H("country",n.colCountry),H("name",n.colCompany),H("amount",n.colAmount,"h-amt",!0),H("stage",n.colStage,"h-stade"),H("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:pe,children:qe})]}),t.jsx("aside",{className:"readpane","aria-label":x==="fr"?"Dossier":"File",children:t.jsx(Dl,{o:ye,extra:ye?null:u})})]}):t.jsx("div",{className:pe,children:qe}),h!=="ops"&&(()=>{const L=G||[["pt"+a.ptab,M]];let D=0,J=0;for(const[Ee,fe]of L){J+=fe.length;let De=a.shown[Ee]||v();fe.length-De<=4&&(De=fe.length),D+=Math.min(fe.length,De)}const ne=J-D;return ne<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>L.forEach(([Ee,fe])=>r({type:"more",group:Ee,by:fe.length,base:v()})),children:[t.jsx("span",{className:"more-label",children:n.more(ne,ne)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(D,J)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(l.kept>0||l.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(l.kept,l.dropped)}})]})}function nr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Vl(e,a){const r=Qo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Hl(e,a){const n=[a.head.split("|").map(nr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Vl(i,a.plabels),Ft(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(nr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Wl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Yl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Je({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Gl({o:e,qa:a}){const{t:r,lang:n,fund:i}=$(),o=(e.cribleStatus||"").trim().toUpperCase()||(Ft(e)==="NO MATCH"?"NO MATCH":"MATCH"),c=rt(e),s=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,c&&t.jsx("em",{children:c})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Je,{k:r.cdSector,v:e.sector}),t.jsx(Je,{k:r.cdStage,v:e.stage}),t.jsx(Je,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Je,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Je,{k:r.cdName,v:e.contactName}),t.jsx(Je,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Je,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Je,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Je,{k:r.cdAngle,v:e.angle}),t.jsx(Je,{k:r.cdDetected,v:Yl(e.date,n)})]}),d.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,x])=>x).map(([x,l])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:l})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Kl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:c}=$(),[s,d]=m.useState({}),x=25,l=m.useMemo(()=>n.slice(0,x),[n]);m.useEffect(()=>{l.length&&Jo(r,l.map(h=>h.name)).then(d)},[r,l]);const f=o.stats,p=h=>h.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(l.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[p(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(f.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(o.marketEstimate)),", ",Math.round(f.screened/o.marketEstimate*100)," %"]})]})]}),l.map(h=>t.jsx(Gl,{o:h,qa:s[h.name]},h.id)),!l.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Ql=50;function tn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=$(),[o,c]=m.useState(null),[s,d]=m.useState(!1),[x,l]=m.useState(""),[f,p]=m.useState(0),[h,u]=m.useState(""),[b,v]=m.useState(!1),g=m.useRef(null);m.useEffect(()=>()=>{g.current&&window.clearInterval(g.current)},[]);const j=async y=>{d(!0),l("");const A=await a();if(d(!1),A.ok){c(A);return}if(A.busy){l(i.alertPreviewBusy);return}if(!y){l(i.alertPreviewFail);return}p(Ql),g.current=window.setInterval(()=>{p(T=>T>1?T-1:(g.current&&window.clearInterval(g.current),j(!1),0))},1e3)},C=async()=>{if(n||b)return;v(!0),u("");const y=await r();v(!1),u(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||f>0,onClick:()=>{j(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{C()},children:b?"…":i.alertTest})]}),f>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(f)}),x&&t.jsx("p",{className:"mnote warn",children:x}),h&&t.jsx("p",{className:"mnote",children:h}),!h&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ht="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Fe({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=$();return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Jl(){const{st:e}=$();switch(e.modal){case"chain":return t.jsx(Zl,{});case"space":return t.jsx(ec,{});case"alert":return t.jsx(tc,{});case"queue":return t.jsx(ic,{});case"export":return t.jsx(sc,{});case"plug":return t.jsx(dc,{});case"recharge":return t.jsx(uc,{});case"cover":return t.jsx(fc,{});case"dossier":return t.jsx(mc,{});case"crit":return t.jsx(xc,{});case"tuto":return t.jsx(hc,{});case"rdv":return t.jsx(Xl,{});case"memoalert":return t.jsx(lc,{});default:return null}}function Xl(){const{dispatch:e,fund:a}=$(),r=typeof document<"u"&&!!document.getElementById("rdv");return m.useEffect(()=>{r&&(e({type:"modal",modal:null}),as())},[r,e]),r?null:t.jsx(ei,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Zl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:c,evalBusy:s,caps:d,memoQueued:x,doAnalyse:l}=$(),f=o==="client",p=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),h=e.chain.idx,u=p[h],b=h>=p.length;return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${h+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:h/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!u?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:u.name}),t.jsx("div",{className:"sub",children:[wt(u.cc,i)||u.countryLabel,u.sector,u.stage,n.daysAgo(nt(u.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ke(u.engine,i).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{children:kt(u.amountEur,i)})]}),ze(u)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(ut,{o:u,lg:!0})," ",t.jsx(la,{o:u,src:!0})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),f&&Oe(u)&&t.jsxs("div",{className:"vbox",style:{"--c":lt(u)==="retenu"?"var(--brand)":lt(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:lt(u)==="retenu"?"✓ "+n.kept:lt(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&u&&d.pipe&&Ce(u)===1&&!x.has(u.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{l(u),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&u&&!(f&&Oe(u))&&(u.noCo&&u.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{c(u)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function ec(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=$(),o=i==="client",c=m.useMemo(()=>o?r.filter(f=>Oe(f)):[],[r,o]),s=m.useMemo(()=>Ga(c.filter(f=>lt(f)==="retenu"),{key:"signal",dir:-1}),[c]),d=m.useMemo(()=>c.filter(f=>lt(f)==="ecarte"),[c]),x=e.spaceTab==="retenu"?s:d,l=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Fe,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":l},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function tc(){const{mode:e}=$();return e==="client"||e==="apercu"?t.jsx(ac,{}):t.jsx(oc,{})}function ac(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),[o,c]=m.useState("d"),s=i!=="client";return t.jsxs(Fe,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>c("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>c("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>c("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(nc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(rc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(Hr,{})]})}function nc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,c]=m.useState(null),[s,d]=m.useState(!1),[x,l]=m.useState(0);m.useEffect(()=>{let u=!0;return d(!1),bn(a).then(b=>{u&&(b?c(b):d(!0))}),()=>{u=!1}},[a,x]);const f=u=>{r||bn(a,u).then(b=>{if(!b){i(e.actErr);return}c(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=u=>!o.sections||o.sections.includes(u),h=u=>{const b=o.sections||e.alertSec.map(([v])=>v);f({sections:p(u)?b.filter(v=>v!==u):[...b,u]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([u,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:p(u),disabled:r,onChange:()=>h(u)}),t.jsxs("span",{children:[b,u==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},u))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(tn,{label:e.alertPreview,readOnly:r,onPreview:()=>li(a),onTest:()=>si(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function rc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,c]=m.useState(null),[s,d]=m.useState(!1),[x,l]=m.useState(0);m.useEffect(()=>{let u=!0;return d(!1),vn(a).then(b=>{u&&(b?c(b):d(!0))}),()=>{u=!1}},[a,x]);const f=u=>{r||vn(a,u).then(b=>{if(!b){i(e.actErr);return}c(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>l(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=o.dow??0,h=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:u=>f({dow:Number(u.target.value)}),children:e.alertDow.map((u,b)=>t.jsx("option",{value:b,children:u},u))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,h-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[h," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,h+1)}),disabled:r,children:"＋"})]})]}),t.jsx(tn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>di(a),onTest:()=>ci(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Hr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=$(),[c,s]=m.useState(o||""),[d,x]=m.useState(!1),[l,f]=m.useState(!1);m.useEffect(()=>{o&&s(o)},[o]);const p=e.filters,h=m.useMemo(()=>n.filter(g=>ze(g)).length,[n]),u=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(c)||l)){f(!0);try{await fetch(`${_a}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c.trim(),sectors:p.sector,countries:p.country,source:o?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{f(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[u]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(g=>Ke(g,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(g=>wt(g,r)||g).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(c)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([g,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:g}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},g))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:c,readOnly:!!o,onChange:g=>s(g.target.value),onKeyDown:g=>{g.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,h)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function oc(){const{t:e}=$();return t.jsx(Fe,{title:e.alertTitle,icon:"🔔",children:t.jsx(Hr,{})})}function ic(){var S,E;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:c,caps:s,dispatch:d,liveMemos:x}=$(),[l,f]=m.useState(null),[p,h]=m.useState([]),[u,b]=m.useState(0),v=n==="client",g=m.useMemo(()=>{const N=new Map;return i.forEach(R=>{const I=(R.name||"").trim().toLowerCase();I&&!N.has(I)&&N.set(I,R)}),N},[i]);m.useEffect(()=>{let N=!0;return(async()=>{const[R,I]=await Promise.all([Va(r),sr(a)]);N&&(R&&f(R),h(I))})(),()=>{N=!1}},[a,r,u]);const j=(l==null?void 0:l.per_day)??0,C=((S=l==null?void 0:l.analyzed_today)==null?void 0:S.length)??0,y=l==null?void 0:l.offre,A=(l==null?void 0:l.pool_meta)||[],T=m.useMemo(()=>{const N=new Map;for(const R of(l==null?void 0:l.scheduled)||[])for(const I of R.names||[])N.has(I)||N.set(I,{label:R.day_label,date:R.date});return N},[l==null?void 0:l.scheduled]),z=(l==null?void 0:l.in_progress)||[];return t.jsxs(Fe,{title:e.queueTitle,wide:!0,children:[y&&t.jsxs("div",{className:"qoffre"+(y.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:y.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:y.delai})]}),t.jsx("span",{className:"osp"}),y.rythme>0?t.jsx("span",{className:"or",children:e.qRate(y.rythme)}):y.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(y.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(C,C+(((E=l==null?void 0:l.pool_order)==null?void 0:E.length)??0))}})}),y&&t.jsxs("div",{className:"qeta",children:[y.file===0?e.qEtaDone:y.rythme<=0?e.qEtaPaused:e.qEta(y.file,y.rythme,y.jours_restants),y.en_retard&&t.jsxs("em",{children:[" ",e.qLate(y.delai,y.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(y==null?void 0:y.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(z.length>0||x.items.some(N=>N.status==="boot"||N.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[x.items.filter(N=>N.status==="boot"||N.status==="running"||N.status==="error").map(N=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:N.name}),t.jsx("span",{className:"qd",children:N.memoType||""}),t.jsx(Tt,{item:N,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+N.name)),z.filter(N=>!x.liveOf(N.name)).map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.name}),t.jsxs("span",{className:"qd",children:[N.memo_type||"",N.age_min?` · ${Math.round(N.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:N.state||""})]},"ip-"+N.name))]})]}),p.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:p.map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.company}),t.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),t.jsx("span",{className:"qt",children:N.status}),N.url&&t.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),v&&N.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{gn(a,N.company,"retry").then(()=>b(R=>R+1))},children:e.queueRetry}),v&&N.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{gn(a,N.company,"delete").then(()=>b(R=>R+1))},children:e.queueDelete})]},N.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(A.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[A.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),A.map((N,R)=>{const I=T.get(N.name),q=g.get((N.name||"").trim().toLowerCase()),O=x.liveOf(N.name),w=!!(q&&c.has(q.id))||!!(O&&(O.status==="boot"||O.status==="running")),M=!!(q&&Ce(q)===1&&!q.memoUrl)&&!O;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),I?t.jsx("span",{className:"qwhen"+(I.label==="demain"?" soon":""),children:I.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:N.name}),N.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof N.score=="number"&&t.jsx("span",{className:"qs2",children:N.score}),O&&(O.status==="boot"||O.status==="running")&&t.jsx(Tt,{item:O,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),M&&(s.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:w,onClick:()=>{o(q),b(W=>W+1)},children:w?e.actAnalyseQueued:e.actAnalyse})),N.excerpt&&t.jsx("span",{className:"qex",children:N.excerpt})]},N.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([N,R])=>t.jsxs("li",{children:[t.jsx("b",{children:N})," — ",R]},N))})]})}function sc(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:c}=$(),s=`${ht}/cibles/list.csv?token=${a}`,d=`${ht}/cibles/list.json?token=${a}`,x=`${ht}/cibles/export.xlsx?token=${a}&scope=full`,l=`=IMPORTDATA("${s}")`,f=v=>{var g;(g=navigator.clipboard)==null||g.writeText(v).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:l},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:x,href:x}],h=!i.lockActions&&n.length>0,u=()=>{Wl(Hl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([g])=>g===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Fe,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),h&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:u,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:v,value:g,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(g),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function lc(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),o=i!=="client",[c,s]=m.useState(null),[d,x]=m.useState(!1),[l,f]=m.useState(0),[p,h]=m.useState(!1);m.useEffect(()=>{let g=!0;return x(!1),hn(a).then(j=>{g&&(j?s(j):x(!0))}),()=>{g=!1}},[a,l]);const u=()=>(c==null?void 0:c.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=g=>{if(o||!c)return;const j={enabled:g.enabled??!!c.enabled,email:g.email??(c.email||""),sections:g.sections??u()};h(!0),hn(a,j).then(C=>{if(h(!1),!C){n(e.memoAlertErr);return}s(C),r(e.memoAlertSaved)})};if(d)return t.jsx(Fe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(g=>g+1),children:e.retry})]})});if(!c)return t.jsx(Fe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=u();return t.jsxs(Fe,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":c.enabled===!0,disabled:o||p,style:c.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!c.enabled}),children:c.enabled?"ON":"OFF"})})]}),t.jsx(cc,{value:c.email||"",readOnly:o||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:g=>b({email:g})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([g,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[g],disabled:o||p,onChange:()=>b({sections:{...v,[g]:!v[g]}})}),t.jsx("span",{children:j})]},g))}),t.jsx(tn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>Zo(a,v),onTest:()=>Xo(a,v)})]})}function cc({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,c]=m.useState(e);m.useEffect(()=>{c(e)},[e]);const s=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:x=>c(x.target.value),onKeyDown:x=>{x.key==="Enter"&&s&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!d,onClick:()=>i(o.trim()),children:n})]})]})}function dc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=$(),[o,c]=m.useState(null),[s,d]=m.useState(!1),[x,l]=m.useState(null),[f,p]=m.useState(""),[h,u]=m.useState(0);m.useEffect(()=>{let C=!0;return d(!1),Sa(a).then(y=>{C&&(y?c({configured:y.configured,url_hint:y.url_hint}):d(!0))}),ni(a).then(y=>{C&&l(y)}),()=>{C=!1}},[a,h]);const b=(C,y)=>{i&&Sa(a,C).then(A=>{if(!A||A.ok===!1){n(e.actErr);return}C.test&&A.sent===!1?n(e.plugTestThrottled):r(y),u(T=>T+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',g=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${ht}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Fe,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>u(C=>C+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!i,onChange:C=>p(C.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!f.trim(),onClick:()=>b({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:g}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(g).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(pc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function pc(){const{t:e,token:a,lang:r}=$(),[n,i]=m.useState("valides"),[o,c]=m.useState(!1),[s,d]=m.useState(null),[x,l]=m.useState(null),[f,p]=m.useState(!1),[h,u]=m.useState(!1),[b,v]=m.useState(null),[g,j]=m.useState(null),[C,y]=m.useState(null),A=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Sa(a).then(I=>{j(I&&I.configured?I.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{d(null),l(null),p(!1),v(null);try{const I=JSON.parse(localStorage.getItem(A)||"null");y(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{y(null)}},[A]);const T=async()=>{c(!0),p(!1),v(null);const I=await oi(a,n);d(I),l(I.ok?n:null),c(!1)},z=m.useRef(!1),S=async()=>{if(z.current)return;z.current=!0,u(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let q;try{q=await ii(a,n,"webhook",void 0,I)}finally{z.current=!1}if(u(!1),p(!1),v(q),q.ok&&(q.pushed||0)>0){const O={t:new Date().toISOString(),n:q.pushed||0};y(O);try{localStorage.setItem(A,JSON.stringify(O))}catch{}}},E=s!=null&&s.ok&&s.ready||0,N=!!(s!=null&&s.ok)&&x===n&&E>0&&!!g&&!C,R=C?new Date(C.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>i(I.target.value),children:e.plugBulkTabs.map(([I,q])=>t.jsx("option",{value:I,children:q},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),C&&t.jsx("p",{className:"mnote",children:e.bulkLocked(R,C.n)}),!C&&!!(s!=null&&s.ok)&&!g&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!C&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),N&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),N&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(E,g||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:h,onClick:()=>{S()},children:h?e.bulkSending:e.bulkConfirm(g||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:h,onClick:()=>p(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function uc(){const{t:e,data:a,lang:r}=$(),n=a.credits,i=a.email,o=async c=>{if(!i)return;const s=window.location.href.split("?")[0];try{const x=await(await fetch(`${_a}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:c,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Fe,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(c=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(c.credits,c.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(c.lookup_key)},children:e.rechargeBuy})]},c.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function mc(){const{t:e}=$();return t.jsx(Fe,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Kl,{})})}function fc(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:c,flash:s}=$(),[d,x]=m.useState(null),[l,f]=m.useState(!1);m.useEffect(()=>{let E=!0;if(o)return Va(o).then(N=>{E&&N&&typeof N.per_day=="number"&&x(N.per_day)}),()=>{E=!1}},[o]);const[p,h]=m.useState(null);m.useEffect(()=>{if(!i)return;let E=!0;return ai(i).then(N=>{E&&h(N)}),()=>{E=!1}},[i]);const u=r.stats,b=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(E=>E.kind==="target"&&Oe(E)).length,v=r.marketEstimate||0,g=v>0?Math.min(100,Math.round(b/v*100)):null,j=(u==null?void 0:u.window_days)||30,C=b>0?b/j:0,y=v>0?Math.max(0,v-b):0,T=v>0&&C>0&&b>=100?Math.round(y/C):null,z=E=>Math.round(E).toLocaleString(a==="en"?"en-US":"fr-FR"),S=E=>{l||!c||(f(!0),ri(i,E).then(N=>{if(f(!1),N===null){s(e.actErr);return}x(N),s(e.alertSaved)}))};return t.jsxs(Fe,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(z(b))}),v>0&&t.jsx("span",{children:e.covOf(z(v))})]}),g!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:g+"%"}}),t.jsxs("em",{children:[g," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),C>=1&&t.jsx("p",{className:"mnote",children:e.covPace(z(C))}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((E,N)=>t.jsxs("tr",{className:E.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[E.code,E.geo?` · ${E.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof E.n=="number"?z(E.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:E.source}),E.elargi&&t.jsx("em",{children:e.covWide(String(E.demande||""))}),E.erreur&&t.jsx("em",{children:e.covMissing})]})]},N)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:z(p.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&u.shown!==u.kept&&t.jsxs("span",{children:[t.jsx("b",{children:z(u.shown)})," ",e.funShown]})]}),c&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(E=>t.jsx("button",{type:"button",className:d===E?"on":"",disabled:l,onClick:()=>S(E),children:E===0?"⏸":E},E))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function xc(){var g,j,C;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:c,lang:s}=$(),d=n==="client",x=m.useMemo(()=>{const y=new Set;return a.forEach(A=>{A.angle&&y.add(A.angle)}),[...y]},[a]),[l,f]=m.useState(""),[p,h]=m.useState(""),[u,b]=m.useState(!1),v=async()=>{const y=l.trim();if(!(!y||u||!d)){b(!0),h("");try{const T=await(await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&h(String(T.reply)),T.job_id){h(e.critChatRunning);const z=async()=>{const S=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(E=>E.json()).catch(()=>null);if(S&&S.done){h(String(S.reply||S.clarification||S.summary||"✓")),b(!1),S.applied&&i(e.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),f("");return}f("")}finally{p.startsWith("⏳")||b(!1)}}};return t.jsxs(Fe,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((g=o.points)!=null&&g.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=o==null?void 0:o.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var A,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((A=y.look)!=null&&A.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(z=>t.jsx("li",{children:z},z))})]}),!!((T=y.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(z=>t.jsx("li",{children:z},z))})]})]})]},y.title)})]}),!!((C=o==null?void 0:o.gate)!=null&&C.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:l,disabled:!d||u,onChange:y=>f(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},disabled:!d||u||!l.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ti,{fund:c,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Ur[y]||"v-cons"),children:y}),t.jsx("span",{children:A})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",A]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function hc(){const{t:e,dispatch:a,startTour:r}=$(),n=i=>{var o,c;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(c=document.querySelector(".atl2 .demand input"))==null||c.focus())};return t.jsxs(Fe,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],c)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:c+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+c))})]})}const Wr="atl2:mapfold",gc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Wr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},bc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},Yr=m.createContext(null),$=()=>{const e=m.useContext(Yr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function ut({o:e,lg:a}){const{lang:r}=$(),n=ze(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Na(n,r),children:[n.emoji," ",Na(n,r)]}):null}function la({o:e,src:a}){const{lang:r,t:n}=$(),i=ze(e);if(!i)return null;const o=xi(i),c=hi(i);return t.jsxs("em",{className:"sigwin"+(c?" hot":""),title:n.signaledOn(Wa(i,r))+" · "+n.win7(Jt(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:c?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function vc(e,a,r){const n=(r||"").trim();if(n){const o=e.find(c=>(c.url||"")===n);if(o)return o}const i=Ue(a);if(i)return e.find(o=>Ue(o.name)===i)||e.find(o=>{const c=Ue(o.name);return c.length>=3&&(i.includes(c)||c.includes(i))})}function yc(){const{scoped:e,t:a}=$(),r=e.length,n=e.filter(o=>!o.noCo).length,i=e.filter(o=>!!o.decryptHtml).length;return t.jsxs("aside",{className:"map-pulse",children:[t.jsx("b",{children:r}),t.jsx("span",{children:a.zoomPulseEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",n," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",r-n," ",a.zoomPulseExplore]}),t.jsxs("li",{children:["📖 ",i," ",a.zoomPulseArts]})]})]})}function Gr({o:e}){const{lang:a}=$(),r=fi(e.cc),n=e.cc?wt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const rr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",wc=!1;function kc(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Kr=e=>`atl2:tour:${e||"anon"}`;function jc(e){try{return localStorage.getItem(Kr(e))==="1"}catch{return!0}}function or(e){try{localStorage.setItem(Kr(e),"1")}catch{}}function Nc(e,a,r,n,i){const o=e.tourT,c=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:c[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:c[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:c[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:c[0][0],modal:"crit"}].filter(Boolean)}function Ac({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var nn;const{lang:c}=pi(),s=Ai[c],d=$i(e,c,a),[x,l]=m.useReducer(Ui,void 0,()=>Bi((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?bc():gc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??(a==="ops"?"liste":void 0),filters:r,modal:n==null?void 0:n.modal})),f=m.useRef(!0);m.useEffect(()=>{if(f.current){f.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Wr,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e,a]);const p=m.useRef(o);p.current=o,m.useEffect(()=>{var k;(k=p.current)==null||k.call(p,x.filters)},[x.filters]);const[h,u]=m.useState(null),[b,v]=m.useState(null),[g,j]=m.useState(null),[C,y]=m.useState({kept:0,dropped:0}),[A,T]=m.useState(!1),[z,S]=m.useState(""),[E,N]=m.useState(!1),[R,I]=m.useState(null),[q,O]=m.useState(!1),[w,M]=m.useState(!1),[,W]=m.useState(0),U=()=>W(k=>k+1),_=m.useRef([]),re=m.useRef(new Set),V=m.useRef(new Set),[X,ae]=m.useState([]),[Y,be]=m.useState([]),[ve,Pe]=m.useState(0),Ae=m.useRef(new Map),me=m.useRef(null),{mode:ee}=d,Q=m.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),H=Q.pipe,G=d.session.token||"",Z=ee==="client"&&!e;m.useEffect(()=>{if(!G||!H)return;let k=!0;const B=async()=>{const se=await gi(G);!k||!se||(be(se.runs),Pe(Date.now()/1e3-se.now),ae(je=>je.filter(Ge=>!se.runs.some(Qe=>Ue(Qe.company)===Ue(Ge.name)))))};B();const F=X.length>0||Y.some(se=>se.status==="running"),K=window.setInterval(()=>{B()},F?8e3:25e3);return()=>{k=!1,window.clearInterval(K)}},[G,H,X.length,Y.some(k=>k.status==="running")]);const ye=m.useMemo(()=>{const k=[],B=new Set;for(const F of X){const K=Ue(F.name);!K||B.has(K)||(B.add(K),k.push({name:F.name,id:F.id,status:"boot",started:F.started,estMin:F.estMin,memoType:"instant"}))}for(const F of Y){const K=Ue(F.company);if(!K||B.has(K))continue;B.add(K);const se=F.status==="error"?"error":F.status==="done"?"done":"running";k.push({name:F.company,status:se,started:F.started||0,estMin:F.est_min||(F.memo_type==="detailed"?40:15),url:F.url,error:F.error,memoType:F.memo_type})}return k},[X,Y]),ce=k=>ye.find(B=>Ue(B.name)===Ue(k))||null,we=(k,B)=>{ae(F=>F.some(K=>Ue(K.name)===Ue(k.name))?F:[...F,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:B==="detailed"?40:15}]),re.current.add(k.id),U()};m.useEffect(()=>{if(document.querySelector(`link[href="${rr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=rr,document.head.appendChild(k)},[]);const le=(k,B=!1)=>{S(k),N(B),me.current&&clearTimeout(me.current),me.current=setTimeout(()=>S(""),B?4200:2400)},pe=k=>le(k,!0),qe=m.useMemo(()=>{const k=new Map;return d.dossiers.forEach(B=>{B.id&&k.set(B.id,B)}),k},[d.dossiers]),Re=m.useMemo(()=>d.dossiers.filter(k=>ur(k,x,H)),[d.dossiers,x,H]),de=m.useRef(!1);m.useEffect(()=>{if(de.current||e||d.loading||!d.dossiers.length)return;if(!Q.showFunnel||jc(d.session.token||"")){de.current=!0;return}de.current=!0;const k=window.setTimeout(()=>{or(d.session.token||""),O(!0)},700);return()=>window.clearTimeout(k)},[e,d.loading,d.dossiers.length,Q.showFunnel,d.session.token]);const L=m.useMemo(()=>d.dossiers.filter(k=>Vi(k,x,H,d.favIds)),[d.dossiers,x,H,d.favIds]),D=m.useMemo(()=>ui(Re,d.favIds),[Re,d.favIds]),J=m.useMemo(()=>{const k=br(d.dossiers);return k?nt(k)===0?s.tourToday:vr(k,c):s.tourNoRun},[d.dossiers,s,c]),ne=m.useMemo(()=>d.dossiers.some(k=>!!k.memoUrl||!!k.summary||gt(k)),[d.dossiers]),[Ee,fe]=m.useState(!1);m.useEffect(()=>{if(d.loading){fe(!1);return}if(d.dossiers.length>0||d.error){fe(!0);return}const k=window.setTimeout(()=>fe(!0),6e3);return()=>window.clearTimeout(k)},[d.loading,d.dossiers.length,d.error]);const De=(d.marketEstimate||0)>0||typeof((nn=d.stats)==null?void 0:nn.screened)=="number"&&d.stats.screened>0,et=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(D[k]||0)>0)??0,[D]),Ie=Ha.find(k=>k.key===x.continent),jt=x.continent==="monde"?s.contWorld:(c==="fr"?Ie==null?void 0:Ie.fr:Ie==null?void 0:Ie.en)||"";m.useEffect(()=>{const k=B=>{var K;const F=(((K=B.detail)==null?void 0:K.name)||"").trim();F&&ot(null,F)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{if(a!=="ops")return;const k=B=>{const F=B.detail||{},K=String(F.id||"").trim(),se=String(F.name||"").trim(),je=String(F.url||"").trim(),Ge=K&&qe.get(K)||vc(d.dossiers,se,je);if(Ge){v(null),l({type:"focus",id:Ge.id}),Ge.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ge.name}}));return}!se&&!je||(l({type:"focus",id:null}),v({name:se,headline:String(F.text||"").trim()||se,url:je,card:F.card}),se&&!sa(se)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:se,url:je}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=K=>{const se={},je=String((K==null?void 0:K.sector)||"").trim();je&&(se.sector=[je]);const Ge=String((K==null?void 0:K.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ge)&&(se.day=Ge);const Qe=String((K==null?void 0:K.search)||"").trim();Qe&&(se.search=Qe);const xe=String((K==null?void 0:K.dealKind)||"").trim();(xe==="ma"||xe==="levee"||xe==="other")&&(se.dealKind=[xe]),Object.keys(se).length&&l({type:"filters",patch:se})},B=K=>k(K.detail),F=K=>{K.data&&K.data.type==="pp-filter"&&k(K.data)};return window.addEventListener("ppmap:filter",B),window.addEventListener("message",F),()=>{window.removeEventListener("ppmap:filter",B),window.removeEventListener("message",F)}},[]),m.useEffect(()=>{const k=B=>{var se;const F=(((se=B.detail)==null?void 0:se.name)||"").trim().toLowerCase();if(!F)return;const K=dossiers.find(je=>(je.name||"").trim().toLowerCase()===F);K&&l({type:"popup",id:K.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const ot=(k,B)=>{const F=((k==null?void 0:k.name)||B||"").trim();if(!Z){j({kicker:F});return}!F||A||(T(!0),(async()=>{try{let K=F;const se=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(se)K=se;else try{const xe=await bi(F);if(xe!=null&&xe.website)K=xe.website;else if(((xe==null?void 0:xe.candidates)||[]).length===1)K=xe.candidates[0].url;else if(((xe==null?void 0:xe.candidates)||[]).length>1){_.current=[{name:F,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(xe.candidates||[]).slice(0,5)},..._.current].slice(0,8),U();return}}catch{}const je=await cr(G,K,"atelier2"),Ge={name:je.company||F,verdict:je.verdict,reason:je.reason||"",remaining:je.remaining??null};_.current=[Ge,..._.current].slice(0,8),je.verdict==="kept"&&y(xe=>({...xe,kept:xe.kept+1})),je.verdict==="ruled_out"&&y(xe=>({...xe,dropped:xe.dropped+1}));const Qe=k||d.dossiers.find(xe=>(xe.name||"").toLowerCase()===F.toLowerCase());Qe&&(je.verdict==="kept"?Qe.verdict=Qe.verdict||"MATCH":je.verdict==="ruled_out"&&(Qe.verdict="NO MATCH"),je.reason&&(Qe.reasoning=je.reason)),U()}finally{T(!1)}})())},P=k=>{if(!Z){j({kicker:k.name});return}we(k,"instant"),Nt(G,"fast_request",k.name||"",""),le(s.memoInstantSent(k.name))},te=k=>Ae.current.get(k.id)??d.thumbs.get((k.name||"").trim().toLowerCase()),oe=(k,B)=>l({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:B}}),he=async(k,B,F)=>{const K=k.ceoStatus||"";k.ceoStatus=B,U();const se=await pa(G,{status:B,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(F==null?void 0:F.note)!==void 0?{note:F.note}:{},...F!=null&&F.via?{via:F.via}:{}});return se.ok?se.skipped?(k.ceoStatus=K,U(),pe(s.actNotPersisted),!1):((F==null?void 0:F.undo)!==!1&&oe(k,K),F!=null&&F.msg&&le(F.msg),(B==="Validé"||B==="Écarté")&&!k.ceoNote&&(F==null?void 0:F.note)===void 0&&I({o:k,yes:B==="Validé"}),!0):(k.ceoStatus=K,U(),pe(s.actErr),!1)},$e=async(k,B)=>{const F=await pa(G,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:B,via:"note"});return!F.ok||F.skipped?(pe(F.skipped?s.actNotPersisted:s.actErr),!1):(k.ceoNote=B,U(),!0)},Te=m.useRef(new Map),ke=k=>Te.current.has(k.id)?Te.current.get(k.id):d.stages.get((k.name||"").trim().toLowerCase()),_e=(k,B)=>{Te.current.set(k.id,B),U()},ca=(k,B)=>{Z&&he(k,B?"Validé":"Écarté",{msg:B?s.decidedYes(k.name):s.decidedNo(k.name)})},Dt=k=>{Z&&he(k,"À trancher",{msg:s.promoted(k.name)})},Qr=k=>{Z&&(async()=>{const B=k.ceoStatus||"";k.ceoStatus="Retenu",U();const F=await pa(G,{status:"Retenu",check_id:k.checkId,company:k.name});if(!F.ok||F.skipped){k.ceoStatus=B,U(),pe(F.skipped?s.actNotPersisted:s.actErr);return}oe(k,B),le(s.repeched(k.name))})()},Jr=()=>{const k=x.undo[x.undo.length-1];if(!k){le(s.undoNone);return}const B=qe.get(k.id);if(!B){l({type:"undoPop"}),le(s.undoNone);return}let F=k.prevCeoStatus;if(!F)if((B.verdict||"").toUpperCase().includes("CALL"))F="À trancher";else{le(s.undoLockedTitle);return}(async()=>await he(B,F,{undo:!1})&&(l({type:"undoPop"}),B.ceoStatus=k.prevCeoStatus,U(),le(s.undoDone(B.name))))()},Xr=k=>{Z&&(V.current.add(k.id),U(),(async()=>{const B=await vi(G,k.name,"email");if(!B||B.ok===!1){V.current.delete(k.id),U(),pe(s.actErr);return}Nt(G,"approach",k.name||"",""),le(s.actApproachSent)})())},Zr=(k,B)=>{Z&&(async()=>{if(!(await Nt(G,B?"yes":"no",k.name||"","")).ok){pe(s.actErr);return}Ae.current.set(k.id,B?"yes":"no"),U(),le(B?s.thumbUpDone:s.thumbDnDone)})()},eo=k=>{!Z||!gt(k)||(we(k,"detailed"),Nt(G,"detailed_request",k.name||"",""),le(s.memoDeepSent(k.name)))},to=k=>{const B=new Set(d.favIds),F=B.has(k.id);F?B.delete(k.id):B.add(k.id),d.setFavIds(B),Z&&yi(G,{id:k.id,co:k.name},F)},ao=()=>{!Z||w||window.confirm(s.identSyncConfirm)&&(M(!0),(async()=>{const k=await wi(G);M(!1),k?le(s.identSyncDone):pe(s.actErr)})())},an=/proplace/i.test(d.fund||""),no=k=>{!Z||!an||(Nt(G,"onboard_request",k.name||"",""),le(s.onboardSent(k.name)))},ro={st:x,dispatch:l,t:s,lang:c,mode:ee,caps:Q,pipe:H,token:G,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:Qr,thumbOf:te,canWrite:Z,commitStatus:he,saveNote:$e,stageOf:ke,setStage:_e,flashErr:pe,startTour:()=>O(!0),dossiers:d.dossiers,scopedAll:Re,scoped:L,counts:D,byId:qe,contName:jt,favIds:d.favIds,toggleFav:to,askEvaluate:ot,doAnalyse:P,doDecide:ca,doPromote:Dt,doApproach:Xr,doThumb:Zr,doDeep:eo,doUndo:Jr,doSync:ao,doOnboard:no,outbound:an,memoQueued:re.current,liveMemos:{items:ye,serverOff:ve,liveOf:ce},approachDone:V.current,sessTally:C,evalCards:_.current,evalBusy:A,markRow:u,markedId:h,flash:le,focusExtra:b};m.useEffect(()=>{const k=B=>{B.key==="Escape"&&(l({type:"popup",id:null}),l({type:"modal",modal:null}),l({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const oo=k=>G?t.jsx(Wi,{token:G,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(Yr.Provider,{value:ro,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":""),children:[t.jsx("style",{children:Li}),Q.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:hr,children:Qa}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Xt}`,children:Xt})]}),t.jsx("button",{type:"button",onClick:()=>l({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),oo(t.jsxs("div",{className:"app"+(H?" pipe":"")+(G?" has-thesis":""),children:[Q.showTicker&&t.jsx(Le,{name:"live",children:t.jsxs("div",{className:"live-stack"+(G?" live-stack--cibles":""),children:[t.jsx(Xi,{}),!!G&&t.jsx(Yi,{})]})}),Q.showIdent&&t.jsx(Le,{name:"identite",children:t.jsx(xs,{})}),!1,!!G&&t.jsx(Le,{name:"brief",children:t.jsx(Gi,{})}),wc,Q.showMorning&&t.jsx(Le,{name:"matin",children:t.jsx(fs,{})}),t.jsx(Le,{name:"mesure",children:t.jsx(is,{})}),Q.showFunnel&&t.jsx(Le,{name:"entonnoir",children:t.jsx(Sc,{})}),Q.showFunnel&&t.jsx(Le,{name:"tunnel",children:t.jsx(hs,{})}),Q.showFunnel&&t.jsx(Le,{name:"tuto",children:t.jsx(gs,{})}),!x.mapFolded&&t.jsx(Le,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Ir,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(yc,{}),t.jsx(fl,{}),t.jsx(Dr,{})]})]})}),Q.showDemand&&H&&t.jsx(Le,{name:"direct",children:t.jsx(Ei,{items:ye,serverOff:ve,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>l({type:"modal",modal:"queue"})})}),Q.showDemand&&t.jsx(Le,{name:"evaluation",children:t.jsx(yl,{})}),Q.showDemand&&x.memoConsole&&t.jsx(Le,{name:"console",children:t.jsx(kl,{})}),t.jsx(Le,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Ul,{})}),d.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:s.retry})]})]})),x.popupId&&a!=="ops"&&t.jsx(Le,{name:"fiche",children:t.jsx(Tl,{})}),t.jsx(Le,{name:"modales",children:t.jsx(Jl,{})}),t.jsx(rs,{}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(ps,{placeholder:R.yes?s.whyYesPh:s.whyNoPh,onDone:k=>{const B=R.o;I(null),k&&$e(B,k).then(F=>{F&&le(s.csNoteSaved)})}})]}),q&&Ee&&t.jsx(ms,{steps:Nc(s,J,ne,et,De),onClose:()=>{O(!1),or(G)}}),t.jsx(kc,{}),z&&t.jsx("div",{className:"flash on"+(E?" err":""),children:z}),g&&t.jsx(mi,{variant:"acquirer",initialCompany:ir().co,initialWebsite:ir().site,onClose:()=>j(null)})]})})}function Sc(){const{t:e}=$(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function ir(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ec(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Gr as FlagCell,ut as SigBadge,la as SigWin,Ac as default,Ec as fmtShort,$ as useV2};
