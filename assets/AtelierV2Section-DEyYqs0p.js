...
.atl2 .bulk .side .hint{white-space:nowrap}`,br=`
...
`,vr=hr+br;function ot(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function yr(){const t=ot("teaser");if(t==="0"||t==="1")return t;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function wr(t,a){if(t||a.mode!=="client"||!a.token)return"visiteur";const n=yr();return n==="0"?"client":n==="1"||ot("embed")==="1"&&ot("chrome")==="1"?"apercu":"client"}const kr={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},jr=t=>kr[t],Se=t=>Object.assign(t,{continent:Ea(t.cc)});function Ze(t){const a=new Set,n=[];for(const r of t){const s=(r.name||"").toLowerCase();!s||a.has(s)||(a.add(s),n.push(r))}return n}const Nr=60*60*1e3;function Sr(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Nr?null:a}catch{return null}}function Be(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Cr=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function Er(t,a,n="default"){const r=n!=="default",s=l.useMemo(()=>t||r?{mode:"anon"}:va(),[t,r]),o=l.useMemo(()=>r?"visiteur":wr(t,s),[t,s,r]),d=l.useMemo(()=>jr(o),[o]),i=o!=="visiteur",c=Cr(n),[m,b]=l.useState([]),[u,h]=l.useState(""),[v,f]=l.useState(null),[x,g]=l.useState(null),[p,y]=l.useState(null),[S,w]=l.useState(()=>new Map),[C,j]=l.useState(()=>new Map),[z,N]=l.useState(""),[L,O]=l.useState(new Set),[M,E]=l.useState(null),[_,P]=l.useState(!0),[Q,I]=l.useState(!1),[ie,me]=l.useState(0),[he,be]=l.useState(0),B=l.useRef(0),ce=l.useMemo(()=>{var U;if(o!=="client")return"";try{return((U=ya())==null?void 0:U.email)||""}catch{return""}},[o]);l.useEffect(()=>{const U=++B.current;let D=!0;const $=()=>D&&U===B.current,F=(i&&s.token?s.token:"pub:"+a)+(c?":"+c:""),K=Sr(F);return K?(b(K.objs.map(Se)),K.fund&&h(K.fund),f(K.marketEstimate??null),g(K.criteria??null),y(K.stats??null),N(K.generatedAt||""),P(!1)):P(!0),(async()=>{try{if(n==="ops"){const G=await Qe(),ae=((G==null?void 0:G.recent_ops)||[]).filter(J=>wa((J.company_name||J.title||"").trim())).map(J=>Je(J,a)).filter(J=>!!J);if(!$())return;b(ae.map(Se)),Be(F,{objs:ae})}else if(typeof n=="object"){const ae=(await vt()||[]).filter(ee=>(ee.slug||"")===n.research).map(ee=>yt(ee,a)).filter(ee=>!!ee),J=Ze(await wt(ae,a));if(!$())return;b(J.map(Se)),Be(F,{objs:J})}else if(i&&s.token){const G=ka(s.token),ae=Qe(),J=ja(s.token),ee=Na(s.token),ve=Sa(s.token),Y=await G;let le=Y?Y.targets:[];$()&&Y&&(h(Y.fund||""),f(Y.marketEstimate??null),g(Y.criteria??null),y(Y.stats??null),N(Y.generatedAt||""),b(le.map(Se)),P(!1),I(!1));const[pe,ye,xe,T]=await Promise.all([ae,J,ee,ve]),V=((pe==null?void 0:pe.recent_ops)||[]).map(W=>Je(W,a)).filter(W=>!!W);if(le=[...le,...V],!$())return;b(le.map(Se));const X=new Set;for(const W of ye){const ue=(W.id||W.co||"").toString().trim().toLowerCase();ue&&X.add(ue.startsWith("t:")?ue:"t:"+ue)}O(X),w(xe),j(T),Y&&Be(F,{fund:Y.fund,marketEstimate:Y.marketEstimate,criteria:Y.criteria,stats:Y.stats,generatedAt:Y.generatedAt,objs:le})}else{const G=Ca(),ae=vt(),J=Qe(),ee=await G;$()&&ee.length&&(b(Ze(ee).map(Se)),P(!1),I(!1));const[ve,Y]=await Promise.all([ae,J]),le=(ve||[]).map(T=>yt(T,a)).filter(T=>!!T),pe=await wt(le,a),ye=((Y==null?void 0:Y.recent_ops)||[]).map(T=>Je(T,a)).filter(T=>!!T),xe=Ze([...ee,...pe,...ye]);if(!$())return;b(xe.map(Se)),Be(F,{objs:xe})}$()&&I(!1)}catch{$()&&!K&&I(!0)}finally{$()&&P(!1)}})(),()=>{D=!1}},[i,s.token,a,ie,c]),l.useEffect(()=>{if(!d.showCredits||!ce){E(null);return}let U=!0;return(async()=>{try{const D=await fetch(`${st}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:ce})});if(!D.ok)return;const $=await D.json();U&&$&&$.ok!==!1&&E($)}catch{}})(),()=>{U=!1}},[d.showCredits,ce,he]);const H=l.useCallback(U=>O(new Set(U)),[]);return{session:s,mode:o,caps:d,fund:u,email:ce,marketEstimate:v,generatedAt:z,criteria:x,stats:p,thumbs:S,stages:C,dossiers:m,favIds:L,setFavIds:H,credits:M,reloadCredits:()=>be(U=>U+1),loading:_,error:Q,refresh:()=>me(U=>U+1)}}const Gt=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),zr=(t="europe",a=!1,n)=>({continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Gt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Tr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(s=>s!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(s=>s!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Gt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ve)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ve=40;function ut(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!ne(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(it(t)))return!1;if(r!=="win"){if(a.day){if((t.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const s=a.win==="1"?0:a.win==="7"?7:30;if(Te(t.date)>s)return!1}}if(r!=="status"&&!n&&a.status!=="all"&&Ee(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const s=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(s))return!1}return!0}function Kt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:ut(t,a.filters,n)}function Ar(t,a,n,r){return!(!Kt(t,a,n)||n&&!za(t,a.ptab,r))}function mt(t,a){const n=a.key,r=s=>{switch(n){case"name":return(s.name||"").toLowerCase();case"country":return s.countryLabel||s.cc||"";case"stage":return s.stage||"";case"amount":return s.amountEur||-1;case"age":return-Te(s.date);case"score":return typeof s.score=="number"?s.score:-1;case"signal":{const o=ne(s);return o?100-(o.left??0):-1}}};return[...t].sort((s,o)=>{const d=r(s),i=r(o);return d<i?-a.dir:d>i?a.dir:(s.name||"").localeCompare(o.name||"")})}function Lr(){const{dossiers:t,st:a,t:n,dispatch:r,contName:s,pipe:o}=A(),d=l.useMemo(()=>{const c=(a.filters.day||"").slice(0,10),m=v=>!(!o&&v.continent!==a.continent||c&&(v.date||"").slice(0,10)!==c),b=t.filter(v=>m(v)&&ne(v)),u=t.filter(v=>m(v)&&v.kind==="op"&&!ne(v)&&(c?!0:Te(v.date)<=7)),h=c||new Date().toISOString().slice(0,10);return u.sort((v,f)=>{const x=(v.date||"").slice(0,10)===h?0:1,g=(f.date||"").slice(0,10)===h?0:1;return x!==g?x-g:(f.amountEur||0)-(v.amountEur||0)}),[...mt(b,{key:"signal",dir:-1}),...u].slice(0,48)},[t,a.continent,a.filters.day,o]),i=c=>d.map(m=>e.jsxs("button",{type:"button",className:"tk"+(de(m)?" spent":""),onClick:b=>{const u=b.currentTarget.getBoundingClientRect();r({type:"popup",id:m.id,anchor:{x:u.left+u.width/2,y:u.bottom}})},title:m.name+(m.tagline?" — "+m.tagline:""),children:[e.jsx(qe,{o:m}),e.jsxs("span",{className:"who",children:[e.jsx(na,{o:m}),e.jsx("span",{className:"co",children:m.name})]}),typeof m.amountEur=="number"&&m.amountEur>0&&e.jsx("span",{className:"am",children:so(m.amountEur)}),m.sector&&e.jsx("span",{className:"mt",children:m.sector}),e.jsx(We,{o:m}),e.jsx("span",{className:"tkgo",children:"→"})]},c+(m.id||m.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:d.length})]}),e.jsx("div",{className:"win",children:d.length?e.jsxs("div",{className:"run",children:[i(0),i(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(s)})})})]})}const qr="aDx8z7Hzksus",Qt="+33 6 83 10 72 86",Tt="alexandre@proplace.co",Rr=`tel:${Qt.replace(/[^\d+]/g,"")}`,At="pp-rdv-slot";function Or(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Fr(){const{t,caps:a,fund:n}=A();if(!a.showOnb)return null;const r=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[e.jsx("style",{children:Dr}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:Rr,children:Qt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${Tt}`,children:Tt})]}),e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(r).map(([s,o],d)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(d+1)}),e.jsx("b",{children:s}),e.jsx("span",{children:o})]},s))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(mr,{filloutId:qr,parameters:n?{company_name:n}:void 0})})]})}function Mr(){const[t,a]=l.useState(()=>typeof document>"u"?null:document.getElementById(At));return l.useEffect(()=>{t||a(document.getElementById(At))},[t]),t?Me.createPortal(e.jsx(Fr,{}),t):null}const Dr=`
...
`;class te extends l.Component{constructor(){super(...arguments);ht(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Pr=8;function Ir(){const{t,lang:a,token:n,dossiers:r,caps:s,markRow:o,dispatch:d}=A(),[i,c]=l.useState(!1),[m,b]=l.useState(!1),[u,h]=l.useState(!1),v=n||"home",{names:f,verdicts:x}=l.useMemo(()=>{const w=[],C={};return r.forEach(j=>{j.kind!=="target"||!j.name||(w.push(j.name),C[j.name]=Ta(j)||"")}),{names:w,verdicts:C}},[r]),g=l.useMemo(()=>f.length?Aa(v,f,x,a):null,[v,f.length]);if(!s.pipe||i||!g||g.firstVisit||!g.added.length&&!g.gone.length)return null;const p=m?g.added:g.added.slice(0,Pr),y=g.added.length-p.length,S=w=>{const C=r.find(j=>j.name===w);C&&(o(C.id),d({type:"popup",id:C.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(g.added.length,g.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{c(!0),La(v,f,x,g.fp,a)},children:"×"})]}),!!g.added.length&&e.jsxs("div",{className:"since-c",children:[p.map(w=>e.jsx("button",{type:"button",onClick:()=>S(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>b(!0),children:t.sinceMore(y)})]}),!!g.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>h(w=>!w),children:t.sinceOut(g.gone.length)}),u&&g.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const et=600,Ce=62,Lt="atl2:fstats";function Br(){const{t,lang:a,data:n,caps:r,st:s,dispatch:o}=A(),[d,i]=l.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Lt)==="on"}catch{return!1}}),c=n.stats,m=l.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),b=l.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!r.showFunnel||!c||typeof c.screened!="number")return null;const u=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,h=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=m.reduce((y,S)=>Math.max(y,S.s||0),0),f=m.length?et/m.length:0,x=Math.max(4,f-4),g=m.length>=5&&v>0,p=[[c.screened,t.funScreened(u(b)),c.screened_today],...typeof c.kept=="number"?[[c.kept,t.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,t.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(d?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[p.map(([y,S,w],C)=>e.jsxs("span",{className:"fst-t",children:[C>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:h(y)}),e.jsx("i",{children:S}),d&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},S)),g&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!d;i(y),y&&!s.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Lt,y?"on":"off")}catch{}},children:d?"⌃":"⌄"})]}),d&&g&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${et} ${Ce}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[m.map((y,S)=>{const w=(y.s||0)/v*(Ce-4),C=(y.m||0)/v*(Ce-4),j=S*f+(f-x)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${u(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:j,y:Ce-2-w,width:x,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:j,y:Ce-2-C,width:x,height:C,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:Ce-1.5,x2:et,y2:Ce-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:u(m[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const $r=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function _r({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:s}=A(),[o,d]=l.useState(""),[i,c]=l.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const m=(t.ceoStatus||"").trim(),b=(Ae(t)||"").startsWith("CALL")&&se(t)===3,u=se(t)>=2,h=async f=>{if(o||f==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(f);const x=await s(t,f);d(""),x&&(c(!0),setTimeout(()=>c(!1),2200))},v=b?[["Validé",a.csYes],["Écarté",a.csNo]]:$r.filter(([f])=>!(u&&f==="Retenu")).map(([f,x])=>[f,a[x]]);return e.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([f,x])=>e.jsx("button",{type:"button",className:"csb"+(m===f?" on":"")+(o===f?" busy":""),disabled:!!o,onClick:()=>{h(f)},children:x},f)),i&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(Ur,{o:t})]})}function Ur({o:t}){const{t:a,saveNote:n,flash:r}=A(),[s,o]=l.useState(t.ceoNote||""),[d,i]=l.useState(!1),[c,m]=l.useState(!1),b=s.trim()!==(t.ceoNote||"").trim(),u=async()=>{if(d||!b)return;i(!0);const h=await n(t,s.trim());i(!1),h&&(m(!0),setTimeout(()=>m(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:s,disabled:d,onChange:h=>o(h.target.value),onKeyDown:h=>{h.key==="Enter"&&u()}}),e.jsx("button",{type:"button",disabled:d||!b,onClick:()=>{u()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Vr({placeholder:t,onDone:a}){const{t:n}=A(),[r,s]=l.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>s(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Hr({o:t}){var g;const{t:a,token:n,caps:r,canWrite:s,stageOf:o,setStage:d,flashErr:i}=A(),[c,m]=l.useState(!1);if(!r.pipe||!s||r.lockActions||se(t)!==4)return null;const b=o(t),u=(b==null?void 0:b.stage)||"todo",h=async p=>{if(c||p===u)return;m(!0);const y=b;d(t,{stage:p,stamps:(b==null?void 0:b.stamps)||{}});const S=Math.max(Date.now(),qt+=1);qt=S;const w=await qa(n,{company:t.name||"",stage:p,cts:S,deal_id:t.airtableId,check_id:t.checkId});m(!1),!w.stale&&(w.ok||(d(t,y),i(a.actErr)))},v=(g=b==null?void 0:b.stamps)==null?void 0:g.sent,f=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,x=u==="sent"&&v&&f>=4;return e.jsxs("div",{className:"stg",onClick:p=>p.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([p,y])=>e.jsx("button",{type:"button",className:"stgb"+(u===p?" on":""),disabled:c,onClick:()=>{h(p)},children:y},p)),x&&e.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let qt=0;const $e=8,_e=340;function Rt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Yr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:s,scoped:o,byId:d,st:i}=A(),[c,m]=l.useState(0),[b,u]=l.useState(null),[h,v]=l.useState([]),f=l.useRef(!1);l.useEffect(()=>{f.current||(f.current=!0,v(t.filter(C=>!!document.querySelector(C.need||C.sel))))},[t]);const x=h[c],g=c>=h.length;l.useEffect(()=>{x&&(x.ptab!==void 0&&i.ptab!==x.ptab&&r({type:"ptab",tab:x.ptab}),x.dens&&i.dens!==x.dens&&r({type:"dens",dens:x.dens}))},[c,x]);const p=l.useCallback(()=>{if(!x){u(null);return}const C=document.querySelector(x.sel);if(!C){u(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),u(C.getBoundingClientRect())},[x]);l.useLayoutEffect(()=>{p();const C=window.setTimeout(p,260),j=()=>p();return window.addEventListener("scroll",j,!0),window.addEventListener("resize",j),()=>{window.clearTimeout(C),window.removeEventListener("scroll",j,!0),window.removeEventListener("resize",j)}},[p]);const y=l.useRef(a);if(y.current=a,l.useEffect(()=>{const C=j=>{j.key==="Escape"?(j.preventDefault(),j.stopPropagation(),y.current()):j.key==="ArrowRight"?m(z=>z+1):j.key==="ArrowLeft"&&m(z=>Math.max(0,z-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!h.length)return null;let S=null;if(g){const C=s[3]||0,j=o.find(z=>z.memoUrl)||[...d.values()].find(z=>z.memoUrl);C>0?S={title:C===1?n.ahaATitle1:n.ahaATitleN(C),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:j?S={title:n.ahaBTitle,body:n.ahaBBody(j.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:j.id}),a()}}:S={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:_e};if(!g&&b){const C=b.bottom+14,z=window.innerHeight-C>190?C:Math.max(12,b.top-200);w={left:Math.min(Math.max(12,b.left+b.width/2-_e/2),window.innerWidth-_e-12),top:z,width:_e}}return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!g&&b&&e.jsx("div",{className:"tour-hole",style:{left:b.left-$e,top:b.top-$e,width:b.width+$e*2,height:b.height+$e*2}}),(g||!b)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(g?" fin":""),style:w,children:[g&&S?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:S.title}),e.jsx("p",{children:e.jsx(Rt,{text:S.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>m(h.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:S.go,children:S.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(c+1,h.length)}),e.jsx("h3",{children:x==null?void 0:x.title}),e.jsx("p",{children:e.jsx(Rt,{text:(x==null?void 0:x.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>m(C=>Math.max(0,C-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>m(C=>C+1),children:c===h.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Wr(){const{dossiers:t,scopedAll:a,pipe:n,mode:r,t:s,st:o,dispatch:d}=A(),i=n?a:t,c=l.useMemo(()=>i.filter(p=>Te(p.date)===0&&p.kind==="target"),[i]),m=l.useMemo(()=>n?a.filter(p=>se(p)===0).slice().sort((p,y)=>(y.date||"").localeCompare(p.date||"")):[],[a,n]),b=l.useMemo(()=>c.filter(p=>n?se(p)===0:!de(p)),[c,n]),u=n?m:b,h=n?a.length-m.length:c.length-b.length,v=n?a.length:c.length,f=v?Math.min(100,h/v*100):100;let x;n?x=s.morningThesis(c.length,m.length):c.length?h===0?x=s.goalSourced(c.length):h>=c.length?x=s.goalCleared:x=s.goalDone(h,c.length):x=s.goalSourced(0);const g=()=>{if(!n){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),r==="client"&&m.length&&d({type:"chainStart",queue:m.map(p=>p.id)})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:x}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:f+"%"}})}),u.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:g,children:n?s.morningEval(u.length):o.pileMode?s.goalContinue(u.length):s.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Gr(){var O,M;const{t,lang:a,st:n,dispatch:r,token:s,fund:o,data:d,dossiers:i,mode:c,doSync:m,startTour:b}=A(),[u,h]=l.useState(null),[v,f]=l.useState([]),x=c==="client";l.useEffect(()=>{if(!s||!o)return;let E=!0;return(async()=>{const[_,P]=await Promise.all([lt(o),Vt(s)]);E&&(_&&h(_),f(P))})(),()=>{E=!1}},[s,o]);const g=(u==null?void 0:u.per_day)??null,p=((O=u==null?void 0:u.pool_order)==null?void 0:O.length)??0,y=v.filter(E=>E.status==="running").length,S=l.useMemo(()=>i.filter(E=>E.kind==="target"&&de(E)).length,[i]),w=d.marketEstimate,C=typeof((M=d.stats)==null?void 0:M.screened)=="number"?d.stats.screened:S,j=w&&w>0?Math.min(100,Math.round(C/w*100)):null,z=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),N=(o||"P").split(/\s+/).map(E=>E[0]).join("").slice(0,2).toUpperCase(),L=(()=>{const E=Date.parse(d.generatedAt||"");if(Number.isNaN(E))return"";const _=new Date(E),P=Q=>String(Q).padStart(2,"0");return`${P(_.getDate())}/${P(_.getMonth()+1)} à ${P(_.getHours())}:${P(_.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),L&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(L)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:b,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[j===null&&C>0&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsx("span",{className:"ev",children:e.jsx("b",{children:z(C)})})]}),j!==null&&w&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:j+"%"}})}),e.jsxs("b",{children:[j," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(C,w)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>r({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),g!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"q",children:g})," ",t.identPerDay]}),e.jsx("span",{className:"edv"})]}),g===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),y>0&&e.jsxs("span",{className:"ev",children:["⏳ ",y]}),e.jsx("span",{className:"ego",children:t.identPending(p)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:E=>{E.stopPropagation(),r({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!x,onClick:m,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:n.filters.search,onChange:E=>r({type:"filters",patch:{search:E.target.value}})})]})]})]})}function Kr(){const{t,counts:a,dispatch:n}=A();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,s],o)=>{const d=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(d?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:s}),d&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Qr=["--p0","--p1","--p2","--p3","--p4"];function Jr(){const{st:t,dispatch:a,counts:n,t:r,doUndo:s}=A(),o=l.useRef({});l.useEffect(()=>{o.current={...n}},[n]);const d=m=>{const b=o.current[m],u=b!==void 0?n[m]-b:0;return e.jsxs("button",{type:"button",className:"step"+(m===3&&n[3]>0?" wait":""),style:{"--c":`var(${Qr[m]})`,"--tc":m<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===m,title:r.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsxs("span",{className:"l",children:[r.plabels[m].toUpperCase(),m===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[n[m],u!==0&&e.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},m)},i=(m,b,u)=>e.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":m===5?"var(--p5)":m===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===m,title:r.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsx("span",{className:"l",children:u.toUpperCase()}),e.jsx("span",{className:"n",children:n[m]})]},m),c=(m,b,u,h=!1)=>e.jsx("button",{type:"button",className:"tool",title:b,disabled:h,onClick:u,children:m},b);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(d)}),e.jsxs("div",{className:"offtrack",children:[i(5,!1,r.plabels[5]),i(7,!0,r.plabels[7]),i(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",r.toolUndo,s,t.undo.length===0),c("↺",r.toolReset,()=>{a({type:"reset"})}),c("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Xr=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Zr(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:s,doAnalyse:o,mode:d}=A(),i=l.useRef(null),[c,m]=l.useState(60);l.useEffect(()=>{let v=0;const f=()=>{var S;const x=i.current;if(!x)return;const g=(S=x.parentElement)==null?void 0:S.querySelector('.funnel [aria-selected="true"]');if(!g)return;const p=g.getBoundingClientRect(),y=x.getBoundingClientRect();m(Math.max(20,Math.min(p.left+p.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",f)}},[t.ptab]);const b=t.ptab;let u=n.tuto[b].p;if(b===3){const v=r.filter(g=>g.kind==="target"&&se(g)===3),f=v.filter(g=>at(g)==="auto").length,x=v.filter(g=>at(g)==="cd").length;u=n.tutoPending(f,x,v.length)}const h=(()=>{if(d!=="client")return null;if(b===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(v=>v.id)})};if(b===1){const v=r.filter(f=>f.kind==="target"&&se(f)===1&&!s.has(f.id)).slice(0,10);if(v.length)return{label:n.tuto[1].a,run:()=>v.forEach(f=>o(f))}}return null})();return e.jsxs("div",{ref:i,className:"tuto mini",style:{"--bg":Xr[b],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[b].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:u}})]})}),h&&e.jsx("button",{type:"button",className:"tprim",onClick:h.run,children:h.label})]})}const Ot=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Ft(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function en(t,a){const[n,r]=l.useState(1);return l.useEffect(()=>{let s=!0,o=0;const d=()=>{var m;if(!s)return;const c=(m=t.current)==null?void 0:m.getScreenCTM();c&&c.a>0?r(c.a):o=requestAnimationFrame(d)};d();const i=new ResizeObserver(()=>d());return t.current&&i.observe(t.current),window.addEventListener("resize",d),()=>{s=!1,cancelAnimationFrame(o),i.disconnect(),window.removeEventListener("resize",d)}},[t,a]),n}function tn(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:s,markedId:o,byId:d,lang:i,t:c}=A(),m=l.useRef(null),b=l.useRef(null),u=dt.find(N=>N.key===t.continent),h=en(m,t.continent+":"+t.mapFolded),[v,f]=l.useState(new Map),[x,g]=l.useState(null);l.useEffect(()=>{const N=m.current;if(!N)return;const L=new Map;N.querySelectorAll("path[data-i2]").forEach(O=>{const M=O.dataset.i2;if(M)try{const E=O.getBBox();E.width>0&&L.set(M,{x:E.x,y:E.y,w:E.width,h:E.height})}catch{}}),f(L)},[t.continent,h]);const p=l.useMemo(()=>n.filter(N=>N.cc),[n]),y=l.useMemo(()=>{const N=new Map;return p.forEach(L=>N.set(L.cc,(N.get(L.cc)||0)+1)),N},[p]),S=l.useMemo(()=>p.map(N=>{const L=N.cc?v.get(N.cc):void 0;if(!L)return null;const O=Ft(N.name||N.id||""),M=Ft((N.id||N.name||"")+"·y"),E=(O-.5)*Math.min(L.w*.55,60),_=(M-.5)*Math.min(L.h*.55,60);return{d:N,x:L.x+L.w/2+E,y:L.y+L.h/2+_}}).filter(N=>!!N),[p,v]),w=N=>h>0?N/h:N,C=l.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:Ot[N],fr:c.plabels[N].toUpperCase(),en:c.plabels[N].toUpperCase(),n:n.filter(L=>L.kind==="target"&&se(L)===N).length})).filter(N=>N.n>0):kt.map((N,L)=>({...N,n:n.filter(O=>jt(O)===L).length})),[n,r,c.plabels]),j=o?d.get(o):null,z=j?S.find(N=>N.d.id===j.id):null;return e.jsxs("div",{className:"mapzone",ref:b,children:[e.jsxs("svg",{ref:m,viewBox:u.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":i==="fr"?u.fr:u.en,onMouseLeave:()=>{g(null),s(null)},children:[e.jsx("g",{children:u.countries.map((N,L)=>e.jsx("g",{className:"ct"+(N.i2&&y.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},L))}),e.jsx("g",{children:S.map(N=>{const L=kt[jt(N.d)],O=!!ne(N.d),M=N.d.kind==="target",E=r&&M?Ot[se(N.d)]:L.c,_=!r&&de(N.d);return e.jsxs("g",{className:"co"+(_?" done":""),onMouseEnter:()=>{var I,ie;const P=(I=b.current)==null?void 0:I.getBoundingClientRect(),Q=(ie=m.current)==null?void 0:ie.createSVGPoint();if(Q&&m.current&&P){Q.x=N.x,Q.y=N.y;const me=Q.matrixTransform(m.current.getScreenCTM());g({x:me.x-P.left,y:me.y-P.top,label:N.d.name+" · "+(Le(N.d.cc,i)||N.d.countryLabel||"")})}s(N.d.id)},onMouseLeave:()=>{g(null),s(null)},onClick:()=>{var I;const P=(I=m.current)==null?void 0:I.createSVGPoint();let Q=null;if(P&&m.current){P.x=N.x,P.y=N.y;const ie=P.matrixTransform(m.current.getScreenCTM());Q={x:ie.x,y:ie.y}}a({type:"popup",id:N.d.id,anchor:Q})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:w(Math.max(11,L.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:w(L.px),fill:E,stroke:O?"#DC2626":"#ffffff",strokeWidth:w(O?2.2:1.3)})]},N.d.id||N.d.name)})}),z&&e.jsx("circle",{className:"ring on",cx:z.x,cy:z.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(x?" on":""),style:x?{left:x.x,top:x.y}:void 0,children:x==null?void 0:x.label}),e.jsx("div",{className:"legend",children:C.map((N,L)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),i==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},L))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function an(t,a){const n=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t);if(!n)return t;const s=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(n[2])-1]||n[2],o=Number(n[3]);return a==="en"?`${s} ${o}, ${n[1]}`:`${o} ${s} ${n[1]}`}function rn(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:s,contName:o,lang:d}=A(),i=t.filters,c=l.useMemo(()=>n.filter(f=>f.continent===t.continent),[n,t.continent]),m=f=>c.filter(x=>f!=="country"&&i.country.length&&!i.country.includes(x.cc||"")?!1:ut(x,i,s,f==="country"?void 0:f)),b=l.useMemo(()=>{const f=m("win"),x=g=>f.filter(p=>(p.date?Math.max(0,Math.floor((Date.now()-Date.parse(p.date))/864e5)):9999)<=g).length;return[x(0),x(7),x(30),f.length]},[c,i,s]),u=l.useMemo(()=>i.day?m("win").filter(f=>(f.date||"").slice(0,10)===i.day).length:0,[c,i,s]),h=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.day||i.win!=="all"?1:0)+(i.search.trim()?1:0),v=(f,x,g,p="fbtn")=>e.jsxs("button",{type:"button",className:p,"aria-expanded":t.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[e.jsx("span",{className:"fl",children:x}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},f);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[i.day?e.jsxs("div",{className:"seg",children:[e.jsxs("button",{type:"button","aria-pressed":!0,children:[r.fDay(an(i.day,d)),e.jsx("b",{children:u})]}),e.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:r.fDayOff})]}):e.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,x)=>e.jsxs("button",{type:"button","aria-pressed":i.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[r.dates[x],e.jsx("b",{children:b[x]})]},f))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:i.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),i.sector.length===1?e.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":t.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:i.sector[0],children:[e.jsx("span",{className:"fl",children:r.fSector}),e.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:i.sector[0]}),e.jsx("span",{className:"cv",children:"▾"})]}):v("sec",r.fSector,i.sector.length),v("pay",r.fCountry,i.country.length),v("det",r.fEngine,i.engine.length),v("sta",r.fStage,i.stage.length),s&&v("ang","Angle",i.angle.length),s&&v("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),h>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(c.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(h)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(nn,{poolFor:m})]})}function nn({poolFor:t}){const{st:a,dispatch:n,t:r,lang:s}=A(),o=a.filters,d=a.openFacet,{title:i,cols:c,options:m}=l.useMemo(()=>{if(d==="sig"){const f=t("signal").filter(p=>ne(p)),x=new Map;f.forEach(p=>{const y=p.engine||"";x.set(y,(x.get(y)||0)+1)});const g=[{v:"*",label:r.fpSigAll,n:f.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...rt([...x.keys()],s).map(p=>({v:p,label:ze(p)+" "+ge(p,s),n:x.get(p)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(p)}))];return{title:r.fpSigTitle,cols:2,options:g}}if(d==="sec"){const f=t("sector"),x=new Map;return f.forEach(g=>{g.sector&&x.set(g.sector,(x.get(g.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...x.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:g,n:p,html:!1,on:o.sector.includes(g)}))}}if(d==="pay"){const f=t("country"),x=new Map;return f.forEach(g=>{g.cc&&x.set(g.cc,(x.get(g.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...x.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:Le(g,s)||g,n:p,html:!1,on:o.country.includes(g)}))}}if(d==="det"){const f=t("engine"),x=new Map;return f.forEach(g=>{g.engine&&x.set(g.engine,(x.get(g.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:rt([...x.keys()],s).map(g=>({v:g,label:ze(g)+" "+ge(g,s)+' <span style="color:var(--dim);font-size:10px">· '+Ra(Oa(g),s)+"</span>",n:x.get(g)||0,html:!0,on:o.engine.includes(g)}))}}if(d==="ang"){const f=t("angle"),x=new Map;return f.forEach(g=>{g.angle&&x.set(g.angle,(x.get(g.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...x.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:g.replace(/[_-]+/g," "),n:p,html:!1,on:o.angle.includes(g)}))}}if(d==="mem"){const f=t("memoLevel"),x=new Map;f.forEach(p=>{if(p.kind==="target"){const y=it(p);x.set(y,(x.get(y)||0)+1)}});const g=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(p=>({v:String(p),label:g[p],n:x.get(p)||0,html:!1,on:o.memoLevel.includes(p)}))}}const h=t("stage"),v=new Map;return h.forEach(f=>{f.stage&&v.set(f.stage,(v.get(f.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((f,x)=>x[1]-f[1]).map(([f,x])=>({v:f,label:f,n:x,html:!1,on:o.stage.includes(f)}))}},[d,a,s]),b=h=>{if(d==="sig"){if(h==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const f=o.signalEngines.includes(h)?o.signalEngines.filter(x=>x!==h):[...o.signalEngines,h];n({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(d==="mem"){n({type:"toggleMemoLevel",value:Number(h)});return}n({type:"toggleFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage",value:h})},u=()=>{n(d==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:d==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:i}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:u,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:m.map(h=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":h.on,onClick:()=>b(h.v),children:[e.jsx("span",{className:"bx"}),h.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:h.label}}):e.jsx("span",{className:"l",children:h.label}),e.jsx("span",{className:"n",children:h.n})]},h.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const Mt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function on(t){return String(t||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function sn(){var xe;const{t,mode:a,token:n,email:r,askEvaluate:s,sessTally:o,dispatch:d,evalBusy:i,evalCards:c,caps:m,data:b}=A(),u=a==="client",[h,v]=l.useState(""),[f,x]=l.useState(!1),[g,p]=l.useState(""),[y,S]=l.useState(!1),[w,C]=l.useState(""),[j,z]=l.useState([]),N=l.useRef(!1),[L,O]=l.useState(!1),[M,E]=l.useState(""),[_,P]=l.useState(""),[Q,I]=l.useState(!1),[ie,me]=l.useState(0),[he,be]=l.useState(""),[B,ce]=l.useState(null),[H,U]=l.useState(null),D=l.useRef(!1),$=h.trim()?Mt.test(h.trim())?t.evalUrl:t.evalName:t.evalWaiting,F=l.useMemo(()=>g.split(`
`).map(T=>T.trim()).filter(Boolean).slice(0,15),[g]);l.useEffect(()=>{if(typeof window>"u")return;const T=(new URLSearchParams(window.location.search).get("rs")||"").trim();!T||!/^https?:\/\//i.test(T)||(E(T),O(!0))},[]);const K=j.length?j:c,G=b.credits;l.useEffect(()=>{if(!Q)return;me(0);const T=window.setInterval(()=>me(V=>V+1),1e3);return()=>window.clearInterval(T)},[Q]);const ae=()=>{const T=h.trim();T&&(s(null,T),v(""))},J=async()=>{if(!u){s(null,F[0]||"");return}if(!F.length||y)return;S(!0),N.current=!1;const T=[];for(let V=0;V<F.length&&!N.current;V++){C(t.evaluating(V+1,F.length,F[V]));const X=await Ht(n,F[V],"atelier2");if(T.unshift({name:X.company||F[V],verdict:X.verdict,reason:X.reason||"",remaining:X.remaining??null}),z([...T]),X.verdict==="quota"){T.unshift({name:"",verdict:"quota",reason:t.quota(F.length-V-1),remaining:0}),z([...T]),p(F.slice(V+1).join(`
`)),C(""),S(!1);return}}C(""),p(N.current?F.slice(T.length).join(`
`):""),S(!1)},ee=async()=>{var X;if(D.current)return;const T=M.trim().replace(/\s+/g,""),V=_.trim();if(!T&&!V){be(t.rsNeed);return}if(!u){s(null,T||V.slice(0,80));return}D.current=!0,be(""),ce(null),U(null),I(!0);try{const W=await Ma({url:T,text:V,email:r,cbToken:n});if(I(!1),!W||W.status!=="success"){be((W==null?void 0:W.message)||"Erreur");return}ce(W),O(!1);const ue=(((X=W.prospective)==null?void 0:X.companies_to_evaluate)||[]).map(ke=>((ke==null?void 0:ke.name)||"").trim()).filter(Boolean);ue.length&&(p(ke=>{const De=ke.split(`
...
`)}),x(!0)),U({state:"pending"});const we=await Da(W,{email:r,cbToken:n});U(we.ok&&we.url?{state:"ok",url:we.url}:{state:"fail",msg:we.error||""})}finally{D.current=!1,I(!1)}},ve=(((xe=B==null?void 0:B.prospective)==null?void 0:xe.companies_to_evaluate)||[]).filter(T=>T&&T.name),Y=[B==null?void 0:B.industry,...(B==null?void 0:B.market_tags)||[],B==null?void 0:B.author].map(T=>(T||"").trim()).filter(Boolean),le=(H==null?void 0:H.state)==="pending",pe=H&&(le?e.jsx("span",{className:"rslink pend",children:t.rsPublishing}):H.state==="ok"?e.jsx("a",{className:"rslink",href:H.url,target:"_blank",rel:"noopener noreferrer",children:t.rsLink}):e.jsx("span",{className:"rslink fail",title:H.msg,children:t.rsPublishFail})),ye=f&&ve.length>0;return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:h,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:T=>v(T.target.value),onKeyDown:T=>{T.key==="Enter"&&ae()}}),e.jsx("span",{className:"detect"+(Mt.test(h.trim())?" url":""),children:$})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:ae,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),m.showCredits&&G&&e.jsxs("button",{type:"button",className:"credits"+(G.total_available<=0&&!G.unlimited?" empty":""),onClick:()=>d({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:G.unlimited?"∞":G.total_available}),!G.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",G.daily_grant+G.purchased]}),G.total_available<=0&&!G.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsxs("div",{className:"dunder",children:[e.jsx("button",{type:"button",className:"dmulti",onClick:()=>x(!f),children:t.evalMulti}),e.jsx("button",{type:"button",className:"dmulti dsearch"+(L?" on":""),onClick:()=>O(!L),children:t.rsOpen})]}),L&&e.jsxs("div",{className:"rsp on",children:[e.jsxs("div",{className:"rsf",children:[e.jsx("input",{className:"rsurl",value:M,placeholder:t.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:T=>E(T.target.value),onKeyDown:T=>{T.key==="Enter"&&ee()}}),e.jsx("span",{className:"rsor",children:t.rsOr}),e.jsx("textarea",{className:"rstext",value:_,placeholder:t.rsTextPh,onChange:T=>P(T.target.value)})]}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(Q?" loading":""),style:{justifyContent:"center"},disabled:Q||le||!M.trim()&&!_.trim(),onClick:()=>{ee()},children:[e.jsx("span",{className:"fill"}),Q?`${Fa(M.trim())==="youtube"&&M.trim()?t.rsRunningVid:t.rsRunning} ${t.rsElapsed(ie)}`:le?t.rsPublishing:t.rsGo]}),e.jsx("span",{className:"hint",children:t.rsHint})]})]}),he&&e.jsx("div",{className:"rserr",children:he}),B&&e.jsxs("div",{className:"rscard",children:[e.jsxs("div",{className:"rsh",children:[e.jsx("b",{children:B.title}),B.source_url&&e.jsx("a",{href:B.source_url,target:"_blank",rel:"noopener noreferrer",children:t.rsSource}),e.jsx("button",{type:"button",className:"rsx",title:t.rsClose,onClick:()=>{ce(null),U(null)},children:"×"})]}),B.market&&e.jsx("p",{className:"rsmk",children:B.market}),Y.length>0&&e.jsxs("div",{className:"rstags",children:[e.jsx("em",{children:t.rsTags}),Y.map(T=>e.jsx("span",{children:T},T))]}),e.jsxs("div",{className:"rsbody",children:[B.mindmap_png_b64&&e.jsxs("figure",{className:"rsmm",children:[e.jsx("img",{src:`data:image/png;base64,${B.mindmap_png_b64}`,alt:t.rsMindmap}),e.jsx("figcaption",{children:t.rsMindmap})]}),e.jsx("div",{className:"rssum",children:on(B.summary_md||"").map((T,V)=>e.jsx("p",{children:T},V))})]}),e.jsxs("div",{className:"rsfoot",children:[e.jsx("span",{children:t.rsFound(ve.length)}),!ye&&pe]})]}),f&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:T=>p(T.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(y?" loading":""),style:{justifyContent:"center"},disabled:y||!F.length,onClick:()=>{J()},children:[e.jsx("span",{className:"fill"}),y&&w?w:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(F.length)}),ye&&pe]})]}),K.slice(0,1).map((T,V)=>{const X=T.verdict==="kept",W=T.verdict==="quota",ue=X?"var(--brand)":W?"var(--bolt)":"var(--red)",we=X?"var(--brand-l)":W?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":ue,"--bgc":we},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:X?"✓ "+t.kept:W?"⏳":"✗ "+t.dropped})}),T.name&&e.jsx("span",{className:"rn",children:T.name}),e.jsx("span",{className:"rr",children:T.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",T.reason]}):null}),!W&&e.jsx("button",{type:"button",className:"go",onClick:()=>d({type:"modal",modal:"space"}),children:t.seeSpace(X?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},V)}),u&&(o.kept+o.dropped>0||K.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(o.kept,o.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>d({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function ln(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function dn(){const{st:t,dispatch:a,byId:n,t:r,doDeep:s}=A(),o=t.memoConsole?n.get(t.memoConsole):null,d=l.useMemo(()=>o?[o.reasoning||"",ln(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const i=Ae(o),c=it(o);return e.jsx("div",{className:"demand",style:{paddingTop:0},children:e.jsxs("div",{className:"memo",style:{marginTop:0},children:[e.jsxs("div",{className:"mh",children:[e.jsx("span",{className:"nm",children:o.name}),i&&e.jsx("span",{className:"vv",children:i}),typeof o.score=="number"&&e.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),e.jsx("div",{className:"tabs2",children:e.jsx("button",{type:"button","aria-selected":"true",children:r.memoSynth})}),e.jsx("div",{className:"mb2",children:d?d.split(`

`).map((m,b)=>e.jsx("p",{style:{margin:"0 0 10px"},children:m},b)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[ct(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>s(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:c===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const cn=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ue=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function pn(t){const a=String(t||"");if(!a)return"";let n="",r=0;for(;r<a.length;){const s=a.indexOf("<",r);if(s<0){n+=Ue(a.slice(r));break}n+=Ue(a.slice(r,s));const o=a.indexOf(">",s);if(o<0){n+=Ue(a.slice(s));break}const d=a.slice(s+1,o).trim(),i=/^(\/?)([a-zA-Z0-9]+)/.exec(d),c=i?i[2].toLowerCase():"";i&&cn.has(c)?n+=`<${i[1]}${c}>`:n+=Ue(a.slice(s,o+1)),r=o+1}return n}const Dt=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function re({k:t,v:a,href:n}){return a==null||a===""?null:e.jsxs("div",{className:"cdl",children:[e.jsx("span",{className:"cdk",children:t}),n?e.jsx("a",{className:"cdv",href:n,target:"_blank",rel:"noopener noreferrer",children:String(a)}):e.jsx("span",{className:"cdv",children:String(a)})]})}function un({o:t}){const{t:a,lang:n,dispatch:r,caps:s}=A(),o=Ye(t),d=Ae(t),i=(t.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[t.sector,t.stage,t.countryLabel,t.city,t.website,t.domain,t.linkedinCompany,t.angle,t.date].filter(Boolean).length,m=[t.contactName,t.contactEmail,t.contactLinkedin].filter(Boolean).length,b=[t.ceoStatus,t.ceoNote,s.pipe?t.memoUrl:"",s.pipe?t.memoPdfUrl:""].filter(Boolean).length+(typeof t.engagement=="number"&&t.engagement>0?1:0),u=l.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(i?1:0)+(t.reasoning?1:0)+(d?1:0)},{k:"ana",lib:a.cdAnalyse,n:(t.summary?1:0)+(s.pipe&&!s.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:m},{k:"suivi",lib:a.cdSuivi,n:b}].filter(x=>x.n>0),[t,a,i,d,c,m,b]),[h,v]=l.useState("");if(!u.length)return null;const f=u.some(x=>x.k===h)?h:u[0].k;return e.jsxs("div",{className:"cdtabs",children:[e.jsx("div",{className:"cdnav",role:"tablist",children:u.map(x=>e.jsx("button",{type:"button",role:"tab","aria-selected":f===x.k,className:f===x.k?"on":"",onClick:g=>{g.stopPropagation(),v(x.k)},children:x.lib},x.k))}),e.jsxs("div",{className:"cdbody",onClick:x=>x.stopPropagation(),children:[f==="conv"&&e.jsxs(e.Fragment,{children:[i&&e.jsxs("div",{className:"cdv1"+(i==="NO MATCH"?" out":""),children:[e.jsx("b",{children:i==="NO MATCH"?a.vOut:a.vKept}),e.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.reasoning&&e.jsx("p",{className:"cdtxt",children:t.reasoning}),d&&e.jsxs("div",{className:"cdv1 memo",children:[e.jsx("b",{children:d}),e.jsx("span",{className:"cdw",children:a.cdMemo(t.memoType||"")})]}),e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(re,{k:a.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(re,{k:a.cdVerdictDate,v:Dt(t.verdictDate,n)})]})]}),f==="ana"&&e.jsxs(e.Fragment,{children:[t.summary&&e.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:pn(t.summary)}}),s.pipe&&!s.lockActions&&e.jsx(mn,{o:t})]}),f==="soc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdSector,v:t.sector}),e.jsx(re,{k:a.cdStage,v:t.stage}),e.jsx(re,{k:a.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(re,{k:a.cdSite,v:t.domain||t.website,href:t.website||void 0}),e.jsx(re,{k:a.cdLinkedin,v:t.linkedinCompany?"LinkedIn":"",href:t.linkedinCompany}),e.jsx(re,{k:a.cdAngle,v:t.angle}),e.jsx(re,{k:a.cdDetected,v:Dt(t.date,n)})]}),f==="ctc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdName,v:t.contactName}),e.jsx(re,{k:a.cdEmail,v:t.contactEmail,href:t.contactEmail?`mailto:${t.contactEmail}`:void 0}),e.jsx(re,{k:a.cdLinkedin,v:t.contactLinkedin?"LinkedIn":"",href:t.contactLinkedin})]}),f==="suivi"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdCeoStatus,v:t.ceoStatus}),e.jsx(re,{k:a.cdEngagement,v:typeof t.engagement=="number"&&t.engagement>0?t.engagement:""})]}),t.ceoNote&&e.jsxs("p",{className:"cdtxt",children:["💬 ",t.ceoNote]}),s.pipe&&(t.memoUrl||t.memoPdfUrl)&&e.jsxs("div",{className:"cdacts",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),t.memoPdfUrl&&e.jsx("a",{className:"abtn",href:t.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function mn({o:t}){const{t:a,token:n}=A(),[r,s]=l.useState(!1),[o,d]=l.useState(null),i=async()=>{r||(s(!0),d(await Pa(n,t.name,t.website||t.domain||"")),s(!1))},c=(o==null?void 0:o.blocs)||{},m=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],b=m.some(([,u])=>u);return e.jsxs("div",{className:"qab",children:[!o&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mnote dim",children:a.qaHint}),e.jsx("button",{type:"button",className:"abtn",disabled:r,onClick:()=>{i()},children:r?a.qaBusy:a.qaRun})]}),o&&b&&e.jsxs(e.Fragment,{children:[m.filter(([,u])=>u).map(([u,h])=>e.jsxs("div",{className:"qal",children:[e.jsx("span",{className:"qak",children:u}),e.jsx("p",{children:h})]},u)),!!(o.pages||[]).length&&e.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!b&&e.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Jt({name:t}){const{t:a,token:n,caps:r,mode:s,flashErr:o}=A(),[d,i]=l.useState(!1),[c,m]=l.useState(null);if(!r.pipe||s!=="client"||r.lockActions)return null;const b=async()=>{if(d)return;i(!0);const u=await Ia(n,t);if(i(!1),!u){o(a.actErr);return}m(u.results||[])};return e.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{b()},children:d?a.similarBusy:a.similar}),c&&(c.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:c.map(u=>e.jsxs("li",{children:[e.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&e.jsx("span",{children:u.reason})]},u.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Xt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function ft({o:t}){const{t:a}=A(),n=Ye(t),r=Ae(t),s=se(t),o=at(t),d=Ba(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Xt[r]||"v-cons"),title:a.vt[r],children:r}):s===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,s===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),s===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),s===3&&d!==null&&e.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:a.waitTitle(d),children:a.waitChip(d)})]})}function Pt({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:s}=A(),[o,d]=l.useState(!1);if(l.useEffect(()=>{r||d(!1)},[r]),de(t)){const m=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[m?"✓":"✗"," ",e.jsx("b",{children:m?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const c=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:r,onClick:m=>{m.stopPropagation(),d(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function fn({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:s,doAnalyse:o,doDecide:d,doPromote:i,doRepeche:c,doApproach:m,dispatch:b}=A();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:v=>{v.stopPropagation(),b({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Pt,{o:t})});const u=se(t),h=v=>f=>{f.stopPropagation(),v()};if(u===0)return e.jsx("span",{className:"cell",children:e.jsx(Pt,{o:t})});if(u===1){const v=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:h(()=>o(t)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:h(()=>d(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:h(()=>d(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})});if(u===4){const v=s.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:v,onClick:h(()=>m(t)),children:v?a.actApproachSent:a.actApproach})})}return u===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:h(()=>i(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):u===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:h(()=>c(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:h(()=>b({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function xn({o:t}){const{t:a,doThumb:n,thumbOf:r}=A(),s=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(s==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(s==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function gn({o:t}){const{lang:a}=A();return ne(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(qe,{o:t}),e.jsx(We,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ze(t.engine||"")," ",ge(t.engine||"",a)]})})}function hn({o:t,locked:a,open:n,onToggle:r}){const{st:s,dispatch:o,caps:d,markRow:i,markedId:c,favIds:m,toggleFav:b}=A(),u=se(t),h=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,f=v<=0?0:v<=7?1:v<=30?2:3,x=d.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:h[f],g=m.has(t.id),p=y=>{if(a)return;if(d.pipe){r();return}const S=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return e.jsxs(l.Fragment,{children:[e.jsxs("div",{className:"row"+(c===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>i(t.id),onMouseLeave:()=>i(null),onClick:p,children:[e.jsx("span",{className:"pt",style:{"--c":x}}),e.jsx(na,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[d.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:g?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),b(t)},children:g?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(bn,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(gn,{o:t}),d.pipe&&e.jsx(ft,{o:t}),d.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(fn,{o:t}),d.showThumbs&&e.jsx(xn,{o:t})]}),(n||s.dens==="deplie")&&!a&&e.jsx(vn,{o:t})]})}function bn({o:t}){const{lang:a,caps:n}=A();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=pt(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function vn({o:t}){const{t:a,lang:n,dispatch:r,caps:s,outbound:o,doOnboard:d}=A();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),e.jsx(un,{o:t}),e.jsx(_r,{o:t}),e.jsx(Hr,{o:t}),e.jsx(Jt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(ft,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ze(t.engine||"")," ",ge(t.engine||"",n)]}),ne(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(qe,{o:t})})]}),s.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(t),children:a.actOnboard})]})]})]})}function yn({o:t,locked:a}){const{t:n,dispatch:r,caps:s,doDecide:o}=A(),d=se(t),i=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][d];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":i},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(ft,{o:t}),ne(t)&&e.jsx(qe,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&s.pipe&&d===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function wn(){const t=A(),{st:a,dispatch:n,t:r,caps:s,scoped:o,lang:d,sessTally:i,data:c,dossiers:m}=t,[b,u]=l.useState(new Set);l.useEffect(()=>{u(new Set)},[a.ptab,a.continent]);const h=j=>u(z=>{const N=new Set(z);return N.has(j)?N.delete(j):N.add(j),N}),v=l.useMemo(()=>mt(o,a.sort),[o,a.sort]),f=l.useMemo(()=>v.filter(j=>ne(j)&&!de(j)).length,[v]),x=l.useMemo(()=>s.pipe?v:v.filter(j=>!de(j)),[v,s.pipe]),g=s.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,p=(j,z,N="",L=!1)=>e.jsxs("button",{type:"button","data-s":j,className:N,"aria-sort":a.sort.key===j?a.sort.dir===1?"ascending":"descending":"none",style:L?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:j}),children:[z,e.jsx("span",{className:"ar",children:a.sort.key===j&&a.sort.dir===1?"▴":"▾"})]},j),y=l.useMemo(()=>{if(s.pipe||a.groupBy==="none")return null;const j=new Map;v.forEach(L=>{const O=L.engine||"?";j.has(O)||j.set(O,[]),j.get(O).push(L)});const z={ma:0,fundraising:1,media:2},N=rt([...j.keys()],d);return[...j.entries()].sort((L,O)=>{const M=z[L[0]]??10+N.indexOf(L[0]),E=z[O[0]]??10+N.indexOf(O[0]);return M-E})},[v,s.pipe,a.groupBy,d]),S=s.lockRowsAfter;let w=0;const C=(j,z)=>{const N=a.shown[z]||Ve,O=j.slice(0,N).map(M=>{const E=S!==null&&w>=S;return w++,a.dens==="maxi"?e.jsx(yn,{o:M,locked:E},M.id):e.jsx(hn,{o:M,locked:E,open:b.has(M.id),onToggle:()=>h(M.id)},M.id)});if(j.length>N){const M=Math.min(Ve,j.length-N),E=j.length-N;O.push(e.jsxs("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:z,by:Ve}),children:[e.jsx("span",{className:"more-label",children:r.more(M,E)}),e.jsxs("span",{className:"more-meta",children:[r.moreMeta(N,j.length)," · ",E," ",d==="en"?"remaining":"restantes"]})]},z+":more"))}return O};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:v.length})," ",g]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,s.pipe&&t.fund?" · "+t.fund:""]}),s.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),s.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([j,z])=>e.jsxs("button",{type:"button","data-d":j,"aria-pressed":a.dens===j,onClick:()=>n({type:"dens",dens:j}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:z})]},j))}),s.showChain&&x.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:x.map(j=>j.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",s.pipe?r.browse(x.length):r.chainAll(x.length)]})]}),f>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(f)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),p("country",r.colCountry),p("name",r.colCompany),p("amount",r.colAmount,"h-amt",!0),p("stage",r.colStage,"h-stade"),p("signal",r.colSignal,"h-sig"),s.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),s.pipe&&p("score",r.colScore,"h-sc",!0),e.jsx("span",{}),s.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[y?y.map(([j,z])=>e.jsxs(l.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ze(j)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:ge(j,d)}),e.jsx("div",{className:"s",children:r.grpCount(z.filter(N=>!de(N)).length,z.length)})]})]}),C(z,j)]},j)):C(v,"pt"+a.ptab),!v.length&&!(c.loading&&!m.length)&&e.jsx("div",{className:"void",children:s.pipe?r.emptyTab:r.emptyScope})]}),s.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(i.kept>0||i.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(i.kept,i.dropped)}})]})}const kn=`
...
`;function jn(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,s=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let d=t.y+10;return d+n>s-8&&(d=Math.max(8,t.y-n-14)),d<8&&(d=8),{left:o,top:d}}function Nn(){const{st:t,dispatch:a,byId:n,t:r,lang:s,caps:o,mode:d,askEvaluate:i,doAnalyse:c,doDecide:m,doPromote:b,doRepeche:u,doApproach:h,doDeep:v,doOnboard:f,outbound:x,evalBusy:g}=A(),p=t.popupId?n.get(t.popupId):null;if(!p)return null;const y=ne(p),S=se(p),w=Ae(p),C=p.kind==="target",j=z=>{a({type:"filters",patch:z}),a({type:"popup",id:null})};return Me.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:kn}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:jn(t.popupAnchor),onClick:z=>z.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:p.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(Te(p.date)),ge(p.engine,s))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[p.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>j({country:[p.cc]}),children:(Le(p.cc,s)||p.countryLabel||"").toUpperCase()}),p.sector&&e.jsx("button",{type:"button",onClick:()=>j({sector:[p.sector]}),children:p.sector.toUpperCase()}),p.stage&&e.jsx("button",{type:"button",onClick:()=>j({stage:[p.stage]}),children:p.stage.toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&e.jsx("span",{className:"am2",children:pt(p.amountEur,s)})]}),(p.tagline||p.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:p.tagline||p.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[ze(p.engine)," ",e.jsx("b",{children:ge(p.engine,s)})," — ",$a(p.engine,s),p.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",p.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(qe,{o:p,lg:!0})," ",e.jsx(We,{o:p,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(Yt(y,s))," · ",r.win7(Wt(y,s))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),p.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&S>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:p.reasoning})]}),o.pipe&&C&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof p.score=="number"&&p.score>0?" · "+r.score(p.score):""]})})]}),e.jsx(Jt,{name:p.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||d!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[S===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>i(p),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),S===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),S===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{b(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),S===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(p,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{m(p,!1),a({type:"popup",id:null})},children:r.actNo}),ct(p)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{v(p),a({type:"popup",id:null})},children:r.memoDeep})]}),S===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),S===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),p.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:p.id}),a({type:"popup",id:null})},children:"📄"}),x&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{f(p),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>i(p),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),p.website&&e.jsx("a",{className:"psite",href:p.website.startsWith("http")?p.website:"https://"+p.website,target:"_blank",rel:"noopener noreferrer",title:p.website,children:"🌐"})]})]})]}),document.body)}function It(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Sn(t,a){const n=_a(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function Cn(t,a){const r=[a.head.split("|").map(It).join(";")];for(const s of t){const o=a.stageOf(s);r.push([s.name||"",Sn(s,a.plabels),Ye(s)||s.verdict||"",typeof s.score=="number"?s.score:"",s.countryLabel||s.cc||"",s.sector||"",o?a.stageLabel(o.stage):"",s.contactName||"",s.contactEmail||"",s.memoUrl||"",(s.date||"").slice(0,10),(s.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(It).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function En(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const zn=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function fe({k:t,v:a}){return a==null||a===""?null:e.jsxs("div",{className:"dsl",children:[e.jsx("span",{children:t}),e.jsx("b",{children:String(a)})]})}function Tn({o:t,qa:a}){const{t:n,lang:r,fund:s}=A(),o=(t.cribleStatus||"").trim().toUpperCase()||(Ye(t)==="NO MATCH"?"NO MATCH":"MATCH"),d=Ae(t),i=(a==null?void 0:a.blocs)||{},c=[[n.qaVP,i.value_prop],[n.qaProduct,i.produit],[n.qaModel,i.modele],[n.qaSummary,i.synthese]];return e.jsxs("article",{className:"dspage",children:[e.jsxs("header",{className:"dsh",children:[e.jsxs("div",{children:[e.jsx("b",{children:t.name}),t.tagline&&e.jsx("p",{children:t.tagline})]}),e.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?n.vOut:n.vKept,d&&e.jsx("em",{children:d})]})]}),t.reasoning&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsWhy}),e.jsx("p",{className:"dstxt",children:t.reasoning})]}),e.jsxs("section",{className:"dsgrid",children:[e.jsx(fe,{k:n.cdSector,v:t.sector}),e.jsx(fe,{k:n.cdStage,v:t.stage}),e.jsx(fe,{k:n.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(fe,{k:n.cdSite,v:t.domain||t.website}),e.jsx(fe,{k:n.cdName,v:t.contactName}),e.jsx(fe,{k:n.cdEmail,v:t.contactEmail}),e.jsx(fe,{k:n.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(fe,{k:n.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(fe,{k:n.cdAngle,v:t.angle}),e.jsx(fe,{k:n.cdDetected,v:zn(t.date,r)})]}),c.some(([,m])=>m)&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsAnalysis}),c.filter(([,m])=>m).map(([m,b])=>e.jsxs("div",{className:"dsb",children:[e.jsx("span",{children:m}),e.jsx("p",{children:b})]},m))]}),(t.ceoStatus||t.ceoNote)&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsDecision}),t.ceoStatus&&e.jsx("p",{className:"dstxt",children:e.jsx("b",{children:t.ceoStatus})}),t.ceoNote&&e.jsxs("p",{className:"dstxt",children:["« ",t.ceoNote," »"]})]}),e.jsx("footer",{className:"dsf",children:n.dsFoot(s)})]})}function An(){const{t,lang:a,token:n,scoped:r,fund:s,data:o,dispatch:d}=A(),[i,c]=l.useState({}),m=25,b=l.useMemo(()=>r.slice(0,m),[r]);l.useEffect(()=>{b.length&&Ua(n,b.map(v=>v.name)).then(c)},[n,b]);const u=o.stats,h=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return e.jsxs("div",{className:"dossier",children:[e.jsxs("div",{className:"dsbar",children:[e.jsx("b",{children:t.dsTitle(b.length)}),r.length>m&&e.jsx("span",{className:"mnote dim",children:t.dsCap(m,r.length)}),e.jsx("span",{className:"dssp"}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:t.printBtn})]}),e.jsxs("div",{className:"dscover",children:[e.jsx("b",{children:s}),u&&typeof u.screened=="number"&&e.jsxs("p",{children:[h(u.screened)," ",t.funScreened(""),typeof u.kept=="number"&&e.jsxs(e.Fragment,{children:[" · ",h(u.kept)," ",t.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&e.jsxs(e.Fragment,{children:[" · ",t.covOf(h(o.marketEstimate)),", ",Math.round(u.screened/o.marketEstimate*100)," %"]})]})]}),b.map(v=>e.jsx(Tn,{o:v,qa:i[v.name]},v.id)),!b.length&&e.jsx("p",{className:"mnote",children:t.dsEmpty})]})}const Ln=50;function xt({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:s}=A(),[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(""),[u,h]=l.useState(0),[v,f]=l.useState(""),[x,g]=l.useState(!1),p=l.useRef(null);l.useEffect(()=>()=>{p.current&&window.clearInterval(p.current)},[]);const y=async w=>{c(!0),b("");const C=await a();if(c(!1),C.ok){d(C);return}if(C.busy){b(s.alertPreviewBusy);return}if(!w){b(s.alertPreviewFail);return}h(Ln),p.current=window.setInterval(()=>{h(j=>j>1?j-1:(p.current&&window.clearInterval(p.current),y(!1),0))},1e3)},S=async()=>{if(r||x)return;g(!0),f("");const w=await n();g(!1),f(w.ok?s.alertTestOk(w.sentTo||""):w.error||s.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:i||u>0,onClick:()=>{y(!0)},children:i?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||x,onClick:()=>{S()},children:x?"…":s.alertTest})]}),u>0&&e.jsx("p",{className:"mnote",children:s.alertPreviewRetry(u)}),m&&e.jsx("p",{className:"mnote warn",children:m}),v&&e.jsx("p",{className:"mnote",children:v}),!v&&e.jsx("p",{className:"mnote dim",children:s.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:s.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:s.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Fe="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function oe({title:t,icon:a,children:n,wide:r}){const{dispatch:s}=A();return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&s({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>s({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function qn(){const{st:t}=A();switch(t.modal){case"chain":return e.jsx(On,{});case"space":return e.jsx(Fn,{});case"alert":return e.jsx(Mn,{});case"queue":return e.jsx($n,{});case"export":return e.jsx(_n,{});case"plug":return e.jsx(Hn,{});case"recharge":return e.jsx(Wn,{});case"cover":return e.jsx(Kn,{});case"dossier":return e.jsx(Gn,{});case"crit":return e.jsx(Qn,{});case"tuto":return e.jsx(Jn,{});case"rdv":return e.jsx(Rn,{});case"memoalert":return e.jsx(Un,{});default:return null}}function Rn(){const{dispatch:t,fund:a}=A(),n=typeof document<"u"&&!!document.getElementById("rdv");return l.useEffect(()=>{n&&(t({type:"modal",modal:null}),Or())},[n,t]),n?null:e.jsx(Ya,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function On(){const{st:t,dispatch:a,byId:n,t:r,lang:s,mode:o,askEvaluate:d,evalBusy:i}=A(),c=o==="client",m=t.chain.queue.map(v=>n.get(v)).filter(v=>!!v),b=t.chain.idx,u=m[b],h=b>=m.length;return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:h?r.finished:`${b+1} / ${m.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(h?100:b/Math.max(1,m.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:h||!u?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(m.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:u.name}),e.jsx("div",{className:"sub",children:[Le(u.cc,s)||u.countryLabel,u.sector,u.stage,r.daysAgo(Te(u.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:ge(u.engine,s).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{children:pt(u.amountEur,s)})]}),ne(u)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(qe,{o:u,lg:!0})," ",e.jsx(We,{o:u,src:!0})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),c&&de(u)&&e.jsxs("div",{className:"vbox",style:{"--c":Ee(u)==="retenu"?"var(--brand)":Ee(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:Ee(u)==="retenu"?"✓ "+r.kept:Ee(u)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!h&&u&&!(c&&de(u))&&e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:i,onClick:()=>{d(u)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(h?{type:"modal",modal:null}:{type:"chainNext"}),children:h?r.closeBtn:r.skip})]})]})})}),document.body)}function Fn(){const{st:t,dispatch:a,dossiers:n,t:r,mode:s}=A(),o=s==="client",d=l.useMemo(()=>o?n.filter(u=>de(u)):[],[n,o]),i=l.useMemo(()=>mt(d.filter(u=>Ee(u)==="retenu"),{key:"signal",dir:-1}),[d]),c=l.useMemo(()=>d.filter(u=>Ee(u)==="ecarte"),[d]),m=t.spaceTab==="retenu"?i:c,b=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(oe,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:i.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),m.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),m.slice(0,40).map(u=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":b},children:typeof u.score=="number"&&u.score>0?u.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:u.name}),e.jsx("div",{className:"rr",children:u.reasoning||u.tagline||""})]})]},u.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function Mn(){const{mode:t}=A();return t==="client"||t==="apercu"?e.jsx(Dn,{}):e.jsx(Bn,{})}function Dn(){const{t,token:a,flash:n,flashErr:r,mode:s}=A(),[o,d]=l.useState("d"),i=s!=="client";return e.jsxs(oe,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>d("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>d("w"),children:t.alertTabWeekly}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>d("m"),children:t.alertTabMarket})]}),o==="d"&&e.jsx(Pn,{t,token:a,readOnly:i,flash:n,flashErr:r}),o==="w"&&e.jsx(In,{t,token:a,readOnly:i,flash:n,flashErr:r}),o==="m"&&e.jsx(Zt,{})]})}function Pn({t,token:a,readOnly:n,flash:r,flashErr:s}){const[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(0);l.useEffect(()=>{let f=!0;return c(!1),Ct(a).then(x=>{f&&(x?d(x):c(!0))}),()=>{f=!1}},[a,m]);const u=f=>{n||Ct(a,f).then(x=>{if(!x){s(t.actErr);return}d(x),x.throttled?s(t.alertThrottled):r(t.alertSaved)})};if(i)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const h=f=>!o.sections||o.sections.includes(f),v=f=>{const x=o.sections||t.alertSec.map(([g])=>g);u({sections:h(f)?x.filter(g=>g!==f):[...x,f]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([f,x])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:h(f),disabled:n,onChange:()=>v(f)}),e.jsxs("span",{children:[x,f==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},f))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(xt,{label:t.alertPreview,readOnly:n,onPreview:()=>Za(a),onTest:()=>Xa(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function In({t,token:a,readOnly:n,flash:r,flashErr:s}){const[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(0);l.useEffect(()=>{let f=!0;return c(!1),Et(a).then(x=>{f&&(x?d(x):c(!0))}),()=>{f=!1}},[a,m]);const u=f=>{n||Et(a,f).then(x=>{if(!x){s(t.actErr);return}d(x),r(t.alertSaved)})};if(i)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const h=o.dow??0,v=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:h,disabled:n,onChange:f=>u({dow:Number(f.target.value)}),children:t.alertDow.map((f,x)=>e.jsx("option",{value:x,children:f},f))}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,v-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[v," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,v+1)}),disabled:n,children:"＋"})]})]}),e.jsx(xt,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>tr(a),onTest:()=>er(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Zt(){const{st:t,t:a,lang:n,scoped:r,contName:s,email:o}=A(),[d,i]=l.useState(o||""),[c,m]=l.useState(!1),[b,u]=l.useState(!1);l.useEffect(()=>{o&&i(o)},[o]);const h=t.filters,v=l.useMemo(()=>r.filter(p=>ne(p)).length,[r]),f=h.win==="1"?0:h.win==="7"?1:h.win==="30"?2:3,x=async()=>{if(!(!/.+@.+\..+/.test(d)||b)){u(!0);try{await fetch(`${st}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:h.sector,countries:h.country,source:o?"atelier2-client":"atelier2",website:""})}),m(!0)}finally{u(!1)}}},g=[[a.amRows.continent,s],[a.amRows.since,a.amSince[f]],[a.amRows.signal,h.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,h.engine.length?h.engine.map(p=>ge(p,n)).join(", "):a.amAllEngines],[a.amRows.sectors,h.sector.length?h.sector.join(", "):a.amAllSectors],[a.amRows.countries,h.country.length?h.country.map(p=>Le(p,n)||p).join(", "):a.amAllCountries],[a.amRows.stages,h.stage.length?h.stage.join(", "):a.amAllStages]];return c?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:g.map(([p,y])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:p}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},p))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!o,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(b?" loading":""),style:{padding:"12px 18px"},onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})}function Bn(){const{t}=A();return e.jsx(oe,{title:t.alertTitle,icon:"🔔",children:e.jsx(Zt,{})})}function $n(){var x,g,p;const{t,token:a,fund:n,mode:r,flash:s}=A(),[o,d]=l.useState(null),[i,c]=l.useState([]),[m,b]=l.useState(0),u=r==="client";l.useEffect(()=>{let y=!0;return(async()=>{const[S,w]=await Promise.all([lt(n),Vt(a)]);y&&(S&&d(S),c(w))})(),()=>{y=!1}},[a,n,m]);const h=(o==null?void 0:o.per_day)??2,v=((x=o==null?void 0:o.analyzed_today)==null?void 0:x.length)??0,f=(g=o==null?void 0:o.tomorrow)!=null&&g.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(oe,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(v,v+(((p=o==null?void 0:o.pool_order)==null?void 0:p.length)??0))}})}),e.jsxs("div",{className:"qrate",children:[t.covRate," — ",e.jsx("b",{children:t.covRateNow(h)})]})]}),i.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:i.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),u&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{St(a,y.company,"retry").then(()=>b(S=>S+1))},children:t.queueRetry}),u&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{St(a,y.company,"delete").then(()=>b(S=>S+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[f.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),f.slice(0,10).map((y,S)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",S+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function _n(){const{t,token:a,flash:n,scoped:r,caps:s,stageOf:o,dispatch:d}=A(),i=`${Fe}/cibles/list.csv?token=${a}`,c=`${Fe}/cibles/list.json?token=${a}`,m=`${Fe}/cibles/export.xlsx?token=${a}&scope=full`,b=`=IMPORTDATA("${i}")`,u=g=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>n(t.exportCopied))},h=[{def:t.exportCsv,value:i,href:i},{def:t.exportSheet,value:b},{def:t.exportLive,value:c,href:c},{def:t.exportXlsx,value:m,href:m}],v=!s.lockActions&&r.length>0,f=()=>{En(Cn(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:g=>(t.stg.find(([p])=>p===g)||["",""])[1]})),n(t.exportViewDone(r.length))},x=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(oe,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:x,children:t.printBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🗂"}),e.jsxs("div",{children:[e.jsx("b",{children:t.dsBtn}),e.jsx("p",{children:t.dsHint})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:t.exportViewBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:f,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:h.map(({def:g,value:p,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:g[0]}),e.jsxs("div",{children:[e.jsx("b",{children:g[1]}),e.jsx("p",{children:g[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>u(p),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},g[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function Un(){const{t,token:a,flash:n,flashErr:r,mode:s}=A(),o=s!=="client",[d,i]=l.useState(null),[c,m]=l.useState(!1),[b,u]=l.useState(0),[h,v]=l.useState(!1);l.useEffect(()=>{let p=!0;return m(!1),Nt(a).then(y=>{p&&(y?i(y):m(!0))}),()=>{p=!1}},[a,b]);const f=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},x=p=>{if(o||!d)return;const y={enabled:p.enabled??!!d.enabled,email:p.email??(d.email||""),sections:p.sections??f()};v(!0),Nt(a,y).then(S=>{if(v(!1),!S){r(t.memoAlertErr);return}i(S),n(t.memoAlertSaved)})};if(c)return e.jsx(oe,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>u(p=>p+1),children:t.retry})]})});if(!d)return e.jsx(oe,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const g=f();return e.jsxs(oe,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:o||h,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),e.jsx(Vn,{value:d.email||"",readOnly:o||h,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:p=>x({email:p})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([p,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!g[p],disabled:o||h,onChange:()=>x({sections:{...g,[p]:!g[p]}})}),e.jsx("span",{children:y})]},p))}),e.jsx(xt,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Ha(a,g),onTest:()=>Va(a,g)})]})}function Vn({value:t,readOnly:a,label:n,okLabel:r,onSave:s}){const[o,d]=l.useState(t);l.useEffect(()=>{d(t)},[t]);const i=o.trim()!==t.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:m=>d(m.target.value),onKeyDown:m=>{m.key==="Enter"&&i&&c&&s(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!i||!c,onClick:()=>s(o.trim()),children:r})]})]})}function Hn(){const{t,token:a,flash:n,flashErr:r,canWrite:s}=A(),[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(null),[u,h]=l.useState(""),[v,f]=l.useState(0);l.useEffect(()=>{let p=!0;return c(!1),nt(a).then(y=>{p&&(y?d({configured:y.configured,url_hint:y.url_hint}):c(!0))}),Ga(a).then(y=>{p&&b(y)}),()=>{p=!1}},[a,v]);const x=(p,y)=>{s&&nt(a,p).then(S=>{if(!S||S.ok===!1){r(t.actErr);return}p.test&&S.sent===!1?r(t.plugTestThrottled):n(y),f(w=>w+1)})},g='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(oe,{title:t.plugTitle,icon:"🔌",wide:!0,children:[m&&e.jsx("p",{className:"mnote"+(m.enabled?" warn":""),children:m.enabled?t.plugAutoOn(m.destination||"webhook"):t.plugAutoOff}),i?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>f(p=>p+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:u,disabled:!s,onChange:p=>h(p.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!s||!u.trim(),onClick:()=>x({url:u.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!s,onClick:()=>x({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!s,onClick:()=>x({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Yn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:g}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Yn(){const{t,token:a,lang:n}=A(),[r,s]=l.useState("valides"),[o,d]=l.useState(!1),[i,c]=l.useState(null),[m,b]=l.useState(null),[u,h]=l.useState(!1),[v,f]=l.useState(!1),[x,g]=l.useState(null),[p,y]=l.useState(null),[S,w]=l.useState(null),C=`atl2:bulk:${a}:${r}`;l.useEffect(()=>{nt(a).then(E=>{y(E&&E.configured?E.url_hint||"webhook":null)})},[a]),l.useEffect(()=>{c(null),b(null),h(!1),g(null);try{const E=JSON.parse(localStorage.getItem(C)||"null");w(E&&Date.now()-Date.parse(E.t)<24*3600*1e3?E:null)}catch{w(null)}},[C]);const j=async()=>{d(!0),h(!1),g(null);const E=await Qa(a,r);c(E),b(E.ok?r:null),d(!1)},z=l.useRef(!1),N=async()=>{if(z.current)return;z.current=!0,f(!0);const E=`${a}:${r}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await Ja(a,r,"webhook",void 0,E)}finally{z.current=!1}if(f(!1),h(!1),g(_),_.ok&&(_.pushed||0)>0){const P={t:new Date().toISOString(),n:_.pushed||0};w(P);try{localStorage.setItem(C,JSON.stringify(P))}catch{}}},L=i!=null&&i.ok&&i.ready||0,O=!!(i!=null&&i.ok)&&m===r&&L>0&&!!p&&!S,M=S?new Date(S.t).toLocaleString(n==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:r,onChange:E=>s(E.target.value),children:t.plugBulkTabs.map(([E,_])=>e.jsx("option",{value:E,children:_},E))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{j()},children:o?"…":t.plugBulkPreview})]}),i&&(i.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(i.ready||0,i.linkedinReady||0,(i.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(i!=null&&i.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),S&&e.jsx("p",{className:"mnote",children:t.bulkLocked(M,S.n)}),!S&&!!(i!=null&&i.ok)&&!p&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!S&&!i&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),O&&!u&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>h(!0),children:t.bulkArm}),O&&u&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(L,p||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{N()},children:v?t.bulkSending:t.bulkConfirm(p||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>h(!1),children:t.bulkCancel})]}),x&&(x.ok?x.replayed?e.jsx("p",{className:"mnote",children:x.pending?t.bulkPending:t.bulkReplayed}):(x.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(x.pushed||0,x.linkedinReady||0,x.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:x.error||t.actErr}))]})}function Wn(){const{t,data:a,lang:n}=A(),r=a.credits,s=a.email,o=async d=>{if(!s)return;const i=window.location.href.split("?")[0];try{const m=await(await fetch(`${st}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s,lookup_key:d,success_url:i+"?credits=ok",cancel_url:i+"?credits=cancel"})})).json();m.url&&(window.location.href=m.url)}catch{}};return e.jsxs(oe,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(d=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(d.credits,d.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(d.lookup_key)},children:t.rechargeBuy})]},d.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Gn(){const{t}=A();return e.jsx(oe,{title:t.dsBtn,icon:"🗂",wide:!0,children:e.jsx(An,{})})}function Kn(){const{t,lang:a,data:n,dossiers:r,token:s,canWrite:o,flash:d}=A(),[i,c]=l.useState(null),[m,b]=l.useState(!1);l.useEffect(()=>{let j=!0;return lt(s).then(z=>{j&&z&&typeof z.per_day=="number"&&c(z.per_day)}),()=>{j=!1}},[s]);const u=n.stats,h=typeof(u==null?void 0:u.screened)=="number"?u.screened:r.filter(j=>j.kind==="target"&&de(j)).length,v=n.marketEstimate||0,f=v>0?Math.min(100,Math.round(h/v*100)):null,x=(u==null?void 0:u.window_days)||30,g=h>0?h/x:0,p=v>0?Math.max(0,v-h):0,S=v>0&&g>0&&h>=100?Math.round(p/g):null,w=j=>Math.round(j).toLocaleString(a==="en"?"en-US":"fr-FR"),C=j=>{m||!o||(b(!0),Ka(s,j).then(z=>{if(b(!1),z===null){d(t.actErr);return}c(z),d(t.alertSaved)}))};return e.jsxs(oe,{title:t.coverTitle,icon:"🌍",children:[e.jsxs("div",{className:"covg",children:[e.jsx("b",{children:t.covScreened(w(h))}),v>0&&e.jsx("span",{children:t.covOf(w(v))})]}),f!==null?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"covbar",children:[e.jsx("i",{style:{width:f+"%"}}),e.jsxs("em",{children:[f," %"]})]}),S!==null&&e.jsx("p",{className:"mnote",children:t.covEta(S)})]}):e.jsx("p",{className:"mnote dim",children:t.covNoEst}),g>=1&&e.jsx("p",{className:"mnote",children:t.covPace(w(g))}),u&&e.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.kept)})," ",t.covKept]}),typeof u.analyzed=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.analyzed)})," ",t.covAna]}),typeof u.shown=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.shown)})," ",t.covShown]})]}),o&&i!==null&&e.jsxs("div",{className:"covr",children:[e.jsxs("div",{className:"covrh",children:[e.jsx("span",{children:t.covRate}),e.jsx("b",{children:t.covRateNow(i)})]}),e.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(j=>e.jsx("button",{type:"button",className:i===j?"on":"",disabled:m,onClick:()=>C(j),children:j===0?"⏸":j},j))}),e.jsx("p",{className:"mnote dim",children:t.covRateHint})]})]})}function Qn(){var p,y,S;const{t,dossiers:a,token:n,mode:r,flash:s,criteria:o}=A(),d=r==="client",i=l.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[c,m]=l.useState(null);l.useEffect(()=>{let w=!0;return Wa(n).then(C=>{w&&m(C.thumbs)}),()=>{w=!1}},[n]);const[b,u]=l.useState(""),[h,v]=l.useState(""),[f,x]=l.useState(!1),g=async()=>{const w=b.trim();if(!(!w||f||!d)){x(!0),v("");try{const j=await(await fetch(`${Fe}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:w,who:"atelier2"})})).json().catch(()=>({}));if(j.reply&&v(String(j.reply)),j.job_id){v(t.critChatRunning);const z=async()=>{const N=await fetch(`${Fe}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:j.job_id})}).then(L=>L.json()).catch(()=>null);if(N&&N.done){v(String(N.reply||N.clarification||N.summary||"✓")),x(!1),N.applied&&s(t.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),u("");return}u("")}finally{h.startsWith("⏳")||x(!1)}}};return e.jsxs(oe,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((p=o.points)!=null&&p.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(w=>{var C,j;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(z=>e.jsx("li",{children:z},z))})]}),!!((j=w.out)!=null&&j.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(z=>e.jsx("li",{children:z},z))})]})]})]},w.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),i.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:i.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:b,disabled:!d||f,onChange:w=>u(w.target.value),onKeyDown:w=>{w.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!d||f||!b.trim(),onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),h&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:h})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((w,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Xt[w]||"v-cons"),children:w}),e.jsx("span",{children:C})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",C]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function Jn(){const{t,dispatch:a,startTour:n}=A(),r=s=>{var o,d;a({type:"modal",modal:null}),s==="crit"||s==="plug"||s==="alert"?a({type:"modal",modal:s}):s.startsWith("tab")?a({type:"ptab",tab:Number(s.slice(3))}):s==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return e.jsxs(oe,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([s,o],d)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:d+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+d))})]})}const tt={},Bt=(tt==null?void 0:tt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function He(){return new Date().toISOString().slice(0,10)}const ea=l.createContext(null);function ta(){const t=l.useContext(ea);if(!t)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return t}function Xn({token:t,children:a}){const{dispatch:n,st:r,lang:s}=A(),[o,d]=l.useState(()=>r.filters.day||He()),[i,c]=l.useState(null),[m,b]=l.useState(!1),u=l.useCallback(f=>{if(/^\d{4}-\d{2}-\d{2}$/.test(f)){d(f);try{n({type:"filters",patch:{day:f,win:"all"}})}catch{}}},[n]);l.useEffect(()=>{r.filters.day||u(He())},[]),l.useEffect(()=>{const f=x=>{var p;const g=(p=x.detail)==null?void 0:p.day;typeof g=="string"&&u(g)};return window.addEventListener("pp-edition-day",f),()=>window.removeEventListener("pp-edition-day",f)},[u]),l.useEffect(()=>{r.filters.day&&r.filters.day!==o&&d(r.filters.day)},[r.filters.day]),l.useEffect(()=>{if(!t||!o)return;let f=!1;b(!0);const x=new URLSearchParams({token:t,date:o});return fetch(`${Bt}/cibles/edition.json?${x}`).then(g=>g.json()).then(g=>{f||c(g)}).catch(()=>{f||c({ok:!1,error:"network"})}).finally(()=>{f||b(!1)}),()=>{f=!0}},[t,o]);const h=l.useMemo(()=>`${Bt}/cibles/editions.json?token=${encodeURIComponent(t)}`,[t]),v=l.useMemo(()=>({token:t,day:o,ed:i,loading:m,pickDay:u,daysUrl:h,isEn:s==="en"}),[t,o,i,m,u,h,s]);return e.jsx(ea.Provider,{value:v,children:a})}function Zn(){const{day:t,daysUrl:a,pickDay:n,isEn:r}=ta();return e.jsxs("div",{className:"thesis-days",children:[e.jsx("style",{children:`
      ...
      `}),e.jsx("p",{className:"thesis-days__h",children:r?"Thesis brief · pick a day":"Brief thèse · choisir un jour"}),e.jsx(ar,{mode:"local",theme:"light",month:t.slice(0,7),current:t,daysUrl:a,onPick:n})]})}function eo(){const{day:t,ed:a,loading:n,pickDay:r,isEn:s}=ta(),o=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!o,i=a&&!a.ok;return e.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||t,"data-fund":(a==null?void 0:a.fund)||"",children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("header",{className:"thesis-brief__hd",children:[e.jsx("span",{className:"thesis-brief__kicker",children:s?"Daily brief":"Brief du jour"}),e.jsxs("h2",{className:"thesis-brief__title",children:[s?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||t)&&e.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||t,children:(a==null?void 0:a.date)||t})]}),e.jsx("p",{className:"thesis-brief__hint",children:s?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),n&&!o&&e.jsx("p",{className:"thesis-brief__loading",children:s?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),i&&e.jsxs("p",{className:"thesis-brief__err",children:[s?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!n&&e.jsx("p",{className:"thesis-brief__empty",children:s?e.jsxs(e.Fragment,{children:["No thesis brief for ",e.jsx("b",{children:t})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):e.jsxs(e.Fragment,{children:["Pas encore de brief de thèse pour le ",e.jsx("b",{children:t}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),o&&(a!=null&&a.html)?e.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,o&&(a!=null&&a.acquirers_html)?e.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,t&&t!==He()&&e.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:()=>r(He()),children:s?"← Back to today":"← Revenir à aujourd’hui"})]})}const aa="atl2:mapfold",to=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(aa);if(t==="on")return!0;if(t==="off")return!1}catch{}try{const t=new URLSearchParams(window.location.search);if(t.get("embed")==="1"&&(t.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},ra=l.createContext(null),A=()=>{const t=l.useContext(ra);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function qe({o:t,lg:a}){const{lang:n}=A(),r=ne(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:zt(r,n),children:[r.emoji," ",zt(r,n)]}):null}function We({o:t,src:a}){const{lang:n,t:r}=A(),s=ne(t);if(!s)return null;const o=ir(s),d=lr(s);return e.jsxs("em",{className:"sigwin"+(d?" hot":""),title:r.signaledOn(Yt(s,n))+" · "+r.win7(Wt(s,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(i,c)=>e.jsx("i",{className:c<o?"on":""},c))}),e.jsx("span",{className:"lb",children:d?r.lastDay:r.daysLeft(Math.max(0,s.left??0))}),a&&s.url&&e.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:i=>i.stopPropagation(),children:"↗"})]})}function na({o:t}){const{lang:a}=A(),n=sr(t.cc),r=t.cc?Le(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const $t="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",oa=t=>`atl2:tour:${t||"anon"}`;function ao(t){try{return localStorage.getItem(oa(t))==="1"}catch{return!0}}function _t(t){try{localStorage.setItem(oa(t),"1")}catch{}}function ro(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function co({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:s,onFiltersChange:o}){const{lang:d}=rr(),i=gr[d],c=Er(t,d,a),[m,b]=l.useReducer(Tr,void 0,()=>zr((r==null?void 0:r.continent)??"europe",t||to(),{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),u=l.useRef(!0);l.useEffect(()=>{if(u.current){u.current=!1;return}if(!t)try{localStorage.setItem(aa,m.mapFolded?"on":"off")}catch{}},[m.mapFolded,t]);const h=l.useRef(o);h.current=o,l.useEffect(()=>{var k;(k=h.current)==null||k.call(h,m.filters)},[m.filters]);const[v,f]=l.useState(null),[x,g]=l.useState(null),[p,y]=l.useState({kept:0,dropped:0}),[S,w]=l.useState(!1),[C,j]=l.useState(""),[z,N]=l.useState(!1),[L,O]=l.useState(null),[M,E]=l.useState(!1),[_,P]=l.useState(!1),[,Q]=l.useState(0),I=()=>Q(k=>k+1),ie=l.useRef([]),me=l.useRef(new Set),he=l.useRef(new Set),be=l.useRef(new Map),B=l.useRef(null),{mode:ce}=c,H=l.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...s||null}),[c.caps,s,a]),U=H.pipe,D=c.session.token||"",$=ce==="client"&&!t;l.useEffect(()=>{if(document.querySelector(`link[href="${$t}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=$t,document.head.appendChild(k)},[]);const F=(k,q=!1)=>{j(k),N(q),B.current&&clearTimeout(B.current),B.current=setTimeout(()=>j(""),q?4200:2400)},K=k=>F(k,!0),G=l.useMemo(()=>{const k=new Map;return c.dossiers.forEach(q=>{q.id&&k.set(q.id,q)}),k},[c.dossiers]),ae=l.useMemo(()=>c.dossiers.filter(k=>Kt(k,m,U)),[c.dossiers,m,U]),J=l.useRef(!1);l.useEffect(()=>{if(J.current||t||c.loading||!c.dossiers.length)return;if(!H.showFunnel||ao(c.session.token||"")){J.current=!0;return}J.current=!0;const k=window.setTimeout(()=>{_t(c.session.token||""),E(!0)},700);return()=>window.clearTimeout(k)},[t,c.loading,c.dossiers.length,H.showFunnel,c.session.token]);const ee=l.useMemo(()=>c.dossiers.filter(k=>Ar(k,m,U,c.favIds)),[c.dossiers,m,U,c.favIds]),ve=l.useMemo(()=>nr(ae,c.favIds),[ae,c.favIds]),Y=dt.find(k=>k.key===m.continent),le=d==="fr"?Y.fr:Y.en;l.useEffect(()=>{const k=q=>{var Z;const R=(((Z=q.detail)==null?void 0:Z.name)||"").trim();R&&pe(null,R)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)});const pe=(k,q)=>{const R=((k==null?void 0:k.name)||q||"").trim();if(!$){g({kicker:R});return}!R||S||(w(!0),(async()=>{try{const Z=await Ht(D,R,"atelier2"),Pe={name:Z.company||R,verdict:Z.verdict,reason:Z.reason||"",remaining:Z.remaining??null};ie.current=[Pe,...ie.current].slice(0,8),Z.verdict==="kept"&&y(Ne=>({...Ne,kept:Ne.kept+1})),Z.verdict==="ruled_out"&&y(Ne=>({...Ne,dropped:Ne.dropped+1}));const Re=k||c.dossiers.find(Ne=>(Ne.name||"").toLowerCase()===R.toLowerCase());Re&&(Z.verdict==="kept"?Re.verdict=Re.verdict||"MATCH":Z.verdict==="ruled_out"&&(Re.verdict="NO MATCH"),Z.reason&&(Re.reasoning=Z.reason)),I()}finally{w(!1)}})())},ye=k=>{if(!$){g({kicker:k.name});return}me.current.add(k.id),Oe(D,"fast_request",k.name||"",""),F(i.memoInstantSent(k.name)),I()},xe=k=>be.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),T=(k,q)=>b({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:q}}),V=async(k,q,R)=>{const Z=k.ceoStatus||"";k.ceoStatus=q,I();const Pe=await Xe(D,{status:q,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(R==null?void 0:R.note)!==void 0?{note:R.note}:{},...R!=null&&R.via?{via:R.via}:{}});return Pe.ok?Pe.skipped?(k.ceoStatus=Z,I(),K(i.actNotPersisted),!1):((R==null?void 0:R.undo)!==!1&&T(k,Z),R!=null&&R.msg&&F(R.msg),(q==="Validé"||q==="Écarté")&&!k.ceoNote&&(R==null?void 0:R.note)===void 0&&O({o:k,yes:q==="Validé"}),!0):(k.ceoStatus=Z,I(),K(i.actErr),!1)},X=async(k,q)=>{const R=await Xe(D,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:q,via:"note"});return!R.ok||R.skipped?(K(R.skipped?i.actNotPersisted:i.actErr),!1):(k.ceoNote=q,I(),!0)},W=l.useRef(new Map),ue=k=>W.current.has(k.id)?W.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),we=(k,q)=>{W.current.set(k.id,q),I()},ke=(k,q)=>{$&&V(k,q?"Validé":"Écarté",{msg:q?i.decidedYes(k.name):i.decidedNo(k.name)})},De=k=>{$&&V(k,"À trancher",{msg:i.promoted(k.name)})},Ge=k=>{$&&(async()=>{const q=k.ceoStatus||"";k.ceoStatus="Retenu",I();const R=await Xe(D,{status:"Retenu",check_id:k.checkId,company:k.name});if(!R.ok||R.skipped){k.ceoStatus=q,I(),K(R.skipped?i.actNotPersisted:i.actErr);return}T(k,q),F(i.repeched(k.name))})()},Ke=()=>{const k=m.undo[m.undo.length-1];if(!k){F(i.undoNone);return}const q=G.get(k.id);if(!q){b({type:"undoPop"}),F(i.undoNone);return}let R=k.prevCeoStatus;if(!R)if((q.verdict||"").toUpperCase().includes("CALL"))R="À trancher";else{F(i.undoLockedTitle);return}(async()=>await V(q,R,{undo:!1})&&(b({type:"undoPop"}),q.ceoStatus=k.prevCeoStatus,I(),F(i.undoDone(q.name))))()},je=k=>{$&&(he.current.add(k.id),I(),(async()=>{const q=await dr(D,k.name,"email");if(!q||q.ok===!1){he.current.delete(k.id),I(),K(i.actErr);return}Oe(D,"approach",k.name||"",""),F(i.actApproachSent)})())},sa=(k,q)=>{$&&(async()=>{if(!(await Oe(D,q?"yes":"no",k.name||"","")).ok){K(i.actErr);return}be.current.set(k.id,q?"yes":"no"),I(),F(q?i.thumbUpDone:i.thumbDnDone)})()},ia=k=>{!$||!ct(k)||(Oe(D,"detailed_request",k.name||"",""),F(i.memoDeepSent(k.name)))},la=k=>{const q=new Set(c.favIds),R=q.has(k.id);R?q.delete(k.id):q.add(k.id),c.setFavIds(q),$&&cr(D,{id:k.id,co:k.name},R)},da=()=>{!$||_||window.confirm(i.identSyncConfirm)&&(P(!0),(async()=>{const k=await pr(D);P(!1),k?F(i.identSyncDone):K(i.actErr)})())},gt=/proplace/i.test(c.fund||""),ca=k=>{!$||!gt||(Oe(D,"onboard_request",k.name||"",""),F(i.onboardSent(k.name)))},pa={st:m,dispatch:b,t:i,lang:d,mode:ce,caps:H,pipe:U,token:D,fund:c.fund,email:c.email,criteria:c.criteria,data:c,doRepeche:Ge,thumbOf:xe,canWrite:$,commitStatus:V,saveNote:X,stageOf:ue,setStage:we,flashErr:K,startTour:()=>E(!0),dossiers:c.dossiers,scopedAll:ae,scoped:ee,counts:ve,byId:G,contName:le,favIds:c.favIds,toggleFav:la,askEvaluate:pe,doAnalyse:ye,doDecide:ke,doPromote:De,doApproach:je,doThumb:sa,doDeep:ia,doUndo:Ke,doSync:da,doOnboard:ca,outbound:gt,memoQueued:me.current,approachDone:he.current,sessTally:p,evalCards:ie.current,evalBusy:S,markRow:f,markedId:v,flash:F};l.useEffect(()=>{const k=q=>{q.key==="Escape"&&(b({type:"popup",id:null}),b({type:"modal",modal:null}),b({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const ua=k=>D?e.jsx(Xn,{token:D,children:k}):e.jsx(e.Fragment,{children:k});return e.jsx(ra.Provider,{value:pa,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:vr}),ua(e.jsxs("div",{className:"app"+(U?" pipe":"")+(D?" has-thesis":""),children:[H.showTicker&&e.jsx(te,{name:"live",children:e.jsxs("div",{className:"live-stack"+(D?" live-stack--cibles":""),children:[e.jsx(Lr,{}),!!D&&e.jsx(Zn,{})]})}),H.showIdent&&e.jsx(te,{name:"identite",children:e.jsx(Gr,{})}),H.showOnb&&e.jsx(te,{name:"onboarding",children:e.jsx(Kr,{})}),H.showMorning&&e.jsx(te,{name:"matin",children:e.jsx(Wr,{})}),e.jsx(te,{name:"fraicheur",children:e.jsx(Ir,{})}),e.jsx(te,{name:"mesure",children:e.jsx(Br,{})}),H.showFunnel&&e.jsx(te,{name:"entonnoir",children:e.jsx(no,{})}),H.showFunnel&&e.jsx(te,{name:"tunnel",children:e.jsx(Jr,{})}),H.showFunnel&&e.jsx(te,{name:"tuto",children:e.jsx(Zr,{})}),e.jsx(te,{name:"carte",fallback:e.jsx("div",{className:"void",children:i.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(oo,{}),e.jsxs("div",{className:"stage"+(m.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(tn,{}),e.jsx(rn,{})]})]})}),H.showDemand&&e.jsx(te,{name:"evaluation",children:e.jsx(sn,{})}),H.showDemand&&m.memoConsole&&e.jsx(te,{name:"console",children:e.jsx(dn,{})}),e.jsx(te,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[i.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:i.retry})]}),children:e.jsx(wn,{})}),!!D&&e.jsx(te,{name:"edition",children:e.jsx(eo,{})}),c.loading&&e.jsx("div",{className:"void",children:i.loadingV2}),c.error&&!c.loading&&e.jsxs("div",{className:"void",children:[i.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:i.retry})]})]})),H.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:i.lockbarText}),e.jsx("button",{type:"button",onClick:()=>b({type:"modal",modal:"rdv"}),children:i.lockbarCta})]}),m.popupId&&e.jsx(te,{name:"fiche",children:e.jsx(Nn,{})}),e.jsx(te,{name:"modales",children:e.jsx(qn,{})}),e.jsx(Mr,{}),L&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:L.o.name}),e.jsx(Vr,{placeholder:L.yes?i.whyYesPh:i.whyNoPh,onDone:k=>{const q=L.o;O(null),k&&X(q,k).then(R=>{R&&F(i.csNoteSaved)})}})]}),M&&e.jsx(Yr,{steps:ro(i),onClose:()=>{E(!1),_t(D)}}),C&&e.jsx("div",{className:"flash on"+(z?" err":""),children:C}),x&&e.jsx(or,{variant:"acquirer",initialCompany:Ut().co,initialWebsite:Ut().site,onClose:()=>g(null)})]})})}function no(){const{t}=A(),[a,n]=l.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function oo(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:s,t:o}=A(),d=l.useMemo(()=>{const i={};return t.forEach(c=>{c.continent&&ut(c,a.filters,r)&&(i[c.continent]=(i[c.continent]||0)+1)}),i},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[ur.map(i=>{const c=dt.find(m=>m.key===i);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===i,onClick:()=>n({type:"continent",key:i}),children:[s==="fr"?c.fr:c.en,e.jsx("span",{className:"n",children:d[i]||0})]},i)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ut(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function so(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{na as FlagCell,qe as SigBadge,We as SigWin,co as default,so as fmtShort,A as useV2};
