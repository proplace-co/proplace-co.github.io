...
.atl2 .bulk .side .hint{white-space:nowrap}`,zo=`
...
`,Ao=Eo+zo;function aa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function To(){const e=aa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Lo(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=To();return r==="0"?"client":r==="1"||aa("embed")==="1"&&aa("chrome")==="1"?"apercu":"client"}const Ro={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Oo=e=>Ro[e],Ue=e=>Object.assign(e,{continent:Or(e.cc)});function Ht(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Mo=60*60*1e3;function qo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Mo?null:a}catch{return null}}function vt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Fo=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Po(e,a,r="default"){const n=r!=="default",o=g.useMemo(()=>e||n?{mode:"anon"}:jr(),[e,n]),i=g.useMemo(()=>n?"visiteur":Lo(e,o),[e,o,n]),l=g.useMemo(()=>Oo(i),[i]),s=i!=="visiteur",p=Fo(r),[u,c]=g.useState([]),[d,f]=g.useState(""),[v,x]=g.useState(null),[b,h]=g.useState(null),[m,y]=g.useState(null),[j,w]=g.useState(()=>new Map),[N,S]=g.useState(()=>new Map),[C,R]=g.useState(""),[F,k]=g.useState(new Set),[T,A]=g.useState(null),[M,O]=g.useState(!0),[E,L]=g.useState(!1),[$,K]=g.useState(0),[X,pe]=g.useState(0),le=g.useRef(0),U=g.useMemo(()=>{var H;if(i!=="client")return"";try{return((H=Nr())==null?void 0:H.email)||""}catch{return""}},[i]);g.useEffect(()=>{const H=++le.current;let _=!0;const G=()=>_&&H===le.current,ee=(s&&o.token?o.token:"pub:"+a)+(p?":"+p:""),ne=qo(ee);return ne?(c(ne.objs.map(Ue)),ne.fund&&f(ne.fund),x(ne.marketEstimate??null),h(ne.criteria??null),y(ne.stats??null),R(ne.generatedAt||""),O(!1)):O(!0),(async()=>{try{if(r==="ops"){const ge=await _t(),ue=((ge==null?void 0:ge.recent_ops)||[]).map(Y=>{const Q=Ut(Y.company_name||Y.title?Y:{...Y,title:(Y.headline_fr||Y.headline||"").slice(0,120)},a),be=String(Y.rubrique||"").toLowerCase();return Q&&(be==="nominations"||be==="recrutements")&&(Q.engine=be),Q&&!String(Y.company_name||"").trim()&&(Q.noCo=!0),Q}).filter(Y=>!!Y).map(Y=>(Sr((Y.name||"").trim())||(Y.noCo=!0),Y));try{const Y=await Cr(),Q=Er(Y),be=((Y==null?void 0:Y.date)||"").slice(0,10);if(Q.length&&be){const B=new Set;for(const de of ue){if(de.noCo||(de.date||"").slice(0,10)!==be)continue;const re=(de.name||"").trim().toLowerCase();if(!(re.length<3)){for(let fe=0;fe<Q.length;fe++)if(!B.has(fe)&&Q[fe].t.includes(re)){B.add(fe),de.decryptHtml=Q[fe].html;break}}}}}catch{}if(!G())return;c(ue.map(Ue)),vt(ee,{objs:ue})}else if(typeof r=="object"){const ue=(await Ma()||[]).filter(Q=>(Q.slug||"")===r.research).map(Q=>qa(Q,a)).filter(Q=>!!Q),Y=Ht(await Fa(ue,a));if(!G())return;c(Y.map(Ue)),vt(ee,{objs:Y})}else if(s&&o.token){const ge=zr(o.token),ue=_t(),Y=Ar(o.token),Q=Tr(o.token),be=Lr(o.token),B=await ge;let de=B?B.targets:[];G()&&B&&(f(B.fund||""),x(B.marketEstimate??null),h(B.criteria??null),y(B.stats??null),R(B.generatedAt||""),c(de.map(Ue)),O(!1),L(!1));const[re,fe,Oe,ve]=await Promise.all([ue,Y,Q,be]),Me=((re==null?void 0:re.recent_ops)||[]).map(ye=>Ut(ye,a)).filter(ye=>!!ye);if(de=[...de,...Me],!G())return;c(de.map(Ue));const Ie=new Set;for(const ye of fe){const Be=(ye.id||ye.co||"").toString().trim().toLowerCase();Be&&Ie.add(Be.startsWith("t:")?Be:"t:"+Be)}k(Ie),w(Oe),S(ve),B&&vt(ee,{fund:B.fund,marketEstimate:B.marketEstimate,criteria:B.criteria,stats:B.stats,generatedAt:B.generatedAt,objs:de})}else{const ge=Rr(),ue=Ma(),Y=_t(),Q=await ge;G()&&Q.length&&(c(Ht(Q).map(Ue)),O(!1),L(!1));const[be,B]=await Promise.all([ue,Y]),de=(be||[]).map(ve=>qa(ve,a)).filter(ve=>!!ve),re=await Fa(de,a),fe=((B==null?void 0:B.recent_ops)||[]).map(ve=>Ut(ve,a)).filter(ve=>!!ve),Oe=Ht([...Q,...re,...fe]);if(!G())return;c(Oe.map(Ue)),vt(ee,{objs:Oe})}G()&&L(!1)}catch{G()&&!ne&&L(!0)}finally{G()&&O(!1)}})(),()=>{_=!1}},[s,o.token,a,$,p]),g.useEffect(()=>{if(!l.showCredits||!U){A(null);return}let H=!0;return(async()=>{try{const _=await fetch(`${va}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:U})});if(!_.ok)return;const G=await _.json();H&&G&&G.ok!==!1&&A(G)}catch{}})(),()=>{H=!1}},[l.showCredits,U,X]);const W=g.useCallback(H=>k(new Set(H)),[]);return{session:o,mode:i,caps:l,fund:d,email:U,marketEstimate:v,generatedAt:C,criteria:b,stats:m,thumbs:j,stages:N,dossiers:u,favIds:F,setFavIds:W,credits:T,reloadCredits:()=>pe(H=>H+1),loading:M,error:E,refresh:()=>K(H=>H+1)}}const On=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Do=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...On(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Io(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:On(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Mn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Mn=40;function Na(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!xe(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(ya(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(et(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&He(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(o))return!1}return!0}function qn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Na(e,a.filters,r)}function Bo(e,a,r,n){return!(!qn(e,a,r)||r&&!Mr(e,a.ptab,n))}function Sa(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-et(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"signal":{const i=xe(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),s=n(i);return l<s?-a.dir:l>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const $o=["ma","levees","nominations","recrutements","actualites"],_o=300,Uo={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Fn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Vo=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ha(e){const a=xe(e);if(a)return"sig:"+(a.theme&&Fn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Ho(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:l}=q(),s=l==="en",[p,u]=g.useState("all"),[c,d]=g.useState(!1),f=g.useMemo(()=>{const C=(a.filters.day||"").slice(0,10),R=A=>!(!i&&a.continent!=="monde"&&A.continent!==a.continent||C&&(A.date||"").slice(0,10)!==C),F=e.filter(A=>R(A)&&xe(A)),k=e.filter(A=>R(A)&&A.kind==="op"&&!xe(A)&&(C?!0:et(A.date)<=7)),T=C||new Date().toISOString().slice(0,10);return k.sort((A,M)=>{const O=(A.date||"").slice(0,10)===T?0:1,E=(M.date||"").slice(0,10)===T?0:1;return O!==E?O-E:(M.amountEur||0)-(A.amountEur||0)}),[...Sa(F,{key:"signal",dir:-1}),...k]},[e,a.continent,a.filters.day,i]),v=g.useMemo(()=>{const C={};for(const R of f){const F=Ha(R);C[F]=(C[F]||0)+1}return C},[f]),x=g.useMemo(()=>p==="all"?f:f.filter(C=>Ha(C)===p),[f,p]),b=g.useMemo(()=>x.slice(0,_o),[x]),h=x.length-b.length,m=C=>C==="all"?f.length:v[C]||0,y=C=>C==="all"?s?"All":"Tout":C.startsWith("sig:")?Fn[s?"en":"fr"][C.slice(4)]||"🔔":Uo[s?"en":"fr"][C],j=[{k:"all"}],w=$o.filter(C=>m(C)>0||C===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const C of w)j.push({k:C})}const N=Vo.map(C=>"sig:"+C).filter(C=>m(C)>0||C===p);if(N.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const C of N)j.push({k:C})}const S=C=>b.map(R=>t.jsxs("button",{type:"button",className:"tk"+(Ne(R)?" spent":""),onClick:F=>{const k=F.currentTarget.getBoundingClientRect();n({type:"popup",id:R.id,anchor:{x:k.left+k.width/2,y:k.bottom}})},title:R.name+(R.tagline?" — "+R.tagline:""),children:[t.jsx(rt,{o:R}),t.jsxs("span",{className:"who",children:[t.jsx(dr,{o:R}),t.jsx("span",{className:"co",children:R.name})]}),typeof R.amountEur=="number"&&R.amountEur>0&&t.jsx("span",{className:"am",children:hl(R.amountEur)}),R.sector&&t.jsx("span",{className:"mt",children:R.sector}),t.jsx(Bt,{o:R}),t.jsx("span",{className:"tkgo",children:"→"})]},C+(R.id||R.name))).concat(h>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${h} more — filter by section to see them`:`+ ${h} autres — filtrez par rubrique pour les voir`},C+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:C=>{C.currentTarget.contains(C.relatedTarget)||d(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":c,onClick:()=>d(C=>!C),children:[y(p),t.jsx("b",{children:m(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsx("div",{className:"tkfilm",hidden:!c,children:j.map(C=>"g"in C?t.jsx("span",{className:"tkfilg",children:C.g},C.g):t.jsxs("button",{type:"button","aria-pressed":C.k===p,onClick:()=>{u(C.k),d(!1)},children:[y(C.k),t.jsx("b",{children:m(C.k)})]},C.k))})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[S(0),S(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})})]})}const Yo="aDx8z7Hzksus",Pn="+33 6 83 10 72 86",Ya="alexandre@proplace.co",Wo=`tel:${Pn.replace(/[^\d+]/g,"")}`,Wa="pp-rdv-slot";function Go(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Ko(){const{t:e,caps:a,fund:r}=q();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:Xo}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Wo,children:Pn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Ya}`,children:Ya})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(jo,{filloutId:Yo,parameters:r?{company_name:r}:void 0})})]})}function Qo(){const[e,a]=g.useState(()=>typeof document>"u"?null:document.getElementById(Wa));return g.useEffect(()=>{e||a(document.getElementById(Wa))},[e]),e?tt.createPortal(t.jsx(Ko,{}),e):null}const Xo=`
...
`;class me extends g.Component{constructor(){super(...arguments);Ra(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Jo=8;function Zo(){const{t:e,lang:a,token:r,dossiers:n,caps:o,markRow:i,dispatch:l}=q(),[s,p]=g.useState(!1),[u,c]=g.useState(!1),[d,f]=g.useState(!1),v=r||"home",{names:x,verdicts:b}=g.useMemo(()=>{const w=[],N={};return n.forEach(S=>{S.kind!=="target"||!S.name||(w.push(S.name),N[S.name]=qr(S)||"")}),{names:w,verdicts:N}},[n]),h=g.useMemo(()=>x.length?Fr(v,x,b,a):null,[v,x.length]);if(!o.pipe||s||!h||h.firstVisit||!h.added.length&&!h.gone.length)return null;const m=u?h.added:h.added.slice(0,Jo),y=h.added.length-m.length,j=w=>{const N=n.find(S=>S.name===w);N&&(i(N.id),l({type:"popup",id:N.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(h.added.length,h.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Pr(v,x,b,h.fp,a)},children:"×"})]}),!!h.added.length&&t.jsxs("div",{className:"since-c",children:[m.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>c(!0),children:e.sinceMore(y)})]}),!!h.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>f(w=>!w),children:e.sinceOut(h.gone.length)}),d&&h.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Yt=600,Ve=62,Ga="atl2:fstats";function ei(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=q(),[l,s]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Ga)==="on"}catch{return!1}}),p=r.stats,u=g.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),c=g.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const d=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,f=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=u.reduce((y,j)=>Math.max(y,j.s||0),0),x=u.length?Yt/u.length:0,b=Math.max(4,x-4),h=u.length>=5&&v>0,m=[[p.screened,e.funScreened(d(c)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[m.map(([y,j,w],N)=>t.jsxs("span",{className:"fst-t",children:[N>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:f(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),h&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Ga,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&h&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Yt} ${Ve}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[u.map((y,j)=>{const w=(y.s||0)/v*(Ve-4),N=(y.m||0)/v*(Ve-4),S=j*x+(x-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${d(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:S,y:Ve-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:Ve-2-N,width:b,height:N,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:Ve-1.5,x2:Yt,y2:Ve-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:d(u[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const ti=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ai({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=q(),[i,l]=g.useState(""),[s,p]=g.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const u=(e.ceoStatus||"").trim(),c=(at(e)||"").startsWith("CALL")&&ke(e)===3,d=ke(e)>=2,f=async x=>{if(i||x==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(x);const b=await o(e,x);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},v=c?[["Validé",a.csYes],["Écarté",a.csNo]]:ti.filter(([x])=>!(d&&x==="Retenu")).map(([x,b])=>[x,a[b]]);return t.jsxs("div",{className:"csp",onClick:x=>x.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([x,b])=>t.jsx("button",{type:"button",className:"csb"+(u===x?" on":"")+(i===x?" busy":""),disabled:!!i,onClick:()=>{f(x)},children:b},x)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ni,{o:e})]})}function ni({o:e}){const{t:a,saveNote:r,flash:n}=q(),[o,i]=g.useState(e.ceoNote||""),[l,s]=g.useState(!1),[p,u]=g.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),d=async()=>{if(l||!c)return;s(!0);const f=await r(e,o.trim());s(!1),f&&(u(!0),setTimeout(()=>u(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:f=>i(f.target.value),onKeyDown:f=>{f.key==="Enter"&&d()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{d()},children:p?a.csNoteSaved:a.csNoteOk})]})}function ri({placeholder:e,onDone:a}){const{t:r}=q(),[n,o]=g.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function oi({o:e}){var h;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:s}=q(),[p,u]=g.useState(!1);if(!n.pipe||!o||n.lockActions||ke(e)!==4)return null;const c=i(e),d=(c==null?void 0:c.stage)||"todo",f=async m=>{if(p||m===d)return;u(!0);const y=c;l(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),Ka+=1);Ka=j;const w=await Dr(r,{company:e.name||"",stage:m,cts:j,deal_id:e.airtableId,check_id:e.checkId});u(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},v=(h=c==null?void 0:c.stamps)==null?void 0:h.sent,x=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,b=d==="sent"&&v&&x>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(d===m?" on":""),disabled:p,onClick:()=>{f(m)},children:y},m)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(x)})]})}let Ka=0;const yt=8,wt=340;function Qa({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function ii({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,scoped:i,byId:l,st:s}=q(),[p,u]=g.useState(0),[c,d]=g.useState(null),[f,v]=g.useState([]),x=g.useRef(!1);g.useEffect(()=>{x.current||(x.current=!0,v(e.filter(N=>!!document.querySelector(N.need||N.sel))))},[e]);const b=f[p],h=p>=f.length;g.useEffect(()=>{b&&(b.ptab!==void 0&&s.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&s.dens!==b.dens&&n({type:"dens",dens:b.dens}))},[p,b]);const m=g.useCallback(()=>{if(!b){d(null);return}const N=document.querySelector(b.sel);if(!N){d(null);return}N.scrollIntoView({block:"nearest",behavior:"smooth"}),d(N.getBoundingClientRect())},[b]);g.useLayoutEffect(()=>{m();const N=window.setTimeout(m,260),S=()=>m();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{window.clearTimeout(N),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[m]);const y=g.useRef(a);if(y.current=a,g.useEffect(()=>{const N=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),y.current()):S.key==="ArrowRight"?u(C=>C+1):S.key==="ArrowLeft"&&u(C=>Math.max(0,C-1))};return document.addEventListener("keydown",N,!0),()=>document.removeEventListener("keydown",N,!0)},[]),!f.length)return null;let j=null;if(h){const N=o[3]||0,S=i.find(C=>C.memoUrl)||[...l.values()].find(C=>C.memoUrl);N>0?j={title:N===1?r.ahaATitle1:r.ahaATitleN(N),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:S?j={title:r.ahaBTitle,body:r.ahaBBody(S.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:S.id}),a()}}:j={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:wt};if(!h&&c){const N=c.bottom+14,C=window.innerHeight-N>190?N:Math.max(12,c.top-200);w={left:Math.min(Math.max(12,c.left+c.width/2-wt/2),window.innerWidth-wt-12),top:C,width:wt}}return tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!h&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-yt,top:c.top-yt,width:c.width+yt*2,height:c.height+yt*2}}),(h||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(h?" fin":""),style:w,children:[h&&j?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:j.title}),t.jsx("p",{children:t.jsx(Qa,{text:j.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>u(f.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:j.go,children:j.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(p+1,f.length)}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx("p",{children:t.jsx(Qa,{text:(b==null?void 0:b.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>u(N=>Math.max(0,N-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>u(N=>N+1),children:p===f.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function si(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,dispatch:l}=q(),s=r?a:e,p=g.useMemo(()=>s.filter(m=>et(m.date)===0&&m.kind==="target"),[s]),u=g.useMemo(()=>r?a.filter(m=>ke(m)===0).slice().sort((m,y)=>(y.date||"").localeCompare(m.date||"")):[],[a,r]),c=g.useMemo(()=>p.filter(m=>r?ke(m)===0:!Ne(m)),[p,r]),d=r?u:c,f=r?a.length-u.length:p.length-c.length,v=r?a.length:p.length,x=v?Math.min(100,f/v*100):100;let b;r?b=o.morningThesis(p.length,u.length):p.length?f===0?b=o.goalSourced(p.length):f>=p.length?b=o.goalCleared:b=o.goalDone(f,p.length):b=o.goalSourced(0);const h=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&u.length&&l({type:"chainStart",queue:u.map(m=>m.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:x+"%"}})}),d.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:h,children:r?o.morningEval(d.length):i.pileMode?o.goalContinue(d.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function li(){var k,T;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:s,mode:p,doSync:u,startTour:c}=q(),[d,f]=g.useState(null),[v,x]=g.useState([]),b=p==="client";g.useEffect(()=>{if(!o||!i)return;let A=!0;return(async()=>{const[M,O]=await Promise.all([wa(i),zn(o)]);A&&(M&&f(M),x(O))})(),()=>{A=!1}},[o,i]);const h=(d==null?void 0:d.per_day)??null,m=((k=d==null?void 0:d.pool_order)==null?void 0:k.length)??0,y=v.filter(A=>A.status==="running").length,j=g.useMemo(()=>s.filter(A=>A.kind==="target"&&Ne(A)).length,[s]),w=l.marketEstimate,N=typeof((T=l.stats)==null?void 0:T.screened)=="number"?l.stats.screened:j,S=w&&w>0?Math.min(100,Math.round(N/w*100)):null,C=A=>A.toLocaleString(a==="en"?"en-US":"fr-FR"),R=(i||"P").split(/\s+/).map(A=>A[0]).join("").slice(0,2).toUpperCase(),F=(()=>{const A=Date.parse(l.generatedAt||"");if(Number.isNaN(A))return"";const M=new Date(A),O=E=>String(E).padStart(2,"0");return`${O(M.getDate())}/${O(M.getMonth()+1)} à ${O(M.getHours())}:${O(M.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:R}),t.jsx("i",{children:i})]}),t.jsx("h1",{children:e.identTitle(i||"…")}),t.jsx("span",{className:"idsp"}),F&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(F)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[S===null&&N>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:C(N)})})]}),S!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:S+"%"}})}),t.jsxs("b",{children:[S," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(N,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),h!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:h})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),h===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(m)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:A=>{A.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:u,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:A=>n({type:"filters",patch:{search:A.target.value}})})]})]})]})}function ci(){const{t:e,counts:a,dispatch:r}=q();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,o],i)=>{const l=i===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:i+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:o}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},i)})})]})}const di=["--p0","--p1","--p2","--p3","--p4"];function pi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o}=q(),i=g.useRef({});g.useEffect(()=>{i.current={...r}},[r]);const l=u=>{const c=i.current[u],d=c!==void 0?r[u]-c:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${di[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(d>0?" up":d<0?" down":""),children:[r[u],d!==0&&t.jsxs("em",{className:"delta",children:[d>0?"+":"−",Math.abs(d)]})]})]},u)},s=(u,c,d)=>t.jsxs("button",{type:"button",className:"off"+(c?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:d.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),p=(u,c,d,f=!1)=>t.jsx("button",{type:"button",className:"tool",title:c,disabled:f,onClick:d,children:u},c);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,o,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const ui=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function fi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=q(),s=g.useRef(null),[p,u]=g.useState(60);g.useEffect(()=>{let v=0;const x=()=>{var j;const b=s.current;if(!b)return;const h=(j=b.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!h)return;const m=h.getBoundingClientRect(),y=b.getBoundingClientRect();u(Math.max(20,Math.min(m.left+m.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(x),window.addEventListener("resize",x),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",x)}},[e.ptab]);const c=e.ptab;let d=r.tuto[c].p;if(c===3){const v=n.filter(h=>h.kind==="target"&&ke(h)===3),x=v.filter(h=>Zt(h)==="auto").length,b=v.filter(h=>Zt(h)==="cd").length;d=r.tutoPending(x,b,v.length)}const f=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(v=>v.id)})};if(c===1){const v=n.filter(x=>x.kind==="target"&&ke(x)===1&&!o.has(x.id)).slice(0,10);if(v.length)return{label:r.tuto[1].a,run:()=>v.forEach(x=>i(x))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":ui[c],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:d}})]})}),f&&t.jsx("button",{type:"button",className:"tprim",onClick:f.run,children:f.label})]})}class Ye{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,s=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*mi(e){for(const a of e)yield*a}function Dn(e){return Array.from(mi(e))}var Z=1e-6,V=Math.PI,Ce=V/2,Xa=V/4,ze=V*2,Fe=180/V,je=V/180,te=Math.abs,xi=Math.atan,ft=Math.atan2,ie=Math.cos,se=Math.sin,hi=Math.sign||function(e){return e>0?1:e<0?-1:0},Ge=Math.sqrt;function gi(e){return e>1?0:e<-1?V:Math.acos(e)}function mt(e){return e>1?Ce:e<-1?-Ce:Math.asin(e)}function Ee(){}function Tt(e,a){e&&Za.hasOwnProperty(e.type)&&Za[e.type](e,a)}var Ja={Feature:function(e,a){Tt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Tt(r[n].geometry,a)}},Za={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){na(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)na(r[n],a,0)},Polygon:function(e,a){en(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)en(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Tt(r[n],a)}};function na(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function en(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)na(e[r],a,1);a.polygonEnd()}function Ke(e,a){e&&Ja.hasOwnProperty(e.type)?Ja[e.type](e,a):Tt(e,a)}function ra(e){return[ft(e[1],e[0]),mt(e[2])]}function Je(e){var a=e[0],r=e[1],n=ie(r);return[n*ie(a),n*se(a),se(r)]}function kt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Lt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Wt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function jt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function oa(e){var a=Ge(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ia(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function sa(e,a){return te(e)>V&&(e-=Math.round(e/ze)*ze),[e,a]}sa.invert=sa;function bi(e,a,r){return(e%=ze)?a||r?ia(an(e),nn(a,r)):an(e):a||r?nn(a,r):sa}function tn(e){return function(a,r){return a+=e,te(a)>V&&(a-=Math.round(a/ze)*ze),[a,r]}}function an(e){var a=tn(e);return a.invert=tn(-e),a}function nn(e,a){var r=ie(e),n=se(e),o=ie(a),i=se(a);function l(s,p){var u=ie(p),c=ie(s)*u,d=se(s)*u,f=se(p),v=f*r+c*n;return[ft(d*o-v*i,c*r-f*n),mt(v*o+d*i)]}return l.invert=function(s,p){var u=ie(p),c=ie(s)*u,d=se(s)*u,f=se(p),v=f*o-d*i;return[ft(d*o+f*i,c*r+v*n),mt(v*r-c*n)]},l}function vi(e,a,r,n,o,i){if(r){var l=ie(a),s=se(a),p=n*r;o==null?(o=a+n*ze,i=a-p/2):(o=rn(l,o),i=rn(l,i),(n>0?o<i:o>i)&&(o+=n*ze));for(var u,c=o;n>0?c>i:c<i;c-=p)u=ra([l,-s*ie(c),-s*se(c)]),e.point(u[0],u[1])}}function rn(e,a){a=Je(a),a[0]-=e,oa(a);var r=gi(-a[1]);return((-a[2]<0?-r:r)+ze-Z)%ze}function In(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:Ee,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function At(e,a){return te(e[0]-a[0])<Z&&te(e[1]-a[1])<Z}function Nt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Bn(e,a,r,n,o){var i=[],l=[],s,p;if(e.forEach(function(x){if(!((b=x.length-1)<=0)){var b,h=x[0],m=x[b],y;if(At(h,m)){if(!h[2]&&!m[2]){for(o.lineStart(),s=0;s<b;++s)o.point((h=x[s])[0],h[1]);o.lineEnd();return}m[0]+=2*Z}i.push(y=new Nt(h,x,null,!0)),l.push(y.o=new Nt(h,null,y,!1)),i.push(y=new Nt(m,x,null,!1)),l.push(y.o=new Nt(m,null,y,!0))}}),!!i.length){for(l.sort(a),on(i),on(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var u=i[0],c,d;;){for(var f=u,v=!0;f.v;)if((f=f.n)===u)return;c=f.z,o.lineStart();do{if(f.v=f.o.v=!0,f.e){if(v)for(s=0,p=c.length;s<p;++s)o.point((d=c[s])[0],d[1]);else n(f.x,f.n.x,1,o);f=f.n}else{if(v)for(c=f.p.z,s=c.length-1;s>=0;--s)o.point((d=c[s])[0],d[1]);else n(f.x,f.p.x,-1,o);f=f.p}f=f.o,c=f.z,v=!v}while(!f.v);o.lineEnd()}}}function on(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Gt(e){return te(e[0])<=V?e[0]:hi(e[0])*((te(e[0])+V)%ze-V)}function yi(e,a){var r=Gt(a),n=a[1],o=se(n),i=[se(r),-ie(r),0],l=0,s=0,p=new Ye;o===1?n=Ce+Z:o===-1&&(n=-Ce-Z);for(var u=0,c=e.length;u<c;++u)if(f=(d=e[u]).length)for(var d,f,v=d[f-1],x=Gt(v),b=v[1]/2+Xa,h=se(b),m=ie(b),y=0;y<f;++y,x=w,h=S,m=C,v=j){var j=d[y],w=Gt(j),N=j[1]/2+Xa,S=se(N),C=ie(N),R=w-x,F=R>=0?1:-1,k=F*R,T=k>V,A=h*S;if(p.add(ft(A*F*se(k),m*C+A*ie(k))),l+=T?R+F*ze:R,T^x>=r^w>=r){var M=Lt(Je(v),Je(j));oa(M);var O=Lt(i,M);oa(O);var E=(T^R>=0?-1:1)*mt(O[2]);(n>E||n===E&&(M[0]||M[1]))&&(s+=T^R>=0?1:-1)}}return(l<-Z||l<Z&&p<-1e-12)^s&1}function $n(e,a,r,n){return function(o){var i=a(o),l=In(),s=a(l),p=!1,u,c,d,f={point:v,lineStart:b,lineEnd:h,polygonStart:function(){f.point=m,f.lineStart=y,f.lineEnd=j,c=[],u=[]},polygonEnd:function(){f.point=v,f.lineStart=b,f.lineEnd=h,c=Dn(c);var w=yi(u,n);c.length?(p||(o.polygonStart(),p=!0),Bn(c,ki,w,r,o)):w&&(p||(o.polygonStart(),p=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),p&&(o.polygonEnd(),p=!1),c=u=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function v(w,N){e(w,N)&&o.point(w,N)}function x(w,N){i.point(w,N)}function b(){f.point=x,i.lineStart()}function h(){f.point=v,i.lineEnd()}function m(w,N){d.push([w,N]),s.point(w,N)}function y(){s.lineStart(),d=[]}function j(){m(d[0][0],d[0][1]),s.lineEnd();var w=s.clean(),N=l.result(),S,C=N.length,R,F,k;if(d.pop(),u.push(d),d=null,!!C){if(w&1){if(F=N[0],(R=F.length-1)>0){for(p||(o.polygonStart(),p=!0),o.lineStart(),S=0;S<R;++S)o.point((k=F[S])[0],k[1]);o.lineEnd()}return}C>1&&w&2&&N.push(N.pop().concat(N.shift())),c.push(N.filter(wi))}}return f}}function wi(e){return e.length>1}function ki(e,a){return((e=e.x)[0]<0?e[1]-Ce-Z:Ce-e[1])-((a=a.x)[0]<0?a[1]-Ce-Z:Ce-a[1])}const sn=$n(function(){return!0},ji,Si,[-V,-Ce]);function ji(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var s=i>0?V:-V,p=te(i-a);te(p-V)<Z?(e.point(a,r=(r+l)/2>0?Ce:-Ce),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&p>=V&&(te(a-n)<Z&&(a-=n*Z),te(i-s)<Z&&(i-=s*Z),r=Ni(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Ni(e,a,r,n){var o,i,l=se(e-r);return te(l)>Z?xi((se(a)*(i=ie(n))*se(r)-se(n)*(o=ie(a))*se(e))/(o*i*l)):(a+n)/2}function Si(e,a,r,n){var o;if(e==null)o=r*Ce,n.point(-V,o),n.point(0,o),n.point(V,o),n.point(V,0),n.point(V,-o),n.point(0,-o),n.point(-V,-o),n.point(-V,0),n.point(-V,o);else if(te(e[0]-a[0])>Z){var i=e[0]<a[0]?V:-V;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Ci(e){var a=ie(e),r=2*je,n=a>0,o=te(a)>Z;function i(c,d,f,v){vi(v,e,r,f,c,d)}function l(c,d){return ie(c)*ie(d)>a}function s(c){var d,f,v,x,b;return{lineStart:function(){x=v=!1,b=1},point:function(h,m){var y=[h,m],j,w=l(h,m),N=n?w?0:u(h,m):w?u(h+(h<0?V:-V),m):0;if(!d&&(x=v=w)&&c.lineStart(),w!==v&&(j=p(d,y),(!j||At(d,j)||At(y,j))&&(y[2]=1)),w!==v)b=0,w?(c.lineStart(),j=p(y,d),c.point(j[0],j[1])):(j=p(d,y),c.point(j[0],j[1],2),c.lineEnd()),d=j;else if(o&&d&&n^w){var S;!(N&f)&&(S=p(y,d,!0))&&(b=0,n?(c.lineStart(),c.point(S[0][0],S[0][1]),c.point(S[1][0],S[1][1]),c.lineEnd()):(c.point(S[1][0],S[1][1]),c.lineEnd(),c.lineStart(),c.point(S[0][0],S[0][1],3)))}w&&(!d||!At(d,y))&&c.point(y[0],y[1]),d=y,v=w,f=N},lineEnd:function(){v&&c.lineEnd(),d=null},clean:function(){return b|(x&&v)<<1}}}function p(c,d,f){var v=Je(c),x=Je(d),b=[1,0,0],h=Lt(v,x),m=kt(h,h),y=h[0],j=m-y*y;if(!j)return!f&&c;var w=a*m/j,N=-a*y/j,S=Lt(b,h),C=jt(b,w),R=jt(h,N);Wt(C,R);var F=S,k=kt(C,F),T=kt(F,F),A=k*k-T*(kt(C,C)-1);if(!(A<0)){var M=Ge(A),O=jt(F,(-k-M)/T);if(Wt(O,C),O=ra(O),!f)return O;var E=c[0],L=d[0],$=c[1],K=d[1],X;L<E&&(X=E,E=L,L=X);var pe=L-E,le=te(pe-V)<Z,U=le||pe<Z;if(!le&&K<$&&(X=$,$=K,K=X),U?le?$+K>0^O[1]<(te(O[0]-E)<Z?$:K):$<=O[1]&&O[1]<=K:pe>V^(E<=O[0]&&O[0]<=L)){var W=jt(F,(-k+M)/T);return Wt(W,C),[O,ra(W)]}}}function u(c,d){var f=n?e:V-e,v=0;return c<-f?v|=1:c>f&&(v|=2),d<-f?v|=4:d>f&&(v|=8),v}return $n(l,s,i,n?[0,-e]:[-V,e-V])}function Ei(e,a,r,n,o,i){var l=e[0],s=e[1],p=a[0],u=a[1],c=0,d=1,f=p-l,v=u-s,x;if(x=r-l,!(!f&&x>0)){if(x/=f,f<0){if(x<c)return;x<d&&(d=x)}else if(f>0){if(x>d)return;x>c&&(c=x)}if(x=o-l,!(!f&&x<0)){if(x/=f,f<0){if(x>d)return;x>c&&(c=x)}else if(f>0){if(x<c)return;x<d&&(d=x)}if(x=n-s,!(!v&&x>0)){if(x/=v,v<0){if(x<c)return;x<d&&(d=x)}else if(v>0){if(x>d)return;x>c&&(c=x)}if(x=i-s,!(!v&&x<0)){if(x/=v,v<0){if(x>d)return;x>c&&(c=x)}else if(v>0){if(x<c)return;x<d&&(d=x)}return c>0&&(e[0]=l+c*f,e[1]=s+c*v),d<1&&(a[0]=l+d*f,a[1]=s+d*v),!0}}}}}var st=1e9,St=-st;function zi(e,a,r,n){function o(u,c){return e<=u&&u<=r&&a<=c&&c<=n}function i(u,c,d,f){var v=0,x=0;if(u==null||(v=l(u,d))!==(x=l(c,d))||p(u,c)<0^d>0)do f.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+d+4)%4)!==x);else f.point(c[0],c[1])}function l(u,c){return te(u[0]-e)<Z?c>0?0:3:te(u[0]-r)<Z?c>0?2:1:te(u[1]-a)<Z?c>0?1:0:c>0?3:2}function s(u,c){return p(u.x,c.x)}function p(u,c){var d=l(u,1),f=l(c,1);return d!==f?d-f:d===0?c[1]-u[1]:d===1?u[0]-c[0]:d===2?u[1]-c[1]:c[0]-u[0]}return function(u){var c=u,d=In(),f,v,x,b,h,m,y,j,w,N,S,C={point:R,lineStart:A,lineEnd:M,polygonStart:k,polygonEnd:T};function R(E,L){o(E,L)&&c.point(E,L)}function F(){for(var E=0,L=0,$=v.length;L<$;++L)for(var K=v[L],X=1,pe=K.length,le=K[0],U,W,H=le[0],_=le[1];X<pe;++X)U=H,W=_,le=K[X],H=le[0],_=le[1],W<=n?_>n&&(H-U)*(n-W)>(_-W)*(e-U)&&++E:_<=n&&(H-U)*(n-W)<(_-W)*(e-U)&&--E;return E}function k(){c=d,f=[],v=[],S=!0}function T(){var E=F(),L=S&&E,$=(f=Dn(f)).length;(L||$)&&(u.polygonStart(),L&&(u.lineStart(),i(null,null,1,u),u.lineEnd()),$&&Bn(f,s,E,i,u),u.polygonEnd()),c=u,f=v=x=null}function A(){C.point=O,v&&v.push(x=[]),N=!0,w=!1,y=j=NaN}function M(){f&&(O(b,h),m&&w&&d.rejoin(),f.push(d.result())),C.point=R,w&&c.lineEnd()}function O(E,L){var $=o(E,L);if(v&&x.push([E,L]),N)b=E,h=L,m=$,N=!1,$&&(c.lineStart(),c.point(E,L));else if($&&w)c.point(E,L);else{var K=[y=Math.max(St,Math.min(st,y)),j=Math.max(St,Math.min(st,j))],X=[E=Math.max(St,Math.min(st,E)),L=Math.max(St,Math.min(st,L))];Ei(K,X,e,a,r,n)?(w||(c.lineStart(),c.point(K[0],K[1])),c.point(X[0],X[1]),$||c.lineEnd(),S=!1):$&&(c.lineStart(),c.point(E,L),S=!1)}y=E,j=L,w=$}return C}}const la=e=>e;var Kt=new Ye,ca=new Ye,_n,Un,da,pa,Pe={point:Ee,lineStart:Ee,lineEnd:Ee,polygonStart:function(){Pe.lineStart=Ai,Pe.lineEnd=Li},polygonEnd:function(){Pe.lineStart=Pe.lineEnd=Pe.point=Ee,Kt.add(te(ca)),ca=new Ye},result:function(){var e=Kt/2;return Kt=new Ye,e}};function Ai(){Pe.point=Ti}function Ti(e,a){Pe.point=Vn,_n=da=e,Un=pa=a}function Vn(e,a){ca.add(pa*e-da*a),da=e,pa=a}function Li(){Vn(_n,Un)}var Ze=1/0,Rt=Ze,xt=-Ze,Ot=xt,Mt={point:Ri,lineStart:Ee,lineEnd:Ee,polygonStart:Ee,polygonEnd:Ee,result:function(){var e=[[Ze,Rt],[xt,Ot]];return xt=Ot=-(Rt=Ze=1/0),e}};function Ri(e,a){e<Ze&&(Ze=e),e>xt&&(xt=e),a<Rt&&(Rt=a),a>Ot&&(Ot=a)}var ua=0,fa=0,lt=0,qt=0,Ft=0,Qe=0,ma=0,xa=0,ct=0,Hn,Yn,Le,Re,Se={point:We,lineStart:ln,lineEnd:cn,polygonStart:function(){Se.lineStart=qi,Se.lineEnd=Fi},polygonEnd:function(){Se.point=We,Se.lineStart=ln,Se.lineEnd=cn},result:function(){var e=ct?[ma/ct,xa/ct]:Qe?[qt/Qe,Ft/Qe]:lt?[ua/lt,fa/lt]:[NaN,NaN];return ua=fa=lt=qt=Ft=Qe=ma=xa=ct=0,e}};function We(e,a){ua+=e,fa+=a,++lt}function ln(){Se.point=Oi}function Oi(e,a){Se.point=Mi,We(Le=e,Re=a)}function Mi(e,a){var r=e-Le,n=a-Re,o=Ge(r*r+n*n);qt+=o*(Le+e)/2,Ft+=o*(Re+a)/2,Qe+=o,We(Le=e,Re=a)}function cn(){Se.point=We}function qi(){Se.point=Pi}function Fi(){Wn(Hn,Yn)}function Pi(e,a){Se.point=Wn,We(Hn=Le=e,Yn=Re=a)}function Wn(e,a){var r=e-Le,n=a-Re,o=Ge(r*r+n*n);qt+=o*(Le+e)/2,Ft+=o*(Re+a)/2,Qe+=o,o=Re*e-Le*a,ma+=o*(Le+e),xa+=o*(Re+a),ct+=o*3,We(Le=e,Re=a)}function Gn(e){this._context=e}Gn.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,ze);break}}},result:Ee};var ha=new Ye,Qt,Kn,Qn,dt,pt,ht={point:Ee,lineStart:function(){ht.point=Di},lineEnd:function(){Qt&&Xn(Kn,Qn),ht.point=Ee},polygonStart:function(){Qt=!0},polygonEnd:function(){Qt=null},result:function(){var e=+ha;return ha=new Ye,e}};function Di(e,a){ht.point=Xn,Kn=dt=e,Qn=pt=a}function Xn(e,a){dt-=e,pt-=a,ha.add(Ge(dt*dt+pt*pt)),dt=e,pt=a}let dn,Pt,pn,un;class fn{constructor(a){this._append=a==null?Jn:Ii(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==pn||this._append!==Pt){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,pn=n,Pt=this._append,un=this._,this._=o}this._+=un;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Jn(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ii(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Jn;if(a!==dn){const r=10**a;dn=a,Pt=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Pt}function Bi(e,a){let r=3,n=4.5,o,i;function l(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Ke(s,o(i))),i.result()}return l.area=function(s){return Ke(s,o(Pe)),Pe.result()},l.measure=function(s){return Ke(s,o(ht)),ht.result()},l.bounds=function(s){return Ke(s,o(Mt)),Mt.result()},l.centroid=function(s){return Ke(s,o(Se)),Se.result()},l.projection=function(s){return arguments.length?(o=s==null?(e=null,la):(e=s).stream,l):e},l.context=function(s){return arguments.length?(i=s==null?(a=null,new fn(r)):new Gn(a=s),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(i=new fn(r)),l},l.projection(e).digits(r).context(a)}function Ca(e){return function(a){var r=new ga;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ga(){}ga.prototype={constructor:ga,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ea(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Ke(r,e.stream(Mt)),a(Mt.result()),n!=null&&e.clipExtent(n),e}function Zn(e,a,r){return Ea(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function $i(e,a,r){return Zn(e,[[0,0],a],r)}function _i(e,a,r){return Ea(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([l,s])},r)}function Ui(e,a,r){return Ea(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,s])},r)}var mn=16,Vi=ie(30*je);function xn(e,a){return+a?Yi(e,a):Hi(e)}function Hi(e){return Ca({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Yi(e,a){function r(n,o,i,l,s,p,u,c,d,f,v,x,b,h){var m=u-n,y=c-o,j=m*m+y*y;if(j>4*a&&b--){var w=l+f,N=s+v,S=p+x,C=Ge(w*w+N*N+S*S),R=mt(S/=C),F=te(te(S)-1)<Z||te(i-d)<Z?(i+d)/2:ft(N,w),k=e(F,R),T=k[0],A=k[1],M=T-n,O=A-o,E=y*M-m*O;(E*E/j>a||te((m*M+y*O)/j-.5)>.3||l*f+s*v+p*x<Vi)&&(r(n,o,i,l,s,p,T,A,F,w/=C,N/=C,S,b,h),h.point(T,A),r(T,A,F,w,N,S,u,c,d,f,v,x,b,h))}}return function(n){var o,i,l,s,p,u,c,d,f,v,x,b,h={point:m,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),h.lineStart=N},polygonEnd:function(){n.polygonEnd(),h.lineStart=y}};function m(R,F){R=e(R,F),n.point(R[0],R[1])}function y(){d=NaN,h.point=j,n.lineStart()}function j(R,F){var k=Je([R,F]),T=e(R,F);r(d,f,c,v,x,b,d=T[0],f=T[1],c=R,v=k[0],x=k[1],b=k[2],mn,n),n.point(d,f)}function w(){h.point=m,n.lineEnd()}function N(){y(),h.point=S,h.lineEnd=C}function S(R,F){j(o=R,F),i=d,l=f,s=v,p=x,u=b,h.point=j}function C(){r(d,f,c,v,x,b,i,l,o,s,p,u,mn,n),h.lineEnd=w,w()}return h}}var Wi=Ca({point:function(e,a){this.stream.point(e*je,a*je)}});function Gi(e){return Ca({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ki(e,a,r,n,o){function i(l,s){return l*=n,s*=o,[a+e*l,r-e*s]}return i.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*o]},i}function hn(e,a,r,n,o,i){if(!i)return Ki(e,a,r,n,o);var l=ie(i),s=se(i),p=l*e,u=s*e,c=l/e,d=s/e,f=(s*r-l*a)/e,v=(s*a+l*r)/e;function x(b,h){return b*=n,h*=o,[p*b-u*h+a,r-u*b-p*h]}return x.invert=function(b,h){return[n*(c*b-d*h+f),o*(v-d*b-c*h)]},x}function Qi(e){return Xi(function(){return e})()}function Xi(e){var a,r=150,n=480,o=250,i=0,l=0,s=0,p=0,u=0,c,d=0,f=1,v=1,x=null,b=sn,h=null,m,y,j,w=la,N=.5,S,C,R,F,k;function T(E){return R(E[0]*je,E[1]*je)}function A(E){return E=R.invert(E[0],E[1]),E&&[E[0]*Fe,E[1]*Fe]}T.stream=function(E){return F&&k===E?F:F=Wi(Gi(c)(b(S(w(k=E)))))},T.preclip=function(E){return arguments.length?(b=E,x=void 0,O()):b},T.postclip=function(E){return arguments.length?(w=E,h=m=y=j=null,O()):w},T.clipAngle=function(E){return arguments.length?(b=+E?Ci(x=E*je):(x=null,sn),O()):x*Fe},T.clipExtent=function(E){return arguments.length?(w=E==null?(h=m=y=j=null,la):zi(h=+E[0][0],m=+E[0][1],y=+E[1][0],j=+E[1][1]),O()):h==null?null:[[h,m],[y,j]]},T.scale=function(E){return arguments.length?(r=+E,M()):r},T.translate=function(E){return arguments.length?(n=+E[0],o=+E[1],M()):[n,o]},T.center=function(E){return arguments.length?(i=E[0]%360*je,l=E[1]%360*je,M()):[i*Fe,l*Fe]},T.rotate=function(E){return arguments.length?(s=E[0]%360*je,p=E[1]%360*je,u=E.length>2?E[2]%360*je:0,M()):[s*Fe,p*Fe,u*Fe]},T.angle=function(E){return arguments.length?(d=E%360*je,M()):d*Fe},T.reflectX=function(E){return arguments.length?(f=E?-1:1,M()):f<0},T.reflectY=function(E){return arguments.length?(v=E?-1:1,M()):v<0},T.precision=function(E){return arguments.length?(S=xn(C,N=E*E),O()):Ge(N)},T.fitExtent=function(E,L){return Zn(T,E,L)},T.fitSize=function(E,L){return $i(T,E,L)},T.fitWidth=function(E,L){return _i(T,E,L)},T.fitHeight=function(E,L){return Ui(T,E,L)};function M(){var E=hn(r,0,0,f,v,d).apply(null,a(i,l)),L=hn(r,n-E[0],o-E[1],f,v,d);return c=bi(s,p,u),C=ia(a,L),R=ia(c,C),S=xn(C,N),O()}function O(){return F=k=null,T}return function(){return a=e.apply(this,arguments),T.invert=a.invert&&A,M()}}function er(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}er.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(te(o)>Z&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Ji(){return Qi(er).scale(175.295)}function Zi(e){return e}function es(e){if(e==null)return Zi;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var u=2,c=s.length,d=new Array(c);for(d[0]=(a+=s[0])*n+i,d[1]=(r+=s[1])*o+l;u<c;)d[u]=s[u],++u;return d}}function ts(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function as(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return gn(e,r)})}:gn(e,a)}function gn(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=ns(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function ns(e,a){var r=es(e.transform),n=e.arcs;function o(c,d){d.length&&d.pop();for(var f=n[c<0?~c:c],v=0,x=f.length;v<x;++v)d.push(r(f[v],v));c<0&&ts(d,x)}function i(c){return r(c)}function l(c){for(var d=[],f=0,v=c.length;f<v;++f)o(c[f],d);return d.length<2&&d.push(d[0]),d}function s(c){for(var d=l(c);d.length<4;)d.push(d[0]);return d}function p(c){return c.map(s)}function u(c){var d=c.type,f;switch(d){case"GeometryCollection":return{type:d,geometries:c.geometries.map(u)};case"Point":f=i(c.coordinates);break;case"MultiPoint":f=c.coordinates.map(i);break;case"LineString":f=l(c.arcs);break;case"MultiLineString":f=c.arcs.map(l);break;case"Polygon":f=p(c.arcs);break;case"MultiPolygon":f=c.arcs.map(p);break;default:return null}return{type:d,coordinates:f}}return u(a)}let Ct=null;function rs(){return Ct||(Ct=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=as(r,n),i=Ji().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Bi(i),s=(o.features||[]).filter(u=>{var c;return(((c=u.properties)==null?void 0:c.name)||"")!=="Antarctica"}).map(u=>{var f;const c=((f=u.properties)==null?void 0:f.name)||"",d=l(u)||"";return d?{i2:Ir(c)||null,n:c,d}:null}).filter(u=>!!u);if(!s.length)return null;const p={};for(const[u,c]of Object.entries(Br)){const d=i(c);d&&(p[u]={x:d[0],y:d[1]})}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p}}catch{return null}})(),Ct)}function os(e){const[a,r]=g.useState(null);return g.useEffect(()=>{if(!e||a)return;let n=!1;return rs().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const bn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Et(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function is(e,a){const[r,n]=g.useState(1);return g.useEffect(()=>{let o=!0,i=0;const l=()=>{var u;if(!o)return;const p=(u=e.current)==null?void 0:u.getScreenCTM();p&&p.a>0?n(p.a):i=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function ss(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:s,t:p}=q(),u=g.useRef(null),c=g.useRef(null),d=os(e.continent==="monde"),f=e.continent==="monde"?d:ka.find(k=>k.key===e.continent)||null,v=is(u,e.continent+":"+e.mapFolded+":"+!!f),[x,b]=g.useState(new Map),[h,m]=g.useState(null);g.useEffect(()=>{const k=u.current;if(!k)return;const T=new Map;k.querySelectorAll("path[data-i2]").forEach(A=>{const M=A.dataset.i2;if(M)try{const O=A.getBBox();O.width>0&&T.set(M,{x:O.x,y:O.y,w:O.width,h:O.height})}catch{}}),b(T)},[e.continent,v,f]);const y=g.useMemo(()=>r.filter(k=>k.cc),[r]),j=g.useMemo(()=>{const k=new Map;return y.forEach(T=>k.set(T.cc,(k.get(T.cc)||0)+1)),k},[y]),w=e.continent==="monde"&&d?d.anchors:null,N=g.useMemo(()=>y.map(k=>{const T=w&&k.cc?w[k.cc]:void 0;if(T){const $=Et(k.name||k.id||""),K=Et((k.id||k.name||"")+"·y");return{d:k,x:T.x+($-.5)*10,y:T.y+(K-.5)*10}}const A=k.cc?x.get(k.cc):void 0;if(!A)return null;const M=Et(k.name||k.id||""),O=Et((k.id||k.name||"")+"·y"),E=(M-.5)*Math.min(A.w*.55,60),L=(O-.5)*Math.min(A.h*.55,60);return{d:k,x:A.x+A.w/2+E,y:A.y+A.h/2+L}}).filter(k=>!!k),[y,x,w]),S=k=>v>0?k/v:k,C=g.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:bn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(T=>T.kind==="target"&&ke(T)===k).length})).filter(k=>k.n>0):Pa.map((k,T)=>({...k,n:r.filter(A=>Da(A)===T).length})),[r,n,p.plabels]),R=i?l.get(i):null,F=R?N.find(k=>k.d.id===R.id):null;return f?t.jsxs("div",{className:"mapzone",ref:c,children:[t.jsxs("svg",{ref:u,viewBox:f.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?f.fr:f.en,onMouseLeave:()=>{m(null),o(null)},children:[t.jsx("g",{children:f.countries.map((k,T)=>t.jsx("g",{className:"ct"+(k.i2&&j.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},T))}),t.jsx("g",{children:N.map(k=>{const T=Pa[Da(k.d)],A=!!xe(k.d),M=k.d.kind==="target",O=n&&M?bn[ke(k.d)]:T.c,E=!n&&Ne(k.d);return t.jsxs("g",{className:"co"+(E?" done":""),onMouseEnter:()=>{var K,X;const L=(K=c.current)==null?void 0:K.getBoundingClientRect(),$=(X=u.current)==null?void 0:X.createSVGPoint();if($&&u.current&&L){$.x=k.x,$.y=k.y;const pe=$.matrixTransform(u.current.getScreenCTM());m({x:pe.x-L.left,y:pe.y-L.top,label:k.d.name+" · "+(nt(k.d.cc,s)||k.d.countryLabel||"")})}o(k.d.id)},onMouseLeave:()=>{m(null),o(null)},onClick:()=>{var K;const L=(K=u.current)==null?void 0:K.createSVGPoint();let $=null;if(L&&u.current){L.x=k.x,L.y=k.y;const X=L.matrixTransform(u.current.getScreenCTM());$={x:X.x,y:X.y}}a({type:"popup",id:k.d.id,anchor:$})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:S(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:S(T.px),fill:O,stroke:A?"#DC2626":"#ffffff",strokeWidth:S(A?2.2:1.3)})]},k.d.id||k.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:S(13),fill:"none",stroke:"#0F172A",strokeWidth:S(2)})]}),t.jsx("div",{className:"hov"+(h?" on":""),style:h?{left:h.x,top:h.y}:void 0,children:h==null?void 0:h.label}),t.jsx("div",{className:"legend",children:C.map((k,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},T))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:c})}function ls(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function cs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:o,contName:i,lang:l}=q(),s=e.filters,p=g.useMemo(()=>e.continent==="monde"?r:r.filter(x=>x.continent===e.continent),[r,e.continent]),u=x=>p.filter(b=>x!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Na(b,s,o,x==="country"?void 0:x)),c=g.useMemo(()=>{const x=u("win"),b=h=>x.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=h).length;return[b(0),b(7),b(30),x.length]},[p,s,o]),d=g.useMemo(()=>s.day?u("win").filter(x=>(x.date||"").slice(0,10)===s.day).length:0,[p,s,o]),f=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),v=(x,b,h,m="fbtn")=>t.jsxs("button",{type:"button",className:m,"aria-expanded":e.openFacet===x,onClick:()=>a({type:"openFacet",facet:x}),children:[t.jsx("span",{className:"fl",children:b}),h>0&&t.jsx("span",{className:"n",children:h}),t.jsx("span",{className:"cv",children:"▾"})]},x);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(ls(s.day,l)),t.jsx("b",{children:d})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((x,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===x,onClick:()=>a({type:"filters",patch:{win:x}}),children:[n.dates[b],t.jsx("b",{children:c[b]})]},x))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:x=>a({type:"filters",patch:{search:x.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):v("sec",n.fSector,s.sector.length),v("pay",n.fCountry,s.country.length),v("det",n.fEngine,s.engine.length),v("sta",n.fStage,s.stage.length),o&&v("ang","Angle",s.angle.length),o&&v("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),f>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,i),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(f)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(ds,{poolFor:u})]})}function ds({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=q(),i=a.filters,l=a.openFacet,{title:s,cols:p,options:u}=g.useMemo(()=>{if(l==="sig"){const x=e("signal").filter(m=>xe(m)),b=new Map;x.forEach(m=>{const y=m.engine||"";b.set(y,(b.get(y)||0)+1)});const h=[{v:"*",label:n.fpSigAll,n:x.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...ea([...b.keys()],o).map(m=>({v:m,label:Xe(m)+" "+De(m,o),n:b.get(m)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(m)}))];return{title:n.fpSigTitle,cols:2,options:h}}if(l==="sec"){const x=e("sector"),b=new Map;return x.forEach(h=>{h.sector&&b.set(h.sector,(b.get(h.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((h,m)=>m[1]-h[1]).map(([h,m])=>({v:h,label:h,n:m,html:!1,on:i.sector.includes(h)}))}}if(l==="pay"){const x=e("country"),b=new Map;return x.forEach(h=>{h.cc&&b.set(h.cc,(b.get(h.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((h,m)=>m[1]-h[1]).map(([h,m])=>({v:h,label:nt(h,o)||h,n:m,html:!1,on:i.country.includes(h)}))}}if(l==="det"){const x=e("engine"),b=new Map;return x.forEach(h=>{h.engine&&b.set(h.engine,(b.get(h.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ea([...b.keys()],o).map(h=>({v:h,label:Xe(h)+" "+De(h,o)+' <span style="color:var(--dim);font-size:10px">· '+$r(_r(h),o)+"</span>",n:b.get(h)||0,html:!0,on:i.engine.includes(h)}))}}if(l==="ang"){const x=e("angle"),b=new Map;return x.forEach(h=>{h.angle&&b.set(h.angle,(b.get(h.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((h,m)=>m[1]-h[1]).map(([h,m])=>({v:h,label:h.replace(/[_-]+/g," "),n:m,html:!1,on:i.angle.includes(h)}))}}if(l==="mem"){const x=e("memoLevel"),b=new Map;x.forEach(m=>{if(m.kind==="target"){const y=ya(m);b.set(y,(b.get(y)||0)+1)}});const h=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(m=>({v:String(m),label:h[m],n:b.get(m)||0,html:!1,on:i.memoLevel.includes(m)}))}}const f=e("stage"),v=new Map;return f.forEach(x=>{x.stage&&v.set(x.stage,(v.get(x.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((x,b)=>b[1]-x[1]).map(([x,b])=>({v:x,label:x,n:b,html:!1,on:i.stage.includes(x)}))}},[l,a,o]),c=f=>{if(l==="sig"){if(f==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const x=i.signalEngines.includes(f)?i.signalEngines.filter(b=>b!==f):[...i.signalEngines,f];r({type:"filters",patch:{signalOnly:!0,signalEngines:x}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(f)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:f})},d=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:d,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:u.map(f=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":f.on,onClick:()=>c(f.v),children:[t.jsx("span",{className:"bx"}),f.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:f.label}}):t.jsx("span",{className:"l",children:f.label}),t.jsx("span",{className:"n",children:f.n})]},f.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function tr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function ps(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function vn({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:s}=q();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(u=>t.jsx("span",{className:"ch",children:u},u))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function ar({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=q(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(vn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(vn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function us({card:e,onEvaluate:a,onAddAll:r}){var s,p,u;const{t:n}=q(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:tr(e.summary_md||"").map((c,d)=>t.jsx("p",{children:c},d))})]}),t.jsx(ar,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((u=e.prospective)==null?void 0:u.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function fs(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ms({onClose:e,onEvaluate:a,onAddAll:r,bump:n}){const{t:o,token:i,email:l}=q(),[s,p]=g.useState(null),[u,c]=g.useState(null),[d,f]=g.useState(null),[v,x]=g.useState(!1);g.useEffect(()=>{let h=!0;return(async()=>{const m=await An({email:l,cbToken:i});h&&p(m)})(),()=>{h=!1}},[l,i,n]);const b=h=>{c(h),f(null),x(!0),(async()=>{const m=await Ur(h.id);f(m),x(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[u?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{c(null),f(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),u&&t.jsx("span",{className:"ti",children:u.title}),!u&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!u&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(s||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>b(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[fs(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),u&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[u.source_url&&t.jsx("a",{href:u.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),u.published&&u.page_url&&t.jsx("a",{href:u.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(u.published?" on":""),children:u.published?o.rsPub:o.rsPriv})]}),v&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!v&&!d&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!v&&d&&t.jsx(us,{card:d,onEvaluate:a,onAddAll:r})]})]})}const yn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function xs(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:s,evalCards:p,caps:u,data:c,canWrite:d}=q(),f=a==="client",[v,x]=g.useState(""),[b,h]=g.useState(!1),[m,y]=g.useState(""),[j,w]=g.useState(!1),[N,S]=g.useState(""),[C,R]=g.useState([]),F=g.useRef(!1),[k,T]=g.useState(!1),[A,M]=g.useState(""),[O,E]=g.useState(""),[L,$]=g.useState(!1),[K,X]=g.useState(0),[pe,le]=g.useState(""),[U,W]=g.useState(null),[H,_]=g.useState(null),[G,ee]=g.useState(!1),[ne,ge]=g.useState(null),[ue,Y]=g.useState(0),Q=g.useRef(!1),be=v.trim()?yn.test(v.trim())?e.evalUrl:e.evalName:e.evalWaiting,B=g.useMemo(()=>m.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[m]);g.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(M(P),T(!0))},[]),g.useEffect(()=>{const P=J=>{var oe;const ae=String(((oe=J.detail)==null?void 0:oe.url)||"").trim();!ae||!/^https?:\/\//i.test(ae)||(M(ae),T(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),g.useEffect(()=>{if(!d){ge(null);return}let P=!0;return(async()=>{const J=await An({email:n,cbToken:r});P&&ge(J.length)})(),()=>{P=!1}},[d,n,r,ue]);const de=C.length?C:p,re=c.credits,fe=g.useCallback(P=>{const J=P.map(ae=>(ae||"").trim()).filter(Boolean);J.length&&(y(ae=>{const oe=ae.split(`
...
`)}),h(!0))},[]);g.useEffect(()=>{if(!L)return;X(0);const P=window.setInterval(()=>X(J=>J+1),1e3);return()=>window.clearInterval(P)},[L]);const Oe=()=>{const P=v.trim();P&&(o(null,P),x(""))},ve=async()=>{if(!f){o(null,B[0]||"");return}if(!B.length||j)return;w(!0),F.current=!1;const P=[];for(let J=0;J<B.length&&!F.current;J++){S(e.evaluating(J+1,B.length,B[J]));const ae=await Tn(r,B[J],"atelier2");if(P.unshift({name:ae.company||B[J],verdict:ae.verdict,reason:ae.reason||"",remaining:ae.remaining??null}),R([...P]),ae.verdict==="quota"){P.unshift({name:"",verdict:"quota",reason:e.quota(B.length-J-1),remaining:0}),R([...P]),y(B.slice(J+1).join(`
`)),S(""),w(!1);return}}S(""),y(F.current?B.slice(P.length).join(`
`):""),w(!1)},Me=async()=>{var ae;if(Q.current)return;const P=A.trim().replace(/\s+/g,""),J=O.trim();if(!P&&!J){le(e.rsNeed);return}if(!f){o(null,P||J.slice(0,80));return}Q.current=!0,le(""),W(null),_(null),$(!0);try{const oe=await Hr({url:P,text:J,email:n,cbToken:r});if($(!1),!oe||oe.status!=="success"){le((oe==null?void 0:oe.message)||"Erreur");return}W(oe),T(!1),fe((((ae=oe.prospective)==null?void 0:ae.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),_({state:"pending"});const qe=await Yr(oe,{email:n,cbToken:r});_(qe.ok?{state:"ok"}:{state:"fail",msg:qe.error||""}),qe.ok&&Y(Ae=>Ae+1)}finally{Q.current=!1,$(!1)}},Ie=[U==null?void 0:U.industry,...(U==null?void 0:U.market_tags)||[],U==null?void 0:U.author].map(P=>(P||"").trim()).filter(Boolean),ye=(H==null?void 0:H.state)==="pending",Be=H&&(ye?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):H.state==="ok"?t.jsx("span",{className:"rslink ok",children:e.rsSaved}):t.jsx("span",{className:"rslink fail",title:H.msg,children:e.rsSaveFail})),$t=ps(U).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:v,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:P=>x(P.target.value),onKeyDown:P=>{P.key==="Enter"&&Oe()}}),t.jsx("span",{className:"detect"+(yn.test(v.trim())?" url":""),children:be})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:Oe,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),u.showCredits&&re&&t.jsxs("button",{type:"button",className:"credits"+(re.total_available<=0&&!re.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:re.unlimited?"∞":re.total_available}),!re.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",re.daily_grant+re.purchased]}),re.total_available<=0&&!re.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>h(!b),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(k?" on":""),onClick:()=>T(!k),children:e.rsOpen}),ne!==null&&ne>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(G?" on":""),onClick:()=>ee(!G),children:e.rsArchOpen(ne)})]}),G&&t.jsx(ms,{bump:ue,onClose:()=>ee(!1),onEvaluate:P=>o(null,P),onAddAll:fe}),k&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:A,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:P=>M(P.target.value),onKeyDown:P=>{P.key==="Enter"&&Me()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:O,placeholder:e.rsTextPh,onChange:P=>E(P.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(L?" loading":""),style:{justifyContent:"center"},disabled:L||ye||!A.trim()&&!O.trim(),onClick:()=>{Me()},children:[t.jsx("span",{className:"fill"}),L?`${Vr(A.trim())==="youtube"&&A.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(K)}`:ye?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),pe&&t.jsx("div",{className:"rserr",children:pe}),U&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:U.title}),U.source_url&&t.jsx("a",{href:U.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{W(null),_(null)},children:"×"})]}),U.market&&t.jsx("p",{className:"rsmk",children:U.market}),Ie.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Ie.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[U.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${U.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:tr(U.summary_md||"").map((P,J)=>t.jsx("p",{children:P},J))})]}),t.jsx(ar,{card:U,onEvaluate:P=>o(null,P),onAddAll:fe}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound($t)}),Be]})]}),b&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:m,placeholder:e.bulkPh,onChange:P=>y(P.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(j?" loading":""),style:{justifyContent:"center"},disabled:j||!B.length,onClick:()=>{ve()},children:[t.jsx("span",{className:"fill"}),j&&N?N:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(B.length)})]})]}),de.slice(0,1).map((P,J)=>{const ae=P.verdict==="kept",oe=P.verdict==="quota",qe=ae?"var(--brand)":oe?"var(--bolt)":"var(--red)",Ae=ae?"var(--brand-l)":oe?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":qe,"--bgc":Ae},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ae?"✓ "+e.kept:oe?"⏳":"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!oe&&t.jsx("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"space"}),children:e.seeSpace(ae?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),f&&(i.kept+i.dropped>0||de.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function hs(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function gs(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=q(),i=e.memoConsole?r.get(e.memoConsole):null,l=g.useMemo(()=>i?[i.reasoning||"",hs(i.summary||"")].filter(Boolean).join(`
...
`)}`}function Ps(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Ds=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Te({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Is({o:e,qa:a}){const{t:r,lang:n,fund:o}=q(),i=(e.cribleStatus||"").trim().toUpperCase()||(It(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=at(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Te,{k:r.cdSector,v:e.sector}),t.jsx(Te,{k:r.cdStage,v:e.stage}),t.jsx(Te,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Te,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Te,{k:r.cdName,v:e.contactName}),t.jsx(Te,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Te,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Te,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Te,{k:r.cdAngle,v:e.angle}),t.jsx(Te,{k:r.cdDetected,v:Ds(e.date,n)})]}),p.some(([,u])=>u)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,u])=>u).map(([u,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:u}),t.jsx("p",{children:c})]},u))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Bs(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=q(),[s,p]=g.useState({}),u=25,c=g.useMemo(()=>n.slice(0,u),[n]);g.useEffect(()=>{c.length&&Jr(r,c.map(v=>v.name)).then(p)},[r,c]);const d=i.stats,f=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),d&&typeof d.screened=="number"&&t.jsxs("p",{children:[f(d.screened)," ",e.funScreened(""),typeof d.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",f(d.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(f(i.marketEstimate)),", ",Math.round(d.screened/i.marketEstimate*100)," %"]})]})]}),c.map(v=>t.jsx(Is,{o:v,qa:s[v.name]},v.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const $s=50;function Ta({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=q(),[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,c]=g.useState(""),[d,f]=g.useState(0),[v,x]=g.useState(""),[b,h]=g.useState(!1),m=g.useRef(null);g.useEffect(()=>()=>{m.current&&window.clearInterval(m.current)},[]);const y=async w=>{p(!0),c("");const N=await a();if(p(!1),N.ok){l(N);return}if(N.busy){c(o.alertPreviewBusy);return}if(!w){c(o.alertPreviewFail);return}f($s),m.current=window.setInterval(()=>{f(S=>S>1?S-1:(m.current&&window.clearInterval(m.current),y(!1),0))},1e3)},j=async()=>{if(n||b)return;h(!0),x("");const w=await r();h(!1),x(w.ok?o.alertTestOk(w.sentTo||""):w.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||d>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{j()},children:b?"…":o.alertTest})]}),d>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(d)}),u&&t.jsx("p",{className:"mnote warn",children:u}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const ut="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function we({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=q();return tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function _s(){const{st:e}=q();switch(e.modal){case"chain":return t.jsx(Vs,{});case"space":return t.jsx(Hs,{});case"alert":return t.jsx(Ys,{});case"queue":return t.jsx(Xs,{});case"export":return t.jsx(Js,{});case"plug":return t.jsx(tl,{});case"recharge":return t.jsx(nl,{});case"cover":return t.jsx(ol,{});case"dossier":return t.jsx(rl,{});case"crit":return t.jsx(il,{});case"tuto":return t.jsx(sl,{});case"rdv":return t.jsx(Us,{});case"memoalert":return t.jsx(Zs,{});default:return null}}function Us(){const{dispatch:e,fund:a}=q(),r=typeof document<"u"&&!!document.getElementById("rdv");return g.useEffect(()=>{r&&(e({type:"modal",modal:null}),Go())},[r,e]),r?null:t.jsx(to,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Vs(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:s}=q(),p=i==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),c=e.chain.idx,d=u[c],f=c>=u.length;return tt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:f?n.finished:`${c+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(f?100:c/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:f||!d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:d.name}),t.jsx("div",{className:"sub",children:[nt(d.cc,o)||d.countryLabel,d.sector,d.stage,n.daysAgo(et(d.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:De(d.engine,o).toUpperCase()}),typeof d.amountEur=="number"&&d.amountEur>0&&t.jsx("span",{children:Dt(d.amountEur,o)})]}),xe(d)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(rt,{o:d,lg:!0})," ",t.jsx(Bt,{o:d,src:!0})]}),(d.tagline||d.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:d.tagline||d.headline})]}),d.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:d.reasoning})]}),p&&Ne(d)&&t.jsxs("div",{className:"vbox",style:{"--c":He(d)==="retenu"?"var(--brand)":He(d)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:He(d)==="retenu"?"✓ "+n.kept:He(d)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:d.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!f&&d&&!(p&&Ne(d))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(d)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(f?{type:"modal",modal:null}:{type:"chainNext"}),children:f?n.closeBtn:n.skip})]})]})})}),document.body)}function Hs(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=q(),i=o==="client",l=g.useMemo(()=>i?r.filter(d=>Ne(d)):[],[r,i]),s=g.useMemo(()=>Sa(l.filter(d=>He(d)==="retenu"),{key:"signal",dir:-1}),[l]),p=g.useMemo(()=>l.filter(d=>He(d)==="ecarte"),[l]),u=e.spaceTab==="retenu"?s:p,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(we,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),u.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),u.slice(0,40).map(d=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof d.score=="number"&&d.score>0?d.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:d.name}),t.jsx("div",{className:"rr",children:d.reasoning||d.tagline||""})]})]},d.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Ys(){const{mode:e}=q();return e==="client"||e==="apercu"?t.jsx(Ws,{}):t.jsx(Qs,{})}function Ws(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=q(),[i,l]=g.useState("d"),s=o!=="client";return t.jsxs(we,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Gs,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(Ks,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(or,{})]})}function Gs({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,c]=g.useState(0);g.useEffect(()=>{let x=!0;return p(!1),_a(a).then(b=>{x&&(b?l(b):p(!0))}),()=>{x=!1}},[a,u]);const d=x=>{r||_a(a,x).then(b=>{if(!b){o(e.actErr);return}l(b),b.throttled?o(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(x=>x+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const f=x=>!i.sections||i.sections.includes(x),v=x=>{const b=i.sections||e.alertSec.map(([h])=>h);d({sections:f(x)?b.filter(h=>h!==x):[...b,x]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,(i.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[i.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,(i.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:i.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([x,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:f(x),disabled:r,onChange:()=>v(x)}),t.jsxs("span",{children:[b,x==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},x))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ta,{label:e.alertPreview,readOnly:r,onPreview:()=>lo(a),onTest:()=>so(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ks({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,c]=g.useState(0);g.useEffect(()=>{let x=!0;return p(!1),Ua(a).then(b=>{x&&(b?l(b):p(!0))}),()=>{x=!1}},[a,u]);const d=x=>{r||Ua(a,x).then(b=>{if(!b){o(e.actErr);return}l(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(x=>x+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const f=i.dow??0,v=i.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:f,disabled:r,onChange:x=>d({dow:Number(x.target.value)}),children:e.alertDow.map((x,b)=>t.jsx("option",{value:b,children:x},x))}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,v+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ta,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>po(a),onTest:()=>co(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function or(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=q(),[l,s]=g.useState(i||""),[p,u]=g.useState(!1),[c,d]=g.useState(!1);g.useEffect(()=>{i&&s(i)},[i]);const f=e.filters,v=g.useMemo(()=>n.filter(m=>xe(m)).length,[n]),x=f.win==="1"?0:f.win==="7"?1:f.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||c)){d(!0);try{await fetch(`${va}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:f.sector,countries:f.country,source:i?"atelier2-client":"atelier2",website:""})}),u(!0)}finally{d(!1)}}},h=[[a.amRows.continent,o],[a.amRows.since,a.amSince[x]],[a.amRows.signal,f.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,f.engine.length?f.engine.map(m=>De(m,r)).join(", "):a.amAllEngines],[a.amRows.sectors,f.sector.length?f.sector.join(", "):a.amAllSectors],[a.amRows.countries,f.country.length?f.country.map(m=>nt(m,r)||m).join(", "):a.amAllCountries],[a.amRows.stages,f.stage.length?f.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:h.map(([m,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:m}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},m))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:m=>s(m.target.value),onKeyDown:m=>{m.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Qs(){const{t:e}=q();return t.jsx(we,{title:e.alertTitle,icon:"🔔",children:t.jsx(or,{})})}function Xs(){var b,h,m;const{t:e,token:a,fund:r,mode:n,flash:o}=q(),[i,l]=g.useState(null),[s,p]=g.useState([]),[u,c]=g.useState(0),d=n==="client";g.useEffect(()=>{let y=!0;return(async()=>{const[j,w]=await Promise.all([wa(r),zn(a)]);y&&(j&&l(j),p(w))})(),()=>{y=!1}},[a,r,u]);const f=(i==null?void 0:i.per_day)??2,v=((b=i==null?void 0:i.analyzed_today)==null?void 0:b.length)??0,x=(h=i==null?void 0:i.tomorrow)!=null&&h.length?i.tomorrow:((i==null?void 0:i.pool_meta)||[]).slice(0,10);return t.jsxs(we,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(v,v+(((m=i==null?void 0:i.pool_order)==null?void 0:m.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(f)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),d&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{$a(a,y.company,"retry").then(()=>c(j=>j+1))},children:e.queueRetry}),d&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{$a(a,y.company,"delete").then(()=>c(j=>j+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[x.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),x.slice(0,10).map((y,j)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",j+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Js(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=q(),s=`${ut}/cibles/list.csv?token=${a}`,p=`${ut}/cibles/list.json?token=${a}`,u=`${ut}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,d=h=>{var m;(m=navigator.clipboard)==null||m.writeText(h).then(()=>r(e.exportCopied))},f=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:u,href:u}],v=!o.lockActions&&n.length>0,x=()=>{Ps(Fs(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:h=>(e.stg.find(([m])=>m===h)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(we,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:x,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:f.map(({def:h,value:m,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:h[0]}),t.jsxs("div",{children:[t.jsx("b",{children:h[1]}),t.jsx("p",{children:h[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d(m),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},h[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Zs(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=q(),i=o!=="client",[l,s]=g.useState(null),[p,u]=g.useState(!1),[c,d]=g.useState(0),[f,v]=g.useState(!1);g.useEffect(()=>{let m=!0;return u(!1),Ba(a).then(y=>{m&&(y?s(y):u(!0))}),()=>{m=!1}},[a,c]);const x=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=m=>{if(i||!l)return;const y={enabled:m.enabled??!!l.enabled,email:m.email??(l.email||""),sections:m.sections??x()};v(!0),Ba(a,y).then(j=>{if(v(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(p)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]})});if(!l)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const h=x();return t.jsxs(we,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||f,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(el,{value:l.email||"",readOnly:i||f,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:m=>b({email:m})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([m,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!h[m],disabled:i||f,onChange:()=>b({sections:{...h,[m]:!h[m]}})}),t.jsx("span",{children:y})]},m))}),t.jsx(Ta,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>eo(a,h),onTest:()=>Zr(a,h)})]})}function el({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=g.useState(e);g.useEffect(()=>{l(e)},[e]);const s=i.trim()!==e.trim(),p=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:u=>l(u.target.value),onKeyDown:u=>{u.key==="Enter"&&s&&p&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>o(i.trim()),children:n})]})]})}function tl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=q(),[i,l]=g.useState(null),[s,p]=g.useState(!1),[u,c]=g.useState(null),[d,f]=g.useState(""),[v,x]=g.useState(0);g.useEffect(()=>{let m=!0;return p(!1),ta(a).then(y=>{m&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),no(a).then(y=>{m&&c(y)}),()=>{m=!1}},[a,v]);const b=(m,y)=>{o&&ta(a,m).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}m.test&&j.sent===!1?n(e.plugTestThrottled):r(y),x(w=>w+1)})},h='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(we,{title:e.plugTitle,icon:"🔌",wide:!0,children:[u&&t.jsx("p",{className:"mnote"+(u.enabled?" warn":""),children:u.enabled?e.plugAutoOn(u.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(m=>m+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:d,disabled:!o,onChange:m=>f(m.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!d.trim(),onClick:()=>b({url:d.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(al,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var m;(m=navigator.clipboard)==null||m.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function al(){const{t:e,token:a,lang:r}=q(),[n,o]=g.useState("valides"),[i,l]=g.useState(!1),[s,p]=g.useState(null),[u,c]=g.useState(null),[d,f]=g.useState(!1),[v,x]=g.useState(!1),[b,h]=g.useState(null),[m,y]=g.useState(null),[j,w]=g.useState(null),N=`atl2:bulk:${a}:${n}`;g.useEffect(()=>{ta(a).then(A=>{y(A&&A.configured?A.url_hint||"webhook":null)})},[a]),g.useEffect(()=>{p(null),c(null),f(!1),h(null);try{const A=JSON.parse(localStorage.getItem(N)||"null");w(A&&Date.now()-Date.parse(A.t)<24*3600*1e3?A:null)}catch{w(null)}},[N]);const S=async()=>{l(!0),f(!1),h(null);const A=await oo(a,n);p(A),c(A.ok?n:null),l(!1)},C=g.useRef(!1),R=async()=>{if(C.current)return;C.current=!0,x(!0);const A=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await io(a,n,"webhook",void 0,A)}finally{C.current=!1}if(x(!1),f(!1),h(M),M.ok&&(M.pushed||0)>0){const O={t:new Date().toISOString(),n:M.pushed||0};w(O);try{localStorage.setItem(N,JSON.stringify(O))}catch{}}},F=s!=null&&s.ok&&s.ready||0,k=!!(s!=null&&s.ok)&&u===n&&F>0&&!!m&&!j,T=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:A=>o(A.target.value),children:e.plugBulkTabs.map(([A,M])=>t.jsx("option",{value:A,children:M},A))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{S()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(T,j.n)}),!j&&!!(s!=null&&s.ok)&&!m&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),k&&!d&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>f(!0),children:e.bulkArm}),k&&d&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(F,m||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{R()},children:v?e.bulkSending:e.bulkConfirm(m||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>f(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function nl(){const{t:e,data:a,lang:r}=q(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const s=window.location.href.split("?")[0];try{const u=await(await fetch(`${va}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();u.url&&(window.location.href=u.url)}catch{}};return t.jsxs(we,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function rl(){const{t:e}=q();return t.jsx(we,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Bs,{})})}function ol(){const{t:e,lang:a,data:r,dossiers:n,token:o,canWrite:i,flash:l}=q(),[s,p]=g.useState(null),[u,c]=g.useState(!1);g.useEffect(()=>{let S=!0;return wa(o).then(C=>{S&&C&&typeof C.per_day=="number"&&p(C.per_day)}),()=>{S=!1}},[o]);const d=r.stats,f=typeof(d==null?void 0:d.screened)=="number"?d.screened:n.filter(S=>S.kind==="target"&&Ne(S)).length,v=r.marketEstimate||0,x=v>0?Math.min(100,Math.round(f/v*100)):null,b=(d==null?void 0:d.window_days)||30,h=f>0?f/b:0,m=v>0?Math.max(0,v-f):0,j=v>0&&h>0&&f>=100?Math.round(m/h):null,w=S=>Math.round(S).toLocaleString(a==="en"?"en-US":"fr-FR"),N=S=>{u||!i||(c(!0),ro(o,S).then(C=>{if(c(!1),C===null){l(e.actErr);return}p(C),l(e.alertSaved)}))};return t.jsxs(we,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(f))}),v>0&&t.jsx("span",{children:e.covOf(w(v))})]}),x!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:x+"%"}}),t.jsxs("em",{children:[x," %"]})]}),j!==null&&t.jsx("p",{className:"mnote",children:e.covEta(j)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),h>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(h))}),d&&t.jsxs("div",{className:"covf",children:[typeof d.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.kept)})," ",e.covKept]}),typeof d.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.analyzed)})," ",e.covAna]}),typeof d.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.shown)})," ",e.covShown]})]}),i&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:s===S?"on":"",disabled:u,onClick:()=>N(S),children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function il(){var m,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i}=q(),l=n==="client",s=g.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[p,u]=g.useState(null);g.useEffect(()=>{let w=!0;return ao(r).then(N=>{w&&u(N.thumbs)}),()=>{w=!1}},[r]);const[c,d]=g.useState(""),[f,v]=g.useState(""),[x,b]=g.useState(!1),h=async()=>{const w=c.trim();if(!(!w||x||!l)){b(!0),v("");try{const S=await(await fetch(`${ut}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&v(String(S.reply)),S.job_id){v(e.critChatRunning);const C=async()=>{const R=await fetch(`${ut}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(F=>F.json()).catch(()=>null);if(R&&R.done){v(String(R.reply||R.clarification||R.summary||"✓")),b(!1),R.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),d("");return}d("")}finally{f.startsWith("⏳")||b(!1)}}};return t.jsxs(we,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((m=i.points)!=null&&m.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var N,S;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((S=w.out)!=null&&S.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},w.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!l||x,onChange:w=>d(w.target.value),onKeyDown:w=>{w.key==="Enter"&&h()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(x?" loading":""),style:{padding:"12px 18px"},disabled:!l||x||!c.trim(),onClick:()=>void h(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),f&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:f})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,N)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},N))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(rr[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function sl(){const{t:e,dispatch:a,startTour:r}=q(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(we,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const Jt={},jn=(Jt==null?void 0:Jt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Nn(){return new Date().toISOString().slice(0,10)}const ir=g.createContext(null);function sr(){const e=g.useContext(ir);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ll({token:e,children:a}){const{dispatch:r,st:n,lang:o}=q(),[i,l]=g.useState(()=>n.filters.day||Nn()),[s,p]=g.useState(null),[u,c]=g.useState(!1),d=g.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),f=g.useCallback(()=>{l(Nn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);g.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),g.useEffect(()=>{const b=h=>{var y;const m=(y=h.detail)==null?void 0:y.day;typeof m=="string"&&d(m)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[d]),g.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),g.useEffect(()=>{if(!e||!i)return;let b=!1;c(!0);const h=new URLSearchParams({token:e,date:i});return fetch(`${jn}/cibles/edition.json?${h}`).then(m=>m.json()).then(m=>{b||p(m)}).catch(()=>{b||p({ok:!1,error:"network"})}).finally(()=>{b||c(!1)}),()=>{b=!0}},[e,i]);const v=g.useMemo(()=>`${jn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),x=g.useMemo(()=>({token:e,day:i,ed:s,loading:u,pickDay:d,pickWindow:f,dayPicked:!!n.filters.day,daysUrl:v,isEn:o==="en"}),[e,i,s,u,d,f,n.filters.day,v,o]);return t.jsx(ir.Provider,{value:x,children:a})}function cl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=sr();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:i?t.jsxs(t.Fragment,{children:["No thesis brief for ",t.jsx("b",{children:e})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):t.jsxs(t.Fragment,{children:["Pas encore de brief de thèse pour le ",t.jsx("b",{children:e}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const lr="atl2:mapfold",pl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(lr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},cr=g.createContext(null),q=()=>{const e=g.useContext(cr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function rt({o:e,lg:a}){const{lang:r}=q(),n=xe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Va(n,r),children:[n.emoji," ",Va(n,r)]}):null}function Bt({o:e,src:a}){const{lang:r,t:n}=q(),o=xe(e);if(!o)return null;const i=go(o),l=bo(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Ln(o,r))+" · "+n.win7(Rn(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<i?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function dr({o:e}){const{lang:a}=q(),r=ho(e.cc),n=e.cc?nt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Sn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",pr=e=>`atl2:tour:${e||"anon"}`;function ul(e){try{return localStorage.getItem(pr(e))==="1"}catch{return!0}}function Cn(e){try{localStorage.setItem(pr(e),"1")}catch{}}function fl(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function vl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){const{lang:l}=fo(),s=Co[l],p=Po(e,l,a),[u,c]=g.useReducer(Io,void 0,()=>Do((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||pl(),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??(a==="ops"?"deplie":void 0),filters:r,modal:n==null?void 0:n.modal})),d=g.useRef(!0);g.useEffect(()=>{if(d.current){d.current=!1;return}if(!e)try{localStorage.setItem(lr,u.mapFolded?"on":"off")}catch{}},[u.mapFolded,e]);const f=g.useRef(i);f.current=i,g.useEffect(()=>{var z;(z=f.current)==null||z.call(f,u.filters)},[u.filters]);const[v,x]=g.useState(null),[b,h]=g.useState(null),[m,y]=g.useState({kept:0,dropped:0}),[j,w]=g.useState(!1),[N,S]=g.useState(""),[C,R]=g.useState(!1),[F,k]=g.useState(null),[T,A]=g.useState(!1),[M,O]=g.useState(!1),[,E]=g.useState(0),L=()=>E(z=>z+1),$=g.useRef([]),K=g.useRef(new Set),X=g.useRef(new Set),pe=g.useRef(new Map),le=g.useRef(null),{mode:U}=p,W=g.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[p.caps,o,a]),H=W.pipe,_=p.session.token||"",G=U==="client"&&!e;g.useEffect(()=>{if(document.querySelector(`link[href="${Sn}"]`))return;const z=document.createElement("link");z.rel="stylesheet",z.href=Sn,document.head.appendChild(z)},[]);const ee=(z,D=!1)=>{S(z),R(D),le.current&&clearTimeout(le.current),le.current=setTimeout(()=>S(""),D?4200:2400)},ne=z=>ee(z,!0),ge=g.useMemo(()=>{const z=new Map;return p.dossiers.forEach(D=>{D.id&&z.set(D.id,D)}),z},[p.dossiers]),ue=g.useMemo(()=>p.dossiers.filter(z=>qn(z,u,H)),[p.dossiers,u,H]),Y=g.useRef(!1);g.useEffect(()=>{if(Y.current||e||p.loading||!p.dossiers.length)return;if(!W.showFunnel||ul(p.session.token||"")){Y.current=!0;return}Y.current=!0;const z=window.setTimeout(()=>{Cn(p.session.token||""),A(!0)},700);return()=>window.clearTimeout(z)},[e,p.loading,p.dossiers.length,W.showFunnel,p.session.token]);const Q=g.useMemo(()=>p.dossiers.filter(z=>Bo(z,u,H,p.favIds)),[p.dossiers,u,H,p.favIds]),be=g.useMemo(()=>mo(ue,p.favIds),[ue,p.favIds]),B=ka.find(z=>z.key===u.continent),de=u.continent==="monde"?s.contWorld:(l==="fr"?B==null?void 0:B.fr:B==null?void 0:B.en)||"";g.useEffect(()=>{const z=D=>{var ce;const I=(((ce=D.detail)==null?void 0:ce.name)||"").trim();I&&re(null,I)};return window.addEventListener("ppmap:evaluate",z),()=>window.removeEventListener("ppmap:evaluate",z)});const re=(z,D)=>{const I=((z==null?void 0:z.name)||D||"").trim();if(!G){h({kicker:I});return}!I||j||(w(!0),(async()=>{try{const ce=await Tn(_,I,"atelier2"),gt={name:ce.company||I,verdict:ce.verdict,reason:ce.reason||"",remaining:ce.remaining??null};$.current=[gt,...$.current].slice(0,8),ce.verdict==="kept"&&y(_e=>({..._e,kept:_e.kept+1})),ce.verdict==="ruled_out"&&y(_e=>({..._e,dropped:_e.dropped+1}));const ot=z||p.dossiers.find(_e=>(_e.name||"").toLowerCase()===I.toLowerCase());ot&&(ce.verdict==="kept"?ot.verdict=ot.verdict||"MATCH":ce.verdict==="ruled_out"&&(ot.verdict="NO MATCH"),ce.reason&&(ot.reasoning=ce.reason)),L()}finally{w(!1)}})())},fe=z=>{if(!G){h({kicker:z.name});return}K.current.add(z.id),it(_,"fast_request",z.name||"",""),ee(s.memoInstantSent(z.name)),L()},Oe=z=>pe.current.get(z.id)??p.thumbs.get((z.name||"").trim().toLowerCase()),ve=(z,D)=>c({type:"undoPush",entry:{id:z.id,name:z.name,prevCeoStatus:D}}),Me=async(z,D,I)=>{const ce=z.ceoStatus||"";z.ceoStatus=D,L();const gt=await Vt(_,{status:D,airtable_id:z.airtableId,check_id:z.checkId,company:z.name,...(I==null?void 0:I.note)!==void 0?{note:I.note}:{},...I!=null&&I.via?{via:I.via}:{}});return gt.ok?gt.skipped?(z.ceoStatus=ce,L(),ne(s.actNotPersisted),!1):((I==null?void 0:I.undo)!==!1&&ve(z,ce),I!=null&&I.msg&&ee(I.msg),(D==="Validé"||D==="Écarté")&&!z.ceoNote&&(I==null?void 0:I.note)===void 0&&k({o:z,yes:D==="Validé"}),!0):(z.ceoStatus=ce,L(),ne(s.actErr),!1)},Ie=async(z,D)=>{const I=await Vt(_,{status:z.ceoStatus||"Retenu",airtable_id:z.airtableId,check_id:z.checkId,company:z.name,note:D,via:"note"});return!I.ok||I.skipped?(ne(I.skipped?s.actNotPersisted:s.actErr),!1):(z.ceoNote=D,L(),!0)},ye=g.useRef(new Map),Be=z=>ye.current.has(z.id)?ye.current.get(z.id):p.stages.get((z.name||"").trim().toLowerCase()),$t=(z,D)=>{ye.current.set(z.id,D),L()},P=(z,D)=>{G&&Me(z,D?"Validé":"Écarté",{msg:D?s.decidedYes(z.name):s.decidedNo(z.name)})},J=z=>{G&&Me(z,"À trancher",{msg:s.promoted(z.name)})},ae=z=>{G&&(async()=>{const D=z.ceoStatus||"";z.ceoStatus="Retenu",L();const I=await Vt(_,{status:"Retenu",check_id:z.checkId,company:z.name});if(!I.ok||I.skipped){z.ceoStatus=D,L(),ne(I.skipped?s.actNotPersisted:s.actErr);return}ve(z,D),ee(s.repeched(z.name))})()},oe=()=>{const z=u.undo[u.undo.length-1];if(!z){ee(s.undoNone);return}const D=ge.get(z.id);if(!D){c({type:"undoPop"}),ee(s.undoNone);return}let I=z.prevCeoStatus;if(!I)if((D.verdict||"").toUpperCase().includes("CALL"))I="À trancher";else{ee(s.undoLockedTitle);return}(async()=>await Me(D,I,{undo:!1})&&(c({type:"undoPop"}),D.ceoStatus=z.prevCeoStatus,L(),ee(s.undoDone(D.name))))()},qe=z=>{G&&(X.current.add(z.id),L(),(async()=>{const D=await vo(_,z.name,"email");if(!D||D.ok===!1){X.current.delete(z.id),L(),ne(s.actErr);return}it(_,"approach",z.name||"",""),ee(s.actApproachSent)})())},Ae=(z,D)=>{G&&(async()=>{if(!(await it(_,D?"yes":"no",z.name||"","")).ok){ne(s.actErr);return}pe.current.set(z.id,D?"yes":"no"),L(),ee(D?s.thumbUpDone:s.thumbDnDone)})()},$e=z=>{!G||!ja(z)||(it(_,"detailed_request",z.name||"",""),ee(s.memoDeepSent(z.name)))},ur=z=>{const D=new Set(p.favIds),I=D.has(z.id);I?D.delete(z.id):D.add(z.id),p.setFavIds(D),G&&yo(_,{id:z.id,co:z.name},I)},fr=()=>{!G||M||window.confirm(s.identSyncConfirm)&&(O(!0),(async()=>{const z=await wo(_);O(!1),z?ee(s.identSyncDone):ne(s.actErr)})())},La=/proplace/i.test(p.fund||""),mr=z=>{!G||!La||(it(_,"onboard_request",z.name||"",""),ee(s.onboardSent(z.name)))},xr={st:u,dispatch:c,t:s,lang:l,mode:U,caps:W,pipe:H,token:_,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:ae,thumbOf:Oe,canWrite:G,commitStatus:Me,saveNote:Ie,stageOf:Be,setStage:$t,flashErr:ne,startTour:()=>A(!0),dossiers:p.dossiers,scopedAll:ue,scoped:Q,counts:be,byId:ge,contName:de,favIds:p.favIds,toggleFav:ur,askEvaluate:re,doAnalyse:fe,doDecide:P,doPromote:J,doApproach:qe,doThumb:Ae,doDeep:$e,doUndo:oe,doSync:fr,doOnboard:mr,outbound:La,memoQueued:K.current,approachDone:X.current,sessTally:m,evalCards:$.current,evalBusy:j,markRow:x,markedId:v,flash:ee};g.useEffect(()=>{const z=D=>{D.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",z),()=>window.removeEventListener("keydown",z)},[]);const hr=z=>_?t.jsx(ll,{token:_,children:z}):t.jsx(t.Fragment,{children:z});return t.jsx(cr.Provider,{value:xr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Ao}),hr(t.jsxs("div",{className:"app"+(H?" pipe":"")+(_?" has-thesis":""),children:[W.showTicker&&t.jsx(me,{name:"live",children:t.jsxs("div",{className:"live-stack"+(_?" live-stack--cibles":""),children:[t.jsx(Ho,{}),!!_&&t.jsx(cl,{})]})}),W.showIdent&&t.jsx(me,{name:"identite",children:t.jsx(li,{})}),W.showOnb&&t.jsx(me,{name:"onboarding",children:t.jsx(ci,{})}),W.showMorning&&t.jsx(me,{name:"matin",children:t.jsx(si,{})}),t.jsx(me,{name:"fraicheur",children:t.jsx(Zo,{})}),t.jsx(me,{name:"mesure",children:t.jsx(ei,{})}),W.showFunnel&&t.jsx(me,{name:"entonnoir",children:t.jsx(ml,{})}),W.showFunnel&&t.jsx(me,{name:"tunnel",children:t.jsx(pi,{})}),W.showFunnel&&t.jsx(me,{name:"tuto",children:t.jsx(fi,{})}),t.jsx(me,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(xl,{}),t.jsxs("div",{className:"stage"+(u.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(ss,{}),t.jsx(cs,{})]})]})}),W.showDemand&&t.jsx(me,{name:"evaluation",children:t.jsx(xs,{})}),W.showDemand&&u.memoConsole&&t.jsx(me,{name:"console",children:t.jsx(gs,{})}),t.jsx(me,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Ms,{})}),!!_&&t.jsx(me,{name:"edition",children:t.jsx(dl,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),W.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),u.popupId&&t.jsx(me,{name:"fiche",children:t.jsx(ys,{})}),t.jsx(me,{name:"modales",children:t.jsx(_s,{})}),t.jsx(Qo,{}),F&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:F.o.name}),t.jsx(ri,{placeholder:F.yes?s.whyYesPh:s.whyNoPh,onDone:z=>{const D=F.o;k(null),z&&Ie(D,z).then(I=>{I&&ee(s.csNoteSaved)})}})]}),T&&t.jsx(ii,{steps:fl(s),onClose:()=>{A(!1),Cn(_)}}),N&&t.jsx("div",{className:"flash on"+(C?" err":""),children:N}),b&&t.jsx(xo,{variant:"acquirer",initialCompany:En().co,initialWebsite:En().site,onClose:()=>h(null)})]})})}function ml(){const{t:e}=q(),[a,r]=g.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function xl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:o,t:i}=q(),l=g.useMemo(()=>{const s={};return e.forEach(p=>{Na(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[ko.map(s=>{const p=ka.find(c=>c.key===s),u=s==="monde"?i.contWorld:o==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[u,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?i.showMap:i.hideMap})})]})}function En(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function hl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{dr as FlagCell,rt as SigBadge,Bt as SigWin,vl as default,hl as fmtShort,q as useV2};
