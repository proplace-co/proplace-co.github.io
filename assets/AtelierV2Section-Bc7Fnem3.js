...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ui=`
...
/* Colonne grise = toute la hauteur de la liste. Le dossier (.zoom) colle
   en haut ; le fond continue jusqu'en bas, même si le contenu est plus court. */
.atl2.ops .readpane{min-width:0;position:relative;align-self:stretch;z-index:20;
...
.atl2.ops .readpane .readpane-empty{position:sticky;z-index:35;
  top:calc(104px + var(--demand-h,56px));
  max-height:calc(100dvh - 104px - var(--demand-h,56px));
  overflow-y:auto;overscroll-behavior:contain;background:#F7F9FB}
/* Le kicker (Radar levées · 25/08/2026) reste collé en tête du dossier. */
...
body.pp-desk .atl2.ops .readpane .zoom,
body.pp-desk .atl2.ops .readpane .zoom-pipe,
body.pp-desk .atl2.ops .readpane .readpane-empty{
  top:calc(104px + var(--demand-h,56px));
  max-height:calc(100dvh - 104px - var(--demand-h,56px))}
...
`,Hi=_i+Ui;function Ba(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Vi(){const e=Ba("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Wi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Vi();return r==="0"?"client":r==="1"||Ba("embed")==="1"&&Ba("chrome")==="1"?"apercu":"client"}const Yi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Gi=e=>Yi[e];function pa(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const ft=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!kr(a)||pa(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Lo(e.cc)})};function Ca(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Ki=60*60*1e3;function Qi(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ki?null:a}catch{return null}}function Jt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ji=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Xi(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:yo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Wi(e,i),[e,i,n]),l=m.useMemo(()=>Gi(o),[o]),c=o!=="visiteur",d=Ji(r),[f,s]=m.useState([]),[x,u]=m.useState(""),[g,p]=m.useState(null),[b,y]=m.useState(null),[h,N]=m.useState(null),[C,w]=m.useState(()=>new Map),[A,L]=m.useState(()=>new Map),[T,z]=m.useState(""),[S,j]=m.useState(new Set),[M,P]=m.useState(null),[O,B]=m.useState(!0),[v,q]=m.useState(!1),[H,U]=m.useState(0),[I,W]=m.useState(0),K=m.useRef(0),Q=m.useMemo(()=>{var ae;if(o!=="client")return"";try{return((ae=wo())==null?void 0:ae.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ae=++K.current;let ve=!0;const G=()=>ve&&ae===K.current,pe=(c&&i.token?i.token:"pub:"+a)+(d?":"+d:""),re=Qi(pe);return re?(s(re.objs.map(ft)),re.fund&&u(re.fund),p(re.marketEstimate??null),y(re.criteria??null),N(re.stats??null),z(re.generatedAt||""),B(!1)):B(!0),(async()=>{try{if(r==="ops"){const ke=await Sa(),me=((ke==null?void 0:ke.recent_ops)||[]).map(Z=>{const ee=sa(Z.company_name||Z.title?Z:{...Z,title:(Z.headline_fr||Z.headline||"").slice(0,120)},a),J=String(Z.rubrique||"").toLowerCase();return ee&&(J==="nominations"||J==="recrutements")&&(ee.engine=J),ee&&!String(Z.company_name||"").trim()&&(ee.noCo=!0),ee}).filter(Z=>!!Z).map(Z=>(kr((Z.name||"").trim())||(Z.noCo=!0),Z));try{const Z=ko(),ee=Z&&Z.doc||await jo(),J=No(ee),te=((Z==null?void 0:Z.day)||(ee==null?void 0:ee.date)||"").slice(0,10);if(te&&J.length){const xe=new Set;for(const Y of me){if((Y.date||"").slice(0,10)!==te)continue;const ue=Nn(J,xe,Y.name,"");ue>=0&&(xe.add(ue),Y.decryptHtml=J[ue].html)}for(const Y of me){if(Y.decryptHtml||(Y.date||"").slice(0,10)!==te)continue;const ue=Nn(J,xe,"",Y.headline||Y.tagline||Y.name);ue>=0&&(xe.add(ue),Y.decryptHtml=J[ue].html)}}if(te){const xe=((ee==null?void 0:ee.title_fr)||"").trim(),Y=((ee==null?void 0:ee.lead_fr)||"").trim(),ue=So(ee),oe=((ee==null?void 0:ee.url)||"").trim();xe&&ue&&me.unshift({id:`edito:${te}`,kind:"op",name:xe,cc:null,date:te,engine:"edito",dealKind:"other",headline:Y||xe,tagline:Y||xe,decryptHtml:ue,url:oe,noCo:!0})}}catch{}if(!G())return;s(me.map(ft)),Jt(pe,{objs:me})}else if(typeof r=="object"){const me=(await Sn()||[]).filter(ee=>(ee.slug||"")===r.research).map(ee=>En(ee,a)).filter(ee=>!!ee),Z=Ca(await Cn(me,a));if(!G())return;s(Z.map(ft)),Jt(pe,{objs:Z})}else if(c&&i.token){const ke=Eo(i.token),me=Sa(),Z=Co(i.token),ee=zo(i.token),J=Ao(i.token),te=await ke;let xe=te?te.targets:[];G()&&te&&(u(te.fund||""),p(te.marketEstimate??null),y(te.criteria??null),N(te.stats??null),z(te.generatedAt||""),s(xe.map(ft)),B(!1),q(!1));const[Y,ue,oe,he]=await Promise.all([me,Z,ee,J]),De=((Y==null?void 0:Y.recent_ops)||[]).map(qe=>sa(qe,a)).filter(qe=>!!qe);if(xe=[...xe,...De],!G())return;s(xe.map(ft));const _e=new Set;for(const qe of ue){const Ue=(qe.id||qe.co||"").toString().trim().toLowerCase();Ue&&_e.add(Ue.startsWith("t:")?Ue:"t:"+Ue)}j(_e),w(oe),L(he),te&&Jt(pe,{fund:te.fund,marketEstimate:te.marketEstimate,criteria:te.criteria,stats:te.stats,generatedAt:te.generatedAt,objs:xe})}else{const ke=To(),me=Sn(),Z=Sa(),ee=await ke;G()&&ee.length&&(s(Ca(ee).map(ft)),B(!1),q(!1));const[J,te]=await Promise.all([me,Z]),xe=(J||[]).map(he=>En(he,a)).filter(he=>!!he),Y=await Cn(xe,a),ue=((te==null?void 0:te.recent_ops)||[]).map(he=>sa(he,a)).filter(he=>!!he),oe=Ca([...ee,...Y,...ue]);if(!G())return;s(oe.map(ft)),Jt(pe,{objs:oe})}G()&&q(!1)}catch{G()&&!re&&q(!0)}finally{G()&&B(!1)}})(),()=>{ve=!1}},[c,i.token,a,H,d]),m.useEffect(()=>{if(!l.showCredits||!Q){P(null);return}let ae=!0;return(async()=>{try{const ve=await fetch(`${rn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Q})});if(!ve.ok)return;const G=await ve.json();ae&&G&&G.ok!==!1&&P(G)}catch{}})(),()=>{ae=!1}},[l.showCredits,Q,I]);const le=m.useCallback(ae=>j(new Set(ae)),[]);return{session:i,mode:o,caps:l,fund:x,email:Q,marketEstimate:g,generatedAt:T,criteria:b,stats:h,thumbs:C,stages:A,dossiers:f,favIds:S,setFavIds:le,credits:M,reloadCredits:()=>W(ae=>ae+1),loading:O,error:v,refresh:()=>U(ae=>ae+1)}}function gt(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Er=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Zi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Er(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),es=new Set(["signal","amount","score","crible","memo"]);function ts(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Er(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:es.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Cr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Cr=80;function ua(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Le(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(on(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(lt(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&ht(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function zr(e,a,r){return gt(e)?ua(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:ua(e,a.filters,r)}function as(e,a,r,n){return!(!zr(e,a,r)||r&&!qo(e,a.ptab,n))}function dn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-lt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Ro(i);case"memo":return Mo(i);case"signal":{const o=Le(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),c=n(o);return l<c?-a.dir:l>c?a.dir:(i.name||"").localeCompare(o.name||"")})}const za={},Pn=(za==null?void 0:za.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Dn(){return new Date().toISOString().slice(0,10)}const pn=m.createContext(null);function Ar(){return m.useContext(pn)}function ns(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const c=n.cloneNode(!0);c.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),c.querySelectorAll("*").forEach(d=>{const f=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(s=>d.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(d.setAttribute("href",f),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:c.outerHTML})}}catch{}return a}function In(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Tr(){const e=m.useContext(pn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function rs({token:e,children:a}){const{dispatch:r,st:n,lang:i}=D(),[o,l]=m.useState(()=>n.filters.day||Dn()),[c,d]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=m.useCallback(()=>{l(Dn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var N;const h=(N=y.detail)==null?void 0:N.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${Pn}/cibles/edition.json?${y}`).then(h=>h.json()).then(h=>{b||d(h)}).catch(()=>{b||d({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const g=m.useMemo(()=>`${Pn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=m.useMemo(()=>({token:e,day:o,ed:c,loading:f,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:g,isEn:i==="en"}),[e,o,c,f,x,u,n.filters.day,g,i]);return t.jsx(pn.Provider,{value:p,children:a})}function os(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Tr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Fo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})]})}function is(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Tr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),c=(a==null?void 0:a.ok)&&!l,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:In(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:In(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const ss=300,Xt=7,ls={fr:{ma:"M&A",levees:"Levées de fonds",nominations:"Nominations",recrutements:"Offres d'emploi",actualites:"Presse"},en:{ma:"M&A",levees:"Fundraising",nominations:"Appointments",recrutements:"Job offers",actualites:"Press"}},Lr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},cs=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Aa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Io(r)&&r!=="media")return"news:"+r;const n=Le(e);return n?"sig:"+(n.theme&&Lr.fr[n.theme]?n.theme:"other"):"actualites"}function ds(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:c}=D(),d=Ar(),f=l==="en",[s,x]=m.useState("all"),[u,g]=m.useState(!1),p=m.useMemo(()=>{var ve;const v=(a.filters.day||"").slice(0,10),q=G=>!(!o&&a.continent!=="monde"&&G.continent!==a.continent||v&&(G.date||"").slice(0,10)!==v),H=e.filter(G=>q(G)&&Le(G)&&(!o||G.kind!=="target"||ze(G)!==5)),U=o&&(((ve=d==null?void 0:d.ed)==null?void 0:ve.ops)||[]).length?d.ed.ops.map(G=>sa(G,l)).filter(G=>!!G).filter(G=>!v||(G.date||"").slice(0,10)===v):[],I=e.filter(G=>q(G)&&G.kind==="op"&&(v?!0:lt(G.date)<=Xt)),W=o?U.length?U:I.filter(G=>{const pe=(c||"").trim().toLowerCase();if(!pe)return!1;const re=G.match||null;return re?Object.keys(re).map(ke=>ke.trim().toLowerCase()).includes(pe):!1}):I,K=v||new Date().toISOString().slice(0,10),Q=G=>{const pe=Aa(G);return pe==="ma"?0:pe==="levees"?1:2};W.sort((G,pe)=>{const re=Q(G)-Q(pe);if(re)return re;const ke=(G.date||"").slice(0,10)===K?0:1,me=(pe.date||"").slice(0,10)===K?0:1;return ke!==me?ke-me:(pe.amountEur||0)-(G.amountEur||0)});const le=new Set,ae=[];for(const G of[...W,...dn(H,{key:"signal",dir:-1})]){const pe=G.id||G.name;!pe||le.has(pe)||(le.add(pe),ae.push(G))}return o&&ae.length===0?e.filter(pe=>q(pe)&&lt(pe.date)<=Xt).sort((pe,re)=>(re.date||"").localeCompare(pe.date||"")).slice(0,80):ae},[e,a.continent,a.filters.day,o,c,l,d]),b=m.useMemo(()=>{const v={};for(const q of p){const H=Aa(q);v[H]=(v[H]||0)+1}return v},[p]),y=m.useMemo(()=>s==="all"?p:p.filter(v=>Aa(v)===s),[p,s]),h=m.useMemo(()=>y.slice(0,ss),[y]),N=y.length-h.length,C=m.useRef(null);m.useEffect(()=>{var W,K;const v=C.current;if(!v)return;const q=()=>{const Q=v.scrollWidth;Q<200||(v.style.animationDuration=Math.max(18,Math.round(Q/130))+"s")};q();const H=requestAnimationFrame(q),U=window.setTimeout(q,1200);let I=!0;return(K=(W=document.fonts)==null?void 0:W.ready)==null||K.then(()=>{I&&q()}),()=>{I=!1,cancelAnimationFrame(H),window.clearTimeout(U)}},[h.length,s]);const w=v=>v==="all"?p.length:b[v]||0,A=v=>{if(v==="all")return f?"All":"Tout";if(v.startsWith("sig:"))return Lr[f?"en":"fr"][v.slice(4)]||"🔔";if(v.startsWith("news:")){const q=v.slice(5);return Po[q]?Do(q,f?"en":"fr"):v}return ls[f?"en":"fr"][v]},L=[{k:"all"}],T=["ma","levees"].filter(v=>w(v)>0||v===s);if(T.length){L.push({g:f?"Recent deals":"Opérations récentes"});for(const v of T)L.push({k:v})}const z=["nominations","recrutements"].filter(v=>w(v)>0||v===s),S=Oo.filter(v=>v!=="media").map(v=>"news:"+v).filter(v=>w(v)>0||v===s),j=w("actualites")>0||s==="actualites"?["actualites"]:[],M=cs.map(v=>"sig:"+v).filter(v=>w(v)>0||v===s);if(z.length||S.length||j.length||M.length){L.push({g:f?"News (incl. wire)":"Actualités (dont fil)"});for(const v of z)L.push({k:v});for(const v of S)L.push({k:v});for(const v of j)L.push({k:v});for(const v of M)L.push({k:v})}const P=v=>{try{return new Date(v+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return v}},O=(()=>{const v=(a.filters.day||"").slice(0,10),q=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return v?(f?`LIVE covers the events of ${P(v)}.`:`Le LIVE regroupe les événements du ${P(v)}.`)+q:(f?`LIVE covers the still-open signals and the deals of the last ${Xt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Xt} derniers jours.`)+q})(),B=v=>h.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Oe(q)?" spent":""),onClick:H=>{if(n({type:"focus",id:q.id}),a.dens!=="liste"){const U=H.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:U.left+U.width/2,y:U.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(wt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(co,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Oc(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(ka,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},v+(q.id||q.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},v+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:v=>{v.currentTarget.contains(v.relatedTarget)||g(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>g(v=>!v),children:[A(s),t.jsx("b",{children:w(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:O}),L.map(v=>"g"in v?t.jsx("span",{className:"tkfilg",children:v.g},v.g):t.jsxs("button",{type:"button","aria-pressed":v.k===s,onClick:()=>{x(v.k),g(!1)},children:[A(v.k),t.jsx("b",{children:w(v.k)})]},v.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:C,children:[B(0),B(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!d&&t.jsx(us,{isEn:f})]})}const ps=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function us({isEn:e}){const[a,r]=m.useState(()=>$o());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(zn,i),()=>window.removeEventListener(zn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Bo(!a),children:ps})}const un="+33 6 83 10 72 86",ma="alexandre@proplace.co",qr=`tel:${un.replace(/[^\d+]/g,"")}`;function ms(){return null}class Me extends m.Component{constructor(){super(...arguments);kn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Ta=600,xt=62,$n="atl2:fstats";function fs(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=D(),[l,c]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem($n)==="on"}catch{return!1}}),d=r.stats,f=m.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),s=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const x=A=>a==="en"?A.slice(5,10):`${A.slice(8,10)}/${A.slice(5,7)}`,u=A=>A.toLocaleString(a==="en"?"en-US":"fr-FR"),g=f.reduce((A,L)=>Math.max(A,L.s||0),0),p=f.length?Ta/f.length:0,b=Math.max(4,p-4),y=f.length>=5&&g>0,h=r.marketEstimate||0,N=x(new Date().toISOString().slice(0,10)),C=A=>[...typeof A=="number"?[[A,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],w=[];return typeof d.screened_window=="number"&&s&&w.push({cle:"fenetre",periode:e.funPerWindow(x(s),N),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:C(d.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(A=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:A.periode}),A.etapes.map(([L,T],z)=>t.jsxs("span",{className:"fst-t",children:[z>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(L)}),t.jsx("i",{children:T})]},A.cle+T)),A.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((d.screened||0)/h*100)))})]}),A.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const L=!l;c(L),L&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem($n,L?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},A.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ta} ${xt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((A,L)=>{const T=(A.s||0)/g*(xt-4),z=(A.m||0)/g*(xt-4),S=L*p+(p-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(A.d)} — ${A.s} ${e.actScreened} · ${A.m} ${e.actKept}`}),t.jsx("rect",{x:S,y:xt-2-T,width:b,height:T,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:xt-2-z,width:b,height:z,fill:"#185c38"})]},A.d)}),t.jsx("line",{x1:0,y1:xt-1.5,x2:Ta,y2:xt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Mr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function xs(e,a){if((pt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return Mr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function hs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=D(),[c,d]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),p=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){u(!0);return}s(b);const y=await i(e,b);s(""),y&&(d(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(b=>!b),u(!1)},children:[g||a.csNone,t.jsx("i",{children:"▾"})]}),c&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),d(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]}):xs(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(g===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{p(b)},children:y},b))})]})}function gs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=D(),[o,l]=m.useState(""),[c,d]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(pt(e)||"").startsWith("CALL")&&ze(e)===3,x=ze(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const b=await i(e,p);l(""),b&&(d(!0),setTimeout(()=>d(!1),2200))},g=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Mr.filter(([p])=>!(x&&p==="Retenu")).map(([p,b])=>[p,a[b]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),g.map(([p,b])=>t.jsx("button",{type:"button",className:"csb"+(f===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:b},p)),c&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(bs,{o:e})]})}function bs({o:e}){const{t:a,saveNote:r,flash:n}=D(),[i,o]=m.useState(e.ceoNote||""),[l,c]=m.useState(!1),[d,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;c(!0);const u=await r(e,i.trim());c(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:d?a.csNoteSaved:a.csNoteOk})]})}function vs({placeholder:e,onDone:a}){const{t:r}=D(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ys({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:c}=D(),[d,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||ze(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",u=async h=>{if(d||h===x)return;f(!0);const N=s;l(e,{stage:h,stamps:(s==null?void 0:s.stamps)||{}});const C=Math.max(Date.now(),Bn+=1);Bn=C;const w=await _o(r,{company:e.name||"",stage:h,cts:C,deal_id:e.airtableId,check_id:e.checkId});f(!1),!w.stale&&(w.ok||(l(e,N),c(a.actErr)))},g=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,p=g?Math.floor((Date.now()-Date.parse(g))/864e5):0,b=x==="sent"&&g&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,N])=>t.jsx("button",{type:"button",className:"stgb"+(x===h?" on":""),disabled:d,onClick:()=>{u(h)},children:N},h)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let Bn=0;const Zt=8,ea=360;function _n({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Un({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(_n,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(_n,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function ws({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=D(),[l,c]=m.useState(0),[d,f]=m.useState(null),[s,x]=m.useState([]),u=m.useRef(!1),g=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=m.useRef(!1);m.useEffect(()=>{const T=g.current;return()=>{p.current||(n({type:"ptab",tab:T.ptab}),n({type:"dens",dens:T.dens}),n({type:"modal",modal:T.modal}))}},[]),m.useEffect(()=>{u.current||(u.current=!0,x(e.filter(T=>!!document.querySelector(T.need||T.sel))))},[e]);const b=s[l],y=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const T=b.click,z=window.setTimeout(()=>{const S=document.querySelector(T);S&&S.getAttribute("aria-selected")!=="true"&&S.click()},60);return()=>window.clearTimeout(z)}},[l,b]);const h=m.useRef(-1),N=m.useCallback(()=>{if(!b){f(null);return}const T=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!T){f(null);return}h.current!==l&&(h.current=l,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const z=T.getBoundingClientRect();f(S=>S&&Math.abs(S.top-z.top)<1&&Math.abs(S.left-z.left)<1&&Math.abs(S.width-z.width)<1&&Math.abs(S.height-z.height)<1?S:z)},[b,l]);m.useLayoutEffect(()=>{N();const T=[90,300,700,1300].map(S=>window.setTimeout(N,S)),z=()=>N();return window.addEventListener("scroll",z,!0),window.addEventListener("resize",z),()=>{T.forEach(S=>window.clearTimeout(S)),window.removeEventListener("scroll",z,!0),window.removeEventListener("resize",z)}},[N]);const C=m.useRef(a);if(C.current=a,m.useEffect(()=>{const T=z=>{z.key==="Escape"?(z.preventDefault(),z.stopPropagation(),C.current()):z.key==="ArrowRight"?c(S=>S+1):z.key==="ArrowLeft"&&c(S=>Math.max(0,S-1))};return document.addEventListener("keydown",T,!0),()=>document.removeEventListener("keydown",T,!0)},[]),!s.length)return null;let w=null;const A=T=>()=>{p.current=!0,n({type:"modal",modal:null}),T()};if(y){const T=i[3]||0;T>0?w={title:T===1?r.ahaATitle1:r.ahaATitleN(T),body:r.ahaABody,btn:r.ahaABtn,go:A(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:A(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:A(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:A(()=>{n({type:"modal",modal:"crit"}),a()})}}let L={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:ea};if(!y&&d){const T=d.bottom+14,S=window.innerHeight-T>190?T:Math.max(12,d.top-200);L={left:Math.min(Math.max(12,d.left+d.width/2-ea/2),window.innerWidth-ea-12),top:S,width:ea}}return Lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Zt,top:d.top-Zt,width:d.width+Zt*2,height:d.height+Zt*2}}),(y||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:L,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(Un,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>c(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Un,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>c(T=>Math.max(0,T-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>c(T=>T+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Rr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Fr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ks(){var z,S;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:c,dispatch:d}=D(),f=r?a:e,s=m.useMemo(()=>f.filter(j=>lt(j.date)===0&&j.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(j=>j.kind==="target"&&ze(j)===0).slice().sort((j,M)=>(M.date||"").localeCompare(j.date||"")):[],[a,r]),u=m.useMemo(()=>s.filter(j=>r?ze(j)===0:!Oe(j)),[s,r]),g=r?x:u,p=r?a.length-x.length:s.length-u.length,b=r?a.length:s.length,y=b?Math.min(100,p/b*100):100,h=m.useMemo(()=>Rr(f),[f]),N=!!h&&lt(h)>0,C=m.useMemo(()=>N?f.filter(j=>(j.date||"").slice(0,10)===h):[],[f,h,N]),w=typeof((z=c.stats)==null?void 0:z.kept_today)=="number"?c.stats.kept_today:null,A=typeof((S=c.stats)==null?void 0:S.screened_today)=="number"?c.stats.screened_today:s.length;let L;N?L=i.morningLast(C.length,x.length,Fr(h,l)):r?L=i.morningThesis(A,x.length,w):s.length?p===0?L=i.goalSourced(s.length):p>=s.length?L=i.goalCleared:L=i.goalDone(p,s.length):L=i.goalSourced(0);const T=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&x.length&&d({type:"chainStart",queue:x.map(j=>j.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:L}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),g.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:T,children:r?i.morningEval(g.length):o.pileMode?i.goalContinue(g.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function js(){var H,U;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:c,mode:d,doSync:f,startTour:s,flash:x,flashErr:u}=D(),[g,p]=m.useState(null),[b,y]=m.useState(!0),[h,N]=m.useState([]),C=d==="client";m.useEffect(()=>{if(!i||!o)return;let I=!0;return y(!0),(async()=>{const[W,K]=await Promise.all([sn(o),jr(i)]);I&&(W&&p(W),y(!1),N(K))})(),()=>{I=!1}},[i,o]);const[w,A]=m.useState(!1),L=()=>{!C||w||!o||(A(!0),Uo(o).then(I=>{A(!1),I?x(e.identRepubDone):u(e.actErr)}))},T=(g==null?void 0:g.per_day)??null,z=((H=g==null?void 0:g.pool_order)==null?void 0:H.length)??0,S=h.filter(I=>I.status==="running").length,j=m.useMemo(()=>c.filter(I=>I.kind==="target"&&Oe(I)).length,[c]),M=l.marketEstimate,P=typeof((U=l.stats)==null?void 0:U.screened)=="number"?l.stats.screened:j,O=M&&M>0?Math.min(100,Math.round(P/M*100)):null,B=I=>I.toLocaleString(a==="en"?"en-US":"fr-FR"),v=(o||"P").split(/\s+/).map(I=>I[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const I=Date.parse(l.generatedAt||"");if(Number.isNaN(I))return"";const W=new Date(I),K=Q=>String(Q).padStart(2,"0");return`${K(W.getDate())}/${K(W.getMonth()+1)} à ${K(W.getHours())}:${K(W.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?v:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[O===null&&P>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:B(P)})})]}),O!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:O+"%"}})}),t.jsxs("b",{children:[O," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(P,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),T!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:T})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),T===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),S>0&&t.jsxs("span",{className:"ev",children:["⏳ ",S]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(z)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:I=>{I.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!C||w,onClick:L,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!C,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:I=>n({type:"filters",patch:{search:I.target.value}})})]})]})]})}function Ns(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=D(),c=o.loading&&!l.length,d=m.useRef({});m.useEffect(()=>{d.current={...r}},[r]);const f=u=>{const g=d.current[u],p=g!==void 0?r[u]-g:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Oa[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},s=(u,g,p)=>t.jsxs("button",{type:"button",className:"off"+(g?" view":""),style:{"--c":`var(${Oa[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),x=(u,g,p,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:g,disabled:b,onClick:p,children:u},g);return t.jsxs("div",{className:"funnel"+(c?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Ss(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=D(),c=m.useRef(null),[d,f]=m.useState(60);m.useEffect(()=>{let p=0;const b=()=>{var w;const y=c.current;if(!y)return;const h=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!h)return;const N=h.getBoundingClientRect(),C=y.getBoundingClientRect();f(Math.max(20,Math.min(N.left+N.width/2-C.left,C.width-30)))};return p=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const p=n.filter(h=>h.kind==="target"&&ze(h)===3),b=p.filter(h=>Pa(h)==="auto").length,y=p.filter(h=>Pa(h)==="cd").length;x=r.tutoPending(b,y,p.length)}const u=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(s===1){const p=n.filter(b=>b.kind==="target"&&ze(b)===1&&!i.has(b.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(b=>b.id)})}}return null})(),g=Ho(s);return t.jsxs("div",{ref:c,className:"tuto mini"+(g?"":" on-dark"),style:{"--bg":`var(${Oa[s]})`,"--ax":d+"px","--stc":g?"var(--ink)":"#fff","--stt":g?"#fff":"var(--ink)","--tc":g?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class vt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,c=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);c&&(r[n++]=c),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Es(e){for(const a of e)yield*a}function Or(e){return Array.from(Es(e))}var be=1e-6,de=Math.PI,Ke=de/2,Hn=de/4,Je=de*2,it=180/de,$e=de/180,Ne=Math.abs,Cs=Math.atan,Bt=Math.atan2,Ee=Math.cos,Ce=Math.sin,zs=Math.sign||function(e){return e>0?1:e<0?-1:0},kt=Math.sqrt;function As(e){return e>1?0:e<-1?de:Math.acos(e)}function _t(e){return e>1?Ke:e<-1?-Ke:Math.asin(e)}function Qe(){}function fa(e,a){e&&Wn.hasOwnProperty(e.type)&&Wn[e.type](e,a)}var Vn={Feature:function(e,a){fa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)fa(r[n].geometry,a)}},Wn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){_a(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)_a(r[n],a,0)},Polygon:function(e,a){Yn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Yn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)fa(r[n],a)}};function _a(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Yn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)_a(e[r],a,1);a.polygonEnd()}function Nt(e,a){e&&Vn.hasOwnProperty(e.type)?Vn[e.type](e,a):fa(e,a)}function Ua(e){return[Bt(e[1],e[0]),_t(e[2])]}function zt(e){var a=e[0],r=e[1],n=Ee(r);return[n*Ee(a),n*Ce(a),Ce(r)]}function ta(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function xa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function La(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function aa(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Ha(e){var a=kt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Va(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Wa(e,a){return Ne(e)>de&&(e-=Math.round(e/Je)*Je),[e,a]}Wa.invert=Wa;function Ts(e,a,r){return(e%=Je)?a||r?Va(Kn(e),Qn(a,r)):Kn(e):a||r?Qn(a,r):Wa}function Gn(e){return function(a,r){return a+=e,Ne(a)>de&&(a-=Math.round(a/Je)*Je),[a,r]}}function Kn(e){var a=Gn(e);return a.invert=Gn(-e),a}function Qn(e,a){var r=Ee(e),n=Ce(e),i=Ee(a),o=Ce(a);function l(c,d){var f=Ee(d),s=Ee(c)*f,x=Ce(c)*f,u=Ce(d),g=u*r+s*n;return[Bt(x*i-g*o,s*r-u*n),_t(g*i+x*o)]}return l.invert=function(c,d){var f=Ee(d),s=Ee(c)*f,x=Ce(c)*f,u=Ce(d),g=u*i-x*o;return[Bt(x*i+u*o,s*r+g*n),_t(g*r-s*n)]},l}function Ls(e,a,r,n,i,o){if(r){var l=Ee(a),c=Ce(a),d=n*r;i==null?(i=a+n*Je,o=a-d/2):(i=Jn(l,i),o=Jn(l,o),(n>0?i<o:i>o)&&(i+=n*Je));for(var f,s=i;n>0?s>o:s<o;s-=d)f=Ua([l,-c*Ee(s),-c*Ce(s)]),e.point(f[0],f[1])}}function Jn(e,a){a=zt(a),a[0]-=e,Ha(a);var r=As(-a[1]);return((-a[2]<0?-r:r)+Je-be)%Je}function Pr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Qe,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function la(e,a){return Ne(e[0]-a[0])<be&&Ne(e[1]-a[1])<be}function na(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Dr(e,a,r,n,i){var o=[],l=[],c,d;if(e.forEach(function(p){if(!((b=p.length-1)<=0)){var b,y=p[0],h=p[b],N;if(la(y,h)){if(!y[2]&&!h[2]){for(i.lineStart(),c=0;c<b;++c)i.point((y=p[c])[0],y[1]);i.lineEnd();return}h[0]+=2*be}o.push(N=new na(y,p,null,!0)),l.push(N.o=new na(y,null,N,!1)),o.push(N=new na(h,p,null,!1)),l.push(N.o=new na(h,null,N,!0))}}),!!o.length){for(l.sort(a),Xn(o),Xn(l),c=0,d=l.length;c<d;++c)l[c].e=r=!r;for(var f=o[0],s,x;;){for(var u=f,g=!0;u.v;)if((u=u.n)===f)return;s=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(g)for(c=0,d=s.length;c<d;++c)i.point((x=s[c])[0],x[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(g)for(s=u.p.z,c=s.length-1;c>=0;--c)i.point((x=s[c])[0],x[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,s=u.z,g=!g}while(!u.v);i.lineEnd()}}}function Xn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function qa(e){return Ne(e[0])<=de?e[0]:zs(e[0])*((Ne(e[0])+de)%Je-de)}function qs(e,a){var r=qa(a),n=a[1],i=Ce(n),o=[Ce(r),-Ee(r),0],l=0,c=0,d=new vt;i===1?n=Ke+be:i===-1&&(n=-Ke-be);for(var f=0,s=e.length;f<s;++f)if(u=(x=e[f]).length)for(var x,u,g=x[u-1],p=qa(g),b=g[1]/2+Hn,y=Ce(b),h=Ee(b),N=0;N<u;++N,p=w,y=L,h=T,g=C){var C=x[N],w=qa(C),A=C[1]/2+Hn,L=Ce(A),T=Ee(A),z=w-p,S=z>=0?1:-1,j=S*z,M=j>de,P=y*L;if(d.add(Bt(P*S*Ce(j),h*T+P*Ee(j))),l+=M?z+S*Je:z,M^p>=r^w>=r){var O=xa(zt(g),zt(C));Ha(O);var B=xa(o,O);Ha(B);var v=(M^z>=0?-1:1)*_t(B[2]);(n>v||n===v&&(O[0]||O[1]))&&(c+=M^z>=0?1:-1)}}return(l<-be||l<be&&d<-1e-12)^c&1}function Ir(e,a,r,n){return function(i){var o=a(i),l=Pr(),c=a(l),d=!1,f,s,x,u={point:g,lineStart:b,lineEnd:y,polygonStart:function(){u.point=h,u.lineStart=N,u.lineEnd=C,s=[],f=[]},polygonEnd:function(){u.point=g,u.lineStart=b,u.lineEnd=y,s=Or(s);var w=qs(f,n);s.length?(d||(i.polygonStart(),d=!0),Dr(s,Rs,w,r,i)):w&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function g(w,A){e(w,A)&&i.point(w,A)}function p(w,A){o.point(w,A)}function b(){u.point=p,o.lineStart()}function y(){u.point=g,o.lineEnd()}function h(w,A){x.push([w,A]),c.point(w,A)}function N(){c.lineStart(),x=[]}function C(){h(x[0][0],x[0][1]),c.lineEnd();var w=c.clean(),A=l.result(),L,T=A.length,z,S,j;if(x.pop(),f.push(x),x=null,!!T){if(w&1){if(S=A[0],(z=S.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),L=0;L<z;++L)i.point((j=S[L])[0],j[1]);i.lineEnd()}return}T>1&&w&2&&A.push(A.pop().concat(A.shift())),s.push(A.filter(Ms))}}return u}}function Ms(e){return e.length>1}function Rs(e,a){return((e=e.x)[0]<0?e[1]-Ke-be:Ke-e[1])-((a=a.x)[0]<0?a[1]-Ke-be:Ke-a[1])}const Zn=Ir(function(){return!0},Fs,Ps,[-de,-Ke]);function Fs(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var c=o>0?de:-de,d=Ne(o-a);Ne(d-de)<be?(e.point(a,r=(r+l)/2>0?Ke:-Ke),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),e.point(o,r),i=0):n!==c&&d>=de&&(Ne(a-n)<be&&(a-=n*be),Ne(o-c)<be&&(o-=c*be),r=Os(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),i=0),e.point(a=o,r=l),n=c},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Os(e,a,r,n){var i,o,l=Ce(e-r);return Ne(l)>be?Cs((Ce(a)*(o=Ee(n))*Ce(r)-Ce(n)*(i=Ee(a))*Ce(e))/(i*o*l)):(a+n)/2}function Ps(e,a,r,n){var i;if(e==null)i=r*Ke,n.point(-de,i),n.point(0,i),n.point(de,i),n.point(de,0),n.point(de,-i),n.point(0,-i),n.point(-de,-i),n.point(-de,0),n.point(-de,i);else if(Ne(e[0]-a[0])>be){var o=e[0]<a[0]?de:-de;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ds(e){var a=Ee(e),r=2*$e,n=a>0,i=Ne(a)>be;function o(s,x,u,g){Ls(g,e,r,u,s,x)}function l(s,x){return Ee(s)*Ee(x)>a}function c(s){var x,u,g,p,b;return{lineStart:function(){p=g=!1,b=1},point:function(y,h){var N=[y,h],C,w=l(y,h),A=n?w?0:f(y,h):w?f(y+(y<0?de:-de),h):0;if(!x&&(p=g=w)&&s.lineStart(),w!==g&&(C=d(x,N),(!C||la(x,C)||la(N,C))&&(N[2]=1)),w!==g)b=0,w?(s.lineStart(),C=d(N,x),s.point(C[0],C[1])):(C=d(x,N),s.point(C[0],C[1],2),s.lineEnd()),x=C;else if(i&&x&&n^w){var L;!(A&u)&&(L=d(N,x,!0))&&(b=0,n?(s.lineStart(),s.point(L[0][0],L[0][1]),s.point(L[1][0],L[1][1]),s.lineEnd()):(s.point(L[1][0],L[1][1]),s.lineEnd(),s.lineStart(),s.point(L[0][0],L[0][1],3)))}w&&(!x||!la(x,N))&&s.point(N[0],N[1]),x=N,g=w,u=A},lineEnd:function(){g&&s.lineEnd(),x=null},clean:function(){return b|(p&&g)<<1}}}function d(s,x,u){var g=zt(s),p=zt(x),b=[1,0,0],y=xa(g,p),h=ta(y,y),N=y[0],C=h-N*N;if(!C)return!u&&s;var w=a*h/C,A=-a*N/C,L=xa(b,y),T=aa(b,w),z=aa(y,A);La(T,z);var S=L,j=ta(T,S),M=ta(S,S),P=j*j-M*(ta(T,T)-1);if(!(P<0)){var O=kt(P),B=aa(S,(-j-O)/M);if(La(B,T),B=Ua(B),!u)return B;var v=s[0],q=x[0],H=s[1],U=x[1],I;q<v&&(I=v,v=q,q=I);var W=q-v,K=Ne(W-de)<be,Q=K||W<be;if(!K&&U<H&&(I=H,H=U,U=I),Q?K?H+U>0^B[1]<(Ne(B[0]-v)<be?H:U):H<=B[1]&&B[1]<=U:W>de^(v<=B[0]&&B[0]<=q)){var le=aa(S,(-j+O)/M);return La(le,T),[B,Ua(le)]}}}function f(s,x){var u=n?e:de-e,g=0;return s<-u?g|=1:s>u&&(g|=2),x<-u?g|=4:x>u&&(g|=8),g}return Ir(l,c,o,n?[0,-e]:[-de,e-de])}function Is(e,a,r,n,i,o){var l=e[0],c=e[1],d=a[0],f=a[1],s=0,x=1,u=d-l,g=f-c,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<s)return;p<x&&(x=p)}else if(u>0){if(p>x)return;p>s&&(s=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>x)return;p>s&&(s=p)}else if(u>0){if(p<s)return;p<x&&(x=p)}if(p=n-c,!(!g&&p>0)){if(p/=g,g<0){if(p<s)return;p<x&&(x=p)}else if(g>0){if(p>x)return;p>s&&(s=p)}if(p=o-c,!(!g&&p<0)){if(p/=g,g<0){if(p>x)return;p>s&&(s=p)}else if(g>0){if(p<s)return;p<x&&(x=p)}return s>0&&(e[0]=l+s*u,e[1]=c+s*g),x<1&&(a[0]=l+x*u,a[1]=c+x*g),!0}}}}}var Ft=1e9,ra=-Ft;function $s(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,u){var g=0,p=0;if(f==null||(g=l(f,x))!==(p=l(s,x))||d(f,s)<0^x>0)do u.point(g===0||g===3?e:r,g>1?n:a);while((g=(g+x+4)%4)!==p);else u.point(s[0],s[1])}function l(f,s){return Ne(f[0]-e)<be?s>0?0:3:Ne(f[0]-r)<be?s>0?2:1:Ne(f[1]-a)<be?s>0?1:0:s>0?3:2}function c(f,s){return d(f.x,s.x)}function d(f,s){var x=l(f,1),u=l(s,1);return x!==u?x-u:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=Pr(),u,g,p,b,y,h,N,C,w,A,L,T={point:z,lineStart:P,lineEnd:O,polygonStart:j,polygonEnd:M};function z(v,q){i(v,q)&&s.point(v,q)}function S(){for(var v=0,q=0,H=g.length;q<H;++q)for(var U=g[q],I=1,W=U.length,K=U[0],Q,le,ae=K[0],ve=K[1];I<W;++I)Q=ae,le=ve,K=U[I],ae=K[0],ve=K[1],le<=n?ve>n&&(ae-Q)*(n-le)>(ve-le)*(e-Q)&&++v:ve<=n&&(ae-Q)*(n-le)<(ve-le)*(e-Q)&&--v;return v}function j(){s=x,u=[],g=[],L=!0}function M(){var v=S(),q=L&&v,H=(u=Or(u)).length;(q||H)&&(f.polygonStart(),q&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),H&&Dr(u,c,v,o,f),f.polygonEnd()),s=f,u=g=p=null}function P(){T.point=B,g&&g.push(p=[]),A=!0,w=!1,N=C=NaN}function O(){u&&(B(b,y),h&&w&&x.rejoin(),u.push(x.result())),T.point=z,w&&s.lineEnd()}function B(v,q){var H=i(v,q);if(g&&p.push([v,q]),A)b=v,y=q,h=H,A=!1,H&&(s.lineStart(),s.point(v,q));else if(H&&w)s.point(v,q);else{var U=[N=Math.max(ra,Math.min(Ft,N)),C=Math.max(ra,Math.min(Ft,C))],I=[v=Math.max(ra,Math.min(Ft,v)),q=Math.max(ra,Math.min(Ft,q))];Is(U,I,e,a,r,n)?(w||(s.lineStart(),s.point(U[0],U[1])),s.point(I[0],I[1]),H||s.lineEnd(),L=!1):H&&(s.lineStart(),s.point(v,q),L=!1)}N=v,C=q,w=H}return T}}const Ya=e=>e;var Ma=new vt,Ga=new vt,$r,Br,Ka,Qa,st={point:Qe,lineStart:Qe,lineEnd:Qe,polygonStart:function(){st.lineStart=Bs,st.lineEnd=Us},polygonEnd:function(){st.lineStart=st.lineEnd=st.point=Qe,Ma.add(Ne(Ga)),Ga=new vt},result:function(){var e=Ma/2;return Ma=new vt,e}};function Bs(){st.point=_s}function _s(e,a){st.point=_r,$r=Ka=e,Br=Qa=a}function _r(e,a){Ga.add(Qa*e-Ka*a),Ka=e,Qa=a}function Us(){_r($r,Br)}var At=1/0,ha=At,Ut=-At,ga=Ut,ba={point:Hs,lineStart:Qe,lineEnd:Qe,polygonStart:Qe,polygonEnd:Qe,result:function(){var e=[[At,ha],[Ut,ga]];return Ut=ga=-(ha=At=1/0),e}};function Hs(e,a){e<At&&(At=e),e>Ut&&(Ut=e),a<ha&&(ha=a),a>ga&&(ga=a)}var Ja=0,Xa=0,Ot=0,va=0,ya=0,St=0,Za=0,en=0,Pt=0,Ur,Hr,tt,at,Ge={point:yt,lineStart:er,lineEnd:tr,polygonStart:function(){Ge.lineStart=Ys,Ge.lineEnd=Gs},polygonEnd:function(){Ge.point=yt,Ge.lineStart=er,Ge.lineEnd=tr},result:function(){var e=Pt?[Za/Pt,en/Pt]:St?[va/St,ya/St]:Ot?[Ja/Ot,Xa/Ot]:[NaN,NaN];return Ja=Xa=Ot=va=ya=St=Za=en=Pt=0,e}};function yt(e,a){Ja+=e,Xa+=a,++Ot}function er(){Ge.point=Vs}function Vs(e,a){Ge.point=Ws,yt(tt=e,at=a)}function Ws(e,a){var r=e-tt,n=a-at,i=kt(r*r+n*n);va+=i*(tt+e)/2,ya+=i*(at+a)/2,St+=i,yt(tt=e,at=a)}function tr(){Ge.point=yt}function Ys(){Ge.point=Ks}function Gs(){Vr(Ur,Hr)}function Ks(e,a){Ge.point=Vr,yt(Ur=tt=e,Hr=at=a)}function Vr(e,a){var r=e-tt,n=a-at,i=kt(r*r+n*n);va+=i*(tt+e)/2,ya+=i*(at+a)/2,St+=i,i=at*e-tt*a,Za+=i*(tt+e),en+=i*(at+a),Pt+=i*3,yt(tt=e,at=a)}function Wr(e){this._context=e}Wr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Je);break}}},result:Qe};var tn=new vt,Ra,Yr,Gr,Dt,It,Ht={point:Qe,lineStart:function(){Ht.point=Qs},lineEnd:function(){Ra&&Kr(Yr,Gr),Ht.point=Qe},polygonStart:function(){Ra=!0},polygonEnd:function(){Ra=null},result:function(){var e=+tn;return tn=new vt,e}};function Qs(e,a){Ht.point=Kr,Yr=Dt=e,Gr=It=a}function Kr(e,a){Dt-=e,It-=a,tn.add(kt(Dt*Dt+It*It)),Dt=e,It=a}let ar,wa,nr,rr;class or{constructor(a){this._append=a==null?Qr:Js(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==nr||this._append!==wa){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,nr=n,wa=this._append,rr=this._,this._=i}this._+=rr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Qr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Js(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Qr;if(a!==ar){const r=10**a;ar=a,wa=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return wa}function Xs(e,a){let r=3,n=4.5,i,o;function l(c){return c&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Nt(c,i(o))),o.result()}return l.area=function(c){return Nt(c,i(st)),st.result()},l.measure=function(c){return Nt(c,i(Ht)),Ht.result()},l.bounds=function(c){return Nt(c,i(ba)),ba.result()},l.centroid=function(c){return Nt(c,i(Ge)),Ge.result()},l.projection=function(c){return arguments.length?(i=c==null?(e=null,Ya):(e=c).stream,l):e},l.context=function(c){return arguments.length?(o=c==null?(a=null,new or(r)):new Wr(a=c),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(c){return arguments.length?(n=typeof c=="function"?c:(o.pointRadius(+c),+c),l):n},l.digits=function(c){if(!arguments.length)return r;if(c==null)r=null;else{const d=Math.floor(c);if(!(d>=0))throw new RangeError(`invalid digits: ${c}`);r=d}return a===null&&(o=new or(r)),l},l.projection(e).digits(r).context(a)}function mn(e){return function(a){var r=new an;for(var n in e)r[n]=e[n];return r.stream=a,r}}function an(){}an.prototype={constructor:an,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function fn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Nt(r,e.stream(ba)),a(ba.result()),n!=null&&e.clipExtent(n),e}function Jr(e,a,r){return fn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),c=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([c,d])},r)}function Zs(e,a,r){return Jr(e,[[0,0],a],r)}function el(e,a,r){return fn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,c=-o*n[0][1];e.scale(150*o).translate([l,c])},r)}function tl(e,a,r){return fn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],c=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,c])},r)}var ir=16,al=Ee(30*$e);function sr(e,a){return+a?rl(e,a):nl(e)}function nl(e){return mn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function rl(e,a){function r(n,i,o,l,c,d,f,s,x,u,g,p,b,y){var h=f-n,N=s-i,C=h*h+N*N;if(C>4*a&&b--){var w=l+u,A=c+g,L=d+p,T=kt(w*w+A*A+L*L),z=_t(L/=T),S=Ne(Ne(L)-1)<be||Ne(o-x)<be?(o+x)/2:Bt(A,w),j=e(S,z),M=j[0],P=j[1],O=M-n,B=P-i,v=N*O-h*B;(v*v/C>a||Ne((h*O+N*B)/C-.5)>.3||l*u+c*g+d*p<al)&&(r(n,i,o,l,c,d,M,P,S,w/=T,A/=T,L,b,y),y.point(M,P),r(M,P,S,w,A,L,f,s,x,u,g,p,b,y))}}return function(n){var i,o,l,c,d,f,s,x,u,g,p,b,y={point:h,lineStart:N,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=A},polygonEnd:function(){n.polygonEnd(),y.lineStart=N}};function h(z,S){z=e(z,S),n.point(z[0],z[1])}function N(){x=NaN,y.point=C,n.lineStart()}function C(z,S){var j=zt([z,S]),M=e(z,S);r(x,u,s,g,p,b,x=M[0],u=M[1],s=z,g=j[0],p=j[1],b=j[2],ir,n),n.point(x,u)}function w(){y.point=h,n.lineEnd()}function A(){N(),y.point=L,y.lineEnd=T}function L(z,S){C(i=z,S),o=x,l=u,c=g,d=p,f=b,y.point=C}function T(){r(x,u,s,g,p,b,o,l,i,c,d,f,ir,n),y.lineEnd=w,w()}return y}}var ol=mn({point:function(e,a){this.stream.point(e*$e,a*$e)}});function il(e){return mn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function sl(e,a,r,n,i){function o(l,c){return l*=n,c*=i,[a+e*l,r-e*c]}return o.invert=function(l,c){return[(l-a)/e*n,(r-c)/e*i]},o}function lr(e,a,r,n,i,o){if(!o)return sl(e,a,r,n,i);var l=Ee(o),c=Ce(o),d=l*e,f=c*e,s=l/e,x=c/e,u=(c*r-l*a)/e,g=(c*a+l*r)/e;function p(b,y){return b*=n,y*=i,[d*b-f*y+a,r-f*b-d*y]}return p.invert=function(b,y){return[n*(s*b-x*y+u),i*(g-x*b-s*y)]},p}function ll(e){return cl(function(){return e})()}function cl(e){var a,r=150,n=480,i=250,o=0,l=0,c=0,d=0,f=0,s,x=0,u=1,g=1,p=null,b=Zn,y=null,h,N,C,w=Ya,A=.5,L,T,z,S,j;function M(v){return z(v[0]*$e,v[1]*$e)}function P(v){return v=z.invert(v[0],v[1]),v&&[v[0]*it,v[1]*it]}M.stream=function(v){return S&&j===v?S:S=ol(il(s)(b(L(w(j=v)))))},M.preclip=function(v){return arguments.length?(b=v,p=void 0,B()):b},M.postclip=function(v){return arguments.length?(w=v,y=h=N=C=null,B()):w},M.clipAngle=function(v){return arguments.length?(b=+v?Ds(p=v*$e):(p=null,Zn),B()):p*it},M.clipExtent=function(v){return arguments.length?(w=v==null?(y=h=N=C=null,Ya):$s(y=+v[0][0],h=+v[0][1],N=+v[1][0],C=+v[1][1]),B()):y==null?null:[[y,h],[N,C]]},M.scale=function(v){return arguments.length?(r=+v,O()):r},M.translate=function(v){return arguments.length?(n=+v[0],i=+v[1],O()):[n,i]},M.center=function(v){return arguments.length?(o=v[0]%360*$e,l=v[1]%360*$e,O()):[o*it,l*it]},M.rotate=function(v){return arguments.length?(c=v[0]%360*$e,d=v[1]%360*$e,f=v.length>2?v[2]%360*$e:0,O()):[c*it,d*it,f*it]},M.angle=function(v){return arguments.length?(x=v%360*$e,O()):x*it},M.reflectX=function(v){return arguments.length?(u=v?-1:1,O()):u<0},M.reflectY=function(v){return arguments.length?(g=v?-1:1,O()):g<0},M.precision=function(v){return arguments.length?(L=sr(T,A=v*v),B()):kt(A)},M.fitExtent=function(v,q){return Jr(M,v,q)},M.fitSize=function(v,q){return Zs(M,v,q)},M.fitWidth=function(v,q){return el(M,v,q)},M.fitHeight=function(v,q){return tl(M,v,q)};function O(){var v=lr(r,0,0,u,g,x).apply(null,a(o,l)),q=lr(r,n-v[0],i-v[1],u,g,x);return s=Ts(c,d,f),T=Va(a,q),z=Va(s,T),L=sr(T,A),B()}function B(){return S=j=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&P,O()}}function Xr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Xr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(Ne(i)>be&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function dl(){return ll(Xr).scale(175.295)}function pl(e){return e}function ul(e){if(e==null)return pl;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(c,d){d||(a=r=0);var f=2,s=c.length,x=new Array(s);for(x[0]=(a+=c[0])*n+o,x[1]=(r+=c[1])*i+l;f<s;)x[f]=c[f],++f;return x}}function ml(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function fl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return cr(e,r)})}:cr(e,a)}function cr(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=xl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function xl(e,a){var r=ul(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var u=n[s<0?~s:s],g=0,p=u.length;g<p;++g)x.push(r(u[g],g));s<0&&ml(x,p)}function o(s){return r(s)}function l(s){for(var x=[],u=0,g=s.length;u<g;++u)i(s[u],x);return x.length<2&&x.push(x[0]),x}function c(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function d(s){return s.map(c)}function f(s){var x=s.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":u=o(s.coordinates);break;case"MultiPoint":u=s.coordinates.map(o);break;case"LineString":u=l(s.arcs);break;case"MultiLineString":u=s.arcs.map(l);break;case"Polygon":u=d(s.arcs);break;case"MultiPolygon":u=s.arcs.map(d);break;default:return null}return{type:x,coordinates:u}}return f(a)}const Zr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},hl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function gl(e,a,r){const n=Zr[e];if(!n||!n.length)return-1;const i=hl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let oa=null;function bl(){return oa||(oa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=fl(r,n),o=dl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Xs(o),c=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var g;const x=((g=s.properties)==null?void 0:g.name)||"",u=l(s)||"";return u?{i2:Vo(x)||null,n:x,d:u}:null}).filter(s=>!!s);if(!c.length)return null;const d={};for(const[s,x]of Object.entries(Wo)){const u=o(x);u&&(d[s]={x:u[0],y:u[1]})}const f={};for(const[s,x]of Object.entries(Zr)){const u=x.map(g=>o(g.ll)).filter(g=>!!g).map(([g,p])=>({x:g,y:p}));u.length&&(f[s]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:c,anchors:d,metros:f}}catch{return null}})(),oa)}function vl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return bl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const yl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},dr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function pr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function wl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const d=(f=e.current)==null?void 0:f.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(l)};l();const c=new ResizeObserver(()=>l());return e.current&&c.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),c.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function ur({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function kl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:c,t:d,data:f,dossiers:s,source:x}=D(),u=f.loading&&!s.length,g=m.useRef(null),p=m.useRef(null),b=vl(e.continent==="monde"),y=e.continent==="monde"?b:ln.find(v=>v.key===e.continent)||null,h=wl(g,e.continent+":"+e.mapFolded+":"+!!y),[N,C]=m.useState(new Map),[w,A]=m.useState(null);m.useEffect(()=>{const v=g.current;if(!v)return;const q=new Map;v.querySelectorAll("path[data-i2]").forEach(H=>{const U=H.dataset.i2;if(U)try{const I=H.getBBox();I.width>0&&q.set(U,{x:I.x,y:I.y,w:I.width,h:I.height})}catch{}}),C(q)},[e.continent,h,y]);const L=m.useMemo(()=>r.filter(v=>v.cc),[r]),T=m.useMemo(()=>{const v=new Map;return L.forEach(q=>v.set(q.cc,(v.get(q.cc)||0)+1)),v},[L]),z=e.continent==="monde"&&b?b.anchors:null,S=e.continent==="monde"&&b?b.metros:null,j=m.useMemo(()=>L.map(v=>{const q=pr(v.name||v.id||""),H=pr((v.id||v.name||"")+"·y");if(z&&v.cc){const Q=S?S[v.cc]:void 0;if(Q&&Q.length){const ae=gl(v.cc,v.city,q);if(ae>=0&&Q[ae])return{d:v,x:Q[ae].x+(q-.5)*5,y:Q[ae].y+(H-.5)*5}}const le=z[v.cc];if(le)return{d:v,x:le.x+(q-.5)*10,y:le.y+(H-.5)*10}}const U=v.cc?N.get(v.cc):void 0;if(!U)return null;const I=yl[`${e.continent}:${v.cc||""}`];if(I)return{d:v,x:U.x+U.w*(I.fx+(q-.5)*I.sx),y:U.y+U.h*(I.fy+(H-.5)*I.sy)};const W=(q-.5)*Math.min(U.w*.55,60),K=(H-.5)*Math.min(U.h*.55,60);return{d:v,x:U.x+U.w/2+W,y:U.y+U.h/2+K}}).filter(v=>!!v),[L,N,z,S,e.continent]),M=v=>h>0?v/h:v,P=m.useMemo(()=>n?[0,1,2,3,4,5].map(v=>({c:dr[v],fr:d.plabels[v].toUpperCase(),en:d.plabels[v].toUpperCase(),n:r.filter(q=>q.kind==="target"&&ze(q)===v).length})).filter(v=>v.n>0):An.map((v,q)=>({...v,n:r.filter(H=>Tn(H)===q).length})),[r,n,d.plabels]),O=o?l.get(o):null,B=O?j.find(v=>v.d.id===O.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:[u&&t.jsx(ur,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:g,viewBox:y.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":c==="fr"?y.fr:y.en,onMouseLeave:()=>{A(null),i(null)},children:[t.jsx("g",{children:y.countries.map((v,q)=>t.jsx("g",{className:"ct"+(v.i2&&T.get(v.i2)?"":" empty"),children:t.jsx("path",{d:v.d,"data-i2":v.i2||void 0})},q))}),t.jsx("g",{children:j.map(v=>{const q=An[Tn(v.d)],H=!!Le(v.d),U=v.d.kind==="target",I=n&&U?dr[ze(v.d)]:q.c,W=!n&&Oe(v.d);return t.jsxs("g",{className:"co"+(W?" done":""),onMouseEnter:()=>{var le,ae;const K=(le=p.current)==null?void 0:le.getBoundingClientRect(),Q=(ae=g.current)==null?void 0:ae.createSVGPoint();if(Q&&g.current&&K){Q.x=v.x,Q.y=v.y;const ve=Q.matrixTransform(g.current.getScreenCTM());A({x:ve.x-K.left,y:ve.y-K.top,label:v.d.name+" · "+(qt(v.d.cc,c)||v.d.countryLabel||"")})}i(v.d.id)},onMouseLeave:()=>{A(null),i(null)},onClick:()=>{var le;if(x==="ops"){a({type:"focus",id:v.d.id}),(v.d.noCo||["media","nominations","recrutements"].includes(v.d.engine||""))&&(v.d.url||v.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:v.d.url||"",text:[v.d.headline,v.d.tagline].filter(Boolean).join(`
`)}})):v.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:v.d.name}}));return}const K=(le=g.current)==null?void 0:le.createSVGPoint();let Q=null;if(K&&g.current){K.x=v.x,K.y=v.y;const ae=K.matrixTransform(g.current.getScreenCTM());Q={x:ae.x,y:ae.y}}a({type:"popup",id:v.d.id,anchor:Q})},children:[t.jsx("circle",{className:"h",cx:v.x,cy:v.y,r:M(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:v.x,cy:v.y,r:M(q.px),fill:I,stroke:H?"#DC2626":"#ffffff",strokeWidth:M(H?2.2:1.3)})]},v.d.id||v.d.name)})}),B&&t.jsx("circle",{className:"ring on",cx:B.x,cy:B.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:P.map((v,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":v.c}}),c==="fr"?v.fr:v.en," ",t.jsx("b",{children:v.n})]},q))}),r.some(v=>!v.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(v=>!v.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:p,children:t.jsx(ur,{msgs:d.loadMsgs})})}function jl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function eo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:c}=D(),d=a.filters,[f,s]=m.useState(!1),x=m.useRef(null),u=m.useMemo(()=>a.continent==="monde"?n:n.filter(z=>z.continent===a.continent),[n,a.continent]),g=z=>u.filter(S=>z!=="country"&&d.country.length&&!d.country.includes(S.cc||"")?!1:ua(S,d,o,z==="country"?void 0:z)),p=m.useMemo(()=>{const z=g("win"),S=j=>z.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=j).length;return[S(0),S(7),S(30),z.length]},[u,d,o]),b=m.useMemo(()=>d.day?g("win").filter(z=>(z.date||"").slice(0,10)===d.day).length:0,[u,d,o]),y=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,h=y+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f)return;const z=j=>{var M;(M=x.current)!=null&&M.contains(j.target)||s(!1)},S=j=>{j.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",z),document.addEventListener("keydown",S),()=>{document.removeEventListener("mousedown",z),document.removeEventListener("keydown",S)}},[f]);const N=(z,S,j,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===z,onClick:()=>r({type:"openFacet",facet:z}),children:[t.jsx("span",{className:"fl",children:S}),j>0&&t.jsx("span",{className:"n",children:j}),t.jsx("span",{className:"cv",children:"▾"})]},z),C=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(jl(d.day,c))}),t.jsx("b",{children:b})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((z,S)=>t.jsxs("button",{type:"button","aria-pressed":d.win===z,onClick:()=>r({type:"filters",patch:{win:z}}),children:[t.jsx("span",{className:"sl",children:i.dates[S]}),t.jsx("b",{children:p[S]})]},z))}),w=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:z=>r({type:"filters",patch:{search:z.target.value}})})]}),A=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,d.sector.length),N("pay",i.fCountry,d.country.length),N("det",i.fEngine,d.engine.length),N("sta",i.fStage,d.stage.length),o&&N("ang","Angle",d.angle.length),o&&N("mem","Mémo",d.memoLevel.length)]}),L=(z=!1)=>t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),z&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),T=t.jsxs("div",{className:"fmenu",ref:x,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(y?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(z=>!z),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),y>0&&t.jsx("span",{className:"n",children:y}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:A})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[!d.day&&t.jsx("div",{className:"fstrip-a",children:C}),t.jsxs("div",{className:"fstrip-b",children:[w,T,L(a.mapFolded)]})]}),a.openFacet&&t.jsx(mr,{poolFor:g})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[C,w,A,t.jsx("span",{className:"fgrow"}),L()]}),a.openFacet&&t.jsx(mr,{poolFor:g})]})}function mr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=D(),o=a.filters,l=a.openFacet,{title:c,cols:d,options:f}=m.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(h=>Le(h)),b=new Map;p.forEach(h=>{const N=h.engine||"";b.set(N,(b.get(N)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Da([...b.keys()],i).map(h=>({v:h,label:bt(h)+" "+Be(h,i),n:b.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const p=e("sector"),b=new Map;return p.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y,n:h,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const p=e("country"),b=new Map;return p.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:qt(y,i)||y,n:h,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const p=e("engine"),b=new Map;return p.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Da([...b.keys()],i).map(y=>({v:y,label:bt(y)+" "+Be(y,i)+' <span style="color:var(--dim);font-size:10px">· '+Yo(Go(y),i)+"</span>",n:b.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const p=e("angle"),b=new Map;return p.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,h)=>h[1]-y[1]).map(([y,h])=>({v:y,label:y.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const p=e("memoLevel"),b=new Map;p.forEach(h=>{if(h.kind==="target"){const N=on(h);b.set(N,(b.get(N)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:y[h],n:b.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),g=new Map;return u.forEach(p=>{p.stage&&g.set(p.stage,(g.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...g.entries()].sort((p,b)=>b[1]-p[1]).map(([p,b])=>({v:p,label:p,n:b,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),s=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:c}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:f.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>s(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function to({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:c}=D(),d=m.useMemo(()=>{const g={};return r.forEach(p=>{ua(p,n.filters,o)&&(g.monde=(g.monde||0)+1,p.continent&&(g[p.continent]=(g[p.continent]||0)+1))}),g},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const g=b=>{var y;(y=x.current)!=null&&y.contains(b.target)||s(!1)},p=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",g),document.addEventListener("keydown",p),()=>{document.removeEventListener("mousedown",g),document.removeEventListener("keydown",p)}},[f]);const u=g=>{const p=ln.find(b=>b.key===g);return g==="monde"?c.contWorld:l==="fr"?p.fr:p.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(g=>!g),children:[u(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Ln.map(g=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===g,onClick:()=>{i({type:"continent",key:g}),s(!1)},children:[u(g),t.jsx("span",{className:"n",children:d[g]||0})]},g))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})]}):t.jsxs("div",{className:"conts",children:[Ln.map(g=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===g,onClick:()=>i({type:"continent",key:g}),children:[u(g),t.jsx("span",{className:"n",children:d[g]||0})]},g)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})})]})}function ao(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Nl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function fr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:c}=D();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:c.rsEvalOne})]},d.name))})]}):null}function no({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=D(),i=((e==null?void 0:e.companies_cited)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.what||"").trim(),line2:(c.role||"").trim(),chips:[(c.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.why||"").trim(),chips:[(c.country||"").trim(),(c.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(fr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(fr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Sl({card:e,onEvaluate:a,onAddAll:r}){var c,d,f;const{t:n}=D(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((c=e.prospective)==null?void 0:c.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ao(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(no,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function El(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Cl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=D(),c=i,[d,f]=m.useState(null),[s,x]=m.useState(null),[u,g]=m.useState(null),[p,b]=m.useState(!1);m.useEffect(()=>{let h=!0;return(async()=>{const N=await Nr({email:l,cbToken:c});h&&f(N)})(),()=>{h=!1}},[l,c,n]);const y=h=>{x(h),g(null),b(!0),(async()=>{const N=await Ko(h.id);g(N),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),g(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[El(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(Sl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Fa=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function xr(e){return/^https?:\/\//i.test((e||"").trim())}function zl(e){const a=(e||"").trim(),r=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([\w-]{6,})/i.exec(a);return r?`https://www.youtube.com/embed/${r[1]}?rel=0`:a}function Al(e){try{return new URL(e).hostname.replace(/^www\./,"")}catch{return e}}function Tl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:c,evalCards:d,caps:f,data:s,canWrite:x,source:u,dossiers:g,doAnalyse:p,liveMemos:b,pipe:y}=D(),h=a==="client",N=m.useMemo(()=>r||(u!=="default"?Qo():""),[r,u]),[C,w]=m.useState(""),[A,L]=m.useState(!1),[T,z]=m.useState(""),[S,j]=m.useState(!1),[M,P]=m.useState(""),[O,B]=m.useState(!1),[v,q]=m.useState(""),[H,U]=m.useState([]),I=m.useRef(!1),[W,K]=m.useState(!1),[Q,le]=m.useState(""),[ae,ve]=m.useState(""),[G,pe]=m.useState(!1),[re,ke]=m.useState(""),[me,Z]=m.useState(!1),[ee,J]=m.useState(0),[te,xe]=m.useState(""),[Y,ue]=m.useState(null),[oe,he]=m.useState(null),[De,_e]=m.useState(!1),[qe,Ue]=m.useState(null),[Xe,nt]=m.useState(0),ct=m.useRef(!1),jt=C.trim()?Fa.test(C.trim())?e.evalUrl:e.evalName:e.evalWaiting,E=m.useMemo(()=>M.split(`
`).map(R=>R.trim()).filter(Boolean).slice(0,15),[M]);m.useEffect(()=>{if(typeof window>"u")return;const R=new URLSearchParams(window.location.search),ne=(R.get("rs")||"").trim(),se=(R.get("rstext")||"").trim();ne&&/^https?:\/\//i.test(ne)&&le(ne),se&&ve(se),(ne&&/^https?:\/\//i.test(ne)||se)&&K(!0)},[]),m.useEffect(()=>{const R=ne=>{const se=ne.detail||{},fe=String(se.url||"").trim(),Ve=String(se.text||"").trim();fe&&/^https?:\/\//i.test(fe)&&le(fe),Ve&&ve(Ve),(fe&&/^https?:\/\//i.test(fe)||Ve)&&(K(!0),w(""),z(""),pe(!0),window.setTimeout(()=>pe(!1),900))};return window.addEventListener("ppmap:research",R),()=>window.removeEventListener("ppmap:research",R)},[]),m.useEffect(()=>{const R=ne=>{const se=ne.detail||{},fe=String(se.name||"").trim();fe&&(K(!1),w(fe),z(fe),L(!0),window.setTimeout(()=>L(!1),900))};return window.addEventListener("ppmap:prefill",R),()=>window.removeEventListener("ppmap:prefill",R)},[]),m.useEffect(()=>{const R=ne=>{var fe;const se=String(((fe=ne.detail)==null?void 0:fe.url)||"").trim();xr(se)&&ke(se)};return window.addEventListener("ppmap:view",R),()=>window.removeEventListener("ppmap:view",R)},[]),m.useEffect(()=>{if(!re)return;const R=ne=>{ne.key==="Escape"&&ke("")};return document.addEventListener("keydown",R),()=>document.removeEventListener("keydown",R)},[re]),m.useEffect(()=>{if(typeof window>"u"||u!=="ops")return;const R=document.querySelector(".atl2.ops .eval-stick")||document.querySelector(".atl2.ops .demand"),ne=document.querySelector(".atl2.ops");if(!R||!ne)return;const se=()=>ne.style.setProperty("--demand-h",`${R.offsetHeight}px`);se();const fe=new ResizeObserver(se);return fe.observe(R),()=>fe.disconnect()},[u,A,G,S,W]),m.useEffect(()=>{if(!x&&!N){Ue(null);return}let R=!0;return(async()=>{const ne=await Nr({email:n,cbToken:N});R&&Ue(ne.length)})(),()=>{R=!1}},[x,N,n,Xe]);const _=H.length?H:d,V=s.credits,ie=m.useCallback(R=>{const ne=R.map(se=>(se||"").trim()).filter(Boolean);ne.length&&(P(se=>{const fe=se.split(`
`).map(Se=>Se.trim()).filter(Boolean),Ve=new Set(fe.map(Se=>Se.toLowerCase())),Fe=ne.filter(Se=>!Ve.has(Se.toLowerCase()));return[...fe,...Fe].slice(0,15).join(`
`)}),j(!0))},[]);m.useEffect(()=>{if(!me)return;J(0);const R=window.setInterval(()=>J(ne=>ne+1),1e3);return()=>window.clearInterval(R)},[me]);const ge=m.useMemo(()=>{const R=C.trim().toLowerCase();return!R||!y?null:g.find(ne=>Ye(ne.name)===R&&ze(ne)===1)||null},[C,g,y]),ye=()=>{const R=C.trim();if(R){if(ge){p(ge);return}i(null,R),h&&w("")}},Ie=async()=>{if(!h){i(null,E[0]||"");return}if(!E.length||O)return;B(!0),I.current=!1;const R=[];for(let ne=0;ne<E.length&&!I.current;ne++){q(e.evaluating(ne+1,E.length,E[ne]));const se=await Sr(r,E[ne],"atelier2");if(R.unshift({name:se.company||E[ne],verdict:se.verdict,reason:se.reason||"",remaining:se.remaining??null}),U([...R]),se.verdict==="quota"){R.unshift({name:"",verdict:"quota",reason:e.quota(E.length-ne-1),remaining:0}),U([...R]),P(E.slice(ne+1).join(`
`)),q(""),B(!1);return}}q(""),P(I.current?E.slice(R.length).join(`
`):""),B(!1)},rt=async()=>{var se,fe,Ve;if(ct.current)return;const R=Q.trim().replace(/\s+/g,""),ne=ae.trim();if(!R&&!ne){xe(e.rsNeed);return}if(!h&&!N){i(null,R||ne.slice(0,80));return}ct.current=!0,xe(""),ue(null),he(null),Z(!0);try{const Fe=await Xo({url:R,text:ne,email:n,cbToken:N});if(Z(!1),!Fe||Fe.status!=="success"){xe((Fe==null?void 0:Fe.message)||"Erreur");return}ue(Fe),K(!1),ie((((se=Fe.prospective)==null?void 0:se.companies_to_evaluate)||[]).map(We=>(We==null?void 0:We.name)||"")),he({state:"pending"});const Se=await Zo(Fe,{email:n,cbToken:N});he(Se.ok?{state:"ok",scopeLabel:((fe=Se.summary)==null?void 0:fe.scope_label)||"",scope:((Ve=Se.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:Se.error||""}),Se.ok&&nt(We=>We+1)}finally{ct.current=!1,Z(!1)}},ut=[Y==null?void 0:Y.industry,...(Y==null?void 0:Y.market_tags)||[],Y==null?void 0:Y.author].map(R=>(R||"").trim()).filter(Boolean),ot=(oe==null?void 0:oe.state)==="pending",dt=oe&&(ot?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),mt=Nl(Y).length,Ae=W,He=(T||C).trim(),ja=ge?e.actAnalyse:He?e.evalGoOn(He.length>22?He.slice(0,21)+"…":He):e.evalGo,Na=me?`${Jo(Q.trim())==="youtube"&&Q.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ee)}`:ot?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ae?" rs-mode":"")+(T&&C.trim()===T||A||G?" pair":"")+(A||G?" echo":""),children:[t.jsxs("div",{className:"drow"+((Ae?G:A)?" flash":"")+((Ae?Q.trim():Fa.test(C.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ae?Q:C,placeholder:Ae?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ae?600:200,spellCheck:Ae?!1:void 0,inputMode:Ae?"url":void 0,onChange:R=>{if(Ae){le(R.target.value);return}w(R.target.value),T&&R.target.value.trim()!==T&&z("")},onKeyDown:R=>{R.key==="Enter"&&(Ae?rt():ye())}}),!Ae&&t.jsx("span",{className:"detect"+(Fa.test(C.trim())?" url":""),children:jt})]}),Ae?t.jsxs(t.Fragment,{children:[t.jsx("button",{type:"button",className:"viewbtn"+(re?" on":""),disabled:!xr(Q),title:re?e.viewLinkClose:e.viewLink,onClick:()=>ke(re?"":Q.trim()),children:re?e.viewLinkClose:e.viewLink}),t.jsxs("button",{type:"button",className:"evalbtn"+(me?" loading":""),disabled:me||ot||!Q.trim()&&!ae.trim(),onClick:()=>{rt()},children:[t.jsx("span",{className:"fill"}),Na]})]}):t.jsxs("button",{type:"button",className:"evalbtn"+(ge?" analyse":"")+(c?" loading":""),disabled:c,onClick:ye,children:[t.jsx("span",{className:"fill"}),ja]}),f.showCredits&&V&&t.jsxs("button",{type:"button",className:"credits"+(V.total_available<=0&&!V.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:V.unlimited?"∞":V.total_available}),!V.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",V.daily_grant+V.purchased]}),V.total_available<=0&&!V.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(R=>R.status==="boot"||R.status==="running").map(R=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:R.name}),t.jsx($t,{item:R,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+R.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>j(!S),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(W?" on":""),onClick:()=>K(!W),children:e.rsOpen}),qe!==null&&qe>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(De?" on":""),onClick:()=>_e(!De),children:e.rsArchOpen(qe)})]}),De&&t.jsx(Cl,{bump:Xe,cbToken:N,onClose:()=>_e(!1),onEvaluate:R=>i(null,R),onAddAll:ie}),W&&t.jsxs("div",{className:"rsp on slim",children:[t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:ae,placeholder:e.rsTextPh,onChange:R=>ve(R.target.value)})]}),te&&t.jsx("div",{className:"rserr",children:te}),Y&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:Y.title}),Y.source_url&&t.jsx("a",{href:Y.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ue(null),he(null)},children:"×"})]}),Y.market&&t.jsx("p",{className:"rsmk",children:Y.market}),ut.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),ut.map(R=>t.jsx("span",{children:R},R))]}),t.jsxs("div",{className:"rsbody",children:[Y.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${Y.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ao(Y.summary_md||"").map((R,ne)=>t.jsx("p",{children:R},ne))})]}),t.jsx(no,{card:Y,onEvaluate:R=>i(null,R),onAddAll:ie}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(mt)}),dt]})]}),S&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:M,placeholder:e.bulkPh,onChange:R=>P(R.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(O?" loading":""),style:{justifyContent:"center"},disabled:O||!E.length,onClick:()=>{Ie()},children:[t.jsx("span",{className:"fill"}),O&&v?v:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(E.length)})]})]}),_.slice(0,1).map((R,ne)=>{const se=R.verdict==="kept",fe=R.verdict==="quota",Ve=se?"var(--brand)":fe?"var(--bolt)":"var(--red)",Fe=se?"var(--brand-l)":fe?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":Fe},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:se?"✓ "+e.kept:fe?"⏳":"✗ "+e.dropped})}),R.name&&t.jsx("span",{className:"rn",children:R.name}),t.jsx("span",{className:"rr",children:R.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",R.reason]}):null}),!!(R.candidates&&R.candidates.length)&&t.jsx("span",{className:"sitepick",children:R.candidates.map(Se=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Se.url.startsWith("http")?Se.url:`https://${Se.url}`,target:"_blank",rel:"nofollow noopener",children:[(Se.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Se.url),children:e.evalPickGo})]},Se.url))}),!fe&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:se?1:5});const Se=(R.name||"").trim().toLowerCase();window.setTimeout(()=>{const We=[...document.querySelectorAll(".atl2 .list .row")].find(Gt=>{var Kt;return(((Kt=Gt.querySelector(".rnm"))==null?void 0:Kt.textContent)||"").trim().toLowerCase().includes(Se)});We&&(We.scrollIntoView({behavior:"smooth",block:"center"}),We.classList.add("flashrow"),window.setTimeout(()=>We.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(se?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),h&&(o.kept+o.dropped>0||_.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]}),re&&t.jsxs("div",{className:"artview",role:"dialog","aria-label":e.viewLink,children:[t.jsxs("div",{className:"artview-bar",children:[t.jsx("b",{children:Al(re)}),t.jsx("span",{className:"artview-hint",children:e.viewLinkHint}),t.jsxs("a",{href:re,target:"_blank",rel:"noopener noreferrer",children:[e.viewLinkTab," ↗"]}),t.jsx("button",{type:"button",className:"artview-x",onClick:()=>ke(""),"aria-label":e.viewLinkClose,children:"×"})]}),t.jsx("iframe",{src:zl(re),title:e.viewLink,sandbox:"allow-scripts allow-same-origin allow-popups allow-forms allow-presentation",referrerPolicy:"no-referrer-when-downgrade"})]})]})}function Ll(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ql(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=D(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",Ll(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const c=pt(o),d=on(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),c&&t.jsx("span",{className:"vv",children:c}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((f,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Ct(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function xn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=D(),[l,c]=m.useState(!1),[d,f]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,x=async()=>{if(!s||l)return;c(!0);const u=await ei(r,e);if(c(!1),!u){o(a.actErr);return}f(u.results||[])};return m.useEffect(()=>{if(!s)return;const u=g=>{var b;const p=String(((b=g.detail)==null?void 0:b.name)||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,s]),m.useEffect(()=>{if(s)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Ml=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ia=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Rl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=ia(a.slice(n));break}r+=ia(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=ia(a.slice(i));break}const l=a.slice(i+1,o).trim(),c=/^(\/?)([a-zA-Z0-9]+)/.exec(l),d=c?c[2].toLowerCase():"";c&&Ml.has(d)?r+=`<${c[1]}${d}>`:r+=ia(a.slice(i,o+1)),n=o+1}return r}const hr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Re({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Fl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ol({o:e}){const{t:a,doDeep:r}=D(),[n,i]=m.useState(!1),o=pt(e),l=[e.reasoning||"",Fl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((c,d)=>t.jsx("p",{className:"cdtxt",children:c},d)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Ct(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:c=>{c.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:c=>{c.stopPropagation(),i(d=>!d)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:c=>c.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:c=>c.stopPropagation()})]})}function hn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=D(),o=Wt(e),l=pt(e),c=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(c?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Ct(e)?1:0}].filter(b=>b.n>0),[e,a,c,l,d,f,s]),[u,g]=m.useState("");if(!x.length)return null;const p=x.some(b=>b.k===u)?u:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===b.k,"data-tour":"tab-"+b.k,className:p===b.k?"on":"",onClick:y=>{y.stopPropagation(),g(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[c&&t.jsxs("div",{className:"cdv1"+(c==="NO MATCH"?" out":""),children:[t.jsx("b",{children:c==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Re,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Re,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Re,{k:a.cdVerdictDate,v:hr(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Rl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Pl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Re,{k:a.cdSector,v:e.sector}),t.jsx(Re,{k:a.cdStage,v:e.stage}),t.jsx(Re,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Re,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Re,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Re,{k:a.cdAngle,v:e.angle}),t.jsx(Re,{k:a.cdDetected,v:hr(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Re,{k:a.cdName,v:e.contactName}),t.jsx(Re,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Re,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(Ol,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Re,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Re,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Pl({o:e}){const{t:a,token:r}=D(),[n,i]=m.useState(!1),[o,l]=m.useState(null),c=async()=>{n||(i(!0),l(await ti(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],s=f.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{c()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[f.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Yt({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const c=()=>{const f=Math.max(280,Math.min(560,o.clientWidth||320));qn({kind:"op",card:e},f).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},d=window.requestAnimationFrame(c);return()=>{l=!0,window.cancelAnimationFrame(d),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;qn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!l&&d&&o.isConnected&&o.replaceChildren(d)});const c=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("keydown",c),()=>{l=!0,document.removeEventListener("keydown",c)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&Lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Dl=`
...
`;function Il(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let c=e.y+10;return c+n>o-8&&(c=Math.max(8,e.y-n-14)),c<8&&(c=8),{left:l,top:c}}function $l(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:c,doAnalyse:d,doDecide:f,doPromote:s,doRepeche:x,doApproach:u,doDeep:g,doOnboard:p,outbound:b,evalBusy:y}=D(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const N=Le(h),C=ze(h),w=pt(h),A=Wt(h),L=h.kind==="target",T=z=>{a({type:"filters",patch:z}),a({type:"popup",id:null})};return Lt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Dl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Il(e.popupAnchor,!!h.card),onClick:z=>z.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(lt(h.date)),Be(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>T({country:[h.cc]}),children:(qt(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>T({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>T({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:Mt(h.amountEur,i)})]}),o.pipe&&L&&t.jsxs("div",{className:"pstat",children:[A&&t.jsx("span",{className:"vd "+(A==="MATCH"?"v-ok":"v-no"),title:n.vt[A],children:A}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[C]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[bt(h.engine)," ",t.jsx("b",{children:Be(h.engine,i)})," — ",ai(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:h,lg:!0})," ",t.jsx(ka,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(cn(N,i))," · ",n.win7(da(N,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(Yt,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&C>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&L&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&L&&t.jsx(hn,{o:h})]}),t.jsx(xn,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[C===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>c(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),C===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),C===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),C===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(h,!1),a({type:"popup",id:null})},children:n.actNo}),Ct(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{g(h),a({type:"popup",id:null})},children:n.memoDeep})]}),C===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),C===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var z;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(z=document.querySelector(".atl2 .demand"))==null||z.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(h.name),onClick:()=>c(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>c(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const Bl=8;function _l(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=D(),[c,d]=m.useState(!1),[f,s]=m.useState(!1),[x,u]=m.useState(!1),g=`atl2:sincemini:${r||"home"}`,[p,b]=m.useState(()=>{try{return localStorage.getItem(g)==="1"}catch{return!1}}),y=()=>{b(z=>{try{localStorage.setItem(g,z?"0":"1")}catch{}return!z})},h=r||"home",{names:N,verdicts:C}=m.useMemo(()=>{const z=[],S={};return n.forEach(j=>{j.kind!=="target"||!j.name||(z.push(j.name),S[j.name]=ni(j)||"")}),{names:z,verdicts:S}},[n]),w=m.useMemo(()=>N.length?ri(h,N,C,a):null,[h,N.length]);if(!i.pipe||c||!w||w.firstVisit||!w.added.length&&!w.gone.length)return null;const A=f?w.added:w.added.slice(0,Bl),L=w.added.length-A.length,T=z=>{const S=n.find(j=>j.name===z);S&&(o(S.id),l({type:"popup",id:S.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(w.added.length,w.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:y,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),oi(h,N,C,w.fp,a)},children:"×"})]}),!!w.added.length&&t.jsxs("div",{className:"sg-c",children:[A.map(z=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>T(z),children:t.jsx("b",{children:z})},z)),L>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>s(!0),children:e.sinceMore(L)})]}),!!w.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(z=>!z),children:e.sinceOut(w.gone.length)}),x&&w.gone.slice(0,20).map(z=>t.jsx("span",{className:"gone",children:z},z))]})]})}const ro={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function gn({o:e,locked:a=!1}){const{t:r}=D(),n=Wt(e),i=pt(e),o=ze(e),l=Pa(e),c=si(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(ro[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&c!==null&&t.jsx("span",{className:"wait2 "+(c>10?"hot":c>=5?"warm":""),title:r.waitTitle(c),children:r.waitChip(c)}),!a&&t.jsx(hs,{o:e})]})}const Tt=e=>e.length>22?e.slice(0,21)+"…":e,ca=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function bn(e){return ca.has(e.engine||"")}function nn(e){return!!e.noCo||bn(e)&&!!e.url}function Vt(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function gr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=D(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),Oe(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Tt(e.name))})]})}function vn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:c,doRepeche:d,doApproach:f,dispatch:s,liveMemos:x}=D();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),s({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Vt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return bn(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{p.stopPropagation(),Vt(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(gr,{o:e})});const u=ze(e),g=p=>b=>{b.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(gr,{o:e})});if(u===1){const p=x.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx($t,{item:p,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:g(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:g(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:g(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:g(()=>f(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>c(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:g(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Ul({o:e}){const{t:a,doThumb:r,thumbOf:n}=D(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Hl({o:e}){const{lang:a}=D();return Le(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(ka,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[bt(e.engine||"")," ",Be(e.engine||"",a)]})})}function Vl({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:c,caps:d,markRow:f,markedId:s,favIds:x,toggleFav:u,t:g}=D(),p=ze(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,h=y<=0?0:y<=7?1:y<=30?2:3,N=d.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][p]:b[h],C=x.has(e.id),w=A=>{if(a)return;if(l){l(e.id);return}if(d.pipe||e.kind==="op"){n();return}const L=A.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:L.left+Math.min(280,L.width/3),y:L.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>f(e.id),onMouseLeave:()=>f(null),onClick:w,children:[t.jsx("span",{className:"pt",style:{"--c":N}}),t.jsx(co,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[d.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:C?1:.35,padding:0,marginRight:4},onClick:A=>{A.stopPropagation(),u(e)},children:C?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(A=>A&&A!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:g.acqSee(e.acquirer),onClick:A=>{A.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Tt(e.acquirer)]}),gt(e)?t.jsx("span",{className:"rdec",title:g.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:g.zoomNewsMark,children:"📰"}):null]}),t.jsx(Wl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Hl,{o:e}),d.pipe&&t.jsx(gn,{o:e,locked:a}),d.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(vn,{o:e}),d.showThumbs&&t.jsx(Ul,{o:e})]}),r&&!a&&!l&&t.jsx(Kl,{o:e})]})}function Wl({o:e}){const{lang:a,caps:r}=D();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Mt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Yl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=D(),l=(u,g=!1)=>p=>{p.stopPropagation(),g&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},c=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),d=Mt(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Oe(e),x=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):nn(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),Vt(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Tt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Tt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Yt,{spec:e.card})})]})}function Gl({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=D();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Be(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(vn,{o:e})}),t.jsx(hn,{o:e})]})}function oo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:c,dossiers:d}=D();if(!e&&!a){const O=d.find(gt);if(O)return t.jsx(oo,{o:O})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),s=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),x=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),g=e?!!e.noCo:!f||pa(f),p=(e==null?void 0:e.engine)||"",b=gt(e),y=e?Mt(e.amountEur,n):"",h=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),N=(()=>{const O=/https?:\/\/(?:www\.)?([^/]+)/.exec(s);return O?O[1].replace(/^www\./,"").slice(0,40):""})(),C=d.find(gt),w=((C==null?void 0:C.url)||"").trim(),A=!!s&&!!w&&(s===w||s.endsWith(w)||w.endsWith(s)),L=(O,B=!1)=>v=>{v.stopPropagation(),B&&l({type:"continent",key:"monde"}),l({type:"filters",patch:O})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},z=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},S=()=>{Vt({url:s,headline:x,tagline:e==null?void 0:e.tagline,name:f})},j=e?Oe(e):!1,M=j&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",P=b?r.doEdito.replace(/^📖\s*/,""):p?Be(p,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[P,h?` · ${h}`:""]}),t.jsx("h3",{className:"zoom-h",children:x}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(Yt,{spec:u})}),(s&&!A||w)&&t.jsxs("div",{className:"zoom-srcbox",children:[s&&!A&&t.jsxs("a",{className:"zoom-src",href:s,target:"_blank",rel:"nofollow noopener",onClick:O=>O.stopPropagation(),children:[r.zoomSrc,N?` · ${N}`:""," ↗"]}),w&&t.jsxs("a",{className:"zoom-src zoom-src-art",href:w,target:"_blank",rel:"noopener noreferrer",onClick:O=>O.stopPropagation(),children:[r.zoomArt," ↗"]})]}),t.jsxs("div",{className:"zoom-acts",children:[j?t.jsxs("span",{className:"verdict",style:{"--c":M?"var(--brand)":"var(--red)"},children:[M?"✓":"✗"," ",t.jsx("b",{children:M?r.kept:r.dropped})]}):!g&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:O=>{O.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Tt(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,s&&(g||bn({engine:p}))&&t.jsxs("div",{className:"zp-pair",children:[t.jsxs("button",{type:"button",className:"zp-go ghost",onClick:O=>{O.stopPropagation(),window.dispatchEvent(new CustomEvent("ppmap:view",{detail:{url:s}}))},children:[t.jsx("span",{className:"zp-ico",children:"👁"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.viewLink}),t.jsx("em",{children:N||r.zoomSrc})]})]}),t.jsxs("button",{type:"button",className:"zp-go"+(!g&&f?" ghost":""),onClick:O=>{O.stopPropagation(),S()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]})]}),!g&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!c.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:O=>{O.stopPropagation(),z()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:O=>{O.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Tt(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!g&&f&&c.pipe&&t.jsx(xn,{name:f})]})]})}function Kl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=D();return!i.pipe&&e.kind==="op"?t.jsx(Yl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(hn,{o:e}),t.jsx(gs,{o:e}),t.jsx(ys,{o:e}),t.jsx(xn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(gn,{o:e})})]}),e.card&&t.jsx(Yt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[bt(e.engine||"")," ",Be(e.engine||"",r)]}),Le(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Ql({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:c,lang:d}=D();if(!l.pipe&&e.kind==="op"){const x=Mt(e.amountEur,d),u=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),g=(p,b=!1)=>y=>{y.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Yt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:g({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:g({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:g({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[bt(e.engine||"")," ",Be(e.engine||"",d)]}),Le(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(d==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(vn,{o:e})})]})}const f=ze(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][f];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(gn,{o:e}),Le(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&f===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>c(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>c(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function Jl(){const{t:e}=D(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Xl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=D(),o=i==="en",l=s=>n.plabels[s]||"",c=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),d=c.includes(0)?0:c.sort((s,x)=>(e[x]||0)-(e[s]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(d)}”`:`${f} dossier${f>1?"s":""} dans « ${l(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+l(d)," →"]})]})}function Zl(){var ct,jt;const e=D(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:c,markRow:d,lang:f,sessTally:s,data:x,dossiers:u,source:g,focusExtra:p,byId:b}=e,y=E=>i.lockRowsAfter!==null||g==="ops"?Number.MAX_SAFE_INTEGER:Cr,[h,N]=m.useState(new Set);m.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[C,w]=m.useState(null);m.useEffect(()=>{w(null)},[a.ptab,a.continent]);const[A,L]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){L(!1);return}const E=document.getElementById("atl2-stage");if(!E){L(!1);return}const _=new IntersectionObserver(([V])=>L(!!V&&V.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return _.observe(E),()=>_.disconnect()},[a.mapFolded]);const T=a.mapFolded||!A,z=E=>N(_=>{const V=new Set(_);return V.has(E)?V.delete(E):V.add(E),V}),S=g==="ops"||i.pipe,[j,M]=m.useState("all"),[P,O]=m.useState(null),[B,v]=m.useState(!1),q=m.useRef(!0);m.useEffect(()=>{if(q.current){q.current=!1;return}M("all"),v(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!B)return;const E=_=>{var V,ie;(ie=(V=_.target)==null?void 0:V.closest)!=null&&ie.call(V,".atl2 .doable")||v(!1)};return document.addEventListener("click",E),()=>document.removeEventListener("click",E)},[B]);const H=Ar(),U=m.useMemo(()=>{var _;const E=new Map;for(const V of ns(((_=H==null?void 0:H.ed)==null?void 0:_.html)||""))E.has(V.t)||E.set(V.t,V.html);return E},[(ct=H==null?void 0:H.ed)==null?void 0:ct.html]),I=m.useCallback(E=>{if(E.decryptHtml)return E.decryptHtml;if(!U.size)return;const _=(E.name||"").trim().toLowerCase();if(_.length<3)return;const V=U.get(_);if(V)return V;for(const[ie,ge]of U)if(ie.includes(_)||_.includes(ie))return ge},[U]),W=m.useMemo(()=>{let E=dn(l,a.sort);return E=E.filter(_=>!gt(_)),j==="explore"?E=E.filter(nn):j==="eval"&&(E=E.filter(_=>!_.noCo)),E},[l,a.sort,j,I]),K=m.useMemo(()=>i.pipe?c.filter(E=>Le(E)&&ii(E)):W.filter(E=>Le(E)&&!Oe(E)),[i.pipe,c,W]),Q=K.length,[le,ae]=m.useState(!1),[ve,G]=m.useState(!1),pe=`atl2:sigmini:${((jt=x.session)==null?void 0:jt.token)||"home"}`,[re,ke]=m.useState(()=>{try{return localStorage.getItem(pe)==="1"}catch{return!1}}),me=m.useMemo(()=>i.pipe?W:W.filter(E=>!Oe(E)&&!E.noCo),[W,i.pipe]),Z=g==="ops"?W.filter(E=>E.noCo).length:0,ee=i.pipe?n.plabels[a.ptab].toLowerCase():g==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,J=a.filters,te=[];if(J.day)te.push({k:"day",lib:n.fDay(J.day.slice(8,10)+"/"+J.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(J.win&&J.win!=="all"){const E=["1","7","30"].indexOf(J.win);E>=0&&te.push({k:"win",lib:n.dates[E],off:()=>r({type:"filters",patch:{win:"all"}})})}const xe=E=>E.length<=2?E.join(", "):`${E.length} ${n.fSelected}`;for(const E of["sector","country","engine"]){const _=J[E];_&&_.length&&te.push({k:E,lib:xe(_),off:()=>r({type:"clearFacet",facet:E})})}J.search&&te.push({k:"search",lib:"🔍 "+J.search,off:()=>r({type:"filters",patch:{search:""}})});const Y=(E,_,V="",ie=!1)=>t.jsxs("button",{type:"button","data-s":E,className:V,"aria-sort":a.sort.key===E?a.sort.dir===1?"ascending":"descending":"none",style:ie?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:E}),children:[_,t.jsx("span",{className:"ar",children:a.sort.key===E&&a.sort.dir===1?"▴":"▾"})]},E),ue=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const E=new Map;W.forEach(ie=>{const ge=ie.engine||"?";E.has(ge)||E.set(ge,[]),E.get(ge).push(ie)});const _={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},V=Da([...E.keys()],f);return[...E.entries()].sort((ie,ge)=>{const ye=_[ie[0]]??10+V.indexOf(ie[0]),Ie=_[ge[0]]??10+V.indexOf(ge[0]);return ye-Ie})},[W,i.pipe,a.groupBy,f]),oe=ue?ue.filter(([E])=>ca.has(E)).length:0,he=(()=>{var _;return((_=(ue?ue.flatMap(([,V])=>V):W)[0])==null?void 0:_.id)??null})();m.useEffect(()=>{if(!a.focusId)return;O(a.focusId);const E=window.setTimeout(()=>O(null),900);return()=>window.clearTimeout(E)},[a.focusId]),m.useEffect(()=>{S&&(a.focusId&&(W.some(E=>E.id===a.focusId)||u.some(E=>E.id===a.focusId))||p||he&&r({type:"focus",id:he}))},[S,a.focusId,W,he,p,r,u]),m.useEffect(()=>{!S||!a.focusId||j!=="all"&&!W.some(E=>E.id===a.focusId)&&u.some(E=>E.id===a.focusId)&&M("all")},[S,a.focusId,j,W,u]),m.useEffect(()=>{if(!S||!a.focusId)return;const E=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel");E==null||E.scrollIntoView({block:"start",inline:"nearest"})},[S,a.focusId]),m.useEffect(()=>{if(typeof window>"u")return;const E=document.querySelector(".atl2.ops .listhead"),_=document.querySelector(".atl2.ops");if(!E||!_)return;const V=()=>_.style.setProperty("--listhead-h",`${E.offsetHeight}px`);V();const ie=new ResizeObserver(V);return ie.observe(E),()=>ie.disconnect()},[T,a.dens,a.mapFolded]);const De=m.useMemo(()=>{if(!S||!a.focusId)return null;const E=W.find(V=>V.id===a.focusId)||u.find(V=>V.id===a.focusId)||null;if(!E)return null;const _=I(E);return _&&_!==E.decryptHtml?{...E,decryptHtml:_}:E},[S,a.focusId,W,u,I]),_e=i.lockRowsAfter;let qe=0;const Ue=(E,_)=>{let V=a.shown[_]||y();return E.length-V<=4&&(V=E.length),E.slice(0,V).map(ye=>{const Ie=_e!==null&&qe>=_e;qe++;const rt=I(ye),ut=rt&&rt!==ye.decryptHtml?{...ye,decryptHtml:rt}:ye,ot=!S&&a.dens!=="maxi"&&(a.dens==="deplie"||(C?C==="open":!!rt)),dt=h.has(ye.id)?!ot:ot,mt=S?Ae=>{r({type:"focus",id:Ae});const He=b.get(Ae);He&&(nn(He)?Vt(He):He.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:He.name}})))}:void 0;return a.dens==="maxi"?t.jsx(Ql,{o:ut,locked:Ie,selected:S&&a.focusId===ye.id,onSelect:mt},ye.id):t.jsx(Vl,{o:ut,locked:Ie,open:dt,onToggle:()=>z(ye.id),selected:S&&a.focusId===ye.id,echo:P===ye.id,onSelect:mt},ye.id)})},Xe="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(g==="ops"?" opsl":"")+(W.length?"":" list-empty"),nt=t.jsxs(t.Fragment,{children:[ue?ue.map(([E,_])=>t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:bt(E)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:E==="ma"?n.grpMa:E==="fundraising"?n.grpLev:ca.has(E)&&oe<=1?n.grpNews:E==="nominations"?n.grpNom:E==="media"?n.grpNewsOther:E==="recrutements"?n.grpHire:ca.has(E)?n.grpNews+" · "+Be(E,f):Be(E,f)}),t.jsx("div",{className:"s",children:n.grpCount(_.filter(V=>!Oe(V)).length,_.length)})]})]}),Ue(_,E)]},E)):Ue(W,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Jl,{}),!W.length&&!(x.loading&&!u.length)&&(i.pipe?t.jsx(Xl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(T?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:W.length})," ",ee]}),t.jsx("span",{className:"dot",children:"·"}),T&&t.jsx(to,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[T?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),te.map(E=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:_=>{_.stopPropagation(),E.off()},children:[E.lib,t.jsx("i",{children:"×"})]},E.k)),g==="ops"&&W.length>0&&" — "+n.edSplit(W.length-Z,Z)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||g==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([E,_])=>t.jsxs("button",{type:"button","data-d":E,"aria-pressed":a.dens===E||E==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:E}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:_})]},E))}),!S&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":C==="open",onClick:()=>{w("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":C==="closed",onClick:()=>{w("closed"),N(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||g==="ops")&&(()=>{var V;const E=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],_=((V=E.find(([ie])=>ie===j))==null?void 0:V[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":B,onClick:()=>v(ie=>!ie),children:[_,t.jsx("i",{children:"▾"})]}),B&&t.jsx("div",{className:"dolist",children:E.map(([ie,ge])=>t.jsx("button",{type:"button","aria-pressed":j===ie,onClick:()=>{M(ie),v(!1)},children:ge},ie))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:E=>r({type:"sort",key:E.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([E,_])=>t.jsx("option",{value:E,children:_},E))})]}),i.showChain&&me.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:me.map(E=>E.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(me.length):n.chainAll(me.length)]}),T&&t.jsx(eo,{compact:!0})]}),t.jsx(_l,{}),Q>0&&!a.filters.signalOnly&&!ve&&t.jsxs("div",{className:"sigstrip"+(re?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(Q)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!re,title:re?n.boxExpand:n.boxCollapse,onClick:()=>ke(E=>{try{localStorage.setItem(pe,E?"0":"1")}catch{}return!E}),children:re?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>G(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(le?K:K.slice(0,12)).map(E=>{const _=Le(E);return _?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(cn(_,f),da(_,f)),onClick:()=>{d(E.id),r({type:"popup",id:E.id})},children:[t.jsx("b",{children:E.name}),t.jsxs("i",{children:[_.emoji," ",Ia(_,f)]}),t.jsx("em",{children:da(_,f)})]},"sg-"+E.id):null}),!le&&K.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>ae(!0),children:n.sigStripMore(K.length-12)})]})]}),a.dens!=="maxi"&&!S&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Y("country",n.colCountry),Y("name",n.colCompany),Y("amount",n.colAmount,"h-amt",!0),Y("stage",n.colStage,"h-stade"),Y("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[Y("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),Y("memo",n.colMemo)]}),i.pipe&&Y("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),S?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),Y("country",n.colCountry),Y("name",n.colCompany),Y("amount",n.colAmount,"h-amt",!0),Y("stage",n.colStage,"h-stade"),Y("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:Xe,children:nt})]}),t.jsx("aside",{className:"readpane","aria-label":f==="fr"?"Dossier":"File",children:i.pipe?t.jsx(Gl,{o:De}):t.jsx(oo,{o:De,extra:De?null:p})})]}):t.jsx("div",{className:Xe,children:nt}),(()=>{const E=ue||[["pt"+a.ptab,W]];let _=0,V=0;for(const[ge,ye]of E){V+=ye.length;let Ie=a.shown[ge]||y();ye.length-Ie<=4&&(Ie=ye.length),_+=Math.min(ye.length,Ie)}const ie=V-_;return ie<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>E.forEach(([ge,ye])=>r({type:"more",group:ge,by:ye.length,base:y()})),children:[t.jsx("span",{className:"more-label",children:n.more(ie,ie)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(_,V)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}function br(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function ec(e,a){const r=li(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function tc(e,a){const n=[a.head.split("|").map(br).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",ec(i,a.plabels),Wt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(br).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function ac(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const nc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function et({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function rc({o:e,qa:a}){const{t:r,lang:n,fund:i}=D(),o=(e.cribleStatus||"").trim().toUpperCase()||(Wt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=pt(e),c=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,c.value_prop],[r.qaProduct,c.produit],[r.qaModel,c.modele],[r.qaSummary,c.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(et,{k:r.cdSector,v:e.sector}),t.jsx(et,{k:r.cdStage,v:e.stage}),t.jsx(et,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(et,{k:r.cdSite,v:e.domain||e.website}),t.jsx(et,{k:r.cdName,v:e.contactName}),t.jsx(et,{k:r.cdEmail,v:e.contactEmail}),t.jsx(et,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(et,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(et,{k:r.cdAngle,v:e.angle}),t.jsx(et,{k:r.cdDetected,v:nc(e.date,n)})]}),d.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,f])=>f).map(([f,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:s})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function oc(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=D(),[c,d]=m.useState({}),f=25,s=m.useMemo(()=>n.slice(0,f),[n]);m.useEffect(()=>{s.length&&ci(r,s.map(g=>g.name)).then(d)},[r,s]);const x=o.stats,u=g=>g.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(x.screened/o.marketEstimate*100)," %"]})]})]}),s.map(g=>t.jsx(rc,{o:g,qa:c[g.name]},g.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ic=50;function yn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=D(),[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(""),[x,u]=m.useState(0),[g,p]=m.useState(""),[b,y]=m.useState(!1),h=m.useRef(null);m.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const N=async w=>{d(!0),s("");const A=await a();if(d(!1),A.ok){l(A);return}if(A.busy){s(i.alertPreviewBusy);return}if(!w){s(i.alertPreviewFail);return}u(ic),h.current=window.setInterval(()=>{u(L=>L>1?L-1:(h.current&&window.clearInterval(h.current),N(!1),0))},1e3)},C=async()=>{if(n||b)return;y(!0),p("");const w=await r();y(!1),p(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||x>0,onClick:()=>{N(!0)},children:c?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{C()},children:b?"…":i.alertTest})]}),x>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(x)}),f&&t.jsx("p",{className:"mnote warn",children:f}),g&&t.jsx("p",{className:"mnote",children:g}),!g&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const Et="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Pe({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=D();return Lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function sc(){const{st:e}=D();switch(e.modal){case"chain":return t.jsx(cc,{});case"space":return t.jsx(dc,{});case"alert":return t.jsx(pc,{});case"queue":return t.jsx(hc,{});case"export":return t.jsx(gc,{});case"plug":return t.jsx(yc,{});case"recharge":return t.jsx(kc,{});case"cover":return t.jsx(Nc,{});case"dossier":return t.jsx(jc,{});case"crit":return t.jsx(Sc,{});case"tuto":return t.jsx(Ec,{});case"rdv":return t.jsx(lc,{});case"memoalert":return t.jsx(bc,{});default:return null}}function lc(){const{dispatch:e,fund:a,t:r}=D(),n=a||r.rdvCoFallback;return Lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:qr,children:un}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ma}`,children:ma})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Ri,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function cc(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:c,caps:d,memoQueued:f,doAnalyse:s}=D(),x=o==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),g=e.chain.idx,p=u[g],b=g>=u.length;return Lt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${g+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:g/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[qt(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(lt(p.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Be(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:Mt(p.amountEur,i)})]}),Le(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:p,lg:!0})," ",t.jsx(ka,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),x&&Oe(p)&&t.jsxs("div",{className:"vbox",style:{"--c":ht(p)==="retenu"?"var(--brand)":ht(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:ht(p)==="retenu"?"✓ "+n.kept:ht(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&p&&d.pipe&&ze(p)===1&&!f.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&p&&!(x&&Oe(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:c,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function dc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=D(),o=i==="client",l=m.useMemo(()=>o?r.filter(x=>Oe(x)):[],[r,o]),c=m.useMemo(()=>dn(l.filter(x=>ht(x)==="retenu"),{key:"signal",dir:-1}),[l]),d=m.useMemo(()=>l.filter(x=>ht(x)==="ecarte"),[l]),f=e.spaceTab==="retenu"?c:d,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Pe,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:c.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function pc(){const{mode:e}=D();return e==="client"||e==="apercu"?t.jsx(uc,{}):t.jsx(xc,{})}function uc(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=D(),[o,l]=m.useState("d"),c=i!=="client";return t.jsxs(Pe,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(mc,{t:e,token:a,readOnly:c,flash:r,flashErr:n}),o==="w"&&t.jsx(fc,{t:e,token:a,readOnly:c,flash:r,flashErr:n}),o==="m"&&t.jsx(io,{})]})}function mc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return d(!1),Fn(a).then(b=>{p&&(b?l(b):d(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||Fn(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(c)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),g=p=>{const b=o.sections||e.alertSec.map(([y])=>y);x({sections:u(p)?b.filter(y=>y!==p):[...b,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>g(p)}),t.jsxs("span",{children:[b,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(yn,{label:e.alertPreview,readOnly:r,onPreview:()=>vi(a),onTest:()=>bi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function fc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let p=!0;return d(!1),On(a).then(b=>{p&&(b?l(b):d(!0))}),()=>{p=!1}},[a,f]);const x=p=>{r||On(a,p).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(c)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,g=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>x({dow:Number(p.target.value)}),children:e.alertDow.map((p,b)=>t.jsx("option",{value:b,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,g-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[g," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,g+1)}),disabled:r,children:"＋"})]})]}),t.jsx(yn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>wi(a),onTest:()=>yi(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function io(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=D(),[l,c]=m.useState(o||""),[d,f]=m.useState(!1),[s,x]=m.useState(!1);m.useEffect(()=>{o&&c(o)},[o]);const u=e.filters,g=m.useMemo(()=>n.filter(h=>Le(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){x(!0);try{await fetch(`${rn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{x(!1)}}},y=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>Be(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>qt(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([h,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:h=>c(h.target.value),onKeyDown:h=>{h.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,g)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function xc(){const{t:e}=D();return t.jsx(Pe,{title:e.alertTitle,icon:"🔔",children:t.jsx(io,{})})}function hc(){var z,S;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:c,dispatch:d,liveMemos:f}=D(),[s,x]=m.useState(null),[u,g]=m.useState([]),[p,b]=m.useState(0),y=n==="client",h=m.useMemo(()=>{const j=new Map;return i.forEach(M=>{const P=(M.name||"").trim().toLowerCase();P&&!j.has(P)&&j.set(P,M)}),j},[i]);m.useEffect(()=>{let j=!0;return(async()=>{const[M,P]=await Promise.all([sn(r),jr(a)]);j&&(M&&x(M),g(P))})(),()=>{j=!1}},[a,r,p]);const N=(s==null?void 0:s.per_day)??0,C=((z=s==null?void 0:s.analyzed_today)==null?void 0:z.length)??0,w=s==null?void 0:s.offre,A=(s==null?void 0:s.pool_meta)||[],L=m.useMemo(()=>{const j=new Map;for(const M of(s==null?void 0:s.scheduled)||[])for(const P of M.names||[])j.has(P)||j.set(P,{label:M.day_label,date:M.date});return j},[s==null?void 0:s.scheduled]),T=(s==null?void 0:s.in_progress)||[];return t.jsxs(Pe,{title:e.queueTitle,wide:!0,children:[w&&t.jsxs("div",{className:"qoffre"+(w.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:w.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:w.delai})]}),t.jsx("span",{className:"osp"}),w.rythme>0?t.jsx("span",{className:"or",children:e.qRate(w.rythme)}):w.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(w.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(C,C+(((S=s==null?void 0:s.pool_order)==null?void 0:S.length)??0))}})}),w&&t.jsxs("div",{className:"qeta",children:[w.file===0?e.qEtaDone:w.rythme<=0?e.qEtaPaused:e.qEta(w.file,w.rythme,w.jours_restants),w.en_retard&&t.jsxs("em",{children:[" ",e.qLate(w.delai,w.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(w==null?void 0:w.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(T.length>0||f.items.some(j=>j.status==="boot"||j.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(j=>j.status==="boot"||j.status==="running"||j.status==="error").map(j=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:j.name}),t.jsx("span",{className:"qd",children:j.memoType||""}),t.jsx($t,{item:j,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+j.name)),T.filter(j=>!f.liveOf(j.name)).map(j=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:j.name}),t.jsxs("span",{className:"qd",children:[j.memo_type||"",j.age_min?` · ${Math.round(j.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:j.state||""})]},"ip-"+j.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(j=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:j.company}),t.jsxs("span",{className:"qd",children:[j.memo_type,typeof j.est_min=="number"?` · ~${j.est_min} min`:""]}),t.jsx("span",{className:"qt",children:j.status}),j.url&&t.jsx("a",{className:"qgo",href:j.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),y&&j.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Rn(a,j.company,"retry").then(()=>b(M=>M+1))},children:e.queueRetry}),y&&j.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Rn(a,j.company,"delete").then(()=>b(M=>M+1))},children:e.queueDelete})]},j.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(A.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[A.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),A.map((j,M)=>{const P=L.get(j.name),O=h.get((j.name||"").trim().toLowerCase()),B=f.liveOf(j.name),v=!!(O&&l.has(O.id))||!!(B&&(B.status==="boot"||B.status==="running")),q=!!(O&&ze(O)===1&&!O.memoUrl)&&!B;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),P?t.jsx("span",{className:"qwhen"+(P.label==="demain"?" soon":""),children:P.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:j.name}),j.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof j.score=="number"&&t.jsx("span",{className:"qs2",children:j.score}),B&&(B.status==="boot"||B.status==="running")&&t.jsx($t,{item:B,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),q&&(c.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:v,onClick:()=>{o(O),b(H=>H+1)},children:v?e.actAnalyseQueued:e.actAnalyse})),j.excerpt&&t.jsx("span",{className:"qex",children:j.excerpt})]},j.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([j,M])=>t.jsxs("li",{children:[t.jsx("b",{children:j})," — ",M]},j))})]})}function gc(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=D(),c=`${Et}/cibles/list.csv?token=${a}`,d=`${Et}/cibles/list.json?token=${a}`,f=`${Et}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${c}")`,x=y=>{var h;(h=navigator.clipboard)==null||h.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:c,href:c},{def:e.exportSheet,value:s},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:f,href:f}],g=!i.lockActions&&n.length>0,p=()=>{ac(tc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:y=>(e.stg.find(([h])=>h===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Pe,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:h,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(h),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function bc(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=D(),o=i!=="client",[l,c]=m.useState(null),[d,f]=m.useState(!1),[s,x]=m.useState(0),[u,g]=m.useState(!1);m.useEffect(()=>{let h=!0;return f(!1),Mn(a).then(N=>{h&&(N?c(N):f(!0))}),()=>{h=!1}},[a,s]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=h=>{if(o||!l)return;const N={enabled:h.enabled??!!l.enabled,email:h.email??(l.email||""),sections:h.sections??p()};g(!0),Mn(a,N).then(C=>{if(g(!1),!C){n(e.memoAlertErr);return}c(C),r(e.memoAlertSaved)})};if(d)return t.jsx(Pe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(h=>h+1),children:e.retry})]})});if(!l)return t.jsx(Pe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=p();return t.jsxs(Pe,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(vc,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>b({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[h],disabled:o||u,onChange:()=>b({sections:{...y,[h]:!y[h]}})}),t.jsx("span",{children:N})]},h))}),t.jsx(yn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>pi(a,y),onTest:()=>di(a,y)})]})}function vc({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const c=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&c&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!c||!d,onClick:()=>i(o.trim()),children:n})]})]})}function yc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=D(),[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(null),[x,u]=m.useState(""),[g,p]=m.useState(0);m.useEffect(()=>{let C=!0;return d(!1),$a(a).then(w=>{C&&(w?l({configured:w.configured,url_hint:w.url_hint}):d(!0))}),fi(a).then(w=>{C&&s(w)}),()=>{C=!1}},[a,g]);const b=(C,w)=>{i&&$a(a,C).then(A=>{if(!A||A.ok===!1){n(e.actErr);return}C.test&&A.sent===!1?n(e.plugTestThrottled):r(w),p(L=>L+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${Et}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Pe,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),c?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(C=>C+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!i,onChange:C=>u(C.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(wc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var C;(C=navigator.clipboard)==null||C.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function wc(){const{t:e,token:a,lang:r}=D(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[c,d]=m.useState(null),[f,s]=m.useState(null),[x,u]=m.useState(!1),[g,p]=m.useState(!1),[b,y]=m.useState(null),[h,N]=m.useState(null),[C,w]=m.useState(null),A=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{$a(a).then(P=>{N(P&&P.configured?P.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{d(null),s(null),u(!1),y(null);try{const P=JSON.parse(localStorage.getItem(A)||"null");w(P&&Date.now()-Date.parse(P.t)<24*3600*1e3?P:null)}catch{w(null)}},[A]);const L=async()=>{l(!0),u(!1),y(null);const P=await hi(a,n);d(P),s(P.ok?n:null),l(!1)},T=m.useRef(!1),z=async()=>{if(T.current)return;T.current=!0,p(!0);const P=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await gi(a,n,"webhook",void 0,P)}finally{T.current=!1}if(p(!1),u(!1),y(O),O.ok&&(O.pushed||0)>0){const B={t:new Date().toISOString(),n:O.pushed||0};w(B);try{localStorage.setItem(A,JSON.stringify(B))}catch{}}},S=c!=null&&c.ok&&c.ready||0,j=!!(c!=null&&c.ok)&&f===n&&S>0&&!!h&&!C,M=C?new Date(C.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:P=>i(P.target.value),children:e.plugBulkTabs.map(([P,O])=>t.jsx("option",{value:P,children:O},P))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{L()},children:o?"…":e.plugBulkPreview})]}),c&&(c.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(c.ready||0,c.linkedinReady||0,(c.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(c!=null&&c.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),C&&t.jsx("p",{className:"mnote",children:e.bulkLocked(M,C.n)}),!C&&!!(c!=null&&c.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!C&&!c&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),j&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),j&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(S,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:g,onClick:()=>{z()},children:g?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:g,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function kc(){const{t:e,data:a,lang:r}=D(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const c=window.location.href.split("?")[0];try{const f=await(await fetch(`${rn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:c+"?credits=ok",cancel_url:c+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(Pe,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function jc(){const{t:e}=D();return t.jsx(Pe,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(oc,{})})}function Nc(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:c}=D(),[d,f]=m.useState(null),[s,x]=m.useState(!1);m.useEffect(()=>{let S=!0;if(o)return sn(o).then(j=>{S&&j&&typeof j.per_day=="number"&&f(j.per_day)}),()=>{S=!1}},[o]);const[u,g]=m.useState(null);m.useEffect(()=>{if(!i)return;let S=!0;return mi(i).then(j=>{S&&g(j)}),()=>{S=!1}},[i]);const p=r.stats,b=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(S=>S.kind==="target"&&Oe(S)).length,y=r.marketEstimate||0,h=y>0?Math.min(100,Math.round(b/y*100)):null,N=(p==null?void 0:p.window_days)||30,C=b>0?b/N:0,w=y>0?Math.max(0,y-b):0,L=y>0&&C>0&&b>=100?Math.round(w/C):null,T=S=>Math.round(S).toLocaleString(a==="en"?"en-US":"fr-FR"),z=S=>{s||!l||(x(!0),xi(i,S).then(j=>{if(x(!1),j===null){c(e.actErr);return}f(j),c(e.alertSaved)}))};return t.jsxs(Pe,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(T(b))}),y>0&&t.jsx("span",{children:e.covOf(T(y))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),L!==null&&t.jsx("p",{className:"mnote",children:e.covEta(L)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),C>=1&&t.jsx("p",{className:"mnote",children:e.covPace(T(C))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((S,j)=>t.jsxs("tr",{className:S.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[S.code,S.geo?` · ${S.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof S.n=="number"?T(S.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:S.source}),S.elargi&&t.jsx("em",{children:e.covWide(String(S.demande||""))}),S.erreur&&t.jsx("em",{children:e.covMissing})]})]},j)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:T(u.total||y)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:T(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:T(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:T(p.shown)})," ",e.funShown]})]}),l&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:d===S?"on":"",disabled:s,onClick:()=>z(S),children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Sc(){var h,N,C;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:c}=D(),d=n==="client",f=m.useMemo(()=>{const w=new Set;return a.forEach(A=>{A.angle&&w.add(A.angle)}),[...w]},[a]),[s,x]=m.useState(""),[u,g]=m.useState(""),[p,b]=m.useState(!1),y=async()=>{const w=s.trim();if(!(!w||p||!d)){b(!0),g("");try{const L=await(await fetch(`${Et}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(L.reply&&g(String(L.reply)),L.job_id){g(e.critChatRunning);const T=async()=>{const z=await fetch(`${Et}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:L.job_id})}).then(S=>S.json()).catch(()=>null);if(z&&z.done){g(String(z.reply||z.clarification||z.summary||"✓")),b(!1),z.applied&&i(e.alertSaved);return}setTimeout(()=>{T()},8e3)};setTimeout(()=>{T()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(Pe,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=o==null?void 0:o.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var A,L;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((A=w.look)!=null&&A.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(T=>t.jsx("li",{children:T},T))})]}),!!((L=w.out)!=null&&L.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(T=>t.jsx("li",{children:T},T))})]})]})]},w.title)})]}),!!((C=o==null?void 0:o.gate)!=null&&C.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!d||p,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!d||p||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ui,{fund:l,lang:c,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(ro[w]||"v-cons"),children:w}),t.jsx("span",{children:A})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",A]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ec(){const{t:e,dispatch:a,startTour:r}=D(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Pe,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const so="atl2:mapfold",Cc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(so);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},zc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},lo=m.createContext(null),D=()=>{const e=m.useContext(lo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=D(),n=Le(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ia(n,r),children:[n.emoji," ",Ia(n,r)]}):null}function ka({o:e,src:a}){const{lang:r,t:n}=D(),i=Le(e);if(!i)return null;const o=Ci(i),l=zi(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(cn(i,r))+" · "+n.win7(da(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(c,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:c=>c.stopPropagation(),children:"↗"})]})}function Ac(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Ye(a);if(i)return e.find(o=>Ye(o.name)===i)||e.find(o=>{const l=Ye(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function Tc(){const{scoped:e,t:a,st:r,dispatch:n}=D(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(x=>!gt(x)),c=l.length,d=l.filter(x=>!x.noCo).length,f=l.filter(x=>!!x.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const x=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:c}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",d," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",f," ",a.zoomPulseExplore]})]})]})}function co({o:e}){const{lang:a}=D(),r=Ei(e.cc),n=e.cc?qt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const vr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Lc=!1;function qc(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const po=e=>`atl2:tour:${e||"anon"}`;function Mc(e){try{return localStorage.getItem(po(e))==="1"}catch{return!0}}function yr(e){try{localStorage.setItem(po(e),"1")}catch{}}function Rc(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Ic({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var wn;const{lang:l}=ki(),c=Bi[l],d=Xi(e,l,a),[f,s]=m.useReducer(ts,void 0,()=>Zi((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?zc():Cc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=m.useRef(!0);m.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(so,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]);const u=m.useRef(o);u.current=o,m.useEffect(()=>{var k;(k=u.current)==null||k.call(u,f.filters)},[f.filters]);const[g,p]=m.useState(null),[b,y]=m.useState(null),[h,N]=m.useState(null),[C,w]=m.useState({kept:0,dropped:0}),[A,L]=m.useState(!1),[T,z]=m.useState(""),[S,j]=m.useState(!1),[M,P]=m.useState(null),[O,B]=m.useState(!1),[v,q]=m.useState(!1),[,H]=m.useState(0),U=()=>H(k=>k+1),I=m.useRef([]),W=m.useRef(new Set),K=m.useRef(new Set),[Q,le]=m.useState([]),[ae,ve]=m.useState([]),[G,pe]=m.useState(0),re=m.useRef(new Map),ke=m.useRef(null),{mode:me}=d,Z=m.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),ee=Z.pipe,J=d.session.token||"",te=me==="client"&&!e;m.useEffect(()=>{if(!J||!ee)return;let k=!0;const $=async()=>{const ce=await Ai(J);!k||!ce||(ve(ce.runs),pe(Date.now()/1e3-ce.now),le(je=>je.filter(Te=>!ce.runs.some(Ze=>Ye(Ze.company)===Ye(Te.name)))))};$();const F=Q.length>0||ae.some(ce=>ce.status==="running"),X=window.setInterval(()=>{$()},F?8e3:25e3);return()=>{k=!1,window.clearInterval(X)}},[J,ee,Q.length,ae.some(k=>k.status==="running")]);const xe=m.useMemo(()=>{const k=[],$=new Set;for(const F of Q){const X=Ye(F.name);!X||$.has(X)||($.add(X),k.push({name:F.name,id:F.id,status:"boot",started:F.started,estMin:F.estMin,memoType:"instant"}))}for(const F of ae){const X=Ye(F.company);if(!X||$.has(X))continue;$.add(X);const ce=F.status==="error"?"error":F.status==="done"?"done":"running";k.push({name:F.company,status:ce,started:F.started||0,estMin:F.est_min||(F.memo_type==="detailed"?40:15),url:F.url,error:F.error,memoType:F.memo_type})}return k},[Q,ae]),Y=k=>xe.find($=>Ye($.name)===Ye(k))||null,ue=(k,$)=>{le(F=>F.some(X=>Ye(X.name)===Ye(k.name))?F:[...F,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:$==="detailed"?40:15}]),W.current.add(k.id),U()};m.useEffect(()=>{if(document.querySelector(`link[href="${vr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=vr,document.head.appendChild(k)},[]);const oe=(k,$=!1)=>{z(k),j($),ke.current&&clearTimeout(ke.current),ke.current=setTimeout(()=>z(""),$?4200:2400)},he=k=>oe(k,!0),De=m.useMemo(()=>{const k=new Map;return d.dossiers.forEach($=>{$.id&&k.set($.id,$)}),k},[d.dossiers]),_e=m.useMemo(()=>d.dossiers.filter(k=>zr(k,f,ee)),[d.dossiers,f,ee]),qe=m.useRef(!1);m.useEffect(()=>{if(qe.current||e||d.loading||!d.dossiers.length)return;if(!Z.showFunnel||Mc(d.session.token||"")){qe.current=!0;return}qe.current=!0;const k=window.setTimeout(()=>{yr(d.session.token||""),B(!0)},700);return()=>window.clearTimeout(k)},[e,d.loading,d.dossiers.length,Z.showFunnel,d.session.token]);const Ue=m.useMemo(()=>d.dossiers.filter(k=>as(k,f,ee,d.favIds)),[d.dossiers,f,ee,d.favIds]),Xe=m.useMemo(()=>ji(_e,d.favIds),[_e,d.favIds]),nt=m.useRef(!1);m.useEffect(()=>{if(nt.current)return;if(!ee||a==="ops"){nt.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){nt.current=!0;return}if(d.loading)return;nt.current=!0;const k=Ni(Xe);k!==f.ptab&&s({type:"ptab",tab:k})},[ee,a,n==null?void 0:n.ptab,d.loading,Xe,f.ptab]);const ct=m.useMemo(()=>{const k=Rr(d.dossiers);return k?lt(k)===0?c.tourToday:Fr(k,l):c.tourNoRun},[d.dossiers,c,l]),jt=m.useMemo(()=>d.dossiers.some(k=>!!k.memoUrl||!!k.summary||Ct(k)),[d.dossiers]),[E,_]=m.useState(!1);m.useEffect(()=>{if(d.loading){_(!1);return}if(d.dossiers.length>0||d.error){_(!0);return}const k=window.setTimeout(()=>_(!0),6e3);return()=>window.clearTimeout(k)},[d.loading,d.dossiers.length,d.error]);const V=(d.marketEstimate||0)>0||typeof((wn=d.stats)==null?void 0:wn.screened)=="number"&&d.stats.screened>0,ie=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(Xe[k]||0)>0)??0,[Xe]),ge=ln.find(k=>k.key===f.continent),ye=f.continent==="monde"?c.contWorld:(l==="fr"?ge==null?void 0:ge.fr:ge==null?void 0:ge.en)||"";m.useEffect(()=>{const k=$=>{var X;const F=(((X=$.detail)==null?void 0:X.name)||"").trim();F&&Ie(null,F)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{if(a!=="ops")return;const k=$=>{const F=$.detail||{},X=String(F.id||"").trim(),ce=String(F.name||"").trim(),je=String(F.url||"").trim(),Te=X&&De.get(X)||Ac(d.dossiers,ce,je);if(Te){y(null),s({type:"focus",id:Te.id}),(Te.noCo||["media","nominations","recrutements"].includes(Te.engine||""))&&(Te.url||Te.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Te.url||"",text:[Te.headline,Te.tagline].filter(Boolean).join(`
`)}})):Te.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Te.name}}));return}!ce&&!je||(s({type:"focus",id:null}),y({name:ce,headline:String(F.text||"").trim()||ce,url:je,card:F.card}),je&&(pa(ce)||!ce)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:je,text:String(F.text||"").trim()}})):ce&&!pa(ce)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ce,url:je}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=X=>{const ce={},je=String((X==null?void 0:X.sector)||"").trim();je&&(ce.sector=[je]);const Te=String((X==null?void 0:X.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Te)&&(ce.day=Te);const Ze=String((X==null?void 0:X.search)||"").trim();Ze&&(ce.search=Ze);const we=String((X==null?void 0:X.dealKind)||"").trim();(we==="ma"||we==="levee"||we==="other")&&(ce.dealKind=[we]),Object.keys(ce).length&&s({type:"filters",patch:ce})},$=X=>k(X.detail),F=X=>{X.data&&X.data.type==="pp-filter"&&k(X.data)};return window.addEventListener("ppmap:filter",$),window.addEventListener("message",F),()=>{window.removeEventListener("ppmap:filter",$),window.removeEventListener("message",F)}},[]),m.useEffect(()=>{const k=$=>{var ce;const F=(((ce=$.detail)==null?void 0:ce.name)||"").trim().toLowerCase();if(!F)return;const X=d.dossiers.find(je=>(je.name||"").trim().toLowerCase()===F);X&&s(a==="ops"?{type:"focus",id:X.id}:{type:"popup",id:X.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const Ie=(k,$)=>{const F=((k==null?void 0:k.name)||$||"").trim();if(!te){N({kicker:F});return}!F||A||(L(!0),(async()=>{try{let X=F;const ce=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(ce)X=ce;else try{const we=await Ti(F);if(we!=null&&we.website)X=we.website;else if(((we==null?void 0:we.candidates)||[]).length===1)X=we.candidates[0].url;else if(((we==null?void 0:we.candidates)||[]).length>1){I.current=[{name:F,verdict:"unresolved",remaining:null,reason:c.evalPickSite,candidates:(we.candidates||[]).slice(0,5)},...I.current].slice(0,8),U();return}}catch{}const je=await Sr(J,X,"atelier2"),Te={name:je.company||F,verdict:je.verdict,reason:je.reason||"",remaining:je.remaining??null};I.current=[Te,...I.current].slice(0,8),je.verdict==="kept"&&w(we=>({...we,kept:we.kept+1})),je.verdict==="ruled_out"&&w(we=>({...we,dropped:we.dropped+1}));const Ze=k||d.dossiers.find(we=>(we.name||"").toLowerCase()===F.toLowerCase());Ze&&(je.verdict==="kept"?Ze.verdict=Ze.verdict||"MATCH":je.verdict==="ruled_out"&&(Ze.verdict="NO MATCH"),je.reason&&(Ze.reasoning=je.reason)),U()}finally{L(!1)}})())},rt=k=>{if(!te){N({kicker:k.name});return}ue(k,"instant"),Rt(J,"fast_request",k.name||"",""),oe(c.memoInstantSent(k.name))},ut=k=>re.current.get(k.id)??d.thumbs.get((k.name||"").trim().toLowerCase()),ot=(k,$)=>s({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:$}}),dt=async(k,$,F)=>{const X=k.ceoStatus||"";k.ceoStatus=$,U();const ce=await Ea(J,{status:$,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(F==null?void 0:F.note)!==void 0?{note:F.note}:{},...F!=null&&F.via?{via:F.via}:{}});return ce.ok?ce.skipped?(k.ceoStatus=X,U(),he(c.actNotPersisted),!1):((F==null?void 0:F.undo)!==!1&&ot(k,X),F!=null&&F.msg&&oe(F.msg),($==="Validé"||$==="Écarté")&&!k.ceoNote&&(F==null?void 0:F.note)===void 0&&P({o:k,yes:$==="Validé"}),!0):(k.ceoStatus=X,U(),he(c.actErr),!1)},mt=async(k,$)=>{const F=await Ea(J,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:$,via:"note"});return!F.ok||F.skipped?(he(F.skipped?c.actNotPersisted:c.actErr),!1):(k.ceoNote=$,U(),!0)},Ae=m.useRef(new Map),He=k=>Ae.current.has(k.id)?Ae.current.get(k.id):d.stages.get((k.name||"").trim().toLowerCase()),ja=(k,$)=>{Ae.current.set(k.id,$),U()},Na=(k,$)=>{te&&dt(k,$?"Validé":"Écarté",{msg:$?c.decidedYes(k.name):c.decidedNo(k.name)})},R=k=>{te&&dt(k,"À trancher",{msg:c.promoted(k.name)})},ne=k=>{te&&(async()=>{const $=k.ceoStatus||"";k.ceoStatus="Retenu",U();const F=await Ea(J,{status:"Retenu",check_id:k.checkId,company:k.name});if(!F.ok||F.skipped){k.ceoStatus=$,U(),he(F.skipped?c.actNotPersisted:c.actErr);return}ot(k,$),oe(c.repeched(k.name))})()},se=()=>{const k=f.undo[f.undo.length-1];if(!k){oe(c.undoNone);return}const $=De.get(k.id);if(!$){s({type:"undoPop"}),oe(c.undoNone);return}let F=k.prevCeoStatus;if(!F)if(($.verdict||"").toUpperCase().includes("CALL"))F="À trancher";else{oe(c.undoLockedTitle);return}(async()=>await dt($,F,{undo:!1})&&(s({type:"undoPop"}),$.ceoStatus=k.prevCeoStatus,U(),oe(c.undoDone($.name))))()},fe=k=>{te&&(K.current.add(k.id),U(),(async()=>{const $=await Li(J,k.name,"email");if(!$||$.ok===!1){K.current.delete(k.id),U(),he(c.actErr);return}Rt(J,"approach",k.name||"",""),oe(c.actApproachSent)})())},Ve=(k,$)=>{te&&(async()=>{if(!(await Rt(J,$?"yes":"no",k.name||"","")).ok){he(c.actErr);return}re.current.set(k.id,$?"yes":"no"),U(),oe($?c.thumbUpDone:c.thumbDnDone)})()},Fe=k=>{!te||!Ct(k)||(ue(k,"detailed"),Rt(J,"detailed_request",k.name||"",""),oe(c.memoDeepSent(k.name)))},Se=k=>{const $=new Set(d.favIds),F=$.has(k.id);F?$.delete(k.id):$.add(k.id),d.setFavIds($),te&&qi(J,{id:k.id,co:k.name},F)},We=()=>{!te||v||window.confirm(c.identSyncConfirm)&&(q(!0),(async()=>{const k=await Mi(J);q(!1),k?oe(c.identSyncDone):he(c.actErr)})())},Gt=/proplace/i.test(d.fund||""),Kt=k=>{!te||!Gt||(Rt(J,"onboard_request",k.name||"",""),oe(c.onboardSent(k.name)))},uo={st:f,dispatch:s,t:c,lang:l,mode:me,caps:Z,pipe:ee,token:J,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:ne,thumbOf:ut,canWrite:te,commitStatus:dt,saveNote:mt,stageOf:He,setStage:ja,flashErr:he,startTour:()=>B(!0),dossiers:d.dossiers,scopedAll:_e,scoped:Ue,counts:Xe,byId:De,contName:ye,favIds:d.favIds,toggleFav:Se,askEvaluate:Ie,doAnalyse:rt,doDecide:Na,doPromote:R,doApproach:fe,doThumb:Ve,doDeep:Fe,doUndo:se,doSync:We,doOnboard:Kt,outbound:Gt,memoQueued:W.current,liveMemos:{items:xe,serverOff:G,liveOf:Y},approachDone:K.current,sessTally:C,evalCards:I.current,evalBusy:A,markRow:p,markedId:g,flash:oe,focusExtra:b};m.useEffect(()=>{const k=$=>{$.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const mo=k=>J?t.jsx(rs,{token:J,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(lo.Provider,{value:uo,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(J?" cibles":""),children:[t.jsx("style",{children:Hi}),Z.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:c.lockbarText}),t.jsxs("span",{className:"lb-c",children:[c.lockbarContactBefore,t.jsx("a",{href:qr,children:un}),c.lockbarContactMid,t.jsx("a",{href:`mailto:${ma}`,children:ma})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:c.lockbarCta})]}),mo(t.jsxs("div",{className:"app"+(ee?" pipe":"")+(J?" has-thesis":""),children:[Z.showTicker&&t.jsx(Me,{name:"live",children:t.jsxs("div",{className:"live-stack"+(J?" live-stack--cibles":""),children:[t.jsx(ds,{}),!!J&&t.jsx(os,{})]})}),Z.showIdent&&t.jsx(Me,{name:"identite",children:t.jsx(js,{})}),!1,!!J&&t.jsx(Me,{name:"brief",children:t.jsx(is,{})}),Lc,Z.showMorning&&t.jsx(Me,{name:"matin",children:t.jsx(ks,{})}),t.jsx(Me,{name:"mesure",children:t.jsx(fs,{})}),Z.showFunnel&&t.jsx(Me,{name:"entonnoir",children:t.jsx(Fc,{})}),Z.showFunnel&&t.jsx(Me,{name:"tunnel",children:t.jsx(Ns,{})}),Z.showFunnel&&t.jsx(Me,{name:"tuto",children:t.jsx(Ss,{})}),!f.mapFolded&&t.jsx(Me,{name:"carte",fallback:t.jsx("div",{className:"void",children:c.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(to,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Tc,{}),t.jsx(kl,{}),t.jsx(eo,{})]})]})}),Z.showDemand&&ee&&t.jsx(Me,{name:"direct",children:t.jsx(Di,{items:xe,serverOff:G,labels:{strip:c.liveStrip,boot:c.liveBoot,end:c.liveEnd,open:c.liveOpenQueue,memo:c.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),Z.showDemand&&t.jsx(Me,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Tl,{})})}),Z.showDemand&&f.memoConsole&&t.jsx(Me,{name:"console",children:t.jsx(ql,{})}),t.jsx(Me,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[c.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:c.retry})]}),children:t.jsx(Zl,{})}),d.loading&&t.jsx("div",{className:"void",children:c.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[c.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:c.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(Me,{name:"fiche",children:t.jsx($l,{})}),t.jsx(Me,{name:"modales",children:t.jsx(sc,{})}),t.jsx(ms,{}),M&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:M.o.name}),t.jsx(vs,{placeholder:M.yes?c.whyYesPh:c.whyNoPh,onDone:k=>{const $=M.o;P(null),k&&mt($,k).then(F=>{F&&oe(c.csNoteSaved)})}})]}),O&&E&&t.jsx(ws,{steps:Rc(c,ct,jt,ie,V),onClose:()=>{B(!1),yr(J)}}),t.jsx(qc,{}),T&&t.jsx("div",{className:"flash on"+(S?" err":""),children:T}),h&&t.jsx(Si,{variant:"acquirer",initialCompany:wr().co,initialWebsite:wr().site,onClose:()=>N(null)})]})})}function Fc(){const{t:e}=D(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function wr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Oc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{co as FlagCell,wt as SigBadge,ka as SigWin,Ic as default,Oc as fmtShort,D as useV2};
