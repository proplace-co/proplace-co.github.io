...
/* Après scroll : la barre prend toute la largeur (sinon elle se casse en 2 rangées
   dans les 62 %). L'encadré commence dessous. */
body.pp-desk .atl2.ops .listhead.mapoff{width:100%!important;max-width:none!important}
body.pp-desk .atl2.ops:has(.listhead.mapoff) .readpane:not(.is-edito){
  top:calc(104px + var(--demand-h,56px) + var(--listhead-h,40px));
  min-height:calc(100dvh - 104px - var(--demand-h,56px) - var(--listhead-h,40px))}
...
body.pp-desk .atl2.ops .listhead.mapoff .fstrip-b,
body.pp-desk .atl2.ops .listhead.mapoff .frow2{
  flex:none;flex-wrap:nowrap;width:auto;min-width:0;padding:0;border-top:0;order:unset}
body.pp-desk .atl2.ops .listhead.mapoff .fstrip .fsrch{flex:0 1 148px;min-width:120px}
body.pp-desk .atl2.ops .listhead.mapoff .winpick-k{display:none}
