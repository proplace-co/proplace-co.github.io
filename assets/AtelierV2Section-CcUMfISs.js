...
.atl2 .evalq .side{width:190px;flex:none}
.atl2 .evalq .hint{white-space:normal;text-align:left;line-height:1.5;letter-spacing:.03em;
  font-size:9px}
...
`,Cs=Ns+Es+Ss;function ln(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function zs(){const e=ln("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function As(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=zs();return r==="0"?"client":r==="1"||ln("embed")==="1"&&ln("chrome")==="1"?"apercu":"client"}const qs={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ts=e=>qs[e];function Ea(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Et=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Jr(a)||Ea(a))&&(e.noCo=!0)}return Object.assign(e,{continent:ui(e.cc)})};function Va(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ls=60*60*1e3;function Fs(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ls?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Rs=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ms(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:ti(),[e,n]),i=p.useMemo(()=>n?"visiteur":As(e,o),[e,o,n]),s=p.useMemo(()=>Ts(i),[i]),l=i!=="visiteur",c=Rs(r),[h,d]=p.useState([]),[x,u]=p.useState(""),[v,m]=p.useState(null),[b,k]=p.useState(null),[f,y]=p.useState(null),[j,w]=p.useState(()=>new Map),[N,S]=p.useState(()=>new Map),[C,T]=p.useState(""),[A,F]=p.useState(new Set),[D,P]=p.useState(null),[L,R]=p.useState(!0),[g,q]=p.useState(!1),[$,X]=p.useState(0),[I,O]=p.useState(0),Q=p.useRef(0),Y=p.useMemo(()=>{var J;if(i!=="client")return"";try{return((J=ai())==null?void 0:J.email)||""}catch{return""}},[i]);p.useEffect(()=>{const J=++Q.current;let ge=!0;const W=()=>ge&&J===Q.current,ce=(l&&o.token?o.token:"pub:"+a)+(c?":"+c:""),le=Fs(ce);return le?(d(le.objs.map(Et)),le.fund&&u(le.fund),m(le.marketEstimate??null),k(le.criteria??null),y(le.stats??null),T(le.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const be=await _a(),me=((be==null?void 0:be.recent_ops)||[]).map(de=>{const pe=va(de.company_name||de.title?de:{...de,title:(de.headline_fr||de.headline||"").slice(0,120)},a),xe=String(de.rubrique||"").toLowerCase();return pe&&(xe==="nominations"||xe==="recrutements")&&(pe.engine=xe),pe&&!String(de.company_name||"").trim()&&(pe.noCo=!0),pe}).filter(de=>!!de).map(de=>(Jr((de.name||"").trim())||(de.noCo=!0),de));try{const de=ni(),pe=await ri(),xe=((pe==null?void 0:pe.date)||"").slice(0,10),H=de?de.doc:pe,re=oi(H),fe=((de==null?void 0:de.day)||(H==null?void 0:H.date)||xe||"").slice(0,10);if(fe&&re.length){const ke=new Set;for(const ne of me){if((ne.date||"").slice(0,10)!==fe)continue;const ve=$n(re,ke,ne.name,"");ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}for(const ne of me){if(ne.decryptHtml||(ne.date||"").slice(0,10)!==fe)continue;const ve=$n(re,ke,"",ne.headline||ne.tagline||ne.name);ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}}if(fe){const ke=((H==null?void 0:H.title_fr)||"").trim(),ne=((H==null?void 0:H.lead_fr)||"").trim(),ve=ii(H),oe=((H==null?void 0:H.url)||"").trim();ke&&(ve||oe)&&me.unshift({id:`edito:${fe}`,kind:"op",name:ke,cc:null,date:fe,engine:"edito",dealKind:"other",headline:ke,tagline:ne||ke,decryptHtml:ve||void 0,url:oe,noCo:!0})}}catch{}if(!W())return;d(me.map(Et)),ca(ce,{objs:me})}else if(typeof r=="object"){const me=(await Un()||[]).filter(pe=>(pe.slug||"")===r.research).map(pe=>Hn(pe,a)).filter(pe=>!!pe),de=Va(await Vn(me,a));if(!W())return;d(de.map(Et)),ca(ce,{objs:de})}else if(l&&o.token){const be=si(o.token),me=_a(),de=li(o.token),pe=di(o.token),xe=ci(o.token),H=await be;let re=H?H.targets:[];W()&&H&&(u(H.fund||""),m(H.marketEstimate??null),k(H.criteria??null),y(H.stats??null),T(H.generatedAt||""),d(re.map(Et)),R(!1),q(!1));const[fe,ke,ne,ve]=await Promise.all([me,de,pe,xe]),oe=((fe==null?void 0:fe.recent_ops)||[]).map(he=>va(he,a)).filter(he=>!!he),Ee=new Set(re.map(he=>he.id));if(re=[...re,...oe.filter(he=>!Ee.has(he.id)&&(Ee.add(he.id),!0))],!W())return;d(re.map(Et));const Qe=new Set;for(const he of ke){const Se=(he.id||he.co||"").toString().trim().toLowerCase();Se&&Qe.add(Se.startsWith("t:")?Se:"t:"+Se)}F(Qe),w(ne),S(ve),H&&ca(ce,{fund:H.fund,marketEstimate:H.marketEstimate,criteria:H.criteria,stats:H.stats,generatedAt:H.generatedAt,objs:re})}else{const be=pi(),me=Un(),de=_a(),pe=await be;W()&&pe.length&&(d(Va(pe).map(Et)),R(!1),q(!1));const[xe,H]=await Promise.all([me,de]),re=(xe||[]).map(ve=>Hn(ve,a)).filter(ve=>!!ve),fe=await Vn(re,a),ke=((H==null?void 0:H.recent_ops)||[]).map(ve=>va(ve,a)).filter(ve=>!!ve),ne=Va([...pe,...fe,...ke]);if(!W())return;d(ne.map(Et)),ca(ce,{objs:ne})}W()&&q(!1)}catch{W()&&!le&&q(!0)}finally{W()&&R(!1)}})(),()=>{ge=!1}},[l,o.token,a,$,c]),p.useEffect(()=>{if(!s.showCredits||!Y){P(null);return}let J=!0;return(async()=>{try{const ge=await fetch(`${Da}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:Y})});if(!ge.ok)return;const W=await ge.json();J&&W&&W.ok!==!1&&P(W)}catch{}})(),()=>{J=!1}},[s.showCredits,Y,I]);const K=p.useCallback(J=>F(new Set(J)),[]);return{session:o,mode:i,caps:s,fund:x,email:Y,marketEstimate:v,generatedAt:C,criteria:b,stats:f,thumbs:j,stages:N,dossiers:h,favIds:A,setFavIds:K,credits:D,reloadCredits:()=>O(J=>J+1),loading:L,error:g,refresh:()=>X(J=>J+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ya=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Sa(e){return ya.has(e.engine||"")}function Ve(e){return!!e.noCo||Sa(e)&&!!e.url}const io=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Os=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...io(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Ds=new Set(["signal","amount","score","crible","memo"]);function Is(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:io(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Ds.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??so)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const so=80;function Ca(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(En(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ht(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ct(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ea(e,a,r){return We(e)?Ca(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ca(e,a.filters,r)}function Ps(e,a,r,n){return!(!ea(e,a,r)||r&&!mi(e,a.ptab,n))}function An(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-ht(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return hi(o);case"memo":return fi(o);case"signal":{const i=Me(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const s=n(o),l=n(i);return s<l?-a.dir:s>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Wa={},rr=(Wa==null?void 0:Wa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function or(){return new Date().toISOString().slice(0,10)}const qn=p.createContext(null);function lo(){return p.useContext(qn)}function Bs(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),s=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),l.querySelectorAll("*").forEach(c=>{const h=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),h&&/^https?:\/\//i.test(h)&&(c.setAttribute("href",h),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function _s(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),s=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(s);!l&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function ir(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),s=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),s&&n.setAttribute("class",s),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function sr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${i} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${i} ${r[1]}`}function co(){const e=p.useContext(qn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function $s({token:e,children:a}){const{dispatch:r,st:n,lang:o}=V(),[i,s]=p.useState(()=>n.filters.day||or()),[l,c]=p.useState(null),[h,d]=p.useState(!1),x=p.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){s(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{s(or());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const b=k=>{var y;const f=(y=k.detail)==null?void 0:y.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&s(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let b=!1;d(!0);const k=new URLSearchParams({token:e,date:i});return fetch(`${rr}/cibles/edition.json?${k}`).then(f=>f.json()).then(f=>{b||c(f)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||d(!1)}),()=>{b=!0}},[e,i]);const v=p.useMemo(()=>`${rr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:l,loading:h,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:v,isEn:o==="en"}),[e,i,l,h,x,u,n.filters.day,v,o]);return t.jsx(qn.Provider,{value:m,children:a})}function Us(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=co(),[o,i]=p.useState(()=>n||Xr());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const s=l=>{var c;return i(!!((c=l.detail)!=null&&c.open))};return window.addEventListener(ja,s),()=>window.removeEventListener(ja,s)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(xi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Hs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function lr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function dr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Vs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=co(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,c=a&&!a.ok,h=p.useRef(null),[d,x]=p.useState("fonds"),[u,v]=p.useState(null),[m,b]=p.useState("idle"),k=p.useRef(!1);p.useEffect(()=>{v(null),b("idle"),k.current=!1,x("fonds")},[e]),p.useEffect(()=>{if(d!=="jour"||k.current)return;k.current=!0;let N=!0;return b("load"),Hs(e).then(S=>{N&&(v(S),b("fait"))}),()=>{N=!1}},[d,e]);const f=p.useMemo(()=>_s((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=p.useRef(null);p.useEffect(()=>{const N=y.current;if(!N||!f)return;let S=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(S||!N.isConnected)&&(C.beautifyEditoRows(N),C.mountCardFits(N))}),()=>{S=!0}},[f]);const j=p.useMemo(()=>ir((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),w=p.useMemo(()=>ir((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const N=h.current;if(!N||!j)return;let S=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(S||!N.isConnected)&&(C.beautifyEditoRows(N),C.mountCardFits(N))}),()=>{S=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?lr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:sr(e,!0)}),"."]}):lr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:sr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&s&&j?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,d==="fonds"&&s&&w?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:w}}):null,d==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:dr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:dr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Ws=300,pa=7,Gs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},po={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ys=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(yi(r)&&r!=="media")return"news:"+r;const n=Me(e);return n?"sig:"+(n.theme&&po.fr[n.theme]?n.theme:"other"):"actualites"}function Ks(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:s,fund:l}=V(),c=lo(),h=s==="en",[d,x]=p.useState("all"),[u,v]=p.useState(!1),m=p.useMemo(()=>{var ge;const g=(a.filters.day||"").slice(0,10),q=W=>!(!i&&a.continent!=="monde"&&W.continent!==a.continent||g&&(W.date||"").slice(0,10)!==g),$=e.filter(W=>q(W)&&Me(W)&&(!i||W.kind!=="target"||ze(W)!==5)),X=i&&(((ge=c==null?void 0:c.ed)==null?void 0:ge.ops)||[]).length?c.ed.ops.map(W=>va(W,s)).filter(W=>!!W).map(W=>(W.briefOnly=!0,W)).filter(W=>!g||(W.date||"").slice(0,10)===g):[],I=e.filter(W=>q(W)&&W.kind==="op"&&(g?!0:ht(W.date)<=pa)),O=i?X.length?X:I.filter(W=>{const ce=(l||"").trim().toLowerCase();if(!ce)return!1;const le=W.match||null;return le?Object.keys(le).map(be=>be.trim().toLowerCase()).includes(ce):!1}):I,Q=g||new Date().toISOString().slice(0,10),Y=W=>{const ce=Ga(W);return ce==="ma"?0:ce==="levees"?1:2};O.sort((W,ce)=>{const le=Y(W)-Y(ce);if(le)return le;const be=(W.date||"").slice(0,10)===Q?0:1,me=(ce.date||"").slice(0,10)===Q?0:1;return be!==me?be-me:(ce.amountEur||0)-(W.amountEur||0)});const K=new Set,J=[];for(const W of[...O,...An($,{key:"signal",dir:-1})]){const ce=W.id||W.name;!ce||K.has(ce)||(K.add(ce),J.push(W))}return i&&J.length===0?e.filter(ce=>q(ce)&&ht(ce.date)<=pa).sort((ce,le)=>(le.date||"").localeCompare(ce.date||"")).slice(0,80):J},[e,a.continent,a.filters.day,i,l,s,c]),b=p.useMemo(()=>{const g={};for(const q of m){const $=Ga(q);g[$]=(g[$]||0)+1}return g},[m]),k=p.useMemo(()=>d==="all"?m:m.filter(g=>Ga(g)===d),[m,d]),f=p.useMemo(()=>k.slice(0,Ws),[k]),y=k.length-f.length,j=p.useRef(null);p.useEffect(()=>{var O,Q;const g=j.current;if(!g)return;const q=()=>{const Y=g.scrollWidth;Y<200||(g.style.animationDuration=Math.max(18,Math.round(Y/130))+"s")};q();const $=requestAnimationFrame(q),X=window.setTimeout(q,1200);let I=!0;return(Q=(O=document.fonts)==null?void 0:O.ready)==null||Q.then(()=>{I&&q()}),()=>{I=!1,cancelAnimationFrame($),window.clearTimeout(X)}},[f.length,d]);const w=g=>g==="all"?m.length:b[g]||0,N=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return po[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const q=g.slice(5);return bi[q]?vi(q,h?"en":"fr"):g}return Gs[h?"en":"fr"][g]},S=[{k:"all"}],C=["ma","levees"].filter(g=>w(g)>0||g===d);if(C.length){S.push({g:h?"Deals":"Opérations"});for(const g of C)S.push({k:g})}const T=["nominations","recrutements"].filter(g=>w(g)>0||g===d),A=gi.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>w(g)>0||g===d),F=w("actualites")>0||d==="actualites"?["actualites"]:[];if(T.length||A.length||F.length){S.push({g:h?"News":"Actualités"});for(const g of T)S.push({k:g});for(const g of A)S.push({k:g});for(const g of F)S.push({k:g})}const D=Ys.map(g=>"sig:"+g).filter(g=>w(g)>0||g===d);if(D.length){S.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of D)S.push({k:g})}const P=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},L=(()=>{const g=(a.filters.day||"").slice(0,10),q=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(h?`LIVE covers the events of ${P(g)}.`:`Le LIVE regroupe les événements du ${P(g)}.`)+q:(h?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+q})(),R=g=>f.map(q=>t.jsxs("button",{type:"button",className:"tk"+(Ie(q)?" spent":""),onClick:$=>{const X=q.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:X?"":q.id,name:q.name,url:q.url||"",text:q.tagline||q.headline||"",card:q.card}}))}catch{}if(X||n({type:"focus",id:q.id}),a.dens!=="liste"){const I=$.currentTarget.getBoundingClientRect();n({type:"popup",id:q.id,anchor:{x:I.left+I.width/2,y:I.bottom}})}},title:q.name+(q.tagline?" — "+q.tagline:""),children:[t.jsx(yt,{o:q}),t.jsxs("span",{className:"who",children:[t.jsx(Go,{o:q}),t.jsx("span",{className:"co",children:q.name})]}),typeof q.amountEur=="number"&&q.amountEur>0&&t.jsx("span",{className:"am",children:Ac(q.amountEur)}),q.sector&&t.jsx("span",{className:"mt",children:q.sector}),t.jsx(Ia,{o:q}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(q.id||q.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||v(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>v(g=>!g),children:[N(d),t.jsx("b",{children:w(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:L}),S.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===d,onClick:()=>{x(g.k),v(!1)},children:[N(g.k),t.jsx("b",{children:w(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(Js,{isEn:h})]})}const Qs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Js({isEn:e}){const[a,r]=p.useState(()=>Xr());p.useEffect(()=>{const o=i=>{var s;return r(!!((s=i.detail)!=null&&s.open))};return window.addEventListener(ja,o),()=>window.removeEventListener(ja,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>wi(!a),children:Qs})}const Tn="+33 6 83 10 72 86",za="alexandre@proplace.co",uo=`tel:${Tn.replace(/[^\d+]/g,"")}`;function Xs(){return null}class rt extends p.Component{constructor(){super(...arguments);Bn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const mo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function cr(e,a){if((wt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return mo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const pr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Zs={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function el({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:s}=V(),[l,c]=p.useState(""),[h,d]=p.useState(!1),[x,u]=p.useState(!1),v=p.useRef(null);if(p.useEffect(()=>{if(!x)return;const y=j=>{v.current&&!v.current.contains(j.target)&&(u(!1),d(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),b=async y=>{if(l)return;if(y==="Analysé"&&!e.memoUrl){d(!0);return}c(y);const j=(cr(e,a).find(([N])=>N===y)||[y,y])[1],w=await o(e,y,{msg:a.csMoved(e.name,j)});c(""),w&&(d(!1),u(!1))},k=cr(e,a),f=y=>(k.find(([j])=>j===y)||[])[1]||y;return k.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:k.map(([y,j])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(l===y?" busy":""),disabled:!!l,onClick:()=>{b(y)},children:j},y))}):t.jsxs("span",{className:"rstat"+(x||h?" rs-open":""),ref:v,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+pr(m),onClick:()=>{u(y=>!y),d(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),x&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:k.map(([y,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===y,className:"rsopt"+(m===y?" on":"")+(l===y?" busy":""),disabled:!!l,onClick:()=>{if(y===m){u(!1);return}b(y)},children:[t.jsx("i",{className:"pt2",style:{background:Zs[pr(y)]}}),j]},y))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{i(e),d(!1),u(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const y=await o(e,"Analysé");c(""),y&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function tl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=V(),[i,s]=p.useState(""),[l,c]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),d=(wt(e)||"").startsWith("CALL")&&ze(e)===3,x=ze(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(m);const b=await o(e,m);s(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},v=d?[["Validé",a.csYes],["Écarté",a.csNo]]:mo.filter(([m])=>!(x&&m==="Retenu")).map(([m,b])=>[m,a[b]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([m,b])=>t.jsx("button",{type:"button",className:"csb"+(h===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:b},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(al,{o:e})]})}function al({o:e}){const{t:a,saveNote:r,flash:n}=V(),[o,i]=p.useState(e.ceoNote||""),[s,l]=p.useState(!1),[c,h]=p.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(s||!d)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:s||!d,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function nl({placeholder:e,onDone:a}){const{t:r}=V(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function rl({o:e}){var k;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:s,flashErr:l}=V(),[c,h]=p.useState(!1);if(!n.pipe||!o||n.lockActions||ze(e)!==4)return null;const d=i(e),x=(d==null?void 0:d.stage)||"todo",u=async f=>{if(c||f===x)return;h(!0);const y=d;s(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const j=Math.max(Date.now(),ur+=1);ur=j;const w=await ki(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});h(!1),!w.stale&&(w.ok||(s(e,y),l(a.actErr)))},v=(k=d==null?void 0:d.stamps)==null?void 0:k.sent,m=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,b=x==="sent"&&v&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:c,onClick:()=>{u(f)},children:y},f)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let ur=0;const Wt=8,vt=360;function mr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function fr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(mr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(mr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function ol({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=V(),[s,l]=p.useState(0),[c,h]=p.useState(null),[d,x]=p.useState([]),u=p.useRef(!1),v=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const C=v.current;return()=>{m.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const b=d[s],k=s>=d.length;p.useEffect(()=>{if(b&&(b.ptab!==void 0&&i.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&i.dens!==b.dens&&n({type:"dens",dens:b.dens}),i.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const C=b.click,T=window.setTimeout(()=>{const A=document.querySelector(C);A&&A.getAttribute("aria-selected")!=="true"&&A.click()},60);return()=>window.clearTimeout(T)}},[s,b]);const f=p.useRef(-1),y=p.useCallback(()=>{if(!b){h(null);return}const C=F=>{if(!F)return null;for(const D of document.querySelectorAll(F)){const P=D.getBoundingClientRect();if(P.width>1&&P.height>1)return D}return null},T=C(b.sel)||C(b.need);if(!T){h(null);return}f.current!==s&&(f.current=s,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const A=T.getBoundingClientRect();h(F=>F&&Math.abs(F.top-A.top)<1&&Math.abs(F.left-A.left)<1&&Math.abs(F.width-A.width)<1&&Math.abs(F.height-A.height)<1?F:A)},[b,s]);p.useLayoutEffect(()=>{y();const C=[90,300,700,1300].map(F=>window.setTimeout(y,F)),T=window.setInterval(y,400),A=()=>y();return window.addEventListener("scroll",A,!0),window.addEventListener("resize",A),()=>{C.forEach(F=>window.clearTimeout(F)),window.clearInterval(T),window.removeEventListener("scroll",A,!0),window.removeEventListener("resize",A)}},[y]);const j=p.useRef(a);if(j.current=a,p.useEffect(()=>{const C=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),j.current()):T.key==="ArrowRight"?l(A=>A+1):T.key==="ArrowLeft"&&l(A=>Math.max(0,A-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!d.length)return null;let w=null;const N=C=>()=>{m.current=!0,n({type:"modal",modal:null}),C()};if(k){const C=o[3]||0;C>0?w={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?w={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?w={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let S={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:vt};if(!k&&c){const C=c.bottom+14,T=window.innerHeight-C;let A=T>190?C:Math.max(12,c.top-200),F=Math.min(Math.max(12,c.left+c.width/2-vt/2),window.innerWidth-vt-12);T<=190&&c.top<212&&(window.innerWidth-c.right>=vt+40?F=Math.min(c.right+26,window.innerWidth-vt-12):c.left>=vt+40&&(F=Math.max(12,c.left-vt-26)),A=Math.max(12,c.top-Wt)),S={left:F,top:A,width:vt}}return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!k&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Wt,top:c.top-Wt,width:c.width+Wt*2,height:c.height+Wt*2}}),(k||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(k?" fin":""),style:S,children:[k&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(fr,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(fr,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(C=>C+1),children:s===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function fo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function ho(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function il(){var T,A;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:s,data:l,dispatch:c}=V(),h=r?a:e,d=p.useMemo(()=>h.filter(F=>ht(F.date)===0&&F.kind==="target"),[h]),x=p.useMemo(()=>r?a.filter(F=>F.kind==="target"&&ze(F)===0).slice().sort((F,D)=>(D.date||"").localeCompare(F.date||"")):[],[a,r]),u=p.useMemo(()=>d.filter(F=>r?ze(F)===0:!Ie(F)),[d,r]),v=r?x:u,m=r?a.length-x.length:d.length-u.length,b=r?a.length:d.length,k=b?Math.min(100,m/b*100):100,f=p.useMemo(()=>fo(h),[h]),y=!!f&&ht(f)>0,j=p.useMemo(()=>y?h.filter(F=>(F.date||"").slice(0,10)===f):[],[h,f,y]),w=typeof((T=l.stats)==null?void 0:T.kept_today)=="number"?l.stats.kept_today:null,N=typeof((A=l.stats)==null?void 0:A.screened_today)=="number"?l.stats.screened_today:d.length;let S;y?S=o.morningLast(j.length,x.length,ho(f,s)):r?S=o.morningThesis(N,x.length,w):d.length?m===0?S=o.goalSourced(d.length):m>=d.length?S=o.goalCleared:S=o.goalDone(m,d.length):S=o.goalSourced(0);const C=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(F=>F.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:S}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:k+"%"}})}),v.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(v.length):i.pileMode?o.goalContinue(v.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function sl(){var $,X;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:s,dossiers:l,mode:c,doSync:h,startTour:d,flash:x,flashErr:u}=V(),[v,m]=p.useState(null),[b,k]=p.useState(!0),[f,y]=p.useState([]),j=c==="client";p.useEffect(()=>{if(!o||!i)return;let I=!0;return k(!0),(async()=>{const[O,Q]=await Promise.all([Sn(i),Zr(o)]);I&&(O&&m(O),k(!1),y(Q))})(),()=>{I=!1}},[o,i]);const[w,N]=p.useState(!1),S=()=>{!j||w||!i||(N(!0),ji(i).then(I=>{N(!1),I?x(e.identRepubDone):u(e.actErr)}))},C=(v==null?void 0:v.per_day)??null,T=(($=v==null?void 0:v.pool_order)==null?void 0:$.length)??0,A=f.filter(I=>I.status==="running").length,F=p.useMemo(()=>l.filter(I=>I.kind==="target"&&Ie(I)).length,[l]),D=s.marketEstimate,P=typeof((X=s.stats)==null?void 0:X.screened)=="number"?s.stats.screened:F,L=D&&D>0?Math.min(100,Math.round(P/D*100)):null,R=I=>I.toLocaleString(a==="en"?"en-US":"fr-FR"),g=(i||"P").split(/\s+/).map(I=>I[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const I=Date.parse(s.generatedAt||"");if(Number.isNaN(I))return"";const O=new Date(I),Q=Y=>String(Y).padStart(2,"0");return`${Q(O.getDate())}/${Q(O.getMonth()+1)} à ${Q(O.getHours())}:${Q(O.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?g:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),q?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(q)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&P>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(P)})})]}),L!==null&&D&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(P,D)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),A>0&&t.jsxs("span",{className:"ev",children:["⏳ ",A]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(T)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:I=>{I.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||w,onClick:S,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:h,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:I=>n({type:"filters",patch:{search:I.target.value}})})]})]})]})}class At{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],s=a+i,l=Math.abs(a)<Math.abs(i)?a-(s-i):i-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,o=a[--r],s=n+o,i=o-(s-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=s+o,o==n-s&&(s=n))}return s}}function*ll(e){for(const a of e)yield*a}function xo(e){return Array.from(ll(e))}var we=1e-6,ue=Math.PI,et=ue/2,hr=ue/4,at=ue*2,mt=180/ue,Ye=ue/180,Ce=Math.abs,dl=Math.atan,ta=Math.atan2,Te=Math.cos,Le=Math.sin,cl=Math.sign||function(e){return e>0?1:e<0?-1:0},Tt=Math.sqrt;function pl(e){return e>1?0:e<-1?ue:Math.acos(e)}function aa(e){return e>1?et:e<-1?-et:Math.asin(e)}function tt(){}function Aa(e,a){e&&gr.hasOwnProperty(e.type)&&gr[e.type](e,a)}var xr={Feature:function(e,a){Aa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Aa(r[n].geometry,a)}},gr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){dn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)dn(r[n],a,0)},Polygon:function(e,a){br(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)br(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Aa(r[n],a)}};function dn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function br(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)dn(e[r],a,1);a.polygonEnd()}function Rt(e,a){e&&xr.hasOwnProperty(e.type)?xr[e.type](e,a):Aa(e,a)}function cn(e){return[ta(e[1],e[0]),aa(e[2])]}function It(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*Le(a),Le(r)]}function ua(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ya(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ma(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function pn(e){var a=Tt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function un(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function mn(e,a){return Ce(e)>ue&&(e-=Math.round(e/at)*at),[e,a]}mn.invert=mn;function ul(e,a,r){return(e%=at)?a||r?un(yr(e),wr(a,r)):yr(e):a||r?wr(a,r):mn}function vr(e){return function(a,r){return a+=e,Ce(a)>ue&&(a-=Math.round(a/at)*at),[a,r]}}function yr(e){var a=vr(e);return a.invert=vr(-e),a}function wr(e,a){var r=Te(e),n=Le(e),o=Te(a),i=Le(a);function s(l,c){var h=Te(c),d=Te(l)*h,x=Le(l)*h,u=Le(c),v=u*r+d*n;return[ta(x*o-v*i,d*r-u*n),aa(v*o+x*i)]}return s.invert=function(l,c){var h=Te(c),d=Te(l)*h,x=Le(l)*h,u=Le(c),v=u*o-x*i;return[ta(x*o+u*i,d*r+v*n),aa(v*r-d*n)]},s}function ml(e,a,r,n,o,i){if(r){var s=Te(a),l=Le(a),c=n*r;o==null?(o=a+n*at,i=a-c/2):(o=kr(s,o),i=kr(s,i),(n>0?o<i:o>i)&&(o+=n*at));for(var h,d=o;n>0?d>i:d<i;d-=c)h=cn([s,-l*Te(d),-l*Le(d)]),e.point(h[0],h[1])}}function kr(e,a){a=It(a),a[0]-=e,pn(a);var r=pl(-a[1]);return((-a[2]<0?-r:r)+at-we)%at}function go(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:tt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function wa(e,a){return Ce(e[0]-a[0])<we&&Ce(e[1]-a[1])<we}function fa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function bo(e,a,r,n,o){var i=[],s=[],l,c;if(e.forEach(function(m){if(!((b=m.length-1)<=0)){var b,k=m[0],f=m[b],y;if(wa(k,f)){if(!k[2]&&!f[2]){for(o.lineStart(),l=0;l<b;++l)o.point((k=m[l])[0],k[1]);o.lineEnd();return}f[0]+=2*we}i.push(y=new fa(k,m,null,!0)),s.push(y.o=new fa(k,null,y,!1)),i.push(y=new fa(f,m,null,!1)),s.push(y.o=new fa(f,null,y,!0))}}),!!i.length){for(s.sort(a),jr(i),jr(s),l=0,c=s.length;l<c;++l)s[l].e=r=!r;for(var h=i[0],d,x;;){for(var u=h,v=!0;u.v;)if((u=u.n)===h)return;d=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(v)for(l=0,c=d.length;l<c;++l)o.point((x=d[l])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(v)for(d=u.p.z,l=d.length-1;l>=0;--l)o.point((x=d[l])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,d=u.z,v=!v}while(!u.v);o.lineEnd()}}}function jr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Ka(e){return Ce(e[0])<=ue?e[0]:cl(e[0])*((Ce(e[0])+ue)%at-ue)}function fl(e,a){var r=Ka(a),n=a[1],o=Le(n),i=[Le(r),-Te(r),0],s=0,l=0,c=new At;o===1?n=et+we:o===-1&&(n=-et-we);for(var h=0,d=e.length;h<d;++h)if(u=(x=e[h]).length)for(var x,u,v=x[u-1],m=Ka(v),b=v[1]/2+hr,k=Le(b),f=Te(b),y=0;y<u;++y,m=w,k=S,f=C,v=j){var j=x[y],w=Ka(j),N=j[1]/2+hr,S=Le(N),C=Te(N),T=w-m,A=T>=0?1:-1,F=A*T,D=F>ue,P=k*S;if(c.add(ta(P*A*Le(F),f*C+P*Te(F))),s+=D?T+A*at:T,D^m>=r^w>=r){var L=qa(It(v),It(j));pn(L);var R=qa(i,L);pn(R);var g=(D^T>=0?-1:1)*aa(R[2]);(n>g||n===g&&(L[0]||L[1]))&&(l+=D^T>=0?1:-1)}}return(s<-we||s<we&&c<-1e-12)^l&1}function vo(e,a,r,n){return function(o){var i=a(o),s=go(),l=a(s),c=!1,h,d,x,u={point:v,lineStart:b,lineEnd:k,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=j,d=[],h=[]},polygonEnd:function(){u.point=v,u.lineStart=b,u.lineEnd=k,d=xo(d);var w=fl(h,n);d.length?(c||(o.polygonStart(),c=!0),bo(d,xl,w,r,o)):w&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),d=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function v(w,N){e(w,N)&&o.point(w,N)}function m(w,N){i.point(w,N)}function b(){u.point=m,i.lineStart()}function k(){u.point=v,i.lineEnd()}function f(w,N){x.push([w,N]),l.point(w,N)}function y(){l.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),l.lineEnd();var w=l.clean(),N=s.result(),S,C=N.length,T,A,F;if(x.pop(),h.push(x),x=null,!!C){if(w&1){if(A=N[0],(T=A.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),S=0;S<T;++S)o.point((F=A[S])[0],F[1]);o.lineEnd()}return}C>1&&w&2&&N.push(N.pop().concat(N.shift())),d.push(N.filter(hl))}}return u}}function hl(e){return e.length>1}function xl(e,a){return((e=e.x)[0]<0?e[1]-et-we:et-e[1])-((a=a.x)[0]<0?a[1]-et-we:et-a[1])}const Nr=vo(function(){return!0},gl,vl,[-ue,-et]);function gl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,s){var l=i>0?ue:-ue,c=Ce(i-a);Ce(c-ue)<we?(e.point(a,r=(r+s)/2>0?et:-et),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&c>=ue&&(Ce(a-n)<we&&(a-=n*we),Ce(i-l)<we&&(i-=l*we),r=bl(a,r,i,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function bl(e,a,r,n){var o,i,s=Le(e-r);return Ce(s)>we?dl((Le(a)*(i=Te(n))*Le(r)-Le(n)*(o=Te(a))*Le(e))/(o*i*s)):(a+n)/2}function vl(e,a,r,n){var o;if(e==null)o=r*et,n.point(-ue,o),n.point(0,o),n.point(ue,o),n.point(ue,0),n.point(ue,-o),n.point(0,-o),n.point(-ue,-o),n.point(-ue,0),n.point(-ue,o);else if(Ce(e[0]-a[0])>we){var i=e[0]<a[0]?ue:-ue;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function yl(e){var a=Te(e),r=2*Ye,n=a>0,o=Ce(a)>we;function i(d,x,u,v){ml(v,e,r,u,d,x)}function s(d,x){return Te(d)*Te(x)>a}function l(d){var x,u,v,m,b;return{lineStart:function(){m=v=!1,b=1},point:function(k,f){var y=[k,f],j,w=s(k,f),N=n?w?0:h(k,f):w?h(k+(k<0?ue:-ue),f):0;if(!x&&(m=v=w)&&d.lineStart(),w!==v&&(j=c(x,y),(!j||wa(x,j)||wa(y,j))&&(y[2]=1)),w!==v)b=0,w?(d.lineStart(),j=c(y,x),d.point(j[0],j[1])):(j=c(x,y),d.point(j[0],j[1],2),d.lineEnd()),x=j;else if(o&&x&&n^w){var S;!(N&u)&&(S=c(y,x,!0))&&(b=0,n?(d.lineStart(),d.point(S[0][0],S[0][1]),d.point(S[1][0],S[1][1]),d.lineEnd()):(d.point(S[1][0],S[1][1]),d.lineEnd(),d.lineStart(),d.point(S[0][0],S[0][1],3)))}w&&(!x||!wa(x,y))&&d.point(y[0],y[1]),x=y,v=w,u=N},lineEnd:function(){v&&d.lineEnd(),x=null},clean:function(){return b|(m&&v)<<1}}}function c(d,x,u){var v=It(d),m=It(x),b=[1,0,0],k=qa(v,m),f=ua(k,k),y=k[0],j=f-y*y;if(!j)return!u&&d;var w=a*f/j,N=-a*y/j,S=qa(b,k),C=ma(b,w),T=ma(k,N);Ya(C,T);var A=S,F=ua(C,A),D=ua(A,A),P=F*F-D*(ua(C,C)-1);if(!(P<0)){var L=Tt(P),R=ma(A,(-F-L)/D);if(Ya(R,C),R=cn(R),!u)return R;var g=d[0],q=x[0],$=d[1],X=x[1],I;q<g&&(I=g,g=q,q=I);var O=q-g,Q=Ce(O-ue)<we,Y=Q||O<we;if(!Q&&X<$&&(I=$,$=X,X=I),Y?Q?$+X>0^R[1]<(Ce(R[0]-g)<we?$:X):$<=R[1]&&R[1]<=X:O>ue^(g<=R[0]&&R[0]<=q)){var K=ma(A,(-F+L)/D);return Ya(K,C),[R,cn(K)]}}}function h(d,x){var u=n?e:ue-e,v=0;return d<-u?v|=1:d>u&&(v|=2),x<-u?v|=4:x>u&&(v|=8),v}return vo(s,l,i,n?[0,-e]:[-ue,e-ue])}function wl(e,a,r,n,o,i){var s=e[0],l=e[1],c=a[0],h=a[1],d=0,x=1,u=c-s,v=h-l,m;if(m=r-s,!(!u&&m>0)){if(m/=u,u<0){if(m<d)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>d&&(d=m)}if(m=o-s,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>d&&(d=m)}else if(u>0){if(m<d)return;m<x&&(x=m)}if(m=n-l,!(!v&&m>0)){if(m/=v,v<0){if(m<d)return;m<x&&(x=m)}else if(v>0){if(m>x)return;m>d&&(d=m)}if(m=i-l,!(!v&&m<0)){if(m/=v,v<0){if(m>x)return;m>d&&(d=m)}else if(v>0){if(m<d)return;m<x&&(x=m)}return d>0&&(e[0]=s+d*u,e[1]=l+d*v),x<1&&(a[0]=s+x*u,a[1]=l+x*v),!0}}}}}var Gt=1e9,ha=-Gt;function kl(e,a,r,n){function o(h,d){return e<=h&&h<=r&&a<=d&&d<=n}function i(h,d,x,u){var v=0,m=0;if(h==null||(v=s(h,x))!==(m=s(d,x))||c(h,d)<0^x>0)do u.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+x+4)%4)!==m);else u.point(d[0],d[1])}function s(h,d){return Ce(h[0]-e)<we?d>0?0:3:Ce(h[0]-r)<we?d>0?2:1:Ce(h[1]-a)<we?d>0?1:0:d>0?3:2}function l(h,d){return c(h.x,d.x)}function c(h,d){var x=s(h,1),u=s(d,1);return x!==u?x-u:x===0?d[1]-h[1]:x===1?h[0]-d[0]:x===2?h[1]-d[1]:d[0]-h[0]}return function(h){var d=h,x=go(),u,v,m,b,k,f,y,j,w,N,S,C={point:T,lineStart:P,lineEnd:L,polygonStart:F,polygonEnd:D};function T(g,q){o(g,q)&&d.point(g,q)}function A(){for(var g=0,q=0,$=v.length;q<$;++q)for(var X=v[q],I=1,O=X.length,Q=X[0],Y,K,J=Q[0],ge=Q[1];I<O;++I)Y=J,K=ge,Q=X[I],J=Q[0],ge=Q[1],K<=n?ge>n&&(J-Y)*(n-K)>(ge-K)*(e-Y)&&++g:ge<=n&&(J-Y)*(n-K)<(ge-K)*(e-Y)&&--g;return g}function F(){d=x,u=[],v=[],S=!0}function D(){var g=A(),q=S&&g,$=(u=xo(u)).length;(q||$)&&(h.polygonStart(),q&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),$&&bo(u,l,g,i,h),h.polygonEnd()),d=h,u=v=m=null}function P(){C.point=R,v&&v.push(m=[]),N=!0,w=!1,y=j=NaN}function L(){u&&(R(b,k),f&&w&&x.rejoin(),u.push(x.result())),C.point=T,w&&d.lineEnd()}function R(g,q){var $=o(g,q);if(v&&m.push([g,q]),N)b=g,k=q,f=$,N=!1,$&&(d.lineStart(),d.point(g,q));else if($&&w)d.point(g,q);else{var X=[y=Math.max(ha,Math.min(Gt,y)),j=Math.max(ha,Math.min(Gt,j))],I=[g=Math.max(ha,Math.min(Gt,g)),q=Math.max(ha,Math.min(Gt,q))];wl(X,I,e,a,r,n)?(w||(d.lineStart(),d.point(X[0],X[1])),d.point(I[0],I[1]),$||d.lineEnd(),S=!1):$&&(d.lineStart(),d.point(g,q),S=!1)}y=g,j=q,w=$}return C}}const fn=e=>e;var Qa=new At,hn=new At,yo,wo,xn,gn,ft={point:tt,lineStart:tt,lineEnd:tt,polygonStart:function(){ft.lineStart=jl,ft.lineEnd=El},polygonEnd:function(){ft.lineStart=ft.lineEnd=ft.point=tt,Qa.add(Ce(hn)),hn=new At},result:function(){var e=Qa/2;return Qa=new At,e}};function jl(){ft.point=Nl}function Nl(e,a){ft.point=ko,yo=xn=e,wo=gn=a}function ko(e,a){hn.add(gn*e-xn*a),xn=e,gn=a}function El(){ko(yo,wo)}var Pt=1/0,Ta=Pt,na=-Pt,La=na,Fa={point:Sl,lineStart:tt,lineEnd:tt,polygonStart:tt,polygonEnd:tt,result:function(){var e=[[Pt,Ta],[na,La]];return na=La=-(Ta=Pt=1/0),e}};function Sl(e,a){e<Pt&&(Pt=e),e>na&&(na=e),a<Ta&&(Ta=a),a>La&&(La=a)}var bn=0,vn=0,Yt=0,Ra=0,Ma=0,Mt=0,yn=0,wn=0,Kt=0,jo,No,ct,pt,Ze={point:qt,lineStart:Er,lineEnd:Sr,polygonStart:function(){Ze.lineStart=Al,Ze.lineEnd=ql},polygonEnd:function(){Ze.point=qt,Ze.lineStart=Er,Ze.lineEnd=Sr},result:function(){var e=Kt?[yn/Kt,wn/Kt]:Mt?[Ra/Mt,Ma/Mt]:Yt?[bn/Yt,vn/Yt]:[NaN,NaN];return bn=vn=Yt=Ra=Ma=Mt=yn=wn=Kt=0,e}};function qt(e,a){bn+=e,vn+=a,++Yt}function Er(){Ze.point=Cl}function Cl(e,a){Ze.point=zl,qt(ct=e,pt=a)}function zl(e,a){var r=e-ct,n=a-pt,o=Tt(r*r+n*n);Ra+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Mt+=o,qt(ct=e,pt=a)}function Sr(){Ze.point=qt}function Al(){Ze.point=Tl}function ql(){Eo(jo,No)}function Tl(e,a){Ze.point=Eo,qt(jo=ct=e,No=pt=a)}function Eo(e,a){var r=e-ct,n=a-pt,o=Tt(r*r+n*n);Ra+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Mt+=o,o=pt*e-ct*a,yn+=o*(ct+e),wn+=o*(pt+a),Kt+=o*3,qt(ct=e,pt=a)}function So(e){this._context=e}So.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,at);break}}},result:tt};var kn=new At,Ja,Co,zo,Qt,Jt,ra={point:tt,lineStart:function(){ra.point=Ll},lineEnd:function(){Ja&&Ao(Co,zo),ra.point=tt},polygonStart:function(){Ja=!0},polygonEnd:function(){Ja=null},result:function(){var e=+kn;return kn=new At,e}};function Ll(e,a){ra.point=Ao,Co=Qt=e,zo=Jt=a}function Ao(e,a){Qt-=e,Jt-=a,kn.add(Tt(Qt*Qt+Jt*Jt)),Qt=e,Jt=a}let Cr,Oa,zr,Ar;class qr{constructor(a){this._append=a==null?qo:Fl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==zr||this._append!==Oa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,zr=n,Oa=this._append,Ar=this._,this._=o}this._+=Ar;break}}}result(){const a=this._;return this._="",a.length?a:null}}function qo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Fl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return qo;if(a!==Cr){const r=10**a;Cr=a,Oa=function(o){let i=1;this._+=o[0];for(const s=o.length;i<s;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Oa}function Rl(e,a){let r=3,n=4.5,o,i;function s(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Rt(l,o(i))),i.result()}return s.area=function(l){return Rt(l,o(ft)),ft.result()},s.measure=function(l){return Rt(l,o(ra)),ra.result()},s.bounds=function(l){return Rt(l,o(Fa)),Fa.result()},s.centroid=function(l){return Rt(l,o(Ze)),Ze.result()},s.projection=function(l){return arguments.length?(o=l==null?(e=null,fn):(e=l).stream,s):e},s.context=function(l){return arguments.length?(i=l==null?(a=null,new qr(r)):new So(a=l),typeof n!="function"&&i.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const c=Math.floor(l);if(!(c>=0))throw new RangeError(`invalid digits: ${l}`);r=c}return a===null&&(i=new qr(r)),s},s.projection(e).digits(r).context(a)}function Ln(e){return function(a){var r=new jn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function jn(){}jn.prototype={constructor:jn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Fn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Rt(r,e.stream(Fa)),a(Fa.result()),n!=null&&e.clipExtent(n),e}function To(e,a,r){return Fn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],s=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-s*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,c])},r)}function Ml(e,a,r){return To(e,[[0,0],a],r)}function Ol(e,a,r){return Fn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),s=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([s,l])},r)}function Dl(e,a,r){return Fn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),s=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([s,l])},r)}var Tr=16,Il=Te(30*Ye);function Lr(e,a){return+a?Bl(e,a):Pl(e)}function Pl(e){return Ln({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Bl(e,a){function r(n,o,i,s,l,c,h,d,x,u,v,m,b,k){var f=h-n,y=d-o,j=f*f+y*y;if(j>4*a&&b--){var w=s+u,N=l+v,S=c+m,C=Tt(w*w+N*N+S*S),T=aa(S/=C),A=Ce(Ce(S)-1)<we||Ce(i-x)<we?(i+x)/2:ta(N,w),F=e(A,T),D=F[0],P=F[1],L=D-n,R=P-o,g=y*L-f*R;(g*g/j>a||Ce((f*L+y*R)/j-.5)>.3||s*u+l*v+c*m<Il)&&(r(n,o,i,s,l,c,D,P,A,w/=C,N/=C,S,b,k),k.point(D,P),r(D,P,A,w,N,S,h,d,x,u,v,m,b,k))}}return function(n){var o,i,s,l,c,h,d,x,u,v,m,b,k={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),k.lineStart=N},polygonEnd:function(){n.polygonEnd(),k.lineStart=y}};function f(T,A){T=e(T,A),n.point(T[0],T[1])}function y(){x=NaN,k.point=j,n.lineStart()}function j(T,A){var F=It([T,A]),D=e(T,A);r(x,u,d,v,m,b,x=D[0],u=D[1],d=T,v=F[0],m=F[1],b=F[2],Tr,n),n.point(x,u)}function w(){k.point=f,n.lineEnd()}function N(){y(),k.point=S,k.lineEnd=C}function S(T,A){j(o=T,A),i=x,s=u,l=v,c=m,h=b,k.point=j}function C(){r(x,u,d,v,m,b,i,s,o,l,c,h,Tr,n),k.lineEnd=w,w()}return k}}var _l=Ln({point:function(e,a){this.stream.point(e*Ye,a*Ye)}});function $l(e){return Ln({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ul(e,a,r,n,o){function i(s,l){return s*=n,l*=o,[a+e*s,r-e*l]}return i.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*o]},i}function Fr(e,a,r,n,o,i){if(!i)return Ul(e,a,r,n,o);var s=Te(i),l=Le(i),c=s*e,h=l*e,d=s/e,x=l/e,u=(l*r-s*a)/e,v=(l*a+s*r)/e;function m(b,k){return b*=n,k*=o,[c*b-h*k+a,r-h*b-c*k]}return m.invert=function(b,k){return[n*(d*b-x*k+u),o*(v-x*b-d*k)]},m}function Hl(e){return Vl(function(){return e})()}function Vl(e){var a,r=150,n=480,o=250,i=0,s=0,l=0,c=0,h=0,d,x=0,u=1,v=1,m=null,b=Nr,k=null,f,y,j,w=fn,N=.5,S,C,T,A,F;function D(g){return T(g[0]*Ye,g[1]*Ye)}function P(g){return g=T.invert(g[0],g[1]),g&&[g[0]*mt,g[1]*mt]}D.stream=function(g){return A&&F===g?A:A=_l($l(d)(b(S(w(F=g)))))},D.preclip=function(g){return arguments.length?(b=g,m=void 0,R()):b},D.postclip=function(g){return arguments.length?(w=g,k=f=y=j=null,R()):w},D.clipAngle=function(g){return arguments.length?(b=+g?yl(m=g*Ye):(m=null,Nr),R()):m*mt},D.clipExtent=function(g){return arguments.length?(w=g==null?(k=f=y=j=null,fn):kl(k=+g[0][0],f=+g[0][1],y=+g[1][0],j=+g[1][1]),R()):k==null?null:[[k,f],[y,j]]},D.scale=function(g){return arguments.length?(r=+g,L()):r},D.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],L()):[n,o]},D.center=function(g){return arguments.length?(i=g[0]%360*Ye,s=g[1]%360*Ye,L()):[i*mt,s*mt]},D.rotate=function(g){return arguments.length?(l=g[0]%360*Ye,c=g[1]%360*Ye,h=g.length>2?g[2]%360*Ye:0,L()):[l*mt,c*mt,h*mt]},D.angle=function(g){return arguments.length?(x=g%360*Ye,L()):x*mt},D.reflectX=function(g){return arguments.length?(u=g?-1:1,L()):u<0},D.reflectY=function(g){return arguments.length?(v=g?-1:1,L()):v<0},D.precision=function(g){return arguments.length?(S=Lr(C,N=g*g),R()):Tt(N)},D.fitExtent=function(g,q){return To(D,g,q)},D.fitSize=function(g,q){return Ml(D,g,q)},D.fitWidth=function(g,q){return Ol(D,g,q)},D.fitHeight=function(g,q){return Dl(D,g,q)};function L(){var g=Fr(r,0,0,u,v,x).apply(null,a(i,s)),q=Fr(r,n-g[0],o-g[1],u,v,x);return d=ul(l,c,h),C=un(a,q),T=un(d,C),S=Lr(C,N),R()}function R(){return A=F=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&P,L()}}function Lo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Lo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,s=i*i;r-=o=(r*(1.007226+i*(.015085+s*(-.044475+.028874*i-.005916*s)))-a)/(1.007226+i*(.015085*3+s*(-.044475*7+.028874*9*i-.005916*11*s)))}while(Ce(o)>we&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Wl(){return Hl(Lo).scale(175.295)}function Gl(e){return e}function Yl(e){if(e==null)return Gl;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],s=e.translate[1];return function(l,c){c||(a=r=0);var h=2,d=l.length,x=new Array(d);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+s;h<d;)x[h]=l[h],++h;return x}}function Kl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Ql(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Rr(e,r)})}:Rr(e,a)}function Rr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Jl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Jl(e,a){var r=Yl(e.transform),n=e.arcs;function o(d,x){x.length&&x.pop();for(var u=n[d<0?~d:d],v=0,m=u.length;v<m;++v)x.push(r(u[v],v));d<0&&Kl(x,m)}function i(d){return r(d)}function s(d){for(var x=[],u=0,v=d.length;u<v;++u)o(d[u],x);return x.length<2&&x.push(x[0]),x}function l(d){for(var x=s(d);x.length<4;)x.push(x[0]);return x}function c(d){return d.map(l)}function h(d){var x=d.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:d.geometries.map(h)};case"Point":u=i(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(i);break;case"LineString":u=s(d.arcs);break;case"MultiLineString":u=d.arcs.map(s);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return h(a)}const Fo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Xl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Zl(e,a,r){const n=Fo[e];if(!n||!n.length)return-1;const o=Xl(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(s=>o.includes(s)))return i}return Math.floor(r*n.length)%n.length}let xa=null;function ed(){return xa||(xa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Ql(r,n),i=Wl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=Rl(i),l=(o.features||[]).filter(d=>{var x;return(((x=d.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(d=>{var v;const x=((v=d.properties)==null?void 0:v.name)||"",u=s(d)||"";return u?{i2:Ni(x)||null,n:x,d:u}:null}).filter(d=>!!d);if(!l.length)return null;const c={};for(const[d,x]of Object.entries(Ei)){const u=i(x);u&&(c[d]={x:u[0],y:u[1]})}const h={};for(const[d,x]of Object.entries(Fo)){const u=x.map(v=>i(v.ll)).filter(v=>!!v).map(([v,m])=>({x:v,y:m}));u.length&&(h[d]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:c,metros:h}}catch{return null}})(),xa)}function td(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return ed().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const ad="8 40 984 210",nd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Mr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Or(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function rd(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const s=()=>{var h;if(!o)return;const c=(h=e.current)==null?void 0:h.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function Dr({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],s)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function od(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:s,lang:l,t:c,data:h,dossiers:d,source:x}=V(),u=h.loading&&!d.length,v=p.useRef(null),m=p.useRef(null),b=td(e.continent==="monde"),k=e.continent==="monde"?b:Cn.find(g=>g.key===e.continent)||null,f=rd(v,e.continent+":"+e.mapFolded+":"+!!k),[y,j]=p.useState(new Map),[w,N]=p.useState(null);p.useEffect(()=>{const g=v.current;if(!g)return;const q=new Map;g.querySelectorAll("path[data-i2]").forEach($=>{const X=$.dataset.i2;if(X)try{const I=$.getBBox();I.width>0&&q.set(X,{x:I.x,y:I.y,w:I.width,h:I.height})}catch{}}),j(q)},[e.continent,f,k]);const S=p.useMemo(()=>r.filter(g=>g.cc),[r]),C=p.useMemo(()=>{const g=new Map;return S.forEach(q=>g.set(q.cc,(g.get(q.cc)||0)+1)),g},[S]),T=e.continent==="monde"&&b?b.anchors:null,A=e.continent==="monde"&&b?b.metros:null,F=p.useMemo(()=>S.map(g=>{const q=Or(g.name||g.id||""),$=Or((g.id||g.name||"")+"·y");if(T&&g.cc){const Y=A?A[g.cc]:void 0;if(Y&&Y.length){const J=Zl(g.cc,g.city,q);if(J>=0&&Y[J])return{d:g,x:Y[J].x+(q-.5)*5,y:Y[J].y+($-.5)*5}}const K=T[g.cc];if(K)return{d:g,x:K.x+(q-.5)*10,y:K.y+($-.5)*10}}const X=g.cc?y.get(g.cc):void 0;if(!X)return null;const I=nd[`${e.continent}:${g.cc||""}`];if(I)return{d:g,x:X.x+X.w*(I.fx+(q-.5)*I.sx),y:X.y+X.h*(I.fy+($-.5)*I.sy)};const O=(q-.5)*Math.min(X.w*.55,60),Q=($-.5)*Math.min(X.h*.55,60);return{d:g,x:X.x+X.w/2+O,y:X.y+X.h/2+Q}}).filter(g=>!!g),[S,y,T,A,e.continent]),D=g=>f>0?g/f:g,P=p.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:Mr[g],fr:c.plabels[g].toUpperCase(),en:c.plabels[g].toUpperCase(),n:r.filter(q=>q.kind==="target"&&ze(q)===g).length})).filter(g=>g.n>0):Wn.map((g,q)=>({...g,n:r.filter($=>Gn($)===q).length})),[r,n,c.plabels]),L=i?s.get(i):null,R=L?F.find(g=>g.d.id===L.id):null;return k?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Dr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:v,viewBox:e.continent==="monde"?ad:k.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?k.fr:k.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:k.countries.map((g,q)=>t.jsx("g",{className:"ct"+(g.i2&&C.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},q))}),t.jsx("g",{children:F.map(g=>{const q=Wn[Gn(g.d)],$=!!Me(g.d),X=g.d.kind==="target",I=n&&X?Mr[ze(g.d)]:q.c,O=!n&&Ie(g.d);return t.jsxs("g",{className:"co"+(O?" done":""),onMouseEnter:()=>{var K,J;const Q=(K=m.current)==null?void 0:K.getBoundingClientRect(),Y=(J=v.current)==null?void 0:J.createSVGPoint();if(Y&&v.current&&Q){Y.x=g.x,Y.y=g.y;const ge=Y.matrixTransform(v.current.getScreenCTM());N({x:ge.x-Q.left,y:ge.y-Q.top,label:g.d.name+" · "+($t(g.d.cc,l)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var K;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const Q=(K=v.current)==null?void 0:K.createSVGPoint();let Y=null;if(Q&&v.current){Q.x=g.x,Q.y=g.y;const J=Q.matrixTransform(v.current.getScreenCTM());Y={x:J.x,y:J.y}}a({type:"popup",id:g.d.id,anchor:Y})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:D(Math.max(11,q.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:D(q.px),fill:I,stroke:$?"#DC2626":"#ffffff",strokeWidth:D($?2.2:1.3)})]},g.d.id||g.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:D(13),fill:"none",stroke:"#0F172A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:P.map((g,q)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),l==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},q))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Dr,{msgs:c.loadMsgs})})}function id(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Ro({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:s,lang:l}=V(),c=a.filters,[h,d]=p.useState(!1),[x,u]=p.useState(!1),v=p.useRef(null),m=p.useRef(null),b=p.useMemo(()=>a.continent==="monde"?n:n.filter(R=>R.continent===a.continent),[n,a.continent]),k=R=>b.filter(g=>R!=="country"&&c.country.length&&!c.country.includes(g.cc||"")?!1:Ca(g,c,i,R==="country"?void 0:R)),f=R=>!i||R.kind!=="op",y=p.useMemo(()=>{const R=k("win").filter(f),g=q=>R.filter($=>($.date?Math.max(0,Math.floor((Date.now()-Date.parse($.date))/864e5)):9999)<=q).length;return[g(0),g(7),g(30),R.length]},[b,c,i]),j=p.useMemo(()=>c.day?k("win").filter(f).filter(R=>(R.date||"").slice(0,10)===c.day).length:0,[b,c,i]),w=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,N=w+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),p.useEffect(()=>{if(!h&&!x)return;const R=q=>{var X,I;const $=q.target;h&&!((X=v.current)!=null&&X.contains($))&&d(!1),x&&!((I=m.current)!=null&&I.contains($))&&u(!1)},g=q=>{q.key==="Escape"&&(d(!1),u(!1))};return document.addEventListener("mousedown",R),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",R),document.removeEventListener("keydown",g)}},[h,x]);const S=(R,g,q,$="fbtn")=>t.jsxs("button",{type:"button",className:$,"aria-expanded":a.openFacet===R,onClick:()=>r({type:"openFacet",facet:R}),children:[t.jsx("span",{className:"fl",children:g}),q>0&&t.jsx("span",{className:"n",children:q}),t.jsx("span",{className:"cv",children:"▾"})]},R),C=["1","7","30","all"],T=Math.max(0,C.indexOf(c.win||"all")),A=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(id(c.day,l))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(R=>!R),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:y[T]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((R,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===R,onClick:()=>{r({type:"filters",patch:{win:R}}),u(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:y[g]})]},R))})]}):t.jsx("div",{className:"seg",children:C.map((R,g)=>t.jsxs("button",{type:"button","aria-pressed":c.win===R,onClick:()=>r({type:"filters",patch:{win:R}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:y[g]})]},R))}),F=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:R=>r({type:"filters",patch:{search:R.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):S("sec",o.fSector,c.sector.length),S("pay",o.fCountry,c.country.length),S("det",o.fEngine,c.engine.length),S("sta",o.fStage,c.stage.length),i&&S("ang","Angle",c.angle.length),i&&S("mem","Mémo",c.memoLevel.length)]}),P=(R=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(b.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),R&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:v,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(w?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{d(R=>!R),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),w>0&&t.jsx("span",{className:"n",children:w}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:A}),t.jsxs("div",{className:"fstrip-b",children:[F,L,P(!1)]})]}),a.openFacet&&t.jsx(Ir,{poolFor:k})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[A,F,D,t.jsx("span",{className:"fgrow"}),P()]}),a.openFacet&&t.jsx(Ir,{poolFor:k})]})}function Ir({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=V(),i=a.filters,s=a.openFacet,{title:l,cols:c,options:h}=p.useMemo(()=>{if(s==="sig"){const m=e("signal").filter(f=>Me(f)),b=new Map;m.forEach(f=>{const y=f.engine||"";b.set(y,(b.get(y)||0)+1)});const k=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...rn([...b.keys()],o).map(f=>({v:f,label:zt(f)+" "+Ke(f,o),n:b.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:k}}if(s==="sec"){const m=e("sector"),b=new Map;return m.forEach(k=>{k.sector&&b.set(k.sector,(b.get(k.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k,n:f,html:!1,on:i.sector.includes(k)}))}}if(s==="pay"){const m=e("country"),b=new Map;return m.forEach(k=>{k.cc&&b.set(k.cc,(b.get(k.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:$t(k,o)||k,n:f,html:!1,on:i.country.includes(k)}))}}if(s==="det"){const m=e("engine"),b=new Map;return m.forEach(k=>{k.engine&&b.set(k.engine,(b.get(k.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:rn([...b.keys()],o).map(k=>({v:k,label:zt(k)+" "+Ke(k,o)+' <span style="color:var(--dim);font-size:10px">· '+Si(Ci(k),o)+"</span>",n:b.get(k)||0,html:!0,on:i.engine.includes(k)}))}}if(s==="ang"){const m=e("angle"),b=new Map;return m.forEach(k=>{k.angle&&b.set(k.angle,(b.get(k.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((k,f)=>f[1]-k[1]).map(([k,f])=>({v:k,label:k.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(k)}))}}if(s==="mem"){const m=e("memoLevel"),b=new Map;m.forEach(f=>{if(f.kind==="target"){const y=En(f);b.set(y,(b.get(y)||0)+1)}});const k=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:k[f],n:b.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const u=e("stage"),v=new Map;return u.forEach(m=>{m.stage&&v.set(m.stage,(v.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((m,b)=>b[1]-m[1]).map(([m,b])=>({v:m,label:m,n:b,html:!1,on:i.stage.includes(m)}))}},[s,a,o]),d=u=>{if(s==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(u)?i.signalEngines.filter(b=>b!==u):[...i.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:u})},x=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:h.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Mo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:s,t:l}=V(),c=p.useMemo(()=>{const v={};return r.forEach(m=>{Ca(m,n.filters,i)&&(v.monde=(v.monde||0)+1,m.continent&&(v[m.continent]=(v[m.continent]||0)+1))}),v},[r,n.filters,i]),[h,d]=p.useState(!1),x=p.useRef(null);p.useEffect(()=>{if(!h)return;const v=b=>{var k;(k=x.current)!=null&&k.contains(b.target)||d(!1)},m=b=>{b.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",v),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",v),document.removeEventListener("keydown",m)}},[h]);const u=v=>{const m=Cn.find(b=>b.key===v);return v==="monde"?l.contWorld:s==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>d(v=>!v),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Yn.map(v=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===v,onClick:()=>{o({type:"continent",key:v}),d(!1)},children:[u(v),t.jsx("span",{className:"n",children:c[v]||0})]},v))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[Yn.map(v=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===v,onClick:()=>o({type:"continent",key:v}),children:[u(v),t.jsx("span",{className:"n",children:c[v]||0})]},v)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function Nn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function Oo(e){return"atl2:evalq:"+(e||"anon")}function sd(e,a){const r=Oo(e),n=Nn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const s=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(s)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Do(){const{t:e,data:a}=V(),r=a.session.token||"",n=Oo(r),[o,i]=p.useState(()=>Nn(n)),s=p.useRef(!1),[l,c]=p.useState(!1);p.useEffect(()=>{try{const y=o.slice(0,30).map(({descBusy:j,evalBusy:w,...N})=>N);localStorage.setItem(n,JSON.stringify(y)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[o,n]),p.useEffect(()=>{const y=()=>{if(s.current)return;const j=Nn(n);i(w=>JSON.stringify(w.map(({descBusy:N,evalBusy:S,...C})=>C))===JSON.stringify(j)?w:j)};return window.addEventListener("atl2:evalq",y),window.addEventListener("storage",y),()=>{window.removeEventListener("atl2:evalq",y),window.removeEventListener("storage",y)}},[n]);const h=p.useCallback((y,j)=>i(w=>w.map((N,S)=>S===y?{...N,...j}:N)),[]),d=p.useCallback((y,j)=>{const w=j.trim();w&&(h(y,{name:w,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),zn(w).then(N=>{const S=N.candidates||[];N.website?h(y,{site:N.website,status:"ready"}):S.length===1?h(y,{site:S[0].url,status:"ready"}):S.length>1?h(y,{status:"pick",candidates:S.slice(0,4)}):h(y,{status:"ready"})}).catch(()=>h(y,{status:"ready"})))},[h]),x=p.useCallback((y,j,w)=>{h(y,{descBusy:!0}),eo(r,j,w).then(N=>{if(N.quota){c(!0),h(y,{descBusy:!1,descDone:!0});return}const S=N.blocs||{},C=(S.synthese||S.value_prop||S.produit||S.modele||"").trim();h(y,{descBusy:!1,descDone:!0,desc:C})}).catch(()=>h(y,{descBusy:!1,descDone:!0}))},[h,r]);p.useEffect(()=>{const y=o.findIndex(w=>w.auto&&w.name.trim()&&w.status==="");if(y>=0){d(y,o[y].name);return}if(l)return;const j=o.findIndex(w=>w.status==="ready"&&w.site&&!w.descDone&&!w.descBusy);j>=0&&x(j,o[j].name,o[j].site)},[o,d,x,l]);const[u,v]=p.useState(!1),m=p.useCallback(async(y,j)=>{h(y,{evalBusy:!0});const w=await to(r,(j.site||j.name).trim(),"atelier2");return w.verdict==="quota"?(h(y,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:w.reason||"",remaining:0}})),!1):(h(y,{evalBusy:!1,status:w.verdict==="kept"?"kept":"out",reason:w.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:w.company||j.name,verdict:w.verdict,reason:w.reason||"",remaining:w.remaining??null}})),!0)},[h,r]),b=async()=>{if(u)return;const y=o.map((j,w)=>({r:j,i:w})).filter(({r:j})=>j.name.trim()&&j.status!=="kept"&&j.status!=="out"&&j.status!=="resolving");if(y.length){v(!0);for(const{r:j,i:w}of y)if(!await m(w,j))break;v(!1)}},k=o.filter(y=>y.name.trim()&&y.status!=="kept"&&y.status!=="out").length,f=y=>y.name.trim()&&y.status!=="kept"&&y.status!=="out"&&y.status!=="resolving"&&!y.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),o.map((y,j)=>t.jsxs("div",{className:"eq-row"+(y.status==="kept"?" r-kept":y.status==="out"?" r-out":""),children:[t.jsx("input",{value:y.name,placeholder:e.eqNamePh,onChange:w=>{const N=w.target.value.split(`
`).map(S=>S.trim()).filter(Boolean);N.length>1?i(S=>{const C=[...S];return C.splice(j,1,...N.map(T=>({name:T,site:"",status:"",auto:!0}))),C.slice(0,30)}):h(j,{name:w.target.value})},onBlur:()=>{y.name.trim()&&!y.site&&y.status!=="resolving"&&y.status!=="pick"&&d(j,y.name)},onKeyDown:w=>{w.key==="Enter"&&d(j,y.name)}}),t.jsxs("span",{className:"eq-site",children:[y.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),y.status==="pick"&&(y.candidates||[]).map(w=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>h(j,{site:w.url,status:"ready",candidates:void 0}),children:(w.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},w.url)),y.status!=="resolving"&&y.status!=="pick"&&(y.site?t.jsxs("a",{href:y.site.startsWith("http")?y.site:"https://"+y.site,target:"_blank",rel:"nofollow noopener",children:[y.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:y.name.trim()&&y.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:y.desc||"",children:y.descBusy?t.jsx("i",{children:e.eqDescBusy}):y.desc?y.desc:t.jsx("em",{children:y.descDone?l?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(y.status||"vide"),title:y.reason||"",children:y.status==="kept"?"✓ "+e.kept:y.status==="out"?"✗ "+e.dropped:y.status==="ready"?e.eqReady:y.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!f(y)||u,onClick:()=>{m(j,y)},children:y.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>i(w=>w.filter((N,S)=>S!==j)),children:"×"})]},j)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>i(y=>[...y,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{justifyContent:"center"},disabled:u||!k,onClick:()=>{b()},children:[t.jsx("span",{className:"fill"}),u?e.eqRunning:e.eqGo(k)]}),t.jsx("span",{className:"hint",children:e.eqHint}),o.some(y=>y.status==="kept"||y.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>i(y=>y.filter(j=>j.status!=="kept"&&j.status!=="out")),children:e.eqClearDone})]})]})}function Io(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function ld(e){var o;const a=[],r=new Set,n=i=>{const s=(i||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Pr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:s}){const{t:l}=V();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:l.rsEvalOne})]},c.name))})]}):null}function Po({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=V(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Pr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Pr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function dd({card:e,onEvaluate:a,onAddAll:r}){var l,c,h;const{t:n}=V(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Io(e.summary_md||"").map((d,x)=>t.jsx("p",{children:d},x))})]}),t.jsx(Po,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function cd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function pd({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:s}=V(),l=o,[c,h]=p.useState(null),[d,x]=p.useState(null),[u,v]=p.useState(null),[m,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const y=await ao({email:s,cbToken:l});f&&h(y)})(),()=>{f=!1}},[s,l,n]);const k=f=>{x(f),v(null),b(!0),(async()=>{const y=await zi(f.id);v(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),v(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>k(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[cd(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(dd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ka=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Xt(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?Xt(a)?a:ka.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function ud(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function md(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:s,evalBusy:l,evalCards:c,caps:h,data:d,canWrite:x,source:u,dossiers:v,doAnalyse:m,liveMemos:b,pipe:k}=V(),f=a==="client",y=p.useMemo(()=>r||(u!=="default"?Ai():""),[r,u]),[j,w]=p.useState(""),[N,S]=p.useState(!1),[C,T]=p.useState(""),[A,F]=p.useState(""),[D,P]=p.useState(""),[L,R]=p.useState(!1),[g,q]=p.useState(!1),[$,X]=p.useState([]);p.useEffect(()=>{const M=ee=>{const ie=ee.detail;ie&&X(Z=>[ie,...Z].slice(0,8))};return window.addEventListener("ppmap:evalcard",M),()=>window.removeEventListener("ppmap:evalcard",M)},[]);const[I,O]=p.useState(!1),[Q,Y]=p.useState(!1),[K,J]=p.useState(!1),ge=p.useRef(!1),[W,ce]=p.useState(""),[le,be]=p.useState(""),[me,de]=p.useState(!1),[pe,xe]=p.useState(!1),[H,re]=p.useState(0),[fe,ke]=p.useState(""),[ne,ve]=p.useState(null),[oe,Ee]=p.useState(null),[Qe,he]=p.useState(!1),[Se,Lt]=p.useState(null),[Pe,Je]=p.useState(0),qe=p.useRef(!1),it=j.trim()?ka.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const M=new URLSearchParams(window.location.search),ee=(M.get("rs")||"").trim(),ie=(M.get("rstext")||"").trim();ee&&/^https?:\/\//i.test(ee)&&ce(ee),ie&&be(ie),(ee&&/^https?:\/\//i.test(ee)||ie)&&O(!0)},[]),p.useEffect(()=>{const M=ee=>{const ie=ee.detail||{},Z=String(ie.url||"").trim(),je=String(ie.text||"").trim();Z&&/^https?:\/\//i.test(Z)&&ce(Z),je&&be(je),(Z&&/^https?:\/\//i.test(Z)||je)&&(O(!0),w(""),T(""),de(!0),window.setTimeout(()=>de(!1),900))};return window.addEventListener("ppmap:research",M),()=>window.removeEventListener("ppmap:research",M)},[]),p.useEffect(()=>{const M=ee=>{const ie=ee.detail||{},Z=String(ie.name||"").trim();if(!Z)return;O(!1),w(Z),T(Z);const je=lt(String(ie.website||ie.domain||""));F(je),P(lt(String(ie.url||""))),R(!je),S(!0),window.setTimeout(()=>S(!1),900)};return window.addEventListener("ppmap:prefill",M),()=>window.removeEventListener("ppmap:prefill",M)},[]),p.useEffect(()=>{const M=(C||"").trim();if(!M||I||A){(A||!M||I)&&R(!1);return}const ee=v.find(je=>_e(je.name)===_e(M)),ie=lt((ee==null?void 0:ee.website)||"")||lt((ee==null?void 0:ee.domain)||"");if(ie){F(ie),R(!1);return}let Z=!0;return R(!0),zn(M).then(je=>{var $e,Ae;if(!Z)return;const De=lt(je.website||"")||lt(((Ae=($e=je.candidates)==null?void 0:$e[0])==null?void 0:Ae.url)||"");De&&F(De)}).catch(()=>{}).finally(()=>{Z&&R(!1)}),()=>{Z=!1}},[C,I,A,v]),p.useEffect(()=>{const M=ee=>{var Z;const ie=String(((Z=ee.detail)==null?void 0:Z.url)||"").trim();Xt(ie)&&window.open(ie,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",M),()=>window.removeEventListener("ppmap:view",M)},[]),p.useEffect(()=>{if(ge.current===I)return;ge.current=I,J(!0);const M=window.setTimeout(()=>J(!1),560);return()=>window.clearTimeout(M)},[I]),p.useEffect(()=>{if(typeof window>"u")return;const M=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ee=document.querySelector(".atl2.ops, .atl2.cibles");if(!M||!ee)return;const ie=()=>ee.style.setProperty("--demand-h",`${M.offsetHeight}px`);ie();const Z=new ResizeObserver(ie);return Z.observe(M),()=>Z.disconnect()},[u,N,me,g,I,K,L]),p.useEffect(()=>{if(!x&&!y){Lt(null);return}let M=!0;return(async()=>{const ee=await ao({email:n,cbToken:y});M&&Lt(ee.length)})(),()=>{M=!1}},[x,y,n,Pe]);const kt=$.length?$:c,Oe=d.credits,xt=p.useCallback(M=>{sd(r,M)&&q(!0)},[r]);p.useEffect(()=>{if(!pe)return;re(0);const M=window.setInterval(()=>re(ee=>ee+1),1e3);return()=>window.clearInterval(M)},[pe]);const ut=p.useMemo(()=>{const M=j.trim().toLowerCase();return!M||!k?null:v.find(ee=>_e(ee.name)===M&&ze(ee)===1)||null},[j,v,k]),Xe=()=>{const M=j.trim();if(M){if(ut){m(ut);return}o(null,M),f&&w("")}},jt=async()=>{var ie,Z,je;if(qe.current)return;const M=W.trim().replace(/\s+/g,""),ee=le.trim();if(!M&&!ee){ke(e.rsNeed);return}if(!f&&!y){o(null,M||ee.slice(0,80));return}qe.current=!0,ke(""),ve(null),Ee(null),xe(!0);try{const De=await Ti({url:M,text:ee,email:n,cbToken:y});if(xe(!1),!De||De.status!=="success"){ke((De==null?void 0:De.message)||"Erreur");return}ve(De),O(!1),xt((((ie=De.prospective)==null?void 0:ie.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),Ee({state:"pending"});const $e=await Li(De,{email:n,cbToken:y});Ee($e.ok?{state:"ok",scopeLabel:((Z=$e.summary)==null?void 0:Z.scope_label)||"",scope:((je=$e.summary)==null?void 0:je.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&Je(Ae=>Ae+1)}finally{qe.current=!1,xe(!1)}},gt=[ne==null?void 0:ne.industry,...(ne==null?void 0:ne.market_tags)||[],ne==null?void 0:ne.author].map(M=>(M||"").trim()).filter(Boolean),bt=(oe==null?void 0:oe.state)==="pending",Ft=oe&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),Nt=ld(ne).length,Fe=I,nt=(C||j).trim(),z=v.find(M=>_e(M.name)===_e(nt)),B=lt(j)||A||lt((z==null?void 0:z.website)||"")||lt((z==null?void 0:z.domain)||""),U=D||lt((z==null?void 0:z.url)||""),ae=ut?e.actAnalyse:nt?e.evalGoOn(nt.length>22?nt.slice(0,21)+"…":nt):e.evalGo,ye=pe?`${qi(W.trim())==="youtube"&&W.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(H)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Fe?" rs-mode":"")+(C&&j.trim()===C||N||me?" pair":"")+(N||me||K?" echo":"")+(K?" swap":""),children:[t.jsxs("div",{className:"drow"+((Fe?me:N)||K?" flash":"")+((Fe?W.trim():ka.test(j.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Fe?W:j,placeholder:Fe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Fe?600:200,spellCheck:Fe?!1:void 0,inputMode:Fe?"url":void 0,onChange:M=>{if(Fe){ce(M.target.value);return}w(M.target.value),C&&M.target.value.trim()!==C&&(T(""),F(""),P(""),R(!1))},onKeyDown:M=>{M.key==="Enter"&&(Fe?jt():Xe())}}),t.jsx("span",{className:"detect"+(Fe?" off":"")+(ka.test(j.trim())?" url":""),children:it})]}),t.jsx("span",{className:"dacts",children:Fe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(pe?" loading":""),disabled:pe||bt||!W.trim()&&!le.trim(),onClick:()=>{jt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ye})]}),t.jsxs("a",{className:"viewbtn"+(Xt(W)?"":" off"),href:Xt(W)?W.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:M=>{Xt(W)||M.preventDefault()},children:[t.jsx(ud,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ut?" analyse":"")+(l?" loading":""),disabled:l,onClick:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ae})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":B?"":" off"),href:B||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:M=>{B||M.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(U?"":" off"),href:U||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:M=>{U||M.preventDefault()},children:e.viewSrc})]})}),h.showCredits&&Oe&&t.jsxs("button",{type:"button",className:"credits"+(Oe.total_available<=0&&!Oe.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Oe.unlimited?"∞":Oe.total_available}),!Oe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Oe.daily_grant+Oe.purchased]}),Oe.total_available<=0&&!Oe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>q(!g),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(I?" on":""),onClick:()=>O(!I),children:e.rsOpen}),Se!==null&&Se>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Qe?" on":""),onClick:()=>he(!Qe),children:e.rsArchOpen(Se)})]}),Qe&&t.jsx(pd,{bump:Pe,cbToken:y,onClose:()=>he(!1),onEvaluate:M=>o(null,M),onAddAll:xt}),t.jsx("div",{className:"rsp slim"+(I?" on":" off"),"aria-hidden":!I,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:I?void 0:-1,onClick:()=>Y(M=>!M),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:Q?"▴":"▾"})]}),Q&&t.jsx("textarea",{className:"rstext",value:le,placeholder:e.rsTextPh,tabIndex:I?void 0:-1,onChange:M=>be(M.target.value)})]})}),fe&&t.jsx("div",{className:"rserr",children:fe}),ne&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ne.title}),ne.source_url&&t.jsx("a",{href:ne.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ve(null),Ee(null)},children:"×"})]}),ne.market&&t.jsx("p",{className:"rsmk",children:ne.market}),gt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),gt.map(M=>t.jsx("span",{children:M},M))]}),t.jsxs("div",{className:"rsbody",children:[ne.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ne.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Io(ne.summary_md||"").map((M,ee)=>t.jsx("p",{children:M},ee))})]}),t.jsx(Po,{card:ne,onEvaluate:M=>o(null,M),onAddAll:xt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Nt)}),Ft]})]}),g&&t.jsx(Do,{}),kt.slice(0,1).map((M,ee)=>{const ie=M.verdict==="kept",Z=M.verdict==="quota",je=M.verdict==="unresolved",De=ie?"var(--brand)":Z?"var(--bolt)":je?"var(--blue)":"var(--red)",$e=ie?"var(--brand-l)":Z?"#FEF3C7":je?"#EEF4FF":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":De,"--bgc":$e},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ie?"✓ "+e.kept:Z?"⏳":je?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),M.name&&t.jsx("span",{className:"rn",children:M.name}),t.jsx("span",{className:"rr",children:M.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",M.reason]}):null}),!!(M.candidates&&M.candidates.length)&&t.jsx("span",{className:"sitepick",children:M.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,Ae.url,M.name),children:e.evalPickGo})]},Ae.url))}),!Z&&!je&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ie?1:5});const Ae=(M.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ue=[...document.querySelectorAll(".atl2 .list .row")].find(Pa=>{var la;return(((la=Pa.querySelector(".rnm"))==null?void 0:la.textContent)||"").trim().toLowerCase().includes(Ae)});Ue&&(Ue.scrollIntoView({behavior:"smooth",block:"center"}),Ue.classList.add("flashrow"),window.setTimeout(()=>Ue.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ie?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),f&&(i.kept+i.dropped>0||kt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function fd(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function hd(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=V(),i=e.memoConsole?r.get(e.memoConsole):null,s=p.useMemo(()=>i?[i.reasoning||"",fd(i.summary||"")].filter(Boolean).join(`
...
`;function Cd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function zd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:s,askEvaluate:l,doAnalyse:c,doDecide:h,doPromote:d,doRepeche:x,doApproach:u,doDeep:v,doOnboard:m,outbound:b,evalBusy:k}=V(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=Me(f),j=ze(f),w=wt(f),N=ia(f),S=f.kind==="target",C=T=>{a({type:"filters",patch:T}),a({type:"popup",id:null})};return _t.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Sd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Cd(e.popupAnchor,!!f.card),onClick:T=>T.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ht(f.date)),Ke(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[f.cc]}),children:($t(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Ut(f.amountEur,o)})]}),i.pipe&&S&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[zt(f.engine)," ",t.jsx("b",{children:Ke(f.engine,o)})," — ",Mi(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(yt,{o:f,lg:!0})," ",t.jsx(Ia,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(ro(y,o))," · ",n.win7(oo(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(sa,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&S&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&S&&t.jsx(Mn,{o:f})]}),t.jsx(Rn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(f,!1),a({type:"popup",id:null})},children:n.actNo}),Dt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var T;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(T=document.querySelector(".atl2 .demand"))==null||T.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:k,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:k,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Ad(){const{lang:e,token:a,dossiers:r,caps:n}=V(),o=a||"home",{names:i,verdicts:s}=p.useMemo(()=>{const c=[],h={};return r.forEach(d=>{d.kind!=="target"||!d.name||(c.push(d.name),h[d.name]=Oi(d)||"")}),{names:c,verdicts:h}},[r]);return{diff:p.useMemo(()=>i.length?Di(o,i,s,e):null,[o,i.length]),names:i,verdicts:s,scope:o,caps:n}}function qd(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:s,caps:l}=V(),[c,h]=p.useState(!1),[d,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!c)return;const j=w=>{u.current&&!u.current.contains(w.target)&&h(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[c]);const v=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!s.length,b=p.useRef({});p.useEffect(()=>{b.current={...r}},[r]);const k=j=>{const w=b.current[j],N=w!==void 0?r[j]-w:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zt[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j].toUpperCase(),j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[j],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},j)},f=(j,w,N)=>t.jsxs("button",{type:"button",className:"off"+(w?" view":""),style:{"--c":`var(${Zt[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:N.toUpperCase()}),t.jsx("span",{className:"n",children:r[j]})]},j),y=(j,w,N,S=!1)=>t.jsx("button",{type:"button",className:"tool",title:w,disabled:S,onClick:N,children:j},w);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(k)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[y("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(d?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":c,title:n.toolSort,onClick:()=>h(j=>!j),children:"⇅"}),c&&t.jsx("span",{className:"sortmenu",role:"listbox",children:v.map(([j,w])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[w,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),y("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),y("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Td(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:s}=V(),l=p.useRef(null),[c,h]=p.useState(60);p.useEffect(()=>{let m=0;const b=()=>{var w;const k=l.current;if(!k)return;const f=(w=k.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!f)return;const y=f.getBoundingClientRect(),j=k.getBoundingClientRect();h(Math.max(20,Math.min(y.left+y.width/2-j.left,j.width-30)))};return m=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",b)}},[e.ptab]);const d=e.ptab;let x=r.tuto[d].p;if(d===3){const m=n.filter(f=>f.kind==="target"&&ze(f)===3),b=m.filter(f=>on(f)==="auto").length,k=m.filter(f=>on(f)==="cd").length;x=r.tutoPending(b,k,m.length)}const u=(()=>{if(s!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(d===1){const m=n.filter(b=>b.kind==="target"&&ze(b)===1&&!o.has(b.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(b=>b.id)})}}return null})(),v=Ii(d);return t.jsxs("div",{ref:l,className:"tuto mini"+(v?"":" on-dark"),style:{"--bg":`var(${Zt[d]})`,"--ax":c+"px","--stc":v?"var(--ink)":"#fff","--stt":v?"#fff":"var(--ink)","--tc":v?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const an=600,St=62,Vr="atl2:fstats";function Ld(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=V(),[s,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Vr)==="on"}catch{return!1}}),c=r.stats,h=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),v=h.reduce((N,S)=>Math.max(N,S.s||0),0),m=h.length?an/h.length:0,b=Math.max(4,m-4),k=h.length>=5&&v>0,f=r.marketEstimate||0,y=x(new Date().toISOString().slice(0,10)),j=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&d&&w.push({cle:"fenetre",periode:e.funPerWindow(x(d),y),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:j(c.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[w.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([S,C],T)=>t.jsxs("span",{className:"fst-t",children:[T>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(S)}),t.jsx("i",{children:C})]},N.cle+C)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),N.cle===w[w.length-1].cle&&k&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const S=!s;l(S),S&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Vr,S?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},N.cle)),s&&k&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${an} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((N,S)=>{const C=(N.s||0)/v*(St-4),T=(N.m||0)/v*(St-4),A=S*m+(m-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:St-2-C,width:b,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:St-2-T,width:b,height:T,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:an,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const _o={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function On({o:e,locked:a=!1}){const{t:r}=V(),n=ia(e),o=wt(e),i=ze(e),s=on(e),l=Pi(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(_o[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(el,{o:e})]})}const Bt=e=>e.length>22?e.slice(0,21)+"…":e;function oa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function $o(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Fd({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const s=()=>{var m,b,k;const l=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const h=l.getBoundingClientRect(),d=c?c.getBoundingClientRect().bottom:h.top;i({top:Math.round(d),left:Math.round(h.left),width:Math.round(h.width)});const x=[...l.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const y=f.querySelector(".grp-h");y&&y.getBoundingClientRect().bottom<=d+2&&(u=f)}if(!u){n(null);return}const v=u.querySelector(".grp-h");if(!v){n(null);return}n({ic:(((m=v.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((b=v.querySelector(".t"))==null?void 0:b.textContent)||"").trim(),s:(((k=v.querySelector(".s"))==null?void 0:k.textContent)||"").trim()})};return s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",s),window.removeEventListener("resize",s)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Rd(e){const r=()=>{const n=$o(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Wr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=V(),[i,s]=p.useState(!1);if(p.useEffect(()=>{n||s(!1)},[n]),Ie(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}function Dn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:s,doPromote:l,doRepeche:c,doApproach:h,dispatch:d,liveMemos:x}=V(),u=m=>b=>{b.stopPropagation(),m()};if(r.lockActions){const m=u(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const b=ze(e);return b===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}):b===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):b===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):b===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):b===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):b===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Sa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Wr,{o:e})});const v=ze(e);if(v===0)return t.jsx("span",{className:"cell",children:t.jsx(Wr,{o:e})});if(v===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:u(()=>i(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(v===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(v===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>h(e)),children:m?a.actApproachSent:a.actApproach})})}return v===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):v===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Md({o:e}){const{t:a,doThumb:r,thumbOf:n}=V(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Od({o:e}){const{lang:a}=V();return Me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(yt,{o:e}),t.jsx(Ia,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[zt(e.engine||"")," ",Ke(e.engine||"",a)]})})}function Dd({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:s,fresh:l}){const{dispatch:c,caps:h,markRow:d,markedId:x,favIds:u,toggleFav:v,t:m}=V(),b=ze(e),k=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,y=f<=0?0:f<=7?1:f<=30?2:3,j=h.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][b]:k[y],w=u.has(e.id),N=S=>{if(a)return;if(s){s(e.id);return}if(h.pipe||e.kind==="op"){n();return}const C=S.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(h.pipe&&e.kind==="target"?" p"+b:"")+(w?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(Go,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),Me(e)&&t.jsx(yt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[h.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:w?1:.35,padding:0,marginRight:4},onClick:S=>{S.stopPropagation(),v(e)},children:w?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ve(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(S=>S&&S!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:S=>{S.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Bt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(Id,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Od,{o:e}),h.pipe&&t.jsx(On,{o:e,locked:a}),h.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Dn,{o:e}),h.showThumbs&&t.jsx(Md,{o:e})]}),r&&!a&&!s&&t.jsx(_d,{o:e})]})}function Id({o:e}){const{lang:a,caps:r}=V();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ut(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Pd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=V(),s=(u,v=!1)=>m=>{m.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Ut(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ie(e),x=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Ve(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),oa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Bt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(sa,{spec:e.card})})]})}function Bd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=V();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ke(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Dn,{o:e})}),t.jsx(Mn,{o:e})]})}function Uo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:s,caps:l,dossiers:c}=V(),h=p.useRef(null),d=We(e);if(p.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const g=h.current;if(!g)return;let q=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async $=>{await $.ensureEditoCss(),!(q||!g.isConnected)&&($.beautifyEditoRows(g),$.mountCardFits(g))}),()=>{q=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const g=c.find(We);if(g)return t.jsx(Uo,{o:g})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),v=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),b=e?!!e.noCo:!x||Ea(x),k=(e==null?void 0:e.engine)||"",f=We(e),y=e?Ut(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(We),S=((N==null?void 0:N.url)||"").trim(),C=!!u&&!!S&&(u===S||u.endsWith(S)||S.endsWith(u)),T=(g,q=!1)=>$=>{$.stopPropagation(),q&&s({type:"continent",key:"monde"}),s({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const A=()=>{x&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:x}}))},F=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},D=()=>{oa({url:u,headline:v,tagline:e==null?void 0:e.tagline,name:x})},P=e?Ie(e):!1,L=P&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",R=f?r.doEdito.replace(/^📖\s*/,""):k?Ke(k,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[R,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:v}),u&&!f&&(b||Sa({engine:k}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(sa,{spec:m})}),(u&&!C&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!C&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),s({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[P?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!b&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:g=>{g.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Bt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(b||Sa({engine:k}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!b&&x?" ghost":""),onClick:g=>{g.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!b&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Bt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!b&&x&&l.pipe&&t.jsx(Rn,{name:x})]})]})}function _d({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:s}=V();return!o.pipe&&e.kind==="op"?t.jsx(Pd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Mn,{o:e}),t.jsx(tl,{o:e}),t.jsx(rl,{o:e}),t.jsx(Rn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(On,{o:e})})]}),e.card&&t.jsx(sa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[zt(e.engine||"")," ",Ke(e.engine||"",r)]}),Me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(yt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function $d({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:s,doDecide:l,lang:c}=V();if(!s.pipe&&e.kind==="op"){const x=Ut(e.amountEur,c),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),v=(m,b=!1)=>k=>{k.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(sa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:v({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:v({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:v({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[zt(e.engine||"")," ",Ke(e.engine||"",c)]}),Me(e)&&t.jsx(yt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Dn,{o:e})})]})}const h=ze(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(On,{o:e}),Me(e)&&t.jsx(yt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&s.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function Ud(){const{t:e}=V(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Hd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=V(),i=o==="en",s=d=>n.plabels[d]||"",l=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=l.includes(0)?0:l.sort((d,x)=>(e[x]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:i?`${h} ${h>1?"files":"file"} in “${s(c)}”`:`${h} dossier${h>1?"s":""} dans « ${s(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+s(c)," →"]})]})}function Vd(){var bt,Ft,Nt,Fe,nt;const e=V(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:s,scopedAll:l,markRow:c,lang:h,sessTally:d,data:x,dossiers:u,source:v,focusExtra:m,byId:b,token:k}=e,f=lo(),y=p.useMemo(()=>{var U,ae,ye,M;if(!k||v==="ops")return null;const z=(((U=f==null?void 0:f.ed)==null?void 0:U.date)||(f==null?void 0:f.day)||"").slice(0,10),B=[(ae=f==null?void 0:f.ed)==null?void 0:ae.html,(ye=f==null?void 0:f.ed)==null?void 0:ye.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((M=f==null?void 0:f.ed)==null?void 0:M.date)||z,decryptHtml:B||void 0,date:z,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[k,v,h,(bt=f==null?void 0:f.ed)==null?void 0:bt.html,(Ft=f==null?void 0:f.ed)==null?void 0:Ft.acquirers_html,(Nt=f==null?void 0:f.ed)==null?void 0:Nt.date,f==null?void 0:f.day]),j=z=>o.lockRowsAfter!==null||v==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:so,[w,N]=p.useState(new Set);p.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[S,C]=p.useState(null);p.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[T,A]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){A(!1);return}const z=document.getElementById("atl2-stage");if(!z){A(!1);return}const B=new IntersectionObserver(([U])=>A(!!U&&U.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return B.observe(z),()=>B.disconnect()},[a.mapFolded]);const F=a.mapFolded||!T,D=z=>N(B=>{const U=new Set(B);return U.has(z)?U.delete(z):U.add(z),U}),P=v==="ops"||o.pipe,[L,R]=p.useState("all"),[g,q]=p.useState(!1),[$,X]=p.useState(null),[I,O]=p.useState(!1),Q=p.useRef(!0);p.useEffect(()=>{if(Q.current){Q.current=!1;return}R("all"),O(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!I)return;const z=B=>{var U,ae;(ae=(U=B.target)==null?void 0:U.closest)!=null&&ae.call(U,".atl2 .doable")||O(!1)};return document.addEventListener("click",z,!0),()=>document.removeEventListener("click",z,!0)},[I]);const Y=p.useMemo(()=>{var B;const z=new Map;for(const U of Bs(((B=f==null?void 0:f.ed)==null?void 0:B.html)||""))z.has(U.t)||z.set(U.t,U.html);return z},[(Fe=f==null?void 0:f.ed)==null?void 0:Fe.html]),K=p.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!Y.size)return;const B=(z.name||"").trim().toLowerCase();if(B.length<3)return;const U=Y.get(B);if(U)return U;for(const[ae,ye]of Y)if(ae.includes(B)||B.includes(ae))return ye},[Y]),{diff:J}=Ad(),[ge,W]=p.useState(!1),ce=a.filters.win==="1"&&!a.filters.day,[le,be]=p.useState(!1),me=p.useMemo(()=>new Set(((J==null?void 0:J.added)||[]).map(z=>z.trim().toLowerCase()).filter(Boolean)),[J]),de=p.useMemo(()=>{if(!me.size)return 0;const z={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(B=>!We(B)&&me.has((B.name||"").trim().toLowerCase())&&ea(B,z,o.pipe)).length},[u,me,a,o.pipe]);p.useEffect(()=>{const z=()=>{be(!1),q(!1),R("all"),O(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",z),()=>window.removeEventListener("ppmap:tunnel",z)},[]),p.useEffect(()=>{be(!1),q(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const pe=p.useMemo(()=>{const z=l.filter(U=>!We(U)&&Ve(U));let B="";for(const U of z){const ae=(U.date||"").slice(0,10);ae&&(!B||ae<B)&&(B=ae)}return{n:z.length,since:B?B.split("-").reverse().slice(0,2).join("/"):""}},[l]),xe=pe.n,H=p.useMemo(()=>{const B=le&&me.size>0||a.filters.signalOnly||L!=="all"||g?l:s;let U=An(B,a.sort);return U=U.filter(ae=>!We(ae)),le&&me.size&&(U=U.filter(ae=>me.has((ae.name||"").trim().toLowerCase()))),g||L==="explore"?U=U.filter(Ve):L==="eval"?U=U.filter(ae=>!Ve(ae)&&!ae.noCo&&(ae.kind==="op"||!Ie(ae))):o.pipe&&(U=U.filter(ae=>!Ve(ae))),U},[s,l,a.sort,L,le,me,g,o.pipe]),fe=p.useMemo(()=>o.pipe?u.filter(z=>z.kind==="target"&&!We(z)&&Me(z)&&(a.continent==="monde"||z.continent===a.continent)):H.filter(z=>Me(z)&&!Ie(z)),[o.pipe,u,H,a.continent]).length,ke=p.useMemo(()=>o.pipe?H:H.filter(z=>!Ie(z)&&!z.noCo&&!Ve(z)),[H,o.pipe]),ne=v==="ops"?H.filter(Ve).length:0,ve=le?"":o.pipe?n.plabels[a.ptab].toLowerCase():v==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,oe=a.filters,Ee=[];if(oe.day)Ee.push({k:"day",lib:n.fDay(oe.day.slice(8,10)+"/"+oe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(oe.win&&oe.win!=="all"){const z=["1","7","30"].indexOf(oe.win);z>=0&&Ee.push({k:"win",lib:n.dates[z],off:()=>r({type:"filters",patch:{win:"all"}})})}const Qe=z=>z.length<=2?z.join(", "):`${z.length} ${n.fSelected}`;for(const z of["sector","country","engine"]){const B=oe[z];B&&B.length&&Ee.push({k:z,lib:Qe(B),off:()=>r({type:"clearFacet",facet:z})})}oe.search&&Ee.push({k:"search",lib:"🔍 "+oe.search,off:()=>r({type:"filters",patch:{search:""}})}),le&&me.size&&Ee.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>be(!1)}),oe.signalOnly&&Ee.push({k:"sig",lib:"🔴 "+n.sigDock(fe||oe.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const he=(z,B,U="",ae=!1)=>t.jsxs("button",{type:"button","data-s":z,className:U,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:ae?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[B,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),Se=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const z=new Map;H.forEach(ae=>{const ye=ae.engine||"?";z.has(ye)||z.set(ye,[]),z.get(ye).push(ae)});const B={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},U=rn([...z.keys()],h);return[...z.entries()].sort((ae,ye)=>{const M=B[ae[0]]??10+U.indexOf(ae[0]),ee=B[ye[0]]??10+U.indexOf(ye[0]);return M-ee})},[H,o.pipe,a.groupBy,h]),Lt=Se?Se.filter(([z])=>ya.has(z)).length:0,Pe=(()=>{var B;return((B=(Se?Se.flatMap(([,U])=>U):H)[0])==null?void 0:B.id)??null})(),Je=p.useRef(!1),qe=p.useMemo(()=>u.find(We)||y,[u,y]);p.useEffect(()=>{const z=()=>{Je.current=!0,be(!1)};return window.addEventListener("ppmap:reveal",z),window.addEventListener("ppmap:focus",z),()=>{window.removeEventListener("ppmap:reveal",z),window.removeEventListener("ppmap:focus",z)}},[]),p.useEffect(()=>{const z=()=>{qe&&r({type:"focus",id:qe.id})};return window.addEventListener("ppmap:edito",z),()=>window.removeEventListener("ppmap:edito",z)},[qe,r]),p.useEffect(()=>{if(!a.focusId)return;X(a.focusId);const z=window.setTimeout(()=>X(null),900);return()=>window.clearTimeout(z)},[a.focusId]),p.useEffect(()=>{if(P&&!(a.focusId&&(H.some(z=>z.id===a.focusId)||u.some(z=>z.id===a.focusId)||a.focusId===(qe==null?void 0:qe.id)))&&!m){if(qe){r({type:"focus",id:qe.id});return}Pe&&r({type:"focus",id:Pe})}},[P,a.focusId,H,Pe,m,r,u,v,qe]),p.useEffect(()=>{if(!P||!a.focusId||qe&&a.focusId===qe.id||H.some(B=>B.id===a.focusId))return;const z=u.find(B=>B.id===a.focusId);if(z){if(Je.current){z.kind==="op"?R(Ve(z)?"explore":"eval"):L!=="all"&&R("all");return}L!=="all"&&Pe&&r({type:"focus",id:Pe})}},[P,a.focusId,L,H,u,Pe,r,qe]),p.useEffect(()=>{if(!P||!a.focusId||!Je.current)return;const z=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!z){const ye=H.findIndex(M=>M.id===a.focusId);if(ye>=0){const M=Se?"":"pt"+a.ptab;if(M){const ee=a.shown[M]||j();ye>=ee&&r({type:"more",group:M,by:ye-ee+8})}}return}Je.current=!1;const B=$o(),U=z.getBoundingClientRect();U.top>=B-2&&U.bottom<=window.innerHeight-4||Rd(z)},[P,a.focusId,a.ptab,H,a.shown,Se,r]),p.useEffect(()=>{if(typeof window>"u")return;const z=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),B=document.querySelector(".atl2.ops, .atl2.cibles");if(!z||!B)return;const U=()=>B.style.setProperty("--listhead-h",`${z.offsetHeight}px`);U();const ae=new ResizeObserver(U);return ae.observe(z),()=>ae.disconnect()},[F,a.dens,a.mapFolded]);const it=p.useMemo(()=>{if(!P||!a.focusId)return null;if(y&&a.focusId===y.id)return y;const z=H.find(U=>U.id===a.focusId)||u.find(U=>U.id===a.focusId)||null;if(!z)return null;const B=K(z);return B&&B!==z.decryptHtml?{...z,decryptHtml:B}:z},[P,a.focusId,H,u,K,y]),kt=o.lockRowsAfter;let Oe=0;const xt=(z,B)=>{let U=a.shown[B]||j();return z.length-U<=4&&(U=z.length),z.slice(0,U).map(M=>{const ee=kt!==null&&Oe>=kt;Oe++;const ie=K(M),Z=ie&&ie!==M.decryptHtml?{...M,decryptHtml:ie}:M,je=!P&&a.dens!=="maxi"&&(a.dens==="deplie"||(S?S==="open":!!ie)),De=w.has(M.id)?!je:je,$e=P?Ae=>{Je.current=!0,r({type:"focus",id:Ae});const Ue=b.get(Ae);Ue&&(Ve(Ue)?oa(Ue):Ue.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ue.name,url:Ue.url||"",website:Ue.website||"",domain:Ue.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx($d,{o:Z,locked:ee,selected:P&&a.focusId===M.id,onSelect:$e},M.id):t.jsx(Dd,{o:Z,locked:ee,open:De,onToggle:()=>D(M.id),selected:P&&a.focusId===M.id,echo:$===M.id,fresh:me.has((M.name||"").trim().toLowerCase()),onSelect:$e},M.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(v==="ops"?" opsl":"")+(H.length?"":" list-empty"),Xe=t.jsxs(t.Fragment,{children:[Se?Se.map(([z,B])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:zt(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:z==="ma"?n.grpMa:z==="fundraising"?n.grpLev:ya.has(z)&&Lt<=1?n.grpNews:z==="nominations"?n.grpNom:z==="media"?n.grpNewsOther:z==="recrutements"?n.grpHire:ya.has(z)?n.grpNews+" · "+Ke(z,h):Ke(z,h)}),t.jsx("div",{className:"s",children:n.grpCount(B.filter(U=>!Ie(U)).length,B.length)})]})]}),xt(B,z)]},z)):xt(H,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(Ud,{}),o.pipe&&a.ptab===0&&!g&&!le&&L==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(Do,{}),!H.length&&!(x.loading&&!u.length)&&(o.pipe&&L==="all"?t.jsx(Hd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),jt=t.jsxs(t.Fragment,{children:[!le&&!g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:H.length})," ",ve]}),g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:H.length})," ",n.newsWord]}),(!le||g)&&t.jsx("span",{className:"dot",children:"·"}),F&&t.jsx(Mo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[F?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),Ee.map(z=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:B=>{B.stopPropagation(),z.off()},children:[z.lib,t.jsx("i",{children:"×"})]},z.k)),v==="ops"&&H.length>0&&!F&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",H.length-ne," ",n.zoomPulseEval,ne>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",ne," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),gt=t.jsxs("div",{className:"listhead"+(F?" mapoff":""),children:[F&&t.jsx("div",{className:"lh-tools",children:t.jsx(Ro,{compact:!0})}),o.showFunnel&&ge&&ce&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(il,{}),t.jsx(Ld,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:jt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(qd,{}),t.jsx(Td,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ce?" on":""),"aria-pressed":ce,title:n.morningDockTitle,onClick:()=>{if(ce){r({type:"filters",patch:{win:"all",day:""}}),W(!1);return}be(!1),q(!1),R("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),W(!0)},children:["📊 ",n.morningDock(typeof((nt=x.stats)==null?void 0:nt.screened_today)=="number"?x.stats.screened_today:0)]}),J&&!J.firstVisit&&(J.added.length>0||J.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(le?" on":""),"aria-pressed":le,title:n.sinceSub,onClick:()=>{const z=!le;be(z),q(!1),W(!1),R("all"),z&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(de),J!=null&&J.lastDate?` · ${n.sinceSince(J.lastDate)}`:""]}),fe>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{be(!1),q(!1),W(!1),R("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(fe)]}),o.pipe&&xe>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(g?" on":""),"aria-pressed":g,title:n.newsDockHint,onClick:()=>{const z=!g;q(z),be(!1),W(!1),R("all"),z&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(xe),pe.since?` · ${n.newsSince(pe.since)}`:""]})]}),!o.showFunnel&&jt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||v==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,B])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:B})]},z))}),!P&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":S==="open",onClick:()=>{C("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":S==="closed",onClick:()=>{C("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||v==="ops")&&(()=>{var ie;const z={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},B=u.filter(Z=>ea(Z,z,o.pipe)&&!We(Z)),U=B.filter(Z=>!Ve(Z)&&!Z.noCo&&(Z.kind==="op"||!Ie(Z))).length,ae=B.filter(Ve).length,ye=o.pipe?B.filter(Z=>Z.kind!=="op"&&ze(Z)===1).length:0,M=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ye?` ${ye}`:""}`]]:[],["eval",`${n.doEval}${U?` ${U}`:""}`],["explore",`${n.doExplore}${ae?` ${ae}`:""}`]],ee=((ie=M.find(([Z])=>Z===L))==null?void 0:ie[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":I,onClick:()=>O(Z=>!Z),children:[ee,t.jsx("i",{children:"▾"})]}),I&&t.jsx("div",{className:"dolist",children:M.map(([Z,je])=>t.jsx("button",{type:"button","aria-pressed":L===Z,onClick:()=>{if(O(!1),Z==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}R(Z),Z!=="all"&&(be(!1),q(!1),W(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:je},Z))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([z,B])=>t.jsx("option",{value:z,children:B},z))})]}),o.showChain&&ke.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ke.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ke.length):n.chainAll(ke.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!P&&gt,a.dens!=="maxi"&&!P&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),he("country",n.colCountry),he("name",n.colCompany),he("amount",n.colAmount,"h-amt",!0),he("stage",n.colStage,"h-stade"),he("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[he("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),he("memo",n.colMemo)]}),o.pipe&&he("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),P?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[gt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),he("country",n.colCountry),he("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[he("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),he("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:Xe})]}),t.jsxs("aside",{className:"readpane"+((it?We(it):!m&&qe)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[qe&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===qe.id,onClick:()=>r({type:"focus",id:qe.id}),children:n.doEdito}),y&&a.focusId===y.id?t.jsx("div",{className:"zoom",children:t.jsx(Vs,{})}):it&&o.pipe?t.jsx(Bd,{o:it}):t.jsx(Uo,{o:it,extra:it?null:m})]})]}):t.jsx("div",{className:ut,children:Xe}),(()=>{const z=Se||[["pt"+a.ptab,H]];let B=0,U=0;for(const[ye,M]of z){U+=M.length;let ee=a.shown[ye]||j();M.length-ee<=4&&(ee=M.length),B+=Math.min(M.length,ee)}const ae=U-B;return ae<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([ye,M])=>r({type:"more",group:ye,by:M.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(ae,ae)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(B,U)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),P&&v==="ops"&&a.dens!=="maxi"&&t.jsx(Fd,{on:!!Se,rev:(Se||[]).map(([z,B])=>z+B.length).join("|")})]})}function Gr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Wd(e,a){const r=Bi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Gd(e,a){const n=[a.head.split("|").map(Gr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Wd(o,a.plabels),ia(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Gr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Yd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Kd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Qd({o:e,qa:a}){const{t:r,lang:n,fund:o}=V(),i=(e.cribleStatus||"").trim().toUpperCase()||(ia(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=wt(e),l=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:Kd(e.date,n)})]}),c.some(([,h])=>h)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,h])=>h).map(([h,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:h}),t.jsx("p",{children:d})]},h))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Jd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:s}=V(),[l,c]=p.useState({}),h=25,d=p.useMemo(()=>n.slice(0,h),[n]);p.useEffect(()=>{d.length&&no(r,d.map(v=>v.name)).then(c)},[r,d]);const x=i.stats,u=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>h&&t.jsx("span",{className:"mnote dim",children:e.dsCap(h,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),d.map(v=>t.jsx(Qd,{o:v,qa:l[v.name]},v.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Xd=50;function In({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=V(),[i,s]=p.useState(null),[l,c]=p.useState(!1),[h,d]=p.useState(""),[x,u]=p.useState(0),[v,m]=p.useState(""),[b,k]=p.useState(!1),[f,y]=p.useState(0),j=p.useRef(null),w=p.useRef(null),N=()=>{y(0),w.current&&window.clearInterval(w.current),w.current=window.setInterval(()=>y(A=>A+1),1e3)},S=()=>{w.current&&(window.clearInterval(w.current),w.current=null)};p.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),w.current&&window.clearInterval(w.current)},[]);const C=async A=>{c(!0),d(""),N();const F=await a();if(c(!1),S(),F.ok){s(F);return}if(F.busy){d(o.alertPreviewBusy);return}if(!A){d(o.alertPreviewFail);return}u(Xd),S(),j.current=window.setInterval(()=>{u(D=>D>1?D-1:(j.current&&window.clearInterval(j.current),C(!1),0))},1e3)},T=async()=>{if(n||b||l)return;k(!0),m(""),N();const A=await r();k(!1),S(),m(A.ok?o.alertTestOk(A.sentTo||""):A.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||b||x>0,onClick:()=>{C(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b||l,onClick:()=>{T()},children:b?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),b&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),h&&t.jsx("p",{className:"mnote warn",children:h}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Ot="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ge({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=V();return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Zd(){const{st:e}=V();switch(e.modal){case"chain":return t.jsx(tc,{});case"space":return t.jsx(ac,{});case"alert":return t.jsx(nc,{});case"queue":return t.jsx(lc,{});case"export":return t.jsx(dc,{});case"plug":return t.jsx(uc,{});case"recharge":return t.jsx(fc,{});case"cover":return t.jsx(xc,{});case"dossier":return t.jsx(hc,{});case"crit":return t.jsx(gc,{});case"tuto":return t.jsx(bc,{});case"rdv":return t.jsx(ec,{});case"memoalert":return t.jsx(cc,{});default:return null}}function ec(){const{dispatch:e,fund:a,t:r}=V(),n=a||r.rdvCoFallback;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:uo,children:Tn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],s)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(s+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(cs,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function tc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:s,evalBusy:l,caps:c,memoQueued:h,doAnalyse:d}=V(),x=i==="client",u=e.chain.queue.map(k=>r.get(k)).filter(k=>!!k),v=e.chain.idx,m=u[v],b=v>=u.length;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${v+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:v/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[$t(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(ht(m.date))].filter(Boolean).map(k=>String(k).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ke(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Ut(m.amountEur,o)})]}),Me(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(yt,{o:m,lg:!0})," ",t.jsx(Ia,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&Ie(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&Ie(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Ct(m)==="retenu"?"var(--brand)":Ct(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ct(m)==="retenu"?"✓ "+n.kept:Ct(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&m&&c.pipe&&ze(m)===1&&!h.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&m&&!(x&&Ie(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var k;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(k=document.querySelector(".atl2 .demand"))==null||k.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function ac(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=V(),i=o==="client",s=p.useMemo(()=>i?r.filter(x=>Ie(x)):[],[r,i]),l=p.useMemo(()=>An(s.filter(x=>Ct(x)==="retenu"),{key:"signal",dir:-1}),[s]),c=p.useMemo(()=>s.filter(x=>Ct(x)==="ecarte"),[s]),h=e.spaceTab==="retenu"?l:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ge,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function nc(){const{mode:e}=V();return e==="client"||e==="apercu"?t.jsx(rc,{}):t.jsx(sc,{})}function rc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),[i,s]=p.useState("d"),l=o!=="client";return t.jsxs(Ge,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(oc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(ic,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(Ho,{})]})}function oc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,c]=p.useState(!1),[h,d]=p.useState(0);p.useEffect(()=>{let T=!0;return c(!1),Xn(a).then(A=>{T&&(A?s(A):c(!0))}),()=>{T=!1}},[a,h]);const x=p.useRef({}),[u,v]=p.useState({}),[m,b]=p.useState(!1),[k,f]=p.useState(!1),y=p.useRef(null);p.useEffect(()=>()=>{y.current&&window.clearTimeout(y.current)},[]);const j=T=>{const A=x.current;Object.keys(A).length&&(b(!0),Xn(a,A).then(F=>{if(!F){b(!1),o(e.actErr);return}if(F.throttled&&T<3){y.current=window.setTimeout(()=>j(T+1),5400);return}if(x.current={},v({}),s(F),b(!1),F.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},w=T=>{r||(x.current={...x.current,...T},v(A=>({...A,...T})),y.current&&window.clearTimeout(y.current),y.current=window.setTimeout(()=>j(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(T=>T+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...u},S=T=>!N.sections||N.sections.includes(T),C=T=>{const A=N.sections||e.alertSec.map(([F])=>F);w({sections:S(T)?A.filter(F=>F!==T):[...A,T]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>w({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>w({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&k&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([T,A])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:S(T),disabled:r,onChange:()=>C(T)}),t.jsxs("span",{children:[A,T==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},T))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(In,{label:e.alertPreview,readOnly:r,onPreview:()=>Qi(a),onTest:()=>Ki(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function ic({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,c]=p.useState(!1),[h,d]=p.useState(0);p.useEffect(()=>{let m=!0;return c(!1),Zn(a).then(b=>{m&&(b?s(b):c(!0))}),()=>{m=!1}},[a,h]);const x=m=>{r||Zn(a,m).then(b=>{if(!b){o(e.actErr);return}s(b),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,v=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,b)=>t.jsx("option",{value:b,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,v+1)}),disabled:r,children:"+"})]})]}),t.jsx(In,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Xi(a),onTest:()=>Ji(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ho(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=V(),[s,l]=p.useState(i||""),[c,h]=p.useState(!1),[d,x]=p.useState(!1);p.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,v=p.useMemo(()=>n.filter(f=>Me(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(s)||d)){x(!0);try{await fetch(`${Da}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{x(!1)}}},k=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Ke(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>$t(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:k.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function sc(){const{t:e}=V();return t.jsx(Ge,{title:e.alertTitle,icon:"🔔",children:t.jsx(Ho,{})})}function lc(){var D,P;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:s,caps:l,dispatch:c,liveMemos:h}=V(),[d,x]=p.useState(()=>$a(r)),[u,v]=p.useState(()=>!$a(r)),[m,b]=p.useState([]),[k,f]=p.useState(0),y=n==="client",j=p.useMemo(()=>{const L=new Map;return o.forEach(R=>{const g=(R.name||"").trim().toLowerCase();g&&!L.has(g)&&L.set(g,R)}),L},[o]);p.useEffect(()=>{let L=!0;return(!$a(r)||k>0)&&v(!0),(async()=>{const[R,g]=await Promise.all([Sn(r,k>0),Zr(a)]);L&&(R&&x(R),v(!1),b(g))})(),()=>{L=!1}},[a,r,k]);const w=u&&!d,N=(d==null?void 0:d.per_day)??0,S=((D=d==null?void 0:d.analyzed_today)==null?void 0:D.length)??0,C=d==null?void 0:d.offre,T=(d==null?void 0:d.pool_meta)||[],A=p.useMemo(()=>{const L=new Map;for(const R of(d==null?void 0:d.scheduled)||[])for(const g of R.names||[])L.has(g)||L.set(g,{label:R.day_label,date:R.date});return L},[d==null?void 0:d.scheduled]),F=(d==null?void 0:d.in_progress)||[];return t.jsxs(Ge,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:w?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(S,S+(((P=d==null?void 0:d.pool_order)==null?void 0:P.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!w&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(F.length>0||h.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(Na,{item:L,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),F.filter(L=>!h.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(L.memo_type)}),y&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Jn(a,L.company,"retry").then(()=>f(R=>R+1))},children:e.queueRetry}),y&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Jn(a,L.company,"delete").then(()=>f(R=>R+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",w?e.qUpNextWait:e.qUpNext(T.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[w&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!w&&T.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),T.map((L,R)=>{const g=A.get(L.name),q=j.get((L.name||"").trim().toLowerCase()),$=h.liveOf(L.name),X=!!(q&&s.has(q.id))||!!($&&($.status==="boot"||$.status==="running")),I=!!(q&&ze(q)===1&&!q.memoUrl)&&!$;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),g?t.jsx("span",{className:"qwhen"+(g.label==="demain"?" soon":""),children:g.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),$&&($.status==="boot"||$.status==="running")&&t.jsx(Na,{item:$,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),I&&(l.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:X,onClick:()=>{i(q),f(O=>O+1)},children:X?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,R])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",R]},L))})]})}function dc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:s}=V(),l=`${Ot}/cibles/list.csv?token=${a}`,c=`${Ot}/cibles/list.json?token=${a}`,h=`${Ot}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${l}")`,x=k=>{var f;(f=navigator.clipboard)==null||f.writeText(k).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:h,href:h}],v=!o.lockActions&&n.length>0,m=()=>{Yd(Gd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:k=>(e.stg.find(([f])=>f===k)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ge,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:k,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:k[0]}),t.jsxs("div",{children:[t.jsx("b",{children:k[1]}),t.jsx("p",{children:k[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},k[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function cc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=V(),i=o!=="client",[s,l]=p.useState(null),[c,h]=p.useState(!1),[d,x]=p.useState(0),[u,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return h(!1),Qn(a).then(y=>{f&&(y?l(y):h(!0))}),()=>{f=!1}},[a,d]);const m=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=f=>{if(i||!s)return;const y={enabled:f.enabled??!!s.enabled,email:f.email??(s.email||""),sections:f.sections??m()};v(!0),Qn(a,y).then(j=>{if(v(!1),!j){n(e.memoAlertErr);return}l(j),r(e.memoAlertSaved)})};if(c)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!s)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const k=m();return t.jsxs(Ge,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:i||u,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(pc,{value:s.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>b({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!k[f],disabled:i||u,onChange:()=>b({sections:{...k,[f]:!k[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(In,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>$i(a,k),onTest:()=>_i(a,k)})]})}function pc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,s]=p.useState(e);p.useEffect(()=>{s(e)},[e]);const l=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:h=>s(h.target.value),onKeyDown:h=>{h.key==="Enter"&&l&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!c,onClick:()=>o(i.trim()),children:n})]})]})}function uc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=V(),[i,s]=p.useState(null),[l,c]=p.useState(!1),[h,d]=p.useState(null),[x,u]=p.useState(""),[v,m]=p.useState(0);p.useEffect(()=>{let j=!0;return c(!1),sn(a).then(w=>{j&&(w?s({configured:w.configured,url_hint:w.url_hint}):c(!0))}),Vi(a).then(w=>{j&&d(w)}),()=>{j=!1}},[a,v]);const b=(j,w)=>{o&&sn(a,j).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}j.test&&N.sent===!1?n(e.plugTestThrottled):r(w),m(S=>S+1)})},k='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),y=`curl -X POST ${Ot}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ge,{title:e.plugTitle,icon:"🔌",wide:!0,children:[h&&t.jsx("p",{className:"mnote"+(h.enabled?" warn":""),children:h.enabled?e.plugAutoOn(h.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(j=>j+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!o,onChange:j=>u(j.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(mc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:k}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(k).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function mc(){const{t:e,token:a,lang:r}=V(),[n,o]=p.useState("valides"),[i,s]=p.useState(!1),[l,c]=p.useState(null),[h,d]=p.useState(null),[x,u]=p.useState(!1),[v,m]=p.useState(!1),[b,k]=p.useState(null),[f,y]=p.useState(null),[j,w]=p.useState(null),N=`atl2:bulk:${a}:${n}`;p.useEffect(()=>{sn(a).then(P=>{y(P&&P.configured?P.url_hint||"webhook":null)})},[a]),p.useEffect(()=>{c(null),d(null),u(!1),k(null);try{const P=JSON.parse(localStorage.getItem(N)||"null");w(P&&Date.now()-Date.parse(P.t)<24*3600*1e3?P:null)}catch{w(null)}},[N]);const S=async()=>{s(!0),u(!1),k(null);const P=await Gi(a,n);c(P),d(P.ok?n:null),s(!1)},C=p.useRef(!1),T=async()=>{if(C.current)return;C.current=!0,m(!0);const P=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await Yi(a,n,"webhook",void 0,P)}finally{C.current=!1}if(m(!1),u(!1),k(L),L.ok&&(L.pushed||0)>0){const R={t:new Date().toISOString(),n:L.pushed||0};w(R);try{localStorage.setItem(N,JSON.stringify(R))}catch{}}},A=l!=null&&l.ok&&l.ready||0,F=!!(l!=null&&l.ok)&&h===n&&A>0&&!!f&&!j,D=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:P=>o(P.target.value),children:e.plugBulkTabs.map(([P,L])=>t.jsx("option",{value:P,children:L},P))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{S()},children:i?"…":e.plugBulkPreview})]}),l&&(l.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(l.ready||0,l.linkedinReady||0,(l.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(l!=null&&l.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(D,j.n)}),!j&&!!(l!=null&&l.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!l&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),F&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),F&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(A,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{T()},children:v?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function fc(){const{t:e,data:a,lang:r}=V(),n=a.credits,o=a.email,i=async s=>{if(!o)return;const l=window.location.href.split("?")[0];try{const h=await(await fetch(`${Da}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs(Ge,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function hc(){const{t:e}=V();return t.jsx(Ge,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Jd,{})})}function xc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:s,flash:l}=V(),[c,h]=p.useState(null),[d,x]=p.useState(!1);p.useEffect(()=>{let A=!0;if(i)return Sn(i).then(F=>{A&&F&&typeof F.per_day=="number"&&h(F.per_day)}),()=>{A=!1}},[i]);const[u,v]=p.useState(null);p.useEffect(()=>{if(!o)return;let A=!0;return Hi(o).then(F=>{A&&v(F)}),()=>{A=!1}},[o]);const m=r.stats,b=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(A=>A.kind==="target"&&Ie(A)).length,k=r.marketEstimate||0,f=k>0?Math.min(100,Math.round(b/k*100)):null,y=(m==null?void 0:m.window_days)||30,j=b>0?b/y:0,w=k>0?Math.max(0,k-b):0,S=k>0&&j>0&&b>=100?Math.round(w/j):null,C=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),T=A=>{d||!s||(x(!0),Wi(o,A).then(F=>{if(x(!1),F===null){l(e.actErr);return}h(F),l(e.alertSaved)}))};return t.jsxs(Ge,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(b))}),k>0&&t.jsx("span",{children:e.covOf(C(k))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),S!==null&&t.jsx("p",{className:"mnote",children:e.covEta(S)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(j))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((A,F)=>t.jsxs("tr",{className:A.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[A.code,A.geo?` · ${A.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof A.n=="number"?C(A.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:A.source}),A.elargi&&t.jsx("em",{children:e.covWide(String(A.demande||""))}),A.erreur&&t.jsx("em",{children:e.covMissing})]})]},F)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(u.total||k)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),s&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:c===A?"on":"",disabled:d,onClick:()=>T(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function gc(){var f,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:s,lang:l}=V(),c=n==="client",h=p.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[d,x]=p.useState(""),[u,v]=p.useState(""),[m,b]=p.useState(!1),k=async()=>{const w=d.trim();if(!(!w||m||!c)){b(!0),v("");try{const S=await(await fetch(`${Ot}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&v(String(S.reply)),S.job_id){v(e.critChatRunning);const C=async()=>{const T=await fetch(`${Ot}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(A=>A.json()).catch(()=>null);if(T&&T.done){v(String(T.reply||T.clarification||T.summary||"✓")),b(!1),T.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(Ge,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var N,S;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((S=w.out)!=null&&S.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},w.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||m,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&k()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!d.trim(),onClick:()=>void k(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Ui,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(_o[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function bc(){const{t:e,dispatch:a,startTour:r}=V(),n=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(Ge,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const Vo="atl2:mapfold",vc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Vo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},yc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Wo=p.createContext(null),V=()=>{const e=p.useContext(Wo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function yt({o:e,lg:a}){const{lang:r}=V(),n=Me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:er(n,r),children:[n.emoji," ",er(n,r)]}):null}function Ia({o:e,src:a}){const{lang:r,t:n}=V(),o=Me(e);if(!o)return null;const i=rs(o),s=os(o);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(ro(o,r))+" · "+n.win7(oo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function wc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(s=>(s.url||"")===n);if(i)return i}const o=_e(a);if(o)return e.find(i=>_e(i.name)===o)||e.find(i=>{const s=_e(i.name);return s.length>=3&&(o.includes(s)||s.includes(o))})}function kc(){const{scoped:e,t:a,st:r,dispatch:n}=V(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,s=e.filter(x=>!We(x)),l=s.length,c=s.filter(x=>!x.noCo).length,h=s.filter(x=>!!x.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function jc(){const{t:e,lang:a,data:r,dispatch:n}=V(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const s=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:s>0?e.covOf(i(s)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function Go({o:e}){const{lang:a}=V(),r=ns(e.cc),n=e.cc?$t(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Yr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Nc=!1;function Ec(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Yo=e=>`atl2:tour:${e||"anon"}`;function Sc(e){try{return localStorage.getItem(Yo(e))==="1"}catch{return!0}}function Kr(e){try{localStorage.setItem(Yo(e),"1")}catch{}}function Cc(e,a,r,n,o,i){const s=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Lc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var Pn;const{lang:s}=Zi(),l=js[s],c=Ms(e,s,a),[h,d]=p.useReducer(Is,void 0,()=>Os((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?yc():vc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=p.useRef(!0);p.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Vo,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const E=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return E(),window.addEventListener("resize",E),()=>window.removeEventListener("resize",E)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var E;(E=u.current)==null||E.call(u,h.filters)},[h.filters]);const[v,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const E=localStorage.getItem("atl2:chrome-mode");if(E==="eval"||E==="filt"||E==="both")return E;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[b,k]=p.useState(null),[f,y]=p.useState(null),[j,w]=p.useState(null),[N,S]=p.useState({kept:0,dropped:0}),[C,T]=p.useState(!1),[A,F]=p.useState(""),[D,P]=p.useState(!1),[L,R]=p.useState(null),[g,q]=p.useState(!1),[$,X]=p.useState(!1),[,I]=p.useState(0),O=()=>I(E=>E+1),Q=p.useRef([]),Y=p.useRef(new Set),K=p.useRef(new Set),[J,ge]=p.useState([]),[W,ce]=p.useState([]),[le,be]=p.useState(0),me=p.useRef(new Map),de=p.useRef(null),{mode:pe}=c,xe=p.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),H=xe.pipe,re=c.session.token||"",fe=pe==="client"&&!e;p.useEffect(()=>{if(!re||!H)return;let E=!0;const G=async()=>{const se=await is(re);!E||!se||(ce(se.runs),be(Date.now()/1e3-se.now),ge(He=>He.filter(Ne=>!se.runs.some(Be=>_e(Be.company)===_e(Ne.name)))))};G();const _=J.length>0||W.some(se=>se.status==="running"),te=window.setInterval(()=>{G()},_?8e3:25e3);return()=>{E=!1,window.clearInterval(te)}},[re,H,J.length,W.some(E=>E.status==="running")]);const ke=p.useMemo(()=>{const E=[],G=new Set;for(const _ of J){const te=_e(_.name);!te||G.has(te)||(G.add(te),E.push({name:_.name,id:_.id,status:"boot",started:_.started,estMin:_.estMin,memoType:"instant"}))}for(const _ of W){const te=_e(_.company);if(!te||G.has(te))continue;G.add(te);const se=_.status==="error"?"error":_.status==="done"?"done":"running";E.push({name:_.company,status:se,started:_.started||0,estMin:_.est_min||(_.memo_type==="detailed"?40:15),url:_.url,error:_.error,memoType:_.memo_type,note:_.note})}return E},[J,W]),ne=E=>ke.find(G=>_e(G.name)===_e(E))||null,ve=(E,G)=>{ge(_=>_.some(te=>_e(te.name)===_e(E.name))?_:[..._,{name:E.name,id:E.id,started:Date.now()/1e3,estMin:G==="detailed"?40:15}]),Y.current.add(E.id),O()};p.useEffect(()=>{if(document.querySelector(`link[href="${Yr}"]`))return;const E=document.createElement("link");E.rel="stylesheet",E.href=Yr,document.head.appendChild(E)},[]);const oe=(E,G=!1)=>{F(E),P(G),de.current&&clearTimeout(de.current),de.current=setTimeout(()=>F(""),G?4200:2400)},Ee=E=>oe(E,!0),Qe=p.useMemo(()=>{const E=new Map;return c.dossiers.forEach(G=>{G.id&&E.set(G.id,G)}),E},[c.dossiers]),he=p.useMemo(()=>c.dossiers.filter(E=>ea(E,h,H)),[c.dossiers,h,H]),Se=p.useRef(!1);p.useEffect(()=>{if(Se.current||e||c.loading||!c.dossiers.length)return;if(!xe.showFunnel||Sc(c.session.token||"")){Se.current=!0;return}Se.current=!0;const E=window.setTimeout(()=>{Kr(c.session.token||""),q(!0)},700);return()=>window.clearTimeout(E)},[e,c.loading,c.dossiers.length,xe.showFunnel,c.session.token]);const Lt=p.useMemo(()=>c.dossiers.filter(E=>Ps(E,h,H,c.favIds)),[c.dossiers,h,H,c.favIds]),Pe=p.useMemo(()=>es(he.filter(E=>!Ve(E)),c.favIds),[he,c.favIds]),Je=p.useRef(!1);p.useEffect(()=>{if(Je.current)return;if(!H||a==="ops"){Je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Je.current=!0;return}if(c.loading)return;Je.current=!0;const E=ts(Pe);E!==h.ptab&&d({type:"ptab",tab:E})},[H,a,n==null?void 0:n.ptab,c.loading,Pe,h.ptab]);const qe=p.useMemo(()=>{const E=fo(c.dossiers);return E?ht(E)===0?l.tourToday:ho(E,s):l.tourNoRun},[c.dossiers,l,s]),it=p.useMemo(()=>c.dossiers.some(E=>!!E.memoUrl||!!E.summary||Dt(E)),[c.dossiers]),[kt,Oe]=p.useState(!1);p.useEffect(()=>{if(c.loading){Oe(!1);return}if(c.dossiers.length>0||c.error){Oe(!0);return}const E=window.setTimeout(()=>Oe(!0),6e3);return()=>window.clearTimeout(E)},[c.loading,c.dossiers.length,c.error]);const xt=(c.marketEstimate||0)>0||typeof((Pn=c.stats)==null?void 0:Pn.screened)=="number"&&c.stats.screened>0,ut=p.useMemo(()=>[1,0,2,4,5,3].find(E=>(Pe[E]||0)>0)??0,[Pe]),Xe=Cn.find(E=>E.key===h.continent),jt=h.continent==="monde"?l.contWorld:(s==="fr"?Xe==null?void 0:Xe.fr:Xe==null?void 0:Xe.en)||"";p.useEffect(()=>{const E=G=>{var te;const _=(((te=G.detail)==null?void 0:te.name)||"").trim();_&&gt(null,_)};return window.addEventListener("ppmap:evaluate",E),()=>window.removeEventListener("ppmap:evaluate",E)}),p.useEffect(()=>{const E=G=>{const _=G.detail||{},te=String(_.id||"").trim(),se=String(_.name||"").trim(),He=String(_.url||"").trim(),Ne=te&&Qe.get(te)||wc(c.dossiers,se,He);if(Ne){if(y(null),ea(Ne,h,H)||(h.continent!=="monde"&&Ne.continent!==h.continent&&d({type:"continent",key:Ne.continent||"monde"}),d({type:"reset"})),H&&Ne.kind!=="op"){const st=ze(Ne);typeof st=="number"&&st!==h.ptab&&d({type:"ptab",tab:st})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:Ne.id}),(Ne.noCo||["media","nominations","recrutements"].includes(Ne.engine||""))&&(Ne.url||Ne.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ne.url||"",text:[Ne.headline,Ne.tagline].filter(Boolean).join(`
`)}})):Ne.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ne.name,url:Ne.url||"",website:Ne.website||"",domain:Ne.domain||""}}));return}!se&&!He||(d({type:"focus",id:te||null}),y({name:se,headline:String(_.text||"").trim()||se,url:He,card:_.card}),He&&(Ea(se)||!se)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:He,text:String(_.text||"").trim()}})):se&&!Ea(se)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:se}})))};return window.addEventListener("ppmap:focus",E),()=>window.removeEventListener("ppmap:focus",E)}),p.useEffect(()=>{const E=te=>{const se={},He=String((te==null?void 0:te.sector)||"").trim();He&&(se.sector=[He]);const Ne=String((te==null?void 0:te.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ne)&&(se.day=Ne);const Be=String((te==null?void 0:te.search)||"").trim();Be&&(se.search=Be);const st=String((te==null?void 0:te.dealKind)||"").trim();(st==="ma"||st==="levee"||st==="other")&&(se.dealKind=[st]),Object.keys(se).length&&d({type:"filters",patch:se})},G=te=>E(te.detail),_=te=>{te.data&&te.data.type==="pp-filter"&&E(te.data)};return window.addEventListener("ppmap:filter",G),window.addEventListener("message",_),()=>{window.removeEventListener("ppmap:filter",G),window.removeEventListener("message",_)}},[]),p.useEffect(()=>{const E=G=>{var se;const _=(((se=G.detail)==null?void 0:se.name)||"").trim().toLowerCase();if(!_)return;const te=c.dossiers.find(He=>(He.name||"").trim().toLowerCase()===_);te&&d(a==="ops"?{type:"focus",id:te.id}:{type:"popup",id:te.id})};return window.addEventListener("ppmap:similar",E),()=>window.removeEventListener("ppmap:similar",E)});const gt=(E,G,_)=>{const te=(_||(E==null?void 0:E.name)||G||"").trim();if(!fe){w({kicker:te});return}!te||C||(T(!0),(async()=>{try{let se=(G||te).trim();const He=((E==null?void 0:E.website)||(E==null?void 0:E.domain)||"").trim();if(!(/^https?:\/\//i.test(se)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(se)&&!/\s/.test(se)))if(He)se=He;else try{const Re=await zn(te);if(Re!=null&&Re.website)se=Re.website;else if(((Re==null?void 0:Re.candidates)||[]).length===1)se=Re.candidates[0].url;else if(((Re==null?void 0:Re.candidates)||[]).length>1){Q.current=[{name:te,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(Re.candidates||[]).slice(0,5)},...Q.current].slice(0,8),O();return}}catch{}const Be=await to(re,se,"atelier2"),st={name:Be.company||te,verdict:Be.verdict,reason:Be.reason||"",remaining:Be.remaining??null};Q.current=[st,...Q.current].slice(0,8),Be.verdict==="kept"&&S(Re=>({...Re,kept:Re.kept+1})),Be.verdict==="ruled_out"&&S(Re=>({...Re,dropped:Re.dropped+1}));const Ht=E||c.dossiers.find(Re=>(Re.name||"").toLowerCase()===te.toLowerCase());Ht&&(Be.verdict==="kept"?Ht.verdict=Ht.verdict||"MATCH":Be.verdict==="ruled_out"&&(Ht.verdict="NO MATCH"),Be.reason&&(Ht.reasoning=Be.reason)),O()}finally{T(!1)}})())},bt=E=>{if(!fe){w({kicker:E.name});return}ve(E,"instant"),Vt(re,"fast_request",E.name||"",""),oe(l.memoInstantSent(E.name))},Ft=E=>me.current.get(E.id)??c.thumbs.get((E.name||"").trim().toLowerCase()),Nt=(E,G)=>d({type:"undoPush",entry:{id:E.id,name:E.name,prevCeoStatus:G}}),Fe=async(E,G,_)=>{const te=E.ceoStatus||"";E.ceoStatus=G,O();const se=await Ua(re,{status:G,airtable_id:E.airtableId,check_id:E.checkId,company:E.name,...(_==null?void 0:_.note)!==void 0?{note:_.note}:{},..._!=null&&_.via?{via:_.via}:{}});return se.ok?se.skipped?(E.ceoStatus=te,O(),Ee(l.actNotPersisted),!1):((_==null?void 0:_.undo)!==!1&&Nt(E,te),_!=null&&_.msg&&oe(_.msg),(G==="Validé"||G==="Écarté")&&!E.ceoNote&&(_==null?void 0:_.note)===void 0&&R({o:E,yes:G==="Validé"}),!0):(E.ceoStatus=te,O(),Ee(l.actErr),!1)},nt=async(E,G)=>{const _=await Ua(re,{status:E.ceoStatus||"Retenu",airtable_id:E.airtableId,check_id:E.checkId,company:E.name,note:G,via:"note"});return!_.ok||_.skipped?(Ee(_.skipped?l.actNotPersisted:l.actErr),!1):(E.ceoNote=G,O(),!0)},z=p.useRef(new Map),B=E=>z.current.has(E.id)?z.current.get(E.id):c.stages.get((E.name||"").trim().toLowerCase()),U=(E,G)=>{z.current.set(E.id,G),O()},ae=(E,G)=>{fe&&Fe(E,G?"Validé":"Écarté",{msg:G?l.decidedYes(E.name):l.decidedNo(E.name)})},ye=E=>{fe&&Fe(E,"À trancher",{msg:l.promoted(E.name)})},M=E=>{fe&&(async()=>{const G=E.ceoStatus||"";E.ceoStatus="Retenu",O();const _=await Ua(re,{status:"Retenu",check_id:E.checkId,company:E.name});if(!_.ok||_.skipped){E.ceoStatus=G,O(),Ee(_.skipped?l.actNotPersisted:l.actErr);return}Nt(E,G),oe(l.repeched(E.name))})()},ee=()=>{const E=h.undo[h.undo.length-1];if(!E){oe(l.undoNone);return}const G=Qe.get(E.id);if(!G){d({type:"undoPop"}),oe(l.undoNone);return}let _=E.prevCeoStatus;if(!_)if((G.verdict||"").toUpperCase().includes("CALL"))_="À trancher";else{oe(l.undoLockedTitle);return}(async()=>await Fe(G,_,{undo:!1})&&(d({type:"undoPop"}),G.ceoStatus=E.prevCeoStatus,O(),oe(l.undoDone(G.name))))()},ie=E=>{fe&&(K.current.add(E.id),O(),(async()=>{const G=await ss(re,E.name,"email");if(!G||G.ok===!1){K.current.delete(E.id),O(),Ee(l.actErr);return}Vt(re,"approach",E.name||"",""),oe(l.actApproachSent)})())},Z=(E,G)=>{fe&&(async()=>{if(!(await Vt(re,G?"yes":"no",E.name||"","")).ok){Ee(l.actErr);return}me.current.set(E.id,G?"yes":"no"),O(),oe(G?l.thumbUpDone:l.thumbDnDone)})()},je=E=>{!fe||!Dt(E)||(ve(E,"detailed"),Vt(re,"detailed_request",E.name||"",""),oe(l.memoDeepSent(E.name)))},De=E=>{const G=new Set(c.favIds),_=G.has(E.id);_?G.delete(E.id):G.add(E.id),c.setFavIds(G),fe&&ls(re,{id:E.id,co:E.name},_)},$e=()=>{!fe||$||window.confirm(l.identSyncConfirm)&&(X(!0),(async()=>{const E=await ds(re);X(!1),E?oe(l.identSyncDone):Ee(l.actErr)})())},Ae=/proplace/i.test(c.fund||""),Ue=E=>{!fe||!Ae||(Vt(re,"onboard_request",E.name||"",""),oe(l.onboardSent(E.name)))},Pa={st:h,dispatch:d,t:l,lang:s,mode:pe,caps:xe,pipe:H,token:re,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:M,thumbOf:Ft,canWrite:fe,commitStatus:Fe,saveNote:nt,stageOf:B,setStage:U,flashErr:Ee,startTour:()=>q(!0),dossiers:c.dossiers,scopedAll:he,scoped:Lt,counts:Pe,byId:Qe,contName:jt,favIds:c.favIds,toggleFav:De,askEvaluate:gt,doAnalyse:bt,doDecide:ae,doPromote:ye,doApproach:ie,doThumb:Z,doDeep:je,doUndo:ee,doSync:$e,doOnboard:Ue,outbound:Ae,memoQueued:Y.current,liveMemos:{items:ke,serverOff:le,liveOf:ne},approachDone:K.current,sessTally:N,evalCards:Q.current,evalBusy:C,markRow:k,markedId:b,flash:oe,focusExtra:f};p.useEffect(()=>{const E=G=>{G.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)},[]);const la=E=>re?t.jsx($s,{token:re,children:E}):t.jsx(t.Fragment,{children:E});return t.jsx(Wo.Provider,{value:Pa,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(re?" cibles":"")+" chrome-"+v,children:[t.jsx("style",{children:Cs}),la(t.jsxs("div",{className:"app"+(H?" pipe":"")+(re?" has-thesis":""),children:[xe.showTicker&&t.jsx(rt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(re?" live-stack--cibles":""),children:[t.jsx(Ks,{}),!!re&&t.jsx(Us,{})]})}),xe.showIdent&&t.jsx(rt,{name:"identite",children:t.jsx(sl,{})}),!1,Nc,xe.showFunnel&&t.jsx(rt,{name:"entonnoir",children:t.jsx(zc,{})}),!h.mapFolded&&t.jsx(rt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Mo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(kc,{}),a!=="ops"&&xe.showFunnel&&t.jsx(jc,{}),t.jsx(od,{}),t.jsx(Ro,{})]})]})}),xe.showDemand&&H&&t.jsx(rt,{name:"direct",children:t.jsx(fs,{items:ke,serverOff:le,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([E,G])=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===E,onClick:()=>{m(E);try{localStorage.setItem("atl2:chrome-mode",E)}catch{}},children:G},E))}),xe.showDemand&&t.jsx(rt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(md,{})})}),xe.showDemand&&h.memoConsole&&t.jsx(rt,{name:"console",children:t.jsx(hd,{})}),xe.pipe&&!!re&&t.jsx(rt,{name:"moteurs",children:t.jsx(ys,{})}),t.jsx(rt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(Vd,{})}),c.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:l.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(rt,{name:"fiche",children:t.jsx(zd,{})}),t.jsx(rt,{name:"modales",children:t.jsx(Zd,{})}),t.jsx(Xs,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(nl,{placeholder:L.yes?l.whyYesPh:l.whyNoPh,onDone:E=>{const G=L.o;R(null),E&&nt(G,E).then(_=>{_&&oe(l.csNoteSaved)})}})]}),g&&kt&&t.jsx(ol,{steps:Cc(l,qe,it,ut,xt,Pe[3]||0),onClose:()=>{q(!1),Kr(re)}}),t.jsx(Ec,{}),xe.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:uo,children:Tn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),A&&t.jsx("div",{className:"flash on"+(D?" err":""),children:A}),j&&t.jsx(as,{variant:"acquirer",initialCompany:Qr().co,initialWebsite:Qr().site,onClose:()=>w(null)})]})})}function zc(){const{t:e}=V(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Qr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ac(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Go as FlagCell,yt as SigBadge,Ia as SigWin,Lc as default,Ac as fmtShort,V as useV2};
;/* deploy-1788072061 */
