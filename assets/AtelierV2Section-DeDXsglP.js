...
.atl2 .bulk .side .hint{white-space:nowrap}`,Yi=`
...
body.pp-desk .atl2.cibles .listhead.mapoff{
  ...
  box-sizing:border-box;padding:4px 14px 0;overflow:visible;background:var(--panel);
  left:0}
...
body.pp-desk .atl2.cibles .listhead .lh-funnel{width:100%;padding:4px 0 2px;
  margin:0;border-bottom:1px solid var(--line);order:3}
body.pp-desk .atl2.cibles .listhead .lh-funnel .funnel{
  gap:8px;flex-wrap:nowrap;align-items:center;padding:2px 0;background:transparent;border:0}
...
body.pp-desk .atl2.cibles .listhead .lh-stats{width:100%;padding:4px 0 8px;
  margin:0 0 4px;border-bottom:1px solid var(--line);order:2}
...
body.pp-desk .atl2.cibles .listhead .lh-dock{order:1}
body.pp-desk .atl2.cibles .listhead .lh-top{order:4;padding:4px 0 6px}
...
`,Gi=Wi+Yi;function Ka(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ki(){const e=Ka("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Qi(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ki();return r==="0"?"client":r==="1"||Ka("embed")==="1"&&Ka("chrome")==="1"?"apercu":"client"}const Ji={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Xi=e=>Ji[e];function ya(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const vt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Sr(a)||ya(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Do(e.cc)})};function Da(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Zi=60*60*1e3;function es(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Zi?null:a}catch{return null}}function oa(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const ts=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function as(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:Eo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Qi(e,i),[e,i,n]),l=m.useMemo(()=>Xi(o),[o]),d=o!=="visiteur",c=ts(r),[h,s]=m.useState([]),[f,p]=m.useState(""),[v,u]=m.useState(null),[b,y]=m.useState(null),[x,j]=m.useState(null),[E,w]=m.useState(()=>new Map),[N,T]=m.useState(()=>new Map),[A,q]=m.useState(""),[L,C]=m.useState(new Set),[O,I]=m.useState(null),[F,P]=m.useState(!0),[g,z]=m.useState(!1),[U,G]=m.useState(0),[V,J]=m.useState(0),X=m.useRef(0),K=m.useMemo(()=>{var ae;if(o!=="client")return"";try{return((ae=Co())==null?void 0:ae.email)||""}catch{return""}},[o]);m.useEffect(()=>{const ae=++X.current;let pe=!0;const H=()=>pe&&ae===X.current,ie=(d&&i.token?i.token:"pub:"+a)+(c?":"+c:""),ee=es(ie);return ee?(s(ee.objs.map(vt)),ee.fund&&p(ee.fund),u(ee.marketEstimate??null),y(ee.criteria??null),j(ee.stats??null),q(ee.generatedAt||""),P(!1)):P(!0),(async()=>{try{if(r==="ops"){const qe=await Ra(),ke=((qe==null?void 0:qe.recent_ops)||[]).map(se=>{const me=xa(se.company_name||se.title?se:{...se,title:(se.headline_fr||se.headline||"").slice(0,120)},a),ce=String(se.rubrique||"").toLowerCase();return me&&(ce==="nominations"||ce==="recrutements")&&(me.engine=ce),me&&!String(se.company_name||"").trim()&&(me.noCo=!0),me}).filter(se=>!!se).map(se=>(Sr((se.name||"").trim())||(se.noCo=!0),se));try{const se=zo(),me=await Ao(),ce=((me==null?void 0:me.date)||"").slice(0,10),Y=se?se.doc:me,Z=To(Y),xe=((se==null?void 0:se.day)||(Y==null?void 0:Y.date)||ce||"").slice(0,10);if(xe&&Z.length){const de=new Set;for(const fe of ke){if((fe.date||"").slice(0,10)!==xe)continue;const he=zn(Z,de,fe.name,"");he>=0&&(de.add(he),fe.decryptHtml=Z[he].html)}for(const fe of ke){if(fe.decryptHtml||(fe.date||"").slice(0,10)!==xe)continue;const he=zn(Z,de,"",fe.headline||fe.tagline||fe.name);he>=0&&(de.add(he),fe.decryptHtml=Z[he].html)}}if(xe){const de=((Y==null?void 0:Y.title_fr)||"").trim(),fe=((Y==null?void 0:Y.lead_fr)||"").trim(),he=Lo(Y),ge=((Y==null?void 0:Y.url)||"").trim();de&&(he||ge)&&ke.unshift({id:`edito:${xe}`,kind:"op",name:de,cc:null,date:xe,engine:"edito",dealKind:"other",headline:de,tagline:fe||de,decryptHtml:he||void 0,url:ge,noCo:!0})}}catch{}if(!H())return;s(ke.map(vt)),oa(ie,{objs:ke})}else if(typeof r=="object"){const ke=(await An()||[]).filter(me=>(me.slug||"")===r.research).map(me=>Tn(me,a)).filter(me=>!!me),se=Da(await Ln(ke,a));if(!H())return;s(se.map(vt)),oa(ie,{objs:se})}else if(d&&i.token){const qe=qo(i.token),ke=Ra(),se=Fo(i.token),me=Mo(i.token),ce=Ro(i.token),Y=await qe;let Z=Y?Y.targets:[];H()&&Y&&(p(Y.fund||""),u(Y.marketEstimate??null),y(Y.criteria??null),j(Y.stats??null),q(Y.generatedAt||""),s(Z.map(vt)),P(!1),z(!1));const[xe,de,fe,he]=await Promise.all([ke,se,me,ce]),ge=((xe==null?void 0:xe.recent_ops)||[]).map(ve=>xa(ve,a)).filter(ve=>!!ve);if(Z=[...Z,...ge],!H())return;s(Z.map(vt));const Le=new Set;for(const ve of de){const Fe=(ve.id||ve.co||"").toString().trim().toLowerCase();Fe&&Le.add(Fe.startsWith("t:")?Fe:"t:"+Fe)}C(Le),w(fe),T(he),Y&&oa(ie,{fund:Y.fund,marketEstimate:Y.marketEstimate,criteria:Y.criteria,stats:Y.stats,generatedAt:Y.generatedAt,objs:Z})}else{const qe=Oo(),ke=An(),se=Ra(),me=await qe;H()&&me.length&&(s(Da(me).map(vt)),P(!1),z(!1));const[ce,Y]=await Promise.all([ke,se]),Z=(ce||[]).map(he=>Tn(he,a)).filter(he=>!!he),xe=await Ln(Z,a),de=((Y==null?void 0:Y.recent_ops)||[]).map(he=>xa(he,a)).filter(he=>!!he),fe=Da([...me,...xe,...de]);if(!H())return;s(fe.map(vt)),oa(ie,{objs:fe})}H()&&z(!1)}catch{H()&&!ee&&z(!0)}finally{H()&&P(!1)}})(),()=>{pe=!1}},[d,i.token,a,U,c]),m.useEffect(()=>{if(!l.showCredits||!K){I(null);return}let ae=!0;return(async()=>{try{const pe=await fetch(`${un}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K})});if(!pe.ok)return;const H=await pe.json();ae&&H&&H.ok!==!1&&I(H)}catch{}})(),()=>{ae=!1}},[l.showCredits,K,V]);const le=m.useCallback(ae=>C(new Set(ae)),[]);return{session:i,mode:o,caps:l,fund:f,email:K,marketEstimate:v,generatedAt:A,criteria:b,stats:x,thumbs:E,stages:N,dossiers:h,favIds:L,setFavIds:le,credits:O,reloadCredits:()=>J(ae=>ae+1),loading:F,error:g,refresh:()=>G(ae=>ae+1)}}function Xe(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Fr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ns=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Fr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),rs=new Set(["signal","amount","score","crible","memo"]);function os(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Fr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:rs.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Mr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Mr=80;function wa(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Re(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(mn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(ct(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&kt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function Rr(e,a,r){return Xe(e)?wa(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:wa(e,a.filters,r)}function is(e,a,r,n){return!(!Rr(e,a,r)||r&&!Po(e,a.ptab,n))}function hn(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ct(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Bo(i);case"memo":return Io(i);case"signal":{const o=Re(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),d=n(o);return l<d?-a.dir:l>d?a.dir:(i.name||"").localeCompare(o.name||"")})}const Pa={},$n=(Pa==null?void 0:Pa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function _n(){return new Date().toISOString().slice(0,10)}const gn=m.createContext(null);function Or(){return m.useContext(gn)}function ss(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const d=n.cloneNode(!0);d.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),d.querySelectorAll("*").forEach(c=>{const h=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(s=>c.removeAttribute(s.name)),h&&/^https?:\/\//i.test(h)&&(c.setAttribute("href",h),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:d.outerHTML})}}catch{}return a}function Un(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Dr(){const e=m.useContext(gn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ls({token:e,children:a}){const{dispatch:r,st:n,lang:i}=_(),[o,l]=m.useState(()=>n.filters.day||_n()),[d,c]=m.useState(null),[h,s]=m.useState(!1),f=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),p=m.useCallback(()=>{l(_n());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);m.useEffect(()=>{const b=y=>{var j;const x=(j=y.detail)==null?void 0:j.day;typeof x=="string"&&f(x)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[f]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const y=new URLSearchParams({token:e,date:o});return fetch(`${$n}/cibles/edition.json?${y}`).then(x=>x.json()).then(x=>{b||c(x)}).catch(()=>{b||c({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const v=m.useMemo(()=>`${$n}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),u=m.useMemo(()=>({token:e,day:o,ed:d,loading:h,pickDay:f,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:v,isEn:i==="en"}),[e,o,d,h,f,p,n.filters.day,v,i]);return t.jsx(gn.Provider,{value:u,children:a})}function ds(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Dr(),[i,o]=m.useState(()=>n||Er());return m.useEffect(()=>{n&&o(!0)},[n]),m.useEffect(()=>{const l=d=>{var c;return o(!!((c=d.detail)!=null&&c.open))};return window.addEventListener(va,l),()=>window.removeEventListener(va,l)},[]),i?t.jsx("div",{className:"thesis-days",children:t.jsx($o,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}function cs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Dr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:Un(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:Un(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← See all":"← Voir tout"})]})}const ps=300,ia=7,us={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Pr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},ms=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ia(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Vo(r)&&r!=="media")return"news:"+r;const n=Re(e);return n?"sig:"+(n.theme&&Pr.fr[n.theme]?n.theme:"other"):"actualites"}function fs(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:d}=_(),c=Or(),h=l==="en",[s,f]=m.useState("all"),[p,v]=m.useState(!1),u=m.useMemo(()=>{var pe;const g=(a.filters.day||"").slice(0,10),z=H=>!(!o&&a.continent!=="monde"&&H.continent!==a.continent||g&&(H.date||"").slice(0,10)!==g),U=e.filter(H=>z(H)&&Re(H)&&(!o||H.kind!=="target"||ze(H)!==5)),G=o&&(((pe=c==null?void 0:c.ed)==null?void 0:pe.ops)||[]).length?c.ed.ops.map(H=>xa(H,l)).filter(H=>!!H).filter(H=>!g||(H.date||"").slice(0,10)===g):[],V=e.filter(H=>z(H)&&H.kind==="op"&&(g?!0:ct(H.date)<=ia)),J=o?G.length?G:V.filter(H=>{const ie=(d||"").trim().toLowerCase();if(!ie)return!1;const ee=H.match||null;return ee?Object.keys(ee).map(qe=>qe.trim().toLowerCase()).includes(ie):!1}):V,X=g||new Date().toISOString().slice(0,10),K=H=>{const ie=Ia(H);return ie==="ma"?0:ie==="levees"?1:2};J.sort((H,ie)=>{const ee=K(H)-K(ie);if(ee)return ee;const qe=(H.date||"").slice(0,10)===X?0:1,ke=(ie.date||"").slice(0,10)===X?0:1;return qe!==ke?qe-ke:(ie.amountEur||0)-(H.amountEur||0)});const le=new Set,ae=[];for(const H of[...J,...hn(U,{key:"signal",dir:-1})]){const ie=H.id||H.name;!ie||le.has(ie)||(le.add(ie),ae.push(H))}return o&&ae.length===0?e.filter(ie=>z(ie)&&ct(ie.date)<=ia).sort((ie,ee)=>(ee.date||"").localeCompare(ie.date||"")).slice(0,80):ae},[e,a.continent,a.filters.day,o,d,l,c]),b=m.useMemo(()=>{const g={};for(const z of u){const U=Ia(z);g[U]=(g[U]||0)+1}return g},[u]),y=m.useMemo(()=>s==="all"?u:u.filter(g=>Ia(g)===s),[u,s]),x=m.useMemo(()=>y.slice(0,ps),[y]),j=y.length-x.length,E=m.useRef(null);m.useEffect(()=>{var J,X;const g=E.current;if(!g)return;const z=()=>{const K=g.scrollWidth;K<200||(g.style.animationDuration=Math.max(18,Math.round(K/130))+"s")};z();const U=requestAnimationFrame(z),G=window.setTimeout(z,1200);let V=!0;return(X=(J=document.fonts)==null?void 0:J.ready)==null||X.then(()=>{V&&z()}),()=>{V=!1,cancelAnimationFrame(U),window.clearTimeout(G)}},[x.length,s]);const w=g=>g==="all"?u.length:b[g]||0,N=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return Pr[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const z=g.slice(5);return Uo[z]?Ho(z,h?"en":"fr"):g}return us[h?"en":"fr"][g]},T=[{k:"all"}],A=["ma","levees"].filter(g=>w(g)>0||g===s);if(A.length){T.push({g:h?"Deals":"Opérations"});for(const g of A)T.push({k:g})}const q=["nominations","recrutements"].filter(g=>w(g)>0||g===s),L=_o.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>w(g)>0||g===s),C=w("actualites")>0||s==="actualites"?["actualites"]:[];if(q.length||L.length||C.length){T.push({g:h?"News":"Actualités"});for(const g of q)T.push({k:g});for(const g of L)T.push({k:g});for(const g of C)T.push({k:g})}const O=ms.map(g=>"sig:"+g).filter(g=>w(g)>0||g===s);if(O.length){T.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of O)T.push({k:g})}const I=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},F=(()=>{const g=(a.filters.day||"").slice(0,10),z=!o&&a.continent!=="monde"&&i?h?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return g?(h?`LIVE covers the events of ${I(g)}.`:`Le LIVE regroupe les événements du ${I(g)}.`)+z:(h?`LIVE covers the still-open signals and the deals of the last ${ia} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ia} derniers jours.`)+z})(),P=g=>x.map(z=>t.jsxs("button",{type:"button",className:"tk"+(Be(z)?" spent":""),onClick:U=>{try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:z.id,name:z.name,url:z.url||"",text:z.tagline||z.headline||"",card:z.card}}))}catch{}if(n({type:"focus",id:z.id}),a.dens!=="liste"){const G=U.currentTarget.getBoundingClientRect();n({type:"popup",id:z.id,anchor:{x:G.left+G.width/2,y:G.bottom}})}},title:z.name+(z.tagline?" — "+z.tagline:""),children:[t.jsx(Ct,{o:z}),t.jsxs("span",{className:"who",children:[t.jsx(bo,{o:z}),t.jsx("span",{className:"co",children:z.name})]}),typeof z.amountEur=="number"&&z.amountEur>0&&t.jsx("span",{className:"am",children:$d(z.amountEur)}),z.sector&&t.jsx("span",{className:"mt",children:z.sector}),t.jsx(qa,{o:z}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(z.id||z.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||v(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>v(g=>!g),children:[N(s),t.jsx("b",{children:w(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:F}),T.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===s,onClick:()=>{f(g.k),v(!1)},children:[N(g.k),t.jsx("b",{children:w(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:x.length?t.jsxs("div",{className:"run",ref:E,children:[P(0),P(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(hs,{isEn:h})]})}const xs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function hs({isEn:e}){const[a,r]=m.useState(()=>Er());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(va,i),()=>window.removeEventListener(va,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Wo(!a),children:xs})}const bn="+33 6 83 10 72 86",ka="alexandre@proplace.co",Ir=`tel:${bn.replace(/[^\d+]/g,"")}`;function gs(){return null}class tt extends m.Component{constructor(){super(...arguments);En(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Br=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function bs(e,a){if((mt(e)||"").startsWith("CALL")&&ze(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ze(e)>=2;return Br.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function vs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=_(),[d,c]=m.useState(!1),[h,s]=m.useState(""),[f,p]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const v=(e.ceoStatus||"").trim(),u=async b=>{if(h)return;if(b==="Analysé"&&!e.memoUrl){p(!0);return}s(b);const y=await i(e,b);s(""),y&&(c(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{c(b=>!b),p(!1)},children:[v||a.csNone,t.jsx("i",{children:"▾"})]}),d&&t.jsx("span",{className:"rstm",children:f?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),p(!1),c(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(c(!1),p(!1))})()},children:a.csAnaAnyway})]}):bs(e,a).map(([b,y])=>t.jsx("button",{type:"button",className:"rsti"+(v===b?" on":"")+(h===b?" busy":""),disabled:!!h,onClick:()=>{u(b)},children:y},b))})]})}function ys({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=_(),[o,l]=m.useState(""),[d,c]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),s=(mt(e)||"").startsWith("CALL")&&ze(e)===3,f=ze(e)>=2,p=async u=>{if(o||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(u);const b=await i(e,u);l(""),b&&(c(!0),setTimeout(()=>c(!1),2200))},v=s?[["Validé",a.csYes],["Écarté",a.csNo]]:Br.filter(([u])=>!(f&&u==="Retenu")).map(([u,b])=>[u,a[b]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([u,b])=>t.jsx("button",{type:"button",className:"csb"+(h===u?" on":"")+(o===u?" busy":""),disabled:!!o,onClick:()=>{p(u)},children:b},u)),d&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ws,{o:e})]})}function ws({o:e}){const{t:a,saveNote:r,flash:n}=_(),[i,o]=m.useState(e.ceoNote||""),[l,d]=m.useState(!1),[c,h]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),f=async()=>{if(l||!s)return;d(!0);const p=await r(e,i.trim());d(!1),p&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:p=>o(p.target.value),onKeyDown:p=>{p.key==="Enter"&&f()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{f()},children:c?a.csNoteSaved:a.csNoteOk})]})}function ks({placeholder:e,onDone:a}){const{t:r}=_(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function js({o:e}){var y;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:d}=_(),[c,h]=m.useState(!1);if(!n.pipe||!i||n.lockActions||ze(e)!==4)return null;const s=o(e),f=(s==null?void 0:s.stage)||"todo",p=async x=>{if(c||x===f)return;h(!0);const j=s;l(e,{stage:x,stamps:(s==null?void 0:s.stamps)||{}});const E=Math.max(Date.now(),Hn+=1);Hn=E;const w=await Yo(r,{company:e.name||"",stage:x,cts:E,deal_id:e.airtableId,check_id:e.checkId});h(!1),!w.stale&&(w.ok||(l(e,j),d(a.actErr)))},v=(y=s==null?void 0:s.stamps)==null?void 0:y.sent,u=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,b=f==="sent"&&v&&u>=4;return t.jsxs("div",{className:"stg",onClick:x=>x.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([x,j])=>t.jsx("button",{type:"button",className:"stgb"+(f===x?" on":""),disabled:c,onClick:()=>{p(x)},children:j},x)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let Hn=0;const sa=8,la=360;function Vn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Wn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(Vn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(Vn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function Ns({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=_(),[l,d]=m.useState(0),[c,h]=m.useState(null),[s,f]=m.useState([]),p=m.useRef(!1),v=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),u=m.useRef(!1);m.useEffect(()=>{const A=v.current;return()=>{u.current||(n({type:"ptab",tab:A.ptab}),n({type:"dens",dens:A.dens}),n({type:"modal",modal:A.modal}))}},[]),m.useEffect(()=>{p.current||(p.current=!0,f(e.filter(A=>!!document.querySelector(A.need||A.sel))))},[e]);const b=s[l],y=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const A=b.click,q=window.setTimeout(()=>{const L=document.querySelector(A);L&&L.getAttribute("aria-selected")!=="true"&&L.click()},60);return()=>window.clearTimeout(q)}},[l,b]);const x=m.useRef(-1),j=m.useCallback(()=>{if(!b){h(null);return}const A=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!A){h(null);return}x.current!==l&&(x.current=l,A.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=A.getBoundingClientRect();h(L=>L&&Math.abs(L.top-q.top)<1&&Math.abs(L.left-q.left)<1&&Math.abs(L.width-q.width)<1&&Math.abs(L.height-q.height)<1?L:q)},[b,l]);m.useLayoutEffect(()=>{j();const A=[90,300,700,1300].map(L=>window.setTimeout(j,L)),q=()=>j();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{A.forEach(L=>window.clearTimeout(L)),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[j]);const E=m.useRef(a);if(E.current=a,m.useEffect(()=>{const A=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),E.current()):q.key==="ArrowRight"?d(L=>L+1):q.key==="ArrowLeft"&&d(L=>Math.max(0,L-1))};return document.addEventListener("keydown",A,!0),()=>document.removeEventListener("keydown",A,!0)},[]),!s.length)return null;let w=null;const N=A=>()=>{u.current=!0,n({type:"modal",modal:null}),A()};if(y){const A=i[3]||0;A>0?w={title:A===1?r.ahaATitle1:r.ahaATitleN(A),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?w={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?w={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:la};if(!y&&c){const A=c.bottom+14,L=window.innerHeight-A>190?A:Math.max(12,c.top-200);T={left:Math.min(Math.max(12,c.left+c.width/2-la/2),window.innerWidth-la-12),top:L,width:la}}return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-sa,top:c.top-sa,width:c.width+sa*2,height:c.height+sa*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:T,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(Wn,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>d(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Wn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>d(A=>Math.max(0,A-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>d(A=>A+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function $r(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function _r(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Ss(){var q,L;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:d,dispatch:c}=_(),h=r?a:e,s=m.useMemo(()=>h.filter(C=>ct(C.date)===0&&C.kind==="target"),[h]),f=m.useMemo(()=>r?a.filter(C=>C.kind==="target"&&ze(C)===0).slice().sort((C,O)=>(O.date||"").localeCompare(C.date||"")):[],[a,r]),p=m.useMemo(()=>s.filter(C=>r?ze(C)===0:!Be(C)),[s,r]),v=r?f:p,u=r?a.length-f.length:s.length-p.length,b=r?a.length:s.length,y=b?Math.min(100,u/b*100):100,x=m.useMemo(()=>$r(h),[h]),j=!!x&&ct(x)>0,E=m.useMemo(()=>j?h.filter(C=>(C.date||"").slice(0,10)===x):[],[h,x,j]),w=typeof((q=d.stats)==null?void 0:q.kept_today)=="number"?d.stats.kept_today:null,N=typeof((L=d.stats)==null?void 0:L.screened_today)=="number"?d.stats.screened_today:s.length;let T;j?T=i.morningLast(E.length,f.length,_r(x,l)):r?T=i.morningThesis(N,f.length,w):s.length?u===0?T=i.goalSourced(s.length):u>=s.length?T=i.goalCleared:T=i.goalDone(u,s.length):T=i.goalSourced(0);const A=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&f.length&&c({type:"chainStart",queue:f.map(C=>C.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),v.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:A,children:r?i.morningEval(v.length):o.pileMode?i.goalContinue(v.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Es(){var U,G;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:d,mode:c,doSync:h,startTour:s,flash:f,flashErr:p}=_(),[v,u]=m.useState(null),[b,y]=m.useState(!0),[x,j]=m.useState([]),E=c==="client";m.useEffect(()=>{if(!i||!o)return;let V=!0;return y(!0),(async()=>{const[J,X]=await Promise.all([fn(o),Cr(i)]);V&&(J&&u(J),y(!1),j(X))})(),()=>{V=!1}},[i,o]);const[w,N]=m.useState(!1),T=()=>{!E||w||!o||(N(!0),Go(o).then(V=>{N(!1),V?f(e.identRepubDone):p(e.actErr)}))},A=(v==null?void 0:v.per_day)??null,q=((U=v==null?void 0:v.pool_order)==null?void 0:U.length)??0,L=x.filter(V=>V.status==="running").length,C=m.useMemo(()=>d.filter(V=>V.kind==="target"&&Be(V)).length,[d]),O=l.marketEstimate,I=typeof((G=l.stats)==null?void 0:G.screened)=="number"?l.stats.screened:C,F=O&&O>0?Math.min(100,Math.round(I/O*100)):null,P=V=>V.toLocaleString(a==="en"?"en-US":"fr-FR"),g=(o||"P").split(/\s+/).map(V=>V[0]).join("").slice(0,2).toUpperCase(),z=(()=>{const V=Date.parse(l.generatedAt||"");if(Number.isNaN(V))return"";const J=new Date(V),X=K=>String(K).padStart(2,"0");return`${X(J.getDate())}/${X(J.getMonth()+1)} à ${X(J.getHours())}:${X(J.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?g:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),z?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(z)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[F===null&&I>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:P(I)})})]}),F!==null&&O&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:F+"%"}})}),t.jsxs("b",{children:[F," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(I,O)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),A!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:A})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),A===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),L>0&&t.jsxs("span",{className:"ev",children:["⏳ ",L]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:V=>{V.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||w,onClick:T,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:h,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:V=>n({type:"filters",patch:{search:V.target.value}})})]})]})]})}class Nt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,d=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);d&&(r[n++]=d),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Cs(e){for(const a of e)yield*a}function Ur(e){return Array.from(Cs(e))}var we=1e-6,ue=Math.PI,Ye=ue/2,Yn=ue/4,Ke=ue*2,lt=180/ue,_e=ue/180,Ee=Math.abs,zs=Math.atan,Qt=Math.atan2,Ae=Math.cos,Te=Math.sin,As=Math.sign||function(e){return e>0?1:e<0?-1:0},zt=Math.sqrt;function Ts(e){return e>1?0:e<-1?ue:Math.acos(e)}function Jt(e){return e>1?Ye:e<-1?-Ye:Math.asin(e)}function Ge(){}function ja(e,a){e&&Kn.hasOwnProperty(e.type)&&Kn[e.type](e,a)}var Gn={Feature:function(e,a){ja(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)ja(r[n].geometry,a)}},Kn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Qa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Qa(r[n],a,0)},Polygon:function(e,a){Qn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Qn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)ja(r[n],a)}};function Qa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Qn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Qa(e[r],a,1);a.polygonEnd()}function Lt(e,a){e&&Gn.hasOwnProperty(e.type)?Gn[e.type](e,a):ja(e,a)}function Ja(e){return[Qt(e[1],e[0]),Jt(e[2])]}function Rt(e){var a=e[0],r=e[1],n=Ae(r);return[n*Ae(a),n*Te(a),Te(r)]}function da(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Na(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ba(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ca(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Xa(e){var a=zt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Za(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function en(e,a){return Ee(e)>ue&&(e-=Math.round(e/Ke)*Ke),[e,a]}en.invert=en;function Ls(e,a,r){return(e%=Ke)?a||r?Za(Xn(e),Zn(a,r)):Xn(e):a||r?Zn(a,r):en}function Jn(e){return function(a,r){return a+=e,Ee(a)>ue&&(a-=Math.round(a/Ke)*Ke),[a,r]}}function Xn(e){var a=Jn(e);return a.invert=Jn(-e),a}function Zn(e,a){var r=Ae(e),n=Te(e),i=Ae(a),o=Te(a);function l(d,c){var h=Ae(c),s=Ae(d)*h,f=Te(d)*h,p=Te(c),v=p*r+s*n;return[Qt(f*i-v*o,s*r-p*n),Jt(v*i+f*o)]}return l.invert=function(d,c){var h=Ae(c),s=Ae(d)*h,f=Te(d)*h,p=Te(c),v=p*i-f*o;return[Qt(f*i+p*o,s*r+v*n),Jt(v*r-s*n)]},l}function qs(e,a,r,n,i,o){if(r){var l=Ae(a),d=Te(a),c=n*r;i==null?(i=a+n*Ke,o=a-c/2):(i=er(l,i),o=er(l,o),(n>0?i<o:i>o)&&(i+=n*Ke));for(var h,s=i;n>0?s>o:s<o;s-=c)h=Ja([l,-d*Ae(s),-d*Te(s)]),e.point(h[0],h[1])}}function er(e,a){a=Rt(a),a[0]-=e,Xa(a);var r=Ts(-a[1]);return((-a[2]<0?-r:r)+Ke-we)%Ke}function Hr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ge,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function ha(e,a){return Ee(e[0]-a[0])<we&&Ee(e[1]-a[1])<we}function pa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Vr(e,a,r,n,i){var o=[],l=[],d,c;if(e.forEach(function(u){if(!((b=u.length-1)<=0)){var b,y=u[0],x=u[b],j;if(ha(y,x)){if(!y[2]&&!x[2]){for(i.lineStart(),d=0;d<b;++d)i.point((y=u[d])[0],y[1]);i.lineEnd();return}x[0]+=2*we}o.push(j=new pa(y,u,null,!0)),l.push(j.o=new pa(y,null,j,!1)),o.push(j=new pa(x,u,null,!1)),l.push(j.o=new pa(x,null,j,!0))}}),!!o.length){for(l.sort(a),tr(o),tr(l),d=0,c=l.length;d<c;++d)l[d].e=r=!r;for(var h=o[0],s,f;;){for(var p=h,v=!0;p.v;)if((p=p.n)===h)return;s=p.z,i.lineStart();do{if(p.v=p.o.v=!0,p.e){if(v)for(d=0,c=s.length;d<c;++d)i.point((f=s[d])[0],f[1]);else n(p.x,p.n.x,1,i);p=p.n}else{if(v)for(s=p.p.z,d=s.length-1;d>=0;--d)i.point((f=s[d])[0],f[1]);else n(p.x,p.p.x,-1,i);p=p.p}p=p.o,s=p.z,v=!v}while(!p.v);i.lineEnd()}}}function tr(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function $a(e){return Ee(e[0])<=ue?e[0]:As(e[0])*((Ee(e[0])+ue)%Ke-ue)}function Fs(e,a){var r=$a(a),n=a[1],i=Te(n),o=[Te(r),-Ae(r),0],l=0,d=0,c=new Nt;i===1?n=Ye+we:i===-1&&(n=-Ye-we);for(var h=0,s=e.length;h<s;++h)if(p=(f=e[h]).length)for(var f,p,v=f[p-1],u=$a(v),b=v[1]/2+Yn,y=Te(b),x=Ae(b),j=0;j<p;++j,u=w,y=T,x=A,v=E){var E=f[j],w=$a(E),N=E[1]/2+Yn,T=Te(N),A=Ae(N),q=w-u,L=q>=0?1:-1,C=L*q,O=C>ue,I=y*T;if(c.add(Qt(I*L*Te(C),x*A+I*Ae(C))),l+=O?q+L*Ke:q,O^u>=r^w>=r){var F=Na(Rt(v),Rt(E));Xa(F);var P=Na(o,F);Xa(P);var g=(O^q>=0?-1:1)*Jt(P[2]);(n>g||n===g&&(F[0]||F[1]))&&(d+=O^q>=0?1:-1)}}return(l<-we||l<we&&c<-1e-12)^d&1}function Wr(e,a,r,n){return function(i){var o=a(i),l=Hr(),d=a(l),c=!1,h,s,f,p={point:v,lineStart:b,lineEnd:y,polygonStart:function(){p.point=x,p.lineStart=j,p.lineEnd=E,s=[],h=[]},polygonEnd:function(){p.point=v,p.lineStart=b,p.lineEnd=y,s=Ur(s);var w=Fs(h,n);s.length?(c||(i.polygonStart(),c=!0),Vr(s,Rs,w,r,i)):w&&(c||(i.polygonStart(),c=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),c&&(i.polygonEnd(),c=!1),s=h=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function v(w,N){e(w,N)&&i.point(w,N)}function u(w,N){o.point(w,N)}function b(){p.point=u,o.lineStart()}function y(){p.point=v,o.lineEnd()}function x(w,N){f.push([w,N]),d.point(w,N)}function j(){d.lineStart(),f=[]}function E(){x(f[0][0],f[0][1]),d.lineEnd();var w=d.clean(),N=l.result(),T,A=N.length,q,L,C;if(f.pop(),h.push(f),f=null,!!A){if(w&1){if(L=N[0],(q=L.length-1)>0){for(c||(i.polygonStart(),c=!0),i.lineStart(),T=0;T<q;++T)i.point((C=L[T])[0],C[1]);i.lineEnd()}return}A>1&&w&2&&N.push(N.pop().concat(N.shift())),s.push(N.filter(Ms))}}return p}}function Ms(e){return e.length>1}function Rs(e,a){return((e=e.x)[0]<0?e[1]-Ye-we:Ye-e[1])-((a=a.x)[0]<0?a[1]-Ye-we:Ye-a[1])}const ar=Wr(function(){return!0},Os,Ps,[-ue,-Ye]);function Os(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var d=o>0?ue:-ue,c=Ee(o-a);Ee(c-ue)<we?(e.point(a,r=(r+l)/2>0?Ye:-Ye),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),e.point(o,r),i=0):n!==d&&c>=ue&&(Ee(a-n)<we&&(a-=n*we),Ee(o-d)<we&&(o-=d*we),r=Ds(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(d,r),i=0),e.point(a=o,r=l),n=d},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ds(e,a,r,n){var i,o,l=Te(e-r);return Ee(l)>we?zs((Te(a)*(o=Ae(n))*Te(r)-Te(n)*(i=Ae(a))*Te(e))/(i*o*l)):(a+n)/2}function Ps(e,a,r,n){var i;if(e==null)i=r*Ye,n.point(-ue,i),n.point(0,i),n.point(ue,i),n.point(ue,0),n.point(ue,-i),n.point(0,-i),n.point(-ue,-i),n.point(-ue,0),n.point(-ue,i);else if(Ee(e[0]-a[0])>we){var o=e[0]<a[0]?ue:-ue;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Is(e){var a=Ae(e),r=2*_e,n=a>0,i=Ee(a)>we;function o(s,f,p,v){qs(v,e,r,p,s,f)}function l(s,f){return Ae(s)*Ae(f)>a}function d(s){var f,p,v,u,b;return{lineStart:function(){u=v=!1,b=1},point:function(y,x){var j=[y,x],E,w=l(y,x),N=n?w?0:h(y,x):w?h(y+(y<0?ue:-ue),x):0;if(!f&&(u=v=w)&&s.lineStart(),w!==v&&(E=c(f,j),(!E||ha(f,E)||ha(j,E))&&(j[2]=1)),w!==v)b=0,w?(s.lineStart(),E=c(j,f),s.point(E[0],E[1])):(E=c(f,j),s.point(E[0],E[1],2),s.lineEnd()),f=E;else if(i&&f&&n^w){var T;!(N&p)&&(T=c(j,f,!0))&&(b=0,n?(s.lineStart(),s.point(T[0][0],T[0][1]),s.point(T[1][0],T[1][1]),s.lineEnd()):(s.point(T[1][0],T[1][1]),s.lineEnd(),s.lineStart(),s.point(T[0][0],T[0][1],3)))}w&&(!f||!ha(f,j))&&s.point(j[0],j[1]),f=j,v=w,p=N},lineEnd:function(){v&&s.lineEnd(),f=null},clean:function(){return b|(u&&v)<<1}}}function c(s,f,p){var v=Rt(s),u=Rt(f),b=[1,0,0],y=Na(v,u),x=da(y,y),j=y[0],E=x-j*j;if(!E)return!p&&s;var w=a*x/E,N=-a*j/E,T=Na(b,y),A=ca(b,w),q=ca(y,N);Ba(A,q);var L=T,C=da(A,L),O=da(L,L),I=C*C-O*(da(A,A)-1);if(!(I<0)){var F=zt(I),P=ca(L,(-C-F)/O);if(Ba(P,A),P=Ja(P),!p)return P;var g=s[0],z=f[0],U=s[1],G=f[1],V;z<g&&(V=g,g=z,z=V);var J=z-g,X=Ee(J-ue)<we,K=X||J<we;if(!X&&G<U&&(V=U,U=G,G=V),K?X?U+G>0^P[1]<(Ee(P[0]-g)<we?U:G):U<=P[1]&&P[1]<=G:J>ue^(g<=P[0]&&P[0]<=z)){var le=ca(L,(-C+F)/O);return Ba(le,A),[P,Ja(le)]}}}function h(s,f){var p=n?e:ue-e,v=0;return s<-p?v|=1:s>p&&(v|=2),f<-p?v|=4:f>p&&(v|=8),v}return Wr(l,d,o,n?[0,-e]:[-ue,e-ue])}function Bs(e,a,r,n,i,o){var l=e[0],d=e[1],c=a[0],h=a[1],s=0,f=1,p=c-l,v=h-d,u;if(u=r-l,!(!p&&u>0)){if(u/=p,p<0){if(u<s)return;u<f&&(f=u)}else if(p>0){if(u>f)return;u>s&&(s=u)}if(u=i-l,!(!p&&u<0)){if(u/=p,p<0){if(u>f)return;u>s&&(s=u)}else if(p>0){if(u<s)return;u<f&&(f=u)}if(u=n-d,!(!v&&u>0)){if(u/=v,v<0){if(u<s)return;u<f&&(f=u)}else if(v>0){if(u>f)return;u>s&&(s=u)}if(u=o-d,!(!v&&u<0)){if(u/=v,v<0){if(u>f)return;u>s&&(s=u)}else if(v>0){if(u<s)return;u<f&&(f=u)}return s>0&&(e[0]=l+s*p,e[1]=d+s*v),f<1&&(a[0]=l+f*p,a[1]=d+f*v),!0}}}}}var Ut=1e9,ua=-Ut;function $s(e,a,r,n){function i(h,s){return e<=h&&h<=r&&a<=s&&s<=n}function o(h,s,f,p){var v=0,u=0;if(h==null||(v=l(h,f))!==(u=l(s,f))||c(h,s)<0^f>0)do p.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+f+4)%4)!==u);else p.point(s[0],s[1])}function l(h,s){return Ee(h[0]-e)<we?s>0?0:3:Ee(h[0]-r)<we?s>0?2:1:Ee(h[1]-a)<we?s>0?1:0:s>0?3:2}function d(h,s){return c(h.x,s.x)}function c(h,s){var f=l(h,1),p=l(s,1);return f!==p?f-p:f===0?s[1]-h[1]:f===1?h[0]-s[0]:f===2?h[1]-s[1]:s[0]-h[0]}return function(h){var s=h,f=Hr(),p,v,u,b,y,x,j,E,w,N,T,A={point:q,lineStart:I,lineEnd:F,polygonStart:C,polygonEnd:O};function q(g,z){i(g,z)&&s.point(g,z)}function L(){for(var g=0,z=0,U=v.length;z<U;++z)for(var G=v[z],V=1,J=G.length,X=G[0],K,le,ae=X[0],pe=X[1];V<J;++V)K=ae,le=pe,X=G[V],ae=X[0],pe=X[1],le<=n?pe>n&&(ae-K)*(n-le)>(pe-le)*(e-K)&&++g:pe<=n&&(ae-K)*(n-le)<(pe-le)*(e-K)&&--g;return g}function C(){s=f,p=[],v=[],T=!0}function O(){var g=L(),z=T&&g,U=(p=Ur(p)).length;(z||U)&&(h.polygonStart(),z&&(h.lineStart(),o(null,null,1,h),h.lineEnd()),U&&Vr(p,d,g,o,h),h.polygonEnd()),s=h,p=v=u=null}function I(){A.point=P,v&&v.push(u=[]),N=!0,w=!1,j=E=NaN}function F(){p&&(P(b,y),x&&w&&f.rejoin(),p.push(f.result())),A.point=q,w&&s.lineEnd()}function P(g,z){var U=i(g,z);if(v&&u.push([g,z]),N)b=g,y=z,x=U,N=!1,U&&(s.lineStart(),s.point(g,z));else if(U&&w)s.point(g,z);else{var G=[j=Math.max(ua,Math.min(Ut,j)),E=Math.max(ua,Math.min(Ut,E))],V=[g=Math.max(ua,Math.min(Ut,g)),z=Math.max(ua,Math.min(Ut,z))];Bs(G,V,e,a,r,n)?(w||(s.lineStart(),s.point(G[0],G[1])),s.point(V[0],V[1]),U||s.lineEnd(),T=!1):U&&(s.lineStart(),s.point(g,z),T=!1)}j=g,E=z,w=U}return A}}const tn=e=>e;var _a=new Nt,an=new Nt,Yr,Gr,nn,rn,dt={point:Ge,lineStart:Ge,lineEnd:Ge,polygonStart:function(){dt.lineStart=_s,dt.lineEnd=Hs},polygonEnd:function(){dt.lineStart=dt.lineEnd=dt.point=Ge,_a.add(Ee(an)),an=new Nt},result:function(){var e=_a/2;return _a=new Nt,e}};function _s(){dt.point=Us}function Us(e,a){dt.point=Kr,Yr=nn=e,Gr=rn=a}function Kr(e,a){an.add(rn*e-nn*a),nn=e,rn=a}function Hs(){Kr(Yr,Gr)}var Ot=1/0,Sa=Ot,Xt=-Ot,Ea=Xt,Ca={point:Vs,lineStart:Ge,lineEnd:Ge,polygonStart:Ge,polygonEnd:Ge,result:function(){var e=[[Ot,Sa],[Xt,Ea]];return Xt=Ea=-(Sa=Ot=1/0),e}};function Vs(e,a){e<Ot&&(Ot=e),e>Xt&&(Xt=e),a<Sa&&(Sa=a),a>Ea&&(Ea=a)}var on=0,sn=0,Ht=0,za=0,Aa=0,qt=0,ln=0,dn=0,Vt=0,Qr,Jr,rt,ot,We={point:St,lineStart:nr,lineEnd:rr,polygonStart:function(){We.lineStart=Gs,We.lineEnd=Ks},polygonEnd:function(){We.point=St,We.lineStart=nr,We.lineEnd=rr},result:function(){var e=Vt?[ln/Vt,dn/Vt]:qt?[za/qt,Aa/qt]:Ht?[on/Ht,sn/Ht]:[NaN,NaN];return on=sn=Ht=za=Aa=qt=ln=dn=Vt=0,e}};function St(e,a){on+=e,sn+=a,++Ht}function nr(){We.point=Ws}function Ws(e,a){We.point=Ys,St(rt=e,ot=a)}function Ys(e,a){var r=e-rt,n=a-ot,i=zt(r*r+n*n);za+=i*(rt+e)/2,Aa+=i*(ot+a)/2,qt+=i,St(rt=e,ot=a)}function rr(){We.point=St}function Gs(){We.point=Qs}function Ks(){Xr(Qr,Jr)}function Qs(e,a){We.point=Xr,St(Qr=rt=e,Jr=ot=a)}function Xr(e,a){var r=e-rt,n=a-ot,i=zt(r*r+n*n);za+=i*(rt+e)/2,Aa+=i*(ot+a)/2,qt+=i,i=ot*e-rt*a,ln+=i*(rt+e),dn+=i*(ot+a),Vt+=i*3,St(rt=e,ot=a)}function Zr(e){this._context=e}Zr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Ke);break}}},result:Ge};var cn=new Nt,Ua,eo,to,Wt,Yt,Zt={point:Ge,lineStart:function(){Zt.point=Js},lineEnd:function(){Ua&&ao(eo,to),Zt.point=Ge},polygonStart:function(){Ua=!0},polygonEnd:function(){Ua=null},result:function(){var e=+cn;return cn=new Nt,e}};function Js(e,a){Zt.point=ao,eo=Wt=e,to=Yt=a}function ao(e,a){Wt-=e,Yt-=a,cn.add(zt(Wt*Wt+Yt*Yt)),Wt=e,Yt=a}let or,Ta,ir,sr;class lr{constructor(a){this._append=a==null?no:Xs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==ir||this._append!==Ta){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,ir=n,Ta=this._append,sr=this._,this._=i}this._+=sr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function no(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Xs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return no;if(a!==or){const r=10**a;or=a,Ta=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Ta}function Zs(e,a){let r=3,n=4.5,i,o;function l(d){return d&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Lt(d,i(o))),o.result()}return l.area=function(d){return Lt(d,i(dt)),dt.result()},l.measure=function(d){return Lt(d,i(Zt)),Zt.result()},l.bounds=function(d){return Lt(d,i(Ca)),Ca.result()},l.centroid=function(d){return Lt(d,i(We)),We.result()},l.projection=function(d){return arguments.length?(i=d==null?(e=null,tn):(e=d).stream,l):e},l.context=function(d){return arguments.length?(o=d==null?(a=null,new lr(r)):new Zr(a=d),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(d){return arguments.length?(n=typeof d=="function"?d:(o.pointRadius(+d),+d),l):n},l.digits=function(d){if(!arguments.length)return r;if(d==null)r=null;else{const c=Math.floor(d);if(!(c>=0))throw new RangeError(`invalid digits: ${d}`);r=c}return a===null&&(o=new lr(r)),l},l.projection(e).digits(r).context(a)}function vn(e){return function(a){var r=new pn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function pn(){}pn.prototype={constructor:pn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function yn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Lt(r,e.stream(Ca)),a(Ca.result()),n!=null&&e.clipExtent(n),e}function ro(e,a,r){return yn(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),d=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([d,c])},r)}function el(e,a,r){return ro(e,[[0,0],a],r)}function tl(e,a,r){return yn(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,d=-o*n[0][1];e.scale(150*o).translate([l,d])},r)}function al(e,a,r){return yn(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],d=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,d])},r)}var dr=16,nl=Ae(30*_e);function cr(e,a){return+a?ol(e,a):rl(e)}function rl(e){return vn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function ol(e,a){function r(n,i,o,l,d,c,h,s,f,p,v,u,b,y){var x=h-n,j=s-i,E=x*x+j*j;if(E>4*a&&b--){var w=l+p,N=d+v,T=c+u,A=zt(w*w+N*N+T*T),q=Jt(T/=A),L=Ee(Ee(T)-1)<we||Ee(o-f)<we?(o+f)/2:Qt(N,w),C=e(L,q),O=C[0],I=C[1],F=O-n,P=I-i,g=j*F-x*P;(g*g/E>a||Ee((x*F+j*P)/E-.5)>.3||l*p+d*v+c*u<nl)&&(r(n,i,o,l,d,c,O,I,L,w/=A,N/=A,T,b,y),y.point(O,I),r(O,I,L,w,N,T,h,s,f,p,v,u,b,y))}}return function(n){var i,o,l,d,c,h,s,f,p,v,u,b,y={point:x,lineStart:j,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=N},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function x(q,L){q=e(q,L),n.point(q[0],q[1])}function j(){f=NaN,y.point=E,n.lineStart()}function E(q,L){var C=Rt([q,L]),O=e(q,L);r(f,p,s,v,u,b,f=O[0],p=O[1],s=q,v=C[0],u=C[1],b=C[2],dr,n),n.point(f,p)}function w(){y.point=x,n.lineEnd()}function N(){j(),y.point=T,y.lineEnd=A}function T(q,L){E(i=q,L),o=f,l=p,d=v,c=u,h=b,y.point=E}function A(){r(f,p,s,v,u,b,o,l,i,d,c,h,dr,n),y.lineEnd=w,w()}return y}}var il=vn({point:function(e,a){this.stream.point(e*_e,a*_e)}});function sl(e){return vn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ll(e,a,r,n,i){function o(l,d){return l*=n,d*=i,[a+e*l,r-e*d]}return o.invert=function(l,d){return[(l-a)/e*n,(r-d)/e*i]},o}function pr(e,a,r,n,i,o){if(!o)return ll(e,a,r,n,i);var l=Ae(o),d=Te(o),c=l*e,h=d*e,s=l/e,f=d/e,p=(d*r-l*a)/e,v=(d*a+l*r)/e;function u(b,y){return b*=n,y*=i,[c*b-h*y+a,r-h*b-c*y]}return u.invert=function(b,y){return[n*(s*b-f*y+p),i*(v-f*b-s*y)]},u}function dl(e){return cl(function(){return e})()}function cl(e){var a,r=150,n=480,i=250,o=0,l=0,d=0,c=0,h=0,s,f=0,p=1,v=1,u=null,b=ar,y=null,x,j,E,w=tn,N=.5,T,A,q,L,C;function O(g){return q(g[0]*_e,g[1]*_e)}function I(g){return g=q.invert(g[0],g[1]),g&&[g[0]*lt,g[1]*lt]}O.stream=function(g){return L&&C===g?L:L=il(sl(s)(b(T(w(C=g)))))},O.preclip=function(g){return arguments.length?(b=g,u=void 0,P()):b},O.postclip=function(g){return arguments.length?(w=g,y=x=j=E=null,P()):w},O.clipAngle=function(g){return arguments.length?(b=+g?Is(u=g*_e):(u=null,ar),P()):u*lt},O.clipExtent=function(g){return arguments.length?(w=g==null?(y=x=j=E=null,tn):$s(y=+g[0][0],x=+g[0][1],j=+g[1][0],E=+g[1][1]),P()):y==null?null:[[y,x],[j,E]]},O.scale=function(g){return arguments.length?(r=+g,F()):r},O.translate=function(g){return arguments.length?(n=+g[0],i=+g[1],F()):[n,i]},O.center=function(g){return arguments.length?(o=g[0]%360*_e,l=g[1]%360*_e,F()):[o*lt,l*lt]},O.rotate=function(g){return arguments.length?(d=g[0]%360*_e,c=g[1]%360*_e,h=g.length>2?g[2]%360*_e:0,F()):[d*lt,c*lt,h*lt]},O.angle=function(g){return arguments.length?(f=g%360*_e,F()):f*lt},O.reflectX=function(g){return arguments.length?(p=g?-1:1,F()):p<0},O.reflectY=function(g){return arguments.length?(v=g?-1:1,F()):v<0},O.precision=function(g){return arguments.length?(T=cr(A,N=g*g),P()):zt(N)},O.fitExtent=function(g,z){return ro(O,g,z)},O.fitSize=function(g,z){return el(O,g,z)},O.fitWidth=function(g,z){return tl(O,g,z)},O.fitHeight=function(g,z){return al(O,g,z)};function F(){var g=pr(r,0,0,p,v,f).apply(null,a(o,l)),z=pr(r,n-g[0],i-g[1],p,v,f);return s=Ls(d,c,h),A=Za(a,z),q=Za(s,A),T=cr(A,N),P()}function P(){return L=C=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&I,F()}}function oo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}oo.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(Ee(i)>we&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function pl(){return dl(oo).scale(175.295)}function ul(e){return e}function ml(e){if(e==null)return ul;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(d,c){c||(a=r=0);var h=2,s=d.length,f=new Array(s);for(f[0]=(a+=d[0])*n+o,f[1]=(r+=d[1])*i+l;h<s;)f[h]=d[h],++h;return f}}function fl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function xl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return ur(e,r)})}:ur(e,a)}function ur(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=hl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function hl(e,a){var r=ml(e.transform),n=e.arcs;function i(s,f){f.length&&f.pop();for(var p=n[s<0?~s:s],v=0,u=p.length;v<u;++v)f.push(r(p[v],v));s<0&&fl(f,u)}function o(s){return r(s)}function l(s){for(var f=[],p=0,v=s.length;p<v;++p)i(s[p],f);return f.length<2&&f.push(f[0]),f}function d(s){for(var f=l(s);f.length<4;)f.push(f[0]);return f}function c(s){return s.map(d)}function h(s){var f=s.type,p;switch(f){case"GeometryCollection":return{type:f,geometries:s.geometries.map(h)};case"Point":p=o(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(o);break;case"LineString":p=l(s.arcs);break;case"MultiLineString":p=s.arcs.map(l);break;case"Polygon":p=c(s.arcs);break;case"MultiPolygon":p=s.arcs.map(c);break;default:return null}return{type:f,coordinates:p}}return h(a)}const io={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},gl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function bl(e,a,r){const n=io[e];if(!n||!n.length)return-1;const i=gl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let ma=null;function vl(){return ma||(ma=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=xl(r,n),o=pl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Zs(o),d=(i.features||[]).filter(s=>{var f;return(((f=s.properties)==null?void 0:f.name)||"")!=="Antarctica"}).map(s=>{var v;const f=((v=s.properties)==null?void 0:v.name)||"",p=l(s)||"";return p?{i2:Ko(f)||null,n:f,d:p}:null}).filter(s=>!!s);if(!d.length)return null;const c={};for(const[s,f]of Object.entries(Qo)){const p=o(f);p&&(c[s]={x:p[0],y:p[1]})}const h={};for(const[s,f]of Object.entries(io)){const p=f.map(v=>o(v.ll)).filter(v=>!!v).map(([v,u])=>({x:v,y:u}));p.length&&(h[s]=p)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:d,anchors:c,metros:h}}catch{return null}})(),ma)}function yl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return vl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const wl="8 40 984 210",kl={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},mr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function fr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function jl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var h;if(!i)return;const c=(h=e.current)==null?void 0:h.getScreenCTM();c&&c.a>0?n(c.a):o=requestAnimationFrame(l)};l();const d=new ResizeObserver(()=>l());return e.current&&d.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),d.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function xr({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Nl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:d,t:c,data:h,dossiers:s,source:f}=_(),p=h.loading&&!s.length,v=m.useRef(null),u=m.useRef(null),b=yl(e.continent==="monde"),y=e.continent==="monde"?b:xn.find(g=>g.key===e.continent)||null,x=jl(v,e.continent+":"+e.mapFolded+":"+!!y),[j,E]=m.useState(new Map),[w,N]=m.useState(null);m.useEffect(()=>{const g=v.current;if(!g)return;const z=new Map;g.querySelectorAll("path[data-i2]").forEach(U=>{const G=U.dataset.i2;if(G)try{const V=U.getBBox();V.width>0&&z.set(G,{x:V.x,y:V.y,w:V.width,h:V.height})}catch{}}),E(z)},[e.continent,x,y]);const T=m.useMemo(()=>r.filter(g=>g.cc),[r]),A=m.useMemo(()=>{const g=new Map;return T.forEach(z=>g.set(z.cc,(g.get(z.cc)||0)+1)),g},[T]),q=e.continent==="monde"&&b?b.anchors:null,L=e.continent==="monde"&&b?b.metros:null,C=m.useMemo(()=>T.map(g=>{const z=fr(g.name||g.id||""),U=fr((g.id||g.name||"")+"·y");if(q&&g.cc){const K=L?L[g.cc]:void 0;if(K&&K.length){const ae=bl(g.cc,g.city,z);if(ae>=0&&K[ae])return{d:g,x:K[ae].x+(z-.5)*5,y:K[ae].y+(U-.5)*5}}const le=q[g.cc];if(le)return{d:g,x:le.x+(z-.5)*10,y:le.y+(U-.5)*10}}const G=g.cc?j.get(g.cc):void 0;if(!G)return null;const V=kl[`${e.continent}:${g.cc||""}`];if(V)return{d:g,x:G.x+G.w*(V.fx+(z-.5)*V.sx),y:G.y+G.h*(V.fy+(U-.5)*V.sy)};const J=(z-.5)*Math.min(G.w*.55,60),X=(U-.5)*Math.min(G.h*.55,60);return{d:g,x:G.x+G.w/2+J,y:G.y+G.h/2+X}}).filter(g=>!!g),[T,j,q,L,e.continent]),O=g=>x>0?g/x:g,I=m.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:mr[g],fr:c.plabels[g].toUpperCase(),en:c.plabels[g].toUpperCase(),n:r.filter(z=>z.kind==="target"&&ze(z)===g).length})).filter(g=>g.n>0):qn.map((g,z)=>({...g,n:r.filter(U=>Fn(U)===z).length})),[r,n,c.plabels]),F=o?l.get(o):null,P=F?C.find(g=>g.d.id===F.id):null;return y?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:[p&&t.jsx(xr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:v,viewBox:f==="ops"&&e.continent==="monde"?wl:y.viewBox,preserveAspectRatio:f==="ops"&&e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":d==="fr"?y.fr:y.en,onMouseLeave:()=>{N(null),i(null)},children:[t.jsx("g",{children:y.countries.map((g,z)=>t.jsx("g",{className:"ct"+(g.i2&&A.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},z))}),t.jsx("g",{children:C.map(g=>{const z=qn[Fn(g.d)],U=!!Re(g.d),G=g.d.kind==="target",V=n&&G?mr[ze(g.d)]:z.c,J=!n&&Be(g.d);return t.jsxs("g",{className:"co"+(J?" done":""),onMouseEnter:()=>{var le,ae;const X=(le=u.current)==null?void 0:le.getBoundingClientRect(),K=(ae=v.current)==null?void 0:ae.createSVGPoint();if(K&&v.current&&X){K.x=g.x,K.y=g.y;const pe=K.matrixTransform(v.current.getScreenCTM());N({x:pe.x-X.left,y:pe.y-X.top,label:g.d.name+" · "+(Pt(g.d.cc,d)||g.d.countryLabel||"")})}i(g.d.id)},onMouseLeave:()=>{N(null),i(null)},onClick:()=>{var le;if(f==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const X=(le=v.current)==null?void 0:le.createSVGPoint();let K=null;if(X&&v.current){X.x=g.x,X.y=g.y;const ae=X.matrixTransform(v.current.getScreenCTM());K={x:ae.x,y:ae.y}}a({type:"popup",id:g.d.id,anchor:K})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:O(Math.max(11,z.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:O(z.px),fill:V,stroke:U?"#DC2626":"#ffffff",strokeWidth:O(U?2.2:1.3)})]},g.d.id||g.d.name)})}),P&&t.jsx("circle",{className:"ring on",cx:P.x,cy:P.y,r:O(13),fill:"none",stroke:"#0F172A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:I.map((g,z)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),d==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},z))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:t.jsx(xr,{msgs:c.loadMsgs})})}function Sl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function so({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:d}=_(),c=a.filters,[h,s]=m.useState(!1),[f,p]=m.useState(!1),v=m.useRef(null),u=m.useRef(null),b=m.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),y=F=>b.filter(P=>F!=="country"&&c.country.length&&!c.country.includes(P.cc||"")?!1:wa(P,c,o,F==="country"?void 0:F)),x=m.useMemo(()=>{const F=y("win"),P=g=>F.filter(z=>(z.date?Math.max(0,Math.floor((Date.now()-Date.parse(z.date))/864e5)):9999)<=g).length;return[P(0),P(7),P(30),F.length]},[b,c,o]),j=m.useMemo(()=>c.day?y("win").filter(F=>(F.date||"").slice(0,10)===c.day).length:0,[b,c,o]),E=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,w=E+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!h&&!f)return;const F=g=>{var U,G;const z=g.target;h&&!((U=v.current)!=null&&U.contains(z))&&s(!1),f&&!((G=u.current)!=null&&G.contains(z))&&p(!1)},P=g=>{g.key==="Escape"&&(s(!1),p(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",P),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",P)}},[h,f]);const N=(F,P,g,z="fbtn")=>t.jsxs("button",{type:"button",className:z,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:P}),g>0&&t.jsx("span",{className:"n",children:g}),t.jsx("span",{className:"cv",children:"▾"})]},F),T=["1","7","30","all"],A=Math.max(0,T.indexOf(c.win||"all")),q=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(Sl(c.day,d))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:u,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>p(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:i.winMenu}),t.jsx("span",{className:"winpick-v",children:i.datesShort[A]}),t.jsx("b",{children:x[A]}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:T.map((F,P)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),p(!1)},children:[i.datesShort[P],t.jsx("span",{className:"n",children:x[P]})]},F))})]}):t.jsx("div",{className:"seg",children:T.map((F,P)=>t.jsxs("button",{type:"button","aria-pressed":c.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:i.dates[P]}),t.jsx("b",{children:x[P]})]},F))}),L=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:c.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),C=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,c.sector.length),N("pay",i.fCountry,c.country.length),N("det",i.fEngine,c.engine.length),N("sta",i.fStage,c.stage.length),o&&N("ang","Angle",c.angle.length),o&&N("mem","Mémo",c.memoLevel.length)]}),O=(F=!1)=>t.jsxs("div",{className:"frow2",children:[w>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(b.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(w)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),I=t.jsxs("div",{className:"fmenu",ref:v,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(E?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{s(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),E>0&&t.jsx("span",{className:"n",children:E}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:C})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:q}),t.jsxs("div",{className:"fstrip-b",children:[L,I,O(!1)]})]}),a.openFacet&&t.jsx(hr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[q,L,C,t.jsx("span",{className:"fgrow"}),O()]}),a.openFacet&&t.jsx(hr,{poolFor:y})]})}function hr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=_(),o=a.filters,l=a.openFacet,{title:d,cols:c,options:h}=m.useMemo(()=>{if(l==="sig"){const u=e("signal").filter(x=>Re(x)),b=new Map;u.forEach(x=>{const j=x.engine||"";b.set(j,(b.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:u.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Va([...b.keys()],i).map(x=>({v:x,label:jt(x)+" "+Ue(x,i),n:b.get(x)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(x)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const u=e("sector"),b=new Map;return u.forEach(y=>{y.sector&&b.set(y.sector,(b.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:y,n:x,html:!1,on:o.sector.includes(y)}))}}if(l==="pay"){const u=e("country"),b=new Map;return u.forEach(y=>{y.cc&&b.set(y.cc,(b.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:Pt(y,i)||y,n:x,html:!1,on:o.country.includes(y)}))}}if(l==="det"){const u=e("engine"),b=new Map;return u.forEach(y=>{y.engine&&b.set(y.engine,(b.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Va([...b.keys()],i).map(y=>({v:y,label:jt(y)+" "+Ue(y,i)+' <span style="color:var(--dim);font-size:10px">· '+Jo(Xo(y),i)+"</span>",n:b.get(y)||0,html:!0,on:o.engine.includes(y)}))}}if(l==="ang"){const u=e("angle"),b=new Map;return u.forEach(y=>{y.angle&&b.set(y.angle,(b.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((y,x)=>x[1]-y[1]).map(([y,x])=>({v:y,label:y.replace(/[_-]+/g," "),n:x,html:!1,on:o.angle.includes(y)}))}}if(l==="mem"){const u=e("memoLevel"),b=new Map;u.forEach(x=>{if(x.kind==="target"){const j=mn(x);b.set(j,(b.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(x=>({v:String(x),label:y[x],n:b.get(x)||0,html:!1,on:o.memoLevel.includes(x)}))}}const p=e("stage"),v=new Map;return p.forEach(u=>{u.stage&&v.set(u.stage,(v.get(u.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((u,b)=>b[1]-u[1]).map(([u,b])=>({v:u,label:u,n:b,html:!1,on:o.stage.includes(u)}))}},[l,a,i]),s=p=>{if(l==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const u=o.signalEngines.includes(p)?o.signalEngines.filter(b=>b!==p):[...o.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:u}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:p})},f=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:d}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:f,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:h.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function lo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:d}=_(),c=m.useMemo(()=>{const v={};return r.forEach(u=>{wa(u,n.filters,o)&&(v.monde=(v.monde||0)+1,u.continent&&(v[u.continent]=(v[u.continent]||0)+1))}),v},[r,n.filters,o]),[h,s]=m.useState(!1),f=m.useRef(null);m.useEffect(()=>{if(!h)return;const v=b=>{var y;(y=f.current)!=null&&y.contains(b.target)||s(!1)},u=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",v),document.addEventListener("keydown",u),()=>{document.removeEventListener("mousedown",v),document.removeEventListener("keydown",u)}},[h]);const p=v=>{const u=xn.find(b=>b.key===v);return v==="monde"?d.contWorld:l==="fr"?u.fr:u.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:f,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>s(v=>!v),children:[p(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Mn.map(v=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===v,onClick:()=>{i({type:"continent",key:v}),s(!1)},children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})]}):t.jsxs("div",{className:"conts",children:[Mn.map(v=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===v,onClick:()=>i({type:"continent",key:v}),children:[p(v),t.jsx("span",{className:"n",children:c[v]||0})]},v)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?d.showMap:d.hideMap})})]})}function co(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function El(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function gr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:d}=_();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(c.name),children:d.rsEvalOne})]},c.name))})]}):null}function po({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=_(),i=((e==null?void 0:e.companies_cited)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.what||"").trim(),line2:(d.role||"").trim(),chips:[(d.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(d=>d&&(d.name||"").trim()).map(d=>({name:(d.name||"").trim(),line1:(d.why||"").trim(),chips:[(d.country||"").trim(),(d.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(gr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(gr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Cl({card:e,onEvaluate:a,onAddAll:r}){var d,c,h;const{t:n}=_(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((d=e.prospective)==null?void 0:d.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:co(e.summary_md||"").map((s,f)=>t.jsx("p",{children:s},f))})]}),t.jsx(po,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function zl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Al({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=_(),d=i,[c,h]=m.useState(null),[s,f]=m.useState(null),[p,v]=m.useState(null),[u,b]=m.useState(!1);m.useEffect(()=>{let x=!0;return(async()=>{const j=await zr({email:l,cbToken:d});x&&h(j)})(),()=>{x=!1}},[l,d,n]);const y=x=>{f(x),v(null),b(!0),(async()=>{const j=await Zo(x.id);v(j),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{f(null),v(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(c||[]).map(x=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(x),children:[t.jsx("span",{className:"ti",children:x.title}),t.jsxs("span",{className:"me",children:[zl(x.created_at),x.industry?` · ${x.industry}`:"",x.author?` · ${x.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(x.cited_n||0,x.evaluate_n||0)}),t.jsx("span",{className:"st"+(x.published?" on":""),children:x.published?o.rsPub:o.rsPriv})]},x.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!u&&!p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!u&&p&&t.jsx(Cl,{card:p,onEvaluate:a,onAddAll:r})]})]})}const ga=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Gt(e){return/^https?:\/\//i.test((e||"").trim())}function at(e){const a=(e||"").trim();return a?Gt(a)?a:ga.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Tl(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Ll(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:d,evalCards:c,caps:h,data:s,canWrite:f,source:p,dossiers:v,doAnalyse:u,liveMemos:b,pipe:y}=_(),x=a==="client",j=m.useMemo(()=>r||(p!=="default"?ei():""),[r,p]),[E,w]=m.useState(""),[N,T]=m.useState(!1),[A,q]=m.useState(""),[L,C]=m.useState(""),[O,I]=m.useState(""),[F,P]=m.useState(!1),[g,z]=m.useState(!1),[U,G]=m.useState(""),[V,J]=m.useState(!1),[X,K]=m.useState(""),[le,ae]=m.useState([]),pe=m.useRef(!1),[H,ie]=m.useState(!1),[ee,qe]=m.useState(!1),[ke,se]=m.useState(!1),me=m.useRef(!1),[ce,Y]=m.useState(""),[Z,xe]=m.useState(""),[de,fe]=m.useState(!1),[he,ge]=m.useState(!1),[Le,ve]=m.useState(0),[Fe,Ze]=m.useState(""),[je,He]=m.useState(null),[Me,it]=m.useState(null),[pt,ft]=m.useState(!1),[et,xt]=m.useState(null),[ht,S]=m.useState(0),$=m.useRef(!1),W=E.trim()?ga.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,ne=m.useMemo(()=>U.split(`
`).map(R=>R.trim()).filter(Boolean).slice(0,15),[U]);m.useEffect(()=>{if(typeof window>"u")return;const R=new URLSearchParams(window.location.search),Q=(R.get("rs")||"").trim(),re=(R.get("rstext")||"").trim();Q&&/^https?:\/\//i.test(Q)&&Y(Q),re&&xe(re),(Q&&/^https?:\/\//i.test(Q)||re)&&ie(!0)},[]),m.useEffect(()=>{const R=Q=>{const re=Q.detail||{},k=String(re.url||"").trim(),D=String(re.text||"").trim();k&&/^https?:\/\//i.test(k)&&Y(k),D&&xe(D),(k&&/^https?:\/\//i.test(k)||D)&&(ie(!0),w(""),q(""),fe(!0),window.setTimeout(()=>fe(!1),900))};return window.addEventListener("ppmap:research",R),()=>window.removeEventListener("ppmap:research",R)},[]),m.useEffect(()=>{const R=Q=>{const re=Q.detail||{},k=String(re.name||"").trim();if(!k)return;ie(!1),w(k),q(k);const D=at(String(re.website||re.domain||""));C(D),I(at(String(re.url||""))),P(!D),T(!0),window.setTimeout(()=>T(!1),900)};return window.addEventListener("ppmap:prefill",R),()=>window.removeEventListener("ppmap:prefill",R)},[]),m.useEffect(()=>{const R=(A||"").trim();if(!R||H||L){(L||!R||H)&&P(!1);return}const Q=v.find(D=>Oe(D.name)===Oe(R)),re=at((Q==null?void 0:Q.website)||"")||at((Q==null?void 0:Q.domain)||"");if(re){C(re),P(!1);return}let k=!0;return P(!0),Ar(R).then(D=>{var B,te;if(!k)return;const M=at(D.website||"")||at(((te=(B=D.candidates)==null?void 0:B[0])==null?void 0:te.url)||"");M&&C(M)}).catch(()=>{}).finally(()=>{k&&P(!1)}),()=>{k=!1}},[A,H,L,v]),m.useEffect(()=>{const R=Q=>{var k;const re=String(((k=Q.detail)==null?void 0:k.url)||"").trim();Gt(re)&&window.open(re,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",R),()=>window.removeEventListener("ppmap:view",R)},[]),m.useEffect(()=>{if(me.current===H)return;me.current=H,se(!0);const R=window.setTimeout(()=>se(!1),560);return()=>window.clearTimeout(R)},[H]),m.useEffect(()=>{if(typeof window>"u")return;const R=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),Q=document.querySelector(".atl2.ops, .atl2.cibles");if(!R||!Q)return;const re=()=>Q.style.setProperty("--demand-h",`${R.offsetHeight}px`);re();const k=new ResizeObserver(re);return k.observe(R),()=>k.disconnect()},[p,N,de,g,H,ke,F]),m.useEffect(()=>{if(!f&&!j){xt(null);return}let R=!0;return(async()=>{const Q=await zr({email:n,cbToken:j});R&&xt(Q.length)})(),()=>{R=!1}},[f,j,n,ht]);const Ce=le.length?le:c,oe=s.credits,be=m.useCallback(R=>{const Q=R.map(re=>(re||"").trim()).filter(Boolean);Q.length&&(G(re=>{const k=re.split(`
`).map(B=>B.trim()).filter(Boolean),D=new Set(k.map(B=>B.toLowerCase())),M=Q.filter(B=>!D.has(B.toLowerCase()));return[...k,...M].slice(0,15).join(`
`)}),z(!0))},[]);m.useEffect(()=>{if(!he)return;ve(0);const R=window.setInterval(()=>ve(Q=>Q+1),1e3);return()=>window.clearInterval(R)},[he]);const Pe=m.useMemo(()=>{const R=E.trim().toLowerCase();return!R||!y?null:v.find(Q=>Oe(Q.name)===R&&ze(Q)===1)||null},[E,v,y]),st=()=>{const R=E.trim();if(R){if(Pe){u(Pe);return}i(null,R),x&&w("")}},At=async()=>{if(!x){i(null,ne[0]||"");return}if(!ne.length||V)return;J(!0),pe.current=!1;const R=[];for(let Q=0;Q<ne.length&&!pe.current;Q++){K(e.evaluating(Q+1,ne.length,ne[Q]));const re=await Tr(r,ne[Q],"atelier2");if(R.unshift({name:re.company||ne[Q],verdict:re.verdict,reason:re.reason||"",remaining:re.remaining??null}),ae([...R]),re.verdict==="quota"){R.unshift({name:"",verdict:"quota",reason:e.quota(ne.length-Q-1),remaining:0}),ae([...R]),G(ne.slice(Q+1).join(`
`)),K(""),J(!1);return}}K(""),G(pe.current?ne.slice(R.length).join(`
`):""),J(!1)},Tt=async()=>{var re,k,D;if($.current)return;const R=ce.trim().replace(/\s+/g,""),Q=Z.trim();if(!R&&!Q){Ze(e.rsNeed);return}if(!x&&!j){i(null,R||Q.slice(0,80));return}$.current=!0,Ze(""),He(null),it(null),ge(!0);try{const M=await ai({url:R,text:Q,email:n,cbToken:j});if(ge(!1),!M||M.status!=="success"){Ze((M==null?void 0:M.message)||"Erreur");return}He(M),ie(!1),be((((re=M.prospective)==null?void 0:re.companies_to_evaluate)||[]).map(te=>(te==null?void 0:te.name)||"")),it({state:"pending"});const B=await ni(M,{email:n,cbToken:j});it(B.ok?{state:"ok",scopeLabel:((k=B.summary)==null?void 0:k.scope_label)||"",scope:((D=B.summary)==null?void 0:D.scope)||""}:{state:"fail",msg:B.error||""}),B.ok&&S(te=>te+1)}finally{$.current=!1,ge(!1)}},gt=[je==null?void 0:je.industry,...(je==null?void 0:je.market_tags)||[],je==null?void 0:je.author].map(R=>(R||"").trim()).filter(Boolean),ut=(Me==null?void 0:Me.state)==="pending",Ve=Me&&(ut?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):Me.state==="ok"?t.jsx("span",{className:"rslink ok",children:Me.scope&&Me.scope!=="public"?e.rsSavedIn(Me.scopeLabel||Me.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:Me.msg,children:e.rsSaveFail})),Fa=El(je).length,Ie=H,bt=(A||E).trim(),Qe=v.find(R=>Oe(R.name)===Oe(bt)),Bt=at(E)||L||at((Qe==null?void 0:Qe.website)||"")||at((Qe==null?void 0:Qe.domain)||""),$t=O||at((Qe==null?void 0:Qe.url)||""),na=Pe?e.actAnalyse:bt?e.evalGoOn(bt.length>22?bt.slice(0,21)+"…":bt):e.evalGo,Ma=he?`${ti(ce.trim())==="youtube"&&ce.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Le)}`:ut?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Ie?" rs-mode":"")+(A&&E.trim()===A||N||de?" pair":"")+(N||de||ke?" echo":"")+(ke?" swap":""),children:[t.jsxs("div",{className:"drow"+((Ie?de:N)||ke?" flash":"")+((Ie?ce.trim():ga.test(E.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Ie?ce:E,placeholder:Ie?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Ie?600:200,spellCheck:Ie?!1:void 0,inputMode:Ie?"url":void 0,onChange:R=>{if(Ie){Y(R.target.value);return}w(R.target.value),A&&R.target.value.trim()!==A&&(q(""),C(""),I(""),P(!1))},onKeyDown:R=>{R.key==="Enter"&&(Ie?Tt():st())}}),t.jsx("span",{className:"detect"+(Ie?" off":"")+(ga.test(E.trim())?" url":""),children:W})]}),t.jsx("span",{className:"dacts",children:Ie?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(he?" loading":""),disabled:he||ut||!ce.trim()&&!Z.trim(),onClick:()=>{Tt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ma})]}),t.jsxs("a",{className:"viewbtn"+(Gt(ce)?"":" off"),href:Gt(ce)?ce.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:R=>{Gt(ce)||R.preventDefault()},children:[t.jsx(Tl,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Pe?" analyse":"")+(d?" loading":""),disabled:d,onClick:st,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:na})]}),t.jsxs("a",{className:"viewbtn sm"+(F?" searching":Bt?"":" off"),href:Bt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:R=>{Bt||R.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+($t?"":" off"),href:$t||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:R=>{$t||R.preventDefault()},children:e.viewSrc})]})}),h.showCredits&&oe&&t.jsxs("button",{type:"button",className:"credits"+(oe.total_available<=0&&!oe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:oe.unlimited?"∞":oe.total_available}),!oe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",oe.daily_grant+oe.purchased]}),oe.total_available<=0&&!oe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(R=>R.status==="boot"||R.status==="running").map(R=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:R.name}),t.jsx(Kt,{item:R,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+R.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>z(!g),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(H?" on":""),onClick:()=>ie(!H),children:e.rsOpen}),et!==null&&et>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(pt?" on":""),onClick:()=>ft(!pt),children:e.rsArchOpen(et)})]}),pt&&t.jsx(Al,{bump:ht,cbToken:j,onClose:()=>ft(!1),onEvaluate:R=>i(null,R),onAddAll:be}),t.jsx("div",{className:"rsp slim"+(H?" on":" off"),"aria-hidden":!H,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:H?void 0:-1,onClick:()=>qe(R=>!R),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:ee?"▴":"▾"})]}),ee&&t.jsx("textarea",{className:"rstext",value:Z,placeholder:e.rsTextPh,tabIndex:H?void 0:-1,onChange:R=>xe(R.target.value)})]})}),Fe&&t.jsx("div",{className:"rserr",children:Fe}),je&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:je.title}),je.source_url&&t.jsx("a",{href:je.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{He(null),it(null)},children:"×"})]}),je.market&&t.jsx("p",{className:"rsmk",children:je.market}),gt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),gt.map(R=>t.jsx("span",{children:R},R))]}),t.jsxs("div",{className:"rsbody",children:[je.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${je.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:co(je.summary_md||"").map((R,Q)=>t.jsx("p",{children:R},Q))})]}),t.jsx(po,{card:je,onEvaluate:R=>i(null,R),onAddAll:be}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Fa)}),Ve]})]}),g&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:U,placeholder:e.bulkPh,onChange:R=>G(R.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(V?" loading":""),style:{justifyContent:"center"},disabled:V||!ne.length,onClick:()=>{At()},children:[t.jsx("span",{className:"fill"}),V&&X?X:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(ne.length)})]})]}),Ce.slice(0,1).map((R,Q)=>{const re=R.verdict==="kept",k=R.verdict==="quota",D=re?"var(--brand)":k?"var(--bolt)":"var(--red)",M=re?"var(--brand-l)":k?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":D,"--bgc":M},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:re?"✓ "+e.kept:k?"⏳":"✗ "+e.dropped})}),R.name&&t.jsx("span",{className:"rn",children:R.name}),t.jsx("span",{className:"rr",children:R.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",R.reason]}):null}),!!(R.candidates&&R.candidates.length)&&t.jsx("span",{className:"sitepick",children:R.candidates.map(B=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:B.url.startsWith("http")?B.url:`https://${B.url}`,target:"_blank",rel:"nofollow noopener",children:[(B.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,B.url),children:e.evalPickGo})]},B.url))}),!k&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:re?1:5});const B=(R.name||"").trim().toLowerCase();window.setTimeout(()=>{const te=[...document.querySelectorAll(".atl2 .list .row")].find(Ne=>{var Se;return(((Se=Ne.querySelector(".rnm"))==null?void 0:Se.textContent)||"").trim().toLowerCase().includes(B)});te&&(te.scrollIntoView({behavior:"smooth",block:"center"}),te.classList.add("flashrow"),window.setTimeout(()=>te.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(re?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},Q)}),x&&(o.kept+o.dropped>0||Ce.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function ql(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Fl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=_(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",ql(o.summary||"")].filter(Boolean).join(`
...
`).map((h,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:h},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Mt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function wn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=_(),[l,d]=m.useState(!1),[c,h]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,f=async()=>{if(!s||l)return;d(!0);const p=await ri(r,e);if(d(!1),!p){o(a.actErr);return}h(p.results||[])};return m.useEffect(()=>{if(!s)return;const p=v=>{var b;const u=String(((b=v.detail)==null?void 0:b.name)||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&f()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,s]),m.useEffect(()=>{if(s)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),f())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{f()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Ml=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),fa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Rl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=fa(a.slice(n));break}r+=fa(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=fa(a.slice(i));break}const l=a.slice(i+1,o).trim(),d=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=d?d[2].toLowerCase():"";d&&Ml.has(c)?r+=`<${d[1]}${c}>`:r+=fa(a.slice(i,o+1)),n=o+1}return r}const br=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function De({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ol(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Dl({o:e}){const{t:a,doDeep:r}=_(),[n,i]=m.useState(!1),o=mt(e),l=[e.reasoning||"",Ol(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((d,c)=>t.jsx("p",{className:"cdtxt",children:d},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[Mt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:d=>{d.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:d=>{d.stopPropagation(),i(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:d=>d.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:d=>d.stopPropagation()})]})}function kn({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=_(),o=ta(e),l=mt(e),d=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,h=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),f=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(d?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:h},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Mt(e)?1:0}].filter(b=>b.n>0),[e,a,d,l,c,h,s]),[p,v]=m.useState("");if(!f.length)return null;const u=f.some(b=>b.k===p)?p:f[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:f.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":u===b.k,"data-tour":"tab-"+b.k,className:u===b.k?"on":"",onClick:y=>{y.stopPropagation(),v(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[u==="conv"&&t.jsxs(t.Fragment,{children:[d&&t.jsxs("div",{className:"cdv1"+(d==="NO MATCH"?" out":""),children:[t.jsx("b",{children:d==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(De,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(De,{k:a.cdVerdictDate,v:br(e.verdictDate,r)})]})]}),u==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Rl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Pl,{o:e})]}),u==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdSector,v:e.sector}),t.jsx(De,{k:a.cdStage,v:e.stage}),t.jsx(De,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(De,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(De,{k:a.cdAngle,v:e.angle}),t.jsx(De,{k:a.cdDetected,v:br(e.date,r)})]}),u==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdName,v:e.contactName}),t.jsx(De,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(De,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),u==="memo"&&t.jsx(Dl,{o:e}),u==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(De,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(De,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Pl({o:e}){const{t:a,token:r}=_(),[n,i]=m.useState(!1),[o,l]=m.useState(null),d=async()=>{n||(i(!0),l(await oi(r,e.name,e.website||e.domain||"")),i(!1))},c=(o==null?void 0:o.blocs)||{},h=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],s=h.some(([,f])=>f);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{d()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[h.filter(([,f])=>f).map(([f,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:f}),t.jsx("p",{children:p})]},f)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function aa({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const d=()=>{const h=Math.max(280,Math.min(560,o.clientWidth||320));Rn({kind:"op",card:e},h).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},c=window.requestAnimationFrame(d);return()=>{l=!0,window.cancelAnimationFrame(c),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Rn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&o.isConnected&&o.replaceChildren(c)});const d=c=>{c.key==="Escape"&&i(!1)};return document.addEventListener("keydown",d),()=>{l=!0,document.removeEventListener("keydown",d)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Il=`
...
`;function Bl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let d=e.y+10;return d+n>o-8&&(d=Math.max(8,e.y-n-14)),d<8&&(d=8),{left:l,top:d}}function $l(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:d,doAnalyse:c,doDecide:h,doPromote:s,doRepeche:f,doApproach:p,doDeep:v,doOnboard:u,outbound:b,evalBusy:y}=_(),x=e.popupId?r.get(e.popupId):null;if(!x)return null;const j=Re(x),E=ze(x),w=mt(x),N=ta(x),T=x.kind==="target",A=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return Dt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Il}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Bl(e.popupAnchor,!!x.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:x.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ct(x.date)),Ue(x.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[x.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[x.cc]}),children:(Pt(x.cc,i)||x.countryLabel||"").toUpperCase()}),x.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[x.sector]}),children:x.sector.toUpperCase()}),x.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[x.stage]}),children:x.stage.toUpperCase()}),typeof x.amountEur=="number"&&x.amountEur>0&&t.jsx("span",{className:"am2",children:It(x.amountEur,i)})]}),o.pipe&&T&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),x.ceoStatus&&t.jsx("span",{className:"pstep own",children:x.ceoStatus})]}),(x.tagline||x.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:x.tagline||x.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[jt(x.engine)," ",t.jsx("b",{children:Ue(x.engine,i)})," — ",ii(x.engine,i),x.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",x.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ct,{o:x,lg:!0})," ",t.jsx(qa,{o:x,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Lr(j,i))," · ",n.win7(qr(j,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),x.card?t.jsx(aa,{spec:x.card}):null,x.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:x.reasoning})]}),o.pipe&&T&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof x.score=="number"&&x.score>0?" · "+n.score(x.score):""]})}),o.pipe&&T&&t.jsx(kn,{o:x})]}),t.jsx(wn,{name:x.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(x,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{h(x,!1),a({type:"popup",id:null})},children:n.actNo}),Mt(x)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(x),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(x),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),x.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:x.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{u(x),a({type:"popup",id:null})},children:"🚀"})]}):x.engine==="media"&&x.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(x.name),onClick:()=>d(x),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>d(x),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(x.name.length>22?x.name.slice(0,21)+"…":x.name)," →"]}),x.website&&t.jsx("a",{className:"psite",href:x.website.startsWith("http")?x.website:"https://"+x.website,target:"_blank",rel:"noopener noreferrer",title:x.website,children:"🌐"})]})]})]}),document.body)}function _l(){const{lang:e,token:a,dossiers:r,caps:n}=_(),i=a||"home",{names:o,verdicts:l}=m.useMemo(()=>{const c=[],h={};return r.forEach(s=>{s.kind!=="target"||!s.name||(c.push(s.name),h[s.name]=si(s)||"")}),{names:c,verdicts:h}},[r]);return{diff:m.useMemo(()=>o.length?li(i,o,l,e):null,[i,o.length]),names:o,verdicts:l,scope:i,caps:n}}function Ul(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=_(),d=o.loading&&!l.length,c=m.useRef({});m.useEffect(()=>{c.current={...r}},[r]);const h=p=>{const v=c.current[p],u=v!==void 0?r[p]-v:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${Wa[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[r[p],u!==0&&t.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},p)},s=(p,v,u)=>t.jsxs("button",{type:"button",className:"off"+(v?" view":""),style:{"--c":`var(${Wa[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:u.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),f=(p,v,u,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:v,disabled:b,onClick:u,children:p},v);return t.jsxs("div",{className:"funnel"+(d?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(h)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[f("↩",n.toolUndo,i,e.undo.length===0),f("↺",n.toolReset,()=>{a({type:"reset"})}),f("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),f("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),f("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Hl(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=_(),d=m.useRef(null),[c,h]=m.useState(60);m.useEffect(()=>{let u=0;const b=()=>{var w;const y=d.current;if(!y)return;const x=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!x)return;const j=x.getBoundingClientRect(),E=y.getBoundingClientRect();h(Math.max(20,Math.min(j.left+j.width/2-E.left,E.width-30)))};return u=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(u),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let f=r.tuto[s].p;if(s===3){const u=n.filter(x=>x.kind==="target"&&ze(x)===3),b=u.filter(x=>Ya(x)==="auto").length,y=u.filter(x=>Ya(x)==="cd").length;f=r.tutoPending(b,y,u.length)}const p=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(u=>u.id)})};if(s===1){const u=n.filter(b=>b.kind==="target"&&ze(b)===1&&!i.has(b.id)).slice(0,10);if(u.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:u.map(b=>b.id)})}}return null})(),v=di(s);return t.jsxs("div",{ref:d,className:"tuto mini"+(v?"":" on-dark"),style:{"--bg":`var(${Wa[s]})`,"--ax":c+"px","--stc":v?"var(--ink)":"#fff","--stt":v?"#fff":"var(--ink)","--tc":v?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:f}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}const Ha=600,yt=62,vr="atl2:fstats";function Vl(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=_(),[l,d]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(vr)==="on"}catch{return!1}}),c=r.stats,h=m.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),s=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const f=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,p=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),v=h.reduce((N,T)=>Math.max(N,T.s||0),0),u=h.length?Ha/h.length:0,b=Math.max(4,u-4),y=h.length>=5&&v>0,x=r.marketEstimate||0,j=f(new Date().toISOString().slice(0,10)),E=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&s&&w.push({cle:"fenetre",periode:e.funPerWindow(f(s),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:E(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([T,A],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(T)}),t.jsx("i",{children:A})]},N.cle+A)),N.cle==="total"&&x>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(x),Math.min(100,Math.round((c.screened||0)/x*100)))})]}),N.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!l;d(T),T&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(vr,T?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},N.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ha} ${yt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[h.map((N,T)=>{const A=(N.s||0)/v*(yt-4),q=(N.m||0)/v*(yt-4),L=T*u+(u-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${f(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:L,y:yt-2-A,width:b,height:A,fill:"#cfe0d6"}),t.jsx("rect",{x:L,y:yt-2-q,width:b,height:q,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:yt-1.5,x2:Ha,y2:yt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:f(h[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const uo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function jn({o:e,locked:a=!1}){const{t:r}=_(),n=ta(e),i=mt(e),o=ze(e),l=Ya(e),d=ui(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(uo[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&d!==null&&t.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:r.waitTitle(d),children:r.waitChip(d)}),!a&&t.jsx(vs,{o:e})]})}const Et=e=>e.length>22?e.slice(0,21)+"…":e,ba=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function La(e){return ba.has(e.engine||"")}function wt(e){return!!e.noCo||La(e)&&!!e.url}function ea(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function mo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Wl({on:e,rev:a}){const[r,n]=m.useState(null),[i,o]=m.useState({top:0,left:0,width:0});return m.useEffect(()=>{if(!e){n(null);return}const l=()=>{var u,b,y;const d=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!d){n(null);return}const h=d.getBoundingClientRect(),s=c?c.getBoundingClientRect().bottom:h.top;o({top:Math.round(s),left:Math.round(h.left),width:Math.round(h.width)});const f=[...d.querySelectorAll(":scope .grp")];let p=null;for(const x of f){const j=x.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=s+2&&(p=x)}if(!p){n(null);return}const v=p.querySelector(".grp-h");if(!v){n(null);return}n({ic:(((u=v.querySelector(".ic"))==null?void 0:u.textContent)||"").trim(),t:(((b=v.querySelector(".t"))==null?void 0:b.textContent)||"").trim(),s:(((y=v.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||i.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:i.top,left:i.left,width:i.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Yl(e){const r=()=>{const n=mo(),i=e.getBoundingClientRect().top-n-8;Math.abs(i)<2||window.scrollBy({top:i,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function yr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=_(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),Be(e)){const h=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:h=>{h.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Et(e.name))})]})}function Nn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:d,doRepeche:c,doApproach:h,dispatch:s,liveMemos:f}=_(),p=u=>b=>{b.stopPropagation(),u()};if(r.lockActions){const u=p(()=>s({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const b=ze(e);return b===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:u,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Et(e.name))})]})}):b===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:u,children:a.actAnalyse})}):b===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:u,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:u,children:a.actNo})]})}):b===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actPromote})}):b===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:u,children:a.actApproach})}):b===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:u,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:u,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ea(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return La(e)&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{u.stopPropagation(),ea(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(yr,{o:e})});const v=ze(e);if(v===0)return t.jsx("span",{className:"cell",children:t.jsx(yr,{o:e})});if(v===1){const u=f.liveOf(e.name);if(u&&(u.status==="boot"||u.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Kt,{item:u,serverOff:f.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:p(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(v===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:p(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:p(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(v===4){const u=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:u,onClick:p(()=>h(e)),children:u?a.actApproachSent:a.actApproach})})}return v===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>d(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):v===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:p(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:p(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:p(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Gl({o:e}){const{t:a,doThumb:r,thumbOf:n}=_(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Kl({o:e}){const{lang:a}=_();return Re(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ct,{o:e}),t.jsx(qa,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[jt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function Ql({o:e,locked:a,open:r,onToggle:n,selected:i,echo:o,onSelect:l}){const{dispatch:d,caps:c,markRow:h,markedId:s,favIds:f,toggleFav:p,t:v}=_(),u=ze(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],y=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,x=y<=0?0:y<=7?1:y<=30?2:3,j=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:b[x],E=f.has(e.id),w=N=>{if(a)return;if(l){l(e.id);return}if(c.pipe||e.kind==="op"){n();return}const T=N.currentTarget.getBoundingClientRect();d({type:"popup",id:e.id,anchor:{x:T.left+Math.min(280,T.width/3),y:T.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(s===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(o?" echo":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>h(e.id),onMouseLeave:()=>h(null),onClick:w,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(bo,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:E?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),p(e)},children:E?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:v.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),d({type:"acquirer",value:e.acquirer||""})},children:["← ",Et(e.acquirer)]}),Xe(e)?t.jsx("span",{className:"rdec",title:v.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:v.zoomNewsMark,children:"📰"}):null]}),t.jsx(Jl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Kl,{o:e}),c.pipe&&t.jsx(jn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Nn,{o:e}),c.showThumbs&&t.jsx(Gl,{o:e})]}),r&&!a&&!l&&t.jsx(ed,{o:e})]})}function Jl({o:e}){const{lang:a,caps:r}=_();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=It(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Xl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=_(),l=(p,v=!1)=>u=>{u.stopPropagation(),v&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})},d=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),c=It(e.amountEur,r),h=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Be(e),f=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),h&&t.jsx("span",{children:h})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):wt(e)?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{p.stopPropagation(),ea(e)},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Et(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Et(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(aa,{spec:e.card})})]})}function Zl({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=_();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Ue(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Nn,{o:e})}),t.jsx(kn,{o:e})]})}function fo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:d,dossiers:c}=_(),h=m.useRef(null),s=Xe(e);if(m.useEffect(()=>{if(!s||!(e!=null&&e.decryptHtml))return;const g=h.current;if(!g)return;let z=!1;return pi(()=>import("./fit-BnaWm7z_.js"),[]).then(async U=>{await U.ensureEditoCss(),!(z||!g.isConnected)&&(U.beautifyEditoRows(g),U.mountCardFits(g))}),()=>{z=!0}},[s,e==null?void 0:e.decryptHtml]),!e&&!a){const g=c.find(Xe);if(g)return t.jsx(fo,{o:g})}const f=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),p=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),v=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||f,u=(e==null?void 0:e.card)||(a==null?void 0:a.card),b=e?!!e.noCo:!f||ya(f),y=(e==null?void 0:e.engine)||"",x=Xe(e),j=e?It(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(p);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(Xe),T=((N==null?void 0:N.url)||"").trim(),A=!!p&&!!T&&(p===T||p.endsWith(T)||T.endsWith(p)),q=(g,z=!1)=>U=>{U.stopPropagation(),z&&l({type:"continent",key:"monde"}),l({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const L=()=>{f&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:f}}))},C=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},O=()=>{ea({url:p,headline:v,tagline:e==null?void 0:e.tagline,name:f})},I=e?Be(e):!1,F=I&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",P=x?r.doEdito.replace(/^📖\s*/,""):y?Ue(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[P,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:v}),p&&!x&&(b||La({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:p,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:h,className:"ed-decrypt-b zoom-body"+(x?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),j&&t.jsx("span",{className:"oc-amt",children:j})]}),u&&t.jsx("div",{className:"zoom-card",children:t.jsx(aa,{spec:u})}),(p&&!A&&!x||N&&!x)&&t.jsxs("div",{className:"zoom-srcbox",children:[p&&!A&&!x&&t.jsxs("a",{className:"zoom-src",href:p,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),N&&!x&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),l({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[I?t.jsxs("span",{className:"verdict",style:{"--c":F?"var(--brand)":"var(--red)"},children:[F?"✓":"✗"," ",t.jsx("b",{children:F?r.kept:r.dropped})]}):!b&&f?t.jsxs("button",{type:"button",className:"zp-go",disabled:o,onClick:g=>{g.stopPropagation(),i(e,f)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Et(f))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,p&&!x&&(b||La({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!b&&f?" ghost":""),onClick:g=>{g.stopPropagation(),O()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!b&&f&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!d.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),C()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Et(f)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!b&&f&&d.pipe&&t.jsx(wn,{name:f})]})]})}function ed({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=_();return!i.pipe&&e.kind==="op"?t.jsx(Xl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(kn,{o:e}),t.jsx(ys,{o:e}),t.jsx(js,{o:e}),t.jsx(wn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:d=>{d.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(jn,{o:e})})]}),e.card&&t.jsx(aa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[jt(e.engine||"")," ",Ue(e.engine||"",r)]}),Re(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ct,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function td({o:e,locked:a,selected:r,onSelect:n}){const{t:i,dispatch:o,caps:l,doDecide:d,lang:c}=_();if(!l.pipe&&e.kind==="op"){const f=It(e.amountEur,c),p=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),v=(u,b=!1)=>y=>{y.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(aa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:v({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:v({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:v({stage:[e.stage]}),children:e.stage}),f&&t.jsx("span",{className:"damt",children:f})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[jt(e.engine||"")," ",Ue(e.engine||"",c)]}),Re(e)&&t.jsx(Ct,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(p?` · ${p}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Nn,{o:e})})]})}const h=ze(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][h];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":s},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(jn,{o:e}),Re(e)&&t.jsx(Ct,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&h===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>d(e,!0),children:i.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>d(e,!1),children:i.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>o({type:"memoConsole",id:e.id}),children:[i.actMemo," →"]})]})}function ad(){const{t:e}=_(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function nd({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=_(),o=i==="en",l=s=>n.plabels[s]||"",d=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),c=d.includes(0)?0:d.sort((s,f)=>(e[f]||0)-(e[s]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const h=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?o?`${h} ${h>1?"files are":"file is"} waiting for your screening`:`${h} dossier${h>1?"s":""} attende${h>1?"nt":""} votre évaluation`:o?`${h} ${h>1?"files":"file"} in “${l(c)}”`:`${h} dossier${h>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(o?"Open ":"Ouvrir ")+l(c)," →"]})]})}function rd(){var pt,ft,et,xt,ht;const e=_(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:d,markRow:c,lang:h,sessTally:s,data:f,dossiers:p,source:v,focusExtra:u,byId:b,token:y}=e,x=Or(),j=m.useMemo(()=>{var W,ne,Ce,oe;if(!y||v==="ops")return null;const S=(((W=x==null?void 0:x.ed)==null?void 0:W.date)||(x==null?void 0:x.day)||"").slice(0,10),$=[(ne=x==null?void 0:x.ed)==null?void 0:ne.html,(Ce=x==null?void 0:x.ed)==null?void 0:Ce.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:h==="en"?"Today's brief":"Brief du jour",headline:h==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((oe=x==null?void 0:x.ed)==null?void 0:oe.date)||S,decryptHtml:$||void 0,date:S,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,v,h,(pt=x==null?void 0:x.ed)==null?void 0:pt.html,(ft=x==null?void 0:x.ed)==null?void 0:ft.acquirers_html,(et=x==null?void 0:x.ed)==null?void 0:et.date,x==null?void 0:x.day]),E=S=>i.lockRowsAfter!==null||v==="ops"?Number.MAX_SAFE_INTEGER:Mr,[w,N]=m.useState(new Set);m.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[T,A]=m.useState(null);m.useEffect(()=>{A(null)},[a.ptab,a.continent]);const[q,L]=m.useState(!a.mapFolded);m.useEffect(()=>{if(a.mapFolded){L(!1);return}const S=document.getElementById("atl2-stage");if(!S){L(!1);return}const $=new IntersectionObserver(([W])=>L(!!W&&W.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return $.observe(S),()=>$.disconnect()},[a.mapFolded]);const C=a.mapFolded||!q,O=S=>N($=>{const W=new Set($);return W.has(S)?W.delete(S):W.add(S),W}),I=v==="ops"||i.pipe,[F,P]=m.useState("all"),[g,z]=m.useState(null),[U,G]=m.useState(!1),V=m.useRef(!0);m.useEffect(()=>{if(V.current){V.current=!1;return}P("all"),G(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!U)return;const S=$=>{var W,ne;(ne=(W=$.target)==null?void 0:W.closest)!=null&&ne.call(W,".atl2 .doable")||G(!1)};return document.addEventListener("click",S),()=>document.removeEventListener("click",S)},[U]);const J=m.useMemo(()=>{var $;const S=new Map;for(const W of ss((($=x==null?void 0:x.ed)==null?void 0:$.html)||""))S.has(W.t)||S.set(W.t,W.html);return S},[(xt=x==null?void 0:x.ed)==null?void 0:xt.html]),X=m.useCallback(S=>{if(S.decryptHtml)return S.decryptHtml;if(!J.size)return;const $=(S.name||"").trim().toLowerCase();if($.length<3)return;const W=J.get($);if(W)return W;for(const[ne,Ce]of J)if(ne.includes($)||$.includes(ne))return Ce},[J]),{diff:K}=_l(),[le,ae]=m.useState(!1),[pe,H]=m.useState(!1),ie=m.useMemo(()=>new Set(((K==null?void 0:K.added)||[]).map(S=>S.trim().toLowerCase()).filter(Boolean)),[K]),ee=m.useMemo(()=>{const S=pe&&ie.size?d:l;let $=hn(S,a.sort);return $=$.filter(W=>!Xe(W)),pe&&ie.size&&($=$.filter(W=>ie.has((W.name||"").trim().toLowerCase()))),F==="explore"?$=$.filter(wt):F==="eval"&&($=$.filter(W=>!wt(W)&&!W.noCo)),$},[l,d,a.sort,F,pe,ie]),ke=m.useMemo(()=>i.pipe?d.filter(S=>Re(S)&&ci(S)):ee.filter(S=>Re(S)&&!Be(S)),[i.pipe,d,ee]).length,se=m.useMemo(()=>i.pipe?ee:ee.filter(S=>!Be(S)&&!S.noCo),[ee,i.pipe]),me=v==="ops"?ee.filter(wt).length:0,ce=pe?n.sinceDock(ee.length):i.pipe?n.plabels[a.ptab].toLowerCase():v==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,Y=a.filters,Z=[];if(Y.day)Z.push({k:"day",lib:n.fDay(Y.day.slice(8,10)+"/"+Y.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(Y.win&&Y.win!=="all"){const S=["1","7","30"].indexOf(Y.win);S>=0&&Z.push({k:"win",lib:n.dates[S],off:()=>r({type:"filters",patch:{win:"all"}})})}const xe=S=>S.length<=2?S.join(", "):`${S.length} ${n.fSelected}`;for(const S of["sector","country","engine"]){const $=Y[S];$&&$.length&&Z.push({k:S,lib:xe($),off:()=>r({type:"clearFacet",facet:S})})}Y.search&&Z.push({k:"search",lib:"🔍 "+Y.search,off:()=>r({type:"filters",patch:{search:""}})}),pe&&ie.size&&Z.push({k:"since",lib:"✨ "+n.sinceDock(ie.size),off:()=>H(!1)}),Y.signalOnly&&Z.push({k:"sig",lib:"🔴 "+n.sigDock(ke||Y.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const de=(S,$,W="",ne=!1)=>t.jsxs("button",{type:"button","data-s":S,className:W,"aria-sort":a.sort.key===S?a.sort.dir===1?"ascending":"descending":"none",style:ne?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:S}),children:[$,t.jsx("span",{className:"ar",children:a.sort.key===S&&a.sort.dir===1?"▴":"▾"})]},S),fe=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const S=new Map;ee.forEach(ne=>{const Ce=ne.engine||"?";S.has(Ce)||S.set(Ce,[]),S.get(Ce).push(ne)});const $={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},W=Va([...S.keys()],h);return[...S.entries()].sort((ne,Ce)=>{const oe=$[ne[0]]??10+W.indexOf(ne[0]),be=$[Ce[0]]??10+W.indexOf(Ce[0]);return oe-be})},[ee,i.pipe,a.groupBy,h]),he=fe?fe.filter(([S])=>ba.has(S)).length:0,ge=(()=>{var $;return(($=(fe?fe.flatMap(([,W])=>W):ee)[0])==null?void 0:$.id)??null})(),Le=m.useRef(!1),ve=m.useMemo(()=>p.find(Xe)||j,[p,j]);m.useEffect(()=>{const S=()=>{Le.current=!0};return window.addEventListener("ppmap:reveal",S),window.addEventListener("ppmap:focus",S),()=>{window.removeEventListener("ppmap:reveal",S),window.removeEventListener("ppmap:focus",S)}},[]),m.useEffect(()=>{const S=()=>{ve&&r({type:"focus",id:ve.id})};return window.addEventListener("ppmap:edito",S),()=>window.removeEventListener("ppmap:edito",S)},[ve,r]),m.useEffect(()=>{if(!a.focusId)return;z(a.focusId);const S=window.setTimeout(()=>z(null),900);return()=>window.clearTimeout(S)},[a.focusId]),m.useEffect(()=>{if(I&&!(a.focusId&&(ee.some(S=>S.id===a.focusId)||p.some(S=>S.id===a.focusId)||a.focusId===(ve==null?void 0:ve.id)))&&!u){if(ve){r({type:"focus",id:ve.id});return}ge&&r({type:"focus",id:ge})}},[I,a.focusId,ee,ge,u,r,p,v,ve]),m.useEffect(()=>{if(!(!I||!a.focusId)&&F!=="all"&&!(ve&&a.focusId===ve.id)&&!ee.some(S=>S.id===a.focusId)&&p.some(S=>S.id===a.focusId)){if(Le.current){P("all");return}ge&&r({type:"focus",id:ge})}},[I,a.focusId,F,ee,p,ge,r]),m.useEffect(()=>{if(!I||!a.focusId||!Le.current)return;const S=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!S)return;Le.current=!1;const $=mo(),W=S.getBoundingClientRect();W.top>=$-2&&W.bottom<=window.innerHeight-4||Yl(S)},[I,a.focusId,a.ptab,ee]),m.useEffect(()=>{if(typeof window>"u")return;const S=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),$=document.querySelector(".atl2.ops, .atl2.cibles");if(!S||!$)return;const W=()=>$.style.setProperty("--listhead-h",`${S.offsetHeight}px`);W();const ne=new ResizeObserver(W);return ne.observe(S),()=>ne.disconnect()},[C,a.dens,a.mapFolded]);const Fe=m.useMemo(()=>{if(!I||!a.focusId)return null;if(j&&a.focusId===j.id)return j;const S=ee.find(W=>W.id===a.focusId)||p.find(W=>W.id===a.focusId)||null;if(!S)return null;const $=X(S);return $&&$!==S.decryptHtml?{...S,decryptHtml:$}:S},[I,a.focusId,ee,p,X,j]),Ze=i.lockRowsAfter;let je=0;const He=(S,$)=>{let W=a.shown[$]||E();return S.length-W<=4&&(W=S.length),S.slice(0,W).map(oe=>{const be=Ze!==null&&je>=Ze;je++;const Pe=X(oe),st=Pe&&Pe!==oe.decryptHtml?{...oe,decryptHtml:Pe}:oe,At=!I&&a.dens!=="maxi"&&(a.dens==="deplie"||(T?T==="open":!!Pe)),Tt=w.has(oe.id)?!At:At,gt=I?ut=>{Le.current=!0,r({type:"focus",id:ut});const Ve=b.get(ut);Ve&&(wt(Ve)?ea(Ve):Ve.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ve.name,url:Ve.url||"",website:Ve.website||"",domain:Ve.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(td,{o:st,locked:be,selected:I&&a.focusId===oe.id,onSelect:gt},oe.id):t.jsx(Ql,{o:st,locked:be,open:Tt,onToggle:()=>O(oe.id),selected:I&&a.focusId===oe.id,echo:g===oe.id,onSelect:gt},oe.id)})},Me="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(v==="ops"?" opsl":"")+(ee.length?"":" list-empty"),it=t.jsxs(t.Fragment,{children:[fe?fe.map(([S,$])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:jt(S)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:S==="ma"?n.grpMa:S==="fundraising"?n.grpLev:ba.has(S)&&he<=1?n.grpNews:S==="nominations"?n.grpNom:S==="media"?n.grpNewsOther:S==="recrutements"?n.grpHire:ba.has(S)?n.grpNews+" · "+Ue(S,h):Ue(S,h)}),t.jsx("div",{className:"s",children:n.grpCount($.filter(W=>!Be(W)).length,$.length)})]})]}),He($,S)]},S)):He(ee,"pt"+a.ptab),f.loading&&!p.length&&t.jsx(ad,{}),!ee.length&&!(f.loading&&!p.length)&&(i.pipe?t.jsx(nd,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(C?" mapoff":""),children:[i.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(le?" on":""),"aria-expanded":le,onClick:()=>ae(S=>!S),children:["📊 ",n.morningDock(typeof((ht=f.stats)==null?void 0:ht.screened_today)=="number"?f.stats.screened_today:0)]}),K&&!K.firstVisit&&(K.added.length>0||K.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(pe?" on":""),"aria-pressed":pe,title:n.sinceSub,onClick:()=>H(S=>!S),children:["✨ ",n.sinceDock(K.added.length)]}),ke>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[]}}),children:["🔴 ",n.sigDock(ke)]})]}),i.showFunnel&&le&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(Ss,{}),t.jsx(Vl,{})]}),i.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Ul,{}),t.jsx(Hl,{})]}),t.jsxs("div",{className:"lh-top",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:ee.length})," ",ce]}),t.jsx("span",{className:"dot",children:"·"}),C&&t.jsx(lo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[C?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),Z.map(S=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:$=>{$.stopPropagation(),S.off()},children:[S.lib,t.jsx("i",{children:"×"})]},S.k)),v==="ops"&&ee.length>0&&!C&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ee.length-me," ",n.zoomPulseEval,me>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",me," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(i.showFunnel||v==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([S,$])=>t.jsxs("button",{type:"button","data-d":S,"aria-pressed":a.dens===S||S==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:S}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:$})]},S))}),!I&&i.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":T==="open",onClick:()=>{A("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":T==="closed",onClick:()=>{A("closed"),N(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||v==="ops")&&(()=>{var oe;const S=l.filter(be=>!Xe(be)),$=S.filter(be=>!wt(be)&&!be.noCo).length,W=S.filter(wt).length,ne=[["all",n.doAll],["eval",`${n.doEval}${$?` ${$}`:""}`],["explore",`${n.doExplore}${W?` ${W}`:""}`]],Ce=((oe=ne.find(([be])=>be===F))==null?void 0:oe[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":U,onClick:()=>G(be=>!be),children:[Ce,t.jsx("i",{children:"▾"})]}),U&&t.jsx("div",{className:"dolist",children:ne.map(([be,Pe])=>t.jsx("button",{type:"button","aria-pressed":F===be,onClick:()=>{P(be),G(!1)},children:Pe},be))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:S=>r({type:"sort",key:S.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([S,$])=>t.jsx("option",{value:S,children:$},S))})]}),i.showChain&&se.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:se.map(S=>S.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(se.length):n.chainAll(se.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]}),C&&t.jsx("div",{className:"lh-tools",children:t.jsx(so,{compact:!0})})]}),a.dens!=="maxi"&&!I&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),de("country",n.colCountry),de("name",n.colCompany),de("amount",n.colAmount,"h-amt",!0),de("stage",n.colStage,"h-stade"),de("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[de("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),de("memo",n.colMemo)]}),i.pipe&&de("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),I?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),de("country",n.colCountry),de("name",n.colCompany),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[de("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),de("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Me,children:it})]}),t.jsxs("aside",{className:"readpane"+((Fe?Xe(Fe):!u&&ve)?" is-edito":""),"aria-label":h==="fr"?"Dossier":"File",children:[ve&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===ve.id,onClick:()=>r({type:"focus",id:ve.id}),children:n.doEdito}),j&&a.focusId===j.id?t.jsx("div",{className:"zoom",children:t.jsx(cs,{})}):Fe&&i.pipe?t.jsx(Zl,{o:Fe}):t.jsx(fo,{o:Fe,extra:Fe?null:u})]})]}):t.jsx("div",{className:Me,children:it}),(()=>{const S=fe||[["pt"+a.ptab,ee]];let $=0,W=0;for(const[Ce,oe]of S){W+=oe.length;let be=a.shown[Ce]||E();oe.length-be<=4&&(be=oe.length),$+=Math.min(oe.length,be)}const ne=W-$;return ne<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>S.forEach(([Ce,oe])=>r({type:"more",group:Ce,by:oe.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(ne,ne)}),t.jsx("span",{className:"more-meta",children:n.moreMeta($,W)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}}),I&&v==="ops"&&a.dens!=="maxi"&&t.jsx(Wl,{on:!!fe,rev:(fe||[]).map(([S,$])=>S+$.length).join("|")})]})}function wr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function od(e,a){const r=mi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function id(e,a){const n=[a.head.split("|").map(wr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",od(i,a.plabels),ta(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(wr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function sd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const ld=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function nt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function dd({o:e,qa:a}){const{t:r,lang:n,fund:i}=_(),o=(e.cribleStatus||"").trim().toUpperCase()||(ta(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=mt(e),d=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,d.value_prop],[r.qaProduct,d.produit],[r.qaModel,d.modele],[r.qaSummary,d.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(nt,{k:r.cdSector,v:e.sector}),t.jsx(nt,{k:r.cdStage,v:e.stage}),t.jsx(nt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(nt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(nt,{k:r.cdName,v:e.contactName}),t.jsx(nt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(nt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(nt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(nt,{k:r.cdAngle,v:e.angle}),t.jsx(nt,{k:r.cdDetected,v:ld(e.date,n)})]}),c.some(([,h])=>h)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,h])=>h).map(([h,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:h}),t.jsx("p",{children:s})]},h))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function cd(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=_(),[d,c]=m.useState({}),h=25,s=m.useMemo(()=>n.slice(0,h),[n]);m.useEffect(()=>{s.length&&fi(r,s.map(v=>v.name)).then(c)},[r,s]);const f=o.stats,p=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>h&&t.jsx("span",{className:"mnote dim",children:e.dsCap(h,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),f&&typeof f.screened=="number"&&t.jsxs("p",{children:[p(f.screened)," ",e.funScreened(""),typeof f.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(f.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(o.marketEstimate)),", ",Math.round(f.screened/o.marketEstimate*100)," %"]})]})]}),s.map(v=>t.jsx(dd,{o:v,qa:d[v.name]},v.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const pd=50;function Sn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=_(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[h,s]=m.useState(""),[f,p]=m.useState(0),[v,u]=m.useState(""),[b,y]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>()=>{x.current&&window.clearInterval(x.current)},[]);const j=async w=>{c(!0),s("");const N=await a();if(c(!1),N.ok){l(N);return}if(N.busy){s(i.alertPreviewBusy);return}if(!w){s(i.alertPreviewFail);return}p(pd),x.current=window.setInterval(()=>{p(T=>T>1?T-1:(x.current&&window.clearInterval(x.current),j(!1),0))},1e3)},E=async()=>{if(n||b)return;y(!0),u("");const w=await r();y(!1),u(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||f>0,onClick:()=>{j(!0)},children:d?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{E()},children:b?"…":i.alertTest})]}),f>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(f)}),h&&t.jsx("p",{className:"mnote warn",children:h}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const Ft="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function $e({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=_();return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function ud(){const{st:e}=_();switch(e.modal){case"chain":return t.jsx(fd,{});case"space":return t.jsx(xd,{});case"alert":return t.jsx(hd,{});case"queue":return t.jsx(wd,{});case"export":return t.jsx(kd,{});case"plug":return t.jsx(Sd,{});case"recharge":return t.jsx(Cd,{});case"cover":return t.jsx(Ad,{});case"dossier":return t.jsx(zd,{});case"crit":return t.jsx(Td,{});case"tuto":return t.jsx(Ld,{});case"rdv":return t.jsx(md,{});case"memoalert":return t.jsx(jd,{});default:return null}}function md(){const{dispatch:e,fund:a,t:r}=_(),n=a||r.rdvCoFallback;return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Ir,children:bn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${ka}`,children:ka})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Pi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function fd(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:d,caps:c,memoQueued:h,doAnalyse:s}=_(),f=o==="client",p=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),v=e.chain.idx,u=p[v],b=v>=p.length;return Dt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${v+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:v/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!u?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:u.name}),t.jsx("div",{className:"sub",children:[Pt(u.cc,i)||u.countryLabel,u.sector,u.stage,n.daysAgo(ct(u.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(u.engine,i).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{children:It(u.amountEur,i)})]}),Re(u)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ct,{o:u,lg:!0})," ",t.jsx(qa,{o:u,src:!0})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),f&&Be(u)&&t.jsxs("div",{className:"vbox",style:{"--c":kt(u)==="retenu"?"var(--brand)":kt(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:kt(u)==="retenu"?"✓ "+n.kept:kt(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&u&&c.pipe&&ze(u)===1&&!h.has(u.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(u),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&u&&!(f&&Be(u))&&(u.noCo&&u.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:d,onClick:()=>{l(u)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function xd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=_(),o=i==="client",l=m.useMemo(()=>o?r.filter(f=>Be(f)):[],[r,o]),d=m.useMemo(()=>hn(l.filter(f=>kt(f)==="retenu"),{key:"signal",dir:-1}),[l]),c=m.useMemo(()=>l.filter(f=>kt(f)==="ecarte"),[l]),h=e.spaceTab==="retenu"?d:c,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs($e,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:d.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),h.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),h.slice(0,40).map(f=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof f.score=="number"&&f.score>0?f.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:f.name}),t.jsx("div",{className:"rr",children:f.reasoning||f.tagline||""})]})]},f.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function hd(){const{mode:e}=_();return e==="client"||e==="apercu"?t.jsx(gd,{}):t.jsx(yd,{})}function gd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=_(),[o,l]=m.useState("d"),d=i!=="client";return t.jsxs($e,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(bd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="w"&&t.jsx(vd,{t:e,token:a,readOnly:d,flash:r,flashErr:n}),o==="m"&&t.jsx(xo,{})]})}function bd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[h,s]=m.useState(0);m.useEffect(()=>{let u=!0;return c(!1),Pn(a).then(b=>{u&&(b?l(b):c(!0))}),()=>{u=!1}},[a,h]);const f=u=>{r||Pn(a,u).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=u=>!o.sections||o.sections.includes(u),v=u=>{const b=o.sections||e.alertSec.map(([y])=>y);f({sections:p(u)?b.filter(y=>y!==u):[...b,u]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>f({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([u,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:p(u),disabled:r,onChange:()=>v(u)}),t.jsxs("span",{children:[b,u==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},u))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Sn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ni(a),onTest:()=>ji(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function vd({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[d,c]=m.useState(!1),[h,s]=m.useState(0);m.useEffect(()=>{let u=!0;return c(!1),In(a).then(b=>{u&&(b?l(b):c(!0))}),()=>{u=!1}},[a,h]);const f=u=>{r||In(a,u).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(d)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=o.dow??0,v=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>f({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:u=>f({dow:Number(u.target.value)}),children:e.alertDow.map((u,b)=>t.jsx("option",{value:b,children:u},u))}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>f({hour:Math.min(21,v+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Sn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Ei(a),onTest:()=>Si(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function xo(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=_(),[l,d]=m.useState(o||""),[c,h]=m.useState(!1),[s,f]=m.useState(!1);m.useEffect(()=>{o&&d(o)},[o]);const p=e.filters,v=m.useMemo(()=>n.filter(x=>Re(x)).length,[n]),u=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){f(!0);try{await fetch(`${un}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:p.sector,countries:p.country,source:o?"atelier2-client":"atelier2",website:""})}),h(!0)}finally{f(!1)}}},y=[[a.amRows.continent,i],[a.amRows.since,a.amSince[u]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(x=>Ue(x,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(x=>Pt(x,r)||x).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([x,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:x}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},x))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:x=>d(x.target.value),onKeyDown:x=>{x.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function yd(){const{t:e}=_();return t.jsx($e,{title:e.alertTitle,icon:"🔔",children:t.jsx(xo,{})})}function wd(){var q,L;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:d,dispatch:c,liveMemos:h}=_(),[s,f]=m.useState(null),[p,v]=m.useState([]),[u,b]=m.useState(0),y=n==="client",x=m.useMemo(()=>{const C=new Map;return i.forEach(O=>{const I=(O.name||"").trim().toLowerCase();I&&!C.has(I)&&C.set(I,O)}),C},[i]);m.useEffect(()=>{let C=!0;return(async()=>{const[O,I]=await Promise.all([fn(r),Cr(a)]);C&&(O&&f(O),v(I))})(),()=>{C=!1}},[a,r,u]);const j=(s==null?void 0:s.per_day)??0,E=((q=s==null?void 0:s.analyzed_today)==null?void 0:q.length)??0,w=s==null?void 0:s.offre,N=(s==null?void 0:s.pool_meta)||[],T=m.useMemo(()=>{const C=new Map;for(const O of(s==null?void 0:s.scheduled)||[])for(const I of O.names||[])C.has(I)||C.set(I,{label:O.day_label,date:O.date});return C},[s==null?void 0:s.scheduled]),A=(s==null?void 0:s.in_progress)||[];return t.jsxs($e,{title:e.queueTitle,wide:!0,children:[w&&t.jsxs("div",{className:"qoffre"+(w.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:w.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:w.delai})]}),t.jsx("span",{className:"osp"}),w.rythme>0?t.jsx("span",{className:"or",children:e.qRate(w.rythme)}):w.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(w.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((L=s==null?void 0:s.pool_order)==null?void 0:L.length)??0))}})}),w&&t.jsxs("div",{className:"qeta",children:[w.file===0?e.qEtaDone:w.rythme<=0?e.qEtaPaused:e.qEta(w.file,w.rythme,w.jours_restants),w.en_retard&&t.jsxs("em",{children:[" ",e.qLate(w.delai,w.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(w==null?void 0:w.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(A.length>0||h.items.some(C=>C.status==="boot"||C.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[h.items.filter(C=>C.status==="boot"||C.status==="running"||C.status==="error").map(C=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:C.name}),t.jsx("span",{className:"qd",children:C.memoType||""}),t.jsx(Kt,{item:C,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+C.name)),A.filter(C=>!h.liveOf(C.name)).map(C=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:C.name}),t.jsxs("span",{className:"qd",children:[C.memo_type||"",C.age_min?` · ${Math.round(C.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:C.state||""})]},"ip-"+C.name))]})]}),p.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:p.map(C=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:C.company}),t.jsxs("span",{className:"qd",children:[C.memo_type,typeof C.est_min=="number"?` · ~${C.est_min} min`:""]}),t.jsx("span",{className:"qt",children:C.status}),C.url&&t.jsx("a",{className:"qgo",href:C.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),y&&C.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Dn(a,C.company,"retry").then(()=>b(O=>O+1))},children:e.queueRetry}),y&&C.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Dn(a,C.company,"delete").then(()=>b(O=>O+1))},children:e.queueDelete})]},C.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(N.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[N.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),N.map((C,O)=>{const I=T.get(C.name),F=x.get((C.name||"").trim().toLowerCase()),P=h.liveOf(C.name),g=!!(F&&l.has(F.id))||!!(P&&(P.status==="boot"||P.status==="running")),z=!!(F&&ze(F)===1&&!F.memoUrl)&&!P;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",O+1]}),I?t.jsx("span",{className:"qwhen"+(I.label==="demain"?" soon":""),children:I.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:C.name}),C.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof C.score=="number"&&t.jsx("span",{className:"qs2",children:C.score}),P&&(P.status==="boot"||P.status==="running")&&t.jsx(Kt,{item:P,serverOff:h.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),z&&(d.lockActions||!y?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:g,onClick:()=>{o(F),b(U=>U+1)},children:g?e.actAnalyseQueued:e.actAnalyse})),C.excerpt&&t.jsx("span",{className:"qex",children:C.excerpt})]},C.name+":"+O)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([C,O])=>t.jsxs("li",{children:[t.jsx("b",{children:C})," — ",O]},C))})]})}function kd(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=_(),d=`${Ft}/cibles/list.csv?token=${a}`,c=`${Ft}/cibles/list.json?token=${a}`,h=`${Ft}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${d}")`,f=y=>{var x;(x=navigator.clipboard)==null||x.writeText(y).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:d,href:d},{def:e.exportSheet,value:s},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:h,href:h}],v=!i.lockActions&&n.length>0,u=()=>{sd(id(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:y=>(e.stg.find(([x])=>x===y)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs($e,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:u,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:y,value:x,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>f(x),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function jd(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=_(),o=i!=="client",[l,d]=m.useState(null),[c,h]=m.useState(!1),[s,f]=m.useState(0),[p,v]=m.useState(!1);m.useEffect(()=>{let x=!0;return h(!1),On(a).then(j=>{x&&(j?d(j):h(!0))}),()=>{x=!1}},[a,s]);const u=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=x=>{if(o||!l)return;const j={enabled:x.enabled??!!l.enabled,email:x.email??(l.email||""),sections:x.sections??u()};v(!0),On(a,j).then(E=>{if(v(!1),!E){n(e.memoAlertErr);return}d(E),r(e.memoAlertSaved)})};if(c)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(x=>x+1),children:e.retry})]})});if(!l)return t.jsx($e,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=u();return t.jsxs($e,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||p,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Nd,{value:l.email||"",readOnly:o||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:x=>b({email:x})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([x,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[x],disabled:o||p,onChange:()=>b({sections:{...y,[x]:!y[x]}})}),t.jsx("span",{children:j})]},x))}),t.jsx(Sn,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>hi(a,y),onTest:()=>xi(a,y)})]})}function Nd({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const d=o.trim()!==e.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:h=>l(h.target.value),onKeyDown:h=>{h.key==="Enter"&&d&&c&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!d||!c,onClick:()=>i(o.trim()),children:n})]})]})}function Sd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=_(),[o,l]=m.useState(null),[d,c]=m.useState(!1),[h,s]=m.useState(null),[f,p]=m.useState(""),[v,u]=m.useState(0);m.useEffect(()=>{let E=!0;return c(!1),Ga(a).then(w=>{E&&(w?l({configured:w.configured,url_hint:w.url_hint}):c(!0))}),vi(a).then(w=>{E&&s(w)}),()=>{E=!1}},[a,v]);const b=(E,w)=>{i&&Ga(a,E).then(N=>{if(!N||N.ok===!1){n(e.actErr);return}E.test&&N.sent===!1?n(e.plugTestThrottled):r(w),u(T=>T+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',x=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${Ft}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs($e,{title:e.plugTitle,icon:"🔌",wide:!0,children:[h&&t.jsx("p",{className:"mnote"+(h.enabled?" warn":""),children:h.enabled?e.plugAutoOn(h.destination||"webhook"):e.plugAutoOff}),d?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>u(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:f,disabled:!i,onChange:E=>p(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!f.trim(),onClick:()=>b({url:f.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:x}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(x).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Ed,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Ed(){const{t:e,token:a,lang:r}=_(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[d,c]=m.useState(null),[h,s]=m.useState(null),[f,p]=m.useState(!1),[v,u]=m.useState(!1),[b,y]=m.useState(null),[x,j]=m.useState(null),[E,w]=m.useState(null),N=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Ga(a).then(I=>{j(I&&I.configured?I.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{c(null),s(null),p(!1),y(null);try{const I=JSON.parse(localStorage.getItem(N)||"null");w(I&&Date.now()-Date.parse(I.t)<24*3600*1e3?I:null)}catch{w(null)}},[N]);const T=async()=>{l(!0),p(!1),y(null);const I=await wi(a,n);c(I),s(I.ok?n:null),l(!1)},A=m.useRef(!1),q=async()=>{if(A.current)return;A.current=!0,u(!0);const I=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let F;try{F=await ki(a,n,"webhook",void 0,I)}finally{A.current=!1}if(u(!1),p(!1),y(F),F.ok&&(F.pushed||0)>0){const P={t:new Date().toISOString(),n:F.pushed||0};w(P);try{localStorage.setItem(N,JSON.stringify(P))}catch{}}},L=d!=null&&d.ok&&d.ready||0,C=!!(d!=null&&d.ok)&&h===n&&L>0&&!!x&&!E,O=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:I=>i(I.target.value),children:e.plugBulkTabs.map(([I,F])=>t.jsx("option",{value:I,children:F},I))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),d&&(d.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(d.ready||0,d.linkedinReady||0,(d.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(d!=null&&d.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(O,E.n)}),!E&&!!(d!=null&&d.ok)&&!x&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!d&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),C&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),C&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(L,x||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{q()},children:v?e.bulkSending:e.bulkConfirm(x||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>p(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function Cd(){const{t:e,data:a,lang:r}=_(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const d=window.location.href.split("?")[0];try{const h=await(await fetch(`${un}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:d+"?credits=ok",cancel_url:d+"?credits=cancel"})})).json();h.url&&(window.location.href=h.url)}catch{}};return t.jsxs($e,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function zd(){const{t:e}=_();return t.jsx($e,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(cd,{})})}function Ad(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:d}=_(),[c,h]=m.useState(null),[s,f]=m.useState(!1);m.useEffect(()=>{let L=!0;if(o)return fn(o).then(C=>{L&&C&&typeof C.per_day=="number"&&h(C.per_day)}),()=>{L=!1}},[o]);const[p,v]=m.useState(null);m.useEffect(()=>{if(!i)return;let L=!0;return bi(i).then(C=>{L&&v(C)}),()=>{L=!1}},[i]);const u=r.stats,b=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(L=>L.kind==="target"&&Be(L)).length,y=r.marketEstimate||0,x=y>0?Math.min(100,Math.round(b/y*100)):null,j=(u==null?void 0:u.window_days)||30,E=b>0?b/j:0,w=y>0?Math.max(0,y-b):0,T=y>0&&E>0&&b>=100?Math.round(w/E):null,A=L=>Math.round(L).toLocaleString(a==="en"?"en-US":"fr-FR"),q=L=>{s||!l||(f(!0),yi(i,L).then(C=>{if(f(!1),C===null){d(e.actErr);return}h(C),d(e.alertSaved)}))};return t.jsxs($e,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(A(b))}),y>0&&t.jsx("span",{children:e.covOf(A(y))})]}),x!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:x+"%"}}),t.jsxs("em",{children:[x," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(A(E))}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:A(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&u.shown!==u.kept&&t.jsxs("span",{children:[t.jsx("b",{children:A(u.shown)})," ",e.funShown]})]}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((L,C)=>t.jsxs("tr",{className:L.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[L.code,L.geo?` · ${L.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof L.n=="number"?A(L.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:L.source}),L.elargi&&t.jsx("em",{children:e.covWide(String(L.demande||""))}),L.erreur&&t.jsx("em",{children:e.covMissing})]})]},C)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:A(p.total||y)})}),t.jsx("td",{className:"cs"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(L=>t.jsx("button",{type:"button",className:c===L?"on":"",disabled:s,onClick:()=>q(L),children:L===0?"⏸":L},L))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Td(){var x,j,E;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:d}=_(),c=n==="client",h=m.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[s,f]=m.useState(""),[p,v]=m.useState(""),[u,b]=m.useState(!1),y=async()=>{const w=s.trim();if(!(!w||u||!c)){b(!0),v("");try{const T=await(await fetch(`${Ft}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&v(String(T.reply)),T.job_id){v(e.critChatRunning);const A=async()=>{const q=await fetch(`${Ft}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(L=>L.json()).catch(()=>null);if(q&&q.done){v(String(q.reply||q.clarification||q.summary||"✓")),b(!1),q.applied&&i(e.alertSaved);return}setTimeout(()=>{A()},8e3)};setTimeout(()=>{A()},8e3),f("");return}f("")}finally{p.startsWith("⏳")||b(!1)}}};return t.jsxs($e,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((x=o.points)!=null&&x.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=o==null?void 0:o.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var N,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(A=>t.jsx("li",{children:A},A))})]}),!!((T=w.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(A=>t.jsx("li",{children:A},A))})]})]})]},w.title)})]}),!!((E=o==null?void 0:o.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:h.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!c||u,onChange:w=>f(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},disabled:!c||u||!s.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(gi,{fund:l,lang:d,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(uo[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ld(){const{t:e,dispatch:a,startTour:r}=_(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs($e,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const ho="atl2:mapfold",qd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(ho);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Fd=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},go=m.createContext(null),_=()=>{const e=m.useContext(go);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ct({o:e,lg:a}){const{lang:r}=_(),n=Re(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Bn(n,r),children:[n.emoji," ",Bn(n,r)]}):null}function qa({o:e,src:a}){const{lang:r,t:n}=_(),i=Re(e);if(!i)return null;const o=qi(i),l=Fi(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Lr(i,r))+" · "+n.win7(qr(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(d,c)=>t.jsx("i",{className:c<o?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:d=>d.stopPropagation(),children:"↗"})]})}function Md(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Oe(a);if(i)return e.find(o=>Oe(o.name)===i)||e.find(o=>{const l=Oe(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function Rd(){const{scoped:e,t:a,st:r,dispatch:n}=_(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.filter(f=>!Xe(f)),d=l.length,c=l.filter(f=>!f.noCo).length,h=l.filter(f=>!!f.noCo).length,s=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:s?"7":"all"}});else{const f=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:f,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:d}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",h," ",a.zoomPulseExplore]})]})]})}function bo({o:e}){const{lang:a}=_(),r=Li(e.cc),n=e.cc?Pt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const kr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Od=!1;function Dd(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const vo=e=>`atl2:tour:${e||"anon"}`;function Pd(e){try{return localStorage.getItem(vo(e))==="1"}catch{return!0}}function jr(e){try{localStorage.setItem(vo(e),"1")}catch{}}function Id(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Hd({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var re;const{lang:l}=Ci(),d=Vi[l],c=as(e,l,a),[h,s]=m.useReducer(os,void 0,()=>ns((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Fd():qd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),f=m.useRef(!0);m.useEffect(()=>{if(f.current){f.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(ho,h.mapFolded?"on":"off")}catch{}},[h.mapFolded,e,a]),m.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const k=()=>{window.innerWidth<=760&&s({type:"mapFold",folded:!0})};return k(),window.addEventListener("resize",k),()=>window.removeEventListener("resize",k)},[a]);const p=m.useRef(o);p.current=o,m.useEffect(()=>{var k;(k=p.current)==null||k.call(p,h.filters)},[h.filters]);const[v,u]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:chrome-min")==="1"}catch{return!1}}),[b,y]=m.useState(null),[x,j]=m.useState(null),[E,w]=m.useState(null),[N,T]=m.useState({kept:0,dropped:0}),[A,q]=m.useState(!1),[L,C]=m.useState(""),[O,I]=m.useState(!1),[F,P]=m.useState(null),[g,z]=m.useState(!1),[U,G]=m.useState(!1),[,V]=m.useState(0),J=()=>V(k=>k+1),X=m.useRef([]),K=m.useRef(new Set),le=m.useRef(new Set),[ae,pe]=m.useState([]),[H,ie]=m.useState([]),[ee,qe]=m.useState(0),ke=m.useRef(new Map),se=m.useRef(null),{mode:me}=c,ce=m.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[c.caps,i,a]),Y=ce.pipe,Z=c.session.token||"",xe=me==="client"&&!e;m.useEffect(()=>{if(!Z||!Y)return;let k=!0;const D=async()=>{const te=await Mi(Z);!k||!te||(ie(te.runs),qe(Date.now()/1e3-te.now),pe(Ne=>Ne.filter(Se=>!te.runs.some(Je=>Oe(Je.company)===Oe(Se.name)))))};D();const M=ae.length>0||H.some(te=>te.status==="running"),B=window.setInterval(()=>{D()},M?8e3:25e3);return()=>{k=!1,window.clearInterval(B)}},[Z,Y,ae.length,H.some(k=>k.status==="running")]);const de=m.useMemo(()=>{const k=[],D=new Set;for(const M of ae){const B=Oe(M.name);!B||D.has(B)||(D.add(B),k.push({name:M.name,id:M.id,status:"boot",started:M.started,estMin:M.estMin,memoType:"instant"}))}for(const M of H){const B=Oe(M.company);if(!B||D.has(B))continue;D.add(B);const te=M.status==="error"?"error":M.status==="done"?"done":"running";k.push({name:M.company,status:te,started:M.started||0,estMin:M.est_min||(M.memo_type==="detailed"?40:15),url:M.url,error:M.error,memoType:M.memo_type})}return k},[ae,H]),fe=k=>de.find(D=>Oe(D.name)===Oe(k))||null,he=(k,D)=>{pe(M=>M.some(B=>Oe(B.name)===Oe(k.name))?M:[...M,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:D==="detailed"?40:15}]),K.current.add(k.id),J()};m.useEffect(()=>{if(document.querySelector(`link[href="${kr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=kr,document.head.appendChild(k)},[]);const ge=(k,D=!1)=>{C(k),I(D),se.current&&clearTimeout(se.current),se.current=setTimeout(()=>C(""),D?4200:2400)},Le=k=>ge(k,!0),ve=m.useMemo(()=>{const k=new Map;return c.dossiers.forEach(D=>{D.id&&k.set(D.id,D)}),k},[c.dossiers]),Fe=m.useMemo(()=>c.dossiers.filter(k=>Rr(k,h,Y)),[c.dossiers,h,Y]),Ze=m.useRef(!1);m.useEffect(()=>{if(Ze.current||e||c.loading||!c.dossiers.length)return;if(!ce.showFunnel||Pd(c.session.token||"")){Ze.current=!0;return}Ze.current=!0;const k=window.setTimeout(()=>{jr(c.session.token||""),z(!0)},700);return()=>window.clearTimeout(k)},[e,c.loading,c.dossiers.length,ce.showFunnel,c.session.token]);const je=m.useMemo(()=>c.dossiers.filter(k=>is(k,h,Y,c.favIds)),[c.dossiers,h,Y,c.favIds]),He=m.useMemo(()=>zi(Fe,c.favIds),[Fe,c.favIds]),Me=m.useRef(!1);m.useEffect(()=>{if(Me.current)return;if(!Y||a==="ops"){Me.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Me.current=!0;return}if(c.loading)return;Me.current=!0;const k=Ai(He);k!==h.ptab&&s({type:"ptab",tab:k})},[Y,a,n==null?void 0:n.ptab,c.loading,He,h.ptab]);const it=m.useMemo(()=>{const k=$r(c.dossiers);return k?ct(k)===0?d.tourToday:_r(k,l):d.tourNoRun},[c.dossiers,d,l]),pt=m.useMemo(()=>c.dossiers.some(k=>!!k.memoUrl||!!k.summary||Mt(k)),[c.dossiers]),[ft,et]=m.useState(!1);m.useEffect(()=>{if(c.loading){et(!1);return}if(c.dossiers.length>0||c.error){et(!0);return}const k=window.setTimeout(()=>et(!0),6e3);return()=>window.clearTimeout(k)},[c.loading,c.dossiers.length,c.error]);const xt=(c.marketEstimate||0)>0||typeof((re=c.stats)==null?void 0:re.screened)=="number"&&c.stats.screened>0,ht=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(He[k]||0)>0)??0,[He]),S=xn.find(k=>k.key===h.continent),$=h.continent==="monde"?d.contWorld:(l==="fr"?S==null?void 0:S.fr:S==null?void 0:S.en)||"";m.useEffect(()=>{const k=D=>{var B;const M=(((B=D.detail)==null?void 0:B.name)||"").trim();M&&W(null,M)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{const k=D=>{const M=D.detail||{},B=String(M.id||"").trim(),te=String(M.name||"").trim(),Ne=String(M.url||"").trim(),Se=B&&ve.get(B)||Md(c.dossiers,te,Ne);if(Se){if(j(null),Y){const ye=ze(Se);typeof ye=="number"&&ye!==h.ptab&&s({type:"ptab",tab:ye})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),s({type:"focus",id:Se.id}),(Se.noCo||["media","nominations","recrutements"].includes(Se.engine||""))&&(Se.url||Se.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Se.url||"",text:[Se.headline,Se.tagline].filter(Boolean).join(`
`)}})):Se.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Se.name,url:Se.url||"",website:Se.website||"",domain:Se.domain||""}}));return}!te&&!Ne||(s({type:"focus",id:B||null}),j({name:te,headline:String(M.text||"").trim()||te,url:Ne,card:M.card}),Ne&&(ya(te)||!te)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ne,text:String(M.text||"").trim()}})):te&&!ya(te)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:te}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=B=>{const te={},Ne=String((B==null?void 0:B.sector)||"").trim();Ne&&(te.sector=[Ne]);const Se=String((B==null?void 0:B.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Se)&&(te.day=Se);const Je=String((B==null?void 0:B.search)||"").trim();Je&&(te.search=Je);const ye=String((B==null?void 0:B.dealKind)||"").trim();(ye==="ma"||ye==="levee"||ye==="other")&&(te.dealKind=[ye]),Object.keys(te).length&&s({type:"filters",patch:te})},D=B=>k(B.detail),M=B=>{B.data&&B.data.type==="pp-filter"&&k(B.data)};return window.addEventListener("ppmap:filter",D),window.addEventListener("message",M),()=>{window.removeEventListener("ppmap:filter",D),window.removeEventListener("message",M)}},[]),m.useEffect(()=>{const k=D=>{var te;const M=(((te=D.detail)==null?void 0:te.name)||"").trim().toLowerCase();if(!M)return;const B=c.dossiers.find(Ne=>(Ne.name||"").trim().toLowerCase()===M);B&&s(a==="ops"?{type:"focus",id:B.id}:{type:"popup",id:B.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const W=(k,D)=>{const M=((k==null?void 0:k.name)||D||"").trim();if(!xe){w({kicker:M});return}!M||A||(q(!0),(async()=>{try{let B=M;const te=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(te)B=te;else try{const ye=await Ar(M);if(ye!=null&&ye.website)B=ye.website;else if(((ye==null?void 0:ye.candidates)||[]).length===1)B=ye.candidates[0].url;else if(((ye==null?void 0:ye.candidates)||[]).length>1){X.current=[{name:M,verdict:"unresolved",remaining:null,reason:d.evalPickSite,candidates:(ye.candidates||[]).slice(0,5)},...X.current].slice(0,8),J();return}}catch{}const Ne=await Tr(Z,B,"atelier2"),Se={name:Ne.company||M,verdict:Ne.verdict,reason:Ne.reason||"",remaining:Ne.remaining??null};X.current=[Se,...X.current].slice(0,8),Ne.verdict==="kept"&&T(ye=>({...ye,kept:ye.kept+1})),Ne.verdict==="ruled_out"&&T(ye=>({...ye,dropped:ye.dropped+1}));const Je=k||c.dossiers.find(ye=>(ye.name||"").toLowerCase()===M.toLowerCase());Je&&(Ne.verdict==="kept"?Je.verdict=Je.verdict||"MATCH":Ne.verdict==="ruled_out"&&(Je.verdict="NO MATCH"),Ne.reason&&(Je.reasoning=Ne.reason)),J()}finally{q(!1)}})())},ne=k=>{if(!xe){w({kicker:k.name});return}he(k,"instant"),_t(Z,"fast_request",k.name||"",""),ge(d.memoInstantSent(k.name))},Ce=k=>ke.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),oe=(k,D)=>s({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:D}}),be=async(k,D,M)=>{const B=k.ceoStatus||"";k.ceoStatus=D,J();const te=await Oa(Z,{status:D,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(M==null?void 0:M.note)!==void 0?{note:M.note}:{},...M!=null&&M.via?{via:M.via}:{}});return te.ok?te.skipped?(k.ceoStatus=B,J(),Le(d.actNotPersisted),!1):((M==null?void 0:M.undo)!==!1&&oe(k,B),M!=null&&M.msg&&ge(M.msg),(D==="Validé"||D==="Écarté")&&!k.ceoNote&&(M==null?void 0:M.note)===void 0&&P({o:k,yes:D==="Validé"}),!0):(k.ceoStatus=B,J(),Le(d.actErr),!1)},Pe=async(k,D)=>{const M=await Oa(Z,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:D,via:"note"});return!M.ok||M.skipped?(Le(M.skipped?d.actNotPersisted:d.actErr),!1):(k.ceoNote=D,J(),!0)},st=m.useRef(new Map),At=k=>st.current.has(k.id)?st.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),Tt=(k,D)=>{st.current.set(k.id,D),J()},gt=(k,D)=>{xe&&be(k,D?"Validé":"Écarté",{msg:D?d.decidedYes(k.name):d.decidedNo(k.name)})},ut=k=>{xe&&be(k,"À trancher",{msg:d.promoted(k.name)})},Ve=k=>{xe&&(async()=>{const D=k.ceoStatus||"";k.ceoStatus="Retenu",J();const M=await Oa(Z,{status:"Retenu",check_id:k.checkId,company:k.name});if(!M.ok||M.skipped){k.ceoStatus=D,J(),Le(M.skipped?d.actNotPersisted:d.actErr);return}oe(k,D),ge(d.repeched(k.name))})()},Fa=()=>{const k=h.undo[h.undo.length-1];if(!k){ge(d.undoNone);return}const D=ve.get(k.id);if(!D){s({type:"undoPop"}),ge(d.undoNone);return}let M=k.prevCeoStatus;if(!M)if((D.verdict||"").toUpperCase().includes("CALL"))M="À trancher";else{ge(d.undoLockedTitle);return}(async()=>await be(D,M,{undo:!1})&&(s({type:"undoPop"}),D.ceoStatus=k.prevCeoStatus,J(),ge(d.undoDone(D.name))))()},Ie=k=>{xe&&(le.current.add(k.id),J(),(async()=>{const D=await Ri(Z,k.name,"email");if(!D||D.ok===!1){le.current.delete(k.id),J(),Le(d.actErr);return}_t(Z,"approach",k.name||"",""),ge(d.actApproachSent)})())},bt=(k,D)=>{xe&&(async()=>{if(!(await _t(Z,D?"yes":"no",k.name||"","")).ok){Le(d.actErr);return}ke.current.set(k.id,D?"yes":"no"),J(),ge(D?d.thumbUpDone:d.thumbDnDone)})()},Qe=k=>{!xe||!Mt(k)||(he(k,"detailed"),_t(Z,"detailed_request",k.name||"",""),ge(d.memoDeepSent(k.name)))},Bt=k=>{const D=new Set(c.favIds),M=D.has(k.id);M?D.delete(k.id):D.add(k.id),c.setFavIds(D),xe&&Oi(Z,{id:k.id,co:k.name},M)},$t=()=>{!xe||U||window.confirm(d.identSyncConfirm)&&(G(!0),(async()=>{const k=await Di(Z);G(!1),k?ge(d.identSyncDone):Le(d.actErr)})())},na=/proplace/i.test(c.fund||""),Ma=k=>{!xe||!na||(_t(Z,"onboard_request",k.name||"",""),ge(d.onboardSent(k.name)))},R={st:h,dispatch:s,t:d,lang:l,mode:me,caps:ce,pipe:Y,token:Z,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:Ve,thumbOf:Ce,canWrite:xe,commitStatus:be,saveNote:Pe,stageOf:At,setStage:Tt,flashErr:Le,startTour:()=>z(!0),dossiers:c.dossiers,scopedAll:Fe,scoped:je,counts:He,byId:ve,contName:$,favIds:c.favIds,toggleFav:Bt,askEvaluate:W,doAnalyse:ne,doDecide:gt,doPromote:ut,doApproach:Ie,doThumb:bt,doDeep:Qe,doUndo:Fa,doSync:$t,doOnboard:Ma,outbound:na,memoQueued:K.current,liveMemos:{items:de,serverOff:ee,liveOf:fe},approachDone:le.current,sessTally:N,evalCards:X.current,evalBusy:A,markRow:y,markedId:b,flash:ge,focusExtra:x};m.useEffect(()=>{const k=D=>{D.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const Q=k=>Z?t.jsx(ls,{token:Z,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(go.Provider,{value:R,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(Z?" cibles":"")+(v?" chrome-min":""),children:[t.jsx("style",{children:Gi}),Q(t.jsxs("div",{className:"app"+(Y?" pipe":"")+(Z?" has-thesis":""),children:[ce.showTicker&&t.jsx(tt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(Z?" live-stack--cibles":""),children:[t.jsx(fs,{}),!!Z&&t.jsx(ds,{})]})}),ce.showIdent&&t.jsx(tt,{name:"identite",children:t.jsx(Es,{})}),!1,Od,ce.showFunnel&&t.jsx(tt,{name:"entonnoir",children:t.jsx(Bd,{})}),!h.mapFolded&&t.jsx(tt,{name:"carte",fallback:t.jsx("div",{className:"void",children:d.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(lo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Rd,{}),t.jsx(Nl,{}),t.jsx(so,{})]})]})}),ce.showDemand&&Y&&t.jsx(tt,{name:"direct",children:t.jsx(_i,{items:de,serverOff:ee,labels:{strip:d.liveStrip,boot:d.liveBoot,end:d.liveEnd,open:d.liveOpenQueue,memo:d.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),ce.showDemand&&t.jsx(tt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Ll,{})})}),a==="ops"&&t.jsxs("button",{type:"button",className:"chrome-tog","aria-expanded":!v,onClick:()=>{u(k=>{const D=!k;try{localStorage.setItem("atl2:chrome-min",D?"1":"0")}catch{}return D})},children:[t.jsx("i",{}),v?d.chromeShow:d.chromeHide]}),ce.showDemand&&h.memoConsole&&t.jsx(tt,{name:"console",children:t.jsx(Fl,{})}),t.jsx(tt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:d.retry})]}),children:t.jsx(rd,{})}),c.loading&&t.jsx("div",{className:"void",children:d.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[d.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:d.retry})]})]})),h.popupId&&h.dens!=="liste"&&a!=="ops"&&t.jsx(tt,{name:"fiche",children:t.jsx($l,{})}),t.jsx(tt,{name:"modales",children:t.jsx(ud,{})}),t.jsx(gs,{}),F&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:F.o.name}),t.jsx(ks,{placeholder:F.yes?d.whyYesPh:d.whyNoPh,onDone:k=>{const D=F.o;P(null),k&&Pe(D,k).then(M=>{M&&ge(d.csNoteSaved)})}})]}),g&&ft&&t.jsx(Ns,{steps:Id(d,it,pt,ht,xt),onClose:()=>{z(!1),jr(Z)}}),t.jsx(Dd,{}),ce.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:d.lockbarText}),t.jsxs("span",{className:"lb-c",children:[d.lockbarContactBefore,t.jsx("a",{href:Ir,children:bn}),d.lockbarContactMid,t.jsx("a",{href:`mailto:${ka}`,children:ka})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:d.lockbarCta})]}),L&&t.jsx("div",{className:"flash on"+(O?" err":""),children:L}),E&&t.jsx(Ti,{variant:"acquirer",initialCompany:Nr().co,initialWebsite:Nr().site,onClose:()=>w(null)})]})})}function Bd(){const{t:e}=_(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Nr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function $d(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{bo as FlagCell,Ct as SigBadge,qa as SigWin,Hd as default,$d as fmtShort,_ as useV2};
