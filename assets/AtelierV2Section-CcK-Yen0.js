...
.atl2 .row .c-vd{display:inline-flex!important;flex-wrap:nowrap!important;
  align-items:center;gap:4px;min-width:0;max-width:100%;overflow:hidden}
.atl2 .row .c-vd>*{flex:0 1 auto;min-width:0;white-space:nowrap;overflow:hidden;
  text-overflow:ellipsis}
.atl2 .row .c-vd .vd.wait{max-width:96px}
...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Po=qo+Fo;function sa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Do(){const e=sa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Io(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Do();return r==="0"?"client":r==="1"||sa("embed")==="1"&&sa("chrome")==="1"?"apercu":"client"}const Bo={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},$o=e=>Bo[e],Ye=e=>(e.noCo===void 0&&!On((e.name||"").trim())&&(e.noCo=!0),Object.assign(e,{continent:Ir(e.cc)}));function Qt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const _o=60*60*1e3;function Uo(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>_o?null:a}catch{return null}}function Nt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Vo=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ho(e,a,r="default"){const n=r!=="default",i=h.useMemo(()=>e||n?{mode:"anon"}:Tr(),[e,n]),o=h.useMemo(()=>n?"visiteur":Io(e,i),[e,i,n]),l=h.useMemo(()=>$o(o),[o]),s=o!=="visiteur",p=Vo(r),[g,d]=h.useState([]),[c,u]=h.useState(""),[x,f]=h.useState(null),[b,v]=h.useState(null),[m,y]=h.useState(null),[j,w]=h.useState(()=>new Map),[E,A]=h.useState(()=>new Map),[R,B]=h.useState(""),[C,M]=h.useState(new Set),[O,L]=h.useState(null),[_,k]=h.useState(!0),[N,T]=h.useState(!1),[H,G]=h.useState(0),[Z,z]=h.useState(0),q=h.useRef(0),I=h.useMemo(()=>{var D;if(o!=="client")return"";try{return((D=Lr())==null?void 0:D.email)||""}catch{return""}},[o]);h.useEffect(()=>{const D=++q.current;let U=!0;const W=()=>U&&D===q.current,J=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),re=Uo(J);return re?(d(re.objs.map(Ye)),re.fund&&u(re.fund),f(re.marketEstimate??null),v(re.criteria??null),y(re.stats??null),B(re.generatedAt||""),k(!1)):k(!0),(async()=>{try{if(r==="ops"){const ue=await Wt(),ce=((ue==null?void 0:ue.recent_ops)||[]).map(Q=>{const te=Gt(Q.company_name||Q.title?Q:{...Q,title:(Q.headline_fr||Q.headline||"").slice(0,120)},a),be=String(Q.rubrique||"").toLowerCase();return te&&(be==="nominations"||be==="recrutements")&&(te.engine=be),te&&!String(Q.company_name||"").trim()&&(te.noCo=!0),te}).filter(Q=>!!Q).map(Q=>(On((Q.name||"").trim())||(Q.noCo=!0),Q));try{const Q=await Rr(),te=Mr(Q),be=((Q==null?void 0:Q.date)||"").slice(0,10);if(te.length&&be){const K=new Set;for(const ie of ce){if(ie.noCo||(ie.date||"").slice(0,10)!==be)continue;const ee=Pa(te,K,ie.name,"");ee>=0&&(K.add(ee),ie.decryptHtml=te[ee].html)}for(const ie of ce){if(ie.decryptHtml||(ie.date||"").slice(0,10)!==be)continue;const ee=Pa(te,K,"",ie.headline||ie.tagline||ie.name);ee>=0&&(K.add(ee),ie.decryptHtml=te[ee].html)}}}catch{}if(!W())return;d(ce.map(Ye)),Nt(J,{objs:ce})}else if(typeof r=="object"){const ce=(await Da()||[]).filter(te=>(te.slug||"")===r.research).map(te=>Ia(te,a)).filter(te=>!!te),Q=Qt(await Ba(ce,a));if(!W())return;d(Q.map(Ye)),Nt(J,{objs:Q})}else if(s&&i.token){const ue=Or(i.token),ce=Wt(),Q=qr(i.token),te=Fr(i.token),be=Pr(i.token),K=await ue;let ie=K?K.targets:[];W()&&K&&(u(K.fund||""),f(K.marketEstimate??null),v(K.criteria??null),y(K.stats??null),B(K.generatedAt||""),d(ie.map(Ye)),k(!1),T(!1));const[ee,_e,fe,xe]=await Promise.all([ce,Q,te,be]),De=((ee==null?void 0:ee.recent_ops)||[]).map(Ne=>Gt(Ne,a)).filter(Ne=>!!Ne);if(ie=[...ie,...De],!W())return;d(ie.map(Ye));const He=new Set;for(const Ne of _e){const Ie=(Ne.id||Ne.co||"").toString().trim().toLowerCase();Ie&&He.add(Ie.startsWith("t:")?Ie:"t:"+Ie)}M(He),w(fe),A(xe),K&&Nt(J,{fund:K.fund,marketEstimate:K.marketEstimate,criteria:K.criteria,stats:K.stats,generatedAt:K.generatedAt,objs:ie})}else{const ue=Dr(),ce=Da(),Q=Wt(),te=await ue;W()&&te.length&&(d(Qt(te).map(Ye)),k(!1),T(!1));const[be,K]=await Promise.all([ce,Q]),ie=(be||[]).map(xe=>Ia(xe,a)).filter(xe=>!!xe),ee=await Ba(ie,a),_e=((K==null?void 0:K.recent_ops)||[]).map(xe=>Gt(xe,a)).filter(xe=>!!xe),fe=Qt([...te,...ee,..._e]);if(!W())return;d(fe.map(Ye)),Nt(J,{objs:fe})}W()&&T(!1)}catch{W()&&!re&&T(!0)}finally{W()&&k(!1)}})(),()=>{U=!1}},[s,i.token,a,H,p]),h.useEffect(()=>{if(!l.showCredits||!I){L(null);return}let D=!0;return(async()=>{try{const U=await fetch(`${Na}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:I})});if(!U.ok)return;const W=await U.json();D&&W&&W.ok!==!1&&L(W)}catch{}})(),()=>{D=!1}},[l.showCredits,I,Z]);const P=h.useCallback(D=>M(new Set(D)),[]);return{session:i,mode:o,caps:l,fund:c,email:I,marketEstimate:x,generatedAt:R,criteria:b,stats:m,thumbs:j,stages:E,dossiers:g,favIds:C,setFavIds:P,credits:O,reloadCredits:()=>z(D=>D+1),loading:_,error:N,refresh:()=>G(D=>D+1)}}const Bn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Yo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Bn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function Wo(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Bn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??$n)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const $n=40;function Aa(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Sa(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ot(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ge(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function _n(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Aa(e,a.filters,r)}function Go(e,a,r,n){return!(!_n(e,a,r)||r&&!Br(e,a.ptab,n))}function za(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-ot(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=me(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const Ko=["ma","levees","nominations","recrutements","actualites"],Qo=300,Xt=7,Xo={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Un={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Jo=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ka(e){const a=me(e);if(a)return"sig:"+(a.theme&&Un.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Zo(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=F(),s=l==="en",[p,g]=h.useState("all"),[d,c]=h.useState(!1),u=h.useMemo(()=>{const C=(a.filters.day||"").slice(0,10),M=k=>!(!o&&a.continent!=="monde"&&k.continent!==a.continent||C&&(k.date||"").slice(0,10)!==C),O=e.filter(k=>M(k)&&me(k)),L=e.filter(k=>M(k)&&k.kind==="op"&&!me(k)&&(C?!0:ot(k.date)<=Xt)),_=C||new Date().toISOString().slice(0,10);return L.sort((k,N)=>{const T=(k.date||"").slice(0,10)===_?0:1,H=(N.date||"").slice(0,10)===_?0:1;return T!==H?T-H:(N.amountEur||0)-(k.amountEur||0)}),[...za(O,{key:"signal",dir:-1}),...L]},[e,a.continent,a.filters.day,o]),x=h.useMemo(()=>{const C={};for(const M of u){const O=Ka(M);C[O]=(C[O]||0)+1}return C},[u]),f=h.useMemo(()=>p==="all"?u:u.filter(C=>Ka(C)===p),[u,p]),b=h.useMemo(()=>f.slice(0,Qo),[f]),v=f.length-b.length,m=C=>C==="all"?u.length:x[C]||0,y=C=>C==="all"?s?"All":"Tout":C.startsWith("sig:")?Un[s?"en":"fr"][C.slice(4)]||"🔔":Xo[s?"en":"fr"][C],j=[{k:"all"}],w=Ko.filter(C=>m(C)>0||C===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const C of w)j.push({k:C})}const E=Jo.map(C=>"sig:"+C).filter(C=>m(C)>0||C===p);if(E.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const C of E)j.push({k:C})}const A=C=>{try{return new Date(C+"T12:00:00Z").toLocaleDateString(s?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return C}},R=(()=>{const C=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?s?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return C?(s?`LIVE covers the events of ${A(C)}.`:`Le LIVE regroupe les événements du ${A(C)}.`)+M:(s?`LIVE covers the still-open signals and the deals of the last ${Xt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Xt} derniers jours.`)+M})(),B=C=>b.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Ee(M)?" spent":""),onClick:O=>{const L=O.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:L.left+L.width/2,y:L.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Je,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(br,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Ml(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Vt,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},C+(M.id||M.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},C+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:C=>{C.currentTarget.contains(C.relatedTarget)||c(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":d,onClick:()=>c(C=>!C),children:[y(p),t.jsx("b",{children:m(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!d,children:[t.jsx("span",{className:"tkfilscope",children:R}),j.map(C=>"g"in C?t.jsx("span",{className:"tkfilg",children:C.g},C.g):t.jsxs("button",{type:"button","aria-pressed":C.k===p,onClick:()=>{g(C.k),c(!1)},children:[y(C.k),t.jsx("b",{children:m(C.k)})]},C.k))]})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[B(0),B(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const ei="aDx8z7Hzksus",Vn="+33 6 83 10 72 86",Qa="alexandre@proplace.co",ti=`tel:${Vn.replace(/[^\d+]/g,"")}`,Xa="pp-rdv-slot";function ai(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function ni(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:oi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:ti,children:Vn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Qa}`,children:Qa})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Lo,{filloutId:ei,parameters:r?{company_name:r}:void 0})})]})}function ri(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById(Xa));return h.useEffect(()=>{e||a(document.getElementById(Xa))},[e]),e?it.createPortal(t.jsx(ni,{}),e):null}const oi=`
...
`;class ge extends h.Component{constructor(){super(...arguments);qa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ii=8;function si(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,p]=h.useState(!1),[g,d]=h.useState(!1),[c,u]=h.useState(!1),x=r||"home",{names:f,verdicts:b}=h.useMemo(()=>{const w=[],E={};return n.forEach(A=>{A.kind!=="target"||!A.name||(w.push(A.name),E[A.name]=$r(A)||"")}),{names:w,verdicts:E}},[n]),v=h.useMemo(()=>f.length?_r(x,f,b,a):null,[x,f.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const m=g?v.added:v.added.slice(0,ii),y=v.added.length-m.length,j=w=>{const E=n.find(A=>A.name===w);E&&(o(E.id),l({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Ur(x,f,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[m.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),c&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Jt=600,We=62,Ja="atl2:fstats";function li(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Ja)==="on"}catch{return!1}}),p=r.stats,g=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const c=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),x=g.reduce((y,j)=>Math.max(y,j.s||0),0),f=g.length?Jt/g.length:0,b=Math.max(4,f-4),v=g.length>=5&&x>0,m=[[p.screened,e.funScreened(c(d)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[m.map(([y,j,w],E)=>t.jsxs("span",{className:"fst-t",children:[E>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Ja,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Jt} ${We}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((y,j)=>{const w=(y.s||0)/x*(We-4),E=(y.m||0)/x*(We-4),A=j*f+(f-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${c(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:We-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:We-2-E,width:b,height:E,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:We-1.5,x2:Jt,y2:We-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:c(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const di=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ci({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(Ze(e)||"").startsWith("CALL")&&je(e)===3,c=je(e)>=2,u=async f=>{if(o||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(f);const b=await i(e,f);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},x=d?[["Validé",a.csYes],["Écarté",a.csNo]]:di.filter(([f])=>!(c&&f==="Retenu")).map(([f,b])=>[f,a[b]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),x.map(([f,b])=>t.jsx("button",{type:"button",className:"csb"+(g===f?" on":"")+(o===f?" busy":""),disabled:!!o,onClick:()=>{u(f)},children:b},f)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(pi,{o:e})]})}function pi({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,g]=h.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),c=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&c()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{c()},children:p?a.csNoteSaved:a.csNoteOk})]})}function ui({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function fi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[p,g]=h.useState(!1);if(!n.pipe||!i||n.lockActions||je(e)!==4)return null;const d=o(e),c=(d==null?void 0:d.stage)||"todo",u=async m=>{if(p||m===c)return;g(!0);const y=d;l(e,{stage:m,stamps:(d==null?void 0:d.stamps)||{}});const j=Math.max(Date.now(),Za+=1);Za=j;const w=await Vr(r,{company:e.name||"",stage:m,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},x=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,f=x?Math.floor((Date.now()-Date.parse(x))/864e5):0,b=c==="sent"&&x&&f>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(c===m?" on":""),disabled:p,onClick:()=>{u(m)},children:y},m)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let Za=0;const St=8,Ct=340;function en({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function mi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=h.useState(0),[p,g]=h.useState(null),[d,c]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,c(e.filter(j=>!!document.querySelector(j.need||j.sel))))},[e]);const x=d[l],f=l>=d.length;h.useEffect(()=>{x&&(x.ptab!==void 0&&o.ptab!==x.ptab&&n({type:"ptab",tab:x.ptab}),x.dens&&o.dens!==x.dens&&n({type:"dens",dens:x.dens}))},[l,x]);const b=h.useCallback(()=>{if(!x){g(null);return}const j=document.querySelector(x.sel);if(!j){g(null);return}j.scrollIntoView({block:"nearest",behavior:"smooth"}),g(j.getBoundingClientRect())},[x]);h.useLayoutEffect(()=>{b();const j=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(j),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=h.useRef(a);if(v.current=a,h.useEffect(()=>{const j=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(E=>E+1):w.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",j,!0),()=>document.removeEventListener("keydown",j,!0)},[]),!d.length)return null;let m=null;if(f){const j=i[3]||0;j>0?m={title:j===1?r.ahaATitle1:r.ahaATitleN(j),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?m={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:m={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Ct};if(!f&&p){const j=p.bottom+14,E=window.innerHeight-j>190?j:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-Ct/2),window.innerWidth-Ct-12),top:E,width:Ct}}return it.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!f&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-St,top:p.top-St,width:p.width+St*2,height:p.height+St*2}}),(f||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(f?" fin":""),style:y,children:[f&&m?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:m.title}),t.jsx("p",{children:t.jsx(en,{text:m.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:m.go,children:m.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(l+1,d.length)}),t.jsx("h3",{children:x==null?void 0:x.title}),t.jsx("p",{children:t.jsx(en,{text:(x==null?void 0:x.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(j=>Math.max(0,j-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(j=>j+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function xi(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=F(),s=r?a:e,p=h.useMemo(()=>s.filter(m=>ot(m.date)===0&&m.kind==="target"),[s]),g=h.useMemo(()=>r?a.filter(m=>je(m)===0).slice().sort((m,y)=>(y.date||"").localeCompare(m.date||"")):[],[a,r]),d=h.useMemo(()=>p.filter(m=>r?je(m)===0:!Ee(m)),[p,r]),c=r?g:d,u=r?a.length-g.length:p.length-d.length,x=r?a.length:p.length,f=x?Math.min(100,u/x*100):100;let b;r?b=i.morningThesis(p.length,g.length):p.length?u===0?b=i.goalSourced(p.length):u>=p.length?b=i.goalCleared:b=i.goalDone(u,p.length):b=i.goalSourced(0);const v=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&g.length&&l({type:"chainStart",queue:g.map(m=>m.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:f+"%"}})}),c.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:v,children:r?i.morningEval(c.length):o.pileMode?i.goalContinue(c.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function hi(){var M,O;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:g,startTour:d}=F(),[c,u]=h.useState(null),[x,f]=h.useState([]),b=p==="client";h.useEffect(()=>{if(!i||!o)return;let L=!0;return(async()=>{const[_,k]=await Promise.all([Ca(o),qn(i)]);L&&(_&&u(_),f(k))})(),()=>{L=!1}},[i,o]);const v=(c==null?void 0:c.per_day)??null,m=((M=c==null?void 0:c.pool_order)==null?void 0:M.length)??0,y=x.filter(L=>L.status==="running").length,j=h.useMemo(()=>s.filter(L=>L.kind==="target"&&Ee(L)).length,[s]),w=l.marketEstimate,E=typeof((O=l.stats)==null?void 0:O.screened)=="number"?l.stats.screened:j,A=w&&w>0?Math.min(100,Math.round(E/w*100)):null,R=L=>L.toLocaleString(a==="en"?"en-US":"fr-FR"),B=(o||"P").split(/\s+/).map(L=>L[0]).join("").slice(0,2).toUpperCase(),C=(()=>{const L=Date.parse(l.generatedAt||"");if(Number.isNaN(L))return"";const _=new Date(L),k=N=>String(N).padStart(2,"0");return`${k(_.getDate())}/${k(_.getMonth()+1)} à ${k(_.getHours())}:${k(_.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:B}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),C&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(C)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&E>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(E)})})]}),A!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(E,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(m)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:L=>{L.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:L=>n({type:"filters",patch:{search:L.target.value}})})]})]})]})}function gi(){const{t:e,counts:a,dispatch:r}=F();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const bi=["--p0","--p1","--p2","--p3","--p4"];function vi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,p=h.useRef({});h.useEffect(()=>{p.current={...r}},[r]);const g=u=>{const x=p.current[u],f=x!==void 0?r[u]-x:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${bi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(f>0?" up":f<0?" down":""),children:[r[u],f!==0&&t.jsxs("em",{className:"delta",children:[f>0?"+":"−",Math.abs(f)]})]})]},u)},d=(u,x,f)=>t.jsxs("button",{type:"button",className:"off"+(x?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:f.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),c=(u,x,f,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:x,disabled:b,onClick:f,children:u},x);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(g)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[c("↩",n.toolUndo,i,e.undo.length===0),c("↺",n.toolReset,()=>{a({type:"reset"})}),c("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),c("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const yi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function wi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=h.useRef(null),[p,g]=h.useState(60);h.useEffect(()=>{let x=0;const f=()=>{var j;const b=s.current;if(!b)return;const v=(j=b.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!v)return;const m=v.getBoundingClientRect(),y=b.getBoundingClientRect();g(Math.max(20,Math.min(m.left+m.width/2-y.left,y.width-30)))};return x=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(x),window.removeEventListener("resize",f)}},[e.ptab]);const d=e.ptab;let c=r.tuto[d].p;if(d===3){const x=n.filter(v=>v.kind==="target"&&je(v)===3),f=x.filter(v=>ra(v)==="auto").length,b=x.filter(v=>ra(v)==="cd").length;c=r.tutoPending(f,b,x.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(x=>x.id)})};if(d===1){const x=n.filter(f=>f.kind==="target"&&je(f)===1&&!i.has(f.id)).slice(0,10);if(x.length)return{label:r.tuto[1].a,run:()=>x.forEach(f=>o(f))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":yi[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:c}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Qe{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*ki(e){for(const a of e)yield*a}function Hn(e){return Array.from(ki(e))}var ne=1e-6,X=Math.PI,ze=X/2,tn=X/4,Le=X*2,Be=180/X,Ce=X/180,oe=Math.abs,ji=Math.atan,gt=Math.atan2,le=Math.cos,de=Math.sin,Ni=Math.sign||function(e){return e>0?1:e<0?-1:0},et=Math.sqrt;function Si(e){return e>1?0:e<-1?X:Math.acos(e)}function bt(e){return e>1?ze:e<-1?-ze:Math.asin(e)}function Te(){}function Ot(e,a){e&&nn.hasOwnProperty(e.type)&&nn[e.type](e,a)}var an={Feature:function(e,a){Ot(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Ot(r[n].geometry,a)}},nn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){la(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)la(r[n],a,0)},Polygon:function(e,a){rn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)rn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Ot(r[n],a)}};function la(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function rn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)la(e[r],a,1);a.polygonEnd()}function tt(e,a){e&&an.hasOwnProperty(e.type)?an[e.type](e,a):Ot(e,a)}function da(e){return[gt(e[1],e[0]),bt(e[2])]}function nt(e){var a=e[0],r=e[1],n=le(r);return[n*le(a),n*de(a),de(r)]}function Et(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Zt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function At(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function ca(e){var a=et(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function pa(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function ua(e,a){return oe(e)>X&&(e-=Math.round(e/Le)*Le),[e,a]}ua.invert=ua;function Ci(e,a,r){return(e%=Le)?a||r?pa(sn(e),ln(a,r)):sn(e):a||r?ln(a,r):ua}function on(e){return function(a,r){return a+=e,oe(a)>X&&(a-=Math.round(a/Le)*Le),[a,r]}}function sn(e){var a=on(e);return a.invert=on(-e),a}function ln(e,a){var r=le(e),n=de(e),i=le(a),o=de(a);function l(s,p){var g=le(p),d=le(s)*g,c=de(s)*g,u=de(p),x=u*r+d*n;return[gt(c*i-x*o,d*r-u*n),bt(x*i+c*o)]}return l.invert=function(s,p){var g=le(p),d=le(s)*g,c=de(s)*g,u=de(p),x=u*i-c*o;return[gt(c*i+u*o,d*r+x*n),bt(x*r-d*n)]},l}function Ei(e,a,r,n,i,o){if(r){var l=le(a),s=de(a),p=n*r;i==null?(i=a+n*Le,o=a-p/2):(i=dn(l,i),o=dn(l,o),(n>0?i<o:i>o)&&(i+=n*Le));for(var g,d=i;n>0?d>o:d<o;d-=p)g=da([l,-s*le(d),-s*de(d)]),e.point(g[0],g[1])}}function dn(e,a){a=nt(a),a[0]-=e,ca(a);var r=Si(-a[1]);return((-a[2]<0?-r:r)+Le-ne)%Le}function Yn(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Te,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Mt(e,a){return oe(e[0]-a[0])<ne&&oe(e[1]-a[1])<ne}function zt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Wn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(f){if(!((b=f.length-1)<=0)){var b,v=f[0],m=f[b],y;if(Mt(v,m)){if(!v[2]&&!m[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=f[s])[0],v[1]);i.lineEnd();return}m[0]+=2*ne}o.push(y=new zt(v,f,null,!0)),l.push(y.o=new zt(v,null,y,!1)),o.push(y=new zt(m,f,null,!1)),l.push(y.o=new zt(m,null,y,!0))}}),!!o.length){for(l.sort(a),cn(o),cn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var g=o[0],d,c;;){for(var u=g,x=!0;u.v;)if((u=u.n)===g)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(x)for(s=0,p=d.length;s<p;++s)i.point((c=d[s])[0],c[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(x)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((c=d[s])[0],c[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,x=!x}while(!u.v);i.lineEnd()}}}function cn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function ea(e){return oe(e[0])<=X?e[0]:Ni(e[0])*((oe(e[0])+X)%Le-X)}function Ai(e,a){var r=ea(a),n=a[1],i=de(n),o=[de(r),-le(r),0],l=0,s=0,p=new Qe;i===1?n=ze+ne:i===-1&&(n=-ze-ne);for(var g=0,d=e.length;g<d;++g)if(u=(c=e[g]).length)for(var c,u,x=c[u-1],f=ea(x),b=x[1]/2+tn,v=de(b),m=le(b),y=0;y<u;++y,f=w,v=A,m=R,x=j){var j=c[y],w=ea(j),E=j[1]/2+tn,A=de(E),R=le(E),B=w-f,C=B>=0?1:-1,M=C*B,O=M>X,L=v*A;if(p.add(gt(L*C*de(M),m*R+L*le(M))),l+=O?B+C*Le:B,O^f>=r^w>=r){var _=qt(nt(x),nt(j));ca(_);var k=qt(o,_);ca(k);var N=(O^B>=0?-1:1)*bt(k[2]);(n>N||n===N&&(_[0]||_[1]))&&(s+=O^B>=0?1:-1)}}return(l<-ne||l<ne&&p<-1e-12)^s&1}function Gn(e,a,r,n){return function(i){var o=a(i),l=Yn(),s=a(l),p=!1,g,d,c,u={point:x,lineStart:b,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=j,d=[],g=[]},polygonEnd:function(){u.point=x,u.lineStart=b,u.lineEnd=v,d=Hn(d);var w=Ai(g,n);d.length?(p||(i.polygonStart(),p=!0),Wn(d,Ti,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),d=g=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function x(w,E){e(w,E)&&i.point(w,E)}function f(w,E){o.point(w,E)}function b(){u.point=f,o.lineStart()}function v(){u.point=x,o.lineEnd()}function m(w,E){c.push([w,E]),s.point(w,E)}function y(){s.lineStart(),c=[]}function j(){m(c[0][0],c[0][1]),s.lineEnd();var w=s.clean(),E=l.result(),A,R=E.length,B,C,M;if(c.pop(),g.push(c),c=null,!!R){if(w&1){if(C=E[0],(B=C.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),A=0;A<B;++A)i.point((M=C[A])[0],M[1]);i.lineEnd()}return}R>1&&w&2&&E.push(E.pop().concat(E.shift())),d.push(E.filter(zi))}}return u}}function zi(e){return e.length>1}function Ti(e,a){return((e=e.x)[0]<0?e[1]-ze-ne:ze-e[1])-((a=a.x)[0]<0?a[1]-ze-ne:ze-a[1])}const pn=Gn(function(){return!0},Li,Mi,[-X,-ze]);function Li(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?X:-X,p=oe(o-a);oe(p-X)<ne?(e.point(a,r=(r+l)/2>0?ze:-ze),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=X&&(oe(a-n)<ne&&(a-=n*ne),oe(o-s)<ne&&(o-=s*ne),r=Ri(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ri(e,a,r,n){var i,o,l=de(e-r);return oe(l)>ne?ji((de(a)*(o=le(n))*de(r)-de(n)*(i=le(a))*de(e))/(i*o*l)):(a+n)/2}function Mi(e,a,r,n){var i;if(e==null)i=r*ze,n.point(-X,i),n.point(0,i),n.point(X,i),n.point(X,0),n.point(X,-i),n.point(0,-i),n.point(-X,-i),n.point(-X,0),n.point(-X,i);else if(oe(e[0]-a[0])>ne){var o=e[0]<a[0]?X:-X;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Oi(e){var a=le(e),r=2*Ce,n=a>0,i=oe(a)>ne;function o(d,c,u,x){Ei(x,e,r,u,d,c)}function l(d,c){return le(d)*le(c)>a}function s(d){var c,u,x,f,b;return{lineStart:function(){f=x=!1,b=1},point:function(v,m){var y=[v,m],j,w=l(v,m),E=n?w?0:g(v,m):w?g(v+(v<0?X:-X),m):0;if(!c&&(f=x=w)&&d.lineStart(),w!==x&&(j=p(c,y),(!j||Mt(c,j)||Mt(y,j))&&(y[2]=1)),w!==x)b=0,w?(d.lineStart(),j=p(y,c),d.point(j[0],j[1])):(j=p(c,y),d.point(j[0],j[1],2),d.lineEnd()),c=j;else if(i&&c&&n^w){var A;!(E&u)&&(A=p(y,c,!0))&&(b=0,n?(d.lineStart(),d.point(A[0][0],A[0][1]),d.point(A[1][0],A[1][1]),d.lineEnd()):(d.point(A[1][0],A[1][1]),d.lineEnd(),d.lineStart(),d.point(A[0][0],A[0][1],3)))}w&&(!c||!Mt(c,y))&&d.point(y[0],y[1]),c=y,x=w,u=E},lineEnd:function(){x&&d.lineEnd(),c=null},clean:function(){return b|(f&&x)<<1}}}function p(d,c,u){var x=nt(d),f=nt(c),b=[1,0,0],v=qt(x,f),m=Et(v,v),y=v[0],j=m-y*y;if(!j)return!u&&d;var w=a*m/j,E=-a*y/j,A=qt(b,v),R=At(b,w),B=At(v,E);Zt(R,B);var C=A,M=Et(R,C),O=Et(C,C),L=M*M-O*(Et(R,R)-1);if(!(L<0)){var _=et(L),k=At(C,(-M-_)/O);if(Zt(k,R),k=da(k),!u)return k;var N=d[0],T=c[0],H=d[1],G=c[1],Z;T<N&&(Z=N,N=T,T=Z);var z=T-N,q=oe(z-X)<ne,I=q||z<ne;if(!q&&G<H&&(Z=H,H=G,G=Z),I?q?H+G>0^k[1]<(oe(k[0]-N)<ne?H:G):H<=k[1]&&k[1]<=G:z>X^(N<=k[0]&&k[0]<=T)){var P=At(C,(-M+_)/O);return Zt(P,R),[k,da(P)]}}}function g(d,c){var u=n?e:X-e,x=0;return d<-u?x|=1:d>u&&(x|=2),c<-u?x|=4:c>u&&(x|=8),x}return Gn(l,s,o,n?[0,-e]:[-X,e-X])}function qi(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],g=a[1],d=0,c=1,u=p-l,x=g-s,f;if(f=r-l,!(!u&&f>0)){if(f/=u,u<0){if(f<d)return;f<c&&(c=f)}else if(u>0){if(f>c)return;f>d&&(d=f)}if(f=i-l,!(!u&&f<0)){if(f/=u,u<0){if(f>c)return;f>d&&(d=f)}else if(u>0){if(f<d)return;f<c&&(c=f)}if(f=n-s,!(!x&&f>0)){if(f/=x,x<0){if(f<d)return;f<c&&(c=f)}else if(x>0){if(f>c)return;f>d&&(d=f)}if(f=o-s,!(!x&&f<0)){if(f/=x,x<0){if(f>c)return;f>d&&(d=f)}else if(x>0){if(f<d)return;f<c&&(c=f)}return d>0&&(e[0]=l+d*u,e[1]=s+d*x),c<1&&(a[0]=l+c*u,a[1]=s+c*x),!0}}}}}var pt=1e9,Tt=-pt;function Fi(e,a,r,n){function i(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function o(g,d,c,u){var x=0,f=0;if(g==null||(x=l(g,c))!==(f=l(d,c))||p(g,d)<0^c>0)do u.point(x===0||x===3?e:r,x>1?n:a);while((x=(x+c+4)%4)!==f);else u.point(d[0],d[1])}function l(g,d){return oe(g[0]-e)<ne?d>0?0:3:oe(g[0]-r)<ne?d>0?2:1:oe(g[1]-a)<ne?d>0?1:0:d>0?3:2}function s(g,d){return p(g.x,d.x)}function p(g,d){var c=l(g,1),u=l(d,1);return c!==u?c-u:c===0?d[1]-g[1]:c===1?g[0]-d[0]:c===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,c=Yn(),u,x,f,b,v,m,y,j,w,E,A,R={point:B,lineStart:L,lineEnd:_,polygonStart:M,polygonEnd:O};function B(N,T){i(N,T)&&d.point(N,T)}function C(){for(var N=0,T=0,H=x.length;T<H;++T)for(var G=x[T],Z=1,z=G.length,q=G[0],I,P,D=q[0],U=q[1];Z<z;++Z)I=D,P=U,q=G[Z],D=q[0],U=q[1],P<=n?U>n&&(D-I)*(n-P)>(U-P)*(e-I)&&++N:U<=n&&(D-I)*(n-P)<(U-P)*(e-I)&&--N;return N}function M(){d=c,u=[],x=[],A=!0}function O(){var N=C(),T=A&&N,H=(u=Hn(u)).length;(T||H)&&(g.polygonStart(),T&&(g.lineStart(),o(null,null,1,g),g.lineEnd()),H&&Wn(u,s,N,o,g),g.polygonEnd()),d=g,u=x=f=null}function L(){R.point=k,x&&x.push(f=[]),E=!0,w=!1,y=j=NaN}function _(){u&&(k(b,v),m&&w&&c.rejoin(),u.push(c.result())),R.point=B,w&&d.lineEnd()}function k(N,T){var H=i(N,T);if(x&&f.push([N,T]),E)b=N,v=T,m=H,E=!1,H&&(d.lineStart(),d.point(N,T));else if(H&&w)d.point(N,T);else{var G=[y=Math.max(Tt,Math.min(pt,y)),j=Math.max(Tt,Math.min(pt,j))],Z=[N=Math.max(Tt,Math.min(pt,N)),T=Math.max(Tt,Math.min(pt,T))];qi(G,Z,e,a,r,n)?(w||(d.lineStart(),d.point(G[0],G[1])),d.point(Z[0],Z[1]),H||d.lineEnd(),A=!1):H&&(d.lineStart(),d.point(N,T),A=!1)}y=N,j=T,w=H}return R}}const fa=e=>e;var ta=new Qe,ma=new Qe,Kn,Qn,xa,ha,$e={point:Te,lineStart:Te,lineEnd:Te,polygonStart:function(){$e.lineStart=Pi,$e.lineEnd=Ii},polygonEnd:function(){$e.lineStart=$e.lineEnd=$e.point=Te,ta.add(oe(ma)),ma=new Qe},result:function(){var e=ta/2;return ta=new Qe,e}};function Pi(){$e.point=Di}function Di(e,a){$e.point=Xn,Kn=xa=e,Qn=ha=a}function Xn(e,a){ma.add(ha*e-xa*a),xa=e,ha=a}function Ii(){Xn(Kn,Qn)}var rt=1/0,Ft=rt,vt=-rt,Pt=vt,Dt={point:Bi,lineStart:Te,lineEnd:Te,polygonStart:Te,polygonEnd:Te,result:function(){var e=[[rt,Ft],[vt,Pt]];return vt=Pt=-(Ft=rt=1/0),e}};function Bi(e,a){e<rt&&(rt=e),e>vt&&(vt=e),a<Ft&&(Ft=a),a>Pt&&(Pt=a)}var ga=0,ba=0,ut=0,It=0,Bt=0,at=0,va=0,ya=0,ft=0,Jn,Zn,qe,Fe,Ae={point:Xe,lineStart:un,lineEnd:fn,polygonStart:function(){Ae.lineStart=Ui,Ae.lineEnd=Vi},polygonEnd:function(){Ae.point=Xe,Ae.lineStart=un,Ae.lineEnd=fn},result:function(){var e=ft?[va/ft,ya/ft]:at?[It/at,Bt/at]:ut?[ga/ut,ba/ut]:[NaN,NaN];return ga=ba=ut=It=Bt=at=va=ya=ft=0,e}};function Xe(e,a){ga+=e,ba+=a,++ut}function un(){Ae.point=$i}function $i(e,a){Ae.point=_i,Xe(qe=e,Fe=a)}function _i(e,a){var r=e-qe,n=a-Fe,i=et(r*r+n*n);It+=i*(qe+e)/2,Bt+=i*(Fe+a)/2,at+=i,Xe(qe=e,Fe=a)}function fn(){Ae.point=Xe}function Ui(){Ae.point=Hi}function Vi(){er(Jn,Zn)}function Hi(e,a){Ae.point=er,Xe(Jn=qe=e,Zn=Fe=a)}function er(e,a){var r=e-qe,n=a-Fe,i=et(r*r+n*n);It+=i*(qe+e)/2,Bt+=i*(Fe+a)/2,at+=i,i=Fe*e-qe*a,va+=i*(qe+e),ya+=i*(Fe+a),ft+=i*3,Xe(qe=e,Fe=a)}function tr(e){this._context=e}tr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Le);break}}},result:Te};var wa=new Qe,aa,ar,nr,mt,xt,yt={point:Te,lineStart:function(){yt.point=Yi},lineEnd:function(){aa&&rr(ar,nr),yt.point=Te},polygonStart:function(){aa=!0},polygonEnd:function(){aa=null},result:function(){var e=+wa;return wa=new Qe,e}};function Yi(e,a){yt.point=rr,ar=mt=e,nr=xt=a}function rr(e,a){mt-=e,xt-=a,wa.add(et(mt*mt+xt*xt)),mt=e,xt=a}let mn,$t,xn,hn;class gn{constructor(a){this._append=a==null?or:Wi(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==xn||this._append!==$t){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,xn=n,$t=this._append,hn=this._,this._=i}this._+=hn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function or(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Wi(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return or;if(a!==mn){const r=10**a;mn=a,$t=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return $t}function Gi(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),tt(s,i(o))),o.result()}return l.area=function(s){return tt(s,i($e)),$e.result()},l.measure=function(s){return tt(s,i(yt)),yt.result()},l.bounds=function(s){return tt(s,i(Dt)),Dt.result()},l.centroid=function(s){return tt(s,i(Ae)),Ae.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,fa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new gn(r)):new tr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new gn(r)),l},l.projection(e).digits(r).context(a)}function Ta(e){return function(a){var r=new ka;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ka(){}ka.prototype={constructor:ka,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function La(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),tt(r,e.stream(Dt)),a(Dt.result()),n!=null&&e.clipExtent(n),e}function ir(e,a,r){return La(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Ki(e,a,r){return ir(e,[[0,0],a],r)}function Qi(e,a,r){return La(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Xi(e,a,r){return La(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var bn=16,Ji=le(30*Ce);function vn(e,a){return+a?es(e,a):Zi(e)}function Zi(e){return Ta({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function es(e,a){function r(n,i,o,l,s,p,g,d,c,u,x,f,b,v){var m=g-n,y=d-i,j=m*m+y*y;if(j>4*a&&b--){var w=l+u,E=s+x,A=p+f,R=et(w*w+E*E+A*A),B=bt(A/=R),C=oe(oe(A)-1)<ne||oe(o-c)<ne?(o+c)/2:gt(E,w),M=e(C,B),O=M[0],L=M[1],_=O-n,k=L-i,N=y*_-m*k;(N*N/j>a||oe((m*_+y*k)/j-.5)>.3||l*u+s*x+p*f<Ji)&&(r(n,i,o,l,s,p,O,L,C,w/=R,E/=R,A,b,v),v.point(O,L),r(O,L,C,w,E,A,g,d,c,u,x,f,b,v))}}return function(n){var i,o,l,s,p,g,d,c,u,x,f,b,v={point:m,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=E},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function m(B,C){B=e(B,C),n.point(B[0],B[1])}function y(){c=NaN,v.point=j,n.lineStart()}function j(B,C){var M=nt([B,C]),O=e(B,C);r(c,u,d,x,f,b,c=O[0],u=O[1],d=B,x=M[0],f=M[1],b=M[2],bn,n),n.point(c,u)}function w(){v.point=m,n.lineEnd()}function E(){y(),v.point=A,v.lineEnd=R}function A(B,C){j(i=B,C),o=c,l=u,s=x,p=f,g=b,v.point=j}function R(){r(c,u,d,x,f,b,o,l,i,s,p,g,bn,n),v.lineEnd=w,w()}return v}}var ts=Ta({point:function(e,a){this.stream.point(e*Ce,a*Ce)}});function as(e){return Ta({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function ns(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function yn(e,a,r,n,i,o){if(!o)return ns(e,a,r,n,i);var l=le(o),s=de(o),p=l*e,g=s*e,d=l/e,c=s/e,u=(s*r-l*a)/e,x=(s*a+l*r)/e;function f(b,v){return b*=n,v*=i,[p*b-g*v+a,r-g*b-p*v]}return f.invert=function(b,v){return[n*(d*b-c*v+u),i*(x-c*b-d*v)]},f}function rs(e){return os(function(){return e})()}function os(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,g=0,d,c=0,u=1,x=1,f=null,b=pn,v=null,m,y,j,w=fa,E=.5,A,R,B,C,M;function O(N){return B(N[0]*Ce,N[1]*Ce)}function L(N){return N=B.invert(N[0],N[1]),N&&[N[0]*Be,N[1]*Be]}O.stream=function(N){return C&&M===N?C:C=ts(as(d)(b(A(w(M=N)))))},O.preclip=function(N){return arguments.length?(b=N,f=void 0,k()):b},O.postclip=function(N){return arguments.length?(w=N,v=m=y=j=null,k()):w},O.clipAngle=function(N){return arguments.length?(b=+N?Oi(f=N*Ce):(f=null,pn),k()):f*Be},O.clipExtent=function(N){return arguments.length?(w=N==null?(v=m=y=j=null,fa):Fi(v=+N[0][0],m=+N[0][1],y=+N[1][0],j=+N[1][1]),k()):v==null?null:[[v,m],[y,j]]},O.scale=function(N){return arguments.length?(r=+N,_()):r},O.translate=function(N){return arguments.length?(n=+N[0],i=+N[1],_()):[n,i]},O.center=function(N){return arguments.length?(o=N[0]%360*Ce,l=N[1]%360*Ce,_()):[o*Be,l*Be]},O.rotate=function(N){return arguments.length?(s=N[0]%360*Ce,p=N[1]%360*Ce,g=N.length>2?N[2]%360*Ce:0,_()):[s*Be,p*Be,g*Be]},O.angle=function(N){return arguments.length?(c=N%360*Ce,_()):c*Be},O.reflectX=function(N){return arguments.length?(u=N?-1:1,_()):u<0},O.reflectY=function(N){return arguments.length?(x=N?-1:1,_()):x<0},O.precision=function(N){return arguments.length?(A=vn(R,E=N*N),k()):et(E)},O.fitExtent=function(N,T){return ir(O,N,T)},O.fitSize=function(N,T){return Ki(O,N,T)},O.fitWidth=function(N,T){return Qi(O,N,T)},O.fitHeight=function(N,T){return Xi(O,N,T)};function _(){var N=yn(r,0,0,u,x,c).apply(null,a(o,l)),T=yn(r,n-N[0],i-N[1],u,x,c);return d=Ci(s,p,g),R=pa(a,T),B=pa(d,R),A=vn(R,E),k()}function k(){return C=M=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&L,_()}}function sr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}sr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(oe(i)>ne&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function is(){return rs(sr).scale(175.295)}function ss(e){return e}function ls(e){if(e==null)return ss;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var g=2,d=s.length,c=new Array(d);for(c[0]=(a+=s[0])*n+o,c[1]=(r+=s[1])*i+l;g<d;)c[g]=s[g],++g;return c}}function ds(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function cs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return wn(e,r)})}:wn(e,a)}function wn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ps(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ps(e,a){var r=ls(e.transform),n=e.arcs;function i(d,c){c.length&&c.pop();for(var u=n[d<0?~d:d],x=0,f=u.length;x<f;++x)c.push(r(u[x],x));d<0&&ds(c,f)}function o(d){return r(d)}function l(d){for(var c=[],u=0,x=d.length;u<x;++u)i(d[u],c);return c.length<2&&c.push(c[0]),c}function s(d){for(var c=l(d);c.length<4;)c.push(c[0]);return c}function p(d){return d.map(s)}function g(d){var c=d.type,u;switch(c){case"GeometryCollection":return{type:c,geometries:d.geometries.map(g)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:c,coordinates:u}}return g(a)}const lr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},us=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function fs(e,a,r){const n=lr[e];if(!n||!n.length)return-1;const i=us(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Lt=null;function ms(){return Lt||(Lt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=cs(r,n),o=is().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Gi(o),s=(i.features||[]).filter(d=>{var c;return(((c=d.properties)==null?void 0:c.name)||"")!=="Antarctica"}).map(d=>{var x;const c=((x=d.properties)==null?void 0:x.name)||"",u=l(d)||"";return u?{i2:Hr(c)||null,n:c,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,c]of Object.entries(Yr)){const u=o(c);u&&(p[d]={x:u[0],y:u[1]})}const g={};for(const[d,c]of Object.entries(lr)){const u=c.map(x=>o(x.ll)).filter(x=>!!x).map(([x,f])=>({x,y:f}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:g}}catch{return null}})(),Lt)}function xs(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return ms().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const hs={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},kn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function jn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function gs(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var g;if(!i)return;const p=(g=e.current)==null?void 0:g.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function bs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:g,dossiers:d}=F(),c=g.loading&&!d.length,u=h.useRef(null),x=h.useRef(null),f=xs(e.continent==="monde"),b=e.continent==="monde"?f:Ea.find(k=>k.key===e.continent)||null,v=gs(u,e.continent+":"+e.mapFolded+":"+!!b),[m,y]=h.useState(new Map),[j,w]=h.useState(null);h.useEffect(()=>{const k=u.current;if(!k)return;const N=new Map;k.querySelectorAll("path[data-i2]").forEach(T=>{const H=T.dataset.i2;if(H)try{const G=T.getBBox();G.width>0&&N.set(H,{x:G.x,y:G.y,w:G.width,h:G.height})}catch{}}),y(N)},[e.continent,v,b]);const E=h.useMemo(()=>r.filter(k=>k.cc),[r]),A=h.useMemo(()=>{const k=new Map;return E.forEach(N=>k.set(N.cc,(k.get(N.cc)||0)+1)),k},[E]),R=e.continent==="monde"&&f?f.anchors:null,B=e.continent==="monde"&&f?f.metros:null,C=h.useMemo(()=>E.map(k=>{const N=jn(k.name||k.id||""),T=jn((k.id||k.name||"")+"·y");if(R&&k.cc){const q=B?B[k.cc]:void 0;if(q&&q.length){const P=fs(k.cc,k.city,N);if(P>=0&&q[P])return{d:k,x:q[P].x+(N-.5)*5,y:q[P].y+(T-.5)*5}}const I=R[k.cc];if(I)return{d:k,x:I.x+(N-.5)*10,y:I.y+(T-.5)*10}}const H=k.cc?m.get(k.cc):void 0;if(!H)return null;const G=hs[`${e.continent}:${k.cc||""}`];if(G)return{d:k,x:H.x+H.w*(G.fx+(N-.5)*G.sx),y:H.y+H.h*(G.fy+(T-.5)*G.sy)};const Z=(N-.5)*Math.min(H.w*.55,60),z=(T-.5)*Math.min(H.h*.55,60);return{d:k,x:H.x+H.w/2+Z,y:H.y+H.h/2+z}}).filter(k=>!!k),[E,m,R,B,e.continent]),M=k=>v>0?k/v:k,O=h.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:kn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(N=>N.kind==="target"&&je(N)===k).length})).filter(k=>k.n>0):$a.map((k,N)=>({...k,n:r.filter(T=>_a(T)===N).length})),[r,n,p.plabels]),L=o?l.get(o):null,_=L?C.find(k=>k.d.id===L.id):null;return b?t.jsxs("div",{className:"mapzone"+(c?" waiting":""),ref:x,children:[t.jsxs("svg",{ref:u,viewBox:b.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?b.fr:b.en,onMouseLeave:()=>{w(null),i(null)},children:[t.jsx("g",{children:b.countries.map((k,N)=>t.jsx("g",{className:"ct"+(k.i2&&A.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},N))}),t.jsx("g",{children:C.map(k=>{const N=$a[_a(k.d)],T=!!me(k.d),H=k.d.kind==="target",G=n&&H?kn[je(k.d)]:N.c,Z=!n&&Ee(k.d);return t.jsxs("g",{className:"co"+(Z?" done":""),onMouseEnter:()=>{var I,P;const z=(I=x.current)==null?void 0:I.getBoundingClientRect(),q=(P=u.current)==null?void 0:P.createSVGPoint();if(q&&u.current&&z){q.x=k.x,q.y=k.y;const D=q.matrixTransform(u.current.getScreenCTM());w({x:D.x-z.left,y:D.y-z.top,label:k.d.name+" · "+(st(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{w(null),i(null)},onClick:()=>{var I;const z=(I=u.current)==null?void 0:I.createSVGPoint();let q=null;if(z&&u.current){z.x=k.x,z.y=k.y;const P=z.matrixTransform(u.current.getScreenCTM());q={x:P.x,y:P.y}}a({type:"popup",id:k.d.id,anchor:q})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:M(Math.max(11,N.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:M(N.px),fill:G,stroke:T?"#DC2626":"#ffffff",strokeWidth:M(T?2.2:1.3)})]},k.d.id||k.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:M(13),fill:"none",stroke:"#0F172A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:O.map((k,N)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},N))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:x})}function vs(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function ys(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(f=>f.continent===e.continent),[r,e.continent]),g=f=>p.filter(b=>f!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Aa(b,s,i,f==="country"?void 0:f)),d=h.useMemo(()=>{const f=g("win"),b=v=>f.filter(m=>(m.date?Math.max(0,Math.floor((Date.now()-Date.parse(m.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),f.length]},[p,s,i]),c=h.useMemo(()=>s.day?g("win").filter(f=>(f.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),x=(f,b,v,m="fbtn")=>t.jsxs("button",{type:"button",className:m,"aria-expanded":e.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},f);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(vs(s.day,l)),t.jsx("b",{children:c})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[n.dates[b],t.jsx("b",{children:d[b]})]},f))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):x("sec",n.fSector,s.sector.length),x("pay",n.fCountry,s.country.length),x("det",n.fEngine,s.engine.length),x("sta",n.fStage,s.stage.length),i&&x("ang","Angle",s.angle.length),i&&x("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(ws,{poolFor:g})]})}function ws({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:g}=h.useMemo(()=>{if(l==="sig"){const f=e("signal").filter(m=>me(m)),b=new Map;f.forEach(m=>{const y=m.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:f.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...oa([...b.keys()],i).map(m=>({v:m,label:Ke(m)+" "+Pe(m,i),n:b.get(m)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(m)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const f=e("sector"),b=new Map;return f.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const f=e("country"),b=new Map;return f.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:st(v,i)||v,n:m,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const f=e("engine"),b=new Map;return f.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:oa([...b.keys()],i).map(v=>({v,label:Ke(v)+" "+Pe(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Wr(Gr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const f=e("angle"),b=new Map;return f.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v.replace(/[_-]+/g," "),n:m,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const f=e("memoLevel"),b=new Map;f.forEach(m=>{if(m.kind==="target"){const y=Sa(m);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(m=>({v:String(m),label:v[m],n:b.get(m)||0,html:!1,on:o.memoLevel.includes(m)}))}}const u=e("stage"),x=new Map;return u.forEach(f=>{f.stage&&x.set(f.stage,(x.get(f.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...x.entries()].sort((f,b)=>b[1]-f[1]).map(([f,b])=>({v:f,label:f,n:b,html:!1,on:o.stage.includes(f)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const f=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},c=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:c,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function dr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function ks(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Nn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function cr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Nn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Nn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function js({card:e,onEvaluate:a,onAddAll:r}){var s,p,g;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:dr(e.summary_md||"").map((d,c)=>t.jsx("p",{children:d},c))})]}),t.jsx(cr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Ns(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Ss({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[p,g]=h.useState(null),[d,c]=h.useState(null),[u,x]=h.useState(null),[f,b]=h.useState(!1);h.useEffect(()=>{let m=!0;return(async()=>{const y=await Fn({email:l,cbToken:s});m&&g(y)})(),()=>{m=!1}},[l,s,n]);const v=m=>{c(m),x(null),b(!0),(async()=>{const y=await Kr(m.id);x(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{c(null),x(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[Ns(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?o.rsPub:o.rsPriv})]},m.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),f&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!f&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!f&&u&&t.jsx(js,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Sn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Cs(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:g,data:d,canWrite:c,source:u}=F(),x=a==="client",f=h.useMemo(()=>r||(u!=="default"?Qr():""),[r,u]),[b,v]=h.useState(""),[m,y]=h.useState(!1),[j,w]=h.useState(""),[E,A]=h.useState(!1),[R,B]=h.useState(""),[C,M]=h.useState([]),O=h.useRef(!1),[L,_]=h.useState(!1),[k,N]=h.useState(""),[T,H]=h.useState(""),[G,Z]=h.useState(!1),[z,q]=h.useState(0),[I,P]=h.useState(""),[D,U]=h.useState(null),[W,J]=h.useState(null),[re,ue]=h.useState(!1),[ce,Q]=h.useState(null),[te,be]=h.useState(0),K=h.useRef(!1),ie=b.trim()?Sn.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,ee=h.useMemo(()=>j.split(`
`).map($=>$.trim()).filter(Boolean).slice(0,15),[j]);h.useEffect(()=>{if(typeof window>"u")return;const $=(new URLSearchParams(window.location.search).get("rs")||"").trim();!$||!/^https?:\/\//i.test($)||(N($),_(!0))},[]),h.useEffect(()=>{const $=ae=>{var ve;const se=String(((ve=ae.detail)==null?void 0:ve.url)||"").trim();!se||!/^https?:\/\//i.test(se)||(N(se),_(!0))};return window.addEventListener("ppmap:research",$),()=>window.removeEventListener("ppmap:research",$)},[]),h.useEffect(()=>{if(!c&&!f){Q(null);return}let $=!0;return(async()=>{const ae=await Fn({email:n,cbToken:f});$&&Q(ae.length)})(),()=>{$=!1}},[c,f,n,te]);const _e=C.length?C:p,fe=d.credits,xe=h.useCallback($=>{const ae=$.map(se=>(se||"").trim()).filter(Boolean);ae.length&&(w(se=>{const ve=se.split(`
`).map(Se=>Se.trim()).filter(Boolean),Ue=new Set(ve.map(Se=>Se.toLowerCase())),we=ae.filter(Se=>!Ue.has(Se.toLowerCase()));return[...ve,...we].slice(0,15).join(`
`)}),y(!0))},[]);h.useEffect(()=>{if(!G)return;q(0);const $=window.setInterval(()=>q(ae=>ae+1),1e3);return()=>window.clearInterval($)},[G]);const De=()=>{const $=b.trim();$&&(i(null,$),v(""))},He=async()=>{if(!x){i(null,ee[0]||"");return}if(!ee.length||E)return;A(!0),O.current=!1;const $=[];for(let ae=0;ae<ee.length&&!O.current;ae++){B(e.evaluating(ae+1,ee.length,ee[ae]));const se=await Pn(r,ee[ae],"atelier2");if($.unshift({name:se.company||ee[ae],verdict:se.verdict,reason:se.reason||"",remaining:se.remaining??null}),M([...$]),se.verdict==="quota"){$.unshift({name:"",verdict:"quota",reason:e.quota(ee.length-ae-1),remaining:0}),M([...$]),w(ee.slice(ae+1).join(`
`)),B(""),A(!1);return}}B(""),w(O.current?ee.slice($.length).join(`
`):""),A(!1)},Ne=async()=>{var se,ve,Ue;if(K.current)return;const $=k.trim().replace(/\s+/g,""),ae=T.trim();if(!$&&!ae){P(e.rsNeed);return}if(!x&&!f){i(null,$||ae.slice(0,80));return}K.current=!0,P(""),U(null),J(null),Z(!0);try{const we=await Jr({url:$,text:ae,email:n,cbToken:f});if(Z(!1),!we||we.status!=="success"){P((we==null?void 0:we.message)||"Erreur");return}U(we),_(!1),xe((((se=we.prospective)==null?void 0:se.companies_to_evaluate)||[]).map(Ve=>(Ve==null?void 0:Ve.name)||"")),J({state:"pending"});const Se=await Zr(we,{email:n,cbToken:f});J(Se.ok?{state:"ok",scopeLabel:((ve=Se.summary)==null?void 0:ve.scope_label)||"",scope:((Ue=Se.summary)==null?void 0:Ue.scope)||""}:{state:"fail",msg:Se.error||""}),Se.ok&&be(Ve=>Ve+1)}finally{K.current=!1,Z(!1)}},Ie=[D==null?void 0:D.industry,...(D==null?void 0:D.market_tags)||[],D==null?void 0:D.author].map($=>($||"").trim()).filter(Boolean),lt=(W==null?void 0:W.state)==="pending",Ht=W&&(lt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):W.state==="ok"?t.jsx("span",{className:"rslink ok",children:W.scope&&W.scope!=="public"?e.rsSavedIn(W.scopeLabel||W.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:W.msg,children:e.rsSaveFail})),Yt=ks(D).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:$=>v($.target.value),onKeyDown:$=>{$.key==="Enter"&&De()}}),t.jsx("span",{className:"detect"+(Sn.test(b.trim())?" url":""),children:ie})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:De,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),g.showCredits&&fe&&t.jsxs("button",{type:"button",className:"credits"+(fe.total_available<=0&&!fe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:fe.unlimited?"∞":fe.total_available}),!fe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",fe.daily_grant+fe.purchased]}),fe.total_available<=0&&!fe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!m),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(L?" on":""),onClick:()=>_(!L),children:e.rsOpen}),ce!==null&&ce>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>ue(!re),children:e.rsArchOpen(ce)})]}),re&&t.jsx(Ss,{bump:te,cbToken:f,onClose:()=>ue(!1),onEvaluate:$=>i(null,$),onAddAll:xe}),L&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:k,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:$=>N($.target.value),onKeyDown:$=>{$.key==="Enter"&&Ne()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:T,placeholder:e.rsTextPh,onChange:$=>H($.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(G?" loading":""),style:{justifyContent:"center"},disabled:G||lt||!k.trim()&&!T.trim(),onClick:()=>{Ne()},children:[t.jsx("span",{className:"fill"}),G?`${Xr(k.trim())==="youtube"&&k.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(z)}`:lt?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),I&&t.jsx("div",{className:"rserr",children:I}),D&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:D.title}),D.source_url&&t.jsx("a",{href:D.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{U(null),J(null)},children:"×"})]}),D.market&&t.jsx("p",{className:"rsmk",children:D.market}),Ie.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Ie.map($=>t.jsx("span",{children:$},$))]}),t.jsxs("div",{className:"rsbody",children:[D.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${D.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:dr(D.summary_md||"").map(($,ae)=>t.jsx("p",{children:$},ae))})]}),t.jsx(cr,{card:D,onEvaluate:$=>i(null,$),onAddAll:xe}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Yt)}),Ht]})]}),m&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:j,placeholder:e.bulkPh,onChange:$=>w($.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(E?" loading":""),style:{justifyContent:"center"},disabled:E||!ee.length,onClick:()=>{He()},children:[t.jsx("span",{className:"fill"}),E&&R?R:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(ee.length)})]})]}),_e.slice(0,1).map(($,ae)=>{const se=$.verdict==="kept",ve=$.verdict==="quota",Ue=se?"var(--brand)":ve?"var(--bolt)":"var(--red)",we=se?"var(--brand-l)":ve?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ue,"--bgc":we},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:se?"✓ "+e.kept:ve?"⏳":"✗ "+e.dropped})}),$.name&&t.jsx("span",{className:"rn",children:$.name}),t.jsx("span",{className:"rr",children:$.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",$.reason]}):null}),!ve&&t.jsx("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"space"}),children:e.seeSpace(se?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),x&&(o.kept+o.dropped>0||_e.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Es(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function As(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=F(),o=e.memoConsole?r.get(e.memoConsole):null,l=h.useMemo(()=>o?[o.reasoning||"",Es(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=Ze(o),p=Sa(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[wt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const na={},Cn=(na==null?void 0:na.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function En(){return new Date().toISOString().slice(0,10)}const Ra=h.createContext(null);function zs(){return h.useContext(Ra)}function Ts(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(i=>/en bref/i.test(i.textContent||"")&&i.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(i=>(i.textContent||"").replace(/\s+/g," ").trim()).filter(i=>i.length>3).slice(0,4)}catch{return[]}}function Ls(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),s.querySelectorAll("*").forEach(p=>{const g=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(d=>p.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(p.setAttribute("href",g),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Rs(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Ms(){const{ed:e,isEn:a,day:r,loading:n}=pr(),i=h.useMemo(()=>Ts((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const o=Rs(r,a);return i.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+o}),t.jsx("ul",{children:i.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${o}.`:`Édition du ${o}.`})]})}function pr(){const e=h.useContext(Ra);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Os({token:e,children:a}){const{dispatch:r,st:n,lang:i}=F(),[o,l]=h.useState(()=>n.filters.day||En()),[s,p]=h.useState(null),[g,d]=h.useState(!1),c=h.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=h.useCallback(()=>{l(En());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);h.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),h.useEffect(()=>{const b=v=>{var y;const m=(y=v.detail)==null?void 0:y.day;typeof m=="string"&&c(m)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[c]),h.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),h.useEffect(()=>{if(!e||!o)return;let b=!1;d(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Cn}/cibles/edition.json?${v}`).then(m=>m.json()).then(m=>{b||p(m)}).catch(()=>{b||p({ok:!1,error:"network"})}).finally(()=>{b||d(!1)}),()=>{b=!0}},[e,o]);const x=h.useMemo(()=>`${Cn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),f=h.useMemo(()=>({token:e,day:o,ed:s,loading:g,pickDay:c,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:x,isEn:i==="en"}),[e,o,s,g,c,u,n.filters.day,x,i]);return t.jsx(Ra.Provider,{value:f,children:a})}function qs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=pr();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(eo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function ur({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=F(),[l,s]=h.useState(!1),[p,g]=h.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const d=async()=>{if(l)return;s(!0);const c=await to(r,e);if(s(!1),!c){o(a.actErr);return}g(c.results||[])};return t.jsxs("div",{className:"simb",onClick:c=>c.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{d()},children:l?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(c=>t.jsxs("li",{children:[t.jsx("b",{className:c.verdict==="kept"?"ok":"ko",children:c.company}),c.reason&&t.jsx("span",{children:c.reason})]},c.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function Ut({spec:e}){const a=h.useRef(null),r=h.useRef(null),[n,i]=h.useState(!1);return h.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;return Ua({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{l=!0,o.replaceChildren()}},[e]),h.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;Ua({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!l&&p&&o.isConnected&&o.replaceChildren(p)});const s=p=>{p.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&it.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Fs=`
...
`;function Ps(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function Ds(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:g,doPromote:d,doRepeche:c,doApproach:u,doDeep:x,doOnboard:f,outbound:b,evalBusy:v}=F(),m=e.popupId?r.get(e.popupId):null;if(!m)return null;const y=me(m),j=je(m),w=Ze(m),E=m.kind==="target",A=R=>{a({type:"filters",patch:R}),a({type:"popup",id:null})};return it.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Fs}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Ps(e.popupAnchor,!!m.card),onClick:R=>R.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:m.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ot(m.date)),Pe(m.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[m.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[m.cc]}),children:(st(m.cc,i)||m.countryLabel||"").toUpperCase()}),m.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[m.sector]}),children:m.sector.toUpperCase()}),m.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[m.stage]}),children:m.stage.toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{className:"am2",children:kt(m.amountEur,i)})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Ke(m.engine)," ",t.jsx("b",{children:Pe(m.engine,i)})," — ",ao(m.engine,i),m.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",m.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Je,{o:m,lg:!0})," ",t.jsx(Vt,{o:m,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Dn(y,i))," · ",n.win7(In(y,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),m.card?t.jsx(Ut,{spec:m.card}):null,m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),o.pipe&&E&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof m.score=="number"&&m.score>0?" · "+n.score(m.score):""]})})]}),t.jsx(ur,{name:m.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(m,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(m,!1),a({type:"popup",id:null})},children:n.actNo}),wt(m)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{x(m),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),m.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:m.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{f(m),a({type:"popup",id:null})},children:"🚀"})]}):m.engine==="media"&&m.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var R;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"popup",id:null}),(R=document.querySelector(".atl2 .demand"))==null||R.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(m.name),onClick:()=>s(m),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)," →"]}),m.website&&t.jsx("a",{className:"psite",href:m.website.startsWith("http")?m.website:"https://"+m.website,target:"_blank",rel:"noopener noreferrer",title:m.website,children:"🌐"})]})]})]}),document.body)}const Is=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Rt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Bs(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Rt(a.slice(n));break}r+=Rt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Rt(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&Is.has(p)?r+=`<${s[1]}${p}>`:r+=Rt(a.slice(i,o+1)),n=o+1}return r}const An=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ye({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function $s(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function _s({o:e}){const{t:a,doDeep:r}=F(),n=Ze(e),i=[e.reasoning||"",$s(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),i.length?i.join(`

`).split(`

`).map((o,l)=>t.jsx("p",{className:"cdtxt",children:o},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[wt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:o=>{o.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:o=>o.stopPropagation(),children:a.memoOpenFull})]})]})}function Us({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=F(),o=_t(e),l=Ze(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),c=h.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||wt(e)?1:0}].filter(b=>b.n>0),[e,a,s,l,p,g,d]),[u,x]=h.useState("");if(!c.length)return null;const f=c.some(b=>b.k===u)?u:c[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:c.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":f===b.k,className:f===b.k?"on":"",onClick:v=>{v.stopPropagation(),x(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[f==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(ye,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ye,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ye,{k:a.cdVerdictDate,v:An(e.verdictDate,r)})]})]}),f==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Bs(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Vs,{o:e})]}),f==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ye,{k:a.cdSector,v:e.sector}),t.jsx(ye,{k:a.cdStage,v:e.stage}),t.jsx(ye,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ye,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ye,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ye,{k:a.cdAngle,v:e.angle}),t.jsx(ye,{k:a.cdDetected,v:An(e.date,r)})]}),f==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ye,{k:a.cdName,v:e.contactName}),t.jsx(ye,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ye,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),f==="memo"&&t.jsx(_s,{o:e}),f==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(ye,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(ye,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Vs({o:e}){const{t:a,token:r}=F(),[n,i]=h.useState(!1),[o,l]=h.useState(null),s=async()=>{n||(i(!0),l(await no(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},g=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=g.some(([,c])=>c);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,c])=>c).map(([c,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:c}),t.jsx("p",{children:u})]},c)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!d&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const fr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ma({o:e}){const{t:a}=F(),r=_t(e),n=Ze(e),i=je(e),o=ra(e),l=ro(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(fr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const ja=e=>e.length>22?e.slice(0,21)+"…":e;function zn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=F(),[o,l]=h.useState(!1);if(h.useEffect(()=>{n||l(!1)},[n]),Ee(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(ja(e.name))})]})}function mr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:g,dispatch:d}=F();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:x=>{x.stopPropagation(),d({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:x=>{var f;x.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(f=document.querySelector(".atl2 .demand"))==null||f.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(zn,{o:e})});const c=je(e),u=x=>f=>{f.stopPropagation(),x()};if(c===0)return t.jsx("span",{className:"cell",children:t.jsx(zn,{o:e})});if(c===1){const x=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:x,onClick:u(()=>o(e)),children:x?a.actAnalyseQueued:a.actAnalyse})})}if(c===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(c===4){const x=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:x,onClick:u(()=>g(e)),children:x?a.actApproachSent:a.actApproach})})}return c===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):c===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function Hs({o:e}){const{t:a,doThumb:r,thumbOf:n}=F(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Ys({o:e}){const{lang:a}=F();return me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Je,{o:e}),t.jsx(Vt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Ke(e.engine||"")," ",Pe(e.engine||"",a)]})})}function Ws({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:g,toggleFav:d}=F(),c=je(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],x=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,f=x<=0?0:x<=7?1:x<=30?2:3,b=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][c]:u[f],v=g.has(e.id),m=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const j=y.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:j.left+Math.min(280,j.width/3),y:j.bottom}})};return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:m,children:[t.jsx("span",{className:"pt",style:{"--c":b}}),t.jsx(br,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),d(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Gs,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Ys,{o:e}),l.pipe&&t.jsx(Ma,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(mr,{o:e}),l.showThumbs&&t.jsx(Hs,{o:e})]}),r&&!a&&t.jsx(Qs,{o:e})]})}function Gs({o:e}){const{lang:a,caps:r}=F();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=kt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Ks({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=F(),l=(u,x=!1)=>f=>{f.stopPropagation(),x&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=kt(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ee(e),c=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":c?"var(--brand)":"var(--red)"},children:[c?"✓":"✗"," ",t.jsx("b",{children:c?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var x;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(x=document.querySelector(".atl2 .demand"))==null||x.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ja(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ja(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Ut,{spec:e.card})})]})}function Qs({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=F();return!i.pipe&&e.kind==="op"?t.jsx(Ks,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Us,{o:e}),t.jsx(ci,{o:e}),t.jsx(fi,{o:e}),t.jsx(ur,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Ma,{o:e})})]}),e.card&&t.jsx(Ut,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Ke(e.engine||"")," ",Pe(e.engine||"",r)]}),me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Je,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Xs({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=F();if(!i.pipe&&e.kind==="op"){const g=kt(e.amountEur,l),d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),c=(u,x=!1)=>f=>{f.stopPropagation(),x&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Ut,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:c({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:c({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:c({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Ke(e.engine||"")," ",Pe(e.engine||"",l)]}),me(e)&&t.jsx(Je,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(mr,{o:e})})]})}const s=je(e),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":p},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Ma,{o:e}),me(e)&&t.jsx(Je,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Js(){const{t:e}=F(),[a,r]=h.useState(0);return h.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Zs({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=i==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),p=s.includes(0)?0:s.sort((d,c)=>(e[c]||0)-(e[d]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:o?`${g} ${g>1?"files":"file"} in “${l(p)}”`:`${g} dossier${g>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function el(){var Z;const e=F(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:p,data:g,dossiers:d,source:c}=e,u=c==="ops"?8:$n,[x,f]=h.useState(new Set);h.useEffect(()=>{f(new Set)},[a.ptab,a.continent]);const[b,v]=h.useState(null);h.useEffect(()=>{v(null)},[a.ptab,a.continent]);const m=z=>f(q=>{const I=new Set(q);return I.has(z)?I.delete(z):I.add(z),I}),[y,j]=h.useState("all"),[w,E]=h.useState(!1);h.useEffect(()=>{j("all"),E(!1)},[a.ptab,a.continent]),h.useEffect(()=>{if(!w)return;const z=q=>{var I,P;(P=(I=q.target)==null?void 0:I.closest)!=null&&P.call(I,".atl2 .doable")||E(!1)};return document.addEventListener("click",z),()=>document.removeEventListener("click",z)},[w]);const A=zs(),R=h.useMemo(()=>{var q;const z=new Map;for(const I of Ls(((q=A==null?void 0:A.ed)==null?void 0:q.html)||""))z.has(I.t)||z.set(I.t,I.html);return z},[(Z=A==null?void 0:A.ed)==null?void 0:Z.html]),B=h.useCallback(z=>{if(z.decryptHtml)return z.decryptHtml;if(!R.size)return;const q=(z.name||"").trim().toLowerCase();if(q.length<3)return;const I=R.get(q);if(I)return I;for(const[P,D]of R)if(P.includes(q)||q.includes(P))return D},[R]),C=h.useMemo(()=>{const z=za(l,a.sort);return y==="all"?z:z.filter(q=>y==="explore"?!!q.noCo:!q.noCo)},[l,a.sort,c,y]),M=h.useMemo(()=>C.filter(z=>me(z)&&!Ee(z)).length,[C]),O=h.useMemo(()=>i.pipe?C:C.filter(z=>!Ee(z)&&!z.noCo),[C,i.pipe]),L=c==="ops"?C.filter(z=>z.noCo).length:0,_=i.pipe?n.plabels[a.ptab].toLowerCase():c==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,k=(z,q,I="",P=!1)=>t.jsxs("button",{type:"button","data-s":z,className:I,"aria-sort":a.sort.key===z?a.sort.dir===1?"ascending":"descending":"none",style:P?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:z}),children:[q,t.jsx("span",{className:"ar",children:a.sort.key===z&&a.sort.dir===1?"▴":"▾"})]},z),N=h.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const z=new Map;C.forEach(P=>{const D=P.engine||"?";z.has(D)||z.set(D,[]),z.get(D).push(P)});const q={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},I=oa([...z.keys()],s);return[...z.entries()].sort((P,D)=>{const U=q[P[0]]??10+I.indexOf(P[0]),W=q[D[0]]??10+I.indexOf(D[0]);return U-W})},[C,i.pipe,a.groupBy,s]),T=i.lockRowsAfter;let H=0;const G=(z,q)=>{let I=a.shown[q]||u;return z.length-I<=4&&(I=z.length),z.slice(0,I).map(U=>{const W=T!==null&&H>=T;H++;const J=B(U),re=J&&J!==U.decryptHtml?{...U,decryptHtml:J}:U,ue=a.dens!=="maxi"&&(a.dens==="deplie"||(b?b==="open":!!J)),ce=x.has(U.id)?!ue:ue;return a.dens==="maxi"?t.jsx(Xs,{o:re,locked:W},U.id):t.jsx(Ws,{o:re,locked:W,open:ce,onToggle:()=>m(U.id)},U.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:C.length})," ",_]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",c==="ops"&&C.length>0&&" — "+n.edSplit(C.length-L,L)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||c==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([z,q])=>t.jsxs("button",{type:"button","data-d":z,"aria-pressed":a.dens===z||z==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:z}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:q})]},z))}),(i.showFunnel||c==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":b==="open",onClick:()=>{v("open"),f(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":b==="closed",onClick:()=>{v("closed"),f(new Set)},children:n.foldAllLbl}),c==="ops"&&t.jsxs("button",{type:"button","aria-pressed":b===null,onClick:()=>{v(null),f(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||c==="ops")&&(()=>{var I;const z=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],q=((I=z.find(([P])=>P===y))==null?void 0:I[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":w,onClick:()=>E(P=>!P),children:[q,t.jsx("i",{children:"▾"})]}),w&&t.jsx("div",{className:"dolist",children:z.map(([P,D])=>t.jsx("button",{type:"button","aria-pressed":y===P,onClick:()=>{j(P),E(!1)},children:D},P))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:z=>r({type:"sort",key:z.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([z,q])=>t.jsx("option",{value:z,children:q},z))})]}),i.showChain&&O.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:O.map(z=>z.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(O.length):n.chainAll(O.length)]})]}),M>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(M)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),k("country",n.colCountry),k("name",n.colCompany),k("amount",n.colAmount,"h-amt",!0),k("stage",n.colStage,"h-stade"),k("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&k("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(c==="ops"?" opsl":"")+(C.length?"":" list-empty"),children:[N?N.map(([z,q])=>t.jsxs(h.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Ke(z)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Pe(z,s)}),t.jsx("div",{className:"s",children:n.grpCount(q.filter(I=>!Ee(I)).length,q.length)})]})]}),G(q,z)]},z)):G(C,"pt"+a.ptab),g.loading&&!d.length&&t.jsx(Js,{}),!C.length&&!(g.loading&&!d.length)&&(i.pipe?t.jsx(Zs,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const z=N||[["pt"+a.ptab,C]];let q=0,I=0;for(const[D,U]of z){I+=U.length;let W=a.shown[D]||u;U.length-W<=4&&(W=U.length),q+=Math.min(U.length,W)}const P=I-q;return P<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>z.forEach(([D,U])=>r({type:"more",group:D,by:U.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(P,P)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(q,I)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function Tn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function tl(e,a){const r=oo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function al(e,a){const n=[a.head.split("|").map(Tn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",tl(i,a.plabels),_t(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Tn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function nl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const rl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Oe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function ol({o:e,qa:a}){const{t:r,lang:n,fund:i}=F(),o=(e.cribleStatus||"").trim().toUpperCase()||(_t(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Ze(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Oe,{k:r.cdSector,v:e.sector}),t.jsx(Oe,{k:r.cdStage,v:e.stage}),t.jsx(Oe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Oe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Oe,{k:r.cdName,v:e.contactName}),t.jsx(Oe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Oe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Oe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Oe,{k:r.cdAngle,v:e.angle}),t.jsx(Oe,{k:r.cdDetected,v:rl(e.date,n)})]}),p.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function il(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=F(),[s,p]=h.useState({}),g=25,d=h.useMemo(()=>n.slice(0,g),[n]);h.useEffect(()=>{d.length&&io(r,d.map(x=>x.name)).then(p)},[r,d]);const c=o.stats,u=x=>x.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),c&&typeof c.screened=="number"&&t.jsxs("p",{children:[u(c.screened)," ",e.funScreened(""),typeof c.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(c.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(c.screened/o.marketEstimate*100)," %"]})]})]}),d.map(x=>t.jsx(ol,{o:x,qa:s[x.name]},x.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const sl=50;function Oa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=F(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(""),[c,u]=h.useState(0),[x,f]=h.useState(""),[b,v]=h.useState(!1),m=h.useRef(null);h.useEffect(()=>()=>{m.current&&window.clearInterval(m.current)},[]);const y=async w=>{p(!0),d("");const E=await a();if(p(!1),E.ok){l(E);return}if(E.busy){d(i.alertPreviewBusy);return}if(!w){d(i.alertPreviewFail);return}u(sl),m.current=window.setInterval(()=>{u(A=>A>1?A-1:(m.current&&window.clearInterval(m.current),y(!1),0))},1e3)},j=async()=>{if(n||b)return;v(!0),f("");const w=await r();v(!1),f(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||c>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{j()},children:b?"…":i.alertTest})]}),c>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(c)}),g&&t.jsx("p",{className:"mnote warn",children:g}),x&&t.jsx("p",{className:"mnote",children:x}),!x&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ht="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function ke({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=F();return it.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function ll(){const{st:e}=F();switch(e.modal){case"chain":return t.jsx(cl,{});case"space":return t.jsx(pl,{});case"alert":return t.jsx(ul,{});case"queue":return t.jsx(gl,{});case"export":return t.jsx(bl,{});case"plug":return t.jsx(wl,{});case"recharge":return t.jsx(jl,{});case"cover":return t.jsx(Sl,{});case"dossier":return t.jsx(Nl,{});case"crit":return t.jsx(Cl,{});case"tuto":return t.jsx(El,{});case"rdv":return t.jsx(dl,{});case"memoalert":return t.jsx(vl,{});default:return null}}function dl(){const{dispatch:e,fund:a}=F(),r=typeof document<"u"&&!!document.getElementById("rdv");return h.useEffect(()=>{r&&(e({type:"modal",modal:null}),ai())},[r,e]),r?null:t.jsx(co,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function cl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s}=F(),p=o==="client",g=e.chain.queue.map(x=>r.get(x)).filter(x=>!!x),d=e.chain.idx,c=g[d],u=d>=g.length;return it.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:u?n.finished:`${d+1} / ${g.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(u?100:d/Math.max(1,g.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:u||!c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(g.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:c.name}),t.jsx("div",{className:"sub",children:[st(c.cc,i)||c.countryLabel,c.sector,c.stage,n.daysAgo(ot(c.date))].filter(Boolean).map(x=>String(x).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Pe(c.engine,i).toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&t.jsx("span",{children:kt(c.amountEur,i)})]}),me(c)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Je,{o:c,lg:!0})," ",t.jsx(Vt,{o:c,src:!0})]}),(c.tagline||c.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:c.tagline||c.headline})]}),c.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:c.reasoning})]}),p&&Ee(c)&&t.jsxs("div",{className:"vbox",style:{"--c":Ge(c)==="retenu"?"var(--brand)":Ge(c)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ge(c)==="retenu"?"✓ "+n.kept:Ge(c)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:c.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!u&&c&&!(p&&Ee(c))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(c)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(u?{type:"modal",modal:null}:{type:"chainNext"}),children:u?n.closeBtn:n.skip})]})]})})}),document.body)}function pl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=F(),o=i==="client",l=h.useMemo(()=>o?r.filter(c=>Ee(c)):[],[r,o]),s=h.useMemo(()=>za(l.filter(c=>Ge(c)==="retenu"),{key:"signal",dir:-1}),[l]),p=h.useMemo(()=>l.filter(c=>Ge(c)==="ecarte"),[l]),g=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(ke,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(c=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof c.score=="number"&&c.score>0?c.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:c.name}),t.jsx("div",{className:"rr",children:c.reasoning||c.tagline||""})]})]},c.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function ul(){const{mode:e}=F();return e==="client"||e==="apercu"?t.jsx(fl,{}):t.jsx(hl,{})}function fl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),[o,l]=h.useState("d"),s=i!=="client";return t.jsxs(ke,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(ml,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(xl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(xr,{})]})}function ml({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(0);h.useEffect(()=>{let f=!0;return p(!1),Ya(a).then(b=>{f&&(b?l(b):p(!0))}),()=>{f=!1}},[a,g]);const c=f=>{r||Ya(a,f).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=f=>!o.sections||o.sections.includes(f),x=f=>{const b=o.sections||e.alertSec.map(([v])=>v);c({sections:u(f)?b.filter(v=>v!==f):[...b,f]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>c({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>c({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>c({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([f,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(f),disabled:r,onChange:()=>x(f)}),t.jsxs("span",{children:[b,f==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},f))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Oa,{label:e.alertPreview,readOnly:r,onPreview:()=>go(a),onTest:()=>ho(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function xl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(0);h.useEffect(()=>{let f=!0;return p(!1),Wa(a).then(b=>{f&&(b?l(b):p(!0))}),()=>{f=!1}},[a,g]);const c=f=>{r||Wa(a,f).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,x=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>c({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:f=>c({dow:Number(f.target.value)}),children:e.alertDow.map((f,b)=>t.jsx("option",{value:b,children:f},f))}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.max(6,x-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[x," h"]}),t.jsx("button",{type:"button",onClick:()=>c({hour:Math.min(21,x+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Oa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>vo(a),onTest:()=>bo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function xr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=F(),[l,s]=h.useState(o||""),[p,g]=h.useState(!1),[d,c]=h.useState(!1);h.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,x=h.useMemo(()=>n.filter(m=>me(m)).length,[n]),f=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){c(!0);try{await fetch(`${Na}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{c(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[f]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(m=>Pe(m,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(m=>st(m,r)||m).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([m,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:m}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},m))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:m=>s(m.target.value),onKeyDown:m=>{m.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,x)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function hl(){const{t:e}=F();return t.jsx(ke,{title:e.alertTitle,icon:"🔔",children:t.jsx(xr,{})})}function gl(){var b,v,m;const{t:e,token:a,fund:r,mode:n,flash:i}=F(),[o,l]=h.useState(null),[s,p]=h.useState([]),[g,d]=h.useState(0),c=n==="client";h.useEffect(()=>{let y=!0;return(async()=>{const[j,w]=await Promise.all([Ca(r),qn(a)]);y&&(j&&l(j),p(w))})(),()=>{y=!1}},[a,r,g]);const u=(o==null?void 0:o.per_day)??2,x=((b=o==null?void 0:o.analyzed_today)==null?void 0:b.length)??0,f=(v=o==null?void 0:o.tomorrow)!=null&&v.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(ke,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(x,x+(((m=o==null?void 0:o.pool_order)==null?void 0:m.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),c&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Ha(a,y.company,"retry").then(()=>d(j=>j+1))},children:e.queueRetry}),c&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Ha(a,y.company,"delete").then(()=>d(j=>j+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[f.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),f.slice(0,10).map((y,j)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",j+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function bl(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=F(),s=`${ht}/cibles/list.csv?token=${a}`,p=`${ht}/cibles/list.json?token=${a}`,g=`${ht}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,c=v=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:g,href:g}],x=!i.lockActions&&n.length>0,f=()=>{nl(al(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([m])=>m===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(ke,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),x&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:f,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:m,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c(m),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function vl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),o=i!=="client",[l,s]=h.useState(null),[p,g]=h.useState(!1),[d,c]=h.useState(0),[u,x]=h.useState(!1);h.useEffect(()=>{let m=!0;return g(!1),Va(a).then(y=>{m&&(y?s(y):g(!0))}),()=>{m=!1}},[a,d]);const f=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=m=>{if(o||!l)return;const y={enabled:m.enabled??!!l.enabled,email:m.email??(l.email||""),sections:m.sections??f()};x(!0),Va(a,y).then(j=>{if(x(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(p)return t.jsx(ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(m=>m+1),children:e.retry})]})});if(!l)return t.jsx(ke,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=f();return t.jsxs(ke,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(yl,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:m=>b({email:m})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([m,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[m],disabled:o||u,onChange:()=>b({sections:{...v,[m]:!v[m]}})}),t.jsx("span",{children:y})]},m))}),t.jsx(Oa,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>lo(a,v),onTest:()=>so(a,v)})]})}function yl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=h.useState(e);h.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function wl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=F(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[g,d]=h.useState(null),[c,u]=h.useState(""),[x,f]=h.useState(0);h.useEffect(()=>{let m=!0;return p(!1),ia(a).then(y=>{m&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),uo(a).then(y=>{m&&d(y)}),()=>{m=!1}},[a,x]);const b=(m,y)=>{i&&ia(a,m).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}m.test&&j.sent===!1?n(e.plugTestThrottled):r(y),f(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(ke,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>f(m=>m+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:c,disabled:!i,onChange:m=>u(m.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!c.trim(),onClick:()=>b({url:c.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(kl,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function kl(){const{t:e,token:a,lang:r}=F(),[n,i]=h.useState("valides"),[o,l]=h.useState(!1),[s,p]=h.useState(null),[g,d]=h.useState(null),[c,u]=h.useState(!1),[x,f]=h.useState(!1),[b,v]=h.useState(null),[m,y]=h.useState(null),[j,w]=h.useState(null),E=`atl2:bulk:${a}:${n}`;h.useEffect(()=>{ia(a).then(L=>{y(L&&L.configured?L.url_hint||"webhook":null)})},[a]),h.useEffect(()=>{p(null),d(null),u(!1),v(null);try{const L=JSON.parse(localStorage.getItem(E)||"null");w(L&&Date.now()-Date.parse(L.t)<24*3600*1e3?L:null)}catch{w(null)}},[E]);const A=async()=>{l(!0),u(!1),v(null);const L=await mo(a,n);p(L),d(L.ok?n:null),l(!1)},R=h.useRef(!1),B=async()=>{if(R.current)return;R.current=!0,f(!0);const L=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await xo(a,n,"webhook",void 0,L)}finally{R.current=!1}if(f(!1),u(!1),v(_),_.ok&&(_.pushed||0)>0){const k={t:new Date().toISOString(),n:_.pushed||0};w(k);try{localStorage.setItem(E,JSON.stringify(k))}catch{}}},C=s!=null&&s.ok&&s.ready||0,M=!!(s!=null&&s.ok)&&g===n&&C>0&&!!m&&!j,O=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:L=>i(L.target.value),children:e.plugBulkTabs.map(([L,_])=>t.jsx("option",{value:L,children:_},L))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{A()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(O,j.n)}),!j&&!!(s!=null&&s.ok)&&!m&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),M&&!c&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),M&&c&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(C,m||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:x,onClick:()=>{B()},children:x?e.bulkSending:e.bulkConfirm(m||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:x,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function jl(){const{t:e,data:a,lang:r}=F(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${Na}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(ke,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Nl(){const{t:e}=F();return t.jsx(ke,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(il,{})})}function Sl(){const{t:e,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:l}=F(),[s,p]=h.useState(null),[g,d]=h.useState(!1);h.useEffect(()=>{let A=!0;return Ca(i).then(R=>{A&&R&&typeof R.per_day=="number"&&p(R.per_day)}),()=>{A=!1}},[i]);const c=r.stats,u=typeof(c==null?void 0:c.screened)=="number"?c.screened:n.filter(A=>A.kind==="target"&&Ee(A)).length,x=r.marketEstimate||0,f=x>0?Math.min(100,Math.round(u/x*100)):null,b=(c==null?void 0:c.window_days)||30,v=u>0?u/b:0,m=x>0?Math.max(0,x-u):0,j=x>0&&v>0&&u>=100?Math.round(m/v):null,w=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),E=A=>{g||!o||(d(!0),fo(i,A).then(R=>{if(d(!1),R===null){l(e.actErr);return}p(R),l(e.alertSaved)}))};return t.jsxs(ke,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(u))}),x>0&&t.jsx("span",{children:e.covOf(w(x))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),j!==null&&t.jsx("p",{className:"mnote",children:e.covEta(j)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),v>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(v))}),c&&t.jsxs("div",{className:"covf",children:[typeof c.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.kept)})," ",e.covKept]}),typeof c.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.analyzed)})," ",e.covAna]}),typeof c.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(c.shown)})," ",e.covShown]})]}),o&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:s===A?"on":"",disabled:g,onClick:()=>E(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Cl(){var m,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o}=F(),l=n==="client",s=h.useMemo(()=>{const w=new Set;return a.forEach(E=>{E.angle&&w.add(E.angle)}),[...w]},[a]),[p,g]=h.useState(null);h.useEffect(()=>{let w=!0;return po(r).then(E=>{w&&g(E.thumbs)}),()=>{w=!1}},[r]);const[d,c]=h.useState(""),[u,x]=h.useState(""),[f,b]=h.useState(!1),v=async()=>{const w=d.trim();if(!(!w||f||!l)){b(!0),x("");try{const A=await(await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&x(String(A.reply)),A.job_id){x(e.critChatRunning);const R=async()=>{const B=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(C=>C.json()).catch(()=>null);if(B&&B.done){x(String(B.reply||B.clarification||B.summary||"✓")),b(!1),B.applied&&i(e.alertSaved);return}setTimeout(()=>{R()},8e3)};setTimeout(()=>{R()},8e3),c("");return}c("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(ke,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((m=o.points)!=null&&m.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var E,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((E=w.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(R=>t.jsx("li",{children:R},R))})]}),!!((A=w.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(R=>t.jsx("li",{children:R},R))})]})]})]},w.title)})]}),!!((j=o==null?void 0:o.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!l||f,onChange:w=>c(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!l||f||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,E)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},E))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(fr[w]||"v-cons"),children:w}),t.jsx("span",{children:E})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",E]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function El(){const{t:e,dispatch:a,startTour:r}=F(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(ke,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const hr="atl2:mapfold",Al=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(hr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},gr=h.createContext(null),F=()=>{const e=h.useContext(gr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Je({o:e,lg:a}){const{lang:r}=F(),n=me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ga(n,r),children:[n.emoji," ",Ga(n,r)]}):null}function Vt({o:e,src:a}){const{lang:r,t:n}=F(),i=me(e);if(!i)return null;const o=No(i),l=So(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Dn(i,r))+" · "+n.win7(In(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<o?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function br({o:e}){const{lang:a}=F(),r=jo(e.cc),n=e.cc?st(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Ln="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",vr=e=>`atl2:tour:${e||"anon"}`;function zl(e){try{return localStorage.getItem(vr(e))==="1"}catch{return!0}}function Rn(e){try{localStorage.setItem(vr(e),"1")}catch{}}function Tl(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function Fl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){const{lang:l}=yo(),s=Oo[l],p=Ho(e,l,a),[g,d]=h.useReducer(Wo,void 0,()=>Yo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Al(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),c=h.useRef(!0);h.useEffect(()=>{if(c.current){c.current=!1;return}if(!e)try{localStorage.setItem(hr,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e]);const u=h.useRef(o);u.current=o,h.useEffect(()=>{var S;(S=u.current)==null||S.call(u,g.filters)},[g.filters]);const[x,f]=h.useState(null),[b,v]=h.useState(null),[m,y]=h.useState({kept:0,dropped:0}),[j,w]=h.useState(!1),[E,A]=h.useState(""),[R,B]=h.useState(!1),[C,M]=h.useState(null),[O,L]=h.useState(!1),[_,k]=h.useState(!1),[,N]=h.useState(0),T=()=>N(S=>S+1),H=h.useRef([]),G=h.useRef(new Set),Z=h.useRef(new Set),z=h.useRef(new Map),q=h.useRef(null),{mode:I}=p,P=h.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[p.caps,i,a]),D=P.pipe,U=p.session.token||"",W=I==="client"&&!e;h.useEffect(()=>{if(document.querySelector(`link[href="${Ln}"]`))return;const S=document.createElement("link");S.rel="stylesheet",S.href=Ln,document.head.appendChild(S)},[]);const J=(S,V=!1)=>{A(S),B(V),q.current&&clearTimeout(q.current),q.current=setTimeout(()=>A(""),V?4200:2400)},re=S=>J(S,!0),ue=h.useMemo(()=>{const S=new Map;return p.dossiers.forEach(V=>{V.id&&S.set(V.id,V)}),S},[p.dossiers]),ce=h.useMemo(()=>p.dossiers.filter(S=>_n(S,g,D)),[p.dossiers,g,D]),Q=h.useRef(!1);h.useEffect(()=>{if(Q.current||e||p.loading||!p.dossiers.length)return;if(!P.showFunnel||zl(p.session.token||"")){Q.current=!0;return}Q.current=!0;const S=window.setTimeout(()=>{Rn(p.session.token||""),L(!0)},700);return()=>window.clearTimeout(S)},[e,p.loading,p.dossiers.length,P.showFunnel,p.session.token]);const te=h.useMemo(()=>p.dossiers.filter(S=>Go(S,g,D,p.favIds)),[p.dossiers,g,D,p.favIds]),be=h.useMemo(()=>wo(ce,p.favIds),[ce,p.favIds]),K=Ea.find(S=>S.key===g.continent),ie=g.continent==="monde"?s.contWorld:(l==="fr"?K==null?void 0:K.fr:K==null?void 0:K.en)||"";h.useEffect(()=>{const S=V=>{var pe;const Y=(((pe=V.detail)==null?void 0:pe.name)||"").trim();Y&&ee(null,Y)};return window.addEventListener("ppmap:evaluate",S),()=>window.removeEventListener("ppmap:evaluate",S)}),h.useEffect(()=>{const S=pe=>{const Re=String(pe||"").trim();Re&&d({type:"filters",patch:{sector:[Re]}})},V=pe=>{var Re;return S((Re=pe.detail)==null?void 0:Re.sector)},Y=pe=>{pe.data&&pe.data.type==="pp-filter"&&S(pe.data.sector)};return window.addEventListener("ppmap:filter",V),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",V),window.removeEventListener("message",Y)}},[]);const ee=(S,V)=>{const Y=((S==null?void 0:S.name)||V||"").trim();if(!W){v({kicker:Y});return}!Y||j||(w(!0),(async()=>{try{let pe=Y;const Re=((S==null?void 0:S.website)||(S==null?void 0:S.domain)||"").trim();if(Re)pe=Re;else try{const he=await Co(Y);he!=null&&he.website?pe=he.website:((he==null?void 0:he.candidates)||[]).length===1&&(pe=he.candidates[0].url)}catch{}const Me=await Pn(U,pe,"atelier2"),jr={name:Me.company||Y,verdict:Me.verdict,reason:Me.reason||"",remaining:Me.remaining??null};H.current=[jr,...H.current].slice(0,8),Me.verdict==="kept"&&y(he=>({...he,kept:he.kept+1})),Me.verdict==="ruled_out"&&y(he=>({...he,dropped:he.dropped+1}));const dt=S||p.dossiers.find(he=>(he.name||"").toLowerCase()===Y.toLowerCase());dt&&(Me.verdict==="kept"?dt.verdict=dt.verdict||"MATCH":Me.verdict==="ruled_out"&&(dt.verdict="NO MATCH"),Me.reason&&(dt.reasoning=Me.reason)),T()}finally{w(!1)}})())},_e=S=>{if(!W){v({kicker:S.name});return}G.current.add(S.id),ct(U,"fast_request",S.name||"",""),J(s.memoInstantSent(S.name)),T()},fe=S=>z.current.get(S.id)??p.thumbs.get((S.name||"").trim().toLowerCase()),xe=(S,V)=>d({type:"undoPush",entry:{id:S.id,name:S.name,prevCeoStatus:V}}),De=async(S,V,Y)=>{const pe=S.ceoStatus||"";S.ceoStatus=V,T();const Re=await Kt(U,{status:V,airtable_id:S.airtableId,check_id:S.checkId,company:S.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return Re.ok?Re.skipped?(S.ceoStatus=pe,T(),re(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&xe(S,pe),Y!=null&&Y.msg&&J(Y.msg),(V==="Validé"||V==="Écarté")&&!S.ceoNote&&(Y==null?void 0:Y.note)===void 0&&M({o:S,yes:V==="Validé"}),!0):(S.ceoStatus=pe,T(),re(s.actErr),!1)},He=async(S,V)=>{const Y=await Kt(U,{status:S.ceoStatus||"Retenu",airtable_id:S.airtableId,check_id:S.checkId,company:S.name,note:V,via:"note"});return!Y.ok||Y.skipped?(re(Y.skipped?s.actNotPersisted:s.actErr),!1):(S.ceoNote=V,T(),!0)},Ne=h.useRef(new Map),Ie=S=>Ne.current.has(S.id)?Ne.current.get(S.id):p.stages.get((S.name||"").trim().toLowerCase()),lt=(S,V)=>{Ne.current.set(S.id,V),T()},Ht=(S,V)=>{W&&De(S,V?"Validé":"Écarté",{msg:V?s.decidedYes(S.name):s.decidedNo(S.name)})},Yt=S=>{W&&De(S,"À trancher",{msg:s.promoted(S.name)})},$=S=>{W&&(async()=>{const V=S.ceoStatus||"";S.ceoStatus="Retenu",T();const Y=await Kt(U,{status:"Retenu",check_id:S.checkId,company:S.name});if(!Y.ok||Y.skipped){S.ceoStatus=V,T(),re(Y.skipped?s.actNotPersisted:s.actErr);return}xe(S,V),J(s.repeched(S.name))})()},ae=()=>{const S=g.undo[g.undo.length-1];if(!S){J(s.undoNone);return}const V=ue.get(S.id);if(!V){d({type:"undoPop"}),J(s.undoNone);return}let Y=S.prevCeoStatus;if(!Y)if((V.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{J(s.undoLockedTitle);return}(async()=>await De(V,Y,{undo:!1})&&(d({type:"undoPop"}),V.ceoStatus=S.prevCeoStatus,T(),J(s.undoDone(V.name))))()},se=S=>{W&&(Z.current.add(S.id),T(),(async()=>{const V=await Eo(U,S.name,"email");if(!V||V.ok===!1){Z.current.delete(S.id),T(),re(s.actErr);return}ct(U,"approach",S.name||"",""),J(s.actApproachSent)})())},ve=(S,V)=>{W&&(async()=>{if(!(await ct(U,V?"yes":"no",S.name||"","")).ok){re(s.actErr);return}z.current.set(S.id,V?"yes":"no"),T(),J(V?s.thumbUpDone:s.thumbDnDone)})()},Ue=S=>{!W||!wt(S)||(ct(U,"detailed_request",S.name||"",""),J(s.memoDeepSent(S.name)))},we=S=>{const V=new Set(p.favIds),Y=V.has(S.id);Y?V.delete(S.id):V.add(S.id),p.setFavIds(V),W&&Ao(U,{id:S.id,co:S.name},Y)},Se=()=>{!W||_||window.confirm(s.identSyncConfirm)&&(k(!0),(async()=>{const S=await zo(U);k(!1),S?J(s.identSyncDone):re(s.actErr)})())},Ve=/proplace/i.test(p.fund||""),yr=S=>{!W||!Ve||(ct(U,"onboard_request",S.name||"",""),J(s.onboardSent(S.name)))},wr={st:g,dispatch:d,t:s,lang:l,mode:I,caps:P,pipe:D,token:U,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:$,thumbOf:fe,canWrite:W,commitStatus:De,saveNote:He,stageOf:Ie,setStage:lt,flashErr:re,startTour:()=>L(!0),dossiers:p.dossiers,scopedAll:ce,scoped:te,counts:be,byId:ue,contName:ie,favIds:p.favIds,toggleFav:we,askEvaluate:ee,doAnalyse:_e,doDecide:Ht,doPromote:Yt,doApproach:se,doThumb:ve,doDeep:Ue,doUndo:ae,doSync:Se,doOnboard:yr,outbound:Ve,memoQueued:G.current,approachDone:Z.current,sessTally:m,evalCards:H.current,evalBusy:j,markRow:f,markedId:x,flash:J};h.useEffect(()=>{const S=V=>{V.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",S),()=>window.removeEventListener("keydown",S)},[]);const kr=S=>U?t.jsx(Os,{token:U,children:S}):t.jsx(t.Fragment,{children:S});return t.jsx(gr.Provider,{value:wr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Po}),kr(t.jsxs("div",{className:"app"+(D?" pipe":"")+(U?" has-thesis":""),children:[P.showTicker&&t.jsx(ge,{name:"live",children:t.jsxs("div",{className:"live-stack"+(U?" live-stack--cibles":""),children:[t.jsx(Zo,{}),!!U&&t.jsx(qs,{})]})}),P.showIdent&&t.jsx(ge,{name:"identite",children:t.jsx(hi,{})}),!!U&&t.jsx(ge,{name:"lead",children:t.jsx(Ms,{})}),P.showOnb&&t.jsx(ge,{name:"onboarding",children:t.jsx(gi,{})}),P.showMorning&&t.jsx(ge,{name:"matin",children:t.jsx(xi,{})}),t.jsx(ge,{name:"fraicheur",children:t.jsx(si,{})}),t.jsx(ge,{name:"mesure",children:t.jsx(li,{})}),P.showFunnel&&t.jsx(ge,{name:"entonnoir",children:t.jsx(Ll,{})}),P.showFunnel&&t.jsx(ge,{name:"tunnel",children:t.jsx(vi,{})}),P.showFunnel&&t.jsx(ge,{name:"tuto",children:t.jsx(wi,{})}),t.jsx(ge,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Rl,{}),t.jsxs("div",{className:"stage"+(g.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(bs,{}),t.jsx(ys,{})]})]})}),P.showDemand&&t.jsx(ge,{name:"evaluation",children:t.jsx(Cs,{})}),P.showDemand&&g.memoConsole&&t.jsx(ge,{name:"console",children:t.jsx(As,{})}),t.jsx(ge,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(el,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),P.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),g.popupId&&t.jsx(ge,{name:"fiche",children:t.jsx(Ds,{})}),t.jsx(ge,{name:"modales",children:t.jsx(ll,{})}),t.jsx(ri,{}),C&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:C.o.name}),t.jsx(ui,{placeholder:C.yes?s.whyYesPh:s.whyNoPh,onDone:S=>{const V=C.o;M(null),S&&He(V,S).then(Y=>{Y&&J(s.csNoteSaved)})}})]}),O&&t.jsx(mi,{steps:Tl(s),onClose:()=>{L(!1),Rn(U)}}),E&&t.jsx("div",{className:"flash on"+(R?" err":""),children:E}),b&&t.jsx(ko,{variant:"acquirer",initialCompany:Mn().co,initialWebsite:Mn().site,onClose:()=>v(null)})]})})}function Ll(){const{t:e}=F(),[a,r]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Rl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=F(),l=h.useMemo(()=>{const s={};return e.forEach(p=>{Aa(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[To.map(s=>{const p=Ea.find(d=>d.key===s),g=s==="monde"?o.contWorld:i==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[g,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Mn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ml(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{br as FlagCell,Je as SigBadge,Vt as SigWin,Fl as default,Ml as fmtShort,F as useV2};
