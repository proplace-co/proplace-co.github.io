...
.atl2 .bulk .side .hint{white-space:nowrap}`,Ni=`
...
`,Si=ji+Ni;function ka(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ei(){const e=ka("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ci(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ei();return r==="0"?"client":r==="1"||ka("embed")==="1"&&ka("chrome")==="1"?"apercu":"client"}const Ai={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ti=e=>Ai[e];function zi(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Xe=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!er(a)||zi(a))&&(e.noCo=!0)}return Object.assign(e,{continent:go(e.cc)})};function ca(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const qi=60*60*1e3;function Li(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>qi?null:a}catch{return null}}function Mt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ri=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Mi(e,a,r="default"){const n=r!=="default",i=f.useMemo(()=>e||n?{mode:"anon"}:so(),[e,n]),o=f.useMemo(()=>n?"visiteur":Ci(e,i),[e,i,n]),l=f.useMemo(()=>Ti(o),[o]),s=o!=="visiteur",d=Ri(r),[x,c]=f.useState([]),[m,u]=f.useState(""),[b,p]=f.useState(null),[g,v]=f.useState(null),[h,N]=f.useState(null),[j,y]=f.useState(()=>new Map),[z,R]=f.useState(()=>new Map),[L,S]=f.useState(""),[E,k]=f.useState(new Set),[M,T]=f.useState(null),[O,C]=f.useState(!0),[A,F]=f.useState(!1),[U,Y]=f.useState(0),[H,V]=f.useState(0),G=f.useRef(0),K=f.useMemo(()=>{var Z;if(o!=="client")return"";try{return((Z=lo())==null?void 0:Z.email)||""}catch{return""}},[o]);f.useEffect(()=>{const Z=++G.current;let me=!0;const he=()=>me&&Z===G.current,fe=(s&&i.token?i.token:"pub:"+a)+(d?":"+d:""),X=Li(fe);return X?(c(X.objs.map(Xe)),X.fund&&u(X.fund),p(X.marketEstimate??null),v(X.criteria??null),N(X.stats??null),S(X.generatedAt||""),C(!1)):C(!0),(async()=>{try{if(r==="ops"){const oe=await sa(),ae=((oe==null?void 0:oe.recent_ops)||[]).map(W=>{const Q=Ut(W.company_name||W.title?W:{...W,title:(W.headline_fr||W.headline||"").slice(0,120)},a),ge=String(W.rubrique||"").toLowerCase();return Q&&(ge==="nominations"||ge==="recrutements")&&(Q.engine=ge),Q&&!String(W.company_name||"").trim()&&(Q.noCo=!0),Q}).filter(W=>!!W).map(W=>(er((W.name||"").trim())||(W.noCo=!0),W));try{const W=await co(),Q=po(W),ge=((W==null?void 0:W.date)||"").slice(0,10);if(Q.length&&ge){const q=new Set;for(const D of ae){if(D.noCo||(D.date||"").slice(0,10)!==ge)continue;const B=tn(Q,q,D.name,"");B>=0&&(q.add(B),D.decryptHtml=Q[B].html)}for(const D of ae){if(D.decryptHtml||(D.date||"").slice(0,10)!==ge)continue;const B=tn(Q,q,"",D.headline||D.tagline||D.name);B>=0&&(q.add(B),D.decryptHtml=Q[B].html)}}}catch{}if(!he())return;c(ae.map(Xe)),Mt(fe,{objs:ae})}else if(typeof r=="object"){const ae=(await an()||[]).filter(Q=>(Q.slug||"")===r.research).map(Q=>nn(Q,a)).filter(Q=>!!Q),W=ca(await rn(ae,a));if(!he())return;c(W.map(Xe)),Mt(fe,{objs:W})}else if(s&&i.token){const oe=uo(i.token),ae=sa(),W=mo(i.token),Q=fo(i.token),ge=xo(i.token),q=await oe;let D=q?q.targets:[];he()&&q&&(u(q.fund||""),p(q.marketEstimate??null),v(q.criteria??null),N(q.stats??null),S(q.generatedAt||""),c(D.map(Xe)),C(!1),F(!1));const[B,J,se,te]=await Promise.all([ae,W,Q,ge]),le=((B==null?void 0:B.recent_ops)||[]).map(pe=>Ut(pe,a)).filter(pe=>!!pe);if(D=[...D,...le],!he())return;c(D.map(Xe));const qe=new Set;for(const pe of J){const Le=(pe.id||pe.co||"").toString().trim().toLowerCase();Le&&qe.add(Le.startsWith("t:")?Le:"t:"+Le)}k(qe),y(se),R(te),q&&Mt(fe,{fund:q.fund,marketEstimate:q.marketEstimate,criteria:q.criteria,stats:q.stats,generatedAt:q.generatedAt,objs:D})}else{const oe=ho(),ae=an(),W=sa(),Q=await oe;he()&&Q.length&&(c(ca(Q).map(Xe)),C(!1),F(!1));const[ge,q]=await Promise.all([ae,W]),D=(ge||[]).map(te=>nn(te,a)).filter(te=>!!te),B=await rn(D,a),J=((q==null?void 0:q.recent_ops)||[]).map(te=>Ut(te,a)).filter(te=>!!te),se=ca([...Q,...B,...J]);if(!he())return;c(se.map(Xe)),Mt(fe,{objs:se})}he()&&F(!1)}catch{he()&&!X&&F(!0)}finally{he()&&C(!1)}})(),()=>{me=!1}},[s,i.token,a,U,d]),f.useEffect(()=>{if(!l.showCredits||!K){T(null);return}let Z=!0;return(async()=>{try{const me=await fetch(`${Pa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:K})});if(!me.ok)return;const he=await me.json();Z&&he&&he.ok!==!1&&T(he)}catch{}})(),()=>{Z=!1}},[l.showCredits,K,H]);const ee=f.useCallback(Z=>k(new Set(Z)),[]);return{session:i,mode:o,caps:l,fund:m,email:K,marketEstimate:b,generatedAt:L,criteria:g,stats:h,thumbs:j,stages:z,dossiers:x,favIds:E,setFavIds:ee,credits:M,reloadCredits:()=>V(Z=>Z+1),loading:O,error:A,refresh:()=>Y(Z=>Z+1)}}const rr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Oi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...rr(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Fi=new Set(["signal","amount","score","crible","memo"]);function Di(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:rr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Fi.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??or)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const or=40;function Ua(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!je(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ia(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(Ke(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&et(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ir(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ua(e,a.filters,r)}function Pi(e,a,r,n){return!(!ir(e,a,r)||r&&!bo(e,a.ptab,n))}function Va(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-Ke(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return yo(i);case"memo":return vo(i);case"signal":{const o=je(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const da={},mn=(da==null?void 0:da.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function fn(){return new Date().toISOString().slice(0,10)}const Ha=f.createContext(null);function sr(){return f.useContext(Ha)}function Ii(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),s.querySelectorAll("*").forEach(d=>{const x=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(c=>d.removeAttribute(c.name)),x&&/^https?:\/\//i.test(x)&&(d.setAttribute("href",x),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function xn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function lr(){const e=f.useContext(Ha);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function $i({token:e,children:a}){const{dispatch:r,st:n,lang:i}=$(),[o,l]=f.useState(()=>n.filters.day||fn()),[s,d]=f.useState(null),[x,c]=f.useState(!1),m=f.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=f.useCallback(()=>{l(fn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);f.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),f.useEffect(()=>{const g=v=>{var N;const h=(N=v.detail)==null?void 0:N.day;typeof h=="string"&&m(h)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[m]),f.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),f.useEffect(()=>{if(!e||!o)return;let g=!1;c(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${mn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{g||d(h)}).catch(()=>{g||d({ok:!1,error:"network"})}).finally(()=>{g||c(!1)}),()=>{g=!0}},[e,o]);const b=f.useMemo(()=>`${mn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),p=f.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,x,m,u,n.filters.day,b,i]);return t.jsx(Ha.Provider,{value:p,children:a})}function Bi(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=lr(),[i,o]=f.useState(n);return f.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(wo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function _i(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=lr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:xn(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:xn(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const Ui=["ma","levees","nominations","recrutements","actualites"],Vi=300,pa=7,Hi={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},cr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Wi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function hn(e){const a=je(e);if(a)return"sig:"+(a.theme&&cr.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Yi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:s}=$(),d=sr(),x=l==="en",[c,m]=f.useState("all"),[u,b]=f.useState(!1),p=f.useMemo(()=>{var H;const T=(a.filters.day||"").slice(0,10),O=V=>!(!o&&a.continent!=="monde"&&V.continent!==a.continent||T&&(V.date||"").slice(0,10)!==T),C=e.filter(V=>O(V)&&je(V)&&(!o||V.kind!=="target"||ke(V)!==5)),A=o&&(((H=d==null?void 0:d.ed)==null?void 0:H.ops)||[]).length?d.ed.ops.map(V=>Ut(V,l)).filter(V=>!!V).filter(V=>!T||(V.date||"").slice(0,10)===T):[],F=e.filter(V=>O(V)&&V.kind==="op"&&!je(V)&&(T?!0:Ke(V.date)<=pa)),U=o?A.length?A:F.filter(V=>{const G=(s||"").trim().toLowerCase();if(!G)return!1;const K=V.match||null;return K?Object.keys(K).map(ee=>ee.trim().toLowerCase()).includes(G):!1}):F,Y=T||new Date().toISOString().slice(0,10);return U.sort((V,G)=>{const K=(V.date||"").slice(0,10)===Y?0:1,ee=(G.date||"").slice(0,10)===Y?0:1;return K!==ee?K-ee:(G.amountEur||0)-(V.amountEur||0)}),[...Va(C,{key:"signal",dir:-1}),...U]},[e,a.continent,a.filters.day,o,s,l,d]),g=f.useMemo(()=>{const T={};for(const O of p){const C=hn(O);T[C]=(T[C]||0)+1}return T},[p]),v=f.useMemo(()=>c==="all"?p:p.filter(T=>hn(T)===c),[p,c]),h=f.useMemo(()=>v.slice(0,Vi),[v]),N=v.length-h.length,j=f.useRef(null);f.useEffect(()=>{var U,Y;const T=j.current;if(!T)return;const O=()=>{const H=T.scrollWidth;H<200||(T.style.animationDuration=Math.max(18,Math.round(H/130))+"s")};O();const C=requestAnimationFrame(O),A=window.setTimeout(O,1200);let F=!0;return(Y=(U=document.fonts)==null?void 0:U.ready)==null||Y.then(()=>{F&&O()}),()=>{F=!1,cancelAnimationFrame(C),window.clearTimeout(A)}},[h.length,c]);const y=T=>T==="all"?p.length:g[T]||0,z=T=>T==="all"?x?"All":"Tout":T.startsWith("sig:")?cr[x?"en":"fr"][T.slice(4)]||"🔔":Hi[x?"en":"fr"][T],R=[{k:"all"}],L=Ui.filter(T=>y(T)>0||T===c);if(L.length){R.push({g:x?"DEALS":"OPÉRATIONS"});for(const T of L)R.push({k:T})}const S=Wi.map(T=>"sig:"+T).filter(T=>y(T)>0||T===c);if(S.length){R.push({g:x?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const T of S)R.push({k:T})}const E=T=>{try{return new Date(T+"T12:00:00Z").toLocaleDateString(x?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return T}},k=(()=>{const T=(a.filters.day||"").slice(0,10),O=!o&&a.continent!=="monde"&&i?x?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return T?(x?`LIVE covers the events of ${E(T)}.`:`Le LIVE regroupe les événements du ${E(T)}.`)+O:(x?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+O})(),M=T=>h.map(O=>t.jsxs("button",{type:"button",className:"tk"+(ze(O)?" spent":""),onClick:C=>{const A=C.currentTarget.getBoundingClientRect();n({type:"popup",id:O.id,anchor:{x:A.left+A.width/2,y:A.bottom}})},title:O.name+(O.tagline?" — "+O.tagline:""),children:[t.jsx(rt,{o:O}),t.jsxs("span",{className:"who",children:[t.jsx(Ur,{o:O}),t.jsx("span",{className:"co",children:O.name})]}),typeof O.amountEur=="number"&&O.amountEur>0&&t.jsx("span",{className:"am",children:xc(O.amountEur)}),O.sector&&t.jsx("span",{className:"mt",children:O.sector}),t.jsx(na,{o:O}),t.jsx("span",{className:"tkgo",children:"→"})]},T+(O.id||O.name))).concat(N>0?[t.jsx("span",{className:"tk quiet",children:x?`+ ${N} more — filter by section to see them`:`+ ${N} autres — filtrez par rubrique pour les voir`},T+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:T=>{T.currentTarget.contains(T.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(T=>!T),children:[z(c),t.jsx("b",{children:y(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:k}),R.map(T=>"g"in T?t.jsx("span",{className:"tkfilg",children:T.g},T.g):t.jsxs("button",{type:"button","aria-pressed":T.k===c,onClick:()=>{m(T.k),b(!1)},children:[z(T.k),t.jsx("b",{children:y(T.k)})]},T.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:j,children:[M(0),M(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const Gi="aDx8z7Hzksus",Wa="+33 6 83 10 72 86",Wt="alexandre@proplace.co",dr=`tel:${Wa.replace(/[^\d+]/g,"")}`,gn="pp-rdv-slot";function Ki(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Qi(){const{t:e,caps:a,fund:r}=$();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:Xi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:dr,children:Wa}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Wt}`,children:Wt})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(xi,{filloutId:Gi,parameters:r?{company_name:r}:void 0})})]})}function Ji(){const[e,a]=f.useState(()=>typeof document>"u"?null:document.getElementById(gn));return f.useEffect(()=>{e||a(document.getElementById(gn))},[e]),e?mt.createPortal(t.jsx(Qi,{}),e):null}const Xi=`
...
`;class Ee extends f.Component{constructor(){super(...arguments);Za(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ua=600,Ze=62,bn="atl2:fstats";function Zi(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=$(),[l,s]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(bn)==="on"}catch{return!1}}),d=r.stats,x=f.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),c=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const m=z=>a==="en"?z.slice(5,10):`${z.slice(8,10)}/${z.slice(5,7)}`,u=z=>z.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((z,R)=>Math.max(z,R.s||0),0),p=x.length?ua/x.length:0,g=Math.max(4,p-4),v=x.length>=5&&b>0,h=r.marketEstimate||0,N=m(new Date().toISOString().slice(0,10)),j=z=>[...typeof z=="number"?[[z,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&c&&y.push({cle:"fenetre",periode:e.funPerWindow(m(c),N),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:j(d.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(z=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:z.periode}),z.etapes.map(([R,L],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(R)}),t.jsx("i",{children:L})]},z.cle+L)),z.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((d.screened||0)/h*100)))})]}),z.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const R=!l;s(R),R&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(bn,R?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},z.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ua} ${Ze}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((z,R)=>{const L=(z.s||0)/b*(Ze-4),S=(z.m||0)/b*(Ze-4),E=R*p+(p-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(z.d)} — ${z.s} ${e.actScreened} · ${z.m} ${e.actKept}`}),t.jsx("rect",{x:E,y:Ze-2-L,width:g,height:L,fill:"#cfe0d6"}),t.jsx("rect",{x:E,y:Ze-2-S,width:g,height:S,fill:"#185c38"})]},z.d)}),t.jsx("line",{x1:0,y1:Ze-1.5,x2:ua,y2:Ze-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const pr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function es(e,a){if((Qe(e)||"").startsWith("CALL")&&ke(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=ke(e)>=2;return pr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function ts({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=$(),[s,d]=f.useState(!1),[x,c]=f.useState(""),[m,u]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),p=async g=>{if(x)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}c(g);const v=await i(e,g);c(""),v&&(d(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:m?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),d(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const g=await i(e,"Analysé");c(""),g&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]}):es(e,a).map(([g,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(x===g?" busy":""),disabled:!!x,onClick:()=>{p(g)},children:v},g))})]})}function as({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=$(),[o,l]=f.useState(""),[s,d]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),c=(Qe(e)||"").startsWith("CALL")&&ke(e)===3,m=ke(e)>=2,u=async p=>{if(o||p==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(p);const g=await i(e,p);l(""),g&&(d(!0),setTimeout(()=>d(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:pr.filter(([p])=>!(m&&p==="Retenu")).map(([p,g])=>[p,a[g]]);return t.jsxs("div",{className:"csp",onClick:p=>p.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([p,g])=>t.jsx("button",{type:"button",className:"csb"+(x===p?" on":"")+(o===p?" busy":""),disabled:!!o,onClick:()=>{u(p)},children:g},p)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ns,{o:e})]})}function ns({o:e}){const{t:a,saveNote:r,flash:n}=$(),[i,o]=f.useState(e.ceoNote||""),[l,s]=f.useState(!1),[d,x]=f.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{m()},children:d?a.csNoteSaved:a.csNoteOk})]})}function rs({placeholder:e,onDone:a}){const{t:r}=$(),[n,i]=f.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function os({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=$(),[d,x]=f.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const c=o(e),m=(c==null?void 0:c.stage)||"todo",u=async h=>{if(d||h===m)return;x(!0);const N=c;l(e,{stage:h,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),vn+=1);vn=j;const y=await ko(r,{company:e.name||"",stage:h,cts:j,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(l(e,N),s(a.actErr)))},b=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,p=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&p>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,N])=>t.jsx("button",{type:"button",className:"stgb"+(m===h?" on":""),disabled:d,onClick:()=>{u(h)},children:N},h)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(p)})]})}let vn=0;const Ot=8,Ft=360;function yn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function wn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(yn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(yn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function is({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=$(),[l,s]=f.useState(0),[d,x]=f.useState(null),[c,m]=f.useState([]),u=f.useRef(!1),b=f.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),p=f.useRef(!1);f.useEffect(()=>{const L=b.current;return()=>{p.current||(n({type:"ptab",tab:L.ptab}),n({type:"dens",dens:L.dens}),n({type:"modal",modal:L.modal}))}},[]),f.useEffect(()=>{u.current||(u.current=!0,m(e.filter(L=>!!document.querySelector(L.need||L.sel))))},[e]);const g=c[l],v=l>=c.length;f.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const L=g.click,S=window.setTimeout(()=>{const E=document.querySelector(L);E&&E.getAttribute("aria-selected")!=="true"&&E.click()},60);return()=>window.clearTimeout(S)}},[l,g]);const h=f.useRef(-1),N=f.useCallback(()=>{if(!g){x(null);return}const L=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!L){x(null);return}h.current!==l&&(h.current=l,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=L.getBoundingClientRect();x(E=>E&&Math.abs(E.top-S.top)<1&&Math.abs(E.left-S.left)<1&&Math.abs(E.width-S.width)<1&&Math.abs(E.height-S.height)<1?E:S)},[g,l]);f.useLayoutEffect(()=>{N();const L=[90,300,700,1300].map(E=>window.setTimeout(N,E)),S=()=>N();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{L.forEach(E=>window.clearTimeout(E)),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[N]);const j=f.useRef(a);if(j.current=a,f.useEffect(()=>{const L=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),j.current()):S.key==="ArrowRight"?s(E=>E+1):S.key==="ArrowLeft"&&s(E=>Math.max(0,E-1))};return document.addEventListener("keydown",L,!0),()=>document.removeEventListener("keydown",L,!0)},[]),!c.length)return null;let y=null;const z=L=>()=>{p.current=!0,n({type:"modal",modal:null}),L()};if(v){const L=i[3]||0;L>0?y={title:L===1?r.ahaATitle1:r.ahaATitleN(L),body:r.ahaABody,btn:r.ahaABtn,go:z(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:z(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:z(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:z(()=>{n({type:"modal",modal:"crit"}),a()})}}let R={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Ft};if(!v&&d){const L=d.bottom+14,E=window.innerHeight-L>190?L:Math.max(12,d.top-200);R={left:Math.min(Math.max(12,d.left+d.width/2-Ft/2),window.innerWidth-Ft-12),top:E,width:Ft}}return mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-Ot,top:d.top-Ot,width:d.width+Ot*2,height:d.height+Ot*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:R,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(wn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(wn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(L=>Math.max(0,L-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(L=>L+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function ur(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function mr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ss(){var S,E;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:s,dispatch:d}=$(),x=r?a:e,c=f.useMemo(()=>x.filter(k=>Ke(k.date)===0&&k.kind==="target"),[x]),m=f.useMemo(()=>r?a.filter(k=>k.kind==="target"&&ke(k)===0).slice().sort((k,M)=>(M.date||"").localeCompare(k.date||"")):[],[a,r]),u=f.useMemo(()=>c.filter(k=>r?ke(k)===0:!ze(k)),[c,r]),b=r?m:u,p=r?a.length-m.length:c.length-u.length,g=r?a.length:c.length,v=g?Math.min(100,p/g*100):100,h=f.useMemo(()=>ur(x),[x]),N=!!h&&Ke(h)>0,j=f.useMemo(()=>N?x.filter(k=>(k.date||"").slice(0,10)===h):[],[x,h,N]),y=typeof((S=s.stats)==null?void 0:S.kept_today)=="number"?s.stats.kept_today:null,z=typeof((E=s.stats)==null?void 0:E.screened_today)=="number"?s.stats.screened_today:c.length;let R;N?R=i.morningLast(j.length,m.length,mr(h,l)):r?R=i.morningThesis(z,m.length,y):c.length?p===0?R=i.goalSourced(c.length):p>=c.length?R=i.goalCleared:R=i.goalDone(p,c.length):R=i.goalSourced(0);const L=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&m.length&&d({type:"chainStart",queue:m.map(k=>k.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:R}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:L,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ls(){var U,Y;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:d,doSync:x,startTour:c,flash:m,flashErr:u}=$(),[b,p]=f.useState(null),[g,v]=f.useState(!0),[h,N]=f.useState([]),j=d==="client";f.useEffect(()=>{if(!i||!o)return;let H=!0;return v(!0),(async()=>{const[V,G]=await Promise.all([$a(o),tr(i)]);H&&(V&&p(V),v(!1),N(G))})(),()=>{H=!1}},[i,o]);const[y,z]=f.useState(!1),R=()=>{!j||y||!o||(z(!0),jo(o).then(H=>{z(!1),H?m(e.identRepubDone):u(e.actErr)}))},L=(b==null?void 0:b.per_day)??null,S=((U=b==null?void 0:b.pool_order)==null?void 0:U.length)??0,E=h.filter(H=>H.status==="running").length,k=f.useMemo(()=>s.filter(H=>H.kind==="target"&&ze(H)).length,[s]),M=l.marketEstimate,T=typeof((Y=l.stats)==null?void 0:Y.screened)=="number"?l.stats.screened:k,O=M&&M>0?Math.min(100,Math.round(T/M*100)):null,C=H=>H.toLocaleString(a==="en"?"en-US":"fr-FR"),A=(o||"P").split(/\s+/).map(H=>H[0]).join("").slice(0,2).toUpperCase(),F=(()=>{const H=Date.parse(l.generatedAt||"");if(Number.isNaN(H))return"";const V=new Date(H),G=K=>String(K).padStart(2,"0");return`${G(V.getDate())}/${G(V.getMonth()+1)} à ${G(V.getHours())}:${G(V.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?A:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),F?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(F)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[O===null&&T>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:C(T)})})]}),O!==null&&M&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:O+"%"}})}),t.jsxs("b",{children:[O," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(T,M)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),L!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:L})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),L===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),E>0&&t.jsxs("span",{className:"ev",children:["⏳ ",E]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:H=>{H.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||y,onClick:R,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:H=>n({type:"filters",patch:{search:H.target.value}})})]})]})]})}function cs(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=$(),s=o.loading&&!l.length,d=f.useRef({});f.useEffect(()=>{d.current={...r}},[r]);const x=u=>{const b=d.current[u],p=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${ga[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(p>0?" up":p<0?" down":""),children:[r[u],p!==0&&t.jsxs("em",{className:"delta",children:[p>0?"+":"−",Math.abs(p)]})]})]},u)},c=(u,b,p)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":`var(${ga[u]})`},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:p.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,p,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:p,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[c(5,!1,n.plabels[5]),c(7,!0,n.plabels[7]),c(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function ds(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=$(),s=f.useRef(null),[d,x]=f.useState(60);f.useEffect(()=>{let p=0;const g=()=>{var y;const v=s.current;if(!v)return;const h=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!h)return;const N=h.getBoundingClientRect(),j=v.getBoundingClientRect();x(Math.max(20,Math.min(N.left+N.width/2-j.left,j.width-30)))};return p=requestAnimationFrame(g),window.addEventListener("resize",g),()=>{cancelAnimationFrame(p),window.removeEventListener("resize",g)}},[e.ptab]);const c=e.ptab;let m=r.tuto[c].p;if(c===3){const p=n.filter(h=>h.kind==="target"&&ke(h)===3),g=p.filter(h=>ba(h)==="auto").length,v=p.filter(h=>ba(h)==="cd").length;m=r.tutoPending(g,v,p.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(p=>p.id)})};if(c===1){const p=n.filter(g=>g.kind==="target"&&ke(g)===1&&!i.has(g.id)).slice(0,10);if(p.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:p.map(g=>g.id)})}}return null})(),b=No(c);return t.jsxs("div",{ref:s,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${ga[c]})`,"--ax":d+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class at{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*ps(e){for(const a of e)yield*a}function fr(e){return Array.from(ps(e))}var ce=1e-6,ne=Math.PI,Fe=ne/2,kn=ne/4,Pe=ne*2,We=180/ne,Te=ne/180,ue=Math.abs,us=Math.atan,jt=Math.atan2,be=Math.cos,ve=Math.sin,ms=Math.sign||function(e){return e>0?1:e<0?-1:0},ot=Math.sqrt;function fs(e){return e>1?0:e<-1?ne:Math.acos(e)}function Nt(e){return e>1?Fe:e<-1?-Fe:Math.asin(e)}function De(){}function Yt(e,a){e&&Nn.hasOwnProperty(e.type)&&Nn[e.type](e,a)}var jn={Feature:function(e,a){Yt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Yt(r[n].geometry,a)}},Nn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ja(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ja(r[n],a,0)},Polygon:function(e,a){Sn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Sn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Yt(r[n],a)}};function ja(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Sn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ja(e[r],a,1);a.polygonEnd()}function st(e,a){e&&jn.hasOwnProperty(e.type)?jn[e.type](e,a):Yt(e,a)}function Na(e){return[jt(e[1],e[0]),Nt(e[2])]}function pt(e){var a=e[0],r=e[1],n=be(r);return[n*be(a),n*ve(a),ve(r)]}function Dt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Gt(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ma(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Pt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Sa(e){var a=ot(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Ea(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ca(e,a){return ue(e)>ne&&(e-=Math.round(e/Pe)*Pe),[e,a]}Ca.invert=Ca;function xs(e,a,r){return(e%=Pe)?a||r?Ea(Cn(e),An(a,r)):Cn(e):a||r?An(a,r):Ca}function En(e){return function(a,r){return a+=e,ue(a)>ne&&(a-=Math.round(a/Pe)*Pe),[a,r]}}function Cn(e){var a=En(e);return a.invert=En(-e),a}function An(e,a){var r=be(e),n=ve(e),i=be(a),o=ve(a);function l(s,d){var x=be(d),c=be(s)*x,m=ve(s)*x,u=ve(d),b=u*r+c*n;return[jt(m*i-b*o,c*r-u*n),Nt(b*i+m*o)]}return l.invert=function(s,d){var x=be(d),c=be(s)*x,m=ve(s)*x,u=ve(d),b=u*i-m*o;return[jt(m*i+u*o,c*r+b*n),Nt(b*r-c*n)]},l}function hs(e,a,r,n,i,o){if(r){var l=be(a),s=ve(a),d=n*r;i==null?(i=a+n*Pe,o=a-d/2):(i=Tn(l,i),o=Tn(l,o),(n>0?i<o:i>o)&&(i+=n*Pe));for(var x,c=i;n>0?c>o:c<o;c-=d)x=Na([l,-s*be(c),-s*ve(c)]),e.point(x[0],x[1])}}function Tn(e,a){a=pt(a),a[0]-=e,Sa(a);var r=fs(-a[1]);return((-a[2]<0?-r:r)+Pe-ce)%Pe}function xr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:De,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Vt(e,a){return ue(e[0]-a[0])<ce&&ue(e[1]-a[1])<ce}function It(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function hr(e,a,r,n,i){var o=[],l=[],s,d;if(e.forEach(function(p){if(!((g=p.length-1)<=0)){var g,v=p[0],h=p[g],N;if(Vt(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=p[s])[0],v[1]);i.lineEnd();return}h[0]+=2*ce}o.push(N=new It(v,p,null,!0)),l.push(N.o=new It(v,null,N,!1)),o.push(N=new It(h,p,null,!1)),l.push(N.o=new It(h,null,N,!0))}}),!!o.length){for(l.sort(a),zn(o),zn(l),s=0,d=l.length;s<d;++s)l[s].e=r=!r;for(var x=o[0],c,m;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,d=c.length;s<d;++s)i.point((m=c[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((m=c[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);i.lineEnd()}}}function zn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function fa(e){return ue(e[0])<=ne?e[0]:ms(e[0])*((ue(e[0])+ne)%Pe-ne)}function gs(e,a){var r=fa(a),n=a[1],i=ve(n),o=[ve(r),-be(r),0],l=0,s=0,d=new at;i===1?n=Fe+ce:i===-1&&(n=-Fe-ce);for(var x=0,c=e.length;x<c;++x)if(u=(m=e[x]).length)for(var m,u,b=m[u-1],p=fa(b),g=b[1]/2+kn,v=ve(g),h=be(g),N=0;N<u;++N,p=y,v=R,h=L,b=j){var j=m[N],y=fa(j),z=j[1]/2+kn,R=ve(z),L=be(z),S=y-p,E=S>=0?1:-1,k=E*S,M=k>ne,T=v*R;if(d.add(jt(T*E*ve(k),h*L+T*be(k))),l+=M?S+E*Pe:S,M^p>=r^y>=r){var O=Gt(pt(b),pt(j));Sa(O);var C=Gt(o,O);Sa(C);var A=(M^S>=0?-1:1)*Nt(C[2]);(n>A||n===A&&(O[0]||O[1]))&&(s+=M^S>=0?1:-1)}}return(l<-ce||l<ce&&d<-1e-12)^s&1}function gr(e,a,r,n){return function(i){var o=a(i),l=xr(),s=a(l),d=!1,x,c,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=N,u.lineEnd=j,c=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,c=fr(c);var y=gs(x,n);c.length?(d||(i.polygonStart(),d=!0),hr(c,vs,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),c=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,z){e(y,z)&&i.point(y,z)}function p(y,z){o.point(y,z)}function g(){u.point=p,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,z){m.push([y,z]),s.point(y,z)}function N(){s.lineStart(),m=[]}function j(){h(m[0][0],m[0][1]),s.lineEnd();var y=s.clean(),z=l.result(),R,L=z.length,S,E,k;if(m.pop(),x.push(m),m=null,!!L){if(y&1){if(E=z[0],(S=E.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),R=0;R<S;++R)i.point((k=E[R])[0],k[1]);i.lineEnd()}return}L>1&&y&2&&z.push(z.pop().concat(z.shift())),c.push(z.filter(bs))}}return u}}function bs(e){return e.length>1}function vs(e,a){return((e=e.x)[0]<0?e[1]-Fe-ce:Fe-e[1])-((a=a.x)[0]<0?a[1]-Fe-ce:Fe-a[1])}const qn=gr(function(){return!0},ys,ks,[-ne,-Fe]);function ys(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?ne:-ne,d=ue(o-a);ue(d-ne)<ce?(e.point(a,r=(r+l)/2>0?Fe:-Fe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&d>=ne&&(ue(a-n)<ce&&(a-=n*ce),ue(o-s)<ce&&(o-=s*ce),r=ws(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function ws(e,a,r,n){var i,o,l=ve(e-r);return ue(l)>ce?us((ve(a)*(o=be(n))*ve(r)-ve(n)*(i=be(a))*ve(e))/(i*o*l)):(a+n)/2}function ks(e,a,r,n){var i;if(e==null)i=r*Fe,n.point(-ne,i),n.point(0,i),n.point(ne,i),n.point(ne,0),n.point(ne,-i),n.point(0,-i),n.point(-ne,-i),n.point(-ne,0),n.point(-ne,i);else if(ue(e[0]-a[0])>ce){var o=e[0]<a[0]?ne:-ne;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function js(e){var a=be(e),r=2*Te,n=a>0,i=ue(a)>ce;function o(c,m,u,b){hs(b,e,r,u,c,m)}function l(c,m){return be(c)*be(m)>a}function s(c){var m,u,b,p,g;return{lineStart:function(){p=b=!1,g=1},point:function(v,h){var N=[v,h],j,y=l(v,h),z=n?y?0:x(v,h):y?x(v+(v<0?ne:-ne),h):0;if(!m&&(p=b=y)&&c.lineStart(),y!==b&&(j=d(m,N),(!j||Vt(m,j)||Vt(N,j))&&(N[2]=1)),y!==b)g=0,y?(c.lineStart(),j=d(N,m),c.point(j[0],j[1])):(j=d(m,N),c.point(j[0],j[1],2),c.lineEnd()),m=j;else if(i&&m&&n^y){var R;!(z&u)&&(R=d(N,m,!0))&&(g=0,n?(c.lineStart(),c.point(R[0][0],R[0][1]),c.point(R[1][0],R[1][1]),c.lineEnd()):(c.point(R[1][0],R[1][1]),c.lineEnd(),c.lineStart(),c.point(R[0][0],R[0][1],3)))}y&&(!m||!Vt(m,N))&&c.point(N[0],N[1]),m=N,b=y,u=z},lineEnd:function(){b&&c.lineEnd(),m=null},clean:function(){return g|(p&&b)<<1}}}function d(c,m,u){var b=pt(c),p=pt(m),g=[1,0,0],v=Gt(b,p),h=Dt(v,v),N=v[0],j=h-N*N;if(!j)return!u&&c;var y=a*h/j,z=-a*N/j,R=Gt(g,v),L=Pt(g,y),S=Pt(v,z);ma(L,S);var E=R,k=Dt(L,E),M=Dt(E,E),T=k*k-M*(Dt(L,L)-1);if(!(T<0)){var O=ot(T),C=Pt(E,(-k-O)/M);if(ma(C,L),C=Na(C),!u)return C;var A=c[0],F=m[0],U=c[1],Y=m[1],H;F<A&&(H=A,A=F,F=H);var V=F-A,G=ue(V-ne)<ce,K=G||V<ce;if(!G&&Y<U&&(H=U,U=Y,Y=H),K?G?U+Y>0^C[1]<(ue(C[0]-A)<ce?U:Y):U<=C[1]&&C[1]<=Y:V>ne^(A<=C[0]&&C[0]<=F)){var ee=Pt(E,(-k+O)/M);return ma(ee,L),[C,Na(ee)]}}}function x(c,m){var u=n?e:ne-e,b=0;return c<-u?b|=1:c>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return gr(l,s,o,n?[0,-e]:[-ne,e-ne])}function Ns(e,a,r,n,i,o){var l=e[0],s=e[1],d=a[0],x=a[1],c=0,m=1,u=d-l,b=x-s,p;if(p=r-l,!(!u&&p>0)){if(p/=u,u<0){if(p<c)return;p<m&&(m=p)}else if(u>0){if(p>m)return;p>c&&(c=p)}if(p=i-l,!(!u&&p<0)){if(p/=u,u<0){if(p>m)return;p>c&&(c=p)}else if(u>0){if(p<c)return;p<m&&(m=p)}if(p=n-s,!(!b&&p>0)){if(p/=b,b<0){if(p<c)return;p<m&&(m=p)}else if(b>0){if(p>m)return;p>c&&(c=p)}if(p=o-s,!(!b&&p<0)){if(p/=b,b<0){if(p>m)return;p>c&&(c=p)}else if(b>0){if(p<c)return;p<m&&(m=p)}return c>0&&(e[0]=l+c*u,e[1]=s+c*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var gt=1e9,$t=-gt;function Ss(e,a,r,n){function i(x,c){return e<=x&&x<=r&&a<=c&&c<=n}function o(x,c,m,u){var b=0,p=0;if(x==null||(b=l(x,m))!==(p=l(c,m))||d(x,c)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==p);else u.point(c[0],c[1])}function l(x,c){return ue(x[0]-e)<ce?c>0?0:3:ue(x[0]-r)<ce?c>0?2:1:ue(x[1]-a)<ce?c>0?1:0:c>0?3:2}function s(x,c){return d(x.x,c.x)}function d(x,c){var m=l(x,1),u=l(c,1);return m!==u?m-u:m===0?c[1]-x[1]:m===1?x[0]-c[0]:m===2?x[1]-c[1]:c[0]-x[0]}return function(x){var c=x,m=xr(),u,b,p,g,v,h,N,j,y,z,R,L={point:S,lineStart:T,lineEnd:O,polygonStart:k,polygonEnd:M};function S(A,F){i(A,F)&&c.point(A,F)}function E(){for(var A=0,F=0,U=b.length;F<U;++F)for(var Y=b[F],H=1,V=Y.length,G=Y[0],K,ee,Z=G[0],me=G[1];H<V;++H)K=Z,ee=me,G=Y[H],Z=G[0],me=G[1],ee<=n?me>n&&(Z-K)*(n-ee)>(me-ee)*(e-K)&&++A:me<=n&&(Z-K)*(n-ee)<(me-ee)*(e-K)&&--A;return A}function k(){c=m,u=[],b=[],R=!0}function M(){var A=E(),F=R&&A,U=(u=fr(u)).length;(F||U)&&(x.polygonStart(),F&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),U&&hr(u,s,A,o,x),x.polygonEnd()),c=x,u=b=p=null}function T(){L.point=C,b&&b.push(p=[]),z=!0,y=!1,N=j=NaN}function O(){u&&(C(g,v),h&&y&&m.rejoin(),u.push(m.result())),L.point=S,y&&c.lineEnd()}function C(A,F){var U=i(A,F);if(b&&p.push([A,F]),z)g=A,v=F,h=U,z=!1,U&&(c.lineStart(),c.point(A,F));else if(U&&y)c.point(A,F);else{var Y=[N=Math.max($t,Math.min(gt,N)),j=Math.max($t,Math.min(gt,j))],H=[A=Math.max($t,Math.min(gt,A)),F=Math.max($t,Math.min(gt,F))];Ns(Y,H,e,a,r,n)?(y||(c.lineStart(),c.point(Y[0],Y[1])),c.point(H[0],H[1]),U||c.lineEnd(),R=!1):U&&(c.lineStart(),c.point(A,F),R=!1)}N=A,j=F,y=U}return L}}const Aa=e=>e;var xa=new at,Ta=new at,br,vr,za,qa,Ge={point:De,lineStart:De,lineEnd:De,polygonStart:function(){Ge.lineStart=Es,Ge.lineEnd=As},polygonEnd:function(){Ge.lineStart=Ge.lineEnd=Ge.point=De,xa.add(ue(Ta)),Ta=new at},result:function(){var e=xa/2;return xa=new at,e}};function Es(){Ge.point=Cs}function Cs(e,a){Ge.point=yr,br=za=e,vr=qa=a}function yr(e,a){Ta.add(qa*e-za*a),za=e,qa=a}function As(){yr(br,vr)}var ut=1/0,Kt=ut,St=-ut,Qt=St,Jt={point:Ts,lineStart:De,lineEnd:De,polygonStart:De,polygonEnd:De,result:function(){var e=[[ut,Kt],[St,Qt]];return St=Qt=-(Kt=ut=1/0),e}};function Ts(e,a){e<ut&&(ut=e),e>St&&(St=e),a<Kt&&(Kt=a),a>Qt&&(Qt=a)}var La=0,Ra=0,bt=0,Xt=0,Zt=0,lt=0,Ma=0,Oa=0,vt=0,wr,kr,Be,_e,Oe={point:nt,lineStart:Ln,lineEnd:Rn,polygonStart:function(){Oe.lineStart=Ls,Oe.lineEnd=Rs},polygonEnd:function(){Oe.point=nt,Oe.lineStart=Ln,Oe.lineEnd=Rn},result:function(){var e=vt?[Ma/vt,Oa/vt]:lt?[Xt/lt,Zt/lt]:bt?[La/bt,Ra/bt]:[NaN,NaN];return La=Ra=bt=Xt=Zt=lt=Ma=Oa=vt=0,e}};function nt(e,a){La+=e,Ra+=a,++bt}function Ln(){Oe.point=zs}function zs(e,a){Oe.point=qs,nt(Be=e,_e=a)}function qs(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Xt+=i*(Be+e)/2,Zt+=i*(_e+a)/2,lt+=i,nt(Be=e,_e=a)}function Rn(){Oe.point=nt}function Ls(){Oe.point=Ms}function Rs(){jr(wr,kr)}function Ms(e,a){Oe.point=jr,nt(wr=Be=e,kr=_e=a)}function jr(e,a){var r=e-Be,n=a-_e,i=ot(r*r+n*n);Xt+=i*(Be+e)/2,Zt+=i*(_e+a)/2,lt+=i,i=_e*e-Be*a,Ma+=i*(Be+e),Oa+=i*(_e+a),vt+=i*3,nt(Be=e,_e=a)}function Nr(e){this._context=e}Nr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Pe);break}}},result:De};var Fa=new at,ha,Sr,Er,yt,wt,Et={point:De,lineStart:function(){Et.point=Os},lineEnd:function(){ha&&Cr(Sr,Er),Et.point=De},polygonStart:function(){ha=!0},polygonEnd:function(){ha=null},result:function(){var e=+Fa;return Fa=new at,e}};function Os(e,a){Et.point=Cr,Sr=yt=e,Er=wt=a}function Cr(e,a){yt-=e,wt-=a,Fa.add(ot(yt*yt+wt*wt)),yt=e,wt=a}let Mn,ea,On,Fn;class Dn{constructor(a){this._append=a==null?Ar:Fs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==On||this._append!==ea){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,On=n,ea=this._append,Fn=this._,this._=i}this._+=Fn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Ar(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Fs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Ar;if(a!==Mn){const r=10**a;Mn=a,ea=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return ea}function Ds(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),st(s,i(o))),o.result()}return l.area=function(s){return st(s,i(Ge)),Ge.result()},l.measure=function(s){return st(s,i(Et)),Et.result()},l.bounds=function(s){return st(s,i(Jt)),Jt.result()},l.centroid=function(s){return st(s,i(Oe)),Oe.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,Aa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new Dn(r)):new Nr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const d=Math.floor(s);if(!(d>=0))throw new RangeError(`invalid digits: ${s}`);r=d}return a===null&&(o=new Dn(r)),l},l.projection(e).digits(r).context(a)}function Ya(e){return function(a){var r=new Da;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Da(){}Da.prototype={constructor:Da,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ga(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),st(r,e.stream(Jt)),a(Jt.result()),n!=null&&e.clipExtent(n),e}function Tr(e,a,r){return Ga(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,d])},r)}function Ps(e,a,r){return Tr(e,[[0,0],a],r)}function Is(e,a,r){return Ga(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function $s(e,a,r){return Ga(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var Pn=16,Bs=be(30*Te);function In(e,a){return+a?Us(e,a):_s(e)}function _s(e){return Ya({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Us(e,a){function r(n,i,o,l,s,d,x,c,m,u,b,p,g,v){var h=x-n,N=c-i,j=h*h+N*N;if(j>4*a&&g--){var y=l+u,z=s+b,R=d+p,L=ot(y*y+z*z+R*R),S=Nt(R/=L),E=ue(ue(R)-1)<ce||ue(o-m)<ce?(o+m)/2:jt(z,y),k=e(E,S),M=k[0],T=k[1],O=M-n,C=T-i,A=N*O-h*C;(A*A/j>a||ue((h*O+N*C)/j-.5)>.3||l*u+s*b+d*p<Bs)&&(r(n,i,o,l,s,d,M,T,E,y/=L,z/=L,R,g,v),v.point(M,T),r(M,T,E,y,z,R,x,c,m,u,b,p,g,v))}}return function(n){var i,o,l,s,d,x,c,m,u,b,p,g,v={point:h,lineStart:N,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=z},polygonEnd:function(){n.polygonEnd(),v.lineStart=N}};function h(S,E){S=e(S,E),n.point(S[0],S[1])}function N(){m=NaN,v.point=j,n.lineStart()}function j(S,E){var k=pt([S,E]),M=e(S,E);r(m,u,c,b,p,g,m=M[0],u=M[1],c=S,b=k[0],p=k[1],g=k[2],Pn,n),n.point(m,u)}function y(){v.point=h,n.lineEnd()}function z(){N(),v.point=R,v.lineEnd=L}function R(S,E){j(i=S,E),o=m,l=u,s=b,d=p,x=g,v.point=j}function L(){r(m,u,c,b,p,g,o,l,i,s,d,x,Pn,n),v.lineEnd=y,y()}return v}}var Vs=Ya({point:function(e,a){this.stream.point(e*Te,a*Te)}});function Hs(e){return Ya({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ws(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function $n(e,a,r,n,i,o){if(!o)return Ws(e,a,r,n,i);var l=be(o),s=ve(o),d=l*e,x=s*e,c=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function p(g,v){return g*=n,v*=i,[d*g-x*v+a,r-x*g-d*v]}return p.invert=function(g,v){return[n*(c*g-m*v+u),i*(b-m*g-c*v)]},p}function Ys(e){return Gs(function(){return e})()}function Gs(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,d=0,x=0,c,m=0,u=1,b=1,p=null,g=qn,v=null,h,N,j,y=Aa,z=.5,R,L,S,E,k;function M(A){return S(A[0]*Te,A[1]*Te)}function T(A){return A=S.invert(A[0],A[1]),A&&[A[0]*We,A[1]*We]}M.stream=function(A){return E&&k===A?E:E=Vs(Hs(c)(g(R(y(k=A)))))},M.preclip=function(A){return arguments.length?(g=A,p=void 0,C()):g},M.postclip=function(A){return arguments.length?(y=A,v=h=N=j=null,C()):y},M.clipAngle=function(A){return arguments.length?(g=+A?js(p=A*Te):(p=null,qn),C()):p*We},M.clipExtent=function(A){return arguments.length?(y=A==null?(v=h=N=j=null,Aa):Ss(v=+A[0][0],h=+A[0][1],N=+A[1][0],j=+A[1][1]),C()):v==null?null:[[v,h],[N,j]]},M.scale=function(A){return arguments.length?(r=+A,O()):r},M.translate=function(A){return arguments.length?(n=+A[0],i=+A[1],O()):[n,i]},M.center=function(A){return arguments.length?(o=A[0]%360*Te,l=A[1]%360*Te,O()):[o*We,l*We]},M.rotate=function(A){return arguments.length?(s=A[0]%360*Te,d=A[1]%360*Te,x=A.length>2?A[2]%360*Te:0,O()):[s*We,d*We,x*We]},M.angle=function(A){return arguments.length?(m=A%360*Te,O()):m*We},M.reflectX=function(A){return arguments.length?(u=A?-1:1,O()):u<0},M.reflectY=function(A){return arguments.length?(b=A?-1:1,O()):b<0},M.precision=function(A){return arguments.length?(R=In(L,z=A*A),C()):ot(z)},M.fitExtent=function(A,F){return Tr(M,A,F)},M.fitSize=function(A,F){return Ps(M,A,F)},M.fitWidth=function(A,F){return Is(M,A,F)},M.fitHeight=function(A,F){return $s(M,A,F)};function O(){var A=$n(r,0,0,u,b,m).apply(null,a(o,l)),F=$n(r,n-A[0],i-A[1],u,b,m);return c=xs(s,d,x),L=Ea(a,F),S=Ea(c,L),R=In(L,z),C()}function C(){return E=k=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&T,O()}}function zr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}zr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ue(i)>ce&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function Ks(){return Ys(zr).scale(175.295)}function Qs(e){return e}function Js(e){if(e==null)return Qs;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,d){d||(a=r=0);var x=2,c=s.length,m=new Array(c);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;x<c;)m[x]=s[x],++x;return m}}function Xs(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function Zs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Bn(e,r)})}:Bn(e,a)}function Bn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=el(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function el(e,a){var r=Js(e.transform),n=e.arcs;function i(c,m){m.length&&m.pop();for(var u=n[c<0?~c:c],b=0,p=u.length;b<p;++b)m.push(r(u[b],b));c<0&&Xs(m,p)}function o(c){return r(c)}function l(c){for(var m=[],u=0,b=c.length;u<b;++u)i(c[u],m);return m.length<2&&m.push(m[0]),m}function s(c){for(var m=l(c);m.length<4;)m.push(m[0]);return m}function d(c){return c.map(s)}function x(c){var m=c.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:c.geometries.map(x)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=d(c.arcs);break;case"MultiPolygon":u=c.arcs.map(d);break;default:return null}return{type:m,coordinates:u}}return x(a)}const qr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},tl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function al(e,a,r){const n=qr[e];if(!n||!n.length)return-1;const i=tl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Bt=null;function nl(){return Bt||(Bt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=Zs(r,n),o=Ks().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Ds(o),s=(i.features||[]).filter(c=>{var m;return(((m=c.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(c=>{var b;const m=((b=c.properties)==null?void 0:b.name)||"",u=l(c)||"";return u?{i2:So(m)||null,n:m,d:u}:null}).filter(c=>!!c);if(!s.length)return null;const d={};for(const[c,m]of Object.entries(Eo)){const u=o(m);u&&(d[c]={x:u[0],y:u[1]})}const x={};for(const[c,m]of Object.entries(qr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,p])=>({x:b,y:p}));u.length&&(x[c]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:d,metros:x}}catch{return null}})(),Bt)}function rl(e){const[a,r]=f.useState(null);return f.useEffect(()=>{if(!e||a)return;let n=!1;return nl().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const ol={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},_n=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Un(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function il(e,a){const[r,n]=f.useState(1);return f.useEffect(()=>{let i=!0,o=0;const l=()=>{var x;if(!i)return;const d=(x=e.current)==null?void 0:x.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Vn({msgs:e}){const[a,r]=f.useState(0);f.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function sl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:d,data:x,dossiers:c}=$(),m=x.loading&&!c.length,u=f.useRef(null),b=f.useRef(null),p=rl(e.continent==="monde"),g=e.continent==="monde"?p:Ba.find(C=>C.key===e.continent)||null,v=il(u,e.continent+":"+e.mapFolded+":"+!!g),[h,N]=f.useState(new Map),[j,y]=f.useState(null);f.useEffect(()=>{const C=u.current;if(!C)return;const A=new Map;C.querySelectorAll("path[data-i2]").forEach(F=>{const U=F.dataset.i2;if(U)try{const Y=F.getBBox();Y.width>0&&A.set(U,{x:Y.x,y:Y.y,w:Y.width,h:Y.height})}catch{}}),N(A)},[e.continent,v,g]);const z=f.useMemo(()=>r.filter(C=>C.cc),[r]),R=f.useMemo(()=>{const C=new Map;return z.forEach(A=>C.set(A.cc,(C.get(A.cc)||0)+1)),C},[z]),L=e.continent==="monde"&&p?p.anchors:null,S=e.continent==="monde"&&p?p.metros:null,E=f.useMemo(()=>z.map(C=>{const A=Un(C.name||C.id||""),F=Un((C.id||C.name||"")+"·y");if(L&&C.cc){const G=S?S[C.cc]:void 0;if(G&&G.length){const ee=al(C.cc,C.city,A);if(ee>=0&&G[ee])return{d:C,x:G[ee].x+(A-.5)*5,y:G[ee].y+(F-.5)*5}}const K=L[C.cc];if(K)return{d:C,x:K.x+(A-.5)*10,y:K.y+(F-.5)*10}}const U=C.cc?h.get(C.cc):void 0;if(!U)return null;const Y=ol[`${e.continent}:${C.cc||""}`];if(Y)return{d:C,x:U.x+U.w*(Y.fx+(A-.5)*Y.sx),y:U.y+U.h*(Y.fy+(F-.5)*Y.sy)};const H=(A-.5)*Math.min(U.w*.55,60),V=(F-.5)*Math.min(U.h*.55,60);return{d:C,x:U.x+U.w/2+H,y:U.y+U.h/2+V}}).filter(C=>!!C),[z,h,L,S,e.continent]),k=C=>v>0?C/v:C,M=f.useMemo(()=>n?[0,1,2,3,4,5].map(C=>({c:_n[C],fr:d.plabels[C].toUpperCase(),en:d.plabels[C].toUpperCase(),n:r.filter(A=>A.kind==="target"&&ke(A)===C).length})).filter(C=>C.n>0):on.map((C,A)=>({...C,n:r.filter(F=>sn(F)===A).length})),[r,n,d.plabels]),T=o?l.get(o):null,O=T?E.find(C=>C.d.id===T.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[m&&t.jsx(Vn,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((C,A)=>t.jsx("g",{className:"ct"+(C.i2&&R.get(C.i2)?"":" empty"),children:t.jsx("path",{d:C.d,"data-i2":C.i2||void 0})},A))}),t.jsx("g",{children:E.map(C=>{const A=on[sn(C.d)],F=!!je(C.d),U=C.d.kind==="target",Y=n&&U?_n[ke(C.d)]:A.c,H=!n&&ze(C.d);return t.jsxs("g",{className:"co"+(H?" done":""),onMouseEnter:()=>{var K,ee;const V=(K=b.current)==null?void 0:K.getBoundingClientRect(),G=(ee=u.current)==null?void 0:ee.createSVGPoint();if(G&&u.current&&V){G.x=C.x,G.y=C.y;const Z=G.matrixTransform(u.current.getScreenCTM());y({x:Z.x-V.left,y:Z.y-V.top,label:C.d.name+" · "+(ft(C.d.cc,s)||C.d.countryLabel||"")})}i(C.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var K;const V=(K=u.current)==null?void 0:K.createSVGPoint();let G=null;if(V&&u.current){V.x=C.x,V.y=C.y;const ee=V.matrixTransform(u.current.getScreenCTM());G={x:ee.x,y:ee.y}}a({type:"popup",id:C.d.id,anchor:G})},children:[t.jsx("circle",{className:"h",cx:C.x,cy:C.y,r:k(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:C.x,cy:C.y,r:k(A.px),fill:Y,stroke:F?"#DC2626":"#ffffff",strokeWidth:k(F?2.2:1.3)})]},C.d.id||C.d.name)})}),O&&t.jsx("circle",{className:"ring on",cx:O.x,cy:O.y,r:k(13),fill:"none",stroke:"#0F172A",strokeWidth:k(2)})]}),t.jsx("div",{className:"hov"+(j?" on":""),style:j?{left:j.x,top:j.y}:void 0,children:j==null?void 0:j.label}),t.jsx("div",{className:"legend",children:M.map((C,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":C.c}}),s==="fr"?C.fr:C.en," ",t.jsx("b",{children:C.n})]},A))}),r.some(C=>!C.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(C=>!C.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:t.jsx(Vn,{msgs:d.loadMsgs})})}function ll(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Lr({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:s}=$(),d=a.filters,[x,c]=f.useState(!1),m=f.useRef(null),u=f.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),b=S=>u.filter(E=>S!=="country"&&d.country.length&&!d.country.includes(E.cc||"")?!1:Ua(E,d,o,S==="country"?void 0:S)),p=f.useMemo(()=>{const S=b("win"),E=k=>S.filter(M=>(M.date?Math.max(0,Math.floor((Date.now()-Date.parse(M.date))/864e5)):9999)<=k).length;return[E(0),E(7),E(30),S.length]},[u,d,o]),g=f.useMemo(()=>d.day?b("win").filter(S=>(S.date||"").slice(0,10)===d.day).length:0,[u,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,h=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);f.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),f.useEffect(()=>{if(!x)return;const S=k=>{var M;(M=m.current)!=null&&M.contains(k.target)||c(!1)},E=k=>{k.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",S),document.addEventListener("keydown",E),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",E)}},[x]);const N=(S,E,k,M="fbtn")=>t.jsxs("button",{type:"button",className:M,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:E}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:"▾"})]},S),j=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(ll(d.day,s))}),t.jsx("b",{children:g})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((S,E)=>t.jsxs("button",{type:"button","aria-pressed":d.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:i.dates[E]}),t.jsx("b",{children:p[E]})]},S))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),z=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",i.fSector,d.sector.length),N("pay",i.fCountry,d.country.length),N("det",i.fEngine,d.engine.length),N("sta",i.fStage,d.stage.length),o&&N("ang","Angle",d.angle.length),o&&N("mem","Mémo",d.memoLevel.length)]}),R=t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(u.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn})]}),L=t.jsxs("div",{className:"fmenu",ref:m,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{c(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:z})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip",children:[t.jsx("div",{className:"fstrip-a",children:j}),t.jsxs("div",{className:"fstrip-b",children:[y,L,R]})]}),a.openFacet&&t.jsx(Hn,{poolFor:b})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[j,y,z,t.jsx("span",{className:"fgrow"}),R]}),a.openFacet&&t.jsx(Hn,{poolFor:b})]})}function Hn({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=a.filters,l=a.openFacet,{title:s,cols:d,options:x}=f.useMemo(()=>{if(l==="sig"){const p=e("signal").filter(h=>je(h)),g=new Map;p.forEach(h=>{const N=h.engine||"";g.set(N,(g.get(N)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:p.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...va([...g.keys()],i).map(h=>({v:h,label:tt(h)+" "+Ue(h,i),n:g.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const p=e("sector"),g=new Map;return p.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const p=e("country"),g=new Map;return p.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:ft(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const p=e("engine"),g=new Map;return p.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:va([...g.keys()],i).map(v=>({v,label:tt(v)+" "+Ue(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Co(Ao(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const p=e("angle"),g=new Map;return p.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const p=e("memoLevel"),g=new Map;p.forEach(h=>{if(h.kind==="target"){const N=Ia(h);g.set(N,(g.get(N)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:g.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(p=>{p.stage&&b.set(p.stage,(b.get(p.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((p,g)=>g[1]-p[1]).map(([p,g])=>({v:p,label:p,n:g,html:!1,on:o.stage.includes(p)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const p=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:p}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Rr({mapToggle:e=!0}){const{dossiers:a,st:r,dispatch:n,pipe:i,lang:o,t:l}=$(),s=f.useMemo(()=>{const d={};return a.forEach(x=>{Ua(x,r.filters,i)&&(d.monde=(d.monde||0)+1,x.continent&&(d[x.continent]=(d[x.continent]||0)+1))}),d},[a,r.filters,i]);return t.jsxs("div",{className:"conts",children:[To.map(d=>{const x=Ba.find(m=>m.key===d),c=d==="monde"?l.contWorld:o==="fr"?x.fr:x.en;return t.jsxs("button",{type:"button",className:"cbtn","aria-selected":r.continent===d,onClick:()=>n({type:"continent",key:d}),children:[c,t.jsx("span",{className:"n",children:s[d]||0})]},d)}),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!r.mapFolded}),children:r.mapFolded?l.showMap:l.hideMap})})]})}function Mr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function cl(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function Wn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=$();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:s.rsEvalOne})]},d.name))})]}):null}function Or({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=$(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Wn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(Wn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function dl({card:e,onEvaluate:a,onAddAll:r}){var s,d,x;const{t:n}=$(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Mr(e.summary_md||"").map((c,m)=>t.jsx("p",{children:c},m))})]}),t.jsx(Or,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function pl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function ul({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=$(),s=i,[d,x]=f.useState(null),[c,m]=f.useState(null),[u,b]=f.useState(null),[p,g]=f.useState(!1);f.useEffect(()=>{let h=!0;return(async()=>{const N=await ar({email:l,cbToken:s});h&&x(N)})(),()=>{h=!1}},[l,s,n]);const v=h=>{m(h),b(null),g(!0),(async()=>{const N=await zo(h.id);b(N),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[pl(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!p&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!p&&u&&t.jsx(dl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Yn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ml(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:d,caps:x,data:c,canWrite:m,source:u,dossiers:b,doAnalyse:p,liveMemos:g,pipe:v}=$(),h=a==="client",N=f.useMemo(()=>r||(u!=="default"?qo():""),[r,u]),[j,y]=f.useState(""),[z,R]=f.useState(!1),[L,S]=f.useState(""),[E,k]=f.useState(!1),[M,T]=f.useState(""),[O,C]=f.useState([]),A=f.useRef(!1),[F,U]=f.useState(!1),[Y,H]=f.useState(""),[V,G]=f.useState(""),[K,ee]=f.useState(!1),[Z,me]=f.useState(0),[he,fe]=f.useState(""),[X,oe]=f.useState(null),[ae,W]=f.useState(null),[Q,ge]=f.useState(!1),[q,D]=f.useState(null),[B,J]=f.useState(0),se=f.useRef(!1),te=j.trim()?Yn.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting,le=f.useMemo(()=>L.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[L]);f.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(H(P),U(!0))},[]),f.useEffect(()=>{const P=ie=>{var Ne;const de=String(((Ne=ie.detail)==null?void 0:Ne.url)||"").trim();!de||!/^https?:\/\//i.test(de)||(H(de),U(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),f.useEffect(()=>{if(!m&&!N){D(null);return}let P=!0;return(async()=>{const ie=await ar({email:n,cbToken:N});P&&D(ie.length)})(),()=>{P=!1}},[m,N,n,B]);const qe=O.length?O:d,pe=c.credits,Le=f.useCallback(P=>{const ie=P.map(de=>(de||"").trim()).filter(Boolean);ie.length&&(S(de=>{const Ne=de.split(`
`).map(xe=>xe.trim()).filter(Boolean),He=new Set(Ne.map(xe=>xe.toLowerCase())),Se=ie.filter(xe=>!He.has(xe.toLowerCase()));return[...Ne,...Se].slice(0,15).join(`
`)}),R(!0))},[]);f.useEffect(()=>{if(!K)return;me(0);const P=window.setInterval(()=>me(ie=>ie+1),1e3);return()=>window.clearInterval(P)},[K]);const Ve=f.useMemo(()=>{const P=j.trim().toLowerCase();return!P||!v?null:b.find(ie=>Ye(ie.name)===P&&ke(ie)===1)||null},[j,b,v]),it=()=>{const P=j.trim();if(P){if(Ve){p(Ve);return}i(null,P),y("")}},xt=async()=>{if(!h){i(null,le[0]||"");return}if(!le.length||E)return;k(!0),A.current=!1;const P=[];for(let ie=0;ie<le.length&&!A.current;ie++){T(e.evaluating(ie+1,le.length,le[ie]));const de=await nr(r,le[ie],"atelier2");if(P.unshift({name:de.company||le[ie],verdict:de.verdict,reason:de.reason||"",remaining:de.remaining??null}),C([...P]),de.verdict==="quota"){P.unshift({name:"",verdict:"quota",reason:e.quota(le.length-ie-1),remaining:0}),C([...P]),S(le.slice(ie+1).join(`
`)),T(""),k(!1);return}}T(""),S(A.current?le.slice(P.length).join(`
`):""),k(!1)},Tt=async()=>{var de,Ne,He;if(se.current)return;const P=Y.trim().replace(/\s+/g,""),ie=V.trim();if(!P&&!ie){fe(e.rsNeed);return}if(!h&&!N){i(null,P||ie.slice(0,80));return}se.current=!0,fe(""),oe(null),W(null),ee(!0);try{const Se=await Ro({url:P,text:ie,email:n,cbToken:N});if(ee(!1),!Se||Se.status!=="success"){fe((Se==null?void 0:Se.message)||"Erreur");return}oe(Se),U(!1),Le((((de=Se.prospective)==null?void 0:de.companies_to_evaluate)||[]).map(Re=>(Re==null?void 0:Re.name)||"")),W({state:"pending"});const xe=await Mo(Se,{email:n,cbToken:N});W(xe.ok?{state:"ok",scopeLabel:((Ne=xe.summary)==null?void 0:Ne.scope_label)||"",scope:((He=xe.summary)==null?void 0:He.scope)||""}:{state:"fail",msg:xe.error||""}),xe.ok&&J(Re=>Re+1)}finally{se.current=!1,ee(!1)}},zt=[X==null?void 0:X.industry,...(X==null?void 0:X.market_tags)||[],X==null?void 0:X.author].map(P=>(P||"").trim()).filter(Boolean),Ie=(ae==null?void 0:ae.state)==="pending",ra=ae&&(Ie?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):ae.state==="ok"?t.jsx("span",{className:"rslink ok",children:ae.scope&&ae.scope!=="public"?e.rsSavedIn(ae.scopeLabel||ae.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:ae.msg,children:e.rsSaveFail})),qt=cl(X).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:j,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:P=>y(P.target.value),onKeyDown:P=>{P.key==="Enter"&&it()}}),t.jsx("span",{className:"detect"+(Yn.test(j.trim())?" url":""),children:te})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(Ve?" analyse":"")+(s?" loading":""),disabled:s,onClick:it,children:[t.jsx("span",{className:"fill"}),Ve?e.actAnalyse:e.evalGo]}),x.showCredits&&pe&&t.jsxs("button",{type:"button",className:"credits"+(pe.total_available<=0&&!pe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:pe.unlimited?"∞":pe.total_available}),!pe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",pe.daily_grant+pe.purchased]}),pe.total_available<=0&&!pe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),g.items.filter(P=>P.status==="boot"||P.status==="running").map(P=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:P.name}),t.jsx(kt,{item:P,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+P.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>R(!z),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(F?" on":""),onClick:()=>U(!F),children:e.rsOpen}),q!==null&&q>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Q?" on":""),onClick:()=>ge(!Q),children:e.rsArchOpen(q)})]}),Q&&t.jsx(ul,{bump:B,cbToken:N,onClose:()=>ge(!1),onEvaluate:P=>i(null,P),onAddAll:Le}),F&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:Y,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:P=>H(P.target.value),onKeyDown:P=>{P.key==="Enter"&&Tt()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:V,placeholder:e.rsTextPh,onChange:P=>G(P.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(K?" loading":""),style:{justifyContent:"center"},disabled:K||Ie||!Y.trim()&&!V.trim(),onClick:()=>{Tt()},children:[t.jsx("span",{className:"fill"}),K?`${Lo(Y.trim())==="youtube"&&Y.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Z)}`:Ie?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),he&&t.jsx("div",{className:"rserr",children:he}),X&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:X.title}),X.source_url&&t.jsx("a",{href:X.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{oe(null),W(null)},children:"×"})]}),X.market&&t.jsx("p",{className:"rsmk",children:X.market}),zt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),zt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[X.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${X.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Mr(X.summary_md||"").map((P,ie)=>t.jsx("p",{children:P},ie))})]}),t.jsx(Or,{card:X,onEvaluate:P=>i(null,P),onAddAll:Le}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(qt)}),ra]})]}),z&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:L,placeholder:e.bulkPh,onChange:P=>S(P.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(E?" loading":""),style:{justifyContent:"center"},disabled:E||!le.length,onClick:()=>{xt()},children:[t.jsx("span",{className:"fill"}),E&&M?M:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(le.length)})]})]}),qe.slice(0,1).map((P,ie)=>{const de=P.verdict==="kept",Ne=P.verdict==="quota",He=de?"var(--brand)":Ne?"var(--bolt)":"var(--red)",Se=de?"var(--brand-l)":Ne?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":He,"--bgc":Se},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:de?"✓ "+e.kept:Ne?"⏳":"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(xe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:xe.url.startsWith("http")?xe.url:`https://${xe.url}`,target:"_blank",rel:"nofollow noopener",children:[(xe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,xe.url),children:e.evalPickGo})]},xe.url))}),!Ne&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:de?1:5});const xe=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const Re=[...document.querySelectorAll(".atl2 .list .row")].find(oa=>{var Lt;return(((Lt=oa.querySelector(".rnm"))==null?void 0:Lt.textContent)||"").trim().toLowerCase().includes(xe)});Re&&(Re.scrollIntoView({behavior:"smooth",block:"center"}),Re.classList.add("flashrow"),window.setTimeout(()=>Re.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(de?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ie)}),h&&(o.kept+o.dropped>0||qe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function fl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function xl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=$(),o=e.memoConsole?r.get(e.memoConsole):null,l=f.useMemo(()=>o?[o.reasoning||"",fl(o.summary||"")].filter(Boolean).join(`
...
`).map((x,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[dt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Fr({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=$(),[l,s]=f.useState(!1),[d,x]=f.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const c=async()=>{if(l)return;s(!0);const m=await Oo(r,e);if(s(!1),!m){o(a.actErr);return}x(m.results||[])};return t.jsxs("div",{className:"simb",onClick:m=>m.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{c()},children:l?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(m=>t.jsxs("li",{children:[t.jsx("b",{className:m.verdict==="kept"?"ok":"ko",children:m.company}),m.reason&&t.jsx("span",{children:m.reason})]},m.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const hl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),_t=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function gl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=_t(a.slice(n));break}r+=_t(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=_t(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),d=s?s[2].toLowerCase():"";s&&hl.has(d)?r+=`<${s[1]}${d}>`:r+=_t(a.slice(i,o+1)),n=o+1}return r}const Gn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ce({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function bl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function vl({o:e}){const{t:a,doDeep:r}=$(),[n,i]=f.useState(!1),o=Qe(e),l=[e.reasoning||"",bl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((s,d)=>t.jsx("p",{className:"cdtxt",children:s},d)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[dt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:s=>{s.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:s=>{s.stopPropagation(),i(d=>!d)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:s=>s.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:s=>s.stopPropagation()})]})}function Dr({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=$(),o=Ct(e),l=Qe(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,c=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),m=f.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:c},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||dt(e)?1:0}].filter(g=>g.n>0),[e,a,s,l,d,x,c]),[u,b]=f.useState("");if(!m.length)return null;const p=m.some(g=>g.k===u)?u:m[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:m.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":p===g.k,"data-tour":"tab-"+g.k,className:p===g.k?"on":"",onClick:v=>{v.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[p==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ce,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Ce,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Ce,{k:a.cdVerdictDate,v:Gn(e.verdictDate,r)})]})]}),p==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:gl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(yl,{o:e})]}),p==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ce,{k:a.cdSector,v:e.sector}),t.jsx(Ce,{k:a.cdStage,v:e.stage}),t.jsx(Ce,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ce,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ce,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ce,{k:a.cdAngle,v:e.angle}),t.jsx(Ce,{k:a.cdDetected,v:Gn(e.date,r)})]}),p==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ce,{k:a.cdName,v:e.contactName}),t.jsx(Ce,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ce,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),p==="memo"&&t.jsx(vl,{o:e}),p==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ce,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Ce,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function yl({o:e}){const{t:a,token:r}=$(),[n,i]=f.useState(!1),[o,l]=f.useState(null),s=async()=>{n||(i(!0),l(await Fo(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},x=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],c=x.some(([,m])=>m);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&c&&t.jsxs(t.Fragment,{children:[x.filter(([,m])=>m).map(([m,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:m}),t.jsx("p",{children:u})]},m)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!c&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function aa({spec:e}){const a=f.useRef(null),r=f.useRef(null),[n,i]=f.useState(!1);return f.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;return ln({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{l=!0,o.replaceChildren()}},[e]),f.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;ln({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!l&&d&&o.isConnected&&o.replaceChildren(d)});const s=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const wl=`
...
`;function kl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function jl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:d,doDecide:x,doPromote:c,doRepeche:m,doApproach:u,doDeep:b,doOnboard:p,outbound:g,evalBusy:v}=$(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const N=je(h),j=ke(h),y=Qe(h),z=Ct(h),R=h.kind==="target",L=S=>{a({type:"filters",patch:S}),a({type:"popup",id:null})};return mt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:wl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:kl(e.popupAnchor,!!h.card),onClick:S=>S.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(Ke(h.date)),Ue(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>L({country:[h.cc]}),children:(ft(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>L({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>L({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:At(h.amountEur,i)})]}),o.pipe&&R&&t.jsxs("div",{className:"pstat",children:[z&&t.jsx("span",{className:"vd "+(z==="MATCH"?"v-ok":"v-no"),title:n.vt[z],children:z}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[tt(h.engine)," ",t.jsx("b",{children:Ue(h.engine,i)})," — ",Do(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),N?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(rt,{o:h,lg:!0})," ",t.jsx(na,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(_a(N,i))," · ",n.win7(Ht(N,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(aa,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&R&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&R&&t.jsx(Dr,{o:h})]}),t.jsx(Fr,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(h,!1),a({type:"popup",id:null})},children:n.actNo}),dt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{p(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var S;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(S=document.querySelector(".atl2 .demand"))==null||S.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(h.name),onClick:()=>s(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const Nl=8;function Sl(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=$(),[s,d]=f.useState(!1),[x,c]=f.useState(!1),[m,u]=f.useState(!1),b=`atl2:sincemini:${r||"home"}`,[p,g]=f.useState(()=>{try{return localStorage.getItem(b)==="1"}catch{return!1}}),v=()=>{g(S=>{try{localStorage.setItem(b,S?"0":"1")}catch{}return!S})},h=r||"home",{names:N,verdicts:j}=f.useMemo(()=>{const S=[],E={};return n.forEach(k=>{k.kind!=="target"||!k.name||(S.push(k.name),E[k.name]=Po(k)||"")}),{names:S,verdicts:E}},[n]),y=f.useMemo(()=>N.length?Io(h,N,j,a):null,[h,N.length]);if(!i.pipe||s||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const z=x?y.added:y.added.slice(0,Nl),R=y.added.length-z.length,L=S=>{const E=n.find(k=>k.name===S);E&&(o(E.id),l({type:"popup",id:E.id}))};return t.jsxs("div",{className:"since"+(p?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!p,title:p?e.boxExpand:e.boxCollapse,onClick:v,children:p?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),$o(h,N,j,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[z.map(S=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>L(S),children:t.jsx("b",{children:S})},S)),R>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>c(!0),children:e.sinceMore(R)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>u(S=>!S),children:e.sinceOut(y.gone.length)}),m&&y.gone.slice(0,20).map(S=>t.jsx("span",{className:"gone",children:S},S))]})]})}const Pr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ka({o:e,locked:a=!1}){const{t:r}=$(),n=Ct(e),i=Qe(e),o=ke(e),l=ba(e),s=_o(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(Pr[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(ts,{o:e})]})}const ta=e=>e.length>22?e.slice(0,21)+"…":e;function Kn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=$(),[o,l]=f.useState(!1);if(f.useEffect(()=>{n||l(!1)},[n]),ze(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(ta(e.name))})]})}function Ir({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:d,doApproach:x,dispatch:c,liveMemos:m}=$();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:p=>{p.stopPropagation(),c({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{var g;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:p=>{var g;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Kn,{o:e})});const u=ke(e),b=p=>g=>{g.stopPropagation(),p()};if(u===0)return t.jsx("span",{className:"cell",children:t.jsx(Kn,{o:e})});if(u===1){const p=m.liveOf(e.name);if(p&&(p.status==="boot"||p.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(kt,{item:p,serverOff:m.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const g=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:g,onClick:b(()=>o(e)),children:g?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})});if(u===4){const p=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:p,onClick:b(()=>x(e)),children:p?a.actApproachSent:a.actApproach})})}return u===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):u===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:b(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>c({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function El({o:e}){const{t:a,doThumb:r,thumbOf:n}=$(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Cl({o:e}){const{lang:a}=$();return je(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(rt,{o:e}),t.jsx(na,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[tt(e.engine||"")," ",Ue(e.engine||"",a)]})})}function Al({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:d,favIds:x,toggleFav:c,t:m}=$(),u=ke(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],p=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,g=p<=0?0:p<=7?1:p<=30?2:3,v=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:b[g],h=x.has(e.id),N=j=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const y=j.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:y.left+Math.min(280,y.width/3),y:y.bottom}})};return t.jsxs(f.Fragment,{children:[t.jsxs("div",{className:"row"+(d===e.id||r?" on":"")+(r?" open":"")+(a?" tzr":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":v}}),t.jsx(Ur,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:h?1:.35,padding:0,marginRight:4},onClick:j=>{j.stopPropagation(),c(e)},children:h?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(j=>j&&j!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:j=>{j.stopPropagation(),o({type:"acquirer",value:e.acquirer||""})},children:["← ",ta(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Tl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Cl,{o:e}),l.pipe&&t.jsx(Ka,{o:e,locked:a}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Ir,{o:e}),l.showThumbs&&t.jsx(El,{o:e})]}),r&&!a&&t.jsx(ql,{o:e})]})}function Tl({o:e}){const{lang:a,caps:r}=$();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=At(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function zl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=$(),l=(u,b=!1)=>p=>{p.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),d=At(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=ze(e),m=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ta(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ta(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(aa,{spec:e.card})})]})}function ql({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=$();return!i.pipe&&e.kind==="op"?t.jsx(zl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Dr,{o:e}),t.jsx(as,{o:e}),t.jsx(os,{o:e}),t.jsx(Fr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Ka,{o:e})})]}),e.card&&t.jsx(aa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[tt(e.engine||"")," ",Ue(e.engine||"",r)]}),je(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(rt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Ll({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=$();if(!i.pipe&&e.kind==="op"){const x=At(e.amountEur,l),c=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),m=(u,b=!1)=>p=>{p.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(aa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:m({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:m({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:m({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[tt(e.engine||"")," ",Ue(e.engine||"",l)]}),je(e)&&t.jsx(rt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Ir,{o:e})})]})}const s=ke(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":d},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Ka,{o:e}),je(e)&&t.jsx(rt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Rl(){const{t:e}=$(),[a,r]=f.useState(0);return f.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Ml({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=$(),o=i==="en",l=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),d=s.includes(0)?0:s.sort((c,m)=>(e[m]||0)-(e[c]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:o?`${x} ${x>1?"files":"file"} in “${l(d)}”`:`${x} dossier${x>1?"s":""} dans « ${l(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+l(d)," →"]})]})}function Ol(){var Q,ge;const e=$(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:s,markRow:d,lang:x,sessTally:c,data:m,dossiers:u,source:b}=e,p=q=>i.lockRowsAfter!==null||b==="ops"&&(q==="ma"||q==="fundraising")?Number.MAX_SAFE_INTEGER:b==="ops"?8:or,[g,v]=f.useState(new Set);f.useEffect(()=>{v(new Set)},[a.ptab,a.continent]);const[h,N]=f.useState(null);f.useEffect(()=>{N(null)},[a.ptab,a.continent]);const j=q=>v(D=>{const B=new Set(D);return B.has(q)?B.delete(q):B.add(q),B}),[y,z]=f.useState("all"),[R,L]=f.useState(!1);f.useEffect(()=>{z("all"),L(!1)},[a.ptab,a.continent]),f.useEffect(()=>{if(!R)return;const q=D=>{var B,J;(J=(B=D.target)==null?void 0:B.closest)!=null&&J.call(B,".atl2 .doable")||L(!1)};return document.addEventListener("click",q),()=>document.removeEventListener("click",q)},[R]);const S=sr(),E=f.useMemo(()=>{var D;const q=new Map;for(const B of Ii(((D=S==null?void 0:S.ed)==null?void 0:D.html)||""))q.has(B.t)||q.set(B.t,B.html);return q},[(Q=S==null?void 0:S.ed)==null?void 0:Q.html]),k=f.useCallback(q=>{if(q.decryptHtml)return q.decryptHtml;if(!E.size)return;const D=(q.name||"").trim().toLowerCase();if(D.length<3)return;const B=E.get(D);if(B)return B;for(const[J,se]of E)if(J.includes(D)||D.includes(J))return se},[E]),M=f.useMemo(()=>{const q=Va(l,a.sort);return y==="all"?q:q.filter(D=>y==="explore"?!!D.noCo:!D.noCo)},[l,a.sort,b,y]),T=f.useMemo(()=>i.pipe?s.filter(q=>je(q)&&Bo(q)):M.filter(q=>je(q)&&!ze(q)),[i.pipe,s,M]),O=T.length,[C,A]=f.useState(!1),[F,U]=f.useState(!1),Y=`atl2:sigmini:${((ge=m.session)==null?void 0:ge.token)||"home"}`,[H,V]=f.useState(()=>{try{return localStorage.getItem(Y)==="1"}catch{return!1}}),G=f.useMemo(()=>i.pipe?M:M.filter(q=>!ze(q)&&!q.noCo),[M,i.pipe]),K=b==="ops"?M.filter(q=>q.noCo).length:0,ee=i.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,Z=a.filters,me=[];if(Z.day)me.push({k:"day",lib:n.fDay(Z.day.slice(8,10)+"/"+Z.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(Z.win&&Z.win!=="all"){const q=["1","7","30"].indexOf(Z.win);q>=0&&me.push({k:"win",lib:n.dates[q],off:()=>r({type:"filters",patch:{win:"all"}})})}const he=q=>q.length<=2?q.join(", "):`${q.length} ${n.fSelected}`;for(const q of["sector","country","engine"]){const D=Z[q];D&&D.length&&me.push({k:q,lib:he(D),off:()=>r({type:"clearFacet",facet:q})})}Z.search&&me.push({k:"search",lib:"🔍 "+Z.search,off:()=>r({type:"filters",patch:{search:""}})});const fe=(q,D,B="",J=!1)=>t.jsxs("button",{type:"button","data-s":q,className:B,"aria-sort":a.sort.key===q?a.sort.dir===1?"ascending":"descending":"none",style:J?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:q}),children:[D,t.jsx("span",{className:"ar",children:a.sort.key===q&&a.sort.dir===1?"▴":"▾"})]},q),X=f.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const q=new Map;M.forEach(J=>{const se=J.engine||"?";q.has(se)||q.set(se,[]),q.get(se).push(J)});const D={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},B=va([...q.keys()],x);return[...q.entries()].sort((J,se)=>{const te=D[J[0]]??10+B.indexOf(J[0]),le=D[se[0]]??10+B.indexOf(se[0]);return te-le})},[M,i.pipe,a.groupBy,x]),oe=i.lockRowsAfter;let ae=0;const W=(q,D)=>{let B=a.shown[D]||p(D);return q.length-B<=4&&(B=q.length),q.slice(0,B).map(te=>{const le=oe!==null&&ae>=oe;ae++;const qe=k(te),pe=qe&&qe!==te.decryptHtml?{...te,decryptHtml:qe}:te,Le=te.engine==="ma"||te.engine==="fundraising",Ve=a.dens!=="maxi"&&(a.dens==="deplie"||(h?h==="open":!!qe||b==="ops"&&Le)),it=g.has(te.id)?!Ve:Ve;return a.dens==="maxi"?t.jsx(Ll,{o:pe,locked:le},te.id):t.jsx(Al,{o:pe,locked:le,open:it,onToggle:()=>j(te.id)},te.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:M.length})," ",ee]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",me.map(q=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:D=>{D.stopPropagation(),q.off()},children:[q.lib,t.jsx("i",{children:"×"})]},q.k)),b==="ops"&&M.length>0&&" — "+n.edSplit(M.length-K,K)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([q,D])=>t.jsxs("button",{type:"button","data-d":q,"aria-pressed":a.dens===q||q==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:q}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:D})]},q))}),(i.showFunnel||b==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":h==="open",onClick:()=>{N("open"),v(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":h==="closed",onClick:()=>{N("closed"),v(new Set)},children:n.foldAllLbl}),b==="ops"&&t.jsxs("button",{type:"button","aria-pressed":h===null,onClick:()=>{N(null),v(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||b==="ops")&&(()=>{var B;const q=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],D=((B=q.find(([J])=>J===y))==null?void 0:B[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":R,onClick:()=>L(J=>!J),children:[D,t.jsx("i",{children:"▾"})]}),R&&t.jsx("div",{className:"dolist",children:q.map(([J,se])=>t.jsx("button",{type:"button","aria-pressed":y===J,onClick:()=>{z(J),L(!1)},children:se},J))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:q=>r({type:"sort",key:q.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([q,D])=>t.jsx("option",{value:q,children:D},q))})]}),i.showChain&&G.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:G.map(q=>q.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(G.length):n.chainAll(G.length)]}),a.mapFolded&&t.jsxs(t.Fragment,{children:[t.jsx(Rr,{}),t.jsx(Lr,{compact:!0})]})]}),t.jsx(Sl,{}),O>0&&!a.filters.signalOnly&&!F&&t.jsxs("div",{className:"sigstrip"+(H?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(O)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!H,title:H?n.boxExpand:n.boxCollapse,onClick:()=>V(q=>{try{localStorage.setItem(Y,q?"0":"1")}catch{}return!q}),children:H?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>U(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(C?T:T.slice(0,12)).map(q=>{const D=je(q);return D?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(_a(D,x),Ht(D,x)),onClick:()=>{d(q.id),r({type:"popup",id:q.id})},children:[t.jsx("b",{children:q.name}),t.jsxs("i",{children:[D.emoji," ",ya(D,x)]}),t.jsx("em",{children:Ht(D,x)})]},"sg-"+q.id):null}),!C&&T.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>A(!0),children:n.sigStripMore(T.length-12)})]})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),fe("country",n.colCountry),fe("name",n.colCompany),fe("amount",n.colAmount,"h-amt",!0),fe("stage",n.colStage,"h-stade"),fe("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[fe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),fe("memo",n.colMemo)]}),i.pipe&&fe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(M.length?"":" list-empty"),children:[X?X.map(([q,D])=>t.jsxs(f.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:tt(q)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:Ue(q,x)}),t.jsx("div",{className:"s",children:n.grpCount(D.filter(B=>!ze(B)).length,D.length)})]})]}),W(D,q)]},q)):W(M,"pt"+a.ptab),m.loading&&!u.length&&t.jsx(Rl,{}),!M.length&&!(m.loading&&!u.length)&&(i.pipe?t.jsx(Ml,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const q=X||[["pt"+a.ptab,M]];let D=0,B=0;for(const[se,te]of q){B+=te.length;let le=a.shown[se]||p(se);te.length-le<=4&&(le=te.length),D+=Math.min(te.length,le)}const J=B-D;return J<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>q.forEach(([se,te])=>r({type:"more",group:se,by:te.length,base:p(se)})),children:[t.jsx("span",{className:"more-label",children:n.more(J,J)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(D,B)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}})]})}function Qn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Fl(e,a){const r=Uo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Dl(e,a){const n=[a.head.split("|").map(Qn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Fl(i,a.plabels),Ct(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Qn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Pl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Il=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function $e({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function $l({o:e,qa:a}){const{t:r,lang:n,fund:i}=$(),o=(e.cribleStatus||"").trim().toUpperCase()||(Ct(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Qe(e),s=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx($e,{k:r.cdSector,v:e.sector}),t.jsx($e,{k:r.cdStage,v:e.stage}),t.jsx($e,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx($e,{k:r.cdSite,v:e.domain||e.website}),t.jsx($e,{k:r.cdName,v:e.contactName}),t.jsx($e,{k:r.cdEmail,v:e.contactEmail}),t.jsx($e,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx($e,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx($e,{k:r.cdAngle,v:e.angle}),t.jsx($e,{k:r.cdDetected,v:Il(e.date,n)})]}),d.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,x])=>x).map(([x,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:c})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Bl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=$(),[s,d]=f.useState({}),x=25,c=f.useMemo(()=>n.slice(0,x),[n]);f.useEffect(()=>{c.length&&Vo(r,c.map(b=>b.name)).then(d)},[r,c]);const m=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[u(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(m.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(m.screened/o.marketEstimate*100)," %"]})]})]}),c.map(b=>t.jsx($l,{o:b,qa:s[b.name]},b.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const _l=50;function Qa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=$(),[o,l]=f.useState(null),[s,d]=f.useState(!1),[x,c]=f.useState(""),[m,u]=f.useState(0),[b,p]=f.useState(""),[g,v]=f.useState(!1),h=f.useRef(null);f.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const N=async y=>{d(!0),c("");const z=await a();if(d(!1),z.ok){l(z);return}if(z.busy){c(i.alertPreviewBusy);return}if(!y){c(i.alertPreviewFail);return}u(_l),h.current=window.setInterval(()=>{u(R=>R>1?R-1:(h.current&&window.clearInterval(h.current),N(!1),0))},1e3)},j=async()=>{if(n||g)return;v(!0),p("");const y=await r();v(!1),p(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||m>0,onClick:()=>{N(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{j()},children:g?"…":i.alertTest})]}),m>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(m)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ct="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ae({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=$();return mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Ul(){const{st:e}=$();switch(e.modal){case"chain":return t.jsx(Hl,{});case"space":return t.jsx(Wl,{});case"alert":return t.jsx(Yl,{});case"queue":return t.jsx(Xl,{});case"export":return t.jsx(Zl,{});case"plug":return t.jsx(ac,{});case"recharge":return t.jsx(rc,{});case"cover":return t.jsx(ic,{});case"dossier":return t.jsx(oc,{});case"crit":return t.jsx(sc,{});case"tuto":return t.jsx(lc,{});case"rdv":return t.jsx(Vl,{});case"memoalert":return t.jsx(ec,{});default:return null}}function Vl(){const{dispatch:e,fund:a}=$(),r=typeof document<"u"&&!!document.getElementById("rdv");return f.useEffect(()=>{r&&(e({type:"modal",modal:null}),Ki())},[r,e]),r?null:t.jsx(Yo,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Hl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s,caps:d,memoQueued:x,doAnalyse:c}=$(),m=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,p=u[b],g=b>=u.length;return mt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:p.name}),t.jsx("div",{className:"sub",children:[ft(p.cc,i)||p.countryLabel,p.sector,p.stage,n.daysAgo(Ke(p.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Ue(p.engine,i).toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&t.jsx("span",{children:At(p.amountEur,i)})]}),je(p)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(rt,{o:p,lg:!0})," ",t.jsx(na,{o:p,src:!0})]}),(p.tagline||p.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:p.tagline||p.headline})]}),p.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:p.reasoning})]}),m&&ze(p)&&t.jsxs("div",{className:"vbox",style:{"--c":et(p)==="retenu"?"var(--brand)":et(p)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:et(p)==="retenu"?"✓ "+n.kept:et(p)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:p.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&p&&d.pipe&&ke(p)===1&&!x.has(p.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(p),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&p&&!(m&&ze(p))&&(p.noCo&&p.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:p.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(p)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function Wl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=$(),o=i==="client",l=f.useMemo(()=>o?r.filter(m=>ze(m)):[],[r,o]),s=f.useMemo(()=>Va(l.filter(m=>et(m)==="retenu"),{key:"signal",dir:-1}),[l]),d=f.useMemo(()=>l.filter(m=>et(m)==="ecarte"),[l]),x=e.spaceTab==="retenu"?s:d,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ae,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(m=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof m.score=="number"&&m.score>0?m.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:m.name}),t.jsx("div",{className:"rr",children:m.reasoning||m.tagline||""})]})]},m.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Yl(){const{mode:e}=$();return e==="client"||e==="apercu"?t.jsx(Gl,{}):t.jsx(Jl,{})}function Gl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),[o,l]=f.useState("d"),s=i!=="client";return t.jsxs(Ae,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(Kl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(Ql,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx($r,{})]})}function Kl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=f.useState(null),[s,d]=f.useState(!1),[x,c]=f.useState(0);f.useEffect(()=>{let p=!0;return d(!1),pn(a).then(g=>{p&&(g?l(g):d(!0))}),()=>{p=!1}},[a,x]);const m=p=>{r||pn(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=p=>!o.sections||o.sections.includes(p),b=p=>{const g=o.sections||e.alertSec.map(([v])=>v);m({sections:u(p)?g.filter(v=>v!==p):[...g,p]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([p,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(p),disabled:r,onChange:()=>b(p)}),t.jsxs("span",{children:[g,p==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},p))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Qa,{label:e.alertPreview,readOnly:r,onPreview:()=>ti(a),onTest:()=>ei(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ql({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=f.useState(null),[s,d]=f.useState(!1),[x,c]=f.useState(0);f.useEffect(()=>{let p=!0;return d(!1),un(a).then(g=>{p&&(g?l(g):d(!0))}),()=>{p=!1}},[a,x]);const m=p=>{r||un(a,p).then(g=>{if(!g){i(e.actErr);return}l(g),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(p=>p+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:p=>m({dow:Number(p.target.value)}),children:e.alertDow.map((p,g)=>t.jsx("option",{value:g,children:p},p))}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Qa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ni(a),onTest:()=>ai(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function $r(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=$(),[l,s]=f.useState(o||""),[d,x]=f.useState(!1),[c,m]=f.useState(!1);f.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,b=f.useMemo(()=>n.filter(h=>je(h)).length,[n]),p=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(l)||c)){m(!0);try{await fetch(`${Pa}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{m(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[p]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>Ue(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>ft(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([h,N])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:N}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:h=>s(h.target.value),onKeyDown:h=>{h.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Jl(){const{t:e}=$();return t.jsx(Ae,{title:e.alertTitle,icon:"🔔",children:t.jsx($r,{})})}function Xl(){var S,E;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:s,dispatch:d,liveMemos:x}=$(),[c,m]=f.useState(null),[u,b]=f.useState([]),[p,g]=f.useState(0),v=n==="client",h=f.useMemo(()=>{const k=new Map;return i.forEach(M=>{const T=(M.name||"").trim().toLowerCase();T&&!k.has(T)&&k.set(T,M)}),k},[i]);f.useEffect(()=>{let k=!0;return(async()=>{const[M,T]=await Promise.all([$a(r),tr(a)]);k&&(M&&m(M),b(T))})(),()=>{k=!1}},[a,r,p]);const N=(c==null?void 0:c.per_day)??0,j=((S=c==null?void 0:c.analyzed_today)==null?void 0:S.length)??0,y=c==null?void 0:c.offre,z=(c==null?void 0:c.pool_meta)||[],R=f.useMemo(()=>{const k=new Map;for(const M of(c==null?void 0:c.scheduled)||[])for(const T of M.names||[])k.has(T)||k.set(T,{label:M.day_label,date:M.date});return k},[c==null?void 0:c.scheduled]),L=(c==null?void 0:c.in_progress)||[];return t.jsxs(Ae,{title:e.queueTitle,wide:!0,children:[y&&t.jsxs("div",{className:"qoffre"+(y.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:y.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:y.delai})]}),t.jsx("span",{className:"osp"}),y.rythme>0?t.jsx("span",{className:"or",children:e.qRate(y.rythme)}):y.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(y.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(j,j+(((E=c==null?void 0:c.pool_order)==null?void 0:E.length)??0))}})}),y&&t.jsxs("div",{className:"qeta",children:[y.file===0?e.qEtaDone:y.rythme<=0?e.qEtaPaused:e.qEta(y.file,y.rythme,y.jours_restants),y.en_retard&&t.jsxs("em",{children:[" ",e.qLate(y.delai,y.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(y==null?void 0:y.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(L.length>0||x.items.some(k=>k.status==="boot"||k.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[x.items.filter(k=>k.status==="boot"||k.status==="running"||k.status==="error").map(k=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:k.name}),t.jsx("span",{className:"qd",children:k.memoType||""}),t.jsx(kt,{item:k,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+k.name)),L.filter(k=>!x.liveOf(k.name)).map(k=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:k.name}),t.jsxs("span",{className:"qd",children:[k.memo_type||"",k.age_min?` · ${Math.round(k.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:k.state||""})]},"ip-"+k.name))]})]}),u.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:u.map(k=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:k.company}),t.jsxs("span",{className:"qd",children:[k.memo_type,typeof k.est_min=="number"?` · ~${k.est_min} min`:""]}),t.jsx("span",{className:"qt",children:k.status}),k.url&&t.jsx("a",{className:"qgo",href:k.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),v&&k.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{dn(a,k.company,"retry").then(()=>g(M=>M+1))},children:e.queueRetry}),v&&k.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{dn(a,k.company,"delete").then(()=>g(M=>M+1))},children:e.queueDelete})]},k.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(z.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[z.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),z.map((k,M)=>{const T=R.get(k.name),O=h.get((k.name||"").trim().toLowerCase()),C=x.liveOf(k.name),A=!!(O&&l.has(O.id))||!!(C&&(C.status==="boot"||C.status==="running")),F=!!(O&&ke(O)===1&&!O.memoUrl)&&!C;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",M+1]}),T?t.jsx("span",{className:"qwhen"+(T.label==="demain"?" soon":""),children:T.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:k.name}),k.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof k.score=="number"&&t.jsx("span",{className:"qs2",children:k.score}),C&&(C.status==="boot"||C.status==="running")&&t.jsx(kt,{item:C,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),F&&(s.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:A,onClick:()=>{o(O),g(U=>U+1)},children:A?e.actAnalyseQueued:e.actAnalyse})),k.excerpt&&t.jsx("span",{className:"qex",children:k.excerpt})]},k.name+":"+M)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([k,M])=>t.jsxs("li",{children:[t.jsx("b",{children:k})," — ",M]},k))})]})}function Zl(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=$(),s=`${ct}/cibles/list.csv?token=${a}`,d=`${ct}/cibles/list.json?token=${a}`,x=`${ct}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,m=v=>{var h;(h=navigator.clipboard)==null||h.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:x,href:x}],b=!i.lockActions&&n.length>0,p=()=>{Pl(Dl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([h])=>h===v)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ae,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:p,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:h,href:N})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>m(h),children:e.exportCopy}),N&&t.jsx("a",{className:"exb",href:N,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function ec(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=$(),o=i!=="client",[l,s]=f.useState(null),[d,x]=f.useState(!1),[c,m]=f.useState(0),[u,b]=f.useState(!1);f.useEffect(()=>{let h=!0;return x(!1),cn(a).then(N=>{h&&(N?s(N):x(!0))}),()=>{h=!1}},[a,c]);const p=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=h=>{if(o||!l)return;const N={enabled:h.enabled??!!l.enabled,email:h.email??(l.email||""),sections:h.sections??p()};b(!0),cn(a,N).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(d)return t.jsx(Ae,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(h=>h+1),children:e.retry})]})});if(!l)return t.jsx(Ae,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=p();return t.jsxs(Ae,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(tc,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>g({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,N])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[h],disabled:o||u,onChange:()=>g({sections:{...v,[h]:!v[h]}})}),t.jsx("span",{children:N})]},h))}),t.jsx(Qa,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>Wo(a,v),onTest:()=>Ho(a,v)})]})}function tc({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=f.useState(e);f.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:x=>l(x.target.value),onKeyDown:x=>{x.key==="Enter"&&s&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!d,onClick:()=>i(o.trim()),children:n})]})]})}function ac(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=$(),[o,l]=f.useState(null),[s,d]=f.useState(!1),[x,c]=f.useState(null),[m,u]=f.useState(""),[b,p]=f.useState(0);f.useEffect(()=>{let j=!0;return d(!1),wa(a).then(y=>{j&&(y?l({configured:y.configured,url_hint:y.url_hint}):d(!0))}),Qo(a).then(y=>{j&&c(y)}),()=>{j=!1}},[a,b]);const g=(j,y)=>{i&&wa(a,j).then(z=>{if(!z||z.ok===!1){n(e.actErr);return}j.test&&z.sent===!1?n(e.plugTestThrottled):r(y),p(R=>R+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),N=`curl -X POST ${ct}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ae,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>p(j=>j+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:m,disabled:!i,onChange:j=>u(j.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!m.trim(),onClick:()=>g({url:m.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(nc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:N}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(N).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var j;(j=navigator.clipboard)==null||j.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function nc(){const{t:e,token:a,lang:r}=$(),[n,i]=f.useState("valides"),[o,l]=f.useState(!1),[s,d]=f.useState(null),[x,c]=f.useState(null),[m,u]=f.useState(!1),[b,p]=f.useState(!1),[g,v]=f.useState(null),[h,N]=f.useState(null),[j,y]=f.useState(null),z=`atl2:bulk:${a}:${n}`;f.useEffect(()=>{wa(a).then(T=>{N(T&&T.configured?T.url_hint||"webhook":null)})},[a]),f.useEffect(()=>{d(null),c(null),u(!1),v(null);try{const T=JSON.parse(localStorage.getItem(z)||"null");y(T&&Date.now()-Date.parse(T.t)<24*3600*1e3?T:null)}catch{y(null)}},[z]);const R=async()=>{l(!0),u(!1),v(null);const T=await Xo(a,n);d(T),c(T.ok?n:null),l(!1)},L=f.useRef(!1),S=async()=>{if(L.current)return;L.current=!0,p(!0);const T=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await Zo(a,n,"webhook",void 0,T)}finally{L.current=!1}if(p(!1),u(!1),v(O),O.ok&&(O.pushed||0)>0){const C={t:new Date().toISOString(),n:O.pushed||0};y(C);try{localStorage.setItem(z,JSON.stringify(C))}catch{}}},E=s!=null&&s.ok&&s.ready||0,k=!!(s!=null&&s.ok)&&x===n&&E>0&&!!h&&!j,M=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:T=>i(T.target.value),children:e.plugBulkTabs.map(([T,O])=>t.jsx("option",{value:T,children:O},T))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{R()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(M,j.n)}),!j&&!!(s!=null&&s.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),k&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),k&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(E,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{S()},children:b?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function rc(){const{t:e,data:a,lang:r}=$(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const x=await(await fetch(`${Pa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Ae,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function oc(){const{t:e}=$();return t.jsx(Ae,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Bl,{})})}function ic(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:s}=$(),[d,x]=f.useState(null),[c,m]=f.useState(!1);f.useEffect(()=>{let E=!0;if(o)return $a(o).then(k=>{E&&k&&typeof k.per_day=="number"&&x(k.per_day)}),()=>{E=!1}},[o]);const[u,b]=f.useState(null);f.useEffect(()=>{if(!i)return;let E=!0;return Ko(i).then(k=>{E&&b(k)}),()=>{E=!1}},[i]);const p=r.stats,g=typeof(p==null?void 0:p.screened)=="number"?p.screened:n.filter(E=>E.kind==="target"&&ze(E)).length,v=r.marketEstimate||0,h=v>0?Math.min(100,Math.round(g/v*100)):null,N=(p==null?void 0:p.window_days)||30,j=g>0?g/N:0,y=v>0?Math.max(0,v-g):0,R=v>0&&j>0&&g>=100?Math.round(y/j):null,L=E=>Math.round(E).toLocaleString(a==="en"?"en-US":"fr-FR"),S=E=>{c||!l||(m(!0),Jo(i,E).then(k=>{if(m(!1),k===null){s(e.actErr);return}x(k),s(e.alertSaved)}))};return t.jsxs(Ae,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(L(g))}),v>0&&t.jsx("span",{children:e.covOf(L(v))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),R!==null&&t.jsx("p",{className:"mnote",children:e.covEta(R)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(L(j))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((E,k)=>t.jsxs("tr",{className:E.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[E.code,E.geo?` · ${E.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof E.n=="number"?L(E.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:E.source}),E.elargi&&t.jsx("em",{children:e.covWide(String(E.demande||""))}),E.erreur&&t.jsx("em",{children:e.covMissing})]})]},k)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:L(u.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),p&&t.jsxs("div",{className:"covf",children:[typeof p.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:L(p.kept)})," ",e.covKept]}),typeof p.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:L(p.analyzed)})," ",e.covAna]}),typeof p.shown=="number"&&p.shown!==p.kept&&t.jsxs("span",{children:[t.jsx("b",{children:L(p.shown)})," ",e.funShown]})]}),l&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(E=>t.jsx("button",{type:"button",className:d===E?"on":"",disabled:c,onClick:()=>S(E),children:E===0?"⏸":E},E))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function sc(){var h,N,j;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:s}=$(),d=n==="client",x=f.useMemo(()=>{const y=new Set;return a.forEach(z=>{z.angle&&y.add(z.angle)}),[...y]},[a]),[c,m]=f.useState(""),[u,b]=f.useState(""),[p,g]=f.useState(!1),v=async()=>{const y=c.trim();if(!(!y||p||!d)){g(!0),b("");try{const R=await(await fetch(`${ct}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(R.reply&&b(String(R.reply)),R.job_id){b(e.critChatRunning);const L=async()=>{const S=await fetch(`${ct}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:R.job_id})}).then(E=>E.json()).catch(()=>null);if(S&&S.done){b(String(S.reply||S.clarification||S.summary||"✓")),g(!1),S.applied&&i(e.alertSaved);return}setTimeout(()=>{L()},8e3)};setTimeout(()=>{L()},8e3),m("");return}m("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(Ae,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((N=o==null?void 0:o.angles)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var z,R;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((z=y.look)!=null&&z.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(L=>t.jsx("li",{children:L},L))})]}),!!((R=y.out)!=null&&R.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(L=>t.jsx("li",{children:L},L))})]})]})]},y.title)})]}),!!((j=o==null?void 0:o.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!d||p,onChange:y=>m(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(p?" loading":""),style:{padding:"12px 18px"},disabled:!d||p||!c.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Go,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Pr[y]||"v-cons"),children:y}),t.jsx("span",{children:z})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",z]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function lc(){const{t:e,dispatch:a,startTour:r}=$(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ae,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Br="atl2:mapfold",cc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Br);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},_r=f.createContext(null),$=()=>{const e=f.useContext(_r);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function rt({o:e,lg:a}){const{lang:r}=$(),n=je(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:ya(n,r),children:[n.emoji," ",ya(n,r)]}):null}function na({o:e,src:a}){const{lang:r,t:n}=$(),i=je(e);if(!i)return null;const o=li(i),l=ci(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(_a(i,r))+" · "+n.win7(Ht(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Ur({o:e}){const{lang:a}=$(),r=si(e.cc),n=e.cc?ft(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Jn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",dc=!1;function pc(){const[e,a]=f.useState(!1);return f.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Vr=e=>`atl2:tour:${e||"anon"}`;function uc(e){try{return localStorage.getItem(Vr(e))==="1"}catch{return!0}}function Xn(e){try{localStorage.setItem(Vr(e),"1")}catch{}}function mc(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function bc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var Xa;const{lang:l}=ri(),s=ki[l],d=Mi(e,l,a),[x,c]=f.useReducer(Di,void 0,()=>Oi((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||cc(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),m=f.useRef(!0);f.useEffect(()=>{if(m.current){m.current=!1;return}if(!e)try{localStorage.setItem(Br,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e]);const u=f.useRef(o);u.current=o,f.useEffect(()=>{var w;(w=u.current)==null||w.call(u,x.filters)},[x.filters]);const[b,p]=f.useState(null),[g,v]=f.useState(null),[h,N]=f.useState({kept:0,dropped:0}),[j,y]=f.useState(!1),[z,R]=f.useState(""),[L,S]=f.useState(!1),[E,k]=f.useState(null),[M,T]=f.useState(!1),[O,C]=f.useState(!1),[,A]=f.useState(0),F=()=>A(w=>w+1),U=f.useRef([]),Y=f.useRef(new Set),H=f.useRef(new Set),[V,G]=f.useState([]),[K,ee]=f.useState([]),[Z,me]=f.useState(0),he=f.useRef(new Map),fe=f.useRef(null),{mode:X}=d,oe=f.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),ae=oe.pipe,W=d.session.token||"",Q=X==="client"&&!e;f.useEffect(()=>{if(!W||!ae)return;let w=!0;const _=async()=>{const ye=await di(W);!w||!ye||(ee(ye.runs),me(Date.now()/1e3-ye.now),G(Me=>Me.filter(ia=>!ye.runs.some(Je=>Ye(Je.company)===Ye(ia.name)))))};_();const I=V.length>0||K.some(ye=>ye.status==="running"),re=window.setInterval(()=>{_()},I?8e3:25e3);return()=>{w=!1,window.clearInterval(re)}},[W,ae,V.length,K.some(w=>w.status==="running")]);const ge=f.useMemo(()=>{const w=[],_=new Set;for(const I of V){const re=Ye(I.name);!re||_.has(re)||(_.add(re),w.push({name:I.name,id:I.id,status:"boot",started:I.started,estMin:I.estMin,memoType:"instant"}))}for(const I of K){const re=Ye(I.company);if(!re||_.has(re))continue;_.add(re);const ye=I.status==="error"?"error":I.status==="done"?"done":"running";w.push({name:I.company,status:ye,started:I.started||0,estMin:I.est_min||(I.memo_type==="detailed"?40:15),url:I.url,error:I.error,memoType:I.memo_type})}return w},[V,K]),q=w=>ge.find(_=>Ye(_.name)===Ye(w))||null,D=(w,_)=>{G(I=>I.some(re=>Ye(re.name)===Ye(w.name))?I:[...I,{name:w.name,id:w.id,started:Date.now()/1e3,estMin:_==="detailed"?40:15}]),Y.current.add(w.id),F()};f.useEffect(()=>{if(document.querySelector(`link[href="${Jn}"]`))return;const w=document.createElement("link");w.rel="stylesheet",w.href=Jn,document.head.appendChild(w)},[]);const B=(w,_=!1)=>{R(w),S(_),fe.current&&clearTimeout(fe.current),fe.current=setTimeout(()=>R(""),_?4200:2400)},J=w=>B(w,!0),se=f.useMemo(()=>{const w=new Map;return d.dossiers.forEach(_=>{_.id&&w.set(_.id,_)}),w},[d.dossiers]),te=f.useMemo(()=>d.dossiers.filter(w=>ir(w,x,ae)),[d.dossiers,x,ae]),le=f.useRef(!1);f.useEffect(()=>{if(le.current||e||d.loading||!d.dossiers.length)return;if(!oe.showFunnel||uc(d.session.token||"")){le.current=!0;return}le.current=!0;const w=window.setTimeout(()=>{Xn(d.session.token||""),T(!0)},700);return()=>window.clearTimeout(w)},[e,d.loading,d.dossiers.length,oe.showFunnel,d.session.token]);const qe=f.useMemo(()=>d.dossiers.filter(w=>Pi(w,x,ae,d.favIds)),[d.dossiers,x,ae,d.favIds]),pe=f.useMemo(()=>oi(te,d.favIds),[te,d.favIds]),Le=f.useMemo(()=>{const w=ur(d.dossiers);return w?Ke(w)===0?s.tourToday:mr(w,l):s.tourNoRun},[d.dossiers,s,l]),Ve=f.useMemo(()=>d.dossiers.some(w=>!!w.memoUrl||!!w.summary||dt(w)),[d.dossiers]),[it,xt]=f.useState(!1);f.useEffect(()=>{if(d.loading){xt(!1);return}if(d.dossiers.length>0||d.error){xt(!0);return}const w=window.setTimeout(()=>xt(!0),6e3);return()=>window.clearTimeout(w)},[d.loading,d.dossiers.length,d.error]);const Tt=(d.marketEstimate||0)>0||typeof((Xa=d.stats)==null?void 0:Xa.screened)=="number"&&d.stats.screened>0,zt=f.useMemo(()=>[1,0,2,4,5,3].find(w=>(pe[w]||0)>0)??0,[pe]),Ie=Ba.find(w=>w.key===x.continent),ra=x.continent==="monde"?s.contWorld:(l==="fr"?Ie==null?void 0:Ie.fr:Ie==null?void 0:Ie.en)||"";f.useEffect(()=>{const w=_=>{var re;const I=(((re=_.detail)==null?void 0:re.name)||"").trim();I&&qt(null,I)};return window.addEventListener("ppmap:evaluate",w),()=>window.removeEventListener("ppmap:evaluate",w)}),f.useEffect(()=>{const w=re=>{const ye=String(re||"").trim();ye&&c({type:"filters",patch:{sector:[ye]}})},_=re=>{var ye;return w((ye=re.detail)==null?void 0:ye.sector)},I=re=>{re.data&&re.data.type==="pp-filter"&&w(re.data.sector)};return window.addEventListener("ppmap:filter",_),window.addEventListener("message",I),()=>{window.removeEventListener("ppmap:filter",_),window.removeEventListener("message",I)}},[]);const qt=(w,_)=>{const I=((w==null?void 0:w.name)||_||"").trim();if(!Q){v({kicker:I});return}!I||j||(y(!0),(async()=>{try{let re=I;const ye=((w==null?void 0:w.website)||(w==null?void 0:w.domain)||"").trim();if(ye)re=ye;else try{const we=await pi(I);if(we!=null&&we.website)re=we.website;else if(((we==null?void 0:we.candidates)||[]).length===1)re=we.candidates[0].url;else if(((we==null?void 0:we.candidates)||[]).length>1){U.current=[{name:I,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(we.candidates||[]).slice(0,5)},...U.current].slice(0,8),F();return}}catch{}const Me=await nr(W,re,"atelier2"),ia={name:Me.company||I,verdict:Me.verdict,reason:Me.reason||"",remaining:Me.remaining??null};U.current=[ia,...U.current].slice(0,8),Me.verdict==="kept"&&N(we=>({...we,kept:we.kept+1})),Me.verdict==="ruled_out"&&N(we=>({...we,dropped:we.dropped+1}));const Je=w||d.dossiers.find(we=>(we.name||"").toLowerCase()===I.toLowerCase());Je&&(Me.verdict==="kept"?Je.verdict=Je.verdict||"MATCH":Me.verdict==="ruled_out"&&(Je.verdict="NO MATCH"),Me.reason&&(Je.reasoning=Me.reason)),F()}finally{y(!1)}})())},P=w=>{if(!Q){v({kicker:w.name});return}D(w,"instant"),ht(W,"fast_request",w.name||"",""),B(s.memoInstantSent(w.name))},ie=w=>he.current.get(w.id)??d.thumbs.get((w.name||"").trim().toLowerCase()),de=(w,_)=>c({type:"undoPush",entry:{id:w.id,name:w.name,prevCeoStatus:_}}),Ne=async(w,_,I)=>{const re=w.ceoStatus||"";w.ceoStatus=_,F();const ye=await la(W,{status:_,airtable_id:w.airtableId,check_id:w.checkId,company:w.name,...(I==null?void 0:I.note)!==void 0?{note:I.note}:{},...I!=null&&I.via?{via:I.via}:{}});return ye.ok?ye.skipped?(w.ceoStatus=re,F(),J(s.actNotPersisted),!1):((I==null?void 0:I.undo)!==!1&&de(w,re),I!=null&&I.msg&&B(I.msg),(_==="Validé"||_==="Écarté")&&!w.ceoNote&&(I==null?void 0:I.note)===void 0&&k({o:w,yes:_==="Validé"}),!0):(w.ceoStatus=re,F(),J(s.actErr),!1)},He=async(w,_)=>{const I=await la(W,{status:w.ceoStatus||"Retenu",airtable_id:w.airtableId,check_id:w.checkId,company:w.name,note:_,via:"note"});return!I.ok||I.skipped?(J(I.skipped?s.actNotPersisted:s.actErr),!1):(w.ceoNote=_,F(),!0)},Se=f.useRef(new Map),xe=w=>Se.current.has(w.id)?Se.current.get(w.id):d.stages.get((w.name||"").trim().toLowerCase()),Re=(w,_)=>{Se.current.set(w.id,_),F()},oa=(w,_)=>{Q&&Ne(w,_?"Validé":"Écarté",{msg:_?s.decidedYes(w.name):s.decidedNo(w.name)})},Lt=w=>{Q&&Ne(w,"À trancher",{msg:s.promoted(w.name)})},Hr=w=>{Q&&(async()=>{const _=w.ceoStatus||"";w.ceoStatus="Retenu",F();const I=await la(W,{status:"Retenu",check_id:w.checkId,company:w.name});if(!I.ok||I.skipped){w.ceoStatus=_,F(),J(I.skipped?s.actNotPersisted:s.actErr);return}de(w,_),B(s.repeched(w.name))})()},Wr=()=>{const w=x.undo[x.undo.length-1];if(!w){B(s.undoNone);return}const _=se.get(w.id);if(!_){c({type:"undoPop"}),B(s.undoNone);return}let I=w.prevCeoStatus;if(!I)if((_.verdict||"").toUpperCase().includes("CALL"))I="À trancher";else{B(s.undoLockedTitle);return}(async()=>await Ne(_,I,{undo:!1})&&(c({type:"undoPop"}),_.ceoStatus=w.prevCeoStatus,F(),B(s.undoDone(_.name))))()},Yr=w=>{Q&&(H.current.add(w.id),F(),(async()=>{const _=await ui(W,w.name,"email");if(!_||_.ok===!1){H.current.delete(w.id),F(),J(s.actErr);return}ht(W,"approach",w.name||"",""),B(s.actApproachSent)})())},Gr=(w,_)=>{Q&&(async()=>{if(!(await ht(W,_?"yes":"no",w.name||"","")).ok){J(s.actErr);return}he.current.set(w.id,_?"yes":"no"),F(),B(_?s.thumbUpDone:s.thumbDnDone)})()},Kr=w=>{!Q||!dt(w)||(D(w,"detailed"),ht(W,"detailed_request",w.name||"",""),B(s.memoDeepSent(w.name)))},Qr=w=>{const _=new Set(d.favIds),I=_.has(w.id);I?_.delete(w.id):_.add(w.id),d.setFavIds(_),Q&&mi(W,{id:w.id,co:w.name},I)},Jr=()=>{!Q||O||window.confirm(s.identSyncConfirm)&&(C(!0),(async()=>{const w=await fi(W);C(!1),w?B(s.identSyncDone):J(s.actErr)})())},Ja=/proplace/i.test(d.fund||""),Xr=w=>{!Q||!Ja||(ht(W,"onboard_request",w.name||"",""),B(s.onboardSent(w.name)))},Zr={st:x,dispatch:c,t:s,lang:l,mode:X,caps:oe,pipe:ae,token:W,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:Hr,thumbOf:ie,canWrite:Q,commitStatus:Ne,saveNote:He,stageOf:xe,setStage:Re,flashErr:J,startTour:()=>T(!0),dossiers:d.dossiers,scopedAll:te,scoped:qe,counts:pe,byId:se,contName:ra,favIds:d.favIds,toggleFav:Qr,askEvaluate:qt,doAnalyse:P,doDecide:oa,doPromote:Lt,doApproach:Yr,doThumb:Gr,doDeep:Kr,doUndo:Wr,doSync:Jr,doOnboard:Xr,outbound:Ja,memoQueued:Y.current,liveMemos:{items:ge,serverOff:Z,liveOf:q},approachDone:H.current,sessTally:h,evalCards:U.current,evalBusy:j,markRow:p,markedId:b,flash:B};f.useEffect(()=>{const w=_=>{_.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",w),()=>window.removeEventListener("keydown",w)},[]);const eo=w=>W?t.jsx($i,{token:W,children:w}):t.jsx(t.Fragment,{children:w});return t.jsx(_r.Provider,{value:Zr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Si}),oe.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:dr,children:Wa}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Wt}`,children:Wt})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),eo(t.jsxs("div",{className:"app"+(ae?" pipe":"")+(W?" has-thesis":""),children:[oe.showTicker&&t.jsx(Ee,{name:"live",children:t.jsxs("div",{className:"live-stack"+(W?" live-stack--cibles":""),children:[t.jsx(Yi,{}),!!W&&t.jsx(Bi,{})]})}),oe.showIdent&&t.jsx(Ee,{name:"identite",children:t.jsx(ls,{})}),!1,!!W&&t.jsx(Ee,{name:"brief",children:t.jsx(_i,{})}),dc,oe.showMorning&&t.jsx(Ee,{name:"matin",children:t.jsx(ss,{})}),t.jsx(Ee,{name:"mesure",children:t.jsx(Zi,{})}),oe.showFunnel&&t.jsx(Ee,{name:"entonnoir",children:t.jsx(fc,{})}),oe.showFunnel&&t.jsx(Ee,{name:"tunnel",children:t.jsx(cs,{})}),oe.showFunnel&&t.jsx(Ee,{name:"tuto",children:t.jsx(ds,{})}),!x.mapFolded&&t.jsx(Ee,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Rr,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[t.jsx(sl,{}),t.jsx(Lr,{})]})]})}),oe.showDemand&&ae&&t.jsx(Ee,{name:"direct",children:t.jsx(vi,{items:ge,serverOff:Z,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),oe.showDemand&&t.jsx(Ee,{name:"evaluation",children:t.jsx(ml,{})}),oe.showDemand&&x.memoConsole&&t.jsx(Ee,{name:"console",children:t.jsx(xl,{})}),t.jsx(Ee,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Ol,{})}),d.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:s.retry})]})]})),x.popupId&&t.jsx(Ee,{name:"fiche",children:t.jsx(jl,{})}),t.jsx(Ee,{name:"modales",children:t.jsx(Ul,{})}),t.jsx(Ji,{}),E&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:E.o.name}),t.jsx(rs,{placeholder:E.yes?s.whyYesPh:s.whyNoPh,onDone:w=>{const _=E.o;k(null),w&&He(_,w).then(I=>{I&&B(s.csNoteSaved)})}})]}),M&&it&&t.jsx(is,{steps:mc(s,Le,Ve,zt,Tt),onClose:()=>{T(!1),Xn(W)}}),t.jsx(pc,{}),z&&t.jsx("div",{className:"flash on"+(L?" err":""),children:z}),g&&t.jsx(ii,{variant:"acquirer",initialCompany:Zn().co,initialWebsite:Zn().site,onClose:()=>v(null)})]})})}function fc(){const{t:e}=$(),[a,r]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Zn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function xc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Ur as FlagCell,rt as SigBadge,na as SigWin,bc as default,xc as fmtShort,$ as useV2};
