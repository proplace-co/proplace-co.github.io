...
.atl2 .bulk .side .hint{white-space:nowrap}`,wr=`
...
`,kr=yr+wr;function nt(t){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(t)||""}catch{return""}}function jr(){const t=nt("teaser");if(t==="0"||t==="1")return t;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Nr(t,a){if(t||a.mode!=="client"||!a.token)return"visiteur";const n=jr();return n==="0"?"client":n==="1"||nt("embed")==="1"&&nt("chrome")==="1"?"apercu":"client"}const Sr={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Cr=t=>Sr[t],Se=t=>Object.assign(t,{continent:Aa(t.cc)});function Ze(t){const a=new Set,n=[];for(const r of t){const s=(r.name||"").toLowerCase();!s||a.has(s)||(a.add(s),n.push(r))}return n}const Er=60*60*1e3;function zr(t){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+t)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Er?null:a}catch{return null}}function Be(t,a){try{sessionStorage.setItem("ppmap:swr:"+t,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Tr=t=>t==="default"?"":t==="ops"?"ops":"research:"+t.research;function Ar(t,a,n="default"){const r=n!=="default",s=l.useMemo(()=>t||r?{mode:"anon"}:va(),[t,r]),o=l.useMemo(()=>r?"visiteur":Nr(t,s),[t,s,r]),d=l.useMemo(()=>Cr(o),[o]),i=o!=="visiteur",c=Tr(n),[m,b]=l.useState([]),[u,h]=l.useState(""),[v,f]=l.useState(null),[x,g]=l.useState(null),[p,y]=l.useState(null),[S,w]=l.useState(()=>new Map),[C,j]=l.useState(()=>new Map),[E,N]=l.useState(""),[q,$]=l.useState(new Set),[F,z]=l.useState(null),[_,D]=l.useState(!0),[Q,P]=l.useState(!1),[le,fe]=l.useState(0),[be,ve]=l.useState(0),I=l.useRef(0),pe=l.useMemo(()=>{var U;if(o!=="client")return"";try{return((U=ya())==null?void 0:U.email)||""}catch{return""}},[o]);l.useEffect(()=>{const U=++I.current;let M=!0;const B=()=>M&&U===I.current,O=(i&&s.token?s.token:"pub:"+a)+(c?":"+c:""),G=zr(O);return G?(b(G.objs.map(Se)),G.fund&&h(G.fund),f(G.marketEstimate??null),g(G.criteria??null),y(G.stats??null),N(G.generatedAt||""),D(!1)):D(!0),(async()=>{try{if(n==="ops"){const[K,oe]=await Promise.all([Qe(),wa()]),ee=ka(K,ja(oe)),J=((ee==null?void 0:ee.recent_ops)||[]).filter(ae=>Na((ae.company_name||ae.title||"").trim())).map(ae=>Je(ae,a)).filter(ae=>!!ae);if(!B())return;b(J.map(Se)),Be(O,{objs:J})}else if(typeof n=="object"){const oe=(await bt()||[]).filter(J=>(J.slug||"")===n.research).map(J=>vt(J,a)).filter(J=>!!J),ee=Ze(await yt(oe,a));if(!B())return;b(ee.map(Se)),Be(O,{objs:ee})}else if(i&&s.token){const K=Sa(s.token),oe=Qe(),ee=Ca(s.token),J=Ea(s.token),ae=za(s.token),H=await K;let de=H?H.targets:[];B()&&H&&(h(H.fund||""),f(H.marketEstimate??null),g(H.criteria??null),y(H.stats??null),N(H.generatedAt||""),b(de.map(Se)),D(!1),P(!1));const[ue,ye,ge,A]=await Promise.all([oe,ee,J,ae]),Y=((ue==null?void 0:ue.recent_ops)||[]).map(W=>Je(W,a)).filter(W=>!!W);if(de=[...de,...Y],!B())return;b(de.map(Se));const X=new Set;for(const W of ye){const me=(W.id||W.co||"").toString().trim().toLowerCase();me&&X.add(me.startsWith("t:")?me:"t:"+me)}$(X),w(ge),j(A),H&&Be(O,{fund:H.fund,marketEstimate:H.marketEstimate,criteria:H.criteria,stats:H.stats,generatedAt:H.generatedAt,objs:de})}else{const K=Ta(),oe=bt(),ee=Qe(),J=await K;B()&&J.length&&(b(Ze(J).map(Se)),D(!1),P(!1));const[ae,H]=await Promise.all([oe,ee]),de=(ae||[]).map(A=>vt(A,a)).filter(A=>!!A),ue=await yt(de,a),ye=((H==null?void 0:H.recent_ops)||[]).map(A=>Je(A,a)).filter(A=>!!A),ge=Ze([...J,...ue,...ye]);if(!B())return;b(ge.map(Se)),Be(O,{objs:ge})}B()&&P(!1)}catch{B()&&!G&&P(!0)}finally{B()&&D(!1)}})(),()=>{M=!1}},[i,s.token,a,le,c]),l.useEffect(()=>{if(!d.showCredits||!pe){z(null);return}let U=!0;return(async()=>{try{const M=await fetch(`${ot}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:pe})});if(!M.ok)return;const B=await M.json();U&&B&&B.ok!==!1&&z(B)}catch{}})(),()=>{U=!1}},[d.showCredits,pe,be]);const V=l.useCallback(U=>$(new Set(U)),[]);return{session:s,mode:o,caps:d,fund:u,email:pe,marketEstimate:v,generatedAt:E,criteria:x,stats:p,thumbs:S,stages:C,dossiers:m,favIds:q,setFavIds:V,credits:F,reloadCredits:()=>ve(U=>U+1),loading:_,error:Q,refresh:()=>fe(U=>U+1)}}const Gt=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Lr=(t="europe",a=!1,n)=>{var r;return{continent:t,ptab:(n==null?void 0:n.ptab)??1,dens:(n==null?void 0:n.dens)??"liste",filters:{...Gt(),...(n==null?void 0:n.filters)||{}},sort:{key:"signal",dir:-1},groupBy:(r=n==null?void 0:n.filters)!=null&&r.day||typeof window<"u"&&new URLSearchParams(window.location.search).get("source")==="ops"?"none":"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(n==null?void 0:n.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}};function qr(t,a){switch(a.type){case"continent":return{...t,continent:a.key,filters:{...t.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...t,ptab:a.tab,shown:{},popupId:null};case"dens":return{...t,dens:a.dens,shown:{}};case"filters":return{...t,filters:{...t.filters,...a.patch},shown:{}};case"toggleFacet":{const n=t.filters[a.facet],r=n.includes(a.value)?n.filter(s=>s!==a.value):[...n,a.value];return{...t,filters:{...t.filters,[a.facet]:r},shown:{}}}case"toggleMemoLevel":{const n=t.filters.memoLevel,r=n.includes(a.value)?n.filter(s=>s!==a.value):[...n,a.value];return{...t,filters:{...t.filters,memoLevel:r},shown:{}}}case"clearFacet":return{...t,filters:{...t.filters,[a.facet]:[]},shown:{}};case"reset":return{...t,filters:Gt(),shown:{},openFacet:null};case"sort":return{...t,sort:t.sort.key===a.key?{key:a.key,dir:t.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...t,groupBy:a.groupBy};case"more":return{...t,shown:{...t.shown,[a.group]:(t.shown[a.group]||Ve)+a.by}};case"pile":return{...t,pileMode:a.on,popupId:null};case"openFacet":return{...t,openFacet:t.openFacet===a.facet?null:a.facet};case"popup":return{...t,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...t,modal:a.modal,popupId:a.modal?null:t.popupId};case"chainStart":return{...t,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...t,chain:{...t.chain,idx:t.chain.idx+1}};case"spaceTab":return{...t,spaceTab:a.tab};case"memoConsole":return{...t,memoConsole:a.id,memoTab:0};case"memoTab":return{...t,memoTab:a.tab};case"undoPush":return{...t,undo:[...t.undo,a.entry].slice(-50)};case"undoPop":return{...t,undo:t.undo.slice(0,-1)};case"mapFold":return{...t,mapFolded:a.folded,openFacet:null};default:return t}}const Ve=40;function pt(t,a,n,r){if(r!=="signal"&&a.signalOnly&&(!ne(t)||a.signalEngines.length&&!a.signalEngines.includes(t.engine||""))||r!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(t.dealKind||"")||r!=="sector"&&a.sector.length&&!a.sector.includes(t.sector||"")||r!=="engine"&&a.engine.length&&!a.engine.includes(t.engine||"")||r!=="stage"&&a.stage.length&&!a.stage.includes(t.stage||"")||r!=="angle"&&n&&a.angle.length&&!a.angle.includes(t.angle||"")||r!=="memoLevel"&&n&&a.memoLevel.length&&!a.memoLevel.includes(st(t)))return!1;if(r!=="win"){if(a.day){if((t.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const s=a.win==="1"?0:a.win==="7"?7:30;if(Te(t.date)>s)return!1}}if(r!=="status"&&!n&&a.status!=="all"&&Ee(t)!==a.status)return!1;if(r!=="search"&&a.search.trim()){const s=a.search.trim().toLowerCase();if(!`${t.name||""} ${t.tagline||""} ${t.sector||""}`.toLowerCase().includes(s))return!1}return!0}function Kt(t,a,n){return t.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(t.cc||"")?!1:pt(t,a.filters,n)}function Rr(t,a,n,r){return!(!Kt(t,a,n)||n&&!La(t,a.ptab,r))}function ut(t,a){const n=a.key,r=s=>{switch(n){case"name":return(s.name||"").toLowerCase();case"country":return s.countryLabel||s.cc||"";case"stage":return s.stage||"";case"amount":return s.amountEur||-1;case"age":return-Te(s.date);case"score":return typeof s.score=="number"?s.score:-1;case"signal":{const o=ne(s);return o?100-(o.left??0):-1}}};return[...t].sort((s,o)=>{const d=r(s),i=r(o);return d<i?-a.dir:d>i?a.dir:(s.name||"").localeCompare(o.name||"")})}function Or(){const{dossiers:t,st:a,t:n,dispatch:r,contName:s,pipe:o}=T(),d=l.useMemo(()=>{const c=(a.filters.day||"").slice(0,10),m=v=>!(!o&&v.continent!==a.continent||c&&(v.date||"").slice(0,10)!==c),b=t.filter(v=>m(v)&&ne(v)),u=t.filter(v=>m(v)&&v.kind==="op"&&!ne(v)&&(c?!0:Te(v.date)<=7)),h=c||new Date().toISOString().slice(0,10);return u.sort((v,f)=>{const x=(v.date||"").slice(0,10)===h?0:1,g=(f.date||"").slice(0,10)===h?0:1;return x!==g?x-g:(f.amountEur||0)-(v.amountEur||0)}),[...ut(b,{key:"signal",dir:-1}),...u].slice(0,48)},[t,a.continent,a.filters.day,o]),i=c=>d.map(m=>e.jsxs("button",{type:"button",className:"tk"+(ce(m)?" spent":""),onClick:b=>{const u=b.currentTarget.getBoundingClientRect();r({type:"popup",id:m.id,anchor:{x:u.left+u.width/2,y:u.bottom}})},title:m.name+(m.tagline?" — "+m.tagline:""),children:[e.jsx(qe,{o:m}),e.jsxs("span",{className:"who",children:[e.jsx(na,{o:m}),e.jsx("span",{className:"co",children:m.name})]}),typeof m.amountEur=="number"&&m.amountEur>0&&e.jsx("span",{className:"am",children:co(m.amountEur)}),m.sector&&e.jsx("span",{className:"mt",children:m.sector}),e.jsx(We,{o:m}),e.jsx("span",{className:"tkgo",children:"→"})]},c+(m.id||m.name)));return e.jsxs("div",{className:"ticker",children:[e.jsxs("span",{className:"lbl",children:[e.jsx("i",{}),n.live,e.jsx("span",{className:"cnt",children:d.length})]}),e.jsx("div",{className:"win",children:d.length?e.jsxs("div",{className:"run",children:[i(0),i(1)]}):e.jsx("div",{className:"run",style:{animation:"none"},children:e.jsx("span",{className:"tk quiet",children:n.liveQuiet(s)})})})]})}const Fr="aDx8z7Hzksus",Qt="+33 6 83 10 72 86",Tt="alexandre@proplace.co",Mr=`tel:${Qt.replace(/[^\d+]/g,"")}`,At="pp-rdv-slot";function Dr(){const t=typeof document<"u"&&document.getElementById("rdv");return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Pr(){const{t,caps:a,fund:n}=T();if(!a.showOnb)return null;const r=n||t.rdvCoFallback;return e.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[e.jsx("style",{children:Br}),e.jsx("h2",{children:t.rdvHeading}),e.jsxs("p",{className:"pp-rdv-sub",children:[t.rdvSubBefore,e.jsx("a",{href:Mr,children:Qt}),t.rdvSubMid,e.jsx("a",{href:`mailto:${Tt}`,children:Tt})]}),e.jsx("div",{className:"pp-rdv-unlocks",children:t.rdvUnlocks(r).map(([s,o],d)=>e.jsxs("div",{className:"pp-rdv-u",children:[e.jsx("em",{children:t.rdvUnlockLabel(d+1)}),e.jsx("b",{children:s}),e.jsx("span",{children:o})]},s))}),e.jsx("div",{className:"pp-rdv-emb",children:e.jsx(gr,{filloutId:Fr,parameters:n?{company_name:n}:void 0})})]})}function Ir(){const[t,a]=l.useState(()=>typeof document>"u"?null:document.getElementById(At));return l.useEffect(()=>{t||a(document.getElementById(At))},[t]),t?Me.createPortal(e.jsx(Pr,{}),t):null}const Br=`
...
`;class te extends l.Component{constructor(){super(...arguments);gt(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(n,r){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,n,r.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const $r=8;function _r(){const{t,lang:a,token:n,dossiers:r,caps:s,markRow:o,dispatch:d}=T(),[i,c]=l.useState(!1),[m,b]=l.useState(!1),[u,h]=l.useState(!1),v=n||"home",{names:f,verdicts:x}=l.useMemo(()=>{const w=[],C={};return r.forEach(j=>{j.kind!=="target"||!j.name||(w.push(j.name),C[j.name]=qa(j)||"")}),{names:w,verdicts:C}},[r]),g=l.useMemo(()=>f.length?Ra(v,f,x,a):null,[v,f.length]);if(!s.pipe||i||!g||g.firstVisit||!g.added.length&&!g.gone.length)return null;const p=m?g.added:g.added.slice(0,$r),y=g.added.length-p.length,S=w=>{const C=r.find(j=>j.name===w);C&&(o(C.id),d({type:"popup",id:C.id}))};return e.jsxs("div",{className:"since",children:[e.jsxs("div",{className:"since-h",children:[e.jsxs("b",{children:["✨ ",t.sinceTitle(g.added.length,g.lastDate)]}),e.jsx("button",{type:"button",className:"x","aria-label":t.tourClose,title:t.tourClose,onClick:()=>{c(!0),Oa(v,f,x,g.fp,a)},children:"×"})]}),!!g.added.length&&e.jsxs("div",{className:"since-c",children:[p.map(w=>e.jsx("button",{type:"button",onClick:()=>S(w),children:w},w)),y>0&&e.jsx("button",{type:"button",className:"mr",onClick:()=>b(!0),children:t.sinceMore(y)})]}),!!g.gone.length&&e.jsxs("div",{className:"since-c",children:[e.jsx("button",{type:"button",className:"mr",onClick:()=>h(w=>!w),children:t.sinceOut(g.gone.length)}),u&&g.gone.slice(0,20).map(w=>e.jsx("span",{className:"gone",children:w},w))]})]})}const et=600,Ce=62,Lt="atl2:fstats";function Ur(){const{t,lang:a,data:n,caps:r,st:s,dispatch:o}=T(),[d,i]=l.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Lt)==="on"}catch{return!1}}),c=n.stats,m=l.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),b=l.useMemo(()=>{if(c!=null&&c.since)return c.since;const y=new Date;return y.setDate(y.getDate()-((c==null?void 0:c.window_days)||30)),y.toISOString().slice(0,10)},[c==null?void 0:c.since,c==null?void 0:c.window_days]);if(!r.showFunnel||!c||typeof c.screened!="number")return null;const u=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,h=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=m.reduce((y,S)=>Math.max(y,S.s||0),0),f=m.length?et/m.length:0,x=Math.max(4,f-4),g=m.length>=5&&v>0,p=[[c.screened,t.funScreened(u(b)),c.screened_today],...typeof c.kept=="number"?[[c.kept,t.funKept,c.kept_today]]:[],...typeof c.analyzed=="number"?[[c.analyzed,t.funAnalyzed,c.analyzed_today]]:[],...typeof c.shown=="number"?[[c.shown,t.funShown,void 0]]:[]];return e.jsxs("div",{className:"fstats"+(d?" on":""),children:[e.jsxs("div",{className:"fst-row",children:[p.map(([y,S,w],C)=>e.jsxs("span",{className:"fst-t",children:[C>0&&e.jsx("span",{className:"fst-ar",children:"→"}),e.jsx("b",{children:h(y)}),e.jsx("i",{children:S}),d&&typeof w=="number"&&w>0&&e.jsx("em",{children:t.funToday(w)})]},S)),g&&e.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?t.fstatsHide:t.fstatsShow,onClick:()=>{const y=!d;i(y),y&&!s.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Lt,y?"on":"off")}catch{}},children:d?"⌃":"⌄"})]}),d&&g&&e.jsxs("div",{className:"fst-act",children:[e.jsxs("div",{className:"fst-ah",children:[e.jsx("span",{children:t.actTitle}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#185c38"}}),t.actKept]}),e.jsxs("span",{className:"fst-lg",children:[e.jsx("i",{style:{background:"#cfe0d6"}}),t.actScreened]})]}),e.jsxs("svg",{viewBox:`0 0 ${et} ${Ce}`,preserveAspectRatio:"none",role:"img","aria-label":t.actTitle,children:[m.map((y,S)=>{const w=(y.s||0)/v*(Ce-4),C=(y.m||0)/v*(Ce-4),j=S*f+(f-x)/2;return e.jsxs("g",{children:[e.jsx("title",{children:`${u(y.d)} — ${y.s} ${t.actScreened} · ${y.m} ${t.actKept}`}),e.jsx("rect",{x:j,y:Ce-2-w,width:x,height:w,fill:"#cfe0d6"}),e.jsx("rect",{x:j,y:Ce-2-C,width:x,height:C,fill:"#185c38"})]},y.d)}),e.jsx("line",{x1:0,y1:Ce-1.5,x2:et,y2:Ce-1.5,stroke:"#dbe5df",strokeWidth:1})]}),e.jsxs("div",{className:"fst-ax",children:[e.jsx("span",{children:u(m[0].d)}),e.jsx("span",{children:t.actToday})]})]})]})}const Vr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Hr({o:t}){const{t:a,caps:n,canWrite:r,commitStatus:s}=T(),[o,d]=l.useState(""),[i,c]=l.useState(!1);if(!n.pipe||!r||n.lockActions)return null;const m=(t.ceoStatus||"").trim(),b=(Ae(t)||"").startsWith("CALL")&&ie(t)===3,u=ie(t)>=2,h=async f=>{if(o||f==="Analysé"&&!t.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(f);const x=await s(t,f);d(""),x&&(c(!0),setTimeout(()=>c(!1),2200))},v=b?[["Validé",a.csYes],["Écarté",a.csNo]]:Vr.filter(([f])=>!(u&&f==="Retenu")).map(([f,x])=>[f,a[x]]);return e.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[e.jsxs("div",{className:"csrow",children:[e.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([f,x])=>e.jsx("button",{type:"button",className:"csb"+(m===f?" on":"")+(o===f?" busy":""),disabled:!!o,onClick:()=>{h(f)},children:x},f)),i&&e.jsx("span",{className:"csok",children:a.csSaved})]}),e.jsx(Yr,{o:t})]})}function Yr({o:t}){const{t:a,saveNote:n,flash:r}=T(),[s,o]=l.useState(t.ceoNote||""),[d,i]=l.useState(!1),[c,m]=l.useState(!1),b=s.trim()!==(t.ceoNote||"").trim(),u=async()=>{if(d||!b)return;i(!0);const h=await n(t,s.trim());i(!1),h&&(m(!0),setTimeout(()=>m(!1),2200),r(a.csNoteSaved))};return e.jsxs("div",{className:"csnote",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:s,disabled:d,onChange:h=>o(h.target.value),onKeyDown:h=>{h.key==="Enter"&&u()}}),e.jsx("button",{type:"button",disabled:d||!b,onClick:()=>{u()},children:c?a.csNoteSaved:a.csNoteOk})]})}function Wr({placeholder:t,onDone:a}){const{t:n}=T(),[r,s]=l.useState("");return e.jsxs("div",{className:"csnote why",children:[e.jsx("input",{type:"text",maxLength:200,placeholder:t,value:r,autoFocus:!0,onChange:o=>s(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(r.trim()),o.key==="Escape"&&a("")},onBlur:()=>{r.trim()||a("")}}),e.jsx("button",{type:"button",onClick:()=>a(r.trim()),children:n.whySend})]})}function Gr({o:t}){var g;const{t:a,token:n,caps:r,canWrite:s,stageOf:o,setStage:d,flashErr:i}=T(),[c,m]=l.useState(!1);if(!r.pipe||!s||r.lockActions||ie(t)!==4)return null;const b=o(t),u=(b==null?void 0:b.stage)||"todo",h=async p=>{if(c||p===u)return;m(!0);const y=b;d(t,{stage:p,stamps:(b==null?void 0:b.stamps)||{}});const S=Math.max(Date.now(),qt+=1);qt=S;const w=await Fa(n,{company:t.name||"",stage:p,cts:S,deal_id:t.airtableId,check_id:t.checkId});m(!1),!w.stale&&(w.ok||(d(t,y),i(a.actErr)))},v=(g=b==null?void 0:b.stamps)==null?void 0:g.sent,f=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,x=u==="sent"&&v&&f>=4;return e.jsxs("div",{className:"stg",onClick:p=>p.stopPropagation(),children:[e.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([p,y])=>e.jsx("button",{type:"button",className:"stgb"+(u===p?" on":""),disabled:c,onClick:()=>{h(p)},children:y},p)),x&&e.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let qt=0;const $e=8,_e=340;function Rt({text:t}){const a=t.split(/\*\*(.+?)\*\*/g);return e.jsx(e.Fragment,{children:a.map((n,r)=>r%2?e.jsx("b",{children:n},r):e.jsx("span",{children:n},r))})}function Kr({steps:t,onClose:a}){const{t:n,dispatch:r,counts:s,scoped:o,byId:d,st:i}=T(),[c,m]=l.useState(0),[b,u]=l.useState(null),[h,v]=l.useState([]),f=l.useRef(!1);l.useEffect(()=>{f.current||(f.current=!0,v(t.filter(C=>!!document.querySelector(C.need||C.sel))))},[t]);const x=h[c],g=c>=h.length;l.useEffect(()=>{x&&(x.ptab!==void 0&&i.ptab!==x.ptab&&r({type:"ptab",tab:x.ptab}),x.dens&&i.dens!==x.dens&&r({type:"dens",dens:x.dens}))},[c,x]);const p=l.useCallback(()=>{if(!x){u(null);return}const C=document.querySelector(x.sel);if(!C){u(null);return}C.scrollIntoView({block:"nearest",behavior:"smooth"}),u(C.getBoundingClientRect())},[x]);l.useLayoutEffect(()=>{p();const C=window.setTimeout(p,260),j=()=>p();return window.addEventListener("scroll",j,!0),window.addEventListener("resize",j),()=>{window.clearTimeout(C),window.removeEventListener("scroll",j,!0),window.removeEventListener("resize",j)}},[p]);const y=l.useRef(a);if(y.current=a,l.useEffect(()=>{const C=j=>{j.key==="Escape"?(j.preventDefault(),j.stopPropagation(),y.current()):j.key==="ArrowRight"?m(E=>E+1):j.key==="ArrowLeft"&&m(E=>Math.max(0,E-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!h.length)return null;let S=null;if(g){const C=s[3]||0,j=o.find(E=>E.memoUrl)||[...d.values()].find(E=>E.memoUrl);C>0?S={title:C===1?n.ahaATitle1:n.ahaATitleN(C),body:n.ahaABody,btn:n.ahaABtn,go:()=>{r({type:"ptab",tab:3}),a()}}:j?S={title:n.ahaBTitle,body:n.ahaBBody(j.name),btn:n.ahaBBtn,go:()=>{r({type:"memoConsole",id:j.id}),a()}}:S={title:n.ahaCTitle,body:n.ahaCBody,btn:n.ahaCBtn,go:()=>{r({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:_e};if(!g&&b){const C=b.bottom+14,E=window.innerHeight-C>190?C:Math.max(12,b.top-200);w={left:Math.min(Math.max(12,b.left+b.width/2-_e/2),window.innerWidth-_e-12),top:E,width:_e}}return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!g&&b&&e.jsx("div",{className:"tour-hole",style:{left:b.left-$e,top:b.top-$e,width:b.width+$e*2,height:b.height+$e*2}}),(g||!b)&&e.jsx("div",{className:"tour-veil"}),e.jsxs("div",{className:"tour-card"+(g?" fin":""),style:w,children:[g&&S?e.jsxs(e.Fragment,{children:[e.jsx("h3",{children:S.title}),e.jsx("p",{children:e.jsx(Rt,{text:S.body})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",onClick:()=>m(h.length-1),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:S.go,children:S.btn})]})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"tour-n",children:n.tourStep(c+1,h.length)}),e.jsx("h3",{children:x==null?void 0:x.title}),e.jsx("p",{children:e.jsx(Rt,{text:(x==null?void 0:x.body)||""})}),e.jsxs("div",{className:"tour-nav",children:[e.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>m(C=>Math.max(0,C-1)),children:n.tourPrev}),e.jsx("button",{type:"button",className:"pri",onClick:()=>m(C=>C+1),children:c===h.length-1?n.tourDone:n.tourNext})]})]}),e.jsx("button",{type:"button",className:"tour-x","aria-label":n.tourClose,title:n.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Qr(){const{dossiers:t,scopedAll:a,pipe:n,mode:r,t:s,st:o,dispatch:d}=T(),i=n?a:t,c=l.useMemo(()=>i.filter(p=>Te(p.date)===0&&p.kind==="target"),[i]),m=l.useMemo(()=>n?a.filter(p=>ie(p)===0).slice().sort((p,y)=>(y.date||"").localeCompare(p.date||"")):[],[a,n]),b=l.useMemo(()=>c.filter(p=>n?ie(p)===0:!ce(p)),[c,n]),u=n?m:b,h=n?a.length-m.length:c.length-b.length,v=n?a.length:c.length,f=v?Math.min(100,h/v*100):100;let x;n?x=s.morningThesis(c.length,m.length):c.length?h===0?x=s.goalSourced(c.length):h>=c.length?x=s.goalCleared:x=s.goalDone(h,c.length):x=s.goalSourced(0);const g=()=>{if(!n){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),r==="client"&&m.length&&d({type:"chainStart",queue:m.map(p=>p.id)})};return e.jsxs("div",{className:"goal",children:[e.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:x}}),e.jsx("div",{className:"pbar",children:e.jsx("i",{style:{width:f+"%"}})}),u.length>0&&e.jsx("button",{type:"button",className:"pilebtn",onClick:g,children:n?s.morningEval(u.length):o.pileMode?s.goalContinue(u.length):s.goalTreat}),e.jsx("span",{className:"gspace"})]})}function Jr(){var $,F;const{t,lang:a,st:n,dispatch:r,token:s,fund:o,data:d,dossiers:i,mode:c,doSync:m,startTour:b}=T(),[u,h]=l.useState(null),[v,f]=l.useState([]),x=c==="client";l.useEffect(()=>{if(!s||!o)return;let z=!0;return(async()=>{const[_,D]=await Promise.all([it(o),Vt(s)]);z&&(_&&h(_),f(D))})(),()=>{z=!1}},[s,o]);const g=(u==null?void 0:u.per_day)??null,p=(($=u==null?void 0:u.pool_order)==null?void 0:$.length)??0,y=v.filter(z=>z.status==="running").length,S=l.useMemo(()=>i.filter(z=>z.kind==="target"&&ce(z)).length,[i]),w=d.marketEstimate,C=typeof((F=d.stats)==null?void 0:F.screened)=="number"?d.stats.screened:S,j=w&&w>0?Math.min(100,Math.round(C/w*100)):null,E=z=>z.toLocaleString(a==="en"?"en-US":"fr-FR"),N=(o||"P").split(/\s+/).map(z=>z[0]).join("").slice(0,2).toUpperCase(),q=(()=>{const z=Date.parse(d.generatedAt||"");if(Number.isNaN(z))return"";const _=new Date(z),D=Q=>String(Q).padStart(2,"0");return`${D(_.getDate())}/${D(_.getMonth()+1)} à ${D(_.getHours())}:${D(_.getMinutes())}`})();return e.jsxs("div",{className:"ident",children:[e.jsxs("div",{className:"idtop",children:[e.jsxs("span",{className:"brand",children:[e.jsx("b",{children:N}),e.jsx("i",{children:o})]}),e.jsx("h1",{children:t.identTitle(o||"…")}),e.jsx("span",{className:"idsp"}),q&&e.jsx("span",{className:"idupd",children:t.identUpdatedAt(q)}),e.jsx("button",{type:"button",className:"ic",title:t.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),e.jsx("button",{type:"button",className:"ic",title:t.tourPlayTitle,onClick:b,children:"▶"})]}),e.jsxs("div",{className:"idmain",children:[j===null&&C>0&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsx("span",{className:"ev",children:e.jsx("b",{children:E(C)})})]}),j!==null&&w&&e.jsxs("span",{className:"cover",title:t.coverTitle,onClick:()=>r({type:"modal",modal:"cover"}),children:[e.jsx("span",{className:"el",children:t.identCoverage}),e.jsxs("span",{className:"ev",children:[e.jsx("span",{className:"bar",children:e.jsx("i",{style:{width:j+"%"}})}),e.jsxs("b",{children:[j," %"]})]}),e.jsx("span",{className:"edv"}),e.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:t.identCoverageOf(C,w)}})]}),e.jsxs("span",{className:"engine",title:t.queueTitle,onClick:()=>r({type:"modal",modal:"queue"}),children:[e.jsx("span",{className:"el",children:t.identEngine}),g!==null&&e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ev",children:[e.jsx("b",{className:"q",children:g})," ",t.identPerDay]}),e.jsx("span",{className:"edv"})]}),g===0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"epause",title:t.identPauseTitle,children:t.identPause}),e.jsx("span",{className:"edv"})]}),y>0&&e.jsxs("span",{className:"ev",children:["⏳ ",y]}),e.jsx("span",{className:"ego",children:t.identPending(p)}),e.jsx("button",{type:"button",className:"ebell",title:t.memoAlertBtn,onClick:z=>{z.stopPropagation(),r({type:"modal",modal:"memoalert"})},children:"🔔"})]}),e.jsx("span",{className:"idsp"}),e.jsxs("span",{className:"icgrp",children:[e.jsx("button",{type:"button",className:"ic",title:t.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),e.jsx("button",{type:"button",className:"ic",title:t.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),e.jsx("button",{type:"button",className:"ic",title:t.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),e.jsx("button",{type:"button",className:"ic",title:t.identSync,disabled:!x,onClick:m,children:"🔄"})]}),e.jsxs("span",{className:"isrch",children:["🔍",e.jsx("input",{placeholder:t.identSearch,value:n.filters.search,onChange:z=>r({type:"filters",patch:{search:z.target.value}})})]})]})]})}function Xr(){const{t,counts:a,dispatch:n}=T();return e.jsxs("div",{className:"onb",children:[e.jsxs("div",{className:"onbh",children:[e.jsxs("span",{className:"tag",children:[e.jsx("i",{}),t.onbTag]}),e.jsx("h2",{dangerouslySetInnerHTML:{__html:t.onbTitle(a[1]+a[2]+a[3])}}),e.jsx("div",{className:"sub",children:t.onbSub(a[7])})]}),e.jsx("div",{className:"steps4",children:t.onbSteps.map(([r,s],o)=>{const d=o===t.onbSteps.length-1;return e.jsxs("div",{className:"s4"+(d?" go":""),children:[e.jsx("span",{className:"s4n",children:o+1}),e.jsx("div",{className:"s4t",children:r}),e.jsx("div",{className:"s4d",children:s}),d&&e.jsx("button",{type:"button",className:"s4b p",onClick:()=>n({type:"modal",modal:"rdv"}),children:t.onbCta})]},o)})})]})}const Zr=["--p0","--p1","--p2","--p3","--p4"];function en(){const{st:t,dispatch:a,counts:n,t:r,doUndo:s}=T(),o=l.useRef({});l.useEffect(()=>{o.current={...n}},[n]);const d=m=>{const b=o.current[m],u=b!==void 0?n[m]-b:0;return e.jsxs("button",{type:"button",className:"step"+(m===3&&n[3]>0?" wait":""),style:{"--c":`var(${Zr[m]})`,"--tc":m<=3?"var(--ink)":"#fff"},"aria-selected":t.ptab===m,title:r.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsxs("span",{className:"l",children:[r.plabels[m].toUpperCase(),m===3&&n[3]>0&&e.jsx("i",{className:"wd"})]}),e.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[n[m],u!==0&&e.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},m)},i=(m,b,u)=>e.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":m===5?"var(--p5)":m===6?"var(--pf)":"var(--pv)"},"aria-selected":t.ptab===m,title:r.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[e.jsx("span",{className:"l",children:u.toUpperCase()}),e.jsx("span",{className:"n",children:n[m]})]},m),c=(m,b,u,h=!1)=>e.jsx("button",{type:"button",className:"tool",title:b,disabled:h,onClick:u,children:m},b);return e.jsxs("div",{className:"funnel",children:[e.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(d)}),e.jsxs("div",{className:"offtrack",children:[i(5,!1,r.plabels[5]),i(7,!0,r.plabels[7]),i(6,!0,"★ "+r.plabels[6])]}),e.jsxs("span",{className:"ftools",children:[c("↩",r.toolUndo,s,t.undo.length===0),c("↺",r.toolReset,()=>{a({type:"reset"})}),c("⇅",r.toolSort,()=>a({type:"sort",key:t.sort.key})),c("▶",r.toolTuto,()=>a({type:"modal",modal:"tuto"})),c("⚙",r.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const tn=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function an(){const{st:t,dispatch:a,t:n,scoped:r,memoQueued:s,doAnalyse:o,mode:d}=T(),i=l.useRef(null),[c,m]=l.useState(60);l.useEffect(()=>{let v=0;const f=()=>{var S;const x=i.current;if(!x)return;const g=(S=x.parentElement)==null?void 0:S.querySelector('.funnel [aria-selected="true"]');if(!g)return;const p=g.getBoundingClientRect(),y=x.getBoundingClientRect();m(Math.max(20,Math.min(p.left+p.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(f),window.addEventListener("resize",f),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",f)}},[t.ptab]);const b=t.ptab;let u=n.tuto[b].p;if(b===3){const v=r.filter(g=>g.kind==="target"&&ie(g)===3),f=v.filter(g=>at(g)==="auto").length,x=v.filter(g=>at(g)==="cd").length;u=n.tutoPending(f,x,v.length)}const h=(()=>{if(d!=="client")return null;if(b===0&&r.length)return{label:n.tuto[0].a,run:()=>a({type:"chainStart",queue:r.map(v=>v.id)})};if(b===1){const v=r.filter(f=>f.kind==="target"&&ie(f)===1&&!s.has(f.id)).slice(0,10);if(v.length)return{label:n.tuto[1].a,run:()=>v.forEach(f=>o(f))}}return null})();return e.jsxs("div",{ref:i,className:"tuto mini",style:{"--bg":tn[b],"--ax":c+"px","--stc":"var(--ink)"},children:[e.jsx("span",{className:"txt",children:e.jsxs("p",{children:[e.jsx("b",{className:"tstep",children:n.plabels[b].toUpperCase()}),e.jsx("span",{dangerouslySetInnerHTML:{__html:u}})]})}),h&&e.jsx("button",{type:"button",className:"tprim",onClick:h.run,children:h.label})]})}const Ot=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Ft(t){let a=2166136261;for(let n=0;n<t.length;n++)a^=t.charCodeAt(n),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function rn(t,a){const[n,r]=l.useState(1);return l.useEffect(()=>{let s=!0,o=0;const d=()=>{var m;if(!s)return;const c=(m=t.current)==null?void 0:m.getScreenCTM();c&&c.a>0?r(c.a):o=requestAnimationFrame(d)};d();const i=new ResizeObserver(()=>d());return t.current&&i.observe(t.current),window.addEventListener("resize",d),()=>{s=!1,cancelAnimationFrame(o),i.disconnect(),window.removeEventListener("resize",d)}},[t,a]),n}function nn(){const{st:t,dispatch:a,scoped:n,pipe:r,markRow:s,markedId:o,byId:d,lang:i,t:c}=T(),m=l.useRef(null),b=l.useRef(null),u=lt.find(N=>N.key===t.continent),h=rn(m,t.continent+":"+t.mapFolded),[v,f]=l.useState(new Map),[x,g]=l.useState(null);l.useEffect(()=>{const N=m.current;if(!N)return;const q=new Map;N.querySelectorAll("path[data-i2]").forEach($=>{const F=$.dataset.i2;if(F)try{const z=$.getBBox();z.width>0&&q.set(F,{x:z.x,y:z.y,w:z.width,h:z.height})}catch{}}),f(q)},[t.continent,h]);const p=l.useMemo(()=>n.filter(N=>N.cc),[n]),y=l.useMemo(()=>{const N=new Map;return p.forEach(q=>N.set(q.cc,(N.get(q.cc)||0)+1)),N},[p]),S=l.useMemo(()=>p.map(N=>{const q=N.cc?v.get(N.cc):void 0;if(!q)return null;const $=Ft(N.name||N.id||""),F=Ft((N.id||N.name||"")+"·y"),z=($-.5)*Math.min(q.w*.55,60),_=(F-.5)*Math.min(q.h*.55,60);return{d:N,x:q.x+q.w/2+z,y:q.y+q.h/2+_}}).filter(N=>!!N),[p,v]),w=N=>h>0?N/h:N,C=l.useMemo(()=>r?[0,1,2,3,4,5].map(N=>({c:Ot[N],fr:c.plabels[N].toUpperCase(),en:c.plabels[N].toUpperCase(),n:n.filter(q=>q.kind==="target"&&ie(q)===N).length})).filter(N=>N.n>0):wt.map((N,q)=>({...N,n:n.filter($=>kt($)===q).length})),[n,r,c.plabels]),j=o?d.get(o):null,E=j?S.find(N=>N.d.id===j.id):null;return e.jsxs("div",{className:"mapzone",ref:b,children:[e.jsxs("svg",{ref:m,viewBox:u.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":i==="fr"?u.fr:u.en,onMouseLeave:()=>{g(null),s(null)},children:[e.jsx("g",{children:u.countries.map((N,q)=>e.jsx("g",{className:"ct"+(N.i2&&y.get(N.i2)?"":" empty"),children:e.jsx("path",{d:N.d,"data-i2":N.i2||void 0})},q))}),e.jsx("g",{children:S.map(N=>{const q=wt[kt(N.d)],$=!!ne(N.d),F=N.d.kind==="target",z=r&&F?Ot[ie(N.d)]:q.c,_=!r&&ce(N.d);return e.jsxs("g",{className:"co"+(_?" done":""),onMouseEnter:()=>{var P,le;const D=(P=b.current)==null?void 0:P.getBoundingClientRect(),Q=(le=m.current)==null?void 0:le.createSVGPoint();if(Q&&m.current&&D){Q.x=N.x,Q.y=N.y;const fe=Q.matrixTransform(m.current.getScreenCTM());g({x:fe.x-D.left,y:fe.y-D.top,label:N.d.name+" · "+(Le(N.d.cc,i)||N.d.countryLabel||"")})}s(N.d.id)},onMouseLeave:()=>{g(null),s(null)},onClick:()=>{var P;const D=(P=m.current)==null?void 0:P.createSVGPoint();let Q=null;if(D&&m.current){D.x=N.x,D.y=N.y;const le=D.matrixTransform(m.current.getScreenCTM());Q={x:le.x,y:le.y}}a({type:"popup",id:N.d.id,anchor:Q})},children:[e.jsx("circle",{className:"h",cx:N.x,cy:N.y,r:w(Math.max(11,q.px+7))}),e.jsx("circle",{className:"v",cx:N.x,cy:N.y,r:w(q.px),fill:z,stroke:$?"#DC2626":"#ffffff",strokeWidth:w($?2.2:1.3)})]},N.d.id||N.d.name)})}),E&&e.jsx("circle",{className:"ring on",cx:E.x,cy:E.y,r:w(13),fill:"none",stroke:"#0F172A",strokeWidth:w(2)})]}),e.jsx("div",{className:"hov"+(x?" on":""),style:x?{left:x.x,top:x.y}:void 0,children:x==null?void 0:x.label}),e.jsx("div",{className:"legend",children:C.map((N,q)=>e.jsxs("span",{children:[e.jsx("i",{style:{"--c":N.c}}),i==="fr"?N.fr:N.en," ",e.jsx("b",{children:N.n})]},q))}),n.some(N=>!N.cc)&&e.jsx("div",{className:"legend",style:{left:"auto",right:10},children:e.jsxs("span",{children:["🌐 ",c.notLocated," ",e.jsx("b",{children:n.filter(N=>!N.cc).length})]})})]})}function on(t,a){const n=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t);if(!n)return t;const s=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(n[2])-1]||n[2],o=Number(n[3]);return a==="en"?`${s} ${o}, ${n[1]}`:`${o} ${s} ${n[1]}`}function sn(){const{st:t,dispatch:a,dossiers:n,t:r,pipe:s,contName:o,lang:d}=T(),i=t.filters,c=l.useMemo(()=>n.filter(f=>f.continent===t.continent),[n,t.continent]),m=f=>c.filter(x=>f!=="country"&&i.country.length&&!i.country.includes(x.cc||"")?!1:pt(x,i,s,f==="country"?void 0:f)),b=l.useMemo(()=>{const f=m("win"),x=g=>f.filter(p=>(p.date?Math.max(0,Math.floor((Date.now()-Date.parse(p.date))/864e5)):9999)<=g).length;return[x(0),x(7),x(30),f.length]},[c,i,s]),u=l.useMemo(()=>i.day?m("win").filter(f=>(f.date||"").slice(0,10)===i.day).length:0,[c,i,s]),h=i.sector.length+i.country.length+i.engine.length+i.stage.length+i.angle.length+i.memoLevel.length+(i.signalOnly?1:0)+(i.day||i.win!=="all"?1:0)+(i.search.trim()?1:0),v=(f,x,g,p="fbtn")=>e.jsxs("button",{type:"button",className:p,"aria-expanded":t.openFacet===f,onClick:()=>a({type:"openFacet",facet:f}),children:[e.jsx("span",{className:"fl",children:x}),g>0&&e.jsx("span",{className:"n",children:g}),e.jsx("span",{className:"cv",children:"▾"})]},f);return e.jsxs(e.Fragment,{children:[e.jsxs("aside",{className:"fbar",children:[i.day?e.jsxs("div",{className:"seg",children:[e.jsxs("button",{type:"button","aria-pressed":!0,children:[r.fDay(on(i.day,d)),e.jsx("b",{children:u})]}),e.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:r.fDayOff})]}):e.jsx("div",{className:"seg",children:["1","7","30","all"].map((f,x)=>e.jsxs("button",{type:"button","aria-pressed":i.win===f,onClick:()=>a({type:"filters",patch:{win:f}}),children:[r.dates[x],e.jsx("b",{children:b[x]})]},f))}),e.jsxs("span",{className:"fsrch",children:["🔍",e.jsx("input",{placeholder:r.identSearch,value:i.search,onChange:f=>a({type:"filters",patch:{search:f.target.value}})})]}),e.jsxs("div",{className:"facets",children:[e.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":t.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[e.jsx("span",{className:"fl",children:r.fSignal}),i.signalOnly&&e.jsx("span",{className:"n",children:i.signalEngines.length||"✓"}),e.jsx("span",{className:"cv",children:"▾"})]}),i.sector.length===1?e.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":t.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:i.sector[0],children:[e.jsx("span",{className:"fl",children:r.fSector}),e.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:i.sector[0]}),e.jsx("span",{className:"cv",children:"▾"})]}):v("sec",r.fSector,i.sector.length),v("pay",r.fCountry,i.country.length),v("det",r.fEngine,i.engine.length),v("sta",r.fStage,i.stage.length),s&&v("ang","Angle",i.angle.length),s&&v("mem","Mémo",i.memoLevel.length)]}),e.jsx("span",{className:"fgrow"}),e.jsxs("div",{className:"frow2",children:[t.mapFolded&&e.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",r.showMap.replace("🗺 ","")]}),h>0&&e.jsxs("button",{type:"button",className:"resetbtn on",title:r.clearTitle(c.length,o),onClick:()=>a({type:"reset"}),children:[e.jsx("span",{className:"rot",children:"↺"}),e.jsx("span",{children:r.clear(h)})]}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:r.alertBtn})]})]}),t.openFacet&&e.jsx(ln,{poolFor:m})]})}function ln({poolFor:t}){const{st:a,dispatch:n,t:r,lang:s}=T(),o=a.filters,d=a.openFacet,{title:i,cols:c,options:m}=l.useMemo(()=>{if(d==="sig"){const f=t("signal").filter(p=>ne(p)),x=new Map;f.forEach(p=>{const y=p.engine||"";x.set(y,(x.get(y)||0)+1)});const g=[{v:"*",label:r.fpSigAll,n:f.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...jt([...x.keys()],s).map(p=>({v:p,label:ze(p)+" "+he(p,s),n:x.get(p)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(p)}))];return{title:r.fpSigTitle,cols:2,options:g}}if(d==="sec"){const f=t("sector"),x=new Map;return f.forEach(g=>{g.sector&&x.set(g.sector,(x.get(g.sector)||0)+1)}),{title:r.fSector.toUpperCase(),cols:3,options:[...x.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:g,n:p,html:!1,on:o.sector.includes(g)}))}}if(d==="pay"){const f=t("country"),x=new Map;return f.forEach(g=>{g.cc&&x.set(g.cc,(x.get(g.cc)||0)+1)}),{title:r.fCountry.toUpperCase(),cols:3,options:[...x.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:Le(g,s)||g,n:p,html:!1,on:o.country.includes(g)}))}}if(d==="det"){const f=t("engine"),x=new Map;return f.forEach(g=>{g.engine&&x.set(g.engine,(x.get(g.engine)||0)+1)}),{title:r.fEngine.toUpperCase(),cols:2,options:jt([...x.keys()],s).map(g=>({v:g,label:ze(g)+" "+he(g,s)+' <span style="color:var(--dim);font-size:10px">· '+Ma(Da(g),s)+"</span>",n:x.get(g)||0,html:!0,on:o.engine.includes(g)}))}}if(d==="ang"){const f=t("angle"),x=new Map;return f.forEach(g=>{g.angle&&x.set(g.angle,(x.get(g.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...x.entries()].sort((g,p)=>p[1]-g[1]).map(([g,p])=>({v:g,label:g.replace(/[_-]+/g," "),n:p,html:!1,on:o.angle.includes(g)}))}}if(d==="mem"){const f=t("memoLevel"),x=new Map;f.forEach(p=>{if(p.kind==="target"){const y=st(p);x.set(y,(x.get(y)||0)+1)}});const g=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(p=>({v:String(p),label:g[p],n:x.get(p)||0,html:!1,on:o.memoLevel.includes(p)}))}}const h=t("stage"),v=new Map;return h.forEach(f=>{f.stage&&v.set(f.stage,(v.get(f.stage)||0)+1)}),{title:r.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((f,x)=>x[1]-f[1]).map(([f,x])=>({v:f,label:f,n:x,html:!1,on:o.stage.includes(f)}))}},[d,a,s]),b=h=>{if(d==="sig"){if(h==="*")n({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const f=o.signalEngines.includes(h)?o.signalEngines.filter(x=>x!==h):[...o.signalEngines,h];n({type:"filters",patch:{signalOnly:!0,signalEngines:f}})}return}if(d==="mem"){n({type:"toggleMemoLevel",value:Number(h)});return}n({type:"toggleFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage",value:h})},u=()=>{n(d==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:d==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:d==="sec"?"sector":d==="pay"?"country":d==="det"?"engine":d==="ang"?"angle":"stage"})};return e.jsxs("div",{className:"fpanel on",children:[e.jsxs("div",{className:"ph",children:[e.jsx("b",{children:i}),e.jsx("span",{className:"sp"}),e.jsx("button",{type:"button",onClick:u,children:r.fpNone}),e.jsx("button",{type:"button",onClick:()=>n({type:"openFacet",facet:null}),children:r.fpClose})]}),e.jsx("div",{className:"fcols"+(c===2?" two":""),children:m.map(h=>e.jsxs("button",{type:"button",className:"opt","aria-pressed":h.on,onClick:()=>b(h.v),children:[e.jsx("span",{className:"bx"}),h.html?e.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:h.label}}):e.jsx("span",{className:"l",children:h.label}),e.jsx("span",{className:"n",children:h.n})]},h.v))}),e.jsxs("div",{className:"pf",children:[e.jsx("span",{className:"t",children:r.alertReady}),e.jsx("button",{type:"button",className:"alertbtn",onClick:()=>n({type:"modal",modal:"alert"}),children:r.alertCreate})]})]})}const Mt=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function dn(t){return String(t||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function cn(){var ge;const{t,mode:a,token:n,email:r,askEvaluate:s,sessTally:o,dispatch:d,evalBusy:i,evalCards:c,caps:m,data:b}=T(),u=a==="client",[h,v]=l.useState(""),[f,x]=l.useState(!1),[g,p]=l.useState(""),[y,S]=l.useState(!1),[w,C]=l.useState(""),[j,E]=l.useState([]),N=l.useRef(!1),[q,$]=l.useState(!1),[F,z]=l.useState(""),[_,D]=l.useState(""),[Q,P]=l.useState(!1),[le,fe]=l.useState(0),[be,ve]=l.useState(""),[I,pe]=l.useState(null),[V,U]=l.useState(null),M=l.useRef(!1),B=h.trim()?Mt.test(h.trim())?t.evalUrl:t.evalName:t.evalWaiting,O=l.useMemo(()=>g.split(`
`).map(A=>A.trim()).filter(Boolean).slice(0,15),[g]),G=j.length?j:c,K=b.credits;l.useEffect(()=>{if(!Q)return;fe(0);const A=window.setInterval(()=>fe(Y=>Y+1),1e3);return()=>window.clearInterval(A)},[Q]);const oe=()=>{const A=h.trim();A&&(s(null,A),v(""))},ee=async()=>{if(!u){s(null,O[0]||"");return}if(!O.length||y)return;S(!0),N.current=!1;const A=[];for(let Y=0;Y<O.length&&!N.current;Y++){C(t.evaluating(Y+1,O.length,O[Y]));const X=await Ht(n,O[Y],"atelier2");if(A.unshift({name:X.company||O[Y],verdict:X.verdict,reason:X.reason||"",remaining:X.remaining??null}),E([...A]),X.verdict==="quota"){A.unshift({name:"",verdict:"quota",reason:t.quota(O.length-Y-1),remaining:0}),E([...A]),p(O.slice(Y+1).join(`
`)),C(""),S(!1);return}}C(""),p(N.current?O.slice(A.length).join(`
`):""),S(!1)},J=async()=>{var X;if(M.current)return;const A=F.trim().replace(/\s+/g,""),Y=_.trim();if(!A&&!Y){ve(t.rsNeed);return}M.current=!0,ve(""),pe(null),U(null),P(!0);try{const W=await Ia({url:A,text:Y,email:r,cbToken:n});if(P(!1),!W||W.status!=="success"){ve((W==null?void 0:W.message)||"Erreur");return}pe(W),$(!1);const me=(((X=W.prospective)==null?void 0:X.companies_to_evaluate)||[]).map(ke=>((ke==null?void 0:ke.name)||"").trim()).filter(Boolean);me.length&&(p(ke=>{const De=ke.split(`
`).map(je=>je.trim()).filter(Boolean),Ge=new Set(De.map(je=>je.toLowerCase())),Ke=me.filter(je=>!Ge.has(je.toLowerCase()));return[...De,...Ke].slice(0,15).join(`
`)}),x(!0)),U({state:"pending"});const we=await Ba(W,{email:r,cbToken:n});U(we.ok&&we.url?{state:"ok",url:we.url}:{state:"fail",msg:we.error||""})}finally{M.current=!1,P(!1)}},ae=(((ge=I==null?void 0:I.prospective)==null?void 0:ge.companies_to_evaluate)||[]).filter(A=>A&&A.name),H=[I==null?void 0:I.industry,...(I==null?void 0:I.market_tags)||[],I==null?void 0:I.author].map(A=>(A||"").trim()).filter(Boolean),de=(V==null?void 0:V.state)==="pending",ue=V&&(de?e.jsx("span",{className:"rslink pend",children:t.rsPublishing}):V.state==="ok"?e.jsx("a",{className:"rslink",href:V.url,target:"_blank",rel:"noopener noreferrer",children:t.rsLink}):e.jsx("span",{className:"rslink fail",title:V.msg,children:t.rsPublishFail})),ye=f&&ae.length>0;return e.jsxs("div",{className:"demand",children:[e.jsxs("div",{className:"drow",children:[e.jsxs("span",{className:"dfield",children:[e.jsx("input",{value:h,placeholder:t.evalPh,autoComplete:"off",maxLength:200,onChange:A=>v(A.target.value),onKeyDown:A=>{A.key==="Enter"&&oe()}}),e.jsx("span",{className:"detect"+(Mt.test(h.trim())?" url":""),children:B})]}),e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),disabled:i,onClick:oe,children:[e.jsx("span",{className:"fill"}),t.evalGo]}),m.showCredits&&K&&e.jsxs("button",{type:"button",className:"credits"+(K.total_available<=0&&!K.unlimited?" empty":""),onClick:()=>d({type:"modal",modal:"recharge"}),children:[e.jsx("span",{className:"cl",children:t.creditsCap}),e.jsx("b",{children:K.unlimited?"∞":K.total_available}),!K.unlimited&&e.jsxs("span",{className:"cm",children:["/ ",K.daily_grant+K.purchased]}),K.total_available<=0&&!K.unlimited?e.jsx("span",{className:"rc",children:t.creditsRecharge}):e.jsx("span",{className:"cd",children:t.creditsToday})]})]}),e.jsxs("div",{className:"dunder",children:[e.jsx("button",{type:"button",className:"dmulti",onClick:()=>x(!f),children:t.evalMulti}),e.jsx("button",{type:"button",className:"dmulti dsearch"+(q?" on":""),onClick:()=>$(!q),children:t.rsOpen})]}),q&&e.jsxs("div",{className:"rsp on",children:[e.jsxs("div",{className:"rsf",children:[e.jsx("input",{className:"rsurl",value:F,placeholder:t.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:A=>z(A.target.value),onKeyDown:A=>{A.key==="Enter"&&J()}}),e.jsx("span",{className:"rsor",children:t.rsOr}),e.jsx("textarea",{className:"rstext",value:_,placeholder:t.rsTextPh,onChange:A=>D(A.target.value)})]}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(Q?" loading":""),style:{justifyContent:"center"},disabled:Q||de||!F.trim()&&!_.trim(),onClick:()=>{J()},children:[e.jsx("span",{className:"fill"}),Q?`${Pa(F.trim())==="youtube"&&F.trim()?t.rsRunningVid:t.rsRunning} ${t.rsElapsed(le)}`:de?t.rsPublishing:t.rsGo]}),e.jsx("span",{className:"hint",children:t.rsHint})]})]}),be&&e.jsx("div",{className:"rserr",children:be}),I&&e.jsxs("div",{className:"rscard",children:[e.jsxs("div",{className:"rsh",children:[e.jsx("b",{children:I.title}),I.source_url&&e.jsx("a",{href:I.source_url,target:"_blank",rel:"noopener noreferrer",children:t.rsSource}),e.jsx("button",{type:"button",className:"rsx",title:t.rsClose,onClick:()=>{pe(null),U(null)},children:"×"})]}),I.market&&e.jsx("p",{className:"rsmk",children:I.market}),H.length>0&&e.jsxs("div",{className:"rstags",children:[e.jsx("em",{children:t.rsTags}),H.map(A=>e.jsx("span",{children:A},A))]}),e.jsxs("div",{className:"rsbody",children:[I.mindmap_png_b64&&e.jsxs("figure",{className:"rsmm",children:[e.jsx("img",{src:`data:image/png;base64,${I.mindmap_png_b64}`,alt:t.rsMindmap}),e.jsx("figcaption",{children:t.rsMindmap})]}),e.jsx("div",{className:"rssum",children:dn(I.summary_md||"").map((A,Y)=>e.jsx("p",{children:A},Y))})]}),e.jsxs("div",{className:"rsfoot",children:[e.jsx("span",{children:t.rsFound(ae.length)}),!ye&&ue]})]}),f&&e.jsxs("div",{className:"bulk on",children:[e.jsx("textarea",{value:g,placeholder:t.bulkPh,onChange:A=>p(A.target.value.split(`
`).slice(0,15).join(`
`))}),e.jsxs("div",{className:"side",children:[e.jsxs("button",{type:"button",className:"evalbtn"+(y?" loading":""),style:{justifyContent:"center"},disabled:y||!O.length,onClick:()=>{ee()},children:[e.jsx("span",{className:"fill"}),y&&w?w:t.evalList]}),e.jsx("span",{className:"hint",children:t.bulkCount(O.length)}),ye&&ue]})]}),G.slice(0,1).map((A,Y)=>{const X=A.verdict==="kept",W=A.verdict==="quota",me=X?"var(--brand)":W?"var(--bolt)":"var(--red)",we=X?"var(--brand-l)":W?"#FEF3C7":"#FEF2F2";return e.jsxs("div",{className:"result on",style:{"--c":me,"--bgc":we},children:[e.jsx("span",{className:"vv",children:e.jsx("span",{className:"vp",children:X?"✓ "+t.kept:W?"⏳":"✗ "+t.dropped})}),A.name&&e.jsx("span",{className:"rn",children:A.name}),e.jsx("span",{className:"rr",children:A.reason?e.jsxs(e.Fragment,{children:[e.jsx("b",{children:t.why})," ",A.reason]}):null}),!W&&e.jsx("button",{type:"button",className:"go",onClick:()=>d({type:"modal",modal:"space"}),children:t.seeSpace(X?t.statusKeep.replace("✅ ",""):t.statusDrop.replace("❌ ",""))})]},Y)}),u&&(o.kept+o.dropped>0||G.length>0)&&e.jsxs("div",{className:"tally",children:[e.jsx("span",{dangerouslySetInnerHTML:{__html:t.session(o.kept,o.dropped)}})," ","·"," ",e.jsx("a",{onClick:()=>d({type:"modal",modal:"space"}),children:t.seeMySpace})]})]})}function pn(t){return t.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function un(){const{st:t,dispatch:a,byId:n,t:r,doDeep:s}=T(),o=t.memoConsole?n.get(t.memoConsole):null,d=l.useMemo(()=>o?[o.reasoning||"",pn(o.summary||"")].filter(Boolean).join(`
...
`).map((m,b)=>e.jsx("p",{style:{margin:"0 0 10px"},children:m},b)):e.jsx("p",{children:r.memoNone})}),e.jsxs("div",{className:"mf",children:[dt(o)?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"t",children:r.memoDeepHint}),e.jsx("button",{type:"button",className:"deep",onClick:()=>s(o),children:r.memoDeep})]}):e.jsx("span",{className:"t",children:c===2?r.critMemoKinds:""}),o.memoUrl&&e.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:r.memoOpenFull})]})]})})}const mn=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ue=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function fn(t){const a=String(t||"");if(!a)return"";let n="",r=0;for(;r<a.length;){const s=a.indexOf("<",r);if(s<0){n+=Ue(a.slice(r));break}n+=Ue(a.slice(r,s));const o=a.indexOf(">",s);if(o<0){n+=Ue(a.slice(s));break}const d=a.slice(s+1,o).trim(),i=/^(\/?)([a-zA-Z0-9]+)/.exec(d),c=i?i[2].toLowerCase():"";i&&mn.has(c)?n+=`<${i[1]}${c}>`:n+=Ue(a.slice(s,o+1)),r=o+1}return n}const Dt=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function re({k:t,v:a,href:n}){return a==null||a===""?null:e.jsxs("div",{className:"cdl",children:[e.jsx("span",{className:"cdk",children:t}),n?e.jsx("a",{className:"cdv",href:n,target:"_blank",rel:"noopener noreferrer",children:String(a)}):e.jsx("span",{className:"cdv",children:String(a)})]})}function xn({o:t}){const{t:a,lang:n,dispatch:r,caps:s}=T(),o=Ye(t),d=Ae(t),i=(t.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),c=[t.sector,t.stage,t.countryLabel,t.city,t.website,t.domain,t.linkedinCompany,t.angle,t.date].filter(Boolean).length,m=[t.contactName,t.contactEmail,t.contactLinkedin].filter(Boolean).length,b=[t.ceoStatus,t.ceoNote,s.pipe?t.memoUrl:"",s.pipe?t.memoPdfUrl:""].filter(Boolean).length+(typeof t.engagement=="number"&&t.engagement>0?1:0),u=l.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(i?1:0)+(t.reasoning?1:0)+(d?1:0)},{k:"ana",lib:a.cdAnalyse,n:(t.summary?1:0)+(s.pipe&&!s.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:m},{k:"suivi",lib:a.cdSuivi,n:b}].filter(x=>x.n>0),[t,a,i,d,c,m,b]),[h,v]=l.useState("");if(!u.length)return null;const f=u.some(x=>x.k===h)?h:u[0].k;return e.jsxs("div",{className:"cdtabs",children:[e.jsx("div",{className:"cdnav",role:"tablist",children:u.map(x=>e.jsx("button",{type:"button",role:"tab","aria-selected":f===x.k,className:f===x.k?"on":"",onClick:g=>{g.stopPropagation(),v(x.k)},children:x.lib},x.k))}),e.jsxs("div",{className:"cdbody",onClick:x=>x.stopPropagation(),children:[f==="conv"&&e.jsxs(e.Fragment,{children:[i&&e.jsxs("div",{className:"cdv1"+(i==="NO MATCH"?" out":""),children:[e.jsx("b",{children:i==="NO MATCH"?a.vOut:a.vKept}),e.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.reasoning&&e.jsx("p",{className:"cdtxt",children:t.reasoning}),d&&e.jsxs("div",{className:"cdv1 memo",children:[e.jsx("b",{children:d}),e.jsx("span",{className:"cdw",children:a.cdMemo(t.memoType||"")})]}),e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(re,{k:a.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(re,{k:a.cdVerdictDate,v:Dt(t.verdictDate,n)})]})]}),f==="ana"&&e.jsxs(e.Fragment,{children:[t.summary&&e.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:fn(t.summary)}}),s.pipe&&!s.lockActions&&e.jsx(gn,{o:t})]}),f==="soc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdSector,v:t.sector}),e.jsx(re,{k:a.cdStage,v:t.stage}),e.jsx(re,{k:a.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(re,{k:a.cdSite,v:t.domain||t.website,href:t.website||void 0}),e.jsx(re,{k:a.cdLinkedin,v:t.linkedinCompany?"LinkedIn":"",href:t.linkedinCompany}),e.jsx(re,{k:a.cdAngle,v:t.angle}),e.jsx(re,{k:a.cdDetected,v:Dt(t.date,n)})]}),f==="ctc"&&e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdName,v:t.contactName}),e.jsx(re,{k:a.cdEmail,v:t.contactEmail,href:t.contactEmail?`mailto:${t.contactEmail}`:void 0}),e.jsx(re,{k:a.cdLinkedin,v:t.contactLinkedin?"LinkedIn":"",href:t.contactLinkedin})]}),f==="suivi"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cdgrid",children:[e.jsx(re,{k:a.cdCeoStatus,v:t.ceoStatus}),e.jsx(re,{k:a.cdEngagement,v:typeof t.engagement=="number"&&t.engagement>0?t.engagement:""})]}),t.ceoNote&&e.jsxs("p",{className:"cdtxt",children:["💬 ",t.ceoNote]}),s.pipe&&(t.memoUrl||t.memoPdfUrl)&&e.jsxs("div",{className:"cdacts",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),t.memoPdfUrl&&e.jsx("a",{className:"abtn",href:t.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function gn({o:t}){const{t:a,token:n}=T(),[r,s]=l.useState(!1),[o,d]=l.useState(null),i=async()=>{r||(s(!0),d(await $a(n,t.name,t.website||t.domain||"")),s(!1))},c=(o==null?void 0:o.blocs)||{},m=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],b=m.some(([,u])=>u);return e.jsxs("div",{className:"qab",children:[!o&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"mnote dim",children:a.qaHint}),e.jsx("button",{type:"button",className:"abtn",disabled:r,onClick:()=>{i()},children:r?a.qaBusy:a.qaRun})]}),o&&b&&e.jsxs(e.Fragment,{children:[m.filter(([,u])=>u).map(([u,h])=>e.jsxs("div",{className:"qal",children:[e.jsx("span",{className:"qak",children:u}),e.jsx("p",{children:h})]},u)),!!(o.pages||[]).length&&e.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!b&&e.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Jt({name:t}){const{t:a,token:n,caps:r,mode:s,flashErr:o}=T(),[d,i]=l.useState(!1),[c,m]=l.useState(null);if(!r.pipe||s!=="client"||r.lockActions)return null;const b=async()=>{if(d)return;i(!0);const u=await _a(n,t);if(i(!1),!u){o(a.actErr);return}m(u.results||[])};return e.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[e.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{b()},children:d?a.similarBusy:a.similar}),c&&(c.length===0?e.jsx("p",{className:"mnote",children:a.similarNone}):e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"siml",children:c.map(u=>e.jsxs("li",{children:[e.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&e.jsx("span",{children:u.reason})]},u.company))}),e.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}const Xt={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function mt({o:t}){const{t:a}=T(),n=Ye(t),r=Ae(t),s=ie(t),o=at(t),d=Ua(t);return e.jsxs("span",{className:"c-vd",children:[n?e.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:a.vt[n],children:n}):e.jsx("span",{className:"vd wait",children:a.actToEval}),r?e.jsx("span",{className:"vd "+(Xt[r]||"v-cons"),title:a.vt[r],children:r}):s===1?e.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,s===3&&o==="auto"&&e.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),s===3&&o==="cd"&&e.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),s===3&&d!==null&&e.jsx("span",{className:"wait2 "+(d>10?"hot":d>=5?"warm":""),title:a.waitTitle(d),children:a.waitChip(d)})]})}function Pt({o:t}){const{t:a,askEvaluate:n,evalBusy:r,lang:s}=T(),[o,d]=l.useState(!1);if(l.useEffect(()=>{r||d(!1)},[r]),ce(t)){const m=(t.verdict||"").toUpperCase()!=="NO MATCH";return e.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},title:t.reasoning||"",children:[m?"✓":"✗"," ",e.jsx("b",{children:m?a.kept:a.dropped}),typeof t.score=="number"&&t.score>0?" "+t.score:""]})}const c=o&&r;return e.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:r,onClick:m=>{m.stopPropagation(),d(!0),n(t)},children:[e.jsx("span",{className:"fill"}),a.evalGo]})}function hn({o:t}){const{t:a,caps:n,memoQueued:r,approachDone:s,doAnalyse:o,doDecide:d,doPromote:i,doRepeche:c,doApproach:m,dispatch:b}=T();if(n.lockActions)return e.jsx("span",{className:"cell",children:e.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:v=>{v.stopPropagation(),b({type:"modal",modal:"rdv"})},children:[e.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!n.pipe)return e.jsx("span",{className:"cell",children:e.jsx(Pt,{o:t})});const u=ie(t),h=v=>f=>{f.stopPropagation(),v()};if(u===0)return e.jsx("span",{className:"cell",children:e.jsx(Pt,{o:t})});if(u===1){const v=r.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:h(()=>o(t)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(u===3)return e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:h(()=>d(t,!0)),children:a.actYes}),e.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:h(()=>d(t,!1)),children:a.actNo}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})});if(u===4){const v=s.has(t.id);return e.jsx("span",{className:"cell",children:e.jsx("button",{type:"button",className:"approach",disabled:v,onClick:h(()=>m(t)),children:v?a.actApproachSent:a.actApproach})})}return u===2?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:h(()=>i(t)),children:a.actPromote}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):u===5?e.jsx("span",{className:"cell",children:e.jsxs("span",{className:"yn",children:[e.jsx("button",{type:"button",className:"promo",onClick:h(()=>c(t)),children:a.actRepeche}),t.memoUrl&&e.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:h(()=>b({type:"memoConsole",id:t.id})),children:"📄"})]})}):e.jsx("span",{className:"cell",children:t.memoUrl?e.jsx("button",{type:"button",className:"memobtn read",onClick:h(()=>b({type:"memoConsole",id:t.id})),children:a.actMemo}):e.jsx("span",{className:"rc",children:"—"})})}function bn({o:t}){const{t:a,doThumb:n,thumbOf:r}=T(),s=r(t);return e.jsxs("span",{className:"thu",children:[e.jsx("button",{type:"button",className:"tb up"+(s==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),n(t,!0)},children:"👍"}),e.jsx("button",{type:"button",className:"tb dn"+(s==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),n(t,!1)},children:"👎"})]})}function vn({o:t}){const{lang:a}=T();return ne(t)?e.jsxs("span",{className:"c-sig",children:[e.jsx(qe,{o:t}),e.jsx(We,{o:t,src:!0})]}):e.jsx("span",{className:"c-sig",children:e.jsxs("span",{className:"mo",children:[ze(t.engine||"")," ",he(t.engine||"",a)]})})}function yn({o:t,locked:a,open:n,onToggle:r}){const{st:s,dispatch:o,caps:d,markRow:i,markedId:c,favIds:m,toggleFav:b}=T(),u=ie(t),h=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=t.date?Math.max(0,Math.floor((Date.now()-Date.parse(t.date))/864e5)):9999,f=v<=0?0:v<=7?1:v<=30?2:3,x=d.pipe&&t.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:h[f],g=m.has(t.id),p=y=>{if(a)return;if(d.pipe){r();return}const S=y.currentTarget.getBoundingClientRect();o({type:"popup",id:t.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return e.jsxs(l.Fragment,{children:[e.jsxs("div",{className:"row"+(c===t.id||n?" on":"")+(a?" locked":""),onMouseEnter:()=>i(t.id),onMouseLeave:()=>i(null),onClick:p,children:[e.jsx("span",{className:"pt",style:{"--c":x}}),e.jsx(na,{o:t}),e.jsxs("span",{className:"nd",children:[e.jsxs("span",{className:"rnm",title:t.name,children:[d.pipe&&e.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:g?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),b(t)},children:g?"★":"☆"}),t.name]}),e.jsx("span",{className:"rds",title:t.tagline||t.headline||"",children:[t.tagline,t.headline,t.reasoning].find(y=>y&&y!==t.name)||""})]}),e.jsx(wn,{o:t}),e.jsx("span",{className:"c-stade",children:t.stage||""}),e.jsx(vn,{o:t}),d.pipe&&e.jsx(mt,{o:t}),d.pipe&&e.jsxs("span",{className:"c-sc",children:[typeof t.score=="number"?t.score:"",typeof t.score=="number"&&e.jsx("s",{children:"/100"})]}),e.jsx(hn,{o:t}),d.showThumbs&&e.jsx(bn,{o:t})]}),(n||s.dens==="deplie")&&!a&&e.jsx(kn,{o:t})]})}function wn({o:t}){const{lang:a,caps:n}=T();if(n.pipe&&t.kind==="target")return e.jsx("span",{className:"c-amt none",children:"—"});const r=ct(t.amountEur,a);return e.jsx("span",{className:"c-amt"+(r?"":" none"),children:r||"—"})}function kn({o:t}){const{t:a,lang:n,dispatch:r,caps:s,outbound:o,doOnboard:d}=T();return e.jsxs("div",{className:"card",style:{display:"grid"},children:[e.jsxs("div",{children:[t.tagline&&e.jsx("p",{className:"lead",children:t.tagline}),e.jsx(xn,{o:t}),e.jsx(Hr,{o:t}),e.jsx(Gr,{o:t}),e.jsx(Jt,{name:t.name}),e.jsxs("div",{className:"tg",children:[t.sector&&e.jsx("span",{children:t.sector}),t.stage&&e.jsx("span",{children:t.stage}),t.countryLabel&&e.jsx("span",{children:t.countryLabel}),t.city&&e.jsx("span",{children:t.city})]})]}),e.jsxs("div",{className:"cside",children:[e.jsxs("div",{className:"top",children:[typeof t.score=="number"&&e.jsx("span",{className:"sc3",children:t.score}),e.jsx("span",{className:"vv",children:e.jsx(mt,{o:t})})]}),e.jsxs("div",{className:"sec2",children:[e.jsxs("div",{className:"k2",children:[ze(t.engine||"")," ",he(t.engine||"",n)]}),ne(t)&&e.jsx("div",{style:{marginTop:8},children:e.jsx(qe,{o:t})})]}),s.pipe&&(t.memoUrl||o)&&e.jsxs("div",{className:"sec2 acts2",children:[t.memoUrl&&e.jsxs("button",{type:"button",className:"btn p",onClick:()=>r({type:"memoConsole",id:t.id}),children:[a.actMemo," →"]}),o&&e.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(t),children:a.actOnboard})]})]})]})}function jn({o:t,locked:a}){const{t:n,dispatch:r,caps:s,doDecide:o}=T(),d=ie(t),i=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][d];return e.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":i},children:[e.jsxs("div",{className:"dh",children:[typeof t.score=="number"&&e.jsx("span",{className:"dsc",children:t.score}),e.jsx("span",{className:"dnm",title:t.name,children:t.name})]}),e.jsxs("div",{className:"dv",children:[e.jsx(mt,{o:t}),ne(t)&&e.jsx(qe,{o:t})]}),e.jsx("div",{className:"dmeta",children:[t.countryLabel,t.stage,t.sector].filter(Boolean).join(" · ").toUpperCase()}),(t.tagline||t.reasoning)&&e.jsx("div",{className:"ddesc",children:t.tagline||t.reasoning}),!a&&s.pipe&&d===3&&e.jsxs("div",{className:"dyn",children:[e.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(t,!0),children:n.actYes}),e.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(t,!1),children:n.actNo})]}),!a&&t.memoUrl&&e.jsxs("button",{type:"button",className:"dmemo",onClick:()=>r({type:"memoConsole",id:t.id}),children:[n.actMemo," →"]})]})}function Nn(){const t=T(),{st:a,dispatch:n,t:r,caps:s,scoped:o,lang:d,sessTally:i,data:c,dossiers:m}=t,[b,u]=l.useState(new Set);l.useEffect(()=>{u(new Set)},[a.ptab,a.continent]);const h=j=>u(E=>{const N=new Set(E);return N.has(j)?N.delete(j):N.add(j),N}),v=l.useMemo(()=>ut(o,a.sort),[o,a.sort]),f=l.useMemo(()=>v.filter(j=>ne(j)&&!ce(j)).length,[v]),x=l.useMemo(()=>s.pipe?v:v.filter(j=>!ce(j)),[v,s.pipe]),g=s.pipe?r.plabels[a.ptab].toLowerCase():a.filters.status==="retenu"?r.keptByStan:a.filters.status==="ecarte"?r.droppedByStan:r.toSend,p=(j,E,N="",q=!1)=>e.jsxs("button",{type:"button","data-s":j,className:N,"aria-sort":a.sort.key===j?a.sort.dir===1?"ascending":"descending":"none",style:q?{justifyContent:"flex-end"}:void 0,onClick:()=>n({type:"sort",key:j}),children:[E,e.jsx("span",{className:"ar",children:a.sort.key===j&&a.sort.dir===1?"▴":"▾"})]},j),y=l.useMemo(()=>{if(s.pipe||a.groupBy==="none")return null;const j=new Map;return v.forEach(E=>{const N=E.engine||"?";j.has(N)||j.set(N,[]),j.get(N).push(E)}),[...j.entries()]},[v,s.pipe,a.groupBy]),S=s.lockRowsAfter;let w=0;const C=(j,E)=>{const N=a.shown[E]||Ve,$=j.slice(0,N).map(F=>{const z=S!==null&&w>=S;return w++,a.dens==="maxi"?e.jsx(jn,{o:F,locked:z},F.id):e.jsx(yn,{o:F,locked:z,open:b.has(F.id),onToggle:()=>h(F.id)},F.id)});if(j.length>N){const F=Math.min(Ve,j.length-N),z=j.length-N;$.push(e.jsxs("button",{type:"button",className:"moregrp",onClick:()=>n({type:"more",group:E,by:Ve}),children:[e.jsx("span",{className:"more-label",children:r.more(F,z)}),e.jsxs("span",{className:"more-meta",children:[r.moreMeta(N,j.length)," · ",z," ",d==="en"?"remaining":"restantes"]})]},E+":more"))}return $};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"listhead",children:[e.jsxs("span",{className:"main",children:[e.jsx("b",{children:v.length})," ",g]}),e.jsx("span",{className:"dot",children:"·"}),e.jsxs("span",{className:"ctx",children:[t.contName,s.pipe&&t.fund?" · "+t.fund:""]}),s.showGroupBar&&e.jsxs("span",{className:"groupbar",children:[e.jsx("span",{className:"gl",children:r.groupBy}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>n({type:"groupBy",groupBy:"engine"}),children:r.groupEngine}),e.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>n({type:"groupBy",groupBy:"none"}),children:r.groupNone})]}),a.pileMode&&e.jsx("button",{type:"button",className:"exitpile",onClick:()=>n({type:"pile",on:!1}),children:r.exitPile}),s.showFunnel&&e.jsx("span",{className:"dens",children:[["liste",r.densList],["deplie",r.densOpen],["maxi",r.densMaxi]].map(([j,E])=>e.jsxs("button",{type:"button","data-d":j,"aria-pressed":a.dens===j,onClick:()=>n({type:"dens",dens:j}),children:[e.jsx("i",{children:e.jsx("em",{})}),e.jsx("b",{children:E})]},j))}),s.showChain&&x.length>0&&e.jsxs("button",{type:"button",className:"chain",onClick:()=>n({type:"chainStart",queue:x.map(j=>j.id)}),children:[e.jsx("span",{className:"b",children:"▶"})," ",s.pipe?r.browse(x.length):r.chainAll(x.length)]})]}),f>0&&!a.filters.signalOnly&&e.jsxs("div",{className:"sigstrip",children:[e.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:r.sigStrip(f)}}),e.jsx("span",{className:"s",children:r.sigStripSub}),e.jsx("button",{type:"button",onClick:()=>n({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:r.sigStripGo})]}),a.dens!=="maxi"&&e.jsxs("div",{className:"cols",children:[e.jsx("span",{}),p("country",r.colCountry),p("name",r.colCompany),p("amount",r.colAmount,"h-amt",!0),p("stage",r.colStage,"h-stade"),p("signal",r.colSignal,"h-sig"),s.pipe&&e.jsx("span",{className:"h-vd",children:r.colVerdict}),s.pipe&&p("score",r.colScore,"h-sc",!0),e.jsx("span",{}),s.showThumbs&&e.jsx("span",{className:"h-thu",children:r.colThumbs})]}),e.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:""),children:[y?y.map(([j,E])=>e.jsxs(l.Fragment,{children:[e.jsxs("div",{className:"grp-h",children:[e.jsx("span",{className:"ic",children:ze(j)}),e.jsxs("span",{children:[e.jsx("span",{className:"t",children:he(j,d)}),e.jsx("div",{className:"s",children:r.grpCount(E.filter(N=>!ce(N)).length,E.length)})]})]}),C(E,j)]},j)):C(v,"pt"+a.ptab),!v.length&&!(c.loading&&!m.length)&&e.jsx("div",{className:"void",children:s.pipe?r.emptyTab:r.emptyScope})]}),s.showThumbs&&e.jsxs("p",{className:"learn",children:[r.learnLine,e.jsx("button",{type:"button",onClick:()=>n({type:"modal",modal:"crit"}),children:r.learnLink})]}),(i.kept>0||i.dropped>0)&&e.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:r.session(i.kept,i.dropped)}})]})}const Sn=`
...
`;function Cn(t){if(!t||typeof window>"u")return;const a=352,n=430,r=window.innerWidth,s=window.innerHeight,o=Math.min(Math.max(t.x-a/2,8),Math.max(8,r-a-8));let d=t.y+10;return d+n>s-8&&(d=Math.max(8,t.y-n-14)),d<8&&(d=8),{left:o,top:d}}function En(){const{st:t,dispatch:a,byId:n,t:r,lang:s,caps:o,mode:d,askEvaluate:i,doAnalyse:c,doDecide:m,doPromote:b,doRepeche:u,doApproach:h,doDeep:v,doOnboard:f,outbound:x,evalBusy:g}=T(),p=t.popupId?n.get(t.popupId):null;if(!p)return null;const y=ne(p),S=ie(p),w=Ae(p),C=p.kind==="target",j=E=>{a({type:"filters",patch:E}),a({type:"popup",id:null})};return Me.createPortal(e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:Sn}),e.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),e.jsxs("div",{className:"pop on "+(t.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Cn(t.popupAnchor),onClick:E=>E.stopPropagation(),children:[e.jsxs("div",{className:"ph",children:[e.jsxs("div",{style:{flex:1},children:[e.jsx("h3",{children:p.name}),e.jsx("span",{className:"id",children:r.detected(r.daysAgo(Te(p.date)),he(p.engine,s))})]}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),e.jsxs("div",{className:"pb",children:[e.jsxs("div",{className:"tags",children:[p.cc&&e.jsx("button",{type:"button",className:"hi",onClick:()=>j({country:[p.cc]}),children:(Le(p.cc,s)||p.countryLabel||"").toUpperCase()}),p.sector&&e.jsx("button",{type:"button",onClick:()=>j({sector:[p.sector]}),children:p.sector.toUpperCase()}),p.stage&&e.jsx("button",{type:"button",onClick:()=>j({stage:[p.stage]}),children:p.stage.toUpperCase()}),typeof p.amountEur=="number"&&p.amountEur>0&&e.jsx("span",{className:"am2",children:ct(p.amountEur,s)})]}),(p.tagline||p.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:p.tagline||p.headline})]}),e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.how}),e.jsxs("p",{children:[ze(p.engine)," ",e.jsx("b",{children:he(p.engine,s)})," — ",Va(p.engine,s),p.noteTitle&&e.jsxs(e.Fragment,{children:[" · ",p.noteTitle]})]}),y?e.jsxs("p",{className:"psig",style:{marginTop:9},children:[e.jsx(qe,{o:p,lg:!0})," ",e.jsx(We,{o:p,src:!0}),e.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[r.signaledOn(Yt(y,s))," · ",r.win7(Wt(y,s))]})]}):e.jsx("p",{className:"pnos",style:{marginTop:5},children:r.noSignal})]}),p.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:o.pipe&&S>=1?r.verdictCap:r.memo}),e.jsx("p",{className:"memo",children:p.reasoning})]}),o.pipe&&C&&w&&e.jsx("div",{className:"fld",children:e.jsxs("p",{style:{fontWeight:700},children:[w,typeof p.score=="number"&&p.score>0?" · "+r.score(p.score):""]})})]}),e.jsx(Jt,{name:p.name}),e.jsxs("div",{className:"pf",children:[o.lockActions||d!=="client"&&o.pipe?e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[e.jsx("span",{className:"fill"}),"🔒 ",r.lockbarCta]}):o.pipe?e.jsxs(e.Fragment,{children:[S===0&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>i(p),children:[e.jsx("span",{className:"fill"}),r.evalGo]}),S===1&&e.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actAnalyse]}),S===2&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{b(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actPromote]}),S===3&&e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(p,!0),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actYes]}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{m(p,!1),a({type:"popup",id:null})},children:r.actNo}),dt(p)&&e.jsx("button",{type:"button",className:"abtn",title:r.memoDeepHint,onClick:()=>{v(p),a({type:"popup",id:null})},children:r.memoDeep})]}),S===4&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actApproach]}),S===5&&e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(p),a({type:"popup",id:null})},children:[e.jsx("span",{className:"fill"}),r.actRepeche]}),p.memoUrl&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:p.id}),a({type:"popup",id:null})},children:"📄"}),x&&e.jsx("button",{type:"button",className:"abtn",title:r.actOnboardTitle,onClick:()=>{f(p),a({type:"popup",id:null})},children:"🚀"})]}):e.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>i(p),children:[e.jsx("span",{className:"fill"}),r.evalGo," →"]}),p.website&&e.jsx("a",{className:"psite",href:p.website.startsWith("http")?p.website:"https://"+p.website,target:"_blank",rel:"noopener noreferrer",title:p.website,children:"🌐"})]})]})]}),document.body)}function It(t){let a=t==null?"":String(t);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function zn(t,a){const n=Ha(t);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[n]??1]||""}function Tn(t,a){const r=[a.head.split("|").map(It).join(";")];for(const s of t){const o=a.stageOf(s);r.push([s.name||"",zn(s,a.plabels),Ye(s)||s.verdict||"",typeof s.score=="number"?s.score:"",s.countryLabel||s.cc||"",s.sector||"",o?a.stageLabel(o.stage):"",s.contactName||"",s.contactEmail||"",s.memoUrl||"",(s.date||"").slice(0,10),(s.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(It).join(";"))}return`\uFEFF${r.join(`\r
`)}`}function An(t){const a=new Blob([t],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n);try{document.body.removeChild(r)}catch{}},400)}const Ln=(t,a)=>{const n=String(t||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(n)?a==="en"?n:`${n.slice(8,10)}/${n.slice(5,7)}/${n.slice(0,4)}`:""};function xe({k:t,v:a}){return a==null||a===""?null:e.jsxs("div",{className:"dsl",children:[e.jsx("span",{children:t}),e.jsx("b",{children:String(a)})]})}function qn({o:t,qa:a}){const{t:n,lang:r,fund:s}=T(),o=(t.cribleStatus||"").trim().toUpperCase()||(Ye(t)==="NO MATCH"?"NO MATCH":"MATCH"),d=Ae(t),i=(a==null?void 0:a.blocs)||{},c=[[n.qaVP,i.value_prop],[n.qaProduct,i.produit],[n.qaModel,i.modele],[n.qaSummary,i.synthese]];return e.jsxs("article",{className:"dspage",children:[e.jsxs("header",{className:"dsh",children:[e.jsxs("div",{children:[e.jsx("b",{children:t.name}),t.tagline&&e.jsx("p",{children:t.tagline})]}),e.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?n.vOut:n.vKept,d&&e.jsx("em",{children:d})]})]}),t.reasoning&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsWhy}),e.jsx("p",{className:"dstxt",children:t.reasoning})]}),e.jsxs("section",{className:"dsgrid",children:[e.jsx(xe,{k:n.cdSector,v:t.sector}),e.jsx(xe,{k:n.cdStage,v:t.stage}),e.jsx(xe,{k:n.cdCountry,v:[t.city,t.countryLabel].filter(Boolean).join(", ")}),e.jsx(xe,{k:n.cdSite,v:t.domain||t.website}),e.jsx(xe,{k:n.cdName,v:t.contactName}),e.jsx(xe,{k:n.cdEmail,v:t.contactEmail}),e.jsx(xe,{k:n.cdScore,v:typeof t.score=="number"?`${t.score}/100`:""}),e.jsx(xe,{k:n.cdConvScore,v:typeof t.convictionScore=="number"?Math.round(t.convictionScore):""}),e.jsx(xe,{k:n.cdAngle,v:t.angle}),e.jsx(xe,{k:n.cdDetected,v:Ln(t.date,r)})]}),c.some(([,m])=>m)&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsAnalysis}),c.filter(([,m])=>m).map(([m,b])=>e.jsxs("div",{className:"dsb",children:[e.jsx("span",{children:m}),e.jsx("p",{children:b})]},m))]}),(t.ceoStatus||t.ceoNote)&&e.jsxs("section",{children:[e.jsx("h3",{children:n.dsDecision}),t.ceoStatus&&e.jsx("p",{className:"dstxt",children:e.jsx("b",{children:t.ceoStatus})}),t.ceoNote&&e.jsxs("p",{className:"dstxt",children:["« ",t.ceoNote," »"]})]}),e.jsx("footer",{className:"dsf",children:n.dsFoot(s)})]})}function Rn(){const{t,lang:a,token:n,scoped:r,fund:s,data:o,dispatch:d}=T(),[i,c]=l.useState({}),m=25,b=l.useMemo(()=>r.slice(0,m),[r]);l.useEffect(()=>{b.length&&Ya(n,b.map(v=>v.name)).then(c)},[n,b]);const u=o.stats,h=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return e.jsxs("div",{className:"dossier",children:[e.jsxs("div",{className:"dsbar",children:[e.jsx("b",{children:t.dsTitle(b.length)}),r.length>m&&e.jsx("span",{className:"mnote dim",children:t.dsCap(m,r.length)}),e.jsx("span",{className:"dssp"}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:t.printBtn})]}),e.jsxs("div",{className:"dscover",children:[e.jsx("b",{children:s}),u&&typeof u.screened=="number"&&e.jsxs("p",{children:[h(u.screened)," ",t.funScreened(""),typeof u.kept=="number"&&e.jsxs(e.Fragment,{children:[" · ",h(u.kept)," ",t.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&e.jsxs(e.Fragment,{children:[" · ",t.covOf(h(o.marketEstimate)),", ",Math.round(u.screened/o.marketEstimate*100)," %"]})]})]}),b.map(v=>e.jsx(qn,{o:v,qa:i[v.name]},v.id)),!b.length&&e.jsx("p",{className:"mnote",children:t.dsEmpty})]})}const On=50;function ft({label:t,onPreview:a,onTest:n,readOnly:r}){const{t:s}=T(),[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(""),[u,h]=l.useState(0),[v,f]=l.useState(""),[x,g]=l.useState(!1),p=l.useRef(null);l.useEffect(()=>()=>{p.current&&window.clearInterval(p.current)},[]);const y=async w=>{c(!0),b("");const C=await a();if(c(!1),C.ok){d(C);return}if(C.busy){b(s.alertPreviewBusy);return}if(!w){b(s.alertPreviewFail);return}h(On),p.current=window.setInterval(()=>{h(j=>j>1?j-1:(p.current&&window.clearInterval(p.current),y(!1),0))},1e3)},S=async()=>{if(r||x)return;g(!0),f("");const w=await n();g(!1),f(w.ok?s.alertTestOk(w.sentTo||""):w.error||s.actErr)};return e.jsxs("div",{className:"mailp",children:[e.jsxs("div",{className:"mailp-row",children:[e.jsx("button",{type:"button",className:"abtn",disabled:i||u>0,onClick:()=>{y(!0)},children:i?"…":t}),e.jsx("button",{type:"button",className:"abtn",disabled:r||x,onClick:()=>{S()},children:x?"…":s.alertTest})]}),u>0&&e.jsx("p",{className:"mnote",children:s.alertPreviewRetry(u)}),m&&e.jsx("p",{className:"mnote warn",children:m}),v&&e.jsx("p",{className:"mnote",children:v}),!v&&e.jsx("p",{className:"mnote dim",children:s.alertTestHint}),(o==null?void 0:o.ok)&&e.jsxs(e.Fragment,{children:[e.jsxs("p",{className:"mnote",children:[e.jsx("b",{children:s.alertSubject})," ",o.subject]}),o.pending===0&&e.jsx("p",{className:"mnote warn",children:s.alertPreviewEmpty}),e.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:t})]})]})}const Fe="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function se({title:t,icon:a,children:n,wide:r}){const{dispatch:s}=T();return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&s({type:"modal",modal:null})},children:e.jsxs("div",{className:"mcard",style:r?{width:"min(760px,100%)"}:void 0,children:[e.jsxs("div",{className:"mh",children:[a&&e.jsx("span",{className:"no g",children:a}),e.jsx("h2",{children:t}),e.jsx("button",{type:"button",className:"x",onClick:()=>s({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"mb",children:n})]})})}),document.body)}function Fn(){const{st:t}=T();switch(t.modal){case"chain":return e.jsx(Dn,{});case"space":return e.jsx(Pn,{});case"alert":return e.jsx(In,{});case"queue":return e.jsx(Vn,{});case"export":return e.jsx(Hn,{});case"plug":return e.jsx(Gn,{});case"recharge":return e.jsx(Qn,{});case"cover":return e.jsx(Xn,{});case"dossier":return e.jsx(Jn,{});case"crit":return e.jsx(Zn,{});case"tuto":return e.jsx(eo,{});case"rdv":return e.jsx(Mn,{});case"memoalert":return e.jsx(Yn,{});default:return null}}function Mn(){const{dispatch:t,fund:a}=T(),n=typeof document<"u"&&!!document.getElementById("rdv");return l.useEffect(()=>{n&&(t({type:"modal",modal:null}),Dr())},[n,t]),n?null:e.jsx(Ka,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>t({type:"modal",modal:null})})}function Dn(){const{st:t,dispatch:a,byId:n,t:r,lang:s,mode:o,askEvaluate:d,evalBusy:i}=T(),c=o==="client",m=t.chain.queue.map(v=>n.get(v)).filter(v=>!!v),b=t.chain.idx,u=m[b],h=b>=m.length;return Me.createPortal(e.jsx("div",{className:"atl2",children:e.jsx("div",{className:"modal on",children:e.jsxs("div",{className:"fcard",children:[e.jsxs("div",{className:"fh",children:[e.jsx("span",{className:"c",children:h?r.finished:`${b+1} / ${m.length}`}),e.jsx("span",{className:"p",children:e.jsx("i",{style:{width:(h?100:b/Math.max(1,m.length)*100)+"%"}})}),e.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),e.jsx("div",{className:"fb",children:h||!u?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🏁"}),e.jsx("div",{className:"t",children:r.chainDone}),e.jsx("div",{className:"s",children:r.chainDoneSub(m.length)})]}):e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:u.name}),e.jsx("div",{className:"sub",children:[Le(u.cc,s)||u.countryLabel,u.sector,u.stage,r.daysAgo(Te(u.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),e.jsxs("div",{className:"tags",children:[e.jsx("span",{className:"hi",children:he(u.engine,s).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&e.jsx("span",{children:ct(u.amountEur,s)})]}),ne(u)&&e.jsxs("div",{style:{marginBottom:12},children:[e.jsx(qe,{o:u,lg:!0})," ",e.jsx(We,{o:u,src:!0})]}),(u.tagline||u.headline)&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.desc}),e.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&e.jsxs("div",{className:"fld",children:[e.jsx("span",{className:"l",children:r.memo}),e.jsx("p",{className:"memo",children:u.reasoning})]}),c&&ce(u)&&e.jsxs("div",{className:"vbox",style:{"--c":Ee(u)==="retenu"?"var(--brand)":Ee(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[e.jsx("span",{className:"vt",children:Ee(u)==="retenu"?"✓ "+r.kept:Ee(u)==="pending"?"📞 "+r.pending:"✗ "+r.dropped}),e.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),e.jsxs("div",{className:"ff",children:[!h&&u&&!(c&&ce(u))&&e.jsxs("button",{type:"button",className:"evalbtn"+(i?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:i,onClick:()=>{d(u)},children:[e.jsx("span",{className:"fill"}),r.launchEval]}),e.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(h?{type:"modal",modal:null}:{type:"chainNext"}),children:h?r.closeBtn:r.skip})]})]})})}),document.body)}function Pn(){const{st:t,dispatch:a,dossiers:n,t:r,mode:s}=T(),o=s==="client",d=l.useMemo(()=>o?n.filter(u=>ce(u)):[],[n,o]),i=l.useMemo(()=>ut(d.filter(u=>Ee(u)==="retenu"),{key:"signal",dir:-1}),[d]),c=l.useMemo(()=>d.filter(u=>Ee(u)==="ecarte"),[d]),m=t.spaceTab==="retenu"?i:c,b=t.spaceTab==="retenu"?"var(--brand)":"var(--red)";return e.jsxs(se,{title:r.spaceTitle,children:[e.jsxs("div",{className:"sp-tabs",children:[e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":t.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",r.statusKeep.replace("✅ ","")," ",e.jsx("b",{children:i.length})]}),e.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":t.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",r.statusDrop.replace("❌ ","")," ",e.jsx("b",{children:c.length})]})]}),m.length===0&&e.jsx("div",{className:"sp-empty",children:r.spEmpty}),m.slice(0,40).map(u=>e.jsxs("div",{className:"sp-row",children:[e.jsx("span",{className:"sc",style:{"--c":b},children:typeof u.score=="number"&&u.score>0?u.score:"—"}),e.jsxs("span",{children:[e.jsx("div",{className:"nm",children:u.name}),e.jsx("div",{className:"rr",children:u.reasoning||u.tagline||""})]})]},u.id)),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:r.spNote}})]})}function In(){const{mode:t}=T();return t==="client"||t==="apercu"?e.jsx(Bn,{}):e.jsx(Un,{})}function Bn(){const{t,token:a,flash:n,flashErr:r,mode:s}=T(),[o,d]=l.useState("d"),i=s!=="client";return e.jsxs(se,{title:t.alertTitle,icon:"🔔",children:[e.jsxs("div",{className:"ntabs",role:"tablist",children:[e.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>d("d"),children:t.alertTabDaily}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>d("w"),children:t.alertTabWeekly}),e.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>d("m"),children:t.alertTabMarket})]}),o==="d"&&e.jsx($n,{t,token:a,readOnly:i,flash:n,flashErr:r}),o==="w"&&e.jsx(_n,{t,token:a,readOnly:i,flash:n,flashErr:r}),o==="m"&&e.jsx(Zt,{})]})}function $n({t,token:a,readOnly:n,flash:r,flashErr:s}){const[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(0);l.useEffect(()=>{let f=!0;return c(!1),Ct(a).then(x=>{f&&(x?d(x):c(!0))}),()=>{f=!1}},[a,m]);const u=f=>{n||Ct(a,f).then(x=>{if(!x){s(t.actErr);return}d(x),x.throttled?s(t.alertThrottled):r(t.alertSaved)})};if(i)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const h=f=>!o.sections||o.sections.includes(f),v=f=>{const x=o.sections||t.alertSec.map(([g])=>g);u({sections:h(f)?x.filter(g=>g!==f):[...x,f]})};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qrow",children:[e.jsxs("span",{children:[e.jsx("b",{children:t.alertDaily}),e.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:t.alertDailyHint})]}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertHour}),e.jsxs("span",{className:"qset",children:[e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,(o.hour??7)-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[o.hour??7," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,(o.hour??7)+1)}),disabled:n,children:"＋"})]})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertDays}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"weekdays"}),children:t.alertWeekdays}),e.jsx("button",{type:"button",className:"abtn",disabled:n,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>u({days:"daily"}),children:t.alertEveryday})]})]}),e.jsx("div",{className:"qsec ok",children:t.alertSections}),e.jsx("div",{className:"secl",children:t.alertSec.map(([f,x])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:h(f),disabled:n,onChange:()=>v(f)}),e.jsxs("span",{children:[x,f==="market"&&e.jsxs("i",{children:[" ",t.alertSecSlow]})]})]},f))}),e.jsx("p",{className:"mnote dim",children:t.alertSecNote}),e.jsx(ft,{label:t.alertPreview,readOnly:n,onPreview:()=>ar(a),onTest:()=>tr(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function _n({t,token:a,readOnly:n,flash:r,flashErr:s}){const[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(0);l.useEffect(()=>{let f=!0;return c(!1),Et(a).then(x=>{f&&(x?d(x):c(!0))}),()=>{f=!1}},[a,m]);const u=f=>{n||Et(a,f).then(x=>{if(!x){s(t.actErr);return}d(x),r(t.alertSaved)})};if(i)return e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>b(f=>f+1),children:t.retry})]});if(!o)return e.jsx("div",{className:"sp-empty",children:"…"});const h=o.dow??0,v=o.hour??16;return e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"lead2",children:t.alertWeeklySub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.alertWeeklyOn})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:n,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>u({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:t.alertWeeklyWhen}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("select",{value:h,disabled:n,onChange:f=>u({dow:Number(f.target.value)}),children:t.alertDow.map((f,x)=>e.jsx("option",{value:x,children:f},f))}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.max(6,v-1)}),disabled:n,children:"−"}),e.jsxs("b",{children:[v," h"]}),e.jsx("button",{type:"button",onClick:()=>u({hour:Math.min(21,v+1)}),disabled:n,children:"＋"})]})]}),e.jsx(ft,{label:t.alertPreviewWeekly,readOnly:n,onPreview:()=>nr(a),onTest:()=>rr(a)}),o.active===!1&&e.jsx("p",{className:"mnote warn",children:t.alertInactive}),o.email_lead?e.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${t.updatedAt(o.last_sent.slice(0,10))}`:""]}):e.jsx("p",{className:"mnote",children:t.alertNoLead})]})}function Zt(){const{st:t,t:a,lang:n,scoped:r,contName:s,email:o}=T(),[d,i]=l.useState(o||""),[c,m]=l.useState(!1),[b,u]=l.useState(!1);l.useEffect(()=>{o&&i(o)},[o]);const h=t.filters,v=l.useMemo(()=>r.filter(p=>ne(p)).length,[r]),f=h.win==="1"?0:h.win==="7"?1:h.win==="30"?2:3,x=async()=>{if(!(!/.+@.+\..+/.test(d)||b)){u(!0);try{await fetch(`${ot}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:h.sector,countries:h.country,source:o?"atelier2-client":"atelier2",website:""})}),m(!0)}finally{u(!1)}}},g=[[a.amRows.continent,s],[a.amRows.since,a.amSince[f]],[a.amRows.signal,h.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,h.engine.length?h.engine.map(p=>he(p,n)).join(", "):a.amAllEngines],[a.amRows.sectors,h.sector.length?h.sector.join(", "):a.amAllSectors],[a.amRows.countries,h.country.length?h.country.map(p=>Le(p,n)||p).join(", "):a.amAllCountries],[a.amRows.stages,h.stage.length?h.stage.join(", "):a.amAllStages]];return c?e.jsxs("div",{className:"fin",children:[e.jsx("div",{className:"em",children:"🔔"}),e.jsx("div",{className:"t",children:a.amOk}),e.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"crit",children:g.map(([p,y])=>e.jsxs("div",{className:"r",children:[e.jsx("span",{className:"k",children:p}),e.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},p))}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!o,onChange:p=>i(p.target.value),onKeyDown:p=>{p.key==="Enter"&&x()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(b?" loading":""),style:{padding:"12px 18px"},onClick:()=>void x(),children:[e.jsx("span",{className:"fill"}),a.amActivate]})]}),e.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(r.length,v)}}),e.jsx("p",{className:"mnote",children:a.amHonest})]})}function Un(){const{t}=T();return e.jsx(se,{title:t.alertTitle,icon:"🔔",children:e.jsx(Zt,{})})}function Vn(){var x,g,p;const{t,token:a,fund:n,mode:r,flash:s}=T(),[o,d]=l.useState(null),[i,c]=l.useState([]),[m,b]=l.useState(0),u=r==="client";l.useEffect(()=>{let y=!0;return(async()=>{const[S,w]=await Promise.all([it(n),Vt(a)]);y&&(S&&d(S),c(w))})(),()=>{y=!1}},[a,n,m]);const h=(o==null?void 0:o.per_day)??2,v=((x=o==null?void 0:o.analyzed_today)==null?void 0:x.length)??0,f=(g=o==null?void 0:o.tomorrow)!=null&&g.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return e.jsxs(se,{title:t.queueTitle,wide:!0,children:[e.jsxs("div",{className:"qbox",children:[e.jsx("div",{className:"qhead",children:e.jsx("b",{dangerouslySetInnerHTML:{__html:t.queueDone(v,v+(((p=o==null?void 0:o.pool_order)==null?void 0:p.length)??0))}})}),e.jsxs("div",{className:"qrate",children:[t.covRate," — ",e.jsx("b",{children:t.covRateNow(h)})]})]}),i.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"qsec ok",children:["⏳ ",t.queueToday]}),e.jsx("div",{className:"qrows",children:i.map(y=>e.jsxs("div",{className:"qr2",children:[e.jsx("b",{children:y.company}),e.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),e.jsx("span",{className:"qt",children:y.status}),y.url&&e.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.actMemo}),u&&y.status==="error"&&e.jsx("button",{type:"button",className:"qgo an",onClick:()=>{St(a,y.company,"retry").then(()=>b(S=>S+1))},children:t.queueRetry}),u&&y.status!=="done"&&e.jsx("button",{type:"button",className:"abtn",onClick:()=>{St(a,y.company,"delete").then(()=>b(S=>S+1))},children:t.queueDelete})]},y.company))})]}),e.jsxs("div",{className:"qsec todo",children:["⚡ ",t.queueTomorrow]}),e.jsxs("div",{className:"qrows",children:[f.length===0&&e.jsx("div",{className:"sp-empty",children:t.queueEmpty}),f.slice(0,10).map((y,S)=>e.jsxs("div",{className:"qr2",children:[e.jsxs("span",{className:"qn2",children:["#",S+1]}),e.jsx("b",{children:y.name}),typeof y.score=="number"&&e.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function Hn(){const{t,token:a,flash:n,scoped:r,caps:s,stageOf:o,dispatch:d}=T(),i=`${Fe}/cibles/list.csv?token=${a}`,c=`${Fe}/cibles/list.json?token=${a}`,m=`${Fe}/cibles/export.xlsx?token=${a}&scope=full`,b=`=IMPORTDATA("${i}")`,u=g=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>n(t.exportCopied))},h=[{def:t.exportCsv,value:i,href:i},{def:t.exportSheet,value:b},{def:t.exportLive,value:c,href:c},{def:t.exportXlsx,value:m,href:m}],v=!s.lockActions&&r.length>0,f=()=>{An(Tn(r,{plabels:t.plabels,head:t.exportViewHead,stageOf:o,stageLabel:g=>(t.stg.find(([p])=>p===g)||["",""])[1]})),n(t.exportViewDone(r.length))},x=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return e.jsxs(se,{title:t.exportTitle,icon:"📥",children:[e.jsx("p",{className:"lead2",children:t.exportLead}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🖨️"}),e.jsxs("div",{children:[e.jsx("b",{children:t.printTitle}),e.jsx("p",{children:t.printDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb",onClick:x,children:t.printBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"🗂"}),e.jsxs("div",{children:[e.jsx("b",{children:t.dsBtn}),e.jsx("p",{children:t.dsHint})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:t.exportViewBtn})]})}),v&&e.jsx("div",{className:"expl",style:{marginBottom:10},children:e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:"📄"}),e.jsxs("div",{children:[e.jsx("b",{children:t.exportViewTitle}),e.jsx("p",{children:t.exportViewDesc(r.length)})]}),e.jsx("button",{type:"button",className:"exb pri",onClick:f,children:t.exportViewBtn})]})}),e.jsx("div",{className:"expl",children:h.map(({def:g,value:p,href:y})=>e.jsxs("div",{className:"exi",children:[e.jsx("span",{className:"exic",children:g[0]}),e.jsxs("div",{children:[e.jsx("b",{children:g[1]}),e.jsx("p",{children:g[2]})]}),e.jsx("button",{type:"button",className:"exb",onClick:()=>u(p),children:t.exportCopy}),y&&e.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:t.exportOpen})]},g[1]))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.exportKeyWarning})]})}function Yn(){const{t,token:a,flash:n,flashErr:r,mode:s}=T(),o=s!=="client",[d,i]=l.useState(null),[c,m]=l.useState(!1),[b,u]=l.useState(0),[h,v]=l.useState(!1);l.useEffect(()=>{let p=!0;return m(!1),Nt(a).then(y=>{p&&(y?i(y):m(!0))}),()=>{p=!1}},[a,b]);const f=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},x=p=>{if(o||!d)return;const y={enabled:p.enabled??!!d.enabled,email:p.email??(d.email||""),sections:p.sections??f()};v(!0),Nt(a,y).then(S=>{if(v(!1),!S){r(t.memoAlertErr);return}i(S),n(t.memoAlertSaved)})};if(c)return e.jsx(se,{title:t.memoAlertTitle,icon:"🔔",children:e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>u(p=>p+1),children:t.retry})]})});if(!d)return e.jsx(se,{title:t.memoAlertTitle,icon:"🔔",children:e.jsx("div",{className:"sp-empty",children:"…"})});const g=f();return e.jsxs(se,{title:t.memoAlertTitle,icon:"🔔",children:[e.jsx("p",{className:"lead2",children:t.memoAlertSub}),e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:e.jsx("b",{children:t.memoAlertToggle})}),e.jsx("span",{className:"qset",children:e.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:o||h,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),e.jsx(Wn,{value:d.email||"",readOnly:o||h,label:t.memoAlertEmail,okLabel:t.csNoteOk,onSave:p=>x({email:p})}),e.jsx("div",{className:"qsec ok",children:t.memoAlertSections}),e.jsx("div",{className:"secl",children:t.memoAlertSec.map(([p,y])=>e.jsxs("label",{className:"secli",children:[e.jsx("input",{type:"checkbox",checked:!!g[p],disabled:o||h,onChange:()=>x({sections:{...g,[p]:!g[p]}})}),e.jsx("span",{children:y})]},p))}),e.jsx(ft,{label:t.memoAlertPreview,readOnly:o,onPreview:()=>Ga(a,g),onTest:()=>Wa(a,g)})]})}function Wn({value:t,readOnly:a,label:n,okLabel:r,onSave:s}){const[o,d]=l.useState(t);l.useEffect(()=>{d(t)},[t]);const i=o.trim()!==t.trim(),c=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return e.jsxs("div",{className:"qrow",children:[e.jsx("span",{children:n}),e.jsxs("span",{className:"qset",style:{gap:6},children:[e.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:m=>d(m.target.value),onKeyDown:m=>{m.key==="Enter"&&i&&c&&s(o.trim())}}),e.jsx("button",{type:"button",className:"abtn",disabled:a||!i||!c,onClick:()=>s(o.trim()),children:r})]})]})}function Gn(){const{t,token:a,flash:n,flashErr:r,canWrite:s}=T(),[o,d]=l.useState(null),[i,c]=l.useState(!1),[m,b]=l.useState(null),[u,h]=l.useState(""),[v,f]=l.useState(0);l.useEffect(()=>{let p=!0;return c(!1),rt(a).then(y=>{p&&(y?d({configured:y.configured,url_hint:y.url_hint}):c(!0))}),Ja(a).then(y=>{p&&b(y)}),()=>{p=!1}},[a,v]);const x=(p,y)=>{s&&rt(a,p).then(S=>{if(!S||S.ok===!1){r(t.actErr);return}p.test&&S.sent===!1?r(t.plugTestThrottled):n(y),f(w=>w+1)})},g='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return e.jsxs(se,{title:t.plugTitle,icon:"🔌",wide:!0,children:[m&&e.jsx("p",{className:"mnote"+(m.enabled?" warn":""),children:m.enabled?t.plugAutoOn(m.destination||"webhook"):t.plugAutoOff}),i?e.jsxs("div",{className:"sp-empty",children:[t.alertLoadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>f(p=>p+1),children:t.retry})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugCrm}),e.jsx("p",{className:"mnote",children:t.plugCrmHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("input",{type:"url",maxLength:500,placeholder:t.plugUrlPh,value:u,disabled:!s,onChange:p=>h(p.target.value)}),e.jsx("button",{type:"button",className:"abtn",disabled:!s||!u.trim(),onClick:()=>x({url:u.trim()},t.plugSaved),children:t.plugSave})]}),(o==null?void 0:o.configured)&&e.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",e.jsx("button",{type:"button",className:"lk",disabled:!s,onClick:()=>x({test:!0},t.plugTested),children:t.plugTest})," · ",e.jsx("button",{type:"button",className:"lk",disabled:!s,onClick:()=>x({remove:!0},t.plugRemoved),children:t.plugRemove})]}),e.jsx(Kn,{}),e.jsx("div",{className:"qsec ok",children:t.plugMcp}),e.jsxs("div",{className:"cpy",children:[e.jsx("code",{children:g}),e.jsx("button",{type:"button",className:"abtn",onClick:()=>{var p;(p=navigator.clipboard)==null||p.writeText(g).then(()=>n(t.exportCopied))},children:t.exportCopy})]})]})]})}function Kn(){const{t,token:a,lang:n}=T(),[r,s]=l.useState("valides"),[o,d]=l.useState(!1),[i,c]=l.useState(null),[m,b]=l.useState(null),[u,h]=l.useState(!1),[v,f]=l.useState(!1),[x,g]=l.useState(null),[p,y]=l.useState(null),[S,w]=l.useState(null),C=`atl2:bulk:${a}:${r}`;l.useEffect(()=>{rt(a).then(z=>{y(z&&z.configured?z.url_hint||"webhook":null)})},[a]),l.useEffect(()=>{c(null),b(null),h(!1),g(null);try{const z=JSON.parse(localStorage.getItem(C)||"null");w(z&&Date.now()-Date.parse(z.t)<24*3600*1e3?z:null)}catch{w(null)}},[C]);const j=async()=>{d(!0),h(!1),g(null);const z=await Za(a,r);c(z),b(z.ok?r:null),d(!1)},E=l.useRef(!1),N=async()=>{if(E.current)return;E.current=!0,f(!0);const z=`${a}:${r}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await er(a,r,"webhook",void 0,z)}finally{E.current=!1}if(f(!1),h(!1),g(_),_.ok&&(_.pushed||0)>0){const D={t:new Date().toISOString(),n:_.pushed||0};w(D);try{localStorage.setItem(C,JSON.stringify(D))}catch{}}},q=i!=null&&i.ok&&i.ready||0,$=!!(i!=null&&i.ok)&&m===r&&q>0&&!!p&&!S,F=S?new Date(S.t).toLocaleString(n==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.plugBulk}),e.jsx("p",{className:"mnote",children:t.plugBulkHint}),e.jsxs("div",{className:"mfield",children:[e.jsx("select",{value:r,onChange:z=>s(z.target.value),children:t.plugBulkTabs.map(([z,_])=>e.jsx("option",{value:z,children:_},z))}),e.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{j()},children:o?"…":t.plugBulkPreview})]}),i&&(i.ok?e.jsx("p",{className:"mnote",children:t.plugBulkResult(i.ready||0,i.linkedinReady||0,(i.noContact||[]).length)}):e.jsx("p",{className:"mnote warn",children:t.actErr})),!!(i!=null&&i.ok)&&e.jsx("p",{className:"mnote dim",children:t.bulkScope}),S&&e.jsx("p",{className:"mnote",children:t.bulkLocked(F,S.n)}),!S&&!!(i!=null&&i.ok)&&!p&&e.jsx("p",{className:"mnote warn",children:t.bulkNoDest}),!S&&!i&&e.jsx("p",{className:"mnote dim",children:t.bulkPreviewFirst}),$&&!u&&e.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>h(!0),children:t.bulkArm}),$&&u&&e.jsxs("div",{className:"bulkc",children:[e.jsx("p",{className:"mnote warn",children:t.bulkWarn(q,p||"")}),e.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{N()},children:v?t.bulkSending:t.bulkConfirm(p||"")}),e.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>h(!1),children:t.bulkCancel})]}),x&&(x.ok?x.replayed?e.jsx("p",{className:"mnote",children:x.pending?t.bulkPending:t.bulkReplayed}):(x.pushed||0)>0?e.jsx("p",{className:"mnote",children:t.bulkDone(x.pushed||0,x.linkedinReady||0,x.skippedNoEmail||0)}):e.jsx("p",{className:"mnote warn",children:t.bulkNone}):e.jsx("p",{className:"mnote warn",children:x.error||t.actErr}))]})}function Qn(){const{t,data:a,lang:n}=T(),r=a.credits,s=a.email,o=async d=>{if(!s)return;const i=window.location.href.split("?")[0];try{const m=await(await fetch(`${ot}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s,lookup_key:d,success_url:i+"?credits=ok",cancel_url:i+"?credits=cancel"})})).json();m.url&&(window.location.href=m.url)}catch{}};return e.jsxs(se,{title:t.rechargeTitle,icon:"⚡",children:[r&&e.jsxs(e.Fragment,{children:[e.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:t.rechargeHint(r.daily_grant)}}),r.costs&&e.jsxs("p",{className:"mnote",children:["① ",t.creditsCost(r.costs.instant)," · ② ",t.creditsCost(r.costs.detailed)]}),e.jsx("div",{className:"packs",children:(r.packs||[]).map(d=>e.jsxs("div",{className:"pack",children:[e.jsx("div",{className:"pt",children:t.rechargeUnit(d.credits,d.price_eur)}),e.jsx("button",{type:"button",onClick:()=>{o(d.lookup_key)},children:t.rechargeBuy})]},d.lookup_key))}),e.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:t.rechargeNote})]}),!r&&e.jsx("div",{className:"sp-empty",children:t.creditsNone})]})}function Jn(){const{t}=T();return e.jsx(se,{title:t.dsBtn,icon:"🗂",wide:!0,children:e.jsx(Rn,{})})}function Xn(){const{t,lang:a,data:n,dossiers:r,token:s,canWrite:o,flash:d}=T(),[i,c]=l.useState(null),[m,b]=l.useState(!1);l.useEffect(()=>{let j=!0;return it(s).then(E=>{j&&E&&typeof E.per_day=="number"&&c(E.per_day)}),()=>{j=!1}},[s]);const u=n.stats,h=typeof(u==null?void 0:u.screened)=="number"?u.screened:r.filter(j=>j.kind==="target"&&ce(j)).length,v=n.marketEstimate||0,f=v>0?Math.min(100,Math.round(h/v*100)):null,x=(u==null?void 0:u.window_days)||30,g=h>0?h/x:0,p=v>0?Math.max(0,v-h):0,S=v>0&&g>0&&h>=100?Math.round(p/g):null,w=j=>Math.round(j).toLocaleString(a==="en"?"en-US":"fr-FR"),C=j=>{m||!o||(b(!0),Xa(s,j).then(E=>{if(b(!1),E===null){d(t.actErr);return}c(E),d(t.alertSaved)}))};return e.jsxs(se,{title:t.coverTitle,icon:"🌍",children:[e.jsxs("div",{className:"covg",children:[e.jsx("b",{children:t.covScreened(w(h))}),v>0&&e.jsx("span",{children:t.covOf(w(v))})]}),f!==null?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"covbar",children:[e.jsx("i",{style:{width:f+"%"}}),e.jsxs("em",{children:[f," %"]})]}),S!==null&&e.jsx("p",{className:"mnote",children:t.covEta(S)})]}):e.jsx("p",{className:"mnote dim",children:t.covNoEst}),g>=1&&e.jsx("p",{className:"mnote",children:t.covPace(w(g))}),u&&e.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.kept)})," ",t.covKept]}),typeof u.analyzed=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.analyzed)})," ",t.covAna]}),typeof u.shown=="number"&&e.jsxs("span",{children:[e.jsx("b",{children:w(u.shown)})," ",t.covShown]})]}),o&&i!==null&&e.jsxs("div",{className:"covr",children:[e.jsxs("div",{className:"covrh",children:[e.jsx("span",{children:t.covRate}),e.jsx("b",{children:t.covRateNow(i)})]}),e.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(j=>e.jsx("button",{type:"button",className:i===j?"on":"",disabled:m,onClick:()=>C(j),children:j===0?"⏸":j},j))}),e.jsx("p",{className:"mnote dim",children:t.covRateHint})]})]})}function Zn(){var p,y,S;const{t,dossiers:a,token:n,mode:r,flash:s,criteria:o}=T(),d=r==="client",i=l.useMemo(()=>{const w=new Set;return a.forEach(C=>{C.angle&&w.add(C.angle)}),[...w]},[a]),[c,m]=l.useState(null);l.useEffect(()=>{let w=!0;return Qa(n).then(C=>{w&&m(C.thumbs)}),()=>{w=!1}},[n]);const[b,u]=l.useState(""),[h,v]=l.useState(""),[f,x]=l.useState(!1),g=async()=>{const w=b.trim();if(!(!w||f||!d)){x(!0),v("");try{const j=await(await fetch(`${Fe}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:n,message:w,who:"atelier2"})})).json().catch(()=>({}));if(j.reply&&v(String(j.reply)),j.job_id){v(t.critChatRunning);const E=async()=>{const N=await fetch(`${Fe}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:j.job_id})}).then(q=>q.json()).catch(()=>null);if(N&&N.done){v(String(N.reply||N.clarification||N.summary||"✓")),x(!1),N.applied&&s(t.alertSaved);return}setTimeout(()=>{E()},8e3)};setTimeout(()=>{E()},8e3),u("");return}u("")}finally{h.startsWith("⏳")||x(!1)}}};return e.jsxs(se,{title:t.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critHypTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((p=o.points)!=null&&p.length)&&e.jsx("ul",{className:"critpts",children:o.points.map(w=>e.jsx("li",{children:w},w))}),e.jsx("p",{className:"mnote",children:t.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critProfilsTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||t.critProfilsSub}),o.angles.map(w=>{var C,j;return e.jsxs("details",{className:"prof",children:[e.jsx("summary",{children:w.title}),w.why&&e.jsx("p",{className:"why",children:w.why}),e.jsxs("div",{className:"lo",children:[!!((C=w.look)!=null&&C.length)&&e.jsxs("div",{children:[e.jsx("em",{children:t.critLookFor}),e.jsx("ul",{children:w.look.map(E=>e.jsx("li",{children:E},E))})]}),!!((j=w.out)!=null&&j.length)&&e.jsxs("div",{className:"ko",children:[e.jsx("em",{children:t.critRuleOut}),e.jsx("ul",{children:w.out.map(E=>e.jsx("li",{children:E},E))})]})]})]},w.title)})]}),!!((S=o==null?void 0:o.gate)!=null&&S.length)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critGateTitle}),e.jsx("p",{className:"mnote",style:{marginTop:0},children:t.critGateSub}),o.gate.length===1&&!o.gate[0].k?e.jsx("p",{className:"gate1",children:o.gate[0].t}):e.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>e.jsxs("li",{children:[w.k&&e.jsx("b",{children:w.k}),w.t]},w.t))})]}),i.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"qsec ok",children:t.critAngles}),e.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:i.map(w=>e.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),e.jsxs("div",{className:"rule",children:[e.jsx("b",{children:t.critChatTitle}),e.jsx("p",{children:t.critChatHint}),e.jsxs("div",{className:"mfield",style:{marginTop:10},children:[e.jsx("input",{placeholder:t.critChatPh,value:b,disabled:!d||f,onChange:w=>u(w.target.value),onKeyDown:w=>{w.key==="Enter"&&g()}}),e.jsxs("button",{type:"button",className:"evalbtn"+(f?" loading":""),style:{padding:"12px 18px"},disabled:!d||f||!b.trim(),onClick:()=>void g(),children:[e.jsx("span",{className:"fill"}),t.critChatSend]})]}),h&&e.jsx("p",{className:"mnote",style:{marginTop:10},children:h})]}),e.jsx("div",{className:"qsec ok",children:t.critThumbsTitle}),c===null?e.jsx("div",{className:"sp-empty",children:"…"}):c.length===0?e.jsx("p",{className:"mnote",children:t.critThumbsEmpty}):e.jsx("div",{className:"qrows",style:{marginBottom:14},children:c.slice(0,12).map((w,C)=>e.jsxs("div",{className:"qr2",children:[e.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),e.jsx("b",{children:w.company}),e.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},C))}),e.jsx("div",{className:"qsec ok",children:t.qvTitle}),e.jsx("div",{className:"vlist",children:t.qv.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vd "+(Xt[w]||"v-cons"),children:w}),e.jsx("span",{children:C})]},w))}),e.jsx("div",{className:"qsec ok",children:t.brTitle}),e.jsx("div",{className:"vlist",children:t.br.map(([w,C])=>e.jsxs("div",{className:"vrow",children:[e.jsx("span",{className:"vtag",children:w}),e.jsxs("span",{children:["← ",C]})]},w))}),e.jsx("p",{className:"mnote",children:t.brNote}),e.jsx("p",{className:"mnote",children:t.critMemoKinds})]})}function eo(){const{t,dispatch:a,startTour:n}=T(),r=s=>{var o,d;a({type:"modal",modal:null}),s==="crit"||s==="plug"||s==="alert"?a({type:"modal",modal:s}):s.startsWith("tab")?a({type:"ptab",tab:Number(s.slice(3))}):s==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return e.jsxs(se,{title:t.tutoTitle,icon:"▶",children:[e.jsxs("div",{className:"howto-go",children:[e.jsx("p",{children:t.tourIntro}),e.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),n()},children:["▶ ",t.tourStart]})]}),e.jsx("ul",{className:"howto",children:t.howto.map(([s,o],d)=>e.jsxs("li",{role:"button",tabIndex:0,onClick:()=>r(o),onKeyDown:i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r(o))},children:[e.jsx("span",{className:"n",children:d+1}),e.jsx("span",{dangerouslySetInnerHTML:{__html:s.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+d))})]})}const tt={},Bt=(tt==null?void 0:tt.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function He(){return new Date().toISOString().slice(0,10)}const ea=l.createContext(null);function ta(){const t=l.useContext(ea);if(!t)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return t}function to({token:t,children:a}){const{dispatch:n,st:r,lang:s}=T(),[o,d]=l.useState(()=>r.filters.day||He()),[i,c]=l.useState(null),[m,b]=l.useState(!1),u=l.useCallback(f=>{if(/^\d{4}-\d{2}-\d{2}$/.test(f)){d(f);try{n({type:"filters",patch:{day:f,win:"all"}})}catch{}}},[n]);l.useEffect(()=>{r.filters.day||u(He())},[]),l.useEffect(()=>{const f=x=>{var p;const g=(p=x.detail)==null?void 0:p.day;typeof g=="string"&&u(g)};return window.addEventListener("pp-edition-day",f),()=>window.removeEventListener("pp-edition-day",f)},[u]),l.useEffect(()=>{r.filters.day&&r.filters.day!==o&&d(r.filters.day)},[r.filters.day]),l.useEffect(()=>{if(!t||!o)return;let f=!1;b(!0);const x=new URLSearchParams({token:t,date:o});return fetch(`${Bt}/cibles/edition.json?${x}`).then(g=>g.json()).then(g=>{f||c(g)}).catch(()=>{f||c({ok:!1,error:"network"})}).finally(()=>{f||b(!1)}),()=>{f=!0}},[t,o]);const h=l.useMemo(()=>`${Bt}/cibles/editions.json?token=${encodeURIComponent(t)}`,[t]),v=l.useMemo(()=>({token:t,day:o,ed:i,loading:m,pickDay:u,daysUrl:h,isEn:s==="en"}),[t,o,i,m,u,h,s]);return e.jsx(ea.Provider,{value:v,children:a})}function ao(){const{day:t,daysUrl:a,pickDay:n,isEn:r}=ta();return e.jsxs("div",{className:"thesis-days",children:[e.jsx("style",{children:`
      ...
      `}),e.jsx("p",{className:"thesis-days__h",children:r?"Thesis brief · pick a day":"Brief thèse · choisir un jour"}),e.jsx(or,{mode:"local",theme:"light",month:t.slice(0,7),current:t,daysUrl:a,onPick:n})]})}function ro(){const{day:t,ed:a,loading:n,pickDay:r,isEn:s}=ta(),o=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),d=(a==null?void 0:a.ok)&&!o,i=a&&!a.ok;return e.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||t,"data-fund":(a==null?void 0:a.fund)||"",children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("header",{className:"thesis-brief__hd",children:[e.jsx("span",{className:"thesis-brief__kicker",children:s?"Daily brief":"Brief du jour"}),e.jsxs("h2",{className:"thesis-brief__title",children:[s?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||t)&&e.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||t,children:(a==null?void 0:a.date)||t})]}),e.jsx("p",{className:"thesis-brief__hint",children:s?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),n&&!o&&e.jsx("p",{className:"thesis-brief__loading",children:s?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),i&&e.jsxs("p",{className:"thesis-brief__err",children:[s?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d&&!n&&e.jsx("p",{className:"thesis-brief__empty",children:s?e.jsxs(e.Fragment,{children:["No thesis brief for ",e.jsx("b",{children:t})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):e.jsxs(e.Fragment,{children:["Pas encore de brief de thèse pour le ",e.jsx("b",{children:t}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),o&&(a!=null&&a.html)?e.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,o&&(a!=null&&a.acquirers_html)?e.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,t&&t!==He()&&e.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:()=>r(He()),children:s?"← Back to today":"← Revenir à aujourd’hui"})]})}const aa="atl2:mapfold",no=()=>{if(typeof window>"u")return!1;try{const t=localStorage.getItem(aa);if(t==="on")return!0;if(t==="off")return!1}catch{}try{const t=new URLSearchParams(window.location.search);if(t.get("embed")==="1"&&(t.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},ra=l.createContext(null),T=()=>{const t=l.useContext(ra);if(!t)throw new Error("AtelierV2Ctx manquant");return t};function qe({o:t,lg:a}){const{lang:n}=T(),r=ne(t);return r?e.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:zt(r,n),children:[r.emoji," ",zt(r,n)]}):null}function We({o:t,src:a}){const{lang:n,t:r}=T(),s=ne(t);if(!s)return null;const o=cr(s),d=pr(s);return e.jsxs("em",{className:"sigwin"+(d?" hot":""),title:r.signaledOn(Yt(s,n))+" · "+r.win7(Wt(s,n)),children:[e.jsx("span",{className:"gg",children:Array.from({length:7},(i,c)=>e.jsx("i",{className:c<o?"on":""},c))}),e.jsx("span",{className:"lb",children:d?r.lastDay:r.daysLeft(Math.max(0,s.left??0))}),a&&s.url&&e.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",title:r.seeSource,onClick:i=>i.stopPropagation(),children:"↗"})]})}function na({o:t}){const{lang:a}=T(),n=dr(t.cc),r=t.cc?Le(t.cc,a)||t.countryLabel||t.cc:t.countryLabel||"—";return e.jsx("span",{className:"c-flag",title:r||void 0,children:n?e.jsx("img",{src:n,width:24,height:18,alt:r||""}):e.jsx("span",{className:"em",children:"🌐"})})}const $t="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",oa=t=>`atl2:tour:${t||"anon"}`;function oo(t){try{return localStorage.getItem(oa(t))==="1"}catch{return!0}}function _t(t){try{localStorage.setItem(oa(t),"1")}catch{}}function so(t){const a=t.tourT,n=t.howto;return[{sel:".atl2 .ident",title:a.ident,body:t.tourIntro},{sel:".atl2 .ticker",title:a.live,body:t.fhintLive},{sel:".atl2 .goal",title:a.goal,body:t.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:n[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:n[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:n[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:t.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:t.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:t.learnLine},{sel:".atl2 .ftools",title:a.tools,body:n[6][0]},{sel:".atl2 .tool",title:a.crit,body:n[0][0]}]}function mo({demo:t=!1,source:a="default",initialFilters:n,initialUi:r,capsOverride:s,onFiltersChange:o}){const{lang:d}=sr(),i=vr[d],c=Ar(t,d,a),[m,b]=l.useReducer(qr,void 0,()=>Lr((r==null?void 0:r.continent)??"europe",t||no(),{ptab:r==null?void 0:r.ptab,dens:r==null?void 0:r.dens,filters:n,modal:r==null?void 0:r.modal})),u=l.useRef(!0);l.useEffect(()=>{if(u.current){u.current=!1;return}if(!t)try{localStorage.setItem(aa,m.mapFolded?"on":"off")}catch{}},[m.mapFolded,t]);const h=l.useRef(o);h.current=o,l.useEffect(()=>{var k;(k=h.current)==null||k.call(h,m.filters)},[m.filters]);const[v,f]=l.useState(null),[x,g]=l.useState(null),[p,y]=l.useState({kept:0,dropped:0}),[S,w]=l.useState(!1),[C,j]=l.useState(""),[E,N]=l.useState(!1),[q,$]=l.useState(null),[F,z]=l.useState(!1),[_,D]=l.useState(!1),[,Q]=l.useState(0),P=()=>Q(k=>k+1),le=l.useRef([]),fe=l.useRef(new Set),be=l.useRef(new Set),ve=l.useRef(new Map),I=l.useRef(null),{mode:pe}=c,V=l.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...s||null}),[c.caps,s,a]),U=V.pipe,M=c.session.token||"",B=pe==="client"&&!t;l.useEffect(()=>{if(document.querySelector(`link[href="${$t}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=$t,document.head.appendChild(k)},[]);const O=(k,L=!1)=>{j(k),N(L),I.current&&clearTimeout(I.current),I.current=setTimeout(()=>j(""),L?4200:2400)},G=k=>O(k,!0),K=l.useMemo(()=>{const k=new Map;return c.dossiers.forEach(L=>{L.id&&k.set(L.id,L)}),k},[c.dossiers]),oe=l.useMemo(()=>c.dossiers.filter(k=>Kt(k,m,U)),[c.dossiers,m,U]),ee=l.useRef(!1);l.useEffect(()=>{if(ee.current||t||c.loading||!c.dossiers.length)return;if(!V.showFunnel||oo(c.session.token||"")){ee.current=!0;return}ee.current=!0;const k=window.setTimeout(()=>{_t(c.session.token||""),z(!0)},700);return()=>window.clearTimeout(k)},[t,c.loading,c.dossiers.length,V.showFunnel,c.session.token]);const J=l.useMemo(()=>c.dossiers.filter(k=>Rr(k,m,U,c.favIds)),[c.dossiers,m,U,c.favIds]),ae=l.useMemo(()=>ir(oe,c.favIds),[oe,c.favIds]),H=lt.find(k=>k.key===m.continent),de=d==="fr"?H.fr:H.en;l.useEffect(()=>{const k=L=>{var Z;const R=(((Z=L.detail)==null?void 0:Z.name)||"").trim();R&&ue(null,R)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)});const ue=(k,L)=>{const R=((k==null?void 0:k.name)||L||"").trim();if(!B){g({kicker:R});return}!R||S||(w(!0),(async()=>{try{const Z=await Ht(M,R,"atelier2"),Pe={name:Z.company||R,verdict:Z.verdict,reason:Z.reason||"",remaining:Z.remaining??null};le.current=[Pe,...le.current].slice(0,8),Z.verdict==="kept"&&y(Ne=>({...Ne,kept:Ne.kept+1})),Z.verdict==="ruled_out"&&y(Ne=>({...Ne,dropped:Ne.dropped+1}));const Re=k||c.dossiers.find(Ne=>(Ne.name||"").toLowerCase()===R.toLowerCase());Re&&(Z.verdict==="kept"?Re.verdict=Re.verdict||"MATCH":Z.verdict==="ruled_out"&&(Re.verdict="NO MATCH"),Z.reason&&(Re.reasoning=Z.reason)),P()}finally{w(!1)}})())},ye=k=>{if(!B){g({kicker:k.name});return}fe.current.add(k.id),Oe(M,"fast_request",k.name||"",""),O(i.memoInstantSent(k.name)),P()},ge=k=>ve.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),A=(k,L)=>b({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:L}}),Y=async(k,L,R)=>{const Z=k.ceoStatus||"";k.ceoStatus=L,P();const Pe=await Xe(M,{status:L,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(R==null?void 0:R.note)!==void 0?{note:R.note}:{},...R!=null&&R.via?{via:R.via}:{}});return Pe.ok?Pe.skipped?(k.ceoStatus=Z,P(),G(i.actNotPersisted),!1):((R==null?void 0:R.undo)!==!1&&A(k,Z),R!=null&&R.msg&&O(R.msg),(L==="Validé"||L==="Écarté")&&!k.ceoNote&&(R==null?void 0:R.note)===void 0&&$({o:k,yes:L==="Validé"}),!0):(k.ceoStatus=Z,P(),G(i.actErr),!1)},X=async(k,L)=>{const R=await Xe(M,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:L,via:"note"});return!R.ok||R.skipped?(G(R.skipped?i.actNotPersisted:i.actErr),!1):(k.ceoNote=L,P(),!0)},W=l.useRef(new Map),me=k=>W.current.has(k.id)?W.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),we=(k,L)=>{W.current.set(k.id,L),P()},ke=(k,L)=>{B&&Y(k,L?"Validé":"Écarté",{msg:L?i.decidedYes(k.name):i.decidedNo(k.name)})},De=k=>{B&&Y(k,"À trancher",{msg:i.promoted(k.name)})},Ge=k=>{B&&(async()=>{const L=k.ceoStatus||"";k.ceoStatus="Retenu",P();const R=await Xe(M,{status:"Retenu",check_id:k.checkId,company:k.name});if(!R.ok||R.skipped){k.ceoStatus=L,P(),G(R.skipped?i.actNotPersisted:i.actErr);return}A(k,L),O(i.repeched(k.name))})()},Ke=()=>{const k=m.undo[m.undo.length-1];if(!k){O(i.undoNone);return}const L=K.get(k.id);if(!L){b({type:"undoPop"}),O(i.undoNone);return}let R=k.prevCeoStatus;if(!R)if((L.verdict||"").toUpperCase().includes("CALL"))R="À trancher";else{O(i.undoLockedTitle);return}(async()=>await Y(L,R,{undo:!1})&&(b({type:"undoPop"}),L.ceoStatus=k.prevCeoStatus,P(),O(i.undoDone(L.name))))()},je=k=>{B&&(be.current.add(k.id),P(),(async()=>{const L=await ur(M,k.name,"email");if(!L||L.ok===!1){be.current.delete(k.id),P(),G(i.actErr);return}Oe(M,"approach",k.name||"",""),O(i.actApproachSent)})())},sa=(k,L)=>{B&&(async()=>{if(!(await Oe(M,L?"yes":"no",k.name||"","")).ok){G(i.actErr);return}ve.current.set(k.id,L?"yes":"no"),P(),O(L?i.thumbUpDone:i.thumbDnDone)})()},ia=k=>{!B||!dt(k)||(Oe(M,"detailed_request",k.name||"",""),O(i.memoDeepSent(k.name)))},la=k=>{const L=new Set(c.favIds),R=L.has(k.id);R?L.delete(k.id):L.add(k.id),c.setFavIds(L),B&&mr(M,{id:k.id,co:k.name},R)},da=()=>{!B||_||window.confirm(i.identSyncConfirm)&&(D(!0),(async()=>{const k=await fr(M);D(!1),k?O(i.identSyncDone):G(i.actErr)})())},xt=/proplace/i.test(c.fund||""),ca=k=>{!B||!xt||(Oe(M,"onboard_request",k.name||"",""),O(i.onboardSent(k.name)))},pa={st:m,dispatch:b,t:i,lang:d,mode:pe,caps:V,pipe:U,token:M,fund:c.fund,email:c.email,criteria:c.criteria,data:c,doRepeche:Ge,thumbOf:ge,canWrite:B,commitStatus:Y,saveNote:X,stageOf:me,setStage:we,flashErr:G,startTour:()=>z(!0),dossiers:c.dossiers,scopedAll:oe,scoped:J,counts:ae,byId:K,contName:de,favIds:c.favIds,toggleFav:la,askEvaluate:ue,doAnalyse:ye,doDecide:ke,doPromote:De,doApproach:je,doThumb:sa,doDeep:ia,doUndo:Ke,doSync:da,doOnboard:ca,outbound:xt,memoQueued:fe.current,approachDone:be.current,sessTally:p,evalCards:le.current,evalBusy:S,markRow:f,markedId:v,flash:O};l.useEffect(()=>{const k=L=>{L.key==="Escape"&&(b({type:"popup",id:null}),b({type:"modal",modal:null}),b({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const ua=k=>M?e.jsx(to,{token:M,children:k}):e.jsx(e.Fragment,{children:k});return e.jsx(ra.Provider,{value:pa,children:e.jsxs("div",{className:"atl2",children:[e.jsx("style",{children:kr}),ua(e.jsxs("div",{className:"app"+(U?" pipe":"")+(M?" has-thesis":""),children:[V.showTicker&&e.jsx(te,{name:"live",children:e.jsxs("div",{className:"live-stack"+(M?" live-stack--cibles":""),children:[e.jsx(Or,{}),!!M&&e.jsx(ao,{})]})}),V.showIdent&&e.jsx(te,{name:"identite",children:e.jsx(Jr,{})}),V.showOnb&&e.jsx(te,{name:"onboarding",children:e.jsx(Xr,{})}),V.showMorning&&e.jsx(te,{name:"matin",children:e.jsx(Qr,{})}),e.jsx(te,{name:"fraicheur",children:e.jsx(_r,{})}),e.jsx(te,{name:"mesure",children:e.jsx(Ur,{})}),V.showFunnel&&e.jsx(te,{name:"entonnoir",children:e.jsx(io,{})}),V.showFunnel&&e.jsx(te,{name:"tunnel",children:e.jsx(en,{})}),V.showFunnel&&e.jsx(te,{name:"tuto",children:e.jsx(an,{})}),e.jsx(te,{name:"carte",fallback:e.jsx("div",{className:"void",children:i.loadError}),children:e.jsxs("div",{className:"fzone",children:[e.jsx(lo,{}),e.jsxs("div",{className:"stage"+(m.mapFolded?" folded":""),id:"atl2-stage",children:[e.jsx(nn,{}),e.jsx(sn,{})]})]})}),V.showDemand&&e.jsx(te,{name:"evaluation",children:e.jsx(cn,{})}),V.showDemand&&m.memoConsole&&e.jsx(te,{name:"console",children:e.jsx(un,{})}),e.jsx(te,{name:"liste",fallback:e.jsxs("div",{className:"void",children:[i.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:i.retry})]}),children:e.jsx(Nn,{})}),!!M&&e.jsx(te,{name:"edition",children:e.jsx(ro,{})}),c.loading&&e.jsx("div",{className:"void",children:i.loadingV2}),c.error&&!c.loading&&e.jsxs("div",{className:"void",children:[i.loadError," ",e.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:i.retry})]})]})),V.showOnb&&e.jsxs("div",{className:"lockbar on",children:[e.jsx("b",{children:i.lockbarText}),e.jsx("button",{type:"button",onClick:()=>b({type:"modal",modal:"rdv"}),children:i.lockbarCta})]}),m.popupId&&e.jsx(te,{name:"fiche",children:e.jsx(En,{})}),e.jsx(te,{name:"modales",children:e.jsx(Fn,{})}),e.jsx(Ir,{}),q&&e.jsxs("div",{className:"whydock",children:[e.jsx("b",{children:q.o.name}),e.jsx(Wr,{placeholder:q.yes?i.whyYesPh:i.whyNoPh,onDone:k=>{const L=q.o;$(null),k&&X(L,k).then(R=>{R&&O(i.csNoteSaved)})}})]}),F&&e.jsx(Kr,{steps:so(i),onClose:()=>{z(!1),_t(M)}}),C&&e.jsx("div",{className:"flash on"+(E?" err":""),children:C}),x&&e.jsx(lr,{variant:"acquirer",initialCompany:Ut().co,initialWebsite:Ut().site,onClose:()=>g(null)})]})})}function io(){const{t}=T(),[a,n]=l.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:e.jsxs("p",{className:"fhint",children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),e.jsx("span",{dangerouslySetInnerHTML:{__html:t.funnelHint}}),e.jsx("button",{type:"button","aria-label":"Fermer",title:t.fhintClose,onClick:()=>{n(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function lo(){const{dossiers:t,st:a,dispatch:n,pipe:r,lang:s,t:o}=T(),d=l.useMemo(()=>{const i={};return t.forEach(c=>{c.continent&&pt(c,a.filters,r)&&(i[c.continent]=(i[c.continent]||0)+1)}),i},[t,a.filters,r]);return e.jsxs("div",{className:"conts",children:[xr.map(i=>{const c=lt.find(m=>m.key===i);return e.jsxs("button",{type:"button",className:"cbtn","aria-selected":a.continent===i,onClick:()=>n({type:"continent",key:i}),children:[s==="fr"?c.fr:c.en,e.jsx("span",{className:"n",children:d[i]||0})]},i)}),e.jsx("span",{className:"side",children:e.jsx("button",{type:"button",onClick:()=>n({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ut(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function co(t){return t>=1e9?(t/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":t>=1e6?Math.round(t/1e6)+" M€":Math.round(t/1e3)+" k€"}export{na as FlagCell,qe as SigBadge,We as SigWin,mo as default,co as fmtShort,T as useV2};
