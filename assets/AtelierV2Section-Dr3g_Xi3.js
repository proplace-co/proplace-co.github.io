...
.atl2 .bulk .side .hint{white-space:nowrap}`,ds=`
...
`,ps=ls+ds+cs;function en(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function us(){const e=en("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function ms(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=us();return r==="0"?"client":r==="1"||en("embed")==="1"&&en("chrome")==="1"?"apercu":"client"}const fs={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},hs=e=>fs[e];function ja(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const zt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Ir(a)||ja(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ko(e.cc)})};function $a(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const xs=60*60*1e3;function gs(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>xs?null:a}catch{return null}}function da(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const bs=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function vs(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:Io(),[e,n]),i=p.useMemo(()=>n?"visiteur":ms(e,o),[e,o,n]),l=p.useMemo(()=>hs(i),[i]),s=i!=="visiteur",c=bs(r),[g,d]=p.useState([]),[x,u]=p.useState(""),[b,m]=p.useState(null),[v,y]=p.useState(null),[f,j]=p.useState(null),[N,w]=p.useState(()=>new Map),[E,z]=p.useState(()=>new Map),[S,q]=p.useState(""),[A,F]=p.useState(new Set),[D,B]=p.useState(null),[L,R]=p.useState(!0),[h,T]=p.useState(!1),[_,J]=p.useState(0),[$,M]=p.useState(0),K=p.useRef(0),W=p.useMemo(()=>{var X;if(i!=="client")return"";try{return((X=Po())==null?void 0:X.email)||""}catch{return""}},[i]);p.useEffect(()=>{const X=++K.current;let be=!0;const U=()=>be&&X===K.current,de=(s&&o.token?o.token:"pub:"+a)+(c?":"+c:""),pe=gs(de);return pe?(d(pe.objs.map(zt)),pe.fund&&u(pe.fund),m(pe.marketEstimate??null),y(pe.criteria??null),j(pe.stats??null),q(pe.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const Ne=await Ia(),fe=((Ne==null?void 0:Ne.recent_ops)||[]).map(ce=>{const ge=ga(ce.company_name||ce.title?ce:{...ce,title:(ce.headline_fr||ce.headline||"").slice(0,120)},a),Z=String(ce.rubrique||"").toLowerCase();return ge&&(Z==="nominations"||Z==="recrutements")&&(ge.engine=Z),ge&&!String(ce.company_name||"").trim()&&(ge.noCo=!0),ge}).filter(ce=>!!ce).map(ce=>(Ir((ce.name||"").trim())||(ce.noCo=!0),ce));try{const ce=Bo(),ge=await _o(),Z=((ge==null?void 0:ge.date)||"").slice(0,10),ee=ce?ce.doc:ge,ne=$o(ee),ue=((ce==null?void 0:ce.day)||(ee==null?void 0:ee.date)||Z||"").slice(0,10);if(ue&&ne.length){const Se=new Set;for(const ze of fe){if((ze.date||"").slice(0,10)!==ue)continue;const ie=Fn(ne,Se,ze.name,"");ie>=0&&(Se.add(ie),ze.decryptHtml=ne[ie].html)}for(const ze of fe){if(ze.decryptHtml||(ze.date||"").slice(0,10)!==ue)continue;const ie=Fn(ne,Se,"",ze.headline||ze.tagline||ze.name);ie>=0&&(Se.add(ie),ze.decryptHtml=ne[ie].html)}}if(ue){const Se=((ee==null?void 0:ee.title_fr)||"").trim(),ze=((ee==null?void 0:ee.lead_fr)||"").trim(),ie=Uo(ee),he=((ee==null?void 0:ee.url)||"").trim();Se&&(ie||he)&&fe.unshift({id:`edito:${ue}`,kind:"op",name:Se,cc:null,date:ue,engine:"edito",dealKind:"other",headline:Se,tagline:ze||Se,decryptHtml:ie||void 0,url:he,noCo:!0})}}catch{}if(!U())return;d(fe.map(zt)),da(de,{objs:fe})}else if(typeof r=="object"){const fe=(await Rn()||[]).filter(ge=>(ge.slug||"")===r.research).map(ge=>Mn(ge,a)).filter(ge=>!!ge),ce=$a(await On(fe,a));if(!U())return;d(ce.map(zt)),da(de,{objs:ce})}else if(s&&o.token){const Ne=Ho(o.token),fe=Ia(),ce=Vo(o.token),ge=Wo(o.token),Z=Go(o.token),ee=await Ne;let ne=ee?ee.targets:[];U()&&ee&&(u(ee.fund||""),m(ee.marketEstimate??null),y(ee.criteria??null),j(ee.stats??null),q(ee.generatedAt||""),d(ne.map(zt)),R(!1),T(!1));const[ue,Se,ze,ie]=await Promise.all([fe,ce,ge,Z]),he=((ue==null?void 0:ue.recent_ops)||[]).map(ve=>ga(ve,a)).filter(ve=>!!ve),_e=new Set(ne.map(ve=>ve.id));if(ne=[...ne,...he.filter(ve=>!_e.has(ve.id)&&(_e.add(ve.id),!0))],!U())return;d(ne.map(zt));const qe=new Set;for(const ve of Se){const Ue=(ve.id||ve.co||"").toString().trim().toLowerCase();Ue&&qe.add(Ue.startsWith("t:")?Ue:"t:"+Ue)}F(qe),w(ze),z(ie),ee&&da(de,{fund:ee.fund,marketEstimate:ee.marketEstimate,criteria:ee.criteria,stats:ee.stats,generatedAt:ee.generatedAt,objs:ne})}else{const Ne=Yo(),fe=Rn(),ce=Ia(),ge=await Ne;U()&&ge.length&&(d($a(ge).map(zt)),R(!1),T(!1));const[Z,ee]=await Promise.all([fe,ce]),ne=(Z||[]).map(ie=>Mn(ie,a)).filter(ie=>!!ie),ue=await On(ne,a),Se=((ee==null?void 0:ee.recent_ops)||[]).map(ie=>ga(ie,a)).filter(ie=>!!ie),ze=$a([...ge,...ue,...Se]);if(!U())return;d(ze.map(zt)),da(de,{objs:ze})}U()&&T(!1)}catch{U()&&!pe&&T(!0)}finally{U()&&R(!1)}})(),()=>{be=!1}},[s,o.token,a,_,c]),p.useEffect(()=>{if(!l.showCredits||!W){B(null);return}let X=!0;return(async()=>{try{const be=await fetch(`${gn}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:W})});if(!be.ok)return;const U=await be.json();X&&U&&U.ok!==!1&&B(U)}catch{}})(),()=>{X=!1}},[l.showCredits,W,$]);const Q=p.useCallback(X=>F(new Set(X)),[]);return{session:o,mode:i,caps:l,fund:x,email:W,marketEstimate:b,generatedAt:S,criteria:v,stats:f,thumbs:N,stages:E,dossiers:g,favIds:A,setFavIds:Q,credits:D,reloadCredits:()=>M(X=>X+1),loading:L,error:h,refresh:()=>J(X=>X+1)}}function He(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ba=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Na(e){return ba.has(e.engine||"")}function Ke(e){return!!e.noCo||Na(e)&&!!e.url}const Wr=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ys=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Wr(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),ws=new Set(["signal","amount","score","crible","memo"]);function ks(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Wr(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:ws.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Gr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Gr=80;function Ea(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Re(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(bn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ht(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Tt(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ea(e,a,r){return He(e)?Ea(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ea(e,a.filters,r)}function js(e,a,r,n){return!(!ea(e,a,r)||r&&!Qo(e,a.ptab,n))}function wn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-ht(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Xo(o);case"memo":return Jo(o);case"signal":{const i=Re(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const l=n(o),s=n(i);return l<s?-a.dir:l>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const Ua={},Kn=(Ua==null?void 0:Ua.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Qn(){return new Date().toISOString().slice(0,10)}const kn=p.createContext(null);function Yr(){return p.useContext(kn)}function Ns(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),l=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),s.querySelectorAll("*").forEach(c=>{const g=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(c.setAttribute("href",g),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Es(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),l=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(l);!s&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function Jn(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),l=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),l&&n.setAttribute("class",l),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function Xn(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${i} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${i} ${r[1]}`}function Kr(){const e=p.useContext(kn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ss({token:e,children:a}){const{dispatch:r,st:n,lang:o}=G(),[i,l]=p.useState(()=>n.filters.day||Qn()),[s,c]=p.useState(null),[g,d]=p.useState(!1),x=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){l(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{l(Qn());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=y=>{var j;const f=(j=y.detail)==null?void 0:j.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[x]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&l(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;d(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${Kn}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{v||c(f)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||d(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${Kn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:s,loading:g,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,g,x,u,n.filters.day,b,o]);return t.jsx(kn.Provider,{value:m,children:a})}function Cs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Kr(),[o,i]=p.useState(()=>n||Pr());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const l=s=>{var c;return i(!!((c=s.detail)!=null&&c.open))};return window.addEventListener(wa,l),()=>window.removeEventListener(wa,l)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Zo,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function zs(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Zn(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function er(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function As(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Kr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,c=a&&!a.ok,g=p.useRef(null),[d,x]=p.useState("fonds"),[u,b]=p.useState(null),[m,v]=p.useState("idle"),y=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),y.current=!1,x("fonds")},[e]),p.useEffect(()=>{if(d!=="jour"||y.current)return;y.current=!0;let E=!0;return v("load"),zs(e).then(z=>{E&&(b(z),v("fait"))}),()=>{E=!1}},[d,e]);const f=p.useMemo(()=>Es((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),j=p.useRef(null);p.useEffect(()=>{const E=j.current;if(!E||!f)return;let z=!1;return Qa(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(z||!E.isConnected)&&(S.beautifyEditoRows(E),S.mountCardFits(E))}),()=>{z=!0}},[f]);const N=p.useMemo(()=>Jn((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),w=p.useMemo(()=>Jn((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const E=g.current;if(!E||!N)return;let z=!1;return Qa(()=>import("./fit-BnaWm7z_.js"),[]).then(async S=>{await S.ensureEditoCss(),!(z||!E.isConnected)&&(S.beautifyEditoRows(E),S.mountCardFits(E))}),()=>{z=!0}},[N]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Zn(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Xn(e,!0)}),"."]}):Zn(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Xn(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&l&&N?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:N}}):null,d==="fonds"&&l&&w?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:w}}):null,d==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:j,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:er(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:er(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Ts=300,ca=7,qs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Qr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ls=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ha(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ni(r)&&r!=="media")return"news:"+r;const n=Re(e);return n?"sig:"+(n.theme&&Qr.fr[n.theme]?n.theme:"other"):"actualites"}function Fs(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:l,fund:s}=G(),c=Yr(),g=l==="en",[d,x]=p.useState("all"),[u,b]=p.useState(!1),m=p.useMemo(()=>{var be;const h=(a.filters.day||"").slice(0,10),T=U=>!(!i&&a.continent!=="monde"&&U.continent!==a.continent||h&&(U.date||"").slice(0,10)!==h),_=e.filter(U=>T(U)&&Re(U)&&(!i||U.kind!=="target"||Te(U)!==5)),J=i&&(((be=c==null?void 0:c.ed)==null?void 0:be.ops)||[]).length?c.ed.ops.map(U=>ga(U,l)).filter(U=>!!U).map(U=>(U.briefOnly=!0,U)).filter(U=>!h||(U.date||"").slice(0,10)===h):[],$=e.filter(U=>T(U)&&U.kind==="op"&&(h?!0:ht(U.date)<=ca)),M=i?J.length?J:$.filter(U=>{const de=(s||"").trim().toLowerCase();if(!de)return!1;const pe=U.match||null;return pe?Object.keys(pe).map(Ne=>Ne.trim().toLowerCase()).includes(de):!1}):$,K=h||new Date().toISOString().slice(0,10),W=U=>{const de=Ha(U);return de==="ma"?0:de==="levees"?1:2};M.sort((U,de)=>{const pe=W(U)-W(de);if(pe)return pe;const Ne=(U.date||"").slice(0,10)===K?0:1,fe=(de.date||"").slice(0,10)===K?0:1;return Ne!==fe?Ne-fe:(de.amountEur||0)-(U.amountEur||0)});const Q=new Set,X=[];for(const U of[...M,...wn(_,{key:"signal",dir:-1})]){const de=U.id||U.name;!de||Q.has(de)||(Q.add(de),X.push(U))}return i&&X.length===0?e.filter(de=>T(de)&&ht(de.date)<=ca).sort((de,pe)=>(pe.date||"").localeCompare(de.date||"")).slice(0,80):X},[e,a.continent,a.filters.day,i,s,l,c]),v=p.useMemo(()=>{const h={};for(const T of m){const _=Ha(T);h[_]=(h[_]||0)+1}return h},[m]),y=p.useMemo(()=>d==="all"?m:m.filter(h=>Ha(h)===d),[m,d]),f=p.useMemo(()=>y.slice(0,Ts),[y]),j=y.length-f.length,N=p.useRef(null);p.useEffect(()=>{var M,K;const h=N.current;if(!h)return;const T=()=>{const W=h.scrollWidth;W<200||(h.style.animationDuration=Math.max(18,Math.round(W/130))+"s")};T();const _=requestAnimationFrame(T),J=window.setTimeout(T,1200);let $=!0;return(K=(M=document.fonts)==null?void 0:M.ready)==null||K.then(()=>{$&&T()}),()=>{$=!1,cancelAnimationFrame(_),window.clearTimeout(J)}},[f.length,d]);const w=h=>h==="all"?m.length:v[h]||0,E=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return Qr[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const T=h.slice(5);return ti[T]?ai(T,g?"en":"fr"):h}return qs[g?"en":"fr"][h]},z=[{k:"all"}],S=["ma","levees"].filter(h=>w(h)>0||h===d);if(S.length){z.push({g:g?"Deals":"Opérations"});for(const h of S)z.push({k:h})}const q=["nominations","recrutements"].filter(h=>w(h)>0||h===d),A=ei.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>w(h)>0||h===d),F=w("actualites")>0||d==="actualites"?["actualites"]:[];if(q.length||A.length||F.length){z.push({g:g?"News":"Actualités"});for(const h of q)z.push({k:h});for(const h of A)z.push({k:h});for(const h of F)z.push({k:h})}const D=Ls.map(h=>"sig:"+h).filter(h=>w(h)>0||h===d);if(D.length){z.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of D)z.push({k:h})}const B=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},L=(()=>{const h=(a.filters.day||"").slice(0,10),T=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${B(h)}.`:`Le LIVE regroupe les événements du ${B(h)}.`)+T:(g?`LIVE covers the still-open signals and the deals of the last ${ca} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ca} derniers jours.`)+T})(),R=h=>f.map(T=>t.jsxs("button",{type:"button",className:"tk"+(De(T)?" spent":""),onClick:_=>{const J=T.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:J?"":T.id,name:T.name,url:T.url||"",text:T.tagline||T.headline||"",card:T.card}}))}catch{}if(J||n({type:"focus",id:T.id}),a.dens!=="liste"){const $=_.currentTarget.getBoundingClientRect();n({type:"popup",id:T.id,anchor:{x:$.left+$.width/2,y:$.bottom}})}},title:T.name+(T.tagline?" — "+T.tagline:""),children:[t.jsx(wt,{o:T}),t.jsxs("span",{className:"who",children:[t.jsx(To,{o:T}),t.jsx("span",{className:"co",children:T.name})]}),typeof T.amountEur=="number"&&T.amountEur>0&&t.jsx("span",{className:"am",children:sc(T.amountEur)}),T.sector&&t.jsx("span",{className:"mt",children:T.sector}),t.jsx(Ma,{o:T}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(T.id||T.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(h=>!h),children:[E(d),t.jsx("b",{children:w(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:L}),z.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===d,onClick:()=>{x(h.k),b(!1)},children:[E(h.k),t.jsx("b",{children:w(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:N,children:[R(0),R(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(Ms,{isEn:g})]})}const Rs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Ms({isEn:e}){const[a,r]=p.useState(()=>Pr());p.useEffect(()=>{const o=i=>{var l;return r(!!((l=i.detail)!=null&&l.open))};return window.addEventListener(wa,o),()=>window.removeEventListener(wa,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ri(!a),children:Rs})}const jn="+33 6 83 10 72 86",Sa="alexandre@proplace.co",Jr=`tel:${jn.replace(/[^\d+]/g,"")}`;function Os(){return null}class st extends p.Component{constructor(){super(...arguments);qn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Xr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function tr(e,a){if((kt(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Xr.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const ar=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",Ds={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function Is({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:l}=G(),[s,c]=p.useState(""),[g,d]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!x)return;const j=N=>{b.current&&!b.current.contains(N.target)&&(u(!1),d(!1))};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),v=async j=>{if(s)return;if(j==="Analysé"&&!e.memoUrl){d(!0);return}c(j);const N=(tr(e,a).find(([E])=>E===j)||[j,j])[1],w=await o(e,j,{msg:a.csMoved(e.name,N)});c(""),w&&(d(!1),u(!1))},y=tr(e,a),f=j=>(y.find(([N])=>N===j)||[])[1]||j;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:j=>j.stopPropagation(),children:y.map(([j,N])=>t.jsx("button",{type:"button",className:"rsd "+(j==="Validé"?"yes":"no")+(s===j?" busy":""),disabled:!!s,onClick:()=>{v(j)},children:N},j))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:j=>j.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!s,title:a.csLabel,className:"rsel rs-"+ar(m),onClick:()=>{u(j=>!j),d(!1)},children:s?f(s)+"…":m?f(m):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([j,N])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===j,className:"rsopt"+(m===j?" on":"")+(s===j?" busy":""),disabled:!!s,onClick:()=>{if(j===m){u(!1);return}v(j)},children:[t.jsx("i",{className:"pt2",style:{background:Ds[ar(j)]}}),N]},j))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{i(e),d(!1),u(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const j=await o(e,"Analysé");c(""),j&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function Ps({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=G(),[i,l]=p.useState(""),[s,c]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(kt(e)||"").startsWith("CALL")&&Te(e)===3,x=Te(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(m);const v=await o(e,m);l(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:Xr.filter(([m])=>!(x&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:v},m)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Bs,{o:e})]})}function Bs({o:e}){const{t:a,saveNote:r,flash:n}=G(),[o,i]=p.useState(e.ceoNote||""),[l,s]=p.useState(!1),[c,g]=p.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!d)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:l,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{x()},children:c?a.csNoteSaved:a.csNoteOk})]})}function _s({placeholder:e,onDone:a}){const{t:r}=G(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function $s({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:l,flashErr:s}=G(),[c,g]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const d=i(e),x=(d==null?void 0:d.stage)||"todo",u=async f=>{if(c||f===x)return;g(!0);const j=d;l(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const N=Math.max(Date.now(),nr+=1);nr=N;const w=await oi(r,{company:e.name||"",stage:f,cts:N,deal_id:e.airtableId,check_id:e.checkId});g(!1),!w.stale&&(w.ok||(l(e,j),s(a.actErr)))},b=(y=d==null?void 0:d.stamps)==null?void 0:y.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,j])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:c,onClick:()=>{u(f)},children:j},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let nr=0;const Wt=8,yt=360;function rr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function or({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(rr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(rr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function Us({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=G(),[l,s]=p.useState(0),[c,g]=p.useState(null),[d,x]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const S=b.current;return()=>{m.current||(n({type:"ptab",tab:S.ptab}),n({type:"dens",dens:S.dens}),n({type:"modal",modal:S.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,x(e.filter(S=>!!document.querySelector(S.need||S.sel))))},[e]);const v=d[l],y=l>=d.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const S=v.click,q=window.setTimeout(()=>{const A=document.querySelector(S);A&&A.getAttribute("aria-selected")!=="true"&&A.click()},60);return()=>window.clearTimeout(q)}},[l,v]);const f=p.useRef(-1),j=p.useCallback(()=>{if(!v){g(null);return}const S=F=>{if(!F)return null;for(const D of document.querySelectorAll(F)){const B=D.getBoundingClientRect();if(B.width>1&&B.height>1)return D}return null},q=S(v.sel)||S(v.need);if(!q){g(null);return}f.current!==l&&(f.current=l,q.scrollIntoView({block:"nearest",behavior:"smooth"}));const A=q.getBoundingClientRect();g(F=>F&&Math.abs(F.top-A.top)<1&&Math.abs(F.left-A.left)<1&&Math.abs(F.width-A.width)<1&&Math.abs(F.height-A.height)<1?F:A)},[v,l]);p.useLayoutEffect(()=>{j();const S=[90,300,700,1300].map(F=>window.setTimeout(j,F)),q=window.setInterval(j,400),A=()=>j();return window.addEventListener("scroll",A,!0),window.addEventListener("resize",A),()=>{S.forEach(F=>window.clearTimeout(F)),window.clearInterval(q),window.removeEventListener("scroll",A,!0),window.removeEventListener("resize",A)}},[j]);const N=p.useRef(a);if(N.current=a,p.useEffect(()=>{const S=q=>{q.key==="Escape"?(q.preventDefault(),q.stopPropagation(),N.current()):q.key==="ArrowRight"?s(A=>A+1):q.key==="ArrowLeft"&&s(A=>Math.max(0,A-1))};return document.addEventListener("keydown",S,!0),()=>document.removeEventListener("keydown",S,!0)},[]),!d.length)return null;let w=null;const E=S=>()=>{m.current=!0,n({type:"modal",modal:null}),S()};if(y){const S=o[3]||0;S>0?w={title:S===1?r.ahaATitle1:r.ahaATitleN(S),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?w={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?w={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let z={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:yt};if(!y&&c){const S=c.bottom+14,q=window.innerHeight-S;let A=q>190?S:Math.max(12,c.top-200),F=Math.min(Math.max(12,c.left+c.width/2-yt/2),window.innerWidth-yt-12);q<=190&&c.top<212&&(window.innerWidth-c.right>=yt+40?F=Math.min(c.right+26,window.innerWidth-yt-12):c.left>=yt+40&&(F=Math.max(12,c.left-yt-26)),A=Math.max(12,c.top-Wt)),z={left:F,top:A,width:yt}}return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Wt,top:c.top-Wt,width:c.width+Wt*2,height:c.height+Wt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:z,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(or,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(or,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(S=>Math.max(0,S-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(S=>S+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Zr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function eo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Hs(){var q,A;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:l,data:s,dispatch:c}=G(),g=r?a:e,d=p.useMemo(()=>g.filter(F=>ht(F.date)===0&&F.kind==="target"),[g]),x=p.useMemo(()=>r?a.filter(F=>F.kind==="target"&&Te(F)===0).slice().sort((F,D)=>(D.date||"").localeCompare(F.date||"")):[],[a,r]),u=p.useMemo(()=>d.filter(F=>r?Te(F)===0:!De(F)),[d,r]),b=r?x:u,m=r?a.length-x.length:d.length-u.length,v=r?a.length:d.length,y=v?Math.min(100,m/v*100):100,f=p.useMemo(()=>Zr(g),[g]),j=!!f&&ht(f)>0,N=p.useMemo(()=>j?g.filter(F=>(F.date||"").slice(0,10)===f):[],[g,f,j]),w=typeof((q=s.stats)==null?void 0:q.kept_today)=="number"?s.stats.kept_today:null,E=typeof((A=s.stats)==null?void 0:A.screened_today)=="number"?s.stats.screened_today:d.length;let z;j?z=o.morningLast(N.length,x.length,eo(f,l)):r?z=o.morningThesis(E,x.length,w):d.length?m===0?z=o.goalSourced(d.length):m>=d.length?z=o.goalCleared:z=o.goalDone(m,d.length):z=o.goalSourced(0);const S=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&x.length&&c({type:"chainStart",queue:x.map(F=>F.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:z}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:S,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Vs(){var _,J;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:l,dossiers:s,mode:c,doSync:g,startTour:d,flash:x,flashErr:u}=G(),[b,m]=p.useState(null),[v,y]=p.useState(!0),[f,j]=p.useState([]),N=c==="client";p.useEffect(()=>{if(!o||!i)return;let $=!0;return y(!0),(async()=>{const[M,K]=await Promise.all([vn(i),Br(o)]);$&&(M&&m(M),y(!1),j(K))})(),()=>{$=!1}},[o,i]);const[w,E]=p.useState(!1),z=()=>{!N||w||!i||(E(!0),ii(i).then($=>{E(!1),$?x(e.identRepubDone):u(e.actErr)}))},S=(b==null?void 0:b.per_day)??null,q=((_=b==null?void 0:b.pool_order)==null?void 0:_.length)??0,A=f.filter($=>$.status==="running").length,F=p.useMemo(()=>s.filter($=>$.kind==="target"&&De($)).length,[s]),D=l.marketEstimate,B=typeof((J=l.stats)==null?void 0:J.screened)=="number"?l.stats.screened:F,L=D&&D>0?Math.min(100,Math.round(B/D*100)):null,R=$=>$.toLocaleString(a==="en"?"en-US":"fr-FR"),h=(i||"P").split(/\s+/).map($=>$[0]).join("").slice(0,2).toUpperCase(),T=(()=>{const $=Date.parse(l.generatedAt||"");if(Number.isNaN($))return"";const M=new Date($),K=W=>String(W).padStart(2,"0");return`${K(M.getDate())}/${K(M.getMonth()+1)} à ${K(M.getHours())}:${K(M.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),T?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(T)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&B>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:R(B)})})]}),L!==null&&D&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(B,D)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),S!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:S})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),S===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),A>0&&t.jsxs("span",{className:"ev",children:["⏳ ",A]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(q)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:$=>{$.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!N||w,onClick:z,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!N,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:$=>n({type:"filters",patch:{search:$.target.value}})})]})]})]})}class Lt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],l=a+i,s=Math.abs(a)<Math.abs(i)?a-(l-i):i-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,o=a[--r],l=n+o,i=o-(l-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=l+o,o==n-l&&(l=n))}return l}}function*Ws(e){for(const a of e)yield*a}function to(e){return Array.from(Ws(e))}var Ee=1e-6,me=Math.PI,et=me/2,ir=me/4,at=me*2,mt=180/me,Qe=me/180,Ae=Math.abs,Gs=Math.atan,ta=Math.atan2,Le=Math.cos,Fe=Math.sin,Ys=Math.sign||function(e){return e>0?1:e<0?-1:0},Rt=Math.sqrt;function Ks(e){return e>1?0:e<-1?me:Math.acos(e)}function aa(e){return e>1?et:e<-1?-et:Math.asin(e)}function tt(){}function Ca(e,a){e&&lr.hasOwnProperty(e.type)&&lr[e.type](e,a)}var sr={Feature:function(e,a){Ca(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ca(r[n].geometry,a)}},lr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){tn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)tn(r[n],a,0)},Polygon:function(e,a){dr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)dr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ca(r[n],a)}};function tn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function dr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)tn(e[r],a,1);a.polygonEnd()}function Mt(e,a){e&&sr.hasOwnProperty(e.type)?sr[e.type](e,a):Ca(e,a)}function an(e){return[ta(e[1],e[0]),aa(e[2])]}function Pt(e){var a=e[0],r=e[1],n=Le(r);return[n*Le(a),n*Fe(a),Fe(r)]}function pa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function za(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Va(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ua(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function nn(e){var a=Rt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function rn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function on(e,a){return Ae(e)>me&&(e-=Math.round(e/at)*at),[e,a]}on.invert=on;function Qs(e,a,r){return(e%=at)?a||r?rn(pr(e),ur(a,r)):pr(e):a||r?ur(a,r):on}function cr(e){return function(a,r){return a+=e,Ae(a)>me&&(a-=Math.round(a/at)*at),[a,r]}}function pr(e){var a=cr(e);return a.invert=cr(-e),a}function ur(e,a){var r=Le(e),n=Fe(e),o=Le(a),i=Fe(a);function l(s,c){var g=Le(c),d=Le(s)*g,x=Fe(s)*g,u=Fe(c),b=u*r+d*n;return[ta(x*o-b*i,d*r-u*n),aa(b*o+x*i)]}return l.invert=function(s,c){var g=Le(c),d=Le(s)*g,x=Fe(s)*g,u=Fe(c),b=u*o-x*i;return[ta(x*o+u*i,d*r+b*n),aa(b*r-d*n)]},l}function Js(e,a,r,n,o,i){if(r){var l=Le(a),s=Fe(a),c=n*r;o==null?(o=a+n*at,i=a-c/2):(o=mr(l,o),i=mr(l,i),(n>0?o<i:o>i)&&(o+=n*at));for(var g,d=o;n>0?d>i:d<i;d-=c)g=an([l,-s*Le(d),-s*Fe(d)]),e.point(g[0],g[1])}}function mr(e,a){a=Pt(a),a[0]-=e,nn(a);var r=Ks(-a[1]);return((-a[2]<0?-r:r)+at-Ee)%at}function ao(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:tt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function va(e,a){return Ae(e[0]-a[0])<Ee&&Ae(e[1]-a[1])<Ee}function ma(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function no(e,a,r,n,o){var i=[],l=[],s,c;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,y=m[0],f=m[v],j;if(va(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),s=0;s<v;++s)o.point((y=m[s])[0],y[1]);o.lineEnd();return}f[0]+=2*Ee}i.push(j=new ma(y,m,null,!0)),l.push(j.o=new ma(y,null,j,!1)),i.push(j=new ma(f,m,null,!1)),l.push(j.o=new ma(f,null,j,!0))}}),!!i.length){for(l.sort(a),fr(i),fr(l),s=0,c=l.length;s<c;++s)l[s].e=r=!r;for(var g=i[0],d,x;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;d=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,c=d.length;s<c;++s)o.point((x=d[s])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)o.point((x=d[s])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);o.lineEnd()}}}function fr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Wa(e){return Ae(e[0])<=me?e[0]:Ys(e[0])*((Ae(e[0])+me)%at-me)}function Xs(e,a){var r=Wa(a),n=a[1],o=Fe(n),i=[Fe(r),-Le(r),0],l=0,s=0,c=new Lt;o===1?n=et+Ee:o===-1&&(n=-et-Ee);for(var g=0,d=e.length;g<d;++g)if(u=(x=e[g]).length)for(var x,u,b=x[u-1],m=Wa(b),v=b[1]/2+ir,y=Fe(v),f=Le(v),j=0;j<u;++j,m=w,y=z,f=S,b=N){var N=x[j],w=Wa(N),E=N[1]/2+ir,z=Fe(E),S=Le(E),q=w-m,A=q>=0?1:-1,F=A*q,D=F>me,B=y*z;if(c.add(ta(B*A*Fe(F),f*S+B*Le(F))),l+=D?q+A*at:q,D^m>=r^w>=r){var L=za(Pt(b),Pt(N));nn(L);var R=za(i,L);nn(R);var h=(D^q>=0?-1:1)*aa(R[2]);(n>h||n===h&&(L[0]||L[1]))&&(s+=D^q>=0?1:-1)}}return(l<-Ee||l<Ee&&c<-1e-12)^s&1}function ro(e,a,r,n){return function(o){var i=a(o),l=ao(),s=a(l),c=!1,g,d,x,u={point:b,lineStart:v,lineEnd:y,polygonStart:function(){u.point=f,u.lineStart=j,u.lineEnd=N,d=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=y,d=to(d);var w=Xs(g,n);d.length?(c||(o.polygonStart(),c=!0),no(d,el,w,r,o)):w&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),d=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(w,E){e(w,E)&&o.point(w,E)}function m(w,E){i.point(w,E)}function v(){u.point=m,i.lineStart()}function y(){u.point=b,i.lineEnd()}function f(w,E){x.push([w,E]),s.point(w,E)}function j(){s.lineStart(),x=[]}function N(){f(x[0][0],x[0][1]),s.lineEnd();var w=s.clean(),E=l.result(),z,S=E.length,q,A,F;if(x.pop(),g.push(x),x=null,!!S){if(w&1){if(A=E[0],(q=A.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),z=0;z<q;++z)o.point((F=A[z])[0],F[1]);o.lineEnd()}return}S>1&&w&2&&E.push(E.pop().concat(E.shift())),d.push(E.filter(Zs))}}return u}}function Zs(e){return e.length>1}function el(e,a){return((e=e.x)[0]<0?e[1]-et-Ee:et-e[1])-((a=a.x)[0]<0?a[1]-et-Ee:et-a[1])}const hr=ro(function(){return!0},tl,nl,[-me,-et]);function tl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,l){var s=i>0?me:-me,c=Ae(i-a);Ae(c-me)<Ee?(e.point(a,r=(r+l)/2>0?et:-et),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&c>=me&&(Ae(a-n)<Ee&&(a-=n*Ee),Ae(i-s)<Ee&&(i-=s*Ee),r=al(a,r,i,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function al(e,a,r,n){var o,i,l=Fe(e-r);return Ae(l)>Ee?Gs((Fe(a)*(i=Le(n))*Fe(r)-Fe(n)*(o=Le(a))*Fe(e))/(o*i*l)):(a+n)/2}function nl(e,a,r,n){var o;if(e==null)o=r*et,n.point(-me,o),n.point(0,o),n.point(me,o),n.point(me,0),n.point(me,-o),n.point(0,-o),n.point(-me,-o),n.point(-me,0),n.point(-me,o);else if(Ae(e[0]-a[0])>Ee){var i=e[0]<a[0]?me:-me;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function rl(e){var a=Le(e),r=2*Qe,n=a>0,o=Ae(a)>Ee;function i(d,x,u,b){Js(b,e,r,u,d,x)}function l(d,x){return Le(d)*Le(x)>a}function s(d){var x,u,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(y,f){var j=[y,f],N,w=l(y,f),E=n?w?0:g(y,f):w?g(y+(y<0?me:-me),f):0;if(!x&&(m=b=w)&&d.lineStart(),w!==b&&(N=c(x,j),(!N||va(x,N)||va(j,N))&&(j[2]=1)),w!==b)v=0,w?(d.lineStart(),N=c(j,x),d.point(N[0],N[1])):(N=c(x,j),d.point(N[0],N[1],2),d.lineEnd()),x=N;else if(o&&x&&n^w){var z;!(E&u)&&(z=c(j,x,!0))&&(v=0,n?(d.lineStart(),d.point(z[0][0],z[0][1]),d.point(z[1][0],z[1][1]),d.lineEnd()):(d.point(z[1][0],z[1][1]),d.lineEnd(),d.lineStart(),d.point(z[0][0],z[0][1],3)))}w&&(!x||!va(x,j))&&d.point(j[0],j[1]),x=j,b=w,u=E},lineEnd:function(){b&&d.lineEnd(),x=null},clean:function(){return v|(m&&b)<<1}}}function c(d,x,u){var b=Pt(d),m=Pt(x),v=[1,0,0],y=za(b,m),f=pa(y,y),j=y[0],N=f-j*j;if(!N)return!u&&d;var w=a*f/N,E=-a*j/N,z=za(v,y),S=ua(v,w),q=ua(y,E);Va(S,q);var A=z,F=pa(S,A),D=pa(A,A),B=F*F-D*(pa(S,S)-1);if(!(B<0)){var L=Rt(B),R=ua(A,(-F-L)/D);if(Va(R,S),R=an(R),!u)return R;var h=d[0],T=x[0],_=d[1],J=x[1],$;T<h&&($=h,h=T,T=$);var M=T-h,K=Ae(M-me)<Ee,W=K||M<Ee;if(!K&&J<_&&($=_,_=J,J=$),W?K?_+J>0^R[1]<(Ae(R[0]-h)<Ee?_:J):_<=R[1]&&R[1]<=J:M>me^(h<=R[0]&&R[0]<=T)){var Q=ua(A,(-F+L)/D);return Va(Q,S),[R,an(Q)]}}}function g(d,x){var u=n?e:me-e,b=0;return d<-u?b|=1:d>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return ro(l,s,i,n?[0,-e]:[-me,e-me])}function ol(e,a,r,n,o,i){var l=e[0],s=e[1],c=a[0],g=a[1],d=0,x=1,u=c-l,b=g-s,m;if(m=r-l,!(!u&&m>0)){if(m/=u,u<0){if(m<d)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>d&&(d=m)}if(m=o-l,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>d&&(d=m)}else if(u>0){if(m<d)return;m<x&&(x=m)}if(m=n-s,!(!b&&m>0)){if(m/=b,b<0){if(m<d)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>d&&(d=m)}if(m=i-s,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>d&&(d=m)}else if(b>0){if(m<d)return;m<x&&(x=m)}return d>0&&(e[0]=l+d*u,e[1]=s+d*b),x<1&&(a[0]=l+x*u,a[1]=s+x*b),!0}}}}}var Gt=1e9,fa=-Gt;function il(e,a,r,n){function o(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function i(g,d,x,u){var b=0,m=0;if(g==null||(b=l(g,x))!==(m=l(d,x))||c(g,d)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(d[0],d[1])}function l(g,d){return Ae(g[0]-e)<Ee?d>0?0:3:Ae(g[0]-r)<Ee?d>0?2:1:Ae(g[1]-a)<Ee?d>0?1:0:d>0?3:2}function s(g,d){return c(g.x,d.x)}function c(g,d){var x=l(g,1),u=l(d,1);return x!==u?x-u:x===0?d[1]-g[1]:x===1?g[0]-d[0]:x===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,x=ao(),u,b,m,v,y,f,j,N,w,E,z,S={point:q,lineStart:B,lineEnd:L,polygonStart:F,polygonEnd:D};function q(h,T){o(h,T)&&d.point(h,T)}function A(){for(var h=0,T=0,_=b.length;T<_;++T)for(var J=b[T],$=1,M=J.length,K=J[0],W,Q,X=K[0],be=K[1];$<M;++$)W=X,Q=be,K=J[$],X=K[0],be=K[1],Q<=n?be>n&&(X-W)*(n-Q)>(be-Q)*(e-W)&&++h:be<=n&&(X-W)*(n-Q)<(be-Q)*(e-W)&&--h;return h}function F(){d=x,u=[],b=[],z=!0}function D(){var h=A(),T=z&&h,_=(u=to(u)).length;(T||_)&&(g.polygonStart(),T&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),_&&no(u,s,h,i,g),g.polygonEnd()),d=g,u=b=m=null}function B(){S.point=R,b&&b.push(m=[]),E=!0,w=!1,j=N=NaN}function L(){u&&(R(v,y),f&&w&&x.rejoin(),u.push(x.result())),S.point=q,w&&d.lineEnd()}function R(h,T){var _=o(h,T);if(b&&m.push([h,T]),E)v=h,y=T,f=_,E=!1,_&&(d.lineStart(),d.point(h,T));else if(_&&w)d.point(h,T);else{var J=[j=Math.max(fa,Math.min(Gt,j)),N=Math.max(fa,Math.min(Gt,N))],$=[h=Math.max(fa,Math.min(Gt,h)),T=Math.max(fa,Math.min(Gt,T))];ol(J,$,e,a,r,n)?(w||(d.lineStart(),d.point(J[0],J[1])),d.point($[0],$[1]),_||d.lineEnd(),z=!1):_&&(d.lineStart(),d.point(h,T),z=!1)}j=h,N=T,w=_}return S}}const sn=e=>e;var Ga=new Lt,ln=new Lt,oo,io,dn,cn,ft={point:tt,lineStart:tt,lineEnd:tt,polygonStart:function(){ft.lineStart=sl,ft.lineEnd=dl},polygonEnd:function(){ft.lineStart=ft.lineEnd=ft.point=tt,Ga.add(Ae(ln)),ln=new Lt},result:function(){var e=Ga/2;return Ga=new Lt,e}};function sl(){ft.point=ll}function ll(e,a){ft.point=so,oo=dn=e,io=cn=a}function so(e,a){ln.add(cn*e-dn*a),dn=e,cn=a}function dl(){so(oo,io)}var Bt=1/0,Aa=Bt,na=-Bt,Ta=na,qa={point:cl,lineStart:tt,lineEnd:tt,polygonStart:tt,polygonEnd:tt,result:function(){var e=[[Bt,Aa],[na,Ta]];return na=Ta=-(Aa=Bt=1/0),e}};function cl(e,a){e<Bt&&(Bt=e),e>na&&(na=e),a<Aa&&(Aa=a),a>Ta&&(Ta=a)}var pn=0,un=0,Yt=0,La=0,Fa=0,Ot=0,mn=0,fn=0,Kt=0,lo,co,pt,ut,Ze={point:Ft,lineStart:xr,lineEnd:gr,polygonStart:function(){Ze.lineStart=ml,Ze.lineEnd=fl},polygonEnd:function(){Ze.point=Ft,Ze.lineStart=xr,Ze.lineEnd=gr},result:function(){var e=Kt?[mn/Kt,fn/Kt]:Ot?[La/Ot,Fa/Ot]:Yt?[pn/Yt,un/Yt]:[NaN,NaN];return pn=un=Yt=La=Fa=Ot=mn=fn=Kt=0,e}};function Ft(e,a){pn+=e,un+=a,++Yt}function xr(){Ze.point=pl}function pl(e,a){Ze.point=ul,Ft(pt=e,ut=a)}function ul(e,a){var r=e-pt,n=a-ut,o=Rt(r*r+n*n);La+=o*(pt+e)/2,Fa+=o*(ut+a)/2,Ot+=o,Ft(pt=e,ut=a)}function gr(){Ze.point=Ft}function ml(){Ze.point=hl}function fl(){po(lo,co)}function hl(e,a){Ze.point=po,Ft(lo=pt=e,co=ut=a)}function po(e,a){var r=e-pt,n=a-ut,o=Rt(r*r+n*n);La+=o*(pt+e)/2,Fa+=o*(ut+a)/2,Ot+=o,o=ut*e-pt*a,mn+=o*(pt+e),fn+=o*(ut+a),Kt+=o*3,Ft(pt=e,ut=a)}function uo(e){this._context=e}uo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,at);break}}},result:tt};var hn=new Lt,Ya,mo,fo,Qt,Jt,ra={point:tt,lineStart:function(){ra.point=xl},lineEnd:function(){Ya&&ho(mo,fo),ra.point=tt},polygonStart:function(){Ya=!0},polygonEnd:function(){Ya=null},result:function(){var e=+hn;return hn=new Lt,e}};function xl(e,a){ra.point=ho,mo=Qt=e,fo=Jt=a}function ho(e,a){Qt-=e,Jt-=a,hn.add(Rt(Qt*Qt+Jt*Jt)),Qt=e,Jt=a}let br,Ra,vr,yr;class wr{constructor(a){this._append=a==null?xo:gl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==vr||this._append!==Ra){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,vr=n,Ra=this._append,yr=this._,this._=o}this._+=yr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function xo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function gl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return xo;if(a!==br){const r=10**a;br=a,Ra=function(o){let i=1;this._+=o[0];for(const l=o.length;i<l;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ra}function bl(e,a){let r=3,n=4.5,o,i;function l(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Mt(s,o(i))),i.result()}return l.area=function(s){return Mt(s,o(ft)),ft.result()},l.measure=function(s){return Mt(s,o(ra)),ra.result()},l.bounds=function(s){return Mt(s,o(qa)),qa.result()},l.centroid=function(s){return Mt(s,o(Ze)),Ze.result()},l.projection=function(s){return arguments.length?(o=s==null?(e=null,sn):(e=s).stream,l):e},l.context=function(s){return arguments.length?(i=s==null?(a=null,new wr(r)):new uo(a=s),typeof n!="function"&&i.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const c=Math.floor(s);if(!(c>=0))throw new RangeError(`invalid digits: ${s}`);r=c}return a===null&&(i=new wr(r)),l},l.projection(e).digits(r).context(a)}function Nn(e){return function(a){var r=new xn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function xn(){}xn.prototype={constructor:xn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function En(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Mt(r,e.stream(qa)),a(qa.result()),n!=null&&e.clipExtent(n),e}function go(e,a,r){return En(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],l=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-l*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,c])},r)}function vl(e,a,r){return go(e,[[0,0],a],r)}function yl(e,a,r){return En(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),l=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([l,s])},r)}function wl(e,a,r){return En(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),l=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([l,s])},r)}var kr=16,kl=Le(30*Qe);function jr(e,a){return+a?Nl(e,a):jl(e)}function jl(e){return Nn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Nl(e,a){function r(n,o,i,l,s,c,g,d,x,u,b,m,v,y){var f=g-n,j=d-o,N=f*f+j*j;if(N>4*a&&v--){var w=l+u,E=s+b,z=c+m,S=Rt(w*w+E*E+z*z),q=aa(z/=S),A=Ae(Ae(z)-1)<Ee||Ae(i-x)<Ee?(i+x)/2:ta(E,w),F=e(A,q),D=F[0],B=F[1],L=D-n,R=B-o,h=j*L-f*R;(h*h/N>a||Ae((f*L+j*R)/N-.5)>.3||l*u+s*b+c*m<kl)&&(r(n,o,i,l,s,c,D,B,A,w/=S,E/=S,z,v,y),y.point(D,B),r(D,B,A,w,E,z,g,d,x,u,b,m,v,y))}}return function(n){var o,i,l,s,c,g,d,x,u,b,m,v,y={point:f,lineStart:j,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=E},polygonEnd:function(){n.polygonEnd(),y.lineStart=j}};function f(q,A){q=e(q,A),n.point(q[0],q[1])}function j(){x=NaN,y.point=N,n.lineStart()}function N(q,A){var F=Pt([q,A]),D=e(q,A);r(x,u,d,b,m,v,x=D[0],u=D[1],d=q,b=F[0],m=F[1],v=F[2],kr,n),n.point(x,u)}function w(){y.point=f,n.lineEnd()}function E(){j(),y.point=z,y.lineEnd=S}function z(q,A){N(o=q,A),i=x,l=u,s=b,c=m,g=v,y.point=N}function S(){r(x,u,d,b,m,v,i,l,o,s,c,g,kr,n),y.lineEnd=w,w()}return y}}var El=Nn({point:function(e,a){this.stream.point(e*Qe,a*Qe)}});function Sl(e){return Nn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Cl(e,a,r,n,o){function i(l,s){return l*=n,s*=o,[a+e*l,r-e*s]}return i.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*o]},i}function Nr(e,a,r,n,o,i){if(!i)return Cl(e,a,r,n,o);var l=Le(i),s=Fe(i),c=l*e,g=s*e,d=l/e,x=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function m(v,y){return v*=n,y*=o,[c*v-g*y+a,r-g*v-c*y]}return m.invert=function(v,y){return[n*(d*v-x*y+u),o*(b-x*v-d*y)]},m}function zl(e){return Al(function(){return e})()}function Al(e){var a,r=150,n=480,o=250,i=0,l=0,s=0,c=0,g=0,d,x=0,u=1,b=1,m=null,v=hr,y=null,f,j,N,w=sn,E=.5,z,S,q,A,F;function D(h){return q(h[0]*Qe,h[1]*Qe)}function B(h){return h=q.invert(h[0],h[1]),h&&[h[0]*mt,h[1]*mt]}D.stream=function(h){return A&&F===h?A:A=El(Sl(d)(v(z(w(F=h)))))},D.preclip=function(h){return arguments.length?(v=h,m=void 0,R()):v},D.postclip=function(h){return arguments.length?(w=h,y=f=j=N=null,R()):w},D.clipAngle=function(h){return arguments.length?(v=+h?rl(m=h*Qe):(m=null,hr),R()):m*mt},D.clipExtent=function(h){return arguments.length?(w=h==null?(y=f=j=N=null,sn):il(y=+h[0][0],f=+h[0][1],j=+h[1][0],N=+h[1][1]),R()):y==null?null:[[y,f],[j,N]]},D.scale=function(h){return arguments.length?(r=+h,L()):r},D.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],L()):[n,o]},D.center=function(h){return arguments.length?(i=h[0]%360*Qe,l=h[1]%360*Qe,L()):[i*mt,l*mt]},D.rotate=function(h){return arguments.length?(s=h[0]%360*Qe,c=h[1]%360*Qe,g=h.length>2?h[2]%360*Qe:0,L()):[s*mt,c*mt,g*mt]},D.angle=function(h){return arguments.length?(x=h%360*Qe,L()):x*mt},D.reflectX=function(h){return arguments.length?(u=h?-1:1,L()):u<0},D.reflectY=function(h){return arguments.length?(b=h?-1:1,L()):b<0},D.precision=function(h){return arguments.length?(z=jr(S,E=h*h),R()):Rt(E)},D.fitExtent=function(h,T){return go(D,h,T)},D.fitSize=function(h,T){return vl(D,h,T)},D.fitWidth=function(h,T){return yl(D,h,T)},D.fitHeight=function(h,T){return wl(D,h,T)};function L(){var h=Nr(r,0,0,u,b,x).apply(null,a(i,l)),T=Nr(r,n-h[0],o-h[1],u,b,x);return d=Qs(s,c,g),S=rn(a,T),q=rn(d,S),z=jr(S,E),R()}function R(){return A=F=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&B,L()}}function bo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}bo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,l=i*i;r-=o=(r*(1.007226+i*(.015085+l*(-.044475+.028874*i-.005916*l)))-a)/(1.007226+i*(.015085*3+l*(-.044475*7+.028874*9*i-.005916*11*l)))}while(Ae(o)>Ee&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Tl(){return zl(bo).scale(175.295)}function ql(e){return e}function Ll(e){if(e==null)return ql;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],l=e.translate[1];return function(s,c){c||(a=r=0);var g=2,d=s.length,x=new Array(d);for(x[0]=(a+=s[0])*n+i,x[1]=(r+=s[1])*o+l;g<d;)x[g]=s[g],++g;return x}}function Fl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Rl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Er(e,r)})}:Er(e,a)}function Er(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Ml(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Ml(e,a){var r=Ll(e.transform),n=e.arcs;function o(d,x){x.length&&x.pop();for(var u=n[d<0?~d:d],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));d<0&&Fl(x,m)}function i(d){return r(d)}function l(d){for(var x=[],u=0,b=d.length;u<b;++u)o(d[u],x);return x.length<2&&x.push(x[0]),x}function s(d){for(var x=l(d);x.length<4;)x.push(x[0]);return x}function c(d){return d.map(s)}function g(d){var x=d.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:d.geometries.map(g)};case"Point":u=i(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(i);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:x,coordinates:u}}return g(a)}const vo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},Ol=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Dl(e,a,r){const n=vo[e];if(!n||!n.length)return-1;const o=Ol(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(l=>o.includes(l)))return i}return Math.floor(r*n.length)%n.length}let ha=null;function Il(){return ha||(ha=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Rl(r,n),i=Tl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=bl(i),s=(o.features||[]).filter(d=>{var x;return(((x=d.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(d=>{var b;const x=((b=d.properties)==null?void 0:b.name)||"",u=l(d)||"";return u?{i2:si(x)||null,n:x,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const c={};for(const[d,x]of Object.entries(li)){const u=i(x);u&&(c[d]={x:u[0],y:u[1]})}const g={};for(const[d,x]of Object.entries(vo)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:c,metros:g}}catch{return null}})(),ha)}function Pl(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return Il().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const Bl="8 40 984 210",_l={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Sr=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Cr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function $l(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const l=()=>{var g;if(!o)return;const c=(g=e.current)==null?void 0:g.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function zr({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],l)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Ul(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:l,lang:s,t:c,data:g,dossiers:d,source:x}=G(),u=g.loading&&!d.length,b=p.useRef(null),m=p.useRef(null),v=Pl(e.continent==="monde"),y=e.continent==="monde"?v:yn.find(h=>h.key===e.continent)||null,f=$l(b,e.continent+":"+e.mapFolded+":"+!!y),[j,N]=p.useState(new Map),[w,E]=p.useState(null);p.useEffect(()=>{const h=b.current;if(!h)return;const T=new Map;h.querySelectorAll("path[data-i2]").forEach(_=>{const J=_.dataset.i2;if(J)try{const $=_.getBBox();$.width>0&&T.set(J,{x:$.x,y:$.y,w:$.width,h:$.height})}catch{}}),N(T)},[e.continent,f,y]);const z=p.useMemo(()=>r.filter(h=>h.cc),[r]),S=p.useMemo(()=>{const h=new Map;return z.forEach(T=>h.set(T.cc,(h.get(T.cc)||0)+1)),h},[z]),q=e.continent==="monde"&&v?v.anchors:null,A=e.continent==="monde"&&v?v.metros:null,F=p.useMemo(()=>z.map(h=>{const T=Cr(h.name||h.id||""),_=Cr((h.id||h.name||"")+"·y");if(q&&h.cc){const W=A?A[h.cc]:void 0;if(W&&W.length){const X=Dl(h.cc,h.city,T);if(X>=0&&W[X])return{d:h,x:W[X].x+(T-.5)*5,y:W[X].y+(_-.5)*5}}const Q=q[h.cc];if(Q)return{d:h,x:Q.x+(T-.5)*10,y:Q.y+(_-.5)*10}}const J=h.cc?j.get(h.cc):void 0;if(!J)return null;const $=_l[`${e.continent}:${h.cc||""}`];if($)return{d:h,x:J.x+J.w*($.fx+(T-.5)*$.sx),y:J.y+J.h*($.fy+(_-.5)*$.sy)};const M=(T-.5)*Math.min(J.w*.55,60),K=(_-.5)*Math.min(J.h*.55,60);return{d:h,x:J.x+J.w/2+M,y:J.y+J.h/2+K}}).filter(h=>!!h),[z,j,q,A,e.continent]),D=h=>f>0?h/f:h,B=p.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Sr[h],fr:c.plabels[h].toUpperCase(),en:c.plabels[h].toUpperCase(),n:r.filter(T=>T.kind==="target"&&Te(T)===h).length})).filter(h=>h.n>0):Dn.map((h,T)=>({...h,n:r.filter(_=>In(_)===T).length})),[r,n,c.plabels]),L=i?l.get(i):null,R=L?F.find(h=>h.d.id===L.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(zr,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?Bl:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?y.fr:y.en,onMouseLeave:()=>{E(null),o(null)},children:[t.jsx("g",{children:y.countries.map((h,T)=>t.jsx("g",{className:"ct"+(h.i2&&S.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},T))}),t.jsx("g",{children:F.map(h=>{const T=Dn[In(h.d)],_=!!Re(h.d),J=h.d.kind==="target",$=n&&J?Sr[Te(h.d)]:T.c,M=!n&&De(h.d);return t.jsxs("g",{className:"co"+(M?" done":""),onMouseEnter:()=>{var Q,X;const K=(Q=m.current)==null?void 0:Q.getBoundingClientRect(),W=(X=b.current)==null?void 0:X.createSVGPoint();if(W&&b.current&&K){W.x=h.x,W.y=h.y;const be=W.matrixTransform(b.current.getScreenCTM());E({x:be.x-K.left,y:be.y-K.top,label:h.d.name+" · "+(Ut(h.d.cc,s)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{E(null),o(null)},onClick:()=>{var Q;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const K=(Q=b.current)==null?void 0:Q.createSVGPoint();let W=null;if(K&&b.current){K.x=h.x,K.y=h.y;const X=K.matrixTransform(b.current.getScreenCTM());W={x:X.x,y:X.y}}a({type:"popup",id:h.d.id,anchor:W})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:D(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:D(T.px),fill:$,stroke:_?"#DC2626":"#ffffff",strokeWidth:D(_?2.2:1.3)})]},h.d.id||h.d.name)})}),R&&t.jsx("circle",{className:"ring on",cx:R.x,cy:R.y,r:D(13),fill:"none",stroke:"#0F172A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:B.map((h,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),s==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},T))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(zr,{msgs:c.loadMsgs})})}function Hl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function yo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:l,lang:s}=G(),c=a.filters,[g,d]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null),m=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(R=>R.continent===a.continent),[n,a.continent]),y=R=>v.filter(h=>R!=="country"&&c.country.length&&!c.country.includes(h.cc||"")?!1:Ea(h,c,i,R==="country"?void 0:R)),f=R=>!i||R.kind!=="op",j=p.useMemo(()=>{const R=y("win").filter(f),h=T=>R.filter(_=>(_.date?Math.max(0,Math.floor((Date.now()-Date.parse(_.date))/864e5)):9999)<=T).length;return[h(0),h(7),h(30),R.length]},[v,c,i]),N=p.useMemo(()=>c.day?y("win").filter(f).filter(R=>(R.date||"").slice(0,10)===c.day).length:0,[v,c,i]),w=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,E=w+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),p.useEffect(()=>{if(!g&&!x)return;const R=T=>{var J,$;const _=T.target;g&&!((J=b.current)!=null&&J.contains(_))&&d(!1),x&&!(($=m.current)!=null&&$.contains(_))&&u(!1)},h=T=>{T.key==="Escape"&&(d(!1),u(!1))};return document.addEventListener("mousedown",R),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",R),document.removeEventListener("keydown",h)}},[g,x]);const z=(R,h,T,_="fbtn")=>t.jsxs("button",{type:"button",className:_,"aria-expanded":a.openFacet===R,onClick:()=>r({type:"openFacet",facet:R}),children:[t.jsx("span",{className:"fl",children:h}),T>0&&t.jsx("span",{className:"n",children:T}),t.jsx("span",{className:"cv",children:"▾"})]},R),S=["1","7","30","all"],q=Math.max(0,S.indexOf(c.win||"all")),A=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(Hl(c.day,s))}),t.jsx("b",{children:N})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(R=>!R),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[q]}),t.jsx("b",{children:j[q]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:S.map((R,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===R,onClick:()=>{r({type:"filters",patch:{win:R}}),u(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:j[h]})]},R))})]}):t.jsx("div",{className:"seg",children:S.map((R,h)=>t.jsxs("button",{type:"button","aria-pressed":c.win===R,onClick:()=>r({type:"filters",patch:{win:R}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:j[h]})]},R))}),F=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:R=>r({type:"filters",patch:{search:R.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):z("sec",o.fSector,c.sector.length),z("pay",o.fCountry,c.country.length),z("det",o.fEngine,c.engine.length),z("sta",o.fStage,c.stage.length),i&&z("ang","Angle",c.angle.length),i&&z("mem","Mémo",c.memoLevel.length)]}),B=(R=!1)=>t.jsxs("div",{className:"frow2",children:[E>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(E)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),R&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),L=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(w?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{d(R=>!R),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),w>0&&t.jsx("span",{className:"n",children:w}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:A}),t.jsxs("div",{className:"fstrip-b",children:[F,L,B(!1)]})]}),a.openFacet&&t.jsx(Ar,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[A,F,D,t.jsx("span",{className:"fgrow"}),B()]}),a.openFacet&&t.jsx(Ar,{poolFor:y})]})}function Ar({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=G(),i=a.filters,l=a.openFacet,{title:s,cols:c,options:g}=p.useMemo(()=>{if(l==="sig"){const m=e("signal").filter(f=>Re(f)),v=new Map;m.forEach(f=>{const j=f.engine||"";v.set(j,(v.get(j)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...Ja([...v.keys()],o).map(f=>({v:f,label:qt(f)+" "+Je(f,o),n:v.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(l==="sec"){const m=e("sector"),v=new Map;return m.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:i.sector.includes(y)}))}}if(l==="pay"){const m=e("country"),v=new Map;return m.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:Ut(y,o)||y,n:f,html:!1,on:i.country.includes(y)}))}}if(l==="det"){const m=e("engine"),v=new Map;return m.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Ja([...v.keys()],o).map(y=>({v:y,label:qt(y)+" "+Je(y,o)+' <span style="color:var(--dim);font-size:10px">· '+di(ci(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(l==="ang"){const m=e("angle"),v=new Map;return m.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(y)}))}}if(l==="mem"){const m=e("memoLevel"),v=new Map;m.forEach(f=>{if(f.kind==="target"){const j=bn(f);v.set(j,(v.get(j)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:v.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const u=e("stage"),b=new Map;return u.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,v)=>v[1]-m[1]).map(([m,v])=>({v:m,label:m,n:v,html:!1,on:i.stage.includes(m)}))}},[l,a,o]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(u)?i.signalEngines.filter(v=>v!==u):[...i.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function wo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:l,t:s}=G(),c=p.useMemo(()=>{const b={};return r.forEach(m=>{Ea(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,d]=p.useState(!1),x=p.useRef(null);p.useEffect(()=>{if(!g)return;const b=v=>{var y;(y=x.current)!=null&&y.contains(v.target)||d(!1)},m=v=>{v.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const u=b=>{const m=yn.find(v=>v.key===b);return b==="monde"?s.contWorld:l==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>d(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Pn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),d(!1)},children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[Pn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function ko(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Vl(e){var o;const a=[],r=new Set,n=i=>{const l=(i||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Tr({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:l}){const{t:s}=G();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:s.rsEvalOne})]},c.name))})]}):null}function jo({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=G(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Tr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Tr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Wl({card:e,onEvaluate:a,onAddAll:r}){var s,c,g;const{t:n}=G(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ko(e.summary_md||"").map((d,x)=>t.jsx("p",{children:d},x))})]}),t.jsx(jo,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Gl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Yl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:l}=G(),s=o,[c,g]=p.useState(null),[d,x]=p.useState(null),[u,b]=p.useState(null),[m,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const j=await _r({email:l,cbToken:s});f&&g(j)})(),()=>{f=!1}},[l,s,n]);const y=f=>{x(f),b(null),v(!0),(async()=>{const j=await pi(f.id);b(j),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Gl(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(Wl,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ya=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Xt(e){return/^https?:\/\//i.test((e||"").trim())}function dt(e){const a=(e||"").trim();return a?Xt(a)?a:ya.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Kl(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Ql(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:l,evalBusy:s,evalCards:c,caps:g,data:d,canWrite:x,source:u,dossiers:b,doAnalyse:m,liveMemos:v,pipe:y}=G(),f=a==="client",j=p.useMemo(()=>r||(u!=="default"?ui():""),[r,u]),[N,w]=p.useState(""),[E,z]=p.useState(!1),[S,q]=p.useState(""),[A,F]=p.useState(""),[D,B]=p.useState(""),[L,R]=p.useState(!1),[h,T]=p.useState(!1),[_,J]=p.useState(""),[$,M]=p.useState(!1),[K,W]=p.useState(""),[Q,X]=p.useState([]),be=p.useRef(!1),[U,de]=p.useState(!1),[pe,Ne]=p.useState(!1),[fe,ce]=p.useState(!1),ge=p.useRef(!1),[Z,ee]=p.useState(""),[ne,ue]=p.useState(""),[Se,ze]=p.useState(!1),[ie,he]=p.useState(!1),[_e,qe]=p.useState(0),[ve,Ue]=p.useState(""),[ye,Ie]=p.useState(null),[xe,We]=p.useState(null),[xt,jt]=p.useState(!1),[lt,Nt]=p.useState(null),[Et,nt]=p.useState(0),gt=p.useRef(!1),St=N.trim()?ya.test(N.trim())?e.evalUrl:e.evalName:e.evalWaiting,Me=p.useMemo(()=>_.split(`
`).map(I=>I.trim()).filter(Boolean).slice(0,15),[_]);p.useEffect(()=>{if(typeof window>"u")return;const I=new URLSearchParams(window.location.search),te=(I.get("rs")||"").trim(),oe=(I.get("rstext")||"").trim();te&&/^https?:\/\//i.test(te)&&ee(te),oe&&ue(oe),(te&&/^https?:\/\//i.test(te)||oe)&&de(!0)},[]),p.useEffect(()=>{const I=te=>{const oe=te.detail||{},k=String(oe.url||"").trim(),P=String(oe.text||"").trim();k&&/^https?:\/\//i.test(k)&&ee(k),P&&ue(P),(k&&/^https?:\/\//i.test(k)||P)&&(de(!0),w(""),q(""),ze(!0),window.setTimeout(()=>ze(!1),900))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),p.useEffect(()=>{const I=te=>{const oe=te.detail||{},k=String(oe.name||"").trim();if(!k)return;de(!1),w(k),q(k);const P=dt(String(oe.website||oe.domain||""));F(P),B(dt(String(oe.url||""))),R(!P),z(!0),window.setTimeout(()=>z(!1),900)};return window.addEventListener("ppmap:prefill",I),()=>window.removeEventListener("ppmap:prefill",I)},[]),p.useEffect(()=>{const I=(S||"").trim();if(!I||U||A){(A||!I||U)&&R(!1);return}const te=b.find(P=>Be(P.name)===Be(I)),oe=dt((te==null?void 0:te.website)||"")||dt((te==null?void 0:te.domain)||"");if(oe){F(oe),R(!1);return}let k=!0;return R(!0),$r(I).then(P=>{var V,ae;if(!k)return;const O=dt(P.website||"")||dt(((ae=(V=P.candidates)==null?void 0:V[0])==null?void 0:ae.url)||"");O&&F(O)}).catch(()=>{}).finally(()=>{k&&R(!1)}),()=>{k=!1}},[S,U,A,b]),p.useEffect(()=>{const I=te=>{var k;const oe=String(((k=te.detail)==null?void 0:k.url)||"").trim();Xt(oe)&&window.open(oe,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",I),()=>window.removeEventListener("ppmap:view",I)},[]),p.useEffect(()=>{if(ge.current===U)return;ge.current=U,ce(!0);const I=window.setTimeout(()=>ce(!1),560);return()=>window.clearTimeout(I)},[U]),p.useEffect(()=>{if(typeof window>"u")return;const I=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),te=document.querySelector(".atl2.ops, .atl2.cibles");if(!I||!te)return;const oe=()=>te.style.setProperty("--demand-h",`${I.offsetHeight}px`);oe();const k=new ResizeObserver(oe);return k.observe(I),()=>k.disconnect()},[u,E,Se,h,U,fe,L]),p.useEffect(()=>{if(!x&&!j){Nt(null);return}let I=!0;return(async()=>{const te=await _r({email:n,cbToken:j});I&&Nt(te.length)})(),()=>{I=!1}},[x,j,n,Et]);const Ct=Q.length?Q:c,Pe=d.credits,rt=p.useCallback(I=>{const te=I.map(oe=>(oe||"").trim()).filter(Boolean);te.length&&(J(oe=>{const k=oe.split(`
`).map(V=>V.trim()).filter(Boolean),P=new Set(k.map(V=>V.toLowerCase())),O=te.filter(V=>!P.has(V.toLowerCase()));return[...k,...O].slice(0,15).join(`
`)}),T(!0))},[]);p.useEffect(()=>{if(!ie)return;qe(0);const I=window.setInterval(()=>qe(te=>te+1),1e3);return()=>window.clearInterval(I)},[ie]);const C=p.useMemo(()=>{const I=N.trim().toLowerCase();return!I||!y?null:b.find(te=>Be(te.name)===I&&Te(te)===1)||null},[N,b,y]),H=()=>{const I=N.trim();if(I){if(C){m(C);return}o(null,I),f&&w("")}},Y=async()=>{if(!f){o(null,Me[0]||"");return}if(!Me.length||$)return;M(!0),be.current=!1;const I=[];for(let te=0;te<Me.length&&!be.current;te++){W(e.evaluating(te+1,Me.length,Me[te]));const oe=await Ur(r,Me[te],"atelier2");if(I.unshift({name:oe.company||Me[te],verdict:oe.verdict,reason:oe.reason||"",remaining:oe.remaining??null}),X([...I]),oe.verdict==="quota"){I.unshift({name:"",verdict:"quota",reason:e.quota(Me.length-te-1),remaining:0}),X([...I]),J(Me.slice(te+1).join(`
`)),W(""),M(!1);return}}W(""),J(be.current?Me.slice(I.length).join(`
`):""),M(!1)},re=async()=>{var oe,k,P;if(gt.current)return;const I=Z.trim().replace(/\s+/g,""),te=ne.trim();if(!I&&!te){Ue(e.rsNeed);return}if(!f&&!j){o(null,I||te.slice(0,80));return}gt.current=!0,Ue(""),Ie(null),We(null),he(!0);try{const O=await fi({url:I,text:te,email:n,cbToken:j});if(he(!1),!O||O.status!=="success"){Ue((O==null?void 0:O.message)||"Erreur");return}Ie(O),de(!1),rt((((oe=O.prospective)==null?void 0:oe.companies_to_evaluate)||[]).map(ae=>(ae==null?void 0:ae.name)||"")),We({state:"pending"});const V=await hi(O,{email:n,cbToken:j});We(V.ok?{state:"ok",scopeLabel:((k=V.summary)==null?void 0:k.scope_label)||"",scope:((P=V.summary)==null?void 0:P.scope)||""}:{state:"fail",msg:V.error||""}),V.ok&&nt(ae=>ae+1)}finally{gt.current=!1,he(!1)}},je=[ye==null?void 0:ye.industry,...(ye==null?void 0:ye.market_tags)||[],ye==null?void 0:ye.author].map(I=>(I||"").trim()).filter(Boolean),se=(xe==null?void 0:xe.state)==="pending",Oe=xe&&(se?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):xe.state==="ok"?t.jsx("span",{className:"rslink ok",children:xe.scope&&xe.scope!=="public"?e.rsSavedIn(xe.scopeLabel||xe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:xe.msg,children:e.rsSaveFail})),ot=Vl(ye).length,le=U,Xe=(S||N).trim(),Ge=b.find(I=>Be(I.name)===Be(Xe)),bt=dt(N)||A||dt((Ge==null?void 0:Ge.website)||"")||dt((Ge==null?void 0:Ge.domain)||""),vt=D||dt((Ge==null?void 0:Ge.url)||""),Ye=C?e.actAnalyse:Xe?e.evalGoOn(Xe.length>22?Xe.slice(0,21)+"…":Xe):e.evalGo,Oa=ie?`${mi(Z.trim())==="youtube"&&Z.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(_e)}`:se?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(le?" rs-mode":"")+(S&&N.trim()===S||E||Se?" pair":"")+(E||Se||fe?" echo":"")+(fe?" swap":""),children:[t.jsxs("div",{className:"drow"+((le?Se:E)||fe?" flash":"")+((le?Z.trim():ya.test(N.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:le?Z:N,placeholder:le?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:le?600:200,spellCheck:le?!1:void 0,inputMode:le?"url":void 0,onChange:I=>{if(le){ee(I.target.value);return}w(I.target.value),S&&I.target.value.trim()!==S&&(q(""),F(""),B(""),R(!1))},onKeyDown:I=>{I.key==="Enter"&&(le?re():H())}}),t.jsx("span",{className:"detect"+(le?" off":"")+(ya.test(N.trim())?" url":""),children:St})]}),t.jsx("span",{className:"dacts",children:le?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ie?" loading":""),disabled:ie||se||!Z.trim()&&!ne.trim(),onClick:()=>{re()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Oa})]}),t.jsxs("a",{className:"viewbtn"+(Xt(Z)?"":" off"),href:Xt(Z)?Z.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:I=>{Xt(Z)||I.preventDefault()},children:[t.jsx(Kl,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(C?" analyse":"")+(s?" loading":""),disabled:s,onClick:H,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:Ye})]}),t.jsxs("a",{className:"viewbtn sm"+(L?" searching":bt?"":" off"),href:bt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":L||void 0,title:L?e.viewSiteBusyHint:e.viewSiteHint,onClick:I=>{bt||I.preventDefault()},children:[L&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),L?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(vt?"":" off"),href:vt||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:I=>{vt||I.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&Pe&&t.jsxs("button",{type:"button",className:"credits"+(Pe.total_available<=0&&!Pe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Pe.unlimited?"∞":Pe.total_available}),!Pe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Pe.daily_grant+Pe.purchased]}),Pe.total_available<=0&&!Pe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>T(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(U?" on":""),onClick:()=>de(!U),children:e.rsOpen}),lt!==null&&lt>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(xt?" on":""),onClick:()=>jt(!xt),children:e.rsArchOpen(lt)})]}),xt&&t.jsx(Yl,{bump:Et,cbToken:j,onClose:()=>jt(!1),onEvaluate:I=>o(null,I),onAddAll:rt}),t.jsx("div",{className:"rsp slim"+(U?" on":" off"),"aria-hidden":!U,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:U?void 0:-1,onClick:()=>Ne(I=>!I),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:pe?"▴":"▾"})]}),pe&&t.jsx("textarea",{className:"rstext",value:ne,placeholder:e.rsTextPh,tabIndex:U?void 0:-1,onChange:I=>ue(I.target.value)})]})}),ve&&t.jsx("div",{className:"rserr",children:ve}),ye&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ye.title}),ye.source_url&&t.jsx("a",{href:ye.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{Ie(null),We(null)},children:"×"})]}),ye.market&&t.jsx("p",{className:"rsmk",children:ye.market}),je.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),je.map(I=>t.jsx("span",{children:I},I))]}),t.jsxs("div",{className:"rsbody",children:[ye.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ye.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:ko(ye.summary_md||"").map((I,te)=>t.jsx("p",{children:I},te))})]}),t.jsx(jo,{card:ye,onEvaluate:I=>o(null,I),onAddAll:rt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(ot)}),Oe]})]}),h&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:_,placeholder:e.bulkPh,onChange:I=>J(I.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+($?" loading":""),style:{justifyContent:"center"},disabled:$||!Me.length,onClick:()=>{Y()},children:[t.jsx("span",{className:"fill"}),$&&K?K:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(Me.length)})]})]}),Ct.slice(0,1).map((I,te)=>{const oe=I.verdict==="kept",k=I.verdict==="quota",P=oe?"var(--brand)":k?"var(--bolt)":"var(--red)",O=oe?"var(--brand-l)":k?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":P,"--bgc":O},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:oe?"✓ "+e.kept:k?"⏳":"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(V=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:V.url.startsWith("http")?V.url:`https://${V.url}`,target:"_blank",rel:"nofollow noopener",children:[(V.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,V.url),children:e.evalPickGo})]},V.url))}),!k&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:oe?1:5});const V=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const ae=[...document.querySelectorAll(".atl2 .list .row")].find(Ce=>{var we;return(((we=Ce.querySelector(".rnm"))==null?void 0:we.textContent)||"").trim().toLowerCase().includes(V)});ae&&(ae.scrollIntoView({behavior:"smooth",block:"center"}),ae.classList.add("flashrow"),window.setTimeout(()=>ae.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(oe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},te)}),f&&(i.kept+i.dropped>0||Ct.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Jl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Xl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=G(),i=e.memoConsole?r.get(e.memoConsole):null,l=p.useMemo(()=>i?[i.reasoning||"",Jl(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const s=kt(i),c=bn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[It(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Sn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=G(),[l,s]=p.useState(!1),[c,g]=p.useState(null),d=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!d||l)return;s(!0);const u=await xi(r,e);if(s(!1),!u){i(a.actErr);return}g(u.results||[])};return p.useEffect(()=>{if(!d)return;const u=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,d]),p.useEffect(()=>{if(d)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,d]),d?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Zl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),xa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ed(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=xa(a.slice(n));break}r+=xa(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=xa(a.slice(o));break}const l=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),c=s?s[2].toLowerCase():"";s&&Zl.has(c)?r+=`<${s[1]}${c}>`:r+=xa(a.slice(o,i+1)),n=i+1}return r}const qr=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function $e({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function td(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ad({o:e}){const{t:a,doDeep:r}=G(),[n,o]=p.useState(!1),i=kt(e),l=[e.reasoning||"",td(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[i&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:i}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((s,c)=>t.jsx("p",{className:"cdtxt",children:s},c)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[It(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:s=>{s.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:s=>{s.stopPropagation(),o(c=>!c)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:s=>s.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:s=>s.stopPropagation()})]})}function Cn({o:e}){const{t:a,lang:r,dispatch:n,caps:o}=G(),i=ia(e),l=kt(e),s=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=p.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(o.pipe&&!o.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||It(e)?1:0}].filter(v=>v.n>0),[e,a,s,l,c,g,d]),[u,b]=p.useState("");if(!x.length)return null;const m=x.some(v=>v.k===u)?u:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(v=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===v.k,"data-tour":"tab-"+v.k,className:m===v.k?"on":"",onClick:y=>{y.stopPropagation(),b(v.k)},children:v.lib},v.k))}),t.jsxs("div",{className:"cdbody",onClick:v=>v.stopPropagation(),children:[m==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx($e,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx($e,{k:a.cdVerdictDate,v:qr(e.verdictDate,r)})]})]}),m==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:ed(e.summary)}}),o.pipe&&!o.lockActions&&t.jsx(nd,{o:e})]}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdSector,v:e.sector}),t.jsx($e,{k:a.cdStage,v:e.stage}),t.jsx($e,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx($e,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx($e,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx($e,{k:a.cdAngle,v:e.angle}),t.jsx($e,{k:a.cdDetected,v:qr(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdName,v:e.contactName}),t.jsx($e,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx($e,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="memo"&&t.jsx(ad,{o:e}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx($e,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx($e,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function nd({o:e}){const{t:a,token:r}=G(),[n,o]=p.useState(!1),[i,l]=p.useState(null),s=async()=>{n||(o(!0),l(await gi(r,e.name,e.website||e.domain||"")),o(!1))},c=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],d=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function sa({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let l=!1;const s=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Bn({kind:"op",card:e},g).then(d=>{!l&&d&&i.isConnected&&i.replaceChildren(d)})},c=window.requestAnimationFrame(s);return()=>{l=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let l=!1;Bn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!l&&c&&i.isConnected&&i.replaceChildren(c)});const s=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&$t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const rd=`
...
`;function od(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function id(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:l,askEvaluate:s,doAnalyse:c,doDecide:g,doPromote:d,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:v,evalBusy:y}=G(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const j=Re(f),N=Te(f),w=kt(f),E=ia(f),z=f.kind==="target",S=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return $t.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:rd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:od(e.popupAnchor,!!f.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ht(f.date)),Je(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[f.cc]}),children:(Ut(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Ht(f.amountEur,o)})]}),i.pipe&&z&&t.jsxs("div",{className:"pstat",children:[E&&t.jsx("span",{className:"vd "+(E==="MATCH"?"v-ok":"v-no"),title:n.vt[E],children:E}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[N]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[qt(f.engine)," ",t.jsx("b",{children:Je(f.engine,o)})," — ",bi(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:f,lg:!0})," ",t.jsx(Ma,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Hr(j,o))," · ",n.win7(Vr(j,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(sa,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&N>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&z&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&z&&t.jsx(Cn,{o:f})]}),t.jsx(Sn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||l!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[N===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),N===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),N===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),N===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),It(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),N===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),N===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function sd(){const{lang:e,token:a,dossiers:r,caps:n}=G(),o=a||"home",{names:i,verdicts:l}=p.useMemo(()=>{const c=[],g={};return r.forEach(d=>{d.kind!=="target"||!d.name||(c.push(d.name),g[d.name]=vi(d)||"")}),{names:c,verdicts:g}},[r]);return{diff:p.useMemo(()=>i.length?yi(o,i,l,e):null,[o,i.length]),names:i,verdicts:l,scope:o,caps:n}}function ld(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:l,caps:s}=G(),[c,g]=p.useState(!1),[d,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!c)return;const N=w=>{u.current&&!u.current.contains(w.target)&&g(!1)};return document.addEventListener("click",N,!0),()=>document.removeEventListener("click",N,!0)},[c]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...s.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!l.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const y=N=>{const w=v.current[N],E=w!==void 0?r[N]-w:0;return t.jsxs("button",{type:"button",className:"step"+(N===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zt[N]})`,"--tc":N<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===N,title:n.phelp[N],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:N})},children:[t.jsxs("span",{className:"l",children:[n.plabels[N].toUpperCase(),N===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(E>0?" up":E<0?" down":""),children:[r[N],E!==0&&t.jsxs("em",{className:"delta",children:[E>0?"+":"−",Math.abs(E)]})]})]},N)},f=(N,w,E)=>t.jsxs("button",{type:"button",className:"off"+(w?" view":""),style:{"--c":`var(${Zt[N]})`},"aria-selected":e.ptab===N,title:n.phelp[N],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:N})},children:[t.jsx("span",{className:"l",children:E.toUpperCase()}),t.jsx("span",{className:"n",children:r[N]})]},N),j=(N,w,E,z=!1)=>t.jsx("button",{type:"button",className:"tool",title:w,disabled:z,onClick:E,children:N},w);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(y)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[j("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(d?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":c,title:n.toolSort,onClick:()=>g(N=>!N),children:"⇅"}),c&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([N,w])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===N,className:"sortopt"+(e.sort.key===N?" on":""),onClick:()=>a({type:"sort",key:N}),children:[w,t.jsx("i",{children:e.sort.key===N?e.sort.dir===1?"↑":"↓":""})]},N))})]}),j("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),j("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function dd(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:l}=G(),s=p.useRef(null),[c,g]=p.useState(60);p.useEffect(()=>{let m=0;const v=()=>{var w;const y=s.current;if(!y)return;const f=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!f)return;const j=f.getBoundingClientRect(),N=y.getBoundingClientRect();g(Math.max(20,Math.min(j.left+j.width/2-N.left,N.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const d=e.ptab;let x=r.tuto[d].p;if(d===3){const m=n.filter(f=>f.kind==="target"&&Te(f)===3),v=m.filter(f=>Xa(f)==="auto").length,y=m.filter(f=>Xa(f)==="cd").length;x=r.tutoPending(v,y,m.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(d===1){const m=n.filter(v=>v.kind==="target"&&Te(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=wi(d);return t.jsxs("div",{ref:s,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Zt[d]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const Ka=600,At=62,Lr="atl2:fstats";function cd(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=G(),[l,s]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Lr)==="on"}catch{return!1}}),c=r.stats,g=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const x=E=>a==="en"?E.slice(5,10):`${E.slice(8,10)}/${E.slice(5,7)}`,u=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((E,z)=>Math.max(E,z.s||0),0),m=g.length?Ka/g.length:0,v=Math.max(4,m-4),y=g.length>=5&&b>0,f=r.marketEstimate||0,j=x(new Date().toISOString().slice(0,10)),N=E=>[...typeof E=="number"?[[E,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&d&&w.push({cle:"fenetre",periode:e.funPerWindow(x(d),j),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:N(c.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[w.map(E=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:E.periode}),E.etapes.map(([z,S],q)=>t.jsxs("span",{className:"fst-t",children:[q>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(z)}),t.jsx("i",{children:S})]},E.cle+S)),E.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),E.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const z=!l;s(z),z&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Lr,z?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},E.cle)),l&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Ka} ${At}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((E,z)=>{const S=(E.s||0)/b*(At-4),q=(E.m||0)/b*(At-4),A=z*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(E.d)} — ${E.s} ${e.actScreened} · ${E.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:At-2-S,width:v,height:S,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:At-2-q,width:v,height:q,fill:"#185c38"})]},E.d)}),t.jsx("line",{x1:0,y1:At-1.5,x2:Ka,y2:At-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const No={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function zn({o:e,locked:a=!1}){const{t:r}=G(),n=ia(e),o=kt(e),i=Te(e),l=Xa(e),s=ki(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(No[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(Is,{o:e})]})}const _t=e=>e.length>22?e.slice(0,21)+"…":e;function oa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Eo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function pd({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const l=()=>{var m,v,y;const s=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!s){n(null);return}const g=s.getBoundingClientRect(),d=c?c.getBoundingClientRect().bottom:g.top;i({top:Math.round(d),left:Math.round(g.left),width:Math.round(g.width)});const x=[...s.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const j=f.querySelector(".grp-h");j&&j.getBoundingClientRect().bottom<=d+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return l(),window.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",l),()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function ud(e){const r=()=>{const n=Eo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Fr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=G(),[i,l]=p.useState(!1);if(p.useEffect(()=>{n||l(!1)},[n]),De(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(_t(e.name))})]})}function An({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:l,doPromote:s,doRepeche:c,doApproach:g,dispatch:d,liveMemos:x}=G(),u=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=u(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Te(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(_t(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemo})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Na(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Fr,{o:e})});const b=Te(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Fr,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(ka,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:u(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function md({o:e}){const{t:a,doThumb:r,thumbOf:n}=G(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function fd({o:e}){const{lang:a}=G();return Re(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(Ma,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[qt(e.engine||"")," ",Je(e.engine||"",a)]})})}function hd({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:l,fresh:s}){const{dispatch:c,caps:g,markRow:d,markedId:x,favIds:u,toggleFav:b,t:m}=G(),v=Te(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,j=f<=0?0:f<=7?1:f<=30?2:3,N=g.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:y[j],w=u.has(e.id),E=z=>{if(a)return;if(l){l(e.id);return}if(g.pipe||e.kind==="op"){n();return}const S=z.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:S.left+Math.min(280,S.width/3),y:S.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+v:"")+(w?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":N}}),t.jsx(To,{o:e}),t.jsxs("span",{className:"nd",children:[s&&t.jsx("span",{className:"rfresh",children:"✨"}),Re(e)&&t.jsx(wt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:w?1:.35,padding:0,marginRight:4},onClick:z=>{z.stopPropagation(),b(e)},children:w?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(z=>z&&z!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:z=>{z.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",_t(e.acquirer)]}),He(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(xd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(fd,{o:e}),g.pipe&&t.jsx(zn,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(An,{o:e}),g.showThumbs&&t.jsx(md,{o:e})]}),r&&!a&&!l&&t.jsx(vd,{o:e})]})}function xd({o:e}){const{lang:a,caps:r}=G();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ht(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function gd({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=G(),l=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Ht(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=De(e),x=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):Ke(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),oa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(_t(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(sa,{spec:e.card})})]})}function bd({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=G();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Je(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(An,{o:e})}),t.jsx(Cn,{o:e})]})}function So({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:l,caps:s,dossiers:c}=G(),g=p.useRef(null),d=He(e);if(p.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let T=!1;return Qa(()=>import("./fit-BnaWm7z_.js"),[]).then(async _=>{await _.ensureEditoCss(),!(T||!h.isConnected)&&(_.beautifyEditoRows(h),_.mountCardFits(h))}),()=>{T=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const h=c.find(He);if(h)return t.jsx(So,{o:h})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!x||ja(x),y=(e==null?void 0:e.engine)||"",f=He(e),j=e?Ht(e.amountEur,n):"",N=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),E=c.find(He),z=((E==null?void 0:E.url)||"").trim(),S=!!u&&!!z&&(u===z||u.endsWith(z)||z.endsWith(u)),q=(h,T=!1)=>_=>{_.stopPropagation(),T&&l({type:"continent",key:"monde"}),l({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const A=()=>{x&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:x}}))},F=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},D=()=>{oa({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},B=e?De(e):!1,L=B&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",R=f?r.doEdito.replace(/^📖\s*/,""):y?Je(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[R,N?` · ${N}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(v||Na({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:q({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:q({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:q({stage:[e.stage]}),children:e.stage}),j&&t.jsx("span",{className:"oc-amt",children:j})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(sa,{spec:m})}),(u&&!S&&!f||E&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!S&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),E&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),l({type:"focus",id:E.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[B?t.jsxs("span",{className:"verdict",style:{"--c":L?"var(--brand)":"var(--red)"},children:[L?"✓":"✗"," ",t.jsx("b",{children:L?r.kept:r.dropped})]}):!v&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(_t(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(v||Na({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&x?" ghost":""),onClick:h=>{h.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!s.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),F()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),A()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:_t(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&x&&s.pipe&&t.jsx(Sn,{name:x})]})]})}function vd({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:l}=G();return!o.pipe&&e.kind==="op"?t.jsx(gd,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Cn,{o:e}),t.jsx(Ps,{o:e}),t.jsx($s,{o:e}),t.jsx(Sn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(zn,{o:e})})]}),e.card&&t.jsx(sa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[qt(e.engine||"")," ",Je(e.engine||"",r)]}),Re(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function yd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:l,doDecide:s,lang:c}=G();if(!l.pipe&&e.kind==="op"){const x=Ht(e.amountEur,c),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(sa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[qt(e.engine||"")," ",Je(e.engine||"",c)]}),Re(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(An,{o:e})})]})}const g=Te(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(zn,{o:e}),Re(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&l.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>s(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemo," →"]})]})}function wd(){const{t:e}=G(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function kd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=G(),i=o==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=s.includes(0)?0:s.sort((d,x)=>(e[x]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${l(c)}”`:`${g} dossier${g>1?"s":""} dans « ${l(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+l(c)," →"]})]})}function jd(){var St,Me,Ct,Pe,rt;const e=G(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:l,scopedAll:s,markRow:c,lang:g,sessTally:d,data:x,dossiers:u,source:b,focusExtra:m,byId:v,token:y}=e,f=Yr(),j=p.useMemo(()=>{var Y,re,je,se;if(!y||b==="ops")return null;const C=(((Y=f==null?void 0:f.ed)==null?void 0:Y.date)||(f==null?void 0:f.day)||"").slice(0,10),H=[(re=f==null?void 0:f.ed)==null?void 0:re.html,(je=f==null?void 0:f.ed)==null?void 0:je.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((se=f==null?void 0:f.ed)==null?void 0:se.date)||C,decryptHtml:H||void 0,date:C,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,g,(St=f==null?void 0:f.ed)==null?void 0:St.html,(Me=f==null?void 0:f.ed)==null?void 0:Me.acquirers_html,(Ct=f==null?void 0:f.ed)==null?void 0:Ct.date,f==null?void 0:f.day]),N=C=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Gr,[w,E]=p.useState(new Set);p.useEffect(()=>{E(new Set)},[a.ptab,a.continent]);const[z,S]=p.useState(null);p.useEffect(()=>{S(null)},[a.ptab,a.continent]);const[q,A]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){A(!1);return}const C=document.getElementById("atl2-stage");if(!C){A(!1);return}const H=new IntersectionObserver(([Y])=>A(!!Y&&Y.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return H.observe(C),()=>H.disconnect()},[a.mapFolded]);const F=a.mapFolded||!q,D=C=>E(H=>{const Y=new Set(H);return Y.has(C)?Y.delete(C):Y.add(C),Y}),B=b==="ops"||o.pipe,[L,R]=p.useState("all"),[h,T]=p.useState(!1),[_,J]=p.useState(null),[$,M]=p.useState(!1),K=p.useRef(!0);p.useEffect(()=>{if(K.current){K.current=!1;return}R("all"),M(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!$)return;const C=H=>{var Y,re;(re=(Y=H.target)==null?void 0:Y.closest)!=null&&re.call(Y,".atl2 .doable")||M(!1)};return document.addEventListener("click",C,!0),()=>document.removeEventListener("click",C,!0)},[$]);const W=p.useMemo(()=>{var H;const C=new Map;for(const Y of Ns(((H=f==null?void 0:f.ed)==null?void 0:H.html)||""))C.has(Y.t)||C.set(Y.t,Y.html);return C},[(Pe=f==null?void 0:f.ed)==null?void 0:Pe.html]),Q=p.useCallback(C=>{if(C.decryptHtml)return C.decryptHtml;if(!W.size)return;const H=(C.name||"").trim().toLowerCase();if(H.length<3)return;const Y=W.get(H);if(Y)return Y;for(const[re,je]of W)if(re.includes(H)||H.includes(re))return je},[W]),{diff:X}=sd(),[be,U]=p.useState(!1),de=a.filters.win==="1"&&!a.filters.day,[pe,Ne]=p.useState(!1),fe=p.useMemo(()=>new Set(((X==null?void 0:X.added)||[]).map(C=>C.trim().toLowerCase()).filter(Boolean)),[X]),ce=p.useMemo(()=>{if(!fe.size)return 0;const C={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(H=>!He(H)&&fe.has((H.name||"").trim().toLowerCase())&&ea(H,C,o.pipe)).length},[u,fe,a,o.pipe]);p.useEffect(()=>{const C=()=>{Ne(!1),T(!1),R("all"),M(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",C),()=>window.removeEventListener("ppmap:tunnel",C)},[]),p.useEffect(()=>{Ne(!1),T(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ge=p.useMemo(()=>s.filter(C=>!He(C)&&Ke(C)).length,[s]),Z=p.useMemo(()=>{const H=pe&&fe.size>0||a.filters.signalOnly||L!=="all"||h?s:l;let Y=wn(H,a.sort);return Y=Y.filter(re=>!He(re)),pe&&fe.size&&(Y=Y.filter(re=>fe.has((re.name||"").trim().toLowerCase()))),h||L==="explore"?Y=Y.filter(Ke):L==="eval"?Y=Y.filter(re=>!Ke(re)&&!re.noCo&&(re.kind==="op"||!De(re))):o.pipe&&(Y=Y.filter(re=>!Ke(re))),Y},[l,s,a.sort,L,pe,fe,h,o.pipe]),ne=p.useMemo(()=>o.pipe?u.filter(C=>C.kind==="target"&&!He(C)&&Re(C)&&(a.continent==="monde"||C.continent===a.continent)):Z.filter(C=>Re(C)&&!De(C)),[o.pipe,u,Z,a.continent]).length,ue=p.useMemo(()=>o.pipe?Z:Z.filter(C=>!De(C)&&!C.noCo&&!Ke(C)),[Z,o.pipe]),Se=b==="ops"?Z.filter(Ke).length:0,ze=pe?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,ie=a.filters,he=[];if(ie.day)he.push({k:"day",lib:n.fDay(ie.day.slice(8,10)+"/"+ie.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(ie.win&&ie.win!=="all"){const C=["1","7","30"].indexOf(ie.win);C>=0&&he.push({k:"win",lib:n.dates[C],off:()=>r({type:"filters",patch:{win:"all"}})})}const _e=C=>C.length<=2?C.join(", "):`${C.length} ${n.fSelected}`;for(const C of["sector","country","engine"]){const H=ie[C];H&&H.length&&he.push({k:C,lib:_e(H),off:()=>r({type:"clearFacet",facet:C})})}ie.search&&he.push({k:"search",lib:"🔍 "+ie.search,off:()=>r({type:"filters",patch:{search:""}})}),pe&&fe.size&&he.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>Ne(!1)}),ie.signalOnly&&he.push({k:"sig",lib:"🔴 "+n.sigDock(ne||ie.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const qe=(C,H,Y="",re=!1)=>t.jsxs("button",{type:"button","data-s":C,className:Y,"aria-sort":a.sort.key===C?a.sort.dir===1?"ascending":"descending":"none",style:re?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:C}),children:[H,t.jsx("span",{className:"ar",children:a.sort.key===C&&a.sort.dir===1?"▴":"▾"})]},C),ve=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const C=new Map;Z.forEach(re=>{const je=re.engine||"?";C.has(je)||C.set(je,[]),C.get(je).push(re)});const H={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},Y=Ja([...C.keys()],g);return[...C.entries()].sort((re,je)=>{const se=H[re[0]]??10+Y.indexOf(re[0]),Oe=H[je[0]]??10+Y.indexOf(je[0]);return se-Oe})},[Z,o.pipe,a.groupBy,g]),Ue=ve?ve.filter(([C])=>ba.has(C)).length:0,ye=(()=>{var H;return((H=(ve?ve.flatMap(([,Y])=>Y):Z)[0])==null?void 0:H.id)??null})(),Ie=p.useRef(!1),xe=p.useMemo(()=>u.find(He)||j,[u,j]);p.useEffect(()=>{const C=()=>{Ie.current=!0,Ne(!1)};return window.addEventListener("ppmap:reveal",C),window.addEventListener("ppmap:focus",C),()=>{window.removeEventListener("ppmap:reveal",C),window.removeEventListener("ppmap:focus",C)}},[]),p.useEffect(()=>{const C=()=>{xe&&r({type:"focus",id:xe.id})};return window.addEventListener("ppmap:edito",C),()=>window.removeEventListener("ppmap:edito",C)},[xe,r]),p.useEffect(()=>{if(!a.focusId)return;J(a.focusId);const C=window.setTimeout(()=>J(null),900);return()=>window.clearTimeout(C)},[a.focusId]),p.useEffect(()=>{if(B&&!(a.focusId&&(Z.some(C=>C.id===a.focusId)||u.some(C=>C.id===a.focusId)||a.focusId===(xe==null?void 0:xe.id)))&&!m){if(xe){r({type:"focus",id:xe.id});return}ye&&r({type:"focus",id:ye})}},[B,a.focusId,Z,ye,m,r,u,b,xe]),p.useEffect(()=>{if(!B||!a.focusId||xe&&a.focusId===xe.id||Z.some(H=>H.id===a.focusId))return;const C=u.find(H=>H.id===a.focusId);if(C){if(Ie.current){C.kind==="op"?R(Ke(C)?"explore":"eval"):L!=="all"&&R("all");return}L!=="all"&&ye&&r({type:"focus",id:ye})}},[B,a.focusId,L,Z,u,ye,r,xe]),p.useEffect(()=>{if(!B||!a.focusId||!Ie.current)return;const C=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!C){const je=Z.findIndex(se=>se.id===a.focusId);if(je>=0){const se=ve?"":"pt"+a.ptab;if(se){const Oe=a.shown[se]||N();je>=Oe&&r({type:"more",group:se,by:je-Oe+8})}}return}Ie.current=!1;const H=Eo(),Y=C.getBoundingClientRect();Y.top>=H-2&&Y.bottom<=window.innerHeight-4||ud(C)},[B,a.focusId,a.ptab,Z,a.shown,ve,r]),p.useEffect(()=>{if(typeof window>"u")return;const C=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),H=document.querySelector(".atl2.ops, .atl2.cibles");if(!C||!H)return;const Y=()=>H.style.setProperty("--listhead-h",`${C.offsetHeight}px`);Y();const re=new ResizeObserver(Y);return re.observe(C),()=>re.disconnect()},[F,a.dens,a.mapFolded]);const We=p.useMemo(()=>{if(!B||!a.focusId)return null;if(j&&a.focusId===j.id)return j;const C=Z.find(Y=>Y.id===a.focusId)||u.find(Y=>Y.id===a.focusId)||null;if(!C)return null;const H=Q(C);return H&&H!==C.decryptHtml?{...C,decryptHtml:H}:C},[B,a.focusId,Z,u,Q,j]),xt=o.lockRowsAfter;let jt=0;const lt=(C,H)=>{let Y=a.shown[H]||N();return C.length-Y<=4&&(Y=C.length),C.slice(0,Y).map(se=>{const Oe=xt!==null&&jt>=xt;jt++;const ot=Q(se),le=ot&&ot!==se.decryptHtml?{...se,decryptHtml:ot}:se,Xe=!B&&a.dens!=="maxi"&&(a.dens==="deplie"||(z?z==="open":!!ot)),Ge=w.has(se.id)?!Xe:Xe,bt=B?vt=>{Ie.current=!0,r({type:"focus",id:vt});const Ye=v.get(vt);Ye&&(Ke(Ye)?oa(Ye):Ye.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ye.name,url:Ye.url||"",website:Ye.website||"",domain:Ye.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(yd,{o:le,locked:Oe,selected:B&&a.focusId===se.id,onSelect:bt},se.id):t.jsx(hd,{o:le,locked:Oe,open:Ge,onToggle:()=>D(se.id),selected:B&&a.focusId===se.id,echo:_===se.id,fresh:fe.has((se.name||"").trim().toLowerCase()),onSelect:bt},se.id)})},Nt="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(Z.length?"":" list-empty"),Et=t.jsxs(t.Fragment,{children:[ve?ve.map(([C,H])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:qt(C)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:C==="ma"?n.grpMa:C==="fundraising"?n.grpLev:ba.has(C)&&Ue<=1?n.grpNews:C==="nominations"?n.grpNom:C==="media"?n.grpNewsOther:C==="recrutements"?n.grpHire:ba.has(C)?n.grpNews+" · "+Je(C,g):Je(C,g)}),t.jsx("div",{className:"s",children:n.grpCount(H.filter(Y=>!De(Y)).length,H.length)})]})]}),lt(H,C)]},C)):lt(Z,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(wd,{}),!Z.length&&!(x.loading&&!u.length)&&(o.pipe&&L==="all"?t.jsx(kd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),nt=t.jsxs(t.Fragment,{children:[!pe&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Z.length})," ",ze]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Z.length})," ",n.newsWord]}),(!pe||h)&&t.jsx("span",{className:"dot",children:"·"}),F&&t.jsx(wo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[F?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),he.map(C=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:H=>{H.stopPropagation(),C.off()},children:[C.lib,t.jsx("i",{children:"×"})]},C.k)),b==="ops"&&Z.length>0&&!F&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",Z.length-Se," ",n.zoomPulseEval,Se>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",Se," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),gt=t.jsxs("div",{className:"listhead"+(F?" mapoff":""),children:[F&&t.jsx("div",{className:"lh-tools",children:t.jsx(yo,{compact:!0})}),o.showFunnel&&be&&de&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(Hs,{}),t.jsx(cd,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:nt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(ld,{}),t.jsx(dd,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(de?" on":""),"aria-pressed":de,title:n.morningDockTitle,onClick:()=>{if(de){r({type:"filters",patch:{win:"all",day:""}}),U(!1);return}Ne(!1),T(!1),R("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),U(!0)},children:["📊 ",n.morningDock(typeof((rt=x.stats)==null?void 0:rt.screened_today)=="number"?x.stats.screened_today:0)]}),X&&!X.firstVisit&&(X.added.length>0||X.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(pe?" on":""),"aria-pressed":pe,title:n.sinceSub,onClick:()=>{const C=!pe;Ne(C),T(!1),U(!1),R("all"),C&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(ce),X!=null&&X.lastDate?` · ${n.sinceSince(X.lastDate)}`:""]}),ne>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{Ne(!1),T(!1),U(!1),R("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(ne)]}),o.pipe&&ge>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const C=!h;T(C),Ne(!1),U(!1),R("all"),C&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ge)]})]}),!o.showFunnel&&nt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([C,H])=>t.jsxs("button",{type:"button","data-d":C,"aria-pressed":a.dens===C||C==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:C}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:H})]},C))}),!B&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":z==="open",onClick:()=>{S("open"),E(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":z==="closed",onClick:()=>{S("closed"),E(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var ot;const C={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},H=u.filter(le=>ea(le,C,o.pipe)&&!He(le)),Y=H.filter(le=>!Ke(le)&&!le.noCo&&(le.kind==="op"||!De(le))).length,re=H.filter(Ke).length,je=o.pipe?H.filter(le=>le.kind!=="op"&&Te(le)===1).length:0,se=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${je?` ${je}`:""}`]]:[],["eval",`${n.doEval}${Y?` ${Y}`:""}`],["explore",`${n.doExplore}${re?` ${re}`:""}`]],Oe=((ot=se.find(([le])=>le===L))==null?void 0:ot[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":$,onClick:()=>M(le=>!le),children:[Oe,t.jsx("i",{children:"▾"})]}),$&&t.jsx("div",{className:"dolist",children:se.map(([le,Xe])=>t.jsx("button",{type:"button","aria-pressed":L===le,onClick:()=>{if(M(!1),le==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}R(le),le!=="all"&&(Ne(!1),T(!1),U(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Xe},le))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:C=>r({type:"sort",key:C.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([C,H])=>t.jsx("option",{value:C,children:H},C))})]}),o.showChain&&ue.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ue.map(C=>C.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ue.length):n.chainAll(ue.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!B&&gt,a.dens!=="maxi"&&!B&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),qe("country",n.colCountry),qe("name",n.colCompany),qe("amount",n.colAmount,"h-amt",!0),qe("stage",n.colStage,"h-stade"),qe("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[qe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),qe("memo",n.colMemo)]}),o.pipe&&qe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),B?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[gt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),qe("country",n.colCountry),qe("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[qe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),qe("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Nt,children:Et})]}),t.jsxs("aside",{className:"readpane"+((We?He(We):!m&&xe)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[xe&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===xe.id,onClick:()=>r({type:"focus",id:xe.id}),children:n.doEdito}),j&&a.focusId===j.id?t.jsx("div",{className:"zoom",children:t.jsx(As,{})}):We&&o.pipe?t.jsx(bd,{o:We}):t.jsx(So,{o:We,extra:We?null:m})]})]}):t.jsx("div",{className:Nt,children:Et}),(()=>{const C=ve||[["pt"+a.ptab,Z]];let H=0,Y=0;for(const[je,se]of C){Y+=se.length;let Oe=a.shown[je]||N();se.length-Oe<=4&&(Oe=se.length),H+=Math.min(se.length,Oe)}const re=Y-H;return re<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>C.forEach(([je,se])=>r({type:"more",group:je,by:se.length,base:N()})),children:[t.jsx("span",{className:"more-label",children:n.more(re,re)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(H,Y)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),B&&b==="ops"&&a.dens!=="maxi"&&t.jsx(pd,{on:!!ve,rev:(ve||[]).map(([C,H])=>C+H.length).join("|")})]})}function Rr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Nd(e,a){const r=ji(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Ed(e,a){const n=[a.head.split("|").map(Rr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Nd(o,a.plabels),ia(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Rr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Sd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Cd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ct({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function zd({o:e,qa:a}){const{t:r,lang:n,fund:o}=G(),i=(e.cribleStatus||"").trim().toUpperCase()||(ia(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=kt(e),s=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(ct,{k:r.cdSector,v:e.sector}),t.jsx(ct,{k:r.cdStage,v:e.stage}),t.jsx(ct,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ct,{k:r.cdSite,v:e.domain||e.website}),t.jsx(ct,{k:r.cdName,v:e.contactName}),t.jsx(ct,{k:r.cdEmail,v:e.contactEmail}),t.jsx(ct,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ct,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ct,{k:r.cdAngle,v:e.angle}),t.jsx(ct,{k:r.cdDetected,v:Cd(e.date,n)})]}),c.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Ad(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:l}=G(),[s,c]=p.useState({}),g=25,d=p.useMemo(()=>n.slice(0,g),[n]);p.useEffect(()=>{d.length&&Ni(r,d.map(b=>b.name)).then(c)},[r,d]);const x=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(zd,{o:b,qa:s[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Td=50;function Tn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=G(),[i,l]=p.useState(null),[s,c]=p.useState(!1),[g,d]=p.useState(""),[x,u]=p.useState(0),[b,m]=p.useState(""),[v,y]=p.useState(!1),[f,j]=p.useState(0),N=p.useRef(null),w=p.useRef(null),E=()=>{j(0),w.current&&window.clearInterval(w.current),w.current=window.setInterval(()=>j(A=>A+1),1e3)},z=()=>{w.current&&(window.clearInterval(w.current),w.current=null)};p.useEffect(()=>()=>{N.current&&window.clearInterval(N.current),w.current&&window.clearInterval(w.current)},[]);const S=async A=>{c(!0),d(""),E();const F=await a();if(c(!1),z(),F.ok){l(F);return}if(F.busy){d(o.alertPreviewBusy);return}if(!A){d(o.alertPreviewFail);return}u(Td),z(),N.current=window.setInterval(()=>{u(D=>D>1?D-1:(N.current&&window.clearInterval(N.current),S(!1),0))},1e3)},q=async()=>{if(n||v||s)return;y(!0),m(""),E();const A=await r();y(!1),z(),m(A.ok?o.alertTestOk(A.sentTo||""):A.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||v||x>0,onClick:()=>{S(!0)},children:s?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||s,onClick:()=>{q()},children:v?o.alertBtnTestBusy:o.alertTest})]}),s&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const Dt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ve({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=G();return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function qd(){const{st:e}=G();switch(e.modal){case"chain":return t.jsx(Fd,{});case"space":return t.jsx(Rd,{});case"alert":return t.jsx(Md,{});case"queue":return t.jsx(Bd,{});case"export":return t.jsx(_d,{});case"plug":return t.jsx(Hd,{});case"recharge":return t.jsx(Wd,{});case"cover":return t.jsx(Yd,{});case"dossier":return t.jsx(Gd,{});case"crit":return t.jsx(Kd,{});case"tuto":return t.jsx(Qd,{});case"rdv":return t.jsx(Ld,{});case"memoalert":return t.jsx($d,{});default:return null}}function Ld(){const{dispatch:e,fund:a,t:r}=G(),n=a||r.rdvCoFallback;return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Jr,children:jn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Sa}`,children:Sa})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Yi,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Fd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:l,evalBusy:s,caps:c,memoQueued:g,doAnalyse:d}=G(),x=i==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,m=u[b],v=b>=u.length;return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Ut(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(ht(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Je(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Ht(m.amountEur,o)})]}),Re(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:m,lg:!0})," ",t.jsx(Ma,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&De(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&De(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Tt(m)==="retenu"?"var(--brand)":Tt(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Tt(m)==="retenu"?"✓ "+n.kept:Tt(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&c.pipe&&Te(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(x&&De(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function Rd(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=G(),i=o==="client",l=p.useMemo(()=>i?r.filter(x=>De(x)):[],[r,i]),s=p.useMemo(()=>wn(l.filter(x=>Tt(x)==="retenu"),{key:"signal",dir:-1}),[l]),c=p.useMemo(()=>l.filter(x=>Tt(x)==="ecarte"),[l]),g=e.spaceTab==="retenu"?s:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ve,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Md(){const{mode:e}=G();return e==="client"||e==="apercu"?t.jsx(Od,{}):t.jsx(Pd,{})}function Od(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=G(),[i,l]=p.useState("d"),s=o!=="client";return t.jsxs(Ve,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Dd,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(Id,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(Co,{})]})}function Dd({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=p.useState(null),[s,c]=p.useState(!1),[g,d]=p.useState(0);p.useEffect(()=>{let q=!0;return c(!1),Un(a).then(A=>{q&&(A?l(A):c(!0))}),()=>{q=!1}},[a,g]);const x=p.useRef({}),[u,b]=p.useState({}),[m,v]=p.useState(!1),[y,f]=p.useState(!1),j=p.useRef(null);p.useEffect(()=>()=>{j.current&&window.clearTimeout(j.current)},[]);const N=q=>{const A=x.current;Object.keys(A).length&&(v(!0),Un(a,A).then(F=>{if(!F){v(!1),o(e.actErr);return}if(F.throttled&&q<3){j.current=window.setTimeout(()=>N(q+1),5400);return}if(x.current={},b({}),l(F),v(!1),F.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},w=q=>{r||(x.current={...x.current,...q},b(A=>({...A,...q})),j.current&&window.clearTimeout(j.current),j.current=window.setTimeout(()=>N(1),700))};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(q=>q+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const E={...i,...u},z=q=>!E.sections||E.sections.includes(q),S=q=>{const A=E.sections||e.alertSec.map(([F])=>F);w({sections:z(q)?A.filter(F=>F!==q):[...A,q]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":E.enabled===!0,disabled:r,style:E.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!E.enabled}),children:E.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>w({hour:Math.max(6,(E.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[E.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>w({hour:Math.min(21,(E.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([q,A])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:z(q),disabled:r,onChange:()=>S(q)}),t.jsxs("span",{children:[A,q==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},q))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Tn,{label:e.alertPreview,readOnly:r,onPreview:()=>Ri(a),onTest:()=>Fi(a)}),E.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),E.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",E.email_lead,E.last_sent?` · ${e.updatedAt(E.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Id({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,l]=p.useState(null),[s,c]=p.useState(!1),[g,d]=p.useState(0);p.useEffect(()=>{let m=!0;return c(!1),Hn(a).then(v=>{m&&(v?l(v):c(!0))}),()=>{m=!1}},[a,g]);const x=m=>{r||Hn(a,m).then(v=>{if(!v){o(e.actErr);return}l(v),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Tn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Oi(a),onTest:()=>Mi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Co(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=G(),[l,s]=p.useState(i||""),[c,g]=p.useState(!1),[d,x]=p.useState(!1);p.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(f=>Re(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){x(!0);try{await fetch(`${gn}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Je(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Ut(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!i,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Pd(){const{t:e}=G();return t.jsx(Ve,{title:e.alertTitle,icon:"🔔",children:t.jsx(Co,{})})}function Bd(){var D,B;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:l,caps:s,dispatch:c,liveMemos:g}=G(),[d,x]=p.useState(()=>Pa(r)),[u,b]=p.useState(()=>!Pa(r)),[m,v]=p.useState([]),[y,f]=p.useState(0),j=n==="client",N=p.useMemo(()=>{const L=new Map;return o.forEach(R=>{const h=(R.name||"").trim().toLowerCase();h&&!L.has(h)&&L.set(h,R)}),L},[o]);p.useEffect(()=>{let L=!0;return(!Pa(r)||y>0)&&b(!0),(async()=>{const[R,h]=await Promise.all([vn(r,y>0),Br(a)]);L&&(R&&x(R),b(!1),v(h))})(),()=>{L=!1}},[a,r,y]);const w=u&&!d,E=(d==null?void 0:d.per_day)??0,z=((D=d==null?void 0:d.analyzed_today)==null?void 0:D.length)??0,S=d==null?void 0:d.offre,q=(d==null?void 0:d.pool_meta)||[],A=p.useMemo(()=>{const L=new Map;for(const R of(d==null?void 0:d.scheduled)||[])for(const h of R.names||[])L.has(h)||L.set(h,{label:R.day_label,date:R.date});return L},[d==null?void 0:d.scheduled]),F=(d==null?void 0:d.in_progress)||[];return t.jsxs(Ve,{title:e.queueTitle,wide:!0,children:[S&&t.jsxs("div",{className:"qoffre"+(S.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:S.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:S.delai})]}),t.jsx("span",{className:"osp"}),S.rythme>0?t.jsx("span",{className:"or",children:e.qRate(S.rythme)}):S.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(S.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:w?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(z,z+(((B=d==null?void 0:d.pool_order)==null?void 0:B.length)??0))}})}),S&&t.jsxs("div",{className:"qeta",children:[S.file===0?e.qEtaDone:S.rythme<=0?e.qEtaPaused:e.qEta(S.file,S.rythme,S.jours_restants),S.en_retard&&t.jsxs("em",{children:[" ",e.qLate(S.delai,S.plafond)]})]}),!w&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(E)}),(S==null?void 0:S.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(F.length>0||g.items.some(L=>L.status==="boot"||L.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(L=>L.status==="boot"||L.status==="running"||L.status==="error").map(L=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:L.name}),t.jsx("span",{className:"qd",children:L.memoType||""}),t.jsx(ka,{item:L,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+L.name)),F.filter(L=>!g.liveOf(L.name)).map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.name}),t.jsxs("span",{className:"qd",children:[L.memo_type||"",L.age_min?` · ${Math.round(L.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:L.state||""})]},"ip-"+L.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(L=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:L.company}),t.jsxs("span",{className:"qd",children:[L.memo_type,typeof L.est_min=="number"?` · ~${L.est_min} min`:""]}),t.jsx("span",{className:"qt",children:L.status}),L.url&&t.jsx("a",{className:"qgo",href:L.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),j&&L.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{$n(a,L.company,"retry").then(()=>f(R=>R+1))},children:e.queueRetry}),j&&L.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{$n(a,L.company,"delete").then(()=>f(R=>R+1))},children:e.queueDelete})]},L.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",w?e.qUpNextWait:e.qUpNext(q.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[w&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!w&&q.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),q.map((L,R)=>{const h=A.get(L.name),T=N.get((L.name||"").trim().toLowerCase()),_=g.liveOf(L.name),J=!!(T&&l.has(T.id))||!!(_&&(_.status==="boot"||_.status==="running")),$=!!(T&&Te(T)===1&&!T.memoUrl)&&!_;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:L.name}),L.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof L.score=="number"&&t.jsx("span",{className:"qs2",children:L.score}),_&&(_.status==="boot"||_.status==="running")&&t.jsx(ka,{item:_,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),$&&(s.lockActions||!j?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:J,onClick:()=>{i(T),f(M=>M+1)},children:J?e.actAnalyseQueued:e.actAnalyse})),L.excerpt&&t.jsx("span",{className:"qex",children:L.excerpt})]},L.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([L,R])=>t.jsxs("li",{children:[t.jsx("b",{children:L})," — ",R]},L))})]})}function _d(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:l}=G(),s=`${Dt}/cibles/list.csv?token=${a}`,c=`${Dt}/cibles/list.json?token=${a}`,g=`${Dt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,x=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{Sd(Ed(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ve,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:f,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function $d(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=G(),i=o!=="client",[l,s]=p.useState(null),[c,g]=p.useState(!1),[d,x]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return g(!1),_n(a).then(j=>{f&&(j?s(j):g(!0))}),()=>{f=!1}},[a,d]);const m=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(i||!l)return;const j={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??m()};b(!0),_n(a,j).then(N=>{if(b(!1),!N){n(e.memoAlertErr);return}s(N),r(e.memoAlertSaved)})};if(c)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(Ve,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:i||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Ud,{value:l.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||u,onChange:()=>v({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:j})]},f))}),t.jsx(Tn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Si(a,y),onTest:()=>Ei(a,y)})]})}function Ud({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,l]=p.useState(e);p.useEffect(()=>{l(e)},[e]);const s=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>l(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!c,onClick:()=>o(i.trim()),children:n})]})]})}function Hd(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=G(),[i,l]=p.useState(null),[s,c]=p.useState(!1),[g,d]=p.useState(null),[x,u]=p.useState(""),[b,m]=p.useState(0);p.useEffect(()=>{let N=!0;return c(!1),Za(a).then(w=>{N&&(w?l({configured:w.configured,url_hint:w.url_hint}):c(!0))}),Ai(a).then(w=>{N&&d(w)}),()=>{N=!1}},[a,b]);const v=(N,w)=>{o&&Za(a,N).then(E=>{if(!E||E.ok===!1){n(e.actErr);return}N.test&&E.sent===!1?n(e.plugTestThrottled):r(w),m(z=>z+1)})},y='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',f=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${Dt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ve,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(N=>N+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!o,onChange:N=>u(N.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!x.trim(),onClick:()=>v({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>v({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:f}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(f).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Vd,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:y}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var N;(N=navigator.clipboard)==null||N.writeText(y).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Vd(){const{t:e,token:a,lang:r}=G(),[n,o]=p.useState("valides"),[i,l]=p.useState(!1),[s,c]=p.useState(null),[g,d]=p.useState(null),[x,u]=p.useState(!1),[b,m]=p.useState(!1),[v,y]=p.useState(null),[f,j]=p.useState(null),[N,w]=p.useState(null),E=`atl2:bulk:${a}:${n}`;p.useEffect(()=>{Za(a).then(B=>{j(B&&B.configured?B.url_hint||"webhook":null)})},[a]),p.useEffect(()=>{c(null),d(null),u(!1),y(null);try{const B=JSON.parse(localStorage.getItem(E)||"null");w(B&&Date.now()-Date.parse(B.t)<24*3600*1e3?B:null)}catch{w(null)}},[E]);const z=async()=>{l(!0),u(!1),y(null);const B=await qi(a,n);c(B),d(B.ok?n:null),l(!1)},S=p.useRef(!1),q=async()=>{if(S.current)return;S.current=!0,m(!0);const B=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await Li(a,n,"webhook",void 0,B)}finally{S.current=!1}if(m(!1),u(!1),y(L),L.ok&&(L.pushed||0)>0){const R={t:new Date().toISOString(),n:L.pushed||0};w(R);try{localStorage.setItem(E,JSON.stringify(R))}catch{}}},A=s!=null&&s.ok&&s.ready||0,F=!!(s!=null&&s.ok)&&g===n&&A>0&&!!f&&!N,D=N?new Date(N.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:B=>o(B.target.value),children:e.plugBulkTabs.map(([B,L])=>t.jsx("option",{value:B,children:L},B))}),t.jsx("button",{type:"button",className:"abtn",disabled:i,onClick:()=>{z()},children:i?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),N&&t.jsx("p",{className:"mnote",children:e.bulkLocked(D,N.n)}),!N&&!!(s!=null&&s.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!N&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),F&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),F&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(A,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{q()},children:b?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),v&&(v.ok?v.replayed?t.jsx("p",{className:"mnote",children:v.pending?e.bulkPending:e.bulkReplayed}):(v.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(v.pushed||0,v.linkedinReady||0,v.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:v.error||e.actErr}))]})}function Wd(){const{t:e,data:a,lang:r}=G(),n=a.credits,o=a.email,i=async l=>{if(!o)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${gn}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ve,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Gd(){const{t:e}=G();return t.jsx(Ve,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Ad,{})})}function Yd(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:l,flash:s}=G(),[c,g]=p.useState(null),[d,x]=p.useState(!1);p.useEffect(()=>{let A=!0;if(i)return vn(i).then(F=>{A&&F&&typeof F.per_day=="number"&&g(F.per_day)}),()=>{A=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let A=!0;return zi(o).then(F=>{A&&b(F)}),()=>{A=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(A=>A.kind==="target"&&De(A)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(v/y*100)):null,j=(m==null?void 0:m.window_days)||30,N=v>0?v/j:0,w=y>0?Math.max(0,y-v):0,z=y>0&&N>0&&v>=100?Math.round(w/N):null,S=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),q=A=>{d||!l||(x(!0),Ti(o,A).then(F=>{if(x(!1),F===null){s(e.actErr);return}g(F),s(e.alertSaved)}))};return t.jsxs(Ve,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(S(v))}),y>0&&t.jsx("span",{children:e.covOf(S(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),z!==null&&t.jsx("p",{className:"mnote",children:e.covEta(z)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),N>=1&&t.jsx("p",{className:"mnote",children:e.covPace(S(N))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:S(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((A,F)=>t.jsxs("tr",{className:A.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[A.code,A.geo?` · ${A.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof A.n=="number"?S(A.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:A.source}),A.elargi&&t.jsx("em",{children:e.covWide(String(A.demande||""))}),A.erreur&&t.jsx("em",{children:e.covMissing})]})]},F)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:S(u.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),l&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:c===A?"on":"",disabled:d,onClick:()=>q(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function Kd(){var f,j,N;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:l,lang:s}=G(),c=n==="client",g=p.useMemo(()=>{const w=new Set;return a.forEach(E=>{E.angle&&w.add(E.angle)}),[...w]},[a]),[d,x]=p.useState(""),[u,b]=p.useState(""),[m,v]=p.useState(!1),y=async()=>{const w=d.trim();if(!(!w||m||!c)){v(!0),b("");try{const z=await(await fetch(`${Dt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(z.reply&&b(String(z.reply)),z.job_id){b(e.critChatRunning);const S=async()=>{const q=await fetch(`${Dt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:z.job_id})}).then(A=>A.json()).catch(()=>null);if(q&&q.done){b(String(q.reply||q.clarification||q.summary||"✓")),v(!1),q.applied&&o(e.alertSaved);return}setTimeout(()=>{S()},8e3)};setTimeout(()=>{S()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs(Ve,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=i==null?void 0:i.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var E,z;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((E=w.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(S=>t.jsx("li",{children:S},S))})]}),!!((z=w.out)!=null&&z.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(S=>t.jsx("li",{children:S},S))})]})]})]},w.title)})]}),!!((N=i==null?void 0:i.gate)!=null&&N.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||m,onChange:w=>x(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!d.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Ci,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(No[w]||"v-cons"),children:w}),t.jsx("span",{children:E})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",E]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Qd(){const{t:e,dispatch:a,startTour:r}=G(),n=o=>{var i,l;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ve,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+l))})]})}const zo="atl2:mapfold",Jd=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(zo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Xd=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Ao=p.createContext(null),G=()=>{const e=p.useContext(Ao);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=G(),n=Re(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Vn(n,r),children:[n.emoji," ",Vn(n,r)]}):null}function Ma({o:e,src:a}){const{lang:r,t:n}=G(),o=Re(e);if(!o)return null;const i=$i(o),l=Ui(o);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Hr(o,r))+" · "+n.win7(Vr(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Zd(e,a,r){const n=(r||"").trim();if(n){const i=e.find(l=>(l.url||"")===n);if(i)return i}const o=Be(a);if(o)return e.find(i=>Be(i.name)===o)||e.find(i=>{const l=Be(i.name);return l.length>=3&&(o.includes(l)||l.includes(o))})}function ec(){const{scoped:e,t:a,st:r,dispatch:n}=G(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,l=e.filter(x=>!He(x)),s=l.length,c=l.filter(x=>!x.noCo).length,g=l.filter(x=>!!x.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:s}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function tc(){const{t:e,lang:a,data:r,dispatch:n}=G(),o=r.stats,i=s=>s.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const l=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:l>0?e.covOf(i(l)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function To({o:e}){const{lang:a}=G(),r=_i(e.cc),n=e.cc?Ut(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Mr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",ac=!1;function nc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const qo=e=>`atl2:tour:${e||"anon"}`;function rc(e){try{return localStorage.getItem(qo(e))==="1"}catch{return!0}}function Or(e){try{localStorage.setItem(qo(e),"1")}catch{}}function oc(e,a,r,n,o,i){const l=e.tourT,s=e.howto;return[{sel:".atl2 .ident",title:l.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:l.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:l.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:l.live,body:e.fhintLive},{sel:".atl2 .goal",title:l.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:l.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:l.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:l.tuto,body:s[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:l.demand,body:s[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:l.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:l.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:l.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:l.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:l.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:l.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:l.tools,body:s[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:l.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:l.crit,body:s[0][0],modal:"crit"}].filter(Boolean)}function cc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var oe;const{lang:l}=Di(),s=ss[l],c=vs(e,l,a),[g,d]=p.useReducer(ks,void 0,()=>ys((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?Xd():Jd()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=p.useRef(!0);p.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(zo,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const k=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return k(),window.addEventListener("resize",k),()=>window.removeEventListener("resize",k)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var k;(k=u.current)==null||k.call(u,g.filters)},[g.filters]);const[b,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const k=localStorage.getItem("atl2:chrome-mode");if(k==="eval"||k==="filt"||k==="both")return k;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=p.useState(null),[f,j]=p.useState(null),[N,w]=p.useState(null),[E,z]=p.useState({kept:0,dropped:0}),[S,q]=p.useState(!1),[A,F]=p.useState(""),[D,B]=p.useState(!1),[L,R]=p.useState(null),[h,T]=p.useState(!1),[_,J]=p.useState(!1),[,$]=p.useState(0),M=()=>$(k=>k+1),K=p.useRef([]),W=p.useRef(new Set),Q=p.useRef(new Set),[X,be]=p.useState([]),[U,de]=p.useState([]),[pe,Ne]=p.useState(0),fe=p.useRef(new Map),ce=p.useRef(null),{mode:ge}=c,Z=p.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),ee=Z.pipe,ne=c.session.token||"",ue=ge==="client"&&!e;p.useEffect(()=>{if(!ne||!ee)return;let k=!0;const P=async()=>{const ae=await Hi(ne);!k||!ae||(de(ae.runs),Ne(Date.now()/1e3-ae.now),be(Ce=>Ce.filter(we=>!ae.runs.some(it=>Be(it.company)===Be(we.name)))))};P();const O=X.length>0||U.some(ae=>ae.status==="running"),V=window.setInterval(()=>{P()},O?8e3:25e3);return()=>{k=!1,window.clearInterval(V)}},[ne,ee,X.length,U.some(k=>k.status==="running")]);const Se=p.useMemo(()=>{const k=[],P=new Set;for(const O of X){const V=Be(O.name);!V||P.has(V)||(P.add(V),k.push({name:O.name,id:O.id,status:"boot",started:O.started,estMin:O.estMin,memoType:"instant"}))}for(const O of U){const V=Be(O.company);if(!V||P.has(V))continue;P.add(V);const ae=O.status==="error"?"error":O.status==="done"?"done":"running";k.push({name:O.company,status:ae,started:O.started||0,estMin:O.est_min||(O.memo_type==="detailed"?40:15),url:O.url,error:O.error,memoType:O.memo_type,note:O.note})}return k},[X,U]),ze=k=>Se.find(P=>Be(P.name)===Be(k))||null,ie=(k,P)=>{be(O=>O.some(V=>Be(V.name)===Be(k.name))?O:[...O,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:P==="detailed"?40:15}]),W.current.add(k.id),M()};p.useEffect(()=>{if(document.querySelector(`link[href="${Mr}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=Mr,document.head.appendChild(k)},[]);const he=(k,P=!1)=>{F(k),B(P),ce.current&&clearTimeout(ce.current),ce.current=setTimeout(()=>F(""),P?4200:2400)},_e=k=>he(k,!0),qe=p.useMemo(()=>{const k=new Map;return c.dossiers.forEach(P=>{P.id&&k.set(P.id,P)}),k},[c.dossiers]),ve=p.useMemo(()=>c.dossiers.filter(k=>ea(k,g,ee)),[c.dossiers,g,ee]),Ue=p.useRef(!1);p.useEffect(()=>{if(Ue.current||e||c.loading||!c.dossiers.length)return;if(!Z.showFunnel||rc(c.session.token||"")){Ue.current=!0;return}Ue.current=!0;const k=window.setTimeout(()=>{Or(c.session.token||""),T(!0)},700);return()=>window.clearTimeout(k)},[e,c.loading,c.dossiers.length,Z.showFunnel,c.session.token]);const ye=p.useMemo(()=>c.dossiers.filter(k=>js(k,g,ee,c.favIds)),[c.dossiers,g,ee,c.favIds]),Ie=p.useMemo(()=>Ii(ve.filter(k=>!Ke(k)),c.favIds),[ve,c.favIds]),xe=p.useRef(!1);p.useEffect(()=>{if(xe.current)return;if(!ee||a==="ops"){xe.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){xe.current=!0;return}if(c.loading)return;xe.current=!0;const k=Pi(Ie);k!==g.ptab&&d({type:"ptab",tab:k})},[ee,a,n==null?void 0:n.ptab,c.loading,Ie,g.ptab]);const We=p.useMemo(()=>{const k=Zr(c.dossiers);return k?ht(k)===0?s.tourToday:eo(k,l):s.tourNoRun},[c.dossiers,s,l]),xt=p.useMemo(()=>c.dossiers.some(k=>!!k.memoUrl||!!k.summary||It(k)),[c.dossiers]),[jt,lt]=p.useState(!1);p.useEffect(()=>{if(c.loading){lt(!1);return}if(c.dossiers.length>0||c.error){lt(!0);return}const k=window.setTimeout(()=>lt(!0),6e3);return()=>window.clearTimeout(k)},[c.loading,c.dossiers.length,c.error]);const Nt=(c.marketEstimate||0)>0||typeof((oe=c.stats)==null?void 0:oe.screened)=="number"&&c.stats.screened>0,Et=p.useMemo(()=>[1,0,2,4,5,3].find(k=>(Ie[k]||0)>0)??0,[Ie]),nt=yn.find(k=>k.key===g.continent),gt=g.continent==="monde"?s.contWorld:(l==="fr"?nt==null?void 0:nt.fr:nt==null?void 0:nt.en)||"";p.useEffect(()=>{const k=P=>{var V;const O=(((V=P.detail)==null?void 0:V.name)||"").trim();O&&St(null,O)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),p.useEffect(()=>{const k=P=>{const O=P.detail||{},V=String(O.id||"").trim(),ae=String(O.name||"").trim(),Ce=String(O.url||"").trim(),we=V&&qe.get(V)||Zd(c.dossiers,ae,Ce);if(we){if(j(null),ea(we,g,ee)||(g.continent!=="monde"&&we.continent!==g.continent&&d({type:"continent",key:we.continent||"monde"}),d({type:"reset"})),ee&&we.kind!=="op"){const ke=Te(we);typeof ke=="number"&&ke!==g.ptab&&d({type:"ptab",tab:ke})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:we.id}),(we.noCo||["media","nominations","recrutements"].includes(we.engine||""))&&(we.url||we.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:we.url||"",text:[we.headline,we.tagline].filter(Boolean).join(`
`)}})):we.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:we.name,url:we.url||"",website:we.website||"",domain:we.domain||""}}));return}!ae&&!Ce||(d({type:"focus",id:V||null}),j({name:ae,headline:String(O.text||"").trim()||ae,url:Ce,card:O.card}),Ce&&(ja(ae)||!ae)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ce,text:String(O.text||"").trim()}})):ae&&!ja(ae)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ae}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),p.useEffect(()=>{const k=V=>{const ae={},Ce=String((V==null?void 0:V.sector)||"").trim();Ce&&(ae.sector=[Ce]);const we=String((V==null?void 0:V.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(we)&&(ae.day=we);const it=String((V==null?void 0:V.search)||"").trim();it&&(ae.search=it);const ke=String((V==null?void 0:V.dealKind)||"").trim();(ke==="ma"||ke==="levee"||ke==="other")&&(ae.dealKind=[ke]),Object.keys(ae).length&&d({type:"filters",patch:ae})},P=V=>k(V.detail),O=V=>{V.data&&V.data.type==="pp-filter"&&k(V.data)};return window.addEventListener("ppmap:filter",P),window.addEventListener("message",O),()=>{window.removeEventListener("ppmap:filter",P),window.removeEventListener("message",O)}},[]),p.useEffect(()=>{const k=P=>{var ae;const O=(((ae=P.detail)==null?void 0:ae.name)||"").trim().toLowerCase();if(!O)return;const V=c.dossiers.find(Ce=>(Ce.name||"").trim().toLowerCase()===O);V&&d(a==="ops"?{type:"focus",id:V.id}:{type:"popup",id:V.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const St=(k,P)=>{const O=((k==null?void 0:k.name)||P||"").trim();if(!ue){w({kicker:O});return}!O||S||(q(!0),(async()=>{try{let V=O;const ae=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(ae)V=ae;else try{const ke=await $r(O);if(ke!=null&&ke.website)V=ke.website;else if(((ke==null?void 0:ke.candidates)||[]).length===1)V=ke.candidates[0].url;else if(((ke==null?void 0:ke.candidates)||[]).length>1){K.current=[{name:O,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(ke.candidates||[]).slice(0,5)},...K.current].slice(0,8),M();return}}catch{}const Ce=await Ur(ne,V,"atelier2"),we={name:Ce.company||O,verdict:Ce.verdict,reason:Ce.reason||"",remaining:Ce.remaining??null};K.current=[we,...K.current].slice(0,8),Ce.verdict==="kept"&&z(ke=>({...ke,kept:ke.kept+1})),Ce.verdict==="ruled_out"&&z(ke=>({...ke,dropped:ke.dropped+1}));const it=k||c.dossiers.find(ke=>(ke.name||"").toLowerCase()===O.toLowerCase());it&&(Ce.verdict==="kept"?it.verdict=it.verdict||"MATCH":Ce.verdict==="ruled_out"&&(it.verdict="NO MATCH"),Ce.reason&&(it.reasoning=Ce.reason)),M()}finally{q(!1)}})())},Me=k=>{if(!ue){w({kicker:k.name});return}ie(k,"instant"),Vt(ne,"fast_request",k.name||"",""),he(s.memoInstantSent(k.name))},Ct=k=>fe.current.get(k.id)??c.thumbs.get((k.name||"").trim().toLowerCase()),Pe=(k,P)=>d({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:P}}),rt=async(k,P,O)=>{const V=k.ceoStatus||"";k.ceoStatus=P,M();const ae=await Ba(ne,{status:P,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(O==null?void 0:O.note)!==void 0?{note:O.note}:{},...O!=null&&O.via?{via:O.via}:{}});return ae.ok?ae.skipped?(k.ceoStatus=V,M(),_e(s.actNotPersisted),!1):((O==null?void 0:O.undo)!==!1&&Pe(k,V),O!=null&&O.msg&&he(O.msg),(P==="Validé"||P==="Écarté")&&!k.ceoNote&&(O==null?void 0:O.note)===void 0&&R({o:k,yes:P==="Validé"}),!0):(k.ceoStatus=V,M(),_e(s.actErr),!1)},C=async(k,P)=>{const O=await Ba(ne,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:P,via:"note"});return!O.ok||O.skipped?(_e(O.skipped?s.actNotPersisted:s.actErr),!1):(k.ceoNote=P,M(),!0)},H=p.useRef(new Map),Y=k=>H.current.has(k.id)?H.current.get(k.id):c.stages.get((k.name||"").trim().toLowerCase()),re=(k,P)=>{H.current.set(k.id,P),M()},je=(k,P)=>{ue&&rt(k,P?"Validé":"Écarté",{msg:P?s.decidedYes(k.name):s.decidedNo(k.name)})},se=k=>{ue&&rt(k,"À trancher",{msg:s.promoted(k.name)})},Oe=k=>{ue&&(async()=>{const P=k.ceoStatus||"";k.ceoStatus="Retenu",M();const O=await Ba(ne,{status:"Retenu",check_id:k.checkId,company:k.name});if(!O.ok||O.skipped){k.ceoStatus=P,M(),_e(O.skipped?s.actNotPersisted:s.actErr);return}Pe(k,P),he(s.repeched(k.name))})()},ot=()=>{const k=g.undo[g.undo.length-1];if(!k){he(s.undoNone);return}const P=qe.get(k.id);if(!P){d({type:"undoPop"}),he(s.undoNone);return}let O=k.prevCeoStatus;if(!O)if((P.verdict||"").toUpperCase().includes("CALL"))O="À trancher";else{he(s.undoLockedTitle);return}(async()=>await rt(P,O,{undo:!1})&&(d({type:"undoPop"}),P.ceoStatus=k.prevCeoStatus,M(),he(s.undoDone(P.name))))()},le=k=>{ue&&(Q.current.add(k.id),M(),(async()=>{const P=await Vi(ne,k.name,"email");if(!P||P.ok===!1){Q.current.delete(k.id),M(),_e(s.actErr);return}Vt(ne,"approach",k.name||"",""),he(s.actApproachSent)})())},Xe=(k,P)=>{ue&&(async()=>{if(!(await Vt(ne,P?"yes":"no",k.name||"","")).ok){_e(s.actErr);return}fe.current.set(k.id,P?"yes":"no"),M(),he(P?s.thumbUpDone:s.thumbDnDone)})()},Ge=k=>{!ue||!It(k)||(ie(k,"detailed"),Vt(ne,"detailed_request",k.name||"",""),he(s.memoDeepSent(k.name)))},bt=k=>{const P=new Set(c.favIds),O=P.has(k.id);O?P.delete(k.id):P.add(k.id),c.setFavIds(P),ue&&Wi(ne,{id:k.id,co:k.name},O)},vt=()=>{!ue||_||window.confirm(s.identSyncConfirm)&&(J(!0),(async()=>{const k=await Gi(ne);J(!1),k?he(s.identSyncDone):_e(s.actErr)})())},Ye=/proplace/i.test(c.fund||""),Oa=k=>{!ue||!Ye||(Vt(ne,"onboard_request",k.name||"",""),he(s.onboardSent(k.name)))},I={st:g,dispatch:d,t:s,lang:l,mode:ge,caps:Z,pipe:ee,token:ne,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:Oe,thumbOf:Ct,canWrite:ue,commitStatus:rt,saveNote:C,stageOf:Y,setStage:re,flashErr:_e,startTour:()=>T(!0),dossiers:c.dossiers,scopedAll:ve,scoped:ye,counts:Ie,byId:qe,contName:gt,favIds:c.favIds,toggleFav:bt,askEvaluate:St,doAnalyse:Me,doDecide:je,doPromote:se,doApproach:le,doThumb:Xe,doDeep:Ge,doUndo:ot,doSync:vt,doOnboard:Oa,outbound:Ye,memoQueued:W.current,liveMemos:{items:Se,serverOff:pe,liveOf:ze},approachDone:Q.current,sessTally:E,evalCards:K.current,evalBusy:S,markRow:y,markedId:v,flash:he,focusExtra:f};p.useEffect(()=>{const k=P=>{P.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const te=k=>ne?t.jsx(Ss,{token:ne,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(Ao.Provider,{value:I,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ne?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:ps}),te(t.jsxs("div",{className:"app"+(ee?" pipe":"")+(ne?" has-thesis":""),children:[Z.showTicker&&t.jsx(st,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ne?" live-stack--cibles":""),children:[t.jsx(Fs,{}),!!ne&&t.jsx(Cs,{})]})}),Z.showIdent&&t.jsx(st,{name:"identite",children:t.jsx(Vs,{})}),!1,ac,Z.showFunnel&&t.jsx(st,{name:"entonnoir",children:t.jsx(ic,{})}),!g.mapFolded&&t.jsx(st,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(wo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(ec,{}),a!=="ops"&&Z.showFunnel&&t.jsx(tc,{}),t.jsx(Ul,{}),t.jsx(yo,{})]})]})}),Z.showDemand&&ee&&t.jsx(st,{name:"direct",children:t.jsx(Xi,{items:Se,serverOff:pe,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([k,P])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===k,onClick:()=>{m(k);try{localStorage.setItem("atl2:chrome-mode",k)}catch{}},children:P},k))}),Z.showDemand&&t.jsx(st,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Ql,{})})}),Z.showDemand&&g.memoConsole&&t.jsx(st,{name:"console",children:t.jsx(Xl,{})}),Z.pipe&&!!ne&&t.jsx(st,{name:"moteurs",children:t.jsx(rs,{})}),t.jsx(st,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(jd,{})}),c.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:s.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(st,{name:"fiche",children:t.jsx(id,{})}),t.jsx(st,{name:"modales",children:t.jsx(qd,{})}),t.jsx(Os,{}),L&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:L.o.name}),t.jsx(_s,{placeholder:L.yes?s.whyYesPh:s.whyNoPh,onDone:k=>{const P=L.o;R(null),k&&C(P,k).then(O=>{O&&he(s.csNoteSaved)})}})]}),h&&jt&&t.jsx(Us,{steps:oc(s,We,xt,Et,Nt,Ie[3]||0),onClose:()=>{T(!1),Or(ne)}}),t.jsx(nc,{}),Z.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Jr,children:jn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Sa}`,children:Sa})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),A&&t.jsx("div",{className:"flash on"+(D?" err":""),children:A}),N&&t.jsx(Bi,{variant:"acquirer",initialCompany:Dr().co,initialWebsite:Dr().site,onClose:()=>w(null)})]})})}function ic(){const{t:e}=G(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Dr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function sc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{To as FlagCell,wt as SigBadge,Ma as SigWin,cc as default,sc as fmtShort,G as useV2};
