...
.atl2 .bulk .side .hint{white-space:nowrap}`,Cs=`
...
`,As=Ss+Cs+zs;function sn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function qs(){const e=sn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ts(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=qs();return r==="0"?"client":r==="1"||sn("embed")==="1"&&sn("chrome")==="1"?"apercu":"client"}const Ls={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Rs=e=>Ls[e];function Ea(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Et=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Xr(a)||Ea(a))&&(e.noCo=!0)}return Object.assign(e,{continent:fi(e.cc)})};function Va(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Fs=60*60*1e3;function Ms(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Fs?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Os=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Ds(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:ni(),[e,n]),i=p.useMemo(()=>n?"visiteur":Ts(e,o),[e,o,n]),s=p.useMemo(()=>Rs(i),[i]),l=i!=="visiteur",c=Os(r),[x,d]=p.useState([]),[h,u]=p.useState(""),[b,m]=p.useState(null),[v,y]=p.useState(null),[f,k]=p.useState(null),[E,w]=p.useState(()=>new Map),[N,q]=p.useState(()=>new Map),[z,F]=p.useState(""),[T,D]=p.useState(new Set),[O,U]=p.useState(null),[M,I]=p.useState(!0),[g,R]=p.useState(!1),[$,X]=p.useState(0),[j,S]=p.useState(0),L=p.useRef(0),B=p.useMemo(()=>{var W;if(i!=="client")return"";try{return((W=ri())==null?void 0:W.email)||""}catch{return""}},[i]);p.useEffect(()=>{const W=++L.current;let ue=!0;const K=()=>ue&&W===L.current,ce=(l&&o.token?o.token:"pub:"+a)+(c?":"+c:""),le=Ms(ce);return le?(d(le.objs.map(Et)),le.fund&&u(le.fund),m(le.marketEstimate??null),y(le.criteria??null),k(le.stats??null),F(le.generatedAt||""),I(!1)):I(!0),(async()=>{try{if(r==="ops"){const be=await _a(),fe=((be==null?void 0:be.recent_ops)||[]).map(de=>{const pe=va(de.company_name||de.title?de:{...de,title:(de.headline_fr||de.headline||"").slice(0,120)},a),ge=String(de.rubrique||"").toLowerCase();return pe&&(ge==="nominations"||ge==="recrutements")&&(pe.engine=ge),pe&&!String(de.company_name||"").trim()&&(pe.noCo=!0),pe}).filter(de=>!!de).map(de=>(Xr((de.name||"").trim())||(de.noCo=!0),de));try{const de=oi(),pe=await ii(),ge=((pe==null?void 0:pe.date)||"").slice(0,10),Q=de?de.doc:pe,re=si(Q),he=((de==null?void 0:de.day)||(Q==null?void 0:Q.date)||ge||"").slice(0,10);if(he&&re.length){const ke=new Set;for(const ne of fe){if((ne.date||"").slice(0,10)!==he)continue;const ve=_n(re,ke,ne.name,"");ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}for(const ne of fe){if(ne.decryptHtml||(ne.date||"").slice(0,10)!==he)continue;const ve=_n(re,ke,"",ne.headline||ne.tagline||ne.name);ve>=0&&(ke.add(ve),ne.decryptHtml=re[ve].html)}}if(he){const ke=((Q==null?void 0:Q.title_fr)||"").trim(),ne=((Q==null?void 0:Q.lead_fr)||"").trim(),ve=li(Q),oe=((Q==null?void 0:Q.url)||"").trim();ke&&(ve||oe)&&fe.unshift({id:`edito:${he}`,kind:"op",name:ke,cc:null,date:he,engine:"edito",dealKind:"other",headline:ke,tagline:ne||ke,decryptHtml:ve||void 0,url:oe,noCo:!0})}}catch{}if(!K())return;d(fe.map(Et)),ca(ce,{objs:fe})}else if(typeof r=="object"){const fe=(await $n()||[]).filter(pe=>(pe.slug||"")===r.research).map(pe=>Un(pe,a)).filter(pe=>!!pe),de=Va(await Hn(fe,a));if(!K())return;d(de.map(Et)),ca(ce,{objs:de})}else if(l&&o.token){const be=di(o.token),fe=_a(),de=ci(o.token),pe=pi(o.token),ge=ui(o.token),Q=await be;let re=Q?Q.targets:[];K()&&Q&&(u(Q.fund||""),m(Q.marketEstimate??null),y(Q.criteria??null),k(Q.stats??null),F(Q.generatedAt||""),d(re.map(Et)),I(!1),R(!1));const[he,ke,ne,ve]=await Promise.all([fe,de,pe,ge]),oe=((he==null?void 0:he.recent_ops)||[]).map(xe=>va(xe,a)).filter(xe=>!!xe),Se=new Set(re.map(xe=>xe.id));if(re=[...re,...oe.filter(xe=>!Se.has(xe.id)&&(Se.add(xe.id),!0))],!K())return;d(re.map(Et));const Ke=new Set;for(const xe of ke){const Ce=(xe.id||xe.co||"").toString().trim().toLowerCase();Ce&&Ke.add(Ce.startsWith("t:")?Ce:"t:"+Ce)}D(Ke),w(ne),q(ve),Q&&ca(ce,{fund:Q.fund,marketEstimate:Q.marketEstimate,criteria:Q.criteria,stats:Q.stats,generatedAt:Q.generatedAt,objs:re})}else{const be=mi(),fe=$n(),de=_a(),pe=await be;K()&&pe.length&&(d(Va(pe).map(Et)),I(!1),R(!1));const[ge,Q]=await Promise.all([fe,de]),re=(ge||[]).map(ve=>Un(ve,a)).filter(ve=>!!ve),he=await Hn(re,a),ke=((Q==null?void 0:Q.recent_ops)||[]).map(ve=>va(ve,a)).filter(ve=>!!ve),ne=Va([...pe,...he,...ke]);if(!K())return;d(ne.map(Et)),ca(ce,{objs:ne})}K()&&R(!1)}catch{K()&&!le&&R(!0)}finally{K()&&I(!1)}})(),()=>{ue=!1}},[l,o.token,a,$,c]),p.useEffect(()=>{if(!s.showCredits||!B){U(null);return}let W=!0;return(async()=>{try{const ue=await fetch(`${Da}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:B})});if(!ue.ok)return;const K=await ue.json();W&&K&&K.ok!==!1&&U(K)}catch{}})(),()=>{W=!1}},[s.showCredits,B,j]);const _=p.useCallback(W=>D(new Set(W)),[]);return{session:o,mode:i,caps:s,fund:h,email:B,marketEstimate:b,generatedAt:z,criteria:v,stats:f,thumbs:E,stages:N,dossiers:x,favIds:T,setFavIds:_,credits:O,reloadCredits:()=>S(W=>W+1),loading:M,error:g,refresh:()=>X(W=>W+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ya=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Sa(e){return ya.has(e.engine||"")}function Ve(e){return!!e.noCo||Sa(e)&&!!e.url}const lo=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Is=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...lo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),Ps=new Set(["signal","amount","score","crible","memo"]);function Bs(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:lo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Ps.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??co)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const co=80;function Ca(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!Me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Nn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(ht(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ct(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function ea(e,a,r){return We(e)?Ca(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ca(e,a.filters,r)}function _s(e,a,r,n){return!(!ea(e,a,r)||r&&!hi(e,a.ptab,n))}function zn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-ht(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return gi(o);case"memo":return xi(o);case"signal":{const i=Me(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const s=n(o),l=n(i);return s<l?-a.dir:s>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const Wa={},or=(Wa==null?void 0:Wa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function ir(){return new Date().toISOString().slice(0,10)}const An=p.createContext(null);function po(){return p.useContext(An)}function $s(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),s=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!s||s.length<2||s.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(c=>c.remove()),l.querySelectorAll("*").forEach(c=>{const x=c.tagName==="A"?c.getAttribute("href"):null;[...c.attributes].forEach(d=>c.removeAttribute(d.name)),x&&/^https?:\/\//i.test(x)&&(c.setAttribute("href",x),c.setAttribute("target","_blank"),c.setAttribute("rel","nofollow noopener"))}),a.push({t:s.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Us(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),s=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),c=(i==="href"||i==="src")&&/^https?:\/\//i.test(s);!l&&!c&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function sr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),s=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),s&&n.setAttribute("class",s),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function lr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",s=String(Number(r[3]));return a?`${i} ${s}, ${r[1]}`:`${s==="1"?"1ᵉʳ":s} ${i} ${r[1]}`}function uo(){const e=p.useContext(An);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Hs({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Y(),[i,s]=p.useState(()=>n.filters.day||ir()),[l,c]=p.useState(null),[x,d]=p.useState(!1),h=p.useCallback(v=>{if(/^\d{4}-\d{2}-\d{2}$/.test(v)){s(v);try{r({type:"filters",patch:{day:v,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{s(ir());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const v=y=>{var k;const f=(k=y.detail)==null?void 0:k.day;typeof f=="string"&&h(f)};return window.addEventListener("pp-edition-day",v),()=>window.removeEventListener("pp-edition-day",v)},[h]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&s(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let v=!1;d(!0);const y=new URLSearchParams({token:e,date:i});return fetch(`${or}/cibles/edition.json?${y}`).then(f=>f.json()).then(f=>{v||c(f)}).catch(()=>{v||c({ok:!1,error:"network"})}).finally(()=>{v||d(!1)}),()=>{v=!0}},[e,i]);const b=p.useMemo(()=>`${or}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:l,loading:x,pickDay:h,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,x,h,u,n.filters.day,b,o]);return t.jsx(An.Provider,{value:m,children:a})}function Vs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=uo(),[o,i]=p.useState(()=>n||Zr());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const s=l=>{var c;return i(!!((c=l.detail)!=null&&c.open))};return window.addEventListener(ja,s),()=>window.removeEventListener(ja,s)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(bi,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function Ws(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function dr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function cr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function Gs(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=uo(),s=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!s,c=a&&!a.ok,x=p.useRef(null),[d,h]=p.useState("fonds"),[u,b]=p.useState(null),[m,v]=p.useState("idle"),y=p.useRef(!1);p.useEffect(()=>{b(null),v("idle"),y.current=!1,h("fonds")},[e]),p.useEffect(()=>{if(d!=="jour"||y.current)return;y.current=!0;let N=!0;return v("load"),Ws(e).then(q=>{N&&(b(q),v("fait"))}),()=>{N=!1}},[d,e]);const f=p.useMemo(()=>Us((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),k=p.useRef(null);p.useEffect(()=>{const N=k.current;if(!N||!f)return;let q=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async z=>{await z.ensureEditoCss(),!(q||!N.isConnected)&&(z.beautifyEditoRows(N),z.mountCardFits(N))}),()=>{q=!0}},[f]);const E=p.useMemo(()=>sr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),w=p.useMemo(()=>sr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const N=x.current;if(!N||!E)return;let q=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async z=>{await z.ensureEditoCss(),!(q||!N.isConnected)&&(z.beautifyEditoRows(N),z.mountCardFits(N))}),()=>{q=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>h("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>h("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!s&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&c&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?dr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:lr(e,!0)}),"."]}):dr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:lr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>h("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&s&&E?t.jsx("div",{ref:x,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,d==="fonds"&&s&&w?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:w}}):null,d==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:k,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:cr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:cr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const Ys=300,pa=7,Qs={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},mo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ks=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ki(r)&&r!=="media")return"news:"+r;const n=Me(e);return n?"sig:"+(n.theme&&mo.fr[n.theme]?n.theme:"other"):"actualites"}function Js(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:s,fund:l}=Y(),c=po(),x=s==="en",[d,h]=p.useState("all"),[u,b]=p.useState(!1),m=p.useMemo(()=>{var ue;const g=(a.filters.day||"").slice(0,10),R=K=>!(!i&&a.continent!=="monde"&&K.continent!==a.continent||g&&(K.date||"").slice(0,10)!==g),$=e.filter(K=>R(K)&&Me(K)&&(!i||K.kind!=="target"||Ne(K)!==5)),X=i&&(((ue=c==null?void 0:c.ed)==null?void 0:ue.ops)||[]).length?c.ed.ops.map(K=>va(K,s)).filter(K=>!!K).map(K=>(K.briefOnly=!0,K)).filter(K=>!g||(K.date||"").slice(0,10)===g):[],j=e.filter(K=>R(K)&&K.kind==="op"&&(g?!0:ht(K.date)<=pa)),S=i?X.length?X:j.filter(K=>{const ce=(l||"").trim().toLowerCase();if(!ce)return!1;const le=K.match||null;return le?Object.keys(le).map(be=>be.trim().toLowerCase()).includes(ce):!1}):j,L=g||new Date().toISOString().slice(0,10),B=K=>{const ce=Ga(K);return ce==="ma"?0:ce==="levees"?1:2};S.sort((K,ce)=>{const le=B(K)-B(ce);if(le)return le;const be=(K.date||"").slice(0,10)===L?0:1,fe=(ce.date||"").slice(0,10)===L?0:1;return be!==fe?be-fe:(ce.amountEur||0)-(K.amountEur||0)});const _=new Set,W=[];for(const K of[...S,...zn($,{key:"signal",dir:-1})]){const ce=K.id||K.name;!ce||_.has(ce)||(_.add(ce),W.push(K))}return i&&W.length===0?e.filter(ce=>R(ce)&&ht(ce.date)<=pa).sort((ce,le)=>(le.date||"").localeCompare(ce.date||"")).slice(0,80):W},[e,a.continent,a.filters.day,i,l,s,c]),v=p.useMemo(()=>{const g={};for(const R of m){const $=Ga(R);g[$]=(g[$]||0)+1}return g},[m]),y=p.useMemo(()=>d==="all"?m:m.filter(g=>Ga(g)===d),[m,d]),f=p.useMemo(()=>y.slice(0,Ys),[y]),k=y.length-f.length,E=p.useRef(null);p.useEffect(()=>{var S,L;const g=E.current;if(!g)return;const R=()=>{const B=g.scrollWidth;B<200||(g.style.animationDuration=Math.max(18,Math.round(B/130))+"s")};R();const $=requestAnimationFrame(R),X=window.setTimeout(R,1200);let j=!0;return(L=(S=document.fonts)==null?void 0:S.ready)==null||L.then(()=>{j&&R()}),()=>{j=!1,cancelAnimationFrame($),window.clearTimeout(X)}},[f.length,d]);const w=g=>g==="all"?m.length:v[g]||0,N=g=>{if(g==="all")return x?"All":"Tout";if(g.startsWith("sig:"))return mo[x?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const R=g.slice(5);return yi[R]?wi(R,x?"en":"fr"):g}return Qs[x?"en":"fr"][g]},q=[{k:"all"}],z=["ma","levees"].filter(g=>w(g)>0||g===d);if(z.length){q.push({g:x?"Deals":"Opérations"});for(const g of z)q.push({k:g})}const F=["nominations","recrutements"].filter(g=>w(g)>0||g===d),T=vi.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>w(g)>0||g===d),D=w("actualites")>0||d==="actualites"?["actualites"]:[];if(F.length||T.length||D.length){q.push({g:x?"News":"Actualités"});for(const g of F)q.push({k:g});for(const g of T)q.push({k:g});for(const g of D)q.push({k:g})}const O=Ks.map(g=>"sig:"+g).filter(g=>w(g)>0||g===d);if(O.length){q.push({g:x?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of O)q.push({k:g})}const U=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(x?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},M=(()=>{const g=(a.filters.day||"").slice(0,10),R=!i&&a.continent!=="monde"&&o?x?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(x?`LIVE covers the events of ${U(g)}.`:`Le LIVE regroupe les événements du ${U(g)}.`)+R:(x?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+R})(),I=g=>f.map(R=>t.jsxs("button",{type:"button",className:"tk"+(Ie(R)?" spent":""),onClick:$=>{const X=R.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:X?"":R.id,name:R.name,url:R.url||"",text:R.tagline||R.headline||"",card:R.card}}))}catch{}if(X||n({type:"focus",id:R.id}),a.dens!=="liste"){const j=$.currentTarget.getBoundingClientRect();n({type:"popup",id:R.id,anchor:{x:j.left+j.width/2,y:j.bottom}})}},title:R.name+(R.tagline?" — "+R.tagline:""),children:[t.jsx(yt,{o:R}),t.jsxs("span",{className:"who",children:[t.jsx(Qo,{o:R}),t.jsx("span",{className:"co",children:R.name})]}),typeof R.amountEur=="number"&&R.amountEur>0&&t.jsx("span",{className:"am",children:Lc(R.amountEur)}),R.sector&&t.jsx("span",{className:"mt",children:R.sector}),t.jsx(Ia,{o:R}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(R.id||R.name))).concat(k>0?[t.jsx("span",{className:"tk quiet",children:x?`+ ${k} more — filter by section to see them`:`+ ${k} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(g=>!g),children:[N(d),t.jsx("b",{children:w(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:M}),q.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===d,onClick:()=>{h(g.k),b(!1)},children:[N(g.k),t.jsx("b",{children:w(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:E,children:[I(0),I(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!c&&t.jsxs("button",{type:"button",className:"tk-edito",title:x?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",x?"Today's editorial":"Edito du jour"]}),!!c&&t.jsx(Zs,{isEn:x})]})}const Xs=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function Zs({isEn:e}){const[a,r]=p.useState(()=>Zr());p.useEffect(()=>{const o=i=>{var s;return r(!!((s=i.detail)!=null&&s.open))};return window.addEventListener(ja,o),()=>window.removeEventListener(ja,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>ji(!a),children:Xs})}const qn="+33 6 83 10 72 86",za="alexandre@proplace.co",fo=`tel:${qn.replace(/[^\d+]/g,"")}`;function el(){return null}class rt extends p.Component{constructor(){super(...arguments);Pn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ho=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function pr(e,a){if((wt(e)||"").startsWith("CALL")&&Ne(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ne(e)>=2;return ho.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const ur=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",tl={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function al({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:s}=Y(),[l,c]=p.useState(""),[x,d]=p.useState(!1),[h,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!h)return;const k=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),d(!1))};return document.addEventListener("click",k,!0),()=>document.removeEventListener("click",k,!0)},[h]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),v=async k=>{if(l)return;if(k==="Analysé"&&!e.memoUrl){d(!0);return}c(k);const E=(pr(e,a).find(([N])=>N===k)||[k,k])[1],w=await o(e,k,{msg:a.csMoved(e.name,E)});c(""),w&&(d(!1),u(!1))},y=pr(e,a),f=k=>(y.find(([E])=>E===k)||[])[1]||k;return y.length===2?t.jsx("span",{className:"rstat rst2",onClick:k=>k.stopPropagation(),children:y.map(([k,E])=>t.jsx("button",{type:"button",className:"rsd "+(k==="Validé"?"yes":"no")+(l===k?" busy":""),disabled:!!l,onClick:()=>{v(k)},children:E},k))}):t.jsxs("span",{className:"rstat"+(h||x?" rs-open":""),ref:b,onClick:k=>k.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":h,disabled:!!l,title:a.csLabel,className:"rsel rs-"+ur(m),onClick:()=>{u(k=>!k),d(!1)},children:l?f(l)+"…":m?f(m):a.csNone}),h&&!x&&t.jsx("span",{className:"rsmenu",role:"listbox",children:y.map(([k,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===k,className:"rsopt"+(m===k?" on":"")+(l===k?" busy":""),disabled:!!l,onClick:()=>{if(k===m){u(!1);return}v(k)},children:[t.jsx("i",{className:"pt2",style:{background:tl[ur(k)]}}),E]},k))}),x&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:s.has(e.id),onClick:()=>{i(e),d(!1),u(!1)},children:s.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{c("Analysé");const k=await o(e,"Analysé");c(""),k&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function nl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Y(),[i,s]=p.useState(""),[l,c]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),d=(wt(e)||"").startsWith("CALL")&&Ne(e)===3,h=Ne(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;s(m);const v=await o(e,m);s(""),v&&(c(!0),setTimeout(()=>c(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:ho.filter(([m])=>!(h&&m==="Retenu")).map(([m,v])=>[m,a[v]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,v])=>t.jsx("button",{type:"button",className:"csb"+(x===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:v},m)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(rl,{o:e})]})}function rl({o:e}){const{t:a,saveNote:r,flash:n}=Y(),[o,i]=p.useState(e.ceoNote||""),[s,l]=p.useState(!1),[c,x]=p.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),h=async()=>{if(s||!d)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:s,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&h()}}),t.jsx("button",{type:"button",disabled:s||!d,onClick:()=>{h()},children:c?a.csNoteSaved:a.csNoteOk})]})}function ol({placeholder:e,onDone:a}){const{t:r}=Y(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function il({o:e}){var y;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:s,flashErr:l}=Y(),[c,x]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Ne(e)!==4)return null;const d=i(e),h=(d==null?void 0:d.stage)||"todo",u=async f=>{if(c||f===h)return;x(!0);const k=d;s(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const E=Math.max(Date.now(),mr+=1);mr=E;const w=await Ni(r,{company:e.name||"",stage:f,cts:E,deal_id:e.airtableId,check_id:e.checkId});x(!1),!w.stale&&(w.ok||(s(e,k),l(a.actErr)))},b=(y=d==null?void 0:d.stamps)==null?void 0:y.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,v=h==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,k])=>t.jsx("button",{type:"button",className:"stgb"+(h===f?" on":""),disabled:c,onClick:()=>{u(f)},children:k},f)),v&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let mr=0;const Wt=8,vt=360;function fr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function hr({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(fr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(fr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function sl({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Y(),[s,l]=p.useState(0),[c,x]=p.useState(null),[d,h]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const z=b.current;return()=>{m.current||(n({type:"ptab",tab:z.ptab}),n({type:"dens",dens:z.dens}),n({type:"modal",modal:z.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,h(e.filter(z=>!!document.querySelector(z.need||z.sel))))},[e]);const v=d[s],y=s>=d.length;p.useEffect(()=>{if(v&&(v.ptab!==void 0&&i.ptab!==v.ptab&&n({type:"ptab",tab:v.ptab}),v.dens&&i.dens!==v.dens&&n({type:"dens",dens:v.dens}),i.modal!==(v.modal??null)&&n({type:"modal",modal:v.modal??null}),v.click)){const z=v.click,F=window.setTimeout(()=>{const T=document.querySelector(z);T&&T.getAttribute("aria-selected")!=="true"&&T.click()},60);return()=>window.clearTimeout(F)}},[s,v]);const f=p.useRef(-1),k=p.useCallback(()=>{if(!v){x(null);return}const z=D=>{if(!D)return null;for(const O of document.querySelectorAll(D)){const U=O.getBoundingClientRect();if(U.width>1&&U.height>1)return O}return null},F=z(v.sel)||z(v.need);if(!F){x(null);return}f.current!==s&&(f.current=s,F.scrollIntoView({block:"nearest",behavior:"smooth"}));const T=F.getBoundingClientRect();x(D=>D&&Math.abs(D.top-T.top)<1&&Math.abs(D.left-T.left)<1&&Math.abs(D.width-T.width)<1&&Math.abs(D.height-T.height)<1?D:T)},[v,s]);p.useLayoutEffect(()=>{k();const z=[90,300,700,1300].map(D=>window.setTimeout(k,D)),F=window.setInterval(k,400),T=()=>k();return window.addEventListener("scroll",T,!0),window.addEventListener("resize",T),()=>{z.forEach(D=>window.clearTimeout(D)),window.clearInterval(F),window.removeEventListener("scroll",T,!0),window.removeEventListener("resize",T)}},[k]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const z=F=>{F.key==="Escape"?(F.preventDefault(),F.stopPropagation(),E.current()):F.key==="ArrowRight"?l(T=>T+1):F.key==="ArrowLeft"&&l(T=>Math.max(0,T-1))};return document.addEventListener("keydown",z,!0),()=>document.removeEventListener("keydown",z,!0)},[]),!d.length)return null;let w=null;const N=z=>()=>{m.current=!0,n({type:"modal",modal:null}),z()};if(y){const z=o[3]||0;z>0?w={title:z===1?r.ahaATitle1:r.ahaATitleN(z),body:r.ahaABody,btn:r.ahaABtn,go:N(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?w={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:N(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?w={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:N(()=>{n({type:"ptab",tab:0}),a()})}:w={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:N(()=>{n({type:"modal",modal:"crit"}),a()})}}let q={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:vt};if(!y&&c){const z=c.bottom+14,F=window.innerHeight-z;let T=F>190?z:Math.max(12,c.top-200),D=Math.min(Math.max(12,c.left+c.width/2-vt/2),window.innerWidth-vt-12);F<=190&&c.top<212&&(window.innerWidth-c.right>=vt+40?D=Math.min(c.right+26,window.innerWidth-vt-12):c.left>=vt+40&&(D=Math.max(12,c.left-vt-26)),T=Math.max(12,c.top-Wt)),q={left:D,top:T,width:vt}}return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!y&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-Wt,top:c.top-Wt,width:c.width+Wt*2,height:c.height+Wt*2}}),(y||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(y?" fin":""),style:q,children:[y&&w?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:w.title}),t.jsx(hr,{text:w.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:w.go,children:w.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(s+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(s+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:v==null?void 0:v.title}),t.jsx(hr,{text:(v==null?void 0:v.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:s===0,onClick:()=>l(z=>Math.max(0,z-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(z=>z+1),children:s===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function xo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function go(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ll(){var F,T;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:s,data:l,dispatch:c}=Y(),x=r?a:e,d=p.useMemo(()=>x.filter(D=>ht(D.date)===0&&D.kind==="target"),[x]),h=p.useMemo(()=>r?a.filter(D=>D.kind==="target"&&Ne(D)===0).slice().sort((D,O)=>(O.date||"").localeCompare(D.date||"")):[],[a,r]),u=p.useMemo(()=>d.filter(D=>r?Ne(D)===0:!Ie(D)),[d,r]),b=r?h:u,m=r?a.length-h.length:d.length-u.length,v=r?a.length:d.length,y=v?Math.min(100,m/v*100):100,f=p.useMemo(()=>xo(x),[x]),k=!!f&&ht(f)>0,E=p.useMemo(()=>k?x.filter(D=>(D.date||"").slice(0,10)===f):[],[x,f,k]),w=typeof((F=l.stats)==null?void 0:F.kept_today)=="number"?l.stats.kept_today:null,N=typeof((T=l.stats)==null?void 0:T.screened_today)=="number"?l.stats.screened_today:d.length;let q;k?q=o.morningLast(E.length,h.length,go(f,s)):r?q=o.morningThesis(N,h.length,w):d.length?m===0?q=o.goalSourced(d.length):m>=d.length?q=o.goalCleared:q=o.goalDone(m,d.length):q=o.goalSourced(0);const z=()=>{if(!r){c({type:"pile",on:!0});return}c({type:"ptab",tab:0}),n==="client"&&h.length&&c({type:"chainStart",queue:h.map(D=>D.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:q}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:y+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:z,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function dl(){var $,X;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:s,dossiers:l,mode:c,doSync:x,startTour:d,flash:h,flashErr:u}=Y(),[b,m]=p.useState(null),[v,y]=p.useState(!0),[f,k]=p.useState([]),E=c==="client";p.useEffect(()=>{if(!o||!i)return;let j=!0;return y(!0),(async()=>{const[S,L]=await Promise.all([En(i),eo(o)]);j&&(S&&m(S),y(!1),k(L))})(),()=>{j=!1}},[o,i]);const[w,N]=p.useState(!1),q=()=>{!E||w||!i||(N(!0),Ei(i).then(j=>{N(!1),j?h(e.identRepubDone):u(e.actErr)}))},z=(b==null?void 0:b.per_day)??null,F=(($=b==null?void 0:b.pool_order)==null?void 0:$.length)??0,T=f.filter(j=>j.status==="running").length,D=p.useMemo(()=>l.filter(j=>j.kind==="target"&&Ie(j)).length,[l]),O=s.marketEstimate,U=typeof((X=s.stats)==null?void 0:X.screened)=="number"?s.stats.screened:D,M=O&&O>0?Math.min(100,Math.round(U/O*100)):null,I=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),g=(i||"P").split(/\s+/).map(j=>j[0]).join("").slice(0,2).toUpperCase(),R=(()=>{const j=Date.parse(s.generatedAt||"");if(Number.isNaN(j))return"";const S=new Date(j),L=B=>String(B).padStart(2,"0");return`${L(S.getDate())}/${L(S.getMonth()+1)} à ${L(S.getHours())}:${L(S.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?g:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),R?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(R)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[M===null&&U>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:I(U)})})]}),M!==null&&O&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:M+"%"}})}),t.jsxs("b",{children:[M," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(U,O)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),z!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:z})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),z===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),T>0&&t.jsxs("span",{className:"ev",children:["⏳ ",T]}),t.jsx("span",{className:"ego",children:v?e.identPendingWait:e.identPending(F)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:j=>{j.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||w,onClick:q,children:w?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:j=>n({type:"filters",patch:{search:j.target.value}})})]})]})]})}class qt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],s=a+i,l=Math.abs(a)<Math.abs(i)?a-(s-i):i-(s-a);l&&(r[n++]=l),a=s}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,s=0;if(r>0){for(s=a[--r];r>0&&(n=s,o=a[--r],s=n+o,i=o-(s-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=s+o,o==n-s&&(s=n))}return s}}function*cl(e){for(const a of e)yield*a}function bo(e){return Array.from(cl(e))}var we=1e-6,me=Math.PI,et=me/2,xr=me/4,at=me*2,mt=180/me,Ye=me/180,ze=Math.abs,pl=Math.atan,ta=Math.atan2,Te=Math.cos,Le=Math.sin,ul=Math.sign||function(e){return e>0?1:e<0?-1:0},Lt=Math.sqrt;function ml(e){return e>1?0:e<-1?me:Math.acos(e)}function aa(e){return e>1?et:e<-1?-et:Math.asin(e)}function tt(){}function Aa(e,a){e&&br.hasOwnProperty(e.type)&&br[e.type](e,a)}var gr={Feature:function(e,a){Aa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Aa(r[n].geometry,a)}},br={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ln(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ln(r[n],a,0)},Polygon:function(e,a){vr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)vr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Aa(r[n],a)}};function ln(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function vr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ln(e[r],a,1);a.polygonEnd()}function Mt(e,a){e&&gr.hasOwnProperty(e.type)?gr[e.type](e,a):Aa(e,a)}function dn(e){return[ta(e[1],e[0]),aa(e[2])]}function It(e){var a=e[0],r=e[1],n=Te(r);return[n*Te(a),n*Le(a),Le(r)]}function ua(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ya(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ma(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function cn(e){var a=Lt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function pn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function un(e,a){return ze(e)>me&&(e-=Math.round(e/at)*at),[e,a]}un.invert=un;function fl(e,a,r){return(e%=at)?a||r?pn(wr(e),kr(a,r)):wr(e):a||r?kr(a,r):un}function yr(e){return function(a,r){return a+=e,ze(a)>me&&(a-=Math.round(a/at)*at),[a,r]}}function wr(e){var a=yr(e);return a.invert=yr(-e),a}function kr(e,a){var r=Te(e),n=Le(e),o=Te(a),i=Le(a);function s(l,c){var x=Te(c),d=Te(l)*x,h=Le(l)*x,u=Le(c),b=u*r+d*n;return[ta(h*o-b*i,d*r-u*n),aa(b*o+h*i)]}return s.invert=function(l,c){var x=Te(c),d=Te(l)*x,h=Le(l)*x,u=Le(c),b=u*o-h*i;return[ta(h*o+u*i,d*r+b*n),aa(b*r-d*n)]},s}function hl(e,a,r,n,o,i){if(r){var s=Te(a),l=Le(a),c=n*r;o==null?(o=a+n*at,i=a-c/2):(o=jr(s,o),i=jr(s,i),(n>0?o<i:o>i)&&(o+=n*at));for(var x,d=o;n>0?d>i:d<i;d-=c)x=dn([s,-l*Te(d),-l*Le(d)]),e.point(x[0],x[1])}}function jr(e,a){a=It(a),a[0]-=e,cn(a);var r=ml(-a[1]);return((-a[2]<0?-r:r)+at-we)%at}function vo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:tt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function wa(e,a){return ze(e[0]-a[0])<we&&ze(e[1]-a[1])<we}function fa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function yo(e,a,r,n,o){var i=[],s=[],l,c;if(e.forEach(function(m){if(!((v=m.length-1)<=0)){var v,y=m[0],f=m[v],k;if(wa(y,f)){if(!y[2]&&!f[2]){for(o.lineStart(),l=0;l<v;++l)o.point((y=m[l])[0],y[1]);o.lineEnd();return}f[0]+=2*we}i.push(k=new fa(y,m,null,!0)),s.push(k.o=new fa(y,null,k,!1)),i.push(k=new fa(f,m,null,!1)),s.push(k.o=new fa(f,null,k,!0))}}),!!i.length){for(s.sort(a),Nr(i),Nr(s),l=0,c=s.length;l<c;++l)s[l].e=r=!r;for(var x=i[0],d,h;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;d=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,c=d.length;l<c;++l)o.point((h=d[l])[0],h[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(d=u.p.z,l=d.length-1;l>=0;--l)o.point((h=d[l])[0],h[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Nr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Qa(e){return ze(e[0])<=me?e[0]:ul(e[0])*((ze(e[0])+me)%at-me)}function xl(e,a){var r=Qa(a),n=a[1],o=Le(n),i=[Le(r),-Te(r),0],s=0,l=0,c=new qt;o===1?n=et+we:o===-1&&(n=-et-we);for(var x=0,d=e.length;x<d;++x)if(u=(h=e[x]).length)for(var h,u,b=h[u-1],m=Qa(b),v=b[1]/2+xr,y=Le(v),f=Te(v),k=0;k<u;++k,m=w,y=q,f=z,b=E){var E=h[k],w=Qa(E),N=E[1]/2+xr,q=Le(N),z=Te(N),F=w-m,T=F>=0?1:-1,D=T*F,O=D>me,U=y*q;if(c.add(ta(U*T*Le(D),f*z+U*Te(D))),s+=O?F+T*at:F,O^m>=r^w>=r){var M=qa(It(b),It(E));cn(M);var I=qa(i,M);cn(I);var g=(O^F>=0?-1:1)*aa(I[2]);(n>g||n===g&&(M[0]||M[1]))&&(l+=O^F>=0?1:-1)}}return(s<-we||s<we&&c<-1e-12)^l&1}function wo(e,a,r,n){return function(o){var i=a(o),s=vo(),l=a(s),c=!1,x,d,h,u={point:b,lineStart:v,lineEnd:y,polygonStart:function(){u.point=f,u.lineStart=k,u.lineEnd=E,d=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=v,u.lineEnd=y,d=bo(d);var w=xl(x,n);d.length?(c||(o.polygonStart(),c=!0),yo(d,bl,w,r,o)):w&&(c||(o.polygonStart(),c=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),c&&(o.polygonEnd(),c=!1),d=x=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(w,N){e(w,N)&&o.point(w,N)}function m(w,N){i.point(w,N)}function v(){u.point=m,i.lineStart()}function y(){u.point=b,i.lineEnd()}function f(w,N){h.push([w,N]),l.point(w,N)}function k(){l.lineStart(),h=[]}function E(){f(h[0][0],h[0][1]),l.lineEnd();var w=l.clean(),N=s.result(),q,z=N.length,F,T,D;if(h.pop(),x.push(h),h=null,!!z){if(w&1){if(T=N[0],(F=T.length-1)>0){for(c||(o.polygonStart(),c=!0),o.lineStart(),q=0;q<F;++q)o.point((D=T[q])[0],D[1]);o.lineEnd()}return}z>1&&w&2&&N.push(N.pop().concat(N.shift())),d.push(N.filter(gl))}}return u}}function gl(e){return e.length>1}function bl(e,a){return((e=e.x)[0]<0?e[1]-et-we:et-e[1])-((a=a.x)[0]<0?a[1]-et-we:et-a[1])}const Er=wo(function(){return!0},vl,wl,[-me,-et]);function vl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,s){var l=i>0?me:-me,c=ze(i-a);ze(c-me)<we?(e.point(a,r=(r+s)/2>0?et:-et),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&c>=me&&(ze(a-n)<we&&(a-=n*we),ze(i-l)<we&&(i-=l*we),r=yl(a,r,i,s),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=s),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function yl(e,a,r,n){var o,i,s=Le(e-r);return ze(s)>we?pl((Le(a)*(i=Te(n))*Le(r)-Le(n)*(o=Te(a))*Le(e))/(o*i*s)):(a+n)/2}function wl(e,a,r,n){var o;if(e==null)o=r*et,n.point(-me,o),n.point(0,o),n.point(me,o),n.point(me,0),n.point(me,-o),n.point(0,-o),n.point(-me,-o),n.point(-me,0),n.point(-me,o);else if(ze(e[0]-a[0])>we){var i=e[0]<a[0]?me:-me;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function kl(e){var a=Te(e),r=2*Ye,n=a>0,o=ze(a)>we;function i(d,h,u,b){hl(b,e,r,u,d,h)}function s(d,h){return Te(d)*Te(h)>a}function l(d){var h,u,b,m,v;return{lineStart:function(){m=b=!1,v=1},point:function(y,f){var k=[y,f],E,w=s(y,f),N=n?w?0:x(y,f):w?x(y+(y<0?me:-me),f):0;if(!h&&(m=b=w)&&d.lineStart(),w!==b&&(E=c(h,k),(!E||wa(h,E)||wa(k,E))&&(k[2]=1)),w!==b)v=0,w?(d.lineStart(),E=c(k,h),d.point(E[0],E[1])):(E=c(h,k),d.point(E[0],E[1],2),d.lineEnd()),h=E;else if(o&&h&&n^w){var q;!(N&u)&&(q=c(k,h,!0))&&(v=0,n?(d.lineStart(),d.point(q[0][0],q[0][1]),d.point(q[1][0],q[1][1]),d.lineEnd()):(d.point(q[1][0],q[1][1]),d.lineEnd(),d.lineStart(),d.point(q[0][0],q[0][1],3)))}w&&(!h||!wa(h,k))&&d.point(k[0],k[1]),h=k,b=w,u=N},lineEnd:function(){b&&d.lineEnd(),h=null},clean:function(){return v|(m&&b)<<1}}}function c(d,h,u){var b=It(d),m=It(h),v=[1,0,0],y=qa(b,m),f=ua(y,y),k=y[0],E=f-k*k;if(!E)return!u&&d;var w=a*f/E,N=-a*k/E,q=qa(v,y),z=ma(v,w),F=ma(y,N);Ya(z,F);var T=q,D=ua(z,T),O=ua(T,T),U=D*D-O*(ua(z,z)-1);if(!(U<0)){var M=Lt(U),I=ma(T,(-D-M)/O);if(Ya(I,z),I=dn(I),!u)return I;var g=d[0],R=h[0],$=d[1],X=h[1],j;R<g&&(j=g,g=R,R=j);var S=R-g,L=ze(S-me)<we,B=L||S<we;if(!L&&X<$&&(j=$,$=X,X=j),B?L?$+X>0^I[1]<(ze(I[0]-g)<we?$:X):$<=I[1]&&I[1]<=X:S>me^(g<=I[0]&&I[0]<=R)){var _=ma(T,(-D+M)/O);return Ya(_,z),[I,dn(_)]}}}function x(d,h){var u=n?e:me-e,b=0;return d<-u?b|=1:d>u&&(b|=2),h<-u?b|=4:h>u&&(b|=8),b}return wo(s,l,i,n?[0,-e]:[-me,e-me])}function jl(e,a,r,n,o,i){var s=e[0],l=e[1],c=a[0],x=a[1],d=0,h=1,u=c-s,b=x-l,m;if(m=r-s,!(!u&&m>0)){if(m/=u,u<0){if(m<d)return;m<h&&(h=m)}else if(u>0){if(m>h)return;m>d&&(d=m)}if(m=o-s,!(!u&&m<0)){if(m/=u,u<0){if(m>h)return;m>d&&(d=m)}else if(u>0){if(m<d)return;m<h&&(h=m)}if(m=n-l,!(!b&&m>0)){if(m/=b,b<0){if(m<d)return;m<h&&(h=m)}else if(b>0){if(m>h)return;m>d&&(d=m)}if(m=i-l,!(!b&&m<0)){if(m/=b,b<0){if(m>h)return;m>d&&(d=m)}else if(b>0){if(m<d)return;m<h&&(h=m)}return d>0&&(e[0]=s+d*u,e[1]=l+d*b),h<1&&(a[0]=s+h*u,a[1]=l+h*b),!0}}}}}var Gt=1e9,ha=-Gt;function Nl(e,a,r,n){function o(x,d){return e<=x&&x<=r&&a<=d&&d<=n}function i(x,d,h,u){var b=0,m=0;if(x==null||(b=s(x,h))!==(m=s(d,h))||c(x,d)<0^h>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+h+4)%4)!==m);else u.point(d[0],d[1])}function s(x,d){return ze(x[0]-e)<we?d>0?0:3:ze(x[0]-r)<we?d>0?2:1:ze(x[1]-a)<we?d>0?1:0:d>0?3:2}function l(x,d){return c(x.x,d.x)}function c(x,d){var h=s(x,1),u=s(d,1);return h!==u?h-u:h===0?d[1]-x[1]:h===1?x[0]-d[0]:h===2?x[1]-d[1]:d[0]-x[0]}return function(x){var d=x,h=vo(),u,b,m,v,y,f,k,E,w,N,q,z={point:F,lineStart:U,lineEnd:M,polygonStart:D,polygonEnd:O};function F(g,R){o(g,R)&&d.point(g,R)}function T(){for(var g=0,R=0,$=b.length;R<$;++R)for(var X=b[R],j=1,S=X.length,L=X[0],B,_,W=L[0],ue=L[1];j<S;++j)B=W,_=ue,L=X[j],W=L[0],ue=L[1],_<=n?ue>n&&(W-B)*(n-_)>(ue-_)*(e-B)&&++g:ue<=n&&(W-B)*(n-_)<(ue-_)*(e-B)&&--g;return g}function D(){d=h,u=[],b=[],q=!0}function O(){var g=T(),R=q&&g,$=(u=bo(u)).length;(R||$)&&(x.polygonStart(),R&&(x.lineStart(),i(null,null,1,x),x.lineEnd()),$&&yo(u,l,g,i,x),x.polygonEnd()),d=x,u=b=m=null}function U(){z.point=I,b&&b.push(m=[]),N=!0,w=!1,k=E=NaN}function M(){u&&(I(v,y),f&&w&&h.rejoin(),u.push(h.result())),z.point=F,w&&d.lineEnd()}function I(g,R){var $=o(g,R);if(b&&m.push([g,R]),N)v=g,y=R,f=$,N=!1,$&&(d.lineStart(),d.point(g,R));else if($&&w)d.point(g,R);else{var X=[k=Math.max(ha,Math.min(Gt,k)),E=Math.max(ha,Math.min(Gt,E))],j=[g=Math.max(ha,Math.min(Gt,g)),R=Math.max(ha,Math.min(Gt,R))];jl(X,j,e,a,r,n)?(w||(d.lineStart(),d.point(X[0],X[1])),d.point(j[0],j[1]),$||d.lineEnd(),q=!1):$&&(d.lineStart(),d.point(g,R),q=!1)}k=g,E=R,w=$}return z}}const mn=e=>e;var Ka=new qt,fn=new qt,ko,jo,hn,xn,ft={point:tt,lineStart:tt,lineEnd:tt,polygonStart:function(){ft.lineStart=El,ft.lineEnd=Cl},polygonEnd:function(){ft.lineStart=ft.lineEnd=ft.point=tt,Ka.add(ze(fn)),fn=new qt},result:function(){var e=Ka/2;return Ka=new qt,e}};function El(){ft.point=Sl}function Sl(e,a){ft.point=No,ko=hn=e,jo=xn=a}function No(e,a){fn.add(xn*e-hn*a),hn=e,xn=a}function Cl(){No(ko,jo)}var Pt=1/0,Ta=Pt,na=-Pt,La=na,Ra={point:zl,lineStart:tt,lineEnd:tt,polygonStart:tt,polygonEnd:tt,result:function(){var e=[[Pt,Ta],[na,La]];return na=La=-(Ta=Pt=1/0),e}};function zl(e,a){e<Pt&&(Pt=e),e>na&&(na=e),a<Ta&&(Ta=a),a>La&&(La=a)}var gn=0,bn=0,Yt=0,Fa=0,Ma=0,Ot=0,vn=0,yn=0,Qt=0,Eo,So,ct,pt,Ze={point:Tt,lineStart:Sr,lineEnd:Cr,polygonStart:function(){Ze.lineStart=Tl,Ze.lineEnd=Ll},polygonEnd:function(){Ze.point=Tt,Ze.lineStart=Sr,Ze.lineEnd=Cr},result:function(){var e=Qt?[vn/Qt,yn/Qt]:Ot?[Fa/Ot,Ma/Ot]:Yt?[gn/Yt,bn/Yt]:[NaN,NaN];return gn=bn=Yt=Fa=Ma=Ot=vn=yn=Qt=0,e}};function Tt(e,a){gn+=e,bn+=a,++Yt}function Sr(){Ze.point=Al}function Al(e,a){Ze.point=ql,Tt(ct=e,pt=a)}function ql(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Ot+=o,Tt(ct=e,pt=a)}function Cr(){Ze.point=Tt}function Tl(){Ze.point=Rl}function Ll(){Co(Eo,So)}function Rl(e,a){Ze.point=Co,Tt(Eo=ct=e,So=pt=a)}function Co(e,a){var r=e-ct,n=a-pt,o=Lt(r*r+n*n);Fa+=o*(ct+e)/2,Ma+=o*(pt+a)/2,Ot+=o,o=pt*e-ct*a,vn+=o*(ct+e),yn+=o*(pt+a),Qt+=o*3,Tt(ct=e,pt=a)}function zo(e){this._context=e}zo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,at);break}}},result:tt};var wn=new qt,Ja,Ao,qo,Kt,Jt,ra={point:tt,lineStart:function(){ra.point=Fl},lineEnd:function(){Ja&&To(Ao,qo),ra.point=tt},polygonStart:function(){Ja=!0},polygonEnd:function(){Ja=null},result:function(){var e=+wn;return wn=new qt,e}};function Fl(e,a){ra.point=To,Ao=Kt=e,qo=Jt=a}function To(e,a){Kt-=e,Jt-=a,wn.add(Lt(Kt*Kt+Jt*Jt)),Kt=e,Jt=a}let zr,Oa,Ar,qr;class Tr{constructor(a){this._append=a==null?Lo:Ml(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Ar||this._append!==Oa){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Ar=n,Oa=this._append,qr=this._,this._=o}this._+=qr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Lo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ml(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Lo;if(a!==zr){const r=10**a;zr=a,Oa=function(o){let i=1;this._+=o[0];for(const s=o.length;i<s;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Oa}function Ol(e,a){let r=3,n=4.5,o,i;function s(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Mt(l,o(i))),i.result()}return s.area=function(l){return Mt(l,o(ft)),ft.result()},s.measure=function(l){return Mt(l,o(ra)),ra.result()},s.bounds=function(l){return Mt(l,o(Ra)),Ra.result()},s.centroid=function(l){return Mt(l,o(Ze)),Ze.result()},s.projection=function(l){return arguments.length?(o=l==null?(e=null,mn):(e=l).stream,s):e},s.context=function(l){return arguments.length?(i=l==null?(a=null,new Tr(r)):new zo(a=l),typeof n!="function"&&i.pointRadius(n),s):a},s.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),s):n},s.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const c=Math.floor(l);if(!(c>=0))throw new RangeError(`invalid digits: ${l}`);r=c}return a===null&&(i=new Tr(r)),s},s.projection(e).digits(r).context(a)}function Tn(e){return function(a){var r=new kn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function kn(){}kn.prototype={constructor:kn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ln(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Mt(r,e.stream(Ra)),a(Ra.result()),n!=null&&e.clipExtent(n),e}function Ro(e,a,r){return Ln(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],s=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-s*(n[1][0]+n[0][0]))/2,c=+a[0][1]+(i-s*(n[1][1]+n[0][1]))/2;e.scale(150*s).translate([l,c])},r)}function Dl(e,a,r){return Ro(e,[[0,0],a],r)}function Il(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),s=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([s,l])},r)}function Pl(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),s=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([s,l])},r)}var Lr=16,Bl=Te(30*Ye);function Rr(e,a){return+a?$l(e,a):_l(e)}function _l(e){return Tn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function $l(e,a){function r(n,o,i,s,l,c,x,d,h,u,b,m,v,y){var f=x-n,k=d-o,E=f*f+k*k;if(E>4*a&&v--){var w=s+u,N=l+b,q=c+m,z=Lt(w*w+N*N+q*q),F=aa(q/=z),T=ze(ze(q)-1)<we||ze(i-h)<we?(i+h)/2:ta(N,w),D=e(T,F),O=D[0],U=D[1],M=O-n,I=U-o,g=k*M-f*I;(g*g/E>a||ze((f*M+k*I)/E-.5)>.3||s*u+l*b+c*m<Bl)&&(r(n,o,i,s,l,c,O,U,T,w/=z,N/=z,q,v,y),y.point(O,U),r(O,U,T,w,N,q,x,d,h,u,b,m,v,y))}}return function(n){var o,i,s,l,c,x,d,h,u,b,m,v,y={point:f,lineStart:k,lineEnd:w,polygonStart:function(){n.polygonStart(),y.lineStart=N},polygonEnd:function(){n.polygonEnd(),y.lineStart=k}};function f(F,T){F=e(F,T),n.point(F[0],F[1])}function k(){h=NaN,y.point=E,n.lineStart()}function E(F,T){var D=It([F,T]),O=e(F,T);r(h,u,d,b,m,v,h=O[0],u=O[1],d=F,b=D[0],m=D[1],v=D[2],Lr,n),n.point(h,u)}function w(){y.point=f,n.lineEnd()}function N(){k(),y.point=q,y.lineEnd=z}function q(F,T){E(o=F,T),i=h,s=u,l=b,c=m,x=v,y.point=E}function z(){r(h,u,d,b,m,v,i,s,o,l,c,x,Lr,n),y.lineEnd=w,w()}return y}}var Ul=Tn({point:function(e,a){this.stream.point(e*Ye,a*Ye)}});function Hl(e){return Tn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Vl(e,a,r,n,o){function i(s,l){return s*=n,l*=o,[a+e*s,r-e*l]}return i.invert=function(s,l){return[(s-a)/e*n,(r-l)/e*o]},i}function Fr(e,a,r,n,o,i){if(!i)return Vl(e,a,r,n,o);var s=Te(i),l=Le(i),c=s*e,x=l*e,d=s/e,h=l/e,u=(l*r-s*a)/e,b=(l*a+s*r)/e;function m(v,y){return v*=n,y*=o,[c*v-x*y+a,r-x*v-c*y]}return m.invert=function(v,y){return[n*(d*v-h*y+u),o*(b-h*v-d*y)]},m}function Wl(e){return Gl(function(){return e})()}function Gl(e){var a,r=150,n=480,o=250,i=0,s=0,l=0,c=0,x=0,d,h=0,u=1,b=1,m=null,v=Er,y=null,f,k,E,w=mn,N=.5,q,z,F,T,D;function O(g){return F(g[0]*Ye,g[1]*Ye)}function U(g){return g=F.invert(g[0],g[1]),g&&[g[0]*mt,g[1]*mt]}O.stream=function(g){return T&&D===g?T:T=Ul(Hl(d)(v(q(w(D=g)))))},O.preclip=function(g){return arguments.length?(v=g,m=void 0,I()):v},O.postclip=function(g){return arguments.length?(w=g,y=f=k=E=null,I()):w},O.clipAngle=function(g){return arguments.length?(v=+g?kl(m=g*Ye):(m=null,Er),I()):m*mt},O.clipExtent=function(g){return arguments.length?(w=g==null?(y=f=k=E=null,mn):Nl(y=+g[0][0],f=+g[0][1],k=+g[1][0],E=+g[1][1]),I()):y==null?null:[[y,f],[k,E]]},O.scale=function(g){return arguments.length?(r=+g,M()):r},O.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],M()):[n,o]},O.center=function(g){return arguments.length?(i=g[0]%360*Ye,s=g[1]%360*Ye,M()):[i*mt,s*mt]},O.rotate=function(g){return arguments.length?(l=g[0]%360*Ye,c=g[1]%360*Ye,x=g.length>2?g[2]%360*Ye:0,M()):[l*mt,c*mt,x*mt]},O.angle=function(g){return arguments.length?(h=g%360*Ye,M()):h*mt},O.reflectX=function(g){return arguments.length?(u=g?-1:1,M()):u<0},O.reflectY=function(g){return arguments.length?(b=g?-1:1,M()):b<0},O.precision=function(g){return arguments.length?(q=Rr(z,N=g*g),I()):Lt(N)},O.fitExtent=function(g,R){return Ro(O,g,R)},O.fitSize=function(g,R){return Dl(O,g,R)},O.fitWidth=function(g,R){return Il(O,g,R)},O.fitHeight=function(g,R){return Pl(O,g,R)};function M(){var g=Fr(r,0,0,u,b,h).apply(null,a(i,s)),R=Fr(r,n-g[0],o-g[1],u,b,h);return d=fl(l,c,x),z=pn(a,R),F=pn(d,z),q=Rr(z,N),I()}function I(){return T=D=null,O}return function(){return a=e.apply(this,arguments),O.invert=a.invert&&U,M()}}function Fo(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Fo.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,s=i*i;r-=o=(r*(1.007226+i*(.015085+s*(-.044475+.028874*i-.005916*s)))-a)/(1.007226+i*(.015085*3+s*(-.044475*7+.028874*9*i-.005916*11*s)))}while(ze(o)>we&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function Yl(){return Wl(Fo).scale(175.295)}function Ql(e){return e}function Kl(e){if(e==null)return Ql;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],s=e.translate[1];return function(l,c){c||(a=r=0);var x=2,d=l.length,h=new Array(d);for(h[0]=(a+=l[0])*n+i,h[1]=(r+=l[1])*o+s;x<d;)h[x]=l[x],++x;return h}}function Jl(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function Xl(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Mr(e,r)})}:Mr(e,a)}function Mr(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=Zl(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function Zl(e,a){var r=Kl(e.transform),n=e.arcs;function o(d,h){h.length&&h.pop();for(var u=n[d<0?~d:d],b=0,m=u.length;b<m;++b)h.push(r(u[b],b));d<0&&Jl(h,m)}function i(d){return r(d)}function s(d){for(var h=[],u=0,b=d.length;u<b;++u)o(d[u],h);return h.length<2&&h.push(h[0]),h}function l(d){for(var h=s(d);h.length<4;)h.push(h[0]);return h}function c(d){return d.map(l)}function x(d){var h=d.type,u;switch(h){case"GeometryCollection":return{type:h,geometries:d.geometries.map(x)};case"Point":u=i(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(i);break;case"LineString":u=s(d.arcs);break;case"MultiLineString":u=d.arcs.map(s);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:h,coordinates:u}}return x(a)}const Mo={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ed=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function td(e,a,r){const n=Mo[e];if(!n||!n.length)return-1;const o=ed(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(s=>o.includes(s)))return i}return Math.floor(r*n.length)%n.length}let xa=null;function ad(){return xa||(xa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=Xl(r,n),i=Yl().fitExtent([[8,8],[992,492]],{type:"Sphere"}),s=Ol(i),l=(o.features||[]).filter(d=>{var h;return(((h=d.properties)==null?void 0:h.name)||"")!=="Antarctica"}).map(d=>{var b;const h=((b=d.properties)==null?void 0:b.name)||"",u=s(d)||"";return u?{i2:Si(h)||null,n:h,d:u}:null}).filter(d=>!!d);if(!l.length)return null;const c={};for(const[d,h]of Object.entries(Ci)){const u=i(h);u&&(c[d]={x:u[0],y:u[1]})}const x={};for(const[d,h]of Object.entries(Mo)){const u=h.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(x[d]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:c,metros:x}}catch{return null}})(),xa)}function nd(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return ad().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const rd="8 40 984 210",od={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Or=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Dr(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function id(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const s=()=>{var x;if(!o)return;const c=(x=e.current)==null?void 0:x.getScreenCTM();c&&c.a>0?n(c.a):i=requestAnimationFrame(s)};s();const l=new ResizeObserver(()=>s());return e.current&&l.observe(e.current),window.addEventListener("resize",s),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",s)}},[e,a]),r}function Ir({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],s)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":s*.18+"s"}},s)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function sd(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:s,lang:l,t:c,data:x,dossiers:d,source:h}=Y(),u=x.loading&&!d.length,b=p.useRef(null),m=p.useRef(null),v=nd(e.continent==="monde"),y=e.continent==="monde"?v:Sn.find(g=>g.key===e.continent)||null,f=id(b,e.continent+":"+e.mapFolded+":"+!!y),[k,E]=p.useState(new Map),[w,N]=p.useState(null);p.useEffect(()=>{const g=b.current;if(!g)return;const R=new Map;g.querySelectorAll("path[data-i2]").forEach($=>{const X=$.dataset.i2;if(X)try{const j=$.getBBox();j.width>0&&R.set(X,{x:j.x,y:j.y,w:j.width,h:j.height})}catch{}}),E(R)},[e.continent,f,y]);const q=p.useMemo(()=>r.filter(g=>g.cc),[r]),z=p.useMemo(()=>{const g=new Map;return q.forEach(R=>g.set(R.cc,(g.get(R.cc)||0)+1)),g},[q]),F=e.continent==="monde"&&v?v.anchors:null,T=e.continent==="monde"&&v?v.metros:null,D=p.useMemo(()=>q.map(g=>{const R=Dr(g.name||g.id||""),$=Dr((g.id||g.name||"")+"·y");if(F&&g.cc){const B=T?T[g.cc]:void 0;if(B&&B.length){const W=td(g.cc,g.city,R);if(W>=0&&B[W])return{d:g,x:B[W].x+(R-.5)*5,y:B[W].y+($-.5)*5}}const _=F[g.cc];if(_)return{d:g,x:_.x+(R-.5)*10,y:_.y+($-.5)*10}}const X=g.cc?k.get(g.cc):void 0;if(!X)return null;const j=od[`${e.continent}:${g.cc||""}`];if(j)return{d:g,x:X.x+X.w*(j.fx+(R-.5)*j.sx),y:X.y+X.h*(j.fy+($-.5)*j.sy)};const S=(R-.5)*Math.min(X.w*.55,60),L=($-.5)*Math.min(X.h*.55,60);return{d:g,x:X.x+X.w/2+S,y:X.y+X.h/2+L}}).filter(g=>!!g),[q,k,F,T,e.continent]),O=g=>f>0?g/f:g,U=p.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:Or[g],fr:c.plabels[g].toUpperCase(),en:c.plabels[g].toUpperCase(),n:r.filter(R=>R.kind==="target"&&Ne(R)===g).length})).filter(g=>g.n>0):Vn.map((g,R)=>({...g,n:r.filter($=>Wn($)===R).length})),[r,n,c.plabels]),M=i?s.get(i):null,I=M?D.find(g=>g.d.id===M.id):null;return y?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Ir,{msgs:c.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?rd:y.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?y.fr:y.en,onMouseLeave:()=>{N(null),o(null)},children:[t.jsx("g",{children:y.countries.map((g,R)=>t.jsx("g",{className:"ct"+(g.i2&&z.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},R))}),t.jsx("g",{children:D.map(g=>{const R=Vn[Wn(g.d)],$=!!Me(g.d),X=g.d.kind==="target",j=n&&X?Or[Ne(g.d)]:R.c,S=!n&&Ie(g.d);return t.jsxs("g",{className:"co"+(S?" done":""),onMouseEnter:()=>{var _,W;const L=(_=m.current)==null?void 0:_.getBoundingClientRect(),B=(W=b.current)==null?void 0:W.createSVGPoint();if(B&&b.current&&L){B.x=g.x,B.y=g.y;const ue=B.matrixTransform(b.current.getScreenCTM());N({x:ue.x-L.left,y:ue.y-L.top,label:g.d.name+" · "+($t(g.d.cc,l)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{N(null),o(null)},onClick:()=>{var _;if(h==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const L=(_=b.current)==null?void 0:_.createSVGPoint();let B=null;if(L&&b.current){L.x=g.x,L.y=g.y;const W=L.matrixTransform(b.current.getScreenCTM());B={x:W.x,y:W.y}}a({type:"popup",id:g.d.id,anchor:B})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:O(Math.max(11,R.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:O(R.px),fill:j,stroke:$?"#DC2626":"#ffffff",strokeWidth:O($?2.2:1.3)})]},g.d.id||g.d.name)})}),I&&t.jsx("circle",{className:"ring on",cx:I.x,cy:I.y,r:O(13),fill:"none",stroke:"#0F172A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(w?" on":""),style:w?{left:w.x,top:w.y}:void 0,children:w==null?void 0:w.label}),t.jsx("div",{className:"legend",children:U.map((g,R)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),l==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},R))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",c.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Ir,{msgs:c.loadMsgs})})}function ld(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function Oo({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:s,lang:l}=Y(),c=a.filters,[x,d]=p.useState(!1),[h,u]=p.useState(!1),b=p.useRef(null),m=p.useRef(null),v=p.useMemo(()=>a.continent==="monde"?n:n.filter(I=>I.continent===a.continent),[n,a.continent]),y=I=>v.filter(g=>I!=="country"&&c.country.length&&!c.country.includes(g.cc||"")?!1:Ca(g,c,i,I==="country"?void 0:I)),f=I=>!i||I.kind!=="op",k=p.useMemo(()=>{const I=y("win").filter(f),g=R=>I.filter($=>($.date?Math.max(0,Math.floor((Date.now()-Date.parse($.date))/864e5)):9999)<=R).length;return[g(0),g(7),g(30),I.length]},[v,c,i]),E=p.useMemo(()=>c.day?y("win").filter(f).filter(I=>(I.date||"").slice(0,10)===c.day).length:0,[v,c,i]),w=(c.signalOnly?1:0)+c.sector.length+c.country.length+c.engine.length+c.stage.length+c.angle.length+c.memoLevel.length,N=w+(c.acquirer.trim()?1:0)+(c.day||c.win!=="all"?1:0)+(c.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),p.useEffect(()=>{if(!x&&!h)return;const I=R=>{var X,j;const $=R.target;x&&!((X=b.current)!=null&&X.contains($))&&d(!1),h&&!((j=m.current)!=null&&j.contains($))&&u(!1)},g=R=>{R.key==="Escape"&&(d(!1),u(!1))};return document.addEventListener("mousedown",I),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",I),document.removeEventListener("keydown",g)}},[x,h]);const q=(I,g,R,$="fbtn")=>t.jsxs("button",{type:"button",className:$,"aria-expanded":a.openFacet===I,onClick:()=>r({type:"openFacet",facet:I}),children:[t.jsx("span",{className:"fl",children:g}),R>0&&t.jsx("span",{className:"n",children:R}),t.jsx("span",{className:"cv",children:"▾"})]},I),z=["1","7","30","all"],F=Math.max(0,z.indexOf(c.win||"all")),T=c.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(ld(c.day,l))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>u(I=>!I),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[F]}),t.jsx("b",{children:k[F]}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:z.map((I,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":c.win===I,onClick:()=>{r({type:"filters",patch:{win:I}}),u(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:k[g]})]},I))})]}):t.jsx("div",{className:"seg",children:z.map((I,g)=>t.jsxs("button",{type:"button","aria-pressed":c.win===I,onClick:()=>r({type:"filters",patch:{win:I}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:k[g]})]},I))}),D=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:c.search,onChange:I=>r({type:"filters",patch:{search:I.target.value}})})]}),O=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),c.signalOnly&&t.jsx("span",{className:"n",children:c.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),c.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:c.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:c.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):q("sec",o.fSector,c.sector.length),q("pay",o.fCountry,c.country.length),q("det",o.fEngine,c.engine.length),q("sta",o.fStage,c.stage.length),i&&q("ang","Angle",c.angle.length),i&&q("mem","Mémo",c.memoLevel.length)]}),U=(I=!1)=>t.jsxs("div",{className:"frow2",children:[N>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(v.length,s),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(N)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),I&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),M=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(w?" on":""),"aria-expanded":x,"aria-haspopup":"true",onClick:()=>{d(I=>!I),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),w>0&&t.jsx("span",{className:"n",children:w}),t.jsx("span",{className:"cv",children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:O})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(c.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:T}),t.jsxs("div",{className:"fstrip-b",children:[D,M,U(!1)]})]}),a.openFacet&&t.jsx(Pr,{poolFor:y})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[T,D,O,t.jsx("span",{className:"fgrow"}),U()]}),a.openFacet&&t.jsx(Pr,{poolFor:y})]})}function Pr({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=a.filters,s=a.openFacet,{title:l,cols:c,options:x}=p.useMemo(()=>{if(s==="sig"){const m=e("signal").filter(f=>Me(f)),v=new Map;m.forEach(f=>{const k=f.engine||"";v.set(k,(v.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:m.length,html:!0,on:i.signalOnly&&!i.signalEngines.length},...rn([...v.keys()],o).map(f=>({v:f,label:At(f)+" "+Qe(f,o),n:v.get(f)||0,html:!1,on:i.signalOnly&&i.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="sec"){const m=e("sector"),v=new Map;return m.forEach(y=>{y.sector&&v.set(y.sector,(v.get(y.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y,n:f,html:!1,on:i.sector.includes(y)}))}}if(s==="pay"){const m=e("country"),v=new Map;return m.forEach(y=>{y.cc&&v.set(y.cc,(v.get(y.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:$t(y,o)||y,n:f,html:!1,on:i.country.includes(y)}))}}if(s==="det"){const m=e("engine"),v=new Map;return m.forEach(y=>{y.engine&&v.set(y.engine,(v.get(y.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:rn([...v.keys()],o).map(y=>({v:y,label:At(y)+" "+Qe(y,o)+' <span style="color:var(--dim);font-size:10px">· '+zi(Ai(y),o)+"</span>",n:v.get(y)||0,html:!0,on:i.engine.includes(y)}))}}if(s==="ang"){const m=e("angle"),v=new Map;return m.forEach(y=>{y.angle&&v.set(y.angle,(v.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...v.entries()].sort((y,f)=>f[1]-y[1]).map(([y,f])=>({v:y,label:y.replace(/[_-]+/g," "),n:f,html:!1,on:i.angle.includes(y)}))}}if(s==="mem"){const m=e("memoLevel"),v=new Map;m.forEach(f=>{if(f.kind==="target"){const k=Nn(f);v.set(k,(v.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:y[f],n:v.get(f)||0,html:!1,on:i.memoLevel.includes(f)}))}}const u=e("stage"),b=new Map;return u.forEach(m=>{m.stage&&b.set(m.stage,(b.get(m.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((m,v)=>v[1]-m[1]).map(([m,v])=>({v:m,label:m,n:v,html:!1,on:i.stage.includes(m)}))}},[s,a,o]),d=u=>{if(s==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(i.signalOnly&&!i.signalEngines.length),signalEngines:[]}});else{const m=i.signalEngines.includes(u)?i.signalEngines.filter(v=>v!==u):[...i.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:m}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage",value:u})},h=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:h,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Do({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:s,t:l}=Y(),c=p.useMemo(()=>{const b={};return r.forEach(m=>{Ca(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[x,d]=p.useState(!1),h=p.useRef(null);p.useEffect(()=>{if(!x)return;const b=v=>{var y;(y=h.current)!=null&&y.contains(v.target)||d(!1)},m=v=>{v.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[x]);const u=b=>{const m=Sn.find(v=>v.key===b);return b==="monde"?l.contWorld:s==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:h,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>d(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:c[n.continent]||0}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Gn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),d(!1)},children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[Gn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:c[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})})]})}function jn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function Io(e){return"atl2:evalq:"+(e||"anon")}function dd(e,a){const r=Io(e),n=jn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const s=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(s)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Po(){const{t:e,data:a,dossiers:r}=Y(),n=a.session.token||"",o=Io(n),[i,s]=p.useState(()=>jn(o)),l=p.useRef(!1),[c,x]=p.useState(!1);p.useEffect(()=>{try{const j=i.slice(0,30).map(({descBusy:S,evalBusy:L,...B})=>B);localStorage.setItem(o,JSON.stringify(j)),l.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),l.current=!1}catch{}},[i,o]),p.useEffect(()=>{const j=()=>{if(l.current)return;const S=jn(o);s(L=>JSON.stringify(L.map(({descBusy:B,evalBusy:_,...W})=>W))===JSON.stringify(S)?L:S)};return window.addEventListener("atl2:evalq",j),window.addEventListener("storage",j),()=>{window.removeEventListener("atl2:evalq",j),window.removeEventListener("storage",j)}},[o]);const[d,h]=p.useState([]),[u,b]=p.useState(""),[m,v]=p.useState(!1),[y,f]=p.useState(!1),[k,E]=p.useState(""),w=p.useCallback((j,S)=>s(L=>L.map((B,_)=>_===j?{...B,...S}:B)),[]),N=p.useCallback((j,S)=>{const L=S.trim();L&&(w(j,{name:L,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Cn(L).then(B=>{const _=B.candidates||[];B.website?w(j,{site:B.website,status:"ready"}):_.length===1?w(j,{site:_[0].url,status:"ready"}):_.length>1?w(j,{status:"pick",candidates:_.slice(0,4)}):w(j,{status:"ready"})}).catch(()=>w(j,{status:"ready"})))},[w]),q=p.useCallback((j,S,L)=>{w(j,{descBusy:!0}),to(n,S,L).then(B=>{if(B.quota){x(!0),w(j,{descBusy:!1,descDone:!0});return}const _=B.blocs||{},W=(_.synthese||_.value_prop||_.produit||_.modele||"").trim();w(j,{descBusy:!1,descDone:!0,desc:W})}).catch(()=>w(j,{descBusy:!1,descDone:!0}))},[w,n]);p.useEffect(()=>{const j=i.findIndex(L=>L.auto&&L.name.trim()&&L.status==="");if(j>=0){N(j,i[j].name);return}if(c)return;const S=i.findIndex(L=>L.status==="ready"&&L.site&&!L.descDone&&!L.descBusy);S>=0&&q(S,i[S].name,i[S].site)},[i,N,q,c]);const[z,F]=p.useState(!1),T=p.useCallback(async(j,S)=>{w(j,{evalBusy:!0});const L=await ao(n,(S.site||S.name).trim(),"atelier2");return L.verdict==="quota"?(w(j,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:L.reason||"",remaining:0}})),!1):(w(j,{evalBusy:!1,status:L.verdict==="kept"?"kept":"out",reason:L.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:L.company||S.name,verdict:L.verdict,reason:L.reason||"",remaining:L.remaining??null}})),!0)},[w,n]),D=async()=>{if(z)return;const j=i.map((S,L)=>({r:S,i:L})).filter(({r:S})=>S.name.trim()&&S.status!=="kept"&&S.status!=="out"&&S.status!=="resolving");if(j.length){F(!0);for(const{r:S,i:L}of j)if(!await T(L,S))break;F(!1)}},O=p.useMemo(()=>{const j=new Set,S=[];return i.filter(L=>L.status==="kept").forEach(L=>{const B=L.name.trim().toLowerCase();B&&!j.has(B)&&(j.add(B),S.push(L.name.trim()))}),r.filter(L=>Ne(L)>=1&&Ne(L)<=4&&(L.website||L.domain)).forEach(L=>{const B=(L.name||"").trim().toLowerCase();B&&!j.has(B)&&(j.add(B),S.push((L.name||"").trim()))}),S},[i,r]),U=p.useMemo(()=>{const j=new Set;return r.forEach(S=>{const L=(S.name||"").trim().toLowerCase();L&&j.add(L)}),i.forEach(S=>{const L=S.name.trim().toLowerCase();L&&j.add(L)}),j},[r,i]),M=async()=>{if(u||!O.length)return;f(!1);const j=[];for(const S of O.slice(0,2)){b(S);const L=await no(n,S);if(L){if(L.verdict==="quota"){v(!0);break}(L.results||[]).forEach(B=>{const _=(B.company||"").trim().toLowerCase();!_||U.has(_)||j.some(W=>W.name.toLowerCase()===_)||j.push({name:(B.company||"").trim(),verdict:B.verdict||"",reason:B.reason,from:S})})}}b(""),f(!0),h(S=>[...j,...S].slice(0,24))},I=async(j,S)=>{if(u)return;f(!1),b(j==="thesis"?e.pxThesis:S);const L=await qi(n,j,S,6);if(b(""),f(!0),!L)return;if(L.verdict==="quota"){v(!0);return}const B=[];(L.results||[]).forEach(_=>{const W=(_.company||"").trim().toLowerCase();!W||U.has(W)||B.some(ue=>ue.name.toLowerCase()===W)||B.push({name:(_.company||"").trim(),verdict:_.verdict||"",reason:_.reason,from:j==="thesis"?e.pxThesis:S})}),h(_=>[...B,..._].slice(0,24))},g=()=>{const j=k.trim();j.length<3||I(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(j)?"registry":"keyword",j)},R=j=>{s(S=>[...S,{name:j.name,site:"",status:"",auto:!0}].slice(0,30)),h(S=>S.filter(L=>L.name!==j.name))},$=i.filter(j=>j.name.trim()&&j.status!=="kept"&&j.status!=="out").length,X=j=>j.name.trim()&&j.status!=="kept"&&j.status!=="out"&&j.status!=="resolving"&&!j.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((j,S)=>t.jsxs("div",{className:"eq-row"+(j.status==="kept"?" r-kept":j.status==="out"?" r-out":""),children:[t.jsx("input",{value:j.name,placeholder:e.eqNamePh,onChange:L=>{const B=L.target.value.split(`
`).map(_=>_.trim()).filter(Boolean);B.length>1?s(_=>{const W=[..._];return W.splice(S,1,...B.map(ue=>({name:ue,site:"",status:"",auto:!0}))),W.slice(0,30)}):w(S,{name:L.target.value})},onBlur:()=>{j.name.trim()&&!j.site&&j.status!=="resolving"&&j.status!=="pick"&&N(S,j.name)},onKeyDown:L=>{L.key==="Enter"&&N(S,j.name)}}),t.jsxs("span",{className:"eq-site",children:[j.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),j.status==="pick"&&(j.candidates||[]).map(L=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>w(S,{site:L.url,status:"ready",candidates:void 0}),children:(L.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},L.url)),j.status!=="resolving"&&j.status!=="pick"&&(j.site?t.jsxs("a",{href:j.site.startsWith("http")?j.site:"https://"+j.site,target:"_blank",rel:"nofollow noopener",children:[j.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:j.name.trim()&&j.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:j.desc||"",children:j.descBusy?t.jsx("i",{children:e.eqDescBusy}):j.desc?j.desc:t.jsx("em",{children:j.descDone?c?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(j.status||"vide"),title:j.reason||"",children:j.status==="kept"?"✓ "+e.kept:j.status==="out"?"✗ "+e.dropped:j.status==="ready"?e.eqReady:j.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!X(j)||z,onClick:()=>{T(S,j)},children:j.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>s(L=>L.filter((B,_)=>_!==S)),children:"×"})]},S)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>s(j=>[...j,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]}),t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{I("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:k,placeholder:e.pxPlace,onChange:j=>E(j.target.value),onKeyDown:j=>{j.key==="Enter"&&g()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||k.trim().length<3,onClick:g,children:e.pxGoFree}),!!O.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{M()},children:u&&u!==e.pxThesis&&u!==k?e.sgBusy(u):e.sgGo}),!!O.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(O[0],O.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),y&&!d.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),d.map(j=>t.jsxs("span",{className:"eq-sc"+(j.verdict==="kept"?" ok":""),title:(j.reason||"")+" — "+e.sgVia(j.from),children:[t.jsx("b",{children:j.name}),j.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>R(j),children:"+"})]},j.name))]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(z?" loading":""),style:{justifyContent:"center"},disabled:z||!$,onClick:()=>{D()},children:[t.jsx("span",{className:"fill"}),z?e.eqRunning:e.eqGo($)]}),t.jsx("span",{className:"hint",children:e.eqHint}),i.some(j=>j.status==="kept"||j.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>s(j=>j.filter(S=>S.status!=="kept"&&S.status!=="out")),children:e.eqClearDone})]})]})}function Bo(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function cd(e){var o;const a=[],r=new Set,n=i=>{const s=(i||"").trim();!s||r.has(s.toLowerCase())||(r.add(s.toLowerCase()),a.push(s))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Br({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:s}){const{t:l}=Y();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),s&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>s(n.map(c=>c.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(c=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:c.name}),c.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),c.line1&&t.jsx("p",{className:"w",children:c.line1}),c.line2&&t.jsx("p",{className:"r",children:c.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(c.name),children:l.rsEvalOne})]},c.name))})]}):null}function _o({card:e,onEvaluate:a,onAddAll:r}){var s;const{t:n}=Y(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((s=e==null?void 0:e.prospective)==null?void 0:s.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Br,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Br,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function pd({card:e,onEvaluate:a,onAddAll:r}){var l,c,x;const{t:n}=Y(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),s=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Bo(e.summary_md||"").map((d,h)=>t.jsx("p",{children:d},h))})]}),t.jsx(_o,{card:e,onEvaluate:a,onAddAll:r}),(((c=e.prospective)==null?void 0:c.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),s.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:s.length})]}),t.jsx("div",{className:"rssrc",children:s.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function ud(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function md({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:s}=Y(),l=o,[c,x]=p.useState(null),[d,h]=p.useState(null),[u,b]=p.useState(null),[m,v]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const k=await ro({email:s,cbToken:l});f&&x(k)})(),()=>{f=!1}},[s,l,n]);const y=f=>{h(f),b(null),v(!0),(async()=>{const k=await Ti(f.id);b(k),v(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{h(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&c&&t.jsx("span",{className:"n",children:c.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[c===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),c!==null&&c.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(c||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>y(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[ud(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(pd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ka=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Xt(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?Xt(a)?a:ka.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function fd(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function hd(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:s,evalBusy:l,evalCards:c,caps:x,data:d,canWrite:h,source:u,dossiers:b,doAnalyse:m,liveMemos:v,pipe:y}=Y(),f=a==="client",k=p.useMemo(()=>r||(u!=="default"?Li():""),[r,u]),[E,w]=p.useState(""),[N,q]=p.useState(!1),[z,F]=p.useState(""),[T,D]=p.useState(""),[O,U]=p.useState(""),[M,I]=p.useState(!1),[g,R]=p.useState(!1),[$,X]=p.useState([]);p.useEffect(()=>{const P=ee=>{const ie=ee.detail;ie&&X(Z=>[ie,...Z].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[j,S]=p.useState(!1),[L,B]=p.useState(!1),[_,W]=p.useState(!1),ue=p.useRef(!1),[K,ce]=p.useState(""),[le,be]=p.useState(""),[fe,de]=p.useState(!1),[pe,ge]=p.useState(!1),[Q,re]=p.useState(0),[he,ke]=p.useState(""),[ne,ve]=p.useState(null),[oe,Se]=p.useState(null),[Ke,xe]=p.useState(!1),[Ce,Rt]=p.useState(null),[Pe,Je]=p.useState(0),qe=p.useRef(!1),it=E.trim()?ka.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),ee=(P.get("rs")||"").trim(),ie=(P.get("rstext")||"").trim();ee&&/^https?:\/\//i.test(ee)&&ce(ee),ie&&be(ie),(ee&&/^https?:\/\//i.test(ee)||ie)&&S(!0)},[]),p.useEffect(()=>{const P=ee=>{const ie=ee.detail||{},Z=String(ie.url||"").trim(),je=String(ie.text||"").trim();Z&&/^https?:\/\//i.test(Z)&&ce(Z),je&&be(je),(Z&&/^https?:\/\//i.test(Z)||je)&&(S(!0),w(""),F(""),de(!0),window.setTimeout(()=>de(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),p.useEffect(()=>{const P=ee=>{const ie=ee.detail||{},Z=String(ie.name||"").trim();if(!Z)return;S(!1),w(Z),F(Z);const je=lt(String(ie.website||ie.domain||""));D(je),U(lt(String(ie.url||""))),I(!je),q(!0),window.setTimeout(()=>q(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),p.useEffect(()=>{const P=(z||"").trim();if(!P||j||T){(T||!P||j)&&I(!1);return}const ee=b.find(je=>_e(je.name)===_e(P)),ie=lt((ee==null?void 0:ee.website)||"")||lt((ee==null?void 0:ee.domain)||"");if(ie){D(ie),I(!1);return}let Z=!0;return I(!0),Cn(P).then(je=>{var $e,Ae;if(!Z)return;const De=lt(je.website||"")||lt(((Ae=($e=je.candidates)==null?void 0:$e[0])==null?void 0:Ae.url)||"");De&&D(De)}).catch(()=>{}).finally(()=>{Z&&I(!1)}),()=>{Z=!1}},[z,j,T,b]),p.useEffect(()=>{const P=ee=>{var Z;const ie=String(((Z=ee.detail)==null?void 0:Z.url)||"").trim();Xt(ie)&&window.open(ie,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),p.useEffect(()=>{if(ue.current===j)return;ue.current=j,W(!0);const P=window.setTimeout(()=>W(!1),560);return()=>window.clearTimeout(P)},[j]),p.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ee=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!ee)return;const ie=()=>ee.style.setProperty("--demand-h",`${P.offsetHeight}px`);ie();const Z=new ResizeObserver(ie);return Z.observe(P),()=>Z.disconnect()},[u,N,fe,g,j,_,M]),p.useEffect(()=>{if(!h&&!k){Rt(null);return}let P=!0;return(async()=>{const ee=await ro({email:n,cbToken:k});P&&Rt(ee.length)})(),()=>{P=!1}},[h,k,n,Pe]);const kt=$.length?$:c,Oe=d.credits,xt=p.useCallback(P=>{dd(r,P)&&R(!0)},[r]);p.useEffect(()=>{if(!pe)return;re(0);const P=window.setInterval(()=>re(ee=>ee+1),1e3);return()=>window.clearInterval(P)},[pe]);const ut=p.useMemo(()=>{const P=E.trim().toLowerCase();return!P||!y?null:b.find(ee=>_e(ee.name)===P&&Ne(ee)===1)||null},[E,b,y]),Xe=()=>{const P=E.trim();if(P){if(ut){m(ut);return}o(null,P),f&&w("")}},jt=async()=>{var ie,Z,je;if(qe.current)return;const P=K.trim().replace(/\s+/g,""),ee=le.trim();if(!P&&!ee){ke(e.rsNeed);return}if(!f&&!k){o(null,P||ee.slice(0,80));return}qe.current=!0,ke(""),ve(null),Se(null),ge(!0);try{const De=await Fi({url:P,text:ee,email:n,cbToken:k});if(ge(!1),!De||De.status!=="success"){ke((De==null?void 0:De.message)||"Erreur");return}ve(De),S(!1),xt((((ie=De.prospective)==null?void 0:ie.companies_to_evaluate)||[]).map(Ae=>(Ae==null?void 0:Ae.name)||"")),Se({state:"pending"});const $e=await Mi(De,{email:n,cbToken:k});Se($e.ok?{state:"ok",scopeLabel:((Z=$e.summary)==null?void 0:Z.scope_label)||"",scope:((je=$e.summary)==null?void 0:je.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&Je(Ae=>Ae+1)}finally{qe.current=!1,ge(!1)}},gt=[ne==null?void 0:ne.industry,...(ne==null?void 0:ne.market_tags)||[],ne==null?void 0:ne.author].map(P=>(P||"").trim()).filter(Boolean),bt=(oe==null?void 0:oe.state)==="pending",Ft=oe&&(bt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):oe.state==="ok"?t.jsx("span",{className:"rslink ok",children:oe.scope&&oe.scope!=="public"?e.rsSavedIn(oe.scopeLabel||oe.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:oe.msg,children:e.rsSaveFail})),Nt=cd(ne).length,Re=j,nt=(z||E).trim(),A=b.find(P=>_e(P.name)===_e(nt)),H=lt(E)||T||lt((A==null?void 0:A.website)||"")||lt((A==null?void 0:A.domain)||""),G=O||lt((A==null?void 0:A.url)||""),ae=ut?e.actAnalyse:nt?e.evalGoOn(nt.length>22?nt.slice(0,21)+"…":nt):e.evalGo,ye=pe?`${Ri(K.trim())==="youtube"&&K.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Q)}`:bt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Re?" rs-mode":"")+(z&&E.trim()===z||N||fe?" pair":"")+(N||fe||_?" echo":"")+(_?" swap":""),children:[t.jsxs("div",{className:"drow"+((Re?fe:N)||_?" flash":"")+((Re?K.trim():ka.test(E.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Re?K:E,placeholder:Re?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Re?600:200,spellCheck:Re?!1:void 0,inputMode:Re?"url":void 0,onChange:P=>{if(Re){ce(P.target.value);return}w(P.target.value),z&&P.target.value.trim()!==z&&(F(""),D(""),U(""),I(!1))},onKeyDown:P=>{P.key==="Enter"&&(Re?jt():Xe())}}),t.jsx("span",{className:"detect"+(Re?" off":"")+(ka.test(E.trim())?" url":""),children:it})]}),t.jsx("span",{className:"dacts",children:Re?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(pe?" loading":""),disabled:pe||bt||!K.trim()&&!le.trim(),onClick:()=>{jt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ye})]}),t.jsxs("a",{className:"viewbtn"+(Xt(K)?"":" off"),href:Xt(K)?K.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{Xt(K)||P.preventDefault()},children:[t.jsx(fd,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ut?" analyse":"")+(l?" loading":""),disabled:l,onClick:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ae})]}),t.jsxs("a",{className:"viewbtn sm"+(M?" searching":H?"":" off"),href:H||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":M||void 0,title:M?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{H||P.preventDefault()},children:[M&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),M?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(G?"":" off"),href:G||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{G||P.preventDefault()},children:e.viewSrc})]})}),x.showCredits&&Oe&&t.jsxs("button",{type:"button",className:"credits"+(Oe.total_available<=0&&!Oe.unlimited?" empty":""),onClick:()=>s({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Oe.unlimited?"∞":Oe.total_available}),!Oe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Oe.daily_grant+Oe.purchased]}),Oe.total_available<=0&&!Oe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>R(!g),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(j?" on":""),onClick:()=>S(!j),children:e.rsOpen}),Ce!==null&&Ce>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Ke?" on":""),onClick:()=>xe(!Ke),children:e.rsArchOpen(Ce)})]}),Ke&&t.jsx(md,{bump:Pe,cbToken:k,onClose:()=>xe(!1),onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsx("div",{className:"rsp slim"+(j?" on":" off"),"aria-hidden":!j,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:j?void 0:-1,onClick:()=>B(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:L?"▴":"▾"})]}),L&&t.jsx("textarea",{className:"rstext",value:le,placeholder:e.rsTextPh,tabIndex:j?void 0:-1,onChange:P=>be(P.target.value)})]})}),he&&t.jsx("div",{className:"rserr",children:he}),ne&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:ne.title}),ne.source_url&&t.jsx("a",{href:ne.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{ve(null),Se(null)},children:"×"})]}),ne.market&&t.jsx("p",{className:"rsmk",children:ne.market}),gt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),gt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[ne.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${ne.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Bo(ne.summary_md||"").map((P,ee)=>t.jsx("p",{children:P},ee))})]}),t.jsx(_o,{card:ne,onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Nt)}),Ft]})]}),g&&t.jsx(Po,{}),kt.slice(0,1).map((P,ee)=>{const ie=P.verdict==="kept",Z=P.verdict==="quota",je=P.verdict==="unresolved",De=ie?"var(--brand)":Z?"var(--bolt)":je?"var(--blue)":"var(--red)",$e=ie?"var(--brand-l)":Z?"#FEF3C7":je?"#EEF4FF":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":De,"--bgc":$e},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ie?"✓ "+e.kept:Z?"⏳":je?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(Ae=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Ae.url.startsWith("http")?Ae.url:`https://${Ae.url}`,target:"_blank",rel:"nofollow noopener",children:[(Ae.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,Ae.url,P.name),children:e.evalPickGo})]},Ae.url))}),!Z&&!je&&t.jsx("button",{type:"button",className:"go",onClick:()=>{s({type:"ptab",tab:ie?1:5});const Ae=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const Ue=[...document.querySelectorAll(".atl2 .list .row")].find(Pa=>{var la;return(((la=Pa.querySelector(".rnm"))==null?void 0:la.textContent)||"").trim().toLowerCase().includes(Ae)});Ue&&(Ue.scrollIntoView({behavior:"smooth",block:"center"}),Ue.classList.add("flashrow"),window.setTimeout(()=>Ue.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ie?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ee)}),f&&(i.kept+i.dropped>0||kt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>s({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function xd(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function gd(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Y(),i=e.memoConsole?r.get(e.memoConsole):null,s=p.useMemo(()=>i?[i.reasoning||"",xd(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=wt(i),c=Nn(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:s?s.split(`

`).map((x,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Dt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:c===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Rn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Y(),[s,l]=p.useState(!1),[c,x]=p.useState(null),d=n.pipe&&o==="client"&&!n.lockActions,h=async()=>{if(!d||s)return;l(!0);const u=await no(r,e);if(l(!1),!u){i(a.actErr);return}x(u.results||[])};return p.useEffect(()=>{if(!d)return;const u=b=>{var v;const m=String(((v=b.detail)==null?void 0:v.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&h()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,d]),p.useEffect(()=>{if(d)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),h())}catch{}},[e,d]),d?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:s,onClick:()=>{h()},children:s?a.similarBusy:a.similar}),c&&(c.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:c.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const bd=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),ga=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function vd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=ga(a.slice(n));break}r+=ga(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=ga(a.slice(o));break}const s=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(s),c=l?l[2].toLowerCase():"";l&&bd.has(c)?r+=`<${l[1]}${c}>`:r+=ga(a.slice(o,i+1)),n=i+1}return r}const yd=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),_r={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function $o(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(yd.has(o)){n.remove();continue}for(const s of Array.from(n.attributes)){const l=s.name.toLowerCase();(!(_r["*"].has(l)||((r=_r[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(s.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const s=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");s!==i&&(s?n.setAttribute("style",s):n.removeAttribute("style"))}if(o==="a"){const s=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(s)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const s=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(s)){n.remove();continue}n.setAttribute("loading","lazy")}$o(n)}}function Xa(e){const a=e.cloneNode(!0);return $o(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Za=new Map;function wd(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=Za.get(a);return r||(r=kd(a).catch(()=>null),r.then(n=>{n||Za.delete(a)}),Za.set(a,r)),r}async function kd(e){var h,u;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=b=>{var m;return(((m=r.querySelector(b))==null?void 0:m.textContent)||"").trim()},o=r.querySelector(".sb-score"),i=((h=Array.from((o==null?void 0:o.classList)||[]).find(b=>b.startsWith("sb-score-")))==null?void 0:h.slice(9))||"",s=[];let l=null;const c=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const b of c){if(b.classList.contains("sb-nav-heading")){l={label:(b.textContent||"").trim(),items:[]},s.push(l);continue}const m=b.getAttribute("href")||"";if(!m.startsWith("#"))continue;const v=m.slice(1),y=jd(r,v);y&&(l||(l={label:"",items:[]},s.push(l)),l.items.push({id:v,title:(b.textContent||"").trim(),html:y,poids:y.length}))}const x=((u=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:u[1])||"",d={score:n(".sb-score"),scoreTone:i,tags:Array.from(r.querySelectorAll(".sb-tag")).map(b=>(b.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:s.filter(b=>b.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?x:""};return d.groups.length?d:null}const $r={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function jd(e,a){const r=e.getElementById(a),n=r?Ur(e,r):"";if(n)return n;const o=$r[a]?e.querySelector($r[a]):null;return o&&o!==r?Ur(e,o):""}function Ur(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Xa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(c=>/^h3$/i.test(c.tagName))[0]===a)for(const c of i){if(c===a)break;/^h2$/i.test(c.tagName)||o.appendChild(c.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?Xa(o):""}return Xa(a)}const en=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ot({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Hr(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Vr({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const tn=new Map;function Nd(e,a){const{token:r}=Y(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let s=tn.get(i);s||(s=Oi(r,e.name,e.checkId),tn.set(i,s),s.then(c=>{(!c||!c.reasoning&&!c.summaryHtml)&&tn.delete(i)}));let l=!0;return s.then(c=>{l&&c&&o({id:e.id,d:c})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const Ed=6e4;function Sd({o:e}){const{t:a,doDeep:r}=Y(),[n,o]=p.useState(null),[i,s]=p.useState(e.memoUrl?"load":"off"),[l,c]=p.useState(()=>new Set),[x,d]=p.useState(!1),h=p.useRef(new Map);p.useEffect(()=>{let v=!0;if(c(new Set),d(!1),h.current=new Map,!e.memoUrl){s("off"),o(null);return}return s("load"),o(null),wd(e.memoUrl).then(y=>{v&&(o(y),s(y?"ok":"err"))}),()=>{v=!1}},[e.memoUrl]);const u=wt(e),b=v=>{var y;return(y=h.current.get(v))==null?void 0:y.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[Dt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:v=>{v.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const v=[e.reasoning||"",Hr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[v.length?v.join(`

`).split(`

`).map((y,f)=>t.jsx("p",{className:"cdtxt",children:y},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(i!=="ok"){const v=[e.reasoning||"",Hr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),v.length>0&&v.join(`

`).split(`

`).map((y,f)=>t.jsx("p",{className:"cdtxt",children:y},f)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:y=>{y.stopPropagation(),d(f=>!f)},children:x?a.memoHideHere:a.memoReadHere})}),x&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:y=>y.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(v=>t.jsx("span",{className:"md-tag",children:v},v)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(v=>v.items.map(y=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),b(y.id)},children:y.title},y.id)))}),n.groups.map((v,y)=>t.jsxs("div",{className:"md-grp",children:[v.label&&t.jsx("div",{className:"md-grp-h",children:v.label}),v.items.map(f=>{const k=f.poids>Ed&&!l.has(f.id),E=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:w=>{w&&h.current.set(f.id,w)},children:[t.jsx("h4",{className:"md-h",children:f.title}),E&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:w=>w.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"LinkedIn"})]}),k?t.jsx("button",{type:"button",className:"abtn md-more",onClick:w=>{w.stopPropagation(),c(N=>new Set(N).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:f.html}}),!k&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Da}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:w=>w.stopPropagation()})]})]},f.id)})]},v.label||y)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}function Fn({o:e}){var E;const{t:a,lang:r,dispatch:n,caps:o}=Y(),i=ia(e),s=wt(e),l=(e.cribleStatus||"").trim().toUpperCase()||(i==="NO MATCH"?"NO MATCH":i==="MATCH"?"MATCH":""),c=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),h=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(l?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Dt(e)?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:d}].filter(w=>w.n>0),[e,a,o,l,s,c,x,d]),[u,b]=p.useState(""),m=h.some(w=>w.k===u)?u:((E=h[0])==null?void 0:E.k)||"",v=Nd(e,m==="eval"||m==="conv");if(!h.length)return null;const y=((v==null?void 0:v.reasoning)||"").length>(e.reasoning||"").length?v.reasoning:e.reasoning||"",f=((v==null?void 0:v.summaryHtml)||"").length>(e.summary||"").length?v.summaryHtml:e.summary||"",k=(v==null?void 0:v.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:h.map(w=>t.jsx("button",{type:"button",role:"tab","aria-selected":m===w.k,"data-tour":"tab-"+w.k,className:m===w.k?"on":"",onClick:N=>{N.stopPropagation(),b(w.k)},children:w.lib},w.k))}),t.jsxs("div",{className:"cdbody",onClick:w=>w.stopPropagation(),children:[m==="eval"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1"+(l==="NO MATCH"?" out":""),children:[t.jsx("b",{children:l==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(Vr,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),y&&y.split(`

`).map((w,N)=>t.jsx("p",{className:"cdtxt",children:w},N)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Cd,{o:e})]}),m==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(Vr,{v:k,sur:100,k:a.cdConvScore}),en(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",en(e.verdictDate,r)]})]}),f&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:vd(f)}})]}),m==="memo"&&t.jsx(Sd,{o:e}),m==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdSector,v:e.sector}),t.jsx(ot,{k:a.cdStage,v:e.stage}),t.jsx(ot,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ot,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ot,{k:a.cdAngle,v:e.angle}),t.jsx(ot,{k:a.cdDetected,v:en(e.date,r)})]}),m==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ot,{k:a.cdName,v:e.contactName}),t.jsx(ot,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ot,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),m==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(ot,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}const ba=new Map;function Cd({o:e}){const{t:a,token:r}=Y(),[n,o]=p.useState(!1),[i,s]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const h=`${r}:${e.name.toLowerCase()}`;let u=ba.get(h);u||(u=oo(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),ba.set(h,u),u.then(m=>{(!m||!m.ok)&&ba.delete(h)}));let b=!0;return u.then(m=>{b&&m&&m.ok&&s(m)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const h=await to(r,e.name,e.website||e.domain||"");s(h),h.ok&&ba.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(h)),o(!1)},c=(i==null?void 0:i.blocs)||{},x=[[a.qaVP,c.value_prop],[a.qaProduct,c.produit],[a.qaModel,c.modele],[a.qaSummary,c.synthese]],d=x.some(([,h])=>h);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[x.filter(([,h])=>h).map(([h,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:h}),t.jsx("p",{children:u})]},h)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function sa({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let s=!1;const l=()=>{const x=Math.max(280,Math.min(560,i.clientWidth||320));Yn({kind:"op",card:e},x).then(d=>{!s&&d&&i.isConnected&&i.replaceChildren(d)})},c=window.requestAnimationFrame(l);return()=>{s=!0,window.cancelAnimationFrame(c),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let s=!1;Yn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(c=>{!s&&c&&i.isConnected&&i.replaceChildren(c)});const l=c=>{c.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{s=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&_t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const zd=`
...
`;function Ad(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,s=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:s,top:l}}function qd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:s,askEvaluate:l,doAnalyse:c,doDecide:x,doPromote:d,doRepeche:h,doApproach:u,doDeep:b,doOnboard:m,outbound:v,evalBusy:y}=Y(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const k=Me(f),E=Ne(f),w=wt(f),N=ia(f),q=f.kind==="target",z=F=>{a({type:"filters",patch:F}),a({type:"popup",id:null})};return _t.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:zd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Ad(e.popupAnchor,!!f.card),onClick:F=>F.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(ht(f.date)),Qe(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>z({country:[f.cc]}),children:($t(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>z({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>z({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Ut(f.amountEur,o)})]}),i.pipe&&q&&t.jsxs("div",{className:"pstat",children:[N&&t.jsx("span",{className:"vd "+(N==="MATCH"?"v-ok":"v-no"),title:n.vt[N],children:N}),w&&t.jsx("span",{className:"vd v-cons",title:n.vt[w],children:w}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[At(f.engine)," ",t.jsx("b",{children:Qe(f.engine,o)})," — ",Di(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),k?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(yt,{o:f,lg:!0})," ",t.jsx(Ia,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(io(k,o))," · ",n.win7(so(k,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(sa,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&q&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&q&&t.jsx(Fn,{o:f})]}),t.jsx(Rn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||s!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(f,!1),a({type:"popup",id:null})},children:n.actNo}),Dt(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{h(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),v&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var F;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(F=document.querySelector(".atl2 .demand"))==null||F.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:y,title:n.evalGoOn(f.name),onClick:()=>l(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:y,onClick:()=>l(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Td(){const{lang:e,token:a,dossiers:r,caps:n}=Y(),o=a||"home",{names:i,verdicts:s}=p.useMemo(()=>{const c=[],x={};return r.forEach(d=>{d.kind!=="target"||!d.name||(c.push(d.name),x[d.name]=Ii(d)||"")}),{names:c,verdicts:x}},[r]);return{diff:p.useMemo(()=>i.length?Pi(o,i,s,e):null,[o,i.length]),names:i,verdicts:s,scope:o,caps:n}}function Ld(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:s,caps:l}=Y(),[c,x]=p.useState(!1),[d,h]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!c)return;const E=w=>{u.current&&!u.current.contains(w.target)&&x(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[c]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!s.length,v=p.useRef({});p.useEffect(()=>{v.current={...r}},[r]);const y=E=>{const w=v.current[E],N=w!==void 0?r[E]-w:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${Zt[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E].toUpperCase(),E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(N>0?" up":N<0?" down":""),children:[r[E],N!==0&&t.jsxs("em",{className:"delta",children:[N>0?"+":"−",Math.abs(N)]})]})]},E)},f=(E,w,N)=>t.jsxs("button",{type:"button",className:"off"+(w?" view":""),style:{"--c":`var(${Zt[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:N.toUpperCase()}),t.jsx("span",{className:"n",children:r[E]})]},E),k=(E,w,N,q=!1)=>t.jsx("button",{type:"button",className:"tool",title:w,disabled:q,onClick:N,children:E},w);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(y)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[k("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(d?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}h(!0),window.setTimeout(()=>h(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":c,title:n.toolSort,onClick:()=>x(E=>!E),children:"⇅"}),c&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,w])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[w,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),k("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),k("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Rd(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:s}=Y(),l=p.useRef(null),[c,x]=p.useState(60);p.useEffect(()=>{let m=0;const v=()=>{var w;const y=l.current;if(!y)return;const f=(w=y.parentElement)==null?void 0:w.querySelector('.funnel [aria-selected="true"]');if(!f)return;const k=f.getBoundingClientRect(),E=y.getBoundingClientRect();x(Math.max(20,Math.min(k.left+k.width/2-E.left,E.width-30)))};return m=requestAnimationFrame(v),window.addEventListener("resize",v),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",v)}},[e.ptab]);const d=e.ptab;let h=r.tuto[d].p;if(d===3){const m=n.filter(f=>f.kind==="target"&&Ne(f)===3),v=m.filter(f=>on(f)==="auto").length,y=m.filter(f=>on(f)==="cd").length;h=r.tutoPending(v,y,m.length)}const u=(()=>{if(s!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(d===1){const m=n.filter(v=>v.kind==="target"&&Ne(v)===1&&!o.has(v.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(v=>v.id)})}}return null})(),b=Bi(d);return t.jsxs("div",{ref:l,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${Zt[d]})`,"--ax":c+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:h}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const an=600,St=62,Wr="atl2:fstats";function Fd(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Y(),[s,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Wr)==="on"}catch{return!1}}),c=r.stats,x=p.useMemo(()=>((c==null?void 0:c.by_day)||[]).slice(-30),[c]),d=(c==null?void 0:c.since)||"";if(!n.showFunnel||!c||typeof c.screened!="number")return null;const h=N=>a==="en"?N.slice(5,10):`${N.slice(8,10)}/${N.slice(5,7)}`,u=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((N,q)=>Math.max(N,q.s||0),0),m=x.length?an/x.length:0,v=Math.max(4,m-4),y=x.length>=5&&b>0,f=r.marketEstimate||0,k=h(new Date().toISOString().slice(0,10)),E=N=>[...typeof N=="number"?[[N,e.funScreened("","")]]:[],...typeof c.kept=="number"?[[c.kept,e.funKept]]:[],...typeof c.analyzed=="number"?[[c.analyzed,e.funAnalyzed]]:[],...typeof c.shown=="number"?[[c.shown,e.funShown]]:[]],w=[];return typeof c.screened_window=="number"&&d&&w.push({cle:"fenetre",periode:e.funPerWindow(h(d),k),etapes:[[c.screened_window,e.funScreened("","")]]}),typeof c.screened=="number"&&w.push({cle:"total",periode:e.funPerAll,etapes:E(c.screened)}),t.jsxs("div",{className:"fstats"+(s?" on":""),children:[w.map(N=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:N.periode}),N.etapes.map(([q,z],F)=>t.jsxs("span",{className:"fst-t",children:[F>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(q)}),t.jsx("i",{children:z})]},N.cle+z)),N.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((c.screened||0)/f*100)))})]}),N.cle===w[w.length-1].cle&&y&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":s,title:s?e.fstatsHide:e.fstatsShow,onClick:()=>{const q=!s;l(q),q&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Wr,q?"on":"off")}catch{}},children:s?"⌃":"⌄"})]},N.cle)),s&&y&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${an} ${St}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((N,q)=>{const z=(N.s||0)/b*(St-4),F=(N.m||0)/b*(St-4),T=q*m+(m-v)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${h(N.d)} — ${N.s} ${e.actScreened} · ${N.m} ${e.actKept}`}),t.jsx("rect",{x:T,y:St-2-z,width:v,height:z,fill:"#cfe0d6"}),t.jsx("rect",{x:T,y:St-2-F,width:v,height:F,fill:"#185c38"})]},N.d)}),t.jsx("line",{x1:0,y1:St-1.5,x2:an,y2:St-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:h(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Uo={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Mn({o:e,locked:a=!1}){const{t:r}=Y(),n=ia(e),o=wt(e),i=Ne(e),s=on(e),l=_i(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Uo[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&s==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&s==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(al,{o:e})]})}const Bt=e=>e.length>22?e.slice(0,21)+"…":e;function oa(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Ho(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Md({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const s=()=>{var m,v,y;const l=document.querySelector(".atl2.ops .desk-list"),c=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const x=l.getBoundingClientRect(),d=c?c.getBoundingClientRect().bottom:x.top;i({top:Math.round(d),left:Math.round(x.left),width:Math.round(x.width)});const h=[...l.querySelectorAll(":scope .grp")];let u=null;for(const f of h){const k=f.querySelector(".grp-h");k&&k.getBoundingClientRect().bottom<=d+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((v=b.querySelector(".t"))==null?void 0:v.textContent)||"").trim(),s:(((y=b.querySelector(".s"))==null?void 0:y.textContent)||"").trim()})};return s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",s),window.removeEventListener("resize",s)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Od(e){const r=()=>{const n=Ho(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Gr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Y(),[i,s]=p.useState(!1);if(p.useEffect(()=>{n||s(!1)},[n]),Ie(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const c=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(c?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),s(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}function On({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:s,doPromote:l,doRepeche:c,doApproach:x,dispatch:d,liveMemos:h}=Y(),u=m=>v=>{v.stopPropagation(),m()};if(r.lockActions){const m=u(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Ne(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Sa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),oa(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Gr,{o:e})});const b=Ne(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Gr,{o:e})});if(b===1){const m=h.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:m,serverOff:h.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:u(()=>i(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>s(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>s(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>x(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>c(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Dd({o:e}){const{t:a,doThumb:r,thumbOf:n}=Y(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function Id({o:e}){const{lang:a}=Y();return Me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(yt,{o:e}),t.jsx(Ia,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[At(e.engine||"")," ",Qe(e.engine||"",a)]})})}function Pd({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:s,fresh:l}){const{dispatch:c,caps:x,markRow:d,markedId:h,favIds:u,toggleFav:b,t:m}=Y(),v=Ne(e),y=["#0F172A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,k=f<=0?0:f<=7?1:f<=30?2:3,E=x.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][v]:y[k],w=u.has(e.id),N=q=>{if(a)return;if(s){s(e.id);return}if(x.pipe||e.kind==="op"){n();return}const z=q.currentTarget.getBoundingClientRect();c({type:"popup",id:e.id,anchor:{x:z.left+Math.min(280,z.width/3),y:z.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(h===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(x.pipe&&e.kind==="target"?" p"+v:"")+(w?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:N,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(Qo,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),Me(e)&&t.jsx(yt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[x.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:w?1:.35,padding:0,marginRight:4},onClick:q=>{q.stopPropagation(),b(e)},children:w?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[Ve(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(q=>q&&q!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:q=>{q.stopPropagation(),c({type:"acquirer",value:e.acquirer||""})},children:["← ",Bt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(Bd,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Id,{o:e}),x.pipe&&t.jsx(Mn,{o:e,locked:a}),x.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(On,{o:e}),x.showThumbs&&t.jsx(Dd,{o:e})]}),r&&!a&&!s&&t.jsx(Ud,{o:e})]})}function Bd({o:e}){const{lang:a,caps:r}=Y();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ut(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function _d({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Y(),s=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),c=Ut(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ie(e),h=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:s({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:s({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:s({stage:[e.stage]}),children:e.stage}),c&&t.jsx("span",{className:"oc-amt",children:c}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":h?"var(--brand)":"var(--red)"},children:[h?"✓":"✗"," ",t.jsx("b",{children:h?a.kept:a.dropped})]}):Ve(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),oa(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Bt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(sa,{spec:e.card})})]})}function $d({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Y();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Qe(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(On,{o:e})}),t.jsx(Fn,{o:e})]})}function Vo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:s,caps:l,dossiers:c}=Y(),x=p.useRef(null),d=We(e);if(p.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const g=x.current;if(!g)return;let R=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async $=>{await $.ensureEditoCss(),!(R||!g.isConnected)&&($.beautifyEditoRows(g),$.mountCardFits(g))}),()=>{R=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const g=c.find(We);if(g)return t.jsx(Vo,{o:g})}const h=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||h,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),v=e?!!e.noCo:!h||Ea(h),y=(e==null?void 0:e.engine)||"",f=We(e),k=e?Ut(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),w=(()=>{const g=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return g?g[1].replace(/^www\./,"").slice(0,40):""})(),N=c.find(We),q=((N==null?void 0:N.url)||"").trim(),z=!!u&&!!q&&(u===q||u.endsWith(q)||q.endsWith(u)),F=(g,R=!1)=>$=>{$.stopPropagation(),R&&s({type:"continent",key:"monde"}),s({type:"filters",patch:g})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const T=()=>{h&&(s({type:"continent",key:"monde"}),s({type:"filters",patch:{search:h}}))},D=()=>{e!=null&&e.sector&&s({type:"filters",patch:{sector:[e.sector]}})},O=()=>{oa({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:h})},U=e?Ie(e):!1,M=U&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",I=f?r.doEdito.replace(/^📖\s*/,""):y?Qe(y,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[I,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(v||Sa({engine:y}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:g=>g.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,w?t.jsx("em",{children:w}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:x,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:F({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:F({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:F({stage:[e.stage]}),children:e.stage}),k&&t.jsx("span",{className:"oc-amt",children:k})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(sa,{spec:m})}),(u&&!z&&!f||N&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!z&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:g=>g.stopPropagation(),children:[r.zoomSrc,w?` · ${w}`:""," ↗"]}),N&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:g=>{g.stopPropagation(),s({type:"focus",id:N.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[U?t.jsxs("span",{className:"verdict",style:{"--c":M?"var(--brand)":"var(--red)"},children:[M?"✓":"✗"," ",t.jsx("b",{children:M?r.kept:r.dropped})]}):!v&&h?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:g=>{g.stopPropagation(),o(e,h)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Bt(h))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(v||Sa({engine:y}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!v&&h?" ghost":""),onClick:g=>{g.stopPropagation(),O()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!v&&h&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),D()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:g=>{g.stopPropagation(),T()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Bt(h)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!v&&h&&l.pipe&&t.jsx(Rn,{name:h})]})]})}function Ud({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:s}=Y();return!o.pipe&&e.kind==="op"?t.jsx(_d,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Fn,{o:e}),t.jsx(nl,{o:e}),t.jsx(il,{o:e}),t.jsx(Rn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Mn,{o:e})})]}),e.card&&t.jsx(sa,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[At(e.engine||"")," ",Qe(e.engine||"",r)]}),Me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(yt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>s(e),children:a.actOnboard})})]})]})}function Hd({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:s,doDecide:l,lang:c}=Y();if(!s.pipe&&e.kind==="op"){const h=Ut(e.amountEur,c),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,v=!1)=>y=>{y.stopPropagation(),v&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(sa,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),h&&t.jsx("span",{className:"damt",children:h})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[At(e.engine||"")," ",Qe(e.engine||"",c)]}),Me(e)&&t.jsx(yt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(c==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(On,{o:e})})]})}const x=Ne(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][x];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Mn,{o:e}),Me(e)&&t.jsx(yt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&s.pipe&&x===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function Vd(){const{t:e}=Y(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Wd({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Y(),i=o==="en",s=d=>n.plabels[d]||"",l=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),c=l.includes(0)?0:l.sort((d,h)=>(e[h]||0)-(e[d]||0))[0];if(c===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[c]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${s(a.ptab)}” for now.`:`0 ${s(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:c===0?i?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:i?`${x} ${x>1?"files":"file"} in “${s(c)}”`:`${x} dossier${x>1?"s":""} dans « ${s(c)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:c}),children:[(i?"Open ":"Ouvrir ")+s(c)," →"]})]})}function Gd(){var bt,Ft,Nt,Re,nt;const e=Y(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:s,scopedAll:l,markRow:c,lang:x,sessTally:d,data:h,dossiers:u,source:b,focusExtra:m,byId:v,token:y}=e,f=po(),k=p.useMemo(()=>{var G,ae,ye,P;if(!y||b==="ops")return null;const A=(((G=f==null?void 0:f.ed)==null?void 0:G.date)||(f==null?void 0:f.day)||"").slice(0,10),H=[(ae=f==null?void 0:f.ed)==null?void 0:ae.html,(ye=f==null?void 0:f.ed)==null?void 0:ye.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:x==="en"?"Today's brief":"Brief du jour",headline:x==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((P=f==null?void 0:f.ed)==null?void 0:P.date)||A,decryptHtml:H||void 0,date:A,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[y,b,x,(bt=f==null?void 0:f.ed)==null?void 0:bt.html,(Ft=f==null?void 0:f.ed)==null?void 0:Ft.acquirers_html,(Nt=f==null?void 0:f.ed)==null?void 0:Nt.date,f==null?void 0:f.day]),E=A=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:co,[w,N]=p.useState(new Set);p.useEffect(()=>{N(new Set)},[a.ptab,a.continent]);const[q,z]=p.useState(null);p.useEffect(()=>{z(null)},[a.ptab,a.continent]);const[F,T]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){T(!1);return}const A=document.getElementById("atl2-stage");if(!A){T(!1);return}const H=new IntersectionObserver(([G])=>T(!!G&&G.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return H.observe(A),()=>H.disconnect()},[a.mapFolded]);const D=a.mapFolded||!F,O=A=>N(H=>{const G=new Set(H);return G.has(A)?G.delete(A):G.add(A),G}),U=b==="ops"||o.pipe,[M,I]=p.useState("all"),[g,R]=p.useState(!1),[$,X]=p.useState(null),[j,S]=p.useState(!1),L=p.useRef(!0);p.useEffect(()=>{if(L.current){L.current=!1;return}I("all"),S(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!j)return;const A=H=>{var G,ae;(ae=(G=H.target)==null?void 0:G.closest)!=null&&ae.call(G,".atl2 .doable")||S(!1)};return document.addEventListener("click",A,!0),()=>document.removeEventListener("click",A,!0)},[j]);const B=p.useMemo(()=>{var H;const A=new Map;for(const G of $s(((H=f==null?void 0:f.ed)==null?void 0:H.html)||""))A.has(G.t)||A.set(G.t,G.html);return A},[(Re=f==null?void 0:f.ed)==null?void 0:Re.html]),_=p.useCallback(A=>{if(A.decryptHtml)return A.decryptHtml;if(!B.size)return;const H=(A.name||"").trim().toLowerCase();if(H.length<3)return;const G=B.get(H);if(G)return G;for(const[ae,ye]of B)if(ae.includes(H)||H.includes(ae))return ye},[B]),{diff:W}=Td(),[ue,K]=p.useState(!1),ce=a.filters.win==="1"&&!a.filters.day,[le,be]=p.useState(!1),fe=p.useMemo(()=>new Set(((W==null?void 0:W.added)||[]).map(A=>A.trim().toLowerCase()).filter(Boolean)),[W]),de=p.useMemo(()=>{if(!fe.size)return 0;const A={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(H=>!We(H)&&fe.has((H.name||"").trim().toLowerCase())&&ea(H,A,o.pipe)).length},[u,fe,a,o.pipe]);p.useEffect(()=>{const A=()=>{be(!1),R(!1),I("all"),S(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",A),()=>window.removeEventListener("ppmap:tunnel",A)},[]),p.useEffect(()=>{be(!1),R(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const pe=p.useMemo(()=>{const A=l.filter(G=>!We(G)&&Ve(G));let H="";for(const G of A){const ae=(G.date||"").slice(0,10);ae&&(!H||ae<H)&&(H=ae)}return{n:A.length,since:H?H.split("-").reverse().slice(0,2).join("/"):""}},[l]),ge=pe.n,Q=p.useMemo(()=>{const H=le&&fe.size>0||a.filters.signalOnly||M!=="all"||g?l:s;let G=zn(H,a.sort);return G=G.filter(ae=>!We(ae)),le&&fe.size&&(G=G.filter(ae=>fe.has((ae.name||"").trim().toLowerCase()))),g||M==="explore"?G=G.filter(Ve):M==="eval"?G=G.filter(ae=>!Ve(ae)&&!ae.noCo&&(ae.kind==="op"||!Ie(ae))):o.pipe&&(G=G.filter(ae=>!Ve(ae))),G},[s,l,a.sort,M,le,fe,g,o.pipe]),he=p.useMemo(()=>o.pipe?u.filter(A=>A.kind==="target"&&!We(A)&&Me(A)&&(a.continent==="monde"||A.continent===a.continent)):Q.filter(A=>Me(A)&&!Ie(A)),[o.pipe,u,Q,a.continent]).length,ke=p.useMemo(()=>o.pipe?Q:Q.filter(A=>!Ie(A)&&!A.noCo&&!Ve(A)),[Q,o.pipe]),ne=b==="ops"?Q.filter(Ve).length:0,ve=le?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,oe=a.filters,Se=[];if(oe.day)Se.push({k:"day",lib:n.fDay(oe.day.slice(8,10)+"/"+oe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(oe.win&&oe.win!=="all"){const A=["1","7","30"].indexOf(oe.win);A>=0&&Se.push({k:"win",lib:n.dates[A],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ke=A=>A.length<=2?A.join(", "):`${A.length} ${n.fSelected}`;for(const A of["sector","country","engine"]){const H=oe[A];H&&H.length&&Se.push({k:A,lib:Ke(H),off:()=>r({type:"clearFacet",facet:A})})}oe.search&&Se.push({k:"search",lib:"🔍 "+oe.search,off:()=>r({type:"filters",patch:{search:""}})}),le&&fe.size&&Se.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>be(!1)}),oe.signalOnly&&Se.push({k:"sig",lib:"🔴 "+n.sigDock(he||oe.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const xe=(A,H,G="",ae=!1)=>t.jsxs("button",{type:"button","data-s":A,className:G,"aria-sort":a.sort.key===A?a.sort.dir===1?"ascending":"descending":"none",style:ae?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:A}),children:[H,t.jsx("span",{className:"ar",children:a.sort.key===A&&a.sort.dir===1?"▴":"▾"})]},A),Ce=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const A=new Map;Q.forEach(ae=>{const ye=ae.engine||"?";A.has(ye)||A.set(ye,[]),A.get(ye).push(ae)});const H={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},G=rn([...A.keys()],x);return[...A.entries()].sort((ae,ye)=>{const P=H[ae[0]]??10+G.indexOf(ae[0]),ee=H[ye[0]]??10+G.indexOf(ye[0]);return P-ee})},[Q,o.pipe,a.groupBy,x]),Rt=Ce?Ce.filter(([A])=>ya.has(A)).length:0,Pe=(()=>{var H;return((H=(Ce?Ce.flatMap(([,G])=>G):Q)[0])==null?void 0:H.id)??null})(),Je=p.useRef(!1),qe=p.useMemo(()=>u.find(We)||k,[u,k]);p.useEffect(()=>{const A=()=>{Je.current=!0,be(!1)};return window.addEventListener("ppmap:reveal",A),window.addEventListener("ppmap:focus",A),()=>{window.removeEventListener("ppmap:reveal",A),window.removeEventListener("ppmap:focus",A)}},[]),p.useEffect(()=>{const A=()=>{qe&&r({type:"focus",id:qe.id})};return window.addEventListener("ppmap:edito",A),()=>window.removeEventListener("ppmap:edito",A)},[qe,r]),p.useEffect(()=>{if(!a.focusId)return;X(a.focusId);const A=window.setTimeout(()=>X(null),900);return()=>window.clearTimeout(A)},[a.focusId]),p.useEffect(()=>{if(U&&!(a.focusId&&(Q.some(A=>A.id===a.focusId)||u.some(A=>A.id===a.focusId)||a.focusId===(qe==null?void 0:qe.id)))&&!m){if(qe){r({type:"focus",id:qe.id});return}Pe&&r({type:"focus",id:Pe})}},[U,a.focusId,Q,Pe,m,r,u,b,qe]),p.useEffect(()=>{if(!U||!a.focusId||qe&&a.focusId===qe.id||Q.some(H=>H.id===a.focusId))return;const A=u.find(H=>H.id===a.focusId);if(A){if(Je.current){A.kind==="op"?I(Ve(A)?"explore":"eval"):M!=="all"&&I("all");return}M!=="all"&&Pe&&r({type:"focus",id:Pe})}},[U,a.focusId,M,Q,u,Pe,r,qe]),p.useEffect(()=>{if(!U||!a.focusId||!Je.current)return;const A=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!A){const ye=Q.findIndex(P=>P.id===a.focusId);if(ye>=0){const P=Ce?"":"pt"+a.ptab;if(P){const ee=a.shown[P]||E();ye>=ee&&r({type:"more",group:P,by:ye-ee+8})}}return}Je.current=!1;const H=Ho(),G=A.getBoundingClientRect();G.top>=H-2&&G.bottom<=window.innerHeight-4||Od(A)},[U,a.focusId,a.ptab,Q,a.shown,Ce,r]),p.useEffect(()=>{if(typeof window>"u")return;const A=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),H=document.querySelector(".atl2.ops, .atl2.cibles");if(!A||!H)return;const G=()=>H.style.setProperty("--listhead-h",`${A.offsetHeight}px`);G();const ae=new ResizeObserver(G);return ae.observe(A),()=>ae.disconnect()},[D,a.dens,a.mapFolded]);const it=p.useMemo(()=>{if(!U||!a.focusId)return null;if(k&&a.focusId===k.id)return k;const A=Q.find(G=>G.id===a.focusId)||u.find(G=>G.id===a.focusId)||null;if(!A)return null;const H=_(A);return H&&H!==A.decryptHtml?{...A,decryptHtml:H}:A},[U,a.focusId,Q,u,_,k]),kt=o.lockRowsAfter;let Oe=0;const xt=(A,H)=>{let G=a.shown[H]||E();return A.length-G<=4&&(G=A.length),A.slice(0,G).map(P=>{const ee=kt!==null&&Oe>=kt;Oe++;const ie=_(P),Z=ie&&ie!==P.decryptHtml?{...P,decryptHtml:ie}:P,je=!U&&a.dens!=="maxi"&&(a.dens==="deplie"||(q?q==="open":!!ie)),De=w.has(P.id)?!je:je,$e=U?Ae=>{Je.current=!0,r({type:"focus",id:Ae});const Ue=v.get(Ae);Ue&&(Ve(Ue)?oa(Ue):Ue.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ue.name,url:Ue.url||"",website:Ue.website||"",domain:Ue.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(Hd,{o:Z,locked:ee,selected:U&&a.focusId===P.id,onSelect:$e},P.id):t.jsx(Pd,{o:Z,locked:ee,open:De,onToggle:()=>O(P.id),selected:U&&a.focusId===P.id,echo:$===P.id,fresh:fe.has((P.name||"").trim().toLowerCase()),onSelect:$e},P.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(Q.length?"":" list-empty"),Xe=t.jsxs(t.Fragment,{children:[Ce?Ce.map(([A,H])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:At(A)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:A==="ma"?n.grpMa:A==="fundraising"?n.grpLev:ya.has(A)&&Rt<=1?n.grpNews:A==="nominations"?n.grpNom:A==="media"?n.grpNewsOther:A==="recrutements"?n.grpHire:ya.has(A)?n.grpNews+" · "+Qe(A,x):Qe(A,x)}),t.jsx("div",{className:"s",children:n.grpCount(H.filter(G=>!Ie(G)).length,H.length)})]})]}),xt(H,A)]},A)):xt(Q,"pt"+a.ptab),h.loading&&!u.length&&t.jsx(Vd,{}),o.pipe&&a.ptab===0&&!g&&!le&&M==="all"&&!a.filters.signalOnly&&!h.loading&&t.jsx(Po,{}),!Q.length&&!(h.loading&&!u.length)&&(o.pipe&&M==="all"?t.jsx(Wd,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),jt=t.jsxs(t.Fragment,{children:[!le&&!g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Q.length})," ",ve]}),g&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+Zt[a.ptab]+")"},children:Q.length})," ",n.newsWord]}),(!le||g)&&t.jsx("span",{className:"dot",children:"·"}),D&&t.jsx(Do,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[D?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),Se.map(A=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:H=>{H.stopPropagation(),A.off()},children:[A.lib,t.jsx("i",{children:"×"})]},A.k)),b==="ops"&&Q.length>0&&!D&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",Q.length-ne," ",n.zoomPulseEval,ne>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",ne," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),gt=t.jsxs("div",{className:"listhead"+(D?" mapoff":""),children:[D&&t.jsx("div",{className:"lh-tools",children:t.jsx(Oo,{compact:!0})}),o.showFunnel&&ue&&ce&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(ll,{}),t.jsx(Fd,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:jt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Ld,{}),t.jsx(Rd,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(ce?" on":""),"aria-pressed":ce,title:n.morningDockTitle,onClick:()=>{if(ce){r({type:"filters",patch:{win:"all",day:""}}),K(!1);return}be(!1),R(!1),I("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),K(!0)},children:["📊 ",n.morningDock(typeof((nt=h.stats)==null?void 0:nt.screened_today)=="number"?h.stats.screened_today:0)]}),W&&!W.firstVisit&&(W.added.length>0||W.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(le?" on":""),"aria-pressed":le,title:n.sinceSub,onClick:()=>{const A=!le;be(A),R(!1),K(!1),I("all"),A&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(de),W!=null&&W.lastDate?` · ${n.sinceSince(W.lastDate)}`:""]}),he>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{be(!1),R(!1),K(!1),I("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(he)]}),o.pipe&&ge>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(g?" on":""),"aria-pressed":g,title:n.newsDockHint,onClick:()=>{const A=!g;R(A),be(!1),K(!1),I("all"),A&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ge),pe.since?` · ${n.newsSince(pe.since)}`:""]})]}),!o.showFunnel&&jt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([A,H])=>t.jsxs("button",{type:"button","data-d":A,"aria-pressed":a.dens===A||A==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:A}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:H})]},A))}),!U&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":q==="open",onClick:()=>{z("open"),N(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":q==="closed",onClick:()=>{z("closed"),N(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var ie;const A={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},H=u.filter(Z=>ea(Z,A,o.pipe)&&!We(Z)),G=H.filter(Z=>!Ve(Z)&&!Z.noCo&&(Z.kind==="op"||!Ie(Z))).length,ae=H.filter(Ve).length,ye=o.pipe?H.filter(Z=>Z.kind!=="op"&&Ne(Z)===1).length:0,P=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ye?` ${ye}`:""}`]]:[],["eval",`${n.doEval}${G?` ${G}`:""}`],["explore",`${n.doExplore}${ae?` ${ae}`:""}`]],ee=((ie=P.find(([Z])=>Z===M))==null?void 0:ie[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":j,onClick:()=>S(Z=>!Z),children:[ee,t.jsx("i",{children:"▾"})]}),j&&t.jsx("div",{className:"dolist",children:P.map(([Z,je])=>t.jsx("button",{type:"button","aria-pressed":M===Z,onClick:()=>{if(S(!1),Z==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}I(Z),Z!=="all"&&(be(!1),R(!1),K(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:je},Z))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:A=>r({type:"sort",key:A.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([A,H])=>t.jsx("option",{value:A,children:H},A))})]}),o.showChain&&ke.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ke.map(A=>A.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ke.length):n.chainAll(ke.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!U&&gt,a.dens!=="maxi"&&!U&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),xe("country",n.colCountry),xe("name",n.colCompany),xe("amount",n.colAmount,"h-amt",!0),xe("stage",n.colStage,"h-stade"),xe("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[xe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),xe("memo",n.colMemo)]}),o.pipe&&xe("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),U?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[gt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),xe("country",n.colCountry),xe("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[xe("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),xe("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:Xe})]}),t.jsxs("aside",{className:"readpane"+((it?We(it):!m&&qe)?" is-edito":""),"aria-label":x==="fr"?"Dossier":"File",children:[qe&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===qe.id,onClick:()=>r({type:"focus",id:qe.id}),children:n.doEdito}),k&&a.focusId===k.id?t.jsx("div",{className:"zoom",children:t.jsx(Gs,{})}):it&&o.pipe?t.jsx($d,{o:it}):t.jsx(Vo,{o:it,extra:it?null:m})]})]}):t.jsx("div",{className:ut,children:Xe}),(()=>{const A=Ce||[["pt"+a.ptab,Q]];let H=0,G=0;for(const[ye,P]of A){G+=P.length;let ee=a.shown[ye]||E();P.length-ee<=4&&(ee=P.length),H+=Math.min(P.length,ee)}const ae=G-H;return ae<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>A.forEach(([ye,P])=>r({type:"more",group:ye,by:P.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(ae,ae)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(H,G)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),U&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Md,{on:!!Ce,rev:(Ce||[]).map(([A,H])=>A+H.length).join("|")})]})}function Yr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Yd(e,a){const r=$i(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Qd(e,a){const n=[a.head.split("|").map(Yr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Yd(o,a.plabels),ia(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Yr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Kd(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Jd=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Xd({o:e,qa:a}){const{t:r,lang:n,fund:o}=Y(),i=(e.cribleStatus||"").trim().toUpperCase()||(ia(e)==="NO MATCH"?"NO MATCH":"MATCH"),s=wt(e),l=(a==null?void 0:a.blocs)||{},c=[[r.qaVP,l.value_prop],[r.qaProduct,l.produit],[r.qaModel,l.modele],[r.qaSummary,l.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,s&&t.jsx("em",{children:s})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:Jd(e.date,n)})]}),c.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),c.filter(([,x])=>x).map(([x,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:d})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function Zd(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:s}=Y(),[l,c]=p.useState({}),x=25,d=p.useMemo(()=>n.slice(0,x),[n]);p.useEffect(()=>{d.length&&oo(r,d.map(b=>b.name)).then(c)},[r,d]);const h=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),h&&typeof h.screened=="number"&&t.jsxs("p",{children:[u(h.screened)," ",e.funScreened(""),typeof h.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(h.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(h.screened/i.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(Xd,{o:b,qa:l[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const ec=50;function Dn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Y(),[i,s]=p.useState(null),[l,c]=p.useState(!1),[x,d]=p.useState(""),[h,u]=p.useState(0),[b,m]=p.useState(""),[v,y]=p.useState(!1),[f,k]=p.useState(0),E=p.useRef(null),w=p.useRef(null),N=()=>{k(0),w.current&&window.clearInterval(w.current),w.current=window.setInterval(()=>k(T=>T+1),1e3)},q=()=>{w.current&&(window.clearInterval(w.current),w.current=null)};p.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),w.current&&window.clearInterval(w.current)},[]);const z=async T=>{c(!0),d(""),N();const D=await a();if(c(!1),q(),D.ok){s(D);return}if(D.busy){d(o.alertPreviewBusy);return}if(!T){d(o.alertPreviewFail);return}u(ec),q(),E.current=window.setInterval(()=>{u(O=>O>1?O-1:(E.current&&window.clearInterval(E.current),z(!1),0))},1e3)},F=async()=>{if(n||v||l)return;y(!0),m(""),N();const T=await r();y(!1),q(),m(T.ok?o.alertTestOk(T.sentTo||""):T.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||v||h>0,onClick:()=>{z(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||v||l,onClick:()=>{F()},children:v?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),v&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),h>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(h)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const zt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ge({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=Y();return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function tc(){const{st:e}=Y();switch(e.modal){case"chain":return t.jsx(nc,{});case"space":return t.jsx(rc,{});case"alert":return t.jsx(oc,{});case"queue":return t.jsx(cc,{});case"export":return t.jsx(pc,{});case"plug":return t.jsx(fc,{});case"recharge":return t.jsx(gc,{});case"cover":return t.jsx(vc,{});case"dossier":return t.jsx(bc,{});case"crit":return t.jsx(yc,{});case"tuto":return t.jsx(wc,{});case"rdv":return t.jsx(ac,{});case"memoalert":return t.jsx(uc,{});default:return null}}function ac(){const{dispatch:e,fund:a,t:r}=Y(),n=a||r.rdvCoFallback;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:fo,children:qn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],s)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(s+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(us,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function nc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:s,evalBusy:l,caps:c,memoQueued:x,doAnalyse:d}=Y(),h=i==="client",u=e.chain.queue.map(y=>r.get(y)).filter(y=>!!y),b=e.chain.idx,m=u[b],v=b>=u.length;return _t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:v?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(v?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:v||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[$t(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(ht(m.date))].filter(Boolean).map(y=>String(y).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Qe(m.engine,o).toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Ut(m.amountEur,o)})]}),Me(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(yt,{o:m,lg:!0})," ",t.jsx(Ia,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(h&&Ie(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),h&&Ie(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":Ct(m)==="retenu"?"var(--brand)":Ct(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ct(m)==="retenu"?"✓ "+n.kept:Ct(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!v&&m&&c.pipe&&Ne(m)===1&&!x.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!v&&m&&!(h&&Ie(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var y;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(y=document.querySelector(".atl2 .demand"))==null||y.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{s(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(v?{type:"modal",modal:null}:{type:"chainNext"}),children:v?n.closeBtn:n.skip})]})]})})}),document.body)}function rc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Y(),i=o==="client",s=p.useMemo(()=>i?r.filter(h=>Ie(h)):[],[r,i]),l=p.useMemo(()=>zn(s.filter(h=>Ct(h)==="retenu"),{key:"signal",dir:-1}),[s]),c=p.useMemo(()=>s.filter(h=>Ct(h)==="ecarte"),[s]),x=e.spaceTab==="retenu"?l:c,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ge,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:c.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(h=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof h.score=="number"&&h.score>0?h.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:h.name}),t.jsx("div",{className:"rr",children:h.reasoning||h.tagline||""})]})]},h.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function oc(){const{mode:e}=Y();return e==="client"||e==="apercu"?t.jsx(ic,{}):t.jsx(dc,{})}function ic(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),[i,s]=p.useState("d"),l=o!=="client";return t.jsxs(Ge,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>s("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>s("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>s("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(sc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(lc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(Wo,{})]})}function sc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,c]=p.useState(!1),[x,d]=p.useState(0);p.useEffect(()=>{let F=!0;return c(!1),Zn(a).then(T=>{F&&(T?s(T):c(!0))}),()=>{F=!1}},[a,x]);const h=p.useRef({}),[u,b]=p.useState({}),[m,v]=p.useState(!1),[y,f]=p.useState(!1),k=p.useRef(null);p.useEffect(()=>()=>{k.current&&window.clearTimeout(k.current)},[]);const E=F=>{const T=h.current;Object.keys(T).length&&(v(!0),Zn(a,T).then(D=>{if(!D){v(!1),o(e.actErr);return}if(D.throttled&&F<3){k.current=window.setTimeout(()=>E(F+1),5400);return}if(h.current={},b({}),s(D),v(!1),D.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},w=F=>{r||(h.current={...h.current,...F},b(T=>({...T,...F})),k.current&&window.clearTimeout(k.current),k.current=window.setTimeout(()=>E(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(F=>F+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const N={...i,...u},q=F=>!N.sections||N.sections.includes(F),z=F=>{const T=N.sections||e.alertSec.map(([D])=>D);w({sections:q(F)?T.filter(D=>D!==F):[...T,F]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":N.enabled===!0,disabled:r,style:N.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!N.enabled}),children:N.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>w({hour:Math.max(6,(N.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[N.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>w({hour:Math.min(21,(N.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:N.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>w({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&y&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([F,T])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:q(F),disabled:r,onChange:()=>z(F)}),t.jsxs("span",{children:[T,F==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},F))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Dn,{label:e.alertPreview,readOnly:r,onPreview:()=>Xi(a),onTest:()=>Ji(a)}),N.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),N.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",N.email_lead,N.last_sent?` · ${e.updatedAt(N.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function lc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,s]=p.useState(null),[l,c]=p.useState(!1),[x,d]=p.useState(0);p.useEffect(()=>{let m=!0;return c(!1),er(a).then(v=>{m&&(v?s(v):c(!0))}),()=>{m=!1}},[a,x]);const h=m=>{r||er(a,m).then(v=>{if(!v){o(e.actErr);return}s(v),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>h({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>h({dow:Number(m.target.value)}),children:e.alertDow.map((m,v)=>t.jsx("option",{value:v,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>h({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Dn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>es(a),onTest:()=>Zi(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Wo(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Y(),[s,l]=p.useState(i||""),[c,x]=p.useState(!1),[d,h]=p.useState(!1);p.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(f=>Me(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,v=async()=>{if(!(!/.+@.+\..+/.test(s)||d)){h(!0);try{await fetch(`${Da}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{h(!1)}}},y=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Qe(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>$t(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(s)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:y.map(([f,k])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:k}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:s,readOnly:!!i,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function dc(){const{t:e}=Y();return t.jsx(Ge,{title:e.alertTitle,icon:"🔔",children:t.jsx(Wo,{})})}function cc(){var O,U;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:s,caps:l,dispatch:c,liveMemos:x}=Y(),[d,h]=p.useState(()=>$a(r)),[u,b]=p.useState(()=>!$a(r)),[m,v]=p.useState([]),[y,f]=p.useState(0),k=n==="client",E=p.useMemo(()=>{const M=new Map;return o.forEach(I=>{const g=(I.name||"").trim().toLowerCase();g&&!M.has(g)&&M.set(g,I)}),M},[o]);p.useEffect(()=>{let M=!0;return(!$a(r)||y>0)&&b(!0),(async()=>{const[I,g]=await Promise.all([En(r,y>0),eo(a)]);M&&(I&&h(I),b(!1),v(g))})(),()=>{M=!1}},[a,r,y]);const w=u&&!d,N=(d==null?void 0:d.per_day)??0,q=((O=d==null?void 0:d.analyzed_today)==null?void 0:O.length)??0,z=d==null?void 0:d.offre,F=(d==null?void 0:d.pool_meta)||[],T=p.useMemo(()=>{const M=new Map;for(const I of(d==null?void 0:d.scheduled)||[])for(const g of I.names||[])M.has(g)||M.set(g,{label:I.day_label,date:I.date});return M},[d==null?void 0:d.scheduled]),D=(d==null?void 0:d.in_progress)||[];return t.jsxs(Ge,{title:e.queueTitle,wide:!0,children:[z&&t.jsxs("div",{className:"qoffre"+(z.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:z.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:z.delai})]}),t.jsx("span",{className:"osp"}),z.rythme>0?t.jsx("span",{className:"or",children:e.qRate(z.rythme)}):z.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(z.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:w?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(q,q+(((U=d==null?void 0:d.pool_order)==null?void 0:U.length)??0))}})}),z&&t.jsxs("div",{className:"qeta",children:[z.file===0?e.qEtaDone:z.rythme<=0?e.qEtaPaused:e.qEta(z.file,z.rythme,z.jours_restants),z.en_retard&&t.jsxs("em",{children:[" ",e.qLate(z.delai,z.plafond)]})]}),!w&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(N)}),(z==null?void 0:z.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(D.length>0||x.items.some(M=>M.status==="boot"||M.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[x.items.filter(M=>M.status==="boot"||M.status==="running"||M.status==="error").map(M=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:M.name}),t.jsx("span",{className:"qd",children:M.memoType||""}),t.jsx(Na,{item:M,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+M.name)),D.filter(M=>!x.liveOf(M.name)).map(M=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:M.name}),t.jsxs("span",{className:"qd",children:[M.memo_type||"",M.age_min?` · ${Math.round(M.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:M.state||""})]},"ip-"+M.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(M=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:M.company}),t.jsxs("span",{className:"qd",children:[M.memo_type,typeof M.est_min=="number"?` · ~${M.est_min} min`:""]}),t.jsx("span",{className:"qt",children:M.status}),M.url&&t.jsx("a",{className:"qgo",href:M.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(M.memo_type)}),k&&M.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Jn(a,M.company,"retry").then(()=>f(I=>I+1))},children:e.queueRetry}),k&&M.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Jn(a,M.company,"delete").then(()=>f(I=>I+1))},children:e.queueDelete})]},M.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",w?e.qUpNextWait:e.qUpNext(F.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[w&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!w&&F.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),F.map((M,I)=>{const g=T.get(M.name),R=E.get((M.name||"").trim().toLowerCase()),$=x.liveOf(M.name),X=!!(R&&s.has(R.id))||!!($&&($.status==="boot"||$.status==="running")),j=!!(R&&Ne(R)===1&&!R.memoUrl)&&!$;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",I+1]}),g?t.jsx("span",{className:"qwhen"+(g.label==="demain"?" soon":""),children:g.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:M.name}),M.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof M.score=="number"&&t.jsx("span",{className:"qs2",children:M.score}),$&&($.status==="boot"||$.status==="running")&&t.jsx(Na,{item:$,serverOff:x.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),j&&(l.lockActions||!k?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>c({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:X,onClick:()=>{i(R),f(S=>S+1)},children:X?e.actAnalyseQueued:e.actAnalyse})),M.excerpt&&t.jsx("span",{className:"qex",children:M.excerpt})]},M.name+":"+I)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([M,I])=>t.jsxs("li",{children:[t.jsx("b",{children:M})," — ",I]},M))})]})}function pc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:s}=Y(),l=`${zt}/cibles/list.csv?token=${a}`,c=`${zt}/cibles/list.json?token=${a}`,x=`${zt}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${l}")`,h=y=>{var f;(f=navigator.clipboard)==null||f.writeText(y).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:d},{def:e.exportLive,value:c,href:c},{def:e.exportXlsx,value:x,href:x}],b=!o.lockActions&&n.length>0,m=()=>{Kd(Qd(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:y=>(e.stg.find(([f])=>f===y)||["",""])[1]})),r(e.exportViewDone(n.length))},v=()=>{s({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ge,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:v,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>s({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:y,value:f,href:k})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:y[0]}),t.jsxs("div",{children:[t.jsx("b",{children:y[1]}),t.jsx("p",{children:y[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>h(f),children:e.exportCopy}),k&&t.jsx("a",{className:"exb",href:k,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},y[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function uc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Y(),i=o!=="client",[s,l]=p.useState(null),[c,x]=p.useState(!1),[d,h]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return x(!1),Qn(a).then(k=>{f&&(k?l(k):x(!0))}),()=>{f=!1}},[a,d]);const m=()=>(s==null?void 0:s.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},v=f=>{if(i||!s)return;const k={enabled:f.enabled??!!s.enabled,email:f.email??(s.email||""),sections:f.sections??m()};b(!0),Qn(a,k).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}l(E),r(e.memoAlertSaved)})};if(c)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>h(f=>f+1),children:e.retry})]})});if(!s)return t.jsx(Ge,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const y=m();return t.jsxs(Ge,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":s.enabled===!0,disabled:i||u,style:s.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>v({enabled:!s.enabled}),children:s.enabled?"ON":"OFF"})})]}),t.jsx(mc,{value:s.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>v({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,k])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!y[f],disabled:i||u,onChange:()=>v({sections:{...y,[f]:!y[f]}})}),t.jsx("span",{children:k})]},f))}),t.jsx(Dn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Hi(a,y),onTest:()=>Ui(a,y)})]})}function mc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,s]=p.useState(e);p.useEffect(()=>{s(e)},[e]);const l=i.trim()!==e.trim(),c=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:x=>s(x.target.value),onKeyDown:x=>{x.key==="Enter"&&l&&c&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!c,onClick:()=>o(i.trim()),children:n})]})]})}function fc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Y(),[i,s]=p.useState(null),[l,c]=p.useState(!1),[x,d]=p.useState(null),[h,u]=p.useState(!1),[b,m]=p.useState(""),[v,y]=p.useState(0),[f,k]=p.useState("webhook"),[E,w]=p.useState(""),N=p.useRef(!1);p.useEffect(()=>{let O=!0;return c(!1),Kn(a).then(U=>{O&&(U?s({configured:U.configured,url_hint:U.url_hint}):c(!0))}),Gi(a).then(U=>{if(O){if(!U){u(!0);return}u(!1),d(U),N.current||(N.current=!0,U.destination==="instantly"&&k(M=>M==="webhook"?"instantly":M),U.campaign_id&&w(M=>M||U.campaign_id||""))}}),()=>{O=!1}},[a,v]);const q=(O,U)=>{o&&Kn(a,O).then(M=>{if(!M||M.ok===!1){n(e.actErr);return}O.test&&M.sent===!1?n(e.plugTestThrottled):r(U),y(I=>I+1)})},z='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',F=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),T=`curl -X POST ${zt}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,D=`curl -X POST ${zt}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ge,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>y(O=>O+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:O=>m(O.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>q({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>q({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>q({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:F}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var O;(O=navigator.clipboard)==null||O.writeText(F).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(xc,{destKind:f,setDestKind:k,camp:E,setCamp:w,whHint:i!=null&&i.configured?i.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(hc,{auto:x,autoKo:h,destKind:f,camp:E,onRetry:()=>y(O=>O+1),onDone:O=>{d(O),u(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:T}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var O;(O=navigator.clipboard)==null||O.writeText(T).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:z}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var O;(O=navigator.clipboard)==null||O.writeText(z).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:D}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var O;(O=navigator.clipboard)==null||O.writeText(D).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function hc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:s,token:l,flash:c,flashErr:x,canWrite:d}=Y(),[h,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:s.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[s.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:s.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?s.plugAutoNeed:"":n.trim()?"":s.plugCampNeed),v=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,y=()=>{if(h||!d||m)return;u(!0),(b?Xn(l,!1):Xn(l,!0,r,n.trim()||void 0)).then(k=>{if(u(!1),!k){x(s.actErr);return}o(k),c(k.enabled?s.plugAutoSavedOn:s.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:s.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:s.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:h||!d||!!m,title:m||void 0,onClick:y,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:s.plugAutoOnLbl})]}),m===s.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),v&&t.jsx("p",{className:"mnote warn",children:s.plugAutoBroken})]})}function xc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:s,lang:l,canWrite:c}=Y(),[x,d]=p.useState("valides"),[h,u]=p.useState(!1),[b,m]=p.useState(null),[v,y]=p.useState(null),[f,k]=p.useState(!1),[E,w]=p.useState(!1),[N,q]=p.useState(null),[z,F]=p.useState(null),T=`atl2:bulk:${s}:${x}:${e}`;p.useEffect(()=>{m(null),y(null),k(!1),q(null);try{const S=localStorage.getItem(T)||localStorage.getItem(`atl2:bulk:${s}:${x}`),L=JSON.parse(S||"null");F(L&&Date.now()-Date.parse(L.t)<24*3600*1e3?L:null)}catch{F(null)}},[T,x,s]);const D=e==="instantly"&&!r.trim(),O=`${x}|${e}|${r.trim()}`,U=async()=>{if(D||!c)return;u(!0),k(!1),q(null);const S=await Qi(s,x,e,r.trim()||void 0);m(S),y(S.ok?O:null),u(!1)},M=p.useRef(!1);if(!c)return null;const I=async()=>{if(M.current||!c)return;M.current=!0,w(!0);const S=`${s}:${x}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await Ki(s,x,e,r.trim()||void 0,S)}finally{M.current=!1}if(w(!1),k(!1),q(L),L.ok&&(L.pushed||0)>0){const B={t:new Date().toISOString(),n:L.pushed||0};F(B);try{localStorage.setItem(T,JSON.stringify(B))}catch{}}};f&&v!==null&&v!==O&&k(!1);const g=o,R=b!=null&&b.ok&&b.ready||0,$=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":g||"",X=!!(b!=null&&b.ok)&&v===O&&R>0&&!!$&&!z,j=z?new Date(z.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:x,onChange:S=>d(S.target.value),children:i.plugBulkTabs.map(([S,L])=>t.jsx("option",{value:S,children:L},S))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:S=>a(S.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:S=>n(S.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:h||D,onClick:()=>{U()},children:h?"…":i.plugBulkPreview})]}),D&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),z&&t.jsx("p",{className:"mnote",children:i.bulkLocked(j,z.n)}),!z&&!!(b!=null&&b.ok)&&!$&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!z&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),X&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>k(!0),children:i.bulkArm}),X&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(R,$)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{I()},children:E?i.bulkSending:i.bulkConfirm($)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>k(!1),children:i.bulkCancel})]}),N&&(N.ok?N.replayed?t.jsx("p",{className:"mnote",children:N.pending?i.bulkPending:i.bulkReplayed}):(N.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(N.pushed||0,N.linkedinReady||0,N.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:N.error||i.actErr}))]})}function gc(){const{t:e,data:a,lang:r}=Y(),n=a.credits,o=a.email,i=async s=>{if(!o)return;const l=window.location.href.split("?")[0];try{const x=await(await fetch(`${Da}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:s,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Ge,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(s=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(s.credits,s.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(s.lookup_key)},children:e.rechargeBuy})]},s.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function bc(){const{t:e}=Y();return t.jsx(Ge,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Zd,{})})}function vc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:s,flash:l}=Y(),[c,x]=p.useState(null),[d,h]=p.useState(!1);p.useEffect(()=>{let T=!0;if(i)return En(i).then(D=>{T&&D&&typeof D.per_day=="number"&&x(D.per_day)}),()=>{T=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let T=!0;return Wi(o).then(D=>{T&&b(D)}),()=>{T=!1}},[o]);const m=r.stats,v=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(T=>T.kind==="target"&&Ie(T)).length,y=r.marketEstimate||0,f=y>0?Math.min(100,Math.round(v/y*100)):null,k=(m==null?void 0:m.window_days)||30,E=v>0?v/k:0,w=y>0?Math.max(0,y-v):0,q=y>0&&E>0&&v>=100?Math.round(w/E):null,z=T=>Math.round(T).toLocaleString(a==="en"?"en-US":"fr-FR"),F=T=>{d||!s||(h(!0),Yi(o,T).then(D=>{if(h(!1),D===null){l(e.actErr);return}x(D),l(e.alertSaved)}))};return t.jsxs(Ge,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(z(v))}),y>0&&t.jsx("span",{children:e.covOf(z(y))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),q!==null&&t.jsx("p",{className:"mnote",children:e.covEta(q)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(z(E))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:z(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((T,D)=>t.jsxs("tr",{className:T.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[T.code,T.geo?` · ${T.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof T.n=="number"?z(T.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:T.source}),T.elargi&&t.jsx("em",{children:e.covWide(String(T.demande||""))}),T.erreur&&t.jsx("em",{children:e.covMissing})]})]},D)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:z(u.total||y)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),s&&c!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(c)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(T=>t.jsx("button",{type:"button",className:c===T?"on":"",disabled:d,onClick:()=>F(T),children:T===0?"⏸":T},T))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function yc(){var f,k,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:s,lang:l}=Y(),c=n==="client",x=p.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[d,h]=p.useState(""),[u,b]=p.useState(""),[m,v]=p.useState(!1),y=async()=>{const w=d.trim();if(!(!w||m||!c)){v(!0),b("");try{const q=await(await fetch(`${zt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(q.reply&&b(String(q.reply)),q.job_id){b(e.critChatRunning);const z=async()=>{const F=await fetch(`${zt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:q.job_id})}).then(T=>T.json()).catch(()=>null);if(F&&F.done){b(String(F.reply||F.clarification||F.summary||"✓")),v(!1),F.applied&&o(e.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),h("");return}h("")}finally{u.startsWith("⏳")||v(!1)}}};return t.jsxs(Ge,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((k=i==null?void 0:i.angles)!=null&&k.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(w=>{var N,q;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(z=>t.jsx("li",{children:z},z))})]}),!!((q=w.out)!=null&&q.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(z=>t.jsx("li",{children:z},z))})]})]})]},w.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!c||m,onChange:w=>h(w.target.value),onKeyDown:w=>{w.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!c||m||!d.trim(),onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Vi,{fund:s,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Uo[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function wc(){const{t:e,dispatch:a,startTour:r}=Y(),n=o=>{var i,s;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(s=document.querySelector(".atl2 .demand input"))==null||s.focus())};return t.jsxs(Ge,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],s)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:s+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+s))})]})}const Go="atl2:mapfold",kc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Go);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},jc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Yo=p.createContext(null),Y=()=>{const e=p.useContext(Yo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function yt({o:e,lg:a}){const{lang:r}=Y(),n=Me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:tr(n,r),children:[n.emoji," ",tr(n,r)]}):null}function Ia({o:e,src:a}){const{lang:r,t:n}=Y(),o=Me(e);if(!o)return null;const i=is(o),s=ss(o);return t.jsxs("em",{className:"sigwin"+(s?" hot":""),title:n.signaledOn(io(o,r))+" · "+n.win7(so(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,c)=>t.jsx("i",{className:c<i?"on":""},c))}),t.jsx("span",{className:"lb",children:s?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function Nc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(s=>(s.url||"")===n);if(i)return i}const o=_e(a);if(o)return e.find(i=>_e(i.name)===o)||e.find(i=>{const s=_e(i.name);return s.length>=3&&(o.includes(s)||s.includes(o))})}function Ec(){const{scoped:e,t:a,st:r,dispatch:n}=Y(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,s=e.filter(h=>!We(h)),l=s.length,c=s.filter(h=>!h.noCo).length,x=s.filter(h=>!!h.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const h=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:h,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",x," ",a.zoomPulseExplore]})]})]})}function Sc(){const{t:e,lang:a,data:r,dispatch:n}=Y(),o=r.stats,i=l=>l.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const s=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:s>0?e.covOf(i(s)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function Qo({o:e}){const{lang:a}=Y(),r=os(e.cc),n=e.cc?$t(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Qr="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Cc=!1;function zc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Ko=e=>`atl2:tour:${e||"anon"}`;function Ac(e){try{return localStorage.getItem(Ko(e))==="1"}catch{return!0}}function Kr(e){try{localStorage.setItem(Ko(e),"1")}catch{}}function qc(e,a,r,n,o,i){const s=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:s.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:s.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Mc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var In;const{lang:s}=ts(),l=Es[s],c=Ds(e,s,a),[x,d]=p.useReducer(Bs,void 0,()=>Is((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?jc():kc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),h=p.useRef(!0);p.useEffect(()=>{if(h.current){h.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Go,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const C=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return C(),window.addEventListener("resize",C),()=>window.removeEventListener("resize",C)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var C;(C=u.current)==null||C.call(u,x.filters)},[x.filters]);const[b,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const C=localStorage.getItem("atl2:chrome-mode");if(C==="eval"||C==="filt"||C==="both")return C;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[v,y]=p.useState(null),[f,k]=p.useState(null),[E,w]=p.useState(null),[N,q]=p.useState({kept:0,dropped:0}),[z,F]=p.useState(!1),[T,D]=p.useState(""),[O,U]=p.useState(!1),[M,I]=p.useState(null),[g,R]=p.useState(!1),[$,X]=p.useState(!1),[,j]=p.useState(0),S=()=>j(C=>C+1),L=p.useRef([]),B=p.useRef(new Set),_=p.useRef(new Set),[W,ue]=p.useState([]),[K,ce]=p.useState([]),[le,be]=p.useState(0),fe=p.useRef(new Map),de=p.useRef(null),{mode:pe}=c,ge=p.useMemo(()=>({...c.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[c.caps,o,a]),Q=ge.pipe,re=c.session.token||"",he=pe==="client"&&!e;p.useEffect(()=>{if(!re||!Q)return;let C=!0;const J=async()=>{const se=await ls(re);!C||!se||(ce(se.runs),be(Date.now()/1e3-se.now),ue(He=>He.filter(Ee=>!se.runs.some(Be=>_e(Be.company)===_e(Ee.name)))))};J();const V=W.length>0||K.some(se=>se.status==="running"),te=window.setInterval(()=>{J()},V?8e3:25e3);return()=>{C=!1,window.clearInterval(te)}},[re,Q,W.length,K.some(C=>C.status==="running")]);const ke=p.useMemo(()=>{const C=[],J=new Set;for(const V of W){const te=_e(V.name);!te||J.has(te)||(J.add(te),C.push({name:V.name,id:V.id,status:"boot",started:V.started,estMin:V.estMin,memoType:"instant"}))}for(const V of K){const te=_e(V.company);if(!te||J.has(te))continue;J.add(te);const se=V.status==="error"?"error":V.status==="done"?"done":"running";C.push({name:V.company,status:se,started:V.started||0,estMin:V.est_min||(V.memo_type==="detailed"?40:15),url:V.url,error:V.error,memoType:V.memo_type,note:V.note})}return C},[W,K]),ne=C=>ke.find(J=>_e(J.name)===_e(C))||null,ve=(C,J)=>{ue(V=>V.some(te=>_e(te.name)===_e(C.name))?V:[...V,{name:C.name,id:C.id,started:Date.now()/1e3,estMin:J==="detailed"?40:15}]),B.current.add(C.id),S()};p.useEffect(()=>{if(document.querySelector(`link[href="${Qr}"]`))return;const C=document.createElement("link");C.rel="stylesheet",C.href=Qr,document.head.appendChild(C)},[]);const oe=(C,J=!1)=>{D(C),U(J),de.current&&clearTimeout(de.current),de.current=setTimeout(()=>D(""),J?4200:2400)},Se=C=>oe(C,!0),Ke=p.useMemo(()=>{const C=new Map;return c.dossiers.forEach(J=>{J.id&&C.set(J.id,J)}),C},[c.dossiers]),xe=p.useMemo(()=>c.dossiers.filter(C=>ea(C,x,Q)),[c.dossiers,x,Q]),Ce=p.useRef(!1);p.useEffect(()=>{if(Ce.current||e||c.loading||!c.dossiers.length)return;if(!ge.showFunnel||Ac(c.session.token||"")){Ce.current=!0;return}Ce.current=!0;const C=window.setTimeout(()=>{Kr(c.session.token||""),R(!0)},700);return()=>window.clearTimeout(C)},[e,c.loading,c.dossiers.length,ge.showFunnel,c.session.token]);const Rt=p.useMemo(()=>c.dossiers.filter(C=>_s(C,x,Q,c.favIds)),[c.dossiers,x,Q,c.favIds]),Pe=p.useMemo(()=>as(xe.filter(C=>!Ve(C)),c.favIds),[xe,c.favIds]),Je=p.useRef(!1);p.useEffect(()=>{if(Je.current)return;if(!Q||a==="ops"){Je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Je.current=!0;return}if(c.loading)return;Je.current=!0;const C=ns(Pe);C!==x.ptab&&d({type:"ptab",tab:C})},[Q,a,n==null?void 0:n.ptab,c.loading,Pe,x.ptab]);const qe=p.useMemo(()=>{const C=xo(c.dossiers);return C?ht(C)===0?l.tourToday:go(C,s):l.tourNoRun},[c.dossiers,l,s]),it=p.useMemo(()=>c.dossiers.some(C=>!!C.memoUrl||!!C.summary||Dt(C)),[c.dossiers]),[kt,Oe]=p.useState(!1);p.useEffect(()=>{if(c.loading){Oe(!1);return}if(c.dossiers.length>0||c.error){Oe(!0);return}const C=window.setTimeout(()=>Oe(!0),6e3);return()=>window.clearTimeout(C)},[c.loading,c.dossiers.length,c.error]);const xt=(c.marketEstimate||0)>0||typeof((In=c.stats)==null?void 0:In.screened)=="number"&&c.stats.screened>0,ut=p.useMemo(()=>[1,0,2,4,5,3].find(C=>(Pe[C]||0)>0)??0,[Pe]),Xe=Sn.find(C=>C.key===x.continent),jt=x.continent==="monde"?l.contWorld:(s==="fr"?Xe==null?void 0:Xe.fr:Xe==null?void 0:Xe.en)||"";p.useEffect(()=>{const C=J=>{var te;const V=(((te=J.detail)==null?void 0:te.name)||"").trim();V&&gt(null,V)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)}),p.useEffect(()=>{const C=J=>{const V=J.detail||{},te=String(V.id||"").trim(),se=String(V.name||"").trim(),He=String(V.url||"").trim(),Ee=te&&Ke.get(te)||Nc(c.dossiers,se,He);if(Ee){if(k(null),ea(Ee,x,Q)||(x.continent!=="monde"&&Ee.continent!==x.continent&&d({type:"continent",key:Ee.continent||"monde"}),d({type:"reset"})),Q&&Ee.kind!=="op"){const st=Ne(Ee);typeof st=="number"&&st!==x.ptab&&d({type:"ptab",tab:st})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:Ee.id}),(Ee.noCo||["media","nominations","recrutements"].includes(Ee.engine||""))&&(Ee.url||Ee.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Ee.url||"",text:[Ee.headline,Ee.tagline].filter(Boolean).join(`
`)}})):Ee.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ee.name,url:Ee.url||"",website:Ee.website||"",domain:Ee.domain||""}}));return}!se&&!He||(d({type:"focus",id:te||null}),k({name:se,headline:String(V.text||"").trim()||se,url:He,card:V.card}),He&&(Ea(se)||!se)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:He,text:String(V.text||"").trim()}})):se&&!Ea(se)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:se}})))};return window.addEventListener("ppmap:focus",C),()=>window.removeEventListener("ppmap:focus",C)}),p.useEffect(()=>{const C=te=>{const se={},He=String((te==null?void 0:te.sector)||"").trim();He&&(se.sector=[He]);const Ee=String((te==null?void 0:te.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ee)&&(se.day=Ee);const Be=String((te==null?void 0:te.search)||"").trim();Be&&(se.search=Be);const st=String((te==null?void 0:te.dealKind)||"").trim();(st==="ma"||st==="levee"||st==="other")&&(se.dealKind=[st]),Object.keys(se).length&&d({type:"filters",patch:se})},J=te=>C(te.detail),V=te=>{te.data&&te.data.type==="pp-filter"&&C(te.data)};return window.addEventListener("ppmap:filter",J),window.addEventListener("message",V),()=>{window.removeEventListener("ppmap:filter",J),window.removeEventListener("message",V)}},[]),p.useEffect(()=>{const C=J=>{var se;const V=(((se=J.detail)==null?void 0:se.name)||"").trim().toLowerCase();if(!V)return;const te=c.dossiers.find(He=>(He.name||"").trim().toLowerCase()===V);te&&d(a==="ops"?{type:"focus",id:te.id}:{type:"popup",id:te.id})};return window.addEventListener("ppmap:similar",C),()=>window.removeEventListener("ppmap:similar",C)});const gt=(C,J,V)=>{const te=(V||(C==null?void 0:C.name)||J||"").trim();if(!he){w({kicker:te});return}!te||z||(F(!0),(async()=>{try{let se=(J||te).trim();const He=((C==null?void 0:C.website)||(C==null?void 0:C.domain)||"").trim();if(!(/^https?:\/\//i.test(se)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(se)&&!/\s/.test(se)))if(He)se=He;else try{const Fe=await Cn(te);if(Fe!=null&&Fe.website)se=Fe.website;else if(((Fe==null?void 0:Fe.candidates)||[]).length===1)se=Fe.candidates[0].url;else if(((Fe==null?void 0:Fe.candidates)||[]).length>1){L.current=[{name:te,verdict:"unresolved",remaining:null,reason:l.evalPickSite,candidates:(Fe.candidates||[]).slice(0,5)},...L.current].slice(0,8),S();return}}catch{}const Be=await ao(re,se,"atelier2"),st={name:Be.company||te,verdict:Be.verdict,reason:Be.reason||"",remaining:Be.remaining??null};L.current=[st,...L.current].slice(0,8),Be.verdict==="kept"&&q(Fe=>({...Fe,kept:Fe.kept+1})),Be.verdict==="ruled_out"&&q(Fe=>({...Fe,dropped:Fe.dropped+1}));const Ht=C||c.dossiers.find(Fe=>(Fe.name||"").toLowerCase()===te.toLowerCase());Ht&&(Be.verdict==="kept"?Ht.verdict=Ht.verdict||"MATCH":Be.verdict==="ruled_out"&&(Ht.verdict="NO MATCH"),Be.reason&&(Ht.reasoning=Be.reason)),S()}finally{F(!1)}})())},bt=C=>{if(!he){w({kicker:C.name});return}ve(C,"instant"),Vt(re,"fast_request",C.name||"",""),oe(l.memoInstantSent(C.name))},Ft=C=>fe.current.get(C.id)??c.thumbs.get((C.name||"").trim().toLowerCase()),Nt=(C,J)=>d({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:J}}),Re=async(C,J,V)=>{const te=C.ceoStatus||"";C.ceoStatus=J,S();const se=await Ua(re,{status:J,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...(V==null?void 0:V.note)!==void 0?{note:V.note}:{},...V!=null&&V.via?{via:V.via}:{}});return se.ok?se.skipped?(C.ceoStatus=te,S(),Se(l.actNotPersisted),!1):((V==null?void 0:V.undo)!==!1&&Nt(C,te),V!=null&&V.msg&&oe(V.msg),(J==="Validé"||J==="Écarté")&&!C.ceoNote&&(V==null?void 0:V.note)===void 0&&I({o:C,yes:J==="Validé"}),!0):(C.ceoStatus=te,S(),Se(l.actErr),!1)},nt=async(C,J)=>{const V=await Ua(re,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:J,via:"note"});return!V.ok||V.skipped?(Se(V.skipped?l.actNotPersisted:l.actErr),!1):(C.ceoNote=J,S(),!0)},A=p.useRef(new Map),H=C=>A.current.has(C.id)?A.current.get(C.id):c.stages.get((C.name||"").trim().toLowerCase()),G=(C,J)=>{A.current.set(C.id,J),S()},ae=(C,J)=>{he&&Re(C,J?"Validé":"Écarté",{msg:J?l.decidedYes(C.name):l.decidedNo(C.name)})},ye=C=>{he&&Re(C,"À trancher",{msg:l.promoted(C.name)})},P=C=>{he&&(async()=>{const J=C.ceoStatus||"";C.ceoStatus="Retenu",S();const V=await Ua(re,{status:"Retenu",check_id:C.checkId,company:C.name});if(!V.ok||V.skipped){C.ceoStatus=J,S(),Se(V.skipped?l.actNotPersisted:l.actErr);return}Nt(C,J),oe(l.repeched(C.name))})()},ee=()=>{const C=x.undo[x.undo.length-1];if(!C){oe(l.undoNone);return}const J=Ke.get(C.id);if(!J){d({type:"undoPop"}),oe(l.undoNone);return}let V=C.prevCeoStatus;if(!V)if((J.verdict||"").toUpperCase().includes("CALL"))V="À trancher";else{oe(l.undoLockedTitle);return}(async()=>await Re(J,V,{undo:!1})&&(d({type:"undoPop"}),J.ceoStatus=C.prevCeoStatus,S(),oe(l.undoDone(J.name))))()},ie=C=>{he&&(_.current.add(C.id),S(),(async()=>{const J=await ds(re,C.name,"email");if(!J||J.ok===!1){_.current.delete(C.id),S(),Se(l.actErr);return}Vt(re,"approach",C.name||"",""),oe(l.actApproachSent)})())},Z=(C,J)=>{he&&(async()=>{if(!(await Vt(re,J?"yes":"no",C.name||"","")).ok){Se(l.actErr);return}fe.current.set(C.id,J?"yes":"no"),S(),oe(J?l.thumbUpDone:l.thumbDnDone)})()},je=C=>{!he||!Dt(C)||(ve(C,"detailed"),Vt(re,"detailed_request",C.name||"",""),oe(l.memoDeepSent(C.name)))},De=C=>{const J=new Set(c.favIds),V=J.has(C.id);V?J.delete(C.id):J.add(C.id),c.setFavIds(J),he&&cs(re,{id:C.id,co:C.name},V)},$e=()=>{!he||$||window.confirm(l.identSyncConfirm)&&(X(!0),(async()=>{const C=await ps(re);X(!1),C?oe(l.identSyncDone):Se(l.actErr)})())},Ae=/proplace/i.test(c.fund||""),Ue=C=>{!he||!Ae||(Vt(re,"onboard_request",C.name||"",""),oe(l.onboardSent(C.name)))},Pa={st:x,dispatch:d,t:l,lang:s,mode:pe,caps:ge,pipe:Q,token:re,fund:c.fund,email:c.email,criteria:c.criteria,source:a||"default",data:c,doRepeche:P,thumbOf:Ft,canWrite:he,commitStatus:Re,saveNote:nt,stageOf:H,setStage:G,flashErr:Se,startTour:()=>R(!0),dossiers:c.dossiers,scopedAll:xe,scoped:Rt,counts:Pe,byId:Ke,contName:jt,favIds:c.favIds,toggleFav:De,askEvaluate:gt,doAnalyse:bt,doDecide:ae,doPromote:ye,doApproach:ie,doThumb:Z,doDeep:je,doUndo:ee,doSync:$e,doOnboard:Ue,outbound:Ae,memoQueued:B.current,liveMemos:{items:ke,serverOff:le,liveOf:ne},approachDone:_.current,sessTally:N,evalCards:L.current,evalBusy:z,markRow:y,markedId:v,flash:oe,focusExtra:f};p.useEffect(()=>{const C=J=>{J.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const la=C=>re?t.jsx(Hs,{token:re,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(Yo.Provider,{value:Pa,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(re?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:As}),la(t.jsxs("div",{className:"app"+(Q?" pipe":"")+(re?" has-thesis":""),children:[ge.showTicker&&t.jsx(rt,{name:"live",children:t.jsxs("div",{className:"live-stack"+(re?" live-stack--cibles":""),children:[t.jsx(Js,{}),!!re&&t.jsx(Vs,{})]})}),ge.showIdent&&t.jsx(rt,{name:"identite",children:t.jsx(dl,{})}),!1,Cc,ge.showFunnel&&t.jsx(rt,{name:"entonnoir",children:t.jsx(Tc,{})}),!x.mapFolded&&t.jsx(rt,{name:"carte",fallback:t.jsx("div",{className:"void",children:l.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Do,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Ec,{}),a!=="ops"&&ge.showFunnel&&t.jsx(Sc,{}),t.jsx(sd,{}),t.jsx(Oo,{})]})]})}),ge.showDemand&&Q&&t.jsx(rt,{name:"direct",children:t.jsx(xs,{items:ke,serverOff:le,labels:{strip:l.liveStrip,boot:l.liveBoot,end:l.liveEnd,open:l.liveOpenQueue,memo:l.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":l.chromeBoth,children:[["eval",l.chromeEval],["filt",l.chromeFilt],["both",l.chromeBoth]].map(([C,J])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===C,onClick:()=>{m(C);try{localStorage.setItem("atl2:chrome-mode",C)}catch{}},children:J},C))}),ge.showDemand&&t.jsx(rt,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(hd,{})})}),ge.showDemand&&x.memoConsole&&t.jsx(rt,{name:"console",children:t.jsx(gd,{})}),ge.pipe&&!!re&&t.jsx(rt,{name:"moteurs",children:t.jsx(ks,{})}),t.jsx(rt,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:l.retry})]}),children:t.jsx(Gd,{})}),c.loading&&t.jsx("div",{className:"void",children:l.loadingV2}),c.error&&!c.loading&&t.jsxs("div",{className:"void",children:[l.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:c.refresh,children:l.retry})]})]})),x.popupId&&x.dens!=="liste"&&a!=="ops"&&t.jsx(rt,{name:"fiche",children:t.jsx(qd,{})}),t.jsx(rt,{name:"modales",children:t.jsx(tc,{})}),t.jsx(el,{}),M&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:M.o.name}),t.jsx(ol,{placeholder:M.yes?l.whyYesPh:l.whyNoPh,onDone:C=>{const J=M.o;I(null),C&&nt(J,C).then(V=>{V&&oe(l.csNoteSaved)})}})]}),g&&kt&&t.jsx(sl,{steps:qc(l,qe,it,ut,xt,Pe[3]||0),onClose:()=>{R(!1),Kr(re)}}),t.jsx(zc,{}),ge.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:l.lockbarText}),t.jsxs("span",{className:"lb-c",children:[l.lockbarContactBefore,t.jsx("a",{href:fo,children:qn}),l.lockbarContactMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:l.lockbarCta})]}),T&&t.jsx("div",{className:"flash on"+(O?" err":""),children:T}),E&&t.jsx(rs,{variant:"acquirer",initialCompany:Jr().co,initialWebsite:Jr().site,onClose:()=>w(null)})]})})}function Tc(){const{t:e}=Y(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Jr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Lc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Qo as FlagCell,yt as SigBadge,Ia as SigWin,Mc as default,Lc as fmtShort,Y as useV2};
