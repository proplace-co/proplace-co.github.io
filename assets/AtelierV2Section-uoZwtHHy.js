...
.atl2 .rscard{margin-top:9px;border:1px solid var(--line);border-radius:var(--ra);
  background:var(--panel);overflow:auto;max-height:min(72vh,760px)}
...
.atl2 .rsarch-one{max-height:min(72vh,760px);overflow-y:auto}
...
.atl2 .rs-mm-host:empty{display:none}
.atl2 .rs-mm-host:not(:empty),.atl2 .rs-mm-svg{width:100%;height:420px;display:block}
.atl2 .rslive-map .rsmm{margin:0;width:100%;max-width:none}
.atl2 .rslive-cats{min-width:0;border:1px solid var(--line);border-radius:10px;
  background:var(--panel3);padding:10px 12px;max-height:420px;overflow-y:auto}
...
.atl2 .rsart p{margin:0 0 12px;font-size:15px;line-height:1.65;color:#16233A;max-width:62ch}
@media (max-width:800px){
  .atl2 .rslive-grid{grid-template-columns:1fr}
  .atl2 .rs-mm-host,.atl2 .rs-mm-svg{height:320px}
}
...
.atl2.cibles .eq-row,.atl2.cibles .eq-head{gap:10px;align-items:center;
  grid-template-columns:minmax(120px,1fr) minmax(100px,160px) minmax(0,1.2fr) 72px 22px minmax(112px,max-content)}
...
.atl2.cibles .eq-go{display:inline-flex;align-items:center;justify-content:center;
  gap:6px;height:28px;box-sizing:border-box;justify-self:end;width:auto;min-width:112px;
  padding:0 12px;border:1px solid var(--pp-green);border-radius:var(--pp-r-pill);
...
`,Il=Rl+Ol+Ml+Dl;function En(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Pl(){const e=En("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function _l(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Pl();return r==="0"?"client":r==="1"||En("embed")==="1"&&En("chrome")==="1"?"apercu":"client"}const Bl={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},$l=e=>Bl[e];function Qt(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||/\?$/.test(a)||/^(this|that|these|those|why|what|what'?s|how|when|where|who|which|is|are|do|does|did|can)\b/i.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Dt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Xa(a)||Qt(a))&&(e.noCo=!0)}return Object.assign(e,{continent:rs(e.cc)})};function sn(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Ul=60*60*1e3;function Hl(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Ul?null:a}catch{return null}}function Ea(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Vl=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Wl(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:Gi(),[e,n]),i=p.useMemo(()=>n?"visiteur":_l(e,o),[e,o,n]),d=p.useMemo(()=>$l(i),[i]),l=i!=="visiteur",s=Vl(r),[f,c]=p.useState([]),[g,u]=p.useState(""),[b,h]=p.useState(null),[w,v]=p.useState(null),[m,y]=p.useState(null),[E,k]=p.useState(()=>new Map),[j,N]=p.useState(()=>new Map),[z,T]=p.useState(""),[L,O]=p.useState(new Set),[M,W]=p.useState(null),[K,F]=p.useState(!0),[x,A]=p.useState(!1),[S,P]=p.useState(0),[U,Q]=p.useState(0),ne=p.useRef(0),C=p.useMemo(()=>{var D;if(i!=="client")return"";try{return((D=Yi())==null?void 0:D.email)||""}catch{return""}},[i]);p.useEffect(()=>{const D=++ne.current;let Z=!0;const $=()=>Z&&D===ne.current,oe=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),me=Hl(oe);return me?(c(me.objs.map(Dt)),me.fund&&u(me.fund),h(me.marketEstimate??null),v(me.criteria??null),y(me.stats??null),T(me.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const xe=await an(),ye=((xe==null?void 0:xe.recent_ops)||[]).map(ce=>{const Ce=Fa(ce.company_name||ce.title?ce:{...ce,title:(ce.headline_fr||ce.headline||"").slice(0,120)},a),Ae=String(ce.rubrique||"").toLowerCase();return Ce&&(Ae==="nominations"||Ae==="recrutements")&&(Ce.engine=Ae),Ce&&!String(ce.company_name||"").trim()&&(Ce.noCo=!0),Ce}).filter(ce=>!!ce).map(ce=>(Xa((ce.name||"").trim())||(ce.noCo=!0),ce));try{const ce=Qi(),Ce=await Ki(),Ae=((Ce==null?void 0:Ce.date)||"").slice(0,10),ue=ce?ce.doc:Ce,ve=Ji(ue),ke=((ce==null?void 0:ce.day)||(ue==null?void 0:ue.date)||Ae||"").slice(0,10);if(ke&&ve.length){const ee=new Set;for(const _ of ye){if((_.date||"").slice(0,10)!==ke)continue;const re=sr(ve,ee,_.name,"");re>=0&&(ee.add(re),_.decryptHtml=ve[re].html)}for(const _ of ye){if(_.decryptHtml||(_.date||"").slice(0,10)!==ke)continue;const re=sr(ve,ee,"",_.headline||_.tagline||_.name);re>=0&&(ee.add(re),_.decryptHtml=ve[re].html)}}if(ke){const ee=((ue==null?void 0:ue.title_fr)||"").trim(),_=((ue==null?void 0:ue.lead_fr)||"").trim(),re=Xi(ue),se=((ue==null?void 0:ue.url)||"").trim();ee&&(re||se)&&ye.unshift({id:`edito:${ke}`,kind:"op",name:ee,cc:null,date:ke,engine:"edito",dealKind:"other",headline:ee,tagline:_||ee,decryptHtml:re||void 0,url:se,noCo:!0})}}catch{}if(!$())return;c(ye.map(Dt)),Ea(oe,{objs:ye})}else if(typeof r=="object"){const ye=(await lr()||[]).filter(Ce=>(Ce.slug||"")===r.research).map(Ce=>dr(Ce,a)).filter(Ce=>!!Ce),ce=sn(await pr(ye,a));if(!$())return;c(ce.map(Dt)),Ea(oe,{objs:ce})}else if(l&&o.token){const xe=Zi(o.token),ye=an(),ce=es(o.token),Ce=ts(o.token),Ae=as(o.token),ue=await xe;let ve=ue?ue.targets:[];$()&&ue&&(u(ue.fund||""),h(ue.marketEstimate??null),v(ue.criteria??null),y(ue.stats??null),T(ue.generatedAt||""),c(ve.map(Dt)),F(!1),A(!1));const[ke,ee,_,re]=await Promise.all([ye,ce,Ce,Ae]),se=((ke==null?void 0:ke.recent_ops)||[]).map(H=>Fa(H,a)).filter(H=>!!H),le=new Set(ve.map(H=>H.id));if(ve=[...ve,...se.filter(H=>!le.has(H.id)&&(le.add(H.id),!0))],!$())return;c(ve.map(Dt));const fe=new Set;for(const H of ee){const de=(H.id||H.co||"").toString().trim().toLowerCase();de&&fe.add(de.startsWith("t:")?de:"t:"+de)}O(fe),k(_),N(re),ue&&Ea(oe,{fund:ue.fund,marketEstimate:ue.marketEstimate,criteria:ue.criteria,stats:ue.stats,generatedAt:ue.generatedAt,objs:ve})}else{const xe=ns(),ye=lr(),ce=an(),Ce=await xe;$()&&Ce.length&&(c(sn(Ce).map(Dt)),F(!1),A(!1));const[Ae,ue]=await Promise.all([ye,ce]),ve=(Ae||[]).map(re=>dr(re,a)).filter(re=>!!re),ke=await pr(ve,a),ee=((ue==null?void 0:ue.recent_ops)||[]).map(re=>Fa(re,a)).filter(re=>!!re),_=sn([...Ce,...ke,...ee]);if(!$())return;c(_.map(Dt)),Ea(oe,{objs:_})}$()&&A(!1)}catch{$()&&!me&&A(!0)}finally{$()&&F(!1)}})(),()=>{Z=!1}},[l,o.token,a,S,s]),p.useEffect(()=>{if(!d.showCredits||!C){W(null);return}let D=!0;return(async()=>{try{const Z=await fetch(`${wa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:C})});if(!Z.ok)return;const $=await Z.json();D&&$&&$.ok!==!1&&W($)}catch{}})(),()=>{D=!1}},[d.showCredits,C,U]);const B=p.useCallback(D=>O(new Set(D)),[]);return{session:o,mode:i,caps:d,fund:g,email:C,marketEstimate:b,generatedAt:z,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:m,thumbs:E,stages:j,dossiers:f,patchStatuses:(D,Z)=>{c($=>{let oe=!1;const me=$.map(xe=>{if(!xe.checkId)return xe;const ye=D.get(xe.checkId);return!ye||ye===(xe.ceoStatus||"")||!Z(xe.id)?xe:(oe=!0,{...xe,ceoStatus:ye})});return oe?me:$})},favIds:L,setFavIds:B,credits:M,reloadCredits:()=>Q(D=>D+1),loading:K,error:x,refresh:()=>P(D=>D+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Ra=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function $a(e){return Ra.has(e.engine||"")}function at(e){return!!e.noCo||$a(e)&&!!e.url}const Wo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Gl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Wo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Yl=new Set(["signal","amount","score","crible","memo"]);function Ql(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Wo(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Yl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Go)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Go=80;function Ua(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!He(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes($n(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(gt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&It(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(zo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function Pt(e,a,r){return We(e)?Ua(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ua(e,a.filters,r)}function Kl(e,a,r,n){return!(!Pt(e,a,r)||r&&!Co(e,a.ptab,n))}function Gn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-gt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return is(o)||null;case"memo":return os(o)||null;case"signal":{const i=He(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const ln={},Ar=(ln==null?void 0:ln.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function qr(){return new Date().toISOString().slice(0,10)}const Yn=p.createContext(null);function Yo(){return p.useContext(Yn)}function Jl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const f=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(c=>s.removeAttribute(c.name)),f&&/^https?:\/\//i.test(f)&&(s.setAttribute("href",f),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Qo(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Xl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Qo(r),r.innerHTML):e}catch{return e}}function Tr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Qo(r),r.innerHTML):e}catch{return e}}function Lr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Ko(){const e=p.useContext(Yn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Zl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=J(),[i,d]=p.useState(()=>n.filters.day||qr()),[l,s]=p.useState(null),[f,c]=p.useState(!1),g=p.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{d(qr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const w=v=>{var y;const m=(y=v.detail)==null?void 0:y.day;typeof m=="string"&&g(m)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[g]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let w=!1;c(!0);const v=new URLSearchParams({token:e,date:i});return fetch(`${Ar}/cibles/edition.json?${v}`).then(m=>m.json()).then(m=>{w||s(m)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||c(!1)}),()=>{w=!0}},[e,i]);const b=p.useMemo(()=>`${Ar}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),h=p.useMemo(()=>({token:e,day:i,ed:l,loading:f,pickDay:g,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,f,g,u,n.filters.day,b,o]);return t.jsx(Yn.Provider,{value:h,children:a})}function ed(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Ko(),[o,i]=p.useState(()=>n||Ao());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Ia,d),()=>window.removeEventListener(Ia,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(ss,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function td(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Fr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Rr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function ad(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Ko(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,f=p.useRef(null),[c,g]=p.useState("fonds"),[u,b]=p.useState(null),[h,w]=p.useState("idle"),v=p.useRef(!1);p.useEffect(()=>{b(null),w("idle"),v.current=!1,g("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||v.current)return;v.current=!0;let j=!0;return w("load"),td(e).then(N=>{j&&(b(N),w("fait"))}),()=>{j=!1}},[c,e]);const m=p.useMemo(()=>Xl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=p.useRef(null);p.useEffect(()=>{const j=y.current;if(!j||!m)return;let N=!1;return wn(()=>import("./fit-DX-mzLKR.js"),[]).then(async z=>{await z.ensureEditoCss(),!(N||!j.isConnected)&&(z.beautifyEditoRows(j),z.mountCardFits(j))}),()=>{N=!0}},[m]);const E=p.useMemo(()=>Tr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>Tr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const j=f.current;if(!j||!E)return;let N=!1;return wn(()=>import("./fit-DX-mzLKR.js"),[]).then(async z=>{await z.ensureEditoCss(),!(N||!j.isConnected)&&(z.beautifyEditoRows(j),z.mountCardFits(j))}),()=>{N=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>g("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>g("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Fr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Lr(e,!0)}),"."]}):Fr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Lr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>g("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&E?t.jsx("div",{ref:f,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(m?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:m}})]}):t.jsx("p",{className:h==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:h!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Rr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Rr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const nd=300,ja=7,rd={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Jo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},od=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Na(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(cs(r)&&r!=="media")return"news:"+r;const n=He(e);return n?"sig:"+(n.theme&&Jo.fr[n.theme]?n.theme:"other"):"actualites"}function id(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=J(),s=Yo(),f=d==="en",[c,g]=p.useState("all"),[u,b]=p.useState(!1),h=p.useMemo(()=>{var Z;const x=(a.filters.day||"").slice(0,10),A=$=>!(!i&&a.continent!=="monde"&&$.continent!==a.continent||x&&($.date||"").slice(0,10)!==x),S=e.filter($=>A($)&&He($)&&(!i||$.kind!=="target"||Te($)!==5)),P=i&&(((Z=s==null?void 0:s.ed)==null?void 0:Z.ops)||[]).length?s.ed.ops.map($=>Fa($,d)).filter($=>!!$).map($=>($.briefOnly=!0,$)).filter($=>!x||($.date||"").slice(0,10)===x):[],U=e.filter($=>A($)&&$.kind==="op"&&(x?!0:gt($.date)<=ja)),Q=i?P.length?P:U.filter($=>{const oe=(l||"").trim().toLowerCase();if(!oe)return!1;const me=$.match||null;return me?Object.keys(me).map(xe=>xe.trim().toLowerCase()).includes(oe):!1}):U,ne=x||new Date().toISOString().slice(0,10),C=$=>{const oe=Na($);return oe==="ma"?0:oe==="levees"?1:2};Q.sort(($,oe)=>{const me=C($)-C(oe);if(me)return me;const xe=($.date||"").slice(0,10)===ne?0:1,ye=(oe.date||"").slice(0,10)===ne?0:1;return xe!==ye?xe-ye:(oe.amountEur||0)-($.amountEur||0)});const B=new Set,D=[];for(const $ of[...Q,...Gn(S,{key:"signal",dir:-1})]){const oe=$.id||$.name;!oe||B.has(oe)||(B.add(oe),D.push($))}return i&&D.length===0?e.filter(oe=>A(oe)&&gt(oe.date)<=ja).sort((oe,me)=>(me.date||"").localeCompare(oe.date||"")).slice(0,80):D},[e,a.continent,a.filters.day,i,l,d,s]),w=p.useMemo(()=>{const x={};for(const A of h){const S=Na(A);x[S]=(x[S]||0)+1}return x},[h]),v=p.useMemo(()=>c==="all"?h:h.filter(x=>Na(x)===c),[h,c]),m=p.useMemo(()=>v.slice(0,nd),[v]),y=v.length-m.length,E=p.useRef(null);p.useEffect(()=>{var Q,ne;const x=E.current;if(!x)return;const A=()=>{const C=x.scrollWidth;C<200||(x.style.animationDuration=Math.max(18,Math.round(C/130))+"s")};A();const S=requestAnimationFrame(A),P=window.setTimeout(A,1200);let U=!0;return(ne=(Q=document.fonts)==null?void 0:Q.ready)==null||ne.then(()=>{U&&A()}),()=>{U=!1,cancelAnimationFrame(S),window.clearTimeout(P)}},[m.length,c]);const k=x=>x==="all"?h.length:w[x]||0,j=x=>{if(x==="all")return f?"All":"Tout";if(x.startsWith("sig:"))return Jo[f?"en":"fr"][x.slice(4)]||"🔔";if(x.startsWith("news:")){const A=x.slice(5);return ds[A]?ps(A,f?"en":"fr"):x}return rd[f?"en":"fr"][x]},N=[{k:"all"}],z=["ma","levees"].filter(x=>k(x)>0||x===c);if(z.length){N.push({g:f?"Deals":"Opérations"});for(const x of z)N.push({k:x})}const T=["nominations","recrutements"].filter(x=>k(x)>0||x===c),L=ls.filter(x=>x!=="media").map(x=>"news:"+x).filter(x=>k(x)>0||x===c),O=k("actualites")>0||c==="actualites"?["actualites"]:[];if(T.length||L.length||O.length){N.push({g:f?"News":"Actualités"});for(const x of T)N.push({k:x});for(const x of L)N.push({k:x});for(const x of O)N.push({k:x})}const M=od.map(x=>"sig:"+x).filter(x=>k(x)>0||x===c);if(M.length){N.push({g:f?"Signals (your engines)":"Signaux (vos moteurs)"});for(const x of M)N.push({k:x})}const W=x=>{try{return new Date(x+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return x}},K=(()=>{const x=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?f?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return x?(f?`LIVE covers the events of ${W(x)}.`:`Le LIVE regroupe les événements du ${W(x)}.`)+A:(f?`LIVE covers the still-open signals and the deals of the last ${ja} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ja} derniers jours.`)+A})(),F=x=>m.map(A=>t.jsxs("button",{type:"button",className:"tk"+(Ye(A)?" spent":""),onClick:S=>{const P=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:P?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(P||n({type:"focus",id:A.id}),a.dens!=="liste"){const U=S.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:U.left+U.width/2,y:U.bottom}})}},title:Ye(A)?f?`${A.name} — already screened (dimmed)`:`${A.name} — déjà évaluée (grisée)`:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(Lt,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(Mi,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),(()=>{const S=(A.tagline||A.headline||"").trim();if(S&&S!==A.name)return t.jsx("span",{className:"what",children:S});const P=Na(A),U=P==="ma"?f?"M&A deal":"opération M&A":P==="levees"?f?"fundraising":"levée de fonds":P==="nominations"?f?"appointment":"nomination":P==="recrutements"?f?"hiring":"recrutement":P.startsWith("sig:")?f?"engine signal":"signal moteur":P.startsWith("news:")?f?"news":"actualité":A.kind==="target"?f?"sourced target":"cible sourcée":f?"news item":"actualité";return t.jsx("span",{className:"what dim",children:U})})(),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:fu(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(en,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},x+(A.id||A.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},x+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:x=>{x.currentTarget.contains(x.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(x=>!x),children:[j(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:K}),N.map(x=>"g"in x?t.jsx("span",{className:"tkfilg",children:x.g},x.g):t.jsxs("button",{type:"button","aria-pressed":x.k===c,onClick:()=>{g(x.k),b(!1)},children:[j(x.k),t.jsx("b",{children:k(x.k)})]},x.k))]})]}),t.jsx("div",{className:"win",children:m.length?t.jsxs("div",{className:"run",ref:E,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:f?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",f?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(ld,{isEn:f})]})}const sd=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function ld({isEn:e}){const[a,r]=p.useState(()=>Ao());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Ia,o),()=>window.removeEventListener(Ia,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>us(!a),children:sd})}class ft extends p.Component{constructor(){super(...arguments);rr(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Xo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Or(e,a){if((Ft(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Xo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Mr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",dd={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function pd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=J(),[l,s]=p.useState(""),[f,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!g)return;const y=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),c(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[g]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const h=(e.ceoStatus||"").trim(),w=async y=>{if(l)return;if(y==="Analysé"&&!e.memoUrl){c(!0);return}s(y);const E=(Or(e,a).find(([j])=>j===y)||[y,y])[1],k=await o(e,y,{msg:a.csMoved(e.name,E)});s(""),k&&(c(!1),u(!1))},v=Or(e,a),m=y=>(v.find(([E])=>E===y)||[])[1]||y;return v.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:v.map(([y,E])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(l===y?" busy":""),disabled:!!l,onClick:()=>{w(y)},children:E},y))}):t.jsxs("span",{className:"rstat"+(g||f?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":g,disabled:!!l,title:a.csLabel,className:"rsel rs-"+Mr(h),onClick:()=>{u(y=>!y),c(!1)},children:l?m(l)+"…":h?m(h):a.csNone}),g&&!f&&t.jsx("span",{className:"rsmenu",role:"listbox",children:v.map(([y,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":h===y,className:"rsopt"+(h===y?" on":"")+(l===y?" busy":""),disabled:!!l,onClick:()=>{if(y===h){u(!1);return}w(y)},children:[t.jsx("i",{className:"pt2",style:{background:dd[Mr(y)]}}),E]},y))}),f&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const y=await o(e,"Analysé");s(""),y&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function cd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=J(),[i,d]=p.useState(""),[l,s]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),c=(Ft(e)||"").startsWith("CALL")&&Te(e)===3,g=Te(e)>=2,u=async h=>{if(i||h==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(h);const w=await o(e,h);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:Xo.filter(([h])=>!(g&&h==="Retenu")).map(([h,w])=>[h,a[w]]);return t.jsxs("div",{className:"csp",onClick:h=>h.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([h,w])=>t.jsx("button",{type:"button",className:"csb"+(f===h?" on":"")+(i===h?" busy":""),disabled:!!i,onClick:()=>{u(h)},children:w},h)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(ud,{o:e})]})}function ud({o:e}){const{t:a,saveNote:r,flash:n}=J(),[o,i]=p.useState(e.ceoNote||""),[d,l]=p.useState(!1),[s,f]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),g=async()=>{if(d||!c)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&g()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{g()},children:s?a.csNoteSaved:a.csNoteOk})]})}function Dr({placeholder:e,onDone:a}){const{t:r}=J(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function md({o:e}){var v;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=J(),[s,f]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const c=i(e),g=(c==null?void 0:c.stage)||"todo",u=async m=>{if(s||m===g)return;f(!0);const y=c;d(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const E=Math.max(Date.now(),Ir+=1);Ir=E;const k=await ms(r,{company:e.name||"",stage:m,cts:E,deal_id:e.airtableId,check_id:e.checkId});f(!1),!k.stale&&(k.ok||(d(e,y),l(a.actErr)))},b=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,h=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=g==="sent"&&b&&h>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(g===m?" on":""),disabled:s,onClick:()=>{u(m)},children:y},m)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(h)})]})}let Ir=0;const ra=8,qt=360;function Pr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function _r({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Pr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Pr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function fd({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=J(),[d,l]=p.useState(0),[s,f]=p.useState(null),[c,g]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),h=p.useRef(!1);p.useEffect(()=>{const z=b.current;return()=>{h.current||(n({type:"ptab",tab:z.ptab}),n({type:"dens",dens:z.dens}),n({type:"modal",modal:z.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,g(e.filter(z=>!!document.querySelector(z.need||z.sel))))},[e]);const w=c[d],v=d>=c.length;p.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const z=w.click,T=window.setTimeout(()=>{const L=document.querySelector(z);L&&L.getAttribute("aria-selected")!=="true"&&L.click()},60);return()=>window.clearTimeout(T)}},[d,w]);const m=p.useRef(-1),y=p.useCallback(()=>{if(!w){f(null);return}const z=O=>{if(!O)return null;for(const M of document.querySelectorAll(O)){const W=M.getBoundingClientRect();if(W.width>1&&W.height>1)return M}return null},T=z(w.sel)||z(w.need);if(!T){f(null);return}m.current!==d&&(m.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=T.getBoundingClientRect();f(O=>O&&Math.abs(O.top-L.top)<1&&Math.abs(O.left-L.left)<1&&Math.abs(O.width-L.width)<1&&Math.abs(O.height-L.height)<1?O:L)},[w,d]);p.useLayoutEffect(()=>{y();const z=[90,300,700,1300].map(O=>window.setTimeout(y,O)),T=window.setInterval(y,400),L=()=>y();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{z.forEach(O=>window.clearTimeout(O)),window.clearInterval(T),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[y]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const z=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),E.current()):T.key==="ArrowRight"?l(L=>L+1):T.key==="ArrowLeft"&&l(L=>Math.max(0,L-1))};return document.addEventListener("keydown",z,!0),()=>document.removeEventListener("keydown",z,!0)},[]),!c.length)return null;let k=null;const j=z=>()=>{h.current=!0,n({type:"modal",modal:null}),z()};if(v){const z=o[3]||0;z>0?k={title:z===1?r.ahaATitle1:r.ahaATitleN(z),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:qt};if(!v&&s){const z=s.bottom+14,T=window.innerHeight-z;let L=T>190?z:Math.max(12,s.top-200),O=Math.min(Math.max(12,s.left+s.width/2-qt/2),window.innerWidth-qt-12);T<=190&&s.top<212&&(window.innerWidth-s.right>=qt+40?O=Math.min(s.right+26,window.innerWidth-qt-12):s.left>=qt+40&&(O=Math.max(12,s.left-qt-26)),L=Math.max(12,s.top-ra)),N={left:O,top:L,width:qt}}return Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-ra,top:s.top-ra,width:s.width+ra*2,height:s.height+ra*2}}),(v||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:N,children:[v&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(_r,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(_r,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(z=>Math.max(0,z-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(z=>z+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Zo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function ei(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function hd(){var T,L;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=J(),f=r?a:e,c=p.useMemo(()=>f.filter(O=>gt(O.date)===0&&O.kind==="target"),[f]),g=p.useMemo(()=>r?a.filter(O=>O.kind==="target"&&Te(O)===0).slice().sort((O,M)=>(M.date||"").localeCompare(O.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(O=>r?Te(O)===0:!Ye(O)),[c,r]),b=r?g:u,h=r?a.length-g.length:c.length-u.length,w=r?a.length:c.length,v=w?Math.min(100,h/w*100):100,m=p.useMemo(()=>Zo(f),[f]),y=!!m&&gt(m)>0,E=p.useMemo(()=>y?f.filter(O=>(O.date||"").slice(0,10)===m):[],[f,m,y]),k=typeof((T=l.stats)==null?void 0:T.kept_today)=="number"?l.stats.kept_today:null,j=typeof((L=l.stats)==null?void 0:L.screened_today)=="number"?l.stats.screened_today:c.length;let N;y?N=o.morningLast(E.length,g.length,ei(m,d)):r?N=o.morningThesis(j,g.length,k):c.length?h===0?N=o.goalSourced(c.length):h>=c.length?N=o.goalCleared:N=o.goalDone(h,c.length):N=o.goalSourced(0);const z=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&g.length&&s({type:"chainStart",queue:g.map(O=>O.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:z,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function gd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:l}=J(),s=i==="client",[f,c]=p.useState(!1),[g,u]=p.useState(""),b=()=>{!s||f||!n||(c(!0),u(""),fs(n).then(v=>{if(c(!1),v.pending){u(e.refreshSlow);return}if(!v.ok){v.error&&console.warn("[republish]",v.error),u(e.refreshKo);return}const m=v.entered??0,y=v.left??0;u(v.unchanged||!m&&!y?e.refreshSame:e.refreshDone(m,y)),o.refresh()}))},h=(n||"P").split(/\s+/).map(v=>v[0]).join("").slice(0,2).toUpperCase(),w=(()=>{const v=Date.parse(o.generatedAt||"");if(Number.isNaN(v))return"";const m=new Date(v),y=E=>String(E).padStart(2,"0");return`${y(m.getDate())}/${y(m.getMonth()+1)} à ${y(m.getHours())}:${y(m.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),w?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(w)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!s||f,onClick:b,children:f?"⏳":"📰"}),(f||!!g)&&t.jsxs("span",{className:"repubst",children:[f?e.refreshRun:g,!f&&t.jsx("button",{type:"button",onClick:()=>u(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!s,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:v=>r({type:"filters",patch:{search:v.target.value}})})]})]})})}class Bt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*xd(e){for(const a of e)yield*a}function ti(e){return Array.from(xd(e))}var Le=1e-6,ze=Math.PI,dt=ze/2,Br=ze/4,ct=ze*2,Et=180/ze,nt=ze/180,Oe=Math.abs,bd=Math.atan,fa=Math.atan2,De=Math.cos,Ie=Math.sin,vd=Math.sign||function(e){return e>0?1:e<0?-1:0},Vt=Math.sqrt;function wd(e){return e>1?0:e<-1?ze:Math.acos(e)}function ha(e){return e>1?dt:e<-1?-dt:Math.asin(e)}function pt(){}function Ha(e,a){e&&Ur.hasOwnProperty(e.type)&&Ur[e.type](e,a)}var $r={Feature:function(e,a){Ha(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ha(r[n].geometry,a)}},Ur={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){jn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)jn(r[n],a,0)},Polygon:function(e,a){Hr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Hr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ha(r[n],a)}};function jn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Hr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)jn(e[r],a,1);a.polygonEnd()}function Wt(e,a){e&&$r.hasOwnProperty(e.type)?$r[e.type](e,a):Ha(e,a)}function Nn(e){return[fa(e[1],e[0]),ha(e[2])]}function Kt(e){var a=e[0],r=e[1],n=De(r);return[n*De(a),n*Ie(a),Ie(r)]}function Sa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Va(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function dn(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Ca(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Sn(e){var a=Vt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function Cn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function zn(e,a){return Oe(e)>ze&&(e-=Math.round(e/ct)*ct),[e,a]}zn.invert=zn;function yd(e,a,r){return(e%=ct)?a||r?Cn(Wr(e),Gr(a,r)):Wr(e):a||r?Gr(a,r):zn}function Vr(e){return function(a,r){return a+=e,Oe(a)>ze&&(a-=Math.round(a/ct)*ct),[a,r]}}function Wr(e){var a=Vr(e);return a.invert=Vr(-e),a}function Gr(e,a){var r=De(e),n=Ie(e),o=De(a),i=Ie(a);function d(l,s){var f=De(s),c=De(l)*f,g=Ie(l)*f,u=Ie(s),b=u*r+c*n;return[fa(g*o-b*i,c*r-u*n),ha(b*o+g*i)]}return d.invert=function(l,s){var f=De(s),c=De(l)*f,g=Ie(l)*f,u=Ie(s),b=u*o-g*i;return[fa(g*o+u*i,c*r+b*n),ha(b*r-c*n)]},d}function kd(e,a,r,n,o,i){if(r){var d=De(a),l=Ie(a),s=n*r;o==null?(o=a+n*ct,i=a-s/2):(o=Yr(d,o),i=Yr(d,i),(n>0?o<i:o>i)&&(o+=n*ct));for(var f,c=o;n>0?c>i:c<i;c-=s)f=Nn([d,-l*De(c),-l*Ie(c)]),e.point(f[0],f[1])}}function Yr(e,a){a=Kt(a),a[0]-=e,Sn(a);var r=wd(-a[1]);return((-a[2]<0?-r:r)+ct-Le)%ct}function ai(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:pt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Oa(e,a){return Oe(e[0]-a[0])<Le&&Oe(e[1]-a[1])<Le}function za(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function ni(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(h){if(!((w=h.length-1)<=0)){var w,v=h[0],m=h[w],y;if(Oa(v,m)){if(!v[2]&&!m[2]){for(o.lineStart(),l=0;l<w;++l)o.point((v=h[l])[0],v[1]);o.lineEnd();return}m[0]+=2*Le}i.push(y=new za(v,h,null,!0)),d.push(y.o=new za(v,null,y,!1)),i.push(y=new za(m,h,null,!1)),d.push(y.o=new za(m,null,y,!0))}}),!!i.length){for(d.sort(a),Qr(i),Qr(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var f=i[0],c,g;;){for(var u=f,b=!0;u.v;)if((u=u.n)===f)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,s=c.length;l<s;++l)o.point((g=c[l])[0],g[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,l=c.length-1;l>=0;--l)o.point((g=c[l])[0],g[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Qr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function pn(e){return Oe(e[0])<=ze?e[0]:vd(e[0])*((Oe(e[0])+ze)%ct-ze)}function Ed(e,a){var r=pn(a),n=a[1],o=Ie(n),i=[Ie(r),-De(r),0],d=0,l=0,s=new Bt;o===1?n=dt+Le:o===-1&&(n=-dt-Le);for(var f=0,c=e.length;f<c;++f)if(u=(g=e[f]).length)for(var g,u,b=g[u-1],h=pn(b),w=b[1]/2+Br,v=Ie(w),m=De(w),y=0;y<u;++y,h=k,v=N,m=z,b=E){var E=g[y],k=pn(E),j=E[1]/2+Br,N=Ie(j),z=De(j),T=k-h,L=T>=0?1:-1,O=L*T,M=O>ze,W=v*N;if(s.add(fa(W*L*Ie(O),m*z+W*De(O))),d+=M?T+L*ct:T,M^h>=r^k>=r){var K=Va(Kt(b),Kt(E));Sn(K);var F=Va(i,K);Sn(F);var x=(M^T>=0?-1:1)*ha(F[2]);(n>x||n===x&&(K[0]||K[1]))&&(l+=M^T>=0?1:-1)}}return(d<-Le||d<Le&&s<-1e-12)^l&1}function ri(e,a,r,n){return function(o){var i=a(o),d=ai(),l=a(d),s=!1,f,c,g,u={point:b,lineStart:w,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=E,c=[],f=[]},polygonEnd:function(){u.point=b,u.lineStart=w,u.lineEnd=v,c=ti(c);var k=Ed(f,n);c.length?(s||(o.polygonStart(),s=!0),ni(c,Nd,k,r,o)):k&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),c=f=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function h(k,j){i.point(k,j)}function w(){u.point=h,i.lineStart()}function v(){u.point=b,i.lineEnd()}function m(k,j){g.push([k,j]),l.point(k,j)}function y(){l.lineStart(),g=[]}function E(){m(g[0][0],g[0][1]),l.lineEnd();var k=l.clean(),j=d.result(),N,z=j.length,T,L,O;if(g.pop(),f.push(g),g=null,!!z){if(k&1){if(L=j[0],(T=L.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),N=0;N<T;++N)o.point((O=L[N])[0],O[1]);o.lineEnd()}return}z>1&&k&2&&j.push(j.pop().concat(j.shift())),c.push(j.filter(jd))}}return u}}function jd(e){return e.length>1}function Nd(e,a){return((e=e.x)[0]<0?e[1]-dt-Le:dt-e[1])-((a=a.x)[0]<0?a[1]-dt-Le:dt-a[1])}const Kr=ri(function(){return!0},Sd,zd,[-ze,-dt]);function Sd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?ze:-ze,s=Oe(i-a);Oe(s-ze)<Le?(e.point(a,r=(r+d)/2>0?dt:-dt),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=ze&&(Oe(a-n)<Le&&(a-=n*Le),Oe(i-l)<Le&&(i-=l*Le),r=Cd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Cd(e,a,r,n){var o,i,d=Ie(e-r);return Oe(d)>Le?bd((Ie(a)*(i=De(n))*Ie(r)-Ie(n)*(o=De(a))*Ie(e))/(o*i*d)):(a+n)/2}function zd(e,a,r,n){var o;if(e==null)o=r*dt,n.point(-ze,o),n.point(0,o),n.point(ze,o),n.point(ze,0),n.point(ze,-o),n.point(0,-o),n.point(-ze,-o),n.point(-ze,0),n.point(-ze,o);else if(Oe(e[0]-a[0])>Le){var i=e[0]<a[0]?ze:-ze;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Ad(e){var a=De(e),r=2*nt,n=a>0,o=Oe(a)>Le;function i(c,g,u,b){kd(b,e,r,u,c,g)}function d(c,g){return De(c)*De(g)>a}function l(c){var g,u,b,h,w;return{lineStart:function(){h=b=!1,w=1},point:function(v,m){var y=[v,m],E,k=d(v,m),j=n?k?0:f(v,m):k?f(v+(v<0?ze:-ze),m):0;if(!g&&(h=b=k)&&c.lineStart(),k!==b&&(E=s(g,y),(!E||Oa(g,E)||Oa(y,E))&&(y[2]=1)),k!==b)w=0,k?(c.lineStart(),E=s(y,g),c.point(E[0],E[1])):(E=s(g,y),c.point(E[0],E[1],2),c.lineEnd()),g=E;else if(o&&g&&n^k){var N;!(j&u)&&(N=s(y,g,!0))&&(w=0,n?(c.lineStart(),c.point(N[0][0],N[0][1]),c.point(N[1][0],N[1][1]),c.lineEnd()):(c.point(N[1][0],N[1][1]),c.lineEnd(),c.lineStart(),c.point(N[0][0],N[0][1],3)))}k&&(!g||!Oa(g,y))&&c.point(y[0],y[1]),g=y,b=k,u=j},lineEnd:function(){b&&c.lineEnd(),g=null},clean:function(){return w|(h&&b)<<1}}}function s(c,g,u){var b=Kt(c),h=Kt(g),w=[1,0,0],v=Va(b,h),m=Sa(v,v),y=v[0],E=m-y*y;if(!E)return!u&&c;var k=a*m/E,j=-a*y/E,N=Va(w,v),z=Ca(w,k),T=Ca(v,j);dn(z,T);var L=N,O=Sa(z,L),M=Sa(L,L),W=O*O-M*(Sa(z,z)-1);if(!(W<0)){var K=Vt(W),F=Ca(L,(-O-K)/M);if(dn(F,z),F=Nn(F),!u)return F;var x=c[0],A=g[0],S=c[1],P=g[1],U;A<x&&(U=x,x=A,A=U);var Q=A-x,ne=Oe(Q-ze)<Le,C=ne||Q<Le;if(!ne&&P<S&&(U=S,S=P,P=U),C?ne?S+P>0^F[1]<(Oe(F[0]-x)<Le?S:P):S<=F[1]&&F[1]<=P:Q>ze^(x<=F[0]&&F[0]<=A)){var B=Ca(L,(-O+K)/M);return dn(B,z),[F,Nn(B)]}}}function f(c,g){var u=n?e:ze-e,b=0;return c<-u?b|=1:c>u&&(b|=2),g<-u?b|=4:g>u&&(b|=8),b}return ri(d,l,i,n?[0,-e]:[-ze,e-ze])}function qd(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],f=a[1],c=0,g=1,u=s-d,b=f-l,h;if(h=r-d,!(!u&&h>0)){if(h/=u,u<0){if(h<c)return;h<g&&(g=h)}else if(u>0){if(h>g)return;h>c&&(c=h)}if(h=o-d,!(!u&&h<0)){if(h/=u,u<0){if(h>g)return;h>c&&(c=h)}else if(u>0){if(h<c)return;h<g&&(g=h)}if(h=n-l,!(!b&&h>0)){if(h/=b,b<0){if(h<c)return;h<g&&(g=h)}else if(b>0){if(h>g)return;h>c&&(c=h)}if(h=i-l,!(!b&&h<0)){if(h/=b,b<0){if(h>g)return;h>c&&(c=h)}else if(b>0){if(h<c)return;h<g&&(g=h)}return c>0&&(e[0]=d+c*u,e[1]=l+c*b),g<1&&(a[0]=d+g*u,a[1]=l+g*b),!0}}}}}var ia=1e9,Aa=-ia;function Td(e,a,r,n){function o(f,c){return e<=f&&f<=r&&a<=c&&c<=n}function i(f,c,g,u){var b=0,h=0;if(f==null||(b=d(f,g))!==(h=d(c,g))||s(f,c)<0^g>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+g+4)%4)!==h);else u.point(c[0],c[1])}function d(f,c){return Oe(f[0]-e)<Le?c>0?0:3:Oe(f[0]-r)<Le?c>0?2:1:Oe(f[1]-a)<Le?c>0?1:0:c>0?3:2}function l(f,c){return s(f.x,c.x)}function s(f,c){var g=d(f,1),u=d(c,1);return g!==u?g-u:g===0?c[1]-f[1]:g===1?f[0]-c[0]:g===2?f[1]-c[1]:c[0]-f[0]}return function(f){var c=f,g=ai(),u,b,h,w,v,m,y,E,k,j,N,z={point:T,lineStart:W,lineEnd:K,polygonStart:O,polygonEnd:M};function T(x,A){o(x,A)&&c.point(x,A)}function L(){for(var x=0,A=0,S=b.length;A<S;++A)for(var P=b[A],U=1,Q=P.length,ne=P[0],C,B,D=ne[0],Z=ne[1];U<Q;++U)C=D,B=Z,ne=P[U],D=ne[0],Z=ne[1],B<=n?Z>n&&(D-C)*(n-B)>(Z-B)*(e-C)&&++x:Z<=n&&(D-C)*(n-B)<(Z-B)*(e-C)&&--x;return x}function O(){c=g,u=[],b=[],N=!0}function M(){var x=L(),A=N&&x,S=(u=ti(u)).length;(A||S)&&(f.polygonStart(),A&&(f.lineStart(),i(null,null,1,f),f.lineEnd()),S&&ni(u,l,x,i,f),f.polygonEnd()),c=f,u=b=h=null}function W(){z.point=F,b&&b.push(h=[]),j=!0,k=!1,y=E=NaN}function K(){u&&(F(w,v),m&&k&&g.rejoin(),u.push(g.result())),z.point=T,k&&c.lineEnd()}function F(x,A){var S=o(x,A);if(b&&h.push([x,A]),j)w=x,v=A,m=S,j=!1,S&&(c.lineStart(),c.point(x,A));else if(S&&k)c.point(x,A);else{var P=[y=Math.max(Aa,Math.min(ia,y)),E=Math.max(Aa,Math.min(ia,E))],U=[x=Math.max(Aa,Math.min(ia,x)),A=Math.max(Aa,Math.min(ia,A))];qd(P,U,e,a,r,n)?(k||(c.lineStart(),c.point(P[0],P[1])),c.point(U[0],U[1]),S||c.lineEnd(),N=!1):S&&(c.lineStart(),c.point(x,A),N=!1)}y=x,E=A,k=S}return z}}const An=e=>e;var cn=new Bt,qn=new Bt,oi,ii,Tn,Ln,Nt={point:pt,lineStart:pt,lineEnd:pt,polygonStart:function(){Nt.lineStart=Ld,Nt.lineEnd=Rd},polygonEnd:function(){Nt.lineStart=Nt.lineEnd=Nt.point=pt,cn.add(Oe(qn)),qn=new Bt},result:function(){var e=cn/2;return cn=new Bt,e}};function Ld(){Nt.point=Fd}function Fd(e,a){Nt.point=si,oi=Tn=e,ii=Ln=a}function si(e,a){qn.add(Ln*e-Tn*a),Tn=e,Ln=a}function Rd(){si(oi,ii)}var Jt=1/0,Wa=Jt,ga=-Jt,Ga=ga,Ya={point:Od,lineStart:pt,lineEnd:pt,polygonStart:pt,polygonEnd:pt,result:function(){var e=[[Jt,Wa],[ga,Ga]];return ga=Ga=-(Wa=Jt=1/0),e}};function Od(e,a){e<Jt&&(Jt=e),e>ga&&(ga=e),a<Wa&&(Wa=a),a>Ga&&(Ga=a)}var Fn=0,Rn=0,sa=0,Qa=0,Ka=0,Gt=0,On=0,Mn=0,la=0,li,di,bt,vt,lt={point:$t,lineStart:Jr,lineEnd:Xr,polygonStart:function(){lt.lineStart=Id,lt.lineEnd=Pd},polygonEnd:function(){lt.point=$t,lt.lineStart=Jr,lt.lineEnd=Xr},result:function(){var e=la?[On/la,Mn/la]:Gt?[Qa/Gt,Ka/Gt]:sa?[Fn/sa,Rn/sa]:[NaN,NaN];return Fn=Rn=sa=Qa=Ka=Gt=On=Mn=la=0,e}};function $t(e,a){Fn+=e,Rn+=a,++sa}function Jr(){lt.point=Md}function Md(e,a){lt.point=Dd,$t(bt=e,vt=a)}function Dd(e,a){var r=e-bt,n=a-vt,o=Vt(r*r+n*n);Qa+=o*(bt+e)/2,Ka+=o*(vt+a)/2,Gt+=o,$t(bt=e,vt=a)}function Xr(){lt.point=$t}function Id(){lt.point=_d}function Pd(){pi(li,di)}function _d(e,a){lt.point=pi,$t(li=bt=e,di=vt=a)}function pi(e,a){var r=e-bt,n=a-vt,o=Vt(r*r+n*n);Qa+=o*(bt+e)/2,Ka+=o*(vt+a)/2,Gt+=o,o=vt*e-bt*a,On+=o*(bt+e),Mn+=o*(vt+a),la+=o*3,$t(bt=e,vt=a)}function ci(e){this._context=e}ci.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,ct);break}}},result:pt};var Dn=new Bt,un,ui,mi,da,pa,xa={point:pt,lineStart:function(){xa.point=Bd},lineEnd:function(){un&&fi(ui,mi),xa.point=pt},polygonStart:function(){un=!0},polygonEnd:function(){un=null},result:function(){var e=+Dn;return Dn=new Bt,e}};function Bd(e,a){xa.point=fi,ui=da=e,mi=pa=a}function fi(e,a){da-=e,pa-=a,Dn.add(Vt(da*da+pa*pa)),da=e,pa=a}let Zr,Ja,eo,to;class ao{constructor(a){this._append=a==null?hi:$d(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==eo||this._append!==Ja){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,eo=n,Ja=this._append,to=this._,this._=o}this._+=to;break}}}result(){const a=this._;return this._="",a.length?a:null}}function hi(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function $d(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return hi;if(a!==Zr){const r=10**a;Zr=a,Ja=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ja}function Ud(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Wt(l,o(i))),i.result()}return d.area=function(l){return Wt(l,o(Nt)),Nt.result()},d.measure=function(l){return Wt(l,o(xa)),xa.result()},d.bounds=function(l){return Wt(l,o(Ya)),Ya.result()},d.centroid=function(l){return Wt(l,o(lt)),lt.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,An):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new ao(r)):new ci(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new ao(r)),d},d.projection(e).digits(r).context(a)}function Qn(e){return function(a){var r=new In;for(var n in e)r[n]=e[n];return r.stream=a,r}}function In(){}In.prototype={constructor:In,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Kn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Wt(r,e.stream(Ya)),a(Ya.result()),n!=null&&e.clipExtent(n),e}function gi(e,a,r){return Kn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Hd(e,a,r){return gi(e,[[0,0],a],r)}function Vd(e,a,r){return Kn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Wd(e,a,r){return Kn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var no=16,Gd=De(30*nt);function ro(e,a){return+a?Qd(e,a):Yd(e)}function Yd(e){return Qn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Qd(e,a){function r(n,o,i,d,l,s,f,c,g,u,b,h,w,v){var m=f-n,y=c-o,E=m*m+y*y;if(E>4*a&&w--){var k=d+u,j=l+b,N=s+h,z=Vt(k*k+j*j+N*N),T=ha(N/=z),L=Oe(Oe(N)-1)<Le||Oe(i-g)<Le?(i+g)/2:fa(j,k),O=e(L,T),M=O[0],W=O[1],K=M-n,F=W-o,x=y*K-m*F;(x*x/E>a||Oe((m*K+y*F)/E-.5)>.3||d*u+l*b+s*h<Gd)&&(r(n,o,i,d,l,s,M,W,L,k/=z,j/=z,N,w,v),v.point(M,W),r(M,W,L,k,j,N,f,c,g,u,b,h,w,v))}}return function(n){var o,i,d,l,s,f,c,g,u,b,h,w,v={point:m,lineStart:y,lineEnd:k,polygonStart:function(){n.polygonStart(),v.lineStart=j},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function m(T,L){T=e(T,L),n.point(T[0],T[1])}function y(){g=NaN,v.point=E,n.lineStart()}function E(T,L){var O=Kt([T,L]),M=e(T,L);r(g,u,c,b,h,w,g=M[0],u=M[1],c=T,b=O[0],h=O[1],w=O[2],no,n),n.point(g,u)}function k(){v.point=m,n.lineEnd()}function j(){y(),v.point=N,v.lineEnd=z}function N(T,L){E(o=T,L),i=g,d=u,l=b,s=h,f=w,v.point=E}function z(){r(g,u,c,b,h,w,i,d,o,l,s,f,no,n),v.lineEnd=k,k()}return v}}var Kd=Qn({point:function(e,a){this.stream.point(e*nt,a*nt)}});function Jd(e){return Qn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Xd(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function oo(e,a,r,n,o,i){if(!i)return Xd(e,a,r,n,o);var d=De(i),l=Ie(i),s=d*e,f=l*e,c=d/e,g=l/e,u=(l*r-d*a)/e,b=(l*a+d*r)/e;function h(w,v){return w*=n,v*=o,[s*w-f*v+a,r-f*w-s*v]}return h.invert=function(w,v){return[n*(c*w-g*v+u),o*(b-g*w-c*v)]},h}function Zd(e){return ep(function(){return e})()}function ep(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,f=0,c,g=0,u=1,b=1,h=null,w=Kr,v=null,m,y,E,k=An,j=.5,N,z,T,L,O;function M(x){return T(x[0]*nt,x[1]*nt)}function W(x){return x=T.invert(x[0],x[1]),x&&[x[0]*Et,x[1]*Et]}M.stream=function(x){return L&&O===x?L:L=Kd(Jd(c)(w(N(k(O=x)))))},M.preclip=function(x){return arguments.length?(w=x,h=void 0,F()):w},M.postclip=function(x){return arguments.length?(k=x,v=m=y=E=null,F()):k},M.clipAngle=function(x){return arguments.length?(w=+x?Ad(h=x*nt):(h=null,Kr),F()):h*Et},M.clipExtent=function(x){return arguments.length?(k=x==null?(v=m=y=E=null,An):Td(v=+x[0][0],m=+x[0][1],y=+x[1][0],E=+x[1][1]),F()):v==null?null:[[v,m],[y,E]]},M.scale=function(x){return arguments.length?(r=+x,K()):r},M.translate=function(x){return arguments.length?(n=+x[0],o=+x[1],K()):[n,o]},M.center=function(x){return arguments.length?(i=x[0]%360*nt,d=x[1]%360*nt,K()):[i*Et,d*Et]},M.rotate=function(x){return arguments.length?(l=x[0]%360*nt,s=x[1]%360*nt,f=x.length>2?x[2]%360*nt:0,K()):[l*Et,s*Et,f*Et]},M.angle=function(x){return arguments.length?(g=x%360*nt,K()):g*Et},M.reflectX=function(x){return arguments.length?(u=x?-1:1,K()):u<0},M.reflectY=function(x){return arguments.length?(b=x?-1:1,K()):b<0},M.precision=function(x){return arguments.length?(N=ro(z,j=x*x),F()):Vt(j)},M.fitExtent=function(x,A){return gi(M,x,A)},M.fitSize=function(x,A){return Hd(M,x,A)},M.fitWidth=function(x,A){return Vd(M,x,A)},M.fitHeight=function(x,A){return Wd(M,x,A)};function K(){var x=oo(r,0,0,u,b,g).apply(null,a(i,d)),A=oo(r,n-x[0],o-x[1],u,b,g);return c=yd(l,s,f),z=Cn(a,A),T=Cn(c,z),N=ro(z,j),F()}function F(){return L=O=null,M}return function(){return a=e.apply(this,arguments),M.invert=a.invert&&W,K()}}function xi(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}xi.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Oe(o)>Le&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function tp(){return Zd(xi).scale(175.295)}function ap(e){return e}function np(e){if(e==null)return ap;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var f=2,c=l.length,g=new Array(c);for(g[0]=(a+=l[0])*n+i,g[1]=(r+=l[1])*o+d;f<c;)g[f]=l[f],++f;return g}}function rp(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function op(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return io(e,r)})}:io(e,a)}function io(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=ip(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function ip(e,a){var r=np(e.transform),n=e.arcs;function o(c,g){g.length&&g.pop();for(var u=n[c<0?~c:c],b=0,h=u.length;b<h;++b)g.push(r(u[b],b));c<0&&rp(g,h)}function i(c){return r(c)}function d(c){for(var g=[],u=0,b=c.length;u<b;++u)o(c[u],g);return g.length<2&&g.push(g[0]),g}function l(c){for(var g=d(c);g.length<4;)g.push(g[0]);return g}function s(c){return c.map(l)}function f(c){var g=c.type,u;switch(g){case"GeometryCollection":return{type:g,geometries:c.geometries.map(f)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=d(c.arcs);break;case"MultiLineString":u=c.arcs.map(d);break;case"Polygon":u=s(c.arcs);break;case"MultiPolygon":u=c.arcs.map(s);break;default:return null}return{type:g,coordinates:u}}return f(a)}const bi={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},sp=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function lp(e,a,r){const n=bi[e];if(!n||!n.length)return-1;const o=sp(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let qa=null;function dp(){return qa||(qa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=op(r,n),i=tp().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=Ud(i),l=(o.features||[]).filter(c=>{var g;return(((g=c.properties)==null?void 0:g.name)||"")!=="Antarctica"}).map(c=>{var b;const g=((b=c.properties)==null?void 0:b.name)||"",u=d(c)||"";return u?{i2:hs(g)||null,n:g,d:u}:null}).filter(c=>!!c);if(!l.length)return null;const s={};for(const[c,g]of Object.entries(gs)){const u=i(g);u&&(s[c]={x:u[0],y:u[1]})}const f={};for(const[c,g]of Object.entries(bi)){const u=g.map(b=>i(b.ll)).filter(b=>!!b).map(([b,h])=>({x:b,y:h}));u.length&&(f[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:f}}catch{return null}})(),qa)}function pp(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return dp().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const cp="8 40 984 210",up={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},so=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function lo(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function mp(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var f;if(!o)return;const s=(f=e.current)==null?void 0:f.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function po({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function fp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:f,dossiers:c,source:g}=J(),u=f.loading&&!c.length,b=p.useRef(null),h=p.useRef(null),w=pp(e.continent==="monde"),v=e.continent==="monde"?w:Un.find(x=>x.key===e.continent)||null,m=mp(b,e.continent+":"+e.mapFolded+":"+!!v),[y,E]=p.useState(new Map),[k,j]=p.useState(null);p.useEffect(()=>{const x=b.current;if(!x)return;const A=new Map;x.querySelectorAll("path[data-i2]").forEach(S=>{const P=S.dataset.i2;if(P)try{const U=S.getBBox();U.width>0&&A.set(P,{x:U.x,y:U.y,w:U.width,h:U.height})}catch{}}),E(A)},[e.continent,m,v]);const N=p.useMemo(()=>r.filter(x=>x.cc),[r]),z=p.useMemo(()=>{const x=new Map;return N.forEach(A=>x.set(A.cc,(x.get(A.cc)||0)+1)),x},[N]),T=e.continent==="monde"&&w?w.anchors:null,L=e.continent==="monde"&&w?w.metros:null,O=p.useMemo(()=>N.map(x=>{const A=lo(x.name||x.id||""),S=lo((x.id||x.name||"")+"·y");if(T&&x.cc){const C=L?L[x.cc]:void 0;if(C&&C.length){const D=lp(x.cc,x.city,A);if(D>=0&&C[D])return{d:x,x:C[D].x+(A-.5)*5,y:C[D].y+(S-.5)*5}}const B=T[x.cc];if(B)return{d:x,x:B.x+(A-.5)*10,y:B.y+(S-.5)*10}}const P=x.cc?y.get(x.cc):void 0;if(!P)return null;const U=up[`${e.continent}:${x.cc||""}`];if(U)return{d:x,x:P.x+P.w*(U.fx+(A-.5)*U.sx),y:P.y+P.h*(U.fy+(S-.5)*U.sy)};const Q=(A-.5)*Math.min(P.w*.55,60),ne=(S-.5)*Math.min(P.h*.55,60);return{d:x,x:P.x+P.w/2+Q,y:P.y+P.h/2+ne}}).filter(x=>!!x),[N,y,T,L,e.continent]),M=x=>m>0?x/m:x,W=p.useMemo(()=>n?[0,1,2,3,4,5].map(x=>({c:so[x],fr:s.plabels[x],en:s.plabels[x],n:r.filter(A=>A.kind==="target"&&Te(A)===x).length})).filter(x=>x.n>0):cr.map((x,A)=>({...x,n:r.filter(S=>ur(S)===A).length})),[r,n,s.plabels]),K=i?d.get(i):null,F=K?O.find(x=>x.d.id===K.id):null;return v?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:[u&&t.jsx(po,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?cp:v.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?v.fr:v.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:v.countries.map((x,A)=>t.jsx("g",{className:"ct"+(x.i2&&z.get(x.i2)?"":" empty"),children:t.jsx("path",{d:x.d,"data-i2":x.i2||void 0})},A))}),t.jsx("g",{children:O.map(x=>{const A=cr[ur(x.d)],S=!!He(x.d),P=x.d.kind==="target",U=n&&P?so[Te(x.d)]:A.c,Q=!n&&Ye(x.d);return t.jsxs("g",{className:"co"+(Q?" done":""),onMouseEnter:()=>{var B,D;const ne=(B=h.current)==null?void 0:B.getBoundingClientRect(),C=(D=b.current)==null?void 0:D.createSVGPoint();if(C&&b.current&&ne){C.x=x.x,C.y=x.y;const Z=C.matrixTransform(b.current.getScreenCTM());j({x:Z.x-ne.left,y:Z.y-ne.top,label:x.d.name+" · "+(ea(x.d.cc,l)||x.d.countryLabel||"")})}o(x.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var B;if(g==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:x.d.id}),(x.d.noCo||["media","nominations","recrutements"].includes(x.d.engine||""))&&(x.d.url||x.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x.d.url||"",text:[x.d.headline,x.d.tagline].filter(Boolean).join(`
`)}})):x.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x.d.name,url:x.d.url||"",website:x.d.website||"",domain:x.d.domain||""}}));return}const ne=(B=b.current)==null?void 0:B.createSVGPoint();let C=null;if(ne&&b.current){ne.x=x.x,ne.y=x.y;const D=ne.matrixTransform(b.current.getScreenCTM());C={x:D.x,y:D.y}}a({type:"popup",id:x.d.id,anchor:C})},children:[t.jsx("circle",{className:"h",cx:x.x,cy:x.y,r:M(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:x.x,cy:x.y,r:M(A.px),fill:U,stroke:S?"#E5484D":"#ffffff",strokeWidth:M(S?2.2:1.3)})]},x.d.id||x.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:M(13),fill:"none",stroke:"#16233A",strokeWidth:M(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:W.map((x,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":x.c}}),l==="fr"?x.fr:x.en," ",t.jsx("b",{children:x.n})]},A))}),r.some(x=>!x.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(x=>!x.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:h,children:t.jsx(po,{msgs:s.loadMsgs})})}function hp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function vi({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=J(),s=a.filters,[f,c]=p.useState(!1),[g,u]=p.useState(!1),b=p.useRef(null),h=p.useRef(null),w=p.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),v=F=>w.filter(x=>F!=="country"&&s.country.length&&!s.country.includes(x.cc||"")?!1:Ua(x,s,i,F==="country"?void 0:F)),m=F=>!i||F.kind!=="op",y=p.useMemo(()=>{const F=v("win").filter(m),x=A=>F.filter(S=>(S.date?Math.max(0,Math.floor((Date.now()-Date.parse(S.date))/864e5)):9999)<=A).length;return[x(0),x(7),x(30),F.length]},[w,s,i]),E=p.useMemo(()=>s.day?v("win").filter(m).filter(F=>(F.date||"").slice(0,10)===s.day).length:0,[w,s,i]),k=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,j=k+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!f&&!g)return;const F=A=>{var P,U;const S=A.target;f&&!((P=b.current)!=null&&P.contains(S))&&c(!1),g&&!((U=h.current)!=null&&U.contains(S))&&u(!1)},x=A=>{A.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",x),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",x)}},[f,g]);const N=(F,x,A,S="fbtn")=>t.jsxs("button",{type:"button",className:S,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:x}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},F),z=["1","7","30","all"],T=Math.max(0,z.indexOf(s.win||"all")),L=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(hp(s.day,l))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:h,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>u(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:y[T]}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:z.map((F,x)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),u(!1)},children:[o.datesShort[x],t.jsx("span",{className:"n",children:y[x]})]},F))})]}):t.jsx("div",{className:"seg",children:z.map((F,x)=>t.jsxs("button",{type:"button","aria-pressed":s.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[x]}),t.jsx("b",{children:y[x]})]},F))}),O=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),M=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,s.sector.length),(n.some(F=>!!F.market)||s.market.length>0)&&N("mar",o.fMarket,s.market.length),N("pay",o.fCountry,s.country.length),N("det",o.fEngine,s.engine.length),N("sta",o.fStage,s.stage.length),i&&N("crib",o.fVerdict,s.crible.length),i&&N("ang","Angle",s.angle.length),i&&N("mem","Mémo",s.memoLevel.length)]}),W=(F=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),K=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{c(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:M})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[O,K,W(!1)]})]}),a.openFacet&&t.jsx(co,{poolFor:v})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,O,M,t.jsx("span",{className:"fgrow"}),W()]}),a.openFacet&&t.jsx(co,{poolFor:v})]})}function co({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=J(),l=a.filters,s=a.openFacet,{title:f,cols:c,options:g}=p.useMemo(()=>{if(s==="sig"){const v=e("signal").filter(E=>He(E)),m=new Map;v.forEach(E=>{const k=E.engine||"";m.set(k,(m.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:v.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...yn([...m.keys()],o).map(E=>({v:E,label:_t(E)+" "+rt(E,o),n:m.get(E)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="crib"){const v=e("crible").filter(y=>!i||Co(y,a.ptab,d.favIds)),m=new Map;return v.forEach(y=>{const E=zo(y);E&&E!=="NEW"&&m.set(E,(m.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...m.entries()].sort((y,E)=>(mr[y[0]]??9)-(mr[E[0]]??9)||E[1]-y[1]).map(([y,E])=>({v:y,label:'<span class="fdot" style="background:'+(xs[y]||"#94A3B8")+'"></span>'+y,n:E,html:!0,on:l.crible.includes(y)}))}}if(s==="sec"){const v=e("sector"),m=new Map;return v.forEach(y=>{y.sector&&m.set(y.sector,(m.get(y.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:l.sector.includes(y)}))}}if(s==="mar"){const v=e("market"),m=new Map;return v.forEach(y=>{y.market&&m.set(y.market,(m.get(y.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:l.market.includes(y)}))}}if(s==="pay"){const v=e("country"),m=new Map;return v.forEach(y=>{y.cc&&m.set(y.cc,(m.get(y.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:ea(y,o)||y,n:E,html:!1,on:l.country.includes(y)}))}}if(s==="det"){const v=e("engine"),m=new Map;return v.forEach(y=>{y.engine&&m.set(y.engine,(m.get(y.engine)||0)+1)}),{title:n.fEngine,cols:2,options:yn([...m.keys()],o).map(y=>({v:y,label:_t(y)+" "+rt(y,o)+' <span style="color:var(--dim);font-size:10px">· '+bs(vs(y),o)+"</span>",n:m.get(y)||0,html:!0,on:l.engine.includes(y)}))}}if(s==="ang"){const v=e("angle"),m=new Map;return v.forEach(y=>{y.angle&&m.set(y.angle,(m.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y.replace(/[_-]+/g," "),n:E,html:!1,on:l.angle.includes(y)}))}}if(s==="mem"){const v=e("memoLevel"),m=new Map;v.forEach(E=>{if(E.kind==="target"){const k=$n(E);m.set(k,(m.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:y[E],n:m.get(E)||0,html:!1,on:l.memoLevel.includes(E)}))}}const h=e("stage"),w=new Map;return h.forEach(v=>{v.stage&&w.set(v.stage,(w.get(v.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:l.stage.includes(v)}))}},[s,a,o]),u=h=>{if(s==="sig"){if(h==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const v=l.signalEngines.includes(h)?l.signalEngines.filter(m=>m!==h):[...l.signalEngines,h];r({type:"filters",patch:{signalOnly:!0,signalEngines:v}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(h)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:h})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:f}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:g.map(h=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":h.on,onClick:()=>u(h.v),children:[t.jsx("span",{className:"bx"}),h.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:h.label}}):t.jsx("span",{className:"l",children:h.label}),t.jsx("span",{className:"n",children:h.n})]},h.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function wi({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=J(),s=p.useMemo(()=>{const b={};return r.forEach(h=>{Ua(h,n.filters,i)&&(b.monde=(b.monde||0)+1,h.continent&&(b[h.continent]=(b[h.continent]||0)+1))}),b},[r,n.filters,i]),[f,c]=p.useState(!1),g=p.useRef(null);p.useEffect(()=>{if(!f)return;const b=w=>{var v;(v=g.current)!=null&&v.contains(w.target)||c(!1)},h=w=>{w.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",h)}},[f]);const u=b=>{const h=Un.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?h.fr:h.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:g,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:fr.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[fr.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]})]})}function Pn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function yi(e){return"atl2:evalq:"+(e||"anon")}function gp(e,a){const r=yi(e),n=Pn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}let _n=null;function xp(e){_n=e;try{window.dispatchEvent(new CustomEvent("atl2:extract-note",{detail:e}))}catch{}}function bp(){const{t:e,lang:a,data:r,dossiers:n}=J(),o=r.session.token||"",i=yi(o),[d,l]=p.useState(()=>Pn(i)),s=p.useRef(!1),[f,c]=p.useState(!1);p.useEffect(()=>{try{const C=d.slice(0,30).map(({descBusy:B,evalBusy:D,...Z})=>Z);localStorage.setItem(i,JSON.stringify(C)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[d,i]),p.useEffect(()=>{const C=()=>{if(s.current)return;const B=Pn(i);l(D=>JSON.stringify(D.map(({descBusy:Z,evalBusy:$,...oe})=>oe))===JSON.stringify(B)?D:B)};return window.addEventListener("atl2:evalq",C),window.addEventListener("storage",C),()=>{window.removeEventListener("atl2:evalq",C),window.removeEventListener("storage",C)}},[i]);const[g,u]=p.useState([]),[b,h]=p.useState(""),[w,v]=p.useState(!1),[m,y]=p.useState(!1),[E,k]=p.useState(""),[j,N]=p.useState(()=>_n);p.useEffect(()=>{const C=B=>{var Z,$;const D=B.detail;D&&((Z=D.cited)!=null&&Z.length||($=D.match)!=null&&$.length||D.title)&&N(D)};return window.addEventListener("atl2:extract-note",C),()=>window.removeEventListener("atl2:extract-note",C)},[]);const z=p.useCallback((C,B)=>l(D=>D.map((Z,$)=>$===C?{...Z,...B}:Z)),[]),T=p.useCallback((C,B)=>{const D=B.trim();D&&(z(C,{name:D,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Hn(D).then(Z=>{const $=Z.candidates||[];Z.website?z(C,{site:Z.website,status:"ready"}):$.length===1?z(C,{site:$[0].url,status:"ready"}):$.length>1?z(C,{status:"pick",candidates:$.slice(0,6)}):z(C,{status:"ready"})}).catch(()=>z(C,{status:"ready"})))},[z]),L=p.useCallback((C,B,D)=>{z(C,{descBusy:!0}),qo(o,B,D).then(Z=>{if(Z.quota){c(!0),z(C,{descBusy:!1,descDone:!0});return}const $=Z.blocs||{},oe=($.synthese||$.value_prop||$.produit||$.modele||"").trim();z(C,{descBusy:!1,descDone:!0,desc:oe})}).catch(()=>z(C,{descBusy:!1,descDone:!0}))},[z,o]);p.useEffect(()=>{const C=d.findIndex(D=>D.auto&&D.name.trim()&&D.status==="");if(C>=0){T(C,d[C].name);return}if(f)return;const B=d.findIndex(D=>D.status==="ready"&&D.site&&!D.descDone&&!D.descBusy);B>=0&&L(B,d[B].name,d[B].site)},[d,T,L,f]);const[O,M]=p.useState(!1),W=p.useCallback(async(C,B)=>{z(C,{evalBusy:!0});const D=(B.site||B.name).trim(),Z=await To(o,D,"atelier2");return Z.verdict==="quota"?(z(C,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:Z.reason||"",remaining:0}})),!1):(z(C,{evalBusy:!1,status:Z.verdict==="kept"?"kept":"out",reason:Z.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:Z.company||B.name,verdict:Z.verdict,reason:Z.reason||"",remaining:Z.remaining??null}})),!0)},[z,o]),K=async()=>{if(O)return;const C=d.map((B,D)=>({r:B,i:D})).filter(({r:B})=>B.name.trim()&&B.status!=="kept"&&B.status!=="out"&&B.status!=="resolving");if(C.length){M(!0);for(const{r:B,i:D}of C)if(!await W(D,B))break;M(!1)}},F=p.useMemo(()=>{const C=new Set,B=[];return d.filter(D=>D.status==="kept").forEach(D=>{const Z=D.name.trim().toLowerCase();Z&&!C.has(Z)&&(C.add(Z),B.push(D.name.trim()))}),n.filter(D=>Te(D)>=1&&Te(D)<=4&&(D.website||D.domain)).forEach(D=>{const Z=(D.name||"").trim().toLowerCase();Z&&!C.has(Z)&&(C.add(Z),B.push((D.name||"").trim()))}),B},[d,n]),x=p.useMemo(()=>{const C=new Set;return n.forEach(B=>{const D=(B.name||"").trim().toLowerCase();D&&C.add(D)}),d.forEach(B=>{const D=B.name.trim().toLowerCase();D&&C.add(D)}),C},[n,d]),A=async()=>{if(b||!F.length)return;y(!1);const C=[];for(const B of F.slice(0,2)){h(B);const D=await Lo(o,B);if(D){if(D.verdict==="quota"){v(!0);break}(D.results||[]).forEach(Z=>{const $=(Z.company||"").trim().toLowerCase();!$||x.has($)||C.some(oe=>oe.name.toLowerCase()===$)||C.push({name:(Z.company||"").trim(),verdict:Z.verdict||"",reason:Z.reason,from:B})})}}h(""),y(!0),u(B=>[...C,...B].slice(0,24))},S=async(C,B)=>{if(b)return;y(!1),h(C==="thesis"?e.pxThesis:B);const D=await ys(o,C,B,6);if(h(""),y(!0),!D)return;if(D.verdict==="quota"){v(!0);return}const Z=[];(D.results||[]).forEach($=>{const oe=($.company||"").trim().toLowerCase();!oe||x.has(oe)||Z.some(me=>me.name.toLowerCase()===oe)||Z.push({name:($.company||"").trim(),verdict:$.verdict||"",reason:$.reason,from:C==="thesis"?e.pxThesis:B})}),u($=>[...Z,...$].slice(0,24))},P=()=>{const C=E.trim();C.length<3||S(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(C)?"registry":"keyword",C)},U=C=>{l(B=>[...B,{name:C.name,site:"",status:"",auto:!0}].slice(0,30)),u(B=>B.filter(D=>D.name!==C.name))},Q=d.filter(C=>C.name.trim()&&C.status!=="kept"&&C.status!=="out").length,ne=C=>C.name.trim()&&C.status!=="kept"&&C.status!=="out"&&C.status!=="resolving"&&!C.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[j&&t.jsxs("div",{className:"eq-note"+(j.fallback?" fb":""),children:[t.jsxs("b",{children:[j.fallback?e.rsNoteFallback:e.rsNoteRead,j.title?` « ${j.title.length>90?j.title.slice(0,89)+"…":j.title} »`:""]}),!!j.cited.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteCited," ",t.jsx("i",{children:j.cited.join(" · ")})]}),!!j.match.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteMatch," ",t.jsx("i",{children:j.match.join(" · ")})]}),!j.match.length&&!!j.cited.length&&t.jsx("p",{className:"eq-nl",children:e.rsNoteNoMatch}),t.jsx("p",{className:"eq-nl",children:e.rsNoteAdded(j.added)}),t.jsx("button",{type:"button",className:"eq-note-x",onClick:()=>{_n=null,N(null)},title:e.rsClose,children:"×"})]}),t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{className:"eq-h-go",children:e.eqRunOneShort})]}),d.map((C,B)=>t.jsxs("div",{className:"eq-item"+(C.status==="kept"?" r-kept":C.status==="out"?" r-out":""),children:[t.jsxs("div",{className:"eq-row"+(C.status==="kept"?" r-kept":C.status==="out"?" r-out":""),children:[t.jsx("input",{value:C.name,placeholder:e.eqNamePh,onChange:D=>{const Z=D.target.value.split(`
`).map($=>$.trim()).filter(Boolean);Z.length>1?l($=>{const oe=[...$];return oe.splice(B,1,...Z.map(me=>({name:me,site:"",status:"",auto:!0}))),oe.slice(0,30)}):z(B,{name:D.target.value})},onBlur:()=>{C.name.trim()&&!C.site&&C.status!=="resolving"&&C.status!=="pick"&&T(B,C.name)},onKeyDown:D=>{D.key==="Enter"&&T(B,C.name)}}),t.jsxs("span",{className:"eq-site",children:[C.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),C.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:D=>{const Z=D.target.value;Z&&z(B,{site:Z,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(C.candidates||[]).map(D=>t.jsx("option",{value:D.url,children:(D.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},D.url))]}),C.status!=="resolving"&&C.status!=="pick"&&(C.site?t.jsxs("a",{href:C.site.startsWith("http")?C.site:"https://"+C.site,target:"_blank",rel:"nofollow noopener",children:[C.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:C.name.trim()&&C.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:C.desc||"",children:C.descBusy?t.jsx("i",{children:e.eqDescBusy}):C.desc?C.desc:t.jsx("em",{children:C.descDone?f?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(C.status||"vide"),title:C.reason||"",children:C.status==="kept"?"✓ "+e.kept:C.status==="out"?"✗ "+e.dropped:C.status==="ready"?e.eqReady:C.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>l(D=>D.filter((Z,$)=>$!==B)),children:"×"}),(C.name.trim()||C.site)&&C.status!=="kept"&&C.status!=="out"?t.jsxs(Za,{lang:a,storeKey:(C.site||C.name).trim(),className:"eq-go",title:e.eqRunOne,disabled:!ne(C)||O,confirmLabel:"⚡ "+e.eqRunOneShort,onConfirm:()=>{W(B,C)},children:[C.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}):t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!ne(C)||O,onClick:()=>{W(B,C)},children:[C.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]})]}),(C.name.trim()||C.site)&&C.status!=="kept"&&C.status!=="out"&&t.jsx(ws,{lang:a,variant:"row",storeKey:(C.site||C.name).trim()})]},B)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>l(C=>[...C,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{S("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:C=>k(C.target.value),onKeyDown:C=>{C.key==="Enter"&&P()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:P,children:e.pxGoFree}),!!F.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{A()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!F.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(F[0],F.length)}),w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),m&&!g.length&&!w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),g.map(C=>t.jsxs("span",{className:"eq-sc"+(C.verdict==="kept"?" ok":""),title:(C.reason||"")+" — "+e.sgVia(C.from),children:[t.jsx("b",{children:C.name}),C.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>U(C),children:"+"})]},C.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(C=>C.status==="kept"||C.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>l(C=>C.filter(B=>B.status!=="kept"&&B.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(O?" loading":""),style:{justifyContent:"center"},disabled:O||!Q,onClick:()=>{K()},children:[t.jsx("span",{className:"fill"}),O?e.eqRunning:e.eqGo(Q)]})]})]})]})}const vp={deals:"ma-deals",news:"veille"},ki=/^(deals?|news|breaking|live|update|analysis|markets?|opinion|icymi)$/i,wp=/^(this|that|these|those|why|what|what'?s|how|when|where|who|which|is|are|do|does|did|can|could|should|would|will|a|an|the|les?|la|des?|une?|un)\b/i,yp=/\b(labor day|workers?|toast|monday|tuesday|wednesday|thursday|friday|saturday|sunday|assessment|volunteer)\b/i,kp=/\b(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\b/i;function Ei(e){const a=(e||"").trim();return!(!a||a.length<2||a.length>48||ki.test(a)||wp.test(a)||yp.test(a)||Qt(a)||!Xa(a))}function uo(e){return(e.url||e.title||"").trim()}function mn(e){const a=(e.kind||"").toLowerCase(),r=(e.ingest_kind||"").toLowerCase();if(a==="article"||a==="news"||a==="media"||r==="url"||r==="youtube")return!0;const n=(e.title||"").replace(/\s+/g," ").trim();return n?Qt(n)||kp.test(n)?!0:!Xa(n):!!(e.url||"").trim()}function Jn(e){let a=(e||"").replace(/\s+/g," ").trim();a=a.replace(/^\s*(?:deals?|news|breaking|live|update|analysis)\s*[:–—|]\s*/i,"");const r=[],n=d=>{let l=(d||"").replace(/[\u2018\u2019\u201c\u201d'"«»]/g,"").trim();l=l.replace(/^(the|le|la|les|l['’])\s+/i,"").trim(),l=l.replace(/\s+(?:'s|retirement|business|unit|division|arm|operations?)\b.*$/i,"").trim(),Ei(l)&&(r.some(s=>s.toLowerCase()===l.toLowerCase())||r.push(l))},o=a.match(/^(.{2,48}?)\s+(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\s+(.{2,60}?)(?:\s+(?:for|pour|en|in|at|à|from|de)\b|$)/i);if(o&&(n(o[1]),n(o[2]),r.length))return r;const i=a.match(/^(.{2,48}?)\s*[:–—]/);return i&&n(i[1]),r}function mo(e){const a=Jn(e.title||"");if(a.length)return a[0];const r=(e.title||"").replace(/\s+/g," ").trim();if(!r)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const n=/^(.{2,72}?)[:–—|]/.exec(r);return n&&!ki.test(n[1].trim())?n[1].trim():(r.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||r).slice(0,72).trim()}function Ep({pageToken:e,onAddNames:a,onPanel:r}){const{t:n,lang:o,token:i,canWrite:d,flash:l}=J(),[s,f]=p.useState(null),[c,g]=p.useState(!1),[u,b]=p.useState({deals:[],news:[]}),[h,w]=p.useState({deals:!1,news:!1}),[v,m]=p.useState(null),[y,E]=p.useState(""),k=p.useCallback(async F=>{if(!i)return[];if(h[F])return u[F];m(F),E("");const x=Date.now(),A=await ks(vp[F],i,o),S=700-(Date.now()-x);return S>0&&await new Promise(P=>window.setTimeout(P,S)),m(null),!A.ok&&A.error?(E(A.error),[]):(b(P=>({...P,[F]:A.items})),w(P=>({...P,[F]:!0})),A.items)},[i,o,h,u]);p.useEffect(()=>{s&&k(s)},[s,k]);const j=p.useCallback(F=>u[F].map(uo).filter(Boolean),[u]),N=p.useMemo(()=>{var A,S;if(!i)return{deals:[],news:[]};const F={deals:j("deals"),news:j("news")},x=Ho("feed:"+i,F);return{deals:((A=x.deals)==null?void 0:A.noms)||[],news:((S=x.news)==null?void 0:S.noms)||[]}},[i,j]),z=p.useRef(null);p.useEffect(()=>{z.current&&!s&&i&&Vo("feed:"+i,{deals:j("deals"),news:j("news")}),z.current=s},[s,i,j]);const T=()=>{f(null),g(!1),r==null||r(!1)},L=F=>{const x=[],A=new Set,S=P=>{const U=P.trim();!U||A.has(U.toLowerCase())||(A.add(U.toLowerCase()),x.push(U))};F.forEach(P=>{mn(P)?Jn(P.title||"").forEach(S):S(mo(P))}),x.length&&(a(x),T(),l(n.feedSent(x.length)))},O=F=>{const x=mo(F);x&&(window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:x,url:(F.url||"").trim()}})),T(),l(n.feedPasted(x)),requestAnimationFrame(()=>{var A;(A=document.querySelector(".atl2 .eval-stick, .atl2 .demand"))==null||A.scrollIntoView({block:"center",behavior:"smooth"})}))},M=F=>{if(mn(F)){const x=(F.url||"").trim(),A=(F.title||"").trim();if(!x&&!A)return;window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:x,text:A,auto:!0}})),T(),l(n.feedExtracting);return}O(F)},W=F=>{f(x=>{const A=x===F?null:F;return A&&g(!1),r==null||r(!!A),A})},K=F=>{const x=u[F],A=new Set(N[F].map(P=>P.toLowerCase())),S=v===F||s===F&&!h[F]&&!y;return t.jsxs("div",{className:"dfpane"+(s===F?" on":"")+(c?" tall":""),hidden:s!==F,children:[t.jsxs("div",{className:"dfhow",children:[t.jsxs("div",{className:"dfhow-h",children:[t.jsx("p",{className:"dfh",children:F==="deals"?n.feedDealsH:n.feedNewsH}),t.jsxs("span",{className:"dfhow-acts",children:[t.jsx("button",{type:"button",className:"dffold",onClick:()=>g(P=>!P),children:c?n.feedShrink:n.feedExpand}),t.jsx("button",{type:"button",className:"dffold",onClick:T,children:n.feedFold})]})]}),t.jsx("p",{className:"dfh2",children:F==="deals"?n.feedDealsHow:n.feedNewsHow})]}),S&&t.jsxs("div",{className:"dfwait",role:"status","aria-live":"polite",children:[t.jsx("i",{className:"dfspin","aria-hidden":"true"}),t.jsxs("div",{children:[t.jsx("b",{children:F==="deals"?n.feedWaitDeals:n.feedWaitNews}),t.jsx("span",{className:"dfbar",children:t.jsx("i",{})})]})]}),s===F&&!!y&&t.jsx("p",{className:"dferr",children:y}),h[F]&&!x.length&&!v&&t.jsx("p",{className:"dfempty",children:F==="deals"?n.feedEmptyDeals:n.feedEmptyNews}),!!x.length&&!S&&t.jsxs(t.Fragment,{children:[F==="deals"&&d&&x.length>1&&t.jsxs("button",{type:"button",className:"dfall",onClick:()=>L(x),children:[n.feedPutAll," (",x.length,")"]}),t.jsx("ul",{className:"dflist",children:x.map((P,U)=>{const Q=uo(P),ne=A.has(Q.toLowerCase()),C=(P.url||"").trim();return t.jsxs("li",{className:ne?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:P.title||C}),t.jsx("span",{children:[P.source,P.sector_fr,(P.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[C&&t.jsx("a",{href:C,target:"_blank",rel:"noopener noreferrer",children:n.feedOpen}),d&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>M(P),children:mn(P)?n.rowExtract:n.feedPutEval})]})]},Q||U)})})]})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(F=>{const x=N[F].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(F==="deals"?"ddeals":"dnews")+(s===F?" on":"")+(v===F?" busy":""),title:F==="deals"?n.feedDealsH:n.feedNewsH,"aria-expanded":s===F,"aria-busy":v===F||void 0,onClick:()=>W(F),children:[v===F?o==="en"?"Loading…":"Chargement…":F==="deals"?n.feedDeals:n.feedNews,x>0&&v!==F&&t.jsx("em",{title:n.feedHint,children:n.feedNew(x)})]},F)}),s&&K(s)]})}function jp(e){return String(e||"").split(`
...
`)){const o=n.replace(/\s+$/,"");if(!o.trim()||o.trim()==="---"||/^\s*markmap:/.test(o)||/^\s+\w+:/.test(o))continue;const i=/^(#+)\s+(.*)/.exec(o);if(i){const c={title:fo(i[2]),kids:[]};a.push(c),r.length=0,r.push({indent:-1,node:c});continue}const d=/^(\s*)[-*+]\s+(.*)/.exec(o);if(!d)continue;const l=d[1].replace(/\t/g,"  ").length,s={title:fo(d[2]),kids:[]};for(;r.length&&r[r.length-1].indent>=l;)r.pop();const f=r.length?r[r.length-1].node:null;f?f.kids.push(s):a.push(s),r.push({indent:l,node:s})}return a}function ji({nodes:e,depth:a=0}){return e.length?t.jsx("ul",{className:"rscats"+(a?" nested":""),children:e.map((r,n)=>t.jsx("li",{children:r.kids.length?t.jsxs("details",{open:a<1,children:[t.jsx("summary",{children:r.title}),t.jsx(ji,{nodes:r.kids,depth:a+1})]}):t.jsx("span",{children:r.title})},n))}):null}const Sp=["https://cdn.jsdelivr.net/npm/d3@7/dist/d3.min.js","https://cdn.jsdelivr.net/npm/markmap-lib@0.18/dist/browser/index.iife.js","https://cdn.jsdelivr.net/npm/markmap-view@0.18/dist/browser/index.js"];function Cp(e){return new Promise((a,r)=>{if(document.querySelector(`script[src="${e}"]`)){a();return}const n=document.createElement("script");n.src=e,n.onload=()=>a(),n.onerror=()=>r(new Error(e)),document.head.appendChild(n)})}function zp({md:e,png:a,alt:r}){const{t:n}=J(),o=p.useRef(null),[i,d]=p.useState(!1),l=Np(e||"");return p.useEffect(()=>{const s=(e||"").trim();if(!s||!o.current)return;let f=!1;return Sp.reduce((c,g)=>c.then(()=>Cp(g)),Promise.resolve()).then(()=>{if(f||!o.current)return;const c=window.markmap;if(!(c!=null&&c.Transformer)||!c.Markmap)return;const{root:g}=new c.Transformer().transform(s);o.current.innerHTML='<svg class="rs-mm-svg"></svg>';const u=o.current.querySelector("svg");u&&(c.Markmap.create(u,{initialExpandLevel:2,maxWidth:280,duration:180},g),d(!0))}).catch(()=>{}),()=>{f=!0}},[e]),!e&&!a&&!l.length?null:t.jsxs("section",{className:"rslive",children:[t.jsxs("div",{className:"rslive-h",children:[t.jsxs("b",{children:["🗺 ",n.rsMindmap]}),t.jsx("span",{children:n.rsMmTip})]}),t.jsxs("div",{className:"rslive-grid",children:[t.jsxs("div",{className:"rslive-map",children:[e?t.jsx("div",{className:"rs-mm-host",ref:o}):null,!i&&a&&t.jsx("figure",{className:"rsmm",children:t.jsx("img",{src:`data:image/png;base64,${a}`,alt:r})})]}),l.length>0&&t.jsxs("nav",{className:"rslive-cats","aria-label":n.rsMmCats,children:[t.jsx("b",{children:n.rsMmCats}),t.jsx(ji,{nodes:l})]})]})]})}function Ap(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function ho({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=J();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function qp({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=J(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(ho,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(ho,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Ni({card:e,onEvaluate:a,onAddAll:r}){var s,f,c;const{t:n}=J(),o=[e.industry,...e.market_tags||[],e.author].map(g=>(g||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(g=>g&&g.url),l=jp(e.summary_md||"");return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(g=>t.jsx("span",{children:g},g))]}),t.jsx(zp,{md:e.mindmap_md,png:e.mindmap_png_b64,alt:n.rsMindmap}),l.length>0&&t.jsxs("article",{className:"rsart",children:[t.jsx("b",{children:n.rsArticle}),l.map((g,u)=>t.jsx("p",{children:g},u))]}),t.jsx(qp,{card:e,onEvaluate:a,onAddAll:r}),(((f=e.prospective)==null?void 0:f.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((c=e.prospective)==null?void 0:c.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(g=>t.jsx("li",{children:g},g))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(g=>t.jsx("a",{href:g.url,target:"_blank",rel:"noopener noreferrer",children:g.label||g.url},g.url))})]})]})}function Tp(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Lp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=J(),l=o,[s,f]=p.useState(null),[c,g]=p.useState(null),[u,b]=p.useState(null),[h,w]=p.useState(!1);p.useEffect(()=>{let m=!0;return(async()=>{const y=await Fo({email:d,cbToken:l});m&&f(y)})(),()=>{m=!1}},[d,l,n]);const v=m=>{g(m),b(null),w(!0),(async()=>{const y=await Es(m.id);b(y),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{g(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[Tp(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?i.rsPub:i.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),h&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!h&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!h&&u&&t.jsx(Ni,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Ma=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ca(e){return/^https?:\/\//i.test((e||"").trim())}function ht(e){const a=(e||"").trim();return a?ca(a)?a:Ma.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Fp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Rp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:f,caps:c,data:g,canWrite:u,source:b,dossiers:h,doAnalyse:w,liveMemos:v,pipe:m}=J(),y=r==="client",E=p.useMemo(()=>n||(b!=="default"?js():""),[n,b]),[k,j]=p.useState(""),[N,z]=p.useState(!1),[T,L]=p.useState(""),[O,M]=p.useState(""),[W,K]=p.useState(""),[F,x]=p.useState(!1),[A,S]=p.useState(!1),[P,U]=p.useState([]);p.useEffect(()=>{const I=ae=>{const V=ae.detail;V&&U(pe=>[V,...pe].slice(0,8))};return window.addEventListener("ppmap:evalcard",I),()=>window.removeEventListener("ppmap:evalcard",I)},[]);const[Q,ne]=p.useState(!1),[C,B]=p.useState(!1),[D,Z]=p.useState(!1),$=p.useRef(!1),[oe,me]=p.useState(""),[xe,ye]=p.useState(""),[ce,Ce]=p.useState(!1),[Ae,ue]=p.useState(!1),[ve,ke]=p.useState(0),[ee,_]=p.useState(""),[re,se]=p.useState(null),[le,fe]=p.useState(null),[H,de]=p.useState(!1),[we,Ee]=p.useState(null),[je,be]=p.useState(0),Be=p.useRef(!1),et=p.useRef(()=>{}),ut=k.trim()?Ma.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const I=new URLSearchParams(window.location.search),ae=(I.get("rs")||"").trim(),V=(I.get("rstext")||"").trim();ae&&/^https?:\/\//i.test(ae)&&me(ae),V&&ye(V),(ae&&/^https?:\/\//i.test(ae)||V)&&ne(!0)},[]),p.useEffect(()=>{const I=ae=>{const V=ae.detail||{},pe=String(V.url||"").trim(),Se=String(V.text||"").trim(),he=pe&&/^https?:\/\//i.test(pe)?pe:"";he&&me(he),Se&&ye(Se),(he||Se)&&(ne(!0),j(""),L(""),_(""),B(!1),Ce(!0),window.setTimeout(()=>Ce(!1),900),V.auto&&window.setTimeout(()=>{et.current({url:he,text:Se})},0))};return window.addEventListener("ppmap:research",I),()=>window.removeEventListener("ppmap:research",I)},[]),p.useEffect(()=>{const I=ae=>{const V=ae.detail||{},pe=String(V.name||"").trim();if(!pe)return;ne(!1),j(pe),L(pe);const Se=ht(String(V.website||V.domain||""));M(Se),K(ht(String(V.url||""))),x(!Se),z(!0),window.setTimeout(()=>z(!1),900)};return window.addEventListener("ppmap:prefill",I),()=>window.removeEventListener("ppmap:prefill",I)},[]),p.useEffect(()=>{const I=(T||"").trim();if(!I||Q||O){(O||!I||Q)&&x(!1);return}const ae=Ge(I),V=h.find(Ne=>Ge(Ne.name)===ae)||h.find(Ne=>{const Re=Ge(Ne.name);return Re.length>=3&&(ae.includes(Re)||Re.includes(ae))}),pe=ht((V==null?void 0:V.website)||"")||ht((V==null?void 0:V.domain)||""),Se=ht((V==null?void 0:V.url)||"");if(Se&&K(Ne=>Ne||Se),pe){M(pe),x(!1);return}let he=!0;return x(!0),Hn(I).then(Ne=>{var Qe,mt;if(!he)return;const Re=ht(Ne.website||"")||ht(((mt=(Qe=Ne.candidates)==null?void 0:Qe[0])==null?void 0:mt.url)||"");Re&&M(Re)}).catch(()=>{}).finally(()=>{he&&x(!1)}),()=>{he=!1}},[T,Q,O,h]),p.useEffect(()=>{const I=ae=>{var pe;const V=String(((pe=ae.detail)==null?void 0:pe.url)||"").trim();ca(V)&&window.open(V,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",I),()=>window.removeEventListener("ppmap:view",I)},[]),p.useEffect(()=>{if($.current===Q)return;$.current=Q,Z(!0);const I=window.setTimeout(()=>Z(!1),560);return()=>window.clearTimeout(I)},[Q]),p.useEffect(()=>{if(typeof window>"u")return;const I=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ae=document.querySelector(".atl2.ops, .atl2.cibles");if(!I||!ae)return;const V=ae.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,pe=()=>{const he=parseFloat(window.getComputedStyle(I).top)||0,Ne=I.getBoundingClientRect().top<=he+1;I.classList.toggle("is-stuck",Ne),ae.classList.toggle("url-stuck",Ne);const Re=Math.round(I.getBoundingClientRect().height);ae.style.setProperty("--demand-h",`${Re}px`);const Qe=window.matchMedia("(min-width: 861px)").matches;V&&Qe?ae.style.setProperty("--pp-live-h",`${Math.round(V.getBoundingClientRect().height)}px`):ae.classList.contains("cibles")&&ae.style.setProperty("--pp-live-h","0px")};pe();const Se=new ResizeObserver(pe);return Se.observe(I),V&&Se.observe(V),window.addEventListener("scroll",pe,!0),window.addEventListener("resize",pe),()=>{Se.disconnect(),I.classList.remove("is-stuck"),ae.classList.remove("url-stuck"),window.removeEventListener("scroll",pe,!0),window.removeEventListener("resize",pe)}},[b,N,ce,A,Q,D,F]),p.useEffect(()=>{if(!u&&!E){Ee(null);return}let I=!0;return(async()=>{const ae=await Fo({email:o,cbToken:E});I&&Ee(ae.length)})(),()=>{I=!1}},[u,E,o,je]);const Fe=P.length?P:f,Ve=g.credits,wt=p.useCallback(I=>{const ae=gp(n,I);return S(!1),l({type:"ptab",tab:0}),requestAnimationFrame(()=>{const V=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!V)return;const pe=window.scrollY+V.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,pe),behavior:"smooth"})}),ae},[n,l]);p.useEffect(()=>{if(!Ae)return;ke(0);const I=window.setInterval(()=>ke(ae=>ae+1),1e3);return()=>window.clearInterval(I)},[Ae]);const Ue=p.useMemo(()=>{const I=k.trim().toLowerCase();return!I||!m?null:h.find(ae=>Ge(ae.name)===I&&Te(ae)===1)||null},[k,h,m]),ot=()=>{const I=k.trim();if(I){if(Ue){w(Ue);return}i(null,I),y&&j("")}},Rt=(I,ae,V,pe)=>{const Se=V.length?V:ae,he=wt(Se)||0;xp({title:(I.title||"").trim(),url:(I.source_url||"").trim(),cited:ae,match:V,added:he,fallback:pe})},yt=async I=>{var pe,Se,he;if(Be.current)return;const ae=((I==null?void 0:I.url)??oe).trim().replace(/\s+/g,""),V=((I==null?void 0:I.text)??xe).trim();if(!ae&&!V){_(e.rsNeed);return}if(!y&&!E){i(null,ae||V.slice(0,80));return}Be.current=!0,_(""),se(null),fe(null),ue(!0);try{const Ne=await Ss({url:ae,text:V,email:o,cbToken:E});ue(!1);const Re=st=>(st||[]).map(At=>((At==null?void 0:At.name)||"").trim()).filter(Ei);if(!Ne||Ne.status!=="success"){const st=Jn(V||(Ne==null?void 0:Ne.title)||"");if(st.length){const At={status:"success",title:V||ae,source_url:ae,summary_md:e.rsNoteFallback,companies_cited:st.map(aa=>({name:aa})),prospective:{companies_to_evaluate:st.map(aa=>({name:aa}))}};_(""),se(At),ne(!1),Rt(At,st,st,!0);return}se(null),B(!0),_((Ne!=null&&Ne.message?Ne.message+" — ":"")+e.rsNoteNone);return}se(Ne),ne(!1);const Qe=Re(Ne.companies_cited),mt=Re((pe=Ne.prospective)==null?void 0:pe.companies_to_evaluate);Rt(Ne,Qe,mt,!1),fe({state:"pending"});const $e=await Cs(Ne,{email:o,cbToken:E});fe($e.ok?{state:"ok",scopeLabel:((Se=$e.summary)==null?void 0:Se.scope_label)||"",scope:((he=$e.summary)==null?void 0:he.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&be(st=>st+1)}finally{Be.current=!1,ue(!1)}};et.current=I=>{yt(I)};const Ct=(le==null?void 0:le.state)==="pending",Ot=()=>{de(!0),requestAnimationFrame(()=>{var I;(I=document.querySelector(".atl2 .rsarch"))==null||I.scrollIntoView({block:"nearest",behavior:"smooth"})})},Mt=le&&(Ct?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):le.state==="ok"?t.jsxs("button",{type:"button",className:"rslink ok",onClick:Ot,children:[le.scope&&le.scope!=="public"?e.rsSavedIn(le.scopeLabel||le.scope.replace(/^fund:/,"")):e.rsSaved," ",e.rsSavedOpen]}):t.jsx("span",{className:"rslink fail",title:le.msg,children:e.rsSaveFail})),kt=Ap(re).length,Pe=Q,it=(T||k).trim(),tt=h.find(I=>Ge(I.name)===Ge(it)),zt=ht(k)||O||ht((tt==null?void 0:tt.website)||"")||ht((tt==null?void 0:tt.domain)||""),R=W||ht((tt==null?void 0:tt.url)||""),G=Ue?e.actAnalyse:it?e.evalGoOn(it.length>22?it.slice(0,21)+"…":it):e.evalGo,te=Ae?`${Ns(oe.trim())==="youtube"&&oe.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ve)}`:Ct?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Pe?" rs-mode":"")+(T&&k.trim()===T||N||ce?" pair":"")+(N||ce||D?" echo":"")+(D?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:Pe?a==="en"?"Extract companies from an article":"Extraire les sociétés d’un article":a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:Pe?a==="en"?"Paste an article or video URL — Stan lists the companies, then you pick which ones to screen.":"Collez l’URL d’un article ou d’une vidéo — Stan en sort les sociétés, vous choisissez lesquelles évaluer.":a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Pe?ce:N)||D?" flash":"")+((Pe?oe.trim():Ma.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Pe?oe:k,placeholder:Pe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Pe?600:200,spellCheck:Pe?!1:void 0,inputMode:Pe?"url":void 0,onChange:I=>{if(Pe){me(I.target.value);return}j(I.target.value),T&&I.target.value.trim()!==T&&(L(""),M(""),K(""),x(!1))},onKeyDown:I=>{I.key==="Enter"&&(Pe?yt():ot())}}),t.jsx("span",{className:"detect"+(Pe?" off":"")+(Ma.test(k.trim())?" url":""),children:ut})]}),t.jsx("span",{className:"dacts",children:Pe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Ae?" loading":""),disabled:Ae||Ct||!oe.trim()&&!xe.trim(),onClick:()=>{yt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:te})]}),t.jsxs("a",{className:"viewbtn"+(ca(oe)?"":" off"),href:ca(oe)?oe.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:I=>{ca(oe)||I.preventDefault()},children:[t.jsx(Fp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(Za,{lang:a,storeKey:((Ue==null?void 0:Ue.name)||k).trim(),className:"evalbtn"+(Ue?" analyse":"")+(s?" loading":""),disabled:s,confirmLabel:G,onConfirm:ot,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:G})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(F?" searching":zt?"":" off"),href:zt||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:I=>{zt||I.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite,!F&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(R?"":" off"),href:R||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:I=>{R||I.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),c.showCredits&&Ve&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(Ve.total_available<=0&&!Ve.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Ve.unlimited?"∞":Ve.total_available}),!Ve.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Ve.daily_grant+Ve.purchased]}),Ve.total_available<=0&&!Ve.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),S(!1),requestAnimationFrame(()=>{const I=document.querySelector(".atl2.cibles .desk-list");if(!I)return;const ae=window.scrollY+I.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,ae),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(Q?" on":""),title:e.rsOpenHint,onClick:()=>ne(!Q),children:e.rsOpen}),we!==null&&we>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(H?" on":""),onClick:()=>{H?de(!1):Ot()},children:e.rsArchOpen(we)}),c.pipe&&!!n&&t.jsx(Ep,{pageToken:E,onAddNames:wt,onPanel:()=>{B(!1)}})]}),H&&t.jsx(Lp,{bump:je,cbToken:E,onClose:()=>de(!1),onEvaluate:I=>i(null,I),onAddAll:wt}),t.jsx("div",{className:"rsp slim"+(Q?" on":" off"),"aria-hidden":!Q,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:Q?void 0:-1,onClick:()=>B(I=>!I),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:C?"▴":"▾"})]}),t.jsx("button",{type:"button",className:"dffold",tabIndex:Q?void 0:-1,onClick:()=>{ne(!1),B(!1),_("")},children:e.feedFold}),C&&t.jsx("textarea",{className:"rstext",value:xe,placeholder:e.rsTextPh,tabIndex:Q?void 0:-1,onChange:I=>ye(I.target.value)})]})}),ee&&t.jsxs("div",{className:"rserr",children:[ee,t.jsx("button",{type:"button",className:"eq-note-x",title:e.rsClose,onClick:()=>_(""),children:"×"})]}),re&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:re.title}),re.source_url&&t.jsx("a",{href:re.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{se(null),fe(null)},children:"×"})]}),t.jsx(Ni,{card:re,onEvaluate:I=>i(null,I),onAddAll:wt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(kt)}),Mt]})]}),Fe.slice(0,1).map((I,ae)=>{const V=I.verdict==="kept",pe=I.verdict==="quota",Se=I.verdict==="unresolved",he=V?"var(--brand)":pe?"var(--bolt)":Se?"var(--blue)":"var(--red)",Ne=V?"var(--brand-l)":pe?"#FFF3D6":Se?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":he,"--bgc":Ne},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:V?"✓ "+e.kept:pe?"⏳":Se?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),I.name&&t.jsx("span",{className:"rn",children:I.name}),t.jsx("span",{className:"rr",children:I.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",I.reason]}):null}),!!(I.candidates&&I.candidates.length)&&t.jsx("span",{className:"sitepick",children:I.candidates.map(Re=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Re.url.startsWith("http")?Re.url:`https://${Re.url}`,target:"_blank",rel:"nofollow noopener",children:[(Re.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Re.url,I.name),children:e.evalPickGo})]},Re.url))}),!pe&&!Se&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:V?1:5});const Re=(I.name||"").trim().toLowerCase();window.setTimeout(()=>{const Qe=[...document.querySelectorAll(".atl2 .list .row")].find(mt=>{var $e;return((($e=mt.querySelector(".rnm"))==null?void 0:$e.textContent)||"").trim().toLowerCase().includes(Re)});Qe&&(Qe.scrollIntoView({behavior:"smooth",block:"center"}),Qe.classList.add("flashrow"),window.setTimeout(()=>Qe.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(V?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ae)}),y&&(d.kept+d.dropped>0||Fe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Op(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Mp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=J(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",Op(i.summary||"")].filter(Boolean).join(`

`):"",[i]);if(!i)return null;const l=Ft(i),s=$n(i);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:i.name}),l&&t.jsx("span",{className:"vv",children:l}),typeof i.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[i.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:d?d.split(`

`).map((f,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Yt(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:s===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Xn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=J(),[d,l]=p.useState(!1),[s,f]=p.useState(null),c=n.pipe&&o==="client"&&!n.lockActions,g=async()=>{if(!c||d)return;l(!0);const u=await Lo(r,e);if(l(!1),!u){i(a.actErr);return}f(u.results||[])};return p.useEffect(()=>{if(!c)return;const u=b=>{var w;const h=String(((w=b.detail)==null?void 0:w.name)||"").trim();h&&h.toLowerCase()===e.toLowerCase()&&g()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,c]),p.useEffect(()=>{if(c)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),g())}catch{}},[e,c]),c?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:d,onClick:()=>{g()},children:d?a.similarBusy:a.similar}),s&&(s.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:s.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Dp=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ta=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ba(e){const a=(e||"").trim();return a?/^https?:\/\//i.test(a)?a:/^[a-z][a-z0-9+.-]*:/i.test(a)?"":`https://${a.replace(/^\/+/,"")}`:""}function Bn(e){const a=ba(e);if(!a)return"";try{return new URL(a).hostname.replace(/^www\./,"")}catch{return""}}function Ip(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=Ta(a.slice(n));break}r+=Ta(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=Ta(a.slice(o));break}const d=a.slice(o+1,i).trim(),l=/^(\/?)([a-zA-Z0-9]+)/.exec(d),s=l?l[2].toLowerCase():"";l&&Dp.has(s)?r+=`<${l[1]}${s}>`:r+=Ta(a.slice(o,i+1)),n=i+1}return r}const Pp=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),go={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Si(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(Pp.has(o)){n.remove();continue}for(const d of Array.from(n.attributes)){const l=d.name.toLowerCase();(!(go["*"].has(l)||((r=go[o])==null?void 0:r.has(l)))||l.startsWith("on"))&&n.removeAttribute(d.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const d=i.split(";").filter(l=>l.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(l)).join(";");d!==i&&(d?n.setAttribute("style",d):n.removeAttribute("style"))}if(o==="a"){const d=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(d)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const d=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(d)){n.remove();continue}n.setAttribute("loading","lazy")}Si(n)}}function Da(e){const a=e.cloneNode(!0);return Si(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const _p={swot:null,summary:"",syn:"",pnl:"",cf:"",roi:"",reco:"",plan:"",pruned:[]},Bp=/chiffre|revenu|revenue|\barr\b|ebitda|marge|gross|fcf|free cash|net|total|r[ée]sultat|cash|capex|nopat|moic|irr|\btri\b|roi|entry|\bev\b|invested|synerg/i,$p=[["syn",/synerg/i],["pnl",/compte de r[ée]sultat|p\s*&\s*l|profit\s*(?:and|&)\s*loss|income statement/i],["cf",/flux de tr[ée]sorerie|cash\s*-?\s*flow/i],["roi",/\broi\b|return on investment|retour sur investissement/i],["reco",/verdict post|post[- ]model verdict|conviction quantitative/i]];function Ut(e){return String(e||"").replace(/<script[\s\S]*?<\/script>/gi," ").replace(/<style[\s\S]*?<\/style>/gi," ").replace(/<[^>]+>/g," ").replace(/&nbsp;/gi," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#39;|&apos;/g,"'").replace(/&quot;/g,'"').replace(/\s+/g," ").trim()}function Ci(e,a){const r=e.slice(a),n=/<div\b|<\/div\s*>/gi;let o=0,i;for(;i=n.exec(r);)if(i[0][1]!=="/")o+=1;else if(o-=1,o===0)return e.slice(a,a+i.index+i[0].length);return""}function fn(e,a){const n=new RegExp(`<div\\b[^>]*\\bid="${a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"`,"i").exec(e);return n?Ci(e,n.index):""}function Up(e,a=14){const r=e.match(/<tr\b[\s\S]*?<\/tr\s*>/gi)||[];if(r.length<=a)return{html:e,pruned:!1};const n=[];for(let d=0;d<r.length-1;d+=1){const l=r[d],s=/<t[dh]\b[^>]*>([\s\S]*?)<\/t[dh]\s*>/i.exec(l),f=s?Ut(s[1]):"";if((d<2||/<th/i.test(l)||Bp.test(f))&&n.push(l),n.length>=a-1)break}n.push(r[r.length-1]);const o=n.length<3?r.slice(0,a):n;return{html:(/^\s*<table\b[^>]*>/i.exec(e)||["<table>"])[0]+o.join("")+"</table>",pruned:!0}}function Hp(e,a=14){let r=!1;return{html:e.replace(/<table\b[\s\S]*?<\/table\s*>/gi,o=>{const i=Up(o,a);return r=r||i.pruned,i.html}),pruned:r}}function Vp(e){const a={s:[],w:[],o:[],t:[]},r=[["s","s-green"],["w","s-red"],["o","s-blue"],["t","s-orange"]];for(const[n,o]of r){const i=new RegExp(`<div\\b[^>]*class="[^"]*swot-item[^"]*\\b${o}\\b[^"]*"`,"i").exec(e);if(!i)return null;const d=Ci(e,i.index);let l=(d.match(/<li\b[^>]*>([\s\S]*?)<\/li\s*>/gi)||[]).map(s=>Ut(s));if(!l.length){const s=/<p\b[^>]*>([\s\S]*?)<\/p\s*>/i.exec(d);s&&(l=[Ut(s[1])])}if(l=l.filter(s=>s&&!/not available/i.test(s)&&!/non disponible/i.test(s)).map(s=>s.slice(0,260)).slice(0,4),!l.length)return null;a[n]=l}return a}function Wp(e){const a=e.search(/id=["']company-summary["']/i);if(a<0)return"";const r=e.slice(a,a+9e3),n=/(?:EN R[ÉE]SUM[ÉE]|EN QUELQUES MOTS|IN SUMMARY|IN A FEW WORDS|IN A NUTSHELL|TL;DR)[\s:]*(?:<\/?span[^>]*>[\s:]*)*([\s\S]+?)(?=<br|<hr|<\/div|<h[23]|⚠|✅|🚀|❓|$)/i.exec(r);return n?Ut(n[1]).slice(0,600):""}function Gp(e,a,r){if(r<0)return"";const n=/<h3\b[^>]*>([\s\S]*?)<\/h3\s*>/gi;n.lastIndex=r;let o;for(;o=n.exec(e);){if(!a.test(Ut(o[1])))continue;const i=/<h3\b[^>]*>/i.exec(e.slice(o.index+o[0].length));return i?e.slice(o.index,o.index+o[0].length+i.index):e.slice(o.index,Math.min(e.length,o.index+o[0].length+6e4))}return""}function xo(e){let a=e.replace(/^\s*<div\b[^>]*>/i,"").replace(/<\/div\s*>\s*$/i,"");return a=a.replace(/<h2\b[^>]*class="[^"]*section-title[^"]*"[^>]*>[\s\S]*?<\/h2\s*>/gi,""),a=a.replace(/<details\b[\s\S]*?<\/details\s*>/gi,""),a.trim()}function hn(e,a){if(e.length<=a)return e;const r=e.slice(0,a),n=r.lastIndexOf(">");return n>=0?r.slice(0,n+1):r}function Yp(e){const a={..._p,pruned:[]};if(!e)return a;try{const n=fn(e,"swot");n&&(a.swot=Vp(n))}catch{}try{a.summary=Wp(e)}catch{}try{const n=fn(e,"action-plan");if(n){const o=xo(n);a.plan=hn(o,12e3)}}catch{}const r=e.search(/id=["']financial-forecast["']/i);for(const[n,o]of $p)try{let i=Gp(e,o,r);if(!i)continue;const d=Hp(i);i=hn(d.html,45e3),Ut(i)&&(a[n]=i,d.pruned&&a.pruned.push(n))}catch{}if(!a.reco)try{const n=fn(e,"conviction");if(n){const o=hn(xo(n),8e3);Ut(o)&&(a.reco=o)}}catch{}return a}function Qp(e){return e?!!(e.swot||e.summary||e.syn||e.pnl||e.cf||e.roi||e.reco||e.plan):!1}const gn=new Map;function zi(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=gn.get(a);return r||(r=Kp(a).catch(()=>null),r.then(n=>{n||gn.delete(a)}),gn.set(a,r)),r}async function Kp(e){var u,b;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=await a.text(),n=new DOMParser().parseFromString(r,"text/html"),o=h=>{var w;return(((w=n.querySelector(h))==null?void 0:w.textContent)||"").trim()},i=n.querySelector(".sb-score"),d=((u=Array.from((i==null?void 0:i.classList)||[]).find(h=>h.startsWith("sb-score-")))==null?void 0:u.slice(9))||"",l=[];let s=null;const f=Array.from(n.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const h of f){if(h.classList.contains("sb-nav-heading")){s={label:(h.textContent||"").trim(),items:[]},l.push(s);continue}const w=h.getAttribute("href")||"";if(!w.startsWith("#"))continue;const v=w.slice(1),m=Xp(n,v);m&&(s||(s={label:"",items:[]},l.push(s)),s.items.push({id:v,title:(h.textContent||"").trim(),html:m,poids:m.length}))}const c=((b=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:b[1])||"",g={score:o(".sb-score"),scoreTone:d,tags:Array.from(n.querySelectorAll(".sb-tag")).map(h=>(h.textContent||"").trim()).filter(Boolean),name:o(".sidebar-company-name"),tagline:o(".sidebar-tagline"),desc:o(".meta-desc"),groups:l.filter(h=>h.items.length),mindmapSlug:n.querySelector(".cm-mindmap-png")?c:"",comite:Jp(n,Yp(r))};return g.groups.length?g:null}function Jp(e,a){const r=n=>{if(!n)return"";const o=e.createElement("div");return o.innerHTML=n,Da(o)};return{...a,syn:r(a.syn),pnl:r(a.pnl),cf:r(a.cf),roi:r(a.roi),reco:r(a.reco),plan:r(a.plan)}}const bo={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Xp(e,a){const r=e.getElementById(a),n=r?vo(e,r):"";if(n)return n;const o=bo[a]?e.querySelector(bo[a]):null;return o&&o!==r?vo(e,o):""}function vo(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Da(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(s=>/^h3$/i.test(s.tagName))[0]===a)for(const s of i){if(s===a)break;/^h2$/i.test(s.tagName)||o.appendChild(s.cloneNode(!0))}let l=a.nextElementSibling;for(;l&&!/^h3$/i.test(l.tagName);)o.appendChild(l.cloneNode(!0)),l=l.nextElementSibling;return o.children.length?Da(o):""}return Da(a)}const xn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Je({k:e,v:a,href:r,wide:n}){return a==null||a===""?null:t.jsxs("div",{className:"cdl"+(n?" cdw":""),children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Zp({k:e,vals:a}){const r=(a||[]).filter(Boolean);return r.length?t.jsxs("div",{className:"cdl cdw",children:[t.jsx("span",{className:"cdk",children:e}),t.jsx("span",{className:"cdtags",children:r.map(n=>t.jsx("span",{className:"cdtag",children:n},n))})]}):null}function wo(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function yo({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const bn=new Map;function ec(e,a){const{token:r}=J(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let d=bn.get(i);d||(d=zs(r,e.name,e.checkId),bn.set(i,d),d.then(s=>{(!s||!s.reasoning&&!s.summaryHtml)&&bn.delete(i)}));let l=!0;return d.then(s=>{l&&s&&o({id:e.id,d:s})}),()=>{l=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const tc=6e4;function ac({o:e}){const{t:a,doDeep:r}=J(),[n,o]=p.useState(null),[i,d]=p.useState(e.memoUrl?"load":"off"),[l,s]=p.useState(()=>new Set),[f,c]=p.useState(!1),g=p.useRef(new Map);p.useEffect(()=>{let w=!0;if(s(new Set),c(!1),g.current=new Map,!e.memoUrl){d("off"),o(null);return}return d("load"),o(null),zi(e.memoUrl).then(v=>{w&&(o(v),d(v?"ok":"err"))}),()=>{w=!1}},[e.memoUrl]);const u=Ft(e),b=w=>{var v;return(v=g.current.get(w))==null?void 0:v.scrollIntoView({behavior:"smooth",block:"start"})},h=t.jsxs("div",{className:"cdacts",children:[Yt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:w=>{w.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const w=[e.reasoning||"",wo(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[w.length?w.join(`

`).split(`

`).map((v,m)=>t.jsx("p",{className:"cdtxt",children:v},m)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),h]})}if(i!=="ok"){const w=[e.reasoning||"",wo(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),w.length>0&&w.join(`

`).split(`

`).map((v,m)=>t.jsx("p",{className:"cdtxt",children:v},m)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:v=>{v.stopPropagation(),c(m=>!m)},children:f?a.memoHideHere:a.memoReadHere})}),f&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:v=>v.stopPropagation()}),h,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:v=>v.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(w=>t.jsx("span",{className:"md-tag",children:w},w)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(w=>w.items.map(v=>t.jsx("button",{type:"button",className:"md-jump",onClick:m=>{m.stopPropagation(),b(v.id)},children:v.title},v.id)))}),n.groups.map((w,v)=>t.jsxs("div",{className:"md-grp",children:[w.label&&t.jsx("div",{className:"md-grp-h",children:w.label}),w.items.map(m=>{const y=m.poids>tc&&!l.has(m.id),E=m.id==="fiche-contact"||m.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&g.current.set(m.id,k)},children:[t.jsx("h4",{className:"md-h",children:m.title}),E&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),y?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),s(j=>new Set(j).add(m.id))},children:a.memoUnfold(Math.round(m.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:E?m.html.replace(/>\s*unavailable(\s+unavailable)*\s*</gi,"><"):m.html}}),!y&&n.mindmapSlug&&m.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${wa}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},m.id)})]},w.label||v)),h,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}function nc({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:d,lang:l}=J(),[s,f]=p.useState(!1),[c,g]=p.useState(!1),[u,b]=p.useState(!1),[h,w]=p.useState(null),[v,m]=p.useState(""),[y,E]=p.useState(null),[k,j]=p.useState(""),N={airtableId:e.airtableId,checkId:e.checkId},z=!!(e.airtableId||e.checkId),T=h&&h.id===e.id?h.entries:[],L=!!h&&h.id===e.id;if(p.useEffect(()=>{m(""),E(null),b(!1)},[e.id]),p.useEffect(()=>{if(!s||L||!z||!o)return;let M=!0;g(!0),b(!1);const W=e.id;return hr(r,"list",N).then(K=>{if(!(!M||W!==e.id)){if(g(!1),!K.ok){b(!0);return}w({id:W,entries:K.entries})}}),()=>{M=!1}},[s,L,z,r,e.id,o]),!n.pipe||!o||!z)return null;const O=(M,W)=>{g(!0);const K=e.id;hr(r,M,N,W).then(F=>{if(K===e.id){if(g(!1),!F.ok){d(a.notesErr);return}w({id:K,entries:F.entries}),b(!1),M==="add"&&(m(""),i(a.notesAdded)),M==="edit"&&E(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":s,onClick:M=>{M.stopPropagation(),f(W=>!W)},children:[t.jsx("b",{children:a.notesT}),T.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(T.length)}),t.jsx("i",{children:s?"▾":"▸"})]}),s&&t.jsxs("div",{className:"dn-b",onClick:M=>M.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),c&&!T.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!c&&!u&&L&&!T.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),T.map(M=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:l==="fr"?M.date.split("-").reverse().join("/"):M.date}),y===M.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:W=>j(W.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||!k.trim(),onClick:()=>O("edit",{entryId:M.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>E(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:M.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{E(M.id),j(M.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:c,onClick:()=>{window.confirm(a.notesDelAsk)&&O("delete",{entryId:M.id})},children:a.notesDel})]})]})]},M.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:v,onChange:M=>m(M.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:c||!v.trim(),onClick:()=>O("add",{text:v.trim()}),children:a.notesAdd})]})]})]})}function Zn({o:e}){var j;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:d}=J(),l=ya(e),s=Ft(e),f=(e.cribleStatus||"").trim().toUpperCase()||(l==="NO MATCH"?"NO MATCH":l==="MATCH"?"MATCH":""),c=[e.sector,e.market,(e.tags||[]).filter(Boolean).length?"1":"",e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.provQuery,Bn(e.provUrl||""),Pa(e),e.date].filter(Boolean).length,g=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,u=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(f?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||Yt(e)?1:0},{k:"soc",lib:a.cdSociete,n:c},{k:"ctc",lib:a.cdContact,n:g},{k:"suivi",lib:a.cdSuivi,n:u}].filter(N=>N.n>0),[e,a,o,f,s,c,g,u]),[h,w]=p.useState(""),v=b.some(N=>N.k===h)?h:((j=b[0])==null?void 0:j.k)||"";p.useEffect(()=>{const N=z=>{var L;const T=String(((L=z.detail)==null?void 0:L.tab)||"");T&&b.some(O=>O.k===T)&&w(T)};return window.addEventListener("ppmap:card-tab",N),()=>window.removeEventListener("ppmap:card-tab",N)},[b]);const m=ec(e,v==="eval"||v==="conv");if(!b.length)return null;const y=((m==null?void 0:m.reasoning)||"").length>(e.reasoning||"").length?m.reasoning:e.reasoning||"",E=((m==null?void 0:m.summaryHtml)||"").length>(e.summary||"").length?m.summaryHtml:e.summary||"",k=(m==null?void 0:m.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(N=>t.jsx("button",{type:"button",role:"tab","aria-selected":v===N.k,"data-tour":"tab-"+N.k,className:v===N.k?"on":"",onClick:z=>{z.stopPropagation(),w(N.k)},children:N.lib},N.k))}),t.jsxs("div",{className:"cdbody",onClick:N=>N.stopPropagation(),children:[v==="eval"&&t.jsxs(t.Fragment,{children:[f&&t.jsxs("div",{className:"cdv1"+(f==="NO MATCH"?" out":""),children:[t.jsx("b",{children:f==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(yo,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),y&&y.split(`

`).map((N,z)=>t.jsx("p",{className:"cdtxt",children:N},z)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(rc,{o:e})]}),v==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(yo,{v:k,sur:100,k:a.cdConvScore}),xn(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",xn(e.verdictDate,r)]})]}),E&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Ip(E)}})]}),v==="memo"&&t.jsx(ac,{o:e}),v==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Je,{k:a.cdSector,v:e.sector}),t.jsx(Je,{k:a.cdMarket,v:e.market,wide:!0}),t.jsx(Zp,{k:a.cdTags,vals:e.tags}),t.jsx(Je,{k:a.cdStage,v:e.stage}),t.jsx(Je,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Je,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Je,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Je,{k:a.cdAngle,v:e.angle}),t.jsx(Je,{k:a.cdDetected,v:xn(e.date,r)}),t.jsx(Je,{k:a.cdQuery,v:e.provQuery,wide:!0}),t.jsx(Je,{k:a.cdSrc,v:Bn(e.provUrl||""),href:ba(e.provUrl||"")}),t.jsx(Je,{k:a.cdAngleSrc,v:Pa(e)})]}),v==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Je,{k:a.cdName,v:e.contactName}),t.jsx(Je,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Je,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(Je,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),v==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(Je,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx(nc,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(e),children:a.actRegen})]})]})]})]})}const La=new Map;function rc({o:e}){const{t:a,token:r}=J(),[n,o]=p.useState(!1),[i,d]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const g=`${r}:${e.name.toLowerCase()}`;let u=La.get(g);u||(u=Ro(r,[e.name]).then(h=>h[e.name]||Object.values(h)[0]||null).catch(()=>null),La.set(g,u),u.then(h=>{(!h||!h.ok)&&La.delete(g)}));let b=!0;return u.then(h=>{b&&h&&h.ok&&d(h)}),()=>{b=!1}},[r,e.id,e.name]);const l=async()=>{if(n)return;o(!0);const g=await qo(r,e.name,e.website||e.domain||"");d(g),g.ok&&La.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(g)),o(!1)},s=(i==null?void 0:i.blocs)||{},f=[[a.qaVP,s.value_prop],[a.qaProduct,s.produit],[a.qaModel,s.modele],[a.qaSummary,s.synthese]],c=f.some(([,g])=>g);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{l()},children:n?a.qaBusy:a.qaRun})]}),i&&c&&t.jsxs(t.Fragment,{children:[f.filter(([,g])=>g).map(([g,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:g}),t.jsx("p",{children:u})]},g)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!c&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function ta({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let d=!1;const l=()=>{const f=Math.max(280,Math.min(560,i.clientWidth||320));gr({kind:"op",card:e},f).then(c=>{!d&&c&&i.isConnected&&i.replaceChildren(c)})},s=window.requestAnimationFrame(l);return()=>{d=!0,window.cancelAnimationFrame(s),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let d=!1;gr({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(s=>{!d&&s&&i.isConnected&&i.replaceChildren(s)});const l=s=>{s.key==="Escape"&&o(!1)};return document.addEventListener("keydown",l),()=>{d=!0,document.removeEventListener("keydown",l)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const oc=`
...
`;function ic(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,d=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let l=e.y+10;return l+n>i-8&&(l=Math.max(8,e.y-n-14)),l<8&&(l=8),{left:d,top:l}}function sc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:d,askEvaluate:l,doAnalyse:s,doDecide:f,doPromote:c,doRepeche:g,doApproach:u,doDeep:b,doOnboard:h,outbound:w,evalBusy:v}=J(),m=e.popupId?r.get(e.popupId):null;if(!m)return null;const y=He(m),E=Te(m),k=Ft(m),j=ya(m),N=m.kind==="target",z=T=>{a({type:"filters",patch:T}),a({type:"popup",id:null})};return Zt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:oc}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:ic(e.popupAnchor,!!m.card),onClick:T=>T.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:m.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(gt(m.date)),rt(m.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[m.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>z({country:[m.cc]}),children:(ea(m.cc,o)||m.countryLabel||"").toUpperCase()}),m.sector&&t.jsx("button",{type:"button",onClick:()=>z({sector:[m.sector]}),children:m.sector.toUpperCase()}),m.stage&&t.jsx("button",{type:"button",onClick:()=>z({stage:[m.stage]}),children:m.stage.toUpperCase()}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{className:"am2",children:Ht(m.amountEur,o)})]}),i.pipe&&N&&t.jsxs("div",{className:"pstat",children:[j&&t.jsx("span",{className:"vd "+(j==="MATCH"?"v-ok":"v-no"),title:n.vt[j],children:j}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),m.ceoStatus&&t.jsx("span",{className:"pstep own",children:m.ceoStatus})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[_t(m.engine)," ",t.jsx("b",{children:rt(m.engine,o)})," — ",As(m.engine,o),m.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",m.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Lt,{o:m,lg:!0})," ",t.jsx(en,{o:m,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Oo(y,o))," · ",n.win7(Mo(y,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),m.card?t.jsx(ta,{spec:m.card}):null,m.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),i.pipe&&N&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof m.score=="number"&&m.score>0?" · "+n.score(m.score):""]})}),i.pipe&&N&&t.jsx(Zn,{o:m})]}),t.jsx(Xn,{name:m.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||d!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>l(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)]}),E===1&&t.jsxs(Za,{lang:o,storeKey:m.name,className:"evalbtn memo",style:{flex:1,justifyContent:"center"},confirmLabel:n.actAnalyse,onConfirm:()=>{s(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(m,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(m,!1),a({type:"popup",id:null})},children:n.actNo}),Yt(m)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(m),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(m),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),m.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:m.id}),a({type:"popup",id:null})},children:"📄"}),w&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{h(m),a({type:"popup",id:null})},children:"🚀"})]}):m.engine==="media"&&m.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var T;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"popup",id:null}),(T=document.querySelector(".atl2 .demand"))==null||T.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(m.name),onClick:()=>l(m),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>l(m),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(m.name.length>22?m.name.slice(0,21)+"…":m.name)," →"]}),m.website&&t.jsx("a",{className:"psite",href:m.website.startsWith("http")?m.website:"https://"+m.website,target:"_blank",rel:"noopener noreferrer",title:m.website,children:"🌐"})]})]})]}),document.body)}function lc(){const{lang:e,token:a,dossiers:r,caps:n}=J(),o=a||"home",{names:i,verdicts:d}=p.useMemo(()=>{const s=[],f={};return r.forEach(c=>{c.kind!=="target"||!c.name||(s.push(c.name),f[c.name]=qs(c)||"")}),{names:s,verdicts:f}},[r]);return{diff:p.useMemo(()=>i.length?Ts(o,i,d,e):null,[o,i.length]),names:i,verdicts:d,scope:o,caps:n}}function dc(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:d,caps:l}=J(),[s,f]=p.useState(!1),[c,g]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!s)return;const E=k=>{u.current&&!u.current.contains(k.target)&&f(!1)};return document.addEventListener("click",E,!0),()=>document.removeEventListener("click",E,!0)},[s]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...l.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],h=i.loading&&!d.length,w=p.useRef({});p.useEffect(()=>{w.current={...r}},[r]);const v=E=>{const k=w.current[E],j=k!==void 0?r[E]-k:0;return t.jsxs("button",{type:"button",className:"step"+(E===3&&r[3]>0?" wait":""),style:{"--c":`var(${ma[E]})`,"--tc":E<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsxs("span",{className:"l",children:[n.plabels[E],E===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(j>0?" up":j<0?" down":""),children:[r[E],j!==0&&t.jsxs("em",{className:"delta",children:[j>0?"+":"−",Math.abs(j)]})]})]},E)},m=(E,k,j)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),"data-off":E,style:{"--c":`var(${ma[E]})`},"aria-selected":e.ptab===E,title:n.phelp[E],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:E})},children:[t.jsx("span",{className:"l",children:j}),t.jsx("span",{className:"n",children:r[E]})]},E),y=(E,k,j,N=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:N,onClick:j,children:E},k);return t.jsxs("div",{className:"funnel"+(h?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(v)}),t.jsxs("div",{className:"offtrack",children:[m(5,!1,n.plabels[5]),m(7,!0,n.plabels[7]),m(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[y("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(c?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"}),a({type:"ptab",tab:1}),a({type:"continent",key:l.pipe?"europe":"monde"}),a({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}g(!0),window.setTimeout(()=>g(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":s,title:n.toolSort,onClick:()=>f(E=>!E),children:"⇅"}),s&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([E,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===E,className:"sortopt"+(e.sort.key===E?" on":""),onClick:()=>a({type:"sort",key:E}),children:[k,t.jsx("i",{children:e.sort.key===E?e.sort.dir===1?"↑":"↓":""})]},E))})]}),y("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),y("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function pc(){const{st:e,dispatch:a,t:r,lang:n,counts:o,scoped:i,memoQueued:d,mode:l,data:s}=J(),f=p.useRef(null),[c,g]=p.useState(60);p.useEffect(()=>{let z=0;const T=()=>{var K;const L=f.current;if(!L)return;const O=(K=L.parentElement)==null?void 0:K.querySelector('.funnel [aria-selected="true"]');if(!O)return;const M=O.getBoundingClientRect(),W=L.getBoundingClientRect();g(Math.max(20,Math.min(M.left+M.width/2-W.left,W.width-30)))};return z=requestAnimationFrame(T),window.addEventListener("resize",T),()=>{cancelAnimationFrame(z),window.removeEventListener("resize",T)}},[e.ptab]);const u=e.ptab;let b=r.tuto[u].p;if(u===3){const z=i.filter(O=>O.kind==="target"&&Te(O)===3),T=z.filter(O=>kn(O)==="auto").length,L=z.filter(O=>kn(O)==="cd").length;b=r.tutoPending(T,L,z.length)}const h=(()=>{var z;if(l!=="client")return null;if(u===0&&i.length)return{label:r.tuto[0].a,locked:!1,run:()=>a({type:"chainStart",queue:i.map(T=>T.id)})};if(u===1){const T=i.filter(L=>L.kind==="target"&&Te(L)===1&&!d.has(L.id)).slice(0,10);if(T.length){const L=String(((z=s.credits)==null?void 0:z.plan)||"").toLowerCase(),O=L==="enterprise"||L==="entreprise";return{label:r.tuto[1].a,locked:!O,run:()=>{O&&a({type:"chainStart",queue:T.map(M=>M.id)})}}}}return null})(),w=Ls(u),v=u===1||u===2,m=u===5,y=u===7,E=u===6,k=w||m||y,j=r.plabels[u]+" · "+(o[u]??0),N=n==="en"?"Back to Kept ✕":"Revenir aux retenues ✕";return t.jsxs("div",{ref:f,className:"tuto mini"+(k?"":" on-dark")+(v?" etape-on":"")+(m?" etape-out":"")+(y?" etape-view":"")+(E?" etape-fav":""),style:{"--bg":`var(${ma[u]})`,"--ax":c+"px","--stc":k?"var(--ink)":"#fff","--stt":k?"#fff":"var(--ink)","--tc":k?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:j}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:b}})]})}),h&&t.jsx("button",{type:"button",className:"tprim"+(h.locked?" lock":""),disabled:!!h.locked,title:h.locked?r.analyseLockHint:void 0,onClick:h.run,children:h.locked?"🔒 "+r.analyseLock:h.label}),u!==1&&t.jsx("button",{type:"button",className:"treset",onClick:()=>a({type:"ptab",tab:1}),children:N})]})}const vn=600,Tt=62,ko="atl2:fstats";function cc(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=J(),[d,l]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(ko)==="on"}catch{return!1}}),s=r.stats,f=p.useMemo(()=>((s==null?void 0:s.by_day)||[]).slice(-30),[s]),c=(s==null?void 0:s.since)||"";if(!n.showFunnel||!s||typeof s.screened!="number")return null;const g=j=>a==="en"?j.slice(5,10):`${j.slice(8,10)}/${j.slice(5,7)}`,u=j=>j.toLocaleString(a==="en"?"en-US":"fr-FR"),b=f.reduce((j,N)=>Math.max(j,N.s||0),0),h=f.length?vn/f.length:0,w=Math.max(4,h-4),v=f.length>=5&&b>0,m=r.marketEstimate||0,y=g(new Date().toISOString().slice(0,10)),E=j=>[...typeof j=="number"?[[j,e.funScreened("","")]]:[],...typeof s.kept=="number"?[[s.kept,e.funKept]]:[],...typeof s.analyzed=="number"?[[s.analyzed,e.funAnalyzed]]:[],...typeof s.shown=="number"?[[s.shown,e.funShown]]:[]],k=[];return typeof s.screened_window=="number"&&c&&k.push({cle:"fenetre",periode:e.funPerWindow(g(c),y),etapes:[[s.screened_window,e.funScreened("","")]]}),typeof s.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:E(s.screened)}),t.jsxs("div",{className:"fstats"+(d?" on":""),children:[k.map(j=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:j.periode}),j.etapes.map(([N,z],T)=>t.jsxs("span",{className:"fst-t",children:[T>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(N)}),t.jsx("i",{children:z})]},j.cle+z)),j.cle==="total"&&m>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(m),Math.min(100,Math.round((s.screened||0)/m*100)))})]}),j.cle==="total"&&(s.screened||0)>=50&&t.jsx("span",{className:"fst-t fst-roi",children:t.jsx("i",{children:e.funAnalyst})}),j.cle===k[k.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":d,title:d?e.fstatsHide:e.fstatsShow,onClick:()=>{const N=!d;l(N),N&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(ko,N?"on":"off")}catch{}},children:d?"⌃":"⌄"})]},j.cle)),d&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${vn} ${Tt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((j,N)=>{const z=(j.s||0)/b*(Tt-4),T=(j.m||0)/b*(Tt-4),L=N*h+(h-w)/2;return t.jsxs("g",{className:"fst-day"+(o.filters.day===j.d?" on":""),role:"button",tabIndex:0,onClick:()=>i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}),onKeyDown:O=>{O.key!=="Enter"&&O.key!==" "||(O.preventDefault(),i({type:"filters",patch:o.filters.day===j.d?{day:"",win:"all"}:{day:j.d,win:"all"}}))},children:[t.jsx("title",{children:`${g(j.d)} — ${j.s} ${e.actScreened} · ${j.m} ${e.actKept}`}),t.jsx("rect",{x:L-1,y:0,width:w+2,height:Tt,fill:"transparent"}),t.jsx("rect",{x:L,y:Tt-2-z,width:w,height:z,fill:"#cfe0d6"}),t.jsx("rect",{x:L,y:Tt-2-T,width:w,height:T,fill:"#0E7F3F"})]},j.d)}),t.jsx("line",{x1:0,y1:Tt-1.5,x2:vn,y2:Tt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:g(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Ai={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function er({o:e,locked:a=!1}){const{t:r}=J(),n=ya(e),o=Ft(e),i=Te(e),d=kn(e),l=Fs(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Ai[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&d==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&d==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:r.waitTitle(l),children:r.waitChip(l)}),!a&&t.jsx(pd,{o:e})]})}const Xt=e=>e.length>22?e.slice(0,21)+"…":e;function va(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function qi(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .fzone:has(.stage.folded), .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .fzone:has(.stage.folded), .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function uc({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const d=()=>{var h,w,v;const l=document.querySelector(".atl2.ops .desk-list"),s=document.querySelector(".atl2.ops .listhead");if(!l){n(null);return}const f=l.getBoundingClientRect(),c=s?s.getBoundingClientRect().bottom:f.top;i({top:Math.round(c),left:Math.round(f.left),width:Math.round(f.width)});const g=[...l.querySelectorAll(":scope .grp")];let u=null;for(const m of g){const y=m.querySelector(".grp-h");y&&y.getBoundingClientRect().bottom<=c+2&&(u=m)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((h=b.querySelector(".ic"))==null?void 0:h.textContent)||"").trim(),t:(((w=b.querySelector(".t"))==null?void 0:w.textContent)||"").trim(),s:(((v=b.querySelector(".s"))==null?void 0:v.textContent)||"").trim()})};return d(),window.addEventListener("scroll",d,{passive:!0}),window.addEventListener("resize",d),()=>{window.removeEventListener("scroll",d),window.removeEventListener("resize",d)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function mc(e){const r=()=>{const n=qi(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Eo({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=J(),[i,d]=p.useState(!1);if(p.useEffect(()=>{n||d(!1)},[n]),Ye(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const s=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(s?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),d(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Xt(e.name))})]})}function ua(e,a){e({type:"focus",id:a.id}),window.setTimeout(()=>{var r;window.dispatchEvent(new CustomEvent("ppmap:card-tab",{detail:{tab:"memo"}})),(r=document.querySelector(".atl2 .readpane"))==null||r.scrollIntoView({block:"nearest"})},40)}function tr({o:e}){const{t:a,lang:r,caps:n,memoQueued:o,approachDone:i,doAnalyse:d,doDecide:l,doPromote:s,doRepeche:f,doApproach:c,dispatch:g,liveMemos:u}=J(),b=w=>v=>{v.stopPropagation(),w()};if(n.lockActions){const w=b(()=>g({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:w,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const v=Te(e);return v===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:w,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Xt(e.name))})]})}):v===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:w,children:a.actAnalyse})}):v===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:w,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:w,children:a.actNo})]})}):v===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:w,children:a.actPromote})}):v===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:w,children:a.actApproach})}):v===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:w,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:w,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:w=>{w.stopPropagation(),va(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if($a(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:w=>{w.stopPropagation(),va(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!n.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Eo,{o:e})});const h=Te(e);if(h===0)return t.jsx("span",{className:"cell",children:t.jsx(Eo,{o:e})});if(h===1){const w=u.liveOf(e.name);if(w&&(w.status==="boot"||w.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Ba,{item:w,serverOff:u.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const v=o.has(e.id);return t.jsx("span",{className:"cell cell-an",children:t.jsx(Za,{lang:r,storeKey:e.name,className:"memobtn",disabled:v,confirmLabel:a.actAnalyse,onConfirm:()=>d(e),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(h===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:b(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:b(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ua(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(h===4){const w=i.has(e.id);return t.jsxs("span",{className:"cell",children:[t.jsx("button",{type:"button",className:"approach",disabled:w,onClick:b(()=>c(e)),children:w?a.actApproachSent:a.actApproach}),t.jsx("button",{type:"button",className:"lk sm",title:a.actConnHint,onClick:b(()=>g({type:"modal",modal:"plug"})),children:a.actConn}),t.jsx("button",{type:"button",className:"lk sm dsrow",title:a.dsBtn,onClick:b(()=>g({type:"dossierOpen",id:e.id})),children:a.dsBtn})]})}return h===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ua(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):h===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:b(()=>f(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:b(()=>ua(g,e)),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:b(()=>ua(g,e)),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function fc({o:e}){const{t:a,doThumb:r,thumbOf:n}=J(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function hc({o:e}){const{lang:a}=J();return He(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Lt,{o:e}),t.jsx(en,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[_t(e.engine||"")," ",rt(e.engine||"",a)]})})}function gc({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:d,fresh:l}){const{dispatch:s,caps:f,markRow:c,markedId:g,favIds:u,toggleFav:b,t:h}=J(),w=Te(e),v=["#16233A","#475C6E","#8798A8","#B9C6D2"],m=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,y=m<=0?0:m<=7?1:m<=30?2:3,E=f.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][w]:v[y],k=u.has(e.id),j=N=>{if(a)return;if(d){d(e.id);return}if(f.pipe||e.kind==="op"){n();return}const z=N.currentTarget.getBoundingClientRect();s({type:"popup",id:e.id,anchor:{x:z.left+Math.min(280,z.width/3),y:z.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(g===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(f.pipe&&e.kind==="target"?" p"+w:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>c(e.id),onMouseLeave:()=>c(null),onClick:j,children:[t.jsx("span",{className:"pt",style:{"--c":E}}),t.jsx(Mi,{o:e}),t.jsxs("span",{className:"nd",children:[l&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${h.cdEngagement} ${Math.round(e.engagement*10)/10} · ${h.cdEngagementHint}`,children:"🔥"}),He(e)&&t.jsx(Lt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[f.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:N=>{N.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[at(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(N=>N&&N!==e.name)||""]}),f.pipe&&!f.lockActions&&!a&&(e.website||e.contactLinkedin||e.contactEmail||e.contactPhone)&&t.jsxs("span",{className:"rlnk",onClick:N=>N.stopPropagation(),children:[e.website&&t.jsx("a",{href:ba(e.website),target:"_blank",rel:"noopener noreferrer","aria-label":h.rowSite,title:h.rowSite,children:"🌐"}),e.contactLinkedin&&t.jsx("a",{href:ba(e.contactLinkedin),target:"_blank",rel:"noopener noreferrer","aria-label":h.rowLi,title:h.rowLi,children:"in"}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,"aria-label":h.rowMail,title:h.rowMail,children:"✉"}),e.contactPhone&&t.jsx("a",{href:`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`,"aria-label":h.rowTel,title:h.rowTel,children:"☎"})]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:h.acqSee(e.acquirer),onClick:N=>{N.stopPropagation(),s({type:"acquirer",value:e.acquirer||""})},children:["← ",Xt(e.acquirer)]}),We(e)?t.jsx("span",{className:"rdec",title:h.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:h.zoomNewsMark,children:"📰"}):null]}),t.jsx(xc,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(hc,{o:e}),f.pipe&&t.jsx(er,{o:e,locked:a}),f.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(tr,{o:e}),f.showThumbs&&t.jsx(fc,{o:e})]}),r&&!a&&!d&&t.jsx(wc,{o:e})]})}function xc({o:e}){const{lang:a,caps:r}=J();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ht(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function bc({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=J(),d=(u,b=!1)=>h=>{h.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},l=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),s=Ht(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Ye(e),g=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:d({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:d({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:d({stage:[e.stage]}),children:e.stage}),s&&t.jsx("span",{className:"oc-amt",children:s}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped})]}):at(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),va(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Xt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(l?` · ${l}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(ta,{spec:e.card})})]})}function vc({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=J();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=[e.tagline,e.headline,e.reasoning].find(f=>f&&f!==e.name)||"",l=Ht(e.amountEur,r),s=(()=>{const f=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return f?f[1].replace(/^www\./,"").slice(0,40):""})();return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[rt(e.engine||"",r),i?` · ${i}`:"",l?` · ${l}`:""]}),t.jsxs("div",{className:"zoom-hd",children:[t.jsx("h3",{className:"zoom-h",children:e.name}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(tr,{o:e})})]}),(e.sector||e.countryLabel||e.stage||e.acquirer)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null,e.acquirer?t.jsxs("span",{children:["← ",e.acquirer]}):null]}),(d||e.decryptHtml||e.url||e.card)&&t.jsxs("div",{className:"zoom-news",children:[d?t.jsx("p",{className:"zoom-lead",children:d}):null,e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):null,e.card?t.jsx("div",{className:"zoom-card",children:t.jsx(ta,{spec:e.card})}):null,e.url?t.jsxs("a",{className:"zoom-src",href:e.url,target:"_blank",rel:"nofollow noopener",children:[a.zoomSrc,s?` · ${s}`:""," ↗"]}):null]}),t.jsx(Zn,{o:e})]})}function Ti({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:d,caps:l,dossiers:s}=J(),f=p.useRef(null),c=We(e);if(p.useEffect(()=>{if(!c||!(e!=null&&e.decryptHtml))return;const x=f.current;if(!x)return;let A=!1;return wn(()=>import("./fit-DX-mzLKR.js"),[]).then(async S=>{await S.ensureEditoCss(),!(A||!x.isConnected)&&(S.beautifyEditoRows(x),S.mountCardFits(x))}),()=>{A=!0}},[c,e==null?void 0:e.decryptHtml]),!e&&!a){const x=s.find(We);if(x)return t.jsx(Ti,{o:x})}const g=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||g,h=(e==null?void 0:e.card)||(a==null?void 0:a.card),w=e?!!e.noCo:!g||Qt(g),v=(e==null?void 0:e.engine)||"",m=We(e),y=e?Ht(e.amountEur,n):"",E=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const x=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return x?x[1].replace(/^www\./,"").slice(0,40):""})(),j=s.find(We),N=((j==null?void 0:j.url)||"").trim(),z=!!u&&!!N&&(u===N||u.endsWith(N)||N.endsWith(u)),T=(x,A=!1)=>S=>{S.stopPropagation(),A&&d({type:"continent",key:"monde"}),d({type:"filters",patch:x})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const L=()=>{g&&(d({type:"continent",key:"monde"}),d({type:"filters",patch:{search:g}}))},O=()=>{e!=null&&e.sector&&d({type:"filters",patch:{sector:[e.sector]}})},M=()=>{va({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:g})},W=e?Ye(e):!1,K=W&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",F=m?r.doEdito.replace(/^📖\s*/,""):v?rt(v,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[F,E?` · ${E}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!m&&(w||$a({engine:v}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:x=>x.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:f,className:"ed-decrypt-b zoom-body"+(m?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:T({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:T({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:T({stage:[e.stage]}),children:e.stage}),y&&t.jsx("span",{className:"oc-amt",children:y})]}),h&&t.jsx("div",{className:"zoom-card",children:t.jsx(ta,{spec:h})}),(u&&!z&&!m||j&&!m)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!z&&!m&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:x=>x.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),j&&!m&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:x=>{x.stopPropagation(),d({type:"focus",id:j.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[W?t.jsxs("span",{className:"verdict",style:{"--c":K?"var(--brand)":"var(--red)"},children:[K?"✓":"✗"," ",t.jsx("b",{children:K?r.kept:r.dropped})]}):!w&&g?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:x=>{x.stopPropagation(),o(e,g)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Xt(g))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!m&&(w||$a({engine:v}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!w&&g?" ghost":""),onClick:x=>{x.stopPropagation(),M()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!w&&g&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!l.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),O()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:x=>{x.stopPropagation(),L()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Xt(g)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!w&&g&&l.pipe&&t.jsx(Xn,{name:g})]})]})}function wc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:d}=J();return!o.pipe&&e.kind==="op"?t.jsx(bc,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Zn,{o:e}),t.jsx(cd,{o:e}),t.jsx(md,{o:e}),t.jsx(Xn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:l=>{l.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(er,{o:e})})]}),e.card&&t.jsx(ta,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[_t(e.engine||"")," ",rt(e.engine||"",r)]}),He(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Lt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>d(e),children:a.actOnboard})})]})]})}function yc({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:d,doDecide:l,lang:s}=J();if(!d.pipe&&e.kind==="op"){const g=Ht(e.amountEur,s),u=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return h?h[1].slice(0,32):""})(),b=(h,w=!1)=>v=>{v.stopPropagation(),w&&i({type:"continent",key:"monde"}),i({type:"filters",patch:h})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(ta,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),g&&t.jsx("span",{className:"damt",children:g})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[_t(e.engine||"")," ",rt(e.engine||"",s)]}),He(e)&&t.jsx(Lt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[(s==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(tr,{o:e})})]})}const f=Te(e),c=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][f];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":c},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(er,{o:e}),He(e)&&t.jsx(Lt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&d.pipe&&f===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>l(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>l(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>ua(i,e),children:[o.actMemoOf(e.memoType)," →"]})]})}function kc(){const{t:e}=J(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Ec({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=J(),i=o==="en",d=c=>n.plabels[c]||"",l=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),s=l.includes(0)?0:l.sort((c,g)=>(e[g]||0)-(e[c]||0))[0];if(s===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[s]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${d(a.ptab)}” for now.`:`0 ${d(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:s===0?i?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:i?`${f} ${f>1?"files":"file"} in “${d(s)}”`:`${f} dossier${f>1?"s":""} dans « ${d(s)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:s}),children:[(i?"Open ":"Ouvrir ")+d(s)," →"]})]})}function jc(){var Pe,it,tt,zt;const e=J(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:d,scopedAll:l,markRow:s,lang:f,sessTally:c,data:g,dossiers:u,source:b,focusExtra:h,byId:w,token:v}=e,m=Yo(),y=p.useMemo(()=>{var te,I,ae,V;if(!v||b==="ops")return null;const R=(((te=m==null?void 0:m.ed)==null?void 0:te.date)||(m==null?void 0:m.day)||"").slice(0,10),G=[(I=m==null?void 0:m.ed)==null?void 0:I.html,(ae=m==null?void 0:m.ed)==null?void 0:ae.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:f==="en"?"Today's brief":"Brief du jour",headline:f==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((V=m==null?void 0:m.ed)==null?void 0:V.date)||R,decryptHtml:G||void 0,date:R,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[v,b,f,(Pe=m==null?void 0:m.ed)==null?void 0:Pe.html,(it=m==null?void 0:m.ed)==null?void 0:it.acquirers_html,(tt=m==null?void 0:m.ed)==null?void 0:tt.date,m==null?void 0:m.day]),E=R=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:Go,[k,j]=p.useState(new Set);p.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[N,z]=p.useState(null);p.useEffect(()=>{z(null)},[a.ptab,a.continent]);const[T,L]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){L(!1);return}const R=document.getElementById("atl2-stage");if(!R){L(!1);return}const G=new IntersectionObserver(([te])=>L(!!te&&te.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return G.observe(R),()=>G.disconnect()},[a.mapFolded]);const O=a.mapFolded||!T,M=R=>j(G=>{const te=new Set(G);return te.has(R)?te.delete(R):te.add(R),te}),W=b==="ops"||o.pipe,[K,F]=p.useState("all"),[x,A]=p.useState(!1),[S,P]=p.useState(null),[U,Q]=p.useState(!1),ne=p.useRef(!0);p.useEffect(()=>{if(ne.current){ne.current=!1;return}F("all"),Q(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!U)return;const R=G=>{var te,I;(I=(te=G.target)==null?void 0:te.closest)!=null&&I.call(te,".atl2 .doable")||Q(!1)};return document.addEventListener("click",R,!0),()=>document.removeEventListener("click",R,!0)},[U]);const C=p.useMemo(()=>{var G;const R=new Map;for(const te of Jl(((G=m==null?void 0:m.ed)==null?void 0:G.html)||""))R.has(te.t)||R.set(te.t,te.html);return R},[(zt=m==null?void 0:m.ed)==null?void 0:zt.html]),B=p.useCallback(R=>{if(R.decryptHtml)return R.decryptHtml;if(!C.size)return;const G=(R.name||"").trim().toLowerCase();if(G.length<3)return;const te=C.get(G);if(te)return te;for(const[I,ae]of C)if(I.includes(G)||G.includes(I))return ae},[C]),{diff:D}=lc(),[Z,$]=p.useState(!1),oe=a.filters.win==="1"&&!a.filters.day,[me,xe]=p.useState(!1),[ye,ce]=p.useState(!1),Ce=p.useMemo(()=>{const R={...a,filters:{...a.filters,win:"all",day:""}};return u.filter(G=>!We(G)&&gt(G.date)===0&&Pt(G,R,o.pipe)).length},[u,a,o.pipe]),Ae=p.useMemo(()=>new Set(((D==null?void 0:D.added)||[]).map(R=>R.trim().toLowerCase()).filter(Boolean)),[D]),ue=p.useMemo(()=>{if(!Ae.size)return 0;const R={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(G=>!We(G)&&Ae.has((G.name||"").trim().toLowerCase())&&Pt(G,R,o.pipe)).length},[u,Ae,a,o.pipe]);p.useEffect(()=>{const R=()=>{ce(!1),A(!1),xe(!1),F("all"),Q(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",R),()=>window.removeEventListener("ppmap:tunnel",R)},[]),p.useEffect(()=>{ce(!1),A(!1),xe(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const ve=p.useMemo(()=>{const R=l.filter(te=>!We(te)&&at(te));let G="";for(const te of R){const I=(te.date||"").slice(0,10);I&&(!G||I<G)&&(G=I)}return{n:R.length,since:G?G.split("-").reverse().slice(0,2).join("/"):""}},[l]),ke=ve.n,ee=p.useMemo(()=>{const G=ye&&Ae.size>0||a.filters.signalOnly||K!=="all"||x||me?l:d;let te=Gn(G,a.sort);return te=te.filter(I=>!We(I)),me&&(te=te.filter(I=>gt(I.date)===0)),ye&&Ae.size&&(te=te.filter(I=>Ae.has((I.name||"").trim().toLowerCase()))),x||K==="explore"?te=te.filter(at):K==="eval"?te=te.filter(I=>!at(I)&&!I.noCo&&(I.kind==="op"||!Ye(I))):o.pipe&&(te=te.filter(I=>!at(I))),te},[d,l,a.sort,K,ye,Ae,x,me,o.pipe]),re=p.useMemo(()=>o.pipe?u.filter(R=>R.kind==="target"&&!We(R)&&He(R)&&(a.continent==="monde"||R.continent===a.continent)):ee.filter(R=>He(R)&&!Ye(R)),[o.pipe,u,ee,a.continent]).length,se=p.useMemo(()=>o.pipe?ee:ee.filter(R=>!Ye(R)&&!R.noCo&&!at(R)),[ee,o.pipe]),le=b==="ops"?ee.filter(at).length:0,fe=me?n.morningList:ye?n.sinceList:o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,H=a.filters,de=H.sector.length+H.market.length+H.country.length+H.engine.length+H.stage.length+H.crible.length+H.angle.length+H.memoLevel.length+H.dealKind.length+(H.signalOnly?1:0)+(H.acquirer.trim()?1:0)+(H.search.trim()?1:0),we=[];if(H.day)we.push({k:"day",lib:n.fDay(H.day.slice(8,10)+"/"+H.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(H.win&&H.win!=="all"){const R=["1","7","30"].indexOf(H.win);R>=0&&we.push({k:"win",lib:n.dates[R],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ee=R=>R.length<=2?R.join(", "):`${R.length} ${n.fSelected}`;for(const R of["sector","market","country","engine","crible"]){const G=H[R];G&&G.length&&we.push({k:R,lib:Ee(G),off:()=>r({type:"clearFacet",facet:R})})}H.search&&we.push({k:"search",lib:"🔍 "+H.search,off:()=>r({type:"filters",patch:{search:""}})}),ye&&Ae.size&&we.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>ce(!1)}),H.signalOnly&&we.push({k:"sig",lib:"🔴 "+n.sigDock(re||H.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const je=(R,G,te="",I=!1)=>t.jsxs("button",{type:"button","data-s":R,className:te,"aria-sort":a.sort.key===R?a.sort.dir===1?"ascending":"descending":"none",style:I?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:R}),children:[G,t.jsx("span",{className:"ar",children:a.sort.key===R&&a.sort.dir===1?"▴":"▾"})]},R),be=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const R=new Map;ee.forEach(I=>{const ae=I.engine||"?";R.has(ae)||R.set(ae,[]),R.get(ae).push(I)});const G={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},te=yn([...R.keys()],f);return[...R.entries()].sort((I,ae)=>{const V=G[I[0]]??10+te.indexOf(I[0]),pe=G[ae[0]]??10+te.indexOf(ae[0]);return V-pe})},[ee,o.pipe,a.groupBy,f]),Be=be?be.filter(([R])=>Ra.has(R)).length:0,et=(()=>{var G;return((G=(be?be.flatMap(([,te])=>te):ee)[0])==null?void 0:G.id)??null})(),ut=p.useRef(!1),Fe=p.useMemo(()=>u.find(We)||y,[u,y]),[Ve,wt]=p.useState(!1);p.useEffect(()=>{const R=()=>{ut.current=!0,ce(!1)};return window.addEventListener("ppmap:reveal",R),window.addEventListener("ppmap:focus",R),()=>{window.removeEventListener("ppmap:reveal",R),window.removeEventListener("ppmap:focus",R)}},[]),p.useEffect(()=>{const R=()=>{Fe&&r({type:"focus",id:Fe.id})};return window.addEventListener("ppmap:edito",R),()=>window.removeEventListener("ppmap:edito",R)},[Fe,r]),p.useEffect(()=>{if(!a.focusId)return;P(a.focusId);const R=window.setTimeout(()=>P(null),900);return()=>window.clearTimeout(R)},[a.focusId]),p.useEffect(()=>{if(W&&!(a.focusId&&(ee.some(R=>R.id===a.focusId)||u.some(R=>R.id===a.focusId)||a.focusId===(Fe==null?void 0:Fe.id)))&&!h){if(Fe){r({type:"focus",id:Fe.id});return}et&&r({type:"focus",id:et})}},[W,a.focusId,ee,et,h,r,u,b,Fe]),p.useEffect(()=>{if(!W||!a.focusId||Fe&&a.focusId===Fe.id||ee.some(G=>G.id===a.focusId))return;const R=u.find(G=>G.id===a.focusId);if(R){if(ut.current){R.kind==="op"?F(at(R)?"explore":"eval"):K!=="all"&&F("all");return}K!=="all"&&et&&r({type:"focus",id:et})}},[W,a.focusId,K,ee,u,et,r,Fe]),p.useEffect(()=>{if(!W||!a.focusId||!ut.current)return;const R=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!R){const ae=ee.findIndex(V=>V.id===a.focusId);if(ae>=0){const V=be?"":"pt"+a.ptab;if(V){const pe=a.shown[V]||E();ae>=pe&&r({type:"more",group:V,by:ae-pe+8})}}return}ut.current=!1;const G=qi(),te=R.getBoundingClientRect();te.top>=G-2&&te.bottom<=window.innerHeight-4||mc(R)},[W,a.focusId,a.ptab,ee,a.shown,be,r]),p.useEffect(()=>{if(typeof window>"u")return;const R=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),G=document.querySelector(".atl2.ops, .atl2.cibles");if(!R||!G)return;const te=document.querySelector(".atl2 .fzone"),I=()=>{G.style.setProperty("--listhead-h",`${R.offsetHeight}px`);const V=!!(te&&te.querySelector(".stage.folded"));G.style.setProperty("--fold-h",V&&te?`${te.offsetHeight}px`:"0px")};I();const ae=new ResizeObserver(I);return ae.observe(R),te&&ae.observe(te),()=>ae.disconnect()},[O,a.dens,a.mapFolded]);const Ue=p.useMemo(()=>{if(!W||!a.focusId)return null;if(y&&a.focusId===y.id)return y;const R=ee.find(te=>te.id===a.focusId)||u.find(te=>te.id===a.focusId)||null;if(!R)return null;const G=B(R);return G&&G!==R.decryptHtml?{...R,decryptHtml:G}:R},[W,a.focusId,ee,u,B,y]),ot=o.lockRowsAfter;let Rt=0;const yt=(R,G)=>{let te=a.shown[G]||E();return R.length-te<=4&&(te=R.length),R.slice(0,te).map(V=>{const pe=ot!==null&&Rt>=ot;Rt++;const Se=B(V),he=Se&&Se!==V.decryptHtml?{...V,decryptHtml:Se}:V,Ne=!W&&a.dens!=="maxi"&&(a.dens==="deplie"||(N?N==="open":!!Se)),Re=k.has(V.id)?!Ne:Ne,Qe=W?mt=>{ut.current=!0,r({type:"focus",id:mt});const $e=w.get(mt);$e&&(at($e)?va($e):$e.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:$e.name,url:$e.url||"",website:$e.website||"",domain:$e.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(yc,{o:he,locked:pe,selected:W&&a.focusId===V.id,onSelect:Qe},V.id):t.jsx(gc,{o:he,locked:pe,open:Re,onToggle:()=>M(V.id),selected:W&&a.focusId===V.id,echo:S===V.id,fresh:Ae.has((V.name||"").trim().toLowerCase()),onSelect:Qe},V.id)})},Ct="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(ee.length?"":" list-empty"),Ot=t.jsxs(t.Fragment,{children:[be?be.map(([R,G])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:_t(R)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:R==="ma"?n.grpMa:R==="fundraising"?n.grpLev:Ra.has(R)&&Be<=1?n.grpNews:R==="nominations"?n.grpNom:R==="media"?n.grpNewsOther:R==="recrutements"?n.grpHire:Ra.has(R)?n.grpNews+" · "+rt(R,f):rt(R,f)}),t.jsx("div",{className:"s",children:n.grpCount(G.filter(te=>!Ye(te)).length,G.length)})]})]}),yt(G,R)]},R)):yt(ee,"pt"+a.ptab),g.loading&&!u.length&&t.jsx(kc,{}),o.pipe&&a.ptab===0&&!x&&!ye&&!me&&K==="all"&&!a.filters.signalOnly&&!g.loading&&t.jsx(bp,{}),!ee.length&&!(g.loading&&!u.length)&&(o.pipe&&K==="all"?t.jsx(Ec,{counts:i}):t.jsxs("div",{className:"void",children:[n.emptyScope,(H.win!=="all"||!!H.day)&&t.jsxs("p",{className:"voidb",children:[n.emptyWin," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"filters",patch:{win:"all",day:""}}),children:n.emptyWinBtn})]}),de>0&&t.jsxs("p",{className:"voidb",children:[n.emptyFilters(de)," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>r({type:"reset"}),children:n.emptyFiltersBtn})]})]}))]}),Mt=t.jsxs(t.Fragment,{children:[!x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ma[a.ptab]+")"},children:ee.length})," ",fe]}),x&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ma[a.ptab]+")"},children:ee.length})," ",n.newsWord]}),t.jsx("span",{className:"dot",children:"·"}),O&&!a.mapFolded&&t.jsx(wi,{variant:"compact",mapToggle:!1}),t.jsxs("span",{className:"ctx",children:[O?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),we.map(R=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:G=>{G.stopPropagation(),R.off()},children:[R.lib,t.jsx("i",{children:"×"})]},R.k)),b==="ops"&&ee.length>0&&!O&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",ee.length-le," ",n.zoomPulseEval,le>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",le," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),kt=t.jsxs("div",{className:"listhead"+(O?" mapoff":""),children:[O&&t.jsx("div",{className:"lh-tools",children:t.jsx(vi,{compact:!0})}),o.showFunnel&&Z&&oe&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(hd,{}),t.jsx(cc,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:Mt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(dc,{}),t.jsx(pc,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(me?" on":""),"aria-pressed":me,title:n.morningDockTitle,onClick:()=>{if(me){xe(!1),$(!1);return}ce(!1),A(!1),F("all"),xe(!0),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}}),$(!1)},children:["📊 ",n.morningDock(Ce)]}),D&&!D.firstVisit&&(D.added.length>0||D.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(ye?" on":""),"aria-pressed":ye,title:n.sinceSub,onClick:()=>{const R=!ye;ce(R),A(!1),xe(!1),$(!1),F("all"),R&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(ue),D!=null&&D.lastDate?` · ${n.sinceSince(D.lastDate)}`:""]}),re>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{ce(!1),A(!1),xe(!1),$(!1),F("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(re)]}),o.pipe&&ke>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(x?" on":""),"aria-pressed":x,title:n.newsDockHint,onClick:()=>{const R=!x;A(R),ce(!1),xe(!1),$(!1),F("all"),R&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ke),ve.since?` · ${n.newsSince(ve.since)}`:""]})]}),!o.showFunnel&&Mt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([R,G])=>t.jsxs("button",{type:"button","data-d":R,"aria-pressed":a.dens===R||R==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:R}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:G})]},R))}),!W&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":N==="open",onClick:()=>{z("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":N==="closed",onClick:()=>{z("closed"),j(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var Se;const R={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},G=u.filter(he=>Pt(he,R,o.pipe)&&!We(he)),te=G.filter(he=>!at(he)&&!he.noCo&&(he.kind==="op"||!Ye(he))).length,I=G.filter(at).length,ae=o.pipe?G.filter(he=>he.kind!=="op"&&Te(he)===1).length:0,V=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${ae?` ${ae}`:""}`]]:[],["eval",`${n.doEval}${te?` ${te}`:""}`],["explore",`${n.doExplore}${I?` ${I}`:""}`]],pe=((Se=V.find(([he])=>he===K))==null?void 0:Se[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":U,onClick:()=>Q(he=>!he),children:[pe,t.jsx("i",{children:"▾"})]}),U&&t.jsx("div",{className:"dolist",children:V.map(([he,Ne])=>t.jsx("button",{type:"button","aria-pressed":K===he,onClick:()=>{if(Q(!1),he==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}F(he),he!=="all"&&(ce(!1),A(!1),$(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:Ne},he))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:R=>r({type:"sort",key:R.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],["sector",n.sortSector],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([R,G])=>t.jsx("option",{value:R,children:G},R))})]}),o.showChain&&t.jsxs("span",{className:"chainwrap"+(se.length===0?" empty":""),children:[t.jsxs("button",{type:"button",className:"chain",disabled:se.length===0,title:n.chainHint,onClick:()=>{se.length&&r({type:"chainStart",queue:se.map(R=>R.id)})},children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(se.length):n.chainAll(se.length)]}),!o.pipe&&t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!W&&kt,a.dens!=="maxi"&&!W&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),je("country",n.colCountry),je("name",n.colCompany),je("amount",n.colAmount,"h-amt",!0),je("stage",n.colStage,"h-stade"),je("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[je("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),je("memo",n.colMemo)]}),o.pipe&&je("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),W?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[kt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),je("country",n.colCountry),je("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[je("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),je("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:Ct,children:Ot})]}),t.jsxs("aside",{className:"readpane"+((Ue?We(Ue):!h&&Fe)?" is-edito":""),"aria-label":f==="fr"?"Dossier":"File",children:[Fe&&(()=>{const R=a.focusId===Fe.id&&!Ve,G=(Fe.headline||Fe.tagline||"").trim();return t.jsxs("button",{type:"button",className:"edito-go pane-edito","aria-pressed":R,onClick:()=>{if(R){wt(!0);return}wt(!1),r({type:"focus",id:Fe.id})},children:[t.jsx("span",{className:"eg-t",children:f==="en"?"Today’s editorial":"Édito du jour"}),G&&t.jsx("span",{className:"eg-sub",children:G}),t.jsx("span",{className:"eg-chev",children:R?f==="en"?"Collapse ▴":"Replier ▴":f==="en"?"Read ▾":"Lire ▾"})]})})(),!!(Fe&&(Ue?We(Ue):!h))&&Ve?null:y&&a.focusId===y.id?t.jsx("div",{className:"zoom",children:t.jsx(ad,{})}):Ue&&o.pipe?t.jsx(vc,{o:Ue}):t.jsx(Ti,{o:Ue,extra:Ue?null:h})]})]}):t.jsx("div",{className:Ct,children:Ot}),(()=>{const R=be||[["pt"+a.ptab,ee]];let G=0,te=0;for(const[ae,V]of R){te+=V.length;let pe=a.shown[ae]||E();V.length-pe<=4&&(pe=V.length),G+=Math.min(V.length,pe)}const I=te-G;return I<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>R.forEach(([ae,V])=>r({type:"more",group:ae,by:V.length,base:E()})),children:[t.jsx("span",{className:"more-label",children:n.more(I,I)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(G,te)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(c.kept>0||c.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(c.kept,c.dropped)}}),W&&b==="ops"&&a.dens!=="maxi"&&t.jsx(uc,{on:!!be,rev:(be||[]).map(([R,G])=>R+G.length).join("|")})]})}function jo(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Nc(e,a){const r=Rs(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Sc(e,a){const n=[a.head.split("|").map(jo).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",Nc(o,a.plabels),ya(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(jo).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Cc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const zc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Xe({k:e,v:a,href:r,title:n,wide:o}){return a==null||a===""?null:t.jsxs("div",{className:"dsl"+(o?" dsw":""),children:[t.jsx("span",{children:e}),r?t.jsx("b",{children:t.jsx("a",{href:r,target:"_blank",rel:"noopener noreferrer",title:n,children:String(a)})}):t.jsx("b",{title:n,children:String(a)})]})}function oa({titre:e,html:a,note:r}){return a?t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:e}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:a}}),r&&t.jsx("p",{className:"dsnote",children:r})]}):null}function Ac({o:e,qa:a,comite:r}){const{t:n,lang:o,fund:i}=J(),d=(e.cribleStatus||"").trim().toUpperCase()||(ya(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=Ft(e),s=(a==null?void 0:a.blocs)||{},f=[[n.qaVP,s.value_prop],[n.qaProduct,s.produit],[n.qaModel,s.modele],[n.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(d==="NO MATCH"?" out":""),children:[d==="NO MATCH"?n.vOut:n.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Xe,{k:n.cdSector,v:e.sector}),t.jsx(Xe,{k:n.cdMarket,v:e.market,wide:!0}),t.jsx(Xe,{k:n.cdTags,v:(e.tags||[]).join(" · "),wide:!0}),t.jsx(Xe,{k:n.cdStage,v:e.stage}),t.jsx(Xe,{k:n.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Xe,{k:n.cdSite,v:e.domain||e.website}),t.jsx(Xe,{k:n.cdName,v:e.contactName}),t.jsx(Xe,{k:n.cdEmail,v:e.contactEmail}),t.jsx(Xe,{k:n.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Xe,{k:n.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Xe,{k:n.cdAngle,v:e.angle}),t.jsx(Xe,{k:n.cdDetected,v:zc(e.date,o)})]}),!!(e.provQuery||e.provUrl||Pa(e))&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsFound}),t.jsxs("div",{className:"dsgrid",children:[t.jsx(Xe,{k:n.cdQuery,v:e.provQuery,title:e.provQuery,wide:!0}),t.jsx(Xe,{k:n.cdSrc,v:Bn(e.provUrl||""),href:ba(e.provUrl||"")||void 0,title:e.provUrl}),t.jsx(Xe,{k:n.cdAngleSrc,v:Pa(e)})]})]}),f.some(([,c])=>c)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsAnalysis}),f.filter(([,c])=>c).map(([c,g])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:c}),t.jsx("p",{children:g})]},c))]}),(r==null?void 0:r.summary)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsExec}),t.jsx("p",{className:"dstxt",children:r.summary})]}),(r==null?void 0:r.swot)&&t.jsxs("section",{className:"dsswot-wrap",children:[t.jsx("h3",{children:n.dsSwot}),t.jsx("div",{className:"dsswot",children:[["s",n.dsSwotS,r.swot.s],["w",n.dsSwotW,r.swot.w],["o",n.dsSwotO,r.swot.o],["t",n.dsSwotT,r.swot.t]].map(([c,g,u])=>t.jsxs("div",{className:"dssq "+c,children:[t.jsx("b",{children:g}),t.jsx("ul",{children:u.map(b=>t.jsx("li",{children:b},b))})]},c))})]}),t.jsx(oa,{titre:n.dsSyn,html:r==null?void 0:r.syn,note:r!=null&&r.pruned.includes("syn")?n.dsTableNote:""}),t.jsx(oa,{titre:n.dsPnl,html:r==null?void 0:r.pnl,note:r!=null&&r.pruned.includes("pnl")?n.dsTableNote:""}),t.jsx(oa,{titre:n.dsCf,html:r==null?void 0:r.cf,note:r!=null&&r.pruned.includes("cf")?n.dsTableNote:""}),t.jsx(oa,{titre:n.dsRoi,html:r==null?void 0:r.roi,note:r!=null&&r.pruned.includes("roi")?n.dsTableNote:""}),t.jsx(oa,{titre:n.dsReco,html:r==null?void 0:r.reco}),(r==null?void 0:r.plan)&&t.jsxs("section",{className:"dsfin",children:[t.jsx("h3",{children:n.dsPlan}),t.jsx("div",{className:"dstbl",dangerouslySetInnerHTML:{__html:r.plan}})]}),e.memoUrl&&t.jsxs("p",{className:"dsannex",children:[n.dsAnnex," ",t.jsx("a",{href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",children:e.memoUrl})]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:n.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:n.dsFoot(i)})]})}function qc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:d,st:l}=J(),[s,f]=p.useState({}),[c,g]=p.useState({}),u=25,b=12,h=p.useMemo(()=>{if(l.dossierId){const m=n.find(y=>y.id===l.dossierId)||i.dossiers.find(y=>y.id===l.dossierId);return m?[m]:n.slice(0,u)}return n.slice(0,u)},[n,l.dossierId,i.dossiers]);p.useEffect(()=>{h.length&&Ro(r,h.map(m=>m.name)).then(f)},[r,h]),p.useEffect(()=>{const m=h.filter(k=>!!k.memoUrl).slice(0,b);if(!m.length){g({});return}let y=!1;const E={};return(async()=>{for(const k of m){if(y)return;try{const j=await zi(k.memoUrl||"");if(y)return;j&&Qp(j.comite)&&(E[k.id]=j.comite,g({...E}))}catch{}}})(),()=>{y=!0}},[h]);const w=i.stats,v=m=>m.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(h.length)}),!l.dossierId&&n.length>u&&t.jsx("span",{className:"mnote dim",children:e.dsCap(u,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),w&&typeof w.screened=="number"&&t.jsxs("p",{children:[v(w.screened)," ",e.funScreened(""),typeof w.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",v(w.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(v(i.marketEstimate)),", ",Math.round(w.screened/i.marketEstimate*100)," %"]})]})]}),h.map(m=>t.jsx(Ac,{o:m,qa:s[m.name],comite:c[m.id]},m.id)),!h.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Tc=50;function ar({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=J(),[i,d]=p.useState(null),[l,s]=p.useState(!1),[f,c]=p.useState(""),[g,u]=p.useState(0),[b,h]=p.useState(""),[w,v]=p.useState(!1),[m,y]=p.useState(0),E=p.useRef(null),k=p.useRef(null),j=()=>{y(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>y(L=>L+1),1e3)},N=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{E.current&&window.clearInterval(E.current),k.current&&window.clearInterval(k.current)},[]);const z=async L=>{s(!0),c(""),j();const O=await a();if(s(!1),N(),O.ok){d(O);return}if(O.busy){c(o.alertPreviewBusy);return}if(!L){c(o.alertPreviewFail);return}u(Tc),N(),E.current=window.setInterval(()=>{u(M=>M>1?M-1:(E.current&&window.clearInterval(E.current),z(!1),0))},1e3)},T=async()=>{if(n||w||l)return;v(!0),h(""),j();const L=await r();v(!1),N(),h(L.ok?o.alertTestOk(L.sentTo||""):L.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:l||w||g>0,onClick:()=>{z(!0)},children:l?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||w||l,onClick:()=>{T()},children:w?o.alertBtnTestBusy:o.alertTest})]}),l&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(m)]}),w&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(m)]}),g>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(g)}),f&&t.jsx("p",{className:"mnote warn",children:f}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const St="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ze({title:e,icon:a,children:r,wide:n,kind:o,lead:i}){const{dispatch:d}=J(),l=o==="plug"?"min(720px,100%)":"min(760px,100%)";return Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:s=>{s.target===s.currentTarget&&d({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard"+(o?" m-"+o:""),style:n?{width:l}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsxs("div",{className:"mh-txt",children:[t.jsx("h2",{children:e}),i&&t.jsx("p",{className:"mh-lead",children:i})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>d({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Lc(){const{st:e}=J();switch(e.modal){case"chain":return t.jsx(Rc,{});case"space":return t.jsx(Oc,{});case"alert":return t.jsx(Mc,{});case"queue":return t.jsx(Bc,{});case"export":return t.jsx($c,{});case"plug":return t.jsx(Vc,{});case"approach":return t.jsx(Wc,{});case"recharge":return t.jsx(Qc,{});case"cover":return t.jsx(Jc,{});case"dossier":return t.jsx(Kc,{});case"crit":return t.jsx(tu,{});case"tuto":return t.jsx(au,{});case"rdv":return t.jsx(Fc,{});case"memoalert":return t.jsx(Uc,{});default:return null}}function Fc(){const{dispatch:e,fund:a,t:r}=J(),n=a||r.rdvCoFallback;return Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:Io,children:Do}),r.rdvSubMid,t.jsx("a",{href:`mailto:${_a}`,children:_a})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],d)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(d+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(dl,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Rc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:d,evalBusy:l,caps:s,memoQueued:f,doAnalyse:c}=J(),g=i==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,h=u[b],w=b>=u.length;return Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:w?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(w?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:w||!h?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:h.name}),t.jsx("div",{className:"sub",children:[ea(h.cc,o)||h.countryLabel,h.sector,h.stage,n.daysAgo(gt(h.date))].filter(Boolean).map(v=>String(v)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:rt(h.engine,o)}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{children:Ht(h.amountEur,o)})]}),He(h)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Lt,{o:h,lg:!0})," ",t.jsx(en,{o:h,src:!0})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),h.reasoning&&!(g&&Ye(h))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),g&&Ye(h)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":It(h)==="retenu"?"var(--brand)":It(h)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:It(h)==="retenu"?"✓ "+n.kept:It(h)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:h.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!w&&h&&s.pipe&&Te(h)===1&&!f.has(h.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{c(h),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!w&&h&&!(g&&Ye(h))&&(h.noCo&&h.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(l?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:l,onClick:()=>{d(h)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(w?{type:"modal",modal:null}:{type:"chainNext"}),children:w?n.closeBtn:n.skip})]})]})})}),document.body)}function Oc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=J(),i=o==="client",d=p.useMemo(()=>i?r.filter(g=>Ye(g)):[],[r,i]),l=p.useMemo(()=>Gn(d.filter(g=>It(g)==="retenu"),{key:"signal",dir:-1}),[d]),s=p.useMemo(()=>d.filter(g=>It(g)==="ecarte"),[d]),f=e.spaceTab==="retenu"?l:s,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ze,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:l.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:s.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(g=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof g.score=="number"&&g.score>0?g.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:g.name}),t.jsx("div",{className:"rr",children:g.reasoning||g.tagline||""})]})]},g.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Mc(){const{mode:e}=J();return e==="client"||e==="apercu"?t.jsx(Dc,{}):t.jsx(_c,{})}function Dc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=J(),[i,d]=p.useState("d"),l=o!=="client";return t.jsxs(Ze,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>d("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>d("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>d("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(Ic,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="w"&&t.jsx(Pc,{t:e,token:a,readOnly:l,flash:r,flashErr:n}),i==="m"&&t.jsx(Li,{})]})}function Ic({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[l,s]=p.useState(!1),[f,c]=p.useState(0);p.useEffect(()=>{let T=!0;return s(!1),yr(a).then(L=>{T&&(L?d(L):s(!0))}),()=>{T=!1}},[a,f]);const g=p.useRef({}),[u,b]=p.useState({}),[h,w]=p.useState(!1),[v,m]=p.useState(!1),y=p.useRef(null);p.useEffect(()=>()=>{y.current&&window.clearTimeout(y.current)},[]);const E=T=>{const L=g.current;Object.keys(L).length&&(w(!0),yr(a,L).then(O=>{if(!O){w(!1),o(e.actErr);return}if(O.throttled&&T<3){y.current=window.setTimeout(()=>E(T+1),5400);return}if(g.current={},b({}),d(O),w(!1),O.throttled){o(e.alertThrottled);return}m(!0),window.setTimeout(()=>m(!1),2e3),n(e.alertSaved)}))},k=T=>{r||(g.current={...g.current,...T},b(L=>({...L,...T})),y.current&&window.clearTimeout(y.current),y.current=window.setTimeout(()=>E(1),700))};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(T=>T+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const j={...i,...u},N=T=>!j.sections||j.sections.includes(T),z=T=>{const L=j.sections||e.alertSec.map(([O])=>O);k({sections:N(T)?L.filter(O=>O!==T):[...L,T]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":j.enabled===!0,disabled:r,style:j.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!j.enabled}),children:j.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(j.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[j.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(j.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:j.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("p",{className:"mnote dim",children:e.alertRules}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,h&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!h&&v&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([T,L])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:N(T),disabled:r,onChange:()=>z(T)}),t.jsxs("span",{children:[L,T==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},T))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(ar,{label:e.alertPreview,readOnly:r,onPreview:()=>Gs(a),onTest:()=>Ws(a)}),j.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),j.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",j.email_lead,j.last_sent?` · ${e.updatedAt(j.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Pc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,d]=p.useState(null),[l,s]=p.useState(!1),[f,c]=p.useState(0);p.useEffect(()=>{let h=!0;return s(!1),kr(a).then(w=>{h&&(w?d(w):s(!0))}),()=>{h=!1}},[a,f]);const g=h=>{r||kr(a,h).then(w=>{if(!w){o(e.actErr);return}d(w),n(e.alertSaved)})};if(l)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(h=>h+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:h=>g({dow:Number(h.target.value)}),children:e.alertDow.map((h,w)=>t.jsx("option",{value:w,children:h},h))}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>g({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(ar,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Qs(a),onTest:()=>Ys(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Li(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=J(),[d,l]=p.useState(i||""),[s,f]=p.useState(!1),[c,g]=p.useState(!1);p.useEffect(()=>{i&&l(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(m=>He(m)).length,[n]),h=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,w=async()=>{if(!(!/.+@.+\..+/.test(d)||c)){g(!0);try{await fetch(`${wa}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:d.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{g(!1)}}},v=[[a.amRows.continent,o],[a.amRows.since,a.amSince[h]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(m=>rt(m,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(m=>ea(m,r)||m).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return s?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(d)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([m,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:m}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},m))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:d,readOnly:!!i,onChange:m=>l(m.target.value),onKeyDown:m=>{m.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function _c(){const{t:e}=J();return t.jsx(Ze,{title:e.alertTitle,icon:"🔔",children:t.jsx(Li,{})})}function Bc(){var x,A;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:d,caps:l,dispatch:s,liveMemos:f,data:c,flash:g}=J(),[u,b]=p.useState(()=>nn(r)),[h,w]=p.useState(()=>!nn(r)),[v,m]=p.useState([]),[y,E]=p.useState(0),[k,j]=p.useState(!1),N=n==="client",z=p.useMemo(()=>{const S=new Map;return o.forEach(P=>{const U=(P.name||"").trim().toLowerCase();U&&!S.has(U)&&S.set(U,P)}),S},[o]);p.useEffect(()=>{let S=!0;return(!nn(r)||y>0)&&w(!0),(async()=>{const[P,U]=await Promise.all([Vn(r,y>0),Po(a)]);S&&(P&&b(P),w(!1),m(U))})(),()=>{S=!1}},[a,r,y]);const T=h&&!u,L=(u==null?void 0:u.per_day)??0,O=((x=u==null?void 0:u.analyzed_today)==null?void 0:x.length)??0,M=u==null?void 0:u.offre,W=(u==null?void 0:u.pool_meta)||[],K=p.useMemo(()=>{const S=new Map;for(const P of(u==null?void 0:u.scheduled)||[])for(const U of P.names||[])S.has(U)||S.set(U,{label:P.day_label,date:P.date});return S},[u==null?void 0:u.scheduled]),F=(u==null?void 0:u.in_progress)||[];return t.jsxs(Ze,{title:e.queueTitle,wide:!0,children:[M&&t.jsxs("div",{className:"qoffre"+(M.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:M.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:M.delai})]}),t.jsx("span",{className:"osp"}),M.rythme>0?t.jsx("span",{className:"or",children:e.qRate(M.rythme)}):M.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(M.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:T?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(O,O+(((A=u==null?void 0:u.pool_order)==null?void 0:A.length)??0))}})}),M&&t.jsxs("div",{className:"qeta",children:[M.file===0?e.qEtaDone:M.rythme<=0?e.qEtaPaused:e.qEta(M.file,M.rythme,M.jours_restants),M.en_retard&&t.jsxs("em",{children:[" ",e.qLate(M.delai,M.plafond)]})]}),!T&&t.jsxs("div",{className:"qrate",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate})," — ",t.jsx("b",{children:e.covRateNow(L)}),(M==null?void 0:M.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]}),N&&t.jsx("div",{className:"covrb",role:"group","aria-label":e.covRate,children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:L===S?"on":"",disabled:k,title:S===0?e.identPauseTitle:e.covRateNow(S),onClick:()=>{k||!a||(j(!0),_o(a,S).then(P=>{j(!1),P!==null&&(b(U=>U&&{...U,per_day:P}),g(e.alertSaved))}))},children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint}),!!c.credits&&!c.credits.unlimited&&!!(c.credits.packs||[]).length&&t.jsxs("div",{className:"qpacks-mini",children:[t.jsxs("span",{children:[e.creditsCap," ",c.credits.total_available,"/",c.credits.daily_grant+c.credits.purchased," · ",e.creditsPacksLbl]}),t.jsx("div",{children:c.credits.packs.map(S=>t.jsxs("button",{type:"button",className:"qpack-mini",onClick:()=>{const P=c.email;if(!P)return;const U=window.location.href.split("?")[0];fetch(`${wa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:P,lookup_key:S.lookup_key,success_url:U+"?credits=ok",cancel_url:U+"?credits=cancel"})}).then(Q=>Q.json()).then(Q=>{Q.url&&(window.location.href=Q.url)}).catch(()=>{})},children:[S.credits," · ",S.price_eur," €"]},S.lookup_key))})]})]})]}),(F.length>0||f.items.some(S=>S.status==="boot"||S.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(S=>S.status==="boot"||S.status==="running"||S.status==="error").map(S=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:S.name}),t.jsx("span",{className:"qd",children:S.memoType||""}),t.jsx(Ba,{item:S,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+S.name)),F.filter(S=>!f.liveOf(S.name)).map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.name}),t.jsxs("span",{className:"qd",children:[S.memo_type||"",S.age_min?` · ${Math.round(S.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:S.state||""})]},"ip-"+S.name))]})]}),v.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:v.map(S=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:S.company}),t.jsxs("span",{className:"qd",children:[S.memo_type,typeof S.est_min=="number"?` · ~${S.est_min} min`:""]}),t.jsx("span",{className:"qt",children:S.status}),S.url&&t.jsx("a",{className:"qgo",href:S.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(S.memo_type)}),N&&S.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{vr(a,S.company,"retry").then(()=>E(P=>P+1))},children:e.queueRetry}),N&&S.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{vr(a,S.company,"delete").then(()=>E(P=>P+1))},children:e.queueDelete})]},S.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",T?e.qUpNextWait:e.qUpNext(W.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[T&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!T&&W.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),W.map((S,P)=>{const U=K.get(S.name),Q=z.get((S.name||"").trim().toLowerCase()),ne=f.liveOf(S.name),C=!!(Q&&d.has(Q.id))||!!(ne&&(ne.status==="boot"||ne.status==="running")),B=!!(Q&&Te(Q)===1&&!Q.memoUrl)&&!ne;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",P+1]}),U?t.jsx("span",{className:"qwhen"+(U.label==="demain"?" soon":""),children:U.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:S.name}),S.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof S.score=="number"&&t.jsx("span",{className:"qs2",children:S.score}),ne&&(ne.status==="boot"||ne.status==="running")&&t.jsx(Ba,{item:ne,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),B&&(l.lockActions||!N?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>s({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:C,onClick:()=>{i(Q),E(D=>D+1)},children:C?e.actAnalyseQueued:e.actAnalyse})),S.excerpt&&t.jsx("span",{className:"qex",children:S.excerpt})]},S.name+":"+P)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([S,P])=>t.jsxs("li",{children:[t.jsx("b",{children:S})," — ",P]},S))})]})}function $c(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:d}=J(),l=`${St}/cibles/list.csv?token=${a}`,s=`${St}/cibles/list.json?token=${a}`,f=`${St}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${l}")`,g=v=>{var m;(m=navigator.clipboard)==null||m.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:l,href:l},{def:e.exportSheet,value:c},{def:e.exportLive,value:s,href:s},{def:e.exportXlsx,value:f,href:f}],b=!o.lockActions&&n.length>0,h=()=>{Cc(Sc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:v=>(e.stg.find(([m])=>m===v)||["",""])[1]})),r(e.exportViewDone(n.length))},w=()=>{d({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ze,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:w,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:h,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:m,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>g(m),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Uc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=J(),i=o!=="client",[d,l]=p.useState(null),[s,f]=p.useState(!1),[c,g]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let m=!0;return f(!1),xr(a).then(y=>{m&&(y?l(y):f(!0))}),()=>{m=!1}},[a,c]);const h=()=>(d==null?void 0:d.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},w=m=>{if(i||!d)return;const y={enabled:m.enabled??!!d.enabled,email:m.email??(d.email||""),sections:m.sections??h()};b(!0),xr(a,y).then(E=>{if(b(!1),!E){n(e.memoAlertErr);return}l(E),r(e.memoAlertSaved)})};if(s)return t.jsx(Ze,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>g(m=>m+1),children:e.retry})]})});if(!d)return t.jsx(Ze,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=h();return t.jsxs(Ze,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":d.enabled===!0,disabled:i||u,style:d.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>w({enabled:!d.enabled}),children:d.enabled?"ON":"OFF"})})]}),t.jsx(Hc,{value:d.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:m=>w({email:m})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([m,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[m],disabled:i||u,onChange:()=>w({sections:{...v,[m]:!v[m]}})}),t.jsx("span",{children:y})]},m))}),t.jsx(ar,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>Ms(a,v),onTest:()=>Os(a,v)})]})}function Hc({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,d]=p.useState(e);p.useEffect(()=>{d(e)},[e]);const l=i.trim()!==e.trim(),s=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:f=>d(f.target.value),onKeyDown:f=>{f.key==="Enter"&&l&&s&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!l||!s,onClick:()=>o(i.trim()),children:n})]})]})}function Vc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=J(),[i,d]=p.useState(null),[l,s]=p.useState(!1),[f,c]=p.useState(null),[g,u]=p.useState(!1),[b,h]=p.useState(""),[w,v]=p.useState(0),[m,y]=p.useState("webhook"),[E,k]=p.useState("webhook"),[j,N]=p.useState(""),z=p.useRef(!1);p.useEffect(()=>{let S=!0;return s(!1),br(a).then(P=>{S&&(P?d({configured:P.configured,url_hint:P.url_hint}):s(!0))}),_s(a).then(P=>{if(S){if(!P){u(!0);return}u(!1),c(P),z.current||(z.current=!0,P.destination==="instantly"&&(y(U=>U==="webhook"?"instantly":U),k(U=>U==="webhook"?"instantly":U)),P.campaign_id&&N(U=>U||P.campaign_id||""))}}),()=>{S=!1}},[a,w]);const T=(S,P)=>{o&&br(a,S).then(U=>{if(!U||U.ok===!1){n(e.actErr);return}S.test&&U.sent===!1?n(e.plugTestThrottled):r(P),v(Q=>Q+1)})},L='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',O=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),M=`curl -X POST ${St}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,W=`curl -X POST ${St}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`,K=[{k:"webhook",t:e.plugDestCrm,s:e.plugDestCrmS},{k:"instantly",t:e.plugDestInst,s:e.plugDestInstS},{k:"script",t:e.plugDestScript,s:e.plugDestScriptS}],F=E==="instantly"?e.plugStep2Inst:E==="script"?e.plugStep2Script:e.plugStep2Wh,x=E==="instantly"?e.plugAideInst:E==="script"?e.plugAideScript:e.plugAideWh,A=S=>{k(S),S!=="script"&&y(S)};return t.jsxs(Ze,{title:e.plugTitle,icon:"🔌",wide:!0,kind:"plug",lead:e.plugLead,children:[f&&t.jsxs("div",{className:"plugetat"+(f.enabled?" on":""),children:[t.jsx("i",{}),t.jsx("b",{children:f.enabled?e.plugEtatOn:e.plugEtatOff})]}),l?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>v(S=>S+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"1"}),t.jsx("h4",{children:e.plugStep1})]}),t.jsx("div",{className:"plugdests",children:K.map(S=>{const P=E===S.k;return t.jsxs("button",{type:"button",className:"plugdest"+(P?" on":""),onClick:()=>A(S.k),children:[t.jsx("span",{className:"pradio","aria-hidden":"true"}),t.jsx("b",{children:S.t}),t.jsx("em",{children:S.s})]},S.k)})}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"2"}),t.jsx("h4",{children:F})]}),E==="script"?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}):E==="instantly"?t.jsx("div",{className:"mfield pill",children:t.jsx("input",{type:"text",maxLength:80,placeholder:e.plugCampPh,value:j,disabled:!o,onChange:S=>N(S.target.value)})}):t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"mfield pill",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:S=>h(S.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>T({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>T({remove:!0},e.plugRemoved),children:e.plugRemove})]})]}),t.jsx("p",{className:"mnote dim",children:x}),t.jsxs("div",{className:"plugstep",children:[t.jsx("span",{className:"pnum",children:"3"}),t.jsx("h4",{children:e.plugStep3})]}),t.jsx(Gc,{auto:f,autoKo:g,destKind:m,camp:j,onRetry:()=>v(S=>S+1),onDone:S=>{c(S),u(!1)}}),t.jsx("p",{className:"mnote dim",children:e.plugHow3}),t.jsxs("details",{className:"plugex plugpay",children:[t.jsxs("summary",{children:[t.jsx("b",{children:e.plugExT}),t.jsx("span",{children:e.plugPayloadSub})]}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:O}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(O).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult}),t.jsx("p",{className:"mnote dim",children:e.plugVars})]}),t.jsx("div",{"data-tour":"plug-bulk",children:t.jsx(Yc,{destKind:m,setDestKind:S=>{y(S),k(S)},camp:j,setCamp:N,whHint:i!=null&&i.configured?i.url_hint||"webhook":null})}),E!=="script"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:M}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(M).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota})]}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm","data-tour":"plug-crm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:W}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var S;(S=navigator.clipboard)==null||S.writeText(W).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugEnrichT})}),t.jsx("p",{className:"mnote",children:e.plugEnrich}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugEnrich1}),t.jsx("p",{className:"mnote",children:e.plugEnrich2}),t.jsx("p",{className:"mnote",children:e.plugEnrich3}),t.jsx("p",{className:"mnote dim",children:e.plugAirtable}),t.jsx("p",{className:"mnote dim",children:e.plugExcel})]})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugScoreT})}),t.jsx("p",{className:"mnote",children:e.plugScore})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Wc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:d,lang:l}=J(),s=p.useMemo(()=>r.find(x=>x.id===n.approachId)||null,[r,n.approachId]),[f,c]=p.useState("email"),[g,u]=p.useState(0),[b,h]=p.useState({}),[w,v]=p.useState(!1),[m,y]=p.useState(""),[E,k]=p.useState({});if(p.useEffect(()=>{!s||b[f]||w||(v(!0),y(""),Ps(a,s.name,f).then(x=>{if(v(!1),!x||x.ok===!1){y((x==null?void 0:x.error)||e.apprFail);return}h(A=>({...A,[f]:x}))}))},[s,f,a]),!s)return null;const j=b[f],N=(j==null?void 0:j.sequence)||[],z=N[g],T=x=>`${f}|${g}|${x}`,L=x=>{const A=T(x);return A in E?E[A]:String(((z==null?void 0:z[x])??"")||"")},O=(x,A)=>k(S=>({...S,[T(x)]:A})),M=T("subject")in E||T("body")in E||T("message")in E,W=L(f==="email"?"body":"message"),K=L("subject"),F=f==="email"&&K?`${K}

${W}`:W;return t.jsxs(Ze,{title:e.apprT(s.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(x=>t.jsx("button",{type:"button",className:"apch"+(f===x?" on":""),"aria-pressed":f===x,onClick:()=>{c(x),u(0)},children:x==="email"?e.apprChEmail:e.apprChLi},x)),t.jsx("span",{className:"sp"}),N.map((x,A)=>t.jsxs("button",{type:"button",className:"apday"+(g===A?" on":""),"aria-pressed":g===A,onClick:()=>u(A),children:[x.day||`J${A}`,[`${f}|${A}|subject`,`${f}|${A}|body`,`${f}|${A}|message`].some(S=>S in E)&&t.jsx("i",{children:"✎"})]},x.day||A))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,j!=null&&j.sender?" · "+e.apprSender(j.sender):""]}),w&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!m&&!w&&t.jsxs("p",{className:"mnote warn",children:[m," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{h(x=>{const A={...x};return delete A[f],A}),y("")},children:e.retry})]}),!w&&!m&&!z&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),z&&t.jsxs(t.Fragment,{children:[f==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:K,onChange:x=>O("subject",x.target.value)})]}),f==="linkedin"&&g===0&&(j==null?void 0:j.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:W,onChange:x=>O(f==="email"?"body":"message",x.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var x;(x=navigator.clipboard)==null||x.writeText(F).then(()=>i(e.exportCopied)).catch(()=>d(e.actErr))},children:e.apprCopy}),f==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(s.contactEmail||"")}?subject=${encodeURIComponent(K)}&body=${encodeURIComponent(W)}`,children:e.apprMailto}),M&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Gc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:d,token:l,flash:s,flashErr:f,canWrite:c}=J(),[g,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[d.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:d.retry})]})]}):null;const b=!!e.enabled,h=!b&&(r==="webhook"?e.webhook_ready===!1?d.plugAutoNeed:"":n.trim()?"":d.plugCampNeed),w=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,v=()=>{if(g||!c||h)return;u(!0),(b?wr(l,!1):wr(l,!0,r,n.trim()||void 0)).then(y=>{if(u(!1),!y){f(d.actErr);return}o(y),s(y.enabled?d.plugAutoSavedOn:d.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:d.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:d.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:g||!c||!!h,title:h||void 0,onClick:v,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:d.plugAutoOnLbl})]}),h===d.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:h}),w&&t.jsx("p",{className:"mnote warn",children:d.plugAutoBroken})]})}function Yc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:d,lang:l,canWrite:s}=J(),[f,c]=p.useState("valides"),[g,u]=p.useState(!1),[b,h]=p.useState(null),[w,v]=p.useState(null),[m,y]=p.useState(!1),[E,k]=p.useState(!1),[j,N]=p.useState(null),[z,T]=p.useState(null),L=`atl2:bulk:${d}:${f}:${e}`;p.useEffect(()=>{h(null),v(null),y(!1),N(null);try{const Q=localStorage.getItem(L)||localStorage.getItem(`atl2:bulk:${d}:${f}`),ne=JSON.parse(Q||"null");T(ne&&Date.now()-Date.parse(ne.t)<24*3600*1e3?ne:null)}catch{T(null)}},[L,f,d]);const O=e==="instantly"&&!r.trim(),M=`${f}|${e}|${r.trim()}`,W=async()=>{if(O||!s)return;u(!0),y(!1),N(null);const Q=await Hs(d,f,e,r.trim()||void 0);h(Q),v(Q.ok?M:null),u(!1)},K=p.useRef(!1);if(!s)return null;const F=async()=>{if(K.current||!s)return;K.current=!0,k(!0);const Q=`${d}:${f}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let ne;try{ne=await Vs(d,f,e,r.trim()||void 0,Q)}finally{K.current=!1}if(k(!1),y(!1),N(ne),ne.ok&&(ne.pushed||0)>0){const C={t:new Date().toISOString(),n:ne.pushed||0};T(C);try{localStorage.setItem(L,JSON.stringify(C))}catch{}}};m&&w!==null&&w!==M&&y(!1);const x=o,A=b!=null&&b.ok&&b.ready||0,S=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":x||"",P=!!(b!=null&&b.ok)&&w===M&&A>0&&!!S&&!z,U=z?new Date(z.t).toLocaleString(l==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:f,onChange:Q=>c(Q.target.value),children:i.plugBulkTabs.map(([Q,ne])=>t.jsx("option",{value:Q,children:ne},Q))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:Q=>a(Q.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:Q=>n(Q.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:g||O,onClick:()=>{W()},children:g?"…":i.plugBulkPreview})]}),O&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),z&&t.jsx("p",{className:"mnote",children:i.bulkLocked(U,z.n)}),!z&&!!(b!=null&&b.ok)&&!S&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!z&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),P&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>y(!0),children:i.bulkArm}),P&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(A,S)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:E,onClick:()=>{F()},children:E?i.bulkSending:i.bulkConfirm(S)}),t.jsx("button",{type:"button",className:"abtn",disabled:E,onClick:()=>y(!1),children:i.bulkCancel})]}),j&&(j.ok?j.replayed?t.jsx("p",{className:"mnote",children:j.pending?i.bulkPending:i.bulkReplayed}):(j.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(j.pushed||0,j.linkedinReady||0,j.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:j.error||i.actErr}))]})}function Qc(){const{t:e,data:a,lang:r}=J(),n=a.credits,o=a.email,i=async d=>{if(!o)return;const l=window.location.href.split("?")[0];try{const f=await(await fetch(`${wa}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:d,success_url:l+"?credits=ok",cancel_url:l+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(Ze,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(d=>t.jsxs("div",{className:"pack",children:[t.jsx("b",{className:"pk-n",children:d.credits}),t.jsx("span",{className:"pk-u",children:e.creditsUnit}),t.jsxs("span",{className:"pk-p",children:[d.price_eur," €"]}),t.jsx("button",{type:"button",onClick:()=>{i(d.lookup_key)},children:e.rechargeBuy})]},d.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Kc(){const{t:e}=J();return t.jsx(Ze,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(qc,{})})}function Jc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:d,flash:l}=J(),[s,f]=p.useState(null),[c,g]=p.useState(!1);p.useEffect(()=>{let L=!0;if(i)return Vn(i).then(O=>{L&&O&&typeof O.per_day=="number"&&f(O.per_day)}),()=>{L=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let L=!0;return Is(o).then(O=>{L&&b(O)}),()=>{L=!1}},[o]);const h=r.stats,w=typeof(h==null?void 0:h.screened)=="number"?h.screened:n.filter(L=>L.kind==="target"&&Ye(L)).length,v=r.marketEstimate||0,m=v>0?Math.min(100,Math.round(w/v*100)):null,y=(h==null?void 0:h.window_days)||30,E=w>0?w/y:0,k=v>0?Math.max(0,v-w):0,N=v>0&&E>0&&w>=100?Math.round(k/E):null,z=L=>Math.round(L).toLocaleString(a==="en"?"en-US":"fr-FR"),T=L=>{c||!d||(g(!0),_o(o,L).then(O=>{if(g(!1),O===null){l(e.actErr);return}f(O),l(e.alertSaved)}))};return t.jsxs(Ze,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(z(w))}),v>0&&t.jsx("span",{children:e.covOf(z(v))})]}),m!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:m+"%"}}),t.jsxs("em",{children:[m," %"]})]}),N!==null&&t.jsx("p",{className:"mnote",children:e.covEta(N)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(z(E))}),h&&t.jsxs("div",{className:"covf",children:[typeof h.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(h.kept)})," ",e.covKept]}),typeof h.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(h.analyzed)})," ",e.covAna]}),typeof h.shown=="number"&&h.shown!==h.kept&&t.jsxs("span",{children:[t.jsx("b",{children:z(h.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((L,O)=>t.jsxs("tr",{className:L.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[L.code,L.geo?` · ${L.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof L.n=="number"?z(L.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:L.source}),L.elargi&&t.jsx("em",{children:e.covWide(String(L.demande||""))}),L.erreur&&t.jsx("em",{children:e.covMissing})]})]},O)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:z(u.total||v)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),d&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(L=>t.jsx("button",{type:"button",className:s===L?"on":"",disabled:c,onClick:()=>T(L),children:L===0?"⏸":L},L))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function Fi(e,a,r){const n=await fetch(`${St}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(d=>window.setTimeout(d,5e3));const i=await fetch(`${St}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(d=>d.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Xc(){const{t:e,token:a,canWrite:r}=J(),[n,o]=p.useState(null),[i,d]=p.useState(""),[l,s]=p.useState(""),[f,c]=p.useState(!1),g=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=p.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const h=JSON.parse(localStorage.getItem(g)||"null");return!!h&&Date.now()-(h.t||0)<14*24*3600*1e3}catch{return!1}},[g,n==null?void 0:n.pattern]);if(p.useEffect(()=>{if(!r)return;let h=!0;return $s(a).then(w=>{h&&o(w)}),()=>{h=!1}},[a,r]),!r||f||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{d("run"),Fi(a,n.instruction||"","atelier2-avis").then(h=>{if(d(h.applied?"ok":"ko"),h.applied||s(h.encours?e.propSlow:h.reply),h.applied)try{localStorage.setItem(g,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:l||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{c(!0);try{localStorage.setItem(g,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Zc(){var j;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=J(),[i,d]=p.useState(!1),[l,s]=p.useState(null),[f,c]=p.useState(!1),[g,u]=p.useState([]),[b,h]=p.useState(null),[w,v]=p.useState([]);if(!r)return null;const m=()=>{d(!0),c(!1),u([]),v([]),Us(a).then(N=>{if(d(!1),!N){c(!0),s(null);return}s(N)})},y=N=>{b||(h(N.title),Fi(a,N.instruction,"atelier2-prop").then(z=>{h(null),z.applied?(v(T=>[...T,N.title]),n(e.propApplied)):z.encours?n(e.propSlow):o(z.reply||e.propApplyFail)}))},E=((l==null?void 0:l.proposals)||[]).filter(N=>!g.includes(N.title)&&!w.includes(N.title)),k=((j=l==null?void 0:l.counts)==null?void 0:j.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:m,children:i?e.propWait:e.propBtn}),!i&&f&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!f&&l&&!(l.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:l.reason==="not_enough_signals"?e.propFew(k):e.propNone}),E.map(N=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[N.section]||N.section}),t.jsx("p",{className:"propt",children:N.title}),N.why&&t.jsx("p",{className:"mnote dim",children:N.why}),N.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",N.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>y(N),children:b===N.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(z=>[...z,N.title]),children:e.propSkip})]})]},N.title))]})}function eu(){const{t:e,token:a,canWrite:r,flash:n,flashErr:o,lang:i,data:d}=J(),[l,s]=p.useState(null),[f,c]=p.useState(!1),[g,u]=p.useState(!1),[b,h]=p.useState(""),[w,v]=p.useState(""),[m,y]=p.useState(!1),E=p.useRef(!1);if(p.useEffect(()=>{if(!a||!r)return;let N=!0;return Bs(a).then(z=>{N&&(c(!0),!(!z||E.current)&&(s(z),h(z.fit),v(z.note)))}),()=>{N=!1}},[a,r]),!r)return null;const k=()=>{if(!(!b||m)){if(l&&l.fit===b&&l.note===w.trim()){u(!1);return}y(!0),jt(a,"thesis_fit",b,w.trim(),"",d.email||"").then(N=>{if(y(!1),!N.ok){o(e.fitKo);return}s({fit:b,note:w.trim(),ts:new Date().toISOString()}),u(!1),n(e.fitSaved)})}},j=N=>N==="yes"?e.fitYes:N==="partial"?e.fitPartial:e.fitNo;if(l&&!g){const N=new Date(String(l.ts||"")),z=Number.isNaN(N.getTime())?"":N.toLocaleDateString(i==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit"});return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitDone}),t.jsxs("p",{className:"fitrep",children:[t.jsx("b",{children:j(l.fit)}),l.note?` — ${l.note}`:""]}),!!z&&t.jsx("p",{className:"mnote dim",children:z}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(!0),children:e.fitEdit})]})}return t.jsxs("div",{className:"rule fitbox",children:[t.jsx("b",{children:e.fitTitle}),t.jsx("p",{children:e.fitSub}),t.jsx("div",{className:"fitopts",children:["yes","partial","no"].map(N=>t.jsx("button",{type:"button","aria-pressed":b===N,className:"fitopt"+(b===N?" on":""),onClick:()=>{E.current=!0,h(N)},children:j(N)},N))}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{type:"text",maxLength:400,placeholder:e.fitPh,value:w,onChange:N=>{E.current=!0,v(N.target.value)},onKeyDown:N=>{N.key==="Enter"&&k()}}),t.jsx("button",{type:"button",className:"abtn",disabled:!b||m,onClick:k,children:m?"…":e.fitSend})]}),t.jsx("p",{className:"mnote dim",children:e.fitSeen}),!f&&t.jsx("p",{className:"mnote dim",children:"…"})]})}function tu(){var m,y,E;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:d,lang:l}=J(),s=n==="client",f=p.useMemo(()=>{const k=new Set;return a.forEach(j=>{j.angle&&k.add(j.angle)}),[...k]},[a]),[c,g]=p.useState(""),[u,b]=p.useState(""),[h,w]=p.useState(!1),v=async()=>{const k=c.trim();if(!(!k||h||!s)){w(!0),b("");try{const N=await(await fetch(`${St}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(N.reply&&b(String(N.reply)),N.job_id){b(e.critChatRunning);const z=async()=>{const T=await fetch(`${St}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:N.job_id})}).then(L=>L.json()).catch(()=>null);if(T&&T.done){b(String(T.reply||T.clarification||T.summary||"✓")),w(!1),T.applied&&o(e.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),g("");return}g("")}finally{u.startsWith("⏳")||w(!1)}}};return t.jsxs(Ze,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-hyp",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((m=i.points)!=null&&m.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=i==null?void 0:i.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-prof",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var j,N;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((j=k.look)!=null&&j.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(z=>t.jsx("li",{children:z},z))})]}),!!((N=k.out)!=null&&N.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(z=>t.jsx("li",{children:z},z))})]})]})]},k.title)})]}),!!((E=i==null?void 0:i.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok","data-tour":"crit-gate",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(eu,{}),t.jsx(Xc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!s||h,onChange:k=>g(k.target.value),onKeyDown:k=>{k.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(h?" loading":""),style:{padding:"12px 18px"},disabled:!s||h||!c.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Zc,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Ds,{fund:d,lang:l,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Ai[k]||"v-cons"),children:k}),t.jsx("span",{children:j})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,j])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",j]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function au(){const{t:e,dispatch:a,startTour:r}=J(),n=o=>{var i,d;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(d=document.querySelector(".atl2 .demand input"))==null||d.focus())};return t.jsxs(Ze,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],d)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&(l.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:d+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+d))})]})}const Ri="atl2:mapfold",nu=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Ri);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},ru=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Oi=p.createContext(null),J=()=>{const e=p.useContext(Oi);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Lt({o:e,lg:a}){const{lang:r}=J(),n=He(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Er(n,r),children:[n.emoji," ",Er(n,r)]}):null}function en({o:e,src:a}){const{lang:r,t:n}=J(),o=He(e);if(!o)return null;const i=al(o),d=nl(o);return t.jsxs("em",{className:"sigwin"+(d?" hot":""),title:n.signaledOn(Oo(o,r))+" · "+n.win7(Mo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(l,s)=>t.jsx("i",{className:s<i?"on":""},s))}),t.jsx("span",{className:"lb",children:d?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:l=>l.stopPropagation(),children:"↗"})]})}function ou(e,a,r){const n=(r||"").trim();if(n){const i=e.find(d=>(d.url||"")===n);if(i)return i}const o=Ge(a);if(o)return e.find(i=>Ge(i.name)===o)||e.find(i=>{const d=Ge(i.name);return d.length>=3&&(o.includes(d)||d.includes(o))})}function iu(){const{scoped:e,t:a,st:r,dispatch:n}=J(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,d=e.filter(g=>!We(g)),l=d.length,s=d.filter(g=>!g.noCo).length,f=d.filter(g=>!!g.noCo).length,c=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:c?"7":"all"}});else{const g=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:g,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",s," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",f," ",a.zoomPulseExplore]})]})]})}function su(){var w;const{t:e,lang:a,data:r,dispatch:n,dossiers:o,st:i,caps:d}=J(),l=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR"),s={...i,filters:{...i.filters,win:"all",day:""}},f=o.filter(v=>!We(v)&&Pt(v,s,d.pipe)),c=f.length,g=f.filter(v=>Te(v)===1).length,u=f.filter(v=>Te(v)===2).length,b=typeof((w=r.stats)==null?void 0:w.screened)=="number"?r.stats.screened:0;if(c<=0&&b<=0)return null;const h=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:l(c)}),t.jsx("span",{children:h>0?e.covOf(l(h)):e.covScreened("").trim()}),t.jsxs("ul",{children:[t.jsxs("li",{children:["✅ ",l(g)," ",e.covKept]}),t.jsxs("li",{children:["⚡ ",l(u)," ",e.covAna]})]})]})}function lu(){var v;const{t:e,token:a,fund:r,dispatch:n,data:o}=J(),[i,d]=p.useState(null),[l,s]=p.useState(!0),[f,c]=p.useState([]),g=o.credits,u=!!g&&!g.unlimited;p.useEffect(()=>{if(!a||!r)return;let m=!0;return s(!0),(async()=>{const[y,E]=await Promise.all([Vn(r),Po(a)]);m&&(y&&d(y),s(!1),c(E))})(),()=>{m=!1}},[a,r]);const b=(i==null?void 0:i.per_day)??null,h=((v=i==null?void 0:i.pool_order)==null?void 0:v.length)??0,w=f.filter(m=>m.status==="running").length;return t.jsxs("div",{className:"map-pulse map-engine",children:[t.jsxs("button",{type:"button",className:"map-engine-hit",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("em",{children:e.identEngine}),t.jsx("b",{children:b===null?"—":b}),t.jsx("span",{children:e.identPerDay}),t.jsxs("ul",{children:[b===0&&t.jsx("li",{children:t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause})}),w>0&&t.jsxs("li",{children:["⏳ ",w]}),t.jsx("li",{children:l?e.identPendingWait:e.identPending(h)})]})]}),t.jsxs("button",{type:"button",className:"map-engine-alert",title:e.memoAlertSub,onClick:()=>n({type:"modal",modal:"memoalert"}),children:["🔔 ",e.memoAlertBtn]}),u&&g&&t.jsxs("div",{className:"map-engine-credits",children:[t.jsx("em",{children:e.creditsCap}),t.jsxs("b",{children:[g.total_available,t.jsxs("span",{children:[" / ",g.daily_grant+g.purchased]})]}),t.jsx("span",{children:e.creditsToday})]})]})}function Mi({o:e}){const{lang:a}=J(),r=tl(e.cc),n=e.cc?ea(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:16,height:16,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const du=!1;function pu(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Di=e=>`atl2:tour:${e||"anon"}`;function cu(e){try{return localStorage.getItem(Di(e))==="1"}catch{return!0}}function No(e){try{localStorage.setItem(Di(e),"1")}catch{}}function uu(e,a,r,n,o,i,d,l){const s=e.tourT,f=e.howto;return[{sel:".atl2 .ident",title:s.ident,body:e.fhintIdent},o?{sel:".atl2 .map-pulse",title:s.cover,body:e.fhintCover,need:".atl2 .map-hud"}:null,{sel:".atl2 .map-engine",title:s.engine,body:`${e.fhintEngine}
${e.fhintMemoDepths}`},{sel:".atl2 .ticker",title:s.live,body:e.fhintLive},{sel:".atl2 .goal",title:s.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:s.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:s.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:s.tuto,body:f[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:s.demand,body:f[1][0]},{sel:".atl2 .dmulti.ddeals",title:s.deals,body:e.fhintDeals},{sel:".atl2 .dmulti.dnews",title:s.news,body:e.fhintNews},{sel:".atl2 .c-vd",need:".atl2 .list",title:s.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:s.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:s.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:s.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:s.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:s.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,d>0?{sel:".atl2 .stg",need:".atl2 .list",title:s.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,d>0?{sel:".atl2 .approach",need:".atl2 .list",title:s.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-bulk"]',need:".atl2 .ic[data-tour=plug]",title:s.campout,body:e.fhintCampout,modal:"plug"}:null,d>0?{sel:'.atl2 .modal.on [data-tour="plug-crm"]',need:".atl2 .ic[data-tour=plug]",title:s.addcrm,body:e.fhintAddcrm,modal:"plug"}:null,...[2,4,5].filter(c=>(l[c]||0)>0).map(c=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:c===2?s.tabAna:c===4?s.tabValid:s.tabRej,body:c===2?e.fhintTabAna:c===4?e.fhintTabValid:e.fhintTabRej,ptab:c})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:s.rank,body:e.fhintRank},{sel:".atl2 .learn",title:s.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:s.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:s.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:s.tools,body:f[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:s.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:s.crit,body:f[0][0],modal:"crit"},{sel:'.atl2 [data-tour="crit-hyp"]',title:s.mHyp,body:e.fhintMHyp,modal:"crit"},{sel:'.atl2 [data-tour="crit-prof"]',title:s.mProf,body:e.fhintMProf,modal:"crit"},{sel:'.atl2 [data-tour="crit-gate"]',title:s.mGate,body:e.fhintMGate,modal:"crit"}].filter(Boolean)}function xu({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var nr;const{lang:d}=Ks(),l=Wl(e,d,a),s=p.useMemo(()=>({...Fl[d],...Ll(d,l.thesisMode)}),[d,l.thesisMode]),[f,c]=p.useReducer(Ql,void 0,()=>Gl((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?ru():nu()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),g=p.useRef(!0);p.useEffect(()=>{if(g.current){g.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Ri,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const q=()=>{window.innerWidth<=760&&c({type:"mapFold",folded:!0})};return q(),window.addEventListener("resize",q),()=>window.removeEventListener("resize",q)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var q;(q=u.current)==null||q.call(u,f.filters)},[f.filters]);const[b,h]=p.useState(()=>{if(typeof window>"u")return"both";try{const q=localStorage.getItem("atl2:chrome-mode");if(q==="eval"||q==="filt"||q==="both")return q;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[w,v]=p.useState(null),[m,y]=p.useState(null),[E,k]=p.useState(null),[j,N]=p.useState({kept:0,dropped:0}),[z,T]=p.useState(!1),[L,O]=p.useState(""),[M,W]=p.useState(!1),[K,F]=p.useState(null),[x,A]=p.useState(null),[S,P]=p.useState(!1),[U,Q]=p.useState(!1),[,ne]=p.useState(0),C=()=>ne(q=>q+1),B=p.useRef([]),D=p.useRef(new Set),Z=p.useRef(new Set),[$,oe]=p.useState([]),[me,xe]=p.useState([]),[ye,ce]=p.useState(0),Ce=p.useRef(new Map),Ae=p.useRef(null),{mode:ue}=l,ve=p.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),ke=ve.pipe,ee=l.session.token||"",_=ue==="client"&&!e;p.useEffect(()=>{if(!ee||!ke)return;let q=!0;const X=async()=>{const ge=await rl(ee);!q||!ge||(xe(ge.runs),ce(Date.now()/1e3-ge.now),oe(Me=>Me.filter(qe=>!ge.runs.some(Ke=>Ge(Ke.company)===Ge(qe.name)))))};X();const Y=$.length>0||me.some(ge=>ge.status==="running"),ie=window.setInterval(()=>{X()},Y?8e3:25e3);return()=>{q=!1,window.clearInterval(ie)}},[ee,ke,$.length,me.some(q=>q.status==="running")]),p.useEffect(()=>{if(!ee||!ke||!_)return;let q=!0;const X=async()=>{const ie=await ol(ee);if(!q||!ie.length)return;const ge=new Map;ie.forEach(Me=>{const qe=String(Me.ceo_status||"").trim();qe&&Me.check_id&&ge.set(String(Me.check_id),qe)}),l.patchStatuses(ge,Me=>Date.now()-(V.current.get(Me)||0)>9e4)};X();const Y=window.setInterval(()=>{X()},6e4);return()=>{q=!1,window.clearInterval(Y)}},[ee,ke,_]);const re=p.useMemo(()=>{const q=[],X=new Set;for(const Y of $){const ie=Ge(Y.name);!ie||X.has(ie)||(X.add(ie),q.push({name:Y.name,id:Y.id,status:"boot",started:Y.started,estMin:Y.estMin,memoType:"instant"}))}for(const Y of me){const ie=Ge(Y.company);if(!ie||X.has(ie))continue;X.add(ie);const ge=Y.status==="error"?"error":Y.status==="done"?"done":"running";q.push({name:Y.company,status:ge,started:Y.started||0,estMin:Y.est_min||(Y.memo_type==="detailed"?40:15),url:Y.url,error:Y.error,memoType:Y.memo_type,note:Y.note})}return q},[$,me]),se=q=>re.find(X=>Ge(X.name)===Ge(q))||null,le=(q,X)=>{oe(Y=>Y.some(ie=>Ge(ie.name)===Ge(q.name))?Y:[...Y,{name:q.name,id:q.id,started:Date.now()/1e3,estMin:X==="detailed"?40:15}]),D.current.add(q.id),C()},fe=(q,X=!1)=>{O(q),W(X),Ae.current&&clearTimeout(Ae.current),Ae.current=setTimeout(()=>O(""),X?4200:2400)},H=q=>fe(q,!0),de=p.useMemo(()=>{const q=new Map;return l.dossiers.forEach(X=>{X.id&&q.set(X.id,X)}),q},[l.dossiers]),we=p.useMemo(()=>l.dossiers.filter(q=>Pt(q,f,ke)),[l.dossiers,f,ke]),Ee=p.useRef(!1);p.useEffect(()=>{if(Ee.current||l.loading||!l.dossiers.length)return;if(e&&!l.session.token){Ee.current=!0;return}if(!ve.showFunnel||cu(l.session.token||"")){Ee.current=!0;return}Ee.current=!0;const q=window.setTimeout(()=>{No(l.session.token||""),P(!0)},700);return()=>window.clearTimeout(q)},[e,l.loading,l.dossiers.length,ve.showFunnel,l.session.token]);const je=p.useMemo(()=>l.dossiers.filter(q=>Kl(q,f,ke,l.favIds)),[l.dossiers,f,ke,l.favIds]),be=p.useMemo(()=>Js(we.filter(q=>!at(q)),l.favIds),[we,l.favIds]),Be=p.useRef(!1);p.useEffect(()=>{if(Be.current)return;if(!ke||a==="ops"){Be.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Be.current=!0;return}if(l.loading)return;Be.current=!0;const q=Xs(be);q!==f.ptab&&c({type:"ptab",tab:q})},[ke,a,n==null?void 0:n.ptab,l.loading,be,f.ptab]);const et=p.useMemo(()=>{const q=Zo(l.dossiers);return q?gt(q)===0?s.tourToday:ei(q,d):s.tourNoRun},[l.dossiers,s,d]),ut=p.useMemo(()=>l.dossiers.some(q=>!!q.memoUrl||!!q.summary||Yt(q)),[l.dossiers]),[Fe,Ve]=p.useState(!1);p.useEffect(()=>{if(l.loading){Ve(!1);return}if(l.dossiers.length>0||l.error){Ve(!0);return}const q=window.setTimeout(()=>Ve(!0),6e3);return()=>window.clearTimeout(q)},[l.loading,l.dossiers.length,l.error]);const wt=(l.marketEstimate||0)>0||typeof((nr=l.stats)==null?void 0:nr.screened)=="number"&&l.stats.screened>0,Ue=p.useMemo(()=>[1,0,2,4,5,3].find(q=>(be[q]||0)>0)??0,[be]),ot=Un.find(q=>q.key===f.continent),Rt=f.continent==="monde"?s.contWorld:(d==="fr"?ot==null?void 0:ot.fr:ot==null?void 0:ot.en)||"";p.useEffect(()=>{const q=X=>{var ie;const Y=(((ie=X.detail)==null?void 0:ie.name)||"").trim();Y&&yt(null,Y)};return window.addEventListener("ppmap:evaluate",q),()=>window.removeEventListener("ppmap:evaluate",q)}),p.useEffect(()=>{const q=X=>{const Y=X.detail||{},ie=String(Y.id||"").trim(),ge=String(Y.name||"").trim(),Me=String(Y.url||"").trim(),qe=ie&&de.get(ie)||ou(l.dossiers,ge,Me);if(qe){if(y(null),Pt(qe,f,ke)||(f.continent!=="monde"&&qe.continent!==f.continent&&c({type:"continent",key:qe.continent||"monde"}),c({type:"reset"})),ke&&qe.kind!=="op"){const xt=Te(qe);typeof xt=="number"&&xt!==f.ptab&&c({type:"ptab",tab:xt})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),c({type:"focus",id:qe.id}),(qe.noCo||["media","nominations","recrutements"].includes(qe.engine||""))&&(qe.url||qe.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:qe.url||"",text:[qe.headline,qe.tagline].filter(Boolean).join(`
`)}})):qe.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:qe.name,url:qe.url||"",website:qe.website||"",domain:qe.domain||""}}));return}!ge&&!Me||(c({type:"focus",id:ie||null}),y({name:ge,headline:String(Y.text||"").trim()||ge,url:Me,card:Y.card}),Me&&(Qt(ge)||!ge)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Me,text:String(Y.text||"").trim()}})):ge&&!Qt(ge)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ge}})))};return window.addEventListener("ppmap:focus",q),()=>window.removeEventListener("ppmap:focus",q)}),p.useEffect(()=>{const q=ie=>{const ge={},Me=String((ie==null?void 0:ie.sector)||"").trim();Me&&(ge.sector=[Me]);const qe=String((ie==null?void 0:ie.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(qe)&&(ge.day=qe);const Ke=String((ie==null?void 0:ie.search)||"").trim();Ke&&(ge.search=Ke);const xt=String((ie==null?void 0:ie.dealKind)||"").trim();(xt==="ma"||xt==="levee"||xt==="other")&&(ge.dealKind=[xt]),Object.keys(ge).length&&c({type:"filters",patch:ge})},X=ie=>q(ie.detail),Y=ie=>{ie.data&&ie.data.type==="pp-filter"&&q(ie.data)};return window.addEventListener("ppmap:filter",X),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",X),window.removeEventListener("message",Y)}},[]),p.useEffect(()=>{const q=X=>{var ge;const Y=(((ge=X.detail)==null?void 0:ge.name)||"").trim().toLowerCase();if(!Y)return;const ie=l.dossiers.find(Me=>(Me.name||"").trim().toLowerCase()===Y);ie&&c(a==="ops"?{type:"focus",id:ie.id}:{type:"popup",id:ie.id})};return window.addEventListener("ppmap:similar",q),()=>window.removeEventListener("ppmap:similar",q)});const yt=(q,X,Y)=>{const ie=(Y||(q==null?void 0:q.name)||X||"").trim();if(!_){k({kicker:ie});return}!ie||z||(T(!0),(async()=>{try{let ge=(X||ie).trim();const Me=((q==null?void 0:q.website)||(q==null?void 0:q.domain)||"").trim();if(!(/^https?:\/\//i.test(ge)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(ge)&&!/\s/.test(ge)))if(Me)ge=Me;else try{const _e=await Hn(ie);if(_e!=null&&_e.website)ge=_e.website;else if(((_e==null?void 0:_e.candidates)||[]).length===1)ge=_e.candidates[0].url;else if(((_e==null?void 0:_e.candidates)||[]).length>1){B.current=[{name:ie,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(_e.candidates||[]).slice(0,5)},...B.current].slice(0,8),C();return}}catch{}const Ke=await To(ee,ge,"atelier2"),xt={name:Ke.company||ie,verdict:Ke.verdict,reason:Ke.reason||"",remaining:Ke.remaining??null};B.current=[xt,...B.current].slice(0,8),Ke.verdict==="kept"&&N(_e=>({..._e,kept:_e.kept+1})),Ke.verdict==="ruled_out"&&N(_e=>({..._e,dropped:_e.dropped+1}));const na=q||l.dossiers.find(_e=>(_e.name||"").toLowerCase()===ie.toLowerCase());na&&(Ke.verdict==="kept"?na.verdict=na.verdict||"MATCH":Ke.verdict==="ruled_out"&&(na.verdict="NO MATCH"),Ke.reason&&(na.reasoning=Ke.reason)),C()}finally{T(!1)}})())},Ct=q=>{if(!_){k({kicker:q.name});return}le(q,"instant"),jt(ee,"fast_request",q.name||"",""),fe(s.memoInstantSent(q.name))},Ot=q=>Ce.current.get(q.id)??l.thumbs.get((q.name||"").trim().toLowerCase()),Mt=(q,X)=>c({type:"undoPush",entry:{id:q.id,name:q.name,prevCeoStatus:X}}),kt=async(q,X,Y)=>{const ie=q.ceoStatus||"";V.current.set(q.id,Date.now()),q.ceoStatus=X,C();const ge=await rn(ee,{status:X,airtable_id:q.airtableId,check_id:q.checkId,company:q.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return ge.ok?ge.skipped?(q.ceoStatus=ie,C(),H(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&Mt(q,ie),Y!=null&&Y.msg&&fe(Y.msg),(X==="Validé"||X==="Écarté")&&!q.ceoNote&&(Y==null?void 0:Y.note)===void 0&&F({o:q,yes:X==="Validé"}),!0):(q.ceoStatus=ie,C(),H(s.actErr),!1)},Pe=async(q,X)=>{const Y=await rn(ee,{status:q.ceoStatus||"Retenu",airtable_id:q.airtableId,check_id:q.checkId,company:q.name,note:X,via:"note"});return!Y.ok||Y.skipped?(H(Y.skipped?s.actNotPersisted:s.actErr),!1):(q.ceoNote=X,C(),!0)},it=p.useRef(new Map),tt=q=>it.current.has(q.id)?it.current.get(q.id):l.stages.get((q.name||"").trim().toLowerCase()),zt=(q,X)=>{it.current.set(q.id,X),C()},R=(q,X)=>{_&&kt(q,X?"Validé":"Écarté",{msg:X?s.decidedYes(q.name):s.decidedNo(q.name)})},G=q=>{_&&kt(q,"À trancher",{msg:s.promoted(q.name)})},te=q=>{_&&(async()=>{const X=q.ceoStatus||"";q.ceoStatus="Retenu",C();const Y=await rn(ee,{status:"Retenu",check_id:q.checkId,company:q.name});if(!Y.ok||Y.skipped){q.ceoStatus=X,C(),H(Y.skipped?s.actNotPersisted:s.actErr);return}Mt(q,X),fe(s.repeched(q.name))})()},I=()=>{const q=f.undo[f.undo.length-1];if(!q){fe(s.undoNone);return}const X=de.get(q.id);if(!X){c({type:"undoPop"}),fe(s.undoNone);return}let Y=q.prevCeoStatus;if(!Y)if((X.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{fe(s.undoLockedTitle);return}(async()=>await kt(X,Y,{undo:!1})&&(c({type:"undoPop"}),X.ceoStatus=q.prevCeoStatus,C(),fe(s.undoDone(X.name))))()},ae=q=>{_&&(Z.current.add(q.id),C(),c({type:"approachOpen",id:q.id}),jt(ee,"approach",q.name||"","","",l.email||""))},V=p.useRef(new Map),pe=p.useRef(!1),[Se,he]=p.useState(0);p.useEffect(()=>{if(!ee||e||!_||pe.current)return;pe.current=!0;const q=new Date().toISOString().slice(0,10),X=l.email||"",Y=`cbv_${ee}_${X}_${q}`,ie=`atl2:vue:${ee}:${q}`;try{if(localStorage.getItem(Y)||localStorage.getItem(ie))return}catch{}jt(ee,"view","","","",X).then(ge=>{if(!ge.ok){pe.current=!1;return}try{localStorage.setItem(Y,"1")}catch{}})},[ee,e,_,l.email]),p.useEffect(()=>{if(!ee||!ke||e||!_||!l.generatedAt)return;let q=!0;const X=()=>{document.hidden||il(ee,l.generatedAt||"").then(ie=>{q&&he(ie)})};X();const Y=window.setInterval(X,6e4);return()=>{q=!1,window.clearInterval(Y)}},[ee,ke,e,l.generatedAt]);const Ne=(q,X)=>{_&&(async()=>{if(!(await jt(ee,X?"yes":"no",q.name||"",(q.ceoNote||"").slice(0,400),q.sector||"",l.email||"")).ok){H(s.actErr);return}Ce.current.set(q.id,X?"yes":"no"),C(),fe(X?s.thumbUpDone:s.thumbDnDone),A({o:q,up:X})})()},Re=q=>{!_||!Yt(q)||(le(q,"detailed"),jt(ee,"detailed_request",q.name||"","","",l.email||""),fe(s.memoDeepSent(q.name)))},Qe=q=>{!_||!q.memoUrl||window.confirm(s.memoRegenAsk(q.name))&&(le(q,"detailed"),jt(ee,"detailed_regen",q.name||"","","",l.email||""),fe(s.memoDeepSent(q.name)))},mt=q=>{const X=new Set(l.favIds),Y=X.has(q.id);Y?X.delete(q.id):X.add(q.id),l.setFavIds(X),_&&sl(ee,{id:q.id,co:q.name},Y)},$e=()=>{!_||U||window.confirm(s.identSyncConfirm)&&(Q(!0),(async()=>{const q=await ll(ee);Q(!1),q?fe(s.identSyncDone):H(s.actErr)})())},st=/proplace/i.test(l.fund||""),At=q=>{!_||!st||(jt(ee,"onboard_request",q.name||"",""),fe(s.onboardSent(q.name)))},aa={st:f,dispatch:c,t:s,lang:d,mode:ue,caps:ve,pipe:ke,token:ee,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:te,thumbOf:Ot,canWrite:_,commitStatus:kt,saveNote:Pe,stageOf:tt,setStage:zt,flashErr:H,startTour:()=>P(!0),dossiers:l.dossiers,scopedAll:we,scoped:je,counts:be,byId:de,contName:Rt,favIds:l.favIds,toggleFav:mt,askEvaluate:yt,doAnalyse:Ct,doDecide:R,doPromote:G,doApproach:ae,doThumb:Ne,doDeep:Re,doRegen:Qe,doUndo:I,doSync:$e,doOnboard:At,outbound:st,memoQueued:D.current,liveMemos:{items:re,serverOff:ye,liveOf:se},approachDone:Z.current,sessTally:j,evalCards:B.current,evalBusy:z,markRow:v,markedId:w,flash:fe,focusExtra:m};p.useEffect(()=>{const q=X=>{X.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",q),()=>window.removeEventListener("keydown",q)},[]);const Ii=q=>ee?t.jsx(Zl,{token:ee,children:q}):t.jsx(t.Fragment,{children:q});return t.jsx(Oi.Provider,{value:aa,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ee?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Il}),Ii(t.jsxs("div",{className:"app"+(ke?" pipe":"")+(ee?" has-thesis":""),children:[ve.showTicker&&t.jsx(ft,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ee?" live-stack--cibles":""),children:[t.jsx(id,{}),!!ee&&t.jsx(ed,{})]})}),ve.showIdent&&t.jsx(ft,{name:"identite",children:t.jsx(gd,{})}),!1,du,ve.showFunnel&&t.jsx(ft,{name:"entonnoir",children:t.jsx(mu,{})}),t.jsx(ft,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(wi,{variant:"tabs"}),!f.mapFolded&&t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(iu,{}),a!=="ops"&&(ve.showFunnel||ve.showIdent)&&t.jsxs("div",{className:"map-hud",children:[ve.showFunnel&&t.jsx(su,{}),ve.showIdent&&t.jsx(lu,{})]}),t.jsx(fp,{}),t.jsx(vi,{})]})]})}),ve.showDemand&&ke&&t.jsx(ft,{name:"direct",children:t.jsx(ml,{items:re,serverOff:ye,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>c({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([q,X])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===q,onClick:()=>{h(q);try{localStorage.setItem("atl2:chrome-mode",q)}catch{}},children:X},q))}),ve.showDemand&&t.jsx(ft,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(Rp,{})})}),ve.showDemand&&f.memoConsole&&t.jsx(ft,{name:"console",children:t.jsx(Mp,{})}),ve.pipe&&!!ee&&t.jsx(ft,{name:"moteurs",children:t.jsx(Sl,{})}),Se>0&&t.jsxs("div",{className:"freshban",children:[t.jsx("span",{children:s.freshBan}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{he(0),l.refresh()},children:s.freshGo})]}),t.jsx(ft,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(jc,{})}),ve.pipe&&!!ee&&t.jsx("p",{className:"privnote",children:s.privLink}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(ft,{name:"fiche",children:t.jsx(sc,{})}),t.jsx(ft,{name:"modales",children:t.jsx(Lc,{})}),t.jsx(Zs,{}),x&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:x.o.name}),t.jsx(Dr,{placeholder:x.up?s.thumbWhyUpPh:s.thumbWhyDnPh,onDone:q=>{const X=x.o;A(null),q&&jt(ee,"note",X.name||"",q,X.sector||"",l.email||"").then(Y=>{Y.ok&&fe(s.csNoteSaved)})}})]}),K&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:K.o.name}),t.jsx(Dr,{placeholder:K.yes?s.whyYesPh:s.whyNoPh,onDone:q=>{const X=K.o;F(null),q&&Pe(X,q).then(Y=>{Y&&fe(s.csNoteSaved)})}})]}),S&&Fe&&t.jsx(fd,{steps:uu(s,et,ut,Ue,wt,be[3]||0,be[4]||0,be),onClose:()=>{P(!1),No(ee)}}),t.jsx(pu,{}),ve.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Io,children:Do}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${_a}`,children:_a})]}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),L&&t.jsx("div",{className:"flash on"+(M?" err":""),children:L}),E&&t.jsx(el,{variant:"acquirer",initialCompany:So().co,initialWebsite:So().site,onClose:()=>k(null)})]})})}function mu(){const{t:e}=J(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function So(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function fu(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Mi as FlagCell,Lt as SigBadge,en as SigWin,xu as default,fu as fmtShort,J as useV2};
