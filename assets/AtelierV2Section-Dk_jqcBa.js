...
.atl2.cibles .evalq .eq-sugg{display:flex;align-items:center;flex-wrap:wrap;gap:8px;
  flex:1 1 380px;min-width:0;margin:0;padding:0;border:0;background:transparent}
...
.atl2.cibles .evalq .side .evalbtn:disabled{background:var(--pp-line-in);
  color:var(--pp-ink-5)}
.atl2.cibles .evalq .side .hint{font-size:12px;color:var(--pp-ink-4);
...
.atl2.cibles .readpane .thesis-brief__sw button.on{background:var(--pp-green);
  border-color:var(--pp-green);color:#fff;font-weight:700}
.atl2.cibles .readpane .thesis-brief__body{font-size:13.5px;line-height:1.65;
  color:var(--pp-ink)}
.atl2.cibles .readpane .thesis-brief__body p{margin:10px 0 0;font-size:13.5px;
  line-height:1.65}
.atl2.cibles .readpane .ed-lead{margin:16px 0 0;padding-left:14px;
  border-left:2px solid var(--pp-green)}
.atl2.cibles .readpane .ed-lead p{margin:0 0 8px;font-size:13.5px;line-height:1.65}
.atl2.cibles .readpane .ed-lead ul{margin:0;padding-left:18px}
.atl2.cibles .readpane .ed-lead li{margin:0 0 8px;font-size:13.5px;line-height:1.65}
