...
/* fiche droite : « Voir le mémo complet » en tête, puis le mémo détaillé en texte */
...
.atl2 .md-deep-txt,.atl2.cibles .readpane .md-deep-txt{
  display:block;margin:0;padding:0;border:0;background:none!important;
  font:inherit;font-size:13.5px;font-weight:600;color:var(--pp-ink,#0F1D33)!important;
  cursor:pointer;text-align:left;line-height:1.4;height:auto;box-shadow:none}
.atl2 .md-deep-txt:hover,.atl2.cibles .readpane .md-deep-txt:hover{
  text-decoration:underline;color:var(--pp-navy,#0F1D33)!important}
.atl2 .cdacts .md-deep-txt{width:100%;flex:1 0 100%}
