...
`,Dl=Fl+Rl+Ol+Ml;function En(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Il(){const e=En("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Pl(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Il();return r==="0"?"client":r==="1"||En("embed")==="1"&&En("chrome")==="1"?"apercu":"client"}const _l={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Bl=e=>_l[e];function Qt(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||/\?$/.test(a)||/^(this|that|these|those|why|what|what'?s|how|when|where|who|which|is|are|do|does|did|can)\b/i.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Dt=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Xa(a)||Qt(a))&&(e.noCo=!0)}return Object.assign(e,{continent:ns(e.cc)})};function sn(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const $l=60*60*1e3;function Ul(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>$l?null:a}catch{return null}}function Ea(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Hl=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Vl(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:Wi(),[e,n]),i=p.useMemo(()=>n?"visiteur":Pl(e,o),[e,o,n]),d=p.useMemo(()=>Bl(i),[i]),l=i!=="visiteur",s=Hl(r),[h,c]=p.useState([]),[x,u]=p.useState(""),[b,f]=p.useState(null),[w,v]=p.useState(null),[m,y]=p.useState(null),[E,k]=p.useState(()=>new Map),[j,N]=p.useState(()=>new Map),[C,T]=p.useState(""),[L,O]=p.useState(new Set),[D,W]=p.useState(null),[J,F]=p.useState(!0),[g,A]=p.useState(!1),[S,P]=p.useState(0),[U,Q]=p.useState(0),re=p.useRef(0),z=p.useMemo(()=>{var I;if(i!=="client")return"";try{return((I=Gi())==null?void 0:I.email)||""}catch{return""}},[i]);p.useEffect(()=>{const I=++re.current;let ee=!0;const $=()=>ee&&I===re.current,oe=(l&&o.token?o.token:"pub:"+a)+(s?":"+s:""),me=Ul(oe);return me?(c(me.objs.map(Dt)),me.fund&&u(me.fund),f(me.marketEstimate??null),v(me.criteria??null),y(me.stats??null),T(me.generatedAt||""),F(!1)):F(!0),(async()=>{try{if(r==="ops"){const xe=await an(),ye=((xe==null?void 0:xe.recent_ops)||[]).map(ce=>{const ze=Fa(ce.company_name||ce.title?ce:{...ce,title:(ce.headline_fr||ce.headline||"").slice(0,120)},a),Ae=String(ce.rubrique||"").toLowerCase();return ze&&(Ae==="nominations"||Ae==="recrutements")&&(ze.engine=Ae),ze&&!String(ce.company_name||"").trim()&&(ze.noCo=!0),ze}).filter(ce=>!!ce).map(ce=>(Xa((ce.name||"").trim())||(ce.noCo=!0),ce));try{const ce=Yi(),ze=await Qi(),Ae=((ze==null?void 0:ze.date)||"").slice(0,10),ue=ce?ce.doc:ze,ve=Ki(ue),ke=((ce==null?void 0:ce.day)||(ue==null?void 0:ue.date)||Ae||"").slice(0,10);if(ke&&ve.length){const te=new Set;for(const _ of ye){if((_.date||"").slice(0,10)!==ke)continue;const K=sr(ve,te,_.name,"");K>=0&&(te.add(K),_.decryptHtml=ve[K].html)}for(const _ of ye){if(_.decryptHtml||(_.date||"").slice(0,10)!==ke)continue;const K=sr(ve,te,"",_.headline||_.tagline||_.name);K>=0&&(te.add(K),_.decryptHtml=ve[K].html)}}if(ke){const te=((ue==null?void 0:ue.title_fr)||"").trim(),_=((ue==null?void 0:ue.lead_fr)||"").trim(),K=Ji(ue),se=((ue==null?void 0:ue.url)||"").trim();te&&(K||se)&&ye.unshift({id:`edito:${ke}`,kind:"op",name:te,cc:null,date:ke,engine:"edito",dealKind:"other",headline:te,tagline:_||te,decryptHtml:K||void 0,url:se,noCo:!0})}}catch{}if(!$())return;c(ye.map(Dt)),Ea(oe,{objs:ye})}else if(typeof r=="object"){const ye=(await lr()||[]).filter(ze=>(ze.slug||"")===r.research).map(ze=>dr(ze,a)).filter(ze=>!!ze),ce=sn(await pr(ye,a));if(!$())return;c(ce.map(Dt)),Ea(oe,{objs:ce})}else if(l&&o.token){const xe=Xi(o.token),ye=an(),ce=Zi(o.token),ze=es(o.token),Ae=ts(o.token),ue=await xe;let ve=ue?ue.targets:[];$()&&ue&&(u(ue.fund||""),f(ue.marketEstimate??null),v(ue.criteria??null),y(ue.stats??null),T(ue.generatedAt||""),c(ve.map(Dt)),F(!1),A(!1));const[ke,te,_,K]=await Promise.all([ye,ce,ze,Ae]),se=((ke==null?void 0:ke.recent_ops)||[]).map(H=>Fa(H,a)).filter(H=>!!H),le=new Set(ve.map(H=>H.id));if(ve=[...ve,...se.filter(H=>!le.has(H.id)&&(le.add(H.id),!0))],!$())return;c(ve.map(Dt));const fe=new Set;for(const H of te){const de=(H.id||H.co||"").toString().trim().toLowerCase();de&&fe.add(de.startsWith("t:")?de:"t:"+de)}O(fe),k(_),N(K),ue&&Ea(oe,{fund:ue.fund,marketEstimate:ue.marketEstimate,criteria:ue.criteria,stats:ue.stats,generatedAt:ue.generatedAt,objs:ve})}else{const xe=as(),ye=lr(),ce=an(),ze=await xe;$()&&ze.length&&(c(sn(ze).map(Dt)),F(!1),A(!1));const[Ae,ue]=await Promise.all([ye,ce]),ve=(Ae||[]).map(K=>dr(K,a)).filter(K=>!!K),ke=await pr(ve,a),te=((ue==null?void 0:ue.recent_ops)||[]).map(K=>Fa(K,a)).filter(K=>!!K),_=sn([...ze,...ke,...te]);if(!$())return;c(_.map(Dt)),Ea(oe,{objs:_})}$()&&A(!1)}catch{$()&&!me&&A(!0)}finally{$()&&F(!1)}})(),()=>{ee=!1}},[l,o.token,a,S,s]),p.useEffect(()=>{if(!d.showCredits||!z){W(null);return}let I=!0;return(async()=>{try{const ee=await fetch(`${wa}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:z})});if(!ee.ok)return;const $=await ee.json();I&&$&&$.ok!==!1&&W($)}catch{}})(),()=>{I=!1}},[d.showCredits,z,U]);const B=p.useCallback(I=>O(new Set(I)),[]);return{session:o,mode:i,caps:d,fund:x,email:z,marketEstimate:b,generatedAt:C,criteria:w,thesisMode:String((w==null?void 0:w.mode)||""),stats:m,thumbs:E,stages:j,dossiers:h,patchStatuses:(I,ee)=>{c($=>{let oe=!1;const me=$.map(xe=>{if(!xe.checkId)return xe;const ye=I.get(xe.checkId);return!ye||ye===(xe.ceoStatus||"")||!ee(xe.id)?xe:(oe=!0,{...xe,ceoStatus:ye})});return oe?me:$})},favIds:L,setFavIds:B,credits:D,reloadCredits:()=>Q(I=>I+1),loading:J,error:g,refresh:()=>P(I=>I+1)}}function We(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const Ra=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function $a(e){return Ra.has(e.engine||"")}function at(e){return!!e.noCo||$a(e)&&!!e.url}const Vo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],market:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Wl=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Vo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,dossierId:null,memoTab:0,undo:[],mapFolded:a}),Gl=new Set(["signal","amount","score","crible","memo"]);function Yl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Vo(),shown:{},openFacet:null,popupId:null,focusId:null,dens:"liste",sort:{key:"signal",dir:-1}};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:Gl.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Wo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId,dossierId:a.modal==="dossier"?null:a.modal?e.dossierId:null};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"dossierOpen":return{...e,dossierId:a.id,modal:a.id?"dossier":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Wo=80;function Ua(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!He(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="market"&&a.market.length&&!a.market.includes(e.market||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes($n(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(gt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&It(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(zo(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.market,...e.tags||[],e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle,e.angleId,e.provQuery].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function Pt(e,a,r){return We(e)?Ua(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ua(e,a.filters,r)}function Ql(e,a,r,n){return!(!Pt(e,a,r)||r&&!So(e,a.ptab,n))}function Gn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase()||null;case"country":return o.countryLabel||o.cc||null;case"stage":return o.stage||null;case"sector":return(o.sector||"").toLowerCase()||null;case"market":return(o.market||"").toLowerCase()||null;case"amount":return typeof o.amountEur=="number"&&o.amountEur>0?o.amountEur:null;case"age":return-gt(o.date);case"score":return typeof o.score=="number"?o.score:null;case"crible":return os(o)||null;case"memo":return rs(o)||null;case"signal":{const i=He(o);return i?100-(i.left??0):null}}};return[...e].sort((o,i)=>{const d=n(o),l=n(i);return d===null||l===null?d===l?(o.name||"").localeCompare(i.name||""):d===null?1:-1:d<l?-a.dir:d>l?a.dir:(o.name||"").localeCompare(i.name||"")})}const ln={},Ar=(ln==null?void 0:ln.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function qr(){return new Date().toISOString().slice(0,10)}const Yn=p.createContext(null);function Go(){return p.useContext(Yn)}function Kl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),d=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!d||d.length<2||d.length>60)continue;const l=n.cloneNode(!0);l.querySelectorAll("script,style,iframe").forEach(s=>s.remove()),l.querySelectorAll("*").forEach(s=>{const h=s.tagName==="A"?s.getAttribute("href"):null;[...s.attributes].forEach(c=>s.removeAttribute(c.name)),h&&/^https?:\/\//i.test(h)&&(s.setAttribute("href",h),s.setAttribute("target","_blank"),s.setAttribute("rel","nofollow noopener"))}),a.push({t:d.toLowerCase(),html:l.outerHTML})}}catch{}return a}function Yo(e){for(const a of[...e.querySelectorAll("p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=28&&!a.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(r)&&r.split(" ").length<=3&&a.classList.add("tb-geo")}for(const a of[...e.querySelectorAll("p,h2,h3")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();r&&r.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(r)&&!a.querySelector("a,ul")&&a.classList.add("tb-sec")}for(const a of[...e.querySelectorAll("b,strong")]){const r=(a.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(r)&&a.classList.add("tb-these")}for(const a of[...e.querySelectorAll("div,section,p")]){const r=(a.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(r)&&a.querySelector("li,p,ul")){a.classList.add("ed-lead");break}}}function Jl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),d=o.value,l=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),s=(i==="href"||i==="src")&&/^https?:\/\//i.test(d);!l&&!s&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Yo(r),r.innerHTML):e}catch{return e}}function Tr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");return r?(r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),d=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(l=>n.removeAttribute(l.name)),d&&n.setAttribute("class",d),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),Yo(r),r.innerHTML):e}catch{return e}}function Lr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",d=String(Number(r[3]));return a?`${i} ${d}, ${r[1]}`:`${d==="1"?"1ᵉʳ":d} ${i} ${r[1]}`}function Qo(){const e=p.useContext(Yn);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Xl({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Z(),[i,d]=p.useState(()=>n.filters.day||qr()),[l,s]=p.useState(null),[h,c]=p.useState(!1),x=p.useCallback(w=>{if(/^\d{4}-\d{2}-\d{2}$/.test(w)){d(w);try{r({type:"filters",patch:{day:w,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{d(qr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const w=v=>{var y;const m=(y=v.detail)==null?void 0:y.day;typeof m=="string"&&x(m)};return window.addEventListener("pp-edition-day",w),()=>window.removeEventListener("pp-edition-day",w)},[x]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&d(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let w=!1;c(!0);const v=new URLSearchParams({token:e,date:i});return fetch(`${Ar}/cibles/edition.json?${v}`).then(m=>m.json()).then(m=>{w||s(m)}).catch(()=>{w||s({ok:!1,error:"network"})}).finally(()=>{w||c(!1)}),()=>{w=!0}},[e,i]);const b=p.useMemo(()=>`${Ar}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),f=p.useMemo(()=>({token:e,day:i,ed:l,loading:h,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,l,h,x,u,n.filters.day,b,o]);return t.jsx(Yn.Provider,{value:f,children:a})}function Zl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Qo(),[o,i]=p.useState(()=>n||Co());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const d=l=>{var s;return i(!!((s=l.detail)!=null&&s.open))};return window.addEventListener(Ia,d),()=>window.removeEventListener(Ia,d)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(is,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function ed(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function Fr(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function Rr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function td(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=Qo(),d=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),l=(a==null?void 0:a.ok)&&!d,s=a&&!a.ok,h=p.useRef(null),[c,x]=p.useState("fonds"),[u,b]=p.useState(null),[f,w]=p.useState("idle"),v=p.useRef(!1);p.useEffect(()=>{b(null),w("idle"),v.current=!1,x("fonds")},[e]),p.useEffect(()=>{if(c!=="jour"||v.current)return;v.current=!0;let j=!0;return w("load"),ed(e).then(N=>{j&&(b(N),w("fait"))}),()=>{j=!1}},[c,e]);const m=p.useMemo(()=>Jl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),y=p.useRef(null);p.useEffect(()=>{const j=y.current;if(!j||!m)return;let N=!1;return wn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!j.isConnected)&&(C.beautifyEditoRows(j),C.mountCardFits(j))}),()=>{N=!0}},[m]);const E=p.useMemo(()=>Tr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>Tr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const j=h.current;if(!j||!E)return;let N=!1;return wn(()=>import("./fit-DX-mzLKR.js"),[]).then(async C=>{await C.ensureEditoCss(),!(N||!j.isConnected)&&(C.beautifyEditoRows(j),C.mountCardFits(j))}),()=>{N=!0}},[E]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(()=>{const j=(a==null?void 0:a.date)||e,N=/^(\d{4})-(\d{2})-(\d{2})/.exec(j);return N?i?`${N[2]}/${N[3]}/${N[1]}`:`${N[3]}/${N[2]}/${N[1]}`:j})()})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":c==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":c==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),c==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),c==="fonds"&&r&&!d&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),c==="fonds"&&s&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c==="fonds"&&l&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?Fr(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:Lr(e,!0)}),"."]}):Fr(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:Lr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),c==="fonds"&&d&&E?t.jsx("div",{ref:h,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:E}}):null,c==="fonds"&&d&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,c==="jour"&&(m?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title thesis-brief__jour-h",children:u.title}),t.jsx("div",{ref:y,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:m}})]}):t.jsx("p",{className:f==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:f!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:Rr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:Rr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const ad=300,ja=7,nd={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},Ko={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},rd=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Na(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(ps(r)&&r!=="media")return"news:"+r;const n=He(e);return n?"sig:"+(n.theme&&Ko.fr[n.theme]?n.theme:"other"):"actualites"}function od(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:d,fund:l}=Z(),s=Go(),h=d==="en",[c,x]=p.useState("all"),[u,b]=p.useState(!1),f=p.useMemo(()=>{var ee;const g=(a.filters.day||"").slice(0,10),A=$=>!(!i&&a.continent!=="monde"&&$.continent!==a.continent||g&&($.date||"").slice(0,10)!==g),S=e.filter($=>A($)&&He($)&&(!i||$.kind!=="target"||Te($)!==5)),P=i&&(((ee=s==null?void 0:s.ed)==null?void 0:ee.ops)||[]).length?s.ed.ops.map($=>Fa($,d)).filter($=>!!$).map($=>($.briefOnly=!0,$)).filter($=>!g||($.date||"").slice(0,10)===g):[],U=e.filter($=>A($)&&$.kind==="op"&&(g?!0:gt($.date)<=ja)),Q=i?P.length?P:U.filter($=>{const oe=(l||"").trim().toLowerCase();if(!oe)return!1;const me=$.match||null;return me?Object.keys(me).map(xe=>xe.trim().toLowerCase()).includes(oe):!1}):U,re=g||new Date().toISOString().slice(0,10),z=$=>{const oe=Na($);return oe==="ma"?0:oe==="levees"?1:2};Q.sort(($,oe)=>{const me=z($)-z(oe);if(me)return me;const xe=($.date||"").slice(0,10)===re?0:1,ye=(oe.date||"").slice(0,10)===re?0:1;return xe!==ye?xe-ye:(oe.amountEur||0)-($.amountEur||0)});const B=new Set,I=[];for(const $ of[...Q,...Gn(S,{key:"signal",dir:-1})]){const oe=$.id||$.name;!oe||B.has(oe)||(B.add(oe),I.push($))}return i&&I.length===0?e.filter(oe=>A(oe)&&gt(oe.date)<=ja).sort((oe,me)=>(me.date||"").localeCompare(oe.date||"")).slice(0,80):I},[e,a.continent,a.filters.day,i,l,d,s]),w=p.useMemo(()=>{const g={};for(const A of f){const S=Na(A);g[S]=(g[S]||0)+1}return g},[f]),v=p.useMemo(()=>c==="all"?f:f.filter(g=>Na(g)===c),[f,c]),m=p.useMemo(()=>v.slice(0,ad),[v]),y=v.length-m.length,E=p.useRef(null);p.useEffect(()=>{var Q,re;const g=E.current;if(!g)return;const A=()=>{const z=g.scrollWidth;z<200||(g.style.animationDuration=Math.max(18,Math.round(z/130))+"s")};A();const S=requestAnimationFrame(A),P=window.setTimeout(A,1200);let U=!0;return(re=(Q=document.fonts)==null?void 0:Q.ready)==null||re.then(()=>{U&&A()}),()=>{U=!1,cancelAnimationFrame(S),window.clearTimeout(P)}},[m.length,c]);const k=g=>g==="all"?f.length:w[g]||0,j=g=>{if(g==="all")return h?"All":"Tout";if(g.startsWith("sig:"))return Ko[h?"en":"fr"][g.slice(4)]||"🔔";if(g.startsWith("news:")){const A=g.slice(5);return ls[A]?ds(A,h?"en":"fr"):g}return nd[h?"en":"fr"][g]},N=[{k:"all"}],C=["ma","levees"].filter(g=>k(g)>0||g===c);if(C.length){N.push({g:h?"Deals":"Opérations"});for(const g of C)N.push({k:g})}const T=["nominations","recrutements"].filter(g=>k(g)>0||g===c),L=ss.filter(g=>g!=="media").map(g=>"news:"+g).filter(g=>k(g)>0||g===c),O=k("actualites")>0||c==="actualites"?["actualites"]:[];if(T.length||L.length||O.length){N.push({g:h?"News":"Actualités"});for(const g of T)N.push({k:g});for(const g of L)N.push({k:g});for(const g of O)N.push({k:g})}const D=rd.map(g=>"sig:"+g).filter(g=>k(g)>0||g===c);if(D.length){N.push({g:h?"Signals (your engines)":"Signaux (vos moteurs)"});for(const g of D)N.push({k:g})}const W=g=>{try{return new Date(g+"T12:00:00Z").toLocaleDateString(h?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return g}},J=(()=>{const g=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?h?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return g?(h?`LIVE covers the events of ${W(g)}.`:`Le LIVE regroupe les événements du ${W(g)}.`)+A:(h?`LIVE covers the still-open signals and the deals of the last ${ja} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${ja} derniers jours.`)+A})(),F=g=>m.map(A=>t.jsxs("button",{type:"button",className:"tk"+(Ye(A)?" spent":""),onClick:S=>{const P=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:P?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(P||n({type:"focus",id:A.id}),a.dens!=="liste"){const U=S.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:U.left+U.width/2,y:U.bottom}})}},title:Ye(A)?h?`${A.name} — already screened (dimmed)`:`${A.name} — déjà évaluée (grisée)`:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(Lt,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(Oi,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),(()=>{const S=(A.tagline||A.headline||"").trim();if(S&&S!==A.name)return t.jsx("span",{className:"what",children:S});const P=Na(A),U=P==="ma"?h?"M&A deal":"opération M&A":P==="levees"?h?"fundraising":"levée de fonds":P==="nominations"?h?"appointment":"nomination":P==="recrutements"?h?"hiring":"recrutement":P.startsWith("sig:")?h?"engine signal":"signal moteur":P.startsWith("news:")?h?"news":"actualité":A.kind==="target"?h?"sourced target":"cible sourcée":h?"news item":"actualité";return t.jsx("span",{className:"what dim",children:U})})(),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:lu(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(en,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},g+(A.id||A.name))).concat(y>0?[t.jsx("span",{className:"tk quiet",children:h?`+ ${y} more — filter by section to see them`:`+ ${y} autres — filtrez par rubrique pour les voir`},g+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:g=>{g.currentTarget.contains(g.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(g=>!g),children:[j(c),t.jsx("b",{children:k(c)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:J}),N.map(g=>"g"in g?t.jsx("span",{className:"tkfilg",children:g.g},g.g):t.jsxs("button",{type:"button","aria-pressed":g.k===c,onClick:()=>{x(g.k),b(!1)},children:[j(g.k),t.jsx("b",{children:k(g.k)})]},g.k))]})]}),t.jsx("div",{className:"win",children:m.length?t.jsxs("div",{className:"run",ref:E,children:[F(0),F(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!s&&t.jsxs("button",{type:"button",className:"tk-edito",title:h?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",h?"Today's editorial":"Edito du jour"]}),!!s&&t.jsx(sd,{isEn:h})]})}const id=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function sd({isEn:e}){const[a,r]=p.useState(()=>Co());p.useEffect(()=>{const o=i=>{var d;return r(!!((d=i.detail)!=null&&d.open))};return window.addEventListener(Ia,o),()=>window.removeEventListener(Ia,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>cs(!a),children:id})}class ft extends p.Component{constructor(){super(...arguments);rr(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const Jo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Or(e,a){if((Ft(e)||"").startsWith("CALL")&&Te(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Te(e)>=2;return Jo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const Mr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",ld={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function dd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:d}=Z(),[l,s]=p.useState(""),[h,c]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!x)return;const y=E=>{b.current&&!b.current.contains(E.target)&&(u(!1),c(!1))};return document.addEventListener("click",y,!0),()=>document.removeEventListener("click",y,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const f=(e.ceoStatus||"").trim(),w=async y=>{if(l)return;if(y==="Analysé"&&!e.memoUrl){c(!0);return}s(y);const E=(Or(e,a).find(([j])=>j===y)||[y,y])[1],k=await o(e,y,{msg:a.csMoved(e.name,E)});s(""),k&&(c(!1),u(!1))},v=Or(e,a),m=y=>(v.find(([E])=>E===y)||[])[1]||y;return v.length===2?t.jsx("span",{className:"rstat rst2",onClick:y=>y.stopPropagation(),children:v.map(([y,E])=>t.jsx("button",{type:"button",className:"rsd "+(y==="Validé"?"yes":"no")+(l===y?" busy":""),disabled:!!l,onClick:()=>{w(y)},children:E},y))}):t.jsxs("span",{className:"rstat"+(x||h?" rs-open":""),ref:b,onClick:y=>y.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!l,title:a.csLabel,className:"rsel rs-"+Mr(f),onClick:()=>{u(y=>!y),c(!1)},children:l?m(l)+"…":f?m(f):a.csNone}),x&&!h&&t.jsx("span",{className:"rsmenu",role:"listbox",children:v.map(([y,E])=>t.jsxs("button",{type:"button",role:"option","aria-selected":f===y,className:"rsopt"+(f===y?" on":"")+(l===y?" busy":""),disabled:!!l,onClick:()=>{if(y===f){u(!1);return}w(y)},children:[t.jsx("i",{className:"pt2",style:{background:ld[Mr(y)]}}),E]},y))}),h&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:d.has(e.id),onClick:()=>{i(e),c(!1),u(!1)},children:d.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const y=await o(e,"Analysé");s(""),y&&(c(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function pd({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Z(),[i,d]=p.useState(""),[l,s]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const h=(e.ceoStatus||"").trim(),c=(Ft(e)||"").startsWith("CALL")&&Te(e)===3,x=Te(e)>=2,u=async f=>{if(i||f==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;d(f);const w=await o(e,f);d(""),w&&(s(!0),setTimeout(()=>s(!1),2200))},b=c?[["Validé",a.csYes],["Écarté",a.csNo]]:Jo.filter(([f])=>!(x&&f==="Retenu")).map(([f,w])=>[f,a[w]]);return t.jsxs("div",{className:"csp",onClick:f=>f.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([f,w])=>t.jsx("button",{type:"button",className:"csb"+(h===f?" on":"")+(i===f?" busy":""),disabled:!!i,onClick:()=>{u(f)},children:w},f)),l&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(cd,{o:e})]})}function cd({o:e}){const{t:a,saveNote:r,flash:n}=Z(),[o,i]=p.useState(e.ceoNote||""),[d,l]=p.useState(!1),[s,h]=p.useState(!1),c=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(d||!c)return;l(!0);const u=await r(e,o.trim());l(!1),u&&(h(!0),setTimeout(()=>h(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:d,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:d||!c,onClick:()=>{x()},children:s?a.csNoteSaved:a.csNoteOk})]})}function Dr({placeholder:e,onDone:a}){const{t:r}=Z(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ud({o:e}){var v;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:d,flashErr:l}=Z(),[s,h]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Te(e)!==4)return null;const c=i(e),x=(c==null?void 0:c.stage)||"todo",u=async m=>{if(s||m===x)return;h(!0);const y=c;d(e,{stage:m,stamps:(c==null?void 0:c.stamps)||{}});const E=Math.max(Date.now(),Ir+=1);Ir=E;const k=await us(r,{company:e.name||"",stage:m,cts:E,deal_id:e.airtableId,check_id:e.checkId});h(!1),!k.stale&&(k.ok||(d(e,y),l(a.actErr)))},b=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,f=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,w=x==="sent"&&b&&f>=4;return t.jsxs("div",{className:"stg",onClick:m=>m.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([m,y])=>t.jsx("button",{type:"button",className:"stgb"+(x===m?" on":""),disabled:s,onClick:()=>{u(m)},children:y},m)),w&&t.jsx("span",{className:"stgj4",children:a.j4Badge(f)})]})}let Ir=0;const ra=8,qt=360;function Pr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function _r({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(Pr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(Pr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function md({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Z(),[d,l]=p.useState(0),[s,h]=p.useState(null),[c,x]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),f=p.useRef(!1);p.useEffect(()=>{const C=b.current;return()=>{f.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const w=c[d],v=d>=c.length;p.useEffect(()=>{if(w&&(w.ptab!==void 0&&i.ptab!==w.ptab&&n({type:"ptab",tab:w.ptab}),w.dens&&i.dens!==w.dens&&n({type:"dens",dens:w.dens}),i.modal!==(w.modal??null)&&n({type:"modal",modal:w.modal??null}),w.click)){const C=w.click,T=window.setTimeout(()=>{const L=document.querySelector(C);L&&L.getAttribute("aria-selected")!=="true"&&L.click()},60);return()=>window.clearTimeout(T)}},[d,w]);const m=p.useRef(-1),y=p.useCallback(()=>{if(!w){h(null);return}const C=O=>{if(!O)return null;for(const D of document.querySelectorAll(O)){const W=D.getBoundingClientRect();if(W.width>1&&W.height>1)return D}return null},T=C(w.sel)||C(w.need);if(!T){h(null);return}m.current!==d&&(m.current=d,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const L=T.getBoundingClientRect();h(O=>O&&Math.abs(O.top-L.top)<1&&Math.abs(O.left-L.left)<1&&Math.abs(O.width-L.width)<1&&Math.abs(O.height-L.height)<1?O:L)},[w,d]);p.useLayoutEffect(()=>{y();const C=[90,300,700,1300].map(O=>window.setTimeout(y,O)),T=window.setInterval(y,400),L=()=>y();return window.addEventListener("scroll",L,!0),window.addEventListener("resize",L),()=>{C.forEach(O=>window.clearTimeout(O)),window.clearInterval(T),window.removeEventListener("scroll",L,!0),window.removeEventListener("resize",L)}},[y]);const E=p.useRef(a);if(E.current=a,p.useEffect(()=>{const C=T=>{T.key==="Escape"?(T.preventDefault(),T.stopPropagation(),E.current()):T.key==="ArrowRight"?l(L=>L+1):T.key==="ArrowLeft"&&l(L=>Math.max(0,L-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!c.length)return null;let k=null;const j=C=>()=>{f.current=!0,n({type:"modal",modal:null}),C()};if(v){const C=o[3]||0;C>0?k={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:j(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:j(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:j(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:j(()=>{n({type:"modal",modal:"crit"}),a()})}}let N={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:qt};if(!v&&s){const C=s.bottom+14,T=window.innerHeight-C;let L=T>190?C:Math.max(12,s.top-200),O=Math.min(Math.max(12,s.left+s.width/2-qt/2),window.innerWidth-qt-12);T<=190&&s.top<212&&(window.innerWidth-s.right>=qt+40?O=Math.min(s.right+26,window.innerWidth-qt-12):s.left>=qt+40&&(O=Math.max(12,s.left-qt-26)),L=Math.max(12,s.top-ra)),N={left:O,top:L,width:qt}}return Zt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&s&&t.jsx("div",{className:"tour-hole",style:{left:s.left-ra,top:s.top-ra,width:s.width+ra*2,height:s.height+ra*2}}),(v||!s)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:N,children:[v&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(_r,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>l(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(d+1,c.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(d+1)/c.length*100+"%"}})})]}),t.jsx("h3",{children:w==null?void 0:w.title}),t.jsx(_r,{text:(w==null?void 0:w.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:d===0,onClick:()=>l(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>l(C=>C+1),children:d===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function Xo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function Zo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function fd(){var T,L;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:d,data:l,dispatch:s}=Z(),h=r?a:e,c=p.useMemo(()=>h.filter(O=>gt(O.date)===0&&O.kind==="target"),[h]),x=p.useMemo(()=>r?a.filter(O=>O.kind==="target"&&Te(O)===0).slice().sort((O,D)=>(D.date||"").localeCompare(O.date||"")):[],[a,r]),u=p.useMemo(()=>c.filter(O=>r?Te(O)===0:!Ye(O)),[c,r]),b=r?x:u,f=r?a.length-x.length:c.length-u.length,w=r?a.length:c.length,v=w?Math.min(100,f/w*100):100,m=p.useMemo(()=>Xo(h),[h]),y=!!m&&gt(m)>0,E=p.useMemo(()=>y?h.filter(O=>(O.date||"").slice(0,10)===m):[],[h,m,y]),k=typeof((T=l.stats)==null?void 0:T.kept_today)=="number"?l.stats.kept_today:null,j=typeof((L=l.stats)==null?void 0:L.screened_today)=="number"?l.stats.screened_today:c.length;let N;y?N=o.morningLast(E.length,x.length,Zo(m,d)):r?N=o.morningThesis(j,x.length,k):c.length?f===0?N=o.goalSourced(c.length):f>=c.length?N=o.goalCleared:N=o.goalDone(f,c.length):N=o.goalSourced(0);const C=()=>{if(!r){s({type:"pile",on:!0});return}s({type:"ptab",tab:0}),n==="client"&&x.length&&s({type:"chainStart",queue:x.map(O=>O.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:N}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function hd(){const{t:e,st:a,dispatch:r,fund:n,data:o,mode:i,doSync:d,startTour:l}=Z(),s=i==="client",[h,c]=p.useState(!1),[x,u]=p.useState(""),b=()=>{!s||h||!n||(c(!0),u(""),ms(n).then(v=>{if(c(!1),v.pending){u(e.refreshSlow);return}if(!v.ok){v.error&&console.warn("[republish]",v.error),u(e.refreshKo);return}const m=v.entered??0,y=v.left??0;u(v.unchanged||!m&&!y?e.refreshSame:e.refreshDone(m,y)),o.refresh()}))},f=(n||"P").split(/\s+/).map(v=>v[0]).join("").slice(0,2).toUpperCase(),w=(()=>{const v=Date.parse(o.generatedAt||"");if(Number.isNaN(v))return"";const m=new Date(v),y=E=>String(E).padStart(2,"0");return`${y(m.getDate())}/${y(m.getMonth()+1)} à ${y(m.getHours())}:${y(m.getMinutes())}`})();return t.jsx("div",{className:"ident",children:t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:n?f:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:n||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:n?e.identTitle(n):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),w?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(w)}):t.jsx("span",{className:"skt sk-upd"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>r({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>r({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>r({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!s||h,onClick:b,children:h?"⏳":"📰"}),(h||!!x)&&t.jsxs("span",{className:"repubst",children:[h?e.refreshRun:x,!h&&t.jsx("button",{type:"button",onClick:()=>u(""),"aria-label":"×",children:"×"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!s,onClick:d,children:"🔄"})]}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>r({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:l,children:"▶"}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:a.filters.search,onChange:v=>r({type:"filters",patch:{search:v.target.value}})})]})]})})}class Bt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],d=a+i,l=Math.abs(a)<Math.abs(i)?a-(d-i):i-(d-a);l&&(r[n++]=l),a=d}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,d=0;if(r>0){for(d=a[--r];r>0&&(n=d,o=a[--r],d=n+o,i=o-(d-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=d+o,o==n-d&&(d=n))}return d}}function*gd(e){for(const a of e)yield*a}function ei(e){return Array.from(gd(e))}var Le=1e-6,Ce=Math.PI,dt=Ce/2,Br=Ce/4,ct=Ce*2,Et=180/Ce,nt=Ce/180,Oe=Math.abs,xd=Math.atan,fa=Math.atan2,De=Math.cos,Ie=Math.sin,bd=Math.sign||function(e){return e>0?1:e<0?-1:0},Vt=Math.sqrt;function vd(e){return e>1?0:e<-1?Ce:Math.acos(e)}function ha(e){return e>1?dt:e<-1?-dt:Math.asin(e)}function pt(){}function Ha(e,a){e&&Ur.hasOwnProperty(e.type)&&Ur[e.type](e,a)}var $r={Feature:function(e,a){Ha(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Ha(r[n].geometry,a)}},Ur={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){jn(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)jn(r[n],a,0)},Polygon:function(e,a){Hr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)Hr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Ha(r[n],a)}};function jn(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function Hr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)jn(e[r],a,1);a.polygonEnd()}function Wt(e,a){e&&$r.hasOwnProperty(e.type)?$r[e.type](e,a):Ha(e,a)}function Nn(e){return[fa(e[1],e[0]),ha(e[2])]}function Kt(e){var a=e[0],r=e[1],n=De(r);return[n*De(a),n*Ie(a),Ie(r)]}function Sa(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Va(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function dn(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function za(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function Sn(e){var a=Vt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function zn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function Cn(e,a){return Oe(e)>Ce&&(e-=Math.round(e/ct)*ct),[e,a]}Cn.invert=Cn;function wd(e,a,r){return(e%=ct)?a||r?zn(Wr(e),Gr(a,r)):Wr(e):a||r?Gr(a,r):Cn}function Vr(e){return function(a,r){return a+=e,Oe(a)>Ce&&(a-=Math.round(a/ct)*ct),[a,r]}}function Wr(e){var a=Vr(e);return a.invert=Vr(-e),a}function Gr(e,a){var r=De(e),n=Ie(e),o=De(a),i=Ie(a);function d(l,s){var h=De(s),c=De(l)*h,x=Ie(l)*h,u=Ie(s),b=u*r+c*n;return[fa(x*o-b*i,c*r-u*n),ha(b*o+x*i)]}return d.invert=function(l,s){var h=De(s),c=De(l)*h,x=Ie(l)*h,u=Ie(s),b=u*o-x*i;return[fa(x*o+u*i,c*r+b*n),ha(b*r-c*n)]},d}function yd(e,a,r,n,o,i){if(r){var d=De(a),l=Ie(a),s=n*r;o==null?(o=a+n*ct,i=a-s/2):(o=Yr(d,o),i=Yr(d,i),(n>0?o<i:o>i)&&(o+=n*ct));for(var h,c=o;n>0?c>i:c<i;c-=s)h=Nn([d,-l*De(c),-l*Ie(c)]),e.point(h[0],h[1])}}function Yr(e,a){a=Kt(a),a[0]-=e,Sn(a);var r=vd(-a[1]);return((-a[2]<0?-r:r)+ct-Le)%ct}function ti(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:pt,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Oa(e,a){return Oe(e[0]-a[0])<Le&&Oe(e[1]-a[1])<Le}function Ca(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function ai(e,a,r,n,o){var i=[],d=[],l,s;if(e.forEach(function(f){if(!((w=f.length-1)<=0)){var w,v=f[0],m=f[w],y;if(Oa(v,m)){if(!v[2]&&!m[2]){for(o.lineStart(),l=0;l<w;++l)o.point((v=f[l])[0],v[1]);o.lineEnd();return}m[0]+=2*Le}i.push(y=new Ca(v,f,null,!0)),d.push(y.o=new Ca(v,null,y,!1)),i.push(y=new Ca(m,f,null,!1)),d.push(y.o=new Ca(m,null,y,!0))}}),!!i.length){for(d.sort(a),Qr(i),Qr(d),l=0,s=d.length;l<s;++l)d[l].e=r=!r;for(var h=i[0],c,x;;){for(var u=h,b=!0;u.v;)if((u=u.n)===h)return;c=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(l=0,s=c.length;l<s;++l)o.point((x=c[l])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(c=u.p.z,l=c.length-1;l>=0;--l)o.point((x=c[l])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,c=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Qr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function pn(e){return Oe(e[0])<=Ce?e[0]:bd(e[0])*((Oe(e[0])+Ce)%ct-Ce)}function kd(e,a){var r=pn(a),n=a[1],o=Ie(n),i=[Ie(r),-De(r),0],d=0,l=0,s=new Bt;o===1?n=dt+Le:o===-1&&(n=-dt-Le);for(var h=0,c=e.length;h<c;++h)if(u=(x=e[h]).length)for(var x,u,b=x[u-1],f=pn(b),w=b[1]/2+Br,v=Ie(w),m=De(w),y=0;y<u;++y,f=k,v=N,m=C,b=E){var E=x[y],k=pn(E),j=E[1]/2+Br,N=Ie(j),C=De(j),T=k-f,L=T>=0?1:-1,O=L*T,D=O>Ce,W=v*N;if(s.add(fa(W*L*Ie(O),m*C+W*De(O))),d+=D?T+L*ct:T,D^f>=r^k>=r){var J=Va(Kt(b),Kt(E));Sn(J);var F=Va(i,J);Sn(F);var g=(D^T>=0?-1:1)*ha(F[2]);(n>g||n===g&&(J[0]||J[1]))&&(l+=D^T>=0?1:-1)}}return(d<-Le||d<Le&&s<-1e-12)^l&1}function ni(e,a,r,n){return function(o){var i=a(o),d=ti(),l=a(d),s=!1,h,c,x,u={point:b,lineStart:w,lineEnd:v,polygonStart:function(){u.point=m,u.lineStart=y,u.lineEnd=E,c=[],h=[]},polygonEnd:function(){u.point=b,u.lineStart=w,u.lineEnd=v,c=ei(c);var k=kd(h,n);c.length?(s||(o.polygonStart(),s=!0),ai(c,jd,k,r,o)):k&&(s||(o.polygonStart(),s=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),s&&(o.polygonEnd(),s=!1),c=h=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,j){e(k,j)&&o.point(k,j)}function f(k,j){i.point(k,j)}function w(){u.point=f,i.lineStart()}function v(){u.point=b,i.lineEnd()}function m(k,j){x.push([k,j]),l.point(k,j)}function y(){l.lineStart(),x=[]}function E(){m(x[0][0],x[0][1]),l.lineEnd();var k=l.clean(),j=d.result(),N,C=j.length,T,L,O;if(x.pop(),h.push(x),x=null,!!C){if(k&1){if(L=j[0],(T=L.length-1)>0){for(s||(o.polygonStart(),s=!0),o.lineStart(),N=0;N<T;++N)o.point((O=L[N])[0],O[1]);o.lineEnd()}return}C>1&&k&2&&j.push(j.pop().concat(j.shift())),c.push(j.filter(Ed))}}return u}}function Ed(e){return e.length>1}function jd(e,a){return((e=e.x)[0]<0?e[1]-dt-Le:dt-e[1])-((a=a.x)[0]<0?a[1]-dt-Le:dt-a[1])}const Kr=ni(function(){return!0},Nd,zd,[-Ce,-dt]);function Nd(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,d){var l=i>0?Ce:-Ce,s=Oe(i-a);Oe(s-Ce)<Le?(e.point(a,r=(r+d)/2>0?dt:-dt),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),e.point(i,r),o=0):n!==l&&s>=Ce&&(Oe(a-n)<Le&&(a-=n*Le),Oe(i-l)<Le&&(i-=l*Le),r=Sd(a,r,i,d),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(l,r),o=0),e.point(a=i,r=d),n=l},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Sd(e,a,r,n){var o,i,d=Ie(e-r);return Oe(d)>Le?xd((Ie(a)*(i=De(n))*Ie(r)-Ie(n)*(o=De(a))*Ie(e))/(o*i*d)):(a+n)/2}function zd(e,a,r,n){var o;if(e==null)o=r*dt,n.point(-Ce,o),n.point(0,o),n.point(Ce,o),n.point(Ce,0),n.point(Ce,-o),n.point(0,-o),n.point(-Ce,-o),n.point(-Ce,0),n.point(-Ce,o);else if(Oe(e[0]-a[0])>Le){var i=e[0]<a[0]?Ce:-Ce;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Cd(e){var a=De(e),r=2*nt,n=a>0,o=Oe(a)>Le;function i(c,x,u,b){yd(b,e,r,u,c,x)}function d(c,x){return De(c)*De(x)>a}function l(c){var x,u,b,f,w;return{lineStart:function(){f=b=!1,w=1},point:function(v,m){var y=[v,m],E,k=d(v,m),j=n?k?0:h(v,m):k?h(v+(v<0?Ce:-Ce),m):0;if(!x&&(f=b=k)&&c.lineStart(),k!==b&&(E=s(x,y),(!E||Oa(x,E)||Oa(y,E))&&(y[2]=1)),k!==b)w=0,k?(c.lineStart(),E=s(y,x),c.point(E[0],E[1])):(E=s(x,y),c.point(E[0],E[1],2),c.lineEnd()),x=E;else if(o&&x&&n^k){var N;!(j&u)&&(N=s(y,x,!0))&&(w=0,n?(c.lineStart(),c.point(N[0][0],N[0][1]),c.point(N[1][0],N[1][1]),c.lineEnd()):(c.point(N[1][0],N[1][1]),c.lineEnd(),c.lineStart(),c.point(N[0][0],N[0][1],3)))}k&&(!x||!Oa(x,y))&&c.point(y[0],y[1]),x=y,b=k,u=j},lineEnd:function(){b&&c.lineEnd(),x=null},clean:function(){return w|(f&&b)<<1}}}function s(c,x,u){var b=Kt(c),f=Kt(x),w=[1,0,0],v=Va(b,f),m=Sa(v,v),y=v[0],E=m-y*y;if(!E)return!u&&c;var k=a*m/E,j=-a*y/E,N=Va(w,v),C=za(w,k),T=za(v,j);dn(C,T);var L=N,O=Sa(C,L),D=Sa(L,L),W=O*O-D*(Sa(C,C)-1);if(!(W<0)){var J=Vt(W),F=za(L,(-O-J)/D);if(dn(F,C),F=Nn(F),!u)return F;var g=c[0],A=x[0],S=c[1],P=x[1],U;A<g&&(U=g,g=A,A=U);var Q=A-g,re=Oe(Q-Ce)<Le,z=re||Q<Le;if(!re&&P<S&&(U=S,S=P,P=U),z?re?S+P>0^F[1]<(Oe(F[0]-g)<Le?S:P):S<=F[1]&&F[1]<=P:Q>Ce^(g<=F[0]&&F[0]<=A)){var B=za(L,(-O+J)/D);return dn(B,C),[F,Nn(B)]}}}function h(c,x){var u=n?e:Ce-e,b=0;return c<-u?b|=1:c>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return ni(d,l,i,n?[0,-e]:[-Ce,e-Ce])}function Ad(e,a,r,n,o,i){var d=e[0],l=e[1],s=a[0],h=a[1],c=0,x=1,u=s-d,b=h-l,f;if(f=r-d,!(!u&&f>0)){if(f/=u,u<0){if(f<c)return;f<x&&(x=f)}else if(u>0){if(f>x)return;f>c&&(c=f)}if(f=o-d,!(!u&&f<0)){if(f/=u,u<0){if(f>x)return;f>c&&(c=f)}else if(u>0){if(f<c)return;f<x&&(x=f)}if(f=n-l,!(!b&&f>0)){if(f/=b,b<0){if(f<c)return;f<x&&(x=f)}else if(b>0){if(f>x)return;f>c&&(c=f)}if(f=i-l,!(!b&&f<0)){if(f/=b,b<0){if(f>x)return;f>c&&(c=f)}else if(b>0){if(f<c)return;f<x&&(x=f)}return c>0&&(e[0]=d+c*u,e[1]=l+c*b),x<1&&(a[0]=d+x*u,a[1]=l+x*b),!0}}}}}var ia=1e9,Aa=-ia;function qd(e,a,r,n){function o(h,c){return e<=h&&h<=r&&a<=c&&c<=n}function i(h,c,x,u){var b=0,f=0;if(h==null||(b=d(h,x))!==(f=d(c,x))||s(h,c)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==f);else u.point(c[0],c[1])}function d(h,c){return Oe(h[0]-e)<Le?c>0?0:3:Oe(h[0]-r)<Le?c>0?2:1:Oe(h[1]-a)<Le?c>0?1:0:c>0?3:2}function l(h,c){return s(h.x,c.x)}function s(h,c){var x=d(h,1),u=d(c,1);return x!==u?x-u:x===0?c[1]-h[1]:x===1?h[0]-c[0]:x===2?h[1]-c[1]:c[0]-h[0]}return function(h){var c=h,x=ti(),u,b,f,w,v,m,y,E,k,j,N,C={point:T,lineStart:W,lineEnd:J,polygonStart:O,polygonEnd:D};function T(g,A){o(g,A)&&c.point(g,A)}function L(){for(var g=0,A=0,S=b.length;A<S;++A)for(var P=b[A],U=1,Q=P.length,re=P[0],z,B,I=re[0],ee=re[1];U<Q;++U)z=I,B=ee,re=P[U],I=re[0],ee=re[1],B<=n?ee>n&&(I-z)*(n-B)>(ee-B)*(e-z)&&++g:ee<=n&&(I-z)*(n-B)<(ee-B)*(e-z)&&--g;return g}function O(){c=x,u=[],b=[],N=!0}function D(){var g=L(),A=N&&g,S=(u=ei(u)).length;(A||S)&&(h.polygonStart(),A&&(h.lineStart(),i(null,null,1,h),h.lineEnd()),S&&ai(u,l,g,i,h),h.polygonEnd()),c=h,u=b=f=null}function W(){C.point=F,b&&b.push(f=[]),j=!0,k=!1,y=E=NaN}function J(){u&&(F(w,v),m&&k&&x.rejoin(),u.push(x.result())),C.point=T,k&&c.lineEnd()}function F(g,A){var S=o(g,A);if(b&&f.push([g,A]),j)w=g,v=A,m=S,j=!1,S&&(c.lineStart(),c.point(g,A));else if(S&&k)c.point(g,A);else{var P=[y=Math.max(Aa,Math.min(ia,y)),E=Math.max(Aa,Math.min(ia,E))],U=[g=Math.max(Aa,Math.min(ia,g)),A=Math.max(Aa,Math.min(ia,A))];Ad(P,U,e,a,r,n)?(k||(c.lineStart(),c.point(P[0],P[1])),c.point(U[0],U[1]),S||c.lineEnd(),N=!1):S&&(c.lineStart(),c.point(g,A),N=!1)}y=g,E=A,k=S}return C}}const An=e=>e;var cn=new Bt,qn=new Bt,ri,oi,Tn,Ln,Nt={point:pt,lineStart:pt,lineEnd:pt,polygonStart:function(){Nt.lineStart=Td,Nt.lineEnd=Fd},polygonEnd:function(){Nt.lineStart=Nt.lineEnd=Nt.point=pt,cn.add(Oe(qn)),qn=new Bt},result:function(){var e=cn/2;return cn=new Bt,e}};function Td(){Nt.point=Ld}function Ld(e,a){Nt.point=ii,ri=Tn=e,oi=Ln=a}function ii(e,a){qn.add(Ln*e-Tn*a),Tn=e,Ln=a}function Fd(){ii(ri,oi)}var Jt=1/0,Wa=Jt,ga=-Jt,Ga=ga,Ya={point:Rd,lineStart:pt,lineEnd:pt,polygonStart:pt,polygonEnd:pt,result:function(){var e=[[Jt,Wa],[ga,Ga]];return ga=Ga=-(Wa=Jt=1/0),e}};function Rd(e,a){e<Jt&&(Jt=e),e>ga&&(ga=e),a<Wa&&(Wa=a),a>Ga&&(Ga=a)}var Fn=0,Rn=0,sa=0,Qa=0,Ka=0,Gt=0,On=0,Mn=0,la=0,si,li,bt,vt,lt={point:$t,lineStart:Jr,lineEnd:Xr,polygonStart:function(){lt.lineStart=Dd,lt.lineEnd=Id},polygonEnd:function(){lt.point=$t,lt.lineStart=Jr,lt.lineEnd=Xr},result:function(){var e=la?[On/la,Mn/la]:Gt?[Qa/Gt,Ka/Gt]:sa?[Fn/sa,Rn/sa]:[NaN,NaN];return Fn=Rn=sa=Qa=Ka=Gt=On=Mn=la=0,e}};function $t(e,a){Fn+=e,Rn+=a,++sa}function Jr(){lt.point=Od}function Od(e,a){lt.point=Md,$t(bt=e,vt=a)}function Md(e,a){var r=e-bt,n=a-vt,o=Vt(r*r+n*n);Qa+=o*(bt+e)/2,Ka+=o*(vt+a)/2,Gt+=o,$t(bt=e,vt=a)}function Xr(){lt.point=$t}function Dd(){lt.point=Pd}function Id(){di(si,li)}function Pd(e,a){lt.point=di,$t(si=bt=e,li=vt=a)}function di(e,a){var r=e-bt,n=a-vt,o=Vt(r*r+n*n);Qa+=o*(bt+e)/2,Ka+=o*(vt+a)/2,Gt+=o,o=vt*e-bt*a,On+=o*(bt+e),Mn+=o*(vt+a),la+=o*3,$t(bt=e,vt=a)}function pi(e){this._context=e}pi.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,ct);break}}},result:pt};var Dn=new Bt,un,ci,ui,da,pa,xa={point:pt,lineStart:function(){xa.point=_d},lineEnd:function(){un&&mi(ci,ui),xa.point=pt},polygonStart:function(){un=!0},polygonEnd:function(){un=null},result:function(){var e=+Dn;return Dn=new Bt,e}};function _d(e,a){xa.point=mi,ci=da=e,ui=pa=a}function mi(e,a){da-=e,pa-=a,Dn.add(Vt(da*da+pa*pa)),da=e,pa=a}let Zr,Ja,eo,to;class ao{constructor(a){this._append=a==null?fi:Bd(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==eo||this._append!==Ja){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,eo=n,Ja=this._append,to=this._,this._=o}this._+=to;break}}}result(){const a=this._;return this._="",a.length?a:null}}function fi(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Bd(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return fi;if(a!==Zr){const r=10**a;Zr=a,Ja=function(o){let i=1;this._+=o[0];for(const d=o.length;i<d;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ja}function $d(e,a){let r=3,n=4.5,o,i;function d(l){return l&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Wt(l,o(i))),i.result()}return d.area=function(l){return Wt(l,o(Nt)),Nt.result()},d.measure=function(l){return Wt(l,o(xa)),xa.result()},d.bounds=function(l){return Wt(l,o(Ya)),Ya.result()},d.centroid=function(l){return Wt(l,o(lt)),lt.result()},d.projection=function(l){return arguments.length?(o=l==null?(e=null,An):(e=l).stream,d):e},d.context=function(l){return arguments.length?(i=l==null?(a=null,new ao(r)):new pi(a=l),typeof n!="function"&&i.pointRadius(n),d):a},d.pointRadius=function(l){return arguments.length?(n=typeof l=="function"?l:(i.pointRadius(+l),+l),d):n},d.digits=function(l){if(!arguments.length)return r;if(l==null)r=null;else{const s=Math.floor(l);if(!(s>=0))throw new RangeError(`invalid digits: ${l}`);r=s}return a===null&&(i=new ao(r)),d},d.projection(e).digits(r).context(a)}function Qn(e){return function(a){var r=new In;for(var n in e)r[n]=e[n];return r.stream=a,r}}function In(){}In.prototype={constructor:In,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Kn(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Wt(r,e.stream(Ya)),a(Ya.result()),n!=null&&e.clipExtent(n),e}function hi(e,a,r){return Kn(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],d=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),l=+a[0][0]+(o-d*(n[1][0]+n[0][0]))/2,s=+a[0][1]+(i-d*(n[1][1]+n[0][1]))/2;e.scale(150*d).translate([l,s])},r)}function Ud(e,a,r){return hi(e,[[0,0],a],r)}function Hd(e,a,r){return Kn(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),d=(o-i*(n[1][0]+n[0][0]))/2,l=-i*n[0][1];e.scale(150*i).translate([d,l])},r)}function Vd(e,a,r){return Kn(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),d=-i*n[0][0],l=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([d,l])},r)}var no=16,Wd=De(30*nt);function ro(e,a){return+a?Yd(e,a):Gd(e)}function Gd(e){return Qn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Yd(e,a){function r(n,o,i,d,l,s,h,c,x,u,b,f,w,v){var m=h-n,y=c-o,E=m*m+y*y;if(E>4*a&&w--){var k=d+u,j=l+b,N=s+f,C=Vt(k*k+j*j+N*N),T=ha(N/=C),L=Oe(Oe(N)-1)<Le||Oe(i-x)<Le?(i+x)/2:fa(j,k),O=e(L,T),D=O[0],W=O[1],J=D-n,F=W-o,g=y*J-m*F;(g*g/E>a||Oe((m*J+y*F)/E-.5)>.3||d*u+l*b+s*f<Wd)&&(r(n,o,i,d,l,s,D,W,L,k/=C,j/=C,N,w,v),v.point(D,W),r(D,W,L,k,j,N,h,c,x,u,b,f,w,v))}}return function(n){var o,i,d,l,s,h,c,x,u,b,f,w,v={point:m,lineStart:y,lineEnd:k,polygonStart:function(){n.polygonStart(),v.lineStart=j},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function m(T,L){T=e(T,L),n.point(T[0],T[1])}function y(){x=NaN,v.point=E,n.lineStart()}function E(T,L){var O=Kt([T,L]),D=e(T,L);r(x,u,c,b,f,w,x=D[0],u=D[1],c=T,b=O[0],f=O[1],w=O[2],no,n),n.point(x,u)}function k(){v.point=m,n.lineEnd()}function j(){y(),v.point=N,v.lineEnd=C}function N(T,L){E(o=T,L),i=x,d=u,l=b,s=f,h=w,v.point=E}function C(){r(x,u,c,b,f,w,i,d,o,l,s,h,no,n),v.lineEnd=k,k()}return v}}var Qd=Qn({point:function(e,a){this.stream.point(e*nt,a*nt)}});function Kd(e){return Qn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Jd(e,a,r,n,o){function i(d,l){return d*=n,l*=o,[a+e*d,r-e*l]}return i.invert=function(d,l){return[(d-a)/e*n,(r-l)/e*o]},i}function oo(e,a,r,n,o,i){if(!i)return Jd(e,a,r,n,o);var d=De(i),l=Ie(i),s=d*e,h=l*e,c=d/e,x=l/e,u=(l*r-d*a)/e,b=(l*a+d*r)/e;function f(w,v){return w*=n,v*=o,[s*w-h*v+a,r-h*w-s*v]}return f.invert=function(w,v){return[n*(c*w-x*v+u),o*(b-x*w-c*v)]},f}function Xd(e){return Zd(function(){return e})()}function Zd(e){var a,r=150,n=480,o=250,i=0,d=0,l=0,s=0,h=0,c,x=0,u=1,b=1,f=null,w=Kr,v=null,m,y,E,k=An,j=.5,N,C,T,L,O;function D(g){return T(g[0]*nt,g[1]*nt)}function W(g){return g=T.invert(g[0],g[1]),g&&[g[0]*Et,g[1]*Et]}D.stream=function(g){return L&&O===g?L:L=Qd(Kd(c)(w(N(k(O=g)))))},D.preclip=function(g){return arguments.length?(w=g,f=void 0,F()):w},D.postclip=function(g){return arguments.length?(k=g,v=m=y=E=null,F()):k},D.clipAngle=function(g){return arguments.length?(w=+g?Cd(f=g*nt):(f=null,Kr),F()):f*Et},D.clipExtent=function(g){return arguments.length?(k=g==null?(v=m=y=E=null,An):qd(v=+g[0][0],m=+g[0][1],y=+g[1][0],E=+g[1][1]),F()):v==null?null:[[v,m],[y,E]]},D.scale=function(g){return arguments.length?(r=+g,J()):r},D.translate=function(g){return arguments.length?(n=+g[0],o=+g[1],J()):[n,o]},D.center=function(g){return arguments.length?(i=g[0]%360*nt,d=g[1]%360*nt,J()):[i*Et,d*Et]},D.rotate=function(g){return arguments.length?(l=g[0]%360*nt,s=g[1]%360*nt,h=g.length>2?g[2]%360*nt:0,J()):[l*Et,s*Et,h*Et]},D.angle=function(g){return arguments.length?(x=g%360*nt,J()):x*Et},D.reflectX=function(g){return arguments.length?(u=g?-1:1,J()):u<0},D.reflectY=function(g){return arguments.length?(b=g?-1:1,J()):b<0},D.precision=function(g){return arguments.length?(N=ro(C,j=g*g),F()):Vt(j)},D.fitExtent=function(g,A){return hi(D,g,A)},D.fitSize=function(g,A){return Ud(D,g,A)},D.fitWidth=function(g,A){return Hd(D,g,A)},D.fitHeight=function(g,A){return Vd(D,g,A)};function J(){var g=oo(r,0,0,u,b,x).apply(null,a(i,d)),A=oo(r,n-g[0],o-g[1],u,b,x);return c=wd(l,s,h),C=zn(a,A),T=zn(c,C),N=ro(C,j),F()}function F(){return L=O=null,D}return function(){return a=e.apply(this,arguments),D.invert=a.invert&&W,J()}}function gi(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}gi.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,d=i*i;r-=o=(r*(1.007226+i*(.015085+d*(-.044475+.028874*i-.005916*d)))-a)/(1.007226+i*(.015085*3+d*(-.044475*7+.028874*9*i-.005916*11*d)))}while(Oe(o)>Le&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function ep(){return Xd(gi).scale(175.295)}function tp(e){return e}function ap(e){if(e==null)return tp;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],d=e.translate[1];return function(l,s){s||(a=r=0);var h=2,c=l.length,x=new Array(c);for(x[0]=(a+=l[0])*n+i,x[1]=(r+=l[1])*o+d;h<c;)x[h]=l[h],++h;return x}}function np(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function rp(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return io(e,r)})}:io(e,a)}function io(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=op(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function op(e,a){var r=ap(e.transform),n=e.arcs;function o(c,x){x.length&&x.pop();for(var u=n[c<0?~c:c],b=0,f=u.length;b<f;++b)x.push(r(u[b],b));c<0&&np(x,f)}function i(c){return r(c)}function d(c){for(var x=[],u=0,b=c.length;u<b;++u)o(c[u],x);return x.length<2&&x.push(x[0]),x}function l(c){for(var x=d(c);x.length<4;)x.push(x[0]);return x}function s(c){return c.map(l)}function h(c){var x=c.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:c.geometries.map(h)};case"Point":u=i(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(i);break;case"LineString":u=d(c.arcs);break;case"MultiLineString":u=c.arcs.map(d);break;case"Polygon":u=s(c.arcs);break;case"MultiPolygon":u=c.arcs.map(s);break;default:return null}return{type:x,coordinates:u}}return h(a)}const xi={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},ip=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function sp(e,a,r){const n=xi[e];if(!n||!n.length)return-1;const o=ip(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(d=>o.includes(d)))return i}return Math.floor(r*n.length)%n.length}let qa=null;function lp(){return qa||(qa=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=rp(r,n),i=ep().fitExtent([[8,8],[992,492]],{type:"Sphere"}),d=$d(i),l=(o.features||[]).filter(c=>{var x;return(((x=c.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(c=>{var b;const x=((b=c.properties)==null?void 0:b.name)||"",u=d(c)||"";return u?{i2:fs(x)||null,n:x,d:u}:null}).filter(c=>!!c);if(!l.length)return null;const s={};for(const[c,x]of Object.entries(hs)){const u=i(x);u&&(s[c]={x:u[0],y:u[1]})}const h={};for(const[c,x]of Object.entries(xi)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,f])=>({x:b,y:f}));u.length&&(h[c]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:l,anchors:s,metros:h}}catch{return null}})(),qa)}function dp(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return lp().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const pp="8 40 984 210",cp={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},so=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function lo(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function up(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const d=()=>{var h;if(!o)return;const s=(h=e.current)==null?void 0:h.getScreenCTM();s&&s.a>0?n(s.a):i=requestAnimationFrame(d)};d();const l=new ResizeObserver(()=>d());return e.current&&l.observe(e.current),window.addEventListener("resize",d),()=>{o=!1,cancelAnimationFrame(i),l.disconnect(),window.removeEventListener("resize",d)}},[e,a]),r}function po({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],d)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":d*.18+"s"}},d)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function mp(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:d,lang:l,t:s,data:h,dossiers:c,source:x}=Z(),u=h.loading&&!c.length,b=p.useRef(null),f=p.useRef(null),w=dp(e.continent==="monde"),v=e.continent==="monde"?w:Un.find(g=>g.key===e.continent)||null,m=up(b,e.continent+":"+e.mapFolded+":"+!!v),[y,E]=p.useState(new Map),[k,j]=p.useState(null);p.useEffect(()=>{const g=b.current;if(!g)return;const A=new Map;g.querySelectorAll("path[data-i2]").forEach(S=>{const P=S.dataset.i2;if(P)try{const U=S.getBBox();U.width>0&&A.set(P,{x:U.x,y:U.y,w:U.width,h:U.height})}catch{}}),E(A)},[e.continent,m,v]);const N=p.useMemo(()=>r.filter(g=>g.cc),[r]),C=p.useMemo(()=>{const g=new Map;return N.forEach(A=>g.set(A.cc,(g.get(A.cc)||0)+1)),g},[N]),T=e.continent==="monde"&&w?w.anchors:null,L=e.continent==="monde"&&w?w.metros:null,O=p.useMemo(()=>N.map(g=>{const A=lo(g.name||g.id||""),S=lo((g.id||g.name||"")+"·y");if(T&&g.cc){const z=L?L[g.cc]:void 0;if(z&&z.length){const I=sp(g.cc,g.city,A);if(I>=0&&z[I])return{d:g,x:z[I].x+(A-.5)*5,y:z[I].y+(S-.5)*5}}const B=T[g.cc];if(B)return{d:g,x:B.x+(A-.5)*10,y:B.y+(S-.5)*10}}const P=g.cc?y.get(g.cc):void 0;if(!P)return null;const U=cp[`${e.continent}:${g.cc||""}`];if(U)return{d:g,x:P.x+P.w*(U.fx+(A-.5)*U.sx),y:P.y+P.h*(U.fy+(S-.5)*U.sy)};const Q=(A-.5)*Math.min(P.w*.55,60),re=(S-.5)*Math.min(P.h*.55,60);return{d:g,x:P.x+P.w/2+Q,y:P.y+P.h/2+re}}).filter(g=>!!g),[N,y,T,L,e.continent]),D=g=>m>0?g/m:g,W=p.useMemo(()=>n?[0,1,2,3,4,5].map(g=>({c:so[g],fr:s.plabels[g],en:s.plabels[g],n:r.filter(A=>A.kind==="target"&&Te(A)===g).length})).filter(g=>g.n>0):cr.map((g,A)=>({...g,n:r.filter(S=>ur(S)===A).length})),[r,n,s.plabels]),J=i?d.get(i):null,F=J?O.find(g=>g.d.id===J.id):null;return v?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:f,children:[u&&t.jsx(po,{msgs:s.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?pp:v.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":l==="fr"?v.fr:v.en,onMouseLeave:()=>{j(null),o(null)},children:[t.jsx("g",{children:v.countries.map((g,A)=>t.jsx("g",{className:"ct"+(g.i2&&C.get(g.i2)?"":" empty"),children:t.jsx("path",{d:g.d,"data-i2":g.i2||void 0})},A))}),t.jsx("g",{children:O.map(g=>{const A=cr[ur(g.d)],S=!!He(g.d),P=g.d.kind==="target",U=n&&P?so[Te(g.d)]:A.c,Q=!n&&Ye(g.d);return t.jsxs("g",{className:"co"+(Q?" done":""),onMouseEnter:()=>{var B,I;const re=(B=f.current)==null?void 0:B.getBoundingClientRect(),z=(I=b.current)==null?void 0:I.createSVGPoint();if(z&&b.current&&re){z.x=g.x,z.y=g.y;const ee=z.matrixTransform(b.current.getScreenCTM());j({x:ee.x-re.left,y:ee.y-re.top,label:g.d.name+" · "+(ea(g.d.cc,l)||g.d.countryLabel||"")})}o(g.d.id)},onMouseLeave:()=>{j(null),o(null)},onClick:()=>{var B;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:g.d.id}),(g.d.noCo||["media","nominations","recrutements"].includes(g.d.engine||""))&&(g.d.url||g.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g.d.url||"",text:[g.d.headline,g.d.tagline].filter(Boolean).join(`
`)}})):g.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g.d.name,url:g.d.url||"",website:g.d.website||"",domain:g.d.domain||""}}));return}const re=(B=b.current)==null?void 0:B.createSVGPoint();let z=null;if(re&&b.current){re.x=g.x,re.y=g.y;const I=re.matrixTransform(b.current.getScreenCTM());z={x:I.x,y:I.y}}a({type:"popup",id:g.d.id,anchor:z})},children:[t.jsx("circle",{className:"h",cx:g.x,cy:g.y,r:D(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:g.x,cy:g.y,r:D(A.px),fill:U,stroke:S?"#E5484D":"#ffffff",strokeWidth:D(S?2.2:1.3)})]},g.d.id||g.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:D(13),fill:"none",stroke:"#16233A",strokeWidth:D(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:W.map((g,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":g.c}}),l==="fr"?g.fr:g.en," ",t.jsx("b",{children:g.n})]},A))}),r.some(g=>!g.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",s.notLocated," ",t.jsx("b",{children:r.filter(g=>!g.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),"data-cont":e.continent,ref:f,children:t.jsx(po,{msgs:s.loadMsgs})})}function fp(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function bi({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:d,lang:l}=Z(),s=a.filters,[h,c]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null),f=p.useRef(null),w=p.useMemo(()=>a.continent==="monde"?n:n.filter(F=>F.continent===a.continent),[n,a.continent]),v=F=>w.filter(g=>F!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Ua(g,s,i,F==="country"?void 0:F)),m=F=>!i||F.kind!=="op",y=p.useMemo(()=>{const F=v("win").filter(m),g=A=>F.filter(S=>(S.date?Math.max(0,Math.floor((Date.now()-Date.parse(S.date))/864e5)):9999)<=A).length;return[g(0),g(7),g(30),F.length]},[w,s,i]),E=p.useMemo(()=>s.day?v("win").filter(m).filter(F=>(F.date||"").slice(0,10)===s.day).length:0,[w,s,i]),k=(s.signalOnly?1:0)+s.sector.length+s.market.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+s.crible.length,j=k+(s.acquirer.trim()?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&c(!1)},[a.openFacet]),p.useEffect(()=>{if(!h&&!x)return;const F=A=>{var P,U;const S=A.target;h&&!((P=b.current)!=null&&P.contains(S))&&c(!1),x&&!((U=f.current)!=null&&U.contains(S))&&u(!1)},g=A=>{A.key==="Escape"&&(c(!1),u(!1))};return document.addEventListener("mousedown",F),document.addEventListener("keydown",g),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("keydown",g)}},[h,x]);const N=(F,g,A,S="fbtn")=>t.jsxs("button",{type:"button",className:S,"aria-expanded":a.openFacet===F,onClick:()=>r({type:"openFacet",facet:F}),children:[t.jsx("span",{className:"fl",children:g}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},F),C=["1","7","30","all"],T=Math.max(0,C.indexOf(s.win||"all")),L=s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(fp(s.day,l))}),t.jsx("b",{children:E})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:f,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(F=>!F),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[T]}),t.jsx("b",{children:y[T]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((F,g)=>t.jsxs("button",{type:"button",role:"option","aria-selected":s.win===F,onClick:()=>{r({type:"filters",patch:{win:F}}),u(!1)},children:[o.datesShort[g],t.jsx("span",{className:"n",children:y[g]})]},F))})]}):t.jsx("div",{className:"seg",children:C.map((F,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===F,onClick:()=>r({type:"filters",patch:{win:F}}),children:[t.jsx("span",{className:"sl",children:o.dates[g]}),t.jsx("b",{children:y[g]})]},F))}),O=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:s.search,onChange:F=>r({type:"filters",patch:{search:F.target.value}})})]}),D=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):N("sec",o.fSector,s.sector.length),(n.some(F=>!!F.market)||s.market.length>0)&&N("mar",o.fMarket,s.market.length),N("pay",o.fCountry,s.country.length),N("det",o.fEngine,s.engine.length),N("sta",o.fStage,s.stage.length),i&&N("crib",o.fVerdict,s.crible.length),i&&N("ang","Angle",s.angle.length),i&&N("mem","Mémo",s.memoLevel.length)]}),W=(F=!1)=>t.jsxs("div",{className:"frow2",children:[j>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(w.length,d),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(j)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),F&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),J=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":h,"aria-haspopup":"true",onClick:()=>{c(F=>!F),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:D})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(s.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:L}),t.jsxs("div",{className:"fstrip-b",children:[O,J,W(!1)]})]}),a.openFacet&&t.jsx(co,{poolFor:v})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[L,O,D,t.jsx("span",{className:"fgrow"}),W()]}),a.openFacet&&t.jsx(co,{poolFor:v})]})}function co({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:d}=Z(),l=a.filters,s=a.openFacet,{title:h,cols:c,options:x}=p.useMemo(()=>{if(s==="sig"){const v=e("signal").filter(E=>He(E)),m=new Map;v.forEach(E=>{const k=E.engine||"";m.set(k,(m.get(k)||0)+1)});const y=[{v:"*",label:n.fpSigAll,n:v.length,html:!0,on:l.signalOnly&&!l.signalEngines.length},...yn([...m.keys()],o).map(E=>({v:E,label:_t(E)+" "+rt(E,o),n:m.get(E)||0,html:!1,on:l.signalOnly&&l.signalEngines.includes(E)}))];return{title:n.fpSigTitle,cols:2,options:y}}if(s==="crib"){const v=e("crible").filter(y=>!i||So(y,a.ptab,d.favIds)),m=new Map;return v.forEach(y=>{const E=zo(y);E&&E!=="NEW"&&m.set(E,(m.get(E)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...m.entries()].sort((y,E)=>(mr[y[0]]??9)-(mr[E[0]]??9)||E[1]-y[1]).map(([y,E])=>({v:y,label:'<span class="fdot" style="background:'+(gs[y]||"#94A3B8")+'"></span>'+y,n:E,html:!0,on:l.crible.includes(y)}))}}if(s==="sec"){const v=e("sector"),m=new Map;return v.forEach(y=>{y.sector&&m.set(y.sector,(m.get(y.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:l.sector.includes(y)}))}}if(s==="mar"){const v=e("market"),m=new Map;return v.forEach(y=>{y.market&&m.set(y.market,(m.get(y.market)||0)+1)}),{title:n.fMarket,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y,n:E,html:!1,on:l.market.includes(y)}))}}if(s==="pay"){const v=e("country"),m=new Map;return v.forEach(y=>{y.cc&&m.set(y.cc,(m.get(y.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:ea(y,o)||y,n:E,html:!1,on:l.country.includes(y)}))}}if(s==="det"){const v=e("engine"),m=new Map;return v.forEach(y=>{y.engine&&m.set(y.engine,(m.get(y.engine)||0)+1)}),{title:n.fEngine,cols:2,options:yn([...m.keys()],o).map(y=>({v:y,label:_t(y)+" "+rt(y,o)+' <span style="color:var(--dim);font-size:10px">· '+xs(bs(y),o)+"</span>",n:m.get(y)||0,html:!0,on:l.engine.includes(y)}))}}if(s==="ang"){const v=e("angle"),m=new Map;return v.forEach(y=>{y.angle&&m.set(y.angle,(m.get(y.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...m.entries()].sort((y,E)=>E[1]-y[1]).map(([y,E])=>({v:y,label:y.replace(/[_-]+/g," "),n:E,html:!1,on:l.angle.includes(y)}))}}if(s==="mem"){const v=e("memoLevel"),m=new Map;v.forEach(E=>{if(E.kind==="target"){const k=$n(E);m.set(k,(m.get(k)||0)+1)}});const y=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(E=>({v:String(E),label:y[E],n:m.get(E)||0,html:!1,on:l.memoLevel.includes(E)}))}}const f=e("stage"),w=new Map;return f.forEach(v=>{v.stage&&w.set(v.stage,(w.get(v.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...w.entries()].sort((v,m)=>m[1]-v[1]).map(([v,m])=>({v,label:v,n:m,html:!1,on:l.stage.includes(v)}))}},[s,a,o]),u=f=>{if(s==="sig"){if(f==="*")r({type:"filters",patch:{signalOnly:!(l.signalOnly&&!l.signalEngines.length),signalEngines:[]}});else{const v=l.signalEngines.includes(f)?l.signalEngines.filter(m=>m!==f):[...l.signalEngines,f];r({type:"filters",patch:{signalOnly:!0,signalEngines:v}})}return}if(s==="mem"){r({type:"toggleMemoLevel",value:Number(f)});return}r({type:"toggleFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage",value:f})},b=()=>{r(s==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:s==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:s==="sec"?"sector":s==="mar"?"market":s==="pay"?"country":s==="det"?"engine":s==="ang"?"angle":s==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:h}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(c===2?" two":""),children:x.map(f=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":f.on,onClick:()=>u(f.v),children:[t.jsx("span",{className:"bx"}),f.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:f.label}}):t.jsx("span",{className:"l",children:f.label}),t.jsx("span",{className:"n",children:f.n})]},f.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function vi({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:d,t:l}=Z(),s=p.useMemo(()=>{const b={};return r.forEach(f=>{Ua(f,n.filters,i)&&(b.monde=(b.monde||0)+1,f.continent&&(b[f.continent]=(b[f.continent]||0)+1))}),b},[r,n.filters,i]),[h,c]=p.useState(!1),x=p.useRef(null);p.useEffect(()=>{if(!h)return;const b=w=>{var v;(v=x.current)!=null&&v.contains(w.target)||c(!1)},f=w=>{w.key==="Escape"&&c(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",f),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",f)}},[h]);const u=b=>{const f=Un.find(w=>w.key===b);return b==="monde"?l.contWorld:d==="fr"?f.fr:f.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":h,"aria-haspopup":"listbox",onClick:()=>c(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:s[n.continent]||0}),t.jsx("i",{children:h?"▴":"▾"})]}),h&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:fr.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),c(!1)},children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b))}),t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]}):t.jsxs("div",{className:"conts",children:[fr.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:s[b]||0})]},b)),t.jsxs("span",{className:"side",children:[t.jsx("button",{type:"button",className:"resetmap",title:l.toolReset,onClick:()=>{o({type:"reset"}),o({type:"ptab",tab:1}),o({type:"continent",key:i?"europe":"monde"}),o({type:"dens",dens:"liste"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}},children:l.toolReset}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?l.showMap:l.hideMap})]})]})}function Pn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function wi(e){return"atl2:evalq:"+(e||"anon")}function hp(e,a){const r=wi(e),n=Pn(r),o=new Set(n.map(l=>(l.name||"").trim().toLowerCase())),i=a.map(l=>(l||"").trim()).filter(l=>l&&!o.has(l.toLowerCase())).map(l=>({name:l,site:"",status:"",auto:!0}));if(!i.length)return 0;const d=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(d)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}let _n=null;function gp(e){_n=e;try{window.dispatchEvent(new CustomEvent("atl2:extract-note",{detail:e}))}catch{}}function xp(){const{t:e,lang:a,data:r,dossiers:n}=Z(),o=r.session.token||"",i=wi(o),[d,l]=p.useState(()=>Pn(i)),s=p.useRef(!1),[h,c]=p.useState(!1);p.useEffect(()=>{try{const z=d.slice(0,30).map(({descBusy:B,evalBusy:I,...ee})=>ee);localStorage.setItem(i,JSON.stringify(z)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[d,i]),p.useEffect(()=>{const z=()=>{if(s.current)return;const B=Pn(i);l(I=>JSON.stringify(I.map(({descBusy:ee,evalBusy:$,...oe})=>oe))===JSON.stringify(B)?I:B)};return window.addEventListener("atl2:evalq",z),window.addEventListener("storage",z),()=>{window.removeEventListener("atl2:evalq",z),window.removeEventListener("storage",z)}},[i]);const[x,u]=p.useState([]),[b,f]=p.useState(""),[w,v]=p.useState(!1),[m,y]=p.useState(!1),[E,k]=p.useState(""),[j,N]=p.useState(()=>_n);p.useEffect(()=>{const z=B=>{var ee,$;const I=B.detail;I&&((ee=I.cited)!=null&&ee.length||($=I.match)!=null&&$.length||I.title)&&N(I)};return window.addEventListener("atl2:extract-note",z),()=>window.removeEventListener("atl2:extract-note",z)},[]);const C=p.useCallback((z,B)=>l(I=>I.map((ee,$)=>$===z?{...ee,...B}:ee)),[]),T=p.useCallback((z,B)=>{const I=B.trim();I&&(C(z,{name:I,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Hn(I).then(ee=>{const $=ee.candidates||[];ee.website?C(z,{site:ee.website,status:"ready"}):$.length===1?C(z,{site:$[0].url,status:"ready"}):$.length>1?C(z,{status:"pick",candidates:$.slice(0,6)}):C(z,{status:"ready"})}).catch(()=>C(z,{status:"ready"})))},[C]),L=p.useCallback((z,B,I)=>{C(z,{descBusy:!0}),Ao(o,B,I).then(ee=>{if(ee.quota){c(!0),C(z,{descBusy:!1,descDone:!0});return}const $=ee.blocs||{},oe=($.synthese||$.value_prop||$.produit||$.modele||"").trim();C(z,{descBusy:!1,descDone:!0,desc:oe})}).catch(()=>C(z,{descBusy:!1,descDone:!0}))},[C,o]);p.useEffect(()=>{const z=d.findIndex(I=>I.auto&&I.name.trim()&&I.status==="");if(z>=0){T(z,d[z].name);return}if(h)return;const B=d.findIndex(I=>I.status==="ready"&&I.site&&!I.descDone&&!I.descBusy);B>=0&&L(B,d[B].name,d[B].site)},[d,T,L,h]);const[O,D]=p.useState(!1),W=p.useCallback(async(z,B)=>{C(z,{evalBusy:!0});const I=(B.site||B.name).trim(),ee=await qo(o,I,"atelier2");return ee.verdict==="quota"?(C(z,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:ee.reason||"",remaining:0}})),!1):(C(z,{evalBusy:!1,status:ee.verdict==="kept"?"kept":"out",reason:ee.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:ee.company||B.name,verdict:ee.verdict,reason:ee.reason||"",remaining:ee.remaining??null}})),!0)},[C,o]),J=async()=>{if(O)return;const z=d.map((B,I)=>({r:B,i:I})).filter(({r:B})=>B.name.trim()&&B.status!=="kept"&&B.status!=="out"&&B.status!=="resolving");if(z.length){D(!0);for(const{r:B,i:I}of z)if(!await W(I,B))break;D(!1)}},F=p.useMemo(()=>{const z=new Set,B=[];return d.filter(I=>I.status==="kept").forEach(I=>{const ee=I.name.trim().toLowerCase();ee&&!z.has(ee)&&(z.add(ee),B.push(I.name.trim()))}),n.filter(I=>Te(I)>=1&&Te(I)<=4&&(I.website||I.domain)).forEach(I=>{const ee=(I.name||"").trim().toLowerCase();ee&&!z.has(ee)&&(z.add(ee),B.push((I.name||"").trim()))}),B},[d,n]),g=p.useMemo(()=>{const z=new Set;return n.forEach(B=>{const I=(B.name||"").trim().toLowerCase();I&&z.add(I)}),d.forEach(B=>{const I=B.name.trim().toLowerCase();I&&z.add(I)}),z},[n,d]),A=async()=>{if(b||!F.length)return;y(!1);const z=[];for(const B of F.slice(0,2)){f(B);const I=await To(o,B);if(I){if(I.verdict==="quota"){v(!0);break}(I.results||[]).forEach(ee=>{const $=(ee.company||"").trim().toLowerCase();!$||g.has($)||z.some(oe=>oe.name.toLowerCase()===$)||z.push({name:(ee.company||"").trim(),verdict:ee.verdict||"",reason:ee.reason,from:B})})}}f(""),y(!0),u(B=>[...z,...B].slice(0,24))},S=async(z,B)=>{if(b)return;y(!1),f(z==="thesis"?e.pxThesis:B);const I=await ws(o,z,B,6);if(f(""),y(!0),!I)return;if(I.verdict==="quota"){v(!0);return}const ee=[];(I.results||[]).forEach($=>{const oe=($.company||"").trim().toLowerCase();!oe||g.has(oe)||ee.some(me=>me.name.toLowerCase()===oe)||ee.push({name:($.company||"").trim(),verdict:$.verdict||"",reason:$.reason,from:z==="thesis"?e.pxThesis:B})}),u($=>[...ee,...$].slice(0,24))},P=()=>{const z=E.trim();z.length<3||S(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(z)?"registry":"keyword",z)},U=z=>{l(B=>[...B,{name:z.name,site:"",status:"",auto:!0}].slice(0,30)),u(B=>B.filter(I=>I.name!==z.name))},Q=d.filter(z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out").length,re=z=>z.name.trim()&&z.status!=="kept"&&z.status!=="out"&&z.status!=="resolving"&&!z.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[j&&t.jsxs("div",{className:"eq-note"+(j.fallback?" fb":""),children:[t.jsxs("b",{children:[j.fallback?e.rsNoteFallback:e.rsNoteRead,j.title?` « ${j.title.length>90?j.title.slice(0,89)+"…":j.title} »`:""]}),!!j.cited.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteCited," ",t.jsx("i",{children:j.cited.join(" · ")})]}),!!j.match.length&&t.jsxs("p",{className:"eq-nl",children:[e.rsNoteMatch," ",t.jsx("i",{children:j.match.join(" · ")})]}),!j.match.length&&!!j.cited.length&&t.jsx("p",{className:"eq-nl",children:e.rsNoteNoMatch}),t.jsx("p",{className:"eq-nl",children:e.rsNoteAdded(j.added)}),t.jsx("button",{type:"button",className:"eq-note-x",onClick:()=>{_n=null,N(null)},title:e.rsClose,children:"×"})]}),t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{className:"eq-h-go",children:e.eqRunOneShort})]}),d.map((z,B)=>t.jsxs("div",{className:"eq-item"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsxs("div",{className:"eq-row"+(z.status==="kept"?" r-kept":z.status==="out"?" r-out":""),children:[t.jsx("input",{value:z.name,placeholder:e.eqNamePh,onChange:I=>{const ee=I.target.value.split(`
`).map($=>$.trim()).filter(Boolean);ee.length>1?l($=>{const oe=[...$];return oe.splice(B,1,...ee.map(me=>({name:me,site:"",status:"",auto:!0}))),oe.slice(0,30)}):C(B,{name:I.target.value})},onBlur:()=>{z.name.trim()&&!z.site&&z.status!=="resolving"&&z.status!=="pick"&&T(B,z.name)},onKeyDown:I=>{I.key==="Enter"&&T(B,z.name)}}),t.jsxs("span",{className:"eq-site",children:[z.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),z.status==="pick"&&t.jsxs("select",{className:"eq-pick",defaultValue:"",onChange:I=>{const ee=I.target.value;ee&&C(B,{site:ee,status:"ready",candidates:void 0})},children:[t.jsx("option",{value:"",disabled:!0,children:e.eqPick}),(z.candidates||[]).map(I=>t.jsx("option",{value:I.url,children:(I.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40)},I.url))]}),z.status!=="resolving"&&z.status!=="pick"&&(z.site?t.jsxs("a",{href:z.site.startsWith("http")?z.site:"https://"+z.site,target:"_blank",rel:"nofollow noopener",children:[z.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:z.name.trim()&&z.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:z.desc||"",children:z.descBusy?t.jsx("i",{children:e.eqDescBusy}):z.desc?z.desc:t.jsx("em",{children:z.descDone?h?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(z.status||"vide"),title:z.reason||"",children:z.status==="kept"?"✓ "+e.kept:z.status==="out"?"✗ "+e.dropped:z.status==="ready"?e.eqReady:z.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>l(I=>I.filter((ee,$)=>$!==B)),children:"×"}),(z.name.trim()||z.site)&&z.status!=="kept"&&z.status!=="out"?t.jsxs(Za,{lang:a,storeKey:(z.site||z.name).trim(),className:"eq-go",title:e.eqRunOne,disabled:!re(z)||O,confirmLabel:"⚡ "+e.eqRunOneShort,onConfirm:()=>{W(B,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]}):t.jsxs("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!re(z)||O,onClick:()=>{W(B,z)},children:[z.evalBusy?"⏳":"⚡",t.jsx("b",{children:e.eqRunOneShort})]})]}),(z.name.trim()||z.site)&&z.status!=="kept"&&z.status!=="out"&&t.jsx(vs,{lang:a,variant:"row",storeKey:(z.site||z.name).trim()})]},B)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>l(z=>[...z,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]})]}),t.jsxs("div",{className:"eq-foot",children:[t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!b,onClick:()=>{S("thesis","")},children:b===e.pxThesis?e.sgBusy(b):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:E,placeholder:e.pxPlace,onChange:z=>k(z.target.value),onKeyDown:z=>{z.key==="Enter"&&P()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b||E.trim().length<3,onClick:P,children:e.pxGoFree}),!!F.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!b,onClick:()=>{A()},children:b&&b!==e.pxThesis&&b!==E?e.sgBusy(b):e.sgGo}),!!F.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(F[0],F.length)}),w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),m&&!x.length&&!w&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),x.map(z=>t.jsxs("span",{className:"eq-sc"+(z.verdict==="kept"?" ok":""),title:(z.reason||"")+" — "+e.sgVia(z.from),children:[t.jsx("b",{children:z.name}),z.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>U(z),children:"+"})]},z.name))]}),t.jsxs("div",{className:"side",children:[t.jsx("span",{className:"hint",children:e.eqHint}),d.some(z=>z.status==="kept"||z.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>l(z=>z.filter(B=>B.status!=="kept"&&B.status!=="out")),children:e.eqClearDone}),t.jsxs("button",{type:"button",className:"evalbtn"+(O?" loading":""),style:{justifyContent:"center"},disabled:O||!Q,onClick:()=>{J()},children:[t.jsx("span",{className:"fill"}),O?e.eqRunning:e.eqGo(Q)]})]})]})]})}const bp={deals:"ma-deals",news:"veille"},yi=/^(deals?|news|breaking|live|update|analysis|markets?|opinion|icymi)$/i,vp=/^(this|that|these|those|why|what|what'?s|how|when|where|who|which|is|are|do|does|did|can|could|should|would|will|a|an|the|les?|la|des?|une?|un)\b/i,wp=/\b(labor day|workers?|toast|monday|tuesday|wednesday|thursday|friday|saturday|sunday|assessment|volunteer)\b/i,yp=/\b(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\b/i;function ki(e){const a=(e||"").trim();return!(!a||a.length<2||a.length>48||yi.test(a)||vp.test(a)||wp.test(a)||Qt(a)||!Xa(a))}function uo(e){return(e.url||e.title||"").trim()}function mn(e){const a=(e.kind||"").toLowerCase(),r=(e.ingest_kind||"").toLowerCase();if(a==="article"||a==="news"||a==="media"||r==="url"||r==="youtube")return!0;const n=(e.title||"").replace(/\s+/g," ").trim();return n?Qt(n)||yp.test(n)?!0:!Xa(n):!!(e.url||"").trim()}function Jn(e){let a=(e||"").replace(/\s+/g," ").trim();a=a.replace(/^\s*(?:deals?|news|breaking|live|update|analysis)\s*[:–—|]\s*/i,"");const r=[],n=d=>{let l=(d||"").replace(/[\u2018\u2019\u201c\u201d'"«»]/g,"").trim();l=l.replace(/^(the|le|la|les|l['’])\s+/i,"").trim(),l=l.replace(/\s+(?:'s|retirement|business|unit|division|arm|operations?)\b.*$/i,"").trim(),ki(l)&&(r.some(s=>s.toLowerCase()===l.toLowerCase())||r.push(l))},o=a.match(/^(.{2,48}?)\s+(?:buys?|buying|to\s+buy|acquired?|acquires?|to\s+acquire|acquiert|rachet(?:e|é|ée)?|raises?|raised|l[èe]ve|merges?\s+with)\s+(.{2,60}?)(?:\s+(?:for|pour|en|in|at|à|from|de)\b|$)/i);if(o&&(n(o[1]),n(o[2]),r.length))return r;const i=a.match(/^(.{2,48}?)\s*[:–—]/);return i&&n(i[1]),r}function mo(e){const a=Jn(e.title||"");if(a.length)return a[0];const r=(e.title||"").replace(/\s+/g," ").trim();if(!r)return(e.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,40);const n=/^(.{2,72}?)[:–—|]/.exec(r);return n&&!yi.test(n[1].trim())?n[1].trim():(r.split(/ (?:in talks|acquiert|acquires|raises|lève|reports)\b/i)[0]||r).slice(0,72).trim()}function kp({pageToken:e,onAddNames:a,onPanel:r}){const{t:n,lang:o,token:i,canWrite:d,flash:l}=Z(),[s,h]=p.useState(null),[c,x]=p.useState(!1),[u,b]=p.useState({deals:[],news:[]}),[f,w]=p.useState({deals:!1,news:!1}),[v,m]=p.useState(null),[y,E]=p.useState(""),k=p.useCallback(async F=>{if(!i)return[];if(f[F])return u[F];m(F),E("");const g=Date.now(),A=await ys(bp[F],i,o),S=700-(Date.now()-g);return S>0&&await new Promise(P=>window.setTimeout(P,S)),m(null),!A.ok&&A.error?(E(A.error),[]):(b(P=>({...P,[F]:A.items})),w(P=>({...P,[F]:!0})),A.items)},[i,o,f,u]);p.useEffect(()=>{s&&k(s)},[s,k]);const j=p.useCallback(F=>u[F].map(uo).filter(Boolean),[u]),N=p.useMemo(()=>{var A,S;if(!i)return{deals:[],news:[]};const F={deals:j("deals"),news:j("news")},g=Uo("feed:"+i,F);return{deals:((A=g.deals)==null?void 0:A.noms)||[],news:((S=g.news)==null?void 0:S.noms)||[]}},[i,j]),C=p.useRef(null);p.useEffect(()=>{C.current&&!s&&i&&Ho("feed:"+i,{deals:j("deals"),news:j("news")}),C.current=s},[s,i,j]);const T=()=>{h(null),x(!1),r==null||r(!1)},L=F=>{const g=[],A=new Set,S=P=>{const U=P.trim();!U||A.has(U.toLowerCase())||(A.add(U.toLowerCase()),g.push(U))};F.forEach(P=>{mn(P)?Jn(P.title||"").forEach(S):S(mo(P))}),g.length&&(a(g),T(),l(n.feedSent(g.length)))},O=F=>{const g=mo(F);g&&(window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:g,url:(F.url||"").trim()}})),T(),l(n.feedPasted(g)),requestAnimationFrame(()=>{var A;(A=document.querySelector(".atl2 .eval-stick, .atl2 .demand"))==null||A.scrollIntoView({block:"center",behavior:"smooth"})}))},D=F=>{if(mn(F)){const g=(F.url||"").trim(),A=(F.title||"").trim();if(!g&&!A)return;window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:g,text:A,auto:!0}})),T(),l(n.feedExtracting);return}O(F)},W=F=>{h(g=>{const A=g===F?null:F;return A&&x(!1),r==null||r(!!A),A})},J=F=>{const g=u[F],A=new Set(N[F].map(P=>P.toLowerCase())),S=v===F||s===F&&!f[F]&&!y;return t.jsxs("div",{className:"dfpane"+(s===F?" on":"")+(c?" tall":""),hidden:s!==F,children:[t.jsxs("div",{className:"dfhow",children:[t.jsxs("div",{className:"dfhow-h",children:[t.jsx("p",{className:"dfh",children:F==="deals"?n.feedDealsH:n.feedNewsH}),t.jsxs("span",{className:"dfhow-acts",children:[t.jsx("button",{type:"button",className:"dffold",onClick:()=>x(P=>!P),children:c?n.feedShrink:n.feedExpand}),t.jsx("button",{type:"button",className:"dffold",onClick:T,children:n.feedFold})]})]}),t.jsx("p",{className:"dfh2",children:F==="deals"?n.feedDealsHow:n.feedNewsHow})]}),S&&t.jsxs("div",{className:"dfwait",role:"status","aria-live":"polite",children:[t.jsx("i",{className:"dfspin","aria-hidden":"true"}),t.jsxs("div",{children:[t.jsx("b",{children:F==="deals"?n.feedWaitDeals:n.feedWaitNews}),t.jsx("span",{className:"dfbar",children:t.jsx("i",{})})]})]}),s===F&&!!y&&t.jsx("p",{className:"dferr",children:y}),f[F]&&!g.length&&!v&&t.jsx("p",{className:"dfempty",children:F==="deals"?n.feedEmptyDeals:n.feedEmptyNews}),!!g.length&&!S&&t.jsxs(t.Fragment,{children:[F==="deals"&&d&&g.length>1&&t.jsxs("button",{type:"button",className:"dfall",onClick:()=>L(g),children:[n.feedPutAll," (",g.length,")"]}),t.jsx("ul",{className:"dflist",children:g.map((P,U)=>{const Q=uo(P),re=A.has(Q.toLowerCase()),z=(P.url||"").trim();return t.jsxs("li",{className:re?"new":void 0,children:[t.jsxs("div",{children:[t.jsx("b",{children:P.title||z}),t.jsx("span",{children:[P.source,P.sector_fr,(P.published_at||"").slice(0,10)].filter(Boolean).join(" · ")})]}),t.jsxs("span",{className:"dfacts",children:[z&&t.jsx("a",{href:z,target:"_blank",rel:"noopener noreferrer",children:n.feedOpen}),d&&t.jsx("button",{type:"button",className:"dfan",onClick:()=>D(P),children:mn(P)?n.rowExtract:n.feedPutEval})]})]},Q||U)})})]})]})};return t.jsxs(t.Fragment,{children:[["deals","news"].map(F=>{const g=N[F].length;return t.jsxs("button",{type:"button",className:"dmulti dfbtn "+(F==="deals"?"ddeals":"dnews")+(s===F?" on":"")+(v===F?" busy":""),title:F==="deals"?n.feedDealsH:n.feedNewsH,"aria-expanded":s===F,"aria-busy":v===F||void 0,onClick:()=>W(F),children:[v===F?o==="en"?"Loading…":"Chargement…":F==="deals"?n.feedDeals:n.feedNews,g>0&&v!==F&&t.jsx("em",{title:n.feedHint,children:n.feedNew(g)})]},F)}),s&&J(s)]})}function Ei(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ep(e){var o;const a=[],r=new Set,n=i=>{const d=(i||"").trim();!d||r.has(d.toLowerCase())||(r.add(d.toLowerCase()),a.push(d))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function fo({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:d}){const{t:l}=Z();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),d&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>d(n.map(s=>s.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(s=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:s.name}),s.chips.map(h=>t.jsx("span",{className:"ch",children:h},h))]}),s.line1&&t.jsx("p",{className:"w",children:s.line1}),s.line2&&t.jsx("p",{className:"r",children:s.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(s.name),children:l.rsEvalOne})]},s.name))})]}):null}function ji({card:e,onEvaluate:a,onAddAll:r}){var d;const{t:n}=Z(),o=((e==null?void 0:e.companies_cited)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.what||"").trim(),line2:(l.role||"").trim(),chips:[(l.country||"").trim()].filter(Boolean)})),i=(((d=e==null?void 0:e.prospective)==null?void 0:d.companies_to_evaluate)||[]).filter(l=>l&&(l.name||"").trim()).map(l=>({name:(l.name||"").trim(),line1:(l.why||"").trim(),chips:[(l.country||"").trim(),(l.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(fo,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(fo,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function jp({card:e,onEvaluate:a,onAddAll:r}){var l,s,h;const{t:n}=Z(),o=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),i=(((l=e.prospective)==null?void 0:l.criteria)||[]).filter(Boolean),d=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ei(e.summary_md||"").map((c,x)=>t.jsx("p",{children:c},x))})]}),t.jsx(ji,{card:e,onEvaluate:a,onAddAll:r}),(((s=e.prospective)==null?void 0:s.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((h=e.prospective)==null?void 0:h.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(c=>t.jsx("li",{children:c},c))})]})]}),d.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:d.length})]}),t.jsx("div",{className:"rssrc",children:d.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function Np(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Sp({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:d}=Z(),l=o,[s,h]=p.useState(null),[c,x]=p.useState(null),[u,b]=p.useState(null),[f,w]=p.useState(!1);p.useEffect(()=>{let m=!0;return(async()=>{const y=await Lo({email:d,cbToken:l});m&&h(y)})(),()=>{m=!1}},[d,l,n]);const v=m=>{x(m),b(null),w(!0),(async()=>{const y=await ks(m.id);b(y),w(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&s&&t.jsx("span",{className:"n",children:s.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[s===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),s!==null&&s.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(s||[]).map(m=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(m),children:[t.jsx("span",{className:"ti",children:m.title}),t.jsxs("span",{className:"me",children:[Np(m.created_at),m.industry?` · ${m.industry}`:"",m.author?` · ${m.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(m.cited_n||0,m.evaluate_n||0)}),t.jsx("span",{className:"st"+(m.published?" on":""),children:m.published?i.rsPub:i.rsPriv})]},m.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?i.rsPub:i.rsPriv})]}),f&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!f&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!f&&u&&t.jsx(jp,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Ma=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function ca(e){return/^https?:\/\//i.test((e||"").trim())}function ht(e){const a=(e||"").trim();return a?ca(a)?a:Ma.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function zp(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function Cp(){const{t:e,lang:a,mode:r,token:n,email:o,askEvaluate:i,sessTally:d,dispatch:l,evalBusy:s,evalCards:h,caps:c,data:x,canWrite:u,source:b,dossiers:f,doAnalyse:w,liveMemos:v,pipe:m}=Z(),y=r==="client",E=p.useMemo(()=>n||(b!=="default"?Es():""),[n,b]),[k,j]=p.useState(""),[N,C]=p.useState(!1),[T,L]=p.useState(""),[O,D]=p.useState(""),[W,J]=p.useState(""),[F,g]=p.useState(!1),[A,S]=p.useState(!1),[P,U]=p.useState([]);p.useEffect(()=>{const M=ne=>{const V=ne.detail;V&&U(pe=>[V,...pe].slice(0,8))};return window.addEventListener("ppmap:evalcard",M),()=>window.removeEventListener("ppmap:evalcard",M)},[]);const[Q,re]=p.useState(!1),[z,B]=p.useState(!1),[I,ee]=p.useState(!1),$=p.useRef(!1),[oe,me]=p.useState(""),[xe,ye]=p.useState(""),[ce,ze]=p.useState(!1),[Ae,ue]=p.useState(!1),[ve,ke]=p.useState(0),[te,_]=p.useState(""),[K,se]=p.useState(null),[le,fe]=p.useState(null),[H,de]=p.useState(!1),[we,Ee]=p.useState(null),[je,be]=p.useState(0),Be=p.useRef(!1),et=p.useRef(()=>{}),ut=k.trim()?Ma.test(k.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const M=new URLSearchParams(window.location.search),ne=(M.get("rs")||"").trim(),V=(M.get("rstext")||"").trim();ne&&/^https?:\/\//i.test(ne)&&me(ne),V&&ye(V),(ne&&/^https?:\/\//i.test(ne)||V)&&re(!0)},[]),p.useEffect(()=>{const M=ne=>{const V=ne.detail||{},pe=String(V.url||"").trim(),Se=String(V.text||"").trim(),he=pe&&/^https?:\/\//i.test(pe)?pe:"";he&&me(he),Se&&ye(Se),(he||Se)&&(re(!0),j(""),L(""),_(""),B(!1),ze(!0),window.setTimeout(()=>ze(!1),900),V.auto&&window.setTimeout(()=>{et.current({url:he,text:Se})},0))};return window.addEventListener("ppmap:research",M),()=>window.removeEventListener("ppmap:research",M)},[]),p.useEffect(()=>{const M=ne=>{const V=ne.detail||{},pe=String(V.name||"").trim();if(!pe)return;re(!1),j(pe),L(pe);const Se=ht(String(V.website||V.domain||""));D(Se),J(ht(String(V.url||""))),g(!Se),C(!0),window.setTimeout(()=>C(!1),900)};return window.addEventListener("ppmap:prefill",M),()=>window.removeEventListener("ppmap:prefill",M)},[]),p.useEffect(()=>{const M=(T||"").trim();if(!M||Q||O){(O||!M||Q)&&g(!1);return}const ne=Ge(M),V=f.find(Ne=>Ge(Ne.name)===ne)||f.find(Ne=>{const Re=Ge(Ne.name);return Re.length>=3&&(ne.includes(Re)||Re.includes(ne))}),pe=ht((V==null?void 0:V.website)||"")||ht((V==null?void 0:V.domain)||""),Se=ht((V==null?void 0:V.url)||"");if(Se&&J(Ne=>Ne||Se),pe){D(pe),g(!1);return}let he=!0;return g(!0),Hn(M).then(Ne=>{var Qe,mt;if(!he)return;const Re=ht(Ne.website||"")||ht(((mt=(Qe=Ne.candidates)==null?void 0:Qe[0])==null?void 0:mt.url)||"");Re&&D(Re)}).catch(()=>{}).finally(()=>{he&&g(!1)}),()=>{he=!1}},[T,Q,O,f]),p.useEffect(()=>{const M=ne=>{var pe;const V=String(((pe=ne.detail)==null?void 0:pe.url)||"").trim();ca(V)&&window.open(V,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",M),()=>window.removeEventListener("ppmap:view",M)},[]),p.useEffect(()=>{if($.current===Q)return;$.current=Q,ee(!0);const M=window.setTimeout(()=>ee(!1),560);return()=>window.clearTimeout(M)},[Q]),p.useEffect(()=>{if(typeof window>"u")return;const M=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ne=document.querySelector(".atl2.ops, .atl2.cibles");if(!M||!ne)return;const V=ne.classList.contains("cibles")?document.querySelector(".atl2.cibles .live-stack"):null,pe=()=>{const he=parseFloat(window.getComputedStyle(M).top)||0,Ne=M.getBoundingClientRect().top<=he+1;M.classList.toggle("is-stuck",Ne),ne.classList.toggle("url-stuck",Ne);const Re=Math.round(M.getBoundingClientRect().height);ne.style.setProperty("--demand-h",`${Re}px`);const Qe=window.matchMedia("(min-width: 861px)").matches;V&&Qe?ne.style.setProperty("--pp-live-h",`${Math.round(V.getBoundingClientRect().height)}px`):ne.classList.contains("cibles")&&ne.style.setProperty("--pp-live-h","0px")};pe();const Se=new ResizeObserver(pe);return Se.observe(M),V&&Se.observe(V),window.addEventListener("scroll",pe,!0),window.addEventListener("resize",pe),()=>{Se.disconnect(),M.classList.remove("is-stuck"),ne.classList.remove("url-stuck"),window.removeEventListener("scroll",pe,!0),window.removeEventListener("resize",pe)}},[b,N,ce,A,Q,I,F]),p.useEffect(()=>{if(!u&&!E){Ee(null);return}let M=!0;return(async()=>{const ne=await Lo({email:o,cbToken:E});M&&Ee(ne.length)})(),()=>{M=!1}},[u,E,o,je]);const Fe=P.length?P:h,Ve=x.credits,wt=p.useCallback(M=>{const ne=hp(n,M);return S(!1),l({type:"ptab",tab:0}),requestAnimationFrame(()=>{const V=document.querySelector(".atl2 .desk-list .evalq, .atl2.cibles .desk-list");if(!V)return;const pe=window.scrollY+V.getBoundingClientRect().top-120;window.scrollTo({top:Math.max(0,pe),behavior:"smooth"})}),ne},[n,l]);p.useEffect(()=>{if(!Ae)return;ke(0);const M=window.setInterval(()=>ke(ne=>ne+1),1e3);return()=>window.clearInterval(M)},[Ae]);const Ue=p.useMemo(()=>{const M=k.trim().toLowerCase();return!M||!m?null:f.find(ne=>Ge(ne.name)===M&&Te(ne)===1)||null},[k,f,m]),ot=()=>{const M=k.trim();if(M){if(Ue){w(Ue);return}i(null,M),y&&j("")}},Rt=(M,ne,V,pe)=>{const Se=V.length?V:ne,he=wt(Se)||0;gp({title:(M.title||"").trim(),url:(M.source_url||"").trim(),cited:ne,match:V,added:he,fallback:pe})},yt=async M=>{var pe,Se,he;if(Be.current)return;const ne=((M==null?void 0:M.url)??oe).trim().replace(/\s+/g,""),V=((M==null?void 0:M.text)??xe).trim();if(!ne&&!V){_(e.rsNeed);return}if(!y&&!E){i(null,ne||V.slice(0,80));return}Be.current=!0,_(""),se(null),fe(null),ue(!0);try{const Ne=await Ns({url:ne,text:V,email:o,cbToken:E});ue(!1);const Re=st=>(st||[]).map(At=>((At==null?void 0:At.name)||"").trim()).filter(ki);if(!Ne||Ne.status!=="success"){const st=Jn(V||(Ne==null?void 0:Ne.title)||"");if(st.length){const At={status:"success",title:V||ne,source_url:ne,summary_md:e.rsNoteFallback,companies_cited:st.map(aa=>({name:aa})),prospective:{companies_to_evaluate:st.map(aa=>({name:aa}))}};_(""),se(At),re(!1),Rt(At,st,st,!0);return}se(null),B(!0),_((Ne!=null&&Ne.message?Ne.message+" — ":"")+e.rsNoteNone);return}se(Ne),re(!1);const Qe=Re(Ne.companies_cited),mt=Re((pe=Ne.prospective)==null?void 0:pe.companies_to_evaluate);Rt(Ne,Qe,mt,!1),fe({state:"pending"});const $e=await Ss(Ne,{email:o,cbToken:E});fe($e.ok?{state:"ok",scopeLabel:((Se=$e.summary)==null?void 0:Se.scope_label)||"",scope:((he=$e.summary)==null?void 0:he.scope)||""}:{state:"fail",msg:$e.error||""}),$e.ok&&be(st=>st+1)}finally{Be.current=!1,ue(!1)}};et.current=M=>{yt(M)};const Ot=[K==null?void 0:K.industry,...(K==null?void 0:K.market_tags)||[],K==null?void 0:K.author].map(M=>(M||"").trim()).filter(Boolean),zt=(le==null?void 0:le.state)==="pending",Mt=le&&(zt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):le.state==="ok"?t.jsx("span",{className:"rslink ok",children:le.scope&&le.scope!=="public"?e.rsSavedIn(le.scopeLabel||le.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:le.msg,children:e.rsSaveFail})),kt=Ep(K).length,Pe=Q,it=(T||k).trim(),tt=f.find(M=>Ge(M.name)===Ge(it)),Ct=ht(k)||O||ht((tt==null?void 0:tt.website)||"")||ht((tt==null?void 0:tt.domain)||""),R=W||ht((tt==null?void 0:tt.url)||""),G=Ue?e.actAnalyse:it?e.evalGoOn(it.length>22?it.slice(0,21)+"…":it):e.evalGo,ae=Ae?`${js(oe.trim())==="youtube"&&oe.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(ve)}`:zt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Pe?" rs-mode":"")+(T&&k.trim()===T||N||ce?" pair":"")+(N||ce||I?" echo":"")+(I?" swap":""),children:[t.jsxs("div",{className:"dhead",children:[t.jsx("h2",{children:Pe?a==="en"?"Extract companies from an article":"Extraire les sociétés d’un article":a==="en"?"Paste a URL and screen it":"Coller une URL et évaluer"}),t.jsx("span",{className:"dhint",children:Pe?a==="en"?"Paste an article or video URL — Stan lists the companies, then you pick which ones to screen.":"Collez l’URL d’un article ou d’une vidéo — Stan en sort les sociétés, vous choisissez lesquelles évaluer.":a==="en"?"A name is enough — Stan fills in the domain, the country and the sector, then runs the screen.":"Un nom suffit — Stan complète le domaine, le pays et le secteur, puis lance le crible."})]}),t.jsxs("div",{className:"drow"+((Pe?ce:N)||I?" flash":"")+((Pe?oe.trim():Ma.test(k.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Pe?oe:k,placeholder:Pe?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Pe?600:200,spellCheck:Pe?!1:void 0,inputMode:Pe?"url":void 0,onChange:M=>{if(Pe){me(M.target.value);return}j(M.target.value),T&&M.target.value.trim()!==T&&(L(""),D(""),J(""),g(!1))},onKeyDown:M=>{M.key==="Enter"&&(Pe?yt():ot())}}),t.jsx("span",{className:"detect"+(Pe?" off":"")+(Ma.test(k.trim())?" url":""),children:ut})]}),t.jsx("span",{className:"dacts",children:Pe?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(Ae?" loading":""),disabled:Ae||zt||!oe.trim()&&!xe.trim(),onClick:()=>{yt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:ae})]}),t.jsxs("a",{className:"viewbtn"+(ca(oe)?"":" off"),href:ca(oe)?oe.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:M=>{ca(oe)||M.preventDefault()},children:[t.jsx(zp,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs(Za,{lang:a,storeKey:((Ue==null?void 0:Ue.name)||k).trim(),className:"evalbtn"+(Ue?" analyse":"")+(s?" loading":""),disabled:s,confirmLabel:G,onConfirm:ot,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:G})]}),t.jsxs("span",{className:"sitepair",children:[t.jsxs("a",{className:"viewbtn sm"+(F?" searching":Ct?"":" off"),href:Ct||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:M=>{Ct||M.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite,!F&&t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]}),t.jsxs("a",{className:"viewbtn sm"+(R?"":" off"),href:R||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:M=>{R||M.preventDefault()},children:[e.viewSrc,t.jsx("span",{className:"xwin","aria-hidden":"true",children:"↗"})]})]})]})}),c.showCredits&&Ve&&b==="ops"&&t.jsxs("button",{type:"button",className:"credits"+(Ve.total_available<=0&&!Ve.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Ve.unlimited?"∞":Ve.total_available}),!Ve.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Ve.daily_grant+Ve.purchased]}),Ve.total_available<=0&&!Ve.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>{l({type:"ptab",tab:0}),S(!1),requestAnimationFrame(()=>{const M=document.querySelector(".atl2.cibles .desk-list");if(!M)return;const ne=window.scrollY+M.getBoundingClientRect().top-110;window.scrollTo({top:Math.max(0,ne),behavior:"smooth"})})},children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(Q?" on":""),title:e.rsOpenHint,onClick:()=>re(!Q),children:e.rsOpen}),we!==null&&we>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(H?" on":""),onClick:()=>de(!H),children:e.rsArchOpen(we)}),c.pipe&&!!n&&t.jsx(kp,{pageToken:E,onAddNames:wt,onPanel:()=>{B(!1)}})]}),H&&t.jsx(Sp,{bump:je,cbToken:E,onClose:()=>de(!1),onEvaluate:M=>i(null,M),onAddAll:wt}),t.jsx("div",{className:"rsp slim"+(Q?" on":" off"),"aria-hidden":!Q,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:Q?void 0:-1,onClick:()=>B(M=>!M),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:z?"▴":"▾"})]}),t.jsx("button",{type:"button",className:"dffold",tabIndex:Q?void 0:-1,onClick:()=>{re(!1),B(!1),_("")},children:e.feedFold}),z&&t.jsx("textarea",{className:"rstext",value:xe,placeholder:e.rsTextPh,tabIndex:Q?void 0:-1,onChange:M=>ye(M.target.value)})]})}),te&&t.jsxs("div",{className:"rserr",children:[te,t.jsx("button",{type:"button",className:"eq-note-x",title:e.rsClose,onClick:()=>_(""),children:"×"})]}),K&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:K.title}),K.source_url&&t.jsx("a",{href:K.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{se(null),fe(null)},children:"×"})]}),K.market&&t.jsx("p",{className:"rsmk",children:K.market}),Ot.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Ot.map(M=>t.jsx("span",{children:M},M))]}),t.jsxs("div",{className:"rsbody",children:[K.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${K.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ei(K.summary_md||"").map((M,ne)=>t.jsx("p",{children:M},ne))})]}),t.jsx(ji,{card:K,onEvaluate:M=>i(null,M),onAddAll:wt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(kt)}),Mt]})]}),Fe.slice(0,1).map((M,ne)=>{const V=M.verdict==="kept",pe=M.verdict==="quota",Se=M.verdict==="unresolved",he=V?"var(--brand)":pe?"var(--bolt)":Se?"var(--blue)":"var(--red)",Ne=V?"var(--brand-l)":pe?"#FFF3D6":Se?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":he,"--bgc":Ne},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:V?"✓ "+e.kept:pe?"⏳":Se?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),M.name&&t.jsx("span",{className:"rn",children:M.name}),t.jsx("span",{className:"rr",children:M.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",M.reason]}):null}),!!(M.candidates&&M.candidates.length)&&t.jsx("span",{className:"sitepick",children:M.candidates.map(Re=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:Re.url.startsWith("http")?Re.url:`https://${Re.url}`,target:"_blank",rel:"nofollow noopener",children:[(Re.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,Re.url,M.name),children:e.evalPickGo})]},Re.url))}),!pe&&!Se&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:V?1:5});const Re=(M.name||"").trim().toLowerCase();window.setTimeout(()=>{const Qe=[...document.querySelectorAll(".atl2 .list .row")].find(mt=>{var $e;return((($e=mt.querySelector(".rnm"))==null?void 0:$e.textContent)||"").trim().toLowerCase().includes(Re)});Qe&&(Qe.scrollIntoView({behavior:"smooth",block:"center"}),Qe.classList.add("flashrow"),window.setTimeout(()=>Qe.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(V?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),y&&(d.kept+d.dropped>0||Fe.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(d.kept,d.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Ap(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function qp(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Z(),i=e.memoConsole?r.get(e.memoConsole):null,d=p.useMemo(()=>i?[i.reasoning||"",Ap(i.summary||"")].filter(Boolean).join(`
