...
.atl2 .bulk .side .hint{white-space:nowrap}`,To=`
...
/* ── DÉPLIÉ = des BLOCS (16/08 : « ça reste très brouillon et fouillis… un
   arrière-plan commun aux lignes et une séparation nette ») : une nappe
   grise commune, chaque ligne (+ son panneau) devient une carte blanche
   bordée à coins ronds — c'est l'AIR entre les blocs qui sépare, pas des
   filets. Les en-têtes de groupe flottent sur la nappe. */
.atl2 .list.deplie{background:#F1F5F9;padding:2px 14px 16px}
.atl2 .list.deplie .row{margin-top:10px;background:#fff;
  border:1px solid #E2E8F0;border-radius:10px;
  box-shadow:0 1px 2px rgba(15,23,42,.04)}
.atl2 .list.deplie .row.open{border-radius:10px 10px 0 0;border-bottom:0;
  box-shadow:none}
.atl2 .list.deplie .card{background:#fff;border:1px solid #E2E8F0;
  border-top:0;border-radius:0 0 10px 10px;
  box-shadow:0 1px 2px rgba(15,23,42,.04)}
.atl2 .list.deplie .grp-h{background:transparent;border:0;margin-top:18px;
  padding-left:2px}
.atl2 .list.deplie .moregrp{background:transparent}
`,Lo=Ao+To;function oa(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Ro(){const e=oa("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Oo(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Ro();return r==="0"?"client":r==="1"||oa("embed")==="1"&&oa("chrome")==="1"?"apercu":"client"}const Mo={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!1,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},qo=e=>Mo[e],Ve=e=>Object.assign(e,{continent:Mr(e.cc)});function Gt(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Fo=60*60*1e3;function Po(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Fo?null:a}catch{return null}}function wt(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Do=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Io(e,a,r="default"){const n=r!=="default",i=h.useMemo(()=>e||n?{mode:"anon"}:Nr(),[e,n]),o=h.useMemo(()=>n?"visiteur":Oo(e,i),[e,i,n]),l=h.useMemo(()=>qo(o),[o]),s=o!=="visiteur",p=Do(r),[f,c]=h.useState([]),[d,m]=h.useState(""),[v,x]=h.useState(null),[b,g]=h.useState(null),[u,y]=h.useState(null),[j,w]=h.useState(()=>new Map),[N,S]=h.useState(()=>new Map),[C,L]=h.useState(""),[F,k]=h.useState(new Set),[T,A]=h.useState(null),[M,R]=h.useState(!0),[E,O]=h.useState(!1),[$,V]=h.useState(0),[Q,xe]=h.useState(0),se=h.useRef(0),le=h.useMemo(()=>{var I;if(o!=="client")return"";try{return((I=Sr())==null?void 0:I.email)||""}catch{return""}},[o]);h.useEffect(()=>{const I=++se.current;let _=!0;const U=()=>_&&I===se.current,ee=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),re=Po(ee);return re?(c(re.objs.map(Ve)),re.fund&&m(re.fund),x(re.marketEstimate??null),g(re.criteria??null),y(re.stats??null),L(re.generatedAt||""),R(!1)):R(!0),(async()=>{try{if(r==="ops"){const ve=await Ht(),ce=((ve==null?void 0:ve.recent_ops)||[]).map(Y=>{const X=Yt(Y.company_name||Y.title?Y:{...Y,title:(Y.headline_fr||Y.headline||"").slice(0,120)},a),he=String(Y.rubrique||"").toLowerCase();return X&&(he==="nominations"||he==="recrutements")&&(X.engine=he),X&&!String(Y.company_name||"").trim()&&(X.noCo=!0),X}).filter(Y=>!!Y).map(Y=>(Cr((Y.name||"").trim())||(Y.noCo=!0),Y));try{const Y=await Er(),X=zr(Y),he=((Y==null?void 0:Y.date)||"").slice(0,10);if(X.length&&he){const H=new Set;for(const ae of ce){if(ae.noCo||(ae.date||"").slice(0,10)!==he)continue;const K=Fa(X,H,ae.name,"");K>=0&&(H.add(K),ae.decryptHtml=X[K].html)}for(const ae of ce){if(ae.decryptHtml||(ae.date||"").slice(0,10)!==he)continue;const K=Fa(X,H,"",ae.headline||ae.tagline||ae.name);K>=0&&(H.add(K),ae.decryptHtml=X[K].html)}}}catch{}if(!U())return;c(ce.map(Ve)),wt(ee,{objs:ce})}else if(typeof r=="object"){const ce=(await Pa()||[]).filter(X=>(X.slug||"")===r.research).map(X=>Da(X,a)).filter(X=>!!X),Y=Gt(await Ia(ce,a));if(!U())return;c(Y.map(Ve)),wt(ee,{objs:Y})}else if(s&&i.token){const ve=Ar(i.token),ce=Ht(),Y=Tr(i.token),X=Lr(i.token),he=Rr(i.token),H=await ve;let ae=H?H.targets:[];U()&&H&&(m(H.fund||""),x(H.marketEstimate??null),g(H.criteria??null),y(H.stats??null),L(H.generatedAt||""),c(ae.map(Ve)),R(!1),O(!1));const[K,Ie,pe,ue]=await Promise.all([ce,Y,X,he]),Me=((K==null?void 0:K.recent_ops)||[]).map(je=>Yt(je,a)).filter(je=>!!je);if(ae=[...ae,...Me],!U())return;c(ae.map(Ve));const _e=new Set;for(const je of Ie){const qe=(je.id||je.co||"").toString().trim().toLowerCase();qe&&_e.add(qe.startsWith("t:")?qe:"t:"+qe)}k(_e),w(pe),S(ue),H&&wt(ee,{fund:H.fund,marketEstimate:H.marketEstimate,criteria:H.criteria,stats:H.stats,generatedAt:H.generatedAt,objs:ae})}else{const ve=Or(),ce=Pa(),Y=Ht(),X=await ve;U()&&X.length&&(c(Gt(X).map(Ve)),R(!1),O(!1));const[he,H]=await Promise.all([ce,Y]),ae=(he||[]).map(ue=>Da(ue,a)).filter(ue=>!!ue),K=await Ia(ae,a),Ie=((H==null?void 0:H.recent_ops)||[]).map(ue=>Yt(ue,a)).filter(ue=>!!ue),pe=Gt([...X,...K,...Ie]);if(!U())return;c(pe.map(Ve)),wt(ee,{objs:pe})}U()&&O(!1)}catch{U()&&!re&&O(!0)}finally{U()&&R(!1)}})(),()=>{_=!1}},[s,i.token,a,$,p]),h.useEffect(()=>{if(!l.showCredits||!le){A(null);return}let I=!0;return(async()=>{try{const _=await fetch(`${ka}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:le})});if(!_.ok)return;const U=await _.json();I&&U&&U.ok!==!1&&A(U)}catch{}})(),()=>{I=!1}},[l.showCredits,le,Q]);const G=h.useCallback(I=>k(new Set(I)),[]);return{session:i,mode:o,caps:l,fund:d,email:le,marketEstimate:v,generatedAt:C,criteria:b,stats:u,thumbs:j,stages:N,dossiers:f,favIds:F,setFavIds:G,credits:T,reloadCredits:()=>xe(I=>I+1),loading:M,error:E,refresh:()=>V(I=>I+1)}}const Fn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],search:""}),Bo=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...Fn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function $o(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Fn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Pn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Pn=40;function Ea(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!me(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(ja(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(tt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ye(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""}`.toLowerCase().includes(i))return!1}return!0}function Dn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ea(e,a.filters,r)}function _o(e,a,r,n){return!(!Dn(e,a,r)||r&&!qr(e,a.ptab,n))}function za(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-tt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=me(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const Uo=["ma","levees","nominations","recrutements","actualites"],Vo=300,Ho={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},In={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Yo=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=me(e);if(a)return"sig:"+(a.theme&&In.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function Wo(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l}=q(),s=l==="en",[p,f]=h.useState("all"),[c,d]=h.useState(!1),m=h.useMemo(()=>{const C=(a.filters.day||"").slice(0,10),L=A=>!(!o&&a.continent!=="monde"&&A.continent!==a.continent||C&&(A.date||"").slice(0,10)!==C),F=e.filter(A=>L(A)&&me(A)),k=e.filter(A=>L(A)&&A.kind==="op"&&!me(A)&&(C?!0:tt(A.date)<=7)),T=C||new Date().toISOString().slice(0,10);return k.sort((A,M)=>{const R=(A.date||"").slice(0,10)===T?0:1,E=(M.date||"").slice(0,10)===T?0:1;return R!==E?R-E:(M.amountEur||0)-(A.amountEur||0)}),[...za(F,{key:"signal",dir:-1}),...k]},[e,a.continent,a.filters.day,o]),v=h.useMemo(()=>{const C={};for(const L of m){const F=Ga(L);C[F]=(C[F]||0)+1}return C},[m]),x=h.useMemo(()=>p==="all"?m:m.filter(C=>Ga(C)===p),[m,p]),b=h.useMemo(()=>x.slice(0,Vo),[x]),g=x.length-b.length,u=C=>C==="all"?m.length:v[C]||0,y=C=>C==="all"?s?"All":"Tout":C.startsWith("sig:")?In[s?"en":"fr"][C.slice(4)]||"🔔":Ho[s?"en":"fr"][C],j=[{k:"all"}],w=Uo.filter(C=>u(C)>0||C===p);if(w.length){j.push({g:s?"DEALS":"OPÉRATIONS"});for(const C of w)j.push({k:C})}const N=Yo.map(C=>"sig:"+C).filter(C=>u(C)>0||C===p);if(N.length){j.push({g:s?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const C of N)j.push({k:C})}const S=C=>b.map(L=>t.jsxs("button",{type:"button",className:"tk"+(Ce(L)?" spent":""),onClick:F=>{const k=F.currentTarget.getBoundingClientRect();n({type:"popup",id:L.id,anchor:{x:k.left+k.width/2,y:k.bottom}})},title:L.name+(L.tagline?" — "+L.tagline:""),children:[t.jsx(ot,{o:L}),t.jsxs("span",{className:"who",children:[t.jsx(fr,{o:L}),t.jsx("span",{className:"co",children:L.name})]}),typeof L.amountEur=="number"&&L.amountEur>0&&t.jsx("span",{className:"am",children:bl(L.amountEur)}),L.sector&&t.jsx("span",{className:"mt",children:L.sector}),t.jsx(_t,{o:L}),t.jsx("span",{className:"tkgo",children:"→"})]},C+(L.id||L.name))).concat(g>0?[t.jsx("span",{className:"tk quiet",children:s?`+ ${g} more — filter by section to see them`:`+ ${g} autres — filtrez par rubrique pour les voir`},C+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:C=>{C.currentTarget.contains(C.relatedTarget)||d(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":c,onClick:()=>d(C=>!C),children:[y(p),t.jsx("b",{children:u(p)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsx("div",{className:"tkfilm",hidden:!c,children:j.map(C=>"g"in C?t.jsx("span",{className:"tkfilg",children:C.g},C.g):t.jsxs("button",{type:"button","aria-pressed":C.k===p,onClick:()=>{f(C.k),d(!1)},children:[y(C.k),t.jsx("b",{children:u(C.k)})]},C.k))})]}),t.jsx("div",{className:"win",children:b.length?t.jsxs("div",{className:"run",children:[S(0),S(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const Go="aDx8z7Hzksus",Bn="+33 6 83 10 72 86",Ka="alexandre@proplace.co",Ko=`tel:${Bn.replace(/[^\d+]/g,"")}`,Qa="pp-rdv-slot";function Qo(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function Xo(){const{t:e,caps:a,fund:r}=q();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:Zo}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Ko,children:Bn}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Ka}`,children:Ka})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(So,{filloutId:Go,parameters:r?{company_name:r}:void 0})})]})}function Jo(){const[e,a]=h.useState(()=>typeof document>"u"?null:document.getElementById(Qa));return h.useEffect(()=>{e||a(document.getElementById(Qa))},[e]),e?at.createPortal(t.jsx(Xo,{}),e):null}const Zo=`
...
`;class fe extends h.Component{constructor(){super(...arguments);Ma(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ei=8;function ti(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=q(),[s,p]=h.useState(!1),[f,c]=h.useState(!1),[d,m]=h.useState(!1),v=r||"home",{names:x,verdicts:b}=h.useMemo(()=>{const w=[],N={};return n.forEach(S=>{S.kind!=="target"||!S.name||(w.push(S.name),N[S.name]=Fr(S)||"")}),{names:w,verdicts:N}},[n]),g=h.useMemo(()=>x.length?Pr(v,x,b,a):null,[v,x.length]);if(!i.pipe||s||!g||g.firstVisit||!g.added.length&&!g.gone.length)return null;const u=f?g.added:g.added.slice(0,ei),y=g.added.length-u.length,j=w=>{const N=n.find(S=>S.name===w);N&&(o(N.id),l({type:"popup",id:N.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(g.added.length,g.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Dr(v,x,b,g.fp,a)},children:"×"})]}),!!g.added.length&&t.jsxs("div",{className:"since-c",children:[u.map(w=>t.jsx("button",{type:"button",onClick:()=>j(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>c(!0),children:e.sinceMore(y)})]}),!!g.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>m(w=>!w),children:e.sinceOut(g.gone.length)}),d&&g.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Kt=600,He=62,Xa="atl2:fstats";function ai(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=q(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Xa)==="on"}catch{return!1}}),p=r.stats,f=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),c=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const d=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,m=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),v=f.reduce((y,j)=>Math.max(y,j.s||0),0),x=f.length?Kt/f.length:0,b=Math.max(4,x-4),g=f.length>=5&&v>0,u=[[p.screened,e.funScreened(d(c)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[u.map(([y,j,w],N)=>t.jsxs("span",{className:"fst-t",children:[N>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:m(y)}),t.jsx("i",{children:j}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},j)),g&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Xa,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&g&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Kt} ${He}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((y,j)=>{const w=(y.s||0)/v*(He-4),N=(y.m||0)/v*(He-4),S=j*x+(x-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${d(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:S,y:He-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:S,y:He-2-N,width:b,height:N,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:He-1.5,x2:Kt,y2:He-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:d(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const ni=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ri({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=q(),[o,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),c=(nt(e)||"").startsWith("CALL")&&ke(e)===3,d=ke(e)>=2,m=async x=>{if(o||x==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(x);const b=await i(e,x);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},v=c?[["Validé",a.csYes],["Écarté",a.csNo]]:ni.filter(([x])=>!(d&&x==="Retenu")).map(([x,b])=>[x,a[b]]);return t.jsxs("div",{className:"csp",onClick:x=>x.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),v.map(([x,b])=>t.jsx("button",{type:"button",className:"csb"+(f===x?" on":"")+(o===x?" busy":""),disabled:!!o,onClick:()=>{m(x)},children:b},x)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(oi,{o:e})]})}function oi({o:e}){const{t:a,saveNote:r,flash:n}=q(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,f]=h.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),d=async()=>{if(l||!c)return;s(!0);const m=await r(e,i.trim());s(!1),m&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:m=>o(m.target.value),onKeyDown:m=>{m.key==="Enter"&&d()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{d()},children:p?a.csNoteSaved:a.csNoteOk})]})}function ii({placeholder:e,onDone:a}){const{t:r}=q(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function si({o:e}){var g;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=q(),[p,f]=h.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const c=o(e),d=(c==null?void 0:c.stage)||"todo",m=async u=>{if(p||u===d)return;f(!0);const y=c;l(e,{stage:u,stamps:(c==null?void 0:c.stamps)||{}});const j=Math.max(Date.now(),Ja+=1);Ja=j;const w=await Ir(r,{company:e.name||"",stage:u,cts:j,deal_id:e.airtableId,check_id:e.checkId});f(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},v=(g=c==null?void 0:c.stamps)==null?void 0:g.sent,x=v?Math.floor((Date.now()-Date.parse(v))/864e5):0,b=d==="sent"&&v&&x>=4;return t.jsxs("div",{className:"stg",onClick:u=>u.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([u,y])=>t.jsx("button",{type:"button",className:"stgb"+(d===u?" on":""),disabled:p,onClick:()=>{m(u)},children:y},u)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(x)})]})}let Ja=0;const kt=8,jt=340;function Za({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function li({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,scoped:o,byId:l,st:s}=q(),[p,f]=h.useState(0),[c,d]=h.useState(null),[m,v]=h.useState([]),x=h.useRef(!1);h.useEffect(()=>{x.current||(x.current=!0,v(e.filter(N=>!!document.querySelector(N.need||N.sel))))},[e]);const b=m[p],g=p>=m.length;h.useEffect(()=>{b&&(b.ptab!==void 0&&s.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&s.dens!==b.dens&&n({type:"dens",dens:b.dens}))},[p,b]);const u=h.useCallback(()=>{if(!b){d(null);return}const N=document.querySelector(b.sel);if(!N){d(null);return}N.scrollIntoView({block:"nearest",behavior:"smooth"}),d(N.getBoundingClientRect())},[b]);h.useLayoutEffect(()=>{u();const N=window.setTimeout(u,260),S=()=>u();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{window.clearTimeout(N),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[u]);const y=h.useRef(a);if(y.current=a,h.useEffect(()=>{const N=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),y.current()):S.key==="ArrowRight"?f(C=>C+1):S.key==="ArrowLeft"&&f(C=>Math.max(0,C-1))};return document.addEventListener("keydown",N,!0),()=>document.removeEventListener("keydown",N,!0)},[]),!m.length)return null;let j=null;if(g){const N=i[3]||0,S=o.find(C=>C.memoUrl)||[...l.values()].find(C=>C.memoUrl);N>0?j={title:N===1?r.ahaATitle1:r.ahaATitleN(N),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:S?j={title:r.ahaBTitle,body:r.ahaBBody(S.name),btn:r.ahaBBtn,go:()=>{n({type:"memoConsole",id:S.id}),a()}}:j={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let w={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:jt};if(!g&&c){const N=c.bottom+14,C=window.innerHeight-N>190?N:Math.max(12,c.top-200);w={left:Math.min(Math.max(12,c.left+c.width/2-jt/2),window.innerWidth-jt-12),top:C,width:jt}}return at.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!g&&c&&t.jsx("div",{className:"tour-hole",style:{left:c.left-kt,top:c.top-kt,width:c.width+kt*2,height:c.height+kt*2}}),(g||!c)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(g?" fin":""),style:w,children:[g&&j?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:j.title}),t.jsx("p",{children:t.jsx(Za,{text:j.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>f(m.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:j.go,children:j.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(p+1,m.length)}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx("p",{children:t.jsx(Za,{text:(b==null?void 0:b.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:p===0,onClick:()=>f(N=>Math.max(0,N-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>f(N=>N+1),children:p===m.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function ci(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=q(),s=r?a:e,p=h.useMemo(()=>s.filter(u=>tt(u.date)===0&&u.kind==="target"),[s]),f=h.useMemo(()=>r?a.filter(u=>ke(u)===0).slice().sort((u,y)=>(y.date||"").localeCompare(u.date||"")):[],[a,r]),c=h.useMemo(()=>p.filter(u=>r?ke(u)===0:!Ce(u)),[p,r]),d=r?f:c,m=r?a.length-f.length:p.length-c.length,v=r?a.length:p.length,x=v?Math.min(100,m/v*100):100;let b;r?b=i.morningThesis(p.length,f.length):p.length?m===0?b=i.goalSourced(p.length):m>=p.length?b=i.goalCleared:b=i.goalDone(m,p.length):b=i.goalSourced(0);const g=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&f.length&&l({type:"chainStart",queue:f.map(u=>u.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:x+"%"}})}),d.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:g,children:r?i.morningEval(d.length):o.pileMode?i.goalContinue(d.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function di(){var k,T;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:f,startTour:c}=q(),[d,m]=h.useState(null),[v,x]=h.useState([]),b=p==="client";h.useEffect(()=>{if(!i||!o)return;let A=!0;return(async()=>{const[M,R]=await Promise.all([Na(o),Ln(i)]);A&&(M&&m(M),x(R))})(),()=>{A=!1}},[i,o]);const g=(d==null?void 0:d.per_day)??null,u=((k=d==null?void 0:d.pool_order)==null?void 0:k.length)??0,y=v.filter(A=>A.status==="running").length,j=h.useMemo(()=>s.filter(A=>A.kind==="target"&&Ce(A)).length,[s]),w=l.marketEstimate,N=typeof((T=l.stats)==null?void 0:T.screened)=="number"?l.stats.screened:j,S=w&&w>0?Math.min(100,Math.round(N/w*100)):null,C=A=>A.toLocaleString(a==="en"?"en-US":"fr-FR"),L=(o||"P").split(/\s+/).map(A=>A[0]).join("").slice(0,2).toUpperCase(),F=(()=>{const A=Date.parse(l.generatedAt||"");if(Number.isNaN(A))return"";const M=new Date(A),R=E=>String(E).padStart(2,"0");return`${R(M.getDate())}/${R(M.getMonth()+1)} à ${R(M.getHours())}:${R(M.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:L}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),F&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(F)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[S===null&&N>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:C(N)})})]}),S!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:S+"%"}})}),t.jsxs("b",{children:[S," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(N,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),g!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:g})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),g===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(u)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:A=>{A.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:A=>n({type:"filters",patch:{search:A.target.value}})})]})]})]})}function pi(){const{t:e,counts:a,dispatch:r}=q();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const ui=["--p0","--p1","--p2","--p3","--p4"];function fi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i}=q(),o=h.useRef({});h.useEffect(()=>{o.current={...r}},[r]);const l=f=>{const c=o.current[f],d=c!==void 0?r[f]-c:0;return t.jsxs("button",{type:"button",className:"step"+(f===3&&r[3]>0?" wait":""),style:{"--c":`var(${ui[f]})`,"--tc":f<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===f,title:n.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[t.jsxs("span",{className:"l",children:[n.plabels[f].toUpperCase(),f===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(d>0?" up":d<0?" down":""),children:[r[f],d!==0&&t.jsxs("em",{className:"delta",children:[d>0?"+":"−",Math.abs(d)]})]})]},f)},s=(f,c,d)=>t.jsxs("button",{type:"button",className:"off"+(c?" view":""),style:{"--c":f===5?"var(--p5)":f===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===f,title:n.phelp[f],onClick:()=>a({type:"ptab",tab:f}),children:[t.jsx("span",{className:"l",children:d.toUpperCase()}),t.jsx("span",{className:"n",children:r[f]})]},f),p=(f,c,d,m=!1)=>t.jsx("button",{type:"button",className:"tool",title:c,disabled:m,onClick:d,children:f},c);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,i,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const mi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function xi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=q(),s=h.useRef(null),[p,f]=h.useState(60);h.useEffect(()=>{let v=0;const x=()=>{var j;const b=s.current;if(!b)return;const g=(j=b.parentElement)==null?void 0:j.querySelector('.funnel [aria-selected="true"]');if(!g)return;const u=g.getBoundingClientRect(),y=b.getBoundingClientRect();f(Math.max(20,Math.min(u.left+u.width/2-y.left,y.width-30)))};return v=requestAnimationFrame(x),window.addEventListener("resize",x),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",x)}},[e.ptab]);const c=e.ptab;let d=r.tuto[c].p;if(c===3){const v=n.filter(g=>g.kind==="target"&&ke(g)===3),x=v.filter(g=>aa(g)==="auto").length,b=v.filter(g=>aa(g)==="cd").length;d=r.tutoPending(x,b,v.length)}const m=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(v=>v.id)})};if(c===1){const v=n.filter(x=>x.kind==="target"&&ke(x)===1&&!i.has(x.id)).slice(0,10);if(v.length)return{label:r.tuto[1].a,run:()=>v.forEach(x=>o(x))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":mi[c],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:d}})]})}),m&&t.jsx("button",{type:"button",className:"tprim",onClick:m.run,children:m.label})]})}class We{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*hi(e){for(const a of e)yield*a}function $n(e){return Array.from(hi(e))}var Z=1e-6,W=Math.PI,ze=W/2,en=W/4,Te=W*2,Fe=180/W,Se=W/180,te=Math.abs,gi=Math.atan,xt=Math.atan2,oe=Math.cos,ie=Math.sin,bi=Math.sign||function(e){return e>0?1:e<0?-1:0},Ke=Math.sqrt;function vi(e){return e>1?0:e<-1?W:Math.acos(e)}function ht(e){return e>1?ze:e<-1?-ze:Math.asin(e)}function Ae(){}function Rt(e,a){e&&an.hasOwnProperty(e.type)&&an[e.type](e,a)}var tn={Feature:function(e,a){Rt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Rt(r[n].geometry,a)}},an={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ia(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)ia(r[n],a,0)},Polygon:function(e,a){nn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)nn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Rt(r[n],a)}};function ia(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function nn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ia(e[r],a,1);a.polygonEnd()}function Qe(e,a){e&&tn.hasOwnProperty(e.type)?tn[e.type](e,a):Rt(e,a)}function sa(e){return[xt(e[1],e[0]),ht(e[2])]}function Ze(e){var a=e[0],r=e[1],n=oe(r);return[n*oe(a),n*ie(a),ie(r)]}function Nt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ot(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Qt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function St(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function la(e){var a=Ke(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ca(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function da(e,a){return te(e)>W&&(e-=Math.round(e/Te)*Te),[e,a]}da.invert=da;function yi(e,a,r){return(e%=Te)?a||r?ca(on(e),sn(a,r)):on(e):a||r?sn(a,r):da}function rn(e){return function(a,r){return a+=e,te(a)>W&&(a-=Math.round(a/Te)*Te),[a,r]}}function on(e){var a=rn(e);return a.invert=rn(-e),a}function sn(e,a){var r=oe(e),n=ie(e),i=oe(a),o=ie(a);function l(s,p){var f=oe(p),c=oe(s)*f,d=ie(s)*f,m=ie(p),v=m*r+c*n;return[xt(d*i-v*o,c*r-m*n),ht(v*i+d*o)]}return l.invert=function(s,p){var f=oe(p),c=oe(s)*f,d=ie(s)*f,m=ie(p),v=m*i-d*o;return[xt(d*i+m*o,c*r+v*n),ht(v*r-c*n)]},l}function wi(e,a,r,n,i,o){if(r){var l=oe(a),s=ie(a),p=n*r;i==null?(i=a+n*Te,o=a-p/2):(i=ln(l,i),o=ln(l,o),(n>0?i<o:i>o)&&(i+=n*Te));for(var f,c=i;n>0?c>o:c<o;c-=p)f=sa([l,-s*oe(c),-s*ie(c)]),e.point(f[0],f[1])}}function ln(e,a){a=Ze(a),a[0]-=e,la(a);var r=vi(-a[1]);return((-a[2]<0?-r:r)+Te-Z)%Te}function _n(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ae,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Lt(e,a){return te(e[0]-a[0])<Z&&te(e[1]-a[1])<Z}function Ct(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Un(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(x){if(!((b=x.length-1)<=0)){var b,g=x[0],u=x[b],y;if(Lt(g,u)){if(!g[2]&&!u[2]){for(i.lineStart(),s=0;s<b;++s)i.point((g=x[s])[0],g[1]);i.lineEnd();return}u[0]+=2*Z}o.push(y=new Ct(g,x,null,!0)),l.push(y.o=new Ct(g,null,y,!1)),o.push(y=new Ct(u,x,null,!1)),l.push(y.o=new Ct(u,null,y,!0))}}),!!o.length){for(l.sort(a),cn(o),cn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var f=o[0],c,d;;){for(var m=f,v=!0;m.v;)if((m=m.n)===f)return;c=m.z,i.lineStart();do{if(m.v=m.o.v=!0,m.e){if(v)for(s=0,p=c.length;s<p;++s)i.point((d=c[s])[0],d[1]);else n(m.x,m.n.x,1,i);m=m.n}else{if(v)for(c=m.p.z,s=c.length-1;s>=0;--s)i.point((d=c[s])[0],d[1]);else n(m.x,m.p.x,-1,i);m=m.p}m=m.o,c=m.z,v=!v}while(!m.v);i.lineEnd()}}}function cn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Xt(e){return te(e[0])<=W?e[0]:bi(e[0])*((te(e[0])+W)%Te-W)}function ki(e,a){var r=Xt(a),n=a[1],i=ie(n),o=[ie(r),-oe(r),0],l=0,s=0,p=new We;i===1?n=ze+Z:i===-1&&(n=-ze-Z);for(var f=0,c=e.length;f<c;++f)if(m=(d=e[f]).length)for(var d,m,v=d[m-1],x=Xt(v),b=v[1]/2+en,g=ie(b),u=oe(b),y=0;y<m;++y,x=w,g=S,u=C,v=j){var j=d[y],w=Xt(j),N=j[1]/2+en,S=ie(N),C=oe(N),L=w-x,F=L>=0?1:-1,k=F*L,T=k>W,A=g*S;if(p.add(xt(A*F*ie(k),u*C+A*oe(k))),l+=T?L+F*Te:L,T^x>=r^w>=r){var M=Ot(Ze(v),Ze(j));la(M);var R=Ot(o,M);la(R);var E=(T^L>=0?-1:1)*ht(R[2]);(n>E||n===E&&(M[0]||M[1]))&&(s+=T^L>=0?1:-1)}}return(l<-Z||l<Z&&p<-1e-12)^s&1}function Vn(e,a,r,n){return function(i){var o=a(i),l=_n(),s=a(l),p=!1,f,c,d,m={point:v,lineStart:b,lineEnd:g,polygonStart:function(){m.point=u,m.lineStart=y,m.lineEnd=j,c=[],f=[]},polygonEnd:function(){m.point=v,m.lineStart=b,m.lineEnd=g,c=$n(c);var w=ki(f,n);c.length?(p||(i.polygonStart(),p=!0),Un(c,Ni,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),c=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function v(w,N){e(w,N)&&i.point(w,N)}function x(w,N){o.point(w,N)}function b(){m.point=x,o.lineStart()}function g(){m.point=v,o.lineEnd()}function u(w,N){d.push([w,N]),s.point(w,N)}function y(){s.lineStart(),d=[]}function j(){u(d[0][0],d[0][1]),s.lineEnd();var w=s.clean(),N=l.result(),S,C=N.length,L,F,k;if(d.pop(),f.push(d),d=null,!!C){if(w&1){if(F=N[0],(L=F.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),S=0;S<L;++S)i.point((k=F[S])[0],k[1]);i.lineEnd()}return}C>1&&w&2&&N.push(N.pop().concat(N.shift())),c.push(N.filter(ji))}}return m}}function ji(e){return e.length>1}function Ni(e,a){return((e=e.x)[0]<0?e[1]-ze-Z:ze-e[1])-((a=a.x)[0]<0?a[1]-ze-Z:ze-a[1])}const dn=Vn(function(){return!0},Si,Ei,[-W,-ze]);function Si(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?W:-W,p=te(o-a);te(p-W)<Z?(e.point(a,r=(r+l)/2>0?ze:-ze),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=W&&(te(a-n)<Z&&(a-=n*Z),te(o-s)<Z&&(o-=s*Z),r=Ci(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ci(e,a,r,n){var i,o,l=ie(e-r);return te(l)>Z?gi((ie(a)*(o=oe(n))*ie(r)-ie(n)*(i=oe(a))*ie(e))/(i*o*l)):(a+n)/2}function Ei(e,a,r,n){var i;if(e==null)i=r*ze,n.point(-W,i),n.point(0,i),n.point(W,i),n.point(W,0),n.point(W,-i),n.point(0,-i),n.point(-W,-i),n.point(-W,0),n.point(-W,i);else if(te(e[0]-a[0])>Z){var o=e[0]<a[0]?W:-W;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function zi(e){var a=oe(e),r=2*Se,n=a>0,i=te(a)>Z;function o(c,d,m,v){wi(v,e,r,m,c,d)}function l(c,d){return oe(c)*oe(d)>a}function s(c){var d,m,v,x,b;return{lineStart:function(){x=v=!1,b=1},point:function(g,u){var y=[g,u],j,w=l(g,u),N=n?w?0:f(g,u):w?f(g+(g<0?W:-W),u):0;if(!d&&(x=v=w)&&c.lineStart(),w!==v&&(j=p(d,y),(!j||Lt(d,j)||Lt(y,j))&&(y[2]=1)),w!==v)b=0,w?(c.lineStart(),j=p(y,d),c.point(j[0],j[1])):(j=p(d,y),c.point(j[0],j[1],2),c.lineEnd()),d=j;else if(i&&d&&n^w){var S;!(N&m)&&(S=p(y,d,!0))&&(b=0,n?(c.lineStart(),c.point(S[0][0],S[0][1]),c.point(S[1][0],S[1][1]),c.lineEnd()):(c.point(S[1][0],S[1][1]),c.lineEnd(),c.lineStart(),c.point(S[0][0],S[0][1],3)))}w&&(!d||!Lt(d,y))&&c.point(y[0],y[1]),d=y,v=w,m=N},lineEnd:function(){v&&c.lineEnd(),d=null},clean:function(){return b|(x&&v)<<1}}}function p(c,d,m){var v=Ze(c),x=Ze(d),b=[1,0,0],g=Ot(v,x),u=Nt(g,g),y=g[0],j=u-y*y;if(!j)return!m&&c;var w=a*u/j,N=-a*y/j,S=Ot(b,g),C=St(b,w),L=St(g,N);Qt(C,L);var F=S,k=Nt(C,F),T=Nt(F,F),A=k*k-T*(Nt(C,C)-1);if(!(A<0)){var M=Ke(A),R=St(F,(-k-M)/T);if(Qt(R,C),R=sa(R),!m)return R;var E=c[0],O=d[0],$=c[1],V=d[1],Q;O<E&&(Q=E,E=O,O=Q);var xe=O-E,se=te(xe-W)<Z,le=se||xe<Z;if(!se&&V<$&&(Q=$,$=V,V=Q),le?se?$+V>0^R[1]<(te(R[0]-E)<Z?$:V):$<=R[1]&&R[1]<=V:xe>W^(E<=R[0]&&R[0]<=O)){var G=St(F,(-k+M)/T);return Qt(G,C),[R,sa(G)]}}}function f(c,d){var m=n?e:W-e,v=0;return c<-m?v|=1:c>m&&(v|=2),d<-m?v|=4:d>m&&(v|=8),v}return Vn(l,s,o,n?[0,-e]:[-W,e-W])}function Ai(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],f=a[1],c=0,d=1,m=p-l,v=f-s,x;if(x=r-l,!(!m&&x>0)){if(x/=m,m<0){if(x<c)return;x<d&&(d=x)}else if(m>0){if(x>d)return;x>c&&(c=x)}if(x=i-l,!(!m&&x<0)){if(x/=m,m<0){if(x>d)return;x>c&&(c=x)}else if(m>0){if(x<c)return;x<d&&(d=x)}if(x=n-s,!(!v&&x>0)){if(x/=v,v<0){if(x<c)return;x<d&&(d=x)}else if(v>0){if(x>d)return;x>c&&(c=x)}if(x=o-s,!(!v&&x<0)){if(x/=v,v<0){if(x>d)return;x>c&&(c=x)}else if(v>0){if(x<c)return;x<d&&(d=x)}return c>0&&(e[0]=l+c*m,e[1]=s+c*v),d<1&&(a[0]=l+d*m,a[1]=s+d*v),!0}}}}}var ct=1e9,Et=-ct;function Ti(e,a,r,n){function i(f,c){return e<=f&&f<=r&&a<=c&&c<=n}function o(f,c,d,m){var v=0,x=0;if(f==null||(v=l(f,d))!==(x=l(c,d))||p(f,c)<0^d>0)do m.point(v===0||v===3?e:r,v>1?n:a);while((v=(v+d+4)%4)!==x);else m.point(c[0],c[1])}function l(f,c){return te(f[0]-e)<Z?c>0?0:3:te(f[0]-r)<Z?c>0?2:1:te(f[1]-a)<Z?c>0?1:0:c>0?3:2}function s(f,c){return p(f.x,c.x)}function p(f,c){var d=l(f,1),m=l(c,1);return d!==m?d-m:d===0?c[1]-f[1]:d===1?f[0]-c[0]:d===2?f[1]-c[1]:c[0]-f[0]}return function(f){var c=f,d=_n(),m,v,x,b,g,u,y,j,w,N,S,C={point:L,lineStart:A,lineEnd:M,polygonStart:k,polygonEnd:T};function L(E,O){i(E,O)&&c.point(E,O)}function F(){for(var E=0,O=0,$=v.length;O<$;++O)for(var V=v[O],Q=1,xe=V.length,se=V[0],le,G,I=se[0],_=se[1];Q<xe;++Q)le=I,G=_,se=V[Q],I=se[0],_=se[1],G<=n?_>n&&(I-le)*(n-G)>(_-G)*(e-le)&&++E:_<=n&&(I-le)*(n-G)<(_-G)*(e-le)&&--E;return E}function k(){c=d,m=[],v=[],S=!0}function T(){var E=F(),O=S&&E,$=(m=$n(m)).length;(O||$)&&(f.polygonStart(),O&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),$&&Un(m,s,E,o,f),f.polygonEnd()),c=f,m=v=x=null}function A(){C.point=R,v&&v.push(x=[]),N=!0,w=!1,y=j=NaN}function M(){m&&(R(b,g),u&&w&&d.rejoin(),m.push(d.result())),C.point=L,w&&c.lineEnd()}function R(E,O){var $=i(E,O);if(v&&x.push([E,O]),N)b=E,g=O,u=$,N=!1,$&&(c.lineStart(),c.point(E,O));else if($&&w)c.point(E,O);else{var V=[y=Math.max(Et,Math.min(ct,y)),j=Math.max(Et,Math.min(ct,j))],Q=[E=Math.max(Et,Math.min(ct,E)),O=Math.max(Et,Math.min(ct,O))];Ai(V,Q,e,a,r,n)?(w||(c.lineStart(),c.point(V[0],V[1])),c.point(Q[0],Q[1]),$||c.lineEnd(),S=!1):$&&(c.lineStart(),c.point(E,O),S=!1)}y=E,j=O,w=$}return C}}const pa=e=>e;var Jt=new We,ua=new We,Hn,Yn,fa,ma,Pe={point:Ae,lineStart:Ae,lineEnd:Ae,polygonStart:function(){Pe.lineStart=Li,Pe.lineEnd=Oi},polygonEnd:function(){Pe.lineStart=Pe.lineEnd=Pe.point=Ae,Jt.add(te(ua)),ua=new We},result:function(){var e=Jt/2;return Jt=new We,e}};function Li(){Pe.point=Ri}function Ri(e,a){Pe.point=Wn,Hn=fa=e,Yn=ma=a}function Wn(e,a){ua.add(ma*e-fa*a),fa=e,ma=a}function Oi(){Wn(Hn,Yn)}var et=1/0,Mt=et,gt=-et,qt=gt,Ft={point:Mi,lineStart:Ae,lineEnd:Ae,polygonStart:Ae,polygonEnd:Ae,result:function(){var e=[[et,Mt],[gt,qt]];return gt=qt=-(Mt=et=1/0),e}};function Mi(e,a){e<et&&(et=e),e>gt&&(gt=e),a<Mt&&(Mt=a),a>qt&&(qt=a)}var xa=0,ha=0,dt=0,Pt=0,Dt=0,Xe=0,ga=0,ba=0,pt=0,Gn,Kn,Re,Oe,Ee={point:Ge,lineStart:pn,lineEnd:un,polygonStart:function(){Ee.lineStart=Pi,Ee.lineEnd=Di},polygonEnd:function(){Ee.point=Ge,Ee.lineStart=pn,Ee.lineEnd=un},result:function(){var e=pt?[ga/pt,ba/pt]:Xe?[Pt/Xe,Dt/Xe]:dt?[xa/dt,ha/dt]:[NaN,NaN];return xa=ha=dt=Pt=Dt=Xe=ga=ba=pt=0,e}};function Ge(e,a){xa+=e,ha+=a,++dt}function pn(){Ee.point=qi}function qi(e,a){Ee.point=Fi,Ge(Re=e,Oe=a)}function Fi(e,a){var r=e-Re,n=a-Oe,i=Ke(r*r+n*n);Pt+=i*(Re+e)/2,Dt+=i*(Oe+a)/2,Xe+=i,Ge(Re=e,Oe=a)}function un(){Ee.point=Ge}function Pi(){Ee.point=Ii}function Di(){Qn(Gn,Kn)}function Ii(e,a){Ee.point=Qn,Ge(Gn=Re=e,Kn=Oe=a)}function Qn(e,a){var r=e-Re,n=a-Oe,i=Ke(r*r+n*n);Pt+=i*(Re+e)/2,Dt+=i*(Oe+a)/2,Xe+=i,i=Oe*e-Re*a,ga+=i*(Re+e),ba+=i*(Oe+a),pt+=i*3,Ge(Re=e,Oe=a)}function Xn(e){this._context=e}Xn.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Te);break}}},result:Ae};var va=new We,Zt,Jn,Zn,ut,ft,bt={point:Ae,lineStart:function(){bt.point=Bi},lineEnd:function(){Zt&&er(Jn,Zn),bt.point=Ae},polygonStart:function(){Zt=!0},polygonEnd:function(){Zt=null},result:function(){var e=+va;return va=new We,e}};function Bi(e,a){bt.point=er,Jn=ut=e,Zn=ft=a}function er(e,a){ut-=e,ft-=a,va.add(Ke(ut*ut+ft*ft)),ut=e,ft=a}let fn,It,mn,xn;class hn{constructor(a){this._append=a==null?tr:$i(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==mn||this._append!==It){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,mn=n,It=this._append,xn=this._,this._=i}this._+=xn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function tr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function $i(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return tr;if(a!==fn){const r=10**a;fn=a,It=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return It}function _i(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Qe(s,i(o))),o.result()}return l.area=function(s){return Qe(s,i(Pe)),Pe.result()},l.measure=function(s){return Qe(s,i(bt)),bt.result()},l.bounds=function(s){return Qe(s,i(Ft)),Ft.result()},l.centroid=function(s){return Qe(s,i(Ee)),Ee.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,pa):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new hn(r)):new Xn(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new hn(r)),l},l.projection(e).digits(r).context(a)}function Aa(e){return function(a){var r=new ya;for(var n in e)r[n]=e[n];return r.stream=a,r}}function ya(){}ya.prototype={constructor:ya,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ta(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Qe(r,e.stream(Ft)),a(Ft.result()),n!=null&&e.clipExtent(n),e}function ar(e,a,r){return Ta(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Ui(e,a,r){return ar(e,[[0,0],a],r)}function Vi(e,a,r){return Ta(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Hi(e,a,r){return Ta(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var gn=16,Yi=oe(30*Se);function bn(e,a){return+a?Gi(e,a):Wi(e)}function Wi(e){return Aa({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Gi(e,a){function r(n,i,o,l,s,p,f,c,d,m,v,x,b,g){var u=f-n,y=c-i,j=u*u+y*y;if(j>4*a&&b--){var w=l+m,N=s+v,S=p+x,C=Ke(w*w+N*N+S*S),L=ht(S/=C),F=te(te(S)-1)<Z||te(o-d)<Z?(o+d)/2:xt(N,w),k=e(F,L),T=k[0],A=k[1],M=T-n,R=A-i,E=y*M-u*R;(E*E/j>a||te((u*M+y*R)/j-.5)>.3||l*m+s*v+p*x<Yi)&&(r(n,i,o,l,s,p,T,A,F,w/=C,N/=C,S,b,g),g.point(T,A),r(T,A,F,w,N,S,f,c,d,m,v,x,b,g))}}return function(n){var i,o,l,s,p,f,c,d,m,v,x,b,g={point:u,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),g.lineStart=N},polygonEnd:function(){n.polygonEnd(),g.lineStart=y}};function u(L,F){L=e(L,F),n.point(L[0],L[1])}function y(){d=NaN,g.point=j,n.lineStart()}function j(L,F){var k=Ze([L,F]),T=e(L,F);r(d,m,c,v,x,b,d=T[0],m=T[1],c=L,v=k[0],x=k[1],b=k[2],gn,n),n.point(d,m)}function w(){g.point=u,n.lineEnd()}function N(){y(),g.point=S,g.lineEnd=C}function S(L,F){j(i=L,F),o=d,l=m,s=v,p=x,f=b,g.point=j}function C(){r(d,m,c,v,x,b,o,l,i,s,p,f,gn,n),g.lineEnd=w,w()}return g}}var Ki=Aa({point:function(e,a){this.stream.point(e*Se,a*Se)}});function Qi(e){return Aa({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Xi(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function vn(e,a,r,n,i,o){if(!o)return Xi(e,a,r,n,i);var l=oe(o),s=ie(o),p=l*e,f=s*e,c=l/e,d=s/e,m=(s*r-l*a)/e,v=(s*a+l*r)/e;function x(b,g){return b*=n,g*=i,[p*b-f*g+a,r-f*b-p*g]}return x.invert=function(b,g){return[n*(c*b-d*g+m),i*(v-d*b-c*g)]},x}function Ji(e){return Zi(function(){return e})()}function Zi(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,f=0,c,d=0,m=1,v=1,x=null,b=dn,g=null,u,y,j,w=pa,N=.5,S,C,L,F,k;function T(E){return L(E[0]*Se,E[1]*Se)}function A(E){return E=L.invert(E[0],E[1]),E&&[E[0]*Fe,E[1]*Fe]}T.stream=function(E){return F&&k===E?F:F=Ki(Qi(c)(b(S(w(k=E)))))},T.preclip=function(E){return arguments.length?(b=E,x=void 0,R()):b},T.postclip=function(E){return arguments.length?(w=E,g=u=y=j=null,R()):w},T.clipAngle=function(E){return arguments.length?(b=+E?zi(x=E*Se):(x=null,dn),R()):x*Fe},T.clipExtent=function(E){return arguments.length?(w=E==null?(g=u=y=j=null,pa):Ti(g=+E[0][0],u=+E[0][1],y=+E[1][0],j=+E[1][1]),R()):g==null?null:[[g,u],[y,j]]},T.scale=function(E){return arguments.length?(r=+E,M()):r},T.translate=function(E){return arguments.length?(n=+E[0],i=+E[1],M()):[n,i]},T.center=function(E){return arguments.length?(o=E[0]%360*Se,l=E[1]%360*Se,M()):[o*Fe,l*Fe]},T.rotate=function(E){return arguments.length?(s=E[0]%360*Se,p=E[1]%360*Se,f=E.length>2?E[2]%360*Se:0,M()):[s*Fe,p*Fe,f*Fe]},T.angle=function(E){return arguments.length?(d=E%360*Se,M()):d*Fe},T.reflectX=function(E){return arguments.length?(m=E?-1:1,M()):m<0},T.reflectY=function(E){return arguments.length?(v=E?-1:1,M()):v<0},T.precision=function(E){return arguments.length?(S=bn(C,N=E*E),R()):Ke(N)},T.fitExtent=function(E,O){return ar(T,E,O)},T.fitSize=function(E,O){return Ui(T,E,O)},T.fitWidth=function(E,O){return Vi(T,E,O)},T.fitHeight=function(E,O){return Hi(T,E,O)};function M(){var E=vn(r,0,0,m,v,d).apply(null,a(o,l)),O=vn(r,n-E[0],i-E[1],m,v,d);return c=yi(s,p,f),C=ca(a,O),L=ca(c,C),S=bn(C,N),R()}function R(){return F=k=null,T}return function(){return a=e.apply(this,arguments),T.invert=a.invert&&A,M()}}function nr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}nr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(te(i)>Z&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function es(){return Ji(nr).scale(175.295)}function ts(e){return e}function as(e){if(e==null)return ts;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var f=2,c=s.length,d=new Array(c);for(d[0]=(a+=s[0])*n+o,d[1]=(r+=s[1])*i+l;f<c;)d[f]=s[f],++f;return d}}function ns(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function rs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return yn(e,r)})}:yn(e,a)}function yn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=os(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function os(e,a){var r=as(e.transform),n=e.arcs;function i(c,d){d.length&&d.pop();for(var m=n[c<0?~c:c],v=0,x=m.length;v<x;++v)d.push(r(m[v],v));c<0&&ns(d,x)}function o(c){return r(c)}function l(c){for(var d=[],m=0,v=c.length;m<v;++m)i(c[m],d);return d.length<2&&d.push(d[0]),d}function s(c){for(var d=l(c);d.length<4;)d.push(d[0]);return d}function p(c){return c.map(s)}function f(c){var d=c.type,m;switch(d){case"GeometryCollection":return{type:d,geometries:c.geometries.map(f)};case"Point":m=o(c.coordinates);break;case"MultiPoint":m=c.coordinates.map(o);break;case"LineString":m=l(c.arcs);break;case"MultiLineString":m=c.arcs.map(l);break;case"Polygon":m=p(c.arcs);break;case"MultiPolygon":m=c.arcs.map(p);break;default:return null}return{type:d,coordinates:m}}return f(a)}let zt=null;function is(){return zt||(zt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=rs(r,n),o=es().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=_i(o),s=(i.features||[]).filter(f=>{var c;return(((c=f.properties)==null?void 0:c.name)||"")!=="Antarctica"}).map(f=>{var m;const c=((m=f.properties)==null?void 0:m.name)||"",d=l(f)||"";return d?{i2:Br(c)||null,n:c,d}:null}).filter(f=>!!f);if(!s.length)return null;const p={};for(const[f,c]of Object.entries($r)){const d=o(c);d&&(p[f]={x:d[0],y:d[1]})}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p}}catch{return null}})(),zt)}function ss(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return is().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const wn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function At(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function ls(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const p=(f=e.current)==null?void 0:f.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function cs(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p}=q(),f=h.useRef(null),c=h.useRef(null),d=ss(e.continent==="monde"),m=e.continent==="monde"?d:Sa.find(k=>k.key===e.continent)||null,v=ls(f,e.continent+":"+e.mapFolded+":"+!!m),[x,b]=h.useState(new Map),[g,u]=h.useState(null);h.useEffect(()=>{const k=f.current;if(!k)return;const T=new Map;k.querySelectorAll("path[data-i2]").forEach(A=>{const M=A.dataset.i2;if(M)try{const R=A.getBBox();R.width>0&&T.set(M,{x:R.x,y:R.y,w:R.width,h:R.height})}catch{}}),b(T)},[e.continent,v,m]);const y=h.useMemo(()=>r.filter(k=>k.cc),[r]),j=h.useMemo(()=>{const k=new Map;return y.forEach(T=>k.set(T.cc,(k.get(T.cc)||0)+1)),k},[y]),w=e.continent==="monde"&&d?d.anchors:null,N=h.useMemo(()=>y.map(k=>{const T=w&&k.cc?w[k.cc]:void 0;if(T){const $=At(k.name||k.id||""),V=At((k.id||k.name||"")+"·y");return{d:k,x:T.x+($-.5)*10,y:T.y+(V-.5)*10}}const A=k.cc?x.get(k.cc):void 0;if(!A)return null;const M=At(k.name||k.id||""),R=At((k.id||k.name||"")+"·y"),E=(M-.5)*Math.min(A.w*.55,60),O=(R-.5)*Math.min(A.h*.55,60);return{d:k,x:A.x+A.w/2+E,y:A.y+A.h/2+O}}).filter(k=>!!k),[y,x,w]),S=k=>v>0?k/v:k,C=h.useMemo(()=>n?[0,1,2,3,4,5].map(k=>({c:wn[k],fr:p.plabels[k].toUpperCase(),en:p.plabels[k].toUpperCase(),n:r.filter(T=>T.kind==="target"&&ke(T)===k).length})).filter(k=>k.n>0):Ba.map((k,T)=>({...k,n:r.filter(A=>$a(A)===T).length})),[r,n,p.plabels]),L=o?l.get(o):null,F=L?N.find(k=>k.d.id===L.id):null;return m?t.jsxs("div",{className:"mapzone",ref:c,children:[t.jsxs("svg",{ref:f,viewBox:m.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?m.fr:m.en,onMouseLeave:()=>{u(null),i(null)},children:[t.jsx("g",{children:m.countries.map((k,T)=>t.jsx("g",{className:"ct"+(k.i2&&j.get(k.i2)?"":" empty"),children:t.jsx("path",{d:k.d,"data-i2":k.i2||void 0})},T))}),t.jsx("g",{children:N.map(k=>{const T=Ba[$a(k.d)],A=!!me(k.d),M=k.d.kind==="target",R=n&&M?wn[ke(k.d)]:T.c,E=!n&&Ce(k.d);return t.jsxs("g",{className:"co"+(E?" done":""),onMouseEnter:()=>{var V,Q;const O=(V=c.current)==null?void 0:V.getBoundingClientRect(),$=(Q=f.current)==null?void 0:Q.createSVGPoint();if($&&f.current&&O){$.x=k.x,$.y=k.y;const xe=$.matrixTransform(f.current.getScreenCTM());u({x:xe.x-O.left,y:xe.y-O.top,label:k.d.name+" · "+(rt(k.d.cc,s)||k.d.countryLabel||"")})}i(k.d.id)},onMouseLeave:()=>{u(null),i(null)},onClick:()=>{var V;const O=(V=f.current)==null?void 0:V.createSVGPoint();let $=null;if(O&&f.current){O.x=k.x,O.y=k.y;const Q=O.matrixTransform(f.current.getScreenCTM());$={x:Q.x,y:Q.y}}a({type:"popup",id:k.d.id,anchor:$})},children:[t.jsx("circle",{className:"h",cx:k.x,cy:k.y,r:S(Math.max(11,T.px+7))}),t.jsx("circle",{className:"v",cx:k.x,cy:k.y,r:S(T.px),fill:R,stroke:A?"#DC2626":"#ffffff",strokeWidth:S(A?2.2:1.3)})]},k.d.id||k.d.name)})}),F&&t.jsx("circle",{className:"ring on",cx:F.x,cy:F.y,r:S(13),fill:"none",stroke:"#0F172A",strokeWidth:S(2)})]}),t.jsx("div",{className:"hov"+(g?" on":""),style:g?{left:g.x,top:g.y}:void 0,children:g==null?void 0:g.label}),t.jsx("div",{className:"legend",children:C.map((k,T)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":k.c}}),s==="fr"?k.fr:k.en," ",t.jsx("b",{children:k.n})]},T))}),r.some(k=>!k.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(k=>!k.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:c})}function ds(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function ps(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=q(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(x=>x.continent===e.continent),[r,e.continent]),f=x=>p.filter(b=>x!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:Ea(b,s,i,x==="country"?void 0:x)),c=h.useMemo(()=>{const x=f("win"),b=g=>x.filter(u=>(u.date?Math.max(0,Math.floor((Date.now()-Date.parse(u.date))/864e5)):9999)<=g).length;return[b(0),b(7),b(30),x.length]},[p,s,i]),d=h.useMemo(()=>s.day?f("win").filter(x=>(x.date||"").slice(0,10)===s.day).length:0,[p,s,i]),m=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),v=(x,b,g,u="fbtn")=>t.jsxs("button",{type:"button",className:u,"aria-expanded":e.openFacet===x,onClick:()=>a({type:"openFacet",facet:x}),children:[t.jsx("span",{className:"fl",children:b}),g>0&&t.jsx("span",{className:"n",children:g}),t.jsx("span",{className:"cv",children:"▾"})]},x);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(ds(s.day,l)),t.jsx("b",{children:d})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((x,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===x,onClick:()=>a({type:"filters",patch:{win:x}}),children:[n.dates[b],t.jsx("b",{children:c[b]})]},x))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:x=>a({type:"filters",patch:{search:x.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):v("sec",n.fSector,s.sector.length),v("pay",n.fCountry,s.country.length),v("det",n.fEngine,s.engine.length),v("sta",n.fStage,s.stage.length),i&&v("ang","Angle",s.angle.length),i&&v("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),m>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(m)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(us,{poolFor:f})]})}function us({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=q(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:f}=h.useMemo(()=>{if(l==="sig"){const x=e("signal").filter(u=>me(u)),b=new Map;x.forEach(u=>{const y=u.engine||"";b.set(y,(b.get(y)||0)+1)});const g=[{v:"*",label:n.fpSigAll,n:x.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...na([...b.keys()],i).map(u=>({v:u,label:Je(u)+" "+De(u,i),n:b.get(u)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(u)}))];return{title:n.fpSigTitle,cols:2,options:g}}if(l==="sec"){const x=e("sector"),b=new Map;return x.forEach(g=>{g.sector&&b.set(g.sector,(b.get(g.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((g,u)=>u[1]-g[1]).map(([g,u])=>({v:g,label:g,n:u,html:!1,on:o.sector.includes(g)}))}}if(l==="pay"){const x=e("country"),b=new Map;return x.forEach(g=>{g.cc&&b.set(g.cc,(b.get(g.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((g,u)=>u[1]-g[1]).map(([g,u])=>({v:g,label:rt(g,i)||g,n:u,html:!1,on:o.country.includes(g)}))}}if(l==="det"){const x=e("engine"),b=new Map;return x.forEach(g=>{g.engine&&b.set(g.engine,(b.get(g.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:na([...b.keys()],i).map(g=>({v:g,label:Je(g)+" "+De(g,i)+' <span style="color:var(--dim);font-size:10px">· '+_r(Ur(g),i)+"</span>",n:b.get(g)||0,html:!0,on:o.engine.includes(g)}))}}if(l==="ang"){const x=e("angle"),b=new Map;return x.forEach(g=>{g.angle&&b.set(g.angle,(b.get(g.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((g,u)=>u[1]-g[1]).map(([g,u])=>({v:g,label:g.replace(/[_-]+/g," "),n:u,html:!1,on:o.angle.includes(g)}))}}if(l==="mem"){const x=e("memoLevel"),b=new Map;x.forEach(u=>{if(u.kind==="target"){const y=ja(u);b.set(y,(b.get(y)||0)+1)}});const g=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(u=>({v:String(u),label:g[u],n:b.get(u)||0,html:!1,on:o.memoLevel.includes(u)}))}}const m=e("stage"),v=new Map;return m.forEach(x=>{x.stage&&v.set(x.stage,(v.get(x.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...v.entries()].sort((x,b)=>b[1]-x[1]).map(([x,b])=>({v:x,label:x,n:b,html:!1,on:o.stage.includes(x)}))}},[l,a,i]),c=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const x=o.signalEngines.includes(m)?o.signalEngines.filter(b=>b!==m):[...o.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:x}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:m})},d=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:d,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:f.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>c(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function rr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function fs(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function kn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=q();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function or({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=q(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(kn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(kn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function ms({card:e,onEvaluate:a,onAddAll:r}){var s,p,f;const{t:n}=q(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:rr(e.summary_md||"").map((c,d)=>t.jsx("p",{children:c},d))})]}),t.jsx(or,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function xs(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function hs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=q(),s=i,[p,f]=h.useState(null),[c,d]=h.useState(null),[m,v]=h.useState(null),[x,b]=h.useState(!1);h.useEffect(()=>{let u=!0;return(async()=>{const y=await Rn({email:l,cbToken:s});u&&f(y)})(),()=>{u=!1}},[l,s,n]);const g=u=>{d(u),v(null),b(!0),(async()=>{const y=await Vr(u.id);v(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{d(null),v(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(u=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>g(u),children:[t.jsx("span",{className:"ti",children:u.title}),t.jsxs("span",{className:"me",children:[xs(u.created_at),u.industry?` · ${u.industry}`:"",u.author?` · ${u.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(u.cited_n||0,u.evaluate_n||0)}),t.jsx("span",{className:"st"+(u.published?" on":""),children:u.published?o.rsPub:o.rsPriv})]},u.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),x&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!x&&!m&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!x&&m&&t.jsx(ms,{card:m,onEvaluate:a,onAddAll:r})]})]})}const jn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function gs(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:f,data:c,canWrite:d,source:m}=q(),v=a==="client",x=h.useMemo(()=>r||(m!=="default"?Hr():""),[r,m]),[b,g]=h.useState(""),[u,y]=h.useState(!1),[j,w]=h.useState(""),[N,S]=h.useState(!1),[C,L]=h.useState(""),[F,k]=h.useState([]),T=h.useRef(!1),[A,M]=h.useState(!1),[R,E]=h.useState(""),[O,$]=h.useState(""),[V,Q]=h.useState(!1),[xe,se]=h.useState(0),[le,G]=h.useState(""),[I,_]=h.useState(null),[U,ee]=h.useState(null),[re,ve]=h.useState(!1),[ce,Y]=h.useState(null),[X,he]=h.useState(0),H=h.useRef(!1),ae=b.trim()?jn.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,K=h.useMemo(()=>j.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[j]);h.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(E(P),M(!0))},[]),h.useEffect(()=>{const P=J=>{var ge;const ne=String(((ge=J.detail)==null?void 0:ge.url)||"").trim();!ne||!/^https?:\/\//i.test(ne)||(E(ne),M(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),h.useEffect(()=>{if(!d&&!x){Y(null);return}let P=!0;return(async()=>{const J=await Rn({email:n,cbToken:x});P&&Y(J.length)})(),()=>{P=!1}},[d,x,n,X]);const Ie=F.length?F:p,pe=c.credits,ue=h.useCallback(P=>{const J=P.map(ne=>(ne||"").trim()).filter(Boolean);J.length&&(w(ne=>{const ge=ne.split(`
...
`)}),y(!0))},[]);h.useEffect(()=>{if(!V)return;se(0);const P=window.setInterval(()=>se(J=>J+1),1e3);return()=>window.clearInterval(P)},[V]);const Me=()=>{const P=b.trim();P&&(i(null,P),g(""))},_e=async()=>{if(!v){i(null,K[0]||"");return}if(!K.length||N)return;S(!0),T.current=!1;const P=[];for(let J=0;J<K.length&&!T.current;J++){L(e.evaluating(J+1,K.length,K[J]));const ne=await On(r,K[J],"atelier2");if(P.unshift({name:ne.company||K[J],verdict:ne.verdict,reason:ne.reason||"",remaining:ne.remaining??null}),k([...P]),ne.verdict==="quota"){P.unshift({name:"",verdict:"quota",reason:e.quota(K.length-J-1),remaining:0}),k([...P]),w(K.slice(J+1).join(`
`)),L(""),S(!1);return}}L(""),w(T.current?K.slice(P.length).join(`
`):""),S(!1)},je=async()=>{var ne,ge,Be;if(H.current)return;const P=R.trim().replace(/\s+/g,""),J=O.trim();if(!P&&!J){G(e.rsNeed);return}if(!v&&!x){i(null,P||J.slice(0,80));return}H.current=!0,G(""),_(null),ee(null),Q(!0);try{const ye=await Wr({url:P,text:J,email:n,cbToken:x});if(Q(!1),!ye||ye.status!=="success"){G((ye==null?void 0:ye.message)||"Erreur");return}_(ye),M(!1),ue((((ne=ye.prospective)==null?void 0:ne.companies_to_evaluate)||[]).map($e=>($e==null?void 0:$e.name)||"")),ee({state:"pending"});const Ne=await Gr(ye,{email:n,cbToken:x});ee(Ne.ok?{state:"ok",scopeLabel:((ge=Ne.summary)==null?void 0:ge.scope_label)||"",scope:((Be=Ne.summary)==null?void 0:Be.scope)||""}:{state:"fail",msg:Ne.error||""}),Ne.ok&&he($e=>$e+1)}finally{H.current=!1,Q(!1)}},qe=[I==null?void 0:I.industry,...(I==null?void 0:I.market_tags)||[],I==null?void 0:I.author].map(P=>(P||"").trim()).filter(Boolean),it=(U==null?void 0:U.state)==="pending",Ut=U&&(it?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):U.state==="ok"?t.jsx("span",{className:"rslink ok",children:U.scope&&U.scope!=="public"?e.rsSavedIn(U.scopeLabel||U.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:U.msg,children:e.rsSaveFail})),Vt=fs(I).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:P=>g(P.target.value),onKeyDown:P=>{P.key==="Enter"&&Me()}}),t.jsx("span",{className:"detect"+(jn.test(b.trim())?" url":""),children:ae})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:Me,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),f.showCredits&&pe&&t.jsxs("button",{type:"button",className:"credits"+(pe.total_available<=0&&!pe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:pe.unlimited?"∞":pe.total_available}),!pe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",pe.daily_grant+pe.purchased]}),pe.total_available<=0&&!pe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!u),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(A?" on":""),onClick:()=>M(!A),children:e.rsOpen}),ce!==null&&ce>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>ve(!re),children:e.rsArchOpen(ce)})]}),re&&t.jsx(hs,{bump:X,cbToken:x,onClose:()=>ve(!1),onEvaluate:P=>i(null,P),onAddAll:ue}),A&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:R,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:P=>E(P.target.value),onKeyDown:P=>{P.key==="Enter"&&je()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:O,placeholder:e.rsTextPh,onChange:P=>$(P.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(V?" loading":""),style:{justifyContent:"center"},disabled:V||it||!R.trim()&&!O.trim(),onClick:()=>{je()},children:[t.jsx("span",{className:"fill"}),V?`${Yr(R.trim())==="youtube"&&R.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(xe)}`:it?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),le&&t.jsx("div",{className:"rserr",children:le}),I&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:I.title}),I.source_url&&t.jsx("a",{href:I.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{_(null),ee(null)},children:"×"})]}),I.market&&t.jsx("p",{className:"rsmk",children:I.market}),qe.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),qe.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[I.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${I.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:rr(I.summary_md||"").map((P,J)=>t.jsx("p",{children:P},J))})]}),t.jsx(or,{card:I,onEvaluate:P=>i(null,P),onAddAll:ue}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Vt)}),Ut]})]}),u&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:j,placeholder:e.bulkPh,onChange:P=>w(P.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(N?" loading":""),style:{justifyContent:"center"},disabled:N||!K.length,onClick:()=>{_e()},children:[t.jsx("span",{className:"fill"}),N&&C?C:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(K.length)})]})]}),Ie.slice(0,1).map((P,J)=>{const ne=P.verdict==="kept",ge=P.verdict==="quota",Be=ne?"var(--brand)":ge?"var(--bolt)":"var(--red)",ye=ne?"var(--brand-l)":ge?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Be,"--bgc":ye},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ne?"✓ "+e.kept:ge?"⏳":"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!ge&&t.jsx("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"space"}),children:e.seeSpace(ne?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),v&&(o.kept+o.dropped>0||Ie.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function bs(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function vs(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=q(),o=e.memoConsole?r.get(e.memoConsole):null,l=h.useMemo(()=>o?[o.reasoning||"",bs(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=nt(o),p=ja(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((f,c)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},c)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[Ca(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function ir({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=q(),[l,s]=h.useState(!1),[p,f]=h.useState(null);if(!n.pipe||i!=="client"||n.lockActions)return null;const c=async()=>{if(l)return;s(!0);const d=await Kr(r,e);if(s(!1),!d){o(a.actErr);return}f(d.results||[])};return t.jsxs("div",{className:"simb",onClick:d=>d.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{c()},children:l?a.similarBusy:a.similar}),p&&(p.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:p.map(d=>t.jsxs("li",{children:[t.jsx("b",{className:d.verdict==="kept"?"ok":"ko",children:d.company}),d.reason&&t.jsx("span",{children:d.reason})]},d.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]})}function La({spec:e}){const a=h.useRef(null),r=h.useRef(null),[n,i]=h.useState(!1);return h.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;return _a({kind:"op",card:e},Math.max(240,o.clientWidth||320)).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)}),()=>{l=!0,o.replaceChildren()}},[e]),h.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;_a({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(p=>{!l&&p&&o.isConnected&&o.replaceChildren(p)});const s=p=>{p.key==="Escape"&&i(!1)};return document.addEventListener("keydown",s),()=>{l=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,title:"Agrandir",onClick:()=>i(!0),style:{marginTop:10,lineHeight:0,border:"1px solid #E2E8F0",borderRadius:8,overflow:"hidden",cursor:"zoom-in"}}),n&&at.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const ys=`
...
`;function ws(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function ks(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:f,doPromote:c,doRepeche:d,doApproach:m,doDeep:v,doOnboard:x,outbound:b,evalBusy:g}=q(),u=e.popupId?r.get(e.popupId):null;if(!u)return null;const y=me(u),j=ke(u),w=nt(u),N=u.kind==="target",S=C=>{a({type:"filters",patch:C}),a({type:"popup",id:null})};return at.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:ys}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:ws(e.popupAnchor,!!u.card),onClick:C=>C.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:u.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(tt(u.date)),De(u.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[u.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>S({country:[u.cc]}),children:(rt(u.cc,i)||u.countryLabel||"").toUpperCase()}),u.sector&&t.jsx("button",{type:"button",onClick:()=>S({sector:[u.sector]}),children:u.sector.toUpperCase()}),u.stage&&t.jsx("button",{type:"button",onClick:()=>S({stage:[u.stage]}),children:u.stage.toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(u.amountEur,i)})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Je(u.engine)," ",t.jsx("b",{children:De(u.engine,i)})," — ",Qr(u.engine,i),u.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",u.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(ot,{o:u,lg:!0})," ",t.jsx(_t,{o:u,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Mn(y,i))," · ",n.win7(qn(y,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),u.card?t.jsx(La,{spec:u.card}):null,u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),o.pipe&&N&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof u.score=="number"&&u.score>0?" · "+n.score(u.score):""]})})]}),t.jsx(ir,{name:u.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>s(u),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(u.name.length>22?u.name.slice(0,21)+"…":u.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(u,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(u,!1),a({type:"popup",id:null})},children:n.actNo}),Ca(u)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{v(u),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(u),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),u.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:u.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{x(u),a({type:"popup",id:null})},children:"🚀"})]}):u.engine==="media"&&u.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var C;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"popup",id:null}),(C=document.querySelector(".atl2 .demand"))==null||C.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:g,title:n.evalGoOn(u.name),onClick:()=>s(u),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:g,onClick:()=>s(u),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(u.name.length>22?u.name.slice(0,21)+"…":u.name)," →"]}),u.website&&t.jsx("a",{className:"psite",href:u.website.startsWith("http")?u.website:"https://"+u.website,target:"_blank",rel:"noopener noreferrer",title:u.website,children:"🌐"})]})]})]}),document.body)}const js=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Tt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Ns(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Tt(a.slice(n));break}r+=Tt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Tt(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&js.has(p)?r+=`<${s[1]}${p}>`:r+=Tt(a.slice(i,o+1)),n=o+1}return r}const Nn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function be({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Ss({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=q(),o=$t(e),l=nt(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,c=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),d=h.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:c}].filter(b=>b.n>0),[e,a,s,l,p,f,c]),[m,v]=h.useState("");if(!d.length)return null;const x=d.some(b=>b.k===m)?m:d[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:d.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":x===b.k,className:x===b.k?"on":"",onClick:g=>{g.stopPropagation(),v(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[x==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(be,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(be,{k:a.cdVerdictDate,v:Nn(e.verdictDate,r)})]})]}),x==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Ns(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(Cs,{o:e})]}),x==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdSector,v:e.sector}),t.jsx(be,{k:a.cdStage,v:e.stage}),t.jsx(be,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(be,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(be,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(be,{k:a.cdAngle,v:e.angle}),t.jsx(be,{k:a.cdDetected,v:Nn(e.date,r)})]}),x==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdName,v:e.contactName}),t.jsx(be,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(be,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),x==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(be,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function Cs({o:e}){const{t:a,token:r}=q(),[n,i]=h.useState(!1),[o,l]=h.useState(null),s=async()=>{n||(i(!0),l(await Xr(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],c=f.some(([,d])=>d);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&c&&t.jsxs(t.Fragment,{children:[f.filter(([,d])=>d).map(([d,m])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:d}),t.jsx("p",{children:m})]},d)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!c&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const sr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ra({o:e}){const{t:a}=q(),r=$t(e),n=nt(e),i=ke(e),o=aa(e),l=Jr(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(sr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const wa=e=>e.length>22?e.slice(0,21)+"…":e;function ea({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=q(),[o,l]=h.useState(!1);if(h.useEffect(()=>{n||l(!1)},[n]),Ce(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(wa(e.name))})]})}function Es({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:f,dispatch:c}=q();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:v=>{v.stopPropagation(),c({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return(e.engine==="media"||e.noCo)&&e.url?t.jsxs("span",{className:"cell cell-duo",children:[t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:v=>{var x;v.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(x=document.querySelector(".atl2 .demand"))==null||x.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]}),!e.noCo&&t.jsx(ea,{o:e})]}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(ea,{o:e})});const d=ke(e),m=v=>x=>{x.stopPropagation(),v()};if(d===0)return t.jsx("span",{className:"cell",children:t.jsx(ea,{o:e})});if(d===1){const v=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:v,onClick:m(()=>o(e)),children:v?a.actAnalyseQueued:a.actAnalyse})})}if(d===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:m(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:m(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})});if(d===4){const v=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:v,onClick:m(()=>f(e)),children:v?a.actApproachSent:a.actApproach})})}return d===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):d===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:m(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:m(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:m(()=>c({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function zs({o:e}){const{t:a,doThumb:r,thumbOf:n}=q(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function As({o:e}){const{lang:a}=q();return me(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(ot,{o:e}),t.jsx(_t,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Je(e.engine||"")," ",De(e.engine||"",a)]})})}function Ts({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:f,toggleFav:c}=q(),d=ke(e),m=["#0F172A","#475C6E","#8798A8","#B9C6D2"],v=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,x=v<=0?0:v<=7?1:v<=30?2:3,b=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][d]:m[x],g=f.has(e.id),u=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const j=y.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:j.left+Math.min(280,j.width/3),y:j.bottom}})};return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:u,children:[t.jsx("span",{className:"pt",style:{"--c":b}}),t.jsx(fr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:g?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),c(e)},children:g?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Ls,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(As,{o:e}),l.pipe&&t.jsx(Ra,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Es,{o:e}),l.showThumbs&&t.jsx(zs,{o:e})]}),r&&!a&&t.jsx(Os,{o:e})]})}function Ls({o:e}){const{lang:a,caps:r}=q();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Rs({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i}=q(),o=(()=>{const c=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return c?c[1].slice(0,40):""})(),l=Bt(e.amountEur,r),s=(e.date||"").slice(0,10).split("-").reverse().join("/"),p=Ce(e),f=p&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("span",{children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&t.jsx("span",{children:e.countryLabel}),e.stage&&t.jsx("span",{children:e.stage}),l&&t.jsx("span",{className:"oc-amt",children:l}),s&&t.jsx("span",{children:s})]}),t.jsxs("div",{className:"oc-acts",children:[p?t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:c=>{var d;c.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(d=document.querySelector(".atl2 .demand"))==null||d.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:c=>{c.stopPropagation(),n(e)},children:a.evalGoOn(wa(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:c=>{c.stopPropagation(),n(e)},children:a.evalGoOn(wa(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:c=>c.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(o?` · ${o}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(La,{spec:e.card})})]})}function Os({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=q();return!i.pipe&&e.kind==="op"?t.jsx(Rs,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Ss,{o:e}),t.jsx(ri,{o:e}),t.jsx(si,{o:e}),t.jsx(ir,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("span",{children:e.sector}),e.stage&&t.jsx("span",{children:e.stage}),e.countryLabel&&t.jsx("span",{children:e.countryLabel}),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Ra,{o:e})})]}),e.card&&t.jsx(La,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Je(e.engine||"")," ",De(e.engine||"",r)]}),me(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(ot,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsxs("div",{className:"sec2 acts2",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})]})]})]})}function Ms({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o}=q(),l=ke(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":s},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Ra,{o:e}),me(e)&&t.jsx(ot,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&l===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function qs({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=q(),o=i==="en",l=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),p=s.includes(0)?0:s.sort((c,d)=>(e[d]||0)-(e[c]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(p)}”`:`${f} dossier${f>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function Fs(){const e=q(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:p,data:f,dossiers:c,source:d}=e,m=d==="ops"?8:Pn,[v,x]=h.useState(new Set);h.useEffect(()=>{x(new Set)},[a.ptab,a.continent]);const b=k=>x(T=>{const A=new Set(T);return A.has(k)?A.delete(k):A.add(k),A}),g=h.useMemo(()=>za(l,a.sort),[l,a.sort]),u=h.useMemo(()=>g.filter(k=>me(k)&&!Ce(k)).length,[g]),y=h.useMemo(()=>i.pipe?g:g.filter(k=>!Ce(k)&&!k.noCo),[g,i.pipe]),j=d==="ops"?g.filter(k=>k.noCo).length:0,w=i.pipe?n.plabels[a.ptab].toLowerCase():d==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,N=(k,T,A="",M=!1)=>t.jsxs("button",{type:"button","data-s":k,className:A,"aria-sort":a.sort.key===k?a.sort.dir===1?"ascending":"descending":"none",style:M?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:k}),children:[T,t.jsx("span",{className:"ar",children:a.sort.key===k&&a.sort.dir===1?"▴":"▾"})]},k),S=h.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const k=new Map;g.forEach(M=>{const R=M.engine||"?";k.has(R)||k.set(R,[]),k.get(R).push(M)});const T={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},A=na([...k.keys()],s);return[...k.entries()].sort((M,R)=>{const E=T[M[0]]??10+A.indexOf(M[0]),O=T[R[0]]??10+A.indexOf(R[0]);return E-O})},[g,i.pipe,a.groupBy,s]),C=i.lockRowsAfter;let L=0;const F=(k,T)=>{const A=a.shown[T]||m,R=k.slice(0,A).map(E=>{const O=C!==null&&L>=C;L++;const $=a.dens==="deplie"&&!E.decryptHtml,V=v.has(E.id)?!$:$;return a.dens==="maxi"?t.jsx(Ms,{o:E,locked:O},E.id):t.jsx(Ts,{o:E,locked:O,open:V,onToggle:()=>b(E.id)},E.id)});if(k.length>A&&d!=="ops"){const E=Math.min(m,k.length-A),O=k.length-A;R.push(t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:T,by:m,base:m}),children:[t.jsx("span",{className:"more-label",children:n.more(E,O)}),t.jsxs("span",{className:"more-meta",children:[n.moreMeta(A,k.length)," · ",O," ",s==="en"?"remaining":O>1?"restantes":"restante"]})]},T+":more"))}return R};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:g.length})," ",w]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",d==="ops"&&g.length>0&&" — "+n.edSplit(g.length-j,j)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||d==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["deplie",n.densOpen],["maxi",n.densMaxi]].map(([k,T])=>t.jsxs("button",{type:"button","data-d":k,"aria-pressed":a.dens===k,onClick:()=>r({type:"dens",dens:k}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:T})]},k))}),i.showChain&&y.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:y.map(k=>k.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(y.length):n.chainAll(y.length)]})]}),u>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(u)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),N("country",n.colCountry),N("name",n.colCompany),N("amount",n.colAmount,"h-amt",!0),N("stage",n.colStage,"h-stade"),N("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&N("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens!=="liste"?" "+a.dens:"")+(g.length?"":" list-empty"),children:[S?S.map(([k,T])=>t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Je(k)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:De(k,s)}),t.jsx("div",{className:"s",children:n.grpCount(T.filter(A=>!Ce(A)).length,T.length)})]})]}),F(T,k)]},k)):F(g,"pt"+a.ptab),!g.length&&!(f.loading&&!c.length)&&(i.pipe?t.jsx(qs,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),d==="ops"&&S&&(()=>{let k=0,T=0;for(const[M,R]of S)T+=R.length,k+=Math.min(R.length,a.shown[M]||m);const A=T-k;return A<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>S.forEach(([M,R])=>r({type:"more",group:M,by:R.length,base:m})),children:[t.jsx("span",{className:"more-label",children:n.more(A,A)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(k,T)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function Sn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Ps(e,a){const r=Zr(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Ds(e,a){const n=[a.head.split("|").map(Sn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Ps(i,a.plabels),$t(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Sn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Is(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Bs=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Le({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function $s({o:e,qa:a}){const{t:r,lang:n,fund:i}=q(),o=(e.cribleStatus||"").trim().toUpperCase()||($t(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=nt(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Le,{k:r.cdSector,v:e.sector}),t.jsx(Le,{k:r.cdStage,v:e.stage}),t.jsx(Le,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Le,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Le,{k:r.cdName,v:e.contactName}),t.jsx(Le,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Le,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Le,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Le,{k:r.cdAngle,v:e.angle}),t.jsx(Le,{k:r.cdDetected,v:Bs(e.date,n)})]}),p.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,f])=>f).map(([f,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:c})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function _s(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=q(),[s,p]=h.useState({}),f=25,c=h.useMemo(()=>n.slice(0,f),[n]);h.useEffect(()=>{c.length&&eo(r,c.map(v=>v.name)).then(p)},[r,c]);const d=o.stats,m=v=>v.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),d&&typeof d.screened=="number"&&t.jsxs("p",{children:[m(d.screened)," ",e.funScreened(""),typeof d.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",m(d.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(m(o.marketEstimate)),", ",Math.round(d.screened/o.marketEstimate*100)," %"]})]})]}),c.map(v=>t.jsx($s,{o:v,qa:s[v.name]},v.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Us=50;function Oa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=q(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[f,c]=h.useState(""),[d,m]=h.useState(0),[v,x]=h.useState(""),[b,g]=h.useState(!1),u=h.useRef(null);h.useEffect(()=>()=>{u.current&&window.clearInterval(u.current)},[]);const y=async w=>{p(!0),c("");const N=await a();if(p(!1),N.ok){l(N);return}if(N.busy){c(i.alertPreviewBusy);return}if(!w){c(i.alertPreviewFail);return}m(Us),u.current=window.setInterval(()=>{m(S=>S>1?S-1:(u.current&&window.clearInterval(u.current),y(!1),0))},1e3)},j=async()=>{if(n||b)return;g(!0),x("");const w=await r();g(!1),x(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||d>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{j()},children:b?"…":i.alertTest})]}),d>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(d)}),f&&t.jsx("p",{className:"mnote warn",children:f}),v&&t.jsx("p",{className:"mnote",children:v}),!v&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const mt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function we({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=q();return at.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Vs(){const{st:e}=q();switch(e.modal){case"chain":return t.jsx(Ys,{});case"space":return t.jsx(Ws,{});case"alert":return t.jsx(Gs,{});case"queue":return t.jsx(Zs,{});case"export":return t.jsx(el,{});case"plug":return t.jsx(nl,{});case"recharge":return t.jsx(ol,{});case"cover":return t.jsx(sl,{});case"dossier":return t.jsx(il,{});case"crit":return t.jsx(ll,{});case"tuto":return t.jsx(cl,{});case"rdv":return t.jsx(Hs,{});case"memoalert":return t.jsx(tl,{});default:return null}}function Hs(){const{dispatch:e,fund:a}=q(),r=typeof document<"u"&&!!document.getElementById("rdv");return h.useEffect(()=>{r&&(e({type:"modal",modal:null}),Qo())},[r,e]),r?null:t.jsx(no,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Ys(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s}=q(),p=o==="client",f=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),c=e.chain.idx,d=f[c],m=c>=f.length;return at.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:m?n.finished:`${c+1} / ${f.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(m?100:c/Math.max(1,f.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:m||!d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(f.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:d.name}),t.jsx("div",{className:"sub",children:[rt(d.cc,i)||d.countryLabel,d.sector,d.stage,n.daysAgo(tt(d.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:De(d.engine,i).toUpperCase()}),typeof d.amountEur=="number"&&d.amountEur>0&&t.jsx("span",{children:Bt(d.amountEur,i)})]}),me(d)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(ot,{o:d,lg:!0})," ",t.jsx(_t,{o:d,src:!0})]}),(d.tagline||d.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:d.tagline||d.headline})]}),d.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:d.reasoning})]}),p&&Ce(d)&&t.jsxs("div",{className:"vbox",style:{"--c":Ye(d)==="retenu"?"var(--brand)":Ye(d)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ye(d)==="retenu"?"✓ "+n.kept:Ye(d)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:d.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!m&&d&&!(p&&Ce(d))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(d)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(m?{type:"modal",modal:null}:{type:"chainNext"}),children:m?n.closeBtn:n.skip})]})]})})}),document.body)}function Ws(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=q(),o=i==="client",l=h.useMemo(()=>o?r.filter(d=>Ce(d)):[],[r,o]),s=h.useMemo(()=>za(l.filter(d=>Ye(d)==="retenu"),{key:"signal",dir:-1}),[l]),p=h.useMemo(()=>l.filter(d=>Ye(d)==="ecarte"),[l]),f=e.spaceTab==="retenu"?s:p,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(we,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(d=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof d.score=="number"&&d.score>0?d.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:d.name}),t.jsx("div",{className:"rr",children:d.reasoning||d.tagline||""})]})]},d.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Gs(){const{mode:e}=q();return e==="client"||e==="apercu"?t.jsx(Ks,{}):t.jsx(Js,{})}function Ks(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=q(),[o,l]=h.useState("d"),s=i!=="client";return t.jsxs(we,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(Qs,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(Xs,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(lr,{})]})}function Qs({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[f,c]=h.useState(0);h.useEffect(()=>{let x=!0;return p(!1),Ha(a).then(b=>{x&&(b?l(b):p(!0))}),()=>{x=!1}},[a,f]);const d=x=>{r||Ha(a,x).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(x=>x+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const m=x=>!o.sections||o.sections.includes(x),v=x=>{const b=o.sections||e.alertSec.map(([g])=>g);d({sections:m(x)?b.filter(g=>g!==x):[...b,x]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([x,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:m(x),disabled:r,onChange:()=>v(x)}),t.jsxs("span",{children:[b,x==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},x))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Oa,{label:e.alertPreview,readOnly:r,onPreview:()=>po(a),onTest:()=>co(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Xs({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[f,c]=h.useState(0);h.useEffect(()=>{let x=!0;return p(!1),Ya(a).then(b=>{x&&(b?l(b):p(!0))}),()=>{x=!1}},[a,f]);const d=x=>{r||Ya(a,x).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(x=>x+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const m=o.dow??0,v=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:m,disabled:r,onChange:x=>d({dow:Number(x.target.value)}),children:e.alertDow.map((x,b)=>t.jsx("option",{value:b,children:x},x))}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,v-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[v," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,v+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Oa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>fo(a),onTest:()=>uo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function lr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=q(),[l,s]=h.useState(o||""),[p,f]=h.useState(!1),[c,d]=h.useState(!1);h.useEffect(()=>{o&&s(o)},[o]);const m=e.filters,v=h.useMemo(()=>n.filter(u=>me(u)).length,[n]),x=m.win==="1"?0:m.win==="7"?1:m.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||c)){d(!0);try{await fetch(`${ka}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:m.sector,countries:m.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{d(!1)}}},g=[[a.amRows.continent,i],[a.amRows.since,a.amSince[x]],[a.amRows.signal,m.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,m.engine.length?m.engine.map(u=>De(u,r)).join(", "):a.amAllEngines],[a.amRows.sectors,m.sector.length?m.sector.join(", "):a.amAllSectors],[a.amRows.countries,m.country.length?m.country.map(u=>rt(u,r)||u).join(", "):a.amAllCountries],[a.amRows.stages,m.stage.length?m.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:g.map(([u,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:u}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},u))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:u=>s(u.target.value),onKeyDown:u=>{u.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,v)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Js(){const{t:e}=q();return t.jsx(we,{title:e.alertTitle,icon:"🔔",children:t.jsx(lr,{})})}function Zs(){var b,g,u;const{t:e,token:a,fund:r,mode:n,flash:i}=q(),[o,l]=h.useState(null),[s,p]=h.useState([]),[f,c]=h.useState(0),d=n==="client";h.useEffect(()=>{let y=!0;return(async()=>{const[j,w]=await Promise.all([Na(r),Ln(a)]);y&&(j&&l(j),p(w))})(),()=>{y=!1}},[a,r,f]);const m=(o==null?void 0:o.per_day)??2,v=((b=o==null?void 0:o.analyzed_today)==null?void 0:b.length)??0,x=(g=o==null?void 0:o.tomorrow)!=null&&g.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(we,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(v,v+(((u=o==null?void 0:o.pool_order)==null?void 0:u.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(m)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),d&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Va(a,y.company,"retry").then(()=>c(j=>j+1))},children:e.queueRetry}),d&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Va(a,y.company,"delete").then(()=>c(j=>j+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[x.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),x.slice(0,10).map((y,j)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",j+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function el(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=q(),s=`${mt}/cibles/list.csv?token=${a}`,p=`${mt}/cibles/list.json?token=${a}`,f=`${mt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,d=g=>{var u;(u=navigator.clipboard)==null||u.writeText(g).then(()=>r(e.exportCopied))},m=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:f,href:f}],v=!i.lockActions&&n.length>0,x=()=>{Is(Ds(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:g=>(e.stg.find(([u])=>u===g)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(we,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),v&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:x,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:m.map(({def:g,value:u,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:g[0]}),t.jsxs("div",{children:[t.jsx("b",{children:g[1]}),t.jsx("p",{children:g[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d(u),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},g[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function tl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=q(),o=i!=="client",[l,s]=h.useState(null),[p,f]=h.useState(!1),[c,d]=h.useState(0),[m,v]=h.useState(!1);h.useEffect(()=>{let u=!0;return f(!1),Ua(a).then(y=>{u&&(y?s(y):f(!0))}),()=>{u=!1}},[a,c]);const x=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=u=>{if(o||!l)return;const y={enabled:u.enabled??!!l.enabled,email:u.email??(l.email||""),sections:u.sections??x()};v(!0),Ua(a,y).then(j=>{if(v(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(p)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(u=>u+1),children:e.retry})]})});if(!l)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const g=x();return t.jsxs(we,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||m,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(al,{value:l.email||"",readOnly:o||m,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:u=>b({email:u})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([u,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!g[u],disabled:o||m,onChange:()=>b({sections:{...g,[u]:!g[u]}})}),t.jsx("span",{children:y})]},u))}),t.jsx(Oa,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>ao(a,g),onTest:()=>to(a,g)})]})}function al({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=h.useState(e);h.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function nl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=q(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[f,c]=h.useState(null),[d,m]=h.useState(""),[v,x]=h.useState(0);h.useEffect(()=>{let u=!0;return p(!1),ra(a).then(y=>{u&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),oo(a).then(y=>{u&&c(y)}),()=>{u=!1}},[a,v]);const b=(u,y)=>{i&&ra(a,u).then(j=>{if(!j||j.ok===!1){n(e.actErr);return}u.test&&j.sent===!1?n(e.plugTestThrottled):r(y),x(w=>w+1)})},g='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(we,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(u=>u+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:d,disabled:!i,onChange:u=>m(u.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!d.trim(),onClick:()=>b({url:d.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(rl,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:g}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var u;(u=navigator.clipboard)==null||u.writeText(g).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function rl(){const{t:e,token:a,lang:r}=q(),[n,i]=h.useState("valides"),[o,l]=h.useState(!1),[s,p]=h.useState(null),[f,c]=h.useState(null),[d,m]=h.useState(!1),[v,x]=h.useState(!1),[b,g]=h.useState(null),[u,y]=h.useState(null),[j,w]=h.useState(null),N=`atl2:bulk:${a}:${n}`;h.useEffect(()=>{ra(a).then(A=>{y(A&&A.configured?A.url_hint||"webhook":null)})},[a]),h.useEffect(()=>{p(null),c(null),m(!1),g(null);try{const A=JSON.parse(localStorage.getItem(N)||"null");w(A&&Date.now()-Date.parse(A.t)<24*3600*1e3?A:null)}catch{w(null)}},[N]);const S=async()=>{l(!0),m(!1),g(null);const A=await so(a,n);p(A),c(A.ok?n:null),l(!1)},C=h.useRef(!1),L=async()=>{if(C.current)return;C.current=!0,x(!0);const A=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await lo(a,n,"webhook",void 0,A)}finally{C.current=!1}if(x(!1),m(!1),g(M),M.ok&&(M.pushed||0)>0){const R={t:new Date().toISOString(),n:M.pushed||0};w(R);try{localStorage.setItem(N,JSON.stringify(R))}catch{}}},F=s!=null&&s.ok&&s.ready||0,k=!!(s!=null&&s.ok)&&f===n&&F>0&&!!u&&!j,T=j?new Date(j.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:A=>i(A.target.value),children:e.plugBulkTabs.map(([A,M])=>t.jsx("option",{value:A,children:M},A))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{S()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),j&&t.jsx("p",{className:"mnote",children:e.bulkLocked(T,j.n)}),!j&&!!(s!=null&&s.ok)&&!u&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!j&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),k&&!d&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>m(!0),children:e.bulkArm}),k&&d&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(F,u||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:v,onClick:()=>{L()},children:v?e.bulkSending:e.bulkConfirm(u||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:v,onClick:()=>m(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function ol(){const{t:e,data:a,lang:r}=q(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const f=await(await fetch(`${ka}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(we,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function il(){const{t:e}=q();return t.jsx(we,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(_s,{})})}function sl(){const{t:e,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:l}=q(),[s,p]=h.useState(null),[f,c]=h.useState(!1);h.useEffect(()=>{let S=!0;return Na(i).then(C=>{S&&C&&typeof C.per_day=="number"&&p(C.per_day)}),()=>{S=!1}},[i]);const d=r.stats,m=typeof(d==null?void 0:d.screened)=="number"?d.screened:n.filter(S=>S.kind==="target"&&Ce(S)).length,v=r.marketEstimate||0,x=v>0?Math.min(100,Math.round(m/v*100)):null,b=(d==null?void 0:d.window_days)||30,g=m>0?m/b:0,u=v>0?Math.max(0,v-m):0,j=v>0&&g>0&&m>=100?Math.round(u/g):null,w=S=>Math.round(S).toLocaleString(a==="en"?"en-US":"fr-FR"),N=S=>{f||!o||(c(!0),io(i,S).then(C=>{if(c(!1),C===null){l(e.actErr);return}p(C),l(e.alertSaved)}))};return t.jsxs(we,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(m))}),v>0&&t.jsx("span",{children:e.covOf(w(v))})]}),x!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:x+"%"}}),t.jsxs("em",{children:[x," %"]})]}),j!==null&&t.jsx("p",{className:"mnote",children:e.covEta(j)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),g>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(g))}),d&&t.jsxs("div",{className:"covf",children:[typeof d.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.kept)})," ",e.covKept]}),typeof d.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.analyzed)})," ",e.covAna]}),typeof d.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.shown)})," ",e.covShown]})]}),o&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(S=>t.jsx("button",{type:"button",className:s===S?"on":"",disabled:f,onClick:()=>N(S),children:S===0?"⏸":S},S))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function ll(){var u,y,j;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o}=q(),l=n==="client",s=h.useMemo(()=>{const w=new Set;return a.forEach(N=>{N.angle&&w.add(N.angle)}),[...w]},[a]),[p,f]=h.useState(null);h.useEffect(()=>{let w=!0;return ro(r).then(N=>{w&&f(N.thumbs)}),()=>{w=!1}},[r]);const[c,d]=h.useState(""),[m,v]=h.useState(""),[x,b]=h.useState(!1),g=async()=>{const w=c.trim();if(!(!w||x||!l)){b(!0),v("");try{const S=await(await fetch(`${mt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&v(String(S.reply)),S.job_id){v(e.critChatRunning);const C=async()=>{const L=await fetch(`${mt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(F=>F.json()).catch(()=>null);if(L&&L.done){v(String(L.reply||L.clarification||L.summary||"✓")),b(!1),L.applied&&i(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),d("");return}d("")}finally{m.startsWith("⏳")||b(!1)}}};return t.jsxs(we,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((u=o.points)!=null&&u.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var N,S;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((N=w.look)!=null&&N.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((S=w.out)!=null&&S.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},w.title)})]}),!!((j=o==null?void 0:o.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!l||x,onChange:w=>d(w.target.value),onKeyDown:w=>{w.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(x?" loading":""),style:{padding:"12px 18px"},disabled:!l||x||!c.trim(),onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),m&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:m})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,N)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},N))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(sr[w]||"v-cons"),children:w}),t.jsx("span",{children:N})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,N])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",N]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function cl(){const{t:e,dispatch:a,startTour:r}=q(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(we,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const ta={},Cn=(ta==null?void 0:ta.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function En(){return new Date().toISOString().slice(0,10)}const cr=h.createContext(null);function dr(){const e=h.useContext(cr);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function dl({token:e,children:a}){const{dispatch:r,st:n,lang:i}=q(),[o,l]=h.useState(()=>n.filters.day||En()),[s,p]=h.useState(null),[f,c]=h.useState(!1),d=h.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),m=h.useCallback(()=>{l(En());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);h.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),h.useEffect(()=>{const b=g=>{var y;const u=(y=g.detail)==null?void 0:y.day;typeof u=="string"&&d(u)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[d]),h.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),h.useEffect(()=>{if(!e||!o)return;let b=!1;c(!0);const g=new URLSearchParams({token:e,date:o});return fetch(`${Cn}/cibles/edition.json?${g}`).then(u=>u.json()).then(u=>{b||p(u)}).catch(()=>{b||p({ok:!1,error:"network"})}).finally(()=>{b||c(!1)}),()=>{b=!0}},[e,o]);const v=h.useMemo(()=>`${Cn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),x=h.useMemo(()=>({token:e,day:o,ed:s,loading:f,pickDay:d,pickWindow:m,dayPicked:!!n.filters.day,daysUrl:v,isEn:i==="en"}),[e,o,s,f,d,m,n.filters.day,v,i]);return t.jsx(cr.Provider,{value:x,children:a})}function pl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=dr();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(mo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function ul(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=dr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,p=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["No thesis brief for ",t.jsx("b",{children:e})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):t.jsxs(t.Fragment,{children:["Pas encore de brief de thèse pour le ",t.jsx("b",{children:e}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const pr="atl2:mapfold",fl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(pr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},ur=h.createContext(null),q=()=>{const e=h.useContext(ur);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function ot({o:e,lg:a}){const{lang:r}=q(),n=me(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Wa(n,r),children:[n.emoji," ",Wa(n,r)]}):null}function _t({o:e,src:a}){const{lang:r,t:n}=q(),i=me(e);if(!i)return null;const o=vo(i),l=yo(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Mn(i,r))+" · "+n.win7(qn(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<o?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function fr({o:e}){const{lang:a}=q(),r=bo(e.cc),n=e.cc?rt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const zn="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",mr=e=>`atl2:tour:${e||"anon"}`;function ml(e){try{return localStorage.getItem(mr(e))==="1"}catch{return!0}}function An(e){try{localStorage.setItem(mr(e),"1")}catch{}}function xl(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function wl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){const{lang:l}=xo(),s=zo[l],p=Io(e,l,a),[f,c]=h.useReducer($o,void 0,()=>Bo((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||fl(),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??(a==="ops"?"deplie":void 0),filters:r,modal:n==null?void 0:n.modal})),d=h.useRef(!0);h.useEffect(()=>{if(d.current){d.current=!1;return}if(!e)try{localStorage.setItem(pr,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e]);const m=h.useRef(o);m.current=o,h.useEffect(()=>{var z;(z=m.current)==null||z.call(m,f.filters)},[f.filters]);const[v,x]=h.useState(null),[b,g]=h.useState(null),[u,y]=h.useState({kept:0,dropped:0}),[j,w]=h.useState(!1),[N,S]=h.useState(""),[C,L]=h.useState(!1),[F,k]=h.useState(null),[T,A]=h.useState(!1),[M,R]=h.useState(!1),[,E]=h.useState(0),O=()=>E(z=>z+1),$=h.useRef([]),V=h.useRef(new Set),Q=h.useRef(new Set),xe=h.useRef(new Map),se=h.useRef(null),{mode:le}=p,G=h.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[p.caps,i,a]),I=G.pipe,_=p.session.token||"",U=le==="client"&&!e;h.useEffect(()=>{if(document.querySelector(`link[href="${zn}"]`))return;const z=document.createElement("link");z.rel="stylesheet",z.href=zn,document.head.appendChild(z)},[]);const ee=(z,D=!1)=>{S(z),L(D),se.current&&clearTimeout(se.current),se.current=setTimeout(()=>S(""),D?4200:2400)},re=z=>ee(z,!0),ve=h.useMemo(()=>{const z=new Map;return p.dossiers.forEach(D=>{D.id&&z.set(D.id,D)}),z},[p.dossiers]),ce=h.useMemo(()=>p.dossiers.filter(z=>Dn(z,f,I)),[p.dossiers,f,I]),Y=h.useRef(!1);h.useEffect(()=>{if(Y.current||e||p.loading||!p.dossiers.length)return;if(!G.showFunnel||ml(p.session.token||"")){Y.current=!0;return}Y.current=!0;const z=window.setTimeout(()=>{An(p.session.token||""),A(!0)},700);return()=>window.clearTimeout(z)},[e,p.loading,p.dossiers.length,G.showFunnel,p.session.token]);const X=h.useMemo(()=>p.dossiers.filter(z=>_o(z,f,I,p.favIds)),[p.dossiers,f,I,p.favIds]),he=h.useMemo(()=>ho(ce,p.favIds),[ce,p.favIds]),H=Sa.find(z=>z.key===f.continent),ae=f.continent==="monde"?s.contWorld:(l==="fr"?H==null?void 0:H.fr:H==null?void 0:H.en)||"";h.useEffect(()=>{const z=D=>{var de;const B=(((de=D.detail)==null?void 0:de.name)||"").trim();B&&K(null,B)};return window.addEventListener("ppmap:evaluate",z),()=>window.removeEventListener("ppmap:evaluate",z)});const K=(z,D)=>{const B=((z==null?void 0:z.name)||D||"").trim();if(!U){g({kicker:B});return}!B||j||(w(!0),(async()=>{try{const de=await On(_,B,"atelier2"),vt={name:de.company||B,verdict:de.verdict,reason:de.reason||"",remaining:de.remaining??null};$.current=[vt,...$.current].slice(0,8),de.verdict==="kept"&&y(Ue=>({...Ue,kept:Ue.kept+1})),de.verdict==="ruled_out"&&y(Ue=>({...Ue,dropped:Ue.dropped+1}));const st=z||p.dossiers.find(Ue=>(Ue.name||"").toLowerCase()===B.toLowerCase());st&&(de.verdict==="kept"?st.verdict=st.verdict||"MATCH":de.verdict==="ruled_out"&&(st.verdict="NO MATCH"),de.reason&&(st.reasoning=de.reason)),O()}finally{w(!1)}})())},Ie=z=>{if(!U){g({kicker:z.name});return}V.current.add(z.id),lt(_,"fast_request",z.name||"",""),ee(s.memoInstantSent(z.name)),O()},pe=z=>xe.current.get(z.id)??p.thumbs.get((z.name||"").trim().toLowerCase()),ue=(z,D)=>c({type:"undoPush",entry:{id:z.id,name:z.name,prevCeoStatus:D}}),Me=async(z,D,B)=>{const de=z.ceoStatus||"";z.ceoStatus=D,O();const vt=await Wt(_,{status:D,airtable_id:z.airtableId,check_id:z.checkId,company:z.name,...(B==null?void 0:B.note)!==void 0?{note:B.note}:{},...B!=null&&B.via?{via:B.via}:{}});return vt.ok?vt.skipped?(z.ceoStatus=de,O(),re(s.actNotPersisted),!1):((B==null?void 0:B.undo)!==!1&&ue(z,de),B!=null&&B.msg&&ee(B.msg),(D==="Validé"||D==="Écarté")&&!z.ceoNote&&(B==null?void 0:B.note)===void 0&&k({o:z,yes:D==="Validé"}),!0):(z.ceoStatus=de,O(),re(s.actErr),!1)},_e=async(z,D)=>{const B=await Wt(_,{status:z.ceoStatus||"Retenu",airtable_id:z.airtableId,check_id:z.checkId,company:z.name,note:D,via:"note"});return!B.ok||B.skipped?(re(B.skipped?s.actNotPersisted:s.actErr),!1):(z.ceoNote=D,O(),!0)},je=h.useRef(new Map),qe=z=>je.current.has(z.id)?je.current.get(z.id):p.stages.get((z.name||"").trim().toLowerCase()),it=(z,D)=>{je.current.set(z.id,D),O()},Ut=(z,D)=>{U&&Me(z,D?"Validé":"Écarté",{msg:D?s.decidedYes(z.name):s.decidedNo(z.name)})},Vt=z=>{U&&Me(z,"À trancher",{msg:s.promoted(z.name)})},P=z=>{U&&(async()=>{const D=z.ceoStatus||"";z.ceoStatus="Retenu",O();const B=await Wt(_,{status:"Retenu",check_id:z.checkId,company:z.name});if(!B.ok||B.skipped){z.ceoStatus=D,O(),re(B.skipped?s.actNotPersisted:s.actErr);return}ue(z,D),ee(s.repeched(z.name))})()},J=()=>{const z=f.undo[f.undo.length-1];if(!z){ee(s.undoNone);return}const D=ve.get(z.id);if(!D){c({type:"undoPop"}),ee(s.undoNone);return}let B=z.prevCeoStatus;if(!B)if((D.verdict||"").toUpperCase().includes("CALL"))B="À trancher";else{ee(s.undoLockedTitle);return}(async()=>await Me(D,B,{undo:!1})&&(c({type:"undoPop"}),D.ceoStatus=z.prevCeoStatus,O(),ee(s.undoDone(D.name))))()},ne=z=>{U&&(Q.current.add(z.id),O(),(async()=>{const D=await wo(_,z.name,"email");if(!D||D.ok===!1){Q.current.delete(z.id),O(),re(s.actErr);return}lt(_,"approach",z.name||"",""),ee(s.actApproachSent)})())},ge=(z,D)=>{U&&(async()=>{if(!(await lt(_,D?"yes":"no",z.name||"","")).ok){re(s.actErr);return}xe.current.set(z.id,D?"yes":"no"),O(),ee(D?s.thumbUpDone:s.thumbDnDone)})()},Be=z=>{!U||!Ca(z)||(lt(_,"detailed_request",z.name||"",""),ee(s.memoDeepSent(z.name)))},ye=z=>{const D=new Set(p.favIds),B=D.has(z.id);B?D.delete(z.id):D.add(z.id),p.setFavIds(D),U&&ko(_,{id:z.id,co:z.name},B)},Ne=()=>{!U||M||window.confirm(s.identSyncConfirm)&&(R(!0),(async()=>{const z=await jo(_);R(!1),z?ee(s.identSyncDone):re(s.actErr)})())},$e=/proplace/i.test(p.fund||""),xr=z=>{!U||!$e||(lt(_,"onboard_request",z.name||"",""),ee(s.onboardSent(z.name)))},hr={st:f,dispatch:c,t:s,lang:l,mode:le,caps:G,pipe:I,token:_,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:P,thumbOf:pe,canWrite:U,commitStatus:Me,saveNote:_e,stageOf:qe,setStage:it,flashErr:re,startTour:()=>A(!0),dossiers:p.dossiers,scopedAll:ce,scoped:X,counts:he,byId:ve,contName:ae,favIds:p.favIds,toggleFav:ye,askEvaluate:K,doAnalyse:Ie,doDecide:Ut,doPromote:Vt,doApproach:ne,doThumb:ge,doDeep:Be,doUndo:J,doSync:Ne,doOnboard:xr,outbound:$e,memoQueued:V.current,approachDone:Q.current,sessTally:u,evalCards:$.current,evalBusy:j,markRow:x,markedId:v,flash:ee};h.useEffect(()=>{const z=D=>{D.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",z),()=>window.removeEventListener("keydown",z)},[]);const gr=z=>_?t.jsx(dl,{token:_,children:z}):t.jsx(t.Fragment,{children:z});return t.jsx(ur.Provider,{value:hr,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Lo}),gr(t.jsxs("div",{className:"app"+(I?" pipe":"")+(_?" has-thesis":""),children:[G.showTicker&&t.jsx(fe,{name:"live",children:t.jsxs("div",{className:"live-stack"+(_?" live-stack--cibles":""),children:[t.jsx(Wo,{}),!!_&&t.jsx(pl,{})]})}),G.showIdent&&t.jsx(fe,{name:"identite",children:t.jsx(di,{})}),G.showOnb&&t.jsx(fe,{name:"onboarding",children:t.jsx(pi,{})}),G.showMorning&&t.jsx(fe,{name:"matin",children:t.jsx(ci,{})}),t.jsx(fe,{name:"fraicheur",children:t.jsx(ti,{})}),t.jsx(fe,{name:"mesure",children:t.jsx(ai,{})}),G.showFunnel&&t.jsx(fe,{name:"entonnoir",children:t.jsx(hl,{})}),G.showFunnel&&t.jsx(fe,{name:"tunnel",children:t.jsx(fi,{})}),G.showFunnel&&t.jsx(fe,{name:"tuto",children:t.jsx(xi,{})}),t.jsx(fe,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(gl,{}),t.jsxs("div",{className:"stage"+(f.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(cs,{}),t.jsx(ps,{})]})]})}),G.showDemand&&t.jsx(fe,{name:"evaluation",children:t.jsx(gs,{})}),G.showDemand&&f.memoConsole&&t.jsx(fe,{name:"console",children:t.jsx(vs,{})}),t.jsx(fe,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Fs,{})}),!!_&&t.jsx(fe,{name:"edition",children:t.jsx(ul,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),G.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),f.popupId&&t.jsx(fe,{name:"fiche",children:t.jsx(ks,{})}),t.jsx(fe,{name:"modales",children:t.jsx(Vs,{})}),t.jsx(Jo,{}),F&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:F.o.name}),t.jsx(ii,{placeholder:F.yes?s.whyYesPh:s.whyNoPh,onDone:z=>{const D=F.o;k(null),z&&_e(D,z).then(B=>{B&&ee(s.csNoteSaved)})}})]}),T&&t.jsx(li,{steps:xl(s),onClose:()=>{A(!1),An(_)}}),N&&t.jsx("div",{className:"flash on"+(C?" err":""),children:N}),b&&t.jsx(go,{variant:"acquirer",initialCompany:Tn().co,initialWebsite:Tn().site,onClose:()=>g(null)})]})})}function hl(){const{t:e}=q(),[a,r]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function gl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=q(),l=h.useMemo(()=>{const s={};return e.forEach(p=>{Ea(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[No.map(s=>{const p=Sa.find(c=>c.key===s),f=s==="monde"?o.contWorld:i==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[f,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Tn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function bl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{fr as FlagCell,ot as SigBadge,_t as SigWin,wl as default,bl as fmtShort,q as useV2};
