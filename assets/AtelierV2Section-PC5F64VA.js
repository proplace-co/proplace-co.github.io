...
.atl2 .doable .dolist button[aria-pressed=true]{color:var(--brand-d);
  border-color:var(--brand);background:var(--brand-l)}
`,Zo=Jo+Xo;function ma(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function ei(){const e=ma("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function ti(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=ei();return r==="0"?"client":r==="1"||ma("embed")==="1"&&ma("chrome")==="1"?"apercu":"client"}const ai={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},ni=e=>ai[e];function ri(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Ye=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!Hn(a)||ri(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Zr(e.cc)})};function ta(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const oi=60*60*1e3;function ii(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>oi?null:a}catch{return null}}function Et(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const si=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function li(e,a,r="default"){const n=r!=="default",i=f.useMemo(()=>e||n?{mode:"anon"}:Vr(),[e,n]),o=f.useMemo(()=>n?"visiteur":ti(e,i),[e,i,n]),l=f.useMemo(()=>ni(o),[o]),s=o!=="visiteur",p=si(r),[x,d]=f.useState([]),[m,u]=f.useState(""),[b,c]=f.useState(null),[g,v]=f.useState(null),[h,C]=f.useState(null),[k,y]=f.useState(()=>new Map),[w,A]=f.useState(()=>new Map),[T,R]=f.useState(""),[z,O]=f.useState(new Set),[S,M]=f.useState(null),[_,j]=f.useState(!0),[E,L]=f.useState(!1),[$,V]=f.useState(0),[I,Z]=f.useState(0),Q=f.useRef(0),te=f.useMemo(()=>{var W;if(o!=="client")return"";try{return((W=Hr())==null?void 0:W.email)||""}catch{return""}},[o]);f.useEffect(()=>{const W=++Q.current;let J=!0;const X=()=>J&&W===Q.current,oe=(s&&i.token?i.token:"pub:"+a)+(p?":"+p:""),q=ii(oe);return q?(d(q.objs.map(Ye)),q.fund&&u(q.fund),c(q.marketEstimate??null),v(q.criteria??null),C(q.stats??null),R(q.generatedAt||""),j(!1)):j(!0),(async()=>{try{if(r==="ops"){const D=await Xt(),H=((D==null?void 0:D.recent_ops)||[]).map(B=>{const K=Zt(B.company_name||B.title?B:{...B,title:(B.headline_fr||B.headline||"").slice(0,120)},a),ae=String(B.rubrique||"").toLowerCase();return K&&(ae==="nominations"||ae==="recrutements")&&(K.engine=ae),K&&!String(B.company_name||"").trim()&&(K.noCo=!0),K}).filter(B=>!!B).map(B=>(Hn((B.name||"").trim())||(B.noCo=!0),B));try{const B=await Wr(),K=Yr(B),ae=((B==null?void 0:B.date)||"").slice(0,10);if(K.length&&ae){const ee=new Set;for(const se of H){if(se.noCo||(se.date||"").slice(0,10)!==ae)continue;const re=Ga(K,ee,se.name,"");re>=0&&(ee.add(re),se.decryptHtml=K[re].html)}for(const se of H){if(se.decryptHtml||(se.date||"").slice(0,10)!==ae)continue;const re=Ga(K,ee,"",se.headline||se.tagline||se.name);re>=0&&(ee.add(re),se.decryptHtml=K[re].html)}}}catch{}if(!X())return;d(H.map(Ye)),Et(oe,{objs:H})}else if(typeof r=="object"){const H=(await Ka()||[]).filter(K=>(K.slug||"")===r.research).map(K=>Qa(K,a)).filter(K=>!!K),B=ta(await Ja(H,a));if(!X())return;d(B.map(Ye)),Et(oe,{objs:B})}else if(s&&i.token){const D=Gr(i.token),H=Xt(),B=Kr(i.token),K=Qr(i.token),ae=Jr(i.token),ee=await D;let se=ee?ee.targets:[];X()&&ee&&(u(ee.fund||""),c(ee.marketEstimate??null),v(ee.criteria??null),C(ee.stats??null),R(ee.generatedAt||""),d(se.map(Ye)),j(!1),L(!1));const[re,Se,xe,ye]=await Promise.all([H,B,K,ae]),Me=((re==null?void 0:re.recent_ops)||[]).map(Ae=>Zt(Ae,a)).filter(Ae=>!!Ae);if(se=[...se,...Me],!X())return;d(se.map(Ye));const tt=new Set;for(const Ae of Se){const Be=(Ae.id||Ae.co||"").toString().trim().toLowerCase();Be&&tt.add(Be.startsWith("t:")?Be:"t:"+Be)}O(tt),y(xe),A(ye),ee&&Et(oe,{fund:ee.fund,marketEstimate:ee.marketEstimate,criteria:ee.criteria,stats:ee.stats,generatedAt:ee.generatedAt,objs:se})}else{const D=Xr(),H=Ka(),B=Xt(),K=await D;X()&&K.length&&(d(ta(K).map(Ye)),j(!1),L(!1));const[ae,ee]=await Promise.all([H,B]),se=(ae||[]).map(ye=>Qa(ye,a)).filter(ye=>!!ye),re=await Ja(se,a),Se=((ee==null?void 0:ee.recent_ops)||[]).map(ye=>Zt(ye,a)).filter(ye=>!!ye),xe=ta([...K,...re,...Se]);if(!X())return;d(xe.map(Ye)),Et(oe,{objs:xe})}X()&&L(!1)}catch{X()&&!q&&L(!0)}finally{X()&&j(!1)}})(),()=>{J=!1}},[s,i.token,a,$,p]),f.useEffect(()=>{if(!l.showCredits||!te){M(null);return}let W=!0;return(async()=>{try{const J=await fetch(`${za}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:te})});if(!J.ok)return;const X=await J.json();W&&X&&X.ok!==!1&&M(X)}catch{}})(),()=>{W=!1}},[l.showCredits,te,I]);const G=f.useCallback(W=>O(new Set(W)),[]);return{session:i,mode:o,caps:l,fund:m,email:te,marketEstimate:b,generatedAt:T,criteria:g,stats:h,thumbs:k,stages:w,dossiers:x,favIds:z,setFavIds:G,credits:S,reloadCredits:()=>Z(W=>W+1),loading:_,error:E,refresh:()=>V(W=>W+1)}}const Kn=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),ci=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"ligne",filters:{...Kn(),...(r==null?void 0:r.filters)||{}},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a});function di(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:Kn(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:a.key==="signal"||a.key==="amount"||a.key==="score"?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??Qn)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const Qn=40;function Oa(e,a,r,n){if(n!=="signal"&&a.signalOnly&&(!ge(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&a.dealKind.length&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(qa(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(He(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&Ke(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(i))return!1}return!0}function Jn(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Oa(e,a.filters,r)}function pi(e,a,r,n){return!(!Jn(e,a,r)||r&&!eo(e,a.ptab,n))}function Fa(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-He(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"signal":{const o=ge(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),s=n(o);return l<s?-a.dir:l>s?a.dir:(i.name||"").localeCompare(o.name||"")})}const ui=["ma","levees","nominations","recrutements","actualites"],mi=300,aa=7,fi={fr:{ma:"🤝 Deals signés",levees:"💰 Levées",nominations:"👤 Nominations",recrutements:"💼 Recrutements",actualites:"📰 Actus"},en:{ma:"🤝 Signed deals",levees:"💰 Raises",nominations:"👤 Appointments",recrutements:"💼 Hirings",actualites:"📰 News"}},Xn={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},hi=["hiring","raised","news","posting","building","community","registry","exodus","other"];function on(e){const a=ge(e);if(a)return"sig:"+(a.theme&&Xn.fr[a.theme]?a.theme:"other");const r=(e.rubrique||"").toLowerCase();return r==="ma"||r==="levees"||r==="nominations"||r==="recrutements"||r==="actualites"?r:e.dealKind==="ma"?"ma":e.dealKind==="levee"?"levees":"actualites"}function xi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:s}=F(),p=l==="en",[x,d]=f.useState("all"),[m,u]=f.useState(!1),b=f.useMemo(()=>{const S=(a.filters.day||"").slice(0,10),M=L=>{if(!o&&a.continent!=="monde"&&L.continent!==a.continent||S&&(L.date||"").slice(0,10)!==S)return!1;if(o&&L.kind==="op"){const $=(s||"").trim().toLowerCase();if(!$)return!1;const V=L.match||null;if(!V||!Object.keys(V).map(Z=>Z.trim().toLowerCase()).includes($))return!1}return!0},_=e.filter(L=>M(L)&&ge(L)),j=e.filter(L=>M(L)&&L.kind==="op"&&!ge(L)&&(S?!0:He(L.date)<=aa)),E=S||new Date().toISOString().slice(0,10);return j.sort((L,$)=>{const V=(L.date||"").slice(0,10)===E?0:1,I=($.date||"").slice(0,10)===E?0:1;return V!==I?V-I:($.amountEur||0)-(L.amountEur||0)}),[...Fa(_,{key:"signal",dir:-1}),...j]},[e,a.continent,a.filters.day,o,s]),c=f.useMemo(()=>{const S={};for(const M of b){const _=on(M);S[_]=(S[_]||0)+1}return S},[b]),g=f.useMemo(()=>x==="all"?b:b.filter(S=>on(S)===x),[b,x]),v=f.useMemo(()=>g.slice(0,mi),[g]),h=g.length-v.length,C=f.useRef(null);f.useEffect(()=>{var L,$;const S=C.current;if(!S)return;const M=()=>{const V=S.scrollWidth;V<200||(S.style.animationDuration=Math.max(30,Math.round(V/70))+"s")};M();const _=requestAnimationFrame(M),j=window.setTimeout(M,1200);let E=!0;return($=(L=document.fonts)==null?void 0:L.ready)==null||$.then(()=>{E&&M()}),()=>{E=!1,cancelAnimationFrame(_),window.clearTimeout(j)}},[v.length,x]);const k=S=>S==="all"?b.length:c[S]||0,y=S=>S==="all"?p?"All":"Tout":S.startsWith("sig:")?Xn[p?"en":"fr"][S.slice(4)]||"🔔":fi[p?"en":"fr"][S],w=[{k:"all"}],A=ui.filter(S=>k(S)>0||S===x);if(A.length){w.push({g:p?"DEALS":"OPÉRATIONS"});for(const S of A)w.push({k:S})}const T=hi.map(S=>"sig:"+S).filter(S=>k(S)>0||S===x);if(T.length){w.push({g:p?"OPEN SIGNALS":"SIGNAUX OUVERTS"});for(const S of T)w.push({k:S})}const R=S=>{try{return new Date(S+"T12:00:00Z").toLocaleDateString(p?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return S}},z=(()=>{const S=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?p?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return S?(p?`LIVE covers the events of ${R(S)}.`:`Le LIVE regroupe les événements du ${R(S)}.`)+M:(p?`LIVE covers the still-open signals and the deals of the last ${aa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${aa} derniers jours.`)+M})(),O=S=>v.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Ee(M)?" spent":""),onClick:_=>{const j=_.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:j.left+j.width/2,y:j.bottom}})},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(Ze,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(Tr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Ql(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(Qt,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},S+(M.id||M.name))).concat(h>0?[t.jsx("span",{className:"tk quiet",children:p?`+ ${h} more — filter by section to see them`:`+ ${h} autres — filtrez par rubrique pour les voir`},S+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:S=>{S.currentTarget.contains(S.relatedTarget)||u(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":m,onClick:()=>u(S=>!S),children:[y(x),t.jsx("b",{children:k(x)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!m,children:[t.jsx("span",{className:"tkfilscope",children:z}),w.map(S=>"g"in S?t.jsx("span",{className:"tkfilg",children:S.g},S.g):t.jsxs("button",{type:"button","aria-pressed":S.k===x,onClick:()=>{d(S.k),u(!1)},children:[y(S.k),t.jsx("b",{children:k(S.k)})]},S.k))]})]}),t.jsx("div",{className:"win",children:v.length?t.jsxs("div",{className:"run",ref:C,children:[O(0),O(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})})]})}const gi="aDx8z7Hzksus",Pa="+33 6 83 10 72 86",Dt="alexandre@proplace.co",Zn=`tel:${Pa.replace(/[^\d+]/g,"")}`,sn="pp-rdv-slot";function bi(){const e=typeof document<"u"&&document.getElementById("rdv");return e?(e.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function vi(){const{t:e,caps:a,fund:r}=F();if(!a.showOnb)return null;const n=r||e.rdvCoFallback;return t.jsxs("section",{id:"rdv",className:"pp-rdv is-teaser",children:[t.jsx("style",{children:wi}),t.jsx("h2",{children:e.rdvHeading}),t.jsxs("p",{className:"pp-rdv-sub",children:[e.rdvSubBefore,t.jsx("a",{href:Zn,children:Pa}),e.rdvSubMid,t.jsx("a",{href:`mailto:${Dt}`,children:Dt})]}),t.jsx("div",{className:"pp-rdv-unlocks",children:e.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"pp-rdv-u",children:[t.jsx("em",{children:e.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"pp-rdv-emb",children:t.jsx(Yo,{filloutId:gi,parameters:r?{company_name:r}:void 0})})]})}function yi(){const[e,a]=f.useState(()=>typeof document>"u"?null:document.getElementById(sn));return f.useEffect(()=>{e||a(document.getElementById(sn))},[e]),e?ct.createPortal(t.jsx(vi,{}),e):null}const wi=`
...
`;class ve extends f.Component{constructor(){super(...arguments);Wa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ki=8;function ji(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=F(),[s,p]=f.useState(!1),[x,d]=f.useState(!1),[m,u]=f.useState(!1),b=r||"home",{names:c,verdicts:g}=f.useMemo(()=>{const y=[],w={};return n.forEach(A=>{A.kind!=="target"||!A.name||(y.push(A.name),w[A.name]=to(A)||"")}),{names:y,verdicts:w}},[n]),v=f.useMemo(()=>c.length?ao(b,c,g,a):null,[b,c.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const h=x?v.added:v.added.slice(0,ki),C=v.added.length-h.length,k=y=>{const w=n.find(A=>A.name===y);w&&(o(w.id),l({type:"popup",id:w.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),no(b,c,g,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[h.map(y=>t.jsx("button",{type:"button",onClick:()=>k(y),children:y},y)),C>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>d(!0),children:e.sinceMore(C)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(y=>!y),children:e.sinceOut(v.gone.length)}),m&&v.gone.slice(0,20).map(y=>t.jsx("span",{className:"gone",children:y},y))]})]})}const na=600,Ge=62,ln="atl2:fstats";function Ni(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=F(),[l,s]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(ln)==="on"}catch{return!1}}),p=r.stats,x=f.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),d=(p==null?void 0:p.since)||"";if(!n.showFunnel||!p||typeof p.screened!="number")return null;const m=w=>a==="en"?w.slice(5,10):`${w.slice(8,10)}/${w.slice(5,7)}`,u=w=>w.toLocaleString(a==="en"?"en-US":"fr-FR"),b=x.reduce((w,A)=>Math.max(w,A.s||0),0),c=x.length?na/x.length:0,g=Math.max(4,c-4),v=x.length>=5&&b>0,h=r.marketEstimate||0,C=m(new Date().toISOString().slice(0,10)),k=w=>[...typeof w=="number"?[[w,e.funScreened("","")]]:[],...typeof p.kept=="number"?[[p.kept,e.funKept]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown]]:[]],y=[];return typeof p.screened_window=="number"&&d&&y.push({cle:"fenetre",periode:e.funPerWindow(m(d),C),etapes:[[p.screened_window,e.funScreened("","")]]}),typeof p.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:k(p.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(w=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:w.periode}),w.etapes.map(([A,T],R)=>t.jsxs("span",{className:"fst-t",children:[R>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(A)}),t.jsx("i",{children:T})]},w.cle+T)),w.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(h),Math.min(100,Math.round((p.screened||0)/h*100)))})]}),w.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const A=!l;s(A),A&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(ln,A?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},w.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${na} ${Ge}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[x.map((w,A)=>{const T=(w.s||0)/b*(Ge-4),R=(w.m||0)/b*(Ge-4),z=A*c+(c-g)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${m(w.d)} — ${w.s} ${e.actScreened} · ${w.m} ${e.actKept}`}),t.jsx("rect",{x:z,y:Ge-2-T,width:g,height:T,fill:"#cfe0d6"}),t.jsx("rect",{x:z,y:Ge-2-R,width:g,height:R,fill:"#185c38"})]},w.d)}),t.jsx("line",{x1:0,y1:Ge-1.5,x2:na,y2:Ge-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:m(x[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const er=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function Si(e,a){if((We(e)||"").startsWith("CALL")&&be(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=be(e)>=2;return er.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function Ci({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=F(),[s,p]=f.useState(!1),[x,d]=f.useState(""),[m,u]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const b=(e.ceoStatus||"").trim(),c=async g=>{if(x)return;if(g==="Analysé"&&!e.memoUrl){u(!0);return}d(g);const v=await i(e,g);d(""),v&&(p(!1),u(!1))};return t.jsxs("span",{className:"rstat",onClick:g=>g.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{p(g=>!g),u(!1)},children:[b||a.csNone,t.jsx("i",{children:"▾"})]}),s&&t.jsx("span",{className:"rstm",children:m?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),u(!1),p(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{d("Analysé");const g=await i(e,"Analysé");d(""),g&&(p(!1),u(!1))})()},children:a.csAnaAnyway})]}):Si(e,a).map(([g,v])=>t.jsx("button",{type:"button",className:"rsti"+(b===g?" on":"")+(x===g?" busy":""),disabled:!!x,onClick:()=>{c(g)},children:v},g))})]})}function Ei({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=F(),[o,l]=f.useState(""),[s,p]=f.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const x=(e.ceoStatus||"").trim(),d=(We(e)||"").startsWith("CALL")&&be(e)===3,m=be(e)>=2,u=async c=>{if(o||c==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(c);const g=await i(e,c);l(""),g&&(p(!0),setTimeout(()=>p(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:er.filter(([c])=>!(m&&c==="Retenu")).map(([c,g])=>[c,a[g]]);return t.jsxs("div",{className:"csp",onClick:c=>c.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([c,g])=>t.jsx("button",{type:"button",className:"csb"+(x===c?" on":"")+(o===c?" busy":""),disabled:!!o,onClick:()=>{u(c)},children:g},c)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(Ai,{o:e})]})}function Ai({o:e}){const{t:a,saveNote:r,flash:n}=F(),[i,o]=f.useState(e.ceoNote||""),[l,s]=f.useState(!1),[p,x]=f.useState(!1),d=i.trim()!==(e.ceoNote||"").trim(),m=async()=>{if(l||!d)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(x(!0),setTimeout(()=>x(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&m()}}),t.jsx("button",{type:"button",disabled:l||!d,onClick:()=>{m()},children:p?a.csNoteSaved:a.csNoteOk})]})}function Ti({placeholder:e,onDone:a}){const{t:r}=F(),[n,i]=f.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function zi({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=F(),[p,x]=f.useState(!1);if(!n.pipe||!i||n.lockActions||be(e)!==4)return null;const d=o(e),m=(d==null?void 0:d.stage)||"todo",u=async h=>{if(p||h===m)return;x(!0);const C=d;l(e,{stage:h,stamps:(d==null?void 0:d.stamps)||{}});const k=Math.max(Date.now(),cn+=1);cn=k;const y=await ro(r,{company:e.name||"",stage:h,cts:k,deal_id:e.airtableId,check_id:e.checkId});x(!1),!y.stale&&(y.ok||(l(e,C),s(a.actErr)))},b=(v=d==null?void 0:d.stamps)==null?void 0:v.sent,c=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,g=m==="sent"&&b&&c>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,C])=>t.jsx("button",{type:"button",className:"stgb"+(m===h?" on":""),disabled:p,onClick:()=>{u(h)},children:C},h)),g&&t.jsx("span",{className:"stgj4",children:a.j4Badge(c)})]})}let cn=0;const At=8,Tt=360;function dn({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function pn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(dn,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(dn,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function qi({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=F(),[l,s]=f.useState(0),[p,x]=f.useState(null),[d,m]=f.useState([]),u=f.useRef(!1),b=f.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),c=f.useRef(!1);f.useEffect(()=>{const T=b.current;return()=>{c.current||(n({type:"ptab",tab:T.ptab}),n({type:"dens",dens:T.dens}),n({type:"modal",modal:T.modal}))}},[]),f.useEffect(()=>{u.current||(u.current=!0,m(e.filter(T=>!!document.querySelector(T.need||T.sel))))},[e]);const g=d[l],v=l>=d.length;f.useEffect(()=>{if(g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}),o.modal!==(g.modal??null)&&n({type:"modal",modal:g.modal??null}),g.click)){const T=g.click,R=window.setTimeout(()=>{const z=document.querySelector(T);z&&z.getAttribute("aria-selected")!=="true"&&z.click()},60);return()=>window.clearTimeout(R)}},[l,g]);const h=f.useRef(-1),C=f.useCallback(()=>{if(!g){x(null);return}const T=document.querySelector(g.sel)||(g.need?document.querySelector(g.need):null);if(!T){x(null);return}h.current!==l&&(h.current=l,T.scrollIntoView({block:"nearest",behavior:"smooth"}));const R=T.getBoundingClientRect();x(z=>z&&Math.abs(z.top-R.top)<1&&Math.abs(z.left-R.left)<1&&Math.abs(z.width-R.width)<1&&Math.abs(z.height-R.height)<1?z:R)},[g,l]);f.useLayoutEffect(()=>{C();const T=[90,300,700,1300].map(z=>window.setTimeout(C,z)),R=()=>C();return window.addEventListener("scroll",R,!0),window.addEventListener("resize",R),()=>{T.forEach(z=>window.clearTimeout(z)),window.removeEventListener("scroll",R,!0),window.removeEventListener("resize",R)}},[C]);const k=f.useRef(a);if(k.current=a,f.useEffect(()=>{const T=R=>{R.key==="Escape"?(R.preventDefault(),R.stopPropagation(),k.current()):R.key==="ArrowRight"?s(z=>z+1):R.key==="ArrowLeft"&&s(z=>Math.max(0,z-1))};return document.addEventListener("keydown",T,!0),()=>document.removeEventListener("keydown",T,!0)},[]),!d.length)return null;let y=null;const w=T=>()=>{c.current=!0,n({type:"modal",modal:null}),T()};if(v){const T=i[3]||0;T>0?y={title:T===1?r.ahaATitle1:r.ahaATitleN(T),body:r.ahaABody,btn:r.ahaABtn,go:w(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:w(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:w(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:w(()=>{n({type:"modal",modal:"crit"}),a()})}}let A={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Tt};if(!v&&p){const T=p.bottom+14,z=window.innerHeight-T>190?T:Math.max(12,p.top-200);A={left:Math.min(Math.max(12,p.left+p.width/2-Tt/2),window.innerWidth-Tt-12),top:z,width:Tt}}return ct.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-At,top:p.top-At,width:p.width+At*2,height:p.height+At*2}}),(v||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:A,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(pn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx(pn,{text:(g==null?void 0:g.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(T=>Math.max(0,T-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(T=>T+1),children:l===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function tr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function ar(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function Li(){var R,z;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:s,dispatch:p}=F(),x=r?a:e,d=f.useMemo(()=>x.filter(O=>He(O.date)===0&&O.kind==="target"),[x]),m=f.useMemo(()=>r?a.filter(O=>O.kind==="target"&&be(O)===0).slice().sort((O,S)=>(S.date||"").localeCompare(O.date||"")):[],[a,r]),u=f.useMemo(()=>d.filter(O=>r?be(O)===0:!Ee(O)),[d,r]),b=r?m:u,c=r?a.length-m.length:d.length-u.length,g=r?a.length:d.length,v=g?Math.min(100,c/g*100):100,h=f.useMemo(()=>tr(x),[x]),C=!!h&&He(h)>0,k=f.useMemo(()=>C?x.filter(O=>(O.date||"").slice(0,10)===h):[],[x,h,C]),y=typeof((R=s.stats)==null?void 0:R.kept_today)=="number"?s.stats.kept_today:null,w=typeof((z=s.stats)==null?void 0:z.screened_today)=="number"?s.stats.screened_today:d.length;let A;C?A=i.morningLast(k.length,m.length,ar(h,l)):r?A=i.morningThesis(w,m.length,y):d.length?c===0?A=i.goalSourced(d.length):c>=d.length?A=i.goalCleared:A=i.goalDone(c,d.length):A=i.goalSourced(0);const T=()=>{if(!r){p({type:"pile",on:!0});return}p({type:"ptab",tab:0}),n==="client"&&m.length&&p({type:"chainStart",queue:m.map(O=>O.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:A}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:T,children:r?i.morningEval(b.length):o.pileMode?i.goalContinue(b.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Ri(){var $,V;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:x,startTour:d,flash:m,flashErr:u}=F(),[b,c]=f.useState(null),[g,v]=f.useState(!0),[h,C]=f.useState([]),k=p==="client";f.useEffect(()=>{if(!i||!o)return;let I=!0;return v(!0),(async()=>{const[Z,Q]=await Promise.all([La(o),Wn(i)]);I&&(Z&&c(Z),v(!1),C(Q))})(),()=>{I=!1}},[i,o]);const[y,w]=f.useState(!1),A=()=>{!k||y||!o||(w(!0),oo(o).then(I=>{w(!1),I?m(e.identRepubDone):u(e.actErr)}))},T=(b==null?void 0:b.per_day)??null,R=(($=b==null?void 0:b.pool_order)==null?void 0:$.length)??0,z=h.filter(I=>I.status==="running").length,O=f.useMemo(()=>s.filter(I=>I.kind==="target"&&Ee(I)).length,[s]),S=l.marketEstimate,M=typeof((V=l.stats)==null?void 0:V.screened)=="number"?l.stats.screened:O,_=S&&S>0?Math.min(100,Math.round(M/S*100)):null,j=I=>I.toLocaleString(a==="en"?"en-US":"fr-FR"),E=(o||"P").split(/\s+/).map(I=>I[0]).join("").slice(0,2).toUpperCase(),L=(()=>{const I=Date.parse(l.generatedAt||"");if(Number.isNaN(I))return"";const Z=new Date(I),Q=te=>String(te).padStart(2,"0");return`${Q(Z.getDate())}/${Q(Z.getMonth()+1)} à ${Q(Z.getHours())}:${Q(Z.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?E:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),L?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(L)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[_===null&&M>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:j(M)})})]}),_!==null&&S&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:_+"%"}})}),t.jsxs("b",{children:[_," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(M,S)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),T!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:T})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),T===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),z>0&&t.jsxs("span",{className:"ev",children:["⏳ ",z]}),t.jsx("span",{className:"ego",children:g?e.identPendingWait:e.identPending(R)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:I=>{I.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!k||y,onClick:A,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!k,onClick:x,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:I=>n({type:"filters",patch:{search:I.target.value}})})]})]})]})}const Mi=["--p0","--p1","--p2","--p3","--p4"];function Oi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=F(),s=o.loading&&!l.length,p=f.useRef({});f.useEffect(()=>{p.current={...r}},[r]);const x=u=>{const b=p.current[u],c=b!==void 0?r[u]-b:0;return t.jsxs("button",{type:"button",className:"step"+(u===3&&r[3]>0?" wait":""),style:{"--c":`var(${Mi[u]})`,"--tc":u<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsxs("span",{className:"l",children:[n.plabels[u].toUpperCase(),u===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(c>0?" up":c<0?" down":""),children:[r[u],c!==0&&t.jsxs("em",{className:"delta",children:[c>0?"+":"−",Math.abs(c)]})]})]},u)},d=(u,b,c)=>t.jsxs("button",{type:"button",className:"off"+(b?" view":""),style:{"--c":u===5?"var(--p5)":u===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===u,title:n.phelp[u],onClick:()=>a({type:"ptab",tab:u}),children:[t.jsx("span",{className:"l",children:c.toUpperCase()}),t.jsx("span",{className:"n",children:r[u]})]},u),m=(u,b,c,g=!1)=>t.jsx("button",{type:"button",className:"tool",title:b,disabled:g,onClick:c,children:u},b);return t.jsxs("div",{className:"funnel"+(s?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(x)}),t.jsxs("div",{className:"offtrack",children:[d(5,!1,n.plabels[5]),d(7,!0,n.plabels[7]),d(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[m("↩",n.toolUndo,i,e.undo.length===0),m("↺",n.toolReset,()=>{a({type:"reset"})}),m("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),m("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),m("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const Fi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function Pi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=F(),s=f.useRef(null),[p,x]=f.useState(60);f.useEffect(()=>{let b=0;const c=()=>{var k;const g=s.current;if(!g)return;const v=(k=g.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!v)return;const h=v.getBoundingClientRect(),C=g.getBoundingClientRect();x(Math.max(20,Math.min(h.left+h.width/2-C.left,C.width-30)))};return b=requestAnimationFrame(c),window.addEventListener("resize",c),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",c)}},[e.ptab]);const d=e.ptab;let m=r.tuto[d].p;if(d===3){const b=n.filter(v=>v.kind==="target"&&be(v)===3),c=b.filter(v=>ca(v)==="auto").length,g=b.filter(v=>ca(v)==="cd").length;m=r.tutoPending(c,g,b.length)}const u=(()=>{if(l!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(b=>b.id)})};if(d===1){const b=n.filter(c=>c.kind==="target"&&be(c)===1&&!i.has(c.id)).slice(0,10);if(b.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:b.map(c=>c.id)})}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":Fi[d],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:m}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class Je{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*Di(e){for(const a of e)yield*a}function nr(e){return Array.from(Di(e))}var le=1e-6,ne=Math.PI,qe=ne/2,un=ne/4,Re=ne*2,_e=180/ne,Ce=ne/180,de=Math.abs,Ii=Math.atan,vt=Math.atan2,ue=Math.cos,me=Math.sin,$i=Math.sign||function(e){return e>0?1:e<0?-1:0},et=Math.sqrt;function Bi(e){return e>1?0:e<-1?ne:Math.acos(e)}function yt(e){return e>1?qe:e<-1?-qe:Math.asin(e)}function Le(){}function It(e,a){e&&fn.hasOwnProperty(e.type)&&fn[e.type](e,a)}var mn={Feature:function(e,a){It(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)It(r[n].geometry,a)}},fn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){fa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)fa(r[n],a,0)},Polygon:function(e,a){hn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)hn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)It(r[n],a)}};function fa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function hn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)fa(e[r],a,1);a.polygonEnd()}function nt(e,a){e&&mn.hasOwnProperty(e.type)?mn[e.type](e,a):It(e,a)}function ha(e){return[vt(e[1],e[0]),yt(e[2])]}function st(e){var a=e[0],r=e[1],n=ue(r);return[n*ue(a),n*me(a),me(r)]}function zt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function $t(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ra(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function qt(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function xa(e){var a=et(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ga(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function ba(e,a){return de(e)>ne&&(e-=Math.round(e/Re)*Re),[e,a]}ba.invert=ba;function _i(e,a,r){return(e%=Re)?a||r?ga(gn(e),bn(a,r)):gn(e):a||r?bn(a,r):ba}function xn(e){return function(a,r){return a+=e,de(a)>ne&&(a-=Math.round(a/Re)*Re),[a,r]}}function gn(e){var a=xn(e);return a.invert=xn(-e),a}function bn(e,a){var r=ue(e),n=me(e),i=ue(a),o=me(a);function l(s,p){var x=ue(p),d=ue(s)*x,m=me(s)*x,u=me(p),b=u*r+d*n;return[vt(m*i-b*o,d*r-u*n),yt(b*i+m*o)]}return l.invert=function(s,p){var x=ue(p),d=ue(s)*x,m=me(s)*x,u=me(p),b=u*i-m*o;return[vt(m*i+u*o,d*r+b*n),yt(b*r-d*n)]},l}function Ui(e,a,r,n,i,o){if(r){var l=ue(a),s=me(a),p=n*r;i==null?(i=a+n*Re,o=a-p/2):(i=vn(l,i),o=vn(l,o),(n>0?i<o:i>o)&&(i+=n*Re));for(var x,d=i;n>0?d>o:d<o;d-=p)x=ha([l,-s*ue(d),-s*me(d)]),e.point(x[0],x[1])}}function vn(e,a){a=st(a),a[0]-=e,xa(a);var r=Bi(-a[1]);return((-a[2]<0?-r:r)+Re-le)%Re}function rr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Le,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Ft(e,a){return de(e[0]-a[0])<le&&de(e[1]-a[1])<le}function Lt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function or(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(c){if(!((g=c.length-1)<=0)){var g,v=c[0],h=c[g],C;if(Ft(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),s=0;s<g;++s)i.point((v=c[s])[0],v[1]);i.lineEnd();return}h[0]+=2*le}o.push(C=new Lt(v,c,null,!0)),l.push(C.o=new Lt(v,null,C,!1)),o.push(C=new Lt(h,c,null,!1)),l.push(C.o=new Lt(h,null,C,!0))}}),!!o.length){for(l.sort(a),yn(o),yn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var x=o[0],d,m;;){for(var u=x,b=!0;u.v;)if((u=u.n)===x)return;d=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,p=d.length;s<p;++s)i.point((m=d[s])[0],m[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)i.point((m=d[s])[0],m[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);i.lineEnd()}}}function yn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function oa(e){return de(e[0])<=ne?e[0]:$i(e[0])*((de(e[0])+ne)%Re-ne)}function Vi(e,a){var r=oa(a),n=a[1],i=me(n),o=[me(r),-ue(r),0],l=0,s=0,p=new Je;i===1?n=qe+le:i===-1&&(n=-qe-le);for(var x=0,d=e.length;x<d;++x)if(u=(m=e[x]).length)for(var m,u,b=m[u-1],c=oa(b),g=b[1]/2+un,v=me(g),h=ue(g),C=0;C<u;++C,c=y,v=A,h=T,b=k){var k=m[C],y=oa(k),w=k[1]/2+un,A=me(w),T=ue(w),R=y-c,z=R>=0?1:-1,O=z*R,S=O>ne,M=v*A;if(p.add(vt(M*z*me(O),h*T+M*ue(O))),l+=S?R+z*Re:R,S^c>=r^y>=r){var _=$t(st(b),st(k));xa(_);var j=$t(o,_);xa(j);var E=(S^R>=0?-1:1)*yt(j[2]);(n>E||n===E&&(_[0]||_[1]))&&(s+=S^R>=0?1:-1)}}return(l<-le||l<le&&p<-1e-12)^s&1}function ir(e,a,r,n){return function(i){var o=a(i),l=rr(),s=a(l),p=!1,x,d,m,u={point:b,lineStart:g,lineEnd:v,polygonStart:function(){u.point=h,u.lineStart=C,u.lineEnd=k,d=[],x=[]},polygonEnd:function(){u.point=b,u.lineStart=g,u.lineEnd=v,d=nr(d);var y=Vi(x,n);d.length?(p||(i.polygonStart(),p=!0),or(d,Wi,y,r,i)):y&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),d=x=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function b(y,w){e(y,w)&&i.point(y,w)}function c(y,w){o.point(y,w)}function g(){u.point=c,o.lineStart()}function v(){u.point=b,o.lineEnd()}function h(y,w){m.push([y,w]),s.point(y,w)}function C(){s.lineStart(),m=[]}function k(){h(m[0][0],m[0][1]),s.lineEnd();var y=s.clean(),w=l.result(),A,T=w.length,R,z,O;if(m.pop(),x.push(m),m=null,!!T){if(y&1){if(z=w[0],(R=z.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),A=0;A<R;++A)i.point((O=z[A])[0],O[1]);i.lineEnd()}return}T>1&&y&2&&w.push(w.pop().concat(w.shift())),d.push(w.filter(Hi))}}return u}}function Hi(e){return e.length>1}function Wi(e,a){return((e=e.x)[0]<0?e[1]-qe-le:qe-e[1])-((a=a.x)[0]<0?a[1]-qe-le:qe-a[1])}const wn=ir(function(){return!0},Yi,Ki,[-ne,-qe]);function Yi(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?ne:-ne,p=de(o-a);de(p-ne)<le?(e.point(a,r=(r+l)/2>0?qe:-qe),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=ne&&(de(a-n)<le&&(a-=n*le),de(o-s)<le&&(o-=s*le),r=Gi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Gi(e,a,r,n){var i,o,l=me(e-r);return de(l)>le?Ii((me(a)*(o=ue(n))*me(r)-me(n)*(i=ue(a))*me(e))/(i*o*l)):(a+n)/2}function Ki(e,a,r,n){var i;if(e==null)i=r*qe,n.point(-ne,i),n.point(0,i),n.point(ne,i),n.point(ne,0),n.point(ne,-i),n.point(0,-i),n.point(-ne,-i),n.point(-ne,0),n.point(-ne,i);else if(de(e[0]-a[0])>le){var o=e[0]<a[0]?ne:-ne;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Qi(e){var a=ue(e),r=2*Ce,n=a>0,i=de(a)>le;function o(d,m,u,b){Ui(b,e,r,u,d,m)}function l(d,m){return ue(d)*ue(m)>a}function s(d){var m,u,b,c,g;return{lineStart:function(){c=b=!1,g=1},point:function(v,h){var C=[v,h],k,y=l(v,h),w=n?y?0:x(v,h):y?x(v+(v<0?ne:-ne),h):0;if(!m&&(c=b=y)&&d.lineStart(),y!==b&&(k=p(m,C),(!k||Ft(m,k)||Ft(C,k))&&(C[2]=1)),y!==b)g=0,y?(d.lineStart(),k=p(C,m),d.point(k[0],k[1])):(k=p(m,C),d.point(k[0],k[1],2),d.lineEnd()),m=k;else if(i&&m&&n^y){var A;!(w&u)&&(A=p(C,m,!0))&&(g=0,n?(d.lineStart(),d.point(A[0][0],A[0][1]),d.point(A[1][0],A[1][1]),d.lineEnd()):(d.point(A[1][0],A[1][1]),d.lineEnd(),d.lineStart(),d.point(A[0][0],A[0][1],3)))}y&&(!m||!Ft(m,C))&&d.point(C[0],C[1]),m=C,b=y,u=w},lineEnd:function(){b&&d.lineEnd(),m=null},clean:function(){return g|(c&&b)<<1}}}function p(d,m,u){var b=st(d),c=st(m),g=[1,0,0],v=$t(b,c),h=zt(v,v),C=v[0],k=h-C*C;if(!k)return!u&&d;var y=a*h/k,w=-a*C/k,A=$t(g,v),T=qt(g,y),R=qt(v,w);ra(T,R);var z=A,O=zt(T,z),S=zt(z,z),M=O*O-S*(zt(T,T)-1);if(!(M<0)){var _=et(M),j=qt(z,(-O-_)/S);if(ra(j,T),j=ha(j),!u)return j;var E=d[0],L=m[0],$=d[1],V=m[1],I;L<E&&(I=E,E=L,L=I);var Z=L-E,Q=de(Z-ne)<le,te=Q||Z<le;if(!Q&&V<$&&(I=$,$=V,V=I),te?Q?$+V>0^j[1]<(de(j[0]-E)<le?$:V):$<=j[1]&&j[1]<=V:Z>ne^(E<=j[0]&&j[0]<=L)){var G=qt(z,(-O+_)/S);return ra(G,T),[j,ha(G)]}}}function x(d,m){var u=n?e:ne-e,b=0;return d<-u?b|=1:d>u&&(b|=2),m<-u?b|=4:m>u&&(b|=8),b}return ir(l,s,o,n?[0,-e]:[-ne,e-ne])}function Ji(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],x=a[1],d=0,m=1,u=p-l,b=x-s,c;if(c=r-l,!(!u&&c>0)){if(c/=u,u<0){if(c<d)return;c<m&&(m=c)}else if(u>0){if(c>m)return;c>d&&(d=c)}if(c=i-l,!(!u&&c<0)){if(c/=u,u<0){if(c>m)return;c>d&&(d=c)}else if(u>0){if(c<d)return;c<m&&(m=c)}if(c=n-s,!(!b&&c>0)){if(c/=b,b<0){if(c<d)return;c<m&&(m=c)}else if(b>0){if(c>m)return;c>d&&(d=c)}if(c=o-s,!(!b&&c<0)){if(c/=b,b<0){if(c>m)return;c>d&&(d=c)}else if(b>0){if(c<d)return;c<m&&(m=c)}return d>0&&(e[0]=l+d*u,e[1]=s+d*b),m<1&&(a[0]=l+m*u,a[1]=s+m*b),!0}}}}}var ft=1e9,Rt=-ft;function Xi(e,a,r,n){function i(x,d){return e<=x&&x<=r&&a<=d&&d<=n}function o(x,d,m,u){var b=0,c=0;if(x==null||(b=l(x,m))!==(c=l(d,m))||p(x,d)<0^m>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+m+4)%4)!==c);else u.point(d[0],d[1])}function l(x,d){return de(x[0]-e)<le?d>0?0:3:de(x[0]-r)<le?d>0?2:1:de(x[1]-a)<le?d>0?1:0:d>0?3:2}function s(x,d){return p(x.x,d.x)}function p(x,d){var m=l(x,1),u=l(d,1);return m!==u?m-u:m===0?d[1]-x[1]:m===1?x[0]-d[0]:m===2?x[1]-d[1]:d[0]-x[0]}return function(x){var d=x,m=rr(),u,b,c,g,v,h,C,k,y,w,A,T={point:R,lineStart:M,lineEnd:_,polygonStart:O,polygonEnd:S};function R(E,L){i(E,L)&&d.point(E,L)}function z(){for(var E=0,L=0,$=b.length;L<$;++L)for(var V=b[L],I=1,Z=V.length,Q=V[0],te,G,W=Q[0],J=Q[1];I<Z;++I)te=W,G=J,Q=V[I],W=Q[0],J=Q[1],G<=n?J>n&&(W-te)*(n-G)>(J-G)*(e-te)&&++E:J<=n&&(W-te)*(n-G)<(J-G)*(e-te)&&--E;return E}function O(){d=m,u=[],b=[],A=!0}function S(){var E=z(),L=A&&E,$=(u=nr(u)).length;(L||$)&&(x.polygonStart(),L&&(x.lineStart(),o(null,null,1,x),x.lineEnd()),$&&or(u,s,E,o,x),x.polygonEnd()),d=x,u=b=c=null}function M(){T.point=j,b&&b.push(c=[]),w=!0,y=!1,C=k=NaN}function _(){u&&(j(g,v),h&&y&&m.rejoin(),u.push(m.result())),T.point=R,y&&d.lineEnd()}function j(E,L){var $=i(E,L);if(b&&c.push([E,L]),w)g=E,v=L,h=$,w=!1,$&&(d.lineStart(),d.point(E,L));else if($&&y)d.point(E,L);else{var V=[C=Math.max(Rt,Math.min(ft,C)),k=Math.max(Rt,Math.min(ft,k))],I=[E=Math.max(Rt,Math.min(ft,E)),L=Math.max(Rt,Math.min(ft,L))];Ji(V,I,e,a,r,n)?(y||(d.lineStart(),d.point(V[0],V[1])),d.point(I[0],I[1]),$||d.lineEnd(),A=!1):$&&(d.lineStart(),d.point(E,L),A=!1)}C=E,k=L,y=$}return T}}const va=e=>e;var ia=new Je,ya=new Je,sr,lr,wa,ka,Ue={point:Le,lineStart:Le,lineEnd:Le,polygonStart:function(){Ue.lineStart=Zi,Ue.lineEnd=ts},polygonEnd:function(){Ue.lineStart=Ue.lineEnd=Ue.point=Le,ia.add(de(ya)),ya=new Je},result:function(){var e=ia/2;return ia=new Je,e}};function Zi(){Ue.point=es}function es(e,a){Ue.point=cr,sr=wa=e,lr=ka=a}function cr(e,a){ya.add(ka*e-wa*a),wa=e,ka=a}function ts(){cr(sr,lr)}var lt=1/0,Bt=lt,wt=-lt,_t=wt,Ut={point:as,lineStart:Le,lineEnd:Le,polygonStart:Le,polygonEnd:Le,result:function(){var e=[[lt,Bt],[wt,_t]];return wt=_t=-(Bt=lt=1/0),e}};function as(e,a){e<lt&&(lt=e),e>wt&&(wt=e),a<Bt&&(Bt=a),a>_t&&(_t=a)}var ja=0,Na=0,ht=0,Vt=0,Ht=0,rt=0,Sa=0,Ca=0,xt=0,dr,pr,De,Ie,ze={point:Xe,lineStart:kn,lineEnd:jn,polygonStart:function(){ze.lineStart=os,ze.lineEnd=is},polygonEnd:function(){ze.point=Xe,ze.lineStart=kn,ze.lineEnd=jn},result:function(){var e=xt?[Sa/xt,Ca/xt]:rt?[Vt/rt,Ht/rt]:ht?[ja/ht,Na/ht]:[NaN,NaN];return ja=Na=ht=Vt=Ht=rt=Sa=Ca=xt=0,e}};function Xe(e,a){ja+=e,Na+=a,++ht}function kn(){ze.point=ns}function ns(e,a){ze.point=rs,Xe(De=e,Ie=a)}function rs(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Vt+=i*(De+e)/2,Ht+=i*(Ie+a)/2,rt+=i,Xe(De=e,Ie=a)}function jn(){ze.point=Xe}function os(){ze.point=ss}function is(){ur(dr,pr)}function ss(e,a){ze.point=ur,Xe(dr=De=e,pr=Ie=a)}function ur(e,a){var r=e-De,n=a-Ie,i=et(r*r+n*n);Vt+=i*(De+e)/2,Ht+=i*(Ie+a)/2,rt+=i,i=Ie*e-De*a,Sa+=i*(De+e),Ca+=i*(Ie+a),xt+=i*3,Xe(De=e,Ie=a)}function mr(e){this._context=e}mr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Re);break}}},result:Le};var Ea=new Je,sa,fr,hr,gt,bt,kt={point:Le,lineStart:function(){kt.point=ls},lineEnd:function(){sa&&xr(fr,hr),kt.point=Le},polygonStart:function(){sa=!0},polygonEnd:function(){sa=null},result:function(){var e=+Ea;return Ea=new Je,e}};function ls(e,a){kt.point=xr,fr=gt=e,hr=bt=a}function xr(e,a){gt-=e,bt-=a,Ea.add(et(gt*gt+bt*bt)),gt=e,bt=a}let Nn,Wt,Sn,Cn;class En{constructor(a){this._append=a==null?gr:cs(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Sn||this._append!==Wt){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Sn=n,Wt=this._append,Cn=this._,this._=i}this._+=Cn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function gr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function cs(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return gr;if(a!==Nn){const r=10**a;Nn=a,Wt=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return Wt}function ds(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),nt(s,i(o))),o.result()}return l.area=function(s){return nt(s,i(Ue)),Ue.result()},l.measure=function(s){return nt(s,i(kt)),kt.result()},l.bounds=function(s){return nt(s,i(Ut)),Ut.result()},l.centroid=function(s){return nt(s,i(ze)),ze.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,va):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new En(r)):new mr(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new En(r)),l},l.projection(e).digits(r).context(a)}function Da(e){return function(a){var r=new Aa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Aa(){}Aa.prototype={constructor:Aa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ia(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),nt(r,e.stream(Ut)),a(Ut.result()),n!=null&&e.clipExtent(n),e}function br(e,a,r){return Ia(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function ps(e,a,r){return br(e,[[0,0],a],r)}function us(e,a,r){return Ia(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function ms(e,a,r){return Ia(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var An=16,fs=ue(30*Ce);function Tn(e,a){return+a?xs(e,a):hs(e)}function hs(e){return Da({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function xs(e,a){function r(n,i,o,l,s,p,x,d,m,u,b,c,g,v){var h=x-n,C=d-i,k=h*h+C*C;if(k>4*a&&g--){var y=l+u,w=s+b,A=p+c,T=et(y*y+w*w+A*A),R=yt(A/=T),z=de(de(A)-1)<le||de(o-m)<le?(o+m)/2:vt(w,y),O=e(z,R),S=O[0],M=O[1],_=S-n,j=M-i,E=C*_-h*j;(E*E/k>a||de((h*_+C*j)/k-.5)>.3||l*u+s*b+p*c<fs)&&(r(n,i,o,l,s,p,S,M,z,y/=T,w/=T,A,g,v),v.point(S,M),r(S,M,z,y,w,A,x,d,m,u,b,c,g,v))}}return function(n){var i,o,l,s,p,x,d,m,u,b,c,g,v={point:h,lineStart:C,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=w},polygonEnd:function(){n.polygonEnd(),v.lineStart=C}};function h(R,z){R=e(R,z),n.point(R[0],R[1])}function C(){m=NaN,v.point=k,n.lineStart()}function k(R,z){var O=st([R,z]),S=e(R,z);r(m,u,d,b,c,g,m=S[0],u=S[1],d=R,b=O[0],c=O[1],g=O[2],An,n),n.point(m,u)}function y(){v.point=h,n.lineEnd()}function w(){C(),v.point=A,v.lineEnd=T}function A(R,z){k(i=R,z),o=m,l=u,s=b,p=c,x=g,v.point=k}function T(){r(m,u,d,b,c,g,o,l,i,s,p,x,An,n),v.lineEnd=y,y()}return v}}var gs=Da({point:function(e,a){this.stream.point(e*Ce,a*Ce)}});function bs(e){return Da({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function vs(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function zn(e,a,r,n,i,o){if(!o)return vs(e,a,r,n,i);var l=ue(o),s=me(o),p=l*e,x=s*e,d=l/e,m=s/e,u=(s*r-l*a)/e,b=(s*a+l*r)/e;function c(g,v){return g*=n,v*=i,[p*g-x*v+a,r-x*g-p*v]}return c.invert=function(g,v){return[n*(d*g-m*v+u),i*(b-m*g-d*v)]},c}function ys(e){return ws(function(){return e})()}function ws(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,x=0,d,m=0,u=1,b=1,c=null,g=wn,v=null,h,C,k,y=va,w=.5,A,T,R,z,O;function S(E){return R(E[0]*Ce,E[1]*Ce)}function M(E){return E=R.invert(E[0],E[1]),E&&[E[0]*_e,E[1]*_e]}S.stream=function(E){return z&&O===E?z:z=gs(bs(d)(g(A(y(O=E)))))},S.preclip=function(E){return arguments.length?(g=E,c=void 0,j()):g},S.postclip=function(E){return arguments.length?(y=E,v=h=C=k=null,j()):y},S.clipAngle=function(E){return arguments.length?(g=+E?Qi(c=E*Ce):(c=null,wn),j()):c*_e},S.clipExtent=function(E){return arguments.length?(y=E==null?(v=h=C=k=null,va):Xi(v=+E[0][0],h=+E[0][1],C=+E[1][0],k=+E[1][1]),j()):v==null?null:[[v,h],[C,k]]},S.scale=function(E){return arguments.length?(r=+E,_()):r},S.translate=function(E){return arguments.length?(n=+E[0],i=+E[1],_()):[n,i]},S.center=function(E){return arguments.length?(o=E[0]%360*Ce,l=E[1]%360*Ce,_()):[o*_e,l*_e]},S.rotate=function(E){return arguments.length?(s=E[0]%360*Ce,p=E[1]%360*Ce,x=E.length>2?E[2]%360*Ce:0,_()):[s*_e,p*_e,x*_e]},S.angle=function(E){return arguments.length?(m=E%360*Ce,_()):m*_e},S.reflectX=function(E){return arguments.length?(u=E?-1:1,_()):u<0},S.reflectY=function(E){return arguments.length?(b=E?-1:1,_()):b<0},S.precision=function(E){return arguments.length?(A=Tn(T,w=E*E),j()):et(w)},S.fitExtent=function(E,L){return br(S,E,L)},S.fitSize=function(E,L){return ps(S,E,L)},S.fitWidth=function(E,L){return us(S,E,L)},S.fitHeight=function(E,L){return ms(S,E,L)};function _(){var E=zn(r,0,0,u,b,m).apply(null,a(o,l)),L=zn(r,n-E[0],i-E[1],u,b,m);return d=_i(s,p,x),T=ga(a,L),R=ga(d,T),A=Tn(T,w),j()}function j(){return z=O=null,S}return function(){return a=e.apply(this,arguments),S.invert=a.invert&&M,_()}}function vr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}vr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(de(i)>le&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function ks(){return ys(vr).scale(175.295)}function js(e){return e}function Ns(e){if(e==null)return js;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var x=2,d=s.length,m=new Array(d);for(m[0]=(a+=s[0])*n+o,m[1]=(r+=s[1])*i+l;x<d;)m[x]=s[x],++x;return m}}function Ss(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function Cs(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return qn(e,r)})}:qn(e,a)}function qn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=Es(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function Es(e,a){var r=Ns(e.transform),n=e.arcs;function i(d,m){m.length&&m.pop();for(var u=n[d<0?~d:d],b=0,c=u.length;b<c;++b)m.push(r(u[b],b));d<0&&Ss(m,c)}function o(d){return r(d)}function l(d){for(var m=[],u=0,b=d.length;u<b;++u)i(d[u],m);return m.length<2&&m.push(m[0]),m}function s(d){for(var m=l(d);m.length<4;)m.push(m[0]);return m}function p(d){return d.map(s)}function x(d){var m=d.type,u;switch(m){case"GeometryCollection":return{type:m,geometries:d.geometries.map(x)};case"Point":u=o(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(o);break;case"LineString":u=l(d.arcs);break;case"MultiLineString":u=d.arcs.map(l);break;case"Polygon":u=p(d.arcs);break;case"MultiPolygon":u=d.arcs.map(p);break;default:return null}return{type:m,coordinates:u}}return x(a)}const yr={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},As=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function Ts(e,a,r){const n=yr[e];if(!n||!n.length)return-1;const i=As(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Mt=null;function zs(){return Mt||(Mt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=Cs(r,n),o=ks().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=ds(o),s=(i.features||[]).filter(d=>{var m;return(((m=d.properties)==null?void 0:m.name)||"")!=="Antarctica"}).map(d=>{var b;const m=((b=d.properties)==null?void 0:b.name)||"",u=l(d)||"";return u?{i2:io(m)||null,n:m,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const p={};for(const[d,m]of Object.entries(so)){const u=o(m);u&&(p[d]={x:u[0],y:u[1]})}const x={};for(const[d,m]of Object.entries(yr)){const u=m.map(b=>o(b.ll)).filter(b=>!!b).map(([b,c])=>({x:b,y:c}));u.length&&(x[d]=u)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p,metros:x}}catch{return null}})(),Mt)}function qs(e){const[a,r]=f.useState(null);return f.useEffect(()=>{if(!e||a)return;let n=!1;return zs().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const Ls={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Ln=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Rn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function Rs(e,a){const[r,n]=f.useState(1);return f.useEffect(()=>{let i=!0,o=0;const l=()=>{var x;if(!i)return;const p=(x=e.current)==null?void 0:x.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Mn({msgs:e}){const[a,r]=f.useState(0);f.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function Ms(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p,data:x,dossiers:d}=F(),m=x.loading&&!d.length,u=f.useRef(null),b=f.useRef(null),c=qs(e.continent==="monde"),g=e.continent==="monde"?c:Ra.find(j=>j.key===e.continent)||null,v=Rs(u,e.continent+":"+e.mapFolded+":"+!!g),[h,C]=f.useState(new Map),[k,y]=f.useState(null);f.useEffect(()=>{const j=u.current;if(!j)return;const E=new Map;j.querySelectorAll("path[data-i2]").forEach(L=>{const $=L.dataset.i2;if($)try{const V=L.getBBox();V.width>0&&E.set($,{x:V.x,y:V.y,w:V.width,h:V.height})}catch{}}),C(E)},[e.continent,v,g]);const w=f.useMemo(()=>r.filter(j=>j.cc),[r]),A=f.useMemo(()=>{const j=new Map;return w.forEach(E=>j.set(E.cc,(j.get(E.cc)||0)+1)),j},[w]),T=e.continent==="monde"&&c?c.anchors:null,R=e.continent==="monde"&&c?c.metros:null,z=f.useMemo(()=>w.map(j=>{const E=Rn(j.name||j.id||""),L=Rn((j.id||j.name||"")+"·y");if(T&&j.cc){const Q=R?R[j.cc]:void 0;if(Q&&Q.length){const G=Ts(j.cc,j.city,E);if(G>=0&&Q[G])return{d:j,x:Q[G].x+(E-.5)*5,y:Q[G].y+(L-.5)*5}}const te=T[j.cc];if(te)return{d:j,x:te.x+(E-.5)*10,y:te.y+(L-.5)*10}}const $=j.cc?h.get(j.cc):void 0;if(!$)return null;const V=Ls[`${e.continent}:${j.cc||""}`];if(V)return{d:j,x:$.x+$.w*(V.fx+(E-.5)*V.sx),y:$.y+$.h*(V.fy+(L-.5)*V.sy)};const I=(E-.5)*Math.min($.w*.55,60),Z=(L-.5)*Math.min($.h*.55,60);return{d:j,x:$.x+$.w/2+I,y:$.y+$.h/2+Z}}).filter(j=>!!j),[w,h,T,R,e.continent]),O=j=>v>0?j/v:j,S=f.useMemo(()=>n?[0,1,2,3,4,5].map(j=>({c:Ln[j],fr:p.plabels[j].toUpperCase(),en:p.plabels[j].toUpperCase(),n:r.filter(E=>E.kind==="target"&&be(E)===j).length})).filter(j=>j.n>0):Xa.map((j,E)=>({...j,n:r.filter(L=>Za(L)===E).length})),[r,n,p.plabels]),M=o?l.get(o):null,_=M?z.find(j=>j.d.id===M.id):null;return g?t.jsxs("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:[m&&t.jsx(Mn,{msgs:p.loadMsgs}),t.jsxs("svg",{ref:u,viewBox:g.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?g.fr:g.en,onMouseLeave:()=>{y(null),i(null)},children:[t.jsx("g",{children:g.countries.map((j,E)=>t.jsx("g",{className:"ct"+(j.i2&&A.get(j.i2)?"":" empty"),children:t.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},E))}),t.jsx("g",{children:z.map(j=>{const E=Xa[Za(j.d)],L=!!ge(j.d),$=j.d.kind==="target",V=n&&$?Ln[be(j.d)]:E.c,I=!n&&Ee(j.d);return t.jsxs("g",{className:"co"+(I?" done":""),onMouseEnter:()=>{var te,G;const Z=(te=b.current)==null?void 0:te.getBoundingClientRect(),Q=(G=u.current)==null?void 0:G.createSVGPoint();if(Q&&u.current&&Z){Q.x=j.x,Q.y=j.y;const W=Q.matrixTransform(u.current.getScreenCTM());y({x:W.x-Z.left,y:W.y-Z.top,label:j.d.name+" · "+(dt(j.d.cc,s)||j.d.countryLabel||"")})}i(j.d.id)},onMouseLeave:()=>{y(null),i(null)},onClick:()=>{var te;const Z=(te=u.current)==null?void 0:te.createSVGPoint();let Q=null;if(Z&&u.current){Z.x=j.x,Z.y=j.y;const G=Z.matrixTransform(u.current.getScreenCTM());Q={x:G.x,y:G.y}}a({type:"popup",id:j.d.id,anchor:Q})},children:[t.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:O(Math.max(11,E.px+7))}),t.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:O(E.px),fill:V,stroke:L?"#DC2626":"#ffffff",strokeWidth:O(L?2.2:1.3)})]},j.d.id||j.d.name)})}),_&&t.jsx("circle",{className:"ring on",cx:_.x,cy:_.y,r:O(13),fill:"none",stroke:"#0F172A",strokeWidth:O(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:S.map((j,E)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":j.c}}),s==="fr"?j.fr:j.en," ",t.jsx("b",{children:j.n})]},E))}),r.some(j=>!j.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(j=>!j.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(m?" waiting":""),ref:b,children:t.jsx(Mn,{msgs:p.loadMsgs})})}function Os(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function Fs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=F(),s=e.filters,p=f.useMemo(()=>e.continent==="monde"?r:r.filter(c=>c.continent===e.continent),[r,e.continent]),x=c=>p.filter(g=>c!=="country"&&s.country.length&&!s.country.includes(g.cc||"")?!1:Oa(g,s,i,c==="country"?void 0:c)),d=f.useMemo(()=>{const c=x("win"),g=v=>c.filter(h=>(h.date?Math.max(0,Math.floor((Date.now()-Date.parse(h.date))/864e5)):9999)<=v).length;return[g(0),g(7),g(30),c.length]},[p,s,i]),m=f.useMemo(()=>s.day?x("win").filter(c=>(c.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=(s.acquirer.trim()?1:0)+s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),b=(c,g,v,h="fbtn")=>t.jsxs("button",{type:"button",className:h,"aria-expanded":e.openFacet===c,onClick:()=>a({type:"openFacet",facet:c}),children:[t.jsx("span",{className:"fl",children:g}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},c);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:n.fDay(Os(s.day,l))}),t.jsx("b",{children:m})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((c,g)=>t.jsxs("button",{type:"button","aria-pressed":s.win===c,onClick:()=>a({type:"filters",patch:{win:c}}),children:[t.jsx("span",{className:"sl",children:n.dates[g]}),t.jsx("b",{children:d[g]})]},c))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:c=>a({type:"filters",patch:{search:c.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):b("sec",n.fSector,s.sector.length),b("pay",n.fCountry,s.country.length),b("det",n.fEngine,s.engine.length),b("sta",n.fStage,s.stage.length),i&&b("ang","Angle",s.angle.length),i&&b("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(Ps,{poolFor:x})]})}function Ps({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:x}=f.useMemo(()=>{if(l==="sig"){const c=e("signal").filter(h=>ge(h)),g=new Map;c.forEach(h=>{const C=h.engine||"";g.set(C,(g.get(C)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:c.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...da([...g.keys()],i).map(h=>({v:h,label:Qe(h)+" "+$e(h,i),n:g.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const c=e("sector"),g=new Map;return c.forEach(v=>{v.sector&&g.set(v.sector,(g.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const c=e("country"),g=new Map;return c.forEach(v=>{v.cc&&g.set(v.cc,(g.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:dt(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const c=e("engine"),g=new Map;return c.forEach(v=>{v.engine&&g.set(v.engine,(g.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:da([...g.keys()],i).map(v=>({v,label:Qe(v)+" "+$e(v,i)+' <span style="color:var(--dim);font-size:10px">· '+lo(co(v),i)+"</span>",n:g.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const c=e("angle"),g=new Map;return c.forEach(v=>{v.angle&&g.set(v.angle,(g.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...g.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const c=e("memoLevel"),g=new Map;c.forEach(h=>{if(h.kind==="target"){const C=qa(h);g.set(C,(g.get(C)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:g.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const u=e("stage"),b=new Map;return u.forEach(c=>{c.stage&&b.set(c.stage,(b.get(c.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...b.entries()].sort((c,g)=>g[1]-c[1]).map(([c,g])=>({v:c,label:c,n:g,html:!1,on:o.stage.includes(c)}))}},[l,a,i]),d=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const c=o.signalEngines.includes(u)?o.signalEngines.filter(g=>g!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:c}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},m=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:m,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:x.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>d(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function wr(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ds(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function On({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=F();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(x=>t.jsx("span",{className:"ch",children:x},x))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function kr({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=F(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(On,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(On,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function Is({card:e,onEvaluate:a,onAddAll:r}){var s,p,x;const{t:n}=F(),i=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:wr(e.summary_md||"").map((d,m)=>t.jsx("p",{children:d},m))})]}),t.jsx(kr,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((x=e.prospective)==null?void 0:x.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(d=>t.jsx("li",{children:d},d))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function $s(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function Bs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=F(),s=i,[p,x]=f.useState(null),[d,m]=f.useState(null),[u,b]=f.useState(null),[c,g]=f.useState(!1);f.useEffect(()=>{let h=!0;return(async()=>{const C=await Yn({email:l,cbToken:s});h&&x(C)})(),()=>{h=!1}},[l,s,n]);const v=h=>{m(h),b(null),g(!0),(async()=>{const C=await po(h.id);b(C),g(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{m(null),b(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[$s(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?o.rsPub:o.rsPriv})]}),c&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!c&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!c&&u&&t.jsx(Is,{card:u,onEvaluate:a,onAddAll:r})]})]})}const Fn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function _s(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:x,data:d,canWrite:m,source:u}=F(),b=a==="client",c=f.useMemo(()=>r||(u!=="default"?uo():""),[r,u]),[g,v]=f.useState(""),[h,C]=f.useState(!1),[k,y]=f.useState(""),[w,A]=f.useState(!1),[T,R]=f.useState(""),[z,O]=f.useState([]),S=f.useRef(!1),[M,_]=f.useState(!1),[j,E]=f.useState(""),[L,$]=f.useState(""),[V,I]=f.useState(!1),[Z,Q]=f.useState(0),[te,G]=f.useState(""),[W,J]=f.useState(null),[X,oe]=f.useState(null),[q,D]=f.useState(!1),[H,B]=f.useState(null),[K,ae]=f.useState(0),ee=f.useRef(!1),se=g.trim()?Fn.test(g.trim())?e.evalUrl:e.evalName:e.evalWaiting,re=f.useMemo(()=>k.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[k]);f.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(E(P),_(!0))},[]),f.useEffect(()=>{const P=ie=>{var we;const ce=String(((we=ie.detail)==null?void 0:we.url)||"").trim();!ce||!/^https?:\/\//i.test(ce)||(E(ce),_(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),f.useEffect(()=>{if(!m&&!c){B(null);return}let P=!0;return(async()=>{const ie=await Yn({email:n,cbToken:c});P&&B(ie.length)})(),()=>{P=!1}},[m,c,n,K]);const Se=z.length?z:p,xe=d.credits,ye=f.useCallback(P=>{const ie=P.map(ce=>(ce||"").trim()).filter(Boolean);ie.length&&(y(ce=>{const we=ce.split(`
`).map(pe=>pe.trim()).filter(Boolean),Ve=new Set(we.map(pe=>pe.toLowerCase())),je=ie.filter(pe=>!Ve.has(pe.toLowerCase()));return[...we,...je].slice(0,15).join(`
`)}),C(!0))},[]);f.useEffect(()=>{if(!V)return;Q(0);const P=window.setInterval(()=>Q(ie=>ie+1),1e3);return()=>window.clearInterval(P)},[V]);const Me=()=>{const P=g.trim();P&&(i(null,P),v(""))},tt=async()=>{if(!b){i(null,re[0]||"");return}if(!re.length||w)return;A(!0),S.current=!1;const P=[];for(let ie=0;ie<re.length&&!S.current;ie++){R(e.evaluating(ie+1,re.length,re[ie]));const ce=await Gn(r,re[ie],"atelier2");if(P.unshift({name:ce.company||re[ie],verdict:ce.verdict,reason:ce.reason||"",remaining:ce.remaining??null}),O([...P]),ce.verdict==="quota"){P.unshift({name:"",verdict:"quota",reason:e.quota(re.length-ie-1),remaining:0}),O([...P]),y(re.slice(ie+1).join(`
`)),R(""),A(!1);return}}R(""),y(S.current?re.slice(P.length).join(`
`):""),A(!1)},Ae=async()=>{var ce,we,Ve;if(ee.current)return;const P=j.trim().replace(/\s+/g,""),ie=L.trim();if(!P&&!ie){G(e.rsNeed);return}if(!b&&!c){i(null,P||ie.slice(0,80));return}ee.current=!0,G(""),J(null),oe(null),I(!0);try{const je=await fo({url:P,text:ie,email:n,cbToken:c});if(I(!1),!je||je.status!=="success"){G((je==null?void 0:je.message)||"Erreur");return}J(je),_(!1),ye((((ce=je.prospective)==null?void 0:ce.companies_to_evaluate)||[]).map(Te=>(Te==null?void 0:Te.name)||"")),oe({state:"pending"});const pe=await ho(je,{email:n,cbToken:c});oe(pe.ok?{state:"ok",scopeLabel:((we=pe.summary)==null?void 0:we.scope_label)||"",scope:((Ve=pe.summary)==null?void 0:Ve.scope)||""}:{state:"fail",msg:pe.error||""}),pe.ok&&ae(Te=>Te+1)}finally{ee.current=!1,I(!1)}},Be=[W==null?void 0:W.industry,...(W==null?void 0:W.market_tags)||[],W==null?void 0:W.author].map(P=>(P||"").trim()).filter(Boolean),pt=(X==null?void 0:X.state)==="pending",Nt=X&&(pt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):X.state==="ok"?t.jsx("span",{className:"rslink ok",children:X.scope&&X.scope!=="public"?e.rsSavedIn(X.scopeLabel||X.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:X.msg,children:e.rsSaveFail})),at=Ds(W).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:g,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:P=>v(P.target.value),onKeyDown:P=>{P.key==="Enter"&&Me()}}),t.jsx("span",{className:"detect"+(Fn.test(g.trim())?" url":""),children:se})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:Me,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),x.showCredits&&xe&&t.jsxs("button",{type:"button",className:"credits"+(xe.total_available<=0&&!xe.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:xe.unlimited?"∞":xe.total_available}),!xe.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",xe.daily_grant+xe.purchased]}),xe.total_available<=0&&!xe.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>C(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(M?" on":""),onClick:()=>_(!M),children:e.rsOpen}),H!==null&&H>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(q?" on":""),onClick:()=>D(!q),children:e.rsArchOpen(H)})]}),q&&t.jsx(Bs,{bump:K,cbToken:c,onClose:()=>D(!1),onEvaluate:P=>i(null,P),onAddAll:ye}),M&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:j,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:P=>E(P.target.value),onKeyDown:P=>{P.key==="Enter"&&Ae()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:L,placeholder:e.rsTextPh,onChange:P=>$(P.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(V?" loading":""),style:{justifyContent:"center"},disabled:V||pt||!j.trim()&&!L.trim(),onClick:()=>{Ae()},children:[t.jsx("span",{className:"fill"}),V?`${mo(j.trim())==="youtube"&&j.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(Z)}`:pt?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),te&&t.jsx("div",{className:"rserr",children:te}),W&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:W.title}),W.source_url&&t.jsx("a",{href:W.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{J(null),oe(null)},children:"×"})]}),W.market&&t.jsx("p",{className:"rsmk",children:W.market}),Be.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Be.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[W.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${W.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:wr(W.summary_md||"").map((P,ie)=>t.jsx("p",{children:P},ie))})]}),t.jsx(kr,{card:W,onEvaluate:P=>i(null,P),onAddAll:ye}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(at)}),Nt]})]}),h&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:k,placeholder:e.bulkPh,onChange:P=>y(P.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(w?" loading":""),style:{justifyContent:"center"},disabled:w||!re.length,onClick:()=>{tt()},children:[t.jsx("span",{className:"fill"}),w&&T?T:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(re.length)})]})]}),Se.slice(0,1).map((P,ie)=>{const ce=P.verdict==="kept",we=P.verdict==="quota",Ve=ce?"var(--brand)":we?"var(--bolt)":"var(--red)",je=ce?"var(--brand-l)":we?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Ve,"--bgc":je},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ce?"✓ "+e.kept:we?"⏳":"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(pe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:pe.url.startsWith("http")?pe.url:`https://${pe.url}`,target:"_blank",rel:"nofollow noopener",children:[(pe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,pe.url),children:e.evalPickGo})]},pe.url))}),!we&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:ce?1:5});const pe=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const Te=[...document.querySelectorAll(".atl2 .list .row")].find(Jt=>{var St;return(((St=Jt.querySelector(".rnm"))==null?void 0:St.textContent)||"").trim().toLowerCase().includes(pe)});Te&&(Te.scrollIntoView({behavior:"smooth",block:"center"}),Te.classList.add("flashrow"),window.setTimeout(()=>Te.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ce?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ie)}),b&&(o.kept+o.dropped>0||Se.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Us(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Vs(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=F(),o=e.memoConsole?r.get(e.memoConsole):null,l=f.useMemo(()=>o?[o.reasoning||"",Us(o.summary||"")].filter(Boolean).join(`

`):"",[o]);if(!o)return null;const s=We(o),p=qa(o);return t.jsx("div",{className:"demand",style:{paddingTop:0},children:t.jsxs("div",{className:"memo",style:{marginTop:0},children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"nm",children:o.name}),s&&t.jsx("span",{className:"vv",children:s}),typeof o.score=="number"&&t.jsxs("span",{className:"vv",style:{background:"var(--panel3)",color:"var(--muted)"},children:[o.score,"/100"]}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"memoConsole",id:null}),children:"×"})]}),t.jsx("div",{className:"tabs2",children:t.jsx("button",{type:"button","aria-selected":"true",children:n.memoSynth})}),t.jsx("div",{className:"mb2",children:l?l.split(`

`).map((x,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:x},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[it(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:p===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}const la={},Pn=(la==null?void 0:la.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Dn(){return new Date().toISOString().slice(0,10)}const $a=f.createContext(null);function Hs(){return f.useContext($a)}function Ws(e){if(!e||typeof DOMParser>"u")return[];try{const r=[...new DOMParser().parseFromString(e,"text/html").querySelectorAll("div,section")].find(i=>/en bref/i.test(i.textContent||"")&&i.querySelector("li"));return(r?[...r.querySelectorAll("li")]:[]).map(i=>(i.textContent||"").replace(/\s+/g," ").trim()).filter(i=>i.length>3).slice(0,4)}catch{return[]}}function Ys(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(p=>p.remove()),s.querySelectorAll("*").forEach(p=>{const x=p.tagName==="A"?p.getAttribute("href"):null;[...p.attributes].forEach(d=>p.removeAttribute(d.name)),x&&/^https?:\/\//i.test(x)&&(p.setAttribute("href",x),p.setAttribute("target","_blank"),p.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:s.outerHTML})}}catch{}return a}function Ta(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function Gs(){const{ed:e,isEn:a,day:r,loading:n}=Ba(),i=f.useMemo(()=>Ws((e==null?void 0:e.html)||""),[e==null?void 0:e.html]);if(n&&!e)return null;const o=Ta(r,a);return i.length?t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:(a?"Daily brief · ":"Brief du jour · ")+o}),t.jsx("ul",{children:i.map((l,s)=>t.jsx("li",{children:l},s))})]}):t.jsxs("div",{className:"thesis-lead",children:[t.jsx("span",{className:"tlk",children:a?"Daily brief":"Brief du jour"}),t.jsx("p",{className:"tlp",children:a?`Edition of ${o}.`:`Édition du ${o}.`})]})}function Ba(){const e=f.useContext($a);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Ks({token:e,children:a}){const{dispatch:r,st:n,lang:i}=F(),[o,l]=f.useState(()=>n.filters.day||Dn()),[s,p]=f.useState(null),[x,d]=f.useState(!1),m=f.useCallback(g=>{if(/^\d{4}-\d{2}-\d{2}$/.test(g)){l(g);try{r({type:"filters",patch:{day:g,win:"all"}})}catch{}}},[r]),u=f.useCallback(()=>{l(Dn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);f.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),f.useEffect(()=>{const g=v=>{var C;const h=(C=v.detail)==null?void 0:C.day;typeof h=="string"&&m(h)};return window.addEventListener("pp-edition-day",g),()=>window.removeEventListener("pp-edition-day",g)},[m]),f.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),f.useEffect(()=>{if(!e||!o)return;let g=!1;d(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Pn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{g||p(h)}).catch(()=>{g||p({ok:!1,error:"network"})}).finally(()=>{g||d(!1)}),()=>{g=!0}},[e,o]);const b=f.useMemo(()=>`${Pn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),c=f.useMemo(()=>({token:e,day:o,ed:s,loading:x,pickDay:m,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:i==="en"}),[e,o,s,x,m,u,n.filters.day,b,i]);return t.jsx($a.Provider,{value:c,children:a})}function Qs(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=Ba();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(xo,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Js(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=Ba(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,p=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
...
`;function Zs(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function el(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:x,doPromote:d,doRepeche:m,doApproach:u,doDeep:b,doOnboard:c,outbound:g,evalBusy:v}=F(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const C=ge(h),k=be(h),y=We(h),w=h.kind==="target",A=T=>{a({type:"filters",patch:T}),a({type:"popup",id:null})};return ct.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Xs}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Zs(e.popupAnchor,!!h.card),onClick:T=>T.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(He(h.date)),$e(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[h.cc]}),children:(dt(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:jt(h.amountEur,i)})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Qe(h.engine)," ",t.jsx("b",{children:$e(h.engine,i)})," — ",bo(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),C?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(Ze,{o:h,lg:!0})," ",t.jsx(Qt,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ma(C,i))," · ",n.win7(Pt(C,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(Kt,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&k>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&w&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})})]}),t.jsx(jr,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[k===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),k===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),k===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),k===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{x(h,!1),a({type:"popup",id:null})},children:n.actNo}),it(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(h),a({type:"popup",id:null})},children:n.memoDeep})]}),k===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),k===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),g&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{c(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var T;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(T=document.querySelector(".atl2 .demand"))==null||T.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(h.name),onClick:()=>s(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const tl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Ot=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function al(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Ot(a.slice(n));break}r+=Ot(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Ot(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&tl.has(p)?r+=`<${s[1]}${p}>`:r+=Ot(a.slice(i,o+1)),n=o+1}return r}const In=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function ke({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function nl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function rl({o:e}){const{t:a,doDeep:r}=F(),n=We(e),i=[e.reasoning||"",nl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[n&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:n}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),i.length?i.join(`

`).split(`

`).map((o,l)=>t.jsx("p",{className:"cdtxt",children:o},l)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[it(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:o=>{o.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:o=>o.stopPropagation(),children:a.memoOpenFull})]})]})}function ol({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=F(),o=Gt(e),l=We(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,d=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),m=f.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:d},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||it(e)?1:0}].filter(g=>g.n>0),[e,a,s,l,p,x,d]),[u,b]=f.useState("");if(!m.length)return null;const c=m.some(g=>g.k===u)?u:m[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:m.map(g=>t.jsx("button",{type:"button",role:"tab","aria-selected":c===g.k,"data-tour":"tab-"+g.k,className:c===g.k?"on":"",onClick:v=>{v.stopPropagation(),b(g.k)},children:g.lib},g.k))}),t.jsxs("div",{className:"cdbody",onClick:g=>g.stopPropagation(),children:[c==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(ke,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(ke,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(ke,{k:a.cdVerdictDate,v:In(e.verdictDate,r)})]})]}),c==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:al(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(il,{o:e})]}),c==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ke,{k:a.cdSector,v:e.sector}),t.jsx(ke,{k:a.cdStage,v:e.stage}),t.jsx(ke,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(ke,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(ke,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(ke,{k:a.cdAngle,v:e.angle}),t.jsx(ke,{k:a.cdDetected,v:In(e.date,r)})]}),c==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(ke,{k:a.cdName,v:e.contactName}),t.jsx(ke,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(ke,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),c==="memo"&&t.jsx(rl,{o:e}),c==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(ke,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(ke,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function il({o:e}){const{t:a,token:r}=F(),[n,i]=f.useState(!1),[o,l]=f.useState(null),s=async()=>{n||(i(!0),l(await vo(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},x=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],d=x.some(([,m])=>m);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&d&&t.jsxs(t.Fragment,{children:[x.filter(([,m])=>m).map(([m,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:m}),t.jsx("p",{children:u})]},m)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!d&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const Nr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function _a({o:e}){const{t:a}=F(),r=Gt(e),n=We(e),i=be(e),o=ca(e),l=yo(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(Nr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const Yt=e=>e.length>22?e.slice(0,21)+"…":e;function $n({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=F(),[o,l]=f.useState(!1);if(f.useEffect(()=>{n||l(!1)},[n]),Ee(e)){const x=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:x=>{x.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Yt(e.name))})]})}function Sr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:x,dispatch:d}=F();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:b=>{b.stopPropagation(),d({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var c;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:b=>{var c;b.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(c=document.querySelector(".atl2 .demand"))==null||c.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx($n,{o:e})});const m=be(e),u=b=>c=>{c.stopPropagation(),b()};if(m===0)return t.jsx("span",{className:"cell",children:t.jsx($n,{o:e})});if(m===1){const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:u(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(m===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})});if(m===4){const b=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:b,onClick:u(()=>x(e)),children:b?a.actApproachSent:a.actApproach})})}return m===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):m===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>d({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function sl({o:e}){const{t:a,doThumb:r,thumbOf:n}=F(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function ll({o:e}){const{lang:a}=F();return ge(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(Ze,{o:e}),t.jsx(Qt,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Qe(e.engine||"")," ",$e(e.engine||"",a)]})})}function cl({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:x,toggleFav:d,t:m}=F(),u=be(e),b=["#0F172A","#475C6E","#8798A8","#B9C6D2"],c=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,g=c<=0?0:c<=7?1:c<=30?2:3,v=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][u]:b[g],h=x.has(e.id),C=k=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const y=k.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:y.left+Math.min(280,y.width/3),y:y.bottom}})};return t.jsxs(f.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" tzr":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:C,children:[t.jsx("span",{className:"pt",style:{"--c":v}}),t.jsx(Tr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:h?1:.35,padding:0,marginRight:4},onClick:k=>{k.stopPropagation(),d(e)},children:h?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(k=>k&&k!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:k=>{k.stopPropagation(),o({type:"acquirer",value:e.acquirer||""})},children:["← ",Yt(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(dl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(ll,{o:e}),l.pipe&&t.jsx(_a,{o:e}),l.pipe&&!a&&t.jsx(Ci,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Sr,{o:e}),l.showThumbs&&t.jsx(sl,{o:e})]}),r&&!a&&t.jsx(ul,{o:e})]})}function dl({o:e}){const{lang:a,caps:r}=F();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=jt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function pl({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=F(),l=(u,b=!1)=>c=>{c.stopPropagation(),b&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=jt(e.amountEur,r),x=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=Ee(e),m=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),x&&t.jsx("span",{children:x})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Yt(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Yt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Kt,{spec:e.card})})]})}function ul({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=F();return!i.pipe&&e.kind==="op"?t.jsx(pl,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(ol,{o:e}),t.jsx(Ei,{o:e}),t.jsx(zi,{o:e}),t.jsx(jr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(_a,{o:e})})]}),e.card&&t.jsx(Kt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Qe(e.engine||"")," ",$e(e.engine||"",r)]}),ge(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(Ze,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function ml({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=F();if(!i.pipe&&e.kind==="op"){const x=jt(e.amountEur,l),d=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,32):""})(),m=(u,b=!1)=>c=>{c.stopPropagation(),b&&n({type:"continent",key:"monde"}),n({type:"filters",patch:u})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Kt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:m({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:m({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:m({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[Qe(e.engine||"")," ",$e(e.engine||"",l)]}),ge(e)&&t.jsx(Ze,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(d?` · ${d}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Sr,{o:e})})]})}const s=be(e),p=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][s];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":p},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(_a,{o:e}),ge(e)&&t.jsx(Ze,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&s===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function fl(){const{t:e}=F(),[a,r]=f.useState(0);return f.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function hl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=F(),o=i==="en",l=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),p=s.includes(0)?0:s.sort((d,m)=>(e[m]||0)-(e[d]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const x=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${x} ${x>1?"files are":"file is"} waiting for your screening`:`${x} dossier${x>1?"s":""} attende${x>1?"nt":""} votre évaluation`:o?`${x} ${x>1?"files":"file"} in “${l(p)}”`:`${x} dossier${x>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function xl(){var oe;const e=F(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:s,markRow:p,lang:x,sessTally:d,data:m,dossiers:u,source:b}=e,c=i.lockRowsAfter!==null?Number.MAX_SAFE_INTEGER:b==="ops"?8:Qn,[g,v]=f.useState(new Set);f.useEffect(()=>{v(new Set)},[a.ptab,a.continent]);const[h,C]=f.useState(null);f.useEffect(()=>{C(null)},[a.ptab,a.continent]);const k=q=>v(D=>{const H=new Set(D);return H.has(q)?H.delete(q):H.add(q),H}),[y,w]=f.useState("all"),[A,T]=f.useState(!1);f.useEffect(()=>{w("all"),T(!1)},[a.ptab,a.continent]),f.useEffect(()=>{if(!A)return;const q=D=>{var H,B;(B=(H=D.target)==null?void 0:H.closest)!=null&&B.call(H,".atl2 .doable")||T(!1)};return document.addEventListener("click",q),()=>document.removeEventListener("click",q)},[A]);const R=Hs(),z=f.useMemo(()=>{var D;const q=new Map;for(const H of Ys(((D=R==null?void 0:R.ed)==null?void 0:D.html)||""))q.has(H.t)||q.set(H.t,H.html);return q},[(oe=R==null?void 0:R.ed)==null?void 0:oe.html]),O=f.useCallback(q=>{if(q.decryptHtml)return q.decryptHtml;if(!z.size)return;const D=(q.name||"").trim().toLowerCase();if(D.length<3)return;const H=z.get(D);if(H)return H;for(const[B,K]of z)if(B.includes(D)||D.includes(B))return K},[z]),S=f.useMemo(()=>{const q=Fa(l,a.sort);return y==="all"?q:q.filter(D=>y==="explore"?!!D.noCo:!D.noCo)},[l,a.sort,b,y]),M=f.useMemo(()=>i.pipe?s.filter(q=>ge(q)&&be(q)>=1):S.filter(q=>ge(q)&&!Ee(q)),[i.pipe,s,S]),_=M.length,[j,E]=f.useState(!1),L=f.useMemo(()=>i.pipe?S:S.filter(q=>!Ee(q)&&!q.noCo),[S,i.pipe]),$=b==="ops"?S.filter(q=>q.noCo).length:0,V=i.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,I=a.filters,Z=[];if(I.day)Z.push({k:"day",lib:n.fDay(I.day.slice(8,10)+"/"+I.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(I.win&&I.win!=="all"){const q=["1","7","30"].indexOf(I.win);q>=0&&Z.push({k:"win",lib:n.dates[q],off:()=>r({type:"filters",patch:{win:"all"}})})}const Q=q=>q.length<=2?q.join(", "):`${q.length} ${n.fSelected}`;for(const q of["sector","country","engine"]){const D=I[q];D&&D.length&&Z.push({k:q,lib:Q(D),off:()=>r({type:"clearFacet",facet:q})})}I.search&&Z.push({k:"search",lib:"🔍 "+I.search,off:()=>r({type:"filters",patch:{search:""}})});const te=(q,D,H="",B=!1)=>t.jsxs("button",{type:"button","data-s":q,className:H,"aria-sort":a.sort.key===q?a.sort.dir===1?"ascending":"descending":"none",style:B?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:q}),children:[D,t.jsx("span",{className:"ar",children:a.sort.key===q&&a.sort.dir===1?"▴":"▾"})]},q),G=f.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const q=new Map;S.forEach(B=>{const K=B.engine||"?";q.has(K)||q.set(K,[]),q.get(K).push(B)});const D={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},H=da([...q.keys()],x);return[...q.entries()].sort((B,K)=>{const ae=D[B[0]]??10+H.indexOf(B[0]),ee=D[K[0]]??10+H.indexOf(K[0]);return ae-ee})},[S,i.pipe,a.groupBy,x]),W=i.lockRowsAfter;let J=0;const X=(q,D)=>{let H=a.shown[D]||c;return q.length-H<=4&&(H=q.length),q.slice(0,H).map(ae=>{const ee=W!==null&&J>=W;J++;const se=O(ae),re=se&&se!==ae.decryptHtml?{...ae,decryptHtml:se}:ae,Se=a.dens!=="maxi"&&(a.dens==="deplie"||(h?h==="open":!!se)),xe=g.has(ae.id)?!Se:Se;return a.dens==="maxi"?t.jsx(ml,{o:re,locked:ee},ae.id):t.jsx(cl,{o:re,locked:ee,open:xe,onToggle:()=>k(ae.id)},ae.id)})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:S.length})," ",V]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",Z.map(q=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:D=>{D.stopPropagation(),q.off()},children:[q.lib,t.jsx("i",{children:"×"})]},q.k)),b==="ops"&&S.length>0&&" — "+n.edSplit(S.length-$,$)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([q,D])=>t.jsxs("button",{type:"button","data-d":q,"aria-pressed":a.dens===q||q==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:q}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:D})]},q))}),(i.showFunnel||b==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":h==="open",onClick:()=>{C("open"),v(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":h==="closed",onClick:()=>{C("closed"),v(new Set)},children:n.foldAllLbl}),b==="ops"&&t.jsxs("button",{type:"button","aria-pressed":h===null,onClick:()=>{C(null),v(new Set)},children:["📖 ",n.foldArts]})]}),(i.showFunnel||b==="ops")&&(()=>{var H;const q=[["all",n.doAll],["eval",n.doEval],["explore",n.doExplore]],D=((H=q.find(([B])=>B===y))==null?void 0:H[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":A,onClick:()=>T(B=>!B),children:[D,t.jsx("i",{children:"▾"})]}),A&&t.jsx("div",{className:"dolist",children:q.map(([B,K])=>t.jsx("button",{type:"button","aria-pressed":y===B,onClick:()=>{w(B),T(!1)},children:K},B))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:q=>r({type:"sort",key:q.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([q,D])=>t.jsx("option",{value:q,children:D},q))})]}),i.showChain&&L.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:L.map(q=>q.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(L.length):n.chainAll(L.length)]})]}),_>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(_)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),t.jsxs("div",{className:"sg-c",children:[(j?M:M.slice(0,12)).map(q=>{const D=ge(q);return D?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(Ma(D,x),Pt(D,x)),onClick:()=>{p(q.id),r({type:"popup",id:q.id})},children:[t.jsx("b",{children:q.name}),t.jsxs("i",{children:[D.emoji," ",pa(D,x)]}),t.jsx("em",{children:Pt(D,x)})]},"sg-"+q.id):null}),!j&&M.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>E(!0),children:n.sigStripMore(M.length-12)})]})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),te("country",n.colCountry),te("name",n.colCompany),te("amount",n.colAmount,"h-amt",!0),te("stage",n.colStage,"h-stade"),te("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&te("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(S.length?"":" list-empty"),children:[G?G.map(([q,D])=>t.jsxs(f.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Qe(q)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:$e(q,x)}),t.jsx("div",{className:"s",children:n.grpCount(D.filter(H=>!Ee(H)).length,D.length)})]})]}),X(D,q)]},q)):X(S,"pt"+a.ptab),m.loading&&!u.length&&t.jsx(fl,{}),!S.length&&!(m.loading&&!u.length)&&(i.pipe?t.jsx(hl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),(()=>{const q=G||[["pt"+a.ptab,S]];let D=0,H=0;for(const[K,ae]of q){H+=ae.length;let ee=a.shown[K]||c;ae.length-ee<=4&&(ee=ae.length),D+=Math.min(ae.length,ee)}const B=H-D;return B<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>q.forEach(([K,ae])=>r({type:"more",group:K,by:ae.length,base:c})),children:[t.jsx("span",{className:"more-label",children:n.more(B,B)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(D,H)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}})]})}function Bn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function gl(e,a){const r=wo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function bl(e,a){const n=[a.head.split("|").map(Bn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",gl(i,a.plabels),Gt(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Bn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function vl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const yl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Pe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function wl({o:e,qa:a}){const{t:r,lang:n,fund:i}=F(),o=(e.cribleStatus||"").trim().toUpperCase()||(Gt(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=We(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Pe,{k:r.cdSector,v:e.sector}),t.jsx(Pe,{k:r.cdStage,v:e.stage}),t.jsx(Pe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Pe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Pe,{k:r.cdName,v:e.contactName}),t.jsx(Pe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Pe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Pe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Pe,{k:r.cdAngle,v:e.angle}),t.jsx(Pe,{k:r.cdDetected,v:yl(e.date,n)})]}),p.some(([,x])=>x)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,x])=>x).map(([x,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:x}),t.jsx("p",{children:d})]},x))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function kl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=F(),[s,p]=f.useState({}),x=25,d=f.useMemo(()=>n.slice(0,x),[n]);f.useEffect(()=>{d.length&&ko(r,d.map(b=>b.name)).then(p)},[r,d]);const m=o.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>x&&t.jsx("span",{className:"mnote dim",children:e.dsCap(x,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),m&&typeof m.screened=="number"&&t.jsxs("p",{children:[u(m.screened)," ",e.funScreened(""),typeof m.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(m.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(m.screened/o.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(wl,{o:b,qa:s[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const jl=50;function Ua({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=F(),[o,l]=f.useState(null),[s,p]=f.useState(!1),[x,d]=f.useState(""),[m,u]=f.useState(0),[b,c]=f.useState(""),[g,v]=f.useState(!1),h=f.useRef(null);f.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const C=async y=>{p(!0),d("");const w=await a();if(p(!1),w.ok){l(w);return}if(w.busy){d(i.alertPreviewBusy);return}if(!y){d(i.alertPreviewFail);return}u(jl),h.current=window.setInterval(()=>{u(A=>A>1?A-1:(h.current&&window.clearInterval(h.current),C(!1),0))},1e3)},k=async()=>{if(n||g)return;v(!0),c("");const y=await r();v(!1),c(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||m>0,onClick:()=>{C(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||g,onClick:()=>{k()},children:g?"…":i.alertTest})]}),m>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(m)}),x&&t.jsx("p",{className:"mnote warn",children:x}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ot="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ne({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=F();return ct.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Nl(){const{st:e}=F();switch(e.modal){case"chain":return t.jsx(Cl,{});case"space":return t.jsx(El,{});case"alert":return t.jsx(Al,{});case"queue":return t.jsx(Rl,{});case"export":return t.jsx(Ml,{});case"plug":return t.jsx(Pl,{});case"recharge":return t.jsx(Il,{});case"cover":return t.jsx(Bl,{});case"dossier":return t.jsx($l,{});case"crit":return t.jsx(_l,{});case"tuto":return t.jsx(Ul,{});case"rdv":return t.jsx(Sl,{});case"memoalert":return t.jsx(Ol,{});default:return null}}function Sl(){const{dispatch:e,fund:a}=F(),r=typeof document<"u"&&!!document.getElementById("rdv");return f.useEffect(()=>{r&&(e({type:"modal",modal:null}),bi())},[r,e]),r?null:t.jsx(So,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Cl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s,caps:p,memoQueued:x,doAnalyse:d}=F(),m=o==="client",u=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),b=e.chain.idx,c=u[b],g=b>=u.length;return ct.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:g?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(g?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:g||!c?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:c.name}),t.jsx("div",{className:"sub",children:[dt(c.cc,i)||c.countryLabel,c.sector,c.stage,n.daysAgo(He(c.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:$e(c.engine,i).toUpperCase()}),typeof c.amountEur=="number"&&c.amountEur>0&&t.jsx("span",{children:jt(c.amountEur,i)})]}),ge(c)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(Ze,{o:c,lg:!0})," ",t.jsx(Qt,{o:c,src:!0})]}),(c.tagline||c.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:c.tagline||c.headline})]}),c.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:c.reasoning})]}),m&&Ee(c)&&t.jsxs("div",{className:"vbox",style:{"--c":Ke(c)==="retenu"?"var(--brand)":Ke(c)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ke(c)==="retenu"?"✓ "+n.kept:Ke(c)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:c.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!g&&c&&p.pipe&&be(c)===1&&!x.has(c.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(c),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!g&&c&&!(m&&Ee(c))&&(c.noCo&&c.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:c.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(c)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(g?{type:"modal",modal:null}:{type:"chainNext"}),children:g?n.closeBtn:n.skip})]})]})})}),document.body)}function El(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=F(),o=i==="client",l=f.useMemo(()=>o?r.filter(m=>Ee(m)):[],[r,o]),s=f.useMemo(()=>Fa(l.filter(m=>Ke(m)==="retenu"),{key:"signal",dir:-1}),[l]),p=f.useMemo(()=>l.filter(m=>Ke(m)==="ecarte"),[l]),x=e.spaceTab==="retenu"?s:p,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ne,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),x.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),x.slice(0,40).map(m=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof m.score=="number"&&m.score>0?m.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:m.name}),t.jsx("div",{className:"rr",children:m.reasoning||m.tagline||""})]})]},m.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Al(){const{mode:e}=F();return e==="client"||e==="apercu"?t.jsx(Tl,{}):t.jsx(Ll,{})}function Tl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),[o,l]=f.useState("d"),s=i!=="client";return t.jsxs(Ne,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(zl,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(ql,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(Cr,{})]})}function zl({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=f.useState(null),[s,p]=f.useState(!1),[x,d]=f.useState(0);f.useEffect(()=>{let c=!0;return p(!1),nn(a).then(g=>{c&&(g?l(g):p(!0))}),()=>{c=!1}},[a,x]);const m=c=>{r||nn(a,c).then(g=>{if(!g){i(e.actErr);return}l(g),g.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=c=>!o.sections||o.sections.includes(c),b=c=>{const g=o.sections||e.alertSec.map(([v])=>v);m({sections:u(c)?g.filter(v=>v!==c):[...g,c]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>m({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([c,g])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(c),disabled:r,onChange:()=>b(c)}),t.jsxs("span",{children:[g,c==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},c))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Ua,{label:e.alertPreview,readOnly:r,onPreview:()=>Ro(a),onTest:()=>Lo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function ql({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=f.useState(null),[s,p]=f.useState(!1),[x,d]=f.useState(0);f.useEffect(()=>{let c=!0;return p(!1),rn(a).then(g=>{c&&(g?l(g):p(!0))}),()=>{c=!1}},[a,x]);const m=c=>{r||rn(a,c).then(g=>{if(!g){i(e.actErr);return}l(g),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(c=>c+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,b=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>m({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:c=>m({dow:Number(c.target.value)}),children:e.alertDow.map((c,g)=>t.jsx("option",{value:g,children:c},c))}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>m({hour:Math.min(21,b+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Ua,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>Oo(a),onTest:()=>Mo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Cr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=F(),[l,s]=f.useState(o||""),[p,x]=f.useState(!1),[d,m]=f.useState(!1);f.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,b=f.useMemo(()=>n.filter(h=>ge(h)).length,[n]),c=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,g=async()=>{if(!(!/.+@.+\..+/.test(l)||d)){m(!0);try{await fetch(`${za}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),x(!0)}finally{m(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[c]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(h=>$e(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(h=>dt(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([h,C])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:C}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:h=>s(h.target.value),onKeyDown:h=>{h.key==="Enter"&&g()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void g(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Ll(){const{t:e}=F();return t.jsx(Ne,{title:e.alertTitle,icon:"🔔",children:t.jsx(Cr,{})})}function Rl(){var C,k;const{t:e,token:a,fund:r,mode:n,flash:i}=F(),[o,l]=f.useState(null),[s,p]=f.useState([]),[x,d]=f.useState(0),m=n==="client";f.useEffect(()=>{let y=!0;return(async()=>{const[w,A]=await Promise.all([La(r),Wn(a)]);y&&(w&&l(w),p(A))})(),()=>{y=!1}},[a,r,x]);const u=(o==null?void 0:o.per_day)??0,b=((C=o==null?void 0:o.analyzed_today)==null?void 0:C.length)??0,c=o==null?void 0:o.offre,g=(o==null?void 0:o.pool_meta)||[],v=f.useMemo(()=>{const y=new Map;for(const w of(o==null?void 0:o.scheduled)||[])for(const A of w.names||[])y.has(A)||y.set(A,{label:w.day_label,date:w.date});return y},[o==null?void 0:o.scheduled]),h=(o==null?void 0:o.in_progress)||[];return t.jsxs(Ne,{title:e.queueTitle,wide:!0,children:[c&&t.jsxs("div",{className:"qoffre"+(c.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:c.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:c.delai})]}),t.jsx("span",{className:"osp"}),c.rythme>0?t.jsx("span",{className:"or",children:e.qRate(c.rythme)}):c.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(c.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(b,b+(((k=o==null?void 0:o.pool_order)==null?void 0:k.length)??0))}})}),c&&t.jsxs("div",{className:"qeta",children:[c.file===0?e.qEtaDone:c.rythme<=0?e.qEtaPaused:e.qEta(c.file,c.rythme,c.jours_restants),c.en_retard&&t.jsxs("em",{children:[" ",e.qLate(c.delai,c.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)}),(c==null?void 0:c.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),h.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsx("div",{className:"qrows",children:h.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.name}),t.jsxs("span",{className:"qd",children:[y.memo_type||"",y.age_min?` · ${Math.round(y.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:y.state||""})]},"ip-"+y.name))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),m&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{an(a,y.company,"retry").then(()=>d(w=>w+1))},children:e.queueRetry}),m&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{an(a,y.company,"delete").then(()=>d(w=>w+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(g.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[g.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),g.map((y,w)=>{const A=v.get(y.name);return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",w+1]}),A?t.jsx("span",{className:"qwhen"+(A.label==="demain"?" soon":""),children:A.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:y.name}),y.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score}),y.excerpt&&t.jsx("span",{className:"qex",children:y.excerpt})]},y.name+":"+w)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([y,w])=>t.jsxs("li",{children:[t.jsx("b",{children:y})," — ",w]},y))})]})}function Ml(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=F(),s=`${ot}/cibles/list.csv?token=${a}`,p=`${ot}/cibles/list.json?token=${a}`,x=`${ot}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,m=v=>{var h;(h=navigator.clipboard)==null||h.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:x,href:x}],b=!i.lockActions&&n.length>0,c=()=>{vl(bl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([h])=>h===v)||["",""])[1]})),r(e.exportViewDone(n.length))},g=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ne,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:g,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:c,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:h,href:C})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>m(h),children:e.exportCopy}),C&&t.jsx("a",{className:"exb",href:C,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function Ol(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=F(),o=i!=="client",[l,s]=f.useState(null),[p,x]=f.useState(!1),[d,m]=f.useState(0),[u,b]=f.useState(!1);f.useEffect(()=>{let h=!0;return x(!1),tn(a).then(C=>{h&&(C?s(C):x(!0))}),()=>{h=!1}},[a,d]);const c=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},g=h=>{if(o||!l)return;const C={enabled:h.enabled??!!l.enabled,email:h.email??(l.email||""),sections:h.sections??c()};b(!0),tn(a,C).then(k=>{if(b(!1),!k){n(e.memoAlertErr);return}s(k),r(e.memoAlertSaved)})};if(p)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>m(h=>h+1),children:e.retry})]})});if(!l)return t.jsx(Ne,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=c();return t.jsxs(Ne,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>g({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(Fl,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>g({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,C])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[h],disabled:o||u,onChange:()=>g({sections:{...v,[h]:!v[h]}})}),t.jsx("span",{children:C})]},h))}),t.jsx(Ua,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>No(a,v),onTest:()=>jo(a,v)})]})}function Fl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=f.useState(e);f.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:x=>l(x.target.value),onKeyDown:x=>{x.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function Pl(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=F(),[o,l]=f.useState(null),[s,p]=f.useState(!1),[x,d]=f.useState(null),[m,u]=f.useState(""),[b,c]=f.useState(0);f.useEffect(()=>{let k=!0;return p(!1),ua(a).then(y=>{k&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),Ao(a).then(y=>{k&&d(y)}),()=>{k=!1}},[a,b]);const g=(k,y)=>{i&&ua(a,k).then(w=>{if(!w||w.ok===!1){n(e.actErr);return}k.test&&w.sent===!1?n(e.plugTestThrottled):r(y),c(A=>A+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),C=`curl -X POST ${ot}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Ne,{title:e.plugTitle,icon:"🔌",wide:!0,children:[x&&t.jsx("p",{className:"mnote"+(x.enabled?" warn":""),children:x.enabled?e.plugAutoOn(x.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(k=>k+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:m,disabled:!i,onChange:k=>u(k.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!m.trim(),onClick:()=>g({url:m.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>g({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var k;(k=navigator.clipboard)==null||k.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Dl,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var k;(k=navigator.clipboard)==null||k.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var k;(k=navigator.clipboard)==null||k.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Dl(){const{t:e,token:a,lang:r}=F(),[n,i]=f.useState("valides"),[o,l]=f.useState(!1),[s,p]=f.useState(null),[x,d]=f.useState(null),[m,u]=f.useState(!1),[b,c]=f.useState(!1),[g,v]=f.useState(null),[h,C]=f.useState(null),[k,y]=f.useState(null),w=`atl2:bulk:${a}:${n}`;f.useEffect(()=>{ua(a).then(M=>{C(M&&M.configured?M.url_hint||"webhook":null)})},[a]),f.useEffect(()=>{p(null),d(null),u(!1),v(null);try{const M=JSON.parse(localStorage.getItem(w)||"null");y(M&&Date.now()-Date.parse(M.t)<24*3600*1e3?M:null)}catch{y(null)}},[w]);const A=async()=>{l(!0),u(!1),v(null);const M=await zo(a,n);p(M),d(M.ok?n:null),l(!1)},T=f.useRef(!1),R=async()=>{if(T.current)return;T.current=!0,c(!0);const M=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let _;try{_=await qo(a,n,"webhook",void 0,M)}finally{T.current=!1}if(c(!1),u(!1),v(_),_.ok&&(_.pushed||0)>0){const j={t:new Date().toISOString(),n:_.pushed||0};y(j);try{localStorage.setItem(w,JSON.stringify(j))}catch{}}},z=s!=null&&s.ok&&s.ready||0,O=!!(s!=null&&s.ok)&&x===n&&z>0&&!!h&&!k,S=k?new Date(k.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:M=>i(M.target.value),children:e.plugBulkTabs.map(([M,_])=>t.jsx("option",{value:M,children:_},M))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{A()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),k&&t.jsx("p",{className:"mnote",children:e.bulkLocked(S,k.n)}),!k&&!!(s!=null&&s.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!k&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),O&&!m&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),O&&m&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(z,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:b,onClick:()=>{R()},children:b?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:b,onClick:()=>u(!1),children:e.bulkCancel})]}),g&&(g.ok?g.replayed?t.jsx("p",{className:"mnote",children:g.pending?e.bulkPending:e.bulkReplayed}):(g.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(g.pushed||0,g.linkedinReady||0,g.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:g.error||e.actErr}))]})}function Il(){const{t:e,data:a,lang:r}=F(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const x=await(await fetch(`${za}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();x.url&&(window.location.href=x.url)}catch{}};return t.jsxs(Ne,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function $l(){const{t:e}=F();return t.jsx(Ne,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(kl,{})})}function Bl(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:s}=F(),[p,x]=f.useState(null),[d,m]=f.useState(!1);f.useEffect(()=>{let z=!0;if(o)return La(o).then(O=>{z&&O&&typeof O.per_day=="number"&&x(O.per_day)}),()=>{z=!1}},[o]);const[u,b]=f.useState(null);f.useEffect(()=>{if(!i)return;let z=!0;return Eo(i).then(O=>{z&&b(O)}),()=>{z=!1}},[i]);const c=r.stats,g=typeof(c==null?void 0:c.screened)=="number"?c.screened:n.filter(z=>z.kind==="target"&&Ee(z)).length,v=r.marketEstimate||0,h=v>0?Math.min(100,Math.round(g/v*100)):null,C=(c==null?void 0:c.window_days)||30,k=g>0?g/C:0,y=v>0?Math.max(0,v-g):0,A=v>0&&k>0&&g>=100?Math.round(y/k):null,T=z=>Math.round(z).toLocaleString(a==="en"?"en-US":"fr-FR"),R=z=>{d||!l||(m(!0),To(i,z).then(O=>{if(m(!1),O===null){s(e.actErr);return}x(O),s(e.alertSaved)}))};return t.jsxs(Ne,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(T(g))}),v>0&&t.jsx("span",{children:e.covOf(T(v))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),A!==null&&t.jsx("p",{className:"mnote",children:e.covEta(A)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),k>=1&&t.jsx("p",{className:"mnote",children:e.covPace(T(k))}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsx("table",{children:t.jsxs("tbody",{children:[(u.detail||[]).map((z,O)=>t.jsxs("tr",{className:z.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[z.code,z.geo?` · ${z.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof z.n=="number"?T(z.n):"—"}),t.jsxs("td",{className:"cs",children:[z.source,z.elargi&&t.jsxs("em",{children:[" · ",e.covWide(String(z.demande||""))]}),z.erreur&&t.jsxs("em",{children:[" · ",e.covMissing]})]})]},O)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:T(u.total||v)})}),t.jsx("td",{className:"cs"})]})]})}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),c&&t.jsxs("div",{className:"covf",children:[typeof c.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:T(c.kept)})," ",e.covKept]}),typeof c.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:T(c.analyzed)})," ",e.covAna]}),typeof c.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:T(c.shown)})," ",e.covShown]})]}),l&&p!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(p)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(z=>t.jsx("button",{type:"button",className:p===z?"on":"",disabled:d,onClick:()=>R(z),children:z===0?"⏸":z},z))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function _l(){var h,C,k;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:s}=F(),p=n==="client",x=f.useMemo(()=>{const y=new Set;return a.forEach(w=>{w.angle&&y.add(w.angle)}),[...y]},[a]),[d,m]=f.useState(""),[u,b]=f.useState(""),[c,g]=f.useState(!1),v=async()=>{const y=d.trim();if(!(!y||c||!p)){g(!0),b("");try{const A=await(await fetch(`${ot}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&b(String(A.reply)),A.job_id){b(e.critChatRunning);const T=async()=>{const R=await fetch(`${ot}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(z=>z.json()).catch(()=>null);if(R&&R.done){b(String(R.reply||R.clarification||R.summary||"✓")),g(!1),R.applied&&i(e.alertSaved);return}setTimeout(()=>{T()},8e3)};setTimeout(()=>{T()},8e3),m("");return}m("")}finally{u.startsWith("⏳")||g(!1)}}};return t.jsxs(Ne,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((C=o==null?void 0:o.angles)!=null&&C.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var w,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((w=y.look)!=null&&w.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(T=>t.jsx("li",{children:T},T))})]}),!!((A=y.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(T=>t.jsx("li",{children:T},T))})]})]})]},y.title)})]}),!!((k=o==null?void 0:o.gate)!=null&&k.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),x.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:x.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!p||c,onChange:y=>m(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},disabled:!p||c||!d.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(Co,{fund:l,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,w])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Nr[y]||"v-cons"),children:y}),t.jsx("span",{children:w})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,w])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",w]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function Ul(){const{t:e,dispatch:a,startTour:r}=F(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Ne,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Er="atl2:mapfold",Vl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Er);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},Ar=f.createContext(null),F=()=>{const e=f.useContext(Ar);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function Ze({o:e,lg:a}){const{lang:r}=F(),n=ge(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:pa(n,r),children:[n.emoji," ",pa(n,r)]}):null}function Qt({o:e,src:a}){const{lang:r,t:n}=F(),i=ge(e);if(!i)return null;const o=$o(i),l=Bo(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Ma(i,r))+" · "+n.win7(Pt(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<o?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Tr({o:e}){const{lang:a}=F(),r=Io(e.cc),n=e.cc?dt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const _n="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",Hl=!1,zr=e=>`atl2:tour:${e||"anon"}`;function Wl(e){try{return localStorage.getItem(zr(e))==="1"}catch{return!0}}function Un(e){try{localStorage.setItem(zr(e),"1")}catch{}}function Yl(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function Zl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var Ha;const{lang:l}=Fo(),s=Qo[l],p=li(e,l,a),[x,d]=f.useReducer(di,void 0,()=>ci((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||Vl(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),m=f.useRef(!0);f.useEffect(()=>{if(m.current){m.current=!1;return}if(!e)try{localStorage.setItem(Er,x.mapFolded?"on":"off")}catch{}},[x.mapFolded,e]);const u=f.useRef(o);u.current=o,f.useEffect(()=>{var N;(N=u.current)==null||N.call(u,x.filters)},[x.filters]);const[b,c]=f.useState(null),[g,v]=f.useState(null),[h,C]=f.useState({kept:0,dropped:0}),[k,y]=f.useState(!1),[w,A]=f.useState(""),[T,R]=f.useState(!1),[z,O]=f.useState(null),[S,M]=f.useState(!1),[_,j]=f.useState(!1),[,E]=f.useState(0),L=()=>E(N=>N+1),$=f.useRef([]),V=f.useRef(new Set),I=f.useRef(new Set),Z=f.useRef(new Map),Q=f.useRef(null),{mode:te}=p,G=f.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[p.caps,i,a]),W=G.pipe,J=p.session.token||"",X=te==="client"&&!e;f.useEffect(()=>{if(document.querySelector(`link[href="${_n}"]`))return;const N=document.createElement("link");N.rel="stylesheet",N.href=_n,document.head.appendChild(N)},[]);const oe=(N,U=!1)=>{A(N),R(U),Q.current&&clearTimeout(Q.current),Q.current=setTimeout(()=>A(""),U?4200:2400)},q=N=>oe(N,!0),D=f.useMemo(()=>{const N=new Map;return p.dossiers.forEach(U=>{U.id&&N.set(U.id,U)}),N},[p.dossiers]),H=f.useMemo(()=>p.dossiers.filter(N=>Jn(N,x,W)),[p.dossiers,x,W]),B=f.useRef(!1);f.useEffect(()=>{if(B.current||e||p.loading||!p.dossiers.length)return;if(!G.showFunnel||Wl(p.session.token||"")){B.current=!0;return}B.current=!0;const N=window.setTimeout(()=>{Un(p.session.token||""),M(!0)},700);return()=>window.clearTimeout(N)},[e,p.loading,p.dossiers.length,G.showFunnel,p.session.token]);const K=f.useMemo(()=>p.dossiers.filter(N=>pi(N,x,W,p.favIds)),[p.dossiers,x,W,p.favIds]),ae=f.useMemo(()=>Po(H,p.favIds),[H,p.favIds]),ee=f.useMemo(()=>{const N=tr(p.dossiers);return N?He(N)===0?s.tourToday:ar(N,l):s.tourNoRun},[p.dossiers,s,l]),se=f.useMemo(()=>p.dossiers.some(N=>!!N.memoUrl||!!N.summary||it(N)),[p.dossiers]),[re,Se]=f.useState(!1);f.useEffect(()=>{if(p.loading){Se(!1);return}if(p.dossiers.length>0||p.error){Se(!0);return}const N=window.setTimeout(()=>Se(!0),6e3);return()=>window.clearTimeout(N)},[p.loading,p.dossiers.length,p.error]);const xe=(p.marketEstimate||0)>0||typeof((Ha=p.stats)==null?void 0:Ha.screened)=="number"&&p.stats.screened>0,ye=f.useMemo(()=>[1,0,2,4,5,3].find(N=>(ae[N]||0)>0)??0,[ae]),Me=Ra.find(N=>N.key===x.continent),tt=x.continent==="monde"?s.contWorld:(l==="fr"?Me==null?void 0:Me.fr:Me==null?void 0:Me.en)||"";f.useEffect(()=>{const N=U=>{var fe;const Y=(((fe=U.detail)==null?void 0:fe.name)||"").trim();Y&&Ae(null,Y)};return window.addEventListener("ppmap:evaluate",N),()=>window.removeEventListener("ppmap:evaluate",N)}),f.useEffect(()=>{const N=fe=>{const Oe=String(fe||"").trim();Oe&&d({type:"filters",patch:{sector:[Oe]}})},U=fe=>{var Oe;return N((Oe=fe.detail)==null?void 0:Oe.sector)},Y=fe=>{fe.data&&fe.data.type==="pp-filter"&&N(fe.data.sector)};return window.addEventListener("ppmap:filter",U),window.addEventListener("message",Y),()=>{window.removeEventListener("ppmap:filter",U),window.removeEventListener("message",Y)}},[]);const Ae=(N,U)=>{const Y=((N==null?void 0:N.name)||U||"").trim();if(!X){v({kicker:Y});return}!Y||k||(y(!0),(async()=>{try{let fe=Y;const Oe=((N==null?void 0:N.website)||(N==null?void 0:N.domain)||"").trim();if(Oe)fe=Oe;else try{const he=await _o(Y);if(he!=null&&he.website)fe=he.website;else if(((he==null?void 0:he.candidates)||[]).length===1)fe=he.candidates[0].url;else if(((he==null?void 0:he.candidates)||[]).length>1){$.current=[{name:Y,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(he.candidates||[]).slice(0,5)},...$.current].slice(0,8),L();return}}catch{}const Fe=await Gn(J,fe,"atelier2"),Pr={name:Fe.company||Y,verdict:Fe.verdict,reason:Fe.reason||"",remaining:Fe.remaining??null};$.current=[Pr,...$.current].slice(0,8),Fe.verdict==="kept"&&C(he=>({...he,kept:he.kept+1})),Fe.verdict==="ruled_out"&&C(he=>({...he,dropped:he.dropped+1}));const ut=N||p.dossiers.find(he=>(he.name||"").toLowerCase()===Y.toLowerCase());ut&&(Fe.verdict==="kept"?ut.verdict=ut.verdict||"MATCH":Fe.verdict==="ruled_out"&&(ut.verdict="NO MATCH"),Fe.reason&&(ut.reasoning=Fe.reason)),L()}finally{y(!1)}})())},Be=N=>{if(!X){v({kicker:N.name});return}V.current.add(N.id),mt(J,"fast_request",N.name||"",""),oe(s.memoInstantSent(N.name)),L()},pt=N=>Z.current.get(N.id)??p.thumbs.get((N.name||"").trim().toLowerCase()),Nt=(N,U)=>d({type:"undoPush",entry:{id:N.id,name:N.name,prevCeoStatus:U}}),at=async(N,U,Y)=>{const fe=N.ceoStatus||"";N.ceoStatus=U,L();const Oe=await ea(J,{status:U,airtable_id:N.airtableId,check_id:N.checkId,company:N.name,...(Y==null?void 0:Y.note)!==void 0?{note:Y.note}:{},...Y!=null&&Y.via?{via:Y.via}:{}});return Oe.ok?Oe.skipped?(N.ceoStatus=fe,L(),q(s.actNotPersisted),!1):((Y==null?void 0:Y.undo)!==!1&&Nt(N,fe),Y!=null&&Y.msg&&oe(Y.msg),(U==="Validé"||U==="Écarté")&&!N.ceoNote&&(Y==null?void 0:Y.note)===void 0&&O({o:N,yes:U==="Validé"}),!0):(N.ceoStatus=fe,L(),q(s.actErr),!1)},P=async(N,U)=>{const Y=await ea(J,{status:N.ceoStatus||"Retenu",airtable_id:N.airtableId,check_id:N.checkId,company:N.name,note:U,via:"note"});return!Y.ok||Y.skipped?(q(Y.skipped?s.actNotPersisted:s.actErr),!1):(N.ceoNote=U,L(),!0)},ie=f.useRef(new Map),ce=N=>ie.current.has(N.id)?ie.current.get(N.id):p.stages.get((N.name||"").trim().toLowerCase()),we=(N,U)=>{ie.current.set(N.id,U),L()},Ve=(N,U)=>{X&&at(N,U?"Validé":"Écarté",{msg:U?s.decidedYes(N.name):s.decidedNo(N.name)})},je=N=>{X&&at(N,"À trancher",{msg:s.promoted(N.name)})},pe=N=>{X&&(async()=>{const U=N.ceoStatus||"";N.ceoStatus="Retenu",L();const Y=await ea(J,{status:"Retenu",check_id:N.checkId,company:N.name});if(!Y.ok||Y.skipped){N.ceoStatus=U,L(),q(Y.skipped?s.actNotPersisted:s.actErr);return}Nt(N,U),oe(s.repeched(N.name))})()},Te=()=>{const N=x.undo[x.undo.length-1];if(!N){oe(s.undoNone);return}const U=D.get(N.id);if(!U){d({type:"undoPop"}),oe(s.undoNone);return}let Y=N.prevCeoStatus;if(!Y)if((U.verdict||"").toUpperCase().includes("CALL"))Y="À trancher";else{oe(s.undoLockedTitle);return}(async()=>await at(U,Y,{undo:!1})&&(d({type:"undoPop"}),U.ceoStatus=N.prevCeoStatus,L(),oe(s.undoDone(U.name))))()},Jt=N=>{X&&(I.current.add(N.id),L(),(async()=>{const U=await Uo(J,N.name,"email");if(!U||U.ok===!1){I.current.delete(N.id),L(),q(s.actErr);return}mt(J,"approach",N.name||"",""),oe(s.actApproachSent)})())},St=(N,U)=>{X&&(async()=>{if(!(await mt(J,U?"yes":"no",N.name||"","")).ok){q(s.actErr);return}Z.current.set(N.id,U?"yes":"no"),L(),oe(U?s.thumbUpDone:s.thumbDnDone)})()},qr=N=>{!X||!it(N)||(mt(J,"detailed_request",N.name||"",""),oe(s.memoDeepSent(N.name)))},Lr=N=>{const U=new Set(p.favIds),Y=U.has(N.id);Y?U.delete(N.id):U.add(N.id),p.setFavIds(U),X&&Vo(J,{id:N.id,co:N.name},Y)},Rr=()=>{!X||_||window.confirm(s.identSyncConfirm)&&(j(!0),(async()=>{const N=await Ho(J);j(!1),N?oe(s.identSyncDone):q(s.actErr)})())},Va=/proplace/i.test(p.fund||""),Mr=N=>{!X||!Va||(mt(J,"onboard_request",N.name||"",""),oe(s.onboardSent(N.name)))},Or={st:x,dispatch:d,t:s,lang:l,mode:te,caps:G,pipe:W,token:J,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:pe,thumbOf:pt,canWrite:X,commitStatus:at,saveNote:P,stageOf:ce,setStage:we,flashErr:q,startTour:()=>M(!0),dossiers:p.dossiers,scopedAll:H,scoped:K,counts:ae,byId:D,contName:tt,favIds:p.favIds,toggleFav:Lr,askEvaluate:Ae,doAnalyse:Be,doDecide:Ve,doPromote:je,doApproach:Jt,doThumb:St,doDeep:qr,doUndo:Te,doSync:Rr,doOnboard:Mr,outbound:Va,memoQueued:V.current,approachDone:I.current,sessTally:h,evalCards:$.current,evalBusy:k,markRow:c,markedId:b,flash:oe};f.useEffect(()=>{const N=U=>{U.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",N),()=>window.removeEventListener("keydown",N)},[]);const Fr=N=>J?t.jsx(Ks,{token:J,children:N}):t.jsx(t.Fragment,{children:N});return t.jsx(Ar.Provider,{value:Or,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Zo}),G.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:Zn,children:Pa}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${Dt}`,children:Dt})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),Fr(t.jsxs("div",{className:"app"+(W?" pipe":"")+(J?" has-thesis":""),children:[G.showTicker&&t.jsx(ve,{name:"live",children:t.jsxs("div",{className:"live-stack"+(J?" live-stack--cibles":""),children:[t.jsx(xi,{}),!!J&&t.jsx(Qs,{})]})}),G.showIdent&&t.jsx(ve,{name:"identite",children:t.jsx(Ri,{})}),!!J&&t.jsx(ve,{name:"lead",children:t.jsx(Gs,{})}),!!J&&t.jsx(ve,{name:"brief",children:t.jsx(Js,{})}),Hl,G.showMorning&&t.jsx(ve,{name:"matin",children:t.jsx(Li,{})}),t.jsx(ve,{name:"fraicheur",children:t.jsx(ji,{})}),t.jsx(ve,{name:"mesure",children:t.jsx(Ni,{})}),G.showFunnel&&t.jsx(ve,{name:"entonnoir",children:t.jsx(Gl,{})}),G.showFunnel&&t.jsx(ve,{name:"tunnel",children:t.jsx(Oi,{})}),G.showFunnel&&t.jsx(ve,{name:"tuto",children:t.jsx(Pi,{})}),t.jsx(ve,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Kl,{}),t.jsxs("div",{className:"stage"+(x.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(Ms,{}),t.jsx(Fs,{})]})]})}),G.showDemand&&t.jsx(ve,{name:"evaluation",children:t.jsx(_s,{})}),G.showDemand&&x.memoConsole&&t.jsx(ve,{name:"console",children:t.jsx(Vs,{})}),t.jsx(ve,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(xl,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),x.popupId&&t.jsx(ve,{name:"fiche",children:t.jsx(el,{})}),t.jsx(ve,{name:"modales",children:t.jsx(Nl,{})}),t.jsx(yi,{}),z&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:z.o.name}),t.jsx(Ti,{placeholder:z.yes?s.whyYesPh:s.whyNoPh,onDone:N=>{const U=z.o;O(null),N&&P(U,N).then(Y=>{Y&&oe(s.csNoteSaved)})}})]}),S&&re&&t.jsx(qi,{steps:Yl(s,ee,se,ye,xe),onClose:()=>{M(!1),Un(J)}}),w&&t.jsx("div",{className:"flash on"+(T?" err":""),children:w}),g&&t.jsx(Do,{variant:"acquirer",initialCompany:Vn().co,initialWebsite:Vn().site,onClose:()=>v(null)})]})})}function Gl(){const{t:e}=F(),[a,r]=f.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Kl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=F(),l=f.useMemo(()=>{const s={};return e.forEach(p=>{Oa(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[Wo.map(s=>{const p=Ra.find(d=>d.key===s),x=s==="monde"?o.contWorld:i==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[x,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Vn(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Ql(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Tr as FlagCell,Ze as SigBadge,Qt as SigWin,Zl as default,Ql as fmtShort,F as useV2};
