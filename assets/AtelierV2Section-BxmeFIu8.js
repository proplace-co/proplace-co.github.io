...
.atl2 .bulk .side .hint{white-space:nowrap}`,$s=`
...
`,Hs=Bs+$s+Us;function sn(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Vs(){const e=sn("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ws(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Vs();return r==="0"?"client":r==="1"||sn("embed")==="1"&&sn("chrome")==="1"?"apercu":"client"}const Gs={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Ys=e=>Gs[e];function Ea(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const Ct=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!eo(a)||Ea(a))&&(e.noCo=!0)}return Object.assign(e,{continent:Ni(e.cc)})};function Va(e){const a=new Set,r=[];for(const n of e){const o=(n.name||"").toLowerCase();!o||a.has(o)||(a.add(o),r.push(n))}return r}const Qs=60*60*1e3;function Ks(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Qs?null:a}catch{return null}}function ca(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Js=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function Xs(e,a,r="default"){const n=r!=="default",o=p.useMemo(()=>e||n?{mode:"anon"}:mi(),[e,n]),i=p.useMemo(()=>n?"visiteur":Ws(e,o),[e,o,n]),c=p.useMemo(()=>Ys(i),[i]),s=i!=="visiteur",l=Js(r),[g,d]=p.useState([]),[x,u]=p.useState(""),[b,m]=p.useState(null),[y,w]=p.useState(null),[f,v]=p.useState(null),[j,k]=p.useState(()=>new Map),[E,S]=p.useState(()=>new Map),[C,L]=p.useState(""),[q,I]=p.useState(new Set),[R,$]=p.useState(null),[F,D]=p.useState(!0),[h,A]=p.useState(!1),[U,te]=p.useState(0),[N,O]=p.useState(0),M=p.useRef(0),V=p.useMemo(()=>{var Z;if(i!=="client")return"";try{return((Z=fi())==null?void 0:Z.email)||""}catch{return""}},[i]);p.useEffect(()=>{const Z=++M.current;let ge=!0;const J=()=>ge&&Z===M.current,me=(s&&o.token?o.token:"pub:"+a)+(l?":"+l:""),fe=Ks(me);return fe?(d(fe.objs.map(Ct)),fe.fund&&u(fe.fund),m(fe.marketEstimate??null),w(fe.criteria??null),v(fe.stats??null),L(fe.generatedAt||""),D(!1)):D(!0),(async()=>{try{if(r==="ops"){const he=await Ba(),B=((he==null?void 0:he.recent_ops)||[]).map(G=>{const H=va(G.company_name||G.title?G:{...G,title:(G.headline_fr||G.headline||"").slice(0,120)},a),ee=String(G.rubrique||"").toLowerCase();return H&&(ee==="nominations"||ee==="recrutements")&&(H.engine=ee),H&&!String(G.company_name||"").trim()&&(H.noCo=!0),H}).filter(G=>!!G).map(G=>(eo((G.name||"").trim())||(G.noCo=!0),G));try{const G=hi(),H=await gi(),ee=((H==null?void 0:H.date)||"").slice(0,10),_=G?G.doc:H,ne=xi(_),se=((G==null?void 0:G.day)||(_==null?void 0:_.date)||ee||"").slice(0,10);if(se&&ne.length){const ye=new Set;for(const le of B){if((le.date||"").slice(0,10)!==se)continue;const be=$n(ne,ye,le.name,"");be>=0&&(ye.add(be),le.decryptHtml=ne[be].html)}for(const le of B){if(le.decryptHtml||(le.date||"").slice(0,10)!==se)continue;const be=$n(ne,ye,"",le.headline||le.tagline||le.name);be>=0&&(ye.add(be),le.decryptHtml=ne[be].html)}}if(se){const ye=((_==null?void 0:_.title_fr)||"").trim(),le=((_==null?void 0:_.lead_fr)||"").trim(),be=bi(_),ce=((_==null?void 0:_.url)||"").trim();ye&&(be||ce)&&B.unshift({id:`edito:${se}`,kind:"op",name:ye,cc:null,date:se,engine:"edito",dealKind:"other",headline:ye,tagline:le||ye,decryptHtml:be||void 0,url:ce,noCo:!0})}}catch{}if(!J())return;d(B.map(Ct)),ca(me,{objs:B})}else if(typeof r=="object"){const B=(await Un()||[]).filter(H=>(H.slug||"")===r.research).map(H=>Hn(H,a)).filter(H=>!!H),G=Va(await Vn(B,a));if(!J())return;d(G.map(Ct)),ca(me,{objs:G})}else if(s&&o.token){const he=vi(o.token),B=Ba(),G=yi(o.token),H=wi(o.token),ee=ki(o.token),_=await he;let ne=_?_.targets:[];J()&&_&&(u(_.fund||""),m(_.marketEstimate??null),w(_.criteria??null),v(_.stats??null),L(_.generatedAt||""),d(ne.map(Ct)),D(!1),A(!1));const[se,ye,le,be]=await Promise.all([B,G,H,ee]),ce=((se==null?void 0:se.recent_ops)||[]).map(ve=>va(ve,a)).filter(ve=>!!ve),ze=new Set(ne.map(ve=>ve.id));if(ne=[...ne,...ce.filter(ve=>!ze.has(ve.id)&&(ze.add(ve.id),!0))],!J())return;d(ne.map(Ct));const Ke=new Set;for(const ve of ye){const Se=(ve.id||ve.co||"").toString().trim().toLowerCase();Se&&Ke.add(Se.startsWith("t:")?Se:"t:"+Se)}I(Ke),k(le),S(be),_&&ca(me,{fund:_.fund,marketEstimate:_.marketEstimate,criteria:_.criteria,stats:_.stats,generatedAt:_.generatedAt,objs:ne})}else{const he=ji(),B=Un(),G=Ba(),H=await he;J()&&H.length&&(d(Va(H).map(Ct)),D(!1),A(!1));const[ee,_]=await Promise.all([B,G]),ne=(ee||[]).map(be=>Hn(be,a)).filter(be=>!!be),se=await Vn(ne,a),ye=((_==null?void 0:_.recent_ops)||[]).map(be=>va(be,a)).filter(be=>!!be),le=Va([...H,...se,...ye]);if(!J())return;d(le.map(Ct)),ca(me,{objs:le})}J()&&A(!1)}catch{J()&&!fe&&A(!0)}finally{J()&&D(!1)}})(),()=>{ge=!1}},[s,o.token,a,U,l]),p.useEffect(()=>{if(!c.showCredits||!V){$(null);return}let Z=!0;return(async()=>{try{const ge=await fetch(`${Da}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:V})});if(!ge.ok)return;const J=await ge.json();Z&&J&&J.ok!==!1&&$(J)}catch{}})(),()=>{Z=!1}},[c.showCredits,V,N]);const ae=p.useCallback(Z=>I(new Set(Z)),[]);return{session:o,mode:i,caps:c,fund:x,email:V,marketEstimate:b,generatedAt:C,criteria:y,stats:f,thumbs:j,stages:E,dossiers:g,patchStatuses:(Z,ge)=>{d(J=>{let me=!1;const fe=J.map(he=>{if(!he.checkId)return he;const B=Z.get(he.checkId);return!B||B===(he.ceoStatus||"")||!ge(he.id)?he:(me=!0,{...he,ceoStatus:B})});return me?fe:J})},favIds:q,setFavIds:ae,credits:R,reloadCredits:()=>O(Z=>Z+1),loading:F,error:h,refresh:()=>te(Z=>Z+1)}}function Ge(e){return e?e.engine==="edito"||String(e.id||"").startsWith("edito:"):!1}const ya=new Set(["media","nominations","recrutements","tribunes","listes","evenements","partenariats","produits","regul","marche"]);function Sa(e){return ya.has(e.engine||"")}function We(e){return!!e.noCo||Sa(e)&&!!e.url}const mo=()=>({win:"all",day:"",status:"all",crible:[],signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Zs=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...mo(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,approachId:null,memoTab:0,undo:[],mapFolded:a}),el=new Set(["signal","amount","score","crible","memo"]);function tl(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(o=>o!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:mo(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:el.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??fo)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"approachOpen":return{...e,approachId:a.id,modal:a.id?"approach":null};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const fo=80;function Ca(e,a,r,n){var o;if(n!=="signal"&&a.signalOnly&&(!De(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((o=a.dealKind)!=null&&o.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Nn(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const i=a.win==="1"?0:a.win==="7"?7:30;if(gt(e.date)>i)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&At(e)!==a.status||n!=="crible"&&a.crible.length&&!a.crible.includes(ao(e)))return!1;if(n!=="search"&&a.search.trim()){const i=a.search.trim().toLowerCase();if(![e.name,e.tagline,e.sector,e.acquirer,e.domain,e.website,e.city,e.countryLabel,e.contactName,e.angle].filter(Boolean).join(" ").toLowerCase().includes(i))return!1}return!0}function ta(e,a,r){return Ge(e)?Ca(e,a.filters,r):a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ca(e,a.filters,r)}function al(e,a,r,n){return!(!ta(e,a,r)||r&&!to(e,a.ptab,n))}function zn(e,a){const r=a.key,n=o=>{switch(r){case"name":return(o.name||"").toLowerCase();case"country":return o.countryLabel||o.cc||"";case"stage":return o.stage||"";case"amount":return o.amountEur||-1;case"age":return-gt(o.date);case"score":return typeof o.score=="number"?o.score:-1;case"crible":return Si(o);case"memo":return Ei(o);case"signal":{const i=De(o);return i?100-(i.left??0):-1}}};return[...e].sort((o,i)=>{const c=n(o),s=n(i);return c<s?-a.dir:c>s?a.dir:(o.name||"").localeCompare(i.name||"")})}const Wa={},lr=(Wa==null?void 0:Wa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function dr(){return new Date().toISOString().slice(0,10)}const An=p.createContext(null);function ho(){return p.useContext(An)}function nl(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const i=n.querySelector("strong,b"),c=((i==null?void 0:i.textContent)||"").replace(/\s+/g," ").trim();if(!c||c.length<2||c.length>60)continue;const s=n.cloneNode(!0);s.querySelectorAll("script,style,iframe").forEach(l=>l.remove()),s.querySelectorAll("*").forEach(l=>{const g=l.tagName==="A"?l.getAttribute("href"):null;[...l.attributes].forEach(d=>l.removeAttribute(d.name)),g&&/^https?:\/\//i.test(g)&&(l.setAttribute("href",g),l.setAttribute("target","_blank"),l.setAttribute("rel","nofollow noopener"))}),a.push({t:c.toLowerCase(),html:s.outerHTML})}}catch{}return a}function rl(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="ed">${e}</div>`,"text/html").getElementById("ed");return r?(r.querySelectorAll("script,style,iframe,object,embed,link,meta,form,input,button").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{[...n.attributes].forEach(o=>{const i=o.name.toLowerCase(),c=o.value,s=i==="class"||i==="alt"||i==="width"||i==="height"||i.startsWith("data-"),l=(i==="href"||i==="src")&&/^https?:\/\//i.test(c);!s&&!l&&n.removeAttribute(o.name)}),n.tagName==="A"&&n.getAttribute("href")&&(n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))}),r.innerHTML):e}catch{return e}}function cr(e){if(!e||typeof DOMParser>"u")return e;try{const r=new DOMParser().parseFromString(`<div id="tb">${e}</div>`,"text/html").getElementById("tb");if(!r)return e;r.querySelectorAll("script,style,iframe").forEach(n=>n.remove()),r.querySelectorAll("*").forEach(n=>{const o=n.tagName==="A"?n.getAttribute("href"):null,i=n.getAttribute("class"),c=i==="tb-geo"||i==="tb-these"||i==="tb-sec"?i:"";[...n.attributes].forEach(s=>n.removeAttribute(s.name)),c&&n.setAttribute("class",c),o&&/^https?:\/\//i.test(o)&&(n.setAttribute("href",o),n.setAttribute("target","_blank"),n.setAttribute("rel","nofollow noopener"))});for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=28&&!n.querySelector("a,ul,li,strong")&&!/[.:;!?]$/.test(o)&&o.split(" ").length<=3&&n.setAttribute("class","tb-geo")}for(const n of[...r.querySelectorAll("p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();o&&o.length<=64&&/^[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}]/u.test(o)&&!n.querySelector("a,ul")&&n.setAttribute("class","tb-sec")}for(const n of[...r.querySelectorAll("b,strong")]){const o=(n.textContent||"").replace(/\s+/g," ").trim().toLowerCase();/^[^a-zà-ÿ]*(pour votre th|for your thesis)/.test(o)&&n.setAttribute("class","tb-these")}for(const n of[...r.querySelectorAll("div,section,p")]){const o=(n.textContent||"").replace(/\s+/g," ").trim();if(/^en bref|^in brief/i.test(o)&&n.querySelector("li,p,ul")){n.classList.add("ed-lead");break}}return r.innerHTML}catch{return e}}function pr(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const i=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",c=String(Number(r[3]));return a?`${i} ${c}, ${r[1]}`:`${c==="1"?"1ᵉʳ":c} ${i} ${r[1]}`}function go(){const e=p.useContext(An);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ol({token:e,children:a}){const{dispatch:r,st:n,lang:o}=Q(),[i,c]=p.useState(()=>n.filters.day||dr()),[s,l]=p.useState(null),[g,d]=p.useState(!1),x=p.useCallback(y=>{if(/^\d{4}-\d{2}-\d{2}$/.test(y)){c(y);try{r({type:"filters",patch:{day:y,win:"all"}})}catch{}}},[r]),u=p.useCallback(()=>{c(dr());try{r({type:"filters",patch:{day:"",win:"all"}})}catch{}},[r]);p.useEffect(()=>{const y=w=>{var v;const f=(v=w.detail)==null?void 0:v.day;typeof f=="string"&&x(f)};return window.addEventListener("pp-edition-day",y),()=>window.removeEventListener("pp-edition-day",y)},[x]),p.useEffect(()=>{n.filters.day&&n.filters.day!==i&&c(n.filters.day)},[n.filters.day]),p.useEffect(()=>{if(!e||!i)return;let y=!1;d(!0);const w=new URLSearchParams({token:e,date:i});return fetch(`${lr}/cibles/edition.json?${w}`).then(f=>f.json()).then(f=>{y||l(f)}).catch(()=>{y||l({ok:!1,error:"network"})}).finally(()=>{y||d(!1)}),()=>{y=!0}},[e,i]);const b=p.useMemo(()=>`${lr}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),m=p.useMemo(()=>({token:e,day:i,ed:s,loading:g,pickDay:x,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:b,isEn:o==="en"}),[e,i,s,g,x,u,n.filters.day,b,o]);return t.jsx(An.Provider,{value:m,children:a})}function il(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=go(),[o,i]=p.useState(()=>n||no());return p.useEffect(()=>{n&&i(!0)},[n]),p.useEffect(()=>{const c=s=>{var l;return i(!!((l=s.detail)!=null&&l.open))};return window.addEventListener(ja,c),()=>window.removeEventListener(ja,c)},[]),o?t.jsx("div",{className:"thesis-days",children:t.jsx(Ci,{mode:"local",theme:"dark",month:e.slice(0,7),current:n?e:"",windowDays:0,daysUrl:a,onPick:r})}):null}async function sl(e){try{const a=await fetch("https://proplace.co/actualites/today.json",{cache:"no-store"});if(!a.ok)return null;const r=await a.json(),n=String((r==null?void 0:r.date)||"").slice(0,10);if(!n||e&&n!==e.slice(0,10))return null;const o=String((r==null?void 0:r.html_fr)||(r==null?void 0:r.html_en)||"");return o.trim()?{date:n,title:String((r==null?void 0:r.title_fr)||(r==null?void 0:r.title_en)||""),html:o}:null}catch{return null}}function ur(e){if(!e)return!1;const a=new Date,r=n=>String(n).padStart(2,"0");return e.slice(0,10)===`${a.getFullYear()}-${r(a.getMonth()+1)}-${r(a.getDate())}`}function mr(e){const a=(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(a)?`https://proplace.co/actualites/operations-${a}/`:"https://proplace.co/actualites/"}function ll(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:o,isEn:i}=go(),c=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!c,l=a&&!a.ok,g=p.useRef(null),[d,x]=p.useState("fonds"),[u,b]=p.useState(null),[m,y]=p.useState("idle"),w=p.useRef(!1);p.useEffect(()=>{b(null),y("idle"),w.current=!1,x("fonds")},[e]),p.useEffect(()=>{if(d!=="jour"||w.current)return;w.current=!0;let E=!0;return y("load"),sl(e).then(S=>{E&&(b(S),y("fait"))}),()=>{E=!1}},[d,e]);const f=p.useMemo(()=>rl((u==null?void 0:u.html)||""),[u==null?void 0:u.html]),v=p.useRef(null);p.useEffect(()=>{const E=v.current;if(!E||!f)return;let S=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(S||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{S=!0}},[f]);const j=p.useMemo(()=>cr((a==null?void 0:a.html)||""),[a==null?void 0:a.html]),k=p.useMemo(()=>cr((a==null?void 0:a.acquirers_html)||""),[a==null?void 0:a.acquirers_html]);return p.useEffect(()=>{const E=g.current;if(!E||!j)return;let S=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async C=>{await C.ensureEditoCss(),!(S||!E.isConnected)&&(C.beautifyEditoRows(E),C.mountCardFits(E))}),()=>{S=!0}},[j]),t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:i?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[i?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsxs("div",{className:"thesis-brief__sw",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":d==="fonds",onClick:()=>x("fonds"),children:(i?"Editorial · ":"Édito · ")+((a==null?void 0:a.fund)||(i?"your thesis":"votre thèse"))}),t.jsx("button",{type:"button",role:"tab","aria-selected":d==="jour",onClick:()=>x("jour"),children:i?"Editorial of the day":"Édito du jour"})]}),d==="fonds"&&t.jsx("p",{className:"thesis-brief__hint",children:i?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),d==="fonds"&&r&&!c&&t.jsx("p",{className:"thesis-brief__loading",children:i?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d==="fonds"&&l&&t.jsxs("p",{className:"thesis-brief__err",children:[i?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),d==="fonds"&&s&&!r&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"thesis-brief__empty",children:i?ur(e)?t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found ",t.jsx("b",{children:"today"}),"."]}):t.jsxs(t.Fragment,{children:["No operation relevant to your thesis was found on ",t.jsx("b",{children:pr(e,!0)}),"."]}):ur(e)?t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée ",t.jsx("b",{children:"aujourd’hui"}),"."]}):t.jsxs(t.Fragment,{children:["Aucune opération pertinente pour votre thèse n’a été relevée le ",t.jsx("b",{children:pr(e)}),"."]})}),t.jsx("button",{type:"button",className:"thesis-brief__all",onClick:()=>x("jour"),children:i?"See all of the day’s operations →":"Voir toutes les opérations du jour →"})]}),d==="fonds"&&c&&j?t.jsx("div",{ref:g,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:j}}):null,d==="fonds"&&c&&k?t.jsx("div",{className:"thesis-brief__acq zoom-body",dangerouslySetInnerHTML:{__html:k}}):null,d==="jour"&&(f?t.jsxs(t.Fragment,{children:[(u==null?void 0:u.title)&&t.jsx("h3",{className:"thesis-brief__title",style:{margin:"0 0 10px"},children:u.title}),t.jsx("div",{ref:v,className:"thesis-brief__body zoom-body ppart",dangerouslySetInnerHTML:{__html:f}})]}):t.jsx("p",{className:m==="fait"?"thesis-brief__empty":"thesis-brief__loading",children:m!=="fait"?i?"Loading the daily editorial…":"Chargement de l’édito du jour…":i?t.jsxs(t.Fragment,{children:["No shared editorial for this day. ",t.jsx("a",{className:"thesis-brief__all",href:mr(e),target:"_blank",rel:"noopener noreferrer",children:"Open the day’s page →"})]}):t.jsxs(t.Fragment,{children:["Pas d’édito partagé pour ce jour. ",t.jsx("a",{className:"thesis-brief__all",href:mr(e),target:"_blank",rel:"noopener noreferrer",children:"Ouvrir la page du jour →"})]})})),o&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:i?"← See all":"← Voir tout"})]})}const dl=300,pa=7,cl={fr:{ma:"🤝 M&A",levees:"🚀 Levées de fonds",nominations:"👤 Nominations",recrutements:"💼 Offres d'emploi",actualites:"📰 Autres actualités"},en:{ma:"🤝 M&A",levees:"🚀 Fundraising",nominations:"👤 Appointments",recrutements:"💼 Job offers",actualites:"📰 Other news"}},xo={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},pl=["hiring","raised","news","posting","building","community","registry","exodus","other"];function Ga(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=(e.engine||"").toLowerCase();if(r==="nominations")return"nominations";if(r==="recrutements")return"recrutements";if(Ti(r)&&r!=="media")return"news:"+r;const n=De(e);return n?"sig:"+(n.theme&&xo.fr[n.theme]?n.theme:"other"):"actualites"}function ul(){const{dossiers:e,st:a,t:r,dispatch:n,contName:o,pipe:i,lang:c,fund:s}=Q(),l=ho(),g=c==="en",[d,x]=p.useState("all"),[u,b]=p.useState(!1),m=p.useMemo(()=>{var ge;const h=(a.filters.day||"").slice(0,10),A=J=>!(!i&&a.continent!=="monde"&&J.continent!==a.continent||h&&(J.date||"").slice(0,10)!==h),U=e.filter(J=>A(J)&&De(J)&&(!i||J.kind!=="target"||Ee(J)!==5)),te=i&&(((ge=l==null?void 0:l.ed)==null?void 0:ge.ops)||[]).length?l.ed.ops.map(J=>va(J,c)).filter(J=>!!J).map(J=>(J.briefOnly=!0,J)).filter(J=>!h||(J.date||"").slice(0,10)===h):[],N=e.filter(J=>A(J)&&J.kind==="op"&&(h?!0:gt(J.date)<=pa)),O=i?te.length?te:N.filter(J=>{const me=(s||"").trim().toLowerCase();if(!me)return!1;const fe=J.match||null;return fe?Object.keys(fe).map(he=>he.trim().toLowerCase()).includes(me):!1}):N,M=h||new Date().toISOString().slice(0,10),V=J=>{const me=Ga(J);return me==="ma"?0:me==="levees"?1:2};O.sort((J,me)=>{const fe=V(J)-V(me);if(fe)return fe;const he=(J.date||"").slice(0,10)===M?0:1,B=(me.date||"").slice(0,10)===M?0:1;return he!==B?he-B:(me.amountEur||0)-(J.amountEur||0)});const ae=new Set,Z=[];for(const J of[...O,...zn(U,{key:"signal",dir:-1})]){const me=J.id||J.name;!me||ae.has(me)||(ae.add(me),Z.push(J))}return i&&Z.length===0?e.filter(me=>A(me)&&gt(me.date)<=pa).sort((me,fe)=>(fe.date||"").localeCompare(me.date||"")).slice(0,80):Z},[e,a.continent,a.filters.day,i,s,c,l]),y=p.useMemo(()=>{const h={};for(const A of m){const U=Ga(A);h[U]=(h[U]||0)+1}return h},[m]),w=p.useMemo(()=>d==="all"?m:m.filter(h=>Ga(h)===d),[m,d]),f=p.useMemo(()=>w.slice(0,dl),[w]),v=w.length-f.length,j=p.useRef(null);p.useEffect(()=>{var O,M;const h=j.current;if(!h)return;const A=()=>{const V=h.scrollWidth;V<200||(h.style.animationDuration=Math.max(18,Math.round(V/130))+"s")};A();const U=requestAnimationFrame(A),te=window.setTimeout(A,1200);let N=!0;return(M=(O=document.fonts)==null?void 0:O.ready)==null||M.then(()=>{N&&A()}),()=>{N=!1,cancelAnimationFrame(U),window.clearTimeout(te)}},[f.length,d]);const k=h=>h==="all"?m.length:y[h]||0,E=h=>{if(h==="all")return g?"All":"Tout";if(h.startsWith("sig:"))return xo[g?"en":"fr"][h.slice(4)]||"🔔";if(h.startsWith("news:")){const A=h.slice(5);return Ai[A]?qi(A,g?"en":"fr"):h}return cl[g?"en":"fr"][h]},S=[{k:"all"}],C=["ma","levees"].filter(h=>k(h)>0||h===d);if(C.length){S.push({g:g?"Deals":"Opérations"});for(const h of C)S.push({k:h})}const L=["nominations","recrutements"].filter(h=>k(h)>0||h===d),q=zi.filter(h=>h!=="media").map(h=>"news:"+h).filter(h=>k(h)>0||h===d),I=k("actualites")>0||d==="actualites"?["actualites"]:[];if(L.length||q.length||I.length){S.push({g:g?"News":"Actualités"});for(const h of L)S.push({k:h});for(const h of q)S.push({k:h});for(const h of I)S.push({k:h})}const R=pl.map(h=>"sig:"+h).filter(h=>k(h)>0||h===d);if(R.length){S.push({g:g?"Signals (your engines)":"Signaux (vos moteurs)"});for(const h of R)S.push({k:h})}const $=h=>{try{return new Date(h+"T12:00:00Z").toLocaleDateString(g?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return h}},F=(()=>{const h=(a.filters.day||"").slice(0,10),A=!i&&a.continent!=="monde"&&o?g?` Scope: ${o}.`:` Périmètre : ${o}.`:"";return h?(g?`LIVE covers the events of ${$(h)}.`:`Le LIVE regroupe les événements du ${$(h)}.`)+A:(g?`LIVE covers the still-open signals and the deals of the last ${pa} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${pa} derniers jours.`)+A})(),D=h=>f.map(A=>t.jsxs("button",{type:"button",className:"tk"+(_e(A)?" spent":""),onClick:U=>{const te=A.briefOnly===!0;try{window.dispatchEvent(new CustomEvent("ppmap:focus",{detail:{id:te?"":A.id,name:A.name,url:A.url||"",text:A.tagline||A.headline||"",card:A.card}}))}catch{}if(te||n({type:"focus",id:A.id}),a.dens!=="liste"){const N=U.currentTarget.getBoundingClientRect();n({type:"popup",id:A.id,anchor:{x:N.left+N.width/2,y:N.bottom}})}},title:A.name+(A.tagline?" — "+A.tagline:""),children:[t.jsx(wt,{o:A}),t.jsxs("span",{className:"who",children:[t.jsx(ei,{o:A}),t.jsx("span",{className:"co",children:A.name})]}),typeof A.amountEur=="number"&&A.amountEur>0&&t.jsx("span",{className:"am",children:Jc(A.amountEur)}),A.sector&&t.jsx("span",{className:"mt",children:A.sector}),t.jsx(Ia,{o:A}),t.jsx("span",{className:"tkgo",children:"→"})]},h+(A.id||A.name))).concat(v>0?[t.jsx("span",{className:"tk quiet",children:g?`+ ${v} more — filter by section to see them`:`+ ${v} autres — filtrez par rubrique pour les voir`},h+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:h=>{h.currentTarget.contains(h.relatedTarget)||b(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":u,onClick:()=>b(h=>!h),children:[E(d),t.jsx("b",{children:k(d)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!u,children:[t.jsx("span",{className:"tkfilscope",children:F}),S.map(h=>"g"in h?t.jsx("span",{className:"tkfilg",children:h.g},h.g):t.jsxs("button",{type:"button","aria-pressed":h.k===d,onClick:()=>{x(h.k),b(!1)},children:[E(h.k),t.jsx("b",{children:k(h.k)})]},h.k))]})]}),t.jsx("div",{className:"win",children:f.length?t.jsxs("div",{className:"run",ref:j,children:[D(0),D(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(o)})})}),!!l&&t.jsxs("button",{type:"button",className:"tk-edito",title:g?"Show today's editorial":"Afficher Edito du jour",onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:edito"))}catch{}},children:["📖 ",g?"Today's editorial":"Edito du jour"]}),!!l&&t.jsx(fl,{isEn:g})]})}const ml=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function fl({isEn:e}){const[a,r]=p.useState(()=>no());p.useEffect(()=>{const o=i=>{var c;return r(!!((c=i.detail)!=null&&c.open))};return window.addEventListener(ja,o),()=>window.removeEventListener(ja,o)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Li(!a),children:ml})}const qn="+33 6 83 10 72 86",za="alexandre@proplace.co",bo=`tel:${qn.replace(/[^\d+]/g,"")}`;function hl(){return null}class ot extends p.Component{constructor(){super(...arguments);Pn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const vo=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function fr(e,a){if((kt(e)||"").startsWith("CALL")&&Ee(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ee(e)>=2;return vo.filter(([o])=>!(n&&o==="Retenu")).map(([o,i])=>[o,a[i]])}const hr=e=>e==="Retenu"?"ret":e==="Analysé"?"ana":e==="À trancher"?"tra":e==="Validé"?"val":e==="Écarté"?"eca":"off",gl={ret:"#12A150",ana:"#3B82F6",tra:"#F59E0B",val:"#0E8A4F",eca:"#EF4444",off:"#94A3B8"};function xl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o,doAnalyse:i,memoQueued:c}=Q(),[s,l]=p.useState(""),[g,d]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null);if(p.useEffect(()=>{if(!x)return;const v=j=>{b.current&&!b.current.contains(j.target)&&(u(!1),d(!1))};return document.addEventListener("click",v,!0),()=>document.removeEventListener("click",v,!0)},[x]),!r.pipe||!n||r.lockActions||e.kind==="op")return null;const m=(e.ceoStatus||"").trim(),y=async v=>{if(s)return;if(v==="Analysé"&&!e.memoUrl){d(!0);return}l(v);const j=(fr(e,a).find(([E])=>E===v)||[v,v])[1],k=await o(e,v,{msg:a.csMoved(e.name,j)});l(""),k&&(d(!1),u(!1))},w=fr(e,a),f=v=>(w.find(([j])=>j===v)||[])[1]||v;return w.length===2?t.jsx("span",{className:"rstat rst2",onClick:v=>v.stopPropagation(),children:w.map(([v,j])=>t.jsx("button",{type:"button",className:"rsd "+(v==="Validé"?"yes":"no")+(s===v?" busy":""),disabled:!!s,onClick:()=>{y(v)},children:j},v))}):t.jsxs("span",{className:"rstat"+(x||g?" rs-open":""),ref:b,onClick:v=>v.stopPropagation(),children:[t.jsx("button",{type:"button","aria-expanded":x,disabled:!!s,title:a.csLabel,className:"rsel rs-"+hr(m),onClick:()=>{u(v=>!v),d(!1)},children:s?f(s)+"…":m?f(m):a.csNone}),x&&!g&&t.jsx("span",{className:"rsmenu",role:"listbox",children:w.map(([v,j])=>t.jsxs("button",{type:"button",role:"option","aria-selected":m===v,className:"rsopt"+(m===v?" on":"")+(s===v?" busy":""),disabled:!!s,onClick:()=>{if(v===m){u(!1);return}y(v)},children:[t.jsx("i",{className:"pt2",style:{background:gl[hr(v)]}}),j]},v))}),g&&t.jsx("span",{className:"rstm",children:t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:c.has(e.id),onClick:()=>{i(e),d(!1),u(!1)},children:c.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{l("Analysé");const v=await o(e,"Analysé");l(""),v&&(d(!1),u(!1))})()},children:a.csAnaAnyway})]})})]})}function bl({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:o}=Q(),[i,c]=p.useState(""),[s,l]=p.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),d=(kt(e)||"").startsWith("CALL")&&Ee(e)===3,x=Ee(e)>=2,u=async m=>{if(i||m==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;c(m);const y=await o(e,m);c(""),y&&(l(!0),setTimeout(()=>l(!1),2200))},b=d?[["Validé",a.csYes],["Écarté",a.csNo]]:vo.filter(([m])=>!(x&&m==="Retenu")).map(([m,y])=>[m,a[y]]);return t.jsxs("div",{className:"csp",onClick:m=>m.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),b.map(([m,y])=>t.jsx("button",{type:"button",className:"csb"+(g===m?" on":"")+(i===m?" busy":""),disabled:!!i,onClick:()=>{u(m)},children:y},m)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(vl,{o:e})]})}function vl({o:e}){const{t:a,saveNote:r,flash:n}=Q(),[o,i]=p.useState(e.ceoNote||""),[c,s]=p.useState(!1),[l,g]=p.useState(!1),d=o.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(c||!d)return;s(!0);const u=await r(e,o.trim());s(!1),u&&(g(!0),setTimeout(()=>g(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:o,disabled:c,onChange:u=>i(u.target.value),onKeyDown:u=>{u.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:c||!d,onClick:()=>{x()},children:l?a.csNoteSaved:a.csNoteOk})]})}function yl({placeholder:e,onDone:a}){const{t:r}=Q(),[n,o]=p.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:i=>o(i.target.value),onKeyDown:i=>{i.key==="Enter"&&a(n.trim()),i.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function wl({o:e}){var w;const{t:a,token:r,caps:n,canWrite:o,stageOf:i,setStage:c,flashErr:s}=Q(),[l,g]=p.useState(!1);if(!n.pipe||!o||n.lockActions||Ee(e)!==4)return null;const d=i(e),x=(d==null?void 0:d.stage)||"todo",u=async f=>{if(l||f===x)return;g(!0);const v=d;c(e,{stage:f,stamps:(d==null?void 0:d.stamps)||{}});const j=Math.max(Date.now(),gr+=1);gr=j;const k=await Fi(r,{company:e.name||"",stage:f,cts:j,deal_id:e.airtableId,check_id:e.checkId});g(!1),!k.stale&&(k.ok||(c(e,v),s(a.actErr)))},b=(w=d==null?void 0:d.stamps)==null?void 0:w.sent,m=b?Math.floor((Date.now()-Date.parse(b))/864e5):0,y=x==="sent"&&b&&m>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,v])=>t.jsx("button",{type:"button",className:"stgb"+(x===f?" on":""),disabled:l,onClick:()=>{u(f)},children:v},f)),y&&t.jsx("span",{className:"stgj4",children:a.j4Badge(m)})]})}let gr=0;const Gt=8,yt=360;function xr({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function br({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,o)=>t.jsx("p",{children:t.jsx(xr,{text:n})},"p"+o)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,o)=>t.jsx("li",{children:t.jsx(xr,{text:n.replace(/^·\s*/,"")})},"l"+o))})]})}function kl({steps:e,onClose:a}){const{t:r,dispatch:n,counts:o,st:i}=Q(),[c,s]=p.useState(0),[l,g]=p.useState(null),[d,x]=p.useState([]),u=p.useRef(!1),b=p.useRef({ptab:i.ptab,dens:i.dens,modal:i.modal}),m=p.useRef(!1);p.useEffect(()=>{const C=b.current;return()=>{m.current||(n({type:"ptab",tab:C.ptab}),n({type:"dens",dens:C.dens}),n({type:"modal",modal:C.modal}))}},[]),p.useEffect(()=>{u.current||(u.current=!0,x(e.filter(C=>!!document.querySelector(C.need||C.sel))))},[e]);const y=d[c],w=c>=d.length;p.useEffect(()=>{if(y&&(y.ptab!==void 0&&i.ptab!==y.ptab&&n({type:"ptab",tab:y.ptab}),y.dens&&i.dens!==y.dens&&n({type:"dens",dens:y.dens}),i.modal!==(y.modal??null)&&n({type:"modal",modal:y.modal??null}),y.click)){const C=y.click,L=window.setTimeout(()=>{const q=document.querySelector(C);q&&q.getAttribute("aria-selected")!=="true"&&q.click()},60);return()=>window.clearTimeout(L)}},[c,y]);const f=p.useRef(-1),v=p.useCallback(()=>{if(!y){g(null);return}const C=I=>{if(!I)return null;for(const R of document.querySelectorAll(I)){const $=R.getBoundingClientRect();if($.width>1&&$.height>1)return R}return null},L=C(y.sel)||C(y.need);if(!L){g(null);return}f.current!==c&&(f.current=c,L.scrollIntoView({block:"nearest",behavior:"smooth"}));const q=L.getBoundingClientRect();g(I=>I&&Math.abs(I.top-q.top)<1&&Math.abs(I.left-q.left)<1&&Math.abs(I.width-q.width)<1&&Math.abs(I.height-q.height)<1?I:q)},[y,c]);p.useLayoutEffect(()=>{v();const C=[90,300,700,1300].map(I=>window.setTimeout(v,I)),L=window.setInterval(v,400),q=()=>v();return window.addEventListener("scroll",q,!0),window.addEventListener("resize",q),()=>{C.forEach(I=>window.clearTimeout(I)),window.clearInterval(L),window.removeEventListener("scroll",q,!0),window.removeEventListener("resize",q)}},[v]);const j=p.useRef(a);if(j.current=a,p.useEffect(()=>{const C=L=>{L.key==="Escape"?(L.preventDefault(),L.stopPropagation(),j.current()):L.key==="ArrowRight"?s(q=>q+1):L.key==="ArrowLeft"&&s(q=>Math.max(0,q-1))};return document.addEventListener("keydown",C,!0),()=>document.removeEventListener("keydown",C,!0)},[]),!d.length)return null;let k=null;const E=C=>()=>{m.current=!0,n({type:"modal",modal:null}),C()};if(w){const C=o[3]||0;C>0?k={title:C===1?r.ahaATitle1:r.ahaATitleN(C),body:r.ahaABody,btn:r.ahaABtn,go:E(()=>{n({type:"ptab",tab:3}),a()})}:(o[1]||0)>0?k={title:r.ahaRetTitle(o[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:E(()=>{n({type:"ptab",tab:1}),a()})}:(o[0]||0)>0?k={title:r.ahaEvalTitle(o[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:E(()=>{n({type:"ptab",tab:0}),a()})}:k={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:E(()=>{n({type:"modal",modal:"crit"}),a()})}}let S={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:yt};if(!w&&l){const C=l.bottom+14,L=window.innerHeight-C;let q=L>190?C:Math.max(12,l.top-200),I=Math.min(Math.max(12,l.left+l.width/2-yt/2),window.innerWidth-yt-12);L<=190&&l.top<212&&(window.innerWidth-l.right>=yt+40?I=Math.min(l.right+26,window.innerWidth-yt-12):l.left>=yt+40&&(I=Math.max(12,l.left-yt-26)),q=Math.max(12,l.top-Gt)),S={left:I,top:q,width:yt}}return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!w&&l&&t.jsx("div",{className:"tour-hole",style:{left:l.left-Gt,top:l.top-Gt,width:l.width+Gt*2,height:l.height+Gt*2}}),(w||!l)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(w?" fin":""),style:S,children:[w&&k?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:k.title}),t.jsx(br,{text:k.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(d.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:k.go,children:k.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(c+1,d.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(c+1)/d.length*100+"%"}})})]}),t.jsx("h3",{children:y==null?void 0:y.title}),t.jsx(br,{text:(y==null?void 0:y.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:c===0,onClick:()=>s(C=>Math.max(0,C-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(C=>C+1),children:c===d.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function yo(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function wo(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function jl(){var L,q;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:o,st:i,lang:c,data:s,dispatch:l}=Q(),g=r?a:e,d=p.useMemo(()=>g.filter(I=>gt(I.date)===0&&I.kind==="target"),[g]),x=p.useMemo(()=>r?a.filter(I=>I.kind==="target"&&Ee(I)===0).slice().sort((I,R)=>(R.date||"").localeCompare(I.date||"")):[],[a,r]),u=p.useMemo(()=>d.filter(I=>r?Ee(I)===0:!_e(I)),[d,r]),b=r?x:u,m=r?a.length-x.length:d.length-u.length,y=r?a.length:d.length,w=y?Math.min(100,m/y*100):100,f=p.useMemo(()=>yo(g),[g]),v=!!f&&gt(f)>0,j=p.useMemo(()=>v?g.filter(I=>(I.date||"").slice(0,10)===f):[],[g,f,v]),k=typeof((L=s.stats)==null?void 0:L.kept_today)=="number"?s.stats.kept_today:null,E=typeof((q=s.stats)==null?void 0:q.screened_today)=="number"?s.stats.screened_today:d.length;let S;v?S=o.morningLast(j.length,x.length,wo(f,c)):r?S=o.morningThesis(E,x.length,k):d.length?m===0?S=o.goalSourced(d.length):m>=d.length?S=o.goalCleared:S=o.goalDone(m,d.length):S=o.goalSourced(0);const C=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&x.length&&l({type:"chainStart",queue:x.map(I=>I.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?o.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:S}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:w+"%"}})}),b.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:C,children:r?o.morningEval(b.length):i.pileMode?o.goalContinue(b.length):o.goalTreat}),t.jsx("span",{className:"gspace"})]})}function Nl(){var U,te;const{t:e,lang:a,st:r,dispatch:n,token:o,fund:i,data:c,dossiers:s,mode:l,doSync:g,startTour:d,flash:x,flashErr:u}=Q(),[b,m]=p.useState(null),[y,w]=p.useState(!0),[f,v]=p.useState([]),j=l==="client";p.useEffect(()=>{if(!o||!i)return;let N=!0;return w(!0),(async()=>{const[O,M]=await Promise.all([En(i),ro(o)]);N&&(O&&m(O),w(!1),v(M))})(),()=>{N=!1}},[o,i]);const[k,E]=p.useState(!1),S=()=>{!j||k||!i||(E(!0),Ri(i).then(N=>{E(!1),N?x(e.identRepubDone):u(e.actErr)}))},C=(b==null?void 0:b.per_day)??null,L=((U=b==null?void 0:b.pool_order)==null?void 0:U.length)??0,q=f.filter(N=>N.status==="running").length,I=p.useMemo(()=>s.filter(N=>N.kind==="target"&&_e(N)).length,[s]),R=c.marketEstimate,$=typeof((te=c.stats)==null?void 0:te.screened)=="number"?c.stats.screened:I,F=R&&R>0?Math.min(100,Math.round($/R*100)):null,D=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),h=(i||"P").split(/\s+/).map(N=>N[0]).join("").slice(0,2).toUpperCase(),A=(()=>{const N=Date.parse(c.generatedAt||"");if(Number.isNaN(N))return"";const O=new Date(N),M=V=>String(V).padStart(2,"0");return`${M(O.getDate())}/${M(O.getMonth()+1)} à ${M(O.getHours())}:${M(O.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:i?h:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:i||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:i?e.identTitle(i):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),A?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(A)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:d,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[F===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:D($)})})]}),F!==null&&R&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:F+"%"}})}),t.jsxs("b",{children:[F," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,R)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),C!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:C})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),C===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),q>0&&t.jsxs("span",{className:"ev",children:["⏳ ",q]}),t.jsx("span",{className:"ego",children:y?e.identPendingWait:e.identPending(L)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:N=>{N.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!j||k,onClick:S,children:k?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!j,onClick:g,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:N=>n({type:"filters",patch:{search:N.target.value}})})]})]})]})}class Tt{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let o=0;o<this._n&&o<32;o++){const i=r[o],c=a+i,s=Math.abs(a)<Math.abs(i)?a-(c-i):i-(c-a);s&&(r[n++]=s),a=c}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,o,i,c=0;if(r>0){for(c=a[--r];r>0&&(n=c,o=a[--r],c=n+o,i=o-(c-n),!i););r>0&&(i<0&&a[r-1]<0||i>0&&a[r-1]>0)&&(o=i*2,n=c+o,o==n-c&&(c=n))}return c}}function*El(e){for(const a of e)yield*a}function ko(e){return Array.from(El(e))}var Ne=1e-6,xe=Math.PI,tt=xe/2,vr=xe/4,nt=xe*2,mt=180/xe,Ye=xe/180,Ce=Math.abs,Sl=Math.atan,aa=Math.atan2,Le=Math.cos,Fe=Math.sin,Cl=Math.sign||function(e){return e>0?1:e<0?-1:0},Ft=Math.sqrt;function zl(e){return e>1?0:e<-1?xe:Math.acos(e)}function na(e){return e>1?tt:e<-1?-tt:Math.asin(e)}function at(){}function Aa(e,a){e&&wr.hasOwnProperty(e.type)&&wr[e.type](e,a)}var yr={Feature:function(e,a){Aa(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,o=r.length;++n<o;)Aa(r[n].geometry,a)}},wr={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){ln(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)ln(r[n],a,0)},Polygon:function(e,a){kr(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,o=r.length;++n<o;)kr(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,o=r.length;++n<o;)Aa(r[n],a)}};function ln(e,a,r){var n=-1,o=e.length-r,i;for(a.lineStart();++n<o;)i=e[n],a.point(i[0],i[1],i[2]);a.lineEnd()}function kr(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)ln(e[r],a,1);a.polygonEnd()}function Mt(e,a){e&&yr.hasOwnProperty(e.type)?yr[e.type](e,a):Aa(e,a)}function dn(e){return[aa(e[1],e[0]),na(e[2])]}function Pt(e){var a=e[0],r=e[1],n=Le(r);return[n*Le(a),n*Fe(a),Fe(r)]}function ua(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function qa(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Ya(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function ma(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function cn(e){var a=Ft(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function pn(e,a){function r(n,o){return n=e(n,o),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,o){return n=a.invert(n,o),n&&e.invert(n[0],n[1])}),r}function un(e,a){return Ce(e)>xe&&(e-=Math.round(e/nt)*nt),[e,a]}un.invert=un;function Al(e,a,r){return(e%=nt)?a||r?pn(Nr(e),Er(a,r)):Nr(e):a||r?Er(a,r):un}function jr(e){return function(a,r){return a+=e,Ce(a)>xe&&(a-=Math.round(a/nt)*nt),[a,r]}}function Nr(e){var a=jr(e);return a.invert=jr(-e),a}function Er(e,a){var r=Le(e),n=Fe(e),o=Le(a),i=Fe(a);function c(s,l){var g=Le(l),d=Le(s)*g,x=Fe(s)*g,u=Fe(l),b=u*r+d*n;return[aa(x*o-b*i,d*r-u*n),na(b*o+x*i)]}return c.invert=function(s,l){var g=Le(l),d=Le(s)*g,x=Fe(s)*g,u=Fe(l),b=u*o-x*i;return[aa(x*o+u*i,d*r+b*n),na(b*r-d*n)]},c}function ql(e,a,r,n,o,i){if(r){var c=Le(a),s=Fe(a),l=n*r;o==null?(o=a+n*nt,i=a-l/2):(o=Sr(c,o),i=Sr(c,i),(n>0?o<i:o>i)&&(o+=n*nt));for(var g,d=o;n>0?d>i:d<i;d-=l)g=dn([c,-s*Le(d),-s*Fe(d)]),e.point(g[0],g[1])}}function Sr(e,a){a=Pt(a),a[0]-=e,cn(a);var r=zl(-a[1]);return((-a[2]<0?-r:r)+nt-Ne)%nt}function jo(){var e=[],a;return{point:function(r,n,o){a.push([r,n,o])},lineStart:function(){e.push(a=[])},lineEnd:at,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function wa(e,a){return Ce(e[0]-a[0])<Ne&&Ce(e[1]-a[1])<Ne}function fa(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function No(e,a,r,n,o){var i=[],c=[],s,l;if(e.forEach(function(m){if(!((y=m.length-1)<=0)){var y,w=m[0],f=m[y],v;if(wa(w,f)){if(!w[2]&&!f[2]){for(o.lineStart(),s=0;s<y;++s)o.point((w=m[s])[0],w[1]);o.lineEnd();return}f[0]+=2*Ne}i.push(v=new fa(w,m,null,!0)),c.push(v.o=new fa(w,null,v,!1)),i.push(v=new fa(f,m,null,!1)),c.push(v.o=new fa(f,null,v,!0))}}),!!i.length){for(c.sort(a),Cr(i),Cr(c),s=0,l=c.length;s<l;++s)c[s].e=r=!r;for(var g=i[0],d,x;;){for(var u=g,b=!0;u.v;)if((u=u.n)===g)return;d=u.z,o.lineStart();do{if(u.v=u.o.v=!0,u.e){if(b)for(s=0,l=d.length;s<l;++s)o.point((x=d[s])[0],x[1]);else n(u.x,u.n.x,1,o);u=u.n}else{if(b)for(d=u.p.z,s=d.length-1;s>=0;--s)o.point((x=d[s])[0],x[1]);else n(u.x,u.p.x,-1,o);u=u.p}u=u.o,d=u.z,b=!b}while(!u.v);o.lineEnd()}}}function Cr(e){if(a=e.length){for(var a,r=0,n=e[0],o;++r<a;)n.n=o=e[r],o.p=n,n=o;n.n=o=e[0],o.p=n}}function Qa(e){return Ce(e[0])<=xe?e[0]:Cl(e[0])*((Ce(e[0])+xe)%nt-xe)}function Tl(e,a){var r=Qa(a),n=a[1],o=Fe(n),i=[Fe(r),-Le(r),0],c=0,s=0,l=new Tt;o===1?n=tt+Ne:o===-1&&(n=-tt-Ne);for(var g=0,d=e.length;g<d;++g)if(u=(x=e[g]).length)for(var x,u,b=x[u-1],m=Qa(b),y=b[1]/2+vr,w=Fe(y),f=Le(y),v=0;v<u;++v,m=k,w=S,f=C,b=j){var j=x[v],k=Qa(j),E=j[1]/2+vr,S=Fe(E),C=Le(E),L=k-m,q=L>=0?1:-1,I=q*L,R=I>xe,$=w*S;if(l.add(aa($*q*Fe(I),f*C+$*Le(I))),c+=R?L+q*nt:L,R^m>=r^k>=r){var F=qa(Pt(b),Pt(j));cn(F);var D=qa(i,F);cn(D);var h=(R^L>=0?-1:1)*na(D[2]);(n>h||n===h&&(F[0]||F[1]))&&(s+=R^L>=0?1:-1)}}return(c<-Ne||c<Ne&&l<-1e-12)^s&1}function Eo(e,a,r,n){return function(o){var i=a(o),c=jo(),s=a(c),l=!1,g,d,x,u={point:b,lineStart:y,lineEnd:w,polygonStart:function(){u.point=f,u.lineStart=v,u.lineEnd=j,d=[],g=[]},polygonEnd:function(){u.point=b,u.lineStart=y,u.lineEnd=w,d=ko(d);var k=Tl(g,n);d.length?(l||(o.polygonStart(),l=!0),No(d,Fl,k,r,o)):k&&(l||(o.polygonStart(),l=!0),o.lineStart(),r(null,null,1,o),o.lineEnd()),l&&(o.polygonEnd(),l=!1),d=g=null},sphere:function(){o.polygonStart(),o.lineStart(),r(null,null,1,o),o.lineEnd(),o.polygonEnd()}};function b(k,E){e(k,E)&&o.point(k,E)}function m(k,E){i.point(k,E)}function y(){u.point=m,i.lineStart()}function w(){u.point=b,i.lineEnd()}function f(k,E){x.push([k,E]),s.point(k,E)}function v(){s.lineStart(),x=[]}function j(){f(x[0][0],x[0][1]),s.lineEnd();var k=s.clean(),E=c.result(),S,C=E.length,L,q,I;if(x.pop(),g.push(x),x=null,!!C){if(k&1){if(q=E[0],(L=q.length-1)>0){for(l||(o.polygonStart(),l=!0),o.lineStart(),S=0;S<L;++S)o.point((I=q[S])[0],I[1]);o.lineEnd()}return}C>1&&k&2&&E.push(E.pop().concat(E.shift())),d.push(E.filter(Ll))}}return u}}function Ll(e){return e.length>1}function Fl(e,a){return((e=e.x)[0]<0?e[1]-tt-Ne:tt-e[1])-((a=a.x)[0]<0?a[1]-tt-Ne:tt-a[1])}const zr=Eo(function(){return!0},Rl,Ml,[-xe,-tt]);function Rl(e){var a=NaN,r=NaN,n=NaN,o;return{lineStart:function(){e.lineStart(),o=1},point:function(i,c){var s=i>0?xe:-xe,l=Ce(i-a);Ce(l-xe)<Ne?(e.point(a,r=(r+c)/2>0?tt:-tt),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(i,r),o=0):n!==s&&l>=xe&&(Ce(a-n)<Ne&&(a-=n*Ne),Ce(i-s)<Ne&&(i-=s*Ne),r=Ol(a,r,i,c),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),o=0),e.point(a=i,r=c),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-o}}}function Ol(e,a,r,n){var o,i,c=Fe(e-r);return Ce(c)>Ne?Sl((Fe(a)*(i=Le(n))*Fe(r)-Fe(n)*(o=Le(a))*Fe(e))/(o*i*c)):(a+n)/2}function Ml(e,a,r,n){var o;if(e==null)o=r*tt,n.point(-xe,o),n.point(0,o),n.point(xe,o),n.point(xe,0),n.point(xe,-o),n.point(0,-o),n.point(-xe,-o),n.point(-xe,0),n.point(-xe,o);else if(Ce(e[0]-a[0])>Ne){var i=e[0]<a[0]?xe:-xe;o=r*i/2,n.point(-i,o),n.point(0,o),n.point(i,o)}else n.point(a[0],a[1])}function Dl(e){var a=Le(e),r=2*Ye,n=a>0,o=Ce(a)>Ne;function i(d,x,u,b){ql(b,e,r,u,d,x)}function c(d,x){return Le(d)*Le(x)>a}function s(d){var x,u,b,m,y;return{lineStart:function(){m=b=!1,y=1},point:function(w,f){var v=[w,f],j,k=c(w,f),E=n?k?0:g(w,f):k?g(w+(w<0?xe:-xe),f):0;if(!x&&(m=b=k)&&d.lineStart(),k!==b&&(j=l(x,v),(!j||wa(x,j)||wa(v,j))&&(v[2]=1)),k!==b)y=0,k?(d.lineStart(),j=l(v,x),d.point(j[0],j[1])):(j=l(x,v),d.point(j[0],j[1],2),d.lineEnd()),x=j;else if(o&&x&&n^k){var S;!(E&u)&&(S=l(v,x,!0))&&(y=0,n?(d.lineStart(),d.point(S[0][0],S[0][1]),d.point(S[1][0],S[1][1]),d.lineEnd()):(d.point(S[1][0],S[1][1]),d.lineEnd(),d.lineStart(),d.point(S[0][0],S[0][1],3)))}k&&(!x||!wa(x,v))&&d.point(v[0],v[1]),x=v,b=k,u=E},lineEnd:function(){b&&d.lineEnd(),x=null},clean:function(){return y|(m&&b)<<1}}}function l(d,x,u){var b=Pt(d),m=Pt(x),y=[1,0,0],w=qa(b,m),f=ua(w,w),v=w[0],j=f-v*v;if(!j)return!u&&d;var k=a*f/j,E=-a*v/j,S=qa(y,w),C=ma(y,k),L=ma(w,E);Ya(C,L);var q=S,I=ua(C,q),R=ua(q,q),$=I*I-R*(ua(C,C)-1);if(!($<0)){var F=Ft($),D=ma(q,(-I-F)/R);if(Ya(D,C),D=dn(D),!u)return D;var h=d[0],A=x[0],U=d[1],te=x[1],N;A<h&&(N=h,h=A,A=N);var O=A-h,M=Ce(O-xe)<Ne,V=M||O<Ne;if(!M&&te<U&&(N=U,U=te,te=N),V?M?U+te>0^D[1]<(Ce(D[0]-h)<Ne?U:te):U<=D[1]&&D[1]<=te:O>xe^(h<=D[0]&&D[0]<=A)){var ae=ma(q,(-I+F)/R);return Ya(ae,C),[D,dn(ae)]}}}function g(d,x){var u=n?e:xe-e,b=0;return d<-u?b|=1:d>u&&(b|=2),x<-u?b|=4:x>u&&(b|=8),b}return Eo(c,s,i,n?[0,-e]:[-xe,e-xe])}function Il(e,a,r,n,o,i){var c=e[0],s=e[1],l=a[0],g=a[1],d=0,x=1,u=l-c,b=g-s,m;if(m=r-c,!(!u&&m>0)){if(m/=u,u<0){if(m<d)return;m<x&&(x=m)}else if(u>0){if(m>x)return;m>d&&(d=m)}if(m=o-c,!(!u&&m<0)){if(m/=u,u<0){if(m>x)return;m>d&&(d=m)}else if(u>0){if(m<d)return;m<x&&(x=m)}if(m=n-s,!(!b&&m>0)){if(m/=b,b<0){if(m<d)return;m<x&&(x=m)}else if(b>0){if(m>x)return;m>d&&(d=m)}if(m=i-s,!(!b&&m<0)){if(m/=b,b<0){if(m>x)return;m>d&&(d=m)}else if(b>0){if(m<d)return;m<x&&(x=m)}return d>0&&(e[0]=c+d*u,e[1]=s+d*b),x<1&&(a[0]=c+x*u,a[1]=s+x*b),!0}}}}}var Yt=1e9,ha=-Yt;function Pl(e,a,r,n){function o(g,d){return e<=g&&g<=r&&a<=d&&d<=n}function i(g,d,x,u){var b=0,m=0;if(g==null||(b=c(g,x))!==(m=c(d,x))||l(g,d)<0^x>0)do u.point(b===0||b===3?e:r,b>1?n:a);while((b=(b+x+4)%4)!==m);else u.point(d[0],d[1])}function c(g,d){return Ce(g[0]-e)<Ne?d>0?0:3:Ce(g[0]-r)<Ne?d>0?2:1:Ce(g[1]-a)<Ne?d>0?1:0:d>0?3:2}function s(g,d){return l(g.x,d.x)}function l(g,d){var x=c(g,1),u=c(d,1);return x!==u?x-u:x===0?d[1]-g[1]:x===1?g[0]-d[0]:x===2?g[1]-d[1]:d[0]-g[0]}return function(g){var d=g,x=jo(),u,b,m,y,w,f,v,j,k,E,S,C={point:L,lineStart:$,lineEnd:F,polygonStart:I,polygonEnd:R};function L(h,A){o(h,A)&&d.point(h,A)}function q(){for(var h=0,A=0,U=b.length;A<U;++A)for(var te=b[A],N=1,O=te.length,M=te[0],V,ae,Z=M[0],ge=M[1];N<O;++N)V=Z,ae=ge,M=te[N],Z=M[0],ge=M[1],ae<=n?ge>n&&(Z-V)*(n-ae)>(ge-ae)*(e-V)&&++h:ge<=n&&(Z-V)*(n-ae)<(ge-ae)*(e-V)&&--h;return h}function I(){d=x,u=[],b=[],S=!0}function R(){var h=q(),A=S&&h,U=(u=ko(u)).length;(A||U)&&(g.polygonStart(),A&&(g.lineStart(),i(null,null,1,g),g.lineEnd()),U&&No(u,s,h,i,g),g.polygonEnd()),d=g,u=b=m=null}function $(){C.point=D,b&&b.push(m=[]),E=!0,k=!1,v=j=NaN}function F(){u&&(D(y,w),f&&k&&x.rejoin(),u.push(x.result())),C.point=L,k&&d.lineEnd()}function D(h,A){var U=o(h,A);if(b&&m.push([h,A]),E)y=h,w=A,f=U,E=!1,U&&(d.lineStart(),d.point(h,A));else if(U&&k)d.point(h,A);else{var te=[v=Math.max(ha,Math.min(Yt,v)),j=Math.max(ha,Math.min(Yt,j))],N=[h=Math.max(ha,Math.min(Yt,h)),A=Math.max(ha,Math.min(Yt,A))];Il(te,N,e,a,r,n)?(k||(d.lineStart(),d.point(te[0],te[1])),d.point(N[0],N[1]),U||d.lineEnd(),S=!1):U&&(d.lineStart(),d.point(h,A),S=!1)}v=h,j=A,k=U}return C}}const mn=e=>e;var Ka=new Tt,fn=new Tt,So,Co,hn,gn,ft={point:at,lineStart:at,lineEnd:at,polygonStart:function(){ft.lineStart=_l,ft.lineEnd=$l},polygonEnd:function(){ft.lineStart=ft.lineEnd=ft.point=at,Ka.add(Ce(fn)),fn=new Tt},result:function(){var e=Ka/2;return Ka=new Tt,e}};function _l(){ft.point=Bl}function Bl(e,a){ft.point=zo,So=hn=e,Co=gn=a}function zo(e,a){fn.add(gn*e-hn*a),hn=e,gn=a}function $l(){zo(So,Co)}var _t=1/0,Ta=_t,ra=-_t,La=ra,Fa={point:Ul,lineStart:at,lineEnd:at,polygonStart:at,polygonEnd:at,result:function(){var e=[[_t,Ta],[ra,La]];return ra=La=-(Ta=_t=1/0),e}};function Ul(e,a){e<_t&&(_t=e),e>ra&&(ra=e),a<Ta&&(Ta=a),a>La&&(La=a)}var xn=0,bn=0,Qt=0,Ra=0,Oa=0,Dt=0,vn=0,yn=0,Kt=0,Ao,qo,ct,pt,et={point:Lt,lineStart:Ar,lineEnd:qr,polygonStart:function(){et.lineStart=Wl,et.lineEnd=Gl},polygonEnd:function(){et.point=Lt,et.lineStart=Ar,et.lineEnd=qr},result:function(){var e=Kt?[vn/Kt,yn/Kt]:Dt?[Ra/Dt,Oa/Dt]:Qt?[xn/Qt,bn/Qt]:[NaN,NaN];return xn=bn=Qt=Ra=Oa=Dt=vn=yn=Kt=0,e}};function Lt(e,a){xn+=e,bn+=a,++Qt}function Ar(){et.point=Hl}function Hl(e,a){et.point=Vl,Lt(ct=e,pt=a)}function Vl(e,a){var r=e-ct,n=a-pt,o=Ft(r*r+n*n);Ra+=o*(ct+e)/2,Oa+=o*(pt+a)/2,Dt+=o,Lt(ct=e,pt=a)}function qr(){et.point=Lt}function Wl(){et.point=Yl}function Gl(){To(Ao,qo)}function Yl(e,a){et.point=To,Lt(Ao=ct=e,qo=pt=a)}function To(e,a){var r=e-ct,n=a-pt,o=Ft(r*r+n*n);Ra+=o*(ct+e)/2,Oa+=o*(pt+a)/2,Dt+=o,o=pt*e-ct*a,vn+=o*(ct+e),yn+=o*(pt+a),Kt+=o*3,Lt(ct=e,pt=a)}function Lo(e){this._context=e}Lo.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,nt);break}}},result:at};var wn=new Tt,Ja,Fo,Ro,Jt,Xt,oa={point:at,lineStart:function(){oa.point=Ql},lineEnd:function(){Ja&&Oo(Fo,Ro),oa.point=at},polygonStart:function(){Ja=!0},polygonEnd:function(){Ja=null},result:function(){var e=+wn;return wn=new Tt,e}};function Ql(e,a){oa.point=Oo,Fo=Jt=e,Ro=Xt=a}function Oo(e,a){Jt-=e,Xt-=a,wn.add(Ft(Jt*Jt+Xt*Xt)),Jt=e,Xt=a}let Tr,Ma,Lr,Fr;class Rr{constructor(a){this._append=a==null?Mo:Kl(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Lr||this._append!==Ma){const n=this._radius,o=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Lr=n,Ma=this._append,Fr=this._,this._=o}this._+=Fr;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Mo(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Kl(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Mo;if(a!==Tr){const r=10**a;Tr=a,Ma=function(o){let i=1;this._+=o[0];for(const c=o.length;i<c;++i)this._+=Math.round(arguments[i]*r)/r+o[i]}}return Ma}function Jl(e,a){let r=3,n=4.5,o,i;function c(s){return s&&(typeof n=="function"&&i.pointRadius(+n.apply(this,arguments)),Mt(s,o(i))),i.result()}return c.area=function(s){return Mt(s,o(ft)),ft.result()},c.measure=function(s){return Mt(s,o(oa)),oa.result()},c.bounds=function(s){return Mt(s,o(Fa)),Fa.result()},c.centroid=function(s){return Mt(s,o(et)),et.result()},c.projection=function(s){return arguments.length?(o=s==null?(e=null,mn):(e=s).stream,c):e},c.context=function(s){return arguments.length?(i=s==null?(a=null,new Rr(r)):new Lo(a=s),typeof n!="function"&&i.pointRadius(n),c):a},c.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(i.pointRadius(+s),+s),c):n},c.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const l=Math.floor(s);if(!(l>=0))throw new RangeError(`invalid digits: ${s}`);r=l}return a===null&&(i=new Rr(r)),c},c.projection(e).digits(r).context(a)}function Tn(e){return function(a){var r=new kn;for(var n in e)r[n]=e[n];return r.stream=a,r}}function kn(){}kn.prototype={constructor:kn,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function Ln(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Mt(r,e.stream(Fa)),a(Fa.result()),n!=null&&e.clipExtent(n),e}function Do(e,a,r){return Ln(e,function(n){var o=a[1][0]-a[0][0],i=a[1][1]-a[0][1],c=Math.min(o/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),s=+a[0][0]+(o-c*(n[1][0]+n[0][0]))/2,l=+a[0][1]+(i-c*(n[1][1]+n[0][1]))/2;e.scale(150*c).translate([s,l])},r)}function Xl(e,a,r){return Do(e,[[0,0],a],r)}function Zl(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][0]-n[0][0]),c=(o-i*(n[1][0]+n[0][0]))/2,s=-i*n[0][1];e.scale(150*i).translate([c,s])},r)}function ed(e,a,r){return Ln(e,function(n){var o=+a,i=o/(n[1][1]-n[0][1]),c=-i*n[0][0],s=(o-i*(n[1][1]+n[0][1]))/2;e.scale(150*i).translate([c,s])},r)}var Or=16,td=Le(30*Ye);function Mr(e,a){return+a?nd(e,a):ad(e)}function ad(e){return Tn({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function nd(e,a){function r(n,o,i,c,s,l,g,d,x,u,b,m,y,w){var f=g-n,v=d-o,j=f*f+v*v;if(j>4*a&&y--){var k=c+u,E=s+b,S=l+m,C=Ft(k*k+E*E+S*S),L=na(S/=C),q=Ce(Ce(S)-1)<Ne||Ce(i-x)<Ne?(i+x)/2:aa(E,k),I=e(q,L),R=I[0],$=I[1],F=R-n,D=$-o,h=v*F-f*D;(h*h/j>a||Ce((f*F+v*D)/j-.5)>.3||c*u+s*b+l*m<td)&&(r(n,o,i,c,s,l,R,$,q,k/=C,E/=C,S,y,w),w.point(R,$),r(R,$,q,k,E,S,g,d,x,u,b,m,y,w))}}return function(n){var o,i,c,s,l,g,d,x,u,b,m,y,w={point:f,lineStart:v,lineEnd:k,polygonStart:function(){n.polygonStart(),w.lineStart=E},polygonEnd:function(){n.polygonEnd(),w.lineStart=v}};function f(L,q){L=e(L,q),n.point(L[0],L[1])}function v(){x=NaN,w.point=j,n.lineStart()}function j(L,q){var I=Pt([L,q]),R=e(L,q);r(x,u,d,b,m,y,x=R[0],u=R[1],d=L,b=I[0],m=I[1],y=I[2],Or,n),n.point(x,u)}function k(){w.point=f,n.lineEnd()}function E(){v(),w.point=S,w.lineEnd=C}function S(L,q){j(o=L,q),i=x,c=u,s=b,l=m,g=y,w.point=j}function C(){r(x,u,d,b,m,y,i,c,o,s,l,g,Or,n),w.lineEnd=k,k()}return w}}var rd=Tn({point:function(e,a){this.stream.point(e*Ye,a*Ye)}});function od(e){return Tn({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function id(e,a,r,n,o){function i(c,s){return c*=n,s*=o,[a+e*c,r-e*s]}return i.invert=function(c,s){return[(c-a)/e*n,(r-s)/e*o]},i}function Dr(e,a,r,n,o,i){if(!i)return id(e,a,r,n,o);var c=Le(i),s=Fe(i),l=c*e,g=s*e,d=c/e,x=s/e,u=(s*r-c*a)/e,b=(s*a+c*r)/e;function m(y,w){return y*=n,w*=o,[l*y-g*w+a,r-g*y-l*w]}return m.invert=function(y,w){return[n*(d*y-x*w+u),o*(b-x*y-d*w)]},m}function sd(e){return ld(function(){return e})()}function ld(e){var a,r=150,n=480,o=250,i=0,c=0,s=0,l=0,g=0,d,x=0,u=1,b=1,m=null,y=zr,w=null,f,v,j,k=mn,E=.5,S,C,L,q,I;function R(h){return L(h[0]*Ye,h[1]*Ye)}function $(h){return h=L.invert(h[0],h[1]),h&&[h[0]*mt,h[1]*mt]}R.stream=function(h){return q&&I===h?q:q=rd(od(d)(y(S(k(I=h)))))},R.preclip=function(h){return arguments.length?(y=h,m=void 0,D()):y},R.postclip=function(h){return arguments.length?(k=h,w=f=v=j=null,D()):k},R.clipAngle=function(h){return arguments.length?(y=+h?Dl(m=h*Ye):(m=null,zr),D()):m*mt},R.clipExtent=function(h){return arguments.length?(k=h==null?(w=f=v=j=null,mn):Pl(w=+h[0][0],f=+h[0][1],v=+h[1][0],j=+h[1][1]),D()):w==null?null:[[w,f],[v,j]]},R.scale=function(h){return arguments.length?(r=+h,F()):r},R.translate=function(h){return arguments.length?(n=+h[0],o=+h[1],F()):[n,o]},R.center=function(h){return arguments.length?(i=h[0]%360*Ye,c=h[1]%360*Ye,F()):[i*mt,c*mt]},R.rotate=function(h){return arguments.length?(s=h[0]%360*Ye,l=h[1]%360*Ye,g=h.length>2?h[2]%360*Ye:0,F()):[s*mt,l*mt,g*mt]},R.angle=function(h){return arguments.length?(x=h%360*Ye,F()):x*mt},R.reflectX=function(h){return arguments.length?(u=h?-1:1,F()):u<0},R.reflectY=function(h){return arguments.length?(b=h?-1:1,F()):b<0},R.precision=function(h){return arguments.length?(S=Mr(C,E=h*h),D()):Ft(E)},R.fitExtent=function(h,A){return Do(R,h,A)},R.fitSize=function(h,A){return Xl(R,h,A)},R.fitWidth=function(h,A){return Zl(R,h,A)},R.fitHeight=function(h,A){return ed(R,h,A)};function F(){var h=Dr(r,0,0,u,b,x).apply(null,a(i,c)),A=Dr(r,n-h[0],o-h[1],u,b,x);return d=Al(s,l,g),C=pn(a,A),L=pn(d,C),S=Mr(C,E),D()}function D(){return q=I=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&$,F()}}function Io(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Io.invert=function(e,a){var r=a,n=25,o;do{var i=r*r,c=i*i;r-=o=(r*(1.007226+i*(.015085+c*(-.044475+.028874*i-.005916*c)))-a)/(1.007226+i*(.015085*3+c*(-.044475*7+.028874*9*i-.005916*11*c)))}while(Ce(o)>Ne&&--n>0);return[e/(.8707+(i=r*r)*(-.131979+i*(-.013791+i*i*i*(.003971-.001529*i)))),r]};function dd(){return sd(Io).scale(175.295)}function cd(e){return e}function pd(e){if(e==null)return cd;var a,r,n=e.scale[0],o=e.scale[1],i=e.translate[0],c=e.translate[1];return function(s,l){l||(a=r=0);var g=2,d=s.length,x=new Array(d);for(x[0]=(a+=s[0])*n+i,x[1]=(r+=s[1])*o+c;g<d;)x[g]=s[g],++g;return x}}function ud(e,a){for(var r,n=e.length,o=n-a;o<--n;)r=e[o],e[o++]=e[n],e[n]=r}function md(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Ir(e,r)})}:Ir(e,a)}function Ir(e,a){var r=a.id,n=a.bbox,o=a.properties==null?{}:a.properties,i=fd(e,a);return r==null&&n==null?{type:"Feature",properties:o,geometry:i}:n==null?{type:"Feature",id:r,properties:o,geometry:i}:{type:"Feature",id:r,bbox:n,properties:o,geometry:i}}function fd(e,a){var r=pd(e.transform),n=e.arcs;function o(d,x){x.length&&x.pop();for(var u=n[d<0?~d:d],b=0,m=u.length;b<m;++b)x.push(r(u[b],b));d<0&&ud(x,m)}function i(d){return r(d)}function c(d){for(var x=[],u=0,b=d.length;u<b;++u)o(d[u],x);return x.length<2&&x.push(x[0]),x}function s(d){for(var x=c(d);x.length<4;)x.push(x[0]);return x}function l(d){return d.map(s)}function g(d){var x=d.type,u;switch(x){case"GeometryCollection":return{type:x,geometries:d.geometries.map(g)};case"Point":u=i(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(i);break;case"LineString":u=c(d.arcs);break;case"MultiLineString":u=d.arcs.map(c);break;case"Polygon":u=l(d.arcs);break;case"MultiPolygon":u=d.arcs.map(l);break;default:return null}return{type:x,coordinates:u}}return g(a)}const Po={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},hd=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function gd(e,a,r){const n=Po[e];if(!n||!n.length)return-1;const o=hd(a||"");if(o){for(let i=0;i<n.length;i++)if(n[i].k.some(c=>o.includes(c)))return i}return Math.floor(r*n.length)%n.length}let ga=null;function xd(){return ga||(ga=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const o=md(r,n),i=dd().fitExtent([[8,8],[992,492]],{type:"Sphere"}),c=Jl(i),s=(o.features||[]).filter(d=>{var x;return(((x=d.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(d=>{var b;const x=((b=d.properties)==null?void 0:b.name)||"",u=c(d)||"";return u?{i2:Oi(x)||null,n:x,d:u}:null}).filter(d=>!!d);if(!s.length)return null;const l={};for(const[d,x]of Object.entries(Mi)){const u=i(x);u&&(l[d]={x:u[0],y:u[1]})}const g={};for(const[d,x]of Object.entries(Po)){const u=x.map(b=>i(b.ll)).filter(b=>!!b).map(([b,m])=>({x:b,y:m}));u.length&&(g[d]=u)}return{key:"monde",viewBox:"40 48 920 360",fr:"Monde",en:"World",countries:s,anchors:l,metros:g}}catch{return null}})(),ga)}function bd(e){const[a,r]=p.useState(null);return p.useEffect(()=>{if(!e||a)return;let n=!1;return xd().then(o=>{!n&&o&&r(o)}),()=>{n=!0}},[e,a]),a}const vd="8 40 984 210",yd={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Pr=["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"];function _r(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function wd(e,a){const[r,n]=p.useState(1);return p.useEffect(()=>{let o=!0,i=0;const c=()=>{var g;if(!o)return;const l=(g=e.current)==null?void 0:g.getScreenCTM();l&&l.a>0?n(l.a):i=requestAnimationFrame(c)};c();const s=new ResizeObserver(()=>c());return e.current&&s.observe(e.current),window.addEventListener("resize",c),()=>{o=!1,cancelAnimationFrame(i),s.disconnect(),window.removeEventListener("resize",c)}},[e,a]),r}function Br({msgs:e}){const[a,r]=p.useState(0);p.useEffect(()=>{const o=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(o)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([o,i],c)=>t.jsx("i",{style:{left:o+"%",top:i+"%","--d":c*.18+"s"}},c)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function kd(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:o,markedId:i,byId:c,lang:s,t:l,data:g,dossiers:d,source:x}=Q(),u=g.loading&&!d.length,b=p.useRef(null),m=p.useRef(null),y=bd(e.continent==="monde"),w=e.continent==="monde"?y:Sn.find(h=>h.key===e.continent)||null,f=wd(b,e.continent+":"+e.mapFolded+":"+!!w),[v,j]=p.useState(new Map),[k,E]=p.useState(null);p.useEffect(()=>{const h=b.current;if(!h)return;const A=new Map;h.querySelectorAll("path[data-i2]").forEach(U=>{const te=U.dataset.i2;if(te)try{const N=U.getBBox();N.width>0&&A.set(te,{x:N.x,y:N.y,w:N.width,h:N.height})}catch{}}),j(A)},[e.continent,f,w]);const S=p.useMemo(()=>r.filter(h=>h.cc),[r]),C=p.useMemo(()=>{const h=new Map;return S.forEach(A=>h.set(A.cc,(h.get(A.cc)||0)+1)),h},[S]),L=e.continent==="monde"&&y?y.anchors:null,q=e.continent==="monde"&&y?y.metros:null,I=p.useMemo(()=>S.map(h=>{const A=_r(h.name||h.id||""),U=_r((h.id||h.name||"")+"·y");if(L&&h.cc){const V=q?q[h.cc]:void 0;if(V&&V.length){const Z=gd(h.cc,h.city,A);if(Z>=0&&V[Z])return{d:h,x:V[Z].x+(A-.5)*5,y:V[Z].y+(U-.5)*5}}const ae=L[h.cc];if(ae)return{d:h,x:ae.x+(A-.5)*10,y:ae.y+(U-.5)*10}}const te=h.cc?v.get(h.cc):void 0;if(!te)return null;const N=yd[`${e.continent}:${h.cc||""}`];if(N)return{d:h,x:te.x+te.w*(N.fx+(A-.5)*N.sx),y:te.y+te.h*(N.fy+(U-.5)*N.sy)};const O=(A-.5)*Math.min(te.w*.55,60),M=(U-.5)*Math.min(te.h*.55,60);return{d:h,x:te.x+te.w/2+O,y:te.y+te.h/2+M}}).filter(h=>!!h),[S,v,L,q,e.continent]),R=h=>f>0?h/f:h,$=p.useMemo(()=>n?[0,1,2,3,4,5].map(h=>({c:Pr[h],fr:l.plabels[h],en:l.plabels[h],n:r.filter(A=>A.kind==="target"&&Ee(A)===h).length})).filter(h=>h.n>0):Wn.map((h,A)=>({...h,n:r.filter(U=>Gn(U)===A).length})),[r,n,l.plabels]),F=i?c.get(i):null,D=F?I.find(h=>h.d.id===F.id):null;return w?t.jsxs("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:[u&&t.jsx(Br,{msgs:l.loadMsgs}),t.jsxs("svg",{ref:b,viewBox:e.continent==="monde"?vd:w.viewBox,preserveAspectRatio:e.continent==="monde"?"xMidYMin slice":"xMidYMid meet",role:"img","aria-label":s==="fr"?w.fr:w.en,onMouseLeave:()=>{E(null),o(null)},children:[t.jsx("g",{children:w.countries.map((h,A)=>t.jsx("g",{className:"ct"+(h.i2&&C.get(h.i2)?"":" empty"),children:t.jsx("path",{d:h.d,"data-i2":h.i2||void 0})},A))}),t.jsx("g",{children:I.map(h=>{const A=Wn[Gn(h.d)],U=!!De(h.d),te=h.d.kind==="target",N=n&&te?Pr[Ee(h.d)]:A.c,O=!n&&_e(h.d);return t.jsxs("g",{className:"co"+(O?" done":""),onMouseEnter:()=>{var ae,Z;const M=(ae=m.current)==null?void 0:ae.getBoundingClientRect(),V=(Z=b.current)==null?void 0:Z.createSVGPoint();if(V&&b.current&&M){V.x=h.x,V.y=h.y;const ge=V.matrixTransform(b.current.getScreenCTM());E({x:ge.x-M.left,y:ge.y-M.top,label:h.d.name+" · "+(Ut(h.d.cc,s)||h.d.countryLabel||"")})}o(h.d.id)},onMouseLeave:()=>{E(null),o(null)},onClick:()=>{var ae;if(x==="ops"){window.dispatchEvent(new CustomEvent("ppmap:reveal")),a({type:"focus",id:h.d.id}),(h.d.noCo||["media","nominations","recrutements"].includes(h.d.engine||""))&&(h.d.url||h.d.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.d.url||"",text:[h.d.headline,h.d.tagline].filter(Boolean).join(`
`)}})):h.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:h.d.name,url:h.d.url||"",website:h.d.website||"",domain:h.d.domain||""}}));return}const M=(ae=b.current)==null?void 0:ae.createSVGPoint();let V=null;if(M&&b.current){M.x=h.x,M.y=h.y;const Z=M.matrixTransform(b.current.getScreenCTM());V={x:Z.x,y:Z.y}}a({type:"popup",id:h.d.id,anchor:V})},children:[t.jsx("circle",{className:"h",cx:h.x,cy:h.y,r:R(Math.max(11,A.px+7))}),t.jsx("circle",{className:"v",cx:h.x,cy:h.y,r:R(A.px),fill:N,stroke:U?"#E5484D":"#ffffff",strokeWidth:R(U?2.2:1.3)})]},h.d.id||h.d.name)})}),D&&t.jsx("circle",{className:"ring on",cx:D.x,cy:D.y,r:R(13),fill:"none",stroke:"#16233A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(k?" on":""),style:k?{left:k.x,top:k.y}:void 0,children:k==null?void 0:k.label}),t.jsx("div",{className:"legend",children:$.map((h,A)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":h.c}}),s==="fr"?h.fr:h.en," ",t.jsx("b",{children:h.n})]},A))}),r.some(h=>!h.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",l.notLocated," ",t.jsx("b",{children:r.filter(h=>!h.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(u?" waiting":""),ref:m,children:t.jsx(Br,{msgs:l.loadMsgs})})}function jd(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const o=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],i=Number(r[3]);return a==="en"?`${o} ${i}, ${r[1]}`:`${i} ${o} ${r[1]}`}function _o({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:o,pipe:i,contName:c,lang:s}=Q(),l=a.filters,[g,d]=p.useState(!1),[x,u]=p.useState(!1),b=p.useRef(null),m=p.useRef(null),y=p.useMemo(()=>a.continent==="monde"?n:n.filter(D=>D.continent===a.continent),[n,a.continent]),w=D=>y.filter(h=>D!=="country"&&l.country.length&&!l.country.includes(h.cc||"")?!1:Ca(h,l,i,D==="country"?void 0:D)),f=D=>!i||D.kind!=="op",v=p.useMemo(()=>{const D=w("win").filter(f),h=A=>D.filter(U=>(U.date?Math.max(0,Math.floor((Date.now()-Date.parse(U.date))/864e5)):9999)<=A).length;return[h(0),h(7),h(30),D.length]},[y,l,i]),j=p.useMemo(()=>l.day?w("win").filter(f).filter(D=>(D.date||"").slice(0,10)===l.day).length:0,[y,l,i]),k=(l.signalOnly?1:0)+l.sector.length+l.country.length+l.engine.length+l.stage.length+l.angle.length+l.memoLevel.length+l.crible.length,E=k+(l.acquirer.trim()?1:0)+(l.day||l.win!=="all"?1:0)+(l.search.trim()?1:0);p.useEffect(()=>{a.openFacet&&d(!1)},[a.openFacet]),p.useEffect(()=>{if(!g&&!x)return;const D=A=>{var te,N;const U=A.target;g&&!((te=b.current)!=null&&te.contains(U))&&d(!1),x&&!((N=m.current)!=null&&N.contains(U))&&u(!1)},h=A=>{A.key==="Escape"&&(d(!1),u(!1))};return document.addEventListener("mousedown",D),document.addEventListener("keydown",h),()=>{document.removeEventListener("mousedown",D),document.removeEventListener("keydown",h)}},[g,x]);const S=(D,h,A,U="fbtn")=>t.jsxs("button",{type:"button",className:U,"aria-expanded":a.openFacet===D,onClick:()=>r({type:"openFacet",facet:D}),children:[t.jsx("span",{className:"fl",children:h}),A>0&&t.jsx("span",{className:"n",children:A}),t.jsx("span",{className:"cv",children:"▾"})]},D),C=["1","7","30","all"],L=Math.max(0,C.indexOf(l.win||"all")),q=l.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:o.fDay(jd(l.day,s))}),t.jsx("b",{children:j})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:o.fDayOff})]}):e?t.jsxs("div",{className:"winpick",ref:m,children:[t.jsxs("button",{type:"button",className:"winpick-btn","aria-expanded":x,"aria-haspopup":"listbox",onClick:()=>u(D=>!D),children:[t.jsx("span",{className:"winpick-k",children:o.winMenu}),t.jsx("span",{className:"winpick-v",children:o.datesShort[L]}),t.jsx("b",{children:v[L]}),t.jsx("i",{children:x?"▴":"▾"})]}),x&&t.jsx("div",{className:"winpick-pop",role:"listbox",children:C.map((D,h)=>t.jsxs("button",{type:"button",role:"option","aria-selected":l.win===D,onClick:()=>{r({type:"filters",patch:{win:D}}),u(!1)},children:[o.datesShort[h],t.jsx("span",{className:"n",children:v[h]})]},D))})]}):t.jsx("div",{className:"seg",children:C.map((D,h)=>t.jsxs("button",{type:"button","aria-pressed":l.win===D,onClick:()=>r({type:"filters",patch:{win:D}}),children:[t.jsx("span",{className:"sl",children:o.dates[h]}),t.jsx("b",{children:v[h]})]},D))}),I=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:o.identSearch,value:l.search,onChange:D=>r({type:"filters",patch:{search:D.target.value}})})]}),R=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:o.fSignal}),l.signalOnly&&t.jsx("span",{className:"n",children:l.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),l.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:l.sector[0],children:[t.jsx("span",{className:"fl",children:o.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):S("sec",o.fSector,l.sector.length),S("pay",o.fCountry,l.country.length),S("det",o.fEngine,l.engine.length),S("sta",o.fStage,l.stage.length),i&&S("crib",o.fVerdict,l.crible.length),i&&S("ang","Angle",l.angle.length),i&&S("mem","Mémo",l.memoLevel.length)]}),$=(D=!1)=>t.jsxs("div",{className:"frow2",children:[E>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:o.clearTitle(y.length,c),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:o.clear(E)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:o.alertBtn}),D&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:o.showMap})]}),F=t.jsxs("div",{className:"fmenu",ref:b,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(k?" on":""),"aria-expanded":g,"aria-haspopup":"true",onClick:()=>{d(D=>!D),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:o.fMenu}),k>0&&t.jsx("span",{className:"n",children:k}),t.jsx("span",{className:"cv",children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:R})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(l.day?" noday":""),children:[t.jsx("div",{className:"fstrip-a",children:q}),t.jsxs("div",{className:"fstrip-b",children:[I,F,$(!1)]})]}),a.openFacet&&t.jsx($r,{poolFor:w})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[q,I,R,t.jsx("span",{className:"fgrow"}),$()]}),a.openFacet&&t.jsx($r,{poolFor:w})]})}function $r({poolFor:e}){const{st:a,dispatch:r,t:n,lang:o,pipe:i,data:c}=Q(),s=a.filters,l=a.openFacet,{title:g,cols:d,options:x}=p.useMemo(()=>{if(l==="sig"){const w=e("signal").filter(j=>De(j)),f=new Map;w.forEach(j=>{const k=j.engine||"";f.set(k,(f.get(k)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:w.length,html:!0,on:s.signalOnly&&!s.signalEngines.length},...rn([...f.keys()],o).map(j=>({v:j,label:qt(j)+" "+Qe(j,o),n:f.get(j)||0,html:!1,on:s.signalOnly&&s.signalEngines.includes(j)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="crib"){const w=e("crible").filter(v=>!i||to(v,a.ptab,c.favIds)),f=new Map;return w.forEach(v=>{const j=ao(v);j&&j!=="NEW"&&f.set(j,(f.get(j)||0)+1)}),{title:n.fVerdict.toUpperCase(),cols:2,options:[...f.entries()].sort((v,j)=>(Yn[v[0]]??9)-(Yn[j[0]]??9)||j[1]-v[1]).map(([v,j])=>({v,label:'<span class="fdot" style="background:'+(Di[v]||"#94A3B8")+'"></span>'+v,n:j,html:!0,on:s.crible.includes(v)}))}}if(l==="sec"){const w=e("sector"),f=new Map;return w.forEach(v=>{v.sector&&f.set(v.sector,(f.get(v.sector)||0)+1)}),{title:n.fSector,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v,n:j,html:!1,on:s.sector.includes(v)}))}}if(l==="pay"){const w=e("country"),f=new Map;return w.forEach(v=>{v.cc&&f.set(v.cc,(f.get(v.cc)||0)+1)}),{title:n.fCountry,cols:3,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:Ut(v,o)||v,n:j,html:!1,on:s.country.includes(v)}))}}if(l==="det"){const w=e("engine"),f=new Map;return w.forEach(v=>{v.engine&&f.set(v.engine,(f.get(v.engine)||0)+1)}),{title:n.fEngine,cols:2,options:rn([...f.keys()],o).map(v=>({v,label:qt(v)+" "+Qe(v,o)+' <span style="color:var(--dim);font-size:10px">· '+Ii(Pi(v),o)+"</span>",n:f.get(v)||0,html:!0,on:s.engine.includes(v)}))}}if(l==="ang"){const w=e("angle"),f=new Map;return w.forEach(v=>{v.angle&&f.set(v.angle,(f.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...f.entries()].sort((v,j)=>j[1]-v[1]).map(([v,j])=>({v,label:v.replace(/[_-]+/g," "),n:j,html:!1,on:s.angle.includes(v)}))}}if(l==="mem"){const w=e("memoLevel"),f=new Map;w.forEach(j=>{if(j.kind==="target"){const k=Nn(j);f.set(k,(f.get(k)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(j=>({v:String(j),label:v[j],n:f.get(j)||0,html:!1,on:s.memoLevel.includes(j)}))}}const m=e("stage"),y=new Map;return m.forEach(w=>{w.stage&&y.set(w.stage,(y.get(w.stage)||0)+1)}),{title:n.fStage,cols:2,options:[...y.entries()].sort((w,f)=>f[1]-w[1]).map(([w,f])=>({v:w,label:w,n:f,html:!1,on:s.stage.includes(w)}))}},[l,a,o]),u=m=>{if(l==="sig"){if(m==="*")r({type:"filters",patch:{signalOnly:!(s.signalOnly&&!s.signalEngines.length),signalEngines:[]}});else{const w=s.signalEngines.includes(m)?s.signalEngines.filter(f=>f!==m):[...s.signalEngines,m];r({type:"filters",patch:{signalOnly:!0,signalEngines:w}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(m)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage",value:m})},b=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":l==="crib"?"crible":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:g}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:b,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:x.map(m=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":m.on,onClick:()=>u(m.v),children:[t.jsx("span",{className:"bx"}),m.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:m.label}}):t.jsx("span",{className:"l",children:m.label}),t.jsx("span",{className:"n",children:m.n})]},m.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Bo({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:o,pipe:i,lang:c,t:s}=Q(),l=p.useMemo(()=>{const b={};return r.forEach(m=>{Ca(m,n.filters,i)&&(b.monde=(b.monde||0)+1,m.continent&&(b[m.continent]=(b[m.continent]||0)+1))}),b},[r,n.filters,i]),[g,d]=p.useState(!1),x=p.useRef(null);p.useEffect(()=>{if(!g)return;const b=y=>{var w;(w=x.current)!=null&&w.contains(y.target)||d(!1)},m=y=>{y.key==="Escape"&&d(!1)};return document.addEventListener("mousedown",b),document.addEventListener("keydown",m),()=>{document.removeEventListener("mousedown",b),document.removeEventListener("keydown",m)}},[g]);const u=b=>{const m=Sn.find(y=>y.key===b);return b==="monde"?s.contWorld:c==="fr"?m.fr:m.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":g,"aria-haspopup":"listbox",onClick:()=>d(b=>!b),children:[u(n.continent),t.jsx("span",{className:"n",children:l[n.continent]||0}),t.jsx("i",{children:g?"▴":"▾"})]}),g&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:Qn.map(b=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===b,onClick:()=>{o({type:"continent",key:b}),d(!1)},children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})]}):t.jsxs("div",{className:"conts",children:[Qn.map(b=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===b,onClick:()=>o({type:"continent",key:b}),children:[u(b),t.jsx("span",{className:"n",children:l[b]||0})]},b)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>o({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?s.showMap:s.hideMap})})]})}function jn(e){try{return JSON.parse(localStorage.getItem(e)||"[]")}catch{return[]}}function $o(e){return"atl2:evalq:"+(e||"anon")}function Nd(e,a){const r=$o(e),n=jn(r),o=new Set(n.map(s=>(s.name||"").trim().toLowerCase())),i=a.map(s=>(s||"").trim()).filter(s=>s&&!o.has(s.toLowerCase())).map(s=>({name:s,site:"",status:"",auto:!0}));if(!i.length)return 0;const c=[...n,...i].slice(0,30);try{localStorage.setItem(r,JSON.stringify(c)),window.dispatchEvent(new CustomEvent("atl2:evalq"))}catch{}return i.length}function Uo(){const{t:e,data:a,dossiers:r}=Q(),n=a.session.token||"",o=$o(n),[i,c]=p.useState(()=>jn(o)),s=p.useRef(!1),[l,g]=p.useState(!1);p.useEffect(()=>{try{const N=i.slice(0,30).map(({descBusy:O,evalBusy:M,...V})=>V);localStorage.setItem(o,JSON.stringify(N)),s.current=!0,window.dispatchEvent(new CustomEvent("atl2:evalq")),s.current=!1}catch{}},[i,o]),p.useEffect(()=>{const N=()=>{if(s.current)return;const O=jn(o);c(M=>JSON.stringify(M.map(({descBusy:V,evalBusy:ae,...Z})=>Z))===JSON.stringify(O)?M:O)};return window.addEventListener("atl2:evalq",N),window.addEventListener("storage",N),()=>{window.removeEventListener("atl2:evalq",N),window.removeEventListener("storage",N)}},[o]);const[d,x]=p.useState([]),[u,b]=p.useState(""),[m,y]=p.useState(!1),[w,f]=p.useState(!1),[v,j]=p.useState(""),k=p.useCallback((N,O)=>c(M=>M.map((V,ae)=>ae===N?{...V,...O}:V)),[]),E=p.useCallback((N,O)=>{const M=O.trim();M&&(k(N,{name:M,status:"resolving",site:"",candidates:void 0,auto:!1,desc:"",descDone:!1}),Cn(M).then(V=>{const ae=V.candidates||[];V.website?k(N,{site:V.website,status:"ready"}):ae.length===1?k(N,{site:ae[0].url,status:"ready"}):ae.length>1?k(N,{status:"pick",candidates:ae.slice(0,4)}):k(N,{status:"ready"})}).catch(()=>k(N,{status:"ready"})))},[k]),S=p.useCallback((N,O,M)=>{k(N,{descBusy:!0}),oo(n,O,M).then(V=>{if(V.quota){g(!0),k(N,{descBusy:!1,descDone:!0});return}const ae=V.blocs||{},Z=(ae.synthese||ae.value_prop||ae.produit||ae.modele||"").trim();k(N,{descBusy:!1,descDone:!0,desc:Z})}).catch(()=>k(N,{descBusy:!1,descDone:!0}))},[k,n]);p.useEffect(()=>{const N=i.findIndex(M=>M.auto&&M.name.trim()&&M.status==="");if(N>=0){E(N,i[N].name);return}if(l)return;const O=i.findIndex(M=>M.status==="ready"&&M.site&&!M.descDone&&!M.descBusy);O>=0&&S(O,i[O].name,i[O].site)},[i,E,S,l]);const[C,L]=p.useState(!1),q=p.useCallback(async(N,O)=>{k(N,{evalBusy:!0});const M=await io(n,(O.site||O.name).trim(),"atelier2");return M.verdict==="quota"?(k(N,{evalBusy:!1}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:"",verdict:"quota",reason:M.reason||"",remaining:0}})),!1):(k(N,{evalBusy:!1,status:M.verdict==="kept"?"kept":"out",reason:M.reason||""}),window.dispatchEvent(new CustomEvent("ppmap:evalcard",{detail:{name:M.company||O.name,verdict:M.verdict,reason:M.reason||"",remaining:M.remaining??null}})),!0)},[k,n]),I=async()=>{if(C)return;const N=i.map((O,M)=>({r:O,i:M})).filter(({r:O})=>O.name.trim()&&O.status!=="kept"&&O.status!=="out"&&O.status!=="resolving");if(N.length){L(!0);for(const{r:O,i:M}of N)if(!await q(M,O))break;L(!1)}},R=p.useMemo(()=>{const N=new Set,O=[];return i.filter(M=>M.status==="kept").forEach(M=>{const V=M.name.trim().toLowerCase();V&&!N.has(V)&&(N.add(V),O.push(M.name.trim()))}),r.filter(M=>Ee(M)>=1&&Ee(M)<=4&&(M.website||M.domain)).forEach(M=>{const V=(M.name||"").trim().toLowerCase();V&&!N.has(V)&&(N.add(V),O.push((M.name||"").trim()))}),O},[i,r]),$=p.useMemo(()=>{const N=new Set;return r.forEach(O=>{const M=(O.name||"").trim().toLowerCase();M&&N.add(M)}),i.forEach(O=>{const M=O.name.trim().toLowerCase();M&&N.add(M)}),N},[r,i]),F=async()=>{if(u||!R.length)return;f(!1);const N=[];for(const O of R.slice(0,2)){b(O);const M=await so(n,O);if(M){if(M.verdict==="quota"){y(!0);break}(M.results||[]).forEach(V=>{const ae=(V.company||"").trim().toLowerCase();!ae||$.has(ae)||N.some(Z=>Z.name.toLowerCase()===ae)||N.push({name:(V.company||"").trim(),verdict:V.verdict||"",reason:V.reason,from:O})})}}b(""),f(!0),x(O=>[...N,...O].slice(0,24))},D=async(N,O)=>{if(u)return;f(!1),b(N==="thesis"?e.pxThesis:O);const M=await _i(n,N,O,6);if(b(""),f(!0),!M)return;if(M.verdict==="quota"){y(!0);return}const V=[];(M.results||[]).forEach(ae=>{const Z=(ae.company||"").trim().toLowerCase();!Z||$.has(Z)||V.some(ge=>ge.name.toLowerCase()===Z)||V.push({name:(ae.company||"").trim(),verdict:ae.verdict||"",reason:ae.reason,from:N==="thesis"?e.pxThesis:O})}),x(ae=>[...V,...ae].slice(0,24))},h=()=>{const N=v.trim();N.length<3||D(/^\d{2}\.?\d{2}[A-Za-z]?$/.test(N)?"registry":"keyword",N)},A=N=>{c(O=>[...O,{name:N.name,site:"",status:"",auto:!0}].slice(0,30)),x(O=>O.filter(M=>M.name!==N.name))},U=i.filter(N=>N.name.trim()&&N.status!=="kept"&&N.status!=="out").length,te=N=>N.name.trim()&&N.status!=="kept"&&N.status!=="out"&&N.status!=="resolving"&&!N.evalBusy;return t.jsxs("div",{className:"bulk on evalq",children:[t.jsxs("div",{className:"eq-rows",children:[t.jsxs("div",{className:"eq-head",children:[t.jsx("span",{children:e.eqColName}),t.jsx("span",{children:e.eqColSite}),t.jsx("span",{children:e.eqColDesc}),t.jsx("span",{children:e.eqColState}),t.jsx("span",{}),t.jsx("span",{})]}),i.map((N,O)=>t.jsxs("div",{className:"eq-row"+(N.status==="kept"?" r-kept":N.status==="out"?" r-out":""),children:[t.jsx("input",{value:N.name,placeholder:e.eqNamePh,onChange:M=>{const V=M.target.value.split(`
`).map(ae=>ae.trim()).filter(Boolean);V.length>1?c(ae=>{const Z=[...ae];return Z.splice(O,1,...V.map(ge=>({name:ge,site:"",status:"",auto:!0}))),Z.slice(0,30)}):k(O,{name:M.target.value})},onBlur:()=>{N.name.trim()&&!N.site&&N.status!=="resolving"&&N.status!=="pick"&&E(O,N.name)},onKeyDown:M=>{M.key==="Enter"&&E(O,N.name)}}),t.jsxs("span",{className:"eq-site",children:[N.status==="resolving"&&t.jsx("i",{className:"eq-spin",children:e.eqLookup}),N.status==="pick"&&(N.candidates||[]).map(M=>t.jsx("button",{type:"button",className:"eq-cand",onClick:()=>k(O,{site:M.url,status:"ready",candidates:void 0}),children:(M.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,24)},M.url)),N.status!=="resolving"&&N.status!=="pick"&&(N.site?t.jsxs("a",{href:N.site.startsWith("http")?N.site:"https://"+N.site,target:"_blank",rel:"nofollow noopener",children:[N.site.replace(/^https?:\/\/(www\.)?/,"").slice(0,28)," ↗"]}):t.jsx("em",{children:N.name.trim()&&N.status==="ready"?e.eqNoSite:""}))]}),t.jsx("span",{className:"eq-desc",title:N.desc||"",children:N.descBusy?t.jsx("i",{children:e.eqDescBusy}):N.desc?N.desc:t.jsx("em",{children:N.descDone?l?e.eqDescQuota:e.eqDescNone:""})}),t.jsx("span",{className:"eq-st s-"+(N.status||"vide"),title:N.reason||"",children:N.status==="kept"?"✓ "+e.kept:N.status==="out"?"✗ "+e.dropped:N.status==="ready"?e.eqReady:N.status==="pick"?e.eqPick:""}),t.jsx("button",{type:"button",className:"eq-go",title:e.eqRunOne,disabled:!te(N)||C,onClick:()=>{q(O,N)},children:N.evalBusy?"⏳":"⚡"}),t.jsx("button",{type:"button",className:"eq-x",title:"×",onClick:()=>c(M=>M.filter((V,ae)=>ae!==O)),children:"×"})]},O)),t.jsxs("button",{type:"button",className:"eq-add",onClick:()=>c(N=>[...N,{name:"",site:"",status:""}].slice(0,30)),children:["+ ",e.eqAdd]}),t.jsxs("div",{className:"eq-sugg",children:[t.jsx("button",{type:"button",className:"eq-sugg-go",disabled:!!u,onClick:()=>{D("thesis","")},children:u===e.pxThesis?e.sgBusy(u):e.pxGoThesis}),t.jsx("input",{className:"eq-sugg-in",value:v,placeholder:e.pxPlace,onChange:N=>j(N.target.value),onKeyDown:N=>{N.key==="Enter"&&h()}}),t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u||v.trim().length<3,onClick:h,children:e.pxGoFree}),!!R.length&&t.jsx("button",{type:"button",className:"eq-sugg-go2",disabled:!!u,onClick:()=>{F()},children:u&&u!==e.pxThesis&&u!==v?e.sgBusy(u):e.sgGo}),!!R.length&&t.jsx("span",{className:"eq-sugg-note",children:e.sgFrom(R[0],R.length)}),m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgQuota}),w&&!d.length&&!m&&t.jsx("span",{className:"eq-sugg-q",children:e.sgNone}),d.map(N=>t.jsxs("span",{className:"eq-sc"+(N.verdict==="kept"?" ok":""),title:(N.reason||"")+" — "+e.sgVia(N.from),children:[t.jsx("b",{children:N.name}),N.verdict==="kept"&&t.jsx("i",{children:"✓"}),t.jsx("button",{type:"button",onClick:()=>A(N),children:"+"})]},N.name))]})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(C?" loading":""),style:{justifyContent:"center"},disabled:C||!U,onClick:()=>{I()},children:[t.jsx("span",{className:"fill"}),C?e.eqRunning:e.eqGo(U)]}),t.jsx("span",{className:"hint",children:e.eqHint}),i.some(N=>N.status==="kept"||N.status==="out")&&t.jsx("button",{type:"button",className:"dmulti",onClick:()=>c(N=>N.filter(O=>O.status!=="kept"&&O.status!=="out")),children:e.eqClearDone})]})]})}function Ho(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function Ed(e){var o;const a=[],r=new Set,n=i=>{const c=(i||"").trim();!c||r.has(c.toLowerCase())||(r.add(c.toLowerCase()),a.push(c))};return((e==null?void 0:e.companies_cited)||[]).forEach(i=>n(i==null?void 0:i.name)),(((o=e==null?void 0:e.prospective)==null?void 0:o.companies_to_evaluate)||[]).forEach(i=>n(i==null?void 0:i.name)),a}function Ur({icon:e,title:a,hint:r,rows:n,addLabel:o,onEvaluate:i,onAddAll:c}){const{t:s}=Q();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),c&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>c(n.map(l=>l.name)),children:o})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(l=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:l.name}),l.chips.map(g=>t.jsx("span",{className:"ch",children:g},g))]}),l.line1&&t.jsx("p",{className:"w",children:l.line1}),l.line2&&t.jsx("p",{className:"r",children:l.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>i(l.name),children:s.rsEvalOne})]},l.name))})]}):null}function Vo({card:e,onEvaluate:a,onAddAll:r}){var c;const{t:n}=Q(),o=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),i=(((c=e==null?void 0:e.prospective)==null?void 0:c.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!o.length&&!i.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(Ur,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r}),t.jsx(Ur,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r})]})}function Sd({card:e,onEvaluate:a,onAddAll:r}){var s,l,g;const{t:n}=Q(),o=[e.industry,...e.market_tags||[],e.author].map(d=>(d||"").trim()).filter(Boolean),i=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),c=(e.sources||[]).filter(d=>d&&d.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),o.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),o.map(d=>t.jsx("span",{children:d},d))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ho(e.summary_md||"").map((d,x)=>t.jsx("p",{children:d},x))})]}),t.jsx(Vo,{card:e,onEvaluate:a,onAddAll:r}),(((l=e.prospective)==null?void 0:l.conclusion)||i.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((g=e.prospective)==null?void 0:g.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),i.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:i.map(d=>t.jsx("li",{children:d},d))})]})]}),c.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:c.length})]}),t.jsx("div",{className:"rssrc",children:c.map(d=>t.jsx("a",{href:d.url,target:"_blank",rel:"noopener noreferrer",children:d.label||d.url},d.url))})]})]})}function Cd(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function zd({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:o}){const{t:i,email:c}=Q(),s=o,[l,g]=p.useState(null),[d,x]=p.useState(null),[u,b]=p.useState(null),[m,y]=p.useState(!1);p.useEffect(()=>{let f=!0;return(async()=>{const v=await lo({email:c,cbToken:s});f&&g(v)})(),()=>{f=!1}},[c,s,n]);const w=f=>{x(f),b(null),y(!0),(async()=>{const v=await Bi(f.id);b(v),y(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[d?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),b(null)},children:i.rsArchBack}):t.jsxs("b",{children:["🗂 ",i.rsArchTitle]}),d&&t.jsx("span",{className:"ti",children:d.title}),!d&&l&&t.jsx("span",{className:"n",children:l.length}),t.jsx("button",{type:"button",className:"rsx",title:i.rsClose,onClick:e,children:"×"})]}),!d&&t.jsxs("div",{className:"rsarch-list",children:[l===null&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),l!==null&&l.length===0&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchEmpty}),(l||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>w(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[Cd(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:i.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?i.rsPub:i.rsPriv})]},f.id))]}),d&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[d.source_url&&t.jsx("a",{href:d.source_url,target:"_blank",rel:"noopener noreferrer",children:i.rsSource}),d.published&&d.page_url&&t.jsx("a",{href:d.page_url,target:"_blank",rel:"noopener noreferrer",children:i.rsLink}),t.jsx("span",{className:"st"+(d.published?" on":""),children:d.published?i.rsPub:i.rsPriv})]}),m&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchLoading}),!m&&!u&&t.jsx("p",{className:"rsarch-msg",children:i.rsArchGone}),!m&&u&&t.jsx(Sd,{card:u,onEvaluate:a,onAddAll:r})]})]})}const ka=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function Zt(e){return/^https?:\/\//i.test((e||"").trim())}function lt(e){const a=(e||"").trim();return a?Zt(a)?a:ka.test(a)&&!/\s/.test(a)?"https://"+a.replace(/^\/+/,""):"":""}function Ad(){return t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]})}function qd(){const{t:e,mode:a,token:r,email:n,askEvaluate:o,sessTally:i,dispatch:c,evalBusy:s,evalCards:l,caps:g,data:d,canWrite:x,source:u,dossiers:b,doAnalyse:m,liveMemos:y,pipe:w}=Q(),f=a==="client",v=p.useMemo(()=>r||(u!=="default"?$i():""),[r,u]),[j,k]=p.useState(""),[E,S]=p.useState(!1),[C,L]=p.useState(""),[q,I]=p.useState(""),[R,$]=p.useState(""),[F,D]=p.useState(!1),[h,A]=p.useState(!1),[U,te]=p.useState([]);p.useEffect(()=>{const P=ie=>{const pe=ie.detail;pe&&te(oe=>[pe,...oe].slice(0,8))};return window.addEventListener("ppmap:evalcard",P),()=>window.removeEventListener("ppmap:evalcard",P)},[]);const[N,O]=p.useState(!1),[M,V]=p.useState(!1),[ae,Z]=p.useState(!1),ge=p.useRef(!1),[J,me]=p.useState(""),[fe,he]=p.useState(""),[B,G]=p.useState(!1),[H,ee]=p.useState(!1),[_,ne]=p.useState(0),[se,ye]=p.useState(""),[le,be]=p.useState(null),[ce,ze]=p.useState(null),[Ke,ve]=p.useState(!1),[Se,Rt]=p.useState(null),[Me,Je]=p.useState(0),Ae=p.useRef(!1),it=j.trim()?ka.test(j.trim())?e.evalUrl:e.evalName:e.evalWaiting;p.useEffect(()=>{if(typeof window>"u")return;const P=new URLSearchParams(window.location.search),ie=(P.get("rs")||"").trim(),pe=(P.get("rstext")||"").trim();ie&&/^https?:\/\//i.test(ie)&&me(ie),pe&&he(pe),(ie&&/^https?:\/\//i.test(ie)||pe)&&O(!0)},[]),p.useEffect(()=>{const P=ie=>{const pe=ie.detail||{},oe=String(pe.url||"").trim(),we=String(pe.text||"").trim();oe&&/^https?:\/\//i.test(oe)&&me(oe),we&&he(we),(oe&&/^https?:\/\//i.test(oe)||we)&&(O(!0),k(""),L(""),G(!0),window.setTimeout(()=>G(!1),900))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),p.useEffect(()=>{const P=ie=>{const pe=ie.detail||{},oe=String(pe.name||"").trim();if(!oe)return;O(!1),k(oe),L(oe);const we=lt(String(pe.website||pe.domain||""));I(we),$(lt(String(pe.url||""))),D(!we),S(!0),window.setTimeout(()=>S(!1),900)};return window.addEventListener("ppmap:prefill",P),()=>window.removeEventListener("ppmap:prefill",P)},[]),p.useEffect(()=>{const P=(C||"").trim();if(!P||N||q){(q||!P||N)&&D(!1);return}const ie=b.find(we=>$e(we.name)===$e(P)),pe=lt((ie==null?void 0:ie.website)||"")||lt((ie==null?void 0:ie.domain)||"");if(pe){I(pe),D(!1);return}let oe=!0;return D(!0),Cn(P).then(we=>{var Ue,qe;if(!oe)return;const Pe=lt(we.website||"")||lt(((qe=(Ue=we.candidates)==null?void 0:Ue[0])==null?void 0:qe.url)||"");Pe&&I(Pe)}).catch(()=>{}).finally(()=>{oe&&D(!1)}),()=>{oe=!1}},[C,N,q,b]),p.useEffect(()=>{const P=ie=>{var oe;const pe=String(((oe=ie.detail)==null?void 0:oe.url)||"").trim();Zt(pe)&&window.open(pe,"_blank","noopener,noreferrer")};return window.addEventListener("ppmap:view",P),()=>window.removeEventListener("ppmap:view",P)},[]),p.useEffect(()=>{if(ge.current===N)return;ge.current=N,Z(!0);const P=window.setTimeout(()=>Z(!1),560);return()=>window.clearTimeout(P)},[N]),p.useEffect(()=>{if(typeof window>"u")return;const P=document.querySelector(".atl2 .eval-stick")||document.querySelector(".atl2 .demand"),ie=document.querySelector(".atl2.ops, .atl2.cibles");if(!P||!ie)return;const pe=()=>ie.style.setProperty("--demand-h",`${P.offsetHeight}px`);pe();const oe=new ResizeObserver(pe);return oe.observe(P),()=>oe.disconnect()},[u,E,B,h,N,ae,F]),p.useEffect(()=>{if(!x&&!v){Rt(null);return}let P=!0;return(async()=>{const ie=await lo({email:n,cbToken:v});P&&Rt(ie.length)})(),()=>{P=!1}},[x,v,n,Me]);const jt=U.length?U:l,Ie=d.credits,xt=p.useCallback(P=>{Nd(r,P)&&A(!0)},[r]);p.useEffect(()=>{if(!H)return;ne(0);const P=window.setInterval(()=>ne(ie=>ie+1),1e3);return()=>window.clearInterval(P)},[H]);const ut=p.useMemo(()=>{const P=j.trim().toLowerCase();return!P||!w?null:b.find(ie=>$e(ie.name)===P&&Ee(ie)===1)||null},[j,b,w]),Xe=()=>{const P=j.trim();if(P){if(ut){m(ut);return}o(null,P),f&&k("")}},Nt=async()=>{var pe,oe,we;if(Ae.current)return;const P=J.trim().replace(/\s+/g,""),ie=fe.trim();if(!P&&!ie){ye(e.rsNeed);return}if(!f&&!v){o(null,P||ie.slice(0,80));return}Ae.current=!0,ye(""),be(null),ze(null),ee(!0);try{const Pe=await Hi({url:P,text:ie,email:n,cbToken:v});if(ee(!1),!Pe||Pe.status!=="success"){ye((Pe==null?void 0:Pe.message)||"Erreur");return}be(Pe),O(!1),xt((((pe=Pe.prospective)==null?void 0:pe.companies_to_evaluate)||[]).map(qe=>(qe==null?void 0:qe.name)||"")),ze({state:"pending"});const Ue=await Vi(Pe,{email:n,cbToken:v});ze(Ue.ok?{state:"ok",scopeLabel:((oe=Ue.summary)==null?void 0:oe.scope_label)||"",scope:((we=Ue.summary)==null?void 0:we.scope)||""}:{state:"fail",msg:Ue.error||""}),Ue.ok&&Je(qe=>qe+1)}finally{Ae.current=!1,ee(!1)}},bt=[le==null?void 0:le.industry,...(le==null?void 0:le.market_tags)||[],le==null?void 0:le.author].map(P=>(P||"").trim()).filter(Boolean),vt=(ce==null?void 0:ce.state)==="pending",Ot=ce&&(vt?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):ce.state==="ok"?t.jsx("span",{className:"rslink ok",children:ce.scope&&ce.scope!=="public"?e.rsSavedIn(ce.scopeLabel||ce.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:ce.msg,children:e.rsSaveFail})),Et=Ed(le).length,Re=N,rt=(C||j).trim(),T=b.find(P=>$e(P.name)===$e(rt)),Y=lt(j)||q||lt((T==null?void 0:T.website)||"")||lt((T==null?void 0:T.domain)||""),K=R||lt((T==null?void 0:T.url)||""),de=ut?e.actAnalyse:rt?e.evalGoOn(rt.length>22?rt.slice(0,21)+"…":rt):e.evalGo,je=H?`${Ui(J.trim())==="youtube"&&J.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(_)}`:vt?e.rsSaving:e.rowExtract;return t.jsxs("div",{className:"demand"+(Re?" rs-mode":"")+(C&&j.trim()===C||E||B?" pair":"")+(E||B||ae?" echo":"")+(ae?" swap":""),children:[t.jsxs("div",{className:"drow"+((Re?B:E)||ae?" flash":"")+((Re?J.trim():ka.test(j.trim()))?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:Re?J:j,placeholder:Re?e.rsUrlPh:e.evalPh,autoComplete:"off",maxLength:Re?600:200,spellCheck:Re?!1:void 0,inputMode:Re?"url":void 0,onChange:P=>{if(Re){me(P.target.value);return}k(P.target.value),C&&P.target.value.trim()!==C&&(L(""),I(""),$(""),D(!1))},onKeyDown:P=>{P.key==="Enter"&&(Re?Nt():Xe())}}),t.jsx("span",{className:"detect"+(Re?" off":"")+(ka.test(j.trim())?" url":""),children:it})]}),t.jsx("span",{className:"dacts",children:Re?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(H?" loading":""),disabled:H||vt||!J.trim()&&!fe.trim(),onClick:()=>{Nt()},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:je})]}),t.jsxs("a",{className:"viewbtn"+(Zt(J)?"":" off"),href:Zt(J)?J.trim():void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewLinkHint,onClick:P=>{Zt(J)||P.preventDefault()},children:[t.jsx(Ad,{}),e.viewLink]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn"+(ut?" analyse":"")+(s?" loading":""),disabled:s,onClick:Xe,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"elab",children:de})]}),t.jsxs("a",{className:"viewbtn sm"+(F?" searching":Y?"":" off"),href:Y||void 0,target:"_blank",rel:"noopener noreferrer","aria-busy":F||void 0,title:F?e.viewSiteBusyHint:e.viewSiteHint,onClick:P=>{Y||P.preventDefault()},children:[F&&t.jsx("span",{className:"sitespin","aria-hidden":"true"}),F?e.viewSiteBusy:e.viewSite]}),t.jsx("a",{className:"viewbtn sm"+(K?"":" off"),href:K||void 0,target:"_blank",rel:"noopener noreferrer",title:e.viewSrcHint,onClick:P=>{K||P.preventDefault()},children:e.viewSrc})]})}),g.showCredits&&Ie&&t.jsxs("button",{type:"button",className:"credits"+(Ie.total_available<=0&&!Ie.unlimited?" empty":""),onClick:()=>c({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Ie.unlimited?"∞":Ie.total_available}),!Ie.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Ie.daily_grant+Ie.purchased]}),Ie.total_available<=0&&!Ie.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>A(!h),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(N?" on":""),onClick:()=>O(!N),children:e.rsOpen}),Se!==null&&Se>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(Ke?" on":""),onClick:()=>ve(!Ke),children:e.rsArchOpen(Se)})]}),Ke&&t.jsx(zd,{bump:Me,cbToken:v,onClose:()=>ve(!1),onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsx("div",{className:"rsp slim"+(N?" on":" off"),"aria-hidden":!N,children:t.jsxs("div",{className:"rsp-in",children:[t.jsxs("button",{type:"button",className:"rspaste",tabIndex:N?void 0:-1,onClick:()=>V(P=>!P),children:[e.rsOr," · ",e.rsTextPh,t.jsx("i",{children:M?"▴":"▾"})]}),M&&t.jsx("textarea",{className:"rstext",value:fe,placeholder:e.rsTextPh,tabIndex:N?void 0:-1,onChange:P=>he(P.target.value)})]})}),se&&t.jsx("div",{className:"rserr",children:se}),le&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:le.title}),le.source_url&&t.jsx("a",{href:le.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{be(null),ze(null)},children:"×"})]}),le.market&&t.jsx("p",{className:"rsmk",children:le.market}),bt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),bt.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[le.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${le.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:Ho(le.summary_md||"").map((P,ie)=>t.jsx("p",{children:P},ie))})]}),t.jsx(Vo,{card:le,onEvaluate:P=>o(null,P),onAddAll:xt}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Et)}),Ot]})]}),h&&t.jsx(Uo,{}),jt.slice(0,1).map((P,ie)=>{const pe=P.verdict==="kept",oe=P.verdict==="quota",we=P.verdict==="unresolved",Pe=pe?"var(--brand)":oe?"var(--bolt)":we?"var(--blue)":"var(--red)",Ue=pe?"var(--brand-l)":oe?"#FFF3D6":we?"#EEF4FF":"#FDECEC";return t.jsxs("div",{className:"result on",style:{"--c":Pe,"--bgc":Ue},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:pe?"✓ "+e.kept:oe?"⏳":we?"❓ "+e.evalPickChip:"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!!(P.candidates&&P.candidates.length)&&t.jsx("span",{className:"sitepick",children:P.candidates.map(qe=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:qe.url.startsWith("http")?qe.url:`https://${qe.url}`,target:"_blank",rel:"nofollow noopener",children:[(qe.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>o(null,qe.url,P.name),children:e.evalPickGo})]},qe.url))}),!oe&&!we&&t.jsx("button",{type:"button",className:"go",onClick:()=>{c({type:"ptab",tab:pe?1:5});const qe=(P.name||"").trim().toLowerCase();window.setTimeout(()=>{const He=[...document.querySelectorAll(".atl2 .list .row")].find(Pa=>{var Vt;return(((Vt=Pa.querySelector(".rnm"))==null?void 0:Vt.textContent)||"").trim().toLowerCase().includes(qe)});He&&(He.scrollIntoView({behavior:"smooth",block:"center"}),He.classList.add("flashrow"),window.setTimeout(()=>He.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(pe?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ie)}),f&&(i.kept+i.dropped>0||jt.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(i.kept,i.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>c({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function Td(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Ld(){const{st:e,dispatch:a,byId:r,t:n,doDeep:o}=Q(),i=e.memoConsole?r.get(e.memoConsole):null,c=p.useMemo(()=>i?[i.reasoning||"",Td(i.summary||"")].filter(Boolean).join(`
...
`).map((g,d)=>t.jsx("p",{style:{margin:"0 0 10px"},children:g},d)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[It(i)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>o(i),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:l===2?n.critMemoKinds:""}),i.memoUrl&&t.jsx("a",{className:"go",href:i.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function Fn({name:e}){const{t:a,token:r,caps:n,mode:o,flashErr:i}=Q(),[c,s]=p.useState(!1),[l,g]=p.useState(null),d=n.pipe&&o==="client"&&!n.lockActions,x=async()=>{if(!d||c)return;s(!0);const u=await so(r,e);if(s(!1),!u){i(a.actErr);return}g(u.results||[])};return p.useEffect(()=>{if(!d)return;const u=b=>{var y;const m=String(((y=b.detail)==null?void 0:y.name)||"").trim();m&&m.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",u),()=>window.removeEventListener("ppmap:similar",u)},[e,d]),p.useEffect(()=>{if(d)try{const u=(sessionStorage.getItem("pp:similar")||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,d]),d?t.jsxs("div",{className:"simb",onClick:u=>u.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:c,onClick:()=>{x()},children:c?a.similarBusy:a.similar}),l&&(l.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:l.map(u=>t.jsxs("li",{children:[t.jsx("b",{className:u.verdict==="kept"?"ok":"ko",children:u.company}),u.reason&&t.jsx("span",{children:u.reason})]},u.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const Fd=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),xa=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Rd(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const o=a.indexOf("<",n);if(o<0){r+=xa(a.slice(n));break}r+=xa(a.slice(n,o));const i=a.indexOf(">",o);if(i<0){r+=xa(a.slice(o));break}const c=a.slice(o+1,i).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(c),l=s?s[2].toLowerCase():"";s&&Fd.has(l)?r+=`<${s[1]}${l}>`:r+=xa(a.slice(o,i+1)),n=i+1}return r}const Od=new Set(["script","noscript","style","link","iframe","object","embed","form","input","select","textarea","button","meta","base","dialog","svg","math","template","video","audio","source"]),Hr={"*":new Set(["class","style","title","colspan","rowspan"]),img:new Set(["src","alt","width","height"]),a:new Set(["href"])};function Wo(e){var r;const a=Array.from(e.children);for(const n of a){const o=n.tagName.toLowerCase();if(Od.has(o)){n.remove();continue}for(const c of Array.from(n.attributes)){const s=c.name.toLowerCase();(!(Hr["*"].has(s)||((r=Hr[o])==null?void 0:r.has(s)))||s.startsWith("on"))&&n.removeAttribute(c.name)}const i=n.getAttribute("style")||"";if(i&&/position\s*:\s*(fixed|sticky)/i.test(i))n.removeAttribute("style");else if(i){const c=i.split(";").filter(s=>s.trim()&&!/^\s*(font-size|font-family|line-height|font)\s*:/i.test(s)).join(";");c!==i&&(c?n.setAttribute("style",c):n.removeAttribute("style"))}if(o==="a"){const c=(n.getAttribute("href")||"").trim();/^(https?:|mailto:)/i.test(c)?(n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")):n.removeAttribute("href")}if(o==="img"){const c=(n.getAttribute("src")||"").trim();if(!/^https?:/i.test(c)){n.remove();continue}n.setAttribute("loading","lazy")}Wo(n)}}function Xa(e){const a=e.cloneNode(!0);return Wo(a),a.querySelectorAll("[id]").forEach(r=>r.removeAttribute("id")),a.removeAttribute("id"),a.innerHTML}const Za=new Map;function Md(e){const a=(e||"").trim();if(!/^https?:/i.test(a))return Promise.resolve(null);let r=Za.get(a);return r||(r=Dd(a).catch(()=>null),r.then(n=>{n||Za.delete(a)}),Za.set(a,r)),r}async function Dd(e){var x,u;const a=await fetch(e,{credentials:"omit"});if(!a.ok)return null;const r=new DOMParser().parseFromString(await a.text(),"text/html"),n=b=>{var m;return(((m=r.querySelector(b))==null?void 0:m.textContent)||"").trim()},o=r.querySelector(".sb-score"),i=((x=Array.from((o==null?void 0:o.classList)||[]).find(b=>b.startsWith("sb-score-")))==null?void 0:x.slice(9))||"",c=[];let s=null;const l=Array.from(r.querySelectorAll(".sidebar .sb-nav-heading, .sidebar a.nav-item"));for(const b of l){if(b.classList.contains("sb-nav-heading")){s={label:(b.textContent||"").trim(),items:[]},c.push(s);continue}const m=b.getAttribute("href")||"";if(!m.startsWith("#"))continue;const y=m.slice(1),w=Id(r,y);w&&(s||(s={label:"",items:[]},c.push(s)),s.items.push({id:y,title:(b.textContent||"").trim(),html:w,poids:w.length}))}const g=((u=/\/([a-z0-9-]+)-v2(?:\.html)?\/?$/i.exec(e))==null?void 0:u[1])||"",d={score:n(".sb-score"),scoreTone:i,tags:Array.from(r.querySelectorAll(".sb-tag")).map(b=>(b.textContent||"").trim()).filter(Boolean),name:n(".sidebar-company-name"),tagline:n(".sidebar-tagline"),desc:n(".meta-desc"),groups:c.filter(b=>b.items.length),mindmapSlug:r.querySelector(".cm-mindmap-png")?g:""};return d.groups.length?d:null}const Vr={"fiche-contact":"[data-ct-card]","fiche-attaque":"[data-ct-card]"};function Id(e,a){const r=e.getElementById(a),n=r?Wr(e,r):"";if(n)return n;const o=Vr[a]?e.querySelector(Vr[a]):null;return o&&o!==r?Wr(e,o):""}function Wr(e,a){var r,n;if(a.classList.contains("section-container")){const o=a.cloneNode(!0);return(r=o.querySelector("h2.section-title"))==null||r.remove(),Xa(o)}if(/^h\d$/i.test(a.tagName)){const o=e.createElement("div"),i=Array.from(((n=a.parentElement)==null?void 0:n.children)||[]);if(i.filter(l=>/^h3$/i.test(l.tagName))[0]===a)for(const l of i){if(l===a)break;/^h2$/i.test(l.tagName)||o.appendChild(l.cloneNode(!0))}let s=a.nextElementSibling;for(;s&&!/^h3$/i.test(s.tagName);)o.appendChild(s.cloneNode(!0)),s=s.nextElementSibling;return o.children.length?Xa(o):""}return Xa(a)}const en=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Ze({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Gr(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function Yr({v:e,sur:a,k:r}){const n=e>=80?"green":e>=55?"blue":e>=35?"amber":"red";return t.jsxs("span",{className:`md-score md-${n}`,title:r,children:[Math.round(e*10)/10,a?`/${a}`:""]})}const tn=new Map;function Pd(e,a){const{token:r}=Q(),[n,o]=p.useState(null);return p.useEffect(()=>{if(!a||!r||!e.name)return;const i=`${r}:${e.id}:${e.checkId||""}`;let c=tn.get(i);c||(c=Wi(r,e.name,e.checkId),tn.set(i,c),c.then(l=>{(!l||!l.reasoning&&!l.summaryHtml)&&tn.delete(i)}));let s=!0;return c.then(l=>{s&&l&&o({id:e.id,d:l})}),()=>{s=!1}},[a,r,e.id,e.name,e.checkId]),n&&n.id===e.id?n.d:null}const _d=6e4;function Bd({o:e}){const{t:a,doDeep:r}=Q(),[n,o]=p.useState(null),[i,c]=p.useState(e.memoUrl?"load":"off"),[s,l]=p.useState(()=>new Set),[g,d]=p.useState(!1),x=p.useRef(new Map);p.useEffect(()=>{let y=!0;if(l(new Set),d(!1),x.current=new Map,!e.memoUrl){c("off"),o(null);return}return c("load"),o(null),Md(e.memoUrl).then(w=>{y&&(o(w),c(w?"ok":"err"))}),()=>{y=!1}},[e.memoUrl]);const u=kt(e),b=y=>{var w;return(w=x.current.get(y))==null?void 0:w.scrollIntoView({behavior:"smooth",block:"start"})},m=t.jsxs("div",{className:"cdacts",children:[It(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:y=>{y.stopPropagation(),r(e)},children:a.memoDeep}),e.memoPdfUrl&&t.jsx("a",{className:"btn d",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:"PDF ↗"})]});if(i==="off"){const y=[e.reasoning||"",Gr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[y.length?y.join(`

`).split(`

`).map((w,f)=>t.jsx("p",{className:"cdtxt",children:w},f)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),m]})}if(i!=="ok"){const y=[e.reasoning||"",Gr(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsx("p",{className:"mnote dim",children:i==="load"?a.memoLoading:a.memoLoadErr}),y.length>0&&y.join(`

`).split(`

`).map((w,f)=>t.jsx("p",{className:"cdtxt",children:w},f)),i==="err"&&e.memoUrl&&t.jsx("div",{className:"cdacts",children:t.jsx("button",{type:"button",className:"btn b",onClick:w=>{w.stopPropagation(),d(f=>!f)},children:g?a.memoHideHere:a.memoReadHere})}),g&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:w=>w.stopPropagation()}),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:w=>w.stopPropagation(),children:a.memoOpenFull})]})}return t.jsxs("div",{className:"cdmemo memodoc",children:[u&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:u}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head",children:[n.score&&t.jsx("span",{className:"md-score"+(n.scoreTone?` md-${n.scoreTone}`:""),children:n.score}),n.tags.map(y=>t.jsx("span",{className:"md-tag",children:y},y)),n.tagline&&t.jsx("p",{className:"md-tagline",children:n.tagline})]}),t.jsx("div",{className:"md-toc",children:n.groups.map(y=>y.items.map(w=>t.jsx("button",{type:"button",className:"md-jump",onClick:f=>{f.stopPropagation(),b(w.id)},children:w.title},w.id)))}),n.groups.map((y,w)=>t.jsxs("div",{className:"md-grp",children:[y.label&&t.jsx("div",{className:"md-grp-h",children:y.label}),y.items.map(f=>{const v=f.poids>_d&&!s.has(f.id),j=f.id==="fiche-contact"||f.id==="fiche-attaque";return t.jsxs("section",{className:"md-sec",ref:k=>{k&&x.current.set(f.id,k)},children:[t.jsx("h4",{className:"md-h",children:f.title}),j&&(e.contactName||e.contactEmail||e.contactLinkedin)&&t.jsxs("div",{className:"md-ctc",children:[t.jsx("span",{className:"cdk",children:a.mdContactKnown}),e.contactName&&t.jsx("b",{children:e.contactName}),e.contactEmail&&t.jsx("a",{href:`mailto:${e.contactEmail}`,onClick:k=>k.stopPropagation(),children:e.contactEmail}),e.contactLinkedin&&t.jsx("a",{href:e.contactLinkedin,target:"_blank",rel:"noopener noreferrer",onClick:k=>k.stopPropagation(),children:"LinkedIn"})]}),v?t.jsx("button",{type:"button",className:"abtn md-more",onClick:k=>{k.stopPropagation(),l(E=>new Set(E).add(f.id))},children:a.memoUnfold(Math.round(f.poids/1024))}):t.jsx("div",{className:"md-body",dangerouslySetInnerHTML:{__html:f.html}}),!v&&n.mindmapSlug&&f.html.includes("cm-mindmap-png")&&t.jsxs(t.Fragment,{children:[t.jsx("h4",{className:"md-h md-mm-h",children:a.mdMindmap(n.name||e.name)}),t.jsx("iframe",{className:"md-mm",loading:"lazy",title:a.mdMindmap(n.name||e.name),src:`${Da}/cibles/mindmap-view?slug=${encodeURIComponent(n.mindmapSlug)}`,onClick:k=>k.stopPropagation()})]})]},f.id)})]},y.label||w)),m,e.memoUrl&&t.jsx("a",{className:"btn p mdfull",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:y=>y.stopPropagation(),children:a.memoOpenFull})]})}function $d({o:e}){const{t:a,token:r,caps:n,canWrite:o,flash:i,flashErr:c,lang:s}=Q(),[l,g]=p.useState(!1),[d,x]=p.useState(!1),[u,b]=p.useState(!1),[m,y]=p.useState(null),[w,f]=p.useState(""),[v,j]=p.useState(null),[k,E]=p.useState(""),S={airtableId:e.airtableId,checkId:e.checkId},C=!!(e.airtableId||e.checkId),L=m&&m.id===e.id?m.entries:[],q=!!m&&m.id===e.id;if(p.useEffect(()=>{f(""),j(null),b(!1)},[e.id]),p.useEffect(()=>{if(!l||q||!C||!o)return;let R=!0;x(!0),b(!1);const $=e.id;return Kn(r,"list",S).then(F=>{if(!(!R||$!==e.id)){if(x(!1),!F.ok){b(!0);return}y({id:$,entries:F.entries})}}),()=>{R=!1}},[l,q,C,r,e.id,o]),!n.pipe||!o||!C)return null;const I=(R,$)=>{x(!0);const F=e.id;Kn(r,R,S,$).then(D=>{if(F===e.id){if(x(!1),!D.ok){c(a.notesErr);return}y({id:F,entries:D.entries}),b(!1),R==="add"&&(f(""),i(a.notesAdded)),R==="edit"&&j(null)}})};return t.jsxs("div",{className:"dnotes",children:[t.jsxs("button",{type:"button",className:"dn-h","aria-expanded":l,onClick:R=>{R.stopPropagation(),g($=>!$)},children:[t.jsx("b",{children:a.notesT}),L.length>0&&t.jsx("span",{className:"dn-n",children:a.notesCount(L.length)}),t.jsx("i",{children:l?"▾":"▸"})]}),l&&t.jsxs("div",{className:"dn-b",onClick:R=>R.stopPropagation(),children:[t.jsx("p",{className:"mnote dim",children:a.notesHint}),d&&!L.length&&t.jsx("p",{className:"mnote",children:a.notesLoading}),u&&t.jsx("p",{className:"mnote warn",children:a.notesErr}),!d&&!u&&q&&!L.length&&t.jsx("p",{className:"mnote dim",children:a.notesEmpty}),L.map(R=>t.jsxs("div",{className:"dn-e",children:[t.jsx("span",{className:"dn-d",children:s==="fr"?R.date.split("-").reverse().join("/"):R.date}),v===R.id?t.jsxs(t.Fragment,{children:[t.jsx("textarea",{maxLength:4e3,value:k,rows:3,onChange:$=>E($.target.value)}),t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"abtn",disabled:d||!k.trim(),onClick:()=>I("edit",{entryId:R.id,text:k.trim()}),children:a.notesSave}),t.jsx("button",{type:"button",className:"lk",onClick:()=>j(null),children:a.notesCancel})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"dn-t",children:R.text}),o&&t.jsxs("div",{className:"dn-a",children:[t.jsx("button",{type:"button",className:"lk",onClick:()=>{j(R.id),E(R.text)},children:a.notesEdit}),t.jsx("button",{type:"button",className:"lk",disabled:d,onClick:()=>{window.confirm(a.notesDelAsk)&&I("delete",{entryId:R.id})},children:a.notesDel})]})]})]},R.id)),o&&t.jsxs("div",{className:"dn-new",children:[t.jsx("textarea",{maxLength:4e3,rows:2,placeholder:a.notesPh,value:w,onChange:R=>f(R.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:d||!w.trim(),onClick:()=>I("add",{text:w.trim()}),children:a.notesAdd})]})]})]})}function Rn({o:e}){var E;const{t:a,lang:r,dispatch:n,caps:o,canWrite:i,doRegen:c}=Q(),s=sa(e),l=kt(e),g=(e.cribleStatus||"").trim().toUpperCase()||(s==="NO MATCH"?"NO MATCH":s==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,x=[e.contactName,e.contactEmail,e.contactLinkedin,e.contactPhone].filter(Boolean).length,u=[e.ceoStatus,e.ceoNote,o.pipe?e.memoUrl:"",o.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0)+(i&&o.pipe&&(e.airtableId||e.checkId)?1:0),b=p.useMemo(()=>[{k:"eval",lib:a.cdEvaluation,n:(g?1:0)+(e.reasoning?1:0)+(o.pipe&&!o.lockActions&&!e.memoUrl?1:0)+(typeof e.engagement=="number"&&e.engagement>0?1:0)},{k:"conv",lib:a.cdConviction,n:(l?1:0)+(e.summary?1:0)+(typeof e.convictionScore=="number"?1:0)},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||It(e)?1:0},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:x},{k:"suivi",lib:a.cdSuivi,n:u}].filter(S=>S.n>0),[e,a,o,g,l,d,x,u]),[m,y]=p.useState(""),w=b.some(S=>S.k===m)?m:((E=b[0])==null?void 0:E.k)||"",f=Pd(e,w==="eval"||w==="conv");if(!b.length)return null;const v=((f==null?void 0:f.reasoning)||"").length>(e.reasoning||"").length?f.reasoning:e.reasoning||"",j=((f==null?void 0:f.summaryHtml)||"").length>(e.summary||"").length?f.summaryHtml:e.summary||"",k=(f==null?void 0:f.convictionScore)??e.convictionScore;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:b.map(S=>t.jsx("button",{type:"button",role:"tab","aria-selected":w===S.k,"data-tour":"tab-"+S.k,className:w===S.k?"on":"",onClick:C=>{C.stopPropagation(),y(S.k)},children:S.lib},S.k))}),t.jsxs("div",{className:"cdbody",onClick:S=>S.stopPropagation(),children:[w==="eval"&&t.jsxs(t.Fragment,{children:[g&&t.jsxs("div",{className:"cdv1"+(g==="NO MATCH"?" out":""),children:[t.jsx("b",{children:g==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof e.score=="number"&&t.jsx(Yr,{v:e.score,sur:100,k:a.cdScore}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs("span",{className:"md-score md-amber",title:a.cdEngagementHint,children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]}),e.angle&&t.jsx("span",{className:"md-tag",children:e.angle})]}),v&&v.split(`

`).map((S,C)=>t.jsx("p",{className:"cdtxt",children:S},C)),typeof e.engagement=="number"&&e.engagement>0&&t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint}),o.pipe&&!o.lockActions&&!e.memoUrl&&t.jsx(Ud,{o:e})]}),w==="conv"&&t.jsxs(t.Fragment,{children:[l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"md-head evalhead",children:[typeof k=="number"&&t.jsx(Yr,{v:k,sur:100,k:a.cdConvScore}),en(e.verdictDate,r)&&t.jsxs("span",{className:"md-tag",children:[a.cdVerdictDate," ",en(e.verdictDate,r)]})]}),j&&t.jsx("div",{className:"cdrich convrich",dangerouslySetInnerHTML:{__html:Rd(j)}})]}),w==="memo"&&t.jsx(Bd,{o:e}),w==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ze,{k:a.cdSector,v:e.sector}),t.jsx(Ze,{k:a.cdStage,v:e.stage}),t.jsx(Ze,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Ze,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Ze,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Ze,{k:a.cdAngle,v:e.angle}),t.jsx(Ze,{k:a.cdDetected,v:en(e.date,r)})]}),w==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Ze,{k:a.cdName,v:e.contactName}),t.jsx(Ze,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Ze,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin}),t.jsx(Ze,{k:a.cdPhone,v:e.contactPhone,href:e.contactPhone?`tel:${e.contactPhone.replace(/[^+0-9]/g,"")}`:void 0})]}),w==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"cdgrid",children:t.jsx(Ze,{k:a.cdCeoStatus,v:e.ceoStatus})}),typeof e.engagement=="number"&&e.engagement>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"md-head evalhead",children:t.jsxs("span",{className:"md-score md-amber",children:[e.engagement>=20?"🔥 ":"",a.cdEngagement," ",Math.round(e.engagement*10)/10]})}),t.jsx("p",{className:"mnote dim",children:a.cdEngagementHint})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),t.jsx($d,{o:e}),o.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemoOf(e.memoType)," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"}),i&&e.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(e),children:a.actRegen})]})]})]})]})}const ba=new Map;function Ud({o:e}){const{t:a,token:r}=Q(),[n,o]=p.useState(!1),[i,c]=p.useState(null);p.useEffect(()=>{if(!r||!e.name)return;const x=`${r}:${e.name.toLowerCase()}`;let u=ba.get(x);u||(u=co(r,[e.name]).then(m=>m[e.name]||Object.values(m)[0]||null).catch(()=>null),ba.set(x,u),u.then(m=>{(!m||!m.ok)&&ba.delete(x)}));let b=!0;return u.then(m=>{b&&m&&m.ok&&c(m)}),()=>{b=!1}},[r,e.id,e.name]);const s=async()=>{if(n)return;o(!0);const x=await oo(r,e.name,e.website||e.domain||"");c(x),x.ok&&ba.set(`${r}:${e.name.toLowerCase()}`,Promise.resolve(x)),o(!1)},l=(i==null?void 0:i.blocs)||{},g=[[a.qaVP,l.value_prop],[a.qaProduct,l.produit],[a.qaModel,l.modele],[a.qaSummary,l.synthese]],d=g.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!i&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),i&&d&&t.jsxs(t.Fragment,{children:[g.filter(([,x])=>x).map(([x,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:u})]},x)),!!(i.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((i.pages||[]).length)})]}),i&&!d&&t.jsx("p",{className:"mnote warn",children:i.quota?a.qaQuota:a.qaEmpty})]})}function la({spec:e}){const a=p.useRef(null),r=p.useRef(null),[n,o]=p.useState(!1);return p.useEffect(()=>{const i=a.current;if(!i)return;let c=!1;const s=()=>{const g=Math.max(280,Math.min(560,i.clientWidth||320));Jn({kind:"op",card:e},g).then(d=>{!c&&d&&i.isConnected&&i.replaceChildren(d)})},l=window.requestAnimationFrame(s);return()=>{c=!0,window.cancelAnimationFrame(l),i.replaceChildren()}},[e]),p.useEffect(()=>{if(!n)return;const i=r.current;if(!i)return;let c=!1;Jn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(l=>{!c&&l&&i.isConnected&&i.replaceChildren(l)});const s=l=>{l.key==="Escape"&&o(!1)};return document.addEventListener("keydown",s),()=>{c=!0,document.removeEventListener("keydown",s)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>o(!0)}),n&&$t.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>o(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>o(!1),children:"×"})]})}),document.body)]})}const Hd=`
...
`;function Vd(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,o=window.innerWidth,i=window.innerHeight,c=Math.min(Math.max(e.x-r/2,8),Math.max(8,o-r-8));let s=e.y+10;return s+n>i-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:c,top:s}}function Wd(){const{st:e,dispatch:a,byId:r,t:n,lang:o,caps:i,mode:c,askEvaluate:s,doAnalyse:l,doDecide:g,doPromote:d,doRepeche:x,doApproach:u,doDeep:b,doOnboard:m,outbound:y,evalBusy:w}=Q(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const v=De(f),j=Ee(f),k=kt(f),E=sa(f),S=f.kind==="target",C=L=>{a({type:"filters",patch:L}),a({type:"popup",id:null})};return $t.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Hd}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Vd(e.popupAnchor,!!f.card),onClick:L=>L.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(gt(f.date)),Qe(f.engine,o))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>C({country:[f.cc]}),children:(Ut(f.cc,o)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>C({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>C({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Ht(f.amountEur,o)})]}),i.pipe&&S&&t.jsxs("div",{className:"pstat",children:[E&&t.jsx("span",{className:"vd "+(E==="MATCH"?"v-ok":"v-no"),title:n.vt[E],children:E}),k&&t.jsx("span",{className:"vd v-cons",title:n.vt[k],children:k}),t.jsx("span",{className:"pstep",children:n.plabels[j]}),f.ceoStatus&&t.jsx("span",{className:"pstep own",children:f.ceoStatus})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[qt(f.engine)," ",t.jsx("b",{children:Qe(f.engine,o)})," — ",Gi(f.engine,o),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),v?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(wt,{o:f,lg:!0})," ",t.jsx(Ia,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(po(v,o))," · ",n.win7(uo(v,o))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(la,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:i.pipe&&j>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),i.pipe&&S&&k&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[k,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})}),i.pipe&&S&&t.jsx(Rn,{o:f})]}),t.jsx(Fn,{name:f.name}),t.jsxs("div",{className:"pf",children:[i.lockActions||c!=="client"&&i.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):i.pipe?t.jsxs(t.Fragment,{children:[j===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),j===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{l(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),j===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),j===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{g(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{g(f,!1),a({type:"popup",id:null})},children:n.actNo}),It(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{b(f),a({type:"popup",id:null})},children:n.memoDeep})]}),j===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),j===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),y&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{m(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&i.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var L;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(L=document.querySelector(".atl2 .demand"))==null||L.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:w,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:w,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}function Gd(){const{lang:e,token:a,dossiers:r,caps:n}=Q(),o=a||"home",{names:i,verdicts:c}=p.useMemo(()=>{const l=[],g={};return r.forEach(d=>{d.kind!=="target"||!d.name||(l.push(d.name),g[d.name]=Yi(d)||"")}),{names:l,verdicts:g}},[r]);return{diff:p.useMemo(()=>i.length?Qi(o,i,c,e):null,[o,i.length]),names:i,verdicts:c,scope:o,caps:n}}function Yd(){const{st:e,dispatch:a,counts:r,t:n,doUndo:o,data:i,dossiers:c,caps:s}=Q(),[l,g]=p.useState(!1),[d,x]=p.useState(!1),u=p.useRef(null);p.useEffect(()=>{if(!l)return;const j=k=>{u.current&&!u.current.contains(k.target)&&g(!1)};return document.addEventListener("click",j,!0),()=>document.removeEventListener("click",j,!0)},[l]);const b=[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...s.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]],m=i.loading&&!c.length,y=p.useRef({});p.useEffect(()=>{y.current={...r}},[r]);const w=j=>{const k=y.current[j],E=k!==void 0?r[j]-k:0;return t.jsxs("button",{type:"button",className:"step"+(j===3&&r[3]>0?" wait":""),style:{"--c":`var(${ea[j]})`,"--tc":j<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsxs("span",{className:"l",children:[n.plabels[j],j===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(E>0?" up":E<0?" down":""),children:[r[j],E!==0&&t.jsxs("em",{className:"delta",children:[E>0?"+":"−",Math.abs(E)]})]})]},j)},f=(j,k,E)=>t.jsxs("button",{type:"button",className:"off"+(k?" view":""),style:{"--c":`var(${ea[j]})`},"aria-selected":e.ptab===j,title:n.phelp[j],onClick:()=>{try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}a({type:"ptab",tab:j})},children:[t.jsx("span",{className:"l",children:E}),t.jsx("span",{className:"n",children:r[j]})]},j),v=(j,k,E,S=!1)=>t.jsx("button",{type:"button",className:"tool",title:k,disabled:S,onClick:E,children:j},k);return t.jsxs("div",{className:"funnel"+(m?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(w)}),t.jsxs("div",{className:"offtrack",children:[f(5,!1,n.plabels[5]),f(7,!0,n.plabels[7]),f(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",style:{marginLeft:"auto"},children:[v("↩",n.toolUndo,o,e.undo.length===0),t.jsx("button",{type:"button",className:"tool"+(d?" spin":""),title:n.toolReset,onClick:()=>{a({type:"reset"});try{window.dispatchEvent(new CustomEvent("ppmap:tunnel"))}catch{}x(!0),window.setTimeout(()=>x(!1),600)},children:"↺"}),t.jsxs("span",{className:"fsort",ref:u,children:[t.jsx("button",{type:"button",className:"tool","aria-pressed":l,title:n.toolSort,onClick:()=>g(j=>!j),children:"⇅"}),l&&t.jsx("span",{className:"sortmenu",role:"listbox",children:b.map(([j,k])=>t.jsxs("button",{type:"button",role:"option","aria-selected":e.sort.key===j,className:"sortopt"+(e.sort.key===j?" on":""),onClick:()=>a({type:"sort",key:j}),children:[k,t.jsx("i",{children:e.sort.key===j?e.sort.dir===1?"↑":"↓":""})]},j))})]}),v("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),v("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function Qd(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:o,doAnalyse:i,mode:c}=Q(),s=p.useRef(null),[l,g]=p.useState(60);p.useEffect(()=>{let m=0;const y=()=>{var k;const w=s.current;if(!w)return;const f=(k=w.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!f)return;const v=f.getBoundingClientRect(),j=w.getBoundingClientRect();g(Math.max(20,Math.min(v.left+v.width/2-j.left,j.width-30)))};return m=requestAnimationFrame(y),window.addEventListener("resize",y),()=>{cancelAnimationFrame(m),window.removeEventListener("resize",y)}},[e.ptab]);const d=e.ptab;let x=r.tuto[d].p;if(d===3){const m=n.filter(f=>f.kind==="target"&&Ee(f)===3),y=m.filter(f=>on(f)==="auto").length,w=m.filter(f=>on(f)==="cd").length;x=r.tutoPending(y,w,m.length)}const u=(()=>{if(c!=="client")return null;if(d===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(m=>m.id)})};if(d===1){const m=n.filter(y=>y.kind==="target"&&Ee(y)===1&&!o.has(y.id)).slice(0,10);if(m.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:m.map(y=>y.id)})}}return null})(),b=Ki(d);return t.jsxs("div",{ref:s,className:"tuto mini"+(b?"":" on-dark"),style:{"--bg":`var(${ea[d]})`,"--ax":l+"px","--stc":b?"var(--ink)":"#fff","--stt":b?"#fff":"var(--ink)","--tc":b?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[d].toUpperCase()}),t.jsx("span",{className:"tbody",dangerouslySetInnerHTML:{__html:x}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}const an=600,zt=62,Qr="atl2:fstats";function Kd(){const{t:e,lang:a,data:r,caps:n,st:o,dispatch:i}=Q(),[c,s]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Qr)==="on"}catch{return!1}}),l=r.stats,g=p.useMemo(()=>((l==null?void 0:l.by_day)||[]).slice(-30),[l]),d=(l==null?void 0:l.since)||"";if(!n.showFunnel||!l||typeof l.screened!="number")return null;const x=E=>a==="en"?E.slice(5,10):`${E.slice(8,10)}/${E.slice(5,7)}`,u=E=>E.toLocaleString(a==="en"?"en-US":"fr-FR"),b=g.reduce((E,S)=>Math.max(E,S.s||0),0),m=g.length?an/g.length:0,y=Math.max(4,m-4),w=g.length>=5&&b>0,f=r.marketEstimate||0,v=x(new Date().toISOString().slice(0,10)),j=E=>[...typeof E=="number"?[[E,e.funScreened("","")]]:[],...typeof l.kept=="number"?[[l.kept,e.funKept]]:[],...typeof l.analyzed=="number"?[[l.analyzed,e.funAnalyzed]]:[],...typeof l.shown=="number"?[[l.shown,e.funShown]]:[]],k=[];return typeof l.screened_window=="number"&&d&&k.push({cle:"fenetre",periode:e.funPerWindow(x(d),v),etapes:[[l.screened_window,e.funScreened("","")]]}),typeof l.screened=="number"&&k.push({cle:"total",periode:e.funPerAll,etapes:j(l.screened)}),t.jsxs("div",{className:"fstats"+(c?" on":""),children:[k.map(E=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:E.periode}),E.etapes.map(([S,C],L)=>t.jsxs("span",{className:"fst-t",children:[L>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(S)}),t.jsx("i",{children:C})]},E.cle+C)),E.cle==="total"&&f>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(u(f),Math.min(100,Math.round((l.screened||0)/f*100)))})]}),E.cle===k[k.length-1].cle&&w&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":c,title:c?e.fstatsHide:e.fstatsShow,onClick:()=>{const S=!c;s(S),S&&!o.mapFolded&&i({type:"mapFold",folded:!0});try{localStorage.setItem(Qr,S?"on":"off")}catch{}},children:c?"⌃":"⌄"})]},E.cle)),c&&w&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#0E7F3F"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${an} ${zt}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[g.map((E,S)=>{const C=(E.s||0)/b*(zt-4),L=(E.m||0)/b*(zt-4),q=S*m+(m-y)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(E.d)} — ${E.s} ${e.actScreened} · ${E.m} ${e.actKept}`}),t.jsx("rect",{x:q,y:zt-2-C,width:y,height:C,fill:"#cfe0d6"}),t.jsx("rect",{x:q,y:zt-2-L,width:y,height:L,fill:"#0E7F3F"})]},E.d)}),t.jsx("line",{x1:0,y1:zt-1.5,x2:an,y2:zt-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(g[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const Go={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function On({o:e,locked:a=!1}){const{t:r}=Q(),n=sa(e),o=kt(e),i=Ee(e),c=on(e),s=Ji(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),o?t.jsx("span",{className:"vd "+(Go[o]||"v-cons"),title:r.vt[o],children:o}):i===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,i===3&&c==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),i===3&&c==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),i===3&&s!==null&&t.jsx("span",{className:"wait2 "+(s>10?"hot":s>=5?"warm":""),title:r.waitTitle(s),children:r.waitChip(s)}),!a&&t.jsx(xl,{o:e})]})}const Bt=e=>e.length>22?e.slice(0,21)+"…":e;function ia(e){const a=(e.url||"").trim(),r=[e.headline,e.tagline].filter(n=>n&&n!==e.name).join(`
`);if(!(!a&&!r))try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:a,text:r}}))}catch{}}function Yo(){let e=0;return document.querySelectorAll("body.pp-desk .pph, body.pp-desk .pp-nav, body.pp-desk .pp-band, .atl2.ops .eval-stick, .atl2.ops .listhead, .atl2.cibles .eval-stick, .atl2.cibles .listhead").forEach(a=>{const r=a.getBoundingClientRect();r.height<4||r.top<window.innerHeight*.55&&r.bottom>e&&(e=r.bottom)}),e}function Jd({on:e,rev:a}){const[r,n]=p.useState(null),[o,i]=p.useState({top:0,left:0,width:0});return p.useEffect(()=>{if(!e){n(null);return}const c=()=>{var m,y,w;const s=document.querySelector(".atl2.ops .desk-list"),l=document.querySelector(".atl2.ops .listhead");if(!s){n(null);return}const g=s.getBoundingClientRect(),d=l?l.getBoundingClientRect().bottom:g.top;i({top:Math.round(d),left:Math.round(g.left),width:Math.round(g.width)});const x=[...s.querySelectorAll(":scope .grp")];let u=null;for(const f of x){const v=f.querySelector(".grp-h");v&&v.getBoundingClientRect().bottom<=d+2&&(u=f)}if(!u){n(null);return}const b=u.querySelector(".grp-h");if(!b){n(null);return}n({ic:(((m=b.querySelector(".ic"))==null?void 0:m.textContent)||"").trim(),t:(((y=b.querySelector(".t"))==null?void 0:y.textContent)||"").trim(),s:(((w=b.querySelector(".s"))==null?void 0:w.textContent)||"").trim()})};return c(),window.addEventListener("scroll",c,{passive:!0}),window.addEventListener("resize",c),()=>{window.removeEventListener("scroll",c),window.removeEventListener("resize",c)}},[e,a]),!e||!r||o.width<80?null:t.jsxs("div",{className:"grp-pin",style:{top:o.top,left:o.left,width:o.width},children:[t.jsx("span",{className:"ic",children:r.ic}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:r.t}),t.jsx("div",{className:"s",children:r.s})]})]})}function Xd(e){const r=()=>{const n=Yo(),o=e.getBoundingClientRect().top-n-8;Math.abs(o)<2||window.scrollBy({top:o,left:0,behavior:"auto"})};r(),requestAnimationFrame(()=>requestAnimationFrame(r))}function Kr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:o}=Q(),[i,c]=p.useState(!1);if(p.useEffect(()=>{n||c(!1)},[n]),_e(e)){const g=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":g?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[g?"✓":"✗"," ",t.jsx("b",{children:g?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const l=i&&n;return t.jsxs("button",{type:"button",className:"rev"+(l?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:g=>{g.stopPropagation(),c(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}function Mn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:o,doAnalyse:i,doDecide:c,doPromote:s,doRepeche:l,doApproach:g,dispatch:d,liveMemos:x}=Q(),u=m=>y=>{y.stopPropagation(),m()};if(r.lockActions){const m=u(()=>d({type:"modal",modal:"rdv"}));if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});const y=Ee(e);return y===0?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",onClick:m,children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Bt(e.name))})]})}):y===1?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:m,children:a.actAnalyse})}):y===3?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",onClick:m,children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",onClick:m,children:a.actNo})]})}):y===2?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actPromote})}):y===4?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",onClick:m,children:a.actApproach})}):y===5?t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"promo",onClick:m,children:a.actRepeche})}):t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn read",onClick:m,children:a.actMemoOf(e.memoType)})})}if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ia(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(Sa(e)&&e.url)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:m=>{m.stopPropagation(),ia(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})});if(!r.pipe)return e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Kr,{o:e})});const b=Ee(e);if(b===0)return t.jsx("span",{className:"cell",children:t.jsx(Kr,{o:e})});if(b===1){const m=x.liveOf(e.name);if(m&&(m.status==="boot"||m.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Na,{item:m,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const y=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:y,onClick:u(()=>i(e)),children:y?a.actAnalyseQueued:a.actAnalyse})})}if(b===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>c(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>c(e,!1)),children:a.actNo}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})});if(b===4){const m=o.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:m,onClick:u(()=>g(e)),children:m?a.actApproachSent:a.actApproach})})}return b===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):b===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>l(e)),children:a.actRepeche}),e.memoUrl&&t.jsxs("button",{type:"button",className:"memobtn read sm",title:a.actMemoOf(e.memoType),onClick:u(()=>d({type:"memoConsole",id:e.id})),children:["📄",t.jsx("span",{className:"mlbl",children:a.actMemoOf(e.memoType).replace("📖 "," ")})]})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>d({type:"memoConsole",id:e.id})),children:a.actMemoOf(e.memoType)}):t.jsx("span",{className:"rc",children:"—"})})}function Zd({o:e}){const{t:a,doThumb:r,thumbOf:n}=Q(),o=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(o==="yes"?" on":""),title:a.thumbUp,onClick:i=>{i.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(o==="no"?" on":""),title:a.thumbDn,onClick:i=>{i.stopPropagation(),r(e,!1)},children:"👎"})]})}function ec({o:e}){const{lang:a}=Q();return De(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(wt,{o:e}),t.jsx(Ia,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[qt(e.engine||"")," ",Qe(e.engine||"",a)]})})}function tc({o:e,locked:a,open:r,onToggle:n,selected:o,echo:i,onSelect:c,fresh:s}){const{dispatch:l,caps:g,markRow:d,markedId:x,favIds:u,toggleFav:b,t:m}=Q(),y=Ee(e),w=["#16233A","#475C6E","#8798A8","#B9C6D2"],f=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=f<=0?0:f<=7?1:f<=30?2:3,j=g.pipe&&e.kind==="target"?["#8FA0B8","#9BD1B4","#5FB98C","#2E9A66","#0E8A44","#E2A5A5"][y]:w[v],k=u.has(e.id),E=S=>{if(a)return;if(c){c(e.id);return}if(g.pipe||e.kind==="op"){n();return}const C=S.currentTarget.getBoundingClientRect();l({type:"popup",id:e.id,anchor:{x:C.left+Math.min(280,C.width/3),y:C.bottom}})};return t.jsxs(p.Fragment,{children:[t.jsxs("div",{className:"row"+(x===e.id||r||o?" on":"")+(r?" open":"")+(o?" sel":"")+(i?" echo":"")+(g.pipe&&e.kind==="target"?" p"+y:"")+(k?" fav":"")+(a?" tzr":""),"aria-selected":o||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":j}}),t.jsx(ei,{o:e}),t.jsxs("span",{className:"nd",children:[s&&t.jsx("span",{className:"rfresh",children:"✨"}),typeof e.engagement=="number"&&e.engagement>=20&&t.jsx("span",{className:"rhot",title:`${m.cdEngagement} ${Math.round(e.engagement*10)/10} · ${m.cdEngagementHint}`,children:"🔥"}),De(e)&&t.jsx(wt,{o:e}),t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[g.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:k?1:.35,padding:0,marginRight:4},onClick:S=>{S.stopPropagation(),b(e)},children:k?"★":"☆"}),e.name]}),t.jsxs("span",{className:"rds",title:e.tagline||e.headline||"",children:[We(e)&&(e.date||"").slice(0,10)&&t.jsx("b",{className:"rdate",children:(e.date||"").slice(0,10).split("-").reverse().slice(0,2).join("/")}),[e.tagline,e.headline,e.reasoning].find(S=>S&&S!==e.name)||""]}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:m.acqSee(e.acquirer),onClick:S=>{S.stopPropagation(),l({type:"acquirer",value:e.acquirer||""})},children:["← ",Bt(e.acquirer)]}),Ge(e)?t.jsx("span",{className:"rdec",title:m.doEdito,children:"📖"}):e.decryptHtml?t.jsx("span",{className:"rdec",title:m.zoomNewsMark,children:"📰"}):null]}),t.jsx(ac,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(ec,{o:e}),g.pipe&&t.jsx(On,{o:e,locked:a}),g.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(Mn,{o:e}),g.showThumbs&&t.jsx(Zd,{o:e})]}),r&&!a&&!c&&t.jsx(oc,{o:e})]})}function ac({o:e}){const{lang:a,caps:r}=Q();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Ht(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function nc({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:o,dispatch:i}=Q(),c=(u,b=!1)=>m=>{m.stopPropagation(),b&&i({type:"continent",key:"monde"}),i({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),l=Ht(e.amountEur,r),g=(e.date||"").slice(0,10).split("-").reverse().join("/"),d=_e(e),x=d&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:c({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:c({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:c({stage:[e.stage]}),children:e.stage}),l&&t.jsx("span",{className:"oc-amt",children:l}),g&&t.jsx("span",{children:g})]}),t.jsxs("div",{className:"oc-acts",children:[d?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):We(e)?e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{u.stopPropagation(),ia(e)},children:a.rowExtract}):t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(Bt(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(la,{spec:e.card})})]})}function rc({o:e}){const{t:a,lang:r,caps:n,dispatch:o}=Q();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const i=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[Qe(e.engine||"",r),i?` · ${i}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>o({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(Mn,{o:e})}),t.jsx(Rn,{o:e})]})}function Qo({o:e,extra:a}){const{t:r,lang:n,askEvaluate:o,evalBusy:i,dispatch:c,caps:s,dossiers:l}=Q(),g=p.useRef(null),d=Ge(e);if(p.useEffect(()=>{if(!d||!(e!=null&&e.decryptHtml))return;const h=g.current;if(!h)return;let A=!1;return nn(()=>import("./fit-BnaWm7z_.js"),[]).then(async U=>{await U.ensureEditoCss(),!(A||!h.isConnected)&&(U.beautifyEditoRows(h),U.mountCardFits(h))}),()=>{A=!0}},[d,e==null?void 0:e.decryptHtml]),!e&&!a){const h=l.find(Ge);if(h)return t.jsx(Qo,{o:h})}const x=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),u=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),b=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||x,m=(e==null?void 0:e.card)||(a==null?void 0:a.card),y=e?!!e.noCo:!x||Ea(x),w=(e==null?void 0:e.engine)||"",f=Ge(e),v=e?Ht(e.amountEur,n):"",j=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),k=(()=>{const h=/https?:\/\/(?:www\.)?([^/]+)/.exec(u);return h?h[1].replace(/^www\./,"").slice(0,40):""})(),E=l.find(Ge),S=((E==null?void 0:E.url)||"").trim(),C=!!u&&!!S&&(u===S||u.endsWith(S)||S.endsWith(u)),L=(h,A=!1)=>U=>{U.stopPropagation(),A&&c({type:"continent",key:"monde"}),c({type:"filters",patch:h})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const q=()=>{x&&(c({type:"continent",key:"monde"}),c({type:"filters",patch:{search:x}}))},I=()=>{e!=null&&e.sector&&c({type:"filters",patch:{sector:[e.sector]}})},R=()=>{ia({url:u,headline:b,tagline:e==null?void 0:e.tagline,name:x})},$=e?_e(e):!1,F=$&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH",D=f?r.doEdito.replace(/^📖\s*/,""):w?Qe(w,n):n==="fr"?"Dossier":"File";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[D,j?` · ${j}`:""]}),t.jsx("h3",{className:"zoom-h",children:b}),u&&!f&&(y||Sa({engine:w}))&&t.jsxs("a",{className:"zoom-ext",href:u,target:"_blank",rel:"noopener noreferrer",title:r.viewLinkHint,onClick:h=>h.stopPropagation(),children:[t.jsxs("svg",{className:"extico",width:"13",height:"13",viewBox:"0 0 16 16","aria-hidden":"true",children:[t.jsx("path",{fill:"currentColor",d:"M6.2 3H3.8A1.8 1.8 0 0 0 2 4.8v7.4C2 13.2 2.8 14 3.8 14h7.4c1 0 1.8-.8 1.8-1.8V9.2h-1.5v3a.3.3 0 0 1-.3.3H3.8a.3.3 0 0 1-.3-.3V4.8a.3.3 0 0 1 .3-.3h2.4V3Z"}),t.jsx("path",{fill:"currentColor",d:"M9 2h5v5h-1.5V4.56L7.78 9.28 6.72 8.22 11.44 3.5H9V2Z"})]}),r.viewLink,k?t.jsx("em",{children:k}):null]}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{ref:g,className:"ed-decrypt-b zoom-body"+(f?" ppart":""),dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:L({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:L({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:L({stage:[e.stage]}),children:e.stage}),v&&t.jsx("span",{className:"oc-amt",children:v})]}),m&&t.jsx("div",{className:"zoom-card",children:t.jsx(la,{spec:m})}),(u&&!C&&!f||E&&!f)&&t.jsxs("div",{className:"zoom-srcbox",children:[u&&!C&&!f&&t.jsxs("a",{className:"zoom-src",href:u,target:"_blank",rel:"nofollow noopener",onClick:h=>h.stopPropagation(),children:[r.zoomSrc,k?` · ${k}`:""," ↗"]}),E&&!f&&t.jsxs("button",{type:"button",className:"zoom-src zoom-src-art",onClick:h=>{h.stopPropagation(),c({type:"focus",id:E.id})},children:[r.doEdito," →"]})]}),t.jsxs("div",{className:"zoom-acts",children:[$?t.jsxs("span",{className:"verdict",style:{"--c":F?"var(--brand)":"var(--red)"},children:[F?"✓":"✗"," ",t.jsx("b",{children:F?r.kept:r.dropped})]}):!y&&x?t.jsxs("button",{type:"button",className:"zp-go",disabled:i,onClick:h=>{h.stopPropagation(),o(e,x)},children:[t.jsx("span",{className:"zp-ico",children:"⚡"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.evalGoOn(Bt(x))}),t.jsx("em",{children:r.zoomEvalHint})]})]}):null,u&&!f&&(y||Sa({engine:w}))&&t.jsxs("button",{type:"button",className:"zp-go"+(!y&&x?" ghost":""),onClick:h=>{h.stopPropagation(),R()},children:[t.jsx("span",{className:"zp-ico",children:"🔎"}),t.jsxs("span",{className:"zp-txt",children:[t.jsx("b",{children:r.rowExtract}),t.jsx("em",{children:r.rsOpen})]})]}),!y&&x&&t.jsxs("div",{className:"zp-row",children:[(e==null?void 0:e.sector)&&!s.pipe&&t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),I()},children:[t.jsx("span",{className:"zp-k",children:r.zoomSimilar}),t.jsx("span",{className:"zp-v",children:e.sector}),t.jsx("em",{children:r.zoomSimilarHint})]}),t.jsxs("button",{type:"button",className:"zp-sec",onClick:h=>{h.stopPropagation(),q()},children:[t.jsx("span",{className:"zp-k",children:r.zoomInCockpit}),t.jsx("span",{className:"zp-v",children:Bt(x)}),t.jsx("em",{children:r.zoomIsolateHint})]})]}),!y&&x&&s.pipe&&t.jsx(Fn,{name:x})]})]})}function oc({o:e}){const{t:a,lang:r,dispatch:n,caps:o,outbound:i,doOnboard:c}=Q();return!o.pipe&&e.kind==="op"?t.jsx(nc,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Rn,{o:e}),t.jsx(bl,{o:e}),t.jsx(wl,{o:e}),t.jsx(Fn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(On,{o:e})})]}),e.card&&t.jsx(la,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[qt(e.engine||"")," ",Qe(e.engine||"",r)]}),De(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(wt,{o:e})})]}),o.pipe&&(e.memoUrl||i)&&t.jsx("div",{className:"sec2 acts2",children:i&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>c(e),children:a.actOnboard})})]})]})}function ic({o:e,locked:a,selected:r,onSelect:n}){const{t:o,dispatch:i,caps:c,doDecide:s,lang:l}=Q();if(!c.pipe&&e.kind==="op"){const x=Ht(e.amountEur,l),u=(()=>{const m=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return m?m[1].slice(0,32):""})(),b=(m,y=!1)=>w=>{w.stopPropagation(),y&&i({type:"continent",key:"monde"}),i({type:"filters",patch:m})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":"")+(r?" sel":""),onClick:()=>{!a&&n&&n(e.id)},children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(la,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:b({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:b({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:b({stage:[e.stage]}),children:e.stage}),x&&t.jsx("span",{className:"damt",children:x})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[qt(e.engine||"")," ",Qe(e.engine||"",l)]}),De(e)&&t.jsx(wt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:m=>m.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(u?` · ${u}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(Mn,{o:e})})]})}const g=Ee(e),d=["#E3E8F0","#E7F3EC","#C4E0D0","#7FC0A0","#12A150","#E5484D"][g];return t.jsxs("div",{className:"dcard"+(a?" tzr":"")+(r?" sel":""),style:{"--c":d},onClick:()=>{!a&&n&&n(e.id)},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(On,{o:e}),De(e)&&t.jsx(wt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ")}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&c.pipe&&g===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0E8A44"},onClick:()=>s(e,!0),children:o.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>s(e,!1),children:o.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>i({type:"memoConsole",id:e.id}),children:[o.actMemoOf(e.memoType)," →"]})]})}function sc(){const{t:e}=Q(),[a,r]=p.useState(0);return p.useEffect(()=>{const n=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function lc({counts:e}){const{st:a,dispatch:r,t:n,lang:o}=Q(),i=o==="en",c=d=>n.plabels[d]||"",s=[0,1,2,3,4,5,6,7].filter(d=>d!==a.ptab&&(e[d]||0)>0),l=s.includes(0)?0:s.sort((d,x)=>(e[x]||0)-(e[d]||0))[0];if(l===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const g=e[l]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:i?`No “${c(a.ptab)}” for now.`:`0 ${c(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:l===0?i?`${g} ${g>1?"files are":"file is"} waiting for your screening`:`${g} dossier${g>1?"s":""} attende${g>1?"nt":""} votre évaluation`:i?`${g} ${g>1?"files":"file"} in “${c(l)}”`:`${g} dossier${g>1?"s":""} dans « ${c(l)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:l}),children:[(i?"Open ":"Ouvrir ")+c(l)," →"]})]})}function dc(){var vt,Ot,Et,Re,rt;const e=Q(),{st:a,dispatch:r,t:n,caps:o,counts:i,scoped:c,scopedAll:s,markRow:l,lang:g,sessTally:d,data:x,dossiers:u,source:b,focusExtra:m,byId:y,token:w}=e,f=ho(),v=p.useMemo(()=>{var K,de,je,P;if(!w||b==="ops")return null;const T=(((K=f==null?void 0:f.ed)==null?void 0:K.date)||(f==null?void 0:f.day)||"").slice(0,10),Y=[(de=f==null?void 0:f.ed)==null?void 0:de.html,(je=f==null?void 0:f.ed)==null?void 0:je.acquirers_html].filter(Boolean).join("");return{id:"edito:brief",kind:"op",name:g==="en"?"Today's brief":"Brief du jour",headline:g==="en"?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",tagline:((P=f==null?void 0:f.ed)==null?void 0:P.date)||T,decryptHtml:Y||void 0,date:T,engine:"edito",dealKind:"other",noCo:!0,cc:null,continent:null}},[w,b,g,(vt=f==null?void 0:f.ed)==null?void 0:vt.html,(Ot=f==null?void 0:f.ed)==null?void 0:Ot.acquirers_html,(Et=f==null?void 0:f.ed)==null?void 0:Et.date,f==null?void 0:f.day]),j=T=>o.lockRowsAfter!==null||b==="ops"||o.pipe?Number.MAX_SAFE_INTEGER:fo,[k,E]=p.useState(new Set);p.useEffect(()=>{E(new Set)},[a.ptab,a.continent]);const[S,C]=p.useState(null);p.useEffect(()=>{C(null)},[a.ptab,a.continent]);const[L,q]=p.useState(!a.mapFolded);p.useEffect(()=>{if(a.mapFolded){q(!1);return}const T=document.getElementById("atl2-stage");if(!T){q(!1);return}const Y=new IntersectionObserver(([K])=>q(!!K&&K.isIntersecting),{root:null,rootMargin:"-120px 0px 0px 0px",threshold:0});return Y.observe(T),()=>Y.disconnect()},[a.mapFolded]);const I=a.mapFolded||!L,R=T=>E(Y=>{const K=new Set(Y);return K.has(T)?K.delete(T):K.add(T),K}),$=b==="ops"||o.pipe,[F,D]=p.useState("all"),[h,A]=p.useState(!1),[U,te]=p.useState(null),[N,O]=p.useState(!1),M=p.useRef(!0);p.useEffect(()=>{if(M.current){M.current=!1;return}D("all"),O(!1)},[a.ptab,a.continent]),p.useEffect(()=>{if(!N)return;const T=Y=>{var K,de;(de=(K=Y.target)==null?void 0:K.closest)!=null&&de.call(K,".atl2 .doable")||O(!1)};return document.addEventListener("click",T,!0),()=>document.removeEventListener("click",T,!0)},[N]);const V=p.useMemo(()=>{var Y;const T=new Map;for(const K of nl(((Y=f==null?void 0:f.ed)==null?void 0:Y.html)||""))T.has(K.t)||T.set(K.t,K.html);return T},[(Re=f==null?void 0:f.ed)==null?void 0:Re.html]),ae=p.useCallback(T=>{if(T.decryptHtml)return T.decryptHtml;if(!V.size)return;const Y=(T.name||"").trim().toLowerCase();if(Y.length<3)return;const K=V.get(Y);if(K)return K;for(const[de,je]of V)if(de.includes(Y)||Y.includes(de))return je},[V]),{diff:Z}=Gd(),[ge,J]=p.useState(!1),me=a.filters.win==="1"&&!a.filters.day,[fe,he]=p.useState(!1),B=p.useMemo(()=>new Set(((Z==null?void 0:Z.added)||[]).map(T=>T.trim().toLowerCase()).filter(Boolean)),[Z]),G=p.useMemo(()=>{if(!B.size)return 0;const T={...a,filters:{...a.filters,win:"all",day:"",signalOnly:!1,signalEngines:[]}};return u.filter(Y=>!Ge(Y)&&B.has((Y.name||"").trim().toLowerCase())&&ta(Y,T,o.pipe)).length},[u,B,a,o.pipe]);p.useEffect(()=>{const T=()=>{he(!1),A(!1),D("all"),O(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})};return window.addEventListener("ppmap:tunnel",T),()=>window.removeEventListener("ppmap:tunnel",T)},[]),p.useEffect(()=>{he(!1),A(!1),a.filters.signalOnly&&r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})},[a.ptab]);const H=p.useMemo(()=>{const T=s.filter(K=>!Ge(K)&&We(K));let Y="";for(const K of T){const de=(K.date||"").slice(0,10);de&&(!Y||de<Y)&&(Y=de)}return{n:T.length,since:Y?Y.split("-").reverse().slice(0,2).join("/"):""}},[s]),ee=H.n,_=p.useMemo(()=>{const Y=fe&&B.size>0||a.filters.signalOnly||F!=="all"||h?s:c;let K=zn(Y,a.sort);return K=K.filter(de=>!Ge(de)),fe&&B.size&&(K=K.filter(de=>B.has((de.name||"").trim().toLowerCase()))),h||F==="explore"?K=K.filter(We):F==="eval"?K=K.filter(de=>!We(de)&&!de.noCo&&(de.kind==="op"||!_e(de))):o.pipe&&(K=K.filter(de=>!We(de))),K},[c,s,a.sort,F,fe,B,h,o.pipe]),se=p.useMemo(()=>o.pipe?u.filter(T=>T.kind==="target"&&!Ge(T)&&De(T)&&(a.continent==="monde"||T.continent===a.continent)):_.filter(T=>De(T)&&!_e(T)),[o.pipe,u,_,a.continent]).length,ye=p.useMemo(()=>o.pipe?_:_.filter(T=>!_e(T)&&!T.noCo&&!We(T)),[_,o.pipe]),le=b==="ops"?_.filter(We).length:0,be=fe?"":o.pipe?n.plabels[a.ptab].toLowerCase():b==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,ce=a.filters,ze=[];if(ce.day)ze.push({k:"day",lib:n.fDay(ce.day.slice(8,10)+"/"+ce.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(ce.win&&ce.win!=="all"){const T=["1","7","30"].indexOf(ce.win);T>=0&&ze.push({k:"win",lib:n.dates[T],off:()=>r({type:"filters",patch:{win:"all"}})})}const Ke=T=>T.length<=2?T.join(", "):`${T.length} ${n.fSelected}`;for(const T of["sector","country","engine","crible"]){const Y=ce[T];Y&&Y.length&&ze.push({k:T,lib:Ke(Y),off:()=>r({type:"clearFacet",facet:T})})}ce.search&&ze.push({k:"search",lib:"🔍 "+ce.search,off:()=>r({type:"filters",patch:{search:""}})}),fe&&B.size&&ze.push({k:"since",lib:"✨ "+n.sinceChip,off:()=>he(!1)}),ce.signalOnly&&ze.push({k:"sig",lib:"🔴 "+n.sigDock(se||ce.signalEngines.length||0),off:()=>r({type:"filters",patch:{signalOnly:!1,signalEngines:[]}})});const ve=(T,Y,K="",de=!1)=>t.jsxs("button",{type:"button","data-s":T,className:K,"aria-sort":a.sort.key===T?a.sort.dir===1?"ascending":"descending":"none",style:de?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:T}),children:[Y,t.jsx("span",{className:"ar",children:a.sort.key===T&&a.sort.dir===1?"▴":"▾"})]},T),Se=p.useMemo(()=>{if(o.pipe||a.groupBy==="none")return null;const T=new Map;_.forEach(de=>{const je=de.engine||"?";T.has(je)||T.set(je,[]),T.get(je).push(de)});const Y={ma:0,fundraising:1,partenariats:2,produits:3,regul:4,marche:5,nominations:6,recrutements:7,evenements:8,listes:9,tribunes:10,media:11,edito:12},K=rn([...T.keys()],g);return[...T.entries()].sort((de,je)=>{const P=Y[de[0]]??10+K.indexOf(de[0]),ie=Y[je[0]]??10+K.indexOf(je[0]);return P-ie})},[_,o.pipe,a.groupBy,g]),Rt=Se?Se.filter(([T])=>ya.has(T)).length:0,Me=(()=>{var Y;return((Y=(Se?Se.flatMap(([,K])=>K):_)[0])==null?void 0:Y.id)??null})(),Je=p.useRef(!1),Ae=p.useMemo(()=>u.find(Ge)||v,[u,v]);p.useEffect(()=>{const T=()=>{Je.current=!0,he(!1)};return window.addEventListener("ppmap:reveal",T),window.addEventListener("ppmap:focus",T),()=>{window.removeEventListener("ppmap:reveal",T),window.removeEventListener("ppmap:focus",T)}},[]),p.useEffect(()=>{const T=()=>{Ae&&r({type:"focus",id:Ae.id})};return window.addEventListener("ppmap:edito",T),()=>window.removeEventListener("ppmap:edito",T)},[Ae,r]),p.useEffect(()=>{if(!a.focusId)return;te(a.focusId);const T=window.setTimeout(()=>te(null),900);return()=>window.clearTimeout(T)},[a.focusId]),p.useEffect(()=>{if($&&!(a.focusId&&(_.some(T=>T.id===a.focusId)||u.some(T=>T.id===a.focusId)||a.focusId===(Ae==null?void 0:Ae.id)))&&!m){if(Ae){r({type:"focus",id:Ae.id});return}Me&&r({type:"focus",id:Me})}},[$,a.focusId,_,Me,m,r,u,b,Ae]),p.useEffect(()=>{if(!$||!a.focusId||Ae&&a.focusId===Ae.id||_.some(Y=>Y.id===a.focusId))return;const T=u.find(Y=>Y.id===a.focusId);if(T){if(Je.current){T.kind==="op"?D(We(T)?"explore":"eval"):F!=="all"&&D("all");return}F!=="all"&&Me&&r({type:"focus",id:Me})}},[$,a.focusId,F,_,u,Me,r,Ae]),p.useEffect(()=>{if(!$||!a.focusId||!Je.current)return;const T=document.querySelector(".atl2.ops .row.sel, .atl2.ops .dcard.sel, .atl2.cibles .row.sel, .atl2.cibles .dcard.sel");if(!T){const je=_.findIndex(P=>P.id===a.focusId);if(je>=0){const P=Se?"":"pt"+a.ptab;if(P){const ie=a.shown[P]||j();je>=ie&&r({type:"more",group:P,by:je-ie+8})}}return}Je.current=!1;const Y=Yo(),K=T.getBoundingClientRect();K.top>=Y-2&&K.bottom<=window.innerHeight-4||Xd(T)},[$,a.focusId,a.ptab,_,a.shown,Se,r]),p.useEffect(()=>{if(typeof window>"u")return;const T=document.querySelector(".atl2.ops .listhead, .atl2.cibles .listhead"),Y=document.querySelector(".atl2.ops, .atl2.cibles");if(!T||!Y)return;const K=()=>Y.style.setProperty("--listhead-h",`${T.offsetHeight}px`);K();const de=new ResizeObserver(K);return de.observe(T),()=>de.disconnect()},[I,a.dens,a.mapFolded]);const it=p.useMemo(()=>{if(!$||!a.focusId)return null;if(v&&a.focusId===v.id)return v;const T=_.find(K=>K.id===a.focusId)||u.find(K=>K.id===a.focusId)||null;if(!T)return null;const Y=ae(T);return Y&&Y!==T.decryptHtml?{...T,decryptHtml:Y}:T},[$,a.focusId,_,u,ae,v]),jt=o.lockRowsAfter;let Ie=0;const xt=(T,Y)=>{let K=a.shown[Y]||j();return T.length-K<=4&&(K=T.length),T.slice(0,K).map(P=>{const ie=jt!==null&&Ie>=jt;Ie++;const pe=ae(P),oe=pe&&pe!==P.decryptHtml?{...P,decryptHtml:pe}:P,we=!$&&a.dens!=="maxi"&&(a.dens==="deplie"||(S?S==="open":!!pe)),Pe=k.has(P.id)?!we:we,Ue=$?qe=>{Je.current=!0,r({type:"focus",id:qe});const He=y.get(qe);He&&(We(He)?ia(He):He.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:He.name,url:He.url||"",website:He.website||"",domain:He.domain||""}})))}:void 0;return a.dens==="maxi"?t.jsx(ic,{o:oe,locked:ie,selected:$&&a.focusId===P.id,onSelect:Ue},P.id):t.jsx(tc,{o:oe,locked:ie,open:Pe,onToggle:()=>R(P.id),selected:$&&a.focusId===P.id,echo:U===P.id,fresh:B.has((P.name||"").trim().toLowerCase()),onSelect:Ue},P.id)})},ut="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(b==="ops"?" opsl":"")+(_.length?"":" list-empty"),Xe=t.jsxs(t.Fragment,{children:[Se?Se.map(([T,Y])=>t.jsxs("div",{className:"grp",children:[t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:qt(T)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:T==="ma"?n.grpMa:T==="fundraising"?n.grpLev:ya.has(T)&&Rt<=1?n.grpNews:T==="nominations"?n.grpNom:T==="media"?n.grpNewsOther:T==="recrutements"?n.grpHire:ya.has(T)?n.grpNews+" · "+Qe(T,g):Qe(T,g)}),t.jsx("div",{className:"s",children:n.grpCount(Y.filter(K=>!_e(K)).length,Y.length)})]})]}),xt(Y,T)]},T)):xt(_,"pt"+a.ptab),x.loading&&!u.length&&t.jsx(sc,{}),o.pipe&&a.ptab===0&&!h&&!fe&&F==="all"&&!a.filters.signalOnly&&!x.loading&&t.jsx(Uo,{}),!_.length&&!(x.loading&&!u.length)&&(o.pipe&&F==="all"?t.jsx(lc,{counts:i}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),Nt=t.jsxs(t.Fragment,{children:[!fe&&!h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ea[a.ptab]+")"},children:_.length})," ",be]}),h&&t.jsxs("span",{className:"main",children:[t.jsx("b",{className:"tn",style:{"--c":"var("+ea[a.ptab]+")"},children:_.length})," ",n.newsWord]}),(!fe||h)&&t.jsx("span",{className:"dot",children:"·"}),I&&t.jsx(Bo,{variant:"compact",mapToggle:!!a.mapFolded}),t.jsxs("span",{className:"ctx",children:[I?o.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,o.pipe&&e.fund?" · "+e.fund:""]}),ze.map(T=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:Y=>{Y.stopPropagation(),T.off()},children:[T.lib,t.jsx("i",{children:"×"})]},T.k)),b==="ops"&&_.length>0&&!I&&t.jsxs("span",{className:"edsplit",children:[" — ","⚡ ",_.length-le," ",n.zoomPulseEval,le>0?t.jsxs(t.Fragment,{children:[" · 🔎 ",le," ",n.zoomPulseExplore]}):null]})]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]})]}),bt=t.jsxs("div",{className:"listhead"+(I?" mapoff":""),children:[I&&t.jsx("div",{className:"lh-tools",children:t.jsx(_o,{compact:!0})}),o.showFunnel&&ge&&me&&t.jsxs("div",{className:"lh-stats",children:[t.jsx(jl,{}),t.jsx(Kd,{})]}),o.showFunnel&&t.jsx("div",{className:"lh-title",children:Nt}),o.showFunnel&&t.jsxs("div",{className:"lh-funnel",children:[t.jsx(Yd,{}),t.jsx(Qd,{})]}),t.jsxs("div",{className:"lh-top",children:[o.showFunnel&&t.jsxs("div",{className:"lh-dock",children:[t.jsxs("button",{type:"button",className:"dockbtn"+(me?" on":""),"aria-pressed":me,title:n.morningDockTitle,onClick:()=>{if(me){r({type:"filters",patch:{win:"all",day:""}}),J(!1);return}he(!1),A(!1),D("all"),r({type:"filters",patch:{win:"1",day:"",signalOnly:!1,signalEngines:[]}}),r({type:"ptab",tab:7}),J(!0)},children:["📊 ",n.morningDock(typeof((rt=x.stats)==null?void 0:rt.screened_today)=="number"?x.stats.screened_today:0)]}),Z&&!Z.firstVisit&&(Z.added.length>0||Z.gone.length>0)&&t.jsxs("button",{type:"button",className:"dockbtn since"+(fe?" on":""),"aria-pressed":fe,title:n.sinceSub,onClick:()=>{const T=!fe;he(T),A(!1),J(!1),D("all"),T&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["✨ ",n.sinceDock(G),Z!=null&&Z.lastDate?` · ${n.sinceSince(Z.lastDate)}`:""]}),se>0&&t.jsxs("button",{type:"button",className:"dockbtn sig"+(a.filters.signalOnly?" on":""),"aria-pressed":a.filters.signalOnly,onClick:()=>{he(!1),A(!1),J(!1),D("all"),r({type:"filters",patch:{signalOnly:!a.filters.signalOnly,signalEngines:[],win:"all",day:""}})},children:["🔴 ",n.sigDock(se)]}),o.pipe&&ee>0&&t.jsxs("button",{type:"button",className:"dockbtn news"+(h?" on":""),"aria-pressed":h,title:n.newsDockHint,onClick:()=>{const T=!h;A(T),he(!1),J(!1),D("all"),T&&r({type:"filters",patch:{win:"all",day:"",signalOnly:!1,signalEngines:[]}})},children:["📰 ",n.newsDock(ee),H.since?` · ${n.newsSince(H.since)}`:""]})]}),!o.showFunnel&&Nt,o.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),t.jsxs("span",{className:"lh-acts",children:[(o.showFunnel||b==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([T,Y])=>t.jsxs("button",{type:"button","data-d":T,"aria-pressed":a.dens===T||T==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:T}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:Y})]},T))}),!$&&o.showFunnel&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":S==="open",onClick:()=>{C("open"),E(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":S==="closed",onClick:()=>{C("closed"),E(new Set)},children:n.foldAllLbl})]}),(o.showFunnel||b==="ops")&&(()=>{var pe;const T={...a,filters:{...a.filters,signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}},Y=u.filter(oe=>ta(oe,T,o.pipe)&&!Ge(oe)),K=Y.filter(oe=>!We(oe)&&!oe.noCo&&(oe.kind==="op"||!_e(oe))).length,de=Y.filter(We).length,je=o.pipe?Y.filter(oe=>oe.kind!=="op"&&Ee(oe)===1).length:0,P=[["all",n.doAll],...o.pipe?[["analyser",`${n.doAna}${je?` ${je}`:""}`]]:[],["eval",`${n.doEval}${K?` ${K}`:""}`],["explore",`${n.doExplore}${de?` ${de}`:""}`]],ie=((pe=P.find(([oe])=>oe===F))==null?void 0:pe[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":N,onClick:()=>O(oe=>!oe),children:[ie,t.jsx("i",{children:"▾"})]}),N&&t.jsx("div",{className:"dolist",children:P.map(([oe,we])=>t.jsx("button",{type:"button","aria-pressed":F===oe,onClick:()=>{if(O(!1),oe==="analyser"){window.dispatchEvent(new CustomEvent("ppmap:tunnel")),r({type:"ptab",tab:1});return}D(oe),oe!=="all"&&(he(!1),A(!1),J(!1),r({type:"filters",patch:{signalOnly:!1,signalEngines:[],...o.pipe?{win:"all",day:""}:{}}}))},children:we},oe))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:T=>r({type:"sort",key:T.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...o.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([T,Y])=>t.jsx("option",{value:T,children:Y},T))})]}),o.showChain&&ye.length>0&&t.jsxs("span",{className:"chainwrap",children:[t.jsxs("button",{type:"button",className:"chain",title:n.chainHint,onClick:()=>r({type:"chainStart",queue:ye.map(T=>T.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",o.pipe?n.browse(ye.length):n.chainAll(ye.length)]}),t.jsx("em",{className:"chainhint",children:n.chainHint})]})]})]})]});return t.jsxs(t.Fragment,{children:[!$&&bt,a.dens!=="maxi"&&!$&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ve("country",n.colCountry),ve("name",n.colCompany),ve("amount",n.colAmount,"h-amt",!0),ve("stage",n.colStage,"h-stade"),ve("signal",n.colSignal,"h-sig"),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ve("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ve("memo",n.colMemo)]}),o.pipe&&ve("score",n.colScore,"h-sc",!0),t.jsx("span",{}),o.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),$?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[bt,a.dens==="liste"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),ve("country",n.colCountry),ve("name",n.colCompany),o.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[ve("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),ve("memo",n.colMemo)]}),t.jsx("span",{})]}),t.jsx("div",{className:ut,children:Xe})]}),t.jsxs("aside",{className:"readpane"+((it?Ge(it):!m&&Ae)?" is-edito":""),"aria-label":g==="fr"?"Dossier":"File",children:[Ae&&t.jsx("button",{type:"button",className:"edito-go pane-edito","aria-pressed":a.focusId===Ae.id,onClick:()=>r({type:"focus",id:Ae.id}),children:n.doEdito}),v&&a.focusId===v.id?t.jsx("div",{className:"zoom",children:t.jsx(ll,{})}):it&&o.pipe?t.jsx(rc,{o:it}):t.jsx(Qo,{o:it,extra:it?null:m})]})]}):t.jsx("div",{className:ut,children:Xe}),(()=>{const T=Se||[["pt"+a.ptab,_]];let Y=0,K=0;for(const[je,P]of T){K+=P.length;let ie=a.shown[je]||j();P.length-ie<=4&&(ie=P.length),Y+=Math.min(P.length,ie)}const de=K-Y;return de<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>T.forEach(([je,P])=>r({type:"more",group:je,by:P.length,base:j()})),children:[t.jsx("span",{className:"more-label",children:n.more(de,de)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(Y,K)})]})})(),o.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(d.kept>0||d.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(d.kept,d.dropped)}}),$&&b==="ops"&&a.dens!=="maxi"&&t.jsx(Jd,{on:!!Se,rev:(Se||[]).map(([T,Y])=>T+Y.length).join("|")})]})}function Jr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function cc(e,a){const r=Xi(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function pc(e,a){const n=[a.head.split("|").map(Jr).join(";")];for(const o of e){const i=a.stageOf(o);n.push([o.name||"",cc(o,a.plabels),sa(o)||o.verdict||"",typeof o.score=="number"?o.score:"",o.countryLabel||o.cc||"",o.sector||"",i?a.stageLabel(i.stage):"",o.contactName||"",o.contactEmail||"",o.memoUrl||"",(o.date||"").slice(0,10),(o.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Jr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function uc(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const mc=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function dt({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function fc({o:e,qa:a}){const{t:r,lang:n,fund:o}=Q(),i=(e.cribleStatus||"").trim().toUpperCase()||(sa(e)==="NO MATCH"?"NO MATCH":"MATCH"),c=kt(e),s=(a==null?void 0:a.blocs)||{},l=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(i==="NO MATCH"?" out":""),children:[i==="NO MATCH"?r.vOut:r.vKept,c&&t.jsx("em",{children:c})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(dt,{k:r.cdSector,v:e.sector}),t.jsx(dt,{k:r.cdStage,v:e.stage}),t.jsx(dt,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(dt,{k:r.cdSite,v:e.domain||e.website}),t.jsx(dt,{k:r.cdName,v:e.contactName}),t.jsx(dt,{k:r.cdEmail,v:e.contactEmail}),t.jsx(dt,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(dt,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(dt,{k:r.cdAngle,v:e.angle}),t.jsx(dt,{k:r.cdDetected,v:mc(e.date,n)})]}),l.some(([,g])=>g)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),l.filter(([,g])=>g).map(([g,d])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:g}),t.jsx("p",{children:d})]},g))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(o)})]})}function hc(){const{t:e,lang:a,token:r,scoped:n,fund:o,data:i,dispatch:c}=Q(),[s,l]=p.useState({}),g=25,d=p.useMemo(()=>n.slice(0,g),[n]);p.useEffect(()=>{d.length&&co(r,d.map(b=>b.name)).then(l)},[r,d]);const x=i.stats,u=b=>b.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(d.length)}),n.length>g&&t.jsx("span",{className:"mnote dim",children:e.dsCap(g,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:o}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[u(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(x.kept)," ",e.covKept]}),typeof i.marketEstimate=="number"&&i.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(i.marketEstimate)),", ",Math.round(x.screened/i.marketEstimate*100)," %"]})]})]}),d.map(b=>t.jsx(fc,{o:b,qa:s[b.name]},b.id)),!d.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const gc=50;function Dn({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:o}=Q(),[i,c]=p.useState(null),[s,l]=p.useState(!1),[g,d]=p.useState(""),[x,u]=p.useState(0),[b,m]=p.useState(""),[y,w]=p.useState(!1),[f,v]=p.useState(0),j=p.useRef(null),k=p.useRef(null),E=()=>{v(0),k.current&&window.clearInterval(k.current),k.current=window.setInterval(()=>v(q=>q+1),1e3)},S=()=>{k.current&&(window.clearInterval(k.current),k.current=null)};p.useEffect(()=>()=>{j.current&&window.clearInterval(j.current),k.current&&window.clearInterval(k.current)},[]);const C=async q=>{l(!0),d(""),E();const I=await a();if(l(!1),S(),I.ok){c(I);return}if(I.busy){d(o.alertPreviewBusy);return}if(!q){d(o.alertPreviewFail);return}u(gc),S(),j.current=window.setInterval(()=>{u(R=>R>1?R-1:(j.current&&window.clearInterval(j.current),C(!1),0))},1e3)},L=async()=>{if(n||y||s)return;w(!0),m(""),E();const q=await r();w(!1),S(),m(q.ok?o.alertTestOk(q.sentTo||""):q.error||o.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||y||x>0,onClick:()=>{C(!0)},children:s?o.alertBtnPrevBusy:e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||y||s,onClick:()=>{L()},children:y?o.alertBtnTestBusy:o.alertTest})]}),s&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertPreviewWait(f)]}),y&&t.jsxs("p",{className:"mnote qwait",children:[t.jsx("i",{className:"qwd"}),o.alertTestWait(f)]}),x>0&&t.jsx("p",{className:"mnote",children:o.alertPreviewRetry(x)}),g&&t.jsx("p",{className:"mnote warn",children:g}),b&&t.jsx("p",{className:"mnote",children:b}),!b&&t.jsx("p",{className:"mnote dim",children:o.alertTestHint}),(i==null?void 0:i.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:o.alertSubject})," ",i.subject]}),i.pending===0&&t.jsx("p",{className:"mnote warn",children:o.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:i.html,title:e})]})]})}const ht="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Ve({title:e,icon:a,children:r,wide:n}){const{dispatch:o}=Q();return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:i=>{i.target===i.currentTarget&&o({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>o({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function xc(){const{st:e}=Q();switch(e.modal){case"chain":return t.jsx(vc,{});case"space":return t.jsx(yc,{});case"alert":return t.jsx(wc,{});case"queue":return t.jsx(Sc,{});case"export":return t.jsx(Cc,{});case"plug":return t.jsx(qc,{});case"approach":return t.jsx(Tc,{});case"recharge":return t.jsx(Rc,{});case"cover":return t.jsx(Mc,{});case"dossier":return t.jsx(Oc,{});case"crit":return t.jsx(Pc,{});case"tuto":return t.jsx(_c,{});case"rdv":return t.jsx(bc,{});case"memoalert":return t.jsx(zc,{});default:return null}}function bc(){const{dispatch:e,fund:a,t:r}=Q(),n=a||r.rdvCoFallback;return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:o=>o.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:bo,children:qn}),r.rdvSubMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([o,i],c)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(c+1)}),t.jsx("b",{children:o}),t.jsx("span",{children:i})]},o))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(Es,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function vc(){const{st:e,dispatch:a,byId:r,t:n,lang:o,mode:i,askEvaluate:c,evalBusy:s,caps:l,memoQueued:g,doAnalyse:d}=Q(),x=i==="client",u=e.chain.queue.map(w=>r.get(w)).filter(w=>!!w),b=e.chain.idx,m=u[b],y=b>=u.length;return $t.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:y?n.finished:`${b+1} / ${u.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(y?100:b/Math.max(1,u.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:y||!m?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(u.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:m.name}),t.jsx("div",{className:"sub",children:[Ut(m.cc,o)||m.countryLabel,m.sector,m.stage,n.daysAgo(gt(m.date))].filter(Boolean).map(w=>String(w)).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:Qe(m.engine,o)}),typeof m.amountEur=="number"&&m.amountEur>0&&t.jsx("span",{children:Ht(m.amountEur,o)})]}),De(m)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(wt,{o:m,lg:!0})," ",t.jsx(Ia,{o:m,src:!0})]}),(m.tagline||m.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:m.tagline||m.headline})]}),m.reasoning&&!(x&&_e(m))&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:m.reasoning})]}),x&&_e(m)&&t.jsxs("div",{className:"vbox vfull",style:{"--c":At(m)==="retenu"?"var(--brand)":At(m)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:At(m)==="retenu"?"✓ "+n.kept:At(m)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:m.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!y&&m&&l.pipe&&Ee(m)===1&&!g.has(m.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{d(m),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!y&&m&&!(x&&_e(m))&&(m.noCo&&m.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var w;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:m.url}}))}catch{}a({type:"modal",modal:null}),(w=document.querySelector(".atl2 .demand"))==null||w.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{c(m)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(y?{type:"modal",modal:null}:{type:"chainNext"}),children:y?n.closeBtn:n.skip})]})]})})}),document.body)}function yc(){const{st:e,dispatch:a,dossiers:r,t:n,mode:o}=Q(),i=o==="client",c=p.useMemo(()=>i?r.filter(x=>_e(x)):[],[r,i]),s=p.useMemo(()=>zn(c.filter(x=>At(x)==="retenu"),{key:"signal",dir:-1}),[c]),l=p.useMemo(()=>c.filter(x=>At(x)==="ecarte"),[c]),g=e.spaceTab==="retenu"?s:l,d=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Ve,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:l.length})]})]}),g.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),g.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":d},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function wc(){const{mode:e}=Q();return e==="client"||e==="apercu"?t.jsx(kc,{}):t.jsx(Ec,{})}function kc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Q(),[i,c]=p.useState("d"),s=o!=="client";return t.jsxs(Ve,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":i==="d",className:i==="d"?"on":"",onClick:()=>c("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="w",className:i==="w"?"on":"",onClick:()=>c("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":i==="m",className:i==="m"?"on":"",onClick:()=>c("m"),children:e.alertTabMarket})]}),i==="d"&&t.jsx(jc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="w"&&t.jsx(Nc,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),i==="m"&&t.jsx(Ko,{})]})}function jc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,c]=p.useState(null),[s,l]=p.useState(!1),[g,d]=p.useState(0);p.useEffect(()=>{let L=!0;return l(!1),ar(a).then(q=>{L&&(q?c(q):l(!0))}),()=>{L=!1}},[a,g]);const x=p.useRef({}),[u,b]=p.useState({}),[m,y]=p.useState(!1),[w,f]=p.useState(!1),v=p.useRef(null);p.useEffect(()=>()=>{v.current&&window.clearTimeout(v.current)},[]);const j=L=>{const q=x.current;Object.keys(q).length&&(y(!0),ar(a,q).then(I=>{if(!I){y(!1),o(e.actErr);return}if(I.throttled&&L<3){v.current=window.setTimeout(()=>j(L+1),5400);return}if(x.current={},b({}),c(I),y(!1),I.throttled){o(e.alertThrottled);return}f(!0),window.setTimeout(()=>f(!1),2e3),n(e.alertSaved)}))},k=L=>{r||(x.current={...x.current,...L},b(q=>({...q,...L})),v.current&&window.clearTimeout(v.current),v.current=window.setTimeout(()=>j(1),700))};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(L=>L+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const E={...i,...u},S=L=>!E.sections||E.sections.includes(L),C=L=>{const q=E.sections||e.alertSec.map(([I])=>I);k({sections:S(L)?q.filter(I=>I!==L):[...q,L]})};return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":E.enabled===!0,disabled:r,style:E.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>k({enabled:!E.enabled}),children:E.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>k({hour:Math.max(6,(E.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[E.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>k({hour:Math.min(21,(E.hour??7)+1)}),disabled:r,children:"+"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:E.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>k({days:"daily"}),children:e.alertEveryday})]})]}),t.jsxs("div",{className:"qsec ok",children:[e.alertSections,m&&t.jsx("span",{className:"secsave",children:e.alertSaving}),!m&&w&&t.jsx("span",{className:"secsave done",children:e.alertSavedShort})]}),t.jsx("div",{className:"secl",children:e.alertSec.map(([L,q])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:S(L),disabled:r,onChange:()=>C(L)}),t.jsxs("span",{children:[q,L==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},L))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Dn,{label:e.alertPreview,readOnly:r,onPreview:()=>ps(a),onTest:()=>cs(a)}),E.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),E.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",E.email_lead,E.last_sent?` · ${e.updatedAt(E.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Nc({t:e,token:a,readOnly:r,flash:n,flashErr:o}){const[i,c]=p.useState(null),[s,l]=p.useState(!1),[g,d]=p.useState(0);p.useEffect(()=>{let m=!0;return l(!1),nr(a).then(y=>{m&&(y?c(y):l(!0))}),()=>{m=!1}},[a,g]);const x=m=>{r||nr(a,m).then(y=>{if(!y){o(e.actErr);return}c(y),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(m=>m+1),children:e.retry})]});if(!i)return t.jsx("div",{className:"sp-empty",children:"…"});const u=i.dow??0,b=i.hour??16;return t.jsxs(t.Fragment,{children:[r&&t.jsx("p",{className:"mnote warn",children:e.alertReadOnly}),t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":i.enabled===!0,disabled:r,style:i.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!i.enabled}),children:i.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:m=>x({dow:Number(m.target.value)}),children:e.alertDow.map((m,y)=>t.jsx("option",{value:y,children:m},m))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,b-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[b," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,b+1)}),disabled:r,children:"+"})]})]}),t.jsx(Dn,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>ms(a),onTest:()=>us(a)}),i.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),i.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",i.email_lead,i.last_sent?` · ${e.updatedAt(i.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Ko(){const{st:e,t:a,lang:r,scoped:n,contName:o,email:i}=Q(),[c,s]=p.useState(i||""),[l,g]=p.useState(!1),[d,x]=p.useState(!1);p.useEffect(()=>{i&&s(i)},[i]);const u=e.filters,b=p.useMemo(()=>n.filter(f=>De(f)).length,[n]),m=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,y=async()=>{if(!(!/.+@.+\..+/.test(c)||d)){x(!0);try{await fetch(`${Da}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:c.trim(),sectors:u.sector,countries:u.country,source:i?"atelier2-client":"atelier2",website:""})}),g(!0)}finally{x(!1)}}},w=[[a.amRows.continent,o],[a.amRows.since,a.amSince[m]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>Qe(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>Ut(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return l?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(c)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:w.map(([f,v])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:v}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:c,readOnly:!!i,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&y()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(d?" loading":""),style:{padding:"12px 18px"},onClick:()=>void y(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,b)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function Ec(){const{t:e}=Q();return t.jsx(Ve,{title:e.alertTitle,icon:"🔔",children:t.jsx(Ko,{})})}function Sc(){var R,$;const{t:e,token:a,fund:r,mode:n,dossiers:o,doAnalyse:i,memoQueued:c,caps:s,dispatch:l,liveMemos:g}=Q(),[d,x]=p.useState(()=>$a(r)),[u,b]=p.useState(()=>!$a(r)),[m,y]=p.useState([]),[w,f]=p.useState(0),v=n==="client",j=p.useMemo(()=>{const F=new Map;return o.forEach(D=>{const h=(D.name||"").trim().toLowerCase();h&&!F.has(h)&&F.set(h,D)}),F},[o]);p.useEffect(()=>{let F=!0;return(!$a(r)||w>0)&&b(!0),(async()=>{const[D,h]=await Promise.all([En(r,w>0),ro(a)]);F&&(D&&x(D),b(!1),y(h))})(),()=>{F=!1}},[a,r,w]);const k=u&&!d,E=(d==null?void 0:d.per_day)??0,S=((R=d==null?void 0:d.analyzed_today)==null?void 0:R.length)??0,C=d==null?void 0:d.offre,L=(d==null?void 0:d.pool_meta)||[],q=p.useMemo(()=>{const F=new Map;for(const D of(d==null?void 0:d.scheduled)||[])for(const h of D.names||[])F.has(h)||F.set(h,{label:D.day_label,date:D.date});return F},[d==null?void 0:d.scheduled]),I=(d==null?void 0:d.in_progress)||[];return t.jsxs(Ve,{title:e.queueTitle,wide:!0,children:[C&&t.jsxs("div",{className:"qoffre"+(C.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:C.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:C.delai})]}),t.jsx("span",{className:"osp"}),C.rythme>0?t.jsx("span",{className:"or",children:e.qRate(C.rythme)}):C.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(C.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:k?t.jsxs("span",{className:"qwait",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}):t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(S,S+((($=d==null?void 0:d.pool_order)==null?void 0:$.length)??0))}})}),C&&t.jsxs("div",{className:"qeta",children:[C.file===0?e.qEtaDone:C.rythme<=0?e.qEtaPaused:e.qEta(C.file,C.rythme,C.jours_restants),C.en_retard&&t.jsxs("em",{children:[" ",e.qLate(C.delai,C.plafond)]})]}),!k&&t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(E)}),(C==null?void 0:C.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(I.length>0||g.items.some(F=>F.status==="boot"||F.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[g.items.filter(F=>F.status==="boot"||F.status==="running"||F.status==="error").map(F=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:F.name}),t.jsx("span",{className:"qd",children:F.memoType||""}),t.jsx(Na,{item:F,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+F.name)),I.filter(F=>!g.liveOf(F.name)).map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.name}),t.jsxs("span",{className:"qd",children:[F.memo_type||"",F.age_min?` · ${Math.round(F.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:F.state||""})]},"ip-"+F.name))]})]}),m.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:m.map(F=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:F.company}),t.jsxs("span",{className:"qd",children:[F.memo_type,typeof F.est_min=="number"?` · ~${F.est_min} min`:""]}),t.jsx("span",{className:"qt",children:F.status}),F.url&&t.jsx("a",{className:"qgo",href:F.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemoOf(F.memo_type)}),v&&F.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{er(a,F.company,"retry").then(()=>f(D=>D+1))},children:e.queueRetry}),v&&F.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{er(a,F.company,"delete").then(()=>f(D=>D+1))},children:e.queueDelete})]},F.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",k?e.qUpNextWait:e.qUpNext(L.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[k&&t.jsxs("div",{className:"qwait qwrow",children:[t.jsx("i",{className:"qwd"}),e.qFileWait]}),!k&&L.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),L.map((F,D)=>{const h=q.get(F.name),A=j.get((F.name||"").trim().toLowerCase()),U=g.liveOf(F.name),te=!!(A&&c.has(A.id))||!!(U&&(U.status==="boot"||U.status==="running")),N=!!(A&&Ee(A)===1&&!A.memoUrl)&&!U;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",D+1]}),h?t.jsx("span",{className:"qwhen"+(h.label==="demain"?" soon":""),children:h.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:F.name}),F.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof F.score=="number"&&t.jsx("span",{className:"qs2",children:F.score}),U&&(U.status==="boot"||U.status==="running")&&t.jsx(Na,{item:U,serverOff:g.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),N&&(s.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>l({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:te,onClick:()=>{i(A),f(O=>O+1)},children:te?e.actAnalyseQueued:e.actAnalyse})),F.excerpt&&t.jsx("span",{className:"qex",children:F.excerpt})]},F.name+":"+D)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([F,D])=>t.jsxs("li",{children:[t.jsx("b",{children:F})," — ",D]},F))})]})}function Cc(){const{t:e,token:a,flash:r,scoped:n,caps:o,stageOf:i,dispatch:c}=Q(),s=`${ht}/cibles/list.csv?token=${a}`,l=`${ht}/cibles/list.json?token=${a}`,g=`${ht}/cibles/export.xlsx?token=${a}&scope=full`,d=`=IMPORTDATA("${s}")`,x=w=>{var f;(f=navigator.clipboard)==null||f.writeText(w).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:d},{def:e.exportLive,value:l,href:l},{def:e.exportXlsx,value:g,href:g}],b=!o.lockActions&&n.length>0,m=()=>{uc(pc(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:i,stageLabel:w=>(e.stg.find(([f])=>f===w)||["",""])[1]})),r(e.exportViewDone(n.length))},y=()=>{c({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Ve,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:y,children:e.printBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>c({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),b&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:m,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:w,value:f,href:v})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:w[0]}),t.jsxs("div",{children:[t.jsx("b",{children:w[1]}),t.jsx("p",{children:w[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(f),children:e.exportCopy}),v&&t.jsx("a",{className:"exb",href:v,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},w[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function zc(){const{t:e,token:a,flash:r,flashErr:n,mode:o}=Q(),i=o!=="client",[c,s]=p.useState(null),[l,g]=p.useState(!1),[d,x]=p.useState(0),[u,b]=p.useState(!1);p.useEffect(()=>{let f=!0;return g(!1),Xn(a).then(v=>{f&&(v?s(v):g(!0))}),()=>{f=!1}},[a,d]);const m=()=>(c==null?void 0:c.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},y=f=>{if(i||!c)return;const v={enabled:f.enabled??!!c.enabled,email:f.email??(c.email||""),sections:f.sections??m()};b(!0),Xn(a,v).then(j=>{if(b(!1),!j){n(e.memoAlertErr);return}s(j),r(e.memoAlertSaved)})};if(l)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]})});if(!c)return t.jsx(Ve,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const w=m();return t.jsxs(Ve,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":c.enabled===!0,disabled:i||u,style:c.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>y({enabled:!c.enabled}),children:c.enabled?"ON":"OFF"})})]}),t.jsx(Ac,{value:c.email||"",readOnly:i||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>y({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,v])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!w[f],disabled:i||u,onChange:()=>y({sections:{...w,[f]:!w[f]}})}),t.jsx("span",{children:v})]},f))}),t.jsx(Dn,{label:e.memoAlertPreview,readOnly:i,onPreview:()=>es(a,w),onTest:()=>Zi(a,w)})]})}function Ac({value:e,readOnly:a,label:r,okLabel:n,onSave:o}){const[i,c]=p.useState(e);p.useEffect(()=>{c(e)},[e]);const s=i.trim()!==e.trim(),l=!i.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(i.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:i,disabled:a,onChange:g=>c(g.target.value),onKeyDown:g=>{g.key==="Enter"&&s&&l&&o(i.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!l,onClick:()=>o(i.trim()),children:n})]})]})}function qc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:o}=Q(),[i,c]=p.useState(null),[s,l]=p.useState(!1),[g,d]=p.useState(null),[x,u]=p.useState(!1),[b,m]=p.useState(""),[y,w]=p.useState(0),[f,v]=p.useState("webhook"),[j,k]=p.useState(""),E=p.useRef(!1);p.useEffect(()=>{let R=!0;return l(!1),Zn(a).then($=>{R&&($?c({configured:$.configured,url_hint:$.url_hint}):l(!0))}),rs(a).then($=>{if(R){if(!$){u(!0);return}u(!1),d($),E.current||(E.current=!0,$.destination==="instantly"&&v(F=>F==="webhook"?"instantly":F),$.campaign_id&&k(F=>F||$.campaign_id||""))}}),()=>{R=!1}},[a,y]);const S=(R,$)=>{o&&Zn(a,R).then(F=>{if(!F||F.ok===!1){n(e.actErr);return}R.test&&F.sent===!1?n(e.plugTestThrottled):r($),w(D=>D+1)})},C='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',L=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),q=`curl -X POST ${ht}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`,I=`curl -X POST ${ht}/cibles/react \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","kind":"fast_request","target":"Acme Group"}'`;return t.jsxs(Ve,{title:e.plugTitle,icon:"🔌",wide:!0,children:[g&&t.jsx("p",{className:"mnote"+(g.enabled?" warn":""),children:g.enabled?e.plugAutoOn(g.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>w(R=>R+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:b,disabled:!o,onChange:R=>m(R.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!o||!b.trim(),onClick:()=>S({url:b.trim()},e.plugSaved),children:e.plugSave})]}),(i==null?void 0:i.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",i.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>S({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!o,onClick:()=>S({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:L}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(L).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(Fc,{destKind:f,setDestKind:v,camp:j,setCamp:k,whHint:i!=null&&i.configured?i.url_hint||"webhook":null}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugVarsT}),t.jsx("p",{className:"mnote",children:e.plugVars})]}),t.jsx(Lc,{auto:g,autoKo:x,destKind:f,camp:j,onRetry:()=>w(R=>R+1),onDone:R=>{d(R),u(!1)}}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:q}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(q).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:C}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(C).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsxs("div",{className:"plugcrm",children:[t.jsx("p",{className:"mnote",children:e.plugCrmRecipeT}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugCrmRecipeOpen}),t.jsx("p",{className:"mnote",children:e.plugCrmR1}),t.jsx("p",{className:"mnote",children:e.plugCrmR2}),t.jsx("p",{className:"mnote",children:e.plugCrmR3}),t.jsx("p",{className:"mnote",children:e.plugCrmR4}),t.jsx("p",{className:"mnote dim",children:e.plugCrmRNote})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugRefT}),t.jsx("p",{className:"mnote",children:e.plugOpt}),t.jsx("p",{className:"mnote dim",children:e.plugCols})]})]}),t.jsxs("div",{className:"plugcrmq",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.plugCrmQT})}),t.jsx("p",{className:"mnote",children:e.plugCrmQ1}),t.jsx("p",{className:"mnote",children:e.plugCrmQ2}),t.jsx("p",{className:"mnote",children:e.plugCrmQ3}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugApiMemoLbl}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:I}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var R;(R=navigator.clipboard)==null||R.writeText(I).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function Tc(){const{t:e,token:a,dossiers:r,st:n,dispatch:o,flash:i,flashErr:c,lang:s}=Q(),l=p.useMemo(()=>r.find(h=>h.id===n.approachId)||null,[r,n.approachId]),[g,d]=p.useState("email"),[x,u]=p.useState(0),[b,m]=p.useState({}),[y,w]=p.useState(!1),[f,v]=p.useState(""),[j,k]=p.useState({});if(p.useEffect(()=>{!l||b[g]||y||(w(!0),v(""),ns(a,l.name,g).then(h=>{if(w(!1),!h||h.ok===!1){v((h==null?void 0:h.error)||e.apprFail);return}m(A=>({...A,[g]:h}))}))},[l,g,a]),!l)return null;const E=b[g],S=(E==null?void 0:E.sequence)||[],C=S[x],L=h=>`${g}|${x}|${h}`,q=h=>{const A=L(h);return A in j?j[A]:String(((C==null?void 0:C[h])??"")||"")},I=(h,A)=>k(U=>({...U,[L(h)]:A})),R=L("subject")in j||L("body")in j||L("message")in j,$=q(g==="email"?"body":"message"),F=q("subject"),D=g==="email"&&F?`${F}

${$}`:$;return t.jsxs(Ve,{title:e.apprT(l.name),icon:"✉",wide:!0,children:[t.jsxs("div",{className:"apnav",children:[["email","linkedin"].map(h=>t.jsx("button",{type:"button",className:"apch"+(g===h?" on":""),"aria-pressed":g===h,onClick:()=>{d(h),u(0)},children:h==="email"?e.apprChEmail:e.apprChLi},h)),t.jsx("span",{className:"sp"}),S.map((h,A)=>t.jsxs("button",{type:"button",className:"apday"+(x===A?" on":""),"aria-pressed":x===A,onClick:()=>u(A),children:[h.day||`J${A}`,[`${g}|${A}|subject`,`${g}|${A}|body`,`${g}|${A}|message`].some(U=>U in j)&&t.jsx("i",{children:"✎"})]},h.day||A))]}),t.jsxs("p",{className:"mnote dim",children:[e.apprSeqHint,E!=null&&E.sender?" · "+e.apprSender(E.sender):""]}),y&&t.jsx("p",{className:"mnote",children:e.apprWait}),!!f&&!y&&t.jsxs("p",{className:"mnote warn",children:[f," ",t.jsx("button",{type:"button",className:"lk",onClick:()=>{m(h=>{const A={...h};return delete A[g],A}),v("")},children:e.retry})]}),!y&&!f&&!C&&t.jsx("p",{className:"mnote dim",children:e.apprFail}),C&&t.jsxs(t.Fragment,{children:[g==="email"&&t.jsxs("div",{className:"apfield",children:[t.jsx("label",{children:e.apprSubj}),t.jsx("input",{type:"text",maxLength:160,value:F,onChange:h=>I("subject",h.target.value)})]}),g==="linkedin"&&x===0&&(E==null?void 0:E.connection_request)&&t.jsx("p",{className:"mnote dim",children:e.apprLiNote}),t.jsx("textarea",{className:"apta",maxLength:4e3,rows:12,value:$,onChange:h=>I(g==="email"?"body":"message",h.target.value)}),t.jsxs("div",{className:"apacts",children:[t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var h;(h=navigator.clipboard)==null||h.writeText(D).then(()=>i(e.exportCopied)).catch(()=>c(e.actErr))},children:e.apprCopy}),g==="email"&&t.jsx("a",{className:"abtn",href:`mailto:${encodeURIComponent(l.contactEmail||"")}?subject=${encodeURIComponent(F)}&body=${encodeURIComponent($)}`,children:e.apprMailto}),R&&t.jsx("span",{className:"apedit",children:e.apprEdited})]}),t.jsx("p",{className:"mnote warn",children:e.apprLocal})]}),t.jsx("p",{className:"mnote dim",children:""})]})}function Lc({auto:e,autoKo:a,destKind:r,camp:n,onDone:o,onRetry:i}){const{t:c,token:s,flash:l,flashErr:g,canWrite:d}=Q(),[x,u]=p.useState(!1);if(!e)return a?t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:c.plugAutoT})}),t.jsxs("p",{className:"mnote warn",children:[c.alertLoadError," ",t.jsx("button",{type:"button",className:"lk",onClick:i,children:c.retry})]})]}):null;const b=!!e.enabled,m=!b&&(r==="webhook"?e.webhook_ready===!1?c.plugAutoNeed:"":n.trim()?"":c.plugCampNeed),y=b&&(e.destination||"webhook")==="webhook"&&e.webhook_ready===!1,w=()=>{if(x||!d||m)return;u(!0),(b?tr(s,!1):tr(s,!0,r,n.trim()||void 0)).then(v=>{if(u(!1),!v){g(c.actErr);return}o(v),l(v.enabled?c.plugAutoSavedOn:c.plugAutoSavedOff)})};return t.jsxs("div",{className:"plugauto",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:c.plugAutoT})}),t.jsx("p",{className:"mnote dim",children:c.plugAutoSub}),t.jsxs("button",{type:"button",role:"switch","aria-checked":b,className:"apsw"+(b?" on":""),disabled:x||!d||!!m,title:m||void 0,onClick:w,children:[t.jsx("span",{className:"apr","aria-hidden":"true"}),t.jsx("span",{children:c.plugAutoOnLbl})]}),m===c.plugAutoNeed&&t.jsx("p",{className:"mnote warn",children:m}),y&&t.jsx("p",{className:"mnote warn",children:c.plugAutoBroken})]})}function Fc({destKind:e,setDestKind:a,camp:r,setCamp:n,whHint:o}){const{t:i,token:c,lang:s,canWrite:l}=Q(),[g,d]=p.useState("valides"),[x,u]=p.useState(!1),[b,m]=p.useState(null),[y,w]=p.useState(null),[f,v]=p.useState(!1),[j,k]=p.useState(!1),[E,S]=p.useState(null),[C,L]=p.useState(null),q=`atl2:bulk:${c}:${g}:${e}`;p.useEffect(()=>{m(null),w(null),v(!1),S(null);try{const O=localStorage.getItem(q)||localStorage.getItem(`atl2:bulk:${c}:${g}`),M=JSON.parse(O||"null");L(M&&Date.now()-Date.parse(M.t)<24*3600*1e3?M:null)}catch{L(null)}},[q,g,c]);const I=e==="instantly"&&!r.trim(),R=`${g}|${e}|${r.trim()}`,$=async()=>{if(I||!l)return;u(!0),v(!1),S(null);const O=await ls(c,g,e,r.trim()||void 0);m(O),w(O.ok?R:null),u(!1)},F=p.useRef(!1);if(!l)return null;const D=async()=>{if(F.current||!l)return;F.current=!0,k(!0);const O=`${c}:${g}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let M;try{M=await ds(c,g,e,r.trim()||void 0,O)}finally{F.current=!1}if(k(!1),v(!1),S(M),M.ok&&(M.pushed||0)>0){const V={t:new Date().toISOString(),n:M.pushed||0};L(V);try{localStorage.setItem(q,JSON.stringify(V))}catch{}}};f&&y!==null&&y!==R&&v(!1);const h=o,A=b!=null&&b.ok&&b.ready||0,U=e==="instantly"?r.trim()?i.plugDestInstOn(r.trim()):"":h||"",te=!!(b!=null&&b.ok)&&y===R&&A>0&&!!U&&!C,N=C?new Date(C.t).toLocaleString(s==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:i.plugBulk}),t.jsx("p",{className:"mnote",children:i.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:g,onChange:O=>d(O.target.value),children:i.plugBulkTabs.map(([O,M])=>t.jsx("option",{value:O,children:M},O))}),t.jsxs("select",{value:e,"aria-label":i.plugDestLbl,onChange:O=>a(O.target.value),children:[t.jsx("option",{value:"webhook",children:i.plugDestWh}),t.jsx("option",{value:"instantly",children:i.plugDestInst})]}),e==="instantly"&&t.jsx("input",{type:"text",maxLength:80,placeholder:i.plugCampPh,value:r,onChange:O=>n(O.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:x||I,onClick:()=>{$()},children:x?"…":i.plugBulkPreview})]}),I&&t.jsx("p",{className:"mnote warn",children:i.plugCampNeed}),b&&(b.ok?t.jsx("p",{className:"mnote",children:i.plugBulkResult(b.ready||0,b.linkedinReady||0,(b.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:i.actErr})),!!(b!=null&&b.ok)&&t.jsx("p",{className:"mnote dim",children:i.bulkScope}),C&&t.jsx("p",{className:"mnote",children:i.bulkLocked(N,C.n)}),!C&&!!(b!=null&&b.ok)&&!U&&e==="webhook"&&t.jsx("p",{className:"mnote warn",children:i.bulkNoDest}),!C&&!b&&t.jsx("p",{className:"mnote dim",children:i.bulkPreviewFirst}),te&&!f&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>v(!0),children:i.bulkArm}),te&&f&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:i.bulkWarn(A,U)}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:j,onClick:()=>{D()},children:j?i.bulkSending:i.bulkConfirm(U)}),t.jsx("button",{type:"button",className:"abtn",disabled:j,onClick:()=>v(!1),children:i.bulkCancel})]}),E&&(E.ok?E.replayed?t.jsx("p",{className:"mnote",children:E.pending?i.bulkPending:i.bulkReplayed}):(E.pushed||0)>0?t.jsx("p",{className:"mnote",children:i.bulkDone(E.pushed||0,E.linkedinReady||0,E.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:i.bulkNone}):t.jsx("p",{className:"mnote warn",children:E.error||i.actErr}))]})}function Rc(){const{t:e,data:a,lang:r}=Q(),n=a.credits,o=a.email,i=async c=>{if(!o)return;const s=window.location.href.split("?")[0];try{const g=await(await fetch(`${Da}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,lookup_key:c,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();g.url&&(window.location.href=g.url)}catch{}};return t.jsxs(Ve,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(c=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(c.credits,c.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{i(c.lookup_key)},children:e.rechargeBuy})]},c.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function Oc(){const{t:e}=Q();return t.jsx(Ve,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(hc,{})})}function Mc(){const{t:e,lang:a,data:r,dossiers:n,token:o,fund:i,canWrite:c,flash:s}=Q(),[l,g]=p.useState(null),[d,x]=p.useState(!1);p.useEffect(()=>{let q=!0;if(i)return En(i).then(I=>{q&&I&&typeof I.per_day=="number"&&g(I.per_day)}),()=>{q=!1}},[i]);const[u,b]=p.useState(null);p.useEffect(()=>{if(!o)return;let q=!0;return as(o).then(I=>{q&&b(I)}),()=>{q=!1}},[o]);const m=r.stats,y=typeof(m==null?void 0:m.screened)=="number"?m.screened:n.filter(q=>q.kind==="target"&&_e(q)).length,w=r.marketEstimate||0,f=w>0?Math.min(100,Math.round(y/w*100)):null,v=(m==null?void 0:m.window_days)||30,j=y>0?y/v:0,k=w>0?Math.max(0,w-y):0,S=w>0&&j>0&&y>=100?Math.round(k/j):null,C=q=>Math.round(q).toLocaleString(a==="en"?"en-US":"fr-FR"),L=q=>{d||!c||(x(!0),is(o,q).then(I=>{if(x(!1),I===null){s(e.actErr);return}g(I),s(e.alertSaved)}))};return t.jsxs(Ve,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(C(y))}),w>0&&t.jsx("span",{children:e.covOf(C(w))})]}),f!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:f+"%"}}),t.jsxs("em",{children:[f," %"]})]}),S!==null&&t.jsx("p",{className:"mnote",children:e.covEta(S)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),j>=1&&t.jsx("p",{className:"mnote",children:e.covPace(C(j))}),m&&t.jsxs("div",{className:"covf",children:[typeof m.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.kept)})," ",e.covKept]}),typeof m.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.analyzed)})," ",e.covAna]}),typeof m.shown=="number"&&m.shown!==m.kept&&t.jsxs("span",{children:[t.jsx("b",{children:C(m.shown)})," ",e.funShown]})]}),(u==null?void 0:u.ok)&&(u.detail||[]).length>0&&t.jsxs("details",{className:"covcalc",children:[t.jsx("summary",{children:e.covHowT}),u.perimetre&&t.jsx("p",{className:"mnote",children:u.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"mkc",children:e.covColCode}),t.jsx("th",{className:"mkn",children:e.covColN}),t.jsx("th",{className:"mks",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(u.detail||[]).map((q,I)=>t.jsxs("tr",{className:q.n?"":"zero",children:[t.jsxs("td",{className:"mkc",children:[q.code,q.geo?` · ${q.geo}`:" · FR"]}),t.jsx("td",{className:"mkn",children:typeof q.n=="number"?C(q.n):"—"}),t.jsxs("td",{className:"mks",children:[t.jsx("span",{children:q.source}),q.elargi&&t.jsx("em",{children:e.covWide(String(q.demande||""))}),q.erreur&&t.jsx("em",{children:e.covMissing})]})]},I)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"mkc",children:e.covTotal}),t.jsx("td",{className:"mkn",children:t.jsx("b",{children:C(u.total||w)})}),t.jsx("td",{className:"mks"})]})]})]}),(u.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((u.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(u.sources||[]).join(" · "),u.calcule_le?` — ${e.covComputedAt(u.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),c&&l!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(l)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(q=>t.jsx("button",{type:"button",className:l===q?"on":"",disabled:d,onClick:()=>L(q),children:q===0?"⏸":q},q))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}async function Jo(e,a,r){const n=await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,message:a,who:r})}).then(o=>o.json().catch(()=>({}))).catch(()=>null);if(!n)return{applied:!1,reply:""};if(n.applied===!0)return{applied:!0,reply:String(n.reply||"")};if(!n.job_id)return{applied:!1,reply:String(n.reply||n.clarification||"")};for(let o=0;o<60;o++){await new Promise(c=>window.setTimeout(c,5e3));const i=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,job_id:n.job_id})}).then(c=>c.json().catch(()=>({}))).catch(()=>null);if(i){if(i.applied===!0)return{applied:!0,reply:String(i.reply||"")};if(i.done===!0||i.status==="done"||i.status==="error"||i.clarification||i.error)return{applied:!1,reply:String(i.reply||i.clarification||i.error||"")}}}return{applied:!1,reply:"",encours:!0}}function Dc(){const{t:e,token:a,canWrite:r}=Q(),[n,o]=p.useState(null),[i,c]=p.useState(""),[s,l]=p.useState(""),[g,d]=p.useState(!1),x=`atl2:avis:${a}:${((n==null?void 0:n.sector)||(n==null?void 0:n.pattern)||"").toLowerCase()}`,u=p.useMemo(()=>{if(!(n!=null&&n.pattern))return!1;try{const m=JSON.parse(localStorage.getItem(x)||"null");return!!m&&Date.now()-(m.t||0)<14*24*3600*1e3}catch{return!1}},[x,n==null?void 0:n.pattern]);if(p.useEffect(()=>{if(!r)return;let m=!0;return os(a).then(y=>{m&&o(y)}),()=>{m=!1}},[a,r]),!r||g||u||!n||!n.pattern||!n.instruction)return null;if(i==="ok")return t.jsx("p",{className:"mnote",children:e.avisDone});const b=()=>{c("run"),Jo(a,n.instruction||"","atelier2-avis").then(m=>{if(c(m.applied?"ok":"ko"),m.applied||l(m.encours?e.propSlow:m.reply),m.applied)try{localStorage.setItem(x,JSON.stringify({t:Date.now(),fait:!0}))}catch{}})};return t.jsxs("div",{className:"avisp",children:[t.jsx("p",{className:"mnote",children:t.jsx("b",{children:e.avisIntro(n.sector||n.pattern||"",n.no||0)})}),t.jsx("p",{className:"mnote dim",children:e.avisAsk}),i==="run"&&t.jsx("p",{className:"mnote",children:e.avisRunning}),i==="ko"&&t.jsx("p",{className:"mnote warn",children:s||e.avisFail}),i!=="run"&&t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",onClick:b,children:e.avisYes}),t.jsx("button",{type:"button",className:"lk",onClick:()=>{d(!0);try{localStorage.setItem(x,JSON.stringify({t:Date.now()}))}catch{}},children:e.avisNo})]})]})}function Ic(){var E;const{t:e,token:a,canWrite:r,flash:n,flashErr:o}=Q(),[i,c]=p.useState(!1),[s,l]=p.useState(null),[g,d]=p.useState(!1),[x,u]=p.useState([]),[b,m]=p.useState(null),[y,w]=p.useState([]);if(!r)return null;const f=()=>{c(!0),d(!1),u([]),w([]),ss(a).then(S=>{if(c(!1),!S){d(!0),l(null);return}l(S)})},v=S=>{b||(m(S.title),Jo(a,S.instruction,"atelier2-prop").then(C=>{m(null),C.applied?(w(L=>[...L,S.title]),n(e.propApplied)):C.encours?n(e.propSlow):o(C.reply||e.propApplyFail)}))},j=((s==null?void 0:s.proposals)||[]).filter(S=>!x.includes(S.title)&&!y.includes(S.title)),k=((E=s==null?void 0:s.counts)==null?void 0:E.judged)??0;return t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.propT}),t.jsx("p",{children:e.propSub}),t.jsx("button",{type:"button",className:"abtn"+(i?" loading":""),disabled:i,style:{marginTop:8},onClick:f,children:i?e.propWait:e.propBtn}),!i&&g&&t.jsx("p",{className:"mnote warn",style:{marginTop:10},children:e.propKo}),!i&&!g&&s&&!(s.proposals||[]).length&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:s.reason==="not_enough_signals"?e.propFew(k):e.propNone}),j.map(S=>t.jsxs("div",{className:"propc",children:[t.jsx("span",{className:"props",children:e.propSections[S.section]||S.section}),t.jsx("p",{className:"propt",children:S.title}),S.why&&t.jsx("p",{className:"mnote dim",children:S.why}),S.evidence.length>0&&t.jsxs("p",{className:"mnote dim",children:[e.propFrom," ",S.evidence.join(" · ")]}),t.jsxs("div",{className:"avisa",children:[t.jsx("button",{type:"button",className:"abtn",disabled:!!b,onClick:()=>v(S),children:b===S.title?e.propApplying:e.propApply}),t.jsx("button",{type:"button",className:"lk",onClick:()=>u(C=>[...C,S.title]),children:e.propSkip})]})]},S.title))]})}function Pc(){var f,v,j;const{t:e,dossiers:a,token:r,mode:n,flash:o,criteria:i,fund:c,lang:s}=Q(),l=n==="client",g=p.useMemo(()=>{const k=new Set;return a.forEach(E=>{E.angle&&k.add(E.angle)}),[...k]},[a]),[d,x]=p.useState(""),[u,b]=p.useState(""),[m,y]=p.useState(!1),w=async()=>{const k=d.trim();if(!(!k||m||!l)){y(!0),b("");try{const S=await(await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:k,who:"atelier2"})})).json().catch(()=>({}));if(S.reply&&b(String(S.reply)),S.job_id){b(e.critChatRunning);const C=async()=>{const L=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:S.job_id})}).then(q=>q.json()).catch(()=>null);if(L&&L.done){b(String(L.reply||L.clarification||L.summary||"✓")),y(!1),L.applied&&o(e.alertSaved);return}setTimeout(()=>{C()},8e3)};setTimeout(()=>{C()},8e3),x("");return}x("")}finally{u.startsWith("⏳")||y(!1)}}};return t.jsxs(Ve,{title:e.critTitle,icon:"⚙",wide:!0,children:[(i==null?void 0:i.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.lead}),!!((f=i.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:i.points.map(k=>t.jsx("li",{children:k},k))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((v=i==null?void 0:i.angles)!=null&&v.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:i.method||e.critProfilsSub}),i.angles.map(k=>{var E,S;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:k.title}),k.why&&t.jsx("p",{className:"why",children:k.why}),t.jsxs("div",{className:"lo",children:[!!((E=k.look)!=null&&E.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:k.look.map(C=>t.jsx("li",{children:C},C))})]}),!!((S=k.out)!=null&&S.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:k.out.map(C=>t.jsx("li",{children:C},C))})]})]})]},k.title)})]}),!!((j=i==null?void 0:i.gate)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),i.gate.length===1&&!i.gate[0].k?t.jsx("p",{className:"gate1",children:i.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:i.gate.map(k=>t.jsxs("li",{children:[k.k&&t.jsx("b",{children:k.k}),k.t]},k.t))})]}),g.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:g.map(k=>t.jsx("li",{style:{marginBottom:5},children:k.replace(/[_-]+/g," ")},k))})]}),t.jsx(Dc,{}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:d,disabled:!l||m,onChange:k=>x(k.target.value),onKeyDown:k=>{k.key==="Enter"&&w()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(m?" loading":""),style:{padding:"12px 18px"},disabled:!l||m||!d.trim(),onClick:()=>void w(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx(Ic,{}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ts,{fund:c,lang:s,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([k,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Go[k]||"v-cons"),children:k}),t.jsx("span",{children:E})]},k))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([k,E])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:k}),t.jsxs("span",{children:["← ",E]})]},k))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function _c(){const{t:e,dispatch:a,startTour:r}=Q(),n=o=>{var i,c;a({type:"modal",modal:null}),o==="crit"||o==="plug"||o==="alert"?a({type:"modal",modal:o}):o.startsWith("tab")?a({type:"ptab",tab:Number(o.slice(3))}):o==="eval"&&((i=document.querySelector(".atl2 .demand input"))==null||i.scrollIntoView({block:"center",behavior:"smooth"}),(c=document.querySelector(".atl2 .demand input"))==null||c.focus())};return t.jsxs(Ve,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([o,i],c)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(i),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(i))},children:[t.jsx("span",{className:"n",children:c+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:o.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},i+c))})]})}const Xo="atl2:mapfold",Bc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Xo);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},$c=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return window.innerWidth<=760},Zo=p.createContext(null),Q=()=>{const e=p.useContext(Zo);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function wt({o:e,lg:a}){const{lang:r}=Q(),n=De(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:rr(n,r),children:[n.emoji," ",rr(n,r)]}):null}function Ia({o:e,src:a}){const{lang:r,t:n}=Q(),o=De(e);if(!o)return null;const i=vs(o),c=ys(o);return t.jsxs("em",{className:"sigwin"+(c?" hot":""),title:n.signaledOn(po(o,r))+" · "+n.win7(uo(o,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,l)=>t.jsx("i",{className:l<i?"on":""},l))}),t.jsx("span",{className:"lb",children:c?n.lastDay:n.daysLeft(Math.max(0,o.left??0))}),a&&o.url&&t.jsx("a",{href:o.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function Uc(e,a,r){const n=(r||"").trim();if(n){const i=e.find(c=>(c.url||"")===n);if(i)return i}const o=$e(a);if(o)return e.find(i=>$e(i.name)===o)||e.find(i=>{const c=$e(i.name);return c.length>=3&&(o.includes(c)||c.includes(o))})}function Hc(){const{scoped:e,t:a,st:r,dispatch:n}=Q(),o=p.useRef(r.filters.day);r.filters.day&&(o.current=r.filters.day);const i=!!r.filters.day,c=e.filter(x=>!Ge(x)),s=c.length,l=c.filter(x=>!x.noCo).length,g=c.filter(x=>!!x.noCo).length,d=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(i?" on":""),"aria-pressed":i,title:i?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(i)n({type:"filters",patch:{day:"",win:d?"7":"all"}});else{const x=o.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:x,win:"all"}})}},children:[t.jsx("em",{children:i?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:s}),t.jsx("span",{children:i?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",l," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",g," ",a.zoomPulseExplore]})]})]})}function Vc(){const{t:e,lang:a,data:r,dispatch:n}=Q(),o=r.stats,i=s=>s.toLocaleString(a==="en"?"en-US":"fr-FR");if(!o||typeof o.screened!="number"||o.screened<=0)return null;const c=r.marketEstimate||0;return t.jsxs("button",{type:"button",className:"map-pulse",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("em",{children:e.identCoverage}),t.jsx("b",{children:i(o.screened)}),t.jsx("span",{children:c>0?e.covOf(i(c)):e.covScreened("").trim()}),t.jsxs("ul",{children:[typeof o.kept=="number"&&t.jsxs("li",{children:["✅ ",i(o.kept)," ",e.covKept," ",t.jsx("i",{className:"cpscope",children:e.covScopeAll})]}),typeof o.analyzed=="number"&&t.jsxs("li",{children:["⚡ ",i(o.analyzed)," ",e.covAna]})]})]})}function ei({o:e}){const{lang:a}=Q(),r=bs(e.cc),n=e.cc?Ut(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const Wc=!1;function Gc(){const[e,a]=p.useState(!1);return p.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const ti=e=>`atl2:tour:${e||"anon"}`;function Yc(e){try{return localStorage.getItem(ti(e))==="1"}catch{return!0}}function Xr(e){try{localStorage.setItem(ti(e),"1")}catch{}}function Qc(e,a,r,n,o,i,c,s){const l=e.tourT,g=e.howto;return[{sel:".atl2 .ident",title:l.ident,body:e.fhintIdent},o?{sel:".atl2 .cover",title:l.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:l.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:l.live,body:e.fhintLive},{sel:".atl2 .goal",title:l.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .srceng",click:".atl2 .srceng:not(.on) .se-head",title:l.engines,body:e.fhintSrcEng},{sel:".atl2 .funnel",title:l.funnel,body:e.fhintFunnel,ptab:n},i>0?{sel:".atl2 .tuto",title:l.tuto,body:g[3][0],ptab:3,need:".atl2 .tuto"}:null,{sel:".atl2 .demand",title:l.demand,body:g[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:l.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:l.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:l.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:l.status,body:e.fhintStatus,ptab:n,dens:"deplie"},i>0?{sel:".atl2 .rst2",need:".atl2 .list",title:l.decide,body:e.fhintDecide,ptab:3,dens:"liste"}:null,i>0?{sel:".atl2 .memobtn",need:".atl2 .list",title:l.memoDeep,body:e.fhintMemoDeep,ptab:3,dens:"liste"}:null,c>0?{sel:".atl2 .stg",need:".atl2 .list",title:l.stage,body:e.fhintStage,ptab:4,dens:"liste"}:null,c>0?{sel:".atl2 .approach",need:".atl2 .list",title:l.appr,body:e.fhintAppr,ptab:4,dens:"liste"}:null,...[2,4,5].filter(d=>(s[d]||0)>0).map(d=>({sel:'.atl2 .listhead .step[aria-selected="true"], .atl2 .listhead .off[aria-selected="true"]',need:".atl2 .funnel",title:d===2?l.tabAna:d===4?l.tabValid:l.tabRej,body:d===2?e.fhintTabAna:d===4?e.fhintTabValid:e.fhintTabRej,ptab:d})),{sel:".atl2 .listhead .lh-title .main",need:".atl2 .listhead",title:l.rank,body:e.fhintRank},{sel:".atl2 .learn",title:l.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",title:l.improve,body:e.fhintImprove,modal:"crit"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:l.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:l.tools,body:g[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:l.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:l.crit,body:g[0][0],modal:"crit"}].filter(Boolean)}function ep({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:o,onFiltersChange:i}){var In;const{lang:c}=fs(),s=_s[c],l=Xs(e,c,a),[g,d]=p.useReducer(tl,void 0,()=>Zs((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?$c():Bc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=p.useRef(!0);p.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Xo,g.mapFolded?"on":"off")}catch{}},[g.mapFolded,e,a]),p.useEffect(()=>{if(a!=="ops"||typeof window>"u")return;const z=()=>{window.innerWidth<=760&&d({type:"mapFold",folded:!0})};return z(),window.addEventListener("resize",z),()=>window.removeEventListener("resize",z)},[a]);const u=p.useRef(i);u.current=i,p.useEffect(()=>{var z;(z=u.current)==null||z.call(u,g.filters)},[g.filters]);const[b,m]=p.useState(()=>{if(typeof window>"u")return"both";try{const z=localStorage.getItem("atl2:chrome-mode");if(z==="eval"||z==="filt"||z==="both")return z;if(localStorage.getItem("atl2:chrome-min")==="1")return"eval"}catch{}return"both"}),[y,w]=p.useState(null),[f,v]=p.useState(null),[j,k]=p.useState(null),[E,S]=p.useState({kept:0,dropped:0}),[C,L]=p.useState(!1),[q,I]=p.useState(""),[R,$]=p.useState(!1),[F,D]=p.useState(null),[h,A]=p.useState(!1),[U,te]=p.useState(!1),[,N]=p.useState(0),O=()=>N(z=>z+1),M=p.useRef([]),V=p.useRef(new Set),ae=p.useRef(new Set),[Z,ge]=p.useState([]),[J,me]=p.useState([]),[fe,he]=p.useState(0),B=p.useRef(new Map),G=p.useRef(null),{mode:H}=l,ee=p.useMemo(()=>({...l.caps,...a==="ops"?{showMorning:!1}:null,...o||null}),[l.caps,o,a]),_=ee.pipe,ne=l.session.token||"",se=H==="client"&&!e;p.useEffect(()=>{if(!ne||!_)return;let z=!0;const X=async()=>{const ue=await ws(ne);!z||!ue||(me(ue.runs),he(Date.now()/1e3-ue.now),ge(Te=>Te.filter(ke=>!ue.runs.some(Be=>$e(Be.company)===$e(ke.name)))))};X();const W=Z.length>0||J.some(ue=>ue.status==="running"),re=window.setInterval(()=>{X()},W?8e3:25e3);return()=>{z=!1,window.clearInterval(re)}},[ne,_,Z.length,J.some(z=>z.status==="running")]),p.useEffect(()=>{if(!ne||!_||!se)return;let z=!0;const X=async()=>{const re=await ks(ne);if(!z||!re.length)return;const ue=new Map;re.forEach(Te=>{const ke=String(Te.ceo_status||"").trim();ke&&Te.check_id&&ue.set(String(Te.check_id),ke)}),l.patchStatuses(ue,Te=>Date.now()-(oe.current.get(Te)||0)>9e4)};X();const W=window.setInterval(()=>{X()},6e4);return()=>{z=!1,window.clearInterval(W)}},[ne,_,se]);const ye=p.useMemo(()=>{const z=[],X=new Set;for(const W of Z){const re=$e(W.name);!re||X.has(re)||(X.add(re),z.push({name:W.name,id:W.id,status:"boot",started:W.started,estMin:W.estMin,memoType:"instant"}))}for(const W of J){const re=$e(W.company);if(!re||X.has(re))continue;X.add(re);const ue=W.status==="error"?"error":W.status==="done"?"done":"running";z.push({name:W.company,status:ue,started:W.started||0,estMin:W.est_min||(W.memo_type==="detailed"?40:15),url:W.url,error:W.error,memoType:W.memo_type,note:W.note})}return z},[Z,J]),le=z=>ye.find(X=>$e(X.name)===$e(z))||null,be=(z,X)=>{ge(W=>W.some(re=>$e(re.name)===$e(z.name))?W:[...W,{name:z.name,id:z.id,started:Date.now()/1e3,estMin:X==="detailed"?40:15}]),V.current.add(z.id),O()},ce=(z,X=!1)=>{I(z),$(X),G.current&&clearTimeout(G.current),G.current=setTimeout(()=>I(""),X?4200:2400)},ze=z=>ce(z,!0),Ke=p.useMemo(()=>{const z=new Map;return l.dossiers.forEach(X=>{X.id&&z.set(X.id,X)}),z},[l.dossiers]),ve=p.useMemo(()=>l.dossiers.filter(z=>ta(z,g,_)),[l.dossiers,g,_]),Se=p.useRef(!1);p.useEffect(()=>{if(Se.current||e||l.loading||!l.dossiers.length)return;if(!ee.showFunnel||Yc(l.session.token||"")){Se.current=!0;return}Se.current=!0;const z=window.setTimeout(()=>{Xr(l.session.token||""),A(!0)},700);return()=>window.clearTimeout(z)},[e,l.loading,l.dossiers.length,ee.showFunnel,l.session.token]);const Rt=p.useMemo(()=>l.dossiers.filter(z=>al(z,g,_,l.favIds)),[l.dossiers,g,_,l.favIds]),Me=p.useMemo(()=>hs(ve.filter(z=>!We(z)),l.favIds),[ve,l.favIds]),Je=p.useRef(!1);p.useEffect(()=>{if(Je.current)return;if(!_||a==="ops"){Je.current=!0;return}if((n==null?void 0:n.ptab)!==void 0){Je.current=!0;return}if(l.loading)return;Je.current=!0;const z=gs(Me);z!==g.ptab&&d({type:"ptab",tab:z})},[_,a,n==null?void 0:n.ptab,l.loading,Me,g.ptab]);const Ae=p.useMemo(()=>{const z=yo(l.dossiers);return z?gt(z)===0?s.tourToday:wo(z,c):s.tourNoRun},[l.dossiers,s,c]),it=p.useMemo(()=>l.dossiers.some(z=>!!z.memoUrl||!!z.summary||It(z)),[l.dossiers]),[jt,Ie]=p.useState(!1);p.useEffect(()=>{if(l.loading){Ie(!1);return}if(l.dossiers.length>0||l.error){Ie(!0);return}const z=window.setTimeout(()=>Ie(!0),6e3);return()=>window.clearTimeout(z)},[l.loading,l.dossiers.length,l.error]);const xt=(l.marketEstimate||0)>0||typeof((In=l.stats)==null?void 0:In.screened)=="number"&&l.stats.screened>0,ut=p.useMemo(()=>[1,0,2,4,5,3].find(z=>(Me[z]||0)>0)??0,[Me]),Xe=Sn.find(z=>z.key===g.continent),Nt=g.continent==="monde"?s.contWorld:(c==="fr"?Xe==null?void 0:Xe.fr:Xe==null?void 0:Xe.en)||"";p.useEffect(()=>{const z=X=>{var re;const W=(((re=X.detail)==null?void 0:re.name)||"").trim();W&&bt(null,W)};return window.addEventListener("ppmap:evaluate",z),()=>window.removeEventListener("ppmap:evaluate",z)}),p.useEffect(()=>{const z=X=>{const W=X.detail||{},re=String(W.id||"").trim(),ue=String(W.name||"").trim(),Te=String(W.url||"").trim(),ke=re&&Ke.get(re)||Uc(l.dossiers,ue,Te);if(ke){if(v(null),ta(ke,g,_)||(g.continent!=="monde"&&ke.continent!==g.continent&&d({type:"continent",key:ke.continent||"monde"}),d({type:"reset"})),_&&ke.kind!=="op"){const st=Ee(ke);typeof st=="number"&&st!==g.ptab&&d({type:"ptab",tab:st})}window.dispatchEvent(new CustomEvent("ppmap:reveal")),d({type:"focus",id:ke.id}),(ke.noCo||["media","nominations","recrutements"].includes(ke.engine||""))&&(ke.url||ke.headline)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:ke.url||"",text:[ke.headline,ke.tagline].filter(Boolean).join(`
`)}})):ke.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ke.name,url:ke.url||"",website:ke.website||"",domain:ke.domain||""}}));return}!ue&&!Te||(d({type:"focus",id:re||null}),v({name:ue,headline:String(W.text||"").trim()||ue,url:Te,card:W.card}),Te&&(Ea(ue)||!ue)?window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:Te,text:String(W.text||"").trim()}})):ue&&!Ea(ue)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:ue}})))};return window.addEventListener("ppmap:focus",z),()=>window.removeEventListener("ppmap:focus",z)}),p.useEffect(()=>{const z=re=>{const ue={},Te=String((re==null?void 0:re.sector)||"").trim();Te&&(ue.sector=[Te]);const ke=String((re==null?void 0:re.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(ke)&&(ue.day=ke);const Be=String((re==null?void 0:re.search)||"").trim();Be&&(ue.search=Be);const st=String((re==null?void 0:re.dealKind)||"").trim();(st==="ma"||st==="levee"||st==="other")&&(ue.dealKind=[st]),Object.keys(ue).length&&d({type:"filters",patch:ue})},X=re=>z(re.detail),W=re=>{re.data&&re.data.type==="pp-filter"&&z(re.data)};return window.addEventListener("ppmap:filter",X),window.addEventListener("message",W),()=>{window.removeEventListener("ppmap:filter",X),window.removeEventListener("message",W)}},[]),p.useEffect(()=>{const z=X=>{var ue;const W=(((ue=X.detail)==null?void 0:ue.name)||"").trim().toLowerCase();if(!W)return;const re=l.dossiers.find(Te=>(Te.name||"").trim().toLowerCase()===W);re&&d(a==="ops"?{type:"focus",id:re.id}:{type:"popup",id:re.id})};return window.addEventListener("ppmap:similar",z),()=>window.removeEventListener("ppmap:similar",z)});const bt=(z,X,W)=>{const re=(W||(z==null?void 0:z.name)||X||"").trim();if(!se){k({kicker:re});return}!re||C||(L(!0),(async()=>{try{let ue=(X||re).trim();const Te=((z==null?void 0:z.website)||(z==null?void 0:z.domain)||"").trim();if(!(/^https?:\/\//i.test(ue)||/^[a-z0-9.-]+\.[a-z]{2,}(\/|$)/i.test(ue)&&!/\s/.test(ue)))if(Te)ue=Te;else try{const Oe=await Cn(re);if(Oe!=null&&Oe.website)ue=Oe.website;else if(((Oe==null?void 0:Oe.candidates)||[]).length===1)ue=Oe.candidates[0].url;else if(((Oe==null?void 0:Oe.candidates)||[]).length>1){M.current=[{name:re,verdict:"unresolved",remaining:null,reason:s.evalPickSite,candidates:(Oe.candidates||[]).slice(0,5)},...M.current].slice(0,8),O();return}}catch{}const Be=await io(ne,ue,"atelier2"),st={name:Be.company||re,verdict:Be.verdict,reason:Be.reason||"",remaining:Be.remaining??null};M.current=[st,...M.current].slice(0,8),Be.verdict==="kept"&&S(Oe=>({...Oe,kept:Oe.kept+1})),Be.verdict==="ruled_out"&&S(Oe=>({...Oe,dropped:Oe.dropped+1}));const Wt=z||l.dossiers.find(Oe=>(Oe.name||"").toLowerCase()===re.toLowerCase());Wt&&(Be.verdict==="kept"?Wt.verdict=Wt.verdict||"MATCH":Be.verdict==="ruled_out"&&(Wt.verdict="NO MATCH"),Be.reason&&(Wt.reasoning=Be.reason)),O()}finally{L(!1)}})())},vt=z=>{if(!se){k({kicker:z.name});return}be(z,"instant"),St(ne,"fast_request",z.name||"",""),ce(s.memoInstantSent(z.name))},Ot=z=>B.current.get(z.id)??l.thumbs.get((z.name||"").trim().toLowerCase()),Et=(z,X)=>d({type:"undoPush",entry:{id:z.id,name:z.name,prevCeoStatus:X}}),Re=async(z,X,W)=>{const re=z.ceoStatus||"";oe.current.set(z.id,Date.now()),z.ceoStatus=X,O();const ue=await Ua(ne,{status:X,airtable_id:z.airtableId,check_id:z.checkId,company:z.name,...(W==null?void 0:W.note)!==void 0?{note:W.note}:{},...W!=null&&W.via?{via:W.via}:{}});return ue.ok?ue.skipped?(z.ceoStatus=re,O(),ze(s.actNotPersisted),!1):((W==null?void 0:W.undo)!==!1&&Et(z,re),W!=null&&W.msg&&ce(W.msg),(X==="Validé"||X==="Écarté")&&!z.ceoNote&&(W==null?void 0:W.note)===void 0&&D({o:z,yes:X==="Validé"}),!0):(z.ceoStatus=re,O(),ze(s.actErr),!1)},rt=async(z,X)=>{const W=await Ua(ne,{status:z.ceoStatus||"Retenu",airtable_id:z.airtableId,check_id:z.checkId,company:z.name,note:X,via:"note"});return!W.ok||W.skipped?(ze(W.skipped?s.actNotPersisted:s.actErr),!1):(z.ceoNote=X,O(),!0)},T=p.useRef(new Map),Y=z=>T.current.has(z.id)?T.current.get(z.id):l.stages.get((z.name||"").trim().toLowerCase()),K=(z,X)=>{T.current.set(z.id,X),O()},de=(z,X)=>{se&&Re(z,X?"Validé":"Écarté",{msg:X?s.decidedYes(z.name):s.decidedNo(z.name)})},je=z=>{se&&Re(z,"À trancher",{msg:s.promoted(z.name)})},P=z=>{se&&(async()=>{const X=z.ceoStatus||"";z.ceoStatus="Retenu",O();const W=await Ua(ne,{status:"Retenu",check_id:z.checkId,company:z.name});if(!W.ok||W.skipped){z.ceoStatus=X,O(),ze(W.skipped?s.actNotPersisted:s.actErr);return}Et(z,X),ce(s.repeched(z.name))})()},ie=()=>{const z=g.undo[g.undo.length-1];if(!z){ce(s.undoNone);return}const X=Ke.get(z.id);if(!X){d({type:"undoPop"}),ce(s.undoNone);return}let W=z.prevCeoStatus;if(!W)if((X.verdict||"").toUpperCase().includes("CALL"))W="À trancher";else{ce(s.undoLockedTitle);return}(async()=>await Re(X,W,{undo:!1})&&(d({type:"undoPop"}),X.ceoStatus=z.prevCeoStatus,O(),ce(s.undoDone(X.name))))()},pe=z=>{se&&(ae.current.add(z.id),O(),d({type:"approachOpen",id:z.id}),St(ne,"approach",z.name||"",""))},oe=p.useRef(new Map),we=p.useRef(!1);p.useEffect(()=>{if(!ne||e||!se||we.current)return;we.current=!0;const z=new Date().toISOString().slice(0,10),X=`atl2:vue:${ne}:${z}`;try{if(localStorage.getItem(X))return}catch{}St(ne,"view","","").then(W=>{if(!W.ok){we.current=!1;return}try{localStorage.setItem(X,"1")}catch{}})},[ne,e]);const Pe=(z,X)=>{se&&(async()=>{if(!(await St(ne,X?"yes":"no",z.name||"",(z.ceoNote||"").slice(0,400),z.sector||"")).ok){ze(s.actErr);return}B.current.set(z.id,X?"yes":"no"),O(),ce(X?s.thumbUpDone:s.thumbDnDone)})()},Ue=z=>{!se||!It(z)||(be(z,"detailed"),St(ne,"detailed_request",z.name||"",""),ce(s.memoDeepSent(z.name)))},qe=z=>{!se||!z.memoUrl||window.confirm(s.memoRegenAsk(z.name))&&(be(z,"detailed"),St(ne,"detailed_regen",z.name||"",""),ce(s.memoDeepSent(z.name)))},He=z=>{const X=new Set(l.favIds),W=X.has(z.id);W?X.delete(z.id):X.add(z.id),l.setFavIds(X),se&&js(ne,{id:z.id,co:z.name},W)},Pa=()=>{!se||U||window.confirm(s.identSyncConfirm)&&(te(!0),(async()=>{const z=await Ns(ne);te(!1),z?ce(s.identSyncDone):ze(s.actErr)})())},Vt=/proplace/i.test(l.fund||""),ai=z=>{!se||!Vt||(St(ne,"onboard_request",z.name||"",""),ce(s.onboardSent(z.name)))},ni={st:g,dispatch:d,t:s,lang:c,mode:H,caps:ee,pipe:_,token:ne,fund:l.fund,email:l.email,criteria:l.criteria,source:a||"default",data:l,doRepeche:P,thumbOf:Ot,canWrite:se,commitStatus:Re,saveNote:rt,stageOf:Y,setStage:K,flashErr:ze,startTour:()=>A(!0),dossiers:l.dossiers,scopedAll:ve,scoped:Rt,counts:Me,byId:Ke,contName:Nt,favIds:l.favIds,toggleFav:He,askEvaluate:bt,doAnalyse:vt,doDecide:de,doPromote:je,doApproach:pe,doThumb:Pe,doDeep:Ue,doRegen:qe,doUndo:ie,doSync:Pa,doOnboard:ai,outbound:Vt,memoQueued:V.current,liveMemos:{items:ye,serverOff:fe,liveOf:le},approachDone:ae.current,sessTally:E,evalCards:M.current,evalBusy:C,markRow:w,markedId:y,flash:ce,focusExtra:f};p.useEffect(()=>{const z=X=>{X.key==="Escape"&&(d({type:"popup",id:null}),d({type:"modal",modal:null}),d({type:"openFacet",facet:null}))};return window.addEventListener("keydown",z),()=>window.removeEventListener("keydown",z)},[]);const ri=z=>ne?t.jsx(ol,{token:ne,children:z}):t.jsx(t.Fragment,{children:z});return t.jsx(Zo.Provider,{value:ni,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(ne?" cibles":"")+" chrome-"+b,children:[t.jsx("style",{children:Hs}),ri(t.jsxs("div",{className:"app"+(_?" pipe":"")+(ne?" has-thesis":""),children:[ee.showTicker&&t.jsx(ot,{name:"live",children:t.jsxs("div",{className:"live-stack"+(ne?" live-stack--cibles":""),children:[t.jsx(ul,{}),!!ne&&t.jsx(il,{})]})}),ee.showIdent&&t.jsx(ot,{name:"identite",children:t.jsx(Nl,{})}),!1,Wc,ee.showFunnel&&t.jsx(ot,{name:"entonnoir",children:t.jsx(Kc,{})}),!g.mapFolded&&t.jsx(ot,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Bo,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(Hc,{}),a!=="ops"&&ee.showFunnel&&t.jsx(Vc,{}),t.jsx(kd,{}),t.jsx(_o,{})]})]})}),ee.showDemand&&_&&t.jsx(ot,{name:"direct",children:t.jsx(As,{items:ye,serverOff:fe,labels:{strip:s.liveStrip,boot:s.liveBoot,end:s.liveEnd,open:s.liveOpenQueue,memo:s.actMemo},onOpen:()=>d({type:"modal",modal:"queue"})})}),a==="ops"&&t.jsx("div",{className:"chrome-tog",role:"tablist","aria-label":s.chromeBoth,children:[["eval",s.chromeEval],["filt",s.chromeFilt],["both",s.chromeBoth]].map(([z,X])=>t.jsx("button",{type:"button",role:"tab","aria-selected":b===z,onClick:()=>{m(z);try{localStorage.setItem("atl2:chrome-mode",z)}catch{}},children:X},z))}),ee.showDemand&&t.jsx(ot,{name:"evaluation",children:t.jsx("div",{className:"eval-stick",children:t.jsx(qd,{})})}),ee.showDemand&&g.memoConsole&&t.jsx(ot,{name:"console",children:t.jsx(Ld,{})}),ee.pipe&&!!ne&&t.jsx(ot,{name:"moteurs",children:t.jsx(Ds,{})}),t.jsx(ot,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(dc,{})}),l.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),l.error&&!l.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:l.refresh,children:s.retry})]})]})),g.popupId&&g.dens!=="liste"&&a!=="ops"&&t.jsx(ot,{name:"fiche",children:t.jsx(Wd,{})}),t.jsx(ot,{name:"modales",children:t.jsx(xc,{})}),t.jsx(hl,{}),F&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:F.o.name}),t.jsx(yl,{placeholder:F.yes?s.whyYesPh:s.whyNoPh,onDone:z=>{const X=F.o;D(null),z&&rt(X,z).then(W=>{W&&ce(s.csNoteSaved)})}})]}),h&&jt&&t.jsx(kl,{steps:Qc(s,Ae,it,ut,xt,Me[3]||0,Me[4]||0,Me),onClose:()=>{A(!1),Xr(ne)}}),t.jsx(Gc,{}),ee.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsxs("span",{className:"lb-c",children:[s.lockbarContactBefore,t.jsx("a",{href:bo,children:qn}),s.lockbarContactMid,t.jsx("a",{href:`mailto:${za}`,children:za})]}),t.jsx("button",{type:"button",onClick:()=>d({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),q&&t.jsx("div",{className:"flash on"+(R?" err":""),children:q}),j&&t.jsx(xs,{variant:"acquirer",initialCompany:Zr().co,initialWebsite:Zr().site,onClose:()=>k(null)})]})})}function Kc(){const{t:e}=Q(),[a,r]=p.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function Zr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Jc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{ei as FlagCell,wt as SigBadge,Ia as SigWin,ep as default,Jc as fmtShort,Q as useV2};
