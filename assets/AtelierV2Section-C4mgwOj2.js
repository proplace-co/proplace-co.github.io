...
`;class me extends h.Component{constructor(){super(...arguments);qa(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ai=8;function ni(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=M(),[s,p]=h.useState(!1),[m,c]=h.useState(!1),[d,u]=h.useState(!1),g=r||"home",{names:x,verdicts:b}=h.useMemo(()=>{const w=[],z={};return n.forEach(A=>{A.kind!=="target"||!A.name||(w.push(A.name),z[A.name]=Dr(A)||"")}),{names:w,verdicts:z}},[n]),v=h.useMemo(()=>x.length?Ir(g,x,b,a):null,[g,x.length]);if(!i.pipe||s||!v||v.firstVisit||!v.added.length&&!v.gone.length)return null;const f=m?v.added:v.added.slice(0,ai),y=v.added.length-f.length,k=w=>{const z=n.find(A=>A.name===w);z&&(o(z.id),l({type:"popup",id:z.id}))};return t.jsxs("div",{className:"since",children:[t.jsxs("div",{className:"since-h",children:[t.jsxs("b",{children:["✨ ",e.sinceTitle(v.added.length,v.lastDate)]}),t.jsx("button",{type:"button",className:"x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{p(!0),Br(g,x,b,v.fp,a)},children:"×"})]}),!!v.added.length&&t.jsxs("div",{className:"since-c",children:[f.map(w=>t.jsx("button",{type:"button",onClick:()=>k(w),children:w},w)),y>0&&t.jsx("button",{type:"button",className:"mr",onClick:()=>c(!0),children:e.sinceMore(y)})]}),!!v.gone.length&&t.jsxs("div",{className:"since-c",children:[t.jsx("button",{type:"button",className:"mr",onClick:()=>u(w=>!w),children:e.sinceOut(v.gone.length)}),d&&v.gone.slice(0,20).map(w=>t.jsx("span",{className:"gone",children:w},w))]})]})}const Xt=600,He=62,Xa="atl2:fstats";function ri(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=M(),[l,s]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Xa)==="on"}catch{return!1}}),p=r.stats,m=h.useMemo(()=>((p==null?void 0:p.by_day)||[]).slice(-30),[p]),c=h.useMemo(()=>{if(p!=null&&p.since)return p.since;const y=new Date;return y.setDate(y.getDate()-((p==null?void 0:p.window_days)||30)),y.toISOString().slice(0,10)},[p==null?void 0:p.since,p==null?void 0:p.window_days]);if(!n.showFunnel||!p||typeof p.screened!="number")return null;const d=y=>a==="en"?y.slice(5,10):`${y.slice(8,10)}/${y.slice(5,7)}`,u=y=>y.toLocaleString(a==="en"?"en-US":"fr-FR"),g=m.reduce((y,k)=>Math.max(y,k.s||0),0),x=m.length?Xt/m.length:0,b=Math.max(4,x-4),v=m.length>=5&&g>0,f=[[p.screened,e.funScreened(d(c)),p.screened_today],...typeof p.kept=="number"?[[p.kept,e.funKept,p.kept_today]]:[],...typeof p.analyzed=="number"?[[p.analyzed,e.funAnalyzed,p.analyzed_today]]:[],...typeof p.shown=="number"?[[p.shown,e.funShown,void 0]]:[]];return t.jsxs("div",{className:"fstats"+(l?" on":""),children:[t.jsxs("div",{className:"fst-row",children:[f.map(([y,k,w],z)=>t.jsxs("span",{className:"fst-t",children:[z>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:u(y)}),t.jsx("i",{children:k}),l&&typeof w=="number"&&w>0&&t.jsx("em",{children:e.funToday(w)})]},k)),v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const y=!l;s(y),y&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Xa,y?"on":"off")}catch{}},children:l?"⌃":"⌄"})]}),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${Xt} ${He}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[m.map((y,k)=>{const w=(y.s||0)/g*(He-4),z=(y.m||0)/g*(He-4),A=k*x+(x-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${d(y.d)} — ${y.s} ${e.actScreened} · ${y.m} ${e.actKept}`}),t.jsx("rect",{x:A,y:He-2-w,width:b,height:w,fill:"#cfe0d6"}),t.jsx("rect",{x:A,y:He-2-z,width:b,height:z,fill:"#185c38"})]},y.d)}),t.jsx("line",{x1:0,y1:He-1.5,x2:Xt,y2:He-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:d(m[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const oi=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ii({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=M(),[o,l]=h.useState(""),[s,p]=h.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const m=(e.ceoStatus||"").trim(),c=(nt(e)||"").startsWith("CALL")&&ke(e)===3,d=ke(e)>=2,u=async x=>{if(o||x==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(x);const b=await i(e,x);l(""),b&&(p(!0),setTimeout(()=>p(!1),2200))},g=c?[["Validé",a.csYes],["Écarté",a.csNo]]:oi.filter(([x])=>!(d&&x==="Retenu")).map(([x,b])=>[x,a[b]]);return t.jsxs("div",{className:"csp",onClick:x=>x.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),g.map(([x,b])=>t.jsx("button",{type:"button",className:"csb"+(m===x?" on":"")+(o===x?" busy":""),disabled:!!o,onClick:()=>{u(x)},children:b},x)),s&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(si,{o:e})]})}function si({o:e}){const{t:a,saveNote:r,flash:n}=M(),[i,o]=h.useState(e.ceoNote||""),[l,s]=h.useState(!1),[p,m]=h.useState(!1),c=i.trim()!==(e.ceoNote||"").trim(),d=async()=>{if(l||!c)return;s(!0);const u=await r(e,i.trim());s(!1),u&&(m(!0),setTimeout(()=>m(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:u=>o(u.target.value),onKeyDown:u=>{u.key==="Enter"&&d()}}),t.jsx("button",{type:"button",disabled:l||!c,onClick:()=>{d()},children:p?a.csNoteSaved:a.csNoteOk})]})}function li({placeholder:e,onDone:a}){const{t:r}=M(),[n,i]=h.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function di({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:s}=M(),[p,m]=h.useState(!1);if(!n.pipe||!i||n.lockActions||ke(e)!==4)return null;const c=o(e),d=(c==null?void 0:c.stage)||"todo",u=async f=>{if(p||f===d)return;m(!0);const y=c;l(e,{stage:f,stamps:(c==null?void 0:c.stamps)||{}});const k=Math.max(Date.now(),Ja+=1);Ja=k;const w=await $r(r,{company:e.name||"",stage:f,cts:k,deal_id:e.airtableId,check_id:e.checkId});m(!1),!w.stale&&(w.ok||(l(e,y),s(a.actErr)))},g=(v=c==null?void 0:c.stamps)==null?void 0:v.sent,x=g?Math.floor((Date.now()-Date.parse(g))/864e5):0,b=d==="sent"&&g&&x>=4;return t.jsxs("div",{className:"stg",onClick:f=>f.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([f,y])=>t.jsx("button",{type:"button",className:"stgb"+(d===f?" on":""),disabled:p,onClick:()=>{u(f)},children:y},f)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(x)})]})}let Ja=0;const kt=8,jt=340;function Za({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function ci({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=M(),[l,s]=h.useState(0),[p,m]=h.useState(null),[c,d]=h.useState([]),u=h.useRef(!1);h.useEffect(()=>{u.current||(u.current=!0,d(e.filter(k=>!!document.querySelector(k.need||k.sel))))},[e]);const g=c[l],x=l>=c.length;h.useEffect(()=>{g&&(g.ptab!==void 0&&o.ptab!==g.ptab&&n({type:"ptab",tab:g.ptab}),g.dens&&o.dens!==g.dens&&n({type:"dens",dens:g.dens}))},[l,g]);const b=h.useCallback(()=>{if(!g){m(null);return}const k=document.querySelector(g.sel);if(!k){m(null);return}k.scrollIntoView({block:"nearest",behavior:"smooth"}),m(k.getBoundingClientRect())},[g]);h.useLayoutEffect(()=>{b();const k=window.setTimeout(b,260),w=()=>b();return window.addEventListener("scroll",w,!0),window.addEventListener("resize",w),()=>{window.clearTimeout(k),window.removeEventListener("scroll",w,!0),window.removeEventListener("resize",w)}},[b]);const v=h.useRef(a);if(v.current=a,h.useEffect(()=>{const k=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),v.current()):w.key==="ArrowRight"?s(z=>z+1):w.key==="ArrowLeft"&&s(z=>Math.max(0,z-1))};return document.addEventListener("keydown",k,!0),()=>document.removeEventListener("keydown",k,!0)},[]),!c.length)return null;let f=null;if(x){const k=i[3]||0;k>0?f={title:k===1?r.ahaATitle1:r.ahaATitleN(k),body:r.ahaABody,btn:r.ahaABtn,go:()=>{n({type:"ptab",tab:3}),a()}}:(i[1]||0)>0?f={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:()=>{n({type:"ptab",tab:1}),a()}}:f={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:()=>{n({type:"modal",modal:"crit"}),a()}}}let y={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:jt};if(!x&&p){const k=p.bottom+14,z=window.innerHeight-k>190?k:Math.max(12,p.top-200);y={left:Math.min(Math.max(12,p.left+p.width/2-jt/2),window.innerWidth-jt-12),top:z,width:jt}}return at.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!x&&p&&t.jsx("div",{className:"tour-hole",style:{left:p.left-kt,top:p.top-kt,width:p.width+kt*2,height:p.height+kt*2}}),(x||!p)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(x?" fin":""),style:y,children:[x&&f?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:f.title}),t.jsx("p",{children:t.jsx(Za,{text:f.body})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>s(c.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:f.go,children:f.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"tour-n",children:r.tourStep(l+1,c.length)}),t.jsx("h3",{children:g==null?void 0:g.title}),t.jsx("p",{children:t.jsx(Za,{text:(g==null?void 0:g.body)||""})}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>s(k=>Math.max(0,k-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>s(k=>k+1),children:l===c.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function pi(){const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,dispatch:l}=M(),s=r?a:e,p=h.useMemo(()=>s.filter(f=>tt(f.date)===0&&f.kind==="target"),[s]),m=h.useMemo(()=>r?a.filter(f=>ke(f)===0).slice().sort((f,y)=>(y.date||"").localeCompare(f.date||"")):[],[a,r]),c=h.useMemo(()=>p.filter(f=>r?ke(f)===0:!Ce(f)),[p,r]),d=r?m:c,u=r?a.length-m.length:p.length-c.length,g=r?a.length:p.length,x=g?Math.min(100,u/g*100):100;let b;r?b=i.morningThesis(p.length,m.length):p.length?u===0?b=i.goalSourced(p.length):u>=p.length?b=i.goalCleared:b=i.goalDone(u,p.length):b=i.goalSourced(0);const v=()=>{if(!r){l({type:"pile",on:!0});return}l({type:"ptab",tab:0}),n==="client"&&m.length&&l({type:"chainStart",queue:m.map(f=>f.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",dangerouslySetInnerHTML:{__html:b}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:x+"%"}})}),d.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:v,children:r?i.morningEval(d.length):o.pileMode?i.goalContinue(d.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ui(){var j,R;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:s,mode:p,doSync:m,startTour:c}=M(),[d,u]=h.useState(null),[g,x]=h.useState([]),b=p==="client";h.useEffect(()=>{if(!i||!o)return;let N=!0;return(async()=>{const[O,T]=await Promise.all([Sa(o),Rn(i)]);N&&(O&&u(O),x(T))})(),()=>{N=!1}},[i,o]);const v=(d==null?void 0:d.per_day)??null,f=((j=d==null?void 0:d.pool_order)==null?void 0:j.length)??0,y=g.filter(N=>N.status==="running").length,k=h.useMemo(()=>s.filter(N=>N.kind==="target"&&Ce(N)).length,[s]),w=l.marketEstimate,z=typeof((R=l.stats)==null?void 0:R.screened)=="number"?l.stats.screened:k,A=w&&w>0?Math.min(100,Math.round(z/w*100)):null,q=N=>N.toLocaleString(a==="en"?"en-US":"fr-FR"),F=(o||"P").split(/\s+/).map(N=>N[0]).join("").slice(0,2).toUpperCase(),E=(()=>{const N=Date.parse(l.generatedAt||"");if(Number.isNaN(N))return"";const O=new Date(N),T=S=>String(S).padStart(2,"0");return`${T(O.getDate())}/${T(O.getMonth()+1)} à ${T(O.getHours())}:${T(O.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:F}),t.jsx("i",{children:o})]}),t.jsx("h1",{children:e.identTitle(o||"…")}),t.jsx("span",{className:"idsp"}),E&&t.jsx("span",{className:"idupd",children:e.identUpdatedAt(E)}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:c,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[A===null&&z>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:q(z)})})]}),A!==null&&w&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:A+"%"}})}),t.jsxs("b",{children:[A," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf(z,w)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),v!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:v})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),v===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),y>0&&t.jsxs("span",{className:"ev",children:["⏳ ",y]}),t.jsx("span",{className:"ego",children:e.identPending(f)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:N=>{N.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!b,onClick:m,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:N=>n({type:"filters",patch:{search:N.target.value}})})]})]})]})}function fi(){const{t:e,counts:a,dispatch:r}=M();return t.jsxs("div",{className:"onb",children:[t.jsxs("div",{className:"onbh",children:[t.jsxs("span",{className:"tag",children:[t.jsx("i",{}),e.onbTag]}),t.jsx("h2",{dangerouslySetInnerHTML:{__html:e.onbTitle(a[1]+a[2]+a[3])}}),t.jsx("div",{className:"sub",children:e.onbSub(a[7])})]}),t.jsx("div",{className:"steps4",children:e.onbSteps.map(([n,i],o)=>{const l=o===e.onbSteps.length-1;return t.jsxs("div",{className:"s4"+(l?" go":""),children:[t.jsx("span",{className:"s4n",children:o+1}),t.jsx("div",{className:"s4t",children:n}),t.jsx("div",{className:"s4d",children:i}),l&&t.jsx("button",{type:"button",className:"s4b p",onClick:()=>r({type:"modal",modal:"rdv"}),children:e.onbCta})]},o)})})]})}const mi=["--p0","--p1","--p2","--p3","--p4"];function xi(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i}=M(),o=h.useRef({});h.useEffect(()=>{o.current={...r}},[r]);const l=m=>{const c=o.current[m],d=c!==void 0?r[m]-c:0;return t.jsxs("button",{type:"button",className:"step"+(m===3&&r[3]>0?" wait":""),style:{"--c":`var(${mi[m]})`,"--tc":m<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===m,title:n.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[t.jsxs("span",{className:"l",children:[n.plabels[m].toUpperCase(),m===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(d>0?" up":d<0?" down":""),children:[r[m],d!==0&&t.jsxs("em",{className:"delta",children:[d>0?"+":"−",Math.abs(d)]})]})]},m)},s=(m,c,d)=>t.jsxs("button",{type:"button",className:"off"+(c?" view":""),style:{"--c":m===5?"var(--p5)":m===6?"var(--pf)":"var(--pv)"},"aria-selected":e.ptab===m,title:n.phelp[m],onClick:()=>a({type:"ptab",tab:m}),children:[t.jsx("span",{className:"l",children:d.toUpperCase()}),t.jsx("span",{className:"n",children:r[m]})]},m),p=(m,c,d,u=!1)=>t.jsx("button",{type:"button",className:"tool",title:c,disabled:u,onClick:d,children:m},c);return t.jsxs("div",{className:"funnel",children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(l)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[p("↩",n.toolUndo,i,e.undo.length===0),p("↺",n.toolReset,()=>{a({type:"reset"})}),p("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),p("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),p("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}const hi=["#eef1f5","#eaf6ef","#e2f0e8","#fdf3e2","#e2efe7","#fdeaea","#fdf6de","#e8eaee"];function gi(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=M(),s=h.useRef(null),[p,m]=h.useState(60);h.useEffect(()=>{let g=0;const x=()=>{var k;const b=s.current;if(!b)return;const v=(k=b.parentElement)==null?void 0:k.querySelector('.funnel [aria-selected="true"]');if(!v)return;const f=v.getBoundingClientRect(),y=b.getBoundingClientRect();m(Math.max(20,Math.min(f.left+f.width/2-y.left,y.width-30)))};return g=requestAnimationFrame(x),window.addEventListener("resize",x),()=>{cancelAnimationFrame(g),window.removeEventListener("resize",x)}},[e.ptab]);const c=e.ptab;let d=r.tuto[c].p;if(c===3){const g=n.filter(v=>v.kind==="target"&&ke(v)===3),x=g.filter(v=>na(v)==="auto").length,b=g.filter(v=>na(v)==="cd").length;d=r.tutoPending(x,b,g.length)}const u=(()=>{if(l!=="client")return null;if(c===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(g=>g.id)})};if(c===1){const g=n.filter(x=>x.kind==="target"&&ke(x)===1&&!i.has(x.id)).slice(0,10);if(g.length)return{label:r.tuto[1].a,run:()=>g.forEach(x=>o(x))}}return null})();return t.jsxs("div",{ref:s,className:"tuto mini",style:{"--bg":hi[c],"--ax":p+"px","--stc":"var(--ink)"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[c].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:d}})]})}),u&&t.jsx("button",{type:"button",className:"tprim",onClick:u.run,children:u.label})]})}class We{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,s=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);s&&(r[n++]=s),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*bi(e){for(const a of e)yield*a}function _n(e){return Array.from(bi(e))}var Z=1e-6,W=Math.PI,ze=W/2,en=W/4,Te=W*2,Fe=180/W,Se=W/180,te=Math.abs,vi=Math.atan,xt=Math.atan2,oe=Math.cos,ie=Math.sin,yi=Math.sign||function(e){return e>0?1:e<0?-1:0},Ke=Math.sqrt;function wi(e){return e>1?0:e<-1?W:Math.acos(e)}function ht(e){return e>1?ze:e<-1?-ze:Math.asin(e)}function Ae(){}function Rt(e,a){e&&an.hasOwnProperty(e.type)&&an[e.type](e,a)}var tn={Feature:function(e,a){Rt(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)Rt(r[n].geometry,a)}},an={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){sa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)sa(r[n],a,0)},Polygon:function(e,a){nn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)nn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)Rt(r[n],a)}};function sa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function nn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)sa(e[r],a,1);a.polygonEnd()}function Qe(e,a){e&&tn.hasOwnProperty(e.type)?tn[e.type](e,a):Rt(e,a)}function la(e){return[xt(e[1],e[0]),ht(e[2])]}function Ze(e){var a=e[0],r=e[1],n=oe(r);return[n*oe(a),n*ie(a),ie(r)]}function Nt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function Ot(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function Jt(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function St(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function da(e){var a=Ke(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function ca(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function pa(e,a){return te(e)>W&&(e-=Math.round(e/Te)*Te),[e,a]}pa.invert=pa;function ki(e,a,r){return(e%=Te)?a||r?ca(on(e),sn(a,r)):on(e):a||r?sn(a,r):pa}function rn(e){return function(a,r){return a+=e,te(a)>W&&(a-=Math.round(a/Te)*Te),[a,r]}}function on(e){var a=rn(e);return a.invert=rn(-e),a}function sn(e,a){var r=oe(e),n=ie(e),i=oe(a),o=ie(a);function l(s,p){var m=oe(p),c=oe(s)*m,d=ie(s)*m,u=ie(p),g=u*r+c*n;return[xt(d*i-g*o,c*r-u*n),ht(g*i+d*o)]}return l.invert=function(s,p){var m=oe(p),c=oe(s)*m,d=ie(s)*m,u=ie(p),g=u*i-d*o;return[xt(d*i+u*o,c*r+g*n),ht(g*r-c*n)]},l}function ji(e,a,r,n,i,o){if(r){var l=oe(a),s=ie(a),p=n*r;i==null?(i=a+n*Te,o=a-p/2):(i=ln(l,i),o=ln(l,o),(n>0?i<o:i>o)&&(i+=n*Te));for(var m,c=i;n>0?c>o:c<o;c-=p)m=la([l,-s*oe(c),-s*ie(c)]),e.point(m[0],m[1])}}function ln(e,a){a=Ze(a),a[0]-=e,da(a);var r=wi(-a[1]);return((-a[2]<0?-r:r)+Te-Z)%Te}function Un(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ae,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Lt(e,a){return te(e[0]-a[0])<Z&&te(e[1]-a[1])<Z}function Ct(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Vn(e,a,r,n,i){var o=[],l=[],s,p;if(e.forEach(function(x){if(!((b=x.length-1)<=0)){var b,v=x[0],f=x[b],y;if(Lt(v,f)){if(!v[2]&&!f[2]){for(i.lineStart(),s=0;s<b;++s)i.point((v=x[s])[0],v[1]);i.lineEnd();return}f[0]+=2*Z}o.push(y=new Ct(v,x,null,!0)),l.push(y.o=new Ct(v,null,y,!1)),o.push(y=new Ct(f,x,null,!1)),l.push(y.o=new Ct(f,null,y,!0))}}),!!o.length){for(l.sort(a),dn(o),dn(l),s=0,p=l.length;s<p;++s)l[s].e=r=!r;for(var m=o[0],c,d;;){for(var u=m,g=!0;u.v;)if((u=u.n)===m)return;c=u.z,i.lineStart();do{if(u.v=u.o.v=!0,u.e){if(g)for(s=0,p=c.length;s<p;++s)i.point((d=c[s])[0],d[1]);else n(u.x,u.n.x,1,i);u=u.n}else{if(g)for(c=u.p.z,s=c.length-1;s>=0;--s)i.point((d=c[s])[0],d[1]);else n(u.x,u.p.x,-1,i);u=u.p}u=u.o,c=u.z,g=!g}while(!u.v);i.lineEnd()}}}function dn(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function Zt(e){return te(e[0])<=W?e[0]:yi(e[0])*((te(e[0])+W)%Te-W)}function Ni(e,a){var r=Zt(a),n=a[1],i=ie(n),o=[ie(r),-oe(r),0],l=0,s=0,p=new We;i===1?n=ze+Z:i===-1&&(n=-ze-Z);for(var m=0,c=e.length;m<c;++m)if(u=(d=e[m]).length)for(var d,u,g=d[u-1],x=Zt(g),b=g[1]/2+en,v=ie(b),f=oe(b),y=0;y<u;++y,x=w,v=A,f=q,g=k){var k=d[y],w=Zt(k),z=k[1]/2+en,A=ie(z),q=oe(z),F=w-x,E=F>=0?1:-1,j=E*F,R=j>W,N=v*A;if(p.add(xt(N*E*ie(j),f*q+N*oe(j))),l+=R?F+E*Te:F,R^x>=r^w>=r){var O=Ot(Ze(g),Ze(k));da(O);var T=Ot(o,O);da(T);var S=(R^F>=0?-1:1)*ht(T[2]);(n>S||n===S&&(O[0]||O[1]))&&(s+=R^F>=0?1:-1)}}return(l<-Z||l<Z&&p<-1e-12)^s&1}function Hn(e,a,r,n){return function(i){var o=a(i),l=Un(),s=a(l),p=!1,m,c,d,u={point:g,lineStart:b,lineEnd:v,polygonStart:function(){u.point=f,u.lineStart=y,u.lineEnd=k,c=[],m=[]},polygonEnd:function(){u.point=g,u.lineStart=b,u.lineEnd=v,c=_n(c);var w=Ni(m,n);c.length?(p||(i.polygonStart(),p=!0),Vn(c,Ci,w,r,i)):w&&(p||(i.polygonStart(),p=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),p&&(i.polygonEnd(),p=!1),c=m=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function g(w,z){e(w,z)&&i.point(w,z)}function x(w,z){o.point(w,z)}function b(){u.point=x,o.lineStart()}function v(){u.point=g,o.lineEnd()}function f(w,z){d.push([w,z]),s.point(w,z)}function y(){s.lineStart(),d=[]}function k(){f(d[0][0],d[0][1]),s.lineEnd();var w=s.clean(),z=l.result(),A,q=z.length,F,E,j;if(d.pop(),m.push(d),d=null,!!q){if(w&1){if(E=z[0],(F=E.length-1)>0){for(p||(i.polygonStart(),p=!0),i.lineStart(),A=0;A<F;++A)i.point((j=E[A])[0],j[1]);i.lineEnd()}return}q>1&&w&2&&z.push(z.pop().concat(z.shift())),c.push(z.filter(Si))}}return u}}function Si(e){return e.length>1}function Ci(e,a){return((e=e.x)[0]<0?e[1]-ze-Z:ze-e[1])-((a=a.x)[0]<0?a[1]-ze-Z:ze-a[1])}const cn=Hn(function(){return!0},Ei,Ai,[-W,-ze]);function Ei(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var s=o>0?W:-W,p=te(o-a);te(p-W)<Z?(e.point(a,r=(r+l)/2>0?ze:-ze),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),e.point(o,r),i=0):n!==s&&p>=W&&(te(a-n)<Z&&(a-=n*Z),te(o-s)<Z&&(o-=s*Z),r=zi(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(s,r),i=0),e.point(a=o,r=l),n=s},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function zi(e,a,r,n){var i,o,l=ie(e-r);return te(l)>Z?vi((ie(a)*(o=oe(n))*ie(r)-ie(n)*(i=oe(a))*ie(e))/(i*o*l)):(a+n)/2}function Ai(e,a,r,n){var i;if(e==null)i=r*ze,n.point(-W,i),n.point(0,i),n.point(W,i),n.point(W,0),n.point(W,-i),n.point(0,-i),n.point(-W,-i),n.point(-W,0),n.point(-W,i);else if(te(e[0]-a[0])>Z){var o=e[0]<a[0]?W:-W;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Ti(e){var a=oe(e),r=2*Se,n=a>0,i=te(a)>Z;function o(c,d,u,g){ji(g,e,r,u,c,d)}function l(c,d){return oe(c)*oe(d)>a}function s(c){var d,u,g,x,b;return{lineStart:function(){x=g=!1,b=1},point:function(v,f){var y=[v,f],k,w=l(v,f),z=n?w?0:m(v,f):w?m(v+(v<0?W:-W),f):0;if(!d&&(x=g=w)&&c.lineStart(),w!==g&&(k=p(d,y),(!k||Lt(d,k)||Lt(y,k))&&(y[2]=1)),w!==g)b=0,w?(c.lineStart(),k=p(y,d),c.point(k[0],k[1])):(k=p(d,y),c.point(k[0],k[1],2),c.lineEnd()),d=k;else if(i&&d&&n^w){var A;!(z&u)&&(A=p(y,d,!0))&&(b=0,n?(c.lineStart(),c.point(A[0][0],A[0][1]),c.point(A[1][0],A[1][1]),c.lineEnd()):(c.point(A[1][0],A[1][1]),c.lineEnd(),c.lineStart(),c.point(A[0][0],A[0][1],3)))}w&&(!d||!Lt(d,y))&&c.point(y[0],y[1]),d=y,g=w,u=z},lineEnd:function(){g&&c.lineEnd(),d=null},clean:function(){return b|(x&&g)<<1}}}function p(c,d,u){var g=Ze(c),x=Ze(d),b=[1,0,0],v=Ot(g,x),f=Nt(v,v),y=v[0],k=f-y*y;if(!k)return!u&&c;var w=a*f/k,z=-a*y/k,A=Ot(b,v),q=St(b,w),F=St(v,z);Jt(q,F);var E=A,j=Nt(q,E),R=Nt(E,E),N=j*j-R*(Nt(q,q)-1);if(!(N<0)){var O=Ke(N),T=St(E,(-j-O)/R);if(Jt(T,q),T=la(T),!u)return T;var S=c[0],L=d[0],D=c[1],_=d[1],G;L<S&&(G=S,S=L,L=G);var pe=L-S,se=te(pe-W)<Z,le=se||pe<Z;if(!se&&_<D&&(G=D,D=_,_=G),le?se?D+_>0^T[1]<(te(T[0]-S)<Z?D:_):D<=T[1]&&T[1]<=_:pe>W^(S<=T[0]&&T[0]<=L)){var K=St(E,(-j+O)/R);return Jt(K,q),[T,la(K)]}}}function m(c,d){var u=n?e:W-e,g=0;return c<-u?g|=1:c>u&&(g|=2),d<-u?g|=4:d>u&&(g|=8),g}return Hn(l,s,o,n?[0,-e]:[-W,e-W])}function Li(e,a,r,n,i,o){var l=e[0],s=e[1],p=a[0],m=a[1],c=0,d=1,u=p-l,g=m-s,x;if(x=r-l,!(!u&&x>0)){if(x/=u,u<0){if(x<c)return;x<d&&(d=x)}else if(u>0){if(x>d)return;x>c&&(c=x)}if(x=i-l,!(!u&&x<0)){if(x/=u,u<0){if(x>d)return;x>c&&(c=x)}else if(u>0){if(x<c)return;x<d&&(d=x)}if(x=n-s,!(!g&&x>0)){if(x/=g,g<0){if(x<c)return;x<d&&(d=x)}else if(g>0){if(x>d)return;x>c&&(c=x)}if(x=o-s,!(!g&&x<0)){if(x/=g,g<0){if(x>d)return;x>c&&(c=x)}else if(g>0){if(x<c)return;x<d&&(d=x)}return c>0&&(e[0]=l+c*u,e[1]=s+c*g),d<1&&(a[0]=l+d*u,a[1]=s+d*g),!0}}}}}var dt=1e9,Et=-dt;function Ri(e,a,r,n){function i(m,c){return e<=m&&m<=r&&a<=c&&c<=n}function o(m,c,d,u){var g=0,x=0;if(m==null||(g=l(m,d))!==(x=l(c,d))||p(m,c)<0^d>0)do u.point(g===0||g===3?e:r,g>1?n:a);while((g=(g+d+4)%4)!==x);else u.point(c[0],c[1])}function l(m,c){return te(m[0]-e)<Z?c>0?0:3:te(m[0]-r)<Z?c>0?2:1:te(m[1]-a)<Z?c>0?1:0:c>0?3:2}function s(m,c){return p(m.x,c.x)}function p(m,c){var d=l(m,1),u=l(c,1);return d!==u?d-u:d===0?c[1]-m[1]:d===1?m[0]-c[0]:d===2?m[1]-c[1]:c[0]-m[0]}return function(m){var c=m,d=Un(),u,g,x,b,v,f,y,k,w,z,A,q={point:F,lineStart:N,lineEnd:O,polygonStart:j,polygonEnd:R};function F(S,L){i(S,L)&&c.point(S,L)}function E(){for(var S=0,L=0,D=g.length;L<D;++L)for(var _=g[L],G=1,pe=_.length,se=_[0],le,K,B=se[0],U=se[1];G<pe;++G)le=B,K=U,se=_[G],B=se[0],U=se[1],K<=n?U>n&&(B-le)*(n-K)>(U-K)*(e-le)&&++S:U<=n&&(B-le)*(n-K)<(U-K)*(e-le)&&--S;return S}function j(){c=d,u=[],g=[],A=!0}function R(){var S=E(),L=A&&S,D=(u=_n(u)).length;(L||D)&&(m.polygonStart(),L&&(m.lineStart(),o(null,null,1,m),m.lineEnd()),D&&Vn(u,s,S,o,m),m.polygonEnd()),c=m,u=g=x=null}function N(){q.point=T,g&&g.push(x=[]),z=!0,w=!1,y=k=NaN}function O(){u&&(T(b,v),f&&w&&d.rejoin(),u.push(d.result())),q.point=F,w&&c.lineEnd()}function T(S,L){var D=i(S,L);if(g&&x.push([S,L]),z)b=S,v=L,f=D,z=!1,D&&(c.lineStart(),c.point(S,L));else if(D&&w)c.point(S,L);else{var _=[y=Math.max(Et,Math.min(dt,y)),k=Math.max(Et,Math.min(dt,k))],G=[S=Math.max(Et,Math.min(dt,S)),L=Math.max(Et,Math.min(dt,L))];Li(_,G,e,a,r,n)?(w||(c.lineStart(),c.point(_[0],_[1])),c.point(G[0],G[1]),D||c.lineEnd(),A=!1):D&&(c.lineStart(),c.point(S,L),A=!1)}y=S,k=L,w=D}return q}}const ua=e=>e;var ea=new We,fa=new We,Yn,Wn,ma,xa,Pe={point:Ae,lineStart:Ae,lineEnd:Ae,polygonStart:function(){Pe.lineStart=Oi,Pe.lineEnd=Mi},polygonEnd:function(){Pe.lineStart=Pe.lineEnd=Pe.point=Ae,ea.add(te(fa)),fa=new We},result:function(){var e=ea/2;return ea=new We,e}};function Oi(){Pe.point=qi}function qi(e,a){Pe.point=Gn,Yn=ma=e,Wn=xa=a}function Gn(e,a){fa.add(xa*e-ma*a),ma=e,xa=a}function Mi(){Gn(Yn,Wn)}var et=1/0,qt=et,gt=-et,Mt=gt,Ft={point:Fi,lineStart:Ae,lineEnd:Ae,polygonStart:Ae,polygonEnd:Ae,result:function(){var e=[[et,qt],[gt,Mt]];return gt=Mt=-(qt=et=1/0),e}};function Fi(e,a){e<et&&(et=e),e>gt&&(gt=e),a<qt&&(qt=a),a>Mt&&(Mt=a)}var ha=0,ga=0,ct=0,Pt=0,Dt=0,Xe=0,ba=0,va=0,pt=0,Kn,Qn,Re,Oe,Ee={point:Ge,lineStart:pn,lineEnd:un,polygonStart:function(){Ee.lineStart=Ii,Ee.lineEnd=Bi},polygonEnd:function(){Ee.point=Ge,Ee.lineStart=pn,Ee.lineEnd=un},result:function(){var e=pt?[ba/pt,va/pt]:Xe?[Pt/Xe,Dt/Xe]:ct?[ha/ct,ga/ct]:[NaN,NaN];return ha=ga=ct=Pt=Dt=Xe=ba=va=pt=0,e}};function Ge(e,a){ha+=e,ga+=a,++ct}function pn(){Ee.point=Pi}function Pi(e,a){Ee.point=Di,Ge(Re=e,Oe=a)}function Di(e,a){var r=e-Re,n=a-Oe,i=Ke(r*r+n*n);Pt+=i*(Re+e)/2,Dt+=i*(Oe+a)/2,Xe+=i,Ge(Re=e,Oe=a)}function un(){Ee.point=Ge}function Ii(){Ee.point=$i}function Bi(){Xn(Kn,Qn)}function $i(e,a){Ee.point=Xn,Ge(Kn=Re=e,Qn=Oe=a)}function Xn(e,a){var r=e-Re,n=a-Oe,i=Ke(r*r+n*n);Pt+=i*(Re+e)/2,Dt+=i*(Oe+a)/2,Xe+=i,i=Oe*e-Re*a,ba+=i*(Re+e),va+=i*(Oe+a),pt+=i*3,Ge(Re=e,Oe=a)}function Jn(e){this._context=e}Jn.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,Te);break}}},result:Ae};var ya=new We,ta,Zn,er,ut,ft,bt={point:Ae,lineStart:function(){bt.point=_i},lineEnd:function(){ta&&tr(Zn,er),bt.point=Ae},polygonStart:function(){ta=!0},polygonEnd:function(){ta=null},result:function(){var e=+ya;return ya=new We,e}};function _i(e,a){bt.point=tr,Zn=ut=e,er=ft=a}function tr(e,a){ut-=e,ft-=a,ya.add(Ke(ut*ut+ft*ft)),ut=e,ft=a}let fn,It,mn,xn;class hn{constructor(a){this._append=a==null?ar:Ui(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==mn||this._append!==It){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,mn=n,It=this._append,xn=this._,this._=i}this._+=xn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function ar(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Ui(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return ar;if(a!==fn){const r=10**a;fn=a,It=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return It}function Vi(e,a){let r=3,n=4.5,i,o;function l(s){return s&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),Qe(s,i(o))),o.result()}return l.area=function(s){return Qe(s,i(Pe)),Pe.result()},l.measure=function(s){return Qe(s,i(bt)),bt.result()},l.bounds=function(s){return Qe(s,i(Ft)),Ft.result()},l.centroid=function(s){return Qe(s,i(Ee)),Ee.result()},l.projection=function(s){return arguments.length?(i=s==null?(e=null,ua):(e=s).stream,l):e},l.context=function(s){return arguments.length?(o=s==null?(a=null,new hn(r)):new Jn(a=s),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(s){return arguments.length?(n=typeof s=="function"?s:(o.pointRadius(+s),+s),l):n},l.digits=function(s){if(!arguments.length)return r;if(s==null)r=null;else{const p=Math.floor(s);if(!(p>=0))throw new RangeError(`invalid digits: ${s}`);r=p}return a===null&&(o=new hn(r)),l},l.projection(e).digits(r).context(a)}function Ta(e){return function(a){var r=new wa;for(var n in e)r[n]=e[n];return r.stream=a,r}}function wa(){}wa.prototype={constructor:wa,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function La(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),Qe(r,e.stream(Ft)),a(Ft.result()),n!=null&&e.clipExtent(n),e}function nr(e,a,r){return La(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),s=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,p=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([s,p])},r)}function Hi(e,a,r){return nr(e,[[0,0],a],r)}function Yi(e,a,r){return La(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,s=-o*n[0][1];e.scale(150*o).translate([l,s])},r)}function Wi(e,a,r){return La(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],s=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,s])},r)}var gn=16,Gi=oe(30*Se);function bn(e,a){return+a?Qi(e,a):Ki(e)}function Ki(e){return Ta({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Qi(e,a){function r(n,i,o,l,s,p,m,c,d,u,g,x,b,v){var f=m-n,y=c-i,k=f*f+y*y;if(k>4*a&&b--){var w=l+u,z=s+g,A=p+x,q=Ke(w*w+z*z+A*A),F=ht(A/=q),E=te(te(A)-1)<Z||te(o-d)<Z?(o+d)/2:xt(z,w),j=e(E,F),R=j[0],N=j[1],O=R-n,T=N-i,S=y*O-f*T;(S*S/k>a||te((f*O+y*T)/k-.5)>.3||l*u+s*g+p*x<Gi)&&(r(n,i,o,l,s,p,R,N,E,w/=q,z/=q,A,b,v),v.point(R,N),r(R,N,E,w,z,A,m,c,d,u,g,x,b,v))}}return function(n){var i,o,l,s,p,m,c,d,u,g,x,b,v={point:f,lineStart:y,lineEnd:w,polygonStart:function(){n.polygonStart(),v.lineStart=z},polygonEnd:function(){n.polygonEnd(),v.lineStart=y}};function f(F,E){F=e(F,E),n.point(F[0],F[1])}function y(){d=NaN,v.point=k,n.lineStart()}function k(F,E){var j=Ze([F,E]),R=e(F,E);r(d,u,c,g,x,b,d=R[0],u=R[1],c=F,g=j[0],x=j[1],b=j[2],gn,n),n.point(d,u)}function w(){v.point=f,n.lineEnd()}function z(){y(),v.point=A,v.lineEnd=q}function A(F,E){k(i=F,E),o=d,l=u,s=g,p=x,m=b,v.point=k}function q(){r(d,u,c,g,x,b,o,l,i,s,p,m,gn,n),v.lineEnd=w,w()}return v}}var Xi=Ta({point:function(e,a){this.stream.point(e*Se,a*Se)}});function Ji(e){return Ta({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Zi(e,a,r,n,i){function o(l,s){return l*=n,s*=i,[a+e*l,r-e*s]}return o.invert=function(l,s){return[(l-a)/e*n,(r-s)/e*i]},o}function vn(e,a,r,n,i,o){if(!o)return Zi(e,a,r,n,i);var l=oe(o),s=ie(o),p=l*e,m=s*e,c=l/e,d=s/e,u=(s*r-l*a)/e,g=(s*a+l*r)/e;function x(b,v){return b*=n,v*=i,[p*b-m*v+a,r-m*b-p*v]}return x.invert=function(b,v){return[n*(c*b-d*v+u),i*(g-d*b-c*v)]},x}function es(e){return ts(function(){return e})()}function ts(e){var a,r=150,n=480,i=250,o=0,l=0,s=0,p=0,m=0,c,d=0,u=1,g=1,x=null,b=cn,v=null,f,y,k,w=ua,z=.5,A,q,F,E,j;function R(S){return F(S[0]*Se,S[1]*Se)}function N(S){return S=F.invert(S[0],S[1]),S&&[S[0]*Fe,S[1]*Fe]}R.stream=function(S){return E&&j===S?E:E=Xi(Ji(c)(b(A(w(j=S)))))},R.preclip=function(S){return arguments.length?(b=S,x=void 0,T()):b},R.postclip=function(S){return arguments.length?(w=S,v=f=y=k=null,T()):w},R.clipAngle=function(S){return arguments.length?(b=+S?Ti(x=S*Se):(x=null,cn),T()):x*Fe},R.clipExtent=function(S){return arguments.length?(w=S==null?(v=f=y=k=null,ua):Ri(v=+S[0][0],f=+S[0][1],y=+S[1][0],k=+S[1][1]),T()):v==null?null:[[v,f],[y,k]]},R.scale=function(S){return arguments.length?(r=+S,O()):r},R.translate=function(S){return arguments.length?(n=+S[0],i=+S[1],O()):[n,i]},R.center=function(S){return arguments.length?(o=S[0]%360*Se,l=S[1]%360*Se,O()):[o*Fe,l*Fe]},R.rotate=function(S){return arguments.length?(s=S[0]%360*Se,p=S[1]%360*Se,m=S.length>2?S[2]%360*Se:0,O()):[s*Fe,p*Fe,m*Fe]},R.angle=function(S){return arguments.length?(d=S%360*Se,O()):d*Fe},R.reflectX=function(S){return arguments.length?(u=S?-1:1,O()):u<0},R.reflectY=function(S){return arguments.length?(g=S?-1:1,O()):g<0},R.precision=function(S){return arguments.length?(A=bn(q,z=S*S),T()):Ke(z)},R.fitExtent=function(S,L){return nr(R,S,L)},R.fitSize=function(S,L){return Hi(R,S,L)},R.fitWidth=function(S,L){return Yi(R,S,L)},R.fitHeight=function(S,L){return Wi(R,S,L)};function O(){var S=vn(r,0,0,u,g,d).apply(null,a(o,l)),L=vn(r,n-S[0],i-S[1],u,g,d);return c=ki(s,p,m),q=ca(a,L),F=ca(c,q),A=bn(q,z),T()}function T(){return E=j=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&N,O()}}function rr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}rr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(te(i)>Z&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function as(){return es(rr).scale(175.295)}function ns(e){return e}function rs(e){if(e==null)return ns;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(s,p){p||(a=r=0);var m=2,c=s.length,d=new Array(c);for(d[0]=(a+=s[0])*n+o,d[1]=(r+=s[1])*i+l;m<c;)d[m]=s[m],++m;return d}}function os(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function is(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return yn(e,r)})}:yn(e,a)}function yn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=ss(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function ss(e,a){var r=rs(e.transform),n=e.arcs;function i(c,d){d.length&&d.pop();for(var u=n[c<0?~c:c],g=0,x=u.length;g<x;++g)d.push(r(u[g],g));c<0&&os(d,x)}function o(c){return r(c)}function l(c){for(var d=[],u=0,g=c.length;u<g;++u)i(c[u],d);return d.length<2&&d.push(d[0]),d}function s(c){for(var d=l(c);d.length<4;)d.push(d[0]);return d}function p(c){return c.map(s)}function m(c){var d=c.type,u;switch(d){case"GeometryCollection":return{type:d,geometries:c.geometries.map(m)};case"Point":u=o(c.coordinates);break;case"MultiPoint":u=c.coordinates.map(o);break;case"LineString":u=l(c.arcs);break;case"MultiLineString":u=c.arcs.map(l);break;case"Polygon":u=p(c.arcs);break;case"MultiPolygon":u=c.arcs.map(p);break;default:return null}return{type:d,coordinates:u}}return m(a)}let zt=null;function ls(){return zt||(zt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=is(r,n),o=as().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=Vi(o),s=(i.features||[]).filter(m=>{var c;return(((c=m.properties)==null?void 0:c.name)||"")!=="Antarctica"}).map(m=>{var u;const c=((u=m.properties)==null?void 0:u.name)||"",d=l(m)||"";return d?{i2:_r(c)||null,n:c,d}:null}).filter(m=>!!m);if(!s.length)return null;const p={};for(const[m,c]of Object.entries(Ur)){const d=o(c);d&&(p[m]={x:d[0],y:d[1]})}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:s,anchors:p}}catch{return null}})(),zt)}function ds(e){const[a,r]=h.useState(null);return h.useEffect(()=>{if(!e||a)return;let n=!1;return ls().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const wn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function At(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function cs(e,a){const[r,n]=h.useState(1);return h.useEffect(()=>{let i=!0,o=0;const l=()=>{var m;if(!i)return;const p=(m=e.current)==null?void 0:m.getScreenCTM();p&&p.a>0?n(p.a):o=requestAnimationFrame(l)};l();const s=new ResizeObserver(()=>l());return e.current&&s.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),s.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function ps(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:s,t:p}=M(),m=h.useRef(null),c=h.useRef(null),d=ds(e.continent==="monde"),u=e.continent==="monde"?d:Ca.find(j=>j.key===e.continent)||null,g=cs(m,e.continent+":"+e.mapFolded+":"+!!u),[x,b]=h.useState(new Map),[v,f]=h.useState(null);h.useEffect(()=>{const j=m.current;if(!j)return;const R=new Map;j.querySelectorAll("path[data-i2]").forEach(N=>{const O=N.dataset.i2;if(O)try{const T=N.getBBox();T.width>0&&R.set(O,{x:T.x,y:T.y,w:T.width,h:T.height})}catch{}}),b(R)},[e.continent,g,u]);const y=h.useMemo(()=>r.filter(j=>j.cc),[r]),k=h.useMemo(()=>{const j=new Map;return y.forEach(R=>j.set(R.cc,(j.get(R.cc)||0)+1)),j},[y]),w=e.continent==="monde"&&d?d.anchors:null,z=h.useMemo(()=>y.map(j=>{const R=w&&j.cc?w[j.cc]:void 0;if(R){const D=At(j.name||j.id||""),_=At((j.id||j.name||"")+"·y");return{d:j,x:R.x+(D-.5)*10,y:R.y+(_-.5)*10}}const N=j.cc?x.get(j.cc):void 0;if(!N)return null;const O=At(j.name||j.id||""),T=At((j.id||j.name||"")+"·y"),S=(O-.5)*Math.min(N.w*.55,60),L=(T-.5)*Math.min(N.h*.55,60);return{d:j,x:N.x+N.w/2+S,y:N.y+N.h/2+L}}).filter(j=>!!j),[y,x,w]),A=j=>g>0?j/g:j,q=h.useMemo(()=>n?[0,1,2,3,4,5].map(j=>({c:wn[j],fr:p.plabels[j].toUpperCase(),en:p.plabels[j].toUpperCase(),n:r.filter(R=>R.kind==="target"&&ke(R)===j).length})).filter(j=>j.n>0):Ba.map((j,R)=>({...j,n:r.filter(N=>$a(N)===R).length})),[r,n,p.plabels]),F=o?l.get(o):null,E=F?z.find(j=>j.d.id===F.id):null;return u?t.jsxs("div",{className:"mapzone",ref:c,children:[t.jsxs("svg",{ref:m,viewBox:u.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":s==="fr"?u.fr:u.en,onMouseLeave:()=>{f(null),i(null)},children:[t.jsx("g",{children:u.countries.map((j,R)=>t.jsx("g",{className:"ct"+(j.i2&&k.get(j.i2)?"":" empty"),children:t.jsx("path",{d:j.d,"data-i2":j.i2||void 0})},R))}),t.jsx("g",{children:z.map(j=>{const R=Ba[$a(j.d)],N=!!xe(j.d),O=j.d.kind==="target",T=n&&O?wn[ke(j.d)]:R.c,S=!n&&Ce(j.d);return t.jsxs("g",{className:"co"+(S?" done":""),onMouseEnter:()=>{var _,G;const L=(_=c.current)==null?void 0:_.getBoundingClientRect(),D=(G=m.current)==null?void 0:G.createSVGPoint();if(D&&m.current&&L){D.x=j.x,D.y=j.y;const pe=D.matrixTransform(m.current.getScreenCTM());f({x:pe.x-L.left,y:pe.y-L.top,label:j.d.name+" · "+(rt(j.d.cc,s)||j.d.countryLabel||"")})}i(j.d.id)},onMouseLeave:()=>{f(null),i(null)},onClick:()=>{var _;const L=(_=m.current)==null?void 0:_.createSVGPoint();let D=null;if(L&&m.current){L.x=j.x,L.y=j.y;const G=L.matrixTransform(m.current.getScreenCTM());D={x:G.x,y:G.y}}a({type:"popup",id:j.d.id,anchor:D})},children:[t.jsx("circle",{className:"h",cx:j.x,cy:j.y,r:A(Math.max(11,R.px+7))}),t.jsx("circle",{className:"v",cx:j.x,cy:j.y,r:A(R.px),fill:T,stroke:N?"#DC2626":"#ffffff",strokeWidth:A(N?2.2:1.3)})]},j.d.id||j.d.name)})}),E&&t.jsx("circle",{className:"ring on",cx:E.x,cy:E.y,r:A(13),fill:"none",stroke:"#0F172A",strokeWidth:A(2)})]}),t.jsx("div",{className:"hov"+(v?" on":""),style:v?{left:v.x,top:v.y}:void 0,children:v==null?void 0:v.label}),t.jsx("div",{className:"legend",children:q.map((j,R)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":j.c}}),s==="fr"?j.fr:j.en," ",t.jsx("b",{children:j.n})]},R))}),r.some(j=>!j.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",p.notLocated," ",t.jsx("b",{children:r.filter(j=>!j.cc).length})]})})]}):t.jsx("div",{className:"mapzone",ref:c})}function us(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function fs(){const{st:e,dispatch:a,dossiers:r,t:n,pipe:i,contName:o,lang:l}=M(),s=e.filters,p=h.useMemo(()=>e.continent==="monde"?r:r.filter(x=>x.continent===e.continent),[r,e.continent]),m=x=>p.filter(b=>x!=="country"&&s.country.length&&!s.country.includes(b.cc||"")?!1:za(b,s,i,x==="country"?void 0:x)),c=h.useMemo(()=>{const x=m("win"),b=v=>x.filter(f=>(f.date?Math.max(0,Math.floor((Date.now()-Date.parse(f.date))/864e5)):9999)<=v).length;return[b(0),b(7),b(30),x.length]},[p,s,i]),d=h.useMemo(()=>s.day?m("win").filter(x=>(x.date||"").slice(0,10)===s.day).length:0,[p,s,i]),u=s.sector.length+s.country.length+s.engine.length+s.stage.length+s.angle.length+s.memoLevel.length+(s.signalOnly?1:0)+(s.day||s.win!=="all"?1:0)+(s.search.trim()?1:0),g=(x,b,v,f="fbtn")=>t.jsxs("button",{type:"button",className:f,"aria-expanded":e.openFacet===x,onClick:()=>a({type:"openFacet",facet:x}),children:[t.jsx("span",{className:"fl",children:b}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:"▾"})]},x);return t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[s.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[n.fDay(us(s.day,l)),t.jsx("b",{children:d})]}),t.jsx("button",{type:"button",onClick:()=>a({type:"filters",patch:{day:"",win:"all"}}),children:n.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((x,b)=>t.jsxs("button",{type:"button","aria-pressed":s.win===x,onClick:()=>a({type:"filters",patch:{win:x}}),children:[n.dates[b],t.jsx("b",{children:c[b]})]},x))}),t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:n.identSearch,value:s.search,onChange:x=>a({type:"filters",patch:{search:x.target.value}})})]}),t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":e.openFacet==="sig",onClick:()=>a({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:n.fSignal}),s.signalOnly&&t.jsx("span",{className:"n",children:s.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),s.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":e.openFacet==="sec",onClick:()=>a({type:"openFacet",facet:"sec"}),title:s.sector[0],children:[t.jsx("span",{className:"fl",children:n.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:s.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):g("sec",n.fSector,s.sector.length),g("pay",n.fCountry,s.country.length),g("det",n.fEngine,s.engine.length),g("sta",n.fStage,s.stage.length),i&&g("ang","Angle",s.angle.length),i&&g("mem","Mémo",s.memoLevel.length)]}),t.jsx("span",{className:"fgrow"}),t.jsxs("div",{className:"frow2",children:[e.mapFolded&&t.jsxs("button",{type:"button",className:"mapbtn",onClick:()=>a({type:"mapFold",folded:!1}),children:["🗺 ",n.showMap.replace("🗺 ","")]}),u>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:n.clearTitle(p.length,o),onClick:()=>a({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:n.clear(u)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>a({type:"modal",modal:"alert"}),children:n.alertBtn})]})]}),e.openFacet&&t.jsx(ms,{poolFor:m})]})}function ms({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=M(),o=a.filters,l=a.openFacet,{title:s,cols:p,options:m}=h.useMemo(()=>{if(l==="sig"){const x=e("signal").filter(f=>xe(f)),b=new Map;x.forEach(f=>{const y=f.engine||"";b.set(y,(b.get(y)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:x.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...ra([...b.keys()],i).map(f=>({v:f,label:Je(f)+" "+De(f,i),n:b.get(f)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(f)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const x=e("sector"),b=new Map;return x.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v,n:f,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const x=e("country"),b=new Map;return x.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:rt(v,i)||v,n:f,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const x=e("engine"),b=new Map;return x.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:ra([...b.keys()],i).map(v=>({v,label:Je(v)+" "+De(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Vr(Hr(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const x=e("angle"),b=new Map;return x.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,f)=>f[1]-v[1]).map(([v,f])=>({v,label:v.replace(/[_-]+/g," "),n:f,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const x=e("memoLevel"),b=new Map;x.forEach(f=>{if(f.kind==="target"){const y=Na(f);b.set(y,(b.get(y)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(f=>({v:String(f),label:v[f],n:b.get(f)||0,html:!1,on:o.memoLevel.includes(f)}))}}const u=e("stage"),g=new Map;return u.forEach(x=>{x.stage&&g.set(x.stage,(g.get(x.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...g.entries()].sort((x,b)=>b[1]-x[1]).map(([x,b])=>({v:x,label:x,n:b,html:!1,on:o.stage.includes(x)}))}},[l,a,i]),c=u=>{if(l==="sig"){if(u==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const x=o.signalEngines.includes(u)?o.signalEngines.filter(b=>b!==u):[...o.signalEngines,u];r({type:"filters",patch:{signalOnly:!0,signalEngines:x}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(u)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:u})},d=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:s}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:d,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(p===2?" two":""),children:m.map(u=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":u.on,onClick:()=>c(u.v),children:[t.jsx("span",{className:"bx"}),u.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:u.label}}):t.jsx("span",{className:"l",children:u.label}),t.jsx("span",{className:"n",children:u.n})]},u.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function or(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function xs(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function kn({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:s}=M();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(p=>p.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(p=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:p.name}),p.chips.map(m=>t.jsx("span",{className:"ch",children:m},m))]}),p.line1&&t.jsx("p",{className:"w",children:p.line1}),p.line2&&t.jsx("p",{className:"r",children:p.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(p.name),children:s.rsEvalOne})]},p.name))})]}):null}function ir({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=M(),i=((e==null?void 0:e.companies_cited)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.what||"").trim(),line2:(s.role||"").trim(),chips:[(s.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(s=>s&&(s.name||"").trim()).map(s=>({name:(s.name||"").trim(),line1:(s.why||"").trim(),chips:[(s.country||"").trim(),(s.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(kn,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(kn,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function hs({card:e,onEvaluate:a,onAddAll:r}){var s,p,m;const{t:n}=M(),i=[e.industry,...e.market_tags||[],e.author].map(c=>(c||"").trim()).filter(Boolean),o=(((s=e.prospective)==null?void 0:s.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(c=>c&&c.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(c=>t.jsx("span",{children:c},c))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:or(e.summary_md||"").map((c,d)=>t.jsx("p",{children:c},d))})]}),t.jsx(ir,{card:e,onEvaluate:a,onAddAll:r}),(((p=e.prospective)==null?void 0:p.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((m=e.prospective)==null?void 0:m.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(c=>t.jsx("li",{children:c},c))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(c=>t.jsx("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",children:c.label||c.url},c.url))})]})]})}function gs(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function bs({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=M(),s=i,[p,m]=h.useState(null),[c,d]=h.useState(null),[u,g]=h.useState(null),[x,b]=h.useState(!1);h.useEffect(()=>{let f=!0;return(async()=>{const y=await On({email:l,cbToken:s});f&&m(y)})(),()=>{f=!1}},[l,s,n]);const v=f=>{d(f),g(null),b(!0),(async()=>{const y=await Yr(f.id);g(y),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[c?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{d(null),g(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),c&&t.jsx("span",{className:"ti",children:c.title}),!c&&p&&t.jsx("span",{className:"n",children:p.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!c&&t.jsxs("div",{className:"rsarch-list",children:[p===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),p!==null&&p.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(p||[]).map(f=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(f),children:[t.jsx("span",{className:"ti",children:f.title}),t.jsxs("span",{className:"me",children:[gs(f.created_at),f.industry?` · ${f.industry}`:"",f.author?` · ${f.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(f.cited_n||0,f.evaluate_n||0)}),t.jsx("span",{className:"st"+(f.published?" on":""),children:f.published?o.rsPub:o.rsPriv})]},f.id))]}),c&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[c.source_url&&t.jsx("a",{href:c.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),c.published&&c.page_url&&t.jsx("a",{href:c.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(c.published?" on":""),children:c.published?o.rsPub:o.rsPriv})]}),x&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!x&&!u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!x&&u&&t.jsx(hs,{card:u,onEvaluate:a,onAddAll:r})]})]})}const jn=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function vs(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:s,evalCards:p,caps:m,data:c,canWrite:d,source:u}=M(),g=a==="client",x=h.useMemo(()=>r||(u!=="default"?Wr():""),[r,u]),[b,v]=h.useState(""),[f,y]=h.useState(!1),[k,w]=h.useState(""),[z,A]=h.useState(!1),[q,F]=h.useState(""),[E,j]=h.useState([]),R=h.useRef(!1),[N,O]=h.useState(!1),[T,S]=h.useState(""),[L,D]=h.useState(""),[_,G]=h.useState(!1),[pe,se]=h.useState(0),[le,K]=h.useState(""),[B,U]=h.useState(null),[V,ee]=h.useState(null),[re,ve]=h.useState(!1),[de,Y]=h.useState(null),[X,he]=h.useState(0),H=h.useRef(!1),ae=b.trim()?jn.test(b.trim())?e.evalUrl:e.evalName:e.evalWaiting,Q=h.useMemo(()=>k.split(`
`).map(P=>P.trim()).filter(Boolean).slice(0,15),[k]);h.useEffect(()=>{if(typeof window>"u")return;const P=(new URLSearchParams(window.location.search).get("rs")||"").trim();!P||!/^https?:\/\//i.test(P)||(S(P),O(!0))},[]),h.useEffect(()=>{const P=J=>{var ge;const ne=String(((ge=J.detail)==null?void 0:ge.url)||"").trim();!ne||!/^https?:\/\//i.test(ne)||(S(ne),O(!0))};return window.addEventListener("ppmap:research",P),()=>window.removeEventListener("ppmap:research",P)},[]),h.useEffect(()=>{if(!d&&!x){Y(null);return}let P=!0;return(async()=>{const J=await On({email:n,cbToken:x});P&&Y(J.length)})(),()=>{P=!1}},[d,x,n,X]);const Ie=E.length?E:p,ue=c.credits,fe=h.useCallback(P=>{const J=P.map(ne=>(ne||"").trim()).filter(Boolean);J.length&&(w(ne=>{const ge=ne.split(`
...
`)}),y(!0))},[]);h.useEffect(()=>{if(!_)return;se(0);const P=window.setInterval(()=>se(J=>J+1),1e3);return()=>window.clearInterval(P)},[_]);const qe=()=>{const P=b.trim();P&&(i(null,P),v(""))},_e=async()=>{if(!g){i(null,Q[0]||"");return}if(!Q.length||z)return;A(!0),R.current=!1;const P=[];for(let J=0;J<Q.length&&!R.current;J++){F(e.evaluating(J+1,Q.length,Q[J]));const ne=await qn(r,Q[J],"atelier2");if(P.unshift({name:ne.company||Q[J],verdict:ne.verdict,reason:ne.reason||"",remaining:ne.remaining??null}),j([...P]),ne.verdict==="quota"){P.unshift({name:"",verdict:"quota",reason:e.quota(Q.length-J-1),remaining:0}),j([...P]),w(Q.slice(J+1).join(`
`)),F(""),A(!1);return}}F(""),w(R.current?Q.slice(P.length).join(`
`):""),A(!1)},je=async()=>{var ne,ge,Be;if(H.current)return;const P=T.trim().replace(/\s+/g,""),J=L.trim();if(!P&&!J){K(e.rsNeed);return}if(!g&&!x){i(null,P||J.slice(0,80));return}H.current=!0,K(""),U(null),ee(null),G(!0);try{const ye=await Kr({url:P,text:J,email:n,cbToken:x});if(G(!1),!ye||ye.status!=="success"){K((ye==null?void 0:ye.message)||"Erreur");return}U(ye),O(!1),fe((((ne=ye.prospective)==null?void 0:ne.companies_to_evaluate)||[]).map($e=>($e==null?void 0:$e.name)||"")),ee({state:"pending"});const Ne=await Qr(ye,{email:n,cbToken:x});ee(Ne.ok?{state:"ok",scopeLabel:((ge=Ne.summary)==null?void 0:ge.scope_label)||"",scope:((Be=Ne.summary)==null?void 0:Be.scope)||""}:{state:"fail",msg:Ne.error||""}),Ne.ok&&he($e=>$e+1)}finally{H.current=!1,G(!1)}},Me=[B==null?void 0:B.industry,...(B==null?void 0:B.market_tags)||[],B==null?void 0:B.author].map(P=>(P||"").trim()).filter(Boolean),it=(V==null?void 0:V.state)==="pending",Vt=V&&(it?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):V.state==="ok"?t.jsx("span",{className:"rslink ok",children:V.scope&&V.scope!=="public"?e.rsSavedIn(V.scopeLabel||V.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:V.msg,children:e.rsSaveFail})),Ht=xs(B).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow",children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:b,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:P=>v(P.target.value),onKeyDown:P=>{P.key==="Enter"&&qe()}}),t.jsx("span",{className:"detect"+(jn.test(b.trim())?" url":""),children:ae})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),disabled:s,onClick:qe,children:[t.jsx("span",{className:"fill"}),e.evalGo]}),m.showCredits&&ue&&t.jsxs("button",{type:"button",className:"credits"+(ue.total_available<=0&&!ue.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:ue.unlimited?"∞":ue.total_available}),!ue.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",ue.daily_grant+ue.purchased]}),ue.total_available<=0&&!ue.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>y(!f),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(N?" on":""),onClick:()=>O(!N),children:e.rsOpen}),de!==null&&de>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(re?" on":""),onClick:()=>ve(!re),children:e.rsArchOpen(de)})]}),re&&t.jsx(bs,{bump:X,cbToken:x,onClose:()=>ve(!1),onEvaluate:P=>i(null,P),onAddAll:fe}),N&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:T,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:P=>S(P.target.value),onKeyDown:P=>{P.key==="Enter"&&je()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:L,placeholder:e.rsTextPh,onChange:P=>D(P.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(_?" loading":""),style:{justifyContent:"center"},disabled:_||it||!T.trim()&&!L.trim(),onClick:()=>{je()},children:[t.jsx("span",{className:"fill"}),_?`${Gr(T.trim())==="youtube"&&T.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(pe)}`:it?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),le&&t.jsx("div",{className:"rserr",children:le}),B&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:B.title}),B.source_url&&t.jsx("a",{href:B.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{U(null),ee(null)},children:"×"})]}),B.market&&t.jsx("p",{className:"rsmk",children:B.market}),Me.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),Me.map(P=>t.jsx("span",{children:P},P))]}),t.jsxs("div",{className:"rsbody",children:[B.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${B.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:or(B.summary_md||"").map((P,J)=>t.jsx("p",{children:P},J))})]}),t.jsx(ir,{card:B,onEvaluate:P=>i(null,P),onAddAll:fe}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(Ht)}),Vt]})]}),f&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:k,placeholder:e.bulkPh,onChange:P=>w(P.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(z?" loading":""),style:{justifyContent:"center"},disabled:z||!Q.length,onClick:()=>{_e()},children:[t.jsx("span",{className:"fill"}),z&&q?q:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(Q.length)})]})]}),Ie.slice(0,1).map((P,J)=>{const ne=P.verdict==="kept",ge=P.verdict==="quota",Be=ne?"var(--brand)":ge?"var(--bolt)":"var(--red)",ye=ne?"var(--brand-l)":ge?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":Be,"--bgc":ye},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ne?"✓ "+e.kept:ge?"⏳":"✗ "+e.dropped})}),P.name&&t.jsx("span",{className:"rn",children:P.name}),t.jsx("span",{className:"rr",children:P.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",P.reason]}):null}),!ge&&t.jsx("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"space"}),children:e.seeSpace(ne?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},J)}),g&&(o.kept+o.dropped>0||Ie.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function ys(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function ws(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=M(),o=e.memoConsole?r.get(e.memoConsole):null,l=h.useMemo(()=>o?[o.reasoning||"",ys(o.summary||"")].filter(Boolean).join(`
...
`;function js(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let s=e.y+10;return s+n>o-8&&(s=Math.max(8,e.y-n-14)),s<8&&(s=8),{left:l,top:s}}function Ns(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:s,doAnalyse:p,doDecide:m,doPromote:c,doRepeche:d,doApproach:u,doDeep:g,doOnboard:x,outbound:b,evalBusy:v}=M(),f=e.popupId?r.get(e.popupId):null;if(!f)return null;const y=xe(f),k=ke(f),w=nt(f),z=f.kind==="target",A=q=>{a({type:"filters",patch:q}),a({type:"popup",id:null})};return at.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:ks}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:js(e.popupAnchor,!!f.card),onClick:q=>q.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:f.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(tt(f.date)),De(f.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[f.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>A({country:[f.cc]}),children:(rt(f.cc,i)||f.countryLabel||"").toUpperCase()}),f.sector&&t.jsx("button",{type:"button",onClick:()=>A({sector:[f.sector]}),children:f.sector.toUpperCase()}),f.stage&&t.jsx("button",{type:"button",onClick:()=>A({stage:[f.stage]}),children:f.stage.toUpperCase()}),typeof f.amountEur=="number"&&f.amountEur>0&&t.jsx("span",{className:"am2",children:Bt(f.amountEur,i)})]}),(f.tagline||f.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:f.tagline||f.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[Je(f.engine)," ",t.jsx("b",{children:De(f.engine,i)})," — ",Jr(f.engine,i),f.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",f.noteTitle]})]}),y?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(ot,{o:f,lg:!0})," ",t.jsx(Ut,{o:f,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Mn(y,i))," · ",n.win7(Fn(y,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),f.card?t.jsx(_t,{spec:f.card}):null,f.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&k>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:f.reasoning})]}),o.pipe&&z&&w&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[w,typeof f.score=="number"&&f.score>0?" · "+n.score(f.score):""]})})]}),t.jsx(sr,{name:f.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[k===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)]}),k===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{p(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),k===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{c(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),k===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{m(f,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{m(f,!1),a({type:"popup",id:null})},children:n.actNo}),Ea(f)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{g(f),a({type:"popup",id:null})},children:n.memoDeep})]}),k===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{u(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),k===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{d(f),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),f.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:f.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{x(f),a({type:"popup",id:null})},children:"🚀"})]}):f.engine==="media"&&f.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var q;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f.url}}))}catch{}a({type:"popup",id:null}),(q=document.querySelector(".atl2 .demand"))==null||q.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(f.name),onClick:()=>s(f),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>s(f),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(f.name.length>22?f.name.slice(0,21)+"…":f.name)," →"]}),f.website&&t.jsx("a",{className:"psite",href:f.website.startsWith("http")?f.website:"https://"+f.website,target:"_blank",rel:"noopener noreferrer",title:f.website,children:"🌐"})]})]})]}),document.body)}const Ss=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Tt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function Cs(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Tt(a.slice(n));break}r+=Tt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Tt(a.slice(i));break}const l=a.slice(i+1,o).trim(),s=/^(\/?)([a-zA-Z0-9]+)/.exec(l),p=s?s[2].toLowerCase():"";s&&Ss.has(p)?r+=`<${s[1]}${p}>`:r+=Tt(a.slice(i,o+1)),n=o+1}return r}const Nn=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function be({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function Es({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=M(),o=$t(e),l=nt(e),s=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),p=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,m=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,c=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),d=h.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(s?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:p},{k:"ctc",lib:a.cdContact,n:m},{k:"suivi",lib:a.cdSuivi,n:c}].filter(b=>b.n>0),[e,a,s,l,p,m,c]),[u,g]=h.useState("");if(!d.length)return null;const x=d.some(b=>b.k===u)?u:d[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:d.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":x===b.k,className:x===b.k?"on":"",onClick:v=>{v.stopPropagation(),g(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[x==="conv"&&t.jsxs(t.Fragment,{children:[s&&t.jsxs("div",{className:"cdv1"+(s==="NO MATCH"?" out":""),children:[t.jsx("b",{children:s==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(be,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(be,{k:a.cdVerdictDate,v:Nn(e.verdictDate,r)})]})]}),x==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:Cs(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(zs,{o:e})]}),x==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdSector,v:e.sector}),t.jsx(be,{k:a.cdStage,v:e.stage}),t.jsx(be,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(be,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(be,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(be,{k:a.cdAngle,v:e.angle}),t.jsx(be,{k:a.cdDetected,v:Nn(e.date,r)})]}),x==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdName,v:e.contactName}),t.jsx(be,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(be,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),x==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(be,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(be,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function zs({o:e}){const{t:a,token:r}=M(),[n,i]=h.useState(!1),[o,l]=h.useState(null),s=async()=>{n||(i(!0),l(await Zr(r,e.name,e.website||e.domain||"")),i(!1))},p=(o==null?void 0:o.blocs)||{},m=[[a.qaVP,p.value_prop],[a.qaProduct,p.produit],[a.qaModel,p.modele],[a.qaSummary,p.synthese]],c=m.some(([,d])=>d);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{s()},children:n?a.qaBusy:a.qaRun})]}),o&&c&&t.jsxs(t.Fragment,{children:[m.filter(([,d])=>d).map(([d,u])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:d}),t.jsx("p",{children:u})]},d)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!c&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}const lr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function Ra({o:e}){const{t:a}=M(),r=$t(e),n=nt(e),i=ke(e),o=na(e),l=eo(e);return t.jsxs("span",{className:"c-vd",children:[r?t.jsx("span",{className:"vd "+(r==="MATCH"?"v-ok":"v-no"),title:a.vt[r],children:r}):t.jsx("span",{className:"vd wait",children:a.actToEval}),n?t.jsx("span",{className:"vd "+(lr[n]||"v-cons"),title:a.vt[n],children:n}):i===1?t.jsx("span",{className:"vd wait",children:a.actMemoQueue}):null,i===3&&o==="auto"&&t.jsx("span",{className:"org au",title:a.orgAutoTitle,children:a.orgAuto}),i===3&&o==="cd"&&t.jsx("span",{className:"org cd",title:a.orgCdTitle,children:a.orgCd}),i===3&&l!==null&&t.jsx("span",{className:"wait2 "+(l>10?"hot":l>=5?"warm":""),title:a.waitTitle(l),children:a.waitChip(l)})]})}const ka=e=>e.length>22?e.slice(0,21)+"…":e;function Sn({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=M(),[o,l]=h.useState(!1);if(h.useEffect(()=>{n||l(!1)},[n]),Ce(e)){const m=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":m?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[m?"✓":"✗"," ",t.jsx("b",{children:m?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const p=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(p?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:m=>{m.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(ka(e.name))})]})}function dr({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:s,doRepeche:p,doApproach:m,dispatch:c}=M();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"stbtn",style:{"--c":"var(--line2)","--tc":"var(--dim)"},onClick:g=>{g.stopPropagation(),c({type:"modal",modal:"rdv"})},children:[t.jsx("span",{className:"lk",children:"🔒"}),a.actLocked.replace("🔒 ","")]})});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:g=>{var x;g.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(x=document.querySelector(".atl2 .demand"))==null||x.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(Sn,{o:e})});const d=ke(e),u=g=>x=>{x.stopPropagation(),g()};if(d===0)return t.jsx("span",{className:"cell",children:t.jsx(Sn,{o:e})});if(d===1){const g=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:g,onClick:u(()=>o(e)),children:g?a.actAnalyseQueued:a.actAnalyse})})}if(d===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:u(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:u(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})});if(d===4){const g=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:g,onClick:u(()=>m(e)),children:g?a.actApproachSent:a.actApproach})})}return d===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>s(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):d===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:u(()=>p(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:u(()=>c({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:u(()=>c({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function As({o:e}){const{t:a,doThumb:r,thumbOf:n}=M(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Ts({o:e}){const{lang:a}=M();return xe(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(ot,{o:e}),t.jsx(Ut,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[Je(e.engine||"")," ",De(e.engine||"",a)]})})}function Ls({o:e,locked:a,open:r,onToggle:n}){const{st:i,dispatch:o,caps:l,markRow:s,markedId:p,favIds:m,toggleFav:c}=M(),d=ke(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],g=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,x=g<=0?0:g<=7?1:g<=30?2:3,b=l.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][d]:u[x],v=m.has(e.id),f=y=>{if(a)return;if(l.pipe||e.kind==="op"){n();return}const k=y.currentTarget.getBoundingClientRect();o({type:"popup",id:e.id,anchor:{x:k.left+Math.min(280,k.width/3),y:k.bottom}})};return t.jsxs(h.Fragment,{children:[t.jsxs("div",{className:"row"+(p===e.id||r?" on":"")+(r?" open":"")+(a?" locked":""),onMouseEnter:()=>s(e.id),onMouseLeave:()=>s(null),onClick:f,children:[t.jsx("span",{className:"pt",style:{"--c":b}}),t.jsx(xr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm",title:e.name,children:[l.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:v?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),c(e)},children:v?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial — cliquez pour déplier",children:"📖"})]}),t.jsx(Rs,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Ts,{o:e}),l.pipe&&t.jsx(Ra,{o:e}),l.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(dr,{o:e}),l.showThumbs&&t.jsx(As,{o:e})]}),r&&!a&&t.jsx(qs,{o:e})]})}function Rs({o:e}){const{lang:a,caps:r}=M();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=Bt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Os({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=M(),l=(u,g=!1)=>x=>{x.stopPropagation(),g&&o({type:"continent",key:"monde"}),o({type:"filters",patch:u})},s=(()=>{const u=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return u?u[1].slice(0,40):""})(),p=Bt(e.amountEur,r),m=(e.date||"").slice(0,10).split("-").reverse().join("/"),c=Ce(e),d=c&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),p&&t.jsx("span",{className:"oc-amt",children:p}),m&&t.jsx("span",{children:m})]}),t.jsxs("div",{className:"oc-acts",children:[c?t.jsxs("span",{className:"verdict",style:{"--c":d?"var(--brand)":"var(--red)"},children:[d?"✓":"✗"," ",t.jsx("b",{children:d?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:u=>{var g;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ka(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:u=>{u.stopPropagation(),n(e)},children:a.evalGoOn(ka(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:u=>u.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(_t,{spec:e.card})})]})}function qs({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=M();return!i.pipe&&e.kind==="op"?t.jsx(Os,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(Es,{o:e}),t.jsx(ii,{o:e}),t.jsx(di,{o:e}),t.jsx(sr,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:s=>{s.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(Ra,{o:e})})]}),e.card&&t.jsx(_t,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[Je(e.engine||"")," ",De(e.engine||"",r)]}),xe(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(ot,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsxs("div",{className:"sec2 acts2",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"btn p",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})]})]})]})}function Ms({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o}=M();if(!i.pipe&&e.kind==="op")return t.jsxs("div",{className:"dcard dops"+(a?" locked":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(_t,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),!a&&t.jsx("div",{className:"dact",children:t.jsx(dr,{o:e})})]});const l=ke(e),s=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][l];return t.jsxs("div",{className:"dcard"+(a?" locked":""),style:{"--c":s},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(Ra,{o:e}),xe(e)&&t.jsx(ot,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&l===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function Fs(){const{t:e}=M(),[a,r]=h.useState(0);return h.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Ps({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=M(),o=i==="en",l=c=>n.plabels[c]||"",s=[0,1,2,3,4,5,6,7].filter(c=>c!==a.ptab&&(e[c]||0)>0),p=s.includes(0)?0:s.sort((c,d)=>(e[d]||0)-(e[c]||0))[0];if(p===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const m=e[p]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:p===0?o?`${m} ${m>1?"files are":"file is"} waiting for your screening`:`${m} dossier${m>1?"s":""} attende${m>1?"nt":""} votre évaluation`:o?`${m} ${m>1?"files":"file"} in “${l(p)}”`:`${m} dossier${m>1?"s":""} dans « ${l(p)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:p}),children:[(o?"Open ":"Ouvrir ")+l(p)," →"]})]})}function Ds(){const e=M(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,lang:s,sessTally:p,data:m,dossiers:c,source:d}=e,u=d==="ops"?8:Dn,[g,x]=h.useState(new Set);h.useEffect(()=>{x(new Set)},[a.ptab,a.continent]);const[b,v]=h.useState(null);h.useEffect(()=>{v(null)},[a.ptab,a.continent]);const f=N=>x(O=>{const T=new Set(O);return T.has(N)?T.delete(N):T.add(N),T}),y=h.useMemo(()=>Aa(l,a.sort),[l,a.sort]),k=h.useMemo(()=>y.filter(N=>xe(N)&&!Ce(N)).length,[y]),w=h.useMemo(()=>i.pipe?y:y.filter(N=>!Ce(N)&&!N.noCo),[y,i.pipe]),z=d==="ops"?y.filter(N=>N.noCo).length:0,A=i.pipe?n.plabels[a.ptab].toLowerCase():d==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,q=(N,O,T="",S=!1)=>t.jsxs("button",{type:"button","data-s":N,className:T,"aria-sort":a.sort.key===N?a.sort.dir===1?"ascending":"descending":"none",style:S?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:N}),children:[O,t.jsx("span",{className:"ar",children:a.sort.key===N&&a.sort.dir===1?"▴":"▾"})]},N),F=h.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const N=new Map;y.forEach(S=>{const L=S.engine||"?";N.has(L)||N.set(L,[]),N.get(L).push(S)});const O={ma:0,fundraising:1,nominations:2,recrutements:3,media:4},T=ra([...N.keys()],s);return[...N.entries()].sort((S,L)=>{const D=O[S[0]]??10+T.indexOf(S[0]),_=O[L[0]]??10+T.indexOf(L[0]);return D-_})},[y,i.pipe,a.groupBy,s]),E=i.lockRowsAfter;let j=0;const R=(N,O)=>{let T=a.shown[O]||u;d==="ops"&&N.length-T<=4&&(T=N.length);const L=N.slice(0,T).map(D=>{const _=E!==null&&j>=E;j++;const G=a.dens!=="maxi"&&(a.dens==="deplie"||(b?b==="open":d==="ops"&&!!D.decryptHtml)),pe=g.has(D.id)?!G:G;return a.dens==="maxi"?t.jsx(Ms,{o:D,locked:_},D.id):t.jsx(Ls,{o:D,locked:_,open:pe,onToggle:()=>f(D.id)},D.id)});if(N.length>T&&d!=="ops"){const D=Math.min(u,N.length-T),_=N.length-T;L.push(t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>r({type:"more",group:O,by:u,base:u}),children:[t.jsx("span",{className:"more-label",children:n.more(D,_)}),t.jsxs("span",{className:"more-meta",children:[n.moreMeta(T,N.length)," · ",_," ",s==="en"?"remaining":_>1?"restantes":"restante"]})]},O+":more"))}return L};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead",children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:y.length})," ",A]}),t.jsx("span",{className:"dot",children:"·"}),t.jsxs("span",{className:"ctx",children:[e.contName,i.pipe&&e.fund?" · "+e.fund:"",d==="ops"&&y.length>0&&" — "+n.edSplit(y.length-z,z)]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||d==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([N,O])=>t.jsxs("button",{type:"button","data-d":N,"aria-pressed":a.dens===N||N==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:N}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:O})]},N))}),(i.showFunnel||d==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":b==="open",onClick:()=>{v("open"),x(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":b==="closed",onClick:()=>{v("closed"),x(new Set)},children:n.foldAllLbl}),d==="ops"&&t.jsxs("button",{type:"button","aria-pressed":b===null,onClick:()=>{v(null),x(new Set)},children:["📖 ",n.foldArts]})]}),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:N=>r({type:"sort",key:N.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage]].map(([N,O])=>t.jsx("option",{value:N,children:O},N))})]}),i.showChain&&w.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:w.map(N=>N.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(w.length):n.chainAll(w.length)]})]}),k>0&&!a.filters.signalOnly&&t.jsxs("div",{className:"sigstrip",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(k)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo})]}),a.dens!=="maxi"&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),q("country",n.colCountry),q("name",n.colCompany),q("amount",n.colAmount,"h-amt",!0),q("stage",n.colStage,"h-stade"),q("signal",n.colSignal,"h-sig"),i.pipe&&t.jsx("span",{className:"h-vd",children:n.colVerdict}),i.pipe&&q("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),t.jsxs("div",{className:"list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(d==="ops"?" opsl":"")+(y.length?"":" list-empty"),children:[F?F.map(([N,O])=>t.jsxs(h.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:Je(N)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:De(N,s)}),t.jsx("div",{className:"s",children:n.grpCount(O.filter(T=>!Ce(T)).length,O.length)})]})]}),R(O,N)]},N)):R(y,"pt"+a.ptab),m.loading&&!c.length&&t.jsx(Fs,{}),!y.length&&!(m.loading&&!c.length)&&(i.pipe?t.jsx(Ps,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]}),d==="ops"&&F&&(()=>{let N=0,O=0;for(const[S,L]of F){O+=L.length;let D=a.shown[S]||u;L.length-D<=4&&(D=L.length),N+=Math.min(L.length,D)}const T=O-N;return T<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>F.forEach(([S,L])=>r({type:"more",group:S,by:L.length,base:u})),children:[t.jsx("span",{className:"more-label",children:n.more(T,T)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(N,O)})]})})(),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(p.kept>0||p.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(p.kept,p.dropped)}})]})}function Cn(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Is(e,a){const r=to(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Bs(e,a){const n=[a.head.split("|").map(Cn).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Is(i,a.plabels),$t(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(Cn).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function $s(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const _s=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Le({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Us({o:e,qa:a}){const{t:r,lang:n,fund:i}=M(),o=(e.cribleStatus||"").trim().toUpperCase()||($t(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=nt(e),s=(a==null?void 0:a.blocs)||{},p=[[r.qaVP,s.value_prop],[r.qaProduct,s.produit],[r.qaModel,s.modele],[r.qaSummary,s.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Le,{k:r.cdSector,v:e.sector}),t.jsx(Le,{k:r.cdStage,v:e.stage}),t.jsx(Le,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Le,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Le,{k:r.cdName,v:e.contactName}),t.jsx(Le,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Le,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Le,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Le,{k:r.cdAngle,v:e.angle}),t.jsx(Le,{k:r.cdDetected,v:_s(e.date,n)})]}),p.some(([,m])=>m)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),p.filter(([,m])=>m).map(([m,c])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:m}),t.jsx("p",{children:c})]},m))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Vs(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=M(),[s,p]=h.useState({}),m=25,c=h.useMemo(()=>n.slice(0,m),[n]);h.useEffect(()=>{c.length&&ao(r,c.map(g=>g.name)).then(p)},[r,c]);const d=o.stats,u=g=>g.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(c.length)}),n.length>m&&t.jsx("span",{className:"mnote dim",children:e.dsCap(m,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),d&&typeof d.screened=="number"&&t.jsxs("p",{children:[u(d.screened)," ",e.funScreened(""),typeof d.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",u(d.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(u(o.marketEstimate)),", ",Math.round(d.screened/o.marketEstimate*100)," %"]})]})]}),c.map(g=>t.jsx(Us,{o:g,qa:s[g.name]},g.id)),!c.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Hs=50;function Oa({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=M(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[m,c]=h.useState(""),[d,u]=h.useState(0),[g,x]=h.useState(""),[b,v]=h.useState(!1),f=h.useRef(null);h.useEffect(()=>()=>{f.current&&window.clearInterval(f.current)},[]);const y=async w=>{p(!0),c("");const z=await a();if(p(!1),z.ok){l(z);return}if(z.busy){c(i.alertPreviewBusy);return}if(!w){c(i.alertPreviewFail);return}u(Hs),f.current=window.setInterval(()=>{u(A=>A>1?A-1:(f.current&&window.clearInterval(f.current),y(!1),0))},1e3)},k=async()=>{if(n||b)return;v(!0),x("");const w=await r();v(!1),x(w.ok?i.alertTestOk(w.sentTo||""):w.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:s||d>0,onClick:()=>{y(!0)},children:s?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{k()},children:b?"…":i.alertTest})]}),d>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(d)}),m&&t.jsx("p",{className:"mnote warn",children:m}),g&&t.jsx("p",{className:"mnote",children:g}),!g&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const mt="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function we({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=M();return at.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Ys(){const{st:e}=M();switch(e.modal){case"chain":return t.jsx(Gs,{});case"space":return t.jsx(Ks,{});case"alert":return t.jsx(Qs,{});case"queue":return t.jsx(tl,{});case"export":return t.jsx(al,{});case"plug":return t.jsx(ol,{});case"recharge":return t.jsx(sl,{});case"cover":return t.jsx(dl,{});case"dossier":return t.jsx(ll,{});case"crit":return t.jsx(cl,{});case"tuto":return t.jsx(pl,{});case"rdv":return t.jsx(Ws,{});case"memoalert":return t.jsx(nl,{});default:return null}}function Ws(){const{dispatch:e,fund:a}=M(),r=typeof document<"u"&&!!document.getElementById("rdv");return h.useEffect(()=>{r&&(e({type:"modal",modal:null}),Jo())},[r,e]),r?null:t.jsx(oo,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0,onClose:()=>e({type:"modal",modal:null})})}function Gs(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:s}=M(),p=o==="client",m=e.chain.queue.map(g=>r.get(g)).filter(g=>!!g),c=e.chain.idx,d=m[c],u=c>=m.length;return at.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:u?n.finished:`${c+1} / ${m.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(u?100:c/Math.max(1,m.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:u||!d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(m.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:d.name}),t.jsx("div",{className:"sub",children:[rt(d.cc,i)||d.countryLabel,d.sector,d.stage,n.daysAgo(tt(d.date))].filter(Boolean).map(g=>String(g).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:De(d.engine,i).toUpperCase()}),typeof d.amountEur=="number"&&d.amountEur>0&&t.jsx("span",{children:Bt(d.amountEur,i)})]}),xe(d)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(ot,{o:d,lg:!0})," ",t.jsx(Ut,{o:d,src:!0})]}),(d.tagline||d.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:d.tagline||d.headline})]}),d.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:d.reasoning})]}),p&&Ce(d)&&t.jsxs("div",{className:"vbox",style:{"--c":Ye(d)==="retenu"?"var(--brand)":Ye(d)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:Ye(d)==="retenu"?"✓ "+n.kept:Ye(d)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:d.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!u&&d&&!(p&&Ce(d))&&t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:s,onClick:()=>{l(d)},children:[t.jsx("span",{className:"fill"}),n.launchEval]}),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(u?{type:"modal",modal:null}:{type:"chainNext"}),children:u?n.closeBtn:n.skip})]})]})})}),document.body)}function Ks(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=M(),o=i==="client",l=h.useMemo(()=>o?r.filter(d=>Ce(d)):[],[r,o]),s=h.useMemo(()=>Aa(l.filter(d=>Ye(d)==="retenu"),{key:"signal",dir:-1}),[l]),p=h.useMemo(()=>l.filter(d=>Ye(d)==="ecarte"),[l]),m=e.spaceTab==="retenu"?s:p,c=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(we,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:s.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:p.length})]})]}),m.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),m.slice(0,40).map(d=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":c},children:typeof d.score=="number"&&d.score>0?d.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:d.name}),t.jsx("div",{className:"rr",children:d.reasoning||d.tagline||""})]})]},d.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function Qs(){const{mode:e}=M();return e==="client"||e==="apercu"?t.jsx(Xs,{}):t.jsx(el,{})}function Xs(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=M(),[o,l]=h.useState("d"),s=i!=="client";return t.jsxs(we,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(Js,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="w"&&t.jsx(Zs,{t:e,token:a,readOnly:s,flash:r,flashErr:n}),o==="m"&&t.jsx(cr,{})]})}function Js({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[m,c]=h.useState(0);h.useEffect(()=>{let x=!0;return p(!1),Ha(a).then(b=>{x&&(b?l(b):p(!0))}),()=>{x=!1}},[a,m]);const d=x=>{r||Ha(a,x).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(x=>x+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=x=>!o.sections||o.sections.includes(x),g=x=>{const b=o.sections||e.alertSec.map(([v])=>v);d({sections:u(x)?b.filter(v=>v!==x):[...b,x]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>d({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([x,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:u(x),disabled:r,onChange:()=>g(x)}),t.jsxs("span",{children:[b,x==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},x))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(Oa,{label:e.alertPreview,readOnly:r,onPreview:()=>fo(a),onTest:()=>uo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Zs({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=h.useState(null),[s,p]=h.useState(!1),[m,c]=h.useState(0);h.useEffect(()=>{let x=!0;return p(!1),Ya(a).then(b=>{x&&(b?l(b):p(!0))}),()=>{x=!1}},[a,m]);const d=x=>{r||Ya(a,x).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(s)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>c(x=>x+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const u=o.dow??0,g=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>d({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:u,disabled:r,onChange:x=>d({dow:Number(x.target.value)}),children:e.alertDow.map((x,b)=>t.jsx("option",{value:b,children:x},x))}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.max(6,g-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[g," h"]}),t.jsx("button",{type:"button",onClick:()=>d({hour:Math.min(21,g+1)}),disabled:r,children:"＋"})]})]}),t.jsx(Oa,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>xo(a),onTest:()=>mo(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function cr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=M(),[l,s]=h.useState(o||""),[p,m]=h.useState(!1),[c,d]=h.useState(!1);h.useEffect(()=>{o&&s(o)},[o]);const u=e.filters,g=h.useMemo(()=>n.filter(f=>xe(f)).length,[n]),x=u.win==="1"?0:u.win==="7"?1:u.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||c)){d(!0);try{await fetch(`${ja}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:u.sector,countries:u.country,source:o?"atelier2-client":"atelier2",website:""})}),m(!0)}finally{d(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[x]],[a.amRows.signal,u.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,u.engine.length?u.engine.map(f=>De(f,r)).join(", "):a.amAllEngines],[a.amRows.sectors,u.sector.length?u.sector.join(", "):a.amAllSectors],[a.amRows.countries,u.country.length?u.country.map(f=>rt(f,r)||f).join(", "):a.amAllCountries],[a.amRows.stages,u.stage.length?u.stage.join(", "):a.amAllStages]];return p?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([f,y])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:f}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:y}})]},f))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:f=>s(f.target.value),onKeyDown:f=>{f.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,g)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function el(){const{t:e}=M();return t.jsx(we,{title:e.alertTitle,icon:"🔔",children:t.jsx(cr,{})})}function tl(){var b,v,f;const{t:e,token:a,fund:r,mode:n,flash:i}=M(),[o,l]=h.useState(null),[s,p]=h.useState([]),[m,c]=h.useState(0),d=n==="client";h.useEffect(()=>{let y=!0;return(async()=>{const[k,w]=await Promise.all([Sa(r),Rn(a)]);y&&(k&&l(k),p(w))})(),()=>{y=!1}},[a,r,m]);const u=(o==null?void 0:o.per_day)??2,g=((b=o==null?void 0:o.analyzed_today)==null?void 0:b.length)??0,x=(v=o==null?void 0:o.tomorrow)!=null&&v.length?o.tomorrow:((o==null?void 0:o.pool_meta)||[]).slice(0,10);return t.jsxs(we,{title:e.queueTitle,wide:!0,children:[t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(g,g+(((f=o==null?void 0:o.pool_order)==null?void 0:f.length)??0))}})}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(u)})]})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:s.map(y=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:y.company}),t.jsxs("span",{className:"qd",children:[y.memo_type,typeof y.est_min=="number"?` · ~${y.est_min} min`:""]}),t.jsx("span",{className:"qt",children:y.status}),y.url&&t.jsx("a",{className:"qgo",href:y.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),d&&y.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{Va(a,y.company,"retry").then(()=>c(k=>k+1))},children:e.queueRetry}),d&&y.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{Va(a,y.company,"delete").then(()=>c(k=>k+1))},children:e.queueDelete})]},y.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.queueTomorrow]}),t.jsxs("div",{className:"qrows",children:[x.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),x.slice(0,10).map((y,k)=>t.jsxs("div",{className:"qr2",children:[t.jsxs("span",{className:"qn2",children:["#",k+1]}),t.jsx("b",{children:y.name}),typeof y.score=="number"&&t.jsx("span",{className:"qs2",children:y.score})]},y.name))]})]})}function al(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=M(),s=`${mt}/cibles/list.csv?token=${a}`,p=`${mt}/cibles/list.json?token=${a}`,m=`${mt}/cibles/export.xlsx?token=${a}&scope=full`,c=`=IMPORTDATA("${s}")`,d=v=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},u=[{def:e.exportCsv,value:s,href:s},{def:e.exportSheet,value:c},{def:e.exportLive,value:p,href:p},{def:e.exportXlsx,value:m,href:m}],g=!i.lockActions&&n.length>0,x=()=>{$s(Bs(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([f])=>f===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(we,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:x,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:u.map(({def:v,value:f,href:y})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>d(f),children:e.exportCopy}),y&&t.jsx("a",{className:"exb",href:y,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function nl(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=M(),o=i!=="client",[l,s]=h.useState(null),[p,m]=h.useState(!1),[c,d]=h.useState(0),[u,g]=h.useState(!1);h.useEffect(()=>{let f=!0;return m(!1),Ua(a).then(y=>{f&&(y?s(y):m(!0))}),()=>{f=!1}},[a,c]);const x=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=f=>{if(o||!l)return;const y={enabled:f.enabled??!!l.enabled,email:f.email??(l.email||""),sections:f.sections??x()};g(!0),Ua(a,y).then(k=>{if(g(!1),!k){n(e.memoAlertErr);return}s(k),r(e.memoAlertSaved)})};if(p)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>d(f=>f+1),children:e.retry})]})});if(!l)return t.jsx(we,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=x();return t.jsxs(we,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||u,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(rl,{value:l.email||"",readOnly:o||u,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:f=>b({email:f})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([f,y])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[f],disabled:o||u,onChange:()=>b({sections:{...v,[f]:!v[f]}})}),t.jsx("span",{children:y})]},f))}),t.jsx(Oa,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>ro(a,v),onTest:()=>no(a,v)})]})}function rl({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=h.useState(e);h.useEffect(()=>{l(e)},[e]);const s=o.trim()!==e.trim(),p=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:m=>l(m.target.value),onKeyDown:m=>{m.key==="Enter"&&s&&p&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!s||!p,onClick:()=>i(o.trim()),children:n})]})]})}function ol(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=M(),[o,l]=h.useState(null),[s,p]=h.useState(!1),[m,c]=h.useState(null),[d,u]=h.useState(""),[g,x]=h.useState(0);h.useEffect(()=>{let f=!0;return p(!1),oa(a).then(y=>{f&&(y?l({configured:y.configured,url_hint:y.url_hint}):p(!0))}),so(a).then(y=>{f&&c(y)}),()=>{f=!1}},[a,g]);const b=(f,y)=>{i&&oa(a,f).then(k=>{if(!k||k.ok===!1){n(e.actErr);return}f.test&&k.sent===!1?n(e.plugTestThrottled):r(y),x(w=>w+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}';return t.jsxs(we,{title:e.plugTitle,icon:"🔌",wide:!0,children:[m&&t.jsx("p",{className:"mnote"+(m.enabled?" warn":""),children:m.enabled?e.plugAutoOn(m.destination||"webhook"):e.plugAutoOff}),s?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(f=>f+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:d,disabled:!i,onChange:f=>u(f.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!d.trim(),onClick:()=>b({url:d.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsx(il,{}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var f;(f=navigator.clipboard)==null||f.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]})]})]})}function il(){const{t:e,token:a,lang:r}=M(),[n,i]=h.useState("valides"),[o,l]=h.useState(!1),[s,p]=h.useState(null),[m,c]=h.useState(null),[d,u]=h.useState(!1),[g,x]=h.useState(!1),[b,v]=h.useState(null),[f,y]=h.useState(null),[k,w]=h.useState(null),z=`atl2:bulk:${a}:${n}`;h.useEffect(()=>{oa(a).then(N=>{y(N&&N.configured?N.url_hint||"webhook":null)})},[a]),h.useEffect(()=>{p(null),c(null),u(!1),v(null);try{const N=JSON.parse(localStorage.getItem(z)||"null");w(N&&Date.now()-Date.parse(N.t)<24*3600*1e3?N:null)}catch{w(null)}},[z]);const A=async()=>{l(!0),u(!1),v(null);const N=await co(a,n);p(N),c(N.ok?n:null),l(!1)},q=h.useRef(!1),F=async()=>{if(q.current)return;q.current=!0,x(!0);const N=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let O;try{O=await po(a,n,"webhook",void 0,N)}finally{q.current=!1}if(x(!1),u(!1),v(O),O.ok&&(O.pushed||0)>0){const T={t:new Date().toISOString(),n:O.pushed||0};w(T);try{localStorage.setItem(z,JSON.stringify(T))}catch{}}},E=s!=null&&s.ok&&s.ready||0,j=!!(s!=null&&s.ok)&&m===n&&E>0&&!!f&&!k,R=k?new Date(k.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:N=>i(N.target.value),children:e.plugBulkTabs.map(([N,O])=>t.jsx("option",{value:N,children:O},N))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{A()},children:o?"…":e.plugBulkPreview})]}),s&&(s.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(s.ready||0,s.linkedinReady||0,(s.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(s!=null&&s.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),k&&t.jsx("p",{className:"mnote",children:e.bulkLocked(R,k.n)}),!k&&!!(s!=null&&s.ok)&&!f&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!k&&!s&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),j&&!d&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>u(!0),children:e.bulkArm}),j&&d&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(E,f||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:g,onClick:()=>{F()},children:g?e.bulkSending:e.bulkConfirm(f||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:g,onClick:()=>u(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function sl(){const{t:e,data:a,lang:r}=M(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const s=window.location.href.split("?")[0];try{const m=await(await fetch(`${ja}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:s+"?credits=ok",cancel_url:s+"?credits=cancel"})})).json();m.url&&(window.location.href=m.url)}catch{}};return t.jsxs(we,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function ll(){const{t:e}=M();return t.jsx(we,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Vs,{})})}function dl(){const{t:e,lang:a,data:r,dossiers:n,token:i,canWrite:o,flash:l}=M(),[s,p]=h.useState(null),[m,c]=h.useState(!1);h.useEffect(()=>{let A=!0;return Sa(i).then(q=>{A&&q&&typeof q.per_day=="number"&&p(q.per_day)}),()=>{A=!1}},[i]);const d=r.stats,u=typeof(d==null?void 0:d.screened)=="number"?d.screened:n.filter(A=>A.kind==="target"&&Ce(A)).length,g=r.marketEstimate||0,x=g>0?Math.min(100,Math.round(u/g*100)):null,b=(d==null?void 0:d.window_days)||30,v=u>0?u/b:0,f=g>0?Math.max(0,g-u):0,k=g>0&&v>0&&u>=100?Math.round(f/v):null,w=A=>Math.round(A).toLocaleString(a==="en"?"en-US":"fr-FR"),z=A=>{m||!o||(c(!0),lo(i,A).then(q=>{if(c(!1),q===null){l(e.actErr);return}p(q),l(e.alertSaved)}))};return t.jsxs(we,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(w(u))}),g>0&&t.jsx("span",{children:e.covOf(w(g))})]}),x!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:x+"%"}}),t.jsxs("em",{children:[x," %"]})]}),k!==null&&t.jsx("p",{className:"mnote",children:e.covEta(k)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),v>=1&&t.jsx("p",{className:"mnote",children:e.covPace(w(v))}),d&&t.jsxs("div",{className:"covf",children:[typeof d.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.kept)})," ",e.covKept]}),typeof d.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.analyzed)})," ",e.covAna]}),typeof d.shown=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:w(d.shown)})," ",e.covShown]})]}),o&&s!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(s)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(A=>t.jsx("button",{type:"button",className:s===A?"on":"",disabled:m,onClick:()=>z(A),children:A===0?"⏸":A},A))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function cl(){var f,y,k;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o}=M(),l=n==="client",s=h.useMemo(()=>{const w=new Set;return a.forEach(z=>{z.angle&&w.add(z.angle)}),[...w]},[a]),[p,m]=h.useState(null);h.useEffect(()=>{let w=!0;return io(r).then(z=>{w&&m(z.thumbs)}),()=>{w=!1}},[r]);const[c,d]=h.useState(""),[u,g]=h.useState(""),[x,b]=h.useState(!1),v=async()=>{const w=c.trim();if(!(!w||x||!l)){b(!0),g("");try{const A=await(await fetch(`${mt}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:w,who:"atelier2"})})).json().catch(()=>({}));if(A.reply&&g(String(A.reply)),A.job_id){g(e.critChatRunning);const q=async()=>{const F=await fetch(`${mt}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:A.job_id})}).then(E=>E.json()).catch(()=>null);if(F&&F.done){g(String(F.reply||F.clarification||F.summary||"✓")),b(!1),F.applied&&i(e.alertSaved);return}setTimeout(()=>{q()},8e3)};setTimeout(()=>{q()},8e3),d("");return}d("")}finally{u.startsWith("⏳")||b(!1)}}};return t.jsxs(we,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((f=o.points)!=null&&f.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(w=>t.jsx("li",{children:w},w))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((y=o==null?void 0:o.angles)!=null&&y.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(w=>{var z,A;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:w.title}),w.why&&t.jsx("p",{className:"why",children:w.why}),t.jsxs("div",{className:"lo",children:[!!((z=w.look)!=null&&z.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:w.look.map(q=>t.jsx("li",{children:q},q))})]}),!!((A=w.out)!=null&&A.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:w.out.map(q=>t.jsx("li",{children:q},q))})]})]})]},w.title)})]}),!!((k=o==null?void 0:o.gate)!=null&&k.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(w=>t.jsxs("li",{children:[w.k&&t.jsx("b",{children:w.k}),w.t]},w.t))})]}),s.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:s.map(w=>t.jsx("li",{style:{marginBottom:5},children:w.replace(/[_-]+/g," ")},w))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:c,disabled:!l||x,onChange:w=>d(w.target.value),onKeyDown:w=>{w.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(x?" loading":""),style:{padding:"12px 18px"},disabled:!l||x||!c.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),u&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:u})]}),t.jsx("div",{className:"qsec ok",children:e.critThumbsTitle}),p===null?t.jsx("div",{className:"sp-empty",children:"…"}):p.length===0?t.jsx("p",{className:"mnote",children:e.critThumbsEmpty}):t.jsx("div",{className:"qrows",style:{marginBottom:14},children:p.slice(0,12).map((w,z)=>t.jsxs("div",{className:"qr2",children:[t.jsx("span",{className:"qn2",children:w.kind==="YES"?"👍":"👎"}),t.jsx("b",{children:w.company}),t.jsx("span",{className:"qd",children:(w.ts||"").slice(0,10)})]},z))}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([w,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(lr[w]||"v-cons"),children:w}),t.jsx("span",{children:z})]},w))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([w,z])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:w}),t.jsxs("span",{children:["← ",z]})]},w))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function pl(){const{t:e,dispatch:a,startTour:r}=M(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(we,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const aa={},En=(aa==null?void 0:aa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function zn(){return new Date().toISOString().slice(0,10)}const pr=h.createContext(null);function ur(){const e=h.useContext(pr);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function ul({token:e,children:a}){const{dispatch:r,st:n,lang:i}=M(),[o,l]=h.useState(()=>n.filters.day||zn()),[s,p]=h.useState(null),[m,c]=h.useState(!1),d=h.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),u=h.useCallback(()=>{l(zn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);h.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),h.useEffect(()=>{const b=v=>{var y;const f=(y=v.detail)==null?void 0:y.day;typeof f=="string"&&d(f)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[d]),h.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),h.useEffect(()=>{if(!e||!o)return;let b=!1;c(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${En}/cibles/edition.json?${v}`).then(f=>f.json()).then(f=>{b||p(f)}).catch(()=>{b||p({ok:!1,error:"network"})}).finally(()=>{b||c(!1)}),()=>{b=!0}},[e,o]);const g=h.useMemo(()=>`${En}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),x=h.useMemo(()=>({token:e,day:o,ed:s,loading:m,pickDay:d,pickWindow:u,dayPicked:!!n.filters.day,daysUrl:g,isEn:i==="en"}),[e,o,s,m,d,u,n.filters.day,g,i]);return t.jsx(pr.Provider,{value:x,children:a})}function fl(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=ur();return t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
        .thesis-days{margin:0;padding:0 12px 2px;background:#0B1220;border:none}
      `}),t.jsx(ho,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function ml(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=ur(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),s=(a==null?void 0:a.ok)&&!l,p=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),p&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),s&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["No thesis brief for ",t.jsx("b",{children:e})," yet. Pick another day on the strip under LIVE, or check back after the morning run."]}):t.jsxs(t.Fragment,{children:["Pas encore de brief de thèse pour le ",t.jsx("b",{children:e}),". Choisissez un autre jour sous le LIVE, ou revenez après le run du matin."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const fr="atl2:mapfold",xl=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(fr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},mr=h.createContext(null),M=()=>{const e=h.useContext(mr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function ot({o:e,lg:a}){const{lang:r}=M(),n=xe(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Wa(n,r),children:[n.emoji," ",Wa(n,r)]}):null}function Ut({o:e,src:a}){const{lang:r,t:n}=M(),i=xe(e);if(!i)return null;const o=wo(i),l=ko(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Mn(i,r))+" · "+n.win7(Fn(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(s,p)=>t.jsx("i",{className:p<o?"on":""},p))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:s=>s.stopPropagation(),children:"↗"})]})}function xr({o:e}){const{lang:a}=M(),r=yo(e.cc),n=e.cc?rt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const An="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",hr=e=>`atl2:tour:${e||"anon"}`;function hl(e){try{return localStorage.getItem(hr(e))==="1"}catch{return!0}}function Tn(e){try{localStorage.setItem(hr(e),"1")}catch{}}function gl(e){const a=e.tourT,r=e.howto;return[{sel:".atl2 .ident",title:a.ident,body:e.tourIntro},{sel:".atl2 .ticker",title:a.live,body:e.fhintLive},{sel:".atl2 .goal",title:a.goal,body:e.fhintGoal},{sel:".atl2 .funnel",title:a.funnel,body:r[2][0],ptab:1},{sel:".atl2 .tuto",title:a.tuto,body:r[3][0],ptab:3},{sel:".atl2 .demand",title:a.demand,body:r[1][0]},{sel:".atl2 .card .dec",need:".atl2 .list",title:a.dec,body:e.fhintDec,ptab:1,dens:"deplie"},{sel:".atl2 .csp",need:".atl2 .list",title:a.status,body:e.fhintStatus,ptab:1,dens:"deplie"},{sel:".atl2 .learn",title:a.learn,body:e.learnLine},{sel:".atl2 .ftools",title:a.tools,body:r[6][0]},{sel:".atl2 .tool",title:a.crit,body:r[0][0]}]}function jl({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){const{lang:l}=go(),s=To[l],p=$o(e,l,a),[m,c]=h.useReducer(Uo,void 0,()=>_o((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||xl(),{ptab:n==null?void 0:n.ptab,dens:n==null?void 0:n.dens,filters:r,modal:n==null?void 0:n.modal})),d=h.useRef(!0);h.useEffect(()=>{if(d.current){d.current=!1;return}if(!e)try{localStorage.setItem(fr,m.mapFolded?"on":"off")}catch{}},[m.mapFolded,e]);const u=h.useRef(o);u.current=o,h.useEffect(()=>{var C;(C=u.current)==null||C.call(u,m.filters)},[m.filters]);const[g,x]=h.useState(null),[b,v]=h.useState(null),[f,y]=h.useState({kept:0,dropped:0}),[k,w]=h.useState(!1),[z,A]=h.useState(""),[q,F]=h.useState(!1),[E,j]=h.useState(null),[R,N]=h.useState(!1),[O,T]=h.useState(!1),[,S]=h.useState(0),L=()=>S(C=>C+1),D=h.useRef([]),_=h.useRef(new Set),G=h.useRef(new Set),pe=h.useRef(new Map),se=h.useRef(null),{mode:le}=p,K=h.useMemo(()=>({...p.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[p.caps,i,a]),B=K.pipe,U=p.session.token||"",V=le==="client"&&!e;h.useEffect(()=>{if(document.querySelector(`link[href="${An}"]`))return;const C=document.createElement("link");C.rel="stylesheet",C.href=An,document.head.appendChild(C)},[]);const ee=(C,I=!1)=>{A(C),F(I),se.current&&clearTimeout(se.current),se.current=setTimeout(()=>A(""),I?4200:2400)},re=C=>ee(C,!0),ve=h.useMemo(()=>{const C=new Map;return p.dossiers.forEach(I=>{I.id&&C.set(I.id,I)}),C},[p.dossiers]),de=h.useMemo(()=>p.dossiers.filter(C=>In(C,m,B)),[p.dossiers,m,B]),Y=h.useRef(!1);h.useEffect(()=>{if(Y.current||e||p.loading||!p.dossiers.length)return;if(!K.showFunnel||hl(p.session.token||"")){Y.current=!0;return}Y.current=!0;const C=window.setTimeout(()=>{Tn(p.session.token||""),N(!0)},700);return()=>window.clearTimeout(C)},[e,p.loading,p.dossiers.length,K.showFunnel,p.session.token]);const X=h.useMemo(()=>p.dossiers.filter(C=>Vo(C,m,B,p.favIds)),[p.dossiers,m,B,p.favIds]),he=h.useMemo(()=>bo(de,p.favIds),[de,p.favIds]),H=Ca.find(C=>C.key===m.continent),ae=m.continent==="monde"?s.contWorld:(l==="fr"?H==null?void 0:H.fr:H==null?void 0:H.en)||"";h.useEffect(()=>{const C=I=>{var ce;const $=(((ce=I.detail)==null?void 0:ce.name)||"").trim();$&&Q(null,$)};return window.addEventListener("ppmap:evaluate",C),()=>window.removeEventListener("ppmap:evaluate",C)});const Q=(C,I)=>{const $=((C==null?void 0:C.name)||I||"").trim();if(!V){v({kicker:$});return}!$||k||(w(!0),(async()=>{try{const ce=await qn(U,$,"atelier2"),vt={name:ce.company||$,verdict:ce.verdict,reason:ce.reason||"",remaining:ce.remaining??null};D.current=[vt,...D.current].slice(0,8),ce.verdict==="kept"&&y(Ue=>({...Ue,kept:Ue.kept+1})),ce.verdict==="ruled_out"&&y(Ue=>({...Ue,dropped:Ue.dropped+1}));const st=C||p.dossiers.find(Ue=>(Ue.name||"").toLowerCase()===$.toLowerCase());st&&(ce.verdict==="kept"?st.verdict=st.verdict||"MATCH":ce.verdict==="ruled_out"&&(st.verdict="NO MATCH"),ce.reason&&(st.reasoning=ce.reason)),L()}finally{w(!1)}})())},Ie=C=>{if(!V){v({kicker:C.name});return}_.current.add(C.id),lt(U,"fast_request",C.name||"",""),ee(s.memoInstantSent(C.name)),L()},ue=C=>pe.current.get(C.id)??p.thumbs.get((C.name||"").trim().toLowerCase()),fe=(C,I)=>c({type:"undoPush",entry:{id:C.id,name:C.name,prevCeoStatus:I}}),qe=async(C,I,$)=>{const ce=C.ceoStatus||"";C.ceoStatus=I,L();const vt=await Gt(U,{status:I,airtable_id:C.airtableId,check_id:C.checkId,company:C.name,...($==null?void 0:$.note)!==void 0?{note:$.note}:{},...$!=null&&$.via?{via:$.via}:{}});return vt.ok?vt.skipped?(C.ceoStatus=ce,L(),re(s.actNotPersisted),!1):(($==null?void 0:$.undo)!==!1&&fe(C,ce),$!=null&&$.msg&&ee($.msg),(I==="Validé"||I==="Écarté")&&!C.ceoNote&&($==null?void 0:$.note)===void 0&&j({o:C,yes:I==="Validé"}),!0):(C.ceoStatus=ce,L(),re(s.actErr),!1)},_e=async(C,I)=>{const $=await Gt(U,{status:C.ceoStatus||"Retenu",airtable_id:C.airtableId,check_id:C.checkId,company:C.name,note:I,via:"note"});return!$.ok||$.skipped?(re($.skipped?s.actNotPersisted:s.actErr),!1):(C.ceoNote=I,L(),!0)},je=h.useRef(new Map),Me=C=>je.current.has(C.id)?je.current.get(C.id):p.stages.get((C.name||"").trim().toLowerCase()),it=(C,I)=>{je.current.set(C.id,I),L()},Vt=(C,I)=>{V&&qe(C,I?"Validé":"Écarté",{msg:I?s.decidedYes(C.name):s.decidedNo(C.name)})},Ht=C=>{V&&qe(C,"À trancher",{msg:s.promoted(C.name)})},P=C=>{V&&(async()=>{const I=C.ceoStatus||"";C.ceoStatus="Retenu",L();const $=await Gt(U,{status:"Retenu",check_id:C.checkId,company:C.name});if(!$.ok||$.skipped){C.ceoStatus=I,L(),re($.skipped?s.actNotPersisted:s.actErr);return}fe(C,I),ee(s.repeched(C.name))})()},J=()=>{const C=m.undo[m.undo.length-1];if(!C){ee(s.undoNone);return}const I=ve.get(C.id);if(!I){c({type:"undoPop"}),ee(s.undoNone);return}let $=C.prevCeoStatus;if(!$)if((I.verdict||"").toUpperCase().includes("CALL"))$="À trancher";else{ee(s.undoLockedTitle);return}(async()=>await qe(I,$,{undo:!1})&&(c({type:"undoPop"}),I.ceoStatus=C.prevCeoStatus,L(),ee(s.undoDone(I.name))))()},ne=C=>{V&&(G.current.add(C.id),L(),(async()=>{const I=await jo(U,C.name,"email");if(!I||I.ok===!1){G.current.delete(C.id),L(),re(s.actErr);return}lt(U,"approach",C.name||"",""),ee(s.actApproachSent)})())},ge=(C,I)=>{V&&(async()=>{if(!(await lt(U,I?"yes":"no",C.name||"","")).ok){re(s.actErr);return}pe.current.set(C.id,I?"yes":"no"),L(),ee(I?s.thumbUpDone:s.thumbDnDone)})()},Be=C=>{!V||!Ea(C)||(lt(U,"detailed_request",C.name||"",""),ee(s.memoDeepSent(C.name)))},ye=C=>{const I=new Set(p.favIds),$=I.has(C.id);$?I.delete(C.id):I.add(C.id),p.setFavIds(I),V&&No(U,{id:C.id,co:C.name},$)},Ne=()=>{!V||O||window.confirm(s.identSyncConfirm)&&(T(!0),(async()=>{const C=await So(U);T(!1),C?ee(s.identSyncDone):re(s.actErr)})())},$e=/proplace/i.test(p.fund||""),gr=C=>{!V||!$e||(lt(U,"onboard_request",C.name||"",""),ee(s.onboardSent(C.name)))},br={st:m,dispatch:c,t:s,lang:l,mode:le,caps:K,pipe:B,token:U,fund:p.fund,email:p.email,criteria:p.criteria,source:a||"default",data:p,doRepeche:P,thumbOf:ue,canWrite:V,commitStatus:qe,saveNote:_e,stageOf:Me,setStage:it,flashErr:re,startTour:()=>N(!0),dossiers:p.dossiers,scopedAll:de,scoped:X,counts:he,byId:ve,contName:ae,favIds:p.favIds,toggleFav:ye,askEvaluate:Q,doAnalyse:Ie,doDecide:Vt,doPromote:Ht,doApproach:ne,doThumb:ge,doDeep:Be,doUndo:J,doSync:Ne,doOnboard:gr,outbound:$e,memoQueued:_.current,approachDone:G.current,sessTally:f,evalCards:D.current,evalBusy:k,markRow:x,markedId:g,flash:ee};h.useEffect(()=>{const C=I=>{I.key==="Escape"&&(c({type:"popup",id:null}),c({type:"modal",modal:null}),c({type:"openFacet",facet:null}))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[]);const vr=C=>U?t.jsx(ul,{token:U,children:C}):t.jsx(t.Fragment,{children:C});return t.jsx(mr.Provider,{value:br,children:t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Oo}),vr(t.jsxs("div",{className:"app"+(B?" pipe":"")+(U?" has-thesis":""),children:[K.showTicker&&t.jsx(me,{name:"live",children:t.jsxs("div",{className:"live-stack"+(U?" live-stack--cibles":""),children:[t.jsx(Ko,{}),!!U&&t.jsx(fl,{})]})}),K.showIdent&&t.jsx(me,{name:"identite",children:t.jsx(ui,{})}),K.showOnb&&t.jsx(me,{name:"onboarding",children:t.jsx(fi,{})}),K.showMorning&&t.jsx(me,{name:"matin",children:t.jsx(pi,{})}),t.jsx(me,{name:"fraicheur",children:t.jsx(ni,{})}),t.jsx(me,{name:"mesure",children:t.jsx(ri,{})}),K.showFunnel&&t.jsx(me,{name:"entonnoir",children:t.jsx(bl,{})}),K.showFunnel&&t.jsx(me,{name:"tunnel",children:t.jsx(xi,{})}),K.showFunnel&&t.jsx(me,{name:"tuto",children:t.jsx(gi,{})}),t.jsx(me,{name:"carte",fallback:t.jsx("div",{className:"void",children:s.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(vl,{}),t.jsxs("div",{className:"stage"+(m.mapFolded?" folded":""),id:"atl2-stage",children:[t.jsx(ps,{}),t.jsx(fs,{})]})]})}),K.showDemand&&t.jsx(me,{name:"evaluation",children:t.jsx(vs,{})}),K.showDemand&&m.memoConsole&&t.jsx(me,{name:"console",children:t.jsx(ws,{})}),t.jsx(me,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:s.retry})]}),children:t.jsx(Ds,{})}),!!U&&t.jsx(me,{name:"edition",children:t.jsx(ml,{})}),p.loading&&t.jsx("div",{className:"void",children:s.loadingV2}),p.error&&!p.loading&&t.jsxs("div",{className:"void",children:[s.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:p.refresh,children:s.retry})]})]})),K.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:s.lockbarText}),t.jsx("button",{type:"button",onClick:()=>c({type:"modal",modal:"rdv"}),children:s.lockbarCta})]}),m.popupId&&t.jsx(me,{name:"fiche",children:t.jsx(Ns,{})}),t.jsx(me,{name:"modales",children:t.jsx(Ys,{})}),t.jsx(ei,{}),E&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:E.o.name}),t.jsx(li,{placeholder:E.yes?s.whyYesPh:s.whyNoPh,onDone:C=>{const I=E.o;j(null),C&&_e(I,C).then($=>{$&&ee(s.csNoteSaved)})}})]}),R&&t.jsx(ci,{steps:gl(s),onClose:()=>{N(!1),Tn(U)}}),z&&t.jsx("div",{className:"flash on"+(q?" err":""),children:z}),b&&t.jsx(vo,{variant:"acquirer",initialCompany:Ln().co,initialWebsite:Ln().site,onClose:()=>v(null)})]})})}function bl(){const{t:e}=M(),[a,r]=h.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function vl(){const{dossiers:e,st:a,dispatch:r,pipe:n,lang:i,t:o}=M(),l=h.useMemo(()=>{const s={};return e.forEach(p=>{za(p,a.filters,n)&&(s.monde=(s.monde||0)+1,p.continent&&(s[p.continent]=(s[p.continent]||0)+1))}),s},[e,a.filters,n]);return t.jsxs("div",{className:"conts",children:[Co.map(s=>{const p=Ca.find(c=>c.key===s),m=s==="monde"?o.contWorld:i==="fr"?p.fr:p.en;return t.jsxs("button",{type:"button",className:"cbtn"+(s==="monde"?" hint":""),"aria-selected":a.continent===s,onClick:()=>r({type:"continent",key:s}),children:[m,t.jsx("span",{className:"n",children:l[s]||0})]},s)}),t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>r({type:"mapFold",folded:!a.mapFolded}),children:a.mapFolded?o.showMap:o.hideMap})})]})}function Ln(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function yl(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{xr as FlagCell,ot as SigBadge,Ut as SigWin,jl as default,yl as fmtShort,M as useV2};
