...
.atl2.cibles .row.sel,.atl2.cibles .row.sel.on{background:#EAF6EF;
  box-shadow:inset 3px 0 0 var(--brand,#0E8A4F);
  outline:2px solid var(--brand,#0E8A4F);outline-offset:-2px}
.atl2.ops .row.sel .rnm,.atl2.cibles .row.sel .rnm{font-weight:700}
.atl2.ops .row.sel .cell .rev,.atl2.cibles .row.sel .cell .rev{box-shadow:0 0 0 2px var(--brand,#0E8A4F)}
...
.atl2.cibles .readpane{position:sticky;z-index:22;
  top:calc(var(--pp-gap,60px) + 48px);
  max-height:calc(100dvh - var(--pp-gap,60px) - 64px);
...
.atl2.cibles:has(> .lockbar.on) .readpane{top:calc(var(--pp-gap,60px) + 44px + 48px);
  max-height:calc(100dvh - var(--pp-gap,60px) - 108px)}
...
`,Li=Ti+qi;function za(e){if(typeof window>"u")return"";try{return new URLSearchParams(window.location.search).get(e)||""}catch{return""}}function Mi(){const e=za("teaser");if(e==="0"||e==="1")return e;try{if(typeof window<"u"&&window.parent&&window.parent!==window){const a=new URL(window.parent.location.href).searchParams.get("teaser");if(a==="0"||a==="1")return a;if(/\/cibles\/[^/]+\/open\/?$/i.test(window.parent.location.pathname||""))return"0"}}catch{}return""}function Ri(e,a){if(e||a.mode!=="client"||!a.token)return"visiteur";const r=Mi();return r==="0"?"client":r==="1"||za("embed")==="1"&&za("chrome")==="1"?"apercu":"client"}const Oi={visiteur:{pipe:!1,showIdent:!1,showOnb:!1,showFunnel:!1,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!0,showGroupBar:!0,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0},apercu:{pipe:!0,showIdent:!0,showOnb:!0,showFunnel:!0,showDemand:!0,showThumbs:!1,showCredits:!1,showChain:!1,showGroupBar:!1,lockRowsAfter:10,lockActions:!0,showTicker:!0,showMorning:!0},client:{pipe:!0,showIdent:!0,showOnb:!1,showFunnel:!0,showDemand:!0,showThumbs:!0,showCredits:!0,showChain:!0,showGroupBar:!1,lockRowsAfter:null,lockActions:!1,showTicker:!0,showMorning:!0}},Fi=e=>Oi[e];function la(e){const a=(e||"").trim();return a.length<3?!1:!!(/^[^\p{L}(]/u.test(a)||/[:—]\s|…|\.{3}/.test(a)||a.split(/\s+/).length>=3&&/\b(icymi|round-?up|wrap|weekly|podcast|interview|what|why|how|biggest|watch|inside|according)\b/i.test(a))}const ot=e=>{if(e.noCo===void 0){const a=(e.name||"").trim();(!ka(a)||la(a))&&(e.noCo=!0)}return Object.assign(e,{continent:jo(e.cc)})};function ma(e){const a=new Set,r=[];for(const n of e){const i=(n.name||"").toLowerCase();!i||a.has(i)||(a.add(i),r.push(n))}return r}const Pi=60*60*1e3;function Di(e){try{const a=JSON.parse(sessionStorage.getItem("ppmap:swr:"+e)||"null");return!a||!Array.isArray(a.objs)||Date.now()-(a.ts||0)>Pi?null:a}catch{return null}}function $t(e,a){try{sessionStorage.setItem("ppmap:swr:"+e,JSON.stringify({...a,ts:Date.now()}))}catch{}}const Ii=e=>e==="default"?"":e==="ops"?"ops":"research:"+e.research;function $i(e,a,r="default"){const n=r!=="default",i=m.useMemo(()=>e||n?{mode:"anon"}:mo(),[e,n]),o=m.useMemo(()=>n?"visiteur":Ri(e,i),[e,i,n]),l=m.useMemo(()=>Fi(o),[o]),c=o!=="visiteur",d=Ii(r),[f,s]=m.useState([]),[x,p]=m.useState(""),[g,u]=m.useState(null),[b,v]=m.useState(null),[h,j]=m.useState(null),[E,y]=m.useState(()=>new Map),[A,T]=m.useState(()=>new Map),[z,S]=m.useState(""),[C,N]=m.useState(new Set),[R,$]=m.useState(null),[L,M]=m.useState(!0),[w,O]=m.useState(!1),[H,V]=m.useState(0),[U,re]=m.useState(0),ee=m.useRef(0),X=m.useMemo(()=>{var I;if(o!=="client")return"";try{return((I=fo())==null?void 0:I.email)||""}catch{return""}},[o]);m.useEffect(()=>{const I=++ee.current;let ae=!0;const pe=()=>ae&&I===ee.current,xe=(c&&i.token?i.token:"pub:"+a)+(d?":"+d:""),ge=Di(xe);return ge?(s(ge.objs.map(ot)),ge.fund&&p(ge.fund),u(ge.marketEstimate??null),v(ge.criteria??null),j(ge.stats??null),S(ge.generatedAt||""),M(!1)):M(!0),(async()=>{try{if(r==="ops"){const ze=await pa(),K=((ze==null?void 0:ze.recent_ops)||[]).map(W=>{const J=Qt(W.company_name||W.title?W:{...W,title:(W.headline_fr||W.headline||"").slice(0,120)},a),Q=String(W.rubrique||"").toLowerCase();return J&&(Q==="nominations"||Q==="recrutements")&&(J.engine=Q),J&&!String(W.company_name||"").trim()&&(J.noCo=!0),J}).filter(W=>!!W).map(W=>(ka((W.name||"").trim())||(W.noCo=!0),W));try{const W=xo(),J=W&&W.doc||await ho(),Q=go(J),te=((W==null?void 0:W.day)||(J==null?void 0:J.date)||"").slice(0,10);if(Q.length&&te){const ye=new Set;for(const de of K){if((de.date||"").slice(0,10)!==te)continue;const we=pn(Q,ye,de.name,"");we>=0&&(ye.add(we),de.decryptHtml=Q[we].html)}for(const de of K){if(de.decryptHtml||(de.date||"").slice(0,10)!==te)continue;const we=pn(Q,ye,"",de.headline||de.tagline||de.name);we>=0&&(ye.add(we),de.decryptHtml=Q[we].html)}Q.forEach((de,we)=>{if(ye.has(we))return;const le=(de.t||"").trim(),ue=le.split(/[:–—]/)[0].trim().slice(0,80)||le.slice(0,40);if(!ue)return;const qe=le+" "+de.html,q=/\b(acquiert|rachat|rachet|fusion|buyout|offre sur)\b/i.test(qe),F=/\b(l[eè]ve|lev[ée]e|raises?|funding|s[eé]rie [a-z]|series [a-z])\b/i.test(qe);K.push({id:`edito:${te}:${we}`,kind:"op",name:ue,cc:null,date:te,engine:"edito",dealKind:q?"ma":F?"levee":"other",headline:le,decryptHtml:de.html,noCo:!ka(ue)||la(ue)})})}}catch{}if(!pe())return;s(K.map(ot)),$t(xe,{objs:K})}else if(typeof r=="object"){const K=(await un()||[]).filter(J=>(J.slug||"")===r.research).map(J=>mn(J,a)).filter(J=>!!J),W=ma(await fn(K,a));if(!pe())return;s(W.map(ot)),$t(xe,{objs:W})}else if(c&&i.token){const ze=bo(i.token),K=pa(),W=vo(i.token),J=yo(i.token),Q=wo(i.token),te=await ze;let ye=te?te.targets:[];pe()&&te&&(p(te.fund||""),u(te.marketEstimate??null),v(te.criteria??null),j(te.stats??null),S(te.generatedAt||""),s(ye.map(ot)),M(!1),O(!1));const[de,we,le,ue]=await Promise.all([K,W,J,Q]),qe=((de==null?void 0:de.recent_ops)||[]).map(F=>Qt(F,a)).filter(F=>!!F);if(ye=[...ye,...qe],!pe())return;s(ye.map(ot));const q=new Set;for(const F of we){const Y=(F.id||F.co||"").toString().trim().toLowerCase();Y&&q.add(Y.startsWith("t:")?Y:"t:"+Y)}N(q),y(le),T(ue),te&&$t(xe,{fund:te.fund,marketEstimate:te.marketEstimate,criteria:te.criteria,stats:te.stats,generatedAt:te.generatedAt,objs:ye})}else{const ze=ko(),K=un(),W=pa(),J=await ze;pe()&&J.length&&(s(ma(J).map(ot)),M(!1),O(!1));const[Q,te]=await Promise.all([K,W]),ye=(Q||[]).map(ue=>mn(ue,a)).filter(ue=>!!ue),de=await fn(ye,a),we=((te==null?void 0:te.recent_ops)||[]).map(ue=>Qt(ue,a)).filter(ue=>!!ue),le=ma([...J,...de,...we]);if(!pe())return;s(le.map(ot)),$t(xe,{objs:le})}pe()&&O(!1)}catch{pe()&&!ge&&O(!0)}finally{pe()&&M(!1)}})(),()=>{ae=!1}},[c,i.token,a,H,d]),m.useEffect(()=>{if(!l.showCredits||!X){$(null);return}let I=!0;return(async()=>{try{const ae=await fetch(`${Va}/inbound/credits`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:X})});if(!ae.ok)return;const pe=await ae.json();I&&pe&&pe.ok!==!1&&$(pe)}catch{}})(),()=>{I=!1}},[l.showCredits,X,U]);const oe=m.useCallback(I=>N(new Set(I)),[]);return{session:i,mode:o,caps:l,fund:x,email:X,marketEstimate:g,generatedAt:z,criteria:b,stats:h,thumbs:E,stages:A,dossiers:f,favIds:C,setFavIds:oe,credits:R,reloadCredits:()=>re(I=>I+1),loading:L,error:w,refresh:()=>V(I=>I+1)}}const ur=()=>({win:"all",day:"",status:"all",signalOnly:!1,signalEngines:[],sector:[],country:[],engine:[],stage:[],angle:[],memoLevel:[],dealKind:[],acquirer:"",search:""}),Bi=(e="europe",a=!1,r)=>({continent:e,ptab:(r==null?void 0:r.ptab)??1,dens:(r==null?void 0:r.dens)??"liste",filters:{...ur(),...Object.fromEntries(Object.entries((r==null?void 0:r.filters)||{}).filter(([,n])=>n!==void 0))},sort:{key:"signal",dir:-1},groupBy:"engine",shown:{},pileMode:!1,openFacet:null,popupId:null,popupAnchor:null,focusId:null,modal:(r==null?void 0:r.modal)??null,chain:{queue:[],idx:0},spaceTab:"retenu",memoConsole:null,memoTab:0,undo:[],mapFolded:a}),_i=new Set(["signal","amount","score","crible","memo"]);function Ui(e,a){switch(a.type){case"continent":return{...e,continent:a.key,filters:{...e.filters,country:[]},shown:{},popupId:null,focusId:null,openFacet:null};case"ptab":return{...e,ptab:a.tab,shown:{},popupId:null,focusId:null};case"dens":return{...e,dens:a.dens,shown:{}};case"filters":return{...e,filters:{...e.filters,...a.patch},shown:{}};case"toggleFacet":{const r=e.filters[a.facet],n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,[a.facet]:n},shown:{}}}case"toggleMemoLevel":{const r=e.filters.memoLevel,n=r.includes(a.value)?r.filter(i=>i!==a.value):[...r,a.value];return{...e,filters:{...e.filters,memoLevel:n},shown:{}}}case"acquirer":return{...e,filters:{...e.filters,acquirer:a.value,day:"",win:"all"},shown:{}};case"clearFacet":return{...e,filters:{...e.filters,[a.facet]:[]},shown:{}};case"reset":return{...e,filters:ur(),shown:{},openFacet:null};case"sort":return{...e,sort:e.sort.key===a.key?{key:a.key,dir:e.sort.dir*-1}:{key:a.key,dir:_i.has(a.key)?-1:1}};case"groupBy":return{...e,groupBy:a.groupBy};case"more":return{...e,shown:{...e.shown,[a.group]:(e.shown[a.group]??a.base??mr)+a.by}};case"pile":return{...e,pileMode:a.on,popupId:null};case"openFacet":return{...e,openFacet:e.openFacet===a.facet?null:a.facet};case"popup":return{...e,popupId:a.id,popupAnchor:a.id?a.anchor??null:null};case"focus":return{...e,focusId:a.id,popupId:a.id?null:e.popupId};case"modal":return{...e,modal:a.modal,popupId:a.modal?null:e.popupId};case"chainStart":return{...e,modal:"chain",chain:{queue:a.queue,idx:0},popupId:null};case"chainNext":return{...e,chain:{...e.chain,idx:e.chain.idx+1}};case"spaceTab":return{...e,spaceTab:a.tab};case"memoConsole":return{...e,memoConsole:a.id,memoTab:0};case"memoTab":return{...e,memoTab:a.tab};case"undoPush":return{...e,undo:[...e.undo,a.entry].slice(-50)};case"undoPop":return{...e,undo:e.undo.slice(0,-1)};case"mapFold":return{...e,mapFolded:a.folded,openFacet:null};default:return e}}const mr=40;function Ka(e,a,r,n){var i;if(n!=="signal"&&a.signalOnly&&(!Ae(e)||a.signalEngines.length&&!a.signalEngines.includes(e.engine||""))||n!=="dealKind"&&((i=a.dealKind)!=null&&i.length)&&!a.dealKind.includes(e.dealKind||"")||n!=="sector"&&a.sector.length&&!a.sector.includes(e.sector||"")||n!=="acquirer"&&a.acquirer.trim()&&(e.acquirer||"").trim().toLowerCase()!==a.acquirer.trim().toLowerCase()||n!=="engine"&&a.engine.length&&!a.engine.includes(e.engine||"")||n!=="stage"&&a.stage.length&&!a.stage.includes(e.stage||"")||n!=="angle"&&r&&a.angle.length&&!a.angle.includes(e.angle||"")||n!=="memoLevel"&&r&&a.memoLevel.length&&!a.memoLevel.includes(Ha(e)))return!1;if(n!=="win"){if(a.day){if((e.date||"").slice(0,10)!==a.day)return!1}else if(a.win!=="all"){const o=a.win==="1"?0:a.win==="7"?7:30;if(tt(e.date)>o)return!1}}if(n!=="status"&&!r&&a.status!=="all"&&st(e)!==a.status)return!1;if(n!=="search"&&a.search.trim()){const o=a.search.trim().toLowerCase();if(!`${e.name||""} ${e.tagline||""} ${e.sector||""} ${e.acquirer||""}`.toLowerCase().includes(o))return!1}return!0}function fr(e,a,r){return a.continent!=="monde"&&e.continent!==a.continent||a.filters.country.length&&!a.filters.country.includes(e.cc||"")?!1:Ka(e,a.filters,r)}function Vi(e,a,r,n){return!(!fr(e,a,r)||r&&!No(e,a.ptab,n))}function Qa(e,a){const r=a.key,n=i=>{switch(r){case"name":return(i.name||"").toLowerCase();case"country":return i.countryLabel||i.cc||"";case"stage":return i.stage||"";case"amount":return i.amountEur||-1;case"age":return-tt(i.date);case"score":return typeof i.score=="number"?i.score:-1;case"crible":return Eo(i);case"memo":return So(i);case"signal":{const o=Ae(i);return o?100-(o.left??0):-1}}};return[...e].sort((i,o)=>{const l=n(i),c=n(o);return l<c?-a.dir:l>c?a.dir:(i.name||"").localeCompare(o.name||"")})}const fa={},Nn=(fa==null?void 0:fa.VITE_API_BASE)||"https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Sn(){return new Date().toISOString().slice(0,10)}const Ja=m.createContext(null);function xr(){return m.useContext(Ja)}function Hi(e){if(!e||typeof DOMParser>"u")return[];const a=[];try{const r=new DOMParser().parseFromString(e,"text/html");for(const n of[...r.querySelectorAll("p")]){if((n.textContent||"").replace(/\s+/g," ").trim().length<40)continue;const o=n.querySelector("strong,b"),l=((o==null?void 0:o.textContent)||"").replace(/\s+/g," ").trim();if(!l||l.length<2||l.length>60)continue;const c=n.cloneNode(!0);c.querySelectorAll("script,style,iframe").forEach(d=>d.remove()),c.querySelectorAll("*").forEach(d=>{const f=d.tagName==="A"?d.getAttribute("href"):null;[...d.attributes].forEach(s=>d.removeAttribute(s.name)),f&&/^https?:\/\//i.test(f)&&(d.setAttribute("href",f),d.setAttribute("target","_blank"),d.setAttribute("rel","nofollow noopener"))}),a.push({t:l.toLowerCase(),html:c.outerHTML})}}catch{}return a}function En(e,a=!1){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!r)return e;const o=(a?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||"",l=String(Number(r[3]));return a?`${o} ${l}, ${r[1]}`:`${l==="1"?"1ᵉʳ":l} ${o} ${r[1]}`}function hr(){const e=m.useContext(Ja);if(!e)throw new Error("ThesisEdition* must be under ThesisEditionProvider");return e}function Wi({token:e,children:a}){const{dispatch:r,st:n,lang:i}=B(),[o,l]=m.useState(()=>n.filters.day||Sn()),[c,d]=m.useState(null),[f,s]=m.useState(!1),x=m.useCallback(b=>{if(/^\d{4}-\d{2}-\d{2}$/.test(b)){l(b);try{r({type:"filters",patch:{day:b,win:"all"}})}catch{}}},[r]),p=m.useCallback(()=>{l(Sn());try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[r]);m.useEffect(()=>{if(!n.filters.day)try{r({type:"filters",patch:{day:"",win:"7"}})}catch{}},[]),m.useEffect(()=>{const b=v=>{var j;const h=(j=v.detail)==null?void 0:j.day;typeof h=="string"&&x(h)};return window.addEventListener("pp-edition-day",b),()=>window.removeEventListener("pp-edition-day",b)},[x]),m.useEffect(()=>{n.filters.day&&n.filters.day!==o&&l(n.filters.day)},[n.filters.day]),m.useEffect(()=>{if(!e||!o)return;let b=!1;s(!0);const v=new URLSearchParams({token:e,date:o});return fetch(`${Nn}/cibles/edition.json?${v}`).then(h=>h.json()).then(h=>{b||d(h)}).catch(()=>{b||d({ok:!1,error:"network"})}).finally(()=>{b||s(!1)}),()=>{b=!0}},[e,o]);const g=m.useMemo(()=>`${Nn}/cibles/editions.json?token=${encodeURIComponent(e)}`,[e]),u=m.useMemo(()=>({token:e,day:o,ed:c,loading:f,pickDay:x,pickWindow:p,dayPicked:!!n.filters.day,daysUrl:g,isEn:i==="en"}),[e,o,c,f,x,p,n.filters.day,g,i]);return t.jsx(Ja.Provider,{value:u,children:a})}function Yi(){const{day:e,daysUrl:a,pickDay:r,dayPicked:n}=hr(),[i,o]=m.useState(n);return m.useEffect(()=>{n&&o(!0)},[n]),t.jsxs("div",{className:"thesis-days",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("button",{type:"button",className:"tdtog","aria-expanded":i,onClick:()=>o(l=>!l),children:[t.jsx("i",{children:i?"▾":"▸"}),i?"Masquer les dates":"Voir les autres jours"]}),i&&t.jsx(Co,{mode:"local",theme:"dark",month:e.slice(0,7),current:e,windowDays:n?0:7,daysUrl:a,onPick:r})]})}function Gi(){const{day:e,ed:a,loading:r,pickWindow:n,dayPicked:i,isEn:o}=hr(),l=!!(a!=null&&a.ok&&(a.html||a.acquirers_html)),c=(a==null?void 0:a.ok)&&!l,d=a&&!a.ok;return t.jsxs("section",{className:"thesis-brief","data-day":(a==null?void 0:a.date)||e,"data-fund":(a==null?void 0:a.fund)||"",children:[t.jsx("style",{children:`
      ...
      `}),t.jsxs("header",{className:"thesis-brief__hd",children:[t.jsx("span",{className:"thesis-brief__kicker",children:o?"Daily brief":"Brief du jour"}),t.jsxs("h2",{className:"thesis-brief__title",children:[o?"Operations relevant to your thesis":"Opérations pertinentes pour votre thèse",(a==null?void 0:a.count)!=null&&a.count>0?` · ${a.count}`:""]}),((a==null?void 0:a.date)||e)&&t.jsx("time",{className:"thesis-brief__date",dateTime:(a==null?void 0:a.date)||e,children:(a==null?void 0:a.date)||e})]}),t.jsx("p",{className:"thesis-brief__hint",children:o?"Same content as your daily email for this fund. Pick a day above the map to change this brief and the LIVE ticker.":"Même contenu que l’email quotidien de ce fonds. Choisir un jour au-dessus de la carte change ce brief et le LIVE."}),r&&!l&&t.jsx("p",{className:"thesis-brief__loading",children:o?"Loading your thesis brief…":"Chargement de votre brief de thèse…"}),d&&t.jsxs("p",{className:"thesis-brief__err",children:[o?"Could not load this brief.":"Impossible de charger ce brief.",a!=null&&a.error?` (${a.error})`:""]}),c&&!r&&t.jsx("p",{className:"thesis-brief__empty",children:o?t.jsxs(t.Fragment,{children:["Edition of ",t.jsx("b",{children:En(e,!0)}),"."]}):t.jsxs(t.Fragment,{children:["Édition du ",t.jsx("b",{children:En(e)}),"."]})}),l&&(a!=null&&a.html)?t.jsx("div",{className:"thesis-brief__body",dangerouslySetInnerHTML:{__html:a.html}}):null,l&&(a!=null&&a.acquirers_html)?t.jsx("div",{className:"thesis-brief__acq",dangerouslySetInnerHTML:{__html:a.acquirers_html}}):null,i&&t.jsx("button",{type:"button",className:"thesis-brief__clear",onClick:n,children:o?"← Back to the last 7 days":"← Revenir aux 7 derniers jours"})]})}const Ki=300,Bt=7,Qi={fr:{ma:"M&A",levees:"Levées de fonds",nominations:"Nominations",recrutements:"Offres d'emploi",actualites:"Presse"},en:{ma:"M&A",levees:"Fundraising",nominations:"Appointments",recrutements:"Job offers",actualites:"Press"}},gr={fr:{hiring:"💼 Recrute",raised:"💰 Lève des fonds",news:"📰 Presse",posting:"📣 Publie",building:"💻 Construit",community:"💬 Communauté",registry:"🆕 Nouveau",exodus:"👋 Départs",other:"🔔 Signal"},en:{hiring:"💼 Hiring",raised:"💰 Raising",news:"📰 Press",posting:"📣 Posting",building:"💻 Building",community:"💬 Community",registry:"🆕 New",exodus:"👋 Exodus",other:"🔔 Signal"}},Ji=["hiring","raised","news","posting","building","community","registry","exodus","other"];function xa(e){const a=(e.rubrique||"").toLowerCase();if(a==="ma"||a==="levees"||a==="nominations"||a==="recrutements")return a;if(e.dealKind==="ma")return"ma";if(e.dealKind==="levee")return"levees";const r=Ae(e);return r?"sig:"+(r.theme&&gr.fr[r.theme]?r.theme:"other"):"actualites"}function Xi(){const{dossiers:e,st:a,t:r,dispatch:n,contName:i,pipe:o,lang:l,fund:c}=B(),d=xr(),f=l==="en",[s,x]=m.useState("all"),[p,g]=m.useState(!1),u=m.useMemo(()=>{var oe;const L=(a.filters.day||"").slice(0,10),M=I=>!(!o&&a.continent!=="monde"&&I.continent!==a.continent||L&&(I.date||"").slice(0,10)!==L),w=e.filter(I=>M(I)&&Ae(I)&&(!o||I.kind!=="target"||Ce(I)!==5)),O=o&&(((oe=d==null?void 0:d.ed)==null?void 0:oe.ops)||[]).length?d.ed.ops.map(I=>Qt(I,l)).filter(I=>!!I).filter(I=>!L||(I.date||"").slice(0,10)===L):[],H=e.filter(I=>M(I)&&I.kind==="op"&&(L?!0:tt(I.date)<=Bt)),V=o?O.length?O:H.filter(I=>{const ae=(c||"").trim().toLowerCase();if(!ae)return!1;const pe=I.match||null;return pe?Object.keys(pe).map(xe=>xe.trim().toLowerCase()).includes(ae):!1}):H,U=L||new Date().toISOString().slice(0,10),re=I=>{const ae=xa(I);return ae==="ma"?0:ae==="levees"?1:2};V.sort((I,ae)=>{const pe=re(I)-re(ae);if(pe)return pe;const xe=(I.date||"").slice(0,10)===U?0:1,ge=(ae.date||"").slice(0,10)===U?0:1;return xe!==ge?xe-ge:(ae.amountEur||0)-(I.amountEur||0)});const ee=new Set,X=[];for(const I of[...V,...Qa(w,{key:"signal",dir:-1})]){const ae=I.id||I.name;!ae||ee.has(ae)||(ee.add(ae),X.push(I))}return o&&X.length===0?e.filter(ae=>M(ae)&&tt(ae.date)<=Bt).sort((ae,pe)=>(pe.date||"").localeCompare(ae.date||"")).slice(0,80):X},[e,a.continent,a.filters.day,o,c,l,d]),b=m.useMemo(()=>{const L={};for(const M of u){const w=xa(M);L[w]=(L[w]||0)+1}return L},[u]),v=m.useMemo(()=>s==="all"?u:u.filter(L=>xa(L)===s),[u,s]),h=m.useMemo(()=>v.slice(0,Ki),[v]),j=v.length-h.length,E=m.useRef(null);m.useEffect(()=>{var V,U;const L=E.current;if(!L)return;const M=()=>{const re=L.scrollWidth;re<200||(L.style.animationDuration=Math.max(18,Math.round(re/130))+"s")};M();const w=requestAnimationFrame(M),O=window.setTimeout(M,1200);let H=!0;return(U=(V=document.fonts)==null?void 0:V.ready)==null||U.then(()=>{H&&M()}),()=>{H=!1,cancelAnimationFrame(w),window.clearTimeout(O)}},[h.length,s]);const y=L=>L==="all"?u.length:b[L]||0,A=L=>L==="all"?f?"All":"Tout":L.startsWith("sig:")?gr[f?"en":"fr"][L.slice(4)]||"🔔":Qi[f?"en":"fr"][L],T=[{k:"all"}],z=["ma","levees"].filter(L=>y(L)>0||L===s);if(z.length){T.push({g:f?"Recent deals":"Opérations récentes"});for(const L of z)T.push({k:L})}const S=["nominations","recrutements","actualites"].filter(L=>y(L)>0||L===s),C=Ji.map(L=>"sig:"+L).filter(L=>y(L)>0||L===s);if(S.length||C.length){T.push({g:f?"News (incl. wire)":"Actualités (dont fil)"});for(const L of S)T.push({k:L});for(const L of C)T.push({k:L})}const N=L=>{try{return new Date(L+"T12:00:00Z").toLocaleDateString(f?"en-GB":"fr-FR",{day:"numeric",month:"long"})}catch{return L}},R=(()=>{const L=(a.filters.day||"").slice(0,10),M=!o&&a.continent!=="monde"&&i?f?` Scope: ${i}.`:` Périmètre : ${i}.`:"";return L?(f?`LIVE covers the events of ${N(L)}.`:`Le LIVE regroupe les événements du ${N(L)}.`)+M:(f?`LIVE covers the still-open signals and the deals of the last ${Bt} days.`:`Le LIVE regroupe les signaux encore ouverts et les opérations des ${Bt} derniers jours.`)+M})(),$=L=>h.map(M=>t.jsxs("button",{type:"button",className:"tk"+(Re(M)?" spent":""),onClick:w=>{if(n({type:"focus",id:M.id}),a.dens!=="liste"){const O=w.currentTarget.getBoundingClientRect();n({type:"popup",id:M.id,anchor:{x:O.left+O.width/2,y:O.bottom}})}},title:M.name+(M.tagline?" — "+M.tagline:""),children:[t.jsx(pt,{o:M}),t.jsxs("span",{className:"who",children:[t.jsx(Gr,{o:M}),t.jsx("span",{className:"co",children:M.name})]}),typeof M.amountEur=="number"&&M.amountEur>0&&t.jsx("span",{className:"am",children:Sc(M.amountEur)}),M.sector&&t.jsx("span",{className:"mt",children:M.sector}),t.jsx(ca,{o:M}),t.jsx("span",{className:"tkgo",children:"→"})]},L+(M.id||M.name))).concat(j>0?[t.jsx("span",{className:"tk quiet",children:f?`+ ${j} more — filter by section to see them`:`+ ${j} autres — filtrez par rubrique pour les voir`},L+":more")]:[]);return t.jsxs("div",{className:"ticker",children:[t.jsxs("span",{className:"lbl",children:[t.jsx("i",{}),r.live]}),t.jsxs("span",{className:"tkfil",onBlur:L=>{L.currentTarget.contains(L.relatedTarget)||g(!1)},children:[t.jsxs("button",{type:"button",className:"tkfilb","aria-expanded":p,onClick:()=>g(L=>!L),children:[A(s),t.jsx("b",{children:y(s)}),t.jsx("span",{"aria-hidden":"true",children:"▾"})]}),t.jsxs("div",{className:"tkfilm",hidden:!p,children:[t.jsx("span",{className:"tkfilscope",children:R}),T.map(L=>"g"in L?t.jsx("span",{className:"tkfilg",children:L.g},L.g):t.jsxs("button",{type:"button","aria-pressed":L.k===s,onClick:()=>{x(L.k),g(!1)},children:[A(L.k),t.jsx("b",{children:y(L.k)})]},L.k))]})]}),t.jsx("div",{className:"win",children:h.length?t.jsxs("div",{className:"run",ref:E,children:[$(0),$(1)]}):t.jsx("div",{className:"run",style:{animation:"none"},children:t.jsx("span",{className:"tk quiet",children:r.liveQuiet(i)})})}),!!d&&t.jsx(es,{isEn:f})]})}const Zi=t.jsxs("svg",{viewBox:"0 0 16 16",width:"15",height:"15",fill:"none",stroke:"currentColor",strokeWidth:"1.4","aria-hidden":"true",children:[t.jsx("rect",{x:"2",y:"3.5",width:"12",height:"10.5",rx:"1.5"}),t.jsx("path",{d:"M2 6.5h12M5.5 2v3M10.5 2v3"})]});function es({isEn:e}){const[a,r]=m.useState(()=>zo());m.useEffect(()=>{const i=o=>{var l;return r(!!((l=o.detail)!=null&&l.open))};return window.addEventListener(xn,i),()=>window.removeEventListener(xn,i)},[]);const n=a?e?"Hide the days":"Masquer les jours":e?"Show the days":"Voir les jours";return t.jsx("button",{type:"button",className:"dytog","aria-pressed":a,title:n,"aria-label":n,onClick:()=>Ao(!a),children:Zi})}const Xa="+33 6 83 10 72 86",Zt="alexandre@proplace.co",br=`tel:${Xa.replace(/[^\d+]/g,"")}`;function ts(){return null}class Le extends m.Component{constructor(){super(...arguments);cn(this,"state",{dead:!1})}static getDerivedStateFromError(){return{dead:!0}}componentDidCatch(r,n){console.error(`[atl2] bandeau « ${this.props.name} » en échec :`,r,n.componentStack)}render(){return this.state.dead?this.props.fallback??null:this.props.children}}const ha=600,it=62,Cn="atl2:fstats";function as(){const{t:e,lang:a,data:r,caps:n,st:i,dispatch:o}=B(),[l,c]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem(Cn)==="on"}catch{return!1}}),d=r.stats,f=m.useMemo(()=>((d==null?void 0:d.by_day)||[]).slice(-30),[d]),s=(d==null?void 0:d.since)||"";if(!n.showFunnel||!d||typeof d.screened!="number")return null;const x=A=>a==="en"?A.slice(5,10):`${A.slice(8,10)}/${A.slice(5,7)}`,p=A=>A.toLocaleString(a==="en"?"en-US":"fr-FR"),g=f.reduce((A,T)=>Math.max(A,T.s||0),0),u=f.length?ha/f.length:0,b=Math.max(4,u-4),v=f.length>=5&&g>0,h=r.marketEstimate||0,j=x(new Date().toISOString().slice(0,10)),E=A=>[...typeof A=="number"?[[A,e.funScreened("","")]]:[],...typeof d.kept=="number"?[[d.kept,e.funKept]]:[],...typeof d.analyzed=="number"?[[d.analyzed,e.funAnalyzed]]:[],...typeof d.shown=="number"?[[d.shown,e.funShown]]:[]],y=[];return typeof d.screened_window=="number"&&s&&y.push({cle:"fenetre",periode:e.funPerWindow(x(s),j),etapes:[[d.screened_window,e.funScreened("","")]]}),typeof d.screened=="number"&&y.push({cle:"total",periode:e.funPerAll,etapes:E(d.screened)}),t.jsxs("div",{className:"fstats"+(l?" on":""),children:[y.map(A=>t.jsxs("div",{className:"fst-row fst-lab",title:e.funScope,children:[t.jsx("span",{className:"fst-per",children:A.periode}),A.etapes.map(([T,z],S)=>t.jsxs("span",{className:"fst-t",children:[S>0&&t.jsx("span",{className:"fst-ar",children:"→"}),t.jsx("b",{children:p(T)}),t.jsx("i",{children:z})]},A.cle+z)),A.cle==="total"&&h>0&&t.jsxs("span",{className:"fst-t fst-mkt",children:[t.jsx("span",{className:"fst-ar",children:"·"}),t.jsx("i",{children:e.funOfMarket(p(h),Math.min(100,Math.round((d.screened||0)/h*100)))})]}),A.cle===y[y.length-1].cle&&v&&t.jsx("button",{type:"button",className:"fst-x","aria-expanded":l,title:l?e.fstatsHide:e.fstatsShow,onClick:()=>{const T=!l;c(T),T&&!i.mapFolded&&o({type:"mapFold",folded:!0});try{localStorage.setItem(Cn,T?"on":"off")}catch{}},children:l?"⌃":"⌄"})]},A.cle)),l&&v&&t.jsxs("div",{className:"fst-act",children:[t.jsxs("div",{className:"fst-ah",children:[t.jsx("span",{children:e.actTitle}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#185c38"}}),e.actKept]}),t.jsxs("span",{className:"fst-lg",children:[t.jsx("i",{style:{background:"#cfe0d6"}}),e.actScreened]})]}),t.jsxs("svg",{viewBox:`0 0 ${ha} ${it}`,preserveAspectRatio:"none",role:"img","aria-label":e.actTitle,children:[f.map((A,T)=>{const z=(A.s||0)/g*(it-4),S=(A.m||0)/g*(it-4),C=T*u+(u-b)/2;return t.jsxs("g",{children:[t.jsx("title",{children:`${x(A.d)} — ${A.s} ${e.actScreened} · ${A.m} ${e.actKept}`}),t.jsx("rect",{x:C,y:it-2-z,width:b,height:z,fill:"#cfe0d6"}),t.jsx("rect",{x:C,y:it-2-S,width:b,height:S,fill:"#185c38"})]},A.d)}),t.jsx("line",{x1:0,y1:it-1.5,x2:ha,y2:it-1.5,stroke:"#dbe5df",strokeWidth:1})]}),t.jsxs("div",{className:"fst-ax",children:[t.jsx("span",{children:x(f[0].d)}),t.jsx("span",{children:e.actToday})]})]})]})}const vr=[["Retenu","csKept"],["Analysé","csAnalysed"],["À trancher","csPending"],["Validé","csValidated"],["Écarté","csOut"]];function ns(e,a){if((at(e)||"").startsWith("CALL")&&Ce(e)===3)return[["Validé",a.csYes],["Écarté",a.csNo]];const n=Ce(e)>=2;return vr.filter(([i])=>!(n&&i==="Retenu")).map(([i,o])=>[i,a[o]])}function rs({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i,doAnalyse:o,memoQueued:l}=B(),[c,d]=m.useState(!1),[f,s]=m.useState(""),[x,p]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const g=(e.ceoStatus||"").trim(),u=async b=>{if(f)return;if(b==="Analysé"&&!e.memoUrl){p(!0);return}s(b);const v=await i(e,b);s(""),v&&(d(!1),p(!1))};return t.jsxs("span",{className:"rstat",onClick:b=>b.stopPropagation(),children:[t.jsxs("button",{type:"button",className:"rstb",title:a.csLabel,onClick:()=>{d(b=>!b),p(!1)},children:[g||a.csNone,t.jsx("i",{children:"▾"})]}),c&&t.jsx("span",{className:"rstm",children:x?t.jsxs("span",{className:"rstask",children:[t.jsx("b",{children:a.csAnaNeedMemo}),t.jsx("button",{type:"button",className:"rsta pri",disabled:l.has(e.id),onClick:()=>{o(e),p(!1),d(!1)},children:l.has(e.id)?a.actMemoQueue:a.csAnaRun}),t.jsx("button",{type:"button",className:"rsta",onClick:()=>{(async()=>{s("Analysé");const b=await i(e,"Analysé");s(""),b&&(d(!1),p(!1))})()},children:a.csAnaAnyway})]}):ns(e,a).map(([b,v])=>t.jsx("button",{type:"button",className:"rsti"+(g===b?" on":"")+(f===b?" busy":""),disabled:!!f,onClick:()=>{u(b)},children:v},b))})]})}function os({o:e}){const{t:a,caps:r,canWrite:n,commitStatus:i}=B(),[o,l]=m.useState(""),[c,d]=m.useState(!1);if(!r.pipe||!n||r.lockActions)return null;const f=(e.ceoStatus||"").trim(),s=(at(e)||"").startsWith("CALL")&&Ce(e)===3,x=Ce(e)>=2,p=async u=>{if(o||u==="Analysé"&&!e.memoUrl&&!window.confirm(a.csAnaConfirm))return;l(u);const b=await i(e,u);l(""),b&&(d(!0),setTimeout(()=>d(!1),2200))},g=s?[["Validé",a.csYes],["Écarté",a.csNo]]:vr.filter(([u])=>!(x&&u==="Retenu")).map(([u,b])=>[u,a[b]]);return t.jsxs("div",{className:"csp",onClick:u=>u.stopPropagation(),children:[t.jsxs("div",{className:"csrow",children:[t.jsx("span",{className:"cslb",children:a.csLabel}),g.map(([u,b])=>t.jsx("button",{type:"button",className:"csb"+(f===u?" on":"")+(o===u?" busy":""),disabled:!!o,onClick:()=>{p(u)},children:b},u)),c&&t.jsx("span",{className:"csok",children:a.csSaved})]}),t.jsx(is,{o:e})]})}function is({o:e}){const{t:a,saveNote:r,flash:n}=B(),[i,o]=m.useState(e.ceoNote||""),[l,c]=m.useState(!1),[d,f]=m.useState(!1),s=i.trim()!==(e.ceoNote||"").trim(),x=async()=>{if(l||!s)return;c(!0);const p=await r(e,i.trim());c(!1),p&&(f(!0),setTimeout(()=>f(!1),2200),n(a.csNoteSaved))};return t.jsxs("div",{className:"csnote",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:a.csNotePh,value:i,disabled:l,onChange:p=>o(p.target.value),onKeyDown:p=>{p.key==="Enter"&&x()}}),t.jsx("button",{type:"button",disabled:l||!s,onClick:()=>{x()},children:d?a.csNoteSaved:a.csNoteOk})]})}function ss({placeholder:e,onDone:a}){const{t:r}=B(),[n,i]=m.useState("");return t.jsxs("div",{className:"csnote why",children:[t.jsx("input",{type:"text",maxLength:200,placeholder:e,value:n,autoFocus:!0,onChange:o=>i(o.target.value),onKeyDown:o=>{o.key==="Enter"&&a(n.trim()),o.key==="Escape"&&a("")},onBlur:()=>{n.trim()||a("")}}),t.jsx("button",{type:"button",onClick:()=>a(n.trim()),children:r.whySend})]})}function ls({o:e}){var v;const{t:a,token:r,caps:n,canWrite:i,stageOf:o,setStage:l,flashErr:c}=B(),[d,f]=m.useState(!1);if(!n.pipe||!i||n.lockActions||Ce(e)!==4)return null;const s=o(e),x=(s==null?void 0:s.stage)||"todo",p=async h=>{if(d||h===x)return;f(!0);const j=s;l(e,{stage:h,stamps:(s==null?void 0:s.stamps)||{}});const E=Math.max(Date.now(),zn+=1);zn=E;const y=await To(r,{company:e.name||"",stage:h,cts:E,deal_id:e.airtableId,check_id:e.checkId});f(!1),!y.stale&&(y.ok||(l(e,j),c(a.actErr)))},g=(v=s==null?void 0:s.stamps)==null?void 0:v.sent,u=g?Math.floor((Date.now()-Date.parse(g))/864e5):0,b=x==="sent"&&g&&u>=4;return t.jsxs("div",{className:"stg",onClick:h=>h.stopPropagation(),children:[t.jsx("span",{className:"stglb",children:a.stgLabel}),a.stg.map(([h,j])=>t.jsx("button",{type:"button",className:"stgb"+(x===h?" on":""),disabled:d,onClick:()=>{p(h)},children:j},h)),b&&t.jsx("span",{className:"stgj4",children:a.j4Badge(u)})]})}let zn=0;const _t=8,Ut=360;function An({text:e}){const a=e.split(/\*\*(.+?)\*\*/g);return t.jsx(t.Fragment,{children:a.map((r,n)=>n%2?t.jsx("b",{children:r},n):t.jsx("span",{children:r},n))})}function Tn({text:e}){const a=(e||"").split(`
`).map(n=>n.trim()).filter(Boolean),r=a.filter(n=>n.startsWith("·"));return t.jsxs(t.Fragment,{children:[a.filter(n=>!n.startsWith("·")).map((n,i)=>t.jsx("p",{children:t.jsx(An,{text:n})},"p"+i)),r.length>0&&t.jsx("ul",{className:"tour-ul",children:r.map((n,i)=>t.jsx("li",{children:t.jsx(An,{text:n.replace(/^·\s*/,"")})},"l"+i))})]})}function cs({steps:e,onClose:a}){const{t:r,dispatch:n,counts:i,st:o}=B(),[l,c]=m.useState(0),[d,f]=m.useState(null),[s,x]=m.useState([]),p=m.useRef(!1),g=m.useRef({ptab:o.ptab,dens:o.dens,modal:o.modal}),u=m.useRef(!1);m.useEffect(()=>{const z=g.current;return()=>{u.current||(n({type:"ptab",tab:z.ptab}),n({type:"dens",dens:z.dens}),n({type:"modal",modal:z.modal}))}},[]),m.useEffect(()=>{p.current||(p.current=!0,x(e.filter(z=>!!document.querySelector(z.need||z.sel))))},[e]);const b=s[l],v=l>=s.length;m.useEffect(()=>{if(b&&(b.ptab!==void 0&&o.ptab!==b.ptab&&n({type:"ptab",tab:b.ptab}),b.dens&&o.dens!==b.dens&&n({type:"dens",dens:b.dens}),o.modal!==(b.modal??null)&&n({type:"modal",modal:b.modal??null}),b.click)){const z=b.click,S=window.setTimeout(()=>{const C=document.querySelector(z);C&&C.getAttribute("aria-selected")!=="true"&&C.click()},60);return()=>window.clearTimeout(S)}},[l,b]);const h=m.useRef(-1),j=m.useCallback(()=>{if(!b){f(null);return}const z=document.querySelector(b.sel)||(b.need?document.querySelector(b.need):null);if(!z){f(null);return}h.current!==l&&(h.current=l,z.scrollIntoView({block:"nearest",behavior:"smooth"}));const S=z.getBoundingClientRect();f(C=>C&&Math.abs(C.top-S.top)<1&&Math.abs(C.left-S.left)<1&&Math.abs(C.width-S.width)<1&&Math.abs(C.height-S.height)<1?C:S)},[b,l]);m.useLayoutEffect(()=>{j();const z=[90,300,700,1300].map(C=>window.setTimeout(j,C)),S=()=>j();return window.addEventListener("scroll",S,!0),window.addEventListener("resize",S),()=>{z.forEach(C=>window.clearTimeout(C)),window.removeEventListener("scroll",S,!0),window.removeEventListener("resize",S)}},[j]);const E=m.useRef(a);if(E.current=a,m.useEffect(()=>{const z=S=>{S.key==="Escape"?(S.preventDefault(),S.stopPropagation(),E.current()):S.key==="ArrowRight"?c(C=>C+1):S.key==="ArrowLeft"&&c(C=>Math.max(0,C-1))};return document.addEventListener("keydown",z,!0),()=>document.removeEventListener("keydown",z,!0)},[]),!s.length)return null;let y=null;const A=z=>()=>{u.current=!0,n({type:"modal",modal:null}),z()};if(v){const z=i[3]||0;z>0?y={title:z===1?r.ahaATitle1:r.ahaATitleN(z),body:r.ahaABody,btn:r.ahaABtn,go:A(()=>{n({type:"ptab",tab:3}),a()})}:(i[1]||0)>0?y={title:r.ahaRetTitle(i[1]||0),body:r.ahaRetBody,btn:r.ahaRetBtn,go:A(()=>{n({type:"ptab",tab:1}),a()})}:(i[0]||0)>0?y={title:r.ahaEvalTitle(i[0]||0),body:r.ahaEvalBody,btn:r.ahaEvalBtn,go:A(()=>{n({type:"ptab",tab:0}),a()})}:y={title:r.ahaCTitle,body:r.ahaCBody,btn:r.ahaCBtn,go:A(()=>{n({type:"modal",modal:"crit"}),a()})}}let T={left:"50%",top:"50%",transform:"translate(-50%,-50%)",width:Ut};if(!v&&d){const z=d.bottom+14,C=window.innerHeight-z>190?z:Math.max(12,d.top-200);T={left:Math.min(Math.max(12,d.left+d.width/2-Ut/2),window.innerWidth-Ut-12),top:C,width:Ut}}return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"tour",role:"dialog","aria-modal":"true",children:[!v&&d&&t.jsx("div",{className:"tour-hole",style:{left:d.left-_t,top:d.top-_t,width:d.width+_t*2,height:d.height+_t*2}}),(v||!d)&&t.jsx("div",{className:"tour-veil"}),t.jsxs("div",{className:"tour-card"+(v?" fin":""),style:T,children:[v&&y?t.jsxs(t.Fragment,{children:[t.jsx("h3",{children:y.title}),t.jsx(Tn,{text:y.body}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",onClick:()=>c(s.length-1),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:y.go,children:y.btn})]})]}):t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"tour-n",children:[r.tourStep(l+1,s.length),t.jsx("span",{className:"tour-bar",children:t.jsx("i",{style:{width:(l+1)/s.length*100+"%"}})})]}),t.jsx("h3",{children:b==null?void 0:b.title}),t.jsx(Tn,{text:(b==null?void 0:b.body)||""}),t.jsxs("div",{className:"tour-nav",children:[t.jsx("button",{type:"button",className:"gh",disabled:l===0,onClick:()=>c(z=>Math.max(0,z-1)),children:r.tourPrev}),t.jsx("button",{type:"button",className:"pri",onClick:()=>c(z=>z+1),children:l===s.length-1?r.tourDone:r.tourNext})]})]}),t.jsx("button",{type:"button",className:"tour-x","aria-label":r.tourClose,title:r.tourClose,onClick:a,children:"×"})]})]})}),document.body)}function yr(e){let a="";for(const r of e){const n=(r.date||"").slice(0,10);n&&n>a&&(a=n)}return a}function wr(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(e||"");return r?a==="en"?`${r[2]}/${r[3]}`:`${r[3]}/${r[2]}`:""}function ds(){var S,C;const{dossiers:e,scopedAll:a,pipe:r,mode:n,t:i,st:o,lang:l,data:c,dispatch:d}=B(),f=r?a:e,s=m.useMemo(()=>f.filter(N=>tt(N.date)===0&&N.kind==="target"),[f]),x=m.useMemo(()=>r?a.filter(N=>N.kind==="target"&&Ce(N)===0).slice().sort((N,R)=>(R.date||"").localeCompare(N.date||"")):[],[a,r]),p=m.useMemo(()=>s.filter(N=>r?Ce(N)===0:!Re(N)),[s,r]),g=r?x:p,u=r?a.length-x.length:s.length-p.length,b=r?a.length:s.length,v=b?Math.min(100,u/b*100):100,h=m.useMemo(()=>yr(f),[f]),j=!!h&&tt(h)>0,E=m.useMemo(()=>j?f.filter(N=>(N.date||"").slice(0,10)===h):[],[f,h,j]),y=typeof((S=c.stats)==null?void 0:S.kept_today)=="number"?c.stats.kept_today:null,A=typeof((C=c.stats)==null?void 0:C.screened_today)=="number"?c.stats.screened_today:s.length;let T;j?T=i.morningLast(E.length,x.length,wr(h,l)):r?T=i.morningThesis(A,x.length,y):s.length?u===0?T=i.goalSourced(s.length):u>=s.length?T=i.goalCleared:T=i.goalDone(u,s.length):T=i.goalSourced(0);const z=()=>{if(!r){d({type:"pile",on:!0});return}d({type:"ptab",tab:0}),n==="client"&&x.length&&d({type:"chainStart",queue:x.map(N=>N.id)})};return t.jsxs("div",{className:"goal",children:[t.jsx("span",{className:"gtxt",title:r?i.morningEnginesTitle:void 0,dangerouslySetInnerHTML:{__html:T}}),t.jsx("div",{className:"pbar",children:t.jsx("i",{style:{width:v+"%"}})}),g.length>0&&t.jsx("button",{type:"button",className:"pilebtn",onClick:z,children:r?i.morningEval(g.length):o.pileMode?i.goalContinue(g.length):i.goalTreat}),t.jsx("span",{className:"gspace"})]})}function ps(){var H,V;const{t:e,lang:a,st:r,dispatch:n,token:i,fund:o,data:l,dossiers:c,mode:d,doSync:f,startTour:s,flash:x,flashErr:p}=B(),[g,u]=m.useState(null),[b,v]=m.useState(!0),[h,j]=m.useState([]),E=d==="client";m.useEffect(()=>{if(!i||!o)return;let U=!0;return v(!0),(async()=>{const[re,ee]=await Promise.all([Wa(o),lr(i)]);U&&(re&&u(re),v(!1),j(ee))})(),()=>{U=!1}},[i,o]);const[y,A]=m.useState(!1),T=()=>{!E||y||!o||(A(!0),qo(o).then(U=>{A(!1),U?x(e.identRepubDone):p(e.actErr)}))},z=(g==null?void 0:g.per_day)??null,S=((H=g==null?void 0:g.pool_order)==null?void 0:H.length)??0,C=h.filter(U=>U.status==="running").length,N=m.useMemo(()=>c.filter(U=>U.kind==="target"&&Re(U)).length,[c]),R=l.marketEstimate,$=typeof((V=l.stats)==null?void 0:V.screened)=="number"?l.stats.screened:N,L=R&&R>0?Math.min(100,Math.round($/R*100)):null,M=U=>U.toLocaleString(a==="en"?"en-US":"fr-FR"),w=(o||"P").split(/\s+/).map(U=>U[0]).join("").slice(0,2).toUpperCase(),O=(()=>{const U=Date.parse(l.generatedAt||"");if(Number.isNaN(U))return"";const re=new Date(U),ee=X=>String(X).padStart(2,"0");return`${ee(re.getDate())}/${ee(re.getMonth()+1)} à ${ee(re.getHours())}:${ee(re.getMinutes())}`})();return t.jsxs("div",{className:"ident",children:[t.jsxs("div",{className:"idtop",children:[t.jsxs("span",{className:"brand",children:[t.jsx("b",{children:o?w:t.jsx("span",{className:"skt sk-ini"})}),t.jsx("i",{children:o||t.jsx("span",{className:"skt sk-nm"})})]}),t.jsx("h1",{children:o?e.identTitle(o):t.jsx("span",{className:"skt sk-h1","aria-label":e.loadingV2})}),t.jsx("span",{className:"idsp"}),O?t.jsx("span",{className:"idupd",children:e.identUpdatedAt(O)}):t.jsx("span",{className:"skt sk-upd"}),t.jsx("button",{type:"button",className:"ic",title:e.identHelp,onClick:()=>n({type:"modal",modal:"tuto"}),children:"?"}),t.jsx("button",{type:"button",className:"ic",title:e.tourPlayTitle,onClick:s,children:"▶"})]}),t.jsxs("div",{className:"idmain",children:[L===null&&$>0&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsx("span",{className:"ev",children:t.jsx("b",{children:M($)})})]}),L!==null&&R&&t.jsxs("span",{className:"cover",title:e.coverTitle,onClick:()=>n({type:"modal",modal:"cover"}),children:[t.jsx("span",{className:"el",children:e.identCoverage}),t.jsxs("span",{className:"ev",children:[t.jsx("span",{className:"bar",children:t.jsx("i",{style:{width:L+"%"}})}),t.jsxs("b",{children:[L," %"]})]}),t.jsx("span",{className:"edv"}),t.jsx("span",{className:"ev",dangerouslySetInnerHTML:{__html:e.identCoverageOf($,R)}})]}),t.jsxs("span",{className:"engine",title:e.queueTitle,onClick:()=>n({type:"modal",modal:"queue"}),children:[t.jsx("span",{className:"el",children:e.identEngine}),z!==null&&t.jsxs(t.Fragment,{children:[t.jsxs("span",{className:"ev",children:[t.jsx("b",{className:"q",children:z})," ",e.identPerDay]}),t.jsx("span",{className:"edv"})]}),z===0&&t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"epause",title:e.identPauseTitle,children:e.identPause}),t.jsx("span",{className:"edv"})]}),C>0&&t.jsxs("span",{className:"ev",children:["⏳ ",C]}),t.jsx("span",{className:"ego",children:b?e.identPendingWait:e.identPending(S)}),t.jsx("button",{type:"button",className:"ebell",title:e.memoAlertBtn,onClick:U=>{U.stopPropagation(),n({type:"modal",modal:"memoalert"})},children:"🔔"})]}),t.jsx("span",{className:"idsp"}),t.jsxs("span",{className:"icgrp",children:[t.jsx("button",{type:"button",className:"ic","data-tour":"export",title:e.identExport,onClick:()=>n({type:"modal",modal:"export"}),children:"📥"}),t.jsx("button",{type:"button",className:"ic","data-tour":"plug",title:e.identPlug,onClick:()=>n({type:"modal",modal:"plug"}),children:"🔌"}),t.jsx("button",{type:"button",className:"ic","data-tour":"alert",title:e.identBell,onClick:()=>n({type:"modal",modal:"alert"}),children:"🔔"}),t.jsx("button",{type:"button",className:"ic",title:e.identRepub,disabled:!E||y,onClick:T,children:y?"⏳":"📰"}),t.jsx("button",{type:"button",className:"ic",title:e.identSync,disabled:!E,onClick:f,children:"🔄"})]}),t.jsxs("span",{className:"isrch",children:["🔍",t.jsx("input",{placeholder:e.identSearch,value:r.filters.search,onChange:U=>n({type:"filters",patch:{search:U.target.value}})})]})]})]})}function us(){const{st:e,dispatch:a,counts:r,t:n,doUndo:i,data:o,dossiers:l}=B(),c=o.loading&&!l.length,d=m.useRef({});m.useEffect(()=>{d.current={...r}},[r]);const f=p=>{const g=d.current[p],u=g!==void 0?r[p]-g:0;return t.jsxs("button",{type:"button",className:"step"+(p===3&&r[3]>0?" wait":""),style:{"--c":`var(${ja[p]})`,"--tc":p<=3?"var(--ink)":"#fff"},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsxs("span",{className:"l",children:[n.plabels[p].toUpperCase(),p===3&&r[3]>0&&t.jsx("i",{className:"wd"})]}),t.jsxs("span",{className:"n"+(u>0?" up":u<0?" down":""),children:[r[p],u!==0&&t.jsxs("em",{className:"delta",children:[u>0?"+":"−",Math.abs(u)]})]})]},p)},s=(p,g,u)=>t.jsxs("button",{type:"button",className:"off"+(g?" view":""),style:{"--c":`var(${ja[p]})`},"aria-selected":e.ptab===p,title:n.phelp[p],onClick:()=>a({type:"ptab",tab:p}),children:[t.jsx("span",{className:"l",children:u.toUpperCase()}),t.jsx("span",{className:"n",children:r[p]})]},p),x=(p,g,u,b=!1)=>t.jsx("button",{type:"button",className:"tool",title:g,disabled:b,onClick:u,children:p},g);return t.jsxs("div",{className:"funnel"+(c?" waiting":""),children:[t.jsx("div",{className:"chain2",children:[0,1,2,3,4].map(f)}),t.jsxs("div",{className:"offtrack",children:[s(5,!1,n.plabels[5]),s(7,!0,n.plabels[7]),s(6,!0,"★ "+n.plabels[6])]}),t.jsxs("span",{className:"ftools",children:[x("↩",n.toolUndo,i,e.undo.length===0),x("↺",n.toolReset,()=>{a({type:"reset"})}),x("⇅",n.toolSort,()=>a({type:"sort",key:e.sort.key})),x("▶",n.toolTuto,()=>a({type:"modal",modal:"tuto"})),x("⚙",n.toolCrit,()=>a({type:"modal",modal:"crit"}))]})]})}function ms(){const{st:e,dispatch:a,t:r,scoped:n,memoQueued:i,doAnalyse:o,mode:l}=B(),c=m.useRef(null),[d,f]=m.useState(60);m.useEffect(()=>{let u=0;const b=()=>{var y;const v=c.current;if(!v)return;const h=(y=v.parentElement)==null?void 0:y.querySelector('.funnel [aria-selected="true"]');if(!h)return;const j=h.getBoundingClientRect(),E=v.getBoundingClientRect();f(Math.max(20,Math.min(j.left+j.width/2-E.left,E.width-30)))};return u=requestAnimationFrame(b),window.addEventListener("resize",b),()=>{cancelAnimationFrame(u),window.removeEventListener("resize",b)}},[e.ptab]);const s=e.ptab;let x=r.tuto[s].p;if(s===3){const u=n.filter(h=>h.kind==="target"&&Ce(h)===3),b=u.filter(h=>Na(h)==="auto").length,v=u.filter(h=>Na(h)==="cd").length;x=r.tutoPending(b,v,u.length)}const p=(()=>{if(l!=="client")return null;if(s===0&&n.length)return{label:r.tuto[0].a,run:()=>a({type:"chainStart",queue:n.map(u=>u.id)})};if(s===1){const u=n.filter(b=>b.kind==="target"&&Ce(b)===1&&!i.has(b.id)).slice(0,10);if(u.length)return{label:r.tuto[1].a,run:()=>a({type:"chainStart",queue:u.map(b=>b.id)})}}return null})(),g=Lo(s);return t.jsxs("div",{ref:c,className:"tuto mini"+(g?"":" on-dark"),style:{"--bg":`var(${ja[s]})`,"--ax":d+"px","--stc":g?"var(--ink)":"#fff","--stt":g?"#fff":"var(--ink)","--tc":g?"var(--ink)":"#fff"},children:[t.jsx("span",{className:"txt",children:t.jsxs("p",{children:[t.jsx("b",{className:"tstep",children:r.plabels[s].toUpperCase()}),t.jsx("span",{dangerouslySetInnerHTML:{__html:x}})]})}),p&&t.jsx("button",{type:"button",className:"tprim",onClick:p.run,children:p.label})]})}class ct{constructor(){this._partials=new Float64Array(32),this._n=0}add(a){const r=this._partials;let n=0;for(let i=0;i<this._n&&i<32;i++){const o=r[i],l=a+o,c=Math.abs(a)<Math.abs(o)?a-(l-o):o-(l-a);c&&(r[n++]=c),a=l}return r[n]=a,this._n=n+1,this}valueOf(){const a=this._partials;let r=this._n,n,i,o,l=0;if(r>0){for(l=a[--r];r>0&&(n=l,i=a[--r],l=n+i,o=i-(l-n),!o););r>0&&(o<0&&a[r-1]<0||o>0&&a[r-1]>0)&&(i=o*2,n=l+i,i==n-l&&(l=n))}return l}}function*fs(e){for(const a of e)yield*a}function kr(e){return Array.from(fs(e))}var fe=1e-6,ie=Math.PI,Ue=ie/2,qn=ie/4,We=ie*2,Ze=180/ie,Ie=ie/180,ve=Math.abs,xs=Math.atan,qt=Math.atan2,Se=Math.cos,Ee=Math.sin,hs=Math.sign||function(e){return e>0?1:e<0?-1:0},ut=Math.sqrt;function gs(e){return e>1?0:e<-1?ie:Math.acos(e)}function Lt(e){return e>1?Ue:e<-1?-Ue:Math.asin(e)}function Ve(){}function ea(e,a){e&&Mn.hasOwnProperty(e.type)&&Mn[e.type](e,a)}var Ln={Feature:function(e,a){ea(e.geometry,a)},FeatureCollection:function(e,a){for(var r=e.features,n=-1,i=r.length;++n<i;)ea(r[n].geometry,a)}},Mn={Sphere:function(e,a){a.sphere()},Point:function(e,a){e=e.coordinates,a.point(e[0],e[1],e[2])},MultiPoint:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)e=r[n],a.point(e[0],e[1],e[2])},LineString:function(e,a){Aa(e.coordinates,a,0)},MultiLineString:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Aa(r[n],a,0)},Polygon:function(e,a){Rn(e.coordinates,a)},MultiPolygon:function(e,a){for(var r=e.coordinates,n=-1,i=r.length;++n<i;)Rn(r[n],a)},GeometryCollection:function(e,a){for(var r=e.geometries,n=-1,i=r.length;++n<i;)ea(r[n],a)}};function Aa(e,a,r){var n=-1,i=e.length-r,o;for(a.lineStart();++n<i;)o=e[n],a.point(o[0],o[1],o[2]);a.lineEnd()}function Rn(e,a){var r=-1,n=e.length;for(a.polygonStart();++r<n;)Aa(e[r],a,1);a.polygonEnd()}function ft(e,a){e&&Ln.hasOwnProperty(e.type)?Ln[e.type](e,a):ea(e,a)}function Ta(e){return[qt(e[1],e[0]),Lt(e[2])]}function bt(e){var a=e[0],r=e[1],n=Se(r);return[n*Se(a),n*Ee(a),Ee(r)]}function Vt(e,a){return e[0]*a[0]+e[1]*a[1]+e[2]*a[2]}function ta(e,a){return[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]]}function ga(e,a){e[0]+=a[0],e[1]+=a[1],e[2]+=a[2]}function Ht(e,a){return[e[0]*a,e[1]*a,e[2]*a]}function qa(e){var a=ut(e[0]*e[0]+e[1]*e[1]+e[2]*e[2]);e[0]/=a,e[1]/=a,e[2]/=a}function La(e,a){function r(n,i){return n=e(n,i),a(n[0],n[1])}return e.invert&&a.invert&&(r.invert=function(n,i){return n=a.invert(n,i),n&&e.invert(n[0],n[1])}),r}function Ma(e,a){return ve(e)>ie&&(e-=Math.round(e/We)*We),[e,a]}Ma.invert=Ma;function bs(e,a,r){return(e%=We)?a||r?La(Fn(e),Pn(a,r)):Fn(e):a||r?Pn(a,r):Ma}function On(e){return function(a,r){return a+=e,ve(a)>ie&&(a-=Math.round(a/We)*We),[a,r]}}function Fn(e){var a=On(e);return a.invert=On(-e),a}function Pn(e,a){var r=Se(e),n=Ee(e),i=Se(a),o=Ee(a);function l(c,d){var f=Se(d),s=Se(c)*f,x=Ee(c)*f,p=Ee(d),g=p*r+s*n;return[qt(x*i-g*o,s*r-p*n),Lt(g*i+x*o)]}return l.invert=function(c,d){var f=Se(d),s=Se(c)*f,x=Ee(c)*f,p=Ee(d),g=p*i-x*o;return[qt(x*i+p*o,s*r+g*n),Lt(g*r-s*n)]},l}function vs(e,a,r,n,i,o){if(r){var l=Se(a),c=Ee(a),d=n*r;i==null?(i=a+n*We,o=a-d/2):(i=Dn(l,i),o=Dn(l,o),(n>0?i<o:i>o)&&(i+=n*We));for(var f,s=i;n>0?s>o:s<o;s-=d)f=Ta([l,-c*Se(s),-c*Ee(s)]),e.point(f[0],f[1])}}function Dn(e,a){a=bt(a),a[0]-=e,qa(a);var r=gs(-a[1]);return((-a[2]<0?-r:r)+We-fe)%We}function jr(){var e=[],a;return{point:function(r,n,i){a.push([r,n,i])},lineStart:function(){e.push(a=[])},lineEnd:Ve,rejoin:function(){e.length>1&&e.push(e.pop().concat(e.shift()))},result:function(){var r=e;return e=[],a=null,r}}}function Jt(e,a){return ve(e[0]-a[0])<fe&&ve(e[1]-a[1])<fe}function Wt(e,a,r,n){this.x=e,this.z=a,this.o=r,this.e=n,this.v=!1,this.n=this.p=null}function Nr(e,a,r,n,i){var o=[],l=[],c,d;if(e.forEach(function(u){if(!((b=u.length-1)<=0)){var b,v=u[0],h=u[b],j;if(Jt(v,h)){if(!v[2]&&!h[2]){for(i.lineStart(),c=0;c<b;++c)i.point((v=u[c])[0],v[1]);i.lineEnd();return}h[0]+=2*fe}o.push(j=new Wt(v,u,null,!0)),l.push(j.o=new Wt(v,null,j,!1)),o.push(j=new Wt(h,u,null,!1)),l.push(j.o=new Wt(h,null,j,!0))}}),!!o.length){for(l.sort(a),In(o),In(l),c=0,d=l.length;c<d;++c)l[c].e=r=!r;for(var f=o[0],s,x;;){for(var p=f,g=!0;p.v;)if((p=p.n)===f)return;s=p.z,i.lineStart();do{if(p.v=p.o.v=!0,p.e){if(g)for(c=0,d=s.length;c<d;++c)i.point((x=s[c])[0],x[1]);else n(p.x,p.n.x,1,i);p=p.n}else{if(g)for(s=p.p.z,c=s.length-1;c>=0;--c)i.point((x=s[c])[0],x[1]);else n(p.x,p.p.x,-1,i);p=p.p}p=p.o,s=p.z,g=!g}while(!p.v);i.lineEnd()}}}function In(e){if(a=e.length){for(var a,r=0,n=e[0],i;++r<a;)n.n=i=e[r],i.p=n,n=i;n.n=i=e[0],i.p=n}}function ba(e){return ve(e[0])<=ie?e[0]:hs(e[0])*((ve(e[0])+ie)%We-ie)}function ys(e,a){var r=ba(a),n=a[1],i=Ee(n),o=[Ee(r),-Se(r),0],l=0,c=0,d=new ct;i===1?n=Ue+fe:i===-1&&(n=-Ue-fe);for(var f=0,s=e.length;f<s;++f)if(p=(x=e[f]).length)for(var x,p,g=x[p-1],u=ba(g),b=g[1]/2+qn,v=Ee(b),h=Se(b),j=0;j<p;++j,u=y,v=T,h=z,g=E){var E=x[j],y=ba(E),A=E[1]/2+qn,T=Ee(A),z=Se(A),S=y-u,C=S>=0?1:-1,N=C*S,R=N>ie,$=v*T;if(d.add(qt($*C*Ee(N),h*z+$*Se(N))),l+=R?S+C*We:S,R^u>=r^y>=r){var L=ta(bt(g),bt(E));qa(L);var M=ta(o,L);qa(M);var w=(R^S>=0?-1:1)*Lt(M[2]);(n>w||n===w&&(L[0]||L[1]))&&(c+=R^S>=0?1:-1)}}return(l<-fe||l<fe&&d<-1e-12)^c&1}function Sr(e,a,r,n){return function(i){var o=a(i),l=jr(),c=a(l),d=!1,f,s,x,p={point:g,lineStart:b,lineEnd:v,polygonStart:function(){p.point=h,p.lineStart=j,p.lineEnd=E,s=[],f=[]},polygonEnd:function(){p.point=g,p.lineStart=b,p.lineEnd=v,s=kr(s);var y=ys(f,n);s.length?(d||(i.polygonStart(),d=!0),Nr(s,ks,y,r,i)):y&&(d||(i.polygonStart(),d=!0),i.lineStart(),r(null,null,1,i),i.lineEnd()),d&&(i.polygonEnd(),d=!1),s=f=null},sphere:function(){i.polygonStart(),i.lineStart(),r(null,null,1,i),i.lineEnd(),i.polygonEnd()}};function g(y,A){e(y,A)&&i.point(y,A)}function u(y,A){o.point(y,A)}function b(){p.point=u,o.lineStart()}function v(){p.point=g,o.lineEnd()}function h(y,A){x.push([y,A]),c.point(y,A)}function j(){c.lineStart(),x=[]}function E(){h(x[0][0],x[0][1]),c.lineEnd();var y=c.clean(),A=l.result(),T,z=A.length,S,C,N;if(x.pop(),f.push(x),x=null,!!z){if(y&1){if(C=A[0],(S=C.length-1)>0){for(d||(i.polygonStart(),d=!0),i.lineStart(),T=0;T<S;++T)i.point((N=C[T])[0],N[1]);i.lineEnd()}return}z>1&&y&2&&A.push(A.pop().concat(A.shift())),s.push(A.filter(ws))}}return p}}function ws(e){return e.length>1}function ks(e,a){return((e=e.x)[0]<0?e[1]-Ue-fe:Ue-e[1])-((a=a.x)[0]<0?a[1]-Ue-fe:Ue-a[1])}const $n=Sr(function(){return!0},js,Ss,[-ie,-Ue]);function js(e){var a=NaN,r=NaN,n=NaN,i;return{lineStart:function(){e.lineStart(),i=1},point:function(o,l){var c=o>0?ie:-ie,d=ve(o-a);ve(d-ie)<fe?(e.point(a,r=(r+l)/2>0?Ue:-Ue),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),e.point(o,r),i=0):n!==c&&d>=ie&&(ve(a-n)<fe&&(a-=n*fe),ve(o-c)<fe&&(o-=c*fe),r=Ns(a,r,o,l),e.point(n,r),e.lineEnd(),e.lineStart(),e.point(c,r),i=0),e.point(a=o,r=l),n=c},lineEnd:function(){e.lineEnd(),a=r=NaN},clean:function(){return 2-i}}}function Ns(e,a,r,n){var i,o,l=Ee(e-r);return ve(l)>fe?xs((Ee(a)*(o=Se(n))*Ee(r)-Ee(n)*(i=Se(a))*Ee(e))/(i*o*l)):(a+n)/2}function Ss(e,a,r,n){var i;if(e==null)i=r*Ue,n.point(-ie,i),n.point(0,i),n.point(ie,i),n.point(ie,0),n.point(ie,-i),n.point(0,-i),n.point(-ie,-i),n.point(-ie,0),n.point(-ie,i);else if(ve(e[0]-a[0])>fe){var o=e[0]<a[0]?ie:-ie;i=r*o/2,n.point(-o,i),n.point(0,i),n.point(o,i)}else n.point(a[0],a[1])}function Es(e){var a=Se(e),r=2*Ie,n=a>0,i=ve(a)>fe;function o(s,x,p,g){vs(g,e,r,p,s,x)}function l(s,x){return Se(s)*Se(x)>a}function c(s){var x,p,g,u,b;return{lineStart:function(){u=g=!1,b=1},point:function(v,h){var j=[v,h],E,y=l(v,h),A=n?y?0:f(v,h):y?f(v+(v<0?ie:-ie),h):0;if(!x&&(u=g=y)&&s.lineStart(),y!==g&&(E=d(x,j),(!E||Jt(x,E)||Jt(j,E))&&(j[2]=1)),y!==g)b=0,y?(s.lineStart(),E=d(j,x),s.point(E[0],E[1])):(E=d(x,j),s.point(E[0],E[1],2),s.lineEnd()),x=E;else if(i&&x&&n^y){var T;!(A&p)&&(T=d(j,x,!0))&&(b=0,n?(s.lineStart(),s.point(T[0][0],T[0][1]),s.point(T[1][0],T[1][1]),s.lineEnd()):(s.point(T[1][0],T[1][1]),s.lineEnd(),s.lineStart(),s.point(T[0][0],T[0][1],3)))}y&&(!x||!Jt(x,j))&&s.point(j[0],j[1]),x=j,g=y,p=A},lineEnd:function(){g&&s.lineEnd(),x=null},clean:function(){return b|(u&&g)<<1}}}function d(s,x,p){var g=bt(s),u=bt(x),b=[1,0,0],v=ta(g,u),h=Vt(v,v),j=v[0],E=h-j*j;if(!E)return!p&&s;var y=a*h/E,A=-a*j/E,T=ta(b,v),z=Ht(b,y),S=Ht(v,A);ga(z,S);var C=T,N=Vt(z,C),R=Vt(C,C),$=N*N-R*(Vt(z,z)-1);if(!($<0)){var L=ut($),M=Ht(C,(-N-L)/R);if(ga(M,z),M=Ta(M),!p)return M;var w=s[0],O=x[0],H=s[1],V=x[1],U;O<w&&(U=w,w=O,O=U);var re=O-w,ee=ve(re-ie)<fe,X=ee||re<fe;if(!ee&&V<H&&(U=H,H=V,V=U),X?ee?H+V>0^M[1]<(ve(M[0]-w)<fe?H:V):H<=M[1]&&M[1]<=V:re>ie^(w<=M[0]&&M[0]<=O)){var oe=Ht(C,(-N+L)/R);return ga(oe,z),[M,Ta(oe)]}}}function f(s,x){var p=n?e:ie-e,g=0;return s<-p?g|=1:s>p&&(g|=2),x<-p?g|=4:x>p&&(g|=8),g}return Sr(l,c,o,n?[0,-e]:[-ie,e-ie])}function Cs(e,a,r,n,i,o){var l=e[0],c=e[1],d=a[0],f=a[1],s=0,x=1,p=d-l,g=f-c,u;if(u=r-l,!(!p&&u>0)){if(u/=p,p<0){if(u<s)return;u<x&&(x=u)}else if(p>0){if(u>x)return;u>s&&(s=u)}if(u=i-l,!(!p&&u<0)){if(u/=p,p<0){if(u>x)return;u>s&&(s=u)}else if(p>0){if(u<s)return;u<x&&(x=u)}if(u=n-c,!(!g&&u>0)){if(u/=g,g<0){if(u<s)return;u<x&&(x=u)}else if(g>0){if(u>x)return;u>s&&(s=u)}if(u=o-c,!(!g&&u<0)){if(u/=g,g<0){if(u>x)return;u>s&&(s=u)}else if(g>0){if(u<s)return;u<x&&(x=u)}return s>0&&(e[0]=l+s*p,e[1]=c+s*g),x<1&&(a[0]=l+x*p,a[1]=c+x*g),!0}}}}}var St=1e9,Yt=-St;function zs(e,a,r,n){function i(f,s){return e<=f&&f<=r&&a<=s&&s<=n}function o(f,s,x,p){var g=0,u=0;if(f==null||(g=l(f,x))!==(u=l(s,x))||d(f,s)<0^x>0)do p.point(g===0||g===3?e:r,g>1?n:a);while((g=(g+x+4)%4)!==u);else p.point(s[0],s[1])}function l(f,s){return ve(f[0]-e)<fe?s>0?0:3:ve(f[0]-r)<fe?s>0?2:1:ve(f[1]-a)<fe?s>0?1:0:s>0?3:2}function c(f,s){return d(f.x,s.x)}function d(f,s){var x=l(f,1),p=l(s,1);return x!==p?x-p:x===0?s[1]-f[1]:x===1?f[0]-s[0]:x===2?f[1]-s[1]:s[0]-f[0]}return function(f){var s=f,x=jr(),p,g,u,b,v,h,j,E,y,A,T,z={point:S,lineStart:$,lineEnd:L,polygonStart:N,polygonEnd:R};function S(w,O){i(w,O)&&s.point(w,O)}function C(){for(var w=0,O=0,H=g.length;O<H;++O)for(var V=g[O],U=1,re=V.length,ee=V[0],X,oe,I=ee[0],ae=ee[1];U<re;++U)X=I,oe=ae,ee=V[U],I=ee[0],ae=ee[1],oe<=n?ae>n&&(I-X)*(n-oe)>(ae-oe)*(e-X)&&++w:ae<=n&&(I-X)*(n-oe)<(ae-oe)*(e-X)&&--w;return w}function N(){s=x,p=[],g=[],T=!0}function R(){var w=C(),O=T&&w,H=(p=kr(p)).length;(O||H)&&(f.polygonStart(),O&&(f.lineStart(),o(null,null,1,f),f.lineEnd()),H&&Nr(p,c,w,o,f),f.polygonEnd()),s=f,p=g=u=null}function $(){z.point=M,g&&g.push(u=[]),A=!0,y=!1,j=E=NaN}function L(){p&&(M(b,v),h&&y&&x.rejoin(),p.push(x.result())),z.point=S,y&&s.lineEnd()}function M(w,O){var H=i(w,O);if(g&&u.push([w,O]),A)b=w,v=O,h=H,A=!1,H&&(s.lineStart(),s.point(w,O));else if(H&&y)s.point(w,O);else{var V=[j=Math.max(Yt,Math.min(St,j)),E=Math.max(Yt,Math.min(St,E))],U=[w=Math.max(Yt,Math.min(St,w)),O=Math.max(Yt,Math.min(St,O))];Cs(V,U,e,a,r,n)?(y||(s.lineStart(),s.point(V[0],V[1])),s.point(U[0],U[1]),H||s.lineEnd(),T=!1):H&&(s.lineStart(),s.point(w,O),T=!1)}j=w,E=O,y=H}return z}}const Ra=e=>e;var va=new ct,Oa=new ct,Er,Cr,Fa,Pa,et={point:Ve,lineStart:Ve,lineEnd:Ve,polygonStart:function(){et.lineStart=As,et.lineEnd=qs},polygonEnd:function(){et.lineStart=et.lineEnd=et.point=Ve,va.add(ve(Oa)),Oa=new ct},result:function(){var e=va/2;return va=new ct,e}};function As(){et.point=Ts}function Ts(e,a){et.point=zr,Er=Fa=e,Cr=Pa=a}function zr(e,a){Oa.add(Pa*e-Fa*a),Fa=e,Pa=a}function qs(){zr(Er,Cr)}var vt=1/0,aa=vt,Mt=-vt,na=Mt,ra={point:Ls,lineStart:Ve,lineEnd:Ve,polygonStart:Ve,polygonEnd:Ve,result:function(){var e=[[vt,aa],[Mt,na]];return Mt=na=-(aa=vt=1/0),e}};function Ls(e,a){e<vt&&(vt=e),e>Mt&&(Mt=e),a<aa&&(aa=a),a>na&&(na=a)}var Da=0,Ia=0,Et=0,oa=0,ia=0,xt=0,$a=0,Ba=0,Ct=0,Ar,Tr,Je,Xe,_e={point:dt,lineStart:Bn,lineEnd:_n,polygonStart:function(){_e.lineStart=Os,_e.lineEnd=Fs},polygonEnd:function(){_e.point=dt,_e.lineStart=Bn,_e.lineEnd=_n},result:function(){var e=Ct?[$a/Ct,Ba/Ct]:xt?[oa/xt,ia/xt]:Et?[Da/Et,Ia/Et]:[NaN,NaN];return Da=Ia=Et=oa=ia=xt=$a=Ba=Ct=0,e}};function dt(e,a){Da+=e,Ia+=a,++Et}function Bn(){_e.point=Ms}function Ms(e,a){_e.point=Rs,dt(Je=e,Xe=a)}function Rs(e,a){var r=e-Je,n=a-Xe,i=ut(r*r+n*n);oa+=i*(Je+e)/2,ia+=i*(Xe+a)/2,xt+=i,dt(Je=e,Xe=a)}function _n(){_e.point=dt}function Os(){_e.point=Ps}function Fs(){qr(Ar,Tr)}function Ps(e,a){_e.point=qr,dt(Ar=Je=e,Tr=Xe=a)}function qr(e,a){var r=e-Je,n=a-Xe,i=ut(r*r+n*n);oa+=i*(Je+e)/2,ia+=i*(Xe+a)/2,xt+=i,i=Xe*e-Je*a,$a+=i*(Je+e),Ba+=i*(Xe+a),Ct+=i*3,dt(Je=e,Xe=a)}function Lr(e){this._context=e}Lr.prototype={_radius:4.5,pointRadius:function(e){return this._radius=e,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(e,a){switch(this._point){case 0:{this._context.moveTo(e,a),this._point=1;break}case 1:{this._context.lineTo(e,a);break}default:{this._context.moveTo(e+this._radius,a),this._context.arc(e,a,this._radius,0,We);break}}},result:Ve};var _a=new ct,ya,Mr,Rr,zt,At,Rt={point:Ve,lineStart:function(){Rt.point=Ds},lineEnd:function(){ya&&Or(Mr,Rr),Rt.point=Ve},polygonStart:function(){ya=!0},polygonEnd:function(){ya=null},result:function(){var e=+_a;return _a=new ct,e}};function Ds(e,a){Rt.point=Or,Mr=zt=e,Rr=At=a}function Or(e,a){zt-=e,At-=a,_a.add(ut(zt*zt+At*At)),zt=e,At=a}let Un,sa,Vn,Hn;class Wn{constructor(a){this._append=a==null?Fr:Is(a),this._radius=4.5,this._=""}pointRadius(a){return this._radius=+a,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(a,r){switch(this._point){case 0:{this._append`M${a},${r}`,this._point=1;break}case 1:{this._append`L${a},${r}`;break}default:{if(this._append`M${a},${r}`,this._radius!==Vn||this._append!==sa){const n=this._radius,i=this._;this._="",this._append`m0,${n}a${n},${n} 0 1,1 0,${-2*n}a${n},${n} 0 1,1 0,${2*n}z`,Vn=n,sa=this._append,Hn=this._,this._=i}this._+=Hn;break}}}result(){const a=this._;return this._="",a.length?a:null}}function Fr(e){let a=1;this._+=e[0];for(const r=e.length;a<r;++a)this._+=arguments[a]+e[a]}function Is(e){const a=Math.floor(e);if(!(a>=0))throw new RangeError(`invalid digits: ${e}`);if(a>15)return Fr;if(a!==Un){const r=10**a;Un=a,sa=function(i){let o=1;this._+=i[0];for(const l=i.length;o<l;++o)this._+=Math.round(arguments[o]*r)/r+i[o]}}return sa}function $s(e,a){let r=3,n=4.5,i,o;function l(c){return c&&(typeof n=="function"&&o.pointRadius(+n.apply(this,arguments)),ft(c,i(o))),o.result()}return l.area=function(c){return ft(c,i(et)),et.result()},l.measure=function(c){return ft(c,i(Rt)),Rt.result()},l.bounds=function(c){return ft(c,i(ra)),ra.result()},l.centroid=function(c){return ft(c,i(_e)),_e.result()},l.projection=function(c){return arguments.length?(i=c==null?(e=null,Ra):(e=c).stream,l):e},l.context=function(c){return arguments.length?(o=c==null?(a=null,new Wn(r)):new Lr(a=c),typeof n!="function"&&o.pointRadius(n),l):a},l.pointRadius=function(c){return arguments.length?(n=typeof c=="function"?c:(o.pointRadius(+c),+c),l):n},l.digits=function(c){if(!arguments.length)return r;if(c==null)r=null;else{const d=Math.floor(c);if(!(d>=0))throw new RangeError(`invalid digits: ${c}`);r=d}return a===null&&(o=new Wn(r)),l},l.projection(e).digits(r).context(a)}function Za(e){return function(a){var r=new Ua;for(var n in e)r[n]=e[n];return r.stream=a,r}}function Ua(){}Ua.prototype={constructor:Ua,point:function(e,a){this.stream.point(e,a)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};function en(e,a,r){var n=e.clipExtent&&e.clipExtent();return e.scale(150).translate([0,0]),n!=null&&e.clipExtent(null),ft(r,e.stream(ra)),a(ra.result()),n!=null&&e.clipExtent(n),e}function Pr(e,a,r){return en(e,function(n){var i=a[1][0]-a[0][0],o=a[1][1]-a[0][1],l=Math.min(i/(n[1][0]-n[0][0]),o/(n[1][1]-n[0][1])),c=+a[0][0]+(i-l*(n[1][0]+n[0][0]))/2,d=+a[0][1]+(o-l*(n[1][1]+n[0][1]))/2;e.scale(150*l).translate([c,d])},r)}function Bs(e,a,r){return Pr(e,[[0,0],a],r)}function _s(e,a,r){return en(e,function(n){var i=+a,o=i/(n[1][0]-n[0][0]),l=(i-o*(n[1][0]+n[0][0]))/2,c=-o*n[0][1];e.scale(150*o).translate([l,c])},r)}function Us(e,a,r){return en(e,function(n){var i=+a,o=i/(n[1][1]-n[0][1]),l=-o*n[0][0],c=(i-o*(n[1][1]+n[0][1]))/2;e.scale(150*o).translate([l,c])},r)}var Yn=16,Vs=Se(30*Ie);function Gn(e,a){return+a?Ws(e,a):Hs(e)}function Hs(e){return Za({point:function(a,r){a=e(a,r),this.stream.point(a[0],a[1])}})}function Ws(e,a){function r(n,i,o,l,c,d,f,s,x,p,g,u,b,v){var h=f-n,j=s-i,E=h*h+j*j;if(E>4*a&&b--){var y=l+p,A=c+g,T=d+u,z=ut(y*y+A*A+T*T),S=Lt(T/=z),C=ve(ve(T)-1)<fe||ve(o-x)<fe?(o+x)/2:qt(A,y),N=e(C,S),R=N[0],$=N[1],L=R-n,M=$-i,w=j*L-h*M;(w*w/E>a||ve((h*L+j*M)/E-.5)>.3||l*p+c*g+d*u<Vs)&&(r(n,i,o,l,c,d,R,$,C,y/=z,A/=z,T,b,v),v.point(R,$),r(R,$,C,y,A,T,f,s,x,p,g,u,b,v))}}return function(n){var i,o,l,c,d,f,s,x,p,g,u,b,v={point:h,lineStart:j,lineEnd:y,polygonStart:function(){n.polygonStart(),v.lineStart=A},polygonEnd:function(){n.polygonEnd(),v.lineStart=j}};function h(S,C){S=e(S,C),n.point(S[0],S[1])}function j(){x=NaN,v.point=E,n.lineStart()}function E(S,C){var N=bt([S,C]),R=e(S,C);r(x,p,s,g,u,b,x=R[0],p=R[1],s=S,g=N[0],u=N[1],b=N[2],Yn,n),n.point(x,p)}function y(){v.point=h,n.lineEnd()}function A(){j(),v.point=T,v.lineEnd=z}function T(S,C){E(i=S,C),o=x,l=p,c=g,d=u,f=b,v.point=E}function z(){r(x,p,s,g,u,b,o,l,i,c,d,f,Yn,n),v.lineEnd=y,y()}return v}}var Ys=Za({point:function(e,a){this.stream.point(e*Ie,a*Ie)}});function Gs(e){return Za({point:function(a,r){var n=e(a,r);return this.stream.point(n[0],n[1])}})}function Ks(e,a,r,n,i){function o(l,c){return l*=n,c*=i,[a+e*l,r-e*c]}return o.invert=function(l,c){return[(l-a)/e*n,(r-c)/e*i]},o}function Kn(e,a,r,n,i,o){if(!o)return Ks(e,a,r,n,i);var l=Se(o),c=Ee(o),d=l*e,f=c*e,s=l/e,x=c/e,p=(c*r-l*a)/e,g=(c*a+l*r)/e;function u(b,v){return b*=n,v*=i,[d*b-f*v+a,r-f*b-d*v]}return u.invert=function(b,v){return[n*(s*b-x*v+p),i*(g-x*b-s*v)]},u}function Qs(e){return Js(function(){return e})()}function Js(e){var a,r=150,n=480,i=250,o=0,l=0,c=0,d=0,f=0,s,x=0,p=1,g=1,u=null,b=$n,v=null,h,j,E,y=Ra,A=.5,T,z,S,C,N;function R(w){return S(w[0]*Ie,w[1]*Ie)}function $(w){return w=S.invert(w[0],w[1]),w&&[w[0]*Ze,w[1]*Ze]}R.stream=function(w){return C&&N===w?C:C=Ys(Gs(s)(b(T(y(N=w)))))},R.preclip=function(w){return arguments.length?(b=w,u=void 0,M()):b},R.postclip=function(w){return arguments.length?(y=w,v=h=j=E=null,M()):y},R.clipAngle=function(w){return arguments.length?(b=+w?Es(u=w*Ie):(u=null,$n),M()):u*Ze},R.clipExtent=function(w){return arguments.length?(y=w==null?(v=h=j=E=null,Ra):zs(v=+w[0][0],h=+w[0][1],j=+w[1][0],E=+w[1][1]),M()):v==null?null:[[v,h],[j,E]]},R.scale=function(w){return arguments.length?(r=+w,L()):r},R.translate=function(w){return arguments.length?(n=+w[0],i=+w[1],L()):[n,i]},R.center=function(w){return arguments.length?(o=w[0]%360*Ie,l=w[1]%360*Ie,L()):[o*Ze,l*Ze]},R.rotate=function(w){return arguments.length?(c=w[0]%360*Ie,d=w[1]%360*Ie,f=w.length>2?w[2]%360*Ie:0,L()):[c*Ze,d*Ze,f*Ze]},R.angle=function(w){return arguments.length?(x=w%360*Ie,L()):x*Ze},R.reflectX=function(w){return arguments.length?(p=w?-1:1,L()):p<0},R.reflectY=function(w){return arguments.length?(g=w?-1:1,L()):g<0},R.precision=function(w){return arguments.length?(T=Gn(z,A=w*w),M()):ut(A)},R.fitExtent=function(w,O){return Pr(R,w,O)},R.fitSize=function(w,O){return Bs(R,w,O)},R.fitWidth=function(w,O){return _s(R,w,O)},R.fitHeight=function(w,O){return Us(R,w,O)};function L(){var w=Kn(r,0,0,p,g,x).apply(null,a(o,l)),O=Kn(r,n-w[0],i-w[1],p,g,x);return s=bs(c,d,f),z=La(a,O),S=La(s,z),T=Gn(z,A),M()}function M(){return C=N=null,R}return function(){return a=e.apply(this,arguments),R.invert=a.invert&&$,L()}}function Dr(e,a){var r=a*a,n=r*r;return[e*(.8707-.131979*r+n*(-.013791+n*(.003971*r-.001529*n))),a*(1.007226+r*(.015085+n*(-.044475+.028874*r-.005916*n)))]}Dr.invert=function(e,a){var r=a,n=25,i;do{var o=r*r,l=o*o;r-=i=(r*(1.007226+o*(.015085+l*(-.044475+.028874*o-.005916*l)))-a)/(1.007226+o*(.015085*3+l*(-.044475*7+.028874*9*o-.005916*11*l)))}while(ve(i)>fe&&--n>0);return[e/(.8707+(o=r*r)*(-.131979+o*(-.013791+o*o*o*(.003971-.001529*o)))),r]};function Xs(){return Qs(Dr).scale(175.295)}function Zs(e){return e}function el(e){if(e==null)return Zs;var a,r,n=e.scale[0],i=e.scale[1],o=e.translate[0],l=e.translate[1];return function(c,d){d||(a=r=0);var f=2,s=c.length,x=new Array(s);for(x[0]=(a+=c[0])*n+o,x[1]=(r+=c[1])*i+l;f<s;)x[f]=c[f],++f;return x}}function tl(e,a){for(var r,n=e.length,i=n-a;i<--n;)r=e[i],e[i++]=e[n],e[n]=r}function al(e,a){return typeof a=="string"&&(a=e.objects[a]),a.type==="GeometryCollection"?{type:"FeatureCollection",features:a.geometries.map(function(r){return Qn(e,r)})}:Qn(e,a)}function Qn(e,a){var r=a.id,n=a.bbox,i=a.properties==null?{}:a.properties,o=nl(e,a);return r==null&&n==null?{type:"Feature",properties:i,geometry:o}:n==null?{type:"Feature",id:r,properties:i,geometry:o}:{type:"Feature",id:r,bbox:n,properties:i,geometry:o}}function nl(e,a){var r=el(e.transform),n=e.arcs;function i(s,x){x.length&&x.pop();for(var p=n[s<0?~s:s],g=0,u=p.length;g<u;++g)x.push(r(p[g],g));s<0&&tl(x,u)}function o(s){return r(s)}function l(s){for(var x=[],p=0,g=s.length;p<g;++p)i(s[p],x);return x.length<2&&x.push(x[0]),x}function c(s){for(var x=l(s);x.length<4;)x.push(x[0]);return x}function d(s){return s.map(c)}function f(s){var x=s.type,p;switch(x){case"GeometryCollection":return{type:x,geometries:s.geometries.map(f)};case"Point":p=o(s.coordinates);break;case"MultiPoint":p=s.coordinates.map(o);break;case"LineString":p=l(s.arcs);break;case"MultiLineString":p=s.arcs.map(l);break;case"Polygon":p=d(s.arcs);break;case"MultiPolygon":p=s.arcs.map(d);break;default:return null}return{type:x,coordinates:p}}return f(a)}const Ir={US:[{k:["new york","nyc","brooklyn","manhattan"],ll:[-74,40.7]},{k:["san francisco","sf","palo alto","mountain view","menlo park","san jose","oakland"],ll:[-122.3,37.6]},{k:["los angeles","santa monica","irvine"],ll:[-118.2,34.1]},{k:["seattle","bellevue","redmond"],ll:[-122.3,47.6]},{k:["austin"],ll:[-97.7,30.3]},{k:["boston","cambridge"],ll:[-71.1,42.4]},{k:["chicago"],ll:[-87.6,41.9]},{k:["miami"],ll:[-80.2,25.8]},{k:["denver","boulder"],ll:[-105,39.7]},{k:["atlanta"],ll:[-84.4,33.7]},{k:["washington","arlington","dc"],ll:[-77,38.9]},{k:["dallas","houston"],ll:[-96.8,31.5]},{k:["salt lake","provo"],ll:[-111.9,40.8]},{k:["phoenix","tempe"],ll:[-112.1,33.4]}],CA:[{k:["toronto","waterloo"],ll:[-79.4,43.7]},{k:["montreal"],ll:[-73.6,45.5]},{k:["vancouver"],ll:[-123.1,49.3]},{k:["calgary"],ll:[-114.1,51]},{k:["ottawa"],ll:[-75.7,45.4]}],AU:[{k:["sydney"],ll:[151.2,-33.9]},{k:["melbourne"],ll:[145,-37.8]},{k:["brisbane"],ll:[153,-27.5]},{k:["perth"],ll:[115.9,-32]}],BR:[{k:["sao paulo"],ll:[-46.6,-23.5]},{k:["rio"],ll:[-43.2,-22.9]}],IN:[{k:["bengaluru","bangalore"],ll:[77.6,13]},{k:["mumbai"],ll:[72.9,19.1]},{k:["delhi","gurgaon","gurugram","noida"],ll:[77.2,28.6]},{k:["hyderabad"],ll:[78.5,17.4]},{k:["chennai"],ll:[80.3,13.1]}],CN:[{k:["beijing","pekin"],ll:[116.4,39.9]},{k:["shanghai"],ll:[121.5,31.2]},{k:["shenzhen","canton","guangzhou"],ll:[113.9,22.7]}],RU:[{k:["moscou","moscow"],ll:[37.6,55.8]},{k:["saint petersbourg","saint petersburg"],ll:[30.3,59.9]}]},rl=e=>e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").trim();function ol(e,a,r){const n=Ir[e];if(!n||!n.length)return-1;const i=rl(a||"");if(i){for(let o=0;o<n.length;o++)if(n[o].k.some(l=>i.includes(l)))return o}return Math.floor(r*n.length)%n.length}let Gt=null;function il(){return Gt||(Gt=(async()=>{var e;try{const a=await fetch("/world/countries-110m.json");if(!a.ok)return null;const r=await a.json(),n=(e=r==null?void 0:r.objects)==null?void 0:e.countries;if(!n)return null;const i=al(r,n),o=Xs().fitExtent([[8,8],[992,492]],{type:"Sphere"}),l=$s(o),c=(i.features||[]).filter(s=>{var x;return(((x=s.properties)==null?void 0:x.name)||"")!=="Antarctica"}).map(s=>{var g;const x=((g=s.properties)==null?void 0:g.name)||"",p=l(s)||"";return p?{i2:Mo(x)||null,n:x,d:p}:null}).filter(s=>!!s);if(!c.length)return null;const d={};for(const[s,x]of Object.entries(Ro)){const p=o(x);p&&(d[s]={x:p[0],y:p[1]})}const f={};for(const[s,x]of Object.entries(Ir)){const p=x.map(g=>o(g.ll)).filter(g=>!!g).map(([g,u])=>({x:g,y:u}));p.length&&(f[s]=p)}return{key:"monde",viewBox:"0 0 1000 500",fr:"Monde",en:"World",countries:c,anchors:d,metros:f}}catch{return null}})(),Gt)}function sl(e){const[a,r]=m.useState(null);return m.useEffect(()=>{if(!e||a)return;let n=!1;return il().then(i=>{!n&&i&&r(i)}),()=>{n=!0}},[e,a]),a}const ll={"northam:US":{fx:.64,fy:.68,sx:.44,sy:.28},"northam:CA":{fx:.58,fy:.86,sx:.34,sy:.1},"oceania:AU":{fx:.72,fy:.62,sx:.34,sy:.3},"europe:RU":{fx:.18,fy:.62,sx:.14,sy:.3}},Jn=["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"];function Xn(e){let a=2166136261;for(let r=0;r<e.length;r++)a^=e.charCodeAt(r),a=Math.imul(a,16777619);return(a>>>0)/4294967295}function cl(e,a){const[r,n]=m.useState(1);return m.useEffect(()=>{let i=!0,o=0;const l=()=>{var f;if(!i)return;const d=(f=e.current)==null?void 0:f.getScreenCTM();d&&d.a>0?n(d.a):o=requestAnimationFrame(l)};l();const c=new ResizeObserver(()=>l());return e.current&&c.observe(e.current),window.addEventListener("resize",l),()=>{i=!1,cancelAnimationFrame(o),c.disconnect(),window.removeEventListener("resize",l)}},[e,a]),r}function Zn({msgs:e}){const[a,r]=m.useState(0);m.useEffect(()=>{const i=window.setInterval(()=>r(o=>o+1),2400);return()=>window.clearInterval(i)},[]);const n=[[46,34],[52,41],[41,46],[57,30],[49,52],[36,38],[61,45],[44,27]];return t.jsxs("div",{className:"mapskel","aria-hidden":"true",children:[n.map(([i,o],l)=>t.jsx("i",{style:{left:i+"%",top:o+"%","--d":l*.18+"s"}},l)),t.jsx("span",{className:"mskm",children:e[a%e.length]})]})}function dl(){const{st:e,dispatch:a,scoped:r,pipe:n,markRow:i,markedId:o,byId:l,lang:c,t:d,data:f,dossiers:s,source:x}=B(),p=f.loading&&!s.length,g=m.useRef(null),u=m.useRef(null),b=sl(e.continent==="monde"),v=e.continent==="monde"?b:Ya.find(w=>w.key===e.continent)||null,h=cl(g,e.continent+":"+e.mapFolded+":"+!!v),[j,E]=m.useState(new Map),[y,A]=m.useState(null);m.useEffect(()=>{const w=g.current;if(!w)return;const O=new Map;w.querySelectorAll("path[data-i2]").forEach(H=>{const V=H.dataset.i2;if(V)try{const U=H.getBBox();U.width>0&&O.set(V,{x:U.x,y:U.y,w:U.width,h:U.height})}catch{}}),E(O)},[e.continent,h,v]);const T=m.useMemo(()=>r.filter(w=>w.cc),[r]),z=m.useMemo(()=>{const w=new Map;return T.forEach(O=>w.set(O.cc,(w.get(O.cc)||0)+1)),w},[T]),S=e.continent==="monde"&&b?b.anchors:null,C=e.continent==="monde"&&b?b.metros:null,N=m.useMemo(()=>T.map(w=>{const O=Xn(w.name||w.id||""),H=Xn((w.id||w.name||"")+"·y");if(S&&w.cc){const X=C?C[w.cc]:void 0;if(X&&X.length){const I=ol(w.cc,w.city,O);if(I>=0&&X[I])return{d:w,x:X[I].x+(O-.5)*5,y:X[I].y+(H-.5)*5}}const oe=S[w.cc];if(oe)return{d:w,x:oe.x+(O-.5)*10,y:oe.y+(H-.5)*10}}const V=w.cc?j.get(w.cc):void 0;if(!V)return null;const U=ll[`${e.continent}:${w.cc||""}`];if(U)return{d:w,x:V.x+V.w*(U.fx+(O-.5)*U.sx),y:V.y+V.h*(U.fy+(H-.5)*U.sy)};const re=(O-.5)*Math.min(V.w*.55,60),ee=(H-.5)*Math.min(V.h*.55,60);return{d:w,x:V.x+V.w/2+re,y:V.y+V.h/2+ee}}).filter(w=>!!w),[T,j,S,C,e.continent]),R=w=>h>0?w/h:w,$=m.useMemo(()=>n?[0,1,2,3,4,5].map(w=>({c:Jn[w],fr:d.plabels[w].toUpperCase(),en:d.plabels[w].toUpperCase(),n:r.filter(O=>O.kind==="target"&&Ce(O)===w).length})).filter(w=>w.n>0):hn.map((w,O)=>({...w,n:r.filter(H=>gn(H)===O).length})),[r,n,d.plabels]),L=o?l.get(o):null,M=L?N.find(w=>w.d.id===L.id):null;return v?t.jsxs("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:[p&&t.jsx(Zn,{msgs:d.loadMsgs}),t.jsxs("svg",{ref:g,viewBox:v.viewBox,preserveAspectRatio:"xMidYMid meet",role:"img","aria-label":c==="fr"?v.fr:v.en,onMouseLeave:()=>{A(null),i(null)},children:[t.jsx("g",{children:v.countries.map((w,O)=>t.jsx("g",{className:"ct"+(w.i2&&z.get(w.i2)?"":" empty"),children:t.jsx("path",{d:w.d,"data-i2":w.i2||void 0})},O))}),t.jsx("g",{children:N.map(w=>{const O=hn[gn(w.d)],H=!!Ae(w.d),V=w.d.kind==="target",U=n&&V?Jn[Ce(w.d)]:O.c,re=!n&&Re(w.d);return t.jsxs("g",{className:"co"+(re?" done":""),onMouseEnter:()=>{var oe,I;const ee=(oe=u.current)==null?void 0:oe.getBoundingClientRect(),X=(I=g.current)==null?void 0:I.createSVGPoint();if(X&&g.current&&ee){X.x=w.x,X.y=w.y;const ae=X.matrixTransform(g.current.getScreenCTM());A({x:ae.x-ee.left,y:ae.y-ee.top,label:w.d.name+" · "+(wt(w.d.cc,c)||w.d.countryLabel||"")})}i(w.d.id)},onMouseLeave:()=>{A(null),i(null)},onClick:()=>{var oe;if(x==="ops"){a({type:"focus",id:w.d.id}),w.d.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:w.d.name}}));return}const ee=(oe=g.current)==null?void 0:oe.createSVGPoint();let X=null;if(ee&&g.current){ee.x=w.x,ee.y=w.y;const I=ee.matrixTransform(g.current.getScreenCTM());X={x:I.x,y:I.y}}a({type:"popup",id:w.d.id,anchor:X})},children:[t.jsx("circle",{className:"h",cx:w.x,cy:w.y,r:R(Math.max(11,O.px+7))}),t.jsx("circle",{className:"v",cx:w.x,cy:w.y,r:R(O.px),fill:U,stroke:H?"#DC2626":"#ffffff",strokeWidth:R(H?2.2:1.3)})]},w.d.id||w.d.name)})}),M&&t.jsx("circle",{className:"ring on",cx:M.x,cy:M.y,r:R(13),fill:"none",stroke:"#0F172A",strokeWidth:R(2)})]}),t.jsx("div",{className:"hov"+(y?" on":""),style:y?{left:y.x,top:y.y}:void 0,children:y==null?void 0:y.label}),t.jsx("div",{className:"legend",children:$.map((w,O)=>t.jsxs("span",{children:[t.jsx("i",{style:{"--c":w.c}}),c==="fr"?w.fr:w.en," ",t.jsx("b",{children:w.n})]},O))}),r.some(w=>!w.cc)&&t.jsx("div",{className:"legend",style:{left:"auto",right:10},children:t.jsxs("span",{children:["🌐 ",d.notLocated," ",t.jsx("b",{children:r.filter(w=>!w.cc).length})]})})]}):t.jsx("div",{className:"mapzone"+(p?" waiting":""),ref:u,children:t.jsx(Zn,{msgs:d.loadMsgs})})}function pl(e,a){const r=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!r)return e;const i=(a==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"])[Number(r[2])-1]||r[2],o=Number(r[3]);return a==="en"?`${i} ${o}, ${r[1]}`:`${o} ${i} ${r[1]}`}function $r({compact:e=!1}){const{st:a,dispatch:r,dossiers:n,t:i,pipe:o,contName:l,lang:c}=B(),d=a.filters,[f,s]=m.useState(!1),x=m.useRef(null),p=m.useMemo(()=>a.continent==="monde"?n:n.filter(S=>S.continent===a.continent),[n,a.continent]),g=S=>p.filter(C=>S!=="country"&&d.country.length&&!d.country.includes(C.cc||"")?!1:Ka(C,d,o,S==="country"?void 0:S)),u=m.useMemo(()=>{const S=g("win"),C=N=>S.filter(R=>(R.date?Math.max(0,Math.floor((Date.now()-Date.parse(R.date))/864e5)):9999)<=N).length;return[C(0),C(7),C(30),S.length]},[p,d,o]),b=m.useMemo(()=>d.day?g("win").filter(S=>(S.date||"").slice(0,10)===d.day).length:0,[p,d,o]),v=(d.signalOnly?1:0)+d.sector.length+d.country.length+d.engine.length+d.stage.length+d.angle.length+d.memoLevel.length,h=v+(d.acquirer.trim()?1:0)+(d.day||d.win!=="all"?1:0)+(d.search.trim()?1:0);m.useEffect(()=>{a.openFacet&&s(!1)},[a.openFacet]),m.useEffect(()=>{if(!f)return;const S=N=>{var R;(R=x.current)!=null&&R.contains(N.target)||s(!1)},C=N=>{N.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",S),document.addEventListener("keydown",C),()=>{document.removeEventListener("mousedown",S),document.removeEventListener("keydown",C)}},[f]);const j=(S,C,N,R="fbtn")=>t.jsxs("button",{type:"button",className:R,"aria-expanded":a.openFacet===S,onClick:()=>r({type:"openFacet",facet:S}),children:[t.jsx("span",{className:"fl",children:C}),N>0&&t.jsx("span",{className:"n",children:N}),t.jsx("span",{className:"cv",children:"▾"})]},S),E=d.day?t.jsxs("div",{className:"seg",children:[t.jsxs("button",{type:"button","aria-pressed":!0,children:[t.jsx("span",{className:"sl",children:i.fDay(pl(d.day,c))}),t.jsx("b",{children:b})]}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{day:"",win:"all"}}),children:i.fDayOff})]}):t.jsx("div",{className:"seg",children:["1","7","30","all"].map((S,C)=>t.jsxs("button",{type:"button","aria-pressed":d.win===S,onClick:()=>r({type:"filters",patch:{win:S}}),children:[t.jsx("span",{className:"sl",children:i.dates[C]}),t.jsx("b",{children:u[C]})]},S))}),y=t.jsxs("span",{className:"fsrch",children:["🔍",t.jsx("input",{placeholder:i.identSearch,value:d.search,onChange:S=>r({type:"filters",patch:{search:S.target.value}})})]}),A=t.jsxs("div",{className:"facets",children:[t.jsxs("button",{type:"button",className:"fbtn fsig","aria-expanded":a.openFacet==="sig",onClick:()=>r({type:"openFacet",facet:"sig"}),children:[t.jsx("span",{className:"fl",children:i.fSignal}),d.signalOnly&&t.jsx("span",{className:"n",children:d.signalEngines.length||"✓"}),t.jsx("span",{className:"cv",children:"▾"})]}),d.sector.length===1?t.jsxs("button",{type:"button",className:"fbtn on","aria-expanded":a.openFacet==="sec",onClick:()=>r({type:"openFacet",facet:"sec"}),title:d.sector[0],children:[t.jsx("span",{className:"fl",children:i.fSector}),t.jsx("span",{className:"n",style:{maxWidth:"16ch",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:d.sector[0]}),t.jsx("span",{className:"cv",children:"▾"})]}):j("sec",i.fSector,d.sector.length),j("pay",i.fCountry,d.country.length),j("det",i.fEngine,d.engine.length),j("sta",i.fStage,d.stage.length),o&&j("ang","Angle",d.angle.length),o&&j("mem","Mémo",d.memoLevel.length)]}),T=(S=!1)=>t.jsxs("div",{className:"frow2",children:[h>0&&t.jsxs("button",{type:"button",className:"resetbtn on",title:i.clearTitle(p.length,l),onClick:()=>r({type:"reset"}),children:[t.jsx("span",{className:"rot",children:"↺"}),t.jsx("span",{children:i.clear(h)})]}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:i.alertBtn}),S&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>r({type:"mapFold",folded:!1}),children:i.showMap})]}),z=t.jsxs("div",{className:"fmenu",ref:x,children:[t.jsxs("button",{type:"button",className:"fbtn fmenu-btn"+(v?" on":""),"aria-expanded":f,"aria-haspopup":"true",onClick:()=>{s(S=>!S),a.openFacet&&r({type:"openFacet",facet:null})},children:[t.jsx("span",{className:"fl",children:i.fMenu}),v>0&&t.jsx("span",{className:"n",children:v}),t.jsx("span",{className:"cv",children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"fmenu-pop",role:"menu",children:A})]});return e?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"fstrip"+(d.day?" noday":""),children:[!d.day&&t.jsx("div",{className:"fstrip-a",children:E}),t.jsxs("div",{className:"fstrip-b",children:[y,z,T(!0)]})]}),a.openFacet&&t.jsx(er,{poolFor:g})]}):t.jsxs(t.Fragment,{children:[t.jsxs("aside",{className:"fbar",children:[E,y,A,t.jsx("span",{className:"fgrow"}),T()]}),a.openFacet&&t.jsx(er,{poolFor:g})]})}function er({poolFor:e}){const{st:a,dispatch:r,t:n,lang:i}=B(),o=a.filters,l=a.openFacet,{title:c,cols:d,options:f}=m.useMemo(()=>{if(l==="sig"){const u=e("signal").filter(h=>Ae(h)),b=new Map;u.forEach(h=>{const j=h.engine||"";b.set(j,(b.get(j)||0)+1)});const v=[{v:"*",label:n.fpSigAll,n:u.length,html:!0,on:o.signalOnly&&!o.signalEngines.length},...Sa([...b.keys()],i).map(h=>({v:h,label:lt(h)+" "+He(h,i),n:b.get(h)||0,html:!1,on:o.signalOnly&&o.signalEngines.includes(h)}))];return{title:n.fpSigTitle,cols:2,options:v}}if(l==="sec"){const u=e("sector"),b=new Map;return u.forEach(v=>{v.sector&&b.set(v.sector,(b.get(v.sector)||0)+1)}),{title:n.fSector.toUpperCase(),cols:3,options:[...b.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v,n:h,html:!1,on:o.sector.includes(v)}))}}if(l==="pay"){const u=e("country"),b=new Map;return u.forEach(v=>{v.cc&&b.set(v.cc,(b.get(v.cc)||0)+1)}),{title:n.fCountry.toUpperCase(),cols:3,options:[...b.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:wt(v,i)||v,n:h,html:!1,on:o.country.includes(v)}))}}if(l==="det"){const u=e("engine"),b=new Map;return u.forEach(v=>{v.engine&&b.set(v.engine,(b.get(v.engine)||0)+1)}),{title:n.fEngine.toUpperCase(),cols:2,options:Sa([...b.keys()],i).map(v=>({v,label:lt(v)+" "+He(v,i)+' <span style="color:var(--dim);font-size:10px">· '+Oo(Fo(v),i)+"</span>",n:b.get(v)||0,html:!0,on:o.engine.includes(v)}))}}if(l==="ang"){const u=e("angle"),b=new Map;return u.forEach(v=>{v.angle&&b.set(v.angle,(b.get(v.angle)||0)+1)}),{title:"ANGLE",cols:2,options:[...b.entries()].sort((v,h)=>h[1]-v[1]).map(([v,h])=>({v,label:v.replace(/[_-]+/g," "),n:h,html:!1,on:o.angle.includes(v)}))}}if(l==="mem"){const u=e("memoLevel"),b=new Map;u.forEach(h=>{if(h.kind==="target"){const j=Ha(h);b.set(j,(b.get(j)||0)+1)}});const v=["Aucun mémo","Mémo instantané","Mémo détaillé"];return{title:"MÉMO",cols:2,options:[0,1,2].map(h=>({v:String(h),label:v[h],n:b.get(h)||0,html:!1,on:o.memoLevel.includes(h)}))}}const p=e("stage"),g=new Map;return p.forEach(u=>{u.stage&&g.set(u.stage,(g.get(u.stage)||0)+1)}),{title:n.fStage.toUpperCase(),cols:2,options:[...g.entries()].sort((u,b)=>b[1]-u[1]).map(([u,b])=>({v:u,label:u,n:b,html:!1,on:o.stage.includes(u)}))}},[l,a,i]),s=p=>{if(l==="sig"){if(p==="*")r({type:"filters",patch:{signalOnly:!(o.signalOnly&&!o.signalEngines.length),signalEngines:[]}});else{const u=o.signalEngines.includes(p)?o.signalEngines.filter(b=>b!==p):[...o.signalEngines,p];r({type:"filters",patch:{signalOnly:!0,signalEngines:u}})}return}if(l==="mem"){r({type:"toggleMemoLevel",value:Number(p)});return}r({type:"toggleFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage",value:p})},x=()=>{r(l==="sig"?{type:"filters",patch:{signalOnly:!1,signalEngines:[]}}:l==="mem"?{type:"clearFacet",facet:"memoLevel"}:{type:"clearFacet",facet:l==="sec"?"sector":l==="pay"?"country":l==="det"?"engine":l==="ang"?"angle":"stage"})};return t.jsxs("div",{className:"fpanel on",children:[t.jsxs("div",{className:"ph",children:[t.jsx("b",{children:c}),t.jsx("span",{className:"sp"}),t.jsx("button",{type:"button",onClick:x,children:n.fpNone}),t.jsx("button",{type:"button",onClick:()=>r({type:"openFacet",facet:null}),children:n.fpClose})]}),t.jsx("div",{className:"fcols"+(d===2?" two":""),children:f.map(p=>t.jsxs("button",{type:"button",className:"opt","aria-pressed":p.on,onClick:()=>s(p.v),children:[t.jsx("span",{className:"bx"}),p.html?t.jsx("span",{className:"l",dangerouslySetInnerHTML:{__html:p.label}}):t.jsx("span",{className:"l",children:p.label}),t.jsx("span",{className:"n",children:p.n})]},p.v))}),t.jsxs("div",{className:"pf",children:[t.jsx("span",{className:"t",children:n.alertReady}),t.jsx("button",{type:"button",className:"alertbtn",onClick:()=>r({type:"modal",modal:"alert"}),children:n.alertCreate})]})]})}function Br({mapToggle:e=!0,variant:a="tabs"}){const{dossiers:r,st:n,dispatch:i,pipe:o,lang:l,t:c}=B(),d=m.useMemo(()=>{const g={};return r.forEach(u=>{Ka(u,n.filters,o)&&(g.monde=(g.monde||0)+1,u.continent&&(g[u.continent]=(g[u.continent]||0)+1))}),g},[r,n.filters,o]),[f,s]=m.useState(!1),x=m.useRef(null);m.useEffect(()=>{if(!f)return;const g=b=>{var v;(v=x.current)!=null&&v.contains(b.target)||s(!1)},u=b=>{b.key==="Escape"&&s(!1)};return document.addEventListener("mousedown",g),document.addEventListener("keydown",u),()=>{document.removeEventListener("mousedown",g),document.removeEventListener("keydown",u)}},[f]);const p=g=>{const u=Ya.find(b=>b.key===g);return g==="monde"?c.contWorld:l==="fr"?u.fr:u.en};return a==="compact"?t.jsxs("div",{className:"contpick",ref:x,children:[t.jsxs("button",{type:"button",className:"contpick-btn","aria-expanded":f,"aria-haspopup":"listbox",onClick:()=>s(g=>!g),children:[p(n.continent),t.jsx("span",{className:"n",children:d[n.continent]||0}),t.jsx("i",{children:f?"▴":"▾"})]}),f&&t.jsx("div",{className:"contpick-pop",role:"listbox",children:bn.map(g=>t.jsxs("button",{type:"button",role:"option","aria-selected":n.continent===g,onClick:()=>{i({type:"continent",key:g}),s(!1)},children:[p(g),t.jsx("span",{className:"n",children:d[g]||0})]},g))}),e&&t.jsx("button",{type:"button",className:"mapbtn",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})]}):t.jsxs("div",{className:"conts",children:[bn.map(g=>t.jsxs("button",{type:"button",className:"cbtn","aria-selected":n.continent===g,onClick:()=>i({type:"continent",key:g}),children:[p(g),t.jsx("span",{className:"n",children:d[g]||0})]},g)),e&&t.jsx("span",{className:"side",children:t.jsx("button",{type:"button",onClick:()=>i({type:"mapFold",folded:!n.mapFolded}),children:n.mapFolded?c.showMap:c.hideMap})})]})}function _r(e){return String(e||"").split(`
`).map(a=>a.replace(/^#{1,6}\s*/,"").replace(/[*_`>]/g,"").trimEnd()).filter(a=>a.trim().length>0)}function ul(e){var i;const a=[],r=new Set,n=o=>{const l=(o||"").trim();!l||r.has(l.toLowerCase())||(r.add(l.toLowerCase()),a.push(l))};return((e==null?void 0:e.companies_cited)||[]).forEach(o=>n(o==null?void 0:o.name)),(((i=e==null?void 0:e.prospective)==null?void 0:i.companies_to_evaluate)||[]).forEach(o=>n(o==null?void 0:o.name)),a}function tr({icon:e,title:a,hint:r,rows:n,addLabel:i,onEvaluate:o,onAddAll:l}){const{t:c}=B();return n.length?t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:[e," ",a]}),t.jsx("span",{className:"n",children:n.length}),l&&t.jsx("button",{type:"button",className:"rsblk-all",onClick:()=>l(n.map(d=>d.name)),children:i})]}),t.jsx("p",{className:"rsblk-hint",children:r}),t.jsx("div",{className:"rsblk-rows",children:n.map(d=>t.jsxs("div",{className:"rsrow",children:[t.jsxs("div",{className:"rsrow-t",children:[t.jsxs("div",{className:"rsrow-h",children:[t.jsx("span",{className:"nm",children:d.name}),d.chips.map(f=>t.jsx("span",{className:"ch",children:f},f))]}),d.line1&&t.jsx("p",{className:"w",children:d.line1}),d.line2&&t.jsx("p",{className:"r",children:d.line2})]}),t.jsx("button",{type:"button",className:"rsrow-go",onClick:()=>o(d.name),children:c.rsEvalOne})]},d.name))})]}):null}function Ur({card:e,onEvaluate:a,onAddAll:r}){var l;const{t:n}=B(),i=((e==null?void 0:e.companies_cited)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.what||"").trim(),line2:(c.role||"").trim(),chips:[(c.country||"").trim()].filter(Boolean)})),o=(((l=e==null?void 0:e.prospective)==null?void 0:l.companies_to_evaluate)||[]).filter(c=>c&&(c.name||"").trim()).map(c=>({name:(c.name||"").trim(),line1:(c.why||"").trim(),chips:[(c.country||"").trim(),(c.stage||"").trim()].filter(Boolean)}));return!i.length&&!o.length?t.jsx("p",{className:"rsblk-none",children:n.rsNoCompanies}):t.jsxs(t.Fragment,{children:[t.jsx(tr,{icon:"🏷",title:n.rsCited,hint:n.rsCitedHint,rows:i,addLabel:n.rsAddAll(i.length),onEvaluate:a,onAddAll:r}),t.jsx(tr,{icon:"🎯",title:n.rsMatch,hint:n.rsMatchHint,rows:o,addLabel:n.rsAddAll(o.length),onEvaluate:a,onAddAll:r})]})}function ml({card:e,onEvaluate:a,onAddAll:r}){var c,d,f;const{t:n}=B(),i=[e.industry,...e.market_tags||[],e.author].map(s=>(s||"").trim()).filter(Boolean),o=(((c=e.prospective)==null?void 0:c.criteria)||[]).filter(Boolean),l=(e.sources||[]).filter(s=>s&&s.url);return t.jsxs("div",{className:"rsdet",children:[e.market&&t.jsx("p",{className:"rsmk",children:e.market}),i.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:n.rsTags}),i.map(s=>t.jsx("span",{children:s},s))]}),t.jsxs("div",{className:"rsbody",children:[e.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${e.mindmap_png_b64}`,alt:n.rsMindmap}),t.jsx("figcaption",{children:n.rsMindmap})]}),t.jsx("div",{className:"rssum",children:_r(e.summary_md||"").map((s,x)=>t.jsx("p",{children:s},x))})]}),t.jsx(Ur,{card:e,onEvaluate:a,onAddAll:r}),(((d=e.prospective)==null?void 0:d.conclusion)||o.length>0)&&t.jsxs("section",{className:"rsblk rspro",children:[t.jsx("div",{className:"rsblk-h",children:t.jsxs("b",{children:["🔮 ",n.rsConclusion]})}),((f=e.prospective)==null?void 0:f.conclusion)&&t.jsx("p",{className:"rspro-c",children:e.prospective.conclusion}),o.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"rsblk-hint",children:n.rsCriteria}),t.jsx("ul",{className:"rspro-l",children:o.map(s=>t.jsx("li",{children:s},s))})]})]}),l.length>0&&t.jsxs("section",{className:"rsblk",children:[t.jsxs("div",{className:"rsblk-h",children:[t.jsxs("b",{children:["🔗 ",n.rsSources]}),t.jsx("span",{className:"n",children:l.length})]}),t.jsx("div",{className:"rssrc",children:l.map(s=>t.jsx("a",{href:s.url,target:"_blank",rel:"noopener noreferrer",children:s.label||s.url},s.url))})]})]})}function fl(e){if(!e)return"";const a=new Date(e);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{day:"2-digit",month:"short"})}function xl({onClose:e,onEvaluate:a,onAddAll:r,bump:n,cbToken:i}){const{t:o,email:l}=B(),c=i,[d,f]=m.useState(null),[s,x]=m.useState(null),[p,g]=m.useState(null),[u,b]=m.useState(!1);m.useEffect(()=>{let h=!0;return(async()=>{const j=await cr({email:l,cbToken:c});h&&f(j)})(),()=>{h=!1}},[l,c,n]);const v=h=>{x(h),g(null),b(!0),(async()=>{const j=await Po(h.id);g(j),b(!1)})()};return t.jsxs("div",{className:"rsarch",children:[t.jsxs("div",{className:"rsarch-h",children:[s?t.jsx("button",{type:"button",className:"rsarch-back",onClick:()=>{x(null),g(null)},children:o.rsArchBack}):t.jsxs("b",{children:["🗂 ",o.rsArchTitle]}),s&&t.jsx("span",{className:"ti",children:s.title}),!s&&d&&t.jsx("span",{className:"n",children:d.length}),t.jsx("button",{type:"button",className:"rsx",title:o.rsClose,onClick:e,children:"×"})]}),!s&&t.jsxs("div",{className:"rsarch-list",children:[d===null&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),d!==null&&d.length===0&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchEmpty}),(d||[]).map(h=>t.jsxs("button",{type:"button",className:"rsarch-row",onClick:()=>v(h),children:[t.jsx("span",{className:"ti",children:h.title}),t.jsxs("span",{className:"me",children:[fl(h.created_at),h.industry?` · ${h.industry}`:"",h.author?` · ${h.author}`:""]}),t.jsx("span",{className:"cn",children:o.rsRowCounts(h.cited_n||0,h.evaluate_n||0)}),t.jsx("span",{className:"st"+(h.published?" on":""),children:h.published?o.rsPub:o.rsPriv})]},h.id))]}),s&&t.jsxs("div",{className:"rsarch-one",children:[t.jsxs("div",{className:"rsarch-sub",children:[s.source_url&&t.jsx("a",{href:s.source_url,target:"_blank",rel:"noopener noreferrer",children:o.rsSource}),s.published&&s.page_url&&t.jsx("a",{href:s.page_url,target:"_blank",rel:"noopener noreferrer",children:o.rsLink}),t.jsx("span",{className:"st"+(s.published?" on":""),children:s.published?o.rsPub:o.rsPriv})]}),u&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchLoading}),!u&&!p&&t.jsx("p",{className:"rsarch-msg",children:o.rsArchGone}),!u&&p&&t.jsx(ml,{card:p,onEvaluate:a,onAddAll:r})]})]})}const wa=/^(https?:\/\/)?([\w-]+\.)+[a-z]{2,}(\/\S*)?$/i;function hl(){const{t:e,mode:a,token:r,email:n,askEvaluate:i,sessTally:o,dispatch:l,evalBusy:c,evalCards:d,caps:f,data:s,canWrite:x,source:p,dossiers:g,doAnalyse:u,liveMemos:b,pipe:v}=B(),h=a==="client",j=m.useMemo(()=>r||(p!=="default"?Do():""),[r,p]),[E,y]=m.useState(""),[A,T]=m.useState(!1),[z,S]=m.useState(!1),[C,N]=m.useState(""),[R,$]=m.useState(!1),[L,M]=m.useState(""),[w,O]=m.useState([]),H=m.useRef(!1),[V,U]=m.useState(!1),[re,ee]=m.useState(""),[X,oe]=m.useState(""),[I,ae]=m.useState(!1),[pe,xe]=m.useState(0),[ge,ze]=m.useState(""),[K,W]=m.useState(null),[J,Q]=m.useState(null),[te,ye]=m.useState(!1),[de,we]=m.useState(null),[le,ue]=m.useState(0),qe=m.useRef(!1),q=E.trim()?wa.test(E.trim())?e.evalUrl:e.evalName:e.evalWaiting,F=m.useMemo(()=>C.split(`
`).map(D=>D.trim()).filter(Boolean).slice(0,15),[C]);m.useEffect(()=>{if(typeof window>"u")return;const D=new URLSearchParams(window.location.search),ne=(D.get("rs")||"").trim(),ce=(D.get("rstext")||"").trim();ne&&/^https?:\/\//i.test(ne)&&ee(ne),ce&&oe(ce),(ne&&/^https?:\/\//i.test(ne)||ce)&&U(!0)},[]),m.useEffect(()=>{const D=ne=>{const ce=ne.detail||{},be=String(ce.url||"").trim(),De=String(ce.text||"").trim();be&&/^https?:\/\//i.test(be)&&ee(be),De&&oe(De),(be&&/^https?:\/\//i.test(be)||De)&&U(!0)};return window.addEventListener("ppmap:research",D),()=>window.removeEventListener("ppmap:research",D)},[]),m.useEffect(()=>{const D=ne=>{const ce=ne.detail||{},be=String(ce.name||"").trim();be&&(y(be),T(!0),window.setTimeout(()=>T(!1),1400))};return window.addEventListener("ppmap:prefill",D),()=>window.removeEventListener("ppmap:prefill",D)},[]),m.useEffect(()=>{if(!x&&!j){we(null);return}let D=!0;return(async()=>{const ne=await cr({email:n,cbToken:j});D&&we(ne.length)})(),()=>{D=!1}},[x,j,n,le]);const Y=w.length?w:d,Z=s.credits,Ne=m.useCallback(D=>{const ne=D.map(ce=>(ce||"").trim()).filter(Boolean);ne.length&&(N(ce=>{const be=ce.split(`
...
`)}),S(!0))},[]);m.useEffect(()=>{if(!I)return;xe(0);const D=window.setInterval(()=>xe(ne=>ne+1),1e3);return()=>window.clearInterval(D)},[I]);const me=m.useMemo(()=>{const D=E.trim().toLowerCase();return!D||!v?null:g.find(ne=>Be(ne.name)===D&&Ce(ne)===1)||null},[E,g,v]),Fe=()=>{const D=E.trim();if(D){if(me){u(me);return}i(null,D),h&&y("")}},Ge=async()=>{if(!h){i(null,F[0]||"");return}if(!F.length||R)return;$(!0),H.current=!1;const D=[];for(let ne=0;ne<F.length&&!H.current;ne++){M(e.evaluating(ne+1,F.length,F[ne]));const ce=await dr(r,F[ne],"atelier2");if(D.unshift({name:ce.company||F[ne],verdict:ce.verdict,reason:ce.reason||"",remaining:ce.remaining??null}),O([...D]),ce.verdict==="quota"){D.unshift({name:"",verdict:"quota",reason:e.quota(F.length-ne-1),remaining:0}),O([...D]),N(F.slice(ne+1).join(`
`)),M(""),$(!1);return}}M(""),N(H.current?F.slice(D.length).join(`
`):""),$(!1)},nt=async()=>{var ce,be,De;if(qe.current)return;const D=re.trim().replace(/\s+/g,""),ne=X.trim();if(!D&&!ne){ze(e.rsNeed);return}if(!h&&!j){i(null,D||ne.slice(0,80));return}qe.current=!0,ze(""),W(null),Q(null),ae(!0);try{const Te=await $o({url:D,text:ne,email:n,cbToken:j});if(ae(!1),!Te||Te.status!=="success"){ze((Te==null?void 0:Te.message)||"Erreur");return}W(Te),U(!1),Ne((((ce=Te.prospective)==null?void 0:ce.companies_to_evaluate)||[]).map($e=>($e==null?void 0:$e.name)||"")),Q({state:"pending"});const ke=await Bo(Te,{email:n,cbToken:j});Q(ke.ok?{state:"ok",scopeLabel:((be=ke.summary)==null?void 0:be.scope_label)||"",scope:((De=ke.summary)==null?void 0:De.scope)||""}:{state:"fail",msg:ke.error||""}),ke.ok&&ue($e=>$e+1)}finally{qe.current=!1,ae(!1)}},mt=[K==null?void 0:K.industry,...(K==null?void 0:K.market_tags)||[],K==null?void 0:K.author].map(D=>(D||"").trim()).filter(Boolean),Pe=(J==null?void 0:J.state)==="pending",jt=J&&(Pe?t.jsx("span",{className:"rslink pend",children:e.rsSaving}):J.state==="ok"?t.jsx("span",{className:"rslink ok",children:J.scope&&J.scope!=="public"?e.rsSavedIn(J.scopeLabel||J.scope.replace(/^fund:/,"")):e.rsSaved}):t.jsx("span",{className:"rslink fail",title:J.msg,children:e.rsSaveFail})),rt=ul(K).length;return t.jsxs("div",{className:"demand",children:[t.jsxs("div",{className:"drow"+(A?" flash":"")+(wa.test(E.trim())?" has-url":""),children:[t.jsxs("span",{className:"dfield",children:[t.jsx("input",{value:E,placeholder:e.evalPh,autoComplete:"off",maxLength:200,onChange:D=>y(D.target.value),onKeyDown:D=>{D.key==="Enter"&&Fe()}}),t.jsx("span",{className:"detect"+(wa.test(E.trim())?" url":""),children:q})]}),t.jsxs("button",{type:"button",className:"evalbtn"+(me?" analyse":"")+(c?" loading":""),disabled:c,onClick:Fe,children:[t.jsx("span",{className:"fill"}),me?e.actAnalyse:e.evalGo]}),f.showCredits&&Z&&t.jsxs("button",{type:"button",className:"credits"+(Z.total_available<=0&&!Z.unlimited?" empty":""),onClick:()=>l({type:"modal",modal:"recharge"}),children:[t.jsx("span",{className:"cl",children:e.creditsCap}),t.jsx("b",{children:Z.unlimited?"∞":Z.total_available}),!Z.unlimited&&t.jsxs("span",{className:"cm",children:["/ ",Z.daily_grant+Z.purchased]}),Z.total_available<=0&&!Z.unlimited?t.jsx("span",{className:"rc",children:e.creditsRecharge}):t.jsx("span",{className:"cd",children:e.creditsToday})]})]}),b.items.filter(D=>D.status==="boot"||D.status==="running").map(D=>t.jsxs("div",{className:"result on memolive",children:[t.jsx("span",{className:"vv",children:t.jsxs("span",{className:"vp",children:["⚡ ",e.actAnalyse]})}),t.jsx("span",{className:"rn",children:D.name}),t.jsx(Tt,{item:D,serverOff:b.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),t.jsxs("button",{type:"button",className:"go",onClick:()=>l({type:"modal",modal:"queue"}),children:[e.liveOpenQueue," →"]})]},"live-"+D.name)),t.jsxs("div",{className:"dunder",children:[t.jsx("button",{type:"button",className:"dmulti",onClick:()=>S(!z),children:e.evalMulti}),t.jsx("button",{type:"button",className:"dmulti dsearch"+(V?" on":""),onClick:()=>U(!V),children:e.rsOpen}),de!==null&&de>0&&t.jsx("button",{type:"button",className:"dmulti darch"+(te?" on":""),onClick:()=>ye(!te),children:e.rsArchOpen(de)})]}),te&&t.jsx(xl,{bump:le,cbToken:j,onClose:()=>ye(!1),onEvaluate:D=>i(null,D),onAddAll:Ne}),V&&t.jsxs("div",{className:"rsp on",children:[t.jsxs("div",{className:"rsf",children:[t.jsx("input",{className:"rsurl",value:re,placeholder:e.rsUrlPh,autoComplete:"off",spellCheck:!1,inputMode:"url",maxLength:600,onChange:D=>ee(D.target.value),onKeyDown:D=>{D.key==="Enter"&&nt()}}),t.jsx("span",{className:"rsor",children:e.rsOr}),t.jsx("textarea",{className:"rstext",value:X,placeholder:e.rsTextPh,onChange:D=>oe(D.target.value)})]}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(I?" loading":""),style:{justifyContent:"center"},disabled:I||Pe||!re.trim()&&!X.trim(),onClick:()=>{nt()},children:[t.jsx("span",{className:"fill"}),I?`${Io(re.trim())==="youtube"&&re.trim()?e.rsRunningVid:e.rsRunning} ${e.rsElapsed(pe)}`:Pe?e.rsSaving:e.rsGo]}),t.jsx("span",{className:"hint",children:e.rsHint})]})]}),ge&&t.jsx("div",{className:"rserr",children:ge}),K&&t.jsxs("div",{className:"rscard",children:[t.jsxs("div",{className:"rsh",children:[t.jsx("b",{children:K.title}),K.source_url&&t.jsx("a",{href:K.source_url,target:"_blank",rel:"noopener noreferrer",children:e.rsSource}),t.jsx("button",{type:"button",className:"rsx",title:e.rsClose,onClick:()=>{W(null),Q(null)},children:"×"})]}),K.market&&t.jsx("p",{className:"rsmk",children:K.market}),mt.length>0&&t.jsxs("div",{className:"rstags",children:[t.jsx("em",{children:e.rsTags}),mt.map(D=>t.jsx("span",{children:D},D))]}),t.jsxs("div",{className:"rsbody",children:[K.mindmap_png_b64&&t.jsxs("figure",{className:"rsmm",children:[t.jsx("img",{src:`data:image/png;base64,${K.mindmap_png_b64}`,alt:e.rsMindmap}),t.jsx("figcaption",{children:e.rsMindmap})]}),t.jsx("div",{className:"rssum",children:_r(K.summary_md||"").map((D,ne)=>t.jsx("p",{children:D},ne))})]}),t.jsx(Ur,{card:K,onEvaluate:D=>i(null,D),onAddAll:Ne}),t.jsxs("div",{className:"rsfoot",children:[t.jsx("span",{children:e.rsFound(rt)}),jt]})]}),z&&t.jsxs("div",{className:"bulk on",children:[t.jsx("textarea",{value:C,placeholder:e.bulkPh,onChange:D=>N(D.target.value.split(`
`).slice(0,15).join(`
`))}),t.jsxs("div",{className:"side",children:[t.jsxs("button",{type:"button",className:"evalbtn"+(R?" loading":""),style:{justifyContent:"center"},disabled:R||!F.length,onClick:()=>{Ge()},children:[t.jsx("span",{className:"fill"}),R&&L?L:e.evalList]}),t.jsx("span",{className:"hint",children:e.bulkCount(F.length)})]})]}),Y.slice(0,1).map((D,ne)=>{const ce=D.verdict==="kept",be=D.verdict==="quota",De=ce?"var(--brand)":be?"var(--bolt)":"var(--red)",Te=ce?"var(--brand-l)":be?"#FEF3C7":"#FEF2F2";return t.jsxs("div",{className:"result on",style:{"--c":De,"--bgc":Te},children:[t.jsx("span",{className:"vv",children:t.jsx("span",{className:"vp",children:ce?"✓ "+e.kept:be?"⏳":"✗ "+e.dropped})}),D.name&&t.jsx("span",{className:"rn",children:D.name}),t.jsx("span",{className:"rr",children:D.reason?t.jsxs(t.Fragment,{children:[t.jsx("b",{children:e.why})," ",D.reason]}):null}),!!(D.candidates&&D.candidates.length)&&t.jsx("span",{className:"sitepick",children:D.candidates.map(ke=>t.jsxs("span",{className:"sp1",children:[t.jsxs("a",{href:ke.url.startsWith("http")?ke.url:`https://${ke.url}`,target:"_blank",rel:"nofollow noopener",children:[(ke.url||"").replace(/^https?:\/\/(www\.)?/,"").slice(0,34)," ↗"]}),t.jsx("button",{type:"button",onClick:()=>i(null,ke.url),children:e.evalPickGo})]},ke.url))}),!be&&t.jsx("button",{type:"button",className:"go",onClick:()=>{l({type:"ptab",tab:ce?1:5});const ke=(D.name||"").trim().toLowerCase();window.setTimeout(()=>{const $e=[...document.querySelectorAll(".atl2 .list .row")].find(da=>{var Dt;return(((Dt=da.querySelector(".rnm"))==null?void 0:Dt.textContent)||"").trim().toLowerCase().includes(ke)});$e&&($e.scrollIntoView({behavior:"smooth",block:"center"}),$e.classList.add("flashrow"),window.setTimeout(()=>$e.classList.remove("flashrow"),2200))},260)},children:e.seeSpace(ce?e.statusKeep.replace("✅ ",""):e.statusDrop.replace("❌ ",""))})]},ne)}),h&&(o.kept+o.dropped>0||Y.length>0)&&t.jsxs("div",{className:"tally",children:[t.jsx("span",{dangerouslySetInnerHTML:{__html:e.session(o.kept,o.dropped)}})," ","·"," ",t.jsx("a",{onClick:()=>l({type:"modal",modal:"space"}),children:e.seeMySpace})]})]})}function gl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function bl(){const{st:e,dispatch:a,byId:r,t:n,doDeep:i}=B(),o=e.memoConsole?r.get(e.memoConsole):null,l=m.useMemo(()=>o?[o.reasoning||"",gl(o.summary||"")].filter(Boolean).join(`
...
`).map((f,s)=>t.jsx("p",{style:{margin:"0 0 10px"},children:f},s)):t.jsx("p",{children:n.memoNone})}),t.jsxs("div",{className:"mf",children:[gt(o)?t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"t",children:n.memoDeepHint}),t.jsx("button",{type:"button",className:"deep",onClick:()=>i(o),children:n.memoDeep})]}):t.jsx("span",{className:"t",children:d===2?n.critMemoKinds:""}),o.memoUrl&&t.jsx("a",{className:"go",href:o.memoUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:n.memoOpenFull})]})]})})}function tn({name:e}){const{t:a,token:r,caps:n,mode:i,flashErr:o}=B(),[l,c]=m.useState(!1),[d,f]=m.useState(null),s=n.pipe&&i==="client"&&!n.lockActions,x=async()=>{if(!s||l)return;c(!0);const p=await _o(r,e);if(c(!1),!p){o(a.actErr);return}f(p.results||[])};return m.useEffect(()=>{if(!s)return;const p=g=>{var b;const u=String(((b=g.detail)==null?void 0:b.name)||"").trim();u&&u.toLowerCase()===e.toLowerCase()&&x()};return window.addEventListener("ppmap:similar",p),()=>window.removeEventListener("ppmap:similar",p)},[e,s]),m.useEffect(()=>{if(s)try{const p=(sessionStorage.getItem("pp:similar")||"").trim();p&&p.toLowerCase()===e.toLowerCase()&&(sessionStorage.removeItem("pp:similar"),x())}catch{}},[e,s]),s?t.jsxs("div",{className:"simb",onClick:p=>p.stopPropagation(),children:[t.jsx("button",{type:"button",className:"abtn",disabled:l,onClick:()=>{x()},children:l?a.similarBusy:a.similar}),d&&(d.length===0?t.jsx("p",{className:"mnote",children:a.similarNone}):t.jsxs(t.Fragment,{children:[t.jsx("ul",{className:"siml",children:d.map(p=>t.jsxs("li",{children:[t.jsx("b",{className:p.verdict==="kept"?"ok":"ko",children:p.company}),p.reason&&t.jsx("span",{children:p.reason})]},p.company))}),t.jsx("p",{className:"mnote dim",children:a.similarNote})]}))]}):null}const vl=new Set(["b","strong","i","em","u","br","p","ul","ol","li","h4","h5"]),Kt=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function yl(e){const a=String(e||"");if(!a)return"";let r="",n=0;for(;n<a.length;){const i=a.indexOf("<",n);if(i<0){r+=Kt(a.slice(n));break}r+=Kt(a.slice(n,i));const o=a.indexOf(">",i);if(o<0){r+=Kt(a.slice(i));break}const l=a.slice(i+1,o).trim(),c=/^(\/?)([a-zA-Z0-9]+)/.exec(l),d=c?c[2].toLowerCase():"";c&&vl.has(d)?r+=`<${c[1]}${d}>`:r+=Kt(a.slice(i,o+1)),n=o+1}return r}const ar=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Me({k:e,v:a,href:r}){return a==null||a===""?null:t.jsxs("div",{className:"cdl",children:[t.jsx("span",{className:"cdk",children:e}),r?t.jsx("a",{className:"cdv",href:r,target:"_blank",rel:"noopener noreferrer",children:String(a)}):t.jsx("span",{className:"cdv",children:String(a)})]})}function wl(e){return e.replace(/<style[\s\S]*?<\/style>/gi,"").replace(/<[^>]+>/g," ").replace(/\s{2,}/g," ").trim()}function kl({o:e}){const{t:a,doDeep:r}=B(),[n,i]=m.useState(!1),o=at(e),l=[e.reasoning||"",wl(e.summary||"")].filter(Boolean);return t.jsxs("div",{className:"cdmemo",children:[o&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:o}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),l.length?l.join(`

`).split(`

`).map((c,d)=>t.jsx("p",{className:"cdtxt",children:c},d)):t.jsx("p",{className:"cdtxt",children:a.memoNone}),t.jsxs("div",{className:"cdacts",children:[gt(e)&&t.jsx("button",{type:"button",className:"btn p",onClick:c=>{c.stopPropagation(),r(e)},children:a.memoDeep}),e.memoUrl&&t.jsx("button",{type:"button",className:"btn b",onClick:c=>{c.stopPropagation(),i(d=>!d)},children:n?a.memoHideHere:a.memoReadHere}),e.memoUrl&&t.jsx("a",{className:"btn d",href:e.memoUrl,target:"_blank",rel:"noopener noreferrer",onClick:c=>c.stopPropagation(),children:a.memoOpenFull})]}),n&&e.memoUrl&&t.jsx("iframe",{className:"cdembed",src:e.memoUrl,loading:"lazy",title:a.cdMemoTab,referrerPolicy:"no-referrer-when-downgrade",onClick:c=>c.stopPropagation()})]})}function an({o:e}){const{t:a,lang:r,dispatch:n,caps:i}=B(),o=Ft(e),l=at(e),c=(e.cribleStatus||"").trim().toUpperCase()||(o==="NO MATCH"?"NO MATCH":o==="MATCH"?"MATCH":""),d=[e.sector,e.stage,e.countryLabel,e.city,e.website,e.domain,e.linkedinCompany,e.angle,e.date].filter(Boolean).length,f=[e.contactName,e.contactEmail,e.contactLinkedin].filter(Boolean).length,s=[e.ceoStatus,e.ceoNote,i.pipe?e.memoUrl:"",i.pipe?e.memoPdfUrl:""].filter(Boolean).length+(typeof e.engagement=="number"&&e.engagement>0?1:0),x=m.useMemo(()=>[{k:"conv",lib:a.cdConviction,n:(c?1:0)+(e.reasoning?1:0)+(l?1:0)},{k:"ana",lib:a.cdAnalyse,n:(e.summary?1:0)+(i.pipe&&!i.lockActions?1:0)},{k:"soc",lib:a.cdSociete,n:d},{k:"ctc",lib:a.cdContact,n:f},{k:"suivi",lib:a.cdSuivi,n:s},{k:"memo",lib:a.cdMemoTab,n:e.memoUrl||e.summary||gt(e)?1:0}].filter(b=>b.n>0),[e,a,c,l,d,f,s]),[p,g]=m.useState("");if(!x.length)return null;const u=x.some(b=>b.k===p)?p:x[0].k;return t.jsxs("div",{className:"cdtabs",children:[t.jsx("div",{className:"cdnav",role:"tablist",children:x.map(b=>t.jsx("button",{type:"button",role:"tab","aria-selected":u===b.k,"data-tour":"tab-"+b.k,className:u===b.k?"on":"",onClick:v=>{v.stopPropagation(),g(b.k)},children:b.lib},b.k))}),t.jsxs("div",{className:"cdbody",onClick:b=>b.stopPropagation(),children:[u==="conv"&&t.jsxs(t.Fragment,{children:[c&&t.jsxs("div",{className:"cdv1"+(c==="NO MATCH"?" out":""),children:[t.jsx("b",{children:c==="NO MATCH"?a.vOut:a.vKept}),t.jsx("span",{className:"cdw",children:a.cdCrible})]}),e.reasoning&&t.jsx("p",{className:"cdtxt",children:e.reasoning}),l&&t.jsxs("div",{className:"cdv1 memo",children:[t.jsx("b",{children:l}),t.jsx("span",{className:"cdw",children:a.cdMemo(e.memoType||"")})]}),t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Me,{k:a.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Me,{k:a.cdVerdictDate,v:ar(e.verdictDate,r)})]})]}),u==="ana"&&t.jsxs(t.Fragment,{children:[e.summary&&t.jsx("div",{className:"cdrich",dangerouslySetInnerHTML:{__html:yl(e.summary)}}),i.pipe&&!i.lockActions&&t.jsx(jl,{o:e})]}),u==="soc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdSector,v:e.sector}),t.jsx(Me,{k:a.cdStage,v:e.stage}),t.jsx(Me,{k:a.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Me,{k:a.cdSite,v:e.domain||e.website,href:e.website||void 0}),t.jsx(Me,{k:a.cdLinkedin,v:e.linkedinCompany?"LinkedIn":"",href:e.linkedinCompany}),t.jsx(Me,{k:a.cdAngle,v:e.angle}),t.jsx(Me,{k:a.cdDetected,v:ar(e.date,r)})]}),u==="ctc"&&t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdName,v:e.contactName}),t.jsx(Me,{k:a.cdEmail,v:e.contactEmail,href:e.contactEmail?`mailto:${e.contactEmail}`:void 0}),t.jsx(Me,{k:a.cdLinkedin,v:e.contactLinkedin?"LinkedIn":"",href:e.contactLinkedin})]}),u==="memo"&&t.jsx(kl,{o:e}),u==="suivi"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"cdgrid",children:[t.jsx(Me,{k:a.cdCeoStatus,v:e.ceoStatus}),t.jsx(Me,{k:a.cdEngagement,v:typeof e.engagement=="number"&&e.engagement>0?e.engagement:""})]}),e.ceoNote&&t.jsxs("p",{className:"cdtxt",children:["💬 ",e.ceoNote]}),i.pipe&&(e.memoUrl||e.memoPdfUrl)&&t.jsxs("div",{className:"cdacts",children:[e.memoUrl&&t.jsxs("button",{type:"button",className:"abtn",onClick:()=>n({type:"memoConsole",id:e.id}),children:[a.actMemo," →"]}),e.memoPdfUrl&&t.jsx("a",{className:"abtn",href:e.memoPdfUrl,target:"_blank",rel:"noopener noreferrer",children:"PDF ↗"})]})]})]})]})}function jl({o:e}){const{t:a,token:r}=B(),[n,i]=m.useState(!1),[o,l]=m.useState(null),c=async()=>{n||(i(!0),l(await Uo(r,e.name,e.website||e.domain||"")),i(!1))},d=(o==null?void 0:o.blocs)||{},f=[[a.qaVP,d.value_prop],[a.qaProduct,d.produit],[a.qaModel,d.modele],[a.qaSummary,d.synthese]],s=f.some(([,x])=>x);return t.jsxs("div",{className:"qab",children:[!o&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"mnote dim",children:a.qaHint}),t.jsx("button",{type:"button",className:"abtn",disabled:n,onClick:()=>{c()},children:n?a.qaBusy:a.qaRun})]}),o&&s&&t.jsxs(t.Fragment,{children:[f.filter(([,x])=>x).map(([x,p])=>t.jsxs("div",{className:"qal",children:[t.jsx("span",{className:"qak",children:x}),t.jsx("p",{children:p})]},x)),!!(o.pages||[]).length&&t.jsx("p",{className:"mnote dim",children:a.qaSources((o.pages||[]).length)})]}),o&&!s&&t.jsx("p",{className:"mnote warn",children:o.quota?a.qaQuota:a.qaEmpty})]})}function Pt({spec:e}){const a=m.useRef(null),r=m.useRef(null),[n,i]=m.useState(!1);return m.useEffect(()=>{const o=a.current;if(!o)return;let l=!1;const c=()=>{const f=Math.max(280,Math.min(560,o.clientWidth||320));vn({kind:"op",card:e},f).then(s=>{!l&&s&&o.isConnected&&o.replaceChildren(s)})},d=window.requestAnimationFrame(c);return()=>{l=!0,window.cancelAnimationFrame(d),o.replaceChildren()}},[e]),m.useEffect(()=>{if(!n)return;const o=r.current;if(!o)return;let l=!1;vn({kind:"op",card:e},Math.min(1100,Math.floor(window.innerWidth*.92))).then(d=>{!l&&d&&o.isConnected&&o.replaceChildren(d)});const c=d=>{d.key==="Escape"&&i(!1)};return document.addEventListener("keydown",c),()=>{l=!0,document.removeEventListener("keydown",c)}},[n,e]),t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:a,className:"zoom-card-host",title:"Agrandir",onClick:()=>i(!0)}),n&&yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsxs("div",{className:"atl2-lb",onClick:()=>i(!1),children:[t.jsx("div",{ref:r,style:{lineHeight:0}}),t.jsx("button",{type:"button",className:"atl2-lb-x","aria-label":"Fermer",onClick:()=>i(!1),children:"×"})]})}),document.body)]})}const Nl=`
...
`;function Sl(e,a=!1){if(!e||typeof window>"u")return;const r=352,n=a?620:430,i=window.innerWidth,o=window.innerHeight,l=Math.min(Math.max(e.x-r/2,8),Math.max(8,i-r-8));let c=e.y+10;return c+n>o-8&&(c=Math.max(8,e.y-n-14)),c<8&&(c=8),{left:l,top:c}}function El(){const{st:e,dispatch:a,byId:r,t:n,lang:i,caps:o,mode:l,askEvaluate:c,doAnalyse:d,doDecide:f,doPromote:s,doRepeche:x,doApproach:p,doDeep:g,doOnboard:u,outbound:b,evalBusy:v}=B(),h=e.popupId?r.get(e.popupId):null;if(!h)return null;const j=Ae(h),E=Ce(h),y=at(h),A=Ft(h),T=h.kind==="target",z=S=>{a({type:"filters",patch:S}),a({type:"popup",id:null})};return yt.createPortal(t.jsxs("div",{className:"atl2",children:[t.jsx("style",{children:Nl}),t.jsx("div",{className:"atl2-pop-veil",onClick:()=>a({type:"popup",id:null})}),t.jsxs("div",{className:"pop on "+(e.popupAnchor?"atl2-pop-fix":"atl2-pop-center"),style:Sl(e.popupAnchor,!!h.card),onClick:S=>S.stopPropagation(),children:[t.jsxs("div",{className:"ph",children:[t.jsxs("div",{style:{flex:1},children:[t.jsx("h3",{children:h.name}),t.jsx("span",{className:"id",children:n.detected(n.daysAgo(tt(h.date)),He(h.engine,i))})]}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"popup",id:null}),children:"×"})]}),t.jsxs("div",{className:"pb",children:[t.jsxs("div",{className:"tags",children:[h.cc&&t.jsx("button",{type:"button",className:"hi",onClick:()=>z({country:[h.cc]}),children:(wt(h.cc,i)||h.countryLabel||"").toUpperCase()}),h.sector&&t.jsx("button",{type:"button",onClick:()=>z({sector:[h.sector]}),children:h.sector.toUpperCase()}),h.stage&&t.jsx("button",{type:"button",onClick:()=>z({stage:[h.stage]}),children:h.stage.toUpperCase()}),typeof h.amountEur=="number"&&h.amountEur>0&&t.jsx("span",{className:"am2",children:kt(h.amountEur,i)})]}),o.pipe&&T&&t.jsxs("div",{className:"pstat",children:[A&&t.jsx("span",{className:"vd "+(A==="MATCH"?"v-ok":"v-no"),title:n.vt[A],children:A}),y&&t.jsx("span",{className:"vd v-cons",title:n.vt[y],children:y}),t.jsx("span",{className:"pstep",children:n.plabels[E]}),h.ceoStatus&&t.jsx("span",{className:"pstep own",children:h.ceoStatus})]}),(h.tagline||h.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:h.tagline||h.headline})]}),t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.how}),t.jsxs("p",{children:[lt(h.engine)," ",t.jsx("b",{children:He(h.engine,i)})," — ",Vo(h.engine,i),h.noteTitle&&t.jsxs(t.Fragment,{children:[" · ",h.noteTitle]})]}),j?t.jsxs("p",{className:"psig",style:{marginTop:9},children:[t.jsx(pt,{o:h,lg:!0})," ",t.jsx(ca,{o:h,src:!0}),t.jsxs("span",{className:"pdate",style:{display:"block",marginTop:5},children:[n.signaledOn(Ga(j,i))," · ",n.win7(Xt(j,i))]})]}):t.jsx("p",{className:"pnos",style:{marginTop:5},children:n.noSignal})]}),h.card?t.jsx(Pt,{spec:h.card}):null,h.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:o.pipe&&E>=1?n.verdictCap:n.memo}),t.jsx("p",{className:"memo",children:h.reasoning})]}),o.pipe&&T&&y&&t.jsx("div",{className:"fld",children:t.jsxs("p",{style:{fontWeight:700},children:[y,typeof h.score=="number"&&h.score>0?" · "+n.score(h.score):""]})}),o.pipe&&T&&t.jsx(an,{o:h})]}),t.jsx(tn,{name:h.name}),t.jsxs("div",{className:"pf",children:[o.lockActions||l!=="client"&&o.pipe?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>a({type:"modal",modal:"rdv"}),children:[t.jsx("span",{className:"fill"}),"🔒 ",n.lockbarCta]}):o.pipe?t.jsxs(t.Fragment,{children:[E===0&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>c(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)]}),E===1&&t.jsxs("button",{type:"button",className:"evalbtn memo",style:{flex:1,justifyContent:"center"},onClick:()=>{d(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actAnalyse]}),E===2&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{s(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actPromote]}),E===3&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{f(h,!0),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actYes]}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{f(h,!1),a({type:"popup",id:null})},children:n.actNo}),gt(h)&&t.jsx("button",{type:"button",className:"abtn",title:n.memoDeepHint,onClick:()=>{g(h),a({type:"popup",id:null})},children:n.memoDeep})]}),E===4&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{p(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actApproach]}),E===5&&t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{x(h),a({type:"popup",id:null})},children:[t.jsx("span",{className:"fill"}),n.actRepeche]}),h.memoUrl&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{a({type:"memoConsole",id:h.id}),a({type:"popup",id:null})},children:"📄"}),b&&t.jsx("button",{type:"button",className:"abtn",title:n.actOnboardTitle,onClick:()=>{u(h),a({type:"popup",id:null})},children:"🚀"})]}):h.engine==="media"&&h.url&&o.showDemand?t.jsxs(t.Fragment,{children:[t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},onClick:()=>{var S;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:h.url}}))}catch{}a({type:"popup",id:null}),(S=document.querySelector(".atl2 .demand"))==null||S.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rsOpen]}),t.jsx("button",{type:"button",className:"abtn",disabled:v,title:n.evalGoOn(h.name),onClick:()=>c(h),children:"⚡"})]}):t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center"},disabled:v,onClick:()=>c(h),children:[t.jsx("span",{className:"fill"}),n.evalGoOn(h.name.length>22?h.name.slice(0,21)+"…":h.name)," →"]}),h.website&&t.jsx("a",{className:"psite",href:h.website.startsWith("http")?h.website:"https://"+h.website,target:"_blank",rel:"noopener noreferrer",title:h.website,children:"🌐"})]})]})]}),document.body)}const Cl={fr:{nlK:"Recevoir l’édition du matin",nlS:"M&A et levées, chaque jour, selon vos critères.",nlCta:"S’abonner",nlAll:"Par secteur →",tgK:"Découvrir mes cibles",tgS:"Stan part de votre site — 10 premières cibles.",tgPh:"votresite.com",tgCta:"Découvrir mes cibles"},en:{nlK:"Get the morning edition",nlS:"Daily M&A and raises, on your criteria.",nlCta:"Subscribe",nlAll:"By sector →",tgK:"Discover my targets",tgS:"Stan starts from your site — first 10 targets.",tgPh:"yoursite.com",tgCta:"Discover my targets"}};function zl(){const{lang:e}=pr(),a=Cl[e==="en"?"en":"fr"],[r,n]=m.useState(""),[i,o]=m.useState(""),{state:l,errMsg:c,submit:d,copy:f}=Ho("general");return t.jsxs("div",{className:"ckdock",children:[t.jsxs("form",{className:"ckdock-row",noValidate:!0,onSubmit:async s=>{s.preventDefault(),await d(r,i)&&n("")},children:[t.jsxs("div",{className:"ckdock-k",children:[t.jsx("b",{children:a.nlK}),t.jsx("span",{children:a.nlS})]}),t.jsxs("div",{className:"ckdock-act",children:[t.jsx("input",{type:"email",required:!0,value:r,placeholder:f.placeholder,"aria-label":f.placeholder,onChange:s=>n(s.target.value)}),t.jsx("input",{type:"text",name:"website",value:i,tabIndex:-1,autoComplete:"off","aria-hidden":"true",className:"ckdock-hp",onChange:s=>o(s.target.value)}),t.jsx("button",{type:"submit",disabled:l==="sending",children:l==="sending"?f.sending:a.nlCta}),t.jsx("a",{href:"/actualites/operations/secteurs/",children:a.nlAll})]}),(l==="ok"||l==="err")&&t.jsx("p",{className:"ckdock-msg"+(l==="err"?" err":""),children:l==="ok"?f.ok:c})]}),t.jsxs("div",{className:"ckdock-row",children:[t.jsxs("div",{className:"ckdock-k",children:[t.jsx("b",{children:a.tgK}),t.jsx("span",{children:a.tgS})]}),t.jsx("div",{className:"ckdock-act ckdock-site",children:t.jsx(Wo,{placeholder:a.tgPh,cta:a.tgCta})})]})]})}const Al=8;function Tl(){const{t:e,lang:a,token:r,dossiers:n,caps:i,markRow:o,dispatch:l}=B(),[c,d]=m.useState(!1),[f,s]=m.useState(!1),[x,p]=m.useState(!1),g=`atl2:sincemini:${r||"home"}`,[u,b]=m.useState(()=>{try{return localStorage.getItem(g)==="1"}catch{return!1}}),v=()=>{b(S=>{try{localStorage.setItem(g,S?"0":"1")}catch{}return!S})},h=r||"home",{names:j,verdicts:E}=m.useMemo(()=>{const S=[],C={};return n.forEach(N=>{N.kind!=="target"||!N.name||(S.push(N.name),C[N.name]=Yo(N)||"")}),{names:S,verdicts:C}},[n]),y=m.useMemo(()=>j.length?Go(h,j,E,a):null,[h,j.length]);if(!i.pipe||c||!y||y.firstVisit||!y.added.length&&!y.gone.length)return null;const A=f?y.added:y.added.slice(0,Al),T=y.added.length-A.length,z=S=>{const C=n.find(N=>N.name===S);C&&(o(C.id),l({type:"popup",id:C.id}))};return t.jsxs("div",{className:"since"+(u?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsxs("span",{className:"t",children:["✨ ",e.sinceTitle(y.added.length,y.lastDate)]}),t.jsx("span",{className:"s",children:e.sinceSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!u,title:u?e.boxExpand:e.boxCollapse,onClick:v,children:u?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x","aria-label":e.tourClose,title:e.tourClose,onClick:()=>{d(!0),Ko(h,j,E,y.fp,a)},children:"×"})]}),!!y.added.length&&t.jsxs("div",{className:"sg-c",children:[A.map(S=>t.jsx("button",{type:"button",className:"sg-chip",onClick:()=>z(S),children:t.jsx("b",{children:S})},S)),T>0&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>s(!0),children:e.sinceMore(T)})]}),!!y.gone.length&&t.jsxs("div",{className:"sg-c",children:[t.jsx("button",{type:"button",className:"sg-more",onClick:()=>p(S=>!S),children:e.sinceOut(y.gone.length)}),x&&y.gone.slice(0,20).map(S=>t.jsx("span",{className:"gone",children:S},S))]})]})}const Vr={"CALL PENDING":"call","CALL YES":"v-yes","CALL NO":"v-no2",CONSIDER:"v-cons",MONITOR:"v-mon",PASS:"v-pass"};function nn({o:e,locked:a=!1}){const{t:r}=B(),n=Ft(e),i=at(e),o=Ce(e),l=Na(e),c=Jo(e);return t.jsxs("span",{className:"c-vd",children:[n?t.jsx("span",{className:"vd "+(n==="MATCH"?"v-ok":"v-no"),title:r.vt[n],children:n}):t.jsx("span",{className:"vd wait",children:r.actToEval}),i?t.jsx("span",{className:"vd "+(Vr[i]||"v-cons"),title:r.vt[i],children:i}):o===1?t.jsx("span",{className:"vd wait",children:r.actMemoQueue}):null,o===3&&l==="auto"&&t.jsx("span",{className:"org au",title:r.orgAutoTitle,children:r.orgAuto}),o===3&&l==="cd"&&t.jsx("span",{className:"org cd",title:r.orgCdTitle,children:r.orgCd}),o===3&&c!==null&&t.jsx("span",{className:"wait2 "+(c>10?"hot":c>=5?"warm":""),title:r.waitTitle(c),children:r.waitChip(c)}),!a&&t.jsx(rs,{o:e})]})}const Ot=e=>e.length>22?e.slice(0,21)+"…":e;function nr({o:e}){const{t:a,askEvaluate:r,evalBusy:n,lang:i}=B(),[o,l]=m.useState(!1);if(m.useEffect(()=>{n||l(!1)},[n]),Re(e)){const f=(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("span",{className:"verdict",style:{"--c":f?"var(--brand)":"var(--red)"},title:e.reasoning||"",children:[f?"✓":"✗"," ",t.jsx("b",{children:f?a.kept:a.dropped}),typeof e.score=="number"&&e.score>0?" "+e.score:""]})}const d=o&&n;return t.jsxs("button",{type:"button",className:"rev"+(d?" loading":""),disabled:n,title:a.evalGoOn(e.name),onClick:f=>{f.stopPropagation(),l(!0),r(e)},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.evalGoOn(Ot(e.name))})]})}function rn({o:e}){const{t:a,caps:r,memoQueued:n,approachDone:i,doAnalyse:o,doDecide:l,doPromote:c,doRepeche:d,doApproach:f,dispatch:s,liveMemos:x}=B();if(r.lockActions)return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",onClick:u=>{u.stopPropagation(),s({type:"modal",modal:"rdv"})},children:a.actAnalyse})});if(e.noCo)return e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):t.jsx("span",{className:"cell"});if(!r.pipe)return e.noCo&&e.url?t.jsx("span",{className:"cell",children:t.jsxs("button",{type:"button",className:"rev",title:a.rsOpen,onClick:u=>{var b;u.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(b=document.querySelector(".atl2 .demand"))==null||b.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),t.jsx("span",{className:"lbl",children:a.rowExtract})]})}):e.noCo?t.jsx("span",{className:"cell"}):t.jsx("span",{className:"cell",children:t.jsx(nr,{o:e})});const p=Ce(e),g=u=>b=>{b.stopPropagation(),u()};if(p===0)return t.jsx("span",{className:"cell",children:t.jsx(nr,{o:e})});if(p===1){const u=x.liveOf(e.name);if(u&&(u.status==="boot"||u.status==="running"))return t.jsx("span",{className:"cell",children:t.jsx(Tt,{item:u,serverOff:x.serverOff,bootLbl:a.liveBoot,endLabel:a.liveEnd})});const b=n.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"memobtn",disabled:b,onClick:g(()=>o(e)),children:b?a.actAnalyseQueued:a.actAnalyse})})}if(p===3)return t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"ynb oui",title:a.actYesTitle,onClick:g(()=>l(e,!0)),children:a.actYes}),t.jsx("button",{type:"button",className:"ynb non",title:a.actNoTitle,onClick:g(()=>l(e,!1)),children:a.actNo}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})});if(p===4){const u=i.has(e.id);return t.jsx("span",{className:"cell",children:t.jsx("button",{type:"button",className:"approach",disabled:u,onClick:g(()=>f(e)),children:u?a.actApproachSent:a.actApproach})})}return p===2?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>c(e)),children:a.actPromote}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):p===5?t.jsx("span",{className:"cell",children:t.jsxs("span",{className:"yn",children:[t.jsx("button",{type:"button",className:"promo",onClick:g(()=>d(e)),children:a.actRepeche}),e.memoUrl&&t.jsx("button",{type:"button",className:"memobtn read sm",title:a.actMemo,onClick:g(()=>s({type:"memoConsole",id:e.id})),children:"📄"})]})}):t.jsx("span",{className:"cell",children:e.memoUrl?t.jsx("button",{type:"button",className:"memobtn read",onClick:g(()=>s({type:"memoConsole",id:e.id})),children:a.actMemo}):t.jsx("span",{className:"rc",children:"—"})})}function ql({o:e}){const{t:a,doThumb:r,thumbOf:n}=B(),i=n(e);return t.jsxs("span",{className:"thu",children:[t.jsx("button",{type:"button",className:"tb up"+(i==="yes"?" on":""),title:a.thumbUp,onClick:o=>{o.stopPropagation(),r(e,!0)},children:"👍"}),t.jsx("button",{type:"button",className:"tb dn"+(i==="no"?" on":""),title:a.thumbDn,onClick:o=>{o.stopPropagation(),r(e,!1)},children:"👎"})]})}function Ll({o:e}){const{lang:a}=B();return Ae(e)?t.jsxs("span",{className:"c-sig",children:[t.jsx(pt,{o:e}),t.jsx(ca,{o:e,src:!0})]}):t.jsx("span",{className:"c-sig",children:t.jsxs("span",{className:"mo",children:[lt(e.engine||"")," ",He(e.engine||"",a)]})})}function Ml({o:e,locked:a,open:r,onToggle:n,selected:i,onSelect:o}){const{dispatch:l,caps:c,markRow:d,markedId:f,favIds:s,toggleFav:x,t:p}=B(),g=Ce(e),u=["#0F172A","#475C6E","#8798A8","#B9C6D2"],b=e.date?Math.max(0,Math.floor((Date.now()-Date.parse(e.date))/864e5)):9999,v=b<=0?0:b<=7?1:b<=30?2:3,h=c.pipe&&e.kind==="target"?["#94A3B8","#9BD1B4","#5FB98C","#2E9A66","#0A6B3D","#E2A5A5"][g]:u[v],j=s.has(e.id),E=y=>{if(a)return;if(o){o(e.id);return}if(c.pipe||e.kind==="op"){n();return}const A=y.currentTarget.getBoundingClientRect();l({type:"popup",id:e.id,anchor:{x:A.left+Math.min(280,A.width/3),y:A.bottom}})};return t.jsxs(m.Fragment,{children:[t.jsxs("div",{className:"row"+(f===e.id||r||i?" on":"")+(r?" open":"")+(i?" sel":"")+(a?" tzr":""),"aria-selected":i||void 0,onMouseEnter:()=>d(e.id),onMouseLeave:()=>d(null),onClick:E,children:[t.jsx("span",{className:"pt",style:{"--c":h}}),t.jsx(Gr,{o:e}),t.jsxs("span",{className:"nd",children:[t.jsxs("span",{className:"rnm"+(a?" nmx":""),title:a?void 0:e.name,children:[c.pipe&&t.jsx("button",{type:"button",className:"tb",title:"★",style:{border:0,background:"none",cursor:"pointer",opacity:j?1:.35,padding:0,marginRight:4},onClick:y=>{y.stopPropagation(),x(e)},children:j?"★":"☆"}),e.name]}),t.jsx("span",{className:"rds",title:e.tagline||e.headline||"",children:[e.tagline,e.headline,e.reasoning].find(y=>y&&y!==e.name)||""}),e.acquirer&&t.jsxs("button",{type:"button",className:"racq",title:p.acqSee(e.acquirer),onClick:y=>{y.stopPropagation(),l({type:"acquirer",value:e.acquirer||""})},children:["← ",Ot(e.acquirer)]}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),t.jsx(Rl,{o:e}),t.jsx("span",{className:"c-stade",children:e.stage||""}),t.jsx(Ll,{o:e}),c.pipe&&t.jsx(nn,{o:e,locked:a}),c.pipe&&t.jsxs("span",{className:"c-sc",children:[typeof e.score=="number"?e.score:"",typeof e.score=="number"&&t.jsx("s",{children:"/100"})]}),t.jsx(rn,{o:e}),c.showThumbs&&t.jsx(ql,{o:e})]}),r&&!a&&!o&&t.jsx(Dl,{o:e})]})}function Rl({o:e}){const{lang:a,caps:r}=B();if(r.pipe&&e.kind==="target")return t.jsx("span",{className:"c-amt none",children:"—"});const n=kt(e.amountEur,a);return t.jsx("span",{className:"c-amt"+(n?"":" none"),children:n||"—"})}function Ol({o:e}){const{t:a,lang:r,askEvaluate:n,evalBusy:i,dispatch:o}=B(),l=(p,g=!1)=>u=>{u.stopPropagation(),g&&o({type:"continent",key:"monde"}),o({type:"filters",patch:p})},c=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,40):""})(),d=kt(e.amountEur,r),f=(e.date||"").slice(0,10).split("-").reverse().join("/"),s=Re(e),x=s&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"card ops-open",children:[t.jsxs("div",{className:"oc-main",children:[e.decryptHtml?t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}):t.jsx("p",{className:"oc-head",children:e.headline||e.tagline||e.name}),t.jsxs("div",{className:"oc-meta",children:[e.sector&&t.jsx("button",{type:"button",onClick:l({sector:[e.sector]}),children:e.sector}),e.countryLabel&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:l({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:l({stage:[e.stage]}),children:e.stage}),d&&t.jsx("span",{className:"oc-amt",children:d}),f&&t.jsx("span",{children:f})]}),t.jsxs("div",{className:"oc-acts",children:[s?t.jsxs("span",{className:"verdict",style:{"--c":x?"var(--brand)":"var(--red)"},children:[x?"✓":"✗"," ",t.jsx("b",{children:x?a.kept:a.dropped})]}):e.noCo||e.engine==="media"&&e.url?t.jsxs(t.Fragment,{children:[e.url&&t.jsx("button",{type:"button",className:"oc-cta",onClick:p=>{var g;p.stopPropagation();try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:e.url}}))}catch{}(g=document.querySelector(".atl2 .demand"))==null||g.scrollIntoView({behavior:"smooth",block:"center"})},children:a.rowExtract}),!e.noCo&&t.jsx("button",{type:"button",className:"oc-ghost",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Ot(e.name))})]}):t.jsx("button",{type:"button",className:"oc-cta",disabled:i,onClick:p=>{p.stopPropagation(),n(e)},children:a.evalGoOn(Ot(e.name))}),e.url&&t.jsxs("a",{className:"oc-src",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(r==="fr"?"lire la source":"read the source")+(c?` · ${c}`:"")," ↗"]})]})]}),e.card&&t.jsx("div",{className:"oc-side",children:t.jsx(Pt,{spec:e.card})})]})}function Fl({o:e}){const{t:a,lang:r,caps:n,dispatch:i}=B();if(!e)return t.jsx("p",{className:"readpane-empty",children:r==="fr"?"Cliquez une ligne — le dossier s’ouvre ici, sans quitter la liste.":"Click a row — the file opens here, without leaving the list."});const o=(e.date||"").slice(0,10).split("-").reverse().join("/");return t.jsxs("div",{className:"zoom zoom-pipe",children:[t.jsxs("div",{className:"zoom-k",children:[He(e.engine||"",r),o?` · ${o}`:""]}),t.jsx("h3",{className:"zoom-h",children:e.name}),(e.sector||e.countryLabel||e.stage)&&t.jsxs("div",{className:"zoom-meta",children:[e.sector?t.jsx("span",{children:e.sector}):null,e.countryLabel?t.jsx("span",{children:e.countryLabel}):null,e.stage?t.jsx("span",{children:e.stage}):null]}),t.jsx("div",{className:"zoom-cta",children:n.lockActions?t.jsx("button",{type:"button",className:"oc-cta",onClick:()=>i({type:"modal",modal:"rdv"}),children:a.lockbarCta}):t.jsx(rn,{o:e})}),t.jsx(an,{o:e})]})}function Pl({o:e,extra:a}){const{t:r,lang:n,askEvaluate:i,evalBusy:o,dispatch:l,caps:c}=B(),d=((e==null?void 0:e.name)||(a==null?void 0:a.name)||"").trim(),f=((e==null?void 0:e.url)||(a==null?void 0:a.url)||"").trim(),s=(e==null?void 0:e.headline)||(e==null?void 0:e.tagline)||(a==null?void 0:a.headline)||d,x=(e==null?void 0:e.card)||(a==null?void 0:a.card),p=e?!!e.noCo:!d||la(d),g=(e==null?void 0:e.engine)||"",u=e?kt(e.amountEur,n):"",b=((e==null?void 0:e.date)||"").slice(0,10).split("-").reverse().join("/"),v=(()=>{const z=/https?:\/\/(?:www\.)?([^/]+)/.exec(f);return z?z[1].replace(/^www\./,"").slice(0,40):""})(),h=(z,S=!1)=>C=>{C.stopPropagation(),S&&l({type:"continent",key:"monde"}),l({type:"filters",patch:z})};if(!e&&!a)return t.jsx("p",{className:"readpane-empty",children:n==="fr"?"Cliquez une ligne, un pin ou le ticker — le dossier s’ouvre ici.":"Click a row, a pin or the ticker — the file opens here."});const j=()=>{d&&(l({type:"continent",key:"monde"}),l({type:"filters",patch:{search:d}}))},E=()=>{e!=null&&e.sector&&l({type:"filters",patch:{sector:[e.sector]}})},y=()=>{var z;f&&(window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:f}})),(z=document.querySelector(".atl2 .demand"))==null||z.scrollIntoView({behavior:"smooth",block:"center"}))},A=e?Re(e):!1,T=A&&e&&(e.verdict||"").toUpperCase()!=="NO MATCH";return t.jsxs("div",{className:"zoom",children:[t.jsxs("div",{className:"zoom-k",children:[g?He(g,n):n==="fr"?"Dossier":"File",b?` · ${b}`:"",e!=null&&e.decryptHtml?n==="fr"?" · Edito du jour":" · Today's editorial":""]}),t.jsx("h3",{className:"zoom-h",children:s}),(e==null?void 0:e.decryptHtml)&&t.jsx("div",{className:"ed-decrypt-b zoom-body",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),f&&t.jsxs("a",{className:"zoom-src",href:f,target:"_blank",rel:"nofollow noopener",onClick:z=>z.stopPropagation(),children:[r.zoomSrc,v?` · ${v}`:""," ↗"]}),t.jsxs("div",{className:"zoom-meta",children:[(e==null?void 0:e.sector)&&t.jsx("button",{type:"button",onClick:h({sector:[e.sector]}),children:e.sector}),(e==null?void 0:e.countryLabel)&&e.countryLabel!=="Europe"&&(e.cc?t.jsx("button",{type:"button",onClick:h({country:[e.cc]},!0),children:e.countryLabel}):e!=null&&e.countryLabel?t.jsx("span",{children:e.countryLabel}):null),(e==null?void 0:e.stage)&&t.jsx("button",{type:"button",onClick:h({stage:[e.stage]}),children:e.stage}),u&&t.jsx("span",{className:"oc-amt",children:u})]}),t.jsxs("div",{className:"zoom-cta",children:[A?t.jsxs("span",{className:"verdict",style:{"--c":T?"var(--brand)":"var(--red)"},children:[T?"✓":"✗"," ",t.jsx("b",{children:T?r.kept:r.dropped})]}):!p&&d?t.jsx("button",{type:"button",className:"oc-cta",disabled:o,onClick:z=>{z.stopPropagation(),i(e,d)},children:r.evalGoOn(Ot(d))}):null,f&&(p||g==="media")&&t.jsx("button",{type:"button",className:"oc-ghost",onClick:z=>{z.stopPropagation(),y()},children:r.rowExtract}),!p&&(e==null?void 0:e.sector)&&!c.pipe&&t.jsx("button",{type:"button",className:"oc-ghost",onClick:z=>{z.stopPropagation(),E()},children:r.zoomSimilar}),!p&&d&&t.jsx("button",{type:"button",className:"oc-ghost",onClick:z=>{z.stopPropagation(),j()},children:r.zoomInCockpit}),!p&&d&&c.pipe&&t.jsx(tn,{name:d})]}),x&&t.jsx("div",{className:"zoom-card",children:t.jsx(Pt,{spec:x})})]})}function Dl({o:e}){const{t:a,lang:r,dispatch:n,caps:i,outbound:o,doOnboard:l}=B();return!i.pipe&&e.kind==="op"?t.jsx(Ol,{o:e}):t.jsxs("div",{className:"card",style:{display:"grid"},children:[t.jsxs("div",{children:[e.tagline&&t.jsx("p",{className:"lead",children:e.tagline}),e.decryptHtml&&t.jsx("div",{className:"ed-decrypt-b",dangerouslySetInnerHTML:{__html:e.decryptHtml}}),t.jsx(an,{o:e}),t.jsx(os,{o:e}),t.jsx(ls,{o:e}),t.jsx(tn,{name:e.name}),t.jsxs("div",{className:"tg",children:[e.sector&&t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"filters",patch:{sector:[e.sector]}})},children:e.sector}),e.stage&&t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"filters",patch:{stage:[e.stage]}})},children:e.stage}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:c=>{c.stopPropagation(),n({type:"continent",key:"monde"}),n({type:"filters",patch:{country:[e.cc]}})},children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.city&&t.jsx("span",{children:e.city})]})]}),t.jsxs("div",{className:"cside",children:[t.jsxs("div",{className:"top",children:[typeof e.score=="number"&&t.jsx("span",{className:"sc3",children:e.score}),t.jsx("span",{className:"vv",children:t.jsx(nn,{o:e})})]}),e.card&&t.jsx(Pt,{spec:e.card}),t.jsxs("div",{className:"sec2",children:[t.jsxs("div",{className:"k2",children:[lt(e.engine||"")," ",He(e.engine||"",r)]}),Ae(e)&&t.jsx("div",{style:{marginTop:8},children:t.jsx(pt,{o:e})})]}),i.pipe&&(e.memoUrl||o)&&t.jsx("div",{className:"sec2 acts2",children:o&&t.jsx("button",{type:"button",className:"btn d",title:a.actOnboardTitle,onClick:()=>l(e),children:a.actOnboard})})]})]})}function Il({o:e,locked:a}){const{t:r,dispatch:n,caps:i,doDecide:o,lang:l}=B();if(!i.pipe&&e.kind==="op"){const f=kt(e.amountEur,l),s=(()=>{const p=/https?:\/\/(?:www\.)?([^/]+)/.exec(e.url||"");return p?p[1].slice(0,32):""})(),x=(p,g=!1)=>u=>{u.stopPropagation(),g&&n({type:"continent",key:"monde"}),n({type:"filters",patch:p})};return t.jsxs("div",{className:"dcard dops"+(a?" tzr":""),children:[e.card&&t.jsx("div",{className:"dimg",children:t.jsx(Pt,{spec:e.card})}),t.jsxs("div",{className:"dh",children:[t.jsx("span",{className:"dnm",title:e.name,children:e.name}),e.decryptHtml&&t.jsx("span",{className:"rdec",title:"Décryptage éditorial",children:"📖"})]}),e.headline&&e.headline!==e.name&&t.jsx("div",{className:"ddesc",children:e.headline}),t.jsxs("div",{className:"dtags",children:[e.sector&&t.jsx("button",{type:"button",onClick:x({sector:[e.sector]}),children:e.sector}),e.countryLabel&&(e.cc?t.jsx("button",{type:"button",onClick:x({country:[e.cc]},!0),children:e.countryLabel}):t.jsx("span",{children:e.countryLabel})),e.stage&&t.jsx("button",{type:"button",onClick:x({stage:[e.stage]}),children:e.stage}),f&&t.jsx("span",{className:"damt",children:f})]}),t.jsxs("div",{className:"dsig",children:[t.jsxs("span",{className:"dmo",children:[lt(e.engine||"")," ",He(e.engine||"",l)]}),Ae(e)&&t.jsx(pt,{o:e})]}),e.url&&t.jsxs("a",{className:"dsrc",href:e.url,target:"_blank",rel:"nofollow noopener",onClick:p=>p.stopPropagation(),children:[(l==="fr"?"lire la source":"read the source")+(s?` · ${s}`:"")," ↗"]}),!a&&t.jsx("div",{className:"dact",children:t.jsx(rn,{o:e})})]})}const c=Ce(e),d=["#E7EBF0","#E7F3EC","#C4E0D0","#7FC0A0","#0E8A4F","#DC2626"][c];return t.jsxs("div",{className:"dcard"+(a?" tzr":""),style:{"--c":d},children:[t.jsxs("div",{className:"dh",children:[typeof e.score=="number"&&t.jsx("span",{className:"dsc",children:e.score}),t.jsx("span",{className:"dnm",title:e.name,children:e.name})]}),t.jsxs("div",{className:"dv",children:[t.jsx(nn,{o:e}),Ae(e)&&t.jsx(pt,{o:e})]}),t.jsx("div",{className:"dmeta",children:[e.countryLabel,e.stage,e.sector].filter(Boolean).join(" · ").toUpperCase()}),(e.tagline||e.reasoning)&&t.jsx("div",{className:"ddesc",children:e.tagline||e.reasoning}),!a&&i.pipe&&c===3&&t.jsxs("div",{className:"dyn",children:[t.jsx("button",{type:"button",style:{"--c3":"#0A6B3D"},onClick:()=>o(e,!0),children:r.actYes}),t.jsx("button",{type:"button",style:{"--c3":"var(--red)"},onClick:()=>o(e,!1),children:r.actNo})]}),!a&&e.memoUrl&&t.jsxs("button",{type:"button",className:"dmemo",onClick:()=>n({type:"memoConsole",id:e.id}),children:[r.actMemo," →"]})]})}function $l(){const{t:e}=B(),[a,r]=m.useState(0);return m.useEffect(()=>{const n=window.setInterval(()=>r(i=>i+1),2400);return()=>window.clearInterval(n)},[]),t.jsxs("div",{className:"loadwait","aria-live":"polite",children:[t.jsxs("div",{className:"lw-top",children:[t.jsx("span",{className:"lw-dot"}),t.jsx("span",{className:"lw-msg",children:e.loadMsgs[a%e.loadMsgs.length]})]}),[0,1,2,3,4,5].map(n=>t.jsxs("div",{className:"lw-row",style:{"--d":`${n*.12}s`},children:[t.jsx("span",{className:"lw-c lw-c1"}),t.jsx("span",{className:"lw-c lw-c2"}),t.jsx("span",{className:"lw-c lw-c3"})]},n))]})}function Bl({counts:e}){const{st:a,dispatch:r,t:n,lang:i}=B(),o=i==="en",l=s=>n.plabels[s]||"",c=[0,1,2,3,4,5,6,7].filter(s=>s!==a.ptab&&(e[s]||0)>0),d=c.includes(0)?0:c.sort((s,x)=>(e[x]||0)-(e[s]||0))[0];if(d===void 0)return t.jsx("div",{className:"void",children:n.emptyTab});const f=e[d]||0;return t.jsxs("div",{className:"void void-empty",children:[t.jsx("b",{children:o?`No “${l(a.ptab)}” for now.`:`0 ${l(a.ptab).toLowerCase().replace(/s$/,"")} pour l’instant.`}),t.jsx("span",{children:d===0?o?`${f} ${f>1?"files are":"file is"} waiting for your screening`:`${f} dossier${f>1?"s":""} attende${f>1?"nt":""} votre évaluation`:o?`${f} ${f>1?"files":"file"} in “${l(d)}”`:`${f} dossier${f>1?"s":""} dans « ${l(d)} »`}),t.jsxs("button",{type:"button",className:"abtn",onClick:()=>r({type:"ptab",tab:d}),children:[(o?"Open ":"Ouvrir ")+l(d)," →"]})]})}function _l(){var ue,qe;const e=B(),{st:a,dispatch:r,t:n,caps:i,counts:o,scoped:l,scopedAll:c,markRow:d,lang:f,sessTally:s,data:x,dossiers:p,source:g,focusExtra:u,byId:b}=e,v=q=>i.lockRowsAfter!==null?Number.MAX_SAFE_INTEGER:g==="ops"?10:mr,[h,j]=m.useState(new Set);m.useEffect(()=>{j(new Set)},[a.ptab,a.continent]);const[E,y]=m.useState(null);m.useEffect(()=>{y(null)},[a.ptab,a.continent]);const A=q=>j(F=>{const Y=new Set(F);return Y.has(q)?Y.delete(q):Y.add(q),Y}),T=a.dens==="liste",[z,S]=m.useState("all"),[C,N]=m.useState(!1);m.useEffect(()=>{S("all"),N(!1)},[a.ptab,a.continent]),m.useEffect(()=>{if(!C)return;const q=F=>{var Y,Z;(Z=(Y=F.target)==null?void 0:Y.closest)!=null&&Z.call(Y,".atl2 .doable")||N(!1)};return document.addEventListener("click",q),()=>document.removeEventListener("click",q)},[C]);const R=xr(),$=m.useMemo(()=>{var F;const q=new Map;for(const Y of Hi(((F=R==null?void 0:R.ed)==null?void 0:F.html)||""))q.has(Y.t)||q.set(Y.t,Y.html);return q},[(ue=R==null?void 0:R.ed)==null?void 0:ue.html]),L=m.useCallback(q=>{if(q.decryptHtml)return q.decryptHtml;if(!$.size)return;const F=(q.name||"").trim().toLowerCase();if(F.length<3)return;const Y=$.get(F);if(Y)return Y;for(const[Z,Ne]of $)if(Z.includes(F)||F.includes(Z))return Ne},[$]),M=m.useMemo(()=>{let q=Qa(l,a.sort);return z==="edito"?q=q.filter(F=>!!L(F)||F.engine==="edito"||(F.id||"").startsWith("edito:")):z==="explore"?q=q.filter(F=>!!F.noCo):z==="eval"&&(q=q.filter(F=>!F.noCo)),q},[l,a.sort,z,L]),w=m.useMemo(()=>i.pipe?c.filter(q=>Ae(q)&&Qo(q)):M.filter(q=>Ae(q)&&!Re(q)),[i.pipe,c,M]),O=w.length,[H,V]=m.useState(!1),[U,re]=m.useState(!1),ee=`atl2:sigmini:${((qe=x.session)==null?void 0:qe.token)||"home"}`,[X,oe]=m.useState(()=>{try{return localStorage.getItem(ee)==="1"}catch{return!1}}),I=m.useMemo(()=>i.pipe?M:M.filter(q=>!Re(q)&&!q.noCo),[M,i.pipe]),ae=g==="ops"?M.filter(q=>q.noCo).length:0,pe=i.pipe?n.plabels[a.ptab].toLowerCase():g==="ops"?n.edLabel:a.filters.status==="retenu"?n.keptByStan:a.filters.status==="ecarte"?n.droppedByStan:n.toSend,xe=a.filters,ge=[];if(xe.day)ge.push({k:"day",lib:n.fDay(xe.day.slice(8,10)+"/"+xe.day.slice(5,7)),off:()=>r({type:"filters",patch:{day:"",win:"all"}})});else if(xe.win&&xe.win!=="all"){const q=["1","7","30"].indexOf(xe.win);q>=0&&ge.push({k:"win",lib:n.dates[q],off:()=>r({type:"filters",patch:{win:"all"}})})}const ze=q=>q.length<=2?q.join(", "):`${q.length} ${n.fSelected}`;for(const q of["sector","country","engine"]){const F=xe[q];F&&F.length&&ge.push({k:q,lib:ze(F),off:()=>r({type:"clearFacet",facet:q})})}xe.search&&ge.push({k:"search",lib:"🔍 "+xe.search,off:()=>r({type:"filters",patch:{search:""}})});const K=(q,F,Y="",Z=!1)=>t.jsxs("button",{type:"button","data-s":q,className:Y,"aria-sort":a.sort.key===q?a.sort.dir===1?"ascending":"descending":"none",style:Z?{justifyContent:"flex-end"}:void 0,onClick:()=>r({type:"sort",key:q}),children:[F,t.jsx("span",{className:"ar",children:a.sort.key===q&&a.sort.dir===1?"▴":"▾"})]},q),W=m.useMemo(()=>{if(i.pipe||a.groupBy==="none")return null;const q=new Map;M.forEach(Z=>{const Ne=Z.engine||"?";q.has(Ne)||q.set(Ne,[]),q.get(Ne).push(Z)});const F={ma:0,fundraising:1,edito:2,nominations:3,recrutements:4,media:5},Y=Sa([...q.keys()],f);return[...q.entries()].sort((Z,Ne)=>{const me=F[Z[0]]??10+Y.indexOf(Z[0]),Fe=F[Ne[0]]??10+Y.indexOf(Ne[0]);return me-Fe})},[M,i.pipe,a.groupBy,f]),J=(()=>{var F,Y;const q=W?W.flatMap(([,Z])=>Z):M;return((F=q.find(Z=>Z.decryptHtml))==null?void 0:F.id)??((Y=q[0])==null?void 0:Y.id)??null})();m.useEffect(()=>{T&&(a.focusId&&M.some(q=>q.id===a.focusId)||u||J&&r({type:"focus",id:J}))},[T,a.focusId,M,J,u,r]),m.useEffect(()=>{if(!T||!a.focusId)return;const q=document.querySelector(".atl2.ops .row.sel");q==null||q.scrollIntoView({block:"nearest"})},[T,a.focusId]);const Q=m.useMemo(()=>{if(!T||!a.focusId)return null;const q=M.find(Y=>Y.id===a.focusId)||p.find(Y=>Y.id===a.focusId)||null;if(!q)return null;const F=L(q);return F&&F!==q.decryptHtml?{...q,decryptHtml:F}:q},[T,a.focusId,M,p,L]),te=i.lockRowsAfter;let ye=0;const de=(q,F)=>{let Y=a.shown[F]||v();return q.length-Y<=4&&(Y=q.length),q.slice(0,Y).map(me=>{const Fe=te!==null&&ye>=te;ye++;const Ge=L(me),nt=Ge&&Ge!==me.decryptHtml?{...me,decryptHtml:Ge}:me,mt=me.engine==="ma"||me.engine==="fundraising",Pe=!T&&a.dens!=="maxi"&&(a.dens==="deplie"||(E?E==="open":!!Ge||g==="ops"&&mt)),jt=h.has(me.id)?!Pe:Pe;return a.dens==="maxi"?t.jsx(Il,{o:nt,locked:Fe},me.id):t.jsx(Ml,{o:nt,locked:Fe,open:jt,onToggle:()=>A(me.id),selected:T&&a.focusId===me.id,onSelect:T?rt=>{r({type:"focus",id:rt});const D=b.get(rt);D&&!D.noCo&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:D.name}}))}:void 0},me.id)})},we="list"+(a.dens==="maxi"?" maxi":a.dens==="ligne"||a.dens==="deplie"?" ligne":"")+(g==="ops"?" opsl":"")+(M.length?"":" list-empty"),le=t.jsxs(t.Fragment,{children:[W?W.map(([q,F])=>t.jsxs(m.Fragment,{children:[a.dens!=="maxi"&&t.jsxs("div",{className:"grp-h",children:[t.jsx("span",{className:"ic",children:lt(q)}),t.jsxs("span",{children:[t.jsx("span",{className:"t",children:He(q,f)}),t.jsx("div",{className:"s",children:n.grpCount(F.filter(Y=>!Re(Y)).length,F.length)})]})]}),de(F,q)]},q)):de(M,"pt"+a.ptab),x.loading&&!p.length&&t.jsx($l,{}),!M.length&&!(x.loading&&!p.length)&&(i.pipe?t.jsx(Bl,{counts:o}):t.jsx("div",{className:"void",children:n.emptyScope}))]});return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"listhead"+(a.mapFolded?" mapoff":""),children:[t.jsxs("span",{className:"main",children:[t.jsx("b",{children:M.length})," ",pe]}),t.jsx("span",{className:"dot",children:"·"}),a.mapFolded&&t.jsx(Br,{variant:"compact",mapToggle:!0}),t.jsxs("span",{className:"ctx",children:[a.mapFolded?i.pipe&&e.fund?e.fund:null:t.jsxs(t.Fragment,{children:[e.contName,i.pipe&&e.fund?" · "+e.fund:""]}),ge.map(q=>t.jsxs("button",{type:"button",className:"fpuce",title:n.filterOff,onClick:F=>{F.stopPropagation(),q.off()},children:[q.lib,t.jsx("i",{children:"×"})]},q.k)),g==="ops"&&M.length>0&&" — "+n.edSplit(M.length-ae,ae)]}),a.filters.acquirer.trim()&&t.jsxs("span",{className:"acqchip",children:["🏢 ",n.acqOn(a.filters.acquirer),t.jsx("button",{type:"button",title:n.acqClear,onClick:()=>r({type:"acquirer",value:""}),children:"✕"})]}),i.showGroupBar&&t.jsxs("span",{className:"groupbar",children:[t.jsx("span",{className:"gl",children:n.groupBy}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="engine",onClick:()=>r({type:"groupBy",groupBy:"engine"}),children:n.groupEngine}),t.jsx("button",{type:"button","aria-pressed":a.groupBy==="none",onClick:()=>r({type:"groupBy",groupBy:"none"}),children:n.groupNone})]}),a.pileMode&&t.jsx("button",{type:"button",className:"exitpile",onClick:()=>r({type:"pile",on:!1}),children:n.exitPile}),(i.showFunnel||g==="ops")&&t.jsx("span",{className:"dens",children:[["liste",n.densList],["ligne",n.densLigne],["maxi",n.densMaxi]].map(([q,F])=>t.jsxs("button",{type:"button","data-d":q,"aria-pressed":a.dens===q||q==="ligne"&&a.dens==="deplie",onClick:()=>r({type:"dens",dens:q}),children:[t.jsx("i",{children:t.jsx("em",{})}),t.jsx("b",{children:F})]},q))}),!T&&(i.showFunnel||g==="ops")&&a.dens!=="maxi"&&t.jsxs("span",{className:"foldall",children:[t.jsx("button",{type:"button","aria-pressed":E==="open",onClick:()=>{y("open"),j(new Set)},children:n.unfoldAll}),t.jsx("button",{type:"button","aria-pressed":E==="closed",onClick:()=>{y("closed"),j(new Set)},children:n.foldAllLbl})]}),(i.showFunnel||g==="ops")&&(()=>{var Y;const q=[["all",n.doAll],...g==="ops"?[["edito",n.doEdito]]:[],["eval",n.doEval],["explore",n.doExplore]],F=((Y=q.find(([Z])=>Z===z))==null?void 0:Y[1])||n.doAll;return t.jsxs("span",{className:"doable",children:[t.jsxs("button",{type:"button",className:"dobtn","aria-expanded":C,onClick:()=>N(Z=>!Z),children:[F,t.jsx("i",{children:"▾"})]}),C&&t.jsx("div",{className:"dolist",children:q.map(([Z,Ne])=>t.jsx("button",{type:"button","aria-pressed":z===Z,onClick:()=>{S(Z),N(!1)},children:Ne},Z))})]})})(),a.dens==="maxi"&&t.jsxs("label",{className:"sortsel",children:[t.jsx("span",{children:n.sortBy}),t.jsx("select",{value:a.sort.key,onChange:q=>r({type:"sort",key:q.target.value}),children:[["signal",n.sortSig],["amount",n.sortAmount],["age",n.sortAge],["name",n.sortName],["country",n.sortCountry],["stage",n.sortStage],...i.pipe?[["crible",n.sortCrible],["memo",n.sortMemo],["score",n.sortScore]]:[]].map(([q,F])=>t.jsx("option",{value:q,children:F},q))})]}),i.showChain&&I.length>0&&t.jsxs("button",{type:"button",className:"chain",onClick:()=>r({type:"chainStart",queue:I.map(q=>q.id)}),children:[t.jsx("span",{className:"b",children:"▶"})," ",i.pipe?n.browse(I.length):n.chainAll(I.length)]}),a.mapFolded&&t.jsx($r,{compact:!0})]}),t.jsx(Tl,{}),O>0&&!a.filters.signalOnly&&!U&&t.jsxs("div",{className:"sigstrip"+(X?" mini":""),children:[t.jsxs("div",{className:"sg-h",children:[t.jsx("span",{className:"t",dangerouslySetInnerHTML:{__html:n.sigStrip(O)}}),t.jsx("span",{className:"s",children:n.sigStripSub}),t.jsx("span",{className:"sg-sp"}),t.jsx("button",{type:"button",onClick:()=>r({type:"filters",patch:{signalOnly:!0,signalEngines:[]}}),children:n.sigStripGo}),t.jsx("button",{type:"button",className:"sg-x","aria-expanded":!X,title:X?n.boxExpand:n.boxCollapse,onClick:()=>oe(q=>{try{localStorage.setItem(ee,q?"0":"1")}catch{}return!q}),children:X?"▸":"▾"}),t.jsx("button",{type:"button",className:"sg-x",title:n.tourClose,onClick:()=>re(!0),children:"×"})]}),t.jsxs("div",{className:"sg-c",children:[(H?w:w.slice(0,12)).map(q=>{const F=Ae(q);return F?t.jsxs("button",{type:"button",className:"sg-chip",title:n.sigChipTitle(Ga(F,f),Xt(F,f)),onClick:()=>{d(q.id),r({type:"popup",id:q.id})},children:[t.jsx("b",{children:q.name}),t.jsxs("i",{children:[F.emoji," ",Ea(F,f)]}),t.jsx("em",{children:Xt(F,f)})]},"sg-"+q.id):null}),!H&&w.length>12&&t.jsx("button",{type:"button",className:"sg-more",onClick:()=>V(!0),children:n.sigStripMore(w.length-12)})]})]}),a.dens!=="maxi"&&!T&&t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),K("country",n.colCountry),K("name",n.colCompany),K("amount",n.colAmount,"h-amt",!0),K("stage",n.colStage,"h-stade"),K("signal",n.colSignal,"h-sig"),i.pipe&&t.jsxs("span",{className:"h-vd h-vd-sort",children:[K("crible",n.colCrible),t.jsx("i",{"aria-hidden":"true",children:"·"}),K("memo",n.colMemo)]}),i.pipe&&K("score",n.colScore,"h-sc",!0),t.jsx("span",{}),i.showThumbs&&t.jsx("span",{className:"h-thu",children:n.colThumbs})]}),T?t.jsxs("div",{className:"desk",children:[t.jsxs("div",{className:"desk-list",children:[t.jsxs("div",{className:"cols",children:[t.jsx("span",{}),K("country",n.colCountry),K("name",n.colCompany),K("amount",n.colAmount,"h-amt",!0),K("stage",n.colStage,"h-stade"),K("signal",n.colSignal,"h-sig"),t.jsx("span",{})]}),t.jsx("div",{className:we,children:le})]}),t.jsx("aside",{className:"readpane","aria-label":f==="fr"?"Dossier":"File",children:i.pipe?t.jsx(Fl,{o:Q}):t.jsx(Pl,{o:Q,extra:Q?null:u})})]}):t.jsx("div",{className:we,children:le}),(()=>{const q=W||[["pt"+a.ptab,M]];let F=0,Y=0;for(const[Ne,me]of q){Y+=me.length;let Fe=a.shown[Ne]||v();me.length-Fe<=4&&(Fe=me.length),F+=Math.min(me.length,Fe)}const Z=Y-F;return Z<=0?null:t.jsxs("button",{type:"button",className:"moregrp",onClick:()=>q.forEach(([Ne,me])=>r({type:"more",group:Ne,by:me.length,base:v()})),children:[t.jsx("span",{className:"more-label",children:n.more(Z,Z)}),t.jsx("span",{className:"more-meta",children:n.moreMeta(F,Y)})]})})(),g==="ops"&&t.jsx(zl,{}),i.showThumbs&&t.jsxs("p",{className:"learn",children:[n.learnLine,t.jsx("button",{type:"button",onClick:()=>r({type:"modal",modal:"crit"}),children:n.learnLink})]}),(s.kept>0||s.dropped>0)&&t.jsx("div",{className:"tally",style:{padding:"6px 14px"},dangerouslySetInnerHTML:{__html:n.session(s.kept,s.dropped)}})]})}function rr(e){let a=e==null?"":String(e);return/^[=+\-@\t]/.test(a)&&(a=`'${a}`),/[";\n\r]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}function Ul(e,a){const r=Xo(e);return a[{retenu:1,ana:2,pending:3,valide:4,ecarte:5}[r]??1]||""}function Vl(e,a){const n=[a.head.split("|").map(rr).join(";")];for(const i of e){const o=a.stageOf(i);n.push([i.name||"",Ul(i,a.plabels),Ft(i)||i.verdict||"",typeof i.score=="number"?i.score:"",i.countryLabel||i.cc||"",i.sector||"",o?a.stageLabel(o.stage):"",i.contactName||"",i.contactEmail||"",i.memoUrl||"",(i.date||"").slice(0,10),(i.reasoning||"").replace(/\s+/g," ").trim().slice(0,280)].map(rr).join(";"))}return`\uFEFF${n.join(`\r
`)}`}function Hl(e){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),r=URL.createObjectURL(a),n=document.createElement("a");n.href=r,n.download=`cibles_vue_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(r);try{document.body.removeChild(n)}catch{}},400)}const Wl=(e,a)=>{const r=String(e||"").slice(0,10);return/^\d{4}-\d{2}-\d{2}$/.test(r)?a==="en"?r:`${r.slice(8,10)}/${r.slice(5,7)}/${r.slice(0,4)}`:""};function Qe({k:e,v:a}){return a==null||a===""?null:t.jsxs("div",{className:"dsl",children:[t.jsx("span",{children:e}),t.jsx("b",{children:String(a)})]})}function Yl({o:e,qa:a}){const{t:r,lang:n,fund:i}=B(),o=(e.cribleStatus||"").trim().toUpperCase()||(Ft(e)==="NO MATCH"?"NO MATCH":"MATCH"),l=at(e),c=(a==null?void 0:a.blocs)||{},d=[[r.qaVP,c.value_prop],[r.qaProduct,c.produit],[r.qaModel,c.modele],[r.qaSummary,c.synthese]];return t.jsxs("article",{className:"dspage",children:[t.jsxs("header",{className:"dsh",children:[t.jsxs("div",{children:[t.jsx("b",{children:e.name}),e.tagline&&t.jsx("p",{children:e.tagline})]}),t.jsxs("span",{className:"dsv"+(o==="NO MATCH"?" out":""),children:[o==="NO MATCH"?r.vOut:r.vKept,l&&t.jsx("em",{children:l})]})]}),e.reasoning&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsWhy}),t.jsx("p",{className:"dstxt",children:e.reasoning})]}),t.jsxs("section",{className:"dsgrid",children:[t.jsx(Qe,{k:r.cdSector,v:e.sector}),t.jsx(Qe,{k:r.cdStage,v:e.stage}),t.jsx(Qe,{k:r.cdCountry,v:[e.city,e.countryLabel].filter(Boolean).join(", ")}),t.jsx(Qe,{k:r.cdSite,v:e.domain||e.website}),t.jsx(Qe,{k:r.cdName,v:e.contactName}),t.jsx(Qe,{k:r.cdEmail,v:e.contactEmail}),t.jsx(Qe,{k:r.cdScore,v:typeof e.score=="number"?`${e.score}/100`:""}),t.jsx(Qe,{k:r.cdConvScore,v:typeof e.convictionScore=="number"?Math.round(e.convictionScore):""}),t.jsx(Qe,{k:r.cdAngle,v:e.angle}),t.jsx(Qe,{k:r.cdDetected,v:Wl(e.date,n)})]}),d.some(([,f])=>f)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsAnalysis}),d.filter(([,f])=>f).map(([f,s])=>t.jsxs("div",{className:"dsb",children:[t.jsx("span",{children:f}),t.jsx("p",{children:s})]},f))]}),(e.ceoStatus||e.ceoNote)&&t.jsxs("section",{children:[t.jsx("h3",{children:r.dsDecision}),e.ceoStatus&&t.jsx("p",{className:"dstxt",children:t.jsx("b",{children:e.ceoStatus})}),e.ceoNote&&t.jsxs("p",{className:"dstxt",children:["« ",e.ceoNote," »"]})]}),t.jsx("footer",{className:"dsf",children:r.dsFoot(i)})]})}function Gl(){const{t:e,lang:a,token:r,scoped:n,fund:i,data:o,dispatch:l}=B(),[c,d]=m.useState({}),f=25,s=m.useMemo(()=>n.slice(0,f),[n]);m.useEffect(()=>{s.length&&Zo(r,s.map(g=>g.name)).then(d)},[r,s]);const x=o.stats,p=g=>g.toLocaleString(a==="en"?"en-US":"fr-FR");return t.jsxs("div",{className:"dossier",children:[t.jsxs("div",{className:"dsbar",children:[t.jsx("b",{children:e.dsTitle(s.length)}),n.length>f&&t.jsx("span",{className:"mnote dim",children:e.dsCap(f,n.length)}),t.jsx("span",{className:"dssp"}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)},children:e.printBtn})]}),t.jsxs("div",{className:"dscover",children:[t.jsx("b",{children:i}),x&&typeof x.screened=="number"&&t.jsxs("p",{children:[p(x.screened)," ",e.funScreened(""),typeof x.kept=="number"&&t.jsxs(t.Fragment,{children:[" · ",p(x.kept)," ",e.covKept]}),typeof o.marketEstimate=="number"&&o.marketEstimate>0&&t.jsxs(t.Fragment,{children:[" · ",e.covOf(p(o.marketEstimate)),", ",Math.round(x.screened/o.marketEstimate*100)," %"]})]})]}),s.map(g=>t.jsx(Yl,{o:g,qa:c[g.name]},g.id)),!s.length&&t.jsx("p",{className:"mnote",children:e.dsEmpty})]})}const Kl=50;function on({label:e,onPreview:a,onTest:r,readOnly:n}){const{t:i}=B(),[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(""),[x,p]=m.useState(0),[g,u]=m.useState(""),[b,v]=m.useState(!1),h=m.useRef(null);m.useEffect(()=>()=>{h.current&&window.clearInterval(h.current)},[]);const j=async y=>{d(!0),s("");const A=await a();if(d(!1),A.ok){l(A);return}if(A.busy){s(i.alertPreviewBusy);return}if(!y){s(i.alertPreviewFail);return}p(Kl),h.current=window.setInterval(()=>{p(T=>T>1?T-1:(h.current&&window.clearInterval(h.current),j(!1),0))},1e3)},E=async()=>{if(n||b)return;v(!0),u("");const y=await r();v(!1),u(y.ok?i.alertTestOk(y.sentTo||""):y.error||i.actErr)};return t.jsxs("div",{className:"mailp",children:[t.jsxs("div",{className:"mailp-row",children:[t.jsx("button",{type:"button",className:"abtn",disabled:c||x>0,onClick:()=>{j(!0)},children:c?"…":e}),t.jsx("button",{type:"button",className:"abtn",disabled:n||b,onClick:()=>{E()},children:b?"…":i.alertTest})]}),x>0&&t.jsx("p",{className:"mnote",children:i.alertPreviewRetry(x)}),f&&t.jsx("p",{className:"mnote warn",children:f}),g&&t.jsx("p",{className:"mnote",children:g}),!g&&t.jsx("p",{className:"mnote dim",children:i.alertTestHint}),(o==null?void 0:o.ok)&&t.jsxs(t.Fragment,{children:[t.jsxs("p",{className:"mnote",children:[t.jsx("b",{children:i.alertSubject})," ",o.subject]}),o.pending===0&&t.jsx("p",{className:"mnote warn",children:i.alertPreviewEmpty}),t.jsx("iframe",{className:"mailp-frame",sandbox:"",srcDoc:o.html,title:e})]})]})}const ht="https://alexandre-79537--proplace-chat-proxy-fastapi-app.modal.run";function Oe({title:e,icon:a,children:r,wide:n}){const{dispatch:i}=B();return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:o=>{o.target===o.currentTarget&&i({type:"modal",modal:null})},children:t.jsxs("div",{className:"mcard",style:n?{width:"min(760px,100%)"}:void 0,children:[t.jsxs("div",{className:"mh",children:[a&&t.jsx("span",{className:"no g",children:a}),t.jsx("h2",{children:e}),t.jsx("button",{type:"button",className:"x",onClick:()=>i({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"mb",children:r})]})})}),document.body)}function Ql(){const{st:e}=B();switch(e.modal){case"chain":return t.jsx(Xl,{});case"space":return t.jsx(Zl,{});case"alert":return t.jsx(ec,{});case"queue":return t.jsx(oc,{});case"export":return t.jsx(ic,{});case"plug":return t.jsx(cc,{});case"recharge":return t.jsx(pc,{});case"cover":return t.jsx(mc,{});case"dossier":return t.jsx(uc,{});case"crit":return t.jsx(fc,{});case"tuto":return t.jsx(xc,{});case"rdv":return t.jsx(Jl,{});case"memoalert":return t.jsx(sc,{});default:return null}}function Jl(){const{dispatch:e,fund:a,t:r}=B(),n=a||r.rdvCoFallback;return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",onClick:()=>e({type:"modal",modal:null}),children:t.jsxs("div",{className:"mcard rdvcard",onClick:i=>i.stopPropagation(),children:[t.jsxs("div",{className:"mh",children:[t.jsx("span",{className:"no g",children:"📅"}),t.jsx("h2",{children:r.rdvHeading}),t.jsx("button",{type:"button",className:"x",onClick:()=>e({type:"modal",modal:null}),children:"×"})]}),t.jsxs("div",{className:"mb",children:[t.jsxs("p",{className:"mnote",children:[r.rdvSubBefore,t.jsx("a",{href:br,children:Xa}),r.rdvSubMid,t.jsx("a",{href:`mailto:${Zt}`,children:Zt})]}),t.jsx("div",{className:"rdv-unlocks",children:r.rdvUnlocks(n).map(([i,o],l)=>t.jsxs("div",{className:"rdv-u",children:[t.jsx("em",{children:r.rdvUnlockLabel(l+1)}),t.jsx("b",{children:i}),t.jsx("span",{children:o})]},i))}),t.jsx("div",{className:"rdv-emb",children:t.jsx(ki,{filloutId:"aDx8z7Hzksus",parameters:a?{company_name:a}:void 0})})]})]})})}),document.body)}function Xl(){const{st:e,dispatch:a,byId:r,t:n,lang:i,mode:o,askEvaluate:l,evalBusy:c,caps:d,memoQueued:f,doAnalyse:s}=B(),x=o==="client",p=e.chain.queue.map(v=>r.get(v)).filter(v=>!!v),g=e.chain.idx,u=p[g],b=g>=p.length;return yt.createPortal(t.jsx("div",{className:"atl2",children:t.jsx("div",{className:"modal on",children:t.jsxs("div",{className:"fcard",children:[t.jsxs("div",{className:"fh",children:[t.jsx("span",{className:"c",children:b?n.finished:`${g+1} / ${p.length}`}),t.jsx("span",{className:"p",children:t.jsx("i",{style:{width:(b?100:g/Math.max(1,p.length)*100)+"%"}})}),t.jsx("button",{type:"button",className:"x",onClick:()=>a({type:"modal",modal:null}),children:"×"})]}),t.jsx("div",{className:"fb",children:b||!u?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🏁"}),t.jsx("div",{className:"t",children:n.chainDone}),t.jsx("div",{className:"s",children:n.chainDoneSub(p.length)})]}):t.jsxs(t.Fragment,{children:[t.jsx("h2",{children:u.name}),t.jsx("div",{className:"sub",children:[wt(u.cc,i)||u.countryLabel,u.sector,u.stage,n.daysAgo(tt(u.date))].filter(Boolean).map(v=>String(v).toUpperCase()).join(" · ")}),t.jsxs("div",{className:"tags",children:[t.jsx("span",{className:"hi",children:He(u.engine,i).toUpperCase()}),typeof u.amountEur=="number"&&u.amountEur>0&&t.jsx("span",{children:kt(u.amountEur,i)})]}),Ae(u)&&t.jsxs("div",{style:{marginBottom:12},children:[t.jsx(pt,{o:u,lg:!0})," ",t.jsx(ca,{o:u,src:!0})]}),(u.tagline||u.headline)&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.desc}),t.jsx("p",{children:u.tagline||u.headline})]}),u.reasoning&&t.jsxs("div",{className:"fld",children:[t.jsx("span",{className:"l",children:n.memo}),t.jsx("p",{className:"memo",children:u.reasoning})]}),x&&Re(u)&&t.jsxs("div",{className:"vbox",style:{"--c":st(u)==="retenu"?"var(--brand)":st(u)==="pending"?"var(--bolt)":"var(--red)",marginTop:12},children:[t.jsx("span",{className:"vt",children:st(u)==="retenu"?"✓ "+n.kept:st(u)==="pending"?"📞 "+n.pending:"✗ "+n.dropped}),t.jsx("span",{className:"vd",children:u.reasoning||""})]})]})}),t.jsxs("div",{className:"ff",children:[!b&&u&&d.pipe&&Ce(u)===1&&!f.has(u.id)?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{s(u),a({type:"chainNext"})},children:[t.jsx("span",{className:"fill"}),n.chainMemoGo]}):!b&&u&&!(x&&Re(u))&&(u.noCo&&u.url?t.jsxs("button",{type:"button",className:"evalbtn",style:{flex:1,justifyContent:"center",padding:15,fontSize:15},onClick:()=>{var v;try{window.dispatchEvent(new CustomEvent("ppmap:research",{detail:{url:u.url}}))}catch{}a({type:"modal",modal:null}),(v=document.querySelector(".atl2 .demand"))==null||v.scrollIntoView({behavior:"smooth",block:"center"})},children:[t.jsx("span",{className:"fill"}),n.rowExtract]}):t.jsxs("button",{type:"button",className:"evalbtn"+(c?" loading":""),style:{flex:1,justifyContent:"center",padding:15,fontSize:15},disabled:c,onClick:()=>{l(u)},children:[t.jsx("span",{className:"fill"}),n.launchEval]})),t.jsx("button",{type:"button",className:"abtn",style:{flex:"0 0 130px"},onClick:()=>a(b?{type:"modal",modal:null}:{type:"chainNext"}),children:b?n.closeBtn:n.skip})]})]})})}),document.body)}function Zl(){const{st:e,dispatch:a,dossiers:r,t:n,mode:i}=B(),o=i==="client",l=m.useMemo(()=>o?r.filter(x=>Re(x)):[],[r,o]),c=m.useMemo(()=>Qa(l.filter(x=>st(x)==="retenu"),{key:"signal",dir:-1}),[l]),d=m.useMemo(()=>l.filter(x=>st(x)==="ecarte"),[l]),f=e.spaceTab==="retenu"?c:d,s=e.spaceTab==="retenu"?"var(--brand)":"var(--red)";return t.jsxs(Oe,{title:n.spaceTitle,children:[t.jsxs("div",{className:"sp-tabs",children:[t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--brand)"},"aria-selected":e.spaceTab==="retenu",onClick:()=>a({type:"spaceTab",tab:"retenu"}),children:["✓ ",n.statusKeep.replace("✅ ","")," ",t.jsx("b",{children:c.length})]}),t.jsxs("button",{type:"button",className:"sp-tab",style:{"--c":"var(--red)"},"aria-selected":e.spaceTab==="ecarte",onClick:()=>a({type:"spaceTab",tab:"ecarte"}),children:["✗ ",n.statusDrop.replace("❌ ","")," ",t.jsx("b",{children:d.length})]})]}),f.length===0&&t.jsx("div",{className:"sp-empty",children:n.spEmpty}),f.slice(0,40).map(x=>t.jsxs("div",{className:"sp-row",children:[t.jsx("span",{className:"sc",style:{"--c":s},children:typeof x.score=="number"&&x.score>0?x.score:"—"}),t.jsxs("span",{children:[t.jsx("div",{className:"nm",children:x.name}),t.jsx("div",{className:"rr",children:x.reasoning||x.tagline||""})]})]},x.id)),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:n.spNote}})]})}function ec(){const{mode:e}=B();return e==="client"||e==="apercu"?t.jsx(tc,{}):t.jsx(rc,{})}function tc(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=B(),[o,l]=m.useState("d"),c=i!=="client";return t.jsxs(Oe,{title:e.alertTitle,icon:"🔔",children:[t.jsxs("div",{className:"ntabs",role:"tablist",children:[t.jsx("button",{type:"button",role:"tab","aria-selected":o==="d",className:o==="d"?"on":"",onClick:()=>l("d"),children:e.alertTabDaily}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="w",className:o==="w"?"on":"",onClick:()=>l("w"),children:e.alertTabWeekly}),t.jsx("button",{type:"button",role:"tab","aria-selected":o==="m",className:o==="m"?"on":"",onClick:()=>l("m"),children:e.alertTabMarket})]}),o==="d"&&t.jsx(ac,{t:e,token:a,readOnly:c,flash:r,flashErr:n}),o==="w"&&t.jsx(nc,{t:e,token:a,readOnly:c,flash:r,flashErr:n}),o==="m"&&t.jsx(Hr,{})]})}function ac({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let u=!0;return d(!1),kn(a).then(b=>{u&&(b?l(b):d(!0))}),()=>{u=!1}},[a,f]);const x=u=>{r||kn(a,u).then(b=>{if(!b){i(e.actErr);return}l(b),b.throttled?i(e.alertThrottled):n(e.alertSaved)})};if(c)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=u=>!o.sections||o.sections.includes(u),g=u=>{const b=o.sections||e.alertSec.map(([v])=>v);x({sections:p(u)?b.filter(v=>v!==u):[...b,u]})};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qrow",children:[t.jsxs("span",{children:[t.jsx("b",{children:e.alertDaily}),t.jsx("div",{style:{fontSize:12,color:"var(--muted)"},children:e.alertDailyHint})]}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertHour}),t.jsxs("span",{className:"qset",children:[t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,(o.hour??7)-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[o.hour??7," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,(o.hour??7)+1)}),disabled:r,children:"＋"})]})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertDays}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days!=="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"weekdays"}),children:e.alertWeekdays}),t.jsx("button",{type:"button",className:"abtn",disabled:r,style:o.days==="daily"?{background:"var(--ink)",color:"#fff"}:void 0,onClick:()=>x({days:"daily"}),children:e.alertEveryday})]})]}),t.jsx("div",{className:"qsec ok",children:e.alertSections}),t.jsx("div",{className:"secl",children:e.alertSec.map(([u,b])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:p(u),disabled:r,onChange:()=>g(u)}),t.jsxs("span",{children:[b,u==="market"&&t.jsxs("i",{children:[" ",e.alertSecSlow]})]})]},u))}),t.jsx("p",{className:"mnote dim",children:e.alertSecNote}),t.jsx(on,{label:e.alertPreview,readOnly:r,onPreview:()=>ci(a),onTest:()=>li(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function nc({t:e,token:a,readOnly:r,flash:n,flashErr:i}){const[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(0);m.useEffect(()=>{let u=!0;return d(!1),jn(a).then(b=>{u&&(b?l(b):d(!0))}),()=>{u=!1}},[a,f]);const x=u=>{r||jn(a,u).then(b=>{if(!b){i(e.actErr);return}l(b),n(e.alertSaved)})};if(c)return t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>s(u=>u+1),children:e.retry})]});if(!o)return t.jsx("div",{className:"sp-empty",children:"…"});const p=o.dow??0,g=o.hour??16;return t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"lead2",children:e.alertWeeklySub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.alertWeeklyOn})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn onoff","aria-pressed":o.enabled===!0,disabled:r,style:o.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>x({enabled:!o.enabled}),children:o.enabled?"ON":"OFF"})})]}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:e.alertWeeklyWhen}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("select",{value:p,disabled:r,onChange:u=>x({dow:Number(u.target.value)}),children:e.alertDow.map((u,b)=>t.jsx("option",{value:b,children:u},u))}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.max(6,g-1)}),disabled:r,children:"−"}),t.jsxs("b",{children:[g," h"]}),t.jsx("button",{type:"button",onClick:()=>x({hour:Math.min(21,g+1)}),disabled:r,children:"＋"})]})]}),t.jsx(on,{label:e.alertPreviewWeekly,readOnly:r,onPreview:()=>pi(a),onTest:()=>di(a)}),o.active===!1&&t.jsx("p",{className:"mnote warn",children:e.alertInactive}),o.email_lead?t.jsxs("p",{className:"mnote",children:["→ ",o.email_lead,o.last_sent?` · ${e.updatedAt(o.last_sent.slice(0,10))}`:""]}):t.jsx("p",{className:"mnote",children:e.alertNoLead})]})}function Hr(){const{st:e,t:a,lang:r,scoped:n,contName:i,email:o}=B(),[l,c]=m.useState(o||""),[d,f]=m.useState(!1),[s,x]=m.useState(!1);m.useEffect(()=>{o&&c(o)},[o]);const p=e.filters,g=m.useMemo(()=>n.filter(h=>Ae(h)).length,[n]),u=p.win==="1"?0:p.win==="7"?1:p.win==="30"?2:3,b=async()=>{if(!(!/.+@.+\..+/.test(l)||s)){x(!0);try{await fetch(`${Va}/mes-secteurs/subscribe`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l.trim(),sectors:p.sector,countries:p.country,source:o?"atelier2-client":"atelier2",website:""})}),f(!0)}finally{x(!1)}}},v=[[a.amRows.continent,i],[a.amRows.since,a.amSince[u]],[a.amRows.signal,p.signalOnly?a.amOnlyOpen:a.amAnySignal],[a.amRows.engines,p.engine.length?p.engine.map(h=>He(h,r)).join(", "):a.amAllEngines],[a.amRows.sectors,p.sector.length?p.sector.join(", "):a.amAllSectors],[a.amRows.countries,p.country.length?p.country.map(h=>wt(h,r)||h).join(", "):a.amAllCountries],[a.amRows.stages,p.stage.length?p.stage.join(", "):a.amAllStages]];return d?t.jsxs("div",{className:"fin",children:[t.jsx("div",{className:"em",children:"🔔"}),t.jsx("div",{className:"t",children:a.amOk}),t.jsx("div",{className:"s",dangerouslySetInnerHTML:{__html:a.amOkSub(l)}})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"crit",children:v.map(([h,j])=>t.jsxs("div",{className:"r",children:[t.jsx("span",{className:"k",children:h}),t.jsx("span",{className:"v",dangerouslySetInnerHTML:{__html:j}})]},h))}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"email",placeholder:a.amMail,autoComplete:"email",value:l,readOnly:!!o,onChange:h=>c(h.target.value),onKeyDown:h=>{h.key==="Enter"&&b()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(s?" loading":""),style:{padding:"12px 18px"},onClick:()=>void b(),children:[t.jsx("span",{className:"fill"}),a.amActivate]})]}),t.jsx("p",{className:"mnote",dangerouslySetInnerHTML:{__html:a.amNote(n.length,g)}}),t.jsx("p",{className:"mnote",children:a.amHonest})]})}function rc(){const{t:e}=B();return t.jsx(Oe,{title:e.alertTitle,icon:"🔔",children:t.jsx(Hr,{})})}function oc(){var S,C;const{t:e,token:a,fund:r,mode:n,dossiers:i,doAnalyse:o,memoQueued:l,caps:c,dispatch:d,liveMemos:f}=B(),[s,x]=m.useState(null),[p,g]=m.useState([]),[u,b]=m.useState(0),v=n==="client",h=m.useMemo(()=>{const N=new Map;return i.forEach(R=>{const $=(R.name||"").trim().toLowerCase();$&&!N.has($)&&N.set($,R)}),N},[i]);m.useEffect(()=>{let N=!0;return(async()=>{const[R,$]=await Promise.all([Wa(r),lr(a)]);N&&(R&&x(R),g($))})(),()=>{N=!1}},[a,r,u]);const j=(s==null?void 0:s.per_day)??0,E=((S=s==null?void 0:s.analyzed_today)==null?void 0:S.length)??0,y=s==null?void 0:s.offre,A=(s==null?void 0:s.pool_meta)||[],T=m.useMemo(()=>{const N=new Map;for(const R of(s==null?void 0:s.scheduled)||[])for(const $ of R.names||[])N.has($)||N.set($,{label:R.day_label,date:R.date});return N},[s==null?void 0:s.scheduled]),z=(s==null?void 0:s.in_progress)||[];return t.jsxs(Oe,{title:e.queueTitle,wide:!0,children:[y&&t.jsxs("div",{className:"qoffre"+(y.en_retard?" late":""),children:[t.jsx("span",{className:"ol",children:e.qOffer}),t.jsx("b",{children:y.libelle}),t.jsxs("span",{className:"od",children:[e.qDelay," ",t.jsx("b",{children:y.delai})]}),t.jsx("span",{className:"osp"}),y.rythme>0?t.jsx("span",{className:"or",children:e.qRate(y.rythme)}):y.manuel_par_jour?t.jsx("span",{className:"or",children:e.qManual(y.manuel_par_jour)}):t.jsx("span",{className:"or dim",children:e.qPaused})]}),t.jsxs("div",{className:"qbox",children:[t.jsx("div",{className:"qhead",children:t.jsx("b",{dangerouslySetInnerHTML:{__html:e.queueDone(E,E+(((C=s==null?void 0:s.pool_order)==null?void 0:C.length)??0))}})}),y&&t.jsxs("div",{className:"qeta",children:[y.file===0?e.qEtaDone:y.rythme<=0?e.qEtaPaused:e.qEta(y.file,y.rythme,y.jours_restants),y.en_retard&&t.jsxs("em",{children:[" ",e.qLate(y.delai,y.plafond)]})]}),t.jsxs("div",{className:"qrate",children:[e.covRate," — ",t.jsx("b",{children:e.covRateNow(j)}),(y==null?void 0:y.reglage_manuel)&&t.jsxs("span",{className:"dim",children:[" · ",e.qManualSet]})]})]}),(z.length>0||f.items.some(N=>N.status==="boot"||N.status==="running"))&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec run",children:["⌛ ",e.qRunning]}),t.jsxs("div",{className:"qrows",children:[f.items.filter(N=>N.status==="boot"||N.status==="running"||N.status==="error").map(N=>t.jsxs("div",{className:"qr2 qfl",children:[t.jsx("b",{children:N.name}),t.jsx("span",{className:"qd",children:N.memoType||""}),t.jsx(Tt,{item:N,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd})]},"live-"+N.name)),z.filter(N=>!f.liveOf(N.name)).map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.name}),t.jsxs("span",{className:"qd",children:[N.memo_type||"",N.age_min?` · ${Math.round(N.age_min)} min`:""]}),t.jsx("span",{className:"qt",children:N.state||""})]},"ip-"+N.name))]})]}),p.length>0&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"qsec ok",children:["⏳ ",e.queueToday]}),t.jsx("div",{className:"qrows",children:p.map(N=>t.jsxs("div",{className:"qr2",children:[t.jsx("b",{children:N.company}),t.jsxs("span",{className:"qd",children:[N.memo_type,typeof N.est_min=="number"?` · ~${N.est_min} min`:""]}),t.jsx("span",{className:"qt",children:N.status}),N.url&&t.jsx("a",{className:"qgo",href:N.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.actMemo}),v&&N.status==="error"&&t.jsx("button",{type:"button",className:"qgo an",onClick:()=>{wn(a,N.company,"retry").then(()=>b(R=>R+1))},children:e.queueRetry}),v&&N.status!=="done"&&t.jsx("button",{type:"button",className:"abtn",onClick:()=>{wn(a,N.company,"delete").then(()=>b(R=>R+1))},children:e.queueDelete})]},N.company))})]}),t.jsxs("div",{className:"qsec todo",children:["⚡ ",e.qUpNext(A.length)]}),t.jsx("div",{className:"qhedge",children:e.qHedge}),t.jsxs("div",{className:"qrows qfile",children:[A.length===0&&t.jsx("div",{className:"sp-empty",children:e.queueEmpty}),A.map((N,R)=>{const $=T.get(N.name),L=h.get((N.name||"").trim().toLowerCase()),M=f.liveOf(N.name),w=!!(L&&l.has(L.id))||!!(M&&(M.status==="boot"||M.status==="running")),O=!!(L&&Ce(L)===1&&!L.memoUrl)&&!M;return t.jsxs("div",{className:"qr2 qfl",children:[t.jsxs("span",{className:"qn2",children:["#",R+1]}),$?t.jsx("span",{className:"qwhen"+($.label==="demain"?" soon":""),children:$.label}):t.jsx("span",{className:"qwhen later",children:e.qLater}),t.jsx("b",{children:N.name}),N.fresh&&t.jsx("span",{className:"qfresh",children:e.qFresh}),typeof N.score=="number"&&t.jsx("span",{className:"qs2",children:N.score}),M&&(M.status==="boot"||M.status==="running")&&t.jsx(Tt,{item:M,serverOff:f.serverOff,bootLbl:e.liveBoot,endLabel:e.liveEnd}),O&&(c.lockActions||!v?t.jsx("button",{type:"button",className:"qgo an",onClick:()=>d({type:"modal",modal:"rdv"}),children:e.actLocked}):t.jsx("button",{type:"button",className:"qgo an",disabled:w,onClick:()=>{o(L),b(H=>H+1)},children:w?e.actAnalyseQueued:e.actAnalyse})),N.excerpt&&t.jsx("span",{className:"qex",children:N.excerpt})]},N.name+":"+R)})]}),t.jsxs("div",{className:"qsec",children:["🧭 ",e.qVerdictsT]}),t.jsx("ul",{className:"qverd",children:e.qVerdicts.map(([N,R])=>t.jsxs("li",{children:[t.jsx("b",{children:N})," — ",R]},N))})]})}function ic(){const{t:e,token:a,flash:r,scoped:n,caps:i,stageOf:o,dispatch:l}=B(),c=`${ht}/cibles/list.csv?token=${a}`,d=`${ht}/cibles/list.json?token=${a}`,f=`${ht}/cibles/export.xlsx?token=${a}&scope=full`,s=`=IMPORTDATA("${c}")`,x=v=>{var h;(h=navigator.clipboard)==null||h.writeText(v).then(()=>r(e.exportCopied))},p=[{def:e.exportCsv,value:c,href:c},{def:e.exportSheet,value:s},{def:e.exportLive,value:d,href:d},{def:e.exportXlsx,value:f,href:f}],g=!i.lockActions&&n.length>0,u=()=>{Hl(Vl(n,{plabels:e.plabels,head:e.exportViewHead,stageOf:o,stageLabel:v=>(e.stg.find(([h])=>h===v)||["",""])[1]})),r(e.exportViewDone(n.length))},b=()=>{l({type:"modal",modal:null}),setTimeout(()=>{try{window.print()}catch{}},120)};return t.jsxs(Oe,{title:e.exportTitle,icon:"📥",children:[t.jsx("p",{className:"lead2",children:e.exportLead}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🖨️"}),t.jsxs("div",{children:[t.jsx("b",{children:e.printTitle}),t.jsx("p",{children:e.printDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb",onClick:b,children:e.printBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"🗂"}),t.jsxs("div",{children:[t.jsx("b",{children:e.dsBtn}),t.jsx("p",{children:e.dsHint})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>l({type:"modal",modal:"dossier"}),children:e.exportViewBtn})]})}),g&&t.jsx("div",{className:"expl",style:{marginBottom:10},children:t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:"📄"}),t.jsxs("div",{children:[t.jsx("b",{children:e.exportViewTitle}),t.jsx("p",{children:e.exportViewDesc(n.length)})]}),t.jsx("button",{type:"button",className:"exb pri",onClick:u,children:e.exportViewBtn})]})}),t.jsx("div",{className:"expl",children:p.map(({def:v,value:h,href:j})=>t.jsxs("div",{className:"exi",children:[t.jsx("span",{className:"exic",children:v[0]}),t.jsxs("div",{children:[t.jsx("b",{children:v[1]}),t.jsx("p",{children:v[2]})]}),t.jsx("button",{type:"button",className:"exb",onClick:()=>x(h),children:e.exportCopy}),j&&t.jsx("a",{className:"exb",href:j,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:e.exportOpen})]},v[1]))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.exportKeyWarning})]})}function sc(){const{t:e,token:a,flash:r,flashErr:n,mode:i}=B(),o=i!=="client",[l,c]=m.useState(null),[d,f]=m.useState(!1),[s,x]=m.useState(0),[p,g]=m.useState(!1);m.useEffect(()=>{let h=!0;return f(!1),yn(a).then(j=>{h&&(j?c(j):f(!0))}),()=>{h=!1}},[a,s]);const u=()=>(l==null?void 0:l.sections)||{swot:!0,action:!0,synergies:!0,quadrant:!0,verdict:!0},b=h=>{if(o||!l)return;const j={enabled:h.enabled??!!l.enabled,email:h.email??(l.email||""),sections:h.sections??u()};g(!0),yn(a,j).then(E=>{if(g(!1),!E){n(e.memoAlertErr);return}c(E),r(e.memoAlertSaved)})};if(d)return t.jsx(Oe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>x(h=>h+1),children:e.retry})]})});if(!l)return t.jsx(Oe,{title:e.memoAlertTitle,icon:"🔔",children:t.jsx("div",{className:"sp-empty",children:"…"})});const v=u();return t.jsxs(Oe,{title:e.memoAlertTitle,icon:"🔔",children:[t.jsx("p",{className:"lead2",children:e.memoAlertSub}),t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:t.jsx("b",{children:e.memoAlertToggle})}),t.jsx("span",{className:"qset",children:t.jsx("button",{type:"button",className:"abtn","aria-pressed":l.enabled===!0,disabled:o||p,style:l.enabled?{background:"var(--brand)",color:"#fff",borderColor:"var(--brand)"}:void 0,onClick:()=>b({enabled:!l.enabled}),children:l.enabled?"ON":"OFF"})})]}),t.jsx(lc,{value:l.email||"",readOnly:o||p,label:e.memoAlertEmail,okLabel:e.csNoteOk,onSave:h=>b({email:h})}),t.jsx("div",{className:"qsec ok",children:e.memoAlertSections}),t.jsx("div",{className:"secl",children:e.memoAlertSec.map(([h,j])=>t.jsxs("label",{className:"secli",children:[t.jsx("input",{type:"checkbox",checked:!!v[h],disabled:o||p,onChange:()=>b({sections:{...v,[h]:!v[h]}})}),t.jsx("span",{children:j})]},h))}),t.jsx(on,{label:e.memoAlertPreview,readOnly:o,onPreview:()=>ti(a,v),onTest:()=>ei(a,v)})]})}function lc({value:e,readOnly:a,label:r,okLabel:n,onSave:i}){const[o,l]=m.useState(e);m.useEffect(()=>{l(e)},[e]);const c=o.trim()!==e.trim(),d=!o.trim()||/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(o.trim());return t.jsxs("div",{className:"qrow",children:[t.jsx("span",{children:r}),t.jsxs("span",{className:"qset",style:{gap:6},children:[t.jsx("input",{type:"email",className:"mailin",value:o,disabled:a,onChange:f=>l(f.target.value),onKeyDown:f=>{f.key==="Enter"&&c&&d&&i(o.trim())}}),t.jsx("button",{type:"button",className:"abtn",disabled:a||!c||!d,onClick:()=>i(o.trim()),children:n})]})]})}function cc(){const{t:e,token:a,flash:r,flashErr:n,canWrite:i}=B(),[o,l]=m.useState(null),[c,d]=m.useState(!1),[f,s]=m.useState(null),[x,p]=m.useState(""),[g,u]=m.useState(0);m.useEffect(()=>{let E=!0;return d(!1),Ca(a).then(y=>{E&&(y?l({configured:y.configured,url_hint:y.url_hint}):d(!0))}),ri(a).then(y=>{E&&s(y)}),()=>{E=!1}},[a,g]);const b=(E,y)=>{i&&Ca(a,E).then(A=>{if(!A||A.ok===!1){n(e.actErr);return}E.test&&A.sent===!1?n(e.plugTestThrottled):r(y),u(T=>T+1)})},v='{"mcpServers":{"proplace":{"url":"https://api.proplace.co/mcp"}}}',h=JSON.stringify({event:"status",company:"Aitona",status:"Validée",note:"très bon fit — introduction chaude possible",score:90,website:"https://aitona.com",memo_url:"https://analysis.proplace.co/…"},null,2),j=`curl -X POST ${ht}/cibles/evaluate \\
  -H "Content-Type: application/json" \\
  -d '{"token":"${a}","q":"nom ou URL de la société"}'`;return t.jsxs(Oe,{title:e.plugTitle,icon:"🔌",wide:!0,children:[f&&t.jsx("p",{className:"mnote"+(f.enabled?" warn":""),children:f.enabled?e.plugAutoOn(f.destination||"webhook"):e.plugAutoOff}),c?t.jsxs("div",{className:"sp-empty",children:[e.alertLoadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>u(E=>E+1),children:e.retry})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugCrm}),t.jsx("p",{className:"mnote",children:e.plugCrmHint}),t.jsxs("ol",{className:"plughow",children:[t.jsx("li",{children:e.plugHow1}),t.jsx("li",{children:e.plugHow2}),t.jsx("li",{children:e.plugHow3})]}),t.jsxs("div",{className:"mfield",children:[t.jsx("input",{type:"url",maxLength:500,placeholder:e.plugUrlPh,value:x,disabled:!i,onChange:E=>p(E.target.value)}),t.jsx("button",{type:"button",className:"abtn",disabled:!i||!x.trim(),onClick:()=>b({url:x.trim()},e.plugSaved),children:e.plugSave})]}),(o==null?void 0:o.configured)&&t.jsxs("p",{className:"mnote",children:["✓ ",o.url_hint||""," ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({test:!0},e.plugTested),children:e.plugTest})," · ",t.jsx("button",{type:"button",className:"lk",disabled:!i,onClick:()=>b({remove:!0},e.plugRemoved),children:e.plugRemove})]}),t.jsxs("details",{className:"plugex",children:[t.jsx("summary",{children:e.plugExT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:h}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(h).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugExResult})]}),t.jsx(dc,{}),t.jsx("div",{className:"qsec ok",children:e.plugApiT}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:j}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(j).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote dim",children:e.plugQuota}),t.jsx("div",{className:"qsec ok",children:e.plugMcp}),t.jsxs("div",{className:"cpy",children:[t.jsx("code",{children:v}),t.jsx("button",{type:"button",className:"abtn",onClick:()=>{var E;(E=navigator.clipboard)==null||E.writeText(v).then(()=>r(e.exportCopied))},children:e.exportCopy})]}),t.jsx("p",{className:"mnote",children:e.plugFeeds}),t.jsx("p",{className:"mnote warn",children:e.plugTokenNote}),t.jsx("p",{className:"mnote dim",children:t.jsx("a",{href:"https://proplace.co/api/",target:"_blank",rel:"noopener noreferrer",children:e.plugDoc})})]})]})}function dc(){const{t:e,token:a,lang:r}=B(),[n,i]=m.useState("valides"),[o,l]=m.useState(!1),[c,d]=m.useState(null),[f,s]=m.useState(null),[x,p]=m.useState(!1),[g,u]=m.useState(!1),[b,v]=m.useState(null),[h,j]=m.useState(null),[E,y]=m.useState(null),A=`atl2:bulk:${a}:${n}`;m.useEffect(()=>{Ca(a).then($=>{j($&&$.configured?$.url_hint||"webhook":null)})},[a]),m.useEffect(()=>{d(null),s(null),p(!1),v(null);try{const $=JSON.parse(localStorage.getItem(A)||"null");y($&&Date.now()-Date.parse($.t)<24*3600*1e3?$:null)}catch{y(null)}},[A]);const T=async()=>{l(!0),p(!1),v(null);const $=await ii(a,n);d($),s($.ok?n:null),l(!1)},z=m.useRef(!1),S=async()=>{if(z.current)return;z.current=!0,u(!0);const $=`${a}:${n}:${Date.now()}:${Math.random().toString(36).slice(2,10)}`;let L;try{L=await si(a,n,"webhook",void 0,$)}finally{z.current=!1}if(u(!1),p(!1),v(L),L.ok&&(L.pushed||0)>0){const M={t:new Date().toISOString(),n:L.pushed||0};y(M);try{localStorage.setItem(A,JSON.stringify(M))}catch{}}},C=c!=null&&c.ok&&c.ready||0,N=!!(c!=null&&c.ok)&&f===n&&C>0&&!!h&&!E,R=E?new Date(E.t).toLocaleString(r==="en"?"en-US":"fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"";return t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.plugBulk}),t.jsx("p",{className:"mnote",children:e.plugBulkHint}),t.jsxs("div",{className:"mfield",children:[t.jsx("select",{value:n,onChange:$=>i($.target.value),children:e.plugBulkTabs.map(([$,L])=>t.jsx("option",{value:$,children:L},$))}),t.jsx("button",{type:"button",className:"abtn",disabled:o,onClick:()=>{T()},children:o?"…":e.plugBulkPreview})]}),c&&(c.ok?t.jsx("p",{className:"mnote",children:e.plugBulkResult(c.ready||0,c.linkedinReady||0,(c.noContact||[]).length)}):t.jsx("p",{className:"mnote warn",children:e.actErr})),!!(c!=null&&c.ok)&&t.jsx("p",{className:"mnote dim",children:e.bulkScope}),E&&t.jsx("p",{className:"mnote",children:e.bulkLocked(R,E.n)}),!E&&!!(c!=null&&c.ok)&&!h&&t.jsx("p",{className:"mnote warn",children:e.bulkNoDest}),!E&&!c&&t.jsx("p",{className:"mnote dim",children:e.bulkPreviewFirst}),N&&!x&&t.jsx("button",{type:"button",className:"abtn dgr",onClick:()=>p(!0),children:e.bulkArm}),N&&x&&t.jsxs("div",{className:"bulkc",children:[t.jsx("p",{className:"mnote warn",children:e.bulkWarn(C,h||"")}),t.jsx("button",{type:"button",className:"abtn dgr",disabled:g,onClick:()=>{S()},children:g?e.bulkSending:e.bulkConfirm(h||"")}),t.jsx("button",{type:"button",className:"abtn",disabled:g,onClick:()=>p(!1),children:e.bulkCancel})]}),b&&(b.ok?b.replayed?t.jsx("p",{className:"mnote",children:b.pending?e.bulkPending:e.bulkReplayed}):(b.pushed||0)>0?t.jsx("p",{className:"mnote",children:e.bulkDone(b.pushed||0,b.linkedinReady||0,b.skippedNoEmail||0)}):t.jsx("p",{className:"mnote warn",children:e.bulkNone}):t.jsx("p",{className:"mnote warn",children:b.error||e.actErr}))]})}function pc(){const{t:e,data:a,lang:r}=B(),n=a.credits,i=a.email,o=async l=>{if(!i)return;const c=window.location.href.split("?")[0];try{const f=await(await fetch(`${Va}/inbound/credits/checkout`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:i,lookup_key:l,success_url:c+"?credits=ok",cancel_url:c+"?credits=cancel"})})).json();f.url&&(window.location.href=f.url)}catch{}};return t.jsxs(Oe,{title:e.rechargeTitle,icon:"⚡",children:[n&&t.jsxs(t.Fragment,{children:[t.jsx("p",{className:"hint",style:{marginTop:0},dangerouslySetInnerHTML:{__html:e.rechargeHint(n.daily_grant)}}),n.costs&&t.jsxs("p",{className:"mnote",children:["① ",e.creditsCost(n.costs.instant)," · ② ",e.creditsCost(n.costs.detailed)]}),t.jsx("div",{className:"packs",children:(n.packs||[]).map(l=>t.jsxs("div",{className:"pack",children:[t.jsx("div",{className:"pt",children:e.rechargeUnit(l.credits,l.price_eur)}),t.jsx("button",{type:"button",onClick:()=>{o(l.lookup_key)},children:e.rechargeBuy})]},l.lookup_key))}),t.jsx("p",{className:"hint",style:{fontSize:12,color:"var(--muted)"},children:e.rechargeNote})]}),!n&&t.jsx("div",{className:"sp-empty",children:e.creditsNone})]})}function uc(){const{t:e}=B();return t.jsx(Oe,{title:e.dsBtn,icon:"🗂",wide:!0,children:t.jsx(Gl,{})})}function mc(){const{t:e,lang:a,data:r,dossiers:n,token:i,fund:o,canWrite:l,flash:c}=B(),[d,f]=m.useState(null),[s,x]=m.useState(!1);m.useEffect(()=>{let C=!0;if(o)return Wa(o).then(N=>{C&&N&&typeof N.per_day=="number"&&f(N.per_day)}),()=>{C=!1}},[o]);const[p,g]=m.useState(null);m.useEffect(()=>{if(!i)return;let C=!0;return ni(i).then(N=>{C&&g(N)}),()=>{C=!1}},[i]);const u=r.stats,b=typeof(u==null?void 0:u.screened)=="number"?u.screened:n.filter(C=>C.kind==="target"&&Re(C)).length,v=r.marketEstimate||0,h=v>0?Math.min(100,Math.round(b/v*100)):null,j=(u==null?void 0:u.window_days)||30,E=b>0?b/j:0,y=v>0?Math.max(0,v-b):0,T=v>0&&E>0&&b>=100?Math.round(y/E):null,z=C=>Math.round(C).toLocaleString(a==="en"?"en-US":"fr-FR"),S=C=>{s||!l||(x(!0),oi(i,C).then(N=>{if(x(!1),N===null){c(e.actErr);return}f(N),c(e.alertSaved)}))};return t.jsxs(Oe,{title:e.coverTitle,icon:"🌍",children:[t.jsxs("div",{className:"covg",children:[t.jsx("b",{children:e.covScreened(z(b))}),v>0&&t.jsx("span",{children:e.covOf(z(v))})]}),h!==null?t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"covbar",children:[t.jsx("i",{style:{width:h+"%"}}),t.jsxs("em",{children:[h," %"]})]}),T!==null&&t.jsx("p",{className:"mnote",children:e.covEta(T)})]}):t.jsx("p",{className:"mnote dim",children:e.covNoEst}),E>=1&&t.jsx("p",{className:"mnote",children:e.covPace(z(E))}),(p==null?void 0:p.ok)&&(p.detail||[]).length>0&&t.jsxs("div",{className:"covcalc",children:[t.jsx("h3",{children:e.covHowT}),p.perimetre&&t.jsx("p",{className:"mnote",children:p.perimetre}),t.jsxs("table",{children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{className:"cc",children:e.covColCode}),t.jsx("th",{className:"cn",children:e.covColN}),t.jsx("th",{className:"cs",children:e.covColSource})]})}),t.jsxs("tbody",{children:[(p.detail||[]).map((C,N)=>t.jsxs("tr",{className:C.n?"":"zero",children:[t.jsxs("td",{className:"cc",children:[C.code,C.geo?` · ${C.geo}`:" · FR"]}),t.jsx("td",{className:"cn",children:typeof C.n=="number"?z(C.n):"—"}),t.jsxs("td",{className:"cs",children:[t.jsx("span",{children:C.source}),C.elargi&&t.jsx("em",{children:e.covWide(String(C.demande||""))}),C.erreur&&t.jsx("em",{children:e.covMissing})]})]},N)),t.jsxs("tr",{className:"tot",children:[t.jsx("td",{className:"cc",children:e.covTotal}),t.jsx("td",{className:"cn",children:t.jsx("b",{children:z(p.total||v)})}),t.jsx("td",{className:"cs"})]})]})]}),(p.rejetes||[]).length>0&&t.jsx("p",{className:"mnote dim",children:e.covRejected((p.rejetes||[]).join(", "))}),t.jsxs("p",{className:"mnote dim",children:[(p.sources||[]).join(" · "),p.calcule_le?` — ${e.covComputedAt(p.calcule_le.slice(0,10).split("-").reverse().join("/"))}`:""]})]}),u&&t.jsxs("div",{className:"covf",children:[typeof u.kept=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(u.kept)})," ",e.covKept]}),typeof u.analyzed=="number"&&t.jsxs("span",{children:[t.jsx("b",{children:z(u.analyzed)})," ",e.covAna]}),typeof u.shown=="number"&&u.shown!==u.kept&&t.jsxs("span",{children:[t.jsx("b",{children:z(u.shown)})," ",e.funShown]})]}),l&&d!==null&&t.jsxs("div",{className:"covr",children:[t.jsxs("div",{className:"covrh",children:[t.jsx("span",{children:e.covRate}),t.jsx("b",{children:e.covRateNow(d)})]}),t.jsx("div",{className:"covrb",children:[0,1,2,3,5,10].map(C=>t.jsx("button",{type:"button",className:d===C?"on":"",disabled:s,onClick:()=>S(C),children:C===0?"⏸":C},C))}),t.jsx("p",{className:"mnote dim",children:e.covRateHint})]})]})}function fc(){var h,j,E;const{t:e,dossiers:a,token:r,mode:n,flash:i,criteria:o,fund:l,lang:c}=B(),d=n==="client",f=m.useMemo(()=>{const y=new Set;return a.forEach(A=>{A.angle&&y.add(A.angle)}),[...y]},[a]),[s,x]=m.useState(""),[p,g]=m.useState(""),[u,b]=m.useState(!1),v=async()=>{const y=s.trim();if(!(!y||u||!d)){b(!0),g("");try{const T=await(await fetch(`${ht}/cibles/thesis-chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:r,message:y,who:"atelier2"})})).json().catch(()=>({}));if(T.reply&&g(String(T.reply)),T.job_id){g(e.critChatRunning);const z=async()=>{const S=await fetch(`${ht}/cibles/thesis-chat-status`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_id:T.job_id})}).then(C=>C.json()).catch(()=>null);if(S&&S.done){g(String(S.reply||S.clarification||S.summary||"✓")),b(!1),S.applied&&i(e.alertSaved);return}setTimeout(()=>{z()},8e3)};setTimeout(()=>{z()},8e3),x("");return}x("")}finally{p.startsWith("⏳")||b(!1)}}};return t.jsxs(Oe,{title:e.critTitle,icon:"⚙",wide:!0,children:[(o==null?void 0:o.lead)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critHypTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.lead}),!!((h=o.points)!=null&&h.length)&&t.jsx("ul",{className:"critpts",children:o.points.map(y=>t.jsx("li",{children:y},y))}),t.jsx("p",{className:"mnote",children:e.critHypSub})]}),!!((j=o==null?void 0:o.angles)!=null&&j.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critProfilsTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:o.method||e.critProfilsSub}),o.angles.map(y=>{var A,T;return t.jsxs("details",{className:"prof",children:[t.jsx("summary",{children:y.title}),y.why&&t.jsx("p",{className:"why",children:y.why}),t.jsxs("div",{className:"lo",children:[!!((A=y.look)!=null&&A.length)&&t.jsxs("div",{children:[t.jsx("em",{children:e.critLookFor}),t.jsx("ul",{children:y.look.map(z=>t.jsx("li",{children:z},z))})]}),!!((T=y.out)!=null&&T.length)&&t.jsxs("div",{className:"ko",children:[t.jsx("em",{children:e.critRuleOut}),t.jsx("ul",{children:y.out.map(z=>t.jsx("li",{children:z},z))})]})]})]},y.title)})]}),!!((E=o==null?void 0:o.gate)!=null&&E.length)&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critGateTitle}),t.jsx("p",{className:"mnote",style:{marginTop:0},children:e.critGateSub}),o.gate.length===1&&!o.gate[0].k?t.jsx("p",{className:"gate1",children:o.gate[0].t}):t.jsx("ol",{className:"gatesteps",children:o.gate.map(y=>t.jsxs("li",{children:[y.k&&t.jsx("b",{children:y.k}),y.t]},y.t))})]}),f.length>0&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"qsec ok",children:e.critAngles}),t.jsx("ul",{style:{margin:"0 0 16px",paddingLeft:18},children:f.map(y=>t.jsx("li",{style:{marginBottom:5},children:y.replace(/[_-]+/g," ")},y))})]}),t.jsxs("div",{className:"rule",children:[t.jsx("b",{children:e.critChatTitle}),t.jsx("p",{children:e.critChatHint}),t.jsxs("div",{className:"mfield",style:{marginTop:10},children:[t.jsx("input",{placeholder:e.critChatPh,value:s,disabled:!d||u,onChange:y=>x(y.target.value),onKeyDown:y=>{y.key==="Enter"&&v()}}),t.jsxs("button",{type:"button",className:"evalbtn"+(u?" loading":""),style:{padding:"12px 18px"},disabled:!d||u||!s.trim(),onClick:()=>void v(),children:[t.jsx("span",{className:"fill"}),e.critChatSend]})]}),p&&t.jsx("p",{className:"mnote",style:{marginTop:10},children:p})]}),t.jsx("div",{style:{marginBottom:14},children:t.jsx(ai,{fund:l,lang:c,limit:30,compact:!0})}),t.jsx("div",{className:"qsec ok",children:e.qvTitle}),t.jsx("div",{className:"vlist",children:e.qv.map(([y,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vd "+(Vr[y]||"v-cons"),children:y}),t.jsx("span",{children:A})]},y))}),t.jsx("div",{className:"qsec ok",children:e.brTitle}),t.jsx("div",{className:"vlist",children:e.br.map(([y,A])=>t.jsxs("div",{className:"vrow",children:[t.jsx("span",{className:"vtag",children:y}),t.jsxs("span",{children:["← ",A]})]},y))}),t.jsx("p",{className:"mnote",children:e.brNote}),t.jsx("p",{className:"mnote",children:e.critMemoKinds})]})}function xc(){const{t:e,dispatch:a,startTour:r}=B(),n=i=>{var o,l;a({type:"modal",modal:null}),i==="crit"||i==="plug"||i==="alert"?a({type:"modal",modal:i}):i.startsWith("tab")?a({type:"ptab",tab:Number(i.slice(3))}):i==="eval"&&((o=document.querySelector(".atl2 .demand input"))==null||o.scrollIntoView({block:"center",behavior:"smooth"}),(l=document.querySelector(".atl2 .demand input"))==null||l.focus())};return t.jsxs(Oe,{title:e.tutoTitle,icon:"▶",children:[t.jsxs("div",{className:"howto-go",children:[t.jsx("p",{children:e.tourIntro}),t.jsxs("button",{type:"button",onClick:()=>{a({type:"modal",modal:null}),r()},children:["▶ ",e.tourStart]})]}),t.jsx("ul",{className:"howto",children:e.howto.map(([i,o],l)=>t.jsxs("li",{role:"button",tabIndex:0,onClick:()=>n(o),onKeyDown:c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),n(o))},children:[t.jsx("span",{className:"n",children:l+1}),t.jsx("span",{dangerouslySetInnerHTML:{__html:i.replace(/\*\*(.+?)\*\*/g,"<b>$1</b>")}})]},o+l))})]})}const Wr="atl2:mapfold",hc=()=>{if(typeof window>"u")return!1;try{const e=localStorage.getItem(Wr);if(e==="on")return!0;if(e==="off")return!1}catch{}try{const e=new URLSearchParams(window.location.search);if(e.get("embed")==="1"&&(e.get("source")||"").toLowerCase()==="ops")return!0}catch{}return window.innerHeight<1e3},gc=()=>{if(typeof window>"u")return!1;try{if(new URLSearchParams(window.location.search).get("embed")==="1")return!0}catch{}return!1},Yr=m.createContext(null),B=()=>{const e=m.useContext(Yr);if(!e)throw new Error("AtelierV2Ctx manquant");return e};function pt({o:e,lg:a}){const{lang:r}=B(),n=Ae(e);return n?t.jsxs("span",{className:"sig"+(a?" sig-lg":""),title:Ea(n,r),children:[n.emoji," ",Ea(n,r)]}):null}function ca({o:e,src:a}){const{lang:r,t:n}=B(),i=Ae(e);if(!i)return null;const o=xi(i),l=hi(i);return t.jsxs("em",{className:"sigwin"+(l?" hot":""),title:n.signaledOn(Ga(i,r))+" · "+n.win7(Xt(i,r)),children:[t.jsx("span",{className:"gg",children:Array.from({length:7},(c,d)=>t.jsx("i",{className:d<o?"on":""},d))}),t.jsx("span",{className:"lb",children:l?n.lastDay:n.daysLeft(Math.max(0,i.left??0))}),a&&i.url&&t.jsx("a",{href:i.url,target:"_blank",rel:"noopener noreferrer",title:n.seeSource,onClick:c=>c.stopPropagation(),children:"↗"})]})}function bc(e,a,r){const n=(r||"").trim();if(n){const o=e.find(l=>(l.url||"")===n);if(o)return o}const i=Be(a);if(i)return e.find(o=>Be(o.name)===i)||e.find(o=>{const l=Be(o.name);return l.length>=3&&(i.includes(l)||l.includes(i))})}function vc(){const{scoped:e,t:a,st:r,dispatch:n}=B(),i=m.useRef(r.filters.day);r.filters.day&&(i.current=r.filters.day);const o=!!r.filters.day,l=e.length,c=e.filter(s=>!s.noCo).length,d=e.filter(s=>!!s.decryptHtml).length,f=(r.filters.sector||[]).length>0;return t.jsxs("button",{type:"button",className:"map-pulse"+(o?" on":""),"aria-pressed":o,title:o?a.zoomPulseBtn:a.zoomPulseWeek,onClick:()=>{if(o)n({type:"filters",patch:{day:"",win:f?"7":"all"}});else{const s=i.current||new Date().toISOString().slice(0,10);n({type:"filters",patch:{day:s,win:"all"}})}},children:[t.jsx("em",{children:o?a.zoomPulseBtn:a.zoomPulseWeek}),t.jsx("b",{children:l}),t.jsx("span",{children:o?a.zoomPulseEd:a.zoomPulseWeekEd}),t.jsxs("ul",{children:[t.jsxs("li",{children:["⚡ ",c," ",a.zoomPulseEval]}),t.jsxs("li",{children:["🔎 ",l-c," ",a.zoomPulseExplore]}),t.jsxs("li",{children:["📖 ",d," ",a.zoomPulseArts]})]})]})}function Gr({o:e}){const{lang:a}=B(),r=fi(e.cc),n=e.cc?wt(e.cc,a)||e.countryLabel||e.cc:e.countryLabel||"—";return t.jsx("span",{className:"c-flag",title:n||void 0,children:r?t.jsx("img",{src:r,width:24,height:18,alt:n||""}):t.jsx("span",{className:"em",children:"🌐"})})}const or="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600;700&family=IBM+Plex+Sans:wght@400;500;600;700;800&display=swap",yc=!1;function wc(){const[e,a]=m.useState(!1);return m.useEffect(()=>{const r=document.scrollingElement||document.documentElement,n=()=>a((r.scrollTop||0)>600);return n(),window.addEventListener("scroll",n,!0),()=>window.removeEventListener("scroll",n,!0)},[]),e?t.jsx("button",{type:"button",className:"totop",title:"Remonter en haut",onClick:()=>{(document.scrollingElement||document.documentElement).scrollTo({top:0,behavior:"smooth"})},children:"↑"}):null}const Kr=e=>`atl2:tour:${e||"anon"}`;function kc(e){try{return localStorage.getItem(Kr(e))==="1"}catch{return!0}}function ir(e){try{localStorage.setItem(Kr(e),"1")}catch{}}function jc(e,a,r,n,i){const o=e.tourT,l=e.howto;return[{sel:".atl2 .ident",title:o.ident,body:e.fhintIdent},i?{sel:".atl2 .cover",title:o.cover,body:e.fhintCover,need:".atl2 .ident"}:null,{sel:".atl2 .engine",title:o.engine,body:e.fhintEngine},{sel:".atl2 .ticker",title:o.live,body:e.fhintLive},{sel:".atl2 .goal",title:o.goal,body:e.fhintGoalAt(a)},{sel:".atl2 .funnel",title:o.funnel,body:e.fhintFunnel,ptab:n},{sel:".atl2 .tuto",title:o.tuto,body:l[3][0],ptab:3,need:".atl2 .tuto"},{sel:".atl2 .demand",title:o.demand,body:l[1][0]},{sel:".atl2 .c-vd",need:".atl2 .list",title:o.chips,body:e.fhintChips,ptab:n,dens:"liste"},{sel:".atl2 .card .cdbody",need:".atl2 .list",title:o.dec,body:e.fhintDec,ptab:n,dens:"deplie"},r?{sel:".atl2 .card .cdtabs",need:".atl2 .list",click:'.atl2 [data-tour="tab-memo"]',title:o.memo,body:e.fhintMemo,ptab:n,dens:"deplie"}:null,{sel:".atl2 .csp",need:".atl2 .list",title:o.status,body:e.fhintStatus,ptab:n,dens:"deplie"},{sel:".atl2 .learn",title:o.learn,body:e.learnLine},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=export]",title:o.exportT,body:e.fhintExport,modal:"export"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=plug]",title:o.tools,body:l[6][0],modal:"plug"},{sel:".atl2 .modal.on .mcard",need:".atl2 .ic[data-tour=alert]",title:o.alerts,body:e.fhintAlerts,modal:"alert"},{sel:".atl2 .modal.on .mcard",title:o.crit,body:l[0][0],modal:"crit"}].filter(Boolean)}function zc({demo:e=!1,source:a="default",initialFilters:r,initialUi:n,capsOverride:i,onFiltersChange:o}){var ln;const{lang:l}=pr(),c=Ai[l],d=$i(e,l,a),[f,s]=m.useReducer(Ui,void 0,()=>Bi((n==null?void 0:n.continent)??(a==="ops"?"monde":"europe"),e||(a==="ops"?gc():hc()),{ptab:n==null?void 0:n.ptab,dens:(n==null?void 0:n.dens)??"liste",filters:r,modal:n==null?void 0:n.modal})),x=m.useRef(!0);m.useEffect(()=>{if(x.current){x.current=!1;return}if(!(e||a==="ops"))try{localStorage.setItem(Wr,f.mapFolded?"on":"off")}catch{}},[f.mapFolded,e,a]);const p=m.useRef(o);p.current=o,m.useEffect(()=>{var k;(k=p.current)==null||k.call(p,f.filters)},[f.filters]);const[g,u]=m.useState(null),[b,v]=m.useState(null),[h,j]=m.useState(null),[E,y]=m.useState({kept:0,dropped:0}),[A,T]=m.useState(!1),[z,S]=m.useState(""),[C,N]=m.useState(!1),[R,$]=m.useState(null),[L,M]=m.useState(!1),[w,O]=m.useState(!1),[,H]=m.useState(0),V=()=>H(k=>k+1),U=m.useRef([]),re=m.useRef(new Set),ee=m.useRef(new Set),[X,oe]=m.useState([]),[I,ae]=m.useState([]),[pe,xe]=m.useState(0),ge=m.useRef(new Map),ze=m.useRef(null),{mode:K}=d,W=m.useMemo(()=>({...d.caps,...a==="ops"?{showMorning:!1}:null,...i||null}),[d.caps,i,a]),J=W.pipe,Q=d.session.token||"",te=K==="client"&&!e;m.useEffect(()=>{if(!Q||!J)return;let k=!0;const _=async()=>{const se=await gi(Q);!k||!se||(ae(se.runs),xe(Date.now()/1e3-se.now),oe(je=>je.filter(Ye=>!se.runs.some(Ke=>Be(Ke.company)===Be(Ye.name)))))};_();const P=X.length>0||I.some(se=>se.status==="running"),G=window.setInterval(()=>{_()},P?8e3:25e3);return()=>{k=!1,window.clearInterval(G)}},[Q,J,X.length,I.some(k=>k.status==="running")]);const ye=m.useMemo(()=>{const k=[],_=new Set;for(const P of X){const G=Be(P.name);!G||_.has(G)||(_.add(G),k.push({name:P.name,id:P.id,status:"boot",started:P.started,estMin:P.estMin,memoType:"instant"}))}for(const P of I){const G=Be(P.company);if(!G||_.has(G))continue;_.add(G);const se=P.status==="error"?"error":P.status==="done"?"done":"running";k.push({name:P.company,status:se,started:P.started||0,estMin:P.est_min||(P.memo_type==="detailed"?40:15),url:P.url,error:P.error,memoType:P.memo_type})}return k},[X,I]),de=k=>ye.find(_=>Be(_.name)===Be(k))||null,we=(k,_)=>{oe(P=>P.some(G=>Be(G.name)===Be(k.name))?P:[...P,{name:k.name,id:k.id,started:Date.now()/1e3,estMin:_==="detailed"?40:15}]),re.current.add(k.id),V()};m.useEffect(()=>{if(document.querySelector(`link[href="${or}"]`))return;const k=document.createElement("link");k.rel="stylesheet",k.href=or,document.head.appendChild(k)},[]);const le=(k,_=!1)=>{S(k),N(_),ze.current&&clearTimeout(ze.current),ze.current=setTimeout(()=>S(""),_?4200:2400)},ue=k=>le(k,!0),qe=m.useMemo(()=>{const k=new Map;return d.dossiers.forEach(_=>{_.id&&k.set(_.id,_)}),k},[d.dossiers]),q=m.useMemo(()=>d.dossiers.filter(k=>fr(k,f,J)),[d.dossiers,f,J]),F=m.useRef(!1);m.useEffect(()=>{if(F.current||e||d.loading||!d.dossiers.length)return;if(!W.showFunnel||kc(d.session.token||"")){F.current=!0;return}F.current=!0;const k=window.setTimeout(()=>{ir(d.session.token||""),M(!0)},700);return()=>window.clearTimeout(k)},[e,d.loading,d.dossiers.length,W.showFunnel,d.session.token]);const Y=m.useMemo(()=>d.dossiers.filter(k=>Vi(k,f,J,d.favIds)),[d.dossiers,f,J,d.favIds]),Z=m.useMemo(()=>ui(q,d.favIds),[q,d.favIds]),Ne=m.useMemo(()=>{const k=yr(d.dossiers);return k?tt(k)===0?c.tourToday:wr(k,l):c.tourNoRun},[d.dossiers,c,l]),me=m.useMemo(()=>d.dossiers.some(k=>!!k.memoUrl||!!k.summary||gt(k)),[d.dossiers]),[Fe,Ge]=m.useState(!1);m.useEffect(()=>{if(d.loading){Ge(!1);return}if(d.dossiers.length>0||d.error){Ge(!0);return}const k=window.setTimeout(()=>Ge(!0),6e3);return()=>window.clearTimeout(k)},[d.loading,d.dossiers.length,d.error]);const nt=(d.marketEstimate||0)>0||typeof((ln=d.stats)==null?void 0:ln.screened)=="number"&&d.stats.screened>0,mt=m.useMemo(()=>[1,0,2,4,5,3].find(k=>(Z[k]||0)>0)??0,[Z]),Pe=Ya.find(k=>k.key===f.continent),jt=f.continent==="monde"?c.contWorld:(l==="fr"?Pe==null?void 0:Pe.fr:Pe==null?void 0:Pe.en)||"";m.useEffect(()=>{const k=_=>{var G;const P=(((G=_.detail)==null?void 0:G.name)||"").trim();P&&rt(null,P)};return window.addEventListener("ppmap:evaluate",k),()=>window.removeEventListener("ppmap:evaluate",k)}),m.useEffect(()=>{if(a!=="ops")return;const k=_=>{const P=_.detail||{},G=String(P.id||"").trim(),se=String(P.name||"").trim(),je=String(P.url||"").trim(),Ye=G&&qe.get(G)||bc(d.dossiers,se,je);if(Ye){v(null),s({type:"focus",id:Ye.id}),Ye.noCo||window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:Ye.name}}));return}!se&&!je||(s({type:"focus",id:null}),v({name:se,headline:String(P.text||"").trim()||se,url:je,card:P.card}),se&&!la(se)&&window.dispatchEvent(new CustomEvent("ppmap:prefill",{detail:{name:se,url:je}})))};return window.addEventListener("ppmap:focus",k),()=>window.removeEventListener("ppmap:focus",k)}),m.useEffect(()=>{const k=G=>{const se={},je=String((G==null?void 0:G.sector)||"").trim();je&&(se.sector=[je]);const Ye=String((G==null?void 0:G.day)||"").slice(0,10);/^\d{4}-\d{2}-\d{2}$/.test(Ye)&&(se.day=Ye);const Ke=String((G==null?void 0:G.search)||"").trim();Ke&&(se.search=Ke);const he=String((G==null?void 0:G.dealKind)||"").trim();(he==="ma"||he==="levee"||he==="other")&&(se.dealKind=[he]),Object.keys(se).length&&s({type:"filters",patch:se})},_=G=>k(G.detail),P=G=>{G.data&&G.data.type==="pp-filter"&&k(G.data)};return window.addEventListener("ppmap:filter",_),window.addEventListener("message",P),()=>{window.removeEventListener("ppmap:filter",_),window.removeEventListener("message",P)}},[]),m.useEffect(()=>{const k=_=>{var se;const P=(((se=_.detail)==null?void 0:se.name)||"").trim().toLowerCase();if(!P)return;const G=d.dossiers.find(je=>(je.name||"").trim().toLowerCase()===P);G&&s(a==="ops"?{type:"focus",id:G.id}:{type:"popup",id:G.id})};return window.addEventListener("ppmap:similar",k),()=>window.removeEventListener("ppmap:similar",k)});const rt=(k,_)=>{const P=((k==null?void 0:k.name)||_||"").trim();if(!te){j({kicker:P});return}!P||A||(T(!0),(async()=>{try{let G=P;const se=((k==null?void 0:k.website)||(k==null?void 0:k.domain)||"").trim();if(se)G=se;else try{const he=await bi(P);if(he!=null&&he.website)G=he.website;else if(((he==null?void 0:he.candidates)||[]).length===1)G=he.candidates[0].url;else if(((he==null?void 0:he.candidates)||[]).length>1){U.current=[{name:P,verdict:"unresolved",remaining:null,reason:c.evalPickSite,candidates:(he.candidates||[]).slice(0,5)},...U.current].slice(0,8),V();return}}catch{}const je=await dr(Q,G,"atelier2"),Ye={name:je.company||P,verdict:je.verdict,reason:je.reason||"",remaining:je.remaining??null};U.current=[Ye,...U.current].slice(0,8),je.verdict==="kept"&&y(he=>({...he,kept:he.kept+1})),je.verdict==="ruled_out"&&y(he=>({...he,dropped:he.dropped+1}));const Ke=k||d.dossiers.find(he=>(he.name||"").toLowerCase()===P.toLowerCase());Ke&&(je.verdict==="kept"?Ke.verdict=Ke.verdict||"MATCH":je.verdict==="ruled_out"&&(Ke.verdict="NO MATCH"),je.reason&&(Ke.reasoning=je.reason)),V()}finally{T(!1)}})())},D=k=>{if(!te){j({kicker:k.name});return}we(k,"instant"),Nt(Q,"fast_request",k.name||"",""),le(c.memoInstantSent(k.name))},ne=k=>ge.current.get(k.id)??d.thumbs.get((k.name||"").trim().toLowerCase()),ce=(k,_)=>s({type:"undoPush",entry:{id:k.id,name:k.name,prevCeoStatus:_}}),be=async(k,_,P)=>{const G=k.ceoStatus||"";k.ceoStatus=_,V();const se=await ua(Q,{status:_,airtable_id:k.airtableId,check_id:k.checkId,company:k.name,...(P==null?void 0:P.note)!==void 0?{note:P.note}:{},...P!=null&&P.via?{via:P.via}:{}});return se.ok?se.skipped?(k.ceoStatus=G,V(),ue(c.actNotPersisted),!1):((P==null?void 0:P.undo)!==!1&&ce(k,G),P!=null&&P.msg&&le(P.msg),(_==="Validé"||_==="Écarté")&&!k.ceoNote&&(P==null?void 0:P.note)===void 0&&$({o:k,yes:_==="Validé"}),!0):(k.ceoStatus=G,V(),ue(c.actErr),!1)},De=async(k,_)=>{const P=await ua(Q,{status:k.ceoStatus||"Retenu",airtable_id:k.airtableId,check_id:k.checkId,company:k.name,note:_,via:"note"});return!P.ok||P.skipped?(ue(P.skipped?c.actNotPersisted:c.actErr),!1):(k.ceoNote=_,V(),!0)},Te=m.useRef(new Map),ke=k=>Te.current.has(k.id)?Te.current.get(k.id):d.stages.get((k.name||"").trim().toLowerCase()),$e=(k,_)=>{Te.current.set(k.id,_),V()},da=(k,_)=>{te&&be(k,_?"Validé":"Écarté",{msg:_?c.decidedYes(k.name):c.decidedNo(k.name)})},Dt=k=>{te&&be(k,"À trancher",{msg:c.promoted(k.name)})},Qr=k=>{te&&(async()=>{const _=k.ceoStatus||"";k.ceoStatus="Retenu",V();const P=await ua(Q,{status:"Retenu",check_id:k.checkId,company:k.name});if(!P.ok||P.skipped){k.ceoStatus=_,V(),ue(P.skipped?c.actNotPersisted:c.actErr);return}ce(k,_),le(c.repeched(k.name))})()},Jr=()=>{const k=f.undo[f.undo.length-1];if(!k){le(c.undoNone);return}const _=qe.get(k.id);if(!_){s({type:"undoPop"}),le(c.undoNone);return}let P=k.prevCeoStatus;if(!P)if((_.verdict||"").toUpperCase().includes("CALL"))P="À trancher";else{le(c.undoLockedTitle);return}(async()=>await be(_,P,{undo:!1})&&(s({type:"undoPop"}),_.ceoStatus=k.prevCeoStatus,V(),le(c.undoDone(_.name))))()},Xr=k=>{te&&(ee.current.add(k.id),V(),(async()=>{const _=await vi(Q,k.name,"email");if(!_||_.ok===!1){ee.current.delete(k.id),V(),ue(c.actErr);return}Nt(Q,"approach",k.name||"",""),le(c.actApproachSent)})())},Zr=(k,_)=>{te&&(async()=>{if(!(await Nt(Q,_?"yes":"no",k.name||"","")).ok){ue(c.actErr);return}ge.current.set(k.id,_?"yes":"no"),V(),le(_?c.thumbUpDone:c.thumbDnDone)})()},eo=k=>{!te||!gt(k)||(we(k,"detailed"),Nt(Q,"detailed_request",k.name||"",""),le(c.memoDeepSent(k.name)))},to=k=>{const _=new Set(d.favIds),P=_.has(k.id);P?_.delete(k.id):_.add(k.id),d.setFavIds(_),te&&yi(Q,{id:k.id,co:k.name},P)},ao=()=>{!te||w||window.confirm(c.identSyncConfirm)&&(O(!0),(async()=>{const k=await wi(Q);O(!1),k?le(c.identSyncDone):ue(c.actErr)})())},sn=/proplace/i.test(d.fund||""),no=k=>{!te||!sn||(Nt(Q,"onboard_request",k.name||"",""),le(c.onboardSent(k.name)))},ro={st:f,dispatch:s,t:c,lang:l,mode:K,caps:W,pipe:J,token:Q,fund:d.fund,email:d.email,criteria:d.criteria,source:a||"default",data:d,doRepeche:Qr,thumbOf:ne,canWrite:te,commitStatus:be,saveNote:De,stageOf:ke,setStage:$e,flashErr:ue,startTour:()=>M(!0),dossiers:d.dossiers,scopedAll:q,scoped:Y,counts:Z,byId:qe,contName:jt,favIds:d.favIds,toggleFav:to,askEvaluate:rt,doAnalyse:D,doDecide:da,doPromote:Dt,doApproach:Xr,doThumb:Zr,doDeep:eo,doUndo:Jr,doSync:ao,doOnboard:no,outbound:sn,memoQueued:re.current,liveMemos:{items:ye,serverOff:pe,liveOf:de},approachDone:ee.current,sessTally:E,evalCards:U.current,evalBusy:A,markRow:u,markedId:g,flash:le,focusExtra:b};m.useEffect(()=>{const k=_=>{_.key==="Escape"&&(s({type:"popup",id:null}),s({type:"modal",modal:null}),s({type:"openFacet",facet:null}))};return window.addEventListener("keydown",k),()=>window.removeEventListener("keydown",k)},[]);const oo=k=>Q?t.jsx(Wi,{token:Q,children:k}):t.jsx(t.Fragment,{children:k});return t.jsx(Yr.Provider,{value:ro,children:t.jsxs("div",{className:"atl2"+(a==="ops"?" ops":"")+(Q?" cibles":""),children:[t.jsx("style",{children:Li}),W.showOnb&&t.jsxs("div",{className:"lockbar on",children:[t.jsx("b",{children:c.lockbarText}),t.jsxs("span",{className:"lb-c",children:[c.lockbarContactBefore,t.jsx("a",{href:br,children:Xa}),c.lockbarContactMid,t.jsx("a",{href:`mailto:${Zt}`,children:Zt})]}),t.jsx("button",{type:"button",onClick:()=>s({type:"modal",modal:"rdv"}),children:c.lockbarCta})]}),oo(t.jsxs("div",{className:"app"+(J?" pipe":"")+(Q?" has-thesis":""),children:[W.showTicker&&t.jsx(Le,{name:"live",children:t.jsxs("div",{className:"live-stack"+(Q?" live-stack--cibles":""),children:[t.jsx(Xi,{}),!!Q&&t.jsx(Yi,{})]})}),W.showIdent&&t.jsx(Le,{name:"identite",children:t.jsx(ps,{})}),!1,!!Q&&t.jsx(Le,{name:"brief",children:t.jsx(Gi,{})}),yc,W.showMorning&&t.jsx(Le,{name:"matin",children:t.jsx(ds,{})}),t.jsx(Le,{name:"mesure",children:t.jsx(as,{})}),W.showFunnel&&t.jsx(Le,{name:"entonnoir",children:t.jsx(Nc,{})}),W.showFunnel&&t.jsx(Le,{name:"tunnel",children:t.jsx(us,{})}),W.showFunnel&&t.jsx(Le,{name:"tuto",children:t.jsx(ms,{})}),!f.mapFolded&&t.jsx(Le,{name:"carte",fallback:t.jsx("div",{className:"void",children:c.loadError}),children:t.jsxs("div",{className:"fzone",children:[t.jsx(Br,{}),t.jsxs("div",{className:"stage",id:"atl2-stage",children:[a==="ops"&&t.jsx(vc,{}),t.jsx(dl,{}),t.jsx($r,{})]})]})}),W.showDemand&&J&&t.jsx(Le,{name:"direct",children:t.jsx(Ei,{items:ye,serverOff:pe,labels:{strip:c.liveStrip,boot:c.liveBoot,end:c.liveEnd,open:c.liveOpenQueue,memo:c.actMemo},onOpen:()=>s({type:"modal",modal:"queue"})})}),W.showDemand&&t.jsx(Le,{name:"evaluation",children:t.jsx(hl,{})}),W.showDemand&&f.memoConsole&&t.jsx(Le,{name:"console",children:t.jsx(bl,{})}),t.jsx(Le,{name:"liste",fallback:t.jsxs("div",{className:"void",children:[c.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:()=>window.location.reload(),children:c.retry})]}),children:t.jsx(_l,{})}),d.loading&&t.jsx("div",{className:"void",children:c.loadingV2}),d.error&&!d.loading&&t.jsxs("div",{className:"void",children:[c.loadError," ",t.jsx("button",{type:"button",className:"abtn",onClick:d.refresh,children:c.retry})]})]})),f.popupId&&f.dens!=="liste"&&a!=="ops"&&t.jsx(Le,{name:"fiche",children:t.jsx(El,{})}),t.jsx(Le,{name:"modales",children:t.jsx(Ql,{})}),t.jsx(ts,{}),R&&t.jsxs("div",{className:"whydock",children:[t.jsx("b",{children:R.o.name}),t.jsx(ss,{placeholder:R.yes?c.whyYesPh:c.whyNoPh,onDone:k=>{const _=R.o;$(null),k&&De(_,k).then(P=>{P&&le(c.csNoteSaved)})}})]}),L&&Fe&&t.jsx(cs,{steps:jc(c,Ne,me,mt,nt),onClose:()=>{M(!1),ir(Q)}}),t.jsx(wc,{}),z&&t.jsx("div",{className:"flash on"+(C?" err":""),children:z}),h&&t.jsx(mi,{variant:"acquirer",initialCompany:sr().co,initialWebsite:sr().site,onClose:()=>j(null)})]})})}function Nc(){const{t:e}=B(),[a,r]=m.useState(()=>{if(typeof window>"u")return!1;try{return localStorage.getItem("atl2:fhint")==="off"}catch{return!1}});return a?null:t.jsxs("p",{className:"fhint",children:[t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12","aria-hidden":"true",children:t.jsx("path",{d:"M1 2h10M2.5 5.5h7M4.5 9h3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",fill:"none"})}),t.jsx("span",{dangerouslySetInnerHTML:{__html:e.funnelHint}}),t.jsx("button",{type:"button","aria-label":"Fermer",title:e.fhintClose,onClick:()=>{r(!0);try{localStorage.setItem("atl2:fhint","off")}catch{}},children:"✕"})]})}function sr(){try{return{co:localStorage.getItem("ppmap:acquirer")||"",site:localStorage.getItem("ppmap:acquirerSite")||""}}catch{return{co:"",site:""}}}function Sc(e){return e>=1e9?(e/1e9).toFixed(1).replace(".0","").replace(".",",")+" Md€":e>=1e6?Math.round(e/1e6)+" M€":Math.round(e/1e3)+" k€"}export{Gr as FlagCell,pt as SigBadge,ca as SigWin,zc as default,Sc as fmtShort,B as useV2};
